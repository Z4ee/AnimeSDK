...
#define CLASS_1_CDAD1C4D78702C93_GET_AXISVALUEXCHANGESPEED_OFFSET UNITYSDK_OFFSET(0xF3FD640)
#define CLASS_1_CDAD1C4D78702C93_GET_CAMERATYPE_OFFSET UNITYSDK_OFFSET(0xF3FD4B0)
#define CLASS_1_CDAD1C4D78702C93_GET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0xF3FD570)
#define CLASS_1_CDAD1C4D78702C93_GET_FREELOOKDRAGMODE_OFFSET UNITYSDK_OFFSET(0xF3FD660)
#define CLASS_1_CDAD1C4D78702C93_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0xF3FD510)
#define CLASS_1_CDAD1C4D78702C93_GET_ISAVAILABLEFORREUSE_OFFSET UNITYSDK_OFFSET(0xF3FD550)
#define CLASS_1_CDAD1C4D78702C93_GET_ISCREATED_OFFSET UNITYSDK_OFFSET(0xF3FD4F0)
#define CLASS_1_CDAD1C4D78702C93_GET_ISDESTROYED_OFFSET UNITYSDK_OFFSET(0xF3FD530)
#define CLASS_1_CDAD1C4D78702C93_GET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0xF3FD590)
#define CLASS_1_CDAD1C4D78702C93_GET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0xF3FD4D0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_03E2B9212B4B6EAF_1_OFFSET UNITYSDK_OFFSET(0xF3F9F70)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_03E2B9212B4B6EAF_OFFSET UNITYSDK_OFFSET(0xF3F9F30)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_043B534750B9E7A6_OFFSET UNITYSDK_OFFSET(0xF3FCAB0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_07A25883744F618C_OFFSET UNITYSDK_OFFSET(0xF3FAFC0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_1658BEB5EC339408_OFFSET UNITYSDK_OFFSET(0xF3FBFB0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0xF3FC780)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_19CCC07C980409E4_1_OFFSET UNITYSDK_OFFSET(0xF3F9300)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0xF3F92A0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_1D4018D4200358D0_1_OFFSET UNITYSDK_OFFSET(0xF3FAE50)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xF3FADF0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0xF3FD690)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_2ED6C3773AA1E488_OFFSET UNITYSDK_OFFSET(0xF3FC990)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xF3FD600)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_3A9C03366E936C66_OFFSET UNITYSDK_OFFSET(0xF3FC110)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_3F5F0BE9AFB2990C_OFFSET UNITYSDK_OFFSET(0xF3FA380)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xF3F9B40)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_460F8AE6EF9687FD_OFFSET UNITYSDK_OFFSET(0xF3FD0B0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_46D5C4F0EA172C6A_OFFSET UNITYSDK_OFFSET(0xF3FAC90)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_4E66CC6A96439F85_OFFSET UNITYSDK_OFFSET(0xF3FA7B0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_5D895A5456A4B9BA_OFFSET UNITYSDK_OFFSET(0xF3FAD70)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_60A0F5EC9777EFB9_OFFSET UNITYSDK_OFFSET(0xF3F9A70)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_1_OFFSET UNITYSDK_OFFSET(0xF3FA040)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_2_OFFSET UNITYSDK_OFFSET(0xF3FA120)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_3_OFFSET UNITYSDK_OFFSET(0xF3FA1B0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_4_OFFSET UNITYSDK_OFFSET(0xF3FA820)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_5_OFFSET UNITYSDK_OFFSET(0xF3FCE60)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_OFFSET UNITYSDK_OFFSET(0xF3F9FB0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_684E8D76BF9D5255_OFFSET UNITYSDK_OFFSET(0xF3FCA70)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_7301533EE4FBBAD2_OFFSET UNITYSDK_OFFSET(0xF3FA6C0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_7F612AA2F04984D6_OFFSET UNITYSDK_OFFSET(0xF3FD680)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_7F84ACCEA43BC283_OFFSET UNITYSDK_OFFSET(0xF3FBB40)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_81D7D1157E92B61D_OFFSET UNITYSDK_OFFSET(0xF3FCB50)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_84516C3E776F194F_OFFSET UNITYSDK_OFFSET(0xF3FCFA0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_861970C5F2C21AB2_OFFSET UNITYSDK_OFFSET(0xF3FC900)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_86914B28476494AF_1_OFFSET UNITYSDK_OFFSET(0xF3FBA20)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_86914B28476494AF_OFFSET UNITYSDK_OFFSET(0xF3FB900)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_8C3EF9C039C5859D_OFFSET UNITYSDK_OFFSET(0xF3F95D0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_96347D126BE5AFBC_OFFSET UNITYSDK_OFFSET(0xF3FD180)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xF3FCDD0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_96DCADC783ACF0D4_OFFSET UNITYSDK_OFFSET(0xF3FB4C0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_9C66B07446448FC6_OFFSET UNITYSDK_OFFSET(0xF3FA8B0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_A03C765EBC5D1677_OFFSET UNITYSDK_OFFSET(0xF3FCF10)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0xF3FD5B0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_AF001DB8752C7089_OFFSET UNITYSDK_OFFSET(0xF3FAA30)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xF3FCD50)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_B2A8785E9E1BD2C1_OFFSET UNITYSDK_OFFSET(0xF3FA510)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_B3895AA881B3EBB9_OFFSET UNITYSDK_OFFSET(0xF3FAEB0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_B74D29C43104A205_OFFSET UNITYSDK_OFFSET(0xF3FA290)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_BA904CAFF6C7217F_OFFSET UNITYSDK_OFFSET(0xF3F99D0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_BC46FCF99873D9DD_OFFSET UNITYSDK_OFFSET(0xF3F9BA0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_C411E5881DF297DE_OFFSET UNITYSDK_OFFSET(0xF3FA400)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_C98BEB16ED641BC0_1_OFFSET UNITYSDK_OFFSET(0xF3FA640)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_C98BEB16ED641BC0_OFFSET UNITYSDK_OFFSET(0xF3FA5C0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xF3FCB10)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xF3FACF0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CA6BDDCC5F7CE11E_1_OFFSET UNITYSDK_OFFSET(0xF3FB370)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0xF3FB2A0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CAAD3899EE103AC7_OFFSET UNITYSDK_OFFSET(0xF3F87B0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CB613A5EF970C11B_OFFSET UNITYSDK_OFFSET(0xF3F9BE0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CD8EB704BDED69B6_OFFSET UNITYSDK_OFFSET(0xF3F9C40)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CF0080D9D0A33EA9_1_OFFSET UNITYSDK_OFFSET(0xF3FB430)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CF0080D9D0A33EA9_OFFSET UNITYSDK_OFFSET(0xF3FAF30)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_D87A7D8243E04FD7_OFFSET UNITYSDK_OFFSET(0xF3F9360)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_D920CA000FAB6C31_OFFSET UNITYSDK_OFFSET(0xF3FB6F0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_DDF4E6AEE2216B17_OFFSET UNITYSDK_OFFSET(0xF3FAC30)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_E7E9C69965F5C461_OFFSET UNITYSDK_OFFSET(0xF3FAAF0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_E7F61176CF07E702_OFFSET UNITYSDK_OFFSET(0xF3FA4A0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_F28136982D1084AB_OFFSET UNITYSDK_OFFSET(0xF3FB200)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_FD7514C64FB1B043_OFFSET UNITYSDK_OFFSET(0xF3F9DE0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_FF7B2911BBACA4A9_1_OFFSET UNITYSDK_OFFSET(0xF3FB3E0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0xF3FB310)
#define CLASS_1_CDAD1C4D78702C93_SET_AXISVALUEXCHANGESPEED_OFFSET UNITYSDK_OFFSET(0xF3FD650)
#define CLASS_1_CDAD1C4D78702C93_SET_CAMERATYPE_OFFSET UNITYSDK_OFFSET(0xF3FD4C0)
#define CLASS_1_CDAD1C4D78702C93_SET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0xF3FD580)
#define CLASS_1_CDAD1C4D78702C93_SET_FREELOOKDRAGMODE_OFFSET UNITYSDK_OFFSET(0xF3FD670)
#define CLASS_1_CDAD1C4D78702C93_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0xF3FD520)
#define CLASS_1_CDAD1C4D78702C93_SET_ISAVAILABLEFORREUSE_OFFSET UNITYSDK_OFFSET(0xF3FD560)
#define CLASS_1_CDAD1C4D78702C93_SET_ISCREATED_OFFSET UNITYSDK_OFFSET(0xF3FD500)
#define CLASS_1_CDAD1C4D78702C93_SET_ISDESTROYED_OFFSET UNITYSDK_OFFSET(0xF3FD540)
#define CLASS_1_CDAD1C4D78702C93_SET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0xF3FD5A0)
#define CLASS_1_CDAD1C4D78702C93_SET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0xF3FD4E0)
#define CLASS_1_CDAD1C4D78702C93__CTOR_OFFSET UNITYSDK_OFFSET(0xF3F8790)
...
public:
	...
	::Class_1_7ACD8E31992CDE1A_2* CINEAOLJBPJ; // 0x18
	::RPG::Client::CameraBlendCurve* ILOGGEBHPHC; // 0x20
	::UnityEngine::GameObject* MHMABPNBJOC; // 0x28
	::RPG::Client::RPGCinemachineZoom* KGGPPJIEGDC; // 0x30
	::RPG::Client::RPGCinemachineCorrectionExtension* HAENPEKCION; // 0x38
	::RPG::Client::RPGCinemachineOldFreelook3rdBlend* IEADFDMEFMG; // 0x40
	::UnityEngine::GameObject* DOKFAOCAKND; // 0x48
	::UnityEngine::Transform* _LookAtTarget_k__BackingField; // 0x50
	::Cinemachine::CinemachineFreeLook* EAJFHBDCFFO; // 0x58
	::System::Int32 DIIBHKPGKCB; // 0x60
	::System::UInt32 _RuntimeID_k__BackingField; // 0x64
	::System::Single IGIPNEKPEHL; // 0x68
	::System::Single PGMIOKKLHIE; // 0x6C
	::System::Nullable_1<::UnityEngine::Vector2> NIIAIMKDCDO; // 0x70
	::System::Boolean _IsAvailableForReuse_k__BackingField; // 0x7C
	::System::Boolean _IsActive_k__BackingField; // 0x7D
	::System::Boolean _IsCreated_k__BackingField; // 0x7E
	::System::Single ADPMMNEFDPA; // 0x80
	...
	::System::Nullable_1<::UnityEngine::Vector2> BLOALMOJGIK; // 0x8C
	::System::Boolean BDFBDJCHHAC; // 0x98
	::System::Boolean _IsDestroyed_k__BackingField; // 0x99
	::System::Boolean CEKJPFJPIDH; // 0x9A
	::System::Boolean _FreelookDragMode_k__BackingField; // 0x9B
	::System::Single HBDJCFFDGDD; // 0x9C
