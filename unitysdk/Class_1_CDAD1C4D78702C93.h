...
#define CLASS_1_CDAD1C4D78702C93_GET_AXISVALUEXCHANGESPEED_OFFSET UNITYSDK_OFFSET(0x10AEBD10)
#define CLASS_1_CDAD1C4D78702C93_GET_CAMERATYPE_OFFSET UNITYSDK_OFFSET(0x10AEBB80)
#define CLASS_1_CDAD1C4D78702C93_GET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x10AEBC40)
#define CLASS_1_CDAD1C4D78702C93_GET_FREELOOKDRAGMODE_OFFSET UNITYSDK_OFFSET(0x10AEBD30)
#define CLASS_1_CDAD1C4D78702C93_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x10AEBBE0)
#define CLASS_1_CDAD1C4D78702C93_GET_ISAVAILABLEFORREUSE_OFFSET UNITYSDK_OFFSET(0x10AEBC20)
#define CLASS_1_CDAD1C4D78702C93_GET_ISCREATED_OFFSET UNITYSDK_OFFSET(0x10AEBBC0)
#define CLASS_1_CDAD1C4D78702C93_GET_ISDESTROYED_OFFSET UNITYSDK_OFFSET(0x10AEBC00)
#define CLASS_1_CDAD1C4D78702C93_GET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x10AEBC60)
#define CLASS_1_CDAD1C4D78702C93_GET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0x10AEBBA0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_03E2B9212B4B6EAF_1_OFFSET UNITYSDK_OFFSET(0x10AE87D0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_03E2B9212B4B6EAF_OFFSET UNITYSDK_OFFSET(0x10AE8790)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_07A25883744F618C_OFFSET UNITYSDK_OFFSET(0x10AE98C0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_1658BEB5EC339408_OFFSET UNITYSDK_OFFSET(0x10AEA8E0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_19CCC07C980409E4_1_OFFSET UNITYSDK_OFFSET(0x10AE7BB0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x10AE7B40)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_1D4018D4200358D0_1_OFFSET UNITYSDK_OFFSET(0x10AE9750)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x10AE96F0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_2045BA2947DBDBCE_OFFSET UNITYSDK_OFFSET(0x10AEB0C0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x10AEBD60)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x10AEBCD0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_3A9C03366E936C66_OFFSET UNITYSDK_OFFSET(0x10AEAA40)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_3F5F0BE9AFB2990C_OFFSET UNITYSDK_OFFSET(0x10AE8C10)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x10AE83E0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_46D5C4F0EA172C6A_OFFSET UNITYSDK_OFFSET(0x10AE9520)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_4BD2BFB48FF90060_OFFSET UNITYSDK_OFFSET(0x10AEB570)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_4E66CC6A96439F85_OFFSET UNITYSDK_OFFSET(0x10AE9050)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_60A0F5EC9777EFB9_OFFSET UNITYSDK_OFFSET(0x10AE8310)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_1_OFFSET UNITYSDK_OFFSET(0x10AE88A0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_2_OFFSET UNITYSDK_OFFSET(0x10AE8980)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_3_OFFSET UNITYSDK_OFFSET(0x10AE8A10)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_4_OFFSET UNITYSDK_OFFSET(0x10AE90C0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_5_OFFSET UNITYSDK_OFFSET(0x10AEB430)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_OFFSET UNITYSDK_OFFSET(0x10AE8810)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_684E8D76BF9D5255_OFFSET UNITYSDK_OFFSET(0x10AEB3F0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_7301533EE4FBBAD2_OFFSET UNITYSDK_OFFSET(0x10AE8F50)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_737220D2233A9067_OFFSET UNITYSDK_OFFSET(0x10AEB2B0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_739DB9F245C7FAD0_OFFSET UNITYSDK_OFFSET(0x10AEB6F0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_7F612AA2F04984D6_OFFSET UNITYSDK_OFFSET(0x10AEBD50)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_86914B28476494AF_1_OFFSET UNITYSDK_OFFSET(0x10AEA340)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_86914B28476494AF_OFFSET UNITYSDK_OFFSET(0x10AEA220)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_8C3EF9C039C5859D_OFFSET UNITYSDK_OFFSET(0x10AE7E80)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_96347D126BE5AFBC_OFFSET UNITYSDK_OFFSET(0x10AEB830)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_96DCADC783ACF0D4_OFFSET UNITYSDK_OFFSET(0x10AE9DC0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_9C66B07446448FC6_OFFSET UNITYSDK_OFFSET(0x10AE9150)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_A03C765EBC5D1677_OFFSET UNITYSDK_OFFSET(0x10AEB4E0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x10AEBC80)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_AF001DB8752C7089_OFFSET UNITYSDK_OFFSET(0x10AE92D0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_B2A8785E9E1BD2C1_OFFSET UNITYSDK_OFFSET(0x10AE8DA0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_B3895AA881B3EBB9_OFFSET UNITYSDK_OFFSET(0x10AE97B0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_B74D29C43104A205_OFFSET UNITYSDK_OFFSET(0x10AE8AF0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_B7592B2BDF345A00_OFFSET UNITYSDK_OFFSET(0x10AE95F0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_BA904CAFF6C7217F_OFFSET UNITYSDK_OFFSET(0x10AE8270)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_BC46FCF99873D9DD_OFFSET UNITYSDK_OFFSET(0x10AE8440)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_C411E5881DF297DE_OFFSET UNITYSDK_OFFSET(0x10AE8C90)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_C7D881C292ED8D3D_OFFSET UNITYSDK_OFFSET(0x10AEA460)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_C98BEB16ED641BC0_1_OFFSET UNITYSDK_OFFSET(0x10AE8ED0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_C98BEB16ED641BC0_OFFSET UNITYSDK_OFFSET(0x10AE8E50)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x10AE9580)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CA6BDDCC5F7CE11E_1_OFFSET UNITYSDK_OFFSET(0x10AE9C70)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0x10AE9BA0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CAAD3899EE103AC7_OFFSET UNITYSDK_OFFSET(0x10AE6FC0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CB613A5EF970C11B_OFFSET UNITYSDK_OFFSET(0x10AE8480)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CBDC22058B67F0FE_OFFSET UNITYSDK_OFFSET(0x10AE84E0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CF0080D9D0A33EA9_1_OFFSET UNITYSDK_OFFSET(0x10AE9D30)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CF0080D9D0A33EA9_OFFSET UNITYSDK_OFFSET(0x10AE9830)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_D64FD9A228A1C4E0_OFFSET UNITYSDK_OFFSET(0x10AEB250)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_D87A7D8243E04FD7_OFFSET UNITYSDK_OFFSET(0x10AE7C20)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_D920CA000FAB6C31_OFFSET UNITYSDK_OFFSET(0x10AEA000)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_DDF4E6AEE2216B17_OFFSET UNITYSDK_OFFSET(0x10AE94C0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_E7E9C69965F5C461_OFFSET UNITYSDK_OFFSET(0x10AE9390)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_E7F61176CF07E702_OFFSET UNITYSDK_OFFSET(0x10AE8D30)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_F28136982D1084AB_OFFSET UNITYSDK_OFFSET(0x10AE9B00)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_FD7514C64FB1B043_OFFSET UNITYSDK_OFFSET(0x10AE8630)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_FF7B2911BBACA4A9_1_OFFSET UNITYSDK_OFFSET(0x10AE9CE0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x10AE9C10)
#define CLASS_1_CDAD1C4D78702C93_SET_AXISVALUEXCHANGESPEED_OFFSET UNITYSDK_OFFSET(0x10AEBD20)
#define CLASS_1_CDAD1C4D78702C93_SET_CAMERATYPE_OFFSET UNITYSDK_OFFSET(0x10AEBB90)
#define CLASS_1_CDAD1C4D78702C93_SET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x10AEBC50)
#define CLASS_1_CDAD1C4D78702C93_SET_FREELOOKDRAGMODE_OFFSET UNITYSDK_OFFSET(0x10AEBD40)
#define CLASS_1_CDAD1C4D78702C93_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x10AEBBF0)
#define CLASS_1_CDAD1C4D78702C93_SET_ISAVAILABLEFORREUSE_OFFSET UNITYSDK_OFFSET(0x10AEBC30)
#define CLASS_1_CDAD1C4D78702C93_SET_ISCREATED_OFFSET UNITYSDK_OFFSET(0x10AEBBD0)
#define CLASS_1_CDAD1C4D78702C93_SET_ISDESTROYED_OFFSET UNITYSDK_OFFSET(0x10AEBC10)
#define CLASS_1_CDAD1C4D78702C93_SET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x10AEBC70)
#define CLASS_1_CDAD1C4D78702C93_SET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0x10AEBBB0)
#define CLASS_1_CDAD1C4D78702C93__CTOR_OFFSET UNITYSDK_OFFSET(0x10AE6FA0)

inline static constexpr unsigned int Class_1_CDAD1C4D78702C93_TypeDefinitionIndex = 57038;

class Class_1_CDAD1C4D78702C93 : public ::System::Object
{
public:
	::UnityEngine::Transform* _FollowTarget_k__BackingField; // 0x10
	::Class_1_7ACD8E31992CDE1A_1* Field_1_24; // 0x18
	::UnityEngine::GameObject* Field_1_12; // 0x20
	::UnityEngine::GameObject* Field_1_10; // 0x28
	::RPG::Client::RPGCinemachineZoom* Field_1_19; // 0x30
	::UnityEngine::Transform* _LookAtTarget_k__BackingField; // 0x38
	::RPG::Client::CameraBlendCurve* Field_1_16; // 0x40
	::Cinemachine::CinemachineFreeLook* Field_1_11; // 0x48
	::RPG::Client::RPGCinemachineOldFreelook3rdBlend* Field_1_20; // 0x50
	::System::Int32 Field_1_25; // 0x58
	::System::Single Field_1_15; // 0x5C
	::System::Single Field_1_17; // 0x60
	::System::UInt32 _RuntimeID_k__BackingField; // 0x64
	::System::Boolean _FreelookDragMode_k__BackingField; // 0x68
	::System::Boolean _IsActive_k__BackingField; // 0x69
	::System::Boolean _IsCreated_k__BackingField; // 0x6A
	::System::Boolean Field_1_22; // 0x6B
	::System::Boolean _IsAvailableForReuse_k__BackingField; // 0x6C
	::System::Boolean _IsDestroyed_k__BackingField; // 0x6D
	::System::Boolean Field_1_21; // 0x6E
	::System::Nullable_1<::UnityEngine::Vector2> Field_1_13; // 0x70
	::System::Single Field_1_18; // 0x7C
	::System::Single _AxisValueXChangeSpeed_k__BackingField; // 0x80
	::Class_1_CD9533418F3B6F39_VCameraType _CameraType_k__BackingField; // 0x84
	::System::Single Field_1_23; // 0x88
	::System::Nullable_1<::UnityEngine::Vector2> Field_1_14; // 0x8C
