...
#define CLASS_1_CDAD1C4D78702C93_GET_AXISVALUEXCHANGESPEED_OFFSET UNITYSDK_OFFSET(0x16FBC4B0)
#define CLASS_1_CDAD1C4D78702C93_GET_CAMERATYPE_OFFSET UNITYSDK_OFFSET(0x16FBC310)
#define CLASS_1_CDAD1C4D78702C93_GET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x16FBC3D0)
#define CLASS_1_CDAD1C4D78702C93_GET_FREELOOKDRAGMODE_OFFSET UNITYSDK_OFFSET(0x16FBC4D0)
#define CLASS_1_CDAD1C4D78702C93_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x16FBC370)
#define CLASS_1_CDAD1C4D78702C93_GET_ISAVAILABLEFORREUSE_OFFSET UNITYSDK_OFFSET(0x16FBC3B0)
#define CLASS_1_CDAD1C4D78702C93_GET_ISCREATED_OFFSET UNITYSDK_OFFSET(0x16FBC350)
#define CLASS_1_CDAD1C4D78702C93_GET_ISDESTROYED_OFFSET UNITYSDK_OFFSET(0x16FBC390)
#define CLASS_1_CDAD1C4D78702C93_GET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x16FBC3F0)
#define CLASS_1_CDAD1C4D78702C93_GET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0x16FBC330)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_03E2B9212B4B6EAF_1_OFFSET UNITYSDK_OFFSET(0x16FB8C90)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_03E2B9212B4B6EAF_OFFSET UNITYSDK_OFFSET(0x16FB8C50)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_043B534750B9E7A6_OFFSET UNITYSDK_OFFSET(0x16FBB8B0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_07A25883744F618C_OFFSET UNITYSDK_OFFSET(0x16FB9D20)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_1658BEB5EC339408_OFFSET UNITYSDK_OFFSET(0x16FBADA0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0x16FBB580)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_19CCC07C980409E4_1_OFFSET UNITYSDK_OFFSET(0x16FB7FF0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x16FB7F90)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_1D4018D4200358D0_1_OFFSET UNITYSDK_OFFSET(0x16FB9BB0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x16FB9B50)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x16FBC500)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_2ED6C3773AA1E488_OFFSET UNITYSDK_OFFSET(0x16FBB790)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x16FBC460)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_3A9C03366E936C66_OFFSET UNITYSDK_OFFSET(0x16FBAF00)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_3F5F0BE9AFB2990C_OFFSET UNITYSDK_OFFSET(0x16FB90E0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x16FB8850)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_460F8AE6EF9687FD_OFFSET UNITYSDK_OFFSET(0x16FBBEE0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_46D5C4F0EA172C6A_OFFSET UNITYSDK_OFFSET(0x16FB99F0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_48D5431F83972562_OFFSET UNITYSDK_OFFSET(0x16FB9F80)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_4E66CC6A96439F85_OFFSET UNITYSDK_OFFSET(0x16FB9510)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_5D895A5456A4B9BA_OFFSET UNITYSDK_OFFSET(0x16FB9AD0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_60A0F5EC9777EFB9_OFFSET UNITYSDK_OFFSET(0x16FB8780)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_1_OFFSET UNITYSDK_OFFSET(0x16FB8D60)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_2_OFFSET UNITYSDK_OFFSET(0x16FB8E40)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_3_OFFSET UNITYSDK_OFFSET(0x16FB8ED0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_4_OFFSET UNITYSDK_OFFSET(0x16FB9580)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_5_OFFSET UNITYSDK_OFFSET(0x16FBBC60)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_OFFSET UNITYSDK_OFFSET(0x16FB8CD0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_684E8D76BF9D5255_OFFSET UNITYSDK_OFFSET(0x16FBB870)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_7301533EE4FBBAD2_OFFSET UNITYSDK_OFFSET(0x16FB9420)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_7F612AA2F04984D6_OFFSET UNITYSDK_OFFSET(0x16FBC4F0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_7F84ACCEA43BC283_OFFSET UNITYSDK_OFFSET(0x16FBA930)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_81D7D1157E92B61D_OFFSET UNITYSDK_OFFSET(0x16FBB950)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_861970C5F2C21AB2_OFFSET UNITYSDK_OFFSET(0x16FBB700)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_86914B28476494AF_OFFSET UNITYSDK_OFFSET(0x16FBA6D0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_96347D126BE5AFBC_OFFSET UNITYSDK_OFFSET(0x16FBBFE0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x16FBBBD0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_96DCADC783ACF0D4_OFFSET UNITYSDK_OFFSET(0x16FBA260)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_9C66B07446448FC6_OFFSET UNITYSDK_OFFSET(0x16FB9610)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_A03C765EBC5D1677_OFFSET UNITYSDK_OFFSET(0x16FBBD10)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x16FBC410)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_AF001DB8752C7089_OFFSET UNITYSDK_OFFSET(0x16FB9790)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_AF769CD15806BD66_OFFSET UNITYSDK_OFFSET(0x16FBBDA0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_B0C9E67798485BC6_OFFSET UNITYSDK_OFFSET(0x16FBA7F0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x16FBBB50)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_B2A8785E9E1BD2C1_OFFSET UNITYSDK_OFFSET(0x16FB9270)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_B3895AA881B3EBB9_OFFSET UNITYSDK_OFFSET(0x16FB9C10)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_B7D0EA531AB98E94_OFFSET UNITYSDK_OFFSET(0x16FB82C0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_BA904CAFF6C7217F_OFFSET UNITYSDK_OFFSET(0x16FB86E0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_BC46FCF99873D9DD_OFFSET UNITYSDK_OFFSET(0x16FB88B0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_C411E5881DF297DE_OFFSET UNITYSDK_OFFSET(0x16FB9160)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_C98BEB16ED641BC0_1_OFFSET UNITYSDK_OFFSET(0x16FB93A0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_C98BEB16ED641BC0_OFFSET UNITYSDK_OFFSET(0x16FB9320)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x16FBB910)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x16FB9A60)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CA6BDDCC5F7CE11E_1_OFFSET UNITYSDK_OFFSET(0x16FBA110)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0x16FBA040)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CAAD3899EE103AC7_OFFSET UNITYSDK_OFFSET(0x16FB7460)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CB613A5EF970C11B_OFFSET UNITYSDK_OFFSET(0x16FB88F0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CD8EB704BDED69B6_OFFSET UNITYSDK_OFFSET(0x16FB8960)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CF0080D9D0A33EA9_1_OFFSET UNITYSDK_OFFSET(0x16FBA1D0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CF0080D9D0A33EA9_OFFSET UNITYSDK_OFFSET(0x16FB9C90)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_D87A7D8243E04FD7_OFFSET UNITYSDK_OFFSET(0x16FB8050)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_D920CA000FAB6C31_OFFSET UNITYSDK_OFFSET(0x16FBA490)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_DDF4E6AEE2216B17_OFFSET UNITYSDK_OFFSET(0x16FB9990)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_E559D5212FA999BC_OFFSET UNITYSDK_OFFSET(0x16FB8FB0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_E7E9C69965F5C461_OFFSET UNITYSDK_OFFSET(0x16FB9850)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_E7F61176CF07E702_OFFSET UNITYSDK_OFFSET(0x16FB9200)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_FD7514C64FB1B043_OFFSET UNITYSDK_OFFSET(0x16FB8B00)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_FF7B2911BBACA4A9_1_OFFSET UNITYSDK_OFFSET(0x16FBA180)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x16FBA0B0)
#define CLASS_1_CDAD1C4D78702C93_SET_AXISVALUEXCHANGESPEED_OFFSET UNITYSDK_OFFSET(0x16FBC4C0)
#define CLASS_1_CDAD1C4D78702C93_SET_CAMERATYPE_OFFSET UNITYSDK_OFFSET(0x16FBC320)
#define CLASS_1_CDAD1C4D78702C93_SET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x16FBC3E0)
#define CLASS_1_CDAD1C4D78702C93_SET_FREELOOKDRAGMODE_OFFSET UNITYSDK_OFFSET(0x16FBC4E0)
#define CLASS_1_CDAD1C4D78702C93_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x16FBC380)
#define CLASS_1_CDAD1C4D78702C93_SET_ISAVAILABLEFORREUSE_OFFSET UNITYSDK_OFFSET(0x16FBC3C0)
#define CLASS_1_CDAD1C4D78702C93_SET_ISCREATED_OFFSET UNITYSDK_OFFSET(0x16FBC360)
#define CLASS_1_CDAD1C4D78702C93_SET_ISDESTROYED_OFFSET UNITYSDK_OFFSET(0x16FBC3A0)
#define CLASS_1_CDAD1C4D78702C93_SET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x16FBC400)
#define CLASS_1_CDAD1C4D78702C93_SET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0x16FBC340)
#define CLASS_1_CDAD1C4D78702C93__CTOR_OFFSET UNITYSDK_OFFSET(0x16FB7450)

inline static constexpr unsigned int Class_1_CDAD1C4D78702C93_TypeDefinitionIndex = 66619;

class Class_1_CDAD1C4D78702C93 : public ::System::Object
{
public:
	::UnityEngine::GameObject* Field_1_0; // 0x10
	::RPG::Client::RPGCinemachineCorrectionExtension* Field_1_1; // 0x18
	::Cinemachine::CinemachineFreeLook* Field_1_2; // 0x20
	::UnityEngine::Transform* _LookAtTarget_k__BackingField; // 0x28
	::Class_1_7ACD8E31992CDE1A* Field_1_4; // 0x30
	::UnityEngine::GameObject* Field_1_5; // 0x38
	::RPG::Client::CameraBlendCurve* Field_1_6; // 0x40
	::RPG::Client::RPGCinemachineOldFreelook3rdBlend* Field_1_7; // 0x48
	::RPG::Client::RPGCinemachineZoom* Field_1_8; // 0x50
	::UnityEngine::Transform* _FollowTarget_k__BackingField; // 0x58
	::System::Single _AxisValueXChangeSpeed_k__BackingField; // 0x60
	...
	::System::Nullable_1<::UnityEngine::Vector2> Field_1_15; // 0x74
	::System::Nullable_1<::UnityEngine::Vector2> Field_1_16; // 0x80
	::System::Single Field_1_17; // 0x8C
	::System::Single Field_1_18; // 0x90
	::System::Boolean _IsAvailableForReuse_k__BackingField; // 0x94
	::System::Boolean Field_1_20; // 0x95
	::System::Boolean _IsActive_k__BackingField; // 0x96
	::System::Boolean _IsCreated_k__BackingField; // 0x97
	::System::Boolean Field_1_23; // 0x98
	::System::Boolean _FreelookDragMode_k__BackingField; // 0x99
	::System::Boolean _IsDestroyed_k__BackingField; // 0x9A
	::System::Single Field_1_26; // 0x9C
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Boolean))((::PBYTE)hIl2Cpp + CLASS_1_CDAD1C4D78702C93_METHOD_1_AF769CD15806BD66_OFFSET))(this, a1);
	}
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_CDAD1C4D78702C93_METHOD_1_18982EFD3B740683_OFFSET))(this);
	}
};
