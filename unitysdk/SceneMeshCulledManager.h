...
#define SCENEMESHCULLEDMANAGER_BAKEAABB_OFFSET UNITYSDK_OFFSET(0x150A42C0)
#define SCENEMESHCULLEDMANAGER_DISTANCE_OFFSET UNITYSDK_OFFSET(0x150A4D70)
#define SCENEMESHCULLEDMANAGER_GETCAMERAPOS_OFFSET UNITYSDK_OFFSET(0x150A4840)
#define SCENEMESHCULLEDMANAGER_INVISBLEMESH_OFFSET UNITYSDK_OFFSET(0x150A4B30)
#define SCENEMESHCULLEDMANAGER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x150A4270)
#define SCENEMESHCULLEDMANAGER_SHOWALL_OFFSET UNITYSDK_OFFSET(0x150A4430)
#define SCENEMESHCULLEDMANAGER_START_OFFSET UNITYSDK_OFFSET(0x150A4530)
#define SCENEMESHCULLEDMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x150A4570)
#define SCENEMESHCULLEDMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x150A4E20)

inline static constexpr unsigned int SceneMeshCulledManager_TypeDefinitionIndex = 40084;
