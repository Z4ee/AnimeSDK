...
#define SCENEMESHCULLEDMANAGER_BAKEAABB_OFFSET UNITYSDK_OFFSET(0x1BC3E900)
#define SCENEMESHCULLEDMANAGER_DISTANCE_OFFSET UNITYSDK_OFFSET(0x1BC3F3B0)
#define SCENEMESHCULLEDMANAGER_GETCAMERAPOS_OFFSET UNITYSDK_OFFSET(0x1BC3EE80)
#define SCENEMESHCULLEDMANAGER_INVISBLEMESH_OFFSET UNITYSDK_OFFSET(0x1BC3F170)
#define SCENEMESHCULLEDMANAGER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1BC3E8B0)
#define SCENEMESHCULLEDMANAGER_SHOWALL_OFFSET UNITYSDK_OFFSET(0x1BC3EA70)
#define SCENEMESHCULLEDMANAGER_START_OFFSET UNITYSDK_OFFSET(0x1BC3EB70)
#define SCENEMESHCULLEDMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1BC3EBB0)
#define SCENEMESHCULLEDMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC3F460)

inline static constexpr unsigned int SceneMeshCulledManager_TypeDefinitionIndex = 52118;
