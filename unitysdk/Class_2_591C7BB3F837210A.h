...
#define CLASS_2_591C7BB3F837210A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x195C3530)
#define CLASS_2_591C7BB3F837210A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x195C3570)
#define CLASS_2_591C7BB3F837210A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x195C36C0)
#define CLASS_2_591C7BB3F837210A_TICK_OFFSET UNITYSDK_OFFSET(0x195C3710)
#define CLASS_2_591C7BB3F837210A__CTOR_OFFSET UNITYSDK_OFFSET(0x195C3520)
...
public:
	...
	::RPG::GameCore::FrameCaptureIfNeed* OFKGLJOAMLD; // 0x20
