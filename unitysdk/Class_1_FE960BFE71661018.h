...
#define CLASS_1_FE960BFE71661018_CLEAR_OFFSET UNITYSDK_OFFSET(0x15B9CAB0)
#define CLASS_1_FE960BFE71661018_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x15B9CBB0)
#define CLASS_1_FE960BFE71661018_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x15B9CBD0)
#define CLASS_1_FE960BFE71661018_METHOD_1_A538D7DBA7BF5017_OFFSET UNITYSDK_OFFSET(0x15B9CB00)
#define CLASS_1_FE960BFE71661018_METHOD_1_F3B68CBB8AE22AB6_OFFSET UNITYSDK_OFFSET(0x15B9CA30)
#define CLASS_1_FE960BFE71661018_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x15B9CBC0)
#define CLASS_1_FE960BFE71661018_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x15B9CBE0)
#define CLASS_1_FE960BFE71661018__CTOR_OFFSET UNITYSDK_OFFSET(0x15B9CBF0)

inline static constexpr unsigned int Class_1_FE960BFE71661018_TypeDefinitionIndex = 57066;

class Class_1_FE960BFE71661018 : public ::System::Object
{
public:
	// static const ::System::String* MOEMFMBKGBA; // 0x0
	::RPG::GameCore::SpecialBpFeature* _Config_k__BackingField; // 0x10
	::System::Boolean IDBEBIDMHME; // 0x18
