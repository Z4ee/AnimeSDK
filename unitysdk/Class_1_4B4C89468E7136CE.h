...
#define CLASS_1_4B4C89468E7136CE_METHOD_1_10FF31F13E8F73BF_OFFSET UNITYSDK_OFFSET(0xB716240)
#define CLASS_1_4B4C89468E7136CE_METHOD_1_775B6D644F07B554_OFFSET UNITYSDK_OFFSET(0xB7163D0)
#define CLASS_1_4B4C89468E7136CE_METHOD_1_941C404C800CB723_OFFSET UNITYSDK_OFFSET(0xB716330)
#define CLASS_1_4B4C89468E7136CE_METHOD_1_C57E9CD0DC8E4C5D_OFFSET UNITYSDK_OFFSET(0xB716050)
#define CLASS_1_4B4C89468E7136CE_METHOD_1_F6B167DD454A8D8F_OFFSET UNITYSDK_OFFSET(0xB716430)
#define CLASS_1_4B4C89468E7136CE_METHOD_1_FE6DE99A2BFC2737_OFFSET UNITYSDK_OFFSET(0xB7161B0)
#define CLASS_1_4B4C89468E7136CE__CTOR_OFFSET UNITYSDK_OFFSET(0xB716140)

inline static constexpr unsigned int Class_1_4B4C89468E7136CE_TypeDefinitionIndex = 71204;

class Class_1_4B4C89468E7136CE : public ::System::Object
{
public:
	::System::String* DEKOLFNNKCJ; // 0x10
	::System::String* FHDKIHEPAHF; // 0x18
	::System::String* NMHICHPNEHN; // 0x20
	::UnityEngine::Animation* PMOJILOJEPE; // 0x28
	::System::String* OAKFDGDMHKE; // 0x30
	::System::String* KDODNCFEJFD; // 0x38
	::System::String* DIDHOFMKIFH; // 0x40
	::System::String* LHANMKCMPCA; // 0x48
