...
#define MONOUIHIDEITEM_AWAKE_OFFSET UNITYSDK_OFFSET(0xC93D320)
#define MONOUIHIDEITEM_CLEARRUNTIMEFADECONFIG_OFFSET UNITYSDK_OFFSET(0xC940000)
#define MONOUIHIDEITEM_GETALPHA_OFFSET UNITYSDK_OFFSET(0xC93F270)
#define MONOUIHIDEITEM_GETANIMCLIPLENGTH_OFFSET UNITYSDK_OFFSET(0xC93F510)
#define MONOUIHIDEITEM_GETSETUPINFO_OFFSET UNITYSDK_OFFSET(0xC93D0F0)
#define MONOUIHIDEITEM_GET_ACTIONSETUPINFOS_OFFSET UNITYSDK_OFFSET(0xC93D0B0)
#define MONOUIHIDEITEM_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0xC93D0D0)
#define MONOUIHIDEITEM_GET_REALTAG_OFFSET UNITYSDK_OFFSET(0xC93CE20)
#define MONOUIHIDEITEM_GET_RUNTIMEFADECONFIGS_OFFSET UNITYSDK_OFFSET(0xC93D000)
#define MONOUIHIDEITEM_GET_ZONESETUPINFOS_OFFSET UNITYSDK_OFFSET(0xC93D0C0)
#define MONOUIHIDEITEM_INTERRUPTSETUP_OFFSET UNITYSDK_OFFSET(0xC93EE10)
#define MONOUIHIDEITEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC93DF10)
#define MONOUIHIDEITEM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC93DEC0)
#define MONOUIHIDEITEM_ONPARENTSHOWSTATECHANGED_OFFSET UNITYSDK_OFFSET(0xC93EF80)
#define MONOUIHIDEITEM_REFRESHITEM_OFFSET UNITYSDK_OFFSET(0xC93E310)
#define MONOUIHIDEITEM_RESETITEM_OFFSET UNITYSDK_OFFSET(0xC93F400)
#define MONOUIHIDEITEM_SAMPLEANIMLASTFRAME_OFFSET UNITYSDK_OFFSET(0xC93FDF0)
#define MONOUIHIDEITEM_SETALPHA_OFFSET UNITYSDK_OFFSET(0xC93F960)
#define MONOUIHIDEITEM_SETBLOCKRAYCASTSSTATE_OFFSET UNITYSDK_OFFSET(0xC93FFB0)
#define MONOUIHIDEITEM_SETUPUI_1_OFFSET UNITYSDK_OFFSET(0xC93E000)
#define MONOUIHIDEITEM_SETUPUI_OFFSET UNITYSDK_OFFSET(0xC93DF70)
#define MONOUIHIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC940320)
#define MONOUIHIDEITEM__GETCURRENTPLAYINGANIM_OFFSET UNITYSDK_OFFSET(0xC93FC50)
#define MONOUIHIDEITEM__GETTARGETANIMATIONCLIPNAME_OFFSET UNITYSDK_OFFSET(0xC93F700)
#define MONOUIHIDEITEM__PLAYANIMATIONWITHDELAYCONFIRM_OFFSET UNITYSDK_OFFSET(0xC93FB10)
#define MONOUIHIDEITEM__RESETFADECONFIGS_OFFSET UNITYSDK_OFFSET(0xC93CEA0)
#define MONOUIHIDEITEM__SETTOANIMATIONLASTFRAME_OFFSET UNITYSDK_OFFSET(0xC9401C0)
#define MONOUIHIDEITEM__STOPCURRENTPLAYINGANIMATIONDELAY_OFFSET UNITYSDK_OFFSET(0xC940260)
#define MONOUIHIDEITEM___PLAYANIMATIONWITHDELAYCONFIRM_B__54_0_OFFSET UNITYSDK_OFFSET(0xC940400)

inline static constexpr unsigned int MonoUIHideItem_TypeDefinitionIndex = 71121;
