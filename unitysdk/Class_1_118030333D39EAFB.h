...
#define CLASS_1_118030333D39EAFB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1624F440)
#define CLASS_1_118030333D39EAFB_GET_OPERATIONLIST_OFFSET UNITYSDK_OFFSET(0x16252AB0)
#define CLASS_1_118030333D39EAFB_GET_SNAPSHOTHASHLIST_OFFSET UNITYSDK_OFFSET(0x16252AF0)
#define CLASS_1_118030333D39EAFB_GET_SNAPSHOTLIST_OFFSET UNITYSDK_OFFSET(0x16252AD0)
#define CLASS_1_118030333D39EAFB_METHOD_1_19C3311A7A653DD7_OFFSET UNITYSDK_OFFSET(0x1624FD80)
#define CLASS_1_118030333D39EAFB_METHOD_1_4D8FE774C4E32126_OFFSET UNITYSDK_OFFSET(0x1624FCC0)
#define CLASS_1_118030333D39EAFB_METHOD_1_58F8ABBE1AFB3135_OFFSET UNITYSDK_OFFSET(0x1624F4F0)
#define CLASS_1_118030333D39EAFB_METHOD_1_63CC7F472044A608_OFFSET UNITYSDK_OFFSET(0x1624F8D0)
#define CLASS_1_118030333D39EAFB_METHOD_1_775B6D644F07B554_OFFSET UNITYSDK_OFFSET(0x162500C0)
#define CLASS_1_118030333D39EAFB_METHOD_1_85501DF13201FEC7_OFFSET UNITYSDK_OFFSET(0x16250490)
#define CLASS_1_118030333D39EAFB_METHOD_1_87F5F69C9D6AE6DF_OFFSET UNITYSDK_OFFSET(0x162501D0)
#define CLASS_1_118030333D39EAFB_METHOD_1_8EB27D281ACA7277_OFFSET UNITYSDK_OFFSET(0x16252970)
#define CLASS_1_118030333D39EAFB_METHOD_1_A408B25A0F96FFA9_OFFSET UNITYSDK_OFFSET(0x16252890)
#define CLASS_1_118030333D39EAFB_METHOD_1_BE18C04CD91E0748_OFFSET UNITYSDK_OFFSET(0x1624F490)
#define CLASS_1_118030333D39EAFB_METHOD_1_C2850027A5C7FEFD_OFFSET UNITYSDK_OFFSET(0x16252680)
#define CLASS_1_118030333D39EAFB_METHOD_1_DF36652FF6AEAAC1_OFFSET UNITYSDK_OFFSET(0x1624F360)
#define CLASS_1_118030333D39EAFB_METHOD_1_EBF44BC910948FDA_OFFSET UNITYSDK_OFFSET(0x16250110)
#define CLASS_1_118030333D39EAFB_METHOD_1_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0x1624FC80)
#define CLASS_1_118030333D39EAFB_SET_OPERATIONLIST_OFFSET UNITYSDK_OFFSET(0x16252AC0)
#define CLASS_1_118030333D39EAFB_SET_SNAPSHOTHASHLIST_OFFSET UNITYSDK_OFFSET(0x16252B00)
#define CLASS_1_118030333D39EAFB_SET_SNAPSHOTLIST_OFFSET UNITYSDK_OFFSET(0x16252AE0)
#define CLASS_1_118030333D39EAFB__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1624DCF0)
#define CLASS_1_118030333D39EAFB__CTOR_OFFSET UNITYSDK_OFFSET(0x1624DC30)
...
public:
	...
	::Class_1_DF769287778AC293* ENFNBBJHLEM; // 0x10
	::System::Collections::Generic::List_1<::Struct_2_B87448D5E720C3DE>* _OperationList_k__BackingField; // 0x18
	::System::Collections::Generic::List_1<::System::UInt32>* _SnapshotHashList_k__BackingField; // 0x20
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_242BFB9DE152D766*>* AAFJGBFJFHE; // 0x28
	::Il2CppArray<::Class_1_DF769287778AC293*>* _SnapshotList_k__BackingField; // 0x30
	::RPG::GameCore::BattleLineupData* PCIGECMCAJM; // 0x38
	::System::UInt32 ABNPHONMCEP; // 0x40
	::System::UInt32 BIIEFLDLGLL; // 0x44
	::System::UInt32 FIMNPJLNLEE; // 0x48
	::System::UInt32 BBFPALEAHAE; // 0x4C
	::System::UInt32 NJIOMOHBILM; // 0x50
	::System::Int32 PMIPHKEANNP; // 0x54
	::System::Int32 PFIPKLJOPLJ; // 0x58
	::System::UInt32 CFOIPGKACMJ; // 0x5C
	::System::UInt32 HNEIIAGADGO; // 0x60
	::System::Boolean IIHAKBBPLEK; // 0x64
	::System::Boolean NIMOCMOJGGJ; // 0x65
	::System::Boolean DEBAOCJBBNB; // 0x66
	::System::Boolean LJPCGDPEGFO; // 0x67
	::System::UInt32 DPDNOGAGALP; // 0x68
	::System::UInt32 BIDGBCELLJK; // 0x6C
	::System::UInt32 FFLDMJCEMDC; // 0x70
