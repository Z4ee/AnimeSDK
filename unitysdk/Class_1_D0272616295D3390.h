...
#define CLASS_1_D0272616295D3390__CTOR_OFFSET UNITYSDK_OFFSET(0x172A2A60)
...
{
public:
	::RPG::GameCore::TargetEvaluator* HILNFHCPEAD; // 0x10
	::System::String* LBFLPOJHJIG; // 0x18
	::RPG::GameCore::GameEntity* MCLLALGABAB; // 0x20
	::RPG::GameCore::TaskContext* BKIFMPHBIAK; // 0x28
	::System::Boolean BPCINCEKHLN; // 0x30
