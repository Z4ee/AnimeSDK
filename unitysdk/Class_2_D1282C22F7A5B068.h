...
#define CLASS_2_D1282C22F7A5B068_METHOD_2_78C5AA85812E15F5_OFFSET UNITYSDK_OFFSET(0x1306BAD0)
#define CLASS_2_D1282C22F7A5B068_METHOD_2_7B352AB79EC4AAF7_OFFSET UNITYSDK_OFFSET(0x1306BD10)
#define CLASS_2_D1282C22F7A5B068_METHOD_2_9FA85F81BF5EE3CA_OFFSET UNITYSDK_OFFSET(0x1306BEF0)
#define CLASS_2_D1282C22F7A5B068_METHOD_2_C8903A36ECBA4078_OFFSET UNITYSDK_OFFSET(0x1306BFA0)
#define CLASS_2_D1282C22F7A5B068__CTOR_OFFSET UNITYSDK_OFFSET(0x1306BF90)

inline static constexpr unsigned int Class_2_D1282C22F7A5B068_TypeDefinitionIndex = 46539;
...
public:
	...
	::System::Collections::Generic::List_1<::Class_3_6630F8877346891C<::MoleMole::UICommonRewardItemWidgetController*>*>* Field_2_5; // 0x30
	::UnityEngine::RectTransform* Field_2_4; // 0x38
	::MoleMole::MonoGamepadSelectable* Field_2_8; // 0x40
	::Class_2_B4378B46E0020E85* Field_2_0; // 0x48
	::System::Collections::Generic::List_1<::Class_3_6630F8877346891C<::MoleMole::UICommonRewardItemWidgetController*>*>* Field_2_6; // 0x50
	...
	{
		return ((::System::Collections::Generic::List_1<::Class_3_6630F8877346891C<::MoleMole::UICommonRewardItemWidgetController*>*>*(*)(::PVOID, ::Class_2_A9A857AD270B9CE1*, ::MoleMole::UIControlCollection*))((::PBYTE)hIl2Cpp + CLASS_2_D1282C22F7A5B068_METHOD_2_7B352AB79EC4AAF7_OFFSET))(this, a1, a2);
	}
};
