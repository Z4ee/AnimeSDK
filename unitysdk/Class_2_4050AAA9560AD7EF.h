...
#define CLASS_2_4050AAA9560AD7EF_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17A07D40)
#define CLASS_2_4050AAA9560AD7EF_METHOD_2_5B9761C1A72C4D1A_OFFSET UNITYSDK_OFFSET(0x17A08340)
#define CLASS_2_4050AAA9560AD7EF_METHOD_2_92FA3247236CD875_OFFSET UNITYSDK_OFFSET(0x17A08470)
#define CLASS_2_4050AAA9560AD7EF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17A07D80)
#define CLASS_2_4050AAA9560AD7EF_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17A083C0)
#define CLASS_2_4050AAA9560AD7EF_TICK_OFFSET UNITYSDK_OFFSET(0x17A08410)
#define CLASS_2_4050AAA9560AD7EF__CTOR_OFFSET UNITYSDK_OFFSET(0x17A07D30)

inline static constexpr unsigned int Class_2_4050AAA9560AD7EF_TypeDefinitionIndex = 56115;

class Class_2_4050AAA9560AD7EF : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::SwitchCharacterAnchor* Field_2_1; // 0x20
