...
#define CLASS_2_165BFDC2F8A1D890_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB716AD0)
#define CLASS_2_165BFDC2F8A1D890_METHOD_2_45AA2F5085C2C40D_OFFSET UNITYSDK_OFFSET(0xB716860)
#define CLASS_2_165BFDC2F8A1D890_METHOD_2_E21AC6EE08DC160A_OFFSET UNITYSDK_OFFSET(0xB716C00)
#define CLASS_2_165BFDC2F8A1D890_METHOD_2_F68F6F2F168E0D7D_OFFSET UNITYSDK_OFFSET(0xB716C90)
#define CLASS_2_165BFDC2F8A1D890__CTOR_OFFSET UNITYSDK_OFFSET(0xB716D60)
...
{
public:
	::RPG::Client::MonoMapPoseSwitcher* KEMBAIBGFPD; // 0x18
	::RPG::GameCore::CharacterVisibleComponent* PLDFJEONENF; // 0x20
	::Class_1_64D890C466F37235* FGNBCPELJEO; // 0x28
