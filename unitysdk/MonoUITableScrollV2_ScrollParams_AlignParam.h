...
#define MONOUITABLESCROLLV2_SCROLLPARAMS_ALIGNPARAM_TOSTRING_OFFSET UNITYSDK_OFFSET(0x15B27BB0)
#define MONOUITABLESCROLLV2_SCROLLPARAMS_ALIGNPARAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x15B0D820)
#define MONOUITABLESCROLLV2_SCROLLPARAMS_ALIGNPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x15B27BA0)
#define MONOUITABLESCROLLV2_SCROLLPARAMS_ALIGNPARAM___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x15B27D20)

inline static constexpr unsigned int MonoUITableScrollV2_ScrollParams_AlignParam_TypeDefinitionIndex = 74999;
