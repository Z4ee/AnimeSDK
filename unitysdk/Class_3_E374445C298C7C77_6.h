...
#define CLASS_3_E374445C298C7C77_6_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18812A40)
#define CLASS_3_E374445C298C7C77_6_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x18812BB0)
#define CLASS_3_E374445C298C7C77_6__CTOR_OFFSET UNITYSDK_OFFSET(0x18812A10)

inline static constexpr unsigned int Class_3_E374445C298C7C77_6_TypeDefinitionIndex = 53865;
