...
#define STONEBRIDGECONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B5A8F20)
#define STONEBRIDGECONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B5A8BF0)
#define STONEBRIDGECONTROLLER_ONLOCALAVATARCHANGE_OFFSET UNITYSDK_OFFSET(0x1B5A9410)
#define STONEBRIDGECONTROLLER_SUBSCRIBEAVATARCHANGE_OFFSET UNITYSDK_OFFSET(0x1B5A9280)
#define STONEBRIDGECONTROLLER_UNSUBSCRIBEAVATARCHANGE_OFFSET UNITYSDK_OFFSET(0x1B5A90F0)
#define STONEBRIDGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B5A9550)
#define STONEBRIDGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5A9AC0)

inline static constexpr unsigned int StoneBridgeController_TypeDefinitionIndex = 75558;
