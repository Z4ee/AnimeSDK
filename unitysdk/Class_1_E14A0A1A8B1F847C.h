...
#define CLASS_1_E14A0A1A8B1F847C_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19B4A4F0)
#define CLASS_1_E14A0A1A8B1F847C_CLONE_OFFSET UNITYSDK_OFFSET(0x19B49BC0)
#define CLASS_1_E14A0A1A8B1F847C_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19B49D40)
#define CLASS_1_E14A0A1A8B1F847C_EQUALS_OFFSET UNITYSDK_OFFSET(0x19B49D10)
#define CLASS_1_E14A0A1A8B1F847C_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19B49F30)
#define CLASS_1_E14A0A1A8B1F847C_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19B4A9D0)
#define CLASS_1_E14A0A1A8B1F847C_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19B4A900)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x19B49C20)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_02A3D10A9D535169_2_OFFSET UNITYSDK_OFFSET(0x19B49CB0)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_02A3D10A9D535169_3_OFFSET UNITYSDK_OFFSET(0x19B49CD0)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_02A3D10A9D535169_4_OFFSET UNITYSDK_OFFSET(0x19B49CF0)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x19B49BF0)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_554199E0076172C5_1_OFFSET UNITYSDK_OFFSET(0x19B49C60)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x19B49C10)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19B499C0)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x19B49C30)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_7786DC814C2FC3BE_2_OFFSET UNITYSDK_OFFSET(0x19B49CC0)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_7786DC814C2FC3BE_3_OFFSET UNITYSDK_OFFSET(0x19B49CE0)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_7786DC814C2FC3BE_4_OFFSET UNITYSDK_OFFSET(0x19B49D00)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x19B49C00)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_8633AE51B23EBDFD_1_OFFSET UNITYSDK_OFFSET(0x19B49CA0)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_8633AE51B23EBDFD_OFFSET UNITYSDK_OFFSET(0x19B49C50)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_C114A1F8E08B6F92_OFFSET UNITYSDK_OFFSET(0x19B49C80)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_C229FF62B898C0B2_1_OFFSET UNITYSDK_OFFSET(0x19B49C90)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_C229FF62B898C0B2_OFFSET UNITYSDK_OFFSET(0x19B49C40)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x19B49C70)
#define CLASS_1_E14A0A1A8B1F847C_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19B499F0)
#define CLASS_1_E14A0A1A8B1F847C_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19B4A220)
#define CLASS_1_E14A0A1A8B1F847C_WRITETO_OFFSET UNITYSDK_OFFSET(0x19B4A280)
#define CLASS_1_E14A0A1A8B1F847C__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B4ABD0)
#define CLASS_1_E14A0A1A8B1F847C__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B49A90)
#define CLASS_1_E14A0A1A8B1F847C__CTOR_OFFSET UNITYSDK_OFFSET(0x19B49A00)

inline static constexpr unsigned int Class_1_E14A0A1A8B1F847C_TypeDefinitionIndex = 24209;
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E14A0A1A8B1F847C_TypeDefinitionIndex)->GetStaticField(0x5DD0);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_5()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E14A0A1A8B1F847C_TypeDefinitionIndex)->GetStaticField(0x5DD8);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_E14A0A1A8B1F847C*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_E14A0A1A8B1F847C*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E14A0A1A8B1F847C_TypeDefinitionIndex)->GetStaticField(0x5DE0);
	}
