...
#define CLASS_1_E14A0A1A8B1F847C_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C459780)
#define CLASS_1_E14A0A1A8B1F847C_CLONE_OFFSET UNITYSDK_OFFSET(0x1C458B90)
#define CLASS_1_E14A0A1A8B1F847C_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C458D10)
#define CLASS_1_E14A0A1A8B1F847C_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C458CE0)
#define CLASS_1_E14A0A1A8B1F847C_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C458F60)
#define CLASS_1_E14A0A1A8B1F847C_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C459C60)
#define CLASS_1_E14A0A1A8B1F847C_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C459B90)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1C458BF0)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_02A3D10A9D535169_2_OFFSET UNITYSDK_OFFSET(0x1C458C80)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_02A3D10A9D535169_3_OFFSET UNITYSDK_OFFSET(0x1C458CA0)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_02A3D10A9D535169_4_OFFSET UNITYSDK_OFFSET(0x1C458CC0)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1C458BC0)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_554199E0076172C5_1_OFFSET UNITYSDK_OFFSET(0x1C458C30)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1C458BE0)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C4589A0)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1C458C00)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_7786DC814C2FC3BE_2_OFFSET UNITYSDK_OFFSET(0x1C458C90)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_7786DC814C2FC3BE_3_OFFSET UNITYSDK_OFFSET(0x1C458CB0)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_7786DC814C2FC3BE_4_OFFSET UNITYSDK_OFFSET(0x1C458CD0)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1C458BD0)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_8633AE51B23EBDFD_1_OFFSET UNITYSDK_OFFSET(0x1C458C70)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_8633AE51B23EBDFD_OFFSET UNITYSDK_OFFSET(0x1C458C20)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_C114A1F8E08B6F92_OFFSET UNITYSDK_OFFSET(0x1C458C50)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_C229FF62B898C0B2_1_OFFSET UNITYSDK_OFFSET(0x1C458C60)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_C229FF62B898C0B2_OFFSET UNITYSDK_OFFSET(0x1C458C10)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x1C458C40)
#define CLASS_1_E14A0A1A8B1F847C_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C4589D0)
#define CLASS_1_E14A0A1A8B1F847C_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C459320)
#define CLASS_1_E14A0A1A8B1F847C_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C459380)
#define CLASS_1_E14A0A1A8B1F847C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C459E60)
#define CLASS_1_E14A0A1A8B1F847C__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C458A70)
#define CLASS_1_E14A0A1A8B1F847C__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4589E0)

inline static constexpr unsigned int Class_1_E14A0A1A8B1F847C_TypeDefinitionIndex = 24553;
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E14A0A1A8B1F847C_TypeDefinitionIndex)->GetStaticField(0x20E10);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E14A0A1A8B1F847C_TypeDefinitionIndex)->GetStaticField(0x20E18);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_E14A0A1A8B1F847C*>** StaticGet_Field_1_2()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_E14A0A1A8B1F847C*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E14A0A1A8B1F847C_TypeDefinitionIndex)->GetStaticField(0x20E20);
	}
