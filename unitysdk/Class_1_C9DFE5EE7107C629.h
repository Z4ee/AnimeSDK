...
#define CLASS_1_C9DFE5EE7107C629_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x196B81E0)
#define CLASS_1_C9DFE5EE7107C629_CLONE_OFFSET UNITYSDK_OFFSET(0x196B7CD0)
#define CLASS_1_C9DFE5EE7107C629_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x196B7DE0)
#define CLASS_1_C9DFE5EE7107C629_EQUALS_OFFSET UNITYSDK_OFFSET(0x196B7DB0)
#define CLASS_1_C9DFE5EE7107C629_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x196B7EE0)
#define CLASS_1_C9DFE5EE7107C629_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x196B8580)
#define CLASS_1_C9DFE5EE7107C629_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x196B84B0)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x196B7D20)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_02A3D10A9D535169_2_OFFSET UNITYSDK_OFFSET(0x196B7D40)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x196B7D00)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x196B7D90)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0x196B7D80)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x196B7D60)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x196B7B60)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x196B7D30)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_7786DC814C2FC3BE_2_OFFSET UNITYSDK_OFFSET(0x196B7D50)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x196B7D10)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x196B7DA0)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x196B7D70)
#define CLASS_1_C9DFE5EE7107C629_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x196B7B90)
#define CLASS_1_C9DFE5EE7107C629_TOSTRING_OFFSET UNITYSDK_OFFSET(0x196B8020)
#define CLASS_1_C9DFE5EE7107C629_WRITETO_OFFSET UNITYSDK_OFFSET(0x196B8080)
#define CLASS_1_C9DFE5EE7107C629__CCTOR_OFFSET UNITYSDK_OFFSET(0x196B86D0)
#define CLASS_1_C9DFE5EE7107C629__CTOR_1_OFFSET UNITYSDK_OFFSET(0x196B7BF0)
#define CLASS_1_C9DFE5EE7107C629__CTOR_OFFSET UNITYSDK_OFFSET(0x196B7BA0)

inline static constexpr unsigned int Class_1_C9DFE5EE7107C629_TypeDefinitionIndex = 24155;
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_C9DFE5EE7107C629_TypeDefinitionIndex)->GetStaticField(0x232F0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_C9DFE5EE7107C629*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_C9DFE5EE7107C629*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_C9DFE5EE7107C629_TypeDefinitionIndex)->GetStaticField(0x232F8);
	}
	...
	::Class_1_D17272E82AE804C2_6* Field_1_14; // 0x18
	...
	::Enum_3_0A3761FE34514D6C_13 Field_1_12; // 0x34
	...
	{
		return ((::Google::Protobuf::Collections::RepeatedField_1<::System::UInt32>*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_C9DFE5EE7107C629_METHOD_1_554199E0076172C5_OFFSET))(this);
	}

	::Enum_3_0A3761FE34514D6C_13 Method_1_A96DCA30C6927810()
	{
		return ((::Enum_3_0A3761FE34514D6C_13(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_C9DFE5EE7107C629_METHOD_1_A96DCA30C6927810_OFFSET))(this);
	}

	::System::Void Method_1_3DACC45AC8150727(::Enum_3_0A3761FE34514D6C_13 a1)
	{
		return ((::System::Void(*)(::PVOID, ::Enum_3_0A3761FE34514D6C_13))((::PBYTE)hIl2Cpp + CLASS_1_C9DFE5EE7107C629_METHOD_1_3DACC45AC8150727_OFFSET))(this, a1);
	}

	::Class_1_D17272E82AE804C2_6* Method_1_24748FC20F375725()
	{
		return ((::Class_1_D17272E82AE804C2_6*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_C9DFE5EE7107C629_METHOD_1_24748FC20F375725_OFFSET))(this);
	}

	::System::Void Method_1_8C8625211DA811AE(::Class_1_D17272E82AE804C2_6* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_D17272E82AE804C2_6*))((::PBYTE)hIl2Cpp + CLASS_1_C9DFE5EE7107C629_METHOD_1_8C8625211DA811AE_OFFSET))(this, a1);
	}
