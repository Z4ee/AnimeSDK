...
#define CLASS_1_C9DFE5EE7107C629_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E4A2410)
#define CLASS_1_C9DFE5EE7107C629_CLONE_OFFSET UNITYSDK_OFFSET(0x1E4A18E0)
#define CLASS_1_C9DFE5EE7107C629_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E4A1B20)
#define CLASS_1_C9DFE5EE7107C629_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E4A1AF0)
#define CLASS_1_C9DFE5EE7107C629_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E4A1CD0)
#define CLASS_1_C9DFE5EE7107C629_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E4A2E70)
#define CLASS_1_C9DFE5EE7107C629_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E4A2B30)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1E4A1950)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_02A3D10A9D535169_2_OFFSET UNITYSDK_OFFSET(0x1E4A1970)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_02A3D10A9D535169_3_OFFSET UNITYSDK_OFFSET(0x1E4A1990)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_02A3D10A9D535169_4_OFFSET UNITYSDK_OFFSET(0x1E4A19D0)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_02A3D10A9D535169_5_OFFSET UNITYSDK_OFFSET(0x1E4A19F0)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_02A3D10A9D535169_6_OFFSET UNITYSDK_OFFSET(0x1E4A1A20)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_02A3D10A9D535169_7_OFFSET UNITYSDK_OFFSET(0x1E4A1A40)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_02A3D10A9D535169_8_OFFSET UNITYSDK_OFFSET(0x1E4A1AA0)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_02A3D10A9D535169_9_OFFSET UNITYSDK_OFFSET(0x1E4A1AD0)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1E4A1930)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_24748FC20F375725_1_OFFSET UNITYSDK_OFFSET(0x1E4A1A80)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x1E4A1A60)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0x1E4A1920)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E4A15F0)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_6E1EC2DF63D7020F_1_OFFSET UNITYSDK_OFFSET(0x1E4A19C0)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_6E1EC2DF63D7020F_2_OFFSET UNITYSDK_OFFSET(0x1E4A1A10)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_6E1EC2DF63D7020F_3_OFFSET UNITYSDK_OFFSET(0x1E4A1AC0)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x1E4A19B0)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1E4A1960)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_7786DC814C2FC3BE_2_OFFSET UNITYSDK_OFFSET(0x1E4A1980)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_7786DC814C2FC3BE_3_OFFSET UNITYSDK_OFFSET(0x1E4A19A0)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_7786DC814C2FC3BE_4_OFFSET UNITYSDK_OFFSET(0x1E4A19E0)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_7786DC814C2FC3BE_5_OFFSET UNITYSDK_OFFSET(0x1E4A1A00)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_7786DC814C2FC3BE_6_OFFSET UNITYSDK_OFFSET(0x1E4A1A30)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_7786DC814C2FC3BE_7_OFFSET UNITYSDK_OFFSET(0x1E4A1A50)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_7786DC814C2FC3BE_8_OFFSET UNITYSDK_OFFSET(0x1E4A1AB0)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_7786DC814C2FC3BE_9_OFFSET UNITYSDK_OFFSET(0x1E4A1AE0)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1E4A1940)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_8C8625211DA811AE_1_OFFSET UNITYSDK_OFFSET(0x1E4A1A90)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1E4A1A70)
#define CLASS_1_C9DFE5EE7107C629_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x1E4A1910)
#define CLASS_1_C9DFE5EE7107C629_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E4A1620)
#define CLASS_1_C9DFE5EE7107C629_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E4A1E20)
#define CLASS_1_C9DFE5EE7107C629_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E4A1E80)
#define CLASS_1_C9DFE5EE7107C629__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E4A3230)
#define CLASS_1_C9DFE5EE7107C629__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E4A16D0)
#define CLASS_1_C9DFE5EE7107C629__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4A1630)

inline static constexpr unsigned int Class_1_C9DFE5EE7107C629_TypeDefinitionIndex = 25067;
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_27DCDC5CAB14C7C7*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_C9DFE5EE7107C629_TypeDefinitionIndex)->GetStaticField(0x138B0);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_D17272E82AE804C2_16*>** StaticGet_DFPBOGBGKLP()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_D17272E82AE804C2_16*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_C9DFE5EE7107C629_TypeDefinitionIndex)->GetStaticField(0x138B8);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_D17272E82AE804C2_16*>** StaticGet_OHPOAJJOBGD()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_D17272E82AE804C2_16*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_C9DFE5EE7107C629_TypeDefinitionIndex)->GetStaticField(0x138C0);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_D17272E82AE804C2_15*>** StaticGet_GPNHFNLKNEK()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_D17272E82AE804C2_15*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_C9DFE5EE7107C629_TypeDefinitionIndex)->GetStaticField(0x138C8);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_C9DFE5EE7107C629*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_C9DFE5EE7107C629*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_C9DFE5EE7107C629_TypeDefinitionIndex)->GetStaticField(0x138D0);
	}
	...
	::Class_1_07701BC2FDC5E4E0* MGAENCPOBKN; // 0x10
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_D17272E82AE804C2_16*>* EKKJMMGCMGI; // 0x18
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_27DCDC5CAB14C7C7*>* KHBFICKDAPA; // 0x20
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_D17272E82AE804C2_16*>* MPMHGINNJFP; // 0x28
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x30
	::Class_1_D17272E82AE804C2_9* NOHFFBHAHFM; // 0x38
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_D17272E82AE804C2_15*>* DGOOJDMMJIP; // 0x40
	::System::UInt32 IMJCALAFOMD; // 0x48
	::Enum_3_01618AD0437C8486 CFCAMOAGIDE; // 0x4C
	::System::UInt32 CLBJDBPOOEK; // 0x50
	::System::UInt32 PLKGEBACJMA; // 0x54
	::System::UInt32 MGDODHEHDFE; // 0x58
	::System::UInt32 KCIKBKIBOPB; // 0x5C
	::System::UInt32 EAFEGFFAIKG; // 0x60
	::System::UInt32 GEMFJILOPLL; // 0x64
	::System::UInt32 MLFLEEGBFJP; // 0x68
	::System::UInt32 OGPNLMIIJCO; // 0x6C
