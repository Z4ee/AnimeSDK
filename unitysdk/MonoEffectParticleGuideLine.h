...
#define MONOEFFECTPARTICLEGUIDELINE_CONTROLPARTICLE_OFFSET UNITYSDK_OFFSET(0xF80E500)
#define MONOEFFECTPARTICLEGUIDELINE_CRATEMESH_OFFSET UNITYSDK_OFFSET(0xF80E710)
#define MONOEFFECTPARTICLEGUIDELINE_GENERATEMESH_OFFSET UNITYSDK_OFFSET(0xF80EB60)
#define MONOEFFECTPARTICLEGUIDELINE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xF810280)
#define MONOEFFECTPARTICLEGUIDELINE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xF80EA80)
#define MONOEFFECTPARTICLEGUIDELINE_REFRESHGUIDELINE_OFFSET UNITYSDK_OFFSET(0xF810180)
#define MONOEFFECTPARTICLEGUIDELINE_START_OFFSET UNITYSDK_OFFSET(0xF80E330)
#define MONOEFFECTPARTICLEGUIDELINE_TESTREFRESHGUIDELINE_OFFSET UNITYSDK_OFFSET(0xF8100A0)
#define MONOEFFECTPARTICLEGUIDELINE__CTOR_OFFSET UNITYSDK_OFFSET(0xF810450)

inline static constexpr unsigned int MonoEffectParticleGuideLine_TypeDefinitionIndex = 56378;
