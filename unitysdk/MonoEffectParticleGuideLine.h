...
#define MONOEFFECTPARTICLEGUIDELINE_CONTROLPARTICLE_OFFSET UNITYSDK_OFFSET(0x10F19B50)
#define MONOEFFECTPARTICLEGUIDELINE_CRATEMESH_OFFSET UNITYSDK_OFFSET(0x10F19D60)
#define MONOEFFECTPARTICLEGUIDELINE_GENERATEMESH_OFFSET UNITYSDK_OFFSET(0x10F1A180)
#define MONOEFFECTPARTICLEGUIDELINE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x10F1B6F0)
#define MONOEFFECTPARTICLEGUIDELINE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x10F1A0A0)
#define MONOEFFECTPARTICLEGUIDELINE_REFRESHGUIDELINE_OFFSET UNITYSDK_OFFSET(0x10F1B5F0)
#define MONOEFFECTPARTICLEGUIDELINE_START_OFFSET UNITYSDK_OFFSET(0x10F19980)
#define MONOEFFECTPARTICLEGUIDELINE_TESTREFRESHGUIDELINE_OFFSET UNITYSDK_OFFSET(0x10F1B510)
#define MONOEFFECTPARTICLEGUIDELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x10F1B8C0)

inline static constexpr unsigned int MonoEffectParticleGuideLine_TypeDefinitionIndex = 85115;
