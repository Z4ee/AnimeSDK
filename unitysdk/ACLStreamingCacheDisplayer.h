...
#define ACLSTREAMINGCACHEDISPLAYER_APPLYSORTINPLACE_OFFSET UNITYSDK_OFFSET(0x102DED80)
#define ACLSTREAMINGCACHEDISPLAYER_BUILDLAYOUT_OFFSET UNITYSDK_OFFSET(0x102DB140)
#define ACLSTREAMINGCACHEDISPLAYER_CLAMPPAGE_OFFSET UNITYSDK_OFFSET(0x102DC0E0)
#define ACLSTREAMINGCACHEDISPLAYER_COMPUTESCALE_OFFSET UNITYSDK_OFFSET(0x102DB0C0)
#define ACLSTREAMINGCACHEDISPLAYER_DRAWLIST_OFFSET UNITYSDK_OFFSET(0x102DE300)
#define ACLSTREAMINGCACHEDISPLAYER_DRAWPAGER_OFFSET UNITYSDK_OFFSET(0x102DE870)
#define ACLSTREAMINGCACHEDISPLAYER_DRAWPROGRESS_OFFSET UNITYSDK_OFFSET(0x102DDBC0)
#define ACLSTREAMINGCACHEDISPLAYER_DRAWTEX_OFFSET UNITYSDK_OFFSET(0x102DD870)
#define ACLSTREAMINGCACHEDISPLAYER_ENSURESTYLES_OFFSET UNITYSDK_OFFSET(0x102DCB80)
#define ACLSTREAMINGCACHEDISPLAYER_FORMATBYTES_OFFSET UNITYSDK_OFFSET(0x102DE050)
#define ACLSTREAMINGCACHEDISPLAYER_GETCLIPS_OFFSET UNITYSDK_OFFSET(0x102DE210)
#define ACLSTREAMINGCACHEDISPLAYER_MINIBUTTON_OFFSET UNITYSDK_OFFSET(0x102DDF30)
#define ACLSTREAMINGCACHEDISPLAYER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x102DBCD0)
#define ACLSTREAMINGCACHEDISPLAYER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x102DAE60)
#define ACLSTREAMINGCACHEDISPLAYER_ONGUI_OFFSET UNITYSDK_OFFSET(0x102DC1A0)
#define ACLSTREAMINGCACHEDISPLAYER_SORTLABEL_OFFSET UNITYSDK_OFFSET(0x102DE250)
#define ACLSTREAMINGCACHEDISPLAYER_UPDATE_OFFSET UNITYSDK_OFFSET(0x102DBEC0)
#define ACLSTREAMINGCACHEDISPLAYER__APPLYSORTINPLACE_B__76_0_OFFSET UNITYSDK_OFFSET(0x102DFB30)
#define ACLSTREAMINGCACHEDISPLAYER__CCTOR_OFFSET UNITYSDK_OFFSET(0x102DFB20)
#define ACLSTREAMINGCACHEDISPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x102DF940)

inline static constexpr unsigned int ACLStreamingCacheDisplayer_TypeDefinitionIndex = 85912;
...
public:
	...
	{
		return (::UnityEngine::Color*)Il2CppClass::FromTypeDefinitionIndex(ACLStreamingCacheDisplayer_TypeDefinitionIndex)->GetStaticField(0x120E0);
	}
