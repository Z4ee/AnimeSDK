...
#define ACLSTREAMINGCACHEDISPLAYER_APPLYSORTINPLACE_OFFSET UNITYSDK_OFFSET(0x11A04070)
#define ACLSTREAMINGCACHEDISPLAYER_BUILDLAYOUT_OFFSET UNITYSDK_OFFSET(0x11A00430)
#define ACLSTREAMINGCACHEDISPLAYER_CLAMPPAGE_OFFSET UNITYSDK_OFFSET(0x11A013D0)
#define ACLSTREAMINGCACHEDISPLAYER_COMPUTESCALE_OFFSET UNITYSDK_OFFSET(0x11A003B0)
#define ACLSTREAMINGCACHEDISPLAYER_DRAWLIST_OFFSET UNITYSDK_OFFSET(0x11A035F0)
#define ACLSTREAMINGCACHEDISPLAYER_DRAWPAGER_OFFSET UNITYSDK_OFFSET(0x11A03B60)
#define ACLSTREAMINGCACHEDISPLAYER_DRAWPROGRESS_OFFSET UNITYSDK_OFFSET(0x11A02EB0)
#define ACLSTREAMINGCACHEDISPLAYER_DRAWTEX_OFFSET UNITYSDK_OFFSET(0x11A02B60)
#define ACLSTREAMINGCACHEDISPLAYER_ENSURESTYLES_OFFSET UNITYSDK_OFFSET(0x11A01E70)
#define ACLSTREAMINGCACHEDISPLAYER_FORMATBYTES_OFFSET UNITYSDK_OFFSET(0x11A03340)
#define ACLSTREAMINGCACHEDISPLAYER_GETCLIPS_OFFSET UNITYSDK_OFFSET(0x11A03500)
#define ACLSTREAMINGCACHEDISPLAYER_MINIBUTTON_OFFSET UNITYSDK_OFFSET(0x11A03220)
#define ACLSTREAMINGCACHEDISPLAYER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x11A00FC0)
#define ACLSTREAMINGCACHEDISPLAYER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x11A00150)
#define ACLSTREAMINGCACHEDISPLAYER_ONGUI_OFFSET UNITYSDK_OFFSET(0x11A01490)
#define ACLSTREAMINGCACHEDISPLAYER_SORTLABEL_OFFSET UNITYSDK_OFFSET(0x11A03540)
#define ACLSTREAMINGCACHEDISPLAYER_UPDATE_OFFSET UNITYSDK_OFFSET(0x11A011B0)
#define ACLSTREAMINGCACHEDISPLAYER__APPLYSORTINPLACE_B__76_0_OFFSET UNITYSDK_OFFSET(0x11A04E20)
#define ACLSTREAMINGCACHEDISPLAYER__CCTOR_OFFSET UNITYSDK_OFFSET(0x11A04E10)
#define ACLSTREAMINGCACHEDISPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x11A04C30)

inline static constexpr unsigned int ACLStreamingCacheDisplayer_TypeDefinitionIndex = 91467;
...
public:
	...
	{
		return (::UnityEngine::Color*)Il2CppClass::FromTypeDefinitionIndex(ACLStreamingCacheDisplayer_TypeDefinitionIndex)->GetStaticField(0x12F40);
	}
