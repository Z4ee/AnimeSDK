...
#define CLASS_1_209EA31B77B8ADFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1D03EC70)
...
public:
	...
	::RPG::GameCore::TRFCubeType DOELLHMOEED; // 0x18
	::System::Boolean HMAIEJIODHO; // 0x1C
	::RPG::Client::LittleGame::TRFOccupyType BIMECHCKKFA; // 0x20
