...
#define CLASS_2_D3DC74FCB64200A3_DISPOSE_OFFSET UNITYSDK_OFFSET(0x199E8EC0)
#define CLASS_2_D3DC74FCB64200A3_GETCONFIG_OFFSET UNITYSDK_OFFSET(0x199EAE70)
#define CLASS_2_D3DC74FCB64200A3_METHOD_2_070B85DE6F787526_OFFSET UNITYSDK_OFFSET(0x199E9C80)
#define CLASS_2_D3DC74FCB64200A3_METHOD_2_0865E94460F11643_OFFSET UNITYSDK_OFFSET(0x199E9830)
#define CLASS_2_D3DC74FCB64200A3_METHOD_2_0B2772044994A2C5_OFFSET UNITYSDK_OFFSET(0x199EAEB0)
#define CLASS_2_D3DC74FCB64200A3_METHOD_2_2B3E418FCEB4ACC0_OFFSET UNITYSDK_OFFSET(0x199EAF70)
#define CLASS_2_D3DC74FCB64200A3_METHOD_2_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x199EA1F0)
#define CLASS_2_D3DC74FCB64200A3_METHOD_2_4D7B4CA2F3097BB0_OFFSET UNITYSDK_OFFSET(0x199EA920)
#define CLASS_2_D3DC74FCB64200A3_METHOD_2_4E6F72124EC1C84B_OFFSET UNITYSDK_OFFSET(0x199EA8B0)
#define CLASS_2_D3DC74FCB64200A3_METHOD_2_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0x199EA0D0)
#define CLASS_2_D3DC74FCB64200A3_METHOD_2_B3D3AD8F3E59981A_OFFSET UNITYSDK_OFFSET(0x199E9D70)
#define CLASS_2_D3DC74FCB64200A3_METHOD_2_B7BDCD0E08EC15F6_OFFSET UNITYSDK_OFFSET(0x199EA270)
#define CLASS_2_D3DC74FCB64200A3_METHOD_2_C38F03C1E988B48E_OFFSET UNITYSDK_OFFSET(0x199E9930)
#define CLASS_2_D3DC74FCB64200A3_METHOD_2_D64FD9A228A1C4E0_OFFSET UNITYSDK_OFFSET(0x199EAE00)
#define CLASS_2_D3DC74FCB64200A3_METHOD_2_D6EE2EB5A2CB5688_OFFSET UNITYSDK_OFFSET(0x199E9AE0)
#define CLASS_2_D3DC74FCB64200A3_METHOD_2_DC822FA3C145458D_OFFSET UNITYSDK_OFFSET(0x199EA820)
#define CLASS_2_D3DC74FCB64200A3_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x199E8F60)
#define CLASS_2_D3DC74FCB64200A3_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x199EAC00)
#define CLASS_2_D3DC74FCB64200A3_TICK_OFFSET UNITYSDK_OFFSET(0x199EACB0)
#define CLASS_2_D3DC74FCB64200A3__CTOR_OFFSET UNITYSDK_OFFSET(0x199E8E50)
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_2_D3DC74FCB64200A3_TypeDefinitionIndex)->GetStaticField(0x14E40);
	}
	static ::System::Single* StaticGet_BDNOFBGDBFF()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_2_D3DC74FCB64200A3_TypeDefinitionIndex)->GetStaticField(0x14E44);
	}
	static ::System::Int32* StaticGet_LCFIPJPEKLK()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_2_D3DC74FCB64200A3_TypeDefinitionIndex)->GetStaticField(0x14E48);
	}
	static ::System::Single* StaticGet_PLBLHNPPLAF()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_2_D3DC74FCB64200A3_TypeDefinitionIndex)->GetStaticField(0x14E4C);
	}
	static ::System::Boolean* StaticGet_AHBDEBJKMOC()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_2_D3DC74FCB64200A3_TypeDefinitionIndex)->GetStaticField(0x14E50);
	}
	...
	::RPG::GameCore::LittleGameAbilityPixAirFireMissle* OFKGLJOAMLD; // 0x20
	::Class_1_B7D8FCA21FE37AFD* KDKAGOHPOOC; // 0x28
	::System::Collections::Generic::List_1<::Class_2_D3DC74FCB64200A3_Class_1_935F1C58F3EECE28*>* DIJHIMLLBHG; // 0x30
	::System::Single BPAIDCADMDO; // 0x38
	::System::Int32 AGKGKJFNBED; // 0x3C
	::System::Boolean OJKJLINNHCJ; // 0x40
