...
#define CLASS_2_1BEF4F2EAF84A774_DISPOSE_OFFSET UNITYSDK_OFFSET(0x188C12D0)
#define CLASS_2_1BEF4F2EAF84A774_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x188C1310)
#define CLASS_2_1BEF4F2EAF84A774_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x188C2200)
#define CLASS_2_1BEF4F2EAF84A774_TICK_OFFSET UNITYSDK_OFFSET(0x188C2250)
#define CLASS_2_1BEF4F2EAF84A774__CTOR_OFFSET UNITYSDK_OFFSET(0x188C12C0)

inline static constexpr unsigned int Class_2_1BEF4F2EAF84A774_TypeDefinitionIndex = 52580;

class Class_2_1BEF4F2EAF84A774 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ForceKill* Field_2_0; // 0x18
