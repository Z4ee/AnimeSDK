...
#define CLASS_2_7B9780DF90EBD6C0_DISPOSE_OFFSET UNITYSDK_OFFSET(0x169E99C0)
#define CLASS_2_7B9780DF90EBD6C0_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x169E9A00)
#define CLASS_2_7B9780DF90EBD6C0_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x169E9C80)
#define CLASS_2_7B9780DF90EBD6C0_TICK_OFFSET UNITYSDK_OFFSET(0x169E9CD0)
#define CLASS_2_7B9780DF90EBD6C0__CTOR_OFFSET UNITYSDK_OFFSET(0x169E99B0)

inline static constexpr unsigned int Class_2_7B9780DF90EBD6C0_TypeDefinitionIndex = 53146;

class Class_2_7B9780DF90EBD6C0 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::StopEffectFollowPoint* Field_2_0; // 0x18
