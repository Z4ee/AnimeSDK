...
#define STRUCT_2_B22A8BD8ED65C725_METHOD_2_003ED7DD9BE67F62_OFFSET UNITYSDK_OFFSET(0x18A83150)
#define STRUCT_2_B22A8BD8ED65C725_METHOD_2_383AE8662A93F4D0_OFFSET UNITYSDK_OFFSET(0x18A83040)
#define STRUCT_2_B22A8BD8ED65C725_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x3AE7760)
#define STRUCT_2_B22A8BD8ED65C725_METHOD_2_3D78D2E0F9F95F07_1_OFFSET UNITYSDK_OFFSET(0x3A422F0)
#define STRUCT_2_B22A8BD8ED65C725_METHOD_2_3D78D2E0F9F95F07_OFFSET UNITYSDK_OFFSET(0x145E0)
#define STRUCT_2_B22A8BD8ED65C725_METHOD_2_602A336CBD30C930_1_OFFSET UNITYSDK_OFFSET(0x3A42330)
#define STRUCT_2_B22A8BD8ED65C725_METHOD_2_602A336CBD30C930_OFFSET UNITYSDK_OFFSET(0x14360)
#define STRUCT_2_B22A8BD8ED65C725_METHOD_2_97409C5AB8423CFA_OFFSET UNITYSDK_OFFSET(0x18A82F80)
#define STRUCT_2_B22A8BD8ED65C725_METHOD_2_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x3AE78F0)
#define STRUCT_2_B22A8BD8ED65C725_METHOD_2_F10A0D072D26C4BF_1_OFFSET UNITYSDK_OFFSET(0x3AE7820)
#define STRUCT_2_B22A8BD8ED65C725_METHOD_2_F10A0D072D26C4BF_OFFSET UNITYSDK_OFFSET(0x3AE77B0)
#define STRUCT_2_B22A8BD8ED65C725__CTOR_OFFSET UNITYSDK_OFFSET(0x3AE7720)

inline static constexpr unsigned int Struct_2_B22A8BD8ED65C725_TypeDefinitionIndex = 73854;
...
struct alignas(8) Struct_2_B22A8BD8ED65C725
{
	...
	::System::Collections::Generic::List_1<::UnityEngine::Vector2>* IPACDKEBGIJ; // 0xA0
	::System::Single HBAMPJPOOLM; // 0xA8
	::UnityEngine::Vector3 BBFOLEOPPPL; // 0xAC
	::UnityEngine::Vector2 OLLHGKFCCJC; // 0xB8
	::UnityEngine::Vector2 PLLHCPALFLN; // 0xC0
	::System::Boolean DFHAINGLMAM; // 0xC8
	::System::Boolean OGFGJAFDMIM; // 0xC9
	::System::Single NMDPAOPJHFO; // 0xCC
