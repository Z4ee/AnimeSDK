...
#define CLASS_2_C413F4BEAE90B538_DISPOSE_OFFSET UNITYSDK_OFFSET(0x156C18F0)
#define CLASS_2_C413F4BEAE90B538_METHOD_2_540DB5DAE524BF3C_OFFSET UNITYSDK_OFFSET(0x156C1CB0)
#define CLASS_2_C413F4BEAE90B538_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x156C1930)
#define CLASS_2_C413F4BEAE90B538_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x156C1C00)
#define CLASS_2_C413F4BEAE90B538_TICK_OFFSET UNITYSDK_OFFSET(0x156C1C50)
#define CLASS_2_C413F4BEAE90B538__CTOR_OFFSET UNITYSDK_OFFSET(0x156C18E0)
...
{
public:
	::RPG::GameCore::TriggerEffectOnlyForLoading* OFKGLJOAMLD; // 0x18
