...
#define SCENENLIGHTMANAGER_SCENEMANAGEDLIGHTCOMPONENT1_GETQUALITYFILTER_OFFSET UNITYSDK_OFFSET(0x19F6E660)
#define SCENENLIGHTMANAGER_SCENEMANAGEDLIGHTCOMPONENT1_GET_LIGHTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x19F6E5C0)
#define SCENENLIGHTMANAGER_SCENEMANAGEDLIGHTCOMPONENT1_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x19F6E700)
#define SCENENLIGHTMANAGER_SCENEMANAGEDLIGHTCOMPONENT1_METHOD_5_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x19F6E710)
#define SCENENLIGHTMANAGER_SCENEMANAGEDLIGHTCOMPONENT1_ONBEGINSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x19F6E6A0)
#define SCENENLIGHTMANAGER_SCENEMANAGEDLIGHTCOMPONENT1_ONBEGINSCENELIGHTLODFADING_OFFSET UNITYSDK_OFFSET(0x19F6E6D0)
#define SCENENLIGHTMANAGER_SCENEMANAGEDLIGHTCOMPONENT1_ONENDSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x19F6E6B0)
#define SCENENLIGHTMANAGER_SCENEMANAGEDLIGHTCOMPONENT1_ONENDSCENELIGHTLODFADING_OFFSET UNITYSDK_OFFSET(0x19F6E6E0)
#define SCENENLIGHTMANAGER_SCENEMANAGEDLIGHTCOMPONENT1_ONSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0x19F6E690)
#define SCENENLIGHTMANAGER_SCENEMANAGEDLIGHTCOMPONENT1_ONSCENELIGHTLODFADING_OFFSET UNITYSDK_OFFSET(0x19F6E6C0)
#define SCENENLIGHTMANAGER_SCENEMANAGEDLIGHTCOMPONENT1_ONSETSCENELIGHTLOD_OFFSET UNITYSDK_OFFSET(0x19F6E6F0)
#define SCENENLIGHTMANAGER_SCENEMANAGEDLIGHTCOMPONENT1_ONTURNOFF_OFFSET UNITYSDK_OFFSET(0x19F6E680)
#define SCENENLIGHTMANAGER_SCENEMANAGEDLIGHTCOMPONENT1_ONTURNON_OFFSET UNITYSDK_OFFSET(0x19F6E670)
#define SCENENLIGHTMANAGER_SCENEMANAGEDLIGHTCOMPONENT1__CTOR_OFFSET UNITYSDK_OFFSET(0x19F6E720)

namespace ScenenLightManager
{
	inline static constexpr unsigned int SceneManagedLightComponent1_TypeDefinitionIndex = 47218;
