...
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATA_EQUALS_OFFSET UNITYSDK_OFFSET(0x19F6C320)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19F6C630)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATA_METHOD_1_922FB2A73E3CC6C9_OFFSET UNITYSDK_OFFSET(0x19F6C030)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19F6BFC0)

namespace ScenenLightManager
{
	inline static constexpr unsigned int LightSetExportData_TypeDefinitionIndex = 47304;
