...
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATA_EQUALS_OFFSET UNITYSDK_OFFSET(0xABC1390)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xABC1650)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATA_METHOD_1_90EA99C5B55095D8_OFFSET UNITYSDK_OFFSET(0xABC10D0)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xABC1060)

namespace ScenenLightManager
{
	inline static constexpr unsigned int LightSetExportData_TypeDefinitionIndex = 39847;
