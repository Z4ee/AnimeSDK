...
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATA_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BF43D80)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BF44090)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATA_METHOD_1_922FB2A73E3CC6C9_OFFSET UNITYSDK_OFFSET(0x1BF43A90)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF43A20)
