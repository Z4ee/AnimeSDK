...
#define SCENENLIGHTMANAGER_MESHRENDEREXPORTDATA_METHOD_1_42422F9198B570F3_OFFSET UNITYSDK_OFFSET(0x19F6E260)
#define SCENENLIGHTMANAGER_MESHRENDEREXPORTDATA_METHOD_1_7CAC9130826180EE_OFFSET UNITYSDK_OFFSET(0x19F6DFC0)
#define SCENENLIGHTMANAGER_MESHRENDEREXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19F6DF40)

namespace ScenenLightManager
{
	inline static constexpr unsigned int MeshRenderExportData_TypeDefinitionIndex = 47292;
