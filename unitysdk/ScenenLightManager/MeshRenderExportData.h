...
#define SCENENLIGHTMANAGER_MESHRENDEREXPORTDATA_METHOD_1_056B895F44D3ED79_OFFSET UNITYSDK_OFFSET(0xABC2E80)
#define SCENENLIGHTMANAGER_MESHRENDEREXPORTDATA_METHOD_1_42422F9198B570F3_OFFSET UNITYSDK_OFFSET(0xABC30E0)
#define SCENENLIGHTMANAGER_MESHRENDEREXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xABC2E00)

namespace ScenenLightManager
{
	inline static constexpr unsigned int MeshRenderExportData_TypeDefinitionIndex = 39835;
