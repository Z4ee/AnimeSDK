...
#define SCENENLIGHTMANAGER_TUP_EQUALS_OFFSET UNITYSDK_OFFSET(0xB9391B0)
#define SCENENLIGHTMANAGER_TUP_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xB939250)
#define SCENENLIGHTMANAGER_TUP_METHOD_1_AF094A37CE984E72_OFFSET UNITYSDK_OFFSET(0xB939230)
#define SCENENLIGHTMANAGER_TUP__CTOR_OFFSET UNITYSDK_OFFSET(0xB9391A0)

namespace ScenenLightManager
{
	inline static constexpr unsigned int Tup_TypeDefinitionIndex = 45762;
