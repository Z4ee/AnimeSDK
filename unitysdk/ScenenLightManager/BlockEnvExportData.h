...
#define SCENENLIGHTMANAGER_BLOCKENVEXPORTDATA_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19F693B0)
#define SCENENLIGHTMANAGER_BLOCKENVEXPORTDATA_METHOD_3_9A948BCE6757BD75_OFFSET UNITYSDK_OFFSET(0x19F693C0)
#define SCENENLIGHTMANAGER_BLOCKENVEXPORTDATA_METHOD_3_9B4CB6A2D6A8932F_OFFSET UNITYSDK_OFFSET(0x19F6A3D0)
#define SCENENLIGHTMANAGER_BLOCKENVEXPORTDATA_METHOD_3_A7255BF3487CAEB2_OFFSET UNITYSDK_OFFSET(0x19F6A960)
#define SCENENLIGHTMANAGER_BLOCKENVEXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19F69220)

namespace ScenenLightManager
{
	inline static constexpr unsigned int BlockEnvExportData_TypeDefinitionIndex = 47211;
