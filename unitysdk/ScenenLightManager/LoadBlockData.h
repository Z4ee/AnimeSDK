...
#define SCENENLIGHTMANAGER_LOADBLOCKDATA_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BF45800)
#define SCENENLIGHTMANAGER_LOADBLOCKDATA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BF458A0)
#define SCENENLIGHTMANAGER_LOADBLOCKDATA_METHOD_1_277FDD755CB452A1_OFFSET UNITYSDK_OFFSET(0x1BF457B0)
#define SCENENLIGHTMANAGER_LOADBLOCKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF457A0)

namespace ScenenLightManager
{
	inline static constexpr unsigned int LoadBlockData_TypeDefinitionIndex = 49582;
