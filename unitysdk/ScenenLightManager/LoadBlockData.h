...
#define SCENENLIGHTMANAGER_LOADBLOCKDATA_EQUALS_OFFSET UNITYSDK_OFFSET(0xB9386A0)
#define SCENENLIGHTMANAGER_LOADBLOCKDATA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xB938740)
#define SCENENLIGHTMANAGER_LOADBLOCKDATA_METHOD_1_277FDD755CB452A1_OFFSET UNITYSDK_OFFSET(0xB938650)
#define SCENENLIGHTMANAGER_LOADBLOCKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB938640)

namespace ScenenLightManager
{
	inline static constexpr unsigned int LoadBlockData_TypeDefinitionIndex = 45754;
