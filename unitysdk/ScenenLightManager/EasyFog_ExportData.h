...
#define SCENENLIGHTMANAGER_EASYFOG_EXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xABC0E30)

namespace ScenenLightManager
{
	inline static constexpr unsigned int EasyFog_ExportData_TypeDefinitionIndex = 39798;
