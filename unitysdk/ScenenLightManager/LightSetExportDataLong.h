...
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATALONG_EQUALS_OFFSET UNITYSDK_OFFSET(0xD07BFF0)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATALONG_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xD07C300)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATALONG_METHOD_1_F4D768D64F0A99F7_OFFSET UNITYSDK_OFFSET(0xD07BD00)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATALONG__CTOR_OFFSET UNITYSDK_OFFSET(0xD07BC90)
