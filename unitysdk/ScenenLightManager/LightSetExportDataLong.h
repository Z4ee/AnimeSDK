...
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATALONG_EQUALS_OFFSET UNITYSDK_OFFSET(0xABC1D10)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATALONG_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xABC1FD0)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATALONG_METHOD_1_7172FE331F6185E2_OFFSET UNITYSDK_OFFSET(0xABC1A50)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATALONG__CTOR_OFFSET UNITYSDK_OFFSET(0xABC19A0)

namespace ScenenLightManager
{
	inline static constexpr unsigned int LightSetExportDataLong_TypeDefinitionIndex = 39849;
