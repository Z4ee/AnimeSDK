...
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATALONG_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BF44780)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATALONG_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BF44A90)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATALONG_METHOD_1_F4D768D64F0A99F7_OFFSET UNITYSDK_OFFSET(0x1BF44490)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATALONG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF44420)
