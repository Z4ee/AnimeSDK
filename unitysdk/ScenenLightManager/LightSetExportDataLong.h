...
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATALONG_EQUALS_OFFSET UNITYSDK_OFFSET(0x19F6CD20)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATALONG_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19F6D030)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATALONG_METHOD_1_F4D768D64F0A99F7_OFFSET UNITYSDK_OFFSET(0x19F6CA30)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATALONG__CTOR_OFFSET UNITYSDK_OFFSET(0x19F6C9C0)

namespace ScenenLightManager
{
	inline static constexpr unsigned int LightSetExportDataLong_TypeDefinitionIndex = 47306;
