...
#define SCENENLIGHTMANAGER_LIGHTCONTROLDATAPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x19F6BE90)

namespace ScenenLightManager
{
	inline static constexpr unsigned int LightControlDataPair_TypeDefinitionIndex = 47303;
