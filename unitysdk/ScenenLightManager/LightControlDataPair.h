...
#define SCENENLIGHTMANAGER_LIGHTCONTROLDATAPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0xABC0F30)

namespace ScenenLightManager
{
	inline static constexpr unsigned int LightControlDataPair_TypeDefinitionIndex = 39846;
