...
#define SCENENLIGHTMANAGER_IRRADIANCECACHE_SCENELIGHTEXPORTDATA_METHOD_3_5E6C930E38E03A19_OFFSET UNITYSDK_OFFSET(0xABC0F10)
#define SCENENLIGHTMANAGER_IRRADIANCECACHE_SCENELIGHTEXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xABC0F20)

namespace ScenenLightManager
{
	inline static constexpr unsigned int IrradianceCache_SceneLightExportData_TypeDefinitionIndex = 39752;
