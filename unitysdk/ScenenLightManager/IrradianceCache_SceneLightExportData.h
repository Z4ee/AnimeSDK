...
#define SCENENLIGHTMANAGER_IRRADIANCECACHE_SCENELIGHTEXPORTDATA_METHOD_3_5E6C930E38E03A19_OFFSET UNITYSDK_OFFSET(0x1BF438D0)
#define SCENENLIGHTMANAGER_IRRADIANCECACHE_SCENELIGHTEXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF438E0)

namespace ScenenLightManager
{
	inline static constexpr unsigned int IrradianceCache_SceneLightExportData_TypeDefinitionIndex = 49489;
