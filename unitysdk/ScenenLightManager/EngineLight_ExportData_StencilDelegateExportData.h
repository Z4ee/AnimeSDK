...
#define SCENENLIGHTMANAGER_ENGINELIGHT_EXPORTDATA_STENCILDELEGATEEXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xABC0E70)

namespace ScenenLightManager
{
	inline static constexpr unsigned int EngineLight_ExportData_StencilDelegateExportData_TypeDefinitionIndex = 39789;
