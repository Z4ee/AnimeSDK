...
#define SCENENLIGHTMANAGER_ENGINELIGHT_EXPORTDATA_STENCILDELEGATEEXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB9368B0)

namespace ScenenLightManager
{
	inline static constexpr unsigned int EngineLight_ExportData_StencilDelegateExportData_TypeDefinitionIndex = 45698;
