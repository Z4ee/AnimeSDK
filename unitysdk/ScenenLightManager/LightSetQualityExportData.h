...
#define SCENENLIGHTMANAGER_LIGHTSETQUALITYEXPORTDATA_EQUALS_OFFSET UNITYSDK_OFFSET(0x19F6D700)
#define SCENENLIGHTMANAGER_LIGHTSETQUALITYEXPORTDATA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19F6D9E0)
#define SCENENLIGHTMANAGER_LIGHTSETQUALITYEXPORTDATA_METHOD_1_9C442F1EEC673542_OFFSET UNITYSDK_OFFSET(0x19F6D440)
#define SCENENLIGHTMANAGER_LIGHTSETQUALITYEXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19F6D3D0)

namespace ScenenLightManager
{
	inline static constexpr unsigned int LightSetQualityExportData_TypeDefinitionIndex = 47308;
