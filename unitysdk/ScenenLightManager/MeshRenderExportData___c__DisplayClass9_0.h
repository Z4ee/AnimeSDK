...
#define SCENENLIGHTMANAGER_MESHRENDEREXPORTDATA___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19F6E250)
#define SCENENLIGHTMANAGER_MESHRENDEREXPORTDATA___C__DISPLAYCLASS9_0__TOMESHRENDER_B__0_OFFSET UNITYSDK_OFFSET(0x19F6E2E0)

namespace ScenenLightManager
{
	inline static constexpr unsigned int MeshRenderExportData___c__DisplayClass9_0_TypeDefinitionIndex = 47293;
