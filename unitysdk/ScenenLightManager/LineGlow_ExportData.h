...
#define SCENENLIGHTMANAGER_LINEGLOW_EXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD07CFE0)

namespace ScenenLightManager
{
	inline static constexpr unsigned int LineGlow_ExportData_TypeDefinitionIndex = 46289;
