...
#define SCENENLIGHTMANAGER_LINEGLOW_EXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF45770)

namespace ScenenLightManager
{
	inline static constexpr unsigned int LineGlow_ExportData_TypeDefinitionIndex = 49534;
