...
#define SCENENLIGHTMANAGER_TRANSFORMEXPORTDATA_METHOD_1_7900DB25C44BBC9B_OFFSET UNITYSDK_OFFSET(0x19F6E810)
#define SCENENLIGHTMANAGER_TRANSFORMEXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19F6E750)

namespace ScenenLightManager
{
	inline static constexpr unsigned int TransformExportData_TypeDefinitionIndex = 47291;
