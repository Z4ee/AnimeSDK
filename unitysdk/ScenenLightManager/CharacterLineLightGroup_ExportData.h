...
#define SCENENLIGHTMANAGER_CHARACTERLINELIGHTGROUP_EXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD07B030)

namespace ScenenLightManager
{
	inline static constexpr unsigned int CharacterLineLightGroup_ExportData_TypeDefinitionIndex = 46287;
