...
#define CLASS_2_FC15238330920B22_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB76C5C0)
#define CLASS_2_FC15238330920B22_METHOD_2_6096CA3BC11444EA_OFFSET UNITYSDK_OFFSET(0xB76C6C0)
#define CLASS_2_FC15238330920B22_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB76C4B0)
#define CLASS_2_FC15238330920B22_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB76C570)
#define CLASS_2_FC15238330920B22_TICK_OFFSET UNITYSDK_OFFSET(0xB76C890)
#define CLASS_2_FC15238330920B22__CTOR_OFFSET UNITYSDK_OFFSET(0xB76C420)

inline static constexpr unsigned int Class_2_FC15238330920B22_TypeDefinitionIndex = 48911;

class Class_2_FC15238330920B22 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::MarbleSimulateListener* Field_2_0; // 0x18
