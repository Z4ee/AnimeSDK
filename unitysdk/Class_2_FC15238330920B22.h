...
#define CLASS_2_FC15238330920B22_DISPOSE_OFFSET UNITYSDK_OFFSET(0x169ADC00)
#define CLASS_2_FC15238330920B22_METHOD_2_6096CA3BC11444EA_OFFSET UNITYSDK_OFFSET(0x169ADD60)
#define CLASS_2_FC15238330920B22_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x169ADAF0)
#define CLASS_2_FC15238330920B22_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x169ADBB0)
#define CLASS_2_FC15238330920B22_TICK_OFFSET UNITYSDK_OFFSET(0x169ADF30)
#define CLASS_2_FC15238330920B22__CTOR_OFFSET UNITYSDK_OFFSET(0x169ADA60)
...
public:
	...
	::RPG::GameCore::MarbleSimulateListener* Field_2_2; // 0x28
