...
#define CLASS_1_5B0957DF4420757C_METHOD_1_2D8C5D24DD2300C5_OFFSET UNITYSDK_OFFSET(0x170603E0)
#define CLASS_1_5B0957DF4420757C_METHOD_1_AAEFE3873973B571_OFFSET UNITYSDK_OFFSET(0x170602A0)
#define CLASS_1_5B0957DF4420757C_METHOD_1_DAB9087B1AF0C469_1_OFFSET UNITYSDK_OFFSET(0x17060470)
#define CLASS_1_5B0957DF4420757C_METHOD_1_DAB9087B1AF0C469_OFFSET UNITYSDK_OFFSET(0x17060380)
#define CLASS_1_5B0957DF4420757C__CTOR_OFFSET UNITYSDK_OFFSET(0x170604C0)

inline static constexpr unsigned int Class_1_5B0957DF4420757C_TypeDefinitionIndex = 72852;

class Class_1_5B0957DF4420757C : public ::System::Object
{
public:
	// static const ::System::Char OBGKJOOLAIO; // 0x0
	// static const ::System::Char CMCGPBKLGEG; // 0x0
	// static const ::System::Char MNDMEJEMMGG; // 0x0
	// static const ::System::Char LCCNLBBBKCN; // 0x0
