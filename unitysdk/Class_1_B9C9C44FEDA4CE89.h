...
#define CLASS_1_B9C9C44FEDA4CE89_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16C1AC30)
#define CLASS_1_B9C9C44FEDA4CE89__CTOR_OFFSET UNITYSDK_OFFSET(0x16C1ACE0)
...
{
public:
	::System::Collections::Generic::List_1<::System::UInt32>* AIBBMKLENFD; // 0x10
	::RPG::GameCore::GameEntity* EHANABPPLEC; // 0x18
	::RPG::GameCore::GameEntity* BNIJLOABKBB; // 0x20
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* LMENPEICODO; // 0x28
