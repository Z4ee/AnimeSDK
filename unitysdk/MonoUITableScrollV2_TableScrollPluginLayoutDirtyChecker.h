...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAYOUTDIRTYCHECKER_ONRECTTRANSFORMDIMENSIONSCHANGE_CONTENT_OFFSET UNITYSDK_OFFSET(0x12A5D3A0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAYOUTDIRTYCHECKER_ONRECTTRANSFORMDIMENSIONSCHANGE_VIEWRECT_OFFSET UNITYSDK_OFFSET(0x12A5D450)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAYOUTDIRTYCHECKER__CTOR_OFFSET UNITYSDK_OFFSET(0x12A53C80)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginLayoutDirtyChecker_TypeDefinitionIndex = 69918;
