...
#define CLASS_2_94DB529DA137E52D_GET_CENTERLERPCURVE_OFFSET UNITYSDK_OFFSET(0xBCA4110)
#define CLASS_2_94DB529DA137E52D_GET_CENTERLERPDURATION_OFFSET UNITYSDK_OFFSET(0xBCA40F0)
#define CLASS_2_94DB529DA137E52D_GET_CHARGEINTERRUPTMINENERGYPERCENT_OFFSET UNITYSDK_OFFSET(0xBCA4090)
#define CLASS_2_94DB529DA137E52D_GET_CURRENTTIME_OFFSET UNITYSDK_OFFSET(0xBCA40D0)
#define CLASS_2_94DB529DA137E52D_GET_DURATION_OFFSET UNITYSDK_OFFSET(0xBCA40B0)
#define CLASS_2_94DB529DA137E52D_GET_ENERGYDECREASESPEED_OFFSET UNITYSDK_OFFSET(0xBCA4070)
#define CLASS_2_94DB529DA137E52D_GET_ENHANCEQTEMODIFIERNAME_OFFSET UNITYSDK_OFFSET(0xBCA41B0)
#define CLASS_2_94DB529DA137E52D_GET_HASSENTCHARGEINTERRUPTNOTIFY_OFFSET UNITYSDK_OFFSET(0xBCA41F0)
#define CLASS_2_94DB529DA137E52D_GET_SPEEDLERPCURVE_OFFSET UNITYSDK_OFFSET(0xBCA4170)
#define CLASS_2_94DB529DA137E52D_GET_SPEEDLERPDURATION_OFFSET UNITYSDK_OFFSET(0xBCA4150)
#define CLASS_2_94DB529DA137E52D_GET_SPEED_OFFSET UNITYSDK_OFFSET(0xBCA4050)
#define CLASS_2_94DB529DA137E52D_GET_STARTOFFSET_OFFSET UNITYSDK_OFFSET(0xBCA4130)
#define CLASS_2_94DB529DA137E52D_GET_TARGETBASEMAXSPEED_OFFSET UNITYSDK_OFFSET(0xBCA4190)
#define CLASS_2_94DB529DA137E52D_GET_TASKUNLOCK_OFFSET UNITYSDK_OFFSET(0xBCA41D0)
#define CLASS_2_94DB529DA137E52D_SET_CENTERLERPCURVE_OFFSET UNITYSDK_OFFSET(0xBCA4120)
#define CLASS_2_94DB529DA137E52D_SET_CENTERLERPDURATION_OFFSET UNITYSDK_OFFSET(0xBCA4100)
#define CLASS_2_94DB529DA137E52D_SET_CHARGEINTERRUPTMINENERGYPERCENT_OFFSET UNITYSDK_OFFSET(0xBCA40A0)
#define CLASS_2_94DB529DA137E52D_SET_CURRENTTIME_OFFSET UNITYSDK_OFFSET(0xBCA40E0)
#define CLASS_2_94DB529DA137E52D_SET_DURATION_OFFSET UNITYSDK_OFFSET(0xBCA40C0)
#define CLASS_2_94DB529DA137E52D_SET_ENERGYDECREASESPEED_OFFSET UNITYSDK_OFFSET(0xBCA4080)
#define CLASS_2_94DB529DA137E52D_SET_ENHANCEQTEMODIFIERNAME_OFFSET UNITYSDK_OFFSET(0xBCA41C0)
#define CLASS_2_94DB529DA137E52D_SET_HASSENTCHARGEINTERRUPTNOTIFY_OFFSET UNITYSDK_OFFSET(0xBCA4200)
#define CLASS_2_94DB529DA137E52D_SET_SPEEDLERPCURVE_OFFSET UNITYSDK_OFFSET(0xBCA4180)
#define CLASS_2_94DB529DA137E52D_SET_SPEEDLERPDURATION_OFFSET UNITYSDK_OFFSET(0xBCA4160)
#define CLASS_2_94DB529DA137E52D_SET_SPEED_OFFSET UNITYSDK_OFFSET(0xBCA4060)
#define CLASS_2_94DB529DA137E52D_SET_STARTOFFSET_OFFSET UNITYSDK_OFFSET(0xBCA4140)
#define CLASS_2_94DB529DA137E52D_SET_TARGETBASEMAXSPEED_OFFSET UNITYSDK_OFFSET(0xBCA41A0)
#define CLASS_2_94DB529DA137E52D_SET_TASKUNLOCK_OFFSET UNITYSDK_OFFSET(0xBCA41E0)
#define CLASS_2_94DB529DA137E52D__CTOR_OFFSET UNITYSDK_OFFSET(0xBCA4210)

inline static constexpr unsigned int Class_2_94DB529DA137E52D_TypeDefinitionIndex = 75424;
...
public:
	...
	::System::String* _EnhanceQTEModifierName_k__BackingField; // 0x20
	::UnityEngine::AnimationCurve* _CenterLerpCurve_k__BackingField; // 0x28
	::System::String* _TaskUnlock_k__BackingField; // 0x30
	::System::Single _SpeedLerpDuration_k__BackingField; // 0x38
	::System::Single _StartOffset_k__BackingField; // 0x3C
	::System::Single _CurrentTime_k__BackingField; // 0x40
	::System::Single _Speed_k__BackingField; // 0x44
	::System::Single _EnergyDecreaseSpeed_k__BackingField; // 0x48
	::System::Boolean _HasSentChargeInterruptNotify_k__BackingField; // 0x4C
	::System::Single _TargetBaseMaxSpeed_k__BackingField; // 0x50
	::System::Single _Duration_k__BackingField; // 0x54
	::System::Single _CenterLerpDuration_k__BackingField; // 0x58
	::System::Single _ChargeInterruptMinEnergyPercent_k__BackingField; // 0x5C
