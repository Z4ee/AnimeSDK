...
#define CLASS_1_E620C0D36AB36D8A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16570980)
#define CLASS_1_E620C0D36AB36D8A_METHOD_1_096C7F7C8EC87129_OFFSET UNITYSDK_OFFSET(0x165706F0)
#define CLASS_1_E620C0D36AB36D8A_METHOD_1_2917BB48A903B3F0_1_OFFSET UNITYSDK_OFFSET(0x16571160)
#define CLASS_1_E620C0D36AB36D8A_METHOD_1_2917BB48A903B3F0_OFFSET UNITYSDK_OFFSET(0x16570FB0)
#define CLASS_1_E620C0D36AB36D8A_METHOD_1_2C95AFAD0256302F_OFFSET UNITYSDK_OFFSET(0x16570AB0)
#define CLASS_1_E620C0D36AB36D8A_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x16570B00)
#define CLASS_1_E620C0D36AB36D8A_METHOD_1_6747250BC2D13457_OFFSET UNITYSDK_OFFSET(0x165706A0)
#define CLASS_1_E620C0D36AB36D8A_METHOD_1_A5CB745FCEAC9303_1_OFFSET UNITYSDK_OFFSET(0x16570A40)
#define CLASS_1_E620C0D36AB36D8A_METHOD_1_A5CB745FCEAC9303_OFFSET UNITYSDK_OFFSET(0x165709D0)
#define CLASS_1_E620C0D36AB36D8A_METHOD_1_DB6AE91A68719504_1_OFFSET UNITYSDK_OFFSET(0x16570F30)
#define CLASS_1_E620C0D36AB36D8A_METHOD_1_DB6AE91A68719504_OFFSET UNITYSDK_OFFSET(0x16570DD0)
#define CLASS_1_E620C0D36AB36D8A_METHOD_1_E01406ED37757F06_OFFSET UNITYSDK_OFFSET(0x16570E50)
#define CLASS_1_E620C0D36AB36D8A__CTOR_OFFSET UNITYSDK_OFFSET(0x16570600)

inline static constexpr unsigned int Class_1_E620C0D36AB36D8A_TypeDefinitionIndex = 60325;

class Class_1_E620C0D36AB36D8A : public ::System::Object
{
public:
	// static const ::System::String* GKIEEMKHMKD; // 0x0
	// static const ::System::String* GMPEOEMJNKJ; // 0x0
	...
	::System::UInt32 EBHMCOPJMPB; // 0x28
	::System::UInt32 MMJKFDNCPCA; // 0x2C
	::System::UInt32 IMMBHNDAEJL; // 0x30
	::System::UInt32 LDMIPMABDGH; // 0x34
