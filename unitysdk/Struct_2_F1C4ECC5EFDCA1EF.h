...
#define STRUCT_2_F1C4ECC5EFDCA1EF_DECONSTRUCT_OFFSET UNITYSDK_OFFSET(0x3AE67D0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3AE99F0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_EQUALS_OFFSET UNITYSDK_OFFSET(0x3AE99B0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3AE99A0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_GET_ID_OFFSET UNITYSDK_OFFSET(0x12370)
#define STRUCT_2_F1C4ECC5EFDCA1EF_GET_PROTOTYPEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x161E0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_METHOD_2_21777270C6646173_OFFSET UNITYSDK_OFFSET(0x3AE9920)
#define STRUCT_2_F1C4ECC5EFDCA1EF_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x18B968E0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x18B968A0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_PRINTMEMBERS_OFFSET UNITYSDK_OFFSET(0x3AE9980)
#define STRUCT_2_F1C4ECC5EFDCA1EF_SET_ID_OFFSET UNITYSDK_OFFSET(0x379F970)
#define STRUCT_2_F1C4ECC5EFDCA1EF_SET_PROTOTYPEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x16050)
#define STRUCT_2_F1C4ECC5EFDCA1EF_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3AE9970)
#define STRUCT_2_F1C4ECC5EFDCA1EF__CTOR_OFFSET UNITYSDK_OFFSET(0x3AE66E0)

inline static constexpr unsigned int Struct_2_F1C4ECC5EFDCA1EF_TypeDefinitionIndex = 52269;

struct alignas(4) Struct_2_F1C4ECC5EFDCA1EF
{
	// static const ::System::UInt32 KPBMAPBBEDG = 0x0; // 0x0
