...
#define STRUCT_2_F1C4ECC5EFDCA1EF_DECONSTRUCT_OFFSET UNITYSDK_OFFSET(0x841F0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x2DF32B0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_EQUALS_OFFSET UNITYSDK_OFFSET(0x2DF3270)
#define STRUCT_2_F1C4ECC5EFDCA1EF_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2DF3260)
#define STRUCT_2_F1C4ECC5EFDCA1EF_GET_ID_OFFSET UNITYSDK_OFFSET(0xDAB0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_GET_PROTOTYPEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x5AB0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_METHOD_2_21777270C6646173_OFFSET UNITYSDK_OFFSET(0x2DF31E0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x160B9BE0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x160B9BA0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_PRINTMEMBERS_OFFSET UNITYSDK_OFFSET(0x2DF3240)
#define STRUCT_2_F1C4ECC5EFDCA1EF_SET_ID_OFFSET UNITYSDK_OFFSET(0xDAC0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_SET_PROTOTYPEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0xC610)
#define STRUCT_2_F1C4ECC5EFDCA1EF_TOSTRING_OFFSET UNITYSDK_OFFSET(0x2DF3230)
#define STRUCT_2_F1C4ECC5EFDCA1EF__CTOR_OFFSET UNITYSDK_OFFSET(0x84130)
