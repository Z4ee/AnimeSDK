...
#define CLASS_3_E8B61C262646DFD9_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C0C4C10)
#define CLASS_3_E8B61C262646DFD9_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C0C4C80)
#define CLASS_3_E8B61C262646DFD9_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C0BEA00)
#define CLASS_3_E8B61C262646DFD9__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0C4BA0)

inline static constexpr unsigned int Class_3_E8B61C262646DFD9_TypeDefinitionIndex = 35574;
