...
#define CINEMACHINE_CINEMACHINEBRAIN__AFTERPHYSICS_D__33_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1F6BF5F0)
#define CINEMACHINE_CINEMACHINEBRAIN__AFTERPHYSICS_D__33_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1F6BF6F0)
#define CINEMACHINE_CINEMACHINEBRAIN__AFTERPHYSICS_D__33_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1F6BF750)
#define CINEMACHINE_CINEMACHINEBRAIN__AFTERPHYSICS_D__33_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1F6BF700)
#define CINEMACHINE_CINEMACHINEBRAIN__AFTERPHYSICS_D__33_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1F6BF5E0)
#define CINEMACHINE_CINEMACHINEBRAIN__AFTERPHYSICS_D__33__CTOR_OFFSET UNITYSDK_OFFSET(0x1F6BF5D0)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineBrain__AfterPhysics_d__33_TypeDefinitionIndex = 34649;
