...
#define CINEMACHINE_CINEMACHINEBRAIN__AFTERPHYSICS_D__33_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BF60430)
#define CINEMACHINE_CINEMACHINEBRAIN__AFTERPHYSICS_D__33_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BF60530)
#define CINEMACHINE_CINEMACHINEBRAIN__AFTERPHYSICS_D__33_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BF60590)
#define CINEMACHINE_CINEMACHINEBRAIN__AFTERPHYSICS_D__33_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BF60540)
#define CINEMACHINE_CINEMACHINEBRAIN__AFTERPHYSICS_D__33_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BF60420)
#define CINEMACHINE_CINEMACHINEBRAIN__AFTERPHYSICS_D__33__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF60410)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineBrain__AfterPhysics_d__33_TypeDefinitionIndex = 32462;
