...
#define CINEMACHINE_CINEMACHINEIMPULSEMANAGER_ENVELOPEDEFINITION_CHANGESTOPTIME_OFFSET UNITYSDK_OFFSET(0x14EC8F0)
#define CINEMACHINE_CINEMACHINEIMPULSEMANAGER_ENVELOPEDEFINITION_CLEAR_OFFSET UNITYSDK_OFFSET(0x14EC930)
#define CINEMACHINE_CINEMACHINEIMPULSEMANAGER_ENVELOPEDEFINITION_DEFAULT_OFFSET UNITYSDK_OFFSET(0x119BD220)
#define CINEMACHINE_CINEMACHINEIMPULSEMANAGER_ENVELOPEDEFINITION_GETVALUEAT_OFFSET UNITYSDK_OFFSET(0x14EC8E0)
#define CINEMACHINE_CINEMACHINEIMPULSEMANAGER_ENVELOPEDEFINITION_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x14EC8C0)
#define CINEMACHINE_CINEMACHINEIMPULSEMANAGER_ENVELOPEDEFINITION_VALIDATE_OFFSET UNITYSDK_OFFSET(0x14EC940)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineImpulseManager_EnvelopeDefinition_TypeDefinitionIndex = 30915;
