...
#define CINEMACHINE_CONFINEROVEN_ASPECTSTRETCHER_GET_ASPECT_OFFSET UNITYSDK_OFFSET(0x45B300)
#define CINEMACHINE_CONFINEROVEN_ASPECTSTRETCHER_STRETCH_OFFSET UNITYSDK_OFFSET(0xA64850)
#define CINEMACHINE_CONFINEROVEN_ASPECTSTRETCHER_UNSTRETCH_OFFSET UNITYSDK_OFFSET(0xA64880)
#define CINEMACHINE_CONFINEROVEN_ASPECTSTRETCHER__CTOR_OFFSET UNITYSDK_OFFSET(0xA64830)

namespace Cinemachine
{
	inline static constexpr unsigned int ConfinerOven_AspectStretcher_TypeDefinitionIndex = 34134;
