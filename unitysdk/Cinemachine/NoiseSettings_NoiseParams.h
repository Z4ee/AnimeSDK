...
#define CINEMACHINE_NOISESETTINGS_NOISEPARAMS_GETVALUEAT_OFFSET UNITYSDK_OFFSET(0x9B37F0)

namespace Cinemachine
{
	inline static constexpr unsigned int NoiseSettings_NoiseParams_TypeDefinitionIndex = 32599;
