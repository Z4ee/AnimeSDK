...
#define CINEMACHINE_CINEMACHINESHOTBASE_GET_CALCULATEINRUNTIME_OFFSET UNITYSDK_OFFSET(0xACFDF80)
#define CINEMACHINE_CINEMACHINESHOTBASE_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0xACFDE70)
#define CINEMACHINE_CINEMACHINESHOTBASE_GET_STAGE_OFFSET UNITYSDK_OFFSET(0xACFDFA0)
#define CINEMACHINE_CINEMACHINESHOTBASE_METHOD_6_07AF65C462E0D8FA_OFFSET UNITYSDK_OFFSET(0xACFD2E0)
#define CINEMACHINE_CINEMACHINESHOTBASE_METHOD_6_1F7078DEAED43133_OFFSET UNITYSDK_OFFSET(0xACFE1B0)
#define CINEMACHINE_CINEMACHINESHOTBASE_METHOD_6_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xACFDF40)
#define CINEMACHINE_CINEMACHINESHOTBASE_METHOD_6_A1D8CD775DEC3C21_1_OFFSET UNITYSDK_OFFSET(0xACFD290)
#define CINEMACHINE_CINEMACHINESHOTBASE_METHOD_6_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0xACFD350)
#define CINEMACHINE_CINEMACHINESHOTBASE_METHOD_6_C4D99CFCA628428A_OFFSET UNITYSDK_OFFSET(0xACFE160)
#define CINEMACHINE_CINEMACHINESHOTBASE_METHOD_6_D64FD9A228A1C4E0_OFFSET UNITYSDK_OFFSET(0xACFD220)
#define CINEMACHINE_CINEMACHINESHOTBASE_MUTATECAMERASTATE_OFFSET UNITYSDK_OFFSET(0xACFE020)
#define CINEMACHINE_CINEMACHINESHOTBASE_PREPIPELINEMUTATECAMERASTATE_OFFSET UNITYSDK_OFFSET(0xACFDFB0)
#define CINEMACHINE_CINEMACHINESHOTBASE_SET_CALCULATEINRUNTIME_OFFSET UNITYSDK_OFFSET(0xACFDF90)
#define CINEMACHINE_CINEMACHINESHOTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xACFDDD0)
#define CINEMACHINE_CINEMACHINESHOTBASE___IFIXBASEPROXY_PREPIPELINEMUTATECAMERASTATE_OFFSET UNITYSDK_OFFSET(0xACFE220)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineShotBase_TypeDefinitionIndex = 46239;
