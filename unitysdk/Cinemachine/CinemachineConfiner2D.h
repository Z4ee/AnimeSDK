...
#define CINEMACHINE_CINEMACHINECONFINER2D_CALCULATEHALFFRUSTUMHEIGHT_OFFSET UNITYSDK_OFFSET(0x1C3575B0)
#define CINEMACHINE_CINEMACHINECONFINER2D_INVALIDATECACHE_OFFSET UNITYSDK_OFFSET(0x1C356D70)
#define CINEMACHINE_CINEMACHINECONFINER2D_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1C357610)
#define CINEMACHINE_CINEMACHINECONFINER2D_POSTPIPELINESTAGECALLBACK_OFFSET UNITYSDK_OFFSET(0x1C356E50)
#define CINEMACHINE_CINEMACHINECONFINER2D_RESET_OFFSET UNITYSDK_OFFSET(0x1C357630)
#define CINEMACHINE_CINEMACHINECONFINER2D_VALIDATECACHE_OFFSET UNITYSDK_OFFSET(0x1C356E10)
#define CINEMACHINE_CINEMACHINECONFINER2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1C357640)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineConfiner2D_TypeDefinitionIndex = 32472;
