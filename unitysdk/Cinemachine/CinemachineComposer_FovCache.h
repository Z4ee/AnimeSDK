...
#define CINEMACHINE_CINEMACHINECOMPOSER_FOVCACHE_SCREENTOFOV_OFFSET UNITYSDK_OFFSET(0x39509D0)
#define CINEMACHINE_CINEMACHINECOMPOSER_FOVCACHE_UPDATECACHE_OFFSET UNITYSDK_OFFSET(0x3950960)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineComposer_FovCache_TypeDefinitionIndex = 37616;
