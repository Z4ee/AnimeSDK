...
#define CINEMACHINE_NAPAXISSTATE_RECENTERING_CANCELRECENTERING_OFFSET UNITYSDK_OFFSET(0xAA1320)
#define CINEMACHINE_NAPAXISSTATE_RECENTERING_COPYSTATEFROM_OFFSET UNITYSDK_OFFSET(0xAA12F0)
#define CINEMACHINE_NAPAXISSTATE_RECENTERING_DORECENTERING_OFFSET UNITYSDK_OFFSET(0xAA1350)
#define CINEMACHINE_NAPAXISSTATE_RECENTERING_LEGACYUPGRADE_OFFSET UNITYSDK_OFFSET(0xAA1360)
#define CINEMACHINE_NAPAXISSTATE_RECENTERING_RECENTERNOW_OFFSET UNITYSDK_OFFSET(0xAA1340)
#define CINEMACHINE_NAPAXISSTATE_RECENTERING_VALIDATE_OFFSET UNITYSDK_OFFSET(0xAA12E0)
#define CINEMACHINE_NAPAXISSTATE_RECENTERING__CTOR_OFFSET UNITYSDK_OFFSET(0xAA12C0)

namespace Cinemachine
{
	inline static constexpr unsigned int NapAxisState_Recentering_TypeDefinitionIndex = 34779;
