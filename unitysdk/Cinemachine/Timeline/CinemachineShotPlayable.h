...
#define CINEMACHINE_TIMELINE_CINEMACHINESHOTPLAYABLE_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x14667150)
#define CINEMACHINE_TIMELINE_CINEMACHINESHOTPLAYABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x14668250)

namespace Cinemachine::Timeline
{
	inline static constexpr unsigned int CinemachineShotPlayable_TypeDefinitionIndex = 36944;
