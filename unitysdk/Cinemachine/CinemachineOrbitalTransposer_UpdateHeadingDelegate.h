...
#define CINEMACHINE_CINEMACHINEORBITALTRANSPOSER_UPDATEHEADINGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x12B94270)
#define CINEMACHINE_CINEMACHINEORBITALTRANSPOSER_UPDATEHEADINGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x12B942F0)
#define CINEMACHINE_CINEMACHINEORBITALTRANSPOSER_UPDATEHEADINGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x12B92160)
#define CINEMACHINE_CINEMACHINEORBITALTRANSPOSER_UPDATEHEADINGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x12B87DD0)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineOrbitalTransposer_UpdateHeadingDelegate_TypeDefinitionIndex = 36546;
