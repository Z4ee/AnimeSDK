...
#define CINEMACHINE_CAMERASTATE_CUSTOMBLENDABLE__CTOR_OFFSET UNITYSDK_OFFSET(0xD8360)

namespace Cinemachine
{
	inline static constexpr unsigned int CameraState_CustomBlendable_TypeDefinitionIndex = 36563;
