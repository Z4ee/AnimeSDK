...
#define CINEMACHINE_CINEMACHINEVIRTUALCAMERA_ONUPDATEVIRTUALCAMERADELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x172A54D0)
#define CINEMACHINE_CINEMACHINEVIRTUALCAMERA_ONUPDATEVIRTUALCAMERADELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x172A5500)
#define CINEMACHINE_CINEMACHINEVIRTUALCAMERA_ONUPDATEVIRTUALCAMERADELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1727AA60)
#define CINEMACHINE_CINEMACHINEVIRTUALCAMERA_ONUPDATEVIRTUALCAMERADELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x172A5460)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineVirtualCamera_OnUpdateVirtualCameraDelegate_TypeDefinitionIndex = 37609;
