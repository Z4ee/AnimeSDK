...
namespace Cinemachine
{
	...
	public:
		...
		{
			return (::UnityEngine::Events::UnityAction_1<::Cinemachine::CinemachineBrain*>**)Il2CppClass::FromTypeDefinitionIndex(CinemachineStoryboard___O_TypeDefinitionIndex)->GetStaticField(0x31C00);
		}
	};
}
