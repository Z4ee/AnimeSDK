...
#define CINEMACHINE_NOISESETTINGS_GETCOMBINEDFILTERRESULTS_OFFSET UNITYSDK_OFFSET(0x1C0FFBF0)
#define CINEMACHINE_NOISESETTINGS_GETSIGNAL_OFFSET UNITYSDK_OFFSET(0x1C0FFE50)
#define CINEMACHINE_NOISESETTINGS_GET_SIGNALDURATION_OFFSET UNITYSDK_OFFSET(0x1C0FFE40)
#define CINEMACHINE_NOISESETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0FFF40)

namespace Cinemachine
{
	inline static constexpr unsigned int NoiseSettings_TypeDefinitionIndex = 32598;
