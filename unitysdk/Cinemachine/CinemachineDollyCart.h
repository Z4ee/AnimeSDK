...
#define CINEMACHINE_CINEMACHINEDOLLYCART_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x164587E0)
#define CINEMACHINE_CINEMACHINEDOLLYCART_INITPOSITIONANDROTATION_OFFSET UNITYSDK_OFFSET(0x16458D60)
#define CINEMACHINE_CINEMACHINEDOLLYCART_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x16458B20)
#define CINEMACHINE_CINEMACHINEDOLLYCART_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0x16458B90)
#define CINEMACHINE_CINEMACHINEDOLLYCART_SETCARTPOSITION_OFFSET UNITYSDK_OFFSET(0x16458840)
#define CINEMACHINE_CINEMACHINEDOLLYCART_UPDATE_OFFSET UNITYSDK_OFFSET(0x16458AB0)
#define CINEMACHINE_CINEMACHINEDOLLYCART__CTOR_OFFSET UNITYSDK_OFFSET(0x16458D70)
