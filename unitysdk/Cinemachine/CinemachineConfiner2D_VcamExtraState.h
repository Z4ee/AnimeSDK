...
#define CINEMACHINE_CINEMACHINECONFINER2D_VCAMEXTRASTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F6C1000)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineConfiner2D_VcamExtraState_TypeDefinitionIndex = 34660;
	...
	public:
		...
		::UnityEngine::Vector3 m_DampedDisplacement; // 0x20
		::UnityEngine::Vector3 m_PreviousDisplacement; // 0x2C
