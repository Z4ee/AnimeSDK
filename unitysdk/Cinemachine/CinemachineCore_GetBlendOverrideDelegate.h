...
#define CINEMACHINE_CINEMACHINECORE_GETBLENDOVERRIDEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1727B1F0)
#define CINEMACHINE_CINEMACHINECORE_GETBLENDOVERRIDEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1727B290)
#define CINEMACHINE_CINEMACHINECORE_GETBLENDOVERRIDEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1726B8C0)
#define CINEMACHINE_CINEMACHINECORE_GETBLENDOVERRIDEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1727B100)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineCore_GetBlendOverrideDelegate_TypeDefinitionIndex = 37657;
