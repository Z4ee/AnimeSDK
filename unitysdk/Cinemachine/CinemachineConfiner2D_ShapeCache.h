...
#define CINEMACHINE_CINEMACHINECONFINER2D_SHAPECACHE_CALCULATEDELTATRANSFORMATIONMATRIX_OFFSET UNITYSDK_OFFSET(0x9BC740)
#define CINEMACHINE_CINEMACHINECONFINER2D_SHAPECACHE_INVALIDATE_OFFSET UNITYSDK_OFFSET(0x9BC680)
#define CINEMACHINE_CINEMACHINECONFINER2D_SHAPECACHE_ISVALID_OFFSET UNITYSDK_OFFSET(0x9BC730)
#define CINEMACHINE_CINEMACHINECONFINER2D_SHAPECACHE_VALIDATECACHE_OFFSET UNITYSDK_OFFSET(0x9BC720)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineConfiner2D_ShapeCache_TypeDefinitionIndex = 32474;
