...
#define CINEMACHINE_CINEMACHINECONFINER2D_SHAPECACHE_CALCULATEDELTATRANSFORMATIONMATRIX_OFFSET UNITYSDK_OFFSET(0xA5E550)
#define CINEMACHINE_CINEMACHINECONFINER2D_SHAPECACHE_INVALIDATE_OFFSET UNITYSDK_OFFSET(0xA5E490)
#define CINEMACHINE_CINEMACHINECONFINER2D_SHAPECACHE_ISVALID_OFFSET UNITYSDK_OFFSET(0xA5E540)
#define CINEMACHINE_CINEMACHINECONFINER2D_SHAPECACHE_VALIDATECACHE_OFFSET UNITYSDK_OFFSET(0xA5E530)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineConfiner2D_ShapeCache_TypeDefinitionIndex = 34025;
