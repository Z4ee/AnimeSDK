...
#define CINEMACHINE_NAPVIRTUALCAMERACORE_CHECHCAMERAMOVEMODESTACKEMPTY_OFFSET UNITYSDK_OFFSET(0x1F94A460)
#define CINEMACHINE_NAPVIRTUALCAMERACORE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1F94A2F0)
#define CINEMACHINE_NAPVIRTUALCAMERACORE_GET_M_ETARGETANIMSTATE_OFFSET UNITYSDK_OFFSET(0x1F94A2D0)
#define CINEMACHINE_NAPVIRTUALCAMERACORE_GET_M_ETARGETDIRSTATE_OFFSET UNITYSDK_OFFSET(0x1F94A2B0)
#define CINEMACHINE_NAPVIRTUALCAMERACORE_ISCAMERAMOVEMODESTACKEMPTY_OFFSET UNITYSDK_OFFSET(0x1F94A610)
#define CINEMACHINE_NAPVIRTUALCAMERACORE_PEEKCAMERAMOVEMODESTACK_OFFSET UNITYSDK_OFFSET(0x1F94A8A0)
#define CINEMACHINE_NAPVIRTUALCAMERACORE_PICKCAMERAMOVEMODESTACK_OFFSET UNITYSDK_OFFSET(0x1F94A630)
#define CINEMACHINE_NAPVIRTUALCAMERACORE_POPCAMERAMOVEMODESTACK_1_OFFSET UNITYSDK_OFFSET(0x1F94A800)
#define CINEMACHINE_NAPVIRTUALCAMERACORE_POPCAMERAMOVEMODESTACK_OFFSET UNITYSDK_OFFSET(0x1F94A6D0)
#define CINEMACHINE_NAPVIRTUALCAMERACORE_POPLASTANDPUSHCAMERAMOVEMODESTACK_OFFSET UNITYSDK_OFFSET(0x1F94A5B0)
#define CINEMACHINE_NAPVIRTUALCAMERACORE_PUSHCAMERAMOVEMODESTACK_OFFSET UNITYSDK_OFFSET(0x1F94A4C0)
#define CINEMACHINE_NAPVIRTUALCAMERACORE_SET_M_ETARGETANIMSTATE_OFFSET UNITYSDK_OFFSET(0x1F94A2E0)
#define CINEMACHINE_NAPVIRTUALCAMERACORE_SET_M_ETARGETDIRSTATE_OFFSET UNITYSDK_OFFSET(0x1F94A2C0)
#define CINEMACHINE_NAPVIRTUALCAMERACORE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F94A940)
#define CINEMACHINE_NAPVIRTUALCAMERACORE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F94A3E0)

namespace Cinemachine
{
	inline static constexpr unsigned int NapVirtualCameraCore_TypeDefinitionIndex = 34783;
	...
	public:
		...
		{
			return (::Cinemachine::NapVirtualCameraCore**)Il2CppClass::FromTypeDefinitionIndex(NapVirtualCameraCore_TypeDefinitionIndex)->GetStaticField(0x29000);
		}
