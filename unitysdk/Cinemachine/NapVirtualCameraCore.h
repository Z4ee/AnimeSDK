...
#define CINEMACHINE_NAPVIRTUALCAMERACORE_CHECHCAMERAMOVEMODESTACKEMPTY_OFFSET UNITYSDK_OFFSET(0x1C20AD30)
#define CINEMACHINE_NAPVIRTUALCAMERACORE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1C20ABC0)
#define CINEMACHINE_NAPVIRTUALCAMERACORE_GET_M_ETARGETANIMSTATE_OFFSET UNITYSDK_OFFSET(0x1C20ABA0)
#define CINEMACHINE_NAPVIRTUALCAMERACORE_GET_M_ETARGETDIRSTATE_OFFSET UNITYSDK_OFFSET(0x1C20AB80)
#define CINEMACHINE_NAPVIRTUALCAMERACORE_ISCAMERAMOVEMODESTACKEMPTY_OFFSET UNITYSDK_OFFSET(0x1C20AEE0)
#define CINEMACHINE_NAPVIRTUALCAMERACORE_PEEKCAMERAMOVEMODESTACK_OFFSET UNITYSDK_OFFSET(0x1C20B170)
#define CINEMACHINE_NAPVIRTUALCAMERACORE_PICKCAMERAMOVEMODESTACK_OFFSET UNITYSDK_OFFSET(0x1C20AF00)
#define CINEMACHINE_NAPVIRTUALCAMERACORE_POPCAMERAMOVEMODESTACK_1_OFFSET UNITYSDK_OFFSET(0x1C20B0D0)
#define CINEMACHINE_NAPVIRTUALCAMERACORE_POPCAMERAMOVEMODESTACK_OFFSET UNITYSDK_OFFSET(0x1C20AFA0)
#define CINEMACHINE_NAPVIRTUALCAMERACORE_POPLASTANDPUSHCAMERAMOVEMODESTACK_OFFSET UNITYSDK_OFFSET(0x1C20AE80)
#define CINEMACHINE_NAPVIRTUALCAMERACORE_PUSHCAMERAMOVEMODESTACK_OFFSET UNITYSDK_OFFSET(0x1C20AD90)
#define CINEMACHINE_NAPVIRTUALCAMERACORE_SET_M_ETARGETANIMSTATE_OFFSET UNITYSDK_OFFSET(0x1C20ABB0)
#define CINEMACHINE_NAPVIRTUALCAMERACORE_SET_M_ETARGETDIRSTATE_OFFSET UNITYSDK_OFFSET(0x1C20AB90)
#define CINEMACHINE_NAPVIRTUALCAMERACORE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C20B210)
#define CINEMACHINE_NAPVIRTUALCAMERACORE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C20ACB0)

namespace Cinemachine
{
	inline static constexpr unsigned int NapVirtualCameraCore_TypeDefinitionIndex = 32596;
	...
	public:
		...
		{
			return (::Cinemachine::NapVirtualCameraCore**)Il2CppClass::FromTypeDefinitionIndex(NapVirtualCameraCore_TypeDefinitionIndex)->GetStaticField(0x25D70);
		}
		...
		::System::Int32 _m_eTargetDirState_k__BackingField; // 0x18
