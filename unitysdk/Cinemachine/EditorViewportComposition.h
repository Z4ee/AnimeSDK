...
#define CINEMACHINE_EDITORVIEWPORTCOMPOSITION_METHOD_2_46D5C4F0EA172C6A_OFFSET UNITYSDK_OFFSET(0x856E0)
#define CINEMACHINE_EDITORVIEWPORTCOMPOSITION_METHOD_2_C21A7AC6282FB0D0_OFFSET UNITYSDK_OFFSET(0x85690)
#define CINEMACHINE_EDITORVIEWPORTCOMPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x85670)

namespace Cinemachine
{
	inline static constexpr unsigned int EditorViewportComposition_TypeDefinitionIndex = 40324;
