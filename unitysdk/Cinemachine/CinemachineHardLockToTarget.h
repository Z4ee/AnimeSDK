...
#define CINEMACHINE_CINEMACHINEHARDLOCKTOTARGET_GETMAXDAMPTIME_OFFSET UNITYSDK_OFFSET(0x12B8A530)
#define CINEMACHINE_CINEMACHINEHARDLOCKTOTARGET_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x12B8A4C0)
#define CINEMACHINE_CINEMACHINEHARDLOCKTOTARGET_GET_STAGE_OFFSET UNITYSDK_OFFSET(0x12B8A520)
#define CINEMACHINE_CINEMACHINEHARDLOCKTOTARGET_MUTATECAMERASTATE_OFFSET UNITYSDK_OFFSET(0x12B8A540)
#define CINEMACHINE_CINEMACHINEHARDLOCKTOTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x12B8A990)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineHardLockToTarget_TypeDefinitionIndex = 36541;
