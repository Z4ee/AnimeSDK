...
#define CINEMACHINE_UTILITY_GAUSSIANWINDOW1D_VECTOR3_COMPUTE_OFFSET UNITYSDK_OFFSET(0x1D21A1E0)
#define CINEMACHINE_UTILITY_GAUSSIANWINDOW1D_VECTOR3__CTOR_OFFSET UNITYSDK_OFFSET(0x1D21A190)

namespace Cinemachine::Utility
{
	inline static constexpr unsigned int GaussianWindow1D_Vector3_TypeDefinitionIndex = 37733;
