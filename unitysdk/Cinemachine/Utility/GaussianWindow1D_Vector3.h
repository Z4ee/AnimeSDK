...
#define CINEMACHINE_UTILITY_GAUSSIANWINDOW1D_VECTOR3_COMPUTE_OFFSET UNITYSDK_OFFSET(0x1466A110)
#define CINEMACHINE_UTILITY_GAUSSIANWINDOW1D_VECTOR3__CTOR_OFFSET UNITYSDK_OFFSET(0x1466A0C0)

namespace Cinemachine::Utility
{
	inline static constexpr unsigned int GaussianWindow1D_Vector3_TypeDefinitionIndex = 36951;
