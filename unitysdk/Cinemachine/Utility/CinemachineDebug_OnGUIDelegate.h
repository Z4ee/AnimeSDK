...
#define CINEMACHINE_UTILITY_CINEMACHINEDEBUG_ONGUIDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C100F00)
#define CINEMACHINE_UTILITY_CINEMACHINEDEBUG_ONGUIDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C100F30)
#define CINEMACHINE_UTILITY_CINEMACHINEDEBUG_ONGUIDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C100C60)
#define CINEMACHINE_UTILITY_CINEMACHINEDEBUG_ONGUIDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0FB660)

namespace Cinemachine::Utility
{
	inline static constexpr unsigned int CinemachineDebug_OnGUIDelegate_TypeDefinitionIndex = 32640;
