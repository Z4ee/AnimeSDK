...
#define CINEMACHINE_UTILITY_CINEMACHINEDEBUG_ONGUIDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E426E90)
#define CINEMACHINE_UTILITY_CINEMACHINEDEBUG_ONGUIDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E426EC0)
#define CINEMACHINE_UTILITY_CINEMACHINEDEBUG_ONGUIDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E426BF0)
#define CINEMACHINE_UTILITY_CINEMACHINEDEBUG_ONGUIDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4215F0)

namespace Cinemachine::Utility
{
	inline static constexpr unsigned int CinemachineDebug_OnGUIDelegate_TypeDefinitionIndex = 34191;
