...
#define CINEMACHINE_UTILITY_CINEMACHINEDEBUG_ONGUIDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x119DDE70)
#define CINEMACHINE_UTILITY_CINEMACHINEDEBUG_ONGUIDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x119DDEA0)
#define CINEMACHINE_UTILITY_CINEMACHINEDEBUG_ONGUIDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x119DDBD0)
#define CINEMACHINE_UTILITY_CINEMACHINEDEBUG_ONGUIDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x119DDBB0)

namespace Cinemachine::Utility
{
	inline static constexpr unsigned int CinemachineDebug_OnGUIDelegate_TypeDefinitionIndex = 30929;
