...
#define CINEMACHINE_GROUPWEIGHTMANIPULATOR_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x119D8780)
#define CINEMACHINE_GROUPWEIGHTMANIPULATOR_START_OFFSET UNITYSDK_OFFSET(0x119D86F0)
#define CINEMACHINE_GROUPWEIGHTMANIPULATOR_UPDATEWEIGHTS_OFFSET UNITYSDK_OFFSET(0x119D87C0)
#define CINEMACHINE_GROUPWEIGHTMANIPULATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x119D87A0)
#define CINEMACHINE_GROUPWEIGHTMANIPULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x119D88A0)

namespace Cinemachine
{
	inline static constexpr unsigned int GroupWeightManipulator_TypeDefinitionIndex = 30904;
