...
#define CINEMACHINE_CINEMACHINEIMPULSELISTENER_POSTPIPELINESTAGECALLBACK_OFFSET UNITYSDK_OFFSET(0x1C0F9870)
#define CINEMACHINE_CINEMACHINEIMPULSELISTENER_RESET_OFFSET UNITYSDK_OFFSET(0x1C0F9850)
#define CINEMACHINE_CINEMACHINEIMPULSELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0F9AC0)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineImpulseListener_TypeDefinitionIndex = 32627;
