...
#define CINEMACHINE_CINEMACHINECORE_UPDATESTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1F489310)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineCore_UpdateStatus_TypeDefinitionIndex = 34743;

	class CinemachineCore_UpdateStatus : public ::System::Object
	{
	public:
		::System::Single lastUpdateDeltaTime; // 0x10
		::System::Int32 lastUpdateFixedFrame; // 0x14
		::System::Int32 lastUpdateFrame; // 0x18
		::Cinemachine::UpdateTracker_UpdateClock lastUpdateMode; // 0x1C
