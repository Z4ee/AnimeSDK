...
#define CINEMACHINE_CINEMACHINECORE_UPDATESTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x12B7B800)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineCore_UpdateStatus_TypeDefinitionIndex = 36576;
	...
	public:
		...
		::System::Int32 lastUpdateFixedFrame; // 0x18
