...
#define CINEMACHINE_CINEMACHINECORE_UPDATESTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1463AF80)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineCore_UpdateStatus_TypeDefinitionIndex = 36876;
