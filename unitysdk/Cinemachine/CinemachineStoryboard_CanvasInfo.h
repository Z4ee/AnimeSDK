...
#define CINEMACHINE_CINEMACHINESTORYBOARD_CANVASINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1729CA50)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineStoryboard_CanvasInfo_TypeDefinitionIndex = 37600;
	...
	public:
		...
		::UnityEngine::GameObject* mCanvas; // 0x28
