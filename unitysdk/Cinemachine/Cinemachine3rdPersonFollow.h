...
#define CINEMACHINE_CINEMACHINE3RDPERSONFOLLOW_GETHEADING_OFFSET UNITYSDK_OFFSET(0x1F6BEB10)
#define CINEMACHINE_CINEMACHINE3RDPERSONFOLLOW_GETMAXDAMPTIME_OFFSET UNITYSDK_OFFSET(0x1F6BD550)
#define CINEMACHINE_CINEMACHINE3RDPERSONFOLLOW_GETRAWRIGPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1F6BEBF0)
#define CINEMACHINE_CINEMACHINE3RDPERSONFOLLOW_GETRIGPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1F6BF1D0)
#define CINEMACHINE_CINEMACHINE3RDPERSONFOLLOW_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x1F6BD180)
#define CINEMACHINE_CINEMACHINE3RDPERSONFOLLOW_GET_STAGE_OFFSET UNITYSDK_OFFSET(0x1F6BD540)
#define CINEMACHINE_CINEMACHINE3RDPERSONFOLLOW_MUTATECAMERASTATE_OFFSET UNITYSDK_OFFSET(0x1F6BD570)
#define CINEMACHINE_CINEMACHINE3RDPERSONFOLLOW_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1F6BD120)
#define CINEMACHINE_CINEMACHINE3RDPERSONFOLLOW_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1F6BD090)
#define CINEMACHINE_CINEMACHINE3RDPERSONFOLLOW_POSITIONCAMERA_OFFSET UNITYSDK_OFFSET(0x1F6BDA10)
#define CINEMACHINE_CINEMACHINE3RDPERSONFOLLOW_RESET_OFFSET UNITYSDK_OFFSET(0x1F6BD0F0)
#define CINEMACHINE_CINEMACHINE3RDPERSONFOLLOW_RESOLVECOLLISIONS_OFFSET UNITYSDK_OFFSET(0x1F6BEF50)
#define CINEMACHINE_CINEMACHINE3RDPERSONFOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1F6BF520)

namespace Cinemachine
{
	inline static constexpr unsigned int Cinemachine3rdPersonFollow_TypeDefinitionIndex = 34696;
