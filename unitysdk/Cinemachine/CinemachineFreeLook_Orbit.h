...
#define CINEMACHINE_CINEMACHINEFREELOOK_ORBIT__CTOR_OFFSET UNITYSDK_OFFSET(0x43F560)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineFreeLook_Orbit_TypeDefinitionIndex = 32481;
