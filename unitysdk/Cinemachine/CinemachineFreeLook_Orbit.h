...
#define CINEMACHINE_CINEMACHINEFREELOOK_ORBIT__CTOR_OFFSET UNITYSDK_OFFSET(0x29890)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineFreeLook_Orbit_TypeDefinitionIndex = 30781;
