...
#define CINEMACHINE_CINEMACHINEFREELOOK_ORBIT__CTOR_OFFSET UNITYSDK_OFFSET(0x4E4210)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineFreeLook_Orbit_TypeDefinitionIndex = 34668;
