...
#define CINEMACHINE_CINEMACHINEINDEPENDENTIMPULSELISTENER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x119BEF20)
#define CINEMACHINE_CINEMACHINEINDEPENDENTIMPULSELISTENER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x119BED10)
#define CINEMACHINE_CINEMACHINEINDEPENDENTIMPULSELISTENER_RESET_OFFSET UNITYSDK_OFFSET(0x119BECF0)
#define CINEMACHINE_CINEMACHINEINDEPENDENTIMPULSELISTENER_UPDATE_OFFSET UNITYSDK_OFFSET(0x119BED30)
#define CINEMACHINE_CINEMACHINEINDEPENDENTIMPULSELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x119BF260)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineIndependentImpulseListener_TypeDefinitionIndex = 30920;
