...
#define STRUCT_2_0FFD957D5C10AA0F_METHOD_2_1F8314262457963A_OFFSET UNITYSDK_OFFSET(0x820D50)
#define STRUCT_2_0FFD957D5C10AA0F_METHOD_2_5489F9CD0AA85DE6_OFFSET UNITYSDK_OFFSET(0x820CD0)
#define STRUCT_2_0FFD957D5C10AA0F_METHOD_2_77E6E3DA1F0E9CCC_OFFSET UNITYSDK_OFFSET(0x820D70)
#define STRUCT_2_0FFD957D5C10AA0F_METHOD_2_9C72894CB5D45A5A_OFFSET UNITYSDK_OFFSET(0x820D40)
#define STRUCT_2_0FFD957D5C10AA0F_METHOD_2_C3B21C74C45D6F86_OFFSET UNITYSDK_OFFSET(0x820D00)
#define STRUCT_2_0FFD957D5C10AA0F_METHOD_2_F088209CA8D65638_OFFSET UNITYSDK_OFFSET(0x820D90)
#define STRUCT_2_0FFD957D5C10AA0F_PROCESSANIMATION_OFFSET UNITYSDK_OFFSET(0x820C50)
#define STRUCT_2_0FFD957D5C10AA0F_PROCESSROOTMOTION_OFFSET UNITYSDK_OFFSET(0x820C90)
#define STRUCT_2_0FFD957D5C10AA0F__CCTOR_OFFSET UNITYSDK_OFFSET(0x168F08C0)
#define STRUCT_2_0FFD957D5C10AA0F__CTOR_OFFSET UNITYSDK_OFFSET(0x820BC0)

inline static constexpr unsigned int Struct_2_0FFD957D5C10AA0F_TypeDefinitionIndex = 52751;

struct alignas(8) Struct_2_0FFD957D5C10AA0F
{
	static ::Struct_2_0FFD957D5C10AA0F* StaticGet_Field_2_6()
	{
		return (::Struct_2_0FFD957D5C10AA0F*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_0FFD957D5C10AA0F_TypeDefinitionIndex)->GetStaticField(0xFFA0);
	}
