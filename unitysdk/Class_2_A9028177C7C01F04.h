...
#define CLASS_2_A9028177C7C01F04_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBF190B0)
#define CLASS_2_A9028177C7C01F04_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xBF190F0)
#define CLASS_2_A9028177C7C01F04_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xBF19A80)
#define CLASS_2_A9028177C7C01F04_TICK_OFFSET UNITYSDK_OFFSET(0xBF19AD0)
#define CLASS_2_A9028177C7C01F04__CTOR_OFFSET UNITYSDK_OFFSET(0xBF18FE0)

inline static constexpr unsigned int Class_2_A9028177C7C01F04_TypeDefinitionIndex = 51778;

class Class_2_A9028177C7C01F04 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::SetDynamicValueByGridFightTraitBonusDropCount* Field_2_1; // 0x20
