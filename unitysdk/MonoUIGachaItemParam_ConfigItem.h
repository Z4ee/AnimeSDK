...
#define MONOUIGACHAITEMPARAM_CONFIGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x18E89080)

inline static constexpr unsigned int MonoUIGachaItemParam_ConfigItem_TypeDefinitionIndex = 87629;

class MonoUIGachaItemParam_ConfigItem : public ::System::Object
{
public:
	::Enum_3_D5E55949F51D9DD0_1 rarity; // 0x10
