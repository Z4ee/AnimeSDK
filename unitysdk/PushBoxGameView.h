...
#define PUSHBOXGAMEVIEW_BINDUI_OFFSET UNITYSDK_OFFSET(0x16828310)
#define PUSHBOXGAMEVIEW_CANMOVETO_OFFSET UNITYSDK_OFFSET(0x1682B730)
#define PUSHBOXGAMEVIEW_CREATENPC_OFFSET UNITYSDK_OFFSET(0x1682A8F0)
#define PUSHBOXGAMEVIEW_CREATETILE_OFFSET UNITYSDK_OFFSET(0x1682A6C0)
#define PUSHBOXGAMEVIEW_CREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1682CE90)
#define PUSHBOXGAMEVIEW_DESTROYVIEW_OFFSET UNITYSDK_OFFSET(0x1682CF70)
#define PUSHBOXGAMEVIEW_DOGENCHESSBOARD_OFFSET UNITYSDK_OFFSET(0x16828660)
#define PUSHBOXGAMEVIEW_FRESHCHESSBOARDVIEW_OFFSET UNITYSDK_OFFSET(0x1682B0B0)
#define PUSHBOXGAMEVIEW_GENCHESSBOARD_OFFSET UNITYSDK_OFFSET(0x16828360)
#define PUSHBOXGAMEVIEW_GETINDEXWORLDPOS_OFFSET UNITYSDK_OFFSET(0x1682AD90)
#define PUSHBOXGAMEVIEW_GETMOVEDIR_OFFSET UNITYSDK_OFFSET(0x1682CAC0)
#define PUSHBOXGAMEVIEW_GETMOVETARGETINDEX_OFFSET UNITYSDK_OFFSET(0x1682C750)
#define PUSHBOXGAMEVIEW_GET_CURBOARDTYPE_OFFSET UNITYSDK_OFFSET(0x1682C740)
#define PUSHBOXGAMEVIEW_GET_REALXSIZE_OFFSET UNITYSDK_OFFSET(0x1682AD40)
#define PUSHBOXGAMEVIEW_GET_SECTIONUID_OFFSET UNITYSDK_OFFSET(0x1682D240)
#define PUSHBOXGAMEVIEW_HIDEALL_OFFSET UNITYSDK_OFFSET(0x16829D90)
#define PUSHBOXGAMEVIEW_INITALLNPC_OFFSET UNITYSDK_OFFSET(0x1682BEA0)
#define PUSHBOXGAMEVIEW_INITCHESSPIECES_OFFSET UNITYSDK_OFFSET(0x16828F90)
#define PUSHBOXGAMEVIEW_INITPLAYER_OFFSET UNITYSDK_OFFSET(0x168298F0)
#define PUSHBOXGAMEVIEW_ONNPCUPDATE_OFFSET UNITYSDK_OFFSET(0x1682B9D0)
#define PUSHBOXGAMEVIEW_PLAYFULLSCREENTEXTURE_OFFSET UNITYSDK_OFFSET(0x1682CFD0)
#define PUSHBOXGAMEVIEW_PLAYINITANIM_OFFSET UNITYSDK_OFFSET(0x1682A560)
#define PUSHBOXGAMEVIEW_PLAYRESETANIM_OFFSET UNITYSDK_OFFSET(0x16828920)
#define PUSHBOXGAMEVIEW_REFRESHPLAYERAPPEARANCE_OFFSET UNITYSDK_OFFSET(0x1682B960)
#define PUSHBOXGAMEVIEW_REFRESHPLAYERPOS_OFFSET UNITYSDK_OFFSET(0x16829A00)
#define PUSHBOXGAMEVIEW_SET_SECTIONUID_OFFSET UNITYSDK_OFFSET(0x1682D250)
#define PUSHBOXGAMEVIEW_SHOWNPCANDPLAYER_OFFSET UNITYSDK_OFFSET(0x1682A1B0)
#define PUSHBOXGAMEVIEW_TRYENTITYMOVE_OFFSET UNITYSDK_OFFSET(0x1682D260)
#define PUSHBOXGAMEVIEW_UPDATESINGLENPC_OFFSET UNITYSDK_OFFSET(0x1682BBF0)
#define PUSHBOXGAMEVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0x16829CC0)
#define PUSHBOXGAMEVIEW__CCTOR_OFFSET UNITYSDK_OFFSET(0x1682D6C0)
#define PUSHBOXGAMEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1682D4F0)
#define PUSHBOXGAMEVIEW__INITCHESSPIECES_G____CALCENTERPOS_28_0_OFFSET UNITYSDK_OFFSET(0x1682AD00)
#define PUSHBOXGAMEVIEW__INITCHESSPIECES_G____CREATELOGICINFO_28_1_OFFSET UNITYSDK_OFFSET(0x1682AB00)
#define PUSHBOXGAMEVIEW__PLAYINITANIM_B__24_0_OFFSET UNITYSDK_OFFSET(0x1682D770)
#define PUSHBOXGAMEVIEW__PLAYINITANIM_B__24_1_OFFSET UNITYSDK_OFFSET(0x1682DA70)

inline static constexpr unsigned int PushBoxGameView_TypeDefinitionIndex = 42711;
...
public:
	...
	{
		return (::Il2CppArray<::Share::GridDir>**)Il2CppClass::FromTypeDefinitionIndex(PushBoxGameView_TypeDefinitionIndex)->GetStaticField(0x4A4C0);
	}
