...
#define CLASS_2_2307E9325C065C89_DISPOSE_OFFSET UNITYSDK_OFFSET(0x90CFBA0)
#define CLASS_2_2307E9325C065C89_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x90CFA50)
#define CLASS_2_2307E9325C065C89_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x90CFB00)
#define CLASS_2_2307E9325C065C89_TICK_OFFSET UNITYSDK_OFFSET(0x90CFB40)
#define CLASS_2_2307E9325C065C89__CTOR_OFFSET UNITYSDK_OFFSET(0x90CFA40)

inline static constexpr unsigned int Class_2_2307E9325C065C89_TypeDefinitionIndex = 49128;
