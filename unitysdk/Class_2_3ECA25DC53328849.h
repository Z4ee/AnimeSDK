...
#define CLASS_2_3ECA25DC53328849_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18971470)
#define CLASS_2_3ECA25DC53328849_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x189714B0)
#define CLASS_2_3ECA25DC53328849_ONSKIP_OFFSET UNITYSDK_OFFSET(0x18971510)
#define CLASS_2_3ECA25DC53328849_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18971560)
#define CLASS_2_3ECA25DC53328849_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x189714C0)
#define CLASS_2_3ECA25DC53328849_TICK_OFFSET UNITYSDK_OFFSET(0x189715B0)
#define CLASS_2_3ECA25DC53328849__CTOR_OFFSET UNITYSDK_OFFSET(0x18971460)

inline static constexpr unsigned int Class_2_3ECA25DC53328849_TypeDefinitionIndex = 59045;

class Class_2_3ECA25DC53328849 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::WaitFrameForBattleServer* OFKGLJOAMLD; // 0x18
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x20
	::System::UInt64 JFMEEDGDMKP; // 0x28
