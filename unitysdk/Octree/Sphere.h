...
#define OCTREE_SPHERE_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x34AF10)
#define OCTREE_SPHERE_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x478130)
#define OCTREE_SPHERE_SET_CENTER_OFFSET UNITYSDK_OFFSET(0x34AC00)
#define OCTREE_SPHERE_SET_RADIUS_OFFSET UNITYSDK_OFFSET(0x53D7C0)
#define OCTREE_SPHERE_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x5E83E0)
#define OCTREE_SPHERE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x5E83D0)
#define OCTREE_SPHERE__CTOR_OFFSET UNITYSDK_OFFSET(0x478110)
#define OCTREE_SPHERE___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x5E83F0)

namespace Octree
{
	inline static constexpr unsigned int Sphere_TypeDefinitionIndex = 80707;
