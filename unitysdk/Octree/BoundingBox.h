...
#define OCTREE_BOUNDINGBOX_CONTAINS_OFFSET UNITYSDK_OFFSET(0x68FF40)
#define OCTREE_BOUNDINGBOX_ENCAPSULATE_1_OFFSET UNITYSDK_OFFSET(0x68FD60)
#define OCTREE_BOUNDINGBOX_ENCAPSULATE_OFFSET UNITYSDK_OFFSET(0x68FD30)
#define OCTREE_BOUNDINGBOX_EQUALS_OFFSET UNITYSDK_OFFSET(0x690350)
#define OCTREE_BOUNDINGBOX_EXPAND_1_OFFSET UNITYSDK_OFFSET(0x68FE60)
#define OCTREE_BOUNDINGBOX_EXPAND_OFFSET UNITYSDK_OFFSET(0x68FD90)
#define OCTREE_BOUNDINGBOX_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x690170)
#define OCTREE_BOUNDINGBOX_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x388220)
#define OCTREE_BOUNDINGBOX_GET_EXTENTS_OFFSET UNITYSDK_OFFSET(0x3E5840)
#define OCTREE_BOUNDINGBOX_GET_MAX_OFFSET UNITYSDK_OFFSET(0x68FB60)
#define OCTREE_BOUNDINGBOX_GET_MIN_OFFSET UNITYSDK_OFFSET(0x68FB00)
#define OCTREE_BOUNDINGBOX_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x68FA10)
#define OCTREE_BOUNDINGBOX_INTERSECTRAY_1_OFFSET UNITYSDK_OFFSET(0x690140)
#define OCTREE_BOUNDINGBOX_INTERSECTRAY_OFFSET UNITYSDK_OFFSET(0x6900B0)
#define OCTREE_BOUNDINGBOX_INTERSECTSPHERE_OFFSET UNITYSDK_OFFSET(0x690090)
#define OCTREE_BOUNDINGBOX_INTERSECTS_OFFSET UNITYSDK_OFFSET(0x690060)
#define OCTREE_BOUNDINGBOX_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xFE2A890)
#define OCTREE_BOUNDINGBOX_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xFE2A950)
#define OCTREE_BOUNDINGBOX_SETMINMAX_OFFSET UNITYSDK_OFFSET(0x68FC00)
#define OCTREE_BOUNDINGBOX_SET_CENTER_OFFSET UNITYSDK_OFFSET(0x387FA0)
#define OCTREE_BOUNDINGBOX_SET_EXTENTS_OFFSET UNITYSDK_OFFSET(0x68FA00)
#define OCTREE_BOUNDINGBOX_SET_MAX_OFFSET UNITYSDK_OFFSET(0x68FB90)
#define OCTREE_BOUNDINGBOX_SET_MIN_OFFSET UNITYSDK_OFFSET(0x68FB30)
#define OCTREE_BOUNDINGBOX_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x68FA30)
#define OCTREE_BOUNDINGBOX_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x690370)
#define OCTREE_BOUNDINGBOX_TOSTRING_OFFSET UNITYSDK_OFFSET(0x690360)
#define OCTREE_BOUNDINGBOX__CTOR_OFFSET UNITYSDK_OFFSET(0x68FBC0)
#define OCTREE_BOUNDINGBOX__INTERSECTSPHERE_G__CLAMP_25_0_OFFSET UNITYSDK_OFFSET(0xFE2A0D0)
#define OCTREE_BOUNDINGBOX___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x690380)
#define OCTREE_BOUNDINGBOX___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x6903F0)
#define OCTREE_BOUNDINGBOX___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x690460)

namespace Octree
{
	inline static constexpr unsigned int BoundingBox_TypeDefinitionIndex = 52508;
