...
#define OCTREE_OCTCHILDBOUNDINGBOX_EQUALS_OFFSET UNITYSDK_OFFSET(0x887160)

namespace Octree
{
	inline static constexpr unsigned int OctChildBoundingBox_TypeDefinitionIndex = 71600;
