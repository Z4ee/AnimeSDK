...
#define OCTREE_OCTCHILDBOUNDINGBOX_EQUALS_OFFSET UNITYSDK_OFFSET(0x658840)

namespace Octree
{
	inline static constexpr unsigned int OctChildBoundingBox_TypeDefinitionIndex = 76811;
