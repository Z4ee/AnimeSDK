...
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_DNATIVEUTILS_PTRMEMCOPY_OFFSET UNITYSDK_OFFSET(0x178FAF20)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_DNATIVEUTILS_PTRMEMEQUALSFAST_OFFSET UNITYSDK_OFFSET(0x178FB300)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_DNATIVEUTILS_PTRMEMEQUALS_1_OFFSET UNITYSDK_OFFSET(0x178FB0B0)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_DNATIVEUTILS_PTRMEMEQUALS_2_OFFSET UNITYSDK_OFFSET(0x178FB100)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_DNATIVEUTILS_PTRMEMEQUALS_OFFSET UNITYSDK_OFFSET(0x178FB070)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_DNATIVEUTILS_PTRMEMISZERO_OFFSET UNITYSDK_OFFSET(0x178FB160)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_DNATIVEUTILS_PTRMEMSET_OFFSET UNITYSDK_OFFSET(0x178FB010)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_DNATIVEUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x178FB480)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_DNATIVEUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x178FB470)

namespace Octree::Native
{
	inline static constexpr unsigned int NativeSizeAreaUtils_DNativeUtils_TypeDefinitionIndex = 71341;
	...
	public:
		...
		{
			return (::Octree::Native::SIMD::uint4*)Il2CppClass::FromTypeDefinitionIndex(NativeSizeAreaUtils_DNativeUtils_TypeDefinitionIndex)->GetStaticField(0xC820);
		}
