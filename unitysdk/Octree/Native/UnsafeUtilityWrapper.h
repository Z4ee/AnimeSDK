...
#define OCTREE_NATIVE_UNSAFEUTILITYWRAPPER_MEMMOVE_1_OFFSET UNITYSDK_OFFSET(0x11CB4990)
#define OCTREE_NATIVE_UNSAFEUTILITYWRAPPER_MEMMOVE_OFFSET UNITYSDK_OFFSET(0x11CB4850)
#define OCTREE_NATIVE_UNSAFEUTILITYWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x11CB49B0)

namespace Octree::Native
{
	inline static constexpr unsigned int UnsafeUtilityWrapper_TypeDefinitionIndex = 71185;
