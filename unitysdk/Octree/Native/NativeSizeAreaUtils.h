...
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_ASNODEELEMENTPTR_OFFSET UNITYSDK_OFFSET(0x14382360)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_ASNODEELEMENT_OFFSET UNITYSDK_OFFSET(0x14382350)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_PTRMEMCOPY_OFFSET UNITYSDK_OFFSET(0x14382370)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_PTRMEMEQUALSFAST_OFFSET UNITYSDK_OFFSET(0x14382840)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_PTRMEMEQUALS_1_OFFSET UNITYSDK_OFFSET(0x143826A0)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_PTRMEMEQUALS_2_OFFSET UNITYSDK_OFFSET(0x14382770)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_PTRMEMEQUALS_OFFSET UNITYSDK_OFFSET(0x143825E0)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_PTRMEMSET_OFFSET UNITYSDK_OFFSET(0x143824F0)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_READBYTEBE_OFFSET UNITYSDK_OFFSET(0x14382220)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_READINTBE_OFFSET UNITYSDK_OFFSET(0x143821C0)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_READSHORTBE_OFFSET UNITYSDK_OFFSET(0x143821F0)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_TOHEX_OFFSET UNITYSDK_OFFSET(0x14382240)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_WRITEBYTEBE_OFFSET UNITYSDK_OFFSET(0x14382230)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_WRITEINTBE_OFFSET UNITYSDK_OFFSET(0x143821D0)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_WRITESHORTBE_OFFSET UNITYSDK_OFFSET(0x14382210)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x14382A40)

namespace Octree::Native
{
	inline static constexpr unsigned int NativeSizeAreaUtils_TypeDefinitionIndex = 57071;
