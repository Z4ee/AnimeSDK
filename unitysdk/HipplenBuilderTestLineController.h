...
#define HIPPLENBUILDERTESTLINECONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x17A6A800)
#define HIPPLENBUILDERTESTLINECONTROLLER_METHOD_5_33CB3B8324399CE4_OFFSET UNITYSDK_OFFSET(0x17A6B340)
#define HIPPLENBUILDERTESTLINECONTROLLER_ONPIN_OFFSET UNITYSDK_OFFSET(0x17A6B840)
#define HIPPLENBUILDERTESTLINECONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x17A6BF90)
#define HIPPLENBUILDERTESTLINECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17A6BFD0)

inline static constexpr unsigned int HipplenBuilderTestLineController_TypeDefinitionIndex = 45422;
