...
#define HIPPLENBUILDERTESTLINECONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x10C281C0)
#define HIPPLENBUILDERTESTLINECONTROLLER_METHOD_5_33CB3B8324399CE4_OFFSET UNITYSDK_OFFSET(0x10C289D0)
#define HIPPLENBUILDERTESTLINECONTROLLER_ONPIN_OFFSET UNITYSDK_OFFSET(0x10C28E20)
#define HIPPLENBUILDERTESTLINECONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x10C29440)
#define HIPPLENBUILDERTESTLINECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x10C29480)

inline static constexpr unsigned int HipplenBuilderTestLineController_TypeDefinitionIndex = 38120;
