...
#define HIPPLENBUILDERTESTLINECONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x18DD57F0)
#define HIPPLENBUILDERTESTLINECONTROLLER_METHOD_5_33CB3B8324399CE4_OFFSET UNITYSDK_OFFSET(0x18DD6330)
#define HIPPLENBUILDERTESTLINECONTROLLER_ONPIN_OFFSET UNITYSDK_OFFSET(0x18DD6830)
#define HIPPLENBUILDERTESTLINECONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x18DD6F80)
#define HIPPLENBUILDERTESTLINECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18DD6FC0)

inline static constexpr unsigned int HipplenBuilderTestLineController_TypeDefinitionIndex = 47672;
