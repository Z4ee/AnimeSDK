...
#define CLASS_1_52DF42E136544C98_METHOD_1_53701A90DF3011E8_OFFSET UNITYSDK_OFFSET(0x151FB0A0)
#define CLASS_1_52DF42E136544C98_METHOD_1_B751F95C5831C42B_OFFSET UNITYSDK_OFFSET(0x151FB230)
#define CLASS_1_52DF42E136544C98__CTOR_OFFSET UNITYSDK_OFFSET(0x151FB090)

inline static constexpr unsigned int Class_1_52DF42E136544C98_TypeDefinitionIndex = 68112;

class Class_1_52DF42E136544C98 : public ::System::Object
{
public:
	::Il2CppArray<::RPG::GameCore::FixPoint>* Field_1_0; // 0x10
	::Il2CppArray<::RPG::GameCore::DynamicFloat*>* Field_1_1; // 0x18
	::RPG::GameCore::TurnBasedModifierInstance* Field_1_2; // 0x20
	::RPG::GameCore::ModifierHintType Field_1_3; // 0x28
