...
#define STRUCT_2_5C4F194DEECB2289_METHOD_2_2188D65D89E63CD4_1_OFFSET UNITYSDK_OFFSET(0x1C132920)
#define STRUCT_2_5C4F194DEECB2289_METHOD_2_2188D65D89E63CD4_OFFSET UNITYSDK_OFFSET(0x1C132850)
#define STRUCT_2_5C4F194DEECB2289_METHOD_2_9FCD8875B177BC0E_OFFSET UNITYSDK_OFFSET(0x1C132730)
#define STRUCT_2_5C4F194DEECB2289_METHOD_2_A5CEFBC2F1F2CC5A_OFFSET UNITYSDK_OFFSET(0x1C132A00)

inline static constexpr unsigned int Struct_2_5C4F194DEECB2289_TypeDefinitionIndex = 41412;

struct alignas(8) Struct_2_5C4F194DEECB2289
{
	::System::UInt32 JCJGJBLENCP; // 0x10
	::System::UInt32 EDIGEANPBNL; // 0x14
	::Class_1_066AB55B5826B0C9* GMNANGJHBPK; // 0x18
	::RPG::GameCore::Match3::BombType HDCBHKGBABI; // 0x20
	::System::UInt32 JDCOJKMKFIA; // 0x24
	::System::Boolean NLDBOFMDOHJ; // 0x28
	::RPG::GameCore::Match3::BombType JBDBEEKACGA; // 0x2C
	::System::Boolean MJIBLFAGEED; // 0x30
	::System::UInt32 NJHBEDINIOH; // 0x34
	::System::UInt32 CKKOPLEHHGL; // 0x38
