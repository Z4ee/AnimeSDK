...
#define CLASS_1_E23A2D2E72B0716C_EXECUTE_OFFSET UNITYSDK_OFFSET(0x16EE1340)
#define CLASS_1_E23A2D2E72B0716C_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x16EE1150)
#define CLASS_1_E23A2D2E72B0716C_METHOD_1_165125547C288B47_OFFSET UNITYSDK_OFFSET(0x16EE10C0)
#define CLASS_1_E23A2D2E72B0716C_METHOD_1_513D34FAFFB1AAB4_OFFSET UNITYSDK_OFFSET(0x16EE1030)
#define CLASS_1_E23A2D2E72B0716C_METHOD_1_B6009F06FE6FBDA6_OFFSET UNITYSDK_OFFSET(0x16EE16E0)
#define CLASS_1_E23A2D2E72B0716C_METHOD_1_BA1BB49741CFDFE1_OFFSET UNITYSDK_OFFSET(0x16EE1190)
#define CLASS_1_E23A2D2E72B0716C_METHOD_1_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0x16EE1A50)
#define CLASS_1_E23A2D2E72B0716C_TICK_OFFSET UNITYSDK_OFFSET(0x16EE19E0)
#define CLASS_1_E23A2D2E72B0716C__CTOR_OFFSET UNITYSDK_OFFSET(0x16EE0FD0)

inline static constexpr unsigned int Class_1_E23A2D2E72B0716C_TypeDefinitionIndex = 77179;

class Class_1_E23A2D2E72B0716C : public ::System::Object
{
public:
	// static const ::System::String* NLFMOONOKLH; // 0x0
	::System::Collections::Generic::List_1<::Class_1_43BD383C98B4C0C5_213*>* OJFECHILFHG; // 0x10
	::Class_1_E518B582305CCAFF* HFOFIODMFGB; // 0x18
	::RPG::Client::LittleGame::ChimeraDuel::ChimeraDuelChimeraCache* IEMEIEMOMIG; // 0x20

	::System::Void _ctor(::Class_2_B66C1067C0468FBB* a1, ::System::Collections::Generic::IEnumerable_1<::Class_1_43BD383C98B4C0C5_213*>* a2, ::Class_2_FB9CF047C8AEAA83* a3)
	{
		return ((::System::Void(*)(::PVOID, ::Class_2_B66C1067C0468FBB*, ::System::Collections::Generic::IEnumerable_1<::Class_1_43BD383C98B4C0C5_213*>*, ::Class_2_FB9CF047C8AEAA83*))((::PBYTE)hIl2Cpp + CLASS_1_E23A2D2E72B0716C__CTOR_OFFSET))(this, a1, a2, a3);
	}
	...
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_F9FBCC956DFCF137_27*, ::System::Action*))((::PBYTE)hIl2Cpp + CLASS_1_E23A2D2E72B0716C_EXECUTE_OFFSET))(this, a1, a2);
	}
