...
#define AKAUDIOINPUTMANAGER_AUDIOFORMATDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E79F0C0)
#define AKAUDIOINPUTMANAGER_AUDIOFORMATDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E79F140)
#define AKAUDIOINPUTMANAGER_AUDIOFORMATDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E79ED80)
#define AKAUDIOINPUTMANAGER_AUDIOFORMATDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E79ED60)

inline static constexpr unsigned int AkAudioInputManager_AudioFormatDelegate_TypeDefinitionIndex = 33039;
