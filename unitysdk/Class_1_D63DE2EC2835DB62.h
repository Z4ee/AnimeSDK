...
#define CLASS_1_D63DE2EC2835DB62_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1586C6C0)
#define CLASS_1_D63DE2EC2835DB62_METHOD_1_06150765F7C4861F_OFFSET UNITYSDK_OFFSET(0x1586D780)
#define CLASS_1_D63DE2EC2835DB62_METHOD_1_141453960CF6404C_OFFSET UNITYSDK_OFFSET(0x1586CAB0)
#define CLASS_1_D63DE2EC2835DB62_METHOD_1_1BEFC7D4DC4592AD_OFFSET UNITYSDK_OFFSET(0x1586D7D0)
#define CLASS_1_D63DE2EC2835DB62_METHOD_1_86BEEB7DC44E6CC1_OFFSET UNITYSDK_OFFSET(0x1586CA40)
#define CLASS_1_D63DE2EC2835DB62_METHOD_1_D412F0348A00EBB5_OFFSET UNITYSDK_OFFSET(0x1586CFB0)
#define CLASS_1_D63DE2EC2835DB62_METHOD_1_F32DFD8F414578F0_OFFSET UNITYSDK_OFFSET(0x1586D720)
#define CLASS_1_D63DE2EC2835DB62__CTOR_OFFSET UNITYSDK_OFFSET(0x1586C5D0)
...
{
public:
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::TimeRewindView, ::Class_1_D63DE2EC2835DB62_Class_1_6516DDC30DD1EB36*>* IOMMOLEMMJI; // 0x10
	::RPG::GameCore::TimeRewindMaterialOverlayConfig* OODHJJMGKMP; // 0x18
	::UnityEngine::GameObject* LNOPCAPDCKM; // 0x20
	::RPG::GameCore::EraStateType HFOLIOPFEGF; // 0x28
	::System::Single CEFJACGKOLE; // 0x2C
	::System::Single GOAHNHLBFGE; // 0x30
