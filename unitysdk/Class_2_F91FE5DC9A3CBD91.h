...
#define CLASS_2_F91FE5DC9A3CBD91_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18A60EB0)
#define CLASS_2_F91FE5DC9A3CBD91_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18A60EF0)
#define CLASS_2_F91FE5DC9A3CBD91_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x18A610F0)
#define CLASS_2_F91FE5DC9A3CBD91_TICK_OFFSET UNITYSDK_OFFSET(0x18A61140)
#define CLASS_2_F91FE5DC9A3CBD91__CTOR_OFFSET UNITYSDK_OFFSET(0x18A60EA0)

inline static constexpr unsigned int Class_2_F91FE5DC9A3CBD91_TypeDefinitionIndex = 53463;

class Class_2_F91FE5DC9A3CBD91 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::GameCore::ResetMissionWayPoint* OFKGLJOAMLD; // 0x20
