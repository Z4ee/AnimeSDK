...
#define CLASS_2_F91FE5DC9A3CBD91_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAFEB8E0)
#define CLASS_2_F91FE5DC9A3CBD91_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xAFEB920)
#define CLASS_2_F91FE5DC9A3CBD91_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xAFEBB20)
#define CLASS_2_F91FE5DC9A3CBD91_TICK_OFFSET UNITYSDK_OFFSET(0xAFEBB70)
#define CLASS_2_F91FE5DC9A3CBD91__CTOR_OFFSET UNITYSDK_OFFSET(0xAFEB8D0)

inline static constexpr unsigned int Class_2_F91FE5DC9A3CBD91_TypeDefinitionIndex = 49060;

class Class_2_F91FE5DC9A3CBD91 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::ResetMissionWayPoint* Field_2_0; // 0x20
