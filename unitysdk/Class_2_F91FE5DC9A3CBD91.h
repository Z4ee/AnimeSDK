...
#define CLASS_2_F91FE5DC9A3CBD91_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13FF3730)
#define CLASS_2_F91FE5DC9A3CBD91_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x13FF3770)
#define CLASS_2_F91FE5DC9A3CBD91_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x13FF3970)
#define CLASS_2_F91FE5DC9A3CBD91_TICK_OFFSET UNITYSDK_OFFSET(0x13FF39C0)
#define CLASS_2_F91FE5DC9A3CBD91__CTOR_OFFSET UNITYSDK_OFFSET(0x13FF3720)

inline static constexpr unsigned int Class_2_F91FE5DC9A3CBD91_TypeDefinitionIndex = 49727;

class Class_2_F91FE5DC9A3CBD91 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::ResetMissionWayPoint* Field_2_1; // 0x20
