...
#define CLASS_1_002DEDC9C18A055B_GET_FIRSTFINISHTIMESECONDS_OFFSET UNITYSDK_OFFSET(0x19AB20D0)
#define CLASS_1_002DEDC9C18A055B_GET_ISTUTORIALMATCH_OFFSET UNITYSDK_OFFSET(0x19AB2130)
#define CLASS_1_002DEDC9C18A055B_GET_MATCHID_OFFSET UNITYSDK_OFFSET(0x19AB2050)
#define CLASS_1_002DEDC9C18A055B_GET_PLAYERRANK_OFFSET UNITYSDK_OFFSET(0x19AB2070)
#define CLASS_1_002DEDC9C18A055B_GET_PLAYERSCOREDELTATEXT_OFFSET UNITYSDK_OFFSET(0x19AB20B0)
#define CLASS_1_002DEDC9C18A055B_GET_PLAYERTEAMID_OFFSET UNITYSDK_OFFSET(0x19AB2150)
#define CLASS_1_002DEDC9C18A055B_GET_RACERANKING_OFFSET UNITYSDK_OFFSET(0x19AB2090)
#define CLASS_1_002DEDC9C18A055B_GET_RANKFINISHTIMESECONDS_OFFSET UNITYSDK_OFFSET(0x19AB20F0)
#define CLASS_1_002DEDC9C18A055B_GET_RANKSCORELIST_OFFSET UNITYSDK_OFFSET(0x19AB2110)
#define CLASS_1_002DEDC9C18A055B_GET_RESULTSTATE_OFFSET UNITYSDK_OFFSET(0x19AB2170)
#define CLASS_1_002DEDC9C18A055B_SET_FIRSTFINISHTIMESECONDS_OFFSET UNITYSDK_OFFSET(0x19AB20E0)
#define CLASS_1_002DEDC9C18A055B_SET_ISTUTORIALMATCH_OFFSET UNITYSDK_OFFSET(0x19AB2140)
#define CLASS_1_002DEDC9C18A055B_SET_MATCHID_OFFSET UNITYSDK_OFFSET(0x19AB2060)
#define CLASS_1_002DEDC9C18A055B_SET_PLAYERRANK_OFFSET UNITYSDK_OFFSET(0x19AB2080)
#define CLASS_1_002DEDC9C18A055B_SET_PLAYERSCOREDELTATEXT_OFFSET UNITYSDK_OFFSET(0x19AB20C0)
#define CLASS_1_002DEDC9C18A055B_SET_PLAYERTEAMID_OFFSET UNITYSDK_OFFSET(0x19AB2160)
#define CLASS_1_002DEDC9C18A055B_SET_RACERANKING_OFFSET UNITYSDK_OFFSET(0x19AB20A0)
#define CLASS_1_002DEDC9C18A055B_SET_RANKFINISHTIMESECONDS_OFFSET UNITYSDK_OFFSET(0x19AB2100)
#define CLASS_1_002DEDC9C18A055B_SET_RANKSCORELIST_OFFSET UNITYSDK_OFFSET(0x19AB2120)
#define CLASS_1_002DEDC9C18A055B_SET_RESULTSTATE_OFFSET UNITYSDK_OFFSET(0x19AB2180)
#define CLASS_1_002DEDC9C18A055B__CTOR_OFFSET UNITYSDK_OFFSET(0x19AB2190)

inline static constexpr unsigned int Class_1_002DEDC9C18A055B_TypeDefinitionIndex = 80609;

class Class_1_002DEDC9C18A055B : public ::System::Object
{
public:
	::System::Collections::Generic::IReadOnlyList_1<::System::UInt32>* _RankScoreList_k__BackingField; // 0x10
	::System::Collections::Generic::IReadOnlyList_1<::System::Single>* _RankFinishTimeSeconds_k__BackingField; // 0x18
	::System::Collections::Generic::List_1<::Struct_2_12121D6A4A8DB72D>* _RaceRanking_k__BackingField; // 0x20
	::System::String* _PlayerScoreDeltaText_k__BackingField; // 0x28
	::System::Single _FirstFinishTimeSeconds_k__BackingField; // 0x30
	::System::UInt32 _MatchId_k__BackingField; // 0x34
	::System::Boolean _IsTutorialMatch_k__BackingField; // 0x38
	...
	::System::UInt32 _PlayerTeamId_k__BackingField; // 0x44
