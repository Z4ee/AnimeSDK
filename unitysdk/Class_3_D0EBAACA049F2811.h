...
#define CLASS_3_D0EBAACA049F2811_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA74E910)
#define CLASS_3_D0EBAACA049F2811_METHOD_3_3C56C1AF247AC1EC_OFFSET UNITYSDK_OFFSET(0xA74ED00)
#define CLASS_3_D0EBAACA049F2811_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xA74E9B0)
#define CLASS_3_D0EBAACA049F2811_TICK_OFFSET UNITYSDK_OFFSET(0xA74ED90)
#define CLASS_3_D0EBAACA049F2811__CTOR_OFFSET UNITYSDK_OFFSET(0xA74E800)
#define CLASS_3_D0EBAACA049F2811___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA74F020)
#define CLASS_3_D0EBAACA049F2811___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xA74F0C0)

inline static constexpr unsigned int Class_3_D0EBAACA049F2811_TypeDefinitionIndex = 51633;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + CLASS_3_D0EBAACA049F2811___IFIXBASEPROXY_TICK_OFFSET))(this, a1);
	}
};
