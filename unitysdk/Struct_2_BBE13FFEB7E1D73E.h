...
#define STRUCT_2_BBE13FFEB7E1D73E_METHOD_2_D0CD9A971CA3B1CF_OFFSET UNITYSDK_OFFSET(0x2DEA8D0)
#define STRUCT_2_BBE13FFEB7E1D73E_METHOD_2_D37FAD0A6AA04B25_1_OFFSET UNITYSDK_OFFSET(0x2DEA6C0)
#define STRUCT_2_BBE13FFEB7E1D73E_METHOD_2_D37FAD0A6AA04B25_OFFSET UNITYSDK_OFFSET(0x2DEA6A0)
#define STRUCT_2_BBE13FFEB7E1D73E_METHOD_2_E9758935FDCEBD14_OFFSET UNITYSDK_OFFSET(0x2DEA6E0)
#define STRUCT_2_BBE13FFEB7E1D73E_METHOD_2_EB7F927150FED3C2_OFFSET UNITYSDK_OFFSET(0x2DEA850)
#define STRUCT_2_BBE13FFEB7E1D73E_METHOD_2_F10A0D072D26C4BF_1_OFFSET UNITYSDK_OFFSET(0x2DEA7E0)
#define STRUCT_2_BBE13FFEB7E1D73E_METHOD_2_F10A0D072D26C4BF_OFFSET UNITYSDK_OFFSET(0x2DEA770)

inline static constexpr unsigned int Struct_2_BBE13FFEB7E1D73E_TypeDefinitionIndex = 59921;

struct alignas(8) Struct_2_BBE13FFEB7E1D73E
{
	::RPG::Client::Airline* BBLOHCHKFKD; // 0x10
	::UnityEngine::Vector3 JFAGECNFHJL; // 0x18
	::System::Single BBFOLEOPPPL; // 0x24
	::System::Single BJNKIKNBFOJ; // 0x28
	::UnityEngine::Vector3 KFEJGBAKKEF; // 0x2C
	::UnityEngine::Vector3 MJHEOHOADGF; // 0x38
	::UnityEngine::Quaternion NCBBBANOECE; // 0x44
