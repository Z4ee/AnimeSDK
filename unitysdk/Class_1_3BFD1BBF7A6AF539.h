...
#define CLASS_1_3BFD1BBF7A6AF539_METHOD_1_1C62453C3F38D037_OFFSET UNITYSDK_OFFSET(0x19FE52D0)
#define CLASS_1_3BFD1BBF7A6AF539_METHOD_1_71F791675693F9C2_OFFSET UNITYSDK_OFFSET(0x19FE54C0)
#define CLASS_1_3BFD1BBF7A6AF539_METHOD_1_7445215661C9D65B_OFFSET UNITYSDK_OFFSET(0x19FE5210)
#define CLASS_1_3BFD1BBF7A6AF539_METHOD_1_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0x19FE5480)
#define CLASS_1_3BFD1BBF7A6AF539__CTOR_OFFSET UNITYSDK_OFFSET(0x19FE5200)

inline static constexpr unsigned int Class_1_3BFD1BBF7A6AF539_TypeDefinitionIndex = 75617;

class Class_1_3BFD1BBF7A6AF539 : public ::System::Object
{
public:
	::Class_1_1C24DB91A0CEBCF1* PGNKDKLMBJJ; // 0x10
	::UnityEngine::GameObject* PJINGPLNBGA; // 0x18
	::Class_1_40CD5CE8474BAA94* LFJOHJEPOKO; // 0x20
	::RPG::Client::DiceCombat::DiceCombatRollDiceEffectParameter* EJGPIGLDFPG; // 0x28
