...
#define REFGPUPARTICLESYSTEMBURST_METHOD_1_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x182FB3A0)
#define REFGPUPARTICLESYSTEMBURST__CTOR_OFFSET UNITYSDK_OFFSET(0x182FD220)

inline static constexpr unsigned int RefGPUParticleSystemBurst_TypeDefinitionIndex = 33927;
