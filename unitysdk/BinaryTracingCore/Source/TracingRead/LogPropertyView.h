...
#define BINARYTRACINGCORE_SOURCE_TRACINGREAD_LOGPROPERTYVIEW_GET_PROPERTYKEY_OFFSET UNITYSDK_OFFSET(0x1F64E7F0)
#define BINARYTRACINGCORE_SOURCE_TRACINGREAD_LOGPROPERTYVIEW_GET_PROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1F64E800)
#define BINARYTRACINGCORE_SOURCE_TRACINGREAD_LOGPROPERTYVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1F64E8F0)

namespace BinaryTracingCore::Source::TracingRead
{
	inline static constexpr unsigned int LogPropertyView_TypeDefinitionIndex = 34603;
