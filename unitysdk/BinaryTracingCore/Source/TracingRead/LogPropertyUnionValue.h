...
#define BINARYTRACINGCORE_SOURCE_TRACINGREAD_LOGPROPERTYUNIONVALUE_CASTFROMOBJECT_OFFSET UNITYSDK_OFFSET(0x1E22A7E0)
#define BINARYTRACINGCORE_SOURCE_TRACINGREAD_LOGPROPERTYUNIONVALUE_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1E22A750)
#define BINARYTRACINGCORE_SOURCE_TRACINGREAD_LOGPROPERTYUNIONVALUE_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1E22A770)
#define BINARYTRACINGCORE_SOURCE_TRACINGREAD_LOGPROPERTYUNIONVALUE_OP_IMPLICIT_3_OFFSET UNITYSDK_OFFSET(0x1E22A780)
#define BINARYTRACINGCORE_SOURCE_TRACINGREAD_LOGPROPERTYUNIONVALUE_OP_IMPLICIT_4_OFFSET UNITYSDK_OFFSET(0x1E22A7A0)
#define BINARYTRACINGCORE_SOURCE_TRACINGREAD_LOGPROPERTYUNIONVALUE_OP_IMPLICIT_5_OFFSET UNITYSDK_OFFSET(0x1E22A7B0)
#define BINARYTRACINGCORE_SOURCE_TRACINGREAD_LOGPROPERTYUNIONVALUE_OP_IMPLICIT_6_OFFSET UNITYSDK_OFFSET(0x1E22A7C0)
#define BINARYTRACINGCORE_SOURCE_TRACINGREAD_LOGPROPERTYUNIONVALUE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1E22A730)

namespace BinaryTracingCore::Source::TracingRead
{
	inline static constexpr unsigned int LogPropertyUnionValue_TypeDefinitionIndex = 33966;
