...
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXYEMPTY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXYEMPTY_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x304470)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXYEMPTY_LOG_1_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXYEMPTY_LOG_2_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXYEMPTY_LOG_3_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXYEMPTY_LOG_OFFSET UNITYSDK_OFFSET(0x2661E0)

namespace BinaryTracingCore::Source::TracingTools
{
	inline static constexpr unsigned int LogChannel_LogUnitProxyEmpty_TypeDefinitionIndex = 32398;
