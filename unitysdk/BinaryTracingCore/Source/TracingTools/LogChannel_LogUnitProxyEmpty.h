...
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXYEMPTY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXYEMPTY_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x332AB0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXYEMPTY_LOG_1_OFFSET UNITYSDK_OFFSET(0x283610)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXYEMPTY_LOG_2_OFFSET UNITYSDK_OFFSET(0x283610)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXYEMPTY_LOG_3_OFFSET UNITYSDK_OFFSET(0x283610)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXYEMPTY_LOG_OFFSET UNITYSDK_OFFSET(0x283610)

namespace BinaryTracingCore::Source::TracingTools
{
	inline static constexpr unsigned int LogChannel_LogUnitProxyEmpty_TypeDefinitionIndex = 33949;
