...
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_CREATE_OFFSET UNITYSDK_OFFSET(0x1E22C160)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_GET_VALIDUNIT_OFFSET UNITYSDK_OFFSET(0x1E22E0D0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_LOG_1_OFFSET UNITYSDK_OFFSET(0x1E22C980)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_LOG_2_OFFSET UNITYSDK_OFFSET(0x1E22CA80)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_LOG_3_OFFSET UNITYSDK_OFFSET(0x1E22CB00)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_LOG_OFFSET UNITYSDK_OFFSET(0x1E22C880)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_RELEASE_OFFSET UNITYSDK_OFFSET(0x1E22C430)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_RESET_OFFSET UNITYSDK_OFFSET(0x1E22E830)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_RESLOVELOGUNIT_OFFSET UNITYSDK_OFFSET(0x1E22B6B0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_SETHEADINFO_OFFSET UNITYSDK_OFFSET(0x1E22E6D0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_SET_VALIDUNIT_OFFSET UNITYSDK_OFFSET(0x1E22E0E0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E22E0F0)

namespace BinaryTracingCore::Source::TracingTools
{
	inline static constexpr unsigned int LogUnit_TypeDefinitionIndex = 33945;
	...
	public:
		...
		::BinaryTracingFramework::Serialize::MemoryWriteArchive* AttachContent; // 0x10
		::System::Collections::Generic::List_1<::BinaryTracingCore::Source::TracingTools::LogProperty>* Properties; // 0x18
		::BinaryTracingCore::Source::TracingTools::LogHeadInfo HeadInfo; // 0x20
		::BinaryTracingFramework::Serialize::MemoryWriteArchive* Content; // 0x68
