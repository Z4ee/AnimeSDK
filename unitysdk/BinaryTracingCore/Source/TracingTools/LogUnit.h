...
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_CREATE_OFFSET UNITYSDK_OFFSET(0x1F6500E0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_GET_VALIDUNIT_OFFSET UNITYSDK_OFFSET(0x1F652070)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_LOG_1_OFFSET UNITYSDK_OFFSET(0x1F650900)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_LOG_2_OFFSET UNITYSDK_OFFSET(0x1F650A00)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_LOG_3_OFFSET UNITYSDK_OFFSET(0x1F650A80)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_LOG_OFFSET UNITYSDK_OFFSET(0x1F650800)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_RELEASE_OFFSET UNITYSDK_OFFSET(0x1F6503B0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_RESET_OFFSET UNITYSDK_OFFSET(0x1F6527E0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_RESLOVELOGUNIT_OFFSET UNITYSDK_OFFSET(0x1F64F6B0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_SETHEADINFO_OFFSET UNITYSDK_OFFSET(0x1F652680)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_SET_VALIDUNIT_OFFSET UNITYSDK_OFFSET(0x1F652080)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1F652090)

namespace BinaryTracingCore::Source::TracingTools
{
	inline static constexpr unsigned int LogUnit_TypeDefinitionIndex = 34581;
	...
	public:
		...
		::BinaryTracingFramework::Serialize::MemoryWriteArchive* Content; // 0x10
		::BinaryTracingFramework::Serialize::MemoryWriteArchive* AttachContent; // 0x18
		::System::Collections::Generic::List_1<::BinaryTracingCore::Source::TracingTools::LogProperty>* Properties; // 0x20
		::BinaryTracingCore::Source::TracingTools::LogHeadInfo HeadInfo; // 0x28
		::System::Boolean _ValidUnit_k__BackingField; // 0x70
		::System::Boolean NeedInitArchetype; // 0x71
