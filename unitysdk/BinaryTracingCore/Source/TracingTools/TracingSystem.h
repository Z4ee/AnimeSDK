...
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_DEFINELOGCHANNEL_OFFSET UNITYSDK_OFFSET(0x1F653600)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_FLUSHWRITE_OFFSET UNITYSDK_OFFSET(0x1F6534A0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_GETFRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x1F653000)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_GETTIME_OFFSET UNITYSDK_OFFSET(0x1F653010)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_INIT_OFFSET UNITYSDK_OFFSET(0x1F652C30)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_PUSHCURBLOCK_OFFSET UNITYSDK_OFFSET(0x1F6537D0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_REGISTERLOGMETA_OFFSET UNITYSDK_OFFSET(0x1F652780)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_REGISTERTRACINGSYSTEM_OFFSET UNITYSDK_OFFSET(0x1F652BF0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_TRYGETMETA_OFFSET UNITYSDK_OFFSET(0x1F6526B0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_UPDATEBLOCK_OFFSET UNITYSDK_OFFSET(0x1F652F60)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_UPDATESATE_OFFSET UNITYSDK_OFFSET(0x1F6530E0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_UPDATE_OFFSET UNITYSDK_OFFSET(0x1F6530B0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_WRITELOG_OFFSET UNITYSDK_OFFSET(0x1F650720)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1F6539C0)

namespace BinaryTracingCore::Source::TracingTools
{
	inline static constexpr unsigned int TracingSystem_TypeDefinitionIndex = 34600;
	...
	public:
		...
		::BinaryTracingCore::Source::TracingTools::LogMetaContainer* MetaContainer; // 0x20
		::BinaryTracingCore::Source::TracingTools::LogBlock* _curLogBlock; // 0x28
		::System::Diagnostics::Stopwatch* TimeStopwatch; // 0x30
