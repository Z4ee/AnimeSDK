...
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_DEFINELOGCHANNEL_OFFSET UNITYSDK_OFFSET(0x1BF04070)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_FLUSHWRITE_OFFSET UNITYSDK_OFFSET(0x1BF03F10)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_GETFRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x1BF03A80)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_GETTIME_OFFSET UNITYSDK_OFFSET(0x1BF03A90)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_INIT_OFFSET UNITYSDK_OFFSET(0x1BF036B0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_PUSHCURBLOCK_OFFSET UNITYSDK_OFFSET(0x1BF04240)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_REGISTERLOGMETA_OFFSET UNITYSDK_OFFSET(0x1BF03200)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_REGISTERTRACINGSYSTEM_OFFSET UNITYSDK_OFFSET(0x1BF03670)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_TRYGETMETA_OFFSET UNITYSDK_OFFSET(0x1BF03130)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_UPDATEBLOCK_OFFSET UNITYSDK_OFFSET(0x1BF039E0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_UPDATESATE_OFFSET UNITYSDK_OFFSET(0x1BF03B60)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_UPDATE_OFFSET UNITYSDK_OFFSET(0x1BF03B30)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_WRITELOG_OFFSET UNITYSDK_OFFSET(0x1BF011C0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF04430)

namespace BinaryTracingCore::Source::TracingTools
{
	inline static constexpr unsigned int TracingSystem_TypeDefinitionIndex = 32413;

	class TracingSystem : public ::System::Object
	{
	public:
		// static const ::System::String* TracingCondition; // 0x0
		::BinaryTracingFramework::Serialize::WriteLinker* Linker; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::Guid, ::BinaryTracingCore::Source::TracingTools::LogChannel*>* Channels; // 0x18
		::System::Diagnostics::Stopwatch* TimeStopwatch; // 0x20
		::BinaryTracingCore::Source::TracingTools::LogMetaContainer* MetaContainer; // 0x28
		::BinaryTracingCore::Source::TracingTools::LogBlock* _curLogBlock; // 0x30
