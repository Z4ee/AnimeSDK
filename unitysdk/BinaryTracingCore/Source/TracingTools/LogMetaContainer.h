...
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGMETACONTAINER_REGISTERLOGMETA_OFFSET UNITYSDK_OFFSET(0x1F651A20)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGMETACONTAINER_TRYGETMETA_1_OFFSET UNITYSDK_OFFSET(0x1F651BF0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGMETACONTAINER_TRYGETMETA_OFFSET UNITYSDK_OFFSET(0x1F651B30)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGMETACONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F651CD0)

namespace BinaryTracingCore::Source::TracingTools
{
	inline static constexpr unsigned int LogMetaContainer_TypeDefinitionIndex = 34596;
