...
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAAA800)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXY_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x324690)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXY_INITUNIT_OFFSET UNITYSDK_OFFSET(0xAAA7F0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXY_LOG_1_OFFSET UNITYSDK_OFFSET(0xAAA900)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXY_LOG_2_OFFSET UNITYSDK_OFFSET(0xAAA990)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXY_LOG_3_OFFSET UNITYSDK_OFFSET(0xAAAA10)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXY_LOG_OFFSET UNITYSDK_OFFSET(0xAAA880)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXY_SET_ISVALID_OFFSET UNITYSDK_OFFSET(0x324490)

namespace BinaryTracingCore::Source::TracingTools
{
	inline static constexpr unsigned int LogChannel_LogUnitProxy_TypeDefinitionIndex = 34584;
