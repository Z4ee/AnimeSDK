...
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA5C000)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXY_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x2ACBE0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXY_INITUNIT_OFFSET UNITYSDK_OFFSET(0xA5BFF0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXY_LOG_1_OFFSET UNITYSDK_OFFSET(0xA5C100)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXY_LOG_2_OFFSET UNITYSDK_OFFSET(0xA5C190)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXY_LOG_3_OFFSET UNITYSDK_OFFSET(0xA5C210)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXY_LOG_OFFSET UNITYSDK_OFFSET(0xA5C080)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXY_SET_ISVALID_OFFSET UNITYSDK_OFFSET(0x2ACBF0)

namespace BinaryTracingCore::Source::TracingTools
{
	inline static constexpr unsigned int LogChannel_LogUnitProxy_TypeDefinitionIndex = 33948;
