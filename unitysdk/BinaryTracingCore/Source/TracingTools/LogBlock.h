...
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_ADDUNIT_OFFSET UNITYSDK_OFFSET(0x1F64F530)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_GETLOGUNIT_OFFSET UNITYSDK_OFFSET(0x1F64F520)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_GET_FRAMECOUNTVIEW_OFFSET UNITYSDK_OFFSET(0x1F64F4F0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_GET_LOGUNITSVIEW_OFFSET UNITYSDK_OFFSET(0x1F64F4A0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_GET_TIMESTAMPVIEW_OFFSET UNITYSDK_OFFSET(0x1F64F500)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_RESET_OFFSET UNITYSDK_OFFSET(0x1F650210)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_RESLOVELOGUNIT_OFFSET UNITYSDK_OFFSET(0x1F64F590)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1F64F8E0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_SETUPHEADINFO_OFFSET UNITYSDK_OFFSET(0x1F64F510)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1F650410)

namespace BinaryTracingCore::Source::TracingTools
{
	inline static constexpr unsigned int LogBlock_TypeDefinitionIndex = 34582;
