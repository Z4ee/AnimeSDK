...
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_ADDUNIT_OFFSET UNITYSDK_OFFSET(0x1BEFFF50)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_GETLOGUNIT_OFFSET UNITYSDK_OFFSET(0x1BEFFF40)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_GET_FRAMECOUNTVIEW_OFFSET UNITYSDK_OFFSET(0x1BEFFF10)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_GET_LOGUNITSVIEW_OFFSET UNITYSDK_OFFSET(0x1BEFFEC0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_GET_TIMESTAMPVIEW_OFFSET UNITYSDK_OFFSET(0x1BEFFF20)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_RESET_OFFSET UNITYSDK_OFFSET(0x1BF00CB0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_RESLOVELOGUNIT_OFFSET UNITYSDK_OFFSET(0x1BEFFFB0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1BF00300)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_SETUPHEADINFO_OFFSET UNITYSDK_OFFSET(0x1BEFFF30)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF00EB0)

namespace BinaryTracingCore::Source::TracingTools
{
	inline static constexpr unsigned int LogBlock_TypeDefinitionIndex = 32395;
