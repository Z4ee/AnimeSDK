...
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGMETA_GET_METATYPE_OFFSET UNITYSDK_OFFSET(0x1E22D310)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGMETA_GET_PROPERTIESVIEW_OFFSET UNITYSDK_OFFSET(0x1E22D2B0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGMETA_MATCH_OFFSET UNITYSDK_OFFSET(0x1E22D460)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGMETA_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E22D7B0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGMETA_SET_METATYPE_OFFSET UNITYSDK_OFFSET(0x1E22D320)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGMETA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E22D330)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGMETA__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E22D3C0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGMETA__CTOR_OFFSET UNITYSDK_OFFSET(0x1E22CF80)

namespace BinaryTracingCore::Source::TracingTools
{
	inline static constexpr unsigned int LogMeta_TypeDefinitionIndex = 33958;
