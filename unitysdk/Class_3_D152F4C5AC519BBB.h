...
#define CLASS_3_D152F4C5AC519BBB_EVALUATE_OFFSET UNITYSDK_OFFSET(0x12527CB0)
#define CLASS_3_D152F4C5AC519BBB__CTOR_OFFSET UNITYSDK_OFFSET(0x12527C80)

inline static constexpr unsigned int Class_3_D152F4C5AC519BBB_TypeDefinitionIndex = 48970;
