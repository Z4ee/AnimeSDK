...
#define PROFILINGRECORDER_SYSTEMTIMERECORDER_SYSTEMTIMEDELTA_TOJSON_OFFSET UNITYSDK_OFFSET(0x95C2A0)
#define PROFILINGRECORDER_SYSTEMTIMERECORDER_SYSTEMTIMEDELTA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x95C210)
#define PROFILINGRECORDER_SYSTEMTIMERECORDER_SYSTEMTIMEDELTA___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x95C2B0)

namespace ProfilingRecorder
{
	inline static constexpr unsigned int SystemTimeRecorder_SystemTimeDelta_TypeDefinitionIndex = 38009;
