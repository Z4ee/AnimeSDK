...
#define PROFILINGRECORDER_ECSRECORDER_BEGIN_OFFSET UNITYSDK_OFFSET(0x1BC3E240)
#define PROFILINGRECORDER_ECSRECORDER_END_OFFSET UNITYSDK_OFFSET(0x1BC3E2A0)
#define PROFILINGRECORDER_ECSRECORDER_GETCOMPONENTCOUNTBYTYPE_OFFSET UNITYSDK_OFFSET(0x1BC3DC70)
#define PROFILINGRECORDER_ECSRECORDER_GETTOTALARCHETYPECOUNT_OFFSET UNITYSDK_OFFSET(0x1BC3D7E0)
#define PROFILINGRECORDER_ECSRECORDER_GETTOTALCOMPONENTCOUNT_OFFSET UNITYSDK_OFFSET(0x1BC3D550)
#define PROFILINGRECORDER_ECSRECORDER_GETTOTALENTITYCOUNT_OFFSET UNITYSDK_OFFSET(0x1BC3DAC0)
#define PROFILINGRECORDER_ECSRECORDER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1BC3D4A0)
#define PROFILINGRECORDER_ECSRECORDER_GET_ISRECORDING_OFFSET UNITYSDK_OFFSET(0x1BC3D520)
#define PROFILINGRECORDER_ECSRECORDER_GET_LASTDELTA_OFFSET UNITYSDK_OFFSET(0x1BC3D530)
#define PROFILINGRECORDER_ECSRECORDER_PROFILINGRECORDER_IPROFILERRECORDER_END_OFFSET UNITYSDK_OFFSET(0x1BC3E820)
#define PROFILINGRECORDER_ECSRECORDER_TAKESNAPSHOT_OFFSET UNITYSDK_OFFSET(0x1BC3E190)
#define PROFILINGRECORDER_ECSRECORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC3D510)

namespace ProfilingRecorder
{
	inline static constexpr unsigned int EcsRecorder_TypeDefinitionIndex = 85710;
	...
	public:
		...
		{
			return (::ProfilingRecorder::EcsRecorder**)Il2CppClass::FromTypeDefinitionIndex(EcsRecorder_TypeDefinitionIndex)->GetStaticField(0x437C0);
		}
		::ProfilingRecorder::EcsRecorder_EcsSnapshot _beginSnapshot; // 0x10
		::ProfilingRecorder::EcsRecorder_EcsDelta _lastDelta; // 0x30
