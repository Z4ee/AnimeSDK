...
#define PROFILINGRECORDER_SYSTEMTIMERECORDER_SYSTEMTIMESNAPSHOT_TOJSON_OFFSET UNITYSDK_OFFSET(0x95C540)
#define PROFILINGRECORDER_SYSTEMTIMERECORDER_SYSTEMTIMESNAPSHOT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x95C4B0)
#define PROFILINGRECORDER_SYSTEMTIMERECORDER_SYSTEMTIMESNAPSHOT___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x95C550)

namespace ProfilingRecorder
{
	inline static constexpr unsigned int SystemTimeRecorder_SystemTimeSnapshot_TypeDefinitionIndex = 38010;
