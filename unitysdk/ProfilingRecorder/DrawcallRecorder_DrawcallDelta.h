...
#define PROFILINGRECORDER_DRAWCALLRECORDER_DRAWCALLDELTA_TOJSON_OFFSET UNITYSDK_OFFSET(0x881AD0)
#define PROFILINGRECORDER_DRAWCALLRECORDER_DRAWCALLDELTA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x881A80)
#define PROFILINGRECORDER_DRAWCALLRECORDER_DRAWCALLDELTA___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x881AE0)

namespace ProfilingRecorder
{
	inline static constexpr unsigned int DrawcallRecorder_DrawcallDelta_TypeDefinitionIndex = 50916;
