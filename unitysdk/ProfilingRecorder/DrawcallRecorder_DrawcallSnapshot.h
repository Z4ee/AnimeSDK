...
#define PROFILINGRECORDER_DRAWCALLRECORDER_DRAWCALLSNAPSHOT_TOJSON_OFFSET UNITYSDK_OFFSET(0x99E880)
#define PROFILINGRECORDER_DRAWCALLRECORDER_DRAWCALLSNAPSHOT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x99E830)
#define PROFILINGRECORDER_DRAWCALLRECORDER_DRAWCALLSNAPSHOT___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x99E890)

namespace ProfilingRecorder
{
	inline static constexpr unsigned int DrawcallRecorder_DrawcallSnapshot_TypeDefinitionIndex = 52484;
