...
#define CLASS_2_EC9A90E156962139_METHOD_2_3534CF2C51C37C8D_OFFSET UNITYSDK_OFFSET(0x1599B370)
#define CLASS_2_EC9A90E156962139_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x15999290)
#define CLASS_2_EC9A90E156962139_METHOD_2_479759059E440327_OFFSET UNITYSDK_OFFSET(0x159989B0)
#define CLASS_2_EC9A90E156962139_METHOD_2_4D60943103925095_OFFSET UNITYSDK_OFFSET(0x159995A0)
#define CLASS_2_EC9A90E156962139_METHOD_2_54A28F738B046BF4_OFFSET UNITYSDK_OFFSET(0x159996D0)
#define CLASS_2_EC9A90E156962139_METHOD_2_7C231B65E5CBDDC5_OFFSET UNITYSDK_OFFSET(0x1599AA60)
#define CLASS_2_EC9A90E156962139_METHOD_2_AB7ED27CAB69BE58_OFFSET UNITYSDK_OFFSET(0x15998A30)
#define CLASS_2_EC9A90E156962139_METHOD_2_ABE7715DB28B2DD1_OFFSET UNITYSDK_OFFSET(0x159992F0)
#define CLASS_2_EC9A90E156962139_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x15999250)
#define CLASS_2_EC9A90E156962139_METHOD_2_CBF99CCF420B8CA6_OFFSET UNITYSDK_OFFSET(0x15999F80)
#define CLASS_2_EC9A90E156962139_METHOD_2_DBF39D86165EF946_OFFSET UNITYSDK_OFFSET(0x159999B0)
#define CLASS_2_EC9A90E156962139__CTOR_OFFSET UNITYSDK_OFFSET(0x15998880)

inline static constexpr unsigned int Class_2_EC9A90E156962139_TypeDefinitionIndex = 77426;

class Class_2_EC9A90E156962139 : public ::Class_1_F65B6F8790DF074B
{
public:
	::System::Collections::Generic::List_1<::Class_2_6B60059019300BAD*>* GAGHFGFDONO; // 0x28
	::Class_1_CD06BB4AEFF829C1* AFFCEKNCAHL; // 0x30
	::RPG::GameCore::ChenLingBattleAbility_CreateLaser* AFJCHEPKFNO; // 0x38
	::System::Boolean OELBLBCINNB; // 0x40
	::System::Single COCJDAKNIAP; // 0x44
	::System::Single HBANLBGKNKP; // 0x48
