...
#define CLASS_1_6DF0D90298F36A2E_2_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x181AFE40)
#define CLASS_1_6DF0D90298F36A2E_2_CLONE_OFFSET UNITYSDK_OFFSET(0x181AF980)
#define CLASS_1_6DF0D90298F36A2E_2_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x181AFA20)
#define CLASS_1_6DF0D90298F36A2E_2_EQUALS_OFFSET UNITYSDK_OFFSET(0x181AF9F0)
#define CLASS_1_6DF0D90298F36A2E_2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x181AFB10)
#define CLASS_1_6DF0D90298F36A2E_2_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x181B0060)
#define CLASS_1_6DF0D90298F36A2E_2_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x181AFFA0)
#define CLASS_1_6DF0D90298F36A2E_2_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x181AF9D0)
#define CLASS_1_6DF0D90298F36A2E_2_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x181AF9B0)
#define CLASS_1_6DF0D90298F36A2E_2_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x181AF9C0)
#define CLASS_1_6DF0D90298F36A2E_2_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x181AF9E0)
#define CLASS_1_6DF0D90298F36A2E_2_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x181AF800)
#define CLASS_1_6DF0D90298F36A2E_2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x181AFCD0)
#define CLASS_1_6DF0D90298F36A2E_2_WRITETO_OFFSET UNITYSDK_OFFSET(0x181AFD30)
#define CLASS_1_6DF0D90298F36A2E_2__CCTOR_OFFSET UNITYSDK_OFFSET(0x181B0180)
#define CLASS_1_6DF0D90298F36A2E_2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x181AF880)
#define CLASS_1_6DF0D90298F36A2E_2__CTOR_OFFSET UNITYSDK_OFFSET(0x181AF810)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6DF0D90298F36A2E_2_TypeDefinitionIndex)->GetStaticField(0x2C900);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_F1F83A16E5B8B459_2*>** StaticGet_Field_1_5()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_F1F83A16E5B8B459_2*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6DF0D90298F36A2E_2_TypeDefinitionIndex)->GetStaticField(0x2C908);
	}
	// static const ::System::Int32 Field_1_1 = 0x2; // 0x0
	// static const ::System::Int32 Field_1_4 = 0xB; // 0x0
	// static const ::System::Int32 Field_1_7 = 0xD; // 0x0
	::Google::Protobuf::UnknownFieldSet* Field_1_0; // 0x10
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_F1F83A16E5B8B459_2*>* Field_1_6; // 0x18
