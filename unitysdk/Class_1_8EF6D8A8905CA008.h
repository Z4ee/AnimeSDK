...
#define CLASS_1_8EF6D8A8905CA008__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA9A4B0)
...
public:
	...
	::UnityEngine::Vector3 EAHFKEGAHKE; // 0x1C
	::UnityEngine::Vector3 NIBGNGICDOO; // 0x28
	::UnityEngine::Vector3 IKNAAOPEKFP; // 0x34
