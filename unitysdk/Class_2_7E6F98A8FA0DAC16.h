...
#define CLASS_2_7E6F98A8FA0DAC16_BEFOREDISPOSE_OFFSET UNITYSDK_OFFSET(0x108C6F90)
#define CLASS_2_7E6F98A8FA0DAC16_DISPOSE_OFFSET UNITYSDK_OFFSET(0x108C7150)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_016A610D2E27A33E_OFFSET UNITYSDK_OFFSET(0x108CA190)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_0860F812E446AE7C_OFFSET UNITYSDK_OFFSET(0x108C9D40)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_0986B6F765C6D4BF_1_OFFSET UNITYSDK_OFFSET(0x108C98D0)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_0986B6F765C6D4BF_2_OFFSET UNITYSDK_OFFSET(0x108C9980)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_0986B6F765C6D4BF_OFFSET UNITYSDK_OFFSET(0x108C9820)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_1107D58E9DAAA01A_OFFSET UNITYSDK_OFFSET(0x108C9BC0)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_12F55A3B72ABD40C_1_OFFSET UNITYSDK_OFFSET(0x108C9B60)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_12F55A3B72ABD40C_OFFSET UNITYSDK_OFFSET(0x108C8B70)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_3A9C03366E936C66_OFFSET UNITYSDK_OFFSET(0x108C7690)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x108C9A30)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x108C8BD0)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_4E06A3CAB868F83F_OFFSET UNITYSDK_OFFSET(0x108C81F0)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_51B145293EFD5C20_OFFSET UNITYSDK_OFFSET(0x108C9320)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_55157FBA4997D865_OFFSET UNITYSDK_OFFSET(0x108C9240)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_56CE4AFC5339F746_OFFSET UNITYSDK_OFFSET(0x108C8CA0)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_57E9D53C8A17BFCC_OFFSET UNITYSDK_OFFSET(0x108C97A0)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_5AD6FBFC290F7CFF_OFFSET UNITYSDK_OFFSET(0x108C8830)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_7003271FF3C0F5CC_OFFSET UNITYSDK_OFFSET(0x108C70C0)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_7D602A72F2676500_OFFSET UNITYSDK_OFFSET(0x108C9440)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_7F29568EA964E563_OFFSET UNITYSDK_OFFSET(0x108C9F50)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_83EF02F8F4B2192A_OFFSET UNITYSDK_OFFSET(0x108C8F60)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_89BAEFE98AE475D0_OFFSET UNITYSDK_OFFSET(0x108C7AB0)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0x108C9620)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_B7A43C06FD78D78B_OFFSET UNITYSDK_OFFSET(0x108C94F0)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_BB2928BEC244DEB7_OFFSET UNITYSDK_OFFSET(0x108C8B20)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_BDEE96BFE11032F9_OFFSET UNITYSDK_OFFSET(0x108C92B0)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_C77463CBD1FD0903_OFFSET UNITYSDK_OFFSET(0x108C6CD0)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x108C9B20)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x108C95E0)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_D3789CFB5317098B_OFFSET UNITYSDK_OFFSET(0x108C8D70)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_E69AA2E64A20143D_OFFSET UNITYSDK_OFFSET(0x108C8530)
#define CLASS_2_7E6F98A8FA0DAC16_METHOD_2_FFE382724CE391A4_OFFSET UNITYSDK_OFFSET(0x108C7930)
#define CLASS_2_7E6F98A8FA0DAC16_TICK_OFFSET UNITYSDK_OFFSET(0x108C7580)
#define CLASS_2_7E6F98A8FA0DAC16__CTOR_OFFSET UNITYSDK_OFFSET(0x108CA1A0)
#define CLASS_2_7E6F98A8FA0DAC16__ONINITOWNERREF_OFFSET UNITYSDK_OFFSET(0x108C6A20)
#define CLASS_2_7E6F98A8FA0DAC16___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x108CA2A0)
#define CLASS_2_7E6F98A8FA0DAC16___IFIXBASEPROXY__ONINITOWNERREF_OFFSET UNITYSDK_OFFSET(0x108CA240)
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_2_7E6F98A8FA0DAC16_TypeDefinitionIndex)->GetStaticField(0x131F0);
	}
	// static const ::System::String* Field_2_15; // 0x0
	::RPG::GameCore::ToastPile* Field_2_20; // 0x18
	::System::Collections::Generic::List_1<::Class_2_7E6F98A8FA0DAC16_Class_1_39154B8B2AA98D66_1*>* Field_2_3; // 0x20
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* Field_2_24; // 0x28
	::RPG::GameCore::GameEntity* Field_2_6; // 0x30
	::Class_2_775953B773EF713C* Field_2_7; // 0x38
	::Class_2_7E6F98A8FA0DAC16_Class_1_2C3C4102E0261131_1* Field_2_2; // 0x40
	::RPG::GameCore::ToastPile* Field_2_21; // 0x48
	::Il2CppArray<::Class_1_DD81253E160EB8B2*>* Field_2_17; // 0x50
	::Class_1_CC64129879E362BF_Class_1_F430351B57E59FB6* Field_2_27; // 0x58
	::RPG::GameCore::PropComponent* Field_2_8; // 0x60
	::RPG::GameCore::ColliderTriggerComponent* Field_2_9; // 0x68
	::UnityEngine::Transform* Field_2_10; // 0x70
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::TimeRewindControlSwitcherState, ::Class_2_7E6F98A8FA0DAC16_Class_1_2C3C4102E0261131_1*>* Field_2_1; // 0x78
	::RPG::GameCore::ButtonListTrigger* Field_2_12; // 0x80
	::RPG::GameCore::GameEntity* Field_2_4; // 0x88
	::System::String* Field_2_14; // 0x90
	::Class_2_775953B773EF713C* Field_2_5; // 0x98
	::Il2CppArray<::Class_1_DD81253E160EB8B2*>* Field_2_18; // 0xA0
	::Class_3_5775A4FEC79026BC* Field_2_19; // 0xA8
	::System::Collections::Generic::List_1<::System::String*>* Field_2_11; // 0xB0
	::System::Single Field_2_25; // 0xB8
	::System::Int32 Field_2_29; // 0xBC
	::System::UInt32 Field_2_22; // 0xC0
	::System::Int32 Field_2_28; // 0xC4
	::System::Boolean Field_2_16; // 0xC8
	::System::Boolean Field_2_26; // 0xC9
	::System::Boolean Field_2_30; // 0xCA
	::System::Boolean Field_2_31; // 0xCB
	::System::UInt32 Field_2_23; // 0xCC
	::RPG::GameCore::TimeRewindControlSwitcherState Field_2_0; // 0xD0
