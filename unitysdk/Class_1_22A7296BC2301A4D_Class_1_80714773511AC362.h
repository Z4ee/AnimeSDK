...
#define CLASS_1_22A7296BC2301A4D_CLASS_1_80714773511AC362__CTOR_OFFSET UNITYSDK_OFFSET(0x15952700)
...
{
public:
	::RPG::GameCore::StageBattleEventConfig* EABKOHGCHFP; // 0x10
	::RPG::GameCore::StageBattleEventRow* FDKPNKAGNFO; // 0x18
