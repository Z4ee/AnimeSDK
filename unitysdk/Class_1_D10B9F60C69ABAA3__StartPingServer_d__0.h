...
#define CLASS_1_D10B9F60C69ABAA3__STARTPINGSERVER_D__0_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x17078990)
#define CLASS_1_D10B9F60C69ABAA3__STARTPINGSERVER_D__0_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x17078DA0)
#define CLASS_1_D10B9F60C69ABAA3__STARTPINGSERVER_D__0_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x17078E00)
#define CLASS_1_D10B9F60C69ABAA3__STARTPINGSERVER_D__0_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x17078DB0)
#define CLASS_1_D10B9F60C69ABAA3__STARTPINGSERVER_D__0_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17078980)
#define CLASS_1_D10B9F60C69ABAA3__STARTPINGSERVER_D__0__CTOR_OFFSET UNITYSDK_OFFSET(0x17078700)
...
public:
	...
	::System::Action* onPingsFinished; // 0x20
	::RPG::Client::GlobalDispatchData* data; // 0x28
