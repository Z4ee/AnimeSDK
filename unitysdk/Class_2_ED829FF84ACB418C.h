...
#define CLASS_2_ED829FF84ACB418C_CLEAR_OFFSET UNITYSDK_OFFSET(0x167C3910)
#define CLASS_2_ED829FF84ACB418C__CTOR_OFFSET UNITYSDK_OFFSET(0x167C3970)
#define CLASS_2_ED829FF84ACB418C___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0x167C3980)

inline static constexpr unsigned int Class_2_ED829FF84ACB418C_TypeDefinitionIndex = 33553;
