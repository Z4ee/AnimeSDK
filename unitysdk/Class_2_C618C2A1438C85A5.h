...
#define CLASS_2_C618C2A1438C85A5_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9A2DD80)
#define CLASS_2_C618C2A1438C85A5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x9A2DDC0)
#define CLASS_2_C618C2A1438C85A5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x9A2DF40)
#define CLASS_2_C618C2A1438C85A5_TICK_OFFSET UNITYSDK_OFFSET(0x9A2DF90)
#define CLASS_2_C618C2A1438C85A5__CTOR_OFFSET UNITYSDK_OFFSET(0x9A2DD00)

inline static constexpr unsigned int Class_2_C618C2A1438C85A5_TypeDefinitionIndex = 52010;

class Class_2_C618C2A1438C85A5 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SetTargetCrossHairVisible* Field_2_0; // 0x18
	::Class_1_9CAA42EF32347EE5_2* Field_2_2; // 0x20
