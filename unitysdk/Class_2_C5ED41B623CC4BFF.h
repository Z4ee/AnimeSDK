...
#define CLASS_2_C5ED41B623CC4BFF_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19BDCCA0)
#define CLASS_2_C5ED41B623CC4BFF_METHOD_2_D148B5D9B2EC21BB_OFFSET UNITYSDK_OFFSET(0x19BDD000)
#define CLASS_2_C5ED41B623CC4BFF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x19BDCCF0)
#define CLASS_2_C5ED41B623CC4BFF_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x19BDCE80)
#define CLASS_2_C5ED41B623CC4BFF_TICK_OFFSET UNITYSDK_OFFSET(0x19BDCED0)
#define CLASS_2_C5ED41B623CC4BFF__CTOR_OFFSET UNITYSDK_OFFSET(0x19BDCC90)
...
{
public:
	::Class_1_1CD633F3449963C2* EIHIJPGBJFO; // 0x18
	::RPG::GameCore::TutorialClickBtn* OFKGLJOAMLD; // 0x20
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x28
	::Class_1_BAD2D343EF0045A3* ALDDFNIAIKP; // 0x30
