...
#define CLASS_1_5B567C8A01BAEDFE_330_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1D84BB20)
#define CLASS_1_5B567C8A01BAEDFE_330_CLONE_OFFSET UNITYSDK_OFFSET(0x1D84B810)
#define CLASS_1_5B567C8A01BAEDFE_330_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1D84B920)
#define CLASS_1_5B567C8A01BAEDFE_330_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D84B850)
#define CLASS_1_5B567C8A01BAEDFE_330_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D84BA80)
#define CLASS_1_5B567C8A01BAEDFE_330_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1D84BB70)
#define CLASS_1_5B567C8A01BAEDFE_330_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1D84BB40)
#define CLASS_1_5B567C8A01BAEDFE_330_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1D84B790)
#define CLASS_1_5B567C8A01BAEDFE_330_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1D84B7C0)
#define CLASS_1_5B567C8A01BAEDFE_330_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D84BAB0)
#define CLASS_1_5B567C8A01BAEDFE_330_WRITETO_OFFSET UNITYSDK_OFFSET(0x1D84BB10)
#define CLASS_1_5B567C8A01BAEDFE_330__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D84BBC0)
#define CLASS_1_5B567C8A01BAEDFE_330__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D84B7E0)
#define CLASS_1_5B567C8A01BAEDFE_330__CTOR_OFFSET UNITYSDK_OFFSET(0x1D84B7D0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_330_TypeDefinitionIndex = 33363;

class Class_1_5B567C8A01BAEDFE_330 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_330*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_330*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_330_TypeDefinitionIndex)->GetStaticField(0x35330);
	}
