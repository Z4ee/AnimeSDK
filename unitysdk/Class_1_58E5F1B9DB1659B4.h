...
#define CLASS_1_58E5F1B9DB1659B4_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15AC1B00)
#define CLASS_1_58E5F1B9DB1659B4_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x15AC1980)
#define CLASS_1_58E5F1B9DB1659B4_METHOD_1_76CD9B9D1269FA90_OFFSET UNITYSDK_OFFSET(0x15AC18A0)
#define CLASS_1_58E5F1B9DB1659B4_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x15AC1A80)
#define CLASS_1_58E5F1B9DB1659B4_METHOD_1_EC9C71CF50EEA7C5_OFFSET UNITYSDK_OFFSET(0x15AC1C40)
#define CLASS_1_58E5F1B9DB1659B4__CTOR_OFFSET UNITYSDK_OFFSET(0x15AC1820)

inline static constexpr unsigned int Class_1_58E5F1B9DB1659B4_TypeDefinitionIndex = 61020;

class Class_1_58E5F1B9DB1659B4 : public ::System::Object
{
public:
	::Class_3_07C3C4D2990C49EE* FGOLPCMCNNM; // 0x10
	::RPG::GameCore::TrackPhotoEvent* AJMCGNIDAEA; // 0x18
	::System::Boolean ANGACHKEMLG; // 0x20
