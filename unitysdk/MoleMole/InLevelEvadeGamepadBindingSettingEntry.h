...
#define MOLEMOLE_INLEVELEVADEGAMEPADBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x17E83F20)
#define MOLEMOLE_INLEVELEVADEGAMEPADBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x17E83F30)
#define MOLEMOLE_INLEVELEVADEGAMEPADBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x17E83F40)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelEvadeGamepadBindingSettingEntry_TypeDefinitionIndex = 61782;
