...
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER_ACTLEVELRESULTCAMERA_OFFSET UNITYSDK_OFFSET(0x1529A3D0)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1529A2A0)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER_HASENDBATTLE_OFFSET UNITYSDK_OFFSET(0x1529B710)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER_INITLOSEVIEW_OFFSET UNITYSDK_OFFSET(0x1529B200)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x1529AAF0)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1529B020)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1529A2B0)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1529B140)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1529AB40)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER_PLAYEXIT_OFFSET UNITYSDK_OFFSET(0x1529B8A0)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER_REFRESHLOSEVIEW_OFFSET UNITYSDK_OFFSET(0x1529BB50)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER_SETMOVE_OFFSET UNITYSDK_OFFSET(0x1529AD60)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x1529B0B0)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1529C3D0)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER__INITLOSEVIEW_B__14_0_OFFSET UNITYSDK_OFFSET(0x1529C3E0)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER__INITLOSEVIEW_B__14_1_OFFSET UNITYSDK_OFFSET(0x1529C400)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1529C470)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1529C500)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1529C510)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1529C520)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x1529C530)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelLoseResultPageController_TypeDefinitionIndex = 77626;

	class UILevelLoseResultPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_94D5884806027679_2* _view; // 0x310
		::MoleMole::UILevelResultPageContext* _curResultContext; // 0x318
		::MoleMole::MonoLevelResultInfo* _levelResultInfo; // 0x320
		::Foundation::Coroutine::CoroutineHandle _animHandle; // 0x328
		::System::Boolean _isShowed; // 0x32C
