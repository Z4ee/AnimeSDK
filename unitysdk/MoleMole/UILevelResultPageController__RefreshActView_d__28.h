...
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__REFRESHACTVIEW_D__28_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x14D2F930)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__REFRESHACTVIEW_D__28_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x14D30650)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__REFRESHACTVIEW_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x14D306B0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__REFRESHACTVIEW_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x14D30660)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__REFRESHACTVIEW_D__28_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14D2F920)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__REFRESHACTVIEW_D__28__CTOR_OFFSET UNITYSDK_OFFSET(0x14D2F910)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultPageController__RefreshActView_d__28_TypeDefinitionIndex = 68606;
