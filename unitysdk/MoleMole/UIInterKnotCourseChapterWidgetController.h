...
#define MOLEMOLE_UIINTERKNOTCOURSECHAPTERWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1911FE90)
#define MOLEMOLE_UIINTERKNOTCOURSECHAPTERWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1911FF00)
#define MOLEMOLE_UIINTERKNOTCOURSECHAPTERWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1911FFA0)
#define MOLEMOLE_UIINTERKNOTCOURSECHAPTERWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x19120060)
#define MOLEMOLE_UIINTERKNOTCOURSECHAPTERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19120290)
#define MOLEMOLE_UIINTERKNOTCOURSECHAPTERWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x191202A0)
#define MOLEMOLE_UIINTERKNOTCOURSECHAPTERWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x19120340)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotCourseChapterWidgetController_TypeDefinitionIndex = 53273;
