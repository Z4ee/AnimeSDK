...
#define MOLEMOLE_UIVRBOSSCARDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x10EFB1A0)
#define MOLEMOLE_UIVRBOSSCARDWIDGETCONTROLLER_ONRELATEDAVATARBTNCLICK_OFFSET UNITYSDK_OFFSET(0x10EFC470)
#define MOLEMOLE_UIVRBOSSCARDWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x10EFB2B0)
#define MOLEMOLE_UIVRBOSSCARDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x10EFB230)
#define MOLEMOLE_UIVRBOSSCARDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x10EFAED0)
#define MOLEMOLE_UIVRBOSSCARDWIDGETCONTROLLER_SETBURNTIP_OFFSET UNITYSDK_OFFSET(0x10EFC1C0)
#define MOLEMOLE_UIVRBOSSCARDWIDGETCONTROLLER_SETREWARDBUFFICON_OFFSET UNITYSDK_OFFSET(0x10EFC030)
#define MOLEMOLE_UIVRBOSSCARDWIDGETCONTROLLER_SETREWARDBUFFTIP_OFFSET UNITYSDK_OFFSET(0x10EFC230)
#define MOLEMOLE_UIVRBOSSCARDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x10EFC4E0)
#define MOLEMOLE_UIVRBOSSCARDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x10EFC570)
#define MOLEMOLE_UIVRBOSSCARDWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x10EFC600)
#define MOLEMOLE_UIVRBOSSCARDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x10EFC6A0)
#define MOLEMOLE_UIVRBOSSCARDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x10EFC730)

namespace MoleMole
{
	inline static constexpr unsigned int UIVRBossCardWidgetController_TypeDefinitionIndex = 81439;
	...
	public:
		...
		::System::Collections::Generic::List_1<::MoleMole::UIItemIconBtnWidgetController*>* _rewardIcons; // 0x2F0
		::MoleMole::UIDailyChallengeCardRowWidgetController* _cardController; // 0x2F8
		::Class_2_B59A5BC3EDB05A2C* _view; // 0x300
		::Class_2_208CC9941471731A_732* _quest; // 0x308
