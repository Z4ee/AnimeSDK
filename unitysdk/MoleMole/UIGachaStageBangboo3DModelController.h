...
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLER_APPLYITEMREF2BASECTRLER_OFFSET UNITYSDK_OFFSET(0x151AF580)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x151AF480)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x151AF510)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x151AF3D0)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x151AF430)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x151AFC80)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x151AFCF0)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x151AFD80)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x151AFD90)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x151AFDE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaStageBangboo3DModelController_TypeDefinitionIndex = 56563;

	class UIGachaStageBangboo3DModelController : public ::MoleMole::UIGachaStageBangboo3DModelControllerBase
	{
	public:
		::Class_2_60638234271CCDB8_102* _view; // 0x6E8
