...
class Class_2_60638234271CCDB8_163;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }

#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLER_APPLYITEMREF2BASECTRLER_OFFSET UNITYSDK_OFFSET(0x1859AFE0)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1859AEE0)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1859AF70)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1859AE30)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1859AE90)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1859B6E0)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1859B750)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1859B7E0)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1859B7F0)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1859B840)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaStageBangboo3DModelController_TypeDefinitionIndex = 80928;

	class UIGachaStageBangboo3DModelController : public ::MoleMole::UIGachaStageBangboo3DModelControllerBase
	{
	public:
		::Class_2_60638234271CCDB8_163* _view; // 0x6F0
