...
#define MOLEMOLE_UIINLEVELSKILLBUTTONZIPLINECHANGEEFFWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x183826F0)
#define MOLEMOLE_UIINLEVELSKILLBUTTONZIPLINECHANGEEFFWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18382760)
#define MOLEMOLE_UIINLEVELSKILLBUTTONZIPLINECHANGEEFFWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18382800)
#define MOLEMOLE_UIINLEVELSKILLBUTTONZIPLINECHANGEEFFWIDGETCONTROLLER_PLAYFEEDBACK_OFFSET UNITYSDK_OFFSET(0x18382A90)
#define MOLEMOLE_UIINLEVELSKILLBUTTONZIPLINECHANGEEFFWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18382DF0)
#define MOLEMOLE_UIINLEVELSKILLBUTTONZIPLINECHANGEEFFWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18382E50)
#define MOLEMOLE_UIINLEVELSKILLBUTTONZIPLINECHANGEEFFWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18382EF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelSkillButtonZiplineChangeEffWidgetController_TypeDefinitionIndex = 53376;
