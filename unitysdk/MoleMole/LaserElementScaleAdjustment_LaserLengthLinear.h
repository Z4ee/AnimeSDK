...
#define MOLEMOLE_LASERELEMENTSCALEADJUSTMENT_LASERLENGTHLINEAR__CTOR_OFFSET UNITYSDK_OFFSET(0x17380B80)

namespace MoleMole
{
	inline static constexpr unsigned int LaserElementScaleAdjustment_LaserLengthLinear_TypeDefinitionIndex = 74493;
