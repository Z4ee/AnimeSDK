...
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x18C00550)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x18C00540)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_LEFTBTNCALL_OFFSET UNITYSDK_OFFSET(0x18C02420)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONCLICKCONSOLECHECKCONSUMEBTN_OFFSET UNITYSDK_OFFSET(0x18C02E50)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONCLICKCONSUMEICONBTN_OFFSET UNITYSDK_OFFSET(0x18C02DB0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18C00AB0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONINFOCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x18C01800)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONLEVELUPRSP_OFFSET UNITYSDK_OFFSET(0x18C01CF0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18C00DF0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18C019F0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18C00560)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_RESETCONTEXT_OFFSET UNITYSDK_OFFSET(0x18C01540)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_RIGHTBTNCALL_OFFSET UNITYSDK_OFFSET(0x18C02370)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_SETATTRIBUTEUI_OFFSET UNITYSDK_OFFSET(0x18C024D0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_SETSTARUPORTOPLIMITATT_OFFSET UNITYSDK_OFFSET(0x18C029C0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_SETTITLE_OFFSET UNITYSDK_OFFSET(0x18C01E50)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_SETUPGRADESTATE_OFFSET UNITYSDK_OFFSET(0x18C02D50)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_SHOWBACKITEMLISTDIALOG_OFFSET UNITYSDK_OFFSET(0x18C01BE0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0x18C01100)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18C02F40)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER__SHOWBACKITEMLISTDIALOG_B__12_0_OFFSET UNITYSDK_OFFSET(0x18C03020)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18C030E0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18C03170)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18C03180)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18C03190)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooDevelopPopWindowController_TypeDefinitionIndex = 42587;

	class UIBangbooDevelopPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_27* _view; // 0x318
