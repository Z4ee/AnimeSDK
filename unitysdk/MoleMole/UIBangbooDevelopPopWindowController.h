...
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x176D21A0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x176D2190)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_LEFTBTNCALL_OFFSET UNITYSDK_OFFSET(0x176D4070)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONCLICKCONSOLECHECKCONSUMEBTN_OFFSET UNITYSDK_OFFSET(0x176D4AC0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONCLICKCONSUMEICONBTN_OFFSET UNITYSDK_OFFSET(0x176D4A20)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x176D2710)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONINFOCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x176D3470)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONLEVELUPRSP_OFFSET UNITYSDK_OFFSET(0x176D3960)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x176D2A50)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x176D3660)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x176D21B0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_RESETCONTEXT_OFFSET UNITYSDK_OFFSET(0x176D31B0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_RIGHTBTNCALL_OFFSET UNITYSDK_OFFSET(0x176D3FC0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_SETATTRIBUTEUI_OFFSET UNITYSDK_OFFSET(0x176D4120)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_SETSTARUPORTOPLIMITATT_OFFSET UNITYSDK_OFFSET(0x176D4630)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_SETTITLE_OFFSET UNITYSDK_OFFSET(0x176D3AC0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_SETUPGRADESTATE_OFFSET UNITYSDK_OFFSET(0x176D49C0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_SHOWBACKITEMLISTDIALOG_OFFSET UNITYSDK_OFFSET(0x176D3850)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0x176D2D60)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x176D4BB0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER__SHOWBACKITEMLISTDIALOG_B__12_0_OFFSET UNITYSDK_OFFSET(0x176D4C90)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x176D4D50)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x176D4DE0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x176D4DF0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x176D4E00)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooDevelopPopWindowController_TypeDefinitionIndex = 48642;

	class UIBangbooDevelopPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_21* _view; // 0x318
		::MoleMole::UIWidgetController* _curSubController; // 0x320
		::MoleMole::UIBangbooDevelopDialogContext* _context; // 0x328
		::System::Collections::Generic::List_1<::MoleMole::BangbooBaseWidget*>* _subControllers; // 0x330
		::System::Collections::Generic::List_1<::Class_1_C5FDB00B12827EE9*>* _curPropertyItemViews; // 0x338
		::Struct_2_928A3C549784FC97 currentUpgradeAniState; // 0x340
		::System::Collections::Generic::List_1<::Class_1_0D6706375CDAAE8C*>* backItemList; // 0x348
		::System::Collections::Generic::List_1<::MoleMole::ScrollViewItemWidgetController*>* starAttributes; // 0x350
