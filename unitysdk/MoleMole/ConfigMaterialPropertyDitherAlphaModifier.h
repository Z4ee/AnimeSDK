...
#define MOLEMOLE_CONFIGMATERIALPROPERTYDITHERALPHAMODIFIER_DOAFTERONENTER_OFFSET UNITYSDK_OFFSET(0xE983B30)
#define MOLEMOLE_CONFIGMATERIALPROPERTYDITHERALPHAMODIFIER_DOONENTER_FORUSER_OFFSET UNITYSDK_OFFSET(0xE984AD0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYDITHERALPHAMODIFIER_DOONENTER_OFFSET UNITYSDK_OFFSET(0xE983A40)
#define MOLEMOLE_CONFIGMATERIALPROPERTYDITHERALPHAMODIFIER_DOWARMUP_OFFSET UNITYSDK_OFFSET(0xE984A40)
#define MOLEMOLE_CONFIGMATERIALPROPERTYDITHERALPHAMODIFIER_ONDONE_OFFSET UNITYSDK_OFFSET(0xE984C50)
#define MOLEMOLE_CONFIGMATERIALPROPERTYDITHERALPHAMODIFIER_PREPAREONENTER_OFFSET UNITYSDK_OFFSET(0xE983890)
#define MOLEMOLE_CONFIGMATERIALPROPERTYDITHERALPHAMODIFIER_PREPAREONEXIT_OFFSET UNITYSDK_OFFSET(0xE983C50)
#define MOLEMOLE_CONFIGMATERIALPROPERTYDITHERALPHAMODIFIER_PROCESSENTER_OFFSET UNITYSDK_OFFSET(0xE983B90)
#define MOLEMOLE_CONFIGMATERIALPROPERTYDITHERALPHAMODIFIER_PROCESSEXIT_OFFSET UNITYSDK_OFFSET(0xE983CB0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYDITHERALPHAMODIFIER_PROCESSKEEP_OFFSET UNITYSDK_OFFSET(0xE984210)
#define MOLEMOLE_CONFIGMATERIALPROPERTYDITHERALPHAMODIFIER_SYNCENABLES_OFFSET UNITYSDK_OFFSET(0xE984000)
#define MOLEMOLE_CONFIGMATERIALPROPERTYDITHERALPHAMODIFIER_SYNCVALUES_OFFSET UNITYSDK_OFFSET(0xE983E00)
#define MOLEMOLE_CONFIGMATERIALPROPERTYDITHERALPHAMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0xE984CE0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigMaterialPropertyDitherAlphaModifier_TypeDefinitionIndex = 58076;

	class ConfigMaterialPropertyDitherAlphaModifier : public ::MoleMole::ConfigMaterialPropertyModifier
	{
	public:
		::System::Single _DitherAlpha2Default; // 0x48
		::MoleMole::MaterialPropertyModifierValueVector _DecolorizationContrast; // 0x4C
		::MoleMole::MaterialPropertyModifierValueFloat _DitherAlpha2; // 0x64
		::System::Single _DitherAlpha2Ref; // 0x6C
		::MoleMole::MaterialPropertyModifierValueVector _FxUVDitherValue; // 0x70
