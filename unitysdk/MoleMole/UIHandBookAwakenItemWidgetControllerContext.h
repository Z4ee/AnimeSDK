...
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT_GET_JUMPID_OFFSET UNITYSDK_OFFSET(0x151D65E0)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x151D6540)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT_GET_PICINDEX_OFFSET UNITYSDK_OFFSET(0x151D6600)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT_GET_QUESTGROUPID_OFFSET UNITYSDK_OFFSET(0x151D65C0)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT_GET_QUESTS_OFFSET UNITYSDK_OFFSET(0x151D6560)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT_GET_REFRESHREMAINTIME_OFFSET UNITYSDK_OFFSET(0x151D6580)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT_GET_SHOWREFRESHREMAINTIME_OFFSET UNITYSDK_OFFSET(0x151D65A0)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT_SET_JUMPID_OFFSET UNITYSDK_OFFSET(0x151D65F0)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT_SET_NAME_OFFSET UNITYSDK_OFFSET(0x151D6550)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT_SET_PICINDEX_OFFSET UNITYSDK_OFFSET(0x151D6610)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT_SET_QUESTGROUPID_OFFSET UNITYSDK_OFFSET(0x151D65D0)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT_SET_QUESTS_OFFSET UNITYSDK_OFFSET(0x151D6570)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT_SET_REFRESHREMAINTIME_OFFSET UNITYSDK_OFFSET(0x151D6590)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT_SET_SHOWREFRESHREMAINTIME_OFFSET UNITYSDK_OFFSET(0x151D65B0)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x151D6620)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookAwakenItemWidgetControllerContext_TypeDefinitionIndex = 74511;
	...
	public:
		...
		::System::Int32 _JumpID_k__BackingField; // 0x38
		::System::Int32 _PicIndex_k__BackingField; // 0x3C
		::System::Int32 _QuestGroupID_k__BackingField; // 0x40
		::System::Boolean _ShowRefreshRemainTime_k__BackingField; // 0x44
