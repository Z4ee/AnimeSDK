...
#define MOLEMOLE_SUPERDEBUG_DRAWCONTEXT_APPENDLINE_OFFSET UNITYSDK_OFFSET(0x1B065880)
#define MOLEMOLE_SUPERDEBUG_DRAWCONTEXT_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B065810)
#define MOLEMOLE_SUPERDEBUG_DRAWCONTEXT_DRAW_OFFSET UNITYSDK_OFFSET(0x1B065A80)
#define MOLEMOLE_SUPERDEBUG_DRAWCONTEXT_GET_OFFSET UNITYSDK_OFFSET(0x1B0657D0)
#define MOLEMOLE_SUPERDEBUG_DRAWCONTEXT_WITHCOLOR_OFFSET UNITYSDK_OFFSET(0x1B065A10)
#define MOLEMOLE_SUPERDEBUG_DRAWCONTEXT_WITHWORLDPOS_OFFSET UNITYSDK_OFFSET(0x1B0659A0)
#define MOLEMOLE_SUPERDEBUG_DRAWCONTEXT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B065AC0)
#define MOLEMOLE_SUPERDEBUG_DRAWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0657C0)

namespace MoleMole
{
	inline static constexpr unsigned int SuperDebug_DrawContext_TypeDefinitionIndex = 7771;
