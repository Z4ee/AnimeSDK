...
#define MOLEMOLE_MONOEFFECTPLUGINFOLLOWCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x13F108D0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginFollowCamera_TypeDefinitionIndex = 64354;
