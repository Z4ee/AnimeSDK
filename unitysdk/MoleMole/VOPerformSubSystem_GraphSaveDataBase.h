...
#define MOLEMOLE_VOPERFORMSUBSYSTEM_GRAPHSAVEDATABASE_FINISH_OFFSET UNITYSDK_OFFSET(0x10AFAE10)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_GRAPHSAVEDATABASE_GETTAGUNIQUEID_OFFSET UNITYSDK_OFFSET(0x10AFAD60)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_GRAPHSAVEDATABASE_GET_TAGUNIQUEID_OFFSET UNITYSDK_OFFSET(0x10AFACC0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_GRAPHSAVEDATABASE__CTOR_OFFSET UNITYSDK_OFFSET(0x10AFAE00)

namespace MoleMole
{
	inline static constexpr unsigned int VOPerformSubSystem_GraphSaveDataBase_TypeDefinitionIndex = 60229;
