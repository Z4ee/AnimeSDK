...
#define MOLEMOLE_UIACTIVITYQUESTTIPSWIDGETCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x18E1E210)
#define MOLEMOLE_UIACTIVITYQUESTTIPSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18E1E480)
#define MOLEMOLE_UIACTIVITYQUESTTIPSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18E1E510)
#define MOLEMOLE_UIACTIVITYQUESTTIPSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18E1E220)
#define MOLEMOLE_UIACTIVITYQUESTTIPSWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18E1E410)
#define MOLEMOLE_UIACTIVITYQUESTTIPSWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x18E1E580)
#define MOLEMOLE_UIACTIVITYQUESTTIPSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18E1E970)
#define MOLEMOLE_UIACTIVITYQUESTTIPSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18E1E980)
#define MOLEMOLE_UIACTIVITYQUESTTIPSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18E1EA10)
#define MOLEMOLE_UIACTIVITYQUESTTIPSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18E1EA20)
#define MOLEMOLE_UIACTIVITYQUESTTIPSWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18E1EA30)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityQuestTipsWidgetController_TypeDefinitionIndex = 85733;

	class UIActivityQuestTipsWidgetController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_60638234271CCDB8_128* _view; // 0x318
