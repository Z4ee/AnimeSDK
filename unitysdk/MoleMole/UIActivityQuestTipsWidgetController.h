...
#define MOLEMOLE_UIACTIVITYQUESTTIPSWIDGETCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x167EABE0)
#define MOLEMOLE_UIACTIVITYQUESTTIPSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x167EAE50)
#define MOLEMOLE_UIACTIVITYQUESTTIPSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x167EAEE0)
#define MOLEMOLE_UIACTIVITYQUESTTIPSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x167EABF0)
#define MOLEMOLE_UIACTIVITYQUESTTIPSWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x167EADE0)
#define MOLEMOLE_UIACTIVITYQUESTTIPSWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x167EAF50)
#define MOLEMOLE_UIACTIVITYQUESTTIPSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x167EB340)
#define MOLEMOLE_UIACTIVITYQUESTTIPSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x167EB350)
#define MOLEMOLE_UIACTIVITYQUESTTIPSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x167EB3E0)
#define MOLEMOLE_UIACTIVITYQUESTTIPSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x167EB3F0)
#define MOLEMOLE_UIACTIVITYQUESTTIPSWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x167EB400)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityQuestTipsWidgetController_TypeDefinitionIndex = 69730;

	class UIActivityQuestTipsWidgetController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_60638234271CCDB8_31* _view; // 0x310
		::MoleMole::UIActivityCameraMissionRowWidgetController* _ActivityCommonMissionRowCtrl; // 0x318
		::Class_2_ECB506AFB4C28723* _photoModel; // 0x320
