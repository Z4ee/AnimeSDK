...
#define MOLEMOLE_ABYSSS2_WORKGRID_LINE_CREATELINE_OFFSET UNITYSDK_OFFSET(0xFEFA300)
#define MOLEMOLE_ABYSSS2_WORKGRID_LINE_EQUALS_OFFSET UNITYSDK_OFFSET(0x6D6140)
#define MOLEMOLE_ABYSSS2_WORKGRID_LINE_ISPOINTINSIDE_OFFSET UNITYSDK_OFFSET(0x6D6150)
#define MOLEMOLE_ABYSSS2_WORKGRID_LINE___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x6D6180)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_WorkGrid_Line_TypeDefinitionIndex = 82313;
