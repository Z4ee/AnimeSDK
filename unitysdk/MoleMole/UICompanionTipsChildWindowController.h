...
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_CLOSETEXT_OFFSET UNITYSDK_OFFSET(0x152540E0)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_FADEIN_OFFSET UNITYSDK_OFFSET(0x15253D80)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_FADEOUT_OFFSET UNITYSDK_OFFSET(0x15253E80)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_GETVIEW_OFFSET UNITYSDK_OFFSET(0x15254190)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_GET_ISIGNOREINPUT_OFFSET UNITYSDK_OFFSET(0x15253760)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15253750)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x152537D0)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15253E10)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15253770)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15253860)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_SETIMAGE_OFFSET UNITYSDK_OFFSET(0x15253F90)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_SETTEXT_OFFSET UNITYSDK_OFFSET(0x15253AE0)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_SHOWTIPS_OFFSET UNITYSDK_OFFSET(0x152538D0)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER__CLOSETEXT_B__15_0_OFFSET UNITYSDK_OFFSET(0x152541F0)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x152541E0)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x152542C0)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15254350)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15254360)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15254370)

namespace MoleMole
{
	inline static constexpr unsigned int UICompanionTipsChildWindowController_TypeDefinitionIndex = 78217;
