...
#define MOLEMOLE_UIGENERALREWARDLISTROWWIDGETCONTROLLER_CLEARREWARDS_OFFSET UNITYSDK_OFFSET(0x1777E5D0)
#define MOLEMOLE_UIGENERALREWARDLISTROWWIDGETCONTROLLER_GERREWARDREQ_OFFSET UNITYSDK_OFFSET(0x1777DCD0)
#define MOLEMOLE_UIGENERALREWARDLISTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1777DB50)
#define MOLEMOLE_UIGENERALREWARDLISTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1777E140)
#define MOLEMOLE_UIGENERALREWARDLISTROWWIDGETCONTROLLER_ONTAKEREWARDHANDLE_OFFSET UNITYSDK_OFFSET(0x1777DE40)
#define MOLEMOLE_UIGENERALREWARDLISTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1777E0C0)
#define MOLEMOLE_UIGENERALREWARDLISTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1777DA10)
#define MOLEMOLE_UIGENERALREWARDLISTROWWIDGETCONTROLLER_REFRESHREWARDBTNREDPOINT_OFFSET UNITYSDK_OFFSET(0x1777E750)
#define MOLEMOLE_UIGENERALREWARDLISTROWWIDGETCONTROLLER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0x1777DE90)
#define MOLEMOLE_UIGENERALREWARDLISTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1777E940)
#define MOLEMOLE_UIGENERALREWARDLISTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1777E9D0)
#define MOLEMOLE_UIGENERALREWARDLISTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1777EA60)
#define MOLEMOLE_UIGENERALREWARDLISTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1777EB00)
#define MOLEMOLE_UIGENERALREWARDLISTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1777EB90)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralRewardListRowWidgetController_TypeDefinitionIndex = 70412;
	...
	public:
		...
		::Class_2_208CC9941471731A_66* rewardCfg; // 0x300
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_29*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGENERALREWARDLISTROWWIDGETCONTROLLER_ONTAKEREWARDHANDLE_OFFSET))(this, rcvMessage);
		}
