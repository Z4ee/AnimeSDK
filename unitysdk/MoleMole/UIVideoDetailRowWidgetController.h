...
#define MOLEMOLE_UIVIDEODETAILROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x11585C60)
#define MOLEMOLE_UIVIDEODETAILROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x11585D70)
#define MOLEMOLE_UIVIDEODETAILROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x11585CF0)
#define MOLEMOLE_UIVIDEODETAILROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x11585C00)
#define MOLEMOLE_UIVIDEODETAILROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11585E20)
#define MOLEMOLE_UIVIDEODETAILROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x11585E30)
#define MOLEMOLE_UIVIDEODETAILROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x11585EC0)
#define MOLEMOLE_UIVIDEODETAILROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x11585F60)
#define MOLEMOLE_UIVIDEODETAILROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x11585FF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVideoDetailRowWidgetController_TypeDefinitionIndex = 74065;
