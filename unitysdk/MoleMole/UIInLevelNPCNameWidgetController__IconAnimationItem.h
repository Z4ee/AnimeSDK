...
#define MOLEMOLE_UIINLEVELNPCNAMEWIDGETCONTROLLER__ICONANIMATIONITEM_GET_ISEXPIRED_OFFSET UNITYSDK_OFFSET(0x184A1480)
#define MOLEMOLE_UIINLEVELNPCNAMEWIDGETCONTROLLER__ICONANIMATIONITEM_GET_PLAYDURATION_OFFSET UNITYSDK_OFFSET(0x184A1460)
#define MOLEMOLE_UIINLEVELNPCNAMEWIDGETCONTROLLER__ICONANIMATIONITEM_ONFINISH_OFFSET UNITYSDK_OFFSET(0x184A1580)
#define MOLEMOLE_UIINLEVELNPCNAMEWIDGETCONTROLLER__ICONANIMATIONITEM_ONPLAY_OFFSET UNITYSDK_OFFSET(0x184A14D0)
#define MOLEMOLE_UIINLEVELNPCNAMEWIDGETCONTROLLER__ICONANIMATIONITEM_ONSKIP_OFFSET UNITYSDK_OFFSET(0x184A1540)
#define MOLEMOLE_UIINLEVELNPCNAMEWIDGETCONTROLLER__ICONANIMATIONITEM_ONSTOPPED_OFFSET UNITYSDK_OFFSET(0x184A1600)
#define MOLEMOLE_UIINLEVELNPCNAMEWIDGETCONTROLLER__ICONANIMATIONITEM_SET_PLAYDURATION_OFFSET UNITYSDK_OFFSET(0x184A1470)
#define MOLEMOLE_UIINLEVELNPCNAMEWIDGETCONTROLLER__ICONANIMATIONITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x184A1680)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelNPCNameWidgetController__IconAnimationItem_TypeDefinitionIndex = 82011;
	...
	public:
		...
		::System::Action* PrePlayCallback; // 0x18
		::System::Func_2<::MoleMole::UIInLevelNPCNameWidgetController__IconAnimationItem*, ::System::Boolean>* ChecCouldPlay; // 0x20
		::System::String* animName; // 0x28
		::MoleMole::UIInLevelNPCNameWidgetController__IconAnimationTag playTag; // 0x30
		::MoleMole::UIInLevelNPCNameWidgetController__IconAnimationTag _replaceTag; // 0x34
		::System::Single _playDuration_k__BackingField; // 0x38
		::System::Boolean onlySample; // 0x3C
		::System::Single playTime; // 0x40
