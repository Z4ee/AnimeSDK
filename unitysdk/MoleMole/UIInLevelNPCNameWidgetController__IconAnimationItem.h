...
#define MOLEMOLE_UIINLEVELNPCNAMEWIDGETCONTROLLER__ICONANIMATIONITEM_GET_ISEXPIRED_OFFSET UNITYSDK_OFFSET(0x14FEA620)
#define MOLEMOLE_UIINLEVELNPCNAMEWIDGETCONTROLLER__ICONANIMATIONITEM_GET_PLAYDURATION_OFFSET UNITYSDK_OFFSET(0x14FEA600)
#define MOLEMOLE_UIINLEVELNPCNAMEWIDGETCONTROLLER__ICONANIMATIONITEM_ONFINISH_OFFSET UNITYSDK_OFFSET(0x14FEA720)
#define MOLEMOLE_UIINLEVELNPCNAMEWIDGETCONTROLLER__ICONANIMATIONITEM_ONPLAY_OFFSET UNITYSDK_OFFSET(0x14FEA670)
#define MOLEMOLE_UIINLEVELNPCNAMEWIDGETCONTROLLER__ICONANIMATIONITEM_ONSKIP_OFFSET UNITYSDK_OFFSET(0x14FEA6E0)
#define MOLEMOLE_UIINLEVELNPCNAMEWIDGETCONTROLLER__ICONANIMATIONITEM_ONSTOPPED_OFFSET UNITYSDK_OFFSET(0x14FEA7A0)
#define MOLEMOLE_UIINLEVELNPCNAMEWIDGETCONTROLLER__ICONANIMATIONITEM_SET_PLAYDURATION_OFFSET UNITYSDK_OFFSET(0x14FEA610)
#define MOLEMOLE_UIINLEVELNPCNAMEWIDGETCONTROLLER__ICONANIMATIONITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x14FEA820)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelNPCNameWidgetController__IconAnimationItem_TypeDefinitionIndex = 43555;
	...
	public:
		...
		::System::Action_1<::MoleMole::UIInLevelNPCNameWidgetController__IconAnimationItem*>* AfterPlayCallback; // 0x20
		...
		::System::Single _playDuration_k__BackingField; // 0x40
