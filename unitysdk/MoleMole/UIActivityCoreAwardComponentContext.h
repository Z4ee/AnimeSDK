...
#define MOLEMOLE_UIACTIVITYCOREAWARDCOMPONENTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18BC47B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityCoreAwardComponentContext_TypeDefinitionIndex = 50420;
