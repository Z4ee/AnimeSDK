...
#define MOLEMOLE_UIACTIVITYCOREAWARDCOMPONENTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15A8BFD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityCoreAwardComponentContext_TypeDefinitionIndex = 75408;
