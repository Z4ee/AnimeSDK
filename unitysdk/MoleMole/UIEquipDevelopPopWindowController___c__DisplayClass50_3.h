...
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___C__DISPLAYCLASS50_3__CTOR_OFFSET UNITYSDK_OFFSET(0x149B8EC0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___C__DISPLAYCLASS50_3__ONCLICKEQUIPLEVELBTN_B__3_OFFSET UNITYSDK_OFFSET(0x149B8ED0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___C__DISPLAYCLASS50_3__ONCLICKEQUIPLEVELBTN_B__4_OFFSET UNITYSDK_OFFSET(0x149B8F70)

namespace MoleMole
{
	inline static constexpr unsigned int UIEquipDevelopPopWindowController___c__DisplayClass50_3_TypeDefinitionIndex = 44465;

	class UIEquipDevelopPopWindowController___c__DisplayClass50_3 : public ::System::Object
	{
	public:
		::UnityEngine::Animation* anim; // 0x10
		::MoleMole::UIEquipDevelopPopWindowController___c__DisplayClass50_2* CS___8__locals1; // 0x18
		::Class_3_9F091E965E210217_6* newInfo; // 0x20
