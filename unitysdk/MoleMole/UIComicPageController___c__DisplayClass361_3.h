...
#define MOLEMOLE_UICOMICPAGECONTROLLER___C__DISPLAYCLASS361_3__CTOR_OFFSET UNITYSDK_OFFSET(0x18AA5630)
#define MOLEMOLE_UICOMICPAGECONTROLLER___C__DISPLAYCLASS361_3__SHOWSPLITSCREENPERFORMANCE_B__2_OFFSET UNITYSDK_OFFSET(0x18AA5640)
#define MOLEMOLE_UICOMICPAGECONTROLLER___C__DISPLAYCLASS361_3__SHOWSPLITSCREENPERFORMANCE_B__3_OFFSET UNITYSDK_OFFSET(0x18AA56C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIComicPageController___c__DisplayClass361_3_TypeDefinitionIndex = 87093;
