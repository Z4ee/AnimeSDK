...
#define MOLEMOLE_MONOARPEGGIOCHAPTERTWEEN_PLAYCHAPTERTWEEN_OFFSET UNITYSDK_OFFSET(0x12BCE420)
#define MOLEMOLE_MONOARPEGGIOCHAPTERTWEEN_PLAYCONTENTRECTTWEEN_OFFSET UNITYSDK_OFFSET(0x12BCE580)
#define MOLEMOLE_MONOARPEGGIOCHAPTERTWEEN_RECOVERCHAPTER_OFFSET UNITYSDK_OFFSET(0x12BCE910)
#define MOLEMOLE_MONOARPEGGIOCHAPTERTWEEN__CTOR_OFFSET UNITYSDK_OFFSET(0x12BCE9B0)
#define MOLEMOLE_MONOARPEGGIOCHAPTERTWEEN__PLAYCONTENTRECTTWEEN_B__8_0_OFFSET UNITYSDK_OFFSET(0x12BCEA60)
#define MOLEMOLE_MONOARPEGGIOCHAPTERTWEEN__PLAYCONTENTRECTTWEEN_B__8_1_OFFSET UNITYSDK_OFFSET(0x12BCEAA0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoArpeggioChapterTween_TypeDefinitionIndex = 75907;
