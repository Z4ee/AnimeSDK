...
#define MOLEMOLE_MONOARPEGGIOCHAPTERTWEEN_PLAYCHAPTERTWEEN_OFFSET UNITYSDK_OFFSET(0x1384C600)
#define MOLEMOLE_MONOARPEGGIOCHAPTERTWEEN_PLAYCONTENTRECTTWEEN_OFFSET UNITYSDK_OFFSET(0x1384C760)
#define MOLEMOLE_MONOARPEGGIOCHAPTERTWEEN_RECOVERCHAPTER_OFFSET UNITYSDK_OFFSET(0x1384CAF0)
#define MOLEMOLE_MONOARPEGGIOCHAPTERTWEEN__CTOR_OFFSET UNITYSDK_OFFSET(0x1384CB90)
#define MOLEMOLE_MONOARPEGGIOCHAPTERTWEEN__PLAYCONTENTRECTTWEEN_B__8_0_OFFSET UNITYSDK_OFFSET(0x1384CC40)
#define MOLEMOLE_MONOARPEGGIOCHAPTERTWEEN__PLAYCONTENTRECTTWEEN_B__8_1_OFFSET UNITYSDK_OFFSET(0x1384CC80)

namespace MoleMole
{
	inline static constexpr unsigned int MonoArpeggioChapterTween_TypeDefinitionIndex = 72675;
