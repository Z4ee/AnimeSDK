...
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_EXPLEVELMAP_OFFSET UNITYSDK_OFFSET(0x10D5F050)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_GAINEXP_OFFSET UNITYSDK_OFFSET(0x10D5F450)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_GAMECONTEXT_OFFSET UNITYSDK_OFFSET(0x10D5DE70)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_GETMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x10D5DDF0)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_GETOVERRIDEMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x10D5E0A0)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_ONFADEINANIMEVENT_1_OFFSET UNITYSDK_OFFSET(0x10D5F8C0)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_ONFADEINANIMEVENT_OFFSET UNITYSDK_OFFSET(0x10D5F810)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x10D5D540)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_OPENEXPWIDGET_OFFSET UNITYSDK_OFFSET(0x10D5D730)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_REFRESHREWARDVIEW_OFFSET UNITYSDK_OFFSET(0x10D5E410)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_ROWDATA_OFFSET UNITYSDK_OFFSET(0x10D5DF90)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x10D5FAB0)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER___BASE_GETMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x10D5FAC0)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER___BASE_GETOVERRIDEMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x10D5FAF0)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x10D5FB80)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER___BASE_REFRESHREWARDVIEW_OFFSET UNITYSDK_OFFSET(0x10D5FB90)

namespace MoleMole
{
	inline static constexpr unsigned int UITriggerShootResultPageController_TypeDefinitionIndex = 56368;

	class UITriggerShootResultPageController : public ::MoleMole::UIHollowLayerResultPageV2PopWindowController
	{
	public:
		::MoleMole::UIGeneralExpProgressWidgetController* _expWidget; // 0x390
		...
		::System::Void OnFadeInAnimEvent_1(::Class_2_A3F4D68D442055C0<::MoleMole::MonoLevelResultPageConfig_DelayType, ::System::Object*>* args)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_A3F4D68D442055C0<::MoleMole::MonoLevelResultPageConfig_DelayType, ::System::Object*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_ONFADEINANIMEVENT_1_OFFSET))(this, args);
		}
