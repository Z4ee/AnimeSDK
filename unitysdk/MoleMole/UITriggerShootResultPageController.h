...
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_EXPLEVELMAP_OFFSET UNITYSDK_OFFSET(0x148F38C0)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_GAINEXP_OFFSET UNITYSDK_OFFSET(0x148F3CC0)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_GAMECONTEXT_OFFSET UNITYSDK_OFFSET(0x148F26F0)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_GETMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x148F2670)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_GETOVERRIDEMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x148F2920)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_ONFADEINANIMEVENT_1_OFFSET UNITYSDK_OFFSET(0x148F4130)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_ONFADEINANIMEVENT_OFFSET UNITYSDK_OFFSET(0x148F4080)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x148F1DD0)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_OPENEXPWIDGET_OFFSET UNITYSDK_OFFSET(0x148F1FB0)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_REFRESHREWARDVIEW_OFFSET UNITYSDK_OFFSET(0x148F2C90)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_ROWDATA_OFFSET UNITYSDK_OFFSET(0x148F2810)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x148F4320)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER___BASE_GETMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x148F4330)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER___BASE_GETOVERRIDEMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x148F4360)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x148F43F0)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER___BASE_REFRESHREWARDVIEW_OFFSET UNITYSDK_OFFSET(0x148F4400)

namespace MoleMole
{
	inline static constexpr unsigned int UITriggerShootResultPageController_TypeDefinitionIndex = 79539;
