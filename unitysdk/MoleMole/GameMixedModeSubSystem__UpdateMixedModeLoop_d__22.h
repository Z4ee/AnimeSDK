...
#define MOLEMOLE_GAMEMIXEDMODESUBSYSTEM__UPDATEMIXEDMODELOOP_D__22_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x8AC140)
#define MOLEMOLE_GAMEMIXEDMODESUBSYSTEM__UPDATEMIXEDMODELOOP_D__22_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

namespace MoleMole
{
	inline static constexpr unsigned int GameMixedModeSubSystem__UpdateMixedModeLoop_d__22_TypeDefinitionIndex = 71852;
