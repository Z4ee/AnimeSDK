...
#define MOLEMOLE_ZNET_ZNETSCENEROOTCOM_FORCERESIMULATEAFTERONESECOND_OFFSET UNITYSDK_OFFSET(0xE86F070)
#define MOLEMOLE_ZNET_ZNETSCENEROOTCOM_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xE86F030)
#define MOLEMOLE_ZNET_ZNETSCENEROOTCOM_METHOD_5_DE3FCF8E254811E9_OFFSET UNITYSDK_OFFSET(0xE86F100)
#define MOLEMOLE_ZNET_ZNETSCENEROOTCOM_UPDATE_OFFSET UNITYSDK_OFFSET(0xE86EF60)
#define MOLEMOLE_ZNET_ZNETSCENEROOTCOM__CTOR_OFFSET UNITYSDK_OFFSET(0xE86F0B0)

namespace MoleMole::ZNet
{
	inline static constexpr unsigned int ZNetSceneRootCom_TypeDefinitionIndex = 68034;
