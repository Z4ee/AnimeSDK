...
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_ADDBANGBOOEXPECTSELF_OFFSET UNITYSDK_OFFSET(0x14DFC390)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_CREATEANDINITAIMANAGER_OFFSET UNITYSDK_OFFSET(0x14DFEB30)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_CREATEANDINITMOVINGWALLAIMANAGER_OFFSET UNITYSDK_OFFSET(0x14DFEC20)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_CREATEDEFAULTCHEATDETECTOR_OFFSET UNITYSDK_OFFSET(0x14DFEE20)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_CREATEORMODIFYCHEATDETECTOR_OFFSET UNITYSDK_OFFSET(0x14DFED60)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_DESTROYMOVINGWALLAIMANAGER_OFFSET UNITYSDK_OFFSET(0x14DFECC0)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_DOHIDEORIBUDDY_OFFSET UNITYSDK_OFFSET(0x14DFDCC0)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_DOUNSETBATTLEINOUTSTATE_OFFSET UNITYSDK_OFFSET(0x14DFDB20)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_GETBANGBOOEXPECTSELF_OFFSET UNITYSDK_OFFSET(0x14DFC510)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_GETQUESTID_OFFSET UNITYSDK_OFFSET(0x14DFF650)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_GET_AIMANAGER_OFFSET UNITYSDK_OFFSET(0x14DFEA30)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_GET_CHEATDETECTOR_OFFSET UNITYSDK_OFFSET(0x14DFEA50)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_GET_EXITTELEPORTID_OFFSET UNITYSDK_OFFSET(0x14DFC350)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_GET_GAMESTATE_OFFSET UNITYSDK_OFFSET(0x14DFE000)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_GET_ISCOLLISIONENABLED_OFFSET UNITYSDK_OFFSET(0x14DFE9E0)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_GET_ISINHENSHINBUDDYSTATUS_OFFSET UNITYSDK_OFFSET(0x14DFC330)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_GET_OFFSET UNITYSDK_OFFSET(0x14DFDF10)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_GET_RESTARTTELEPORTID_OFFSET UNITYSDK_OFFSET(0x14DFC370)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_HANDLEPARTYGAMECHEATENOTIFY_OFFSET UNITYSDK_OFFSET(0x14DFFEC0)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x14DFC5B0)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_ONCHANGETOAUTHORITY_OFFSET UNITYSDK_OFFSET(0x14DFF1A0)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x14DFCF60)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_ONGAMESTATECHANGED_OFFSET UNITYSDK_OFFSET(0x14DFE010)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_ONMARCELMOVETOPODIUM_OFFSET UNITYSDK_OFFSET(0x14DFFBC0)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_ONMPPARTYGAMERESULTSCNOTIFY_OFFSET UNITYSDK_OFFSET(0x14DFF800)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_ONREBORN_OFFSET UNITYSDK_OFFSET(0x14DFEEB0)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_ONRESET_OFFSET UNITYSDK_OFFSET(0x14DFEA60)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x14DFD280)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_RECOVERDISPLAYENTITIES_OFFSET UNITYSDK_OFFSET(0x14DFD7C0)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_REGISTERAIBUDDY_OFFSET UNITYSDK_OFFSET(0x14DFEF20)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_SAVEBEREPLACEENTITY_OFFSET UNITYSDK_OFFSET(0x14DFD460)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_SETEXITTELEPORTID_OFFSET UNITYSDK_OFFSET(0x14DFDE70)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_SETHENSHINBUDDYSTATUS_OFFSET UNITYSDK_OFFSET(0x14DFDA00)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_SETPLAYERMULTIPLAYSTATE_OFFSET UNITYSDK_OFFSET(0x14DFC730)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_SETRESTARTTELEPORTID_OFFSET UNITYSDK_OFFSET(0x14DFDEC0)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_SET_AIMANAGER_OFFSET UNITYSDK_OFFSET(0x14DFEA40)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_SET_EXITTELEPORTID_OFFSET UNITYSDK_OFFSET(0x14DFC360)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_SET_GAMESTATE_OFFSET UNITYSDK_OFFSET(0x14DFD400)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_SET_ISINHENSHINBUDDYSTATUS_OFFSET UNITYSDK_OFFSET(0x14DFC340)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_SET_RESTARTTELEPORTID_OFFSET UNITYSDK_OFFSET(0x14DFC380)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_UNREGISTERAIBUDDY_OFFSET UNITYSDK_OFFSET(0x14DFF060)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x14E000D0)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x14E001C0)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x14E00250)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x14E002E0)

namespace MoleMole
{
	inline static constexpr unsigned int BangbooGameSubsystem_TypeDefinitionIndex = 75831;

	class BangbooGameSubsystem : public ::MoleMole::GameSubsystemBase
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Int32>* rankInfo; // 0x10
		::MoleMole::EntityHandle beReplacedEntityHandle; // 0x18
		::System::Collections::Generic::HashSet_1<::System::UInt32>* quitPlayerSet; // 0x28
		::System::Collections::Generic::List_1<::MoleMole::EntityHandle>* _bangBooExpectSelf; // 0x30
		::System::Collections::Generic::List_1<::MoleMole::EntityHandle>* refReplacedEntityHandles; // 0x38
		::System::Collections::Generic::HashSet_1<::System::UInt32>* reachedPlayers; // 0x40
		::MoleMole::EntityHandle bangbooEntity; // 0x48
		::Class_1_33B50469231C7D95* _aiManager; // 0x58
		::Class_1_8A0D924C14430663_1* _cheatDetector; // 0x60
		::Enum_3_C24BA36B4CDB26BB _gameState; // 0x68
		::System::Int32 levelEndTimeMs; // 0x6C
		::System::Int64 StartCountDownTime; // 0x70
		::MoleMole::Level::BangbooPlayType curPlayType; // 0x78
		::System::Int32 _restartTeleportID_k__BackingField; // 0x7C
		::System::Int64 StopCountDownTime; // 0x80
		::System::Int32 levelTotalTimeSeconds; // 0x88
		::System::Boolean _isInHenshinBuddyStatus_k__BackingField; // 0x8C
		::System::Boolean isSlideAILevel; // 0x8D
		::System::Boolean IsInHenshinMazinger; // 0x8E
		::System::Int32 _exitTeleportID_k__BackingField; // 0x90
		::Enum_3_C24BA36B4CDB26BB curState; // 0x94
		...
		::System::Void CreateAndInitAIManager(::Enum_3_0A3761FE34514D6C_21 playType)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_0A3761FE34514D6C_21))((::PBYTE)hIl2Cpp + MOLEMOLE_BANGBOOGAMESUBSYSTEM_CREATEANDINITAIMANAGER_OFFSET))(this, playType);
		}
