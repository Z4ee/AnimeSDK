...
#define MOLEMOLE_UIYOROZUYARALLYQUESTITEMWIDGETCONTROLLER_ISNEW_OFFSET UNITYSDK_OFFSET(0x11A1A6B0)
#define MOLEMOLE_UIYOROZUYARALLYQUESTITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x11A19FE0)
#define MOLEMOLE_UIYOROZUYARALLYQUESTITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x11A1A070)
#define MOLEMOLE_UIYOROZUYARALLYQUESTITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x11A193A0)
#define MOLEMOLE_UIYOROZUYARALLYQUESTITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x11A19780)
#define MOLEMOLE_UIYOROZUYARALLYQUESTITEMWIDGETCONTROLLER_READNEW_OFFSET UNITYSDK_OFFSET(0x11A1A730)
#define MOLEMOLE_UIYOROZUYARALLYQUESTITEMWIDGETCONTROLLER_REFRESHNEW_OFFSET UNITYSDK_OFFSET(0x11A1AE20)
#define MOLEMOLE_UIYOROZUYARALLYQUESTITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x11A19A60)
#define MOLEMOLE_UIYOROZUYARALLYQUESTITEMWIDGETCONTROLLER_REGISTERCLICKCB_OFFSET UNITYSDK_OFFSET(0x11A1A2A0)
#define MOLEMOLE_UIYOROZUYARALLYQUESTITEMWIDGETCONTROLLER_RESELECT_OFFSET UNITYSDK_OFFSET(0x11A1AC10)
#define MOLEMOLE_UIYOROZUYARALLYQUESTITEMWIDGETCONTROLLER_SETNAME_OFFSET UNITYSDK_OFFSET(0x11A1A7A0)
#define MOLEMOLE_UIYOROZUYARALLYQUESTITEMWIDGETCONTROLLER_SETSELECT_OFFSET UNITYSDK_OFFSET(0x11A1A2F0)
#define MOLEMOLE_UIYOROZUYARALLYQUESTITEMWIDGETCONTROLLER_TRIGGERBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x11A1ACA0)
#define MOLEMOLE_UIYOROZUYARALLYQUESTITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11A1AE90)
#define MOLEMOLE_UIYOROZUYARALLYQUESTITEMWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0x11A1AEF0)
#define MOLEMOLE_UIYOROZUYARALLYQUESTITEMWIDGETCONTROLLER__ONUIINIT_B__1_1_OFFSET UNITYSDK_OFFSET(0x11A1AF50)
#define MOLEMOLE_UIYOROZUYARALLYQUESTITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x11A1AFC0)
#define MOLEMOLE_UIYOROZUYARALLYQUESTITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x11A1B050)
#define MOLEMOLE_UIYOROZUYARALLYQUESTITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x11A1B0E0)
#define MOLEMOLE_UIYOROZUYARALLYQUESTITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x11A1B170)

namespace MoleMole
{
	inline static constexpr unsigned int UIYorozuyaRallyQuestItemWidgetController_TypeDefinitionIndex = 78292;

	class UIYorozuyaRallyQuestItemWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_F9471F3BB5949932_10* _view; // 0x2C0
		::Class_1_16C7607DC7EE71E8* _rallyData; // 0x2C8
