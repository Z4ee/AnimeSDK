...
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ANIMDAEMON_OFFSET UNITYSDK_OFFSET(0x178D9220)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ENQUEUEANIM_OFFSET UNITYSDK_OFFSET(0x178D8CE0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_INPUT2NUMIMAGEKEY_OFFSET UNITYSDK_OFFSET(0x178D65B0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_INPUT2NUMTEXTIMAGEKEY_OFFSET UNITYSDK_OFFSET(0x178D66A0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_INPUT2POS_OFFSET UNITYSDK_OFFSET(0x178D6470)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ONBACKSPACE_OFFSET UNITYSDK_OFFSET(0x178D6AB0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x178D62A0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ONHINT_OFFSET UNITYSDK_OFFSET(0x178D6B10)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ONINFO_OFFSET UNITYSDK_OFFSET(0x178D7810)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ONRESET_OFFSET UNITYSDK_OFFSET(0x178D78A0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x178D6330)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x178D56A0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x178D60C0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_POS2INPUT_OFFSET UNITYSDK_OFFSET(0x178D6520)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_REFRESHHINTBTN_OFFSET UNITYSDK_OFFSET(0x178D6D30)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_REFRESHINPUTSCREEN_OFFSET UNITYSDK_OFFSET(0x178D6F10)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_REFRESHSELECTEDBUTTON_OFFSET UNITYSDK_OFFSET(0x178D8B60)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_RESETANIMNONCALLBACK_OFFSET UNITYSDK_OFFSET(0x178D8430)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_RESETBACKSPACEBTN_OFFSET UNITYSDK_OFFSET(0x178D7C70)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_RESETBTNBINDING_OFFSET UNITYSDK_OFFSET(0x178D80D0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_RESETINPUTSCREEN_OFFSET UNITYSDK_OFFSET(0x178D7D00)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_RESETNUMBERBTN_OFFSET UNITYSDK_OFFSET(0x178D7900)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_RESETVIEW_OFFSET UNITYSDK_OFFSET(0x178D6140)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_SETSELECTED_OFFSET UNITYSDK_OFFSET(0x178D8F50)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_SIMULATEHINTBTN_OFFSET UNITYSDK_OFFSET(0x178D6930)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_SIMULATESELECTINPUTBTN_OFFSET UNITYSDK_OFFSET(0x178D6750)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x178D92A0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER__REFRESHINPUTSCREEN_B__36_0_OFFSET UNITYSDK_OFFSET(0x178D94D0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER__REFRESHINPUTSCREEN_B__36_1_OFFSET UNITYSDK_OFFSET(0x178D9680)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER__REFRESHINPUTSCREEN_B__36_2_OFFSET UNITYSDK_OFFSET(0x178D96F0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER__REFRESHINPUTSCREEN_B__36_3_OFFSET UNITYSDK_OFFSET(0x178D98A0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x178D98C0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x178D9950)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x178D99E0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x178D9A70)

namespace MoleMole
{
	inline static constexpr unsigned int UIPasswordGameWidgetController_TypeDefinitionIndex = 49226;
