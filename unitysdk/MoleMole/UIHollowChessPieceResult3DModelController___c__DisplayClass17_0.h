...
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER___C__DISPLAYCLASS17_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18365E90)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowChessPieceResult3DModelController___c__DisplayClass17_0_TypeDefinitionIndex = 78926;
	...
	public:
		...
		::MonoHollowResultPageConfig_HueAndLight hue1; // 0x18
		::System::Single saturationCon; // 0x20
		::System::Single hue2; // 0x24
