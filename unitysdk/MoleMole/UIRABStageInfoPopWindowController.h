...
#define MOLEMOLE_UIRABSTAGEINFOPOPWINDOWCONTROLLER_BUILDLIST_OFFSET UNITYSDK_OFFSET(0x17A1FC10)
#define MOLEMOLE_UIRABSTAGEINFOPOPWINDOWCONTROLLER_GETTEMPLATEINDEXFROMDATA_OFFSET UNITYSDK_OFFSET(0x17A20A70)
#define MOLEMOLE_UIRABSTAGEINFOPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x17A1F640)
#define MOLEMOLE_UIRABSTAGEINFOPOPWINDOWCONTROLLER_ONCLOSEBTNCLICK_OFFSET UNITYSDK_OFFSET(0x17A1F8A0)
#define MOLEMOLE_UIRABSTAGEINFOPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17A20940)
#define MOLEMOLE_UIRABSTAGEINFOPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17A209D0)
#define MOLEMOLE_UIRABSTAGEINFOPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17A1F650)
#define MOLEMOLE_UIRABSTAGEINFOPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17A1F900)
#define MOLEMOLE_UIRABSTAGEINFOPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17A20AF0)
#define MOLEMOLE_UIRABSTAGEINFOPOPWINDOWCONTROLLER__ONUIINIT_B__7_0_OFFSET UNITYSDK_OFFSET(0x17A20B60)
#define MOLEMOLE_UIRABSTAGEINFOPOPWINDOWCONTROLLER__ONUIINIT_B__7_1_OFFSET UNITYSDK_OFFSET(0x17A20BE0)
#define MOLEMOLE_UIRABSTAGEINFOPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17A20C60)
#define MOLEMOLE_UIRABSTAGEINFOPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17A20CF0)
#define MOLEMOLE_UIRABSTAGEINFOPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17A20D00)
#define MOLEMOLE_UIRABSTAGEINFOPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17A20D10)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABStageInfoPopWindowController_TypeDefinitionIndex = 91171;
