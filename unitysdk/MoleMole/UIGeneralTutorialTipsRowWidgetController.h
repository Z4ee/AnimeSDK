...
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_ADDONCLOSE_OFFSET UNITYSDK_OFFSET(0x16AA24A0)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_CLOSETIP_OFFSET UNITYSDK_OFFSET(0x16AA0C70)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_CLOSEWIDGETWITHFADE_OFFSET UNITYSDK_OFFSET(0x16AA0D90)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_DOANIMATION_OFFSET UNITYSDK_OFFSET(0x16AA0F70)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_DOAUTOCLOSE_OFFSET UNITYSDK_OFFSET(0x16AA1420)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_GET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x16AA2550)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_INITICON_OFFSET UNITYSDK_OFFSET(0x16AA1E40)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_INITINFOTEXT_OFFSET UNITYSDK_OFFSET(0x16AA1870)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_INITPROGRESSICON_OFFSET UNITYSDK_OFFSET(0x16AA1BA0)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_INITTIPSPANEL_OFFSET UNITYSDK_OFFSET(0x16AA1F00)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_LOADREALFINISHICON_OFFSET UNITYSDK_OFFSET(0x16AA2260)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16AA0490)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x16AA0520)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_ONTIPBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x16AA05D0)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x16AA0770)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16AA06D0)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16AA0430)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16AA0680)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_RESETSIZE_OFFSET UNITYSDK_OFFSET(0x16AA08A0)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_SET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x16AA2560)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_SHOWHOLLOWNORMALTIPS_OFFSET UNITYSDK_OFFSET(0x16AA16B0)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_SHOWHOLLOWTIPS_1_OFFSET UNITYSDK_OFFSET(0x16AA1620)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_SHOWHOLLOWTIPS_OFFSET UNITYSDK_OFFSET(0x16AA1540)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_STOPAUTOCLOSE_OFFSET UNITYSDK_OFFSET(0x16AA0D30)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER__CACHECLEAN_OFFSET UNITYSDK_OFFSET(0x16AA0BA0)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16AA2570)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER__INITPROGRESSICON_B__19_0_OFFSET UNITYSDK_OFFSET(0x16AA25E0)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16AA25F0)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x16AA2680)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x16AA26B0)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16AA26C0)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16AA2750)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16AA27E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralTutorialTipsRowWidgetController_TypeDefinitionIndex = 62545;
	...
	public:
		...
		::System::Void ShowHollowTips(::UnityEngine::UI::VerticalLayoutGroup* layout, ::Class_1_43BD383C98B4C0C5_36* data, ::UnityEngine::RectTransform* viewHollowTip, ::System::Boolean playAnim)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::UI::VerticalLayoutGroup*, ::Class_1_43BD383C98B4C0C5_36*, ::UnityEngine::RectTransform*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_SHOWHOLLOWTIPS_OFFSET))(this, layout, data, viewHollowTip, playAnim);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::UI::VerticalLayoutGroup*, ::Class_1_43BD383C98B4C0C5_36*, ::UnityEngine::RectTransform*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_SHOWHOLLOWTIPS_1_OFFSET))(this, layout, data, viewHollowTip);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::UI::VerticalLayoutGroup*, ::Class_1_43BD383C98B4C0C5_36*, ::UnityEngine::RectTransform*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_SHOWHOLLOWNORMALTIPS_OFFSET))(this, missionLayout, data, maxTransform);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_43BD383C98B4C0C5_36*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_INITICON_OFFSET))(this, data);
		}

		::System::Void InitProgressIcon(::Class_1_43BD383C98B4C0C5_36* data)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_43BD383C98B4C0C5_36*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_INITPROGRESSICON_OFFSET))(this, data);
		}

		::System::Void InitInfoText(::Class_1_43BD383C98B4C0C5_36* data, ::UnityEngine::RectTransform* maxTransform)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_43BD383C98B4C0C5_36*, ::UnityEngine::RectTransform*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER_INITINFOTEXT_OFFSET))(this, data, maxTransform);
		}
