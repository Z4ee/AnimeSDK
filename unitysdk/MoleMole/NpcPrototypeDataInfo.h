...
#define MOLEMOLE_NPCPROTOTYPEDATAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x12B0BE40)

namespace MoleMole
{
	inline static constexpr unsigned int NpcPrototypeDataInfo_TypeDefinitionIndex = 75117;
