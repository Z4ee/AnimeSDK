...
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEPOINTWIDGETCONTROLLER_ADDTARGETENTITY_OFFSET UNITYSDK_OFFSET(0x16D663C0)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEPOINTWIDGETCONTROLLER_GET_FULLSCREENRECTTRANS_OFFSET UNITYSDK_OFFSET(0x16D65E00)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEPOINTWIDGETCONTROLLER_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x16D65D70)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEPOINTWIDGETCONTROLLER_GET_ISTARGETVISIBLE_OFFSET UNITYSDK_OFFSET(0x16D65D60)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEPOINTWIDGETCONTROLLER_HASTARGET_OFFSET UNITYSDK_OFFSET(0x16D661D0)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEPOINTWIDGETCONTROLLER_HIDEVIEW_OFFSET UNITYSDK_OFFSET(0x16D66480)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEPOINTWIDGETCONTROLLER_ISCURTARGETVISIBLEBYGUIDEZONE_OFFSET UNITYSDK_OFFSET(0x16D67250)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEPOINTWIDGETCONTROLLER_ISCURTARGET_OFFSET UNITYSDK_OFFSET(0x16D66250)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEPOINTWIDGETCONTROLLER_MOVETOMISSION_OFFSET UNITYSDK_OFFSET(0x16D67B30)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEPOINTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16D660C0)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEPOINTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16D66150)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEPOINTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16D65E20)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEPOINTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16D66050)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEPOINTWIDGETCONTROLLER_REMOVETARGETENTITY_OFFSET UNITYSDK_OFFSET(0x16D666F0)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEPOINTWIDGETCONTROLLER_RESETVIEWSTATE_OFFSET UNITYSDK_OFFSET(0x16D66300)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEPOINTWIDGETCONTROLLER_SET_FULLSCREENRECTTRANS_OFFSET UNITYSDK_OFFSET(0x16D65E10)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEPOINTWIDGETCONTROLLER_SHOWVIEW_OFFSET UNITYSDK_OFFSET(0x16D67650)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEPOINTWIDGETCONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0x16D667E0)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEPOINTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16D67DA0)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEPOINTWIDGETCONTROLLER__ONUIINIT_B__9_0_OFFSET UNITYSDK_OFFSET(0x16D67E50)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEPOINTWIDGETCONTROLLER__TICK_G___UPDATEPOS_18_0_OFFSET UNITYSDK_OFFSET(0x16D67700)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEPOINTWIDGETCONTROLLER__TICK_G___UPDATEROT_18_1_OFFSET UNITYSDK_OFFSET(0x16D678F0)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEPOINTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16D67FF0)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEPOINTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16D68080)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEPOINTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16D68110)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEPOINTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16D681A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMissionGuidePointWidgetController_TypeDefinitionIndex = 63547;
