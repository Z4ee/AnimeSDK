...
#define MOLEMOLE_MONOUIGRIDLAYOUTGROUPADAPTOR_DOINITLAYOUT_OFFSET UNITYSDK_OFFSET(0x1303C260)
#define MOLEMOLE_MONOUIGRIDLAYOUTGROUPADAPTOR_INITGRIDLAYOUTGROUP_OFFSET UNITYSDK_OFFSET(0x1303C490)
#define MOLEMOLE_MONOUIGRIDLAYOUTGROUPADAPTOR_ISCONTAINPLATFORMUIPARAMS_OFFSET UNITYSDK_OFFSET(0x1303C180)
#define MOLEMOLE_MONOUIGRIDLAYOUTGROUPADAPTOR_ISPLATFORMUIPARAMSEMPTY_OFFSET UNITYSDK_OFFSET(0x1303C0E0)
#define MOLEMOLE_MONOUIGRIDLAYOUTGROUPADAPTOR_RELOADDATAFROMJSON_OFFSET UNITYSDK_OFFSET(0x1303C890)
#define MOLEMOLE_MONOUIGRIDLAYOUTGROUPADAPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1303CB80)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIGridLayoutGroupAdaptor_TypeDefinitionIndex = 60917;
