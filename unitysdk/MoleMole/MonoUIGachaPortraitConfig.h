...
#define MOLEMOLE_MONOUIGACHAPORTRAITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x13AC5CE0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIGachaPortraitConfig_TypeDefinitionIndex = 62332;
