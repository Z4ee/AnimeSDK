...
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x17702EB0)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x177036C0)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17703750)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17702EC0)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17703100)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER_UPDATECARD_OFFSET UNITYSDK_OFFSET(0x17703460)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17703860)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER__UPDATECARD_G__SETNAME_10_0_OFFSET UNITYSDK_OFFSET(0x177037C0)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17703870)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17703900)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17703910)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17703920)

namespace MoleMole
{
	inline static constexpr unsigned int UIDoubleEliteExhibitionPopWindowController_TypeDefinitionIndex = 84170;
	...
	public:
		...
		::System::Void UpdateCard(::Class_2_208CC9941471731A_401* template_)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_401*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER_UPDATECARD_OFFSET))(this, template_);
		}
