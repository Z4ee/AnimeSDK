...
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x186A40E0)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x186A48F0)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x186A4980)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x186A40F0)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x186A4330)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER_UPDATECARD_OFFSET UNITYSDK_OFFSET(0x186A4690)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x186A4A90)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER__UPDATECARD_G__SETNAME_10_0_OFFSET UNITYSDK_OFFSET(0x186A49F0)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x186A4AA0)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x186A4B30)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x186A4B40)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x186A4B50)

namespace MoleMole
{
	inline static constexpr unsigned int UIDoubleEliteExhibitionPopWindowController_TypeDefinitionIndex = 52243;

	class UIDoubleEliteExhibitionPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_8D91CCB135292C21* _view; // 0x318
		::Class_2_8D91CCB135292C21_Class_2_3DD13681DECC4A27* _cardView; // 0x320
		::MoleMole::UIDailyChallengeCardRowWidgetController* _elite1; // 0x328
		::MoleMole::UIDailyChallengeCardRowWidgetController* _elite2; // 0x330
		...
		::System::Void UpdateCard(::Class_2_208CC9941471731A_573* template_)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_573*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER_UPDATECARD_OFFSET))(this, template_);
		}
