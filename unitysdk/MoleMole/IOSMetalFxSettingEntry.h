...
#define MOLEMOLE_IOSMETALFXSETTINGENTRY_GETSETTINGCONTROLUNIT_OFFSET UNITYSDK_OFFSET(0x19DC4F40)
#define MOLEMOLE_IOSMETALFXSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x19DC4F30)
#define MOLEMOLE_IOSMETALFXSETTINGENTRY_ISMETALFXENABLED_OFFSET UNITYSDK_OFFSET(0x19DC5010)
#define MOLEMOLE_IOSMETALFXSETTINGENTRY_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0x19DC4FC0)
#define MOLEMOLE_IOSMETALFXSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x19DC5390)
#define MOLEMOLE_IOSMETALFXSETTINGENTRY___BASE_GETSETTINGCONTROLUNIT_OFFSET UNITYSDK_OFFSET(0x19DC5430)
#define MOLEMOLE_IOSMETALFXSETTINGENTRY___BASE_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0x19DC5440)

namespace MoleMole
{
	inline static constexpr unsigned int IOSMetalFxSettingEntry_TypeDefinitionIndex = 84241;
	...
	public:
		...
		{
			return ((::Enum_3_7FA27888FA17A22A(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_IOSMETALFXSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET))(this);
		}
