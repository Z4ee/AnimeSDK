...
#define MOLEMOLE_IOSMETALFXSETTINGENTRY_GETSETTINGCONTROLUNIT_OFFSET UNITYSDK_OFFSET(0x19131960)
#define MOLEMOLE_IOSMETALFXSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x19131950)
#define MOLEMOLE_IOSMETALFXSETTINGENTRY_ISMETALFXENABLED_OFFSET UNITYSDK_OFFSET(0x19131A30)
#define MOLEMOLE_IOSMETALFXSETTINGENTRY_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0x191319E0)
#define MOLEMOLE_IOSMETALFXSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x19131DC0)
#define MOLEMOLE_IOSMETALFXSETTINGENTRY___BASE_GETSETTINGCONTROLUNIT_OFFSET UNITYSDK_OFFSET(0x19131E60)
#define MOLEMOLE_IOSMETALFXSETTINGENTRY___BASE_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0x19131E70)

namespace MoleMole
{
	inline static constexpr unsigned int IOSMetalFxSettingEntry_TypeDefinitionIndex = 42068;
