...
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_FASTFORWARDTOANIMEND_OFFSET UNITYSDK_OFFSET(0x125E7030)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0x125E6360)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0x125E6370)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_METHOD_5_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0x125E6E50)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_METHOD_5_1F130271093617A5_OFFSET UNITYSDK_OFFSET(0x125E7430)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_METHOD_5_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0x125E6A60)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_METHOD_5_E01AB12B6F23773D_OFFSET UNITYSDK_OFFSET(0x125E7390)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_PLAYWHENSTOP_OFFSET UNITYSDK_OFFSET(0x125E6AE0)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_PLAY_OFFSET UNITYSDK_OFFSET(0x125E6980)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_RESET_OFFSET UNITYSDK_OFFSET(0x125E6B30)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x125E7330)

namespace MoleMole
{
	inline static constexpr unsigned int MonoScrollerFadeManager_TypeDefinitionIndex = 80634;
