...
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18AA99D0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___C__DISPLAYCLASS13_0__TRYTAKEVITALITYREWARDS_B__0_OFFSET UNITYSDK_OFFSET(0x18AA99E0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___C__DISPLAYCLASS13_0__TRYTAKEVITALITYREWARDS_B__1_OFFSET UNITYSDK_OFFSET(0x18AA9BD0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___C__DISPLAYCLASS13_0__TRYTAKEVITALITYREWARDS_B__2_OFFSET UNITYSDK_OFFSET(0x18AA9B70)

namespace MoleMole
{
	inline static constexpr unsigned int UIDailyQuestHandBookWidgetController___c__DisplayClass13_0_TypeDefinitionIndex = 43701;
