...
#define MOLEMOLE_MONOSUMMEREVENTROWS__CTOR_OFFSET UNITYSDK_OFFSET(0x1783B120)

namespace MoleMole
{
	inline static constexpr unsigned int MonoSummerEventRows_TypeDefinitionIndex = 70670;
