...
#define MOLEMOLE_UIBALLGAMELEVELLISTROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19A787D0)
#define MOLEMOLE_UIBALLGAMELEVELLISTROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19A78840)
#define MOLEMOLE_UIBALLGAMELEVELLISTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x19A788E0)
#define MOLEMOLE_UIBALLGAMELEVELLISTROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x19A789A0)
#define MOLEMOLE_UIBALLGAMELEVELLISTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19A78B90)
#define MOLEMOLE_UIBALLGAMELEVELLISTROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19A78BA0)
#define MOLEMOLE_UIBALLGAMELEVELLISTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x19A78C40)

namespace MoleMole
{
	inline static constexpr unsigned int UIBallGameLevelListRowWidgetController_TypeDefinitionIndex = 57856;
