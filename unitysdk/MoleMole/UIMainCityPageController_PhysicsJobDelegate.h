...
#define MOLEMOLE_UIMAINCITYPAGECONTROLLER_PHYSICSJOBDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18A24430)
#define MOLEMOLE_UIMAINCITYPAGECONTROLLER_PHYSICSJOBDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18A244A0)
#define MOLEMOLE_UIMAINCITYPAGECONTROLLER_PHYSICSJOBDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18A24130)
#define MOLEMOLE_UIMAINCITYPAGECONTROLLER_PHYSICSJOBDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A24110)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityPageController_PhysicsJobDelegate_TypeDefinitionIndex = 88768;
