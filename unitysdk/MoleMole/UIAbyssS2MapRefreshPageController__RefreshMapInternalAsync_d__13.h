...
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER__REFRESHMAPINTERNALASYNC_D__13_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x884230)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER__REFRESHMAPINTERNALASYNC_D__13_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2MapRefreshPageController__RefreshMapInternalAsync_d__13_TypeDefinitionIndex = 91336;

	struct alignas(8) UIAbyssS2MapRefreshPageController__RefreshMapInternalAsync_d__13
	{
		::Cysharp::Threading::Tasks::UniTask_1_Awaiter<::System::ValueTuple_2<::System::Boolean, ::Class_3_C85FE8723112A032*>> __u__2; // 0x10
		::Cysharp::Threading::Tasks::UniTask_1_Awaiter<::Class_3_6DFA4B549BEBC7A5_3*> __u__1; // 0x30
		::Cysharp::Threading::Tasks::CompilerServices::AsyncUniTaskMethodBuilder __t__builder; // 0x48
		::MoleMole::UIAbyssS2MapRefreshPageController* __4__this; // 0x58
		::Cysharp::Threading::Tasks::UniTask_Awaiter __u__3; // 0x60
		::System::Threading::CancellationTokenSource* cts; // 0x70
