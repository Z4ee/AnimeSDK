...
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER_CANVASRTHANDLER_ALLOCATERT_OFFSET UNITYSDK_OFFSET(0x15FA39B0)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER_CANVASRTHANDLER_ASSIGNUICONTROLLER_OFFSET UNITYSDK_OFFSET(0x15FA3640)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER_CANVASRTHANDLER_BINDPIECE_OFFSET UNITYSDK_OFFSET(0x15FA2EF0)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER_CANVASRTHANDLER_CLOSEUICONTROLLER_OFFSET UNITYSDK_OFFSET(0x15FA3460)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER_CANVASRTHANDLER_CLOSE_OFFSET UNITYSDK_OFFSET(0x15FA2F80)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER_CANVASRTHANDLER_CREATEFULLRECTOFPARENT_OFFSET UNITYSDK_OFFSET(0x15FA28E0)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER_CANVASRTHANDLER_DEALLOCATERT_OFFSET UNITYSDK_OFFSET(0x15FA32D0)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER_CANVASRTHANDLER_DESTROY_OFFSET UNITYSDK_OFFSET(0x15FA3030)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER_CANVASRTHANDLER_GETCANVASSCALEFACTOR_OFFSET UNITYSDK_OFFSET(0x15FA3ED0)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER_CANVASRTHANDLER_GET_CANVAS_OFFSET UNITYSDK_OFFSET(0x15FA1CC0)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER_CANVASRTHANDLER_GET_ISASSIGNEDCONTROLLER_OFFSET UNITYSDK_OFFSET(0x15FA1D20)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER_CANVASRTHANDLER_GET_ISDESTROYED_OFFSET UNITYSDK_OFFSET(0x15FA1D40)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER_CANVASRTHANDLER_GET_RENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0x15FA1CA0)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER_CANVASRTHANDLER_GET_UIROOTOBJ_OFFSET UNITYSDK_OFFSET(0x15FA1CE0)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER_CANVASRTHANDLER_GET_UIWINDOWCONTROLLER_OFFSET UNITYSDK_OFFSET(0x15FA1D00)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER_CANVASRTHANDLER_LAZYINIT_OFFSET UNITYSDK_OFFSET(0x15FA1D60)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER_CANVASRTHANDLER_POSTOPENUI_OFFSET UNITYSDK_OFFSET(0x15FA3700)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER_CANVASRTHANDLER_SET_CANVAS_OFFSET UNITYSDK_OFFSET(0x15FA1CD0)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER_CANVASRTHANDLER_SET_ISASSIGNEDCONTROLLER_OFFSET UNITYSDK_OFFSET(0x15FA1D30)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER_CANVASRTHANDLER_SET_ISDESTROYED_OFFSET UNITYSDK_OFFSET(0x15FA1D50)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER_CANVASRTHANDLER_SET_RENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0x15FA1CB0)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER_CANVASRTHANDLER_SET_UIROOTOBJ_OFFSET UNITYSDK_OFFSET(0x15FA1CF0)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER_CANVASRTHANDLER_SET_UIWINDOWCONTROLLER_OFFSET UNITYSDK_OFFSET(0x15FA1D10)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER_CANVASRTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15FA4060)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowChessboard3DModelController_CanvasRTHandler_TypeDefinitionIndex = 44036;

	class UIHollowChessboard3DModelController_CanvasRTHandler : public ::System::Object
	{
	public:
		::UnityEngine::GameObject* _rootGo; // 0x10
		::UnityEngine::GameObject* _uiRootObj_k__BackingField; // 0x18
		::UnityEngine::Camera* _rtCamera; // 0x20
		::MoleMole::NapCanvasScaler* _canvasScaler; // 0x28
		::UnityEngine::GameObject* _canvasObj; // 0x30
		::UnityEngine::NAPRenderPipeline0::RTHandle* _renderTexture_k__BackingField; // 0x38
		::UnityEngine::Canvas* _canvas_k__BackingField; // 0x40
		::UnityEngine::GameObject* _rtCameraObj; // 0x48
		::MoleMole::UIWindowController* _uiWindowController_k__BackingField; // 0x50
