...
#define MOLEMOLE_UIGENERALSORT2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x169C3910)
#define MOLEMOLE_UIGENERALSORT2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x169C39A0)
#define MOLEMOLE_UIGENERALSORT2WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x169C3840)
#define MOLEMOLE_UIGENERALSORT2WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x169C38A0)
#define MOLEMOLE_UIGENERALSORT2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x169C3A20)
#define MOLEMOLE_UIGENERALSORT2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x169C3A80)
#define MOLEMOLE_UIGENERALSORT2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x169C3B10)
#define MOLEMOLE_UIGENERALSORT2WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x169C3BA0)
#define MOLEMOLE_UIGENERALSORT2WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x169C3C30)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralSort2WidgetController_TypeDefinitionIndex = 44280;

	class UIGeneralSort2WidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_DE782794730406DC_3* _view; // 0x2B8
