...
#define MOLEMOLE_UIGENERALSORT2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x199C8B50)
#define MOLEMOLE_UIGENERALSORT2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x199C8BE0)
#define MOLEMOLE_UIGENERALSORT2WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x199C8A80)
#define MOLEMOLE_UIGENERALSORT2WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x199C8AE0)
#define MOLEMOLE_UIGENERALSORT2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x199C8C60)
#define MOLEMOLE_UIGENERALSORT2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x199C8CC0)
#define MOLEMOLE_UIGENERALSORT2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x199C8D50)
#define MOLEMOLE_UIGENERALSORT2WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x199C8DE0)
#define MOLEMOLE_UIGENERALSORT2WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x199C8E70)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralSort2WidgetController_TypeDefinitionIndex = 61871;
