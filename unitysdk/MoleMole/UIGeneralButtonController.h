...
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_ADDJUMPCLICKLISTENER_OFFSET UNITYSDK_OFFSET(0x151B5510)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_BINDREDSIGN_OFFSET UNITYSDK_OFFSET(0x151B38C0)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_BINDVIEWCALLBACK_OFFSET UNITYSDK_OFFSET(0x151B4360)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_GETBUTTONSTATEINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x151B3600)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_GETBUTTONSTATETEXTKEY_OFFSET UNITYSDK_OFFSET(0x151B3230)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_GETBUTTONSTATE_OFFSET UNITYSDK_OFFSET(0x151B36F0)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_GETEFFECTENABLED_OFFSET UNITYSDK_OFFSET(0x151B54C0)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_GETTEXT_OFFSET UNITYSDK_OFFSET(0x151B4FB0)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_GET_INTERACTABLE_OFFSET UNITYSDK_OFFSET(0x151B40C0)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_REBINDVIEWCALLBACKADVANCE_OFFSET UNITYSDK_OFFSET(0x151B4160)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_REMOVECLICKLISTENER_OFFSET UNITYSDK_OFFSET(0x151B42B0)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0x1519F750)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETARGS_OFFSET UNITYSDK_OFFSET(0x151B58F0)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETBUTTONSTATEINTERACTABLE_1_OFFSET UNITYSDK_OFFSET(0x151B35B0)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETBUTTONSTATEINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x151B3320)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETBUTTONSTATETEXTKEY_1_OFFSET UNITYSDK_OFFSET(0x151B31E0)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETBUTTONSTATETEXTKEY_OFFSET UNITYSDK_OFFSET(0x1519DEB0)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETBUTTONSTATE_1_OFFSET UNITYSDK_OFFSET(0x1519F8E0)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETBUTTONSTATE_OFFSET UNITYSDK_OFFSET(0x151B3740)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETEFFECTENABLED_OFFSET UNITYSDK_OFFSET(0x151B5010)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x151B3420)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETKEY_OFFSET UNITYSDK_OFFSET(0x151B58A0)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETLOCK_OFFSET UNITYSDK_OFFSET(0x151B40F0)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETTEXTARGS_OFFSET UNITYSDK_OFFSET(0x151B43F0)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETTEXTCOLOR_OFFSET UNITYSDK_OFFSET(0x151B4AF0)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETTEXTKEY_OFFSET UNITYSDK_OFFSET(0x151B2C60)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETTEXT_OFFSET UNITYSDK_OFFSET(0x151B3A50)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SET_INTERACTABLE_OFFSET UNITYSDK_OFFSET(0x151B3860)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_TRIGGERBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x151B5780)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x151B5940)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralButtonController_TypeDefinitionIndex = 82734;
