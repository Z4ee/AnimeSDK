...
#define MOLEMOLE_CHATPOPSHOW_GENERATECHATFLAG_OFFSET UNITYSDK_OFFSET(0xFAF1900)
#define MOLEMOLE_CHATPOPSHOW_GETCHATCAMERATYPE_OFFSET UNITYSDK_OFFSET(0xFAF0060)
#define MOLEMOLE_CHATPOPSHOW_GETCHATENTITIES_OFFSET UNITYSDK_OFFSET(0xFAF0C80)
#define MOLEMOLE_CHATPOPSHOW_GETENTITY_OFFSET UNITYSDK_OFFSET(0xFAF0B60)
#define MOLEMOLE_CHATPOPSHOW_GETTAGMAP_OFFSET UNITYSDK_OFFSET(0xFAF0520)
#define MOLEMOLE_CHATPOPSHOW_GET_ISTRIGGERINLOADING_OFFSET UNITYSDK_OFFSET(0xFAF0050)
#define MOLEMOLE_CHATPOPSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xFAF1980)
#define MOLEMOLE_CHATPOPSHOW_ONPLAYCHAT_OFFSET UNITYSDK_OFFSET(0xFAF1E70)
#define MOLEMOLE_CHATPOPSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xFAF1AC0)
#define MOLEMOLE_CHATPOPSHOW_PLAYCHATWITHFIXEDCAMERA_OFFSET UNITYSDK_OFFSET(0xFAF1300)
#define MOLEMOLE_CHATPOPSHOW_PLAYCHATWITHMULTIPLECAMERA_OFFSET UNITYSDK_OFFSET(0xFAF1100)
#define MOLEMOLE_CHATPOPSHOW_PLAYCHATWITHSOLOCAMERA_OFFSET UNITYSDK_OFFSET(0xFAF00F0)
#define MOLEMOLE_CHATPOPSHOW_PLAYCHAT_OFFSET UNITYSDK_OFFSET(0xFAF1BE0)
#define MOLEMOLE_CHATPOPSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0xFAF1990)
#define MOLEMOLE_CHATPOPSHOW__PLAYCHATWITHFIXEDCAMERA_B__15_0_OFFSET UNITYSDK_OFFSET(0xFAF2080)
#define MOLEMOLE_CHATPOPSHOW__PLAYCHATWITHFIXEDCAMERA_G__GETTRANSFORM_15_1_OFFSET UNITYSDK_OFFSET(0xFAF1740)
#define MOLEMOLE_CHATPOPSHOW__PLAYCHATWITHMULTIPLECAMERA_B__14_0_OFFSET UNITYSDK_OFFSET(0xFAF2020)
#define MOLEMOLE_CHATPOPSHOW__PLAYCHATWITHSOLOCAMERA_B__10_0_OFFSET UNITYSDK_OFFSET(0xFAF1FC0)
#define MOLEMOLE_CHATPOPSHOW__PLAYCHAT_B__21_0_OFFSET UNITYSDK_OFFSET(0xFAF20E0)

namespace MoleMole
{
	inline static constexpr unsigned int ChatPopShow_TypeDefinitionIndex = 57810;

	class ChatPopShow : public ::MoleMole::DisplayMessageBase
	{
	public:
		::System::Action_1<::Class_1_D65512A83CF70AB7*>* _finishCallback; // 0x28
		::Class_1_3A46F934F31B990A* _actionActionParams; // 0x30
		::System::Int32 _targetUid; // 0x38
		::System::Int32 _endTransitionId; // 0x3C
		::System::Int32 _interactId; // 0x40
		::System::UInt32 _chatUid; // 0x44
