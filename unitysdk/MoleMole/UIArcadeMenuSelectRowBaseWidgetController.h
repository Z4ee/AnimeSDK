...
#define MOLEMOLE_UIARCADEMENUSELECTROWBASEWIDGETCONTROLLER_DISABLECANVASSORTINGORDER_OFFSET UNITYSDK_OFFSET(0x181BFEA0)
#define MOLEMOLE_UIARCADEMENUSELECTROWBASEWIDGETCONTROLLER_ENABLECANVASSORTINGORDER_OFFSET UNITYSDK_OFFSET(0x181BFE20)
#define MOLEMOLE_UIARCADEMENUSELECTROWBASEWIDGETCONTROLLER_GETARCADEGAMEID_OFFSET UNITYSDK_OFFSET(0x181BFB20)
#define MOLEMOLE_UIARCADEMENUSELECTROWBASEWIDGETCONTROLLER_GETITEMCENTERY_OFFSET UNITYSDK_OFFSET(0x181BFBF0)
#define MOLEMOLE_UIARCADEMENUSELECTROWBASEWIDGETCONTROLLER_GETITEMHEIGHT_OFFSET UNITYSDK_OFFSET(0x181BFC60)
#define MOLEMOLE_UIARCADEMENUSELECTROWBASEWIDGETCONTROLLER_INITVIEWCONTROL_OFFSET UNITYSDK_OFFSET(0x181BFAA0)
#define MOLEMOLE_UIARCADEMENUSELECTROWBASEWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x181BE540)
#define MOLEMOLE_UIARCADEMENUSELECTROWBASEWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x181BF9A0)
#define MOLEMOLE_UIARCADEMENUSELECTROWBASEWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x181BEB30)
#define MOLEMOLE_UIARCADEMENUSELECTROWBASEWIDGETCONTROLLER_ONSCROLLVIEWITEMMOVE_OFFSET UNITYSDK_OFFSET(0x181BF600)
#define MOLEMOLE_UIARCADEMENUSELECTROWBASEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x181BEAD0)
#define MOLEMOLE_UIARCADEMENUSELECTROWBASEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x181BE4C0)
#define MOLEMOLE_UIARCADEMENUSELECTROWBASEWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x181BF030)
#define MOLEMOLE_UIARCADEMENUSELECTROWBASEWIDGETCONTROLLER_SETBUTTONENABLE_OFFSET UNITYSDK_OFFSET(0x181BFB70)
#define MOLEMOLE_UIARCADEMENUSELECTROWBASEWIDGETCONTROLLER_SETITEMCENTEROFFSET_OFFSET UNITYSDK_OFFSET(0x181BEC40)
#define MOLEMOLE_UIARCADEMENUSELECTROWBASEWIDGETCONTROLLER_SETWIDGETINNERPOSITION_OFFSET UNITYSDK_OFFSET(0x181BFD70)
#define MOLEMOLE_UIARCADEMENUSELECTROWBASEWIDGETCONTROLLER_SETWIDGETINNERSCALE_OFFSET UNITYSDK_OFFSET(0x181BFCD0)
#define MOLEMOLE_UIARCADEMENUSELECTROWBASEWIDGETCONTROLLER_UPDATECANVAS_OFFSET UNITYSDK_OFFSET(0x181BF760)
#define MOLEMOLE_UIARCADEMENUSELECTROWBASEWIDGETCONTROLLER_UPDATEITEMSCALE_OFFSET UNITYSDK_OFFSET(0x181BF650)
#define MOLEMOLE_UIARCADEMENUSELECTROWBASEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x181C18C0)
#define MOLEMOLE_UIARCADEMENUSELECTROWBASEWIDGETCONTROLLER__UPDATEITEMSCALE_G__NEWSCALELOGICRECT_17_0_OFFSET UNITYSDK_OFFSET(0x181BFF00)
#define MOLEMOLE_UIARCADEMENUSELECTROWBASEWIDGETCONTROLLER__UPDATEITEMSCALE_G__NEWSCALELOGIC_17_1_OFFSET UNITYSDK_OFFSET(0x181C0CA0)
#define MOLEMOLE_UIARCADEMENUSELECTROWBASEWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x181C18D0)
#define MOLEMOLE_UIARCADEMENUSELECTROWBASEWIDGETCONTROLLER___BASE_ONSCROLLVIEWITEMMOVE_OFFSET UNITYSDK_OFFSET(0x181C1970)
#define MOLEMOLE_UIARCADEMENUSELECTROWBASEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x181C1A00)
#define MOLEMOLE_UIARCADEMENUSELECTROWBASEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x181C1A90)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeMenuSelectRowBaseWidgetController_TypeDefinitionIndex = 84073;
