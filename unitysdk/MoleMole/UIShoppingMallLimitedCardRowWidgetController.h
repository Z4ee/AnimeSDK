...
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARDROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1273F3D0)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARDROWWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1273F4E0)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARDROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1273F270)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARDROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1273F460)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARDROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1273EFC0)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARDROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1273F200)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1273F550)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARDROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1273F5B0)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARDROWWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1273F640)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARDROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1273F670)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARDROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1273F710)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARDROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1273F7A0)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARDROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1273F830)

namespace MoleMole
{
	inline static constexpr unsigned int UIShoppingMallLimitedCardRowWidgetController_TypeDefinitionIndex = 45148;

	class UIShoppingMallLimitedCardRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_94* _view; // 0x2B8
