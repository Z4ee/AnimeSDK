...
#define MOLEMOLE_UIRABDEPOSITORYELEMENTUPROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17A1C560)
#define MOLEMOLE_UIRABDEPOSITORYELEMENTUPROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17A1C5D0)
#define MOLEMOLE_UIRABDEPOSITORYELEMENTUPROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17A1C670)
#define MOLEMOLE_UIRABDEPOSITORYELEMENTUPROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17A1C830)
#define MOLEMOLE_UIRABDEPOSITORYELEMENTUPROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17A1C890)
#define MOLEMOLE_UIRABDEPOSITORYELEMENTUPROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17A1C930)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABDepositoryElementUpRowWidgetController_TypeDefinitionIndex = 60889;
