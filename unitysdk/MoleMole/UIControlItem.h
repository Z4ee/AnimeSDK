...
#define MOLEMOLE_UICONTROLITEM_EQUALS_OFFSET UNITYSDK_OFFSET(0x17A5B1E0)
#define MOLEMOLE_UICONTROLITEM_ISMATCH_OFFSET UNITYSDK_OFFSET(0x17A5AEB0)
#define MOLEMOLE_UICONTROLITEM_METHOD_1_4DE8CBABBBA1918B_OFFSET UNITYSDK_OFFSET(0x17A5B280)
#define MOLEMOLE_UICONTROLITEM_METHOD_1_54EE5091F9DB1A7D_OFFSET UNITYSDK_OFFSET(0x17A5B7E0)
#define MOLEMOLE_UICONTROLITEM_METHOD_1_7222809C3B193985_OFFSET UNITYSDK_OFFSET(0x17A5B870)
#define MOLEMOLE_UICONTROLITEM_METHOD_1_7447D31007493755_OFFSET UNITYSDK_OFFSET(0x17A5B600)
#define MOLEMOLE_UICONTROLITEM_METHOD_1_7F53CB1E098E0EB4_OFFSET UNITYSDK_OFFSET(0x17A5B590)
#define MOLEMOLE_UICONTROLITEM_METHOD_1_DC142A2AF2A69784_OFFSET UNITYSDK_OFFSET(0x17A5B580)
#define MOLEMOLE_UICONTROLITEM_METHOD_1_FF9D9C132E279CF6_OFFSET UNITYSDK_OFFSET(0x17A5B450)
#define MOLEMOLE_UICONTROLITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x17A5B440)

namespace MoleMole
{
	inline static constexpr unsigned int UIControlItem_TypeDefinitionIndex = 75651;
