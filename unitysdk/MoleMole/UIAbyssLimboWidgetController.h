...
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_GETENTRANCEID_OFFSET UNITYSDK_OFFSET(0x18733A90)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_GETNEEDPLAYUNLOCKEFFECT_OFFSET UNITYSDK_OFFSET(0x18737E90)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_GETPROGRESSEFFECTPLAYCOUNT_OFFSET UNITYSDK_OFFSET(0x18737F40)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_GET_ISAFKLOCKED_OFFSET UNITYSDK_OFFSET(0x18737E70)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_GET_ISBOSSRUSHENTRANCE_OFFSET UNITYSDK_OFFSET(0x18737010)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_GET_ISLOCK_OFFSET UNITYSDK_OFFSET(0x18737E80)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_GET_ISNESTENTRANCE_OFFSET UNITYSDK_OFFSET(0x18737020)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x18733270)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_ISNEW_OFFSET UNITYSDK_OFFSET(0x18738990)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_ISRED_OFFSET UNITYSDK_OFFSET(0x18738B30)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18738CB0)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18737D00)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_ONLIMBOBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x187308B0)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18737E00)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18738D40)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18737030)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18737B30)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_REFRESHENTRANCEVIEW_OFFSET UNITYSDK_OFFSET(0x18737FC0)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_REFRESHHOBAPREFACVIEW_OFFSET UNITYSDK_OFFSET(0x18738500)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_REFRESHNEWSTATE_OFFSET UNITYSDK_OFFSET(0x18734D90)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_REFRESHPERIODVIEW_OFFSET UNITYSDK_OFFSET(0x18738190)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_REFRESHSTATE_OFFSET UNITYSDK_OFFSET(0x18733AF0)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18738DC0)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER__ONUIOPEN_B__21_0_OFFSET UNITYSDK_OFFSET(0x18738F20)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER__ONUIOPEN_B__21_1_OFFSET UNITYSDK_OFFSET(0x18738F30)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER__REFRESHSTATE_B__35_0_OFFSET UNITYSDK_OFFSET(0x18738F40)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER__REFRESHSTATE_B__35_1_OFFSET UNITYSDK_OFFSET(0x18738FB0)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER__REFRESHSTATE_B__35_2_OFFSET UNITYSDK_OFFSET(0x18739020)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER__REFRESHSTATE_B__35_3_OFFSET UNITYSDK_OFFSET(0x187390C0)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18739330)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x187393C0)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18739460)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x187394F0)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18739580)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssLimboWidgetController_TypeDefinitionIndex = 53696;

	class UIAbyssLimboWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_46B1304F31463D00_1* _view; // 0x2C0
		...
		::System::Action_1<::Class_2_208CC9941471731A_629*>* clickAction; // 0x308
		::Class_2_E621E51D351EB960* _abyssModel; // 0x310
		...
		::Class_2_208CC9941471731A_629* entranceCfg; // 0x350
