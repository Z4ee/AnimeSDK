...
#define MOLEMOLE_UIFISHINGROLEEFFECTDIALOGPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x17A6F100)
#define MOLEMOLE_UIFISHINGROLEEFFECTDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x17A6F0F0)
#define MOLEMOLE_UIFISHINGROLEEFFECTDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17A6F890)
#define MOLEMOLE_UIFISHINGROLEEFFECTDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17A6F920)
#define MOLEMOLE_UIFISHINGROLEEFFECTDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17A6F110)
#define MOLEMOLE_UIFISHINGROLEEFFECTDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17A6F360)
#define MOLEMOLE_UIFISHINGROLEEFFECTDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17A6F990)
#define MOLEMOLE_UIFISHINGROLEEFFECTDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__6_0_OFFSET UNITYSDK_OFFSET(0x17A6FA20)
#define MOLEMOLE_UIFISHINGROLEEFFECTDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__6_1_OFFSET UNITYSDK_OFFSET(0x17A6FAA0)
#define MOLEMOLE_UIFISHINGROLEEFFECTDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__6_2_OFFSET UNITYSDK_OFFSET(0x17A6FB20)
#define MOLEMOLE_UIFISHINGROLEEFFECTDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17A6FBA0)
#define MOLEMOLE_UIFISHINGROLEEFFECTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17A6FC30)
#define MOLEMOLE_UIFISHINGROLEEFFECTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17A6FC40)
#define MOLEMOLE_UIFISHINGROLEEFFECTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17A6FC50)

namespace MoleMole
{
	inline static constexpr unsigned int UIFishingRoleEffectDialogPopWindowController_TypeDefinitionIndex = 68326;
