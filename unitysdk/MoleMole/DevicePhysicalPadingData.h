...
#define MOLEMOLE_DEVICEPHYSICALPADINGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19D6EAB0)

namespace MoleMole
{
	inline static constexpr unsigned int DevicePhysicalPadingData_TypeDefinitionIndex = 67173;
