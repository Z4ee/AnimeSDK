...
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17875550)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER___C__DISPLAYCLASS1_0__ONUIOPEN_B__0_OFFSET UNITYSDK_OFFSET(0x17875560)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER___C__DISPLAYCLASS1_0__ONUIOPEN_B__1_OFFSET UNITYSDK_OFFSET(0x17875720)

namespace MoleMole
{
	inline static constexpr unsigned int UIMusicBattleResultPopWindowController___c__DisplayClass1_0_TypeDefinitionIndex = 55290;
