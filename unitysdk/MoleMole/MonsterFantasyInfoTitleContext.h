...
#define MOLEMOLE_MONSTERFANTASYINFOTITLECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x17920B90)

namespace MoleMole
{
	inline static constexpr unsigned int MonsterFantasyInfoTitleContext_TypeDefinitionIndex = 45024;
