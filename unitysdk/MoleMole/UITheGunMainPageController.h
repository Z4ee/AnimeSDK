...
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_GETLISTDATA_OFFSET UNITYSDK_OFFSET(0x11B80F50)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_GETQUESTINDEX_OFFSET UNITYSDK_OFFSET(0x11B81050)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x11B7FF30)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_GOTOMAINCITY_OFFSET UNITYSDK_OFFSET(0x11B82110)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_ONACTIVITYCLOSE_OFFSET UNITYSDK_OFFSET(0x11B82700)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_ONCLICKLEVELITEM_OFFSET UNITYSDK_OFFSET(0x11B81BB0)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_ONCLICKMAIN_OFFSET UNITYSDK_OFFSET(0x11B81CA0)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x11B7FF40)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x11B80EB0)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x11B80910)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x11B7FFD0)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x11B80980)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_OPENINFO_OFFSET UNITYSDK_OFFSET(0x11B81DD0)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_REFRESHTABNEW_OFFSET UNITYSDK_OFFSET(0x11B81620)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_REFRESHTABTRACK_OFFSET UNITYSDK_OFFSET(0x11B81540)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_REFRESHTAB_OFFSET UNITYSDK_OFFSET(0x11B80D10)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_SETPAGEMODE_OFFSET UNITYSDK_OFFSET(0x11B81150)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_SHOWGOBATTLE_OFFSET UNITYSDK_OFFSET(0x11B81FD0)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_TRACKQUESTGROUP_OFFSET UNITYSDK_OFFSET(0x11B82230)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11B828F0)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER__ONUIINIT_B__14_0_OFFSET UNITYSDK_OFFSET(0x11B82900)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER__ONUIINIT_B__14_1_OFFSET UNITYSDK_OFFSET(0x11B82910)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER__ONUIINIT_B__14_2_OFFSET UNITYSDK_OFFSET(0x11B82920)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER__ONUIINIT_B__14_3_OFFSET UNITYSDK_OFFSET(0x11B82930)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER__ONUIINIT_B__14_4_OFFSET UNITYSDK_OFFSET(0x11B82940)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x11B82950)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x11B829E0)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x11B82AA0)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x11B82AB0)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x11B82AC0)

namespace MoleMole
{
	inline static constexpr unsigned int UITheGunMainPageController_TypeDefinitionIndex = 81504;

	class UITheGunMainPageController : public ::MoleMole::UIWindowController
	{
	public:
		::UnityEngine::GameObject* BGNormal; // 0x310
		::UnityEngine::GameObject* BGHard; // 0x318
		::MoleMole::UITheGunGoBattlePopWindowController* goBattlePop; // 0x320
		::MoleMole::TheGunGoBattleContext* popContex; // 0x328
		::System::Int32 currentTab; // 0x330
		::Class_2_A29AABB3C13F614B* model; // 0x338
		::System::Int32 activityID; // 0x340
		::MoleMole::UIGeneralNewHintWidgetController* _newHintCtrlNormal; // 0x348
		::MoleMole::UIGeneralNewHintWidgetController* _newHintCtrlHard; // 0x350
		::Class_2_79F6D62CE30E3F8E_169* _view; // 0x358
