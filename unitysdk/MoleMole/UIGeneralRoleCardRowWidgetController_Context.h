...
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_GET_ATTACKVALUE_OFFSET UNITYSDK_OFFSET(0x18408800)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_GET_HANDLESELECT_OFFSET UNITYSDK_OFFSET(0x18408660)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_GET_HPPERCENT_OFFSET UNITYSDK_OFFSET(0x18408700)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_GET_ISADD_OFFSET UNITYSDK_OFFSET(0x184086E0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_GET_ISDEFAULTAVATAR_OFFSET UNITYSDK_OFFSET(0x18408740)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x18408640)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_GET_ISLOCK_OFFSET UNITYSDK_OFFSET(0x184087A0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_GET_ISMASK_OFFSET UNITYSDK_OFFSET(0x18408680)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_GET_ISNEW_OFFSET UNITYSDK_OFFSET(0x18408720)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_GET_ISROBOT_OFFSET UNITYSDK_OFFSET(0x18408780)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_GET_ISSELECTED_OFFSET UNITYSDK_OFFSET(0x184086A0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_GET_ROLETAGTEXT_OFFSET UNITYSDK_OFFSET(0x18408760)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_GET_SHOWATTACKVALUE_OFFSET UNITYSDK_OFFSET(0x184087E0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_GET_SHOWCOOPUP_OFFSET UNITYSDK_OFFSET(0x18408820)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_GET_SHOWNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x184086C0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_GET_SHOWUPGRADE_OFFSET UNITYSDK_OFFSET(0x184087C0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_SETAVATARADDSTATE_OFFSET UNITYSDK_OFFSET(0x18408840)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_SETAVATAR_1_OFFSET UNITYSDK_OFFSET(0x18408C90)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_SETAVATAR_OFFSET UNITYSDK_OFFSET(0x18408A50)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_SETBUDDYADDSTATE_OFFSET UNITYSDK_OFFSET(0x18408890)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_SETHANDLESELECT_OFFSET UNITYSDK_OFFSET(0x18408F00)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_SETLOCKSTATE_OFFSET UNITYSDK_OFFSET(0x18408B60)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_SETMASK_OFFSET UNITYSDK_OFFSET(0x18408F60)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_SETROBOT_OFFSET UNITYSDK_OFFSET(0x184088E0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_SET_ATTACKVALUE_OFFSET UNITYSDK_OFFSET(0x18408810)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_SET_HANDLESELECT_OFFSET UNITYSDK_OFFSET(0x18408670)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_SET_HPPERCENT_OFFSET UNITYSDK_OFFSET(0x18408710)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_SET_ISADD_OFFSET UNITYSDK_OFFSET(0x184086F0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_SET_ISDEFAULTAVATAR_OFFSET UNITYSDK_OFFSET(0x18408750)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_SET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x18408650)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_SET_ISLOCK_OFFSET UNITYSDK_OFFSET(0x184087B0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_SET_ISMASK_OFFSET UNITYSDK_OFFSET(0x18408690)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_SET_ISNEW_OFFSET UNITYSDK_OFFSET(0x18408730)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_SET_ISROBOT_OFFSET UNITYSDK_OFFSET(0x18408790)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_SET_ISSELECTED_OFFSET UNITYSDK_OFFSET(0x184086B0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_SET_ROLETAGTEXT_OFFSET UNITYSDK_OFFSET(0x18408770)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_SET_SHOWATTACKVALUE_OFFSET UNITYSDK_OFFSET(0x184087F0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_SET_SHOWCOOPUP_OFFSET UNITYSDK_OFFSET(0x18408830)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_SET_SHOWNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x184086D0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT_SET_SHOWUPGRADE_OFFSET UNITYSDK_OFFSET(0x184087D0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18408D60)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18408DD0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x18408E40)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18408D00)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralRoleCardRowWidgetController_Context_TypeDefinitionIndex = 64138;
	...
	public:
		...
		::Enum_3_CB0BFAD855838C72 ShowType; // 0x3C
		::System::Boolean _ShowUpgrade_k__BackingField; // 0x40
		::System::Boolean IsBtnInteractable; // 0x41
		::System::Int32 BuddyId; // 0x44
		::System::Int32 _HpPercent_k__BackingField; // 0x48
		::UnityEngine::Color AttackValueColor; // 0x4C
		::System::Int32 _AttackValue_k__BackingField; // 0x5C
		::System::Int32 Level; // 0x60
		::System::Boolean _HandleSelect_k__BackingField; // 0x64
		::System::Boolean _IsNew_k__BackingField; // 0x65
		::System::Boolean _IsDefaultAvatar_k__BackingField; // 0x66
		::System::Boolean _IsLock_k__BackingField; // 0x67
		::System::Boolean _ShowAttackValue_k__BackingField; // 0x68
		::System::Boolean _ShowNotification_k__BackingField; // 0x69
		::System::Boolean _IsMask_k__BackingField; // 0x6A
		::System::Boolean _IsAdd_k__BackingField; // 0x6B
		::System::Boolean _ShowCoopUp_k__BackingField; // 0x6C
		::System::Boolean _IsRobot_k__BackingField; // 0x6D
		::System::Boolean _IsSelected_k__BackingField; // 0x6E
		::System::Boolean _IsEmpty_k__BackingField; // 0x6F
