...
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSITEMCONTROLLERBASE_DOREFRESHITEMSHOWSTATE_OFFSET UNITYSDK_OFFSET(0x19EBB620)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSITEMCONTROLLERBASE_HANDLESHOWSTATEANIM_OFFSET UNITYSDK_OFFSET(0x19EBB6F0)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSITEMCONTROLLERBASE_INIT_OFFSET UNITYSDK_OFFSET(0x19EBB270)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSITEMCONTROLLERBASE_PLAYMAXANIM_OFFSET UNITYSDK_OFFSET(0x19EBB2C0)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSITEMCONTROLLERBASE_PLAYNOTMAXANIM_OFFSET UNITYSDK_OFFSET(0x19EBB430)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSITEMCONTROLLERBASE_REFRESHITEMSHOWSTATE_OFFSET UNITYSDK_OFFSET(0x19EBB5A0)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSITEMCONTROLLERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19EBBF40)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSITEMCONTROLLERBASE__HANDLESHOWSTATEANIM_B__24_0_OFFSET UNITYSDK_OFFSET(0x19EBBFA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelLightUpPointsItemControllerBase_TypeDefinitionIndex = 85937;
