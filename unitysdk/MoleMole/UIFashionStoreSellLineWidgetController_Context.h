...
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER_CONTEXT_ADDPRODUCT_OFFSET UNITYSDK_OFFSET(0x15A55FD0)
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER_CONTEXT_FILLWITHNULL_OFFSET UNITYSDK_OFFSET(0x15A56100)
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER_CONTEXT_GETPRODUCTARRAY_OFFSET UNITYSDK_OFFSET(0x15A56220)
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15A55F40)

namespace MoleMole
{
	inline static constexpr unsigned int UIFashionStoreSellLineWidgetController_Context_TypeDefinitionIndex = 55937;
