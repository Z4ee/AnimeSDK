...
#define MOLEMOLE_UIROARINSTORECARDWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16A8ACD0)
#define MOLEMOLE_UIROARINSTORECARDWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16A8AD40)
#define MOLEMOLE_UIROARINSTORECARDWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16A8ADE0)
#define MOLEMOLE_UIROARINSTORECARDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16A8AF50)
#define MOLEMOLE_UIROARINSTORECARDWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16A8AF60)
#define MOLEMOLE_UIROARINSTORECARDWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16A8B000)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoarinStoreCardWidgetController_TypeDefinitionIndex = 56950;
