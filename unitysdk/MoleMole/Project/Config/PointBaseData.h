...
#define MOLEMOLE_PROJECT_CONFIG_POINTBASEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3FCA00)

namespace MoleMole::Project::Config
{
	inline static constexpr unsigned int PointBaseData_TypeDefinitionIndex = 15839;
