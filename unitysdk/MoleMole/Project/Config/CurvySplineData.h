...
#define MOLEMOLE_PROJECT_CONFIG_CURVYSPLINEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFB59C0)

namespace MoleMole::Project::Config
{
	inline static constexpr unsigned int CurvySplineData_TypeDefinitionIndex = 13993;
