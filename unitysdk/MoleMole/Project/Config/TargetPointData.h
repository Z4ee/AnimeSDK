...
#define MOLEMOLE_PROJECT_CONFIG_TARGETPOINTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19055AD0)

namespace MoleMole::Project::Config
{
	inline static constexpr unsigned int TargetPointData_TypeDefinitionIndex = 12604;
