...
#define MOLEMOLE_UISTOREPAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x15A40150)

namespace MoleMole
{
	inline static constexpr unsigned int UIStorePageConfig_TypeDefinitionIndex = 63589;
