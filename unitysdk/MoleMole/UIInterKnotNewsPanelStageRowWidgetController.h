...
#define MOLEMOLE_UIINTERKNOTNEWSPANELSTAGEROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14B79EC0)
#define MOLEMOLE_UIINTERKNOTNEWSPANELSTAGEROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x14B79FD0)
#define MOLEMOLE_UIINTERKNOTNEWSPANELSTAGEROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14B79F50)
#define MOLEMOLE_UIINTERKNOTNEWSPANELSTAGEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14B79CF0)
#define MOLEMOLE_UIINTERKNOTNEWSPANELSTAGEROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x14B7A110)
#define MOLEMOLE_UIINTERKNOTNEWSPANELSTAGEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14B7A620)
#define MOLEMOLE_UIINTERKNOTNEWSPANELSTAGEROWWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0x14B7A630)
#define MOLEMOLE_UIINTERKNOTNEWSPANELSTAGEROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14B7A6B0)
#define MOLEMOLE_UIINTERKNOTNEWSPANELSTAGEROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x14B7A740)
#define MOLEMOLE_UIINTERKNOTNEWSPANELSTAGEROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14B7A7E0)
#define MOLEMOLE_UIINTERKNOTNEWSPANELSTAGEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14B7A870)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotNewsPanelStageRowWidgetController_TypeDefinitionIndex = 76263;

	class UIInterKnotNewsPanelStageRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_C39030A6227D9C3E_1* _view; // 0x2E8
		::System::Collections::Generic::List_1<::Class_1_C4CB11A2FD957208_Struct_2_98E057419FFAAB00>* _rewardList; // 0x2F0
