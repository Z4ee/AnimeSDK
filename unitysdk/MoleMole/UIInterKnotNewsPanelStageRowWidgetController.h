...
#define MOLEMOLE_UIINTERKNOTNEWSPANELSTAGEROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x182C4F70)
#define MOLEMOLE_UIINTERKNOTNEWSPANELSTAGEROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x182C5080)
#define MOLEMOLE_UIINTERKNOTNEWSPANELSTAGEROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x182C5000)
#define MOLEMOLE_UIINTERKNOTNEWSPANELSTAGEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x182C4DA0)
#define MOLEMOLE_UIINTERKNOTNEWSPANELSTAGEROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x182C51C0)
#define MOLEMOLE_UIINTERKNOTNEWSPANELSTAGEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x182C5730)
#define MOLEMOLE_UIINTERKNOTNEWSPANELSTAGEROWWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0x182C5740)
#define MOLEMOLE_UIINTERKNOTNEWSPANELSTAGEROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x182C57C0)
#define MOLEMOLE_UIINTERKNOTNEWSPANELSTAGEROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x182C5850)
#define MOLEMOLE_UIINTERKNOTNEWSPANELSTAGEROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x182C58F0)
#define MOLEMOLE_UIINTERKNOTNEWSPANELSTAGEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x182C5980)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotNewsPanelStageRowWidgetController_TypeDefinitionIndex = 76979;
