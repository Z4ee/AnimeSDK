...
#define MOLEMOLE_UIACTIVITYHOTPOTREWARDPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x181B2BD0)
#define MOLEMOLE_UIACTIVITYHOTPOTREWARDPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x181B2BE0)
#define MOLEMOLE_UIACTIVITYHOTPOTREWARDPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x181B2C50)
#define MOLEMOLE_UIACTIVITYHOTPOTREWARDPAGECONTROLLER_ONLIVEHOUSEGETREWARD_OFFSET UNITYSDK_OFFSET(0x181B2F80)
#define MOLEMOLE_UIACTIVITYHOTPOTREWARDPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x181B2EE0)
#define MOLEMOLE_UIACTIVITYHOTPOTREWARDPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x181B2CF0)
#define MOLEMOLE_UIACTIVITYHOTPOTREWARDPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x181B31F0)
#define MOLEMOLE_UIACTIVITYHOTPOTREWARDPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x181B3200)
#define MOLEMOLE_UIACTIVITYHOTPOTREWARDPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x181B32A0)
#define MOLEMOLE_UIACTIVITYHOTPOTREWARDPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x181B32B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityHotPotRewardPageController_TypeDefinitionIndex = 52397;
