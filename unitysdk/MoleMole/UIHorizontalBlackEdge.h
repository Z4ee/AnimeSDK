...
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_CALCULATELAYOUT_OFFSET UNITYSDK_OFFSET(0x18FBBE10)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_GETPIXELSCREENSIZEEXCLUDEHORIZONTALBLACKEDGE_OFFSET UNITYSDK_OFFSET(0x18FBD040)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_INIT_OFFSET UNITYSDK_OFFSET(0x18FBBBF0)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_METHOD_5_4B72F72501001F72_OFFSET UNITYSDK_OFFSET(0x18FBCE40)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_METHOD_5_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x18FBD1A0)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x18FBD290)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x18FBD2D0)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_METHOD_5_F8D89B01C3E76DAB_OFFSET UNITYSDK_OFFSET(0x18FBD1B0)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18FBBD60)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18FBBB60)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18FBD150)

namespace MoleMole
{
	inline static constexpr unsigned int UIHorizontalBlackEdge_TypeDefinitionIndex = 88562;

	class UIHorizontalBlackEdge : public ::UnityEngine::MonoBehaviour
	{
	public:
		::MoleMole::UIHorizontalBlackEdge_Enum_3_66284F0EC32C48A3 Field_5_3; // 0x18
		::UnityEngine::CanvasGroup* Field_5_2; // 0x20
		::System::Nullable_1<::System::Int32> Field_5_1; // 0x28
		::UnityEngine::RectTransform* Field_5_0; // 0x30
		::System::Boolean _isLeft; // 0x38
		::UnityEngine::Canvas* Field_5_6; // 0x40
