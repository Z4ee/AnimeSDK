...
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_CALCULATELAYOUT_OFFSET UNITYSDK_OFFSET(0x157D0550)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_GETPIXELSCREENSIZEEXCLUDEHORIZONTALBLACKEDGE_OFFSET UNITYSDK_OFFSET(0x157D1770)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_INIT_OFFSET UNITYSDK_OFFSET(0x157D0330)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_METHOD_5_4B72F72501001F72_OFFSET UNITYSDK_OFFSET(0x157D1570)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_METHOD_5_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x157D19F0)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x157D18D0)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x157D18C0)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_METHOD_5_F8D89B01C3E76DAB_OFFSET UNITYSDK_OFFSET(0x157D1910)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x157D04A0)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x157D02A0)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x157D1870)

namespace MoleMole
{
	inline static constexpr unsigned int UIHorizontalBlackEdge_TypeDefinitionIndex = 43767;
