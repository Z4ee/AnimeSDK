...
#define MOLEMOLE_UISTRATEGYGUIDEPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15E908E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIStrategyGuidePageContext_TypeDefinitionIndex = 71053;
