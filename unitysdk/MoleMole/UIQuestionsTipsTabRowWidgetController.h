...
#define MOLEMOLE_UIQUESTIONSTIPSTABROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16131220)
#define MOLEMOLE_UIQUESTIONSTIPSTABROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16131330)
#define MOLEMOLE_UIQUESTIONSTIPSTABROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x161312B0)
#define MOLEMOLE_UIQUESTIONSTIPSTABROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x161310D0)
#define MOLEMOLE_UIQUESTIONSTIPSTABROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16131750)
#define MOLEMOLE_UIQUESTIONSTIPSTABROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x161318F0)
#define MOLEMOLE_UIQUESTIONSTIPSTABROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16131980)
#define MOLEMOLE_UIQUESTIONSTIPSTABROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16131A20)
#define MOLEMOLE_UIQUESTIONSTIPSTABROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16131AB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsTipsTabRowWidgetController_TypeDefinitionIndex = 39626;

	class UIQuestionsTipsTabRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Il2CppArray<::System::String*>* NumberPath; // 0x2E8
		::Class_2_D974C8170E0C9A87* _view; // 0x2F0
