...
#define MOLEMOLE_UIQUESTIONSTIPSTABROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18459CF0)
#define MOLEMOLE_UIQUESTIONSTIPSTABROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x18459E00)
#define MOLEMOLE_UIQUESTIONSTIPSTABROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18459D80)
#define MOLEMOLE_UIQUESTIONSTIPSTABROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18459BA0)
#define MOLEMOLE_UIQUESTIONSTIPSTABROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1845A220)
#define MOLEMOLE_UIQUESTIONSTIPSTABROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1845A3C0)
#define MOLEMOLE_UIQUESTIONSTIPSTABROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1845A450)
#define MOLEMOLE_UIQUESTIONSTIPSTABROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1845A4F0)
#define MOLEMOLE_UIQUESTIONSTIPSTABROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1845A580)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsTipsTabRowWidgetController_TypeDefinitionIndex = 66985;
