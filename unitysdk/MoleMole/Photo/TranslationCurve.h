...
#define MOLEMOLE_PHOTO_TRANSLATIONCURVE_CREATE_OFFSET UNITYSDK_OFFSET(0x16888150)
#define MOLEMOLE_PHOTO_TRANSLATIONCURVE_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x16888880)
#define MOLEMOLE_PHOTO_TRANSLATIONCURVE_REQUEST_OFFSET UNITYSDK_OFFSET(0x16888890)
#define MOLEMOLE_PHOTO_TRANSLATIONCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x168889D0)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int TranslationCurve_TypeDefinitionIndex = 55061;
	...
	public:
		...
		{
			return ((::Struct_2_AAD4F4215611A948_1(*)(::PVOID, ::UnityEngine::Playables::PlayableGraph, ::UnityEngine::Animator*, ::Struct_2_ACD0EF80A5330786&, ::Foundation::NativeMemory*, ::System::ReadOnlySpan_1<::Foundation::NativeMemoryRequestHandle>))((::PBYTE)hIl2Cpp + MOLEMOLE_PHOTO_TRANSLATIONCURVE_CREATE_OFFSET))(this, a1, a2, a3, a4, a5);
		}
