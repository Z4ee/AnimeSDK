...
#define MOLEMOLE_PHOTO_TRANSLATIONCURVE_CREATE_OFFSET UNITYSDK_OFFSET(0x15BAFF20)
#define MOLEMOLE_PHOTO_TRANSLATIONCURVE_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x15BB0630)
#define MOLEMOLE_PHOTO_TRANSLATIONCURVE_REQUEST_OFFSET UNITYSDK_OFFSET(0x15BB0640)
#define MOLEMOLE_PHOTO_TRANSLATIONCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x15BB0780)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int TranslationCurve_TypeDefinitionIndex = 77725;
