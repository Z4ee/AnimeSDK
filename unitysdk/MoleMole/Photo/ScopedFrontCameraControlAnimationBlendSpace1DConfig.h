...
#define MOLEMOLE_PHOTO_SCOPEDFRONTCAMERACONTROLANIMATIONBLENDSPACE1DCONFIG_CREATE_OFFSET UNITYSDK_OFFSET(0x13859B30)
#define MOLEMOLE_PHOTO_SCOPEDFRONTCAMERACONTROLANIMATIONBLENDSPACE1DCONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x1385ABA0)
#define MOLEMOLE_PHOTO_SCOPEDFRONTCAMERACONTROLANIMATIONBLENDSPACE1DCONFIG_REQUEST_OFFSET UNITYSDK_OFFSET(0x1385AD30)
#define MOLEMOLE_PHOTO_SCOPEDFRONTCAMERACONTROLANIMATIONBLENDSPACE1DCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1385C160)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int ScopedFrontCameraControlAnimationBlendSpace1DConfig_TypeDefinitionIndex = 82745;
