...
#define MOLEMOLE_PHOTO_ANIMATIONSAVECACHEDPOSECONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0x144FAB50)
#define MOLEMOLE_PHOTO_ANIMATIONSAVECACHEDPOSECONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x144FAB40)
#define MOLEMOLE_PHOTO_ANIMATIONSAVECACHEDPOSECONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0x144FB260)
#define MOLEMOLE_PHOTO_ANIMATIONSAVECACHEDPOSECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x144FB540)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int AnimationSaveCachedPoseConfig_TypeDefinitionIndex = 82195;
