...
#define MOLEMOLE_PHOTO_FRONTCAMERAPROCESSEMOTIONPOSECONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0x19983960)
#define MOLEMOLE_PHOTO_FRONTCAMERAPROCESSEMOTIONPOSECONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x19983950)
#define MOLEMOLE_PHOTO_FRONTCAMERAPROCESSEMOTIONPOSECONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0x19983F20)
#define MOLEMOLE_PHOTO_FRONTCAMERAPROCESSEMOTIONPOSECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19984040)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int FrontCameraProcessEmotionPoseConfig_TypeDefinitionIndex = 41158;
