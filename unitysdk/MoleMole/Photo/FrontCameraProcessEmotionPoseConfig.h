...
#define MOLEMOLE_PHOTO_FRONTCAMERAPROCESSEMOTIONPOSECONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0x12B11890)
#define MOLEMOLE_PHOTO_FRONTCAMERAPROCESSEMOTIONPOSECONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x12B11880)
#define MOLEMOLE_PHOTO_FRONTCAMERAPROCESSEMOTIONPOSECONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0x12B11E60)
#define MOLEMOLE_PHOTO_FRONTCAMERAPROCESSEMOTIONPOSECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x12B11F80)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int FrontCameraProcessEmotionPoseConfig_TypeDefinitionIndex = 44366;
