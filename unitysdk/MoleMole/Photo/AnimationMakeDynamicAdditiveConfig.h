...
#define MOLEMOLE_PHOTO_ANIMATIONMAKEDYNAMICADDITIVECONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0x18CF26A0)
#define MOLEMOLE_PHOTO_ANIMATIONMAKEDYNAMICADDITIVECONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x18CF2690)
#define MOLEMOLE_PHOTO_ANIMATIONMAKEDYNAMICADDITIVECONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0x18CF27E0)
#define MOLEMOLE_PHOTO_ANIMATIONMAKEDYNAMICADDITIVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CF2860)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int AnimationMakeDynamicAdditiveConfig_TypeDefinitionIndex = 66712;
