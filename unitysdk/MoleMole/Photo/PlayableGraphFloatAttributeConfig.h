...
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHFLOATATTRIBUTECONFIG_APPLY_OFFSET UNITYSDK_OFFSET(0x158554C0)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHFLOATATTRIBUTECONFIG_GETMULTIPLIERCURVENAME_OFFSET UNITYSDK_OFFSET(0x15855430)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHFLOATATTRIBUTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x15855870)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int PlayableGraphFloatAttributeConfig_TypeDefinitionIndex = 48317;
