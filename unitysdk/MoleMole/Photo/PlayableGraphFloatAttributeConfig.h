...
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHFLOATATTRIBUTECONFIG_APPLY_OFFSET UNITYSDK_OFFSET(0x164252E0)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHFLOATATTRIBUTECONFIG_GETMULTIPLIERCURVENAME_OFFSET UNITYSDK_OFFSET(0x16425250)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHFLOATATTRIBUTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16425690)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int PlayableGraphFloatAttributeConfig_TypeDefinitionIndex = 53003;
