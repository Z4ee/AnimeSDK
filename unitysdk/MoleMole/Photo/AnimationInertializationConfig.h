...
#define MOLEMOLE_PHOTO_ANIMATIONINERTIALIZATIONCONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0x11D5C300)
#define MOLEMOLE_PHOTO_ANIMATIONINERTIALIZATIONCONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x11D5CEB0)
#define MOLEMOLE_PHOTO_ANIMATIONINERTIALIZATIONCONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0x11D5CEC0)
#define MOLEMOLE_PHOTO_ANIMATIONINERTIALIZATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x11D5D5D0)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int AnimationInertializationConfig_TypeDefinitionIndex = 76959;
