...
#define MOLEMOLE_PHOTO_PLAYABLEUPDATEPROCESSCONTEXTCONFIG_CREATEPLAYABLEBEHAVIOUR_OFFSET UNITYSDK_OFFSET(0x191B2570)
#define MOLEMOLE_PHOTO_PLAYABLEUPDATEPROCESSCONTEXTCONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x191B2560)
#define MOLEMOLE_PHOTO_PLAYABLEUPDATEPROCESSCONTEXTCONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0x191B2730)
#define MOLEMOLE_PHOTO_PLAYABLEUPDATEPROCESSCONTEXTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x191B27B0)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int PlayableUpdateProcessContextConfig_TypeDefinitionIndex = 43689;
