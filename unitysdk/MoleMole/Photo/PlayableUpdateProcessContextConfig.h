...
#define MOLEMOLE_PHOTO_PLAYABLEUPDATEPROCESSCONTEXTCONFIG_CREATEPLAYABLEBEHAVIOUR_OFFSET UNITYSDK_OFFSET(0x15E54860)
#define MOLEMOLE_PHOTO_PLAYABLEUPDATEPROCESSCONTEXTCONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x15E54850)
#define MOLEMOLE_PHOTO_PLAYABLEUPDATEPROCESSCONTEXTCONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0x15E54A20)
#define MOLEMOLE_PHOTO_PLAYABLEUPDATEPROCESSCONTEXTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x15E54AA0)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int PlayableUpdateProcessContextConfig_TypeDefinitionIndex = 56784;
