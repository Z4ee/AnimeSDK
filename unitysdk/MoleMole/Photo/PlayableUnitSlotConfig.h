...
#define MOLEMOLE_PHOTO_PLAYABLEUNITSLOTCONFIG_CREATEPLAYABLEUNIT_OFFSET UNITYSDK_OFFSET(0x180951E0)
#define MOLEMOLE_PHOTO_PLAYABLEUNITSLOTCONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x18095960)
#define MOLEMOLE_PHOTO_PLAYABLEUNITSLOTCONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0x18095980)
#define MOLEMOLE_PHOTO_PLAYABLEUNITSLOTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18095CE0)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int PlayableUnitSlotConfig_TypeDefinitionIndex = 42483;
