...
#define MOLEMOLE_PHOTO_TRANSLATIONRATIOCURVE_CREATE_OFFSET UNITYSDK_OFFSET(0x12FADB30)
#define MOLEMOLE_PHOTO_TRANSLATIONRATIOCURVE_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x12FAE240)
#define MOLEMOLE_PHOTO_TRANSLATIONRATIOCURVE_REQUEST_OFFSET UNITYSDK_OFFSET(0x12FAE250)
#define MOLEMOLE_PHOTO_TRANSLATIONRATIOCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x12FAE390)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int TranslationRatioCurve_TypeDefinitionIndex = 46422;
