...
#define MOLEMOLE_PHOTO_FRONTCAMERAPROCESSBLENDSPACEPOSECONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0x15854600)
#define MOLEMOLE_PHOTO_FRONTCAMERAPROCESSBLENDSPACEPOSECONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x158545F0)
#define MOLEMOLE_PHOTO_FRONTCAMERAPROCESSBLENDSPACEPOSECONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0x15854E50)
#define MOLEMOLE_PHOTO_FRONTCAMERAPROCESSBLENDSPACEPOSECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x15854FC0)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int FrontCameraProcessBlendSpacePoseConfig_TypeDefinitionIndex = 57821;
