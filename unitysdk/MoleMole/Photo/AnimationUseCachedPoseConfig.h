...
#define MOLEMOLE_PHOTO_ANIMATIONUSECACHEDPOSECONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0x10D7D830)
#define MOLEMOLE_PHOTO_ANIMATIONUSECACHEDPOSECONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x10D7D7E0)
#define MOLEMOLE_PHOTO_ANIMATIONUSECACHEDPOSECONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0x10D7E040)
#define MOLEMOLE_PHOTO_ANIMATIONUSECACHEDPOSECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x10D7E320)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int AnimationUseCachedPoseConfig_TypeDefinitionIndex = 58581;
