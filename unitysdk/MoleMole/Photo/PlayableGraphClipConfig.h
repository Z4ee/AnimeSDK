...
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHCLIPCONFIG_CREATE_OFFSET UNITYSDK_OFFSET(0x144FB560)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHCLIPCONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x144FB750)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHCLIPCONFIG_REQUEST_OFFSET UNITYSDK_OFFSET(0x144FB760)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHCLIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x144FB7E0)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int PlayableGraphClipConfig_TypeDefinitionIndex = 75510;
