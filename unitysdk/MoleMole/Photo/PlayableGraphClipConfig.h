...
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHCLIPCONFIG_CREATE_OFFSET UNITYSDK_OFFSET(0x18CF32C0)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHCLIPCONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x18CF34C0)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHCLIPCONFIG_REQUEST_OFFSET UNITYSDK_OFFSET(0x18CF34D0)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHCLIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CF3550)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int PlayableGraphClipConfig_TypeDefinitionIndex = 77674;
