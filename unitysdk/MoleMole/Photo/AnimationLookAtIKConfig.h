...
#define MOLEMOLE_PHOTO_ANIMATIONLOOKATIKCONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0x12BD82A0)
#define MOLEMOLE_PHOTO_ANIMATIONLOOKATIKCONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x12BD8290)
#define MOLEMOLE_PHOTO_ANIMATIONLOOKATIKCONFIG_INITEYES_OFFSET UNITYSDK_OFFSET(0x12BD9760)
#define MOLEMOLE_PHOTO_ANIMATIONLOOKATIKCONFIG_INITSOLVER_OFFSET UNITYSDK_OFFSET(0x12BD9980)
#define MOLEMOLE_PHOTO_ANIMATIONLOOKATIKCONFIG_INITSPINES_OFFSET UNITYSDK_OFFSET(0x12BD94A0)
#define MOLEMOLE_PHOTO_ANIMATIONLOOKATIKCONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0x12BD9B30)
#define MOLEMOLE_PHOTO_ANIMATIONLOOKATIKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x12BDA380)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int AnimationLookAtIKConfig_TypeDefinitionIndex = 77771;
