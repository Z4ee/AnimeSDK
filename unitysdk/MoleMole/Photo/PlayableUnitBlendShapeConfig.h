...
#define MOLEMOLE_PHOTO_PLAYABLEUNITBLENDSHAPECONFIG_BUILDPROPERTYHANDLES_OFFSET UNITYSDK_OFFSET(0x18CF4060)
#define MOLEMOLE_PHOTO_PLAYABLEUNITBLENDSHAPECONFIG_CREATEPLAYABLEUNIT_OFFSET UNITYSDK_OFFSET(0x18CF3570)
#define MOLEMOLE_PHOTO_PLAYABLEUNITBLENDSHAPECONFIG_GETBLENDSHAPEPARAMCOUNT_OFFSET UNITYSDK_OFFSET(0x18CF5110)
#define MOLEMOLE_PHOTO_PLAYABLEUNITBLENDSHAPECONFIG_GETSKINNEDMESHRENDERERS_OFFSET UNITYSDK_OFFSET(0x18CF4EA0)
#define MOLEMOLE_PHOTO_PLAYABLEUNITBLENDSHAPECONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x18CF3560)
#define MOLEMOLE_PHOTO_PLAYABLEUNITBLENDSHAPECONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0x18CF44E0)
#define MOLEMOLE_PHOTO_PLAYABLEUNITBLENDSHAPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CF5340)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int PlayableUnitBlendShapeConfig_TypeDefinitionIndex = 48814;
