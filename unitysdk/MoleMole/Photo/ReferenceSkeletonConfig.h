...
#define MOLEMOLE_PHOTO_REFERENCESKELETONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19986C40)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int ReferenceSkeletonConfig_TypeDefinitionIndex = 60695;
