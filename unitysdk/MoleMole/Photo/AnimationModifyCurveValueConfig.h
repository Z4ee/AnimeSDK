...
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVEVALUECONFIG_CREATE_OFFSET UNITYSDK_OFFSET(0x1264EFB0)
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVEVALUECONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x1264EE50)
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVEVALUECONFIG_GET_NAMES_OFFSET UNITYSDK_OFFSET(0x1264F800)
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVEVALUECONFIG_REQUEST_OFFSET UNITYSDK_OFFSET(0x1264F5C0)
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVEVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1264F930)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int AnimationModifyCurveValueConfig_TypeDefinitionIndex = 74665;
