...
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVEVALUECONFIG_CREATE_OFFSET UNITYSDK_OFFSET(0x13EAFA00)
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVEVALUECONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x13EAF8A0)
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVEVALUECONFIG_GET_NAMES_OFFSET UNITYSDK_OFFSET(0x13EB0250)
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVEVALUECONFIG_REQUEST_OFFSET UNITYSDK_OFFSET(0x13EB0010)
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVEVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x13EB0380)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int AnimationModifyCurveValueConfig_TypeDefinitionIndex = 71046;
