...
#define MOLEMOLE_PHOTO_SCOPEDFRONTCAMERACONTROLEMOTIONCONFIG_CREATE_OFFSET UNITYSDK_OFFSET(0x10D7E380)
#define MOLEMOLE_PHOTO_SCOPEDFRONTCAMERACONTROLEMOTIONCONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x10D7E9F0)
#define MOLEMOLE_PHOTO_SCOPEDFRONTCAMERACONTROLEMOTIONCONFIG_REQUEST_OFFSET UNITYSDK_OFFSET(0x10D7EA60)
#define MOLEMOLE_PHOTO_SCOPEDFRONTCAMERACONTROLEMOTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x10D7F1A0)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int ScopedFrontCameraControlEmotionConfig_TypeDefinitionIndex = 77531;
