...
#define MOLEMOLE_PHOTO_ANIMATIONAPPLYDYNAMICADDITIVECONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0x1177FC20)
#define MOLEMOLE_PHOTO_ANIMATIONAPPLYDYNAMICADDITIVECONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x11780030)
#define MOLEMOLE_PHOTO_ANIMATIONAPPLYDYNAMICADDITIVECONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0x11780040)
#define MOLEMOLE_PHOTO_ANIMATIONAPPLYDYNAMICADDITIVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x11780110)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int AnimationApplyDynamicAdditiveConfig_TypeDefinitionIndex = 51292;
