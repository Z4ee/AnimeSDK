...
#define MOLEMOLE_PHOTO_ANIMATIONAPPLYDYNAMICADDITIVECONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0x173FA890)
#define MOLEMOLE_PHOTO_ANIMATIONAPPLYDYNAMICADDITIVECONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x173FACA0)
#define MOLEMOLE_PHOTO_ANIMATIONAPPLYDYNAMICADDITIVECONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0x173FACB0)
#define MOLEMOLE_PHOTO_ANIMATIONAPPLYDYNAMICADDITIVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x173FAD80)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int AnimationApplyDynamicAdditiveConfig_TypeDefinitionIndex = 72391;
