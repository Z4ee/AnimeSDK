...
#define MOLEMOLE_PHOTO_MESHSPACEMOTIONCURVE_CREATE_OFFSET UNITYSDK_OFFSET(0x179293B0)
#define MOLEMOLE_PHOTO_MESHSPACEMOTIONCURVE_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x17929FF0)
#define MOLEMOLE_PHOTO_MESHSPACEMOTIONCURVE_REQUEST_OFFSET UNITYSDK_OFFSET(0x1792A050)
#define MOLEMOLE_PHOTO_MESHSPACEMOTIONCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1792A190)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int MeshSpaceMotionCurve_TypeDefinitionIndex = 89048;
