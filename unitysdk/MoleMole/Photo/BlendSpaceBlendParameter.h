...
#define MOLEMOLE_PHOTO_BLENDSPACEBLENDPARAMETER_GETNORMALIZED_OFFSET UNITYSDK_OFFSET(0x76E390)
#define MOLEMOLE_PHOTO_BLENDSPACEBLENDPARAMETER_GETUNCLAMPNORMALIZED_OFFSET UNITYSDK_OFFSET(0x76E3A0)
#define MOLEMOLE_PHOTO_BLENDSPACEBLENDPARAMETER_GET_MIN_OFFSET UNITYSDK_OFFSET(0x76E560)
#define MOLEMOLE_PHOTO_BLENDSPACEBLENDPARAMETER_GET_RANGE_OFFSET UNITYSDK_OFFSET(0x76E570)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int BlendSpaceBlendParameter_TypeDefinitionIndex = 39843;
