...
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVEVALUECONFIG___C_METHOD_1_990263BC0BE1F726_OFFSET UNITYSDK_OFFSET(0x173FAE20)
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVEVALUECONFIG___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x173FADD0)
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVEVALUECONFIG___C__CTOR_OFFSET UNITYSDK_OFFSET(0x173FAE10)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int AnimationModifyCurveValueConfig___c_TypeDefinitionIndex = 74666;
	...
	public:
		...
		{
			return (::System::Func_2<::MoleMole::Photo::AnimationModifyCurveValueItem*, ::Foundation::Unreal::FName>**)Il2CppClass::FromTypeDefinitionIndex(AnimationModifyCurveValueConfig___c_TypeDefinitionIndex)->GetStaticField(0x30880);
		}
		static ::MoleMole::Photo::AnimationModifyCurveValueConfig___c** StaticGet___9()
		{
			return (::MoleMole::Photo::AnimationModifyCurveValueConfig___c**)Il2CppClass::FromTypeDefinitionIndex(AnimationModifyCurveValueConfig___c_TypeDefinitionIndex)->GetStaticField(0x30888);
		}
