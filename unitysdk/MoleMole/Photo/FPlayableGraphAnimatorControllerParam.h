...
#define MOLEMOLE_PHOTO_FPLAYABLEGRAPHANIMATORCONTROLLERPARAM_CHECKBOOL_OFFSET UNITYSDK_OFFSET(0x7CF8C0)
#define MOLEMOLE_PHOTO_FPLAYABLEGRAPHANIMATORCONTROLLERPARAM_CHECKFLOAT_OFFSET UNITYSDK_OFFSET(0x7CF6A0)
#define MOLEMOLE_PHOTO_FPLAYABLEGRAPHANIMATORCONTROLLERPARAM_CHECKINTEGER_OFFSET UNITYSDK_OFFSET(0x7CF7B0)
#define MOLEMOLE_PHOTO_FPLAYABLEGRAPHANIMATORCONTROLLERPARAM_CHECKTRIGGER_OFFSET UNITYSDK_OFFSET(0x7CF9D0)
#define MOLEMOLE_PHOTO_FPLAYABLEGRAPHANIMATORCONTROLLERPARAM_CHECK_OFFSET UNITYSDK_OFFSET(0x7CF5A0)
#define MOLEMOLE_PHOTO_FPLAYABLEGRAPHANIMATORCONTROLLERPARAM_GETBOOL_OFFSET UNITYSDK_OFFSET(0x7CF9A0)
#define MOLEMOLE_PHOTO_FPLAYABLEGRAPHANIMATORCONTROLLERPARAM_GETFLOAT_OFFSET UNITYSDK_OFFSET(0x7CF780)
#define MOLEMOLE_PHOTO_FPLAYABLEGRAPHANIMATORCONTROLLERPARAM_GETINTEGER_OFFSET UNITYSDK_OFFSET(0x7CF890)
#define MOLEMOLE_PHOTO_FPLAYABLEGRAPHANIMATORCONTROLLERPARAM_GETTRIGGER_OFFSET UNITYSDK_OFFSET(0x7CFAB0)
#define MOLEMOLE_PHOTO_FPLAYABLEGRAPHANIMATORCONTROLLERPARAM_GET_OFFSET UNITYSDK_OFFSET(0x7CF680)
#define MOLEMOLE_PHOTO_FPLAYABLEGRAPHANIMATORCONTROLLERPARAM_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x2A99F0)
#define MOLEMOLE_PHOTO_FPLAYABLEGRAPHANIMATORCONTROLLERPARAM_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x7CFB20)
#define MOLEMOLE_PHOTO_FPLAYABLEGRAPHANIMATORCONTROLLERPARAM_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x7CFAE0)
#define MOLEMOLE_PHOTO_FPLAYABLEGRAPHANIMATORCONTROLLERPARAM_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x141A2C90)
#define MOLEMOLE_PHOTO_FPLAYABLEGRAPHANIMATORCONTROLLERPARAM_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x7CF540)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int FPlayableGraphAnimatorControllerParam_TypeDefinitionIndex = 54835;
