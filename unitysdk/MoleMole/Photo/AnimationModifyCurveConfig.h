...
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVECONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0x1081E6F0)
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVECONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x1081E6D0)
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVECONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0x1081EF60)
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1081F230)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int AnimationModifyCurveConfig_TypeDefinitionIndex = 85767;
