...
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVECONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0x141A18E0)
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVECONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x141A18C0)
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVECONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0x141A2150)
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x141A2400)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int AnimationModifyCurveConfig_TypeDefinitionIndex = 43622;
