...
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHANIMATORCONTROLLERCONFIG_CREATE_OFFSET UNITYSDK_OFFSET(0x16065120)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHANIMATORCONTROLLERCONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x160653B0)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHANIMATORCONTROLLERCONFIG_REQUEST_OFFSET UNITYSDK_OFFSET(0x160653C0)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHANIMATORCONTROLLERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16065440)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int PlayableGraphAnimatorControllerConfig_TypeDefinitionIndex = 45213;
