...
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHANIMATORCONTROLLERCONFIG_CREATE_OFFSET UNITYSDK_OFFSET(0x12BDA430)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHANIMATORCONTROLLERCONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x12BDA6C0)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHANIMATORCONTROLLERCONFIG_REQUEST_OFFSET UNITYSDK_OFFSET(0x12BDA6D0)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHANIMATORCONTROLLERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x12BDA750)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int PlayableGraphAnimatorControllerConfig_TypeDefinitionIndex = 44970;
