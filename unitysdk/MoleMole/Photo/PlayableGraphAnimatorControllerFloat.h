...
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHANIMATORCONTROLLERFLOAT_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0x136E9610)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHANIMATORCONTROLLERFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x136E96B0)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int PlayableGraphAnimatorControllerFloat_TypeDefinitionIndex = 73898;
