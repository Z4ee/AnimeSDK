...
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_CREATE_OFFSET UNITYSDK_OFFSET(0x1997DEF0)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x19980880)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE01_OFFSET UNITYSDK_OFFSET(0x19983480)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE02_OFFSET UNITYSDK_OFFSET(0x19983490)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE03_OFFSET UNITYSDK_OFFSET(0x199834A0)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE04_OFFSET UNITYSDK_OFFSET(0x199834B0)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE05_OFFSET UNITYSDK_OFFSET(0x199834C0)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE06_OFFSET UNITYSDK_OFFSET(0x199834D0)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE07_OFFSET UNITYSDK_OFFSET(0x199834E0)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE08_OFFSET UNITYSDK_OFFSET(0x199834F0)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE09_OFFSET UNITYSDK_OFFSET(0x19983500)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE10_OFFSET UNITYSDK_OFFSET(0x19983510)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE11_OFFSET UNITYSDK_OFFSET(0x19983520)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE12_OFFSET UNITYSDK_OFFSET(0x19983530)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE13_OFFSET UNITYSDK_OFFSET(0x19983540)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE14_OFFSET UNITYSDK_OFFSET(0x19983550)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE15_OFFSET UNITYSDK_OFFSET(0x19983560)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE16_OFFSET UNITYSDK_OFFSET(0x19983570)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE17_OFFSET UNITYSDK_OFFSET(0x19983580)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE18_OFFSET UNITYSDK_OFFSET(0x19983590)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_REQUEST_OFFSET UNITYSDK_OFFSET(0x19980AC0)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x199835A0)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int FrontCameraAnimationGraphConfig_TypeDefinitionIndex = 73072;
