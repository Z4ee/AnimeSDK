...
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_CREATE_OFFSET UNITYSDK_OFFSET(0x12B0BE50)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x12B0E720)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE01_OFFSET UNITYSDK_OFFSET(0x12B113B0)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE02_OFFSET UNITYSDK_OFFSET(0x12B113C0)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE03_OFFSET UNITYSDK_OFFSET(0x12B113D0)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE04_OFFSET UNITYSDK_OFFSET(0x12B113E0)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE05_OFFSET UNITYSDK_OFFSET(0x12B113F0)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE06_OFFSET UNITYSDK_OFFSET(0x12B11400)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE07_OFFSET UNITYSDK_OFFSET(0x12B11410)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE08_OFFSET UNITYSDK_OFFSET(0x12B11420)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE09_OFFSET UNITYSDK_OFFSET(0x12B11430)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE10_OFFSET UNITYSDK_OFFSET(0x12B11440)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE11_OFFSET UNITYSDK_OFFSET(0x12B11450)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE12_OFFSET UNITYSDK_OFFSET(0x12B11460)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE13_OFFSET UNITYSDK_OFFSET(0x12B11470)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE14_OFFSET UNITYSDK_OFFSET(0x12B11480)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE15_OFFSET UNITYSDK_OFFSET(0x12B11490)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE16_OFFSET UNITYSDK_OFFSET(0x12B114A0)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE17_OFFSET UNITYSDK_OFFSET(0x12B114B0)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE18_OFFSET UNITYSDK_OFFSET(0x12B114C0)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_REQUEST_OFFSET UNITYSDK_OFFSET(0x12B0E960)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x12B114D0)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int FrontCameraAnimationGraphConfig_TypeDefinitionIndex = 80895;
