...
#define MOLEMOLE_PHOTO_ANIMATIONSELECTBYSLOTSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x13EB0390)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int AnimationSelectBySlotStateConfig_TypeDefinitionIndex = 71802;
