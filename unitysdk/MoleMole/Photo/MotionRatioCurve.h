...
#include "unitysdk/Struct_2_9C50B3E290ECAADB.h"
...
#define MOLEMOLE_PHOTO_MOTIONRATIOCURVE_CREATE_OFFSET UNITYSDK_OFFSET(0x12367430)
#define MOLEMOLE_PHOTO_MOTIONRATIOCURVE_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x12367E10)
#define MOLEMOLE_PHOTO_MOTIONRATIOCURVE_REQUEST_OFFSET UNITYSDK_OFFSET(0x12367E70)
#define MOLEMOLE_PHOTO_MOTIONRATIOCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x12367FF0)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int MotionRatioCurve_TypeDefinitionIndex = 50566;
	...
	public:
		...
		::Struct_2_9C50B3E290ECAADB Create(::UnityEngine::Playables::PlayableGraph a1, ::UnityEngine::Animator* a2, ::Struct_2_ACD0EF80A5330786& a3, ::Foundation::NativeMemory* a4, ::System::ReadOnlySpan_1<::Foundation::NativeMemoryRequestHandle> a5)
		{
			return ((::Struct_2_9C50B3E290ECAADB(*)(::PVOID, ::UnityEngine::Playables::PlayableGraph, ::UnityEngine::Animator*, ::Struct_2_ACD0EF80A5330786&, ::Foundation::NativeMemory*, ::System::ReadOnlySpan_1<::Foundation::NativeMemoryRequestHandle>))((::PBYTE)hIl2Cpp + MOLEMOLE_PHOTO_MOTIONRATIOCURVE_CREATE_OFFSET))(this, a1, a2, a3, a4, a5);
		}
