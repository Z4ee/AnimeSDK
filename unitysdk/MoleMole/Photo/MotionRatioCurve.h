...
#define MOLEMOLE_PHOTO_MOTIONRATIOCURVE_CREATE_OFFSET UNITYSDK_OFFSET(0x13F1CFD0)
#define MOLEMOLE_PHOTO_MOTIONRATIOCURVE_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x13F1D9B0)
#define MOLEMOLE_PHOTO_MOTIONRATIOCURVE_REQUEST_OFFSET UNITYSDK_OFFSET(0x13F1DA10)
#define MOLEMOLE_PHOTO_MOTIONRATIOCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x13F1DB90)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int MotionRatioCurve_TypeDefinitionIndex = 72632;
