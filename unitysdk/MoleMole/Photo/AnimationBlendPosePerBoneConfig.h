...
#define MOLEMOLE_PHOTO_ANIMATIONBLENDPOSEPERBONECONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0x136E6E30)
#define MOLEMOLE_PHOTO_ANIMATIONBLENDPOSEPERBONECONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x136E7CE0)
#define MOLEMOLE_PHOTO_ANIMATIONBLENDPOSEPERBONECONFIG_INITIALIZEWEIGHT_OFFSET UNITYSDK_OFFSET(0x136E8000)
#define MOLEMOLE_PHOTO_ANIMATIONBLENDPOSEPERBONECONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0x136E7CF0)
#define MOLEMOLE_PHOTO_ANIMATIONBLENDPOSEPERBONECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x136E8780)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int AnimationBlendPosePerBoneConfig_TypeDefinitionIndex = 47217;
