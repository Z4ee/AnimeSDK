...
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHANIMATORCONTROLLERBOOL_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0x10BE5DE0)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHANIMATORCONTROLLERBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x10BE5EC0)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int PlayableGraphAnimatorControllerBool_TypeDefinitionIndex = 54529;
