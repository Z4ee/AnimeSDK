...
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHANIMATORCONTROLLERBOOL_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0x1792A2F0)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHANIMATORCONTROLLERBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1792A3D0)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int PlayableGraphAnimatorControllerBool_TypeDefinitionIndex = 56067;
