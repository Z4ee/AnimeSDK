...
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_BINDNEWNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x15EAB500)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_CHANGENEWBADGETYPE_OFFSET UNITYSDK_OFFSET(0x15EAB1F0)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_CHANGEREDDOTBADGETYPE_OFFSET UNITYSDK_OFFSET(0x15EAB180)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_GETBATTLEINFONAME_OFFSET UNITYSDK_OFFSET(0x15EAAEB0)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_GETNOTIFICATIONBADGE_OFFSET UNITYSDK_OFFSET(0x15EAB570)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_GETSETTINGTYPE_OFFSET UNITYSDK_OFFSET(0x15EAB0D0)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_GETUITABBUTTON_OFFSET UNITYSDK_OFFSET(0x15EAB120)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15EAA9F0)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15EAAA80)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15EAAB00)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_REGISTERNEWSUBNOTIFY_OFFSET UNITYSDK_OFFSET(0x15EAB2F0)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_REGISTERREDDOTSUBNOTIFY_OFFSET UNITYSDK_OFFSET(0x15EAB260)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_SETSELECTED_OFFSET UNITYSDK_OFFSET(0x15EAB5D0)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_SETSETTINGTYPE_OFFSET UNITYSDK_OFFSET(0x15EAACE0)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_SETTEXTMAPKEY_OFFSET UNITYSDK_OFFSET(0x15EAAC50)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_SETTEXT_OFFSET UNITYSDK_OFFSET(0x15EAABE0)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_SETUPNEWNOTIFICATIONBADGE_OFFSET UNITYSDK_OFFSET(0x15EAB440)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_SETUPNOTIFICATIONBADGE_OFFSET UNITYSDK_OFFSET(0x15EAB380)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15EAB620)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15EAB680)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15EAB710)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15EAB7A0)

namespace MoleMole
{
	inline static constexpr unsigned int UITabBtn03RowAllRoundWidgetController_TypeDefinitionIndex = 45317;
