...
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_INITPARENTCONTROLLER_OFFSET UNITYSDK_OFFSET(0x160C6900)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONCLICKRECENTCONNECTTAB_OFFSET UNITYSDK_OFFSET(0x160C6440)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONCLICKRECOMMENDFRIENDTAB_OFFSET UNITYSDK_OFFSET(0x160C6340)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x160C6540)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x160C6800)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONRECEIVEPLAYERLIST_OFFSET UNITYSDK_OFFSET(0x160C6A10)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONRECEIVERECENTPLAYERLIST_OFFSET UNITYSDK_OFFSET(0x160C7190)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONRECEIVERECOMMENDFRIENDLIST_OFFSET UNITYSDK_OFFSET(0x160C7200)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x160C65D0)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x160C6880)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x160C5D20)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_TRIGGERRECOMMENDMORE_OFFSET UNITYSDK_OFFSET(0x160C6950)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x160C7270)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER__ONSHOW_B__7_0_OFFSET UNITYSDK_OFFSET(0x160C73B0)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER__ONUIINIT_B__3_0_OFFSET UNITYSDK_OFFSET(0x160C72D0)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER__ONUIINIT_B__3_1_OFFSET UNITYSDK_OFFSET(0x160C72E0)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER__ONUIINIT_B__3_2_OFFSET UNITYSDK_OFFSET(0x160C72F0)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER__ONUIINIT_B__3_3_OFFSET UNITYSDK_OFFSET(0x160C7350)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x160C7410)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x160C74A0)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x160C7530)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x160C75D0)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x160C7660)

namespace MoleMole
{
	inline static constexpr unsigned int UIRecentPlayerWidgetController_TypeDefinitionIndex = 43286;
