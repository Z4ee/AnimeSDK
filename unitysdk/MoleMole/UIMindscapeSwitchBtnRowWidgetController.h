...
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17AF33A0)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_ONTABCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x17AF32A0)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17AF3D30)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17AF3170)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17AF3330)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_SETAVATARCOLOR_OFFSET UNITYSDK_OFFSET(0x17AF37E0)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_SETAVATARID_OFFSET UNITYSDK_OFFSET(0x17AF34D0)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_SETCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x17AF3430)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_SETTABINDEX_OFFSET UNITYSDK_OFFSET(0x17AF3480)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_SETTABSTATE_OFFSET UNITYSDK_OFFSET(0x17AF3A30)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17AF3DB0)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17AF3E10)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17AF3EA0)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17AF3F30)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17AF3FC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMindscapeSwitchBtnRowWidgetController_TypeDefinitionIndex = 59549;
