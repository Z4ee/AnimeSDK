...
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16649700)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER___C__DISPLAYCLASS12_0__SETDATA_B__0_OFFSET UNITYSDK_OFFSET(0x16649710)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER___C__DISPLAYCLASS12_0__SETDATA_B__1_OFFSET UNITYSDK_OFFSET(0x16649790)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastSettlementPageController___c__DisplayClass12_0_TypeDefinitionIndex = 57241;
