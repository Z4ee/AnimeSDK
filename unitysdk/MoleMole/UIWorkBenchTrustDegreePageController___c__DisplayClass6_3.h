...
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER___C__DISPLAYCLASS6_3__CTOR_OFFSET UNITYSDK_OFFSET(0x12C9BB10)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER___C__DISPLAYCLASS6_3__ONUIOPEN_B__5_OFFSET UNITYSDK_OFFSET(0x12C9BB20)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkBenchTrustDegreePageController___c__DisplayClass6_3_TypeDefinitionIndex = 50978;
