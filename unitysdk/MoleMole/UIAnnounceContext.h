...
#define MOLEMOLE_UIANNOUNCECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x19763E10)

namespace MoleMole
{
	inline static constexpr unsigned int UIAnnounceContext_TypeDefinitionIndex = 82521;
