...
#define MOLEMOLE_UITRENDYSTOREWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x165553B0)

namespace MoleMole
{
	inline static constexpr unsigned int UITrendyStoreWidgetContext_TypeDefinitionIndex = 60629;
