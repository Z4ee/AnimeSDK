...
#define MOLEMOLE_UIABCOLLECTCAMPINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x197A4DB0)
#define MOLEMOLE_UIABCOLLECTCAMPINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x197A4E40)
#define MOLEMOLE_UIABCOLLECTCAMPINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x197A4CE0)
#define MOLEMOLE_UIABCOLLECTCAMPINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x197A4D40)
#define MOLEMOLE_UIABCOLLECTCAMPINFOWIDGETCONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0x197A4EF0)
#define MOLEMOLE_UIABCOLLECTCAMPINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x197A51F0)
#define MOLEMOLE_UIABCOLLECTCAMPINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x197A52D0)
#define MOLEMOLE_UIABCOLLECTCAMPINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x197A5360)
#define MOLEMOLE_UIABCOLLECTCAMPINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x197A53F0)
#define MOLEMOLE_UIABCOLLECTCAMPINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x197A5480)

namespace MoleMole
{
	inline static constexpr unsigned int UIABCollectCampInfoWidgetController_TypeDefinitionIndex = 86774;

	class UIABCollectCampInfoWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_3E1A0459A6647B99_12* _view; // 0x2C0
