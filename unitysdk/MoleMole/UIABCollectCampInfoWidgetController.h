...
#define MOLEMOLE_UIABCOLLECTCAMPINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12FD3770)
#define MOLEMOLE_UIABCOLLECTCAMPINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12FD3800)
#define MOLEMOLE_UIABCOLLECTCAMPINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12FD36A0)
#define MOLEMOLE_UIABCOLLECTCAMPINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12FD3700)
#define MOLEMOLE_UIABCOLLECTCAMPINFOWIDGETCONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0x12FD38B0)
#define MOLEMOLE_UIABCOLLECTCAMPINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12FD3B30)
#define MOLEMOLE_UIABCOLLECTCAMPINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12FD3C10)
#define MOLEMOLE_UIABCOLLECTCAMPINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12FD3CA0)
#define MOLEMOLE_UIABCOLLECTCAMPINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12FD3D30)
#define MOLEMOLE_UIABCOLLECTCAMPINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12FD3DC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIABCollectCampInfoWidgetController_TypeDefinitionIndex = 55168;

	class UIABCollectCampInfoWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_3E1A0459A6647B99_8* _view; // 0x2B8
		::System::Collections::Generic::List_1<::MoleMole::UIAutoBattlePVPCollectBangbooRowWidgetController*>* _bangbooCtrls; // 0x2C0
		::System::Action_1<::System::Int32>* JumpToBangbooTab; // 0x2C8
