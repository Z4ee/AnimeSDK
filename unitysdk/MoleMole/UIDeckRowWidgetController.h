...
#define MOLEMOLE_UIDECKROWWIDGETCONTROLLER_CANBEUPBYREWARDBUFF_OFFSET UNITYSDK_OFFSET(0x16487C30)
#define MOLEMOLE_UIDECKROWWIDGETCONTROLLER_GETCARDID_OFFSET UNITYSDK_OFFSET(0x16487510)
#define MOLEMOLE_UIDECKROWWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x16486F80)
#define MOLEMOLE_UIDECKROWWIDGETCONTROLLER_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x164879B0)
#define MOLEMOLE_UIDECKROWWIDGETCONTROLLER_ONCONTROLLERCLICK_OFFSET UNITYSDK_OFFSET(0x16487A00)
#define MOLEMOLE_UIDECKROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x164872B0)
#define MOLEMOLE_UIDECKROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x164873C0)
#define MOLEMOLE_UIDECKROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16487340)
#define MOLEMOLE_UIDECKROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16486F10)
#define MOLEMOLE_UIDECKROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16487240)
#define MOLEMOLE_UIDECKROWWIDGETCONTROLLER_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0x16487A90)
#define MOLEMOLE_UIDECKROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x16487710)
#define MOLEMOLE_UIDECKROWWIDGETCONTROLLER_SAMPLEANIMATION_OFFSET UNITYSDK_OFFSET(0x16487B40)
#define MOLEMOLE_UIDECKROWWIDGETCONTROLLER_SETCARDCLICKFUNC_OFFSET UNITYSDK_OFFSET(0x16487960)
#define MOLEMOLE_UIDECKROWWIDGETCONTROLLER_SETREWARDBUFFICON_OFFSET UNITYSDK_OFFSET(0x16487BC0)
#define MOLEMOLE_UIDECKROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16487CC0)
#define MOLEMOLE_UIDECKROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16487CD0)
#define MOLEMOLE_UIDECKROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16487D60)
#define MOLEMOLE_UIDECKROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16487E00)
#define MOLEMOLE_UIDECKROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16487E90)
#define MOLEMOLE_UIDECKROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16487F20)

namespace MoleMole
{
	inline static constexpr unsigned int UIDeckRowWidgetController_TypeDefinitionIndex = 54534;

	class UIDeckRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_58619A0893665D06_1* _view; // 0x2E8
		::Struct_2_B00164FCF88F89F6 viewData; // 0x2F0
		::MoleMole::UIDailyChallengeCardRowWidgetController* controller; // 0x300
		::System::Int32 cardId; // 0x308
		::System::Action_1<::System::Int32>* onClick; // 0x310
