...
#define MOLEMOLE_UIDEVFLOWERARRANGEMENTROWWIDGETCONTROLLER_DATA_GET_FLOWERFEATUREDATA_OFFSET UNITYSDK_OFFSET(0x149B68C0)
#define MOLEMOLE_UIDEVFLOWERARRANGEMENTROWWIDGETCONTROLLER_DATA_SET_FLOWERFEATUREDATA_OFFSET UNITYSDK_OFFSET(0x149B68D0)
#define MOLEMOLE_UIDEVFLOWERARRANGEMENTROWWIDGETCONTROLLER_DATA__CTOR_OFFSET UNITYSDK_OFFSET(0x149B68E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIDevFlowerArrangementRowWidgetController_Data_TypeDefinitionIndex = 71681;
