...
#define MOLEMOLE_UIINTERKNOTV3PAGECONTEXT_MISSIONFOCUSITEMSTYLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x189EC720)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTEXT_MISSIONFOCUSITEMSTYLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8843B0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTEXT_MISSIONFOCUSITEMSTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x8843A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotV3PageContext_MissionFocusItemStyle_TypeDefinitionIndex = 64618;

	struct alignas(4) UIInterKnotV3PageContext_MissionFocusItemStyle
	{
		static ::System::Char* StaticGet_SplitContextJumpArg()
		{
			return (::System::Char*)Il2CppClass::FromTypeDefinitionIndex(UIInterKnotV3PageContext_MissionFocusItemStyle_TypeDefinitionIndex)->GetStaticField(0x121C0);
		}
