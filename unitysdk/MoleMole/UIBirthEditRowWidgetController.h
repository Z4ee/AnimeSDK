...
#define MOLEMOLE_UIBIRTHEDITROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17F58990)
#define MOLEMOLE_UIBIRTHEDITROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17F58AA0)
#define MOLEMOLE_UIBIRTHEDITROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17F58A20)
#define MOLEMOLE_UIBIRTHEDITROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17F58930)
#define MOLEMOLE_UIBIRTHEDITROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17F58B50)
#define MOLEMOLE_UIBIRTHEDITROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17F58B60)
#define MOLEMOLE_UIBIRTHEDITROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17F58BF0)
#define MOLEMOLE_UIBIRTHEDITROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17F58C90)
#define MOLEMOLE_UIBIRTHEDITROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17F58D20)

namespace MoleMole
{
	inline static constexpr unsigned int UIBirthEditRowWidgetController_TypeDefinitionIndex = 61044;

	class UIBirthEditRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_7382653E970C5F93_2* _view; // 0x2F0
