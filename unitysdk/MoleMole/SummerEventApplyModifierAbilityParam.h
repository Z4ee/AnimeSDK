...
#define MOLEMOLE_SUMMEREVENTAPPLYMODIFIERABILITYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x13ADC730)

namespace MoleMole
{
	inline static constexpr unsigned int SummerEventApplyModifierAbilityParam_TypeDefinitionIndex = 55197;
