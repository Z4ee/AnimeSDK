...
#define MOLEMOLE_IKUTIL_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1737DE60)
#define MOLEMOLE_IKUTIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1737DFF0)

namespace MoleMole
{
	inline static constexpr unsigned int IKUtil_TypeDefinitionIndex = 86101;
