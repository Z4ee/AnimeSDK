...
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1781DC00)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1781DAF0)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1781DB80)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1781DA20)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1781DA80)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_REFRESHATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1781E600)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_REFRESHDESC_OFFSET UNITYSDK_OFFSET(0x1781E920)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0x1781E130)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_REFRESHTITLE_OFFSET UNITYSDK_OFFSET(0x1781DE30)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x1781E590)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_SETFOLD_OFFSET UNITYSDK_OFFSET(0x1781EC20)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1781F050)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER__REFRESHINFO_B__7_0_OFFSET UNITYSDK_OFFSET(0x1781F1F0)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER__REFRESHINFO_B__7_1_OFFSET UNITYSDK_OFFSET(0x1781F270)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1781F280)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1781F310)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1781F3A0)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1781F430)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseBangbooSkillRowWidgetController_TypeDefinitionIndex = 41730;

	class UIInLevelPauseBangbooSkillRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_94D5884806027679* _view; // 0x2C0
		::System::Boolean isFold; // 0x2C8
		::Class_1_893417714B2AA846* buddyData; // 0x2D0
		...
		::System::Collections::Generic::List_1<::Class_1_945ACFB1FEBC7A2C*>* cur_ls; // 0x300
