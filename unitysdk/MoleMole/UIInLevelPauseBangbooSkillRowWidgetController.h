...
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_CLEAR_OFFSET UNITYSDK_OFFSET(0x17C0A250)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17C0A140)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17C0A1D0)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17C0A070)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17C0A0D0)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_REFRESHATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x17C0AC50)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_REFRESHDESC_OFFSET UNITYSDK_OFFSET(0x17C0AF70)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0x17C0A780)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_REFRESHTITLE_OFFSET UNITYSDK_OFFSET(0x17C0A480)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x17C0ABE0)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_SETFOLD_OFFSET UNITYSDK_OFFSET(0x17C0B300)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17C0B710)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER__REFRESHINFO_B__7_0_OFFSET UNITYSDK_OFFSET(0x17C0B8B0)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER__REFRESHINFO_B__7_1_OFFSET UNITYSDK_OFFSET(0x17C0B930)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17C0B940)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17C0B9D0)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17C0BA60)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17C0BAF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseBangbooSkillRowWidgetController_TypeDefinitionIndex = 87552;

	class UIInLevelPauseBangbooSkillRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_94D5884806027679_4* _view; // 0x2C0
		::System::Boolean isFold; // 0x2C8
		::Class_1_39AB0B931DA10399* buddyData; // 0x2D0
		::Enum_3_9FBDB47166F97B2B skillType; // 0x2D8
		::Class_1_6D3ECB4C39924DFD* skillInfo; // 0x2E0
		::System::Boolean isBattleBuddy; // 0x2E8
		::System::Boolean isShowingAttribute; // 0x2E9
		::System::Collections::Generic::List_1<::MoleMole::UIRoleSkillInfoRowChildWindowController*>* _infoItemCtrlList; // 0x2F0
		::System::Collections::Generic::List_1<::MoleMole::UIRoleSkillAttributeRowChildWindowController*>* _attributeCtrlList; // 0x2F8
		::System::Collections::Generic::List_1<::Class_1_945ACFB1FEBC7A2C_1*>* cur_ls; // 0x300
		...
		::System::Void RefreshInfo(::Enum_3_9FBDB47166F97B2B type, ::System::Int32 buddyID, ::Class_1_39AB0B931DA10399* buddyData, ::System::Boolean isBattleBuddy)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_9FBDB47166F97B2B, ::System::Int32, ::Class_1_39AB0B931DA10399*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_REFRESHINFO_OFFSET))(this, type, buddyID, buddyData, isBattleBuddy);
		}
