...
#define MOLEMOLE_UICOMICPAGECONTROLLER_COMICPAGEDELAYACTION_RESET_OFFSET UNITYSDK_OFFSET(0x16EF6170)
#define MOLEMOLE_UICOMICPAGECONTROLLER_COMICPAGEDELAYACTION_TRIGGERED_OFFSET UNITYSDK_OFFSET(0x16EF6250)
#define MOLEMOLE_UICOMICPAGECONTROLLER_COMICPAGEDELAYACTION_UPDATE_OFFSET UNITYSDK_OFFSET(0x16EF61D0)
#define MOLEMOLE_UICOMICPAGECONTROLLER_COMICPAGEDELAYACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16EF6290)

namespace MoleMole
{
	inline static constexpr unsigned int UIComicPageController_ComicPageDelayAction_TypeDefinitionIndex = 46632;
