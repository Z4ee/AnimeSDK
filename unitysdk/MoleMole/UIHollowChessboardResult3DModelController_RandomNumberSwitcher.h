...
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_RANDOMNUMBERSWITCHER_GENERATEDIFFERENTRANDOM_OFFSET UNITYSDK_OFFSET(0x17DB5E60)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_RANDOMNUMBERSWITCHER_GETRANDOMHUEANDSATURATIONGROUP_OFFSET UNITYSDK_OFFSET(0x17DB6030)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_RANDOMNUMBERSWITCHER_SWITCHRANDOMNUMBER_OFFSET UNITYSDK_OFFSET(0x17DB5EE0)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_RANDOMNUMBERSWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x17DB6110)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowChessboardResult3DModelController_RandomNumberSwitcher_TypeDefinitionIndex = 49222;
