...
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_RANDOMNUMBERSWITCHER_GENERATEDIFFERENTRANDOM_OFFSET UNITYSDK_OFFSET(0x16977140)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_RANDOMNUMBERSWITCHER_GETRANDOMHUEANDSATURATIONGROUP_OFFSET UNITYSDK_OFFSET(0x16977310)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_RANDOMNUMBERSWITCHER_SWITCHRANDOMNUMBER_OFFSET UNITYSDK_OFFSET(0x169771C0)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_RANDOMNUMBERSWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x169773F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowChessboardResult3DModelController_RandomNumberSwitcher_TypeDefinitionIndex = 70490;
