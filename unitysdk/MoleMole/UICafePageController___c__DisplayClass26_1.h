...
#define MOLEMOLE_UICAFEPAGECONTROLLER___C__DISPLAYCLASS26_1__CTOR_OFFSET UNITYSDK_OFFSET(0x18C9A0B0)
#define MOLEMOLE_UICAFEPAGECONTROLLER___C__DISPLAYCLASS26_1__ONSHOWDRINKCAFEFINISHED_B__2_OFFSET UNITYSDK_OFFSET(0x18C9A0C0)
#define MOLEMOLE_UICAFEPAGECONTROLLER___C__DISPLAYCLASS26_1__ONSHOWDRINKCAFEFINISHED_B__3_OFFSET UNITYSDK_OFFSET(0x18C9A600)

namespace MoleMole
{
	inline static constexpr unsigned int UICafePageController___c__DisplayClass26_1_TypeDefinitionIndex = 85844;
