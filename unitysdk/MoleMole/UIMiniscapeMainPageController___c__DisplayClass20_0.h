...
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER___C__DISPLAYCLASS20_0__CTOR_OFFSET UNITYSDK_OFFSET(0x179F1930)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER___C__DISPLAYCLASS20_0__PLAYLEVELUPGRADE_B__0_OFFSET UNITYSDK_OFFSET(0x179F1940)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER___C__DISPLAYCLASS20_0__PLAYLEVELUPGRADE_B__2_OFFSET UNITYSDK_OFFSET(0x179F1BF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMiniscapeMainPageController___c__DisplayClass20_0_TypeDefinitionIndex = 88198;

	class UIMiniscapeMainPageController___c__DisplayClass20_0 : public ::System::Object
	{
	public:
		::Class_2_348ECAB3896F67AE* model; // 0x10
