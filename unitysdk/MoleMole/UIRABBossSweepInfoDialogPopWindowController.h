...
#define MOLEMOLE_UIRABBOSSSWEEPINFODIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15787030)
#define MOLEMOLE_UIRABBOSSSWEEPINFODIALOGPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15787040)
#define MOLEMOLE_UIRABBOSSSWEEPINFODIALOGPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x157870B0)
#define MOLEMOLE_UIRABBOSSSWEEPINFODIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15787150)
#define MOLEMOLE_UIRABBOSSSWEEPINFODIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15787300)
#define MOLEMOLE_UIRABBOSSSWEEPINFODIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15787310)
#define MOLEMOLE_UIRABBOSSSWEEPINFODIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x157873B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABBossSweepInfoDialogPopWindowController_TypeDefinitionIndex = 78950;
