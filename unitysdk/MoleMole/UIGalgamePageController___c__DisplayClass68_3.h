...
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS68_3__CTOR_OFFSET UNITYSDK_OFFSET(0x1465B3E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgamePageController___c__DisplayClass68_3_TypeDefinitionIndex = 41808;

	class UIGalgamePageController___c__DisplayClass68_3 : public ::System::Object
	{
	public:
		::MoleMole::UIGalgamePageController___c__DisplayClass68_0* CS___8__locals3; // 0x10
