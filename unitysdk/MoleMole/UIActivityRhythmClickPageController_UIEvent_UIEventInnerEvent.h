...
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER_UIEVENT_UIEVENTINNEREVENT_COMPARETO_OFFSET UNITYSDK_OFFSET(0x8358B0)
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER_UIEVENT_UIEVENTINNEREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x45B2F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityRhythmClickPageController_UIEvent_UIEventInnerEvent_TypeDefinitionIndex = 81304;
