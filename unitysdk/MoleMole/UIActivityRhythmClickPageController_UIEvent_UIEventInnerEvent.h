...
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER_UIEVENT_UIEVENTINNEREVENT_COMPARETO_OFFSET UNITYSDK_OFFSET(0x7A40F0)
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER_UIEVENT_UIEVENTINNEREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x3A5D20)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityRhythmClickPageController_UIEvent_UIEventInnerEvent_TypeDefinitionIndex = 46819;
