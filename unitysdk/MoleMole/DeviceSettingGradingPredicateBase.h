...
#define MOLEMOLE_DEVICESETTINGGRADINGPREDICATEBASE_GETPREDICATEFLOAT_OFFSET UNITYSDK_OFFSET(0x16ABA910)
#define MOLEMOLE_DEVICESETTINGGRADINGPREDICATEBASE_PREDICATE_OFFSET UNITYSDK_OFFSET(0x16ABA790)
#define MOLEMOLE_DEVICESETTINGGRADINGPREDICATEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x16ABA950)
#define MOLEMOLE_DEVICESETTINGGRADINGPREDICATEBASE___BASE_PREDICATE_OFFSET UNITYSDK_OFFSET(0x16ABA9D0)

namespace MoleMole
{
	inline static constexpr unsigned int DeviceSettingGradingPredicateBase_TypeDefinitionIndex = 76175;
