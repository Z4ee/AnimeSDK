...
#define MOLEMOLE_DEVICESETTINGGRADINGPREDICATEBASE_GETPREDICATEFLOAT_OFFSET UNITYSDK_OFFSET(0x158D6200)
#define MOLEMOLE_DEVICESETTINGGRADINGPREDICATEBASE_PREDICATE_OFFSET UNITYSDK_OFFSET(0x158D6080)
#define MOLEMOLE_DEVICESETTINGGRADINGPREDICATEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x158D6240)
#define MOLEMOLE_DEVICESETTINGGRADINGPREDICATEBASE___BASE_PREDICATE_OFFSET UNITYSDK_OFFSET(0x158D62C0)

namespace MoleMole
{
	inline static constexpr unsigned int DeviceSettingGradingPredicateBase_TypeDefinitionIndex = 56820;
