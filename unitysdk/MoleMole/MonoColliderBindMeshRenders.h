...
#define MOLEMOLE_MONOCOLLIDERBINDMESHRENDERS_GETBINDMESHRENDERERS_OFFSET UNITYSDK_OFFSET(0x12F9BB20)
#define MOLEMOLE_MONOCOLLIDERBINDMESHRENDERS_GETMATERIALSLISTBYRENDERS_OFFSET UNITYSDK_OFFSET(0x12F9B270)
#define MOLEMOLE_MONOCOLLIDERBINDMESHRENDERS_GETOVERRIDERDITHERKEY_OFFSET UNITYSDK_OFFSET(0x12F9BAE0)
#define MOLEMOLE_MONOCOLLIDERBINDMESHRENDERS_METHOD_5_3306F24AC967FE79_OFFSET UNITYSDK_OFFSET(0x12F9B6D0)
#define MOLEMOLE_MONOCOLLIDERBINDMESHRENDERS_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x12F9B680)
#define MOLEMOLE_MONOCOLLIDERBINDMESHRENDERS__CTOR_OFFSET UNITYSDK_OFFSET(0x12F9BB60)

namespace MoleMole
{
	inline static constexpr unsigned int MonoColliderBindMeshRenders_TypeDefinitionIndex = 38471;
