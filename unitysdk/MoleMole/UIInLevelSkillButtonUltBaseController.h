...
#define MOLEMOLE_UIINLEVELSKILLBUTTONULTBASECONTROLLER_GET_BUTTONSKILLNAME_OFFSET UNITYSDK_OFFSET(0x174B62A0)
#define MOLEMOLE_UIINLEVELSKILLBUTTONULTBASECONTROLLER_GET_KEYBUTTONCODE_OFFSET UNITYSDK_OFFSET(0x174B62E0)
#define MOLEMOLE_UIINLEVELSKILLBUTTONULTBASECONTROLLER_ONHIDEULTBTN_OFFSET UNITYSDK_OFFSET(0x174B6400)
#define MOLEMOLE_UIINLEVELSKILLBUTTONULTBASECONTROLLER_ONSHOWULTBTN_OFFSET UNITYSDK_OFFSET(0x174B6350)
#define MOLEMOLE_UIINLEVELSKILLBUTTONULTBASECONTROLLER_SHOULDSKILLBUTTONHANDLEINPUT_OFFSET UNITYSDK_OFFSET(0x174B62F0)
#define MOLEMOLE_UIINLEVELSKILLBUTTONULTBASECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x174B64C0)
#define MOLEMOLE_UIINLEVELSKILLBUTTONULTBASECONTROLLER___BASE_SHOULDSKILLBUTTONHANDLEINPUT_OFFSET UNITYSDK_OFFSET(0x174B6540)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelSkillButtonUltBaseController_TypeDefinitionIndex = 42624;
