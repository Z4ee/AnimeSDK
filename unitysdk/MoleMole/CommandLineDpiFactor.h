...
#define MOLEMOLE_COMMANDLINEDPIFACTOR_METHOD_2_1A25E1AE01917D63_OFFSET UNITYSDK_OFFSET(0x1484A530)
#define MOLEMOLE_COMMANDLINEDPIFACTOR_METHOD_2_96BB3F4580463B05_OFFSET UNITYSDK_OFFSET(0x1484A420)
#define MOLEMOLE_COMMANDLINEDPIFACTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1484A4F0)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineDpiFactor_TypeDefinitionIndex = 61964;
