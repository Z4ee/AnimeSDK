...
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG_GET_RNGSEED_OFFSET UNITYSDK_OFFSET(0x116C5D00)
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG_NEXTBOOL_OFFSET UNITYSDK_OFFSET(0x116C5D20)
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG_NEXTFLOAT_OFFSET UNITYSDK_OFFSET(0x116C5E00)
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG_NEXTINT_OFFSET UNITYSDK_OFFSET(0x116C5D90)
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG_NEXTLONG_OFFSET UNITYSDK_OFFSET(0x116C5E80)
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG_NEXTUINT_OFFSET UNITYSDK_OFFSET(0x116C5EF0)
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG_NEXTULONG_OFFSET UNITYSDK_OFFSET(0x116C5F60)
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG_RANGEINT_OFFSET UNITYSDK_OFFSET(0x116C5FD0)
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG_SET_RNGSEED_OFFSET UNITYSDK_OFFSET(0x116C5D10)
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG__CTOR_OFFSET UNITYSDK_OFFSET(0x116C5CF0)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_XorShift64Rng_TypeDefinitionIndex = 87615;
