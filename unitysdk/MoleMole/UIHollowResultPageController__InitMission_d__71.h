...
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER__INITMISSION_D__71_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x15FAA5D0)
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER__INITMISSION_D__71_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15FABFB0)
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER__INITMISSION_D__71_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15FAC010)
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER__INITMISSION_D__71_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x15FABFC0)
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER__INITMISSION_D__71_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15FAA5C0)
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER__INITMISSION_D__71__CTOR_OFFSET UNITYSDK_OFFSET(0x15FAA5B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowResultPageController__InitMission_d__71_TypeDefinitionIndex = 80784;
