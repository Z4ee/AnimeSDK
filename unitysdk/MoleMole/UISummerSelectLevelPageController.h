...
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_CANCELTABREDSIGN_OFFSET UNITYSDK_OFFSET(0x122BB380)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_CREATELEVELRANKWIDGETGROUP_OFFSET UNITYSDK_OFFSET(0x122BD0C0)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_GET_MESSAGEMATCHPAGE_OFFSET UNITYSDK_OFFSET(0x122BB6A0)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x122BAA90)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_GOTOMAINPANELBUTTON_OFFSET UNITYSDK_OFFSET(0x122BE1C0)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x122BAAA0)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x122BD150)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_ONGOTOSELECTEQUIPPANELBUTTON_OFFSET UNITYSDK_OFFSET(0x122BDD90)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_ONPOPULARITYICONBUTTON_OFFSET UNITYSDK_OFFSET(0x122BE460)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_ONSELECTITEM_OFFSET UNITYSDK_OFFSET(0x122BD290)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_ONSTARTBATTLEBUTTON_OFFSET UNITYSDK_OFFSET(0x122BE3E0)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_ONSUMMERSELECTEQUIPCHANGEEVENT_OFFSET UNITYSDK_OFFSET(0x122BE4C0)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_ONTOGGLEPRECHECK_OFFSET UNITYSDK_OFFSET(0x122BE080)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_ONTOGGLE_OFFSET UNITYSDK_OFFSET(0x122BDE30)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x122BB310)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x122BABE0)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x122BB6B0)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_SELECTITEMONOPEN_OFFSET UNITYSDK_OFFSET(0x122BCD40)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_SETPANELDATA_OFFSET UNITYSDK_OFFSET(0x122BC010)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_SETTABREDSIGN_OFFSET UNITYSDK_OFFSET(0x122BC510)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_SHOWEQUIPBYDATA_OFFSET UNITYSDK_OFFSET(0x122BD9C0)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_SHOWGOTOMAINPANELBUTTON_OFFSET UNITYSDK_OFFSET(0x122BCAB0)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_SHOWSCORE_OFFSET UNITYSDK_OFFSET(0x122BD4A0)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x122BE510)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x122BE5B0)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER___BASE_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x122BE640)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x122BE730)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x122BE740)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x122BE750)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerSelectLevelPageController_TypeDefinitionIndex = 79401;

	class UISummerSelectLevelPageController : public ::MoleMole::UIMainCityStorePageController
	{
	public:
		::Class_2_79AE422BA06F6D26_191* _view; // 0x328
		...
		::System::Void SetPanelData(::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_169*>* LevelList)
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_169*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_SETPANELDATA_OFFSET))(this, LevelList);
		}
