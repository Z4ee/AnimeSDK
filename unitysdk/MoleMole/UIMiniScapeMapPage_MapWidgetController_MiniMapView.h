...
#define MOLEMOLE_UIMINISCAPEMAPPAGE_MAPWIDGETCONTROLLER_MINIMAPVIEW_GET_ANIMATION_OFFSET UNITYSDK_OFFSET(0x15DABEC0)
#define MOLEMOLE_UIMINISCAPEMAPPAGE_MAPWIDGETCONTROLLER_MINIMAPVIEW_GET_CONTENTLAYOUTELEMENT_OFFSET UNITYSDK_OFFSET(0x15DAC020)
#define MOLEMOLE_UIMINISCAPEMAPPAGE_MAPWIDGETCONTROLLER_MINIMAPVIEW_GET_IMAGE_OFFSET UNITYSDK_OFFSET(0x15DABE10)
#define MOLEMOLE_UIMINISCAPEMAPPAGE_MAPWIDGETCONTROLLER_MINIMAPVIEW_GET_SCROLLRECT_OFFSET UNITYSDK_OFFSET(0x15DAC0D0)
#define MOLEMOLE_UIMINISCAPEMAPPAGE_MAPWIDGETCONTROLLER_MINIMAPVIEW_GET_SLIDER_OFFSET UNITYSDK_OFFSET(0x15DABF70)
#define MOLEMOLE_UIMINISCAPEMAPPAGE_MAPWIDGETCONTROLLER_MINIMAPVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x15DAC180)

namespace MoleMole
{
	inline static constexpr unsigned int UIMiniScapeMapPage_MapWidgetController_MiniMapView_TypeDefinitionIndex = 47343;
