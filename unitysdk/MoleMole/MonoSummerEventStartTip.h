...
#define MOLEMOLE_MONOSUMMEREVENTSTARTTIP_METHOD_5_1D9AD08B174D2098_OFFSET UNITYSDK_OFFSET(0x17DD9A40)
#define MOLEMOLE_MONOSUMMEREVENTSTARTTIP_RUN_OFFSET UNITYSDK_OFFSET(0x17DD9850)
#define MOLEMOLE_MONOSUMMEREVENTSTARTTIP__CTOR_OFFSET UNITYSDK_OFFSET(0x17DD9AD0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoSummerEventStartTip_TypeDefinitionIndex = 77793;
