...
#define MOLEMOLE_CLOTHTORENDERERSDATADICENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x16C2A010)

namespace MoleMole
{
	inline static constexpr unsigned int ClothToRenderersDataDicEntry_TypeDefinitionIndex = 65797;
