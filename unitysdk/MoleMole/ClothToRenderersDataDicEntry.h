...
#define MOLEMOLE_CLOTHTORENDERERSDATADICENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x16297590)

namespace MoleMole
{
	inline static constexpr unsigned int ClothToRenderersDataDicEntry_TypeDefinitionIndex = 85575;
