...
#define MOLEMOLE_DOFPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x161B0430)

namespace MoleMole
{
	inline static constexpr unsigned int DOFProfileContext_TypeDefinitionIndex = 61960;
