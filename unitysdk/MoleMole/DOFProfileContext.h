...
#define MOLEMOLE_DOFPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x153E14E0)

namespace MoleMole
{
	inline static constexpr unsigned int DOFProfileContext_TypeDefinitionIndex = 61480;
