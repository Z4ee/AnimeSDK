...
#define MOLEMOLE_SETTRIGGERPARAMETER__RESETVALUE_D__7_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x108241A0)
#define MOLEMOLE_SETTRIGGERPARAMETER__RESETVALUE_D__7_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x10824240)
#define MOLEMOLE_SETTRIGGERPARAMETER__RESETVALUE_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x108242A0)
#define MOLEMOLE_SETTRIGGERPARAMETER__RESETVALUE_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x10824250)
#define MOLEMOLE_SETTRIGGERPARAMETER__RESETVALUE_D__7_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10824190)
#define MOLEMOLE_SETTRIGGERPARAMETER__RESETVALUE_D__7__CTOR_OFFSET UNITYSDK_OFFSET(0x10824180)

namespace MoleMole
{
	inline static constexpr unsigned int SetTriggerParameter__ResetValue_d__7_TypeDefinitionIndex = 41565;
