...
#define MOLEMOLE_SETTRIGGERPARAMETER__RESETVALUE_D__7_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x12FAF660)
#define MOLEMOLE_SETTRIGGERPARAMETER__RESETVALUE_D__7_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x12FAF700)
#define MOLEMOLE_SETTRIGGERPARAMETER__RESETVALUE_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x12FAF760)
#define MOLEMOLE_SETTRIGGERPARAMETER__RESETVALUE_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x12FAF710)
#define MOLEMOLE_SETTRIGGERPARAMETER__RESETVALUE_D__7_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x12FAF650)
#define MOLEMOLE_SETTRIGGERPARAMETER__RESETVALUE_D__7__CTOR_OFFSET UNITYSDK_OFFSET(0x12FAF640)

namespace MoleMole
{
	inline static constexpr unsigned int SetTriggerParameter__ResetValue_d__7_TypeDefinitionIndex = 49334;

	class SetTriggerParameter__ResetValue_d__7 : public ::System::Object
	{
	public:
		::System::Object* __2__current; // 0x10
		::MoleMole::SetTriggerParameter* __4__this; // 0x18
