...
#define MOLEMOLE_MONOUILAYOUTELEMENTADAPTOR_DOINITLAYOUT_OFFSET UNITYSDK_OFFSET(0x144F69F0)
#define MOLEMOLE_MONOUILAYOUTELEMENTADAPTOR_INITLAYOUTELEMENT_OFFSET UNITYSDK_OFFSET(0x144F6C20)
#define MOLEMOLE_MONOUILAYOUTELEMENTADAPTOR_ISCONTAINPLATFORMUIPARAMS_OFFSET UNITYSDK_OFFSET(0x144F6910)
#define MOLEMOLE_MONOUILAYOUTELEMENTADAPTOR_ISPLATFORMUIPARAMSEMPTY_OFFSET UNITYSDK_OFFSET(0x144F6870)
#define MOLEMOLE_MONOUILAYOUTELEMENTADAPTOR_RELOADDATAFROMJSON_OFFSET UNITYSDK_OFFSET(0x144F6E80)
#define MOLEMOLE_MONOUILAYOUTELEMENTADAPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x144F7150)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUILayoutElementAdaptor_TypeDefinitionIndex = 69778;
