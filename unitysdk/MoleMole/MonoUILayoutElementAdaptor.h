...
#define MOLEMOLE_MONOUILAYOUTELEMENTADAPTOR_DOINITLAYOUT_OFFSET UNITYSDK_OFFSET(0x170338C0)
#define MOLEMOLE_MONOUILAYOUTELEMENTADAPTOR_INITLAYOUTELEMENT_OFFSET UNITYSDK_OFFSET(0x17033AF0)
#define MOLEMOLE_MONOUILAYOUTELEMENTADAPTOR_ISCONTAINPLATFORMUIPARAMS_OFFSET UNITYSDK_OFFSET(0x170337E0)
#define MOLEMOLE_MONOUILAYOUTELEMENTADAPTOR_ISPLATFORMUIPARAMSEMPTY_OFFSET UNITYSDK_OFFSET(0x17033740)
#define MOLEMOLE_MONOUILAYOUTELEMENTADAPTOR_RELOADDATAFROMJSON_OFFSET UNITYSDK_OFFSET(0x17033D50)
#define MOLEMOLE_MONOUILAYOUTELEMENTADAPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17034030)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUILayoutElementAdaptor_TypeDefinitionIndex = 73839;
