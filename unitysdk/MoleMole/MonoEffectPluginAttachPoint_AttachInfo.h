...
#define MOLEMOLE_MONOEFFECTPLUGINATTACHPOINT_ATTACHINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1582F870)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginAttachPoint_AttachInfo_TypeDefinitionIndex = 52743;
