...
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1744BC20)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER___C__DISPLAYCLASS7_0__SHOWMISSIONFINISHANDHIDE_B__0_OFFSET UNITYSDK_OFFSET(0x1744BC30)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER___C__DISPLAYCLASS7_0__SHOWMISSIONFINISHANDHIDE_B__1_OFFSET UNITYSDK_OFFSET(0x1744BC80)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityMissionWidgetController___c__DisplayClass7_0_TypeDefinitionIndex = 88617;
