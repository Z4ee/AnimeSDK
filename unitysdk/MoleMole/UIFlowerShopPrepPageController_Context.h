...
#define MOLEMOLE_UIFLOWERSHOPPREPPAGECONTROLLER_CONTEXT_GET_FLOWERSHOP3DMODELCONTROLLER_OFFSET UNITYSDK_OFFSET(0x18D65DE0)
#define MOLEMOLE_UIFLOWERSHOPPREPPAGECONTROLLER_CONTEXT_SET_FLOWERSHOP3DMODELCONTROLLER_OFFSET UNITYSDK_OFFSET(0x18D65DF0)
#define MOLEMOLE_UIFLOWERSHOPPREPPAGECONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18D65E00)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerShopPrepPageController_Context_TypeDefinitionIndex = 86419;
