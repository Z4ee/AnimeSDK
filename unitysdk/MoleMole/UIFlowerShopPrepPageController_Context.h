...
#define MOLEMOLE_UIFLOWERSHOPPREPPAGECONTROLLER_CONTEXT_GET_FLOWERSHOP3DMODELCONTROLLER_OFFSET UNITYSDK_OFFSET(0x16F24980)
#define MOLEMOLE_UIFLOWERSHOPPREPPAGECONTROLLER_CONTEXT_SET_FLOWERSHOP3DMODELCONTROLLER_OFFSET UNITYSDK_OFFSET(0x16F24990)
#define MOLEMOLE_UIFLOWERSHOPPREPPAGECONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F249A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerShopPrepPageController_Context_TypeDefinitionIndex = 51504;
