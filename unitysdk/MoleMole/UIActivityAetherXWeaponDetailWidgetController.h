...
#define MOLEMOLE_UIACTIVITYAETHERXWEAPONDETAILWIDGETCONTROLLER_BINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x183C1570)
#define MOLEMOLE_UIACTIVITYAETHERXWEAPONDETAILWIDGETCONTROLLER_INITINDEX_OFFSET UNITYSDK_OFFSET(0x183C1410)
#define MOLEMOLE_UIACTIVITYAETHERXWEAPONDETAILWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x183C1300)
#define MOLEMOLE_UIACTIVITYAETHERXWEAPONDETAILWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x183C1390)
#define MOLEMOLE_UIACTIVITYAETHERXWEAPONDETAILWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x183C1130)
#define MOLEMOLE_UIACTIVITYAETHERXWEAPONDETAILWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x183C1290)
#define MOLEMOLE_UIACTIVITYAETHERXWEAPONDETAILWIDGETCONTROLLER_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x183C1500)
#define MOLEMOLE_UIACTIVITYAETHERXWEAPONDETAILWIDGETCONTROLLER_SETSELECT_OFFSET UNITYSDK_OFFSET(0x183C1460)
#define MOLEMOLE_UIACTIVITYAETHERXWEAPONDETAILWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x183C15C0)
#define MOLEMOLE_UIACTIVITYAETHERXWEAPONDETAILWIDGETCONTROLLER__ONUIINIT_B__3_0_OFFSET UNITYSDK_OFFSET(0x183C1620)
#define MOLEMOLE_UIACTIVITYAETHERXWEAPONDETAILWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x183C1680)
#define MOLEMOLE_UIACTIVITYAETHERXWEAPONDETAILWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x183C1710)
#define MOLEMOLE_UIACTIVITYAETHERXWEAPONDETAILWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x183C17A0)
#define MOLEMOLE_UIACTIVITYAETHERXWEAPONDETAILWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x183C1830)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityAetherXWeaponDetailWidgetController_TypeDefinitionIndex = 84639;

	class UIActivityAetherXWeaponDetailWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_A933CF9454745DA7_3* _view; // 0x2C0
