...
#define MOLEMOLE_UIBALLGAMEPLAYERMOVECHILDWINDOWCONTROLLER_GET_JOYSTICKMOVEDIR_OFFSET UNITYSDK_OFFSET(0x1CFA0CE0)
#define MOLEMOLE_UIBALLGAMEPLAYERMOVECHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1CFA0CD0)
#define MOLEMOLE_UIBALLGAMEPLAYERMOVECHILDWINDOWCONTROLLER_HIGHLIGHTDIRTRANS_OFFSET UNITYSDK_OFFSET(0x1CFA2080)
#define MOLEMOLE_UIBALLGAMEPLAYERMOVECHILDWINDOWCONTROLLER_INITDIRTRANS_OFFSET UNITYSDK_OFFSET(0x1CFA1320)
#define MOLEMOLE_UIBALLGAMEPLAYERMOVECHILDWINDOWCONTROLLER_ISINDEADZONE_OFFSET UNITYSDK_OFFSET(0x1CFA2E30)
#define MOLEMOLE_UIBALLGAMEPLAYERMOVECHILDWINDOWCONTROLLER_ONACTIVE_OFFSET UNITYSDK_OFFSET(0x1CFA1FB0)
#define MOLEMOLE_UIBALLGAMEPLAYERMOVECHILDWINDOWCONTROLLER_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x1CFA1970)
#define MOLEMOLE_UIBALLGAMEPLAYERMOVECHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1CFA0D00)
#define MOLEMOLE_UIBALLGAMEPLAYERMOVECHILDWINDOWCONTROLLER_ONPOINTDOWN2UP_OFFSET UNITYSDK_OFFSET(0x1CFA1F60)
#define MOLEMOLE_UIBALLGAMEPLAYERMOVECHILDWINDOWCONTROLLER_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x1CFA30D0)
#define MOLEMOLE_UIBALLGAMEPLAYERMOVECHILDWINDOWCONTROLLER_ONPOINTERUP2DOWN_OFFSET UNITYSDK_OFFSET(0x1CFA1F20)
#define MOLEMOLE_UIBALLGAMEPLAYERMOVECHILDWINDOWCONTROLLER_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x1CFA3280)
#define MOLEMOLE_UIBALLGAMEPLAYERMOVECHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1CFA1630)
#define MOLEMOLE_UIBALLGAMEPLAYERMOVECHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1CFA0D90)
#define MOLEMOLE_UIBALLGAMEPLAYERMOVECHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1CFA1550)
#define MOLEMOLE_UIBALLGAMEPLAYERMOVECHILDWINDOWCONTROLLER_ONUNACTIVE_OFFSET UNITYSDK_OFFSET(0x1CFA2FF0)
#define MOLEMOLE_UIBALLGAMEPLAYERMOVECHILDWINDOWCONTROLLER_RESETDIRTRANS_OFFSET UNITYSDK_OFFSET(0x1CFA28E0)
#define MOLEMOLE_UIBALLGAMEPLAYERMOVECHILDWINDOWCONTROLLER_RESETGRAPHICPOSITION_OFFSET UNITYSDK_OFFSET(0x1CFA2860)
#define MOLEMOLE_UIBALLGAMEPLAYERMOVECHILDWINDOWCONTROLLER_SETGRAPHICPOSITION_OFFSET UNITYSDK_OFFSET(0x1CFA2AD0)
#define MOLEMOLE_UIBALLGAMEPLAYERMOVECHILDWINDOWCONTROLLER_SET_JOYSTICKMOVEDIR_OFFSET UNITYSDK_OFFSET(0x1CFA0CF0)
#define MOLEMOLE_UIBALLGAMEPLAYERMOVECHILDWINDOWCONTROLLER_TRYGETCURRENTPOINTERID_OFFSET UNITYSDK_OFFSET(0x1CFA1D40)
#define MOLEMOLE_UIBALLGAMEPLAYERMOVECHILDWINDOWCONTROLLER_UPDATEAXISINPUT_OFFSET UNITYSDK_OFFSET(0x1CFA2310)
#define MOLEMOLE_UIBALLGAMEPLAYERMOVECHILDWINDOWCONTROLLER_UPDATEJOYSTICK_OFFSET UNITYSDK_OFFSET(0x1CFA19D0)
#define MOLEMOLE_UIBALLGAMEPLAYERMOVECHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFA32E0)
#define MOLEMOLE_UIBALLGAMEPLAYERMOVECHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1CFA32F0)
#define MOLEMOLE_UIBALLGAMEPLAYERMOVECHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1CFA3380)
#define MOLEMOLE_UIBALLGAMEPLAYERMOVECHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1CFA3390)
#define MOLEMOLE_UIBALLGAMEPLAYERMOVECHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1CFA33A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBallGamePlayerMoveChildWindowController_TypeDefinitionIndex = 89405;
	...
	public:
		...
		{
			return (::UnityEngine::Vector2*)Il2CppClass::FromTypeDefinitionIndex(UIBallGamePlayerMoveChildWindowController_TypeDefinitionIndex)->GetStaticField(0x12B80);
		}
		// static const ::System::Single DeadZonePercent; // 0x0
		::Class_2_79F6D62CE30E3F8E_189* _view; // 0x318
