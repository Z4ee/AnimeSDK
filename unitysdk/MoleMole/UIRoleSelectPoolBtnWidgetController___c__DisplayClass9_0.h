...
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x13782480)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER___C__DISPLAYCLASS9_0__SETPROGRESSFORGACHATIMES_B__2_OFFSET UNITYSDK_OFFSET(0x13782490)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER___C__DISPLAYCLASS9_0__SETPROGRESSFORGACHATIMES_B__3_OFFSET UNITYSDK_OFFSET(0x13782530)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleSelectPoolBtnWidgetController___c__DisplayClass9_0_TypeDefinitionIndex = 43851;
