...
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1616BA90)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER___C__DISPLAYCLASS9_0__SETPROGRESSFORGACHATIMES_B__2_OFFSET UNITYSDK_OFFSET(0x1616BAA0)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER___C__DISPLAYCLASS9_0__SETPROGRESSFORGACHATIMES_B__3_OFFSET UNITYSDK_OFFSET(0x1616BB40)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleSelectPoolBtnWidgetController___c__DisplayClass9_0_TypeDefinitionIndex = 73956;
	...
	public:
		...
		::System::Single prvProgress; // 0x1C
		::System::Single targetProgress; // 0x20
