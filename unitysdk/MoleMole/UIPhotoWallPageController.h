...
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_BEGINDRAGCALLBACK_OFFSET UNITYSDK_OFFSET(0x166614B0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_CHANGEPLATFORMIDMODE_OFFSET UNITYSDK_OFFSET(0x166600B0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_CHANGETOEDITMODE_OFFSET UNITYSDK_OFFSET(0x1665E790)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_CHANGETOWATCHMODE_OFFSET UNITYSDK_OFFSET(0x1665E8B0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_CUSTOMCHECKEDGEFUNC_OFFSET UNITYSDK_OFFSET(0x16666720)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_CUSTOMCOLLECTALLITEMFUNC_OFFSET UNITYSDK_OFFSET(0x166652C0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_CUSTOMGETITEMPOSFUNC_OFFSET UNITYSDK_OFFSET(0x16664380)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_CUSTOMSETITEMSELECTSTATEFUNC_OFFSET UNITYSDK_OFFSET(0x16664180)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_DRAGCALLBACK_OFFSET UNITYSDK_OFFSET(0x16661B50)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_DRAGTWOPOINTCALLBACK_OFFSET UNITYSDK_OFFSET(0x16662F70)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ENDDRAGCALLBACK_OFFSET UNITYSDK_OFFSET(0x16661A20)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ENDDRAGTWOPOINTCALLBACK_OFFSET UNITYSDK_OFFSET(0x16662F10)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_FIXEXMOVEDELTA_OFFSET UNITYSDK_OFFSET(0x1665C760)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_GETCAMERA_OFFSET UNITYSDK_OFFSET(0x16654F70)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_GETCURRENTCAMERAOFFSET_OFFSET UNITYSDK_OFFSET(0x166550E0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_GETCURRENTFOV_OFFSET UNITYSDK_OFFSET(0x1665EB60)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_GETFRIENDNETWORKDATA_OFFSET UNITYSDK_OFFSET(0x166612B0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_GETNEWBIEDYNAMICOBJECT_OFFSET UNITYSDK_OFFSET(0x16663E90)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_GET_CURRENTFRIENDSYS_OFFSET UNITYSDK_OFFSET(0x16659B50)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_GET_CURRENTGROUP_OFFSET UNITYSDK_OFFSET(0x16659AF0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_GET_FRIENDSYSINFOS_OFFSET UNITYSDK_OFFSET(0x16659B30)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_GET_NETWORKDATA_OFFSET UNITYSDK_OFFSET(0x16659B00)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_GET_OPENMODE_OFFSET UNITYSDK_OFFSET(0x16659B10)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_GET_PHOTOWALLOBJECTDATAS_OFFSET UNITYSDK_OFFSET(0x1664E200)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_GET_VIRTUALCURSOR_OFFSET UNITYSDK_OFFSET(0x1664EE90)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x16659AE0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_INITBYOPENMODE_OFFSET UNITYSDK_OFFSET(0x1665B460)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_INITCAMERA_OFFSET UNITYSDK_OFFSET(0x16660710)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_INITDATA_OFFSET UNITYSDK_OFFSET(0x16660E90)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ISINNEWBIE_OFFSET UNITYSDK_OFFSET(0x16652560)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x16662610)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_MOVECAMERAFORWARD_OFFSET UNITYSDK_OFFSET(0x1665D1B0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_MOVECAMERATO_OFFSET UNITYSDK_OFFSET(0x166551B0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONBEFORENEXTSTEPHANDLE_OFFSET UNITYSDK_OFFSET(0x16666450)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONCHANGECURRENTINDEXHANDLE_OFFSET UNITYSDK_OFFSET(0x16660C40)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONCLICKBACK_OFFSET UNITYSDK_OFFSET(0x1665FA10)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONCLICKLEFTCALLBACK_OFFSET UNITYSDK_OFFSET(0x16663C70)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONCLICKPLATFORMIDCALLBACK_OFFSET UNITYSDK_OFFSET(0x16660060)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONCLICKRIGHTCALLBACK_OFFSET UNITYSDK_OFFSET(0x16663D90)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONCLICKSHOWUI_OFFSET UNITYSDK_OFFSET(0x1665FF20)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONCLICKSWITCHCALLBACK_OFFSET UNITYSDK_OFFSET(0x16660420)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16659B70)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x1665D320)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x1665AE40)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1665C1C0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONNEWBIECLOSEHANDLE_OFFSET UNITYSDK_OFFSET(0x166666D0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONPHOTOWALLNAMEHANDLE_OFFSET UNITYSDK_OFFSET(0x16664080)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONSCROLLCALLBACK_OFFSET UNITYSDK_OFFSET(0x16663B40)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1665AF20)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1665A690)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16659C00)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1665AD80)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_POINTUPCALLBACK_OFFSET UNITYSDK_OFFSET(0x16662D20)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_PROCESS3DENTITYHANDLE_OFFSET UNITYSDK_OFFSET(0x1665C030)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_PROCESSAFTERSETFOV_OFFSET UNITYSDK_OFFSET(0x1665D470)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_PROCESSTWOPOINTERDRAG_OFFSET UNITYSDK_OFFSET(0x16663010)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_RAYCASTPHOTOWALLOBJECT_OFFSET UNITYSDK_OFFSET(0x16661660)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_REFRESHOPENMODE_OFFSET UNITYSDK_OFFSET(0x1665B350)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_RESETCAMERA_OFFSET UNITYSDK_OFFSET(0x16652760)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_SETBACKBTNENABLE_OFFSET UNITYSDK_OFFSET(0x1665EAF0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_SETBLOCKALLBUTTON_OFFSET UNITYSDK_OFFSET(0x166664C0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_SETEDITMODECAMERACLAMP_OFFSET UNITYSDK_OFFSET(0x1665EC30)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_SETFULLSCREENBTNACTIVE_OFFSET UNITYSDK_OFFSET(0x166521D0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_SETSHARECONSOLEBTN_OFFSET UNITYSDK_OFFSET(0x16663FD0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x1665C120)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER__CHANGETOEDITMODE_B__36_0_OFFSET UNITYSDK_OFFSET(0x16667750)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER__CHANGETOEDITMODE_B__36_1_OFFSET UNITYSDK_OFFSET(0x16667840)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x166670C0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER__ONCHANGECURRENTINDEXHANDLE_B__56_0_OFFSET UNITYSDK_OFFSET(0x16667B70)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER__ONCLICKBACK_B__51_0_OFFSET UNITYSDK_OFFSET(0x16667910)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER__ONCLICKBACK_B__51_1_OFFSET UNITYSDK_OFFSET(0x16667950)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER__ONCLICKSWITCHCALLBACK_B__54_0_OFFSET UNITYSDK_OFFSET(0x16667990)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER__ONSHOW_B__27_0_OFFSET UNITYSDK_OFFSET(0x16667170)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER__ONUIINIT_B__23_0_OFFSET UNITYSDK_OFFSET(0x166670D0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER__ONUIINIT_B__23_1_OFFSET UNITYSDK_OFFSET(0x16667120)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___BASE_GETNEWBIEDYNAMICOBJECT_OFFSET UNITYSDK_OFFSET(0x16667F00)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16667F90)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x16668020)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x166680D0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x16668160)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16668190)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16668230)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16668240)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16668250)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x16668260)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoWallPageController_TypeDefinitionIndex = 52431;
	...
	public:
		...
		::Class_2_60638234271CCDB8_79* _view; // 0x328
		::Class_1_3773F938AA2C6232* _currentGroup; // 0x330
		::Class_1_3056A65E74601914* _currentNetworkData; // 0x338
		...
		::Class_1_44EB9C1BE1434A8D* _cameraMode; // 0x388
		...
		::System::Void InitCamera(::Class_2_208CC9941471731A_115* cameraPos, ::MoleMole::UIVirtualCameraConfigs* cameraConfig)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_115*, ::MoleMole::UIVirtualCameraConfigs*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_INITCAMERA_OFFSET))(this, cameraPos, cameraConfig);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_468*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_CUSTOMSETITEMSELECTSTATEFUNC_OFFSET))(this, target, isselect);
		}
		...
		::System::Void _OnChangeCurrentIndexHandle_b__56_0(::Class_1_7D59F735ACB38970_Enum_3_6E0E8267CDDC65CF r)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_7D59F735ACB38970_Enum_3_6E0E8267CDDC65CF))((::PBYTE)hIl2Cpp + MOLEMOLE_UIPHOTOWALLPAGECONTROLLER__ONCHANGECURRENTINDEXHANDLE_B__56_0_OFFSET))(this, r);
		}
