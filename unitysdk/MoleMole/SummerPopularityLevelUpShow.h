...
#define MOLEMOLE_SUMMERPOPULARITYLEVELUPSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x18717170)
#define MOLEMOLE_SUMMERPOPULARITYLEVELUPSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x187171C0)
#define MOLEMOLE_SUMMERPOPULARITYLEVELUPSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x18717180)

namespace MoleMole
{
	inline static constexpr unsigned int SummerPopularityLevelUpShow_TypeDefinitionIndex = 86085;
