...
#define MOLEMOLE_MONOWAYPATH_FINDCLOSESTWAYPOINT_OFFSET UNITYSDK_OFFSET(0x10BDC410)
#define MOLEMOLE_MONOWAYPATH_FINDNEXTWAYPOINT_OFFSET UNITYSDK_OFFSET(0x10BDC5B0)
#define MOLEMOLE_MONOWAYPATH_GETWAYPOINTBYPOINTNAME_OFFSET UNITYSDK_OFFSET(0x10BDC8A0)
#define MOLEMOLE_MONOWAYPATH_GETWAYPOINT_OFFSET UNITYSDK_OFFSET(0x10BDC800)
#define MOLEMOLE_MONOWAYPATH_INIT_OFFSET UNITYSDK_OFFSET(0x10BDC100)
#define MOLEMOLE_MONOWAYPATH_UPDATE_OFFSET UNITYSDK_OFFSET(0x10BDBEB0)
#define MOLEMOLE_MONOWAYPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x10BDC9B0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoWayPath_TypeDefinitionIndex = 39565;
