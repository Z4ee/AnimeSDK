...
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER__ROTARROW_D__22_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1744FD90)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER__ROTARROW_D__22_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1744FFE0)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER__ROTARROW_D__22_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x17450040)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER__ROTARROW_D__22_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1744FFF0)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER__ROTARROW_D__22_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1744FD80)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER__ROTARROW_D__22__CTOR_OFFSET UNITYSDK_OFFSET(0x1744FD70)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityTimeTipsPopWindowController__RotArrow_d__22_TypeDefinitionIndex = 65801;
	...
	public:
		...
		::System::Single _delta_5__3; // 0x1C
		::System::Single nextRatio; // 0x20
