...
#define MOLEMOLE_UITHREEDMAPELEMENT_SUBAREACONTEXT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x10894320)
#define MOLEMOLE_UITHREEDMAPELEMENT_SUBAREACONTEXT_EQUALS_OFFSET UNITYSDK_OFFSET(0x10894290)
#define MOLEMOLE_UITHREEDMAPELEMENT_SUBAREACONTEXT_GETPOINTLOCKTYPE_OFFSET UNITYSDK_OFFSET(0x10893A70)
#define MOLEMOLE_UITHREEDMAPELEMENT_SUBAREACONTEXT_GETWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x10892CD0)
#define MOLEMOLE_UITHREEDMAPELEMENT_SUBAREACONTEXT_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x108933E0)
#define MOLEMOLE_UITHREEDMAPELEMENT_SUBAREACONTEXT_ONSHOWPANEL_OFFSET UNITYSDK_OFFSET(0x10893AC0)
#define MOLEMOLE_UITHREEDMAPELEMENT_SUBAREACONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x10894420)
#define MOLEMOLE_UITHREEDMAPELEMENT_SUBAREACONTEXT___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x10894480)
#define MOLEMOLE_UITHREEDMAPELEMENT_SUBAREACONTEXT___BASE_GETPOINTLOCKTYPE_OFFSET UNITYSDK_OFFSET(0x10894490)
#define MOLEMOLE_UITHREEDMAPELEMENT_SUBAREACONTEXT___BASE_GETWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x108944A0)
#define MOLEMOLE_UITHREEDMAPELEMENT_SUBAREACONTEXT___BASE_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x10894580)
#define MOLEMOLE_UITHREEDMAPELEMENT_SUBAREACONTEXT___BASE_ONSHOWPANEL_OFFSET UNITYSDK_OFFSET(0x10894610)

namespace MoleMole
{
	inline static constexpr unsigned int UIThreeDMapElement_SubAreaContext_TypeDefinitionIndex = 68627;

	class UIThreeDMapElement_SubAreaContext : public ::MoleMole::UIUrbanMapPointWidgetContext
	{
	public:
		::System::Int32 TargetLayerIndex; // 0x58
		::System::Int32 TargetSection; // 0x5C
		::System::Int32 TargetFloor; // 0x60
		::System::Int32 FromSection; // 0x64
