...
#define MOLEMOLE_MAINCITYGACHAKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1175A380)
#define MOLEMOLE_MAINCITYGACHAKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x1175A390)
#define MOLEMOLE_MAINCITYGACHAKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1175A3A0)

namespace MoleMole
{
	inline static constexpr unsigned int MainCityGachaKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 82970;
