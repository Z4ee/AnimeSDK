...
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE_GETCHARACTERLIGHTSTLPATH_OFFSET UNITYSDK_OFFSET(0x16F5DAF0)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE_GETINITEULER_OFFSET UNITYSDK_OFFSET(0x16F5A080)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE_GETLIGHTIDS_OFFSET UNITYSDK_OFFSET(0x16F5DA90)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE_GETSTAYEULER_OFFSET UNITYSDK_OFFSET(0x16F5A270)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE_GET_BLUEPRINT_NAME_OFFSET UNITYSDK_OFFSET(0x16F5DB70)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE_GET_ISANGLEFLOATINGACTIVE_OFFSET UNITYSDK_OFFSET(0x16F5DBC0)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE_GET_ISFLOATINGACTIVE_OFFSET UNITYSDK_OFFSET(0x16F5DBB0)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE_GET_RARITY_TV_INDEX_OFFSET UNITYSDK_OFFSET(0x16F5DB60)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE_GET_TOTAL_TV_NUM_OFFSET UNITYSDK_OFFSET(0x16F5DB50)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE_HANDLEONOPEN_OFFSET UNITYSDK_OFFSET(0x16F5B8E0)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE_HANDLEUPDATE_OFFSET UNITYSDK_OFFSET(0x16F5AEE0)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE_INITLIGHTS_OFFSET UNITYSDK_OFFSET(0x16F5D850)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE_ISVIDEOTVINDEX_OFFSET UNITYSDK_OFFSET(0x16F5D800)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE_ONCAMERASHAKE_OFFSET UNITYSDK_OFFSET(0x16F5B840)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE_ONREFRESHSTAGE_OFFSET UNITYSDK_OFFSET(0x16F5BBE0)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE_PRELOADSTAGEBEFOREPLAY_OFFSET UNITYSDK_OFFSET(0x16F5B9C0)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE_ROTATEWEAPON_OFFSET UNITYSDK_OFFSET(0x16F59DD0)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE_SET_ISANGLEFLOATINGACTIVE_OFFSET UNITYSDK_OFFSET(0x16F5B7D0)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE_SET_ISFLOATINGACTIVE_OFFSET UNITYSDK_OFFSET(0x16F5B460)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE_STOPSOUND_OFFSET UNITYSDK_OFFSET(0x16F5AC70)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE_TRYHANDLESPECIALWEAPONROTATE_OFFSET UNITYSDK_OFFSET(0x16F5A9F0)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE_UPDATEANGLEFLOATING_OFFSET UNITYSDK_OFFSET(0x16F5B4D0)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE_UPDATEFLOATING_OFFSET UNITYSDK_OFFSET(0x16F5B240)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE_UPDATEROTATEWEAPON_OFFSET UNITYSDK_OFFSET(0x16F5A460)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F5DBD0)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE___BASE_HANDLEONOPEN_OFFSET UNITYSDK_OFFSET(0x16F5DCC0)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE___BASE_HANDLEUPDATE_OFFSET UNITYSDK_OFFSET(0x16F5DCD0)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE___BASE_ISVIDEOTVINDEX_OFFSET UNITYSDK_OFFSET(0x16F5DD60)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE___BASE_ONCAMERASHAKE_OFFSET UNITYSDK_OFFSET(0x16F5DDF0)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE___BASE_STOPSOUND_OFFSET UNITYSDK_OFFSET(0x16F5DE80)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaStageWeapon3DModelControllerBase_TypeDefinitionIndex = 64031;
	...
	public:
		...
		::Class_2_208CC9941471731A_1012* _weaponPerformTemplate; // 0x700
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_385*, ::System::Action*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLERBASE_PRELOADSTAGEBEFOREPLAY_OFFSET))(this, template_, preloadComplete);
		}
