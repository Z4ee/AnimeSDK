...
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER_GETCURRENTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x172E2870)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER_ONBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x172E27E0)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x172E2980)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x172E2A10)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x172E2430)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x172E2910)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER_REFRESHSELECTSTATE_OFFSET UNITYSDK_OFFSET(0x172E2720)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x172E2A90)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER_SETCLICKACTION_OFFSET UNITYSDK_OFFSET(0x172E28C0)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER_SETCURRENTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x172E26C0)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER_UPDATESELECTALPHA_OFFSET UNITYSDK_OFFSET(0x172E2B50)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x172E2C10)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x172E2CF0)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x172E2D80)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x172E2E10)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x172E2EA0)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopRoulettPanelWidgetController_TypeDefinitionIndex = 53765;

	class UICoopRoulettPanelWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_5B9F677DE471C1A7* _view; // 0x2C0
