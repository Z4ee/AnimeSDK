...
#define MOLEMOLE_UICONTROLCHOOSEPOPWINDOWCONTROLLER_CONFIRMUILAYOUT_OFFSET UNITYSDK_OFFSET(0x172DF3D0)
#define MOLEMOLE_UICONTROLCHOOSEPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x172DE670)
#define MOLEMOLE_UICONTROLCHOOSEPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x172DE660)
#define MOLEMOLE_UICONTROLCHOOSEPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x172DEE40)
#define MOLEMOLE_UICONTROLCHOOSEPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x172DF1C0)
#define MOLEMOLE_UICONTROLCHOOSEPOPWINDOWCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x172DF100)
#define MOLEMOLE_UICONTROLCHOOSEPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x172DEED0)
#define MOLEMOLE_UICONTROLCHOOSEPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x172DE680)
#define MOLEMOLE_UICONTROLCHOOSEPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x172DE9B0)
#define MOLEMOLE_UICONTROLCHOOSEPOPWINDOWCONTROLLER_SETFINISHCB_OFFSET UNITYSDK_OFFSET(0x172DF380)
#define MOLEMOLE_UICONTROLCHOOSEPOPWINDOWCONTROLLER_SWITCHUILAYOUTPLATFORM_OFFSET UNITYSDK_OFFSET(0x172DEA80)
#define MOLEMOLE_UICONTROLCHOOSEPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x172DF480)
#define MOLEMOLE_UICONTROLCHOOSEPOPWINDOWCONTROLLER__ONUIINIT_B__5_0_OFFSET UNITYSDK_OFFSET(0x172DF490)
#define MOLEMOLE_UICONTROLCHOOSEPOPWINDOWCONTROLLER__ONUIINIT_B__5_1_OFFSET UNITYSDK_OFFSET(0x172DF4A0)
#define MOLEMOLE_UICONTROLCHOOSEPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x172DF4B0)
#define MOLEMOLE_UICONTROLCHOOSEPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x172DF540)
#define MOLEMOLE_UICONTROLCHOOSEPOPWINDOWCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x172DF570)
#define MOLEMOLE_UICONTROLCHOOSEPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x172DF600)
#define MOLEMOLE_UICONTROLCHOOSEPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x172DF610)
#define MOLEMOLE_UICONTROLCHOOSEPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x172DF620)

namespace MoleMole
{
	inline static constexpr unsigned int UIControlChoosePopWindowController_TypeDefinitionIndex = 64355;
