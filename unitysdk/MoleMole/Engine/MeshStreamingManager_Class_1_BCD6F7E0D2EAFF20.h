...
#define MOLEMOLE_ENGINE_MESHSTREAMINGMANAGER_CLASS_1_BCD6F7E0D2EAFF20_METHOD_1_8945464396F3B4FA_OFFSET UNITYSDK_OFFSET(0x191B86D0)
#define MOLEMOLE_ENGINE_MESHSTREAMINGMANAGER_CLASS_1_BCD6F7E0D2EAFF20__CTOR_OFFSET UNITYSDK_OFFSET(0x191B86C0)

namespace MoleMole::Engine
{
	inline static constexpr unsigned int MeshStreamingManager_Class_1_BCD6F7E0D2EAFF20_TypeDefinitionIndex = 53087;
