...
#define MOLEMOLE_ENGINE_NAPSCENEOPTIMIZEMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0x170BBB60)
#define MOLEMOLE_ENGINE_NAPSCENEOPTIMIZEMANAGER_REFRESHDATA_OFFSET UNITYSDK_OFFSET(0x170BBBB0)
#define MOLEMOLE_ENGINE_NAPSCENEOPTIMIZEMANAGER_TRIGGERSETTINGS_OFFSET UNITYSDK_OFFSET(0x170BC0B0)
#define MOLEMOLE_ENGINE_NAPSCENEOPTIMIZEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x170BC270)

namespace MoleMole::Engine
{
	inline static constexpr unsigned int NapSceneOptimizeManager_TypeDefinitionIndex = 45193;
