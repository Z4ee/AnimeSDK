...
#define MOLEMOLE_ENGINE_NAPSCENEOPTIMIZEMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0x19115260)
#define MOLEMOLE_ENGINE_NAPSCENEOPTIMIZEMANAGER_REFRESHDATA_OFFSET UNITYSDK_OFFSET(0x191152B0)
#define MOLEMOLE_ENGINE_NAPSCENEOPTIMIZEMANAGER_TRIGGERSETTINGS_OFFSET UNITYSDK_OFFSET(0x191157B0)
#define MOLEMOLE_ENGINE_NAPSCENEOPTIMIZEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x19115970)

namespace MoleMole::Engine
{
	inline static constexpr unsigned int NapSceneOptimizeManager_TypeDefinitionIndex = 79414;

	class NapSceneOptimizeManager : public ::UnityEngine::MonoBehaviour
	{
	public:
		::System::Collections::Generic::List_1<::UnityEngine::Material*>* Field_5_0; // 0x18
