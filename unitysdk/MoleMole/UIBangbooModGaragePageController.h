...
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER_APPLYCHANGEBUDDY_OFFSET UNITYSDK_OFFSET(0x16EC7530)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER_CALLBUDDYREDRANGE_OFFSET UNITYSDK_OFFSET(0x16EC8DD0)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER_CLOSEDETAILWIDGET_OFFSET UNITYSDK_OFFSET(0x16EC8490)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER_CLOSEDIYWIDGET_OFFSET UNITYSDK_OFFSET(0x16EC7950)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER_CLOSEPAGE_OFFSET UNITYSDK_OFFSET(0x16EC7740)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER_CLOSETRANSFORMWIDGET_OFFSET UNITYSDK_OFFSET(0x16EC89E0)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER_GETNEWBIEDYNAMICOBJECT_OFFSET UNITYSDK_OFFSET(0x16EC9110)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x16EC5A10)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER_ONBUDDYSORTORFILTERCHANGED_OFFSET UNITYSDK_OFFSET(0x16EC8A40)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER_ONCHANGESELECTBUDDY_OFFSET UNITYSDK_OFFSET(0x16EC7140)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16EC5A20)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER_ONFAVORITEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x16EC7A20)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x16EC8D10)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER_ONRECIVEBUDDYSERVERDATA_OFFSET UNITYSDK_OFFSET(0x16EC6F90)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16EC6C20)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16EC5AB0)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16EC6B70)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER_OPENDETAILWIDGET_OFFSET UNITYSDK_OFFSET(0x16EC85A0)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER_OPENDIYWIDGET_OFFSET UNITYSDK_OFFSET(0x16EC8A90)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER_OPENTRANSFOMBUDDYPANEL_OFFSET UNITYSDK_OFFSET(0x16EC8080)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER_OPENTRANSFOMWIDGET_OFFSET UNITYSDK_OFFSET(0x16EC84F0)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER_SENDFAVORITECSREQ_OFFSET UNITYSDK_OFFSET(0x16EC7E10)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER_UPDATEBATTLEBUDDYS_OFFSET UNITYSDK_OFFSET(0x16EC66B0)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER_UPDATEFAVORITEBTNSTATE_OFFSET UNITYSDK_OFFSET(0x16EC7380)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER_UPDATEMAINBUDDY_OFFSET UNITYSDK_OFFSET(0x16EC6E10)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0x16EC6DC0)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16EC94C0)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER__ONUIINIT_B__4_1_OFFSET UNITYSDK_OFFSET(0x16EC9550)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER___BASE_GETNEWBIEDYNAMICOBJECT_OFFSET UNITYSDK_OFFSET(0x16EC9560)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16EC95F0)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x16EC9680)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16EC9710)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16EC9720)
#define MOLEMOLE_UIBANGBOOMODGARAGEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16EC9730)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooModGaragePageController_TypeDefinitionIndex = 63151;
	...
	public:
		...
		::Class_2_60638234271CCDB8_85* _view; // 0x320
		::Class_1_31414A4EF43A2EAA* _data; // 0x328
		::MoleMole::UIBangbooUpgradeWidgetController* _detailWidget; // 0x330
		::MoleMole::UIBangbooTransformWidgetController* _buddyTransformWidget; // 0x338
		::MoleMole::UIBangbooDIYWidgetWidgetController* _buddyDiyWidget; // 0x340
		::MoleMole::UIModificationShop3DModelController* _diyScene; // 0x348
		::Class_2_A67757DE8DF470D1<::Class_2_4DA7BFFCF976F7D7*>* _sorter; // 0x350
		::System::Int32 _curSelectIndex; // 0x358
		::System::Int32 _preSelectIndex; // 0x35C
		::System::Collections::Generic::List_1<::Class_2_4DA7BFFCF976F7D7*>* _battleBuddyDatas; // 0x360
		::System::Collections::Generic::List_1<::Class_2_4DA7BFFCF976F7D7*>* _sortedBattleBuddyDatas; // 0x368
		::Foundation::Coroutine::CoroutineHandle delayApplyBuddy; // 0x370
		::MoleMole::BangbooModGarageContext* _context; // 0x378
		::MoleMole::MonoGamepadNestedListDelegate* buddyGamePadList; // 0x380
