...
#define MOLEMOLE_ARCADE_BALLSRACE_CLIENT_BRGAMEMANIFEST_AWAKE_OFFSET UNITYSDK_OFFSET(0x1C54EEC0)
#define MOLEMOLE_ARCADE_BALLSRACE_CLIENT_BRGAMEMANIFEST_GET_INS_OFFSET UNITYSDK_OFFSET(0x1C54EEB0)
#define MOLEMOLE_ARCADE_BALLSRACE_CLIENT_BRGAMEMANIFEST_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1C54EF10)
#define MOLEMOLE_ARCADE_BALLSRACE_CLIENT_BRGAMEMANIFEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1C54EF60)

namespace MoleMole::Arcade::BallsRace::Client
{
	inline static constexpr unsigned int BRGameManifest_TypeDefinitionIndex = 83893;
	...
	public:
		...
		{
			return (::MoleMole::Arcade::BallsRace::Client::BRGameManifest**)Il2CppClass::FromTypeDefinitionIndex(BRGameManifest_TypeDefinitionIndex)->GetStaticField(0x49900);
		}
