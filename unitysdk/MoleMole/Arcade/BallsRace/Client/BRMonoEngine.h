...
#define MOLEMOLE_ARCADE_BALLSRACE_CLIENT_BRMONOENGINE_METHOD_6_D3129FE8DF635B48_OFFSET UNITYSDK_OFFSET(0x1CFA0760)
#define MOLEMOLE_ARCADE_BALLSRACE_CLIENT_BRMONOENGINE_METHOD_6_DF2A78D8DB25ED05_OFFSET UNITYSDK_OFFSET(0x1CFA06C0)
#define MOLEMOLE_ARCADE_BALLSRACE_CLIENT_BRMONOENGINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFA0890)

namespace MoleMole::Arcade::BallsRace::Client
{
	inline static constexpr unsigned int BRMonoEngine_TypeDefinitionIndex = 89315;
