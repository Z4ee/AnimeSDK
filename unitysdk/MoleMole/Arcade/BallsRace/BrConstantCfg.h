...
#define MOLEMOLE_ARCADE_BALLSRACE_BRCONSTANTCFG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF1E330)

namespace MoleMole::Arcade::BallsRace
{
	inline static constexpr unsigned int BrConstantCfg_TypeDefinitionIndex = 83192;
