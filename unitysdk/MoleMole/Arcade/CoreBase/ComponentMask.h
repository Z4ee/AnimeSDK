...
#define MOLEMOLE_ARCADE_COREBASE_COMPONENTMASK_EQUALS_OFFSET UNITYSDK_OFFSET(0xA5E8A0)
#define MOLEMOLE_ARCADE_COREBASE_COMPONENTMASK_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA5E8B0)
#define MOLEMOLE_ARCADE_COREBASE_COMPONENTMASK_GET_ALLFALSE_OFFSET UNITYSDK_OFFSET(0xA5E710)
#define MOLEMOLE_ARCADE_COREBASE_COMPONENTMASK_GET_ALLTRUE_OFFSET UNITYSDK_OFFSET(0xA5E780)
#define MOLEMOLE_ARCADE_COREBASE_COMPONENTMASK_GET_CAPACITY_OFFSET UNITYSDK_OFFSET(0x6F61E0)
#define MOLEMOLE_ARCADE_COREBASE_COMPONENTMASK_GET_HUMANIZEDDATA_OFFSET UNITYSDK_OFFSET(0xA5E7F0)
#define MOLEMOLE_ARCADE_COREBASE_COMPONENTMASK_GET_ITEM_OFFSET UNITYSDK_OFFSET(0xA5E800)
#define MOLEMOLE_ARCADE_COREBASE_COMPONENTMASK_METHOD_2_0147A22E503BD4DB_1_OFFSET UNITYSDK_OFFSET(0x1E2D73B0)
#define MOLEMOLE_ARCADE_COREBASE_COMPONENTMASK_METHOD_2_0147A22E503BD4DB_OFFSET UNITYSDK_OFFSET(0x1E2D7010)
#define MOLEMOLE_ARCADE_COREBASE_COMPONENTMASK_METHOD_2_5C5453F8BFC207B6_OFFSET UNITYSDK_OFFSET(0xA5EA00)
#define MOLEMOLE_ARCADE_COREBASE_COMPONENTMASK_METHOD_2_6D0360BD23602584_OFFSET UNITYSDK_OFFSET(0xA5EA10)
#define MOLEMOLE_ARCADE_COREBASE_COMPONENTMASK_METHOD_2_7D707A563DCABBD4_OFFSET UNITYSDK_OFFSET(0x1E2D70C0)
#define MOLEMOLE_ARCADE_COREBASE_COMPONENTMASK_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0xA5E990)
#define MOLEMOLE_ARCADE_COREBASE_COMPONENTMASK_METHOD_2_C3AC317E66DB45FB_OFFSET UNITYSDK_OFFSET(0x1E2D6F70)
#define MOLEMOLE_ARCADE_COREBASE_COMPONENTMASK_METHOD_2_DB89B426EC2F338A_OFFSET UNITYSDK_OFFSET(0x1E2D7460)
#define MOLEMOLE_ARCADE_COREBASE_COMPONENTMASK_METHOD_2_DB8AD7EC9C4D43ED_OFFSET UNITYSDK_OFFSET(0x1E2D7560)
#define MOLEMOLE_ARCADE_COREBASE_COMPONENTMASK_SET_ITEM_OFFSET UNITYSDK_OFFSET(0xA5E890)
#define MOLEMOLE_ARCADE_COREBASE_COMPONENTMASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E2D6260)
#define MOLEMOLE_ARCADE_COREBASE_COMPONENTMASK__CTOR_1_OFFSET UNITYSDK_OFFSET(0x6F6380)
#define MOLEMOLE_ARCADE_COREBASE_COMPONENTMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x32DFA0)

namespace MoleMole::Arcade::CoreBase
{
	inline static constexpr unsigned int ComponentMask_TypeDefinitionIndex = 29036;
