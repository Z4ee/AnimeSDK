...
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CPSKILLEFFECTMOVEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0BFB80)

namespace MoleMole::Arcade::CompanionProject
{
	inline static constexpr unsigned int CpSkillEffectMoveData_TypeDefinitionIndex = 92673;

	class CpSkillEffectMoveData : public ::MoleMole::Arcade::CompanionProject::CpSkillEffectData
	{
	public:
		::Struct_2_E614D3B245F96744 pos; // 0x28
		::Struct_2_4C8453486C91E3A1_26 posParam; // 0x30
