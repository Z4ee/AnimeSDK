...
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_COMPANIONMAPLAYOUT_AWAKE_OFFSET UNITYSDK_OFFSET(0x1E75E9E0)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_COMPANIONMAPLAYOUT_DESTROYTEMPALTEOBJECT_OFFSET UNITYSDK_OFFSET(0x1E75ED10)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_COMPANIONMAPLAYOUT_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1E75E9D0)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_COMPANIONMAPLAYOUT_INSTANTIATESELECTTEMPLATE_OFFSET UNITYSDK_OFFSET(0x1E75EF00)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_COMPANIONMAPLAYOUT_INSTANTIATETEMPLATE_OFFSET UNITYSDK_OFFSET(0x1E75EA80)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_COMPANIONMAPLAYOUT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1E75EA30)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_COMPANIONMAPLAYOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E75F090)

namespace MoleMole::Arcade::CompanionProject::Client
{
	inline static constexpr unsigned int CompanionMapLayout_TypeDefinitionIndex = 90824;
	...
	public:
		...
		{
			return (::MoleMole::Arcade::CompanionProject::Client::CompanionMapLayout**)Il2CppClass::FromTypeDefinitionIndex(CompanionMapLayout_TypeDefinitionIndex)->GetStaticField(0x4E490);
		}
