...
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_COMPANIONMAPLAYOUT_AWAKE_OFFSET UNITYSDK_OFFSET(0x1BF29410)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_COMPANIONMAPLAYOUT_DESTROYTEMPALTEOBJECT_OFFSET UNITYSDK_OFFSET(0x1BF29740)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_COMPANIONMAPLAYOUT_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1BF29400)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_COMPANIONMAPLAYOUT_INSTANTIATESELECTTEMPLATE_OFFSET UNITYSDK_OFFSET(0x1BF29930)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_COMPANIONMAPLAYOUT_INSTANTIATETEMPLATE_OFFSET UNITYSDK_OFFSET(0x1BF294B0)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_COMPANIONMAPLAYOUT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1BF29460)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_COMPANIONMAPLAYOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF29AC0)

namespace MoleMole::Arcade::CompanionProject::Client
{
	inline static constexpr unsigned int CompanionMapLayout_TypeDefinitionIndex = 85278;
	...
	public:
		...
		{
			return (::MoleMole::Arcade::CompanionProject::Client::CompanionMapLayout**)Il2CppClass::FromTypeDefinitionIndex(CompanionMapLayout_TypeDefinitionIndex)->GetStaticField(0x49D70);
		}
