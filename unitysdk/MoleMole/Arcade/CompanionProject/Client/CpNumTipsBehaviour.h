...
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_CPNUMTIPSBEHAVIOUR_BUILDLAYOUT_OFFSET UNITYSDK_OFFSET(0x1F776ED0)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_CPNUMTIPSBEHAVIOUR_FLUSH_OFFSET UNITYSDK_OFFSET(0x1F777430)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_CPNUMTIPSBEHAVIOUR_INITDATA_OFFSET UNITYSDK_OFFSET(0x1F776AD0)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_CPNUMTIPSBEHAVIOUR_INIT_OFFSET UNITYSDK_OFFSET(0x1F776A20)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_CPNUMTIPSBEHAVIOUR_METHOD_5_10E513360D352B03_OFFSET UNITYSDK_OFFSET(0x1F776BA0)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_CPNUMTIPSBEHAVIOUR_METHOD_5_9D0688AE2E08E349_OFFSET UNITYSDK_OFFSET(0x1F777480)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_CPNUMTIPSBEHAVIOUR_METHOD_5_EB2EF2323DFB43ED_OFFSET UNITYSDK_OFFSET(0x1F777950)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_CPNUMTIPSBEHAVIOUR_RELEASE_OFFSET UNITYSDK_OFFSET(0x1F776A70)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_CPNUMTIPSBEHAVIOUR_SETEXCLAMATIONMARK_OFFSET UNITYSDK_OFFSET(0x1F7771C0)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_CPNUMTIPSBEHAVIOUR_SETGLODMARK_OFFSET UNITYSDK_OFFSET(0x1F777100)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_CPNUMTIPSBEHAVIOUR_SETNUM_OFFSET UNITYSDK_OFFSET(0x1F776B20)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_CPNUMTIPSBEHAVIOUR_SETPROPSPRITE_OFFSET UNITYSDK_OFFSET(0x1F777280)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_CPNUMTIPSBEHAVIOUR_SETSYMBOL_OFFSET UNITYSDK_OFFSET(0x1F776FB0)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_CPNUMTIPSBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1F7777D0)

namespace MoleMole::Arcade::CompanionProject::Client
{
	inline static constexpr unsigned int CpNumTipsBehaviour_TypeDefinitionIndex = 94781;
	...
	public:
		...
		::System::Int32 Field_5_4; // 0x44
		::System::Boolean Field_5_11; // 0x48
		::System::Boolean Field_5_10; // 0x49
		...
		::Class_2_E26E60413FE51F20* Field_5_12; // 0x60
		::Il2CppArray<::System::Int32>* Field_5_19; // 0x68
