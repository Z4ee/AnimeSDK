...
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CPSKILLEFFECTDATA_METHOD_1_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x1D1560E0)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CPSKILLEFFECTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1560D0)

namespace MoleMole::Arcade::CompanionProject
{
	inline static constexpr unsigned int CpSkillEffectData_TypeDefinitionIndex = 89042;
