...
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CPSKILLEFFECTDATA_METHOD_1_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x1AEB1210)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CPSKILLEFFECTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEB1200)

namespace MoleMole::Arcade::CompanionProject
{
	inline static constexpr unsigned int CpSkillEffectData_TypeDefinitionIndex = 83393;
