...
#define MOLEMOLE_ARCADE_ABGAME_ABMAPCONFIGTEMPLATEEXT_MOLEMOLE_ARCADE_ABGAME_ABMAPCONFIGTEMPLATEINTERFACE_GET_ID_OFFSET UNITYSDK_OFFSET(0x1BCBF930)
#define MOLEMOLE_ARCADE_ABGAME_ABMAPCONFIGTEMPLATEEXT_ONCHECKANDBUILDCONFIGSTRUCTURE_OFFSET UNITYSDK_OFFSET(0x1BCBF360)
#define MOLEMOLE_ARCADE_ABGAME_ABMAPCONFIGTEMPLATEEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCBF0A0)

namespace MoleMole::Arcade::AbGame
{
	inline static constexpr unsigned int ABMapConfigTemplateExt_TypeDefinitionIndex = 83140;

	class ABMapConfigTemplateExt : public ::MoleMole::FlatBuffers::Config::ABMapConfigTemplate
	{
	public:
		::System::Collections::Generic::Dictionary_2<::HexagonalLib::Coordinates::Offset, ::Struct_2_749BE91557627726>* NeutralCellsDescDict; // 0x48
		::System::Collections::Generic::Dictionary_2<::HexagonalLib::Coordinates::Offset, ::Struct_2_749BE91557627726>* Deploy1PCellsDescDict; // 0x50
		::System::Collections::Generic::Dictionary_2<::HexagonalLib::Coordinates::Offset, ::Struct_2_749BE91557627726>* CellsDescDict; // 0x58
		...
		{
			return ((::System::Void(*)(::PVOID, ::Struct_2_3E75877A2888D88A_534, ::Class_0_16E4307DCC419505_13*))((::PBYTE)hIl2Cpp + MOLEMOLE_ARCADE_ABGAME_ABMAPCONFIGTEMPLATEEXT__CTOR_OFFSET))(this, data, notify);
		}
