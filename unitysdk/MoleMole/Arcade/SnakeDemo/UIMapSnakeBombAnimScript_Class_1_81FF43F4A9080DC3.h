...
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_CLASS_1_81FF43F4A9080DC3_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1E7890D0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_CLASS_1_81FF43F4A9080DC3_METHOD_1_ED7FC3204065168B_OFFSET UNITYSDK_OFFSET(0x1E789140)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_CLASS_1_81FF43F4A9080DC3__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7890C0)

namespace MoleMole::Arcade::SnakeDemo
{
	inline static constexpr unsigned int UIMapSnakeBombAnimScript_Class_1_81FF43F4A9080DC3_TypeDefinitionIndex = 91020;

	class UIMapSnakeBombAnimScript_Class_1_81FF43F4A9080DC3 : public ::System::Object
	{
	public:
		::UnityEngine::GameObject* Field_1_2; // 0x10
		::UnityEngine::UI::Image* Field_1_3; // 0x18
