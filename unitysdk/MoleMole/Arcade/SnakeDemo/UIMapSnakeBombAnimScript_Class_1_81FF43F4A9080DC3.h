...
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_CLASS_1_81FF43F4A9080DC3_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1B68ED80)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_CLASS_1_81FF43F4A9080DC3_METHOD_1_ED7FC3204065168B_OFFSET UNITYSDK_OFFSET(0x1B68EBA0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_CLASS_1_81FF43F4A9080DC3__CTOR_OFFSET UNITYSDK_OFFSET(0x1B68EB90)

namespace MoleMole::Arcade::SnakeDemo
{
	inline static constexpr unsigned int UIMapSnakeBombAnimScript_Class_1_81FF43F4A9080DC3_TypeDefinitionIndex = 85420;

	class UIMapSnakeBombAnimScript_Class_1_81FF43F4A9080DC3 : public ::System::Object
	{
	public:
		::UnityEngine::UI::Image* Field_1_3; // 0x10
		::UnityEngine::RectTransform* Field_1_5; // 0x18
