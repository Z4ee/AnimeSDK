...
#define MOLEMOLE_ARCADE_SNAKEDEMO_DEBUGFORSNAKE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1E3D1EC0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_DEBUGFORSNAKE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1E3D1EB0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_DEBUGFORSNAKE_METHOD_5_A8DD56714A34681F_OFFSET UNITYSDK_OFFSET(0x1E3D2010)
#define MOLEMOLE_ARCADE_SNAKEDEMO_DEBUGFORSNAKE_METHOD_5_F86F3C934C617D7C_OFFSET UNITYSDK_OFFSET(0x1E3D2450)
#define MOLEMOLE_ARCADE_SNAKEDEMO_DEBUGFORSNAKE_REFRESHDELAY_OFFSET UNITYSDK_OFFSET(0x1E3D2160)
#define MOLEMOLE_ARCADE_SNAKEDEMO_DEBUGFORSNAKE_REFRESHENTITYMSG_OFFSET UNITYSDK_OFFSET(0x1E3D21D0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_DEBUGFORSNAKE_REFRESHWORLDPASSTIME_OFFSET UNITYSDK_OFFSET(0x1E3D1F10)
#define MOLEMOLE_ARCADE_SNAKEDEMO_DEBUGFORSNAKE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3D22C0)

namespace MoleMole::Arcade::SnakeDemo
{
	inline static constexpr unsigned int DebugForSnake_TypeDefinitionIndex = 90948;
	...
	public:
		...
		{
			return (::MoleMole::Arcade::SnakeDemo::DebugForSnake**)Il2CppClass::FromTypeDefinitionIndex(DebugForSnake_TypeDefinitionIndex)->GetStaticField(0x4E690);
		}
