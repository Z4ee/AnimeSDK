...
#define MOLEMOLE_ARCADE_SNAKEDEMO_DEBUGFORSNAKE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1F67FFA0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_DEBUGFORSNAKE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1F67FF90)
#define MOLEMOLE_ARCADE_SNAKEDEMO_DEBUGFORSNAKE_METHOD_5_A8DD56714A34681F_OFFSET UNITYSDK_OFFSET(0x1F6800F0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_DEBUGFORSNAKE_METHOD_5_F86F3C934C617D7C_OFFSET UNITYSDK_OFFSET(0x1F680530)
#define MOLEMOLE_ARCADE_SNAKEDEMO_DEBUGFORSNAKE_REFRESHDELAY_OFFSET UNITYSDK_OFFSET(0x1F680240)
#define MOLEMOLE_ARCADE_SNAKEDEMO_DEBUGFORSNAKE_REFRESHENTITYMSG_OFFSET UNITYSDK_OFFSET(0x1F6802B0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_DEBUGFORSNAKE_REFRESHWORLDPASSTIME_OFFSET UNITYSDK_OFFSET(0x1F67FFF0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_DEBUGFORSNAKE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F6803A0)

namespace MoleMole::Arcade::SnakeDemo
{
	inline static constexpr unsigned int DebugForSnake_TypeDefinitionIndex = 94948;
	...
	public:
		...
		{
			return (::MoleMole::Arcade::SnakeDemo::DebugForSnake**)Il2CppClass::FromTypeDefinitionIndex(DebugForSnake_TypeDefinitionIndex)->GetStaticField(0x52810);
		}
