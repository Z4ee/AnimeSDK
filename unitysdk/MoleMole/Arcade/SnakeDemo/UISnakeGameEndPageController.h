...
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEGAMEENDPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1BCECB50)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEGAMEENDPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1BCECF40)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEGAMEENDPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1BCECB60)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEGAMEENDPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1BCECFD0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEGAMEENDPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCED040)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEGAMEENDPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1BCED050)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEGAMEENDPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1BCED0E0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEGAMEENDPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1BCED0F0)

namespace MoleMole::Arcade::SnakeDemo
{
	inline static constexpr unsigned int UISnakeGameEndPageController_TypeDefinitionIndex = 85415;

	class UISnakeGameEndPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_60638234271CCDB8_155* _view; // 0x310
		::MoleMole::Arcade::SnakeDemo::UISnakeDuelEndingChildWindowController* _endingCtrl; // 0x318
		::MoleMole::UISnakeDuelOnlineEndingChildWindowController* _endingOnlineCtrl; // 0x320
