...
#define MOLEMOLE_ARCADE_BALLPIT_BALLGAMERESULTENDDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD0AFE0)

namespace MoleMole::Arcade::BallPit
{
	inline static constexpr unsigned int BallGameResultEndDialogContext_TypeDefinitionIndex = 88490;

	class BallGameResultEndDialogContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::Class_3_6F28FFD006F2B451* world; // 0x28
		::System::String* RankStr; // 0x30
