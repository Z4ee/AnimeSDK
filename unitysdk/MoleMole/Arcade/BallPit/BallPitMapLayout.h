...
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITMAPLAYOUT_AWAKE_OFFSET UNITYSDK_OFFSET(0x1E76AAC0)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITMAPLAYOUT_CONVERTLOGICPOSTOLAYOUTPOS_OFFSET UNITYSDK_OFFSET(0x1E76C5D0)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITMAPLAYOUT_CONVERTSCREENPOSTOLOGICPOS_OFFSET UNITYSDK_OFFSET(0x1E76C690)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITMAPLAYOUT_DESTROYTEMPLATEOBJECT_OFFSET UNITYSDK_OFFSET(0x1E76D660)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITMAPLAYOUT_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1E76AAB0)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITMAPLAYOUT_INSTANTIATETEMPLATE_OFFSET UNITYSDK_OFFSET(0x1E76CE90)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITMAPLAYOUT_METHOD_6_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x1E76C010)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITMAPLAYOUT_METHOD_6_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x1E76DC50)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITMAPLAYOUT_METHOD_6_322660C1A07434B2_OFFSET UNITYSDK_OFFSET(0x1E76AEC0)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITMAPLAYOUT_METHOD_6_36D70E65FEC0C573_OFFSET UNITYSDK_OFFSET(0x1E76BAB0)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITMAPLAYOUT_METHOD_6_7998F8CA1E002410_OFFSET UNITYSDK_OFFSET(0x1E76C0A0)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITMAPLAYOUT_METHOD_6_8910F56557128EB6_OFFSET UNITYSDK_OFFSET(0x1E76DC40)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITMAPLAYOUT_METHOD_6_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1E76BA50)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITMAPLAYOUT_METHOD_6_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x1E76ACF0)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITMAPLAYOUT_METHOD_6_A666BD4C2D583F89_OFFSET UNITYSDK_OFFSET(0x1E76DDA0)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITMAPLAYOUT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1E76CB30)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITMAPLAYOUT_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1E76D9D0)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITMAPLAYOUT_SETCONFIG_OFFSET UNITYSDK_OFFSET(0x1E76B7A0)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITMAPLAYOUT_START_OFFSET UNITYSDK_OFFSET(0x1E76AB10)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITMAPLAYOUT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E76BEF0)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITMAPLAYOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E76DA10)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITMAPLAYOUT___BASE_CONVERTLOGICPOSTOLAYOUTPOS_OFFSET UNITYSDK_OFFSET(0x1E76DC10)

namespace MoleMole::Arcade::BallPit
{
	inline static constexpr unsigned int BallPitMapLayout_TypeDefinitionIndex = 93431;

	class BallPitMapLayout : public ::MoleMole::MiniGame::MiniGameManifest
	{
	public:
		static ::MoleMole::Arcade::BallPit::BallPitMapLayout** StaticGet_Field_6_6()
		{
			return (::MoleMole::Arcade::BallPit::BallPitMapLayout**)Il2CppClass::FromTypeDefinitionIndex(BallPitMapLayout_TypeDefinitionIndex)->GetStaticField(0x52180);
		}
		...
		::System::Collections::Generic::Queue_1<::UnityEngine::GameObject*>* Field_6_13; // 0x98
		::System::Collections::Generic::List_1<::UnityEngine::Transform*>* Field_6_12; // 0xA0
		::System::Single Field_6_19; // 0xA8
		::System::Single Field_6_18; // 0xAC
		::System::Boolean Field_6_17; // 0xB0
		::UnityEngine::Transform* Field_6_16; // 0xB8
		::UnityEngine::Transform* Field_6_23; // 0xC0
		::UnityEngine::Transform* Field_6_22; // 0xC8
		::System::Single TopPercent; // 0xD0
		::System::Single BottomPercent; // 0xD4
		::UnityEngine::Rendering::Volume* volume; // 0xD8
		::Class_4_BB295FBF5DD8DB59_1* Field_6_26; // 0xE0
		::Class_4_06287BFE0A30E0A3_1* Field_6_25; // 0xE8
		...
		::System::Collections::Generic::List_1<::Foundation::IRenderElement*>* Field_6_34; // 0x118
		::Foundation::AssetRequestHandle Field_6_33; // 0x120
		::Class_3_6F28FFD006F2B451* Field_6_39; // 0x140
		::Class_4_E9A048EC2D3C7A0F* Field_6_38; // 0x148
		::Class_1_C93DB23A802B5457* Field_6_37; // 0x150
		...
		{
			return ((::UnityEngine::Vector3(*)(::PVOID, ::Struct_2_E614D3B245F96744))((::PBYTE)hIl2Cpp + MOLEMOLE_ARCADE_BALLPIT_BALLPITMAPLAYOUT_CONVERTLOGICPOSTOLAYOUTPOS_OFFSET))(this, a1);
		}

		::Struct_2_E614D3B245F96744 ConvertScreenPosToLogicPos(::UnityEngine::Vector2 a1)
		{
			return ((::Struct_2_E614D3B245F96744(*)(::PVOID, ::UnityEngine::Vector2))((::PBYTE)hIl2Cpp + MOLEMOLE_ARCADE_BALLPIT_BALLPITMAPLAYOUT_CONVERTSCREENPOSTOLOGICPOS_OFFSET))(this, a1);
		}
		...
		{
			return ((::UnityEngine::Vector3(*)(::PVOID, ::Struct_2_E614D3B245F96744))((::PBYTE)hIl2Cpp + MOLEMOLE_ARCADE_BALLPIT_BALLPITMAPLAYOUT___BASE_CONVERTLOGICPOSTOLAYOUTPOS_OFFSET))(this, a1);
		}
