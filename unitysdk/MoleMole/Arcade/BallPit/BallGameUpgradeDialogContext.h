...
#define MOLEMOLE_ARCADE_BALLPIT_BALLGAMEUPGRADEDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D13F2A0)

namespace MoleMole::Arcade::BallPit
{
	inline static constexpr unsigned int BallGameUpgradeDialogContext_TypeDefinitionIndex = 92312;

	class BallGameUpgradeDialogContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::Class_3_6F28FFD006F2B451* world; // 0x28
		::System::Collections::Generic::List_1<::Struct_2_0DF1D818AC0BE25A>* Bullets; // 0x30
