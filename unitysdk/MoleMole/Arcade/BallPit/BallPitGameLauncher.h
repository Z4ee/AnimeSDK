...
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITGAMELAUNCHER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1E638430)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITGAMELAUNCHER_GENERATEMAINPAGECONTEXT_OFFSET UNITYSDK_OFFSET(0x1E638830)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITGAMELAUNCHER_METHOD_5_6916CB2AB9451DD7_OFFSET UNITYSDK_OFFSET(0x1E6384C0)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITGAMELAUNCHER_METHOD_5_8D51EA8930FD3172_OFFSET UNITYSDK_OFFSET(0x1E6395B0)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITGAMELAUNCHER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1E6387F0)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITGAMELAUNCHER_START_OFFSET UNITYSDK_OFFSET(0x1E638470)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITGAMELAUNCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E639560)

namespace MoleMole::Arcade::BallPit
{
	inline static constexpr unsigned int BallPitGameLauncher_TypeDefinitionIndex = 93240;
