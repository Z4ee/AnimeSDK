...
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITRENDERLAYER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1D78A2C0)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITRENDERLAYER_COPYFROM_OFFSET UNITYSDK_OFFSET(0x1D78A260)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITRENDERLAYER_COPYTOALLCHILDREN_OFFSET UNITYSDK_OFFSET(0x1D789ED0)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITRENDERLAYER_GET_MAINRENDERER_OFFSET UNITYSDK_OFFSET(0x1D789EC0)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITRENDERLAYER_METHOD_5_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0x1D78A3C0)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITRENDERLAYER_METHOD_5_FB306D946BF229A1_OFFSET UNITYSDK_OFFSET(0x1D78A4E0)
#define MOLEMOLE_ARCADE_BALLPIT_BALLPITRENDERLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D78A490)

namespace MoleMole::Arcade::BallPit
{
	inline static constexpr unsigned int BallPitRenderLayer_TypeDefinitionIndex = 89463;

	class BallPitRenderLayer : public ::UnityEngine::MonoBehaviour
	{
	public:
		::Enum_3_D9A408E8ECACCA0E Layer; // 0x18
		::System::Int32 SubLayer; // 0x1C
		::UnityEngine::Renderer* Field_5_2; // 0x20
