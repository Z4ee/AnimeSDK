...
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_GETMAXLEVEL_OFFSET UNITYSDK_OFFSET(0x187F1050)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_INITEQUIPSTAR_OFFSET UNITYSDK_OFFSET(0x187F0500)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_INITPROPERTYVIEW_OFFSET UNITYSDK_OFFSET(0x187F00B0)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x187EF540)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x187EF880)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_ONEQUIPCHANGED_OFFSET UNITYSDK_OFFSET(0x187F1130)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x187EF780)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x187EF910)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x187EF4D0)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x187EF710)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x187EFC80)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_SETEQUIPINFO_OFFSET UNITYSDK_OFFSET(0x187F1440)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_SETITEMDATA_OFFSET UNITYSDK_OFFSET(0x187EFA20)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_SETITEMINFO_OFFSET UNITYSDK_OFFSET(0x187F3E30)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_SETROLEICON_OFFSET UNITYSDK_OFFSET(0x187F1220)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_SETSTAR_OFFSET UNITYSDK_OFFSET(0x187F0E50)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_SETTITLETEXTSTATE_OFFSET UNITYSDK_OFFSET(0x187EFEB0)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_SETWEAPONINFO_OFFSET UNITYSDK_OFFSET(0x187F26A0)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x187F4110)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x187F4170)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x187F4200)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x187F42A0)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x187F4330)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x187F43C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralEquipDetailV2WidgetController_TypeDefinitionIndex = 74638;
	...
	public:
		...
		::Class_2_1CC0E2699D5FB1A6* _view; // 0x2C0
		::System::Boolean IsHideAvatarIcon; // 0x2C8
		::System::Boolean _firstTimeShow; // 0x2C9
		::Class_1_0D6706375CDAAE8C* _itemData; // 0x2D0
		::System::Collections::Generic::List_1<::Class_1_B14C7DE6F3342DD7*>* _equipStarList; // 0x2D8
