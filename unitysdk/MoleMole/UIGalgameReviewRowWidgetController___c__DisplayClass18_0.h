...
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER___C__DISPLAYCLASS18_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15F7D480)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER___C__DISPLAYCLASS18_0__PLAYVOICE_B__0_OFFSET UNITYSDK_OFFSET(0x15F7D490)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER___C__DISPLAYCLASS18_0__PLAYVOICE_G__PLAYAUDIOAFTERVO_1_OFFSET UNITYSDK_OFFSET(0x15F7D690)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgameReviewRowWidgetController___c__DisplayClass18_0_TypeDefinitionIndex = 79751;
