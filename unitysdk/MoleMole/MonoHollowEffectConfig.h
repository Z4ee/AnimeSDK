...
#define MOLEMOLE_MONOHOLLOWEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x15149570)

namespace MoleMole
{
	inline static constexpr unsigned int MonoHollowEffectConfig_TypeDefinitionIndex = 86153;
