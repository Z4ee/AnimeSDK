...
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_GET_MODEL_OFFSET UNITYSDK_OFFSET(0x16EF82D0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_INITOPTIONGIFT_OFFSET UNITYSDK_OFFSET(0x16EF8F30)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_INITPERMANENTREWARDS_OFFSET UNITYSDK_OFFSET(0x16EF9100)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_ISITEMOWNED_OFFSET UNITYSDK_OFFSET(0x16EF9B60)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_ONCLICKGETREWARD_ASYNC_OFFSET UNITYSDK_OFFSET(0x16EF9AC0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_ONCLICKGETREWARD_OFFSET UNITYSDK_OFFSET(0x16EF9600)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16EF9C80)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16EF8640)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16EF9D10)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16EF8390)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16EF8810)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_REFRESHBYCACHE_OFFSET UNITYSDK_OFFSET(0x16EF8880)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_REFRESHBYCONTEXT_OFFSET UNITYSDK_OFFSET(0x16EF87A0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16EF9D90)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER__ONUIINIT_B__4_0_OFFSET UNITYSDK_OFFSET(0x16EF9DA0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER__ONUIINIT_B__4_1_OFFSET UNITYSDK_OFFSET(0x16EF9DB0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER__REFRESHBYCACHE_B__9_0_OFFSET UNITYSDK_OFFSET(0x16EF9DC0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16EF9DD0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16EF9E60)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16EF9F00)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16EF9F90)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16EFA020)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopLevelRewardRowWidgetController_TypeDefinitionIndex = 51341;
	...
	public:
		...
		::Class_2_208CC9941471731A_369* _cachedCfg; // 0x2F8
