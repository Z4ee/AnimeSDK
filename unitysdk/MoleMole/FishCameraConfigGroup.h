...
#define MOLEMOLE_FISHCAMERACONFIGGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x161CB2E0)

namespace MoleMole
{
	inline static constexpr unsigned int FishCameraConfigGroup_TypeDefinitionIndex = 56463;
