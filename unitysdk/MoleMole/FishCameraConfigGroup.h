...
#define MOLEMOLE_FISHCAMERACONFIGGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B951B20)

namespace MoleMole
{
	inline static constexpr unsigned int FishCameraConfigGroup_TypeDefinitionIndex = 89052;
