...
#define MOLEMOLE_UIGENERAL3DMODELDIALOGPOPWINDOWCONTROLLER_GENERAL3DMODELDIALOGSUBTITLEVIEWER_HIDE_OFFSET UNITYSDK_OFFSET(0x1859DF00)
#define MOLEMOLE_UIGENERAL3DMODELDIALOGPOPWINDOWCONTROLLER_GENERAL3DMODELDIALOGSUBTITLEVIEWER_SHOW_OFFSET UNITYSDK_OFFSET(0x1859DC80)
#define MOLEMOLE_UIGENERAL3DMODELDIALOGPOPWINDOWCONTROLLER_GENERAL3DMODELDIALOGSUBTITLEVIEWER__CTOR_OFFSET UNITYSDK_OFFSET(0x1859DC70)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneral3DModelDialogPopWindowController_General3DModelDialogSubtitleViewer_TypeDefinitionIndex = 84103;
