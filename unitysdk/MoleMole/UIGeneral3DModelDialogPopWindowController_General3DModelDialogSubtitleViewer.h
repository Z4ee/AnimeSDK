...
#define MOLEMOLE_UIGENERAL3DMODELDIALOGPOPWINDOWCONTROLLER_GENERAL3DMODELDIALOGSUBTITLEVIEWER_HIDE_OFFSET UNITYSDK_OFFSET(0x151B1A20)
#define MOLEMOLE_UIGENERAL3DMODELDIALOGPOPWINDOWCONTROLLER_GENERAL3DMODELDIALOGSUBTITLEVIEWER_SHOW_OFFSET UNITYSDK_OFFSET(0x151B17A0)
#define MOLEMOLE_UIGENERAL3DMODELDIALOGPOPWINDOWCONTROLLER_GENERAL3DMODELDIALOGSUBTITLEVIEWER__CTOR_OFFSET UNITYSDK_OFFSET(0x151B1790)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneral3DModelDialogPopWindowController_General3DModelDialogSubtitleViewer_TypeDefinitionIndex = 64394;
