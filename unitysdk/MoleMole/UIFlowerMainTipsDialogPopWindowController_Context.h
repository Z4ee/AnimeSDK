...
#define MOLEMOLE_UIFLOWERMAINTIPSDIALOGPOPWINDOWCONTROLLER_CONTEXT_GET_FLOWERQUESTDETAILDATA_OFFSET UNITYSDK_OFFSET(0x17F8AF30)
#define MOLEMOLE_UIFLOWERMAINTIPSDIALOGPOPWINDOWCONTROLLER_CONTEXT_SET_FLOWERQUESTDETAILDATA_OFFSET UNITYSDK_OFFSET(0x17F8AF40)
#define MOLEMOLE_UIFLOWERMAINTIPSDIALOGPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x17F8AF50)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerMainTipsDialogPopWindowController_Context_TypeDefinitionIndex = 41033;
