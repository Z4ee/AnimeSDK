...
#define MOLEMOLE_UIFLOWERMAINTIPSDIALOGPOPWINDOWCONTROLLER_CONTEXT_GET_FLOWERQUESTDETAILDATA_OFFSET UNITYSDK_OFFSET(0x16CC36D0)
#define MOLEMOLE_UIFLOWERMAINTIPSDIALOGPOPWINDOWCONTROLLER_CONTEXT_SET_FLOWERQUESTDETAILDATA_OFFSET UNITYSDK_OFFSET(0x16CC36E0)
#define MOLEMOLE_UIFLOWERMAINTIPSDIALOGPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16CC36F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerMainTipsDialogPopWindowController_Context_TypeDefinitionIndex = 38374;
