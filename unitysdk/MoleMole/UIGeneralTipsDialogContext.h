...
#define MOLEMOLE_UIGENERALTIPSDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x17780360)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralTipsDialogContext_TypeDefinitionIndex = 57890;
