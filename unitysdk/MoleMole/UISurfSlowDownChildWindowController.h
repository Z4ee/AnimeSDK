...
#define MOLEMOLE_UISURFSLOWDOWNCHILDWINDOWCONTROLLER_GET_BUTTON_OFFSET UNITYSDK_OFFSET(0x157C0D80)
#define MOLEMOLE_UISURFSLOWDOWNCHILDWINDOWCONTROLLER_GET_EVENT_OFFSET UNITYSDK_OFFSET(0x157C0D70)
#define MOLEMOLE_UISURFSLOWDOWNCHILDWINDOWCONTROLLER_GET_KEYPANELROOT_OFFSET UNITYSDK_OFFSET(0x157C0D50)
#define MOLEMOLE_UISURFSLOWDOWNCHILDWINDOWCONTROLLER_GET_SKILLBUTTON_OFFSET UNITYSDK_OFFSET(0x157C0D30)
#define MOLEMOLE_UISURFSLOWDOWNCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x157C0D90)

namespace MoleMole
{
	inline static constexpr unsigned int UISurfSlowDownChildWindowController_TypeDefinitionIndex = 63756;

	class UISurfSlowDownChildWindowController : public ::MoleMole::UISurfAutoSkillButton_1<::Class_2_79AE422BA06F6D26_91*>
	{
	public:
		::System::Void _ctor()
		{
