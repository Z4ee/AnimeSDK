...
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRSIMPLEMODE_ONEVENTTRIGGER_OFFSET UNITYSDK_OFFSET(0x18090EC0)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRSIMPLEMODE_ONFIREPRESSEND_OFFSET UNITYSDK_OFFSET(0x18091230)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRSIMPLEMODE_ONFIREPRESSSTART_OFFSET UNITYSDK_OFFSET(0x180911F0)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRSIMPLEMODE_ONHITTARGET_OFFSET UNITYSDK_OFFSET(0x180911B0)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRSIMPLEMODE_ONSHOOTSTART_OFFSET UNITYSDK_OFFSET(0x18090F10)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRSIMPLEMODE_SETEVENTMODE_OFFSET UNITYSDK_OFFSET(0x18090E70)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRSIMPLEMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x18091270)

namespace MoleMole
{
	inline static constexpr unsigned int MonoSummerEventCrossHairSimpleMode_TypeDefinitionIndex = 78080;
