...
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRSIMPLEMODE_ONEVENTTRIGGER_OFFSET UNITYSDK_OFFSET(0x16421EA0)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRSIMPLEMODE_ONFIREPRESSEND_OFFSET UNITYSDK_OFFSET(0x16422210)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRSIMPLEMODE_ONFIREPRESSSTART_OFFSET UNITYSDK_OFFSET(0x164221D0)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRSIMPLEMODE_ONHITTARGET_OFFSET UNITYSDK_OFFSET(0x16422190)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRSIMPLEMODE_ONSHOOTSTART_OFFSET UNITYSDK_OFFSET(0x16421EF0)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRSIMPLEMODE_SETEVENTMODE_OFFSET UNITYSDK_OFFSET(0x16421E50)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRSIMPLEMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x16422250)

namespace MoleMole
{
	inline static constexpr unsigned int MonoSummerEventCrossHairSimpleMode_TypeDefinitionIndex = 83416;
