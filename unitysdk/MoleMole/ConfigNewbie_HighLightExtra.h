...
#define MOLEMOLE_CONFIGNEWBIE_HIGHLIGHTEXTRA__CTOR_OFFSET UNITYSDK_OFFSET(0x17D337B0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigNewbie_HighLightExtra_TypeDefinitionIndex = 56126;
