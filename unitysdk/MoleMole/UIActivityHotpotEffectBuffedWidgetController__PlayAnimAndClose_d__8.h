...
#define MOLEMOLE_UIACTIVITYHOTPOTEFFECTBUFFEDWIDGETCONTROLLER__PLAYANIMANDCLOSE_D__8_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x73F3B0)
#define MOLEMOLE_UIACTIVITYHOTPOTEFFECTBUFFEDWIDGETCONTROLLER__PLAYANIMANDCLOSE_D__8_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2661E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityHotpotEffectBuffedWidgetController__PlayAnimAndClose_d__8_TypeDefinitionIndex = 73722;
