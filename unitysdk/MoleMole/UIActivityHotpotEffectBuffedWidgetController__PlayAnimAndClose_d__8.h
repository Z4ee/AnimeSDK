...
#define MOLEMOLE_UIACTIVITYHOTPOTEFFECTBUFFEDWIDGETCONTROLLER__PLAYANIMANDCLOSE_D__8_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x844B10)
#define MOLEMOLE_UIACTIVITYHOTPOTEFFECTBUFFEDWIDGETCONTROLLER__PLAYANIMANDCLOSE_D__8_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x283610)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityHotpotEffectBuffedWidgetController__PlayAnimAndClose_d__8_TypeDefinitionIndex = 81021;

	struct alignas(8) UIActivityHotpotEffectBuffedWidgetController__PlayAnimAndClose_d__8
	{
		::MoleMole::UIActivityHotpotEffectBuffedWidgetController* __4__this; // 0x10
