...
class Class_2_A969C4A108E8A78F_1_Class_2_E3085A286707C63B_1;
...
#define MOLEMOLE_UIABINLEVELCAMPINFOWIDGETCONTROLLER_CANCELSELECT_OFFSET UNITYSDK_OFFSET(0x1B6D2BD0)
#define MOLEMOLE_UIABINLEVELCAMPINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1B6D1B40)
#define MOLEMOLE_UIABINLEVELCAMPINFOWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1B6D1C80)
#define MOLEMOLE_UIABINLEVELCAMPINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1B6D1BD0)
#define MOLEMOLE_UIABINLEVELCAMPINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1B6D1900)
#define MOLEMOLE_UIABINLEVELCAMPINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1B6D1AD0)
#define MOLEMOLE_UIABINLEVELCAMPINFOWIDGETCONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0x1B6D1F20)
#define MOLEMOLE_UIABINLEVELCAMPINFOWIDGETCONTROLLER_RESETCAMP_OFFSET UNITYSDK_OFFSET(0x1B6D1ED0)
#define MOLEMOLE_UIABINLEVELCAMPINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6D2E10)
#define MOLEMOLE_UIABINLEVELCAMPINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1B6D2F10)
#define MOLEMOLE_UIABINLEVELCAMPINFOWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1B6D2FA0)
#define MOLEMOLE_UIABINLEVELCAMPINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1B6D2FD0)
#define MOLEMOLE_UIABINLEVELCAMPINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1B6D3060)
#define MOLEMOLE_UIABINLEVELCAMPINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1B6D30F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIABInLevelCampInfoWidgetController_TypeDefinitionIndex = 83497;

	class UIABInLevelCampInfoWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_A969C4A108E8A78F_1* _view; // 0x2C0
		::System::Collections::Generic::List_1<::Class_2_0D31A1661D004892<::Class_2_A969C4A108E8A78F_1_Class_2_E3085A286707C63B_1*>*>* _iconWidgetList; // 0x2C8
