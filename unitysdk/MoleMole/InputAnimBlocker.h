...
#define MOLEMOLE_INPUTANIMBLOCKER__CTOR_OFFSET UNITYSDK_OFFSET(0x12BC6940)

namespace MoleMole
{
	inline static constexpr unsigned int InputAnimBlocker_TypeDefinitionIndex = 81523;
