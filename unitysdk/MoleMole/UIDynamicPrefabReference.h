...
#define MOLEMOLE_UIDYNAMICPREFABREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x14E9B480)

namespace MoleMole
{
	inline static constexpr unsigned int UIDynamicPrefabReference_TypeDefinitionIndex = 52465;
