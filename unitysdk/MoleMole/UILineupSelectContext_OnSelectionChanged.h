...
#define MOLEMOLE_UILINEUPSELECTCONTEXT_ONSELECTIONCHANGED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1783C810)
#define MOLEMOLE_UILINEUPSELECTCONTEXT_ONSELECTIONCHANGED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1783C840)
#define MOLEMOLE_UILINEUPSELECTCONTEXT_ONSELECTIONCHANGED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1783C310)
#define MOLEMOLE_UILINEUPSELECTCONTEXT_ONSELECTIONCHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1783C2F0)

namespace MoleMole
{
	inline static constexpr unsigned int UILineupSelectContext_OnSelectionChanged_TypeDefinitionIndex = 60180;
