...
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER__SHOWNPCEFFECT_D__109_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x884250)
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER__SHOWNPCEFFECT_D__109_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityRhythmClickPageController__ShowNPCEffect_d__109_TypeDefinitionIndex = 87493;
	...
	struct alignas(8) UIActivityRhythmClickPageController__ShowNPCEffect_d__109
	{
		...
		::MoleMole::Battle::Entity* npcEntity; // 0x38
		::MoleMole::UIActivityRhythmClickPageController* __4__this; // 0x40
		::MoleMole::Battle::Entity* effectEntity; // 0x48
		::System::String* effectName; // 0x50
