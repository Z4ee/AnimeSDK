...
#define MOLEMOLE_UISWEEPREWARDCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xE4645B0)

namespace MoleMole
{
	inline static constexpr unsigned int UISweepRewardContext_TypeDefinitionIndex = 54749;

	class UISweepRewardContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::Collections::Generic::List_1<::Class_1_516A565475879095<::System::UInt32, ::Class_3_1A345EAE5F749316_11*>*>* RewardList; // 0x28
