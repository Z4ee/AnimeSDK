...
#define MOLEMOLE_UIGENERALROLESELECTLISTWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x195FF250)
#define MOLEMOLE_UIGENERALROLESELECTLISTWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x195FF2C0)
#define MOLEMOLE_UIGENERALROLESELECTLISTWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x195FF830)
#define MOLEMOLE_UIGENERALROLESELECTLISTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x195FF360)
#define MOLEMOLE_UIGENERALROLESELECTLISTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x195FF460)
#define MOLEMOLE_UIGENERALROLESELECTLISTWIDGETCONTROLLER_SETMODE_OFFSET UNITYSDK_OFFSET(0x195FF690)
#define MOLEMOLE_UIGENERALROLESELECTLISTWIDGETCONTROLLER_SETROLEFOCUS_OFFSET UNITYSDK_OFFSET(0x195FF760)
#define MOLEMOLE_UIGENERALROLESELECTLISTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x195FF8D0)
#define MOLEMOLE_UIGENERALROLESELECTLISTWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x195FF930)
#define MOLEMOLE_UIGENERALROLESELECTLISTWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x195FF9D0)
#define MOLEMOLE_UIGENERALROLESELECTLISTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x195FFA60)
#define MOLEMOLE_UIGENERALROLESELECTLISTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x195FFB00)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralRoleSelectListWidgetController_TypeDefinitionIndex = 83239;
