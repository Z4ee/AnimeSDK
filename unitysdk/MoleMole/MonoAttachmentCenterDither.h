...
#define MOLEMOLE_MONOATTACHMENTCENTERDITHER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x16D53660)
#define MOLEMOLE_MONOATTACHMENTCENTERDITHER_METHOD_5_0869E1192F8E01DF_OFFSET UNITYSDK_OFFSET(0x16D536E0)
#define MOLEMOLE_MONOATTACHMENTCENTERDITHER_METHOD_5_39FD7185C859CEAD_OFFSET UNITYSDK_OFFSET(0x16D53B00)
#define MOLEMOLE_MONOATTACHMENTCENTERDITHER_METHOD_5_870AF3CD1D0A67B1_OFFSET UNITYSDK_OFFSET(0x16D537A0)
#define MOLEMOLE_MONOATTACHMENTCENTERDITHER_METHOD_5_8F7825DAFFB9B517_OFFSET UNITYSDK_OFFSET(0x16D53FC0)
#define MOLEMOLE_MONOATTACHMENTCENTERDITHER__CTOR_OFFSET UNITYSDK_OFFSET(0x16D53750)

namespace MoleMole
{
	inline static constexpr unsigned int MonoAttachmentCenterDither_TypeDefinitionIndex = 50377;
