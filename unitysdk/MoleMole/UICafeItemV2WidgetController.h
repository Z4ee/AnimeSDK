...
class Class_2_94D5884806027679_6;
namespace MoleMole { class UIControlReference; }
namespace System { class Object; }

#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175BD4F0)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x175BE050)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x175BD6A0)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x175BD620)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER_SETTRANSGRAY_OFFSET UNITYSDK_OFFSET(0x175BDDA0)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x175BE130)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER__ONCREATEVIEW_B__2_0_OFFSET UNITYSDK_OFFSET(0x175BE140)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175BE150)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x175BE1E0)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x175BE270)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x175BE310)

namespace MoleMole
{
	inline static constexpr unsigned int UICafeItemV2WidgetController_TypeDefinitionIndex = 64744;

	class UICafeItemV2WidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_94D5884806027679_6* _view; // 0x2F0
