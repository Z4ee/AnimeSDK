...
class Class_2_C7387D40D4120A48_14_Class_2_870C11D2A8D09105;
...
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER_BINDEVENT_OFFSET UNITYSDK_OFFSET(0x1579C880)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER_ENABLEEMPTY_OFFSET UNITYSDK_OFFSET(0x1579CAA0)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER_GETMAINBUTTON_OFFSET UNITYSDK_OFFSET(0x1579CAF0)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER_GET_CURRENTCARDSUMMARY_OFFSET UNITYSDK_OFFSET(0x1579C7F0)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1579C710)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER_GET__VIEW_OFFSET UNITYSDK_OFFSET(0x1579C780)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER_INITITEMROOTSTATE_OFFSET UNITYSDK_OFFSET(0x1579F3C0)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER_ISSELECTED_OFFSET UNITYSDK_OFFSET(0x1579F490)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1579CA10)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER_ONROLE1CLICK_OFFSET UNITYSDK_OFFSET(0x157A0810)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER_ONROLE2CLICK_OFFSET UNITYSDK_OFFSET(0x157A0860)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER_ONROLE3CLICK_OFFSET UNITYSDK_OFFSET(0x157A08B0)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER_ONROLECLICK_OFFSET UNITYSDK_OFFSET(0x157A0770)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1579CBB0)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1579C810)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER_REFESHITEMROOTVIEW_OFFSET UNITYSDK_OFFSET(0x157A0520)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER_REFRESHCARDIMG_OFFSET UNITYSDK_OFFSET(0x1579F810)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER_REFRESHEMPTYVIEW_OFFSET UNITYSDK_OFFSET(0x1579D1B0)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER_REFRESHROLE_OFFSET UNITYSDK_OFFSET(0x157A01D0)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1579D850)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER_SETCARDCLICKFUNC_OFFSET UNITYSDK_OFFSET(0x1579F370)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER_SETCLICKENABLE_OFFSET UNITYSDK_OFFSET(0x1579F650)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER_SET_CURRENTCARDSUMMARY_OFFSET UNITYSDK_OFFSET(0x1579C800)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER_TURNITEMROOTACTIVE_OFFSET UNITYSDK_OFFSET(0x157A05F0)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER__BINDEVENT_B__23_0_OFFSET UNITYSDK_OFFSET(0x157A0910)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x157A0900)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER__TURNITEMROOTACTIVE_B__40_0_OFFSET UNITYSDK_OFFSET(0x157A0980)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x157A0A20)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x157A0AC0)
#define MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x157A0B60)

namespace MoleMole
{
	inline static constexpr unsigned int UISelectMonsterCardWidgetController_TypeDefinitionIndex = 62380;
	...
	public:
		...
		::System::Void RefreshRole(::Class_2_C7387D40D4120A48_14_Class_2_870C11D2A8D09105* view, ::System::Boolean enable, ::System::Int32 count1, ::System::Int32 count2, ::Class_2_208CC9941471731A_131* itemConfig, ::UnityEngine::Events::UnityAction* callback)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_C7387D40D4120A48_14_Class_2_870C11D2A8D09105*, ::System::Boolean, ::System::Int32, ::System::Int32, ::Class_2_208CC9941471731A_131*, ::UnityEngine::Events::UnityAction*))((::PBYTE)hIl2Cpp + MOLEMOLE_UISELECTMONSTERCARDWIDGETCONTROLLER_REFRESHROLE_OFFSET))(this, view, enable, count1, count2, itemConfig, callback);
		}
