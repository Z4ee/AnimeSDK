...
#define MOLEMOLE_STATICCOLORMATERIALMODIFIER_METHOD_2_3750F4A9FEA7F5EF_OFFSET UNITYSDK_OFFSET(0x88E8B0)
#define MOLEMOLE_STATICCOLORMATERIALMODIFIER_METHOD_2_C446CE6A5E1982BC_OFFSET UNITYSDK_OFFSET(0x88E910)
#define MOLEMOLE_STATICCOLORMATERIALMODIFIER_METHOD_2_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x88E8C0)
#define MOLEMOLE_STATICCOLORMATERIALMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x88E880)

namespace MoleMole
{
	inline static constexpr unsigned int StaticColorMaterialModifier_TypeDefinitionIndex = 85472;
	...
	struct alignas(8) StaticColorMaterialModifier
	{
		...
		{
			return ((::Class_1_D66755A4450D1F25*(*)(::PVOID, ::Enum_3_FA887B12EB8EFCE2, ::MoleMole::MonoRenderHandler*))((::PBYTE)hIl2Cpp + MOLEMOLE_STATICCOLORMATERIALMODIFIER_METHOD_2_3750F4A9FEA7F5EF_OFFSET))(this, a1, a2);
		}
