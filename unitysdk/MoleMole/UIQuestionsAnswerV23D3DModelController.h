...
#define MOLEMOLE_UIQUESTIONSANSWERV23D3DMODELCONTROLLER_CREATEUIQUESTIONSANSWERSCREENWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x15DC5AA0)
#define MOLEMOLE_UIQUESTIONSANSWERV23D3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15DC5B50)
#define MOLEMOLE_UIQUESTIONSANSWERV23D3DMODELCONTROLLER___BASE_CREATEUIQUESTIONSANSWERSCREENWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x15DC5BB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerV23D3DModelController_TypeDefinitionIndex = 68357;
