...
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_DOFADEOUTANIM_OFFSET UNITYSDK_OFFSET(0x155E24E0)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x155E1840)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_LOOPBLENDTOENDANIM_OFFSET UNITYSDK_OFFSET(0x155E23B0)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x155E1A30)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_ONSTOPLOOPANIM_OFFSET UNITYSDK_OFFSET(0x155E1FA0)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x155E1AC0)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x155E1850)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x155E19E0)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_PLAYFADEINANDLOOPANIM_OFFSET UNITYSDK_OFFSET(0x155E1D50)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_PLAYFADEOUTANIM_OFFSET UNITYSDK_OFFSET(0x155E20D0)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_STOPALLANIM_OFFSET UNITYSDK_OFFSET(0x155E1C10)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_SYNCTRANSFORM_OFFSET UNITYSDK_OFFSET(0x155E2570)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_WAITFORANIMATION_OFFSET UNITYSDK_OFFSET(0x155E2050)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x155E2970)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER__WAITFORANIMATION_B__20_0_OFFSET UNITYSDK_OFFSET(0x155E2A50)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x155E2A80)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x155E2B10)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x155E2B20)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x155E2B30)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowTvSelect3DModelController_TypeDefinitionIndex = 39315;

	class UIHollowTvSelect3DModelController : public ::MoleMole::UIBase3DModelController
	{
	public:
		::UnityEngine::Camera* _chessboardCamera; // 0x358
		::Class_1_E4B28BF4798FAC79* _animSyncer; // 0x360
		::UnityEngine::AnimationState* _loopState_QueuedClone; // 0x368
		::Foundation::Coroutine::CoroutineHandle _loopDelayEndHandler; // 0x370
		::UnityEngine::Coroutine* _loopQueuedHandler; // 0x378
		::System::String* FADE_OUT_ANIM_NAME; // 0x380
		::System::String* LOOP_ANIM_NAME; // 0x388
		::Class_2_424C59E7A53DF715* _view; // 0x390
