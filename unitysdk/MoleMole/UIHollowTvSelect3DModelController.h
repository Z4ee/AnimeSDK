...
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_DOFADEOUTANIM_OFFSET UNITYSDK_OFFSET(0x17C05470)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x17C04760)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_LOOPBLENDTOENDANIM_OFFSET UNITYSDK_OFFSET(0x17C05340)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17C04950)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_ONSTOPLOOPANIM_OFFSET UNITYSDK_OFFSET(0x17C04EC0)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17C049E0)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17C04770)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17C04900)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_PLAYFADEINANDLOOPANIM_OFFSET UNITYSDK_OFFSET(0x17C04C70)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_PLAYFADEOUTANIM_OFFSET UNITYSDK_OFFSET(0x17C04FF0)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_STOPALLANIM_OFFSET UNITYSDK_OFFSET(0x17C04B30)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_SYNCTRANSFORM_OFFSET UNITYSDK_OFFSET(0x17C05500)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_WAITFORANIMATION_OFFSET UNITYSDK_OFFSET(0x17C04F70)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17C058E0)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER__WAITFORANIMATION_B__20_0_OFFSET UNITYSDK_OFFSET(0x17C059C0)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17C059F0)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17C05A80)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17C05A90)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17C05AA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowTvSelect3DModelController_TypeDefinitionIndex = 64372;
