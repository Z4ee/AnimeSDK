...
#define MOLEMOLE_UICINEMADATEPLAYWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x14C0D520)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaDatePlayWidgetContext_TypeDefinitionIndex = 72121;
