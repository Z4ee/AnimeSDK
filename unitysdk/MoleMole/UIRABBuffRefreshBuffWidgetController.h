...
#define MOLEMOLE_UIRABBUFFREFRESHBUFFWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x156109C0)
#define MOLEMOLE_UIRABBUFFREFRESHBUFFWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15610A30)
#define MOLEMOLE_UIRABBUFFREFRESHBUFFWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15610AD0)
#define MOLEMOLE_UIRABBUFFREFRESHBUFFWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15610C80)
#define MOLEMOLE_UIRABBUFFREFRESHBUFFWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15610CE0)
#define MOLEMOLE_UIRABBUFFREFRESHBUFFWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15610D80)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABBuffRefreshBuffWidgetController_TypeDefinitionIndex = 80844;
