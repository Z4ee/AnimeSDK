...
#define MOLEMOLE_UIGALGAMEREVIEWDIALOGPOPWINDOWCONTROLLER_GETMODELICON_OFFSET UNITYSDK_OFFSET(0x169AC840)
#define MOLEMOLE_UIGALGAMEREVIEWDIALOGPOPWINDOWCONTROLLER_GETVOICEICON_OFFSET UNITYSDK_OFFSET(0x169AC7F0)
#define MOLEMOLE_UIGALGAMEREVIEWDIALOGPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x169AB990)
#define MOLEMOLE_UIGALGAMEREVIEWDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x169AB980)
#define MOLEMOLE_UIGALGAMEREVIEWDIALOGPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x169ABB60)
#define MOLEMOLE_UIGALGAMEREVIEWDIALOGPOPWINDOWCONTROLLER_MODIFYLISTWITHCALLBACK_OFFSET UNITYSDK_OFFSET(0x169AC890)
#define MOLEMOLE_UIGALGAMEREVIEWDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x169AC0F0)
#define MOLEMOLE_UIGALGAMEREVIEWDIALOGPOPWINDOWCONTROLLER_ONGAMEPADMODULEDESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x169ACDC0)
#define MOLEMOLE_UIGALGAMEREVIEWDIALOGPOPWINDOWCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x169ACA80)
#define MOLEMOLE_UIGALGAMEREVIEWDIALOGPOPWINDOWCONTROLLER_ONGAMEPADSELECTITEMCHANGE_OFFSET UNITYSDK_OFFSET(0x169ACBD0)
#define MOLEMOLE_UIGALGAMEREVIEWDIALOGPOPWINDOWCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x169AC180)
#define MOLEMOLE_UIGALGAMEREVIEWDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x169AC4E0)
#define MOLEMOLE_UIGALGAMEREVIEWDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x169AB9A0)
#define MOLEMOLE_UIGALGAMEREVIEWDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x169ACF10)
#define MOLEMOLE_UIGALGAMEREVIEWDIALOGPOPWINDOWCONTROLLER__MODIFYLISTWITHCALLBACK_B__13_0_OFFSET UNITYSDK_OFFSET(0x169ACF20)
#define MOLEMOLE_UIGALGAMEREVIEWDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x169AD1B0)
#define MOLEMOLE_UIGALGAMEREVIEWDIALOGPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULEDESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x169AD240)
#define MOLEMOLE_UIGALGAMEREVIEWDIALOGPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x169AD2F0)
#define MOLEMOLE_UIGALGAMEREVIEWDIALOGPOPWINDOWCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x169AD3A0)
#define MOLEMOLE_UIGALGAMEREVIEWDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x169AD430)
#define MOLEMOLE_UIGALGAMEREVIEWDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x169AD440)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgameReviewDialogPopWindowController_TypeDefinitionIndex = 39647;
	...
	public:
		...
		{
			return (::UnityEngine::Sprite**)Il2CppClass::FromTypeDefinitionIndex(UIGalgameReviewDialogPopWindowController_TypeDefinitionIndex)->GetStaticField(0x407F0);
		}
		static ::UnityEngine::Sprite** StaticGet_voiceIcon()
		{
			return (::UnityEngine::Sprite**)Il2CppClass::FromTypeDefinitionIndex(UIGalgameReviewDialogPopWindowController_TypeDefinitionIndex)->GetStaticField(0x407F8);
		}
		// static const ::System::String* _VOICE_ICON_SPRITE_PATH; // 0x0
		// static const ::System::String* _MODEL_ICON_SPRITE_PATH; // 0x0
		::Class_2_15D211EB7129E545* _view; // 0x310
		::System::Action* _closeCallback; // 0x318
		::Foundation::AssetRequestHandle voiceHandler; // 0x320
		::Foundation::AssetRequestHandle modelHandler; // 0x340
		::System::Int32 _gamepadSelectIdx; // 0x360
