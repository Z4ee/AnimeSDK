...
#define MOLEMOLE_UILIVEHOUSEINGAMEMULTIPLETRACKWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x169BDE70)

namespace MoleMole
{
	inline static constexpr unsigned int UILiveHouseInGameMultipleTrackWidgetController_Context_TypeDefinitionIndex = 42511;
