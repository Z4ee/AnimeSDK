...
class Class_2_82E7DB6BA9499BE4_6;
...
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_CLEARWRONGTIPS_OFFSET UNITYSDK_OFFSET(0x15111F30)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_GETCURSELECTEDCOUNT_OFFSET UNITYSDK_OFFSET(0x15113980)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_GETORADDWIDGET_OFFSET UNITYSDK_OFFSET(0x15112B60)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_GET_MODEL_OFFSET UNITYSDK_OFFSET(0x151126B0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_GET_QAMAP_OFFSET UNITYSDK_OFFSET(0x15112AA0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_INITOPTIONS_OFFSET UNITYSDK_OFFSET(0x15112EC0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_ONCLICKNEXTOREND_OFFSET UNITYSDK_OFFSET(0x15111800)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15112770)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_ONOPTIONSELECTED_OFFSET UNITYSDK_OFFSET(0x15113600)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x151128A0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15112800)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x151116F0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_REFRESHBYCTX_OFFSET UNITYSDK_OFFSET(0x15112900)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_REFRESHDESC_OFFSET UNITYSDK_OFFSET(0x15112D00)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_REFRESHQUESTION_OFFSET UNITYSDK_OFFSET(0x15111F90)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_REFRESHSELECTIONACTIVE_OFFSET UNITYSDK_OFFSET(0x15113030)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_REFRESHSUBMITBTN_OFFSET UNITYSDK_OFFSET(0x15113460)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_SHOWSETTLETEMP_OFFSET UNITYSDK_OFFSET(0x15112640)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_SHOWSUBMITORNEXTBTN_OFFSET UNITYSDK_OFFSET(0x15112550)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15113A80)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15113AF0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15113B80)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15113C20)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15113CB0)

namespace MoleMole
{
	inline static constexpr unsigned int UISearchObjectQuestionWidgetController_TypeDefinitionIndex = 57132;

	class UISearchObjectQuestionWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_82E7DB6BA9499BE4_6* _view; // 0x2F0
		...
		::Class_2_208CC9941471731A_436* m_groupCfg; // 0x330
		...
		{
			return ((::Class_1_6776E23B83545D72*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_GET_QAMAP_OFFSET))(this);
		}
