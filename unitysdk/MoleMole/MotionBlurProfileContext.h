...
#define MOLEMOLE_MOTIONBLURPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x12BD7480)

namespace MoleMole
{
	inline static constexpr unsigned int MotionBlurProfileContext_TypeDefinitionIndex = 72515;
