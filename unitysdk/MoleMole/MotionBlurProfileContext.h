...
#define MOLEMOLE_MOTIONBLURPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x160624B0)

namespace MoleMole
{
	inline static constexpr unsigned int MotionBlurProfileContext_TypeDefinitionIndex = 65124;
