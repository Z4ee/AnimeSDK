...
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS58_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15199A00)
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS58_0__GACHA_B__1_OFFSET UNITYSDK_OFFSET(0x15199C30)
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS58_0__GACHA_G__QUICKBUYORGACHA_0_OFFSET UNITYSDK_OFFSET(0x15199A10)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaPageController___c__DisplayClass58_0_TypeDefinitionIndex = 45786;
