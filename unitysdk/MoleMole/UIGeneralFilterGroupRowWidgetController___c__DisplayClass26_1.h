...
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER___C__DISPLAYCLASS26_1__CTOR_OFFSET UNITYSDK_OFFSET(0x15F8C3F0)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER___C__DISPLAYCLASS26_1__REFRESHITEMS_B__0_OFFSET UNITYSDK_OFFSET(0x15F8C400)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralFilterGroupRowWidgetController___c__DisplayClass26_1_TypeDefinitionIndex = 51548;
