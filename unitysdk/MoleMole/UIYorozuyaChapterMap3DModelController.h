...
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_ABYSSTONORMAL3D_OFFSET UNITYSDK_OFFSET(0x10AF3A60)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_CHECKCUBEMESHRENDER_OFFSET UNITYSDK_OFFSET(0x10AF3570)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_GETANCHORPOINTS_OFFSET UNITYSDK_OFFSET(0x10AF1A50)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_GETCUBEGRIDFADEOUTDURATION_OFFSET UNITYSDK_OFFSET(0x10AF2900)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_GETRALLYWIDGETAUTOOPENDELAY_OFFSET UNITYSDK_OFFSET(0x10AF4170)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_GETVOLUMECURVEVALUE_OFFSET UNITYSDK_OFFSET(0x10AF38A0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x10AEFEC0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_INITCITYHOLLOWMAP_OFFSET UNITYSDK_OFFSET(0x10AF1AA0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_KILLMAPTIPSSHOWDELAY_OFFSET UNITYSDK_OFFSET(0x10AF37E0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x10AF1360)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_LOADMATERIALPROPERTYANDTEXTURE_OFFSET UNITYSDK_OFFSET(0x10AF20F0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_ONALLSPHEREHIDE_OFFSET UNITYSDK_OFFSET(0x10AF3480)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_ONALLSPHERESHOW_OFFSET UNITYSDK_OFFSET(0x10AF36B0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_ONCLICK_OFFSET UNITYSDK_OFFSET(0x10AF1800)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x10AF0500)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x10AF0590)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x10AF06A0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x10AEFEE0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x10AF04B0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_PLAYHIDEMAP_OFFSET UNITYSDK_OFFSET(0x10AF32C0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_PLAYSPHERETRACKFADEANI_OFFSET UNITYSDK_OFFSET(0x10AF2950)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_PLAYSTARTMAP_OFFSET UNITYSDK_OFFSET(0x10AF2E40)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_REFRESHREFLECTIONPROBE_OFFSET UNITYSDK_OFFSET(0x10AF16D0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_REGISTERVOLUME_OFFSET UNITYSDK_OFFSET(0x10AF0330)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_RESETVOLUME_OFFSET UNITYSDK_OFFSET(0x10AF0880)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_SETCONTINER_OFFSET UNITYSDK_OFFSET(0x10AF1A00)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_SETCUBEGRIDEMATPROPERTY_OFFSET UNITYSDK_OFFSET(0x10AF3D50)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_SETSOUNDWILLHIDESPHERE_OFFSET UNITYSDK_OFFSET(0x10AF1D10)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_SETSOUNDWILLSHOWSPHERE_OFFSET UNITYSDK_OFFSET(0x10AF1F00)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_SETYOROZUYACAMERA_OFFSET UNITYSDK_OFFSET(0x10AF1760)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x10AEFED0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_SHOWCURRENTSPHERE_OFFSET UNITYSDK_OFFSET(0x10AF2A20)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_SWITCHHOLLOWGROUP_OFFSET UNITYSDK_OFFSET(0x10AF3990)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_TICKENDMAP_OFFSET UNITYSDK_OFFSET(0x10AF1130)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_TICKSTARTMAP_OFFSET UNITYSDK_OFFSET(0x10AF0F10)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_TRYHIDEALLSPHEREANDSHOWNEW_OFFSET UNITYSDK_OFFSET(0x10AF25B0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_UPDATESPHERESINK_OFFSET UNITYSDK_OFFSET(0x10AF0960)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_UPDATETEST_OFFSET UNITYSDK_OFFSET(0x10AF2840)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_UPDATEVOLUME_OFFSET UNITYSDK_OFFSET(0x10AF13B0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x10AF0900)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x10AF4300)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x10AF41D0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER__SHOWCURRENTSPHERE_B__30_0_OFFSET UNITYSDK_OFFSET(0x10AF43E0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER__TRYHIDEALLSPHEREANDSHOWNEW_B__25_0_OFFSET UNITYSDK_OFFSET(0x10AF4310)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x10AF4420)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x10AF44B0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x10AF4570)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x10AF4580)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x10AF4590)

namespace MoleMole
{
	inline static constexpr unsigned int UIYorozuyaChapterMap3DModelController_TypeDefinitionIndex = 73884;
	...
	public:
		...
		::Class_2_79F6D62CE30E3F8E_173* _view; // 0x380
		...
		::Class_2_208CC9941471731A_784* preSelectChapter; // 0x430
		...
		::System::Boolean LoadMaterialPropertyAndTexture(::Class_2_208CC9941471731A_784* config, ::System::Boolean setStart, ::System::Boolean setEnd)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_2_208CC9941471731A_784*, ::System::Boolean, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_LOADMATERIALPROPERTYANDTEXTURE_OFFSET))(this, config, setStart, setEnd);
		}
