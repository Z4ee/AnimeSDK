...
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_ATTACHEFFECT_OFFSET UNITYSDK_OFFSET(0x1417FEB0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_CONSTRUCTNPCDATA_OFFSET UNITYSDK_OFFSET(0x1417F320)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_EXECUTEDELAYEDLASER_OFFSET UNITYSDK_OFFSET(0x14180360)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_DAMAGEWHENESCAPE_OFFSET UNITYSDK_OFFSET(0x1417EB50)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_DAMAGE_OFFSET UNITYSDK_OFFSET(0x1417EB30)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_ENTITYTAG_OFFSET UNITYSDK_OFFSET(0x1417EC10)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_FEVERREWARD_OFFSET UNITYSDK_OFFSET(0x1417EB10)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_MOVESPEED_OFFSET UNITYSDK_OFFSET(0x1417EAD0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_MOVETIMER_OFFSET UNITYSDK_OFFSET(0x1417EB70)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_ONBEFOREMOVEEVENT_OFFSET UNITYSDK_OFFSET(0x1417EBD0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_ONCREATEDEVENT_OFFSET UNITYSDK_OFFSET(0x1417EBF0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_ONDAMAGEDCAMERASHAKEKEY_OFFSET UNITYSDK_OFFSET(0x1417EC70)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_ONDAMAGEDEFFECTKEY_OFFSET UNITYSDK_OFFSET(0x1417EC30)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_ONDAMAGEDEVENT_OFFSET UNITYSDK_OFFSET(0x1417EB90)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_ONDEATHBODYEFFECTKEY_OFFSET UNITYSDK_OFFSET(0x1417EC90)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_ONDEATHEVENT_OFFSET UNITYSDK_OFFSET(0x1417EBB0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_ONESCAPEEFFECTKEY_OFFSET UNITYSDK_OFFSET(0x1417ECD0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_ONFEVERDAMAGEDEFFECTKEY_OFFSET UNITYSDK_OFFSET(0x1417EC50)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_ONFEVERDEATHBODYEFFECTKEY_OFFSET UNITYSDK_OFFSET(0x1417ECB0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_REWARD_OFFSET UNITYSDK_OFFSET(0x1417EAF0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GRIDDIRTOVECTOR2INT_OFFSET UNITYSDK_OFFSET(0x1417F1C0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GRIDLINKHELPER_OFFSET UNITYSDK_OFFSET(0x1417F7B0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_INIT_OFFSET UNITYSDK_OFFSET(0x1417F860)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_MOVEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1417EE30)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_MOVE_OFFSET UNITYSDK_OFFSET(0x1417ECF0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_ONATTACHHACKSHARDEDINFO_OFFSET UNITYSDK_OFFSET(0x14180000)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_ONUPDATEINTERNAL_OFFSET UNITYSDK_OFFSET(0x14180180)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SETEFFECT_OFFSET UNITYSDK_OFFSET(0x1417FF60)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_DAMAGEWHENESCAPE_OFFSET UNITYSDK_OFFSET(0x1417EB60)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_DAMAGE_OFFSET UNITYSDK_OFFSET(0x1417EB40)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_ENTITYTAG_OFFSET UNITYSDK_OFFSET(0x1417EC20)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_FEVERREWARD_OFFSET UNITYSDK_OFFSET(0x1417EB20)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_MOVESPEED_OFFSET UNITYSDK_OFFSET(0x1417EAE0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_MOVETIMER_OFFSET UNITYSDK_OFFSET(0x1417EB80)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_ONBEFOREMOVEEVENT_OFFSET UNITYSDK_OFFSET(0x1417EBE0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_ONCREATEDEVENT_OFFSET UNITYSDK_OFFSET(0x1417EC00)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_ONDAMAGEDCAMERASHAKEKEY_OFFSET UNITYSDK_OFFSET(0x1417EC80)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_ONDAMAGEDEFFECTKEY_OFFSET UNITYSDK_OFFSET(0x1417EC40)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_ONDAMAGEDEVENT_OFFSET UNITYSDK_OFFSET(0x1417EBA0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_ONDEATHBODYEFFECTKEY_OFFSET UNITYSDK_OFFSET(0x1417ECA0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_ONDEATHEVENT_OFFSET UNITYSDK_OFFSET(0x1417EBC0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_ONESCAPEEFFECTKEY_OFFSET UNITYSDK_OFFSET(0x1417ECE0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_ONFEVERDAMAGEDEFFECTKEY_OFFSET UNITYSDK_OFFSET(0x1417EC60)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_ONFEVERDEATHBODYEFFECTKEY_OFFSET UNITYSDK_OFFSET(0x1417ECC0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_REWARD_OFFSET UNITYSDK_OFFSET(0x1417EB00)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_TAKEDAMAGE_OFFSET UNITYSDK_OFFSET(0x1417FAD0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x141803E0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY___BASE_MOVE_OFFSET UNITYSDK_OFFSET(0x14180440)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY___BASE_ONATTACHHACKSHARDEDINFO_OFFSET UNITYSDK_OFFSET(0x14180450)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY___BASE_ONUPDATEINTERNAL_OFFSET UNITYSDK_OFFSET(0x141804E0)

namespace MoleMole
{
	inline static constexpr unsigned int HackerGameNpcChessEntity_TypeDefinitionIndex = 87576;

	class HackerGameNpcChessEntity : public ::MoleMole::HackerGameChessEntity
	{
	public:
		// static const ::System::Int32 playbackSpeedId = 0x1; // 0x0
		::System::String* _OnEscapeEffectKey_k__BackingField; // 0x50
		::System::String* _OnDamagedCameraShakeKey_k__BackingField; // 0x58
		::System::String* _EntityTag_k__BackingField; // 0x60
		::System::String* _OnFeverDamagedEffectKey_k__BackingField; // 0x68
		::MoleMole::HackerGameBaseDamage* _DamageWhenEscape_k__BackingField; // 0x70
		::System::String* _OnFeverDeathBodyEffectKey_k__BackingField; // 0x78
		::System::String* _OnDeathBodyEffectKey_k__BackingField; // 0x80
		::System::Collections::Generic::HashSet_1<::MoleMole::HollowChessboard::HollowCell>* DamagedBodyPart; // 0x88
		::System::String* _OnDamagedEvent_k__BackingField; // 0x90
		::MoleMole::HackerGameBaseDamage* _Damage_k__BackingField; // 0x98
		::System::String* _OnBeforeMoveEvent_k__BackingField; // 0xA0
		::System::String* _OnDeathEvent_k__BackingField; // 0xA8
		::System::String* _OnCreatedEvent_k__BackingField; // 0xB0
		::System::Collections::IEnumerator* DeathEnumerator; // 0xB8
		::System::String* _OnDamagedEffectKey_k__BackingField; // 0xC0
		::System::Int32 _Reward_k__BackingField; // 0xC8
		::System::Int32 _MoveSpeed_k__BackingField; // 0xCC
		::System::Int32 _MoveTimer_k__BackingField; // 0xD0
		::System::Int32 _FeverReward_k__BackingField; // 0xD4
		...
		::System::Void Init(::Class_5_FCAF801AC482D3B5* chessboard, ::System::UInt32 entityID)
		{
			return ((::System::Void(*)(::PVOID, ::Class_5_FCAF801AC482D3B5*, ::System::UInt32))((::PBYTE)hIl2Cpp + MOLEMOLE_HACKERGAMENPCCHESSENTITY_INIT_OFFSET))(this, chessboard, entityID);
		}
