...
#define MOLEMOLE_UICAMPIDLEPAGECONTROLLER___C__DISPLAYCLASS35_0__CTOR_OFFSET UNITYSDK_OFFSET(0x170A8BB0)
#define MOLEMOLE_UICAMPIDLEPAGECONTROLLER___C__DISPLAYCLASS35_0__ONCLICKSTARTBATTLE_B__0_OFFSET UNITYSDK_OFFSET(0x170A8FB0)
#define MOLEMOLE_UICAMPIDLEPAGECONTROLLER___C__DISPLAYCLASS35_0__ONCLICKSTARTBATTLE_B__1_OFFSET UNITYSDK_OFFSET(0x170A8BC0)

namespace MoleMole
{
	inline static constexpr unsigned int UICampIdlePageController___c__DisplayClass35_0_TypeDefinitionIndex = 75915;
