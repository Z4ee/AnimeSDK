...
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18D3B620)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18D3B690)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18D3B8D0)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_ONSWITCHPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0x18D3BC70)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18D3B730)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_SHOWINFO_OFFSET UNITYSDK_OFFSET(0x18D3BC00)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_SHOWPLATFORMUI_OFFSET UNITYSDK_OFFSET(0x18D3BD10)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_SHOWUIVIEW_OFFSET UNITYSDK_OFFSET(0x18D3BEE0)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18D3C360)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER__SHOWUIVIEW_G__SETUPPLATFORMUI_11_0_OFFSET UNITYSDK_OFFSET(0x18D3C280)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18D3C3C0)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18D3C460)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18D3C500)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopTeamNameRowWidgetController_TypeDefinitionIndex = 89499;

	class UICoopTeamNameRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_3_B6F2480661C7032D_6* _view; // 0x2C0
