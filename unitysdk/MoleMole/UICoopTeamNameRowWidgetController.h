...
class Class_3_B6F2480661C7032D_17;
...
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16EFA0D0)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16EFA140)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16EFA380)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_ONSWITCHPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0x16EFA720)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16EFA1E0)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_SHOWINFO_OFFSET UNITYSDK_OFFSET(0x16EFA6B0)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_SHOWPLATFORMUI_OFFSET UNITYSDK_OFFSET(0x16EFA7B0)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_SHOWUIVIEW_OFFSET UNITYSDK_OFFSET(0x16EFA980)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16EFAE10)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER__SHOWUIVIEW_G__SETUPPLATFORMUI_11_0_OFFSET UNITYSDK_OFFSET(0x16EFAD30)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16EFAE70)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16EFAF10)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16EFAFB0)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopTeamNameRowWidgetController_TypeDefinitionIndex = 74620;

	class UICoopTeamNameRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_3_B6F2480661C7032D_17* _view; // 0x2C0
		::Class_2_2F3C7D4EFC74D485* _model; // 0x2C8
		::MoleMole::UICoopTeamNameRowWidgetController_Context* _context; // 0x2D0
