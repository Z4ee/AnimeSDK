...
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_CREATEPERCENTTIPS_OFFSET UNITYSDK_OFFSET(0x18FBAFD0)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_DOOPENBAG_OFFSET UNITYSDK_OFFSET(0x18FBB520)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_INITFLOWPERCENTTIPS_OFFSET UNITYSDK_OFFSET(0x18FBA1B0)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_ONACTIVITYPARAMUPDATED_OFFSET UNITYSDK_OFFSET(0x18FBB150)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18FBB760)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_ONHOLLOWWATERFLOWFEVERCHANGE_OFFSET UNITYSDK_OFFSET(0x18FBA6B0)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_ONHOLLOWWATERFLOWPERCENTCHANGE_OFFSET UNITYSDK_OFFSET(0x18FBB0B0)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_ONHOLLOWWATERFLOWPERCENTTIPSINIT_OFFSET UNITYSDK_OFFSET(0x18FBAF20)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18FBB7F0)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18FB96A0)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18FBB6F0)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_REFRESHPARAMS_OFFSET UNITYSDK_OFFSET(0x18FB9BE0)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_REGISTERVIRUSINDEX_OFFSET UNITYSDK_OFFSET(0x18FBB410)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_REGISTERVIRUSOFCONCERN_OFFSET UNITYSDK_OFFSET(0x18FBB1A0)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_SETDEFAULTVIEW_OFFSET UNITYSDK_OFFSET(0x18FB9920)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_UPDATEFEVER_OFFSET UNITYSDK_OFFSET(0x18FBA750)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_UPDATEPERCENTVIEW_OFFSET UNITYSDK_OFFSET(0x18FB9F20)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18FBB8E0)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FBB880)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18FBB920)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18FBB9B0)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18FBBA40)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18FBBAD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowWaterFlowFishingWidgetController_TypeDefinitionIndex = 41057;
	...
	public:
		...
		{
			return (::MoleMole::UIHollowWaterFlowFishingWidgetController_HollowWaterFlowPercentTipsInitInfo**)Il2CppClass::FromTypeDefinitionIndex(UIHollowWaterFlowFishingWidgetController_TypeDefinitionIndex)->GetStaticField(0x51000);
		}
