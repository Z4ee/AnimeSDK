...
#define MOLEMOLE_MONOONEWAYDOORSENSOR_METHOD_5_77FD543600E00498_OFFSET UNITYSDK_OFFSET(0x15B3F400)
#define MOLEMOLE_MONOONEWAYDOORSENSOR_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x15B3F930)
#define MOLEMOLE_MONOONEWAYDOORSENSOR_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x15B3EF90)
#define MOLEMOLE_MONOONEWAYDOORSENSOR_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x15B3F710)
#define MOLEMOLE_MONOONEWAYDOORSENSOR_SYNCSIZE_OFFSET UNITYSDK_OFFSET(0x15B3F7B0)
#define MOLEMOLE_MONOONEWAYDOORSENSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x15B3F8E0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoOneWayDoorSensor_TypeDefinitionIndex = 41546;
