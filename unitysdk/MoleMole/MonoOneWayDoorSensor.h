...
#define MOLEMOLE_MONOONEWAYDOORSENSOR_METHOD_5_77FD543600E00498_OFFSET UNITYSDK_OFFSET(0x17DD6E30)
#define MOLEMOLE_MONOONEWAYDOORSENSOR_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x17DD7360)
#define MOLEMOLE_MONOONEWAYDOORSENSOR_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x17DD69C0)
#define MOLEMOLE_MONOONEWAYDOORSENSOR_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x17DD7140)
#define MOLEMOLE_MONOONEWAYDOORSENSOR_SYNCSIZE_OFFSET UNITYSDK_OFFSET(0x17DD71E0)
#define MOLEMOLE_MONOONEWAYDOORSENSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17DD7310)

namespace MoleMole
{
	inline static constexpr unsigned int MonoOneWayDoorSensor_TypeDefinitionIndex = 63326;
