...
#define MOLEMOLE_UIBABELTOWERMEDALWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14BD8830)
#define MOLEMOLE_UIBABELTOWERMEDALWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14BD88C0)
#define MOLEMOLE_UIBABELTOWERMEDALWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14BD8760)
#define MOLEMOLE_UIBABELTOWERMEDALWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14BD87C0)
#define MOLEMOLE_UIBABELTOWERMEDALWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14BD8940)
#define MOLEMOLE_UIBABELTOWERMEDALWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14BD89A0)
#define MOLEMOLE_UIBABELTOWERMEDALWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14BD89F0)
#define MOLEMOLE_UIBABELTOWERMEDALWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14BD8A30)
#define MOLEMOLE_UIBABELTOWERMEDALWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14BD8A70)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerMedalWidgetController_TypeDefinitionIndex = 72994;

	class UIBabeltowerMedalWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_60638234271CCDB8_144* _view; // 0x2C0
