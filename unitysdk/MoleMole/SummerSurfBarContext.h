...
#define MOLEMOLE_SUMMERSURFBARCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x11DFABB0)

namespace MoleMole
{
	inline static constexpr unsigned int SummerSurfBarContext_TypeDefinitionIndex = 72120;
