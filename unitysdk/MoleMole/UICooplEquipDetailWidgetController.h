...
#define MOLEMOLE_UICOOPLEQUIPDETAILWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1958C7A0)
#define MOLEMOLE_UICOOPLEQUIPDETAILWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1958C810)
#define MOLEMOLE_UICOOPLEQUIPDETAILWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1958C8B0)
#define MOLEMOLE_UICOOPLEQUIPDETAILWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1958C9C0)
#define MOLEMOLE_UICOOPLEQUIPDETAILWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1958CA20)
#define MOLEMOLE_UICOOPLEQUIPDETAILWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1958CAC0)

namespace MoleMole
{
	inline static constexpr unsigned int UICooplEquipDetailWidgetController_TypeDefinitionIndex = 60210;
