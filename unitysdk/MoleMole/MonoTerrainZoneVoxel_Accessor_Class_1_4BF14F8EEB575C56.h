...
#define MOLEMOLE_MONOTERRAINZONEVOXEL_ACCESSOR_CLASS_1_4BF14F8EEB575C56_METHOD_1_5AFFA079DA8B20AA_OFFSET UNITYSDK_OFFSET(0x199771A0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_ACCESSOR_CLASS_1_4BF14F8EEB575C56_METHOD_1_885DF4DA0F709E3E_OFFSET UNITYSDK_OFFSET(0x19976E80)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_ACCESSOR_CLASS_1_4BF14F8EEB575C56__CTOR_OFFSET UNITYSDK_OFFSET(0x19976E70)

namespace MoleMole
{
	inline static constexpr unsigned int MonoTerrainZoneVoxel_Accessor_Class_1_4BF14F8EEB575C56_TypeDefinitionIndex = 43928;

	class MonoTerrainZoneVoxel_Accessor_Class_1_4BF14F8EEB575C56 : public ::System::Object
	{
	public:
		::System::Action* Field_1_0; // 0x10
		::MoleMole::MonoTerrainZoneVoxel_Accessor* Field_1_1; // 0x18
