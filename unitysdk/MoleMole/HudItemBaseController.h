...
#define MOLEMOLE_HUDITEMBASECONTROLLER_DODESTROY_OFFSET UNITYSDK_OFFSET(0x17814CF0)
#define MOLEMOLE_HUDITEMBASECONTROLLER_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x17814300)
#define MOLEMOLE_HUDITEMBASECONTROLLER_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0x178142E0)
#define MOLEMOLE_HUDITEMBASECONTROLLER_GET_FOLLOWPOSITION_OFFSET UNITYSDK_OFFSET(0x178146F0)
#define MOLEMOLE_HUDITEMBASECONTROLLER_GET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x178146E0)
#define MOLEMOLE_HUDITEMBASECONTROLLER_GET_HEIGHTOFFSET_OFFSET UNITYSDK_OFFSET(0x178142F0)
#define MOLEMOLE_HUDITEMBASECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x17814100)
#define MOLEMOLE_HUDITEMBASECONTROLLER_GET__RECTTRANSFORMREF_OFFSET UNITYSDK_OFFSET(0x17814110)
#define MOLEMOLE_HUDITEMBASECONTROLLER_ISINCAMERAVISIBLERANGE_OFFSET UNITYSDK_OFFSET(0x17814FF0)
#define MOLEMOLE_HUDITEMBASECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17814A30)
#define MOLEMOLE_HUDITEMBASECONTROLLER_SETDISABLE_OFFSET UNITYSDK_OFFSET(0x17814C40)
#define MOLEMOLE_HUDITEMBASECONTROLLER_SETUNACTIVE_OFFSET UNITYSDK_OFFSET(0x17814B90)
#define MOLEMOLE_HUDITEMBASECONTROLLER_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x17814A80)
#define MOLEMOLE_HUDITEMBASECONTROLLER_SET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x178144F0)
#define MOLEMOLE_HUDITEMBASECONTROLLER_UPDATEHUDPOSITION_OFFSET UNITYSDK_OFFSET(0x17814D40)
#define MOLEMOLE_HUDITEMBASECONTROLLER_UPDATEHUD_OFFSET UNITYSDK_OFFSET(0x17814DB0)
#define MOLEMOLE_HUDITEMBASECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x178152E0)
#define MOLEMOLE_HUDITEMBASECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x178152D0)
#define MOLEMOLE_HUDITEMBASECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17815300)

namespace MoleMole
{
	inline static constexpr unsigned int HudItemBaseController_TypeDefinitionIndex = 45849;
	...
	public:
		...
		{
			return (::UnityEngine::Vector2*)Il2CppClass::FromTypeDefinitionIndex(HudItemBaseController_TypeDefinitionIndex)->GetStaticField(0x10540);
		}
		::UnityEngine::RectTransform* _rectTrans; // 0x310
		::System::Single _offset; // 0x318
		::UnityEngine::GameObject* _followTarget; // 0x320
		::System::UInt32 _entityID; // 0x328
		::UnityEngine::Transform* _followSpine; // 0x330
		::Class_3_DFD5D1FDB9D2A4AC* modelComponent; // 0x338
		::Class_3_F97B015544BE936B* dataComponent; // 0x340
		::Class_3_7472FB6CC4015359* hudComponent; // 0x348
		::Class_3_F41D242A20F8FE06* abilityComponent; // 0x350
		::System::Boolean _enable; // 0x358
		::System::String* spineName; // 0x360
