...
#define MOLEMOLE_HUDITEMBASECONTROLLER_DODESTROY_OFFSET UNITYSDK_OFFSET(0x182F3BE0)
#define MOLEMOLE_HUDITEMBASECONTROLLER_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x182F31F0)
#define MOLEMOLE_HUDITEMBASECONTROLLER_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0x182F31D0)
#define MOLEMOLE_HUDITEMBASECONTROLLER_GET_FOLLOWPOSITION_OFFSET UNITYSDK_OFFSET(0x182F35E0)
#define MOLEMOLE_HUDITEMBASECONTROLLER_GET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x182F35D0)
#define MOLEMOLE_HUDITEMBASECONTROLLER_GET_HEIGHTOFFSET_OFFSET UNITYSDK_OFFSET(0x182F31E0)
#define MOLEMOLE_HUDITEMBASECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x182F2FF0)
#define MOLEMOLE_HUDITEMBASECONTROLLER_GET__RECTTRANSFORMREF_OFFSET UNITYSDK_OFFSET(0x182F3000)
#define MOLEMOLE_HUDITEMBASECONTROLLER_ISINCAMERAVISIBLERANGE_OFFSET UNITYSDK_OFFSET(0x182F3EE0)
#define MOLEMOLE_HUDITEMBASECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x182F3920)
#define MOLEMOLE_HUDITEMBASECONTROLLER_SETDISABLE_OFFSET UNITYSDK_OFFSET(0x182F3B30)
#define MOLEMOLE_HUDITEMBASECONTROLLER_SETUNACTIVE_OFFSET UNITYSDK_OFFSET(0x182F3A80)
#define MOLEMOLE_HUDITEMBASECONTROLLER_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x182F3970)
#define MOLEMOLE_HUDITEMBASECONTROLLER_SET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x182F33E0)
#define MOLEMOLE_HUDITEMBASECONTROLLER_UPDATEHUDPOSITION_OFFSET UNITYSDK_OFFSET(0x182F3C30)
#define MOLEMOLE_HUDITEMBASECONTROLLER_UPDATEHUD_OFFSET UNITYSDK_OFFSET(0x182F3CA0)
#define MOLEMOLE_HUDITEMBASECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x182F41D0)
#define MOLEMOLE_HUDITEMBASECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x182F41C0)
#define MOLEMOLE_HUDITEMBASECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x182F41F0)

namespace MoleMole
{
	inline static constexpr unsigned int HudItemBaseController_TypeDefinitionIndex = 45344;
	...
	public:
		...
		{
			return (::UnityEngine::Vector2*)Il2CppClass::FromTypeDefinitionIndex(HudItemBaseController_TypeDefinitionIndex)->GetStaticField(0x11B40);
		}
		...
		::Class_3_DFD5D1FDB9D2A4AC* modelComponent; // 0x340
