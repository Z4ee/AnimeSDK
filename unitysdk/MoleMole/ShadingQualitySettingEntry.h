...
#define MOLEMOLE_SHADINGQUALITYSETTINGENTRY_GET_PROFILETYPE_OFFSET UNITYSDK_OFFSET(0x15B52CF0)
#define MOLEMOLE_SHADINGQUALITYSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x15B52CE0)
#define MOLEMOLE_SHADINGQUALITYSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x15B52D00)

namespace MoleMole
{
	inline static constexpr unsigned int ShadingQualitySettingEntry_TypeDefinitionIndex = 43971;
