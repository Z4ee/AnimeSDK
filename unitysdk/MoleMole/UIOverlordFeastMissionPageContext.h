...
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x14C6AA30)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastMissionPageContext_TypeDefinitionIndex = 77910;
