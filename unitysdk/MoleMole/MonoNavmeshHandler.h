...
#define MOLEMOLE_MONONAVMESHHANDLER_CALCULATEPATH_OFFSET UNITYSDK_OFFSET(0x125E5370)
#define MOLEMOLE_MONONAVMESHHANDLER_GET_DEBUGPATHROOT_OFFSET UNITYSDK_OFFSET(0x125E5250)
#define MOLEMOLE_MONONAVMESHHANDLER_GET_MOVEPATHDEBUGGER_OFFSET UNITYSDK_OFFSET(0x125E4FF0)
#define MOLEMOLE_MONONAVMESHHANDLER_GET_NAVMESHHELPER_OFFSET UNITYSDK_OFFSET(0x125E5260)
#define MOLEMOLE_MONONAVMESHHANDLER_GET_PATHINDEX_OFFSET UNITYSDK_OFFSET(0x125E5240)
#define MOLEMOLE_MONONAVMESHHANDLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x125E54F0)
#define MOLEMOLE_MONONAVMESHHANDLER_METHOD_5_56CE4AFC5339F746_OFFSET UNITYSDK_OFFSET(0x125E5810)
#define MOLEMOLE_MONONAVMESHHANDLER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x125E5950)
#define MOLEMOLE_MONONAVMESHHANDLER_METHOD_5_CCAB1FEBC1E7CB11_OFFSET UNITYSDK_OFFSET(0x125E57D0)
#define MOLEMOLE_MONONAVMESHHANDLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x125E5630)
#define MOLEMOLE_MONONAVMESHHANDLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x125E56D0)
#define MOLEMOLE_MONONAVMESHHANDLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x125E5690)
#define MOLEMOLE_MONONAVMESHHANDLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x125E55C0)
#define MOLEMOLE_MONONAVMESHHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x125E5720)

namespace MoleMole
{
	inline static constexpr unsigned int MonoNavmeshHandler_TypeDefinitionIndex = 74974;
