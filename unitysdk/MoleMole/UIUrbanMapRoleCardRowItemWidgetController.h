...
#define MOLEMOLE_UIURBANMAPROLECARDROWITEMWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1383CCC0)
#define MOLEMOLE_UIURBANMAPROLECARDROWITEMWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1383CD30)
#define MOLEMOLE_UIURBANMAPROLECARDROWITEMWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1383CDF0)
#define MOLEMOLE_UIURBANMAPROLECARDROWITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1383CFC0)
#define MOLEMOLE_UIURBANMAPROLECARDROWITEMWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1383D020)
#define MOLEMOLE_UIURBANMAPROLECARDROWITEMWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1383D0C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapRoleCardRowItemWidgetController_TypeDefinitionIndex = 47377;
