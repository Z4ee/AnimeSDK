...
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_ADDBUBBLETIP_OFFSET UNITYSDK_OFFSET(0x199C03B0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_ADDSLOTLOCK_OFFSET UNITYSDK_OFFSET(0x199C6FC0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_ADDSTATE_OFFSET UNITYSDK_OFFSET(0x199BE390)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_CHANGESTATE_OFFSET UNITYSDK_OFFSET(0x199BE470)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_CHECKANDDOMOVE_OFFSET UNITYSDK_OFFSET(0x199C29A0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_CHECKCANFADE_OFFSET UNITYSDK_OFFSET(0x199C1F60)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_CHECKCANMOVE_OFFSET UNITYSDK_OFFSET(0x199C1B90)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_CHECKWAITBUBBLE_OFFSET UNITYSDK_OFFSET(0x199C5C10)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_CLOSEALLBUBBLES_OFFSET UNITYSDK_OFFSET(0x199C3660)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_CREATEROW_OFFSET UNITYSDK_OFFSET(0x199C5D80)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_DELAYSHOWCONTAINSGROUP_OFFSET UNITYSDK_OFFSET(0x199C68C0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_DOMOVE_OFFSET UNITYSDK_OFFSET(0x199C1D10)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_DOPLAYSTARTANIM_OFFSET UNITYSDK_OFFSET(0x199C2460)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_FINISHBUBBLEGROUP_OFFSET UNITYSDK_OFFSET(0x199C3F30)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_GETCURRENTSHOWMAP_OFFSET UNITYSDK_OFFSET(0x199C1A90)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_GETFADEINTIPS_OFFSET UNITYSDK_OFFSET(0x199C4870)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_GETGROUP_OFFSET UNITYSDK_OFFSET(0x199C56B0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_GETSHOWINGTIP_OFFSET UNITYSDK_OFFSET(0x199C2BC0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_GETTIPBYID_OFFSET UNITYSDK_OFFSET(0x199C46A0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_GETWIDGETBYGROUPID_OFFSET UNITYSDK_OFFSET(0x199C5550)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_GET_GETCURRENTSHOWLIST_OFFSET UNITYSDK_OFFSET(0x199C70F0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_GET_MAXSHOWCOUNT_OFFSET UNITYSDK_OFFSET(0x199BE9D0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_GET_WIDGETSTATE_OFFSET UNITYSDK_OFFSET(0x199BE190)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x199BE180)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_HANDLESOUNDGROUP_OFFSET UNITYSDK_OFFSET(0x199C6A10)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_HASANYBUBBLEEXCLUDECTRL_OFFSET UNITYSDK_OFFSET(0x199C2FA0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_HASANYTIPEXCLUDECTRL_OFFSET UNITYSDK_OFFSET(0x199C2D90)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_HASTIPID_OFFSET UNITYSDK_OFFSET(0x199C3190)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_HASWAITTIPUI_OFFSET UNITYSDK_OFFSET(0x199BF650)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_INITSTATEMAP_OFFSET UNITYSDK_OFFSET(0x199BE1C0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_INTERRUPTTIPID_OFFSET UNITYSDK_OFFSET(0x199BF480)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_INTERRUPT_OFFSET UNITYSDK_OFFSET(0x199C4A50)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_ISININTERVAL_OFFSET UNITYSDK_OFFSET(0x199C60E0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_ONCLOSEFAIRYTIP_OFFSET UNITYSDK_OFFSET(0x199BF3E0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x199BE9E0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_ONHIDEMIDDLETIP_OFFSET UNITYSDK_OFFSET(0x199BEC70)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x199BF180)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_ONLOADINGFINISH_OFFSET UNITYSDK_OFFSET(0x199BECC0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_ONMIDDLETIPSSHOW_OFFSET UNITYSDK_OFFSET(0x199BEC10)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_ONNOTIFYFADEINFINISH_OFFSET UNITYSDK_OFFSET(0x199C1B30)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_ONNOTIFYFADEOUTFINISH_OFFSET UNITYSDK_OFFSET(0x199C26F0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_ONNOTIFYMOVEFINISH_OFFSET UNITYSDK_OFFSET(0x199C1F00)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_ONPAUSENEWSBUBBLE_OFFSET UNITYSDK_OFFSET(0x199BF340)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_ONRESUMENEWSBUBBLE_OFFSET UNITYSDK_OFFSET(0x199BF390)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_ONSLOTCOUNTCHANGED_OFFSET UNITYSDK_OFFSET(0x199C70A0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x199BEA70)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x199BE5B0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x199BEFB0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x199BFC30)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_PAUSEBUBBLEGROUP_OFFSET UNITYSDK_OFFSET(0x199C4FE0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_REALADDBUBBLETIP_OFFSET UNITYSDK_OFFSET(0x199C1760)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_REGISTERNEWBUBBLE_OFFSET UNITYSDK_OFFSET(0x199C5740)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_REMOVESLOTLOCK_OFFSET UNITYSDK_OFFSET(0x199C7030)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_RESETALLOVERRIDECANVAS_OFFSET UNITYSDK_OFFSET(0x199C4120)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_RESUMEBUBBLEGROUP_OFFSET UNITYSDK_OFFSET(0x199C4BD0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_SORTBUBBLEROW_OFFSET UNITYSDK_OFFSET(0x199C24C0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_SORTBUBBLES_OFFSET UNITYSDK_OFFSET(0x199C22D0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_TESTSORTBUBBLE_OFFSET UNITYSDK_OFFSET(0x199C2280)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_TRIGGERFADE_OFFSET UNITYSDK_OFFSET(0x199C2060)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_TRYADDBUBBLETIP_OFFSET UNITYSDK_OFFSET(0x199C6200)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_TRYGETLRUNEWSBUBBLEROW_OFFSET UNITYSDK_OFFSET(0x199C6600)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_TRYHANDLEWAITTIPS_OFFSET UNITYSDK_OFFSET(0x199BED10)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_TRYSETTIPEXTRADATA_OFFSET UNITYSDK_OFFSET(0x199C4400)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_UNREGNEWSBUBBLE_OFFSET UNITYSDK_OFFSET(0x199C5320)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_UPDATEPOSITION_OFFSET UNITYSDK_OFFSET(0x199C0820)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_WAITSHOWLIST_OFFSET UNITYSDK_OFFSET(0x199C1AE0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x199C7150)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER__ONUIOPEN_B__20_0_OFFSET UNITYSDK_OFFSET(0x199C7690)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER__ONUIOPEN_B__20_1_OFFSET UNITYSDK_OFFSET(0x199C7BB0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER__ONUIOPEN_B__20_2_OFFSET UNITYSDK_OFFSET(0x199C7D60)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER__ONUIOPEN_B__20_3_OFFSET UNITYSDK_OFFSET(0x199C7F40)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x199C7F70)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x199C8000)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x199C8090)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x199C80A0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x199C80B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralNewsBubbleWidgetController_TypeDefinitionIndex = 85272;
	...
	public:
		...
		::Class_2_60638234271CCDB8_100* _view; // 0x348
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_ONUPDATE_OFFSET))(this, dt);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::System::Func_2<::MoleMole::UIGeneralNewsBubbleRowWidgetController*, ::System::Boolean>*, ::MoleMole::UIGeneralNewsBubbleRowWidgetController*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_HASANYBUBBLEEXCLUDECTRL_OFFSET))(this, predicate, excludeCtrl);
		}
