...
#define MOLEMOLE_ANIMATIONCURVEEX_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x12C9D600)
#define MOLEMOLE_ANIMATIONCURVEEX_GET_KEYS_OFFSET UNITYSDK_OFFSET(0x12C9D560)
#define MOLEMOLE_ANIMATIONCURVEEX_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x12C9D660)
#define MOLEMOLE_ANIMATIONCURVEEX_GET_NOTNULLRUNTIMECURVE_OFFSET UNITYSDK_OFFSET(0x12C9D540)
#define MOLEMOLE_ANIMATIONCURVEEX_GET__NOTNULLRUNTIMECURVE_OFFSET UNITYSDK_OFFSET(0x12C9D420)
#define MOLEMOLE_ANIMATIONCURVEEX_METHOD_1_532AE2993E04D764_OFFSET UNITYSDK_OFFSET(0x12C9D770)
#define MOLEMOLE_ANIMATIONCURVEEX_METHOD_1_64629612F3646911_OFFSET UNITYSDK_OFFSET(0x12C9D8F0)
#define MOLEMOLE_ANIMATIONCURVEEX_METHOD_1_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0x12C9D440)
#define MOLEMOLE_ANIMATIONCURVEEX_METHOD_1_A82658DA976A3BA7_OFFSET UNITYSDK_OFFSET(0x12C9D6E0)
#define MOLEMOLE_ANIMATIONCURVEEX_METHOD_1_D09831639F615812_OFFSET UNITYSDK_OFFSET(0x12C9D800)
#define MOLEMOLE_ANIMATIONCURVEEX_METHOD_1_D437D090E63BE8A7_OFFSET UNITYSDK_OFFSET(0x12C9D870)
#define MOLEMOLE_ANIMATIONCURVEEX_SET_KEYS_OFFSET UNITYSDK_OFFSET(0x12C9D590)
#define MOLEMOLE_ANIMATIONCURVEEX_SET__NOTNULLRUNTIMECURVE_OFFSET UNITYSDK_OFFSET(0x12C9D530)
#define MOLEMOLE_ANIMATIONCURVEEX__CCTOR_OFFSET UNITYSDK_OFFSET(0x12C9D690)
#define MOLEMOLE_ANIMATIONCURVEEX__CTOR_OFFSET UNITYSDK_OFFSET(0x12C9D410)

namespace MoleMole
{
	inline static constexpr unsigned int AnimationCurveEx_TypeDefinitionIndex = 79505;
	...
	public:
		...
		{
			return (::UnityEngine::AnimationCurve**)Il2CppClass::FromTypeDefinitionIndex(AnimationCurveEx_TypeDefinitionIndex)->GetStaticField(0x509A0);
		}
