...
#define MOLEMOLE_ACTIVITYCOMBATPAUSESTAGEWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x11444AC0)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityCombatPauseStageWidgetContext_TypeDefinitionIndex = 45041;
	...
	public:
		...
		::System::Int32 targetQuestID; // 0x3C
