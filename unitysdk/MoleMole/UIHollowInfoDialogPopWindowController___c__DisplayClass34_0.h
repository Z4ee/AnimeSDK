...
#define MOLEMOLE_UIHOLLOWINFODIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS34_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17210C90)
#define MOLEMOLE_UIHOLLOWINFODIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS34_0__ONRESETBTNCLICKED_B__0_OFFSET UNITYSDK_OFFSET(0x17210CA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowInfoDialogPopWindowController___c__DisplayClass34_0_TypeDefinitionIndex = 79133;
