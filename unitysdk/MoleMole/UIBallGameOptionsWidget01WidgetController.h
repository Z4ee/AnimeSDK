...
#define MOLEMOLE_UIBALLGAMEOPTIONSWIDGET01WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1F9F0F10)
#define MOLEMOLE_UIBALLGAMEOPTIONSWIDGET01WIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x1F9F13A0)
#define MOLEMOLE_UIBALLGAMEOPTIONSWIDGET01WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1F9F1030)
#define MOLEMOLE_UIBALLGAMEOPTIONSWIDGET01WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1F9F0FA0)
#define MOLEMOLE_UIBALLGAMEOPTIONSWIDGET01WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1F9F0CF0)
#define MOLEMOLE_UIBALLGAMEOPTIONSWIDGET01WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1F9F0D60)
#define MOLEMOLE_UIBALLGAMEOPTIONSWIDGET01WIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1F9F1130)
#define MOLEMOLE_UIBALLGAMEOPTIONSWIDGET01WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F9F1520)
#define MOLEMOLE_UIBALLGAMEOPTIONSWIDGET01WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1F9F1530)
#define MOLEMOLE_UIBALLGAMEOPTIONSWIDGET01WIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x1F9F15C0)
#define MOLEMOLE_UIBALLGAMEOPTIONSWIDGET01WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1F9F1650)
#define MOLEMOLE_UIBALLGAMEOPTIONSWIDGET01WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1F9F16F0)
#define MOLEMOLE_UIBALLGAMEOPTIONSWIDGET01WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1F9F1780)
#define MOLEMOLE_UIBALLGAMEOPTIONSWIDGET01WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1F9F1810)

namespace MoleMole
{
	inline static constexpr unsigned int UIBallGameOptionsWidget01WidgetController_TypeDefinitionIndex = 93307;
