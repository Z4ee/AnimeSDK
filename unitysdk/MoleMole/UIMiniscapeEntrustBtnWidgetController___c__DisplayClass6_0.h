...
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15F03870)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER___C__DISPLAYCLASS6_0__PLAYREFRESHANIM_B__0_OFFSET UNITYSDK_OFFSET(0x15F03880)

namespace MoleMole
{
	inline static constexpr unsigned int UIMiniscapeEntrustBtnWidgetController___c__DisplayClass6_0_TypeDefinitionIndex = 76930;
	...
	public:
		...
		::UnityEngine::Animation* rootAnim; // 0x18
