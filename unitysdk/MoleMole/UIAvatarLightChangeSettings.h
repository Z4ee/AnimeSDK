...
#define MOLEMOLE_UIAVATARLIGHTCHANGESETTINGS_ONCONFIGCHANGED_OFFSET UNITYSDK_OFFSET(0x8C9F80)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarLightChangeSettings_TypeDefinitionIndex = 80154;
