...
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x186FC300)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotLevelWidgetController___c__DisplayClass8_0_TypeDefinitionIndex = 71785;
	...
	public:
		...
		::System::Int32 maxLevel; // 0x20
		::System::Int32 curLv; // 0x24
		::System::Int32 maxExp; // 0x28
