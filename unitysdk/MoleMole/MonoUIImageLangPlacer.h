...
#define MOLEMOLE_MONOUIIMAGELANGPLACER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1419E480)
#define MOLEMOLE_MONOUIIMAGELANGPLACER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1419E810)
#define MOLEMOLE_MONOUIIMAGELANGPLACER_SETIMAGEPATH_OFFSET UNITYSDK_OFFSET(0x1419E9D0)
#define MOLEMOLE_MONOUIIMAGELANGPLACER_SETLANGUAGEIMAGEPATH_OFFSET UNITYSDK_OFFSET(0x1419E5F0)
#define MOLEMOLE_MONOUIIMAGELANGPLACER__CTOR_OFFSET UNITYSDK_OFFSET(0x1419EE50)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIImageLangPlacer_TypeDefinitionIndex = 80466;
