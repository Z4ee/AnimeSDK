...
#define MOLEMOLE_MONOUIIMAGELANGPLACER_AWAKE_OFFSET UNITYSDK_OFFSET(0x12FA9D20)
#define MOLEMOLE_MONOUIIMAGELANGPLACER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x12FAA0C0)
#define MOLEMOLE_MONOUIIMAGELANGPLACER_SETIMAGEPATH_OFFSET UNITYSDK_OFFSET(0x12FAA280)
#define MOLEMOLE_MONOUIIMAGELANGPLACER_SETLANGUAGEIMAGEPATH_OFFSET UNITYSDK_OFFSET(0x12FA9E90)
#define MOLEMOLE_MONOUIIMAGELANGPLACER__CTOR_OFFSET UNITYSDK_OFFSET(0x12FAA700)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIImageLangPlacer_TypeDefinitionIndex = 56954;
