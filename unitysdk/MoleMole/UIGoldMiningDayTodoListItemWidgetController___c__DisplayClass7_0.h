...
#define MOLEMOLE_UIGOLDMININGDAYTODOLISTITEMWIDGETCONTROLLER___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19FCC6D0)
#define MOLEMOLE_UIGOLDMININGDAYTODOLISTITEMWIDGETCONTROLLER___C__DISPLAYCLASS7_0__SETGENERALQUEST_B__0_OFFSET UNITYSDK_OFFSET(0x19FCC6E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGoldMiningDayTodoListItemWidgetController___c__DisplayClass7_0_TypeDefinitionIndex = 42446;
