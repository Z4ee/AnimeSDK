...
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT02WIDGETCONTROLLER_GETVIEW_OFFSET UNITYSDK_OFFSET(0x15A59850)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT02WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A59720)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT02WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A597B0)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT02WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A595A0)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT02WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15A59600)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT02WIDGETCONTROLLER_PLAYNODEUIANIM_OFFSET UNITYSDK_OFFSET(0x15A598A0)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT02WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15A59B00)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT02WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A59B60)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT02WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A59BF0)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT02WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A59C80)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT02WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15A59D10)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnowCoursePoint02WidgetController_TypeDefinitionIndex = 51620;

	class UIInterKnowCoursePoint02WidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_60638234271CCDB8_80* _view; // 0x2B8
		...
		::Class_2_60638234271CCDB8_80* GetView()
		{
			return ((::Class_2_60638234271CCDB8_80*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIINTERKNOWCOURSEPOINT02WIDGETCONTROLLER_GETVIEW_OFFSET))(this);
		}
