...
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1303ECE0)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER___C__DISPLAYCLASS8_0__PLAYBYINDEX_B__0_OFFSET UNITYSDK_OFFSET(0x1303ECF0)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER___C__DISPLAYCLASS8_0__PLAYBYINDEX_B__1_OFFSET UNITYSDK_OFFSET(0x1303ED00)

namespace MoleMole
{
	inline static constexpr unsigned int MultipleVideoPlayerManager___c__DisplayClass8_0_TypeDefinitionIndex = 67965;
