...
#define MOLEMOLE_VIDEOPLAYERMONO_GET_PLAYERISLOOPING_OFFSET UNITYSDK_OFFSET(0x11340FC0)
#define MOLEMOLE_VIDEOPLAYERMONO_GET_PLAYERISLOOP_OFFSET UNITYSDK_OFFSET(0x11341260)
#define MOLEMOLE_VIDEOPLAYERMONO_GET_PLAYERISPAUSED_OFFSET UNITYSDK_OFFSET(0x113410E0)
#define MOLEMOLE_VIDEOPLAYERMONO_GET_PLAYERISPLAYING_OFFSET UNITYSDK_OFFSET(0x11341020)
#define MOLEMOLE_VIDEOPLAYERMONO_GET_PLAYERISPREPARED_OFFSET UNITYSDK_OFFSET(0x11341080)
#define MOLEMOLE_VIDEOPLAYERMONO_GET_PLAYERPLAYONAWAKE_OFFSET UNITYSDK_OFFSET(0x11341380)
#define MOLEMOLE_VIDEOPLAYERMONO_GET_PLAYERRENDERMODE_OFFSET UNITYSDK_OFFSET(0x113412C0)
#define MOLEMOLE_VIDEOPLAYERMONO_GET_PLAYERTARGETMATERIALPROPERTY_OFFSET UNITYSDK_OFFSET(0x11341200)
#define MOLEMOLE_VIDEOPLAYERMONO_GET_PLAYERTARGETMATERIALRENDERER_OFFSET UNITYSDK_OFFSET(0x11341320)
#define MOLEMOLE_VIDEOPLAYERMONO_GET_PLAYERTARGETTEXTURE_OFFSET UNITYSDK_OFFSET(0x11341140)
#define MOLEMOLE_VIDEOPLAYERMONO_GET_PLAYERTEXTURE_OFFSET UNITYSDK_OFFSET(0x113411A0)
#define MOLEMOLE_VIDEOPLAYERMONO_GET_PLAYERURL_OFFSET UNITYSDK_OFFSET(0x11340F60)
#define MOLEMOLE_VIDEOPLAYERMONO_GET_VIDEOPLAYER_OFFSET UNITYSDK_OFFSET(0x113413E0)
#define MOLEMOLE_VIDEOPLAYERMONO_INITCOMPONENT_OFFSET UNITYSDK_OFFSET(0x11341400)
#define MOLEMOLE_VIDEOPLAYERMONO_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x11341750)
#define MOLEMOLE_VIDEOPLAYERMONO_METHOD_5_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0x11341520)
#define MOLEMOLE_VIDEOPLAYERMONO_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x113417B0)
#define MOLEMOLE_VIDEOPLAYERMONO_PREPARE_OFFSET UNITYSDK_OFFSET(0x11341810)
#define MOLEMOLE_VIDEOPLAYERMONO_SET_VIDEOPLAYER_OFFSET UNITYSDK_OFFSET(0x113413F0)
#define MOLEMOLE_VIDEOPLAYERMONO__CTOR_OFFSET UNITYSDK_OFFSET(0x11341960)

namespace MoleMole
{
	inline static constexpr unsigned int VideoPlayerMono_TypeDefinitionIndex = 49575;
