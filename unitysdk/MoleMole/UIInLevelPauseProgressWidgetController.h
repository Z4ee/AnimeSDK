...
#define MOLEMOLE_UIINLEVELPAUSEPROGRESSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16D7F7D0)
#define MOLEMOLE_UIINLEVELPAUSEPROGRESSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16D7F860)
#define MOLEMOLE_UIINLEVELPAUSEPROGRESSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16D7F700)
#define MOLEMOLE_UIINLEVELPAUSEPROGRESSWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16D7F760)
#define MOLEMOLE_UIINLEVELPAUSEPROGRESSWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x16D7F8E0)
#define MOLEMOLE_UIINLEVELPAUSEPROGRESSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16D800A0)
#define MOLEMOLE_UIINLEVELPAUSEPROGRESSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16D80100)
#define MOLEMOLE_UIINLEVELPAUSEPROGRESSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16D80190)
#define MOLEMOLE_UIINLEVELPAUSEPROGRESSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16D80220)
#define MOLEMOLE_UIINLEVELPAUSEPROGRESSWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16D802B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseProgressWidgetController_TypeDefinitionIndex = 48101;
