...
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x150EC430)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_ONCLICKGETBTN_OFFSET UNITYSDK_OFFSET(0x150F1700)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_ONCLICKSCROLLITEM_OFFSET UNITYSDK_OFFSET(0x150F1E30)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x150EC440)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x150F13A0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x150F1570)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x150F03F0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_ONSCROLLMOVE_OFFSET UNITYSDK_OFFSET(0x150F1EE0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x150F1130)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x150F11C0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x150EC4D0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x150F0380)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_REFRESHALLMAILS_OFFSET UNITYSDK_OFFSET(0x150F24E0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_REFRESHCOUNT_OFFSET UNITYSDK_OFFSET(0x150EDA30)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_REFRESHRECEIVEALLBTNSTATE_OFFSET UNITYSDK_OFFSET(0x150F0A10)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_REFRESHSCROLLVIEWCONFIG_OFFSET UNITYSDK_OFFSET(0x150EDC70)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_REPLACETEXT_OFFSET UNITYSDK_OFFSET(0x150F2CF0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_SETACCESSINFO_OFFSET UNITYSDK_OFFSET(0x150F2DA0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_SETEMPTYSTATE_OFFSET UNITYSDK_OFFSET(0x150ECF00)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_SETNEEDUPDATEMAIL_OFFSET UNITYSDK_OFFSET(0x150F1DE0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_SETREWARDINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x150F1520)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_SETREWARDMODULEINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x150F2C40)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_TRYGETMAILAWARD_OFFSET UNITYSDK_OFFSET(0x150F1AF0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_UPDATEDETAIL_OFFSET UNITYSDK_OFFSET(0x150EDF80)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_UPDATEMAILDETAILS_OFFSET UNITYSDK_OFFSET(0x150EDEF0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x150F3130)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__ONCLICKGETBTN_B__13_0_OFFSET UNITYSDK_OFFSET(0x150F39B0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__ONCLICKGETBTN_B__13_1_OFFSET UNITYSDK_OFFSET(0x150F3B10)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__4_0_OFFSET UNITYSDK_OFFSET(0x150F3220)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__4_10_OFFSET UNITYSDK_OFFSET(0x150F3850)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__4_1_OFFSET UNITYSDK_OFFSET(0x150F3280)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__4_2_OFFSET UNITYSDK_OFFSET(0x150F35D0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__4_3_OFFSET UNITYSDK_OFFSET(0x150F3650)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__4_4_OFFSET UNITYSDK_OFFSET(0x150F36D0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__4_6_OFFSET UNITYSDK_OFFSET(0x150F3960)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__4_7_OFFSET UNITYSDK_OFFSET(0x150F3990)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__4_8_OFFSET UNITYSDK_OFFSET(0x150F3480)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__4_9_OFFSET UNITYSDK_OFFSET(0x150F35A0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__SETACCESSINFO_B__24_0_OFFSET UNITYSDK_OFFSET(0x150F3F30)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__UPDATEDETAIL_B__22_0_OFFSET UNITYSDK_OFFSET(0x150F3DD0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x150F3FB0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x150F4040)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x150F40D0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x150F4160)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x150F4190)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x150F4250)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x150F4260)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x150F4270)

namespace MoleMole
{
	inline static constexpr unsigned int UIMailDialogPopWindowController_TypeDefinitionIndex = 61716;
	...
	public:
		...
		::Class_2_79F6D62CE30E3F8E_119* _view; // 0x310
		::System::Boolean inited; // 0x318
		::System::Collections::Generic::List_1<::MoleMole::UIGeneralClickToProceed02WidgetController*>* urlCtrls; // 0x320
		::System::Collections::Generic::List_1<::Class_1_0A0B50D6899733CD*>* _cacheMails; // 0x328
		::Class_1_0A0B50D6899733CD* _currentMail; // 0x330
		::UnityEngine::UI::Text* GetText; // 0x338
		::System::Collections::Generic::List_1<::MoleMole::UIItemIconBtnWidgetController*>* itemList; // 0x340
		::System::Boolean isFocusingReward; // 0x348
		::System::Boolean showRewardHintKey; // 0x349
		::System::Boolean isRequestingNew; // 0x34A
		::System::Boolean needUpdateMail; // 0x34B
