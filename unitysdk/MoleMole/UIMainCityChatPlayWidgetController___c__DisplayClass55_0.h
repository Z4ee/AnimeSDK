...
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS55_0__CTOR_OFFSET UNITYSDK_OFFSET(0x155D6E90)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS55_0__SHOWQUESTRECOMMEND_B__2_OFFSET UNITYSDK_OFFSET(0x155D7A10)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS55_0__SHOWQUESTRECOMMEND_B__3_OFFSET UNITYSDK_OFFSET(0x155D7BA0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS55_0__SHOWQUESTRECOMMEND_G__OPENQUESTRECOMMEND_0_OFFSET UNITYSDK_OFFSET(0x155D6EA0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS55_0__SHOWQUESTRECOMMEND_G__REFRESHQUESTLIST_1_OFFSET UNITYSDK_OFFSET(0x155D71C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityChatPlayWidgetController___c__DisplayClass55_0_TypeDefinitionIndex = 83713;

	class UIMainCityChatPlayWidgetController___c__DisplayClass55_0 : public ::System::Object
	{
	public:
		::Class_2_701D0105B8E2A1C9* node; // 0x10
