...
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS55_0__CTOR_OFFSET UNITYSDK_OFFSET(0x13DCC9D0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS55_0__SHOWQUESTRECOMMEND_B__2_OFFSET UNITYSDK_OFFSET(0x13DCD560)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS55_0__SHOWQUESTRECOMMEND_B__3_OFFSET UNITYSDK_OFFSET(0x13DCD6F0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS55_0__SHOWQUESTRECOMMEND_G__OPENQUESTRECOMMEND_0_OFFSET UNITYSDK_OFFSET(0x13DCC9E0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS55_0__SHOWQUESTRECOMMEND_G__REFRESHQUESTLIST_1_OFFSET UNITYSDK_OFFSET(0x13DCCD00)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityChatPlayWidgetController___c__DisplayClass55_0_TypeDefinitionIndex = 47785;
