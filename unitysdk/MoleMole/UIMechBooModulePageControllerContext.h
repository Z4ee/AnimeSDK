...
#define MOLEMOLE_UIMECHBOOMODULEPAGECONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x182DFF70)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechBooModulePageControllerContext_TypeDefinitionIndex = 88849;
