...
#define MOLEMOLE_UINEOGOLDENMECHALEVELTABWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15C83240)
#define MOLEMOLE_UINEOGOLDENMECHALEVELTABWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15C832B0)
#define MOLEMOLE_UINEOGOLDENMECHALEVELTABWIDGETCONTROLLER_SETLEVEL_OFFSET UNITYSDK_OFFSET(0x15C83370)
#define MOLEMOLE_UINEOGOLDENMECHALEVELTABWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15C83420)
#define MOLEMOLE_UINEOGOLDENMECHALEVELTABWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15C83480)

namespace MoleMole
{
	inline static constexpr unsigned int UINeoGoldenMechaLevelTabWidgetController_TypeDefinitionIndex = 77482;
	...
	public:
		...
		{
			return ((::Class_2_1C97EB19EBCD7CE1_1*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UINEOGOLDENMECHALEVELTABWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
