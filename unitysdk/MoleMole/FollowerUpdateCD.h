...
#define MOLEMOLE_FOLLOWERUPDATECD_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x12332DF0)
#define MOLEMOLE_FOLLOWERUPDATECD__CTOR_OFFSET UNITYSDK_OFFSET(0x12332E60)
#define MOLEMOLE_FOLLOWERUPDATECD___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x12332F00)

namespace MoleMole
{
	inline static constexpr unsigned int FollowerUpdateCD_TypeDefinitionIndex = 67929;
