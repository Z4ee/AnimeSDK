...
#define MOLEMOLE_UITAPE3DMODELCONTROLLER___C__DISPLAYCLASS66_0__CTOR_OFFSET UNITYSDK_OFFSET(0x12E40E00)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER___C__DISPLAYCLASS66_0__FIRSTBOOKPERFORMANCE_B__0_OFFSET UNITYSDK_OFFSET(0x12E40E10)

namespace MoleMole
{
	inline static constexpr unsigned int UITape3DModelController___c__DisplayClass66_0_TypeDefinitionIndex = 77368;
