...
#define MOLEMOLE_UITAPE3DMODELCONTROLLER___C__DISPLAYCLASS66_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1677F500)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER___C__DISPLAYCLASS66_0__FIRSTBOOKPERFORMANCE_B__0_OFFSET UNITYSDK_OFFSET(0x1677F510)

namespace MoleMole
{
	inline static constexpr unsigned int UITape3DModelController___c__DisplayClass66_0_TypeDefinitionIndex = 63858;
