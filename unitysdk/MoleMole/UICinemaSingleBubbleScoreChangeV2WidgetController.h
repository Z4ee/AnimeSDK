...
class Class_2_4331D4B951FDD777;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }

#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEV2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x183CF3C0)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEV2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x183CF450)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEV2WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x183CEF30)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEV2WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x183CEF90)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEV2WIDGETCONTROLLER_SHOWSCORECHANGE_OFFSET UNITYSDK_OFFSET(0x183CF080)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEV2WIDGETCONTROLLER_SHOWSCORE_OFFSET UNITYSDK_OFFSET(0x183CF700)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x183CFA00)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEV2WIDGETCONTROLLER__SHOWSCORECHANGE_B__5_0_OFFSET UNITYSDK_OFFSET(0x183CFA60)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEV2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x183CFA70)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEV2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x183CFB00)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEV2WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x183CFB90)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEV2WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x183CFC20)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaSingleBubbleScoreChangeV2WidgetController_TypeDefinitionIndex = 49793;

	class UICinemaSingleBubbleScoreChangeV2WidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_4331D4B951FDD777* _view; // 0x2C0
