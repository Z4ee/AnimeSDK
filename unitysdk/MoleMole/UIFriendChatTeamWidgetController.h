...
class Class_2_292898978640E62C_2;
...
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER_INITSHAREPLAYERTEAMUIVIEW_OFFSET UNITYSDK_OFFSET(0x172E4490)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER_INITSHARESELFPLAYERTEAMUIVIEW_OFFSET UNITYSDK_OFFSET(0x172E4430)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x172E3EE0)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x172E3CD0)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x172E3DE0)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x172E3D60)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x172E3A40)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER_ONUPDATECHATMESSAGEROW_OFFSET UNITYSDK_OFFSET(0x172E4250)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER_RESETSPECIALUI_OFFSET UNITYSDK_OFFSET(0x172E43A0)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER_RESETUIVIEW_OFFSET UNITYSDK_OFFSET(0x172E42E0)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER_SETUPTEAMUIWITHCONTENT_OFFSET UNITYSDK_OFFSET(0x172E44F0)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x172E4E10)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x172E4E20)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x172E4EB0)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x172E4F50)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x172E4FE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendChatTeamWidgetController_TypeDefinitionIndex = 60863;
	...
	public:
		...
		::Class_2_292898978640E62C_2* _view; // 0x2F0
		...
		::Class_2_292898978640E62C_2_Class_2_F03B0164AF5E38A9_1* _playerShareTeamView; // 0x308
		::Class_2_292898978640E62C_2_Class_2_F03B0164AF5E38A9_1* _selfShareTeamView; // 0x310
		...
		::System::Void SetupTeamUIWithContent(::Class_3_8B38DDDE25B29A1E* teamContent, ::Class_2_292898978640E62C_2_Class_2_F03B0164AF5E38A9_1* viewWidget)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_8B38DDDE25B29A1E*, ::Class_2_292898978640E62C_2_Class_2_F03B0164AF5E38A9_1*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER_SETUPTEAMUIWITHCONTENT_OFFSET))(this, teamContent, viewWidget);
		}
