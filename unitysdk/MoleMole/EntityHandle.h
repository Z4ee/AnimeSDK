...
#define MOLEMOLE_ENTITYHANDLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8AF070)
#define MOLEMOLE_ENTITYHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x8AF060)
#define MOLEMOLE_ENTITYHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8AF010)
#define MOLEMOLE_ENTITYHANDLE_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0x32EEE0)
#define MOLEMOLE_ENTITYHANDLE_GET_ENTITYTYPE_OFFSET UNITYSDK_OFFSET(0x8AEF10)
#define MOLEMOLE_ENTITYHANDLE_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x8AEF20)
#define MOLEMOLE_ENTITYHANDLE_GET_ISPRELOAD_OFFSET UNITYSDK_OFFSET(0x8AEF90)
#define MOLEMOLE_ENTITYHANDLE_GET_ISREADY_OFFSET UNITYSDK_OFFSET(0x8AEFA0)
#define MOLEMOLE_ENTITYHANDLE_GET_OFFSET UNITYSDK_OFFSET(0x8AEEB0)
#define MOLEMOLE_ENTITYHANDLE_ISVALID_OFFSET UNITYSDK_OFFSET(0x7B0B00)
#define MOLEMOLE_ENTITYHANDLE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A039C40)
#define MOLEMOLE_ENTITYHANDLE_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1A039A00)
#define MOLEMOLE_ENTITYHANDLE_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x19FF4690)
#define MOLEMOLE_ENTITYHANDLE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A039990)
#define MOLEMOLE_ENTITYHANDLE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A039CF0)
#define MOLEMOLE_ENTITYHANDLE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8AEFB0)
#define MOLEMOLE_ENTITYHANDLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A039DA0)
#define MOLEMOLE_ENTITYHANDLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8AEE50)
#define MOLEMOLE_ENTITYHANDLE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x8AEE70)
#define MOLEMOLE_ENTITYHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x8AEE40)
#define MOLEMOLE_ENTITYHANDLE___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8AF0E0)
#define MOLEMOLE_ENTITYHANDLE___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8AF140)

namespace MoleMole
{
	inline static constexpr unsigned int EntityHandle_TypeDefinitionIndex = 49017;

	struct alignas(8) EntityHandle
	{
		static ::MoleMole::EntityHandle* StaticGet_Empty()
		{
			return (::MoleMole::EntityHandle*)Il2CppClass::FromTypeDefinitionIndex(EntityHandle_TypeDefinitionIndex)->GetStaticField(0x2D630);
		}
