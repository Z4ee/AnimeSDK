...
#define MOLEMOLE_UIHORIZONTALBATTLEMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x199E04E0)
#define MOLEMOLE_UIHORIZONTALBATTLEMAINPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x199E04F0)
#define MOLEMOLE_UIHORIZONTALBATTLEMAINPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x199E0600)
#define MOLEMOLE_UIHORIZONTALBATTLEMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x199E0560)
#define MOLEMOLE_UIHORIZONTALBATTLEMAINPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x199E06C0)
#define MOLEMOLE_UIHORIZONTALBATTLEMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x199E0770)
#define MOLEMOLE_UIHORIZONTALBATTLEMAINPAGECONTROLLER__ONUIINIT_B__4_0_OFFSET UNITYSDK_OFFSET(0x199E0780)
#define MOLEMOLE_UIHORIZONTALBATTLEMAINPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x199E07F0)
#define MOLEMOLE_UIHORIZONTALBATTLEMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x199E0890)
#define MOLEMOLE_UIHORIZONTALBATTLEMAINPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x199E08A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHorizontalBattleMainPageController_TypeDefinitionIndex = 88792;
