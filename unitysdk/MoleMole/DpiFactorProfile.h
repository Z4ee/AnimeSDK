...
#define MOLEMOLE_DPIFACTORPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x18F3B150)
#define MOLEMOLE_DPIFACTORPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x18F3B290)
#define MOLEMOLE_DPIFACTORPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x18F3B070)
#define MOLEMOLE_DPIFACTORPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x18F3B210)
#define MOLEMOLE_DPIFACTORPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x18F3B060)
#define MOLEMOLE_DPIFACTORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x18F3B3B0)
#define MOLEMOLE_DPIFACTORPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x18F3B440)
#define MOLEMOLE_DPIFACTORPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x18F3B4D0)
#define MOLEMOLE_DPIFACTORPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x18F3B560)

namespace MoleMole
{
	inline static constexpr unsigned int DpiFactorProfile_TypeDefinitionIndex = 60509;
