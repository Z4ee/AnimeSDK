...
#define MOLEMOLE_DPIFACTORPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x1B21F360)
#define MOLEMOLE_DPIFACTORPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x1B21F4A0)
#define MOLEMOLE_DPIFACTORPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x1B21F280)
#define MOLEMOLE_DPIFACTORPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1B21F420)
#define MOLEMOLE_DPIFACTORPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x1B21F270)
#define MOLEMOLE_DPIFACTORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B21F5C0)
#define MOLEMOLE_DPIFACTORPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x1B21F650)
#define MOLEMOLE_DPIFACTORPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x1B21F6E0)
#define MOLEMOLE_DPIFACTORPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1B21F770)

namespace MoleMole
{
	inline static constexpr unsigned int DpiFactorProfile_TypeDefinitionIndex = 43634;
