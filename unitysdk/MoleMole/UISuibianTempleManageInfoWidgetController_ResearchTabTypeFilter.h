...
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_RESEARCHTABTYPEFILTER_PREDICATE_OFFSET UNITYSDK_OFFSET(0x11BBC100)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_RESEARCHTABTYPEFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x11BBC0F0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleManageInfoWidgetController_ResearchTabTypeFilter_TypeDefinitionIndex = 58304;
