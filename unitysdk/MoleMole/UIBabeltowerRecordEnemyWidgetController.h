...
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1635D3F0)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1635D480)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1635D220)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1635D280)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER_REFRESHCARD_OFFSET UNITYSDK_OFFSET(0x1635D500)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1635D790)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER__UPDATEBOSSIMAGE_OFFSET UNITYSDK_OFFSET(0x1635D710)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1635D7F0)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1635D880)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1635D910)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1635D9A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerRecordEnemyWidgetController_TypeDefinitionIndex = 52420;

	class UIBabeltowerRecordEnemyWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_BCA11629035BC7F2_1* _view; // 0x2B8
		::Class_2_08E43914789BE5F3* towerModel; // 0x2C0
		::System::Int32 curFloor; // 0x2C8
		::System::Int32 towerid; // 0x2CC
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_5DA2E7556103D5A3_344*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER__UPDATEBOSSIMAGE_OFFSET))(this, cardConfigTemplate);
		}
