...
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1801ECA0)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1801ED30)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1801EAD0)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1801EB30)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER_REFRESHCARD_OFFSET UNITYSDK_OFFSET(0x1801EDB0)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1801F050)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER__UPDATEBOSSIMAGE_OFFSET UNITYSDK_OFFSET(0x1801EFD0)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1801F0B0)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1801F140)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1801F1D0)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1801F260)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerRecordEnemyWidgetController_TypeDefinitionIndex = 41802;

	class UIBabeltowerRecordEnemyWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_BCA11629035BC7F2* _view; // 0x2C0
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_5DA2E7556103D5A3_94*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER__UPDATEBOSSIMAGE_OFFSET))(this, cardConfigTemplate);
		}
