...
#define MOLEMOLE_UIEXPLORATIONMISSIONROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16EF0EA0)
#define MOLEMOLE_UIEXPLORATIONMISSIONROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16EF0FB0)
#define MOLEMOLE_UIEXPLORATIONMISSIONROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16EF0F30)
#define MOLEMOLE_UIEXPLORATIONMISSIONROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16EF0E40)
#define MOLEMOLE_UIEXPLORATIONMISSIONROWWIDGETCONTROLLER_SHOWQUESTSTATE_OFFSET UNITYSDK_OFFSET(0x16EF1610)
#define MOLEMOLE_UIEXPLORATIONMISSIONROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16EF16A0)
#define MOLEMOLE_UIEXPLORATIONMISSIONROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16EF16B0)
#define MOLEMOLE_UIEXPLORATIONMISSIONROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16EF1740)
#define MOLEMOLE_UIEXPLORATIONMISSIONROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16EF17E0)
#define MOLEMOLE_UIEXPLORATIONMISSIONROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16EF1870)

namespace MoleMole
{
	inline static constexpr unsigned int UIExplorationMissionRowWidgetController_TypeDefinitionIndex = 42023;

	class UIExplorationMissionRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_24456E84F3C6FD1D* _view; // 0x2E8
