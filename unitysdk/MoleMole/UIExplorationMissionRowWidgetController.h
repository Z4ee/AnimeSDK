...
#define MOLEMOLE_UIEXPLORATIONMISSIONROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19AAE370)
#define MOLEMOLE_UIEXPLORATIONMISSIONROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x19AAE480)
#define MOLEMOLE_UIEXPLORATIONMISSIONROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19AAE400)
#define MOLEMOLE_UIEXPLORATIONMISSIONROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19AAE310)
#define MOLEMOLE_UIEXPLORATIONMISSIONROWWIDGETCONTROLLER_SHOWQUESTSTATE_OFFSET UNITYSDK_OFFSET(0x19AAEBB0)
#define MOLEMOLE_UIEXPLORATIONMISSIONROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19AAEC40)
#define MOLEMOLE_UIEXPLORATIONMISSIONROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19AAEC50)
#define MOLEMOLE_UIEXPLORATIONMISSIONROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x19AAECE0)
#define MOLEMOLE_UIEXPLORATIONMISSIONROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19AAED80)
#define MOLEMOLE_UIEXPLORATIONMISSIONROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19AAEE10)

namespace MoleMole
{
	inline static constexpr unsigned int UIExplorationMissionRowWidgetController_TypeDefinitionIndex = 61672;
