...
#define MOLEMOLE_CONFIGRHYTHMMOVEBEATMAP_BEATMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5283A0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigRhythmMoveBeatMap_BeatMap_TypeDefinitionIndex = 65971;
