...
#define MOLEMOLE_CONFIGUIDAMAGETEXTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B21E2F0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIDamageTextItem_TypeDefinitionIndex = 44815;
