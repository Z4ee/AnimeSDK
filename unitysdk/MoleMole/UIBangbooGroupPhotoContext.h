...
#define MOLEMOLE_UIBANGBOOGROUPPHOTOCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x173557A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooGroupPhotoContext_TypeDefinitionIndex = 79686;
