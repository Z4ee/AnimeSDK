...
#define MOLEMOLE_UILEVELRESULTDELAYEVENT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x16C066E0)
#define MOLEMOLE_UILEVELRESULTDELAYEVENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16C06530)
#define MOLEMOLE_UILEVELRESULTDELAYEVENT_TRYFIREEVENT_OFFSET UNITYSDK_OFFSET(0x16C06570)
#define MOLEMOLE_UILEVELRESULTDELAYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16C06720)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultDelayEvent_TypeDefinitionIndex = 72344;
