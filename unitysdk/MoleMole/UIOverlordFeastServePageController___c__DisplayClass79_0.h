...
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER___C__DISPLAYCLASS79_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16A6DB30)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER___C__DISPLAYCLASS79_0__ISGUESTHAVESPECIFICDISHID_B__0_OFFSET UNITYSDK_OFFSET(0x16A6DB40)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastServePageController___c__DisplayClass79_0_TypeDefinitionIndex = 53324;
