...
#define MOLEMOLE_UIURBANMAPEXPLORELISTROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x151B5D50)
#define MOLEMOLE_UIURBANMAPEXPLORELISTROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x151B5DC0)
#define MOLEMOLE_UIURBANMAPEXPLORELISTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x151B5E80)
#define MOLEMOLE_UIURBANMAPEXPLORELISTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x151B5FF0)
#define MOLEMOLE_UIURBANMAPEXPLORELISTROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x151B6000)
#define MOLEMOLE_UIURBANMAPEXPLORELISTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x151B60A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapExploreListRowWidgetController_TypeDefinitionIndex = 80900;
