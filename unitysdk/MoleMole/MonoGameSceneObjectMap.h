...
#define MOLEMOLE_MONOGAMESCENEOBJECTMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x10809BC0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGameSceneObjectMap_TypeDefinitionIndex = 90379;
