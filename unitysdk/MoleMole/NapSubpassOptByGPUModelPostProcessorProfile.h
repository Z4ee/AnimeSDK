...
#define MOLEMOLE_NAPSUBPASSOPTBYGPUMODELPOSTPROCESSORPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x11D5A710)
#define MOLEMOLE_NAPSUBPASSOPTBYGPUMODELPOSTPROCESSORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x11D5A780)
#define MOLEMOLE_NAPSUBPASSOPTBYGPUMODELPOSTPROCESSORPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x11D5A810)

namespace MoleMole
{
	inline static constexpr unsigned int NapSubpassOptByGPUModelPostProcessorProfile_TypeDefinitionIndex = 79894;
