...
#define MOLEMOLE_NAPSUBPASSOPTBYGPUMODELPOSTPROCESSORPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x11DE3400)
#define MOLEMOLE_NAPSUBPASSOPTBYGPUMODELPOSTPROCESSORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x11DE3470)
#define MOLEMOLE_NAPSUBPASSOPTBYGPUMODELPOSTPROCESSORPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x11DE3500)

namespace MoleMole
{
	inline static constexpr unsigned int NapSubpassOptByGPUModelPostProcessorProfile_TypeDefinitionIndex = 63672;
