...
#define MOLEMOLE_UINAVIGATIONAREADETAILWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18205870)
#define MOLEMOLE_UINAVIGATIONAREADETAILWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x18205980)
#define MOLEMOLE_UINAVIGATIONAREADETAILWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18205900)
#define MOLEMOLE_UINAVIGATIONAREADETAILWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18205810)
#define MOLEMOLE_UINAVIGATIONAREADETAILWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x18205B00)
#define MOLEMOLE_UINAVIGATIONAREADETAILWIDGETCONTROLLER_SETPARTNERID_OFFSET UNITYSDK_OFFSET(0x18205AB0)
#define MOLEMOLE_UINAVIGATIONAREADETAILWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18205DB0)
#define MOLEMOLE_UINAVIGATIONAREADETAILWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18205DC0)
#define MOLEMOLE_UINAVIGATIONAREADETAILWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x18205E50)
#define MOLEMOLE_UINAVIGATIONAREADETAILWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18205EF0)
#define MOLEMOLE_UINAVIGATIONAREADETAILWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18205F80)

namespace MoleMole
{
	inline static constexpr unsigned int UINavigationAreaDetailWidgetController_TypeDefinitionIndex = 59647;
