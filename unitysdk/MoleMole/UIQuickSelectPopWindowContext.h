...
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x13E04C80)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuickSelectPopWindowContext_TypeDefinitionIndex = 49831;
