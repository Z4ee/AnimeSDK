...
#define MOLEMOLE_UIHOUNDGAMEPAGECONTROLLER_DOINPUT_OFFSET UNITYSDK_OFFSET(0x18370A70)
#define MOLEMOLE_UIHOUNDGAMEPAGECONTROLLER_GET_UICURSORHIDESTATE_OFFSET UNITYSDK_OFFSET(0x1836F600)
#define MOLEMOLE_UIHOUNDGAMEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1836F5F0)
#define MOLEMOLE_UIHOUNDGAMEPAGECONTROLLER_HIDEGAMEUI_OFFSET UNITYSDK_OFFSET(0x183706B0)
#define MOLEMOLE_UIHOUNDGAMEPAGECONTROLLER_HIDEIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x18370840)
#define MOLEMOLE_UIHOUNDGAMEPAGECONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1836FC70)
#define MOLEMOLE_UIHOUNDGAMEPAGECONTROLLER_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x1836F910)
#define MOLEMOLE_UIHOUNDGAMEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1836F610)
#define MOLEMOLE_UIHOUNDGAMEPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x18370D50)
#define MOLEMOLE_UIHOUNDGAMEPAGECONTROLLER_ONLOGICINIT_OFFSET UNITYSDK_OFFSET(0x1836FD70)
#define MOLEMOLE_UIHOUNDGAMEPAGECONTROLLER_ONREVCWORLDINITSCNOTIFY_OFFSET UNITYSDK_OFFSET(0x183726E0)
#define MOLEMOLE_UIHOUNDGAMEPAGECONTROLLER_ONSOULHOUNDBLOCKINPUT_OFFSET UNITYSDK_OFFSET(0x18370600)
#define MOLEMOLE_UIHOUNDGAMEPAGECONTROLLER_ONSOULHOUNDSGAMEEND_OFFSET UNITYSDK_OFFSET(0x18370490)
#define MOLEMOLE_UIHOUNDGAMEPAGECONTROLLER_ONSOULHOUNDUNBLOCKINPUT_OFFSET UNITYSDK_OFFSET(0x18370550)
#define MOLEMOLE_UIHOUNDGAMEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x183708A0)
#define MOLEMOLE_UIHOUNDGAMEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1836F6A0)
#define MOLEMOLE_UIHOUNDGAMEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1836F7D0)
#define MOLEMOLE_UIHOUNDGAMEPAGECONTROLLER_OPENGAMEUI_OFFSET UNITYSDK_OFFSET(0x183700B0)
#define MOLEMOLE_UIHOUNDGAMEPAGECONTROLLER_SETGAMETYPE_OFFSET UNITYSDK_OFFSET(0x18372650)
#define MOLEMOLE_UIHOUNDGAMEPAGECONTROLLER_SETWWISEFOLLOWINGLISTENER_OFFSET UNITYSDK_OFFSET(0x1836FDD0)
#define MOLEMOLE_UIHOUNDGAMEPAGECONTROLLER_TRYINPUT_OFFSET UNITYSDK_OFFSET(0x1836FB00)
#define MOLEMOLE_UIHOUNDGAMEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18372740)
#define MOLEMOLE_UIHOUNDGAMEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18372850)
#define MOLEMOLE_UIHOUNDGAMEPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x183728E0)
#define MOLEMOLE_UIHOUNDGAMEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18372910)
#define MOLEMOLE_UIHOUNDGAMEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18372920)
#define MOLEMOLE_UIHOUNDGAMEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18372930)

namespace MoleMole
{
	inline static constexpr unsigned int UIHoundGamePageController_TypeDefinitionIndex = 53914;

	class UIHoundGamePageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_60638234271CCDB8_73* _view; // 0x318
