...
#define MOLEMOLE_UIRABINLEVELTABBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x178EA650)
#define MOLEMOLE_UIRABINLEVELTABBTNWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x178EA760)
#define MOLEMOLE_UIRABINLEVELTABBTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x178EA6E0)
#define MOLEMOLE_UIRABINLEVELTABBTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x178EA5F0)
#define MOLEMOLE_UIRABINLEVELTABBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x178EAA20)
#define MOLEMOLE_UIRABINLEVELTABBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x178EAA30)
#define MOLEMOLE_UIRABINLEVELTABBTNWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x178EAAC0)
#define MOLEMOLE_UIRABINLEVELTABBTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x178EAB60)
#define MOLEMOLE_UIRABINLEVELTABBTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x178EABF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRabInLevelTabBtnWidgetController_TypeDefinitionIndex = 57586;
