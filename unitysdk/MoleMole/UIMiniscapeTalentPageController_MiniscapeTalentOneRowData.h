...
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_MINISCAPETALENTONEROWDATA_GETMINISCAPETALENTPERDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x13007B70)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_MINISCAPETALENTONEROWDATA_GETPERTALENTDATALIST_OFFSET UNITYSDK_OFFSET(0x13007B30)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_MINISCAPETALENTONEROWDATA_SETTABLEINFO_OFFSET UNITYSDK_OFFSET(0x13007C10)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_MINISCAPETALENTONEROWDATA_SORTMETHOD_OFFSET UNITYSDK_OFFSET(0x13007E40)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_MINISCAPETALENTONEROWDATA_SORTTABLEINFOLIST_OFFSET UNITYSDK_OFFSET(0x13007D40)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_MINISCAPETALENTONEROWDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x13007FB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMiniscapeTalentPageController_MiniscapeTalentOneRowData_TypeDefinitionIndex = 63122;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_147*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_MINISCAPETALENTONEROWDATA_SETTABLEINFO_OFFSET))(this, tableInfo);
		}
