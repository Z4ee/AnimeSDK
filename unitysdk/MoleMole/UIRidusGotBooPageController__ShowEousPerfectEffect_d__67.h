...
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__SHOWEOUSPERFECTEFFECT_D__67_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x7EA7F0)
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__SHOWEOUSPERFECTEFFECT_D__67_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x283610)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooPageController__ShowEousPerfectEffect_d__67_TypeDefinitionIndex = 40718;
