...
#define MOLEMOLE_UIBPPURCHASEV2CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15AB8180)

namespace MoleMole
{
	inline static constexpr unsigned int UIBPPurchaseV2Context_TypeDefinitionIndex = 75370;
