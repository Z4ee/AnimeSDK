...
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x169B6AF0)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER___C__DISPLAYCLASS13_0__PLAYEXIT_B__0_OFFSET UNITYSDK_OFFSET(0x169B7560)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER___C__DISPLAYCLASS13_0__PLAYEXIT_B__1_OFFSET UNITYSDK_OFFSET(0x169B7570)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelLoseResultPageController___c__DisplayClass13_0_TypeDefinitionIndex = 75529;
