...
#define MOLEMOLE_SLIDINGCONFIG___C__DISPLAYCLASS20_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1190E850)
#define MOLEMOLE_SLIDINGCONFIG___C__DISPLAYCLASS20_0__RELOADFROMFILEASYNC_G__LOADCALLBACK_0_OFFSET UNITYSDK_OFFSET(0x1190E860)

namespace MoleMole
{
	inline static constexpr unsigned int SlidingConfig___c__DisplayClass20_0_TypeDefinitionIndex = 58772;
