...
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY_ONADDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A004C50)
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY_ONINITINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A004BB0)
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY_ONREMOVEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A004C90)
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY_ONUPDATEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A004CD0)
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY_SENDTIMEROUTEVENT_OFFSET UNITYSDK_OFFSET(0x1A004E40)
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A004EC0)
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY___BASE_ONADDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A004ED0)
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY___BASE_ONINITINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A004F60)
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY___BASE_ONREMOVEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A004FF0)
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY___BASE_ONUPDATEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A005080)

namespace MoleMole::DefenseScene
{
	inline static constexpr unsigned int DefenseSceneTrapChessEntity_TypeDefinitionIndex = 43217;
