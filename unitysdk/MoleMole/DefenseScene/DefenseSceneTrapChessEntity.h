...
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY_ONADDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A07FF90)
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY_ONINITINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A07FEF0)
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY_ONREMOVEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A07FFD0)
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY_ONUPDATEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A080010)
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY_SENDTIMEROUTEVENT_OFFSET UNITYSDK_OFFSET(0x1A080180)
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A080200)
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY___BASE_ONADDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A080310)
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY___BASE_ONINITINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A080350)
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY___BASE_ONREMOVEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A0803A0)
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY___BASE_ONUPDATEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A0803E0)

namespace MoleMole::DefenseScene
{
	inline static constexpr unsigned int DefenseSceneTrapChessEntity_TypeDefinitionIndex = 74506;
