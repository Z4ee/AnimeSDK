...
#define MOLEMOLE_UIHOLLOWS2WEAPONWIDGETCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x163FBA60)
#define MOLEMOLE_UIHOLLOWS2WEAPONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x163FBD90)
#define MOLEMOLE_UIHOLLOWS2WEAPONWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x163FC540)
#define MOLEMOLE_UIHOLLOWS2WEAPONWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x163FBEA0)
#define MOLEMOLE_UIHOLLOWS2WEAPONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x163FBE20)
#define MOLEMOLE_UIHOLLOWS2WEAPONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x163FBA70)
#define MOLEMOLE_UIHOLLOWS2WEAPONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x163FBCD0)
#define MOLEMOLE_UIHOLLOWS2WEAPONWIDGETCONTROLLER_REFRESHREDPOINTBYDATA_OFFSET UNITYSDK_OFFSET(0x163FC7B0)
#define MOLEMOLE_UIHOLLOWS2WEAPONWIDGETCONTROLLER_REFRESHREDPOINT_OFFSET UNITYSDK_OFFSET(0x163FC800)
#define MOLEMOLE_UIHOLLOWS2WEAPONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x163FC9C0)
#define MOLEMOLE_UIHOLLOWS2WEAPONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x163FC9D0)
#define MOLEMOLE_UIHOLLOWS2WEAPONWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x163FCA60)
#define MOLEMOLE_UIHOLLOWS2WEAPONWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x163FCAF0)
#define MOLEMOLE_UIHOLLOWS2WEAPONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x163FCB90)
#define MOLEMOLE_UIHOLLOWS2WEAPONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x163FCC20)
#define MOLEMOLE_UIHOLLOWS2WEAPONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x163FCCB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowS2WeaponWidgetController_TypeDefinitionIndex = 39824;

	class UIHollowS2WeaponWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_17FE6C9BAA500062* _view; // 0x2E8
		::Class_2_E621E51D351EB960* _abyssModel; // 0x2F0
		::Class_2_F8D0B9C0BCFFDC55* _relicData; // 0x2F8
