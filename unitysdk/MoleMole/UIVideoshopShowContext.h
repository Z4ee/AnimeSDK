...
#define MOLEMOLE_UIVIDEOSHOPSHOWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x134342E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVideoshopShowContext_TypeDefinitionIndex = 52660;
