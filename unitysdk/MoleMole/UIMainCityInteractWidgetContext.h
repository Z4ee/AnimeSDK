...
#define MOLEMOLE_UIMAINCITYINTERACTWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x183A44F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityInteractWidgetContext_TypeDefinitionIndex = 67750;
