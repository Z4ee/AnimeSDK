...
#define MOLEMOLE_MONOEFFECTSUBPARTCLAMPMOVING_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x17E92550)
#define MOLEMOLE_MONOEFFECTSUBPARTCLAMPMOVING_METHOD_5_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0x17E920F0)
#define MOLEMOLE_MONOEFFECTSUBPARTCLAMPMOVING_METHOD_5_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0x17E923C0)
#define MOLEMOLE_MONOEFFECTSUBPARTCLAMPMOVING_METHOD_5_F0BD65B017F2AC0B_OFFSET UNITYSDK_OFFSET(0x17E92FB0)
#define MOLEMOLE_MONOEFFECTSUBPARTCLAMPMOVING_METHOD_5_F79D5EC57FBF426E_OFFSET UNITYSDK_OFFSET(0x17E93010)
#define MOLEMOLE_MONOEFFECTSUBPARTCLAMPMOVING_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x17E92300)
#define MOLEMOLE_MONOEFFECTSUBPARTCLAMPMOVING_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17E92030)
#define MOLEMOLE_MONOEFFECTSUBPARTCLAMPMOVING__CTOR_OFFSET UNITYSDK_OFFSET(0x17E92F30)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectSubpartClampMoving_TypeDefinitionIndex = 69765;
