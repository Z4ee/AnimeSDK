...
class Class_2_12CA2BD783D6D85C_1;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }
namespace System { class Object; }

#define MOLEMOLE_UIFISHINGCONTESTSTARWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1678F360)
#define MOLEMOLE_UIFISHINGCONTESTSTARWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1678F470)
#define MOLEMOLE_UIFISHINGCONTESTSTARWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1678F3F0)
#define MOLEMOLE_UIFISHINGCONTESTSTARWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1678F290)
#define MOLEMOLE_UIFISHINGCONTESTSTARWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1678F2F0)
#define MOLEMOLE_UIFISHINGCONTESTSTARWIDGETCONTROLLER_SETDATA_OFFSET UNITYSDK_OFFSET(0x1678F6C0)
#define MOLEMOLE_UIFISHINGCONTESTSTARWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1678F7D0)
#define MOLEMOLE_UIFISHINGCONTESTSTARWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1678F7E0)
#define MOLEMOLE_UIFISHINGCONTESTSTARWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1678F870)
#define MOLEMOLE_UIFISHINGCONTESTSTARWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1678F910)
#define MOLEMOLE_UIFISHINGCONTESTSTARWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1678F9A0)
#define MOLEMOLE_UIFISHINGCONTESTSTARWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1678FA30)

namespace MoleMole
{
	inline static constexpr unsigned int UIFishingContestStarWidgetController_TypeDefinitionIndex = 74385;

	class UIFishingContestStarWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_12CA2BD783D6D85C_1* _view; // 0x2E8
