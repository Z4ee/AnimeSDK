...
#define MOLEMOLE_UIRABCITYENTRANCEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x17A19450)
#define MOLEMOLE_UIRABCITYENTRANCEPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17A19460)
#define MOLEMOLE_UIRABCITYENTRANCEPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17A194D0)
#define MOLEMOLE_UIRABCITYENTRANCEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17A19570)
#define MOLEMOLE_UIRABCITYENTRANCEPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x17A193C0)
#define MOLEMOLE_UIRABCITYENTRANCEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17A197B0)
#define MOLEMOLE_UIRABCITYENTRANCEPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17A197C0)
#define MOLEMOLE_UIRABCITYENTRANCEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17A19860)
#define MOLEMOLE_UIRABCITYENTRANCEPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x17A198F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABCityEntrancePageController_TypeDefinitionIndex = 59808;
