...
#define MOLEMOLE_INPUTACTIONEVENT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x77F590)
#define MOLEMOLE_INPUTACTIONEVENT_EQUALS_OFFSET UNITYSDK_OFFSET(0x77F520)
#define MOLEMOLE_INPUTACTIONEVENT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x77F4D0)
#define MOLEMOLE_INPUTACTIONEVENT_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x14292680)
#define MOLEMOLE_INPUTACTIONEVENT_GET_INPUTDEVICEUSAGE_OFFSET UNITYSDK_OFFSET(0x2F0420)
#define MOLEMOLE_INPUTACTIONEVENT_METHOD_2_6D0360BD23602584_OFFSET UNITYSDK_OFFSET(0x77F610)
#define MOLEMOLE_INPUTACTIONEVENT_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x77F5A0)
#define MOLEMOLE_INPUTACTIONEVENT_SET_INPUTDEVICEUSAGE_OFFSET UNITYSDK_OFFSET(0x50A4B0)

namespace MoleMole
{
	inline static constexpr unsigned int InputActionEvent_TypeDefinitionIndex = 65635;
