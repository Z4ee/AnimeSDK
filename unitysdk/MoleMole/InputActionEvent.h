...
#define MOLEMOLE_INPUTACTIONEVENT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x741400)
#define MOLEMOLE_INPUTACTIONEVENT_EQUALS_OFFSET UNITYSDK_OFFSET(0x741390)
#define MOLEMOLE_INPUTACTIONEVENT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x741340)
#define MOLEMOLE_INPUTACTIONEVENT_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x116253F0)
#define MOLEMOLE_INPUTACTIONEVENT_GET_INPUTDEVICEUSAGE_OFFSET UNITYSDK_OFFSET(0x2C19D0)
#define MOLEMOLE_INPUTACTIONEVENT_METHOD_2_6D0360BD23602584_OFFSET UNITYSDK_OFFSET(0x741410)
#define MOLEMOLE_INPUTACTIONEVENT_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x741480)
#define MOLEMOLE_INPUTACTIONEVENT_SET_INPUTDEVICEUSAGE_OFFSET UNITYSDK_OFFSET(0x52CCD0)

namespace MoleMole
{
	inline static constexpr unsigned int InputActionEvent_TypeDefinitionIndex = 45314;
