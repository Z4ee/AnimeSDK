...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUEBOOL_MATERIALPROPERTYMODIFIERVALUEBOOL_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x13027EB0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUEBOOL_MATERIALPROPERTYMODIFIERVALUEBOOL_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x13027EC0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUEBOOL_MATERIALPROPERTYMODIFIERVALUEBOOL_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x13028130)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUEBOOL_MATERIALPROPERTYMODIFIERVALUEBOOL_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x13028320)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUEBOOL_MATERIALPROPERTYMODIFIERVALUEBOOL_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x130282C0)

namespace MoleMole
{
	inline static constexpr unsigned int MaterialPropertyModifierValueBool_MaterialPropertyModifierValueBool_UnityGeneratedFormatter_TypeDefinitionIndex = 65332;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(MaterialPropertyModifierValueBool_MaterialPropertyModifierValueBool_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x49DF0);
		}
