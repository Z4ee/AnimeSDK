...
#define MOLEMOLE_MAINCITYCHANGETARGETQUESTKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x12BC9160)
#define MOLEMOLE_MAINCITYCHANGETARGETQUESTKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x12BC9170)
#define MOLEMOLE_MAINCITYCHANGETARGETQUESTKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x12BC9180)

namespace MoleMole
{
	inline static constexpr unsigned int MainCityChangeTargetQuestKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 43145;
