...
#define MOLEMOLE_DEVICESETTINGVRAMPREDICATE_GETPREDICATEFLOAT_OFFSET UNITYSDK_OFFSET(0x16B61E60)
#define MOLEMOLE_DEVICESETTINGVRAMPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16B61EB0)
#define MOLEMOLE_DEVICESETTINGVRAMPREDICATE___BASE_GETPREDICATEFLOAT_OFFSET UNITYSDK_OFFSET(0x16B61F30)

namespace MoleMole
{
	inline static constexpr unsigned int DeviceSettingVRAMPredicate_TypeDefinitionIndex = 78015;
