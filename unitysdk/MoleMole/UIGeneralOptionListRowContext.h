...
#define MOLEMOLE_UIGENERALOPTIONLISTROWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1580CF10)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralOptionListRowContext_TypeDefinitionIndex = 64038;

	class UIGeneralOptionListRowContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::Collections::Generic::List_1<::System::String*>* DropDownContentRedPointPathList; // 0x28
		...
		::System::Boolean isUp; // 0x55
		::System::Boolean useLocalYHeight; // 0x56
		::System::Int32 curSelectIndex; // 0x58
		::System::Boolean ShowRedPointOnRootButton; // 0x5C
		::System::Boolean IsDesCenter; // 0x5D
		::UnityEngine::Vector3 positionOffset; // 0x60
		::Enum_3_58B2CC1546FE1550 arrowDirection; // 0x6C
