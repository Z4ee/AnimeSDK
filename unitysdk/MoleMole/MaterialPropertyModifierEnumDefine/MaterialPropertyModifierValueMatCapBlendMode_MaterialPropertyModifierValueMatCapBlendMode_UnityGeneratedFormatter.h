...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x130274D0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x130274E0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x13027750)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x13027940)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x130278E0)

namespace MoleMole::MaterialPropertyModifierEnumDefine
{
	inline static constexpr unsigned int MaterialPropertyModifierValueMatCapBlendMode_MaterialPropertyModifierValueMatCapBlendMode_UnityGeneratedFormatter_TypeDefinitionIndex = 62934;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(MaterialPropertyModifierValueMatCapBlendMode_MaterialPropertyModifierValueMatCapBlendMode_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x49DD0);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::MaterialPropertyModifierEnumDefine::MatCapBlendMode>**)Il2CppClass::FromTypeDefinitionIndex(MaterialPropertyModifierValueMatCapBlendMode_MaterialPropertyModifierValueMatCapBlendMode_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x49DD8);
		}
