...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMASKCHANNELTYPE_GETCLONEFROMENUM_OFFSET UNITYSDK_OFFSET(0x136C8FD0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMASKCHANNELTYPE_SYNCENABLE_1_OFFSET UNITYSDK_OFFSET(0x7D0A80)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMASKCHANNELTYPE_SYNCENABLE_OFFSET UNITYSDK_OFFSET(0x7D0A10)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMASKCHANNELTYPE_SYNCVALUE_1_OFFSET UNITYSDK_OFFSET(0x7D09B0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMASKCHANNELTYPE_SYNCVALUE_OFFSET UNITYSDK_OFFSET(0x7D0950)

namespace MoleMole::MaterialPropertyModifierEnumDefine
{
	inline static constexpr unsigned int MaterialPropertyModifierValueMaskChannelType_TypeDefinitionIndex = 60202;
