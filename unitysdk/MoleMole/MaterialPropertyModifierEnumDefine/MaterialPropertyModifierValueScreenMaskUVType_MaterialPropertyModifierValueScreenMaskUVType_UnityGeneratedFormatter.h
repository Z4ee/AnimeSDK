...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUESCREENMASKUVTYPE_MATERIALPROPERTYMODIFIERVALUESCREENMASKUVTYPE_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x125D34C0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUESCREENMASKUVTYPE_MATERIALPROPERTYMODIFIERVALUESCREENMASKUVTYPE_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x125D34D0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUESCREENMASKUVTYPE_MATERIALPROPERTYMODIFIERVALUESCREENMASKUVTYPE_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x125D3740)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUESCREENMASKUVTYPE_MATERIALPROPERTYMODIFIERVALUESCREENMASKUVTYPE_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x125D3930)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUESCREENMASKUVTYPE_MATERIALPROPERTYMODIFIERVALUESCREENMASKUVTYPE_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x125D38D0)

namespace MoleMole::MaterialPropertyModifierEnumDefine
{
	inline static constexpr unsigned int MaterialPropertyModifierValueScreenMaskUVType_MaterialPropertyModifierValueScreenMaskUVType_UnityGeneratedFormatter_TypeDefinitionIndex = 65650;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::MaterialPropertyModifierEnumDefine::ScreenMaskUVType>**)Il2CppClass::FromTypeDefinitionIndex(MaterialPropertyModifierValueScreenMaskUVType_MaterialPropertyModifierValueScreenMaskUVType_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x479D0);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Boolean>** StaticGet_CachedSerializer0()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(MaterialPropertyModifierValueScreenMaskUVType_MaterialPropertyModifierValueScreenMaskUVType_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x479D8);
		}
