...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPTYPE_GETCLONEFROMENUM_OFFSET UNITYSDK_OFFSET(0x19B2E6F0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPTYPE_SYNCENABLE_1_OFFSET UNITYSDK_OFFSET(0x8A9940)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPTYPE_SYNCENABLE_OFFSET UNITYSDK_OFFSET(0x8A98D0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPTYPE_SYNCVALUE_1_OFFSET UNITYSDK_OFFSET(0x8A9870)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPTYPE_SYNCVALUE_OFFSET UNITYSDK_OFFSET(0x8A9810)

namespace MoleMole::MaterialPropertyModifierEnumDefine
{
	inline static constexpr unsigned int MaterialPropertyModifierValueMatCapType_TypeDefinitionIndex = 46778;
