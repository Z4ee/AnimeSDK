...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPTYPE_GETCLONEFROMENUM_OFFSET UNITYSDK_OFFSET(0x1781A390)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPTYPE_SYNCENABLE_1_OFFSET UNITYSDK_OFFSET(0x7D6D40)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPTYPE_SYNCENABLE_OFFSET UNITYSDK_OFFSET(0x7D6CD0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPTYPE_SYNCVALUE_1_OFFSET UNITYSDK_OFFSET(0x7D6C70)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPTYPE_SYNCVALUE_OFFSET UNITYSDK_OFFSET(0x7D6C10)

namespace MoleMole::MaterialPropertyModifierEnumDefine
{
	inline static constexpr unsigned int MaterialPropertyModifierValueMatCapType_TypeDefinitionIndex = 71210;
