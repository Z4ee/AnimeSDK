...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEPOINTSPACE_GETCLONEFROMENUM_OFFSET UNITYSDK_OFFSET(0x1582C8E0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEPOINTSPACE_SYNCENABLE_1_OFFSET UNITYSDK_OFFSET(0x8008C0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEPOINTSPACE_SYNCENABLE_OFFSET UNITYSDK_OFFSET(0x800850)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEPOINTSPACE_SYNCVALUE_1_OFFSET UNITYSDK_OFFSET(0x8007F0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEPOINTSPACE_SYNCVALUE_OFFSET UNITYSDK_OFFSET(0x800790)

namespace MoleMole::MaterialPropertyModifierEnumDefine
{
	inline static constexpr unsigned int MaterialPropertyModifierValuePointSpace_TypeDefinitionIndex = 66772;
