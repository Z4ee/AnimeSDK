...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_GETCLONEFROMENUM_OFFSET UNITYSDK_OFFSET(0x138399A0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_SYNCENABLE_1_OFFSET UNITYSDK_OFFSET(0x76E280)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_SYNCENABLE_OFFSET UNITYSDK_OFFSET(0x76E210)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_SYNCVALUE_1_OFFSET UNITYSDK_OFFSET(0x76E1B0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_SYNCVALUE_OFFSET UNITYSDK_OFFSET(0x76E150)

namespace MoleMole::MaterialPropertyModifierEnumDefine
{
	inline static constexpr unsigned int MaterialPropertyModifierValueChannelEnumType_TypeDefinitionIndex = 58537;
