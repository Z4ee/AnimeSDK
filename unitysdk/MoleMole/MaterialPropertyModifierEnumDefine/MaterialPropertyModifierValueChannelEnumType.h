...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_GETCLONEFROMENUM_OFFSET UNITYSDK_OFFSET(0x16CB1780)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_SYNCENABLE_1_OFFSET UNITYSDK_OFFSET(0x824B60)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_SYNCENABLE_OFFSET UNITYSDK_OFFSET(0x824AF0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_SYNCVALUE_1_OFFSET UNITYSDK_OFFSET(0x824A90)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_SYNCVALUE_OFFSET UNITYSDK_OFFSET(0x824A30)

namespace MoleMole::MaterialPropertyModifierEnumDefine
{
	inline static constexpr unsigned int MaterialPropertyModifierValueChannelEnumType_TypeDefinitionIndex = 67836;
