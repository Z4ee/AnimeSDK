...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUELIGHTSOURCE_GETCLONEFROMENUM_OFFSET UNITYSDK_OFFSET(0x10BC7320)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUELIGHTSOURCE_SYNCENABLE_1_OFFSET UNITYSDK_OFFSET(0x701FE0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUELIGHTSOURCE_SYNCENABLE_OFFSET UNITYSDK_OFFSET(0x701F70)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUELIGHTSOURCE_SYNCVALUE_1_OFFSET UNITYSDK_OFFSET(0x701F10)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUELIGHTSOURCE_SYNCVALUE_OFFSET UNITYSDK_OFFSET(0x701EB0)

namespace MoleMole::MaterialPropertyModifierEnumDefine
{
	inline static constexpr unsigned int MaterialPropertyModifierValueLightSource_TypeDefinitionIndex = 63718;
