...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEOVERRIDERIMGLOWFRESNELBLENDMODE_GETCLONEFROMENUM_OFFSET UNITYSDK_OFFSET(0x1908E7F0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEOVERRIDERIMGLOWFRESNELBLENDMODE_SYNCENABLE_1_OFFSET UNITYSDK_OFFSET(0x88E270)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEOVERRIDERIMGLOWFRESNELBLENDMODE_SYNCENABLE_OFFSET UNITYSDK_OFFSET(0x88E200)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEOVERRIDERIMGLOWFRESNELBLENDMODE_SYNCVALUE_1_OFFSET UNITYSDK_OFFSET(0x88E1A0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEOVERRIDERIMGLOWFRESNELBLENDMODE_SYNCVALUE_OFFSET UNITYSDK_OFFSET(0x88E140)

namespace MoleMole::MaterialPropertyModifierEnumDefine
{
	inline static constexpr unsigned int MaterialPropertyModifierValueOverrideRimGlowFresnelBlendMode_TypeDefinitionIndex = 58706;
