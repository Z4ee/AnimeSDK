...
#define MOLEMOLE_SUMMERPLAYERWEAPONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x11D723E0)

namespace MoleMole
{
	inline static constexpr unsigned int SummerPlayerWeaponInfo_TypeDefinitionIndex = 81329;
