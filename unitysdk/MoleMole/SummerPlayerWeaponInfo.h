...
#define MOLEMOLE_SUMMERPLAYERWEAPONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1839AF00)

namespace MoleMole
{
	inline static constexpr unsigned int SummerPlayerWeaponInfo_TypeDefinitionIndex = 71513;
