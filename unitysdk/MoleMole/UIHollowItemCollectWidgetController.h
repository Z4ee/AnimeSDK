...
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_ADDITEMCOLLECTBYINDEX_1_OFFSET UNITYSDK_OFFSET(0x15FA6230)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_ADDITEMCOLLECTBYINDEX_OFFSET UNITYSDK_OFFSET(0x15FA5F00)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_GETFADEOUTEFFECTPARTICLE_OFFSET UNITYSDK_OFFSET(0x15FA8450)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_GETPIECEINDEXUIPOS_OFFSET UNITYSDK_OFFSET(0x15FA7EE0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_GET_BOTTOMCTRL_OFFSET UNITYSDK_OFFSET(0x15FA7430)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_GET_CHESSBOARD3DCTRL_OFFSET UNITYSDK_OFFSET(0x15FA6020)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_GET_HOLLOWMAINPAGE_OFFSET UNITYSDK_OFFSET(0x15FA87A0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_INITMOVEFINALPOS_OFFSET UNITYSDK_OFFSET(0x15FA54C0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x15FA8280)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15FA53B0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15FA5440)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15FA4F50)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15FA5340)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_PLAYGRIDCOLLECTIONDATA_OFFSET UNITYSDK_OFFSET(0x15FA68A0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_POPEFFECT_OFFSET UNITYSDK_OFFSET(0x15FA7C90)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_PROLOADEFFECTPOOL_OFFSET UNITYSDK_OFFSET(0x15FA52C0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_RECYCLEEFFECT_OFFSET UNITYSDK_OFFSET(0x15FA8320)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_RECYCLEFADEOUTEFFECTPARTICLE_OFFSET UNITYSDK_OFFSET(0x15FA8670)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_SHOWEFFECTATPOS_OFFSET UNITYSDK_OFFSET(0x15FA75E0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_TRYTRIGGEREFFECT_OFFSET UNITYSDK_OFFSET(0x15FA6630)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15FA89B0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15FA8C60)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15FA8CF0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15FA8D80)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15FA8E10)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowItemCollectWidgetController_TypeDefinitionIndex = 70383;

	class UIHollowItemCollectWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_6BC87267F41C82C6_12* _view; // 0x2B8
		::Foundation::ObjectPool_1<::MoleMole::UIHollowItemCollectWidgetController_GridCollectionData*>* _gridCollectionPool; // 0x2C0
		::System::Collections::Generic::Dictionary_2<::MoleMole::HollowChessboard::HollowCell, ::MoleMole::UIHollowItemCollectWidgetController_GridCollectionData*>* _collectionData; // 0x2C8
		::System::Collections::Generic::Dictionary_2<::MoleMole::HollowChessboard::HollowCell, ::UnityEngine::Vector3>* _index2PosCacheDic; // 0x2D0
		::System::Collections::Generic::List_1<::MoleMole::UIHollowItemCollectEffectWidgetController*>* _activeEffects; // 0x2D8
		::System::Collections::Generic::List_1<::MoleMole::UIHollowItemCollectEffectWidgetController*>* _itemCollectEffectPool; // 0x2E0
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::UnityEngine::ParticleSystem*>*>* _fadeOutParticlePoolDic; // 0x2E8
		::UnityEngine::Vector3 _coinFinalPos; // 0x2F0
		::UnityEngine::Vector3 _dinyFinalPos; // 0x2FC
		::UnityEngine::Vector3 _itemFinalPos; // 0x308
		::UnityEngine::GameObject* _coinTargetGo; // 0x318
		::UnityEngine::GameObject* _dinyTargetGo; // 0x320
		::UnityEngine::GameObject* _itemTargetGo; // 0x328
		::MoleMole::Config::ConfigHollowChessboard_ItemCollectConfigData* _itemCollectConfig; // 0x330
		::MoleMole::UIHollowMainPageController* _mainPage; // 0x338
		::MoleMole::UIHollowChessboard3DModelController* _chessboard3DCtrl; // 0x340
		::UnityEngine::RectTransform* _uiRect; // 0x348
