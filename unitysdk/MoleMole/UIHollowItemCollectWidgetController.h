...
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_ADDITEMCOLLECTBYINDEX_1_OFFSET UNITYSDK_OFFSET(0x19614940)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_ADDITEMCOLLECTBYINDEX_OFFSET UNITYSDK_OFFSET(0x19614610)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_GETFADEOUTEFFECTPARTICLE_OFFSET UNITYSDK_OFFSET(0x19616B70)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_GETPIECEINDEXUIPOS_OFFSET UNITYSDK_OFFSET(0x196165F0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_GET_BOTTOMCTRL_OFFSET UNITYSDK_OFFSET(0x19615B40)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_GET_CHESSBOARD3DCTRL_OFFSET UNITYSDK_OFFSET(0x19614730)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_GET_HOLLOWMAINPAGE_OFFSET UNITYSDK_OFFSET(0x19616EC0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_INITMOVEFINALPOS_OFFSET UNITYSDK_OFFSET(0x19613BE0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x196169A0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19613AD0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19613B60)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19613600)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19613A60)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_PLAYGRIDCOLLECTIONDATA_OFFSET UNITYSDK_OFFSET(0x19614FB0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_POPEFFECT_OFFSET UNITYSDK_OFFSET(0x196163A0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_PROLOADEFFECTPOOL_OFFSET UNITYSDK_OFFSET(0x196139E0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_RECYCLEEFFECT_OFFSET UNITYSDK_OFFSET(0x19616A40)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_RECYCLEFADEOUTEFFECTPARTICLE_OFFSET UNITYSDK_OFFSET(0x19616D90)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_SHOWEFFECTATPOS_OFFSET UNITYSDK_OFFSET(0x19615CF0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_TRYTRIGGEREFFECT_OFFSET UNITYSDK_OFFSET(0x19614D40)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x196170D0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19617380)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19617410)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x196174A0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19617530)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowItemCollectWidgetController_TypeDefinitionIndex = 54633;

	class UIHollowItemCollectWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_6BC87267F41C82C6_5* _view; // 0x2C0
		...
		::UnityEngine::Vector3 GetPieceIndexUIPos(::Class_4_AC6D98911872E0CE* piece)
		{
			return ((::UnityEngine::Vector3(*)(::PVOID, ::Class_4_AC6D98911872E0CE*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_GETPIECEINDEXUIPOS_OFFSET))(this, piece);
		}
