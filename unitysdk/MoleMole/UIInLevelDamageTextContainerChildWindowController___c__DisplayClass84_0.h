...
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER___C__DISPLAYCLASS84_0__CTOR_OFFSET UNITYSDK_OFFSET(0x14B59EC0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER___C__DISPLAYCLASS84_0__REFRESHSPECIALDAMAGETEXTV3CACHE_B__0_OFFSET UNITYSDK_OFFSET(0x14B59ED0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelDamageTextContainerChildWindowController___c__DisplayClass84_0_TypeDefinitionIndex = 45075;
