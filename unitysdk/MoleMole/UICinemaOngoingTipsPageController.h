...
#define MOLEMOLE_UICINEMAONGOINGTIPSPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x175BFCC0)
#define MOLEMOLE_UICINEMAONGOINGTIPSPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175BFCD0)
#define MOLEMOLE_UICINEMAONGOINGTIPSPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x175BFDB0)
#define MOLEMOLE_UICINEMAONGOINGTIPSPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x175BFD60)
#define MOLEMOLE_UICINEMAONGOINGTIPSPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x175BFE20)
#define MOLEMOLE_UICINEMAONGOINGTIPSPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175BFE30)
#define MOLEMOLE_UICINEMAONGOINGTIPSPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x175BFEC0)
#define MOLEMOLE_UICINEMAONGOINGTIPSPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x175BFED0)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaOngoingTipsPageController_TypeDefinitionIndex = 59890;
