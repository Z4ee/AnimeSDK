...
#define MOLEMOLE_GAMEOBJECTPOSITIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17905210)

namespace MoleMole
{
	inline static constexpr unsigned int GameObjectPositionData_TypeDefinitionIndex = 46819;
