...
#define MOLEMOLE_UICOMMONWEEKREWARDCOMPROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175C3350)
#define MOLEMOLE_UICOMMONWEEKREWARDCOMPROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x175C3570)
#define MOLEMOLE_UICOMMONWEEKREWARDCOMPROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x175C34F0)
#define MOLEMOLE_UICOMMONWEEKREWARDCOMPROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x175C3240)
#define MOLEMOLE_UICOMMONWEEKREWARDCOMPROWWIDGETCONTROLLER_REFRESHROWSTATE_OFFSET UNITYSDK_OFFSET(0x175C36A0)
#define MOLEMOLE_UICOMMONWEEKREWARDCOMPROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x175C3700)
#define MOLEMOLE_UICOMMONWEEKREWARDCOMPROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175C37A0)
#define MOLEMOLE_UICOMMONWEEKREWARDCOMPROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x175C3830)
#define MOLEMOLE_UICOMMONWEEKREWARDCOMPROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x175C38D0)
#define MOLEMOLE_UICOMMONWEEKREWARDCOMPROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x175C3710)

namespace MoleMole
{
	inline static constexpr unsigned int UICommonWeekRewardCompRowWidgetController_TypeDefinitionIndex = 60786;

	class UICommonWeekRewardCompRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_132* _view; // 0x2F0
