...
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATE_GET_CONTROLLER_OFFSET UNITYSDK_OFFSET(0x1939B020)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATE_ONCHANGESTATE_OFFSET UNITYSDK_OFFSET(0x1939B050)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATE_SET_CONTROLLER_OFFSET UNITYSDK_OFFSET(0x1939B030)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1939B040)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralNewsBubbleWidgetController_NewsBubbleState_TypeDefinitionIndex = 85279;
