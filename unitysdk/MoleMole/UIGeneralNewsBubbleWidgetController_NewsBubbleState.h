...
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATE_GET_CONTROLLER_OFFSET UNITYSDK_OFFSET(0x175E71F0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATE_ONCHANGESTATE_OFFSET UNITYSDK_OFFSET(0x175E7220)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATE_SET_CONTROLLER_OFFSET UNITYSDK_OFFSET(0x175E7200)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x175E7210)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralNewsBubbleWidgetController_NewsBubbleState_TypeDefinitionIndex = 54499;
