...
#define MOLEMOLE_CONFIGHOLLOWCHESSBOARDENTITYBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF8780)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigHollowChessboardEntityBehavior_TypeDefinitionIndex = 71822;
