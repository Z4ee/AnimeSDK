...
#define MOLEMOLE_UIANTIQUELEVELUPPOPWINDOWCONTROLLER___C__DISPLAYCLASS19_1__CTOR_OFFSET UNITYSDK_OFFSET(0x181BCB20)
#define MOLEMOLE_UIANTIQUELEVELUPPOPWINDOWCONTROLLER___C__DISPLAYCLASS19_1__REFRESHLEVELTXTVIEW_B__1_OFFSET UNITYSDK_OFFSET(0x181BCB30)
#define MOLEMOLE_UIANTIQUELEVELUPPOPWINDOWCONTROLLER___C__DISPLAYCLASS19_1__REFRESHLEVELTXTVIEW_B__2_OFFSET UNITYSDK_OFFSET(0x181BCBE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAntiqueLevelUpPopWindowController___c__DisplayClass19_1_TypeDefinitionIndex = 72507;
