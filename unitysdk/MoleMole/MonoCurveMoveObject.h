...
#define MOLEMOLE_MONOCURVEMOVEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x11634D80)

namespace MoleMole
{
	inline static constexpr unsigned int MonoCurveMoveObject_TypeDefinitionIndex = 39980;
