...
#define MOLEMOLE_MONOCURVEMOVEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x11D47B10)

namespace MoleMole
{
	inline static constexpr unsigned int MonoCurveMoveObject_TypeDefinitionIndex = 46261;
