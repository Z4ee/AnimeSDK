...
#define MOLEMOLE_CONFIGENEMYMONSTERDYNAMICCHECKTREENODE_CREATE_OFFSET UNITYSDK_OFFSET(0x19FF8240)
#define MOLEMOLE_CONFIGENEMYMONSTERDYNAMICCHECKTREENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF82D0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigEnemyMonsterDynamicCheckTreeNode_TypeDefinitionIndex = 47380;
	...
	public:
		...
		{
			return ((::Class_1_688FBF6C0FC439E7_Class_1_7E14AFCE0E4315E7*(*)(::PVOID, ::Class_1_BFC2F9D5895EB2FB*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIGENEMYMONSTERDYNAMICCHECKTREENODE_CREATE_OFFSET))(this, overrideMap);
		}
	};
}
