...
#define MOLEMOLE_CONFIGENEMYMONSTERDYNAMICCHECKTREENODE_CREATE_OFFSET UNITYSDK_OFFSET(0x1A077DF0)
#define MOLEMOLE_CONFIGENEMYMONSTERDYNAMICCHECKTREENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A077E80)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigEnemyMonsterDynamicCheckTreeNode_TypeDefinitionIndex = 75416;
