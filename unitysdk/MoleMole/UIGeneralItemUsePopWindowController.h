...
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_DOITEMUSE_OFFSET UNITYSDK_OFFSET(0x175E53C0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_DOPOWERACTION_OFFSET UNITYSDK_OFFSET(0x175E5430)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_DOPURCHASE_OFFSET UNITYSDK_OFFSET(0x175E52F0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x175E2D40)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x175E2D30)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_INITNUMINFOCONTENT_OFFSET UNITYSDK_OFFSET(0x175E4D70)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONCLICKSETTOMAX_OFFSET UNITYSDK_OFFSET(0x175E5880)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175E3080)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x175E5D60)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x175E5E60)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONINPUTCHANGED_OFFSET UNITYSDK_OFFSET(0x175E5B60)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONINPUTFIELDDESELECT_OFFSET UNITYSDK_OFFSET(0x175E59B0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONINPUTFIELDSELECT_OFFSET UNITYSDK_OFFSET(0x175E5970)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONITEMCHANGED_OFFSET UNITYSDK_OFFSET(0x175E51C0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONTEXTVALIDATEINPUT_OFFSET UNITYSDK_OFFSET(0x175E5AF0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x175E5900)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x175E2D50)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x175E3110)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x175E3350)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SETCONSOLEINFOBTN_OFFSET UNITYSDK_OFFSET(0x175E4A00)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SETDETAILSICONBTN_OFFSET UNITYSDK_OFFSET(0x175E46B0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SETITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x175E4BF0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SETMAXUSECOUNT_OFFSET UNITYSDK_OFFSET(0x175E4B90)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SETSLIDERGREY_OFFSET UNITYSDK_OFFSET(0x175E4C80)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SETSPECIALBTNTEXT_OFFSET UNITYSDK_OFFSET(0x175E4490)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SETTITLEINFOBTN_OFFSET UNITYSDK_OFFSET(0x175E4870)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SHOWSPECIAL02BTNTIP_OFFSET UNITYSDK_OFFSET(0x175E45D0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SHOWSPECIALBTNPANEL_OFFSET UNITYSDK_OFFSET(0x175E4200)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SHOWUSEBTN_OFFSET UNITYSDK_OFFSET(0x175E4190)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x175E6080)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER__REFRESHVIEW_B__17_0_OFFSET UNITYSDK_OFFSET(0x175E6090)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER__REFRESHVIEW_B__17_1_OFFSET UNITYSDK_OFFSET(0x175E6310)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER__REFRESHVIEW_B__17_2_OFFSET UNITYSDK_OFFSET(0x175E63B0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175E6410)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x175E64A0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x175E6530)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x175E65C0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x175E65D0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x175E65E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralItemUsePopWindowController_TypeDefinitionIndex = 80924;
