...
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_DOITEMUSE_OFFSET UNITYSDK_OFFSET(0x19399C90)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_DOPOWERACTION_OFFSET UNITYSDK_OFFSET(0x19399D00)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_DOPURCHASE_OFFSET UNITYSDK_OFFSET(0x19399BC0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x19397530)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x19397520)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_INITNUMINFOCONTENT_OFFSET UNITYSDK_OFFSET(0x19399640)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONCLICKSETTOMAX_OFFSET UNITYSDK_OFFSET(0x1939A160)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19397870)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x1939A640)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x1939A740)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONINPUTCHANGED_OFFSET UNITYSDK_OFFSET(0x1939A440)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONINPUTFIELDDESELECT_OFFSET UNITYSDK_OFFSET(0x1939A290)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONINPUTFIELDSELECT_OFFSET UNITYSDK_OFFSET(0x1939A250)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONITEMCHANGED_OFFSET UNITYSDK_OFFSET(0x19399A90)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONTEXTVALIDATEINPUT_OFFSET UNITYSDK_OFFSET(0x1939A3D0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1939A1E0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19397540)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19397900)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x19397B40)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SETCONSOLEINFOBTN_OFFSET UNITYSDK_OFFSET(0x193992D0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SETDETAILSICONBTN_OFFSET UNITYSDK_OFFSET(0x19398F70)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SETITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x193994C0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SETMAXUSECOUNT_OFFSET UNITYSDK_OFFSET(0x19399460)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SETSLIDERGREY_OFFSET UNITYSDK_OFFSET(0x19399550)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SETSPECIALBTNTEXT_OFFSET UNITYSDK_OFFSET(0x19398D50)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SETTITLEINFOBTN_OFFSET UNITYSDK_OFFSET(0x19399130)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SHOWSPECIAL02BTNTIP_OFFSET UNITYSDK_OFFSET(0x19398E90)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SHOWSPECIALBTNPANEL_OFFSET UNITYSDK_OFFSET(0x19398AC0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SHOWUSEBTN_OFFSET UNITYSDK_OFFSET(0x19398A50)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1939A960)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER__REFRESHVIEW_B__17_0_OFFSET UNITYSDK_OFFSET(0x1939A970)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER__REFRESHVIEW_B__17_1_OFFSET UNITYSDK_OFFSET(0x1939ABF0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER__REFRESHVIEW_B__17_2_OFFSET UNITYSDK_OFFSET(0x1939AC90)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1939ACF0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x1939AD80)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x1939AE10)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1939AEA0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1939AEB0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1939AEC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralItemUsePopWindowController_TypeDefinitionIndex = 55113;
	...
	public:
		...
		::System::Int32 _maxUseCount; // 0x328
		::System::Boolean _showInputField; // 0x32C
		::System::Int32 _expectedInitCount; // 0x330
		::System::UInt32 useCount; // 0x334
		::UnityEngine::UI::Image* _sliderHandleImage; // 0x338
		::System::Action_1<::System::Int32>* useAction; // 0x340
		::System::Boolean isTextChanging; // 0x348
		::System::String* _titleText; // 0x350
