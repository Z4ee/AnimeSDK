...
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ENTERARCADEMACHINEPHASEFROMPLAYGAMENOANIM_OFFSET UNITYSDK_OFFSET(0x18BE8510)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ENTERARCADEMACHINEPHASEFROMPLAYGAME_OFFSET UNITYSDK_OFFSET(0x18BE8370)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ENTERARCADEMACHINEPHASEFROMSPINNINGTABLE_OFFSET UNITYSDK_OFFSET(0x18BE77B0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ENTERENTRANCEPHASEFROMSPINNINGTABLE_OFFSET UNITYSDK_OFFSET(0x18BE7180)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ENTERPLAYGAMEPHASEFROMARCADEMACHINENOANIM_OFFSET UNITYSDK_OFFSET(0x18BE8180)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ENTERPLAYGAMEPHASEFROMARCADEMACHINE_OFFSET UNITYSDK_OFFSET(0x18BE7DB0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ENTERPLAYGAMEPHASEFROMSPINNINGTABLE_OFFSET UNITYSDK_OFFSET(0x18BE8700)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ENTERSPINNINGTABLEPHASEFROMARCADEMACHINE_OFFSET UNITYSDK_OFFSET(0x18BE79B0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ENTERSPINNINGTABLEPHASEFROMENTRANCEDIRECT_OFFSET UNITYSDK_OFFSET(0x18BE6F90)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ENTERSPINNINGTABLEPHASEFROMENTRANCE_OFFSET UNITYSDK_OFFSET(0x18BE6CF0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ENTERSPINNINGTABLEPHASEFROMPLAYGAME_OFFSET UNITYSDK_OFFSET(0x18BE88A0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_GETARCADEMODELSCREENDISPLAYTYPE_OFFSET UNITYSDK_OFFSET(0x18BE9CB0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_GETCENTERDATAINDEX_OFFSET UNITYSDK_OFFSET(0x18BE6CA0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_GETCENTERPOSITIONINDEX_OFFSET UNITYSDK_OFFSET(0x18BE6C50)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_GETMACHINEUNIT3DMODELCONTROLLER_OFFSET UNITYSDK_OFFSET(0x18BE8E70)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_GETTARGETROTATIONAXISVALUE_OFFSET UNITYSDK_OFFSET(0x18BEA5C0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_INITARCADEMACHINEINFO_OFFSET UNITYSDK_OFFSET(0x18BE9E50)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_INITCAMERAINFO_OFFSET UNITYSDK_OFFSET(0x18BEA6A0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x18BE5790)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ISTABLEROTATING_OFFSET UNITYSDK_OFFSET(0x18BEA1D0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18BE5B80)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ONENTERGAMERTPHASE_OFFSET UNITYSDK_OFFSET(0x18BE7F50)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ONENTERNEARPOSPHASE_OFFSET UNITYSDK_OFFSET(0x18BE7BB0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ONENTERTITLEVIDEOPHASE_OFFSET UNITYSDK_OFFSET(0x18BE7570)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18BE5C10)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18BE5710)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_PRELEAVEPLAYGAMEPHASE_OFFSET UNITYSDK_OFFSET(0x18BE7510)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_REFRESHCOMMONVIEW_OFFSET UNITYSDK_OFFSET(0x18BE9000)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_REFRESHSPINNINGTABLESTATE_OFFSET UNITYSDK_OFFSET(0x18BE8AD0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_REFRESHTABLEROTATINGBYGAMELIST_OFFSET UNITYSDK_OFFSET(0x18BE9F50)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_REFRESHTABLEROTATING_OFFSET UNITYSDK_OFFSET(0x18BE9FB0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_REGISTERMINIGAMEWORLD_OFFSET UNITYSDK_OFFSET(0x18BE9670)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_RESETCAMERAMOVE_OFFSET UNITYSDK_OFFSET(0x18BE6E90)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_RESETTABLEROTATING_OFFSET UNITYSDK_OFFSET(0x18BE74C0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_SET3DSCREENSHOWENABLED_OFFSET UNITYSDK_OFFSET(0x18BE9B30)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_SETCAMERAMOVESTATE_OFFSET UNITYSDK_OFFSET(0x18BEA4A0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_SETDIRECTIONALLIGHTSTATE_OFFSET UNITYSDK_OFFSET(0x18BEA220)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_SETREFCONTROLLER_OFFSET UNITYSDK_OFFSET(0x18BE94D0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_STARTARCADEGAME_OFFSET UNITYSDK_OFFSET(0x18BE99B0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_STOPCENTERMACHINEVIDEO_OFFSET UNITYSDK_OFFSET(0x18BE8A40)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_TICKCAMERA_OFFSET UNITYSDK_OFFSET(0x18BE5D70)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_TICKSPINNINGTABLEROTATE_OFFSET UNITYSDK_OFFSET(0x18BE6840)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_TICKTABLEROTATINGBYSELF_OFFSET UNITYSDK_OFFSET(0x18BE6B90)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_UNREGISTERMINIGAMEWORLD_OFFSET UNITYSDK_OFFSET(0x18BE9810)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x18BE5C80)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18BEAC30)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18BEAD30)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18BEADC0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18BEADD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeShop3DModelController_TypeDefinitionIndex = 40354;

	class UIArcadeShop3DModelController : public ::MoleMole::UIBase3DModelController
	{
	public:
		::Class_2_6BC87267F41C82C6* _view; // 0x360
