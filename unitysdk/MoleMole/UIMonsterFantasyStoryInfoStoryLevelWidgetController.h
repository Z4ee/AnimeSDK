...
#define MOLEMOLE_UIMONSTERFANTASYSTORYINFOSTORYLEVELWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16DA7C40)
#define MOLEMOLE_UIMONSTERFANTASYSTORYINFOSTORYLEVELWIDGETCONTROLLER_ONCLICKSTART_OFFSET UNITYSDK_OFFSET(0x16DA81A0)
#define MOLEMOLE_UIMONSTERFANTASYSTORYINFOSTORYLEVELWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16DA7CB0)
#define MOLEMOLE_UIMONSTERFANTASYSTORYINFOSTORYLEVELWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16DA7D70)
#define MOLEMOLE_UIMONSTERFANTASYSTORYINFOSTORYLEVELWIDGETCONTROLLER_SYNCCONTEXT_OFFSET UNITYSDK_OFFSET(0x16DA7FE0)
#define MOLEMOLE_UIMONSTERFANTASYSTORYINFOSTORYLEVELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16DA8240)
#define MOLEMOLE_UIMONSTERFANTASYSTORYINFOSTORYLEVELWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16DA82A0)
#define MOLEMOLE_UIMONSTERFANTASYSTORYINFOSTORYLEVELWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16DA8340)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyStoryInfoStoryLevelWidgetController_TypeDefinitionIndex = 43826;
