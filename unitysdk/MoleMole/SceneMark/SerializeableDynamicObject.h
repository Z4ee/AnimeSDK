...
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT_COPYFROMMONO_1_OFFSET UNITYSDK_OFFSET(0x191B2B70)
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT_COPYFROMMONO_OFFSET UNITYSDK_OFFSET(0x191B29D0)
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT_GETOBJECTTAG_OFFSET UNITYSDK_OFFSET(0x191B2D00)
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT_GETOBJECT_OFFSET UNITYSDK_OFFSET(0x191B2D60)
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT_RESETACTIVE_OFFSET UNITYSDK_OFFSET(0x191B2E00)
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT_SETACTIVE_OFFSET UNITYSDK_OFFSET(0x191B2DA0)
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191B2B60)
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x191B29C0)

namespace MoleMole::SceneMark
{
	inline static constexpr unsigned int SerializeableDynamicObject_TypeDefinitionIndex = 64106;
