...
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT_COPYFROMMONO_1_OFFSET UNITYSDK_OFFSET(0x15E54E60)
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT_COPYFROMMONO_OFFSET UNITYSDK_OFFSET(0x15E54CC0)
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT_GETOBJECTTAG_OFFSET UNITYSDK_OFFSET(0x15E54FF0)
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT_GETOBJECT_OFFSET UNITYSDK_OFFSET(0x15E55050)
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT_RESETACTIVE_OFFSET UNITYSDK_OFFSET(0x15E550F0)
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT_SETACTIVE_OFFSET UNITYSDK_OFFSET(0x15E55090)
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x15E54E50)
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x15E54CB0)

namespace MoleMole::SceneMark
{
	inline static constexpr unsigned int SerializeableDynamicObject_TypeDefinitionIndex = 44919;
