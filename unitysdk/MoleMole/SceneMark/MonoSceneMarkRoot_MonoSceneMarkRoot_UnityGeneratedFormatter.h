...
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT_MONOSCENEMARKROOT_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x16CE2C40)
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT_MONOSCENEMARKROOT_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x16CE2C50)
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT_MONOSCENEMARKROOT_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x16CE2EF0)
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT_MONOSCENEMARKROOT_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x16CE30E0)
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT_MONOSCENEMARKROOT_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x16CE30A0)

namespace MoleMole::SceneMark
{
	inline static constexpr unsigned int MonoSceneMarkRoot_MonoSceneMarkRoot_UnityGeneratedFormatter_TypeDefinitionIndex = 70868;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::SceneMark::SceneMarkNode*>**)Il2CppClass::FromTypeDefinitionIndex(MonoSceneMarkRoot_MonoSceneMarkRoot_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x42FB8);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::SceneMark::SceneMarkNode*>*>**)Il2CppClass::FromTypeDefinitionIndex(MonoSceneMarkRoot_MonoSceneMarkRoot_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x42FC0);
		}
