...
#define MOLEMOLE_SCENEMARK_LEVELEXTRADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1792BAE0)

namespace MoleMole::SceneMark
{
	inline static constexpr unsigned int LevelExtraData_TypeDefinitionIndex = 86886;
