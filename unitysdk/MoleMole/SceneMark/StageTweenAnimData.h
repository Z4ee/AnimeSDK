...
#define MOLEMOLE_SCENEMARK_STAGETWEENANIMDATA_CREATETWEENHANDLE_OFFSET UNITYSDK_OFFSET(0x10BE91F0)
#define MOLEMOLE_SCENEMARK_STAGETWEENANIMDATA_CREATETWEEN_OFFSET UNITYSDK_OFFSET(0x10BE7A50)
#define MOLEMOLE_SCENEMARK_STAGETWEENANIMDATA_GETCOMPONENT_OFFSET UNITYSDK_OFFSET(0x10BE78F0)
#define MOLEMOLE_SCENEMARK_STAGETWEENANIMDATA_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x10BE7590)
#define MOLEMOLE_SCENEMARK_STAGETWEENANIMDATA_GET__ONTWEENFINISHED_OFFSET UNITYSDK_OFFSET(0x10BE9150)
#define MOLEMOLE_SCENEMARK_STAGETWEENANIMDATA_ONTWEENFINISHED_OFFSET UNITYSDK_OFFSET(0x10BE9230)
#define MOLEMOLE_SCENEMARK_STAGETWEENANIMDATA_TYPETODOTARGETTYPE_OFFSET UNITYSDK_OFFSET(0x10BE7710)
#define MOLEMOLE_SCENEMARK_STAGETWEENANIMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x10BE9280)

namespace MoleMole::SceneMark
{
	inline static constexpr unsigned int StageTweenAnimData_TypeDefinitionIndex = 55021;
