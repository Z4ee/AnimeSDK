...
#define MOLEMOLE_SCENEMARK_STAGETWEENANIMDATA_CREATETWEENHANDLE_OFFSET UNITYSDK_OFFSET(0x17386E90)
#define MOLEMOLE_SCENEMARK_STAGETWEENANIMDATA_CREATETWEEN_OFFSET UNITYSDK_OFFSET(0x173856F0)
#define MOLEMOLE_SCENEMARK_STAGETWEENANIMDATA_GETCOMPONENT_OFFSET UNITYSDK_OFFSET(0x17385590)
#define MOLEMOLE_SCENEMARK_STAGETWEENANIMDATA_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x17385230)
#define MOLEMOLE_SCENEMARK_STAGETWEENANIMDATA_GET__ONTWEENFINISHED_OFFSET UNITYSDK_OFFSET(0x17386DF0)
#define MOLEMOLE_SCENEMARK_STAGETWEENANIMDATA_ONTWEENFINISHED_OFFSET UNITYSDK_OFFSET(0x17386ED0)
#define MOLEMOLE_SCENEMARK_STAGETWEENANIMDATA_TYPETODOTARGETTYPE_OFFSET UNITYSDK_OFFSET(0x173853B0)
#define MOLEMOLE_SCENEMARK_STAGETWEENANIMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17386F20)

namespace MoleMole::SceneMark
{
	inline static constexpr unsigned int StageTweenAnimData_TypeDefinitionIndex = 66295;
