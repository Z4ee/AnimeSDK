...
#define MOLEMOLE_SCENEMARK_NAVMESHLINKMARK__CTOR_OFFSET UNITYSDK_OFFSET(0x15B4ABE0)

namespace MoleMole::SceneMark
{
	inline static constexpr unsigned int NavmeshLinkMark_TypeDefinitionIndex = 79117;
