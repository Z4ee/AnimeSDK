...
#define MOLEMOLE_SCENEMARK_DYNAMICOBJECT_DYNAMICOBJECTCOLLECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17385180)

namespace MoleMole::SceneMark::DynamicObject
{
	inline static constexpr unsigned int DynamicObjectCollector_TypeDefinitionIndex = 81928;
