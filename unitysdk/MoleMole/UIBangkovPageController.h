...
class Class_2_799D895C9BACE912;
...
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER_BANGBOOFRIENDCLEAR_OFFSET UNITYSDK_OFFSET(0x12F54EA0)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER_BANGBOOFRIENDINIT_OFFSET UNITYSDK_OFFSET(0x12F548B0)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER_GETUIBANGBOOEOUSPREFABPATH_OFFSET UNITYSDK_OFFSET(0x12F56020)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER_GETUIBANGBOOPREFABPATH_OFFSET UNITYSDK_OFFSET(0x12F55CF0)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x12F561D0)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x12F561E0)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER_HANDLEGOBTNNAVTORIGHT_OFFSET UNITYSDK_OFFSET(0x12F58830)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER_HANDLERIGHTNAVTOGOBTN_OFFSET UNITYSDK_OFFSET(0x12F58940)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER_INITATTACHPOINTS_OFFSET UNITYSDK_OFFSET(0x12F54A10)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x12F56250)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER_ONGAMEPADMODULETRYOVERRIDENAVIGATETARGET_OFFSET UNITYSDK_OFFSET(0x12F586E0)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER_ONSELECTBANGBOOCHANGED_OFFSET UNITYSDK_OFFSET(0x12F55070)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x12F56960)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER_ONTALENTNODESTATECHANGED_OFFSET UNITYSDK_OFFSET(0x12F58090)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x12F579C0)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12F57660)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12F56700)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER_PLACEEOUS_OFFSET UNITYSDK_OFFSET(0x12F55E60)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER_REFRESHALLBUTTONS_OFFSET UNITYSDK_OFFSET(0x12F578E0)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER_REFRESHTOKEN_OFFSET UNITYSDK_OFFSET(0x12F57090)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER_REGISTERUNLOCKEVENT_OFFSET UNITYSDK_OFFSET(0x12F56630)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x12F57FF0)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER_TRYSHOWSETTLECOINRATEDIALOG_OFFSET UNITYSDK_OFFSET(0x12F574D0)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER_UNREGISTERUNLOCKEVENT_OFFSET UNITYSDK_OFFSET(0x12F57810)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER__BANGBOOFRIENDINIT_B__9_0_OFFSET UNITYSDK_OFFSET(0x12F58B80)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12F58A50)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER__PLACEEOUS_B__13_0_OFFSET UNITYSDK_OFFSET(0x12F58DD0)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER__REGISTERUNLOCKEVENT_B__29_0_OFFSET UNITYSDK_OFFSET(0x12F58EF0)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER__UNREGISTERUNLOCKEVENT_B__30_0_OFFSET UNITYSDK_OFFSET(0x12F58F00)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x12F58F10)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER___BASE_ONGAMEPADMODULETRYOVERRIDENAVIGATETARGET_OFFSET UNITYSDK_OFFSET(0x12F58F60)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x12F58FF0)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x12F59090)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12F590A0)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12F590B0)
#define MOLEMOLE_UIBANGKOVPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x12F590C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangkovPageController_TypeDefinitionIndex = 54299;
	...
	public:
		...
		::Il2CppArray<::System::String*>* _bangbooAttachPointNames; // 0x320
		::Il2CppArray<::UnityEngine::Transform*>* _bangbooAttachPoints; // 0x328
		::UnityEngine::Transform* _eousAttachPoint; // 0x330
		::Class_1_312B1553EA241D69* _loadProxy; // 0x338
		::Il2CppArray<::System::Int32>* _bangbooRobotIds; // 0x340
		::Il2CppArray<::UnityEngine::GameObject*>* _bangbooGameObjects; // 0x348
		...
		::Class_2_799D895C9BACE912* get__viewModel()
		{
			return ((::Class_2_799D895C9BACE912*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBANGKOVPAGECONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
