...
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x1A1C7CF0)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1A1C7900)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1A1C7A10)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1A1C7990)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1A1C7750)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1A1C7B10)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER_SETSELECTED_OFFSET UNITYSDK_OFFSET(0x1A1C7E30)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1C7EC0)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x1A1C7ED0)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1A1C7EE0)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1A1C7F70)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1A1C8010)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1A1C80A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssRoleBtnRowWidgetController_TypeDefinitionIndex = 51096;

	class UIAbyssRoleBtnRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_4DCCADF9A0DA6BC6* _view; // 0x2F0
