...
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x196C4D50)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x196C4960)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x196C4A70)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x196C49F0)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x196C47B0)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x196C4B70)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER_SETSELECTED_OFFSET UNITYSDK_OFFSET(0x196C4E90)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x196C4F20)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x196C4F30)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x196C4F40)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x196C4FD0)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x196C5070)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x196C5100)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssRoleBtnRowWidgetController_TypeDefinitionIndex = 84633;
