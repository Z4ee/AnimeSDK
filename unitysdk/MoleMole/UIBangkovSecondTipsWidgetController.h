...
#define MOLEMOLE_UIBANGKOVSECONDTIPSWIDGETCONTROLLER_ONCLICKREWARDITEMBTN_OFFSET UNITYSDK_OFFSET(0x197023F0)
#define MOLEMOLE_UIBANGKOVSECONDTIPSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19702D30)
#define MOLEMOLE_UIBANGKOVSECONDTIPSWIDGETCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x19702E40)
#define MOLEMOLE_UIBANGKOVSECONDTIPSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19702DC0)
#define MOLEMOLE_UIBANGKOVSECONDTIPSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19702220)
#define MOLEMOLE_UIBANGKOVSECONDTIPSWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19702440)
#define MOLEMOLE_UIBANGKOVSECONDTIPSWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x19702540)
#define MOLEMOLE_UIBANGKOVSECONDTIPSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19703050)
#define MOLEMOLE_UIBANGKOVSECONDTIPSWIDGETCONTROLLER__ONUIINIT_B__4_0_OFFSET UNITYSDK_OFFSET(0x197030B0)
#define MOLEMOLE_UIBANGKOVSECONDTIPSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x197031B0)
#define MOLEMOLE_UIBANGKOVSECONDTIPSWIDGETCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x19703240)
#define MOLEMOLE_UIBANGKOVSECONDTIPSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x197032F0)
#define MOLEMOLE_UIBANGKOVSECONDTIPSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19703380)
#define MOLEMOLE_UIBANGKOVSECONDTIPSWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19703410)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangkovSecondTipsWidgetController_TypeDefinitionIndex = 87830;

	class UIBangkovSecondTipsWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_1FDF4A6B8296853E* _view; // 0x2C0
		::Class_0_16E4307DCC419505_266* _kovData; // 0x2C8
		...
		{
			return ((::MoleMole::ScrollViewItemWidgetController*(*)(::PVOID, ::Struct_2_575273D27F02957E))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBANGKOVSECONDTIPSWIDGETCONTROLLER__ONUIINIT_B__4_0_OFFSET))(this, binderInfo);
		}
