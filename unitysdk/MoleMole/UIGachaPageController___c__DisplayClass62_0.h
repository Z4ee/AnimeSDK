...
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS62_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19DB6CA0)
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS62_0__REFRESHSPECIALPANEL_B__2_OFFSET UNITYSDK_OFFSET(0x19DB6CB0)
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS62_0__REFRESHSPECIALPANEL_G__SHOULDWEAPONSHOWSP_0_OFFSET UNITYSDK_OFFSET(0x19DB7460)
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS62_0__REFRESHSPECIALPANEL_G__TRYGETWEAPONGACHADEMOVIDEOPATH_1_OFFSET UNITYSDK_OFFSET(0x19DB7260)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaPageController___c__DisplayClass62_0_TypeDefinitionIndex = 64993;

	class UIGachaPageController___c__DisplayClass62_0 : public ::System::Object
	{
	public:
		::MoleMole::UIGachaPageController* __4__this; // 0x10
		::Class_3_4666E61F66433B1E_2* gacha; // 0x18
