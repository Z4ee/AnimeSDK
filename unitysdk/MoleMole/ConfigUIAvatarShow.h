...
#define MOLEMOLE_CONFIGUIAVATARSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C486490)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIAvatarShow_TypeDefinitionIndex = 43720;
