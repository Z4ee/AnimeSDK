...
#define MOLEMOLE_CONFIGUIAVATARSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x189E4A70)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIAvatarShow_TypeDefinitionIndex = 55792;
