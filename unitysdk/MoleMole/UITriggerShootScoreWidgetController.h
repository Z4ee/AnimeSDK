...
#define MOLEMOLE_UITRIGGERSHOOTSCOREWIDGETCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x15529350)
#define MOLEMOLE_UITRIGGERSHOOTSCOREWIDGETCONTROLLER_ISALIVE_OFFSET UNITYSDK_OFFSET(0x155295E0)
#define MOLEMOLE_UITRIGGERSHOOTSCOREWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15529130)
#define MOLEMOLE_UITRIGGERSHOOTSCOREWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x155292F0)
#define MOLEMOLE_UITRIGGERSHOOTSCOREWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15529240)
#define MOLEMOLE_UITRIGGERSHOOTSCOREWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x155291C0)
#define MOLEMOLE_UITRIGGERSHOOTSCOREWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15529060)
#define MOLEMOLE_UITRIGGERSHOOTSCOREWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x155290C0)
#define MOLEMOLE_UITRIGGERSHOOTSCOREWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15529640)
#define MOLEMOLE_UITRIGGERSHOOTSCOREWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x155296A0)
#define MOLEMOLE_UITRIGGERSHOOTSCOREWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x15529730)
#define MOLEMOLE_UITRIGGERSHOOTSCOREWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x155297C0)
#define MOLEMOLE_UITRIGGERSHOOTSCOREWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15529860)
#define MOLEMOLE_UITRIGGERSHOOTSCOREWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x155298F0)
#define MOLEMOLE_UITRIGGERSHOOTSCOREWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15529980)

namespace MoleMole
{
	inline static constexpr unsigned int UITriggerShootScoreWidgetController_TypeDefinitionIndex = 81831;

	class UITriggerShootScoreWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_13FA7ABD96D1051D_1* _view; // 0x2B8
		::UnityEngine::Vector3 worldPosition; // 0x2C0
