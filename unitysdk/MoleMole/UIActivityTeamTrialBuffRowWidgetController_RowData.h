...
#define MOLEMOLE_UIACTIVITYTEAMTRIALBUFFROWWIDGETCONTROLLER_ROWDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x197DA160)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityTeamTrialBuffRowWidgetController_RowData_TypeDefinitionIndex = 58411;
	...
	public:
		...
		::System::Int32 conditionActivityAbilityID; // 0x2C
		::System::Boolean isSelect; // 0x30
		::System::Boolean isShowSelect; // 0x31
		::System::Boolean enable; // 0x32
