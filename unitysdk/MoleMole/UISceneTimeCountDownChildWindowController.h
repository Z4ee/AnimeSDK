...
#define MOLEMOLE_UISCENETIMECOUNTDOWNCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15F78840)
#define MOLEMOLE_UISCENETIMECOUNTDOWNCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15F78850)
#define MOLEMOLE_UISCENETIMECOUNTDOWNCHILDWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x15F78B10)
#define MOLEMOLE_UISCENETIMECOUNTDOWNCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15F78C50)
#define MOLEMOLE_UISCENETIMECOUNTDOWNCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15F78C60)

namespace MoleMole
{
	inline static constexpr unsigned int UISceneTimeCountDownChildWindowController_TypeDefinitionIndex = 57796;
