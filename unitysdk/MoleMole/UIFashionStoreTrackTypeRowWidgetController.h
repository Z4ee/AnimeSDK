...
#define MOLEMOLE_UIFASHIONSTORETRACKTYPEROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19DB0270)
#define MOLEMOLE_UIFASHIONSTORETRACKTYPEROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x19DB0380)
#define MOLEMOLE_UIFASHIONSTORETRACKTYPEROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19DB0300)
#define MOLEMOLE_UIFASHIONSTORETRACKTYPEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19DB00C0)
#define MOLEMOLE_UIFASHIONSTORETRACKTYPEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19DB07C0)
#define MOLEMOLE_UIFASHIONSTORETRACKTYPEROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19DB07D0)
#define MOLEMOLE_UIFASHIONSTORETRACKTYPEROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x19DB0860)
#define MOLEMOLE_UIFASHIONSTORETRACKTYPEROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19DB0900)
#define MOLEMOLE_UIFASHIONSTORETRACKTYPEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19DB0990)

namespace MoleMole
{
	inline static constexpr unsigned int UIFashionStoreTrackTypeRowWidgetController_TypeDefinitionIndex = 56937;

	class UIFashionStoreTrackTypeRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_C9DDE9730C6BE395_2* _view; // 0x2F0
