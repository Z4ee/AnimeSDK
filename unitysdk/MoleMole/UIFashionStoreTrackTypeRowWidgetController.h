...
#define MOLEMOLE_UIFASHIONSTORETRACKTYPEROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16EF2CC0)
#define MOLEMOLE_UIFASHIONSTORETRACKTYPEROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16EF2DD0)
#define MOLEMOLE_UIFASHIONSTORETRACKTYPEROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16EF2D50)
#define MOLEMOLE_UIFASHIONSTORETRACKTYPEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16EF2B10)
#define MOLEMOLE_UIFASHIONSTORETRACKTYPEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16EF3210)
#define MOLEMOLE_UIFASHIONSTORETRACKTYPEROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16EF3220)
#define MOLEMOLE_UIFASHIONSTORETRACKTYPEROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16EF32B0)
#define MOLEMOLE_UIFASHIONSTORETRACKTYPEROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16EF3350)
#define MOLEMOLE_UIFASHIONSTORETRACKTYPEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16EF33E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFashionStoreTrackTypeRowWidgetController_TypeDefinitionIndex = 77887;

	class UIFashionStoreTrackTypeRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_C9DDE9730C6BE395_5* _view; // 0x2E8
