...
#define MOLEMOLE_UITWODMAPELEMENT_DATA_STREETNAME_CREATEUICONTROLLER_OFFSET UNITYSDK_OFFSET(0x10D5FC80)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_STREETNAME_GETICONTYPE_OFFSET UNITYSDK_OFFSET(0x10D5FBB0)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_STREETNAME_GETOFFSETPOSITION_OFFSET UNITYSDK_OFFSET(0x10D5FC00)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_STREETNAME_GET_ROOTNAME_OFFSET UNITYSDK_OFFSET(0x10D5FD40)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_STREETNAME_SHOWPROGRESS_OFFSET UNITYSDK_OFFSET(0x10D5FD80)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_STREETNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x10D5FBA0)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_STREETNAME___BASE_CREATEUICONTROLLER_OFFSET UNITYSDK_OFFSET(0x10D5FDC0)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_STREETNAME___BASE_GETICONTYPE_OFFSET UNITYSDK_OFFSET(0x10D5FDD0)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_STREETNAME___BASE_GETOFFSETPOSITION_OFFSET UNITYSDK_OFFSET(0x10D5FE60)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_STREETNAME___BASE_SHOWPROGRESS_OFFSET UNITYSDK_OFFSET(0x10D5FE70)

namespace MoleMole
{
	inline static constexpr unsigned int UITwoDMapElement_Data_StreetName_TypeDefinitionIndex = 66442;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::System::Single, ::Class_0_16E4307DCC419505_334*, ::System::Action_2<::MoleMole::UITwoDMapElement_Data_StreetIcon*, ::System::Single>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UITWODMAPELEMENT_DATA_STREETNAME__CTOR_OFFSET))(this, streetId, rate, posProvider, onScrollTo);
		}
