...
#define MOLEMOLE_MECHBOOITEMDIALOGCONTEXT_GETPARTITEMDATA_OFFSET UNITYSDK_OFFSET(0x1A03DC10)
#define MOLEMOLE_MECHBOOITEMDIALOGCONTEXT_ISVALIDTEMPLATE_OFFSET UNITYSDK_OFFSET(0x1A03DBB0)
#define MOLEMOLE_MECHBOOITEMDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A03DEF0)

namespace MoleMole
{
	inline static constexpr unsigned int MechBooItemDialogContext_TypeDefinitionIndex = 45375;
