...
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER_CREATEREWARDITEMSCROLL_OFFSET UNITYSDK_OFFSET(0x14EF4BA0)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER_GET_CURREWARDTAKESTATE_OFFSET UNITYSDK_OFFSET(0x14EF4A40)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14EF48D0)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x14EF49E0)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14EF4960)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14EF4870)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER_REFRESHTAKEBTNSTATE_OFFSET UNITYSDK_OFFSET(0x14EF4EA0)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14EF5150)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14EF5210)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x14EF52A0)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14EF5340)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14EF53D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookAvatarAwakenRewardItemWidgetController_TypeDefinitionIndex = 75595;
	...
	public:
		...
		::MoleMole::UIHandBookAwakenItemRewardContext* m_ctx; // 0x2F0
