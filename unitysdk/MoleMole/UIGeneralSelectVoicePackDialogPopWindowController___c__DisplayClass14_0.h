...
#define MOLEMOLE_UIGENERALSELECTVOICEPACKDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0x14678780)
#define MOLEMOLE_UIGENERALSELECTVOICEPACKDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS14_0__DOCLICKUNINSTALL_B__0_OFFSET UNITYSDK_OFFSET(0x14678790)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralSelectVoicePackDialogPopWindowController___c__DisplayClass14_0_TypeDefinitionIndex = 69098;
