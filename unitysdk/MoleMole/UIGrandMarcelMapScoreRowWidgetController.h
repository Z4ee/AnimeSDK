...
#define MOLEMOLE_UIGRANDMARCELMAPSCOREROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175EC820)
#define MOLEMOLE_UIGRANDMARCELMAPSCOREROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x175EC930)
#define MOLEMOLE_UIGRANDMARCELMAPSCOREROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x175EC8B0)
#define MOLEMOLE_UIGRANDMARCELMAPSCOREROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x175EC7C0)
#define MOLEMOLE_UIGRANDMARCELMAPSCOREROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x175ECD30)
#define MOLEMOLE_UIGRANDMARCELMAPSCOREROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175ECD40)
#define MOLEMOLE_UIGRANDMARCELMAPSCOREROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x175ECDD0)
#define MOLEMOLE_UIGRANDMARCELMAPSCOREROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x175ECE70)
#define MOLEMOLE_UIGRANDMARCELMAPSCOREROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x175ECF00)

namespace MoleMole
{
	inline static constexpr unsigned int UIGrandMarcelMapScoreRowWidgetController_TypeDefinitionIndex = 56033;

	class UIGrandMarcelMapScoreRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_788A82EBB7FFB629* _view; // 0x2F0
