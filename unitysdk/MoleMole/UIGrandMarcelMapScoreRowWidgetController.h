...
class Class_2_2BA5D85C3B9EB578;
namespace MoleMole { class UIControlReference; }
namespace System { class Object; }

#define MOLEMOLE_UIGRANDMARCELMAPSCOREROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1897AFC0)
#define MOLEMOLE_UIGRANDMARCELMAPSCOREROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1897B0D0)
#define MOLEMOLE_UIGRANDMARCELMAPSCOREROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1897B050)
#define MOLEMOLE_UIGRANDMARCELMAPSCOREROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1897AF60)
#define MOLEMOLE_UIGRANDMARCELMAPSCOREROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1897B4D0)
#define MOLEMOLE_UIGRANDMARCELMAPSCOREROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1897B4E0)
#define MOLEMOLE_UIGRANDMARCELMAPSCOREROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1897B570)
#define MOLEMOLE_UIGRANDMARCELMAPSCOREROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1897B610)
#define MOLEMOLE_UIGRANDMARCELMAPSCOREROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1897B6A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGrandMarcelMapScoreRowWidgetController_TypeDefinitionIndex = 48469;

	class UIGrandMarcelMapScoreRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_2BA5D85C3B9EB578* _view; // 0x2F0
