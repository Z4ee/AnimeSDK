...
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_CHANGETOFISHQTE_OFFSET UNITYSDK_OFFSET(0x15126370)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_CHANGETOSTARTFISH_OFFSET UNITYSDK_OFFSET(0x15126150)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_CHANGETOWAITFISH_OFFSET UNITYSDK_OFFSET(0x15125B10)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_CLEARALLSTATE_OFFSET UNITYSDK_OFFSET(0x151244C0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_CLOSEUI_OFFSET UNITYSDK_OFFSET(0x15126620)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15122CD0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x151256B0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15122D80)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONFISHBEGINWAITIDLEHANDLE_OFFSET UNITYSDK_OFFSET(0x15126040)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONFISHENDWAITIDLEHANDLE_OFFSET UNITYSDK_OFFSET(0x151260B0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONFISHINGBATTLEPROGRESSHANDLE_OFFSET UNITYSDK_OFFSET(0x15129670)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONFISHINGBOSSSHIELDUPDATE_OFFSET UNITYSDK_OFFSET(0x1512A210)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONFISHINGENDCOUNTDOWNHANDLE_OFFSET UNITYSDK_OFFSET(0x1512A8A0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONFISHINGENDTIMELINEHANDLE_OFFSET UNITYSDK_OFFSET(0x15127530)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONFISHINGFAILPRESSHANDLE_OFFSET UNITYSDK_OFFSET(0x15129D50)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONFISHINGHPUPDATE_OFFSET UNITYSDK_OFFSET(0x1512A100)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONFISHINGMATCHFINALTIMEHANDLE_OFFSET UNITYSDK_OFFSET(0x1512AC40)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONFISHINGMATCHTIMEOUTHANDLE_OFFSET UNITYSDK_OFFSET(0x1512AAD0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONFISHINGMATCHTIMEUPDATEHANDLE_OFFSET UNITYSDK_OFFSET(0x1512A9F0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONFISHINGPRESSPROGRESSUPDATE_OFFSET UNITYSDK_OFFSET(0x1512ACE0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONFISHINGQTERESULTHANDLE_OFFSET UNITYSDK_OFFSET(0x15128BD0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONFISHINGQTETIMERATEHANDLE_OFFSET UNITYSDK_OFFSET(0x15128B10)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONFISHINGQUEUEENDHANDLE_OFFSET UNITYSDK_OFFSET(0x1512A470)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONFISHINGSHIELDRECOVERHINT_OFFSET UNITYSDK_OFFSET(0x1512A400)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONFISHINGSINGLEBATTLEENDHANDLE_OFFSET UNITYSDK_OFFSET(0x151298E0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONFISHINGSTARTBATTLELOOPHANDLE_OFFSET UNITYSDK_OFFSET(0x15128CC0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONFISHINGSTARTCOUNTDOWNHANDLE_OFFSET UNITYSDK_OFFSET(0x1512A680)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONFISHINGSTARTSINGLEBATTLEHANDLE_OFFSET UNITYSDK_OFFSET(0x15127A30)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONFISHINGSTARTSKILLHANDLE_OFFSET UNITYSDK_OFFSET(0x1512A550)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONFISHINGSTARTTIMELINEHANDLE_OFFSET UNITYSDK_OFFSET(0x151274E0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONFISHINGSUCCESSCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x151296E0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONFISHINGSUCCESSPRESSHANDLE_OFFSET UNITYSDK_OFFSET(0x15129F00)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONGOINGTRIGGER_OFFSET UNITYSDK_OFFSET(0x15127440)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x15124C00)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15125870)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x151268D0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15123360)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15122E10)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x151233D0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_REGISTERCONTROLEVENTS_OFFSET UNITYSDK_OFFSET(0x151241B0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x15122CE0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_SHOWBIGSCENETUTORIALDIALOG_OFFSET UNITYSDK_OFFSET(0x15124AD0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_SHOWFOLLOWTIPS_OFFSET UNITYSDK_OFFSET(0x15126EF0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_SHOWNEWTIPS_OFFSET UNITYSDK_OFFSET(0x15126FF0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_UPDATEBAR_OFFSET UNITYSDK_OFFSET(0x15127930)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_UPDATEFOLLOWTIPSPOS_OFFSET UNITYSDK_OFFSET(0x15126FB0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x15127580)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER_WAITMESSAGECENTERFREE_OFFSET UNITYSDK_OFFSET(0x151265A0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER__CHANGETOWAITFISH_B__51_0_OFFSET UNITYSDK_OFFSET(0x1512B380)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER__CHANGETOWAITFISH_B__51_2_OFFSET UNITYSDK_OFFSET(0x1512B550)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1512ADA0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER__ONFISHINGSTARTCOUNTDOWNHANDLE_B__76_0_OFFSET UNITYSDK_OFFSET(0x1512B7F0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER__ONUIINIT_B__5_0_OFFSET UNITYSDK_OFFSET(0x1512ADF0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER__ONUIINIT_B__5_1_OFFSET UNITYSDK_OFFSET(0x1512AF30)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER__ONUIOPEN_B__7_0_OFFSET UNITYSDK_OFFSET(0x1512B060)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER__ONUIOPEN_B__7_1_OFFSET UNITYSDK_OFFSET(0x1512B0E0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1512B830)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1512B8C0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1512B8F0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x1512B990)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1512B9A0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1512B9B0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1512B9C0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x1512B9D0)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerFishPlayPageController_TypeDefinitionIndex = 54758;

	class UISummerFishPlayPageController : public ::MoleMole::UIMainCityStorePageController
	{
	public:
		::Class_2_60638234271CCDB8_46* _view; // 0x328
		...
		::Class_1_285B51729FE48850* _chatPlayer; // 0x370
		...
		::Class_0_16E4307DCC419505_321* _OnUIOpen_b__7_0()
		{
			return ((::Class_0_16E4307DCC419505_321*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER__ONUIOPEN_B__7_0_OFFSET))(this);
		}
