...
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_FORMATGAMETIME_OFFSET UNITYSDK_OFFSET(0x18478340)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_GETNIKENAMEBYPLAYERIDX_OFFSET UNITYSDK_OFFSET(0x184785A0)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x18474090)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_INITDOGTEXTURESHEET_OFFSET UNITYSDK_OFFSET(0x18475CE0)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_INITRANKDETAIL_OFFSET UNITYSDK_OFFSET(0x18478140)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_ONCLICKINFOBTN_OFFSET UNITYSDK_OFFSET(0x184787D0)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18474D20)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x18475450)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_ONLOGICINIT_OFFSET UNITYSDK_OFFSET(0x18475B40)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18474DB0)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x184740A0)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18474260)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_PLAYDOGANIMSTATE_OFFSET UNITYSDK_OFFSET(0x18477910)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x18474B50)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x18475AB0)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_REFRESHRETURNIMG_OFFSET UNITYSDK_OFFSET(0x184743E0)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_REFRESHUIBYGAMETYPE_OFFSET UNITYSDK_OFFSET(0x18475BA0)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_SETPVPDETAILINFO_OFFSET UNITYSDK_OFFSET(0x184767E0)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_SETSCOREINFO_OFFSET UNITYSDK_OFFSET(0x18477570)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_SWITCHACCOUNTNAMEINFO_OFFSET UNITYSDK_OFFSET(0x18478610)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_TICKFADEIN_OFFSET UNITYSDK_OFFSET(0x18475330)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_TICKFADEOUT_OFFSET UNITYSDK_OFFSET(0x184753B0)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_TRYFADEOUT_OFFSET UNITYSDK_OFFSET(0x18475A40)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x18475180)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18478940)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER__SETPVPDETAILINFO_B__15_0_OFFSET UNITYSDK_OFFSET(0x18478960)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER__SETPVPDETAILINFO_B__15_1_OFFSET UNITYSDK_OFFSET(0x18478970)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18478980)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x18478A10)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18478A40)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18478A50)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18478A60)

namespace MoleMole
{
	inline static constexpr unsigned int UISoulHoundsIIIEndingChildWindowController_TypeDefinitionIndex = 81392;
	...
	public:
		...
		::Class_2_60638234271CCDB8_77* _view; // 0x318
