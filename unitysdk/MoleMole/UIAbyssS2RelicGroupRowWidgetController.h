...
#define MOLEMOLE_UIABYSSS2RELICGROUPROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15E3B2F0)
#define MOLEMOLE_UIABYSSS2RELICGROUPROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15E3B400)
#define MOLEMOLE_UIABYSSS2RELICGROUPROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15E3B380)
#define MOLEMOLE_UIABYSSS2RELICGROUPROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15E3B290)
#define MOLEMOLE_UIABYSSS2RELICGROUPROWWIDGETCONTROLLER_SETCLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x15E3B800)
#define MOLEMOLE_UIABYSSS2RELICGROUPROWWIDGETCONTROLLER_SETCURRENTSELECT_OFFSET UNITYSDK_OFFSET(0x15E3BA20)
#define MOLEMOLE_UIABYSSS2RELICGROUPROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15E3BC70)
#define MOLEMOLE_UIABYSSS2RELICGROUPROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15E3BD00)
#define MOLEMOLE_UIABYSSS2RELICGROUPROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15E3BD90)
#define MOLEMOLE_UIABYSSS2RELICGROUPROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15E3BE30)
#define MOLEMOLE_UIABYSSS2RELICGROUPROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15E3BEC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2RelicGroupRowWidgetController_TypeDefinitionIndex = 63137;

	class UIAbyssS2RelicGroupRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_5E2FBACADDB625B7_32* _view; // 0x2F0
