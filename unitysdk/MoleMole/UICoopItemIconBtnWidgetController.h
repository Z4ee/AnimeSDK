...
#define MOLEMOLE_UICOOPITEMICONBTNWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x17A5C1A0)
#define MOLEMOLE_UICOOPITEMICONBTNWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17A5BC60)
#define MOLEMOLE_UICOOPITEMICONBTNWIDGETCONTROLLER_UPDATENEWHINT_OFFSET UNITYSDK_OFFSET(0x17A5BF50)
#define MOLEMOLE_UICOOPITEMICONBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17A5C400)
#define MOLEMOLE_UICOOPITEMICONBTNWIDGETCONTROLLER__ONCLICKITEM_B__2_0_OFFSET UNITYSDK_OFFSET(0x17A5C420)
#define MOLEMOLE_UICOOPITEMICONBTNWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x17A5C430)
#define MOLEMOLE_UICOOPITEMICONBTNWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17A5C440)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopItemIconBtnWidgetController_TypeDefinitionIndex = 69767;

	class UICoopItemIconBtnWidgetController : public ::MoleMole::UIItemIconBtnWidgetController
	{
	public:
		::System::Boolean _isCommonDress; // 0x3D0
