...
class Class_2_7B15B3118FE590CD_36_Class_2_16AC50F20374540A_1;
...
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER_ONCLICKSENDTIME_OFFSET UNITYSDK_OFFSET(0x14C3BA20)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER_ONCLICKTIMETAB_OFFSET UNITYSDK_OFFSET(0x14C3B7F0)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14C380E0)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x14C38170)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER_ONMAINCITYLOADREADYHANDLE_OFFSET UNITYSDK_OFFSET(0x14C3BD90)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x14C376E0)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14C38230)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14C370C0)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14C37670)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER_REFRESHBTN_OFFSET UNITYSDK_OFFSET(0x14C38390)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER_REFRESHDESC_OFFSET UNITYSDK_OFFSET(0x14C38AE0)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER_REFRESHSTAGE_OFFSET UNITYSDK_OFFSET(0x14C37D40)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER_REFRESHTIME_OFFSET UNITYSDK_OFFSET(0x14C37950)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x14C37880)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER_ROTARROW_OFFSET UNITYSDK_OFFSET(0x14C3B760)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER_SETDESC_OFFSET UNITYSDK_OFFSET(0x14C3AC30)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER_TRYROTARROW_OFFSET UNITYSDK_OFFSET(0x14C38830)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x14C38320)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14C3BF40)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER__ONMAINCITYLOADREADYHANDLE_B__33_0_OFFSET UNITYSDK_OFFSET(0x14C3C100)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER__ONMAINCITYLOADREADYHANDLE_B__33_1_OFFSET UNITYSDK_OFFSET(0x14C3C280)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER__ONUIINIT_B__17_0_OFFSET UNITYSDK_OFFSET(0x14C3C0F0)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER__REFRESHSTAGE_G__TOGGLESTAGEICON_26_1_OFFSET UNITYSDK_OFFSET(0x14C38A40)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER__REFRESHTIME_G__GETTIMEPROGRESS_25_1_OFFSET UNITYSDK_OFFSET(0x14C387F0)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14C3C310)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x14C3C3A0)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x14C3C430)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14C3C4D0)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14C3C560)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14C3C5F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCitySwitchRoleTimePanelWidgetController_TypeDefinitionIndex = 78543;
	...
	public:
		...
		::Class_2_7B15B3118FE590CD_36* _view; // 0x2E0
		...
		static ::System::Void _RefreshStage_g__ToggleStageIcon_26_1(::System::Collections::Generic::List_1<::Class_2_0D31A1661D004892<::Class_2_7B15B3118FE590CD_36_Class_2_16AC50F20374540A_1*>*>* icons, ::System::Int32 stage)
		{
			return ((::System::Void(*)(::System::Collections::Generic::List_1<::Class_2_0D31A1661D004892<::Class_2_7B15B3118FE590CD_36_Class_2_16AC50F20374540A_1*>*>*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER__REFRESHSTAGE_G__TOGGLESTAGEICON_26_1_OFFSET))(icons, stage);
		}
