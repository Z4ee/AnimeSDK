...
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_CHANGEDIFFICULTY_OFFSET UNITYSDK_OFFSET(0x19CC87F0)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_GETFIRSTREWARDBYID_OFFSET UNITYSDK_OFFSET(0x17556F00)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_GETFIRSTREWARDBYINDEX_1_OFFSET UNITYSDK_OFFSET(0x17556FF0)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_GETFIRSTREWARDBYINDEX_OFFSET UNITYSDK_OFFSET(0x17556E40)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_INITREWARDVIEW_OFFSET UNITYSDK_OFFSET(0x175553E0)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x19CC7720)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_ONADDDIFFICULTYLEVEL_OFFSET UNITYSDK_OFFSET(0x19CC87A0)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_ONADDSUITECLICK_OFFSET UNITYSDK_OFFSET(0x19CC8470)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_ONAUTOFILL_OFFSET UNITYSDK_OFFSET(0x19CC8CE0)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_ONCARDCLICK_OFFSET UNITYSDK_OFFSET(0x19CC8A30)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_ONCLICKDELITEM_OFFSET UNITYSDK_OFFSET(0x19CC8AD0)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19CC7F90)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_ONEDITCLICK_OFFSET UNITYSDK_OFFSET(0x175552C0)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_ONENDEDIT_OFFSET UNITYSDK_OFFSET(0x17554B50)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_ONREDDIFFICULTYLEVEL_OFFSET UNITYSDK_OFFSET(0x19CC89E0)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x19CC80A0)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_ONSUITECHANGED_OFFSET UNITYSDK_OFFSET(0x19CC82A0)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19CC8020)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19CC7640)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19CC76A0)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_REFRESHBASEVIEW_OFFSET UNITYSDK_OFFSET(0x17554CB0)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_REFRESHCARDLISTVIEW_OFFSET UNITYSDK_OFFSET(0x17556850)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_REFRESHEMPTYVIEW_OFFSET UNITYSDK_OFFSET(0x17555A20)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_REFRESHREWARDBUFFVIEW_OFFSET UNITYSDK_OFFSET(0x17556040)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_REFRESHREWARDVIEW_OFFSET UNITYSDK_OFFSET(0x17555B60)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_SELECTCURSUITE_OFFSET UNITYSDK_OFFSET(0x19CC8650)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_SETOWNERVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19CC8420)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_SETSUITE_OFFSET UNITYSDK_OFFSET(0x19CC8230)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17557200)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER__ONCLICKDELITEM_B__26_0_OFFSET UNITYSDK_OFFSET(0x17557330)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17557430)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x175574C0)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17557560)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x175575F0)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17557680)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterCardDeckWidgetController_TypeDefinitionIndex = 65133;
	...
	public:
		...
		::Class_2_79F6D62CE30E3F8E_155* _view; // 0x2F0
