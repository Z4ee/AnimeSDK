...
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_CHANGEDIFFICULTY_OFFSET UNITYSDK_OFFSET(0x15C71D60)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_GETFIRSTREWARDBYID_OFFSET UNITYSDK_OFFSET(0x15C73B30)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_GETFIRSTREWARDBYINDEX_1_OFFSET UNITYSDK_OFFSET(0x15C73C20)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_GETFIRSTREWARDBYINDEX_OFFSET UNITYSDK_OFFSET(0x15C73A70)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_INITREWARDVIEW_OFFSET UNITYSDK_OFFSET(0x15C713B0)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x15C70060)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_ONADDDIFFICULTYLEVEL_OFFSET UNITYSDK_OFFSET(0x15C71D10)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_ONADDSUITECLICK_OFFSET UNITYSDK_OFFSET(0x15C719E0)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_ONAUTOFILL_OFFSET UNITYSDK_OFFSET(0x15C72990)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_ONCARDCLICK_OFFSET UNITYSDK_OFFSET(0x15C71FA0)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_ONCLICKDELITEM_OFFSET UNITYSDK_OFFSET(0x15C72790)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15C708C0)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_ONEDITCLICK_OFFSET UNITYSDK_OFFSET(0x15C72C80)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_ONENDEDIT_OFFSET UNITYSDK_OFFSET(0x15C72B20)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_ONREDDIFFICULTYLEVEL_OFFSET UNITYSDK_OFFSET(0x15C71F50)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15C709D0)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_ONSUITECHANGED_OFFSET UNITYSDK_OFFSET(0x15C711E0)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15C70950)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15C6FF80)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15C6FFE0)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_REFRESHBASEVIEW_OFFSET UNITYSDK_OFFSET(0x15C70BD0)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_REFRESHCARDLISTVIEW_OFFSET UNITYSDK_OFFSET(0x15C72040)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_REFRESHEMPTYVIEW_OFFSET UNITYSDK_OFFSET(0x15C72650)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_REFRESHREWARDBUFFVIEW_OFFSET UNITYSDK_OFFSET(0x15C73260)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_REFRESHREWARDVIEW_OFFSET UNITYSDK_OFFSET(0x15C72DA0)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_SELECTCURSUITE_OFFSET UNITYSDK_OFFSET(0x15C71BC0)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_SETOWNERVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15C71360)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER_SETSUITE_OFFSET UNITYSDK_OFFSET(0x15C70B60)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15C73E40)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER__ONCLICKDELITEM_B__26_0_OFFSET UNITYSDK_OFFSET(0x15C73F70)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15C74070)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15C74100)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15C741A0)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15C74230)
#define MOLEMOLE_UIMONSTERCARDDECKWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15C742C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterCardDeckWidgetController_TypeDefinitionIndex = 58576;
	...
	public:
		...
		::Class_2_79F6D62CE30E3F8E_54* _view; // 0x2E8
		::System::Collections::Generic::List_1<::Class_1_088B0B1F0C00183A*>* _cardViewModels; // 0x2F0
		::System::Collections::Generic::List_1<::MoleMole::UIItemIconBtnWidgetController*>* _rewardControllers; // 0x2F8
		::System::Int32 _curSuiteId; // 0x300
		::System::Int32 _curDifficultyLevel; // 0x304
		::Class_1_346A299033A30404* ownerViewModel; // 0x308
