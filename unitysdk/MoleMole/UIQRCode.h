...
#define MOLEMOLE_UIQRCODE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1531F620)
#define MOLEMOLE_UIQRCODE_CREATEQRCODE_OFFSET UNITYSDK_OFFSET(0x1531FEB0)
#define MOLEMOLE_UIQRCODE_GENERATEQRIMAGE_OFFSET UNITYSDK_OFFSET(0x1531F8A0)
#define MOLEMOLE_UIQRCODE_METHOD_5_5EF18AEB1B1089EF_OFFSET UNITYSDK_OFFSET(0x15320010)
#define MOLEMOLE_UIQRCODE_START_OFFSET UNITYSDK_OFFSET(0x1531F7D0)
#define MOLEMOLE_UIQRCODE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1531F810)
#define MOLEMOLE_UIQRCODE__CTOR_OFFSET UNITYSDK_OFFSET(0x15320220)

namespace MoleMole
{
	inline static constexpr unsigned int UIQRCode_TypeDefinitionIndex = 42284;
