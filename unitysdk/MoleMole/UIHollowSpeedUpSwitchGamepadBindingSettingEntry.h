...
#define MOLEMOLE_UIHOLLOWSPEEDUPSWITCHGAMEPADBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x16BDA480)
#define MOLEMOLE_UIHOLLOWSPEEDUPSWITCHGAMEPADBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x16BDA490)
#define MOLEMOLE_UIHOLLOWSPEEDUPSWITCHGAMEPADBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x16BDA4A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowSpeedUpSwitchGamepadBindingSettingEntry_TypeDefinitionIndex = 83865;
