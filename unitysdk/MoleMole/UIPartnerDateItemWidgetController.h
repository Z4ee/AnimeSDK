...
#define MOLEMOLE_UIPARTNERDATEITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17D24960)
#define MOLEMOLE_UIPARTNERDATEITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x17D253C0)
#define MOLEMOLE_UIPARTNERDATEITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17D24A70)
#define MOLEMOLE_UIPARTNERDATEITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17D249F0)
#define MOLEMOLE_UIPARTNERDATEITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17D24740)
#define MOLEMOLE_UIPARTNERDATEITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17D248F0)
#define MOLEMOLE_UIPARTNERDATEITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x17D24DD0)
#define MOLEMOLE_UIPARTNERDATEITEMWIDGETCONTROLLER_SHOWEMPTY_OFFSET UNITYSDK_OFFSET(0x17D24D00)
#define MOLEMOLE_UIPARTNERDATEITEMWIDGETCONTROLLER_TRIGGERBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x17D25590)
#define MOLEMOLE_UIPARTNERDATEITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17D25710)
#define MOLEMOLE_UIPARTNERDATEITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17D25720)
#define MOLEMOLE_UIPARTNERDATEITEMWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x17D257B0)
#define MOLEMOLE_UIPARTNERDATEITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17D25840)
#define MOLEMOLE_UIPARTNERDATEITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17D258E0)
#define MOLEMOLE_UIPARTNERDATEITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17D25970)
#define MOLEMOLE_UIPARTNERDATEITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17D25A00)

namespace MoleMole
{
	inline static constexpr unsigned int UIPartnerDateItemWidgetController_TypeDefinitionIndex = 72126;
