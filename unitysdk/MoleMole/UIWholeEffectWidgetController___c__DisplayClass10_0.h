...
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER___C__DISPLAYCLASS10_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15145F00)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER___C__DISPLAYCLASS10_0__INITCARD_B__0_OFFSET UNITYSDK_OFFSET(0x15145F10)

namespace MoleMole
{
	inline static constexpr unsigned int UIWholeEffectWidgetController___c__DisplayClass10_0_TypeDefinitionIndex = 89258;
