...
#define MOLEMOLE_UICAMPIDLECHOICEWIDGETCONTROLLER_ONCLICKACTION_OFFSET UNITYSDK_OFFSET(0x12F771F0)
#define MOLEMOLE_UICAMPIDLECHOICEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12F772C0)
#define MOLEMOLE_UICAMPIDLECHOICEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12F77350)
#define MOLEMOLE_UICAMPIDLECHOICEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12F76D80)
#define MOLEMOLE_UICAMPIDLECHOICEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12F76F50)
#define MOLEMOLE_UICAMPIDLECHOICEWIDGETCONTROLLER_REFRESHVIEWBYCONTEXT_OFFSET UNITYSDK_OFFSET(0x12F77080)
#define MOLEMOLE_UICAMPIDLECHOICEWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x12F77100)
#define MOLEMOLE_UICAMPIDLECHOICEWIDGETCONTROLLER_SETCHECKSTATE_OFFSET UNITYSDK_OFFSET(0x12F77180)
#define MOLEMOLE_UICAMPIDLECHOICEWIDGETCONTROLLER_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x12F76EE0)
#define MOLEMOLE_UICAMPIDLECHOICEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12F773D0)
#define MOLEMOLE_UICAMPIDLECHOICEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12F77430)
#define MOLEMOLE_UICAMPIDLECHOICEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12F77480)
#define MOLEMOLE_UICAMPIDLECHOICEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12F774C0)
#define MOLEMOLE_UICAMPIDLECHOICEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12F77500)

namespace MoleMole
{
	inline static constexpr unsigned int UICampIdleChoiceWidgetController_TypeDefinitionIndex = 66680;

	class UICampIdleChoiceWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_46B1304F31463D00_2* _view; // 0x2B8
		::System::Boolean m_isStoryQA; // 0x2C0
		::System::Boolean m_isCorrectAnswer; // 0x2C1
		::MoleMole::UICampIdleChoiceWidgetControllerContext* m_ctx; // 0x2C8
		::System::Action* m_onclickAction; // 0x2D0
