...
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER___C__DISPLAYCLASS26_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1722F430)
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER___C__DISPLAYCLASS26_0__RESTARTSCORETIP_B__0_OFFSET UNITYSDK_OFFSET(0x1722F440)
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER___C__DISPLAYCLASS26_0__RESTARTSCORETIP_B__1_OFFSET UNITYSDK_OFFSET(0x1722F4E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelScoreUIChildWindowController___c__DisplayClass26_0_TypeDefinitionIndex = 74146;
