...
#define MOLEMOLE_UITAPE3DMODELCONTROLLER___C__DISPLAYCLASS72_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1382ACE0)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER___C__DISPLAYCLASS72_0__ROTATE_B__0_OFFSET UNITYSDK_OFFSET(0x1382ACF0)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER___C__DISPLAYCLASS72_0__ROTATE_B__1_OFFSET UNITYSDK_OFFSET(0x1382AD00)

namespace MoleMole
{
	inline static constexpr unsigned int UITape3DModelController___c__DisplayClass72_0_TypeDefinitionIndex = 68363;
