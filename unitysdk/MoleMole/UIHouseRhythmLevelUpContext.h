...
#define MOLEMOLE_UIHOUSERHYTHMLEVELUPCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1481C070)

namespace MoleMole
{
	inline static constexpr unsigned int UIHouseRhythmLevelUpContext_TypeDefinitionIndex = 52125;
