...
#define MOLEMOLE_CONFIGPHOTOSTICKERDYNAMICCHECKTREENODE_CREATE_OFFSET UNITYSDK_OFFSET(0x17E469C0)
#define MOLEMOLE_CONFIGPHOTOSTICKERDYNAMICCHECKTREENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x17E46A40)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigPhotoStickerDynamicCheckTreeNode_TypeDefinitionIndex = 48310;
