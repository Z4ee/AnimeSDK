...
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_AWAKE_OFFSET UNITYSDK_OFFSET(0x142A1F50)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_COLLECTBINDINGDICT_OFFSET UNITYSDK_OFFSET(0x142A1FA0)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_COLLECTBRANCHBINDINGDICT_OFFSET UNITYSDK_OFFSET(0x142A29B0)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_GETTRACKBINDING_OFFSET UNITYSDK_OFFSET(0x142A3A10)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_GET_ISBRANCHTIMELINEV2_OFFSET UNITYSDK_OFFSET(0x142A1EF0)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_ISANIMATIONTRACK_OFFSET UNITYSDK_OFFSET(0x142A3EA0)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_SETANIMATIONTRACKBLENDTARGET_OFFSET UNITYSDK_OFFSET(0x142A4180)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_SETANIMATIONTRACKOUTPUTWEIGHT_1_OFFSET UNITYSDK_OFFSET(0x142A4640)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_SETANIMATIONTRACKOUTPUTWEIGHT_OFFSET UNITYSDK_OFFSET(0x142A44D0)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_SETTRACKDYNAMIC_OFFSET UNITYSDK_OFFSET(0x142A3590)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE__CTOR_OFFSET UNITYSDK_OFFSET(0x142A4940)

namespace MoleMole
{
	inline static constexpr unsigned int MonoDirectorBindingReplace_TypeDefinitionIndex = 80199;
