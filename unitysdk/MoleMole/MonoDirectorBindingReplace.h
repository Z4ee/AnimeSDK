...
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_AWAKE_OFFSET UNITYSDK_OFFSET(0x11D47CC0)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_COLLECTBINDINGDICT_OFFSET UNITYSDK_OFFSET(0x11D47D10)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_COLLECTBRANCHBINDINGDICT_OFFSET UNITYSDK_OFFSET(0x11D48720)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_GETTRACKBINDING_OFFSET UNITYSDK_OFFSET(0x11D497A0)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_GET_ISBRANCHTIMELINEV2_OFFSET UNITYSDK_OFFSET(0x11D47C60)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_ISANIMATIONTRACK_OFFSET UNITYSDK_OFFSET(0x11D49C20)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_SETANIMATIONTRACKBLENDTARGET_OFFSET UNITYSDK_OFFSET(0x11D49F00)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_SETANIMATIONTRACKOUTPUTWEIGHT_1_OFFSET UNITYSDK_OFFSET(0x11D4A3C0)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_SETANIMATIONTRACKOUTPUTWEIGHT_OFFSET UNITYSDK_OFFSET(0x11D4A240)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_SETTRACKDYNAMIC_OFFSET UNITYSDK_OFFSET(0x11D49320)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE__CTOR_OFFSET UNITYSDK_OFFSET(0x11D4A6C0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoDirectorBindingReplace_TypeDefinitionIndex = 45457;

	class MonoDirectorBindingReplace : public ::UnityEngine::MonoBehaviour
	{
	public:
		::UnityEngine::Playables::PlayableDirector* Field_5_1; // 0x18
		::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::Playables::PlayableBinding>* Field_5_0; // 0x20
		::System::Collections::Generic::Dictionary_2<::UnityEngine::Playables::PlayableDirector*, ::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::Playables::PlayableBinding>*>* Field_5_7; // 0x28
