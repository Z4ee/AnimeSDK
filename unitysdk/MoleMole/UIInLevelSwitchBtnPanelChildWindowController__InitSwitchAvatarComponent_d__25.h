...
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER__INITSWITCHAVATARCOMPONENT_D__25_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x78CCE0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER__INITSWITCHAVATARCOMPONENT_D__25_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2661E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelSwitchBtnPanelChildWindowController__InitSwitchAvatarComponent_d__25_TypeDefinitionIndex = 46282;
	...
	struct alignas(8) UIInLevelSwitchBtnPanelChildWindowController__InitSwitchAvatarComponent_d__25
	{
		...
		::MoleMole::UIInLevelSwitchBtnPanelChildWindowController* __4__this; // 0x28
