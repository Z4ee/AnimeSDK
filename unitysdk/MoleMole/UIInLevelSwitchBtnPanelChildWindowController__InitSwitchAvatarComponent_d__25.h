...
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER__INITSWITCHAVATARCOMPONENT_D__25_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x8842C0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER__INITSWITCHAVATARCOMPONENT_D__25_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelSwitchBtnPanelChildWindowController__InitSwitchAvatarComponent_d__25_TypeDefinitionIndex = 91122;

	struct alignas(8) UIInLevelSwitchBtnPanelChildWindowController__InitSwitchAvatarComponent_d__25
	{
		::Cysharp::Threading::Tasks::UniTask_Awaiter __u__1; // 0x10
		::MoleMole::UIInLevelSwitchBtnPanelChildWindowController* __4__this; // 0x20
