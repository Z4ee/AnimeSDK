...
#define MOLEMOLE_UIFORBIDDENAREAINSIGHTLEVELUPPOPWINDOWCONTROLLER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x166CF420)
#define MOLEMOLE_UIFORBIDDENAREAINSIGHTLEVELUPPOPWINDOWCONTROLLER___C__DISPLAYCLASS13_0__REFRESHLEVELTXTVIEW_B__10_OFFSET UNITYSDK_OFFSET(0x166CF480)
#define MOLEMOLE_UIFORBIDDENAREAINSIGHTLEVELUPPOPWINDOWCONTROLLER___C__DISPLAYCLASS13_0__REFRESHLEVELTXTVIEW_B__3_OFFSET UNITYSDK_OFFSET(0x166CF430)
#define MOLEMOLE_UIFORBIDDENAREAINSIGHTLEVELUPPOPWINDOWCONTROLLER___C__DISPLAYCLASS13_0__REFRESHLEVELTXTVIEW_B__7_OFFSET UNITYSDK_OFFSET(0x166CF570)
#define MOLEMOLE_UIFORBIDDENAREAINSIGHTLEVELUPPOPWINDOWCONTROLLER___C__DISPLAYCLASS13_0__REFRESHLEVELTXTVIEW_G__ONPROGRESS_0_OFFSET UNITYSDK_OFFSET(0x166CF590)

namespace MoleMole
{
	inline static constexpr unsigned int UIForbiddenAreaInsightLevelUpPopWindowController___c__DisplayClass13_0_TypeDefinitionIndex = 81277;
