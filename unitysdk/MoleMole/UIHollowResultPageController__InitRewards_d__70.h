...
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER__INITREWARDS_D__70_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x167C9070)
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER__INITREWARDS_D__70_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x167C96E0)
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER__INITREWARDS_D__70_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x167C9740)
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER__INITREWARDS_D__70_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x167C96F0)
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER__INITREWARDS_D__70_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x167C9060)
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER__INITREWARDS_D__70__CTOR_OFFSET UNITYSDK_OFFSET(0x167C9050)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowResultPageController__InitRewards_d__70_TypeDefinitionIndex = 57540;
