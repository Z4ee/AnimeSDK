...
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER__INITREWARDS_D__70_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1836AF10)
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER__INITREWARDS_D__70_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1836B580)
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER__INITREWARDS_D__70_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1836B5E0)
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER__INITREWARDS_D__70_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1836B590)
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER__INITREWARDS_D__70_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1836AF00)
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER__INITREWARDS_D__70__CTOR_OFFSET UNITYSDK_OFFSET(0x1836AEF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowResultPageController__InitRewards_d__70_TypeDefinitionIndex = 41921;
