...
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F58770)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendChatPopWindowController_Context_TypeDefinitionIndex = 81243;
