...
#define MOLEMOLE_SUMMEREVENTSHOOTINGGAMEPLAYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x14A23290)

namespace MoleMole
{
	inline static constexpr unsigned int SummerEventShootingGamePlayConfig_TypeDefinitionIndex = 71956;
