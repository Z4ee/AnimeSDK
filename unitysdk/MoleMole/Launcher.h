...
#define MOLEMOLE_LAUNCHER_AWAKE_OFFSET UNITYSDK_OFFSET(0x10E22C20)
#define MOLEMOLE_LAUNCHER_GET_ISSTARTGAMEPRELOADMODE_OFFSET UNITYSDK_OFFSET(0x10E22990)
#define MOLEMOLE_LAUNCHER_METHOD_5_10054BB010E03EDD_OFFSET UNITYSDK_OFFSET(0x10E24500)
#define MOLEMOLE_LAUNCHER_METHOD_5_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0x10E274A0)
#define MOLEMOLE_LAUNCHER_METHOD_5_261DF843E298B71B_1_OFFSET UNITYSDK_OFFSET(0x10E276D0)
#define MOLEMOLE_LAUNCHER_METHOD_5_261DF843E298B71B_OFFSET UNITYSDK_OFFSET(0x10E27650)
#define MOLEMOLE_LAUNCHER_METHOD_5_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x10E231B0)
#define MOLEMOLE_LAUNCHER_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x10E24120)
#define MOLEMOLE_LAUNCHER_METHOD_5_5835DC16FC46989B_OFFSET UNITYSDK_OFFSET(0x10E23BF0)
#define MOLEMOLE_LAUNCHER_METHOD_5_5AE5B86437B31074_OFFSET UNITYSDK_OFFSET(0x10E24D50)
#define MOLEMOLE_LAUNCHER_METHOD_5_6BA7BB45F0BA72F4_OFFSET UNITYSDK_OFFSET(0x10E23560)
#define MOLEMOLE_LAUNCHER_METHOD_5_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x10E24430)
#define MOLEMOLE_LAUNCHER_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x10E27420)
#define MOLEMOLE_LAUNCHER_METHOD_5_9D8CB5E47C1952BD_OFFSET UNITYSDK_OFFSET(0x10E23320)
#define MOLEMOLE_LAUNCHER_METHOD_5_A239DF324AF4215C_OFFSET UNITYSDK_OFFSET(0x10E27790)
#define MOLEMOLE_LAUNCHER_METHOD_5_B2C0ADBFEA309440_OFFSET UNITYSDK_OFFSET(0x10E27A60)
#define MOLEMOLE_LAUNCHER_METHOD_5_B76CD5CB3E297DF3_OFFSET UNITYSDK_OFFSET(0x10E24E50)
#define MOLEMOLE_LAUNCHER_METHOD_5_BA1BB49741CFDFE1_OFFSET UNITYSDK_OFFSET(0x10E23E00)
#define MOLEMOLE_LAUNCHER_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x10E23DB0)
#define MOLEMOLE_LAUNCHER_METHOD_5_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x10E273A0)
#define MOLEMOLE_LAUNCHER_METHOD_5_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0x10E273E0)
#define MOLEMOLE_LAUNCHER_METHOD_5_CA373AA1C7054598_4_OFFSET UNITYSDK_OFFSET(0x10E27750)
#define MOLEMOLE_LAUNCHER_METHOD_5_CA373AA1C7054598_5_OFFSET UNITYSDK_OFFSET(0x10E27990)
#define MOLEMOLE_LAUNCHER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x10E23D70)
#define MOLEMOLE_LAUNCHER_METHOD_5_CB85C990DB613548_OFFSET UNITYSDK_OFFSET(0x10E26750)
#define MOLEMOLE_LAUNCHER_METHOD_5_F84B9C94CF10263D_OFFSET UNITYSDK_OFFSET(0x10E26B80)
#define MOLEMOLE_LAUNCHER_START_OFFSET UNITYSDK_OFFSET(0x10E23B90)
#define MOLEMOLE_LAUNCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x10E24180)

namespace MoleMole
{
	inline static constexpr unsigned int Launcher_TypeDefinitionIndex = 38341;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Launcher_TypeDefinitionIndex)->GetStaticField(0x121C0);
		}
		static ::System::Boolean* StaticGet_StatEcsCoreEnabled()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Launcher_TypeDefinitionIndex)->GetStaticField(0x121C1);
		}
