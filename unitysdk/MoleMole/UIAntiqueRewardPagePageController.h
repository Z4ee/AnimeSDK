...
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_GETLEVELASSETPATH_OFFSET UNITYSDK_OFFSET(0x17444E10)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x17444360)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_ONANTIQUELEVELCHANGE_OFFSET UNITYSDK_OFFSET(0x176B6C70)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_ONCLICKCOLLECTTASK_OFFSET UNITYSDK_OFFSET(0x176B68F0)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_ONCLICKCOLLECT_OFFSET UNITYSDK_OFFSET(0x176B69E0)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_ONCLICKINFO_OFFSET UNITYSDK_OFFSET(0x176B68B0)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_ONCLICKSIDETASK_OFFSET UNITYSDK_OFFSET(0x176B6AD0)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_ONCLICKTAKEALLREWARD_OFFSET UNITYSDK_OFFSET(0x176B6BC0)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17444370)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_ONEXPCHANGE_OFFSET UNITYSDK_OFFSET(0x176B6C20)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_ONPERMANENTREWARDUPDATE_OFFSET UNITYSDK_OFFSET(0x176B6CC0)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17444D50)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17444DA0)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17444A30)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17444BF0)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_REFRESHEXP_OFFSET UNITYSDK_OFFSET(0x17445690)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_REFRESHGETALL_OFFSET UNITYSDK_OFFSET(0x17445090)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_REFRESHGOTOBTN_OFFSET UNITYSDK_OFFSET(0x17445860)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0x17444CF0)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_REFRESHLEFTINFO_OFFSET UNITYSDK_OFFSET(0x17444F00)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_REFRESHREWARDLIST_OFFSET UNITYSDK_OFFSET(0x17445120)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_SORTREWARD_OFFSET UNITYSDK_OFFSET(0x176B6820)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x176B6D20)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x176B6DB0)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x176B6E40)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x176B6E50)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x176B6E60)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x176B6E70)

namespace MoleMole
{
	inline static constexpr unsigned int UIAntiqueRewardPagePageController_TypeDefinitionIndex = 62293;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_1_9532C712260DD3D3_1*>* _rewardList; // 0x340
		...
		::System::Int32 SortReward(::Class_1_9532C712260DD3D3_1* rewardA, ::Class_1_9532C712260DD3D3_1* rewardB)
		{
			return ((::System::Int32(*)(::PVOID, ::Class_1_9532C712260DD3D3_1*, ::Class_1_9532C712260DD3D3_1*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_SORTREWARD_OFFSET))(this, rewardA, rewardB);
		}
