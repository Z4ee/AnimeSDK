...
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x199BCD40)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___C__DISPLAYCLASS9_0__SHOWSPECIALBTNPANEL_B__0_OFFSET UNITYSDK_OFFSET(0x199BCD50)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___C__DISPLAYCLASS9_0__SHOWSPECIALBTNPANEL_B__1_OFFSET UNITYSDK_OFFSET(0x199BCDC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralItemUsePopWindowController___c__DisplayClass9_0_TypeDefinitionIndex = 55117;
	...
	public:
		...
		::System::Action* onClickBtn02; // 0x18
		::System::Action_1<::System::Int32>* onClickBtn01; // 0x20
