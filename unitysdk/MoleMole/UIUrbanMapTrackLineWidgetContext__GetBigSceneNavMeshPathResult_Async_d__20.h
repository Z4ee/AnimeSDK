...
#define MOLEMOLE_UIURBANMAPTRACKLINEWIDGETCONTEXT__GETBIGSCENENAVMESHPATHRESULT_ASYNC_D__20_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x75A730)
#define MOLEMOLE_UIURBANMAPTRACKLINEWIDGETCONTEXT__GETBIGSCENENAVMESHPATHRESULT_ASYNC_D__20_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2661E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapTrackLineWidgetContext__GetBigSceneNavMeshPathResult_Async_d__20_TypeDefinitionIndex = 63384;

	struct alignas(8) UIUrbanMapTrackLineWidgetContext__GetBigSceneNavMeshPathResult_Async_d__20
	{
		::MoleMole::UIUrbanMapTrackLineWidgetContext* __4__this; // 0x10
		...
		::UnityEngine::Vector3 playerPosVal; // 0x54
