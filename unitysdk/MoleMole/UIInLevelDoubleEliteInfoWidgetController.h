...
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER_CREATECHALLENGEVIEW_OFFSET UNITYSDK_OFFSET(0x19C70A70)
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER_FILLCARDLIST_OFFSET UNITYSDK_OFFSET(0x19C70F80)
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER_FILLREWARDMAP_OFFSET UNITYSDK_OFFSET(0x19C71190)
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0x19C709C0)
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19C70E80)
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x19C70A10)
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19C714B0)
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER___BASE_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0x19C714C0)
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19C71550)
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x19C71620)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelDoubleEliteInfoWidgetController_TypeDefinitionIndex = 61022;

	class UIInLevelDoubleEliteInfoWidgetController : public ::MoleMole::UIBattleInfoWidgetControllerBase
	{
	public:
		::Class_2_79AE422BA06F6D26_184* _view; // 0x2E0
