...
#define MOLEMOLE_UIPOSTTITLEROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16127FB0)
#define MOLEMOLE_UIPOSTTITLEROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16128020)
#define MOLEMOLE_UIPOSTTITLEROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x161280E0)
#define MOLEMOLE_UIPOSTTITLEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16128380)
#define MOLEMOLE_UIPOSTTITLEROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16128390)
#define MOLEMOLE_UIPOSTTITLEROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16128430)

namespace MoleMole
{
	inline static constexpr unsigned int UIPostTitleRowWidgetController_TypeDefinitionIndex = 39400;
	...
	public:
		...
		{
			return ((::Class_2_EC28E1D3A39EE7DE*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIPOSTTITLEROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
