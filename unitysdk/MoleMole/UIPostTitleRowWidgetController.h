...
#define MOLEMOLE_UIPOSTTITLEROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17890C10)
#define MOLEMOLE_UIPOSTTITLEROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17890C80)
#define MOLEMOLE_UIPOSTTITLEROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17890D40)
#define MOLEMOLE_UIPOSTTITLEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17890FD0)
#define MOLEMOLE_UIPOSTTITLEROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17890FE0)
#define MOLEMOLE_UIPOSTTITLEROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17891080)

namespace MoleMole
{
	inline static constexpr unsigned int UIPostTitleRowWidgetController_TypeDefinitionIndex = 48699;
	...
	public:
		...
		{
			return ((::Class_2_EC28E1D3A39EE7DE_12*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIPOSTTITLEROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
