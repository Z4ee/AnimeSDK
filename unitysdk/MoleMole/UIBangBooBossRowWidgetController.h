...
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16802C40)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x168027A0)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16802CD0)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16802380)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x168023E0)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER_REFRESHBYCONTEXT_OFFSET UNITYSDK_OFFSET(0x16802540)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER_SETCLICK_OFFSET UNITYSDK_OFFSET(0x16802960)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16802D50)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER__ONSCROLLITEMUPDATE_B__6_0_OFFSET UNITYSDK_OFFSET(0x16802D80)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER__ONUIOPEN_B__5_0_OFFSET UNITYSDK_OFFSET(0x16802D60)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER__UPDATECARD_OFFSET UNITYSDK_OFFSET(0x168029B0)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16802DA0)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16802E30)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16802ED0)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16802F60)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16802FF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangBooBossRowWidgetController_TypeDefinitionIndex = 68136;

	class UIBangBooBossRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_EC707217DE7794EF_7* _view; // 0x2E8
