...
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_CHECKDURATIONBUTTONVIEW_OFFSET UNITYSDK_OFFSET(0x15A72210)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_DIRTYCHECKTARGETGAMEPADMODULE_OFFSET UNITYSDK_OFFSET(0x15A73730)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_DOGENERALKEYSORT_OFFSET UNITYSDK_OFFSET(0x15A700D0)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_DOREFRESHCOMMONVIEW_OFFSET UNITYSDK_OFFSET(0x15A72830)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_GETGENERALKEYPANELVISIBLE_OFFSET UNITYSDK_OFFSET(0x15A6EA50)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_GETINPUTLOGICEVENT_OFFSET UNITYSDK_OFFSET(0x15A737B0)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_GETISNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x15A70970)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_GETISVISIBLE_OFFSET UNITYSDK_OFFSET(0x15A6E820)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_GETNOTIFICATIONKEY_OFFSET UNITYSDK_OFFSET(0x15A708D0)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_GET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x15A6BEE0)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_HANDLEDEFAULTKEYINPUT_OFFSET UNITYSDK_OFFSET(0x15A71520)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_HANDLELONGPRESSDURATIONBUTTONINPUT_OFFSET UNITYSDK_OFFSET(0x15A710B0)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_HANDLESHORTPRESSDURATIONBUTTONINPUT_OFFSET UNITYSDK_OFFSET(0x15A70F90)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_INITBINDEDTEXT_OFFSET UNITYSDK_OFFSET(0x15A70610)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_ISBINDEDBUTTONACTIVE_OFFSET UNITYSDK_OFFSET(0x15A70C50)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_ISBINDEDBUTTONENABLE_OFFSET UNITYSDK_OFFSET(0x15A70DF0)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_ONBEFOREWORLDUPDATE_OFFSET UNITYSDK_OFFSET(0x15A6EAB0)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A6D7F0)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x15A6CC60)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x15A6E620)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x15A6E030)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x15A73440)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x15A6CB00)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_ONKEYBINDINGUPDATED_OFFSET UNITYSDK_OFFSET(0x15A73070)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_ONLANGUAGECHANGE_OFFSET UNITYSDK_OFFSET(0x15A73610)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x15A6E7D0)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x15A6DA00)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_ONNOTIFYCHANGEHANDLE_OFFSET UNITYSDK_OFFSET(0x15A70920)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15A6CA90)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x15A6CB60)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A6D880)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A6BEF0)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15A6BFF0)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_ONUIREUSE_OFFSET UNITYSDK_OFFSET(0x15A6D170)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x15A6E770)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_REFRESHBINDEDBUTTONACTIVE_OFFSET UNITYSDK_OFFSET(0x15A6E430)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_REFRESHDURATIONBUTTON_OFFSET UNITYSDK_OFFSET(0x15A6F710)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_REFRESHGAMEPADBUTTONVIEW_OFFSET UNITYSDK_OFFSET(0x15A72690)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_REFRESHHINTENABLESTATE_OFFSET UNITYSDK_OFFSET(0x15A6C340)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_REFRESHKEYBOARDBUTTONVIEW_OFFSET UNITYSDK_OFFSET(0x15A725F0)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_REFRESHKEYPANELPRIORITY_OFFSET UNITYSDK_OFFSET(0x15A73280)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_REFRESHKEYPANELTARGETGAMEPADMODULE_OFFSET UNITYSDK_OFFSET(0x15A73370)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_REFRESHLONGPRESSSTATE_OFFSET UNITYSDK_OFFSET(0x15A6F500)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_REFRESHMOUSEBUTTONVIEW_OFFSET UNITYSDK_OFFSET(0x15A724F0)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_REFRESHPRIORITYDISPLAY_OFFSET UNITYSDK_OFFSET(0x15A6EBB0)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_REFRESHSPECIALGAMEPADBUTTONVIEW_OFFSET UNITYSDK_OFFSET(0x15A72050)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_REFRESHTARGETGAMEPADMODULE_OFFSET UNITYSDK_OFFSET(0x15A6E1B0)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_REFRESHTEXT_OFFSET UNITYSDK_OFFSET(0x15A6EDE0)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x15A6DA50)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_REFRESHVISIBLE_OFFSET UNITYSDK_OFFSET(0x15A6F930)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_RESETTEXTKEY_OFFSET UNITYSDK_OFFSET(0x15A71EE0)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_SETATTACHEDLAYOUTELEMENT_OFFSET UNITYSDK_OFFSET(0x15A6FE60)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_SETDEFAULTSTATE_OFFSET UNITYSDK_OFFSET(0x15A6CE50)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_SETEMPTYVIEW_OFFSET UNITYSDK_OFFSET(0x15A6BF60)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_SETFORCEHINTDISABLE_OFFSET UNITYSDK_OFFSET(0x15A71F90)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_SETHANDLEINPUT_1_OFFSET UNITYSDK_OFFSET(0x15A72000)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_SETHANDLEINPUT_OFFSET UNITYSDK_OFFSET(0x15A702F0)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_SETINPUTKEYHINTSTATE_OFFSET UNITYSDK_OFFSET(0x15A736D0)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_SETINPUTLOGICEVENT_OFFSET UNITYSDK_OFFSET(0x15A70000)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_SETLOCKSCINCN_OFFSET UNITYSDK_OFFSET(0x15A71DB0)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_SETLOGICBUTTONINPUT_OFFSET UNITYSDK_OFFSET(0x15A71CF0)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_SETNOTIFICATIONKEYSTATE_OFFSET UNITYSDK_OFFSET(0x15A73670)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_SETPARENTLAYOUTELEMENT_OFFSET UNITYSDK_OFFSET(0x15A6F790)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_TRYHANDLEKEYINPUT_OFFSET UNITYSDK_OFFSET(0x15A70AB0)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER_UPDATELONGPRESSDURATIONBUTTONPROGRESS_OFFSET UNITYSDK_OFFSET(0x15A71C30)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15A73800)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER__ONUIOPEN_B__4_0_OFFSET UNITYSDK_OFFSET(0x15A73880)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER__ONUIOPEN_B__4_1_OFFSET UNITYSDK_OFFSET(0x15A73890)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER__ONUIOPEN_B__4_2_OFFSET UNITYSDK_OFFSET(0x15A738A0)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A738B0)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x15A73940)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x15A739D0)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15A73A60)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x15A73B00)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A73B10)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A73BA0)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15A73C30)
#define MOLEMOLE_UIGENERALKEYPANELWIDGETCONTROLLER___BASE_ONUIREUSE_OFFSET UNITYSDK_OFFSET(0x15A73CC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralKeyPanelWidgetController_TypeDefinitionIndex = 79597;

	class UIGeneralKeyPanelWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_100* _view; // 0x2C0
		...
		::UnityEngine::UI::Extension::UIButtonEx* _bindedButton; // 0x300
