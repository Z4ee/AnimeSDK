...
#define MOLEMOLE_CONFIGCOMICSHAKEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD4D40)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigComicShakeData_TypeDefinitionIndex = 74206;

	class ConfigComicShakeData : public ::System::Object
	{
	public:
		::MoleMole::ConfigPerformUIShake* configShake; // 0x10
		::MoleMole::Config::AnimCurveParam* ShrinkScaleParam; // 0x18
		::MoleMole::Config::AnimCurveParam* EnlargeScaleParam; // 0x20
		::System::Single maxDeltaScale; // 0x28
		::System::Single TotalDuration; // 0x2C
