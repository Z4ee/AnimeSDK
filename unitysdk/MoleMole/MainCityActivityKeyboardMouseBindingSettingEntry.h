...
#define MOLEMOLE_MAINCITYACTIVITYKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x14188680)
#define MOLEMOLE_MAINCITYACTIVITYKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x14188690)
#define MOLEMOLE_MAINCITYACTIVITYKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x141886A0)

namespace MoleMole
{
	inline static constexpr unsigned int MainCityActivityKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 82010;
