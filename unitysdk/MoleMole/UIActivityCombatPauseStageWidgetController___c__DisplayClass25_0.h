...
#define MOLEMOLE_UIACTIVITYCOMBATPAUSESTAGEWIDGETCONTROLLER___C__DISPLAYCLASS25_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15A8B3C0)
#define MOLEMOLE_UIACTIVITYCOMBATPAUSESTAGEWIDGETCONTROLLER___C__DISPLAYCLASS25_0__FINDQUESTINDEX_B__0_OFFSET UNITYSDK_OFFSET(0x15A8B3D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityCombatPauseStageWidgetController___c__DisplayClass25_0_TypeDefinitionIndex = 49852;
