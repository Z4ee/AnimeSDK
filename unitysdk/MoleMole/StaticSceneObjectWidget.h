...
#define MOLEMOLE_STATICSCENEOBJECTWIDGET_AWAKE_OFFSET UNITYSDK_OFFSET(0x13871620)
#define MOLEMOLE_STATICSCENEOBJECTWIDGET_METHOD_5_0DE3BA0A26CD13D8_OFFSET UNITYSDK_OFFSET(0x13871F00)
#define MOLEMOLE_STATICSCENEOBJECTWIDGET_METHOD_5_5176DC743E478510_OFFSET UNITYSDK_OFFSET(0x138717A0)
#define MOLEMOLE_STATICSCENEOBJECTWIDGET_METHOD_5_E88C43AB30548154_OFFSET UNITYSDK_OFFSET(0x13872170)
#define MOLEMOLE_STATICSCENEOBJECTWIDGET_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x13871DF0)
#define MOLEMOLE_STATICSCENEOBJECTWIDGET_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x13871BB0)
#define MOLEMOLE_STATICSCENEOBJECTWIDGET_ONENABLE_OFFSET UNITYSDK_OFFSET(0x13871A80)
#define MOLEMOLE_STATICSCENEOBJECTWIDGET_ONLEAVESCENE_OFFSET UNITYSDK_OFFSET(0x13871D70)
#define MOLEMOLE_STATICSCENEOBJECTWIDGET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x13871CF0)
#define MOLEMOLE_STATICSCENEOBJECTWIDGET_START_OFFSET UNITYSDK_OFFSET(0x13871720)
#define MOLEMOLE_STATICSCENEOBJECTWIDGET__CCTOR_OFFSET UNITYSDK_OFFSET(0x13871EA0)
#define MOLEMOLE_STATICSCENEOBJECTWIDGET__CTOR_OFFSET UNITYSDK_OFFSET(0x13871E50)

namespace MoleMole
{
	inline static constexpr unsigned int StaticSceneObjectWidget_TypeDefinitionIndex = 61300;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(StaticSceneObjectWidget_TypeDefinitionIndex)->GetStaticField(0xFA10);
		}
		static ::UnityEngine::Vector3* StaticGet_Field_5_12()
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(StaticSceneObjectWidget_TypeDefinitionIndex)->GetStaticField(0xFA14);
		}
