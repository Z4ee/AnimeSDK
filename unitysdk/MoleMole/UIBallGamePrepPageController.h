...
#define MOLEMOLE_UIBALLGAMEPREPPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15224530)
#define MOLEMOLE_UIBALLGAMEPREPPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15224540)
#define MOLEMOLE_UIBALLGAMEPREPPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x152245B0)
#define MOLEMOLE_UIBALLGAMEPREPPAGECONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x152249C0)
#define MOLEMOLE_UIBALLGAMEPREPPAGECONTROLLER_ONPREPBACKTOMAINCITY_OFFSET UNITYSDK_OFFSET(0x15224B10)
#define MOLEMOLE_UIBALLGAMEPREPPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x152248C0)
#define MOLEMOLE_UIBALLGAMEPREPPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15224A20)
#define MOLEMOLE_UIBALLGAMEPREPPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15224650)
#define MOLEMOLE_UIBALLGAMEPREPPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x15224A70)
#define MOLEMOLE_UIBALLGAMEPREPPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15224B60)
#define MOLEMOLE_UIBALLGAMEPREPPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15224B70)
#define MOLEMOLE_UIBALLGAMEPREPPAGECONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x15224C10)
#define MOLEMOLE_UIBALLGAMEPREPPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15224CA0)
#define MOLEMOLE_UIBALLGAMEPREPPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15224D40)
#define MOLEMOLE_UIBALLGAMEPREPPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15224D50)
#define MOLEMOLE_UIBALLGAMEPREPPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x15224D60)

namespace MoleMole
{
	inline static constexpr unsigned int UIBallGamePrepPageController_TypeDefinitionIndex = 73699;
