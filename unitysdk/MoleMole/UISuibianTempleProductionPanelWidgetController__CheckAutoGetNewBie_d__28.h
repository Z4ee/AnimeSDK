...
#define MOLEMOLE_UISUIBIANTEMPLEPRODUCTIONPANELWIDGETCONTROLLER__CHECKAUTOGETNEWBIE_D__28_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x8499D0)
#define MOLEMOLE_UISUIBIANTEMPLEPRODUCTIONPANELWIDGETCONTROLLER__CHECKAUTOGETNEWBIE_D__28_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleProductionPanelWidgetController__CheckAutoGetNewBie_d__28_TypeDefinitionIndex = 90732;
