...
#define MOLEMOLE_GROUPCHALLENGECONFIGMANAGER_METHOD_1_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x1912F6D0)
#define MOLEMOLE_GROUPCHALLENGECONFIGMANAGER_METHOD_1_222951B8BA7FC1B0_OFFSET UNITYSDK_OFFSET(0x1912F4D0)
#define MOLEMOLE_GROUPCHALLENGECONFIGMANAGER_METHOD_1_44C6956149352354_OFFSET UNITYSDK_OFFSET(0x1912F6F0)
#define MOLEMOLE_GROUPCHALLENGECONFIGMANAGER_METHOD_1_6156EF6FFD0A172B_OFFSET UNITYSDK_OFFSET(0x1912F600)
#define MOLEMOLE_GROUPCHALLENGECONFIGMANAGER_METHOD_1_62167C28EC14CC63_OFFSET UNITYSDK_OFFSET(0x1912EA10)
#define MOLEMOLE_GROUPCHALLENGECONFIGMANAGER_METHOD_1_D12B7AF287E2C1C1_OFFSET UNITYSDK_OFFSET(0x1912EE40)
#define MOLEMOLE_GROUPCHALLENGECONFIGMANAGER_METHOD_1_DD788187B6D83B98_OFFSET UNITYSDK_OFFSET(0x1912EEC0)
#define MOLEMOLE_GROUPCHALLENGECONFIGMANAGER_METHOD_1_EE0137E8EED79B71_OFFSET UNITYSDK_OFFSET(0x1912F390)
#define MOLEMOLE_GROUPCHALLENGECONFIGMANAGER_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1912F6E0)
#define MOLEMOLE_GROUPCHALLENGECONFIGMANAGER_RESET_OFFSET UNITYSDK_OFFSET(0x1912E860)
#define MOLEMOLE_GROUPCHALLENGECONFIGMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1912E970)

namespace MoleMole
{
	inline static constexpr unsigned int GroupChallengeConfigManager_TypeDefinitionIndex = 45295;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::Class_1_380E15D819BCBADA*>**)Il2CppClass::FromTypeDefinitionIndex(GroupChallengeConfigManager_TypeDefinitionIndex)->GetStaticField(0x39DE0);
		}
