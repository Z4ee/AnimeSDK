...
#define MOLEMOLE_UIARCADEBASEPLAYCHILDWINDOWCONTROLLER_FADEANIMTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x18BE56A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeBasePlayChildWindowController_FadeAnimTask_TypeDefinitionIndex = 47783;
