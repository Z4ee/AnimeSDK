...
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT03WIDGETCONTROLLER_GETVIEW_OFFSET UNITYSDK_OFFSET(0x179D8670)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT03WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x179D8540)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT03WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x179D85D0)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT03WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x179D83C0)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT03WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x179D8420)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT03WIDGETCONTROLLER_PLAYNODEUIANIM_OFFSET UNITYSDK_OFFSET(0x179D86C0)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT03WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x179D8970)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT03WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x179D89D0)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT03WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x179D8A60)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT03WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x179D8AF0)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT03WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x179D8B80)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnowCoursePoint03WidgetController_TypeDefinitionIndex = 81468;
	...
	public:
		...
		::Class_2_60638234271CCDB8_116* GetView()
		{
			return ((::Class_2_60638234271CCDB8_116*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIINTERKNOWCOURSEPOINT03WIDGETCONTROLLER_GETVIEW_OFFSET))(this);
		}
