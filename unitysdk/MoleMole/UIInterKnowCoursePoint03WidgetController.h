...
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT03WIDGETCONTROLLER_GETVIEW_OFFSET UNITYSDK_OFFSET(0x169B2220)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT03WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x169B20F0)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT03WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x169B2180)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT03WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x169B1F70)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT03WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x169B1FD0)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT03WIDGETCONTROLLER_PLAYNODEUIANIM_OFFSET UNITYSDK_OFFSET(0x169B2270)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT03WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x169B2520)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT03WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x169B2580)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT03WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x169B2610)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT03WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x169B26A0)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINT03WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x169B2730)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnowCoursePoint03WidgetController_TypeDefinitionIndex = 62102;
	...
	public:
		...
		::Class_2_60638234271CCDB8_108* GetView()
		{
			return ((::Class_2_60638234271CCDB8_108*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIINTERKNOWCOURSEPOINT03WIDGETCONTROLLER_GETVIEW_OFFSET))(this);
		}
