...
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__PLAYTIMELINE_D__148_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x84CC50)
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__PLAYTIMELINE_D__148_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooPageController__PlayTimeline_d__148_TypeDefinitionIndex = 91531;
	...
	struct alignas(8) UIRidusGotBooPageController__PlayTimeline_d__148
	{
		...
		::System::Boolean withInputBlock; // 0x48
