...
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_ACTLEVELRESULTCAMERA_OFFSET UNITYSDK_OFFSET(0x18396650)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_CREATEITEMICON_OFFSET UNITYSDK_OFFSET(0x1839A0B0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_GETSHOWREWARDLIST_OFFSET UNITYSDK_OFFSET(0x1839A4C0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x18394AA0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_HASENDBATTLE_OFFSET UNITYSDK_OFFSET(0x183991B0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_INITACTVIEW_OFFSET UNITYSDK_OFFSET(0x18397670)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_INITCHESSBOARDVIEW_OFFSET UNITYSDK_OFFSET(0x18397C30)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_INITDAILYCHALLENGEVIEW_OFFSET UNITYSDK_OFFSET(0x18397F90)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_INITLOSEVIEW_OFFSET UNITYSDK_OFFSET(0x18398330)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x18396D70)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_INVOKEACTION1_OFFSET UNITYSDK_OFFSET(0x18399F80)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_INVOKEACTION2_OFFSET UNITYSDK_OFFSET(0x18399FE0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_ISADDITIONAUPITEM_OFFSET UNITYSDK_OFFSET(0x1839A040)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_ONCLICKITEMBTN_OFFSET UNITYSDK_OFFSET(0x1839A1F0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18397490)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18394AB0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x183975B0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18396E00)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_PLAYEXIT_OFFSET UNITYSDK_OFFSET(0x18399340)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_REFRESHACTVIEW_OFFSET UNITYSDK_OFFSET(0x183995E0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_REFRESHCHALLENGE_OFFSET UNITYSDK_OFFSET(0x18398A80)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_REFRESHCHESSBOARDVIEW_OFFSET UNITYSDK_OFFSET(0x18399660)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_REFRESHLOSEVIEW_OFFSET UNITYSDK_OFFSET(0x183996E0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_SETMOVE_OFFSET UNITYSDK_OFFSET(0x183971D0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x18397520)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1839A730)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__INITACTVIEW_B__15_0_OFFSET UNITYSDK_OFFSET(0x1839A920)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__INITACTVIEW_B__15_1_OFFSET UNITYSDK_OFFSET(0x1839AAE0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__INITCHESSBOARDVIEW_B__17_0_OFFSET UNITYSDK_OFFSET(0x1839AF60)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__INITDAILYCHALLENGEVIEW_B__16_0_OFFSET UNITYSDK_OFFSET(0x1839AD60)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__INITLOSEVIEW_B__18_0_OFFSET UNITYSDK_OFFSET(0x1839B140)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__INITLOSEVIEW_B__18_1_OFFSET UNITYSDK_OFFSET(0x1839B1A0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1839B2C0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1839B350)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1839B360)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1839B370)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x1839B380)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultPageController_TypeDefinitionIndex = 69273;

	class UILevelResultPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_102* _view; // 0x318
		...
		::Class_3_AE02BC8285203464_10* Ret; // 0x360
