...
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_ACTLEVELRESULTCAMERA_OFFSET UNITYSDK_OFFSET(0x15A66B10)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_CREATEITEMICON_OFFSET UNITYSDK_OFFSET(0x15A6A5A0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_GETSHOWREWARDLIST_OFFSET UNITYSDK_OFFSET(0x15A6A950)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15A64F10)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_HASENDBATTLE_OFFSET UNITYSDK_OFFSET(0x15A69690)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_INITACTVIEW_OFFSET UNITYSDK_OFFSET(0x15A67B60)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_INITCHESSBOARDVIEW_OFFSET UNITYSDK_OFFSET(0x15A68110)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_INITDAILYCHALLENGEVIEW_OFFSET UNITYSDK_OFFSET(0x15A68480)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_INITLOSEVIEW_OFFSET UNITYSDK_OFFSET(0x15A68820)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x15A67230)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_INVOKEACTION1_OFFSET UNITYSDK_OFFSET(0x15A6A470)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_INVOKEACTION2_OFFSET UNITYSDK_OFFSET(0x15A6A4D0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_ISADDITIONAUPITEM_OFFSET UNITYSDK_OFFSET(0x15A6A530)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_ONCLICKITEMBTN_OFFSET UNITYSDK_OFFSET(0x15A6A6E0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A67980)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15A64F20)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A67AA0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A672E0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_PLAYEXIT_OFFSET UNITYSDK_OFFSET(0x15A69820)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_REFRESHACTVIEW_OFFSET UNITYSDK_OFFSET(0x15A69AC0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_REFRESHCHALLENGE_OFFSET UNITYSDK_OFFSET(0x15A68F60)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_REFRESHCHESSBOARDVIEW_OFFSET UNITYSDK_OFFSET(0x15A69B40)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_REFRESHLOSEVIEW_OFFSET UNITYSDK_OFFSET(0x15A69BC0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_SETMOVE_OFFSET UNITYSDK_OFFSET(0x15A676C0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x15A67A10)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15A6ABB0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__INITACTVIEW_B__15_0_OFFSET UNITYSDK_OFFSET(0x15A6ADA0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__INITACTVIEW_B__15_1_OFFSET UNITYSDK_OFFSET(0x15A6AF60)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__INITCHESSBOARDVIEW_B__17_0_OFFSET UNITYSDK_OFFSET(0x15A6B3E0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__INITDAILYCHALLENGEVIEW_B__16_0_OFFSET UNITYSDK_OFFSET(0x15A6B1E0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__INITLOSEVIEW_B__18_0_OFFSET UNITYSDK_OFFSET(0x15A6B5D0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__INITLOSEVIEW_B__18_1_OFFSET UNITYSDK_OFFSET(0x15A6B630)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A6B750)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15A6B7E0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A6B7F0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A6B800)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x15A6B810)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultPageController_TypeDefinitionIndex = 68599;

	class UILevelResultPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_142* _view; // 0x310
		::MoleMole::UILevelResultPageContext* _resultPageContext; // 0x318
		::System::Collections::Generic::List_1<::Class_1_1685EC66FBD28897*>* showList; // 0x320
		::System::Collections::Generic::List_1<::MoleMole::UIItemIconBtnWidgetController*>* _caches; // 0x328
		::System::Boolean _skip; // 0x330
		::Enum_3_3FDE76C86672FDDC _curShowType; // 0x334
		::System::Action* Action1; // 0x338
		::System::Action* Action2; // 0x340
		::MoleMole::MonoLevelResultInfo* _levelResultInfo; // 0x348
		::Class_2_1A3197598F874EB7* _questModel; // 0x350
		::Class_3_AE02BC8285203464_6* Ret; // 0x358
		::System::Int32 _score; // 0x360
		::System::Collections::Generic::List_1<::Class_1_0D6706375CDAAE8C*>* _RewardItems; // 0x368
		::System::Collections::Generic::List_1<::MoleMole::UILevelResultPageController_RewardItemMeta>* _rewardItemsMeta; // 0x370
		::MonoUITableScrollV2* _missionscroll; // 0x378
		::MonoUITableScrollV2* _challengescroll; // 0x380
		::Class_2_9D9172C07F82DDAE* _itemModel; // 0x388
		::System::Collections::Generic::List_1<::Class_1_82297B6AFFE49354*>* _recordItems; // 0x390
		::System::Collections::Generic::List_1<::MoleMole::UILevelResultPageController_MissionRow*>* _missionItems; // 0x398
		::System::Int32 _nextID; // 0x3A0
		::System::Collections::Generic::List_1<::System::Int32>* _challenge; // 0x3A8
		::System::Boolean _procedure; // 0x3B0
		::System::Int32 _nextFile; // 0x3B4
		::Class_2_33EA27A25F076E07* _mainStoryModel; // 0x3B8
		::Foundation::Coroutine::CoroutineHandle _animHandle; // 0x3C0
		::System::Boolean _isShowed; // 0x3C4
