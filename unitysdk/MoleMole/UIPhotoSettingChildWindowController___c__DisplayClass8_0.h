...
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17170E30)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER___C__DISPLAYCLASS8_0__REFRESHSELFIEMOTIONDATA_B__0_OFFSET UNITYSDK_OFFSET(0x17170E40)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoSettingChildWindowController___c__DisplayClass8_0_TypeDefinitionIndex = 82755;
