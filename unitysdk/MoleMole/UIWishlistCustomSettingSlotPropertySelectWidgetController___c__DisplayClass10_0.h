...
#define MOLEMOLE_UIWISHLISTCUSTOMSETTINGSLOTPROPERTYSELECTWIDGETCONTROLLER___C__DISPLAYCLASS10_0__CTOR_OFFSET UNITYSDK_OFFSET(0x11B9B610)
#define MOLEMOLE_UIWISHLISTCUSTOMSETTINGSLOTPROPERTYSELECTWIDGETCONTROLLER___C__DISPLAYCLASS10_0__REFRESHVIEW_B__0_OFFSET UNITYSDK_OFFSET(0x11B9B620)

namespace MoleMole
{
	inline static constexpr unsigned int UIWishlistCustomSettingSlotPropertySelectWidgetController___c__DisplayClass10_0_TypeDefinitionIndex = 62286;
