...
#define MOLEMOLE_SHOPPINGMALLLIMITEDCARDROWCONTEXT_GET_LOGINFUNDINFOSHOPDATA_OFFSET UNITYSDK_OFFSET(0x1809EF80)
#define MOLEMOLE_SHOPPINGMALLLIMITEDCARDROWCONTEXT_GET_REWARDINDEX_OFFSET UNITYSDK_OFFSET(0x1809EFA0)
#define MOLEMOLE_SHOPPINGMALLLIMITEDCARDROWCONTEXT_SET_LOGINFUNDINFOSHOPDATA_OFFSET UNITYSDK_OFFSET(0x1809EF90)
#define MOLEMOLE_SHOPPINGMALLLIMITEDCARDROWCONTEXT_SET_REWARDINDEX_OFFSET UNITYSDK_OFFSET(0x1809EFB0)
#define MOLEMOLE_SHOPPINGMALLLIMITEDCARDROWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1809EFC0)

namespace MoleMole
{
	inline static constexpr unsigned int ShoppingMallLimitedCardRowContext_TypeDefinitionIndex = 61403;
