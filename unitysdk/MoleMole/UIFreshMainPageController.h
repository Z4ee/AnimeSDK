...
#define MOLEMOLE_UIFRESHMAINPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x188063C0)
#define MOLEMOLE_UIFRESHMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x188063B0)
#define MOLEMOLE_UIFRESHMAINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x188063D0)
#define MOLEMOLE_UIFRESHMAINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x188064B0)
#define MOLEMOLE_UIFRESHMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18806460)
#define MOLEMOLE_UIFRESHMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18806520)
#define MOLEMOLE_UIFRESHMAINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18806530)
#define MOLEMOLE_UIFRESHMAINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x188065C0)
#define MOLEMOLE_UIFRESHMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x188065D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFreshMainPageController_TypeDefinitionIndex = 71846;

	class UIFreshMainPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_60638234271CCDB8_132* _view; // 0x318
