...
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER_BINDVIEW_OFFSET UNITYSDK_OFFSET(0x1F3EB300)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1F3EAE70)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1F3EB460)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER_ONGAMEEND_OFFSET UNITYSDK_OFFSET(0x1F3EBB20)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1F3EB630)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER_ONSCORECHANGE_OFFSET UNITYSDK_OFFSET(0x1F3EBB90)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER_ONSPEEDSYNC_OFFSET UNITYSDK_OFFSET(0x1F3EBAC0)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER_ONTIMELEFTSYNC_OFFSET UNITYSDK_OFFSET(0x1F3EBF70)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1F3EB4F0)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1F3EAE80)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1F3EAFB0)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1F3EB8A0)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F3EC150)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1F3EC160)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1F3EC1F0)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1F3EC220)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1F3EC230)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1F3EC240)

namespace MoleMole
{
	inline static constexpr unsigned int UIBrInLevelChildWindowController_TypeDefinitionIndex = 93456;
