...
class Class_2_7BF2EAF8B77D0A8E;
...
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER_GETSKILLASSETPATH_OFFSET UNITYSDK_OFFSET(0x15A2A300)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x15A28A90)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15A28A80)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER_INITSKILLICON_OFFSET UNITYSDK_OFFSET(0x15A290F0)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A2A4B0)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER_ONLEFTCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x15A298F0)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER_ONRIGHTCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x15A29390)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A2A540)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A28AA0)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15A29950)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER_REFRESHSKILLICON_OFFSET UNITYSDK_OFFSET(0x15A29D90)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER_REFRESHSKILLROW_OFFSET UNITYSDK_OFFSET(0x15A29410)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x15A29AE0)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15A2A5B0)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A2A790)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A2A820)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A2A830)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15A2A840)

namespace MoleMole
{
	inline static constexpr unsigned int UISkillRecommendPopWindowController_TypeDefinitionIndex = 43646;

	class UISkillRecommendPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_7BF2EAF8B77D0A8E* _view; // 0x318
		...
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_881*>* _skillRecoList; // 0x340
		::Class_2_208CC9941471731A_881* _currentSkillRecoCfg; // 0x348
