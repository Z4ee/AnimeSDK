...
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER_GETSKILLASSETPATH_OFFSET UNITYSDK_OFFSET(0x1400FC10)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x1400E3A0)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1400E390)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER_INITSKILLICON_OFFSET UNITYSDK_OFFSET(0x1400EA00)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1400FDC0)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER_ONLEFTCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x1400F200)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER_ONRIGHTCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x1400ECA0)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1400FE50)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1400E3B0)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1400F260)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER_REFRESHSKILLICON_OFFSET UNITYSDK_OFFSET(0x1400F6A0)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER_REFRESHSKILLROW_OFFSET UNITYSDK_OFFSET(0x1400ED20)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1400F3F0)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1400FEC0)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x140100B0)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14010140)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14010150)
#define MOLEMOLE_UISKILLRECOMMENDPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14010160)

namespace MoleMole
{
	inline static constexpr unsigned int UISkillRecommendPopWindowController_TypeDefinitionIndex = 54752;

	class UISkillRecommendPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_72D2E63B32BDB80C* _view; // 0x310
		::System::Collections::Generic::List_1<::MoleMole::UISkillRecommendRowWidgetController*>* _rowFirst; // 0x318
		::System::Collections::Generic::List_1<::MoleMole::UISkillRecommendRowWidgetController*>* _rowSecond; // 0x320
		::System::Collections::Generic::List_1<::MoleMole::UISkillRecommendRowWidgetController*>* _rowThird; // 0x328
		::Class_2_1824EF69C8E376A3* _avatarItemData; // 0x330
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_770*>* _skillRecoList; // 0x338
		::Class_2_208CC9941471731A_770* _currentSkillRecoCfg; // 0x340
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::Foundation::AssetPath>* talentIconDir; // 0x348
		::System::Int32 _currentIndex; // 0x350
