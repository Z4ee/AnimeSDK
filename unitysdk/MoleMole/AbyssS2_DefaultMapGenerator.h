...
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_FETCHROUTEPOINTNEIGHBOR_OFFSET UNITYSDK_OFFSET(0x1627E0B0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_GETAREAMETATYPETEMPLATEEXTBYAREAID_OFFSET UNITYSDK_OFFSET(0x16282710)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_GET_RESULT_OFFSET UNITYSDK_OFFSET(0x16283120)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_POST_OFFSET UNITYSDK_OFFSET(0x16280E70)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_PREPARE_OFFSET UNITYSDK_OFFSET(0x162792D0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_PROCESS_NORMALPARTFIXGEN_3_OFFSET UNITYSDK_OFFSET(0x1627CD60)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_PROCESS_NORMALPARTGEN_1_OFFSET UNITYSDK_OFFSET(0x1627BC50)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_PROCESS_NORMALPARTREDUCEGEN_2_OFFSET UNITYSDK_OFFSET(0x1627C3E0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_PROCESS_OFFSET UNITYSDK_OFFSET(0x162796E0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_PROCESS_STARTPOINTS_0_OFFSET UNITYSDK_OFFSET(0x1627B540)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16279160)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__FETCHROUTEPOINTNEIGHBOOR_OFFSET UNITYSDK_OFFSET(0x1627DD90)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__FETCHROUTEPOINTNEIGHBOR_G__GETINDEX_17_0_OFFSET UNITYSDK_OFFSET(0x1627E370)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__ISAREAIDUNDERFORBIDRULE_OFFSET UNITYSDK_OFFSET(0x1627E470)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__ISAREASERINDEXUNDERFORBIDRULE_OFFSET UNITYSDK_OFFSET(0x16280130)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__ISTAGMATCHLIST_OFFSET UNITYSDK_OFFSET(0x1627E3C0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__RANDOMFILLAREA_OFFSET UNITYSDK_OFFSET(0x1627A180)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__SORTROUTEPOINTLISTBYFLOOR_OFFSET UNITYSDK_OFFSET(0x1627D860)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__TRYBUILDDYNAMICMERGES_OFFSET UNITYSDK_OFFSET(0x16280EC0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__TRYGENSERIALID_OFFSET UNITYSDK_OFFSET(0x16280460)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__TRYPARSEAREAPOOL_OFFSET UNITYSDK_OFFSET(0x16279940)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__WEIGHTRANDOMAREA_OFFSET UNITYSDK_OFFSET(0x1627D970)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR___FETCHROUTEPOINTNEIGHBOOR_G____GETINDEX_16_0_OFFSET UNITYSDK_OFFSET(0x1627E060)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR___TRYBUILDDYNAMICMERGES_G____GETAREAIDBYROUTEPOINTID_29_4_OFFSET UNITYSDK_OFFSET(0x16282CF0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR___TRYBUILDDYNAMICMERGES_G____HASSPECIALINDEXORTAGS_29_0_OFFSET UNITYSDK_OFFSET(0x16282E00)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR___TRYBUILDDYNAMICMERGES_G____ISLEFTINRIGHT_29_2_OFFSET UNITYSDK_OFFSET(0x16282C70)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR___TRYBUILDDYNAMICMERGES_G____NEXTPOSSIBLESELECTIONS_29_3_OFFSET UNITYSDK_OFFSET(0x16282950)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR___TRYBUILDDYNAMICMERGES_G____SPLITLISTTONEW_29_1_OFFSET UNITYSDK_OFFSET(0x16283000)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_DefaultMapGenerator_TypeDefinitionIndex = 85700;

	class AbyssS2_DefaultMapGenerator : public ::System::Object
	{
	public:
		// static const ::System::Int32 MAX_TRY = 0x64; // 0x0
		::MoleMole::AbyssS2_IRNG* _rngEvent; // 0x10
		::MoleMole::AbyssS2_WorkGrid* grid; // 0x18
		::MoleMole::AbyssS2_DefaultMapGenerator_GenPointID2AreaInterObject* runTimeID2AreaInterObject; // 0x20
		::MoleMole::AbyssS2_IRNG* _rngRoute; // 0x28
		...
		::Class_2_208CC9941471731A_19* GetAreaMetaTypeTemplateExtByAreaID(::System::Int32 areaID, ::System::Int32 areaIndex)
		{
			return ((::Class_2_208CC9941471731A_19*(*)(::PVOID, ::System::Int32, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_GETAREAMETATYPETEMPLATEEXTBYAREAID_OFFSET))(this, areaID, areaIndex);
		}
