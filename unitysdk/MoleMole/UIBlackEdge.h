...
#define MOLEMOLE_UIBLACKEDGE_CALCULATELAYOUT_OFFSET UNITYSDK_OFFSET(0x17F590F0)
#define MOLEMOLE_UIBLACKEDGE_GETPIXELSCREENSIZEEXCLUDEBLACKEDGE_OFFSET UNITYSDK_OFFSET(0x17F5A320)
#define MOLEMOLE_UIBLACKEDGE_INIT_OFFSET UNITYSDK_OFFSET(0x17F58E40)
#define MOLEMOLE_UIBLACKEDGE_METHOD_5_4B72F72501001F72_OFFSET UNITYSDK_OFFSET(0x17F5A120)
#define MOLEMOLE_UIBLACKEDGE_METHOD_5_AAB7CE7031E7B228_OFFSET UNITYSDK_OFFSET(0x17F5A4B0)
#define MOLEMOLE_UIBLACKEDGE_METHOD_5_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x17F5A5C0)
#define MOLEMOLE_UIBLACKEDGE_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x17F5A470)
#define MOLEMOLE_UIBLACKEDGE_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x17F5A5B0)
#define MOLEMOLE_UIBLACKEDGE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17F59040)
#define MOLEMOLE_UIBLACKEDGE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17F58DB0)
#define MOLEMOLE_UIBLACKEDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17F5A420)

namespace MoleMole
{
	inline static constexpr unsigned int UIBlackEdge_TypeDefinitionIndex = 76836;
