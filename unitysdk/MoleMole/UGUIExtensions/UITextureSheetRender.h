...
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_ADDENDEVENT_OFFSET UNITYSDK_OFFSET(0x15A77B80)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_GET_COLUMNS_OFFSET UNITYSDK_OFFSET(0x15A74FA0)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_GET_CURRENTFRAME_OFFSET UNITYSDK_OFFSET(0x15A75010)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_GET_FRAMES_OFFSET UNITYSDK_OFFSET(0x15A74FC0)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_GET_GRAPHIC_OFFSET UNITYSDK_OFFSET(0x15A750E0)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_GET_ROWS_OFFSET UNITYSDK_OFFSET(0x15A74FB0)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_INITRAWIMAGE_OFFSET UNITYSDK_OFFSET(0x15A76310)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_INIT_OFFSET UNITYSDK_OFFSET(0x15A758B0)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x15A77A90)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x15A77750)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_PLAYRAWIMAGESINGLEFRAME_OFFSET UNITYSDK_OFFSET(0x15A77190)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_PLAYSINGLEFRAME_OFFSET UNITYSDK_OFFSET(0x15A76990)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_REFRESHRUNTIMEFREQUENCY_OFFSET UNITYSDK_OFFSET(0x15A77AE0)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_REMOVEENDEVENT_OFFSET UNITYSDK_OFFSET(0x15A77C00)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_UPDATE_OFFSET UNITYSDK_OFFSET(0x15A751C0)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x15A77D30)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x15A77C80)

namespace MoleMole::UGUIExtensions
{
	inline static constexpr unsigned int UITextureSheetRender_TypeDefinitionIndex = 66124;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UITextureSheetRender_TypeDefinitionIndex)->GetStaticField(0xE600);
		}
		static ::System::Int32* StaticGet_Field_6_6()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UITextureSheetRender_TypeDefinitionIndex)->GetStaticField(0xE604);
		}
		static ::System::Int32* StaticGet_Field_6_10()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UITextureSheetRender_TypeDefinitionIndex)->GetStaticField(0xE608);
		}
		static ::System::Int32* StaticGet_Field_6_5()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UITextureSheetRender_TypeDefinitionIndex)->GetStaticField(0xE60C);
		}
		static ::System::Int32* StaticGet_Field_6_19()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UITextureSheetRender_TypeDefinitionIndex)->GetStaticField(0xE610);
		}
