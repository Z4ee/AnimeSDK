...
#define MOLEMOLE_UGUIEXTENSIONS_UIFAKEPERSPECTIVE_METHOD_7_486AF1E6C0038D4C_1_OFFSET UNITYSDK_OFFSET(0x1740ED10)
#define MOLEMOLE_UGUIEXTENSIONS_UIFAKEPERSPECTIVE_METHOD_7_486AF1E6C0038D4C_2_OFFSET UNITYSDK_OFFSET(0x1740ED20)
#define MOLEMOLE_UGUIEXTENSIONS_UIFAKEPERSPECTIVE_METHOD_7_486AF1E6C0038D4C_3_OFFSET UNITYSDK_OFFSET(0x1740ED30)
#define MOLEMOLE_UGUIEXTENSIONS_UIFAKEPERSPECTIVE_METHOD_7_486AF1E6C0038D4C_OFFSET UNITYSDK_OFFSET(0x1740ED00)
#define MOLEMOLE_UGUIEXTENSIONS_UIFAKEPERSPECTIVE_METHOD_7_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x1740ED50)
#define MOLEMOLE_UGUIEXTENSIONS_UIFAKEPERSPECTIVE_METHOD_7_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1740ED40)
#define MOLEMOLE_UGUIEXTENSIONS_UIFAKEPERSPECTIVE_SETUPDATE_OFFSET UNITYSDK_OFFSET(0x1740ED60)
#define MOLEMOLE_UGUIEXTENSIONS_UIFAKEPERSPECTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1740EDB0)

namespace MoleMole::UGUIExtensions
{
	inline static constexpr unsigned int UIFakePerspective_TypeDefinitionIndex = 61707;
