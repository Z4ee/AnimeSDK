...
#define MOLEMOLE_UGUIEXTENSIONS_UIFAKEPERSPECTIVE_METHOD_7_486AF1E6C0038D4C_1_OFFSET UNITYSDK_OFFSET(0x129EBB70)
#define MOLEMOLE_UGUIEXTENSIONS_UIFAKEPERSPECTIVE_METHOD_7_486AF1E6C0038D4C_2_OFFSET UNITYSDK_OFFSET(0x129EBB80)
#define MOLEMOLE_UGUIEXTENSIONS_UIFAKEPERSPECTIVE_METHOD_7_486AF1E6C0038D4C_3_OFFSET UNITYSDK_OFFSET(0x129EBB90)
#define MOLEMOLE_UGUIEXTENSIONS_UIFAKEPERSPECTIVE_METHOD_7_486AF1E6C0038D4C_OFFSET UNITYSDK_OFFSET(0x129EBB60)
#define MOLEMOLE_UGUIEXTENSIONS_UIFAKEPERSPECTIVE_METHOD_7_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x129EBBB0)
#define MOLEMOLE_UGUIEXTENSIONS_UIFAKEPERSPECTIVE_METHOD_7_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x129EBBA0)
#define MOLEMOLE_UGUIEXTENSIONS_UIFAKEPERSPECTIVE_SETUPDATE_OFFSET UNITYSDK_OFFSET(0x129EBBC0)
#define MOLEMOLE_UGUIEXTENSIONS_UIFAKEPERSPECTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x129EBC10)

namespace MoleMole::UGUIExtensions
{
	inline static constexpr unsigned int UIFakePerspective_TypeDefinitionIndex = 82126;
