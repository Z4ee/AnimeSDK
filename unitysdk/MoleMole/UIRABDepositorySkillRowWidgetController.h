...
#define MOLEMOLE_UIRABDEPOSITORYSKILLROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15F5D540)
#define MOLEMOLE_UIRABDEPOSITORYSKILLROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15F5D5B0)
#define MOLEMOLE_UIRABDEPOSITORYSKILLROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15F5D650)
#define MOLEMOLE_UIRABDEPOSITORYSKILLROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15F5D810)
#define MOLEMOLE_UIRABDEPOSITORYSKILLROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15F5D870)
#define MOLEMOLE_UIRABDEPOSITORYSKILLROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15F5D910)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABDepositorySkillRowWidgetController_TypeDefinitionIndex = 47768;
