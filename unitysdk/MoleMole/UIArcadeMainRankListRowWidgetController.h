...
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_INITPLATFORMUI_OFFSET UNITYSDK_OFFSET(0x17338840)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x173379A0)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17337AA0)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17337BB0)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17337B30)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17337930)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17337A30)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_REFRESHCOMMONVIEW_OFFSET UNITYSDK_OFFSET(0x17338550)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_REFRESHTOPSELFVIEW_OFFSET UNITYSDK_OFFSET(0x17337CC0)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_REFRESHUSERVIEW_OFFSET UNITYSDK_OFFSET(0x17338230)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_SWITCHACCOUNTNAMEINFO_OFFSET UNITYSDK_OFFSET(0x173387C0)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17339030)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17339040)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x173390D0)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17339170)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17339200)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17339290)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeMainRankListRowWidgetController_TypeDefinitionIndex = 73873;

	class UIArcadeMainRankListRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_19206BC47BA92FC3_2* _view; // 0x2F0
		...
		::System::Void RefreshTopSelfView(::System::Int32 playerID, ::Class_2_888C59F77423C576_2* rankData)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::Class_2_888C59F77423C576_2*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_REFRESHTOPSELFVIEW_OFFSET))(this, playerID, rankData);
		}
