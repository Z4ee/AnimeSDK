...
#define MOLEMOLE_UISOCIALCIRCLENEWSTITLEROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15E903B0)
#define MOLEMOLE_UISOCIALCIRCLENEWSTITLEROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15E90480)
#define MOLEMOLE_UISOCIALCIRCLENEWSTITLEROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15E90540)
#define MOLEMOLE_UISOCIALCIRCLENEWSTITLEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15E90420)
#define MOLEMOLE_UISOCIALCIRCLENEWSTITLEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15E906F0)
#define MOLEMOLE_UISOCIALCIRCLENEWSTITLEROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15E90700)
#define MOLEMOLE_UISOCIALCIRCLENEWSTITLEROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15E907A0)
#define MOLEMOLE_UISOCIALCIRCLENEWSTITLEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15E90840)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleNewsTitleRowWidgetController_TypeDefinitionIndex = 73129;
