...
class Class_2_FB90F8F234309AE5;
namespace MoleMole { class UIControlReference; }
namespace System { class Object; }

#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER_ISUSING_OFFSET UNITYSDK_OFFSET(0x17BBB920)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17BBB4C0)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17BBB5D0)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17BBB550)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17BBB310)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER_SHOWFILTERROW_OFFSET UNITYSDK_OFFSET(0x17BBB730)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17BBB980)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17BBB990)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17BBBA20)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17BBBAC0)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17BBBB50)

namespace MoleMole
{
	inline static constexpr unsigned int UIFilterRowWidgetController_TypeDefinitionIndex = 55535;

	class UIFilterRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_FB90F8F234309AE5* _view; // 0x2F0
		::Class_1_03687BAE461D2A08* _filter; // 0x2F8
