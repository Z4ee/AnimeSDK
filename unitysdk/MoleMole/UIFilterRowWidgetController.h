...
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER_ISUSING_OFFSET UNITYSDK_OFFSET(0x1526EC80)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1526E820)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1526E930)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1526E8B0)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1526E670)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER_SHOWFILTERROW_OFFSET UNITYSDK_OFFSET(0x1526EA90)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1526ECE0)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1526ECF0)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1526ED80)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1526EE20)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1526EEB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFilterRowWidgetController_TypeDefinitionIndex = 60835;

	class UIFilterRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_FB90F8F234309AE5_1* _view; // 0x2F0
