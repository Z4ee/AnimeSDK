...
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16691000)

namespace MoleMole
{
	inline static constexpr unsigned int UISearchObjectQuestionRowWidgetControllerContext_TypeDefinitionIndex = 61544;
