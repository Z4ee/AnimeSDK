...
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_CARDCHANGEINFO_GET_ADD_OFFSET UNITYSDK_OFFSET(0x172160C0)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_CARDCHANGEINFO_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0x172160A0)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_CARDCHANGEINFO_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x17216100)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_CARDCHANGEINFO_GET_SLOT_OFFSET UNITYSDK_OFFSET(0x172160E0)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_CARDCHANGEINFO_SET_ADD_OFFSET UNITYSDK_OFFSET(0x172160D0)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_CARDCHANGEINFO_SET_ITEMID_OFFSET UNITYSDK_OFFSET(0x172160B0)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_CARDCHANGEINFO_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x17216110)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_CARDCHANGEINFO_SET_SLOT_OFFSET UNITYSDK_OFFSET(0x172160F0)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_CARDCHANGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17216120)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMainPageController_CardChangeInfo_TypeDefinitionIndex = 78309;
