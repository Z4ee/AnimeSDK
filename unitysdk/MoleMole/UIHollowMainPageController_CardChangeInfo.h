...
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_CARDCHANGEINFO_GET_ADD_OFFSET UNITYSDK_OFFSET(0x163857E0)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_CARDCHANGEINFO_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0x163857C0)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_CARDCHANGEINFO_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x16385820)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_CARDCHANGEINFO_GET_SLOT_OFFSET UNITYSDK_OFFSET(0x16385800)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_CARDCHANGEINFO_SET_ADD_OFFSET UNITYSDK_OFFSET(0x163857F0)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_CARDCHANGEINFO_SET_ITEMID_OFFSET UNITYSDK_OFFSET(0x163857D0)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_CARDCHANGEINFO_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x16385830)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_CARDCHANGEINFO_SET_SLOT_OFFSET UNITYSDK_OFFSET(0x16385810)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_CARDCHANGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16385840)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMainPageController_CardChangeInfo_TypeDefinitionIndex = 44952;

	class UIHollowMainPageController_CardChangeInfo : public ::System::Object
	{
	public:
		::Class_1_0D6706375CDAAE8C* _item_k__BackingField; // 0x10
		::MoleMole::UIHollowMainPageController_CardSlot* _slot_k__BackingField; // 0x18
