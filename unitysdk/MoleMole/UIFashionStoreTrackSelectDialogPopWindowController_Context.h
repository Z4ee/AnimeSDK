...
#define MOLEMOLE_UIFASHIONSTORETRACKSELECTDIALOGPOPWINDOWCONTROLLER_CONTEXT_GET_KEYBOARDDATAS_OFFSET UNITYSDK_OFFSET(0x16CC3550)
#define MOLEMOLE_UIFASHIONSTORETRACKSELECTDIALOGPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16CC3560)

namespace MoleMole
{
	inline static constexpr unsigned int UIFashionStoreTrackSelectDialogPopWindowController_Context_TypeDefinitionIndex = 57520;

	class UIFashionStoreTrackSelectDialogPopWindowController_Context : public ::MoleMole::UIControllerContextBase
	{
	public:
		::Class_0_16E4307DCC41950C_14<::Class_2_720FD421F092FF93_Class_2_64BF5C9CD45A0BD0*>* _KeyBoardDatas_k__BackingField; // 0x28
		::Class_1_1B85226610A5D17C* _propertyAllocateHelper; // 0x30
		::System::Action_1<::Class_2_720FD421F092FF93_Class_2_64BF5C9CD45A0BD0*>* OnClickItemCallback; // 0x38
