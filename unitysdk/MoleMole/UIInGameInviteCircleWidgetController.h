...
#define MOLEMOLE_UIINGAMEINVITECIRCLEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15FB4920)
#define MOLEMOLE_UIINGAMEINVITECIRCLEWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15FB4990)
#define MOLEMOLE_UIINGAMEINVITECIRCLEWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15FB4A50)
#define MOLEMOLE_UIINGAMEINVITECIRCLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15FB4D90)
#define MOLEMOLE_UIINGAMEINVITECIRCLEWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15FB4DA0)
#define MOLEMOLE_UIINGAMEINVITECIRCLEWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15FB4E40)

namespace MoleMole
{
	inline static constexpr unsigned int UIInGameInviteCircleWidgetController_TypeDefinitionIndex = 52863;
