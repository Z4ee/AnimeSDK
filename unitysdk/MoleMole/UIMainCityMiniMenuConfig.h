...
#define MOLEMOLE_UIMAINCITYMINIMENUCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19865E00)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityMiniMenuConfig_TypeDefinitionIndex = 79547;
