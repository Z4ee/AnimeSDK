...
#define MOLEMOLE_UIMAINCITYMINIMENUCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16D96060)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityMiniMenuConfig_TypeDefinitionIndex = 64720;
