...
#define MOLEMOLE_UIINLEVELPAUSEBUFFROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1828D620)
#define MOLEMOLE_UIINLEVELPAUSEBUFFROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1828D6B0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1828D550)
#define MOLEMOLE_UIINLEVELPAUSEBUFFROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1828D5B0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFROWWIDGETCONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0x1828D730)
#define MOLEMOLE_UIINLEVELPAUSEBUFFROWWIDGETCONTROLLER_SETBUFFSTATE_OFFSET UNITYSDK_OFFSET(0x1828E0A0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1828E2A0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1828E380)
#define MOLEMOLE_UIINLEVELPAUSEBUFFROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1828E410)
#define MOLEMOLE_UIINLEVELPAUSEBUFFROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1828E4A0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1828E530)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseBuffRowWidgetController_TypeDefinitionIndex = 86166;

	class UIInLevelPauseBuffRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_7A192581FF7290CF* _view; // 0x2C0
		::System::Collections::Generic::List_1<::Class_2_EA995402651EF7A9*>* modifiers; // 0x2C8
