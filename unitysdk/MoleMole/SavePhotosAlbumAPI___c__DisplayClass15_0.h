...
#define MOLEMOLE_SAVEPHOTOSALBUMAPI___C__DISPLAYCLASS15_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19987730)
#define MOLEMOLE_SAVEPHOTOSALBUMAPI___C__DISPLAYCLASS15_0__REQUESTPHOTOPERMISSIONBYMHYSDK_B__0_OFFSET UNITYSDK_OFFSET(0x19987740)
#define MOLEMOLE_SAVEPHOTOSALBUMAPI___C__DISPLAYCLASS15_0__REQUESTPHOTOPERMISSIONBYMHYSDK_B__1_OFFSET UNITYSDK_OFFSET(0x199877E0)

namespace MoleMole
{
	inline static constexpr unsigned int SavePhotosAlbumAPI___c__DisplayClass15_0_TypeDefinitionIndex = 69777;
