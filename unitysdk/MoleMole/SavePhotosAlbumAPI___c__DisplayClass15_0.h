...
#define MOLEMOLE_SAVEPHOTOSALBUMAPI___C__DISPLAYCLASS15_0__CTOR_OFFSET UNITYSDK_OFFSET(0x160EA950)
#define MOLEMOLE_SAVEPHOTOSALBUMAPI___C__DISPLAYCLASS15_0__REQUESTPHOTOPERMISSIONBYMHYSDK_B__0_OFFSET UNITYSDK_OFFSET(0x160EA960)
#define MOLEMOLE_SAVEPHOTOSALBUMAPI___C__DISPLAYCLASS15_0__REQUESTPHOTOPERMISSIONBYMHYSDK_B__1_OFFSET UNITYSDK_OFFSET(0x160EAA00)

namespace MoleMole
{
	inline static constexpr unsigned int SavePhotosAlbumAPI___c__DisplayClass15_0_TypeDefinitionIndex = 64673;
