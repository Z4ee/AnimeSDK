...
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_GETBINDMODULES_OFFSET UNITYSDK_OFFSET(0x17DC7EA0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_GETNESTEDLISTDELEGATEGOLIST_OFFSET UNITYSDK_OFFSET(0x17DC7EE0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_GETSHOWREWARDLIST_OFFSET UNITYSDK_OFFSET(0x17DC9B00)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x17DC6340)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17DC6240)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_ONCREATREWARDITEM_OFFSET UNITYSDK_OFFSET(0x17DC7C50)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17DC6810)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17DC6860)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17DC62D0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17DC67A0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_REFRESHACTCHALLENGELIST_OFFSET UNITYSDK_OFFSET(0x17DC84E0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_REFRESHACTVIEW_OFFSET UNITYSDK_OFFSET(0x17DC7D10)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_REFRESHCHESSBOARDVIEW_OFFSET UNITYSDK_OFFSET(0x17DC68E0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_REFRESHCONSOLE_OFFSET UNITYSDK_OFFSET(0x17DC7F20)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0x17DC84A0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_REFRESHLEVELQUESTSVIEW_OFFSET UNITYSDK_OFFSET(0x17DCA420)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_REFRESHREWARDVIEW_OFFSET UNITYSDK_OFFSET(0x17DC83D0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_REFRESHSHOWREWARDLIST_OFFSET UNITYSDK_OFFSET(0x17DC9390)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_REFRESHTITLEAREA_OFFSET UNITYSDK_OFFSET(0x17DC9E00)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_UPDATEREWARDITEM_OFFSET UNITYSDK_OFFSET(0x17DC9F70)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17DCA790)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17DCA870)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17DCA990)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17DCA9A0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17DCA900)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17DCAA30)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseBattleInfoWidgetController_TypeDefinitionIndex = 88180;
	...
	public:
		...
		::Class_2_79F6D62CE30E3F8E_37* _view; // 0x2C8
