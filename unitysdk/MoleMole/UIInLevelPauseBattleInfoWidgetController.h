...
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_GETBINDMODULES_OFFSET UNITYSDK_OFFSET(0x15271120)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_GETNESTEDLISTDELEGATEGOLIST_OFFSET UNITYSDK_OFFSET(0x15271160)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_GETSHOWREWARDLIST_OFFSET UNITYSDK_OFFSET(0x15272DB0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x1526F580)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1526F480)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_ONCREATREWARDITEM_OFFSET UNITYSDK_OFFSET(0x15270ED0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x1526FA50)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1526FAA0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1526F510)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1526F9E0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_REFRESHACTCHALLENGELIST_OFFSET UNITYSDK_OFFSET(0x15271760)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_REFRESHACTVIEW_OFFSET UNITYSDK_OFFSET(0x15270F90)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_REFRESHCHESSBOARDVIEW_OFFSET UNITYSDK_OFFSET(0x1526FB20)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_REFRESHCONSOLE_OFFSET UNITYSDK_OFFSET(0x152711A0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0x15271720)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_REFRESHLEVELQUESTSVIEW_OFFSET UNITYSDK_OFFSET(0x152736D0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_REFRESHREWARDVIEW_OFFSET UNITYSDK_OFFSET(0x15271650)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_REFRESHSHOWREWARDLIST_OFFSET UNITYSDK_OFFSET(0x15272640)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_REFRESHTITLEAREA_OFFSET UNITYSDK_OFFSET(0x152730B0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_UPDATEREWARDITEM_OFFSET UNITYSDK_OFFSET(0x15273220)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x152739E0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15273AC0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x15273BE0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15273BF0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15273B50)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15273C80)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseBattleInfoWidgetController_TypeDefinitionIndex = 51445;

	class UIInLevelPauseBattleInfoWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::System::Collections::Generic::List_1<::Class_1_1685EC66FBD28897*>* showList; // 0x2B8
		...
		::MoleMole::UIInLevelPauseBattleInfoWidgetController_EShowType _showType; // 0x2D0
		::System::Int32 _battleID; // 0x2D4
