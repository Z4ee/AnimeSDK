...
#define MOLEMOLE_UISUIBIANTEMPLEPRODUCTIONPANELWIDGETCONTROLLER__CHECKGETPRODUCTNEWBIE_D__27_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x62B8D0)
#define MOLEMOLE_UISUIBIANTEMPLEPRODUCTIONPANELWIDGETCONTROLLER__CHECKGETPRODUCTNEWBIE_D__27_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2661E0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleProductionPanelWidgetController__CheckGetProductNewBie_d__27_TypeDefinitionIndex = 77195;
