...
#define MOLEMOLE_UISUIBIANTEMPLEPRODUCTIONPANELWIDGETCONTROLLER__CHECKGETPRODUCTNEWBIE_D__27_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x7C5260)
#define MOLEMOLE_UISUIBIANTEMPLEPRODUCTIONPANELWIDGETCONTROLLER__CHECKGETPRODUCTNEWBIE_D__27_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleProductionPanelWidgetController__CheckGetProductNewBie_d__27_TypeDefinitionIndex = 90727;
	...
	struct alignas(8) UISuibianTempleProductionPanelWidgetController__CheckGetProductNewBie_d__27
	{
		...
		::MoleMole::UISuibianTempleProductionPanelWidgetController* __4__this; // 0x30
