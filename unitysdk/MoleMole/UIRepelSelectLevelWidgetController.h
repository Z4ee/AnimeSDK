...
#define MOLEMOLE_UIREPELSELECTLEVELWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x13763E90)
#define MOLEMOLE_UIREPELSELECTLEVELWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x13763F00)
#define MOLEMOLE_UIREPELSELECTLEVELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x13763FC0)
#define MOLEMOLE_UIREPELSELECTLEVELWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x13764020)

namespace MoleMole
{
	inline static constexpr unsigned int UIRepelSelectLevelWidgetController_TypeDefinitionIndex = 72620;
	...
	public:
		...
		{
			return ((::Class_2_EC28E1D3A39EE7DE_29*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIREPELSELECTLEVELWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
