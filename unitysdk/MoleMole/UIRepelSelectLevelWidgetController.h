...
#define MOLEMOLE_UIREPELSELECTLEVELWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1614D1E0)
#define MOLEMOLE_UIREPELSELECTLEVELWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1614D250)
#define MOLEMOLE_UIREPELSELECTLEVELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1614D310)
#define MOLEMOLE_UIREPELSELECTLEVELWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1614D370)

namespace MoleMole
{
	inline static constexpr unsigned int UIRepelSelectLevelWidgetController_TypeDefinitionIndex = 80161;
