...
#define MOLEMOLE_UISUMMERFISHACCUMULATEITEMCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x157BE0A0)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerFishAccumulateItemContext_TypeDefinitionIndex = 69032;
