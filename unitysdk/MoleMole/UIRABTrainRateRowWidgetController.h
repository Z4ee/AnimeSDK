...
#define MOLEMOLE_UIRABTRAINRATEROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1757F4D0)
#define MOLEMOLE_UIRABTRAINRATEROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1757F540)
#define MOLEMOLE_UIRABTRAINRATEROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1757F5E0)
#define MOLEMOLE_UIRABTRAINRATEROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1757F6A0)
#define MOLEMOLE_UIRABTRAINRATEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1757F890)
#define MOLEMOLE_UIRABTRAINRATEROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1757F8A0)
#define MOLEMOLE_UIRABTRAINRATEROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1757F940)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABTrainRateRowWidgetController_TypeDefinitionIndex = 68593;
