...
#define MOLEMOLE_UIGENERALCLAIMPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x16799D80)
#define MOLEMOLE_UIGENERALCLAIMPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16799D90)
#define MOLEMOLE_UIGENERALCLAIMPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16799E00)
#define MOLEMOLE_UIGENERALCLAIMPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1679A580)
#define MOLEMOLE_UIGENERALCLAIMPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16799EC0)
#define MOLEMOLE_UIGENERALCLAIMPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1679A610)
#define MOLEMOLE_UIGENERALCLAIMPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1679A620)
#define MOLEMOLE_UIGENERALCLAIMPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1679A6C0)
#define MOLEMOLE_UIGENERALCLAIMPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1679A6F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralClaimPopWindowController_TypeDefinitionIndex = 56854;
