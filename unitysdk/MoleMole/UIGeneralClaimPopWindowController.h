...
class Class_2_4B20B18938399FEA;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }

#define MOLEMOLE_UIGENERALCLAIMPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15A186E0)
#define MOLEMOLE_UIGENERALCLAIMPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15A186F0)
#define MOLEMOLE_UIGENERALCLAIMPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15A18760)
#define MOLEMOLE_UIGENERALCLAIMPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x15A18EE0)
#define MOLEMOLE_UIGENERALCLAIMPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15A18820)
#define MOLEMOLE_UIGENERALCLAIMPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15A18F70)
#define MOLEMOLE_UIGENERALCLAIMPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15A18F80)
#define MOLEMOLE_UIGENERALCLAIMPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x15A19020)
#define MOLEMOLE_UIGENERALCLAIMPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15A19050)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralClaimPopWindowController_TypeDefinitionIndex = 39659;
	...
	public:
		...
		::Class_2_4B20B18938399FEA* get__viewModel()
		{
			return ((::Class_2_4B20B18938399FEA*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGENERALCLAIMPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
