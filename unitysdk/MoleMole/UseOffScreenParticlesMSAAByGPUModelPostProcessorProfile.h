...
#define MOLEMOLE_USEOFFSCREENPARTICLESMSAABYGPUMODELPOSTPROCESSORPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x11665300)
#define MOLEMOLE_USEOFFSCREENPARTICLESMSAABYGPUMODELPOSTPROCESSORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x11665370)
#define MOLEMOLE_USEOFFSCREENPARTICLESMSAABYGPUMODELPOSTPROCESSORPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x116653F0)

namespace MoleMole
{
	inline static constexpr unsigned int UseOffScreenParticlesMSAAByGPUModelPostProcessorProfile_TypeDefinitionIndex = 70631;
