...
#define MOLEMOLE_UIACTIVITYNEWPLAYERINFOV2WIDGETCONTROLLER___C__DISPLAYCLASS20_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18A3A8E0)
#define MOLEMOLE_UIACTIVITYNEWPLAYERINFOV2WIDGETCONTROLLER___C__DISPLAYCLASS20_0__UPDATEMISSIONTASKITEM_B__0_OFFSET UNITYSDK_OFFSET(0x18A3A8F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityNewplayerInfoV2WidgetController___c__DisplayClass20_0_TypeDefinitionIndex = 40857;
