...
#define MOLEMOLE_UIACTIVITYNEWPLAYERINFOV2WIDGETCONTROLLER___C__DISPLAYCLASS20_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A614F50)
#define MOLEMOLE_UIACTIVITYNEWPLAYERINFOV2WIDGETCONTROLLER___C__DISPLAYCLASS20_0__UPDATEMISSIONTASKITEM_B__0_OFFSET UNITYSDK_OFFSET(0x1A614F60)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityNewplayerInfoV2WidgetController___c__DisplayClass20_0_TypeDefinitionIndex = 87156;
	...
	public:
		...
		::Class_2_1B9E82423379AC42_Class_1_3008768648A5355A* _view; // 0x18
		::MoleMole::UIActivityNewplayerInfoV2WidgetController* __4__this; // 0x20
