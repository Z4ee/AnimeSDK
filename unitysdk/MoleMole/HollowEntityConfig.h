...
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_ATTACK_OFFSET UNITYSDK_OFFSET(0x19257F00)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_CAMP_OFFSET UNITYSDK_OFFSET(0x19257F60)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_CANBATTLE_OFFSET UNITYSDK_OFFSET(0x19257E80)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_CANBEPUSH_OFFSET UNITYSDK_OFFSET(0x19257DA0)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_CANCOLLIDER_OFFSET UNITYSDK_OFFSET(0x19257DE0)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_CANMAXDEATHTIME_OFFSET UNITYSDK_OFFSET(0x19257FC0)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_CANMOVE_OFFSET UNITYSDK_OFFSET(0x19257CC0)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_CANPUSH_OFFSET UNITYSDK_OFFSET(0x19257D80)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_HP_OFFSET UNITYSDK_OFFSET(0x19257EA0)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x19257E60)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_LAYER_OFFSET UNITYSDK_OFFSET(0x19257E00)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_MAXDEATHTIME_OFFSET UNITYSDK_OFFSET(0x19257FE0)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_MOVESTATENAME_OFFSET UNITYSDK_OFFSET(0x19257CE0)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x19258040)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_RENDERPRIORITY_OFFSET UNITYSDK_OFFSET(0x19258060)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0x19257DC0)
#define MOLEMOLE_HOLLOWENTITYCONFIG_SET_CANBATTLE_OFFSET UNITYSDK_OFFSET(0x19257E90)
#define MOLEMOLE_HOLLOWENTITYCONFIG_SET_CANBEPUSH_OFFSET UNITYSDK_OFFSET(0x19257DB0)
#define MOLEMOLE_HOLLOWENTITYCONFIG_SET_CANCOLLIDER_OFFSET UNITYSDK_OFFSET(0x19257DF0)
#define MOLEMOLE_HOLLOWENTITYCONFIG_SET_CANMAXDEATHTIME_OFFSET UNITYSDK_OFFSET(0x19257FD0)
#define MOLEMOLE_HOLLOWENTITYCONFIG_SET_CANMOVE_OFFSET UNITYSDK_OFFSET(0x19257CD0)
#define MOLEMOLE_HOLLOWENTITYCONFIG_SET_CANPUSH_OFFSET UNITYSDK_OFFSET(0x19257D90)
#define MOLEMOLE_HOLLOWENTITYCONFIG_SET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x19257E70)
#define MOLEMOLE_HOLLOWENTITYCONFIG_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x19258050)
#define MOLEMOLE_HOLLOWENTITYCONFIG_SET_WEIGHT_OFFSET UNITYSDK_OFFSET(0x19257DD0)
#define MOLEMOLE_HOLLOWENTITYCONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0x19258770)
#define MOLEMOLE_HOLLOWENTITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x192580C0)

namespace MoleMole
{
	inline static constexpr unsigned int HollowEntityConfig_TypeDefinitionIndex = 68293;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::Share::GridDir, ::MoleMole::ChessStateMachine::OnceTriggerString*>**)Il2CppClass::FromTypeDefinitionIndex(HollowEntityConfig_TypeDefinitionIndex)->GetStaticField(0x4FDE0);
		}
