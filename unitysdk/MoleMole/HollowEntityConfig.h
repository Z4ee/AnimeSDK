...
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_ATTACK_OFFSET UNITYSDK_OFFSET(0x142918B0)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_CAMP_OFFSET UNITYSDK_OFFSET(0x14291910)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_CANBATTLE_OFFSET UNITYSDK_OFFSET(0x14291830)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_CANBEPUSH_OFFSET UNITYSDK_OFFSET(0x14291750)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_CANCOLLIDER_OFFSET UNITYSDK_OFFSET(0x14291790)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_CANMAXDEATHTIME_OFFSET UNITYSDK_OFFSET(0x14291970)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_CANMOVE_OFFSET UNITYSDK_OFFSET(0x14291670)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_CANPUSH_OFFSET UNITYSDK_OFFSET(0x14291730)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_HP_OFFSET UNITYSDK_OFFSET(0x14291850)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x14291810)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_LAYER_OFFSET UNITYSDK_OFFSET(0x142917B0)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_MAXDEATHTIME_OFFSET UNITYSDK_OFFSET(0x14291990)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_MOVESTATENAME_OFFSET UNITYSDK_OFFSET(0x14291690)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x142919F0)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_RENDERPRIORITY_OFFSET UNITYSDK_OFFSET(0x14291A10)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0x14291770)
#define MOLEMOLE_HOLLOWENTITYCONFIG_SET_CANBATTLE_OFFSET UNITYSDK_OFFSET(0x14291840)
#define MOLEMOLE_HOLLOWENTITYCONFIG_SET_CANBEPUSH_OFFSET UNITYSDK_OFFSET(0x14291760)
#define MOLEMOLE_HOLLOWENTITYCONFIG_SET_CANCOLLIDER_OFFSET UNITYSDK_OFFSET(0x142917A0)
#define MOLEMOLE_HOLLOWENTITYCONFIG_SET_CANMAXDEATHTIME_OFFSET UNITYSDK_OFFSET(0x14291980)
#define MOLEMOLE_HOLLOWENTITYCONFIG_SET_CANMOVE_OFFSET UNITYSDK_OFFSET(0x14291680)
#define MOLEMOLE_HOLLOWENTITYCONFIG_SET_CANPUSH_OFFSET UNITYSDK_OFFSET(0x14291740)
#define MOLEMOLE_HOLLOWENTITYCONFIG_SET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x14291820)
#define MOLEMOLE_HOLLOWENTITYCONFIG_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x14291A00)
#define MOLEMOLE_HOLLOWENTITYCONFIG_SET_WEIGHT_OFFSET UNITYSDK_OFFSET(0x14291780)
#define MOLEMOLE_HOLLOWENTITYCONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0x14292120)
#define MOLEMOLE_HOLLOWENTITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x14291A70)

namespace MoleMole
{
	inline static constexpr unsigned int HollowEntityConfig_TypeDefinitionIndex = 40467;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::Share::GridDir, ::MoleMole::ChessStateMachine::OnceTriggerString*>**)Il2CppClass::FromTypeDefinitionIndex(HollowEntityConfig_TypeDefinitionIndex)->GetStaticField(0x45BC0);
		}
