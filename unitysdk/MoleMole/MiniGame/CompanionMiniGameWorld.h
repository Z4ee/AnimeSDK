...
#define MOLEMOLE_MINIGAME_COMPANIONMINIGAMEWORLD_GETMINIGAMELOGIC_OFFSET UNITYSDK_OFFSET(0x161F6E00)
#define MOLEMOLE_MINIGAME_COMPANIONMINIGAMEWORLD_GETPREFABPATH_OFFSET UNITYSDK_OFFSET(0x161F6D90)
#define MOLEMOLE_MINIGAME_COMPANIONMINIGAMEWORLD_GETRTNAME_OFFSET UNITYSDK_OFFSET(0x161F6CE0)
#define MOLEMOLE_MINIGAME_COMPANIONMINIGAMEWORLD_ONENTER_OFFSET UNITYSDK_OFFSET(0x161F7080)
#define MOLEMOLE_MINIGAME_COMPANIONMINIGAMEWORLD_ONEXIT_OFFSET UNITYSDK_OFFSET(0x161F7270)
#define MOLEMOLE_MINIGAME_COMPANIONMINIGAMEWORLD_RTUSEALPHA_OFFSET UNITYSDK_OFFSET(0x161F6D50)
#define MOLEMOLE_MINIGAME_COMPANIONMINIGAMEWORLD_SHOWROOTPAGEUI_OFFSET UNITYSDK_OFFSET(0x161F6E90)
#define MOLEMOLE_MINIGAME_COMPANIONMINIGAMEWORLD__CTOR_OFFSET UNITYSDK_OFFSET(0x161F7540)
#define MOLEMOLE_MINIGAME_COMPANIONMINIGAMEWORLD___BASE_ONENTER_OFFSET UNITYSDK_OFFSET(0x161F7590)
#define MOLEMOLE_MINIGAME_COMPANIONMINIGAMEWORLD___BASE_ONEXIT_OFFSET UNITYSDK_OFFSET(0x161F75A0)

namespace MoleMole::MiniGame
{
	inline static constexpr unsigned int CompanionMiniGameWorld_TypeDefinitionIndex = 56440;
	...
	public:
		...
		{
			return ((::Class_0_16E4307DCC419505_391*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MINIGAME_COMPANIONMINIGAMEWORLD_GETMINIGAMELOGIC_OFFSET))(this);
		}
