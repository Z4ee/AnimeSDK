...
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST_CONVERTLOGICPOSTOGLOBALLAYOUTPOS_OFFSET UNITYSDK_OFFSET(0x170DC8F0)
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST_CONVERTLOGICPOSTOLAYOUTPOS_1_OFFSET UNITYSDK_OFFSET(0x170DC740)
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST_CONVERTLOGICPOSTOLAYOUTPOS_2_OFFSET UNITYSDK_OFFSET(0x170DC810)
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST_CONVERTLOGICPOSTOLAYOUTPOS_OFFSET UNITYSDK_OFFSET(0x170DC660)
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST_GETGAMEROOT_OFFSET UNITYSDK_OFFSET(0x170DCA50)
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST_GET_LEFTDOWNGLOBALPOS_OFFSET UNITYSDK_OFFSET(0x170DCB30)
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST_GET_LEFTDOWNPOS_OFFSET UNITYSDK_OFFSET(0x170DCA90)
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST_GET_RIGHTUPGLOBALPOS_OFFSET UNITYSDK_OFFSET(0x170DCB80)
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST_GET_RIGHTUPPOS_OFFSET UNITYSDK_OFFSET(0x170DCAE0)
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST__CTOR_OFFSET UNITYSDK_OFFSET(0x170DCBD0)

namespace MoleMole::MiniGame
{
	inline static constexpr unsigned int MiniGameManifest_TypeDefinitionIndex = 53975;
