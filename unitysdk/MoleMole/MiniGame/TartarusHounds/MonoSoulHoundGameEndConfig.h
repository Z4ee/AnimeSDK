...
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOSOULHOUNDGAMEENDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x161F7640)

namespace MoleMole::MiniGame::TartarusHounds
{
	inline static constexpr unsigned int MonoSoulHoundGameEndConfig_TypeDefinitionIndex = 57830;
