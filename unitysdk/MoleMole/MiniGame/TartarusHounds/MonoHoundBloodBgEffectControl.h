...
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDBLOODBGEFFECTCONTROL_AWAKE_OFFSET UNITYSDK_OFFSET(0x13028ED0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDBLOODBGEFFECTCONTROL_FADETRAILANIMCO_OFFSET UNITYSDK_OFFSET(0x13029F40)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDBLOODBGEFFECTCONTROL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x13029FD0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDBLOODBGEFFECTCONTROL_PARAMCHECK_OFFSET UNITYSDK_OFFSET(0x13028F90)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDBLOODBGEFFECTCONTROL_RESETTOSTART_OFFSET UNITYSDK_OFFSET(0x13029480)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDBLOODBGEFFECTCONTROL_SETGEAR_OFFSET UNITYSDK_OFFSET(0x13029970)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDBLOODBGEFFECTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1302A0A0)

namespace MoleMole::MiniGame::TartarusHounds
{
	inline static constexpr unsigned int MonoHoundBloodBgEffectControl_TypeDefinitionIndex = 68289;
