...
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDBLOODBGEFFECTCONTROL_AWAKE_OFFSET UNITYSDK_OFFSET(0x17381E30)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDBLOODBGEFFECTCONTROL_FADETRAILANIMCO_OFFSET UNITYSDK_OFFSET(0x17382E10)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDBLOODBGEFFECTCONTROL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17382EA0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDBLOODBGEFFECTCONTROL_PARAMCHECK_OFFSET UNITYSDK_OFFSET(0x17381EF0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDBLOODBGEFFECTCONTROL_RESETTOSTART_OFFSET UNITYSDK_OFFSET(0x17382340)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDBLOODBGEFFECTCONTROL_SETGEAR_OFFSET UNITYSDK_OFFSET(0x17382830)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDBLOODBGEFFECTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x17382F70)

namespace MoleMole::MiniGame::TartarusHounds
{
	inline static constexpr unsigned int MonoHoundBloodBgEffectControl_TypeDefinitionIndex = 54290;
