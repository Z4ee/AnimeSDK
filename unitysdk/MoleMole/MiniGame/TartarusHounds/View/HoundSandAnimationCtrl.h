...
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL_AWAKE_OFFSET UNITYSDK_OFFSET(0x136D0BA0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL_INITSANDANIMATION_OFFSET UNITYSDK_OFFSET(0x136D0D90)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x136D1920)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x136D1790)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x136D13B0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL_RESET_OFFSET UNITYSDK_OFFSET(0x136D1800)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL_TICKANIMATION_OFFSET UNITYSDK_OFFSET(0x136D1490)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL_TICKSAND_OFFSET UNITYSDK_OFFSET(0x136D1100)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL_UPDATE_OFFSET UNITYSDK_OFFSET(0x136D1420)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL__CTOR_OFFSET UNITYSDK_OFFSET(0x136D1980)

namespace MoleMole::MiniGame::TartarusHounds::View
{
	inline static constexpr unsigned int HoundSandAnimationCtrl_TypeDefinitionIndex = 86226;
