...
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_PLAYEREXTRASHEETCONFIGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19DCE170)

namespace MoleMole::MiniGame::TartarusHounds::View
{
	inline static constexpr unsigned int PlayerExtraSheetConfigData_TypeDefinitionIndex = 43821;
