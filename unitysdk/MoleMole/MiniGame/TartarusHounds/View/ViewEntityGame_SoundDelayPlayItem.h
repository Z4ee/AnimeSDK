...
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_SOUNDDELAYPLAYITEM_TICK_OFFSET UNITYSDK_OFFSET(0x16E65BC0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_SOUNDDELAYPLAYITEM_TIMEOUT_OFFSET UNITYSDK_OFFSET(0x16E65A20)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_SOUNDDELAYPLAYITEM_TRIGGERSOUND_OFFSET UNITYSDK_OFFSET(0x16E65A70)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_SOUNDDELAYPLAYITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x16E65C20)

namespace MoleMole::MiniGame::TartarusHounds::View
{
	inline static constexpr unsigned int ViewEntityGame_SoundDelayPlayItem_TypeDefinitionIndex = 51163;
