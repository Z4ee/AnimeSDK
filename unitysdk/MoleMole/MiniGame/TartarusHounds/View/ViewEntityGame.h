...
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_AWAKE_OFFSET UNITYSDK_OFFSET(0x1383FE00)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_CACHEORCREATEBLOCK_OFFSET UNITYSDK_OFFSET(0x1383DE70)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_CACHEORCREATESANDBLOCK_OFFSET UNITYSDK_OFFSET(0x1383E890)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_CHECKANDPUTBESTSCORELINE_OFFSET UNITYSDK_OFFSET(0x1384A050)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_CHECKPASSBESTSCORELINE_OFFSET UNITYSDK_OFFSET(0x1384BBF0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_COLLECTBLOCKASSET_OFFSET UNITYSDK_OFFSET(0x13842A50)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_COLLECTCURRENTPAGE_OFFSET UNITYSDK_OFFSET(0x138425D0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_COLLECTSANDASSET_OFFSET UNITYSDK_OFFSET(0x13842B50)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_COUNTCURRENTLEVELHPPROPITEM_OFFSET UNITYSDK_OFFSET(0x13849BB0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_CREATEWOOLBLOCK_OFFSET UNITYSDK_OFFSET(0x1384A3B0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_DEALGAMESTARTINIT_OFFSET UNITYSDK_OFFSET(0x138461B0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_DESTROYSAND_OFFSET UNITYSDK_OFFSET(0x138415B0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_DOUPDATE_OFFSET UNITYSDK_OFFSET(0x138440F0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_EDITORINIT_OFFSET UNITYSDK_OFFSET(0x1383ED50)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ENTERNEWLEVEL_OFFSET UNITYSDK_OFFSET(0x13846230)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_FADEINSANDBACKGROUND_OFFSET UNITYSDK_OFFSET(0x13840F30)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_FADEOUTSANDBACKGROUND_OFFSET UNITYSDK_OFFSET(0x13840EF0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_FINISHSWITCHLEVEL_OFFSET UNITYSDK_OFFSET(0x13849DD0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x13844070)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_GAMEDURATION_OFFSET UNITYSDK_OFFSET(0x1384BFB0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_GENERATELEVELGAPBLOCKS_OFFSET UNITYSDK_OFFSET(0x1383E100)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_GENERATENEXTLEVEL_OFFSET UNITYSDK_OFFSET(0x13849210)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_GENERATEPVPSCENE_OFFSET UNITYSDK_OFFSET(0x1383E630)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_GENERATEVIEWBLOCKS_OFFSET UNITYSDK_OFFSET(0x1383D680)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_GETDESTROYBLOCKROWSOUNDBYROWITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x1384B070)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_GETGRIDPOS_OFFSET UNITYSDK_OFFSET(0x1384C070)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_GETGRIDSTARTPOSITION_OFFSET UNITYSDK_OFFSET(0x1384C000)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_GETPVPREALTIMERANK_OFFSET UNITYSDK_OFFSET(0x13843290)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_GETPVPROOTY_OFFSET UNITYSDK_OFFSET(0x1383EA90)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_GETPVPSERVERREMAINTIME_OFFSET UNITYSDK_OFFSET(0x138429A0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_GOTOGAMEEND_OFFSET UNITYSDK_OFFSET(0x13841A60)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_HIDEPLAYER_OFFSET UNITYSDK_OFFSET(0x138401A0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_HIDEPVPSCENE_OFFSET UNITYSDK_OFFSET(0x1383EBC0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_HIDESANDBACKGROUND_OFFSET UNITYSDK_OFFSET(0x13840340)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_HOUNDVIEWGAMEINIT_OFFSET UNITYSDK_OFFSET(0x138403B0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_INITANIMATIONDATA_OFFSET UNITYSDK_OFFSET(0x1383F260)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_INITANIMATIONSTATEINFO_OFFSET UNITYSDK_OFFSET(0x1383F2B0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_INITBLOCKCACHEROOT_OFFSET UNITYSDK_OFFSET(0x1383FF10)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_INITMISC_OFFSET UNITYSDK_OFFSET(0x1383ED90)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_INITMULTIPLAYERS_OFFSET UNITYSDK_OFFSET(0x13840C50)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_INITPLAYER_OFFSET UNITYSDK_OFFSET(0x13840B10)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_INITWWISELISTENER_OFFSET UNITYSDK_OFFSET(0x13843F10)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ISGAMEEND_OFFSET UNITYSDK_OFFSET(0x13841D60)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ISOUTOFSCREEN_OFFSET UNITYSDK_OFFSET(0x1384B5B0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_LEAVEGAME_OFFSET UNITYSDK_OFFSET(0x138429F0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_LEVELDURATION_OFFSET UNITYSDK_OFFSET(0x1384BF60)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x13845B80)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ONEVENT_OFFSET UNITYSDK_OFFSET(0x13846580)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ONGAMEEND_OFFSET UNITYSDK_OFFSET(0x13841890)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ONGAMESTART_OFFSET UNITYSDK_OFFSET(0x13846380)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ONPARRYCHANGECOLORSTART_OFFSET UNITYSDK_OFFSET(0x138458B0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ONPARRYFINISH_OFFSET UNITYSDK_OFFSET(0x13842C80)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ONPOSTUPDATE_OFFSET UNITYSDK_OFFSET(0x13845410)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ONPVPGAMEFINISH_OFFSET UNITYSDK_OFFSET(0x13841420)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ONPVPGAMESTART_OFFSET UNITYSDK_OFFSET(0x13846480)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ONRECVGAMEEND_OFFSET UNITYSDK_OFFSET(0x13841DB0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ONRECVSELFFINISHPVPGAME_OFFSET UNITYSDK_OFFSET(0x13841760)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ONRECVWORLDINITSC_OFFSET UNITYSDK_OFFSET(0x13842930)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ONSCOREADDLIFE_OFFSET UNITYSDK_OFFSET(0x1384AEA0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ONVIEWUPDATE_OFFSET UNITYSDK_OFFSET(0x138442A0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_PASSLEVELBLOCKPERFORM_OFFSET UNITYSDK_OFFSET(0x138495D0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_PAUSE_OFFSET UNITYSDK_OFFSET(0x1384B7A0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_PLAYCOLORBLOCKGROUPDESTROYSOUND_OFFSET UNITYSDK_OFFSET(0x1384A880)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_PLAYERLOWHPSTATE_OFFSET UNITYSDK_OFFSET(0x13843320)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_PLAYPLAYERBACKGROUPANIMATION_OFFSET UNITYSDK_OFFSET(0x13843BC0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_PLAYPLAYERLOWHPANIMATION_OFFSET UNITYSDK_OFFSET(0x138437E0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_PULLPLAYERUP_OFFSET UNITYSDK_OFFSET(0x1384B430)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_REALSHOWGAMEEND_OFFSET UNITYSDK_OFFSET(0x13842270)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_RECORDLASTBESTSCORE_OFFSET UNITYSDK_OFFSET(0x1384BF10)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_RECORDSPEEDUPFALL_OFFSET UNITYSDK_OFFSET(0x1384B190)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_REMOVEGRIDEPAGE_OFFSET UNITYSDK_OFFSET(0x1384B260)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_RESETCAMERAWITHYOFFSET_OFFSET UNITYSDK_OFFSET(0x13846060)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_RESETGAMEORINIT_OFFSET UNITYSDK_OFFSET(0x13840F80)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_RESETGAMERECORDMODULEANDTIME_OFFSET UNITYSDK_OFFSET(0x13841330)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_RESETPARAM_OFFSET UNITYSDK_OFFSET(0x13841290)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_SETARCADEGAMEID_OFFSET UNITYSDK_OFFSET(0x1384B140)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_SETARCADELOGIC_OFFSET UNITYSDK_OFFSET(0x1384B210)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_SETCAMSHAKE_OFFSET UNITYSDK_OFFSET(0x13846130)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_SETDAMPING_OFFSET UNITYSDK_OFFSET(0x13845D10)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_SETGRIDEPAGESHOWSTATE_OFFSET UNITYSDK_OFFSET(0x138427E0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_SHOWADDLIFEEFFECT_OFFSET UNITYSDK_OFFSET(0x1384B890)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_SHOWPLAYER_OFFSET UNITYSDK_OFFSET(0x13840D50)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_SHOWSANDBACKGROUND_OFFSET UNITYSDK_OFFSET(0x13840CF0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_STARTCHECKALLPLAYERENTERPVPSCENEBOTTOM_OFFSET UNITYSDK_OFFSET(0x13842190)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_STOPADDLIFEEFFECT_OFFSET UNITYSDK_OFFSET(0x1384BA40)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_STOPHISTORYBESTLINE_OFFSET UNITYSDK_OFFSET(0x138423E0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_STOPPLAYERBACKGROUNDANIMATION_OFFSET UNITYSDK_OFFSET(0x13843D80)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_STOPPLAYERLOWHPANIMATION_OFFSET UNITYSDK_OFFSET(0x138439C0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_SWITCHNOISECAM_OFFSET UNITYSDK_OFFSET(0x13845DA0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_SWITCHTONEWLEVEL_OFFSET UNITYSDK_OFFSET(0x13848AF0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_TICKDELAYACTION_OFFSET UNITYSDK_OFFSET(0x13845810)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_TICKHISTORYBESTLINE_OFFSET UNITYSDK_OFFSET(0x13845120)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_TICKLOWHPSTATEANDCHECK_OFFSET UNITYSDK_OFFSET(0x13843410)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_TICKPARRY_OFFSET UNITYSDK_OFFSET(0x138452A0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_TICKSELFREACHBOTTOM_OFFSET UNITYSDK_OFFSET(0x13842DB0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_TICKSOUND_OFFSET UNITYSDK_OFFSET(0x13844C80)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_TICKWAITPVPREACHBOTTOMANDFINISHGAME_OFFSET UNITYSDK_OFFSET(0x13842F20)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_TRYSENDGAMEFINISHTOBATTLESERVER_OFFSET UNITYSDK_OFFSET(0x13841550)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_UNPAUSE_OFFSET UNITYSDK_OFFSET(0x1384B800)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_UPDATECAMERA_OFFSET UNITYSDK_OFFSET(0x13844900)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_UPDATECAMSHAKE_OFFSET UNITYSDK_OFFSET(0x13844BF0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_UPDATESOUNDPARAM_OFFSET UNITYSDK_OFFSET(0x13844EC0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_UPDATE_OFFSET UNITYSDK_OFFSET(0x138457C0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1384C260)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME__ONEVENT_B__164_0_OFFSET UNITYSDK_OFFSET(0x1384C7A0)

namespace MoleMole::MiniGame::TartarusHounds::View
{
	inline static constexpr unsigned int ViewEntityGame_TypeDefinitionIndex = 51162;
	...
	public:
		...
		::System::Void PlayColorBlockGroupDestroySound(::Class_1_61AF8621E96999C8* group, ::Class_1_D64959CBBD533335_1* param)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_61AF8621E96999C8*, ::Class_1_D64959CBBD533335_1*))((::PBYTE)hIl2Cpp + MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_PLAYCOLORBLOCKGROUPDESTROYSOUND_OFFSET))(this, group, param);
		}
