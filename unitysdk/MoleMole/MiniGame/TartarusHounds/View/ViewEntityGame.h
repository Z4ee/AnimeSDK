...
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_AWAKE_OFFSET UNITYSDK_OFFSET(0x16CB7BF0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_CACHEORCREATEBLOCK_OFFSET UNITYSDK_OFFSET(0x16CB5C70)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_CACHEORCREATESANDBLOCK_OFFSET UNITYSDK_OFFSET(0x16CB6690)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_CHECKANDPUTBESTSCORELINE_OFFSET UNITYSDK_OFFSET(0x16CC1DE0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_CHECKPASSBESTSCORELINE_OFFSET UNITYSDK_OFFSET(0x16CC3970)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_COLLECTBLOCKASSET_OFFSET UNITYSDK_OFFSET(0x16CBA830)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_COLLECTCURRENTPAGE_OFFSET UNITYSDK_OFFSET(0x16CBA3C0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_COLLECTSANDASSET_OFFSET UNITYSDK_OFFSET(0x16CBA930)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_COUNTCURRENTLEVELHPPROPITEM_OFFSET UNITYSDK_OFFSET(0x16CC1940)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_CREATEWOOLBLOCK_OFFSET UNITYSDK_OFFSET(0x16CC2140)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_DEALGAMESTARTINIT_OFFSET UNITYSDK_OFFSET(0x16CBDF80)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_DESTROYSAND_OFFSET UNITYSDK_OFFSET(0x16CB93B0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_DOUPDATE_OFFSET UNITYSDK_OFFSET(0x16CBBEC0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_EDITORINIT_OFFSET UNITYSDK_OFFSET(0x16CB6B50)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ENTERNEWLEVEL_OFFSET UNITYSDK_OFFSET(0x16CBE000)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_FADEINSANDBACKGROUND_OFFSET UNITYSDK_OFFSET(0x16CB8D30)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_FADEOUTSANDBACKGROUND_OFFSET UNITYSDK_OFFSET(0x16CB8CF0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_FINISHSWITCHLEVEL_OFFSET UNITYSDK_OFFSET(0x16CC1B60)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x16CBBE40)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_GAMEDURATION_OFFSET UNITYSDK_OFFSET(0x16CC3D30)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_GENERATELEVELGAPBLOCKS_OFFSET UNITYSDK_OFFSET(0x16CB5F00)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_GENERATENEXTLEVEL_OFFSET UNITYSDK_OFFSET(0x16CC0FA0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_GENERATEPVPSCENE_OFFSET UNITYSDK_OFFSET(0x16CB6430)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_GENERATEVIEWBLOCKS_OFFSET UNITYSDK_OFFSET(0x16CB5480)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_GETDESTROYBLOCKROWSOUNDBYROWITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x16CC2E00)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_GETGRIDPOS_OFFSET UNITYSDK_OFFSET(0x16CC3DF0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_GETGRIDSTARTPOSITION_OFFSET UNITYSDK_OFFSET(0x16CC3D80)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_GETPVPREALTIMERANK_OFFSET UNITYSDK_OFFSET(0x16CBB060)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_GETPVPROOTY_OFFSET UNITYSDK_OFFSET(0x16CB6890)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_GETPVPSERVERREMAINTIME_OFFSET UNITYSDK_OFFSET(0x16CBA780)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_GOTOGAMEEND_OFFSET UNITYSDK_OFFSET(0x16CB9850)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_HIDEPLAYER_OFFSET UNITYSDK_OFFSET(0x16CB7F90)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_HIDEPVPSCENE_OFFSET UNITYSDK_OFFSET(0x16CB69C0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_HIDESANDBACKGROUND_OFFSET UNITYSDK_OFFSET(0x16CB8130)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_HOUNDVIEWGAMEINIT_OFFSET UNITYSDK_OFFSET(0x16CB81A0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_INITANIMATIONDATA_OFFSET UNITYSDK_OFFSET(0x16CB7060)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_INITANIMATIONSTATEINFO_OFFSET UNITYSDK_OFFSET(0x16CB70B0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_INITBLOCKCACHEROOT_OFFSET UNITYSDK_OFFSET(0x16CB7D00)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_INITMISC_OFFSET UNITYSDK_OFFSET(0x16CB6B90)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_INITMULTIPLAYERS_OFFSET UNITYSDK_OFFSET(0x16CB8A50)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_INITPLAYER_OFFSET UNITYSDK_OFFSET(0x16CB8910)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_INITWWISELISTENER_OFFSET UNITYSDK_OFFSET(0x16CBBCE0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ISGAMEEND_OFFSET UNITYSDK_OFFSET(0x16CB9B50)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ISOUTOFSCREEN_OFFSET UNITYSDK_OFFSET(0x16CC3340)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_LEAVEGAME_OFFSET UNITYSDK_OFFSET(0x16CBA7D0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_LEVELDURATION_OFFSET UNITYSDK_OFFSET(0x16CC3CE0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x16CBD950)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ONEVENT_OFFSET UNITYSDK_OFFSET(0x16CBE350)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ONGAMEEND_OFFSET UNITYSDK_OFFSET(0x16CB9680)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ONGAMESTART_OFFSET UNITYSDK_OFFSET(0x16CBE150)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ONPARRYCHANGECOLORSTART_OFFSET UNITYSDK_OFFSET(0x16CBD680)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ONPARRYFINISH_OFFSET UNITYSDK_OFFSET(0x16CBAA60)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ONPOSTUPDATE_OFFSET UNITYSDK_OFFSET(0x16CBD1E0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ONPVPGAMEFINISH_OFFSET UNITYSDK_OFFSET(0x16CB9220)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ONPVPGAMESTART_OFFSET UNITYSDK_OFFSET(0x16CBE250)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ONRECVGAMEEND_OFFSET UNITYSDK_OFFSET(0x16CB9BA0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ONRECVSELFFINISHPVPGAME_OFFSET UNITYSDK_OFFSET(0x16CB9560)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ONRECVWORLDINITSC_OFFSET UNITYSDK_OFFSET(0x16CBA710)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ONSCOREADDLIFE_OFFSET UNITYSDK_OFFSET(0x16CC2C30)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_ONVIEWUPDATE_OFFSET UNITYSDK_OFFSET(0x16CBC070)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_PASSLEVELBLOCKPERFORM_OFFSET UNITYSDK_OFFSET(0x16CC1370)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_PAUSE_OFFSET UNITYSDK_OFFSET(0x16CC3520)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_PLAYCOLORBLOCKGROUPDESTROYSOUND_OFFSET UNITYSDK_OFFSET(0x16CC2610)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_PLAYERLOWHPSTATE_OFFSET UNITYSDK_OFFSET(0x16CBB0F0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_PLAYPLAYERBACKGROUPANIMATION_OFFSET UNITYSDK_OFFSET(0x16CBB990)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_PLAYPLAYERLOWHPANIMATION_OFFSET UNITYSDK_OFFSET(0x16CBB5B0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_PULLPLAYERUP_OFFSET UNITYSDK_OFFSET(0x16CC31C0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_REALSHOWGAMEEND_OFFSET UNITYSDK_OFFSET(0x16CBA060)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_RECORDLASTBESTSCORE_OFFSET UNITYSDK_OFFSET(0x16CC3C90)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_RECORDSPEEDUPFALL_OFFSET UNITYSDK_OFFSET(0x16CC2F20)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_REMOVEGRIDEPAGE_OFFSET UNITYSDK_OFFSET(0x16CC2FF0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_RESETCAMERAWITHYOFFSET_OFFSET UNITYSDK_OFFSET(0x16CBDE30)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_RESETGAMEORINIT_OFFSET UNITYSDK_OFFSET(0x16CB8D80)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_RESETGAMERECORDMODULEANDTIME_OFFSET UNITYSDK_OFFSET(0x16CB9130)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_RESETPARAM_OFFSET UNITYSDK_OFFSET(0x16CB9090)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_SETARCADEGAMEID_OFFSET UNITYSDK_OFFSET(0x16CC2ED0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_SETARCADELOGIC_OFFSET UNITYSDK_OFFSET(0x16CC2FA0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_SETCAMSHAKE_OFFSET UNITYSDK_OFFSET(0x16CBDF00)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_SETDAMPING_OFFSET UNITYSDK_OFFSET(0x16CBDAE0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_SETGRIDEPAGESHOWSTATE_OFFSET UNITYSDK_OFFSET(0x16CBA5C0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_SHOWADDLIFEEFFECT_OFFSET UNITYSDK_OFFSET(0x16CC3610)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_SHOWPLAYER_OFFSET UNITYSDK_OFFSET(0x16CB8B50)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_SHOWSANDBACKGROUND_OFFSET UNITYSDK_OFFSET(0x16CB8AF0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_STARTCHECKALLPLAYERENTERPVPSCENEBOTTOM_OFFSET UNITYSDK_OFFSET(0x16CB9F80)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_STOPADDLIFEEFFECT_OFFSET UNITYSDK_OFFSET(0x16CC37C0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_STOPHISTORYBESTLINE_OFFSET UNITYSDK_OFFSET(0x16CBA1D0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_STOPPLAYERBACKGROUNDANIMATION_OFFSET UNITYSDK_OFFSET(0x16CBBB50)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_STOPPLAYERLOWHPANIMATION_OFFSET UNITYSDK_OFFSET(0x16CBB790)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_SWITCHNOISECAM_OFFSET UNITYSDK_OFFSET(0x16CBDB70)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_SWITCHTONEWLEVEL_OFFSET UNITYSDK_OFFSET(0x16CC08A0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_TICKDELAYACTION_OFFSET UNITYSDK_OFFSET(0x16CBD5E0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_TICKHISTORYBESTLINE_OFFSET UNITYSDK_OFFSET(0x16CBCEF0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_TICKLOWHPSTATEANDCHECK_OFFSET UNITYSDK_OFFSET(0x16CBB1E0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_TICKPARRY_OFFSET UNITYSDK_OFFSET(0x16CBD070)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_TICKSELFREACHBOTTOM_OFFSET UNITYSDK_OFFSET(0x16CBAB90)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_TICKSOUND_OFFSET UNITYSDK_OFFSET(0x16CBCA50)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_TICKWAITPVPREACHBOTTOMANDFINISHGAME_OFFSET UNITYSDK_OFFSET(0x16CBAD00)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_TRYSENDGAMEFINISHTOBATTLESERVER_OFFSET UNITYSDK_OFFSET(0x16CB9350)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_UNPAUSE_OFFSET UNITYSDK_OFFSET(0x16CC3580)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_UPDATECAMERA_OFFSET UNITYSDK_OFFSET(0x16CBC6D0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_UPDATECAMSHAKE_OFFSET UNITYSDK_OFFSET(0x16CBC9C0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_UPDATESOUNDPARAM_OFFSET UNITYSDK_OFFSET(0x16CBCC90)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_UPDATE_OFFSET UNITYSDK_OFFSET(0x16CBD590)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x16CC3FE0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME__ONEVENT_B__164_0_OFFSET UNITYSDK_OFFSET(0x16CC4510)

namespace MoleMole::MiniGame::TartarusHounds::View
{
	inline static constexpr unsigned int ViewEntityGame_TypeDefinitionIndex = 74710;
