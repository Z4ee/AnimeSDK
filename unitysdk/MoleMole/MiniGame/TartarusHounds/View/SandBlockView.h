...
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_AWAKE_OFFSET UNITYSDK_OFFSET(0x10E2AB70)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_GET_CANBERECYCLE_OFFSET UNITYSDK_OFFSET(0x10E2B810)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_GET_SELFGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x10E2B660)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_GET_SELFTRANSFORM_OFFSET UNITYSDK_OFFSET(0x10E2B4F0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_INITSHEETANIM_OFFSET UNITYSDK_OFFSET(0x10E2AC10)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_METHOD_5_0581090195E9C81F_OFFSET UNITYSDK_OFFSET(0x10E2B870)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_METHOD_5_8FAD57395F26ACC4_OFFSET UNITYSDK_OFFSET(0x10E2B100)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x10E2AF50)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_PLAYDESTROYINGANIMATION_OFFSET UNITYSDK_OFFSET(0x10E2B210)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_PLAYIDLEANIMATION_OFFSET UNITYSDK_OFFSET(0x10E2B190)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_REFRESHSANVIEWANIMATION_OFFSET UNITYSDK_OFFSET(0x10E2B3C0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_RESET_OFFSET UNITYSDK_OFFSET(0x10E2B7D0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_SETSANDSTYLE_OFFSET UNITYSDK_OFFSET(0x10E2B370)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_SETSORTINGORDERINDEX_OFFSET UNITYSDK_OFFSET(0x10E2B490)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_SETSTATUS_OFFSET UNITYSDK_OFFSET(0x10E2B320)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x10E2B820)

namespace MoleMole::MiniGame::TartarusHounds::View
{
	inline static constexpr unsigned int SandBlockView_TypeDefinitionIndex = 65446;
