...
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ATTACHCOMP_OFFSET UNITYSDK_OFFSET(0x144DE4E0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ATTACH_OFFSET UNITYSDK_OFFSET(0x144DE440)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_BASETICK_OFFSET UNITYSDK_OFFSET(0x144E0ED0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_BLINKADDLIFE_OFFSET UNITYSDK_OFFSET(0x144E25C0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_CHANGETOLIST_OFFSET UNITYSDK_OFFSET(0x144DF470)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_CHECKBUFFCHANGE_OFFSET UNITYSDK_OFFSET(0x144E0980)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_CHECKPROPERTYCHANGE_OFFSET UNITYSDK_OFFSET(0x144E0400)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_CLEARPLAYERBLINK_OFFSET UNITYSDK_OFFSET(0x144DE2C0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_CLEARSTATE_OFFSET UNITYSDK_OFFSET(0x144DF580)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_CLOSESHADOW_OFFSET UNITYSDK_OFFSET(0x144DEE30)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_CLOSEWOOLBLINK_OFFSET UNITYSDK_OFFSET(0x144E2370)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_DEALAFTERATTACK_OFFSET UNITYSDK_OFFSET(0x144E1930)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_DOINIT_OFFSET UNITYSDK_OFFSET(0x144DD8B0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_GET_ISPLAYATTACKING_OFFSET UNITYSDK_OFFSET(0x144DF420)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_HANDLERLOWHPANIMATION_OFFSET UNITYSDK_OFFSET(0x144E2560)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_INITSHEETANIM_OFFSET UNITYSDK_OFFSET(0x144DE570)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ONATTACKFINISHED_OFFSET UNITYSDK_OFFSET(0x144E1D10)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ONCHANGE_OFFSET UNITYSDK_OFFSET(0x144E1F20)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ONFAKEJUMPFINISHED_OFFSET UNITYSDK_OFFSET(0x144E1D90)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ONFALLLANDINGFINISHED_OFFSET UNITYSDK_OFFSET(0x144E1EA0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ONFALLSLIPFINISHED_OFFSET UNITYSDK_OFFSET(0x144E1E10)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ONRESET_OFFSET UNITYSDK_OFFSET(0x144DE270)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ONTEXSHEETANIMEND_OFFSET UNITYSDK_OFFSET(0x144DEE90)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ONTIMESCALECHANGE_OFFSET UNITYSDK_OFFSET(0x144E2680)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x144DF8A0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_OPENSHADOW_OFFSET UNITYSDK_OFFSET(0x144DEDC0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_PLAYANIMSTATE_1_OFFSET UNITYSDK_OFFSET(0x144DEA30)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_PLAYANIMSTATE_OFFSET UNITYSDK_OFFSET(0x144DF030)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_PLAYANIM_OFFSET UNITYSDK_OFFSET(0x144DF0A0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_PLAYBASICMOVE_OFFSET UNITYSDK_OFFSET(0x144E0C30)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_PLAYCURRENTSHEET_OFFSET UNITYSDK_OFFSET(0x144DEF20)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_PLAYPLAYERBLINK_OFFSET UNITYSDK_OFFSET(0x144E1340)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_PLAYSOUND_OFFSET UNITYSDK_OFFSET(0x144DF2D0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_SETBLINKPARAMBYINDEX_OFFSET UNITYSDK_OFFSET(0x144E23C0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_SETVIEWENTITYGAME_OFFSET UNITYSDK_OFFSET(0x144DE3C0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_SHOULDPLAYFALL_OFFSET UNITYSDK_OFFSET(0x144E1C80)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_SIMULATEPVPSWITCHPOS_OFFSET UNITYSDK_OFFSET(0x144DF5D0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_STOPPLAYERBLINK_OFFSET UNITYSDK_OFFSET(0x144E1580)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_SYNCTIMESCALEWITHSPEED_OFFSET UNITYSDK_OFFSET(0x144DE0F0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_TICKTIMESCALECHANGE_OFFSET UNITYSDK_OFFSET(0x144E0380)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_TRIGGERSTRUGGLE_OFFSET UNITYSDK_OFFSET(0x144E2620)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_TRYPLAYREADYSTOPINVINCIBLE_OFFSET UNITYSDK_OFFSET(0x144E22C0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_UPDATECLIMBSTATUS_OFFSET UNITYSDK_OFFSET(0x144E1A80)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_UPDATEDIVINGSHADOWSTATUS_OFFSET UNITYSDK_OFFSET(0x144E1810)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_UPDATEDYINGANIM_OFFSET UNITYSDK_OFFSET(0x144E0BA0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_UPDATEINJUREDSTATUS_OFFSET UNITYSDK_OFFSET(0x144E1070)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x144E2710)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER__ONCHANGE_B__93_0_OFFSET UNITYSDK_OFFSET(0x144E2840)

namespace MoleMole::MiniGame::TartarusHounds::View
{
	inline static constexpr unsigned int ViewEntityPlayer_TypeDefinitionIndex = 66953;
