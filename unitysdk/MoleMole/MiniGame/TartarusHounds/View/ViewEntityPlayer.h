...
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ATTACHCOMP_OFFSET UNITYSDK_OFFSET(0x1542B7F0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ATTACH_OFFSET UNITYSDK_OFFSET(0x1542B750)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_BASETICK_OFFSET UNITYSDK_OFFSET(0x1542E1E0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_BLINKADDLIFE_OFFSET UNITYSDK_OFFSET(0x1542F8E0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_CHANGETOLIST_OFFSET UNITYSDK_OFFSET(0x1542C780)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_CHECKBUFFCHANGE_OFFSET UNITYSDK_OFFSET(0x1542DCA0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_CHECKPROPERTYCHANGE_OFFSET UNITYSDK_OFFSET(0x1542D720)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_CLEARPLAYERBLINK_OFFSET UNITYSDK_OFFSET(0x1542B5D0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_CLEARSTATE_OFFSET UNITYSDK_OFFSET(0x1542C890)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_CLOSESHADOW_OFFSET UNITYSDK_OFFSET(0x1542C140)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_CLOSEWOOLBLINK_OFFSET UNITYSDK_OFFSET(0x1542F670)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_DEALAFTERATTACK_OFFSET UNITYSDK_OFFSET(0x1542EC40)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_DOINIT_OFFSET UNITYSDK_OFFSET(0x1542ABB0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_GET_ISPLAYATTACKING_OFFSET UNITYSDK_OFFSET(0x1542C730)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_HANDLERLOWHPANIMATION_OFFSET UNITYSDK_OFFSET(0x1542F880)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_INITSHEETANIM_OFFSET UNITYSDK_OFFSET(0x1542B880)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ONATTACKFINISHED_OFFSET UNITYSDK_OFFSET(0x1542F010)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ONCHANGE_OFFSET UNITYSDK_OFFSET(0x1542F220)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ONFAKEJUMPFINISHED_OFFSET UNITYSDK_OFFSET(0x1542F090)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ONFALLLANDINGFINISHED_OFFSET UNITYSDK_OFFSET(0x1542F1A0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ONFALLSLIPFINISHED_OFFSET UNITYSDK_OFFSET(0x1542F110)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ONRESET_OFFSET UNITYSDK_OFFSET(0x1542B580)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ONTEXSHEETANIMEND_OFFSET UNITYSDK_OFFSET(0x1542C1A0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ONTIMESCALECHANGE_OFFSET UNITYSDK_OFFSET(0x1542F9A0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1542CBC0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_OPENSHADOW_OFFSET UNITYSDK_OFFSET(0x1542C0D0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_PLAYANIMSTATE_1_OFFSET UNITYSDK_OFFSET(0x1542BD40)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_PLAYANIMSTATE_OFFSET UNITYSDK_OFFSET(0x1542C340)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_PLAYANIM_OFFSET UNITYSDK_OFFSET(0x1542C3B0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_PLAYBASICMOVE_OFFSET UNITYSDK_OFFSET(0x1542DF50)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_PLAYCURRENTSHEET_OFFSET UNITYSDK_OFFSET(0x1542C230)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_PLAYPLAYERBLINK_OFFSET UNITYSDK_OFFSET(0x1542E660)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_PLAYSOUND_OFFSET UNITYSDK_OFFSET(0x1542C5E0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_SETBLINKPARAMBYINDEX_OFFSET UNITYSDK_OFFSET(0x1542F6C0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_SETVIEWENTITYGAME_OFFSET UNITYSDK_OFFSET(0x1542B6D0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_SHOULDPLAYFALL_OFFSET UNITYSDK_OFFSET(0x1542EF80)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_SIMULATEPVPSWITCHPOS_OFFSET UNITYSDK_OFFSET(0x1542C8E0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_STOPPLAYERBLINK_OFFSET UNITYSDK_OFFSET(0x1542E890)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_SYNCTIMESCALEWITHSPEED_OFFSET UNITYSDK_OFFSET(0x1542B400)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_TICKTIMESCALECHANGE_OFFSET UNITYSDK_OFFSET(0x1542D6A0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_TRIGGERSTRUGGLE_OFFSET UNITYSDK_OFFSET(0x1542F940)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_TRYPLAYREADYSTOPINVINCIBLE_OFFSET UNITYSDK_OFFSET(0x1542F5C0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_UPDATECLIMBSTATUS_OFFSET UNITYSDK_OFFSET(0x1542ED80)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_UPDATEDIVINGSHADOWSTATUS_OFFSET UNITYSDK_OFFSET(0x1542EB20)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_UPDATEDYINGANIM_OFFSET UNITYSDK_OFFSET(0x1542DEC0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_UPDATEINJUREDSTATUS_OFFSET UNITYSDK_OFFSET(0x1542E380)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1542FA30)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER__ONCHANGE_B__93_0_OFFSET UNITYSDK_OFFSET(0x1542FB60)

namespace MoleMole::MiniGame::TartarusHounds::View
{
	inline static constexpr unsigned int ViewEntityPlayer_TypeDefinitionIndex = 38623;
	...
	public:
		...
		::Class_2_A7BCFF3A4359DD5D* playerBlinkControlStack; // 0xC8
		...
		::Enum_3_0A3761FE34514D6C_60 lastLifeStatus; // 0x16C
		::Enum_3_0A3761FE34514D6C_61 lastInjuredStatus; // 0x170
		::Enum_3_DB663931210BBC27_44 divingStatus; // 0x174
		...
		::System::Collections::Generic::Dictionary_2<::Enum_3_63CDB6C405C8FD68_3, ::System::Boolean>* lastBuffDict; // 0x1A8
		...
		::System::Void OnChange(::Enum_3_63CDB6C405C8FD68_3 buffType, ::System::Boolean val)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_63CDB6C405C8FD68_3, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ONCHANGE_OFFSET))(this, buffType, val);
		}
