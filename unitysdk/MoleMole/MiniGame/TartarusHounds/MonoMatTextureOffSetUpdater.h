...
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOMATTEXTUREOFFSETUPDATER_AWAKE_OFFSET UNITYSDK_OFFSET(0x10E2A080)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOMATTEXTUREOFFSETUPDATER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x10E2AA10)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOMATTEXTUREOFFSETUPDATER_TRANSITIONSPEED_OFFSET UNITYSDK_OFFSET(0x10E2A950)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOMATTEXTUREOFFSETUPDATER_TWEENTARGETSPEED_OFFSET UNITYSDK_OFFSET(0x10E2A820)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOMATTEXTUREOFFSETUPDATER_UPDATEBYTIME_OFFSET UNITYSDK_OFFSET(0x10E2A340)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOMATTEXTUREOFFSETUPDATER_UPDATE_OFFSET UNITYSDK_OFFSET(0x10E2A690)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOMATTEXTUREOFFSETUPDATER__CTOR_OFFSET UNITYSDK_OFFSET(0x10E2AAE0)

namespace MoleMole::MiniGame::TartarusHounds
{
	inline static constexpr unsigned int MonoMatTextureOffSetUpdater_TypeDefinitionIndex = 80537;
