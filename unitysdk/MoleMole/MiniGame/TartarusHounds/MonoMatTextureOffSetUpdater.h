...
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOMATTEXTUREOFFSETUPDATER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1914E630)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOMATTEXTUREOFFSETUPDATER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1914EFC0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOMATTEXTUREOFFSETUPDATER_TRANSITIONSPEED_OFFSET UNITYSDK_OFFSET(0x1914EF00)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOMATTEXTUREOFFSETUPDATER_TWEENTARGETSPEED_OFFSET UNITYSDK_OFFSET(0x1914EDD0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOMATTEXTUREOFFSETUPDATER_UPDATEBYTIME_OFFSET UNITYSDK_OFFSET(0x1914E8F0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOMATTEXTUREOFFSETUPDATER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1914EC40)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOMATTEXTUREOFFSETUPDATER__CTOR_OFFSET UNITYSDK_OFFSET(0x1914F090)

namespace MoleMole::MiniGame::TartarusHounds
{
	inline static constexpr unsigned int MonoMatTextureOffSetUpdater_TypeDefinitionIndex = 87318;
