...
#define MOLEMOLE_MINIGAME_MINIGAME3DMANIFEST_CONVERTLOGICPOSTOGLOBALLAYOUTPOS_OFFSET UNITYSDK_OFFSET(0x125D4800)
#define MOLEMOLE_MINIGAME_MINIGAME3DMANIFEST_CONVERTLOGICPOSTOLAYOUTPOS_1_OFFSET UNITYSDK_OFFSET(0x125D4690)
#define MOLEMOLE_MINIGAME_MINIGAME3DMANIFEST_CONVERTLOGICPOSTOLAYOUTPOS_2_OFFSET UNITYSDK_OFFSET(0x125D4740)
#define MOLEMOLE_MINIGAME_MINIGAME3DMANIFEST_CONVERTLOGICPOSTOLAYOUTPOS_OFFSET UNITYSDK_OFFSET(0x125D45D0)
#define MOLEMOLE_MINIGAME_MINIGAME3DMANIFEST__CTOR_OFFSET UNITYSDK_OFFSET(0x125D48B0)
#define MOLEMOLE_MINIGAME_MINIGAME3DMANIFEST___BASE_CONVERTLOGICPOSTOGLOBALLAYOUTPOS_OFFSET UNITYSDK_OFFSET(0x125D4900)
#define MOLEMOLE_MINIGAME_MINIGAME3DMANIFEST___BASE_CONVERTLOGICPOSTOLAYOUTPOS_1_OFFSET UNITYSDK_OFFSET(0x125D4970)
#define MOLEMOLE_MINIGAME_MINIGAME3DMANIFEST___BASE_CONVERTLOGICPOSTOLAYOUTPOS_2_OFFSET UNITYSDK_OFFSET(0x125D49A0)
#define MOLEMOLE_MINIGAME_MINIGAME3DMANIFEST___BASE_CONVERTLOGICPOSTOLAYOUTPOS_OFFSET UNITYSDK_OFFSET(0x125D4930)

namespace MoleMole::MiniGame
{
	inline static constexpr unsigned int MiniGame3DManifest_TypeDefinitionIndex = 80040;
