...
#define MOLEMOLE_MINIGAME_UIGAMELOGICPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1418A8C0)

namespace MoleMole::MiniGame
{
	inline static constexpr unsigned int UIGameLogicPageContext_TypeDefinitionIndex = 55066;
