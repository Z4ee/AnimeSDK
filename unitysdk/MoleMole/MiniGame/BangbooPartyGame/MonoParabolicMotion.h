...
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONOPARABOLICMOTION_METHOD_5_10867B69EFBCA83E_OFFSET UNITYSDK_OFFSET(0x107FC9D0)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONOPARABOLICMOTION_METHOD_5_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0x107FC890)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONOPARABOLICMOTION_RESETPOSITION_OFFSET UNITYSDK_OFFSET(0x107FC910)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONOPARABOLICMOTION_SIMULATEMOTION_OFFSET UNITYSDK_OFFSET(0x107FC790)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONOPARABOLICMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x107FC980)

namespace MoleMole::MiniGame::BangbooPartyGame
{
	inline static constexpr unsigned int MonoParabolicMotion_TypeDefinitionIndex = 65302;
