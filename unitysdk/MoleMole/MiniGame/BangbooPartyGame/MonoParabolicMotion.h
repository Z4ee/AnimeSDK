...
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONOPARABOLICMOTION_METHOD_5_10867B69EFBCA83E_OFFSET UNITYSDK_OFFSET(0x12F96500)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONOPARABOLICMOTION_METHOD_5_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0x12F963C0)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONOPARABOLICMOTION_RESETPOSITION_OFFSET UNITYSDK_OFFSET(0x12F96440)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONOPARABOLICMOTION_SIMULATEMOTION_OFFSET UNITYSDK_OFFSET(0x12F962C0)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONOPARABOLICMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x12F964B0)

namespace MoleMole::MiniGame::BangbooPartyGame
{
	inline static constexpr unsigned int MonoParabolicMotion_TypeDefinitionIndex = 72108;
