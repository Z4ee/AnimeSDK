...
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONOBANGBOOPARTYDEMOPARA_EACHLAYERDATA_GETCENTERS_OFFSET UNITYSDK_OFFSET(0x15429E70)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONOBANGBOOPARTYDEMOPARA_EACHLAYERDATA_GET_COLUMNNUM_OFFSET UNITYSDK_OFFSET(0x15429E50)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONOBANGBOOPARTYDEMOPARA_EACHLAYERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1542A130)

namespace MoleMole::MiniGame::BangbooPartyGame
{
	inline static constexpr unsigned int MonoBangbooPartyDemoPara_EachLayerData_TypeDefinitionIndex = 38383;
