...
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONOBANGBOOPARTYDEMOPARA_EACHLAYERDATA_GETCENTERS_OFFSET UNITYSDK_OFFSET(0x161F6A10)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONOBANGBOOPARTYDEMOPARA_EACHLAYERDATA_GET_COLUMNNUM_OFFSET UNITYSDK_OFFSET(0x161F69F0)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONOBANGBOOPARTYDEMOPARA_EACHLAYERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x161F6CD0)

namespace MoleMole::MiniGame::BangbooPartyGame
{
	inline static constexpr unsigned int MonoBangbooPartyDemoPara_EachLayerData_TypeDefinitionIndex = 40871;
