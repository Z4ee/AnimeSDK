...
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_CHILDTRIGGERFORWARDER_INITIALIZESTREAMING_OFFSET UNITYSDK_OFFSET(0x1685C8A0)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_CHILDTRIGGERFORWARDER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1685C650)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_CHILDTRIGGERFORWARDER_ONTRIGGER_OFFSET UNITYSDK_OFFSET(0x1685C8F0)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_CHILDTRIGGERFORWARDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1685C980)

namespace MoleMole::MiniGame::BangbooPartyGame
{
	inline static constexpr unsigned int ChildTriggerForwarder_TypeDefinitionIndex = 46547;
