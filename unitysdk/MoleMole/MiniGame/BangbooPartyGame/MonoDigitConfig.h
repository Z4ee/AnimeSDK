...
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONODIGITCONFIG_SETDIGITWITHLEADINGZERO_OFFSET UNITYSDK_OFFSET(0x136C9660)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONODIGITCONFIG_SETDIGIT_OFFSET UNITYSDK_OFFSET(0x136C94B0)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONODIGITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x136C9780)

namespace MoleMole::MiniGame::BangbooPartyGame
{
	inline static constexpr unsigned int MonoDigitConfig_TypeDefinitionIndex = 84416;
