...
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_DOINITNETCONNET_OFFSET UNITYSDK_OFFSET(0x13F00380)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_ENTERGAMEEND_OFFSET UNITYSDK_OFFSET(0x13F031F0)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_ENTERGAME_OFFSET UNITYSDK_OFFSET(0x13F00870)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_ENTERSTARTPAGE_OFFSET UNITYSDK_OFFSET(0x13F02DC0)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_GETMULTIPLAYERINFOS_OFFSET UNITYSDK_OFFSET(0x13F063C0)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_GETNIKENAMEBYREADYINFOBYPLAYERIDX_OFFSET UNITYSDK_OFFSET(0x13F04440)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_GETNIKENAMEBYREADYINFO_OFFSET UNITYSDK_OFFSET(0x13F04310)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_GETPLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0x13F03880)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_GETPVPREALTIMERANK_OFFSET UNITYSDK_OFFSET(0x13F04050)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_GETRANDOMSEED_OFFSET UNITYSDK_OFFSET(0x13F02CF0)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_GETSELFUID_OFFSET UNITYSDK_OFFSET(0x13F02D60)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_GET_MINIGAMERT_OFFSET UNITYSDK_OFFSET(0x13F02790)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_INITGAMETYPEBYARCADEGAMEID_OFFSET UNITYSDK_OFFSET(0x13F01B00)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_ISGAMEENDSTATE_OFFSET UNITYSDK_OFFSET(0x13F027B0)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_ONCREATE_OFFSET UNITYSDK_OFFSET(0x13EFFA40)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_ONENTER_OFFSET UNITYSDK_OFFSET(0x13F03EB0)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_ONEXIT_OFFSET UNITYSDK_OFFSET(0x13F01F10)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_ONLOADFINISH_OFFSET UNITYSDK_OFFSET(0x13F00230)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_ONRSVALLPLAYERREADY_OFFSET UNITYSDK_OFFSET(0x13F05020)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_ONRSVGAMEEND_OFFSET UNITYSDK_OFFSET(0x13F05080)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_ONRSVPLAYEREVENTS_OFFSET UNITYSDK_OFFSET(0x13F055E0)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_ONRSVPLAYERINFO_OFFSET UNITYSDK_OFFSET(0x13F05400)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_ONRSVPLAYERREADYINFO_OFFSET UNITYSDK_OFFSET(0x13F045F0)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_ONRSVPLAYERREADY_OFFSET UNITYSDK_OFFSET(0x13F04BF0)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_ONTHREALGAMESTARTSCNOTIFY_OFFSET UNITYSDK_OFFSET(0x13F058C0)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_ONTITLEVIDEOPLAYSTART_OFFSET UNITYSDK_OFFSET(0x13EFFFC0)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_ONUFIGHTCONNECTSUCCESS_OFFSET UNITYSDK_OFFSET(0x13F00AC0)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_ONUFIGHTDISCONNECT_OFFSET UNITYSDK_OFFSET(0x13F00B60)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_ONUFIGHTRECONNECTSUCCESS_OFFSET UNITYSDK_OFFSET(0x13F014C0)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_ONUFIGHTSTARTRECONNECT_OFFSET UNITYSDK_OFFSET(0x13F00C00)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_ONWILLEXIT_OFFSET UNITYSDK_OFFSET(0x13F01BF0)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_ONWORLDINITNOTIFY_OFFSET UNITYSDK_OFFSET(0x13F05EB0)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_PAUSE_OFFSET UNITYSDK_OFFSET(0x13F00FD0)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_REALENTERGAME_OFFSET UNITYSDK_OFFSET(0x13F02A70)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_REALSHOWENDPAGE_OFFSET UNITYSDK_OFFSET(0x13F03360)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_REGISTERLOADFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0x13F026E0)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_RESETPARAM_OFFSET UNITYSDK_OFFSET(0x13F00110)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_SETARCADEGAMEID_OFFSET UNITYSDK_OFFSET(0x13F018E0)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_SETPLAYERMULTIPLAYSTATE_OFFSET UNITYSDK_OFFSET(0x13F00D30)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_SET_MINIGAMERT_OFFSET UNITYSDK_OFFSET(0x13F027A0)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_SHOWGAMEENDPAGE_OFFSET UNITYSDK_OFFSET(0x13F03550)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_TRYSTARTGAME_OFFSET UNITYSDK_OFFSET(0x13F00580)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD__CTOR_OFFSET UNITYSDK_OFFSET(0x13F066A0)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD___BASE_ISGAMEENDSTATE_OFFSET UNITYSDK_OFFSET(0x13F06820)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD___BASE_ONCREATE_OFFSET UNITYSDK_OFFSET(0x13F068B0)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD___BASE_ONENTER_OFFSET UNITYSDK_OFFSET(0x13F068C0)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD___BASE_ONEXIT_OFFSET UNITYSDK_OFFSET(0x13F068D0)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD___BASE_ONLOADFINISH_OFFSET UNITYSDK_OFFSET(0x13F068E0)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD___BASE_ONTITLEVIDEOPLAYSTART_OFFSET UNITYSDK_OFFSET(0x13F06970)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD___BASE_ONUFIGHTCONNECTSUCCESS_OFFSET UNITYSDK_OFFSET(0x13F06A00)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD___BASE_ONUFIGHTDISCONNECT_OFFSET UNITYSDK_OFFSET(0x13F06A90)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD___BASE_ONUFIGHTRECONNECTSUCCESS_OFFSET UNITYSDK_OFFSET(0x13F06B20)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD___BASE_ONUFIGHTSTARTRECONNECT_OFFSET UNITYSDK_OFFSET(0x13F06BB0)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD___BASE_ONWILLEXIT_OFFSET UNITYSDK_OFFSET(0x13F06C40)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD___BASE_PAUSE_OFFSET UNITYSDK_OFFSET(0x13F06CD0)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD___BASE_REGISTERLOADFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0x13F06D70)
#define MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD___BASE_SETARCADEGAMEID_OFFSET UNITYSDK_OFFSET(0x13F06E00)

namespace MoleMole::MiniGame
{
	inline static constexpr unsigned int HoundMiniGameWorld_TypeDefinitionIndex = 55966;
	...
	public:
		...
		::MoleMole::UIHoundGame3DModelController* houndGame3dCtrl; // 0xA0
		::System::Action* loadFinishCb; // 0xA8
		::MoleMole::UIHoundGamePageController* houndGamePageCtrl; // 0xB0
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_3_CE3642B3ECB61D27_42*>* playerInfoDict; // 0xB8
		::UnityEngine::RenderTexture* gameRt; // 0xC0
		::Class_3_7A7210476589789D_4* EndBattleInfo; // 0xC8
		::Enum_3_3A8D4AF679CBDF1E gameType; // 0xD0
		::System::Int32 selfIndex; // 0xD4
		::System::Boolean isActivity; // 0xD8
		::System::Boolean isConncted; // 0xD9
		::System::Single startSeconds; // 0xDC
		::System::Int32 historyBestScore; // 0xE0
		::System::Int32 onlinePvpPlayerCount; // 0xE4
		::System::Boolean isSendPlayerReady; // 0xE8
		::System::Boolean allPlayherReadySetAfterLoad; // 0xE9
		::System::Boolean isLoad; // 0xEA
		::System::Boolean allPlayerReady; // 0xEB
		...
		::System::Void OnRsvPlayerReady(::Class_3_CE3642B3ECB61D27_42* readyInfo)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_CE3642B3ECB61D27_42*))((::PBYTE)hIl2Cpp + MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_ONRSVPLAYERREADY_OFFSET))(this, readyInfo);
		}
		...
		::System::Void OnRsvPlayerInfo(::Class_3_D42977F88D59ACE7_3* info)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_D42977F88D59ACE7_3*))((::PBYTE)hIl2Cpp + MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_ONRSVPLAYERINFO_OFFSET))(this, info);
		}

		::System::Void OnRsvPlayerEvents(::Class_3_1A345EAE5F749316_118* notify)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_1A345EAE5F749316_118*))((::PBYTE)hIl2Cpp + MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_ONRSVPLAYEREVENTS_OFFSET))(this, notify);
		}
		...
		::System::Void OnWorldInitNotify(::Class_3_9EBB12CA711CD77A_1* notify)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_9EBB12CA711CD77A_1*))((::PBYTE)hIl2Cpp + MOLEMOLE_MINIGAME_HOUNDMINIGAMEWORLD_ONWORLDINITNOTIFY_OFFSET))(this, notify);
		}
