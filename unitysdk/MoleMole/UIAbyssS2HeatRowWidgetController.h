...
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_GETABYSSPOINT_OFFSET UNITYSDK_OFFSET(0x15871700)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_GET_HEADID_OFFSET UNITYSDK_OFFSET(0x15871190)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_ISSELECT_OFFSET UNITYSDK_OFFSET(0x15872350)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x15871510)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15870DF0)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x158722A0)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15870F00)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15870E80)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15870B40)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_REFRESHUIBYPOINTROOTSTATE_OFFSET UNITYSDK_OFFSET(0x158711B0)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_SELECTHEATBUFF_OFFSET UNITYSDK_OFFSET(0x15871750)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_SETHEATID_OFFSET UNITYSDK_OFFSET(0x15871120)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_SETSELECTSTATE_OFFSET UNITYSDK_OFFSET(0x15871E10)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0x15871FD0)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x158723A0)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x158723B0)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15872440)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x158724E0)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15872570)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2HeatRowWidgetController_TypeDefinitionIndex = 81433;

	class UIAbyssS2HeatRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_724B3079070B9259_1* _view; // 0x2E8
		::System::Int32 _index; // 0x2F0
		::MoleMole::UIYorozuyaS2DifficultyInfoWidgetController_AbyssHeatData* _data; // 0x2F8
		::System::Action_2<::System::Int32, ::System::Boolean>* _toggleCall; // 0x300
		::System::Action* _selectCall; // 0x308
		::Class_2_E621E51D351EB960* _abyssModel; // 0x310
		::System::Boolean _isSelect; // 0x318
		::MoleMole::UIAbyssS2HeatRowWidgetController_PointRootState _pointRootState; // 0x31C
		::Class_2_208CC9941471731A_448* _config; // 0x320
		::MoleMole::UIYorozuyaS2DifficultyInfoWidgetController* _parentWidget; // 0x328
		::System::Int32 _heatLimit; // 0x330
		...
		::System::Void SetHeatID(::Class_2_208CC9941471731A_448* heatConfig, ::System::Int32 index)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_448*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_SETHEATID_OFFSET))(this, heatConfig, index);
		}
