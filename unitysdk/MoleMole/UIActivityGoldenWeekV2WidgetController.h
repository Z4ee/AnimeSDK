...
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_INITTABUIVIEW_OFFSET UNITYSDK_OFFSET(0x18C53400)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_ONCLICKDETAILSICONBTN_OFFSET UNITYSDK_OFFSET(0x18C54290)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_ONCLICKTABLEROW_OFFSET UNITYSDK_OFFSET(0x18C53ED0)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0x18C53860)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18C531E0)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18C52E30)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18C53270)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18C529E0)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18C52A40)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_REFRESHREMAINTIMERTEXT_OFFSET UNITYSDK_OFFSET(0x18C53E00)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_REFRESHSHOWTABLE_OFFSET UNITYSDK_OFFSET(0x18C52EC0)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_SHOWTABLEUIVIEWEMPTY_OFFSET UNITYSDK_OFFSET(0x18C53760)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_SHOWTABLEUIVIEW_OFFSET UNITYSDK_OFFSET(0x18C53AE0)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0x18C53A90)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x18C53380)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18C542F0)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER__ONCLICKTABLEROW_B__28_0_OFFSET UNITYSDK_OFFSET(0x18C54470)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER__REFRESHREMAINTIMERTEXT_B__27_0_OFFSET UNITYSDK_OFFSET(0x18C54440)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18C54480)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18C54510)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18C545B0)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18C54640)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18C546D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityGoldenWeekV2WidgetController_TypeDefinitionIndex = 82046;
	...
	public:
		...
		::System::Void _OnClickTableRow_b__28_0(::Class_0_16E4307DCC419505_29* rspMsg)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_29*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER__ONCLICKTABLEROW_B__28_0_OFFSET))(this, rspMsg);
		}
