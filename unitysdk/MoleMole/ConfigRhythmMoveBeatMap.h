...
#define MOLEMOLE_CONFIGRHYTHMMOVEBEATMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x15A06EA0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigRhythmMoveBeatMap_TypeDefinitionIndex = 47554;
