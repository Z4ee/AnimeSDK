...
#define MOLEMOLE_CONFIGRHYTHMMOVEBEATMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x190D3990)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigRhythmMoveBeatMap_TypeDefinitionIndex = 68420;
