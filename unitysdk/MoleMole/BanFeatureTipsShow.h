...
#define MOLEMOLE_BANFEATURETIPSSHOW_CLEARBANTYPE_OFFSET UNITYSDK_OFFSET(0x11C77BA0)
#define MOLEMOLE_BANFEATURETIPSSHOW_GET_ISBLOCKCENTER_OFFSET UNITYSDK_OFFSET(0x11C77B40)
#define MOLEMOLE_BANFEATURETIPSSHOW_GET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x11C77AE0)
#define MOLEMOLE_BANFEATURETIPSSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x11C77B30)
#define MOLEMOLE_BANFEATURETIPSSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x11C77BF0)
#define MOLEMOLE_BANFEATURETIPSSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x11C77B50)
#define MOLEMOLE_BANFEATURETIPSSHOW___BASE_GET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x11C77E10)

namespace MoleMole
{
	inline static constexpr unsigned int BanFeatureTipsShow_TypeDefinitionIndex = 65817;
