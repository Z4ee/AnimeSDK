...
#define MOLEMOLE_UIURBANMAPNAVIGATIONTELEPORTROWWIDGETCONTROLLER___C__DISPLAYCLASS17_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1655C310)
#define MOLEMOLE_UIURBANMAPNAVIGATIONTELEPORTROWWIDGETCONTROLLER___C__DISPLAYCLASS17_0__DOTELEPORTMAINCITY_B__0_OFFSET UNITYSDK_OFFSET(0x1655C320)
#define MOLEMOLE_UIURBANMAPNAVIGATIONTELEPORTROWWIDGETCONTROLLER___C__DISPLAYCLASS17_0__DOTELEPORTMAINCITY_B__1_OFFSET UNITYSDK_OFFSET(0x1655C360)
#define MOLEMOLE_UIURBANMAPNAVIGATIONTELEPORTROWWIDGETCONTROLLER___C__DISPLAYCLASS17_0__DOTELEPORTMAINCITY_B__2_OFFSET UNITYSDK_OFFSET(0x1655C430)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapNavigationTeleportRowWidgetController___c__DisplayClass17_0_TypeDefinitionIndex = 73848;
	...
	public:
		...
		::Class_2_208CC9941471731A_552* teleportTemplate; // 0x20
