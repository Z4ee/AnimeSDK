...
#define MOLEMOLE_UIREWARDBUFFROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16756CF0)
#define MOLEMOLE_UIREWARDBUFFROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16756E00)
#define MOLEMOLE_UIREWARDBUFFROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16756D80)
#define MOLEMOLE_UIREWARDBUFFROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16756C20)
#define MOLEMOLE_UIREWARDBUFFROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16756C80)
#define MOLEMOLE_UIREWARDBUFFROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x16756EC0)
#define MOLEMOLE_UIREWARDBUFFROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x167575B0)
#define MOLEMOLE_UIREWARDBUFFROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x167575C0)
#define MOLEMOLE_UIREWARDBUFFROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16757650)
#define MOLEMOLE_UIREWARDBUFFROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x167576F0)
#define MOLEMOLE_UIREWARDBUFFROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16757780)
#define MOLEMOLE_UIREWARDBUFFROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16757810)

namespace MoleMole
{
	inline static constexpr unsigned int UIRewardBuffRowWidgetController_TypeDefinitionIndex = 71073;
