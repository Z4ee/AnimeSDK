...
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_CANMOVECAMERA_OFFSET UNITYSDK_OFFSET(0x185592E0)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_CANROTATECAM_OFFSET UNITYSDK_OFFSET(0x18559840)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x185577D0)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_GETMOVEDELTA_OFFSET UNITYSDK_OFFSET(0x18559050)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_GET_CASEFWD_OFFSET UNITYSDK_OFFSET(0x18556DE0)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_GET_CASERIGHT_OFFSET UNITYSDK_OFFSET(0x18556CA0)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_GET_CASEUP_OFFSET UNITYSDK_OFFSET(0x18556B70)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_GET_PIVOTPOS_OFFSET UNITYSDK_OFFSET(0x185569A0)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_GET_PIVOT_OFFSET UNITYSDK_OFFSET(0x18556B60)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_INITCAMPOS_OFFSET UNITYSDK_OFFSET(0x185578D0)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_INITFROMCAMERACFG_OFFSET UNITYSDK_OFFSET(0x18558840)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_INITMAINVIRTUALCAMERA_OFFSET UNITYSDK_OFFSET(0x18557100)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_ISCAMERADIRTY_OFFSET UNITYSDK_OFFSET(0x18558AF0)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_MOVECAMERA_OFFSET UNITYSDK_OFFSET(0x18558EE0)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x185575B0)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18557640)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18556F10)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18557560)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_REPOSITIONCAMERA_OFFSET UNITYSDK_OFFSET(0x18558D80)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_RESETCAMERA_OFFSET UNITYSDK_OFFSET(0x18557740)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_ROTATECAMERA_OFFSET UNITYSDK_OFFSET(0x18559690)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_SETPIVOTPOS_OFFSET UNITYSDK_OFFSET(0x185594F0)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_ZOOMCAMERA_OFFSET UNITYSDK_OFFSET(0x18559890)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18559920)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER__INITCAMPOS_B__31_0_OFFSET UNITYSDK_OFFSET(0x185599B0)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER__INITMAINVIRTUALCAMERA_B__26_0_OFFSET UNITYSDK_OFFSET(0x18559990)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER___BASE_INITMAINVIRTUALCAMERA_OFFSET UNITYSDK_OFFSET(0x185599D0)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18559A60)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18559AF0)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18559B00)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18559B10)

namespace MoleMole
{
	inline static constexpr unsigned int UIDisplayCase3DModelController_TypeDefinitionIndex = 76318;
	...
	public:
		...
		::Class_2_5BB615FAF8CE49B7* _view; // 0x448
