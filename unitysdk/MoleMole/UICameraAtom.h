...
#define MOLEMOLE_UICAMERAATOM_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x7F6D40)
#define MOLEMOLE_UICAMERAATOM_EQUALS_OFFSET UNITYSDK_OFFSET(0x7F6D10)
#define MOLEMOLE_UICAMERAATOM_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7F6E30)
#define MOLEMOLE_UICAMERAATOM_GET_DEFAULT_OFFSET UNITYSDK_OFFSET(0x1524A430)
#define MOLEMOLE_UICAMERAATOM_GET_FOV_OFFSET UNITYSDK_OFFSET(0x45B300)
#define MOLEMOLE_UICAMERAATOM_GET_POS_OFFSET UNITYSDK_OFFSET(0x2ACBC0)
#define MOLEMOLE_UICAMERAATOM_GET_ROT_OFFSET UNITYSDK_OFFSET(0x3E6590)
#define MOLEMOLE_UICAMERAATOM_METHOD_2_128A3A066D9C08E3_1_OFFSET UNITYSDK_OFFSET(0x1524B870)
#define MOLEMOLE_UICAMERAATOM_METHOD_2_128A3A066D9C08E3_OFFSET UNITYSDK_OFFSET(0x1524B760)
#define MOLEMOLE_UICAMERAATOM_METHOD_2_27AF3C8987EB39AF_OFFSET UNITYSDK_OFFSET(0x1524B270)
#define MOLEMOLE_UICAMERAATOM_METHOD_2_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x7F70B0)
#define MOLEMOLE_UICAMERAATOM_METHOD_2_4321AFA5981896E4_OFFSET UNITYSDK_OFFSET(0x7F6F40)
#define MOLEMOLE_UICAMERAATOM_METHOD_2_6695159C43613292_OFFSET UNITYSDK_OFFSET(0x1524B4C0)
#define MOLEMOLE_UICAMERAATOM_METHOD_2_6D0360BD23602584_OFFSET UNITYSDK_OFFSET(0x7F7010)
#define MOLEMOLE_UICAMERAATOM_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x7F6ED0)
#define MOLEMOLE_UICAMERAATOM_METHOD_2_ACFC02CB143DEFAA_OFFSET UNITYSDK_OFFSET(0x1524AD20)
#define MOLEMOLE_UICAMERAATOM_METHOD_2_B2FBAC43FA08C2C9_OFFSET UNITYSDK_OFFSET(0x7F7080)
#define MOLEMOLE_UICAMERAATOM_METHOD_2_F7514505158903D4_OFFSET UNITYSDK_OFFSET(0x1524A9A0)
#define MOLEMOLE_UICAMERAATOM_SET_FOV_OFFSET UNITYSDK_OFFSET(0x55FE60)
#define MOLEMOLE_UICAMERAATOM_SET_POS_OFFSET UNITYSDK_OFFSET(0x2ACB80)
#define MOLEMOLE_UICAMERAATOM_SET_ROT_OFFSET UNITYSDK_OFFSET(0x446EF0)
#define MOLEMOLE_UICAMERAATOM_TOSTRING_OFFSET UNITYSDK_OFFSET(0x7F6EC0)

namespace MoleMole
{
	inline static constexpr unsigned int UICameraAtom_TypeDefinitionIndex = 55750;
