...
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER___C__DISPLAYCLASS24_0__CTOR_OFFSET UNITYSDK_OFFSET(0x167C45A0)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER___C__DISPLAYCLASS24_0__REFRESHCHOICEDESC_B__0_OFFSET UNITYSDK_OFFSET(0x167C45B0)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER___C__DISPLAYCLASS24_0__REFRESHCHOICEDESC_B__1_OFFSET UNITYSDK_OFFSET(0x167C4600)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowEventWidgetChildWindowController___c__DisplayClass24_0_TypeDefinitionIndex = 56239;

	class UIHollowEventWidgetChildWindowController___c__DisplayClass24_0 : public ::System::Object
	{
	public:
		::System::Single oPosx1; // 0x10
		::System::Single oPosx2; // 0x14
