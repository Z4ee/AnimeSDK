...
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER___C__DISPLAYCLASS24_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18366450)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER___C__DISPLAYCLASS24_0__REFRESHCHOICEDESC_B__0_OFFSET UNITYSDK_OFFSET(0x18366460)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER___C__DISPLAYCLASS24_0__REFRESHCHOICEDESC_B__1_OFFSET UNITYSDK_OFFSET(0x183664B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowEventWidgetChildWindowController___c__DisplayClass24_0_TypeDefinitionIndex = 77972;
