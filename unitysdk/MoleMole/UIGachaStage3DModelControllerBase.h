...
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_AFTERREFRESHSTAGEONEFRAME_OFFSET UNITYSDK_OFFSET(0x18595B60)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_CHECKRARITYTV_OFFSET UNITYSDK_OFFSET(0x18599350)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_FIRETVEFFECT_OFFSET UNITYSDK_OFFSET(0x18597E50)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GETCURPLAYERCONDITION_OFFSET UNITYSDK_OFFSET(0x18596590)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GETLIGHTCUTSCENEATTACHPOINT_OFFSET UNITYSDK_OFFSET(0x18594560)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GETRARITYEFFDELAY_OFFSET UNITYSDK_OFFSET(0x185984D0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GETSCREENPLAYDATAFROM_1_OFFSET UNITYSDK_OFFSET(0x1858F140)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GETSCREENPLAYDATAFROM_OFFSET UNITYSDK_OFFSET(0x1858EF80)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GETUIPREFABPATH_OFFSET UNITYSDK_OFFSET(0x18593A40)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GETUITEXTMOVEDISTANE_OFFSET UNITYSDK_OFFSET(0x18594460)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_ANIMACHECKMODE_OFFSET UNITYSDK_OFFSET(0x18594040)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_BLUEPRINT_NAME_OFFSET UNITYSDK_OFFSET(0x18599DD0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_CURCHARACTERLIGHTTIMELINEGO_OFFSET UNITYSDK_OFFSET(0x18597CD0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_CURMODEL_OFFSET UNITYSDK_OFFSET(0x18599DF0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_CURTIMESCALE_OFFSET UNITYSDK_OFFSET(0x1858ED40)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x18599E00)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_ISANIMATORSPEEDCTRLED_OFFSET UNITYSDK_OFFSET(0x18592BA0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_PLAYER_OFFSET UNITYSDK_OFFSET(0x18599DE0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_RARITY_TV_INDEX_OFFSET UNITYSDK_OFFSET(0x18599DC0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_SHAKEITEMGO_OFFSET UNITYSDK_OFFSET(0x1858E580)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_TOTAL_TV_NUM_OFFSET UNITYSDK_OFFSET(0x18599DB0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET__ISNONGACHA_OFFSET UNITYSDK_OFFSET(0x18592770)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_HANDLECREATESUMMONS_OFFSET UNITYSDK_OFFSET(0x18592DC0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_HANDLEONOPEN_OFFSET UNITYSDK_OFFSET(0x1858E820)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_HANDLEREMOVESUMMONS_OFFSET UNITYSDK_OFFSET(0x18592270)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_HANDLESUMMONENTITYONCLOSEUPTLCHANGE_OFFSET UNITYSDK_OFFSET(0x185998E0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_HANDLEUITEXTMATONREFRESH_OFFSET UNITYSDK_OFFSET(0x18594150)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_HANDLEUPDATE_OFFSET UNITYSDK_OFFSET(0x1858E5D0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ISVIDEOTVINDEX_OFFSET UNITYSDK_OFFSET(0x1858F260)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1858E000)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_NEXTITEM_OFFSET UNITYSDK_OFFSET(0x18596160)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONCAMERASHAKE_OFFSET UNITYSDK_OFFSET(0x18599850)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONCLOSEUPTLEND_OFFSET UNITYSDK_OFFSET(0x18599A70)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONCLOSEUPTLSTART_OFFSET UNITYSDK_OFFSET(0x18599890)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONTIMESCALECHANGED_OFFSET UNITYSDK_OFFSET(0x185993C0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x1858CF40)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1858D7D0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1858CB30)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1858CBE0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYBLUEPRINT_OFFSET UNITYSDK_OFFSET(0x18594D70)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYCHARACTERLIGHTSTL_OFFSET UNITYSDK_OFFSET(0x18596910)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYITEMSHAKE_OFFSET UNITYSDK_OFFSET(0x18598CC0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYSTAGETEXSHEETBYBLACKBOARD_OFFSET UNITYSDK_OFFSET(0x185945A0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYSTAGETEXSHEET_OFFSET UNITYSDK_OFFSET(0x18594770)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYSUMMONSBORNANIMATION_OFFSET UNITYSDK_OFFSET(0x18588D50)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYTVEFFECTANIMLASTFRAME_OFFSET UNITYSDK_OFFSET(0x18598940)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYTVEFFECTANIM_OFFSET UNITYSDK_OFFSET(0x18598740)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PRELOADITEMSTAGE_OFFSET UNITYSDK_OFFSET(0x1858F2B0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_REALSHOWCHARACTERLIGHTSV2_OFFSET UNITYSDK_OFFSET(0x18596EE0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_REALSHOWCHARACTERLIGHTS_OFFSET UNITYSDK_OFFSET(0x185969C0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_REFRESHITEMSTAGE_1_OFFSET UNITYSDK_OFFSET(0x18593890)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_REFRESHITEMSTAGE_OFFSET UNITYSDK_OFFSET(0x1858F340)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_REFRESHSTAGE_OFFSET UNITYSDK_OFFSET(0x18595230)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_REMOVECURENTITY_OFFSET UNITYSDK_OFFSET(0x18592880)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_RESETUITEXT_1_OFFSET UNITYSDK_OFFSET(0x18593C90)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_RESETUITEXT_OFFSET UNITYSDK_OFFSET(0x18593B60)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_SETSUMMONSTIMESCALE_OFFSET UNITYSDK_OFFSET(0x18593620)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_SETTVMATPROPERTY_OFFSET UNITYSDK_OFFSET(0x18599290)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x18599E10)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_STOPALLTVS_OFFSET UNITYSDK_OFFSET(0x18594C40)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_STOPPLAY_OFFSET UNITYSDK_OFFSET(0x18596600)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_STOPSOUND_OFFSET UNITYSDK_OFFSET(0x185968D0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_STOPTVEFFECTANIM_OFFSET UNITYSDK_OFFSET(0x18598AD0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_STOPTV_OFFSET UNITYSDK_OFFSET(0x18594B70)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_UPDATESUMMONSANIMATORMANUALLY_OFFSET UNITYSDK_OFFSET(0x18599AC0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_UPDATETVS_OFFSET UNITYSDK_OFFSET(0x1858E620)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1858CB80)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x18599E20)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE__REFRESHITEMSTAGE_B__18_0_OFFSET UNITYSDK_OFFSET(0x1859A390)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE__REFRESHSTAGE_B__40_0_OFFSET UNITYSDK_OFFSET(0x1859A400)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x1859A410)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1859A4D0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1859A4E0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1859A4F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaStage3DModelControllerBase_TypeDefinitionIndex = 54982;
	...
	public:
		...
		::System::Collections::Generic::List_1<::UnityEngine::GameObject*>* _toHideModels; // 0x360
		::System::Int32 _characterTemplateID; // 0x368
		::System::Collections::Generic::Dictionary_2<::Foundation::AssetPath, ::System::Collections::Generic::List_1<::UnityEngine::GameObject*>*>* _loadedSummonGos; // 0x370
		::System::Collections::Generic::Dictionary_2<::Foundation::AssetPath, ::System::Collections::Generic::List_1<::UnityEngine::GameObject*>*>* _usedSummonGos; // 0x378
		::System::Collections::Generic::List_1<::MoleMole::Battle::Entity*>* _summonEntitys; // 0x380
		::MoleMole::Config::ConfigEntityTimeSlow* _timeSlowConfig; // 0x388
		::Class_1_C87309B6DF67BFA9* _timeSlowData; // 0x390
		::System::String* PreTexSheetStart_Tv; // 0x398
		::System::String* PreTexSheetLoop_Tv; // 0x3A0
		::System::String* PreTexSheetEnd_Tv; // 0x3A8
		::System::String* TexSheetStart_Tv; // 0x3B0
		::System::String* TexSheetLoop_Tv; // 0x3B8
		::System::String* TexSheetEnd_Tv; // 0x3C0
		::System::String* AnimationKeyDelay; // 0x3C8
		::System::String* ModelAnimatorCom; // 0x3D0
		::System::String* CamShakeKey; // 0x3D8
		::System::String* CamRotDuration; // 0x3E0
		::System::String* IfRefreshStage; // 0x3E8
		::System::String* AllowToNext; // 0x3F0
		::System::String* AvatarAnimOffset; // 0x3F8
		::System::String* UITextMoveDuration; // 0x400
		::System::String* UITextMoveCurve; // 0x408
		::System::String* UITextTwinkleDuration; // 0x410
		::System::String* UITextTwinkleCurve; // 0x418
		::System::String* UITextTwinkleMaxAlpha; // 0x420
		::System::String* UITextSpeedUpScale; // 0x428
		::System::String* UITextFadeOutDelaySpeedUp; // 0x430
		::System::String* UITextFadeInSuspend; // 0x438
		::System::String* UITextFadeInCurve; // 0x440
		::System::String* UITextFadeInMaxAlpha; // 0x448
		::System::String* IsNextItemBtnClicked; // 0x450
		::System::String* ItemNameKey; // 0x458
		::System::String* ItemNameText; // 0x460
		::System::String* ItemNameAnim; // 0x468
		::System::String* UITextUpGo; // 0x470
		::System::String* UITextLeftGo; // 0x478
		::System::String* UITextRightGo; // 0x480
		::System::String* UITextMidGo; // 0x488
		::System::String* RarityEffectPattern; // 0x490
		::System::String* RarityEffectPatternSpecial; // 0x498
		::System::String* StageRarityEffectPattern; // 0x4A0
		::System::String* CamRarityEffectPattern_Openning; // 0x4A8
		::System::String* CamRarityEffectPattern_ItemStage; // 0x4B0
		::System::String* CamRarityEffectPattern_Common; // 0x4B8
		::System::String* MonoCGCustomGlobalAnimationGo; // 0x4C0
		::System::String* MonoCGCustomGlobalAnimationGo1; // 0x4C8
		::System::String* MonoCGCustomGlobalAnimationGo2; // 0x4D0
		::System::String* CGCustomGlobalAnimationOpenCurve; // 0x4D8
		::System::String* CGCustomGlobalAnimationOpenDuration; // 0x4E0
		::System::String* CGCustomGlobalAnimationCloseCurve; // 0x4E8
		::System::String* CGCustomGlobalAnimationCloseDuration; // 0x4F0
		::System::String* IsRarityS; // 0x4F8
		::System::String* TvRarityEffShowInterval; // 0x500
		::System::String* TvRarityEffAnimShowInterval; // 0x508
		::System::String* RaritySPerformInterval; // 0x510
		::System::String* IsRarityTv; // 0x518
		::System::String* TvRarityEffAnim; // 0x520
		::System::String* TvCommonEffAnim_ItemStage; // 0x528
		::System::String* UITextColor; // 0x530
		::System::String* UITextIntensityCurve; // 0x538
		::System::String* UITextIntensityDuration; // 0x540
		::System::String* CamEff_Rotate_Delay; // 0x548
		::System::String* HasRarityS; // 0x550
		::System::String* NeedStopCloseupTL; // 0x558
		::System::Collections::Generic::List_1<::UnityEngine::Renderer*>* _tvRenders; // 0x560
		::System::Collections::Generic::List_1<::MoleMole::ScreenPlayer*>* _screenPlayers; // 0x568
		::System::Collections::Generic::List_1<::TextureFrameScreenPlayData*>* _startScreenDatas; // 0x570
		::System::Collections::Generic::List_1<::TextureFrameScreenPlayData*>* _loopScreenDatas; // 0x578
		::System::Collections::Generic::List_1<::TextureFrameScreenPlayData*>* _endScreenDatas; // 0x580
		::System::Collections::Generic::List_1<::VideoScreenPlayData*>* _startVideoScreenDatas; // 0x588
		::System::Collections::Generic::List_1<::VideoScreenPlayData*>* _loopVideoScreenDatas; // 0x590
		::System::Collections::Generic::List_1<::VideoScreenPlayData*>* _endVideoScreenDatas; // 0x598
		::Class_1_D3581D8A71834B25* _player; // 0x5A0
		::UnityEngine::Transform* _characterLightsTimelineRoot; // 0x5A8
		::Class_2_208CC9941471731A_52* _itemPerformTemplate; // 0x5B0
		::UnityEngine::GameObject* _curModel; // 0x5B8
		::UnityEngine::Vector3 _startLocalPos; // 0x5C0
		::MoleMole::Battle::Entity* _curEntity; // 0x5D0
		::UnityEngine::GameObject* _contentRootGo; // 0x5D8
		::System::Boolean _IsActive_k__BackingField; // 0x5E0
		::System::Collections::Generic::Dictionary_2<::Foundation::AssetPath, ::UnityEngine::GameObject*>* _loadedModels; // 0x5E8
		::System::Collections::Generic::Dictionary_2<::Foundation::AssetPath, ::UnityEngine::GameObject*>* _loadedUITextModels; // 0x5F0
		::System::String* _Color; // 0x5F8
		::System::String* _ChannelA; // 0x600
		::Class_2_208CC9941471731A_344* _gachaPerformTamplate; // 0x608
		::System::Collections::Generic::List_1<::UnityEngine::Light*>* _allLights; // 0x610
		::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::GameObject*>* _loadedCharacterLightsTLs; // 0x618
		::UnityEngine::Playables::PlayableDirector* _curCharacterLightsDirector; // 0x620
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::List_1<::UnityEngine::GameObject*>*>* _loadedTvEffects; // 0x628
		::Class_2_5F64140FAB2210F3* _camClip; // 0x630
		::Foundation::AssetPath _lastModelPrefabPath; // 0x638
		...
		::System::Void PlayBlueprint(::System::Single camRotateDuration, ::Class_2_208CC9941471731A_52* tamplate, ::System::Action* blueprintEndCb, ::System::Int32 performedPhaseCount, ::System::Int32 totalPhaseCount, ::System::String* overrideBlueprint)
		{
			return ((::System::Void(*)(::PVOID, ::System::Single, ::Class_2_208CC9941471731A_52*, ::System::Action*, ::System::Int32, ::System::Int32, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYBLUEPRINT_OFFSET))(this, camRotateDuration, tamplate, blueprintEndCb, performedPhaseCount, totalPhaseCount, overrideBlueprint);
		}
		...
		::Class_1_D3581D8A71834B25* get_Player()
		{
			return ((::Class_1_D3581D8A71834B25*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_PLAYER_OFFSET))(this);
		}
