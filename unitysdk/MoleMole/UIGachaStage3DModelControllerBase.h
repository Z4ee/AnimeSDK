...
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_AFTERREFRESHSTAGEONEFRAME_OFFSET UNITYSDK_OFFSET(0x17646DC0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_CHECKRARITYTV_OFFSET UNITYSDK_OFFSET(0x1764A690)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_FIRETVEFFECT_OFFSET UNITYSDK_OFFSET(0x176490B0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GETCURPLAYERCONDITION_OFFSET UNITYSDK_OFFSET(0x17647800)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GETLIGHTCUTSCENEATTACHPOINT_OFFSET UNITYSDK_OFFSET(0x176457B0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GETRARITYEFFDELAY_OFFSET UNITYSDK_OFFSET(0x17649740)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GETSCREENPLAYDATAFROM_1_OFFSET UNITYSDK_OFFSET(0x176402C0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GETSCREENPLAYDATAFROM_OFFSET UNITYSDK_OFFSET(0x17640100)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GETUIPREFABPATH_OFFSET UNITYSDK_OFFSET(0x17644CA0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GETUITEXTMOVEDISTANE_OFFSET UNITYSDK_OFFSET(0x176456B0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_ANIMACHECKMODE_OFFSET UNITYSDK_OFFSET(0x17645290)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_BLUEPRINT_NAME_OFFSET UNITYSDK_OFFSET(0x1764B130)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_CURCHARACTERLIGHTTIMELINEGO_OFFSET UNITYSDK_OFFSET(0x17648F30)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_CURMODEL_OFFSET UNITYSDK_OFFSET(0x1764B150)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_CURTIMESCALE_OFFSET UNITYSDK_OFFSET(0x1763FEC0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1764B160)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_ISANIMATORSPEEDCTRLED_OFFSET UNITYSDK_OFFSET(0x17643DF0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_PLAYER_OFFSET UNITYSDK_OFFSET(0x1764B140)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_RARITY_TV_INDEX_OFFSET UNITYSDK_OFFSET(0x1764B120)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_SHAKEITEMGO_OFFSET UNITYSDK_OFFSET(0x1763F700)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_TOTAL_TV_NUM_OFFSET UNITYSDK_OFFSET(0x1764B110)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET__ISNONGACHA_OFFSET UNITYSDK_OFFSET(0x176439B0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_HANDLECREATESUMMONS_OFFSET UNITYSDK_OFFSET(0x17644010)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_HANDLEONOPEN_OFFSET UNITYSDK_OFFSET(0x1763F9A0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_HANDLEREMOVESUMMONS_OFFSET UNITYSDK_OFFSET(0x176434C0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_HANDLESUMMONENTITYONCLOSEUPTLCHANGE_OFFSET UNITYSDK_OFFSET(0x1764AC40)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_HANDLEUITEXTMATONREFRESH_OFFSET UNITYSDK_OFFSET(0x176453A0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_HANDLEUPDATE_OFFSET UNITYSDK_OFFSET(0x1763F750)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ISVIDEOTVINDEX_OFFSET UNITYSDK_OFFSET(0x176403E0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1763F180)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_NEXTITEM_OFFSET UNITYSDK_OFFSET(0x176473D0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONCAMERASHAKE_OFFSET UNITYSDK_OFFSET(0x1764ABB0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONCLOSEUPTLEND_OFFSET UNITYSDK_OFFSET(0x1764ADD0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONCLOSEUPTLSTART_OFFSET UNITYSDK_OFFSET(0x1764ABF0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONTIMESCALECHANGED_OFFSET UNITYSDK_OFFSET(0x1764A700)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x1763E120)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1763E930)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1763DD10)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1763DDC0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYBLUEPRINT_OFFSET UNITYSDK_OFFSET(0x17645FD0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYCHARACTERLIGHTSTL_OFFSET UNITYSDK_OFFSET(0x17647B80)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYITEMSHAKE_OFFSET UNITYSDK_OFFSET(0x17649F30)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYSTAGETEXSHEETBYBLACKBOARD_OFFSET UNITYSDK_OFFSET(0x176457F0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYSTAGETEXSHEET_OFFSET UNITYSDK_OFFSET(0x176459C0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYSUMMONSBORNANIMATION_OFFSET UNITYSDK_OFFSET(0x1763A950)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYTVEFFECTANIMLASTFRAME_OFFSET UNITYSDK_OFFSET(0x17649BB0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYTVEFFECTANIM_OFFSET UNITYSDK_OFFSET(0x176499B0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PRELOADITEMSTAGE_OFFSET UNITYSDK_OFFSET(0x17640430)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_REALSHOWCHARACTERLIGHTSV2_OFFSET UNITYSDK_OFFSET(0x17648140)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_REALSHOWCHARACTERLIGHTS_OFFSET UNITYSDK_OFFSET(0x17647C30)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_REFRESHITEMSTAGE_1_OFFSET UNITYSDK_OFFSET(0x17644AF0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_REFRESHITEMSTAGE_OFFSET UNITYSDK_OFFSET(0x176404C0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_REFRESHSTAGE_OFFSET UNITYSDK_OFFSET(0x17646490)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_REMOVECURENTITY_OFFSET UNITYSDK_OFFSET(0x17643AC0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_RESETUITEXT_1_OFFSET UNITYSDK_OFFSET(0x17644EF0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_RESETUITEXT_OFFSET UNITYSDK_OFFSET(0x17644DC0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_SETSUMMONSTIMESCALE_OFFSET UNITYSDK_OFFSET(0x17644880)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_SETTVMATPROPERTY_OFFSET UNITYSDK_OFFSET(0x1764A5D0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1764B170)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_STOPALLTVS_OFFSET UNITYSDK_OFFSET(0x17645EA0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_STOPPLAY_OFFSET UNITYSDK_OFFSET(0x17647870)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_STOPSOUND_OFFSET UNITYSDK_OFFSET(0x17647B40)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_STOPTVEFFECTANIM_OFFSET UNITYSDK_OFFSET(0x17649D40)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_STOPTV_OFFSET UNITYSDK_OFFSET(0x17645DD0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_UPDATESUMMONSANIMATORMANUALLY_OFFSET UNITYSDK_OFFSET(0x1764AE20)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_UPDATETVS_OFFSET UNITYSDK_OFFSET(0x1763F7A0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1763DD60)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1764B180)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE__REFRESHITEMSTAGE_B__18_0_OFFSET UNITYSDK_OFFSET(0x1764B6F0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE__REFRESHSTAGE_B__40_0_OFFSET UNITYSDK_OFFSET(0x1764B760)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x1764B770)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1764B830)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1764B840)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1764B850)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaStage3DModelControllerBase_TypeDefinitionIndex = 86533;
	...
	public:
		...
		::Class_1_CC527FA3839977FC* _timeSlowData; // 0x390
		...
		::Class_1_C376DB68B1C74261* _player; // 0x5A0
		::UnityEngine::Transform* _characterLightsTimelineRoot; // 0x5A8
		::Class_2_208CC9941471731A_385* _itemPerformTemplate; // 0x5B0
		...
		::Class_2_208CC9941471731A_384* _gachaPerformTamplate; // 0x608
		...
		::System::Void PlayBlueprint(::System::Single camRotateDuration, ::Class_2_208CC9941471731A_385* tamplate, ::System::Action* blueprintEndCb, ::System::Int32 performedPhaseCount, ::System::Int32 totalPhaseCount, ::System::String* overrideBlueprint)
		{
			return ((::System::Void(*)(::PVOID, ::System::Single, ::Class_2_208CC9941471731A_385*, ::System::Action*, ::System::Int32, ::System::Int32, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYBLUEPRINT_OFFSET))(this, camRotateDuration, tamplate, blueprintEndCb, performedPhaseCount, totalPhaseCount, overrideBlueprint);
		}
