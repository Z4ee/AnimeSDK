...
#define MOLEMOLE_UITABBTN01ROWWIDGETCONTROLLER_BINDNOTIFICATIONCOUNTNODE_1_OFFSET UNITYSDK_OFFSET(0x15F8E5D0)
#define MOLEMOLE_UITABBTN01ROWWIDGETCONTROLLER_BINDNOTIFICATIONCOUNTNODE_OFFSET UNITYSDK_OFFSET(0x15F8E390)
#define MOLEMOLE_UITABBTN01ROWWIDGETCONTROLLER_BINDNOTIFICATIONNODE_1_OFFSET UNITYSDK_OFFSET(0x15F8DD50)
#define MOLEMOLE_UITABBTN01ROWWIDGETCONTROLLER_BINDNOTIFICATIONNODE_OFFSET UNITYSDK_OFFSET(0x15F8DB10)
#define MOLEMOLE_UITABBTN01ROWWIDGETCONTROLLER_DISABLEBADGEWIDGET_OFFSET UNITYSDK_OFFSET(0x15F8E1D0)
#define MOLEMOLE_UITABBTN01ROWWIDGETCONTROLLER_ENABLEBADGEWIDGET_OFFSET UNITYSDK_OFFSET(0x15F8DF80)
#define MOLEMOLE_UITABBTN01ROWWIDGETCONTROLLER_GET_TABBUTTON_OFFSET UNITYSDK_OFFSET(0x15F8D6B0)
#define MOLEMOLE_UITABBTN01ROWWIDGETCONTROLLER_LAZYLOADNOTIFICATIONBADGEEXCOUNT_OFFSET UNITYSDK_OFFSET(0x15F8E430)
#define MOLEMOLE_UITABBTN01ROWWIDGETCONTROLLER_LAZYLOADNOTIFICATIONBADGEEX_OFFSET UNITYSDK_OFFSET(0x15F8DBB0)
#define MOLEMOLE_UITABBTN01ROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15F8E640)
#define MOLEMOLE_UITABBTN01ROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15F8E6D0)
#define MOLEMOLE_UITABBTN01ROWWIDGETCONTROLLER_SETICON_1_OFFSET UNITYSDK_OFFSET(0x15F8D830)
#define MOLEMOLE_UITABBTN01ROWWIDGETCONTROLLER_SETICON_2_OFFSET UNITYSDK_OFFSET(0x15F8D950)
#define MOLEMOLE_UITABBTN01ROWWIDGETCONTROLLER_SETICON_OFFSET UNITYSDK_OFFSET(0x15F8D770)
#define MOLEMOLE_UITABBTN01ROWWIDGETCONTROLLER_SETNOTIFICATIONBADGE_OFFSET UNITYSDK_OFFSET(0x15F8DDC0)
#define MOLEMOLE_UITABBTN01ROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15F8E750)
#define MOLEMOLE_UITABBTN01ROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15F8E7B0)
#define MOLEMOLE_UITABBTN01ROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15F8E840)

namespace MoleMole
{
	inline static constexpr unsigned int UITabBtn01RowWidgetController_TypeDefinitionIndex = 57849;
