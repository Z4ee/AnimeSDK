...
#define MOLEMOLE_CAMERALOCKBOSSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x116CC110)

namespace MoleMole
{
	inline static constexpr unsigned int CameraLockBossConfig_TypeDefinitionIndex = 81404;
