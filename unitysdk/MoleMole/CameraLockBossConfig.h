...
#define MOLEMOLE_CAMERALOCKBOSSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x10CD1F00)

namespace MoleMole
{
	inline static constexpr unsigned int CameraLockBossConfig_TypeDefinitionIndex = 56867;
