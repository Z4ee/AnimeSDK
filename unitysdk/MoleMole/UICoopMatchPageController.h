...
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_CHECKTABCLICKWITHTIPS_OFFSET UNITYSDK_OFFSET(0x17F70FD0)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_CHECKUNLOCKPOP_OFFSET UNITYSDK_OFFSET(0x17F725C0)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_DELTABLEVELNEW_OFFSET UNITYSDK_OFFSET(0x17F71030)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_GETTABANIM_OFFSET UNITYSDK_OFFSET(0x17F716D0)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_GETTABINDEX_OFFSET UNITYSDK_OFFSET(0x17F70BE0)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_GETTABTYPE_OFFSET UNITYSDK_OFFSET(0x17F708E0)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x17F6F720)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17F6F730)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_INITPLATFORMSETTING_OFFSET UNITYSDK_OFFSET(0x17F70390)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0x17F70C30)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17F6F7A0)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_ONGAMEROOMCHANGEDETAILHANDLE_OFFSET UNITYSDK_OFFSET(0x17F71D70)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_ONPOSTPAGESHOWED_OFFSET UNITYSDK_OFFSET(0x17F72500)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17F73100)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17F6F840)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17F722B0)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_PLAYTABFADEINANIM_OFFSET UNITYSDK_OFFSET(0x17F71A00)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_PLAYTABFADEOUTANIM_OFFSET UNITYSDK_OFFSET(0x17F71820)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_REFRESHTABANIM_OFFSET UNITYSDK_OFFSET(0x17F71090)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_SELECTTAB_OFFSET UNITYSDK_OFFSET(0x17F70930)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_SETPLATFORMBTNSHOWSTATE_OFFSET UNITYSDK_OFFSET(0x17F72390)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_SHOWTIP_OFFSET UNITYSDK_OFFSET(0x17F71FD0)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_STOPSWITCHANIM_OFFSET UNITYSDK_OFFSET(0x17F715A0)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_STOPTABANIM_OFFSET UNITYSDK_OFFSET(0x17F71BD0)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_TIPENDHANDLE_OFFSET UNITYSDK_OFFSET(0x17F72150)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x17F733E0)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17F73190)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER__ONPOSTPAGESHOWED_B__32_0_OFFSET UNITYSDK_OFFSET(0x17F73E10)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER__ONUIINIT_B__6_0_OFFSET UNITYSDK_OFFSET(0x17F73600)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER__ONUIINIT_B__6_1_OFFSET UNITYSDK_OFFSET(0x17F73640)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER__ONUIOPEN_B__31_0_OFFSET UNITYSDK_OFFSET(0x17F73CC0)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER__ONUIOPEN_B__31_1_OFFSET UNITYSDK_OFFSET(0x17F73DE0)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17F73E20)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER___BASE_ONPOSTPAGESHOWED_OFFSET UNITYSDK_OFFSET(0x17F73EC0)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17F73ED0)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17F73F90)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17F73FA0)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopMatchPageController_TypeDefinitionIndex = 44194;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::MoleMole::UICoopMatchPageController_LevelTabStatus, ::Il2CppArray<::System::String*>*>**)Il2CppClass::FromTypeDefinitionIndex(UICoopMatchPageController_TypeDefinitionIndex)->GetStaticField(0x4B120);
		}
		...
		::Class_2_C04F87C132BA9A06* _coopPlayModel; // 0x360
		::MoleMole::UIActivityCompWeekRewardBtnWidgetController* _rewardBtn; // 0x368
		::Class_3_1F2AB93F01651F88* _view; // 0x370
