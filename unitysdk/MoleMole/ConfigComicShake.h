...
#define MOLEMOLE_CONFIGCOMICSHAKE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B92CA30)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigComicShake_TypeDefinitionIndex = 82593;
