...
#define MOLEMOLE_CONFIGCOMICSHAKE__CTOR_OFFSET UNITYSDK_OFFSET(0x161A4270)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigComicShake_TypeDefinitionIndex = 51629;
