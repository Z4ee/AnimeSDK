...
#define MOLEMOLE_UIRABINLEVELBOTTOMWIDGETCONTROLLER_SFILTERKEYTEXT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x843F30)
#define MOLEMOLE_UIRABINLEVELBOTTOMWIDGETCONTROLLER_SFILTERKEYTEXT_EQUALS_OFFSET UNITYSDK_OFFSET(0x843E80)
#define MOLEMOLE_UIRABINLEVELBOTTOMWIDGETCONTROLLER_SFILTERKEYTEXT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x843F40)
#define MOLEMOLE_UIRABINLEVELBOTTOMWIDGETCONTROLLER_SFILTERKEYTEXT___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x844000)
#define MOLEMOLE_UIRABINLEVELBOTTOMWIDGETCONTROLLER_SFILTERKEYTEXT___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x844070)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABInLevelBottomWidgetController_SFilterKeyText_TypeDefinitionIndex = 63751;
