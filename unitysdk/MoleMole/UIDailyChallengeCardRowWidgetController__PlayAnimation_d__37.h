...
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER__PLAYANIMATION_D__37_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x87FB00)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER__PLAYANIMATION_D__37_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

namespace MoleMole
{
	inline static constexpr unsigned int UIDailyChallengeCardRowWidgetController__PlayAnimation_d__37_TypeDefinitionIndex = 54394;
	...
	struct alignas(8) UIDailyChallengeCardRowWidgetController__PlayAnimation_d__37
	{
		...
		::MoleMole::UIDailyChallengeCardRowWidgetController* __4__this; // 0x40
