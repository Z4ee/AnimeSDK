...
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER__PLAYANIMATION_D__37_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x79BEF0)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER__PLAYANIMATION_D__37_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2661E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIDailyChallengeCardRowWidgetController__PlayAnimation_d__37_TypeDefinitionIndex = 74954;
