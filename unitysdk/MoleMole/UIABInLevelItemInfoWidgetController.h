...
#define MOLEMOLE_UIABINLEVELITEMINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12381B90)
#define MOLEMOLE_UIABINLEVELITEMINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12381C20)
#define MOLEMOLE_UIABINLEVELITEMINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12381AB0)
#define MOLEMOLE_UIABINLEVELITEMINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12381B10)
#define MOLEMOLE_UIABINLEVELITEMINFOWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x12381CA0)
#define MOLEMOLE_UIABINLEVELITEMINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12382AB0)
#define MOLEMOLE_UIABINLEVELITEMINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12382B10)
#define MOLEMOLE_UIABINLEVELITEMINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12382BA0)
#define MOLEMOLE_UIABINLEVELITEMINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12382C30)
#define MOLEMOLE_UIABINLEVELITEMINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12382CC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIABInLevelItemInfoWidgetController_TypeDefinitionIndex = 66354;

	class UIABInLevelItemInfoWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_F3088E2F287D7C4D_1* _view; // 0x2B8
