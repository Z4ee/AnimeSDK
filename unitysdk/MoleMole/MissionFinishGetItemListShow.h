...
#define MOLEMOLE_MISSIONFINISHGETITEMLISTSHOW_DIRECTSHOW_OFFSET UNITYSDK_OFFSET(0x149F40C0)
#define MOLEMOLE_MISSIONFINISHGETITEMLISTSHOW_DOPROCESS_OFFSET UNITYSDK_OFFSET(0x149F4110)
#define MOLEMOLE_MISSIONFINISHGETITEMLISTSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x149F3C60)
#define MOLEMOLE_MISSIONFINISHGETITEMLISTSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x149F4070)
#define MOLEMOLE_MISSIONFINISHGETITEMLISTSHOW_SHOWREWARDWINDOW_OFFSET UNITYSDK_OFFSET(0x149F4160)
#define MOLEMOLE_MISSIONFINISHGETITEMLISTSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x149F3C70)

namespace MoleMole
{
	inline static constexpr unsigned int MissionFinishGetItemListShow_TypeDefinitionIndex = 60780;

	class MissionFinishGetItemListShow : public ::MoleMole::DisplayMessageBase
	{
	public:
		::Class_1_B46A33D0838CB6F0* _context; // 0x28
		::System::Collections::Generic::List_1<::Class_1_0D6706375CDAAE8C*>* items; // 0x30
