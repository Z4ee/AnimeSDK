...
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ALLOCRTUNIT_OFFSET UNITYSDK_OFFSET(0x16F08480)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_BINDNOTIFICATIONNODE_OFFSET UNITYSDK_OFFSET(0x16F122D0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_DESTROYWEAPONVIDEOPLAYER_OFFSET UNITYSDK_OFFSET(0x16F11D20)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_DOREFRESHVIEWCOMMON_OFFSET UNITYSDK_OFFSET(0x16F0E240)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_GETRTSOUNDGO_OFFSET UNITYSDK_OFFSET(0x16F12F20)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_GETWEAPONRTANIMATOR_OFFSET UNITYSDK_OFFSET(0x16F0C590)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x16F06140)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_GET_INPREVIEWMODE_OFFSET UNITYSDK_OFFSET(0x16F05FB0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_GET_ROTATESPEED_OFFSET UNITYSDK_OFFSET(0x16F0F7F0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x16F05FA0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_HANDLEZHENZHENWEAPONSTART_OFFSET UNITYSDK_OFFSET(0x16F0FE10)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x16F07220)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_INITWEAPON2DSWITCH_OFFSET UNITYSDK_OFFSET(0x16F0E080)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_INITWEAPONVIDEOPLAYER_OFFSET UNITYSDK_OFFSET(0x16F12CA0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ISHOLLOWGAMEROOM_OFFSET UNITYSDK_OFFSET(0x16F070B0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONBACKBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x16F08940)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONCLICKINFOBTN_OFFSET UNITYSDK_OFFSET(0x16F0B100)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONCLICKLEVELUPBTN_OFFSET UNITYSDK_OFFSET(0x16F0B310)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONCLICKPREVIEWBTN_OFFSET UNITYSDK_OFFSET(0x16F08FF0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONCLICKREFINELEVELPREVIEWBTN_OFFSET UNITYSDK_OFFSET(0x16F0B810)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONCLICKSPINFOBTN_OFFSET UNITYSDK_OFFSET(0x16F086A0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONCLICKSTARUPBTN_OFFSET UNITYSDK_OFFSET(0x16F08BC0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONCLICKSWITCHWEAPON2DBTN_OFFSET UNITYSDK_OFFSET(0x16F12500)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16F060B0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONEQUIPRTLOADED_OFFSET UNITYSDK_OFFSET(0x16F101A0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x16F116D0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x16F0BB20)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONITEMCHANGE_OFFSET UNITYSDK_OFFSET(0x16F11940)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x16F06150)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONMAINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x16F0B650)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONSHOWFRIENDPREVIEWMODEHINT_OFFSET UNITYSDK_OFFSET(0x16F08AD0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONSHOWPREVIEWMODEHINT_OFFSET UNITYSDK_OFFSET(0x16F089E0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16F10D70)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONSTORYINFOBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x16F06800)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONSTORYINFOGAMEPADBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x16F0B780)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x16F119A0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16F11B80)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16F10E80)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONWEAPONREFINECLOSEHANDLE_OFFSET UNITYSDK_OFFSET(0x16F08EF0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONWEAPONRTLOADED_OFFSET UNITYSDK_OFFSET(0x16F0FB60)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_PLAYVIDEOFORWEAPON_OFFSET UNITYSDK_OFFSET(0x16F12840)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_PROCESSUIAVATAR_OFFSET UNITYSDK_OFFSET(0x16F071D0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_REALLOCRTUNIT_OFFSET UNITYSDK_OFFSET(0x16F06F60)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_REFRESHANDPLAYLEVELUPANIM_OFFSET UNITYSDK_OFFSET(0x16F0CD30)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_REFRESHANDPLAYREFINEANIM_OFFSET UNITYSDK_OFFSET(0x16F0CE10)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_REFRESHAUDIOOCCLUSION_OFFSET UNITYSDK_OFFSET(0x16F130D0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_REFRESHMAINCITYBTN_OFFSET UNITYSDK_OFFSET(0x16F063B0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_REFRESHRTORVIDEO_OFFSET UNITYSDK_OFFSET(0x16F12250)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_REFRESHRT_OFFSET UNITYSDK_OFFSET(0x16F0F4D0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_REFRESHVIEWFOREQUIP_OFFSET UNITYSDK_OFFSET(0x16F0D020)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_REFRESHVIEWFORWEAPON_OFFSET UNITYSDK_OFFSET(0x16F09160)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x16F07000)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_RELEASERTUNIT_OFFSET UNITYSDK_OFFSET(0x16F08630)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_RESETGAMEPADLISTSELECT_OFFSET UNITYSDK_OFFSET(0x16F06690)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_SETBTNGAMEPADLISTFOCUS_OFFSET UNITYSDK_OFFSET(0x16F10980)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_SETROLEJUMPDATA_OFFSET UNITYSDK_OFFSET(0x16F10A30)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_SETSTAR_OFFSET UNITYSDK_OFFSET(0x16F0B980)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_SETUPSTARLIGHTNODES_OFFSET UNITYSDK_OFFSET(0x16F0C9B0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_SETWEAPONANIMATORENABLE_OFFSET UNITYSDK_OFFSET(0x16F0C830)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_SETWEAPONVIDEOTOGGLEBTNSTATE_OFFSET UNITYSDK_OFFSET(0x16F12170)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_SHOULDSHOWWEAPON2DSWITCH_OFFSET UNITYSDK_OFFSET(0x16F12100)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_SHOULDWEAPONSHOWSP_OFFSET UNITYSDK_OFFSET(0x16F10910)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_STOPVIDEOFORWEAPON_OFFSET UNITYSDK_OFFSET(0x16F12A60)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_TICKRTROTATING_OFFSET UNITYSDK_OFFSET(0x16F0BD90)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_TOGGLEAUDIOFORWEAPONVIDEO_OFFSET UNITYSDK_OFFSET(0x16F11D80)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_TRIGGERSTARTWEAPONPERFORM_OFFSET UNITYSDK_OFFSET(0x16F0C2C0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_TRYREADWEAPONVIDEONEW_OFFSET UNITYSDK_OFFSET(0x16F125C0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_TRYSETOCCLUSIONRTPCFORRTGO_OFFSET UNITYSDK_OFFSET(0x16F13220)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_TRYSETOCCULSIONRTPCFORVIDEO_OFFSET UNITYSDK_OFFSET(0x16F13460)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x16F0BD40)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x16F13610)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16F135B0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__INITVIEW_B__38_0_OFFSET UNITYSDK_OFFSET(0x16F13660)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__INITVIEW_B__38_1_OFFSET UNITYSDK_OFFSET(0x16F13670)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__INITWEAPONVIDEOPLAYER_B__106_0_OFFSET UNITYSDK_OFFSET(0x16F13EF0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__ONBACKBTNCLICKHANDLE_B__43_0_OFFSET UNITYSDK_OFFSET(0x16F136E0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__ONCLICKSPINFOBTN_B__42_0_OFFSET UNITYSDK_OFFSET(0x16F13680)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__ONCLICKSPINFOBTN_B__42_1_OFFSET UNITYSDK_OFFSET(0x16F136B0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__ONSTORYINFOBTNCLICKED_B__53_0_OFFSET UNITYSDK_OFFSET(0x16F13B10)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__ONUIOPEN_B__80_0_OFFSET UNITYSDK_OFFSET(0x16F13EC0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__ONUIOPEN_B__80_1_OFFSET UNITYSDK_OFFSET(0x16F13EE0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__REFRESHANDPLAYLEVELUPANIM_B__62_0_OFFSET UNITYSDK_OFFSET(0x16F13E20)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__REFRESHANDPLAYREFINEANIM_B__63_0_OFFSET UNITYSDK_OFFSET(0x16F13E40)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__STOPVIDEOFORWEAPON_B__109_1_OFFSET UNITYSDK_OFFSET(0x16F13F00)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__STOPVIDEOFORWEAPON_G__SETSTATE_109_0_OFFSET UNITYSDK_OFFSET(0x16F12E50)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__TRIGGERSTARTWEAPONPERFORM_B__58_0_OFFSET UNITYSDK_OFFSET(0x16F13CE0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16F13F80)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x16F14010)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x16F140A0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x16F140D0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16F14160)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x16F14170)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16F14230)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16F14240)

namespace MoleMole
{
	inline static constexpr unsigned int UIEquipDetailPageController_TypeDefinitionIndex = 48000;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIEquipDetailPageController_TypeDefinitionIndex)->GetStaticField(0x10370);
		}
		static ::System::Int32* StaticGet_SecondaryMask()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIEquipDetailPageController_TypeDefinitionIndex)->GetStaticField(0x10374);
		}
		...
		::Class_2_2DFDAF0B881128C6* _equipModel; // 0x338
		::Class_2_1824EF69C8E376A3* _avatarData; // 0x340
		::System::Collections::Generic::List_1<::Class_1_B14C7DE6F3342DD7*>* _equipStar; // 0x348
		...
		::Class_2_60638234271CCDB8_52* _view; // 0x388
		...
		::Class_1_6D9C9FB235F47E7C* _gamepadEquipStateProxy; // 0x3A8
