...
#define MOLEMOLE_FLOATRENDERERFADER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x161CB810)
#define MOLEMOLE_FLOATRENDERERFADER_METHOD_2_066A2A302F994390_OFFSET UNITYSDK_OFFSET(0x161CB510)
#define MOLEMOLE_FLOATRENDERERFADER_METHOD_2_128774387667156B_OFFSET UNITYSDK_OFFSET(0x161CC4C0)
#define MOLEMOLE_FLOATRENDERERFADER_METHOD_2_446DC60834959E58_OFFSET UNITYSDK_OFFSET(0x161CBCA0)
#define MOLEMOLE_FLOATRENDERERFADER_METHOD_2_665FCAD00B431E3A_OFFSET UNITYSDK_OFFSET(0x161CC200)
#define MOLEMOLE_FLOATRENDERERFADER_METHOD_2_C638E91FC0D3A13A_OFFSET UNITYSDK_OFFSET(0x161CC080)
#define MOLEMOLE_FLOATRENDERERFADER_METHOD_2_E8DB97264B6D98F7_OFFSET UNITYSDK_OFFSET(0x161CB300)
#define MOLEMOLE_FLOATRENDERERFADER_METHOD_2_FC67D285196A4120_OFFSET UNITYSDK_OFFSET(0x161CB620)
#define MOLEMOLE_FLOATRENDERERFADER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x161CB8B0)
#define MOLEMOLE_FLOATRENDERERFADER__CTOR_OFFSET UNITYSDK_OFFSET(0x161CB2F0)

namespace MoleMole
{
	inline static constexpr unsigned int FloatRendererFader_TypeDefinitionIndex = 84512;
