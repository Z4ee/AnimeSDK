...
#define MOLEMOLE_CDNCONFIGEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x122DD610)

namespace MoleMole
{
	inline static constexpr unsigned int CDNConfigExtension_TypeDefinitionIndex = 78464;
