...
#define MOLEMOLE_UIINLEVELCHATPLAYCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15FB6680)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelChatPlayContext_TypeDefinitionIndex = 47856;
