...
#define MOLEMOLE_UIINLEVELCHATPLAYCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F97CB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelChatPlayContext_TypeDefinitionIndex = 68689;
