...
#define MOLEMOLE_UIACTIVITYSKINREWARDV2WIDGETCONTROLLER_ONCLICKSKINBTN_OFFSET UNITYSDK_OFFSET(0x15A9F6E0)
#define MOLEMOLE_UIACTIVITYSKINREWARDV2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A9F060)
#define MOLEMOLE_UIACTIVITYSKINREWARDV2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A9F0F0)
#define MOLEMOLE_UIACTIVITYSKINREWARDV2WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A9EBF0)
#define MOLEMOLE_UIACTIVITYSKINREWARDV2WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15A9EFF0)
#define MOLEMOLE_UIACTIVITYSKINREWARDV2WIDGETCONTROLLER_SETROOTACTIVITYDATA_OFFSET UNITYSDK_OFFSET(0x15A9F480)
#define MOLEMOLE_UIACTIVITYSKINREWARDV2WIDGETCONTROLLER_SETSKINREWARDSTATE_OFFSET UNITYSDK_OFFSET(0x15A9F170)
#define MOLEMOLE_UIACTIVITYSKINREWARDV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15A9F770)
#define MOLEMOLE_UIACTIVITYSKINREWARDV2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A9F7D0)
#define MOLEMOLE_UIACTIVITYSKINREWARDV2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A9F860)
#define MOLEMOLE_UIACTIVITYSKINREWARDV2WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A9F8F0)
#define MOLEMOLE_UIACTIVITYSKINREWARDV2WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15A9F980)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivitySkinRewardV2WidgetController_TypeDefinitionIndex = 82647;

	class UIActivitySkinRewardV2WidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_1DB39C120B52CB5D* _view; // 0x2B8
		::System::Collections::Generic::List_1<::Class_2_1DB39C120B52CB5D_Class_2_47F94C3827CAB3BB_6*>* _roleImageView; // 0x2C0
		::Class_1_D375C91CCE5D3999* rootActivityData; // 0x2C8
		::Class_1_D375C91CCE5D3999* doubleSkinActivityData; // 0x2D0
