...
#define MOLEMOLE_UIACTIVITYSKINREWARDV2WIDGETCONTROLLER_ONCLICKSKINBTN_OFFSET UNITYSDK_OFFSET(0x18BDEBA0)
#define MOLEMOLE_UIACTIVITYSKINREWARDV2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18BDE590)
#define MOLEMOLE_UIACTIVITYSKINREWARDV2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18BDE620)
#define MOLEMOLE_UIACTIVITYSKINREWARDV2WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18BDE1C0)
#define MOLEMOLE_UIACTIVITYSKINREWARDV2WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18BDE520)
#define MOLEMOLE_UIACTIVITYSKINREWARDV2WIDGETCONTROLLER_SETROOTACTIVITYDATA_OFFSET UNITYSDK_OFFSET(0x18BDE9B0)
#define MOLEMOLE_UIACTIVITYSKINREWARDV2WIDGETCONTROLLER_SETSKINREWARDSTATE_OFFSET UNITYSDK_OFFSET(0x18BDE6A0)
#define MOLEMOLE_UIACTIVITYSKINREWARDV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18BDEC30)
#define MOLEMOLE_UIACTIVITYSKINREWARDV2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18BDEC90)
#define MOLEMOLE_UIACTIVITYSKINREWARDV2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18BDED20)
#define MOLEMOLE_UIACTIVITYSKINREWARDV2WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18BDEDB0)
#define MOLEMOLE_UIACTIVITYSKINREWARDV2WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18BDEE40)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivitySkinRewardV2WidgetController_TypeDefinitionIndex = 41280;

	class UIActivitySkinRewardV2WidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_1DB39C120B52CB5D* _view; // 0x2C0
		::System::Collections::Generic::List_1<::Class_2_1DB39C120B52CB5D_Class_2_47F94C3827CAB3BB_1*>* _roleImageView; // 0x2C8
