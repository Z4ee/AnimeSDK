...
#define MOLEMOLE_INLEVELINTERACTGAMEPADBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x12BC68A0)
#define MOLEMOLE_INLEVELINTERACTGAMEPADBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x12BC68B0)
#define MOLEMOLE_INLEVELINTERACTGAMEPADBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x12BC68C0)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelInteractGamepadBindingSettingEntry_TypeDefinitionIndex = 71856;
