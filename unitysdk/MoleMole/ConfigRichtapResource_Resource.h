...
#define MOLEMOLE_CONFIGRICHTAPRESOURCE_RESOURCE_GETAMPLITUDE_OFFSET UNITYSDK_OFFSET(0x17D33970)
#define MOLEMOLE_CONFIGRICHTAPRESOURCE_RESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x17D33A30)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigRichtapResource_Resource_TypeDefinitionIndex = 49156;
