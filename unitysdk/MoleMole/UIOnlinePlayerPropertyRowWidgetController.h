...
#define MOLEMOLE_UIONLINEPLAYERPROPERTYROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x151FB480)
#define MOLEMOLE_UIONLINEPLAYERPROPERTYROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x151FB510)
#define MOLEMOLE_UIONLINEPLAYERPROPERTYROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x151FB3B0)
#define MOLEMOLE_UIONLINEPLAYERPROPERTYROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x151FB410)
#define MOLEMOLE_UIONLINEPLAYERPROPERTYROWWIDGETCONTROLLER_SETDATA_OFFSET UNITYSDK_OFFSET(0x151FB590)
#define MOLEMOLE_UIONLINEPLAYERPROPERTYROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x151FB770)
#define MOLEMOLE_UIONLINEPLAYERPROPERTYROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x151FB7D0)
#define MOLEMOLE_UIONLINEPLAYERPROPERTYROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x151FB860)
#define MOLEMOLE_UIONLINEPLAYERPROPERTYROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x151FB8F0)
#define MOLEMOLE_UIONLINEPLAYERPROPERTYROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x151FB980)

namespace MoleMole
{
	inline static constexpr unsigned int UIOnlinePlayerPropertyRowWidgetController_TypeDefinitionIndex = 64812;

	class UIOnlinePlayerPropertyRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_3E1A0459A6647B99_3* _view; // 0x2B8
