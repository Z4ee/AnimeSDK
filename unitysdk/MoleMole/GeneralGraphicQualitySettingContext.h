...
#define MOLEMOLE_GENERALGRAPHICQUALITYSETTINGCONTEXT_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0x149ECBE0)
#define MOLEMOLE_GENERALGRAPHICQUALITYSETTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x149ECC30)
#define MOLEMOLE_GENERALGRAPHICQUALITYSETTINGCONTEXT___BASE_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0x149ECC50)

namespace MoleMole
{
	inline static constexpr unsigned int GeneralGraphicQualitySettingContext_TypeDefinitionIndex = 69867;
