...
#define MOLEMOLE_GENERALGRAPHICQUALITYSETTINGCONTEXT_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0x1261EAB0)
#define MOLEMOLE_GENERALGRAPHICQUALITYSETTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1261EB00)
#define MOLEMOLE_GENERALGRAPHICQUALITYSETTINGCONTEXT___BASE_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0x1261EB20)

namespace MoleMole
{
	inline static constexpr unsigned int GeneralGraphicQualitySettingContext_TypeDefinitionIndex = 42390;
