...
#define MOLEMOLE_UIBPITEMICONROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12B56D70)
#define MOLEMOLE_UIBPITEMICONROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x12B56E80)
#define MOLEMOLE_UIBPITEMICONROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12B56E00)
#define MOLEMOLE_UIBPITEMICONROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12B56C90)
#define MOLEMOLE_UIBPITEMICONROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12B57070)
#define MOLEMOLE_UIBPITEMICONROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12B57200)
#define MOLEMOLE_UIBPITEMICONROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x12B57290)
#define MOLEMOLE_UIBPITEMICONROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12B572F0)
#define MOLEMOLE_UIBPITEMICONROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12B57380)

namespace MoleMole
{
	inline static constexpr unsigned int UIBPItemIconRowWidgetController_TypeDefinitionIndex = 75366;

	class UIBPItemIconRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_A0E8715294BAB4D5* _view; // 0x2E8
		::Class_1_451601B8BB62C38C_12* viewData; // 0x2F0
		::MoleMole::UIItemIconBtnWidgetController* itemIconWidget; // 0x2F8
