...
#define MOLEMOLE_UIINLEVELMECHBOOPANELCHILDWINDOWCONTROLLER_CHANGEMATERIAL_OFFSET UNITYSDK_OFFSET(0x190FA7E0)
#define MOLEMOLE_UIINLEVELMECHBOOPANELCHILDWINDOWCONTROLLER_COLLECTALLANIMATIONCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x190FA720)
#define MOLEMOLE_UIINLEVELMECHBOOPANELCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x190F9530)
#define MOLEMOLE_UIINLEVELMECHBOOPANELCHILDWINDOWCONTROLLER_HANDLEALLCUSTOMPROPERTIESONSHOW_OFFSET UNITYSDK_OFFSET(0x190F9660)
#define MOLEMOLE_UIINLEVELMECHBOOPANELCHILDWINDOWCONTROLLER_HANDLECUSTOMPROPERTY_OFFSET UNITYSDK_OFFSET(0x190F9780)
#define MOLEMOLE_UIINLEVELMECHBOOPANELCHILDWINDOWCONTROLLER_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x190FA4C0)
#define MOLEMOLE_UIINLEVELMECHBOOPANELCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x190F9540)
#define MOLEMOLE_UIINLEVELMECHBOOPANELCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x190F95D0)
#define MOLEMOLE_UIINLEVELMECHBOOPANELCHILDWINDOWCONTROLLER_SETTHRESHOLDLINEPOSITION_OFFSET UNITYSDK_OFFSET(0x190FA480)
#define MOLEMOLE_UIINLEVELMECHBOOPANELCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x190FA820)
#define MOLEMOLE_UIINLEVELMECHBOOPANELCHILDWINDOWCONTROLLER___BASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x190FA830)
#define MOLEMOLE_UIINLEVELMECHBOOPANELCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x190FA8C0)
#define MOLEMOLE_UIINLEVELMECHBOOPANELCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x190FA950)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelMechBooPanelChildWindowController_TypeDefinitionIndex = 55199;
