...
#define MOLEMOLE_UIACTIVITYBLINDBOXWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17E156D0)
#define MOLEMOLE_UIACTIVITYBLINDBOXWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17E15740)
#define MOLEMOLE_UIACTIVITYBLINDBOXWIDGETCONTROLLER_ONFOCUS_OFFSET UNITYSDK_OFFSET(0x17E15C10)
#define MOLEMOLE_UIACTIVITYBLINDBOXWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x17E15D90)
#define MOLEMOLE_UIACTIVITYBLINDBOXWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17E157E0)
#define MOLEMOLE_UIACTIVITYBLINDBOXWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x17E16020)
#define MOLEMOLE_UIACTIVITYBLINDBOXWIDGETCONTROLLER_TABIDXCHANGED_OFFSET UNITYSDK_OFFSET(0x17E163C0)
#define MOLEMOLE_UIACTIVITYBLINDBOXWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17E16450)
#define MOLEMOLE_UIACTIVITYBLINDBOXWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17E164B0)
#define MOLEMOLE_UIACTIVITYBLINDBOXWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x17E16550)
#define MOLEMOLE_UIACTIVITYBLINDBOXWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17E165E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityBlindBoxWidgetController_TypeDefinitionIndex = 62695;
	...
	public:
		...
		{
			return ((::Class_2_EC28E1D3A39EE7DE_14*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIACTIVITYBLINDBOXWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
