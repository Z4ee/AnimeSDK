...
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_BINDNOTIFICATIONBADGE_OFFSET UNITYSDK_OFFSET(0x12E918D0)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_ENABLEWIDGET_OFFSET UNITYSDK_OFFSET(0x12E91970)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_GETSETTINGTYPE_OFFSET UNITYSDK_OFFSET(0x12E915E0)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_GETTABBUTTON_OFFSET UNITYSDK_OFFSET(0x12E913A0)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12E90EB0)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_ONHOLLOWEXITPOINT_OFFSET UNITYSDK_OFFSET(0x12E91100)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12E90F40)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12E90CE0)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_REFRESHPOINT_OFFSET UNITYSDK_OFFSET(0x12E91150)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_REGISTERREDPOINT_OFFSET UNITYSDK_OFFSET(0x12E91630)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_SETSETTINGTYPE_OFFSET UNITYSDK_OFFSET(0x12E91470)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_SETTABNAMEBYTEXTKEY_OFFSET UNITYSDK_OFFSET(0x12E91B20)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_SETTEXT_OFFSET UNITYSDK_OFFSET(0x12E91400)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_SHOWLOCK_OFFSET UNITYSDK_OFFSET(0x12E91B90)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12E91C00)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12E91C60)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12E91CF0)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12E91D80)

namespace MoleMole
{
	inline static constexpr unsigned int UITabBtn03RowWidgetController_TypeDefinitionIndex = 63781;

	class UITabBtn03RowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_F4F42734846BD0C3* _view; // 0x2B8
		::Enum_3_0F46F2034DC32D68 _hollowInfoType; // 0x2C0
		::MoleMole::ESystemSettingType _settingType; // 0x2C4
		::MoleMole::UIGeneralPopUpHintWidgetController* _popCtrl; // 0x2C8
		::System::Action* click; // 0x2D0
