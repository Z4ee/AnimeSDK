...
#define MOLEMOLE_UIAUTOBATTLEPVEROWWIDGETCONTROLLER_DATA_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x15AB02D0)
#define MOLEMOLE_UIAUTOBATTLEPVEROWWIDGETCONTROLLER_DATA_GET_STATE_OFFSET UNITYSDK_OFFSET(0x15AB0070)
#define MOLEMOLE_UIAUTOBATTLEPVEROWWIDGETCONTROLLER_DATA__CTOR_OFFSET UNITYSDK_OFFSET(0x15AB0310)

namespace MoleMole
{
	inline static constexpr unsigned int UIAutoBattlePVERowWidgetController_Data_TypeDefinitionIndex = 73102;

	class UIAutoBattlePVERowWidgetController_Data : public ::System::Object
	{
	public:
		::Class_2_208CC9941471731A_341* Template; // 0x10
