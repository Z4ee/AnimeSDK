...
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER_CANVASRTHELPER_POSTCREATEASSET_OFFSET UNITYSDK_OFFSET(0x19EB1500)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowChessboard3DModelController_CanvasRTHelper_TypeDefinitionIndex = 63284;
