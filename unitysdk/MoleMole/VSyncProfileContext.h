...
#define MOLEMOLE_VSYNCPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x10F17D30)

namespace MoleMole
{
	inline static constexpr unsigned int VSyncProfileContext_TypeDefinitionIndex = 90908;
