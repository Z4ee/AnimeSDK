...
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER_EMPTYROWDATA_OFFSET UNITYSDK_OFFSET(0x12E00D60)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER_GETMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x12E00EB0)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER_GETOVERRIDEMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x12E005A0)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x12E01180)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12E003B0)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER_ROWDATA_OFFSET UNITYSDK_OFFSET(0x12E00DF0)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12E016A0)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER___BASE_GETMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x12E016B0)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER___BASE_GETOVERRIDEMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x12E016E0)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER___BASE_INITVIEW_OFFSET UNITYSDK_OFFSET(0x12E01770)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12E01780)

namespace MoleMole
{
	inline static constexpr unsigned int UIMusicBattleResultPopWindowController_TypeDefinitionIndex = 49951;

	class UIMusicBattleResultPopWindowController : public ::MoleMole::UIHollowLayerResultPageV2PopWindowController
	{
	public:
		::MoleMole::UIHollowHollowLayerResultDialogContext* context; // 0x390
