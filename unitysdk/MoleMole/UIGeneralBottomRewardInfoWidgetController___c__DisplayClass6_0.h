...
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0x186C0F00)
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER___C__DISPLAYCLASS6_0__SETQUESTFIRSTREWARD_B__0_OFFSET UNITYSDK_OFFSET(0x186C0F10)
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER___C__DISPLAYCLASS6_0__SETQUESTFIRSTREWARD_B__1_OFFSET UNITYSDK_OFFSET(0x186C0F40)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralBottomRewardInfoWidgetController___c__DisplayClass6_0_TypeDefinitionIndex = 88008;
