...
#define MOLEMOLE_INLEVELQTELEFTKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x12F93290)
#define MOLEMOLE_INLEVELQTELEFTKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x12F932A0)
#define MOLEMOLE_INLEVELQTELEFTKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x12F932B0)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelQTELeftKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 81249;
