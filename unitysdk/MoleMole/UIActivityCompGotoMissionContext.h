...
#define MOLEMOLE_UIACTIVITYCOMPGOTOMISSIONCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6E6370)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityCompGotoMissionContext_TypeDefinitionIndex = 76431;
