...
#define MOLEMOLE_HOLLOWCARDCOMBINEANIMATIONCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x19DC45B0)

namespace MoleMole
{
	inline static constexpr unsigned int HollowCardCombineAnimationConfigs_TypeDefinitionIndex = 62345;
