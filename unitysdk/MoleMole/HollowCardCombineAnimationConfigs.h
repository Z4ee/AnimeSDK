...
#define MOLEMOLE_HOLLOWCARDCOMBINEANIMATIONCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x170D7460)

namespace MoleMole
{
	inline static constexpr unsigned int HollowCardCombineAnimationConfigs_TypeDefinitionIndex = 42992;
