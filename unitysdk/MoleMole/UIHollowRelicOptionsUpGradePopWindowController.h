...
#define MOLEMOLE_UIHOLLOWRELICOPTIONSUPGRADEPOPWINDOWCONTROLLER_CREATEITEM_OFFSET UNITYSDK_OFFSET(0x19618C00)
#define MOLEMOLE_UIHOLLOWRELICOPTIONSUPGRADEPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19618CB0)
#define MOLEMOLE_UIHOLLOWRELICOPTIONSUPGRADEPOPWINDOWCONTROLLER___BASE_CREATEITEM_OFFSET UNITYSDK_OFFSET(0x19618CC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowRelicOptionsUpGradePopWindowController_TypeDefinitionIndex = 90819;
