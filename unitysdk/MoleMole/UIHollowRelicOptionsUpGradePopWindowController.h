...
#define MOLEMOLE_UIHOLLOWRELICOPTIONSUPGRADEPOPWINDOWCONTROLLER_CREATEITEM_OFFSET UNITYSDK_OFFSET(0x15FAA4E0)
#define MOLEMOLE_UIHOLLOWRELICOPTIONSUPGRADEPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15FAA590)
#define MOLEMOLE_UIHOLLOWRELICOPTIONSUPGRADEPOPWINDOWCONTROLLER___BASE_CREATEITEM_OFFSET UNITYSDK_OFFSET(0x15FAA5A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowRelicOptionsUpGradePopWindowController_TypeDefinitionIndex = 58869;
