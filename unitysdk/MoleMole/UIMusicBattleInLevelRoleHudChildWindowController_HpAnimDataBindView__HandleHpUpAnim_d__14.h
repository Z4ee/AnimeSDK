...
#define MOLEMOLE_UIMUSICBATTLEINLEVELROLEHUDCHILDWINDOWCONTROLLER_HPANIMDATABINDVIEW__HANDLEHPUPANIM_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x79BF30)
#define MOLEMOLE_UIMUSICBATTLEINLEVELROLEHUDCHILDWINDOWCONTROLLER_HPANIMDATABINDVIEW__HANDLEHPUPANIM_D__14_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2661E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMusicBattleInLevelRoleHudChildWindowController_HpAnimDataBindView__HandleHpUpAnim_d__14_TypeDefinitionIndex = 44127;
