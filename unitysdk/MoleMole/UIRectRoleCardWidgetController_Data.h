...
#define MOLEMOLE_UIRECTROLECARDWIDGETCONTROLLER_DATA__CTOR_OFFSET UNITYSDK_OFFSET(0x15101DB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRectRoleCardWidgetController_Data_TypeDefinitionIndex = 43966;
