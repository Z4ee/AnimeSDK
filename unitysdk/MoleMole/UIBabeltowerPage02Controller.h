...
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_AFTERSHOWLEVELUPANIMATION_OFFSET UNITYSDK_OFFSET(0x175A6600)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_CALCULATECURRENTMVPCOUNT_OFFSET UNITYSDK_OFFSET(0x175A6650)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_CHECKNEWBIE_OFFSET UNITYSDK_OFFSET(0x175A6480)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_CREATEBOTTOM_OFFSET UNITYSDK_OFFSET(0x175A4EC0)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_CREATESELECTITEM_OFFSET UNITYSDK_OFFSET(0x175A4F70)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_CREATETOP_OFFSET UNITYSDK_OFFSET(0x175A4E10)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_GETFIGHTINFOWIDGET_OFFSET UNITYSDK_OFFSET(0x175A4370)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_GETTOTALPOWERCOUNT_OFFSET UNITYSDK_OFFSET(0x175A5F10)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_GET_CURRENTMVPCOUNT_OFFSET UNITYSDK_OFFSET(0x175A5EB0)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_INITSCROLL_OFFSET UNITYSDK_OFFSET(0x175A4160)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175A3DF0)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_ONFAIRYFINISH_OFFSET UNITYSDK_OFFSET(0x175A4050)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_ONPOSTREFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x175A5A30)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x175A3EF0)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_OPENRECORD_OFFSET UNITYSDK_OFFSET(0x175A50A0)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_OVERRIDEINITSCROLLINDEXANDFLOOR_OFFSET UNITYSDK_OFFSET(0x175A6230)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_REFRESHPOWER_OFFSET UNITYSDK_OFFSET(0x175A5D50)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_REFRESHTIME_OFFSET UNITYSDK_OFFSET(0x175A5310)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x175A59E0)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER__CREATESELECTITEM_B__9_0_OFFSET UNITYSDK_OFFSET(0x175A6840)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x175A67D0)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER__ONUIINIT_B__2_0_OFFSET UNITYSDK_OFFSET(0x175A6830)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER__OPENBABELTOWERFIGHTINGINFO_OFFSET UNITYSDK_OFFSET(0x175A4500)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER__OPENRECORD_B__10_0_OFFSET UNITYSDK_OFFSET(0x175A69B0)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER___BASE_AFTERSHOWLEVELUPANIMATION_OFFSET UNITYSDK_OFFSET(0x175A6B10)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER___BASE_GETFIGHTINFOWIDGET_OFFSET UNITYSDK_OFFSET(0x175A6BA0)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER___BASE_INITSCROLL_OFFSET UNITYSDK_OFFSET(0x175A6BB0)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175A6BC0)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER___BASE_ONPOSTREFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x175A6C90)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x175A6D40)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER___BASE_OVERRIDEINITSCROLLINDEXANDFLOOR_OFFSET UNITYSDK_OFFSET(0x175A6D50)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER___BASE_UPDATE_OFFSET UNITYSDK_OFFSET(0x175A6DF0)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER___BASE__OPENBABELTOWERFIGHTINGINFO_OFFSET UNITYSDK_OFFSET(0x175A6B00)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerPage02Controller_TypeDefinitionIndex = 46138;

	class UIBabeltowerPage02Controller : public ::MoleMole::UIBabeltowerPageController
	{
	public:
		::Class_2_79AE422BA06F6D26_73* _view; // 0x3D0
		::System::Int32 _currentMvp; // 0x3D8
