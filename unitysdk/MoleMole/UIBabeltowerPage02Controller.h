...
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_AFTERSHOWLEVELUPANIMATION_OFFSET UNITYSDK_OFFSET(0x19356670)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_CALCULATECURRENTMVPCOUNT_OFFSET UNITYSDK_OFFSET(0x193566C0)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_CHECKNEWBIE_OFFSET UNITYSDK_OFFSET(0x193564F0)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_CREATEBOTTOM_OFFSET UNITYSDK_OFFSET(0x19354F30)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_CREATESELECTITEM_OFFSET UNITYSDK_OFFSET(0x19354FE0)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_CREATETOP_OFFSET UNITYSDK_OFFSET(0x19354E80)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_GETFIGHTINFOWIDGET_OFFSET UNITYSDK_OFFSET(0x193543E0)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_GETTOTALPOWERCOUNT_OFFSET UNITYSDK_OFFSET(0x19355F80)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_GET_CURRENTMVPCOUNT_OFFSET UNITYSDK_OFFSET(0x19355F20)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_INITSCROLL_OFFSET UNITYSDK_OFFSET(0x193541D0)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19353E60)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_ONFAIRYFINISH_OFFSET UNITYSDK_OFFSET(0x193540C0)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_ONPOSTREFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x19355AA0)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19353F60)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_OPENRECORD_OFFSET UNITYSDK_OFFSET(0x19355110)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_OVERRIDEINITSCROLLINDEXANDFLOOR_OFFSET UNITYSDK_OFFSET(0x193562A0)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_REFRESHPOWER_OFFSET UNITYSDK_OFFSET(0x19355DC0)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_REFRESHTIME_OFFSET UNITYSDK_OFFSET(0x19355380)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x19355A50)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER__CREATESELECTITEM_B__9_0_OFFSET UNITYSDK_OFFSET(0x193568B0)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19356840)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER__ONUIINIT_B__2_0_OFFSET UNITYSDK_OFFSET(0x193568A0)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER__OPENBABELTOWERFIGHTINGINFO_OFFSET UNITYSDK_OFFSET(0x19354570)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER__OPENRECORD_B__10_0_OFFSET UNITYSDK_OFFSET(0x19356A20)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER___BASE_AFTERSHOWLEVELUPANIMATION_OFFSET UNITYSDK_OFFSET(0x19356B80)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER___BASE_GETFIGHTINFOWIDGET_OFFSET UNITYSDK_OFFSET(0x19356C10)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER___BASE_INITSCROLL_OFFSET UNITYSDK_OFFSET(0x19356C20)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19356C30)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER___BASE_ONPOSTREFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x19356D00)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19356DB0)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER___BASE_OVERRIDEINITSCROLLINDEXANDFLOOR_OFFSET UNITYSDK_OFFSET(0x19356DC0)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER___BASE_UPDATE_OFFSET UNITYSDK_OFFSET(0x19356E60)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER___BASE__OPENBABELTOWERFIGHTINGINFO_OFFSET UNITYSDK_OFFSET(0x19356B70)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerPage02Controller_TypeDefinitionIndex = 85331;

	class UIBabeltowerPage02Controller : public ::MoleMole::UIBabeltowerPageController
	{
	public:
		::Class_2_79AE422BA06F6D26* _view; // 0x3D0
