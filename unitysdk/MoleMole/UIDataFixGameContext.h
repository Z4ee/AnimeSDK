...
#define MOLEMOLE_UIDATAFIXGAMECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x167746C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIDataFixGameContext_TypeDefinitionIndex = 49667;
