...
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_BACKTOSELECT_OFFSET UNITYSDK_OFFSET(0x19893860)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_CREATEUIQUESTIONSANSWER3D3DMODELCONTROLLER_OFFSET UNITYSDK_OFFSET(0x19891230)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_CREATEUIQUESTIONSANSWERWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x19891180)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_CREATEUIQUESTIONSLISTWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x198910D0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x19891010)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_GET_THREEDWIDGET_OFFSET UNITYSDK_OFFSET(0x19891030)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x19891000)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_ONBACKCALLBACK_OFFSET UNITYSDK_OFFSET(0x19891520)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19891040)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x19891A10)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x19892260)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19891E10)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x198912C0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_PLAYTIMELINE_OFFSET UNITYSDK_OFFSET(0x19893040)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_SETBACKBTNACTIVE_OFFSET UNITYSDK_OFFSET(0x19893A60)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_SETENVIRONMENTENABLE_OFFSET UNITYSDK_OFFSET(0x19892220)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x19890F60)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_STARTGAMETASK_OFFSET UNITYSDK_OFFSET(0x198937D0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_STARTGAME_OFFSET UNITYSDK_OFFSET(0x19893480)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x198936A0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19893AD0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER__ONBACKCALLBACK_B__19_0_OFFSET UNITYSDK_OFFSET(0x19893AE0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER__ONBACKCALLBACK_B__19_1_OFFSET UNITYSDK_OFFSET(0x19893B40)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER__ONBACKCALLBACK_B__19_2_OFFSET UNITYSDK_OFFSET(0x19893BC0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER__ONBACKCALLBACK_B__19_3_OFFSET UNITYSDK_OFFSET(0x19893BF0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER__ONBACKCALLBACK_B__19_4_OFFSET UNITYSDK_OFFSET(0x19893BB0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19893C20)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x19893CB0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x19893D40)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19893DE0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19893DF0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x19893E00)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerPageController_TypeDefinitionIndex = 89531;
