...
#define MOLEMOLE_UIRABEXPTOPTIPSPOPWINDOWCONTROLLER_GET_IGNOREFADING_OFFSET UNITYSDK_OFFSET(0x1845ACF0)
#define MOLEMOLE_UIRABEXPTOPTIPSPOPWINDOWCONTROLLER_GET_ISALLOWINPUTPASS_OFFSET UNITYSDK_OFFSET(0x1845AD00)
#define MOLEMOLE_UIRABEXPTOPTIPSPOPWINDOWCONTROLLER_GET_UICURSORHIDESTATE_OFFSET UNITYSDK_OFFSET(0x1845AD10)
#define MOLEMOLE_UIRABEXPTOPTIPSPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1845AC70)
#define MOLEMOLE_UIRABEXPTOPTIPSPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1845AC80)
#define MOLEMOLE_UIRABEXPTOPTIPSPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1845AD20)
#define MOLEMOLE_UIRABEXPTOPTIPSPOPWINDOWCONTROLLER_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0x1845AFF0)
#define MOLEMOLE_UIRABEXPTOPTIPSPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1845ADC0)
#define MOLEMOLE_UIRABEXPTOPTIPSPOPWINDOWCONTROLLER_PLAYEXPTHENCLOSE_OFFSET UNITYSDK_OFFSET(0x1845B0E0)
#define MOLEMOLE_UIRABEXPTOPTIPSPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1845B160)
#define MOLEMOLE_UIRABEXPTOPTIPSPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1845B170)
#define MOLEMOLE_UIRABEXPTOPTIPSPOPWINDOWCONTROLLER___BASE_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0x1845B210)
#define MOLEMOLE_UIRABEXPTOPTIPSPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1845B220)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABExpTopTipsPopWindowController_TypeDefinitionIndex = 43146;
