...
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLER_APPLYITEMREF2BASECTRLER_OFFSET UNITYSDK_OFFSET(0x15B9AE30)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15B9AD30)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15B9ADC0)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15B9AC80)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15B9ACE0)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15B9BD50)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15B9BD60)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15B9BDF0)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15B9BE00)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15B9BE90)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaStageTv3DModelController_TypeDefinitionIndex = 80312;

	class UIGachaStageTv3DModelController : public ::MoleMole::UIGachaStageTv3DModelControllerBase
	{
	public:
		::Class_2_60638234271CCDB8_21* _view; // 0x6B0
