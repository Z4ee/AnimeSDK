...
#define MOLEMOLE_UIPLAYERSKINSWITCHTABWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15BF78D0)
#define MOLEMOLE_UIPLAYERSKINSWITCHTABWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15BF79E0)
#define MOLEMOLE_UIPLAYERSKINSWITCHTABWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15BF7960)
#define MOLEMOLE_UIPLAYERSKINSWITCHTABWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15BF74F0)
#define MOLEMOLE_UIPLAYERSKINSWITCHTABWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15BF7660)
#define MOLEMOLE_UIPLAYERSKINSWITCHTABWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15BF7A40)
#define MOLEMOLE_UIPLAYERSKINSWITCHTABWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15BF7A50)
#define MOLEMOLE_UIPLAYERSKINSWITCHTABWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15BF7AE0)
#define MOLEMOLE_UIPLAYERSKINSWITCHTABWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15BF7B80)
#define MOLEMOLE_UIPLAYERSKINSWITCHTABWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15BF7C10)
#define MOLEMOLE_UIPLAYERSKINSWITCHTABWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15BF7CA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPlayerSkinSwitchTabWidgetController_TypeDefinitionIndex = 77618;
