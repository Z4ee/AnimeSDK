...
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER__ANIMDAEMON_D__43_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x15C886F0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER__ANIMDAEMON_D__43_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15C89080)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER__ANIMDAEMON_D__43_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15C890E0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER__ANIMDAEMON_D__43_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x15C89090)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER__ANIMDAEMON_D__43_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15C886E0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER__ANIMDAEMON_D__43__CTOR_OFFSET UNITYSDK_OFFSET(0x15C886D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPasswordGameWidgetController__AnimDaemon_d__43_TypeDefinitionIndex = 74812;
