...
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER__ANIMDAEMON_D__43_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1820B840)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER__ANIMDAEMON_D__43_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1820C1B0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER__ANIMDAEMON_D__43_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1820C210)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER__ANIMDAEMON_D__43_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1820C1C0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER__ANIMDAEMON_D__43_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1820B830)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER__ANIMDAEMON_D__43__CTOR_OFFSET UNITYSDK_OFFSET(0x1820B820)

namespace MoleMole
{
	inline static constexpr unsigned int UIPasswordGameWidgetController__AnimDaemon_d__43_TypeDefinitionIndex = 49227;

	class UIPasswordGameWidgetController__AnimDaemon_d__43 : public ::System::Object
	{
	public:
		::MoleMole::UIPasswordGameWidgetController* __4__this; // 0x10
