...
#define MOLEMOLE_NAPSENDEVENT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1419FB10)
#define MOLEMOLE_NAPSENDEVENT_ONSTART_OFFSET UNITYSDK_OFFSET(0x1419F1B0)
#define MOLEMOLE_NAPSENDEVENT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1419F300)
#define MOLEMOLE_NAPSENDEVENT_RESOLVETARGET_OFFSET UNITYSDK_OFFSET(0x1419FB90)
#define MOLEMOLE_NAPSENDEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1419FE00)
#define MOLEMOLE_NAPSENDEVENT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1419FE90)
#define MOLEMOLE_NAPSENDEVENT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1419FF20)
#define MOLEMOLE_NAPSENDEVENT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1419FFB0)

namespace MoleMole
{
	inline static constexpr unsigned int NapSendEvent_TypeDefinitionIndex = 67336;
