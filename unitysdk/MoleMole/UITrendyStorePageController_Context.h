...
#define MOLEMOLE_UITRENDYSTOREPAGECONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x151B2840)

namespace MoleMole
{
	inline static constexpr unsigned int UITrendyStorePageController_Context_TypeDefinitionIndex = 59330;
