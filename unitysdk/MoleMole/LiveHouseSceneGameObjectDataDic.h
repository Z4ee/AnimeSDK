...
#define MOLEMOLE_LIVEHOUSESCENEGAMEOBJECTDATADIC__CTOR_OFFSET UNITYSDK_OFFSET(0x17380B90)

namespace MoleMole
{
	inline static constexpr unsigned int LiveHouseSceneGameObjectDataDic_TypeDefinitionIndex = 42547;
