...
#define MOLEMOLE_UIHANDBOOKWEEKENDBOSSITEMWIDGETCONTROLLER___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15FA1500)
#define MOLEMOLE_UIHANDBOOKWEEKENDBOSSITEMWIDGETCONTROLLER___C__DISPLAYCLASS8_0__ONSCROLLITEMUPDATE_B__1_OFFSET UNITYSDK_OFFSET(0x15FA1510)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookWeekendBossItemWidgetController___c__DisplayClass8_0_TypeDefinitionIndex = 59967;
