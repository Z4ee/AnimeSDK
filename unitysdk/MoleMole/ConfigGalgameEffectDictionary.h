...
#define MOLEMOLE_CONFIGGALGAMEEFFECTDICTIONARY__CTOR_OFFSET UNITYSDK_OFFSET(0x19FFE930)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigGalgameEffectDictionary_TypeDefinitionIndex = 85303;
