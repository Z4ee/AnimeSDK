...
#define MOLEMOLE_UIRABBATTLERESULTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15F272D0)
#define MOLEMOLE_UIRABBATTLERESULTPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15F272E0)
#define MOLEMOLE_UIRABBATTLERESULTPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15F27350)
#define MOLEMOLE_UIRABBATTLERESULTPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x15F277F0)
#define MOLEMOLE_UIRABBATTLERESULTPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x15F276F0)
#define MOLEMOLE_UIRABBATTLERESULTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15F27480)
#define MOLEMOLE_UIRABBATTLERESULTPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x15F273F0)
#define MOLEMOLE_UIRABBATTLERESULTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15F27960)
#define MOLEMOLE_UIRABBATTLERESULTPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15F27970)
#define MOLEMOLE_UIRABBATTLERESULTPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x15F27A10)
#define MOLEMOLE_UIRABBATTLERESULTPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x15F27A40)
#define MOLEMOLE_UIRABBATTLERESULTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15F27B00)
#define MOLEMOLE_UIRABBATTLERESULTPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x15F27B90)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABBattleResultPageController_TypeDefinitionIndex = 45553;
