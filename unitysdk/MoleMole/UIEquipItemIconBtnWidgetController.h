...
#define MOLEMOLE_UIEQUIPITEMICONBTNWIDGETCONTROLLER_GETISMATERIAL_OFFSET UNITYSDK_OFFSET(0x1697D6E0)
#define MOLEMOLE_UIEQUIPITEMICONBTNWIDGETCONTROLLER_GET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x1697D3E0)
#define MOLEMOLE_UIEQUIPITEMICONBTNWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1697D3F0)
#define MOLEMOLE_UIEQUIPITEMICONBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1697D730)
#define MOLEMOLE_UIEQUIPITEMICONBTNWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1697D750)

namespace MoleMole
{
	inline static constexpr unsigned int UIEquipItemIconBtnWidgetController_TypeDefinitionIndex = 74187;

	class UIEquipItemIconBtnWidgetController : public ::MoleMole::UIItemIconBtnWidgetController
	{
	public:
		::System::Action_1<::MoleMole::UIEquipItemIconBtnWidgetController*>* RefreshEquipStateAction; // 0x3C8
		::Class_1_0D6706375CDAAE8C* itemData; // 0x3D0
		::System::Boolean isMaterial; // 0x3D8
