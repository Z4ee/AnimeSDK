...
#define MOLEMOLE_UIEQUIPITEMICONBTNWIDGETCONTROLLER_GETISMATERIAL_OFFSET UNITYSDK_OFFSET(0x18D55A60)
#define MOLEMOLE_UIEQUIPITEMICONBTNWIDGETCONTROLLER_GET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x18D55760)
#define MOLEMOLE_UIEQUIPITEMICONBTNWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x18D55770)
#define MOLEMOLE_UIEQUIPITEMICONBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18D55AB0)
#define MOLEMOLE_UIEQUIPITEMICONBTNWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x18D55AD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIEquipItemIconBtnWidgetController_TypeDefinitionIndex = 62589;

	class UIEquipItemIconBtnWidgetController : public ::MoleMole::UIItemIconBtnWidgetController
	{
	public:
		::System::Action_1<::MoleMole::UIEquipItemIconBtnWidgetController*>* RefreshEquipStateAction; // 0x3D8
		::Class_1_0D6706375CDAAE8C* itemData; // 0x3E0
		::System::Boolean isMaterial; // 0x3E8
