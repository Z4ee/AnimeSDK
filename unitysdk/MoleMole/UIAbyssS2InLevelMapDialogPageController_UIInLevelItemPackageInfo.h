...
#define MOLEMOLE_UIABYSSS2INLEVELMAPDIALOGPAGECONTROLLER_UIINLEVELITEMPACKAGEINFO_GETTEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x15A86260)
#define MOLEMOLE_UIABYSSS2INLEVELMAPDIALOGPAGECONTROLLER_UIINLEVELITEMPACKAGEINFO_SETBRIEF_OFFSET UNITYSDK_OFFSET(0x15A862B0)
#define MOLEMOLE_UIABYSSS2INLEVELMAPDIALOGPAGECONTROLLER_UIINLEVELITEMPACKAGEINFO_SETSELECT_OFFSET UNITYSDK_OFFSET(0x15A86300)
#define MOLEMOLE_UIABYSSS2INLEVELMAPDIALOGPAGECONTROLLER_UIINLEVELITEMPACKAGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x15A86350)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2InLevelMapDialogPageController_UIInLevelItemPackageInfo_TypeDefinitionIndex = 45600;
	...
	public:
		...
		::System::Boolean UseGamepadSelectable; // 0x22
