...
#define MOLEMOLE_UIABYSSS2INLEVELMAPDIALOGPAGECONTROLLER_UIINLEVELITEMPACKAGEINFO_GETTEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x17420470)
#define MOLEMOLE_UIABYSSS2INLEVELMAPDIALOGPAGECONTROLLER_UIINLEVELITEMPACKAGEINFO_SETBRIEF_OFFSET UNITYSDK_OFFSET(0x174204C0)
#define MOLEMOLE_UIABYSSS2INLEVELMAPDIALOGPAGECONTROLLER_UIINLEVELITEMPACKAGEINFO_SETSELECT_OFFSET UNITYSDK_OFFSET(0x17420510)
#define MOLEMOLE_UIABYSSS2INLEVELMAPDIALOGPAGECONTROLLER_UIINLEVELITEMPACKAGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17420560)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2InLevelMapDialogPageController_UIInLevelItemPackageInfo_TypeDefinitionIndex = 62275;
