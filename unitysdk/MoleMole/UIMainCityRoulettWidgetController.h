...
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_AFTERMOUSEPOSSETHANDLE_OFFSET UNITYSDK_OFFSET(0x168CB840)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_CLAMPDIRECTIONVALUE_OFFSET UNITYSDK_OFFSET(0x168C5E60)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_CLICKBUTTON_OFFSET UNITYSDK_OFFSET(0x168C7D80)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_DOWNBUTTON_OFFSET UNITYSDK_OFFSET(0x168C8C80)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETCURRENTINDEX_OFFSET UNITYSDK_OFFSET(0x168C49C0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETDIRECTIONANDANGLE2D_OFFSET UNITYSDK_OFFSET(0x168C8300)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETIGNOREFADING_OFFSET UNITYSDK_OFFSET(0x168C1730)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETINDEXDIRECTIONVALUE_OFFSET UNITYSDK_OFFSET(0x168CA0F0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETMISTICKCURRENTINDEX_OFFSET UNITYSDK_OFFSET(0x168C4A10)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETNEWBIEDYNAMICOBJECT_OFFSET UNITYSDK_OFFSET(0x168C1770)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETRINGINNERRADIUS_OFFSET UNITYSDK_OFFSET(0x168C7470)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETROULETTEITEMCONFIGID_OFFSET UNITYSDK_OFFSET(0x168CB070)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETROULETTETXTKEY_OFFSET UNITYSDK_OFFSET(0x168CB6B0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETTARGETVIEW_OFFSET UNITYSDK_OFFSET(0x168C1A50)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETVECTORINDEX_OFFSET UNITYSDK_OFFSET(0x168C5530)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GET_IGNOREFADING_OFFSET UNITYSDK_OFFSET(0x168C16F0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GET_PLATFORMNEEDREFRESHROULETTETITLEVIEW_OFFSET UNITYSDK_OFFSET(0x168CB2F0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_HIDEROULETTETITLEVIEW_OFFSET UNITYSDK_OFFSET(0x168CAFD0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_INITSELECTINDEXONSHOW_OFFSET UNITYSDK_OFFSET(0x168C9B60)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x168C1B80)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ISSHOWCURSORMODE_OFFSET UNITYSDK_OFFSET(0x168C2320)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ISWITHINANGLE_OFFSET UNITYSDK_OFFSET(0x168C7FC0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ISWITHINRING_OFFSET UNITYSDK_OFFSET(0x168C7A50)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_JOYSTICK2WHEELPOINT_OFFSET UNITYSDK_OFFSET(0x168C8210)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x168C48E0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_NEEDREFRESHROULETTETITLEVIEW_OFFSET UNITYSDK_OFFSET(0x168CAE20)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_NEWBIECORRECT_OFFSET UNITYSDK_OFFSET(0x168C3610)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x168C34F0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONDOWNBUTTONCALLBACK_OFFSET UNITYSDK_OFFSET(0x168CA560)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONENTERBUTTONCALLBACK_OFFSET UNITYSDK_OFFSET(0x168CA5B0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONEXITBUTTONCALLBACK_OFFSET UNITYSDK_OFFSET(0x168CA7B0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x168C3450)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x168C3670)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONNOTIFY_OFFSET UNITYSDK_OFFSET(0x168C3390)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONPHOTOQUESTTIPSUPDATEHANDLE_OFFSET UNITYSDK_OFFSET(0x168CBAD0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x168C25A0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x168C3580)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x168C1AA0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x168C1E20)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONUNLOCKCHANGE_OFFSET UNITYSDK_OFFSET(0x168CA9C0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONWHEELSHORTCUTCHANGEHANDLE_OFFSET UNITYSDK_OFFSET(0x168CBB20)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x168C1E90)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x168C2420)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_PLAYTITLEFADEINANIM_OFFSET UNITYSDK_OFFSET(0x168CB7F0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_REFRESHBUTTON_OFFSET UNITYSDK_OFFSET(0x168C9100)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_REFRESHROULETTETITLEVIEWBYCONFIGID_OFFSET UNITYSDK_OFFSET(0x168CB200)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_REFRESHROULETTETITLEVIEW_OFFSET UNITYSDK_OFFSET(0x168CADA0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_REFRESHTITLETXT_OFFSET UNITYSDK_OFFSET(0x168CB4D0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_REGISTNOTIFY_OFFSET UNITYSDK_OFFSET(0x168C2FB0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_RINGANGLERANGEINDEX_OFFSET UNITYSDK_OFFSET(0x168C7C20)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_SETONCLICKBUTTON_OFFSET UNITYSDK_OFFSET(0x168C4A60)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_SHOWVIEW_OFFSET UNITYSDK_OFFSET(0x168C2790)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x168C72F0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_TRYREFRESHNOTIFY_OFFSET UNITYSDK_OFFSET(0x168C9480)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_UNREGISTNOTIFY_OFFSET UNITYSDK_OFFSET(0x168C2A00)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_UPBUTTON_OFFSET UNITYSDK_OFFSET(0x168C8EC0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_UPDATEARROW_OFFSET UNITYSDK_OFFSET(0x168C7070)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_UPDATESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x168C6940)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_UPDATESELECT_GAMEPAD_OFFSET UNITYSDK_OFFSET(0x168C3B70)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_UPDATESELECT_MOBILE_OFFSET UNITYSDK_OFFSET(0x168C8770)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_UPDATESELECT_MOUSENEW_OFFSET UNITYSDK_OFFSET(0x168C4200)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_UPDATESELECT_MOUSE_OFFSET UNITYSDK_OFFSET(0x168C4AB0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x168CBBC0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_GETNEWBIEDYNAMICOBJECT_OFFSET UNITYSDK_OFFSET(0x168CBC30)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x168CBCC0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x168CBD50)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x168CBDE0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x168CBE10)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x168CBEB0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x168CBF40)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x168CBFD0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x168CC060)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x168CC070)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityRoulettWidgetController_TypeDefinitionIndex = 78413;
	...
	public:
		...
		::Class_2_B61F7879B44C046D_Class_2_A8551DB78FCCDD55_1* _mobileView; // 0x2E8
		...
		static ::System::Int32 RingAngleRangeIndex(::UnityEngine::Vector2& joystick, ::UnityEngine::Vector2& center, ::System::Single& outerRadius, ::System::Single& angleRangeTolerance, ::Class_2_B61F7879B44C046D_Class_2_A8551DB78FCCDD55_1*& viewList, ::System::Func_2<::UnityEngine::Vector3, ::UnityEngine::Vector2>*& to2dSpace)
		{
			return ((::System::Int32(*)(::UnityEngine::Vector2&, ::UnityEngine::Vector2&, ::System::Single&, ::System::Single&, ::Class_2_B61F7879B44C046D_Class_2_A8551DB78FCCDD55_1*&, ::System::Func_2<::UnityEngine::Vector3, ::UnityEngine::Vector2>*&))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_RINGANGLERANGEINDEX_OFFSET))(joystick, center, outerRadius, angleRangeTolerance, viewList, to2dSpace);
		}
		...
		::System::Void InitView(::Class_2_B61F7879B44C046D_Class_2_A8551DB78FCCDD55_1* targetView)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_B61F7879B44C046D_Class_2_A8551DB78FCCDD55_1*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_INITVIEW_OFFSET))(this, targetView);
		}

		::System::Void ShowView(::Class_2_B61F7879B44C046D_Class_2_A8551DB78FCCDD55_1* targetView)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_B61F7879B44C046D_Class_2_A8551DB78FCCDD55_1*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_SHOWVIEW_OFFSET))(this, targetView);
		}
		...
		::Class_2_B61F7879B44C046D_Class_2_A8551DB78FCCDD55_1* GetTargetView()
		{
			return ((::Class_2_B61F7879B44C046D_Class_2_A8551DB78FCCDD55_1*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETTARGETVIEW_OFFSET))(this);
		}
