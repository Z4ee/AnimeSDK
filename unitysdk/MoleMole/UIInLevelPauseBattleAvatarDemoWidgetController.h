...
#define MOLEMOLE_UIINLEVELPAUSEBATTLEAVATARDEMOWIDGETCONTROLLER_REFRESHSHOWREWARDLIST_OFFSET UNITYSDK_OFFSET(0x155E8970)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEAVATARDEMOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x155E93A0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEAVATARDEMOWIDGETCONTROLLER___BASE_REFRESHSHOWREWARDLIST_OFFSET UNITYSDK_OFFSET(0x155E93B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseBattleAvatarDemoWidgetController_TypeDefinitionIndex = 71321;
