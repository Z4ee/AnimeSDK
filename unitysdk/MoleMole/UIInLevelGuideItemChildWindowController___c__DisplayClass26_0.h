...
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER___C__DISPLAYCLASS26_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1825E8D0)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER___C__DISPLAYCLASS26_0__SETVISIBLE_B__0_OFFSET UNITYSDK_OFFSET(0x1825E8E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelGuideItemChildWindowController___c__DisplayClass26_0_TypeDefinitionIndex = 79406;
