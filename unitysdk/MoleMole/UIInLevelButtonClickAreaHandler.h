...
#define MOLEMOLE_UIINLEVELBUTTONCLICKAREAHANDLER_CALCULATELAYOUT_OFFSET UNITYSDK_OFFSET(0x167D1F80)
#define MOLEMOLE_UIINLEVELBUTTONCLICKAREAHANDLER_METHOD_6_3BFE3B9EF8374F61_OFFSET UNITYSDK_OFFSET(0x167D1FD0)
#define MOLEMOLE_UIINLEVELBUTTONCLICKAREAHANDLER_METHOD_6_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x167D2360)
#define MOLEMOLE_UIINLEVELBUTTONCLICKAREAHANDLER_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x167D2320)
#define MOLEMOLE_UIINLEVELBUTTONCLICKAREAHANDLER_METHOD_6_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x167D2310)
#define MOLEMOLE_UIINLEVELBUTTONCLICKAREAHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x167D22C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelButtonClickAreaHandler_TypeDefinitionIndex = 45762;
