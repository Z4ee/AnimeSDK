...
#define MOLEMOLE_UIBALLGAMEMAINPAGECONTROLLER___C__DISPLAYCLASS25_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1ED533C0)
#define MOLEMOLE_UIBALLGAMEMAINPAGECONTROLLER___C__DISPLAYCLASS25_0__ONBALLPITINLEVELTRIGGERNEWBIE_B__0_OFFSET UNITYSDK_OFFSET(0x1ED533D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBallGameMainPageController___c__DisplayClass25_0_TypeDefinitionIndex = 93365;
