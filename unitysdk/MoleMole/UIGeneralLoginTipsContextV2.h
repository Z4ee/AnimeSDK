...
#define MOLEMOLE_UIGENERALLOGINTIPSCONTEXTV2__CTOR_OFFSET UNITYSDK_OFFSET(0x17D9B6D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralLoginTipsContextV2_TypeDefinitionIndex = 84657;
