...
#define MOLEMOLE_UIGENERALLOGINTIPSCONTEXTV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1730F2E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralLoginTipsContextV2_TypeDefinitionIndex = 45182;
