...
#define MOLEMOLE_UIACTIVITYTEAMTRIALINLEVELPAUSEBUFFINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15EC29F0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALINLEVELPAUSEBUFFINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15EC2A80)
#define MOLEMOLE_UIACTIVITYTEAMTRIALINLEVELPAUSEBUFFINFOWIDGETCONTROLLER_REFRESHBATTLEPHOTOWIDGET_OFFSET UNITYSDK_OFFSET(0x15EC2B00)
#define MOLEMOLE_UIACTIVITYTEAMTRIALINLEVELPAUSEBUFFINFOWIDGETCONTROLLER_REFRESHWIDGETINLEVEL_OFFSET UNITYSDK_OFFSET(0x15EC2C80)
#define MOLEMOLE_UIACTIVITYTEAMTRIALINLEVELPAUSEBUFFINFOWIDGETCONTROLLER_REFRESHWIDGET_OFFSET UNITYSDK_OFFSET(0x15EC3190)
#define MOLEMOLE_UIACTIVITYTEAMTRIALINLEVELPAUSEBUFFINFOWIDGETCONTROLLER_SHOWBUFF_OFFSET UNITYSDK_OFFSET(0x15EC3540)
#define MOLEMOLE_UIACTIVITYTEAMTRIALINLEVELPAUSEBUFFINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15EC3D70)
#define MOLEMOLE_UIACTIVITYTEAMTRIALINLEVELPAUSEBUFFINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15EC3DD0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALINLEVELPAUSEBUFFINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15EC3E60)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityTeamTrialInLevelPauseBuffInfoWidgetController_TypeDefinitionIndex = 43173;
	...
	public:
		...
		::System::Void RefreshBattlePhotoWidget(::Class_2_208CC9941471731A_396* activityBattleAbilityTemplate)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_396*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIACTIVITYTEAMTRIALINLEVELPAUSEBUFFINFOWIDGETCONTROLLER_REFRESHBATTLEPHOTOWIDGET_OFFSET))(this, activityBattleAbilityTemplate);
		}
