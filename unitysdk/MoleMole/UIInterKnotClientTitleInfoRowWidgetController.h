...
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_CLICKSELECT_OFFSET UNITYSDK_OFFSET(0x17DE5140)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17DE4440)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17DE44D0)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17DE42E0)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_SETARROW_OFFSET UNITYSDK_OFFSET(0x17DE5020)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_SETBYID_OFFSET UNITYSDK_OFFSET(0x17DE45A0)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_SETCB_OFFSET UNITYSDK_OFFSET(0x17DE4550)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_SETEPISODE_OFFSET UNITYSDK_OFFSET(0x17DE4E50)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_SETSHOWCONTENT_OFFSET UNITYSDK_OFFSET(0x17DE4DE0)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_SHOWINFO_OFFSET UNITYSDK_OFFSET(0x17DE4A00)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_SHOWTARGET_OFFSET UNITYSDK_OFFSET(0x17DE4BC0)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x17DE52C0)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17DE5260)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17DE52E0)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17DE5370)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17DE5400)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotClientTitleInfoRowWidgetController_TypeDefinitionIndex = 45905;
	...
	public:
		...
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(UIInterKnotClientTitleInfoRowWidgetController_TypeDefinitionIndex)->GetStaticField(0x12660);
		}
		static ::UnityEngine::Vector3* StaticGet_selectArrow()
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(UIInterKnotClientTitleInfoRowWidgetController_TypeDefinitionIndex)->GetStaticField(0x1266C);
		}
		...
		::System::Void SetById(::Class_2_208CC9941471731A_535* spConfig, ::System::Int32 questId, ::System::Boolean select)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_535*, ::System::Int32, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_SETBYID_OFFSET))(this, spConfig, questId, select);
		}
