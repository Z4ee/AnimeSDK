...
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_CLICKSELECT_OFFSET UNITYSDK_OFFSET(0x1528A770)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15289A70)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15289B00)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15289910)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_SETARROW_OFFSET UNITYSDK_OFFSET(0x1528A650)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_SETBYID_OFFSET UNITYSDK_OFFSET(0x15289BD0)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_SETCB_OFFSET UNITYSDK_OFFSET(0x15289B80)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_SETEPISODE_OFFSET UNITYSDK_OFFSET(0x1528A480)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_SETSHOWCONTENT_OFFSET UNITYSDK_OFFSET(0x1528A410)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_SHOWINFO_OFFSET UNITYSDK_OFFSET(0x1528A030)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_SHOWTARGET_OFFSET UNITYSDK_OFFSET(0x1528A1F0)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1528A8F0)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1528A890)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1528A910)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1528A9A0)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1528AA30)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotClientTitleInfoRowWidgetController_TypeDefinitionIndex = 55434;
	...
	public:
		...
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(UIInterKnotClientTitleInfoRowWidgetController_TypeDefinitionIndex)->GetStaticField(0x10D70);
		}
		static ::UnityEngine::Vector3* StaticGet_selectArrow()
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(UIInterKnotClientTitleInfoRowWidgetController_TypeDefinitionIndex)->GetStaticField(0x10D7C);
		}
		::Class_2_2FF629CF4A5DE934* _view; // 0x2B8
		::System::Action_1<::MoleMole::UIInterKnotClientTitleInfoRowWidgetController*>* _clickCallback; // 0x2C0
		::System::Int32 _questId; // 0x2C8
		::System::Boolean _isSelect; // 0x2CC
		...
		::System::Void SetById(::Class_2_208CC9941471731A_989* spConfig, ::System::Int32 questId, ::System::Boolean select)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_989*, ::System::Int32, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_SETBYID_OFFSET))(this, spConfig, questId, select);
		}
