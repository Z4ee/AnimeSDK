...
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER___C__DISPLAYCLASS37_0__CTOR_OFFSET UNITYSDK_OFFSET(0x197615A0)
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER___C__DISPLAYCLASS37_0__TRIGGERCLICKGUIDESTARTFADEINUIACTION_B__0_OFFSET UNITYSDK_OFFSET(0x197615B0)
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER___C__DISPLAYCLASS37_0__TRIGGERCLICKGUIDESTARTFADEINUIACTION_B__1_OFFSET UNITYSDK_OFFSET(0x19761600)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityRhythmClickPageController___c__DisplayClass37_0_TypeDefinitionIndex = 87500;
