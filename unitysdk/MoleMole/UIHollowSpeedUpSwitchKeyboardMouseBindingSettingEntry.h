...
#define MOLEMOLE_UIHOLLOWSPEEDUPSWITCHKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_LOCKEDSETTINGRAWINPUTDEVICELIST_OFFSET UNITYSDK_OFFSET(0x1488B3F0)
#define MOLEMOLE_UIHOLLOWSPEEDUPSWITCHKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1488B3D0)
#define MOLEMOLE_UIHOLLOWSPEEDUPSWITCHKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x1488B3E0)
#define MOLEMOLE_UIHOLLOWSPEEDUPSWITCHKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1488B480)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowSpeedUpSwitchKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 41000;
