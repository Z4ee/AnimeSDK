...
#define MOLEMOLE_COMMANDLINEANISOTROPICSAMPLING_METHOD_2_035B471DAE7665D5_OFFSET UNITYSDK_OFFSET(0x1347D4F0)
#define MOLEMOLE_COMMANDLINEANISOTROPICSAMPLING_METHOD_2_ABACFB27553ACD1B_OFFSET UNITYSDK_OFFSET(0x1347D3E0)
#define MOLEMOLE_COMMANDLINEANISOTROPICSAMPLING__CTOR_OFFSET UNITYSDK_OFFSET(0x1347D4B0)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineAnisotropicSampling_TypeDefinitionIndex = 52553;
