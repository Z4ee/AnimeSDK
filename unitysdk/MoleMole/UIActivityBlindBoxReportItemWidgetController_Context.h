...
#define MOLEMOLE_UIACTIVITYBLINDBOXREPORTITEMWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x138735E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityBlindBoxReportItemWidgetController_Context_TypeDefinitionIndex = 52273;
