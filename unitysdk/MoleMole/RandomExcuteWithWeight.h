...
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x10823320)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_CHOOSEEXCUTEINDEX_OFFSET UNITYSDK_OFFSET(0x10823080)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x108232D0)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_GETALLWEIGHT_OFFSET UNITYSDK_OFFSET(0x10823170)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x10822F80)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x10823370)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x108233D0)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_ONEND_OFFSET UNITYSDK_OFFSET(0x10823420)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_ONRESET_OFFSET UNITYSDK_OFFSET(0x10823470)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_ONSTART_OFFSET UNITYSDK_OFFSET(0x10823030)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x108234C0)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x108235B0)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT___BASE_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x10823640)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x108236D0)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x10823760)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT___BASE_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x108237F0)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x10823880)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x10823910)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x108239A0)

namespace MoleMole
{
	inline static constexpr unsigned int RandomExcuteWithWeight_TypeDefinitionIndex = 48375;
	...
	public:
		...
		::System::Int32 _excuteIndex; // 0x74
