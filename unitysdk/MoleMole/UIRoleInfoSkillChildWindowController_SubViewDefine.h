...
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_GET_REFRESH_OFFSET UNITYSDK_OFFSET(0x16DB0210)
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_GET_SETACTIVE_OFFSET UNITYSDK_OFFSET(0x16DB0220)
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x16DB0230)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleInfoSkillChildWindowController_SubViewDefine_TypeDefinitionIndex = 77492;
