...
#define MOLEMOLE_UIINLEVELCISSIAPANELCHILDWINDOWCONTROLLER_COLLECTALLANIMATIONCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x18374500)
#define MOLEMOLE_UIINLEVELCISSIAPANELCHILDWINDOWCONTROLLER_CREATEITEMCONTROLLER_OFFSET UNITYSDK_OFFSET(0x18374450)
#define MOLEMOLE_UIINLEVELCISSIAPANELCHILDWINDOWCONTROLLER_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0x18374270)
#define MOLEMOLE_UIINLEVELCISSIAPANELCHILDWINDOWCONTROLLER_GET_PLACEHOLDERKEY_CURPOINT_OFFSET UNITYSDK_OFFSET(0x183741F0)
#define MOLEMOLE_UIINLEVELCISSIAPANELCHILDWINDOWCONTROLLER_GET_PLACEHOLDERKEY_MAXPOINT_OFFSET UNITYSDK_OFFSET(0x18374230)
#define MOLEMOLE_UIINLEVELCISSIAPANELCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x183741E0)
#define MOLEMOLE_UIINLEVELCISSIAPANELCHILDWINDOWCONTROLLER_HANDLEALLCUSTOMPROPERTIESONSHOW_OFFSET UNITYSDK_OFFSET(0x18374540)
#define MOLEMOLE_UIINLEVELCISSIAPANELCHILDWINDOWCONTROLLER_HANDLECUSTOMPROPERTY_OFFSET UNITYSDK_OFFSET(0x18374610)
#define MOLEMOLE_UIINLEVELCISSIAPANELCHILDWINDOWCONTROLLER_HANDLEENHANCEMODE_OFFSET UNITYSDK_OFFSET(0x183746F0)
#define MOLEMOLE_UIINLEVELCISSIAPANELCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18374350)
#define MOLEMOLE_UIINLEVELCISSIAPANELCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x183743E0)
#define MOLEMOLE_UIINLEVELCISSIAPANELCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18374290)
#define MOLEMOLE_UIINLEVELCISSIAPANELCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x183742E0)
#define MOLEMOLE_UIINLEVELCISSIAPANELCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18374860)
#define MOLEMOLE_UIINLEVELCISSIAPANELCHILDWINDOWCONTROLLER___BASE_HANDLEALLCUSTOMPROPERTIESONSHOW_OFFSET UNITYSDK_OFFSET(0x18374940)
#define MOLEMOLE_UIINLEVELCISSIAPANELCHILDWINDOWCONTROLLER___BASE_HANDLECUSTOMPROPERTY_OFFSET UNITYSDK_OFFSET(0x18374950)
#define MOLEMOLE_UIINLEVELCISSIAPANELCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18374960)
#define MOLEMOLE_UIINLEVELCISSIAPANELCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x183749F0)
#define MOLEMOLE_UIINLEVELCISSIAPANELCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18374A00)
#define MOLEMOLE_UIINLEVELCISSIAPANELCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18374A10)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelCissiaPanelChildWindowController_TypeDefinitionIndex = 90151;
