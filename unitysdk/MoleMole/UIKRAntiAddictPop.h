...
#define MOLEMOLE_UIKRANTIADDICTPOP_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x16E7E790)
#define MOLEMOLE_UIKRANTIADDICTPOP_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x16E7E7D0)
#define MOLEMOLE_UIKRANTIADDICTPOP__CTOR_OFFSET UNITYSDK_OFFSET(0x16E7E7A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIKRAntiAddictPop_TypeDefinitionIndex = 75668;
