...
#define MOLEMOLE_GAMEPLAYTAG_EMPTY_OFFSET UNITYSDK_OFFSET(0x11754B90)
#define MOLEMOLE_GAMEPLAYTAG_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x71F1A0)
#define MOLEMOLE_GAMEPLAYTAG_EQUALS_OFFSET UNITYSDK_OFFSET(0x71F190)
#define MOLEMOLE_GAMEPLAYTAG_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x71F0B0)
#define MOLEMOLE_GAMEPLAYTAG_GET_INSTANCEID_OFFSET UNITYSDK_OFFSET(0x2F0420)
#define MOLEMOLE_GAMEPLAYTAG_GET_TAGNAME_OFFSET UNITYSDK_OFFSET(0x228FE0)
#define MOLEMOLE_GAMEPLAYTAG_INTERNALGETHASHCODE_OFFSET UNITYSDK_OFFSET(0x71F180)
#define MOLEMOLE_GAMEPLAYTAG_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x71EEF0)
#define MOLEMOLE_GAMEPLAYTAG_MATCH_OFFSET UNITYSDK_OFFSET(0x71EFB0)
#define MOLEMOLE_GAMEPLAYTAG_NAMEMATCH_OFFSET UNITYSDK_OFFSET(0x71EFD0)
#define MOLEMOLE_GAMEPLAYTAG_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x117552A0)
#define MOLEMOLE_GAMEPLAYTAG_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x11754E90)
#define MOLEMOLE_GAMEPLAYTAG_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x11755380)
#define MOLEMOLE_GAMEPLAYTAG_PURETAG_OFFSET UNITYSDK_OFFSET(0x71EF50)
#define MOLEMOLE_GAMEPLAYTAG_SET_INSTANCEID_OFFSET UNITYSDK_OFFSET(0x50A4B0)
#define MOLEMOLE_GAMEPLAYTAG_TOSTRING_OFFSET UNITYSDK_OFFSET(0x71F060)
#define MOLEMOLE_GAMEPLAYTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x39EDC0)
#define MOLEMOLE_GAMEPLAYTAG___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x71F2C0)
#define MOLEMOLE_GAMEPLAYTAG___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x71F330)
#define MOLEMOLE_GAMEPLAYTAG___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x71F240)

namespace MoleMole
{
	inline static constexpr unsigned int GameplayTag_TypeDefinitionIndex = 65292;
