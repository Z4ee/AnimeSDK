...
#define MOLEMOLE_MONOUILAYOUTADAPTOR_AUTOADAPTORUIBYSCREENRATE_OFFSET UNITYSDK_OFFSET(0x10D71080)
#define MOLEMOLE_MONOUILAYOUTADAPTOR_CALDRIVENTRANSFORMPROPERTIES_OFFSET UNITYSDK_OFFSET(0x10D71F50)
#define MOLEMOLE_MONOUILAYOUTADAPTOR_DOINITLAYOUT_OFFSET UNITYSDK_OFFSET(0x10D705B0)
#define MOLEMOLE_MONOUILAYOUTADAPTOR_FORCEREFRESHLAYOUT_OFFSET UNITYSDK_OFFSET(0x10D70530)
#define MOLEMOLE_MONOUILAYOUTADAPTOR_INITTRANSFORM_OFFSET UNITYSDK_OFFSET(0x10D708A0)
#define MOLEMOLE_MONOUILAYOUTADAPTOR_ISCONTAINPLATFORMUIPARAMS_OFFSET UNITYSDK_OFFSET(0x10D70450)
#define MOLEMOLE_MONOUILAYOUTADAPTOR_ISPLATFORMUIPARAMSEMPTY_OFFSET UNITYSDK_OFFSET(0x10D703B0)
#define MOLEMOLE_MONOUILAYOUTADAPTOR_RELOADDATAFROMJSON_OFFSET UNITYSDK_OFFSET(0x10D71C50)
#define MOLEMOLE_MONOUILAYOUTADAPTOR__CALDRIVENTRANSFORMPROPERTIES_G__CANBEIGNORE_10_0_OFFSET UNITYSDK_OFFSET(0x10D726A0)
#define MOLEMOLE_MONOUILAYOUTADAPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x10D72810)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUILayoutAdaptor_TypeDefinitionIndex = 65262;
