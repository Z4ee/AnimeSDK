...
#define MOLEMOLE_UIGROCERYCHILDCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x169D38A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGroceryChildContext_TypeDefinitionIndex = 43012;
