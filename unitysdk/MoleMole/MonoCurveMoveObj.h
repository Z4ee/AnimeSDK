...
#define MOLEMOLE_MONOCURVEMOVEOBJ_AWAKE_OFFSET UNITYSDK_OFFSET(0x19091800)
#define MOLEMOLE_MONOCURVEMOVEOBJ_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x19091850)
#define MOLEMOLE_MONOCURVEMOVEOBJ_METHOD_8_DFBBBBB761BF1414_OFFSET UNITYSDK_OFFSET(0x19092310)
#define MOLEMOLE_MONOCURVEMOVEOBJ_ONDOUPDATE_OFFSET UNITYSDK_OFFSET(0x190919A0)
#define MOLEMOLE_MONOCURVEMOVEOBJ__CTOR_OFFSET UNITYSDK_OFFSET(0x19092400)
#define MOLEMOLE_MONOCURVEMOVEOBJ___BASE_ONDOUPDATE_OFFSET UNITYSDK_OFFSET(0x19092510)

namespace MoleMole
{
	inline static constexpr unsigned int MonoCurveMoveObj_TypeDefinitionIndex = 44751;
	...
	public:
		...
		::System::Single Field_8_11; // 0x50
		::Il2CppArray<::System::Single>* timePeriods; // 0x58
		::Il2CppArray<::System::Single>* Field_8_9; // 0x60
		::System::String* UpCurveKey; // 0x68
		::System::String* DownCurveKey; // 0x70
		::UnityEngine::AnimationCurve* Field_8_14; // 0x78
		::UnityEngine::AnimationCurve* Field_8_13; // 0x80
		::System::String* SoundUpEvent; // 0x88
		::System::String* SoundDownEvent; // 0x90
		::System::Int32 Field_8_18; // 0x98
