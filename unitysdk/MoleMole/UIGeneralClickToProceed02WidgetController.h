...
#define MOLEMOLE_UIGENERALCLICKTOPROCEED02WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1679A780)
#define MOLEMOLE_UIGENERALCLICKTOPROCEED02WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1679A810)
#define MOLEMOLE_UIGENERALCLICKTOPROCEED02WIDGETCONTROLLER_SETURL_OFFSET UNITYSDK_OFFSET(0x1679A890)
#define MOLEMOLE_UIGENERALCLICKTOPROCEED02WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1679AA50)
#define MOLEMOLE_UIGENERALCLICKTOPROCEED02WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1679AAB0)
#define MOLEMOLE_UIGENERALCLICKTOPROCEED02WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1679AB40)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralClickToProceed02WidgetController_TypeDefinitionIndex = 42957;
