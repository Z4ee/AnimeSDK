...
#define MOLEMOLE_UIQUESTIONSANSWERCHATPLAYWIDGETCONTROLLER__FADEOUTCHATANDHIDE_D__28_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x871C50)
#define MOLEMOLE_UIQUESTIONSANSWERCHATPLAYWIDGETCONTROLLER__FADEOUTCHATANDHIDE_D__28_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerChatPlayWidgetController__FadeOutChatAndHide_d__28_TypeDefinitionIndex = 57030;
