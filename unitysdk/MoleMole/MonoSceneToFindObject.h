...
#define MOLEMOLE_MONOSCENETOFINDOBJECT_DOREALRESET_OFFSET UNITYSDK_OFFSET(0x158512F0)
#define MOLEMOLE_MONOSCENETOFINDOBJECT_DOSHOW_OFFSET UNITYSDK_OFFSET(0x1584FA90)
#define MOLEMOLE_MONOSCENETOFINDOBJECT_DOSTARTRESET_OFFSET UNITYSDK_OFFSET(0x158510A0)
#define MOLEMOLE_MONOSCENETOFINDOBJECT_DOUPDATE_OFFSET UNITYSDK_OFFSET(0x15850B70)
#define MOLEMOLE_MONOSCENETOFINDOBJECT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x15851430)
#define MOLEMOLE_MONOSCENETOFINDOBJECT_SETMAT_OFFSET UNITYSDK_OFFSET(0x1584FAF0)
#define MOLEMOLE_MONOSCENETOFINDOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x15851630)

namespace MoleMole
{
	inline static constexpr unsigned int MonoSceneToFindObject_TypeDefinitionIndex = 42886;
