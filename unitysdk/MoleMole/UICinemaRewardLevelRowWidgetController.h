...
#define MOLEMOLE_UICINEMAREWARDLEVELROWWIDGETCONTROLLER_GETVIEW_OFFSET UNITYSDK_OFFSET(0x16055700)
#define MOLEMOLE_UICINEMAREWARDLEVELROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x160555F0)
#define MOLEMOLE_UICINEMAREWARDLEVELROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16055680)
#define MOLEMOLE_UICINEMAREWARDLEVELROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x160554A0)
#define MOLEMOLE_UICINEMAREWARDLEVELROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16055580)
#define MOLEMOLE_UICINEMAREWARDLEVELROWWIDGETCONTROLLER_SETDESCRAWTEXT_OFFSET UNITYSDK_OFFSET(0x160557E0)
#define MOLEMOLE_UICINEMAREWARDLEVELROWWIDGETCONTROLLER_SETDESCTEXT_OFFSET UNITYSDK_OFFSET(0x16055750)
#define MOLEMOLE_UICINEMAREWARDLEVELROWWIDGETCONTROLLER_SETFAVOURICON_1_OFFSET UNITYSDK_OFFSET(0x160558C0)
#define MOLEMOLE_UICINEMAREWARDLEVELROWWIDGETCONTROLLER_SETFAVOURICON_OFFSET UNITYSDK_OFFSET(0x16055850)
#define MOLEMOLE_UICINEMAREWARDLEVELROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16055950)
#define MOLEMOLE_UICINEMAREWARDLEVELROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x160559B0)
#define MOLEMOLE_UICINEMAREWARDLEVELROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16055A00)
#define MOLEMOLE_UICINEMAREWARDLEVELROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16055A40)
#define MOLEMOLE_UICINEMAREWARDLEVELROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16055A80)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaRewardLevelRowWidgetController_TypeDefinitionIndex = 51312;
