...
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLAPPLYMODIFIER_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1998E0D0)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLAPPLYMODIFIER_INIT_OFFSET UNITYSDK_OFFSET(0x1998DB70)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLAPPLYMODIFIER_ISINSTANTSKILLTYPE_OFFSET UNITYSDK_OFFSET(0x1998E090)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLAPPLYMODIFIER_ONADD_OFFSET UNITYSDK_OFFSET(0x1998DCA0)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLAPPLYMODIFIER_ONRECYCLE_OFFSET UNITYSDK_OFFSET(0x1998E180)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLAPPLYMODIFIER_ONREMOVED_OFFSET UNITYSDK_OFFSET(0x1998DF10)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLAPPLYMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1998E210)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLAPPLYMODIFIER___BASE_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1998E230)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLAPPLYMODIFIER___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x1998E2E0)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLAPPLYMODIFIER___BASE_ISINSTANTSKILLTYPE_OFFSET UNITYSDK_OFFSET(0x1998E3B0)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLAPPLYMODIFIER___BASE_ONADD_OFFSET UNITYSDK_OFFSET(0x1998E440)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLAPPLYMODIFIER___BASE_ONREMOVED_OFFSET UNITYSDK_OFFSET(0x1998E4D0)

namespace MoleMole
{
	inline static constexpr unsigned int SummerEventDroneSubsystem_WeaponSkillApplyModifier_TypeDefinitionIndex = 47062;

	class SummerEventDroneSubsystem_WeaponSkillApplyModifier : public ::MoleMole::SummerEventDroneSubsystem_WeaponSkillBase
	{
	public:
		::Class_3_F41D242A20F8FE06* abilityComponent; // 0x38
