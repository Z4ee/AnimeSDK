...
#define MOLEMOLE_HORIZONTALLAYOUTGROUPADAPTOR_GET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x16B92530)
#define MOLEMOLE_HORIZONTALLAYOUTGROUPADAPTOR_SET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x16B92550)
#define MOLEMOLE_HORIZONTALLAYOUTGROUPADAPTOR_UPDATEPARAMS_OFFSET UNITYSDK_OFFSET(0x16B926F0)
#define MOLEMOLE_HORIZONTALLAYOUTGROUPADAPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16B925B0)

namespace MoleMole
{
	inline static constexpr unsigned int HorizontalLayoutGroupAdaptor_TypeDefinitionIndex = 67223;
