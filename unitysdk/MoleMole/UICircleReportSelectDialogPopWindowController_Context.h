...
#define MOLEMOLE_UICIRCLEREPORTSELECTDIALOGPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x14E860E0)

namespace MoleMole
{
	inline static constexpr unsigned int UICircleReportSelectDialogPopWindowController_Context_TypeDefinitionIndex = 51529;
