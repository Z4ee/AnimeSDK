...
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___C__DISPLAYCLASS11_2__CTOR_OFFSET UNITYSDK_OFFSET(0x177EAA00)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___C__DISPLAYCLASS11_2__REFRESHLEVELTXTVIEW_B__10_OFFSET UNITYSDK_OFFSET(0x177EAFA0)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___C__DISPLAYCLASS11_2__REFRESHLEVELTXTVIEW_B__4_OFFSET UNITYSDK_OFFSET(0x177EAA10)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___C__DISPLAYCLASS11_2__REFRESHLEVELTXTVIEW_B__5_OFFSET UNITYSDK_OFFSET(0x177EAAC0)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___C__DISPLAYCLASS11_2__REFRESHLEVELTXTVIEW_B__6_OFFSET UNITYSDK_OFFSET(0x177EB150)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___C__DISPLAYCLASS11_2__REFRESHLEVELTXTVIEW_B__9_OFFSET UNITYSDK_OFFSET(0x177EAF00)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralLevelUp02WidgetController___c__DisplayClass11_2_TypeDefinitionIndex = 64199;
	...
	public:
		...
		::System::Single remainExpRatio; // 0x38
