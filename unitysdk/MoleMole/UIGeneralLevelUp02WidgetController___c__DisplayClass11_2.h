...
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___C__DISPLAYCLASS11_2__CTOR_OFFSET UNITYSDK_OFFSET(0x155B7630)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___C__DISPLAYCLASS11_2__REFRESHLEVELTXTVIEW_B__10_OFFSET UNITYSDK_OFFSET(0x155B7BD0)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___C__DISPLAYCLASS11_2__REFRESHLEVELTXTVIEW_B__4_OFFSET UNITYSDK_OFFSET(0x155B7640)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___C__DISPLAYCLASS11_2__REFRESHLEVELTXTVIEW_B__5_OFFSET UNITYSDK_OFFSET(0x155B76F0)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___C__DISPLAYCLASS11_2__REFRESHLEVELTXTVIEW_B__6_OFFSET UNITYSDK_OFFSET(0x155B7D80)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___C__DISPLAYCLASS11_2__REFRESHLEVELTXTVIEW_B__9_OFFSET UNITYSDK_OFFSET(0x155B7B30)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralLevelUp02WidgetController___c__DisplayClass11_2_TypeDefinitionIndex = 57687;
	...
	public:
		...
		::MoleMole::UIGeneralLevelUp02WidgetController___c__DisplayClass11_0* CS___8__locals2; // 0x20
