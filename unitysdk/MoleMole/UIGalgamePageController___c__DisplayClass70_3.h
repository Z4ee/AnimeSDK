...
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS70_3__CTOR_OFFSET UNITYSDK_OFFSET(0x149D6990)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS70_3__PLAYSWITCHSCENEGROUPNODE_INNER_B__13_OFFSET UNITYSDK_OFFSET(0x149D7370)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS70_3__PLAYSWITCHSCENEGROUPNODE_INNER_B__14_OFFSET UNITYSDK_OFFSET(0x149D7380)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgamePageController___c__DisplayClass70_3_TypeDefinitionIndex = 41773;
