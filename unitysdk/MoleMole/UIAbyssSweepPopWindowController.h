...
#define MOLEMOLE_UIABYSSSWEEPPOPWINDOWCONTROLLER_GET_SWEEPBTN_OFFSET UNITYSDK_OFFSET(0x197C83E0)
#define MOLEMOLE_UIABYSSSWEEPPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x197C7AF0)
#define MOLEMOLE_UIABYSSSWEEPPOPWINDOWCONTROLLER_GOTOSHOP_OFFSET UNITYSDK_OFFSET(0x197C8340)
#define MOLEMOLE_UIABYSSSWEEPPOPWINDOWCONTROLLER_INITSWEEPBTN_OFFSET UNITYSDK_OFFSET(0x197C7ED0)
#define MOLEMOLE_UIABYSSSWEEPPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x197C8240)
#define MOLEMOLE_UIABYSSSWEEPPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x197C82D0)
#define MOLEMOLE_UIABYSSSWEEPPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x197C7B00)
#define MOLEMOLE_UIABYSSSWEEPPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x197C7DE0)
#define MOLEMOLE_UIABYSSSWEEPPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x197C80F0)
#define MOLEMOLE_UIABYSSSWEEPPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x197C83F0)
#define MOLEMOLE_UIABYSSSWEEPPOPWINDOWCONTROLLER__GOTOSHOP_B__9_0_OFFSET UNITYSDK_OFFSET(0x197C8460)
#define MOLEMOLE_UIABYSSSWEEPPOPWINDOWCONTROLLER__GOTOSHOP_B__9_1_OFFSET UNITYSDK_OFFSET(0x197C86E0)
#define MOLEMOLE_UIABYSSSWEEPPOPWINDOWCONTROLLER__GOTOSHOP_B__9_2_OFFSET UNITYSDK_OFFSET(0x197C87A0)
#define MOLEMOLE_UIABYSSSWEEPPOPWINDOWCONTROLLER__ONUIINIT_B__3_0_OFFSET UNITYSDK_OFFSET(0x197C8400)
#define MOLEMOLE_UIABYSSSWEEPPOPWINDOWCONTROLLER__ONUIINIT_B__3_1_OFFSET UNITYSDK_OFFSET(0x197C8440)
#define MOLEMOLE_UIABYSSSWEEPPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x197C8840)
#define MOLEMOLE_UIABYSSSWEEPPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x197C88D0)
#define MOLEMOLE_UIABYSSSWEEPPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x197C88E0)
#define MOLEMOLE_UIABYSSSWEEPPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x197C88F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssSweepPopWindowController_TypeDefinitionIndex = 47940;
	...
	public:
		...
		::System::Void _GoToShop_b__9_1()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABYSSSWEEPPOPWINDOWCONTROLLER__GOTOSHOP_B__9_1_OFFSET))(this);
		}
