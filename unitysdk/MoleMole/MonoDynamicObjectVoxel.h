...
#define MOLEMOLE_MONODYNAMICOBJECTVOXEL_METHOD_5_9275F47A24A5718D_OFFSET UNITYSDK_OFFSET(0x12F9C280)
#define MOLEMOLE_MONODYNAMICOBJECTVOXEL_METHOD_5_AFB6F6055EEF24B1_OFFSET UNITYSDK_OFFSET(0x12F9C010)
#define MOLEMOLE_MONODYNAMICOBJECTVOXEL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x12F9C0A0)
#define MOLEMOLE_MONODYNAMICOBJECTVOXEL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x12F9BEA0)
#define MOLEMOLE_MONODYNAMICOBJECTVOXEL__CTOR_OFFSET UNITYSDK_OFFSET(0x12F9C230)

namespace MoleMole
{
	inline static constexpr unsigned int MonoDynamicObjectVoxel_TypeDefinitionIndex = 49007;
