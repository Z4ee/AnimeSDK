...
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_CHECKNEWBIE_OFFSET UNITYSDK_OFFSET(0x172BB6C0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_CREATESELECTITEM_OFFSET UNITYSDK_OFFSET(0x172BBBF0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_GETFIGHTINFOWIDGET_OFFSET UNITYSDK_OFFSET(0x172BBA60)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_ONBABELTOWERUPDATERANK_OFFSET UNITYSDK_OFFSET(0x172BCB40)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x172BB9D0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x172BB830)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_ONPOSTREFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x172BBD20)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_ONTEACH_OFFSET UNITYSDK_OFFSET(0x172BCB90)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x172BB230)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x172BB4C0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_OPENRANKINFO_OFFSET UNITYSDK_OFFSET(0x172BD510)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0x172BC270)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_REFRESHPOWER_OFFSET UNITYSDK_OFFSET(0x172BC150)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_TEST_OFFSET UNITYSDK_OFFSET(0x172BB1C0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_UPDATERANKDATA_OFFSET UNITYSDK_OFFSET(0x172BD1B0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_UPDATERANKVIEW_OFFSET UNITYSDK_OFFSET(0x172BC8B0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x172BD130)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER__CREATESELECTITEM_B__10_0_OFFSET UNITYSDK_OFFSET(0x172BD850)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x172BD6E0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER__ONUIOPEN_B__5_0_OFFSET UNITYSDK_OFFSET(0x172BD780)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER__OPENRANKINFO_B__19_0_OFFSET UNITYSDK_OFFSET(0x172BD9C0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_CHECKNEWBIE_OFFSET UNITYSDK_OFFSET(0x172BDB90)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_CREATESELECTITEM_OFFSET UNITYSDK_OFFSET(0x172BDBA0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_GETFIGHTINFOWIDGET_OFFSET UNITYSDK_OFFSET(0x172BDBB0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x172BDBC0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x172BDBD0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_ONPOSTREFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x172BDC00)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x172BDC10)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x172BDC20)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0x172BDC30)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_UPDATE_OFFSET UNITYSDK_OFFSET(0x172BDC40)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerPage03Controller_TypeDefinitionIndex = 61542;

	class UIBabeltowerPage03Controller : public ::MoleMole::UIBabeltowerPage02Controller
	{
	public:
		::Class_2_79AE422BA06F6D26_73* _view; // 0x3E0
