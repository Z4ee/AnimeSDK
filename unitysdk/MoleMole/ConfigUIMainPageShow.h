...
#define MOLEMOLE_CONFIGUIMAINPAGESHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C486CE0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIMainPageShow_TypeDefinitionIndex = 42758;
