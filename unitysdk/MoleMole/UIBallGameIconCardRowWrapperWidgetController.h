...
#define MOLEMOLE_UIBALLGAMEICONCARDROWWRAPPERWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19307BF0)
#define MOLEMOLE_UIBALLGAMEICONCARDROWWRAPPERWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19307C60)
#define MOLEMOLE_UIBALLGAMEICONCARDROWWRAPPERWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x19307D00)
#define MOLEMOLE_UIBALLGAMEICONCARDROWWRAPPERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19307EC0)
#define MOLEMOLE_UIBALLGAMEICONCARDROWWRAPPERWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19307F20)
#define MOLEMOLE_UIBALLGAMEICONCARDROWWRAPPERWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x19307FC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBallGameIconCardRowWrapperWidgetController_TypeDefinitionIndex = 74340;
