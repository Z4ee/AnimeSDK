...
#define MOLEMOLE_TWEENPOSITION_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x13F36880)
#define MOLEMOLE_TWEENPOSITION_METHOD_7_08B7287B59325288_OFFSET UNITYSDK_OFFSET(0x13F36A20)
#define MOLEMOLE_TWEENPOSITION_METHOD_7_626C719A884DEF9A_OFFSET UNITYSDK_OFFSET(0x13F36990)
#define MOLEMOLE_TWEENPOSITION_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x13F368A0)
#define MOLEMOLE_TWEENPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x13F36AD0)
#define MOLEMOLE_TWEENPOSITION___BASE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x13F36AF0)

namespace MoleMole
{
	inline static constexpr unsigned int TweenPosition_TypeDefinitionIndex = 48980;
