...
#define MOLEMOLE_CINEMAOPENPAGEPOPMESSAGE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x12B11950)
#define MOLEMOLE_CINEMAOPENPAGEPOPMESSAGE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x12B11970)
#define MOLEMOLE_CINEMAOPENPAGEPOPMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x12B11960)

namespace MoleMole
{
	inline static constexpr unsigned int CinemaOpenPagePopMessage_TypeDefinitionIndex = 74991;
