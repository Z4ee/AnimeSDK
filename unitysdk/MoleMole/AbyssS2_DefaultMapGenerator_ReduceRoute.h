...
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_REDUCEROUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x12795570)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_DefaultMapGenerator_ReduceRoute_TypeDefinitionIndex = 87622;
