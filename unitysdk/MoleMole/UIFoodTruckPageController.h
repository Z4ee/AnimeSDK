...
class Class_2_82E7DB6BA9499BE4_1;
namespace DG::Tweening { class Tween; }
namespace MoleMole { class UIActivityCompWeekRewardBtnWidgetController; }
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }

#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_CHECKCB_OFFSET UNITYSDK_OFFSET(0x16DB4800)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x16DAF9D0)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_ONACTIVECHANGEACTION_OFFSET UNITYSDK_OFFSET(0x16DB4C90)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_ONCLICKOKBUTTONCALLBACK_OFFSET UNITYSDK_OFFSET(0x16DB5380)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0x16DB4EE0)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16DAFA80)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_ONFADEINANIMATION_OFFSET UNITYSDK_OFFSET(0x16DB3F50)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_ONSTARFADEINANIMATION_OFFSET UNITYSDK_OFFSET(0x16DB0ED0)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x16DB46B0)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16DB4D10)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16DAFB10)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16DAFDF0)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_REFRESHALLTABS_OFFSET UNITYSDK_OFFSET(0x16DB1210)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_REFRESHQUEST_OFFSET UNITYSDK_OFFSET(0x16DB19B0)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x16DAF9E0)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16DB5690)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16DB56B0)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x16DB5740)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16DB5750)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16DB5760)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16DB5770)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x16DB5780)

namespace MoleMole
{
	inline static constexpr unsigned int UIFoodTruckPageController_TypeDefinitionIndex = 59335;

	class UIFoodTruckPageController : public ::MoleMole::UIMainCityStorePageController
	{
	public:
		::Class_2_82E7DB6BA9499BE4_1* _view; // 0x328
