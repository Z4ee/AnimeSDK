...
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW_ADDMONSTERIDTOLISTBYCFGID_OFFSET UNITYSDK_OFFSET(0x171591D0)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW_GETBOSSLEVEL_OFFSET UNITYSDK_OFFSET(0x17159620)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW_GETHOLLOWMONSTERIDLIST_OFFSET UNITYSDK_OFFSET(0x17158850)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW_GETLEVELSTRBYID_OFFSET UNITYSDK_OFFSET(0x17159580)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW_UPDATEBOSSCFGLIST_OFFSET UNITYSDK_OFFSET(0x171586A0)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x17159790)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW___BASE_GETBOSSLEVEL_OFFSET UNITYSDK_OFFSET(0x17159830)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW___BASE_UPDATEBOSSCFGLIST_OFFSET UNITYSDK_OFFSET(0x171598C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterCardInfoPopWindowController_Hollow_TypeDefinitionIndex = 72746;

	class UIMonsterCardInfoPopWindowController_Hollow : public ::MoleMole::UIMonsterCardInfoPopWindowController
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::System::Int32>*>* HollowMonsterIDToAppearLevelDict; // 0x370
