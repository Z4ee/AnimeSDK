...
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW_ADDMONSTERIDTOLISTBYCFGID_OFFSET UNITYSDK_OFFSET(0x183BED40)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW_GETBOSSLEVEL_OFFSET UNITYSDK_OFFSET(0x183BF1A0)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW_GETHOLLOWMONSTERIDLIST_OFFSET UNITYSDK_OFFSET(0x183BE3B0)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW_GETLEVELSTRBYID_OFFSET UNITYSDK_OFFSET(0x183BF100)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW_UPDATEBOSSCFGLIST_OFFSET UNITYSDK_OFFSET(0x183BE200)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x183BF310)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW___BASE_GETBOSSLEVEL_OFFSET UNITYSDK_OFFSET(0x183BF3B0)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW___BASE_UPDATEBOSSCFGLIST_OFFSET UNITYSDK_OFFSET(0x183BF440)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterCardInfoPopWindowController_Hollow_TypeDefinitionIndex = 52951;

	class UIMonsterCardInfoPopWindowController_Hollow : public ::MoleMole::UIMonsterCardInfoPopWindowController
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::System::Int32>*>* HollowMonsterIDToAppearLevelDict; // 0x368
