...
#define MOLEMOLE_UIACTIVITYHOTPOTSTRATEGYWIDGETCONTROLLER_HASCARD_OFFSET UNITYSDK_OFFSET(0x15615DF0)
#define MOLEMOLE_UIACTIVITYHOTPOTSTRATEGYWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15615400)
#define MOLEMOLE_UIACTIVITYHOTPOTSTRATEGYWIDGETCONTROLLER_ONHOTPOTLEVELSELECT_OFFSET UNITYSDK_OFFSET(0x156159F0)
#define MOLEMOLE_UIACTIVITYHOTPOTSTRATEGYWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x15615AB0)
#define MOLEMOLE_UIACTIVITYHOTPOTSTRATEGYWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15615510)
#define MOLEMOLE_UIACTIVITYHOTPOTSTRATEGYWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15615490)
#define MOLEMOLE_UIACTIVITYHOTPOTSTRATEGYWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15615240)
#define MOLEMOLE_UIACTIVITYHOTPOTSTRATEGYWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15615300)
#define MOLEMOLE_UIACTIVITYHOTPOTSTRATEGYWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x15615600)
#define MOLEMOLE_UIACTIVITYHOTPOTSTRATEGYWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15616000)
#define MOLEMOLE_UIACTIVITYHOTPOTSTRATEGYWIDGETCONTROLLER__ONUIOPEN_B__4_0_OFFSET UNITYSDK_OFFSET(0x15616060)
#define MOLEMOLE_UIACTIVITYHOTPOTSTRATEGYWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x156160E0)
#define MOLEMOLE_UIACTIVITYHOTPOTSTRATEGYWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x15616170)
#define MOLEMOLE_UIACTIVITYHOTPOTSTRATEGYWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15616200)
#define MOLEMOLE_UIACTIVITYHOTPOTSTRATEGYWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x156162A0)
#define MOLEMOLE_UIACTIVITYHOTPOTSTRATEGYWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15616330)
#define MOLEMOLE_UIACTIVITYHOTPOTSTRATEGYWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x156163C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityHotPotStrategyWidgetController_TypeDefinitionIndex = 47608;

	class UIActivityHotPotStrategyWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_FBB8E5C056021DB6_3* _view; // 0x2B8
		::MoleMole::UIActivityHotPotStrategyWidgetController_Data* data; // 0x2C0
