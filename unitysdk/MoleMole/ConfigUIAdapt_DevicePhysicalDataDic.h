...
#define MOLEMOLE_CONFIGUIADAPT_DEVICEPHYSICALDATADIC__CTOR_OFFSET UNITYSDK_OFFSET(0x153E0370)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIAdapt_DevicePhysicalDataDic_TypeDefinitionIndex = 75585;
