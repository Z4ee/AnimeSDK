...
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_CHECKCANTOGGLEHANDLE_OFFSET UNITYSDK_OFFSET(0x169A6130)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_CLEARLASTTABMANUALNEW_OFFSET UNITYSDK_OFFSET(0x169A56A0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_CLEARMANUALNEWS_OFFSET UNITYSDK_OFFSET(0x169A79A0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_GETCANENTERWORLDSTATE_OFFSET UNITYSDK_OFFSET(0x169AA1A0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_GETCURRENTTOPIC_OFFSET UNITYSDK_OFFSET(0x169AB5D0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_GETLATESTSEASON_OFFSET UNITYSDK_OFFSET(0x169AB390)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_GETMAINMANUALBYSEASONID_OFFSET UNITYSDK_OFFSET(0x169AB150)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_GETMANUALCOMPARE_OFFSET UNITYSDK_OFFSET(0x169ABC60)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_GETQUESTDESCPREFIX_OFFSET UNITYSDK_OFFSET(0x169AC900)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x169A4970)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_HASMAINQUEST_OFFSET UNITYSDK_OFFSET(0x169AB060)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_HASTRACKQUEST_OFFSET UNITYSDK_OFFSET(0x169AA9C0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_INITMISSION_OFFSET UNITYSDK_OFFSET(0x169A6F60)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ISTRACKINGPERSONALQUEST_OFFSET UNITYSDK_OFFSET(0x169AF250)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONCLICLGROUPTAB_OFFSET UNITYSDK_OFFSET(0x169A5EA0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x169A6220)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONCREATMISSIONITEM_OFFSET UNITYSDK_OFFSET(0x169A78D0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONGENERALTOGGLEHANDLE_OFFSET UNITYSDK_OFFSET(0x169A7790)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x169A5610)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONINTERKNOTMISSIONBANNERTRACK_OFFSET UNITYSDK_OFFSET(0x169A81B0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x169AF290)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONMISSIONITEMCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x169A62B0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONPREUNLOCKSEASONFINISH_OFFSET UNITYSDK_OFFSET(0x169A5E40)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONQUESTTRACKUPDATE_OFFSET UNITYSDK_OFFSET(0x169A51B0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x169A5BE0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONTRACKBTNCLICKHANDLE_1_OFFSET UNITYSDK_OFFSET(0x169AA320)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONTRACKBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x169A8390)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONTRANSBTNCLICKHANDLE_1_OFFSET UNITYSDK_OFFSET(0x169AA4B0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONTRANSBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x169A9CB0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x169AF460)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x169A4990)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x169A5A30)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_OPENMAP_OFFSET UNITYSDK_OFFSET(0x169AA370)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_REFRESHACTIVITYTIMER_OFFSET UNITYSDK_OFFSET(0x169ACD00)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_REFRESHMISSIONDETAILLIST_OFFSET UNITYSDK_OFFSET(0x169ABEB0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_REFRESHMISSIONIMAGE_OFFSET UNITYSDK_OFFSET(0x169AD920)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_REFRESHMISSIONREWARDLIST_OFFSET UNITYSDK_OFFSET(0x169AD430)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_REFRESHMONSTERLEVEL_OFFSET UNITYSDK_OFFSET(0x169AEB80)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_REFRESHTRACKTIP_OFFSET UNITYSDK_OFFSET(0x169ADF20)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_SELECTQUEST_OFFSET UNITYSDK_OFFSET(0x169AB7E0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x169A4980)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_SHOWBANNER_OFFSET UNITYSDK_OFFSET(0x169AA500)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_UPDATEMISSIONTRACK_OFFSET UNITYSDK_OFFSET(0x169A5200)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_UPDATESELECTEDMISSION_OFFSET UNITYSDK_OFFSET(0x169A6630)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x169AF6E0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER__CHECKCANTOGGLEHANDLE_B__27_0_OFFSET UNITYSDK_OFFSET(0x169AF900)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x169AF530)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER__INITMISSION_B__46_0_OFFSET UNITYSDK_OFFSET(0x169AF990)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER__REFRESHACTIVITYTIMER_G__GETTIMESPANFROMTIMESTRING_57_0_OFFSET UNITYSDK_OFFSET(0x169AEFE0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x169AFA70)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x169AFB00)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x169AFB90)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x169AFC20)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x169AFCC0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x169AFD50)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x169AFDE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotMissionWidgetController_TypeDefinitionIndex = 84823;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(UIInterKnotMissionWidgetController_TypeDefinitionIndex)->GetStaticField(0x46C40);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::String*>** StaticGet_ConditionKeyMap()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(UIInterKnotMissionWidgetController_TypeDefinitionIndex)->GetStaticField(0x46C48);
		}
		::Class_2_EA1353AD6403670A* _view; // 0x2C0
		...
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_181*>* sortTabList; // 0x300
		...
		static ::System::TimeSpan _RefreshActivityTimer_g__GetTimeSpanFromTimeString_57_0(::System::String* str)
		{
			return ((::System::TimeSpan(*)(::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER__REFRESHACTIVITYTIMER_G__GETTIMESPANFROMTIMESTRING_57_0_OFFSET))(str);
		}
