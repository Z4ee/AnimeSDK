...
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_CLEARMATERIALCACHE_OFFSET UNITYSDK_OFFSET(0x1AE88BD0)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_DOUPGRADE_OFFSET UNITYSDK_OFFSET(0x1AE8AE80)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_GETOPERATIONNORMALTEXTKEY_OFFSET UNITYSDK_OFFSET(0x1AE8A060)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_GETOUTANIMNAME_OFFSET UNITYSDK_OFFSET(0x1AE8ADB0)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_GETUPGRADEANIMNAME_OFFSET UNITYSDK_OFFSET(0x1AE8B000)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_GET_VIEW_OFFSET UNITYSDK_OFFSET(0x1AE884C0)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1AE884B0)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_INITMATERIALCACHE_OFFSET UNITYSDK_OFFSET(0x1AE89530)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x1AE885D0)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_KILLUPGRADECOROUTINE_OFFSET UNITYSDK_OFFSET(0x1AE8A930)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1AE88AD0)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1AE88B60)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_ONUIHIDEITEMPROCESSUIPERFORM_OFFSET UNITYSDK_OFFSET(0x1AE8B110)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1AE884D0)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1AE88A10)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE89240)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_REFRESHMATERIALPARAM_OFFSET UNITYSDK_OFFSET(0x1AE89A60)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_SETLEVEL_OFFSET UNITYSDK_OFFSET(0x1AE8A9C0)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_SETMATERIALPARAM_OFFSET UNITYSDK_OFFSET(0x1AE89EF0)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_SETOPERATIONAREAVISIBLE_OFFSET UNITYSDK_OFFSET(0x1AE8A580)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_SETOPERATIONTEXT_OFFSET UNITYSDK_OFFSET(0x1AE8A2A0)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_SETPTSAREAVISIBLE_OFFSET UNITYSDK_OFFSET(0x1AE8A360)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_SETPTSTEXT_OFFSET UNITYSDK_OFFSET(0x1AE8A1E0)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_TRYPLAYOPERATIONBLINKANIM_OFFSET UNITYSDK_OFFSET(0x1AE8A850)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_UPDATESUBFEVERCONTROLLER_OFFSET UNITYSDK_OFFSET(0x1AE89490)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_UPGRADEBYLEVEL_OFFSET UNITYSDK_OFFSET(0x1AE8AB20)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AE8B2F0)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE8B2E0)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER__ONUIOPEN_B__7_0_OFFSET UNITYSDK_OFFSET(0x1AE8B3B0)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER__TRYPLAYOPERATIONBLINKANIM_B__24_0_OFFSET UNITYSDK_OFFSET(0x1AE8B510)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1AE8B540)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1AE8B5D0)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1AE8B5E0)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1AE8B5F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelExQteFeverV3ChildWindowController_TypeDefinitionIndex = 45233;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIInLevelExQteFeverV3ChildWindowController_TypeDefinitionIndex)->GetStaticField(0x4EB90);
		}
		static ::System::String** StaticGet_FEVER_LEVEL_02_FADE_OUT_ANIM_NAME()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIInLevelExQteFeverV3ChildWindowController_TypeDefinitionIndex)->GetStaticField(0x4EB98);
		}
		static ::System::String** StaticGet_FEVER_LEVEL_03_FADE_IN_ANIM_NAME()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIInLevelExQteFeverV3ChildWindowController_TypeDefinitionIndex)->GetStaticField(0x4EBA0);
		}
		static ::System::String** StaticGet_FEVER_LEVEL_01_FADE_OUT_ANIM_NAME()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIInLevelExQteFeverV3ChildWindowController_TypeDefinitionIndex)->GetStaticField(0x4EBA8);
		}
		static ::System::String** StaticGet_FEVER_LEVEL_01_FADE_IN_ANIM_NAME()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIInLevelExQteFeverV3ChildWindowController_TypeDefinitionIndex)->GetStaticField(0x4EBB0);
		}
		static ::System::Int32* StaticGet_ColorMoveSpeedPropertyID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelExQteFeverV3ChildWindowController_TypeDefinitionIndex)->GetStaticField(0x121B0);
		}
		static ::System::Int32* StaticGet_RampColorBPropertyID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelExQteFeverV3ChildWindowController_TypeDefinitionIndex)->GetStaticField(0x121B4);
		}
		static ::System::Int32* StaticGet_RampColorAPropertyID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelExQteFeverV3ChildWindowController_TypeDefinitionIndex)->GetStaticField(0x121B8);
		}
		::Class_2_79F6D62CE30E3F8E_2* _view; // 0x318
		::Class_1_FBD3B8F833098AE6* Noice; // 0x320
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_7D80245AA250FE12*>* _subFeverControllers; // 0x328
		::Class_1_7D80245AA250FE12* _lastController; // 0x330
		::MonoUIHideItem_ShowStatus _inLevelMainPageShowStatus; // 0x338
		::MonoUIHideItem_ShowStatus _inLevelFeverStatus; // 0x33C
		::System::Collections::Generic::List_1<::UnityEngine::RectTransform*>* _gradeWidgetList; // 0x340
		::Foundation::Coroutine::CoroutineHandle _upgradeDelayHandler; // 0x348
		::UnityEngine::Material* _ptsMat; // 0x350
		::UnityEngine::Material* _operationMat; // 0x358
		::UnityEngine::Material* _ptsNormalMat; // 0x360
		::UnityEngine::Material* _operationNormalMat; // 0x368
		::System::Boolean _isPtsShow; // 0x370
		::System::Boolean _isOperationShow; // 0x371
		::System::Collections::Generic::List_1<::System::String*>* _allLevelAnimNameList; // 0x378
		...
		::Class_2_79F6D62CE30E3F8E_2* get_View()
		{
			return ((::Class_2_79F6D62CE30E3F8E_2*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_GET_VIEW_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_ONUPDATE_OFFSET))(this, dt);
		}

		::System::Void UpdateSubFeverController(::Class_1_7D80245AA250FE12* controller)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_7D80245AA250FE12*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_UPDATESUBFEVERCONTROLLER_OFFSET))(this, controller);
		}
