...
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_CLEARMATERIALCACHE_OFFSET UNITYSDK_OFFSET(0x188B3530)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_DOUPGRADE_OFFSET UNITYSDK_OFFSET(0x188B5780)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_GETOPERATIONNORMALTEXTKEY_OFFSET UNITYSDK_OFFSET(0x188B4970)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_GETOUTANIMNAME_OFFSET UNITYSDK_OFFSET(0x188B56B0)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_GETUPGRADEANIMNAME_OFFSET UNITYSDK_OFFSET(0x188B5900)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_GET_VIEW_OFFSET UNITYSDK_OFFSET(0x188B2E60)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x188B2E50)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_INITMATERIALCACHE_OFFSET UNITYSDK_OFFSET(0x188B3E50)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x188B2F30)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_KILLUPGRADECOROUTINE_OFFSET UNITYSDK_OFFSET(0x188B5240)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x188B3430)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x188B34C0)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_ONUIHIDEITEMPROCESSUIPERFORM_OFFSET UNITYSDK_OFFSET(0x188B5A10)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x188B2E70)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x188B3370)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_REFRESHMATERIALPARAM_OFFSET UNITYSDK_OFFSET(0x188B4380)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_SETLEVEL_OFFSET UNITYSDK_OFFSET(0x188B52D0)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_SETMATERIALPARAM_OFFSET UNITYSDK_OFFSET(0x188B4800)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_SETOPERATIONAREAVISIBLE_OFFSET UNITYSDK_OFFSET(0x188B4E90)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_SETOPERATIONTEXT_OFFSET UNITYSDK_OFFSET(0x188B4BC0)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_SETPTSAREAVISIBLE_OFFSET UNITYSDK_OFFSET(0x188B4C80)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_SETPTSTEXT_OFFSET UNITYSDK_OFFSET(0x188B4AF0)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_TRYPLAYOPERATIONBLINKANIM_OFFSET UNITYSDK_OFFSET(0x188B5160)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x188B3DC0)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x188B3B90)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_UPGRADEBYLEVEL_OFFSET UNITYSDK_OFFSET(0x188B5420)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x188B5CB0)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x188B5CA0)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER__ONUIOPEN_B__7_0_OFFSET UNITYSDK_OFFSET(0x188B5D70)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER__TRYPLAYOPERATIONBLINKANIM_B__24_0_OFFSET UNITYSDK_OFFSET(0x188B5ED0)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x188B5F00)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x188B5F90)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x188B5FA0)
#define MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x188B5FB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelExQteFeverV3ChildWindowController_TypeDefinitionIndex = 74215;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIInLevelExQteFeverV3ChildWindowController_TypeDefinitionIndex)->GetStaticField(0x488D0);
		}
		static ::System::String** StaticGet_FEVER_LEVEL_03_FADE_IN_ANIM_NAME()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIInLevelExQteFeverV3ChildWindowController_TypeDefinitionIndex)->GetStaticField(0x488D8);
		}
		static ::System::String** StaticGet_FEVER_LEVEL_02_FADE_OUT_ANIM_NAME()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIInLevelExQteFeverV3ChildWindowController_TypeDefinitionIndex)->GetStaticField(0x488E0);
		}
		static ::System::String** StaticGet_FEVER_LEVEL_02_FADE_IN_ANIM_NAME()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIInLevelExQteFeverV3ChildWindowController_TypeDefinitionIndex)->GetStaticField(0x488E8);
		}
		static ::System::String** StaticGet_FEVER_LEVEL_01_FADE_IN_ANIM_NAME()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIInLevelExQteFeverV3ChildWindowController_TypeDefinitionIndex)->GetStaticField(0x488F0);
		}
		static ::System::Int32* StaticGet_ColorMoveSpeedPropertyID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelExQteFeverV3ChildWindowController_TypeDefinitionIndex)->GetStaticField(0x115B0);
		}
		static ::System::Int32* StaticGet_RampColorBPropertyID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelExQteFeverV3ChildWindowController_TypeDefinitionIndex)->GetStaticField(0x115B4);
		}
		static ::System::Int32* StaticGet_RampColorAPropertyID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelExQteFeverV3ChildWindowController_TypeDefinitionIndex)->GetStaticField(0x115B8);
		}
		::Class_2_79F6D62CE30E3F8E_20* _view; // 0x318
		...
		::Class_2_79F6D62CE30E3F8E_20* get_View()
		{
			return ((::Class_2_79F6D62CE30E3F8E_20*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIINLEVELEXQTEFEVERV3CHILDWINDOWCONTROLLER_GET_VIEW_OFFSET))(this);
		}
