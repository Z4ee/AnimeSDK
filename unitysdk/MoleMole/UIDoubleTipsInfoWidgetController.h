...
#define MOLEMOLE_UIDOUBLETIPSINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x172CFFE0)
#define MOLEMOLE_UIDOUBLETIPSINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x172D0070)
#define MOLEMOLE_UIDOUBLETIPSINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x172CFF10)
#define MOLEMOLE_UIDOUBLETIPSINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x172CFF70)
#define MOLEMOLE_UIDOUBLETIPSINFOWIDGETCONTROLLER_REFRESHBUFFVIEW_1_OFFSET UNITYSDK_OFFSET(0x172D0920)
#define MOLEMOLE_UIDOUBLETIPSINFOWIDGETCONTROLLER_REFRESHBUFFVIEW_OFFSET UNITYSDK_OFFSET(0x172C82A0)
#define MOLEMOLE_UIDOUBLETIPSINFOWIDGETCONTROLLER_SETBGCOLOR_1_OFFSET UNITYSDK_OFFSET(0x172D0500)
#define MOLEMOLE_UIDOUBLETIPSINFOWIDGETCONTROLLER_SETBGCOLOR_OFFSET UNITYSDK_OFFSET(0x172D00F0)
#define MOLEMOLE_UIDOUBLETIPSINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x172D0AE0)
#define MOLEMOLE_UIDOUBLETIPSINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x172D0B40)
#define MOLEMOLE_UIDOUBLETIPSINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x172D0BD0)
#define MOLEMOLE_UIDOUBLETIPSINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x172D0C60)
#define MOLEMOLE_UIDOUBLETIPSINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x172D0CF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIDoubleTipsInfoWidgetController_TypeDefinitionIndex = 41737;
