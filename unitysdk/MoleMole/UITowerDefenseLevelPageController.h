...
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_ADDDAYWIDGET_OFFSET UNITYSDK_OFFSET(0x17D6D800)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_CACHEENHANCE_OFFSET UNITYSDK_OFFSET(0x17D70930)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_CLEARDATALIST_OFFSET UNITYSDK_OFFSET(0x17D70420)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_DATALISTSELECT_OFFSET UNITYSDK_OFFSET(0x17D706C0)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_GETENTRYLIST_OFFSET UNITYSDK_OFFSET(0x17D6D340)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_GETINITSELECTOR_OFFSET UNITYSDK_OFFSET(0x17D6AE30)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_GETLEVELTABCONTROLLER_OFFSET UNITYSDK_OFFSET(0x17D6EE20)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_GETREWARDLIST_OFFSET UNITYSDK_OFFSET(0x17D6C5B0)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_GET_MESSAGEMATCHPAGE_OFFSET UNITYSDK_OFFSET(0x17D6AE20)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x17D6AE10)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_ISUNLOCKENTRY_OFFSET UNITYSDK_OFFSET(0x17D6D760)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17D6AEB0)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_ONLEVELSCROLLCREATE_OFFSET UNITYSDK_OFFSET(0x17D700A0)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_ONSTART_OFFSET UNITYSDK_OFFSET(0x17D6C010)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_ONTOWERDEFENSELEVELUPDATE_OFFSET UNITYSDK_OFFSET(0x17D70200)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17D6C530)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17D6AF40)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_OPENTUTORIAL_OFFSET UNITYSDK_OFFSET(0x17D6BE20)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_REFRESHDATADETAIL_OFFSET UNITYSDK_OFFSET(0x17D704A0)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0x17D6D880)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_REFRESHLEVELLIST_OFFSET UNITYSDK_OFFSET(0x17D6EEC0)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_REFRESHREWARD_OFFSET UNITYSDK_OFFSET(0x17D6C730)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_REFRESHSPECIALICON_OFFSET UNITYSDK_OFFSET(0x17D6CE50)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x17D6B3C0)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_RESETCONTENTPOS_OFFSET UNITYSDK_OFFSET(0x17D6ECD0)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_RESETDATALIST_OFFSET UNITYSDK_OFFSET(0x17D6E8F0)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_STOPCONTENTANIMATION_OFFSET UNITYSDK_OFFSET(0x17D6E860)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x17D6D300)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17D70B90)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER__ONUIINIT_B__12_0_OFFSET UNITYSDK_OFFSET(0x17D70EC0)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER__REFRESHDATADETAIL_B__33_0_OFFSET UNITYSDK_OFFSET(0x17D70F90)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17D71560)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17D715F0)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17D71600)

namespace MoleMole
{
	inline static constexpr unsigned int UITowerDefenseLevelPageController_TypeDefinitionIndex = 84613;
	...
	public:
		...
		::Class_0_16E4307DCC419505_649* initSelector; // 0x318
		::Class_2_1CC0E2699D5FB1A6_4* _view; // 0x320
		...
		::Class_0_16E4307DCC419505_649* GetInitSelector()
		{
			return ((::Class_0_16E4307DCC419505_649*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_GETINITSELECTOR_OFFSET))(this);
		}
		...
		::System::Void RefreshDetail(::Class_1_7807B2B04302CD7B_11* data)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_7807B2B04302CD7B_11*))((::PBYTE)hIl2Cpp + MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_REFRESHDETAIL_OFFSET))(this, data);
		}
