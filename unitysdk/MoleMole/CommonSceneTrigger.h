...
#define MOLEMOLE_COMMONSCENETRIGGER_CREATEBOXTRIGGER_OFFSET UNITYSDK_OFFSET(0x17433B90)
#define MOLEMOLE_COMMONSCENETRIGGER_CREATECAPSULETRIGGER_OFFSET UNITYSDK_OFFSET(0x17433F40)
#define MOLEMOLE_COMMONSCENETRIGGER_CREATESPHERETRIGGER_OFFSET UNITYSDK_OFFSET(0x174342B0)
#define MOLEMOLE_COMMONSCENETRIGGER_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x174337B0)
#define MOLEMOLE_COMMONSCENETRIGGER_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x17433840)
#define MOLEMOLE_COMMONSCENETRIGGER_REGISTERTRIGGERENTERCALLBACK_OFFSET UNITYSDK_OFFSET(0x174338D0)
#define MOLEMOLE_COMMONSCENETRIGGER_REGISTERTRIGGEREXITCALLBACK_OFFSET UNITYSDK_OFFSET(0x17433980)
#define MOLEMOLE_COMMONSCENETRIGGER_UNREGISTERTRIGGERENTERCALLBACK_OFFSET UNITYSDK_OFFSET(0x17433A30)
#define MOLEMOLE_COMMONSCENETRIGGER_UNREGISTERTRIGGEREXITCALLBACK_OFFSET UNITYSDK_OFFSET(0x17433AE0)
#define MOLEMOLE_COMMONSCENETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x17434610)

namespace MoleMole
{
	inline static constexpr unsigned int CommonSceneTrigger_TypeDefinitionIndex = 40507;
