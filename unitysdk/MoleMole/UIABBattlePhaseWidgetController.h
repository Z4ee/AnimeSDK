...
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_BINDVIEW_OFFSET UNITYSDK_OFFSET(0x18DF0790)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_CLONEMATERIALS_OFFSET UNITYSDK_OFFSET(0x18DEF4F0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_CREATEACTIVATEEFFECTFORCAMP_OFFSET UNITYSDK_OFFSET(0x18DF3D80)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_CREATEHUD_OFFSET UNITYSDK_OFFSET(0x18DEFEE0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_DISPOSEMATERIALS_OFFSET UNITYSDK_OFFSET(0x18DEFD00)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_GETDMGTXTROOT_OFFSET UNITYSDK_OFFSET(0x18DF0370)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ISSTARTTIPSPLAYING_OFFSET UNITYSDK_OFFSET(0x18DF0A90)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x18DEFDB0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x18DF0B40)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONCAMPCHANGE_OFFSET UNITYSDK_OFFSET(0x18DF37C0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18DEFAA0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONENTERBATTLEANIMFINISH_OFFSET UNITYSDK_OFFSET(0x18DF36A0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONENTERBATTLE_OFFSET UNITYSDK_OFFSET(0x18DF1910)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONENTERRESULT_OFFSET UNITYSDK_OFFSET(0x18DF1AC0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONHUDCHANGE_OFFSET UNITYSDK_OFFSET(0x18DF0DB0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONSTAGECHANGE_OFFSET UNITYSDK_OFFSET(0x18DF1480)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18DEFB30)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18DEF2D0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18DEF900)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_REFRESHRESULTTIPSBASEINFO_OFFSET UNITYSDK_OFFSET(0x18DF3060)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_REFRESHSTARTTIPSBASEINFO_OFFSET UNITYSDK_OFFSET(0x18DF1B10)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_SETPLAYERNAMEANDICON_OFFSET UNITYSDK_OFFSET(0x18DF1E10)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_TOGGLEHUDDRAG_OFFSET UNITYSDK_OFFSET(0x18DF0670)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_TOGGLEHUDFOCUS_OFFSET UNITYSDK_OFFSET(0x18DF03D0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_UPDATEHUDRENDERORDER_OFFSET UNITYSDK_OFFSET(0x18DF00B0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18DF4720)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF44D0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER__ONSTAGECHANGE_B__26_0_OFFSET UNITYSDK_OFFSET(0x18DF4760)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18DF47F0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18DF4880)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18DF4910)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18DF49A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIABBattlePhaseWidgetController_TypeDefinitionIndex = 54927;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIABBattlePhaseWidgetController_TypeDefinitionIndex)->GetStaticField(0xF8C0);
		}
		...
		::System::Void CreateActivateEffectForCamp(::Class_2_208CC9941471731A_1014* campCfg, ::System::Int32 camp)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_1014*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_CREATEACTIVATEEFFECTFORCAMP_OFFSET))(this, campCfg, camp);
		}
