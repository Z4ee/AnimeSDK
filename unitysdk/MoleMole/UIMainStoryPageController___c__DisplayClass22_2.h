...
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS22_2__CTOR_OFFSET UNITYSDK_OFFSET(0x17451AD0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS22_2__INITLEVEL_B__3_OFFSET UNITYSDK_OFFSET(0x17451AE0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS22_2__INITLEVEL_B__4_OFFSET UNITYSDK_OFFSET(0x17451B40)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainStoryPageController___c__DisplayClass22_2_TypeDefinitionIndex = 84566;
