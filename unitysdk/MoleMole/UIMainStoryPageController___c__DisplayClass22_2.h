...
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS22_2__CTOR_OFFSET UNITYSDK_OFFSET(0x15D512B0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS22_2__INITLEVEL_B__3_OFFSET UNITYSDK_OFFSET(0x15D512C0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS22_2__INITLEVEL_B__4_OFFSET UNITYSDK_OFFSET(0x15D51320)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainStoryPageController___c__DisplayClass22_2_TypeDefinitionIndex = 56264;
