...
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x17D20A30)

namespace MoleMole
{
	inline static constexpr unsigned int UIOperationYumPageController_Context_TypeDefinitionIndex = 40286;
