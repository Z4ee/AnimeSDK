...
#define MOLEMOLE_UIINGAMEINVITEFRIENDROWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1825C2A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInGameInviteFriendRowContext_TypeDefinitionIndex = 68663;
