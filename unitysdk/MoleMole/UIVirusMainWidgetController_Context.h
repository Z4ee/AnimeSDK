...
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x12768970)

namespace MoleMole
{
	inline static constexpr unsigned int UIVirusMainWidgetController_Context_TypeDefinitionIndex = 56885;
