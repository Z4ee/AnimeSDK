...
#define MOLEMOLE_UIACTIVITYFISHPROGRESSBARWIDGETCONTROLLER_GETFOCUSREWARD_OFFSET UNITYSDK_OFFSET(0x173C5060)
#define MOLEMOLE_UIACTIVITYFISHPROGRESSBARWIDGETCONTROLLER_GETPROGRESSPOINTPOSX_OFFSET UNITYSDK_OFFSET(0x173C46C0)
#define MOLEMOLE_UIACTIVITYFISHPROGRESSBARWIDGETCONTROLLER_GETREWARD_OFFSET UNITYSDK_OFFSET(0x173C4E70)
#define MOLEMOLE_UIACTIVITYFISHPROGRESSBARWIDGETCONTROLLER_ONACTIVITYWATERGETREWARD_OFFSET UNITYSDK_OFFSET(0x173C5230)
#define MOLEMOLE_UIACTIVITYFISHPROGRESSBARWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x173C3E60)
#define MOLEMOLE_UIACTIVITYFISHPROGRESSBARWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x173C3EF0)
#define MOLEMOLE_UIACTIVITYFISHPROGRESSBARWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x173C3C60)
#define MOLEMOLE_UIACTIVITYFISHPROGRESSBARWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x173C3DF0)
#define MOLEMOLE_UIACTIVITYFISHPROGRESSBARWIDGETCONTROLLER_REFRESHPROGRESSBARVIEW_OFFSET UNITYSDK_OFFSET(0x173C3FF0)
#define MOLEMOLE_UIACTIVITYFISHPROGRESSBARWIDGETCONTROLLER_REFRESHPROGRESSPOINTVIEW_1_OFFSET UNITYSDK_OFFSET(0x173C4510)
#define MOLEMOLE_UIACTIVITYFISHPROGRESSBARWIDGETCONTROLLER_REFRESHPROGRESSPOINTVIEW_OFFSET UNITYSDK_OFFSET(0x173C4820)
#define MOLEMOLE_UIACTIVITYFISHPROGRESSBARWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x173C3F70)
#define MOLEMOLE_UIACTIVITYFISHPROGRESSBARWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x173C52E0)
#define MOLEMOLE_UIACTIVITYFISHPROGRESSBARWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x173C5340)
#define MOLEMOLE_UIACTIVITYFISHPROGRESSBARWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x173C53D0)
#define MOLEMOLE_UIACTIVITYFISHPROGRESSBARWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x173C5460)
#define MOLEMOLE_UIACTIVITYFISHPROGRESSBARWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x173C54F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityFishProgressBarWidgetController_TypeDefinitionIndex = 85257;
	...
	public:
		...
		::System::Void RefreshProgressPointView(::Class_2_1F265C0C485137E3_2_Class_2_D9EA9254F6280D85* view, ::Class_3_BD954AEAE8F1A57B* task, ::System::Boolean playGetEffect)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_1F265C0C485137E3_2_Class_2_D9EA9254F6280D85*, ::Class_3_BD954AEAE8F1A57B*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIACTIVITYFISHPROGRESSBARWIDGETCONTROLLER_REFRESHPROGRESSPOINTVIEW_OFFSET))(this, view, task, playGetEffect);
		}
