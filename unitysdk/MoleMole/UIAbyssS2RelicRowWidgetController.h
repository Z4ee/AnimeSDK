...
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER_GET_CANUNLOCK_OFFSET UNITYSDK_OFFSET(0x16443360)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER_GET_INITIALRELICMODEL_OFFSET UNITYSDK_OFFSET(0x16441340)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER_GET_INTERACTABLE_OFFSET UNITYSDK_OFFSET(0x16443380)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER_LOADIMG_OFFSET UNITYSDK_OFFSET(0x16443120)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x16442EC0)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER_ONCLICKSELECT_OFFSET UNITYSDK_OFFSET(0x16441140)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x164429E0)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER_ONINITIALRELICDATAUPDATE_OFFSET UNITYSDK_OFFSET(0x164411C0)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x16442E30)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0x16440F60)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16442C20)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16442B50)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16440D40)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16440EF0)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER_PLAYFRAMETEXTURE_OFFSET UNITYSDK_OFFSET(0x16442F50)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER_REFRESHINITIALRELICVIEW_OFFSET UNITYSDK_OFFSET(0x16441470)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER_REGEVENTS_OFFSET UNITYSDK_OFFSET(0x16441040)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER_SETCLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x164410F0)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER_SETLOCKED_OFFSET UNITYSDK_OFFSET(0x164432E0)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER_SET_CANUNLOCK_OFFSET UNITYSDK_OFFSET(0x16443370)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER_SET_INTERACTABLE_OFFSET UNITYSDK_OFFSET(0x16443390)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER_UNREGEVENTS_OFFSET UNITYSDK_OFFSET(0x16440FE0)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x164433A0)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x164433B0)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x164433C0)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x16443450)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER___BASE_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0x164434E0)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16443570)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16443610)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x164436A0)
#define MOLEMOLE_UIABYSSS2RELICROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16443730)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2RelicRowWidgetController_TypeDefinitionIndex = 71128;
	...
	public:
		...
		::Class_2_86B3C791290970F4* m_initialRelicModel; // 0x320
