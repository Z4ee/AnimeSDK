...
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTPAGECONTROLLER_GETREWARDITEMFROMID_OFFSET UNITYSDK_OFFSET(0x16953FD0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x16951600)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x169516F0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16951610)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTPAGECONTROLLER_ONLEVELCHANGED_OFFSET UNITYSDK_OFFSET(0x169530E0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x169526F0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16952EC0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x169516A0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16951A00)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTPAGECONTROLLER_READTODOLISTFORLASTLEVEL_OFFSET UNITYSDK_OFFSET(0x16952F30)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x169529D0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTPAGECONTROLLER_SETTODOLISTS_OFFSET UNITYSDK_OFFSET(0x169536A0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16954300)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTPAGECONTROLLER__ONUIOPEN_G__GETLEVELIDXWITHUNFINISHEDQUEST_6_0_OFFSET UNITYSDK_OFFSET(0x16951BB0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTPAGECONTROLLER__REFRESHVIEW_B__10_0_OFFSET UNITYSDK_OFFSET(0x16954310)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16954360)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x169543F0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16954400)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16954410)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16954420)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastTodoListPageController_TypeDefinitionIndex = 65078;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_130*>* _levels; // 0x328
