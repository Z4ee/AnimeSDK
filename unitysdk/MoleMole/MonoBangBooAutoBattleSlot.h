...
#define MOLEMOLE_MONOBANGBOOAUTOBATTLESLOT_GETALL_OFFSET UNITYSDK_OFFSET(0x118E5B80)
#define MOLEMOLE_MONOBANGBOOAUTOBATTLESLOT_METHOD_7_135905C820F0E175_OFFSET UNITYSDK_OFFSET(0x118E5D60)
#define MOLEMOLE_MONOBANGBOOAUTOBATTLESLOT_METHOD_7_4A3F02CE2DBC2621_1_OFFSET UNITYSDK_OFFSET(0x118E5E40)
#define MOLEMOLE_MONOBANGBOOAUTOBATTLESLOT_METHOD_7_4A3F02CE2DBC2621_OFFSET UNITYSDK_OFFSET(0x118E5DF0)
#define MOLEMOLE_MONOBANGBOOAUTOBATTLESLOT_METHOD_7_A1C7122184516C18_OFFSET UNITYSDK_OFFSET(0x118E4F30)
#define MOLEMOLE_MONOBANGBOOAUTOBATTLESLOT_SETEFF_OFFSET UNITYSDK_OFFSET(0x118E5740)
#define MOLEMOLE_MONOBANGBOOAUTOBATTLESLOT_SETISOVERLIMIT_OFFSET UNITYSDK_OFFSET(0x118E5B20)
#define MOLEMOLE_MONOBANGBOOAUTOBATTLESLOT_SETVALIDCOLOR_OFFSET UNITYSDK_OFFSET(0x118E5AC0)
#define MOLEMOLE_MONOBANGBOOAUTOBATTLESLOT_START_OFFSET UNITYSDK_OFFSET(0x118E4E30)
#define MOLEMOLE_MONOBANGBOOAUTOBATTLESLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x118E5CC0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoBangBooAutoBattleSlot_TypeDefinitionIndex = 56221;

	class MonoBangBooAutoBattleSlot : public ::MoleMole::MonoSceneObjectBase
	{
	public:
		::Enum_3_C774F445599ED339 SlotType; // 0x28
		::System::Int32 X; // 0x2C
		::System::Int32 Y; // 0x30
		...
		::System::Boolean Field_7_8; // 0x70
		::System::Boolean Field_7_15; // 0x71
		::MoleMole::MonoBangBooAutoBattleSlot_Enum_3_1468EE9C811FF285 Field_7_14; // 0x74
		::MoleMole::MonoGamepadSelectable* Field_7_13; // 0x78
		::System::Collections::Generic::Dictionary_2<::MoleMole::MonoBangBooAutoBattleSlot_Enum_3_1468EE9C811FF285, ::MoleMole::MonoBangBooAutoBattleSlot_Struct_2_1B86EF0E2A277D72>* Field_7_12; // 0x80
