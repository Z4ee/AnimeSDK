...
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER_GETLOCATETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1777BC70)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER_GETTEXTANCHOR_OFFSET UNITYSDK_OFFSET(0x1777BD70)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER_INITCHILDS_OFFSET UNITYSDK_OFFSET(0x1777B630)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER_ISOVERCANVAS_OFFSET UNITYSDK_OFFSET(0x1777C170)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1777BA80)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1777BBD0)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER_ONREFRESHWIDGETROOTPOSITION_OFFSET UNITYSDK_OFFSET(0x1777BFD0)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER_ONSELECTCHILDITEM_OFFSET UNITYSDK_OFFSET(0x1777C0B0)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1777B2B0)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1777BB10)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1777B0C0)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1777B260)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1777CB20)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1777CA40)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER___BASE_GETLOCATETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1777CB70)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1777CC00)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1777CC90)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER___BASE_ONREFRESHWIDGETROOTPOSITION_OFFSET UNITYSDK_OFFSET(0x1777CCC0)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1777CD50)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1777CDF0)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1777CE80)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1777CF10)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralDropDownActionsWidgetController_TypeDefinitionIndex = 52094;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Vector3>**)Il2CppClass::FromTypeDefinitionIndex(UIGeneralDropDownActionsWidgetController_TypeDefinitionIndex)->GetStaticField(0x4C070);
		}
		::Class_2_DAEA51265F00BCA5* _view; // 0x2C8
		::System::Collections::Generic::List_1<::Class_1_777EB91B86430809_1*>* _contexts; // 0x2D0
		::Class_1_4BB73BC1050D704C* _layoutProxy; // 0x2D8
		::MoleMole::InputLogicEventType _closeEvent; // 0x2E0
		::System::Boolean _setAnchorFinished; // 0x2E4
		::UnityEngine::TextAnchor _cacheAnchor; // 0x2E8
