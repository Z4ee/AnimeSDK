...
#define MOLEMOLE_CINEMASINGLEBEATMAPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xF12C740)

namespace MoleMole
{
	inline static constexpr unsigned int CinemaSingleBeatMapConfig_TypeDefinitionIndex = 67283;
