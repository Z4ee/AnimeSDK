...
#define MOLEMOLE_UIACTIVITYRETURNPAGECONTROLLER___C__DISPLAYCLASS24_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1676A830)
#define MOLEMOLE_UIACTIVITYRETURNPAGECONTROLLER___C__DISPLAYCLASS24_0__OPNETABWIDGETBYACTIVITYDATA_B__0_OFFSET UNITYSDK_OFFSET(0x1676A840)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityReturnPageController___c__DisplayClass24_0_TypeDefinitionIndex = 75098;
	...
	public:
		...
		::MoleMole::UIBackFlowContext* contextBase; // 0x18
