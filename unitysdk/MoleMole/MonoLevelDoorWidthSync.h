...
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_APPLYPROJECTIONTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1640E880)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_AWAKE_OFFSET UNITYSDK_OFFSET(0x1640D9C0)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_METHOD_5_218124418542E081_OFFSET UNITYSDK_OFFSET(0x16410FE0)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_METHOD_5_332E8DA02BCCBD12_OFFSET UNITYSDK_OFFSET(0x1640F150)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_METHOD_5_4200CD8D3A56BF83_OFFSET UNITYSDK_OFFSET(0x16410290)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_METHOD_5_6BA7BB45F0BA72F4_OFFSET UNITYSDK_OFFSET(0x1640F950)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_METHOD_5_7B0A407379BA27E7_OFFSET UNITYSDK_OFFSET(0x16410E80)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_METHOD_5_AE80CBC984AADFD5_OFFSET UNITYSDK_OFFSET(0x1640DC80)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_METHOD_5_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x16410ED0)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x16410E40)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x16410160)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1640E570)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1640E520)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_RUNTIMESYNCSIZE_1_OFFSET UNITYSDK_OFFSET(0x1640FEC0)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_RUNTIMESYNCSIZE_OFFSET UNITYSDK_OFFSET(0x1640FC90)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_RUNTIMESYNCWIDTH_OFFSET UNITYSDK_OFFSET(0x1640E640)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_SETONEWAYDOORSENSORACTIVE_OFFSET UNITYSDK_OFFSET(0x1640E5C0)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC__CCTOR_OFFSET UNITYSDK_OFFSET(0x16410960)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x16410630)

namespace MoleMole
{
	inline static constexpr unsigned int MonoLevelDoorWidthSync_TypeDefinitionIndex = 56424;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(MonoLevelDoorWidthSync_TypeDefinitionIndex)->GetStaticField(0x4CD80);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::MonoLevelDoorWidthSync_Class_1_991BEB3714D9D0F5*>**)Il2CppClass::FromTypeDefinitionIndex(MonoLevelDoorWidthSync_TypeDefinitionIndex)->GetStaticField(0x4CD88);
		}
