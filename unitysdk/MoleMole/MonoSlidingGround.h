...
#define MOLEMOLE_MONOSLIDINGGROUND__CTOR_OFFSET UNITYSDK_OFFSET(0x13EA6590)

namespace MoleMole
{
	inline static constexpr unsigned int MonoSlidingGround_TypeDefinitionIndex = 79888;
