...
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___C__DISPLAYCLASS45_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17707EE0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___C__DISPLAYCLASS45_0__REFRESHSTARUPVIEW_B__0_OFFSET UNITYSDK_OFFSET(0x17707EF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIEquipDevelopPopWindowController___c__DisplayClass45_0_TypeDefinitionIndex = 84130;
	...
	public:
		...
		::Class_3_9F091E965E210217_11* serverInfo; // 0x20
		::MoleMole::UIEquipDevelopPopWindowController* __4__this; // 0x28
