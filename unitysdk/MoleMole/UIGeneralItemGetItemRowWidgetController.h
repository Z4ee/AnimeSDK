...
#define MOLEMOLE_UIGENERALITEMGETITEMROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16F6E250)
#define MOLEMOLE_UIGENERALITEMGETITEMROWWIDGETCONTROLLER_ONGETBTNCLICK_OFFSET UNITYSDK_OFFSET(0x16F6E500)
#define MOLEMOLE_UIGENERALITEMGETITEMROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16F6E360)
#define MOLEMOLE_UIGENERALITEMGETITEMROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16F6E2E0)
#define MOLEMOLE_UIGENERALITEMGETITEMROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16F6E0F0)
#define MOLEMOLE_UIGENERALITEMGETITEMROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16F6E560)
#define MOLEMOLE_UIGENERALITEMGETITEMROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16F6E570)
#define MOLEMOLE_UIGENERALITEMGETITEMROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16F6E600)
#define MOLEMOLE_UIGENERALITEMGETITEMROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16F6E6A0)
#define MOLEMOLE_UIGENERALITEMGETITEMROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16F6E730)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralItemGetItemRowWidgetController_TypeDefinitionIndex = 70588;

	class UIGeneralItemGetItemRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_7BEEB90214042948_9* _view; // 0x2F0
