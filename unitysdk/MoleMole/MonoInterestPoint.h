...
#define MOLEMOLE_MONOINTERESTPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x125E3AD0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoInterestPoint_TypeDefinitionIndex = 43753;
