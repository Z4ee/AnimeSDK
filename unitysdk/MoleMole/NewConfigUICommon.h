...
#define MOLEMOLE_NEWCONFIGUICOMMON_GETALLSUBCONFIGS_OFFSET UNITYSDK_OFFSET(0x17DDE7B0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETBUTTONCLICKCOLDDOWN_OFFSET UNITYSDK_OFFSET(0x17DDFF30)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETCARDOPTIONBGCOLOR_OFFSET UNITYSDK_OFFSET(0x17DDF260)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETCARDOPTIONRARITYBGCOLOR_OFFSET UNITYSDK_OFFSET(0x17DDF500)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETGENERALICONBADGEDATA_OFFSET UNITYSDK_OFFSET(0x17DDFD20)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETITEMRARITYBGCOLOR_OFFSET UNITYSDK_OFFSET(0x17DDF7C0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETOVERRIDESIZE_OFFSET UNITYSDK_OFFSET(0x17DDEE70)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETROLERARITYICONPATH_OFFSET UNITYSDK_OFFSET(0x17DDEFD0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETSTANIMAOVERLOADENDEFFECT_OFFSET UNITYSDK_OFFSET(0x17DDECB0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETSTANIMAOVERLOADLOOPEFFECT_OFFSET UNITYSDK_OFFSET(0x17DDEAF0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETSTANIMAOVERLOADSTARTEFFECT_OFFSET UNITYSDK_OFFSET(0x17DDE930)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETUITOKENDIALOGCONFIGSBYTYPE_OFFSET UNITYSDK_OFFSET(0x17DDFA50)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONDAMAGETEXT_OFFSET UNITYSDK_OFFSET(0x17DDE690)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONGAMESTART_OFFSET UNITYSDK_OFFSET(0x17DDE500)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONHOLLOWCARD_OFFSET UNITYSDK_OFFSET(0x17DDE640)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONI18NIMAGE_OFFSET UNITYSDK_OFFSET(0x17DDE6F0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONINPUT_OFFSET UNITYSDK_OFFSET(0x17DDE750)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONMISC_OFFSET UNITYSDK_OFFSET(0x17DDE550)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x17DDE5A0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONUIPAGE_OFFSET UNITYSDK_OFFSET(0x17DDE5F0)
#define MOLEMOLE_NEWCONFIGUICOMMON__CCTOR_OFFSET UNITYSDK_OFFSET(0x17DE0020)
#define MOLEMOLE_NEWCONFIGUICOMMON__CTOR_OFFSET UNITYSDK_OFFSET(0x17DDFFC0)

namespace MoleMole
{
	inline static constexpr unsigned int NewConfigUICommon_TypeDefinitionIndex = 71207;
	...
	public:
		...
		{
			return (::UnityEngine::Color*)Il2CppClass::FromTypeDefinitionIndex(NewConfigUICommon_TypeDefinitionIndex)->GetStaticField(0x11A40);
		}
		...
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_715*>* _allSubConfigs; // 0x98
		...
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_715*>* GetAllSubConfigs()
		{
			return ((::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_715*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_NEWCONFIGUICOMMON_GETALLSUBCONFIGS_OFFSET))(this);
		}
