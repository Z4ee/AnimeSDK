...
#define MOLEMOLE_NEWCONFIGUICOMMON_GETALLSUBCONFIGS_OFFSET UNITYSDK_OFFSET(0x190A4580)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETBUTTONCLICKCOLDDOWN_OFFSET UNITYSDK_OFFSET(0x190A5D10)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETCARDOPTIONBGCOLOR_OFFSET UNITYSDK_OFFSET(0x190A5040)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETCARDOPTIONRARITYBGCOLOR_OFFSET UNITYSDK_OFFSET(0x190A52E0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETGENERALICONBADGEDATA_OFFSET UNITYSDK_OFFSET(0x190A5B00)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETITEMRARITYBGCOLOR_OFFSET UNITYSDK_OFFSET(0x190A55A0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETOVERRIDESIZE_OFFSET UNITYSDK_OFFSET(0x190A4C40)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETROLERARITYICONPATH_OFFSET UNITYSDK_OFFSET(0x190A4DA0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETSTANIMAOVERLOADENDEFFECT_OFFSET UNITYSDK_OFFSET(0x190A4A80)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETSTANIMAOVERLOADLOOPEFFECT_OFFSET UNITYSDK_OFFSET(0x190A48C0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETSTANIMAOVERLOADSTARTEFFECT_OFFSET UNITYSDK_OFFSET(0x190A4700)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETUITOKENDIALOGCONFIGSBYTYPE_OFFSET UNITYSDK_OFFSET(0x190A5830)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONDAMAGETEXT_OFFSET UNITYSDK_OFFSET(0x190A4460)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONGAMESTART_OFFSET UNITYSDK_OFFSET(0x190A42D0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONHOLLOWCARD_OFFSET UNITYSDK_OFFSET(0x190A4410)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONI18NIMAGE_OFFSET UNITYSDK_OFFSET(0x190A44C0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONINPUT_OFFSET UNITYSDK_OFFSET(0x190A4520)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONMISC_OFFSET UNITYSDK_OFFSET(0x190A4320)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x190A4370)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONUIPAGE_OFFSET UNITYSDK_OFFSET(0x190A43C0)
#define MOLEMOLE_NEWCONFIGUICOMMON__CCTOR_OFFSET UNITYSDK_OFFSET(0x190A5E00)
#define MOLEMOLE_NEWCONFIGUICOMMON__CTOR_OFFSET UNITYSDK_OFFSET(0x190A5DA0)

namespace MoleMole
{
	inline static constexpr unsigned int NewConfigUICommon_TypeDefinitionIndex = 42640;
	...
	public:
		...
		{
			return (::UnityEngine::Color*)Il2CppClass::FromTypeDefinitionIndex(NewConfigUICommon_TypeDefinitionIndex)->GetStaticField(0x11360);
		}
		...
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_261*>* _allSubConfigs; // 0x98
		...
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_261*>* GetAllSubConfigs()
		{
			return ((::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_261*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_NEWCONFIGUICOMMON_GETALLSUBCONFIGS_OFFSET))(this);
		}
