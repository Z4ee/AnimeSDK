...
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATEALLOWWHITELIST_GET_STATE_OFFSET UNITYSDK_OFFSET(0x186C5750)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATEALLOWWHITELIST_ONCHANGESTATE_OFFSET UNITYSDK_OFFSET(0x186C5760)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATEALLOWWHITELIST__CTOR_OFFSET UNITYSDK_OFFSET(0x186BBC50)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATEALLOWWHITELIST___BASE_ONCHANGESTATE_OFFSET UNITYSDK_OFFSET(0x186C5CA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralNewsBubbleWidgetController_NewsBubbleStateAllowWhiteList_TypeDefinitionIndex = 54504;
