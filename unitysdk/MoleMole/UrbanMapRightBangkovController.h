...
#define MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x12A20F10)
#define MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER_GET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x12A208D0)
#define MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x12A208E0)
#define MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x12A20950)
#define MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x12A20E00)
#define MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x12A20FD0)
#define MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x12A20A20)
#define MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x12A20DA0)
#define MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12A210B0)
#define MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x12A21110)
#define MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x12A211B0)
#define MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x12A21240)
#define MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x12A212D0)
#define MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x12A21370)

namespace MoleMole
{
	inline static constexpr unsigned int UrbanMapRightBangkovController_TypeDefinitionIndex = 68763;
