...
class Class_2_41D3E6DBD63C1836;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }

#define MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x1352E420)
#define MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER_GET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x1352DDD0)
#define MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1352DDE0)
#define MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1352DE50)
#define MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x1352E300)
#define MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x1352E4E0)
#define MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1352DF20)
#define MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x1352E2A0)
#define MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1352E5C0)
#define MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1352E620)
#define MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x1352E6C0)
#define MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x1352E750)
#define MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1352E7E0)
#define MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x1352E880)

namespace MoleMole
{
	inline static constexpr unsigned int UrbanMapRightBangkovController_TypeDefinitionIndex = 88919;
	...
	public:
		...
		::Class_2_41D3E6DBD63C1836* get__viewModel()
		{
			return ((::Class_2_41D3E6DBD63C1836*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_URBANMAPRIGHTBANGKOVCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
