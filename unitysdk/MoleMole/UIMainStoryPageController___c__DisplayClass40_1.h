...
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS40_1__CTOR_OFFSET UNITYSDK_OFFSET(0x147BD260)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS40_1__SHOWTAPEDECKINFO_B__1_OFFSET UNITYSDK_OFFSET(0x147BD270)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainStoryPageController___c__DisplayClass40_1_TypeDefinitionIndex = 56290;
	...
	public:
		...
		::UnityEngine::Animation* deckInfoAnimation; // 0x20
