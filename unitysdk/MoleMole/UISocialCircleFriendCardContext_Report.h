...
#define MOLEMOLE_UISOCIALCIRCLEFRIENDCARDCONTEXT_REPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x15C263F0)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleFriendCardContext_Report_TypeDefinitionIndex = 46803;
