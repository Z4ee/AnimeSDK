...
#define MOLEMOLE_ABYSSS2_WORKGRID_V2_EQUALS_OFFSET UNITYSDK_OFFSET(0x76ECD0)
#define MOLEMOLE_ABYSSS2_WORKGRID_V2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x76EDC0)
#define MOLEMOLE_ABYSSS2_WORKGRID_V2__CTOR_OFFSET UNITYSDK_OFFSET(0x293FB0)
#define MOLEMOLE_ABYSSS2_WORKGRID_V2___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x76EE10)
#define MOLEMOLE_ABYSSS2_WORKGRID_V2___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x76EE70)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_WorkGrid_V2_TypeDefinitionIndex = 82314;
