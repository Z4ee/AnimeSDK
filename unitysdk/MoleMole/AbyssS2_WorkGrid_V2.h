...
#define MOLEMOLE_ABYSSS2_WORKGRID_V2_EQUALS_OFFSET UNITYSDK_OFFSET(0x816830)
#define MOLEMOLE_ABYSSS2_WORKGRID_V2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x816920)
#define MOLEMOLE_ABYSSS2_WORKGRID_V2__CTOR_OFFSET UNITYSDK_OFFSET(0x2AB920)
#define MOLEMOLE_ABYSSS2_WORKGRID_V2___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x816970)
#define MOLEMOLE_ABYSSS2_WORKGRID_V2___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8169D0)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_WorkGrid_V2_TypeDefinitionIndex = 85685;
