...
#define MOLEMOLE_UISOCIALCIRCLEFRIENDCARDROWWIDGETCONTROLLER_REPORT_ONCLICKREPORTCHECKMARKCALLBACK_OFFSET UNITYSDK_OFFSET(0x16696970)
#define MOLEMOLE_UISOCIALCIRCLEFRIENDCARDROWWIDGETCONTROLLER_REPORT_PROCESSBYOPENPAGE_OFFSET UNITYSDK_OFFSET(0x16696650)
#define MOLEMOLE_UISOCIALCIRCLEFRIENDCARDROWWIDGETCONTROLLER_REPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x16696A90)
#define MOLEMOLE_UISOCIALCIRCLEFRIENDCARDROWWIDGETCONTROLLER_REPORT___BASE_PROCESSBYOPENPAGE_OFFSET UNITYSDK_OFFSET(0x16696AB0)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleFriendCardRowWidgetController_Report_TypeDefinitionIndex = 53328;
