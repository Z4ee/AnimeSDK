...
#define MOLEMOLE_LEVELNODEEVENTTRIGGER_AWAKE_OFFSET UNITYSDK_OFFSET(0x170D8720)
#define MOLEMOLE_LEVELNODEEVENTTRIGGER_CHECKENTERTRIGGER_OFFSET UNITYSDK_OFFSET(0x170DA890)
#define MOLEMOLE_LEVELNODEEVENTTRIGGER_CHECKEXITTRIGGER_OFFSET UNITYSDK_OFFSET(0x170DA7F0)
#define MOLEMOLE_LEVELNODEEVENTTRIGGER_CONFIGCOLLIDER_OFFSET UNITYSDK_OFFSET(0x170D9A30)
#define MOLEMOLE_LEVELNODEEVENTTRIGGER_GET_ENABLESTATE_OFFSET UNITYSDK_OFFSET(0x170D98A0)
#define MOLEMOLE_LEVELNODEEVENTTRIGGER_METHOD_5_C0FD77CCB1B53417_OFFSET UNITYSDK_OFFSET(0x170DA980)
#define MOLEMOLE_LEVELNODEEVENTTRIGGER_METHOD_5_F4209394A808B3B4_1_OFFSET UNITYSDK_OFFSET(0x170D9240)
#define MOLEMOLE_LEVELNODEEVENTTRIGGER_METHOD_5_F4209394A808B3B4_OFFSET UNITYSDK_OFFSET(0x170D9570)
#define MOLEMOLE_LEVELNODEEVENTTRIGGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x170D8B20)
#define MOLEMOLE_LEVELNODEEVENTTRIGGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x170D88D0)
#define MOLEMOLE_LEVELNODEEVENTTRIGGER_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x170DA620)
#define MOLEMOLE_LEVELNODEEVENTTRIGGER_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x170DA700)
#define MOLEMOLE_LEVELNODEEVENTTRIGGER_SET_ENABLESTATE_OFFSET UNITYSDK_OFFSET(0x170D98B0)
#define MOLEMOLE_LEVELNODEEVENTTRIGGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x170D8D90)
#define MOLEMOLE_LEVELNODEEVENTTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x170DA920)

namespace MoleMole
{
	inline static constexpr unsigned int LevelNodeEventTrigger_TypeDefinitionIndex = 54479;
