...
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS59_0__CTOR_OFFSET UNITYSDK_OFFSET(0x163C6930)
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS59_0__SETACTIVITYBATTLEQUESTCONTEXT_B__1_OFFSET UNITYSDK_OFFSET(0x163C6AB0)
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS59_0__SETACTIVITYBATTLEQUESTCONTEXT_B__4_OFFSET UNITYSDK_OFFSET(0x163C7640)
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS59_0__SETACTIVITYBATTLEQUESTCONTEXT_G__ONGETSELECTROLECONTEXT_2_OFFSET UNITYSDK_OFFSET(0x163C70E0)
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS59_0__SETACTIVITYBATTLEQUESTCONTEXT_G__ONPOSTGETBUDDYSELECTCONTEXT_3_OFFSET UNITYSDK_OFFSET(0x163C7430)
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS59_0__SETACTIVITYBATTLEQUESTCONTEXT_G__ONSHOWDETAILINFO_0_OFFSET UNITYSDK_OFFSET(0x163C6940)

namespace MoleMole
{
	inline static constexpr unsigned int UILineupSelectContext___c__DisplayClass59_0_TypeDefinitionIndex = 57532;

	class UILineupSelectContext___c__DisplayClass59_0 : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::System::Int32>* effectList; // 0x10
		::System::Collections::Generic::List_1<::System::Int32>* conditionList; // 0x18
		::Class_2_208CC9941471731A_935* config; // 0x20
