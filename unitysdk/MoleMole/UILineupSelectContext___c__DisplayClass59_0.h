...
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS59_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19134A60)
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS59_0__SETACTIVITYBATTLEQUESTCONTEXT_B__1_OFFSET UNITYSDK_OFFSET(0x19134C20)
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS59_0__SETACTIVITYBATTLEQUESTCONTEXT_B__4_OFFSET UNITYSDK_OFFSET(0x19135830)
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS59_0__SETACTIVITYBATTLEQUESTCONTEXT_G__ONGETSELECTROLECONTEXT_2_OFFSET UNITYSDK_OFFSET(0x19135270)
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS59_0__SETACTIVITYBATTLEQUESTCONTEXT_G__ONPOSTGETBUDDYSELECTCONTEXT_3_OFFSET UNITYSDK_OFFSET(0x19135610)
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS59_0__SETACTIVITYBATTLEQUESTCONTEXT_G__ONSHOWDETAILINFO_0_OFFSET UNITYSDK_OFFSET(0x19134A70)

namespace MoleMole
{
	inline static constexpr unsigned int UILineupSelectContext___c__DisplayClass59_0_TypeDefinitionIndex = 52593;

	class UILineupSelectContext___c__DisplayClass59_0 : public ::System::Object
	{
	public:
		::Class_2_208CC9941471731A_462* config; // 0x10
		::System::Collections::Generic::List_1<::System::Int32>* conditionList; // 0x18
		::System::Collections::Generic::List_1<::System::Int32>* effectList; // 0x20
