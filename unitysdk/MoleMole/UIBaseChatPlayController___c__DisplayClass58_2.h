...
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER___C__DISPLAYCLASS58_2__CTOR_OFFSET UNITYSDK_OFFSET(0x142D0010)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER___C__DISPLAYCLASS58_2__PROCESSCONDITION_B__2_OFFSET UNITYSDK_OFFSET(0x142D0020)

namespace MoleMole
{
	inline static constexpr unsigned int UIBaseChatPlayController___c__DisplayClass58_2_TypeDefinitionIndex = 39184;
