...
#define MOLEMOLE_BLADEILLUSIONNPCGROUPDATASO_BLADEILLUSIONNPCGROUPDATASO_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xE94AB50)
#define MOLEMOLE_BLADEILLUSIONNPCGROUPDATASO_BLADEILLUSIONNPCGROUPDATASO_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xE94AB60)
#define MOLEMOLE_BLADEILLUSIONNPCGROUPDATASO_BLADEILLUSIONNPCGROUPDATASO_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xE94AE00)
#define MOLEMOLE_BLADEILLUSIONNPCGROUPDATASO_BLADEILLUSIONNPCGROUPDATASO_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xE94AFF0)
#define MOLEMOLE_BLADEILLUSIONNPCGROUPDATASO_BLADEILLUSIONNPCGROUPDATASO_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xE94AFB0)

namespace MoleMole
{
	inline static constexpr unsigned int BladeIllusionNPCGroupDataSo_BladeIllusionNPCGroupDataSo_UnityGeneratedFormatter_TypeDefinitionIndex = 44266;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::Il2CppArray<::MoleMole::BladeIllusionNPCInfo>*>**)Il2CppClass::FromTypeDefinitionIndex(BladeIllusionNPCGroupDataSo_BladeIllusionNPCGroupDataSo_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x4AD20);
		}
