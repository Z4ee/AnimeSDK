...
#define MOLEMOLE_COMMANDLINEVOLUMETRICFOG_METHOD_2_4FEEEA56B286E7CE_OFFSET UNITYSDK_OFFSET(0x11458140)
#define MOLEMOLE_COMMANDLINEVOLUMETRICFOG_METHOD_2_5A641E4B57BEEA2D_OFFSET UNITYSDK_OFFSET(0x11458030)
#define MOLEMOLE_COMMANDLINEVOLUMETRICFOG__CTOR_OFFSET UNITYSDK_OFFSET(0x11458100)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineVolumetricFog_TypeDefinitionIndex = 84734;
