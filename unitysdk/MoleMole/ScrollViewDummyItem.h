...
#define MOLEMOLE_SCROLLVIEWDUMMYITEM_AWAKE_OFFSET UNITYSDK_OFFSET(0x173870F0)
#define MOLEMOLE_SCROLLVIEWDUMMYITEM_GETLAYOUTELEMENTSIZE_OFFSET UNITYSDK_OFFSET(0x17387270)
#define MOLEMOLE_SCROLLVIEWDUMMYITEM_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x17387360)
#define MOLEMOLE_SCROLLVIEWDUMMYITEM_SETLAYOUTELEMENTSIZE_OFFSET UNITYSDK_OFFSET(0x173871C0)
#define MOLEMOLE_SCROLLVIEWDUMMYITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x17387300)

namespace MoleMole
{
	inline static constexpr unsigned int ScrollViewDummyItem_TypeDefinitionIndex = 51825;
