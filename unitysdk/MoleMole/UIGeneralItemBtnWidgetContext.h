...
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x19EEDCC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralItemBtnWidgetContext_TypeDefinitionIndex = 48128;
