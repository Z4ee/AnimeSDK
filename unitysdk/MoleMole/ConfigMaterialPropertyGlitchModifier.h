...
#define MOLEMOLE_CONFIGMATERIALPROPERTYGLITCHMODIFIER_DOAFTERONENTER_OFFSET UNITYSDK_OFFSET(0x19219BF0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYGLITCHMODIFIER_DOONENTER_FORUSER_OFFSET UNITYSDK_OFFSET(0x1921B360)
#define MOLEMOLE_CONFIGMATERIALPROPERTYGLITCHMODIFIER_DOONENTER_OFFSET UNITYSDK_OFFSET(0x19219B30)
#define MOLEMOLE_CONFIGMATERIALPROPERTYGLITCHMODIFIER_DOWARMUP_OFFSET UNITYSDK_OFFSET(0x1921B230)
#define MOLEMOLE_CONFIGMATERIALPROPERTYGLITCHMODIFIER_ONDONE_OFFSET UNITYSDK_OFFSET(0x1921B3D0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYGLITCHMODIFIER_PREPAREONENTER_OFFSET UNITYSDK_OFFSET(0x192199D0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYGLITCHMODIFIER_PREPAREONEXIT_OFFSET UNITYSDK_OFFSET(0x19219CE0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYGLITCHMODIFIER_PROCESSENTER_OFFSET UNITYSDK_OFFSET(0x19219C50)
#define MOLEMOLE_CONFIGMATERIALPROPERTYGLITCHMODIFIER_PROCESSEXIT_OFFSET UNITYSDK_OFFSET(0x19219D20)
#define MOLEMOLE_CONFIGMATERIALPROPERTYGLITCHMODIFIER_PROCESSKEEP_OFFSET UNITYSDK_OFFSET(0x1921A4E0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYGLITCHMODIFIER_SYNCENABLES_OFFSET UNITYSDK_OFFSET(0x1921A150)
#define MOLEMOLE_CONFIGMATERIALPROPERTYGLITCHMODIFIER_SYNCVALUES_OFFSET UNITYSDK_OFFSET(0x19219E10)
#define MOLEMOLE_CONFIGMATERIALPROPERTYGLITCHMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1921B450)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigMaterialPropertyGlitchModifier_TypeDefinitionIndex = 70141;
	...
	public:
		...
		::MoleMole::MaterialPropertyModifierValueColor _BlockColorD; // 0x78
		::MoleMole::MaterialPropertyModifierValueColor _BlockColorB; // 0x8C
		::MoleMole::MaterialPropertyModifierValueBool _ScreenScale; // 0xA0
		::MoleMole::MaterialPropertyModifierValueBool _Glitch; // 0xA3
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_413B2BDBE645DB66*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIGMATERIALPROPERTYGLITCHMODIFIER_DOONENTER_FORUSER_OFFSET))(this, instance);
		}

		::System::Void OnDone(::Class_1_413B2BDBE645DB66* instance)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_413B2BDBE645DB66*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIGMATERIALPROPERTYGLITCHMODIFIER_ONDONE_OFFSET))(this, instance);
		}
	};
}
