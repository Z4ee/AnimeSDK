...
#define MOLEMOLE_UIBUFFINFOPANELWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175BB420)
#define MOLEMOLE_UIBUFFINFOPANELWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x175BB4B0)
#define MOLEMOLE_UIBUFFINFOPANELWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x175BB350)
#define MOLEMOLE_UIBUFFINFOPANELWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x175BB3B0)
#define MOLEMOLE_UIBUFFINFOPANELWIDGETCONTROLLER_REFRESHACTIVESTATE_OFFSET UNITYSDK_OFFSET(0x175BB760)
#define MOLEMOLE_UIBUFFINFOPANELWIDGETCONTROLLER_REFRESHBUFFID_OFFSET UNITYSDK_OFFSET(0x175BB530)
#define MOLEMOLE_UIBUFFINFOPANELWIDGETCONTROLLER_REFRESHBUFF_1_OFFSET UNITYSDK_OFFSET(0x175BB9E0)
#define MOLEMOLE_UIBUFFINFOPANELWIDGETCONTROLLER_REFRESHBUFF_OFFSET UNITYSDK_OFFSET(0x175BB610)
#define MOLEMOLE_UIBUFFINFOPANELWIDGETCONTROLLER_SETTITLE_OFFSET UNITYSDK_OFFSET(0x175BB900)
#define MOLEMOLE_UIBUFFINFOPANELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x175BBB20)
#define MOLEMOLE_UIBUFFINFOPANELWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175BBB80)
#define MOLEMOLE_UIBUFFINFOPANELWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x175BBC10)
#define MOLEMOLE_UIBUFFINFOPANELWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x175BBCA0)
#define MOLEMOLE_UIBUFFINFOPANELWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x175BBD30)

namespace MoleMole
{
	inline static constexpr unsigned int UIBuffInfoPanelWidgetController_TypeDefinitionIndex = 40320;
