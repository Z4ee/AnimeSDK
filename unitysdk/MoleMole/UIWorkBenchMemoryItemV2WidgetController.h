...
#define MOLEMOLE_UIWORKBENCHMEMORYITEMV2WIDGETCONTROLLER_GET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x1490F6D0)
#define MOLEMOLE_UIWORKBENCHMEMORYITEMV2WIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x1490F550)
#define MOLEMOLE_UIWORKBENCHMEMORYITEMV2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1490EE80)
#define MOLEMOLE_UIWORKBENCHMEMORYITEMV2WIDGETCONTROLLER_ONISUNLOCKCHANGED_OFFSET UNITYSDK_OFFSET(0x1490F680)
#define MOLEMOLE_UIWORKBENCHMEMORYITEMV2WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1490EF90)
#define MOLEMOLE_UIWORKBENCHMEMORYITEMV2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1490EF10)
#define MOLEMOLE_UIWORKBENCHMEMORYITEMV2WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1490ECD0)
#define MOLEMOLE_UIWORKBENCHMEMORYITEMV2WIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x1490F400)
#define MOLEMOLE_UIWORKBENCHMEMORYITEMV2WIDGETCONTROLLER_SETLOCK_OFFSET UNITYSDK_OFFSET(0x1490F5B0)
#define MOLEMOLE_UIWORKBENCHMEMORYITEMV2WIDGETCONTROLLER_SET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x1490F370)
#define MOLEMOLE_UIWORKBENCHMEMORYITEMV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1490F6E0)
#define MOLEMOLE_UIWORKBENCHMEMORYITEMV2WIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x1490F6F0)
#define MOLEMOLE_UIWORKBENCHMEMORYITEMV2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1490F700)
#define MOLEMOLE_UIWORKBENCHMEMORYITEMV2WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1490F790)
#define MOLEMOLE_UIWORKBENCHMEMORYITEMV2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1490F830)
#define MOLEMOLE_UIWORKBENCHMEMORYITEMV2WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1490F8C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkBenchMemoryItemV2WidgetController_TypeDefinitionIndex = 41999;
