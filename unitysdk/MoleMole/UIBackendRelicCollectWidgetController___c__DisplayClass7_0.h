...
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0x193059A0)
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER___C__DISPLAYCLASS7_0__MATCHFUNCCOLLECTED_B__0_OFFSET UNITYSDK_OFFSET(0x19307040)

namespace MoleMole
{
	inline static constexpr unsigned int UIBackendRelicCollectWidgetController___c__DisplayClass7_0_TypeDefinitionIndex = 86479;
