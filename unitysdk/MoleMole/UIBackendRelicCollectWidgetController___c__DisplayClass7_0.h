...
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15B41250)
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER___C__DISPLAYCLASS7_0__MATCHFUNCCOLLECTED_B__0_OFFSET UNITYSDK_OFFSET(0x15B42900)

namespace MoleMole
{
	inline static constexpr unsigned int UIBackendRelicCollectWidgetController___c__DisplayClass7_0_TypeDefinitionIndex = 58287;
