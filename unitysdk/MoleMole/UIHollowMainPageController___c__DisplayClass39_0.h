...
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS39_0__CHECKCHESSBOARDPREPARE_B__2_OFFSET UNITYSDK_OFFSET(0x16917A80)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS39_0__CHECKCHESSBOARDPREPARE_G____AFTERBATTLEWAITFORMAINPAGEFADEIN_1_OFFSET UNITYSDK_OFFSET(0x169177B0)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS39_0__CHECKCHESSBOARDPREPARE_G____CHECKNORMALCHESSBOARD_0_OFFSET UNITYSDK_OFFSET(0x16917560)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS39_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16917550)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMainPageController___c__DisplayClass39_0_TypeDefinitionIndex = 78315;
	...
	public:
		...
		::System::Action* preloadFinishCallBack; // 0x18
