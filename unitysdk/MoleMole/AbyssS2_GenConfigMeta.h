...
#define MOLEMOLE_ABYSSS2_GENCONFIGMETA_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x8430B0)
#define MOLEMOLE_ABYSSS2_GENCONFIGMETA_VALIDATE_OFFSET UNITYSDK_OFFSET(0x8430F0)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_GenConfigMeta_TypeDefinitionIndex = 87603;
