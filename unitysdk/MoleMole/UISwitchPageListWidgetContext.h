...
#define MOLEMOLE_UISWITCHPAGELISTWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15EAA3E0)

namespace MoleMole
{
	inline static constexpr unsigned int UISwitchPageListWidgetContext_TypeDefinitionIndex = 51165;
