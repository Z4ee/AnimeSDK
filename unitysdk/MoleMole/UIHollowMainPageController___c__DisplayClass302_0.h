...
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS302_0__CTOR_OFFSET UNITYSDK_OFFSET(0x164D4020)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS302_0__LOADNXTLEVELFAKELOADINGVIEW_B__0_OFFSET UNITYSDK_OFFSET(0x164D4030)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMainPageController___c__DisplayClass302_0_TypeDefinitionIndex = 73680;
