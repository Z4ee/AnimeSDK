...
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER_DOFADEOUT_OFFSET UNITYSDK_OFFSET(0x162E3680)
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER_GETALPHA_OFFSET UNITYSDK_OFFSET(0x162EB9C0)
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER_MOLEMOLE_ISCREENLAYOUT_CALCULATELAYOUT_OFFSET UNITYSDK_OFFSET(0x162EBBD0)
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER_MOLEMOLE_ISCREENLAYOUT_GET_PAUSE_OFFSET UNITYSDK_OFFSET(0x162EBC20)
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER_MOLEMOLE_ISCREENLAYOUT_ONAFTERAPPLYLAYOUTBYPLATFORM_OFFSET UNITYSDK_OFFSET(0x162EBB90)
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER_MOLEMOLE_ISCREENLAYOUT_SET_PAUSE_OFFSET UNITYSDK_OFFSET(0x162EBC30)
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x162EB8B0)
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x162EB940)
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x162EB580)
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER_REFRESHSPRITECANVAS_OFFSET UNITYSDK_OFFSET(0x162EB5F0)
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x162E39D0)
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x162EBC40)
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x162EBD20)
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x162EBDB0)
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x162EBE40)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowDamnationEliminateWidgetController_TypeDefinitionIndex = 49924;

	class UIHollowDamnationEliminateWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_7382653E970C5F93* _view; // 0x2B8
		::MoleMole::UIHollowAchievementDialogWidgetController* parent; // 0x2C0
		::System::Boolean _MoleMole_IScreenLayout_Pause_k__BackingField; // 0x2C8
		::System::Collections::Generic::List_1<::MoleMole::UIHollowDamnationWidgetController*>* childCtrls; // 0x2D0
		::System::Collections::Generic::List_1<::Class_1_0D6706375CDAAE8C*>* blessList; // 0x2D8
