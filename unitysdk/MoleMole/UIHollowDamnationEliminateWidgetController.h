...
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER_DOFADEOUT_OFFSET UNITYSDK_OFFSET(0x1824F650)
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER_GETALPHA_OFFSET UNITYSDK_OFFSET(0x18257AA0)
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER_MOLEMOLE_ISCREENLAYOUT_CALCULATELAYOUT_OFFSET UNITYSDK_OFFSET(0x18257CB0)
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER_MOLEMOLE_ISCREENLAYOUT_GET_PAUSE_OFFSET UNITYSDK_OFFSET(0x18257D00)
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER_MOLEMOLE_ISCREENLAYOUT_ONAFTERAPPLYLAYOUTBYPLATFORM_OFFSET UNITYSDK_OFFSET(0x18257C70)
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER_MOLEMOLE_ISCREENLAYOUT_SET_PAUSE_OFFSET UNITYSDK_OFFSET(0x18257D10)
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18257990)
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18257A20)
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18257660)
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER_REFRESHSPRITECANVAS_OFFSET UNITYSDK_OFFSET(0x182576D0)
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1824F9A0)
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18257D20)
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18257E00)
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18257E90)
#define MOLEMOLE_UIHOLLOWDAMNATIONELIMINATEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18257F20)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowDamnationEliminateWidgetController_TypeDefinitionIndex = 71479;

	class UIHollowDamnationEliminateWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_7382653E970C5F93_3* _view; // 0x2C0
