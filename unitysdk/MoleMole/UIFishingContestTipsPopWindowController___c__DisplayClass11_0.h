...
#define MOLEMOLE_UIFISHINGCONTESTTIPSPOPWINDOWCONTROLLER___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15270EF0)
#define MOLEMOLE_UIFISHINGCONTESTTIPSPOPWINDOWCONTROLLER___C__DISPLAYCLASS11_0__ONSHOW_B__0_OFFSET UNITYSDK_OFFSET(0x15270F00)
#define MOLEMOLE_UIFISHINGCONTESTTIPSPOPWINDOWCONTROLLER___C__DISPLAYCLASS11_0__ONSHOW_B__1_OFFSET UNITYSDK_OFFSET(0x15271080)

namespace MoleMole
{
	inline static constexpr unsigned int UIFishingContestTipsPopWindowController___c__DisplayClass11_0_TypeDefinitionIndex = 56911;
