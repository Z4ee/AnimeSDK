...
#define MOLEMOLE_UIBABELTOWERPAUSEWIDGETCONTROLLER_GETBINDMODULES_OFFSET UNITYSDK_OFFSET(0x1977B830)
#define MOLEMOLE_UIBABELTOWERPAUSEWIDGETCONTROLLER_GETNESTEDLISTDELEGATEGOLIST_OFFSET UNITYSDK_OFFSET(0x1977B910)
#define MOLEMOLE_UIBABELTOWERPAUSEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1977B720)
#define MOLEMOLE_UIBABELTOWERPAUSEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1977B7B0)
#define MOLEMOLE_UIBABELTOWERPAUSEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19779520)
#define MOLEMOLE_UIBABELTOWERPAUSEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1977B6B0)
#define MOLEMOLE_UIBABELTOWERPAUSEWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x19779750)
#define MOLEMOLE_UIBABELTOWERPAUSEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1977BC70)
#define MOLEMOLE_UIBABELTOWERPAUSEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1977BDA0)
#define MOLEMOLE_UIBABELTOWERPAUSEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1977BE30)
#define MOLEMOLE_UIBABELTOWERPAUSEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1977BEC0)
#define MOLEMOLE_UIBABELTOWERPAUSEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1977BF50)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerPauseWidgetController_TypeDefinitionIndex = 52213;

	class UIBabeltowerPauseWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_B2303AC82AEE5F2A* _view; // 0x2C0
		::Class_2_48FC6C91D47A4882* scoreData; // 0x2C8
