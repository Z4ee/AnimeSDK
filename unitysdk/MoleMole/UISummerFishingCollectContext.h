...
#define MOLEMOLE_UISUMMERFISHINGCOLLECTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1274B180)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerFishingCollectContext_TypeDefinitionIndex = 69328;
