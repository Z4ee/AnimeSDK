...
#define MOLEMOLE_UIRABSTARUPSKILLWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1569F340)
#define MOLEMOLE_UIRABSTARUPSKILLWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1569F3B0)
#define MOLEMOLE_UIRABSTARUPSKILLWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1569F450)
#define MOLEMOLE_UIRABSTARUPSKILLWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1569F600)
#define MOLEMOLE_UIRABSTARUPSKILLWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1569F660)
#define MOLEMOLE_UIRABSTARUPSKILLWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1569F700)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABStarUpSkillWidgetController_TypeDefinitionIndex = 73290;
