...
#define MOLEMOLE_UIHOLLOWRESULTINFOROWNEWWIDGETCONTROLLER_BINDNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x19F330C0)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWNEWWIDGETCONTROLLER_MARKANIMATIONNOTPLAY_OFFSET UNITYSDK_OFFSET(0x19F32A00)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWNEWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19F32940)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWNEWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19F32B80)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWNEWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19F328E0)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWNEWWIDGETCONTROLLER_PLAYANIMATIONFADEIN_OFFSET UNITYSDK_OFFSET(0x19F32AC0)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWNEWWIDGETCONTROLLER_REFRESHVIEW_1_OFFSET UNITYSDK_OFFSET(0x19F33130)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWNEWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x19F32C20)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWNEWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19F339E0)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWNEWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19F33A40)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWNEWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19F33AD0)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWNEWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19F33B60)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowResultInfoRowNewWidgetController_TypeDefinitionIndex = 51480;
	...
	public:
		...
		::System::Void RefreshView(::Class_1_F24A790D52CF0024* quest)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_F24A790D52CF0024*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHOLLOWRESULTINFOROWNEWWIDGETCONTROLLER_REFRESHVIEW_OFFSET))(this, quest);
		}
