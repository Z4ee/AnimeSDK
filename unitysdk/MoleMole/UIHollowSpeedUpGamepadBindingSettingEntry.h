...
#define MOLEMOLE_UIHOLLOWSPEEDUPGAMEPADBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x16AE0730)
#define MOLEMOLE_UIHOLLOWSPEEDUPGAMEPADBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x16AE0740)
#define MOLEMOLE_UIHOLLOWSPEEDUPGAMEPADBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x16AE0750)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowSpeedUpGamepadBindingSettingEntry_TypeDefinitionIndex = 40428;
