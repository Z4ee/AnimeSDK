...
#define MOLEMOLE_GETITEMLISTSHOW_DIRECTSHOW_OFFSET UNITYSDK_OFFSET(0x19B19AE0)
#define MOLEMOLE_GETITEMLISTSHOW_DOPROCESS_OFFSET UNITYSDK_OFFSET(0x19B19B30)
#define MOLEMOLE_GETITEMLISTSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x19B19640)
#define MOLEMOLE_GETITEMLISTSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x19B19A90)
#define MOLEMOLE_GETITEMLISTSHOW_SETDETAILANDTTITLE_OFFSET UNITYSDK_OFFSET(0x19B1A0F0)
#define MOLEMOLE_GETITEMLISTSHOW_SETGOBTN_1_OFFSET UNITYSDK_OFFSET(0x19B19FB0)
#define MOLEMOLE_GETITEMLISTSHOW_SETGOBTN_OFFSET UNITYSDK_OFFSET(0x19B19F40)
#define MOLEMOLE_GETITEMLISTSHOW_SETMESSAGECONFIG_OFFSET UNITYSDK_OFFSET(0x19B19A30)
#define MOLEMOLE_GETITEMLISTSHOW_SHOWREWARDWINDOW_OFFSET UNITYSDK_OFFSET(0x19B19B80)
#define MOLEMOLE_GETITEMLISTSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x19B19650)
#define MOLEMOLE_GETITEMLISTSHOW___BASE_SETMESSAGECONFIG_OFFSET UNITYSDK_OFFSET(0x19B1A150)

namespace MoleMole
{
	inline static constexpr unsigned int GetItemListShow_TypeDefinitionIndex = 89512;
	...
	public:
		...
		::System::String* GainTitle; // 0x38
		::System::String* detail; // 0x40
		::MoleMole::GetItemListShow_GoBtnData GoData; // 0x48
		::System::Collections::Generic::List_1<::Class_1_0D6706375CDAAE8C*>* items; // 0x68
