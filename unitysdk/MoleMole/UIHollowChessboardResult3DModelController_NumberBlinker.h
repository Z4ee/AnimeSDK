...
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_NUMBERBLINKER_DONUMBERBLINKASYNC_OFFSET UNITYSDK_OFFSET(0x18816950)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_NUMBERBLINKER_GETBLINKMATRIXCONFIG_OFFSET UNITYSDK_OFFSET(0x18817310)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_NUMBERBLINKER_NUMBERBLINK_OFFSET UNITYSDK_OFFSET(0x18816A20)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_NUMBERBLINKER_SHOWNUMBER_OFFSET UNITYSDK_OFFSET(0x18816CD0)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_NUMBERBLINKER_SWITCHANDSHOWNUMBER_OFFSET UNITYSDK_OFFSET(0x18816B20)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_NUMBERBLINKER__CTOR_OFFSET UNITYSDK_OFFSET(0x18816860)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowChessboardResult3DModelController_NumberBlinker_TypeDefinitionIndex = 70492;

	class UIHollowChessboardResult3DModelController_NumberBlinker : public ::System::Object
	{
	public:
		::MonoHollowResultPageConfig* _config; // 0x10
		::Il2CppArray<::MoleMole::UIHollowChessPieceResult3DModelController*>* _chessPieceCtrlGrid; // 0x18
		::MoleMole::UIHollowChessboardResult3DModelController_RandomNumberSwitcher* _numberSwitcher; // 0x20
		::System::Int32 _configCol; // 0x28
		::System::Int32 _configRow; // 0x2C
