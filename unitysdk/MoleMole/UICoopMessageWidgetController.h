...
#define MOLEMOLE_UICOOPMESSAGEWIDGETCONTROLLER_ONCOOPMATCHSTARTMESSAGE_OFFSET UNITYSDK_OFFSET(0x14E91450)
#define MOLEMOLE_UICOOPMESSAGEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14E91340)
#define MOLEMOLE_UICOOPMESSAGEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14E913D0)
#define MOLEMOLE_UICOOPMESSAGEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14E90FF0)
#define MOLEMOLE_UICOOPMESSAGEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14E91050)
#define MOLEMOLE_UICOOPMESSAGEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14E914A0)
#define MOLEMOLE_UICOOPMESSAGEWIDGETCONTROLLER__ONUIOPEN_B__2_0_OFFSET UNITYSDK_OFFSET(0x14E91500)
#define MOLEMOLE_UICOOPMESSAGEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14E91580)
#define MOLEMOLE_UICOOPMESSAGEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14E91610)
#define MOLEMOLE_UICOOPMESSAGEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14E916A0)
#define MOLEMOLE_UICOOPMESSAGEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14E91730)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopMessageWidgetController_TypeDefinitionIndex = 41960;

	class UICoopMessageWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_68A5E7EF823C92F4* _view; // 0x2B8
