...
#define MOLEMOLE_UIQUESTIONSANSWERV43D3DMODELCONTROLLER_CREATEUIQUESTIONSANSWERSCREENWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x168FE860)
#define MOLEMOLE_UIQUESTIONSANSWERV43D3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x168FE910)
#define MOLEMOLE_UIQUESTIONSANSWERV43D3DMODELCONTROLLER___BASE_CREATEUIQUESTIONSANSWERSCREENWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x168FE970)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerV43D3DModelController_TypeDefinitionIndex = 43458;
