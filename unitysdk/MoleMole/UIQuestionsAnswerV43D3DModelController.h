...
#define MOLEMOLE_UIQUESTIONSANSWERV43D3DMODELCONTROLLER_CREATEUIQUESTIONSANSWERSCREENWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x13FF3000)
#define MOLEMOLE_UIQUESTIONSANSWERV43D3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x13FF30B0)
#define MOLEMOLE_UIQUESTIONSANSWERV43D3DMODELCONTROLLER___BASE_CREATEUIQUESTIONSANSWERSCREENWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x13FF3110)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerV43D3DModelController_TypeDefinitionIndex = 66725;
