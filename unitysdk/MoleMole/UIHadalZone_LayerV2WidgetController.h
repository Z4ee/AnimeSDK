...
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_CREATEIMPACTBATTLELAYER_OFFSET UNITYSDK_OFFSET(0x16AAD080)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_CREATENORMALLAYER_OFFSET UNITYSDK_OFFSET(0x16AACDC0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_GET_ONENTERLAYERROOMCALLBACK_OFFSET UNITYSDK_OFFSET(0x16AAA640)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_GET_ONSWITCHZONE_OFFSET UNITYSDK_OFFSET(0x16AAA620)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16AAB9C0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x16AAF550)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x16AAF450)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x16AAC440)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x16AAB930)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x16AAEAC0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_ONPARENTWINDOWFADEINDONE_OFFSET UNITYSDK_OFFSET(0x16AADFC0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_ONREWARDNOTIFICATIONUPDATE_OFFSET UNITYSDK_OFFSET(0x16AAE160)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x16AAB720)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16AABA50)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16AAA660)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16AAA8D0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_SETLAYERWIDGET_OFFSET UNITYSDK_OFFSET(0x16AACE70)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_SET_ONENTERLAYERROOMCALLBACK_OFFSET UNITYSDK_OFFSET(0x16AAA650)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_SET_ONSWITCHZONE_OFFSET UNITYSDK_OFFSET(0x16AAA630)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_UPDATEFRAMETEXTURE_OFFSET UNITYSDK_OFFSET(0x16AAE010)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__BINDGAMEPAD_OFFSET UNITYSDK_OFFSET(0x16AAB4C0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__BINDZONEINFOBTN_OFFSET UNITYSDK_OFFSET(0x16AAC320)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__CHECKPREVDYNAMICLAYER_OFFSET UNITYSDK_OFFSET(0x16AAD8E0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__CLOSELAYERSPREV_OFFSET UNITYSDK_OFFSET(0x16AAB770)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16AAF840)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__FINDLAYERINDEXTOLISTINDEX_OFFSET UNITYSDK_OFFSET(0x16AAD130)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__GAMEPADITEMSUBMIT_OFFSET UNITYSDK_OFFSET(0x16AAF130)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__GAMEPADSELECTNAVLISTITEM_OFFSET UNITYSDK_OFFSET(0x16AAEC20)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__MARKALLLAYERROWSTATU_OFFSET UNITYSDK_OFFSET(0x16AAE5B0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__ONCLICK_LAYERITEM_OFFSET UNITYSDK_OFFSET(0x16AAE430)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__ONCLICK_ZONEINFOITEM_OFFSET UNITYSDK_OFFSET(0x16AACBC0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__ONUIOPEN_B__14_0_OFFSET UNITYSDK_OFFSET(0x16AAFA90)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__ONUIOPEN_B__14_1_OFFSET UNITYSDK_OFFSET(0x16AAFC30)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__ONUIOPEN_B__14_2_OFFSET UNITYSDK_OFFSET(0x16AAFC20)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__RECORDREWARDBTNCLICK_OFFSET UNITYSDK_OFFSET(0x16AAE820)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__SETLAYERSSCROLLCREATEFUNC_OFFSET UNITYSDK_OFFSET(0x16AAACA0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__SETLAYERWIDGET_B__41_0_OFFSET UNITYSDK_OFFSET(0x16AB05D0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__SETLAYERWIDGET_B__41_1_OFFSET UNITYSDK_OFFSET(0x16AB05E0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__SETLAYERWIDGET_B__41_2_OFFSET UNITYSDK_OFFSET(0x16AB06E0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__SHOWZONEINFO_OFFSET UNITYSDK_OFFSET(0x16AAC6B0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__TRYSELECTZONEITEM_OFFSET UNITYSDK_OFFSET(0x16AABBD0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__UPDATEBADGE_OFFSET UNITYSDK_OFFSET(0x16AADF50)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__UPDATECONSOLELAYERBYSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x16AAC920)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__UPDATEFRAMETEXTURE_G__SHOULDPLAYREWARDFRAMETEXTURE_47_0_OFFSET UNITYSDK_OFFSET(0x16AAE1B0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__UPDATEZONEINFO_OFFSET UNITYSDK_OFFSET(0x16AAD2A0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__UPDATEZONES_OFFSET UNITYSDK_OFFSET(0x16AAAE40)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__UPDATE_ZONELAYERS_OFFSET UNITYSDK_OFFSET(0x16AABEE0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16AB0720)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x16AB07B0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x16AB0840)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER___BASE_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x16AB08D0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x16AB09C0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x16AB0A50)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x16AB0A80)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16AB0A90)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16AB0B20)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16AB0BB0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER___BINDGAMEPAD_B__18_1_OFFSET UNITYSDK_OFFSET(0x16AAFDC0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER___BINDZONEINFOBTN_B__31_0_OFFSET UNITYSDK_OFFSET(0x16AB0220)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER___SETLAYERSSCROLLCREATEFUNC_B__38_0_OFFSET UNITYSDK_OFFSET(0x16AB03E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_LayerV2WidgetController_TypeDefinitionIndex = 62771;
	...
	public:
		...
		::System::Action_1<::Class_1_5DA2E7556103D5A3_399*>* _OnEnterLayerRoomCallback_k__BackingField; // 0x2E0
		...
		::System::Action_1<::Class_1_5DA2E7556103D5A3_399*>* get_OnEnterLayerRoomCallback()
		{
			return ((::System::Action_1<::Class_1_5DA2E7556103D5A3_399*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_GET_ONENTERLAYERROOMCALLBACK_OFFSET))(this);
		}

		::System::Void set_OnEnterLayerRoomCallback(::System::Action_1<::Class_1_5DA2E7556103D5A3_399*>* value)
		{
			return ((::System::Void(*)(::PVOID, ::System::Action_1<::Class_1_5DA2E7556103D5A3_399*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_SET_ONENTERLAYERROOMCALLBACK_OFFSET))(this, value);
		}
		...
		::System::Int32 _FindLayerIndexToListIndex(::System::Collections::Generic::List_1<::Class_1_5DA2E7556103D5A3_399*>* dataList, ::System::Int32 layerIndex)
		{
			return ((::System::Int32(*)(::PVOID, ::System::Collections::Generic::List_1<::Class_1_5DA2E7556103D5A3_399*>*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__FINDLAYERINDEXTOLISTINDEX_OFFSET))(this, dataList, layerIndex);
		}
