...
#define MOLEMOLE_UICOLORTWEAKERTARGETGROUP_GET_LEADERCOLOR_OFFSET UNITYSDK_OFFSET(0x176114D0)
#define MOLEMOLE_UICOLORTWEAKERTARGETGROUP_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x17611C00)
#define MOLEMOLE_UICOLORTWEAKERTARGETGROUP_METHOD_1_7A0A609FED879DF6_OFFSET UNITYSDK_OFFSET(0x176124E0)
#define MOLEMOLE_UICOLORTWEAKERTARGETGROUP_METHOD_1_B0F2C48B9F11EEB1_OFFSET UNITYSDK_OFFSET(0x17611650)
#define MOLEMOLE_UICOLORTWEAKERTARGETGROUP_METHOD_1_D4E0886303081325_OFFSET UNITYSDK_OFFSET(0x17611870)
#define MOLEMOLE_UICOLORTWEAKERTARGETGROUP_METHOD_1_DC715239B8B98D9C_OFFSET UNITYSDK_OFFSET(0x17611C60)
#define MOLEMOLE_UICOLORTWEAKERTARGETGROUP_METHOD_1_EE60F812A0098D6C_OFFSET UNITYSDK_OFFSET(0x176120C0)
#define MOLEMOLE_UICOLORTWEAKERTARGETGROUP_SET_LEADERCOLOR_OFFSET UNITYSDK_OFFSET(0x17611500)
#define MOLEMOLE_UICOLORTWEAKERTARGETGROUP__CCTOR_OFFSET UNITYSDK_OFFSET(0x176115E0)
#define MOLEMOLE_UICOLORTWEAKERTARGETGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x176115D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIColorTweakerTargetGroup_TypeDefinitionIndex = 54413;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::MoleMole::UIColorTweakerTargetGroup_Struct_2_B6CC7A1324E97FE4>**)Il2CppClass::FromTypeDefinitionIndex(UIColorTweakerTargetGroup_TypeDefinitionIndex)->GetStaticField(0x41370);
		}
