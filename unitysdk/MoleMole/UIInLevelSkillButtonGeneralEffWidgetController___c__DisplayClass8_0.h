...
#define MOLEMOLE_UIINLEVELSKILLBUTTONGENERALEFFWIDGETCONTROLLER___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16BFDC30)
#define MOLEMOLE_UIINLEVELSKILLBUTTONGENERALEFFWIDGETCONTROLLER___C__DISPLAYCLASS8_0__PLAYFEEDBACK_B__0_OFFSET UNITYSDK_OFFSET(0x16BFDC40)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelSkillButtonGeneralEffWidgetController___c__DisplayClass8_0_TypeDefinitionIndex = 87441;
