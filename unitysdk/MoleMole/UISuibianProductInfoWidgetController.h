...
#define MOLEMOLE_UISUIBIANPRODUCTINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x11B6DEE0)
#define MOLEMOLE_UISUIBIANPRODUCTINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x11B6E0A0)
#define MOLEMOLE_UISUIBIANPRODUCTINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x11B6DE10)
#define MOLEMOLE_UISUIBIANPRODUCTINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x11B6DE70)
#define MOLEMOLE_UISUIBIANPRODUCTINFOWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x11B6E1C0)
#define MOLEMOLE_UISUIBIANPRODUCTINFOWIDGETCONTROLLER_SETDARK_OFFSET UNITYSDK_OFFSET(0x11B6E120)
#define MOLEMOLE_UISUIBIANPRODUCTINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11B6E8A0)
#define MOLEMOLE_UISUIBIANPRODUCTINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x11B6E900)
#define MOLEMOLE_UISUIBIANPRODUCTINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x11B6E990)
#define MOLEMOLE_UISUIBIANPRODUCTINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x11B6EA20)
#define MOLEMOLE_UISUIBIANPRODUCTINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x11B6EAB0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianProductInfoWidgetController_TypeDefinitionIndex = 71766;

	class UISuibianProductInfoWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_F2A455F9EA6FD712* _view; // 0x2B8
