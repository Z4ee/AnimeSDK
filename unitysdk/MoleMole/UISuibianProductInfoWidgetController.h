...
#define MOLEMOLE_UISUIBIANPRODUCTINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17BA5300)
#define MOLEMOLE_UISUIBIANPRODUCTINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17BA54C0)
#define MOLEMOLE_UISUIBIANPRODUCTINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17BA5230)
#define MOLEMOLE_UISUIBIANPRODUCTINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17BA5290)
#define MOLEMOLE_UISUIBIANPRODUCTINFOWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x17BA55E0)
#define MOLEMOLE_UISUIBIANPRODUCTINFOWIDGETCONTROLLER_SETDARK_OFFSET UNITYSDK_OFFSET(0x17BA5540)
#define MOLEMOLE_UISUIBIANPRODUCTINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17BA5CE0)
#define MOLEMOLE_UISUIBIANPRODUCTINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17BA5D40)
#define MOLEMOLE_UISUIBIANPRODUCTINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17BA5DD0)
#define MOLEMOLE_UISUIBIANPRODUCTINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17BA5E60)
#define MOLEMOLE_UISUIBIANPRODUCTINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17BA5EF0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianProductInfoWidgetController_TypeDefinitionIndex = 57733;
