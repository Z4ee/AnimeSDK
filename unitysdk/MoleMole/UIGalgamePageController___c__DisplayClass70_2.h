...
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS70_2__CTOR_OFFSET UNITYSDK_OFFSET(0x149D5F90)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS70_2__PLAYSWITCHSCENEGROUPNODE_INNER_B__10_OFFSET UNITYSDK_OFFSET(0x149D6E40)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS70_2__PLAYSWITCHSCENEGROUPNODE_INNER_B__11_OFFSET UNITYSDK_OFFSET(0x149D7240)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS70_2__PLAYSWITCHSCENEGROUPNODE_INNER_B__12_OFFSET UNITYSDK_OFFSET(0x149D6690)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS70_2__PLAYSWITCHSCENEGROUPNODE_INNER_B__15_OFFSET UNITYSDK_OFFSET(0x149D69A0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS70_2__PLAYSWITCHSCENEGROUPNODE_INNER_B__6_OFFSET UNITYSDK_OFFSET(0x149D5FA0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS70_2__PLAYSWITCHSCENEGROUPNODE_INNER_B__7_OFFSET UNITYSDK_OFFSET(0x149D6240)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS70_2__PLAYSWITCHSCENEGROUPNODE_INNER_B__8_OFFSET UNITYSDK_OFFSET(0x149D6A60)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS70_2__PLAYSWITCHSCENEGROUPNODE_INNER_B__9_OFFSET UNITYSDK_OFFSET(0x149D6CD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgamePageController___c__DisplayClass70_2_TypeDefinitionIndex = 41801;
	...
	public:
		...
		::MoleMole::UIGalgameTextRowWidgetController* itemController; // 0x28
		::Class_2_9A82E4A106BA6573* voicePlayable; // 0x30
		::DG::Tweening::TweenCallback* __9__15; // 0x38
		::MoleMole::UIGalgamePageController___c__DisplayClass70_1* CS___8__locals2; // 0x40
		::System::String* talkText; // 0x48
