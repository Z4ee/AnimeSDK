...
#define MOLEMOLE_UIINTERKNOTFORUMLEVELROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17828970)
#define MOLEMOLE_UIINTERKNOTFORUMLEVELROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x178289E0)
#define MOLEMOLE_UIINTERKNOTFORUMLEVELROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17828A80)
#define MOLEMOLE_UIINTERKNOTFORUMLEVELROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x17828B40)
#define MOLEMOLE_UIINTERKNOTFORUMLEVELROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17828CC0)
#define MOLEMOLE_UIINTERKNOTFORUMLEVELROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17828CD0)
#define MOLEMOLE_UIINTERKNOTFORUMLEVELROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17828D70)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotForumLevelRowWidgetController_TypeDefinitionIndex = 69814;
