...
#define MOLEMOLE_UIINTERKNOTFORUMLEVELROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x155F1C50)
#define MOLEMOLE_UIINTERKNOTFORUMLEVELROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x155F1CC0)
#define MOLEMOLE_UIINTERKNOTFORUMLEVELROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x155F1D60)
#define MOLEMOLE_UIINTERKNOTFORUMLEVELROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x155F1E20)
#define MOLEMOLE_UIINTERKNOTFORUMLEVELROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x155F1FA0)
#define MOLEMOLE_UIINTERKNOTFORUMLEVELROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x155F1FB0)
#define MOLEMOLE_UIINTERKNOTFORUMLEVELROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x155F2050)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotForumLevelRowWidgetController_TypeDefinitionIndex = 76444;
