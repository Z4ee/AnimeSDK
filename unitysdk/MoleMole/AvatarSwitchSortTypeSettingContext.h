...
#define MOLEMOLE_AVATARSWITCHSORTTYPESETTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x159BC1B0)

namespace MoleMole
{
	inline static constexpr unsigned int AvatarSwitchSortTypeSettingContext_TypeDefinitionIndex = 42094;
