...
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER__WAITBLACKSCREENFADEOUT_D__104_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x811210)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER__WAITBLACKSCREENFADEOUT_D__104_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x283610)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerWidgetController__WaitBlackscreenFadeOut_d__104_TypeDefinitionIndex = 61866;
