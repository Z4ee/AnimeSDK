...
#define MOLEMOLE_TEXTURESHEETLOOPFRAME_COLLIDEREND_OFFSET UNITYSDK_OFFSET(0x18D00740)
#define MOLEMOLE_TEXTURESHEETLOOPFRAME_COLLIDERSTART_OFFSET UNITYSDK_OFFSET(0x18D006A0)
#define MOLEMOLE_TEXTURESHEETLOOPFRAME_ISEND_OFFSET UNITYSDK_OFFSET(0x18D00790)
#define MOLEMOLE_TEXTURESHEETLOOPFRAME_NEXTLOOP_OFFSET UNITYSDK_OFFSET(0x18D007F0)
#define MOLEMOLE_TEXTURESHEETLOOPFRAME_RESET_OFFSET UNITYSDK_OFFSET(0x18D006F0)
#define MOLEMOLE_TEXTURESHEETLOOPFRAME_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18D00830)
#define MOLEMOLE_TEXTURESHEETLOOPFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x18D00B90)
#define MOLEMOLE_TEXTURESHEETLOOPFRAME___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18D00BA0)

namespace MoleMole
{
	inline static constexpr unsigned int TextureSheetLoopFrame_TypeDefinitionIndex = 70861;

	class TextureSheetLoopFrame : public ::System::Object
	{
	public:
		::System::Int32 startFrame; // 0x10
		::System::Int32 curLoopCount; // 0x14
