...
#define MOLEMOLE_UIACTIVITYBLINDBOXTABBTNWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x173C21F0)
#define MOLEMOLE_UIACTIVITYBLINDBOXTABBTNWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x173C2260)
#define MOLEMOLE_UIACTIVITYBLINDBOXTABBTNWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x173C2300)
#define MOLEMOLE_UIACTIVITYBLINDBOXTABBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x173C24B0)
#define MOLEMOLE_UIACTIVITYBLINDBOXTABBTNWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x173C2510)
#define MOLEMOLE_UIACTIVITYBLINDBOXTABBTNWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x173C25B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityBlindBoxTabBtnWidgetController_TypeDefinitionIndex = 54343;
