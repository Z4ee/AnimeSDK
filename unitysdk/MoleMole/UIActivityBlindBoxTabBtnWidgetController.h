...
#define MOLEMOLE_UIACTIVITYBLINDBOXTABBTNWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18E0AA50)
#define MOLEMOLE_UIACTIVITYBLINDBOXTABBTNWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18E0AAC0)
#define MOLEMOLE_UIACTIVITYBLINDBOXTABBTNWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18E0AB60)
#define MOLEMOLE_UIACTIVITYBLINDBOXTABBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18E0AD20)
#define MOLEMOLE_UIACTIVITYBLINDBOXTABBTNWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18E0AD80)
#define MOLEMOLE_UIACTIVITYBLINDBOXTABBTNWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18E0AE20)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityBlindBoxTabBtnWidgetController_TypeDefinitionIndex = 86461;
