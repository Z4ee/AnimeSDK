...
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE_CHECKRARITYTV_OFFSET UNITYSDK_OFFSET(0x17308410)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE_GETCHARACTERLIGHTSTLPATH_OFFSET UNITYSDK_OFFSET(0x173083C0)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE_GETLIGHTIDS_OFFSET UNITYSDK_OFFSET(0x17308380)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE_GETRARITYEFFDELAY_OFFSET UNITYSDK_OFFSET(0x17308080)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE_GET_BLUEPRINT_NAME_OFFSET UNITYSDK_OFFSET(0x17308480)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE_GET_CONTENTROOTANIM_OFFSET UNITYSDK_OFFSET(0x17308500)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE_GET_TOTAL_TV_NUM_OFFSET UNITYSDK_OFFSET(0x17308330)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE_HANDLEONOPEN_OFFSET UNITYSDK_OFFSET(0x17305090)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE_HANDLEUPDATE_OFFSET UNITYSDK_OFFSET(0x173052B0)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE_INITLIGHTS_OFFSET UNITYSDK_OFFSET(0x17308340)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE_ONREFRESHSTAGE_OFFSET UNITYSDK_OFFSET(0x173054C0)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE_PRELOADSTAGEBEFOREPLAY_OFFSET UNITYSDK_OFFSET(0x17305460)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE_STOPSOUND_OFFSET UNITYSDK_OFFSET(0x17305310)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x17308510)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE___BASE_CHECKRARITYTV_OFFSET UNITYSDK_OFFSET(0x17308610)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE___BASE_GETRARITYEFFDELAY_OFFSET UNITYSDK_OFFSET(0x173086E0)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE___BASE_GET_BLUEPRINT_NAME_OFFSET UNITYSDK_OFFSET(0x173086D0)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE___BASE_HANDLEONOPEN_OFFSET UNITYSDK_OFFSET(0x173086F0)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE___BASE_HANDLEUPDATE_OFFSET UNITYSDK_OFFSET(0x17308700)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE___BASE_STOPSOUND_OFFSET UNITYSDK_OFFSET(0x17308790)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaStageTv3DModelControllerBase_TypeDefinitionIndex = 62334;
	...
	public:
		...
		::Class_2_208CC9941471731A_384* _gachaPerformTamplate; // 0x678
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_385*, ::System::Action*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE_PRELOADSTAGEBEFOREPLAY_OFFSET))(this, template_, preloadComplete);
		}
