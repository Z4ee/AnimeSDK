...
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_CREATEFULLHIERACHY_OFFSET UNITYSDK_OFFSET(0x13E4C370)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_CREATETALENTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x13E4ECA0)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x13E4BE00)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x13E4BE10)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_ISINPUTMENUNAVIGATION_OFFSET UNITYSDK_OFFSET(0x13E50C50)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x13E4BE80)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x13E4E960)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x13E50AD0)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x13E504E0)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_ONNODELEVELCHANGED_OFFSET UNITYSDK_OFFSET(0x13E50A60)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_ONNODESTATECHANGED_OFFSET UNITYSDK_OFFSET(0x13E505A0)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x13E4DFB0)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x13E4E360)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x13E4BF20)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_OPENBANGKOVITEMINFOFROMCOSTICON_OFFSET UNITYSDK_OFFSET(0x13E4E730)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_REFRESHALLTALENTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x13E500F0)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_REFRESHPROGRESSBAR_OFFSET UNITYSDK_OFFSET(0x13E4F820)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x13E4E900)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x13E50CA0)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER__ONINPUTACTION_B__33_0_OFFSET UNITYSDK_OFFSET(0x13E511A0)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER__OPENBANGKOVITEMINFOFROMCOSTICON_B__21_0_OFFSET UNITYSDK_OFFSET(0x13E50FF0)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x13E511B0)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x13E51250)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x13E51300)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x13E51330)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x13E513C0)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x13E51480)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x13E51490)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangkovTalentPageController_TypeDefinitionIndex = 49172;
	...
	public:
		...
		::System::Collections::Generic::List_1<::UnityEngine::Transform*>* _talentColPanelsLayer1; // 0x310
		::System::Collections::Generic::List_1<::UnityEngine::Transform*>* _talentColPanelsLayer2; // 0x318
		::System::Collections::Generic::List_1<::UnityEngine::Transform*>* _talentCols; // 0x320
		::System::Collections::Generic::List_1<::UnityEngine::Transform*>* _staffTalentAnchorsLayer1; // 0x328
		::System::Collections::Generic::List_1<::UnityEngine::Transform*>* _staffTalentAnchorsLayer2; // 0x330
		::System::Collections::Generic::List_1<::System::Int32>* _staffTalentLevelChecks; // 0x338
		::System::Collections::Generic::Dictionary_2<::Class_2_D1CED082B4F1459A_Class_2_EDF9FC262B9CBBA4*, ::MoleMole::UIBangkovTalentPointWidgetController*>* _nodeControllers; // 0x340
		::System::Collections::Generic::Dictionary_2<::Class_2_D1CED082B4F1459A_Class_2_EDF9FC262B9CBBA4*, ::System::Collections::Generic::List_1<::MoleMole::UIBangkovTalentPageController_TalentConnectionLine*>*>* _nodeConnections; // 0x348
		::System::Collections::Generic::List_1<::MoleMole::UIBangkovTalentPointWidgetController*>* _staffTalentNodes; // 0x350
		::Class_1_61933880828D8052* _bangkovItemInfo; // 0x358
		...
		::Class_2_8084448E150A929C* get__viewModel()
		{
			return ((::Class_2_8084448E150A929C*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
		...
		::System::Void OpenBangkovItemInfoFromCostIcon(::MoleMole::UIItemIconBtnWidgetController* iconController, ::System::Int32 logicItemId)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::UIItemIconBtnWidgetController*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_OPENBANGKOVITEMINFOFROMCOSTICON_OFFSET))(this, iconController, logicItemId);
		}
