...
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_CREATEFULLHIERACHY_OFFSET UNITYSDK_OFFSET(0x15B4B580)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_CREATETALENTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x15B4DFB0)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15B4B010)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15B4B020)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_ISINPUTMENUNAVIGATION_OFFSET UNITYSDK_OFFSET(0x15B4FF50)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15B4B090)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x15B4DC70)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x15B4FDD0)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x15B4F7E0)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_ONNODELEVELCHANGED_OFFSET UNITYSDK_OFFSET(0x15B4FD60)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_ONNODESTATECHANGED_OFFSET UNITYSDK_OFFSET(0x15B4F8A0)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x15B4D2C0)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15B4D670)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15B4B130)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_OPENBANGKOVITEMINFOFROMCOSTICON_OFFSET UNITYSDK_OFFSET(0x15B4DA40)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_REFRESHALLTALENTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x15B4F3F0)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_REFRESHPROGRESSBAR_OFFSET UNITYSDK_OFFSET(0x15B4EB20)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x15B4DC10)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15B4FFA0)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER__ONINPUTACTION_B__33_0_OFFSET UNITYSDK_OFFSET(0x15B50480)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER__OPENBANGKOVITEMINFOFROMCOSTICON_B__21_0_OFFSET UNITYSDK_OFFSET(0x15B502F0)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15B50490)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x15B50530)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x15B505E0)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x15B50610)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x15B506A0)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15B50760)
#define MOLEMOLE_UIBANGKOVTALENTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15B50770)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangkovTalentPageController_TypeDefinitionIndex = 69426;
	...
	public:
		...
		::Class_1_61933880828D8052* _bangkovItemInfo; // 0x360
