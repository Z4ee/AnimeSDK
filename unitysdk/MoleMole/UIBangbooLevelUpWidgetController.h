...
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_CALMAXMATERIALCOUNT_OFFSET UNITYSDK_OFFSET(0x142CA180)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_CLEARMATERIAL_OFFSET UNITYSDK_OFFSET(0x142C9F50)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_GETALLSELECTMATERIAL_OFFSET UNITYSDK_OFFSET(0x142C6D70)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_GETHASSELECTMATERIAL_OFFSET UNITYSDK_OFFSET(0x142C6C70)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_GETLEFTBTNTEXT_OFFSET UNITYSDK_OFFSET(0x142C79E0)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_GETRIGHTBTNTEXT_OFFSET UNITYSDK_OFFSET(0x142C7A70)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_GETTIPSTEXT_OFFSET UNITYSDK_OFFSET(0x142C7B00)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_LEFTBTNCALL_OFFSET UNITYSDK_OFFSET(0x142C6780)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_ONBEFOREWORLDUPDATE_OFFSET UNITYSDK_OFFSET(0x142C8B80)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_ONBUDDYLEVELUP_OFFSET UNITYSDK_OFFSET(0x142CAC00)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x142C7530)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x142C85F0)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x142C9490)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_ONITEMCHANGE_OFFSET UNITYSDK_OFFSET(0x142C5D30)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_ONMATITEMCHANGED_OFFSET UNITYSDK_OFFSET(0x142CA3B0)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x142C6690)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x142C76B0)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x142C5A40)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_REFRESHLEVELUPINPUTKEY_OFFSET UNITYSDK_OFFSET(0x142C8710)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_REQLEVELUP_OFFSET UNITYSDK_OFFSET(0x142C70D0)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_RIGHTBTNCALL_OFFSET UNITYSDK_OFFSET(0x142C7080)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_SETCONSUME_OFFSET UNITYSDK_OFFSET(0x142C7C80)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_SETPROGRESSMAT_OFFSET UNITYSDK_OFFSET(0x142C7320)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_SETPROGRESS_OFFSET UNITYSDK_OFFSET(0x142C7B90)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_TRIGGERGAMEPADADDBTN_OFFSET UNITYSDK_OFFSET(0x142C8C30)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_TRIGGERGAMEPADREDUCEBTN_OFFSET UNITYSDK_OFFSET(0x142C9060)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0x142C5D80)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x142CB180)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER__ONBUDDYLEVELUP_B__33_1_OFFSET UNITYSDK_OFFSET(0x142CB360)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER__ONBUDDYLEVELUP_B__33_2_OFFSET UNITYSDK_OFFSET(0x142CB4C0)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER___BASE_GETLEFTBTNTEXT_OFFSET UNITYSDK_OFFSET(0x142CB5A0)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER___BASE_GETRIGHTBTNTEXT_OFFSET UNITYSDK_OFFSET(0x142CB630)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER___BASE_GETTIPSTEXT_OFFSET UNITYSDK_OFFSET(0x142CB6C0)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER___BASE_LEFTBTNCALL_OFFSET UNITYSDK_OFFSET(0x142CB750)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x142CB7E0)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x142CB870)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x142CB920)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x142CB950)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x142CB9F0)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x142CBA80)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER___BASE_RIGHTBTNCALL_OFFSET UNITYSDK_OFFSET(0x142CBB10)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER___BASE_SETPROGRESSMAT_OFFSET UNITYSDK_OFFSET(0x142CBBA0)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER___BASE_UPDATEUI_OFFSET UNITYSDK_OFFSET(0x142CBC30)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooLevelUpWidgetController_TypeDefinitionIndex = 58594;

	class UIBangbooLevelUpWidgetController : public ::MoleMole::BangbooBaseWidget
	{
	public:
		::Class_2_DBC51CF79F50022E* _view; // 0x2D8
		::System::Collections::Generic::List_1<::MoleMole::UIItemIconBtnWidgetController*>* _expMatItems; // 0x2E0
		::System::Int32 _nowLv; // 0x2E8
		::System::Int32 roleToMaxLvNeedExp; // 0x2EC
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* hasMaterialDir; // 0x2F0
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* suggestMaterialDir; // 0x2F8
		::Class_2_9D9172C07F82DDAE* _itemDataProxy; // 0x300
		::System::Int32 tarLevel; // 0x308
		::Class_2_79F6D62CE30E3F8E_84* _ParentView; // 0x310
		::System::Int32 curToMaxLeftEXP; // 0x318
		::MoleMole::MonoGamepadCustomList* _monoGamepadCustomList; // 0x320
		::System::Int32 _gamepadAddSelectIndex; // 0x328
		::System::Int32 _gamepadReduceSelectIndex; // 0x32C
		::System::Boolean _isGamepadAddBtnPressed; // 0x330
		::System::Boolean _isGamepadReduceBtnPressed; // 0x331
