...
#define MOLEMOLE_OVERRIDEGENERALGRAPHICPROFILEPOSTPROCESSORPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x11D5B9B0)
#define MOLEMOLE_OVERRIDEGENERALGRAPHICPROFILEPOSTPROCESSORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x11D5BA20)
#define MOLEMOLE_OVERRIDEGENERALGRAPHICPROFILEPOSTPROCESSORPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x11D5BB10)

namespace MoleMole
{
	inline static constexpr unsigned int OverrideGeneralGraphicProfilePostProcessorProfile_TypeDefinitionIndex = 66545;
