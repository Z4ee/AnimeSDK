...
#define MOLEMOLE_UIYOROZUYAENTRUSTINFOROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x156F0840)
#define MOLEMOLE_UIYOROZUYAENTRUSTINFOROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x156F08D0)
#define MOLEMOLE_UIYOROZUYAENTRUSTINFOROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x156F06A0)
#define MOLEMOLE_UIYOROZUYAENTRUSTINFOROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x156F07D0)
#define MOLEMOLE_UIYOROZUYAENTRUSTINFOROWWIDGETCONTROLLER_SETABYSS_OFFSET UNITYSDK_OFFSET(0x156F1540)
#define MOLEMOLE_UIYOROZUYAENTRUSTINFOROWWIDGETCONTROLLER_SETCHALLENGE_OFFSET UNITYSDK_OFFSET(0x156F0D70)
#define MOLEMOLE_UIYOROZUYAENTRUSTINFOROWWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x156F1CA0)
#define MOLEMOLE_UIYOROZUYAENTRUSTINFOROWWIDGETCONTROLLER_SETHOLLOWCHALLENGEBYOVERRIDEITEMDATA_OFFSET UNITYSDK_OFFSET(0x156F14A0)
#define MOLEMOLE_UIYOROZUYAENTRUSTINFOROWWIDGETCONTROLLER_SETHOLLOWCHALLENGE_OFFSET UNITYSDK_OFFSET(0x156F1430)
#define MOLEMOLE_UIYOROZUYAENTRUSTINFOROWWIDGETCONTROLLER_SETPLAYTYPETEXT_OFFSET UNITYSDK_OFFSET(0x156F1AD0)
#define MOLEMOLE_UIYOROZUYAENTRUSTINFOROWWIDGETCONTROLLER_SETRALLYCHALLENGE_OFFSET UNITYSDK_OFFSET(0x156F0BF0)
#define MOLEMOLE_UIYOROZUYAENTRUSTINFOROWWIDGETCONTROLLER__CHECKCHALLENGEFINISH_OFFSET UNITYSDK_OFFSET(0x156F0A00)
#define MOLEMOLE_UIYOROZUYAENTRUSTINFOROWWIDGETCONTROLLER__CHECKCHALLENGEIDVALID_OFFSET UNITYSDK_OFFSET(0x156F0950)
#define MOLEMOLE_UIYOROZUYAENTRUSTINFOROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x156F1D20)
#define MOLEMOLE_UIYOROZUYAENTRUSTINFOROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x156F1D30)
#define MOLEMOLE_UIYOROZUYAENTRUSTINFOROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x156F1DC0)
#define MOLEMOLE_UIYOROZUYAENTRUSTINFOROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x156F1E50)
#define MOLEMOLE_UIYOROZUYAENTRUSTINFOROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x156F1EE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIYorozuyaEntrustInfoRowWidgetController_TypeDefinitionIndex = 47709;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_398B7A90ED0C0464_1*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIYOROZUYAENTRUSTINFOROWWIDGETCONTROLLER_SETABYSS_OFFSET))(this, abyss);
		}
