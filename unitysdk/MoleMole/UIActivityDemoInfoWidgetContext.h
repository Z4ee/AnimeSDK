...
#define MOLEMOLE_UIACTIVITYDEMOINFOWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x173C3110)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityDemoInfoWidgetContext_TypeDefinitionIndex = 64854;
