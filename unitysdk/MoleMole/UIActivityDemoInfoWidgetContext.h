...
#define MOLEMOLE_UIACTIVITYDEMOINFOWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18E0CD90)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityDemoInfoWidgetContext_TypeDefinitionIndex = 58974;
