...
#define MOLEMOLE_LEVEL_LEVELCONFIG_SPLIT_ONCONVERTTOSPLIT_OFFSET UNITYSDK_OFFSET(0x1233EC90)
#define MOLEMOLE_LEVEL_LEVELCONFIG_SPLIT_ONMERGESPLIT_OFFSET UNITYSDK_OFFSET(0x1233EF30)
#define MOLEMOLE_LEVEL_LEVELCONFIG_SPLIT_ONRUNTIMEPREPARE_OFFSET UNITYSDK_OFFSET(0x1233E2B0)
#define MOLEMOLE_LEVEL_LEVELCONFIG_SPLIT__CTOR_OFFSET UNITYSDK_OFFSET(0x12344140)
#define MOLEMOLE_LEVEL_LEVELCONFIG_SPLIT___BASE_ONCONVERTTOSPLIT_OFFSET UNITYSDK_OFFSET(0x12344B20)
#define MOLEMOLE_LEVEL_LEVELCONFIG_SPLIT___BASE_ONMERGESPLIT_OFFSET UNITYSDK_OFFSET(0x12344B30)
#define MOLEMOLE_LEVEL_LEVELCONFIG_SPLIT___BASE_ONRUNTIMEPREPARE_OFFSET UNITYSDK_OFFSET(0x12344BC0)

namespace MoleMole::Level
{
	inline static constexpr unsigned int LevelConfig_Split_TypeDefinitionIndex = 56142;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Enum_3_7590C8C40FF831C9>* ApplyRatingQuestTypes; // 0x88
