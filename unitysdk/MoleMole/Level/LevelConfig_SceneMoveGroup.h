...
#define MOLEMOLE_LEVEL_LEVELCONFIG_SCENEMOVEGROUP_CHECKNOTONLYONEMAINELEMENT_OFFSET UNITYSDK_OFFSET(0x15134BB0)
#define MOLEMOLE_LEVEL_LEVELCONFIG_SCENEMOVEGROUP_GET_MAININDEX_OFFSET UNITYSDK_OFFSET(0x15118460)
#define MOLEMOLE_LEVEL_LEVELCONFIG_SCENEMOVEGROUP_GET_MAXDISTANCE_OFFSET UNITYSDK_OFFSET(0x15134AA0)
#define MOLEMOLE_LEVEL_LEVELCONFIG_SCENEMOVEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x15134C60)

namespace MoleMole::Level
{
	inline static constexpr unsigned int LevelConfig_SceneMoveGroup_TypeDefinitionIndex = 47026;
