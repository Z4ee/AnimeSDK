...
#define MOLEMOLE_UIHOLLOWSKILLBUTTONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x169D1BD0)
#define MOLEMOLE_UIHOLLOWSKILLBUTTONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x169D1C60)
#define MOLEMOLE_UIHOLLOWSKILLBUTTONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x169D1A00)
#define MOLEMOLE_UIHOLLOWSKILLBUTTONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x169D1B60)
#define MOLEMOLE_UIHOLLOWSKILLBUTTONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x169D1CE0)
#define MOLEMOLE_UIHOLLOWSKILLBUTTONWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0x169D1D40)
#define MOLEMOLE_UIHOLLOWSKILLBUTTONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x169D1D60)
#define MOLEMOLE_UIHOLLOWSKILLBUTTONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x169D1DF0)
#define MOLEMOLE_UIHOLLOWSKILLBUTTONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x169D1E80)
#define MOLEMOLE_UIHOLLOWSKILLBUTTONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x169D1F10)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowSkillButtonWidgetController_TypeDefinitionIndex = 48158;

	class UIHollowSkillButtonWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_5BA0256FCCEF80F3_1* _view; // 0x2B8
		::UnityEngine::Events::UnityAction* OnClick; // 0x2C0
