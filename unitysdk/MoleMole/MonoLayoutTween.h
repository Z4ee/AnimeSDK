...
#define MOLEMOLE_MONOLAYOUTTWEEN_AWAKE_OFFSET UNITYSDK_OFFSET(0x118FD920)
#define MOLEMOLE_MONOLAYOUTTWEEN_CANCELTWEEN_OFFSET UNITYSDK_OFFSET(0x118FE600)
#define MOLEMOLE_MONOLAYOUTTWEEN_INSERTCELL_OFFSET UNITYSDK_OFFSET(0x118FDB30)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x118FE960)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_2B486E50305A7CDC_OFFSET UNITYSDK_OFFSET(0x118FDE20)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_2C9E083DC9C549F9_OFFSET UNITYSDK_OFFSET(0x118FDD80)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_2CBE0B79DD36047E_OFFSET UNITYSDK_OFFSET(0x118FF8F0)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_3CCA0B8A31B650A8_OFFSET UNITYSDK_OFFSET(0x118FF190)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x118FD970)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_497833CF065C1894_OFFSET UNITYSDK_OFFSET(0x118FEA20)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_5323F2DF46A044DA_OFFSET UNITYSDK_OFFSET(0x118FF410)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_7BD3449C94EB28DC_OFFSET UNITYSDK_OFFSET(0x118FF720)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_7EBA8DAF54830EDE_OFFSET UNITYSDK_OFFSET(0x118FECF0)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_A1739D86623C0116_OFFSET UNITYSDK_OFFSET(0x118FE370)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_A56385E6706FA723_OFFSET UNITYSDK_OFFSET(0x118FF940)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_A8F30D3692AA24D3_OFFSET UNITYSDK_OFFSET(0x118FF420)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_C114A1F8E08B6F92_1_OFFSET UNITYSDK_OFFSET(0x118FF5D0)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_C114A1F8E08B6F92_OFFSET UNITYSDK_OFFSET(0x118FEFD0)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_C74CF020AA42ED85_1_OFFSET UNITYSDK_OFFSET(0x118FF160)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x118FEFE0)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x118FF180)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_D94E828E9DA8A315_OFFSET UNITYSDK_OFFSET(0x118FF5E0)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_E7F1AECA7CFF8AAD_OFFSET UNITYSDK_OFFSET(0x118FF170)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x118FF8E0)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_F0C971A0A9681120_OFFSET UNITYSDK_OFFSET(0x118FEFF0)
#define MOLEMOLE_MONOLAYOUTTWEEN_NEEDINSERTTWEEN_OFFSET UNITYSDK_OFFSET(0x118FDCE0)
#define MOLEMOLE_MONOLAYOUTTWEEN_NEEDREMOVETWEEN_OFFSET UNITYSDK_OFFSET(0x118FE260)
#define MOLEMOLE_MONOLAYOUTTWEEN_REMOVECELL_OFFSET UNITYSDK_OFFSET(0x118FE0A0)
#define MOLEMOLE_MONOLAYOUTTWEEN_SETDURATION_OFFSET UNITYSDK_OFFSET(0x118FE5A0)
#define MOLEMOLE_MONOLAYOUTTWEEN_SETSLOTHELPER_OFFSET UNITYSDK_OFFSET(0x118FDAE0)
#define MOLEMOLE_MONOLAYOUTTWEEN__CTOR_OFFSET UNITYSDK_OFFSET(0x118FE9C0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoLayoutTween_TypeDefinitionIndex = 75834;
	...
	public:
		...
		::UnityEngine::UI::LayoutGroup* Field_5_6; // 0x30
		::UnityEngine::Transform* Field_5_5; // 0x38
		::Class_1_402DBB6FAC12574C* Field_5_4; // 0x40
		::DG::Tweening::Tweener* Field_5_11; // 0x48
		::System::Single Field_5_10; // 0x50
		::System::Int32 Field_5_9; // 0x54
		::System::Int32 Field_5_8; // 0x58
		::System::Boolean Field_5_15; // 0x5C
