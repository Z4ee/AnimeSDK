...
#define MOLEMOLE_PHOTOFRAMERENDER_ADDPHOTOFRAME_OFFSET UNITYSDK_OFFSET(0x1385C960)
#define MOLEMOLE_PHOTOFRAMERENDER_CAMERARENDERRT_OFFSET UNITYSDK_OFFSET(0x1385C890)
#define MOLEMOLE_PHOTOFRAMERENDER_CLEARCAMERATARGETTEXTURE_OFFSET UNITYSDK_OFFSET(0x1385C900)
#define MOLEMOLE_PHOTOFRAMERENDER_GET_CANVASSIZE_OFFSET UNITYSDK_OFFSET(0x1385C430)
#define MOLEMOLE_PHOTOFRAMERENDER_GET_RENDERSCALE_OFFSET UNITYSDK_OFFSET(0x1385C370)
#define MOLEMOLE_PHOTOFRAMERENDER_GET_RENDERSIZE_OFFSET UNITYSDK_OFFSET(0x1385C440)
#define MOLEMOLE_PHOTOFRAMERENDER_SETPHOTOCANVASSIZE_OFFSET UNITYSDK_OFFSET(0x1385C450)
#define MOLEMOLE_PHOTOFRAMERENDER_SET_RENDERSCALE_OFFSET UNITYSDK_OFFSET(0x1385C3D0)
#define MOLEMOLE_PHOTOFRAMERENDER_UPDATECANVASANDCAMERA_OFFSET UNITYSDK_OFFSET(0x1385CA50)
#define MOLEMOLE_PHOTOFRAMERENDER_UPDATERENDERSIZE_OFFSET UNITYSDK_OFFSET(0x1385C4A0)
#define MOLEMOLE_PHOTOFRAMERENDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1385CB40)
#define MOLEMOLE_PHOTOFRAMERENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1385CAF0)

namespace MoleMole
{
	inline static constexpr unsigned int PhotoFrameRender_TypeDefinitionIndex = 81759;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(PhotoFrameRender_TypeDefinitionIndex)->GetStaticField(0xEBB0);
		}
