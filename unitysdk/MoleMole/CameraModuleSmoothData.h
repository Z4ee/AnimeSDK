...
#define MOLEMOLE_CAMERAMODULESMOOTHDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x106AD000)

namespace MoleMole
{
	inline static constexpr unsigned int CameraModuleSmoothData_TypeDefinitionIndex = 41258;
