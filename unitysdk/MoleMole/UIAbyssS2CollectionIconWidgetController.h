...
#define MOLEMOLE_UIABYSSS2COLLECTIONICONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1B6DADE0)
#define MOLEMOLE_UIABYSSS2COLLECTIONICONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1B6DAE70)
#define MOLEMOLE_UIABYSSS2COLLECTIONICONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1B6DAD10)
#define MOLEMOLE_UIABYSSS2COLLECTIONICONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1B6DAD70)
#define MOLEMOLE_UIABYSSS2COLLECTIONICONWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1B6DAEF0)
#define MOLEMOLE_UIABYSSS2COLLECTIONICONWIDGETCONTROLLER_SETICON_OFFSET UNITYSDK_OFFSET(0x1B6DAFB0)
#define MOLEMOLE_UIABYSSS2COLLECTIONICONWIDGETCONTROLLER_SETOUTLINE_OFFSET UNITYSDK_OFFSET(0x1B6DB030)
#define MOLEMOLE_UIABYSSS2COLLECTIONICONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6DB0B0)
#define MOLEMOLE_UIABYSSS2COLLECTIONICONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1B6DB110)
#define MOLEMOLE_UIABYSSS2COLLECTIONICONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1B6DB1A0)
#define MOLEMOLE_UIABYSSS2COLLECTIONICONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1B6DB230)
#define MOLEMOLE_UIABYSSS2COLLECTIONICONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1B6DB2C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2CollectionIconWidgetController_TypeDefinitionIndex = 57076;
