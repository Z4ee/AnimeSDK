...
#define MOLEMOLE_UIINLEVELTRIGGERPANELCHILDWINDOWCONTROLLER_CHANGEMATERIAL_OFFSET UNITYSDK_OFFSET(0x16D84E00)
#define MOLEMOLE_UIINLEVELTRIGGERPANELCHILDWINDOWCONTROLLER_COLLECTALLANIMATIONCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x16D84D40)
#define MOLEMOLE_UIINLEVELTRIGGERPANELCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x16D83B90)
#define MOLEMOLE_UIINLEVELTRIGGERPANELCHILDWINDOWCONTROLLER_HANDLEALLCUSTOMPROPERTIESONSHOW_OFFSET UNITYSDK_OFFSET(0x16D83CC0)
#define MOLEMOLE_UIINLEVELTRIGGERPANELCHILDWINDOWCONTROLLER_HANDLECUSTOMPROPERTY_OFFSET UNITYSDK_OFFSET(0x16D83DC0)
#define MOLEMOLE_UIINLEVELTRIGGERPANELCHILDWINDOWCONTROLLER_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x16D84B40)
#define MOLEMOLE_UIINLEVELTRIGGERPANELCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16D83BA0)
#define MOLEMOLE_UIINLEVELTRIGGERPANELCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16D83C30)
#define MOLEMOLE_UIINLEVELTRIGGERPANELCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16D85140)
#define MOLEMOLE_UIINLEVELTRIGGERPANELCHILDWINDOWCONTROLLER__HANDLECUSTOMPROPERTY_B__16_0_OFFSET UNITYSDK_OFFSET(0x16D85150)
#define MOLEMOLE_UIINLEVELTRIGGERPANELCHILDWINDOWCONTROLLER___BASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x16D85270)
#define MOLEMOLE_UIINLEVELTRIGGERPANELCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16D85300)
#define MOLEMOLE_UIINLEVELTRIGGERPANELCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16D85390)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelTriggerPanelChildWindowController_TypeDefinitionIndex = 63569;
	...
	public:
		...
		::Class_2_BCA11629035BC7F2_2* _view; // 0x350
