...
#define MOLEMOLE_UILEVELRESULTONLINECONTENTWIDGETCONTROLLER_GET_GAMEPADMODULE_OFFSET UNITYSDK_OFFSET(0x182D1460)
#define MOLEMOLE_UILEVELRESULTONLINECONTENTWIDGETCONTROLLER_GET_SCROLLVIEWMODULE_OFFSET UNITYSDK_OFFSET(0x182D1490)
#define MOLEMOLE_UILEVELRESULTONLINECONTENTWIDGETCONTROLLER_ONCLICKREWARDITEMBTN_OFFSET UNITYSDK_OFFSET(0x182D09C0)
#define MOLEMOLE_UILEVELRESULTONLINECONTENTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x182CF250)
#define MOLEMOLE_UILEVELRESULTONLINECONTENTWIDGETCONTROLLER_ONSWITCHSHOWPLATFORM_OFFSET UNITYSDK_OFFSET(0x182D0A10)
#define MOLEMOLE_UILEVELRESULTONLINECONTENTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x182CF2E0)
#define MOLEMOLE_UILEVELRESULTONLINECONTENTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x182CEEB0)
#define MOLEMOLE_UILEVELRESULTONLINECONTENTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x182CF0B0)
#define MOLEMOLE_UILEVELRESULTONLINECONTENTWIDGETCONTROLLER_REFRESHIDINFO_OFFSET UNITYSDK_OFFSET(0x182D0B00)
#define MOLEMOLE_UILEVELRESULTONLINECONTENTWIDGETCONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0x182CF3E0)
#define MOLEMOLE_UILEVELRESULTONLINECONTENTWIDGETCONTROLLER_RESETGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x182D14C0)
#define MOLEMOLE_UILEVELRESULTONLINECONTENTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x182D1670)
#define MOLEMOLE_UILEVELRESULTONLINECONTENTWIDGETCONTROLLER__ONUIINIT_B__4_0_OFFSET UNITYSDK_OFFSET(0x182D16D0)
#define MOLEMOLE_UILEVELRESULTONLINECONTENTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x182D17D0)
#define MOLEMOLE_UILEVELRESULTONLINECONTENTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x182D1860)
#define MOLEMOLE_UILEVELRESULTONLINECONTENTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x182D18F0)
#define MOLEMOLE_UILEVELRESULTONLINECONTENTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x182D1980)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultOnlineContentWidgetController_TypeDefinitionIndex = 73848;
