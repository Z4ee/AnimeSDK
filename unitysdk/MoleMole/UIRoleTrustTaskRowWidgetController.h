...
#define MOLEMOLE_UIROLETRUSTTASKROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12E78F50)
#define MOLEMOLE_UIROLETRUSTTASKROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x12E79060)
#define MOLEMOLE_UIROLETRUSTTASKROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12E78FE0)
#define MOLEMOLE_UIROLETRUSTTASKROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12E79680)
#define MOLEMOLE_UIROLETRUSTTASKROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12E79690)
#define MOLEMOLE_UIROLETRUSTTASKROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x12E79720)
#define MOLEMOLE_UIROLETRUSTTASKROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12E797C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleTrustTaskRowWidgetController_TypeDefinitionIndex = 59389;

	class UIRoleTrustTaskRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_142C57324E00A5F7_1* _view; // 0x2E8
