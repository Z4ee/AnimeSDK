...
#define MOLEMOLE_UIBOSSCHALLENGEQUICKTEAMROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x158C09B0)
#define MOLEMOLE_UIBOSSCHALLENGEQUICKTEAMROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x158C0A20)
#define MOLEMOLE_UIBOSSCHALLENGEQUICKTEAMROWWIDGETCONTROLLER_ONSELECTROLEEVENT_OFFSET UNITYSDK_OFFSET(0x158C0C60)
#define MOLEMOLE_UIBOSSCHALLENGEQUICKTEAMROWWIDGETCONTROLLER_ONSETDATA_OFFSET UNITYSDK_OFFSET(0x158C0AE0)
#define MOLEMOLE_UIBOSSCHALLENGEQUICKTEAMROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x158C0BA0)
#define MOLEMOLE_UIBOSSCHALLENGEQUICKTEAMROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x158C0D00)
#define MOLEMOLE_UIBOSSCHALLENGEQUICKTEAMROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x158C0D60)
#define MOLEMOLE_UIBOSSCHALLENGEQUICKTEAMROWWIDGETCONTROLLER___BASE_ONSETDATA_OFFSET UNITYSDK_OFFSET(0x158C0E00)
#define MOLEMOLE_UIBOSSCHALLENGEQUICKTEAMROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x158C0EA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBossChallengeQuickTeamRowWidgetController_TypeDefinitionIndex = 58968;
