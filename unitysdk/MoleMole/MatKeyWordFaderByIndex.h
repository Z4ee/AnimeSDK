...
#define MOLEMOLE_MATKEYWORDFADERBYINDEX_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1429A6C0)
#define MOLEMOLE_MATKEYWORDFADERBYINDEX_GET_MAT_OFFSET UNITYSDK_OFFSET(0x14299FF0)
#define MOLEMOLE_MATKEYWORDFADERBYINDEX_GET_MONOEFFECT_OFFSET UNITYSDK_OFFSET(0x14299FE0)
#define MOLEMOLE_MATKEYWORDFADERBYINDEX_METHOD_2_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x1429ADB0)
#define MOLEMOLE_MATKEYWORDFADERBYINDEX_METHOD_2_128774387667156B_OFFSET UNITYSDK_OFFSET(0x1429AB60)
#define MOLEMOLE_MATKEYWORDFADERBYINDEX_METHOD_2_6D1AD736C02B5A5D_OFFSET UNITYSDK_OFFSET(0x1429ABA0)
#define MOLEMOLE_MATKEYWORDFADERBYINDEX_METHOD_2_99E148EAF19C2DF6_OFFSET UNITYSDK_OFFSET(0x1429A460)
#define MOLEMOLE_MATKEYWORDFADERBYINDEX_METHOD_2_C2E812C9305B1BB9_OFFSET UNITYSDK_OFFSET(0x1429A280)
#define MOLEMOLE_MATKEYWORDFADERBYINDEX_METHOD_2_C638E91FC0D3A13A_OFFSET UNITYSDK_OFFSET(0x1429A9D0)
#define MOLEMOLE_MATKEYWORDFADERBYINDEX_METHOD_2_D1D374C6EA801A5E_OFFSET UNITYSDK_OFFSET(0x1429A4F0)
#define MOLEMOLE_MATKEYWORDFADERBYINDEX_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1429A770)
#define MOLEMOLE_MATKEYWORDFADERBYINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1429A270)

namespace MoleMole
{
	inline static constexpr unsigned int MatKeyWordFaderByIndex_TypeDefinitionIndex = 52468;
