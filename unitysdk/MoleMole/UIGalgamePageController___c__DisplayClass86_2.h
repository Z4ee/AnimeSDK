...
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS86_2__CTOR_OFFSET UNITYSDK_OFFSET(0x177E1720)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS86_2__PLAYSTORYNODE_B__10_OFFSET UNITYSDK_OFFSET(0x177E1730)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS86_2__PLAYSTORYNODE_B__11_OFFSET UNITYSDK_OFFSET(0x177E18F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgamePageController___c__DisplayClass86_2_TypeDefinitionIndex = 54861;

	class UIGalgamePageController___c__DisplayClass86_2 : public ::System::Object
	{
	public:
		::System::Action* __9__11; // 0x10
		::MoleMole::UIGalgamePageController___c__DisplayClass86_0* CS___8__locals2; // 0x18
