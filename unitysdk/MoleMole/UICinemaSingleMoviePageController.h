...
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_EXITPREPPAGE_OFFSET UNITYSDK_OFFSET(0x172DC970)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x172DB670)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_INITFIRSTSELECTLEVEL_OFFSET UNITYSDK_OFFSET(0x172DBFF0)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x172DBA10)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_ONCLICKSINGLELEVELMOVIE_OFFSET UNITYSDK_OFFSET(0x172DC680)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_ONCLICKSTARTSINGLELEVEL_OFFSET UNITYSDK_OFFSET(0x172DC6D0)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x172DB680)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x172DBF10)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x172DBE10)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x172DBEA0)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x172DB710)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_REFRESHDIFFICULT_OFFSET UNITYSDK_OFFSET(0x172DAFE0)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_REFRESHMOVIEINFO_OFFSET UNITYSDK_OFFSET(0x172DAEA0)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_REFRESHRANKINFO_OFFSET UNITYSDK_OFFSET(0x172DB0F0)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_REFRESHRIGHTINFO_OFFSET UNITYSDK_OFFSET(0x172DAB90)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_RESETCLICKMASK_OFFSET UNITYSDK_OFFSET(0x172DCAF0)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_SETNOWINDEX_OFFSET UNITYSDK_OFFSET(0x172DC320)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x172DCB40)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x172DCC00)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER___BASE_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x172DCC90)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x172DCD80)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x172DCD90)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x172DCDA0)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaSingleMoviePageController_TypeDefinitionIndex = 39902;
	...
	public:
		...
		::Class_2_26F71DED66AFE0B6* _view; // 0x320
