...
#define MOLEMOLE_UIBANGBOOITEMWIDGETCONTROLLER_ENABLEHINT_OFFSET UNITYSDK_OFFSET(0x14EBB510)
#define MOLEMOLE_UIBANGBOOITEMWIDGETCONTROLLER_ONBUDDYFAVORITE_OFFSET UNITYSDK_OFFSET(0x14EBCAB0)
#define MOLEMOLE_UIBANGBOOITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14EBB560)
#define MOLEMOLE_UIBANGBOOITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x14EBC9D0)
#define MOLEMOLE_UIBANGBOOITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x14EBBB00)
#define MOLEMOLE_UIBANGBOOITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14EBB5F0)
#define MOLEMOLE_UIBANGBOOITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14EBAF20)
#define MOLEMOLE_UIBANGBOOITEMWIDGETCONTROLLER_ONUPDATEBUDDY_OFFSET UNITYSDK_OFFSET(0x14EBCA60)
#define MOLEMOLE_UIBANGBOOITEMWIDGETCONTROLLER_REGISTERNOTIFY_OFFSET UNITYSDK_OFFSET(0x14EBC250)
#define MOLEMOLE_UIBANGBOOITEMWIDGETCONTROLLER_SETFAVORITESTATE_OFFSET UNITYSDK_OFFSET(0x14EBC950)
#define MOLEMOLE_UIBANGBOOITEMWIDGETCONTROLLER_SETRARITY_OFFSET UNITYSDK_OFFSET(0x14EBC8C0)
#define MOLEMOLE_UIBANGBOOITEMWIDGETCONTROLLER_SETSTAR_OFFSET UNITYSDK_OFFSET(0x14EBC5A0)
#define MOLEMOLE_UIBANGBOOITEMWIDGETCONTROLLER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0x14EBBDC0)
#define MOLEMOLE_UIBANGBOOITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14EBCC00)
#define MOLEMOLE_UIBANGBOOITEMWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0x14EBCC10)
#define MOLEMOLE_UIBANGBOOITEMWIDGETCONTROLLER__ONUIINIT_B__1_1_OFFSET UNITYSDK_OFFSET(0x14EBCFE0)
#define MOLEMOLE_UIBANGBOOITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14EBD200)
#define MOLEMOLE_UIBANGBOOITEMWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x14EBD290)
#define MOLEMOLE_UIBANGBOOITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x14EBD320)
#define MOLEMOLE_UIBANGBOOITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14EBD3C0)
#define MOLEMOLE_UIBANGBOOITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14EBD450)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooItemWidgetController_TypeDefinitionIndex = 52396;

	class UIBangbooItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_04C0D840520454A3* _view; // 0x2E8
		::Class_2_4DA7BFFCF976F7D7* _data; // 0x2F0
		::System::Int32 MaxStarCount; // 0x2F8
