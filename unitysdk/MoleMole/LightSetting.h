...
#define MOLEMOLE_LIGHTSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1925B720)

namespace MoleMole
{
	inline static constexpr unsigned int LightSetting_TypeDefinitionIndex = 86029;

	class LightSetting : public ::System::Object
	{
	public:
		::System::Single avatarLightMultiplier; // 0x10
