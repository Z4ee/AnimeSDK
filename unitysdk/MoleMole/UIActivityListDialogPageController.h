...
#define MOLEMOLE_UIACTIVITYLISTDIALOGPAGECONTROLLER_CREATELISTROW_OFFSET UNITYSDK_OFFSET(0x173299E0)
#define MOLEMOLE_UIACTIVITYLISTDIALOGPAGECONTROLLER_CREATETITLE_OFFSET UNITYSDK_OFFSET(0x17329A90)
#define MOLEMOLE_UIACTIVITYLISTDIALOGPAGECONTROLLER_GETTEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x17329B40)
#define MOLEMOLE_UIACTIVITYLISTDIALOGPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1732A730)
#define MOLEMOLE_UIACTIVITYLISTDIALOGPAGECONTROLLER_INITSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x173297D0)
#define MOLEMOLE_UIACTIVITYLISTDIALOGPAGECONTROLLER_ONCLICKRIGHTGOBTN_OFFSET UNITYSDK_OFFSET(0x173296D0)
#define MOLEMOLE_UIACTIVITYLISTDIALOGPAGECONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0x1732A0A0)
#define MOLEMOLE_UIACTIVITYLISTDIALOGPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1732A740)
#define MOLEMOLE_UIACTIVITYLISTDIALOGPAGECONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x1732A8F0)
#define MOLEMOLE_UIACTIVITYLISTDIALOGPAGECONTROLLER_ONREFRESHUITIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1732A660)
#define MOLEMOLE_UIACTIVITYLISTDIALOGPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1732A9E0)
#define MOLEMOLE_UIACTIVITYLISTDIALOGPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1732A970)
#define MOLEMOLE_UIACTIVITYLISTDIALOGPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1732A7D0)
#define MOLEMOLE_UIACTIVITYLISTDIALOGPAGECONTROLLER_REFRESHSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x17329F80)
#define MOLEMOLE_UIACTIVITYLISTDIALOGPAGECONTROLLER_REFRESHTABDATA_OFFSET UNITYSDK_OFFSET(0x17329C00)
#define MOLEMOLE_UIACTIVITYLISTDIALOGPAGECONTROLLER_REFRESHTABSELECTITEM_OFFSET UNITYSDK_OFFSET(0x1732A020)
#define MOLEMOLE_UIACTIVITYLISTDIALOGPAGECONTROLLER_REFRESHUI_OFFSET UNITYSDK_OFFSET(0x1732A6D0)
#define MOLEMOLE_UIACTIVITYLISTDIALOGPAGECONTROLLER_SETCURTABBYINDEX_OFFSET UNITYSDK_OFFSET(0x1732A0F0)
#define MOLEMOLE_UIACTIVITYLISTDIALOGPAGECONTROLLER_SHOWTAB_OFFSET UNITYSDK_OFFSET(0x17328D00)
#define MOLEMOLE_UIACTIVITYLISTDIALOGPAGECONTROLLER_TIMERREFRESH_CALTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1732A310)
#define MOLEMOLE_UIACTIVITYLISTDIALOGPAGECONTROLLER_TRYSETREFRESHUITIMER_OFFSET UNITYSDK_OFFSET(0x1732A1B0)
#define MOLEMOLE_UIACTIVITYLISTDIALOGPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1732ABC0)
#define MOLEMOLE_UIACTIVITYLISTDIALOGPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1732AC50)
#define MOLEMOLE_UIACTIVITYLISTDIALOGPAGECONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x1732ACE0)
#define MOLEMOLE_UIACTIVITYLISTDIALOGPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1732AD70)
#define MOLEMOLE_UIACTIVITYLISTDIALOGPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1732AD80)
#define MOLEMOLE_UIACTIVITYLISTDIALOGPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1732AD90)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityListDialogPageController_TypeDefinitionIndex = 74983;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_557*>* tabDatas; // 0x338
		...
		::System::Void ShowTab(::Class_0_16E4307DCC419505_557* tabData)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_557*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIACTIVITYLISTDIALOGPAGECONTROLLER_SHOWTAB_OFFSET))(this, tabData);
		}
