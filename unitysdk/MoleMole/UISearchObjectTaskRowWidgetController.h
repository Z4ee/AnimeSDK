...
#define MOLEMOLE_UISEARCHOBJECTTASKROWWIDGETCONTROLLER_GET_MODEL_OFFSET UNITYSDK_OFFSET(0x16AA27F0)
#define MOLEMOLE_UISEARCHOBJECTTASKROWWIDGETCONTROLLER_GET_SCANMAP_OFFSET UNITYSDK_OFFSET(0x16AA2730)
#define MOLEMOLE_UISEARCHOBJECTTASKROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16AA22E0)
#define MOLEMOLE_UISEARCHOBJECTTASKROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16AA23F0)
#define MOLEMOLE_UISEARCHOBJECTTASKROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16AA2370)
#define MOLEMOLE_UISEARCHOBJECTTASKROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16AA2280)
#define MOLEMOLE_UISEARCHOBJECTTASKROWWIDGETCONTROLLER_REFRESHBYCONTEXT_OFFSET UNITYSDK_OFFSET(0x16AA24B0)
#define MOLEMOLE_UISEARCHOBJECTTASKROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16AA28B0)
#define MOLEMOLE_UISEARCHOBJECTTASKROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16AA2900)
#define MOLEMOLE_UISEARCHOBJECTTASKROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16AA2990)
#define MOLEMOLE_UISEARCHOBJECTTASKROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16AA2A30)
#define MOLEMOLE_UISEARCHOBJECTTASKROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16AA2AC0)

namespace MoleMole
{
	inline static constexpr unsigned int UISearchObjectTaskRowWidgetController_TypeDefinitionIndex = 52038;
	...
	public:
		...
		{
			return ((::Class_1_1E1C1443C31C63A1*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UISEARCHOBJECTTASKROWWIDGETCONTROLLER_GET_SCANMAP_OFFSET))(this);
		}
