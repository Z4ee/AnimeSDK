...
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_GETCAMERA_OFFSET UNITYSDK_OFFSET(0x14541910)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_GETFOV_OFFSET UNITYSDK_OFFSET(0x14541420)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_GETHORIZONTALCLAMP_OFFSET UNITYSDK_OFFSET(0x145417F0)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_GETLOCATION_OFFSET UNITYSDK_OFFSET(0x14541480)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_GETOFFSET_OFFSET UNITYSDK_OFFSET(0x14541530)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_GETVERTICALCLAMP_OFFSET UNITYSDK_OFFSET(0x14541790)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_GETWALLPOS_OFFSET UNITYSDK_OFFSET(0x14541180)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x145409D0)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_INITMAINVIRTUALCAMERA_OFFSET UNITYSDK_OFFSET(0x14540FD0)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14541080)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14541110)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x145409E0)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14541030)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_OP_ADDFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x14541380)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_OP_MOVE_OFFSET UNITYSDK_OFFSET(0x145411F0)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_OP_RESET_OFFSET UNITYSDK_OFFSET(0x14540F30)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_OP_SETFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x145416F0)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_OP_SETHORIZONTALCLAMP_OFFSET UNITYSDK_OFFSET(0x145418B0)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_OP_SETOFFSET_OFFSET UNITYSDK_OFFSET(0x14541580)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_OP_SETVERTICALCLAMP_OFFSET UNITYSDK_OFFSET(0x14541850)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_RESETISFEMALE_OFFSET UNITYSDK_OFFSET(0x14540AA0)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14541960)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER___BASE_INITMAINVIRTUALCAMERA_OFFSET UNITYSDK_OFFSET(0x145419D0)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14541A60)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14541AF0)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14541B00)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14541B10)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoWall3D3DModelController_TypeDefinitionIndex = 77237;

	class UIPhotoWall3D3DModelController : public ::MoleMole::UIBase3DModelController
	{
	public:
		::Class_2_C74B331EF3E6062C* _view; // 0x358
		::UnityEngine::Vector3 _originPos; // 0x360
		::UnityEngine::Vector3 _currentPos; // 0x36C
		::System::Single _originFov; // 0x378
		::System::Single Top; // 0x37C
		::System::Single Down; // 0x380
		::System::Single Left; // 0x384
		::System::Single Right; // 0x388
		::System::Single MinFov; // 0x38C
		::System::Single MaxFov; // 0x390
