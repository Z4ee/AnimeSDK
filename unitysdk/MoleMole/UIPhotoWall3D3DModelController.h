...
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_GETCAMERA_OFFSET UNITYSDK_OFFSET(0x1664BE00)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_GETFOV_OFFSET UNITYSDK_OFFSET(0x1664B910)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_GETHORIZONTALCLAMP_OFFSET UNITYSDK_OFFSET(0x1664BCE0)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_GETLOCATION_OFFSET UNITYSDK_OFFSET(0x1664B970)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_GETOFFSET_OFFSET UNITYSDK_OFFSET(0x1664BA20)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_GETVERTICALCLAMP_OFFSET UNITYSDK_OFFSET(0x1664BC80)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_GETWALLPOS_OFFSET UNITYSDK_OFFSET(0x1664B670)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1664AEC0)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_INITMAINVIRTUALCAMERA_OFFSET UNITYSDK_OFFSET(0x1664B4C0)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1664B570)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1664B600)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1664AED0)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1664B520)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_OP_ADDFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x1664B870)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_OP_MOVE_OFFSET UNITYSDK_OFFSET(0x1664B6E0)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_OP_RESET_OFFSET UNITYSDK_OFFSET(0x1664B420)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_OP_SETFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x1664BBE0)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_OP_SETHORIZONTALCLAMP_OFFSET UNITYSDK_OFFSET(0x1664BDA0)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_OP_SETOFFSET_OFFSET UNITYSDK_OFFSET(0x1664BA70)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_OP_SETVERTICALCLAMP_OFFSET UNITYSDK_OFFSET(0x1664BD40)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER_RESETISFEMALE_OFFSET UNITYSDK_OFFSET(0x1664AF90)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1664BE50)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER___BASE_INITMAINVIRTUALCAMERA_OFFSET UNITYSDK_OFFSET(0x1664BEC0)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1664BF50)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1664BFE0)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1664BFF0)
#define MOLEMOLE_UIPHOTOWALL3D3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1664C000)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoWall3D3DModelController_TypeDefinitionIndex = 83631;

	class UIPhotoWall3D3DModelController : public ::MoleMole::UIBase3DModelController
	{
	public:
		::Class_2_C74B331EF3E6062C* _view; // 0x360
