...
#define MOLEMOLE_CONFIGUISOUND_STATETRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x181F0DC0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUISound_StateTransition_TypeDefinitionIndex = 75889;
