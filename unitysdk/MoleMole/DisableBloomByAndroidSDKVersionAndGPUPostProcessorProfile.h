...
#define MOLEMOLE_DISABLEBLOOMBYANDROIDSDKVERSIONANDGPUPOSTPROCESSORPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1C5298A0)
#define MOLEMOLE_DISABLEBLOOMBYANDROIDSDKVERSIONANDGPUPOSTPROCESSORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C529910)
#define MOLEMOLE_DISABLEBLOOMBYANDROIDSDKVERSIONANDGPUPOSTPROCESSORPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1C5299A0)

namespace MoleMole
{
	inline static constexpr unsigned int DisableBloomByAndroidSDKVersionAndGPUPostProcessorProfile_TypeDefinitionIndex = 53218;
