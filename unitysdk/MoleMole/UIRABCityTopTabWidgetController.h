...
#define MOLEMOLE_UIRABCITYTOPTABWIDGETCONTROLLER_GETTABBUTTON_OFFSET UNITYSDK_OFFSET(0x1789AC70)
#define MOLEMOLE_UIRABCITYTOPTABWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1789A9B0)
#define MOLEMOLE_UIRABCITYTOPTABWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1789AA20)
#define MOLEMOLE_UIRABCITYTOPTABWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1789AAC0)
#define MOLEMOLE_UIRABCITYTOPTABWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1789ACE0)
#define MOLEMOLE_UIRABCITYTOPTABWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1789AE60)
#define MOLEMOLE_UIRABCITYTOPTABWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1789AEC0)
#define MOLEMOLE_UIRABCITYTOPTABWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1789AF60)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABCityTopTabWidgetController_TypeDefinitionIndex = 67173;
