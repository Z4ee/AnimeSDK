...
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_GENERATESORTERLIST_OFFSET UNITYSDK_OFFSET(0x175E8B50)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_GETFILTERBTN_OFFSET UNITYSDK_OFFSET(0x175E8BD0)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x175E8C30)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_GET_POPWINDOW_OFFSET UNITYSDK_OFFSET(0x175E8A70)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_GET_SELECTEDSORTOPTIONSTATE_OFFSET UNITYSDK_OFFSET(0x175E8A50)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_GET_SELECTEDSORTOPTIONSUBTYPE_OFFSET UNITYSDK_OFFSET(0x175E8A30)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_GET_SELECTEDSORTOPTION_OFFSET UNITYSDK_OFFSET(0x175E8A10)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_ISFILTERACTIVE_OFFSET UNITYSDK_OFFSET(0x175E9860)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175E9CE0)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_ONFILTERBTNCLICK_OFFSET UNITYSDK_OFFSET(0x175E9DF0)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x175E9D70)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x175E9970)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x175E9BB0)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_REFRESHSORTOPTIONS_OFFSET UNITYSDK_OFFSET(0x175E8AD0)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x175E9260)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_RESETALL_OFFSET UNITYSDK_OFFSET(0x175E9690)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_SETCHILDSIZE_OFFSET UNITYSDK_OFFSET(0x175E8C40)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_SETCONSOLEKEY_OFFSET UNITYSDK_OFFSET(0x175E8D70)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_SETFILTERINSTANCE_OFFSET UNITYSDK_OFFSET(0x175E8A80)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_SETFILTERSTATE_OFFSET UNITYSDK_OFFSET(0x175EA0F0)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x175EA400)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER__ONUIINIT_B__29_0_OFFSET UNITYSDK_OFFSET(0x175EA520)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175EA550)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x175EA5E0)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x175EA670)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x175EA700)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralSortWidgetController_TypeDefinitionIndex = 58251;
	...
	public:
		...
		::Class_0_16E4307DCC419505_532* _filterInstance; // 0x2E8
		...
		::Class_1_709BB9A644D884B9* _data; // 0x308
		...
		::System::Void SetFilterInstance(::Class_0_16E4307DCC419505_532* instance)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_532*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_SETFILTERINSTANCE_OFFSET))(this, instance);
		}
		...
		::Class_0_16E4307DCC419505_532* get_Instance()
		{
			return ((::Class_0_16E4307DCC419505_532*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_GET_INSTANCE_OFFSET))(this);
		}
