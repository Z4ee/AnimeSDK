...
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x7E79E0)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x7E7970)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7E79F0)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x189E4AE0)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x189E4CB0)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x189E4D70)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x3EABD0)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x7E7A50)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7E7AC0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUICommon_Input_MobileButtonPositionInfo_TypeDefinitionIndex = 52101;
