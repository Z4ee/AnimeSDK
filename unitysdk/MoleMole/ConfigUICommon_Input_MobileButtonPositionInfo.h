...
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x882370)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x882300)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x882380)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x1AA84570)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AA84740)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1AA84800)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x4E6C30)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x8823E0)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x882450)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUICommon_Input_MobileButtonPositionInfo_TypeDefinitionIndex = 61661;
