...
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x17BCA170)
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x17BCA330)
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17BCB060)
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x17BCB160)
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17BCB0F0)
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17BCA180)
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER_SORTFUNC_OFFSET UNITYSDK_OFFSET(0x17BCB220)
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17BCB310)
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER__INITVIEW_B__8_0_OFFSET UNITYSDK_OFFSET(0x17BCB450)
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER__INITVIEW_B__8_1_OFFSET UNITYSDK_OFFSET(0x17BCB320)
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17BCB490)
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x17BCB520)
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17BCB550)
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17BCB560)

namespace MoleMole
{
	inline static constexpr unsigned int UIVideoShopTipsPopWindowController_TypeDefinitionIndex = 64541;
