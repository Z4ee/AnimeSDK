...
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_DETACH_OFFSET UNITYSDK_OFFSET(0x17D722A0)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_FIXPOSITION_OFFSET UNITYSDK_OFFSET(0x17D73450)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_GET_ENTITY_OFFSET UNITYSDK_OFFSET(0x17D718B0)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x17D71610)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_INITIALIZEFILL_OFFSET UNITYSDK_OFFSET(0x17D72030)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_INITUIDEFAULTSTATE_OFFSET UNITYSDK_OFFSET(0x17D71A10)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17D72B60)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_ONFIGHTER_PROPERTYVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x17D72530)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_ONPROPERTYCHANGE_OFFSET UNITYSDK_OFFSET(0x17D725E0)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17D731A0)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17D71620)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17D71670)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_REFRESHDATA_OFFSET UNITYSDK_OFFSET(0x17D720D0)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_SHOWTIP_OFFSET UNITYSDK_OFFSET(0x17D72AF0)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_UPDATEPOSITION_OFFSET UNITYSDK_OFFSET(0x17D72BF0)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x17D73590)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17D73580)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17D735D0)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17D73660)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17D73670)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17D73680)

namespace MoleMole
{
	inline static constexpr unsigned int UITowerDefenseMonsterHudChildWindowController_TypeDefinitionIndex = 87729;
