...
#define MOLEMOLE_MONOWEAPONVIDEOSCREENPLAYER_CLASS_1_423B27F32DDBE5D7_METHOD_1_14057E65D2C9824C_OFFSET UNITYSDK_OFFSET(0x11D59B40)
#define MOLEMOLE_MONOWEAPONVIDEOSCREENPLAYER_CLASS_1_423B27F32DDBE5D7_METHOD_1_57D5ED2C4C06D908_OFFSET UNITYSDK_OFFSET(0x11D59BC0)
#define MOLEMOLE_MONOWEAPONVIDEOSCREENPLAYER_CLASS_1_423B27F32DDBE5D7_METHOD_1_DC715239B8B98D9C_OFFSET UNITYSDK_OFFSET(0x11D59C00)
#define MOLEMOLE_MONOWEAPONVIDEOSCREENPLAYER_CLASS_1_423B27F32DDBE5D7_METHOD_1_F9E46980478DCFE2_OFFSET UNITYSDK_OFFSET(0x11D59BF0)
#define MOLEMOLE_MONOWEAPONVIDEOSCREENPLAYER_CLASS_1_423B27F32DDBE5D7__CTOR_OFFSET UNITYSDK_OFFSET(0x11D59B30)

namespace MoleMole
{
	inline static constexpr unsigned int MonoWeaponVideoScreenPlayer_Class_1_423B27F32DDBE5D7_TypeDefinitionIndex = 67328;

	class MonoWeaponVideoScreenPlayer_Class_1_423B27F32DDBE5D7 : public ::System::Object
	{
	public:
		::MoleMole::MonoWeaponVideoScreenPlayer* Field_1_7; // 0x10
		::VideoScreenPlayData* Field_1_0; // 0x18
