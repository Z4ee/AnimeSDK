...
#define MOLEMOLE_MONOUIVERTICALLAYOUTGROUPADAPTOR_DOINITLAYOUT_OFFSET UNITYSDK_OFFSET(0x17035460)
#define MOLEMOLE_MONOUIVERTICALLAYOUTGROUPADAPTOR_INITLAYOUTELEMENT_OFFSET UNITYSDK_OFFSET(0x17035690)
#define MOLEMOLE_MONOUIVERTICALLAYOUTGROUPADAPTOR_ISCONTAINPLATFORMUIPARAMS_OFFSET UNITYSDK_OFFSET(0x17035380)
#define MOLEMOLE_MONOUIVERTICALLAYOUTGROUPADAPTOR_ISPLATFORMUIPARAMSEMPTY_OFFSET UNITYSDK_OFFSET(0x170352E0)
#define MOLEMOLE_MONOUIVERTICALLAYOUTGROUPADAPTOR_RELOADDATAFROMJSON_OFFSET UNITYSDK_OFFSET(0x17035970)
#define MOLEMOLE_MONOUIVERTICALLAYOUTGROUPADAPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17035C20)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIVerticalLayoutGroupAdaptor_TypeDefinitionIndex = 62850;
