...
#define MOLEMOLE_UILEVELRESULTV2_VR_TEAMCOOP_PAGECONTROLLER_REFRESHACTMEDAL_OFFSET UNITYSDK_OFFSET(0x174CD960)
#define MOLEMOLE_UILEVELRESULTV2_VR_TEAMCOOP_PAGECONTROLLER_REFRESHSPINFO_OFFSET UNITYSDK_OFFSET(0x174CD720)
#define MOLEMOLE_UILEVELRESULTV2_VR_TEAMCOOP_PAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x174CDF80)
#define MOLEMOLE_UILEVELRESULTV2_VR_TEAMCOOP_PAGECONTROLLER___BASE_REFRESHSPINFO_OFFSET UNITYSDK_OFFSET(0x174CE010)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultV2_VR_TeamCoop_PageController_TypeDefinitionIndex = 65656;
