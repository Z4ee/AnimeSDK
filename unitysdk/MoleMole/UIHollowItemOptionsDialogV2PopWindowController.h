...
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_CREATEARTIFACTITEMROWV2_OFFSET UNITYSDK_OFFSET(0x1883B910)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_CREATEARTIFACTITEMROW_OFFSET UNITYSDK_OFFSET(0x1883B880)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_CREATECARDROWV2_OFFSET UNITYSDK_OFFSET(0x1883BA30)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_CREATECARDROW_OFFSET UNITYSDK_OFFSET(0x1883B760)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_CREATEHOLLOWCHOICEITEMROW_OFFSET UNITYSDK_OFFSET(0x1883B9A0)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_CREATERELICITEMROW_OFFSET UNITYSDK_OFFSET(0x1883B7F0)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_GETTEMPLATEINDEXFROMDATA_OFFSET UNITYSDK_OFFSET(0x1883BAC0)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_ONTOGGLECHANGE_OFFSET UNITYSDK_OFFSET(0x1883AEE0)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1883A920)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1883AC30)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_REFRESHTOGGLETEXT_OFFSET UNITYSDK_OFFSET(0x1883B3A0)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_SCROLLWIDGETFUNC_OFFSET UNITYSDK_OFFSET(0x1883B480)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_SETTOGGLE_OFFSET UNITYSDK_OFFSET(0x1883ABA0)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1883BBB0)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1883BC10)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1883BC20)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER___BASE_SCROLLWIDGETFUNC_OFFSET UNITYSDK_OFFSET(0x1883BC30)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowItemOptionsDialogV2PopWindowController_TypeDefinitionIndex = 76667;
	...
	{
	public:
		::MoleMole::UIGeneralToggleWidgetControllerWithModel* _toggleDetail; // 0x400
