...
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_CREATEARTIFACTITEMROWV2_OFFSET UNITYSDK_OFFSET(0x16AC5530)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_CREATEARTIFACTITEMROW_OFFSET UNITYSDK_OFFSET(0x16AC54A0)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_CREATECARDROWV2_OFFSET UNITYSDK_OFFSET(0x16AC5650)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_CREATECARDROW_OFFSET UNITYSDK_OFFSET(0x16AC5380)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_CREATEHOLLOWCHOICEITEMROW_OFFSET UNITYSDK_OFFSET(0x16AC55C0)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_CREATERELICITEMROW_OFFSET UNITYSDK_OFFSET(0x16AC5410)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_GETTEMPLATEINDEXFROMDATA_OFFSET UNITYSDK_OFFSET(0x16AC56E0)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_ONTOGGLECHANGE_OFFSET UNITYSDK_OFFSET(0x16AC4AE0)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16AC4520)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16AC4830)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_REFRESHTOGGLETEXT_OFFSET UNITYSDK_OFFSET(0x16AC4FB0)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_SCROLLWIDGETFUNC_OFFSET UNITYSDK_OFFSET(0x16AC5090)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_SETTOGGLE_OFFSET UNITYSDK_OFFSET(0x16AC47A0)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16AC57D0)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16AC5830)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16AC5840)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER___BASE_SCROLLWIDGETFUNC_OFFSET UNITYSDK_OFFSET(0x16AC5850)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowItemOptionsDialogV2PopWindowController_TypeDefinitionIndex = 51802;
