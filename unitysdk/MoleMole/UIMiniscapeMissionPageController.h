...
#define MOLEMOLE_UIMINISCAPEMISSIONPAGECONTROLLER_BIND_OFFSET UNITYSDK_OFFSET(0x15754220)
#define MOLEMOLE_UIMINISCAPEMISSIONPAGECONTROLLER_CANGETREWARDS_OFFSET UNITYSDK_OFFSET(0x15755B70)
#define MOLEMOLE_UIMINISCAPEMISSIONPAGECONTROLLER_GETFIRSTALLOWGOIDX_OFFSET UNITYSDK_OFFSET(0x15755180)
#define MOLEMOLE_UIMINISCAPEMISSIONPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15754130)
#define MOLEMOLE_UIMINISCAPEMISSIONPAGECONTROLLER_INITTABS_OFFSET UNITYSDK_OFFSET(0x15754580)
#define MOLEMOLE_UIMINISCAPEMISSIONPAGECONTROLLER_ONCHAPTERCHANGE_OFFSET UNITYSDK_OFFSET(0x15755420)
#define MOLEMOLE_UIMINISCAPEMISSIONPAGECONTROLLER_ONCLICKTAKEREWARDS_OFFSET UNITYSDK_OFFSET(0x15755710)
#define MOLEMOLE_UIMINISCAPEMISSIONPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15754140)
#define MOLEMOLE_UIMINISCAPEMISSIONPAGECONTROLLER_ONTAKEREWARD_OFFSET UNITYSDK_OFFSET(0x15754E50)
#define MOLEMOLE_UIMINISCAPEMISSIONPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15754C10)
#define MOLEMOLE_UIMINISCAPEMISSIONPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x157541D0)
#define MOLEMOLE_UIMINISCAPEMISSIONPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15754500)
#define MOLEMOLE_UIMINISCAPEMISSIONPAGECONTROLLER_REFRESHTAKEALLBTN_OFFSET UNITYSDK_OFFSET(0x157550C0)
#define MOLEMOLE_UIMINISCAPEMISSIONPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x15755470)
#define MOLEMOLE_UIMINISCAPEMISSIONPAGECONTROLLER__BIND_B__8_0_OFFSET UNITYSDK_OFFSET(0x15755F80)
#define MOLEMOLE_UIMINISCAPEMISSIONPAGECONTROLLER__BIND_B__8_1_OFFSET UNITYSDK_OFFSET(0x15756000)
#define MOLEMOLE_UIMINISCAPEMISSIONPAGECONTROLLER__BIND_B__8_2_OFFSET UNITYSDK_OFFSET(0x15756580)
#define MOLEMOLE_UIMINISCAPEMISSIONPAGECONTROLLER__BIND_B__8_3_OFFSET UNITYSDK_OFFSET(0x15756600)
#define MOLEMOLE_UIMINISCAPEMISSIONPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15755EE0)
#define MOLEMOLE_UIMINISCAPEMISSIONPAGECONTROLLER__INITTABS_B__10_0_OFFSET UNITYSDK_OFFSET(0x15756610)
#define MOLEMOLE_UIMINISCAPEMISSIONPAGECONTROLLER__ONCLICKTAKEREWARDS_B__13_0_OFFSET UNITYSDK_OFFSET(0x157568D0)
#define MOLEMOLE_UIMINISCAPEMISSIONPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x157568E0)
#define MOLEMOLE_UIMINISCAPEMISSIONPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15756970)
#define MOLEMOLE_UIMINISCAPEMISSIONPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15756980)
#define MOLEMOLE_UIMINISCAPEMISSIONPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15756990)

namespace MoleMole
{
	inline static constexpr unsigned int UIMiniscapeMissionPageController_TypeDefinitionIndex = 65698;
	...
	public:
		...
		::System::Collections::Generic::IReadOnlyList_1<::Class_2_208CC9941471731A_768*>* _chapterConfigs; // 0x328
