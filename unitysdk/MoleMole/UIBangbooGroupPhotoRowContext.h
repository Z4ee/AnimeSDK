...
#define MOLEMOLE_UIBANGBOOGROUPPHOTOROWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1930BFC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooGroupPhotoRowContext_TypeDefinitionIndex = 74005;
