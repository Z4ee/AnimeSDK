...
#define MOLEMOLE_MONOTEMPLEEFFECTCONTROL_INITTEMPLEPARTICLE_OFFSET UNITYSDK_OFFSET(0x15E50C90)
#define MOLEMOLE_MONOTEMPLEEFFECTCONTROL_METHOD_5_025E4B1A2211CF52_OFFSET UNITYSDK_OFFSET(0x15E509E0)
#define MOLEMOLE_MONOTEMPLEEFFECTCONTROL_METHOD_5_652F3820D8B242FF_OFFSET UNITYSDK_OFFSET(0x15E514C0)
#define MOLEMOLE_MONOTEMPLEEFFECTCONTROL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x15E50920)
#define MOLEMOLE_MONOTEMPLEEFFECTCONTROL_START_OFFSET UNITYSDK_OFFSET(0x15E50C50)
#define MOLEMOLE_MONOTEMPLEEFFECTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x15E51470)

namespace MoleMole
{
	inline static constexpr unsigned int MonoTempleEffectControl_TypeDefinitionIndex = 78585;
