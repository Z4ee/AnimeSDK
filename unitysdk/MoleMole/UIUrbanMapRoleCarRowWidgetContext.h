...
#define MOLEMOLE_UIURBANMAPROLECARROWWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x162AD3B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapRoleCarRowWidgetContext_TypeDefinitionIndex = 45582;
