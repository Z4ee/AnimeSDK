...
#define MOLEMOLE_MONO2DMAPDATA_ICONINFOGROUP_METHOD_1_025E4B1A2211CF52_OFFSET UNITYSDK_OFFSET(0x123565A0)
#define MOLEMOLE_MONO2DMAPDATA_ICONINFOGROUP_METHOD_1_8D61BE16C9463302_OFFSET UNITYSDK_OFFSET(0x123552B0)
#define MOLEMOLE_MONO2DMAPDATA_ICONINFOGROUP_METHOD_1_D78B51BFDA4B8B32_OFFSET UNITYSDK_OFFSET(0x12356520)
#define MOLEMOLE_MONO2DMAPDATA_ICONINFOGROUP_METHOD_1_E876C8B6D3B840A6_1_OFFSET UNITYSDK_OFFSET(0x12355890)
#define MOLEMOLE_MONO2DMAPDATA_ICONINFOGROUP_METHOD_1_E876C8B6D3B840A6_OFFSET UNITYSDK_OFFSET(0x12354610)
#define MOLEMOLE_MONO2DMAPDATA_ICONINFOGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x12354580)

namespace MoleMole
{
	inline static constexpr unsigned int Mono2dMapData_IconInfoGroup_TypeDefinitionIndex = 55546;
