...
class Class_3_19EF277AF5D11235_27;
...
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19350020)
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER_ONCOOPMATCHMESSAGE_OFFSET UNITYSDK_OFFSET(0x19350FC0)
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19350090)
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x19350300)
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER_ONSWITCHPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0x19350D50)
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19350130)
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER_SHOWINFO_OFFSET UNITYSDK_OFFSET(0x19350CE0)
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER_SHOWPLATFORMUI_OFFSET UNITYSDK_OFFSET(0x19350DF0)
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER_SHOWUIVIEW_OFFSET UNITYSDK_OFFSET(0x19351ED0)
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x19351760)
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19352330)
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER__SHOWUIVIEW_G__SETUPPLATFORMUI_13_0_OFFSET UNITYSDK_OFFSET(0x19352280)
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19352390)
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x19352430)
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x193524D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarViewWithNumColorWidgetController_TypeDefinitionIndex = 84460;

	class UIAvatarViewWithNumColorWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_3_19EF277AF5D11235_27* _view; // 0x2C0
		::Class_2_2F3C7D4EFC74D485* _model; // 0x2C8
		::MoleMole::UIAvatarViewWithNumColorWidgetController_Context* _context; // 0x2D0
		::System::Boolean _allowShowPlatform; // 0x2D8
		::System::Boolean _canSwitchPlatformInfo; // 0x2D9
		::System::Boolean _isShowingPlatform; // 0x2DA
		::UnityEngine::UI::Extension::UILocalizationText* displayNameText; // 0x2E0
