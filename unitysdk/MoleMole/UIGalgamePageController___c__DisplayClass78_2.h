...
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS78_2__CTOR_OFFSET UNITYSDK_OFFSET(0x16A92DA0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS78_2__PLAYSUBNARRATORNODE_B__7_OFFSET UNITYSDK_OFFSET(0x16A92DB0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS78_2__PLAYSUBNARRATORNODE_B__8_OFFSET UNITYSDK_OFFSET(0x16A92E90)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgamePageController___c__DisplayClass78_2_TypeDefinitionIndex = 54855;
