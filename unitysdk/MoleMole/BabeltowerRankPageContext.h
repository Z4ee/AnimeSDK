...
#define MOLEMOLE_BABELTOWERRANKPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x17797DD0)

namespace MoleMole
{
	inline static constexpr unsigned int BabeltowerRankPageContext_TypeDefinitionIndex = 49883;
