...
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_CREATENORMALITEMROW_OFFSET UNITYSDK_OFFSET(0x15E46920)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_CREATESPECIALITEMROW_OFFSET UNITYSDK_OFFSET(0x15E469D0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_GETTEMPLATEINDEXFROMDATA_OFFSET UNITYSDK_OFFSET(0x15E468B0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15E45960)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x15E459F0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_ONLEVELUP_OFFSET UNITYSDK_OFFSET(0x15E46610)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_ONOPENLAMBGIFTWIDGET_OFFSET UNITYSDK_OFFSET(0x15E455B0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15E457B0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15E45B70)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15E452A0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15E45480)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_OPENDETAIL_OFFSET UNITYSDK_OFFSET(0x15E46850)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_REFRESHBACKGROUND_OFFSET UNITYSDK_OFFSET(0x15E46350)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_REFRESHINIT_OFFSET UNITYSDK_OFFSET(0x15E45FD0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_REFRESHREMAINTIMERTEXT_OFFSET UNITYSDK_OFFSET(0x15E465B0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_REFRESHTASKLIST_OFFSET UNITYSDK_OFFSET(0x15E45DF0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15E46A80)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15E46AE0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x15E46B70)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15E46B80)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15E46B90)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15E46BA0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15E46C30)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityLambGiftWidgetController_TypeDefinitionIndex = 76036;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_1_B08665FEB7112467*>* rewardContextList; // 0x2F0
