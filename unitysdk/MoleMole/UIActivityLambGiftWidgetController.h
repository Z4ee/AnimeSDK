...
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_CREATENORMALITEMROW_OFFSET UNITYSDK_OFFSET(0x152D3360)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_CREATESPECIALITEMROW_OFFSET UNITYSDK_OFFSET(0x152D3410)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_GETTEMPLATEINDEXFROMDATA_OFFSET UNITYSDK_OFFSET(0x152D32F0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x152D23A0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x152D2430)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_ONLEVELUP_OFFSET UNITYSDK_OFFSET(0x152D3050)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_ONOPENLAMBGIFTWIDGET_OFFSET UNITYSDK_OFFSET(0x152D1FF0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x152D21F0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x152D25B0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x152D1CE0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x152D1EC0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_OPENDETAIL_OFFSET UNITYSDK_OFFSET(0x152D3290)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_REFRESHBACKGROUND_OFFSET UNITYSDK_OFFSET(0x152D2D90)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_REFRESHINIT_OFFSET UNITYSDK_OFFSET(0x152D2A10)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_REFRESHREMAINTIMERTEXT_OFFSET UNITYSDK_OFFSET(0x152D2FF0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_REFRESHTASKLIST_OFFSET UNITYSDK_OFFSET(0x152D2830)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x152D34C0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x152D3520)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x152D35B0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x152D35C0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x152D35D0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x152D35E0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x152D3670)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityLambGiftWidgetController_TypeDefinitionIndex = 67259;

	class UIActivityLambGiftWidgetController : public ::MoleMole::ActivityGuideUIBaseWidgetController
	{
	public:
		::Class_2_D983B8EE78FC39CC* _view; // 0x2E0
		::System::Collections::Generic::List_1<::Class_1_B08665FEB7112467_1*>* rewardContextList; // 0x2E8
		::UnityEngine::GameObject* cacheBG; // 0x2F0
