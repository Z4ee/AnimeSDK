...
#define MOLEMOLE_UIVIDEOSHOPSELECTPROPERTYPOPWINDOWCONTROLLER___C__DISPLAYCLASS28_0__CTOR_OFFSET UNITYSDK_OFFSET(0x112C5B70)
#define MOLEMOLE_UIVIDEOSHOPSELECTPROPERTYPOPWINDOWCONTROLLER___C__DISPLAYCLASS28_0__INITBASEPROPERTYITEMS_B__0_OFFSET UNITYSDK_OFFSET(0x112C5B80)

namespace MoleMole
{
	inline static constexpr unsigned int UIVideoShopSelectPropertyPopWindowController___c__DisplayClass28_0_TypeDefinitionIndex = 68102;
	...
	public:
		...
		::System::Int32 baseProperty; // 0x24
