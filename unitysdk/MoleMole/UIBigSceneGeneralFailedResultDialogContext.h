...
#define MOLEMOLE_UIBIGSCENEGENERALFAILEDRESULTDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1680D5B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBigSceneGeneralFailedResultDialogContext_TypeDefinitionIndex = 81878;
	...
	public:
		...
		::System::Action* OnFairyAction; // 0x38
