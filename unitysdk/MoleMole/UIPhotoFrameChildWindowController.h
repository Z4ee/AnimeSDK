...
class Class_2_79AE422BA06F6D26_160_Class_2_0CFC8DCC343CD856;
class PhotoFrame;
...
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1820FFA0)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_GET__PHOTOFRAMESETTING_OFFSET UNITYSDK_OFFSET(0x1820C220)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_INITPHOTOFRAME_OFFSET UNITYSDK_OFFSET(0x1820C240)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_LOADCONFIGSETFRAMEINNER_OFFSET UNITYSDK_OFFSET(0x1820CBA0)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_LOADCONFIGSETFRAMEOUTER_OFFSET UNITYSDK_OFFSET(0x1820D500)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_LOADCONFIGSETFRAMEPHOTO_OFFSET UNITYSDK_OFFSET(0x1820C8C0)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_LOADFRAMEASSETS_OFFSET UNITYSDK_OFFSET(0x1820EA00)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x182101B0)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_ONPHOTOPLAYERINFOCHANGE_OFFSET UNITYSDK_OFFSET(0x1820FDB0)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_ONSWITCHPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0x1820FF10)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18210240)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1820FFB0)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x182100C0)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_PROCESSINNER_OFFSET UNITYSDK_OFFSET(0x1820DD70)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_PROCESSNEXTFRAME_OFFSET UNITYSDK_OFFSET(0x1820DD10)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_PROCESSOUTER_OFFSET UNITYSDK_OFFSET(0x1820E290)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_PROCESSSCALE_OFFSET UNITYSDK_OFFSET(0x1820E8E0)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_REFRESHMPTEAMMATEINFO_OFFSET UNITYSDK_OFFSET(0x1820EE00)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_REFRESHPLAYERINFO_OFFSET UNITYSDK_OFFSET(0x1820EE70)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_SETPHOTOSTEP1_OFFSET UNITYSDK_OFFSET(0x1820C390)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_SET__PHOTOFRAMESETTING_OFFSET UNITYSDK_OFFSET(0x1820C230)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_SHOWPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0x1820F620)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_SHOWSTICKERS_OFFSET UNITYSDK_OFFSET(0x1820CFE0)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x182102E0)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x182103D0)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18210460)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18210470)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18210480)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoFrameChildWindowController_TypeDefinitionIndex = 57942;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_160* _view; // 0x378
		...
		::System::Boolean ShowPlatformInfo(::Class_2_79AE422BA06F6D26_160_Class_2_0CFC8DCC343CD856* view, ::System::UInt32 uid, ::System::Boolean isShowPlatform)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_2_79AE422BA06F6D26_160_Class_2_0CFC8DCC343CD856*, ::System::UInt32, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_SHOWPLATFORMINFO_OFFSET))(this, view, uid, isShowPlatform);
		}
