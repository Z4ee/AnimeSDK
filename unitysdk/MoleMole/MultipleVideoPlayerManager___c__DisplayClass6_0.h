...
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1739CF60)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER___C__DISPLAYCLASS6_0__PREPARE_B__0_OFFSET UNITYSDK_OFFSET(0x1739CF70)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER___C__DISPLAYCLASS6_0__PREPARE_B__1_OFFSET UNITYSDK_OFFSET(0x1739CFA0)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER___C__DISPLAYCLASS6_0__PREPARE_B__2_OFFSET UNITYSDK_OFFSET(0x1739D000)

namespace MoleMole
{
	inline static constexpr unsigned int MultipleVideoPlayerManager___c__DisplayClass6_0_TypeDefinitionIndex = 70084;
