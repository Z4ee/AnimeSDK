...
#define MOLEMOLE_UINEWSSTANDCHILDWINDOWCONTROLLER_GET_PLAYANIMWITHPARENT_OFFSET UNITYSDK_OFFSET(0x1529CD40)
#define MOLEMOLE_UINEWSSTANDCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1529CD30)
#define MOLEMOLE_UINEWSSTANDCHILDWINDOWCONTROLLER_ISNEWSFIRST_OFFSET UNITYSDK_OFFSET(0x1529D040)
#define MOLEMOLE_UINEWSSTANDCHILDWINDOWCONTROLLER_ONCLICKNEXT_OFFSET UNITYSDK_OFFSET(0x1529D160)
#define MOLEMOLE_UINEWSSTANDCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1529CF40)
#define MOLEMOLE_UINEWSSTANDCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1529CFD0)
#define MOLEMOLE_UINEWSSTANDCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1529CD50)
#define MOLEMOLE_UINEWSSTANDCHILDWINDOWCONTROLLER_SHOWDETAILWINDOW_OFFSET UNITYSDK_OFFSET(0x1529D0E0)
#define MOLEMOLE_UINEWSSTANDCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1529D300)
#define MOLEMOLE_UINEWSSTANDCHILDWINDOWCONTROLLER__ONCLICKNEXT_B__15_0_OFFSET UNITYSDK_OFFSET(0x1529D310)
#define MOLEMOLE_UINEWSSTANDCHILDWINDOWCONTROLLER__ONCLICKNEXT_G__GETPLAYANIMNAME_15_1_OFFSET UNITYSDK_OFFSET(0x1529D2A0)
#define MOLEMOLE_UINEWSSTANDCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1529D620)
#define MOLEMOLE_UINEWSSTANDCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1529D6B0)
#define MOLEMOLE_UINEWSSTANDCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1529D6C0)

namespace MoleMole
{
	inline static constexpr unsigned int UINewsStandChildWindowController_TypeDefinitionIndex = 68315;
