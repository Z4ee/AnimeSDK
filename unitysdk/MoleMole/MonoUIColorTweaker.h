...
#define MOLEMOLE_MONOUICOLORTWEAKER_AWAKE_OFFSET UNITYSDK_OFFSET(0x138547B0)
#define MOLEMOLE_MONOUICOLORTWEAKER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x13854850)
#define MOLEMOLE_MONOUICOLORTWEAKER_SETGROUPTARGETCOLOR_OFFSET UNITYSDK_OFFSET(0x13854610)
#define MOLEMOLE_MONOUICOLORTWEAKER__CTOR_OFFSET UNITYSDK_OFFSET(0x13854A90)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIColorTweaker_TypeDefinitionIndex = 55052;
