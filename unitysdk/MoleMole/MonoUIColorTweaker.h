...
#define MOLEMOLE_MONOUICOLORTWEAKER_AWAKE_OFFSET UNITYSDK_OFFSET(0x12BD5560)
#define MOLEMOLE_MONOUICOLORTWEAKER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x12BD5600)
#define MOLEMOLE_MONOUICOLORTWEAKER_SETGROUPTARGETCOLOR_OFFSET UNITYSDK_OFFSET(0x12BD53C0)
#define MOLEMOLE_MONOUICOLORTWEAKER__CTOR_OFFSET UNITYSDK_OFFSET(0x12BD5840)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIColorTweaker_TypeDefinitionIndex = 79679;
