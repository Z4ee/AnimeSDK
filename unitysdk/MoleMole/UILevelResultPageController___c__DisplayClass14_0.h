...
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0x189B19A0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER___C__DISPLAYCLASS14_0__PLAYEXIT_B__0_OFFSET UNITYSDK_OFFSET(0x189B19B0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER___C__DISPLAYCLASS14_0__PLAYEXIT_B__1_OFFSET UNITYSDK_OFFSET(0x189B19C0)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultPageController___c__DisplayClass14_0_TypeDefinitionIndex = 69275;
