...
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1482B040)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER___C__DISPLAYCLASS14_0__PLAYEXIT_B__0_OFFSET UNITYSDK_OFFSET(0x1482B050)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER___C__DISPLAYCLASS14_0__PLAYEXIT_B__1_OFFSET UNITYSDK_OFFSET(0x1482B060)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultPageController___c__DisplayClass14_0_TypeDefinitionIndex = 68600;
