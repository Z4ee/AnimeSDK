...
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__PLAYENVTIMELINE_D__146_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x7FFC00)
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__PLAYENVTIMELINE_D__146_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x283610)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooPageController__PlayEnvTimeline_d__146_TypeDefinitionIndex = 40740;
