...
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_BACKTOLIST_OFFSET UNITYSDK_OFFSET(0x18503670)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_CLEARHEADSTATE_OFFSET UNITYSDK_OFFSET(0x18505140)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_CLOSEMENUPOP_OFFSET UNITYSDK_OFFSET(0x184FD8F0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ENTERPLAYGAMEPHASE_OFFSET UNITYSDK_OFFSET(0x184FF2D0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_GETPLAYERBYPOS_OFFSET UNITYSDK_OFFSET(0x18502720)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x184FD1F0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_INITGAMEINFO_OFFSET UNITYSDK_OFFSET(0x184FE440)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x184FD250)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ISBLOCKINPUT_OFFSET UNITYSDK_OFFSET(0x185035D0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONACHIEVEMENTBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x185038C0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONASKCHANGEPOSRESULT_OFFSET UNITYSDK_OFFSET(0x185044C0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONBATTLEABORT_OFFSET UNITYSDK_OFFSET(0x18505AB0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONBATTLEREADY_OFFSET UNITYSDK_OFFSET(0x18505290)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONBEASKCHANGEPOS_OFFSET UNITYSDK_OFFSET(0x18504770)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONCLICKINVITEHANDLER_OFFSET UNITYSDK_OFFSET(0x185030C0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONCLICKKICKOFFHANDLER_OFFSET UNITYSDK_OFFSET(0x18502CF0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONCLICKSWITCHHANDLER_OFFSET UNITYSDK_OFFSET(0x18503200)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x185034F0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x184FDE10)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONINFOBTNCLICK_OFFSET UNITYSDK_OFFSET(0x184FE140)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x184FE0B0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONMAINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x185039C0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONPLAYERHEADROWBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18501E50)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONRANKBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x185037C0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONREADYBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18503B10)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONROOMINFOSYNC_OFFSET UNITYSDK_OFFSET(0x18504AA0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x184FD770)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x184FDEA0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x184FD200)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x184FD660)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_PLAYALLFADEINANIM_OFFSET UNITYSDK_OFFSET(0x184FF3D0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_PLAYALLFADEOUTANIM_OFFSET UNITYSDK_OFFSET(0x18501840)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_PLAYMATCHINGANIM_OFFSET UNITYSDK_OFFSET(0x18503F00)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_PLAYMATCHINGSOUND_OFFSET UNITYSDK_OFFSET(0x18504020)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_PLAYROOTANIM_OFFSET UNITYSDK_OFFSET(0x184FFCC0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_PLAYSPECIALFADEINPOSTANIM_OFFSET UNITYSDK_OFFSET(0x18501610)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_PLAYSPECIALFADEINPREANIM_OFFSET UNITYSDK_OFFSET(0x185014C0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_PLAYSPECIALFADEOUTANIM_OFFSET UNITYSDK_OFFSET(0x185018C0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_REFRESHCONSUME_OFFSET UNITYSDK_OFFSET(0x185019B0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_REFRESHHEAD_OFFSET UNITYSDK_OFFSET(0x184FFE40)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_REFRESHMATCHBTN_OFFSET UNITYSDK_OFFSET(0x185028D0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x184FE860)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_SAMPLEALLFADEINANIM_OFFSET UNITYSDK_OFFSET(0x185012C0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_SETBOTTOMAREAACTIVE_OFFSET UNITYSDK_OFFSET(0x18501940)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_SETHEADINFOLOCK_OFFSET UNITYSDK_OFFSET(0x18504F70)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_SETREADYSTATEWITHMATCHINGANIM_OFFSET UNITYSDK_OFFSET(0x184FDD90)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_SETREADYSTATE_OFFSET UNITYSDK_OFFSET(0x18501A70)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_SETREFCONTROLLER_OFFSET UNITYSDK_OFFSET(0x184FE380)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_SHOWERRORMESSAGEWITHTIMEOUT_OFFSET UNITYSDK_OFFSET(0x18505E90)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_SHOWERRORMESSAGE_OFFSET UNITYSDK_OFFSET(0x18505CF0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_SHOWFRIENDINVITEPOPWINDOW_OFFSET UNITYSDK_OFFSET(0x18503110)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__BACKTOLIST_B__45_0_OFFSET UNITYSDK_OFFSET(0x185069C0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18506170)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18506050)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__ENTERPLAYGAMEPHASE_B__37_0_OFFSET UNITYSDK_OFFSET(0x18506720)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__INITVIEW_B__21_0_OFFSET UNITYSDK_OFFSET(0x18506290)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__ONASKCHANGEPOSRESULT_B__46_0_OFFSET UNITYSDK_OFFSET(0x185069F0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__ONBATTLEREADY_G__COMATCHREADY_49_0_OFFSET UNITYSDK_OFFSET(0x18505A60)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__ONREADYBTNCLICKED_B__36_0_OFFSET UNITYSDK_OFFSET(0x18506580)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__ONREADYBTNCLICKED_B__36_1_OFFSET UNITYSDK_OFFSET(0x18506690)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__PLAYMATCHINGANIM_G__COSTARTMATCHING_41_2_OFFSET UNITYSDK_OFFSET(0x18506970)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__PLAYMATCHINGANIM_G__PLAYMATCHINGANIMINTERNAL_41_0_OFFSET UNITYSDK_OFFSET(0x18504240)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__PLAYMATCHINGANIM_G__STOPMATCHINGANIMINTERNAL_41_1_OFFSET UNITYSDK_OFFSET(0x18504310)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__PLAYSPECIALFADEINPOSTANIM_B__17_0_OFFSET UNITYSDK_OFFSET(0x18506180)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__PLAYSPECIALFADEINPOSTANIM_G__COPLAYANIMSEQUENCE_17_1_OFFSET UNITYSDK_OFFSET(0x18506240)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18506A00)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x18506A90)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x18506AC0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18506B80)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18506B90)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18506BA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeTeamChildWindowController_TypeDefinitionIndex = 65751;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIArcadeTeamChildWindowController_TypeDefinitionIndex)->GetStaticField(0x10D60);
		}
		...
		::Class_2_79AE422BA06F6D26_194* _view; // 0x318
		...
		::Class_3_5078920EEFF548CF* GetPlayerByPos(::Class_3_A2FA498259515937* roomInfo, ::System::Int32 pos)
		{
			return ((::Class_3_5078920EEFF548CF*(*)(::PVOID, ::Class_3_A2FA498259515937*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_GETPLAYERBYPOS_OFFSET))(this, roomInfo, pos);
		}
