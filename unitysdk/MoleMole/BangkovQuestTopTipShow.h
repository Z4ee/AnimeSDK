...
#define MOLEMOLE_BANGKOVQUESTTOPTIPSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x14E00390)
#define MOLEMOLE_BANGKOVQUESTTOPTIPSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x14E00370)
#define MOLEMOLE_BANGKOVQUESTTOPTIPSHOW___BASE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x14E00550)

namespace MoleMole
{
	inline static constexpr unsigned int BangkovQuestTopTipShow_TypeDefinitionIndex = 76287;
