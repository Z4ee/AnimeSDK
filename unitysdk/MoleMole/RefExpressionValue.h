...
#define MOLEMOLE_REFEXPRESSIONVALUE_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x1870CC90)
#define MOLEMOLE_REFEXPRESSIONVALUE_METHOD_1_49AC00594530B714_OFFSET UNITYSDK_OFFSET(0x1870CB20)
#define MOLEMOLE_REFEXPRESSIONVALUE_METHOD_1_79AB2D796DCCB2A4_OFFSET UNITYSDK_OFFSET(0x1870CB60)
#define MOLEMOLE_REFEXPRESSIONVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1870CB10)

namespace MoleMole
{
	inline static constexpr unsigned int RefExpressionValue_TypeDefinitionIndex = 74878;
	...
	public:
		...
		::Struct_2_A47ACAABA9AAFE92 Method_1_79AB2D796DCCB2A4(::Class_0_16E4307DCC419505_263* a1)
		{
			return ((::Struct_2_A47ACAABA9AAFE92(*)(::PVOID, ::Class_0_16E4307DCC419505_263*))((::PBYTE)hIl2Cpp + MOLEMOLE_REFEXPRESSIONVALUE_METHOD_1_79AB2D796DCCB2A4_OFFSET))(this, a1);
		}
