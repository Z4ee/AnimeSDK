...
#define MOLEMOLE_UIGACHABTNWIDGETCONTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18807C30)
#define MOLEMOLE_UIGACHABTNWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18807BC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaBtnWidgetContext_TypeDefinitionIndex = 69615;
	...
	public:
		...
		::System::Int32 UIGroupID; // 0x38
		::System::Int32 GachaID; // 0x3C
		::System::Int32 GachaScheduleID; // 0x40
