...
#define MOLEMOLE_UINOUNDETAILPANELWIDGETCONTROLLER__PLAYHIDEHEADERANDDEACTIVATEASYNC_D__40_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x7FFC70)
#define MOLEMOLE_UINOUNDETAILPANELWIDGETCONTROLLER__PLAYHIDEHEADERANDDEACTIVATEASYNC_D__40_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x283610)

namespace MoleMole
{
	inline static constexpr unsigned int UINounDetailPanelWidgetController__PlayHideHeaderAndDeactivateAsync_d__40_TypeDefinitionIndex = 77764;
