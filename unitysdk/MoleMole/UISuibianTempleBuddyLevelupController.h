...
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_BUILDVIEWMODELDATABINDING_OFFSET UNITYSDK_OFFSET(0x12E87E00)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_CALCURITEMMAX_OFFSET UNITYSDK_OFFSET(0x12E89A40)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_CLEARMATERIAL_OFFSET UNITYSDK_OFFSET(0x12E89DA0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_GETALLSELECTMATERIAL_OFFSET UNITYSDK_OFFSET(0x12E89250)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_GETSELECTLEVELUPMATERIALEXCEPTI_OFFSET UNITYSDK_OFFSET(0x12E89750)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x12E886A0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x12E876A0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONBEFOREWORLDUPDATE_OFFSET UNITYSDK_OFFSET(0x12E8C680)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONCLICKBTN1_OFFSET UNITYSDK_OFFSET(0x12E8A250)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONCLICKBTN2_OFFSET UNITYSDK_OFFSET(0x12E8AAC0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONCLICKMATITEM_OFFSET UNITYSDK_OFFSET(0x12E8AB50)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x12E8C080)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x12E8D030)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x12E87AA0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12E89F60)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12E879F0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12E88540)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_REFRESHLEVELUPINPUTKEY_OFFSET UNITYSDK_OFFSET(0x12E8C1A0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x12E884B0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_SETCONSUME_OFFSET UNITYSDK_OFFSET(0x12E8B3F0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_SETPARENTVIEW_OFFSET UNITYSDK_OFFSET(0x12E87320)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_SETPROGRESS_OFFSET UNITYSDK_OFFSET(0x12E89060)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_TRIGGERGAMEPADADDBTN_OFFSET UNITYSDK_OFFSET(0x12E8C730)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_TRIGGERGAMEPADREDUCEBTN_OFFSET UNITYSDK_OFFSET(0x12E8CBB0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_UPDATETEMPLEBUDDY_OFFSET UNITYSDK_OFFSET(0x12E88740)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__BUILDVIEWMODELDATABINDING_B__24_0_OFFSET UNITYSDK_OFFSET(0x12E8DE60)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__BUILDVIEWMODELDATABINDING_B__24_1_OFFSET UNITYSDK_OFFSET(0x12E8DFC0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__BUILDVIEWMODELDATABINDING_B__24_2_OFFSET UNITYSDK_OFFSET(0x12E8E110)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__BUILDVIEWMODELDATABINDING_B__24_3_OFFSET UNITYSDK_OFFSET(0x12E8E310)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__BUILDVIEWMODELDATABINDING_B__24_4_OFFSET UNITYSDK_OFFSET(0x12E8E510)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__BUILDVIEWMODELDATABINDING_B__24_5_OFFSET UNITYSDK_OFFSET(0x12E8E650)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__BUILDVIEWMODELDATABINDING_B__24_6_OFFSET UNITYSDK_OFFSET(0x12E8E830)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12E8DAF0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__ONUIOPEN_B__15_0_OFFSET UNITYSDK_OFFSET(0x12E8DC30)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__SETPARENTVIEW_B__11_0_OFFSET UNITYSDK_OFFSET(0x12E8DBA0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x12E8E970)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x12E8EA00)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x12E8EAB0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x12E8EAE0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12E8EB80)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12E8EC10)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12E8ECA0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleBuddyLevelupController_TypeDefinitionIndex = 66366;

	class UISuibianTempleBuddyLevelupController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_152* _view; // 0x2B8
		::Class_2_9D9172C07F82DDAE* _itemModel; // 0x2C0
		::Class_2_07A2E3D9266E9604* _roleDataProxy; // 0x2C8
		::MoleMole::UISuibianTempleBuddyDevelopePopWindowController* _mainController; // 0x2D0
		::System::Collections::Generic::List_1<::Class_1_C5FDB00B12827EE9*>* _curPropertyItemViews; // 0x2D8
		::UnityEngine::Material* _percentMaterial; // 0x2E0
		::MoleMole::MonoGamepadCustomList* _monoGamepadCustomList; // 0x2E8
		::System::Int32 _gamepadAddSelectIndex; // 0x2F0
		::System::Int32 _gamepadReduceSelectIndex; // 0x2F4
		::System::Boolean _isGamepadAddBtnPressed; // 0x2F8
		::System::Boolean _isGamepadReduceBtnPressed; // 0x2F9
		::Class_1_48D56DACBE4271BC* _propertySyncHelper; // 0x300
		::MoleMole::UISuibianTempleBuddyLevelupController_ViewModel* _viewModel; // 0x308
		::System::Threading::CancellationTokenSource* _cancellationTokenSource; // 0x310
