...
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_BUILDVIEWMODELDATABINDING_OFFSET UNITYSDK_OFFSET(0x15C2FE20)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_CALCURITEMMAX_OFFSET UNITYSDK_OFFSET(0x15C31A60)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_CLEARMATERIAL_OFFSET UNITYSDK_OFFSET(0x15C31E90)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_GETALLSELECTMATERIAL_OFFSET UNITYSDK_OFFSET(0x15C31270)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_GETSELECTLEVELUPMATERIALEXCEPTI_OFFSET UNITYSDK_OFFSET(0x15C31770)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x15C306C0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x15C2F6C0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONBEFOREWORLDUPDATE_OFFSET UNITYSDK_OFFSET(0x15C34870)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONCLICKBTN1_OFFSET UNITYSDK_OFFSET(0x15C32340)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONCLICKBTN2_OFFSET UNITYSDK_OFFSET(0x15C32C80)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONCLICKMATITEM_OFFSET UNITYSDK_OFFSET(0x15C32D10)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x15C34280)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x15C35200)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15C2FAC0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15C32050)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15C2FA10)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15C30560)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_REFRESHLEVELUPINPUTKEY_OFFSET UNITYSDK_OFFSET(0x15C343A0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x15C304D0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_SETCONSUME_OFFSET UNITYSDK_OFFSET(0x15C33610)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_SETPARENTVIEW_OFFSET UNITYSDK_OFFSET(0x15C2F330)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_SETPROGRESS_OFFSET UNITYSDK_OFFSET(0x15C31080)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_TRIGGERGAMEPADADDBTN_OFFSET UNITYSDK_OFFSET(0x15C34920)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_TRIGGERGAMEPADREDUCEBTN_OFFSET UNITYSDK_OFFSET(0x15C34D90)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_UPDATETEMPLEBUDDY_OFFSET UNITYSDK_OFFSET(0x15C30760)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__BUILDVIEWMODELDATABINDING_B__24_0_OFFSET UNITYSDK_OFFSET(0x15C36030)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__BUILDVIEWMODELDATABINDING_B__24_1_OFFSET UNITYSDK_OFFSET(0x15C36190)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__BUILDVIEWMODELDATABINDING_B__24_2_OFFSET UNITYSDK_OFFSET(0x15C362E0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__BUILDVIEWMODELDATABINDING_B__24_3_OFFSET UNITYSDK_OFFSET(0x15C364E0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__BUILDVIEWMODELDATABINDING_B__24_4_OFFSET UNITYSDK_OFFSET(0x15C366E0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__BUILDVIEWMODELDATABINDING_B__24_5_OFFSET UNITYSDK_OFFSET(0x15C36820)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__BUILDVIEWMODELDATABINDING_B__24_6_OFFSET UNITYSDK_OFFSET(0x15C36A00)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15C35CC0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__ONUIOPEN_B__15_0_OFFSET UNITYSDK_OFFSET(0x15C35E00)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__SETPARENTVIEW_B__11_0_OFFSET UNITYSDK_OFFSET(0x15C35D70)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x15C36B40)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x15C36BD0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x15C36C80)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15C36CB0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15C36D50)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15C36DE0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15C36E70)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleBuddyLevelupController_TypeDefinitionIndex = 71353;

	class UISuibianTempleBuddyLevelupController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_154* _view; // 0x2C0
