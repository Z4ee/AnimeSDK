...
#define MOLEMOLE_UNLOCKVIEWPOINTREWARDPOPSHOW_CLOSEACTION_OFFSET UNITYSDK_OFFSET(0x1491EE00)
#define MOLEMOLE_UNLOCKVIEWPOINTREWARDPOPSHOW_ONNEWBIEGONEXTHANDLE_OFFSET UNITYSDK_OFFSET(0x1491F320)
#define MOLEMOLE_UNLOCKVIEWPOINTREWARDPOPSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x1491EB90)
#define MOLEMOLE_UNLOCKVIEWPOINTREWARDPOPSHOW_SETMESSAGECONFIG_OFFSET UNITYSDK_OFFSET(0x1491EB30)
#define MOLEMOLE_UNLOCKVIEWPOINTREWARDPOPSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1491EA70)
#define MOLEMOLE_UNLOCKVIEWPOINTREWARDPOPSHOW___BASE_SETMESSAGECONFIG_OFFSET UNITYSDK_OFFSET(0x1491F8A0)

namespace MoleMole
{
	inline static constexpr unsigned int UnlockViewPointRewardPopShow_TypeDefinitionIndex = 72687;
