...
#define MOLEMOLE_CONFIGUIADAPT_DEFAULTUIADAPTDATADIC__CTOR_OFFSET UNITYSDK_OFFSET(0x14260050)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIAdapt_DefaultUIAdaptDataDic_TypeDefinitionIndex = 75581;
