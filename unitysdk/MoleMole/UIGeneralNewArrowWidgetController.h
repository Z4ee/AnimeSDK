...
#define MOLEMOLE_UIGENERALNEWARROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x155B8400)
#define MOLEMOLE_UIGENERALNEWARROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x155B8470)
#define MOLEMOLE_UIGENERALNEWARROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x155B8530)
#define MOLEMOLE_UIGENERALNEWARROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x155B8600)
#define MOLEMOLE_UIGENERALNEWARROWWIDGETCONTROLLER_SETARROWPOSITION_OFFSET UNITYSDK_OFFSET(0x155B86F0)
#define MOLEMOLE_UIGENERALNEWARROWWIDGETCONTROLLER_SETSHOWINGSTATE_OFFSET UNITYSDK_OFFSET(0x155B87B0)
#define MOLEMOLE_UIGENERALNEWARROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x155B8880)
#define MOLEMOLE_UIGENERALNEWARROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x155B88E0)
#define MOLEMOLE_UIGENERALNEWARROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x155B8980)
#define MOLEMOLE_UIGENERALNEWARROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x155B8A10)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralNewArrowWidgetController_TypeDefinitionIndex = 70996;
