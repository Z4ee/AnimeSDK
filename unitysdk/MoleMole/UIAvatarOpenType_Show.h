...
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW_GETSETTINGTYPES_OFFSET UNITYSDK_OFFSET(0x172B5C60)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW_GETUIFROM_OFFSET UNITYSDK_OFFSET(0x172B5710)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW_GETUISHOWSETTINGDROPDOWNVALUE_OFFSET UNITYSDK_OFFSET(0x172B5D20)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW_GETUISHOWSETTINGTYPENAME_OFFSET UNITYSDK_OFFSET(0x172B59E0)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW_GET_UIFROM_OFFSET UNITYSDK_OFFSET(0x172B5560)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW_GET_UISHOWSETTINGTYPE_OFFSET UNITYSDK_OFFSET(0x172B59D0)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW_ONUIFROMVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x172B5960)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW_SET_UIFROM_OFFSET UNITYSDK_OFFSET(0x172B56A0)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW_SET_UISHOWSETTINGTYPE_OFFSET UNITYSDK_OFFSET(0x172B5AA0)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW__CCTOR_OFFSET UNITYSDK_OFFSET(0x172B5DE0)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x172B5DD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarOpenType_Show_TypeDefinitionIndex = 52133;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(UIAvatarOpenType_Show_TypeDefinitionIndex)->GetStaticField(0x46B10);
		}
