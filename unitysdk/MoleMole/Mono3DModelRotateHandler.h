...
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1429BA10)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_BINDIMGEVENTTRIGGER_OFFSET UNITYSDK_OFFSET(0x1429B190)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_BINDMODELPROVIDER_OFFSET UNITYSDK_OFFSET(0x1429B140)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_BINDROTATEPOS_OFFSET UNITYSDK_OFFSET(0x1429B0E0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_GET_ISDRAGING_OFFSET UNITYSDK_OFFSET(0x1429C910)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_GET_ROTATEAXIS_OFFSET UNITYSDK_OFFSET(0x1429B750)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_ISCONTENTOUTOFRANGE_OFFSET UNITYSDK_OFFSET(0x1429C920)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1429B8E0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_0B63A0EF42BD601E_OFFSET UNITYSDK_OFFSET(0x1429D980)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_128774387667156B_OFFSET UNITYSDK_OFFSET(0x1429DC70)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_18177A4B3C1B0D63_OFFSET UNITYSDK_OFFSET(0x1429DA40)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_36936583E2881CD1_OFFSET UNITYSDK_OFFSET(0x1429D020)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0x1429DDB0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x1429DC20)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_40E490E2772D5D75_OFFSET UNITYSDK_OFFSET(0x1429E1E0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x1429C6A0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1429B970)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_67D41ACFEF39E84E_OFFSET UNITYSDK_OFFSET(0x1429B470)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_9ACDED94382FBB80_OFFSET UNITYSDK_OFFSET(0x1429E260)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_9AD90DEC7E116B80_1_OFFSET UNITYSDK_OFFSET(0x1429CEB0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_9AD90DEC7E116B80_OFFSET UNITYSDK_OFFSET(0x1429CA60)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_A2DEBE149A58BBB9_OFFSET UNITYSDK_OFFSET(0x1429DDF0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_A36150C5DCC8409E_1_OFFSET UNITYSDK_OFFSET(0x1429DD60)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x1429CA10)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_A698503049613B5B_1_OFFSET UNITYSDK_OFFSET(0x1429CF60)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_A698503049613B5B_OFFSET UNITYSDK_OFFSET(0x1429CB10)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_AA24E94F43F25FC1_OFFSET UNITYSDK_OFFSET(0x1429DF10)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x1429BD00)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_B8968E62A435FE6D_OFFSET UNITYSDK_OFFSET(0x1429CFE0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_BF972395CC722BF9_OFFSET UNITYSDK_OFFSET(0x1429D8F0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_C1A893ED051978C6_OFFSET UNITYSDK_OFFSET(0x1429BDC0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_D77B9BAF12E64B4B_OFFSET UNITYSDK_OFFSET(0x1429DCB0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_D93EC3DDD756C47C_OFFSET UNITYSDK_OFFSET(0x1429B7F0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_DE2BC44ACB86CE8C_OFFSET UNITYSDK_OFFSET(0x1429D870)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_F79D5EC57FBF426E_OFFSET UNITYSDK_OFFSET(0x1429CB90)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1429BA70)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1429BB50)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1429C700)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1429BB00)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_RESETTODEFAULTROTATE_OFFSET UNITYSDK_OFFSET(0x1429C2A0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_ROTATE_OFFSET UNITYSDK_OFFSET(0x1429BBE0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_SET_ROTATEAXIS_OFFSET UNITYSDK_OFFSET(0x1429B760)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1429B770)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1429C960)

namespace MoleMole
{
	inline static constexpr unsigned int Mono3DModelRotateHandler_TypeDefinitionIndex = 78170;
