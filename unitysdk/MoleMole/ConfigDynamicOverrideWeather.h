...
#define MOLEMOLE_CONFIGDYNAMICOVERRIDEWEATHER__CTOR_OFFSET UNITYSDK_OFFSET(0x13519180)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigDynamicOverrideWeather_TypeDefinitionIndex = 50648;
