...
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_CREATEOPTIONDATALIST_OFFSET UNITYSDK_OFFSET(0x15EA86A0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_FINDCURSELECTEDITEMID_OFFSET UNITYSDK_OFFSET(0x15EA8BB0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_GETCURRENTSKILLRELICITEM_OFFSET UNITYSDK_OFFSET(0x15EA7F50)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_GETTRENDID_OFFSET UNITYSDK_OFFSET(0x15EAA610)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_GET_ABYSSS2MODEL_OFFSET UNITYSDK_OFFSET(0x15EAC580)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_GET_CURFOCUSED_OFFSET UNITYSDK_OFFSET(0x15EA8F80)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x12FE6570)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_GET_INITIALRELICMODEL_OFFSET UNITYSDK_OFFSET(0x15EAC450)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x12FE6580)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITGENERALTOKENWIDGET_OFFSET UNITYSDK_OFFSET(0x15EA7450)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITGENREGROUPLIST_OFFSET UNITYSDK_OFFSET(0x15EA8170)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITINITIALRELICVIEW_OFFSET UNITYSDK_OFFSET(0x12FE7490)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITRELICACTIVEVIEW_OFFSET UNITYSDK_OFFSET(0x12FE76A0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITRELICITEMLIST_OFFSET UNITYSDK_OFFSET(0x15EA8C10)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITRELICTYPE_OFFSET UNITYSDK_OFFSET(0x15EA8B10)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x12FE7740)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITSELECTEDVIEW_1_OFFSET UNITYSDK_OFFSET(0x15EAA940)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITSELECTEDVIEW_OFFSET UNITYSDK_OFFSET(0x15EAA8B0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITSTATEDATALIST_OFFSET UNITYSDK_OFFSET(0x15EA78B0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITTOGGLE_OFFSET UNITYSDK_OFFSET(0x12FE6C30)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONCLICKCANCELBTN_OFFSET UNITYSDK_OFFSET(0x15EABCF0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONCLICKCLOSEBTN_OFFSET UNITYSDK_OFFSET(0x15EAAE00)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONCLICKOKBTN_OFFSET UNITYSDK_OFFSET(0x15EAB250)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONCLICKPAYBTN_OFFSET UNITYSDK_OFFSET(0x15EAAEA0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONCLICKTRENDBTN_OFFSET UNITYSDK_OFFSET(0x15EABE50)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONCONFIRM_OFFSET UNITYSDK_OFFSET(0x15EABAF0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12FE6590)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONINITIALRELICDATAUPDATE_OFFSET UNITYSDK_OFFSET(0x15EAC2E0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x12FE6F30)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONITEMCHANGED_OFFSET UNITYSDK_OFFSET(0x15EAC130)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONTOGGLECHANGE_OFFSET UNITYSDK_OFFSET(0x12FE6E70)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15EA8F10)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12FE6620)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12FE70F0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_PLAYSELECTTOPANIM_OFFSET UNITYSDK_OFFSET(0x15EABC60)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_PROCESSNORMALCONFIRM_OFFSET UNITYSDK_OFFSET(0x15EAB6D0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_REFRESHSELECTVIEW_OFFSET UNITYSDK_OFFSET(0x15EA9B30)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_REFRESHTOPVIEW_OFFSET UNITYSDK_OFFSET(0x15EA9210)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_REFRESHTRENDVIEW_OFFSET UNITYSDK_OFFSET(0x15EA9EC0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_REFRESHVIEWONFOCUSCHANGE_OFFSET UNITYSDK_OFFSET(0x15EA9120)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x15EA91B0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_SETCLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x15EAA9E0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15EAC6B0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER__ONCLICKCANCELBTN_B__59_0_OFFSET UNITYSDK_OFFSET(0x15EAC760)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER__ONCONFIRM_B__57_0_OFFSET UNITYSDK_OFFSET(0x15EAC750)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15EAC7D0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x15EAC860)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15EAC890)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15EAC8A0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15EAC8B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2RelicSelectPageController_TypeDefinitionIndex = 42686;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_70* _view; // 0x310
		::System::Collections::Generic::List_1<::MoleMole::UIWidgetController*>* _contentAddtiveWidgetList; // 0x318
		::System::UInt32 _lastMUid; // 0x320
		::System::Boolean playSelectAnim; // 0x324
		::System::Int32 _lastIndex; // 0x328
		::MoleMole::UIGeneralToggleWidgetControllerWithModel* toggle; // 0x330
		::MoleMole::UIAbyssS2RelicSelectPageController_RelicSelectType _relicType; // 0x338
		::Enum_3_15A8EF2824547B27 _currentPageShowType; // 0x33C
		::System::UInt32 initialRelicUID; // 0x340
		::Class_1_0E5778BB52E10271* _showData; // 0x348
		::Class_1_0E5778BB52E10271* _lastShowData; // 0x350
		::System::Boolean _everSelected; // 0x358
		::MoleMole::MonoGamepadCustomList* _naviList; // 0x360
		::System::Collections::Generic::List_1<::Class_1_0E5778BB52E10271*>* _list; // 0x368
		::System::Collections::Generic::List_1<::Class_1_E49B99468FA26AB2*>* _groupByGenreList; // 0x370
		::System::Collections::Generic::List_1<::System::Int32>* relicItemIDList; // 0x378
		::System::Int32 m_relicID; // 0x380
		::System::UInt32 m_objUID; // 0x384
		::System::Boolean CanUnlock; // 0x388
		::System::Boolean isCurrentLocked; // 0x389
		::Class_2_86B3C791290970F4* m_initialRelicModel; // 0x390
		::Class_2_E621E51D351EB960_1* _abyssS2Model; // 0x398
		::MoleMole::UIAbyssS2InfoBtnWidgetController* _abyssS2InfoBtn; // 0x3A0
