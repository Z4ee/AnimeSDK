...
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER_INITPROGRESSVIEW_OFFSET UNITYSDK_OFFSET(0x166EED70)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER_MAINICONANIM_OFFSET UNITYSDK_OFFSET(0x166F00D0)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x166EECE0)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x166F0960)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x166EEC10)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x166EEC70)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER_PLAYPROGRESSANIM_OFFSET UNITYSDK_OFFSET(0x166EF880)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER_PROGRESSBARANIM_OFFSET UNITYSDK_OFFSET(0x166EF940)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER_SETPROGRESSIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x166F05F0)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x166F0A00)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x166F0A60)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x166F0AF0)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x166F0B80)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x166F0C10)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralPhaseProgressWidgetController_TypeDefinitionIndex = 67907;

	class UIGeneralPhaseProgressWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_5E2FBACADDB625B7_15* _view; // 0x2C0
