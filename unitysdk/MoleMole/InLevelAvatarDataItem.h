...
#define MOLEMOLE_INLEVELAVATARDATAITEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x12F91900)
#define MOLEMOLE_INLEVELAVATARDATAITEM_GETAVATARTEMPLATEID_OFFSET UNITYSDK_OFFSET(0x12F91940)
#define MOLEMOLE_INLEVELAVATARDATAITEM_GETITEMDATA_OFFSET UNITYSDK_OFFSET(0x12F916B0)
#define MOLEMOLE_INLEVELAVATARDATAITEM_GET_DATAITEMID_OFFSET UNITYSDK_OFFSET(0x12F910A0)
#define MOLEMOLE_INLEVELAVATARDATAITEM_GET_ROBOTTEMPLATECONFIG_OFFSET UNITYSDK_OFFSET(0x12F910B0)
#define MOLEMOLE_INLEVELAVATARDATAITEM_INITAVATARDATAITEM_OFFSET UNITYSDK_OFFSET(0x12F915C0)
#define MOLEMOLE_INLEVELAVATARDATAITEM_INITAVATARSKINDATA_OFFSET UNITYSDK_OFFSET(0x12F91610)
#define MOLEMOLE_INLEVELAVATARDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x12F91140)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelAvatarDataItem_TypeDefinitionIndex = 47912;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::MoleMole::Config::BaseProperty, ::System::Single>* mpPropertyOverrideMap; // 0x20
		::Class_2_208CC9941471731A_8* _robotTemplateExt; // 0x28
		::System::Collections::Generic::HashSet_1<::System::Int32>* equipAbilityIDList; // 0x30
		::System::Collections::Generic::List_1<::System::Int32>* initDynamicAccs; // 0x38
		::System::Collections::Generic::HashSet_1<::System::String*>* equipAbilityList; // 0x40
		::System::Int32 avatarTemplateID; // 0x48
		::System::Boolean isAwakeEnable; // 0x4C
		::System::Boolean isDead; // 0x4D
		::System::Boolean isLoadShow; // 0x4E
		::System::Int32 talent; // 0x50
		::MoleMole::InLevelAvatarDataItem_InLevelAvatarDataType AvatarTeamTag; // 0x54
		::Share::EAvatarShowWeaponType showWeaponType; // 0x58
		::System::Int32 star; // 0x5C
		::System::Int32 position; // 0x60
		::System::Int32 passiveSkillLevel; // 0x64
		::System::Int32 awakeID; // 0x68
		::System::Int32 robotID; // 0x6C
		::System::Int32 rank; // 0x70
		::System::Int32 avatarSkinID; // 0x74
		::System::Int32 level; // 0x78
		...
		::Class_2_208CC9941471731A_8* get_robotTemplateConfig()
		{
			return ((::Class_2_208CC9941471731A_8*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_INLEVELAVATARDATAITEM_GET_ROBOTTEMPLATECONFIG_OFFSET))(this);
		}
