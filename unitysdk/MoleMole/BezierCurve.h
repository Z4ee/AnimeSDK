...
#define MOLEMOLE_BEZIERCURVE_AUTOSMOOTHALL_OFFSET UNITYSDK_OFFSET(0x17D252B0)
#define MOLEMOLE_BEZIERCURVE_GETPOSITIONBYNORMALIZETIME_OFFSET UNITYSDK_OFFSET(0x17D25230)
#define MOLEMOLE_BEZIERCURVE_GET_MAXTIME_OFFSET UNITYSDK_OFFSET(0x17D25190)
#define MOLEMOLE_BEZIERCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x17D25330)

namespace MoleMole
{
	inline static constexpr unsigned int BezierCurve_TypeDefinitionIndex = 41143;
