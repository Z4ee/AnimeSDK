...
#define MOLEMOLE_UIGACHAPERFORMANCECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x177E0D20)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaPerformanceContext_TypeDefinitionIndex = 73145;
	...
	public:
		...
		::System::Boolean ShowBackBtn; // 0x44
		::System::Boolean SkipOpenning; // 0x45
		::System::Boolean IsNonGacha; // 0x46
		::System::Boolean AnimaCheckMode; // 0x47
