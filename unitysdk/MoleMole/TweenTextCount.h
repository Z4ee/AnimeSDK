...
#define MOLEMOLE_TWEENTEXTCOUNT_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x141C9180)
#define MOLEMOLE_TWEENTEXTCOUNT_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x141C9350)
#define MOLEMOLE_TWEENTEXTCOUNT_METHOD_7_1E1DF25023616168_OFFSET UNITYSDK_OFFSET(0x141C9510)
#define MOLEMOLE_TWEENTEXTCOUNT_METHOD_7_8B7AE99A932B2193_OFFSET UNITYSDK_OFFSET(0x141C93C0)
#define MOLEMOLE_TWEENTEXTCOUNT_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x141C9360)
#define MOLEMOLE_TWEENTEXTCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x141C9680)
#define MOLEMOLE_TWEENTEXTCOUNT___BASE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x141C96A0)

namespace MoleMole
{
	inline static constexpr unsigned int TweenTextCount_TypeDefinitionIndex = 46938;
