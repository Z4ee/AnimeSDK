...
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS21_0__CTOR_OFFSET UNITYSDK_OFFSET(0x156188C0)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS21_0__ONCLICKSELECTCHATHISTORY_B__0_OFFSET UNITYSDK_OFFSET(0x156188D0)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS21_0__ONCLICKSELECTCHATHISTORY_B__1_OFFSET UNITYSDK_OFFSET(0x15618B80)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS21_0__ONCLICKSELECTCHATHISTORY_B__2_OFFSET UNITYSDK_OFFSET(0x15618BF0)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS21_0__ONCLICKSELECTCHATHISTORY_B__3_OFFSET UNITYSDK_OFFSET(0x15618B10)

namespace MoleMole
{
	inline static constexpr unsigned int UIReportDialogPopWindowController___c__DisplayClass21_0_TypeDefinitionIndex = 69532;

	class UIReportDialogPopWindowController___c__DisplayClass21_0 : public ::System::Object
	{
	public:
		::MoleMole::UIReportChatPopWindowController* reportChatController; // 0x10
		::MoleMole::UIReportDialogPopWindowController* __4__this; // 0x18
