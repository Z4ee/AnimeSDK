...
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS21_0__CTOR_OFFSET UNITYSDK_OFFSET(0x13E07720)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS21_0__ONCLICKSELECTCHATHISTORY_B__0_OFFSET UNITYSDK_OFFSET(0x13E07730)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS21_0__ONCLICKSELECTCHATHISTORY_B__1_OFFSET UNITYSDK_OFFSET(0x13E079D0)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS21_0__ONCLICKSELECTCHATHISTORY_B__2_OFFSET UNITYSDK_OFFSET(0x13E07A30)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS21_0__ONCLICKSELECTCHATHISTORY_B__3_OFFSET UNITYSDK_OFFSET(0x13E07970)

namespace MoleMole
{
	inline static constexpr unsigned int UIReportDialogPopWindowController___c__DisplayClass21_0_TypeDefinitionIndex = 38582;

	class UIReportDialogPopWindowController___c__DisplayClass21_0 : public ::System::Object
	{
	public:
		::MoleMole::UIReportDialogPopWindowController* __4__this; // 0x10
