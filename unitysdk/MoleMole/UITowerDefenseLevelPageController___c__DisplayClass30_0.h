...
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER___C__DISPLAYCLASS30_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1915D540)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER___C__DISPLAYCLASS30_0__ONTOWERDEFENSELEVELUPDATE_B__0_OFFSET UNITYSDK_OFFSET(0x1915D550)

namespace MoleMole
{
	inline static constexpr unsigned int UITowerDefenseLevelPageController___c__DisplayClass30_0_TypeDefinitionIndex = 84616;
	...
	public:
		...
		::Class_1_7807B2B04302CD7B_11* towerData; // 0x18
