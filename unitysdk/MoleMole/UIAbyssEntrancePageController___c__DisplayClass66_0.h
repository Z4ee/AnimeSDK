...
#define MOLEMOLE_UIABYSSENTRANCEPAGECONTROLLER___C__DISPLAYCLASS66_0__CTOR_OFFSET UNITYSDK_OFFSET(0x12BE8690)
#define MOLEMOLE_UIABYSSENTRANCEPAGECONTROLLER___C__DISPLAYCLASS66_0__TRYPLAYANIM_B__0_OFFSET UNITYSDK_OFFSET(0x12BE86A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssEntrancePageController___c__DisplayClass66_0_TypeDefinitionIndex = 79319;
	...
	public:
		...
		::System::Int32 curLevel; // 0x18
		::System::Int32 reqDutyNum; // 0x1C
		::System::Int32 reminderID; // 0x20
		::System::Boolean reqShowNestHard; // 0x24
		::System::Int32 reqPointNum; // 0x28
