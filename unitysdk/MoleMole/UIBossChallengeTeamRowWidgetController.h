...
#define MOLEMOLE_UIBOSSCHALLENGETEAMROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x197F32C0)
#define MOLEMOLE_UIBOSSCHALLENGETEAMROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x197F3390)
#define MOLEMOLE_UIBOSSCHALLENGETEAMROWWIDGETCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x197F3630)
#define MOLEMOLE_UIBOSSCHALLENGETEAMROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x197F3450)
#define MOLEMOLE_UIBOSSCHALLENGETEAMROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x197F3330)
#define MOLEMOLE_UIBOSSCHALLENGETEAMROWWIDGETCONTROLLER_REFRESHGAMEPADSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x183C9820)
#define MOLEMOLE_UIBOSSCHALLENGETEAMROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x183C98C0)
#define MOLEMOLE_UIBOSSCHALLENGETEAMROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x183C98D0)
#define MOLEMOLE_UIBOSSCHALLENGETEAMROWWIDGETCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x183C9970)
#define MOLEMOLE_UIBOSSCHALLENGETEAMROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x183C9A20)
#define MOLEMOLE_UIBOSSCHALLENGETEAMROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x183C9AC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBossChallengeTeamRowWidgetController_TypeDefinitionIndex = 78039;
