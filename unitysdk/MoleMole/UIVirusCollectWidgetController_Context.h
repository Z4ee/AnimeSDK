...
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x11E30B50)

namespace MoleMole
{
	inline static constexpr unsigned int UIVirusCollectWidgetController_Context_TypeDefinitionIndex = 49564;
