...
#define MOLEMOLE_UIACTIVITYHOTPOTINGAMEPAGECONTROLLER__FETCHBYSPOONINTERNAL_D__154_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x777AE0)
#define MOLEMOLE_UIACTIVITYHOTPOTINGAMEPAGECONTROLLER__FETCHBYSPOONINTERNAL_D__154_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2661E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityHotpotInGamePageController__FetchBySpoonInternal_d__154_TypeDefinitionIndex = 53746;
	...
	struct alignas(8) UIActivityHotpotInGamePageController__FetchBySpoonInternal_d__154
	{
		...
		::Cysharp::Threading::Tasks::UniTask_1_Awaiter<::Class_3_C91109162D964E4D_Struct_2_05E939B2CEBE19D9> __u__1; // 0x18
