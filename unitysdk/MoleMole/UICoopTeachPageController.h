...
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_GET_MODEL_OFFSET UNITYSDK_OFFSET(0x15E730A0)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15E72F20)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15E72F30)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_INITEXPITEM_OFFSET UNITYSDK_OFFSET(0x15E736E0)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_INITINDEX_OFFSET UNITYSDK_OFFSET(0x15E73B80)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15E72FA0)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_ONLEVELREWARDCHANGE_OFFSET UNITYSDK_OFFSET(0x15E73160)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15E73AC0)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15E74020)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15E73FB0)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_REFRESHEXP_OFFSET UNITYSDK_OFFSET(0x15E731B0)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15E74210)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15E74220)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15E742C0)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15E742D0)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15E742E0)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopTeachPageController_TypeDefinitionIndex = 85638;
