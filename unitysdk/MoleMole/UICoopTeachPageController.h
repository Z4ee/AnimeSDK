...
class Class_2_6022184E9EB3C904;
...
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_GET_MODEL_OFFSET UNITYSDK_OFFSET(0x170ADDE0)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x170ADC60)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x170ADC70)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_INITEXPITEM_OFFSET UNITYSDK_OFFSET(0x170AE440)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_INITINDEX_OFFSET UNITYSDK_OFFSET(0x170AE8D0)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x170ADCE0)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_ONLEVELREWARDCHANGE_OFFSET UNITYSDK_OFFSET(0x170ADEA0)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x170AE810)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x170AED70)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x170AED00)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_REFRESHEXP_OFFSET UNITYSDK_OFFSET(0x170ADEF0)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x170AEF60)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x170AEF70)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x170AF010)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x170AF020)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x170AF030)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopTeachPageController_TypeDefinitionIndex = 72010;
	...
	public:
		...
		::Class_2_6022184E9EB3C904* get__viewModel()
		{
			return ((::Class_2_6022184E9EB3C904*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UICOOPTEACHPAGECONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
		...
		{
			return ((::Class_2_C66E4DE78E6562C8*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UICOOPTEACHPAGECONTROLLER_GET_MODEL_OFFSET))(this);
		}
