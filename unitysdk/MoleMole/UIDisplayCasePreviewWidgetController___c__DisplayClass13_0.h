...
#define MOLEMOLE_UIDISPLAYCASEPREVIEWWIDGETCONTROLLER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x153049A0)
#define MOLEMOLE_UIDISPLAYCASEPREVIEWWIDGETCONTROLLER___C__DISPLAYCLASS13_0__SWITCHFRIEND_B__0_OFFSET UNITYSDK_OFFSET(0x153049B0)
#define MOLEMOLE_UIDISPLAYCASEPREVIEWWIDGETCONTROLLER___C__DISPLAYCLASS13_0__SWITCHFRIEND_B__1_OFFSET UNITYSDK_OFFSET(0x15304BE0)
#define MOLEMOLE_UIDISPLAYCASEPREVIEWWIDGETCONTROLLER___C__DISPLAYCLASS13_0__SWITCHFRIEND_G__ONFAIL_2_OFFSET UNITYSDK_OFFSET(0x15304A70)

namespace MoleMole
{
	inline static constexpr unsigned int UIDisplayCasePreviewWidgetController___c__DisplayClass13_0_TypeDefinitionIndex = 56657;
