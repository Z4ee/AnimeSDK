...
#define MOLEMOLE_UIDISPLAYCASEPREVIEWWIDGETCONTROLLER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15E7D440)
#define MOLEMOLE_UIDISPLAYCASEPREVIEWWIDGETCONTROLLER___C__DISPLAYCLASS13_0__SWITCHFRIEND_B__0_OFFSET UNITYSDK_OFFSET(0x15E7D450)
#define MOLEMOLE_UIDISPLAYCASEPREVIEWWIDGETCONTROLLER___C__DISPLAYCLASS13_0__SWITCHFRIEND_B__1_OFFSET UNITYSDK_OFFSET(0x15E7D680)
#define MOLEMOLE_UIDISPLAYCASEPREVIEWWIDGETCONTROLLER___C__DISPLAYCLASS13_0__SWITCHFRIEND_G__ONFAIL_2_OFFSET UNITYSDK_OFFSET(0x15E7D510)

namespace MoleMole
{
	inline static constexpr unsigned int UIDisplayCasePreviewWidgetController___c__DisplayClass13_0_TypeDefinitionIndex = 39906;
