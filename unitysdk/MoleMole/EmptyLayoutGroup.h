...
#define MOLEMOLE_EMPTYLAYOUTGROUP_GETCOLROW_OFFSET UNITYSDK_OFFSET(0x18200EF0)
#define MOLEMOLE_EMPTYLAYOUTGROUP_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x18200E70)
#define MOLEMOLE_EMPTYLAYOUTGROUP_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x18200EB0)
#define MOLEMOLE_EMPTYLAYOUTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x18200F40)

namespace MoleMole
{
	inline static constexpr unsigned int EmptyLayoutGroup_TypeDefinitionIndex = 73540;
