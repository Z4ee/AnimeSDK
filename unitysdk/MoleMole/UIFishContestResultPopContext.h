...
#define MOLEMOLE_UIFISHCONTESTRESULTPOPCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F21050)

namespace MoleMole
{
	inline static constexpr unsigned int UIFishContestResultPopContext_TypeDefinitionIndex = 85987;

	class UIFishContestResultPopContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::Class_1_2A154C6D4517B879* FishData; // 0x28
