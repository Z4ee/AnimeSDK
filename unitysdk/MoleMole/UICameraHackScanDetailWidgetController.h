...
#define MOLEMOLE_UICAMERAHACKSCANDETAILWIDGETCONTROLLER_APPLYCURRENTREVEALSTATE_OFFSET UNITYSDK_OFFSET(0x1736B9D0)
#define MOLEMOLE_UICAMERAHACKSCANDETAILWIDGETCONTROLLER_GET_UICAMERA_OFFSET UNITYSDK_OFFSET(0x1736A530)
#define MOLEMOLE_UICAMERAHACKSCANDETAILWIDGETCONTROLLER_HIDEIFVISIBLE_OFFSET UNITYSDK_OFFSET(0x1736BB20)
#define MOLEMOLE_UICAMERAHACKSCANDETAILWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1736BBD0)
#define MOLEMOLE_UICAMERAHACKSCANDETAILWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1736A730)
#define MOLEMOLE_UICAMERAHACKSCANDETAILWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1736A7C0)
#define MOLEMOLE_UICAMERAHACKSCANDETAILWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1736A5D0)
#define MOLEMOLE_UICAMERAHACKSCANDETAILWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1736A6C0)
#define MOLEMOLE_UICAMERAHACKSCANDETAILWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1736A850)
#define MOLEMOLE_UICAMERAHACKSCANDETAILWIDGETCONTROLLER_RESETSCANNINGREVEALSTATE_OFFSET UNITYSDK_OFFSET(0x1736B970)
#define MOLEMOLE_UICAMERAHACKSCANDETAILWIDGETCONTROLLER_REVEALALLCONTENTITEMS_OFFSET UNITYSDK_OFFSET(0x1736B810)
#define MOLEMOLE_UICAMERAHACKSCANDETAILWIDGETCONTROLLER_REVEALBTNITEM_OFFSET UNITYSDK_OFFSET(0x1736CF90)
#define MOLEMOLE_UICAMERAHACKSCANDETAILWIDGETCONTROLLER_REVEALCONTENTITEM_OFFSET UNITYSDK_OFFSET(0x1736C8C0)
#define MOLEMOLE_UICAMERAHACKSCANDETAILWIDGETCONTROLLER_SAMPLECONTENTITEMFADEINTOEND_OFFSET UNITYSDK_OFFSET(0x1736CC60)
#define MOLEMOLE_UICAMERAHACKSCANDETAILWIDGETCONTROLLER_SETPROGRESSVISIBLE_OFFSET UNITYSDK_OFFSET(0x1736B190)
#define MOLEMOLE_UICAMERAHACKSCANDETAILWIDGETCONTROLLER_SHOWORREFRESH_OFFSET UNITYSDK_OFFSET(0x1736B4A0)
#define MOLEMOLE_UICAMERAHACKSCANDETAILWIDGETCONTROLLER_UPDATELINE_OFFSET UNITYSDK_OFFSET(0x1736BC40)
#define MOLEMOLE_UICAMERAHACKSCANDETAILWIDGETCONTROLLER_UPDATEPROGRESS_OFFSET UNITYSDK_OFFSET(0x1736C680)
#define MOLEMOLE_UICAMERAHACKSCANDETAILWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1736D190)
#define MOLEMOLE_UICAMERAHACKSCANDETAILWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1736D1F0)
#define MOLEMOLE_UICAMERAHACKSCANDETAILWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1736D280)
#define MOLEMOLE_UICAMERAHACKSCANDETAILWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1736D310)
#define MOLEMOLE_UICAMERAHACKSCANDETAILWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1736D3A0)

namespace MoleMole
{
	inline static constexpr unsigned int UICameraHackScanDetailWidgetController_TypeDefinitionIndex = 45825;
	...
	public:
		...
		::Class_2_5BBE3E96570FCF6A* _view; // 0x2C0
