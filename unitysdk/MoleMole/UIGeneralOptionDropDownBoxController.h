...
#define MOLEMOLE_UIGENERALOPTIONDROPDOWNBOXCONTROLLER_GETBUTTON_OFFSET UNITYSDK_OFFSET(0x18EBA710)
#define MOLEMOLE_UIGENERALOPTIONDROPDOWNBOXCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x18EB9C80)
#define MOLEMOLE_UIGENERALOPTIONDROPDOWNBOXCONTROLLER_ONDYNAMICTIPSCLOSE_OFFSET UNITYSDK_OFFSET(0x18EBA770)
#define MOLEMOLE_UIGENERALOPTIONDROPDOWNBOXCONTROLLER_ONFILTERDROPVALUECHANGE_OFFSET UNITYSDK_OFFSET(0x18EBA880)
#define MOLEMOLE_UIGENERALOPTIONDROPDOWNBOXCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18EB9A50)
#define MOLEMOLE_UIGENERALOPTIONDROPDOWNBOXCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18EB9AB0)
#define MOLEMOLE_UIGENERALOPTIONDROPDOWNBOXCONTROLLER_REFRESHCONTEXT_OFFSET UNITYSDK_OFFSET(0x18EBA820)
#define MOLEMOLE_UIGENERALOPTIONDROPDOWNBOXCONTROLLER_SETENABLE_OFFSET UNITYSDK_OFFSET(0x18EBA7D0)
#define MOLEMOLE_UIGENERALOPTIONDROPDOWNBOXCONTROLLER_SHOWDROPDOWN_OFFSET UNITYSDK_OFFSET(0x18EBA150)
#define MOLEMOLE_UIGENERALOPTIONDROPDOWNBOXCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18EBAD80)
#define MOLEMOLE_UIGENERALOPTIONDROPDOWNBOXCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18EBAD90)
#define MOLEMOLE_UIGENERALOPTIONDROPDOWNBOXCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18EBAE20)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralOptionDropDownBoxController_TypeDefinitionIndex = 48348;
