...
#define MOLEMOLE_MONOSTAGEENV_AWAKE_OFFSET UNITYSDK_OFFSET(0x173F04D0)
#define MOLEMOLE_MONOSTAGEENV_BUILDSTAGEENV_OFFSET UNITYSDK_OFFSET(0x173F05A0)
#define MOLEMOLE_MONOSTAGEENV_CLEAR_OFFSET UNITYSDK_OFFSET(0x173F5740)
#define MOLEMOLE_MONOSTAGEENV_CREATEDYNAMICSPAWNPOINT_OFFSET UNITYSDK_OFFSET(0x173F5DE0)
#define MOLEMOLE_MONOSTAGEENV_CREATESPAWNPOINTMASKREGION_OFFSET UNITYSDK_OFFSET(0x173F6840)
#define MOLEMOLE_MONOSTAGEENV_FINDMARKNODEBYSHORTNAME_OFFSET UNITYSDK_OFFSET(0x173F44E0)
#define MOLEMOLE_MONOSTAGEENV_GETALLCURVEMOVEOBJECTS_OFFSET UNITYSDK_OFFSET(0x173F0090)
#define MOLEMOLE_MONOSTAGEENV_GETALLCURVYSPLINE_OFFSET UNITYSDK_OFFSET(0x173F4380)
#define MOLEMOLE_MONOSTAGEENV_GETALLDESTRUCTIONOBJECTS_OFFSET UNITYSDK_OFFSET(0x173F0050)
#define MOLEMOLE_MONOSTAGEENV_GETALLINTERESTPOINTS_OFFSET UNITYSDK_OFFSET(0x173EFE30)
#define MOLEMOLE_MONOSTAGEENV_GETALLMAINCITYSCENEOBJECTS_OFFSET UNITYSDK_OFFSET(0x173F0010)
#define MOLEMOLE_MONOSTAGEENV_GETALLPARTYSCENEOBJECTS_OFFSET UNITYSDK_OFFSET(0x173F0160)
#define MOLEMOLE_MONOSTAGEENV_GETALLSCENEFINDWAYOBJECTS_OFFSET UNITYSDK_OFFSET(0x173F0110)
#define MOLEMOLE_MONOSTAGEENV_GETALLSCENEMOVEOBJECTS_OFFSET UNITYSDK_OFFSET(0x173EFF90)
#define MOLEMOLE_MONOSTAGEENV_GETALLSCENEOBJECTS_OFFSET UNITYSDK_OFFSET(0x173EFF50)
#define MOLEMOLE_MONOSTAGEENV_GETALLSIMPLERIGIDBODYOBJECTS_OFFSET UNITYSDK_OFFSET(0x173F00D0)
#define MOLEMOLE_MONOSTAGEENV_GETALLSTAGEDOORS_OFFSET UNITYSDK_OFFSET(0x173F4490)
#define MOLEMOLE_MONOSTAGEENV_GETALLVEHICLEOBJECTS_OFFSET UNITYSDK_OFFSET(0x173EFFD0)
#define MOLEMOLE_MONOSTAGEENV_GETALLWAYPATHSNOALLOC_OFFSET UNITYSDK_OFFSET(0x173F3FA0)
#define MOLEMOLE_MONOSTAGEENV_GETCOLLIDEREVENTDISPATCHER_OFFSET UNITYSDK_OFFSET(0x173F38C0)
#define MOLEMOLE_MONOSTAGEENV_GETCURVYSPLINE_OFFSET UNITYSDK_OFFSET(0x173F42A0)
#define MOLEMOLE_MONOSTAGEENV_GETDOOR_OFFSET UNITYSDK_OFFSET(0x173F43D0)
#define MOLEMOLE_MONOSTAGEENV_GETDYNAMICOBJECT_OFFSET UNITYSDK_OFFSET(0x173F4110)
#define MOLEMOLE_MONOSTAGEENV_GETENTITYMODELMODIFIERBYSPAWNPOINT_OFFSET UNITYSDK_OFFSET(0x173F56E0)
#define MOLEMOLE_MONOSTAGEENV_GETRANDOMSPAWNPOINT_OFFSET UNITYSDK_OFFSET(0x173F3AC0)
#define MOLEMOLE_MONOSTAGEENV_GETSPAWNMONSTERCONFIGBYSPAWNPOINT_OFFSET UNITYSDK_OFFSET(0x173F5180)
#define MOLEMOLE_MONOSTAGEENV_GETSPAWNPOINTGROUPLIST_OFFSET UNITYSDK_OFFSET(0x173F4870)
#define MOLEMOLE_MONOSTAGEENV_GETSPAWNPOINTMASKREGION_OFFSET UNITYSDK_OFFSET(0x173F6E80)
#define MOLEMOLE_MONOSTAGEENV_GETSPAWNPOINT_OFFSET UNITYSDK_OFFSET(0x173F57B0)
#define MOLEMOLE_MONOSTAGEENV_GETVIRTUALCAMERA_OFFSET UNITYSDK_OFFSET(0x173EFE70)
#define MOLEMOLE_MONOSTAGEENV_GETWAYENTITYLIST_OFFSET UNITYSDK_OFFSET(0x173F6750)
#define MOLEMOLE_MONOSTAGEENV_GETWAYPATH_OFFSET UNITYSDK_OFFSET(0x173F3EB0)
#define MOLEMOLE_MONOSTAGEENV_GET_DYNAMICOBJECTMANAGER_OFFSET UNITYSDK_OFFSET(0x173EFE00)
#define MOLEMOLE_MONOSTAGEENV_GET_EVNDESIGNGO_OFFSET UNITYSDK_OFFSET(0x173EFDF0)
#define MOLEMOLE_MONOSTAGEENV_GET_MONOSTAGECAMERACONFIG_OFFSET UNITYSDK_OFFSET(0x173EFE20)
#define MOLEMOLE_MONOSTAGEENV_GET_SPAWNPOINTMASKREGIONS_OFFSET UNITYSDK_OFFSET(0x173F6830)
#define MOLEMOLE_MONOSTAGEENV_GET_SPAWNPOINTS_OFFSET UNITYSDK_OFFSET(0x173F57A0)
#define MOLEMOLE_MONOSTAGEENV_GET_STAGEPREHITBOUNDS_OFFSET UNITYSDK_OFFSET(0x173EFE10)
#define MOLEMOLE_MONOSTAGEENV_GET_TERRAINVOXEL_OFFSET UNITYSDK_OFFSET(0x173F0340)
#define MOLEMOLE_MONOSTAGEENV_GET_TERRAINZONE_OFFSET UNITYSDK_OFFSET(0x173F01B0)
#define MOLEMOLE_MONOSTAGEENV_INITSPAWNPOINTMASKREGIONS_OFFSET UNITYSDK_OFFSET(0x173F3040)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_086B8F3BEB129044_OFFSET UNITYSDK_OFFSET(0x173F0CB0)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_1659BCB6D1A9FC34_OFFSET UNITYSDK_OFFSET(0x173F34F0)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_1BB114A39722C94E_OFFSET UNITYSDK_OFFSET(0x173F2910)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_1C3A83F41FF8C386_OFFSET UNITYSDK_OFFSET(0x173F5910)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_1C82E9956F02E977_OFFSET UNITYSDK_OFFSET(0x173F51E0)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_2839AE123F8ECAA7_OFFSET UNITYSDK_OFFSET(0x173F11F0)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_3986038F8A75EC34_OFFSET UNITYSDK_OFFSET(0x173F4FB0)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_3FAAA518D3F433CC_OFFSET UNITYSDK_OFFSET(0x173F7370)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_5EBCF276C230582C_OFFSET UNITYSDK_OFFSET(0x173F2430)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_81BB58ABD0B02221_OFFSET UNITYSDK_OFFSET(0x173F76E0)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x173F7910)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_9755255E23633868_OFFSET UNITYSDK_OFFSET(0x173F7360)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_A984848EA3E436DA_OFFSET UNITYSDK_OFFSET(0x173F2E90)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_ACE888BF6F5BC5FD_OFFSET UNITYSDK_OFFSET(0x173F0FA0)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_C9A3013DD208C696_OFFSET UNITYSDK_OFFSET(0x173F2A90)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_ED665226DF4C8866_OFFSET UNITYSDK_OFFSET(0x173F0B20)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_F04C04E6DB6D6224_OFFSET UNITYSDK_OFFSET(0x173F1EF0)
#define MOLEMOLE_MONOSTAGEENV_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x173F4620)
#define MOLEMOLE_MONOSTAGEENV_ONENABLE_OFFSET UNITYSDK_OFFSET(0x173F0510)
#define MOLEMOLE_MONOSTAGEENV_QUERYALLSPAWNPOINTBYPREFIX_OFFSET UNITYSDK_OFFSET(0x173F5A20)
#define MOLEMOLE_MONOSTAGEENV_REBUILDSPAWNPOINTS_OFFSET UNITYSDK_OFFSET(0x173F37B0)
#define MOLEMOLE_MONOSTAGEENV_REGISTERSPAWNPOINTENTITY_OFFSET UNITYSDK_OFFSET(0x173F6430)
#define MOLEMOLE_MONOSTAGEENV_RESETDYNAMICOBJECTLAYER_OFFSET UNITYSDK_OFFSET(0x173F4230)
#define MOLEMOLE_MONOSTAGEENV_SETDYNAMICOBJECTLAYERACTIVE_OFFSET UNITYSDK_OFFSET(0x173F41C0)
#define MOLEMOLE_MONOSTAGEENV_UPDATE_OFFSET UNITYSDK_OFFSET(0x173F4540)
#define MOLEMOLE_MONOSTAGEENV__CCTOR_OFFSET UNITYSDK_OFFSET(0x173F72C0)
#define MOLEMOLE_MONOSTAGEENV__CTOR_OFFSET UNITYSDK_OFFSET(0x173F6F60)

namespace MoleMole
{
	inline static constexpr unsigned int MonoStageEnv_TypeDefinitionIndex = 85613;
	...
	public:
		...
		{
			return (::MoleMole::MonoStageEnv**)Il2CppClass::FromTypeDefinitionIndex(MonoStageEnv_TypeDefinitionIndex)->GetStaticField(0x36C70);
		}
		static ::Il2CppArray<::UnityEngine::Collider*>** StaticGet_Field_5_1()
		{
			return (::Il2CppArray<::UnityEngine::Collider*>**)Il2CppClass::FromTypeDefinitionIndex(MonoStageEnv_TypeDefinitionIndex)->GetStaticField(0x36C78);
		}
		static ::System::Collections::Generic::List_1<::MoleMole::MonoSpawnPoint*>** StaticGet_Field_5_35()
		{
			return (::System::Collections::Generic::List_1<::MoleMole::MonoSpawnPoint*>**)Il2CppClass::FromTypeDefinitionIndex(MonoStageEnv_TypeDefinitionIndex)->GetStaticField(0x36C80);
		}
		...
		::Class_0_16E4307DCC419505_449* GetDynamicObject(::System::String* a1)
		{
			return ((::Class_0_16E4307DCC419505_449*(*)(::PVOID, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOSTAGEENV_GETDYNAMICOBJECT_OFFSET))(this, a1);
		}
