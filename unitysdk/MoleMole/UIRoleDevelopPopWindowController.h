...
#define MOLEMOLE_UIROLEDEVELOPPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x1376B480)
#define MOLEMOLE_UIROLEDEVELOPPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1376B470)
#define MOLEMOLE_UIROLEDEVELOPPOPWINDOWCONTROLLER_INITCONSUMEITEMID_OFFSET UNITYSDK_OFFSET(0x1376D190)
#define MOLEMOLE_UIROLEDEVELOPPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x1376BA20)
#define MOLEMOLE_UIROLEDEVELOPPOPWINDOWCONTROLLER_ONCLICKCONSOLECHECKCONSUMEBTN_OFFSET UNITYSDK_OFFSET(0x1376D6A0)
#define MOLEMOLE_UIROLEDEVELOPPOPWINDOWCONTROLLER_ONCLICKCONSUMEICONBTN_OFFSET UNITYSDK_OFFSET(0x1376D600)
#define MOLEMOLE_UIROLEDEVELOPPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1376BDC0)
#define MOLEMOLE_UIROLEDEVELOPPOPWINDOWCONTROLLER_ONINFOCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x1376D440)
#define MOLEMOLE_UIROLEDEVELOPPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1376D870)
#define MOLEMOLE_UIROLEDEVELOPPOPWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x1376DA30)
#define MOLEMOLE_UIROLEDEVELOPPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1376DAC0)
#define MOLEMOLE_UIROLEDEVELOPPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1376B490)
#define MOLEMOLE_UIROLEDEVELOPPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1376BE50)
#define MOLEMOLE_UIROLEDEVELOPPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1376C1C0)
#define MOLEMOLE_UIROLEDEVELOPPOPWINDOWCONTROLLER_SETBTNACTION_OFFSET UNITYSDK_OFFSET(0x1376D3E0)
#define MOLEMOLE_UIROLEDEVELOPPOPWINDOWCONTROLLER_SETBUTTONINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x1376D790)
#define MOLEMOLE_UIROLEDEVELOPPOPWINDOWCONTROLLER_SETROLEDEVELOPCONTENT_OFFSET UNITYSDK_OFFSET(0x1376BF40)
#define MOLEMOLE_UIROLEDEVELOPPOPWINDOWCONTROLLER_SETTITLE_OFFSET UNITYSDK_OFFSET(0x1376CE00)
#define MOLEMOLE_UIROLEDEVELOPPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1376DB30)
#define MOLEMOLE_UIROLEDEVELOPPOPWINDOWCONTROLLER__REFRESHVIEW_B__19_0_OFFSET UNITYSDK_OFFSET(0x1376DBC0)
#define MOLEMOLE_UIROLEDEVELOPPOPWINDOWCONTROLLER__REFRESHVIEW_B__19_1_OFFSET UNITYSDK_OFFSET(0x1376DBE0)
#define MOLEMOLE_UIROLEDEVELOPPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1376DC00)
#define MOLEMOLE_UIROLEDEVELOPPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1376DC90)
#define MOLEMOLE_UIROLEDEVELOPPOPWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x1376DCC0)
#define MOLEMOLE_UIROLEDEVELOPPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1376DD80)
#define MOLEMOLE_UIROLEDEVELOPPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1376DD90)
#define MOLEMOLE_UIROLEDEVELOPPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1376DDA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleDevelopPopWindowController_TypeDefinitionIndex = 69764;

	class UIRoleDevelopPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Enum_3_B944D5F0FFA609A4 _curDialogType; // 0x310
		::System::Collections::Generic::Dictionary_2<::Enum_3_B944D5F0FFA609A4, ::MoleMole::UIBaseController*>* _subChildControllers; // 0x318
		::MoleMole::UIControllerContextBase* _showContext; // 0x320
		::System::Collections::Generic::List_1<::UnityEngine::UI::Button*>* _generalBtns; // 0x328
		::System::Action* _generalBtn0Act; // 0x330
		::System::Action* _generalBtn1Act; // 0x338
		::Class_2_79F6D62CE30E3F8E_11* _view; // 0x340
		::System::Collections::Generic::List_1<::MonoUILoopBGText*>* _loopTxtList; // 0x348
