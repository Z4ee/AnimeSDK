...
class Class_2_2D3F31A667E60709;
...
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER_BIND_OFFSET UNITYSDK_OFFSET(0x1988A530)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1988A3D0)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER_HANDLEFAIRYTIP_OFFSET UNITYSDK_OFFSET(0x1988BE20)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER_INITWIDGETS_OFFSET UNITYSDK_OFFSET(0x1988AB90)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER_ONBEFOREPLAYSTARTFADEIN_OFFSET UNITYSDK_OFFSET(0x1988BC10)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER_ONCONFIRMSELECT_OFFSET UNITYSDK_OFFSET(0x1988CBF0)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1988A3E0)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER_ONDROPDOWNCHANGED_OFFSET UNITYSDK_OFFSET(0x1988C000)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0x1988BCC0)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1988B900)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1988AD40)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1988A470)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1988AEE0)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER_OPENREWARDDIALOG_OFFSET UNITYSDK_OFFSET(0x1988D970)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER_REFRESHCONFIRMBTN_OFFSET UNITYSDK_OFFSET(0x1988CAB0)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER_REFRESHGOBTN_OFFSET UNITYSDK_OFFSET(0x1988B790)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER_REFRESHHIDEBTNVISIBLE_OFFSET UNITYSDK_OFFSET(0x1988C9D0)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER_REFRESHOTHERPARTNERREWARDNOTIFY_OFFSET UNITYSDK_OFFSET(0x1988B430)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER_REFRESHOTHERPARTNERREWARDNOTIFY_STASH_OFFSET UNITYSDK_OFFSET(0x1988DB30)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER_REFRESHREWARDSTATE_OFFSET UNITYSDK_OFFSET(0x1988C7D0)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER_REFRESHROLEIMAGE_OFFSET UNITYSDK_OFFSET(0x1988C070)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1988B390)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER_SELECTPARTNER_OFFSET UNITYSDK_OFFSET(0x1988CA50)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER_SETIMMERSIVEMODE_OFFSET UNITYSDK_OFFSET(0x1988A1C0)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER_SHOWSELECTWIDGET_OFFSET UNITYSDK_OFFSET(0x1988C670)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER_UPDATESHOWPARTNERID_OFFSET UNITYSDK_OFFSET(0x1988D670)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER__BIND_B__13_0_OFFSET UNITYSDK_OFFSET(0x1988E070)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER__BIND_B__13_1_OFFSET UNITYSDK_OFFSET(0x1988E080)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER__BIND_B__13_2_OFFSET UNITYSDK_OFFSET(0x1988E120)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER__BIND_B__13_4_OFFSET UNITYSDK_OFFSET(0x1988E160)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER__BIND_B__13_5_OFFSET UNITYSDK_OFFSET(0x1988E190)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER__BIND_B__13_6_OFFSET UNITYSDK_OFFSET(0x1988E1B0)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER__BIND_B__13_7_OFFSET UNITYSDK_OFFSET(0x1988E1D0)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1988DF30)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER__HANDLEFAIRYTIP_B__17_0_OFFSET UNITYSDK_OFFSET(0x1988E360)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER__HANDLEFAIRYTIP_B__17_1_OFFSET UNITYSDK_OFFSET(0x1988E370)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER__SETIMMERSIVEMODE_B__0_0_OFFSET UNITYSDK_OFFSET(0x1988E060)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER__SETIMMERSIVEMODE_G__SETACTIVEFORIMMERSIVEMODE_0_1_OFFSET UNITYSDK_OFFSET(0x1988A2D0)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER___BASE_ONBEFOREPLAYSTARTFADEIN_OFFSET UNITYSDK_OFFSET(0x1988E380)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1988E410)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER___BASE_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0x1988E4A0)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1988E4B0)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1988E4E0)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1988E4F0)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1988E500)

namespace MoleMole
{
	inline static constexpr unsigned int UIPartnerDatePageController_TypeDefinitionIndex = 74034;

	class UIPartnerDatePageController : public ::MoleMole::UIWindowController
	{
	public:
		::System::Boolean _inImmersiveMode; // 0x318
		::Class_2_2D3F31A667E60709* _view; // 0x320
