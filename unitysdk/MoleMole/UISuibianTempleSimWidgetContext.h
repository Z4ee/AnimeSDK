...
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x11B7A970)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleSimWidgetContext_TypeDefinitionIndex = 64174;
