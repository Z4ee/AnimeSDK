...
#define MOLEMOLE_CUSTOMCOLLISIONCONFIGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5296A0)

namespace MoleMole
{
	inline static constexpr unsigned int CustomCollisionConfigData_TypeDefinitionIndex = 54056;
