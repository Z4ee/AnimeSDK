...
#define MOLEMOLE_CUSTOMCOLLISIONCONFIGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B21EE90)

namespace MoleMole
{
	inline static constexpr unsigned int CustomCollisionConfigData_TypeDefinitionIndex = 50492;
