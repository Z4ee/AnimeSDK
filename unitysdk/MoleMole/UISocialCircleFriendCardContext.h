...
#define MOLEMOLE_UISOCIALCIRCLEFRIENDCARDCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x12674AD0)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleFriendCardContext_TypeDefinitionIndex = 54615;
