...
#define MOLEMOLE_UIINLEVELCARDOPTIONSDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x183741D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelCardOptionsDialogContext_TypeDefinitionIndex = 84281;
