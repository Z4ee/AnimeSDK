...
#define MOLEMOLE_ACTIVITYSPINEANIMATIONREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0xFEFA9A0)

namespace MoleMole
{
	inline static constexpr unsigned int ActivitySpineAnimationReference_TypeDefinitionIndex = 77724;
