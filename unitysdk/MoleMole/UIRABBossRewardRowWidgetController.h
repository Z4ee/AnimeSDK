...
#define MOLEMOLE_UIRABBOSSREWARDROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17D379A0)
#define MOLEMOLE_UIRABBOSSREWARDROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17D37A10)
#define MOLEMOLE_UIRABBOSSREWARDROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17D37AB0)
#define MOLEMOLE_UIRABBOSSREWARDROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x17D37B70)
#define MOLEMOLE_UIRABBOSSREWARDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17D37CF0)
#define MOLEMOLE_UIRABBOSSREWARDROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17D37D00)
#define MOLEMOLE_UIRABBOSSREWARDROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17D37DA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABBossRewardRowWidgetController_TypeDefinitionIndex = 77548;
