...
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER_GETTRICKROWCONTROLLERS_OFFSET UNITYSDK_OFFSET(0x15528D40)
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15527F00)
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15527F10)
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER_INITTRICKS_OFFSET UNITYSDK_OFFSET(0x15528440)
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15527F80)
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15528220)
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER_SETSTATE_OFFSET UNITYSDK_OFFSET(0x15528940)
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15528E90)
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15528FB0)
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15529050)

namespace MoleMole
{
	inline static constexpr unsigned int UITrickDialogPopWindowController_TypeDefinitionIndex = 65636;

	class UITrickDialogPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::List_1<::MoleMole::UIWidgetController*>*>* trickMapController; // 0x310
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>* titleMap; // 0x318
