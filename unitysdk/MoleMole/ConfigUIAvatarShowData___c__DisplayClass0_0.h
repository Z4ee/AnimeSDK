...
#define MOLEMOLE_CONFIGUIAVATARSHOWDATA___C__DISPLAYCLASS0_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18F4C810)
#define MOLEMOLE_CONFIGUIAVATARSHOWDATA___C__DISPLAYCLASS0_0__RELOADFROMFILEASYNC_B__0_OFFSET UNITYSDK_OFFSET(0x18F4C820)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIAvatarShowData___c__DisplayClass0_0_TypeDefinitionIndex = 82020;
