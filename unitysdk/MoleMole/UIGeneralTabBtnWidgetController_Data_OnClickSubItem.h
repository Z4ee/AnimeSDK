...
#define MOLEMOLE_UIGENERALTABBTNWIDGETCONTROLLER_DATA_ONCLICKSUBITEM_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17BD56D0)
#define MOLEMOLE_UIGENERALTABBTNWIDGETCONTROLLER_DATA_ONCLICKSUBITEM_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17BD5700)
#define MOLEMOLE_UIGENERALTABBTNWIDGETCONTROLLER_DATA_ONCLICKSUBITEM_INVOKE_OFFSET UNITYSDK_OFFSET(0x17BD51B0)
#define MOLEMOLE_UIGENERALTABBTNWIDGETCONTROLLER_DATA_ONCLICKSUBITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x17BD5190)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralTabBtnWidgetController_Data_OnClickSubItem_TypeDefinitionIndex = 42462;
