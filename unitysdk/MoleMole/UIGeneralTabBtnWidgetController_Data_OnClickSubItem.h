...
#define MOLEMOLE_UIGENERALTABBTNWIDGETCONTROLLER_DATA_ONCLICKSUBITEM_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x155BA440)
#define MOLEMOLE_UIGENERALTABBTNWIDGETCONTROLLER_DATA_ONCLICKSUBITEM_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x155BA470)
#define MOLEMOLE_UIGENERALTABBTNWIDGETCONTROLLER_DATA_ONCLICKSUBITEM_INVOKE_OFFSET UNITYSDK_OFFSET(0x155B9F40)
#define MOLEMOLE_UIGENERALTABBTNWIDGETCONTROLLER_DATA_ONCLICKSUBITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x155B9F30)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralTabBtnWidgetController_Data_OnClickSubItem_TypeDefinitionIndex = 43069;
