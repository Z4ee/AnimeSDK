...
#define MOLEMOLE_UIACTGIVITYMASTERCOFFEEITEMWIDGETCONTROLLER_GETBUTTON_OFFSET UNITYSDK_OFFSET(0x11D99AB0)
#define MOLEMOLE_UIACTGIVITYMASTERCOFFEEITEMWIDGETCONTROLLER_ONCLICKJUMP_OFFSET UNITYSDK_OFFSET(0x11D99C60)
#define MOLEMOLE_UIACTGIVITYMASTERCOFFEEITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x11D999A0)
#define MOLEMOLE_UIACTGIVITYMASTERCOFFEEITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x11D99A30)
#define MOLEMOLE_UIACTGIVITYMASTERCOFFEEITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x11D998D0)
#define MOLEMOLE_UIACTGIVITYMASTERCOFFEEITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x11D99930)
#define MOLEMOLE_UIACTGIVITYMASTERCOFFEEITEMWIDGETCONTROLLER_SETREFACTIVITYTASK_OFFSET UNITYSDK_OFFSET(0x11D99B10)
#define MOLEMOLE_UIACTGIVITYMASTERCOFFEEITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11D99CF0)
#define MOLEMOLE_UIACTGIVITYMASTERCOFFEEITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x11D99D50)
#define MOLEMOLE_UIACTGIVITYMASTERCOFFEEITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x11D99DE0)
#define MOLEMOLE_UIACTGIVITYMASTERCOFFEEITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x11D99E70)
#define MOLEMOLE_UIACTGIVITYMASTERCOFFEEITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x11D99F00)

namespace MoleMole
{
	inline static constexpr unsigned int UIActgivityMasterCoffeeItemWidgetController_TypeDefinitionIndex = 66055;
