...
#define MOLEMOLE_UIACTGIVITYMASTERCOFFEEITEMWIDGETCONTROLLER_GETBUTTON_OFFSET UNITYSDK_OFFSET(0x11E20970)
#define MOLEMOLE_UIACTGIVITYMASTERCOFFEEITEMWIDGETCONTROLLER_ONCLICKJUMP_OFFSET UNITYSDK_OFFSET(0x11E20B20)
#define MOLEMOLE_UIACTGIVITYMASTERCOFFEEITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x11E20860)
#define MOLEMOLE_UIACTGIVITYMASTERCOFFEEITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x11E208F0)
#define MOLEMOLE_UIACTGIVITYMASTERCOFFEEITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x11E20790)
#define MOLEMOLE_UIACTGIVITYMASTERCOFFEEITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x11E207F0)
#define MOLEMOLE_UIACTGIVITYMASTERCOFFEEITEMWIDGETCONTROLLER_SETREFACTIVITYTASK_OFFSET UNITYSDK_OFFSET(0x11E209D0)
#define MOLEMOLE_UIACTGIVITYMASTERCOFFEEITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11E20BB0)
#define MOLEMOLE_UIACTGIVITYMASTERCOFFEEITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x11E20C10)
#define MOLEMOLE_UIACTGIVITYMASTERCOFFEEITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x11E20CA0)
#define MOLEMOLE_UIACTGIVITYMASTERCOFFEEITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x11E20D30)
#define MOLEMOLE_UIACTGIVITYMASTERCOFFEEITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x11E20DC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActgivityMasterCoffeeItemWidgetController_TypeDefinitionIndex = 57713;

	class UIActgivityMasterCoffeeItemWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_1D34530DBCF53121_1* _view; // 0x2B8
		::Class_1_1D6B384C0B7DC7C3* refActivityTask; // 0x2C0
		::System::Action_1<::Class_1_1D6B384C0B7DC7C3*>* clickCallback; // 0x2C8
