...
#define MOLEMOLE_MONOSHOWTEXTURESTREAMINGSUMMARY_HUMANREADABLESIZE_OFFSET UNITYSDK_OFFSET(0x10BD4DF0)
#define MOLEMOLE_MONOSHOWTEXTURESTREAMINGSUMMARY_METHOD_5_EBF44BC910948FDA_OFFSET UNITYSDK_OFFSET(0x10BD5080)
#define MOLEMOLE_MONOSHOWTEXTURESTREAMINGSUMMARY_ONGUI_OFFSET UNITYSDK_OFFSET(0x10BD4EE0)
#define MOLEMOLE_MONOSHOWTEXTURESTREAMINGSUMMARY_START_OFFSET UNITYSDK_OFFSET(0x10BD4DA0)
#define MOLEMOLE_MONOSHOWTEXTURESTREAMINGSUMMARY__CTOR_OFFSET UNITYSDK_OFFSET(0x10BD5180)

namespace MoleMole
{
	inline static constexpr unsigned int MonoShowTextureStreamingSummary_TypeDefinitionIndex = 50433;
