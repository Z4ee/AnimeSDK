...
class Class_2_60638234271CCDB8_32_Class_2_EF16346D79C18F15_5;
...
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x130275A0)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x13026D20)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x13027630)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x13026A10)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x13026CB0)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER_OPENGACHAROLESELECTWINDOW_OFFSET UNITYSDK_OFFSET(0x130276B0)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x13026E10)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER_SETPOINTVIEW_OFFSET UNITYSDK_OFFSET(0x13027BE0)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER_SETPROGRESSFORGACHATIMES_OFFSET UNITYSDK_OFFSET(0x13027C70)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x130282F0)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0x13028350)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER__ONUIINIT_B__1_1_OFFSET UNITYSDK_OFFSET(0x13028360)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER__SETPROGRESSFORGACHATIMES_G__DOSETPROGRESS_9_1_OFFSET UNITYSDK_OFFSET(0x13027F00)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER__SETPROGRESSFORGACHATIMES_G__PLAYPROGRESSANIM_9_0_OFFSET UNITYSDK_OFFSET(0x13027DD0)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x13028370)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x13028400)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x130284A0)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x13028530)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x130285C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleSelectPoolBtnWidgetController_TypeDefinitionIndex = 43850;
	...
	public:
		...
		::Class_2_60638234271CCDB8_32* _view; // 0x2B8
		::MoleMole::MonoRoleSelectPoolBtnConfig* _config; // 0x2C0
		::MoleMole::UIRoleSelectPoolBtnWidgetContext* _context; // 0x2C8
		::System::Single _maxProgressValue; // 0x2D0
		...
		::System::Void SetPointView(::Class_2_60638234271CCDB8_32_Class_2_EF16346D79C18F15_5* pointView, ::System::Boolean isFull)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_60638234271CCDB8_32_Class_2_EF16346D79C18F15_5*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER_SETPOINTVIEW_OFFSET))(this, pointView, isFull);
		}
