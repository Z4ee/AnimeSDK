...
#define MOLEMOLE_UIBANGBOOUAVMAINPAGECONTROLLER_ACTIVITYEND_OFFSET UNITYSDK_OFFSET(0x14EBA750)
#define MOLEMOLE_UIBANGBOOUAVMAINPAGECONTROLLER_CHECKNEWLEVEL_OFFSET UNITYSDK_OFFSET(0x14EB9190)
#define MOLEMOLE_UIBANGBOOUAVMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x14EB83D0)
#define MOLEMOLE_UIBANGBOOUAVMAINPAGECONTROLLER_ONCHANLLENGEBTNCLICK_OFFSET UNITYSDK_OFFSET(0x14EBA880)
#define MOLEMOLE_UIBANGBOOUAVMAINPAGECONTROLLER_ONCOLLECTINFO_OFFSET UNITYSDK_OFFSET(0x14EBA440)
#define MOLEMOLE_UIBANGBOOUAVMAINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14EB83E0)
#define MOLEMOLE_UIBANGBOOUAVMAINPAGECONTROLLER_ONGRADE_OFFSET UNITYSDK_OFFSET(0x14EBA590)
#define MOLEMOLE_UIBANGBOOUAVMAINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14EBA990)
#define MOLEMOLE_UIBANGBOOUAVMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14EB8470)
#define MOLEMOLE_UIBANGBOOUAVMAINPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14EBA210)
#define MOLEMOLE_UIBANGBOOUAVMAINPAGECONTROLLER_OPENINFO_OFFSET UNITYSDK_OFFSET(0x14EBA8C0)
#define MOLEMOLE_UIBANGBOOUAVMAINPAGECONTROLLER_OPENLEVEL_OFFSET UNITYSDK_OFFSET(0x14EBA2F0)
#define MOLEMOLE_UIBANGBOOUAVMAINPAGECONTROLLER_REFRESHCOLLECTCOUNT_OFFSET UNITYSDK_OFFSET(0x14EB8CF0)
#define MOLEMOLE_UIBANGBOOUAVMAINPAGECONTROLLER_REFRESHLEVEL_OFFSET UNITYSDK_OFFSET(0x14EB97B0)
#define MOLEMOLE_UIBANGBOOUAVMAINPAGECONTROLLER_REFRESHLOCK_OFFSET UNITYSDK_OFFSET(0x14EB9970)
#define MOLEMOLE_UIBANGBOOUAVMAINPAGECONTROLLER__ACTIVITYEND_B__13_0_OFFSET UNITYSDK_OFFSET(0x14EBADD0)
#define MOLEMOLE_UIBANGBOOUAVMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14EBAB60)
#define MOLEMOLE_UIBANGBOOUAVMAINPAGECONTROLLER__ONUIINIT_B__6_0_OFFSET UNITYSDK_OFFSET(0x14EBAD10)
#define MOLEMOLE_UIBANGBOOUAVMAINPAGECONTROLLER__ONUIINIT_B__6_1_OFFSET UNITYSDK_OFFSET(0x14EBACE0)
#define MOLEMOLE_UIBANGBOOUAVMAINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14EBADE0)
#define MOLEMOLE_UIBANGBOOUAVMAINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14EBAE70)
#define MOLEMOLE_UIBANGBOOUAVMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14EBAE80)
#define MOLEMOLE_UIBANGBOOUAVMAINPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14EBAE90)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangBooUAVMainPageController_TypeDefinitionIndex = 44612;

	class UIBangBooUAVMainPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_C7387D40D4120A48_5* _view; // 0x310
		::Class_2_604149159BD159AA* activityModel; // 0x318
		::Class_2_0F98EC09A480D0AE* dreamModel; // 0x320
		::System::Collections::Generic::List_1<::System::String*>* numPaths; // 0x328
