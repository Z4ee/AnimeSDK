...
#define MOLEMOLE_CAMERACHANGETYPE_INSTANCE_CAMERACHANGETYPE_INSTANCE_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x139886E0)
#define MOLEMOLE_CAMERACHANGETYPE_INSTANCE_CAMERACHANGETYPE_INSTANCE_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x139886F0)
#define MOLEMOLE_CAMERACHANGETYPE_INSTANCE_CAMERACHANGETYPE_INSTANCE_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x13988760)
#define MOLEMOLE_CAMERACHANGETYPE_INSTANCE_CAMERACHANGETYPE_INSTANCE_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x139887B0)

namespace MoleMole
{
	inline static constexpr unsigned int CameraChangeType_Instance_CameraChangeType_Instance_UnityGeneratedFormatter_TypeDefinitionIndex = 82303;
