...
#define MOLEMOLE_UIBANGKOVSEARCHWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1735CCE0)
#define MOLEMOLE_UIBANGKOVSEARCHWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1735CD50)
#define MOLEMOLE_UIBANGKOVSEARCHWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1735CDF0)
#define MOLEMOLE_UIBANGKOVSEARCHWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x1735D1B0)
#define MOLEMOLE_UIBANGKOVSEARCHWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1735D250)
#define MOLEMOLE_UIBANGKOVSEARCHWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1735D2B0)
#define MOLEMOLE_UIBANGKOVSEARCHWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1735D350)
#define MOLEMOLE_UIBANGKOVSEARCHWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x1735D3F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangkovSearchWidgetController_TypeDefinitionIndex = 48623;
