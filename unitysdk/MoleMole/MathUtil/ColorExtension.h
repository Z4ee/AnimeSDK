...
#define MOLEMOLE_MATHUTIL_COLOREXTENSION_ISEQUAL_OFFSET UNITYSDK_OFFSET(0x107FBEA0)

namespace MoleMole::MathUtil
{
	inline static constexpr unsigned int ColorExtension_TypeDefinitionIndex = 62627;
