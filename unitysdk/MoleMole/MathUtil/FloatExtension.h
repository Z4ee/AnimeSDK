...
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ABS_1_OFFSET UNITYSDK_OFFSET(0x17E85C80)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ABS_OFFSET UNITYSDK_OFFSET(0x17E85C30)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_CHECKHASBITID_OFFSET UNITYSDK_OFFSET(0x17E86AD0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_CHECKHASBITMASK_OFFSET UNITYSDK_OFFSET(0x17E86B50)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_CLAMP01_OFFSET UNITYSDK_OFFSET(0x17E85DD0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_CLAMP_1_OFFSET UNITYSDK_OFFSET(0x17E85D40)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_CLAMP_OFFSET UNITYSDK_OFFSET(0x17E85CE0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_DIV_OFFSET UNITYSDK_OFFSET(0x17E85300)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_FINDMAXBIT_OFFSET UNITYSDK_OFFSET(0x17E868B0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_FINDMINBIT_OFFSET UNITYSDK_OFFSET(0x17E86690)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_FRAMETOTIME_OFFSET UNITYSDK_OFFSET(0x17E85900)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_GETEPS_OFFSET UNITYSDK_OFFSET(0x17E853E0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_GETFRACTIONALPART_OFFSET UNITYSDK_OFFSET(0x17E862D0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_HERMITEINTERPOLATE_OFFSET UNITYSDK_OFFSET(0x17E864D0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ISEQUAL_1_OFFSET UNITYSDK_OFFSET(0x17E865E0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ISEQUAL_OFFSET UNITYSDK_OFFSET(0x17E85450)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ISGREATEROREQUAL_OFFSET UNITYSDK_OFFSET(0x17E85740)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ISGREATER_OFFSET UNITYSDK_OFFSET(0x17E855E0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ISINT_OFFSET UNITYSDK_OFFSET(0x17E86250)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ISLESSOREQUAL_OFFSET UNITYSDK_OFFSET(0x17E856A0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ISLESS_OFFSET UNITYSDK_OFFSET(0x17E85520)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ISZERO_OFFSET UNITYSDK_OFFSET(0x17E857E0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_NICEFY_OFFSET UNITYSDK_OFFSET(0x17E85F90)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_POWOF_OFFSET UNITYSDK_OFFSET(0x17E85F00)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_SIGN_1_OFFSET UNITYSDK_OFFSET(0x17E85A90)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_SIGN_OFFSET UNITYSDK_OFFSET(0x17E85A40)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_SQRT_OFFSET UNITYSDK_OFFSET(0x17E85E90)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_SQUARE_OFFSET UNITYSDK_OFFSET(0x17E85E40)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_TIMETOFRAME_OFFSET UNITYSDK_OFFSET(0x17E85890)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_TOFLOAT_OFFSET UNITYSDK_OFFSET(0x17E853A0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_TUBESPLINE_OFFSET UNITYSDK_OFFSET(0x17E86330)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_UPCASEOF_OFFSET UNITYSDK_OFFSET(0x17E86070)

namespace MoleMole::MathUtil
{
	inline static constexpr unsigned int FloatExtension_TypeDefinitionIndex = 52496;
