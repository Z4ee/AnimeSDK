...
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ABS_1_OFFSET UNITYSDK_OFFSET(0x16B94760)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ABS_OFFSET UNITYSDK_OFFSET(0x16B94710)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_CHECKHASBITID_OFFSET UNITYSDK_OFFSET(0x16B955B0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_CHECKHASBITMASK_OFFSET UNITYSDK_OFFSET(0x16B95630)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_CLAMP01_OFFSET UNITYSDK_OFFSET(0x16B948B0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_CLAMP_1_OFFSET UNITYSDK_OFFSET(0x16B94820)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_CLAMP_OFFSET UNITYSDK_OFFSET(0x16B947C0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_DIV_OFFSET UNITYSDK_OFFSET(0x16B93DE0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_FINDMAXBIT_OFFSET UNITYSDK_OFFSET(0x16B95390)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_FINDMINBIT_OFFSET UNITYSDK_OFFSET(0x16B95170)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_FRAMETOTIME_OFFSET UNITYSDK_OFFSET(0x16B943E0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_GETEPS_OFFSET UNITYSDK_OFFSET(0x16B93EC0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_GETFRACTIONALPART_OFFSET UNITYSDK_OFFSET(0x16B94DB0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_HERMITEINTERPOLATE_OFFSET UNITYSDK_OFFSET(0x16B94FB0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ISEQUAL_1_OFFSET UNITYSDK_OFFSET(0x16B950C0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ISEQUAL_OFFSET UNITYSDK_OFFSET(0x16B93F30)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ISGREATEROREQUAL_OFFSET UNITYSDK_OFFSET(0x16B94220)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ISGREATER_OFFSET UNITYSDK_OFFSET(0x16B940C0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ISINT_OFFSET UNITYSDK_OFFSET(0x16B94D30)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ISLESSOREQUAL_OFFSET UNITYSDK_OFFSET(0x16B94180)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ISLESS_OFFSET UNITYSDK_OFFSET(0x16B94000)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ISZERO_OFFSET UNITYSDK_OFFSET(0x16B942C0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_NICEFY_OFFSET UNITYSDK_OFFSET(0x16B94A70)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_POWOF_OFFSET UNITYSDK_OFFSET(0x16B949E0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_SIGN_1_OFFSET UNITYSDK_OFFSET(0x16B94570)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_SIGN_OFFSET UNITYSDK_OFFSET(0x16B94520)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_SQRT_OFFSET UNITYSDK_OFFSET(0x16B94970)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_SQUARE_OFFSET UNITYSDK_OFFSET(0x16B94920)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_TIMETOFRAME_OFFSET UNITYSDK_OFFSET(0x16B94370)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_TOFLOAT_OFFSET UNITYSDK_OFFSET(0x16B93E80)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_TUBESPLINE_OFFSET UNITYSDK_OFFSET(0x16B94E10)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_UPCASEOF_OFFSET UNITYSDK_OFFSET(0x16B94B50)

namespace MoleMole::MathUtil
{
	inline static constexpr unsigned int FloatExtension_TypeDefinitionIndex = 42508;
