...
#define MOLEMOLE_BANGBOOMODGARAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x11446840)

namespace MoleMole
{
	inline static constexpr unsigned int BangbooModGarageContext_TypeDefinitionIndex = 62548;
