...
#define MOLEMOLE_UIGACHACOMMONBGROWWIDGETCONTROLLER_CREATEFRAMETEXTUREPLAYER_OFFSET UNITYSDK_OFFSET(0x170E6F40)
#define MOLEMOLE_UIGACHACOMMONBGROWWIDGETCONTROLLER_CREATEVIDEOPLAYER_OFFSET UNITYSDK_OFFSET(0x170E6C90)
#define MOLEMOLE_UIGACHACOMMONBGROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x170E64B0)
#define MOLEMOLE_UIGACHACOMMONBGROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x170E62D0)
#define MOLEMOLE_UIGACHACOMMONBGROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x170E6540)
#define MOLEMOLE_UIGACHACOMMONBGROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x170E6200)
#define MOLEMOLE_UIGACHACOMMONBGROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x170E6260)
#define MOLEMOLE_UIGACHACOMMONBGROWWIDGETCONTROLLER_REFRESHSCREENPLAYERS_OFFSET UNITYSDK_OFFSET(0x170E66F0)
#define MOLEMOLE_UIGACHACOMMONBGROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x170E6460)
#define MOLEMOLE_UIGACHACOMMONBGROWWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x170E7250)
#define MOLEMOLE_UIGACHACOMMONBGROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x170E7400)
#define MOLEMOLE_UIGACHACOMMONBGROWWIDGETCONTROLLER__REFRESHSCREENPLAYERS_G__INITPLAYERANDPLAY_7_0_OFFSET UNITYSDK_OFFSET(0x170E6BE0)
#define MOLEMOLE_UIGACHACOMMONBGROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x170E7460)
#define MOLEMOLE_UIGACHACOMMONBGROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x170E74F0)
#define MOLEMOLE_UIGACHACOMMONBGROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x170E7590)
#define MOLEMOLE_UIGACHACOMMONBGROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x170E7620)
#define MOLEMOLE_UIGACHACOMMONBGROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x170E76B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaCommonBgRowWidgetController_TypeDefinitionIndex = 90478;
