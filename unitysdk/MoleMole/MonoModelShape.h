...
#define MOLEMOLE_MONOMODELSHAPE_FETCHMODELSHAPE_OFFSET UNITYSDK_OFFSET(0x13AC17B0)
#define MOLEMOLE_MONOMODELSHAPE_GETSHAPECAPACITY_OFFSET UNITYSDK_OFFSET(0x13AC16F0)
#define MOLEMOLE_MONOMODELSHAPE_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x13AC1970)
#define MOLEMOLE_MONOMODELSHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x13AC19B0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoModelShape_TypeDefinitionIndex = 50941;
