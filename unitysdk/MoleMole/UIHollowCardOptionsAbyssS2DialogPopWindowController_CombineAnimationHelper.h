...
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_CALCULATEDELAY_OFFSET UNITYSDK_OFFSET(0x14B49940)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_CREATECOMPLETIONTASK_OFFSET UNITYSDK_OFFSET(0x14B49A10)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_DESTROYSTARTEFFECTS_OFFSET UNITYSDK_OFFSET(0x14B48C30)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14B442B0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_GETCENTERPOSITIONS_OFFSET UNITYSDK_OFFSET(0x14B49870)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_HANDLEEFFECT_OFFSET UNITYSDK_OFFSET(0x14B48860)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PLAYBGEFFECT_OFFSET UNITYSDK_OFFSET(0x14B49B90)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PLAYCARDANIMASYNC_OFFSET UNITYSDK_OFFSET(0x14B491E0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PLAYCARDANIM_OFFSET UNITYSDK_OFFSET(0x14B4A140)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PLAYCARDEFFECT_OFFSET UNITYSDK_OFFSET(0x14B49C30)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PLAYCARDMERGEANIM_OFFSET UNITYSDK_OFFSET(0x14B49CE0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PLAYCARDSHOWANIM_OFFSET UNITYSDK_OFFSET(0x14B492B0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PLAYCOMBINEANIMATIONASYNC_OFFSET UNITYSDK_OFFSET(0x14B476A0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PREPARECARD_OFFSET UNITYSDK_OFFSET(0x14B48E10)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PREPARECOMBINEEFFECT_OFFSET UNITYSDK_OFFSET(0x14B47FB0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_SETPARTICLESPEED_OFFSET UNITYSDK_OFFSET(0x14B48BB0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_SHOWCOMBINECARD_OFFSET UNITYSDK_OFFSET(0x14B47F10)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x14B475F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCardOptionsAbyssS2DialogPopWindowController_CombineAnimationHelper_TypeDefinitionIndex = 51112;
	...
	public:
		...
		::System::Collections::Generic::List_1<::UnityEngine::GameObject*>* startEffects; // 0x20
