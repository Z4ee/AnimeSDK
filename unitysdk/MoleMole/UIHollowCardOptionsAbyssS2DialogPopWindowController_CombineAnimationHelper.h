...
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_CALCULATEDELAY_OFFSET UNITYSDK_OFFSET(0x18138490)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_CREATECOMPLETIONTASK_OFFSET UNITYSDK_OFFSET(0x18138560)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_DESTROYSTARTEFFECTS_OFFSET UNITYSDK_OFFSET(0x18137790)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18132E10)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_GETCENTERPOSITIONS_OFFSET UNITYSDK_OFFSET(0x181383C0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_HANDLEEFFECT_OFFSET UNITYSDK_OFFSET(0x181373C0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PLAYBGEFFECT_OFFSET UNITYSDK_OFFSET(0x181386D0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PLAYCARDANIMASYNC_OFFSET UNITYSDK_OFFSET(0x18137D30)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PLAYCARDANIM_OFFSET UNITYSDK_OFFSET(0x18138CA0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PLAYCARDEFFECT_OFFSET UNITYSDK_OFFSET(0x18138770)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PLAYCARDMERGEANIM_OFFSET UNITYSDK_OFFSET(0x18138830)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PLAYCARDSHOWANIM_OFFSET UNITYSDK_OFFSET(0x18137E00)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PLAYCOMBINEANIMATIONASYNC_OFFSET UNITYSDK_OFFSET(0x18136210)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PREPARECARD_OFFSET UNITYSDK_OFFSET(0x18137970)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PREPARECOMBINEEFFECT_OFFSET UNITYSDK_OFFSET(0x18136B10)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_SETPARTICLESPEED_OFFSET UNITYSDK_OFFSET(0x18137710)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_SHOWCOMBINECARD_OFFSET UNITYSDK_OFFSET(0x18136A70)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x18136160)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCardOptionsAbyssS2DialogPopWindowController_CombineAnimationHelper_TypeDefinitionIndex = 58269;

	class UIHollowCardOptionsAbyssS2DialogPopWindowController_CombineAnimationHelper : public ::System::Object
	{
	public:
		::System::Threading::CancellationTokenSource* _cts; // 0x10
		::System::Collections::Generic::List_1<::UnityEngine::GameObject*>* startEffects; // 0x18
		::MoleMole::UIHollowCardOptionsAbyssS2DialogPopWindowController* baseController; // 0x20
		::System::Single timeScale; // 0x28
		::System::Boolean InUpdating; // 0x2C
		::System::Boolean _disposed; // 0x2D
