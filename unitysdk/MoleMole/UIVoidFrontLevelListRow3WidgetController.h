...
class Class_2_792B0D4C328D2185;
namespace MoleMole { class UIControlReference; }
namespace System { class Object; }

#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW3WIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15FA2A90)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW3WIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15FA2B00)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW3WIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x15FA2CD0)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW3WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15FA2BC0)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW3WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15FA2DD0)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW3WIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15FA2DE0)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW3WIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x15FA2E80)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW3WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15FA2F10)

namespace MoleMole
{
	inline static constexpr unsigned int UIVoidFrontLevelListRow3WidgetController_TypeDefinitionIndex = 70022;
	...
	public:
		...
		::Class_2_792B0D4C328D2185* get__viewModel()
		{
			return ((::Class_2_792B0D4C328D2185*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVOIDFRONTLEVELLISTROW3WIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
