...
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER_HIDEREWARDROWGETREWARDEFFECT_OFFSET UNITYSDK_OFFSET(0x18958510)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER_ONCLIKLEVELREWARDROW_OFFSET UNITYSDK_OFFSET(0x18958420)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18957B50)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER_ONGAMEPADMODULEDESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x18958370)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x189582B0)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x18957C70)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18957BE0)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18957880)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER_REFRESHCONSOLEBTNSTATE_OFFSET UNITYSDK_OFFSET(0x18958040)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER_STARTREWARDROWGETREWARDEFFECT_OFFSET UNITYSDK_OFFSET(0x18958490)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18958570)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18958580)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER___BASE_ONGAMEPADMODULEDESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x18958610)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x189586C0)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x18958770)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18958810)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x189588A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBPLevelRewardRowWidgetController_TypeDefinitionIndex = 56750;

	class UIBPLevelRewardRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_60638234271CCDB8_90* _view; // 0x2F0
		::Class_1_C24B693A39FF0505_1* levelRewardData; // 0x2F8
		::Class_1_F9A4B687C800B5DE* levelRewardHandler; // 0x300
		::System::Boolean isSelect; // 0x308
		::System::Int32 selectIndex; // 0x30C
