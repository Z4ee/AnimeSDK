...
#define MOLEMOLE_UIHOLLOWLAYERRESULTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18499770)
#define MOLEMOLE_UIHOLLOWLAYERRESULTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18499800)
#define MOLEMOLE_UIHOLLOWLAYERRESULTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x184996A0)
#define MOLEMOLE_UIHOLLOWLAYERRESULTROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18499700)
#define MOLEMOLE_UIHOLLOWLAYERRESULTROWWIDGETCONTROLLER_REFRESHWIDGET_OFFSET UNITYSDK_OFFSET(0x18499880)
#define MOLEMOLE_UIHOLLOWLAYERRESULTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18499B70)
#define MOLEMOLE_UIHOLLOWLAYERRESULTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18499BD0)
#define MOLEMOLE_UIHOLLOWLAYERRESULTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18499C60)
#define MOLEMOLE_UIHOLLOWLAYERRESULTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18499CF0)
#define MOLEMOLE_UIHOLLOWLAYERRESULTROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18499D80)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowLayerResultRowWidgetController_TypeDefinitionIndex = 79918;
