...
class Class_2_E88EAE6AD8012179;
...
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_AFTERSHOW_OFFSET UNITYSDK_OFFSET(0x192FCE90)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_GET_PAGEWIDGETSTATE_OFFSET UNITYSDK_OFFSET(0x192FBC80)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x192FC030)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONACTIVITYCLOSE_OFFSET UNITYSDK_OFFSET(0x19300A60)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONCLICKBACK_OFFSET UNITYSDK_OFFSET(0x192FD840)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONCLICKCOINBRUSHINGENTRY_OFFSET UNITYSDK_OFFSET(0x192FDFD0)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONCLICKLEFTACTIVITYTAB_OFFSET UNITYSDK_OFFSET(0x192FF330)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONCLICKNEXTBTN_OFFSET UNITYSDK_OFFSET(0x19300660)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONCLICKRIGHTACTIVITYTAB_OFFSET UNITYSDK_OFFSET(0x192FF4C0)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0x192FF100)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONCLICKTIMELIMISHOP_OFFSET UNITYSDK_OFFSET(0x193002E0)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x192FC040)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONENTEROVA_OFFSET UNITYSDK_OFFSET(0x192FE180)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONENTERSPECIALENTRY_OFFSET UNITYSDK_OFFSET(0x192FDC00)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONENTERSTORY_OFFSET UNITYSDK_OFFSET(0x192FEC50)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONSELECTBATTLEQUEST_OFFSET UNITYSDK_OFFSET(0x192FDAB0)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x192FD7D0)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x192FD750)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x192FC0D0)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x192FCB00)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_OPENAVATARWIDGETBYBTN_OFFSET UNITYSDK_OFFSET(0x192FFE80)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_OPENMAINBATTLEWIDGET_OFFSET UNITYSDK_OFFSET(0x192FEFD0)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_OPENSTORYWIDEGT_OFFSET UNITYSDK_OFFSET(0x192FE800)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_PERUNLOCKQUEST_OFFSET UNITYSDK_OFFSET(0x192FE6F0)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_RECOVERCURRENTAVATARWIDGET_OFFSET UNITYSDK_OFFSET(0x192FDB60)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_SETAVATARACTIVITYTAB_OFFSET UNITYSDK_OFFSET(0x192FF650)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_SETBG_OFFSET UNITYSDK_OFFSET(0x192FFB50)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_SETCOMPWEEKREWARDBTN_OFFSET UNITYSDK_OFFSET(0x193006A0)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_SET_PAGEWIDGETSTATE_OFFSET UNITYSDK_OFFSET(0x192FBC90)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_UPDATETAB_OFFSET UNITYSDK_OFFSET(0x192FD060)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19301000)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER__ONACTIVITYCLOSE_B__53_0_OFFSET UNITYSDK_OFFSET(0x19301210)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER__ONUIINIT_B__27_0_OFFSET UNITYSDK_OFFSET(0x19301120)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER__ONUIINIT_B__27_1_OFFSET UNITYSDK_OFFSET(0x19301130)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER__ONUIINIT_B__27_2_OFFSET UNITYSDK_OFFSET(0x193011A0)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER___BASE_AFTERSHOW_OFFSET UNITYSDK_OFFSET(0x193012E0)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x193012F0)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x19301380)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19301420)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19301430)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19301440)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarStoryActivityPageController_TypeDefinitionIndex = 50990;
	...
	public:
		...
		::Class_2_E88EAE6AD8012179* _model; // 0x340
		...
		::Class_2_208CC9941471731A_985* aSAStoryDisplayConfig; // 0x398
