...
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_GET_CURRENTCURSORSCREENPOS_OFFSET UNITYSDK_OFFSET(0x13858740)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_GET_CURRENTSELECTABLE_OFFSET UNITYSDK_OFFSET(0x13858730)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_GET_SCROLLVIEWWRAPPER_OFFSET UNITYSDK_OFFSET(0x138584F0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_ISRAYSEGMENTINTERSECT_OFFSET UNITYSDK_OFFSET(0x1385D6C0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_MANUALREFRESHALLSELECTSTATE_OFFSET UNITYSDK_OFFSET(0x1385D350)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_MANUALRESETPOS_OFFSET UNITYSDK_OFFSET(0x1385A800)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_078D85152011B919_OFFSET UNITYSDK_OFFSET(0x13858EF0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_14246CEAE2B2DA69_OFFSET UNITYSDK_OFFSET(0x13858D40)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_16795D52109A6C43_OFFSET UNITYSDK_OFFSET(0x13860860)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_1E8AEE8D9D242023_OFFSET UNITYSDK_OFFSET(0x13861130)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_357CC795E551368B_OFFSET UNITYSDK_OFFSET(0x1385FDD0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x13859270)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_4AF3A50A92CC492C_OFFSET UNITYSDK_OFFSET(0x1385A750)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_56BE2B738E535346_OFFSET UNITYSDK_OFFSET(0x1385C4A0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_59E9ABF4634513FE_OFFSET UNITYSDK_OFFSET(0x13858910)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_672E3DECEBB4A051_OFFSET UNITYSDK_OFFSET(0x1385A8C0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_67CEDED9BD8F2DA6_OFFSET UNITYSDK_OFFSET(0x13860DB0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_735EE20B25F86BF4_OFFSET UNITYSDK_OFFSET(0x1385BCA0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_833E61AA8ABCFDD8_OFFSET UNITYSDK_OFFSET(0x1385EEF0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_84024AA3B92C6350_OFFSET UNITYSDK_OFFSET(0x1385D3E0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_84516C3E776F194F_OFFSET UNITYSDK_OFFSET(0x13859610)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x13858B80)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_9741A7A0642405F1_OFFSET UNITYSDK_OFFSET(0x138603B0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x1385A590)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_B7A138FF7998A4AC_OFFSET UNITYSDK_OFFSET(0x1385BB80)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_BC3D63492246CA32_OFFSET UNITYSDK_OFFSET(0x1385BA30)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_BFCBCC58B41174A0_OFFSET UNITYSDK_OFFSET(0x1385A6E0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_C48187169E33825B_OFFSET UNITYSDK_OFFSET(0x1385ABE0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1385AE10)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_CDE4B97094B8D1CF_OFFSET UNITYSDK_OFFSET(0x1385E5B0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_D4E0886303081325_OFFSET UNITYSDK_OFFSET(0x13859820)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_EBE339A3EBBAC21A_OFFSET UNITYSDK_OFFSET(0x1385E080)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_EFF8666A3EE7A9A3_OFFSET UNITYSDK_OFFSET(0x1385AE70)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_F34C7D12CD06208F_1_OFFSET UNITYSDK_OFFSET(0x13860600)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_F34C7D12CD06208F_OFFSET UNITYSDK_OFFSET(0x13860400)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_FB44E56B032AA9DE_OFFSET UNITYSDK_OFFSET(0x138618D0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_FD1D91E1FE54EABE_OFFSET UNITYSDK_OFFSET(0x1385CDD0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_SETCURSORTOSELECTBLE_OFFSET UNITYSDK_OFFSET(0x1385C750)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_SETHIDECURSORSTATEANDLOCKSELECT_OFFSET UNITYSDK_OFFSET(0x13859460)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_SETHIDECURSORSTATE_OFFSET UNITYSDK_OFFSET(0x13859670)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_SETLOCKSELECT_OFFSET UNITYSDK_OFFSET(0x1385BAD0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_SET_SCROLLVIEWWRAPPER_OFFSET UNITYSDK_OFFSET(0x13858500)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1385D9D0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR___BASE_GETGAMEPADSELECTABLE_OFFSET UNITYSDK_OFFSET(0x1385DD50)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR___BASE_ISWORKABLEINNER_OFFSET UNITYSDK_OFFSET(0x1385DDE0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1385DE70)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR___BASE_ONMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x1385DF20)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR___BASE_ONMODULEINIT_OFFSET UNITYSDK_OFFSET(0x1385DF30)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR___BASE_ONMODULELATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1385DFC0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR___BASE_ONMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x1385E070)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGamepadVirtualCursor_TypeDefinitionIndex = 48260;
	...
	public:
		...
		::Class_0_16E4307DCC419505_401* get_CurrentSelectable()
		{
			return ((::Class_0_16E4307DCC419505_401*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_GET_CURRENTSELECTABLE_OFFSET))(this);
		}
		...
		::System::Void SetCursorToSelectble(::Class_0_16E4307DCC419505_401* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_401*))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_SETCURSORTOSELECTBLE_OFFSET))(this, a1);
		}
		...
		::System::Void Method_6_C48187169E33825B(::Class_0_16E4307DCC419505_401* a1, ::System::Boolean a2, ::System::Boolean a3)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_401*, ::System::Boolean, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_C48187169E33825B_OFFSET))(this, a1, a2, a3);
		}
		...
		::Class_0_16E4307DCC419505_402* Method_6_FB44E56B032AA9DE()
		{
			return ((::Class_0_16E4307DCC419505_402*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_FB44E56B032AA9DE_OFFSET))(this);
		}
