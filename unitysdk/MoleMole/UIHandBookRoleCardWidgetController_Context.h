...
#define MOLEMOLE_UIHANDBOOKROLECARDWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1696F780)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookRoleCardWidgetController_Context_TypeDefinitionIndex = 47370;

	class UIHandBookRoleCardWidgetController_Context : public ::System::Object
	{
	public:
		::Class_2_1824EF69C8E376A3* AvatarData; // 0x10
		::System::Boolean IsShowWishListTarget; // 0x18
