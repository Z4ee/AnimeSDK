...
#define MOLEMOLE_UIMISSIONTIPSROWWIDGETCONTROLLER_CHALLENGECACHEDATA_CHALLENGECACHEDATACREATOR_OFFSET UNITYSDK_OFFSET(0x155EE560)
#define MOLEMOLE_UIMISSIONTIPSROWWIDGETCONTROLLER_CHALLENGECACHEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x155EE700)
#define MOLEMOLE_UIMISSIONTIPSROWWIDGETCONTROLLER_CHALLENGECACHEDATA_ISCONDITIONVALUECHANGE_OFFSET UNITYSDK_OFFSET(0x155EE5E0)
#define MOLEMOLE_UIMISSIONTIPSROWWIDGETCONTROLLER_CHALLENGECACHEDATA_RELEASE_OFFSET UNITYSDK_OFFSET(0x155EE800)
#define MOLEMOLE_UIMISSIONTIPSROWWIDGETCONTROLLER_CHALLENGECACHEDATA_SETDEFAULT_OFFSET UNITYSDK_OFFSET(0x155EE7B0)
#define MOLEMOLE_UIMISSIONTIPSROWWIDGETCONTROLLER_CHALLENGECACHEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x155EE910)
#define MOLEMOLE_UIMISSIONTIPSROWWIDGETCONTROLLER_CHALLENGECACHEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x155EE5D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMissionTipsRowWidgetController_ChallengeCacheData_TypeDefinitionIndex = 40292;
	...
	public:
		...
		{
			return (::Foundation::ObjectPool_1<::MoleMole::UIMissionTipsRowWidgetController_ChallengeCacheData*>**)Il2CppClass::FromTypeDefinitionIndex(UIMissionTipsRowWidgetController_ChallengeCacheData_TypeDefinitionIndex)->GetStaticField(0x48960);
		}
		::Class_0_16E4307DCC419505_192* condition; // 0x10
		::UnityEngine::UI::Extension::UILocalizationText* lt; // 0x18
