...
#define MOLEMOLE_ITEMRARITYCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x107F95C0)

namespace MoleMole
{
	inline static constexpr unsigned int ItemRarityConfigs_TypeDefinitionIndex = 86052;
