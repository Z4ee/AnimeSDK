...
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__ROUNDEND_D__331_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x75E490)
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__ROUNDEND_D__331_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2661E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooPageController__RoundEnd_d__331_TypeDefinitionIndex = 75525;
