...
#define MOLEMOLE_SCENEOBJECT_MAINCITYCURVEMOVE_ANIMATION_GET_COLLIDEREVENTMODE_OFFSET UNITYSDK_OFFSET(0x126515A0)
#define MOLEMOLE_SCENEOBJECT_MAINCITYCURVEMOVE_ANIMATION_GET_FLOORINFOLIST_OFFSET UNITYSDK_OFFSET(0x12651570)
#define MOLEMOLE_SCENEOBJECT_MAINCITYCURVEMOVE_ANIMATION_GET_NPCACTIONSTATEINFOLIST_OFFSET UNITYSDK_OFFSET(0x12651580)
#define MOLEMOLE_SCENEOBJECT_MAINCITYCURVEMOVE_ANIMATION_GET_SCENEOBJACTIONSTATEINFOLIST_OFFSET UNITYSDK_OFFSET(0x12651590)
#define MOLEMOLE_SCENEOBJECT_MAINCITYCURVEMOVE_ANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x126515B0)

namespace MoleMole
{
	inline static constexpr unsigned int SceneObject_MainCityCurveMove_Animation_TypeDefinitionIndex = 49312;
