...
#define MOLEMOLE_SCENEOBJECT_MAINCITYCURVEMOVE_ANIMATION_GET_COLLIDEREVENTMODE_OFFSET UNITYSDK_OFFSET(0x13EB1CD0)
#define MOLEMOLE_SCENEOBJECT_MAINCITYCURVEMOVE_ANIMATION_GET_FLOORINFOLIST_OFFSET UNITYSDK_OFFSET(0x13EB1CA0)
#define MOLEMOLE_SCENEOBJECT_MAINCITYCURVEMOVE_ANIMATION_GET_NPCACTIONSTATEINFOLIST_OFFSET UNITYSDK_OFFSET(0x13EB1CB0)
#define MOLEMOLE_SCENEOBJECT_MAINCITYCURVEMOVE_ANIMATION_GET_SCENEOBJACTIONSTATEINFOLIST_OFFSET UNITYSDK_OFFSET(0x13EB1CC0)
#define MOLEMOLE_SCENEOBJECT_MAINCITYCURVEMOVE_ANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x13EB1CE0)

namespace MoleMole
{
	inline static constexpr unsigned int SceneObject_MainCityCurveMove_Animation_TypeDefinitionIndex = 47657;
