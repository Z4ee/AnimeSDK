...
#define MOLEMOLE_UITIMEREGIONSWITCHING_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x122C38F0)
#define MOLEMOLE_UITIMEREGIONSWITCHING__CTOR_OFFSET UNITYSDK_OFFSET(0x122C38B0)
#define MOLEMOLE_UITIMEREGIONSWITCHING___BASE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x122C3A50)

namespace MoleMole
{
	inline static constexpr unsigned int UITimeRegionSwitching_TypeDefinitionIndex = 52651;
