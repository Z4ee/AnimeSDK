...
#define MOLEMOLE_UITIMEREGIONSWITCHING_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x11A00180)
#define MOLEMOLE_UITIMEREGIONSWITCHING__CTOR_OFFSET UNITYSDK_OFFSET(0x11A00140)
#define MOLEMOLE_UITIMEREGIONSWITCHING___BASE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x11A002E0)

namespace MoleMole
{
	inline static constexpr unsigned int UITimeRegionSwitching_TypeDefinitionIndex = 66474;
