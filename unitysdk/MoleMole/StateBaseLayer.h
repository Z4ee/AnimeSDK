...
#define MOLEMOLE_STATEBASELAYER_METHOD_4_2DB8CABC5F9281CC_OFFSET UNITYSDK_OFFSET(0x13AD7990)
#define MOLEMOLE_STATEBASELAYER_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x13AD7630)
#define MOLEMOLE_STATEBASELAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x13AD7930)

namespace MoleMole
{
	inline static constexpr unsigned int StateBaseLayer_TypeDefinitionIndex = 88834;
