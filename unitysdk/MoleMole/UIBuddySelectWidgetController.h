...
#define MOLEMOLE_UIBUDDYSELECTWIDGETCONTROLLER_GETMULTIRAW_OFFSET UNITYSDK_OFFSET(0x18C98B10)
#define MOLEMOLE_UIBUDDYSELECTWIDGETCONTROLLER_INITSLOT_OFFSET UNITYSDK_OFFSET(0x18C98D10)
#define MOLEMOLE_UIBUDDYSELECTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18C99AB0)
#define MOLEMOLE_UIBUDDYSELECTWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x18C994F0)
#define MOLEMOLE_UIBUDDYSELECTWIDGETCONTROLLER_ONMULTIBUILDDONE_OFFSET UNITYSDK_OFFSET(0x18C99A30)
#define MOLEMOLE_UIBUDDYSELECTWIDGETCONTROLLER_ONMULTISELECT_OFFSET UNITYSDK_OFFSET(0x18C987B0)
#define MOLEMOLE_UIBUDDYSELECTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18C98C10)
#define MOLEMOLE_UIBUDDYSELECTWIDGETCONTROLLER_ONSINGLERTBUILDDONE_OFFSET UNITYSDK_OFFSET(0x18C99A70)
#define MOLEMOLE_UIBUDDYSELECTWIDGETCONTROLLER_ONSINGLESELECT_OFFSET UNITYSDK_OFFSET(0x18C980B0)
#define MOLEMOLE_UIBUDDYSELECTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18C99B40)
#define MOLEMOLE_UIBUDDYSELECTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18C97E70)
#define MOLEMOLE_UIBUDDYSELECTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18C98BA0)
#define MOLEMOLE_UIBUDDYSELECTWIDGETCONTROLLER_OPENBUDDYSELECT_OFFSET UNITYSDK_OFFSET(0x18C995C0)
#define MOLEMOLE_UIBUDDYSELECTWIDGETCONTROLLER_PROCESSUIAVATAR_OFFSET UNITYSDK_OFFSET(0x18C98060)
#define MOLEMOLE_UIBUDDYSELECTWIDGETCONTROLLER_SETBUDDYSELECTSTATE_OFFSET UNITYSDK_OFFSET(0x18C985E0)
#define MOLEMOLE_UIBUDDYSELECTWIDGETCONTROLLER_SETMULTISELECT_OFFSET UNITYSDK_OFFSET(0x18C98860)
#define MOLEMOLE_UIBUDDYSELECTWIDGETCONTROLLER_SETSINGLESELECT_OFFSET UNITYSDK_OFFSET(0x18C98330)
#define MOLEMOLE_UIBUDDYSELECTWIDGETCONTROLLER_SHOWINITBUDDY_OFFSET UNITYSDK_OFFSET(0x18C98F20)
#define MOLEMOLE_UIBUDDYSELECTWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18C99CB0)
#define MOLEMOLE_UIBUDDYSELECTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18C99C50)
#define MOLEMOLE_UIBUDDYSELECTWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0x18C99CC0)
#define MOLEMOLE_UIBUDDYSELECTWIDGETCONTROLLER__OPENBUDDYSELECT_B__12_0_OFFSET UNITYSDK_OFFSET(0x18C99D20)
#define MOLEMOLE_UIBUDDYSELECTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18C99D30)
#define MOLEMOLE_UIBUDDYSELECTWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x18C99DC0)
#define MOLEMOLE_UIBUDDYSELECTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18C99E50)
#define MOLEMOLE_UIBUDDYSELECTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18C99EF0)
#define MOLEMOLE_UIBUDDYSELECTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18C99F80)
#define MOLEMOLE_UIBUDDYSELECTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18C9A010)

namespace MoleMole
{
	inline static constexpr unsigned int UIBuddySelectWidgetController_TypeDefinitionIndex = 48100;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UIBuddySelectWidgetController_TypeDefinitionIndex)->GetStaticField(0xDC10);
		}
