...
#define MOLEMOLE_UIBABELROLECARDWIDGETCONTROLLER_HIDEALL_OFFSET UNITYSDK_OFFSET(0x17A46930)
#define MOLEMOLE_UIBABELROLECARDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17A45040)
#define MOLEMOLE_UIBABELROLECARDWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x17A46D60)
#define MOLEMOLE_UIBABELROLECARDWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17A46CA0)
#define MOLEMOLE_UIBABELROLECARDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17A450D0)
#define MOLEMOLE_UIBABELROLECARDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17A44C60)
#define MOLEMOLE_UIBABELROLECARDWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x17A455C0)
#define MOLEMOLE_UIBABELROLECARDWIDGETCONTROLLER_SETAVATARSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x17A45310)
#define MOLEMOLE_UIBABELROLECARDWIDGETCONTROLLER_SETBTNCLICKEDACTION_OFFSET UNITYSDK_OFFSET(0x17A44FB0)
#define MOLEMOLE_UIBABELROLECARDWIDGETCONTROLLER_SETFOCUSSTATE_OFFSET UNITYSDK_OFFSET(0x17A453C0)
#define MOLEMOLE_UIBABELROLECARDWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x17A46F90)
#define MOLEMOLE_UIBABELROLECARDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17A46F20)
#define MOLEMOLE_UIBABELROLECARDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17A46FA0)
#define MOLEMOLE_UIBABELROLECARDWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x17A47030)
#define MOLEMOLE_UIBABELROLECARDWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17A470C0)
#define MOLEMOLE_UIBABELROLECARDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17A47160)
#define MOLEMOLE_UIBABELROLECARDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17A471F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabelRoleCardWidgetController_TypeDefinitionIndex = 40387;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIBabelRoleCardWidgetController_TypeDefinitionIndex)->GetStaticField(0x13020);
		}
		::Class_2_79AE422BA06F6D26_13* _view; // 0x2F0
