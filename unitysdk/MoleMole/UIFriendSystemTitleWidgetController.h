...
#define MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER_GET_HASTITLE_OFFSET UNITYSDK_OFFSET(0x17633160)
#define MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17632EA0)
#define MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17632F10)
#define MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17632FB0)
#define MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER_REFRESHPLAYERTITLE_OFFSET UNITYSDK_OFFSET(0x17633340)
#define MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER_REFRESHSELFTITLE_OFFSET UNITYSDK_OFFSET(0x176332A0)
#define MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17633420)
#define MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17633480)
#define MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17633520)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendSystemTitleWidgetController_TypeDefinitionIndex = 69721;
