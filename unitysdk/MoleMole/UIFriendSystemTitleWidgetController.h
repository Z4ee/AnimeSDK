...
#define MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER_GET_HASTITLE_OFFSET UNITYSDK_OFFSET(0x18584F90)
#define MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18584CC0)
#define MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18584D30)
#define MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18584DD0)
#define MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER_REFRESHPLAYERTITLE_OFFSET UNITYSDK_OFFSET(0x18585170)
#define MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER_REFRESHSELFTITLE_OFFSET UNITYSDK_OFFSET(0x185850D0)
#define MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18585250)
#define MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x185852B0)
#define MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18585350)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendSystemTitleWidgetController_TypeDefinitionIndex = 48015;
	...
	public:
		...
		::System::Void RefreshPlayerTitle(::System::UInt32 playerAvatarId, ::Struct_2_5773E3AF07ABF14E title)
		{
			return ((::System::Void(*)(::PVOID, ::System::UInt32, ::Struct_2_5773E3AF07ABF14E))((::PBYTE)hIl2Cpp + MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER_REFRESHPLAYERTITLE_OFFSET))(this, playerAvatarId, title);
		}
