...
#define MOLEMOLE_UIGENERALHEADSLOTWIDGETCONTROLLER_BUILDVIEWMODELDATABINDING_OFFSET UNITYSDK_OFFSET(0x1A30DA70)
#define MOLEMOLE_UIGENERALHEADSLOTWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A30D810)
#define MOLEMOLE_UIGENERALHEADSLOTWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A30D880)
#define MOLEMOLE_UIGENERALHEADSLOTWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1A30DD90)
#define MOLEMOLE_UIGENERALHEADSLOTWIDGETCONTROLLER_SETHEADSLOTVIEW_OFFSET UNITYSDK_OFFSET(0x1A30D990)
#define MOLEMOLE_UIGENERALHEADSLOTWIDGETCONTROLLER__BUILDVIEWMODELDATABINDING_B__7_0_OFFSET UNITYSDK_OFFSET(0x1A30DE60)
#define MOLEMOLE_UIGENERALHEADSLOTWIDGETCONTROLLER__BUILDVIEWMODELDATABINDING_B__7_1_OFFSET UNITYSDK_OFFSET(0x1A30DFE0)
#define MOLEMOLE_UIGENERALHEADSLOTWIDGETCONTROLLER__BUILDVIEWMODELDATABINDING_B__7_2_OFFSET UNITYSDK_OFFSET(0x1A30E170)
#define MOLEMOLE_UIGENERALHEADSLOTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A30DE50)
#define MOLEMOLE_UIGENERALHEADSLOTWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A30E300)
#define MOLEMOLE_UIGENERALHEADSLOTWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1A30E3A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralHeadSlotWidgetController_TypeDefinitionIndex = 70372;

	class UIGeneralHeadSlotWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_984AA59ECF07A77D* _headSlotView; // 0x2F0
		...
		::System::Void SetHeadSlotView(::Class_2_984AA59ECF07A77D* headSlotView)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_984AA59ECF07A77D*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGENERALHEADSLOTWIDGETCONTROLLER_SETHEADSLOTVIEW_OFFSET))(this, headSlotView);
		}
