...
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x172F5BC0)
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x172F5CD0)
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x172F5C50)
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x172F5B60)
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER_SHOWTIPS_OFFSET UNITYSDK_OFFSET(0x172F63A0)
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x172F6410)
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x172F6420)
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x172F64B0)
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x172F6550)
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x172F65E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGroceryActivityIconCardWidgetController_TypeDefinitionIndex = 82018;
	...
	public:
		...
		::Class_1_47F263CB5C51B1A3_2* refRewardData; // 0x2F8
