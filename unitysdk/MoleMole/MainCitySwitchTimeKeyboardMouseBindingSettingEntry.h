...
#define MOLEMOLE_MAINCITYSWITCHTIMEKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x16053DE0)
#define MOLEMOLE_MAINCITYSWITCHTIMEKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x16053DF0)
#define MOLEMOLE_MAINCITYSWITCHTIMEKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x16053E00)

namespace MoleMole
{
	inline static constexpr unsigned int MainCitySwitchTimeKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 43548;
