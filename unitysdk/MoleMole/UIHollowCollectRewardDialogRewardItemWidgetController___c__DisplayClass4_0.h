...
#define MOLEMOLE_UIHOLLOWCOLLECTREWARDDIALOGREWARDITEMWIDGETCONTROLLER___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0x186D3360)
#define MOLEMOLE_UIHOLLOWCOLLECTREWARDDIALOGREWARDITEMWIDGETCONTROLLER___C__DISPLAYCLASS4_0__ONCLICKSWEEP_B__5_OFFSET UNITYSDK_OFFSET(0x186D3370)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCollectRewardDialogRewardItemWidgetController___c__DisplayClass4_0_TypeDefinitionIndex = 49618;
