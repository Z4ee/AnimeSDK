...
#define MOLEMOLE_UIHARDCOREBOSSBATTLEHISTORYROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x169046D0)
#define MOLEMOLE_UIHARDCOREBOSSBATTLEHISTORYROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16904740)
#define MOLEMOLE_UIHARDCOREBOSSBATTLEHISTORYROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x169047E0)
#define MOLEMOLE_UIHARDCOREBOSSBATTLEHISTORYROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16904980)
#define MOLEMOLE_UIHARDCOREBOSSBATTLEHISTORYROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16904990)
#define MOLEMOLE_UIHARDCOREBOSSBATTLEHISTORYROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16904A30)

namespace MoleMole
{
	inline static constexpr unsigned int UIHardCoreBossBattleHistoryRowWidgetController_TypeDefinitionIndex = 43803;
