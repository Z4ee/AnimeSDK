...
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER_BINDVIEW_1_OFFSET UNITYSDK_OFFSET(0x18721CF0)
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER_BINDVIEW_OFFSET UNITYSDK_OFFSET(0x18721B20)
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER_CHECKSTAGE_OFFSET UNITYSDK_OFFSET(0x18722F80)
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER_GETTIPSTEXT_OFFSET UNITYSDK_OFFSET(0x187224C0)
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER_GET__ISUIACTIVE_OFFSET UNITYSDK_OFFSET(0x187217A0)
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER_GET__ISUIVALID_OFFSET UNITYSDK_OFFSET(0x187214F0)
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER_HIDEPERSISTENTTIPS_OFFSET UNITYSDK_OFFSET(0x18721EA0)
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x187231D0)
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18721940)
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x187219D0)
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18721830)
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER_REFRESHTIPS_OFFSET UNITYSDK_OFFSET(0x187220E0)
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER_RESETSIZE_OFFSET UNITYSDK_OFFSET(0x18722800)
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER_SCHEDULEAUTOHIDE_OFFSET UNITYSDK_OFFSET(0x18722EA0)
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER_SETPERSISTENTTIPS_OFFSET UNITYSDK_OFFSET(0x18721D40)
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER_SHOWPERSISTENTTIPS_OFFSET UNITYSDK_OFFSET(0x18721FE0)
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER_SHOWTIPS_OFFSET UNITYSDK_OFFSET(0x187225B0)
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER_STOPSIZEANIMATION_OFFSET UNITYSDK_OFFSET(0x18721A80)
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER_UPDATECONTENTFADEINANIMATION_OFFSET UNITYSDK_OFFSET(0x18722B60)
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER_UPDATECONTENTFADEOUTANIMATION_OFFSET UNITYSDK_OFFSET(0x18722150)
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER_UPDATEPERSISTENTTIPSDISPLAY_OFFSET UNITYSDK_OFFSET(0x18721E20)
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x187233E0)
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER__HIDEPERSISTENTTIPS_B__27_0_OFFSET UNITYSDK_OFFSET(0x18723970)
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x187239D0)
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18723A60)
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18723AF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIABInLevelTipsWidgetController_TypeDefinitionIndex = 49123;
