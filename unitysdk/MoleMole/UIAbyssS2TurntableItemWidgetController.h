...
#define MOLEMOLE_UIABYSSS2TURNTABLEITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x190D8980)
#define MOLEMOLE_UIABYSSS2TURNTABLEITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x190D8170)
#define MOLEMOLE_UIABYSSS2TURNTABLEITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x190D8A10)
#define MOLEMOLE_UIABYSSS2TURNTABLEITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x190D8090)
#define MOLEMOLE_UIABYSSS2TURNTABLEITEMWIDGETCONTROLLER_SETGETSTATUS_OFFSET UNITYSDK_OFFSET(0x190D8910)
#define MOLEMOLE_UIABYSSS2TURNTABLEITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x190D8A90)
#define MOLEMOLE_UIABYSSS2TURNTABLEITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x190D8AA0)
#define MOLEMOLE_UIABYSSS2TURNTABLEITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x190D8B30)
#define MOLEMOLE_UIABYSSS2TURNTABLEITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x190D8BD0)
#define MOLEMOLE_UIABYSSS2TURNTABLEITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x190D8C60)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2TurntableItemWidgetController_TypeDefinitionIndex = 66059;
