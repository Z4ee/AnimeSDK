...
#define MOLEMOLE_UIACTIVITYVIDEOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18C61D70)
#define MOLEMOLE_UIACTIVITYVIDEOWIDGETCONTROLLER_ONDETAILBTNCLICK_OFFSET UNITYSDK_OFFSET(0x18C625F0)
#define MOLEMOLE_UIACTIVITYVIDEOWIDGETCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x18C62120)
#define MOLEMOLE_UIACTIVITYVIDEOWIDGETCONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x18C62580)
#define MOLEMOLE_UIACTIVITYVIDEOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18C61E00)
#define MOLEMOLE_UIACTIVITYVIDEOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18C61AB0)
#define MOLEMOLE_UIACTIVITYVIDEOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18C61D00)
#define MOLEMOLE_UIACTIVITYVIDEOWIDGETCONTROLLER_PLAYVIDEOFROMSTART_OFFSET UNITYSDK_OFFSET(0x18C61EE0)
#define MOLEMOLE_UIACTIVITYVIDEOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18C62B20)
#define MOLEMOLE_UIACTIVITYVIDEOWIDGETCONTROLLER__ONDETAILBTNCLICK_B__12_0_OFFSET UNITYSDK_OFFSET(0x18C62B80)
#define MOLEMOLE_UIACTIVITYVIDEOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18C62BF0)
#define MOLEMOLE_UIACTIVITYVIDEOWIDGETCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x18C62C80)
#define MOLEMOLE_UIACTIVITYVIDEOWIDGETCONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x18C62D10)
#define MOLEMOLE_UIACTIVITYVIDEOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18C62DA0)
#define MOLEMOLE_UIACTIVITYVIDEOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18C62E30)
#define MOLEMOLE_UIACTIVITYVIDEOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18C62EC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityVideoWidgetController_TypeDefinitionIndex = 79675;
