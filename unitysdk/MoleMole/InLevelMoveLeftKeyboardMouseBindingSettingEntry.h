...
#define MOLEMOLE_INLEVELMOVELEFTKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x17816FC0)
#define MOLEMOLE_INLEVELMOVELEFTKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x17816FD0)
#define MOLEMOLE_INLEVELMOVELEFTKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x17816FE0)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelMoveLeftKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 60295;
