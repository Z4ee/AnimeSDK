...
#define MOLEMOLE_UIVRBATTLERESULTRECORDROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15C42410)
#define MOLEMOLE_UIVRBATTLERESULTRECORDROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15C424A0)
#define MOLEMOLE_UIVRBATTLERESULTRECORDROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15C422B0)
#define MOLEMOLE_UIVRBATTLERESULTRECORDROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15C42310)
#define MOLEMOLE_UIVRBATTLERESULTRECORDROWWIDGETCONTROLLER_REFRESHWIDGET_OFFSET UNITYSDK_OFFSET(0x15C42520)
#define MOLEMOLE_UIVRBATTLERESULTRECORDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15C42750)
#define MOLEMOLE_UIVRBATTLERESULTRECORDROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15C427B0)
#define MOLEMOLE_UIVRBATTLERESULTRECORDROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15C42840)
#define MOLEMOLE_UIVRBATTLERESULTRECORDROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15C428D0)
#define MOLEMOLE_UIVRBATTLERESULTRECORDROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15C42960)

namespace MoleMole
{
	inline static constexpr unsigned int UIVRBattleResultRecordRowWidgetController_TypeDefinitionIndex = 85201;
