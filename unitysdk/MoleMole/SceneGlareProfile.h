...
#define MOLEMOLE_SCENEGLAREPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x199879B0)
#define MOLEMOLE_SCENEGLAREPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x19987AF0)
#define MOLEMOLE_SCENEGLAREPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x199878D0)
#define MOLEMOLE_SCENEGLAREPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x19987A70)
#define MOLEMOLE_SCENEGLAREPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x199878C0)
#define MOLEMOLE_SCENEGLAREPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x19987C10)
#define MOLEMOLE_SCENEGLAREPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x19987CA0)
#define MOLEMOLE_SCENEGLAREPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x19987D30)
#define MOLEMOLE_SCENEGLAREPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x19987DC0)

namespace MoleMole
{
	inline static constexpr unsigned int SceneGlareProfile_TypeDefinitionIndex = 44242;
