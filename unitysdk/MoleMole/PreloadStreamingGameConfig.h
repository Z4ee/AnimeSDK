...
#define MOLEMOLE_PRELOADSTREAMINGGAMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x173A1680)

namespace MoleMole
{
	inline static constexpr unsigned int PreloadStreamingGameConfig_TypeDefinitionIndex = 74549;
