...
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER_CLEARMATERIALS_OFFSET UNITYSDK_OFFSET(0x177AE1A0)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER_INITCHOICEOBJ_OFFSET UNITYSDK_OFFSET(0x177AE460)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x177AE110)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x177AFAF0)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x177AD890)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x177AD8F0)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER_PLAYFRAMETEXTUREFAIRY_OFFSET UNITYSDK_OFFSET(0x177AF7F0)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER_REBUILD_OFFSET UNITYSDK_OFFSET(0x177AF650)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x177AD9E0)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x177AF780)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x177AFC70)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x177AFDE0)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x177AFE70)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x177AFF00)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x177AFF90)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMiniEventWidgetController_TypeDefinitionIndex = 44905;
