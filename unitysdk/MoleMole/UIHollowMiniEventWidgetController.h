...
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER_CLEARMATERIALS_OFFSET UNITYSDK_OFFSET(0x14FD7980)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER_INITCHOICEOBJ_OFFSET UNITYSDK_OFFSET(0x14FD7C40)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14FD78F0)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14FD92E0)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14FD7070)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14FD70D0)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER_PLAYFRAMETEXTUREFAIRY_OFFSET UNITYSDK_OFFSET(0x14FD8FD0)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER_REBUILD_OFFSET UNITYSDK_OFFSET(0x14FD8E30)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x14FD71C0)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x14FD8F60)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14FD9460)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14FD95D0)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14FD9660)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14FD96F0)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14FD9780)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMiniEventWidgetController_TypeDefinitionIndex = 50737;
	...
	public:
		...
		::Class_2_2019B3C14943B358* _view; // 0x2B8
		::MoleMole::UIHollowMiniEventWidgetController_Context* _context; // 0x2C0
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::Class_1_6C2E46293F2AE988*>* uiFrameTextureSheetPlayer; // 0x2C8
		::System::Single _refreshCDTimer; // 0x2D0
		::System::Collections::Generic::List_1<::UnityEngine::Material*>* loadImgsMaterials; // 0x2D8
		::Class_1_0AEBFEBDADDA07AC* _serverInfo; // 0x2E0
		::Enum_3_BF73F764A6192785 State; // 0x2E8
