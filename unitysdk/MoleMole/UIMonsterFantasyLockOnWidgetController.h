...
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER_GET_ISTARGETINVIEWPORT_OFFSET UNITYSDK_OFFSET(0x155F7CF0)
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x155F7C80)
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x155F7FE0)
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER_ISINVIEWPORT_OFFSET UNITYSDK_OFFSET(0x155F9160)
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x155F89D0)
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x155F8220)
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x155F87F0)
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER_ONUNITSELECTED_OFFSET UNITYSDK_OFFSET(0x155F9CC0)
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER_ONUNITTURNSTART_OFFSET UNITYSDK_OFFSET(0x155F9A20)
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x155F9FC0)
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER__INITAUTODISPOSEDATABIND_B__12_0_OFFSET UNITYSDK_OFFSET(0x155FA020)
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER__ONCREATEVIEWMODEL_B__13_0_OFFSET UNITYSDK_OFFSET(0x155FA220)
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x155FA440)
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x155FA4D0)
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x155FA570)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyLockOnWidgetController_TypeDefinitionIndex = 41652;

	class UIMonsterFantasyLockOnWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_4_3D4EFA6B3CC691CC* _ctx; // 0x2C0
