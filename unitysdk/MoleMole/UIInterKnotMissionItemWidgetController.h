...
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x19A03230)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_ISNEW_OFFSET UNITYSDK_OFFSET(0x19A04270)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19A03620)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_ONMANUALADD_OFFSET UNITYSDK_OFFSET(0x19A03C50)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_ONTRACKQUESTUPDATE_OFFSET UNITYSDK_OFFSET(0x19A038E0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19A036B0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19A03250)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19A035B0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_PLAYSELECT_OFFSET UNITYSDK_OFFSET(0x19A03DA0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_READNEW_OFFSET UNITYSDK_OFFSET(0x19A042D0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_REFRESHNEW_OFFSET UNITYSDK_OFFSET(0x19A03CA0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_REFRESHTRACK_OFFSET UNITYSDK_OFFSET(0x19A03930)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x19A04490)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_REGISTERCLICKCB_OFFSET UNITYSDK_OFFSET(0x19A03D50)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_RESELECT_OFFSET UNITYSDK_OFFSET(0x19A041D0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_SETINDEX_OFFSET UNITYSDK_OFFSET(0x19A047B0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_SETNAMETEXT_OFFSET UNITYSDK_OFFSET(0x19A03FC0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_SETSELECT_OFFSET UNITYSDK_OFFSET(0x19A03F50)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x19A03240)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_TRIGGERBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x19A04310)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19A048D0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19A04870)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER__ONUIINIT_B__8_0_OFFSET UNITYSDK_OFFSET(0x19A04920)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER__REFRESHTRACK_G__SETTRACKED_26_0_OFFSET UNITYSDK_OFFSET(0x19A04800)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19A04980)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19A04A10)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19A04AA0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19A04B30)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotMissionItemWidgetController_TypeDefinitionIndex = 53942;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInterKnotMissionItemWidgetController_TypeDefinitionIndex)->GetStaticField(0x10860);
		}
		static ::System::Int32* StaticGet_RampColorA()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInterKnotMissionItemWidgetController_TypeDefinitionIndex)->GetStaticField(0x10864);
		}
		::Class_2_F9471F3BB5949932_10* _view; // 0x2C0
