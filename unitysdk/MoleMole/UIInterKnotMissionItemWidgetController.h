...
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x186FF0A0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_ISNEW_OFFSET UNITYSDK_OFFSET(0x187000B0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x186FF480)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_ONMANUALADD_OFFSET UNITYSDK_OFFSET(0x186FFAA0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_ONTRACKQUESTUPDATE_OFFSET UNITYSDK_OFFSET(0x186FF740)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x186FF510)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x186FF0C0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x186FF410)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_PLAYSELECT_OFFSET UNITYSDK_OFFSET(0x186FFBF0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_READNEW_OFFSET UNITYSDK_OFFSET(0x18700110)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_REFRESHNEW_OFFSET UNITYSDK_OFFSET(0x186FFAF0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_REFRESHTRACK_OFFSET UNITYSDK_OFFSET(0x186FF790)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x187002D0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_REGISTERCLICKCB_OFFSET UNITYSDK_OFFSET(0x186FFBA0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_RESELECT_OFFSET UNITYSDK_OFFSET(0x18700010)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_SETINDEX_OFFSET UNITYSDK_OFFSET(0x187005F0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_SETNAMETEXT_OFFSET UNITYSDK_OFFSET(0x186FFE10)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_SETSELECT_OFFSET UNITYSDK_OFFSET(0x186FFDA0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x186FF0B0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_TRIGGERBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x18700150)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18700710)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x187006B0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER__ONUIINIT_B__8_0_OFFSET UNITYSDK_OFFSET(0x18700760)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER__REFRESHTRACK_G__SETTRACKED_26_0_OFFSET UNITYSDK_OFFSET(0x18700640)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x187007C0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18700850)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x187008E0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18700970)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotMissionItemWidgetController_TypeDefinitionIndex = 83867;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInterKnotMissionItemWidgetController_TypeDefinitionIndex)->GetStaticField(0x103A0);
		}
		static ::System::Int32* StaticGet_RampColorB()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInterKnotMissionItemWidgetController_TypeDefinitionIndex)->GetStaticField(0x103A4);
		}
		::Class_2_79AE422BA06F6D26_164* _view; // 0x2C0
		::MoleMole::UIInterKnotPageConfig* _Config_k__BackingField; // 0x2C8
		::MoleMole::UIInterKnotPageConfig_MainCityQuestTypeRowConfig* _rowConfig; // 0x2D0
		::DG::Tweening::Tweener* tweener; // 0x2D8
		...
		::Class_1_2181504E881DDEE4* _manual; // 0x300
