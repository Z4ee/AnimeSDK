...
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ATLEASTONETABUNLOCK_OFFSET UNITYSDK_OFFSET(0x18C3F480)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_BACKTOMAIN_OFFSET UNITYSDK_OFFSET(0x18C40440)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_BIND_OFFSET UNITYSDK_OFFSET(0x18C3E810)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_GETTABID_OFFSET UNITYSDK_OFFSET(0x18C3FBE0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_GETTABNAME_OFFSET UNITYSDK_OFFSET(0x18C3FA40)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_GETTABUNLOCKID_OFFSET UNITYSDK_OFFSET(0x18C3FD50)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x18C3E460)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_HASTABCONTENT_OFFSET UNITYSDK_OFFSET(0x18C3F620)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ISTABUNLOCK_OFFSET UNITYSDK_OFFSET(0x18C3F910)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONCLICKTABBTN_OFFSET UNITYSDK_OFFSET(0x18C40560)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18C3E470)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONGAMEPADMODULEDESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x18C40370)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x18C3FF70)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x18C40010)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x18C400B0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x18C3F230)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18C3F3F0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18C3E500)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_SORTTAB_OFFSET UNITYSDK_OFFSET(0x18C3E9D0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18C40AE0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18C40B90)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONGAMEPADMODULEDESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x18C40C20)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x18C40CD0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x18C40D60)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x18C40DF0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x18C40EA0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18C40ED0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18C40EE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivePropsPageController_TypeDefinitionIndex = 73777;

	class UIActivePropsPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_11* _view; // 0x318
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_276*>* iniItemTemplates; // 0x320
