...
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ATLEASTONETABUNLOCK_OFFSET UNITYSDK_OFFSET(0x1B23CE30)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_BACKTOMAIN_OFFSET UNITYSDK_OFFSET(0x1B23DDE0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_BIND_OFFSET UNITYSDK_OFFSET(0x1B23C1B0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_GETTABID_OFFSET UNITYSDK_OFFSET(0x1B23D580)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_GETTABNAME_OFFSET UNITYSDK_OFFSET(0x1B23D3F0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_GETTABUNLOCKID_OFFSET UNITYSDK_OFFSET(0x1B23D6F0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1B23BE00)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_HASTABCONTENT_OFFSET UNITYSDK_OFFSET(0x1B23CFD0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ISTABUNLOCK_OFFSET UNITYSDK_OFFSET(0x1B23D2C0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONCLICKTABBTN_OFFSET UNITYSDK_OFFSET(0x1B23DF00)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1B23BE10)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONGAMEPADMODULEDESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x1B23DD10)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x1B23D910)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x1B23D9B0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x1B23DA50)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1B23CBE0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1B23CDA0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1B23BEA0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_SORTTAB_OFFSET UNITYSDK_OFFSET(0x1B23C370)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B23E470)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1B23E520)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONGAMEPADMODULEDESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x1B23E5B0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x1B23E660)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x1B23E6F0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x1B23E780)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1B23E830)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1B23E860)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1B23E870)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivePropsPageController_TypeDefinitionIndex = 44049;

	class UIActivePropsPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_39* _view; // 0x318
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_534*>* iniItemTemplates; // 0x320
		::System::Int32 _curSelect; // 0x328
		::MoleMole::UIActivePropsItemIconWidgetController* _lastSelectItemCtrl; // 0x330
		::System::Collections::Generic::Dictionary_2<::System::String*, ::Class_1_2BEA9D62D0D61789*>* widgets; // 0x338
		::Class_1_2BEA9D62D0D61789* currentOpenWiget; // 0x340
		::System::Collections::Generic::List_1<::UnityEngine::UI::Extension::UITabButton*>* _tabButtons; // 0x348
		::System::Collections::Generic::List_1<::MoleMole::NotificationBadge*>* _tabNotificationBadges; // 0x350
