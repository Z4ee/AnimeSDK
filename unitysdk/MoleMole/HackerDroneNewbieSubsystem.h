...
#define MOLEMOLE_HACKERDRONENEWBIESUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x19B27BE0)
#define MOLEMOLE_HACKERDRONENEWBIESUBSYSTEM_ONBUTTONDOWN_OFFSET UNITYSDK_OFFSET(0x19B28880)
#define MOLEMOLE_HACKERDRONENEWBIESUBSYSTEM_ONBUTTONUP_OFFSET UNITYSDK_OFFSET(0x19B28A60)
#define MOLEMOLE_HACKERDRONENEWBIESUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19B27EC0)
#define MOLEMOLE_HACKERDRONENEWBIESUBSYSTEM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B285C0)
#define MOLEMOLE_HACKERDRONENEWBIESUBSYSTEM_REGISTERINPUTHOLD_OFFSET UNITYSDK_OFFSET(0x19B282C0)
#define MOLEMOLE_HACKERDRONENEWBIESUBSYSTEM_UNREGISTERINPUTHOLD_OFFSET UNITYSDK_OFFSET(0x19B28470)
#define MOLEMOLE_HACKERDRONENEWBIESUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x19B28C40)
#define MOLEMOLE_HACKERDRONENEWBIESUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x19B28D20)
#define MOLEMOLE_HACKERDRONENEWBIESUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19B28DB0)
#define MOLEMOLE_HACKERDRONENEWBIESUBSYSTEM___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B28E40)

namespace MoleMole
{
	inline static constexpr unsigned int HackerDroneNewbieSubsystem_TypeDefinitionIndex = 68087;

	class HackerDroneNewbieSubsystem : public ::MoleMole::GameSubsystemBaseEx_1<::MoleMole::HackerDroneNewbieSubsystem*>
	{
	public:
		::System::Action_1<::System::EventArgs*>* _onButtonDown; // 0x10
		::System::Action_1<::System::EventArgs*>* _onButtonUp; // 0x18
		::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::HackerDroneNewbieSubsystem_InputHoldEntry*>* _entries; // 0x20
		::System::Collections::Generic::List_1<::System::String*>* _pendingRemove; // 0x28
