...
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15F5A800)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER_ISITEMEQUIPPED_OFFSET UNITYSDK_OFFSET(0x15F5CB80)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER_ISITEMLEVELUP_OFFSET UNITYSDK_OFFSET(0x15F5CC60)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER_ISITEMLOCK_OFFSET UNITYSDK_OFFSET(0x15F5CA90)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER_ISITEMTRASH_OFFSET UNITYSDK_OFFSET(0x15F5CD50)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15F5BD20)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER_ONOKBTNCLICK_OFFSET UNITYSDK_OFFSET(0x15F5CE00)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER_ONRESETBTNCLICK_OFFSET UNITYSDK_OFFSET(0x15F5D0E0)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15F5BDB0)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15F5A810)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15F5AA60)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER_REFRESHITEMTYPEROW_OFFSET UNITYSDK_OFFSET(0x15F5BE20)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER_REFRESHNUM_OFFSET UNITYSDK_OFFSET(0x15F5C450)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x15F5AC60)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15F5D130)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER__REFRESHVIEW_B__20_0_OFFSET UNITYSDK_OFFSET(0x15F5D140)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER__REFRESHVIEW_B__20_1_OFFSET UNITYSDK_OFFSET(0x15F5D170)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER__REFRESHVIEW_B__20_2_OFFSET UNITYSDK_OFFSET(0x15F5D1C0)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER__REFRESHVIEW_B__20_3_OFFSET UNITYSDK_OFFSET(0x15F5D210)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER__REFRESHVIEW_B__20_4_OFFSET UNITYSDK_OFFSET(0x15F5D260)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER__REFRESHVIEW_B__20_5_OFFSET UNITYSDK_OFFSET(0x15F5D2B0)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER__REFRESHVIEW_B__20_6_OFFSET UNITYSDK_OFFSET(0x15F5D300)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER__REFRESHVIEW_B__20_7_OFFSET UNITYSDK_OFFSET(0x15F5D330)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15F5D360)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15F5D3F0)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15F5D400)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15F5D410)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuickSelectPopWindowController_TypeDefinitionIndex = 83907;

	class UIQuickSelectPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_60638234271CCDB8_64* _view; // 0x318
