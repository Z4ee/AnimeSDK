...
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE__PRELOADITEMSTAGE_D__17_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x166E63D0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE__PRELOADITEMSTAGE_D__17_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x166E6680)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE__PRELOADITEMSTAGE_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x166E66E0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE__PRELOADITEMSTAGE_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x166E6690)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE__PRELOADITEMSTAGE_D__17_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x166E63C0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE__PRELOADITEMSTAGE_D__17__CTOR_OFFSET UNITYSDK_OFFSET(0x166E63B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaStage3DModelControllerBase__PreloadItemStage_d__17_TypeDefinitionIndex = 86538;

	class UIGachaStage3DModelControllerBase__PreloadItemStage_d__17 : public ::System::Object
	{
	public:
		::System::Action* completeCb; // 0x10
		::System::Object* __2__current; // 0x18
		::MoleMole::UIGachaStage3DModelControllerBase* __4__this; // 0x20
		::Il2CppArray<::Foundation::AssetPath>* preloadAssets; // 0x28
