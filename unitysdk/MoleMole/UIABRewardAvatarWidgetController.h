...
#define MOLEMOLE_UIABREWARDAVATARWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x174124A0)
#define MOLEMOLE_UIABREWARDAVATARWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x17413030)
#define MOLEMOLE_UIABREWARDAVATARWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x17413210)
#define MOLEMOLE_UIABREWARDAVATARWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17412530)
#define MOLEMOLE_UIABREWARDAVATARWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17412FB0)
#define MOLEMOLE_UIABREWARDAVATARWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x174121D0)
#define MOLEMOLE_UIABREWARDAVATARWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17412340)
#define MOLEMOLE_UIABREWARDAVATARWIDGETCONTROLLER_REFRESHSUGGEST_OFFSET UNITYSDK_OFFSET(0x174133F0)
#define MOLEMOLE_UIABREWARDAVATARWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x174125D0)
#define MOLEMOLE_UIABREWARDAVATARWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x174134F0)
#define MOLEMOLE_UIABREWARDAVATARWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17413500)
#define MOLEMOLE_UIABREWARDAVATARWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x17413590)
#define MOLEMOLE_UIABREWARDAVATARWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x17413620)
#define MOLEMOLE_UIABREWARDAVATARWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x174136B0)
#define MOLEMOLE_UIABREWARDAVATARWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17413750)
#define MOLEMOLE_UIABREWARDAVATARWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x174137E0)
#define MOLEMOLE_UIABREWARDAVATARWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17413870)

namespace MoleMole
{
	inline static constexpr unsigned int UIABRewardAvatarWidgetController_TypeDefinitionIndex = 53786;

	class UIABRewardAvatarWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_9905A598E4B2F534_1* _view; // 0x2F0
