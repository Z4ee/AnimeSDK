...
#define MOLEMOLE_UIRABENTRYREFRESHITEMROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15F5D9B0)
#define MOLEMOLE_UIRABENTRYREFRESHITEMROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15F5DA20)
#define MOLEMOLE_UIRABENTRYREFRESHITEMROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15F5DAC0)
#define MOLEMOLE_UIRABENTRYREFRESHITEMROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15F5DC80)
#define MOLEMOLE_UIRABENTRYREFRESHITEMROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15F5DCE0)
#define MOLEMOLE_UIRABENTRYREFRESHITEMROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15F5DD80)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABEntryRefreshItemRowWidgetController_TypeDefinitionIndex = 68381;
