...
#define MOLEMOLE_UIBABELTOWERLIST02WIDGETCONTROLLER_HIDEALL_OFFSET UNITYSDK_OFFSET(0x16359F20)
#define MOLEMOLE_UIBABELTOWERLIST02WIDGETCONTROLLER_ONBABELTOWERFLOORFINISHANIMATION_OFFSET UNITYSDK_OFFSET(0x16358BD0)
#define MOLEMOLE_UIBABELTOWERLIST02WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16358AC0)
#define MOLEMOLE_UIBABELTOWERLIST02WIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x1635AD30)
#define MOLEMOLE_UIBABELTOWERLIST02WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16358FE0)
#define MOLEMOLE_UIBABELTOWERLIST02WIDGETCONTROLLER_ONSHOWBABELTOWERUNLOCK_OFFSET UNITYSDK_OFFSET(0x16359470)
#define MOLEMOLE_UIBABELTOWERLIST02WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16358B50)
#define MOLEMOLE_UIBABELTOWERLIST02WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16358850)
#define MOLEMOLE_UIBABELTOWERLIST02WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x163589B0)
#define MOLEMOLE_UIBABELTOWERLIST02WIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x16359110)
#define MOLEMOLE_UIBABELTOWERLIST02WIDGETCONTROLLER_SETCLICKFUNC_OFFSET UNITYSDK_OFFSET(0x1635AE60)
#define MOLEMOLE_UIBABELTOWERLIST02WIDGETCONTROLLER_UPDATEFLOOR_OFFSET UNITYSDK_OFFSET(0x1635A260)
#define MOLEMOLE_UIBABELTOWERLIST02WIDGETCONTROLLER_UPDATEOFFSET_OFFSET UNITYSDK_OFFSET(0x1635AA50)
#define MOLEMOLE_UIBABELTOWERLIST02WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1635AEB0)
#define MOLEMOLE_UIBABELTOWERLIST02WIDGETCONTROLLER__REFRESHNORMALVIEW_OFFSET UNITYSDK_OFFSET(0x16359580)
#define MOLEMOLE_UIBABELTOWERLIST02WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1635B0B0)
#define MOLEMOLE_UIBABELTOWERLIST02WIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x1635B140)
#define MOLEMOLE_UIBABELTOWERLIST02WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1635B1D0)
#define MOLEMOLE_UIBABELTOWERLIST02WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1635B270)
#define MOLEMOLE_UIBABELTOWERLIST02WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1635B300)
#define MOLEMOLE_UIBABELTOWERLIST02WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1635B390)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerList02WidgetController_TypeDefinitionIndex = 44523;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_89* _view; // 0x2E8
