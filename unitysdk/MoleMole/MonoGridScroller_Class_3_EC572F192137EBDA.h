...
#define MOLEMOLE_MONOGRIDSCROLLER_CLASS_3_EC572F192137EBDA_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x11D4DB40)
#define MOLEMOLE_MONOGRIDSCROLLER_CLASS_3_EC572F192137EBDA_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11D4DBC0)
#define MOLEMOLE_MONOGRIDSCROLLER_CLASS_3_EC572F192137EBDA_INVOKE_OFFSET UNITYSDK_OFFSET(0x11D4D5C0)
#define MOLEMOLE_MONOGRIDSCROLLER_CLASS_3_EC572F192137EBDA__CTOR_OFFSET UNITYSDK_OFFSET(0x11D4D5A0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGridScroller_Class_3_EC572F192137EBDA_TypeDefinitionIndex = 87763;
