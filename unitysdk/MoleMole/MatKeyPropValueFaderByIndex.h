...
#define MOLEMOLE_MATKEYPROPVALUEFADERBYINDEX_DISPOSE_OFFSET UNITYSDK_OFFSET(0x170DB6A0)
#define MOLEMOLE_MATKEYPROPVALUEFADERBYINDEX_GET_MAT_OFFSET UNITYSDK_OFFSET(0x170DB040)
#define MOLEMOLE_MATKEYPROPVALUEFADERBYINDEX_GET_MONOEFFECT_OFFSET UNITYSDK_OFFSET(0x170DB030)
#define MOLEMOLE_MATKEYPROPVALUEFADERBYINDEX_METHOD_2_128774387667156B_OFFSET UNITYSDK_OFFSET(0x170DB9B0)
#define MOLEMOLE_MATKEYPROPVALUEFADERBYINDEX_METHOD_2_3C081D06DA6B1B22_OFFSET UNITYSDK_OFFSET(0x170DB470)
#define MOLEMOLE_MATKEYPROPVALUEFADERBYINDEX_METHOD_2_5171919365955F95_OFFSET UNITYSDK_OFFSET(0x170DB4F0)
#define MOLEMOLE_MATKEYPROPVALUEFADERBYINDEX_METHOD_2_5539393F5F97D178_OFFSET UNITYSDK_OFFSET(0x170DBBD0)
#define MOLEMOLE_MATKEYPROPVALUEFADERBYINDEX_METHOD_2_8EB0B5A1956DA0FB_OFFSET UNITYSDK_OFFSET(0x170DB2C0)
#define MOLEMOLE_MATKEYPROPVALUEFADERBYINDEX_METHOD_2_ADF4AD3331B4D7AD_OFFSET UNITYSDK_OFFSET(0x170DB9F0)
#define MOLEMOLE_MATKEYPROPVALUEFADERBYINDEX_METHOD_2_C638E91FC0D3A13A_OFFSET UNITYSDK_OFFSET(0x170DBA40)
#define MOLEMOLE_MATKEYPROPVALUEFADERBYINDEX_TOSTRING_OFFSET UNITYSDK_OFFSET(0x170DB750)
#define MOLEMOLE_MATKEYPROPVALUEFADERBYINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x170DB9A0)

namespace MoleMole
{
	inline static constexpr unsigned int MatKeyPropValueFaderByIndex_TypeDefinitionIndex = 70853;
