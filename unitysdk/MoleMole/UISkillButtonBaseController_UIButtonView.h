...
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_UIBUTTONVIEW_GET_BTN_OFFSET UNITYSDK_OFFSET(0x15A28750)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_UIBUTTONVIEW_GET_BUTTONAREA_OFFSET UNITYSDK_OFFSET(0x15A289B0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_UIBUTTONVIEW_GET_BUTTONROOT_OFFSET UNITYSDK_OFFSET(0x15A28770)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_UIBUTTONVIEW_GET_MAXDRAGAREA_OFFSET UNITYSDK_OFFSET(0x15A28830)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_UIBUTTONVIEW_GET_MINDRAGAREA_OFFSET UNITYSDK_OFFSET(0x15A288F0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_UIBUTTONVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x15A28A70)

namespace MoleMole
{
	inline static constexpr unsigned int UISkillButtonBaseController_UIButtonView_TypeDefinitionIndex = 65493;
