...
#define MOLEMOLE_UIHADALZONE_IMPACTBATTLE_LINEUPWIDGETCONTROLLER___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0x157B0A10)
#define MOLEMOLE_UIHADALZONE_IMPACTBATTLE_LINEUPWIDGETCONTROLLER___C__DISPLAYCLASS12_0__OPENSELECTROLEPAGE_B__0_OFFSET UNITYSDK_OFFSET(0x157B0F20)
#define MOLEMOLE_UIHADALZONE_IMPACTBATTLE_LINEUPWIDGETCONTROLLER___C__DISPLAYCLASS12_0__OPENSELECTROLEPAGE_B__1_OFFSET UNITYSDK_OFFSET(0x157B0A20)
#define MOLEMOLE_UIHADALZONE_IMPACTBATTLE_LINEUPWIDGETCONTROLLER___C__DISPLAYCLASS12_0__OPENSELECTROLEPAGE_B__3_OFFSET UNITYSDK_OFFSET(0x157B0E20)
#define MOLEMOLE_UIHADALZONE_IMPACTBATTLE_LINEUPWIDGETCONTROLLER___C__DISPLAYCLASS12_0__OPENSELECTROLEPAGE_B__4_OFFSET UNITYSDK_OFFSET(0x157B0EA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_ImpactBattle_LineupWidgetController___c__DisplayClass12_0_TypeDefinitionIndex = 51565;
