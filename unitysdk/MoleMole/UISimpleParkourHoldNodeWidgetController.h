...
#define MOLEMOLE_UISIMPLEPARKOURHOLDNODEWIDGETCONTROLLER_GET__HOLDNODEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1533FC10)
#define MOLEMOLE_UISIMPLEPARKOURHOLDNODEWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1533FC70)
#define MOLEMOLE_UISIMPLEPARKOURHOLDNODEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1533FD10)
#define MOLEMOLE_UISIMPLEPARKOURHOLDNODEWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1533FD70)

namespace MoleMole
{
	inline static constexpr unsigned int UISimpleParkourHoldNodeWidgetController_TypeDefinitionIndex = 74810;
