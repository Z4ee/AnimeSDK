...
#define MOLEMOLE_UIINLEVELCHAINULTIMATEWIDGETCONTROLLER_GETSLOTCOLORBYINDEX_OFFSET UNITYSDK_OFFSET(0x14FE5310)
#define MOLEMOLE_UIINLEVELCHAINULTIMATEWIDGETCONTROLLER_GETTEAMINDEX_OFFSET UNITYSDK_OFFSET(0x14FE54B0)
#define MOLEMOLE_UIINLEVELCHAINULTIMATEWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x14FE4B80)
#define MOLEMOLE_UIINLEVELCHAINULTIMATEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14FE4C50)
#define MOLEMOLE_UIINLEVELCHAINULTIMATEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14FE4CE0)
#define MOLEMOLE_UIINLEVELCHAINULTIMATEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14FE4AD0)
#define MOLEMOLE_UIINLEVELCHAINULTIMATEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14FE4BE0)
#define MOLEMOLE_UIINLEVELCHAINULTIMATEWIDGETCONTROLLER_PLAYFADEINANIM_OFFSET UNITYSDK_OFFSET(0x14FE5500)
#define MOLEMOLE_UIINLEVELCHAINULTIMATEWIDGETCONTROLLER_PLAYFADEOUTANIM_OFFSET UNITYSDK_OFFSET(0x14FE4E10)
#define MOLEMOLE_UIINLEVELCHAINULTIMATEWIDGETCONTROLLER_REFRESHROLEICONIMG_OFFSET UNITYSDK_OFFSET(0x14FE5710)
#define MOLEMOLE_UIINLEVELCHAINULTIMATEWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x14FE4FD0)
#define MOLEMOLE_UIINLEVELCHAINULTIMATEWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x14FE4D60)
#define MOLEMOLE_UIINLEVELCHAINULTIMATEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14FE5990)
#define MOLEMOLE_UIINLEVELCHAINULTIMATEWIDGETCONTROLLER__PLAYFADEOUTANIM_B__9_0_OFFSET UNITYSDK_OFFSET(0x14FE5A10)
#define MOLEMOLE_UIINLEVELCHAINULTIMATEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14FE5A50)
#define MOLEMOLE_UIINLEVELCHAINULTIMATEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14FE5AE0)
#define MOLEMOLE_UIINLEVELCHAINULTIMATEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14FE5B70)
#define MOLEMOLE_UIINLEVELCHAINULTIMATEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14FE5C00)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelChainUltimateWidgetController_TypeDefinitionIndex = 61793;

	class UIInLevelChainUltimateWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_A859226CC8C47666* _view; // 0x2B8
		::System::Int32 _teamIndex; // 0x2C0
		::System::Boolean _isShow; // 0x2C4
		::Foundation::Coroutine::CoroutineHandle _fadeOutCoroutineHandle; // 0x2C8
		::System::Single _autoFadeOutTimer; // 0x2CC
		::System::String* _cachedIconPath; // 0x2D0
