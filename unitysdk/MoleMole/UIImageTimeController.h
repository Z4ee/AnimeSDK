...
#define MOLEMOLE_UIIMAGETIMECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16BDB170)
#define MOLEMOLE_UIIMAGETIMECONTROLLER_SETTIME_OFFSET UNITYSDK_OFFSET(0x16BDA570)
#define MOLEMOLE_UIIMAGETIMECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16BDB1C0)
#define MOLEMOLE_UIIMAGETIMECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16BDB270)

namespace MoleMole
{
	inline static constexpr unsigned int UIImageTimeController_TypeDefinitionIndex = 86876;
