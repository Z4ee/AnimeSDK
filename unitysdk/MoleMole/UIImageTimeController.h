...
#define MOLEMOLE_UIIMAGETIMECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15CED840)
#define MOLEMOLE_UIIMAGETIMECONTROLLER_SETTIME_OFFSET UNITYSDK_OFFSET(0x15CECC40)
#define MOLEMOLE_UIIMAGETIMECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15CED890)
#define MOLEMOLE_UIIMAGETIMECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15CED940)

namespace MoleMole
{
	inline static constexpr unsigned int UIImageTimeController_TypeDefinitionIndex = 79068;
