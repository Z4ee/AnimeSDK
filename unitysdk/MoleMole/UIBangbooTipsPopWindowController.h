...
#define MOLEMOLE_UIBANGBOOTIPSPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x172C41F0)
#define MOLEMOLE_UIBANGBOOTIPSPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x172C45A0)
#define MOLEMOLE_UIBANGBOOTIPSPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x172C4630)
#define MOLEMOLE_UIBANGBOOTIPSPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x172C4200)
#define MOLEMOLE_UIBANGBOOTIPSPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x172C4370)
#define MOLEMOLE_UIBANGBOOTIPSPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x172C46A0)
#define MOLEMOLE_UIBANGBOOTIPSPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x172C46B0)
#define MOLEMOLE_UIBANGBOOTIPSPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x172C4740)
#define MOLEMOLE_UIBANGBOOTIPSPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x172C4750)
#define MOLEMOLE_UIBANGBOOTIPSPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x172C4760)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooTipsPopWindowController_TypeDefinitionIndex = 67077;

	class UIBangbooTipsPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_FE0256D987DC2C1C* _view; // 0x318
		::Class_1_37531022BA965541* skill; // 0x320
