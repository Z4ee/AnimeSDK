...
#define MOLEMOLE_MONOUIOVERLORDFEASTLEVELCONFIG_GETCONFIGITEM_OFFSET UNITYSDK_OFFSET(0x144F8210)
#define MOLEMOLE_MONOUIOVERLORDFEASTLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x144F8360)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIOverlordFeastLevelConfig_TypeDefinitionIndex = 80989;
