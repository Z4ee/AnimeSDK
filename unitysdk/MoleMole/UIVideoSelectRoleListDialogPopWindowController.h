...
#define MOLEMOLE_UIVIDEOSELECTROLELISTDIALOGPOPWINDOWCONTROLLER_BUILDSUITMATCHFOURPIECEOWNEDLIST_OFFSET UNITYSDK_OFFSET(0x122C95D0)
#define MOLEMOLE_UIVIDEOSELECTROLELISTDIALOGPOPWINDOWCONTROLLER_BUILDSUITMATCHTWOPIECEOWNEDLIST_OFFSET UNITYSDK_OFFSET(0x122C9980)
#define MOLEMOLE_UIVIDEOSELECTROLELISTDIALOGPOPWINDOWCONTROLLER_CLEARROLEGROUP_OFFSET UNITYSDK_OFFSET(0x122C8F90)
#define MOLEMOLE_UIVIDEOSELECTROLELISTDIALOGPOPWINDOWCONTROLLER_FILLROLEGROUP_OFFSET UNITYSDK_OFFSET(0x122C9F30)
#define MOLEMOLE_UIVIDEOSELECTROLELISTDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x122C8B10)
#define MOLEMOLE_UIVIDEOSELECTROLELISTDIALOGPOPWINDOWCONTROLLER_ONANYROWCLICK_OFFSET UNITYSDK_OFFSET(0x122CB560)
#define MOLEMOLE_UIVIDEOSELECTROLELISTDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x122C8E70)
#define MOLEMOLE_UIVIDEOSELECTROLELISTDIALOGPOPWINDOWCONTROLLER_ONSETTARGETBTNCLICK_OFFSET UNITYSDK_OFFSET(0x122CB8A0)
#define MOLEMOLE_UIVIDEOSELECTROLELISTDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x122C8F00)
#define MOLEMOLE_UIVIDEOSELECTROLELISTDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x122C8B20)
#define MOLEMOLE_UIVIDEOSELECTROLELISTDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x122C8CE0)
#define MOLEMOLE_UIVIDEOSELECTROLELISTDIALOGPOPWINDOWCONTROLLER_PADTOROWSIZE_OFFSET UNITYSDK_OFFSET(0x122C9D30)
#define MOLEMOLE_UIVIDEOSELECTROLELISTDIALOGPOPWINDOWCONTROLLER_PICKDEFAULTSELECTION_OFFSET UNITYSDK_OFFSET(0x122CA220)
#define MOLEMOLE_UIVIDEOSELECTROLELISTDIALOGPOPWINDOWCONTROLLER_REFRESHALL_OFFSET UNITYSDK_OFFSET(0x122C8E20)
#define MOLEMOLE_UIVIDEOSELECTROLELISTDIALOGPOPWINDOWCONTROLLER_REFRESHAVATARLISTS_OFFSET UNITYSDK_OFFSET(0x122C9400)
#define MOLEMOLE_UIVIDEOSELECTROLELISTDIALOGPOPWINDOWCONTROLLER_REFRESHEMPTYSTATE_OFFSET UNITYSDK_OFFSET(0x122C9E30)
#define MOLEMOLE_UIVIDEOSELECTROLELISTDIALOGPOPWINDOWCONTROLLER_REFRESHROLESPACELIST_OFFSET UNITYSDK_OFFSET(0x122CAE10)
#define MOLEMOLE_UIVIDEOSELECTROLELISTDIALOGPOPWINDOWCONTROLLER_REFRESHSELECTSTATE_OFFSET UNITYSDK_OFFSET(0x122CA3F0)
#define MOLEMOLE_UIVIDEOSELECTROLELISTDIALOGPOPWINDOWCONTROLLER_REFRESHSETTARGETBTNSTATE_OFFSET UNITYSDK_OFFSET(0x122CAB60)
#define MOLEMOLE_UIVIDEOSELECTROLELISTDIALOGPOPWINDOWCONTROLLER_REFRESHSUITHEADER_OFFSET UNITYSDK_OFFSET(0x122C9170)
#define MOLEMOLE_UIVIDEOSELECTROLELISTDIALOGPOPWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x122CC130)
#define MOLEMOLE_UIVIDEOSELECTROLELISTDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x122CBF90)
#define MOLEMOLE_UIVIDEOSELECTROLELISTDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x122CC1E0)
#define MOLEMOLE_UIVIDEOSELECTROLELISTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x122CC270)
#define MOLEMOLE_UIVIDEOSELECTROLELISTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x122CC280)
#define MOLEMOLE_UIVIDEOSELECTROLELISTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x122CC290)

namespace MoleMole
{
	inline static constexpr unsigned int UIVideoSelectRoleListDialogPopWindowController_TypeDefinitionIndex = 45571;
	...
	public:
		...
		{
			return (::Il2CppArray<::Enum_3_3A280D225275881D>**)Il2CppClass::FromTypeDefinitionIndex(UIVideoSelectRoleListDialogPopWindowController_TypeDefinitionIndex)->GetStaticField(0x41860);
		}
