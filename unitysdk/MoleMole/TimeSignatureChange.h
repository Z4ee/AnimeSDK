...
#define MOLEMOLE_TIMESIGNATURECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x173FDEA0)

namespace MoleMole
{
	inline static constexpr unsigned int TimeSignatureChange_TypeDefinitionIndex = 64243;
