...
#define MOLEMOLE_TIMESIGNATURECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x129DAC40)

namespace MoleMole
{
	inline static constexpr unsigned int TimeSignatureChange_TypeDefinitionIndex = 43967;
