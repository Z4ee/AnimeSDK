...
#define MOLEMOLE_UIHOLLOWITEMOPTIONSUPGRADECONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18366BD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowItemOptionsUpGradeControllerContext_TypeDefinitionIndex = 90036;
