...
#define MOLEMOLE_UIARCADEBASEPLAYCHILDWINDOWCONTROLLER___C__DISPLAYCLASS30_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15EA5930)
#define MOLEMOLE_UIARCADEBASEPLAYCHILDWINDOWCONTROLLER___C__DISPLAYCLASS30_0__EXITMINIGAME_B__3_OFFSET UNITYSDK_OFFSET(0x15EA5940)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeBasePlayChildWindowController___c__DisplayClass30_0_TypeDefinitionIndex = 47948;

	class UIArcadeBasePlayChildWindowController___c__DisplayClass30_0 : public ::System::Object
	{
	public:
		::Class_1_782D7B640E2E81AE* oldLogic; // 0x10
		::Class_1_469466241042B140* miniGame; // 0x18
