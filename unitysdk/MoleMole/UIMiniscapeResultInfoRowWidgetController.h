...
#define MOLEMOLE_UIMINISCAPERESULTINFOROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17871E20)
#define MOLEMOLE_UIMINISCAPERESULTINFOROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17871EB0)
#define MOLEMOLE_UIMINISCAPERESULTINFOROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17871A80)
#define MOLEMOLE_UIMINISCAPERESULTINFOROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17871AE0)
#define MOLEMOLE_UIMINISCAPERESULTINFOROWWIDGETCONTROLLER_REFRESHITEM_OFFSET UNITYSDK_OFFSET(0x17871BC0)
#define MOLEMOLE_UIMINISCAPERESULTINFOROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17871F30)
#define MOLEMOLE_UIMINISCAPERESULTINFOROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17871F90)
#define MOLEMOLE_UIMINISCAPERESULTINFOROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17872020)
#define MOLEMOLE_UIMINISCAPERESULTINFOROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x178720B0)
#define MOLEMOLE_UIMINISCAPERESULTINFOROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17872140)

namespace MoleMole
{
	inline static constexpr unsigned int UIMiniscapeResultInfoRowWidgetController_TypeDefinitionIndex = 86627;
