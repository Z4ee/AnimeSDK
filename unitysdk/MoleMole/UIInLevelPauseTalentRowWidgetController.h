...
#define MOLEMOLE_UIINLEVELPAUSETALENTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18158810)
#define MOLEMOLE_UIINLEVELPAUSETALENTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x181588A0)
#define MOLEMOLE_UIINLEVELPAUSETALENTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18158510)
#define MOLEMOLE_UIINLEVELPAUSETALENTROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18158570)
#define MOLEMOLE_UIINLEVELPAUSETALENTROWWIDGETCONTROLLER_REFRESHTALENT_OFFSET UNITYSDK_OFFSET(0x18158920)
#define MOLEMOLE_UIINLEVELPAUSETALENTROWWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18159010)
#define MOLEMOLE_UIINLEVELPAUSETALENTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18158FB0)
#define MOLEMOLE_UIINLEVELPAUSETALENTROWWIDGETCONTROLLER__ONUIOPEN_B__3_0_OFFSET UNITYSDK_OFFSET(0x18159170)
#define MOLEMOLE_UIINLEVELPAUSETALENTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18159280)
#define MOLEMOLE_UIINLEVELPAUSETALENTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18159310)
#define MOLEMOLE_UIINLEVELPAUSETALENTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x181593A0)
#define MOLEMOLE_UIINLEVELPAUSETALENTROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18159430)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseTalentRowWidgetController_TypeDefinitionIndex = 68965;
	...
	public:
		...
		{
			return (::Il2CppArray<::Foundation::AssetPath>**)Il2CppClass::FromTypeDefinitionIndex(UIInLevelPauseTalentRowWidgetController_TypeDefinitionIndex)->GetStaticField(0x4B1C0);
		}
		...
		::System::Void RefreshTalent(::Class_2_208CC9941471731A_573* template_, ::Class_2_1824EF69C8E376A3* avatarItemData, ::System::Boolean unlock, ::System::Int32 index)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_573*, ::Class_2_1824EF69C8E376A3*, ::System::Boolean, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIINLEVELPAUSETALENTROWWIDGETCONTROLLER_REFRESHTALENT_OFFSET))(this, template_, avatarItemData, unlock, index);
		}
