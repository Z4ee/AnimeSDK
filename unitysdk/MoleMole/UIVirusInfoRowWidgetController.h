...
#define MOLEMOLE_UIVIRUSINFOROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15C47630)
#define MOLEMOLE_UIVIRUSINFOROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15C47740)
#define MOLEMOLE_UIVIRUSINFOROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15C476C0)
#define MOLEMOLE_UIVIRUSINFOROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15C47900)
#define MOLEMOLE_UIVIRUSINFOROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15C47910)
#define MOLEMOLE_UIVIRUSINFOROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15C479A0)
#define MOLEMOLE_UIVIRUSINFOROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15C47A40)

namespace MoleMole
{
	inline static constexpr unsigned int UIVirusInfoRowWidgetController_TypeDefinitionIndex = 54536;

	class UIVirusInfoRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_754022533D501C3E_8* _view; // 0x2F0
