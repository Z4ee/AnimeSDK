...
#define MOLEMOLE_MONOCINEMACAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x136D7AE0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoCinemaCameraConfig_TypeDefinitionIndex = 62405;
