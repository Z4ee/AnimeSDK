...
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x183392E0)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER___C__DISPLAYCLASS13_0__PLAYSWITCHBUDDY_B__1_OFFSET UNITYSDK_OFFSET(0x183394D0)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER___C__DISPLAYCLASS13_0__PLAYSWITCHBUDDY_B__2_OFFSET UNITYSDK_OFFSET(0x18339710)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER___C__DISPLAYCLASS13_0__PLAYSWITCHBUDDY_G__NEWFADE_0_OFFSET UNITYSDK_OFFSET(0x183392F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIModificationShop3DModelController___c__DisplayClass13_0_TypeDefinitionIndex = 67400;

	class UIModificationShop3DModelController___c__DisplayClass13_0 : public ::System::Object
	{
	public:
		::MoleMole::UIModificationShop3DModelController* __4__this; // 0x10
		::UnityEngine::Animator* newBuddy; // 0x18
		::System::Boolean isLeft; // 0x20
		::System::Int32 nextBuddyID; // 0x24
