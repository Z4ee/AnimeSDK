...
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x178B6C60)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER___C__DISPLAYCLASS13_0__PLAYSWITCHBUDDY_B__1_OFFSET UNITYSDK_OFFSET(0x178B6E50)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER___C__DISPLAYCLASS13_0__PLAYSWITCHBUDDY_B__2_OFFSET UNITYSDK_OFFSET(0x178B7090)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER___C__DISPLAYCLASS13_0__PLAYSWITCHBUDDY_G__NEWFADE_0_OFFSET UNITYSDK_OFFSET(0x178B6C70)

namespace MoleMole
{
	inline static constexpr unsigned int UIModificationShop3DModelController___c__DisplayClass13_0_TypeDefinitionIndex = 48305;
