...
#define MOLEMOLE_UIBLURBACKGROUNDIMAGE_AWAKE_OFFSET UNITYSDK_OFFSET(0x16ED2BE0)
#define MOLEMOLE_UIBLURBACKGROUNDIMAGE_GET_SERIALIZATIONDATA_OFFSET UNITYSDK_OFFSET(0x16ED2B80)
#define MOLEMOLE_UIBLURBACKGROUNDIMAGE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x16ED2DB0)
#define MOLEMOLE_UIBLURBACKGROUNDIMAGE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x16ED2D70)
#define MOLEMOLE_UIBLURBACKGROUNDIMAGE_SET_SERIALIZATIONDATA_OFFSET UNITYSDK_OFFSET(0x16ED2BB0)
#define MOLEMOLE_UIBLURBACKGROUNDIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16ED2DF0)
#define MOLEMOLE_UIBLURBACKGROUNDIMAGE___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x16ED2F00)
#define MOLEMOLE_UIBLURBACKGROUNDIMAGE___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x16ED2F10)
#define MOLEMOLE_UIBLURBACKGROUNDIMAGE___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x16ED3000)

namespace MoleMole
{
	inline static constexpr unsigned int UIBlurBackgroundImage_TypeDefinitionIndex = 55466;
