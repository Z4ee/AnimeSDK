...
#define MOLEMOLE_UIACTIVITYHOTPOTINGAMEPAGECONTROLLER___C__DISPLAYCLASS173_0__CTOR_OFFSET UNITYSDK_OFFSET(0x12B4AE00)
#define MOLEMOLE_UIACTIVITYHOTPOTINGAMEPAGECONTROLLER___C__DISPLAYCLASS173_0__ONINLEVELPAUSERESTART_B__0_OFFSET UNITYSDK_OFFSET(0x12B4AE10)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityHotpotInGamePageController___c__DisplayClass173_0_TypeDefinitionIndex = 53757;
