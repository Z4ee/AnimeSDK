...
#define MOLEMOLE_CONFIGUINEWMAP_2DGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9358B0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUINewMap_2DGroup_TypeDefinitionIndex = 58692;
