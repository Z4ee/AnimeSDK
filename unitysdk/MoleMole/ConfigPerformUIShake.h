...
#define MOLEMOLE_CONFIGPERFORMUISHAKE__CTOR_OFFSET UNITYSDK_OFFSET(0x181EFFA0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigPerformUIShake_TypeDefinitionIndex = 80880;
