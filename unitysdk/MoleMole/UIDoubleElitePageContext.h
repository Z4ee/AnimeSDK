...
#define MOLEMOLE_UIDOUBLEELITEPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1761B7A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIDoubleElitePageContext_TypeDefinitionIndex = 78637;
