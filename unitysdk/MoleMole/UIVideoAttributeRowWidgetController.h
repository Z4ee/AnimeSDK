...
#define MOLEMOLE_UIVIDEOATTRIBUTEROWWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x11BDDE10)
#define MOLEMOLE_UIVIDEOATTRIBUTEROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x11BDDAB0)
#define MOLEMOLE_UIVIDEOATTRIBUTEROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x11BDDD40)
#define MOLEMOLE_UIVIDEOATTRIBUTEROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x11BDDE80)
#define MOLEMOLE_UIVIDEOATTRIBUTEROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x11BDDCC0)
#define MOLEMOLE_UIVIDEOATTRIBUTEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x11BDDB40)
#define MOLEMOLE_UIVIDEOATTRIBUTEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11BDE010)
#define MOLEMOLE_UIVIDEOATTRIBUTEROWWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x11BDE020)
#define MOLEMOLE_UIVIDEOATTRIBUTEROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x11BDE030)
#define MOLEMOLE_UIVIDEOATTRIBUTEROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x11BDE0C0)
#define MOLEMOLE_UIVIDEOATTRIBUTEROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x11BDE150)
#define MOLEMOLE_UIVIDEOATTRIBUTEROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x11BDE1F0)
#define MOLEMOLE_UIVIDEOATTRIBUTEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x11BDE280)

namespace MoleMole
{
	inline static constexpr unsigned int UIVideoAttributeRowWidgetController_TypeDefinitionIndex = 80069;
