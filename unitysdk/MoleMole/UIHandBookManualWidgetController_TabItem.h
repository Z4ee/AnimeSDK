...
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_CHECKCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x157BC240)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_CHECKREWARDBUFF_OFFSET UNITYSDK_OFFSET(0x157BC400)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_GETREWARDBUFFGAMETAG_OFFSET UNITYSDK_OFFSET(0x157BC390)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_GET_CONTROLLER_OFFSET UNITYSDK_OFFSET(0x157BBB70)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_GET_CREATEWIDGET_OFFSET UNITYSDK_OFFSET(0x157BBCF0)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x157BBB00)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_GET_ICONTYPE_OFFSET UNITYSDK_OFFSET(0x157BBB40)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_GET_REDDOTINFO_OFFSET UNITYSDK_OFFSET(0x157BBB50)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_GET_REWARDBUFF_OFFSET UNITYSDK_OFFSET(0x157BBD10)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_GET_TITLE_OFFSET UNITYSDK_OFFSET(0x157BBA60)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_SET_CREATEWIDGET_OFFSET UNITYSDK_OFFSET(0x157BBD00)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_SET_REDDOTINFO_OFFSET UNITYSDK_OFFSET(0x157BBB60)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_SET_REWARDBUFF_OFFSET UNITYSDK_OFFSET(0x157BBD20)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_SHOWTAB_OFFSET UNITYSDK_OFFSET(0x157BBD30)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x157BC5A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookManualWidgetController_TabItem_TypeDefinitionIndex = 70006;

	class UIHandBookManualWidgetController_TabItem : public ::System::Object
	{
	public:
		::System::Func_1<::MoleMole::UIBaseController*>* _CreateWidget_k__BackingField; // 0x10
		::Class_2_208CC9941471731A_520* entryTemplate; // 0x18
		::MoleMole::UIBaseController* _controller; // 0x20
		::Class_1_6535CE33BDD95E74* _RewardBuff_k__BackingField; // 0x28
