...
#define MOLEMOLE_UISETTINGPAGECONTROLLER_CALSETTINGTYPEBYIDX_OFFSET UNITYSDK_OFFSET(0x152B3040)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_CLEARNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x152B1C00)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_CREATECONTENTAREABYTABTYPE_OFFSET UNITYSDK_OFFSET(0x152B30F0)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_GETSHOWSETTINGTYPES_OFFSET UNITYSDK_OFFSET(0x152B2760)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x152B14C0)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x152B14B0)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_HASCLOSED_OFFSET UNITYSDK_OFFSET(0x152B27F0)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x152B1690)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x152B14D0)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x152B3690)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x152B2700)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_ONRESETBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x152B3280)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x152B1B50)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x152B1560)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x152B1DB0)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x152B1F90)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_SWITCHCONTENTAREA_OFFSET UNITYSDK_OFFSET(0x152B2830)
#define MOLEMOLE_UISETTINGPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x152B3850)
#define MOLEMOLE_UISETTINGPAGECONTROLLER__INITVIEW_B__12_1_OFFSET UNITYSDK_OFFSET(0x152B3920)
#define MOLEMOLE_UISETTINGPAGECONTROLLER__INITVIEW_B__12_2_OFFSET UNITYSDK_OFFSET(0x152B3A00)
#define MOLEMOLE_UISETTINGPAGECONTROLLER__ONRESETBTNCLICKED_B__17_0_OFFSET UNITYSDK_OFFSET(0x152B3B00)
#define MOLEMOLE_UISETTINGPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x152B3BD0)
#define MOLEMOLE_UISETTINGPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x152B3C70)
#define MOLEMOLE_UISETTINGPAGECONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x152B3CA0)
#define MOLEMOLE_UISETTINGPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x152B3D30)
#define MOLEMOLE_UISETTINGPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x152B3C60)
#define MOLEMOLE_UISETTINGPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x152B3D40)

namespace MoleMole
{
	inline static constexpr unsigned int UISettingPageController_TypeDefinitionIndex = 48673;
