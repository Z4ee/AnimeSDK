...
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_ROLEBGCOLOR_LERP_OFFSET UNITYSDK_OFFSET(0x155F86A0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_ROLEBGCOLOR_WRITE_OFFSET UNITYSDK_OFFSET(0x79EFC0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_ROLEBGCOLOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x79ECD0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_ROLEBGCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x79ECC0)

namespace MoleMole
{
	inline static constexpr unsigned int UILineupRoleSelectWidgetController_RoleBGColor_TypeDefinitionIndex = 51160;
	...
	struct alignas(4) UILineupRoleSelectWidgetController_RoleBGColor
	{
		...
		::System::Void _ctor(::Class_2_1CC0E2699D5FB1A6_8* bg)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_1CC0E2699D5FB1A6_8*))((::PBYTE)hIl2Cpp + MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_ROLEBGCOLOR__CTOR_OFFSET))(this, bg);
		}
		...
		*/
		...
		::System::Void Write(::Class_2_1CC0E2699D5FB1A6_8* bg)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_1CC0E2699D5FB1A6_8*))((::PBYTE)hIl2Cpp + MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_ROLEBGCOLOR_WRITE_OFFSET))(this, bg);
		}
	};
}
