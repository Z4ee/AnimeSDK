...
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_ROLEBGCOLOR_LERP_OFFSET UNITYSDK_OFFSET(0x168AEC90)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_ROLEBGCOLOR_WRITE_OFFSET UNITYSDK_OFFSET(0x84CBC0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_ROLEBGCOLOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x84C8D0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_ROLEBGCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x84C8C0)

namespace MoleMole
{
	inline static constexpr unsigned int UILineupRoleSelectWidgetController_RoleBGColor_TypeDefinitionIndex = 90032;
	...
	struct alignas(4) UILineupRoleSelectWidgetController_RoleBGColor
	{
		...
		::System::Void _ctor(::Class_2_82E7DB6BA9499BE4_4* bg)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_82E7DB6BA9499BE4_4*))((::PBYTE)hIl2Cpp + MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_ROLEBGCOLOR__CTOR_OFFSET))(this, bg);
		}
		...
		*/
		...
		::System::Void Write(::Class_2_82E7DB6BA9499BE4_4* bg)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_82E7DB6BA9499BE4_4*))((::PBYTE)hIl2Cpp + MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_ROLEBGCOLOR_WRITE_OFFSET))(this, bg);
		}
	};
}
