...
#define MOLEMOLE_UIMAINSTORYDIFFICULTYPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x1900E060)
#define MOLEMOLE_UIMAINSTORYDIFFICULTYPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1900E050)
#define MOLEMOLE_UIMAINSTORYDIFFICULTYPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x1900E140)
#define MOLEMOLE_UIMAINSTORYDIFFICULTYPOPWINDOWCONTROLLER_ONBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1900E7D0)
#define MOLEMOLE_UIMAINSTORYDIFFICULTYPOPWINDOWCONTROLLER_ONCONFIRMBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1900EAB0)
#define MOLEMOLE_UIMAINSTORYDIFFICULTYPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1900E6D0)
#define MOLEMOLE_UIMAINSTORYDIFFICULTYPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1900E760)
#define MOLEMOLE_UIMAINSTORYDIFFICULTYPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1900E070)
#define MOLEMOLE_UIMAINSTORYDIFFICULTYPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1900E0C0)
#define MOLEMOLE_UIMAINSTORYDIFFICULTYPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1900EB50)
#define MOLEMOLE_UIMAINSTORYDIFFICULTYPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1900EB70)
#define MOLEMOLE_UIMAINSTORYDIFFICULTYPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1900EC00)
#define MOLEMOLE_UIMAINSTORYDIFFICULTYPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1900EC10)
#define MOLEMOLE_UIMAINSTORYDIFFICULTYPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1900EC20)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainStoryDifficultyPopWindowController_TypeDefinitionIndex = 66027;
