...
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER___C__DISPLAYCLASS37_0__CTOR_OFFSET UNITYSDK_OFFSET(0x151B93C0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER___C__DISPLAYCLASS37_0__UPDATEPOSITION_B__1_OFFSET UNITYSDK_OFFSET(0x151B93D0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER___C__DISPLAYCLASS37_0__UPDATEPOSITION_B__2_OFFSET UNITYSDK_OFFSET(0x151B93F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralNewsBubbleWidgetController___c__DisplayClass37_0_TypeDefinitionIndex = 58769;
