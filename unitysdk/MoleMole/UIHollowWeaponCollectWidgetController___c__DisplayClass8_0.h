...
#define MOLEMOLE_UIHOLLOWWEAPONCOLLECTWIDGETCONTROLLER___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1829AF60)
#define MOLEMOLE_UIHOLLOWWEAPONCOLLECTWIDGETCONTROLLER___C__DISPLAYCLASS8_0__MATCHFUNCCOLLECTED_B__0_OFFSET UNITYSDK_OFFSET(0x1829AF70)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowWeaponCollectWidgetController___c__DisplayClass8_0_TypeDefinitionIndex = 83013;
