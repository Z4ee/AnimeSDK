...
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER_ONCLICKEDITNAMECALLBACK_OFFSET UNITYSDK_OFFSET(0x1485E640)
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1485DB50)
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1485DCF0)
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1485DBE0)
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1485D840)
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0x1485DED0)
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER_REFRESHPHOTOIMAGE_OFFSET UNITYSDK_OFFSET(0x1485E4A0)
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER_TRIGGERRENAME_OFFSET UNITYSDK_OFFSET(0x1485E500)
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1485E7A0)
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER__ONCLICKEDITNAMECALLBACK_B__10_0_OFFSET UNITYSDK_OFFSET(0x1485E7B0)
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER__ONCLICKEDITNAMECALLBACK_B__10_2_OFFSET UNITYSDK_OFFSET(0x1485E960)
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1485EA80)
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1485EB10)
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1485EBB0)
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1485EC40)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoWallSwitchItemWidgetController_TypeDefinitionIndex = 64127;

	class UIPhotoWallSwitchItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_57821D84473AF5D0* _view; // 0x2E8
		::MoleMole::UICreateRoleNameDialogPopWindowController* _pop; // 0x2F0
		::Class_1_7AD143A329DB3CBB* _imageViewModel; // 0x2F8
		::Class_1_3056A65E74601914* _photoWallData; // 0x300
