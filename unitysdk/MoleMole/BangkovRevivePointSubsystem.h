...
#define MOLEMOLE_BANGKOVREVIVEPOINTSUBSYSTEM_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x134C86E0)
#define MOLEMOLE_BANGKOVREVIVEPOINTSUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x134C8650)
#define MOLEMOLE_BANGKOVREVIVEPOINTSUBSYSTEM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x134C8860)
#define MOLEMOLE_BANGKOVREVIVEPOINTSUBSYSTEM_TRYGETREVIVEPOINT_OFFSET UNITYSDK_OFFSET(0x134C8750)
#define MOLEMOLE_BANGKOVREVIVEPOINTSUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x134C8B80)
#define MOLEMOLE_BANGKOVREVIVEPOINTSUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x134C8BA0)
#define MOLEMOLE_BANGKOVREVIVEPOINTSUBSYSTEM___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x134C8C30)

namespace MoleMole
{
	inline static constexpr unsigned int BangkovRevivePointSubsystem_TypeDefinitionIndex = 68642;
