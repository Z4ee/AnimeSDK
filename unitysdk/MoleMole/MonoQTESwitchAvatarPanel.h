...
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x11640460)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_INITQTEAVATARBTNPANEL_OFFSET UNITYSDK_OFFSET(0x11641640)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_ONBEFOREWORLDUPDATE_OFFSET UNITYSDK_OFFSET(0x11642140)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_ONLEFTCHARBTNCLICK_OFFSET UNITYSDK_OFFSET(0x11642F60)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_ONQTEWINDOWCLOSED_OFFSET UNITYSDK_OFFSET(0x11642660)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_ONQTEWINDOWOPENED_OFFSET UNITYSDK_OFFSET(0x11642560)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_ONRIGHTCHARBTNCLICK_OFFSET UNITYSDK_OFFSET(0x11642FE0)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_ONSWITCHBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x11642500)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x11641540)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_PLAYANIM_OFFSET UNITYSDK_OFFSET(0x11641D80)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_PLAYFADEOUTANIMEND_OFFSET UNITYSDK_OFFSET(0x11641E00)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_SECONDSTODATATIMEFORMAT_OFFSET UNITYSDK_OFFSET(0x11642890)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_SETAVATARICONINFO_OFFSET UNITYSDK_OFFSET(0x11642AD0)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_SETDEFAULTTIMERTWEENBAR_OFFSET UNITYSDK_OFFSET(0x11642040)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_SETQTEEFFECTACTIVE_OFFSET UNITYSDK_OFFSET(0x11641E50)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_STARTPLAYLOOPANIM_OFFSET UNITYSDK_OFFSET(0x11641CA0)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_STARTPLAYTWEERBAR_OFFSET UNITYSDK_OFFSET(0x11641A90)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_START_OFFSET UNITYSDK_OFFSET(0x11640470)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_SWITCHAVATAR_OFFSET UNITYSDK_OFFSET(0x11643060)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_TWEENQTETIMEBAR_OFFSET UNITYSDK_OFFSET(0x11641AE0)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_UPDATEQTEBTNCOUNTDOWNPANEL_OFFSET UNITYSDK_OFFSET(0x11642270)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0x11643120)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x11643130)

namespace MoleMole
{
	inline static constexpr unsigned int MonoQTESwitchAvatarPanel_TypeDefinitionIndex = 74013;
