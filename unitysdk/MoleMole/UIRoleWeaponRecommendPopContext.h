...
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x137825E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleWeaponRecommendPopContext_TypeDefinitionIndex = 76835;
