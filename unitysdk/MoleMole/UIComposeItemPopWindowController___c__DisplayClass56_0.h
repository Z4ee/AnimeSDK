...
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER___C__DISPLAYCLASS56_0__CTOR_OFFSET UNITYSDK_OFFSET(0x176FBF80)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER___C__DISPLAYCLASS56_0__SENDDATA_B__0_OFFSET UNITYSDK_OFFSET(0x176FBF90)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER___C__DISPLAYCLASS56_0__SENDDATA_B__1_OFFSET UNITYSDK_OFFSET(0x176FC170)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER___C__DISPLAYCLASS56_0__SENDDATA_B__2_OFFSET UNITYSDK_OFFSET(0x176FC350)

namespace MoleMole
{
	inline static constexpr unsigned int UIComposeItemPopWindowController___c__DisplayClass56_0_TypeDefinitionIndex = 78467;
