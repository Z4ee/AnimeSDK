...
#define MOLEMOLE_UIACTIVITYHOTPOTDELETECARDPOPWINDOWCONTROLLER_CREATECARDITEMROW_OFFSET UNITYSDK_OFFSET(0x12B49A80)
#define MOLEMOLE_UIACTIVITYHOTPOTDELETECARDPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x12B48F70)
#define MOLEMOLE_UIACTIVITYHOTPOTDELETECARDPOPWINDOWCONTROLLER_ONCONFIRMBTNCLICK_OFFSET UNITYSDK_OFFSET(0x12B4A530)
#define MOLEMOLE_UIACTIVITYHOTPOTDELETECARDPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12B49980)
#define MOLEMOLE_UIACTIVITYHOTPOTDELETECARDPOPWINDOWCONTROLLER_ONITEMCLICK_OFFSET UNITYSDK_OFFSET(0x12B49B80)
#define MOLEMOLE_UIACTIVITYHOTPOTDELETECARDPOPWINDOWCONTROLLER_ONSWITCHBTNCLICK_OFFSET UNITYSDK_OFFSET(0x12B4A420)
#define MOLEMOLE_UIACTIVITYHOTPOTDELETECARDPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12B49A10)
#define MOLEMOLE_UIACTIVITYHOTPOTDELETECARDPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12B48F80)
#define MOLEMOLE_UIACTIVITYHOTPOTDELETECARDPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12B492F0)
#define MOLEMOLE_UIACTIVITYHOTPOTDELETECARDPOPWINDOWCONTROLLER_ONWIDGETUPDATE_OFFSET UNITYSDK_OFFSET(0x12B4A100)
#define MOLEMOLE_UIACTIVITYHOTPOTDELETECARDPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x12B495F0)
#define MOLEMOLE_UIACTIVITYHOTPOTDELETECARDPOPWINDOWCONTROLLER_SETSWITCHBTNSTATE_OFFSET UNITYSDK_OFFSET(0x12B498E0)
#define MOLEMOLE_UIACTIVITYHOTPOTDELETECARDPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12B4A900)
#define MOLEMOLE_UIACTIVITYHOTPOTDELETECARDPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12B4A970)
#define MOLEMOLE_UIACTIVITYHOTPOTDELETECARDPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12B4AA00)
#define MOLEMOLE_UIACTIVITYHOTPOTDELETECARDPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12B4AA10)
#define MOLEMOLE_UIACTIVITYHOTPOTDELETECARDPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12B4AA20)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityHotPotDeleteCardPopWindowController_TypeDefinitionIndex = 63365;

	class UIActivityHotPotDeleteCardPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_CA475E4A850C2837* _view; // 0x310
		::System::Collections::Generic::List_1<::System::Int32>* _currentSelectCardIDsIndex; // 0x318
		::System::Boolean _isSwitchBtnOn; // 0x320
		::System::Int32 _toDeleteNum; // 0x324
		::System::Collections::Generic::List_1<::Class_1_7807B2B04302CD7B_1*>* _orderedList; // 0x328
