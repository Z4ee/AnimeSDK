...
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER_BINDONCLICK_OFFSET UNITYSDK_OFFSET(0x17703FD0)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x177039B0)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17703F40)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17703A40)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER_UPDATECARDINFO_OFFSET UNITYSDK_OFFSET(0x17704690)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER_UPDATEINFO_OFFSET UNITYSDK_OFFSET(0x177040D0)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17704A80)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER__UPDATEINFO_B__10_1_OFFSET UNITYSDK_OFFSET(0x17704AE0)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER__UPDATEINFO_G__INTERNALDOREFRESH_10_0_OFFSET UNITYSDK_OFFSET(0x177044B0)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17704AF0)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17704B80)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17704C10)

namespace MoleMole
{
	inline static constexpr unsigned int UIDoubleEliteMonsterWidgetController_TypeDefinitionIndex = 63793;
	...
	public:
		...
		::Class_2_208CC9941471731A_401* _cardInfoTempate; // 0x2F0
