...
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER_BINDONCLICK_OFFSET UNITYSDK_OFFSET(0x1578BFE0)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1578B9B0)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1578BF50)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1578BA40)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER_UPDATECARDINFO_OFFSET UNITYSDK_OFFSET(0x1578C690)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER_UPDATEINFO_OFFSET UNITYSDK_OFFSET(0x1578C0E0)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1578CA30)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER__UPDATEINFO_B__10_1_OFFSET UNITYSDK_OFFSET(0x1578CA90)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER__UPDATEINFO_G__INTERNALDOREFRESH_10_0_OFFSET UNITYSDK_OFFSET(0x1578C4B0)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1578CAA0)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1578CB30)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1578CBC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIDoubleEliteMonsterWidgetController_TypeDefinitionIndex = 81296;

	class UIDoubleEliteMonsterWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::System::String* _refreshAnimName; // 0x2B8
		::Class_2_9666903FCFB10C51* _view; // 0x2C0
		::MoleMole::UIDailyChallengeCardRowWidgetController* _card1; // 0x2C8
		::MoleMole::UIDailyChallengeCardRowWidgetController* _card2; // 0x2D0
		::Struct_2_49ABC235CB23B56F _delayUpdateInfoHandle; // 0x2D8
		::Class_2_208CC9941471731A_261* _cardInfoTempate; // 0x2E8
