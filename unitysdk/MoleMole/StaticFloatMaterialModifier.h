...
#define MOLEMOLE_STATICFLOATMATERIALMODIFIER_METHOD_2_3750F4A9FEA7F5EF_OFFSET UNITYSDK_OFFSET(0x74CFB0)
#define MOLEMOLE_STATICFLOATMATERIALMODIFIER_METHOD_2_C446CE6A5E1982BC_OFFSET UNITYSDK_OFFSET(0x74CFC0)
#define MOLEMOLE_STATICFLOATMATERIALMODIFIER_METHOD_2_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x74D010)
#define MOLEMOLE_STATICFLOATMATERIALMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x74CF90)

namespace MoleMole
{
	inline static constexpr unsigned int StaticFloatMaterialModifier_TypeDefinitionIndex = 73850;
	...
	struct alignas(8) StaticFloatMaterialModifier
	{
		...
		{
			return ((::Class_1_A0B58236B258B7B2*(*)(::PVOID, ::Enum_3_7F3F4476896DB547, ::MoleMole::MonoRenderHandler*))((::PBYTE)hIl2Cpp + MOLEMOLE_STATICFLOATMATERIALMODIFIER_METHOD_2_3750F4A9FEA7F5EF_OFFSET))(this, a1, a2);
		}
