...
#define MOLEMOLE_PARTICLEQUALITYPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x190A6220)
#define MOLEMOLE_PARTICLEQUALITYPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x190A6360)
#define MOLEMOLE_PARTICLEQUALITYPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x190A6140)
#define MOLEMOLE_PARTICLEQUALITYPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x190A62E0)
#define MOLEMOLE_PARTICLEQUALITYPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x190A6130)
#define MOLEMOLE_PARTICLEQUALITYPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x190A6480)
#define MOLEMOLE_PARTICLEQUALITYPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x190A6510)
#define MOLEMOLE_PARTICLEQUALITYPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x190A65A0)
#define MOLEMOLE_PARTICLEQUALITYPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x190A6630)

namespace MoleMole
{
	inline static constexpr unsigned int ParticleQualityProfile_TypeDefinitionIndex = 65483;
