...
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17307AF0)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17307C00)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17307B80)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x173078E0)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER_REFRESHGAMEPADLIST_OFFSET UNITYSDK_OFFSET(0x17309920)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17309FD0)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER__ONSCROLLITEMUPDATE_B__9_1_OFFSET UNITYSDK_OFFSET(0x17309FE0)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER__ONSCROLLITEMUPDATE_G__SETEMPTY_9_0_OFFSET UNITYSDK_OFFSET(0x173098C0)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1730A050)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1730A0E0)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1730A180)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1730A210)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookItemWidgetController_TypeDefinitionIndex = 70473;
	...
	public:
		...
		::Class_2_79F6D62CE30E3F8E_169* _view; // 0x300
