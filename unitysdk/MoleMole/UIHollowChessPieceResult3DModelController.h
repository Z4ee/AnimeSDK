...
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_ADJUSTPOS_OFFSET UNITYSDK_OFFSET(0x18254E60)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_BLINK_OFFSET UNITYSDK_OFFSET(0x182551C0)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_CENTER_OFFSET UNITYSDK_OFFSET(0x18254C20)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x18254620)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_GET_FRONTRECTPOINTSWORLD_OFFSET UNITYSDK_OFFSET(0x18255B50)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_GET_FRONTRECT_OFFSET UNITYSDK_OFFSET(0x182559E0)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_GET_FULLINDEX_OFFSET UNITYSDK_OFFSET(0x18254750)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x18254740)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x18254AB0)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18254760)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x18254950)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x182549E0)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x182547F0)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18254900)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_PERFORM_OFFSET UNITYSDK_OFFSET(0x18255520)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_SETBRIGHTNESS_OFFSET UNITYSDK_OFFSET(0x18254FA0)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_SETSATURATION_OFFSET UNITYSDK_OFFSET(0x182550B0)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x18254A40)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18255E00)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18255D90)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18255EC0)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x18255F50)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18256010)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18256020)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18256030)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowChessPieceResult3DModelController_TypeDefinitionIndex = 41071;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIHollowChessPieceResult3DModelController_TypeDefinitionIndex)->GetStaticField(0xB0F0);
		}
		static ::System::Int32* StaticGet_MatUVAnimationForSequenceToggleId()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIHollowChessPieceResult3DModelController_TypeDefinitionIndex)->GetStaticField(0xB0F4);
		}
		static ::System::Int32* StaticGet_MatScreenBrightID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIHollowChessPieceResult3DModelController_TypeDefinitionIndex)->GetStaticField(0xB0F8);
		}
		static ::System::Int32* StaticGet_MatSccSaturationID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIHollowChessPieceResult3DModelController_TypeDefinitionIndex)->GetStaticField(0xB0FC);
		}
		static ::System::Int32* StaticGet_MatOverallOpacity()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIHollowChessPieceResult3DModelController_TypeDefinitionIndex)->GetStaticField(0xB100);
		}
		static ::System::Int32* StaticGet_MatScreenColorID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIHollowChessPieceResult3DModelController_TypeDefinitionIndex)->GetStaticField(0xB104);
		}
		static ::System::Int32* StaticGet_MatScreenHueID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIHollowChessPieceResult3DModelController_TypeDefinitionIndex)->GetStaticField(0xB108);
		}
		::Class_2_D68EC59F0214DAC2* _view; // 0x360
		...
		::Struct_2_3BFB14B0511B64BC_1 get_FrontRect()
		{
			return ((::Struct_2_3BFB14B0511B64BC_1(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_GET_FRONTRECT_OFFSET))(this);
		}
