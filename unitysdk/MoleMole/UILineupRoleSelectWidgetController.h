...
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_ACTIVEAVATARMODEL_OFFSET UNITYSDK_OFFSET(0x15EF4D60)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_APPLYROLEIMAGETEXTURE_OFFSET UNITYSDK_OFFSET(0x15EF49D0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_APPLYROLETEXTURE_OFFSET UNITYSDK_OFFSET(0x15EF1E00)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_BUILDMODEL_OFFSET UNITYSDK_OFFSET(0x15EF4940)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_ENABLEAVATARRTCAMERA_OFFSET UNITYSDK_OFFSET(0x15EF4F10)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_ENABLEAVATARRT_OFFSET UNITYSDK_OFFSET(0x15EF4E80)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_GETANIMSTATE_OFFSET UNITYSDK_OFFSET(0x15EF02F0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_GETLOCKINBATTLETOGGLE_OFFSET UNITYSDK_OFFSET(0x15EF1A40)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_GETSELECTBUTTON_OFFSET UNITYSDK_OFFSET(0x15EF19E0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_GETWAITANIMNORMALIZEDTIME_OFFSET UNITYSDK_OFFSET(0x15EF01F0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x15EF1010)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_GET_ISROLEIMAGEFADEOUTCOMPLETE_OFFSET UNITYSDK_OFFSET(0x15EF3130)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_GET_ISROLEIMAGEFADING_OFFSET UNITYSDK_OFFSET(0x15EF30B0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_GET_MODELAVATAR_OFFSET UNITYSDK_OFFSET(0x15EF0FF0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_GET_ROLEIMAGEFADING_OFFSET UNITYSDK_OFFSET(0x15EF0FA0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_GET_RTSTATE_OFFSET UNITYSDK_OFFSET(0x15EF0FD0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_INTERNALPLAYMATCHINGANIM_OFFSET UNITYSDK_OFFSET(0x15EEFF80)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_INTERNALSTOPMATCHINGANIM_OFFSET UNITYSDK_OFFSET(0x15EEF550)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_ISSELECTABLE_OFFSET UNITYSDK_OFFSET(0x15EF1F50)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x15EF1920)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_LERPBGCOLORBYALPHA_OFFSET UNITYSDK_OFFSET(0x15EF2B80)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_LOADPLAYERICON_OFFSET UNITYSDK_OFFSET(0x15EF0E60)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15EF1570)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15EF1600)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15EF16E0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15EF1090)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15EF1500)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_PLAYANIMLOOP_OFFSET UNITYSDK_OFFSET(0x15EF0990)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_PLAYFADEANIMINTERNAL_OFFSET UNITYSDK_OFFSET(0x15EF2E10)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_PLAYMATCHINGANIM_OFFSET UNITYSDK_OFFSET(0x15EEFF20)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_PLAYROLEIMAGEFADEINANIM_OFFSET UNITYSDK_OFFSET(0x15EF2DC0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_PLAYROLEIMAGEFADEOUTANIM_OFFSET UNITYSDK_OFFSET(0x15EF3050)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_REFRESHAVATARINFO_OFFSET UNITYSDK_OFFSET(0x15EF3270)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_REFRESHAVATARLEVEL_OFFSET UNITYSDK_OFFSET(0x15EF3BB0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_REFRESHBUFFPAIRUP_OFFSET UNITYSDK_OFFSET(0x15EF4050)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_REFRESHHPSTATE_OFFSET UNITYSDK_OFFSET(0x15EF45F0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_REFRESHONLINESELECTSHOWICON_OFFSET UNITYSDK_OFFSET(0x15EF0640)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_REFRESHPLAYERDATA_OFFSET UNITYSDK_OFFSET(0x15EEFC20)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_REFRESHPLAYERNAMEICON_OFFSET UNITYSDK_OFFSET(0x15EEF990)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_REFRESHPLAYERNAMEICON_PC_OFFSET UNITYSDK_OFFSET(0x15EF0AE0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_REFRESHROLEINFOSTATE_1_OFFSET UNITYSDK_OFFSET(0x15EEF9E0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_REFRESHROLEINFOSTATE_OFFSET UNITYSDK_OFFSET(0x15EF1D10)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_REFRESHSELECTBUTTONMP_OFFSET UNITYSDK_OFFSET(0x15EEF760)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_REFRESHSELECTBUTTON_OFFSET UNITYSDK_OFFSET(0x15EF1BB0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_RELEASE_OFFSET UNITYSDK_OFFSET(0x15EF1AA0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_REQUIREBUILDAVATARMODEL_OFFSET UNITYSDK_OFFSET(0x15EF4D00)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_SAMPLEANIMATION_OFFSET UNITYSDK_OFFSET(0x15EF0A00)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_SETBACKFLOWTRIAL_OFFSET UNITYSDK_OFFSET(0x15EF1FC0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_SETLOCKED_OFFSET UNITYSDK_OFFSET(0x15EEFE20)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_SETLOCKINBATTLE_OFFSET UNITYSDK_OFFSET(0x15EF2800)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_SETONLINEPLAYERSELECTED_OFFSET UNITYSDK_OFFSET(0x15EEF800)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_SETRECOMMENDUP_OFFSET UNITYSDK_OFFSET(0x15EF21B0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_SETREPELTAG_OFFSET UNITYSDK_OFFSET(0x15EF2160)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_SETROLEIMAGEFADEANIMSPEED_OFFSET UNITYSDK_OFFSET(0x15EF31B0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_SETSELECTABLE_OFFSET UNITYSDK_OFFSET(0x15EEFEB0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_SETTEXTBGLOOPREVERSE_OFFSET UNITYSDK_OFFSET(0x15EF5040)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_SETTRIALSTYLE_OFFSET UNITYSDK_OFFSET(0x15EF2250)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_SETTRIAL_OFFSET UNITYSDK_OFFSET(0x15EF2380)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_SETWAITANIMLOOPNORMALIZEDTIME_OFFSET UNITYSDK_OFFSET(0x15EF0510)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x15EF1030)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_STOPROLEIMAGEFADEANIM_OFFSET UNITYSDK_OFFSET(0x15EF2CB0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_SWAPAVATARRT_OFFSET UNITYSDK_OFFSET(0x15EF4FA0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_SWITCHSHOWSTATE_OFFSET UNITYSDK_OFFSET(0x15EEF140)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_SWITCHUSERSNAMEUIBYPLATFORM_OFFSET UNITYSDK_OFFSET(0x15EF0F50)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15EF5550)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER__SETTEXTBGLOOPREVERSE_G__SAFEREVERSE_94_0_OFFSET UNITYSDK_OFFSET(0x15EF5430)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15EF55F0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15EF5680)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15EF5720)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15EF57B0)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15EF5840)

namespace MoleMole
{
	inline static constexpr unsigned int UILineupRoleSelectWidgetController_TypeDefinitionIndex = 78768;

	class UILineupRoleSelectWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Struct_2_B6BE0E422E1288EE _playerData; // 0x2C0
		::Enum_3_74604EE93A89573F _showState; // 0x2C8
		...
		::Class_2_1CC0E2699D5FB1A6_6* _view; // 0x358
		...
		::System::Void RefreshOnlineSelectShowIcon(::Class_2_1CC0E2699D5FB1A6_6_Class_2_37D3DE03A9F27246_Enum_3_C8E5B7E08211DD2C icon)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_1CC0E2699D5FB1A6_6_Class_2_37D3DE03A9F27246_Enum_3_C8E5B7E08211DD2C))((::PBYTE)hIl2Cpp + MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_REFRESHONLINESELECTSHOWICON_OFFSET))(this, icon);
		}
		...
		::System::Void RefreshAvatarInfo(::Class_2_1824EF69C8E376A3* showAvatar, ::Class_2_F95242C0939727AB* pairUpInfo, ::System::Boolean writeRoleColorImmediately)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_1824EF69C8E376A3*, ::Class_2_F95242C0939727AB*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_REFRESHAVATARINFO_OFFSET))(this, showAvatar, pairUpInfo, writeRoleColorImmediately);
		}
		...
		::System::Void RefreshBuffPairUp(::Class_2_1824EF69C8E376A3* avatar, ::Class_2_F95242C0939727AB* pairUpInfo)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_1824EF69C8E376A3*, ::Class_2_F95242C0939727AB*))((::PBYTE)hIl2Cpp + MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_REFRESHBUFFPAIRUP_OFFSET))(this, avatar, pairUpInfo);
		}
