...
#define MOLEMOLE_UICOMICPAGECONTROLLER___C__DISPLAYCLASS259_0__CLOSEMENU_B__0_OFFSET UNITYSDK_OFFSET(0x176FBEA0)
#define MOLEMOLE_UICOMICPAGECONTROLLER___C__DISPLAYCLASS259_0__CTOR_OFFSET UNITYSDK_OFFSET(0x176FBE90)

namespace MoleMole
{
	inline static constexpr unsigned int UIComicPageController___c__DisplayClass259_0_TypeDefinitionIndex = 46640;
