...
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS67_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15005290)
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS67_0__SETMINISCAPEQUESTCONTEXT_B__0_OFFSET UNITYSDK_OFFSET(0x150052A0)

namespace MoleMole
{
	inline static constexpr unsigned int UILineupSelectContext___c__DisplayClass67_0_TypeDefinitionIndex = 57536;
