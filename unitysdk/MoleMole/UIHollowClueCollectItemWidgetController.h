...
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER_HASREDPOINTINSTORYGROUP_OFFSET UNITYSDK_OFFSET(0x14686830)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14686E50)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x14686A00)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x14686F60)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14686EE0)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14686440)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER_REFRESHREDPOINT_OFFSET UNITYSDK_OFFSET(0x14686690)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x14686A70)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14687140)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14687150)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x146871E0)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x14687270)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14687310)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x146873A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowClueCollectItemWidgetController_TypeDefinitionIndex = 57230;

	class UIHollowClueCollectItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_13B0F8CFF863C291* _view; // 0x2E8
		::MoleMole::UIGeneralPopUpHintWidgetController* _new; // 0x2F0
		::Class_2_208CC9941471731A_85* m_storyCfg; // 0x2F8
		::System::Collections::Generic::List_1<::Class_2_6D99A03C58ED2B6E*>* m_cfgs; // 0x300
