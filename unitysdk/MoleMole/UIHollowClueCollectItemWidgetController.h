...
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER_HASREDPOINTINSTORYGROUP_OFFSET UNITYSDK_OFFSET(0x164D0450)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x164D0A70)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x164D0620)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x164D0B80)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x164D0B00)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x164D0070)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER_REFRESHREDPOINT_OFFSET UNITYSDK_OFFSET(0x164D02C0)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x164D0690)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x164D0D60)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x164D0D70)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x164D0E00)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x164D0E90)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x164D0F30)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x164D0FC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowClueCollectItemWidgetController_TypeDefinitionIndex = 57649;
	...
	public:
		...
		::Class_2_208CC9941471731A_204* m_storyCfg; // 0x300
		::System::Collections::Generic::List_1<::Class_2_6D99A03C58ED2B6E*>* m_cfgs; // 0x308
