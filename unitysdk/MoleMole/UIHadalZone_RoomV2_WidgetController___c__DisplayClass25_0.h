...
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER___C__DISPLAYCLASS25_0__CTOR_OFFSET UNITYSDK_OFFSET(0x199D4170)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER___C__DISPLAYCLASS25_0__RECONFIRMSELECTIONCHANGEDONLINEUPCLOSE_B__0_OFFSET UNITYSDK_OFFSET(0x199D4180)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER___C__DISPLAYCLASS25_0__RECONFIRMSELECTIONCHANGEDONLINEUPCLOSE_B__1_OFFSET UNITYSDK_OFFSET(0x199D41F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_RoomV2_WidgetController___c__DisplayClass25_0_TypeDefinitionIndex = 46165;
