...
class Class_2_67436C2846633F4F;
namespace MoleMole { class UIControlReference; }
namespace System { class Object; }

#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW2WIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19176FC0)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW2WIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19177030)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW2WIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x19177200)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW2WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x191770F0)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19177300)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW2WIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19177310)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW2WIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x191773B0)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW2WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x19177440)

namespace MoleMole
{
	inline static constexpr unsigned int UIVoidFrontLevelListRow2WidgetController_TypeDefinitionIndex = 44604;
	...
	public:
		...
		::Class_2_67436C2846633F4F* get__viewModel()
		{
			return ((::Class_2_67436C2846633F4F*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVOIDFRONTLEVELLISTROW2WIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
