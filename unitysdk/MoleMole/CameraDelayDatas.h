...
#define MOLEMOLE_CAMERADELAYDATAS_CLONE_OFFSET UNITYSDK_OFFSET(0x12AFA200)
#define MOLEMOLE_CAMERADELAYDATAS_LERP_OFFSET UNITYSDK_OFFSET(0x12AFA070)
#define MOLEMOLE_CAMERADELAYDATAS_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x12AF9E60)
#define MOLEMOLE_CAMERADELAYDATAS_POSTINIT_OFFSET UNITYSDK_OFFSET(0x12AFA030)
#define MOLEMOLE_CAMERADELAYDATAS_ZERO_OFFSET UNITYSDK_OFFSET(0x12AF9D60)
#define MOLEMOLE_CAMERADELAYDATAS__CTOR_OFFSET UNITYSDK_OFFSET(0x12AF9C90)

namespace MoleMole
{
	inline static constexpr unsigned int CameraDelayDatas_TypeDefinitionIndex = 72176;
