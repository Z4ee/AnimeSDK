...
#define MOLEMOLE_SMALLTITLESETTINGENTRY_GET_SETTINGWIDGETTYPE_OFFSET UNITYSDK_OFFSET(0x12BE0F20)
#define MOLEMOLE_SMALLTITLESETTINGENTRY_GET__ISHIDEVERSIONCODE_OFFSET UNITYSDK_OFFSET(0x12BE0F10)
#define MOLEMOLE_SMALLTITLESETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x12BE0F30)

namespace MoleMole
{
	inline static constexpr unsigned int SmallTitleSettingEntry_TypeDefinitionIndex = 76377;
