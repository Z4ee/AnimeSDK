...
#include "unitysdk/Struct_2_2D9FE49A93BEEC6D.h"
...
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_APPLYCHANGEDEPTH_OFFSET UNITYSDK_OFFSET(0x14C55540)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_CALCHANGEDEPTH_OFFSET UNITYSDK_OFFSET(0x14C55340)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_CREATEBUDDYMODEL_OFFSET UNITYSDK_OFFSET(0x14C54EC0)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_CREATEBUDDY_OFFSET UNITYSDK_OFFSET(0x14C55780)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_DESTROYALLBUDDIES_OFFSET UNITYSDK_OFFSET(0x14C540B0)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_GETTVSCREEN_OFFSET UNITYSDK_OFFSET(0x14C54800)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_HIDETV_OFFSET UNITYSDK_OFFSET(0x14C56290)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_INITBUDDYCAMERA_OFFSET UNITYSDK_OFFSET(0x14C53780)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14C53AA0)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14C53BF0)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14C528D0)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14C53B30)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_PLAYBUDDYANI_OFFSET UNITYSDK_OFFSET(0x14C552D0)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_PLAYENTEREDITOREFFECT_OFFSET UNITYSDK_OFFSET(0x14C56520)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_PLAYEXITEDITOREFFECT_OFFSET UNITYSDK_OFFSET(0x14C56560)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_PLAYFIRSTBUDDY_OFFSET UNITYSDK_OFFSET(0x14C54CE0)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_PLAYSWITCHBUDDY_OFFSET UNITYSDK_OFFSET(0x14C54B00)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_REMOVEBUDDY_OFFSET UNITYSDK_OFFSET(0x14C56350)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_RESERGAMEPADCONTROL_OFFSET UNITYSDK_OFFSET(0x14C54400)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_SETBUDDYCAMERACONFIG_OFFSET UNITYSDK_OFFSET(0x14C55C10)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_SETBUDDYEDITORCAMERAPOS_OFFSET UNITYSDK_OFFSET(0x14C55A80)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_SETBUDDYINITCAMERA_OFFSET UNITYSDK_OFFSET(0x14C56230)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_SETCURRENTBUDDY_OFFSET UNITYSDK_OFFSET(0x14C54870)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_SHOWTV_OFFSET UNITYSDK_OFFSET(0x14C55B60)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_TICKDEPTH_OFFSET UNITYSDK_OFFSET(0x14C54770)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_TICKGAMEPADCONTROL_OFFSET UNITYSDK_OFFSET(0x14C54340)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x14C54490)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14C565A0)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14C567E0)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14C56870)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14C56880)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14C56890)

namespace MoleMole
{
	inline static constexpr unsigned int UIModificationShop3DModelController_TypeDefinitionIndex = 48301;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Struct_2_2D9FE49A93BEEC6D>* waitFadeActions; // 0x430
