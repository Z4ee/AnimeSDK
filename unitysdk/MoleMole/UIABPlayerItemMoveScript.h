...
#define MOLEMOLE_UIABPLAYERITEMMOVESCRIPT_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B2296B0)
#define MOLEMOLE_UIABPLAYERITEMMOVESCRIPT_ISMOVING_OFFSET UNITYSDK_OFFSET(0x1B229AC0)
#define MOLEMOLE_UIABPLAYERITEMMOVESCRIPT_RESETPOSITION_OFFSET UNITYSDK_OFFSET(0x1B229740)
#define MOLEMOLE_UIABPLAYERITEMMOVESCRIPT_SETTARGETPOS_OFFSET UNITYSDK_OFFSET(0x1B2299A0)
#define MOLEMOLE_UIABPLAYERITEMMOVESCRIPT_STARTMOVE_OFFSET UNITYSDK_OFFSET(0x1B229A80)
#define MOLEMOLE_UIABPLAYERITEMMOVESCRIPT_STOPMOVE_OFFSET UNITYSDK_OFFSET(0x1B229B00)
#define MOLEMOLE_UIABPLAYERITEMMOVESCRIPT_TICK_OFFSET UNITYSDK_OFFSET(0x1B2297B0)
#define MOLEMOLE_UIABPLAYERITEMMOVESCRIPT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B229B50)

namespace MoleMole
{
	inline static constexpr unsigned int UIABPlayerItemMoveScript_TypeDefinitionIndex = 65376;
	...
	public:
		...
		::UnityEngine::Vector3 Field_5_11; // 0x40
