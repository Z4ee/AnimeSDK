...
#define MOLEMOLE_NAPSPLITSERIALIZED_MAINSCRIPTABLEOBJECT_ADDNEWBRANCH_OFFSET UNITYSDK_OFFSET(0x17DDCA00)
#define MOLEMOLE_NAPSPLITSERIALIZED_MAINSCRIPTABLEOBJECT_ISDEBUG_OFFSET UNITYSDK_OFFSET(0x17DDCBE0)
#define MOLEMOLE_NAPSPLITSERIALIZED_MAINSCRIPTABLEOBJECT_REFRESHSPLIT_OFFSET UNITYSDK_OFFSET(0x17DDCC30)
#define MOLEMOLE_NAPSPLITSERIALIZED_MAINSCRIPTABLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x17DDCE60)

namespace MoleMole
{
	inline static constexpr unsigned int NapSplitSerialized_MainScriptableObject_TypeDefinitionIndex = 41117;
