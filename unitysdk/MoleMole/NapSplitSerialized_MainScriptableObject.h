...
#define MOLEMOLE_NAPSPLITSERIALIZED_MAINSCRIPTABLEOBJECT_ADDNEWBRANCH_OFFSET UNITYSDK_OFFSET(0x190A2830)
#define MOLEMOLE_NAPSPLITSERIALIZED_MAINSCRIPTABLEOBJECT_ISDEBUG_OFFSET UNITYSDK_OFFSET(0x190A2A10)
#define MOLEMOLE_NAPSPLITSERIALIZED_MAINSCRIPTABLEOBJECT_REFRESHSPLIT_OFFSET UNITYSDK_OFFSET(0x190A2A60)
#define MOLEMOLE_NAPSPLITSERIALIZED_MAINSCRIPTABLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x190A2C90)

namespace MoleMole
{
	inline static constexpr unsigned int NapSplitSerialized_MainScriptableObject_TypeDefinitionIndex = 88228;
