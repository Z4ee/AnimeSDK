...
#define MOLEMOLE_UIPLAYERSKINSWITCHWIDGETCONTROLLER___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15BF7D30)
#define MOLEMOLE_UIPLAYERSKINSWITCHWIDGETCONTROLLER___C__DISPLAYCLASS11_0__SWITCHTOSKIN_B__0_OFFSET UNITYSDK_OFFSET(0x15BF7D40)
#define MOLEMOLE_UIPLAYERSKINSWITCHWIDGETCONTROLLER___C__DISPLAYCLASS11_0__SWITCHTOSKIN_B__1_OFFSET UNITYSDK_OFFSET(0x15BF7D50)

namespace MoleMole
{
	inline static constexpr unsigned int UIPlayerSkinSwitchWidgetController___c__DisplayClass11_0_TypeDefinitionIndex = 68105;
