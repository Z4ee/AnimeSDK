...
#define MOLEMOLE_UIACTIVITYABYSSZEROCOMPCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x191E2380)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityAbyssZeroCompContext_TypeDefinitionIndex = 84779;
