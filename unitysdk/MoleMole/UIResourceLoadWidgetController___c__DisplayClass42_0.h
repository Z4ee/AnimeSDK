...
#define MOLEMOLE_UIRESOURCELOADWIDGETCONTROLLER___C__DISPLAYCLASS42_0__CTOR_OFFSET UNITYSDK_OFFSET(0x13FF8A70)
#define MOLEMOLE_UIRESOURCELOADWIDGETCONTROLLER___C__DISPLAYCLASS42_0__STARTLOADGAMECONFIGASSETSBYLOADER_B__0_OFFSET UNITYSDK_OFFSET(0x13FF8A80)

namespace MoleMole
{
	inline static constexpr unsigned int UIResourceLoadWidgetController___c__DisplayClass42_0_TypeDefinitionIndex = 81091;
