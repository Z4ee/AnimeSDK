...
#define MOLEMOLE_SHAREDGAMEENTITY_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1703F7B0)
#define MOLEMOLE_SHAREDGAMEENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1703F880)

namespace MoleMole
{
	inline static constexpr unsigned int SharedGameEntity_TypeDefinitionIndex = 55622;
