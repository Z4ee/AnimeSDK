...
#define MOLEMOLE_UITITLESELECTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS55_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1340E620)
#define MOLEMOLE_UITITLESELECTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS55_0__ONUPDATETITLEDATA_B__0_OFFSET UNITYSDK_OFFSET(0x1340E630)

namespace MoleMole
{
	inline static constexpr unsigned int UITitleSelectDialogPopWindowController___c__DisplayClass55_0_TypeDefinitionIndex = 62084;

	class UITitleSelectDialogPopWindowController___c__DisplayClass55_0 : public ::System::Object
	{
	public:
		::Class_2_208CC9941471731A_990* variableTemplateExt; // 0x10
