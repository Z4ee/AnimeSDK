...
#define MOLEMOLE_UIMONSTERFANTASYEVENTPREPPAGECONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18676290)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyEventPrepPageController_Context_TypeDefinitionIndex = 91127;
