...
#define MOLEMOLE_UICINEMADATEPLAYWIDGETCONTROLLER__PLAYFAVOURSCOREUP_D__23_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x88AE90)
#define MOLEMOLE_UICINEMADATEPLAYWIDGETCONTROLLER__PLAYFAVOURSCOREUP_D__23_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaDatePlayWidgetController__PlayFavourScoreUp_d__23_TypeDefinitionIndex = 66828;
	...
	struct alignas(8) UICinemaDatePlayWidgetController__PlayFavourScoreUp_d__23
	{
		...
		::System::Threading::CancellationTokenSource* tokenSource; // 0x18
