...
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER___C__DISPLAYCLASS10_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18349F10)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER___C__DISPLAYCLASS10_0__DOREFRESHVIEWWITHLEVELUPGRADE_B__0_OFFSET UNITYSDK_OFFSET(0x18349F20)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER___C__DISPLAYCLASS10_0__DOREFRESHVIEWWITHLEVELUPGRADE_B__1_OFFSET UNITYSDK_OFFSET(0x1834A0C0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER___C__DISPLAYCLASS10_0__DOREFRESHVIEWWITHLEVELUPGRADE_B__2_OFFSET UNITYSDK_OFFSET(0x1834A120)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastLevelWidgetController___c__DisplayClass10_0_TypeDefinitionIndex = 49694;
