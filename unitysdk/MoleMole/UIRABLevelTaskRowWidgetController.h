...
#define MOLEMOLE_UIRABLEVELTASKROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15F5E140)
#define MOLEMOLE_UIRABLEVELTASKROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15F5E1B0)
#define MOLEMOLE_UIRABLEVELTASKROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15F5E250)
#define MOLEMOLE_UIRABLEVELTASKROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15F5E410)
#define MOLEMOLE_UIRABLEVELTASKROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15F5E470)
#define MOLEMOLE_UIRABLEVELTASKROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15F5E510)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABLevelTaskRowWidgetController_TypeDefinitionIndex = 72093;
