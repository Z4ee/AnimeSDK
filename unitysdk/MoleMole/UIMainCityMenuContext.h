...
#define MOLEMOLE_UIMAINCITYMENUCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15D4BC80)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityMenuContext_TypeDefinitionIndex = 52409;
