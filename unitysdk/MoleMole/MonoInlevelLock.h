...
#define MOLEMOLE_MONOINLEVELLOCK_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x142A70C0)
#define MOLEMOLE_MONOINLEVELLOCK_METHOD_5_62167C28EC14CC63_OFFSET UNITYSDK_OFFSET(0x142A7850)
#define MOLEMOLE_MONOINLEVELLOCK_METHOD_5_A88B36294D55B85C_OFFSET UNITYSDK_OFFSET(0x142A72F0)
#define MOLEMOLE_MONOINLEVELLOCK_METHOD_5_DEC8270AEB6D885D_OFFSET UNITYSDK_OFFSET(0x142A7600)
#define MOLEMOLE_MONOINLEVELLOCK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x142A6EB0)
#define MOLEMOLE_MONOINLEVELLOCK_RESET_OFFSET UNITYSDK_OFFSET(0x142A7220)
#define MOLEMOLE_MONOINLEVELLOCK_SETLOCKFOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x142A71D0)
#define MOLEMOLE_MONOINLEVELLOCK_START_OFFSET UNITYSDK_OFFSET(0x142A6C70)
#define MOLEMOLE_MONOINLEVELLOCK_UPDATEPOSITION_OFFSET UNITYSDK_OFFSET(0x142A7140)
#define MOLEMOLE_MONOINLEVELLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x142A7290)

namespace MoleMole
{
	inline static constexpr unsigned int MonoInlevelLock_TypeDefinitionIndex = 63261;
