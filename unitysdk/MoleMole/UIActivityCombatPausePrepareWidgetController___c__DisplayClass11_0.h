...
#define MOLEMOLE_UIACTIVITYCOMBATPAUSEPREPAREWIDGETCONTROLLER___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15A8AAA0)
#define MOLEMOLE_UIACTIVITYCOMBATPAUSEPREPAREWIDGETCONTROLLER___C__DISPLAYCLASS11_0__OPENTEAMPAGE_B__0_OFFSET UNITYSDK_OFFSET(0x15A8B290)
#define MOLEMOLE_UIACTIVITYCOMBATPAUSEPREPAREWIDGETCONTROLLER___C__DISPLAYCLASS11_0__OPENTEAMPAGE_B__1_OFFSET UNITYSDK_OFFSET(0x15A8AAB0)
#define MOLEMOLE_UIACTIVITYCOMBATPAUSEPREPAREWIDGETCONTROLLER___C__DISPLAYCLASS11_0__OPENTEAMPAGE_B__2_OFFSET UNITYSDK_OFFSET(0x15A8AD90)
#define MOLEMOLE_UIACTIVITYCOMBATPAUSEPREPAREWIDGETCONTROLLER___C__DISPLAYCLASS11_0__OPENTEAMPAGE_B__3_OFFSET UNITYSDK_OFFSET(0x15A8B1D0)
#define MOLEMOLE_UIACTIVITYCOMBATPAUSEPREPAREWIDGETCONTROLLER___C__DISPLAYCLASS11_0__OPENTEAMPAGE_B__5_OFFSET UNITYSDK_OFFSET(0x15A8ABF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityCombatPausePrepareWidgetController___c__DisplayClass11_0_TypeDefinitionIndex = 42099;
	...
	public:
		...
		::Class_2_208CC9941471731A_935* activityBattleQuestCfg; // 0x20
