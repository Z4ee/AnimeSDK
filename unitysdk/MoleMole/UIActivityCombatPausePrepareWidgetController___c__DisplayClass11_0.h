...
#define MOLEMOLE_UIACTIVITYCOMBATPAUSEPREPAREWIDGETCONTROLLER___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17424CE0)
#define MOLEMOLE_UIACTIVITYCOMBATPAUSEPREPAREWIDGETCONTROLLER___C__DISPLAYCLASS11_0__OPENTEAMPAGE_B__0_OFFSET UNITYSDK_OFFSET(0x174254E0)
#define MOLEMOLE_UIACTIVITYCOMBATPAUSEPREPAREWIDGETCONTROLLER___C__DISPLAYCLASS11_0__OPENTEAMPAGE_B__1_OFFSET UNITYSDK_OFFSET(0x17424CF0)
#define MOLEMOLE_UIACTIVITYCOMBATPAUSEPREPAREWIDGETCONTROLLER___C__DISPLAYCLASS11_0__OPENTEAMPAGE_B__2_OFFSET UNITYSDK_OFFSET(0x17424FE0)
#define MOLEMOLE_UIACTIVITYCOMBATPAUSEPREPAREWIDGETCONTROLLER___C__DISPLAYCLASS11_0__OPENTEAMPAGE_B__3_OFFSET UNITYSDK_OFFSET(0x17425420)
#define MOLEMOLE_UIACTIVITYCOMBATPAUSEPREPAREWIDGETCONTROLLER___C__DISPLAYCLASS11_0__OPENTEAMPAGE_B__5_OFFSET UNITYSDK_OFFSET(0x17424E40)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityCombatPausePrepareWidgetController___c__DisplayClass11_0_TypeDefinitionIndex = 80730;
