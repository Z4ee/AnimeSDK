...
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x12FD9180)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER_GET__RELICDIC_OFFSET UNITYSDK_OFFSET(0x12FDBD00)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER_GET__RELICLIST_OFFSET UNITYSDK_OFFSET(0x12FDC250)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER_INITTAB_OFFSET UNITYSDK_OFFSET(0x12FD9410)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12FDB2D0)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER_ONLEFTTABCLICK_OFFSET UNITYSDK_OFFSET(0x12FDB620)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER_ONRIGHTBTNCLICK_OFFSET UNITYSDK_OFFSET(0x12FDBD80)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12FDB360)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12FD9190)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12FD9320)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER_SETAVATARBTNSELECT_OFFSET UNITYSDK_OFFSET(0x12FDBF20)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER_TRYGETDEFAULTTABINDEXBYRELICID_OFFSET UNITYSDK_OFFSET(0x12FDB3D0)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12FDC390)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER__ONLEFTTABCLICK_B__9_0_OFFSET UNITYSDK_OFFSET(0x12FDC4C0)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12FDC4E0)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12FDC570)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12FDC580)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12FDC590)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssBackstageRelicInfoPopWindowController_TypeDefinitionIndex = 54236;

	class UIAbyssBackstageRelicInfoPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_DD0C18373FC569C0* _view; // 0x310
		::MoleMole::UIAbyssBackstageRelicInfoPopContext* _context; // 0x318
		::System::Int32 _pendingRightTabIndex; // 0x320
		::System::Int32 _leftTabIndex; // 0x324
		::System::Int32 _rightTabIndex; // 0x328
		::System::Collections::Generic::List_1<::Class_2_541EA3F0D78A7596*>* _genreList; // 0x330
		::System::Collections::Generic::List_1<::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::System::Int32>*>*>* _relicDicList; // 0x338
		::System::Collections::Generic::List_1<::System::Int32>* _avatarList; // 0x340
		::System::Collections::Generic::List_1<::MoleMole::UIYorozuyaAbyssS3RoleBigItemRowWidgetController*>* _avatarBtnList; // 0x348
