...
#define MOLEMOLE_QUESTTIPPOPSHOW_GETVIDEOPATH_OFFSET UNITYSDK_OFFSET(0x10D81CE0)
#define MOLEMOLE_QUESTTIPPOPSHOW_GET_ISBLOCKCENTER_OFFSET UNITYSDK_OFFSET(0x10D81AD0)
#define MOLEMOLE_QUESTTIPPOPSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x10D81AC0)
#define MOLEMOLE_QUESTTIPPOPSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x10D81B10)
#define MOLEMOLE_QUESTTIPPOPSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x10D81AE0)

namespace MoleMole
{
	inline static constexpr unsigned int QuestTipPopShow_TypeDefinitionIndex = 47391;
