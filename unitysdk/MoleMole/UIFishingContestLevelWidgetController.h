...
#define MOLEMOLE_UIFISHINGCONTESTLEVELWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16783500)
#define MOLEMOLE_UIFISHINGCONTESTLEVELWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16783590)
#define MOLEMOLE_UIFISHINGCONTESTLEVELWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16783430)
#define MOLEMOLE_UIFISHINGCONTESTLEVELWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16783490)
#define MOLEMOLE_UIFISHINGCONTESTLEVELWIDGETCONTROLLER_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0x167843D0)
#define MOLEMOLE_UIFISHINGCONTESTLEVELWIDGETCONTROLLER_PLAYLEVELUPANIMATION_1_OFFSET UNITYSDK_OFFSET(0x167845C0)
#define MOLEMOLE_UIFISHINGCONTESTLEVELWIDGETCONTROLLER_PLAYLEVELUPANIMATION_OFFSET UNITYSDK_OFFSET(0x167844E0)
#define MOLEMOLE_UIFISHINGCONTESTLEVELWIDGETCONTROLLER_SHOWLEVELPROGRESS_OFFSET UNITYSDK_OFFSET(0x16783610)
#define MOLEMOLE_UIFISHINGCONTESTLEVELWIDGETCONTROLLER_SHOWLEVEL_OFFSET UNITYSDK_OFFSET(0x16783AC0)
#define MOLEMOLE_UIFISHINGCONTESTLEVELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16784780)
#define MOLEMOLE_UIFISHINGCONTESTLEVELWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x167847F0)
#define MOLEMOLE_UIFISHINGCONTESTLEVELWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16784880)
#define MOLEMOLE_UIFISHINGCONTESTLEVELWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16784910)
#define MOLEMOLE_UIFISHINGCONTESTLEVELWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x167849A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFishingContestLevelWidgetController_TypeDefinitionIndex = 77202;
