...
#define MOLEMOLE_UIGENERALOPTIONTITLEROWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1580CF20)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralOptionTitleRowContext_TypeDefinitionIndex = 46665;
