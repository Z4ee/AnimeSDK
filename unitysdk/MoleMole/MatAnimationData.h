...
#define MOLEMOLE_MATANIMATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x170DB020)

namespace MoleMole
{
	inline static constexpr unsigned int MatAnimationData_TypeDefinitionIndex = 67000;
