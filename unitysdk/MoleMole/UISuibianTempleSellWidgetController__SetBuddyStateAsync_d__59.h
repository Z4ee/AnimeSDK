...
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER__SETBUDDYSTATEASYNC_D__59_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x7570A0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER__SETBUDDYSTATEASYNC_D__59_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleSellWidgetController__SetBuddyStateAsync_d__59_TypeDefinitionIndex = 45983;
	...
	struct alignas(8) UISuibianTempleSellWidgetController__SetBuddyStateAsync_d__59
	{
		...
		::System::Threading::CancellationToken _cancelToken_5__2; // 0x18
