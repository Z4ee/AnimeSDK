...
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER__SETBUDDYSTATEASYNC_D__59_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x79C000)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER__SETBUDDYSTATEASYNC_D__59_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2661E0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleSellWidgetController__SetBuddyStateAsync_d__59_TypeDefinitionIndex = 81140;
	...
	struct alignas(8) UISuibianTempleSellWidgetController__SetBuddyStateAsync_d__59
	{
		...
		::MoleMole::UISuibianTempleSellWidgetController* __4__this; // 0x28
