...
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER_GET_PLAYANIMWITHPARENT_OFFSET UNITYSDK_OFFSET(0x1732C160)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1732C230)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x1732C3D0)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x1732C380)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1732C330)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1732C2C0)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1732C170)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1732C1D0)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1732C4A0)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1732C500)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x1732C590)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x1732C620)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1732C630)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1732C640)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1732C650)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1732C6E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivitySignInInfoWidgetController_TypeDefinitionIndex = 75876;

	class UIActivitySignInInfoWidgetController : public ::MoleMole::ActivityGuideUIBaseWidgetController
	{
	public:
		::Class_2_1060F418DF0EA240* _view; // 0x2E8
