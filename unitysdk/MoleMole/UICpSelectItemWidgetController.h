...
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER_GETHOST_OFFSET UNITYSDK_OFFSET(0x1D86B230)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1D86B360)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x1D86B4F0)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1D86B6A0)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1D86B610)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1D86AF20)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1D86B2E0)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER_SENDCLICK_OFFSET UNITYSDK_OFFSET(0x1D86B010)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D86BE90)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER__ONUIINIT_B__4_0_OFFSET UNITYSDK_OFFSET(0x1D86BEA0)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1D86BEB0)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x1D86BF40)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1D86BFD0)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1D86C070)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1D86C100)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1D86C190)

namespace MoleMole
{
	inline static constexpr unsigned int UICpSelectItemWidgetController_TypeDefinitionIndex = 90933;
