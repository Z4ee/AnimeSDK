...
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER_GETHOST_OFFSET UNITYSDK_OFFSET(0x1B208940)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1B208A70)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x1B208C00)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1B208DB0)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1B208D20)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1B208640)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1B2089F0)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER_SENDCLICK_OFFSET UNITYSDK_OFFSET(0x1B208730)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2095A0)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER__ONUIINIT_B__4_0_OFFSET UNITYSDK_OFFSET(0x1B2095B0)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1B2095C0)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x1B209650)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1B2096E0)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1B209780)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1B209810)
#define MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1B2098A0)

namespace MoleMole
{
	inline static constexpr unsigned int UICpSelectItemWidgetController_TypeDefinitionIndex = 85276;

	class UICpSelectItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_9FBB709904E5162A* _view; // 0x2E8
		::Class_1_D76391934630D6CD* _info; // 0x2F0
		::MoleMole::UIGeneralPopUpHintWidgetController* _popCtrl; // 0x2F8
		::System::Boolean showRedpoint; // 0x300
		::System::Func_2<::Foundation::AssetPath, ::UnityEngine::Sprite*>* _loadSprite; // 0x308
		...
		{
			return ((::Class_3_01B4CC30216C9ABE_3*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UICPSELECTITEMWIDGETCONTROLLER_GETHOST_OFFSET))(this);
		}
