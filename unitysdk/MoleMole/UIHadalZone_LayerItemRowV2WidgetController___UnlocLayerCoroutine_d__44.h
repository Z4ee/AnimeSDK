...
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER___UNLOCLAYERCOROUTINE_D__44_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x171FB920)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER___UNLOCLAYERCOROUTINE_D__44_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x171FBE00)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER___UNLOCLAYERCOROUTINE_D__44_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x171FBE60)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER___UNLOCLAYERCOROUTINE_D__44_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x171FBE10)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER___UNLOCLAYERCOROUTINE_D__44_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x171FB910)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER___UNLOCLAYERCOROUTINE_D__44__CTOR_OFFSET UNITYSDK_OFFSET(0x171FB900)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_LayerItemRowV2WidgetController___UnlocLayerCoroutine_d__44_TypeDefinitionIndex = 68195;
	...
	public:
		...
		::MoleMole::UIHadalZone_LayerItemRowV2WidgetController___c__DisplayClass44_0* __8__1; // 0x18
		::System::Int32 __1__state; // 0x20
		::System::Single _start_5__3; // 0x24
