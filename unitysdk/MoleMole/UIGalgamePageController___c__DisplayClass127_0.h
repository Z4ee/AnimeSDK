...
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS127_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15F7D2A0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS127_0__GENERATEUIZOOMPLAYABLE_B__0_OFFSET UNITYSDK_OFFSET(0x15F7D2B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgamePageController___c__DisplayClass127_0_TypeDefinitionIndex = 41799;
	...
	public:
		...
		::MoleMole::UIGalgamePageController_StageZoomInfo* stageZoomInfo; // 0x20
