...
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_DELAYCLOSE_OFFSET UNITYSDK_OFFSET(0x152797E0)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_GET_ISBUSYING_OFFSET UNITYSDK_OFFSET(0x15279DD0)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_ONCHALLENGEUPDATE_OFFSET UNITYSDK_OFFSET(0x15279990)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15278FF0)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x15279080)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x152790D0)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15278BE0)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15278C40)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_PLAYCLOSE_OFFSET UNITYSDK_OFFSET(0x15279860)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_PLAYCOMPLETE_OFFSET UNITYSDK_OFFSET(0x15279590)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_REGISTERCHALLENGE_OFFSET UNITYSDK_OFFSET(0x15279650)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_REPLAY_OFFSET UNITYSDK_OFFSET(0x15279440)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_SETICONTYPE_OFFSET UNITYSDK_OFFSET(0x15278ED0)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_SETTEXT_OFFSET UNITYSDK_OFFSET(0x15279150)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15279E50)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER__DELAYCLOSE_B__22_0_OFFSET UNITYSDK_OFFSET(0x1527A240)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER__GETSTAYDURATION_OFFSET UNITYSDK_OFFSET(0x15279250)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER__REGISTERCHALLENGE_B__21_0_OFFSET UNITYSDK_OFFSET(0x15279EB0)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1527A250)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x1527A2E0)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1527A2F0)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1527A380)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1527A410)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelRankingSABInfoRowWidgetController_TypeDefinitionIndex = 64117;

	class UIInLevelRankingSABInfoRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_EA00FF79749FF75E* _view; // 0x2B8
		::System::Int32 ListenChallengeId; // 0x2C0
		::Enum_3_BD9BD7E290475B28 _iconType; // 0x2C4
		::MoleMole::UIInLevelRankingSABInfoRowConfig* _config; // 0x2C8
		::MoleMole::UICommonTimeCoolDownWidgetController* SwitchTeamBattleTime; // 0x2D0
		::System::Boolean isInReplay; // 0x2D8
