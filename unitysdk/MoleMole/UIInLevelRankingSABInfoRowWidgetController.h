...
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_DELAYCLOSE_OFFSET UNITYSDK_OFFSET(0x17DD05C0)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_GET_ISBUSYING_OFFSET UNITYSDK_OFFSET(0x17DD0BB0)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_ONCHALLENGEUPDATE_OFFSET UNITYSDK_OFFSET(0x17DD0770)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17DCFE10)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17DCFEA0)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17DCFEF0)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17DCFA00)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17DCFA60)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_PLAYCLOSE_OFFSET UNITYSDK_OFFSET(0x17DD0640)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_PLAYCOMPLETE_OFFSET UNITYSDK_OFFSET(0x17DD0370)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_REGISTERCHALLENGE_OFFSET UNITYSDK_OFFSET(0x17DD0430)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_REPLAY_OFFSET UNITYSDK_OFFSET(0x17DD0220)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_SETICONTYPE_OFFSET UNITYSDK_OFFSET(0x17DCFCF0)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_SETTEXT_OFFSET UNITYSDK_OFFSET(0x17DCFF70)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17DD0C30)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER__DELAYCLOSE_B__22_0_OFFSET UNITYSDK_OFFSET(0x17DD1020)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER__GETSTAYDURATION_OFFSET UNITYSDK_OFFSET(0x17DD0030)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER__REGISTERCHALLENGE_B__21_0_OFFSET UNITYSDK_OFFSET(0x17DD0C90)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17DD1030)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17DD10C0)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17DD10D0)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17DD1160)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17DD11F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelRankingSABInfoRowWidgetController_TypeDefinitionIndex = 89111;
