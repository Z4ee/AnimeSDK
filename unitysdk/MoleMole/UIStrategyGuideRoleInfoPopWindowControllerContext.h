...
#define MOLEMOLE_UISTRATEGYGUIDEROLEINFOPOPWINDOWCONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x17D55D10)

namespace MoleMole
{
	inline static constexpr unsigned int UIStrategyGuideRoleInfoPopWindowControllerContext_TypeDefinitionIndex = 50359;
	...
	public:
		...
		::System::Boolean IsPreviewMode; // 0x40
