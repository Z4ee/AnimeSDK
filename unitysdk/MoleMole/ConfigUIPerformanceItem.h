...
#define MOLEMOLE_CONFIGUIPERFORMANCEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x157D8B00)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIPerformanceItem_TypeDefinitionIndex = 62720;
