...
#define MOLEMOLE_UIHOLLOWSPEEDUPKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_LOCKEDSETTINGRAWINPUTDEVICELIST_OFFSET UNITYSDK_OFFSET(0x15FACAC0)
#define MOLEMOLE_UIHOLLOWSPEEDUPKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x15FACAA0)
#define MOLEMOLE_UIHOLLOWSPEEDUPKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x15FACAB0)
#define MOLEMOLE_UIHOLLOWSPEEDUPKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x15FACB50)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowSpeedUpKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 82958;
