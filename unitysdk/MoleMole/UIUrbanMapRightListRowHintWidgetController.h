...
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWHINTWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x12C83E00)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWHINTWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x12C83E70)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWHINTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x12C83F30)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWHINTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12C84090)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWHINTWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x12C840F0)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWHINTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x12C84190)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapRightListRowHintWidgetController_TypeDefinitionIndex = 53374;
