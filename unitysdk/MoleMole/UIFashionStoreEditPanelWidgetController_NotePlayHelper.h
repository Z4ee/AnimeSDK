...
#define MOLEMOLE_UIFASHIONSTOREEDITPANELWIDGETCONTROLLER_NOTEPLAYHELPER_INIT_OFFSET UNITYSDK_OFFSET(0x19AAEEB0)
#define MOLEMOLE_UIFASHIONSTOREEDITPANELWIDGETCONTROLLER_NOTEPLAYHELPER_PLAYSOUND_OFFSET UNITYSDK_OFFSET(0x19AAEF60)
#define MOLEMOLE_UIFASHIONSTOREEDITPANELWIDGETCONTROLLER_NOTEPLAYHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x19AAEEA0)
#define MOLEMOLE_UIFASHIONSTOREEDITPANELWIDGETCONTROLLER_NOTEPLAYHELPER___BASE_PLAYSOUND_OFFSET UNITYSDK_OFFSET(0x19AAF6C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFashionStoreEditPanelWidgetController_NotePlayHelper_TypeDefinitionIndex = 82649;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_135*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIFASHIONSTOREEDITPANELWIDGETCONTROLLER_NOTEPLAYHELPER__CTOR_OFFSET))(this, autoDisposePool);
		}

		::System::Void Init(::Class_2_720FD421F092FF93_Class_0_16E7307DCC43CB2C_9* fashionStoreData, ::Class_2_720FD421F092FF93_Class_2_97C8D60D51E8546D_1* fashionStoreTrackData, ::MoleMole::UIFashionStorePreviewPanelWidgetController_MusicRowData* musicRowData, ::Class_0_16E4307DCC419505_164<::System::Boolean>* isShow)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_720FD421F092FF93_Class_0_16E7307DCC43CB2C_9*, ::Class_2_720FD421F092FF93_Class_2_97C8D60D51E8546D_1*, ::MoleMole::UIFashionStorePreviewPanelWidgetController_MusicRowData*, ::Class_0_16E4307DCC419505_164<::System::Boolean>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIFASHIONSTOREEDITPANELWIDGETCONTROLLER_NOTEPLAYHELPER_INIT_OFFSET))(this, fashionStoreData, fashionStoreTrackData, musicRowData, isShow);
		}
