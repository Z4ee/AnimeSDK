...
#define MOLEMOLE_AMBVOLUMESETTINGENTRY_GETSETTINGCONTROLUNIT_OFFSET UNITYSDK_OFFSET(0x12C48F00)
#define MOLEMOLE_AMBVOLUMESETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x12C48EF0)
#define MOLEMOLE_AMBVOLUMESETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x12C49020)
#define MOLEMOLE_AMBVOLUMESETTINGENTRY___BASE_GETSETTINGCONTROLUNIT_OFFSET UNITYSDK_OFFSET(0x12C49040)

namespace MoleMole
{
	inline static constexpr unsigned int AmbVolumeSettingEntry_TypeDefinitionIndex = 65280;
