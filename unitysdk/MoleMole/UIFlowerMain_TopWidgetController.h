...
#define MOLEMOLE_UIFLOWERMAIN_TOPWIDGETCONTROLLER_BINDBUTTON_OFFSET UNITYSDK_OFFSET(0x187FEC30)
#define MOLEMOLE_UIFLOWERMAIN_TOPWIDGETCONTROLLER_BUILDDATABINDING_OFFSET UNITYSDK_OFFSET(0x187FF020)
#define MOLEMOLE_UIFLOWERMAIN_TOPWIDGETCONTROLLER_BUILDVIEWMODELDATABINDING_OFFSET UNITYSDK_OFFSET(0x187FEDA0)
#define MOLEMOLE_UIFLOWERMAIN_TOPWIDGETCONTROLLER_CREATESUBWIDGET_OFFSET UNITYSDK_OFFSET(0x187FF0B0)
#define MOLEMOLE_UIFLOWERMAIN_TOPWIDGETCONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x187FF180)
#define MOLEMOLE_UIFLOWERMAIN_TOPWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x187FF0F0)
#define MOLEMOLE_UIFLOWERMAIN_TOPWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x187FEF00)
#define MOLEMOLE_UIFLOWERMAIN_TOPWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x187FF240)
#define MOLEMOLE_UIFLOWERMAIN_TOPWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x187FEB50)
#define MOLEMOLE_UIFLOWERMAIN_TOPWIDGETCONTROLLER__BUILDVIEWMODELDATABINDING_B__8_0_OFFSET UNITYSDK_OFFSET(0x187FF320)
#define MOLEMOLE_UIFLOWERMAIN_TOPWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x187FF2C0)
#define MOLEMOLE_UIFLOWERMAIN_TOPWIDGETCONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x187FF440)
#define MOLEMOLE_UIFLOWERMAIN_TOPWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x187FF4D0)
#define MOLEMOLE_UIFLOWERMAIN_TOPWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x187FF560)
#define MOLEMOLE_UIFLOWERMAIN_TOPWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x187FF600)
#define MOLEMOLE_UIFLOWERMAIN_TOPWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x187FF690)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerMain_TopWidgetController_TypeDefinitionIndex = 71067;
