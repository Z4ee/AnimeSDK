...
#define MOLEMOLE_MAINCITYRUNGAMEPADBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x191347B0)
#define MOLEMOLE_MAINCITYRUNGAMEPADBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x191347C0)
#define MOLEMOLE_MAINCITYRUNGAMEPADBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x191347D0)

namespace MoleMole
{
	inline static constexpr unsigned int MainCityRunGamepadBindingSettingEntry_TypeDefinitionIndex = 58958;
