...
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER___C__DISPLAYCLASS25_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16979AE0)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER___C__DISPLAYCLASS25_0__INITCHOICEOBJ_B__0_OFFSET UNITYSDK_OFFSET(0x16979AF0)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER___C__DISPLAYCLASS25_0__INITCHOICEOBJ_B__1_OFFSET UNITYSDK_OFFSET(0x16979C70)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER___C__DISPLAYCLASS25_0__INITCHOICEOBJ_B__2_OFFSET UNITYSDK_OFFSET(0x16979CA0)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER___C__DISPLAYCLASS25_0__INITCHOICEOBJ_B__3_OFFSET UNITYSDK_OFFSET(0x16979CF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowEventWidgetChildWindowController___c__DisplayClass25_0_TypeDefinitionIndex = 56240;
