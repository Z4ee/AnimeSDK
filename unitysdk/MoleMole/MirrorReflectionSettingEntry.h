...
#define MOLEMOLE_MIRRORREFLECTIONSETTINGENTRY_GET_PROFILETYPE_OFFSET UNITYSDK_OFFSET(0x1A03E450)
#define MOLEMOLE_MIRRORREFLECTIONSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A03E440)
#define MOLEMOLE_MIRRORREFLECTIONSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A03E460)

namespace MoleMole
{
	inline static constexpr unsigned int MirrorReflectionSettingEntry_TypeDefinitionIndex = 74884;
