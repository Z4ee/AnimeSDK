...
#define MOLEMOLE_UILINEUPSELECTPAGECONTROLLER_UIBUDDYSELECT_BUILDRT_OFFSET UNITYSDK_OFFSET(0x16C0A410)
#define MOLEMOLE_UILINEUPSELECTPAGECONTROLLER_UIBUDDYSELECT_GET_UNIT_OFFSET UNITYSDK_OFFSET(0x16C0A3E0)
#define MOLEMOLE_UILINEUPSELECTPAGECONTROLLER_UIBUDDYSELECT_RELEASE_OFFSET UNITYSDK_OFFSET(0x16C0A4F0)
#define MOLEMOLE_UILINEUPSELECTPAGECONTROLLER_UIBUDDYSELECT_SET_UNIT_OFFSET UNITYSDK_OFFSET(0x16C0A3F0)
#define MOLEMOLE_UILINEUPSELECTPAGECONTROLLER_UIBUDDYSELECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16C0A400)

namespace MoleMole
{
	inline static constexpr unsigned int UILineupSelectPageController_UIBuddySelect_TypeDefinitionIndex = 79055;
