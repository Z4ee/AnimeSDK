...
#define MOLEMOLE_UILINEUPSELECTPAGECONTROLLER_UIBUDDYSELECT_BUILDRT_OFFSET UNITYSDK_OFFSET(0x19C9BE40)
#define MOLEMOLE_UILINEUPSELECTPAGECONTROLLER_UIBUDDYSELECT_GET_UNIT_OFFSET UNITYSDK_OFFSET(0x19C9BE10)
#define MOLEMOLE_UILINEUPSELECTPAGECONTROLLER_UIBUDDYSELECT_RELEASE_OFFSET UNITYSDK_OFFSET(0x19C9BF20)
#define MOLEMOLE_UILINEUPSELECTPAGECONTROLLER_UIBUDDYSELECT_SET_UNIT_OFFSET UNITYSDK_OFFSET(0x19C9BE20)
#define MOLEMOLE_UILINEUPSELECTPAGECONTROLLER_UIBUDDYSELECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C9BE30)

namespace MoleMole
{
	inline static constexpr unsigned int UILineupSelectPageController_UIBuddySelect_TypeDefinitionIndex = 82702;
