...
#define MOLEMOLE_CAMERAFOLLOWENTITYTRANSFORMCALCULATOR_PROCESSS_OFFSET UNITYSDK_OFFSET(0x116CBB10)
#define MOLEMOLE_CAMERAFOLLOWENTITYTRANSFORMCALCULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x116CC040)
#define MOLEMOLE_CAMERAFOLLOWENTITYTRANSFORMCALCULATOR___BASE_PROCESSS_OFFSET UNITYSDK_OFFSET(0x116CC050)

namespace MoleMole
{
	inline static constexpr unsigned int CameraFollowEntityTransformCalculator_TypeDefinitionIndex = 86515;
