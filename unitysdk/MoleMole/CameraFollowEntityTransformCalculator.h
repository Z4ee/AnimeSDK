...
#define MOLEMOLE_CAMERAFOLLOWENTITYTRANSFORMCALCULATOR_PROCESSS_OFFSET UNITYSDK_OFFSET(0x10CD1900)
#define MOLEMOLE_CAMERAFOLLOWENTITYTRANSFORMCALCULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x10CD1E30)
#define MOLEMOLE_CAMERAFOLLOWENTITYTRANSFORMCALCULATOR___BASE_PROCESSS_OFFSET UNITYSDK_OFFSET(0x10CD1E40)

namespace MoleMole
{
	inline static constexpr unsigned int CameraFollowEntityTransformCalculator_TypeDefinitionIndex = 51385;
