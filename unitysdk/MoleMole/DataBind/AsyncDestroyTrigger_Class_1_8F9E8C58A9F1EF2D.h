...
#define MOLEMOLE_DATABIND_ASYNCDESTROYTRIGGER_CLASS_1_8F9E8C58A9F1EF2D_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1C928CF0)
#define MOLEMOLE_DATABIND_ASYNCDESTROYTRIGGER_CLASS_1_8F9E8C58A9F1EF2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1C928BF0)

namespace MoleMole::DataBind
{
	inline static constexpr unsigned int AsyncDestroyTrigger_Class_1_8F9E8C58A9F1EF2D_TypeDefinitionIndex = 34532;
