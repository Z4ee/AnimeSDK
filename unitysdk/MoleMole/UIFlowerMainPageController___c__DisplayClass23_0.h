...
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER___C__DISPLAYCLASS23_0__CTOR_OFFSET UNITYSDK_OFFSET(0x166CC530)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER___C__DISPLAYCLASS23_0__ONCLICKFINISHBUTTON_B__0_OFFSET UNITYSDK_OFFSET(0x166CC540)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER___C__DISPLAYCLASS23_0__ONCLICKFINISHBUTTON_B__1_OFFSET UNITYSDK_OFFSET(0x166CC570)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerMainPageController___c__DisplayClass23_0_TypeDefinitionIndex = 67749;
