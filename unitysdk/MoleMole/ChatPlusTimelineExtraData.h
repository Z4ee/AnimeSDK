...
#define MOLEMOLE_CHATPLUSTIMELINEEXTRADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17D27050)

namespace MoleMole
{
	inline static constexpr unsigned int ChatPlusTimelineExtraData_TypeDefinitionIndex = 57130;
