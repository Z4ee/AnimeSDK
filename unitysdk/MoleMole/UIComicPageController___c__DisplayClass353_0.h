...
#define MOLEMOLE_UICOMICPAGECONTROLLER___C__DISPLAYCLASS353_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1605FD80)
#define MOLEMOLE_UICOMICPAGECONTROLLER___C__DISPLAYCLASS353_0__SETUPBUBBLEAUDIOS_B__0_OFFSET UNITYSDK_OFFSET(0x1605FD90)
#define MOLEMOLE_UICOMICPAGECONTROLLER___C__DISPLAYCLASS353_0__SETUPBUBBLEAUDIOS_B__1_OFFSET UNITYSDK_OFFSET(0x1605FDC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIComicPageController___c__DisplayClass353_0_TypeDefinitionIndex = 87109;
