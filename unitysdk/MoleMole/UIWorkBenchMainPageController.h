...
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_BINDEVENT_OFFSET UNITYSDK_OFFSET(0x12C98930)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_CANOPENAPP_OFFSET UNITYSDK_OFFSET(0x12C999B0)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_CREATEWIDGET_OFFSET UNITYSDK_OFFSET(0x12C98810)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_GETAPPBGCOLOR_OFFSET UNITYSDK_OFFSET(0x12C99890)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x12C986D0)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_ICONSCROLLVIEWONMOVE_OFFSET UNITYSDK_OFFSET(0x12C9ADA0)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_INITAPPICONSDATA_OFFSET UNITYSDK_OFFSET(0x12C98E90)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_INITAPPICONSVIEW_OFFSET UNITYSDK_OFFSET(0x12C98A50)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_ONCLICKBIGBTN_OFFSET UNITYSDK_OFFSET(0x12C9A780)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12C986E0)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_ONPOSTPAGESHOWED_OFFSET UNITYSDK_OFFSET(0x12C99790)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x12C99710)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12C995C0)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12C98770)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12C99550)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_SELECTEDAPPICON_1_OFFSET UNITYSDK_OFFSET(0x12C9A7E0)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_SELECTEDAPPICON_OFFSET UNITYSDK_OFFSET(0x12C9B070)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_TRYOPENAPP_OFFSET UNITYSDK_OFFSET(0x12C99CB0)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_WARMUPTRANSITIONCONTROLLER_OFFSET UNITYSDK_OFFSET(0x12C98D20)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x12C9B300)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12C9B260)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER__INITAPPICONSDATA_B__25_1_OFFSET UNITYSDK_OFFSET(0x12C9B310)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER__INITAPPICONSDATA_B__25_2_OFFSET UNITYSDK_OFFSET(0x12C9B3F0)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12C9B660)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER___BASE_ONPOSTPAGESHOWED_OFFSET UNITYSDK_OFFSET(0x12C9B6F0)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x12C9B700)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12C9B710)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12C9B720)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12C9B730)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkBenchMainPageController_TypeDefinitionIndex = 47422;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIWorkBenchMainPageController_TypeDefinitionIndex)->GetStaticField(0x11C90);
		}
