...
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS96_0__CTOR_OFFSET UNITYSDK_OFFSET(0x14845F70)
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS96_0__PLAYACTIVITYTIP_B__0_OFFSET UNITYSDK_OFFSET(0x148460C0)
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS96_0__PLAYACTIVITYTIP_B__3_OFFSET UNITYSDK_OFFSET(0x14845F80)

namespace MoleMole
{
	inline static constexpr unsigned int UIMissionTipsContainerWidgetController___c__DisplayClass96_0_TypeDefinitionIndex = 55054;
