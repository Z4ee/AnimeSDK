...
#define MOLEMOLE_UIMAINCITYSIDEBARSKINITEMWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x184E31F0)
#define MOLEMOLE_UIMAINCITYSIDEBARSKINITEMWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x184E3260)
#define MOLEMOLE_UIMAINCITYSIDEBARSKINITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x184E3300)
#define MOLEMOLE_UIMAINCITYSIDEBARSKINITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x184E33C0)
#define MOLEMOLE_UIMAINCITYSIDEBARSKINITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x184E3540)
#define MOLEMOLE_UIMAINCITYSIDEBARSKINITEMWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x184E3550)
#define MOLEMOLE_UIMAINCITYSIDEBARSKINITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x184E35F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCitySidebarSkinItemWidgetController_TypeDefinitionIndex = 91144;
