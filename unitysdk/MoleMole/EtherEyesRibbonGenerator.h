...
#define MOLEMOLE_ETHEREYESRIBBONGENERATOR_AWAKE_OFFSET UNITYSDK_OFFSET(0x1497F890)
#define MOLEMOLE_ETHEREYESRIBBONGENERATOR_METHOD_5_40EBA7013E4CCDDF_OFFSET UNITYSDK_OFFSET(0x1497F840)
#define MOLEMOLE_ETHEREYESRIBBONGENERATOR_METHOD_5_489E0B827662C211_OFFSET UNITYSDK_OFFSET(0x149803F0)
#define MOLEMOLE_ETHEREYESRIBBONGENERATOR_METHOD_5_6675531D375F235D_OFFSET UNITYSDK_OFFSET(0x1497FC40)
#define MOLEMOLE_ETHEREYESRIBBONGENERATOR_METHOD_5_CFE6FB160FFF5938_OFFSET UNITYSDK_OFFSET(0x14982460)
#define MOLEMOLE_ETHEREYESRIBBONGENERATOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1497F740)
#define MOLEMOLE_ETHEREYESRIBBONGENERATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x1497FBE0)
#define MOLEMOLE_ETHEREYESRIBBONGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x149823F0)

namespace MoleMole
{
	inline static constexpr unsigned int EtherEyesRibbonGenerator_TypeDefinitionIndex = 38385;
