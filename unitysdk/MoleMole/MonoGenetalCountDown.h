...
#define MOLEMOLE_MONOGENETALCOUNTDOWN_HASTIMESWITCHING_OFFSET UNITYSDK_OFFSET(0x170EC2F0)
#define MOLEMOLE_MONOGENETALCOUNTDOWN_METHOD_5_FA67A5A26F4AE823_OFFSET UNITYSDK_OFFSET(0x15838790)
#define MOLEMOLE_MONOGENETALCOUNTDOWN_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x170EC810)
#define MOLEMOLE_MONOGENETALCOUNTDOWN_RESET_OFFSET UNITYSDK_OFFSET(0x170EAF00)
#define MOLEMOLE_MONOGENETALCOUNTDOWN_SETTIMEFORCE_OFFSET UNITYSDK_OFFSET(0x170EB1C0)
#define MOLEMOLE_MONOGENETALCOUNTDOWN_SETTIMEICONFORCE_OFFSET UNITYSDK_OFFSET(0x170EB2A0)
#define MOLEMOLE_MONOGENETALCOUNTDOWN_SETTIMEICON_OFFSET UNITYSDK_OFFSET(0x170EBBB0)
#define MOLEMOLE_MONOGENETALCOUNTDOWN_SETTIME_OFFSET UNITYSDK_OFFSET(0x170EBAB0)
#define MOLEMOLE_MONOGENETALCOUNTDOWN_WILLCHANGETIMEICON_OFFSET UNITYSDK_OFFSET(0x170EB770)
#define MOLEMOLE_MONOGENETALCOUNTDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x15838740)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGenetalCountDown_TypeDefinitionIndex = 57173;
	...
	public:
		...
		::System::Boolean HasTimeSwitching(::Class_2_208CC9941471731A_575*& a1)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_2_208CC9941471731A_575*&))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGENETALCOUNTDOWN_HASTIMESWITCHING_OFFSET))(this, a1);
		}
