...
#define MOLEMOLE_SUIBIANDEVELOPRIGHTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16890F30)

namespace MoleMole
{
	inline static constexpr unsigned int SuibianDevelopRightContext_TypeDefinitionIndex = 73479;
