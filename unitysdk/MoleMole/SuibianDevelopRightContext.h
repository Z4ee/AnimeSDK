...
#define MOLEMOLE_SUIBIANDEVELOPRIGHTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15BB6DF0)

namespace MoleMole
{
	inline static constexpr unsigned int SuibianDevelopRightContext_TypeDefinitionIndex = 58664;
