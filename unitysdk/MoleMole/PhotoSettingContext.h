...
#define MOLEMOLE_PHOTOSETTINGCONTEXT_GET_INITTABTYPE_OFFSET UNITYSDK_OFFSET(0x15BB0900)
#define MOLEMOLE_PHOTOSETTINGCONTEXT_GET_ISSHOWFRAME_OFFSET UNITYSDK_OFFSET(0x15BB08A0)
#define MOLEMOLE_PHOTOSETTINGCONTEXT_GET_ISSHOWSETTINGSCOPEDFRONT_OFFSET UNITYSDK_OFFSET(0x15BB0880)
#define MOLEMOLE_PHOTOSETTINGCONTEXT_GET_ISSHOWSTICKER_OFFSET UNITYSDK_OFFSET(0x15BB08C0)
#define MOLEMOLE_PHOTOSETTINGCONTEXT_GET_ISSHOWVOLUME_OFFSET UNITYSDK_OFFSET(0x15BB0860)
#define MOLEMOLE_PHOTOSETTINGCONTEXT_GET_RESETSETTINGTABINDEX_OFFSET UNITYSDK_OFFSET(0x15BB08E0)
#define MOLEMOLE_PHOTOSETTINGCONTEXT_SET_INITTABTYPE_OFFSET UNITYSDK_OFFSET(0x15BB0910)
#define MOLEMOLE_PHOTOSETTINGCONTEXT_SET_ISSHOWFRAME_OFFSET UNITYSDK_OFFSET(0x15BB08B0)
#define MOLEMOLE_PHOTOSETTINGCONTEXT_SET_ISSHOWSETTINGSCOPEDFRONT_OFFSET UNITYSDK_OFFSET(0x15BB0890)
#define MOLEMOLE_PHOTOSETTINGCONTEXT_SET_ISSHOWSTICKER_OFFSET UNITYSDK_OFFSET(0x15BB08D0)
#define MOLEMOLE_PHOTOSETTINGCONTEXT_SET_ISSHOWVOLUME_OFFSET UNITYSDK_OFFSET(0x15BB0870)
#define MOLEMOLE_PHOTOSETTINGCONTEXT_SET_RESETSETTINGTABINDEX_OFFSET UNITYSDK_OFFSET(0x15BB08F0)
#define MOLEMOLE_PHOTOSETTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15BB0920)

namespace MoleMole
{
	inline static constexpr unsigned int PhotoSettingContext_TypeDefinitionIndex = 41307;
	...
	public:
		...
		::System::Nullable_1<::Enum_3_67693CAD6D4923AA> _InitTabType_k__BackingField; // 0x40
		::System::Boolean _IsShowFrame_k__BackingField; // 0x48
		::System::Boolean _IsShowVolume_k__BackingField; // 0x49
		::System::Boolean _ResetSettingTabIndex_k__BackingField; // 0x4A
		::System::Boolean _IsShowSettingScopedFront_k__BackingField; // 0x4B
		::System::Boolean _IsShowSticker_k__BackingField; // 0x4C
