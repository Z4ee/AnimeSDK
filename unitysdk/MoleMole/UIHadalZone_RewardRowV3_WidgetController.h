...
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER_GET_TAKEREWARDACTION_OFFSET UNITYSDK_OFFSET(0x17788FF0)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17787930)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0x177887A0)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17787BC0)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17787AF0)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17787B40)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x177876F0)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER_REFRESHREWARDITEMS_OFFSET UNITYSDK_OFFSET(0x17787EE0)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER_SET_TAKEREWARDACTION_OFFSET UNITYSDK_OFFSET(0x17789000)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER__CLEARPREVS_OFFSET UNITYSDK_OFFSET(0x17788820)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER__CREATEREWARDITEMSCROLL_OFFSET UNITYSDK_OFFSET(0x17788A50)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17789010)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER__ONSCROLLITEMUPDATE_B__12_0_OFFSET UNITYSDK_OFFSET(0x17789020)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER__SETBTNCLICK_OFFSET UNITYSDK_OFFSET(0x177889A0)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER__TAKEREWARD_OFFSET UNITYSDK_OFFSET(0x17788D50)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17789270)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER___BASE_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0x17789300)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17789390)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17789430)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17789440)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x177894D0)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER___SETBTNCLICK_B__15_0_OFFSET UNITYSDK_OFFSET(0x177890C0)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER___TAKEREWARD_B__18_0_OFFSET UNITYSDK_OFFSET(0x17789170)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_RewardRowV3_WidgetController_TypeDefinitionIndex = 75194;
	...
	public:
		...
		::System::Void __TakeReward_b__18_0(::Class_3_025FF4981524A424_164* rsp)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_025FF4981524A424_164*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER___TAKEREWARD_B__18_0_OFFSET))(this, rsp);
		}
