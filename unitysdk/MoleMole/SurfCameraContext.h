...
#define MOLEMOLE_SURFCAMERACONTEXT_RESET_OFFSET UNITYSDK_OFFSET(0x7D37F0)

namespace MoleMole
{
	inline static constexpr unsigned int SurfCameraContext_TypeDefinitionIndex = 51817;
