...
#define MOLEMOLE_UIVOIDFRONTOPTIONITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1610D3C0)
#define MOLEMOLE_UIVOIDFRONTOPTIONITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x1610DA60)
#define MOLEMOLE_UIVOIDFRONTOPTIONITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1610D4D0)
#define MOLEMOLE_UIVOIDFRONTOPTIONITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1610D450)
#define MOLEMOLE_UIVOIDFRONTOPTIONITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1610D260)
#define MOLEMOLE_UIVOIDFRONTOPTIONITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1610DB10)
#define MOLEMOLE_UIVOIDFRONTOPTIONITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1610DB20)
#define MOLEMOLE_UIVOIDFRONTOPTIONITEMWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x1610DBB0)
#define MOLEMOLE_UIVOIDFRONTOPTIONITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1610DC40)
#define MOLEMOLE_UIVOIDFRONTOPTIONITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1610DCE0)
#define MOLEMOLE_UIVOIDFRONTOPTIONITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1610DD70)

namespace MoleMole
{
	inline static constexpr unsigned int UIVoidFrontOptionItemWidgetController_TypeDefinitionIndex = 84424;

	class UIVoidFrontOptionItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_A7E16C971D58140E* _view; // 0x2F0
