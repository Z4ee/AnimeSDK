...
#define MOLEMOLE_CINEMAPOSITIONSO_METHOD_4_88B60F3B95FAA4F1_1_OFFSET UNITYSDK_OFFSET(0x11013010)
#define MOLEMOLE_CINEMAPOSITIONSO_METHOD_4_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x11012F90)
#define MOLEMOLE_CINEMAPOSITIONSO__CTOR_OFFSET UNITYSDK_OFFSET(0x11013000)

namespace MoleMole
{
	inline static constexpr unsigned int CinemaPositionSo_TypeDefinitionIndex = 45122;
