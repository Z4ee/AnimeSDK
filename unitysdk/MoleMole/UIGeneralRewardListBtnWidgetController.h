...
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER_GET_ICON_OFFSET UNITYSDK_OFFSET(0x16CEEFC0)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER_GET_PRESSURE_OFFSET UNITYSDK_OFFSET(0x16CEEFE0)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER_HANDLEPOPUP_OFFSET UNITYSDK_OFFSET(0x16CEE920)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER_HIDEPROGRESSVALUE_OFFSET UNITYSDK_OFFSET(0x16CEEF60)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER_MARKCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x16CEE860)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16CEE750)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16CEE7E0)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16CEE580)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16CEE6E0)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER_SETONCLICKBACK_OFFSET UNITYSDK_OFFSET(0x16CEE8D0)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER_SHOWPROGRESSVALUE_OFFSET UNITYSDK_OFFSET(0x16CEED40)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16CEF000)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER__ONUIINIT_B__2_0_OFFSET UNITYSDK_OFFSET(0x16CEF060)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16CEF080)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16CEF110)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16CEF1A0)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16CEF230)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralRewardListBtnWidgetController_TypeDefinitionIndex = 43738;
	...
	public:
		...
		::Class_2_36865368388A1C3B* _view; // 0x2B8
