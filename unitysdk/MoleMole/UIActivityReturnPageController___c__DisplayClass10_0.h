...
#define MOLEMOLE_UIACTIVITYRETURNPAGECONTROLLER___C__DISPLAYCLASS10_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1732AEB0)
#define MOLEMOLE_UIACTIVITYRETURNPAGECONTROLLER___C__DISPLAYCLASS10_0__PLAYINTROVIDEO_B__0_OFFSET UNITYSDK_OFFSET(0x1732AEC0)
#define MOLEMOLE_UIACTIVITYRETURNPAGECONTROLLER___C__DISPLAYCLASS10_0__PLAYINTROVIDEO_B__1_OFFSET UNITYSDK_OFFSET(0x1732AF10)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityReturnPageController___c__DisplayClass10_0_TypeDefinitionIndex = 84842;
