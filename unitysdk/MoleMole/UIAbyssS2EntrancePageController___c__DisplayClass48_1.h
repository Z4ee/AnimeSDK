...
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER___C__DISPLAYCLASS48_1__CTOR_OFFSET UNITYSDK_OFFSET(0x16105900)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER___C__DISPLAYCLASS48_1__ONLIMBOENTRANCE_B__0_OFFSET UNITYSDK_OFFSET(0x16105910)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2EntrancePageController___c__DisplayClass48_1_TypeDefinitionIndex = 54809;

	class UIAbyssS2EntrancePageController___c__DisplayClass48_1 : public ::System::Object
	{
	public:
		::MoleMole::UIAbyssS2EventContext* contextBase; // 0x10
		::MoleMole::UIAbyssS2EntrancePageController___c__DisplayClass48_0* CS___8__locals1; // 0x18
