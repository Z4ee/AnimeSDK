...
#define MOLEMOLE_UISOCIALCIRCLETAGROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x152B97A0)
#define MOLEMOLE_UISOCIALCIRCLETAGROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x152B9810)
#define MOLEMOLE_UISOCIALCIRCLETAGROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x152B98D0)
#define MOLEMOLE_UISOCIALCIRCLETAGROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x152B9990)
#define MOLEMOLE_UISOCIALCIRCLETAGROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x152B9B10)
#define MOLEMOLE_UISOCIALCIRCLETAGROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x152B9B20)
#define MOLEMOLE_UISOCIALCIRCLETAGROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x152B9BC0)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleTagRowWidgetController_TypeDefinitionIndex = 58347;
