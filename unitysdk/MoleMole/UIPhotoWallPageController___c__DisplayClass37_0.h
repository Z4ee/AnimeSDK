...
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___C__DISPLAYCLASS37_0__CHANGETOWATCHMODE_B__0_OFFSET UNITYSDK_OFFSET(0x1844B240)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___C__DISPLAYCLASS37_0__CHANGETOWATCHMODE_B__1_OFFSET UNITYSDK_OFFSET(0x1844BB30)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___C__DISPLAYCLASS37_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1844B230)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoWallPageController___c__DisplayClass37_0_TypeDefinitionIndex = 61305;
