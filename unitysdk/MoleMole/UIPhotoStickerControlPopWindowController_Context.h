...
#define MOLEMOLE_UIPHOTOSTICKERCONTROLPOPWINDOWCONTROLLER_CONTEXT_GET_STICKERID_OFFSET UNITYSDK_OFFSET(0x147E31B0)
#define MOLEMOLE_UIPHOTOSTICKERCONTROLPOPWINDOWCONTROLLER_CONTEXT_GET_STICKERINDEX_OFFSET UNITYSDK_OFFSET(0x147E3520)
#define MOLEMOLE_UIPHOTOSTICKERCONTROLPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x147E3890)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoStickerControlPopWindowController_Context_TypeDefinitionIndex = 49011;
