...
#define MOLEMOLE_UIPHOTOSTICKERCONTROLPOPWINDOWCONTROLLER_CONTEXT_GET_STICKERID_OFFSET UNITYSDK_OFFSET(0x171718C0)
#define MOLEMOLE_UIPHOTOSTICKERCONTROLPOPWINDOWCONTROLLER_CONTEXT_GET_STICKERINDEX_OFFSET UNITYSDK_OFFSET(0x17171C30)
#define MOLEMOLE_UIPHOTOSTICKERCONTROLPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x17171FA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoStickerControlPopWindowController_Context_TypeDefinitionIndex = 79240;
