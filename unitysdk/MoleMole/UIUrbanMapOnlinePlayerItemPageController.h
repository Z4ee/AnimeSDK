...
#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x10405A30)
#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x10405A40)
#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER_ONCAMERAFOLLOWCHANGE_OFFSET UNITYSDK_OFFSET(0x10405E40)
#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x10405AB0)
#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x10405BC0)
#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x10405DD0)
#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x104061D0)
#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x10406230)
#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x104062D0)
#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x10406370)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapOnlinePlayerItemPageController_TypeDefinitionIndex = 64573;
