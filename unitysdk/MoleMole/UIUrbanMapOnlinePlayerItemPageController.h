...
class Class_2_C5D23C81397424FE;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }
namespace MoleMole { class UIUrbanOnLinePlayerWidgetContext; }
namespace System { class EventArgs; }

#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1552FA80)
#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1552FA90)
#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER_ONCAMERAFOLLOWCHANGE_OFFSET UNITYSDK_OFFSET(0x1552FE90)
#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1552FB00)
#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1552FC10)
#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1552FE20)
#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15530220)
#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15530280)
#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15530320)
#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x155303C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapOnlinePlayerItemPageController_TypeDefinitionIndex = 63620;

	class UIUrbanMapOnlinePlayerItemPageController : public ::MoleMole::UIWidgetController
	{
	public:
		::MoleMole::UIUrbanOnLinePlayerWidgetContext* _context; // 0x2B8
		...
		::Class_2_C5D23C81397424FE* get__viewModel()
		{
			return ((::Class_2_C5D23C81397424FE*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
