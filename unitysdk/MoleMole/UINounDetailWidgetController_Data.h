...
#define MOLEMOLE_UINOUNDETAILWIDGETCONTROLLER_DATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17464BF0)

namespace MoleMole
{
	inline static constexpr unsigned int UINounDetailWidgetController_Data_TypeDefinitionIndex = 62461;
