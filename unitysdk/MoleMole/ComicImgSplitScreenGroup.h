...
#define MOLEMOLE_COMICIMGSPLITSCREENGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1F95F120)

namespace MoleMole
{
	inline static constexpr unsigned int ComicImgSplitScreenGroup_TypeDefinitionIndex = 32751;
