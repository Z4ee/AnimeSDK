...
#define MOLEMOLE_MAINCITYQUICKFUNC3GAMEPADBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1582B840)
#define MOLEMOLE_MAINCITYQUICKFUNC3GAMEPADBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x1582B850)
#define MOLEMOLE_MAINCITYQUICKFUNC3GAMEPADBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1582B860)

namespace MoleMole
{
	inline static constexpr unsigned int MainCityQuickFunc3GamepadBindingSettingEntry_TypeDefinitionIndex = 60554;
