...
#define MOLEMOLE_UIROLETRUSTBUTTONWIDGETCONTROLLER_AVATARDATAHELPER_GET_AVATARTEMPLATE_OFFSET UNITYSDK_OFFSET(0x1510F290)
#define MOLEMOLE_UIROLETRUSTBUTTONWIDGETCONTROLLER_AVATARDATAHELPER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1510F2F0)
#define MOLEMOLE_UIROLETRUSTBUTTONWIDGETCONTROLLER_AVATARDATAHELPER_SET_AVATARTEMPLATE_OFFSET UNITYSDK_OFFSET(0x1510F2A0)
#define MOLEMOLE_UIROLETRUSTBUTTONWIDGETCONTROLLER_AVATARDATAHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1510F670)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleTrustButtonWidgetController_AvatarDataHelper_TypeDefinitionIndex = 61961;

	class UIRoleTrustButtonWidgetController_AvatarDataHelper : public ::System::Object
	{
	public:
		::Class_2_1A39E1B51756BF41* ProfessionIcon; // 0x10
		::Class_2_1A39E1B51756BF41* ElementIcon; // 0x18
		::Class_2_013DB5EBD89922B2* _avatarTemplate; // 0x20
		::UnityEngine::UI::Extension::UILocalizationText* RoleName; // 0x28
