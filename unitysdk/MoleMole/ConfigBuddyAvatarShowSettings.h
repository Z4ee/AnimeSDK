...
#define MOLEMOLE_CONFIGBUDDYAVATARSHOWSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x158CB3B0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigBuddyAvatarShowSettings_TypeDefinitionIndex = 43524;
