...
#define MOLEMOLE_CONFIGBUDDYAVATARSHOWSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A94A1B0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigBuddyAvatarShowSettings_TypeDefinitionIndex = 65287;
