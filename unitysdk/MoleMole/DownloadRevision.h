...
#define MOLEMOLE_DOWNLOADREVISION_GET_P4CHANGELIST_OFFSET UNITYSDK_OFFSET(0x18AE9760)
#define MOLEMOLE_DOWNLOADREVISION_GET_SUFFIX_OFFSET UNITYSDK_OFFSET(0x18AE9720)
#define MOLEMOLE_DOWNLOADREVISION_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x18AE98D0)
#define MOLEMOLE_DOWNLOADREVISION_METHOD_1_D95BC964A2667B55_OFFSET UNITYSDK_OFFSET(0x18AE9910)
#define MOLEMOLE_DOWNLOADREVISION_METHOD_1_DD6D03899D36FF8C_OFFSET UNITYSDK_OFFSET(0x18AE9770)
#define MOLEMOLE_DOWNLOADREVISION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18AE9860)
#define MOLEMOLE_DOWNLOADREVISION__CTOR_OFFSET UNITYSDK_OFFSET(0x18AE96D0)

namespace MoleMole
{
	inline static constexpr unsigned int DownloadRevision_TypeDefinitionIndex = 69025;
