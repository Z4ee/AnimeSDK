...
#define MOLEMOLE_DOWNLOADREVISION_GET_P4CHANGELIST_OFFSET UNITYSDK_OFFSET(0x1A4CE060)
#define MOLEMOLE_DOWNLOADREVISION_GET_SUFFIX_OFFSET UNITYSDK_OFFSET(0x1A4CE020)
#define MOLEMOLE_DOWNLOADREVISION_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x1A4CE1D0)
#define MOLEMOLE_DOWNLOADREVISION_METHOD_1_D95BC964A2667B55_OFFSET UNITYSDK_OFFSET(0x1A4CE210)
#define MOLEMOLE_DOWNLOADREVISION_METHOD_1_DD6D03899D36FF8C_OFFSET UNITYSDK_OFFSET(0x1A4CE070)
#define MOLEMOLE_DOWNLOADREVISION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A4CE160)
#define MOLEMOLE_DOWNLOADREVISION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4CDFD0)

namespace MoleMole
{
	inline static constexpr unsigned int DownloadRevision_TypeDefinitionIndex = 50252;
