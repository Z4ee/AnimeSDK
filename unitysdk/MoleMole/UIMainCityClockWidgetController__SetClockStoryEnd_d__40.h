...
#define MOLEMOLE_UIMAINCITYCLOCKWIDGETCONTROLLER__SETCLOCKSTORYEND_D__40_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x82ED40)
#define MOLEMOLE_UIMAINCITYCLOCKWIDGETCONTROLLER__SETCLOCKSTORYEND_D__40_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x283610)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityClockWidgetController__SetClockStoryEnd_d__40_TypeDefinitionIndex = 69182;
