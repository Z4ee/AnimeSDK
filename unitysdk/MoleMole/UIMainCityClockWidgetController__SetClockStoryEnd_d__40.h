...
#define MOLEMOLE_UIMAINCITYCLOCKWIDGETCONTROLLER__SETCLOCKSTORYEND_D__40_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x799350)
#define MOLEMOLE_UIMAINCITYCLOCKWIDGETCONTROLLER__SETCLOCKSTORYEND_D__40_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2661E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityClockWidgetController__SetClockStoryEnd_d__40_TypeDefinitionIndex = 53261;
