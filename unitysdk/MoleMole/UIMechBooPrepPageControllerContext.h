...
#define MOLEMOLE_UIMECHBOOPREPPAGECONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1714D8C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechBooPrepPageControllerContext_TypeDefinitionIndex = 75051;
