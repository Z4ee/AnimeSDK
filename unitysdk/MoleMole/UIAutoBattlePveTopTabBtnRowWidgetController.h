...
#define MOLEMOLE_UIAUTOBATTLEPVETOPTABBTNROWWIDGETCONTROLLER_GETTABBUTTON_OFFSET UNITYSDK_OFFSET(0x17A427B0)
#define MOLEMOLE_UIAUTOBATTLEPVETOPTABBTNROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17A426A0)
#define MOLEMOLE_UIAUTOBATTLEPVETOPTABBTNROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17A42730)
#define MOLEMOLE_UIAUTOBATTLEPVETOPTABBTNROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17A425D0)
#define MOLEMOLE_UIAUTOBATTLEPVETOPTABBTNROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17A42630)
#define MOLEMOLE_UIAUTOBATTLEPVETOPTABBTNROWWIDGETCONTROLLER_SETTEXT_OFFSET UNITYSDK_OFFSET(0x17A42810)
#define MOLEMOLE_UIAUTOBATTLEPVETOPTABBTNROWWIDGETCONTROLLER_SHOWPOPUP_OFFSET UNITYSDK_OFFSET(0x17A42A80)
#define MOLEMOLE_UIAUTOBATTLEPVETOPTABBTNROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17A42D90)
#define MOLEMOLE_UIAUTOBATTLEPVETOPTABBTNROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17A42DF0)
#define MOLEMOLE_UIAUTOBATTLEPVETOPTABBTNROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17A42E80)
#define MOLEMOLE_UIAUTOBATTLEPVETOPTABBTNROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17A42F10)
#define MOLEMOLE_UIAUTOBATTLEPVETOPTABBTNROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17A42FA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAutoBattlePveTopTabBtnRowWidgetController_TypeDefinitionIndex = 79885;
