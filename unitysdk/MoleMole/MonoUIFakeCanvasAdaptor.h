...
#define MOLEMOLE_MONOUIFAKECANVASADAPTOR_DOINITLAYOUT_OFFSET UNITYSDK_OFFSET(0x15BA0380)
#define MOLEMOLE_MONOUIFAKECANVASADAPTOR_INITTRANSFORM_OFFSET UNITYSDK_OFFSET(0x15BA05B0)
#define MOLEMOLE_MONOUIFAKECANVASADAPTOR_ISCONTAINPLATFORMUIPARAMS_OFFSET UNITYSDK_OFFSET(0x15BA02A0)
#define MOLEMOLE_MONOUIFAKECANVASADAPTOR_ISPLATFORMUIPARAMSEMPTY_OFFSET UNITYSDK_OFFSET(0x15BA0200)
#define MOLEMOLE_MONOUIFAKECANVASADAPTOR_RELOADDATAFROMJSON_OFFSET UNITYSDK_OFFSET(0x15BA0D40)
#define MOLEMOLE_MONOUIFAKECANVASADAPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x15BA1070)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIFakeCanvasAdaptor_TypeDefinitionIndex = 39302;
