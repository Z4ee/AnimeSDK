...
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_SETACTIVEDEL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x14C05E90)
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_SETACTIVEDEL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x14C05F20)
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_SETACTIVEDEL_INVOKE_OFFSET UNITYSDK_OFFSET(0x14C05B70)
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_SETACTIVEDEL__CTOR_OFFSET UNITYSDK_OFFSET(0x14C05B60)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleInfoSkillChildWindowController_SubViewDefine_SetActiveDel_TypeDefinitionIndex = 79297;
