...
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_SETACTIVEDEL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x175A2980)
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_SETACTIVEDEL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x175A2A10)
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_SETACTIVEDEL_INVOKE_OFFSET UNITYSDK_OFFSET(0x175A2600)
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_SETACTIVEDEL__CTOR_OFFSET UNITYSDK_OFFSET(0x175A25E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleInfoSkillChildWindowController_SubViewDefine_SetActiveDel_TypeDefinitionIndex = 45385;
