...
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_AFTERREFRESHBUFF_OFFSET UNITYSDK_OFFSET(0x18A5BC60)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_CALCULATESELECTTYPE_OFFSET UNITYSDK_OFFSET(0x18A5E220)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_CANCELSCROLLVIEWSELECT_OFFSET UNITYSDK_OFFSET(0x18A5F9B0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_CHECKSAFEDELAY_OFFSET UNITYSDK_OFFSET(0x18A5CDA0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_CLICKBUDDY_OFFSET UNITYSDK_OFFSET(0x18A57520)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_CLICKROLE_OFFSET UNITYSDK_OFFSET(0x18A570D0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_EXCHANGEBTNINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x18A5F670)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_GENERALROLECARDCLICK_OFFSET UNITYSDK_OFFSET(0x18A56430)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_GETAVATARSELECTTOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x18A60670)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_GETCURRENTTEMPLATE_OFFSET UNITYSDK_OFFSET(0x18A59670)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_GETREWARDINFODATALIST_OFFSET UNITYSDK_OFFSET(0x18A5F6D0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_GET_DATALOGIC_OFFSET UNITYSDK_OFFSET(0x18A560C0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_INITBUDDY_OFFSET UNITYSDK_OFFSET(0x18A5D210)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_INITPOOLDATA_OFFSET UNITYSDK_OFFSET(0x18A5BCA0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_INITREWARD_OFFSET UNITYSDK_OFFSET(0x18A5B8E0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONCARDSET_OFFSET UNITYSDK_OFFSET(0x18A584E0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONCLEARINTERACT_OFFSET UNITYSDK_OFFSET(0x18A5E520)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18A59A00)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x18A560E0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONGO_OFFSET UNITYSDK_OFFSET(0x18A5D400)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONMULTISELECTBUDDY_OFFSET UNITYSDK_OFFSET(0x18A5E7E0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONPOSTREFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x18A5BC20)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONPOSTSETROLECARDDATA_OFFSET UNITYSDK_OFFSET(0x18A5F550)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONREWARDINFOCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x18A5FC80)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONSELECTAVATAR_OFFSET UNITYSDK_OFFSET(0x18A5EBA0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18A59A90)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18A56300)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18A576C0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_OPENBANGBOO_OFFSET UNITYSDK_OFFSET(0x18A56CA0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_OPENBUFF_OFFSET UNITYSDK_OFFSET(0x18A58440)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_OPENDETAILDIALOG_OFFSET UNITYSDK_OFFSET(0x18A597B0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_OPENMONSTER_OFFSET UNITYSDK_OFFSET(0x18A59440)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_OPENPOOLROLESELECT_OFFSET UNITYSDK_OFFSET(0x18A564F0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_OPENROLEDETAIL_OFFSET UNITYSDK_OFFSET(0x18A58AC0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REALFLOORINDEXTOINDEX_OFFSET UNITYSDK_OFFSET(0x18A59740)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REFRESHBOSS_OFFSET UNITYSDK_OFFSET(0x18A5A020)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REFRESHBUFFSTATE_OFFSET UNITYSDK_OFFSET(0x18A586D0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REFRESHBUFF_OFFSET UNITYSDK_OFFSET(0x18A5B0F0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0x18A5AA90)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REFRESHRANKING_OFFSET UNITYSDK_OFFSET(0x18A5CDF0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REFRESHRESETBTNSTATE_OFFSET UNITYSDK_OFFSET(0x18A59C10)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x18A59E50)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REQBABELTOWERBEGINFIGHT_OFFSET UNITYSDK_OFFSET(0x18A5E6E0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_RESETAVATAR_OFFSET UNITYSDK_OFFSET(0x18A59B10)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_RESETPOOL_OFFSET UNITYSDK_OFFSET(0x18A59B60)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_SETBEFOREENTERACTION_OFFSET UNITYSDK_OFFSET(0x18A59E00)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_SETBUFFSELECTBTNSTATE_OFFSET UNITYSDK_OFFSET(0x18A582B0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_SETCARDSETBUFF_OFFSET UNITYSDK_OFFSET(0x18A58590)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_SET_DATALOGIC_OFFSET UNITYSDK_OFFSET(0x18A560D0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_TRIGGERNEWBIE_OFFSET UNITYSDK_OFFSET(0x18A58800)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_UPDATEAVATARSELECTVIEW_OFFSET UNITYSDK_OFFSET(0x18A5F4E0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_UPDATEFLOORINDEX_OFFSET UNITYSDK_OFFSET(0x18A58FE0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_UPDATEPOOLAVARTAR_OFFSET UNITYSDK_OFFSET(0x18A5C090)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_UPDATEROOMRECOMMANDBYINDEX_OFFSET UNITYSDK_OFFSET(0x18A60370)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_UPDATEROOMRECOMMAND_OFFSET UNITYSDK_OFFSET(0x18A5A880)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_UPDATEROOMRESISTBYINDEX_OFFSET UNITYSDK_OFFSET(0x18A60080)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_UPDATEROOMRESIST_OFFSET UNITYSDK_OFFSET(0x18A5A670)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x18A58240)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18A606E0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER__ONGO_OFFSET UNITYSDK_OFFSET(0x18A5DC20)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER__ONUIINIT_B__19_0_OFFSET UNITYSDK_OFFSET(0x18A608E0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER__ONUIOPEN_B__21_0_OFFSET UNITYSDK_OFFSET(0x18A60960)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER__REFRESHRANKING_G__REFRESHRANKIMAGE_47_0_OFFSET UNITYSDK_OFFSET(0x18A5D130)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER__UPDATEBOSSIMAGE_OFFSET UNITYSDK_OFFSET(0x18A60000)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18A60D80)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER___BASE_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x18A60EA0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18A60F90)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18A60E10)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18A61020)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER___ONGO_B__51_0_OFFSET UNITYSDK_OFFSET(0x18A60B10)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerFightingInfoWidgetController_TypeDefinitionIndex = 57677;
	...
	public:
		...
		::Class_2_60638234271CCDB8_9* _view; // 0x2C8
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::System::UInt32, ::System::Int32, ::System::Collections::Generic::List_1<::System::Int32>*, ::System::Collections::Generic::List_1<::System::Int32>*, ::System::Collections::Generic::List_1<::System::Int32>*, ::System::Boolean, ::System::Int32, ::System::Action_2<::System::Boolean, ::Class_3_025FF4981524A424_10*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REQBABELTOWERBEGINFIGHT_OFFSET))(this, towerid, floorIndex, buddy, selectAvatars, poolAvatars, buddyList, isContinue, selectBuf, overrideCallback);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_5DA2E7556103D5A3_236*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER__UPDATEBOSSIMAGE_OFFSET))(this, cardConfigTemplate);
		}
		...
		::System::Void __OnGo_b__51_0(::System::Boolean s, ::Class_3_025FF4981524A424_10* rsp)
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean, ::Class_3_025FF4981524A424_10*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER___ONGO_B__51_0_OFFSET))(this, s, rsp);
		}
