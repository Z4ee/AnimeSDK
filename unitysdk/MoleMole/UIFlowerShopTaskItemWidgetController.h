...
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER_CLICKITEMBUTTON_OFFSET UNITYSDK_OFFSET(0x16F554B0)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16F54860)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER_ONFLOWERSHOPTASKCHANGEEVENT_OFFSET UNITYSDK_OFFSET(0x16F55560)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x16F55410)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16F54A20)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16F549A0)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16F545D0)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16F547F0)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER_REFRESHPANEL_OFFSET UNITYSDK_OFFSET(0x16F54B90)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16F555F0)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16F55600)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x16F55690)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16F55720)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16F557C0)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16F55850)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16F558E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerShopTaskItemWidgetController_TypeDefinitionIndex = 81944;
	...
	public:
		...
		::Class_2_208CC9941471731A_584* _data; // 0x300
