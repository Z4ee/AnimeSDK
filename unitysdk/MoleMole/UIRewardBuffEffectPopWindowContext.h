...
#define MOLEMOLE_UIREWARDBUFFEFFECTPOPWINDOWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16908090)

namespace MoleMole
{
	inline static constexpr unsigned int UIRewardBuffEffectPopWindowContext_TypeDefinitionIndex = 50063;
