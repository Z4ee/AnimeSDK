...
#define MOLEMOLE_UIREWARDBUFFEFFECTPOPWINDOWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15329AE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRewardBuffEffectPopWindowContext_TypeDefinitionIndex = 60045;
