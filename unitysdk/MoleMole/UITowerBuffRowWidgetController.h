...
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_BINDNOTFICATION_OFFSET UNITYSDK_OFFSET(0x12C7EEC0)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12C7EAC0)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12C7EB50)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12C7E8F0)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12C7EA50)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0x12C7EF50)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x12C7EC40)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_SETCLICKACTION_OFFSET UNITYSDK_OFFSET(0x12C7F110)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x12C7F160)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_SETLOCK_OFFSET UNITYSDK_OFFSET(0x12C7EBD0)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12C7F340)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0x12C7F3A0)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12C7F3C0)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12C7F450)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12C7F4E0)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12C7F570)

namespace MoleMole
{
	inline static constexpr unsigned int UITowerBuffRowWidgetController_TypeDefinitionIndex = 54968;
