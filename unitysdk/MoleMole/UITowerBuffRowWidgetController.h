...
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_BINDNOTFICATION_OFFSET UNITYSDK_OFFSET(0x167824A0)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16782090)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16782120)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16781EC0)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16782020)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0x16782530)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x16782210)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_SETCLICKACTION_OFFSET UNITYSDK_OFFSET(0x167826F0)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x16782740)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_SETLOCK_OFFSET UNITYSDK_OFFSET(0x167821A0)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16782920)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0x16782980)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x167829A0)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16782A30)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16782AC0)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16782B50)

namespace MoleMole
{
	inline static constexpr unsigned int UITowerBuffRowWidgetController_TypeDefinitionIndex = 64914;

	class UITowerBuffRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_124142F81A078603* _view; // 0x2C0
		::System::Int32 itemid; // 0x2C8
		::System::Action* callback; // 0x2D0
