...
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_GET_EDITORDEFAULTVAL_OFFSET UNITYSDK_OFFSET(0x16E3A110)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_GET_WKEYFRAME_OFFSET UNITYSDK_OFFSET(0x16E39EB0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_GET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x16E39AE0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_GET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0x16E39C70)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_GET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0x16E39D90)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_043B534750B9E7A6_OFFSET UNITYSDK_OFFSET(0x16E39BF0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_1DE6433C25680F9D_OFFSET UNITYSDK_OFFSET(0x16E3B0B0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_21A9C5CD44F59232_OFFSET UNITYSDK_OFFSET(0x16E3A770)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_358636A0F7882E47_1_OFFSET UNITYSDK_OFFSET(0x16E3B470)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_358636A0F7882E47_OFFSET UNITYSDK_OFFSET(0x16E3B340)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x16E3B330)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_8899B33907DB68CE_OFFSET UNITYSDK_OFFSET(0x16E3AE30)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_8F8B3C218D38C840_OFFSET UNITYSDK_OFFSET(0x16E3ADA0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_A0F1D07FA5BAF2AE_OFFSET UNITYSDK_OFFSET(0x16E3A560)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_B06E4777914A5853_OFFSET UNITYSDK_OFFSET(0x16E3A810)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_B56234B03748E3AC_OFFSET UNITYSDK_OFFSET(0x16E3A630)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_C21A7AC6282FB0D0_1_OFFSET UNITYSDK_OFFSET(0x16E3B500)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_C21A7AC6282FB0D0_OFFSET UNITYSDK_OFFSET(0x16E3B3D0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_CEE72EAC18ECC163_OFFSET UNITYSDK_OFFSET(0x16E3A6D0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_CFE795238058307E_OFFSET UNITYSDK_OFFSET(0x16E3A4A0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_DABB2D6C36ED9992_OFFSET UNITYSDK_OFFSET(0x16E3A120)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_SET_WKEYFRAME_OFFSET UNITYSDK_OFFSET(0x16E39F20)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_SET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x16E39B40)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_SET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0x16E39CE0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_SET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0x16E39E00)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x16E39FD0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int UV01KeyframeCurve_TypeDefinitionIndex = 70415;
