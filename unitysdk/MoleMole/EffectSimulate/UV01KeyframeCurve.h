...
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_GET_EDITORDEFAULTVAL_OFFSET UNITYSDK_OFFSET(0x1A98F350)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_GET_WKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1A98F230)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_GET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1A98EE60)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_GET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1A98EFF0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_GET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1A98F110)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_043B534750B9E7A6_OFFSET UNITYSDK_OFFSET(0x1A98EF70)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_1DE6433C25680F9D_OFFSET UNITYSDK_OFFSET(0x1A9902A0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_21A9C5CD44F59232_OFFSET UNITYSDK_OFFSET(0x1A98F990)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_358636A0F7882E47_1_OFFSET UNITYSDK_OFFSET(0x1A990700)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_358636A0F7882E47_OFFSET UNITYSDK_OFFSET(0x1A9905C0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_6AE5DBADE4150179_OFFSET UNITYSDK_OFFSET(0x1A98F360)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x1A990650)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_8899B33907DB68CE_OFFSET UNITYSDK_OFFSET(0x1A990040)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_8F8B3C218D38C840_OFFSET UNITYSDK_OFFSET(0x1A98FFB0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_A0F1D07FA5BAF2AE_OFFSET UNITYSDK_OFFSET(0x1A98F7A0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_B06E4777914A5853_OFFSET UNITYSDK_OFFSET(0x1A98FA20)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_B56234B03748E3AC_OFFSET UNITYSDK_OFFSET(0x1A98F870)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_C21A7AC6282FB0D0_1_OFFSET UNITYSDK_OFFSET(0x1A990660)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_C21A7AC6282FB0D0_OFFSET UNITYSDK_OFFSET(0x1A990520)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_CEE72EAC18ECC163_OFFSET UNITYSDK_OFFSET(0x1A98F900)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_CFE795238058307E_OFFSET UNITYSDK_OFFSET(0x1A98F6E0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_SET_WKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1A98F2A0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_SET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1A98EEC0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_SET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1A98F060)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_SET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1A98F180)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A952D40)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int UV01KeyframeCurve_TypeDefinitionIndex = 70200;
	...
	public:
		...
		::UnityEngine::Vector4 Method_4_6AE5DBADE4150179(::System::Single a1, ::UnityEngine::Vector4 a2)
		{
			return ((::UnityEngine::Vector4(*)(::PVOID, ::System::Single, ::UnityEngine::Vector4))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_6AE5DBADE4150179_OFFSET))(this, a1, a2);
		}
