...
#define MOLEMOLE_EFFECTSIMULATE_ESUIMATVECTORANIMATION_GET_WKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1B51E570)
#define MOLEMOLE_EFFECTSIMULATE_ESUIMATVECTORANIMATION_GET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1B51E2D0)
#define MOLEMOLE_EFFECTSIMULATE_ESUIMATVECTORANIMATION_GET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1B51E3B0)
#define MOLEMOLE_EFFECTSIMULATE_ESUIMATVECTORANIMATION_GET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1B51E490)
#define MOLEMOLE_EFFECTSIMULATE_ESUIMATVECTORANIMATION_METHOD_5_3552A6615B9A8C78_OFFSET UNITYSDK_OFFSET(0x1B51E0D0)
#define MOLEMOLE_EFFECTSIMULATE_ESUIMATVECTORANIMATION_METHOD_5_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x1B51E6E0)
#define MOLEMOLE_EFFECTSIMULATE_ESUIMATVECTORANIMATION_METHOD_5_7FD266B25805528E_OFFSET UNITYSDK_OFFSET(0x1B51E160)
#define MOLEMOLE_EFFECTSIMULATE_ESUIMATVECTORANIMATION_METHOD_5_8181F1A8A772EA0A_OFFSET UNITYSDK_OFFSET(0x1B51E0C0)
#define MOLEMOLE_EFFECTSIMULATE_ESUIMATVECTORANIMATION_METHOD_5_A1025C3B0B9B691C_OFFSET UNITYSDK_OFFSET(0x1B51DBB0)
#define MOLEMOLE_EFFECTSIMULATE_ESUIMATVECTORANIMATION_METHOD_5_A68A981870186A39_OFFSET UNITYSDK_OFFSET(0x1B51D9E0)
#define MOLEMOLE_EFFECTSIMULATE_ESUIMATVECTORANIMATION_METHOD_5_BB39E3A44FF3B23C_OFFSET UNITYSDK_OFFSET(0x1B51E1F0)
#define MOLEMOLE_EFFECTSIMULATE_ESUIMATVECTORANIMATION_METHOD_5_C446CE6A5E1982BC_OFFSET UNITYSDK_OFFSET(0x1B51E290)
#define MOLEMOLE_EFFECTSIMULATE_ESUIMATVECTORANIMATION_SET_WKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1B51E5C0)
#define MOLEMOLE_EFFECTSIMULATE_ESUIMATVECTORANIMATION_SET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1B51E320)
#define MOLEMOLE_EFFECTSIMULATE_ESUIMATVECTORANIMATION_SET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1B51E400)
#define MOLEMOLE_EFFECTSIMULATE_ESUIMATVECTORANIMATION_SET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1B51E4E0)
#define MOLEMOLE_EFFECTSIMULATE_ESUIMATVECTORANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B51E650)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESUIMatVectorAnimation_TypeDefinitionIndex = 43545;
