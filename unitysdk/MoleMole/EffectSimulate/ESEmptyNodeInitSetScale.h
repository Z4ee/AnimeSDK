...
#define MOLEMOLE_EFFECTSIMULATE_ESEMPTYNODEINITSETSCALE_METHOD_4_25317D1DD74E2173_OFFSET UNITYSDK_OFFSET(0x1A4D2B30)
#define MOLEMOLE_EFFECTSIMULATE_ESEMPTYNODEINITSETSCALE_METHOD_4_C433AF37CE9D6E5B_OFFSET UNITYSDK_OFFSET(0x1A4D2DF0)
#define MOLEMOLE_EFFECTSIMULATE_ESEMPTYNODEINITSETSCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4D2DD0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESEmptyNodeInitSetScale_TypeDefinitionIndex = 74679;
