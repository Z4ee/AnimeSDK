...
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSNAPCONTACTSHADOW_METHOD_5_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0x19231740)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSNAPCONTACTSHADOW_METHOD_5_2561DC986DD32699_OFFSET UNITYSDK_OFFSET(0x19233300)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSNAPCONTACTSHADOW_METHOD_5_25CD86BF8626C8D9_OFFSET UNITYSDK_OFFSET(0x19232080)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSNAPCONTACTSHADOW_METHOD_5_2A99139D13C42A50_1_OFFSET UNITYSDK_OFFSET(0x19234170)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSNAPCONTACTSHADOW_METHOD_5_2A99139D13C42A50_OFFSET UNITYSDK_OFFSET(0x19233A80)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSNAPCONTACTSHADOW_METHOD_5_37CF7377CBA6E635_OFFSET UNITYSDK_OFFSET(0x19231AE0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSNAPCONTACTSHADOW_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x19231930)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSNAPCONTACTSHADOW_METHOD_5_A4D542D66439C65E_OFFSET UNITYSDK_OFFSET(0x192322B0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSNAPCONTACTSHADOW_METHOD_5_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0x19231940)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSNAPCONTACTSHADOW__CTOR_OFFSET UNITYSDK_OFFSET(0x19234860)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESPostProcessNapContactShadow_TypeDefinitionIndex = 40725;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSNAPCONTACTSHADOW_METHOD_5_A4D542D66439C65E_OFFSET))(this, a1);
		}
