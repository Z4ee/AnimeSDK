...
#define MOLEMOLE_EFFECTSIMULATE_ESLIGHT_GET_LIGHTTYPE_OFFSET UNITYSDK_OFFSET(0x192C2470)
#define MOLEMOLE_EFFECTSIMULATE_ESLIGHT_METHOD_3_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x192C17A0)
#define MOLEMOLE_EFFECTSIMULATE_ESLIGHT_METHOD_3_2685B6183E614529_1_OFFSET UNITYSDK_OFFSET(0x192C3A30)
#define MOLEMOLE_EFFECTSIMULATE_ESLIGHT_METHOD_3_2685B6183E614529_2_OFFSET UNITYSDK_OFFSET(0x192C3AD0)
#define MOLEMOLE_EFFECTSIMULATE_ESLIGHT_METHOD_3_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x192C3900)
#define MOLEMOLE_EFFECTSIMULATE_ESLIGHT_METHOD_3_2D6A717E40A58BC9_OFFSET UNITYSDK_OFFSET(0x192C1860)
#define MOLEMOLE_EFFECTSIMULATE_ESLIGHT_METHOD_3_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x192C3870)
#define MOLEMOLE_EFFECTSIMULATE_ESLIGHT_METHOD_3_36714E99DCDF3D04_OFFSET UNITYSDK_OFFSET(0x192C2CE0)
#define MOLEMOLE_EFFECTSIMULATE_ESLIGHT_METHOD_3_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0x192C37E0)
#define MOLEMOLE_EFFECTSIMULATE_ESLIGHT_METHOD_3_391A84BCD9F51317_2_OFFSET UNITYSDK_OFFSET(0x192C3B70)
#define MOLEMOLE_EFFECTSIMULATE_ESLIGHT_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x192C1820)
#define MOLEMOLE_EFFECTSIMULATE_ESLIGHT_METHOD_3_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x192C39A0)
#define MOLEMOLE_EFFECTSIMULATE_ESLIGHT_METHOD_3_4272BE5198E6F216_OFFSET UNITYSDK_OFFSET(0x192C38F0)
#define MOLEMOLE_EFFECTSIMULATE_ESLIGHT_METHOD_3_CBE9026C6B9DC823_OFFSET UNITYSDK_OFFSET(0x192C3160)
#define MOLEMOLE_EFFECTSIMULATE_ESLIGHT_METHOD_3_DB3ED8CB2B8E8B5D_OFFSET UNITYSDK_OFFSET(0x192C20A0)
#define MOLEMOLE_EFFECTSIMULATE_ESLIGHT_METHOD_3_FF4D5A5D6DBC9904_OFFSET UNITYSDK_OFFSET(0x192C25F0)
#define MOLEMOLE_EFFECTSIMULATE_ESLIGHT__CCTOR_OFFSET UNITYSDK_OFFSET(0x192C37D0)
#define MOLEMOLE_EFFECTSIMULATE_ESLIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x192C3340)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESLight_TypeDefinitionIndex = 79061;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ESLight_TypeDefinitionIndex)->GetStaticField(0xF910);
		}
