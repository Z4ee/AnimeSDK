...
#define MOLEMOLE_EFFECTSIMULATE_RANDOMFLOAT_GET_CANUSERANDOM_OFFSET UNITYSDK_OFFSET(0x16E39940)
#define MOLEMOLE_EFFECTSIMULATE_RANDOMFLOAT_METHOD_1_8B133A880F05B901_OFFSET UNITYSDK_OFFSET(0x16E399C0)
#define MOLEMOLE_EFFECTSIMULATE_RANDOMFLOAT_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x16E39A90)
#define MOLEMOLE_EFFECTSIMULATE_RANDOMFLOAT_METHOD_1_D437D090E63BE8A7_OFFSET UNITYSDK_OFFSET(0x16E39A20)
#define MOLEMOLE_EFFECTSIMULATE_RANDOMFLOAT_SET_CANUSERANDOM_OFFSET UNITYSDK_OFFSET(0x16E39950)
#define MOLEMOLE_EFFECTSIMULATE_RANDOMFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x16E399B0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int RandomFloat_TypeDefinitionIndex = 51561;
