...
#define MOLEMOLE_EFFECTSIMULATE_ESPARTICLEMEMBERBEHAVIOR_METHOD_3_4272BE5198E6F216_OFFSET UNITYSDK_OFFSET(0x1495F090)
#define MOLEMOLE_EFFECTSIMULATE_ESPARTICLEMEMBERBEHAVIOR_METHOD_3_990C94EC15D6CE86_OFFSET UNITYSDK_OFFSET(0x1495EEA0)
#define MOLEMOLE_EFFECTSIMULATE_ESPARTICLEMEMBERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1495F020)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESParticleMemberBehavior_TypeDefinitionIndex = 73854;
