...
#define MOLEMOLE_EFFECTSIMULATE_ESUIIMAGE_METHOD_4_23C10DE8FC25A0DA_OFFSET UNITYSDK_OFFSET(0x1A0186F0)
#define MOLEMOLE_EFFECTSIMULATE_ESUIIMAGE_METHOD_4_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x1A018930)
#define MOLEMOLE_EFFECTSIMULATE_ESUIIMAGE_METHOD_4_6B5BBAB9118D01A9_OFFSET UNITYSDK_OFFSET(0x1A018320)
#define MOLEMOLE_EFFECTSIMULATE_ESUIIMAGE_METHOD_4_990C94EC15D6CE86_OFFSET UNITYSDK_OFFSET(0x1A0189C0)
#define MOLEMOLE_EFFECTSIMULATE_ESUIIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0188B0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESUIImage_TypeDefinitionIndex = 77321;
