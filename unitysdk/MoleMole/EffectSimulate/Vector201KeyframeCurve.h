...
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_GET_EDITORDEFAULTVAL_OFFSET UNITYSDK_OFFSET(0x19AFED20)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_GET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x19AFE9B0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_GET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0x19AFEB40)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_01F677A8852683A3_OFFSET UNITYSDK_OFFSET(0x19AFEAC0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_037E3F5BEC1EEC81_OFFSET UNITYSDK_OFFSET(0x19AFF4A0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_2356514D84A0DDE4_OFFSET UNITYSDK_OFFSET(0x19AFF040)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x19AFF7D0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_4552C310294DCA81_OFFSET UNITYSDK_OFFSET(0x19AFF190)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_456E9019CE0C69CF_OFFSET UNITYSDK_OFFSET(0x19AFEF00)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_5C660F51F7E7B3D8_OFFSET UNITYSDK_OFFSET(0x19AFF120)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x19AFF850)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_958E77D3D32E4233_OFFSET UNITYSDK_OFFSET(0x19AFF0B0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x19AFF660)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_A596B48F7BD9EDA6_OFFSET UNITYSDK_OFFSET(0x19AFED30)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_C21A7AC6282FB0D0_OFFSET UNITYSDK_OFFSET(0x19AFF450)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_E49226E55BF3741F_OFFSET UNITYSDK_OFFSET(0x19AFEF80)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_SET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x19AFEA10)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_SET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0x19AFEBA0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x19AFEC50)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int Vector201KeyframeCurve_TypeDefinitionIndex = 89161;
