...
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_GET_EDITORDEFAULTVAL_OFFSET UNITYSDK_OFFSET(0x177F6700)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_GET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x177F6390)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_GET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0x177F6520)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_01F677A8852683A3_OFFSET UNITYSDK_OFFSET(0x177F64A0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_037E3F5BEC1EEC81_OFFSET UNITYSDK_OFFSET(0x177F6E80)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_2356514D84A0DDE4_OFFSET UNITYSDK_OFFSET(0x177F6A20)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x177F71C0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_4552C310294DCA81_OFFSET UNITYSDK_OFFSET(0x177F6B70)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_456E9019CE0C69CF_OFFSET UNITYSDK_OFFSET(0x177F68E0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_5C660F51F7E7B3D8_OFFSET UNITYSDK_OFFSET(0x177F6B00)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x177F71B0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_958E77D3D32E4233_OFFSET UNITYSDK_OFFSET(0x177F6A90)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x177F7040)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_A596B48F7BD9EDA6_OFFSET UNITYSDK_OFFSET(0x177F6710)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_C21A7AC6282FB0D0_OFFSET UNITYSDK_OFFSET(0x177F6E30)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_E49226E55BF3741F_OFFSET UNITYSDK_OFFSET(0x177F6960)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_SET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x177F63F0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_SET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0x177F6580)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x177F6630)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int Vector201KeyframeCurve_TypeDefinitionIndex = 50190;
