...
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDERIMGLOW_METHOD_4_128774387667156B_10_OFFSET UNITYSDK_OFFSET(0x170D7230)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDERIMGLOW_METHOD_4_128774387667156B_11_OFFSET UNITYSDK_OFFSET(0x170D7270)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDERIMGLOW_METHOD_4_128774387667156B_12_OFFSET UNITYSDK_OFFSET(0x170D72B0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDERIMGLOW_METHOD_4_128774387667156B_1_OFFSET UNITYSDK_OFFSET(0x170D6FF0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDERIMGLOW_METHOD_4_128774387667156B_2_OFFSET UNITYSDK_OFFSET(0x170D7030)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDERIMGLOW_METHOD_4_128774387667156B_3_OFFSET UNITYSDK_OFFSET(0x170D7070)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDERIMGLOW_METHOD_4_128774387667156B_4_OFFSET UNITYSDK_OFFSET(0x170D70B0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDERIMGLOW_METHOD_4_128774387667156B_5_OFFSET UNITYSDK_OFFSET(0x170D70F0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDERIMGLOW_METHOD_4_128774387667156B_6_OFFSET UNITYSDK_OFFSET(0x170D7130)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDERIMGLOW_METHOD_4_128774387667156B_7_OFFSET UNITYSDK_OFFSET(0x170D7170)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDERIMGLOW_METHOD_4_128774387667156B_8_OFFSET UNITYSDK_OFFSET(0x170D71B0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDERIMGLOW_METHOD_4_128774387667156B_9_OFFSET UNITYSDK_OFFSET(0x170D71F0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDERIMGLOW_METHOD_4_128774387667156B_OFFSET UNITYSDK_OFFSET(0x170D69E0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDERIMGLOW_METHOD_4_5C90471BE03E101A_OFFSET UNITYSDK_OFFSET(0x170D6A80)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDERIMGLOW_METHOD_4_65F7F584FDCE6774_OFFSET UNITYSDK_OFFSET(0x170D6A20)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDERIMGLOW_METHOD_4_6F54E34F52AB60F6_OFFSET UNITYSDK_OFFSET(0x170D6590)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDERIMGLOW_METHOD_4_CF05E675E2E94F01_OFFSET UNITYSDK_OFFSET(0x170D6AB0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDERIMGLOW_METHOD_4_EB15466536C39910_OFFSET UNITYSDK_OFFSET(0x170D72F0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDERIMGLOW_METHOD_4_F922D767491C9C6A_OFFSET UNITYSDK_OFFSET(0x170D6760)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDERIMGLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x170D6AC0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESAvatarOverrideRimGlow_TypeDefinitionIndex = 79656;
	...
	public:
		...
		{
			return ((::System::Type*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDERIMGLOW_METHOD_4_5C90471BE03E101A_OFFSET))(this);
		}
