...
#define MOLEMOLE_EFFECTSIMULATE_ESUIINVERTMASK_METHOD_4_1471EFD2EDBD5779_OFFSET UNITYSDK_OFFSET(0x18F85230)
#define MOLEMOLE_EFFECTSIMULATE_ESUIINVERTMASK_METHOD_4_23C10DE8FC25A0DA_OFFSET UNITYSDK_OFFSET(0x18F858D0)
#define MOLEMOLE_EFFECTSIMULATE_ESUIINVERTMASK_METHOD_4_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x18F85C00)
#define MOLEMOLE_EFFECTSIMULATE_ESUIINVERTMASK_METHOD_4_990C94EC15D6CE86_OFFSET UNITYSDK_OFFSET(0x18F85C90)
#define MOLEMOLE_EFFECTSIMULATE_ESUIINVERTMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x18F85B90)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESUIInvertMask_TypeDefinitionIndex = 42321;
