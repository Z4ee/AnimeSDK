...
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARDIFFUSE_METHOD_4_128774387667156B_1_OFFSET UNITYSDK_OFFSET(0x1A4CE940)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARDIFFUSE_METHOD_4_128774387667156B_2_OFFSET UNITYSDK_OFFSET(0x1A4CE980)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARDIFFUSE_METHOD_4_128774387667156B_3_OFFSET UNITYSDK_OFFSET(0x1A4CE9C0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARDIFFUSE_METHOD_4_128774387667156B_4_OFFSET UNITYSDK_OFFSET(0x1A4CEBC0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARDIFFUSE_METHOD_4_128774387667156B_OFFSET UNITYSDK_OFFSET(0x1A4CE650)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARDIFFUSE_METHOD_4_52CB45FA69620080_OFFSET UNITYSDK_OFFSET(0x1A4CEA40)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARDIFFUSE_METHOD_4_6F54E34F52AB60F6_OFFSET UNITYSDK_OFFSET(0x1A4CE330)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARDIFFUSE_METHOD_4_9B92C44D5842AA8A_OFFSET UNITYSDK_OFFSET(0x1A4CEA00)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARDIFFUSE_METHOD_4_A3CF806971F50D26_OFFSET UNITYSDK_OFFSET(0x1A4CE690)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARDIFFUSE_METHOD_4_B8746CF4034D9E80_OFFSET UNITYSDK_OFFSET(0x1A4CE500)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARDIFFUSE_METHOD_4_CF05E675E2E94F01_OFFSET UNITYSDK_OFFSET(0x1A4CE700)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARDIFFUSE_METHOD_4_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1A4CE640)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARDIFFUSE_METHOD_4_FB9A1387D38501D0_OFFSET UNITYSDK_OFFSET(0x1A4CE6D0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARDIFFUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4CE710)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESAvatarDiffuse_TypeDefinitionIndex = 70794;
	...
	public:
		...
		{
			return ((::System::Type*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_ESAVATARDIFFUSE_METHOD_4_FB9A1387D38501D0_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Renderer*, ::UnityEngine::Material*, ::UnityEngine::MaterialPropertyBlock*, ::UnityEngine::Material*))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_ESAVATARDIFFUSE_METHOD_4_52CB45FA69620080_OFFSET))(this, a1, a2, a3, a4);
		}
