...
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_GET_EDITORDEFAULTVAL_OFFSET UNITYSDK_OFFSET(0x118A9350)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_GET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x118A8E40)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_GET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0x118A8FE0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_GET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0x118A9110)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_METHOD_4_0173DC4321843C93_OFFSET UNITYSDK_OFFSET(0x118A9710)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_METHOD_4_043B534750B9E7A6_OFFSET UNITYSDK_OFFSET(0x118A8F60)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_METHOD_4_05A2DFD507593DE5_OFFSET UNITYSDK_OFFSET(0x118A9F60)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_METHOD_4_31BBB9AD8D2C3DC7_OFFSET UNITYSDK_OFFSET(0x118A9810)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_METHOD_4_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x118AA3C0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_METHOD_4_459E632F046395C5_OFFSET UNITYSDK_OFFSET(0x118A9370)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_METHOD_4_4D3533BDA0DDCF1E_OFFSET UNITYSDK_OFFSET(0x118A9900)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_METHOD_4_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x118AA440)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_METHOD_4_8F089EFDA7DA3A98_OFFSET UNITYSDK_OFFSET(0x118A9880)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_METHOD_4_C813ED51B36FFD80_OFFSET UNITYSDK_OFFSET(0x118A9980)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_METHOD_4_D2A1DD761855A1B6_OFFSET UNITYSDK_OFFSET(0x118A9690)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_METHOD_4_D7852DE078ACC1F1_OFFSET UNITYSDK_OFFSET(0x118AA1C0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_METHOD_4_F10A0D072D26C4BF_OFFSET UNITYSDK_OFFSET(0x118A9ED0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_SET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x118A8EA0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_SET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0x118A9050)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_SET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0x118A9180)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x118A9240)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int Vector301KeyframeCurve_TypeDefinitionIndex = 43730;
