...
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_GET_EDITORDEFAULTVAL_OFFSET UNITYSDK_OFFSET(0x191B79E0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_GET_WKEYFRAME_OFFSET UNITYSDK_OFFSET(0x191B78C0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_GET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x191B74F0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_GET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0x191B7680)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_GET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0x191B77A0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_METHOD_4_043B534750B9E7A6_OFFSET UNITYSDK_OFFSET(0x191B7600)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_METHOD_4_0CD324DF036A29AB_OFFSET UNITYSDK_OFFSET(0x191B79F0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_METHOD_4_164B2BDEE6F7C25D_OFFSET UNITYSDK_OFFSET(0x191B7D70)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_METHOD_4_1DE6433C25680F9D_OFFSET UNITYSDK_OFFSET(0x191B83B0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_METHOD_4_21A9C5CD44F59232_OFFSET UNITYSDK_OFFSET(0x191B8000)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_METHOD_4_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x191B8640)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_METHOD_4_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x191B8630)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_METHOD_4_8899B33907DB68CE_OFFSET UNITYSDK_OFFSET(0x191B8130)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_METHOD_4_8F8B3C218D38C840_OFFSET UNITYSDK_OFFSET(0x191B80A0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_METHOD_4_A0F1D07FA5BAF2AE_OFFSET UNITYSDK_OFFSET(0x191B7DF0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_METHOD_4_B06E4777914A5853_OFFSET UNITYSDK_OFFSET(0x191572C0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_METHOD_4_B56234B03748E3AC_OFFSET UNITYSDK_OFFSET(0x191B7EC0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_METHOD_4_CEE72EAC18ECC163_OFFSET UNITYSDK_OFFSET(0x191B7F60)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_SET_WKEYFRAME_OFFSET UNITYSDK_OFFSET(0x191B7930)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_SET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x191B7550)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_SET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0x191B76F0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_SET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0x191B7810)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1915AD10)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int Vector401KeyframeCurve_TypeDefinitionIndex = 58504;
