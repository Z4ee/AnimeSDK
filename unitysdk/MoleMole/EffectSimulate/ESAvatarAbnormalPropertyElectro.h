...
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARABNORMALPROPERTYELECTRO_METHOD_4_128774387667156B_10_OFFSET UNITYSDK_OFFSET(0x1A081620)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARABNORMALPROPERTYELECTRO_METHOD_4_128774387667156B_11_OFFSET UNITYSDK_OFFSET(0x1A081660)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARABNORMALPROPERTYELECTRO_METHOD_4_128774387667156B_12_OFFSET UNITYSDK_OFFSET(0x1A0816A0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARABNORMALPROPERTYELECTRO_METHOD_4_128774387667156B_13_OFFSET UNITYSDK_OFFSET(0x1A0816E0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARABNORMALPROPERTYELECTRO_METHOD_4_128774387667156B_14_OFFSET UNITYSDK_OFFSET(0x1A081720)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARABNORMALPROPERTYELECTRO_METHOD_4_128774387667156B_1_OFFSET UNITYSDK_OFFSET(0x1A0810A0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARABNORMALPROPERTYELECTRO_METHOD_4_128774387667156B_2_OFFSET UNITYSDK_OFFSET(0x1A0810E0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARABNORMALPROPERTYELECTRO_METHOD_4_128774387667156B_3_OFFSET UNITYSDK_OFFSET(0x1A081120)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARABNORMALPROPERTYELECTRO_METHOD_4_128774387667156B_4_OFFSET UNITYSDK_OFFSET(0x1A081160)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARABNORMALPROPERTYELECTRO_METHOD_4_128774387667156B_5_OFFSET UNITYSDK_OFFSET(0x1A0814E0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARABNORMALPROPERTYELECTRO_METHOD_4_128774387667156B_6_OFFSET UNITYSDK_OFFSET(0x1A081520)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARABNORMALPROPERTYELECTRO_METHOD_4_128774387667156B_7_OFFSET UNITYSDK_OFFSET(0x1A081560)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARABNORMALPROPERTYELECTRO_METHOD_4_128774387667156B_8_OFFSET UNITYSDK_OFFSET(0x1A0815A0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARABNORMALPROPERTYELECTRO_METHOD_4_128774387667156B_9_OFFSET UNITYSDK_OFFSET(0x1A0815E0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARABNORMALPROPERTYELECTRO_METHOD_4_128774387667156B_OFFSET UNITYSDK_OFFSET(0x1A0809A0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARABNORMALPROPERTYELECTRO_METHOD_4_5C90471BE03E101A_OFFSET UNITYSDK_OFFSET(0x1A080A50)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARABNORMALPROPERTYELECTRO_METHOD_4_65F7F584FDCE6774_OFFSET UNITYSDK_OFFSET(0x1A0809E0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARABNORMALPROPERTYELECTRO_METHOD_4_6F54E34F52AB60F6_OFFSET UNITYSDK_OFFSET(0x1A0804C0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARABNORMALPROPERTYELECTRO_METHOD_4_CF05E675E2E94F01_OFFSET UNITYSDK_OFFSET(0x1A080A80)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARABNORMALPROPERTYELECTRO_METHOD_4_EB15466536C39910_OFFSET UNITYSDK_OFFSET(0x1A0811A0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARABNORMALPROPERTYELECTRO_METHOD_4_F922D767491C9C6A_OFFSET UNITYSDK_OFFSET(0x1A080690)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARABNORMALPROPERTYELECTRO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A080A90)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESAvatarAbnormalPropertyElectro_TypeDefinitionIndex = 44785;
	...
	public:
		...
		{
			return ((::System::Type*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_ESAVATARABNORMALPROPERTYELECTRO_METHOD_4_5C90471BE03E101A_OFFSET))(this);
		}
