...
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSDIRECTIONALBLUR_METHOD_5_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0x18F6A0E0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSDIRECTIONALBLUR_METHOD_5_0BF1620F1E4289BD_OFFSET UNITYSDK_OFFSET(0x18F6AC10)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSDIRECTIONALBLUR_METHOD_5_0FD0EC313FAAB75A_OFFSET UNITYSDK_OFFSET(0x18F6A280)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSDIRECTIONALBLUR_METHOD_5_5BD973238595BF89_OFFSET UNITYSDK_OFFSET(0x18F6C130)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSDIRECTIONALBLUR_METHOD_5_65BB8F0F1E258993_1_OFFSET UNITYSDK_OFFSET(0x18F6CD40)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSDIRECTIONALBLUR_METHOD_5_65BB8F0F1E258993_OFFSET UNITYSDK_OFFSET(0x18F6CA00)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSDIRECTIONALBLUR_METHOD_5_80313B77C31AD02B_OFFSET UNITYSDK_OFFSET(0x18F6A470)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSDIRECTIONALBLUR_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x18F6A270)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSDIRECTIONALBLUR_METHOD_5_C6534C82224A6491_OFFSET UNITYSDK_OFFSET(0x18F6ACE0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSDIRECTIONALBLUR__CTOR_OFFSET UNITYSDK_OFFSET(0x18F6D080)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESPostProcessDirectionalBlur_TypeDefinitionIndex = 83527;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSDIRECTIONALBLUR_METHOD_5_5BD973238595BF89_OFFSET))(this, a1);
		}
