...
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_GET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x12FF5860)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_GET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0x12FF5900)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_GET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0x12FF59A0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_011F18E07064382B_OFFSET UNITYSDK_OFFSET(0x12FF5CB0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_0173DC4321843C93_OFFSET UNITYSDK_OFFSET(0x12FF60C0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_04EDF435A0D753A9_OFFSET UNITYSDK_OFFSET(0x12FF5FC0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_31BBB9AD8D2C3DC7_OFFSET UNITYSDK_OFFSET(0x12FF5B30)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x12FF68B0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_76CD9B9D1269FA90_OFFSET UNITYSDK_OFFSET(0x12FF64D0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x12FF68A0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_8B6B6AE1C765104E_OFFSET UNITYSDK_OFFSET(0x12FF61C0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_8F089EFDA7DA3A98_OFFSET UNITYSDK_OFFSET(0x12FF5BA0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_9823BFA3CE8B5542_OFFSET UNITYSDK_OFFSET(0x12FF6380)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x12FF6440)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_D7852DE078ACC1F1_OFFSET UNITYSDK_OFFSET(0x12FF66A0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_F10A0D072D26C4BF_OFFSET UNITYSDK_OFFSET(0x12FF5C20)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_SET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x12FF5890)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_SET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0x12FF5930)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_SET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0x12FF59D0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x12FF5A40)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int Vector3KeyframeCurve_TypeDefinitionIndex = 47149;
