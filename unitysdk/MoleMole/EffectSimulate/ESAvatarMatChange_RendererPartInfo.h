...
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARMATCHANGE_RENDERERPARTINFO_METHOD_1_24E7552FF0F8F32A_OFFSET UNITYSDK_OFFSET(0x1627EFC0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARMATCHANGE_RENDERERPARTINFO_METHOD_1_4E056BB144231A80_1_OFFSET UNITYSDK_OFFSET(0x1627F310)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARMATCHANGE_RENDERERPARTINFO_METHOD_1_4E056BB144231A80_OFFSET UNITYSDK_OFFSET(0x1627EF60)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARMATCHANGE_RENDERERPARTINFO_METHOD_1_7B0A407379BA27E7_OFFSET UNITYSDK_OFFSET(0x1627F4A0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARMATCHANGE_RENDERERPARTINFO_METHOD_1_B0A7B48A95450D3C_OFFSET UNITYSDK_OFFSET(0x1627F370)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARMATCHANGE_RENDERERPARTINFO_METHOD_1_D378F4A233D67999_OFFSET UNITYSDK_OFFSET(0x1627EBD0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARMATCHANGE_RENDERERPARTINFO_METHOD_1_DD590BDFE4ADC9A9_OFFSET UNITYSDK_OFFSET(0x1627EA30)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARMATCHANGE_RENDERERPARTINFO_METHOD_1_F5A738034151F52F_OFFSET UNITYSDK_OFFSET(0x1627F2B0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARMATCHANGE_RENDERERPARTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16278560)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESAvatarMatChange_RendererPartInfo_TypeDefinitionIndex = 48681;
