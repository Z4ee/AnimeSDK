...
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARMATCHANGE_RENDERERPARTINFO_METHOD_1_24E7552FF0F8F32A_OFFSET UNITYSDK_OFFSET(0x1104CA40)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARMATCHANGE_RENDERERPARTINFO_METHOD_1_4E056BB144231A80_1_OFFSET UNITYSDK_OFFSET(0x1104D530)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARMATCHANGE_RENDERERPARTINFO_METHOD_1_4E056BB144231A80_OFFSET UNITYSDK_OFFSET(0x1104D0C0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARMATCHANGE_RENDERERPARTINFO_METHOD_1_7B0A407379BA27E7_OFFSET UNITYSDK_OFFSET(0x1104D120)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARMATCHANGE_RENDERERPARTINFO_METHOD_1_B0A7B48A95450D3C_OFFSET UNITYSDK_OFFSET(0x1104D400)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARMATCHANGE_RENDERERPARTINFO_METHOD_1_D378F4A233D67999_OFFSET UNITYSDK_OFFSET(0x1104CD30)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARMATCHANGE_RENDERERPARTINFO_METHOD_1_DD590BDFE4ADC9A9_OFFSET UNITYSDK_OFFSET(0x1104A400)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARMATCHANGE_RENDERERPARTINFO_METHOD_1_F5A738034151F52F_OFFSET UNITYSDK_OFFSET(0x1104D3A0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARMATCHANGE_RENDERERPARTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x11042110)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESAvatarMatChange_RendererPartInfo_TypeDefinitionIndex = 63018;
