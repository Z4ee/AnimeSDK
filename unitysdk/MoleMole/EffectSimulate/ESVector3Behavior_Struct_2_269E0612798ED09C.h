...
{
	inline static constexpr unsigned int ESVector3Behavior_Struct_2_269E0612798ED09C_TypeDefinitionIndex = 54765;

	struct alignas(8) ESVector3Behavior_Struct_2_269E0612798ED09C
	{
		::MoleMole::EffectSimulate::Vector3Curve* Field_2_3; // 0x10
