...
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARWEAPONBALLMAINMAPS_METHOD_4_128774387667156B_1_OFFSET UNITYSDK_OFFSET(0x1A084010)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARWEAPONBALLMAINMAPS_METHOD_4_128774387667156B_2_OFFSET UNITYSDK_OFFSET(0x1A084050)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARWEAPONBALLMAINMAPS_METHOD_4_128774387667156B_3_OFFSET UNITYSDK_OFFSET(0x1A084090)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARWEAPONBALLMAINMAPS_METHOD_4_128774387667156B_OFFSET UNITYSDK_OFFSET(0x1A083C00)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARWEAPONBALLMAINMAPS_METHOD_4_5C90471BE03E101A_OFFSET UNITYSDK_OFFSET(0x1A083C90)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARWEAPONBALLMAINMAPS_METHOD_4_65F7F584FDCE6774_OFFSET UNITYSDK_OFFSET(0x1A083C40)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARWEAPONBALLMAINMAPS_METHOD_4_6F54E34F52AB60F6_OFFSET UNITYSDK_OFFSET(0x1A0838E0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARWEAPONBALLMAINMAPS_METHOD_4_B8746CF4034D9E80_OFFSET UNITYSDK_OFFSET(0x1A083AB0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARWEAPONBALLMAINMAPS_METHOD_4_CF05E675E2E94F01_OFFSET UNITYSDK_OFFSET(0x1A083CC0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARWEAPONBALLMAINMAPS_METHOD_4_EB15466536C39910_OFFSET UNITYSDK_OFFSET(0x1A083EE0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARWEAPONBALLMAINMAPS_METHOD_4_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1A083BF0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARWEAPONBALLMAINMAPS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A083CD0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESAvatarWeaponBallMainMaps_TypeDefinitionIndex = 45058;
	...
	public:
		...
		{
			return ((::System::Type*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_ESAVATARWEAPONBALLMAINMAPS_METHOD_4_5C90471BE03E101A_OFFSET))(this);
		}
