...
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDE2TONE_METHOD_4_128774387667156B_10_OFFSET UNITYSDK_OFFSET(0x1B503CE0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDE2TONE_METHOD_4_128774387667156B_1_OFFSET UNITYSDK_OFFSET(0x1B5036B0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDE2TONE_METHOD_4_128774387667156B_2_OFFSET UNITYSDK_OFFSET(0x1B5036F0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDE2TONE_METHOD_4_128774387667156B_3_OFFSET UNITYSDK_OFFSET(0x1B503730)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDE2TONE_METHOD_4_128774387667156B_4_OFFSET UNITYSDK_OFFSET(0x1B503B40)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDE2TONE_METHOD_4_128774387667156B_5_OFFSET UNITYSDK_OFFSET(0x1B503B80)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDE2TONE_METHOD_4_128774387667156B_6_OFFSET UNITYSDK_OFFSET(0x1B503BD0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDE2TONE_METHOD_4_128774387667156B_7_OFFSET UNITYSDK_OFFSET(0x1B503C20)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDE2TONE_METHOD_4_128774387667156B_8_OFFSET UNITYSDK_OFFSET(0x1B503C60)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDE2TONE_METHOD_4_128774387667156B_9_OFFSET UNITYSDK_OFFSET(0x1B503CA0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDE2TONE_METHOD_4_128774387667156B_OFFSET UNITYSDK_OFFSET(0x1B503230)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDE2TONE_METHOD_4_15169B7DEE2D29F3_OFFSET UNITYSDK_OFFSET(0x1B503060)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDE2TONE_METHOD_4_52CB45FA69620080_OFFSET UNITYSDK_OFFSET(0x1B503770)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDE2TONE_METHOD_4_65F7F584FDCE6774_OFFSET UNITYSDK_OFFSET(0x1B503270)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDE2TONE_METHOD_4_6F54E34F52AB60F6_OFFSET UNITYSDK_OFFSET(0x1B502E90)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDE2TONE_METHOD_4_9B92C44D5842AA8A_OFFSET UNITYSDK_OFFSET(0x1B503B00)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDE2TONE_METHOD_4_CF05E675E2E94F01_OFFSET UNITYSDK_OFFSET(0x1B503300)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDE2TONE_METHOD_4_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x1B503BC0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDE2TONE_METHOD_4_F0088C88851A7DFB_2_OFFSET UNITYSDK_OFFSET(0x1B503C10)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDE2TONE_METHOD_4_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1B5036A0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDE2TONE_METHOD_4_FB9A1387D38501D0_OFFSET UNITYSDK_OFFSET(0x1B5032D0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDE2TONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B503310)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESAvatarOverride2Tone_TypeDefinitionIndex = 69914;
	...
	public:
		...
		{
			return ((::System::Type*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDE2TONE_METHOD_4_FB9A1387D38501D0_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Renderer*, ::UnityEngine::Material*, ::UnityEngine::MaterialPropertyBlock*, ::UnityEngine::Material*))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_ESAVATAROVERRIDE2TONE_METHOD_4_52CB45FA69620080_OFFSET))(this, a1, a2, a3, a4);
		}
