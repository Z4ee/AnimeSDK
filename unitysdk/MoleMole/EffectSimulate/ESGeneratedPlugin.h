...
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_0F5FCD9311F1F043_OFFSET UNITYSDK_OFFSET(0x115FA510)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_17D6658AB3662CFC_OFFSET UNITYSDK_OFFSET(0x115FA3A0)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_2685B6183E614529_1_OFFSET UNITYSDK_OFFSET(0x115FA0B0)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_2685B6183E614529_2_OFFSET UNITYSDK_OFFSET(0x115FA110)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_2685B6183E614529_3_OFFSET UNITYSDK_OFFSET(0x115FA190)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_2685B6183E614529_4_OFFSET UNITYSDK_OFFSET(0x115FA570)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_2685B6183E614529_5_OFFSET UNITYSDK_OFFSET(0x115FA920)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x115FA050)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_336DFDB5749719BB_OFFSET UNITYSDK_OFFSET(0x115FA9C0)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_5A6C775540DF4D71_OFFSET UNITYSDK_OFFSET(0x115FAB10)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_63320E40C83A8B11_OFFSET UNITYSDK_OFFSET(0x115FA450)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_634A76FECFEA4D77_OFFSET UNITYSDK_OFFSET(0x115FA8C0)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_7C59A089E6388962_OFFSET UNITYSDK_OFFSET(0x115FABA0)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_8FAFE9E50DAA8169_OFFSET UNITYSDK_OFFSET(0x115FA850)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_93097B60EF70000E_OFFSET UNITYSDK_OFFSET(0x115FA610)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_934BA889F3752EEB_OFFSET UNITYSDK_OFFSET(0x115FAA80)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_B02969298FA9638E_OFFSET UNITYSDK_OFFSET(0x115FA2F0)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_B9BF76B9DB6922FB_OFFSET UNITYSDK_OFFSET(0x115FA280)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x115FA210)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESGeneratedPlugin_TypeDefinitionIndex = 61263;
