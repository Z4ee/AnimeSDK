...
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_0F5FCD9311F1F043_OFFSET UNITYSDK_OFFSET(0x14267FF0)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_17D6658AB3662CFC_OFFSET UNITYSDK_OFFSET(0x142680E0)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_2685B6183E614529_1_OFFSET UNITYSDK_OFFSET(0x14267610)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_2685B6183E614529_2_OFFSET UNITYSDK_OFFSET(0x14267670)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_2685B6183E614529_3_OFFSET UNITYSDK_OFFSET(0x142676F0)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_2685B6183E614529_4_OFFSET UNITYSDK_OFFSET(0x14267910)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_2685B6183E614529_5_OFFSET UNITYSDK_OFFSET(0x14267BD0)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x142675B0)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_336DFDB5749719BB_OFFSET UNITYSDK_OFFSET(0x14267850)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_5A6C775540DF4D71_OFFSET UNITYSDK_OFFSET(0x14267C70)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_63320E40C83A8B11_OFFSET UNITYSDK_OFFSET(0x14267AB0)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_634A76FECFEA4D77_OFFSET UNITYSDK_OFFSET(0x14267B70)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_7C59A089E6388962_OFFSET UNITYSDK_OFFSET(0x14268050)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_8FAFE9E50DAA8169_OFFSET UNITYSDK_OFFSET(0x142677E0)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_93097B60EF70000E_OFFSET UNITYSDK_OFFSET(0x14267D00)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_934BA889F3752EEB_OFFSET UNITYSDK_OFFSET(0x14267A20)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_B02969298FA9638E_OFFSET UNITYSDK_OFFSET(0x14267F40)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN_METHOD_4_B9BF76B9DB6922FB_OFFSET UNITYSDK_OFFSET(0x142679B0)
#define MOLEMOLE_EFFECTSIMULATE_ESGENERATEDPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x14267770)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESGeneratedPlugin_TypeDefinitionIndex = 66149;
