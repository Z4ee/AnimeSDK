...
#define MOLEMOLE_EFFECTSIMULATE_AVATARMATCHANGE_EXPORTCONTEXTACTIVITY_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x19D6FDF0)
#define MOLEMOLE_EFFECTSIMULATE_AVATARMATCHANGE_EXPORTCONTEXTACTIVITY_METHOD_2_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x19D6FD20)
#define MOLEMOLE_EFFECTSIMULATE_AVATARMATCHANGE_EXPORTCONTEXTACTIVITY_METHOD_2_8A082AE0230435DC_OFFSET UNITYSDK_OFFSET(0x19D6FBB0)
#define MOLEMOLE_EFFECTSIMULATE_AVATARMATCHANGE_EXPORTCONTEXTACTIVITY_METHOD_2_B345A53823FD29B2_OFFSET UNITYSDK_OFFSET(0x19D6FA00)
#define MOLEMOLE_EFFECTSIMULATE_AVATARMATCHANGE_EXPORTCONTEXTACTIVITY__CTOR_OFFSET UNITYSDK_OFFSET(0x19D6FD90)

namespace MoleMole::EffectSimulate::AvatarMatChange
{
	inline static constexpr unsigned int ExportContextActivity_TypeDefinitionIndex = 86613;
