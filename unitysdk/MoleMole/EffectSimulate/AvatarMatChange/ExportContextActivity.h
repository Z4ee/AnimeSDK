...
#define MOLEMOLE_EFFECTSIMULATE_AVATARMATCHANGE_EXPORTCONTEXTACTIVITY_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x15A08950)
#define MOLEMOLE_EFFECTSIMULATE_AVATARMATCHANGE_EXPORTCONTEXTACTIVITY_METHOD_2_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x15A08880)
#define MOLEMOLE_EFFECTSIMULATE_AVATARMATCHANGE_EXPORTCONTEXTACTIVITY_METHOD_2_8A082AE0230435DC_OFFSET UNITYSDK_OFFSET(0x15A08710)
#define MOLEMOLE_EFFECTSIMULATE_AVATARMATCHANGE_EXPORTCONTEXTACTIVITY_METHOD_2_B345A53823FD29B2_OFFSET UNITYSDK_OFFSET(0x15A08560)
#define MOLEMOLE_EFFECTSIMULATE_AVATARMATCHANGE_EXPORTCONTEXTACTIVITY__CTOR_OFFSET UNITYSDK_OFFSET(0x15A088F0)

namespace MoleMole::EffectSimulate::AvatarMatChange
{
	inline static constexpr unsigned int ExportContextActivity_TypeDefinitionIndex = 56607;
