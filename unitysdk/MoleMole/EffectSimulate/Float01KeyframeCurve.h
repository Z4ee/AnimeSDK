...
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_GET_EDITORDEFAULTVAL_OFFSET UNITYSDK_OFFSET(0x182B1930)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_GET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x182B1780)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_11104293008C2056_OFFSET UNITYSDK_OFFSET(0x182B1A50)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x182B1E70)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_627557CE4CD0ABB4_OFFSET UNITYSDK_OFFSET(0x182B1C80)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_72D76C080E60069F_OFFSET UNITYSDK_OFFSET(0x182B1D20)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_7A37753F2CEC6D53_OFFSET UNITYSDK_OFFSET(0x182B19F0)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x182B1F40)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_9FBCB7EE3738DEA4_OFFSET UNITYSDK_OFFSET(0x182B1B60)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x182B1B10)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_AE7ACA9431B8342C_OFFSET UNITYSDK_OFFSET(0x182B1990)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_D5CE98C81E7D70E3_OFFSET UNITYSDK_OFFSET(0x182B1940)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_FED21563FA953D2A_OFFSET UNITYSDK_OFFSET(0x182B1C10)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_SET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x182B17E0)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x182B1850)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int Float01KeyframeCurve_TypeDefinitionIndex = 76388;
