...
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSCHARACTERVOLUMEPROXY_METHOD_5_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0x19D6FE40)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSCHARACTERVOLUMEPROXY_METHOD_5_0BF1620F1E4289BD_OFFSET UNITYSDK_OFFSET(0x19D70350)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSCHARACTERVOLUMEPROXY_METHOD_5_24B05D2E15A5C3C8_OFFSET UNITYSDK_OFFSET(0x19D70130)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSCHARACTERVOLUMEPROXY_METHOD_5_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x19D6FFE0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSCHARACTERVOLUMEPROXY_METHOD_5_65BB8F0F1E258993_1_OFFSET UNITYSDK_OFFSET(0x19D70BC0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSCHARACTERVOLUMEPROXY_METHOD_5_65BB8F0F1E258993_2_OFFSET UNITYSDK_OFFSET(0x19D70F00)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSCHARACTERVOLUMEPROXY_METHOD_5_65BB8F0F1E258993_OFFSET UNITYSDK_OFFSET(0x19D70850)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSCHARACTERVOLUMEPROXY_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x19D6FFD0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSCHARACTERVOLUMEPROXY_METHOD_5_853336442C31C044_OFFSET UNITYSDK_OFFSET(0x19D70420)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSCHARACTERVOLUMEPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x19D71240)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESPostProcessCharacterVolumeProxy_TypeDefinitionIndex = 60531;
