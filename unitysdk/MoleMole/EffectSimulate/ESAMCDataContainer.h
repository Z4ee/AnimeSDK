...
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_ENSURETARGETASSETNEW_OFFSET UNITYSDK_OFFSET(0x17E55A90)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_GETTARGETASSETNEWBYCTX_OFFSET UNITYSDK_OFFSET(0x17E55A50)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_INITCTX_OFFSET UNITYSDK_OFFSET(0x17E55DB0)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x17E56550)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_08550FA7D4D2CFC9_OFFSET UNITYSDK_OFFSET(0x17E55D20)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_1FB5DBFCDAB7243D_OFFSET UNITYSDK_OFFSET(0x17E55E80)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_8AE88CC79AC0221D_OFFSET UNITYSDK_OFFSET(0x17E56370)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x17E56330)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x17E565A0)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x17E55D70)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_E9E44213FE3B59FD_OFFSET UNITYSDK_OFFSET(0x17E56480)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_TRYEXPROT_OFFSET UNITYSDK_OFFSET(0x17E55F10)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER__CCTOR_OFFSET UNITYSDK_OFFSET(0x17E560F0)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x17E560A0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESAMCDataContainer_TypeDefinitionIndex = 85081;
	...
	public:
		...
		{
			return (::Sirenix::OdinInspector::ValueDropdownList_1<::MoleMole::EffectSimulate::ESAMCDataContainer_Enum_3_CD74075A03CBCAFE>**)Il2CppClass::FromTypeDefinitionIndex(ESAMCDataContainer_TypeDefinitionIndex)->GetStaticField(0x44CA0);
		}
