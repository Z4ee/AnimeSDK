...
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_ENSURETARGETASSETNEW_OFFSET UNITYSDK_OFFSET(0x16B62940)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_GETTARGETASSETNEWBYCTX_OFFSET UNITYSDK_OFFSET(0x16B62900)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_INITCTX_OFFSET UNITYSDK_OFFSET(0x16B62C60)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x16B63400)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_08550FA7D4D2CFC9_OFFSET UNITYSDK_OFFSET(0x16B62BD0)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_1FB5DBFCDAB7243D_OFFSET UNITYSDK_OFFSET(0x16B62D30)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_8AE88CC79AC0221D_OFFSET UNITYSDK_OFFSET(0x16B63220)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x16B62C20)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x16B63450)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x16B631E0)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_E9E44213FE3B59FD_OFFSET UNITYSDK_OFFSET(0x16B63330)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_TRYEXPROT_OFFSET UNITYSDK_OFFSET(0x16B62DC0)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER__CCTOR_OFFSET UNITYSDK_OFFSET(0x16B62FA0)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x16B62F50)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESAMCDataContainer_TypeDefinitionIndex = 48693;
	...
	public:
		...
		{
			return (::Sirenix::OdinInspector::ValueDropdownList_1<::MoleMole::EffectSimulate::ESAMCDataContainer_Enum_3_CD74075A03CBCAFE>**)Il2CppClass::FromTypeDefinitionIndex(ESAMCDataContainer_TypeDefinitionIndex)->GetStaticField(0x41B70);
		}
