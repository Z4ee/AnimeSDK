...
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_249FA32D7067822D_OFFSET UNITYSDK_OFFSET(0x138274E0)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_37285E3083F6D690_OFFSET UNITYSDK_OFFSET(0x13827630)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_56EAD71929EF7E75_OFFSET UNITYSDK_OFFSET(0x13826F20)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_63E7CA2473DB5E8B_OFFSET UNITYSDK_OFFSET(0x13826A70)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_6FF3E514220A5943_OFFSET UNITYSDK_OFFSET(0x13826A20)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_A2FA6C3F3F699E32_OFFSET UNITYSDK_OFFSET(0x138270E0)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_B747781924F4C9A5_OFFSET UNITYSDK_OFFSET(0x13826B60)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_CA16E66277F3799C_OFFSET UNITYSDK_OFFSET(0x138269B0)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x138270A0)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x13826AB0)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_DEC74973168460AA_OFFSET UNITYSDK_OFFSET(0x13826DF0)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_E88782EA1EE9EB39_OFFSET UNITYSDK_OFFSET(0x13826C30)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x13826AF0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESShaderCustomBehavior_TypeDefinitionIndex = 58175;
	...
	public:
		...
		::NapGradient* Method_3_56EAD71929EF7E75(::MoleMole::EffectSimulate::ColorKeyframeCurve* a1)
		{
			return ((::NapGradient*(*)(::PVOID, ::MoleMole::EffectSimulate::ColorKeyframeCurve*))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_56EAD71929EF7E75_OFFSET))(this, a1);
		}
