...
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_249FA32D7067822D_OFFSET UNITYSDK_OFFSET(0x12BA5510)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_37285E3083F6D690_OFFSET UNITYSDK_OFFSET(0x12BA5FE0)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_5BBD93948C2F2F16_OFFSET UNITYSDK_OFFSET(0x12BA5CA0)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_63E7CA2473DB5E8B_OFFSET UNITYSDK_OFFSET(0x12BA5420)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_6FF3E514220A5943_OFFSET UNITYSDK_OFFSET(0x12BA53D0)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_A2FA6C3F3F699E32_OFFSET UNITYSDK_OFFSET(0x12BA58A0)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_B747781924F4C9A5_OFFSET UNITYSDK_OFFSET(0x12BA5660)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_CA16E66277F3799C_OFFSET UNITYSDK_OFFSET(0x12BA5360)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x12BA5730)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x12BA5460)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_DEC74973168460AA_OFFSET UNITYSDK_OFFSET(0x12BA5770)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_E88782EA1EE9EB39_OFFSET UNITYSDK_OFFSET(0x12BA5E20)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x12BA54A0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESShaderCustomBehavior_TypeDefinitionIndex = 76086;
