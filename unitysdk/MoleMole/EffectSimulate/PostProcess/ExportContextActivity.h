...
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTACTIVITY_METHOD_2_102F0330C791FBB8_OFFSET UNITYSDK_OFFSET(0x153F6930)
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTACTIVITY_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x153F6CB0)
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTACTIVITY_METHOD_2_420F5543CED5025E_OFFSET UNITYSDK_OFFSET(0x153F6B20)
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTACTIVITY_METHOD_2_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x153F6C30)
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTACTIVITY__CTOR_OFFSET UNITYSDK_OFFSET(0x153F6CA0)

namespace MoleMole::EffectSimulate::PostProcess
{
	inline static constexpr unsigned int ExportContextActivity_TypeDefinitionIndex = 51756;
