...
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTACTIVITY_METHOD_2_102F0330C791FBB8_OFFSET UNITYSDK_OFFSET(0x161C11A0)
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTACTIVITY_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x161C1520)
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTACTIVITY_METHOD_2_420F5543CED5025E_OFFSET UNITYSDK_OFFSET(0x161C1390)
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTACTIVITY_METHOD_2_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x161C14A0)
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTACTIVITY__CTOR_OFFSET UNITYSDK_OFFSET(0x161C1510)

namespace MoleMole::EffectSimulate::PostProcess
{
	inline static constexpr unsigned int ExportContextActivity_TypeDefinitionIndex = 60344;
