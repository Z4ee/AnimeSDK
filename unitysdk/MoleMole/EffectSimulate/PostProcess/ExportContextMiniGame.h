...
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTMINIGAME_METHOD_2_102F0330C791FBB8_OFFSET UNITYSDK_OFFSET(0x149CEBF0)
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTMINIGAME_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x149CEF70)
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTMINIGAME_METHOD_2_420F5543CED5025E_OFFSET UNITYSDK_OFFSET(0x149CEDE0)
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTMINIGAME_METHOD_2_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x149CEEF0)
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTMINIGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x149CEF60)

namespace MoleMole::EffectSimulate::PostProcess
{
	inline static constexpr unsigned int ExportContextMiniGame_TypeDefinitionIndex = 59153;
