...
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTHOLLOW_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x118A8DF0)
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTHOLLOW_METHOD_2_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x118A8D70)
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTHOLLOW_METHOD_2_BA0DC2F7F154B425_OFFSET UNITYSDK_OFFSET(0x118A8BB0)
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTHOLLOW_METHOD_2_C101CD8C5CF89A5A_OFFSET UNITYSDK_OFFSET(0x118A8CC0)
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTHOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x118A8DE0)

namespace MoleMole::EffectSimulate::PostProcess
{
	inline static constexpr unsigned int ExportContextHollow_TypeDefinitionIndex = 47895;
