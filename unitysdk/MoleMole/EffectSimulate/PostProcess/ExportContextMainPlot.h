...
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTMAINPLOT_METHOD_2_102F0330C791FBB8_OFFSET UNITYSDK_OFFSET(0x170BA540)
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTMAINPLOT_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x170BA8F0)
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTMAINPLOT_METHOD_2_420F5543CED5025E_OFFSET UNITYSDK_OFFSET(0x170BA730)
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTMAINPLOT_METHOD_2_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x170BA840)
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTMAINPLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x170BA8B0)

namespace MoleMole::EffectSimulate::PostProcess
{
	inline static constexpr unsigned int ExportContextMainPlot_TypeDefinitionIndex = 48788;
