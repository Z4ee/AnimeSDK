...
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_0EB2899F45F512FE_OFFSET UNITYSDK_OFFSET(0x1A013DA0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_128774387667156B_10_OFFSET UNITYSDK_OFFSET(0x1A013CD0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_128774387667156B_11_OFFSET UNITYSDK_OFFSET(0x1A013D10)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_128774387667156B_12_OFFSET UNITYSDK_OFFSET(0x1A013D50)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_128774387667156B_13_OFFSET UNITYSDK_OFFSET(0x1A013F00)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_128774387667156B_14_OFFSET UNITYSDK_OFFSET(0x1A013F40)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_128774387667156B_15_OFFSET UNITYSDK_OFFSET(0x1A013FE0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_128774387667156B_1_OFFSET UNITYSDK_OFFSET(0x1A013720)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_128774387667156B_2_OFFSET UNITYSDK_OFFSET(0x1A013A50)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_128774387667156B_3_OFFSET UNITYSDK_OFFSET(0x1A013A90)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_128774387667156B_4_OFFSET UNITYSDK_OFFSET(0x1A013AD0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_128774387667156B_5_OFFSET UNITYSDK_OFFSET(0x1A013B50)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_128774387667156B_6_OFFSET UNITYSDK_OFFSET(0x1A013B90)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_128774387667156B_7_OFFSET UNITYSDK_OFFSET(0x1A013C10)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_128774387667156B_8_OFFSET UNITYSDK_OFFSET(0x1A013C50)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_128774387667156B_9_OFFSET UNITYSDK_OFFSET(0x1A013C90)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_128774387667156B_OFFSET UNITYSDK_OFFSET(0x1A012490)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_2EC08A3DF3EE073C_OFFSET UNITYSDK_OFFSET(0x1A012260)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_50EDCF53F0176FCF_OFFSET UNITYSDK_OFFSET(0x1A012560)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_550E8CE56610A57E_OFFSET UNITYSDK_OFFSET(0x1A013D90)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_5C90471BE03E101A_OFFSET UNITYSDK_OFFSET(0x1A012520)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_65F7F584FDCE6774_OFFSET UNITYSDK_OFFSET(0x1A0124D0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_6F54E34F52AB60F6_OFFSET UNITYSDK_OFFSET(0x1A012090)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_97B3D064317CBD55_OFFSET UNITYSDK_OFFSET(0x1A013760)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_9B92C44D5842AA8A_1_OFFSET UNITYSDK_OFFSET(0x1A013BD0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_9B92C44D5842AA8A_2_OFFSET UNITYSDK_OFFSET(0x1A013FA0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_9B92C44D5842AA8A_OFFSET UNITYSDK_OFFSET(0x1A013B10)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_CF05E675E2E94F01_OFFSET UNITYSDK_OFFSET(0x1A012550)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1A013F80)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A013280)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESAvatarSecondaryEmission_TypeDefinitionIndex = 49688;
	...
	public:
		...
		{
			return ((::System::Type*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_ESAVATARSECONDARYEMISSION_METHOD_4_5C90471BE03E101A_OFFSET))(this);
		}
