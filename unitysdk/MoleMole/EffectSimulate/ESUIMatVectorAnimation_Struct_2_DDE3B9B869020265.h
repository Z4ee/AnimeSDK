...
{
	inline static constexpr unsigned int ESUIMatVectorAnimation_Struct_2_DDE3B9B869020265_TypeDefinitionIndex = 46917;

	struct alignas(8) ESUIMatVectorAnimation_Struct_2_DDE3B9B869020265
	{
		::System::String* Field_2_0; // 0x10
		::MoleMole::EffectSimulate::Vector4Curve* Field_2_3; // 0x18
