...
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSMOTIONBLUR_METHOD_5_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0xE9882C0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSMOTIONBLUR_METHOD_5_2561DC986DD32699_OFFSET UNITYSDK_OFFSET(0x182A6D90)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSMOTIONBLUR_METHOD_5_25CD86BF8626C8D9_OFFSET UNITYSDK_OFFSET(0xE988DF0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSMOTIONBLUR_METHOD_5_522F2897D3370F6B_OFFSET UNITYSDK_OFFSET(0xE989020)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSMOTIONBLUR_METHOD_5_80313B77C31AD02B_OFFSET UNITYSDK_OFFSET(0xE9886E0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSMOTIONBLUR_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0xE9884B0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSMOTIONBLUR_METHOD_5_D7852DE078ACC1F1_OFFSET UNITYSDK_OFFSET(0xE9884C0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSMOTIONBLUR_METHOD_5_EE2957687AFE92A5_1_OFFSET UNITYSDK_OFFSET(0x182A7C50)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSMOTIONBLUR_METHOD_5_EE2957687AFE92A5_OFFSET UNITYSDK_OFFSET(0x182A7690)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSMOTIONBLUR__CTOR_OFFSET UNITYSDK_OFFSET(0x182A8210)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESPostProcessMotionBlur_TypeDefinitionIndex = 55051;
