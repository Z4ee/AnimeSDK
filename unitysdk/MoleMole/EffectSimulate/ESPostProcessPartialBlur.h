...
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSPARTIALBLUR_METHOD_5_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0x192C5B60)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSPARTIALBLUR_METHOD_5_0FD0EC313FAAB75A_OFFSET UNITYSDK_OFFSET(0x192C5DB0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSPARTIALBLUR_METHOD_5_25CD86BF8626C8D9_OFFSET UNITYSDK_OFFSET(0x192C67E0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSPARTIALBLUR_METHOD_5_2A99139D13C42A50_OFFSET UNITYSDK_OFFSET(0x192C6B80)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSPARTIALBLUR_METHOD_5_63E3E26A3D57F57D_1_OFFSET UNITYSDK_OFFSET(0x192C8EE0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSPARTIALBLUR_METHOD_5_63E3E26A3D57F57D_2_OFFSET UNITYSDK_OFFSET(0x192C98E0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSPARTIALBLUR_METHOD_5_63E3E26A3D57F57D_OFFSET UNITYSDK_OFFSET(0x192C8410)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSPARTIALBLUR_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x192C5DA0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSPARTIALBLUR_METHOD_5_D68547FF19A170E2_OFFSET UNITYSDK_OFFSET(0x192C5FA0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSPARTIALBLUR__CTOR_OFFSET UNITYSDK_OFFSET(0x192CA2E0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESPostProcessPartialBlur_TypeDefinitionIndex = 61588;
