...
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSNAPCAPSULEAOLIGHTING_METHOD_5_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0x170D8BF0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSNAPCAPSULEAOLIGHTING_METHOD_5_0FD0EC313FAAB75A_OFFSET UNITYSDK_OFFSET(0x170D8E40)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSNAPCAPSULEAOLIGHTING_METHOD_5_2561DC986DD32699_OFFSET UNITYSDK_OFFSET(0x170D9AA0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSNAPCAPSULEAOLIGHTING_METHOD_5_25CD86BF8626C8D9_OFFSET UNITYSDK_OFFSET(0x170D9710)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSNAPCAPSULEAOLIGHTING_METHOD_5_2A99139D13C42A50_1_OFFSET UNITYSDK_OFFSET(0x170DC1F0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSNAPCAPSULEAOLIGHTING_METHOD_5_2A99139D13C42A50_OFFSET UNITYSDK_OFFSET(0x170DB980)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSNAPCAPSULEAOLIGHTING_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x170D8E30)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSNAPCAPSULEAOLIGHTING_METHOD_5_9D8EF9AD3B13BD0E_OFFSET UNITYSDK_OFFSET(0x170DB010)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSNAPCAPSULEAOLIGHTING_METHOD_5_D35B60AE823B8CC1_OFFSET UNITYSDK_OFFSET(0x170D9040)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSNAPCAPSULEAOLIGHTING__CTOR_OFFSET UNITYSDK_OFFSET(0x170DCA60)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESPostProcessNapCapsuleAOLighting_TypeDefinitionIndex = 64467;
