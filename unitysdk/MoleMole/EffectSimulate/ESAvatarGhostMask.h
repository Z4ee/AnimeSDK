...
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARGHOSTMASK_METHOD_4_128774387667156B_1_OFFSET UNITYSDK_OFFSET(0x161B3220)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARGHOSTMASK_METHOD_4_128774387667156B_OFFSET UNITYSDK_OFFSET(0x161B2FA0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARGHOSTMASK_METHOD_4_5C90471BE03E101A_OFFSET UNITYSDK_OFFSET(0x161B3020)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARGHOSTMASK_METHOD_4_6F54E34F52AB60F6_OFFSET UNITYSDK_OFFSET(0x161B2D00)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARGHOSTMASK_METHOD_4_83A2D2FF4410F4BE_OFFSET UNITYSDK_OFFSET(0x161B2ED0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARGHOSTMASK_METHOD_4_A3CF806971F50D26_OFFSET UNITYSDK_OFFSET(0x161B2FE0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARGHOSTMASK_METHOD_4_CF05E675E2E94F01_OFFSET UNITYSDK_OFFSET(0x161B3050)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARGHOSTMASK_METHOD_4_EB15466536C39910_OFFSET UNITYSDK_OFFSET(0x161B3140)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARGHOSTMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x161B3060)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESAvatarGhostMask_TypeDefinitionIndex = 59587;
	...
	public:
		...
		{
			return ((::System::Type*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_ESAVATARGHOSTMASK_METHOD_4_5C90471BE03E101A_OFFSET))(this);
		}
