...
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSSCREENSPACEAMBIENTOCCLUSION_METHOD_5_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0x1A09E9E0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSSCREENSPACEAMBIENTOCCLUSION_METHOD_5_22A1090553AAABBF_OFFSET UNITYSDK_OFFSET(0x1A09F190)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSSCREENSPACEAMBIENTOCCLUSION_METHOD_5_25CD86BF8626C8D9_OFFSET UNITYSDK_OFFSET(0x1A0A0840)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSSCREENSPACEAMBIENTOCCLUSION_METHOD_5_33AEB8F024CE4DC0_1_OFFSET UNITYSDK_OFFSET(0x1A0A9570)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSSCREENSPACEAMBIENTOCCLUSION_METHOD_5_33AEB8F024CE4DC0_OFFSET UNITYSDK_OFFSET(0x1A0A7BC0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSSCREENSPACEAMBIENTOCCLUSION_METHOD_5_497833CF065C1894_OFFSET UNITYSDK_OFFSET(0x1A09EE00)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSSCREENSPACEAMBIENTOCCLUSION_METHOD_5_522F2897D3370F6B_OFFSET UNITYSDK_OFFSET(0x1A0A12D0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSSCREENSPACEAMBIENTOCCLUSION_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x1A09EDF0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSSCREENSPACEAMBIENTOCCLUSION_METHOD_5_C8CC3F1CE7238E46_OFFSET UNITYSDK_OFFSET(0x1A0A5F60)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSSCREENSPACEAMBIENTOCCLUSION__CTOR_OFFSET UNITYSDK_OFFSET(0x12FEE530)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESPostProcessScreenSpaceAmbientOcclusion_TypeDefinitionIndex = 86581;
