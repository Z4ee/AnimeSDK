...
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0x18B0F1D0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_25CD86BF8626C8D9_OFFSET UNITYSDK_OFFSET(0x18B0FE70)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_522F2897D3370F6B_OFFSET UNITYSDK_OFFSET(0x18B102C0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_58D68FEBA7B5A778_1_OFFSET UNITYSDK_OFFSET(0x18B13070)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_58D68FEBA7B5A778_OFFSET UNITYSDK_OFFSET(0x18B125E0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_80313B77C31AD02B_OFFSET UNITYSDK_OFFSET(0x18B0F690)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x18B0F440)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_87DA5EB0C040E3E5_OFFSET UNITYSDK_OFFSET(0x18B11AC0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_D7852DE078ACC1F1_OFFSET UNITYSDK_OFFSET(0x18B0F450)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18B13B00)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESPostProcessLensDistortion_TypeDefinitionIndex = 53603;
