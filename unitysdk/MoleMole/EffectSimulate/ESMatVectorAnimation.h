...
#define MOLEMOLE_EFFECTSIMULATE_ESMATVECTORANIMATION_GET_WKEYFRAME_OFFSET UNITYSDK_OFFSET(0x17E57200)
#define MOLEMOLE_EFFECTSIMULATE_ESMATVECTORANIMATION_GET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x17E56F60)
#define MOLEMOLE_EFFECTSIMULATE_ESMATVECTORANIMATION_GET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0x17E57040)
#define MOLEMOLE_EFFECTSIMULATE_ESMATVECTORANIMATION_GET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0x17E57120)
#define MOLEMOLE_EFFECTSIMULATE_ESMATVECTORANIMATION_METHOD_5_1367934296657450_OFFSET UNITYSDK_OFFSET(0x17E56D60)
#define MOLEMOLE_EFFECTSIMULATE_ESMATVECTORANIMATION_METHOD_5_213C38CA5FA1A7E9_OFFSET UNITYSDK_OFFSET(0x17E56E80)
#define MOLEMOLE_EFFECTSIMULATE_ESMATVECTORANIMATION_METHOD_5_3306C8E1BEF2340E_OFFSET UNITYSDK_OFFSET(0x17E56D70)
#define MOLEMOLE_EFFECTSIMULATE_ESMATVECTORANIMATION_METHOD_5_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x17E57390)
#define MOLEMOLE_EFFECTSIMULATE_ESMATVECTORANIMATION_METHOD_5_54E8DBCCA773657A_OFFSET UNITYSDK_OFFSET(0x17E565E0)
#define MOLEMOLE_EFFECTSIMULATE_ESMATVECTORANIMATION_METHOD_5_5B1C7E235BC8BD41_OFFSET UNITYSDK_OFFSET(0x17E56E00)
#define MOLEMOLE_EFFECTSIMULATE_ESMATVECTORANIMATION_METHOD_5_85BE9D03D509479D_OFFSET UNITYSDK_OFFSET(0x17E56660)
#define MOLEMOLE_EFFECTSIMULATE_ESMATVECTORANIMATION_METHOD_5_A1025C3B0B9B691C_OFFSET UNITYSDK_OFFSET(0x17E56850)
#define MOLEMOLE_EFFECTSIMULATE_ESMATVECTORANIMATION_METHOD_5_C446CE6A5E1982BC_OFFSET UNITYSDK_OFFSET(0x17E56F20)
#define MOLEMOLE_EFFECTSIMULATE_ESMATVECTORANIMATION_SET_WKEYFRAME_OFFSET UNITYSDK_OFFSET(0x17E57250)
#define MOLEMOLE_EFFECTSIMULATE_ESMATVECTORANIMATION_SET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x17E56FB0)
#define MOLEMOLE_EFFECTSIMULATE_ESMATVECTORANIMATION_SET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0x17E57090)
#define MOLEMOLE_EFFECTSIMULATE_ESMATVECTORANIMATION_SET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0x17E57170)
#define MOLEMOLE_EFFECTSIMULATE_ESMATVECTORANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x17E572E0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESMatVectorAnimation_TypeDefinitionIndex = 71404;
