...
#define MOLEMOLE_EFFECTSIMULATE_COLORCURVE_METHOD_4_0A66118846A84639_OFFSET UNITYSDK_OFFSET(0x11CC3710)
#define MOLEMOLE_EFFECTSIMULATE_COLORCURVE_METHOD_4_155C191EC0431EA4_OFFSET UNITYSDK_OFFSET(0x11CC3420)
#define MOLEMOLE_EFFECTSIMULATE_COLORCURVE_METHOD_4_30C47F9E0D18E066_OFFSET UNITYSDK_OFFSET(0x11CC3980)
#define MOLEMOLE_EFFECTSIMULATE_COLORCURVE_METHOD_4_5D0FD43AB821A5B3_OFFSET UNITYSDK_OFFSET(0x11CC35F0)
#define MOLEMOLE_EFFECTSIMULATE_COLORCURVE_METHOD_4_72B99BAD012F62D7_OFFSET UNITYSDK_OFFSET(0x11CC3330)
#define MOLEMOLE_EFFECTSIMULATE_COLORCURVE_METHOD_4_ADF4AD3331B4D7AD_1_OFFSET UNITYSDK_OFFSET(0x11CC35A0)
#define MOLEMOLE_EFFECTSIMULATE_COLORCURVE_METHOD_4_ADF4AD3331B4D7AD_OFFSET UNITYSDK_OFFSET(0x11CC3550)
#define MOLEMOLE_EFFECTSIMULATE_COLORCURVE_METHOD_4_DB7D026E80324413_OFFSET UNITYSDK_OFFSET(0x11CC3680)
#define MOLEMOLE_EFFECTSIMULATE_COLORCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x11CC34F0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ColorCurve_TypeDefinitionIndex = 63337;
