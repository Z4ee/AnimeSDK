...
#define MOLEMOLE_EFFECTSIMULATE_ESLINELIGHTINGV2_GET_WRAPPERCOMSHOWER_OFFSET UNITYSDK_OFFSET(0x1A4D5100)
#define MOLEMOLE_EFFECTSIMULATE_ESLINELIGHTINGV2_METHOD_3_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x1A4D52B0)
#define MOLEMOLE_EFFECTSIMULATE_ESLINELIGHTINGV2_METHOD_3_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x1A4D5370)
#define MOLEMOLE_EFFECTSIMULATE_ESLINELIGHTINGV2_METHOD_3_41A65CD6A0F4418F_OFFSET UNITYSDK_OFFSET(0x1A4D48B0)
#define MOLEMOLE_EFFECTSIMULATE_ESLINELIGHTINGV2_METHOD_3_4272BE5198E6F216_OFFSET UNITYSDK_OFFSET(0x1A4D52A0)
#define MOLEMOLE_EFFECTSIMULATE_ESLINELIGHTINGV2_METHOD_3_7B12DCDC7C0C0CFC_OFFSET UNITYSDK_OFFSET(0x1A4D4B60)
#define MOLEMOLE_EFFECTSIMULATE_ESLINELIGHTINGV2_METHOD_3_E1FD4DD6CA52AE1F_OFFSET UNITYSDK_OFFSET(0x1A4D4300)
#define MOLEMOLE_EFFECTSIMULATE_ESLINELIGHTINGV2_SET_WRAPPERCOMSHOWER_OFFSET UNITYSDK_OFFSET(0x1A4D51A0)
#define MOLEMOLE_EFFECTSIMULATE_ESLINELIGHTINGV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4D51B0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESLineLightingV2_TypeDefinitionIndex = 82197;
