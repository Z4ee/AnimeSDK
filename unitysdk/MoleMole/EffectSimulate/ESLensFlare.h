...
#define MOLEMOLE_EFFECTSIMULATE_ESLENSFLARE_GET_LENSFLAREDATASHOWER_OFFSET UNITYSDK_OFFSET(0x1A0145C0)
#define MOLEMOLE_EFFECTSIMULATE_ESLENSFLARE_METHOD_3_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x1A014940)
#define MOLEMOLE_EFFECTSIMULATE_ESLENSFLARE_METHOD_3_2898E3EC91BCF259_OFFSET UNITYSDK_OFFSET(0x1A0143F0)
#define MOLEMOLE_EFFECTSIMULATE_ESLENSFLARE_METHOD_3_4272BE5198E6F216_OFFSET UNITYSDK_OFFSET(0x1A014930)
#define MOLEMOLE_EFFECTSIMULATE_ESLENSFLARE_METHOD_3_AFA9D88E62D257E4_OFFSET UNITYSDK_OFFSET(0x1A014020)
#define MOLEMOLE_EFFECTSIMULATE_ESLENSFLARE_SET_LENSFLAREDATASHOWER_OFFSET UNITYSDK_OFFSET(0x1A014620)
#define MOLEMOLE_EFFECTSIMULATE_ESLENSFLARE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0147A0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESLensFlare_TypeDefinitionIndex = 43197;
