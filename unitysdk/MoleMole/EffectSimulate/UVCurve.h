...
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_1DE6433C25680F9D_OFFSET UNITYSDK_OFFSET(0x1B520760)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_358636A0F7882E47_1_OFFSET UNITYSDK_OFFSET(0x1B520B80)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_358636A0F7882E47_OFFSET UNITYSDK_OFFSET(0x1B520AF0)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_6DEA78A5E1683024_OFFSET UNITYSDK_OFFSET(0x1B520070)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_6FD64B3DB3CCB573_OFFSET UNITYSDK_OFFSET(0x1B51F7C0)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_828ACC8ED623D850_OFFSET UNITYSDK_OFFSET(0x1B51F3F0)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x1B520A60)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_A0F1D07FA5BAF2AE_OFFSET UNITYSDK_OFFSET(0x1B51F8F0)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_B56234B03748E3AC_OFFSET UNITYSDK_OFFSET(0x1B51FFE0)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x1B520A20)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x1B520A70)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0x1B520AB0)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1B5209E0)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_CEE72EAC18ECC163_OFFSET UNITYSDK_OFFSET(0x1B51FF50)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_FFDB41E6BD9C64A5_OFFSET UNITYSDK_OFFSET(0x1B51F9C0)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B51F310)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int UVCurve_TypeDefinitionIndex = 61992;
	...
	public:
		...
		::UnityEngine::Vector4 Method_4_828ACC8ED623D850(::System::Single a1, ::UnityEngine::Vector4 a2)
		{
			return ((::UnityEngine::Vector4(*)(::PVOID, ::System::Single, ::UnityEngine::Vector4))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_828ACC8ED623D850_OFFSET))(this, a1, a2);
		}
		...
		::System::Void Method_4_6DEA78A5E1683024(::System::Int32 a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_6DEA78A5E1683024_OFFSET))(this, a1);
		}
