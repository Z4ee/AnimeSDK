...
#define MOLEMOLE_EFFECTSIMULATE_EFFECTMESHRENDERERCAMERAFACINGCOMPONENT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x19DA52D0)
#define MOLEMOLE_EFFECTSIMULATE_EFFECTMESHRENDERERCAMERAFACINGCOMPONENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19DA5170)
#define MOLEMOLE_EFFECTSIMULATE_EFFECTMESHRENDERERCAMERAFACINGCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19DA5B50)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int EffectMeshRendererCameraFacingComponent_TypeDefinitionIndex = 46802;
