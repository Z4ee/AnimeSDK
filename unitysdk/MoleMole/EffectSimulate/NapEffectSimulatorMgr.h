...
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_ADDCHILDRENVISIBLESTATE_OFFSET UNITYSDK_OFFSET(0x153EE530)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_AWAKE_OFFSET UNITYSDK_OFFSET(0x153EEF30)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_CLEAR_OFFSET UNITYSDK_OFFSET(0x153F3A40)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_DURATIONISINF_OFFSET UNITYSDK_OFFSET(0x153F23C0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GETALLCHILDRENCOM_OFFSET UNITYSDK_OFFSET(0x153F40D0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GETDTCACHE_OFFSET UNITYSDK_OFFSET(0x153EC320)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GETESCOMBYGO_OFFSET UNITYSDK_OFFSET(0x153F1A80)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GETFADEOUTVAL_OFFSET UNITYSDK_OFFSET(0x153F1880)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GETINITPHASEACTIVESTATE_OFFSET UNITYSDK_OFFSET(0x153F3C80)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GETISFORCELIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x153EF050)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GETISSUPPORTLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x153EF010)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GETMRBYGO_OFFSET UNITYSDK_OFFSET(0x153F4220)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GETNOWTIMEAT_OFFSET UNITYSDK_OFFSET(0x153F3BD0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GETOTHERRENDERERBYGO_OFFSET UNITYSDK_OFFSET(0x153F42A0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GETPSBYGO_OFFSET UNITYSDK_OFFSET(0x153F4120)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GETPSRBYGO_OFFSET UNITYSDK_OFFSET(0x153F41A0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GET_ARRCOMS_OFFSET UNITYSDK_OFFSET(0x153EEF00)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GET_ARRPS_OFFSET UNITYSDK_OFFSET(0x153EEF10)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GET_ISRUNTIMEUPDATEREADY_OFFSET UNITYSDK_OFFSET(0x153F4E50)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GET_MAPGO2ESCOM_OFFSET UNITYSDK_OFFSET(0x153EEF20)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GET_PLAYMODE_OFFSET UNITYSDK_OFFSET(0x153F3C20)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_HANDLESIMULATORMGRFADEVALUE_OFFSET UNITYSDK_OFFSET(0x153F15D0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_INIT_OFFSET UNITYSDK_OFFSET(0x153F2E20)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x153F2240)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_ISININIT_OFFSET UNITYSDK_OFFSET(0x153F3C30)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_MAPEFFECTLODTYPE_OFFSET UNITYSDK_OFFSET(0x153ED1C0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_0B1EB5C9B94BAB66_1_OFFSET UNITYSDK_OFFSET(0x153F62C0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_0B1EB5C9B94BAB66_OFFSET UNITYSDK_OFFSET(0x153EC0E0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_0CC4BC19C602BCD0_OFFSET UNITYSDK_OFFSET(0x153F6000)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_0DF420E95D6252BE_OFFSET UNITYSDK_OFFSET(0x153F6760)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_0E142E3463F30350_OFFSET UNITYSDK_OFFSET(0x153EE400)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_1808E1CF7A125519_1_OFFSET UNITYSDK_OFFSET(0x153F6210)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x153F6110)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x153F5850)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_24ACE8D2378D26B0_OFFSET UNITYSDK_OFFSET(0x153F54D0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_32B2368221A04800_OFFSET UNITYSDK_OFFSET(0x153F0FC0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0x153F5E80)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x153F5650)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_3E7CB6C2B0DD1E2A_OFFSET UNITYSDK_OFFSET(0x153EC650)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_464B80C09A37526F_OFFSET UNITYSDK_OFFSET(0x153EE060)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_4C1C6BDA70EF0410_OFFSET UNITYSDK_OFFSET(0x153F35B0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0x153EC430)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_5323F2DF46A044DA_OFFSET UNITYSDK_OFFSET(0x153F6920)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_741837A0FB99F394_OFFSET UNITYSDK_OFFSET(0x153F58B0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_7AEA4B2B25797605_OFFSET UNITYSDK_OFFSET(0x153F5690)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x153F55B0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_9B6BAF49879647BD_OFFSET UNITYSDK_OFFSET(0x153EE8E0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_9D0688AE2E08E349_OFFSET UNITYSDK_OFFSET(0x153F6070)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0x153EE840)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0x153ED0A0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_ACD535D83ECB43B9_OFFSET UNITYSDK_OFFSET(0x153F65D0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_AD23FDCC7576BB32_OFFSET UNITYSDK_OFFSET(0x153EC1F0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_C1D3BDE2A17F5C9D_OFFSET UNITYSDK_OFFSET(0x153F5550)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_C5E0FC6E1C3C1128_OFFSET UNITYSDK_OFFSET(0x153ED650)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x153F61A0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_D829460A9C07E886_1_OFFSET UNITYSDK_OFFSET(0x153F5970)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_D829460A9C07E886_OFFSET UNITYSDK_OFFSET(0x153F4FC0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_E7F1AECA7CFF8AAD_OFFSET UNITYSDK_OFFSET(0x153F6060)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_E907F5C75FFBA4EA_OFFSET UNITYSDK_OFFSET(0x153F5EC0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_ED754E022B2B63CC_OFFSET UNITYSDK_OFFSET(0x153EFB90)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0x153F2640)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_FB4BE762B6186C23_OFFSET UNITYSDK_OFFSET(0x153F61E0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_FB870C37E702D8C7_OFFSET UNITYSDK_OFFSET(0x153F6420)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_FF5188F77C143723_OFFSET UNITYSDK_OFFSET(0x153EDF30)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x153F4320)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x153F4D10)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x153F4BB0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x153EC590)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x153EC370)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x153F4DE0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_REMOVECHILDRENVISIBLESTATE_OFFSET UNITYSDK_OFFSET(0x153EEC10)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_RUNTIMEDOFADEOUTTHREADSAFE_OFFSET UNITYSDK_OFFSET(0x153F10A0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_RUNTIMEDOFADEOUT_OFFSET UNITYSDK_OFFSET(0x153F0E10)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_RUNTIMEDOINACTIVE_OFFSET UNITYSDK_OFFSET(0x153F1390)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_RUNTIMEGLOBALSPEED_OFFSET UNITYSDK_OFFSET(0x153F1580)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_RUNTIMEINIT_OFFSET UNITYSDK_OFFSET(0x153EF090)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_RUNTIMEINIT_POOLOPT_OFFSET UNITYSDK_OFFSET(0x153EC780)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_RUNTIMERELEASE_OFFSET UNITYSDK_OFFSET(0x153F0450)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_RUNTIMESIMULATE_JOB_OTHER_OFFSET UNITYSDK_OFFSET(0x153EC2E0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_RUNTIMESIMULATE_JOB_PREPARE_OFFSET UNITYSDK_OFFSET(0x153EBE20)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_RUNTIMESIMULATE_OFFSET UNITYSDK_OFFSET(0x153F0800)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_RUNTIMESIMULATE_RECORD_OFFSET UNITYSDK_OFFSET(0x153EBDB0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_SETINITPHASEACTIVESTATE_OFFSET UNITYSDK_OFFSET(0x153F3EB0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_SETPHASETIMEDURATION_OFFSET UNITYSDK_OFFSET(0x153F3740)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_SETPHASETIMERATE_OFFSET UNITYSDK_OFFSET(0x153F01F0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_SETTIMEAT_OFFSET UNITYSDK_OFFSET(0x153F27D0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_SET_ISRUNTIMEUPDATEREADY_OFFSET UNITYSDK_OFFSET(0x153F4E60)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_SIMULATE_OFFSET UNITYSDK_OFFSET(0x153F1B00)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_START_OFFSET UNITYSDK_OFFSET(0x153F4D50)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_STOPSELF_OFFSET UNITYSDK_OFFSET(0x153F1210)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_STOP_OFFSET UNITYSDK_OFFSET(0x153F2490)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR__CCTOR_OFFSET UNITYSDK_OFFSET(0x153F4F10)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR__CTOR_OFFSET UNITYSDK_OFFSET(0x153F4E70)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int NapEffectSimulatorMgr_TypeDefinitionIndex = 70986;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::UnityEngine::GameObject*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(NapEffectSimulatorMgr_TypeDefinitionIndex)->GetStaticField(0x34AA0);
		}
		static ::System::Boolean* StaticGet_USE_VISIBLE_OPT()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(NapEffectSimulatorMgr_TypeDefinitionIndex)->GetStaticField(0xCEE0);
		}
		static ::System::Single* StaticGet_DEFAULT_RENDERER_CULLING_DIS()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(NapEffectSimulatorMgr_TypeDefinitionIndex)->GetStaticField(0xCEE4);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_C1D3BDE2A17F5C9D_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_0CC4BC19C602BCD0_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_51CFFE2AF748ECD7_OFFSET))(this);
		}
		...
		::System::Void Method_5_3E7CB6C2B0DD1E2A()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_3E7CB6C2B0DD1E2A_OFFSET))(this);
		}
