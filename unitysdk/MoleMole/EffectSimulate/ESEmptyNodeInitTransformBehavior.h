...
#define MOLEMOLE_EFFECTSIMULATE_ESEMPTYNODEINITTRANSFORMBEHAVIOR_GET_RANDOMVAL_OFFSET UNITYSDK_OFFSET(0xE9881A0)
#define MOLEMOLE_EFFECTSIMULATE_ESEMPTYNODEINITTRANSFORMBEHAVIOR_METHOD_3_FA662896843C137A_OFFSET UNITYSDK_OFFSET(0xE9881F0)
#define MOLEMOLE_EFFECTSIMULATE_ESEMPTYNODEINITTRANSFORMBEHAVIOR_SET_RANDOMVAL_OFFSET UNITYSDK_OFFSET(0xE9881C0)
#define MOLEMOLE_EFFECTSIMULATE_ESEMPTYNODEINITTRANSFORMBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xE9881D0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESEmptyNodeInitTransformBehavior_TypeDefinitionIndex = 72564;
