...
#define MOLEMOLE_EFFECTSIMULATE_ESEMPTYNODEINITTRANSFORMBEHAVIOR_GET_RANDOMVAL_OFFSET UNITYSDK_OFFSET(0x19ADBF20)
#define MOLEMOLE_EFFECTSIMULATE_ESEMPTYNODEINITTRANSFORMBEHAVIOR_METHOD_3_FA662896843C137A_OFFSET UNITYSDK_OFFSET(0x19ADBF70)
#define MOLEMOLE_EFFECTSIMULATE_ESEMPTYNODEINITTRANSFORMBEHAVIOR_SET_RANDOMVAL_OFFSET UNITYSDK_OFFSET(0x19ADBF40)
#define MOLEMOLE_EFFECTSIMULATE_ESEMPTYNODEINITTRANSFORMBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19ADBF50)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESEmptyNodeInitTransformBehavior_TypeDefinitionIndex = 52022;
