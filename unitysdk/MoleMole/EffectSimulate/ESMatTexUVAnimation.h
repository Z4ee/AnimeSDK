...
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_GET_WKEYFRAME_OFFSET UNITYSDK_OFFSET(0x181FCED0)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_GET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x181FCC30)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_GET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0x181FCD10)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_GET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0x181FCDF0)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_141D753555787675_OFFSET UNITYSDK_OFFSET(0x181FC9B0)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_213C38CA5FA1A7E9_OFFSET UNITYSDK_OFFSET(0x181FC200)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_358636A0F7882E47_OFFSET UNITYSDK_OFFSET(0x181FC360)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0x181FD110)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_391A84BCD9F51317_2_OFFSET UNITYSDK_OFFSET(0x181FD1A0)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x181FC450)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_3BA5D8A9922E37AE_OFFSET UNITYSDK_OFFSET(0x181FC490)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_54E8DBCCA773657A_OFFSET UNITYSDK_OFFSET(0x181FBED0)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_5B1C7E235BC8BD41_OFFSET UNITYSDK_OFFSET(0x181FC180)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_7857B385C2B6C0EB_OFFSET UNITYSDK_OFFSET(0x181FD100)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_85BE9D03D509479D_OFFSET UNITYSDK_OFFSET(0x181FBF50)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_867E858DEBE0B46F_OFFSET UNITYSDK_OFFSET(0x181FC9A0)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x181FC3E0)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0x181FD230)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_C446CE6A5E1982BC_OFFSET UNITYSDK_OFFSET(0x181FC140)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x181FD160)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x181FC2A0)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x181FD070)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_E21AC6EE08DC160A_OFFSET UNITYSDK_OFFSET(0x181FCA40)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_SET_WKEYFRAME_OFFSET UNITYSDK_OFFSET(0x181FCF20)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_SET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x181FCC80)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_SET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0x181FCD60)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_SET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0x181FCE40)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x181FCFB0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESMatTexUVAnimation_TypeDefinitionIndex = 55129;
	...
	public:
		...
		{
			return ((::System::String*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_358636A0F7882E47_OFFSET))(this);
		}
		...
		{
			return ((::System::String*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_7857B385C2B6C0EB_OFFSET))(this);
		}
