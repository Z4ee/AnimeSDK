...
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_GET_WKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1B828720)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_GET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1B828480)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_GET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1B828560)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_GET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1B828640)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_141D753555787675_OFFSET UNITYSDK_OFFSET(0x1B8283F0)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_213C38CA5FA1A7E9_OFFSET UNITYSDK_OFFSET(0x1B827D70)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x1B8288B0)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_3BA5D8A9922E37AE_OFFSET UNITYSDK_OFFSET(0x1B827ED0)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_54E8DBCCA773657A_OFFSET UNITYSDK_OFFSET(0x1B827A40)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_5B1C7E235BC8BD41_OFFSET UNITYSDK_OFFSET(0x1B827CF0)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_85BE9D03D509479D_OFFSET UNITYSDK_OFFSET(0x1B827AC0)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_867E858DEBE0B46F_OFFSET UNITYSDK_OFFSET(0x1B8283E0)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0x1B828900)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_C446CE6A5E1982BC_OFFSET UNITYSDK_OFFSET(0x1B827CB0)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_METHOD_5_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x1B827E10)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_SET_WKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1B828770)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_SET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1B8284D0)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_SET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1B8285B0)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION_SET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1B828690)
#define MOLEMOLE_EFFECTSIMULATE_ESMATTEXUVANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B828800)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESMatTexUVAnimation_TypeDefinitionIndex = 78894;
