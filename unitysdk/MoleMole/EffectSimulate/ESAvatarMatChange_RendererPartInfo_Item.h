...
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARMATCHANGE_RENDERERPARTINFO_ITEM_METHOD_1_C433AF37CE9D6E5B_OFFSET UNITYSDK_OFFSET(0x1A378B80)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARMATCHANGE_RENDERERPARTINFO_ITEM_METHOD_1_D890CE7609917E81_OFFSET UNITYSDK_OFFSET(0x1A378AD0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARMATCHANGE_RENDERERPARTINFO_ITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A378A60)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESAvatarMatChange_RendererPartInfo_Item_TypeDefinitionIndex = 40406;
