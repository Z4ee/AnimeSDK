...
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARMATCHANGE_RENDERERPARTINFO_ITEM_METHOD_1_C433AF37CE9D6E5B_OFFSET UNITYSDK_OFFSET(0x1B57F030)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARMATCHANGE_RENDERERPARTINFO_ITEM_METHOD_1_D890CE7609917E81_OFFSET UNITYSDK_OFFSET(0x1B57EF80)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARMATCHANGE_RENDERERPARTINFO_ITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B57EF10)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESAvatarMatChange_RendererPartInfo_Item_TypeDefinitionIndex = 48683;
