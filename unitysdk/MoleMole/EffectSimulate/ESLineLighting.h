...
#define MOLEMOLE_EFFECTSIMULATE_ESLINELIGHTING_GET_WRAPPERCOMSHOWER_OFFSET UNITYSDK_OFFSET(0x170D86F0)
#define MOLEMOLE_EFFECTSIMULATE_ESLINELIGHTING_METHOD_3_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x170D8890)
#define MOLEMOLE_EFFECTSIMULATE_ESLINELIGHTING_METHOD_3_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x170D8950)
#define MOLEMOLE_EFFECTSIMULATE_ESLINELIGHTING_METHOD_3_41A65CD6A0F4418F_OFFSET UNITYSDK_OFFSET(0x170D7EA0)
#define MOLEMOLE_EFFECTSIMULATE_ESLINELIGHTING_METHOD_3_4272BE5198E6F216_OFFSET UNITYSDK_OFFSET(0x170D89E0)
#define MOLEMOLE_EFFECTSIMULATE_ESLINELIGHTING_METHOD_3_7B12DCDC7C0C0CFC_OFFSET UNITYSDK_OFFSET(0x170D8150)
#define MOLEMOLE_EFFECTSIMULATE_ESLINELIGHTING_METHOD_3_E1FD4DD6CA52AE1F_OFFSET UNITYSDK_OFFSET(0x170D78F0)
#define MOLEMOLE_EFFECTSIMULATE_ESLINELIGHTING_SET_WRAPPERCOMSHOWER_OFFSET UNITYSDK_OFFSET(0x170D8790)
#define MOLEMOLE_EFFECTSIMULATE_ESLINELIGHTING__CTOR_OFFSET UNITYSDK_OFFSET(0x170D87A0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESLineLighting_TypeDefinitionIndex = 51617;
