...
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARTRANSITION_METHOD_4_128774387667156B_1_OFFSET UNITYSDK_OFFSET(0x1A083530)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARTRANSITION_METHOD_4_128774387667156B_2_OFFSET UNITYSDK_OFFSET(0x1A083760)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARTRANSITION_METHOD_4_128774387667156B_3_OFFSET UNITYSDK_OFFSET(0x1A0837A0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARTRANSITION_METHOD_4_128774387667156B_4_OFFSET UNITYSDK_OFFSET(0x1A083820)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARTRANSITION_METHOD_4_128774387667156B_5_OFFSET UNITYSDK_OFFSET(0x1A083860)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARTRANSITION_METHOD_4_128774387667156B_6_OFFSET UNITYSDK_OFFSET(0x1A0838A0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARTRANSITION_METHOD_4_128774387667156B_OFFSET UNITYSDK_OFFSET(0x1A083210)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARTRANSITION_METHOD_4_5C90471BE03E101A_OFFSET UNITYSDK_OFFSET(0x1A083290)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARTRANSITION_METHOD_4_65F7F584FDCE6774_OFFSET UNITYSDK_OFFSET(0x1A083250)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARTRANSITION_METHOD_4_6F54E34F52AB60F6_OFFSET UNITYSDK_OFFSET(0x1A082EA0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARTRANSITION_METHOD_4_9B92C44D5842AA8A_OFFSET UNITYSDK_OFFSET(0x1A0837E0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARTRANSITION_METHOD_4_BB26D4750A632557_OFFSET UNITYSDK_OFFSET(0x1A083570)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARTRANSITION_METHOD_4_CF05E675E2E94F01_OFFSET UNITYSDK_OFFSET(0x1A0832C0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARTRANSITION_METHOD_4_E907F5C75FFBA4EA_OFFSET UNITYSDK_OFFSET(0x1A083070)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARTRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0832D0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESAvatarTransition_TypeDefinitionIndex = 77751;
	...
	public:
		...
		{
			return ((::System::Type*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_ESAVATARTRANSITION_METHOD_4_5C90471BE03E101A_OFFSET))(this);
		}
