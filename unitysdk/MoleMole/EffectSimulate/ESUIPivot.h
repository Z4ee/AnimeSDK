...
#define MOLEMOLE_EFFECTSIMULATE_ESUIPIVOT_METHOD_4_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x16C97AC0)
#define MOLEMOLE_EFFECTSIMULATE_ESUIPIVOT_METHOD_4_49AA86D9F19FB057_OFFSET UNITYSDK_OFFSET(0x16C977B0)
#define MOLEMOLE_EFFECTSIMULATE_ESUIPIVOT_METHOD_4_990C94EC15D6CE86_OFFSET UNITYSDK_OFFSET(0x16C97B60)
#define MOLEMOLE_EFFECTSIMULATE_ESUIPIVOT_METHOD_4_B179D9338896C46D_OFFSET UNITYSDK_OFFSET(0x16C97510)
#define MOLEMOLE_EFFECTSIMULATE_ESUIPIVOT__CTOR_OFFSET UNITYSDK_OFFSET(0x16C97970)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESUIPivot_TypeDefinitionIndex = 69261;
