...
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSWHITEBALANCE_METHOD_5_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0x182AA350)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSWHITEBALANCE_METHOD_5_1C409C2CC83887DC_1_OFFSET UNITYSDK_OFFSET(0x182ABCA0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSWHITEBALANCE_METHOD_5_1C409C2CC83887DC_OFFSET UNITYSDK_OFFSET(0x182AB820)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSWHITEBALANCE_METHOD_5_46737F85CDB5E497_OFFSET UNITYSDK_OFFSET(0x182AAB40)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSWHITEBALANCE_METHOD_5_46DF29ACE60986D7_OFFSET UNITYSDK_OFFSET(0x182AA9C0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSWHITEBALANCE_METHOD_5_71170E420FCC0F61_OFFSET UNITYSDK_OFFSET(0x182AB340)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSWHITEBALANCE_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x182AA510)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSWHITEBALANCE_METHOD_5_8DF47EF45ABD2A6C_OFFSET UNITYSDK_OFFSET(0x182AA6A0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSWHITEBALANCE_METHOD_5_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x182AA520)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSWHITEBALANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x182AC120)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESPostProcessWhiteBalance_TypeDefinitionIndex = 80400;
