...
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMFOG_METHOD_4_1000D6400DA4668F_OFFSET UNITYSDK_OFFSET(0x18F82310)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMFOG_METHOD_4_128774387667156B_OFFSET UNITYSDK_OFFSET(0x18F82280)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMFOG_METHOD_4_AF36EBA0C8D1FBA2_OFFSET UNITYSDK_OFFSET(0x18F81D70)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMFOG_METHOD_4_C91E5170F9E36EED_OFFSET UNITYSDK_OFFSET(0x18F822C0)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMFOG_METHOD_4_E80F0CA54EBF1847_OFFSET UNITYSDK_OFFSET(0x18F82040)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMFOG__CTOR_OFFSET UNITYSDK_OFFSET(0x18F82320)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESShaderCustomFog_TypeDefinitionIndex = 46924;
