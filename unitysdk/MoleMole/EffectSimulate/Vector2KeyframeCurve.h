...
#define MOLEMOLE_EFFECTSIMULATE_VECTOR2KEYFRAMECURVE_GET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x15105910)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR2KEYFRAMECURVE_GET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0x151059A0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR2KEYFRAMECURVE_METHOD_5_04EDF435A0D753A9_OFFSET UNITYSDK_OFFSET(0x15105D70)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR2KEYFRAMECURVE_METHOD_5_2356514D84A0DDE4_OFFSET UNITYSDK_OFFSET(0x15105A30)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR2KEYFRAMECURVE_METHOD_5_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x15106470)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR2KEYFRAMECURVE_METHOD_5_459C79521BFE514E_OFFSET UNITYSDK_OFFSET(0x151061A0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR2KEYFRAMECURVE_METHOD_5_52DF83C4F40068CC_OFFSET UNITYSDK_OFFSET(0x15105B60)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR2KEYFRAMECURVE_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x15106460)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR2KEYFRAMECURVE_METHOD_5_8CAE1B3C917045D7_OFFSET UNITYSDK_OFFSET(0x15105F30)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR2KEYFRAMECURVE_METHOD_5_958E77D3D32E4233_OFFSET UNITYSDK_OFFSET(0x15105AA0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR2KEYFRAMECURVE_METHOD_5_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x151062F0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR2KEYFRAMECURVE_METHOD_5_9823BFA3CE8B5542_OFFSET UNITYSDK_OFFSET(0x15106080)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR2KEYFRAMECURVE_METHOD_5_C21A7AC6282FB0D0_OFFSET UNITYSDK_OFFSET(0x15105B10)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR2KEYFRAMECURVE_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x15106130)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR2KEYFRAMECURVE_METHOD_5_E49226E55BF3741F_OFFSET UNITYSDK_OFFSET(0x15105E70)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR2KEYFRAMECURVE_SET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x15105930)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR2KEYFRAMECURVE_SET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0x151059C0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR2KEYFRAMECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x150FC800)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int Vector2KeyframeCurve_TypeDefinitionIndex = 46829;
