...
#define MOLEMOLE_EFFECTSIMULATE_IEVALUATECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1426FF80)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int IEvaluateCurve_TypeDefinitionIndex = 61211;
