...
#define MOLEMOLE_EFFECTSIMULATE_FLOATCURVE_METHOD_4_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x153EB640)
#define MOLEMOLE_EFFECTSIMULATE_FLOATCURVE_METHOD_4_180D96D05146E077_OFFSET UNITYSDK_OFFSET(0x153EAF40)
#define MOLEMOLE_EFFECTSIMULATE_FLOATCURVE_METHOD_4_627557CE4CD0ABB4_OFFSET UNITYSDK_OFFSET(0x153EAEA0)
#define MOLEMOLE_EFFECTSIMULATE_FLOATCURVE_METHOD_4_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x153EB7C0)
#define MOLEMOLE_EFFECTSIMULATE_FLOATCURVE_METHOD_4_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x153EB750)
#define MOLEMOLE_EFFECTSIMULATE_FLOATCURVE_METHOD_4_A6F875702993FA31_OFFSET UNITYSDK_OFFSET(0x153EABD0)
#define MOLEMOLE_EFFECTSIMULATE_FLOATCURVE_METHOD_4_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x153EB710)
#define MOLEMOLE_EFFECTSIMULATE_FLOATCURVE_METHOD_4_CEE72EAC18ECC163_OFFSET UNITYSDK_OFFSET(0x153EB5E0)
#define MOLEMOLE_EFFECTSIMULATE_FLOATCURVE_METHOD_4_D5CE98C81E7D70E3_OFFSET UNITYSDK_OFFSET(0x153EB590)
#define MOLEMOLE_EFFECTSIMULATE_FLOATCURVE_METHOD_4_E9B750BB61FFD0D0_OFFSET UNITYSDK_OFFSET(0x153EADC0)
#define MOLEMOLE_EFFECTSIMULATE_FLOATCURVE_METHOD_4_F7E4906784B9935A_OFFSET UNITYSDK_OFFSET(0x153EB230)
#define MOLEMOLE_EFFECTSIMULATE_FLOATCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x153EAB60)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int FloatCurve_TypeDefinitionIndex = 76668;
