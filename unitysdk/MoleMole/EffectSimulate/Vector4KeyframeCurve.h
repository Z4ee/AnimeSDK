...
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_GET_WKEYFRAME_OFFSET UNITYSDK_OFFSET(0x18F87EC0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_GET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x18F87CE0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_GET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0x18F87D80)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_GET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0x18F87E20)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_04EDF435A0D753A9_OFFSET UNITYSDK_OFFSET(0x18F88500)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_1DE6433C25680F9D_OFFSET UNITYSDK_OFFSET(0x18F88CD0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_31FC867766176C3A_OFFSET UNITYSDK_OFFSET(0x18F88130)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x18F88F60)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x18F88F50)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_8F8B3C218D38C840_OFFSET UNITYSDK_OFFSET(0x18F880A0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_9823BFA3CE8B5542_OFFSET UNITYSDK_OFFSET(0x18F88910)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_A0F1D07FA5BAF2AE_OFFSET UNITYSDK_OFFSET(0x18F88600)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_A5ADA4706DA592FA_OFFSET UNITYSDK_OFFSET(0x18F88A90)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_B56234B03748E3AC_OFFSET UNITYSDK_OFFSET(0x18F87F60)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x18F889F0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_CEE72EAC18ECC163_OFFSET UNITYSDK_OFFSET(0x18F88000)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_D219DD9B6D30CBB4_OFFSET UNITYSDK_OFFSET(0x18F886D0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_SET_WKEYFRAME_OFFSET UNITYSDK_OFFSET(0x18F87EF0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_SET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x18F87D10)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_SET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0x18F87DB0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_SET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0x18F87E50)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x18F81C50)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int Vector4KeyframeCurve_TypeDefinitionIndex = 63235;
