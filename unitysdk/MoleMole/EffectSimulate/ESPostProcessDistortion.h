...
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSDISTORTION_METHOD_5_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0x17E5FBB0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSDISTORTION_METHOD_5_25CD86BF8626C8D9_OFFSET UNITYSDK_OFFSET(0x17E60B70)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSDISTORTION_METHOD_5_63E3E26A3D57F57D_1_OFFSET UNITYSDK_OFFSET(0x17E64700)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSDISTORTION_METHOD_5_63E3E26A3D57F57D_OFFSET UNITYSDK_OFFSET(0x17E63F20)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSDISTORTION_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x17E5FDD0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSDISTORTION_METHOD_5_84B92802FDAFF6C8_OFFSET UNITYSDK_OFFSET(0x17E5FDE0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSDISTORTION_METHOD_5_9E93A3CD963FC72F_OFFSET UNITYSDK_OFFSET(0x17E631B0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSDISTORTION_METHOD_5_A4D542D66439C65E_OFFSET UNITYSDK_OFFSET(0x17E60E50)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSDISTORTION_METHOD_5_D35B60AE823B8CC1_OFFSET UNITYSDK_OFFSET(0x17E60030)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSDISTORTION__CTOR_OFFSET UNITYSDK_OFFSET(0x17E64EE0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESPostProcessDistortion_TypeDefinitionIndex = 72314;
