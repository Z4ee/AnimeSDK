...
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFXCOMICDOT_METHOD_5_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0x158DE770)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFXCOMICDOT_METHOD_5_1AB9D4E0D4B0F708_OFFSET UNITYSDK_OFFSET(0x158DFA90)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFXCOMICDOT_METHOD_5_46DF29ACE60986D7_OFFSET UNITYSDK_OFFSET(0x158DEEB0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFXCOMICDOT_METHOD_5_499C93D7C9F81C2E_OFFSET UNITYSDK_OFFSET(0x158DEAC0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFXCOMICDOT_METHOD_5_72EE0536B7197A31_1_OFFSET UNITYSDK_OFFSET(0x158E0520)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFXCOMICDOT_METHOD_5_72EE0536B7197A31_OFFSET UNITYSDK_OFFSET(0x158E0010)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFXCOMICDOT_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x158DE930)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFXCOMICDOT_METHOD_5_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x158DE940)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFXCOMICDOT_METHOD_5_A4D542D66439C65E_OFFSET UNITYSDK_OFFSET(0x158DF030)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFXCOMICDOT__CTOR_OFFSET UNITYSDK_OFFSET(0x158E0A30)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESPostProcessFXComicDot_TypeDefinitionIndex = 80783;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFXCOMICDOT_METHOD_5_A4D542D66439C65E_OFFSET))(this, a1);
		}
