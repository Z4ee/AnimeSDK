...
#define MOLEMOLE_CONFIGHIDEMENUCUTSCENEVIDEOLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x192156E0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigHideMenuCutSceneVideoList_TypeDefinitionIndex = 46806;
