...
#define MOLEMOLE_CUSTOMGETCHESSENTITYSAVEMAPNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x16B61710)

namespace MoleMole
{
	inline static constexpr unsigned int CustomGetChessEntitySaveMapNode_TypeDefinitionIndex = 82786;
