...
#define MOLEMOLE_UIGACHABANGBOOPANELWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17D908F0)
#define MOLEMOLE_UIGACHABANGBOOPANELWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17D90430)
#define MOLEMOLE_UIGACHABANGBOOPANELWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17D90980)
#define MOLEMOLE_UIGACHABANGBOOPANELWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17D90360)
#define MOLEMOLE_UIGACHABANGBOOPANELWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17D903C0)
#define MOLEMOLE_UIGACHABANGBOOPANELWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x17D90520)
#define MOLEMOLE_UIGACHABANGBOOPANELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17D90A00)
#define MOLEMOLE_UIGACHABANGBOOPANELWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17D90A60)
#define MOLEMOLE_UIGACHABANGBOOPANELWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17D90AF0)
#define MOLEMOLE_UIGACHABANGBOOPANELWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17D90B90)
#define MOLEMOLE_UIGACHABANGBOOPANELWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17D90C20)
#define MOLEMOLE_UIGACHABANGBOOPANELWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17D90CB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaBangbooPanelWidgetController_TypeDefinitionIndex = 51478;
