...
#define MOLEMOLE_UIRABSTARUPFACTORDESCWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x152AA9C0)
#define MOLEMOLE_UIRABSTARUPFACTORDESCWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x152AAA30)
#define MOLEMOLE_UIRABSTARUPFACTORDESCWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x152AAAD0)
#define MOLEMOLE_UIRABSTARUPFACTORDESCWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x152AAC80)
#define MOLEMOLE_UIRABSTARUPFACTORDESCWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x152AACE0)
#define MOLEMOLE_UIRABSTARUPFACTORDESCWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x152AAD80)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABStarUpFactorDescWidgetController_TypeDefinitionIndex = 40316;
