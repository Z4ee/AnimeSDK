...
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_GETOPTIONITEMICONBTNCONTROLLER_OFFSET UNITYSDK_OFFSET(0x147E40B0)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x147E38C0)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x147E38B0)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_INITITEMLIST_OFFSET UNITYSDK_OFFSET(0x147E52E0)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x147E4B50)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_MASKCLOSE_OFFSET UNITYSDK_OFFSET(0x147E3C70)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_ONAUTORECOVERYITEMGETHANDLE_OFFSET UNITYSDK_OFFSET(0x147E7170)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_ONCANCLECLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x147E7660)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_ONCLICKITEMBTN_OFFSET UNITYSDK_OFFSET(0x147E77D0)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x147E38D0)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x147E4550)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x147E4760)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x147E4020)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x147E4180)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_ONOKCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x147E76B0)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x147E7820)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x147E78B0)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x147E3960)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x147E4970)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_RECALCULATESELECTIDX_OFFSET UNITYSDK_OFFSET(0x147E73E0)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_SETSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x147E5C30)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_UPDATEBACKUPENERGY_OFFSET UNITYSDK_OFFSET(0x147E72B0)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_UPDATEENERGY_OFFSET UNITYSDK_OFFSET(0x147E64F0)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER__CREATITEM_OFFSET UNITYSDK_OFFSET(0x147E5030)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x147E7900)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER__ONOKCLICKHANDLE_B__21_0_OFFSET UNITYSDK_OFFSET(0x147E7A80)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER__ONOKCLICKHANDLE_B__21_1_OFFSET UNITYSDK_OFFSET(0x147E7DE0)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER__ONOKCLICKHANDLE_B__21_2_OFFSET UNITYSDK_OFFSET(0x147E7E50)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER___BASE_MASKCLOSE_OFFSET UNITYSDK_OFFSET(0x147E7EF0)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x147E7F80)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x147E8010)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x147E80A0)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x147E8130)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x147E8160)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x147E81F0)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x147E82B0)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x147E82C0)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x147E82D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPowerTipsPopWindowController_TypeDefinitionIndex = 68829;
	...
	public:
		...
		::Class_2_79F6D62CE30E3F8E_64* _view; // 0x310
		::System::Collections::Generic::List_1<::Class_1_0D6706375CDAAE8C*>* _itemList; // 0x318
		::Class_1_0D6706375CDAAE8C* _selectItem; // 0x320
		::System::Int32 _curSelectedOptionItemIndex; // 0x328
		::Class_2_208CC9941471731A_255* _recoverytemplate; // 0x330
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* _exchangeLimitDir; // 0x338
		::System::Collections::Generic::List_1<::System::Int32>* costList; // 0x340
		::System::Int32 buyTimes; // 0x348
		::System::Int32 _lackEnergyAmount; // 0x34C
