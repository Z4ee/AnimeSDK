...
#define MOLEMOLE_UIWISHLISTSUITPLANWIDGETCONTROLLER_CLEARSELECT_OFFSET UNITYSDK_OFFSET(0x15A87700)
#define MOLEMOLE_UIWISHLISTSUITPLANWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A86BC0)
#define MOLEMOLE_UIWISHLISTSUITPLANWIDGETCONTROLLER_ONSELECT_OFFSET UNITYSDK_OFFSET(0x15A86CD0)
#define MOLEMOLE_UIWISHLISTSUITPLANWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A86C50)
#define MOLEMOLE_UIWISHLISTSUITPLANWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A86950)
#define MOLEMOLE_UIWISHLISTSUITPLANWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15A86B50)
#define MOLEMOLE_UIWISHLISTSUITPLANWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x15A86D50)
#define MOLEMOLE_UIWISHLISTSUITPLANWIDGETCONTROLLER_SETITEMCLICKEDACT_OFFSET UNITYSDK_OFFSET(0x15A877E0)
#define MOLEMOLE_UIWISHLISTSUITPLANWIDGETCONTROLLER_SETSELECT_OFFSET UNITYSDK_OFFSET(0x15A87770)
#define MOLEMOLE_UIWISHLISTSUITPLANWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15A87830)
#define MOLEMOLE_UIWISHLISTSUITPLANWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A87890)
#define MOLEMOLE_UIWISHLISTSUITPLANWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A87920)
#define MOLEMOLE_UIWISHLISTSUITPLANWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A879B0)
#define MOLEMOLE_UIWISHLISTSUITPLANWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15A87A40)

namespace MoleMole
{
	inline static constexpr unsigned int UIWishlistSuitPlanWidgetController_TypeDefinitionIndex = 60800;
