...
#define MOLEMOLE_UICONTROLLEREXTENSION_CHECKCOLDDOWN_OFFSET UNITYSDK_OFFSET(0x195897D0)
#define MOLEMOLE_UICONTROLLEREXTENSION_ENABLEMASKCLICK_OFFSET UNITYSDK_OFFSET(0x19588BD0)
#define MOLEMOLE_UICONTROLLEREXTENSION_GETALLFADEANIMNAMESET_OFFSET UNITYSDK_OFFSET(0x19588DF0)
#define MOLEMOLE_UICONTROLLEREXTENSION_GETFADEDATA_OFFSET UNITYSDK_OFFSET(0x19588DA0)
#define MOLEMOLE_UICONTROLLEREXTENSION_GETGENERALAUDIOCONFIG_OFFSET UNITYSDK_OFFSET(0x19589280)
#define MOLEMOLE_UICONTROLLEREXTENSION_GETPLAYMIXDROPDOWN_OFFSET UNITYSDK_OFFSET(0x195888C0)
#define MOLEMOLE_UICONTROLLEREXTENSION_ONCLICKMASK_OFFSET UNITYSDK_OFFSET(0x19589520)
#define MOLEMOLE_UICONTROLLEREXTENSION_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19589360)
#define MOLEMOLE_UICONTROLLEREXTENSION_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19588B00)
#define MOLEMOLE_UICONTROLLEREXTENSION_VALIDATEAUDIOSTATECONFIGS_OFFSET UNITYSDK_OFFSET(0x195886D0)
#define MOLEMOLE_UICONTROLLEREXTENSION_VALIDATESTATEGROUP_OFFSET UNITYSDK_OFFSET(0x195885C0)
#define MOLEMOLE_UICONTROLLEREXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x19589940)

namespace MoleMole
{
	inline static constexpr unsigned int UIControllerExtension_TypeDefinitionIndex = 81387;
	...
	public:
		...
		::MoleMole::UIFadeConfig* GetFadeData(::Enum_3_DBF2701137F18AA6 uiCtrl)
		{
			return ((::MoleMole::UIFadeConfig*(*)(::PVOID, ::Enum_3_DBF2701137F18AA6))((::PBYTE)hIl2Cpp + MOLEMOLE_UICONTROLLEREXTENSION_GETFADEDATA_OFFSET))(this, uiCtrl);
		}

		::System::Collections::Generic::HashSet_1<::System::String*>* GetAllFadeAnimNameSet(::Enum_3_DBF2701137F18AA6 uiCtrl)
		{
			return ((::System::Collections::Generic::HashSet_1<::System::String*>*(*)(::PVOID, ::Enum_3_DBF2701137F18AA6))((::PBYTE)hIl2Cpp + MOLEMOLE_UICONTROLLEREXTENSION_GETALLFADEANIMNAMESET_OFFSET))(this, uiCtrl);
		}
