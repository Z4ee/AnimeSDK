...
#define MOLEMOLE_UIFORBIDDENAREAPREPPAGECONTROLLER___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0x193875C0)
#define MOLEMOLE_UIFORBIDDENAREAPREPPAGECONTROLLER___C__DISPLAYCLASS16_0__REFRESHTALENTVIEW_B__0_OFFSET UNITYSDK_OFFSET(0x193876D0)
#define MOLEMOLE_UIFORBIDDENAREAPREPPAGECONTROLLER___C__DISPLAYCLASS16_0__REFRESHTALENTVIEW_B__1_OFFSET UNITYSDK_OFFSET(0x193875D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIForbiddenAreaPrepPageController___c__DisplayClass16_0_TypeDefinitionIndex = 51975;
