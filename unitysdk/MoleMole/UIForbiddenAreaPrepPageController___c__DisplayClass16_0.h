...
#define MOLEMOLE_UIFORBIDDENAREAPREPPAGECONTROLLER___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0x175D4900)
#define MOLEMOLE_UIFORBIDDENAREAPREPPAGECONTROLLER___C__DISPLAYCLASS16_0__REFRESHTALENTVIEW_B__0_OFFSET UNITYSDK_OFFSET(0x175D4A10)
#define MOLEMOLE_UIFORBIDDENAREAPREPPAGECONTROLLER___C__DISPLAYCLASS16_0__REFRESHTALENTVIEW_B__1_OFFSET UNITYSDK_OFFSET(0x175D4910)

namespace MoleMole
{
	inline static constexpr unsigned int UIForbiddenAreaPrepPageController___c__DisplayClass16_0_TypeDefinitionIndex = 60735;
