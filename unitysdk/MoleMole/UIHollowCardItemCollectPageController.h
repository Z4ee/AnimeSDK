...
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_CREATEWIDGET_OFFSET UNITYSDK_OFFSET(0x1468E540)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_GETCARDWIDGETCONTEXT_OFFSET UNITYSDK_OFFSET(0x1468D9D0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_GETCTRL_OFFSET UNITYSDK_OFFSET(0x1468F110)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_GETCURRENTREWARDBADGETYPE_OFFSET UNITYSDK_OFFSET(0x1468B570)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_GETRESEARCHPROGRESSCONFIGLIST_OFFSET UNITYSDK_OFFSET(0x1468F970)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x1468A7C0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1468A7D0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_GOTOMAINCITY_OFFSET UNITYSDK_OFFSET(0x1468F210)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_INITTOPTABS_OFFSET UNITYSDK_OFFSET(0x1468B030)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_INITWIDGET_OFFSET UNITYSDK_OFFSET(0x1468AF60)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_ONABYSSTABSELECTHANDLE_OFFSET UNITYSDK_OFFSET(0x1468B460)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_ONCLICKVIDEOBTN_OFFSET UNITYSDK_OFFSET(0x1468FD20)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_ONCLOSEREFRESHHALLDATA_OFFSET UNITYSDK_OFFSET(0x1468D8B0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1468A7E0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_ONDATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1468CBA0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x1468C830)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_ONGOTOREWARDBTN_OFFSET UNITYSDK_OFFSET(0x1468CA90)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x14690000)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1468CC70)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_ONTABSELECTHANDLE_OFFSET UNITYSDK_OFFSET(0x1468F330)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x1468D700)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14690190)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1468A870)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1468CDD0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_REFRESHORIGINALBADGETYPELIST_OFFSET UNITYSDK_OFFSET(0x1468E0D0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_REFRESHREWARDTAKENPROGRESS_OFFSET UNITYSDK_OFFSET(0x1468BF10)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_REFRESHREWARDTEX_OFFSET UNITYSDK_OFFSET(0x1468C5D0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_REFRESHSYSTEMREDPOINT_OFFSET UNITYSDK_OFFSET(0x1468C970)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_REFRESHTABREDPOINT_OFFSET UNITYSDK_OFFSET(0x1468C310)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_REFRESHTAB_OFFSET UNITYSDK_OFFSET(0x1468B5E0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x1468CC00)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_SORTCFGS_OFFSET UNITYSDK_OFFSET(0x1468AD10)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_TRYCANCELSELECT_OFFSET UNITYSDK_OFFSET(0x1468FA80)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_TRYPOPTIPSANDCLEARUNLOCKNEWGENREWINDOW_OFFSET UNITYSDK_OFFSET(0x1468CF50)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_TRYSELECTCTRL_OFFSET UNITYSDK_OFFSET(0x1468F610)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14690420)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER__INITTOPTABS_B__8_0_OFFSET UNITYSDK_OFFSET(0x14690430)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER__INITTOPTABS_B__8_1_OFFSET UNITYSDK_OFFSET(0x14690460)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER__ONCLICKVIDEOBTN_B__40_0_OFFSET UNITYSDK_OFFSET(0x146904D0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER__ONTABSELECTHANDLE_B__36_0_OFFSET UNITYSDK_OFFSET(0x14690490)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14690500)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x14690590)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x14690620)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x146906B0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x146906C0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14690780)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14690790)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x146907A0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x14690830)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCardItemCollectPageController_TypeDefinitionIndex = 42851;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_1105*>* m_sortedTabList; // 0x330
		...
		::Class_2_E621E51D351EB960* _abyssModel; // 0x3B0
		...
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_1098*>* GetResearchProgressConfigList(::MoleMole::UIHollowCardItemCollectPageController_TabType type)
		{
			return ((::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_1098*>*(*)(::PVOID, ::MoleMole::UIHollowCardItemCollectPageController_TabType))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_GETRESEARCHPROGRESSCONFIGLIST_OFFSET))(this, type);
		}
		...
		::System::Boolean _OnTabSelectHandle_b__36_0(::Class_2_208CC9941471731A_1105* x)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_2_208CC9941471731A_1105*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER__ONTABSELECTHANDLE_B__36_0_OFFSET))(this, x);
		}

		::System::Boolean _OnClickVideoBtn_b__40_0(::Class_2_208CC9941471731A_1105* x)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_2_208CC9941471731A_1105*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER__ONCLICKVIDEOBTN_B__40_0_OFFSET))(this, x);
		}
