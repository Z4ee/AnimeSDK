...
#define MOLEMOLE_UILEVELUPDETAILSROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16C08D40)
#define MOLEMOLE_UILEVELUPDETAILSROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16C08E50)
#define MOLEMOLE_UILEVELUPDETAILSROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16C08DD0)
#define MOLEMOLE_UILEVELUPDETAILSROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16C08C30)
#define MOLEMOLE_UILEVELUPDETAILSROWWIDGETCONTROLLER_REFRESHWEAPONVIEW_OFFSET UNITYSDK_OFFSET(0x16C08F00)
#define MOLEMOLE_UILEVELUPDETAILSROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16C095B0)
#define MOLEMOLE_UILEVELUPDETAILSROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16C09640)
#define MOLEMOLE_UILEVELUPDETAILSROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16C096D0)
#define MOLEMOLE_UILEVELUPDETAILSROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16C09770)
#define MOLEMOLE_UILEVELUPDETAILSROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16C09800)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelUpDetailsRowWidgetController_TypeDefinitionIndex = 47980;
