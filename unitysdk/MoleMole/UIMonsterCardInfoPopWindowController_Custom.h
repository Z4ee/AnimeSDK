...
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_CUSTOM_GETBOSSLEVEL_OFFSET UNITYSDK_OFFSET(0x15D5B520)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_CUSTOM_GETHOLLOWMONSTERIDLIST_OFFSET UNITYSDK_OFFSET(0x15D5B460)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_CUSTOM_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15D5AF60)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_CUSTOM_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15D5B060)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_CUSTOM_UPDATEBOSSCFGLIST_OFFSET UNITYSDK_OFFSET(0x15D5B1F0)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_CUSTOM__CTOR_OFFSET UNITYSDK_OFFSET(0x15D5B570)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_CUSTOM___BASE_GETBOSSLEVEL_OFFSET UNITYSDK_OFFSET(0x15D5B580)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_CUSTOM___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15D5B610)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_CUSTOM___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15D5B6E0)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_CUSTOM___BASE_UPDATEBOSSCFGLIST_OFFSET UNITYSDK_OFFSET(0x15D5B6F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterCardInfoPopWindowController_Custom_TypeDefinitionIndex = 46264;
