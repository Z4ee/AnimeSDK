...
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_CUSTOM_GETBOSSLEVEL_OFFSET UNITYSDK_OFFSET(0x1745C270)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_CUSTOM_GETHOLLOWMONSTERIDLIST_OFFSET UNITYSDK_OFFSET(0x1745C1B0)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_CUSTOM_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1745BCB0)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_CUSTOM_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1745BDB0)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_CUSTOM_UPDATEBOSSCFGLIST_OFFSET UNITYSDK_OFFSET(0x1745BF40)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_CUSTOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1745C2C0)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_CUSTOM___BASE_GETBOSSLEVEL_OFFSET UNITYSDK_OFFSET(0x1745C2D0)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_CUSTOM___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1745C360)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_CUSTOM___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1745C430)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_CUSTOM___BASE_UPDATEBOSSCFGLIST_OFFSET UNITYSDK_OFFSET(0x1745C440)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterCardInfoPopWindowController_Custom_TypeDefinitionIndex = 53101;
