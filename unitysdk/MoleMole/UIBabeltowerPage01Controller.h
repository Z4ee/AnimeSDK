...
#define MOLEMOLE_UIBABELTOWERPAGE01CONTROLLER_AFTERSHOWLEVELUPANIMATION_OFFSET UNITYSDK_OFFSET(0x14BD96D0)
#define MOLEMOLE_UIBABELTOWERPAGE01CONTROLLER_CHECKNEWBIE_OFFSET UNITYSDK_OFFSET(0x14BD8FA0)
#define MOLEMOLE_UIBABELTOWERPAGE01CONTROLLER_GETFIGHTINFOWIDGET_OFFSET UNITYSDK_OFFSET(0x14BD9840)
#define MOLEMOLE_UIBABELTOWERPAGE01CONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14BD8C70)
#define MOLEMOLE_UIBABELTOWERPAGE01CONTROLLER_ONPOSTREFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x14BD9090)
#define MOLEMOLE_UIBABELTOWERPAGE01CONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14BD8D70)
#define MOLEMOLE_UIBABELTOWERPAGE01CONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14BD99B0)
#define MOLEMOLE_UIBABELTOWERPAGE01CONTROLLER__ONUIOPEN_B__3_0_OFFSET UNITYSDK_OFFSET(0x14BD9A10)
#define MOLEMOLE_UIBABELTOWERPAGE01CONTROLLER___BASE_AFTERSHOWLEVELUPANIMATION_OFFSET UNITYSDK_OFFSET(0x14BD9B10)
#define MOLEMOLE_UIBABELTOWERPAGE01CONTROLLER___BASE_GETFIGHTINFOWIDGET_OFFSET UNITYSDK_OFFSET(0x14BD9BA0)
#define MOLEMOLE_UIBABELTOWERPAGE01CONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14BD9BB0)
#define MOLEMOLE_UIBABELTOWERPAGE01CONTROLLER___BASE_ONPOSTREFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x14BD9C80)
#define MOLEMOLE_UIBABELTOWERPAGE01CONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14BD9D30)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerPage01Controller_TypeDefinitionIndex = 69187;

	class UIBabeltowerPage01Controller : public ::MoleMole::UIBabeltowerPageController
	{
	public:
		::Class_2_79AE422BA06F6D26_73* _view; // 0x3D0
		::System::String* ANIM_NAME; // 0x3D8
