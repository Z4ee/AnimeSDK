...
class Class_2_79AE422BA06F6D26_274;
...
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER_ADDREPLYTOBOTTOM_OFFSET UNITYSDK_OFFSET(0x182CB990)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER_BINDREPLY_OFFSET UNITYSDK_OFFSET(0x182CB540)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER_BIND_OFFSET UNITYSDK_OFFSET(0x182C9250)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER_CREATEPOST_OFFSET UNITYSDK_OFFSET(0x182CCAE0)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER_GETBTN1_OFFSET UNITYSDK_OFFSET(0x182CB880)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER_GETBTN2_OFFSET UNITYSDK_OFFSET(0x182CB8E0)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER_GETPOSTLASTFLOOR_OFFSET UNITYSDK_OFFSET(0x182CCA10)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER_GETUSERCOMMENTFLOOR_OFFSET UNITYSDK_OFFSET(0x182CC320)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x182C87A0)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x182C9840)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER_ONCLICKFAIRYBUTTON_OFFSET UNITYSDK_OFFSET(0x182CD120)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER_ONCLICKFANSBTNCALLBACK_OFFSET UNITYSDK_OFFSET(0x182CB940)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x182CADB0)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x182CB490)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER_ONRECEIVEQUESTDIALOGCLOSED_OFFSET UNITYSDK_OFFSET(0x182C8960)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x182CAE40)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x182C87B0)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x182C8A50)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER_REFRESHTEXTSTATE_OFFSET UNITYSDK_OFFSET(0x182CCDD0)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER_REFRESHTIPSPANEL_OFFSET UNITYSDK_OFFSET(0x182CC3E0)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER_SETPOSITIONTOBOTTOM_OFFSET UNITYSDK_OFFSET(0x182CC790)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x182C89C0)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER_SHOWCHATANIM_OFFSET UNITYSDK_OFFSET(0x182CC630)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER__BIND_B__12_0_OFFSET UNITYSDK_OFFSET(0x182CD350)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER__BIND_B__12_1_OFFSET UNITYSDK_OFFSET(0x182CD3E0)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER__BIND_B__12_2_OFFSET UNITYSDK_OFFSET(0x182CD550)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x182CD230)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER__ONUIOPEN_B__8_0_OFFSET UNITYSDK_OFFSET(0x182CD240)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER__ONUIOPEN_B__8_1_OFFSET UNITYSDK_OFFSET(0x182CD270)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x182CD620)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x182CD6B0)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x182CD740)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x182CD750)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x182CD760)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x182CD7F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotPostDialogPopWindowController_TypeDefinitionIndex = 85433;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_274* _view; // 0x318
		...
		::Class_2_208CC9941471731A_565* template_; // 0x350
