...
#define MOLEMOLE_CONFIGHOLLOWCHESSBOARDENTITYBEHAVIOR_BEHAVIORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x161A4330)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigHollowChessboardEntityBehavior_BehaviorConfig_TypeDefinitionIndex = 45726;
	...
	public:
		...
		::System::Collections::Generic::List_1<::MoleMole::Config::ConfigUIBaseActionNode*>* configActions; // 0x20
