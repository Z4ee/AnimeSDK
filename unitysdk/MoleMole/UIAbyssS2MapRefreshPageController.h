...
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER_CHECKNEEDSORTPROPS_OFFSET UNITYSDK_OFFSET(0x183B2A70)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER_CREATEMAPREFRESHPROPINFO_OFFSET UNITYSDK_OFFSET(0x183B2870)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER_CREATEPROPLIST_OFFSET UNITYSDK_OFFSET(0x183B2E20)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER_GETSELECTEDPROPSID_OFFSET UNITYSDK_OFFSET(0x183B2040)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x183B1A70)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER_INITPROPS_OFFSET UNITYSDK_OFFSET(0x183B3460)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER_ONCLICKITEMEXPEND_OFFSET UNITYSDK_OFFSET(0x183B3670)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x183B3240)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x183B1A80)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER_ONDETAILBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x183B3D70)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x183B1E20)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER_ONREFRESHBTN_OFFSET UNITYSDK_OFFSET(0x183B2180)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER_ONTIPSCLICK_OFFSET UNITYSDK_OFFSET(0x183B1F70)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x183B3EF0)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x183B1B10)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x183B3CA0)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER_REFRESHMAPINTERNALASYNC_OFFSET UNITYSDK_OFFSET(0x183B23D0)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER_REFRESHMAP_OFFSET UNITYSDK_OFFSET(0x183B2320)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER_REFRESHONEPROP_OFFSET UNITYSDK_OFFSET(0x183B2570)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER_REFRESHPROPS_OFFSET UNITYSDK_OFFSET(0x183B2C40)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER_SELECTEDPROPSID_OFFSET UNITYSDK_OFFSET(0x183B20B0)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER_SENDREFRESHMAPREQ_OFFSET UNITYSDK_OFFSET(0x183B3360)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER_SORTPROPS_OFFSET UNITYSDK_OFFSET(0x183B3B20)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER_UPDATEMAPANDPROPS_OFFSET UNITYSDK_OFFSET(0x183B24C0)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x183B3F70)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER__INITPROPS_B__19_0_OFFSET UNITYSDK_OFFSET(0x183B4000)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x183B4100)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x183B4190)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x183B41C0)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x183B41D0)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x183B41E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2MapRefreshPageController_TypeDefinitionIndex = 56655;
	...
	public:
		...
		static ::Class_1_18814BC9826CDED5* CreateMapRefreshPropInfo(::Class_2_208CC9941471731A_1065* prop, ::Class_2_208CC9941471731A_131* itemConfig)
		{
			return ((::Class_1_18814BC9826CDED5*(*)(::Class_2_208CC9941471731A_1065*, ::Class_2_208CC9941471731A_131*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER_CREATEMAPREFRESHPROPINFO_OFFSET))(prop, itemConfig);
		}
