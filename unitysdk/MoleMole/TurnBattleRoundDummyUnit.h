...
#define MOLEMOLE_TURNBATTLEROUNDDUMMYUNIT_GET_ROUNDINDEX_OFFSET UNITYSDK_OFFSET(0x17E062E0)
#define MOLEMOLE_TURNBATTLEROUNDDUMMYUNIT_SET_ROUNDINDEX_OFFSET UNITYSDK_OFFSET(0x17E062F0)
#define MOLEMOLE_TURNBATTLEROUNDDUMMYUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x17E06300)

namespace MoleMole
{
	inline static constexpr unsigned int TurnBattleRoundDummyUnit_TypeDefinitionIndex = 69077;
