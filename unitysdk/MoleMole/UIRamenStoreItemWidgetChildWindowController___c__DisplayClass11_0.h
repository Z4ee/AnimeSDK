...
#define MOLEMOLE_UIRAMENSTOREITEMWIDGETCHILDWINDOWCONTROLLER___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x12E63840)
#define MOLEMOLE_UIRAMENSTOREITEMWIDGETCHILDWINDOWCONTROLLER___C__DISPLAYCLASS11_0__PLAYSELECTFADE_B__0_OFFSET UNITYSDK_OFFSET(0x12E63880)
#define MOLEMOLE_UIRAMENSTOREITEMWIDGETCHILDWINDOWCONTROLLER___C__DISPLAYCLASS11_0__PLAYSELECTFADE_B__1_OFFSET UNITYSDK_OFFSET(0x12E63850)

namespace MoleMole
{
	inline static constexpr unsigned int UIRamenStoreItemWidgetChildWindowController___c__DisplayClass11_0_TypeDefinitionIndex = 53405;
