...
#define MOLEMOLE_UIRAMENSTOREITEMWIDGETCHILDWINDOWCONTROLLER___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x160C4180)
#define MOLEMOLE_UIRAMENSTOREITEMWIDGETCHILDWINDOWCONTROLLER___C__DISPLAYCLASS11_0__PLAYSELECTFADE_B__0_OFFSET UNITYSDK_OFFSET(0x160C41C0)
#define MOLEMOLE_UIRAMENSTOREITEMWIDGETCHILDWINDOWCONTROLLER___C__DISPLAYCLASS11_0__PLAYSELECTFADE_B__1_OFFSET UNITYSDK_OFFSET(0x160C4190)

namespace MoleMole
{
	inline static constexpr unsigned int UIRamenStoreItemWidgetChildWindowController___c__DisplayClass11_0_TypeDefinitionIndex = 83569;
