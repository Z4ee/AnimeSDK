...
#define MOLEMOLE_TOWERDEFENSENEWBIEDISPLAYMESSAGE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x12BE6370)
#define MOLEMOLE_TOWERDEFENSENEWBIEDISPLAYMESSAGE_SETMESSAGECONFIG_OFFSET UNITYSDK_OFFSET(0x12BE6310)
#define MOLEMOLE_TOWERDEFENSENEWBIEDISPLAYMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x12BE62E0)
#define MOLEMOLE_TOWERDEFENSENEWBIEDISPLAYMESSAGE___BASE_SETMESSAGECONFIG_OFFSET UNITYSDK_OFFSET(0x12BE6640)

namespace MoleMole
{
	inline static constexpr unsigned int TowerDefenseNewbieDisplayMessage_TypeDefinitionIndex = 65007;
