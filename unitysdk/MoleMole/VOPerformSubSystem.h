...
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ADDBLACKCURTAIN_OFFSET UNITYSDK_OFFSET(0x12A25F50)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ADDPENDINGTIP_OFFSET UNITYSDK_OFFSET(0x12A263A0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ADDTAGGRAPHNODEDATA_OFFSET UNITYSDK_OFFSET(0x12A245F0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_CLEARALLDROPPERFORMS_OFFSET UNITYSDK_OFFSET(0x12A241C0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_DELALLBLACKCURTAIN_OFFSET UNITYSDK_OFFSET(0x12A262F0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_DELBLACKCURTAIN_1_OFFSET UNITYSDK_OFFSET(0x12A261E0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_DELBLACKCURTAIN_OFFSET UNITYSDK_OFFSET(0x12A26020)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_DOFORCEREFRESHALLGUIDEPOSTARGET_OFFSET UNITYSDK_OFFSET(0x12A2AA90)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_GET_ISTELEPORTING_OFFSET UNITYSDK_OFFSET(0x12A2A920)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_HIDE_GUIDEPOSTARGET_OFFSET UNITYSDK_OFFSET(0x12A2A160)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ISCONTAINSNODEDATABYKEY_OFFSET UNITYSDK_OFFSET(0x12A24230)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ISGUIDEPOSTARGETEXIST_OFFSET UNITYSDK_OFFSET(0x12A2A2C0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_CLEARALLNAMEPANEL_OFFSET UNITYSDK_OFFSET(0x12A28390)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_GETVOCONFIGNAMESHOWTYPE_OFFSET UNITYSDK_OFFSET(0x12A27EC0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_HIDEBUBBLEBYVOCONFIGID_OFFSET UNITYSDK_OFFSET(0x12A289E0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_HIDEICONBYVOCONFIGID_OFFSET UNITYSDK_OFFSET(0x12A28050)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_HIDENAMEBYENTITYID_OFFSET UNITYSDK_OFFSET(0x12A28FC0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_SHOWBUBBLEBYVOCONFIGID_OFFSET UNITYSDK_OFFSET(0x12A28780)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_SHOWICONBYVOCONFIGID_1_OFFSET UNITYSDK_OFFSET(0x12A27D60)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_SHOWICONBYVOCONFIGID_OFFSET UNITYSDK_OFFSET(0x12A27B60)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_SHOWNAMEBYENTITYID_OFFSET UNITYSDK_OFFSET(0x12A28AC0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_SHOWNAMEBYVOCONFIGID_OFFSET UNITYSDK_OFFSET(0x12A277B0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x12A249F0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x12A24A50)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ONTELEPORTFINISH_OFFSET UNITYSDK_OFFSET(0x12A2A980)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ONTELEPORTSTARTED_OFFSET UNITYSDK_OFFSET(0x12A2A940)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x12A24B10)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_QUERYTIPINFO_OFFSET UNITYSDK_OFFSET(0x12A264F0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_REMOVEALLBLACKCURTAINBYTRANSITION_OFFSET UNITYSDK_OFFSET(0x12A25730)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_REMOVETAGGRAPHNODEDATA_OFFSET UNITYSDK_OFFSET(0x12A24910)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_SET_ISTELEPORTING_OFFSET UNITYSDK_OFFSET(0x12A2A930)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_SHOW_GUIDEPOSTARGETBYPOS_OFFSET UNITYSDK_OFFSET(0x12A29B70)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_SHOW_GUIDEPOSTARGET_OFFSET UNITYSDK_OFFSET(0x12A29FF0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_SUBMITDROPPERFORM_OFFSET UNITYSDK_OFFSET(0x12A23B40)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_TRYGETGUIDEPOSTARGETROUTEINFO_OFFSET UNITYSDK_OFFSET(0x12A2A370)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_TRYGETTAGGRAPHNODEDATA_OFFSET UNITYSDK_OFFSET(0x12A24800)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_TRYGETUNWALKGUIDEPOSTARGETROUTEINFO_OFFSET UNITYSDK_OFFSET(0x12A2A600)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_TRYREMOVEALLTIPINFO_OFFSET UNITYSDK_OFFSET(0x12A26D90)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_TRYREMOVETIPINFO_OFFSET UNITYSDK_OFFSET(0x12A268D0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_TRYSPLIT_GUIDEPOS_OFFSET UNITYSDK_OFFSET(0x12A29AF0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_UNLOADSAVEDATASBYGROUPID_OFFSET UNITYSDK_OFFSET(0x12A242E0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_UPDATETIPINFO_OFFSET UNITYSDK_OFFSET(0x12A27100)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__ATTACHRUNNINGDATA_OFFSET UNITYSDK_OFFSET(0x12A29310)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__CLOSEBLACKCURTAIN_OFFSET UNITYSDK_OFFSET(0x12A25A20)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x12A2AC40)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__LOGERROR_OFFSET UNITYSDK_OFFSET(0x12A2A110)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__LOG_OFFSET UNITYSDK_OFFSET(0x12A2ABF0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__NPC_ADDDELAYQUEUE_1_OFFSET UNITYSDK_OFFSET(0x12A29220)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__NPC_ADDDELAYQUEUE_OFFSET UNITYSDK_OFFSET(0x12A27A60)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__OPENBLACKCURTAIN_OFFSET UNITYSDK_OFFSET(0x12A257B0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__OPERATENPCENTITYICONBYENTITYID_1_OFFSET UNITYSDK_OFFSET(0x12A280F0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__OPERATENPCENTITYICONBYENTITYID_OFFSET UNITYSDK_OFFSET(0x12A27CA0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__OPERATENPCENTITYNAMEBYCONFIG_OFFSET UNITYSDK_OFFSET(0x12A279B0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__OPERATENPCENTITYNAMEBYENTITY_OFFSET UNITYSDK_OFFSET(0x12A28D30)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__OPERATE_GUIDEPOSTARGET_OFFSET UNITYSDK_OFFSET(0x12A29500)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__REFRESHBLACKCURTAIN_OFFSET UNITYSDK_OFFSET(0x12A25CA0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__SETBACK_OFFSET UNITYSDK_OFFSET(0x12A27000)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__SHOW_GUIDEPOSTARGET_IMPL_OFFSET UNITYSDK_OFFSET(0x12A29D00)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__TICKDELAYNPCNAMES_OFFSET UNITYSDK_OFFSET(0x12A24F70)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__TICKDROPPERFORM_OFFSET UNITYSDK_OFFSET(0x12A23CC0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__TICKPENDINGTIP_OFFSET UNITYSDK_OFFSET(0x12A24BA0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__TICKSPLITGUIDETARGETPOS_OFFSET UNITYSDK_OFFSET(0x12A25560)
#define MOLEMOLE_VOPERFORMSUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x12A2B270)
#define MOLEMOLE_VOPERFORMSUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x12A2B300)
#define MOLEMOLE_VOPERFORMSUBSYSTEM___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x12A2B390)
#define MOLEMOLE_VOPERFORMSUBSYSTEM___OPENBLACKCURTAIN_B__17_0_OFFSET UNITYSDK_OFFSET(0x12A2AFB0)

namespace MoleMole
{
	inline static constexpr unsigned int VOPerformSubSystem_TypeDefinitionIndex = 69477;

	class VOPerformSubSystem : public ::MoleMole::GameSubsystemBaseEx_1<::MoleMole::VOPerformSubSystem*>
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::MoleMole::VOPerformSubSystem_NpcNameShowInfo>* _npcCurrentNameShowType; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::String*, ::Class_1_534AF681CC2BD5FD_258_Class_1_481A253ED6F79F1A*>* _targetGuideInfoMap; // 0x18
		::System::Collections::Generic::List_1<::Class_1_534AF681CC2BD5FD_258_Class_1_481A253ED6F79F1A*>* _splitGuideInfoList; // 0x20
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::List_1<::System::Int32>*>* _targetFocusIconMapResults; // 0x28
		::System::Collections::Generic::List_1<::MoleMole::VOPerformSubSystem_DropPerformRequest*>* _activeDropPerforms; // 0x30
		::System::Collections::Generic::List_1<::MoleMole::VOPerformSubSystem_CurtainSetInfo>* waitBlackCurtainList; // 0x38
		::System::Collections::Generic::List_1<::MoleMole::VOPerformSubSystem_NpcNameShowInfo>* _delayNpcNameCmdList; // 0x40
		::System::Collections::Generic::List_1<::MoleMole::VOPerformSubSystem_VoTipInfo>* handledTipList; // 0x48
		::System::Collections::Generic::List_1<::MoleMole::VOPerformSubSystem_VoTipInfo>* pendingTipList; // 0x50
		::MoleMole::VOPerformSubSystem_CurtainSetInfo _waitPendingCurtainSet; // 0x58
		::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::VOPerformSubSystem_GraphSaveDataBase*>* _saveDatas; // 0x70
		::System::Int32 _tickIndex; // 0x78
		::System::Boolean _IsTeleporting_k__BackingField; // 0x7C
		::System::Int32 _lazyGuideTick; // 0x80
		...
		::System::Void TrySplit_GuidePos(::Class_1_534AF681CC2BD5FD_258_Class_1_481A253ED6F79F1A* runtimeData)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_534AF681CC2BD5FD_258_Class_1_481A253ED6F79F1A*))((::PBYTE)hIl2Cpp + MOLEMOLE_VOPERFORMSUBSYSTEM_TRYSPLIT_GUIDEPOS_OFFSET))(this, runtimeData);
		}
		...
		::System::Void __OpenBlackCurtain_b__17_0(::Class_1_7D59F735ACB38970_Enum_3_6E0E8267CDDC65CF reason)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_7D59F735ACB38970_Enum_3_6E0E8267CDDC65CF))((::PBYTE)hIl2Cpp + MOLEMOLE_VOPERFORMSUBSYSTEM___OPENBLACKCURTAIN_B__17_0_OFFSET))(this, reason);
		}
