...
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___C__DISPLAYCLASS44_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18448E70)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___C__DISPLAYCLASS44_0__RECOVERTIMELINEWORLDPOS_B__0_OFFSET UNITYSDK_OFFSET(0x1844A790)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___C__DISPLAYCLASS44_0__RECOVERTIMELINEWORLDPOS_B__1_OFFSET UNITYSDK_OFFSET(0x1844A7C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPerformPageController___c__DisplayClass44_0_TypeDefinitionIndex = 45495;
