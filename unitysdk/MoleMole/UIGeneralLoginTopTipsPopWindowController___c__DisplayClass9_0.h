...
#define MOLEMOLE_UIGENERALLOGINTOPTIPSPOPWINDOWCONTROLLER___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x176547D0)
#define MOLEMOLE_UIGENERALLOGINTOPTIPSPOPWINDOWCONTROLLER___C__DISPLAYCLASS9_0__ONSTARTCLOSE_B__0_OFFSET UNITYSDK_OFFSET(0x176547E0)
#define MOLEMOLE_UIGENERALLOGINTOPTIPSPOPWINDOWCONTROLLER___C__DISPLAYCLASS9_0__ONSTARTCLOSE_B__1_OFFSET UNITYSDK_OFFSET(0x176548B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralLoginTopTipsPopWindowController___c__DisplayClass9_0_TypeDefinitionIndex = 56480;
