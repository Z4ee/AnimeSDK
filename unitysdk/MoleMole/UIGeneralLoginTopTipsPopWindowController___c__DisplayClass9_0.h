...
#define MOLEMOLE_UIGENERALLOGINTOPTIPSPOPWINDOWCONTROLLER___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x185A4E50)
#define MOLEMOLE_UIGENERALLOGINTOPTIPSPOPWINDOWCONTROLLER___C__DISPLAYCLASS9_0__ONSTARTCLOSE_B__0_OFFSET UNITYSDK_OFFSET(0x185A4E60)
#define MOLEMOLE_UIGENERALLOGINTOPTIPSPOPWINDOWCONTROLLER___C__DISPLAYCLASS9_0__ONSTARTCLOSE_B__1_OFFSET UNITYSDK_OFFSET(0x185A4F30)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralLoginTopTipsPopWindowController___c__DisplayClass9_0_TypeDefinitionIndex = 44644;
