...
#define MOLEMOLE_UIROULETTECANCELWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175A5A00)
#define MOLEMOLE_UIROULETTECANCELWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x175A5A90)
#define MOLEMOLE_UIROULETTECANCELWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x175A5830)
#define MOLEMOLE_UIROULETTECANCELWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x175A5990)
#define MOLEMOLE_UIROULETTECANCELWIDGETCONTROLLER_SETONCLICKBUTTON_OFFSET UNITYSDK_OFFSET(0x175A5B10)
#define MOLEMOLE_UIROULETTECANCELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x175A5B60)
#define MOLEMOLE_UIROULETTECANCELWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0x175A5BC0)
#define MOLEMOLE_UIROULETTECANCELWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175A5BE0)
#define MOLEMOLE_UIROULETTECANCELWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x175A5C70)
#define MOLEMOLE_UIROULETTECANCELWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x175A5D00)
#define MOLEMOLE_UIROULETTECANCELWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x175A5D90)

namespace MoleMole
{
	inline static constexpr unsigned int UIRouletteCancelWidgetController_TypeDefinitionIndex = 48000;
