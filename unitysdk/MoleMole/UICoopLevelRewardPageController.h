...
#define MOLEMOLE_UICOOPLEVELREWARDPAGECONTROLLER_GET_MODEL_OFFSET UNITYSDK_OFFSET(0x192C0A80)
#define MOLEMOLE_UICOOPLEVELREWARDPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x192C0340)
#define MOLEMOLE_UICOOPLEVELREWARDPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x192C0350)
#define MOLEMOLE_UICOOPLEVELREWARDPAGECONTROLLER_INITEXPITEM_OFFSET UNITYSDK_OFFSET(0x192C0D80)
#define MOLEMOLE_UICOOPLEVELREWARDPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x192C03C0)
#define MOLEMOLE_UICOOPLEVELREWARDPAGECONTROLLER_ONITEMCHANGEHANDLE_OFFSET UNITYSDK_OFFSET(0x192C0540)
#define MOLEMOLE_UICOOPLEVELREWARDPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x192C0460)
#define MOLEMOLE_UICOOPLEVELREWARDPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x192C0B40)
#define MOLEMOLE_UICOOPLEVELREWARDPAGECONTROLLER_SETPROPERTYBYMODELDATA_OFFSET UNITYSDK_OFFSET(0x192C0590)
#define MOLEMOLE_UICOOPLEVELREWARDPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x192C1090)
#define MOLEMOLE_UICOOPLEVELREWARDPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x192C10A0)
#define MOLEMOLE_UICOOPLEVELREWARDPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x192C1140)
#define MOLEMOLE_UICOOPLEVELREWARDPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x192C1150)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopLevelRewardPageController_TypeDefinitionIndex = 58530;
	...
	public:
		...
		{
			return ((::Class_2_C66E4DE78E6562C8*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UICOOPLEVELREWARDPAGECONTROLLER_GET_MODEL_OFFSET))(this);
		}
