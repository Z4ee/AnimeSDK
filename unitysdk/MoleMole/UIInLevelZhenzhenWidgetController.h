...
#define MOLEMOLE_UIINLEVELZHENZHENWIDGETCONTROLLER_DOREFRESHITEMSHOWSTATE_OFFSET UNITYSDK_OFFSET(0x188C4030)
#define MOLEMOLE_UIINLEVELZHENZHENWIDGETCONTROLLER_GET_ISBREATHING_OFFSET UNITYSDK_OFFSET(0x188C3E40)
#define MOLEMOLE_UIINLEVELZHENZHENWIDGETCONTROLLER_GET_ITEMBREATH_OFFSET UNITYSDK_OFFSET(0x188C3D70)
#define MOLEMOLE_UIINLEVELZHENZHENWIDGETCONTROLLER_GET_ITEMFADEIN_OFFSET UNITYSDK_OFFSET(0x188C3CE0)
#define MOLEMOLE_UIINLEVELZHENZHENWIDGETCONTROLLER_GET_ITEMFADEOUT_OFFSET UNITYSDK_OFFSET(0x188C3D30)
#define MOLEMOLE_UIINLEVELZHENZHENWIDGETCONTROLLER_GET_ITEMLOOP_OFFSET UNITYSDK_OFFSET(0x188C3D20)
#define MOLEMOLE_UIINLEVELZHENZHENWIDGETCONTROLLER_GET_LIGHTUPANIM_OFFSET UNITYSDK_OFFSET(0x188C3E00)
#define MOLEMOLE_UIINLEVELZHENZHENWIDGETCONTROLLER_GET_LIGHTUPGO_OFFSET UNITYSDK_OFFSET(0x188C3DD0)
#define MOLEMOLE_UIINLEVELZHENZHENWIDGETCONTROLLER_GET_MAXANIM_OFFSET UNITYSDK_OFFSET(0x188C3E30)
#define MOLEMOLE_UIINLEVELZHENZHENWIDGETCONTROLLER_GET_POINTMAXFADEIN_OFFSET UNITYSDK_OFFSET(0x188C3DB0)
#define MOLEMOLE_UIINLEVELZHENZHENWIDGETCONTROLLER_GET_POINTMAXFADEOUT_OFFSET UNITYSDK_OFFSET(0x188C3DC0)
#define MOLEMOLE_UIINLEVELZHENZHENWIDGETCONTROLLER_GET_ROOTANIM_OFFSET UNITYSDK_OFFSET(0x188C20A0)
#define MOLEMOLE_UIINLEVELZHENZHENWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x188C3F20)
#define MOLEMOLE_UIINLEVELZHENZHENWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x188C3FB0)
#define MOLEMOLE_UIINLEVELZHENZHENWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x188C3E50)
#define MOLEMOLE_UIINLEVELZHENZHENWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x188C3EB0)
#define MOLEMOLE_UIINLEVELZHENZHENWIDGETCONTROLLER_SET_ISBREATHING_OFFSET UNITYSDK_OFFSET(0x188C33E0)
#define MOLEMOLE_UIINLEVELZHENZHENWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x188C4120)
#define MOLEMOLE_UIINLEVELZHENZHENWIDGETCONTROLLER___BASE_DOREFRESHITEMSHOWSTATE_OFFSET UNITYSDK_OFFSET(0x188C4330)
#define MOLEMOLE_UIINLEVELZHENZHENWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x188C4340)
#define MOLEMOLE_UIINLEVELZHENZHENWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x188C4180)
#define MOLEMOLE_UIINLEVELZHENZHENWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x188C4210)
#define MOLEMOLE_UIINLEVELZHENZHENWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x188C42A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelZhenzhenWidgetController_TypeDefinitionIndex = 45992;
