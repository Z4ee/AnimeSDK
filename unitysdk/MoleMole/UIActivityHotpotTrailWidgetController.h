...
#define MOLEMOLE_UIACTIVITYHOTPOTTRAILWIDGETCONTROLLER_CLOSESELF_OFFSET UNITYSDK_OFFSET(0x12B4B3C0)
#define MOLEMOLE_UIACTIVITYHOTPOTTRAILWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12B4B480)
#define MOLEMOLE_UIACTIVITYHOTPOTTRAILWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x12B4B510)
#define MOLEMOLE_UIACTIVITYHOTPOTTRAILWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12B4B8D0)
#define MOLEMOLE_UIACTIVITYHOTPOTTRAILWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12B4B0F0)
#define MOLEMOLE_UIACTIVITYHOTPOTTRAILWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12B4B410)
#define MOLEMOLE_UIACTIVITYHOTPOTTRAILWIDGETCONTROLLER_SAMPLE_OFFSET UNITYSDK_OFFSET(0x12B4B950)
#define MOLEMOLE_UIACTIVITYHOTPOTTRAILWIDGETCONTROLLER_SETHIGHORLOW_OFFSET UNITYSDK_OFFSET(0x12B4B7E0)
#define MOLEMOLE_UIACTIVITYHOTPOTTRAILWIDGETCONTROLLER_SETWIDTH_OFFSET UNITYSDK_OFFSET(0x12B4BA60)
#define MOLEMOLE_UIACTIVITYHOTPOTTRAILWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12B4BB10)
#define MOLEMOLE_UIACTIVITYHOTPOTTRAILWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12B4BBB0)
#define MOLEMOLE_UIACTIVITYHOTPOTTRAILWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x12B4BC40)
#define MOLEMOLE_UIACTIVITYHOTPOTTRAILWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12B4BCE0)
#define MOLEMOLE_UIACTIVITYHOTPOTTRAILWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12B4BD70)
#define MOLEMOLE_UIACTIVITYHOTPOTTRAILWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12B4BE00)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityHotpotTrailWidgetController_TypeDefinitionIndex = 74071;

	class UIActivityHotpotTrailWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_759F9F5E10B92499* _view; // 0x2B8
		::System::String* animKey; // 0x2C0
