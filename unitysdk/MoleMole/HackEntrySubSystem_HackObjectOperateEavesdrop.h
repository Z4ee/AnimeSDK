...
#define MOLEMOLE_HACKENTRYSUBSYSTEM_HACKOBJECTOPERATEEAVESDROP_DEALLOCATE_OFFSET UNITYSDK_OFFSET(0x161F4940)
#define MOLEMOLE_HACKENTRYSUBSYSTEM_HACKOBJECTOPERATEEAVESDROP__CTOR_OFFSET UNITYSDK_OFFSET(0x161F49D0)
#define MOLEMOLE_HACKENTRYSUBSYSTEM_HACKOBJECTOPERATEEAVESDROP___BASE_DEALLOCATE_OFFSET UNITYSDK_OFFSET(0x161F49E0)

namespace MoleMole
{
	inline static constexpr unsigned int HackEntrySubSystem_HackObjectOperateEavesdrop_TypeDefinitionIndex = 83313;
