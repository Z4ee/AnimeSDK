...
#define MOLEMOLE_MONOEFFECTPLUGINPROGRAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x11638D30)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginProgramConfig_TypeDefinitionIndex = 60227;
