...
#define MOLEMOLE_AFTERALLPOPUP_GET_ISBLOCKCENTER_OFFSET UNITYSDK_OFFSET(0x106AAA30)
#define MOLEMOLE_AFTERALLPOPUP_GET_ISTRIGGERINLOADING_OFFSET UNITYSDK_OFFSET(0x106AAA50)
#define MOLEMOLE_AFTERALLPOPUP_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x106AAA40)
#define MOLEMOLE_AFTERALLPOPUP_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x106AAA90)
#define MOLEMOLE_AFTERALLPOPUP__CTOR_OFFSET UNITYSDK_OFFSET(0x106AAA60)

namespace MoleMole
{
	inline static constexpr unsigned int AfterAllPopup_TypeDefinitionIndex = 81002;
