...
#define MOLEMOLE_DICEROTADJUSTER_METHOD_5_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0x1A00F890)
#define MOLEMOLE_DICEROTADJUSTER_METHOD_5_7E015B837E1981C0_OFFSET UNITYSDK_OFFSET(0x1A00FB70)
#define MOLEMOLE_DICEROTADJUSTER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A00F5C0)
#define MOLEMOLE_DICEROTADJUSTER_SETCTRLDICERESULT_OFFSET UNITYSDK_OFFSET(0x1A00F7E0)
#define MOLEMOLE_DICEROTADJUSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A010120)

namespace MoleMole
{
	inline static constexpr unsigned int DiceRotAdjuster_TypeDefinitionIndex = 82930;
