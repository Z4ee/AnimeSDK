...
#define MOLEMOLE_UIPLAYERSKINSWITCHROLECARDWIDGETCONTROLLER_GET_MODEL_OFFSET UNITYSDK_OFFSET(0x1695EC10)
#define MOLEMOLE_UIPLAYERSKINSWITCHROLECARDWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x1695EBB0)
#define MOLEMOLE_UIPLAYERSKINSWITCHROLECARDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1695ECD0)
#define MOLEMOLE_UIPLAYERSKINSWITCHROLECARDWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x1695F4D0)
#define MOLEMOLE_UIPLAYERSKINSWITCHROLECARDWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1695EDE0)
#define MOLEMOLE_UIPLAYERSKINSWITCHROLECARDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1695ED60)
#define MOLEMOLE_UIPLAYERSKINSWITCHROLECARDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1695EA00)
#define MOLEMOLE_UIPLAYERSKINSWITCHROLECARDWIDGETCONTROLLER_REFRESHBYUICONTEXT_1_OFFSET UNITYSDK_OFFSET(0x1695F1B0)
#define MOLEMOLE_UIPLAYERSKINSWITCHROLECARDWIDGETCONTROLLER_REFRESHBYUICONTEXT_OFFSET UNITYSDK_OFFSET(0x1695EEE0)
#define MOLEMOLE_UIPLAYERSKINSWITCHROLECARDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1695F580)
#define MOLEMOLE_UIPLAYERSKINSWITCHROLECARDWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x1695F590)
#define MOLEMOLE_UIPLAYERSKINSWITCHROLECARDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1695F5A0)
#define MOLEMOLE_UIPLAYERSKINSWITCHROLECARDWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x1695F630)
#define MOLEMOLE_UIPLAYERSKINSWITCHROLECARDWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1695F6C0)
#define MOLEMOLE_UIPLAYERSKINSWITCHROLECARDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1695F760)
#define MOLEMOLE_UIPLAYERSKINSWITCHROLECARDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1695F7F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPlayerSkinSwitchRoleCardWidgetController_TypeDefinitionIndex = 67407;

	class UIPlayerSkinSwitchRoleCardWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_217* _view; // 0x2F0
		...
		{
			return ((::Class_2_F4C32234518D6B43*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIPLAYERSKINSWITCHROLECARDWIDGETCONTROLLER_GET_MODEL_OFFSET))(this);
		}
