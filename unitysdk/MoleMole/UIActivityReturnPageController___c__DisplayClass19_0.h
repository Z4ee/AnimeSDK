...
#define MOLEMOLE_UIACTIVITYRETURNPAGECONTROLLER___C__DISPLAYCLASS19_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6F1A10)
#define MOLEMOLE_UIACTIVITYRETURNPAGECONTROLLER___C__DISPLAYCLASS19_0__PLAYTRAILVIDEO_B__0_OFFSET UNITYSDK_OFFSET(0x1B6F1A20)
#define MOLEMOLE_UIACTIVITYRETURNPAGECONTROLLER___C__DISPLAYCLASS19_0__PLAYTRAILVIDEO_B__1_OFFSET UNITYSDK_OFFSET(0x1B6F1A70)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityReturnPageController___c__DisplayClass19_0_TypeDefinitionIndex = 73189;
