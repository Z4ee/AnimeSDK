...
#define MOLEMOLE_UIACTIVITYTEAMTRIALWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x173D9F50)
#define MOLEMOLE_UIACTIVITYTEAMTRIALWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x173D9750)
#define MOLEMOLE_UIACTIVITYTEAMTRIALWIDGETCONTROLLER_ONFADEINFINISH_OFFSET UNITYSDK_OFFSET(0x173DA030)
#define MOLEMOLE_UIACTIVITYTEAMTRIALWIDGETCONTROLLER_ONSELECTQUEST_OFFSET UNITYSDK_OFFSET(0x173DA770)
#define MOLEMOLE_UIACTIVITYTEAMTRIALWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x173D98D0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x173D9950)
#define MOLEMOLE_UIACTIVITYTEAMTRIALWIDGETCONTROLLER_REFRESHWIDGET_OFFSET UNITYSDK_OFFSET(0x173D9A40)
#define MOLEMOLE_UIACTIVITYTEAMTRIALWIDGETCONTROLLER_TRYPLAYUNLOCKANIM_OFFSET UNITYSDK_OFFSET(0x173DA2C0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALWIDGETCONTROLLER_UNLOCKANIMFINISH_OFFSET UNITYSDK_OFFSET(0x173DA720)
#define MOLEMOLE_UIACTIVITYTEAMTRIALWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x173DAA40)
#define MOLEMOLE_UIACTIVITYTEAMTRIALWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x173DAB60)
#define MOLEMOLE_UIACTIVITYTEAMTRIALWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x173DABF0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x173DAC80)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityTeamTrialWidgetController_TypeDefinitionIndex = 72795;

	class UIActivityTeamTrialWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_DEED5AAD1F9518EE_1* _view; // 0x2C0
