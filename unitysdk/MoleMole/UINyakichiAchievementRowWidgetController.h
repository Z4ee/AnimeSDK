...
#define MOLEMOLE_UINYAKICHIACHIEVEMENTROWWIDGETCONTROLLER_ONCLICK_OFFSET UNITYSDK_OFFSET(0x14D582B0)
#define MOLEMOLE_UINYAKICHIACHIEVEMENTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14D581A0)
#define MOLEMOLE_UINYAKICHIACHIEVEMENTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14D58230)
#define MOLEMOLE_UINYAKICHIACHIEVEMENTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14D57FD0)
#define MOLEMOLE_UINYAKICHIACHIEVEMENTROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14D58130)
#define MOLEMOLE_UINYAKICHIACHIEVEMENTROWWIDGETCONTROLLER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0x14D58850)
#define MOLEMOLE_UINYAKICHIACHIEVEMENTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14D58C00)
#define MOLEMOLE_UINYAKICHIACHIEVEMENTROWWIDGETCONTROLLER__ONCLICK_B__5_0_OFFSET UNITYSDK_OFFSET(0x14D58C60)
#define MOLEMOLE_UINYAKICHIACHIEVEMENTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14D58DC0)
#define MOLEMOLE_UINYAKICHIACHIEVEMENTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14D58E50)
#define MOLEMOLE_UINYAKICHIACHIEVEMENTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14D58EE0)
#define MOLEMOLE_UINYAKICHIACHIEVEMENTROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14D58F70)

namespace MoleMole
{
	inline static constexpr unsigned int UINyakichiAchievementRowWidgetController_TypeDefinitionIndex = 46920;

	class UINyakichiAchievementRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_071490F73A72357F* _view; // 0x2B8
		::System::Int32 questID; // 0x2C0
