...
#define MOLEMOLE_AFTERIMAGEOBJECT_AWAKE_OFFSET UNITYSDK_OFFSET(0xF95AFA0)
#define MOLEMOLE_AFTERIMAGEOBJECT_BEGINBLURSHADOW_OFFSET UNITYSDK_OFFSET(0xF95B030)
#define MOLEMOLE_AFTERIMAGEOBJECT_METHOD_5_102A1038C38883F3_OFFSET UNITYSDK_OFFSET(0xF95B9B0)
#define MOLEMOLE_AFTERIMAGEOBJECT_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0xF95B7F0)
#define MOLEMOLE_AFTERIMAGEOBJECT_METHOD_5_3A158F2DBB2E47FE_OFFSET UNITYSDK_OFFSET(0xF95B260)
#define MOLEMOLE_AFTERIMAGEOBJECT_METHOD_5_F5E47CC27E96B888_OFFSET UNITYSDK_OFFSET(0xF95BC50)
#define MOLEMOLE_AFTERIMAGEOBJECT_METHOD_5_F655FFE0347E3008_OFFSET UNITYSDK_OFFSET(0xF95BCD0)
#define MOLEMOLE_AFTERIMAGEOBJECT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xF95BA00)
#define MOLEMOLE_AFTERIMAGEOBJECT_STOPBLURSHADOW_OFFSET UNITYSDK_OFFSET(0xF95B6D0)
#define MOLEMOLE_AFTERIMAGEOBJECT_UPDATE_OFFSET UNITYSDK_OFFSET(0xF95B8C0)
#define MOLEMOLE_AFTERIMAGEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xF95BC00)

namespace MoleMole
{
	inline static constexpr unsigned int AfterImageObject_TypeDefinitionIndex = 82473;
