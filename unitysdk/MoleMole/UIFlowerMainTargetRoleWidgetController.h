...
#define MOLEMOLE_UIFLOWERMAINTARGETROLEWIDGETCONTROLLER_BINDBUTTON_OFFSET UNITYSDK_OFFSET(0x17A77D30)
#define MOLEMOLE_UIFLOWERMAINTARGETROLEWIDGETCONTROLLER_BUILDDATABINDING_OFFSET UNITYSDK_OFFSET(0x17A78150)
#define MOLEMOLE_UIFLOWERMAINTARGETROLEWIDGETCONTROLLER_BUILDVIEWMODELDATABINDING_OFFSET UNITYSDK_OFFSET(0x17A77E50)
#define MOLEMOLE_UIFLOWERMAINTARGETROLEWIDGETCONTROLLER_CREATESUBWIDGET_OFFSET UNITYSDK_OFFSET(0x17A77D70)
#define MOLEMOLE_UIFLOWERMAINTARGETROLEWIDGETCONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x17A78300)
#define MOLEMOLE_UIFLOWERMAINTARGETROLEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17A78270)
#define MOLEMOLE_UIFLOWERMAINTARGETROLEWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17A77EC0)
#define MOLEMOLE_UIFLOWERMAINTARGETROLEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17A783C0)
#define MOLEMOLE_UIFLOWERMAINTARGETROLEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17A77C30)
#define MOLEMOLE_UIFLOWERMAINTARGETROLEWIDGETCONTROLLER_SHOWSUBWIDGET_OFFSET UNITYSDK_OFFSET(0x17A77FB0)
#define MOLEMOLE_UIFLOWERMAINTARGETROLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17A78440)
#define MOLEMOLE_UIFLOWERMAINTARGETROLEWIDGETCONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x17A784A0)
#define MOLEMOLE_UIFLOWERMAINTARGETROLEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17A78530)
#define MOLEMOLE_UIFLOWERMAINTARGETROLEWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17A785C0)
#define MOLEMOLE_UIFLOWERMAINTARGETROLEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17A78660)
#define MOLEMOLE_UIFLOWERMAINTARGETROLEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17A786F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerMainTargetRoleWidgetController_TypeDefinitionIndex = 65012;
