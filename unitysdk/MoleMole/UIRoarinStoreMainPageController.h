...
#define MOLEMOLE_UIROARINSTOREMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x14C86B80)
#define MOLEMOLE_UIROARINSTOREMAINPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x14C86B90)
#define MOLEMOLE_UIROARINSTOREMAINPAGECONTROLLER_ONBEFOREPLAYANIMATION_OFFSET UNITYSDK_OFFSET(0x14C86DE0)
#define MOLEMOLE_UIROARINSTOREMAINPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x14C86C00)
#define MOLEMOLE_UIROARINSTOREMAINPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14C86CA0)
#define MOLEMOLE_UIROARINSTOREMAINPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x14C86D50)
#define MOLEMOLE_UIROARINSTOREMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14C86F20)
#define MOLEMOLE_UIROARINSTOREMAINPAGECONTROLLER___BASE_ONBEFOREPLAYANIMATION_OFFSET UNITYSDK_OFFSET(0x14C86F30)
#define MOLEMOLE_UIROARINSTOREMAINPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x14C86FD0)
#define MOLEMOLE_UIROARINSTOREMAINPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14C87070)
#define MOLEMOLE_UIROARINSTOREMAINPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x14C87080)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoarinStoreMainPageController_TypeDefinitionIndex = 42826;
