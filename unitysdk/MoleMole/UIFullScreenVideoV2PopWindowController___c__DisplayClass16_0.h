...
#define MOLEMOLE_UIFULLSCREENVIDEOV2POPWINDOWCONTROLLER___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17633790)
#define MOLEMOLE_UIFULLSCREENVIDEOV2POPWINDOWCONTROLLER___C__DISPLAYCLASS16_0__TRYPLAY_B__0_OFFSET UNITYSDK_OFFSET(0x176337A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFullScreenVideoV2PopWindowController___c__DisplayClass16_0_TypeDefinitionIndex = 87132;
	...
	public:
		...
		::System::Action* prepareFinished; // 0x20
