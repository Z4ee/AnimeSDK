...
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_APPLYKEYBINDING_OFFSET UNITYSDK_OFFSET(0x17BD20A0)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_CHECKDPADCOMBOCONFLICT_OFFSET UNITYSDK_OFFSET(0x17BD28E0)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_DOTRYKEYBINDING_OFFSET UNITYSDK_OFFSET(0x17BD13F0)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_GETDPADCONFLICTTEXTPARAM_OFFSET UNITYSDK_OFFSET(0x17BD2690)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x17BCF110)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x17BCF100)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x17BCF290)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x17BCF920)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17BCF6E0)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17BCF770)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17BCF800)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17BCF120)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_POSTCHECKGAMEPADCOMBOKEYBINDINGVALID_OFFSET UNITYSDK_OFFSET(0x17BD1B00)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_TICKKEYBINDING_OFFSET UNITYSDK_OFFSET(0x17BD0110)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_TRYKEYBINDING_OFFSET UNITYSDK_OFFSET(0x17BD0E70)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_UNBINDKEY_OFFSET UNITYSDK_OFFSET(0x17BCFCD0)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17BD2B40)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER__UNBINDKEY_B__11_0_OFFSET UNITYSDK_OFFSET(0x17BD2B50)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER__UNBINDKEY_B__11_1_OFFSET UNITYSDK_OFFSET(0x17BD2F70)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17BD2F80)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17BD3010)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17BD30D0)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17BD30E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralKeyBindingsTipsPopWindowController_TypeDefinitionIndex = 84297;

	class UIGeneralKeyBindingsTipsPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_754022533D501C3E_14* _view; // 0x318
		::MoleMole::UIKeyBindingContext* _context; // 0x320
		::Enum_3_A019F766F8C74696 _inputDevice; // 0x328
		::MoleMole::LogicButtonInputType _logicButtonType; // 0x32C
		::Enum_3_7FA27888FA17A22A _settingContentType; // 0x330
		::System::Boolean _isListenInput; // 0x334
		::System::Boolean _isEnableUpdate; // 0x335
