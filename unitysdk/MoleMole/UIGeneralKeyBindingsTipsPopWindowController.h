...
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_APPLYKEYBINDING_OFFSET UNITYSDK_OFFSET(0x177E9920)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_CHECKDPADCOMBOCONFLICT_OFFSET UNITYSDK_OFFSET(0x177EA160)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_DOTRYKEYBINDING_OFFSET UNITYSDK_OFFSET(0x177E8C60)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_GETDPADCONFLICTTEXTPARAM_OFFSET UNITYSDK_OFFSET(0x177E9F10)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x177E65E0)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x177E65D0)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x177E6760)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x177E6E00)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x177E6BC0)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x177E6C50)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x177E6CE0)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x177E65F0)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_POSTCHECKGAMEPADCOMBOKEYBINDINGVALID_OFFSET UNITYSDK_OFFSET(0x177E9370)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_TICKKEYBINDING_OFFSET UNITYSDK_OFFSET(0x177E7600)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_TRYKEYBINDING_OFFSET UNITYSDK_OFFSET(0x177E86E0)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER_UNBINDKEY_OFFSET UNITYSDK_OFFSET(0x177E71B0)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x177EA3D0)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER__UNBINDKEY_B__11_0_OFFSET UNITYSDK_OFFSET(0x177EA3E0)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER__UNBINDKEY_B__11_1_OFFSET UNITYSDK_OFFSET(0x177EA800)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x177EA810)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x177EA8A0)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x177EA960)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x177EA970)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralKeyBindingsTipsPopWindowController_TypeDefinitionIndex = 81804;

	class UIGeneralKeyBindingsTipsPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_754022533D501C3E_15* _view; // 0x318
		...
		::Enum_3_54486B88E1863A04 _settingContentType; // 0x330
