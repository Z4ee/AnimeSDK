...
#define MOLEMOLE_UIABYSSMAPICONBASECONTROLLER_SETAFFIXICON_OFFSET UNITYSDK_OFFSET(0x11D877F0)
#define MOLEMOLE_UIABYSSMAPICONBASECONTROLLER_SETICON_OFFSET UNITYSDK_OFFSET(0x11D87730)
#define MOLEMOLE_UIABYSSMAPICONBASECONTROLLER_SETMUTEICONINTERNAL_OFFSET UNITYSDK_OFFSET(0x11D87850)
#define MOLEMOLE_UIABYSSMAPICONBASECONTROLLER_SETMUTEICON_OFFSET UNITYSDK_OFFSET(0x11D87790)
#define MOLEMOLE_UIABYSSMAPICONBASECONTROLLER_SWITCHSTYLE_OFFSET UNITYSDK_OFFSET(0x11D876B0)
#define MOLEMOLE_UIABYSSMAPICONBASECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11D87410)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssMapIconBaseController_TypeDefinitionIndex = 82686;

	class UIAbyssMapIconBaseController : public ::MoleMole::UIWidgetController
	{
	public:
		::MoleMole::UIAbyssMapIconBaseController_Style _style; // 0x2C0
