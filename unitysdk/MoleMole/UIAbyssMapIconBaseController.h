...
#define MOLEMOLE_UIABYSSMAPICONBASECONTROLLER_SETAFFIXICON_OFFSET UNITYSDK_OFFSET(0x183AE920)
#define MOLEMOLE_UIABYSSMAPICONBASECONTROLLER_SETICON_OFFSET UNITYSDK_OFFSET(0x183AE860)
#define MOLEMOLE_UIABYSSMAPICONBASECONTROLLER_SETMUTEICONINTERNAL_OFFSET UNITYSDK_OFFSET(0x183AE980)
#define MOLEMOLE_UIABYSSMAPICONBASECONTROLLER_SETMUTEICON_OFFSET UNITYSDK_OFFSET(0x183AE8C0)
#define MOLEMOLE_UIABYSSMAPICONBASECONTROLLER_SWITCHSTYLE_OFFSET UNITYSDK_OFFSET(0x183AE7E0)
#define MOLEMOLE_UIABYSSMAPICONBASECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x183AE540)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssMapIconBaseController_TypeDefinitionIndex = 60266;
