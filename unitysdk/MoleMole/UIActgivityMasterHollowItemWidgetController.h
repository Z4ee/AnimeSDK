...
#define MOLEMOLE_UIACTGIVITYMASTERHOLLOWITEMWIDGETCONTROLLER_ONCLICKJUMP_OFFSET UNITYSDK_OFFSET(0x158781B0)
#define MOLEMOLE_UIACTGIVITYMASTERHOLLOWITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15877F40)
#define MOLEMOLE_UIACTGIVITYMASTERHOLLOWITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15877FD0)
#define MOLEMOLE_UIACTGIVITYMASTERHOLLOWITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15877E70)
#define MOLEMOLE_UIACTGIVITYMASTERHOLLOWITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15877ED0)
#define MOLEMOLE_UIACTGIVITYMASTERHOLLOWITEMWIDGETCONTROLLER_SETREFACTIVITYTASK_OFFSET UNITYSDK_OFFSET(0x15878050)
#define MOLEMOLE_UIACTGIVITYMASTERHOLLOWITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15878240)
#define MOLEMOLE_UIACTGIVITYMASTERHOLLOWITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x158782A0)
#define MOLEMOLE_UIACTGIVITYMASTERHOLLOWITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15878330)
#define MOLEMOLE_UIACTGIVITYMASTERHOLLOWITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x158783C0)
#define MOLEMOLE_UIACTGIVITYMASTERHOLLOWITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15878450)

namespace MoleMole
{
	inline static constexpr unsigned int UIActgivityMasterHollowItemWidgetController_TypeDefinitionIndex = 43627;

	class UIActgivityMasterHollowItemWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_8533A19858ADADCC* _view; // 0x2B8
