...
#define MOLEMOLE_COMMANDLINEMOTIONBLUR_METHOD_2_3807E61C224E8F21_OFFSET UNITYSDK_OFFSET(0x1A055760)
#define MOLEMOLE_COMMANDLINEMOTIONBLUR_METHOD_2_8478238C93615013_OFFSET UNITYSDK_OFFSET(0x1A055870)
#define MOLEMOLE_COMMANDLINEMOTIONBLUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A055830)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineMotionBlur_TypeDefinitionIndex = 78741;
