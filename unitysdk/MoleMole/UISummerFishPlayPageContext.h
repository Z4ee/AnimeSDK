...
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x12E3BB90)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerFishPlayPageContext_TypeDefinitionIndex = 73567;
