...
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x12C77100)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerFishPlayPageContext_TypeDefinitionIndex = 77957;
