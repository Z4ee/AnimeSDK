...
#define MOLEMOLE_UIOVERLORDFEASTDISHITEMWIDGETCONTROLLER_BEGINDRAGCALLBACK_OFFSET UNITYSDK_OFFSET(0x15F4FCD0)
#define MOLEMOLE_UIOVERLORDFEASTDISHITEMWIDGETCONTROLLER_CLEARPRESSED_OFFSET UNITYSDK_OFFSET(0x15F4FB10)
#define MOLEMOLE_UIOVERLORDFEASTDISHITEMWIDGETCONTROLLER_DRAGCALLBACK_OFFSET UNITYSDK_OFFSET(0x15F4FE10)
#define MOLEMOLE_UIOVERLORDFEASTDISHITEMWIDGETCONTROLLER_ENDDRAGCALLBACK_OFFSET UNITYSDK_OFFSET(0x15F4FFC0)
#define MOLEMOLE_UIOVERLORDFEASTDISHITEMWIDGETCONTROLLER_GETINDEX_OFFSET UNITYSDK_OFFSET(0x15F4FAC0)
#define MOLEMOLE_UIOVERLORDFEASTDISHITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15F4EEE0)
#define MOLEMOLE_UIOVERLORDFEASTDISHITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15F4F0B0)
#define MOLEMOLE_UIOVERLORDFEASTDISHITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15F4EF70)
#define MOLEMOLE_UIOVERLORDFEASTDISHITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15F4EB10)
#define MOLEMOLE_UIOVERLORDFEASTDISHITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15F4EE70)
#define MOLEMOLE_UIOVERLORDFEASTDISHITEMWIDGETCONTROLLER_PLAYCANNOTSELECTANIM_OFFSET UNITYSDK_OFFSET(0x15F4FB60)
#define MOLEMOLE_UIOVERLORDFEASTDISHITEMWIDGETCONTROLLER_PLAYFOCUSANIM_OFFSET UNITYSDK_OFFSET(0x15F4FC30)
#define MOLEMOLE_UIOVERLORDFEASTDISHITEMWIDGETCONTROLLER_REFRESHUSEDTAG_OFFSET UNITYSDK_OFFSET(0x15F4F800)
#define MOLEMOLE_UIOVERLORDFEASTDISHITEMWIDGETCONTROLLER_SETONDRAGFUNC_OFFSET UNITYSDK_OFFSET(0x15F4FA70)
#define MOLEMOLE_UIOVERLORDFEASTDISHITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15F50050)
#define MOLEMOLE_UIOVERLORDFEASTDISHITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15F50060)
#define MOLEMOLE_UIOVERLORDFEASTDISHITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15F500F0)
#define MOLEMOLE_UIOVERLORDFEASTDISHITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15F50190)
#define MOLEMOLE_UIOVERLORDFEASTDISHITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15F50220)
#define MOLEMOLE_UIOVERLORDFEASTDISHITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15F502B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastDishItemWidgetController_TypeDefinitionIndex = 62733;
	...
	public:
		...
		::Class_2_208CC9941471731A_1114* _template; // 0x318
