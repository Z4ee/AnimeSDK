...
#define MOLEMOLE_CAMERACHANGETYPE_LINER__CTOR_OFFSET UNITYSDK_OFFSET(0x14355FE0)

namespace MoleMole
{
	inline static constexpr unsigned int CameraChangeType_Liner_TypeDefinitionIndex = 73574;
