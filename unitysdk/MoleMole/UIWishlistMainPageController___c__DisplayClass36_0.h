...
#define MOLEMOLE_UIWISHLISTMAINPAGECONTROLLER___C__DISPLAYCLASS36_0__CTOR_OFFSET UNITYSDK_OFFSET(0x11BDF350)
#define MOLEMOLE_UIWISHLISTMAINPAGECONTROLLER___C__DISPLAYCLASS36_0__SHOWSKILLLEVELUPPROCESS_B__0_OFFSET UNITYSDK_OFFSET(0x11BDF360)
#define MOLEMOLE_UIWISHLISTMAINPAGECONTROLLER___C__DISPLAYCLASS36_0__SHOWSKILLLEVELUPPROCESS_B__1_OFFSET UNITYSDK_OFFSET(0x11BDF3B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWishlistMainPageController___c__DisplayClass36_0_TypeDefinitionIndex = 75931;
