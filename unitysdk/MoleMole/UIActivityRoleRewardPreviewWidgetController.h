...
#define MOLEMOLE_UIACTIVITYROLEREWARDPREVIEWWIDGETCONTROLLER_ONCLICKPREVIEWAVATAR_OFFSET UNITYSDK_OFFSET(0x17E28410)
#define MOLEMOLE_UIACTIVITYROLEREWARDPREVIEWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17E27620)
#define MOLEMOLE_UIACTIVITYROLEREWARDPREVIEWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17E276B0)
#define MOLEMOLE_UIACTIVITYROLEREWARDPREVIEWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17E27400)
#define MOLEMOLE_UIACTIVITYROLEREWARDPREVIEWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17E275B0)
#define MOLEMOLE_UIACTIVITYROLEREWARDPREVIEWWIDGETCONTROLLER_RESETIMGACTIVE_OFFSET UNITYSDK_OFFSET(0x17E27730)
#define MOLEMOLE_UIACTIVITYROLEREWARDPREVIEWWIDGETCONTROLLER_SETPREVIEWBANGBOO_OFFSET UNITYSDK_OFFSET(0x17E27CC0)
#define MOLEMOLE_UIACTIVITYROLEREWARDPREVIEWWIDGETCONTROLLER_SETPREVIEWROLE_OFFSET UNITYSDK_OFFSET(0x17E27900)
#define MOLEMOLE_UIACTIVITYROLEREWARDPREVIEWWIDGETCONTROLLER_SETPREVIEWWEAPON_OFFSET UNITYSDK_OFFSET(0x17E28000)
#define MOLEMOLE_UIACTIVITYROLEREWARDPREVIEWWIDGETCONTROLLER_SETRECEIVEMASK_OFFSET UNITYSDK_OFFSET(0x17E27890)
#define MOLEMOLE_UIACTIVITYROLEREWARDPREVIEWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17E284A0)
#define MOLEMOLE_UIACTIVITYROLEREWARDPREVIEWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17E28500)
#define MOLEMOLE_UIACTIVITYROLEREWARDPREVIEWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17E28590)
#define MOLEMOLE_UIACTIVITYROLEREWARDPREVIEWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17E28620)
#define MOLEMOLE_UIACTIVITYROLEREWARDPREVIEWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17E286B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityRoleRewardPreviewWidgetController_TypeDefinitionIndex = 62268;

	class UIActivityRoleRewardPreviewWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_114* _view; // 0x2C0
