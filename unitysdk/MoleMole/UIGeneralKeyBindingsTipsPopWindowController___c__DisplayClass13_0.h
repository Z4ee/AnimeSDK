...
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1730F010)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER___C__DISPLAYCLASS13_0__TRYKEYBINDING_B__0_OFFSET UNITYSDK_OFFSET(0x1730F020)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER___C__DISPLAYCLASS13_0__TRYKEYBINDING_B__1_OFFSET UNITYSDK_OFFSET(0x1730F040)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralKeyBindingsTipsPopWindowController___c__DisplayClass13_0_TypeDefinitionIndex = 81805;
