...
#define MOLEMOLE_UIGENERALITEMGETDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x19FAC820)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralItemGetDialogContext_TypeDefinitionIndex = 72520;
