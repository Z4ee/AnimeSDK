...
#define MOLEMOLE_UIMARCELMAPROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x184E43F0)
#define MOLEMOLE_UIMARCELMAPROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x184E4500)
#define MOLEMOLE_UIMARCELMAPROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x184E4480)
#define MOLEMOLE_UIMARCELMAPROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x184E4390)
#define MOLEMOLE_UIMARCELMAPROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x184E4720)
#define MOLEMOLE_UIMARCELMAPROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x184E4730)
#define MOLEMOLE_UIMARCELMAPROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x184E47C0)
#define MOLEMOLE_UIMARCELMAPROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x184E4860)
#define MOLEMOLE_UIMARCELMAPROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x184E48F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMarcelMapRowWidgetController_TypeDefinitionIndex = 85683;

	class UIMarcelMapRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_22FEBBA7FA4D4D4A_7* _view; // 0x2F0
