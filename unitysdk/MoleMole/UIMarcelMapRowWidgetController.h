...
class Class_2_22FEBBA7FA4D4D4A_11;
namespace MoleMole { class UIControlReference; }
namespace System { class Object; }

#define MOLEMOLE_UIMARCELMAPROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17863200)
#define MOLEMOLE_UIMARCELMAPROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17863310)
#define MOLEMOLE_UIMARCELMAPROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17863290)
#define MOLEMOLE_UIMARCELMAPROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x178631A0)
#define MOLEMOLE_UIMARCELMAPROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17863530)
#define MOLEMOLE_UIMARCELMAPROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17863540)
#define MOLEMOLE_UIMARCELMAPROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x178635D0)
#define MOLEMOLE_UIMARCELMAPROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17863670)
#define MOLEMOLE_UIMARCELMAPROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17863700)

namespace MoleMole
{
	inline static constexpr unsigned int UIMarcelMapRowWidgetController_TypeDefinitionIndex = 80093;

	class UIMarcelMapRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_22FEBBA7FA4D4D4A_11* _view; // 0x2F0
