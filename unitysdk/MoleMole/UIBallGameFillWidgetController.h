...
#define MOLEMOLE_UIBALLGAMEFILLWIDGETCONTROLLER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1D09C380)
#define MOLEMOLE_UIBALLGAMEFILLWIDGETCONTROLLER_CONVERTWAVETYPE_OFFSET UNITYSDK_OFFSET(0x1D09C3F0)
#define MOLEMOLE_UIBALLGAMEFILLWIDGETCONTROLLER_ONBALLPITKEYMONSTERKILLED_OFFSET UNITYSDK_OFFSET(0x1D09BC70)
#define MOLEMOLE_UIBALLGAMEFILLWIDGETCONTROLLER_ONBALLPITWAVETIMEUPDATE_OFFSET UNITYSDK_OFFSET(0x1D09B690)
#define MOLEMOLE_UIBALLGAMEFILLWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1D09B570)
#define MOLEMOLE_UIBALLGAMEFILLWIDGETCONTROLLER_ONLEVELRESTART_OFFSET UNITYSDK_OFFSET(0x1D09B8E0)
#define MOLEMOLE_UIBALLGAMEFILLWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1D09B600)
#define MOLEMOLE_UIBALLGAMEFILLWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1D09B220)
#define MOLEMOLE_UIBALLGAMEFILLWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1D09B390)
#define MOLEMOLE_UIBALLGAMEFILLWIDGETCONTROLLER_ONWAVEUPDATE_OFFSET UNITYSDK_OFFSET(0x1D09BAB0)
#define MOLEMOLE_UIBALLGAMEFILLWIDGETCONTROLLER_PLAYFADEOUTANIMATION_OFFSET UNITYSDK_OFFSET(0x1D09C450)
#define MOLEMOLE_UIBALLGAMEFILLWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1D09BE40)
#define MOLEMOLE_UIBALLGAMEFILLWIDGETCONTROLLER_SAMPLEFADEINANIMATION_OFFSET UNITYSDK_OFFSET(0x1D09C5A0)
#define MOLEMOLE_UIBALLGAMEFILLWIDGETCONTROLLER_SETAMOUNT_OFFSET UNITYSDK_OFFSET(0x1D09B7E0)
#define MOLEMOLE_UIBALLGAMEFILLWIDGETCONTROLLER_SETCURRENTWAVE_OFFSET UNITYSDK_OFFSET(0x1D09C6A0)
#define MOLEMOLE_UIBALLGAMEFILLWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D09C6F0)
#define MOLEMOLE_UIBALLGAMEFILLWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1D09C860)
#define MOLEMOLE_UIBALLGAMEFILLWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1D09C8F0)
#define MOLEMOLE_UIBALLGAMEFILLWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1D09C980)
#define MOLEMOLE_UIBALLGAMEFILLWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1D09CA10)

namespace MoleMole
{
	inline static constexpr unsigned int UIBallGameFillWidgetController_TypeDefinitionIndex = 89411;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::Enum_3_F3B35B60B7BAFCAF_2>* sourceViewTypes; // 0x2F0
		...
		::Enum_3_F3B35B60B7BAFCAF_2 ConvertWaveType(::Enum_3_190E3717882702BE_2 type)
		{
			return ((::Enum_3_F3B35B60B7BAFCAF_2(*)(::PVOID, ::Enum_3_190E3717882702BE_2))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBALLGAMEFILLWIDGETCONTROLLER_CONVERTWAVETYPE_OFFSET))(this, type);
		}
