...
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_BUILDMAP_OFFSET UNITYSDK_OFFSET(0x175B1D50)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_CANCELAREAFOCUS_OFFSET UNITYSDK_OFFSET(0x175B4710)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_CREATETEAM_OFFSET UNITYSDK_OFFSET(0x175B2170)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ENABLETEAMLIST_OFFSET UNITYSDK_OFFSET(0x175B4A80)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_FINDAREAGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x175B2CE0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x175B1190)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x175B1180)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_INITGAMEPADNAV_OFFSET UNITYSDK_OFFSET(0x175B22C0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_MOVETOCENTER_OFFSET UNITYSDK_OFFSET(0x175B2F20)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ONCHANGEEXPEITIONDAREA_OFFSET UNITYSDK_OFFSET(0x175B46A0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175B11A0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ONDISPATCHINGAREA_OFFSET UNITYSDK_OFFSET(0x175B3F00)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ONFOCUSAREA_1_OFFSET UNITYSDK_OFFSET(0x175B3E50)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ONFOCUSAREA_OFFSET UNITYSDK_OFFSET(0x175B2510)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ONGAMEPADMODULEDESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x175B2C60)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x175B4990)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ONGAMEPADMODULESELECTINDEXFROMINPUT_OFFSET UNITYSDK_OFFSET(0x175B2BE0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x175B4090)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x175B1A20)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ONSUCCESSDISPATCHING_OFFSET UNITYSDK_OFFSET(0x175B4510)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ONTEMPLEJUMPDATASTORE_OFFSET UNITYSDK_OFFSET(0x175B18D0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x175B2A20)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x175B1230)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_OPENINFOBTN_OFFSET UNITYSDK_OFFSET(0x175B4E60)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_OPENINFO_OFFSET UNITYSDK_OFFSET(0x175B3700)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_OPENTEAMPREVIEW_OFFSET UNITYSDK_OFFSET(0x175B3220)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0x175B5060)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_RESTOREPARAS_OFFSET UNITYSDK_OFFSET(0x175B50B0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_SETTEAMINFO_OFFSET UNITYSDK_OFFSET(0x175B2070)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x175B52E0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x175B5190)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER__ENABLETEAMLIST_B__35_0_OFFSET UNITYSDK_OFFSET(0x175B5560)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER__ONUIINIT_B__18_0_OFFSET UNITYSDK_OFFSET(0x175B52F0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER__ONUIINIT_B__18_1_OFFSET UNITYSDK_OFFSET(0x175B53F0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER__ONUIINIT_B__18_2_OFFSET UNITYSDK_OFFSET(0x175B5400)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER__ONUIINIT_B__18_3_OFFSET UNITYSDK_OFFSET(0x175B5550)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175B5660)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER___BASE_ONGAMEPADMODULEDESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x175B56F0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x175B57A0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER___BASE_ONGAMEPADMODULESELECTINDEXFROMINPUT_OFFSET UNITYSDK_OFFSET(0x175B58E0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x175B5830)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x175B5990)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x175B59A0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x175B59B0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleExpeditionPageController_TypeDefinitionIndex = 62505;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UISuibianTempleExpeditionPageController_TypeDefinitionIndex)->GetStaticField(0xCEF0);
		}
		...
		{
			return ((::Class_1_B890BA8430A32496_Class_1_D8C08C94211C11A1*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_RESTOREPARAS_OFFSET))(this);
		}
