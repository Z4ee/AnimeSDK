...
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER__MOVETOLEVELPROCESS_D__30_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xEBD0020)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER__MOVETOLEVELPROCESS_D__30_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xEBD01E0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER__MOVETOLEVELPROCESS_D__30_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xEBD0240)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER__MOVETOLEVELPROCESS_D__30_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xEBD01F0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER__MOVETOLEVELPROCESS_D__30_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xEBD0010)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER__MOVETOLEVELPROCESS_D__30__CTOR_OFFSET UNITYSDK_OFFSET(0xEBD0000)

namespace MoleMole
{
	inline static constexpr unsigned int UIVirusMainWidgetController__MoveToLevelProcess_d__30_TypeDefinitionIndex = 56886;
