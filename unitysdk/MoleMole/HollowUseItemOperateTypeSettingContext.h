...
#define MOLEMOLE_HOLLOWUSEITEMOPERATETYPESETTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16CB0960)

namespace MoleMole
{
	inline static constexpr unsigned int HollowUseItemOperateTypeSettingContext_TypeDefinitionIndex = 81289;
