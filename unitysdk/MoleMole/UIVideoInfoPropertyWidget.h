...
#define MOLEMOLE_UIVIDEOINFOPROPERTYWIDGET_HIDEALLITEM_OFFSET UNITYSDK_OFFSET(0x188B6830)
#define MOLEMOLE_UIVIDEOINFOPROPERTYWIDGET_REFRESHDAMAGEELEMENTSVIEW_1_OFFSET UNITYSDK_OFFSET(0x188B63D0)
#define MOLEMOLE_UIVIDEOINFOPROPERTYWIDGET_REFRESHDAMAGEELEMENTSVIEW_OFFSET UNITYSDK_OFFSET(0x188B61F0)
#define MOLEMOLE_UIVIDEOINFOPROPERTYWIDGET__CTOR_OFFSET UNITYSDK_OFFSET(0x188B6890)

namespace MoleMole
{
	inline static constexpr unsigned int UIVideoInfoPropertyWidget_TypeDefinitionIndex = 89544;
