...
#define MOLEMOLE_UIVIDEOINFOPROPERTYWIDGET_HIDEALLITEM_OFFSET UNITYSDK_OFFSET(0x1040A880)
#define MOLEMOLE_UIVIDEOINFOPROPERTYWIDGET_REFRESHDAMAGEELEMENTSVIEW_1_OFFSET UNITYSDK_OFFSET(0x1040A420)
#define MOLEMOLE_UIVIDEOINFOPROPERTYWIDGET_REFRESHDAMAGEELEMENTSVIEW_OFFSET UNITYSDK_OFFSET(0x1040A240)
#define MOLEMOLE_UIVIDEOINFOPROPERTYWIDGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1040A8E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVideoInfoPropertyWidget_TypeDefinitionIndex = 46947;
