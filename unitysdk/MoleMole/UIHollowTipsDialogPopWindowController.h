...
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER_BINDDEFAULTOKBTN_OFFSET UNITYSDK_OFFSET(0x167CBEB0)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x167CB2C0)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x167CB2B0)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER_INITHOLLOWITEM_OFFSET UNITYSDK_OFFSET(0x167CB700)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER_INITSWITCHHOLLOWITEM_OFFSET UNITYSDK_OFFSET(0x167CBFD0)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER_MASKCLOSE_OFFSET UNITYSDK_OFFSET(0x167CB540)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x167CB390)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x167CB4B0)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x167CB420)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x167CB2D0)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x167CB320)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER_SETCLOSETRIGGEROKCLICK_OFFSET UNITYSDK_OFFSET(0x167CC640)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER_SETOKCALLBACK_OFFSET UNITYSDK_OFFSET(0x167CC690)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER__BINDDEFAULTOKBTN_B__15_0_OFFSET UNITYSDK_OFFSET(0x167CC6F0)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER__BINDDEFAULTOKBTN_B__15_1_OFFSET UNITYSDK_OFFSET(0x167CC770)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x167CC6E0)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER___BASE_MASKCLOSE_OFFSET UNITYSDK_OFFSET(0x167CCA10)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x167CCAA0)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x167CCB30)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x167CCB60)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x167CCB70)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x167CCB80)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowTipsDialogPopWindowController_TypeDefinitionIndex = 44932;
