...
#define MOLEMOLE_UIINLEVEL_MISSIONINFO_WIDGETCONTROLLER_ISCOULDSHOW_OFFSET UNITYSDK_OFFSET(0x17AC5760)
#define MOLEMOLE_UIINLEVEL_MISSIONINFO_WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17AC5630)
#define MOLEMOLE_UIINLEVEL_MISSIONINFO_WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17AC56E0)
#define MOLEMOLE_UIINLEVEL_MISSIONINFO_WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17AC5500)
#define MOLEMOLE_UIINLEVEL_MISSIONINFO_WIDGETCONTROLLER_SETBYSABDATA_OFFSET UNITYSDK_OFFSET(0x17AC5E50)
#define MOLEMOLE_UIINLEVEL_MISSIONINFO_WIDGETCONTROLLER_SETQUESTBYID_OFFSET UNITYSDK_OFFSET(0x17AC5820)
#define MOLEMOLE_UIINLEVEL_MISSIONINFO_WIDGETCONTROLLER__CHECKCHALLENGEFINISH_OFFSET UNITYSDK_OFFSET(0x17AC5D20)
#define MOLEMOLE_UIINLEVEL_MISSIONINFO_WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17AC61D0)
#define MOLEMOLE_UIINLEVEL_MISSIONINFO_WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17AC6250)
#define MOLEMOLE_UIINLEVEL_MISSIONINFO_WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17AC62E0)
#define MOLEMOLE_UIINLEVEL_MISSIONINFO_WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17AC6370)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevel_MissionInfo_WidgetController_TypeDefinitionIndex = 73961;
