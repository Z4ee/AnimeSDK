...
#define MOLEMOLE_MONOEFFECTPLUGINDESTROY_CLASS_3_19C7D4730AEE4117_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x163FAF60)
#define MOLEMOLE_MONOEFFECTPLUGINDESTROY_CLASS_3_19C7D4730AEE4117_READMEMBER_OFFSET UNITYSDK_OFFSET(0x163FAF70)
#define MOLEMOLE_MONOEFFECTPLUGINDESTROY_CLASS_3_19C7D4730AEE4117_WRITE_OFFSET UNITYSDK_OFFSET(0x163FAFE0)
#define MOLEMOLE_MONOEFFECTPLUGINDESTROY_CLASS_3_19C7D4730AEE4117__CTOR_OFFSET UNITYSDK_OFFSET(0x163FB030)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginDestroy_Class_3_19C7D4730AEE4117_TypeDefinitionIndex = 56032;
