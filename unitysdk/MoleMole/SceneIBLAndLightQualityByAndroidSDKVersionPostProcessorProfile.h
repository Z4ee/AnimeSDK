...
#define MOLEMOLE_SCENEIBLANDLIGHTQUALITYBYANDROIDSDKVERSIONPOSTPROCESSORPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x12FAF500)
#define MOLEMOLE_SCENEIBLANDLIGHTQUALITYBYANDROIDSDKVERSIONPOSTPROCESSORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x12FAF570)
#define MOLEMOLE_SCENEIBLANDLIGHTQUALITYBYANDROIDSDKVERSIONPOSTPROCESSORPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x12FAF580)

namespace MoleMole
{
	inline static constexpr unsigned int SceneIBLAndLightQualityByAndroidSDKVersionPostProcessorProfile_TypeDefinitionIndex = 38029;
