...
#define MOLEMOLE_PS5RAYTRACINGSETTINGENTRY_GETDEFAULTINDEX_OFFSET UNITYSDK_OFFSET(0x1870C220)
#define MOLEMOLE_PS5RAYTRACINGSETTINGENTRY_GETSETTINGCONTROLUNIT_OFFSET UNITYSDK_OFFSET(0x1870C1A0)
#define MOLEMOLE_PS5RAYTRACINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1870C190)
#define MOLEMOLE_PS5RAYTRACINGSETTINGENTRY_GET__ISHIDEDEFAULTINDEX_OFFSET UNITYSDK_OFFSET(0x1870C180)
#define MOLEMOLE_PS5RAYTRACINGSETTINGENTRY_ISDEFAULTENABLED_OFFSET UNITYSDK_OFFSET(0x1870C320)
#define MOLEMOLE_PS5RAYTRACINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1870C6B0)
#define MOLEMOLE_PS5RAYTRACINGSETTINGENTRY___BASE_GETDEFAULTINDEX_OFFSET UNITYSDK_OFFSET(0x1870C750)
#define MOLEMOLE_PS5RAYTRACINGSETTINGENTRY___BASE_GETSETTINGCONTROLUNIT_OFFSET UNITYSDK_OFFSET(0x1870C7E0)

namespace MoleMole
{
	inline static constexpr unsigned int PS5RayTracingSettingEntry_TypeDefinitionIndex = 58145;
