...
#define MOLEMOLE_UISOCIALCIRCLE_ROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x14C8E120)
#define MOLEMOLE_UISOCIALCIRCLE_ROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x14C8E190)
#define MOLEMOLE_UISOCIALCIRCLE_ROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14C8E250)
#define MOLEMOLE_UISOCIALCIRCLE_ROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x14C8E2B0)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircle_RowWidgetController_TypeDefinitionIndex = 72008;
