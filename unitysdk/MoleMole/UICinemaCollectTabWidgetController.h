...
#define MOLEMOLE_UICINEMACOLLECTTABWIDGETCONTROLLER_ONCLICKCOLLECTTAB_OFFSET UNITYSDK_OFFSET(0x19329080)
#define MOLEMOLE_UICINEMACOLLECTTABWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19328800)
#define MOLEMOLE_UICINEMACOLLECTTABWIDGETCONTROLLER_ONITEMRESELECT_OFFSET UNITYSDK_OFFSET(0x193289C0)
#define MOLEMOLE_UICINEMACOLLECTTABWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x19328930)
#define MOLEMOLE_UICINEMACOLLECTTABWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x19328AC0)
#define MOLEMOLE_UICINEMACOLLECTTABWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19328890)
#define MOLEMOLE_UICINEMACOLLECTTABWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19328710)
#define MOLEMOLE_UICINEMACOLLECTTABWIDGETCONTROLLER_REFRESHSTATE_OFFSET UNITYSDK_OFFSET(0x19328D40)
#define MOLEMOLE_UICINEMACOLLECTTABWIDGETCONTROLLER_SETTABSELECTSTATE_OFFSET UNITYSDK_OFFSET(0x19329330)
#define MOLEMOLE_UICINEMACOLLECTTABWIDGETCONTROLLER_SETTABSTATE_OFFSET UNITYSDK_OFFSET(0x19329120)
#define MOLEMOLE_UICINEMACOLLECTTABWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x193293C0)
#define MOLEMOLE_UICINEMACOLLECTTABWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x193293D0)
#define MOLEMOLE_UICINEMACOLLECTTABWIDGETCONTROLLER___BASE_ONITEMRESELECT_OFFSET UNITYSDK_OFFSET(0x19329460)
#define MOLEMOLE_UICINEMACOLLECTTABWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x193294F0)
#define MOLEMOLE_UICINEMACOLLECTTABWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x19329580)
#define MOLEMOLE_UICINEMACOLLECTTABWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19329620)
#define MOLEMOLE_UICINEMACOLLECTTABWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x193296B0)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaCollectTabWidgetController_TypeDefinitionIndex = 73790;
