...
#define MOLEMOLE_MAINCITYQUICKFUNC2KEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x125D2D40)
#define MOLEMOLE_MAINCITYQUICKFUNC2KEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x125D2D50)
#define MOLEMOLE_MAINCITYQUICKFUNC2KEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x125D2D60)

namespace MoleMole
{
	inline static constexpr unsigned int MainCityQuickFunc2KeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 76522;
