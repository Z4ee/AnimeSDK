...
#define MOLEMOLE_UIYOROZUYAAUTOPOPWINDOWCONTROLLER___C__DISPLAYCLASS30_0__CTOR_OFFSET UNITYSDK_OFFSET(0x11A16C50)
#define MOLEMOLE_UIYOROZUYAAUTOPOPWINDOWCONTROLLER___C__DISPLAYCLASS30_0__ONOKCLICKHANDLE_B__0_OFFSET UNITYSDK_OFFSET(0x11A16C60)
#define MOLEMOLE_UIYOROZUYAAUTOPOPWINDOWCONTROLLER___C__DISPLAYCLASS30_0__ONOKCLICKHANDLE_B__1_OFFSET UNITYSDK_OFFSET(0x11A16D90)

namespace MoleMole
{
	inline static constexpr unsigned int UIYorozuyaAutoPopWindowController___c__DisplayClass30_0_TypeDefinitionIndex = 56945;
