...
#define MOLEMOLE_UINORMALSAMPLEPOPWINDOWCONTROLLER_BINDBUTTON_OFFSET UNITYSDK_OFFSET(0x12FD42C0)
#define MOLEMOLE_UINORMALSAMPLEPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x12FD41D0)
#define MOLEMOLE_UINORMALSAMPLEPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12FD4940)
#define MOLEMOLE_UINORMALSAMPLEPOPWINDOWCONTROLLER_ONMODELVALUECHANGE_OFFSET UNITYSDK_OFFSET(0x12FD4AA0)
#define MOLEMOLE_UINORMALSAMPLEPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12FD49D0)
#define MOLEMOLE_UINORMALSAMPLEPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12FD41E0)
#define MOLEMOLE_UINORMALSAMPLEPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12FD4840)
#define MOLEMOLE_UINORMALSAMPLEPOPWINDOWCONTROLLER_REFRESHALLVIEW_OFFSET UNITYSDK_OFFSET(0x12FD47E0)
#define MOLEMOLE_UINORMALSAMPLEPOPWINDOWCONTROLLER_REFRESHITEMICONBTN_OFFSET UNITYSDK_OFFSET(0x12FD4EA0)
#define MOLEMOLE_UINORMALSAMPLEPOPWINDOWCONTROLLER_REFRESHRESULTTEXT_OFFSET UNITYSDK_OFFSET(0x12FD5250)
#define MOLEMOLE_UINORMALSAMPLEPOPWINDOWCONTROLLER_REFRESHTEXT_OFFSET UNITYSDK_OFFSET(0x12FD4B20)
#define MOLEMOLE_UINORMALSAMPLEPOPWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x12FD4A40)
#define MOLEMOLE_UINORMALSAMPLEPOPWINDOWCONTROLLER__BINDBUTTON_B__13_0_OFFSET UNITYSDK_OFFSET(0x12FD5350)
#define MOLEMOLE_UINORMALSAMPLEPOPWINDOWCONTROLLER__BINDBUTTON_B__13_1_OFFSET UNITYSDK_OFFSET(0x12FD5380)
#define MOLEMOLE_UINORMALSAMPLEPOPWINDOWCONTROLLER__BINDBUTTON_B__13_2_OFFSET UNITYSDK_OFFSET(0x12FD53E0)
#define MOLEMOLE_UINORMALSAMPLEPOPWINDOWCONTROLLER__BINDBUTTON_B__13_3_OFFSET UNITYSDK_OFFSET(0x12FD5440)
#define MOLEMOLE_UINORMALSAMPLEPOPWINDOWCONTROLLER__BINDBUTTON_B__13_4_OFFSET UNITYSDK_OFFSET(0x12FD5470)
#define MOLEMOLE_UINORMALSAMPLEPOPWINDOWCONTROLLER__BINDBUTTON_B__13_5_OFFSET UNITYSDK_OFFSET(0x12FD54A0)
#define MOLEMOLE_UINORMALSAMPLEPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12FD5300)
#define MOLEMOLE_UINORMALSAMPLEPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12FD54C0)
#define MOLEMOLE_UINORMALSAMPLEPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12FD5550)
#define MOLEMOLE_UINORMALSAMPLEPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12FD5560)
#define MOLEMOLE_UINORMALSAMPLEPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12FD5570)

namespace MoleMole
{
	inline static constexpr unsigned int UINormalSamplePopWindowController_TypeDefinitionIndex = 74512;
