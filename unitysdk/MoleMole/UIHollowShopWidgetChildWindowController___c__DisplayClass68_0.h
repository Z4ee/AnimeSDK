...
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER___C__DISPLAYCLASS68_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16F8D660)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER___C__DISPLAYCLASS68_0___BUY_B__0_OFFSET UNITYSDK_OFFSET(0x16F8D670)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowShopWidgetChildWindowController___c__DisplayClass68_0_TypeDefinitionIndex = 66346;
	...
	public:
		...
		::MoleMole::UIHollowShopWidgetChildWindowController* __4__this; // 0x20
		::ProtoScript::HollowShopType shopType; // 0x28
		::System::Int32 uid; // 0x2C
