...
#define MOLEMOLE_HACKENTRYSUBSYSTEM_HACKOBJECTOPERATECAMERAVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x17E81680)

namespace MoleMole
{
	inline static constexpr unsigned int HackEntrySubSystem_HackObjectOperateCameraView_TypeDefinitionIndex = 83315;
