...
#define MOLEMOLE_UICOOPLEVELINFOPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x183D3C60)
#define MOLEMOLE_UICOOPLEVELINFOPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x183D3C70)
#define MOLEMOLE_UICOOPLEVELINFOPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x183D3CE0)
#define MOLEMOLE_UICOOPLEVELINFOPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x183D3D80)
#define MOLEMOLE_UICOOPLEVELINFOPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x183D3FB0)
#define MOLEMOLE_UICOOPLEVELINFOPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x183D3FC0)
#define MOLEMOLE_UICOOPLEVELINFOPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x183D4060)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopLevelInfoPopWindowController_TypeDefinitionIndex = 78444;
