...
#define MOLEMOLE_ABYSSS2_CUSTOMCONFIG_CUSTOMAREACONFIG_GETALLAREACONFIG_OFFSET UNITYSDK_OFFSET(0x816820)
#define MOLEMOLE_ABYSSS2_CUSTOMCONFIG_CUSTOMAREACONFIG_GETALLSCENE_OFFSET UNITYSDK_OFFSET(0x16278A10)
#define MOLEMOLE_ABYSSS2_CUSTOMCONFIG_CUSTOMAREACONFIG_REFRESH_OFFSET UNITYSDK_OFFSET(0x816810)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_CustomConfig_CustomAreaConfig_TypeDefinitionIndex = 85691;
