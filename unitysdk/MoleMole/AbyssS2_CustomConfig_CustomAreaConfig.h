...
#define MOLEMOLE_ABYSSS2_CUSTOMCONFIG_CUSTOMAREACONFIG_GETALLAREACONFIG_OFFSET UNITYSDK_OFFSET(0x76ECC0)
#define MOLEMOLE_ABYSSS2_CUSTOMCONFIG_CUSTOMAREACONFIG_GETALLSCENE_OFFSET UNITYSDK_OFFSET(0x13970100)
#define MOLEMOLE_ABYSSS2_CUSTOMCONFIG_CUSTOMAREACONFIG_REFRESH_OFFSET UNITYSDK_OFFSET(0x76ECB0)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_CustomConfig_CustomAreaConfig_TypeDefinitionIndex = 82320;
