...
#define MOLEMOLE_UIAVATARSPECIALAWAKENCONTRASTDESCWIDGETCONTROLLER___C__DISPLAYCLASS4_1__CTOR_OFFSET UNITYSDK_OFFSET(0x17A43BF0)
#define MOLEMOLE_UIAVATARSPECIALAWAKENCONTRASTDESCWIDGETCONTROLLER___C__DISPLAYCLASS4_1__ONSCROLLITEMUPDATE_B__0_OFFSET UNITYSDK_OFFSET(0x17A43C00)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarSpecialAwakenContrastDescWidgetController___c__DisplayClass4_1_TypeDefinitionIndex = 47627;
