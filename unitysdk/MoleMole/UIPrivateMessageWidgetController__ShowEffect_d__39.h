...
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER__SHOWEFFECT_D__39_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x17E165E0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER__SHOWEFFECT_D__39_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x17E16750)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER__SHOWEFFECT_D__39_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x17E167B0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER__SHOWEFFECT_D__39_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x17E16760)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER__SHOWEFFECT_D__39_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17E165D0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER__SHOWEFFECT_D__39__CTOR_OFFSET UNITYSDK_OFFSET(0x17E165C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPrivateMessageWidgetController__ShowEffect_d__39_TypeDefinitionIndex = 40982;
