...
#define MOLEMOLE_UIHOLLOWCURSEGAMEPADBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x14687440)
#define MOLEMOLE_UIHOLLOWCURSEGAMEPADBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x14687450)
#define MOLEMOLE_UIHOLLOWCURSEGAMEPADBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x14687460)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCurseGamepadBindingSettingEntry_TypeDefinitionIndex = 70244;
