...
#define MOLEMOLE_MONOENTITYCOLLIDER_AWAKE_OFFSET UNITYSDK_OFFSET(0x163FB570)
#define MOLEMOLE_MONOENTITYCOLLIDER_EMPTY_OFFSET UNITYSDK_OFFSET(0x163FB2F0)
#define MOLEMOLE_MONOENTITYCOLLIDER_GETCOMPONENTSAFELY_OFFSET UNITYSDK_OFFSET(0x163FB400)
#define MOLEMOLE_MONOENTITYCOLLIDER_GET_ENTITY_OFFSET UNITYSDK_OFFSET(0x163FB2E0)
#define MOLEMOLE_MONOENTITYCOLLIDER_METHOD_5_B235E757922104A8_OFFSET UNITYSDK_OFFSET(0x163FB5C0)
#define MOLEMOLE_MONOENTITYCOLLIDER_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0x163FBBC0)
#define MOLEMOLE_MONOENTITYCOLLIDER_ONCOLLISIONEXIT_OFFSET UNITYSDK_OFFSET(0x163FBC60)
#define MOLEMOLE_MONOENTITYCOLLIDER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x163FBA40)
#define MOLEMOLE_MONOENTITYCOLLIDER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x163FB930)
#define MOLEMOLE_MONOENTITYCOLLIDER_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x163FBD00)
#define MOLEMOLE_MONOENTITYCOLLIDER_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x163FBD60)
#define MOLEMOLE_MONOENTITYCOLLIDER_SET_ENTITY_OFFSET UNITYSDK_OFFSET(0x163FB120)
#define MOLEMOLE_MONOENTITYCOLLIDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x163FBE20)
#define MOLEMOLE_MONOENTITYCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x163FBDD0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEntityCollider_TypeDefinitionIndex = 48548;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::MonoEntityCollider*>**)Il2CppClass::FromTypeDefinitionIndex(MonoEntityCollider_TypeDefinitionIndex)->GetStaticField(0x4CD70);
		}
