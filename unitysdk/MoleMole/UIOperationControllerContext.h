...
#define MOLEMOLE_UIOPERATIONCONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x17D209E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIOperationControllerContext_TypeDefinitionIndex = 64350;
