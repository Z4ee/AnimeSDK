...
#define MOLEMOLE_UILEVELRESULTV2_MP_PAGECONTROLLER___C__DISPLAYCLASS38_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1782F050)
#define MOLEMOLE_UILEVELRESULTV2_MP_PAGECONTROLLER___C__DISPLAYCLASS38_0__EXTRACTPLAYERINFO_B__0_OFFSET UNITYSDK_OFFSET(0x1782F060)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultV2_MP_PageController___c__DisplayClass38_0_TypeDefinitionIndex = 78335;
