...
#define MOLEMOLE_TWEENSCALE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x181A09F0)
#define MOLEMOLE_TWEENSCALE_METHOD_7_08B7287B59325288_OFFSET UNITYSDK_OFFSET(0x181A0B90)
#define MOLEMOLE_TWEENSCALE_METHOD_7_626C719A884DEF9A_OFFSET UNITYSDK_OFFSET(0x181A0B00)
#define MOLEMOLE_TWEENSCALE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x181A0A10)
#define MOLEMOLE_TWEENSCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x181A0C40)
#define MOLEMOLE_TWEENSCALE___BASE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x181A0C60)

namespace MoleMole
{
	inline static constexpr unsigned int TweenScale_TypeDefinitionIndex = 61954;
