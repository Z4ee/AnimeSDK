...
#define MOLEMOLE_TWEENSCALE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1389AB60)
#define MOLEMOLE_TWEENSCALE_METHOD_7_08B7287B59325288_OFFSET UNITYSDK_OFFSET(0x1389AD00)
#define MOLEMOLE_TWEENSCALE_METHOD_7_626C719A884DEF9A_OFFSET UNITYSDK_OFFSET(0x1389AC70)
#define MOLEMOLE_TWEENSCALE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1389AB80)
#define MOLEMOLE_TWEENSCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x1389ADB0)
#define MOLEMOLE_TWEENSCALE___BASE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1389ADD0)

namespace MoleMole
{
	inline static constexpr unsigned int TweenScale_TypeDefinitionIndex = 48366;
