...
#define MOLEMOLE_UIGACHAREWARDLISTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x166E6300)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaRewardListContext_TypeDefinitionIndex = 59916;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_3_601FA52CA5E757A0_1*>* Rewards; // 0x30
