...
#define MOLEMOLE_UIMAINCITYROULETTOPTIONWIDGETCONTROLLER_GETCURRENTSETINDEX_OFFSET UNITYSDK_OFFSET(0x184E2BF0)
#define MOLEMOLE_UIMAINCITYROULETTOPTIONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x184E2720)
#define MOLEMOLE_UIMAINCITYROULETTOPTIONWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x184E2830)
#define MOLEMOLE_UIMAINCITYROULETTOPTIONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x184E27B0)
#define MOLEMOLE_UIMAINCITYROULETTOPTIONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x184E2500)
#define MOLEMOLE_UIMAINCITYROULETTOPTIONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x184E26B0)
#define MOLEMOLE_UIMAINCITYROULETTOPTIONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x184E2F00)
#define MOLEMOLE_UIMAINCITYROULETTOPTIONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x184E2F10)
#define MOLEMOLE_UIMAINCITYROULETTOPTIONWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x184E2FA0)
#define MOLEMOLE_UIMAINCITYROULETTOPTIONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x184E3040)
#define MOLEMOLE_UIMAINCITYROULETTOPTIONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x184E30D0)
#define MOLEMOLE_UIMAINCITYROULETTOPTIONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x184E3160)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityRoulettOptionWidgetController_TypeDefinitionIndex = 44096;
