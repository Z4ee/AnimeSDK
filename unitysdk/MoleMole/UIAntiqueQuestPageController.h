...
#define MOLEMOLE_UIANTIQUEQUESTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x19346290)
#define MOLEMOLE_UIANTIQUEQUESTPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x193462A0)
#define MOLEMOLE_UIANTIQUEQUESTPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19346310)
#define MOLEMOLE_UIANTIQUEQUESTPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x193463B0)
#define MOLEMOLE_UIANTIQUEQUESTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x193464D0)
#define MOLEMOLE_UIANTIQUEQUESTPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x193464E0)
#define MOLEMOLE_UIANTIQUEQUESTPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x19346580)

namespace MoleMole
{
	inline static constexpr unsigned int UIAntiqueQuestPageController_TypeDefinitionIndex = 85574;
