...
#define MOLEMOLE_UINOUNDETAILWIDGETCONTROLLER_GETLOCALIZATIONTEXT_OFFSET UNITYSDK_OFFSET(0x1453C190)
#define MOLEMOLE_UINOUNDETAILWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1453BE40)
#define MOLEMOLE_UINOUNDETAILWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1453BEB0)
#define MOLEMOLE_UINOUNDETAILWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1453BF50)
#define MOLEMOLE_UINOUNDETAILWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1453C010)
#define MOLEMOLE_UINOUNDETAILWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1453C250)
#define MOLEMOLE_UINOUNDETAILWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1453C260)
#define MOLEMOLE_UINOUNDETAILWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1453C300)

namespace MoleMole
{
	inline static constexpr unsigned int UINounDetailWidgetController_TypeDefinitionIndex = 55512;
