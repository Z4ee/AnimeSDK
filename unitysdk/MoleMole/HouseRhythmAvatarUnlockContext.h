...
#define MOLEMOLE_HOUSERHYTHMAVATARUNLOCKCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x19258810)

namespace MoleMole
{
	inline static constexpr unsigned int HouseRhythmAvatarUnlockContext_TypeDefinitionIndex = 80325;
