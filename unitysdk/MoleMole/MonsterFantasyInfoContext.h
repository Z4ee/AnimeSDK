...
#define MOLEMOLE_MONSTERFANTASYINFOCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x129D6450)

namespace MoleMole
{
	inline static constexpr unsigned int MonsterFantasyInfoContext_TypeDefinitionIndex = 89818;
