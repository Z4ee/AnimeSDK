...
#define MOLEMOLE_MONSTERFANTASYINFOCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x173F95D0)

namespace MoleMole
{
	inline static constexpr unsigned int MonsterFantasyInfoContext_TypeDefinitionIndex = 67960;
