...
#define MOLEMOLE_UIRABCITYMISSIONPAGECONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15F28080)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABCityMissionPageController_Context_TypeDefinitionIndex = 41380;
