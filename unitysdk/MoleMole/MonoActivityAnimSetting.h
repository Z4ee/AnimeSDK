...
#define MOLEMOLE_MONOACTIVITYANIMSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x13F0CC60)

namespace MoleMole
{
	inline static constexpr unsigned int MonoActivityAnimSetting_TypeDefinitionIndex = 86843;
