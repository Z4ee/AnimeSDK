...
#define MOLEMOLE_MONOTERRAINZONEVOXEL_ADDDYNAMICOBJECTVOXEL_OFFSET UNITYSDK_OFFSET(0x1514ECA0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_FETCHVOXELWITHLAYER_COMPRESSEDARRAY_OFFSET UNITYSDK_OFFSET(0x1514E8A0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_FETCHVOXELWITHLAYER_OCT_OFFSET UNITYSDK_OFFSET(0x1514DFF0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_FETCHVOXELWITHLAYER_OFFSET UNITYSDK_OFFSET(0x1514DEF0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_FETCHVOXELWITHLAYER_RAWARRAY_OFFSET UNITYSDK_OFFSET(0x1514E5B0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_GETSURFACECOVERSWITCHINFO_OFFSET UNITYSDK_OFFSET(0x1514CA60)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_GETSURFACESWITCHINFO_OFFSET UNITYSDK_OFFSET(0x1514C8F0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_GETUNSCALEPOS_OFFSET UNITYSDK_OFFSET(0x1514DBD0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_GETVOXEL_OFFSET UNITYSDK_OFFSET(0x1514DCC0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_02416282B55EC5F3_OFFSET UNITYSDK_OFFSET(0x1514D6B0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x1514FEE0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_0927CBCFB2A51C9A_OFFSET UNITYSDK_OFFSET(0x1514FC20)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x1514FF30)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x15150440)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_19FB9C4218A5B74F_OFFSET UNITYSDK_OFFSET(0x1514F3F0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_28EB11670A8E5A86_OFFSET UNITYSDK_OFFSET(0x1514D080)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_464F9487BF0D77F8_OFFSET UNITYSDK_OFFSET(0x1514F710)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_4DA6D4A624E42CAB_OFFSET UNITYSDK_OFFSET(0x1514FB20)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0x1514CE60)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_6424DA16BE1ACD1D_OFFSET UNITYSDK_OFFSET(0x151503F0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_6C34F0EA80C7348F_OFFSET UNITYSDK_OFFSET(0x1514EE00)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0x1514D3B0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_7DB49B5407C8FD68_OFFSET UNITYSDK_OFFSET(0x1514F4E0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_7F576417C636CD3F_1_OFFSET UNITYSDK_OFFSET(0x15150370)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_7F576417C636CD3F_OFFSET UNITYSDK_OFFSET(0x1514DE70)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_904639FDEF8DA904_OFFSET UNITYSDK_OFFSET(0x1514F860)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1514FD70)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_BFB8545B28B0DAAD_OFFSET UNITYSDK_OFFSET(0x1514FE80)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_C0B9D1B2E5611154_OFFSET UNITYSDK_OFFSET(0x151500E0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x1514FE40)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1514FD20)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_DDA7FEACCC547653_OFFSET UNITYSDK_OFFSET(0x151502C0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_E05A16F4C3178177_1_OFFSET UNITYSDK_OFFSET(0x1514FAC0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_E05A16F4C3178177_OFFSET UNITYSDK_OFFSET(0x1514FBC0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_F3F1A00B2E67355E_OFFSET UNITYSDK_OFFSET(0x1514EC50)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_F8E58E0FD73B9311_OFFSET UNITYSDK_OFFSET(0x15150080)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_FEA241CA014F8043_OFFSET UNITYSDK_OFFSET(0x1514FC80)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1514CE10)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1514CDD0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_PACKMATTYPE_OFFSET UNITYSDK_OFFSET(0x1514CBA0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_PACKSPANDATATOTOP_OFFSET UNITYSDK_OFFSET(0x1514CD80)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_REMOVEDYNAMICOBJECTVOXEL_OFFSET UNITYSDK_OFFSET(0x1514ED50)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_RESETVOXEL_OFFSET UNITYSDK_OFFSET(0x1514DC70)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_START_OFFSET UNITYSDK_OFFSET(0x1514D360)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_UNPACKMATTYPE_OFFSET UNITYSDK_OFFSET(0x1514CCE0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_UPDATE_OFFSET UNITYSDK_OFFSET(0x1514D660)
#define MOLEMOLE_MONOTERRAINZONEVOXEL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1514F380)
#define MOLEMOLE_MONOTERRAINZONEVOXEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1514F000)

namespace MoleMole
{
	inline static constexpr unsigned int MonoTerrainZoneVoxel_TypeDefinitionIndex = 70792;
	...
	public:
		...
		{
			return (::System::Action_1<::UnityEngine::Vector3>**)Il2CppClass::FromTypeDefinitionIndex(MonoTerrainZoneVoxel_TypeDefinitionIndex)->GetStaticField(0x30850);
		}
		static ::System::Byte* StaticGet_COVER_MAT_MAX_RANGE()
		{
			return (::System::Byte*)Il2CppClass::FromTypeDefinitionIndex(MonoTerrainZoneVoxel_TypeDefinitionIndex)->GetStaticField(0xB030);
		}
		static ::System::Byte* StaticGet_BASE_MAT_MAX_RANGE()
		{
			return (::System::Byte*)Il2CppClass::FromTypeDefinitionIndex(MonoTerrainZoneVoxel_TypeDefinitionIndex)->GetStaticField(0xB031);
		}
		static ::System::Int32* StaticGet_Field_5_29()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoTerrainZoneVoxel_TypeDefinitionIndex)->GetStaticField(0xB034);
		}
		static ::System::Int32* StaticGet_Field_5_28()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoTerrainZoneVoxel_TypeDefinitionIndex)->GetStaticField(0xB038);
		}
