...
#define MOLEMOLE_UIRIGIDBODY_CLASS_1_18DE9524B9A30AD9_METHOD_1_5323F2DF46A044DA_OFFSET UNITYSDK_OFFSET(0x1886E200)
#define MOLEMOLE_UIRIGIDBODY_CLASS_1_18DE9524B9A30AD9_METHOD_1_CEE772DE95055C01_OFFSET UNITYSDK_OFFSET(0x1886E210)
#define MOLEMOLE_UIRIGIDBODY_CLASS_1_18DE9524B9A30AD9__CTOR_OFFSET UNITYSDK_OFFSET(0x1886E1F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRigidbody_Class_1_18DE9524B9A30AD9_TypeDefinitionIndex = 64128;

	class UIRigidbody_Class_1_18DE9524B9A30AD9 : public ::System::Object
	{
	public:
		::MoleMole::UIRigidbody* Field_1_7; // 0x10
