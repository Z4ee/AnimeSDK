...
#define MOLEMOLE_UISOCIALCIRCLEMAIN_MAINWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x12675060)
#define MOLEMOLE_UISOCIALCIRCLEMAIN_MAINWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x126750D0)
#define MOLEMOLE_UISOCIALCIRCLEMAIN_MAINWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x12675190)
#define MOLEMOLE_UISOCIALCIRCLEMAIN_MAINWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12675440)
#define MOLEMOLE_UISOCIALCIRCLEMAIN_MAINWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x126754A0)
#define MOLEMOLE_UISOCIALCIRCLEMAIN_MAINWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x12675540)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleMain_MainWidgetController_TypeDefinitionIndex = 42607;
