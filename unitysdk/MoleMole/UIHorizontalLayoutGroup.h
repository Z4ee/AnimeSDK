...
#define MOLEMOLE_UIHORIZONTALLAYOUTGROUP_GET_VALUECHANGED_OFFSET UNITYSDK_OFFSET(0x163FD060)
#define MOLEMOLE_UIHORIZONTALLAYOUTGROUP_MARKVALUECHANGE_OFFSET UNITYSDK_OFFSET(0x163FD080)
#define MOLEMOLE_UIHORIZONTALLAYOUTGROUP_REINITFROMLAYOUTGROUP_OFFSET UNITYSDK_OFFSET(0x163FCF50)
#define MOLEMOLE_UIHORIZONTALLAYOUTGROUP_SET_VALUECHANGED_OFFSET UNITYSDK_OFFSET(0x163FD070)
#define MOLEMOLE_UIHORIZONTALLAYOUTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x163FCE10)

namespace MoleMole
{
	inline static constexpr unsigned int UIHorizontalLayoutGroup_TypeDefinitionIndex = 47289;
