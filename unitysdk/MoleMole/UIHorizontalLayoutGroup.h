...
#define MOLEMOLE_UIHORIZONTALLAYOUTGROUP_GET_VALUECHANGED_OFFSET UNITYSDK_OFFSET(0x188B1D20)
#define MOLEMOLE_UIHORIZONTALLAYOUTGROUP_MARKVALUECHANGE_OFFSET UNITYSDK_OFFSET(0x188B1D40)
#define MOLEMOLE_UIHORIZONTALLAYOUTGROUP_REINITFROMLAYOUTGROUP_OFFSET UNITYSDK_OFFSET(0x188B1C10)
#define MOLEMOLE_UIHORIZONTALLAYOUTGROUP_SET_VALUECHANGED_OFFSET UNITYSDK_OFFSET(0x188B1D30)
#define MOLEMOLE_UIHORIZONTALLAYOUTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x188B1AD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHorizontalLayoutGroup_TypeDefinitionIndex = 61678;
