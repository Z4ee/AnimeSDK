...
#define MOLEMOLE_UIURBANMAPLEFTLOCATIONROWTITLEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1399A5C0)
#define MOLEMOLE_UIURBANMAPLEFTLOCATIONROWTITLEWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1399A690)
#define MOLEMOLE_UIURBANMAPLEFTLOCATIONROWTITLEWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1399A750)
#define MOLEMOLE_UIURBANMAPLEFTLOCATIONROWTITLEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1399A630)
#define MOLEMOLE_UIURBANMAPLEFTLOCATIONROWTITLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1399A900)
#define MOLEMOLE_UIURBANMAPLEFTLOCATIONROWTITLEWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1399A910)
#define MOLEMOLE_UIURBANMAPLEFTLOCATIONROWTITLEWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1399A9B0)
#define MOLEMOLE_UIURBANMAPLEFTLOCATIONROWTITLEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1399AA50)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapLeftLocationRowTitleWidgetController_TypeDefinitionIndex = 46783;
