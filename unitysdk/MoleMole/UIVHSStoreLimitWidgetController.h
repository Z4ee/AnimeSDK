...
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_CHECKVALID_OFFSET UNITYSDK_OFFSET(0xE46FCD0)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_GET_SELECTEDVHS_OFFSET UNITYSDK_OFFSET(0xE46FDE0)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_GET__CONTEXT_OFFSET UNITYSDK_OFFSET(0xE46FDD0)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_INITBYCONTEXT_OFFSET UNITYSDK_OFFSET(0xE46FBD0)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_ONCONTEXTCHANGE_OFFSET UNITYSDK_OFFSET(0xE46FD20)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xE46FA60)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xE46FAF0)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xE46F870)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_SET__CONTEXT_OFFSET UNITYSDK_OFFSET(0xE46FC60)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xE46FB70)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xE46FE50)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xE46FEB0)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xE46FF40)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xE46FFD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSStoreLimitWidgetController_TypeDefinitionIndex = 74348;

	class UIVHSStoreLimitWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_BE9E890626A0960B* _view; // 0x2B8
		::MoleMole::UIVHSStoreLimitRoleInfoWidgetController* _roleInfoWidget; // 0x2C0
		::MoleMole::UIVHSStoreLimitBtnsWidgetController* _btnsWidget; // 0x2C8
		::MoleMole::UIVHSStoreRecommandWidgetController* _recommandWidget; // 0x2D0
		::MoleMole::UIVHSStoreLimitWidgetController_Context* __context; // 0x2D8
		::MoleMole::UIVHSStoreLimitWidgetController_TagScrollViewHelper* tagHelper; // 0x2E0
