...
#define MOLEMOLE_UIGOLDMININGDAYTABBUTTONWIDGETCONTROLLER_GET_TABBTN_OFFSET UNITYSDK_OFFSET(0x15A25060)
#define MOLEMOLE_UIGOLDMININGDAYTABBUTTONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A25150)
#define MOLEMOLE_UIGOLDMININGDAYTABBUTTONWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15A251E0)
#define MOLEMOLE_UIGOLDMININGDAYTABBUTTONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A25520)
#define MOLEMOLE_UIGOLDMININGDAYTABBUTTONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A25080)
#define MOLEMOLE_UIGOLDMININGDAYTABBUTTONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15A250E0)
#define MOLEMOLE_UIGOLDMININGDAYTABBUTTONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15A255A0)
#define MOLEMOLE_UIGOLDMININGDAYTABBUTTONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A255B0)
#define MOLEMOLE_UIGOLDMININGDAYTABBUTTONWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15A25640)
#define MOLEMOLE_UIGOLDMININGDAYTABBUTTONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A256E0)
#define MOLEMOLE_UIGOLDMININGDAYTABBUTTONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A25770)
#define MOLEMOLE_UIGOLDMININGDAYTABBUTTONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15A25800)

namespace MoleMole
{
	inline static constexpr unsigned int UIGoldMiningDayTabButtonWidgetController_TypeDefinitionIndex = 72217;

	class UIGoldMiningDayTabButtonWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_C31421CDE660CB44* _view; // 0x2E8
