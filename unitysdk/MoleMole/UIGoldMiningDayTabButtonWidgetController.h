...
#define MOLEMOLE_UIGOLDMININGDAYTABBUTTONWIDGETCONTROLLER_GET_TABBTN_OFFSET UNITYSDK_OFFSET(0x167AA650)
#define MOLEMOLE_UIGOLDMININGDAYTABBUTTONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x167AA740)
#define MOLEMOLE_UIGOLDMININGDAYTABBUTTONWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x167AA7D0)
#define MOLEMOLE_UIGOLDMININGDAYTABBUTTONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x167AAB10)
#define MOLEMOLE_UIGOLDMININGDAYTABBUTTONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x167AA670)
#define MOLEMOLE_UIGOLDMININGDAYTABBUTTONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x167AA6D0)
#define MOLEMOLE_UIGOLDMININGDAYTABBUTTONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x167AAB90)
#define MOLEMOLE_UIGOLDMININGDAYTABBUTTONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x167AABA0)
#define MOLEMOLE_UIGOLDMININGDAYTABBUTTONWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x167AAC30)
#define MOLEMOLE_UIGOLDMININGDAYTABBUTTONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x167AACD0)
#define MOLEMOLE_UIGOLDMININGDAYTABBUTTONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x167AAD60)
#define MOLEMOLE_UIGOLDMININGDAYTABBUTTONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x167AADF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGoldMiningDayTabButtonWidgetController_TypeDefinitionIndex = 71750;
