...
#define MOLEMOLE_UIBANGKOVCOUNTDOWNWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x12F53BD0)
#define MOLEMOLE_UIBANGKOVCOUNTDOWNWIDGETCONTROLLER_GET__VIEW_OFFSET UNITYSDK_OFFSET(0x12F53B60)
#define MOLEMOLE_UIBANGKOVCOUNTDOWNWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x12F53C40)
#define MOLEMOLE_UIBANGKOVCOUNTDOWNWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x12F53E90)
#define MOLEMOLE_UIBANGKOVCOUNTDOWNWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x12F53CE0)
#define MOLEMOLE_UIBANGKOVCOUNTDOWNWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x12F53EF0)
#define MOLEMOLE_UIBANGKOVCOUNTDOWNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12F54760)
#define MOLEMOLE_UIBANGKOVCOUNTDOWNWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x12F547C0)
#define MOLEMOLE_UIBANGKOVCOUNTDOWNWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x12F54810)
#define MOLEMOLE_UIBANGKOVCOUNTDOWNWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x12F54850)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangkovCountDownWidgetController_TypeDefinitionIndex = 47544;

	class UIBangkovCountDownWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::System::Boolean _timerBlinkActive; // 0x2B8
		::System::Single lastLeftTime; // 0x2BC
