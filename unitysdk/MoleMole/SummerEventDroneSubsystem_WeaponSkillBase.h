...
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLBASE_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1304AF20)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLBASE_CORE_OFFSET UNITYSDK_OFFSET(0x1304AEB0)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLBASE_GETDURATION_OFFSET UNITYSDK_OFFSET(0x1304B0A0)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLBASE_GETTIMER_OFFSET UNITYSDK_OFFSET(0x1304B0F0)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLBASE_INIT_OFFSET UNITYSDK_OFFSET(0x1304ADA0)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLBASE_ISINSTANTSKILLTYPE_OFFSET UNITYSDK_OFFSET(0x1304AF80)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLBASE_ISTIMEUP_OFFSET UNITYSDK_OFFSET(0x1304AFC0)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLBASE_ONADD_OFFSET UNITYSDK_OFFSET(0x1304AE30)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLBASE_ONEVENT_OFFSET UNITYSDK_OFFSET(0x1304B020)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLBASE_ONREMOVED_OFFSET UNITYSDK_OFFSET(0x1304AE70)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1304B140)

namespace MoleMole
{
	inline static constexpr unsigned int SummerEventDroneSubsystem_WeaponSkillBase_TypeDefinitionIndex = 87301;
