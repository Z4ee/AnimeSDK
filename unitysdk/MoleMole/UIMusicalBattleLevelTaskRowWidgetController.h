...
#define MOLEMOLE_UIMUSICALBATTLELEVELTASKROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x12E01D00)
#define MOLEMOLE_UIMUSICALBATTLELEVELTASKROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x12E01D70)
#define MOLEMOLE_UIMUSICALBATTLELEVELTASKROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x12E01E10)
#define MOLEMOLE_UIMUSICALBATTLELEVELTASKROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12E01F20)
#define MOLEMOLE_UIMUSICALBATTLELEVELTASKROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x12E01F80)
#define MOLEMOLE_UIMUSICALBATTLELEVELTASKROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x12E02020)

namespace MoleMole
{
	inline static constexpr unsigned int UIMusicalBattleLevelTaskRowWidgetController_TypeDefinitionIndex = 38414;
