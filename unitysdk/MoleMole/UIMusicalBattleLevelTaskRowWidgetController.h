...
#define MOLEMOLE_UIMUSICALBATTLELEVELTASKROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16733B70)
#define MOLEMOLE_UIMUSICALBATTLELEVELTASKROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16733BE0)
#define MOLEMOLE_UIMUSICALBATTLELEVELTASKROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16733C80)
#define MOLEMOLE_UIMUSICALBATTLELEVELTASKROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16733D90)
#define MOLEMOLE_UIMUSICALBATTLELEVELTASKROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16733DF0)
#define MOLEMOLE_UIMUSICALBATTLELEVELTASKROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16733E90)

namespace MoleMole
{
	inline static constexpr unsigned int UIMusicalBattleLevelTaskRowWidgetController_TypeDefinitionIndex = 46572;
