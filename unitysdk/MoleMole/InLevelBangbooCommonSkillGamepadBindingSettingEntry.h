...
#define MOLEMOLE_INLEVELBANGBOOCOMMONSKILLGAMEPADBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x161F6310)
#define MOLEMOLE_INLEVELBANGBOOCOMMONSKILLGAMEPADBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x161F6320)
#define MOLEMOLE_INLEVELBANGBOOCOMMONSKILLGAMEPADBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x161F6330)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelBangbooCommonSkillGamepadBindingSettingEntry_TypeDefinitionIndex = 44015;
