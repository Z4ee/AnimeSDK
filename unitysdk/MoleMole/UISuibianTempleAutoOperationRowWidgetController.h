...
#define MOLEMOLE_UISUIBIANTEMPLEAUTOOPERATIONROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x13025450)
#define MOLEMOLE_UISUIBIANTEMPLEAUTOOPERATIONROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x130254C0)
#define MOLEMOLE_UISUIBIANTEMPLEAUTOOPERATIONROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x13025580)
#define MOLEMOLE_UISUIBIANTEMPLEAUTOOPERATIONROWWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x13025850)
#define MOLEMOLE_UISUIBIANTEMPLEAUTOOPERATIONROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x130258F0)
#define MOLEMOLE_UISUIBIANTEMPLEAUTOOPERATIONROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x13025900)
#define MOLEMOLE_UISUIBIANTEMPLEAUTOOPERATIONROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x130259A0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleAutoOperationRowWidgetController_TypeDefinitionIndex = 62134;
