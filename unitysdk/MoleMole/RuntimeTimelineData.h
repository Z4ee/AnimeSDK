...
#define MOLEMOLE_RUNTIMETIMELINEDATA_GETDEFAULTNEEDDISPLAYTIMELINERESOVERRIDE_OFFSET UNITYSDK_OFFSET(0x190A8240)
#define MOLEMOLE_RUNTIMETIMELINEDATA_GETIGNORETIMELINERESOVERRIDE_OFFSET UNITYSDK_OFFSET(0x190A8200)
#define MOLEMOLE_RUNTIMETIMELINEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x190A8280)
#define MOLEMOLE_RUNTIMETIMELINEDATA___BASE_GETDEFAULTNEEDDISPLAYTIMELINERESOVERRIDE_OFFSET UNITYSDK_OFFSET(0x190A82E0)
#define MOLEMOLE_RUNTIMETIMELINEDATA___BASE_GETIGNORETIMELINERESOVERRIDE_OFFSET UNITYSDK_OFFSET(0x190A8370)

namespace MoleMole
{
	inline static constexpr unsigned int RuntimeTimelineData_TypeDefinitionIndex = 58610;
