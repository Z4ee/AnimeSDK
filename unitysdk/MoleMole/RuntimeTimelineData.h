...
#define MOLEMOLE_RUNTIMETIMELINEDATA_GETDEFAULTNEEDDISPLAYTIMELINERESOVERRIDE_OFFSET UNITYSDK_OFFSET(0x17DE1530)
#define MOLEMOLE_RUNTIMETIMELINEDATA_GETIGNORETIMELINERESOVERRIDE_OFFSET UNITYSDK_OFFSET(0x17DE14F0)
#define MOLEMOLE_RUNTIMETIMELINEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17DE1570)
#define MOLEMOLE_RUNTIMETIMELINEDATA___BASE_GETDEFAULTNEEDDISPLAYTIMELINERESOVERRIDE_OFFSET UNITYSDK_OFFSET(0x17DE15C0)
#define MOLEMOLE_RUNTIMETIMELINEDATA___BASE_GETIGNORETIMELINERESOVERRIDE_OFFSET UNITYSDK_OFFSET(0x17DE1650)

namespace MoleMole
{
	inline static constexpr unsigned int RuntimeTimelineData_TypeDefinitionIndex = 82303;
