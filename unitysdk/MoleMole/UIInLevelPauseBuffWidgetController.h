...
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_INITMONSTERINFO_OFFSET UNITYSDK_OFFSET(0x148AD5D0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_INITROLEBTN_OFFSET UNITYSDK_OFFSET(0x148ADAA0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_ISMONSTERBOSS_OFFSET UNITYSDK_OFFSET(0x148AF230)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_ONCLICKDROPDOWN_OFFSET UNITYSDK_OFFSET(0x148AE4B0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x148AE420)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_ONDROPDOWNCHANGE_OFFSET UNITYSDK_OFFSET(0x148AE8B0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x148AF180)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x148AD350)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x148AD3B0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_REFRESHAVATARSKILLINFO_OFFSET UNITYSDK_OFFSET(0x148AF480)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_REFRESHBUFFINFO_OFFSET UNITYSDK_OFFSET(0x148AFB80)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_SETSELECTEDAVATARID_OFFSET UNITYSDK_OFFSET(0x148AF820)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_SWITCHSELECTEDAVATAR_OFFSET UNITYSDK_OFFSET(0x148AEC10)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_SWITCHSELECTEDMONSTER_OFFSET UNITYSDK_OFFSET(0x148AECF0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_TRYHANDLEGAMEPADSELECT_OFFSET UNITYSDK_OFFSET(0x148B0DC0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x148B12C0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x148B10C0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER__INITROLEBTN_B__10_0_OFFSET UNITYSDK_OFFSET(0x148B1330)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER__ONUIOPEN_B__2_0_OFFSET UNITYSDK_OFFSET(0x148B1320)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x148B1340)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x148B13D0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x148B1460)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x148B14F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseBuffWidgetController_TypeDefinitionIndex = 75074;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIInLevelPauseBuffWidgetController_TypeDefinitionIndex)->GetStaticField(0x3CC40);
		}
		static ::System::String** StaticGet_BOSS_NAME()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIInLevelPauseBuffWidgetController_TypeDefinitionIndex)->GetStaticField(0x3CC48);
		}
		static ::System::Int32* StaticGet_MAX_AVATAR_NUM()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelPauseBuffWidgetController_TypeDefinitionIndex)->GetStaticField(0xEE40);
		}
		::Class_2_938422ACC5F2A616* _view; // 0x2B8
		::System::Collections::Generic::List_1<::Foundation::Coroutine::CoroutineHandle>* handleList; // 0x2C0
		::System::Collections::Generic::List_1<::MoleMole::UIInLevelPauseBuffRowWidgetController*>* _buffRowList; // 0x2C8
		::System::UInt32 _curEntity; // 0x2D0
		::MoleMole::UIInLevelPauseBuffWidgetController_EShowType _curType; // 0x2D4
		::System::Collections::Generic::List_1<::MoleMole::Battle::Entity*>* _showAvatars; // 0x2D8
		::MoleMole::Battle::Entity* _showMonster; // 0x2E0
		::MoleMole::UIGeneralDynamicTipsPopWindowController* _dropDown; // 0x2E8
		::System::Collections::Generic::List_1<::System::Int32>* _showBuffIDs; // 0x2F0
