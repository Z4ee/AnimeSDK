...
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_INITMONSTERINFO_OFFSET UNITYSDK_OFFSET(0x15718CC0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_INITROLEBTN_OFFSET UNITYSDK_OFFSET(0x15719190)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_ISMONSTERBOSS_OFFSET UNITYSDK_OFFSET(0x1571AA20)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_ONCLICKDROPDOWN_OFFSET UNITYSDK_OFFSET(0x15719C40)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15719BB0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_ONDROPDOWNCHANGE_OFFSET UNITYSDK_OFFSET(0x1571A0A0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1571A970)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15718A40)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15718AA0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_REFRESHAVATARSKILLINFO_OFFSET UNITYSDK_OFFSET(0x1571AC70)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_REFRESHBUFFINFO_OFFSET UNITYSDK_OFFSET(0x1571B370)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_SETSELECTEDAVATARID_OFFSET UNITYSDK_OFFSET(0x1571B010)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_SWITCHSELECTEDAVATAR_OFFSET UNITYSDK_OFFSET(0x1571A400)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_SWITCHSELECTEDMONSTER_OFFSET UNITYSDK_OFFSET(0x1571A4E0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_TRYHANDLEGAMEPADSELECT_OFFSET UNITYSDK_OFFSET(0x1571C590)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1571CA90)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1571C890)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER__INITROLEBTN_B__10_0_OFFSET UNITYSDK_OFFSET(0x1571CB00)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER__ONUIOPEN_B__2_0_OFFSET UNITYSDK_OFFSET(0x1571CAF0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1571CB10)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1571CBA0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1571CC30)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1571CCC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseBuffWidgetController_TypeDefinitionIndex = 62205;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIInLevelPauseBuffWidgetController_TypeDefinitionIndex)->GetStaticField(0x3F260);
		}
		static ::System::String** StaticGet_BOSS_NAME()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIInLevelPauseBuffWidgetController_TypeDefinitionIndex)->GetStaticField(0x3F268);
		}
		static ::System::Int32* StaticGet_MAX_AVATAR_NUM()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelPauseBuffWidgetController_TypeDefinitionIndex)->GetStaticField(0xF3C0);
		}
