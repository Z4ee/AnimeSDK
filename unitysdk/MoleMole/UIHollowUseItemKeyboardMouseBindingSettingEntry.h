...
#define MOLEMOLE_UIHOLLOWUSEITEMKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_LOCKEDSETTINGRAWINPUTDEVICELIST_OFFSET UNITYSDK_OFFSET(0x18142090)
#define MOLEMOLE_UIHOLLOWUSEITEMKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x18142070)
#define MOLEMOLE_UIHOLLOWUSEITEMKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x18142080)
#define MOLEMOLE_UIHOLLOWUSEITEMKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x18142120)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowUseItemKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 67039;
