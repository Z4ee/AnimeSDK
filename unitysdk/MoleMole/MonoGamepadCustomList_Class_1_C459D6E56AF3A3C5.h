...
#define MOLEMOLE_MONOGAMEPADCUSTOMLIST_CLASS_1_C459D6E56AF3A3C5_METHOD_1_AFB756BC1B1D6035_OFFSET UNITYSDK_OFFSET(0x191AAAA0)
#define MOLEMOLE_MONOGAMEPADCUSTOMLIST_CLASS_1_C459D6E56AF3A3C5__CTOR_OFFSET UNITYSDK_OFFSET(0x191AAA90)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGamepadCustomList_Class_1_C459D6E56AF3A3C5_TypeDefinitionIndex = 58247;
