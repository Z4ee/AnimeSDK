...
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_INITFRIENDINFOPAGE_OFFSET UNITYSDK_OFFSET(0x17BC6700)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_ONCLICKCONSOLEFRIENDTAB_OFFSET UNITYSDK_OFFSET(0x17BC8A80)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_ONCLICKINGAMEFRIENDTAB_OFFSET UNITYSDK_OFFSET(0x17BC8AD0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17BC7380)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_ONFRIENDINFOGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x17BC7490)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x17BC7300)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_ONRECEIVEFRIENDLIST_OFFSET UNITYSDK_OFFSET(0x17BC79C0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17BC70F0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17BC7410)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17BC6500)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_PLATFORM_ONRECEIVEFRIENDLIST_OFFSET UNITYSDK_OFFSET(0x17BC8270)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_SETUPONCLICKSENDMSGBTNACTION_OFFSET UNITYSDK_OFFSET(0x17BC70A0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_UPDATEFRIENDINFOPAGE_OFFSET UNITYSDK_OFFSET(0x17BC7230)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_UPDATEFRIENDINFO_OFFSET UNITYSDK_OFFSET(0x17BC7530)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17BC8B80)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER__INITFRIENDINFOPAGE_B__10_1_OFFSET UNITYSDK_OFFSET(0x17BC8C60)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER__INITFRIENDINFOPAGE_B__10_2_OFFSET UNITYSDK_OFFSET(0x17BC8C90)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER__INITFRIENDINFOPAGE_B__10_3_OFFSET UNITYSDK_OFFSET(0x17BC8CF0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER__INITFRIENDINFOPAGE_B__10_4_OFFSET UNITYSDK_OFFSET(0x17BC8D50)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER__INITFRIENDINFOPAGE_B__10_5_OFFSET UNITYSDK_OFFSET(0x17BC8D60)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17BC8DB0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x17BC8E40)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17BC8ED0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17BC8F70)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17BC9000)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendInfoWidgetController_TypeDefinitionIndex = 74252;
