...
#define MOLEMOLE_UIURBANMAPRIGHTTASTLISTWIDGET02WIDGETCONTROLLER_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x10EF8C40)
#define MOLEMOLE_UIURBANMAPRIGHTTASTLISTWIDGET02WIDGETCONTROLLER_GET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x10EF8C30)
#define MOLEMOLE_UIURBANMAPRIGHTTASTLISTWIDGET02WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x10EF8C50)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapRightTastListWidget02WidgetController_TypeDefinitionIndex = 41007;
