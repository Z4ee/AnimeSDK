...
#define MOLEMOLE_UICOOPCLUEINFOPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x192BFFA0)
#define MOLEMOLE_UICOOPCLUEINFOPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x192BFFB0)
#define MOLEMOLE_UICOOPCLUEINFOPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x192C0020)
#define MOLEMOLE_UICOOPCLUEINFOPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x192C00C0)
#define MOLEMOLE_UICOOPCLUEINFOPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x192C01D0)
#define MOLEMOLE_UICOOPCLUEINFOPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x192C01E0)
#define MOLEMOLE_UICOOPCLUEINFOPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x192C0280)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopClueInfoPopWindowController_TypeDefinitionIndex = 42304;
