...
#define MOLEMOLE_UICOOPCLUEINFOPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x17F6DB60)
#define MOLEMOLE_UICOOPCLUEINFOPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17F6DB70)
#define MOLEMOLE_UICOOPCLUEINFOPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17F6DBE0)
#define MOLEMOLE_UICOOPCLUEINFOPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17F6DC80)
#define MOLEMOLE_UICOOPCLUEINFOPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17F6DD90)
#define MOLEMOLE_UICOOPCLUEINFOPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17F6DDA0)
#define MOLEMOLE_UICOOPCLUEINFOPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17F6DE40)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopClueInfoPopWindowController_TypeDefinitionIndex = 60152;
