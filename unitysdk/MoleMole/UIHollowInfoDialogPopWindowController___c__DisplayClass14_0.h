...
#define MOLEMOLE_UIHOLLOWINFODIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18836570)
#define MOLEMOLE_UIHOLLOWINFODIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS14_0__SAVEDUNGEON_B__0_OFFSET UNITYSDK_OFFSET(0x188391D0)
#define MOLEMOLE_UIHOLLOWINFODIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS14_0__SAVEDUNGEON_B__1_OFFSET UNITYSDK_OFFSET(0x18839280)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowInfoDialogPopWindowController___c__DisplayClass14_0_TypeDefinitionIndex = 75518;
