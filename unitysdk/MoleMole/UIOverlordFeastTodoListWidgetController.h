...
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_ONCLICKGENERAL_OFFSET UNITYSDK_OFFSET(0x12FDBF50)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_ONCLICKOVERLORD_OFFSET UNITYSDK_OFFSET(0x12FDB950)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12FDA350)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x12FDC040)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x12FDA460)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12FDA3E0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12FDA280)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12FDA2E0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_SETBTNINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x12FDADC0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x12FDB7E0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_SETGENERALQUEST_OFFSET UNITYSDK_OFFSET(0x12FDAE30)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_SETQUEST_OFFSET UNITYSDK_OFFSET(0x12FDA650)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12FDC0B0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12FDC0C0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x12FDC150)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x12FDC1E0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12FDC280)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12FDC310)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12FDC3A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastTodoListWidgetController_TypeDefinitionIndex = 69982;

	class UIOverlordFeastTodoListWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_6AAA836985EA0A07_1* _view; // 0x2F0
		::Enum_3_D03B1A3DDBB3D34D _funcType; // 0x2F8
		::System::Int32 _questID; // 0x2FC
