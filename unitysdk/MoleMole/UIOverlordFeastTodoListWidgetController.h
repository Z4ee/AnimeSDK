...
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_ONCLICKGENERAL_OFFSET UNITYSDK_OFFSET(0x15F13090)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_ONCLICKOVERLORD_OFFSET UNITYSDK_OFFSET(0x15F12AA0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15F11560)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x15F13180)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15F11670)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15F115F0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15F11490)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15F114F0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_SETBTNINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x15F11FB0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x15F12930)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_SETGENERALQUEST_OFFSET UNITYSDK_OFFSET(0x15F12020)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_SETQUEST_OFFSET UNITYSDK_OFFSET(0x15F11860)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15F131F0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15F13200)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x15F13290)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15F13320)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15F133C0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15F13450)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15F134E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastTodoListWidgetController_TypeDefinitionIndex = 83189;
