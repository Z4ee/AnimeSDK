...
#define MOLEMOLE_UIEXPEDITIONBUDDYSELECTPOPWINDOWCONTROLLER___C__DISPLAYCLASS43_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19AAE130)
#define MOLEMOLE_UIEXPEDITIONBUDDYSELECTPOPWINDOWCONTROLLER___C__DISPLAYCLASS43_0__GETAUTOTSELECTTARGET_B__1_OFFSET UNITYSDK_OFFSET(0x19AAE140)

namespace MoleMole
{
	inline static constexpr unsigned int UIExpeditionBuddySelectPopWindowController___c__DisplayClass43_0_TypeDefinitionIndex = 57710;
