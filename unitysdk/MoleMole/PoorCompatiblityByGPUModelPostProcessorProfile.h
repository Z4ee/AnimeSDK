...
#define MOLEMOLE_POORCOMPATIBLITYBYGPUMODELPOSTPROCESSORPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x129D7F10)
#define MOLEMOLE_POORCOMPATIBLITYBYGPUMODELPOSTPROCESSORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x129D7F80)
#define MOLEMOLE_POORCOMPATIBLITYBYGPUMODELPOSTPROCESSORPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x129D8000)

namespace MoleMole
{
	inline static constexpr unsigned int PoorCompatiblityByGPUModelPostProcessorProfile_TypeDefinitionIndex = 71973;
