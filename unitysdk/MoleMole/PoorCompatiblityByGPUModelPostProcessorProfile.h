...
#define MOLEMOLE_POORCOMPATIBLITYBYGPUMODELPOSTPROCESSORPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x173FB0A0)
#define MOLEMOLE_POORCOMPATIBLITYBYGPUMODELPOSTPROCESSORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x173FB110)
#define MOLEMOLE_POORCOMPATIBLITYBYGPUMODELPOSTPROCESSORPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x173FB190)

namespace MoleMole
{
	inline static constexpr unsigned int PoorCompatiblityByGPUModelPostProcessorProfile_TypeDefinitionIndex = 45224;
