...
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1802C1B0)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1802C120)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x1802C3E0)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1802C250)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1802BE70)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER_ONTRACKQUESTUPDATE_OFFSET UNITYSDK_OFFSET(0x1802D5F0)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1802BEE0)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER_REFRESHITEMVIEW_OFFSET UNITYSDK_OFFSET(0x1802C360)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER_REFRESHQUESTINFO_OFFSET UNITYSDK_OFFSET(0x1802C5F0)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER_REFRESHSELECTED_OFFSET UNITYSDK_OFFSET(0x1802C5B0)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER_REFRESHTRACKSTATE_OFFSET UNITYSDK_OFFSET(0x1802D330)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1802D640)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1802D6E0)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1802D650)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x1802D780)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1802D810)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1802D8B0)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1802D950)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangkovTaskRowWidgetController_TypeDefinitionIndex = 74381;
