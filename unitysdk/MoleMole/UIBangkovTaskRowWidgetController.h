...
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16366E90)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16366E00)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x163670C0)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16366F30)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16366B50)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER_ONTRACKQUESTUPDATE_OFFSET UNITYSDK_OFFSET(0x16368150)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16366BC0)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER_REFRESHITEMVIEW_OFFSET UNITYSDK_OFFSET(0x16367040)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER_REFRESHQUESTINFO_OFFSET UNITYSDK_OFFSET(0x16367240)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER_REFRESHSELECTED_OFFSET UNITYSDK_OFFSET(0x16367200)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER_REFRESHTRACKSTATE_OFFSET UNITYSDK_OFFSET(0x16367E90)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x163681A0)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16368240)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x163681B0)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x163682E0)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16368370)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16368410)
#define MOLEMOLE_UIBANGKOVTASKROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x163684B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangkovTaskRowWidgetController_TypeDefinitionIndex = 54893;

	class UIBangkovTaskRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_8E4120A0B29DC2E8* _view; // 0x2E8
		::Class_1_1710A4EE34865C78* _questData; // 0x2F0
