...
#define MOLEMOLE_UIMAINCITYCAMERAIMGTRACKWIDGETCONTROLLER_GETORCREATEWIDGET_OFFSET UNITYSDK_OFFSET(0x174D2F30)
#define MOLEMOLE_UIMAINCITYCAMERAIMGTRACKWIDGETCONTROLLER_ONCAMERACONTROLTIPSCLEARALL_OFFSET UNITYSDK_OFFSET(0x174D3060)
#define MOLEMOLE_UIMAINCITYCAMERAIMGTRACKWIDGETCONTROLLER_ONCAMERACONTROLTIPSMODIFY_OFFSET UNITYSDK_OFFSET(0x174D30D0)
#define MOLEMOLE_UIMAINCITYCAMERAIMGTRACKWIDGETCONTROLLER_ONCAMERACONTROLTIPSREMOVE_OFFSET UNITYSDK_OFFSET(0x174D33E0)
#define MOLEMOLE_UIMAINCITYCAMERAIMGTRACKWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x174D2670)
#define MOLEMOLE_UIMAINCITYCAMERAIMGTRACKWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x174D2620)
#define MOLEMOLE_UIMAINCITYCAMERAIMGTRACKWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x174D2700)
#define MOLEMOLE_UIMAINCITYCAMERAIMGTRACKWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x174D2470)
#define MOLEMOLE_UIMAINCITYCAMERAIMGTRACKWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x174D25B0)
#define MOLEMOLE_UIMAINCITYCAMERAIMGTRACKWIDGETCONTROLLER_REFRESHUI_OFFSET UNITYSDK_OFFSET(0x174D2780)
#define MOLEMOLE_UIMAINCITYCAMERAIMGTRACKWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x174D36F0)
#define MOLEMOLE_UIMAINCITYCAMERAIMGTRACKWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x174D3880)
#define MOLEMOLE_UIMAINCITYCAMERAIMGTRACKWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x174D3910)
#define MOLEMOLE_UIMAINCITYCAMERAIMGTRACKWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x174D3920)
#define MOLEMOLE_UIMAINCITYCAMERAIMGTRACKWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x174D39B0)
#define MOLEMOLE_UIMAINCITYCAMERAIMGTRACKWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x174D3A40)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityCameraImgTrackWidgetController_TypeDefinitionIndex = 40897;
	...
	public:
		...
		::Class_1_D80ACD1ACA5CCC2A* _cameraControlTip; // 0x2D8
