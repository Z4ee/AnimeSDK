...
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___C__DISPLAYCLASS50_2__CTOR_OFFSET UNITYSDK_OFFSET(0x149B8910)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___C__DISPLAYCLASS50_2__ONCLICKEQUIPLEVELBTN_B__2_OFFSET UNITYSDK_OFFSET(0x149B8920)

namespace MoleMole
{
	inline static constexpr unsigned int UIEquipDevelopPopWindowController___c__DisplayClass50_2_TypeDefinitionIndex = 44461;
	...
	public:
		...
		::System::Int32 rarity; // 0x20
		::System::UInt32 curlevel; // 0x24
