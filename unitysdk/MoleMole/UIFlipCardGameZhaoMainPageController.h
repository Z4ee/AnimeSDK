...
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER_FLIPCARDSUCCESSHANDLE_OFFSET UNITYSDK_OFFSET(0x15A576E0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15A566D0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x15A56AD0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER_ONACTIVITYCHANGE_OFFSET UNITYSDK_OFFSET(0x15A57590)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A566E0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER_ONCREATITEM_OFFSET UNITYSDK_OFFSET(0x15A575E0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER_ONINFOBTNCLICK_OFFSET UNITYSDK_OFFSET(0x15A57810)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER_ONITEMCHANGED_OFFSET UNITYSDK_OFFSET(0x15A574A0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER_ONREWARDBTNCLICK_OFFSET UNITYSDK_OFFSET(0x15A57970)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A57B90)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A56770)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x15A56C70)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x15A57C00)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15A57CA0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER__FLIPCARDSUCCESSHANDLE_B__15_0_OFFSET UNITYSDK_OFFSET(0x15A57CB0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A57D60)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A57DF0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A57E00)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x15A57E10)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlipCardGameZhaoMainPageController_TypeDefinitionIndex = 42558;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_40* _view; // 0x330
