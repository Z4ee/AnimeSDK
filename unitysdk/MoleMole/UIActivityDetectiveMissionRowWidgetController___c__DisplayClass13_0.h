...
#define MOLEMOLE_UIACTIVITYDETECTIVEMISSIONROWWIDGETCONTROLLER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A60F480)
#define MOLEMOLE_UIACTIVITYDETECTIVEMISSIONROWWIDGETCONTROLLER___C__DISPLAYCLASS13_0__TRACKQUESTTHENOPENMAINPAGE_B__0_OFFSET UNITYSDK_OFFSET(0x1A60F490)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityDetectiveMissionRowWidgetController___c__DisplayClass13_0_TypeDefinitionIndex = 85130;
