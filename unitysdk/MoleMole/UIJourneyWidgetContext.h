...
#define MOLEMOLE_UIJOURNEYWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x189B1470)

namespace MoleMole
{
	inline static constexpr unsigned int UIJourneyWidgetContext_TypeDefinitionIndex = 80741;
