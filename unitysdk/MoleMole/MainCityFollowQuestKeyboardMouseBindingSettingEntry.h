...
#define MOLEMOLE_MAINCITYFOLLOWQUESTKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x16E5D930)
#define MOLEMOLE_MAINCITYFOLLOWQUESTKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x16E5D940)
#define MOLEMOLE_MAINCITYFOLLOWQUESTKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x16E5D950)

namespace MoleMole
{
	inline static constexpr unsigned int MainCityFollowQuestKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 79051;
