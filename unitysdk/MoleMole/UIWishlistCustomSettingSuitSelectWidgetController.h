...
#define MOLEMOLE_UIWISHLISTCUSTOMSETTINGSUITSELECTWIDGETCONTROLLER_CREATESUITITEM_OFFSET UNITYSDK_OFFSET(0x11B9BEC0)
#define MOLEMOLE_UIWISHLISTCUSTOMSETTINGSUITSELECTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x11B9BD00)
#define MOLEMOLE_UIWISHLISTCUSTOMSETTINGSUITSELECTWIDGETCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x11B9BE10)
#define MOLEMOLE_UIWISHLISTCUSTOMSETTINGSUITSELECTWIDGETCONTROLLER_ONITEMCLICK_OFFSET UNITYSDK_OFFSET(0x11B9BFC0)
#define MOLEMOLE_UIWISHLISTCUSTOMSETTINGSUITSELECTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x11B9BD90)
#define MOLEMOLE_UIWISHLISTCUSTOMSETTINGSUITSELECTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x11B9B9C0)
#define MOLEMOLE_UIWISHLISTCUSTOMSETTINGSUITSELECTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x11B9BA20)
#define MOLEMOLE_UIWISHLISTCUSTOMSETTINGSUITSELECTWIDGETCONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0x11B9C280)
#define MOLEMOLE_UIWISHLISTCUSTOMSETTINGSUITSELECTWIDGETCONTROLLER_UPDATEDETAIL_OFFSET UNITYSDK_OFFSET(0x11B94E70)
#define MOLEMOLE_UIWISHLISTCUSTOMSETTINGSUITSELECTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11B9C480)
#define MOLEMOLE_UIWISHLISTCUSTOMSETTINGSUITSELECTWIDGETCONTROLLER__ONUIOPEN_B__6_0_OFFSET UNITYSDK_OFFSET(0x11B9C590)
#define MOLEMOLE_UIWISHLISTCUSTOMSETTINGSUITSELECTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x11B9C6C0)
#define MOLEMOLE_UIWISHLISTCUSTOMSETTINGSUITSELECTWIDGETCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x11B9C750)
#define MOLEMOLE_UIWISHLISTCUSTOMSETTINGSUITSELECTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x11B9C800)
#define MOLEMOLE_UIWISHLISTCUSTOMSETTINGSUITSELECTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x11B9C890)
#define MOLEMOLE_UIWISHLISTCUSTOMSETTINGSUITSELECTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x11B9C920)

namespace MoleMole
{
	inline static constexpr unsigned int UIWishlistCustomSettingSuitSelectWidgetController_TypeDefinitionIndex = 71654;

	class UIWishlistCustomSettingSuitSelectWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_66BE852A26D39BD4_1* _view; // 0x2B8
		::System::Collections::Generic::List_1<::System::UInt32>* _curSuitIds; // 0x2C0
		::System::Action_1<::System::Collections::Generic::List_1<::System::UInt32>*>* _OnSuitSelect; // 0x2C8
		::System::Collections::Generic::List_1<::Class_1_451601B8BB62C38C_5*>* _suitData; // 0x2D0
		::System::Int32 MaxSuitNum; // 0x2D8
