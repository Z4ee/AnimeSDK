...
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWSCROLLVIEWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x157C6920)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWSCROLLVIEWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x157C6990)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWSCROLLVIEWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x157C6A50)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWSCROLLVIEWWIDGETCONTROLLER_RESETPOS_OFFSET UNITYSDK_OFFSET(0x157C6BB0)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWSCROLLVIEWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x157C6C50)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWSCROLLVIEWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x157C6CB0)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWSCROLLVIEWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x157C6D50)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapRightListRowScrollViewWidgetController_TypeDefinitionIndex = 78956;
