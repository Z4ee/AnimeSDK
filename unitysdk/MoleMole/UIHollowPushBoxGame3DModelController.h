...
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_GETREFRT_OFFSET UNITYSDK_OFFSET(0x164D5110)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_GET_ATMASTERPOS_OFFSET UNITYSDK_OFFSET(0x164D4B50)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_GET_CHESSBOARDINDEX_OFFSET UNITYSDK_OFFSET(0x164D4B70)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_GET_CHESSBOARD_OFFSET UNITYSDK_OFFSET(0x164D4B90)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_GET_ISMOVEACTION_OFFSET UNITYSDK_OFFSET(0x164D5F60)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_GET_SECTIONUID_OFFSET UNITYSDK_OFFSET(0x164D4B30)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_INITCHESSBOARD_OFFSET UNITYSDK_OFFSET(0x164D4140)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x164D64D0)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_ONFINISHGRAPH_OFFSET UNITYSDK_OFFSET(0x164D5F00)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_ONHOLLOWGRIDUPDATE_OFFSET UNITYSDK_OFFSET(0x164D51F0)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_ONHOLLOWPUSHBACK_OFFSET UNITYSDK_OFFSET(0x164D4CD0)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_ONNPCUPDATE_OFFSET UNITYSDK_OFFSET(0x164D52C0)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x164D6560)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x164D5F70)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x164D62E0)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_PLAYFULLSCREENTEXTURE_OFFSET UNITYSDK_OFFSET(0x164D6460)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_REFRESHPLAYERAPPEARANCE_OFFSET UNITYSDK_OFFSET(0x164D5160)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_REFRESHPLAYERPOS_OFFSET UNITYSDK_OFFSET(0x164D5030)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_SETGAMERT_OFFSET UNITYSDK_OFFSET(0x164D5090)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_SETLASTMOVE_OFFSET UNITYSDK_OFFSET(0x164D5EA0)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_SET_ATMASTERPOS_OFFSET UNITYSDK_OFFSET(0x164D4B60)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_SET_CHESSBOARDINDEX_OFFSET UNITYSDK_OFFSET(0x164D4B80)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_SET_ISMOVEACTION_OFFSET UNITYSDK_OFFSET(0x164D5F50)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_SET_SECTIONUID_OFFSET UNITYSDK_OFFSET(0x164D4B40)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x164D4BA0)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x164D67F0)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x164D6780)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER__ONNPCUPDATE_G____ISBALLNPC_27_0_OFFSET UNITYSDK_OFFSET(0x164D5E00)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x164D6870)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x164D6900)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x164D6910)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x164D6920)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowPushBoxGame3DModelController_TypeDefinitionIndex = 63978;
	...
	public:
		...
		{
			return (::System::Collections::Generic::HashSet_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(UIHollowPushBoxGame3DModelController_TypeDefinitionIndex)->GetStaticField(0x3D0F0);
		}
		::Class_2_23D9BB4D5379D91C_5* _view; // 0x360
