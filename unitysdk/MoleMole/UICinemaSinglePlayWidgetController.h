...
class Class_2_7341BF3E408F4DA8_Class_2_2F70A5530E8B30FD;
...
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_CHANGEFEVERUICOLOR_OFFSET UNITYSDK_OFFSET(0x1605F4A0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_CHECKLOCATIONMISSCLICKABLE_OFFSET UNITYSDK_OFFSET(0x1605DC00)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_DESTORYEFFECTENTITY_OFFSET UNITYSDK_OFFSET(0x160562F0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_DESTROYMATERIALS_OFFSET UNITYSDK_OFFSET(0x16056E00)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_DISPATCHGRAPHEVENT_OFFSET UNITYSDK_OFFSET(0x1605DB40)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_ENDFEVEREFFECT_OFFSET UNITYSDK_OFFSET(0x16055DC0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_ENDSUPERBUBBLEEFFECT_OFFSET UNITYSDK_OFFSET(0x16056200)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_ENSUREINPUTACTIONISDOWN_OFFSET UNITYSDK_OFFSET(0x16058240)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GENERATEBADBUBBLECONTEXT_OFFSET UNITYSDK_OFFSET(0x1605B250)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GENERATEGOODBUBBLECONTEXT_OFFSET UNITYSDK_OFFSET(0x1605AE70)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GETCOMBOIMGBYINT_OFFSET UNITYSDK_OFFSET(0x1605ED30)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GETENTITYEFFECTBYTYPE_OFFSET UNITYSDK_OFFSET(0x16057160)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GETLOCATIONVIEWBYLOCATION_OFFSET UNITYSDK_OFFSET(0x1605B760)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GETMULTICLICKBUBBLEWIDGETBYSIDE_OFFSET UNITYSDK_OFFSET(0x1605C2C0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GETNORMALBUBBLEWIDGETBYSIDE_OFFSET UNITYSDK_OFFSET(0x1605B960)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GETVIEW_OFFSET UNITYSDK_OFFSET(0x160595D0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GET_ISTICKING_OFFSET UNITYSDK_OFFSET(0x160564F0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GET_MAINCAM_OFFSET UNITYSDK_OFFSET(0x16056480)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_HIDEFEVERUI_OFFSET UNITYSDK_OFFSET(0x1605F400)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_INITBACKGROUNDBTNGROUP_OFFSET UNITYSDK_OFFSET(0x16057AB0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_INITSCREENEFFECTPARAMS_OFFSET UNITYSDK_OFFSET(0x16055AD0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_INITTUTORIALLIST_OFFSET UNITYSDK_OFFSET(0x16057BE0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_INITUIMATERIALPARAMS_OFFSET UNITYSDK_OFFSET(0x16056570)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16057D40)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x16057E70)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16057DD0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16057800)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x160579A0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_PAUSEALLEVENT_OFFSET UNITYSDK_OFFSET(0x16058700)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_PLAYCOMBOINCREASEANIM_OFFSET UNITYSDK_OFFSET(0x1605E7B0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_PLAYFEVERSTARTEFFECT_OFFSET UNITYSDK_OFFSET(0x16055D20)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_PLAYFEVERWIDGETFADEANIM_OFFSET UNITYSDK_OFFSET(0x1605F1C0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_PLAYFEVERWIDGETFEVERANIM_OFFSET UNITYSDK_OFFSET(0x1605F280)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_PLAYSUPERBUBBLESTARTEFFECT_OFFSET UNITYSDK_OFFSET(0x16055FF0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_PLAYTIMEBARFEVERANIM_OFFSET UNITYSDK_OFFSET(0x1605F340)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_REFRESHCOMBO_OFFSET UNITYSDK_OFFSET(0x1605E690)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESETALLBUBBLE_OFFSET UNITYSDK_OFFSET(0x16059FF0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESETBUBBLEDIC_OFFSET UNITYSDK_OFFSET(0x1605A770)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESETDATAWHENRESTART_OFFSET UNITYSDK_OFFSET(0x16059620)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESETFEVERAPPEARPARAMSWHENRESTART_OFFSET UNITYSDK_OFFSET(0x160597B0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESETLOCATIONCLICKABLEDIC_OFFSET UNITYSDK_OFFSET(0x16059A90)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESETSOSETTING_OFFSET UNITYSDK_OFFSET(0x16059940)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESETTIMEBARUI_OFFSET UNITYSDK_OFFSET(0x1605ADE0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESETTIMEUI_OFFSET UNITYSDK_OFFSET(0x16059E00)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESETUI_OFFSET UNITYSDK_OFFSET(0x16059DB0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESUMEALLEVENT_OFFSET UNITYSDK_OFFSET(0x160588D0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SETNEWSCORE_OFFSET UNITYSDK_OFFSET(0x1605E280)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SETTIMEPROGRESS_OFFSET UNITYSDK_OFFSET(0x160592C0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWBADBUBBLE_1_OFFSET UNITYSDK_OFFSET(0x1605C680)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWBADBUBBLE_OFFSET UNITYSDK_OFFSET(0x1605C5E0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWCLEARALLBUBBLE_1_OFFSET UNITYSDK_OFFSET(0x1605D2E0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWCLEARALLBUBBLE_OFFSET UNITYSDK_OFFSET(0x1605D240)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWCOMBOATLOCATION_OFFSET UNITYSDK_OFFSET(0x1605D8D0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWCOMBOUI_INNER_OFFSET UNITYSDK_OFFSET(0x1605D940)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWENTEREFFECT_OFFSET UNITYSDK_OFFSET(0x160571F0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWFEVEREFFECT_OFFSET UNITYSDK_OFFSET(0x16055EB0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWFEVERTIPSDIALOG_OFFSET UNITYSDK_OFFSET(0x16055C50)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWFEVERUI_OFFSET UNITYSDK_OFFSET(0x1605F070)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWMULTICLICKBUBBLE_1_OFFSET UNITYSDK_OFFSET(0x1605BFE0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWMULTICLICKBUBBLE_OFFSET UNITYSDK_OFFSET(0x1605BF30)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWNORMALBUBBLE_1_OFFSET UNITYSDK_OFFSET(0x1605B490)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWNORMALBUBBLE_OFFSET UNITYSDK_OFFSET(0x1605B3F0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWPLAYEREFFECT_OFFSET UNITYSDK_OFFSET(0x160570D0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWSCOREATLOCATION_OFFSET UNITYSDK_OFFSET(0x1605D770)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWSUPERBUBBLEEFFECT_OFFSET UNITYSDK_OFFSET(0x160560C0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWSUPERBUBBLE_1_OFFSET UNITYSDK_OFFSET(0x1605CC10)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWSUPERBUBBLE_OFFSET UNITYSDK_OFFSET(0x1605CB70)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_STARTFEVERAPPEARUPDATE_OFFSET UNITYSDK_OFFSET(0x1605DF90)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_STARTFEVERAPPEAR_OFFSET UNITYSDK_OFFSET(0x1605EF30)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_STARTFEVERUPDATE_OFFSET UNITYSDK_OFFSET(0x1605DEF0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SWITCHGOODBUBBLESOUNDSTATE_OFFSET UNITYSDK_OFFSET(0x1605B020)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SWITCHLOCATIONMISSCLICKABLE_OFFSET UNITYSDK_OFFSET(0x1605DD50)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SWITCHUISHOW_OFFSET UNITYSDK_OFFSET(0x16059C20)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_TRIGGERAVATARANIMFINISH_OFFSET UNITYSDK_OFFSET(0x160598C0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_TRIGGERFEVEREND_OFFSET UNITYSDK_OFFSET(0x16059830)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_TRYTRIGGERAVATARANIMCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1605F5F0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_TRYTRIGGERLOGICEVENTWITHLOCATION_OFFSET UNITYSDK_OFFSET(0x16058050)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_TRYUPDATETIMELINEMANAGER_OFFSET UNITYSDK_OFFSET(0x16058660)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATEAVATARANIM_OFFSET UNITYSDK_OFFSET(0x16058B90)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATEBUBBLEDICT_OFFSET UNITYSDK_OFFSET(0x1605BD20)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATEBUBBLES_OFFSET UNITYSDK_OFFSET(0x16058C70)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATECOMBOCOUNT_OFFSET UNITYSDK_OFFSET(0x1605E740)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATECOMBOMULTIPLIER_OFFSET UNITYSDK_OFFSET(0x1605E890)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATEEVENTANIM_OFFSET UNITYSDK_OFFSET(0x16058AA0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATEFEVERAPPEAR_OFFSET UNITYSDK_OFFSET(0x160591E0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATEFEVER_OFFSET UNITYSDK_OFFSET(0x160590E0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATESCORE_OFFSET UNITYSDK_OFFSET(0x1605E0C0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATESCREENEFFECT_OFFSET UNITYSDK_OFFSET(0x16056500)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATETIMEBAR_OFFSET UNITYSDK_OFFSET(0x16058B20)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x160583F0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_WAITUNTILTIMECURSOR_OFFSET UNITYSDK_OFFSET(0x160563A0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER__CHANGEFEVERUICOLOR_B__123_0_OFFSET UNITYSDK_OFFSET(0x1605FB50)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER__CHANGEFEVERUICOLOR_B__123_1_OFFSET UNITYSDK_OFFSET(0x1605FBC0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1605F680)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER__HIDEFEVERUI_B__122_0_OFFSET UNITYSDK_OFFSET(0x1605FB40)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER__SHOWPLAYEREFFECT_B__36_0_OFFSET UNITYSDK_OFFSET(0x1605FAD0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER__STARTFEVERAPPEAR_B__117_0_OFFSET UNITYSDK_OFFSET(0x1605FB20)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER__STARTFEVERAPPEAR_B__117_1_OFFSET UNITYSDK_OFFSET(0x1605FB30)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1605FC30)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1605FC80)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1605FCB0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1605FCF0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1605FD30)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaSinglePlayWidgetController_TypeDefinitionIndex = 46341;
	...
	public:
		...
		::Class_2_7341BF3E408F4DA8_Class_2_2F70A5530E8B30FD* _scoreWidgetView; // 0x318
		...
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::Class_0_16E4307DCC419505_351*>* _displayBubbleDic; // 0x428
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* _locationEmptyClickableDic; // 0x430
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_351*>* _toBeRemovedList; // 0x438
		...
		::System::Void ShowNormalBubble(::Class_2_3F802DF1B3FAD67A_2* bubbleEvent, ::System::String* textmapText, ::System::Func_1<::Foundation::Tuple_2<::System::Int32, ::System::Single>>* onClick)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_3F802DF1B3FAD67A_2*, ::System::String*, ::System::Func_1<::Foundation::Tuple_2<::System::Int32, ::System::Single>>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWNORMALBUBBLE_OFFSET))(this, bubbleEvent, textmapText, onClick);
		}

		::System::Void ShowNormalBubble_1(::Class_2_3F802DF1B3FAD67A_2* bubbleEvent, ::System::String* textmapText, ::System::Int32 bubbleLocation, ::System::Single timeDuration, ::MoleMole::CinemaSingleBeatMapConfig_BeatMap_BeatItem item, ::System::Func_1<::Foundation::Tuple_2<::System::Int32, ::System::Single>>* onClick)
		{
		...
		::Class_0_16E4307DCC419505_351* GetNormalBubbleWidgetBySide(::System::Boolean isRightSide, ::UnityEngine::Transform* parentLocation, ::MoleMole::UICinemaBubbleBaseContext* context)
		{
			return ((::Class_0_16E4307DCC419505_351*(*)(::PVOID, ::System::Boolean, ::UnityEngine::Transform*, ::MoleMole::UICinemaBubbleBaseContext*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GETNORMALBUBBLEWIDGETBYSIDE_OFFSET))(this, isRightSide, parentLocation, context);
		}

		::System::Void ShowMultiClickBubble(::Class_2_3F802DF1B3FAD67A_1* bubbleEvent, ::System::String* textmapText, ::System::Int32 hitNum, ::System::Func_1<::Foundation::Tuple_2<::System::Int32, ::System::Single>>* onClick)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_3F802DF1B3FAD67A_1*, ::System::String*, ::System::Int32, ::System::Func_1<::Foundation::Tuple_2<::System::Int32, ::System::Single>>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWMULTICLICKBUBBLE_OFFSET))(this, bubbleEvent, textmapText, hitNum, onClick);
		}

		::System::Void ShowMultiClickBubble_1(::Class_2_3F802DF1B3FAD67A_1* bubbleEvent, ::System::String* textmapText, ::System::Int32 hitNum, ::System::Int32 bubbleLocation, ::System::Single timeDuration, ::MoleMole::CinemaSingleBeatMapConfig_BeatMap_BeatItem item, ::System::Func_1<::Foundation::Tuple_2<::System::Int32, ::System::Single>>* onClick)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_3F802DF1B3FAD67A_1*, ::System::String*, ::System::Int32, ::System::Int32, ::System::Single, ::MoleMole::CinemaSingleBeatMapConfig_BeatMap_BeatItem, ::System::Func_1<::Foundation::Tuple_2<::System::Int32, ::System::Single>>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWMULTICLICKBUBBLE_1_OFFSET))(this, bubbleEvent, textmapText, hitNum, bubbleLocation, timeDuration, item, onClick);
		}

		::Class_0_16E4307DCC419505_351* GetMultiClickBubbleWidgetBySide(::System::Boolean isRightSide, ::UnityEngine::Transform* parentLocation, ::MoleMole::UICinemaBubbleBaseContext* context)
		{
			return ((::Class_0_16E4307DCC419505_351*(*)(::PVOID, ::System::Boolean, ::UnityEngine::Transform*, ::MoleMole::UICinemaBubbleBaseContext*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GETMULTICLICKBUBBLEWIDGETBYSIDE_OFFSET))(this, isRightSide, parentLocation, context);
		}

		::System::Void ShowBadBubble(::Class_2_3F802DF1B3FAD67A_4* bubbleEvent, ::System::String* textmapText, ::System::Func_1<::System::Int32>* onClick)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_3F802DF1B3FAD67A_4*, ::System::String*, ::System::Func_1<::System::Int32>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWBADBUBBLE_OFFSET))(this, bubbleEvent, textmapText, onClick);
		}

		::System::Void ShowBadBubble_1(::Class_2_3F802DF1B3FAD67A_4* bubbleEvent, ::System::String* textmapText, ::System::Int32 bubbleLocation, ::System::Single timeDuration, ::MoleMole::CinemaSingleBeatMapConfig_BeatMap_BeatItem item, ::System::Func_1<::System::Int32>* onClick)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_3F802DF1B3FAD67A_4*, ::System::String*, ::System::Int32, ::System::Single, ::MoleMole::CinemaSingleBeatMapConfig_BeatMap_BeatItem, ::System::Func_1<::System::Int32>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWBADBUBBLE_1_OFFSET))(this, bubbleEvent, textmapText, bubbleLocation, timeDuration, item, onClick);
		}
		...
		::System::Void ShowClearAllBubble(::Class_2_3F802DF1B3FAD67A* bubbleEvent, ::System::String* textmapText, ::System::Func_1<::Foundation::Tuple_2<::System::Int32, ::System::Single>>* onClick)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_3F802DF1B3FAD67A*, ::System::String*, ::System::Func_1<::Foundation::Tuple_2<::System::Int32, ::System::Single>>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWCLEARALLBUBBLE_OFFSET))(this, bubbleEvent, textmapText, onClick);
		}

		::System::Void ShowClearAllBubble_1(::Class_2_3F802DF1B3FAD67A* bubbleEvent, ::System::String* textmapText, ::System::Int32 bubbleLocation, ::System::Single timeDuration, ::MoleMole::CinemaSingleBeatMapConfig_BeatMap_BeatItem item, ::System::Func_1<::Foundation::Tuple_2<::System::Int32, ::System::Single>>* onClick)
		{
		...
		::System::Void ShowComboAtLocation(::Class_2_7341BF3E408F4DA8_Class_2_5F3C14FED1CE4C5F* locationView)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_7341BF3E408F4DA8_Class_2_5F3C14FED1CE4C5F*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWCOMBOATLOCATION_OFFSET))(this, locationView);
		}
		...
		::Class_2_7341BF3E408F4DA8_Class_2_5F3C14FED1CE4C5F* GetLocationViewByLocation(::System::Int32 bubbleLocation)
		{
			return ((::Class_2_7341BF3E408F4DA8_Class_2_5F3C14FED1CE4C5F*(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GETLOCATIONVIEWBYLOCATION_OFFSET))(this, bubbleLocation);
		}
		...
		::System::Void UpdateBubbleDict(::MoleMole::CinemaSingleBeatMapConfig_BeatMap_BeatItem item, ::System::Int32 location, ::System::Boolean willShow, ::Class_0_16E4307DCC419505_351* bubble)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::CinemaSingleBeatMapConfig_BeatMap_BeatItem, ::System::Int32, ::System::Boolean, ::Class_0_16E4307DCC419505_351*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATEBUBBLEDICT_OFFSET))(this, item, location, willShow, bubble);
		}
		...
		::System::Void StartFeverUpdate(::Class_2_3F802DF1B3FAD67A_3* feverEvent, ::System::Action* onFeverEnd)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_3F802DF1B3FAD67A_3*, ::System::Action*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_STARTFEVERUPDATE_OFFSET))(this, feverEvent, onFeverEnd);
		}
