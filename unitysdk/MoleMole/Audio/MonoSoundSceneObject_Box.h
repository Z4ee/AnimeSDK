...
#define MOLEMOLE_AUDIO_MONOSOUNDSCENEOBJECT_BOX_AWAKE_OFFSET UNITYSDK_OFFSET(0xECE1810)
#define MOLEMOLE_AUDIO_MONOSOUNDSCENEOBJECT_BOX_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xECE1A30)
#define MOLEMOLE_AUDIO_MONOSOUNDSCENEOBJECT_BOX__CTOR_OFFSET UNITYSDK_OFFSET(0xECE1B60)

namespace MoleMole::Audio
{
	inline static constexpr unsigned int MonoSoundSceneObject_Box_TypeDefinitionIndex = 67173;
