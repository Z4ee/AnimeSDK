...
#define MOLEMOLE_AUDIO_MONOSOUNDSCENE_OUTERINGDOOR_AWAKE_OFFSET UNITYSDK_OFFSET(0x11002BA0)
#define MOLEMOLE_AUDIO_MONOSOUNDSCENE_OUTERINGDOOR_METHOD_5_AE828D899505A3B4_OFFSET UNITYSDK_OFFSET(0x110033C0)
#define MOLEMOLE_AUDIO_MONOSOUNDSCENE_OUTERINGDOOR_METHOD_5_CEA32FF190776922_OFFSET UNITYSDK_OFFSET(0x11002FD0)
#define MOLEMOLE_AUDIO_MONOSOUNDSCENE_OUTERINGDOOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x11003810)
#define MOLEMOLE_AUDIO_MONOSOUNDSCENE_OUTERINGDOOR_START_OFFSET UNITYSDK_OFFSET(0x11002C20)
#define MOLEMOLE_AUDIO_MONOSOUNDSCENE_OUTERINGDOOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x11002CF0)
#define MOLEMOLE_AUDIO_MONOSOUNDSCENE_OUTERINGDOOR__CTOR_OFFSET UNITYSDK_OFFSET(0x11003A30)

namespace MoleMole::Audio
{
	inline static constexpr unsigned int MonoSoundScene_OuteringDoor_TypeDefinitionIndex = 51358;
