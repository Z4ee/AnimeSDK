...
#define MOLEMOLE_AUDIO_SOUNDSUBSCRIPTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x114465E0)

namespace MoleMole::Audio
{
	inline static constexpr unsigned int SoundSubScriptBase_TypeDefinitionIndex = 45752;
