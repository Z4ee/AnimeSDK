...
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC_AUTOCOLLECTWAYPATHPOINTS_OFFSET UNITYSDK_OFFSET(0xFEFBC10)
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC_DRAWGIZMOSARROW_OFFSET UNITYSDK_OFFSET(0xFEFC5C0)
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC_INIT_OFFSET UNITYSDK_OFFSET(0xFEFB7F0)
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xFEFCC70)
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC_ONITEMACTIVECHANGED_OFFSET UNITYSDK_OFFSET(0xFEFB8B0)
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC_REGISTER_OFFSET UNITYSDK_OFFSET(0xFEFBFD0)
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC_UNREGISTER_OFFSET UNITYSDK_OFFSET(0xFEFC2F0)
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC__CTOR_OFFSET UNITYSDK_OFFSET(0xFEFD060)

namespace MoleMole::Audio
{
	inline static constexpr unsigned int SceneSound_WayPathToRTPC_TypeDefinitionIndex = 39049;
