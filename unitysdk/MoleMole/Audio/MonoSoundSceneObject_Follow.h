...
#define MOLEMOLE_AUDIO_MONOSOUNDSCENEOBJECT_FOLLOW_AWAKE_OFFSET UNITYSDK_OFFSET(0x174276E0)
#define MOLEMOLE_AUDIO_MONOSOUNDSCENEOBJECT_FOLLOW_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17427B10)
#define MOLEMOLE_AUDIO_MONOSOUNDSCENEOBJECT_FOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x17427CD0)

namespace MoleMole::Audio
{
	inline static constexpr unsigned int MonoSoundSceneObject_Follow_TypeDefinitionIndex = 48027;
