...
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC_WAYPATHTORTPC_SYNCMETHODPROVIDER_APPLYSYNCTOWWISE_OFFSET UNITYSDK_OFFSET(0x10CCCC10)
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC_WAYPATHTORTPC_SYNCMETHODPROVIDER_COMPUTESYNC_OFFSET UNITYSDK_OFFSET(0x10CCC790)
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC_WAYPATHTORTPC_SYNCMETHODPROVIDER_CREATE_OFFSET UNITYSDK_OFFSET(0x10CCD530)
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC_WAYPATHTORTPC_SYNCMETHODPROVIDER_INIT_OFFSET UNITYSDK_OFFSET(0x10CCCF20)
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC_WAYPATHTORTPC_SYNCMETHODPROVIDER_ONSYNC_OFFSET UNITYSDK_OFFSET(0x10CCD360)
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC_WAYPATHTORTPC_SYNCMETHODPROVIDER_POLISH_OFFSET UNITYSDK_OFFSET(0x10CCD3E0)
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC_WAYPATHTORTPC_SYNCMETHODPROVIDER_RECYCLE_OFFSET UNITYSDK_OFFSET(0x10CCD460)
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC_WAYPATHTORTPC_SYNCMETHODPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x10CCD5D0)

namespace MoleMole::Audio
{
	inline static constexpr unsigned int SceneSound_WayPathToRTPC_WayPathToRTPC_SyncMethodProvider_TypeDefinitionIndex = 65413;
	...
	public:
		...
		::System::Single _computedRtpcT; // 0x24
