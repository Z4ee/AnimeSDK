...
#define MOLEMOLE_AUDIO_MONOSCENESOUNDITEM_AWAKE_OFFSET UNITYSDK_OFFSET(0x13586B80)
#define MOLEMOLE_AUDIO_MONOSCENESOUNDITEM_GET_SOUNDACTIONSOURCEHINT_OFFSET UNITYSDK_OFFSET(0x13586B20)
#define MOLEMOLE_AUDIO_MONOSCENESOUNDITEM_GET_SOUNDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x13586B10)
#define MOLEMOLE_AUDIO_MONOSCENESOUNDITEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x13586C30)
#define MOLEMOLE_AUDIO_MONOSCENESOUNDITEM_ONSCENELEAVE_OFFSET UNITYSDK_OFFSET(0x13586F40)
#define MOLEMOLE_AUDIO_MONOSCENESOUNDITEM_ONSCENETAGCHANGED_OFFSET UNITYSDK_OFFSET(0x13586D10)
#define MOLEMOLE_AUDIO_MONOSCENESOUNDITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x13586FC0)

namespace MoleMole::Audio
{
	inline static constexpr unsigned int MonoSceneSoundItem_TypeDefinitionIndex = 63319;
