...
#define MOLEMOLE_AUDIO_MONOSOUND_PARTICLEEMITCALLBACK_GET_SOUNDACTIONSOURCEHINT_OFFSET UNITYSDK_OFFSET(0xF119CD0)
#define MOLEMOLE_AUDIO_MONOSOUND_PARTICLEEMITCALLBACK_GET_SOUNDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xF119880)
#define MOLEMOLE_AUDIO_MONOSOUND_PARTICLEEMITCALLBACK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xF11A0C0)
#define MOLEMOLE_AUDIO_MONOSOUND_PARTICLEEMITCALLBACK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xF119F30)
#define MOLEMOLE_AUDIO_MONOSOUND_PARTICLEEMITCALLBACK_ONENABLE_OFFSET UNITYSDK_OFFSET(0xF119D30)
#define MOLEMOLE_AUDIO_MONOSOUND_PARTICLEEMITCALLBACK_ONPARTICLEEMIT_OFFSET UNITYSDK_OFFSET(0xF11A370)
#define MOLEMOLE_AUDIO_MONOSOUND_PARTICLEEMITCALLBACK_UPDATE_OFFSET UNITYSDK_OFFSET(0xF11A410)
#define MOLEMOLE_AUDIO_MONOSOUND_PARTICLEEMITCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xF11A5C0)

namespace MoleMole::Audio
{
	inline static constexpr unsigned int MonoSound_ParticleEmitCallback_TypeDefinitionIndex = 62022;
