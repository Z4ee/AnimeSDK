...
#define MOLEMOLE_AUDIO_SOUNDSUBSCRIPT_MOVING_INIT_OFFSET UNITYSDK_OFFSET(0xFE8ABB0)
#define MOLEMOLE_AUDIO_SOUNDSUBSCRIPT_MOVING_ONSUBSCRIPTACTIVE_OFFSET UNITYSDK_OFFSET(0xFE8B0F0)
#define MOLEMOLE_AUDIO_SOUNDSUBSCRIPT_MOVING_ONSUBSCRIPTDEACTIVE_OFFSET UNITYSDK_OFFSET(0xFE8B430)
#define MOLEMOLE_AUDIO_SOUNDSUBSCRIPT_MOVING_ONSUBSCRIPTTICK_OFFSET UNITYSDK_OFFSET(0xFE8AC00)
#define MOLEMOLE_AUDIO_SOUNDSUBSCRIPT_MOVING__CTOR_OFFSET UNITYSDK_OFFSET(0xFE8B750)

namespace MoleMole::Audio
{
	inline static constexpr unsigned int SoundSubScript_Moving_TypeDefinitionIndex = 39324;
