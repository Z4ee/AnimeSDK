...
#define MOLEMOLE_AUDIO_SOUNDSUBSCRIPT_MOVING_INIT_OFFSET UNITYSDK_OFFSET(0x14342050)
#define MOLEMOLE_AUDIO_SOUNDSUBSCRIPT_MOVING_ONSUBSCRIPTACTIVE_OFFSET UNITYSDK_OFFSET(0x14342590)
#define MOLEMOLE_AUDIO_SOUNDSUBSCRIPT_MOVING_ONSUBSCRIPTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x143428D0)
#define MOLEMOLE_AUDIO_SOUNDSUBSCRIPT_MOVING_ONSUBSCRIPTTICK_OFFSET UNITYSDK_OFFSET(0x143420A0)
#define MOLEMOLE_AUDIO_SOUNDSUBSCRIPT_MOVING__CTOR_OFFSET UNITYSDK_OFFSET(0x14342BE0)

namespace MoleMole::Audio
{
	inline static constexpr unsigned int SoundSubScript_Moving_TypeDefinitionIndex = 86606;
