...
#define MOLEMOLE_AUDIO_MONOSOUND_SIMPLEMASTS_WATCHER_AWAKE_OFFSET UNITYSDK_OFFSET(0x11C76990)
#define MOLEMOLE_AUDIO_MONOSOUND_SIMPLEMASTS_WATCHER_METHOD_5_E21AC6EE08DC160A_OFFSET UNITYSDK_OFFSET(0x11C77350)
#define MOLEMOLE_AUDIO_MONOSOUND_SIMPLEMASTS_WATCHER_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0x11C76CF0)
#define MOLEMOLE_AUDIO_MONOSOUND_SIMPLEMASTS_WATCHER_START_OFFSET UNITYSDK_OFFSET(0x11C76A60)
#define MOLEMOLE_AUDIO_MONOSOUND_SIMPLEMASTS_WATCHER_UPDATE_OFFSET UNITYSDK_OFFSET(0x11C76D80)
#define MOLEMOLE_AUDIO_MONOSOUND_SIMPLEMASTS_WATCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x11C77280)

namespace MoleMole::Audio
{
	inline static constexpr unsigned int MonoSound_SimpleMASTS_Watcher_TypeDefinitionIndex = 65966;
