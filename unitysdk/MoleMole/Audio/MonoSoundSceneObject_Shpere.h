...
#define MOLEMOLE_AUDIO_MONOSOUNDSCENEOBJECT_SHPERE_AWAKE_OFFSET UNITYSDK_OFFSET(0xFE8A2D0)
#define MOLEMOLE_AUDIO_MONOSOUNDSCENEOBJECT_SHPERE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xFE8A4F0)
#define MOLEMOLE_AUDIO_MONOSOUNDSCENEOBJECT_SHPERE__CTOR_OFFSET UNITYSDK_OFFSET(0xFE8A620)

namespace MoleMole::Audio
{
	inline static constexpr unsigned int MonoSoundSceneObject_Shpere_TypeDefinitionIndex = 60269;
