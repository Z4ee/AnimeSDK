...
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS87_0__CTOR_OFFSET UNITYSDK_OFFSET(0x177E21C0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS87_0__PLAYAUDIOLIST_B__2_OFFSET UNITYSDK_OFFSET(0x177E21D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgamePageController___c__DisplayClass87_0_TypeDefinitionIndex = 54863;

	class UIGalgamePageController___c__DisplayClass87_0 : public ::System::Object
	{
	public:
		::MoleMole::GalGame::AudioEventItem* eventItem; // 0x10
