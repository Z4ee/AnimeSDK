...
#define MOLEMOLE_UIABYSSTALENTPOINTCONTROLLER_GETCANACTIVE_OFFSET UNITYSDK_OFFSET(0x17423100)
#define MOLEMOLE_UIABYSSTALENTPOINTCONTROLLER_GETISUNLOCK_OFFSET UNITYSDK_OFFSET(0x174231A0)
#define MOLEMOLE_UIABYSSTALENTPOINTCONTROLLER_GETMATERIALENOUGH_OFFSET UNITYSDK_OFFSET(0x17422B10)
#define MOLEMOLE_UIABYSSTALENTPOINTCONTROLLER_GETTALENTPOINTCFG_OFFSET UNITYSDK_OFFSET(0x17422AC0)
#define MOLEMOLE_UIABYSSTALENTPOINTCONTROLLER_GETTALENTPOINTID_OFFSET UNITYSDK_OFFSET(0x17422A60)
#define MOLEMOLE_UIABYSSTALENTPOINTCONTROLLER_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x17422470)
#define MOLEMOLE_UIABYSSTALENTPOINTCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17422600)
#define MOLEMOLE_UIABYSSTALENTPOINTCONTROLLER_ONSKINBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x17423210)
#define MOLEMOLE_UIABYSSTALENTPOINTCONTROLLER_PLAYACTIVEEFFECT_OFFSET UNITYSDK_OFFSET(0x17423310)
#define MOLEMOLE_UIABYSSTALENTPOINTCONTROLLER_PLAYUNLOCKEFFECT_OFFSET UNITYSDK_OFFSET(0x17423520)
#define MOLEMOLE_UIABYSSTALENTPOINTCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x17422CA0)
#define MOLEMOLE_UIABYSSTALENTPOINTCONTROLLER_SETCLICKACTION_OFFSET UNITYSDK_OFFSET(0x17422C50)
#define MOLEMOLE_UIABYSSTALENTPOINTCONTROLLER_SETSELECTED_OFFSET UNITYSDK_OFFSET(0x174232B0)
#define MOLEMOLE_UIABYSSTALENTPOINTCONTROLLER_SETTALENTPOINT_OFFSET UNITYSDK_OFFSET(0x174226F0)
#define MOLEMOLE_UIABYSSTALENTPOINTCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x174226B0)
#define MOLEMOLE_UIABYSSTALENTPOINTCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x174235E0)
#define MOLEMOLE_UIABYSSTALENTPOINTCONTROLLER___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x174237A0)
#define MOLEMOLE_UIABYSSTALENTPOINTCONTROLLER___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17423830)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssTalentPointController_TypeDefinitionIndex = 43117;
