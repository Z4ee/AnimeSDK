...
#define MOLEMOLE_WEAPONATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x174C2D00)

namespace MoleMole
{
	inline static constexpr unsigned int WeaponAttachPoint_TypeDefinitionIndex = 87159;
