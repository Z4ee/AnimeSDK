...
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER___C__DISPLAYCLASS29_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16767240)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER___C__DISPLAYCLASS29_0__ONCLICKBTN2_G__TRYOPENLEVELUPTIPS_0_OFFSET UNITYSDK_OFFSET(0x16767250)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleBuddyLevelupController___c__DisplayClass29_0_TypeDefinitionIndex = 65050;
	...
	public:
		...
		::System::Int32 cachedDurability; // 0x18
		::System::Int32 tarLv; // 0x1C
		::System::Int32 cachedExpedition; // 0x20
		::System::Int32 cachedSimulation; // 0x24
