...
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER___C__DISPLAYCLASS29_0__CTOR_OFFSET UNITYSDK_OFFSET(0x12C64BD0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER___C__DISPLAYCLASS29_0__ONCLICKBTN2_G__TRYOPENLEVELUPTIPS_0_OFFSET UNITYSDK_OFFSET(0x12C64BE0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleBuddyLevelupController___c__DisplayClass29_0_TypeDefinitionIndex = 71356;
	...
	public:
		...
		::System::Int32 cachedSimulation; // 0x20
		::System::Int32 prvLevel; // 0x24
