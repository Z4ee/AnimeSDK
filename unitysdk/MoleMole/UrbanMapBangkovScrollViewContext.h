...
#define MOLEMOLE_URBANMAPBANGKOVSCROLLVIEWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xF63DB70)

namespace MoleMole
{
	inline static constexpr unsigned int UrbanMapBangkovScrollViewContext_TypeDefinitionIndex = 66928;
	...
	public:
		...
		::System::Boolean EnableExpand; // 0x34
		::System::Boolean DefaultExpand; // 0x35
		::System::Int32 InitIndex; // 0x38
