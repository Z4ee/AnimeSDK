...
#define MOLEMOLE_UISOCIALCIRCLEJOINROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x154F5A50)
#define MOLEMOLE_UISOCIALCIRCLEJOINROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x154F5B20)
#define MOLEMOLE_UISOCIALCIRCLEJOINROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x154F5BE0)
#define MOLEMOLE_UISOCIALCIRCLEJOINROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x154F5AC0)
#define MOLEMOLE_UISOCIALCIRCLEJOINROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x154F5DA0)
#define MOLEMOLE_UISOCIALCIRCLEJOINROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x154F5DB0)
#define MOLEMOLE_UISOCIALCIRCLEJOINROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x154F5E50)
#define MOLEMOLE_UISOCIALCIRCLEJOINROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x154F5EF0)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleJoinRowWidgetController_TypeDefinitionIndex = 59786;
