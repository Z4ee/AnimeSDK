...
#define MOLEMOLE_UISOCIALCIRCLEJOINROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x178FA470)
#define MOLEMOLE_UISOCIALCIRCLEJOINROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x178FA540)
#define MOLEMOLE_UISOCIALCIRCLEJOINROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x178FA600)
#define MOLEMOLE_UISOCIALCIRCLEJOINROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x178FA4E0)
#define MOLEMOLE_UISOCIALCIRCLEJOINROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x178FA7C0)
#define MOLEMOLE_UISOCIALCIRCLEJOINROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x178FA7D0)
#define MOLEMOLE_UISOCIALCIRCLEJOINROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x178FA870)
#define MOLEMOLE_UISOCIALCIRCLEJOINROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x178FA910)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleJoinRowWidgetController_TypeDefinitionIndex = 82384;
