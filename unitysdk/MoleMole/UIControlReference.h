...
#define MOLEMOLE_UICONTROLREFERENCE_APPLYLAYOUTBYPLATFORM_OFFSET UNITYSDK_OFFSET(0x192BF8E0)
#define MOLEMOLE_UICONTROLREFERENCE_AWAKE_OFFSET UNITYSDK_OFFSET(0x192BF1B0)
#define MOLEMOLE_UICONTROLREFERENCE_COLLECTISCREENLAYOUTCOMPONENT_OFFSET UNITYSDK_OFFSET(0x192BF760)
#define MOLEMOLE_UICONTROLREFERENCE_COLLECTMULTILAYOUTPLATFORMCOMPONENT_OFFSET UNITYSDK_OFFSET(0x192BF460)
#define MOLEMOLE_UICONTROLREFERENCE_FORCEREBUILDLAYOUT_OFFSET UNITYSDK_OFFSET(0x192BFB20)
#define MOLEMOLE_UICONTROLREFERENCE_GET_ISVALIDCTRL_OFFSET UNITYSDK_OFFSET(0x192BF0D0)
#define MOLEMOLE_UICONTROLREFERENCE_INITLAYOUT_OFFSET UNITYSDK_OFFSET(0x192BF3B0)
#define MOLEMOLE_UICONTROLREFERENCE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x192BF210)
#define MOLEMOLE_UICONTROLREFERENCE_SHOWEXPORTDIR_OFFSET UNITYSDK_OFFSET(0x192BF170)
#define MOLEMOLE_UICONTROLREFERENCE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x192BFE50)
#define MOLEMOLE_UICONTROLREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x192BFEB0)
#define MOLEMOLE_UICONTROLREFERENCE___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x192BFF40)

namespace MoleMole
{
	inline static constexpr unsigned int UIControlReference_TypeDefinitionIndex = 89453;
