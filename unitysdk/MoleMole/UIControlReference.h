...
#define MOLEMOLE_UICONTROLREFERENCE_APPLYLAYOUTBYPLATFORM_OFFSET UNITYSDK_OFFSET(0x17F6D4A0)
#define MOLEMOLE_UICONTROLREFERENCE_AWAKE_OFFSET UNITYSDK_OFFSET(0x17F6CD70)
#define MOLEMOLE_UICONTROLREFERENCE_COLLECTISCREENLAYOUTCOMPONENT_OFFSET UNITYSDK_OFFSET(0x17F6D320)
#define MOLEMOLE_UICONTROLREFERENCE_COLLECTMULTILAYOUTPLATFORMCOMPONENT_OFFSET UNITYSDK_OFFSET(0x17F6D020)
#define MOLEMOLE_UICONTROLREFERENCE_FORCEREBUILDLAYOUT_OFFSET UNITYSDK_OFFSET(0x17F6D6E0)
#define MOLEMOLE_UICONTROLREFERENCE_GET_ISVALIDCTRL_OFFSET UNITYSDK_OFFSET(0x17F6CC90)
#define MOLEMOLE_UICONTROLREFERENCE_INITLAYOUT_OFFSET UNITYSDK_OFFSET(0x17F6CF70)
#define MOLEMOLE_UICONTROLREFERENCE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17F6CDD0)
#define MOLEMOLE_UICONTROLREFERENCE_SHOWEXPORTDIR_OFFSET UNITYSDK_OFFSET(0x17F6CD30)
#define MOLEMOLE_UICONTROLREFERENCE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17F6DA10)
#define MOLEMOLE_UICONTROLREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x17F6DA70)
#define MOLEMOLE_UICONTROLREFERENCE___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17F6DB00)

namespace MoleMole
{
	inline static constexpr unsigned int UIControlReference_TypeDefinitionIndex = 82775;
