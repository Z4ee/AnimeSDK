...
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_CLOSESELF_OFFSET UNITYSDK_OFFSET(0x196007B0)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x195FFBA0)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x195FFB90)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x195FFF40)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x19600590)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19600520)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x195FFBB0)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x195FFFD0)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_SETGAMEPADSELECTED_OFFSET UNITYSDK_OFFSET(0x196002E0)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_SETSELECTSERVERCALLBACK_OFFSET UNITYSDK_OFFSET(0x19600750)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19600800)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER__ONUIINIT_B__7_0_OFFSET UNITYSDK_OFFSET(0x19600890)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19600B20)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x19600BB0)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19600C40)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19600C50)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19600C60)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralSelectServerPopWindowController_TypeDefinitionIndex = 69537;

	class UIGeneralSelectServerPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_138* _view; // 0x318
