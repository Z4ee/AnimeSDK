...
class Class_2_79F6D62CE30E3F8E_174;
...
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_CLOSESELF_OFFSET UNITYSDK_OFFSET(0x16F72DF0)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x16F721F0)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x16F721E0)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16F72580)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x16F72BD0)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16F72B60)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16F72200)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16F72610)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_SETGAMEPADSELECTED_OFFSET UNITYSDK_OFFSET(0x16F72920)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_SETSELECTSERVERCALLBACK_OFFSET UNITYSDK_OFFSET(0x16F72D90)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16F72E40)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER__ONUIINIT_B__7_0_OFFSET UNITYSDK_OFFSET(0x16F72ED0)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16F73160)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x16F731F0)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16F73280)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16F73290)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16F732A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralSelectServerPopWindowController_TypeDefinitionIndex = 76524;

	class UIGeneralSelectServerPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_174* _view; // 0x318
		::System::Collections::Generic::List_1<::MoleMole::ServerListInfo*>* filterServerList; // 0x320
		::System::Int32 selectIndex; // 0x328
		::Class_2_80AC63F59C5E376B* _loginModel; // 0x330
		::System::Action_1<::MoleMole::ServerListInfo*>* OnSelect; // 0x338
		::System::Action* OnCancel; // 0x340
