...
#define MOLEMOLE_ANIMATORCLIPBLENDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x12AF4D30)

namespace MoleMole
{
	inline static constexpr unsigned int AnimatorClipBlendData_TypeDefinitionIndex = 84736;
