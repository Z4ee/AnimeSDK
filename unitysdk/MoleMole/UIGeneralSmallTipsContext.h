...
#define MOLEMOLE_UIGENERALSMALLTIPSCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F746A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralSmallTipsContext_TypeDefinitionIndex = 39761;
