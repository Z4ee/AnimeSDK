...
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER_BTNCONFIRM_OFFSET UNITYSDK_OFFSET(0x15A5ACA0)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x15A59EF0)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15A59EE0)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x15A5A6F0)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER_MASKCLOSEINNER_OFFSET UNITYSDK_OFFSET(0x15A5A280)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER_MASKCLOSE_OFFSET UNITYSDK_OFFSET(0x15A5A230)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A5A130)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x15A5A660)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A5A1C0)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A59F00)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15A5A0C0)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x15A5A950)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15A5AD70)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER__ONUIINIT_B__5_0_OFFSET UNITYSDK_OFFSET(0x15A5AD80)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER__ONUIINIT_B__5_1_OFFSET UNITYSDK_OFFSET(0x15A5AD90)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER___BASE_MASKCLOSE_OFFSET UNITYSDK_OFFSET(0x15A5ADA0)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A5AE30)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x15A5AEC0)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A5AEF0)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A5AF00)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15A5AF10)

namespace MoleMole
{
	inline static constexpr unsigned int UIKeyBindingConflictTipsPopWindowController_TypeDefinitionIndex = 67798;

	class UIKeyBindingConflictTipsPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_6D7677793BF052C1* _view; // 0x310
		::System::String* _strMsg; // 0x318
		::System::String* _strTitle; // 0x320
		::System::Action* _okBtnCb; // 0x328
		::System::Action* _cancelBtnCb; // 0x330
		::System::Collections::Generic::List_1<::Struct_2_029003AFE5A42E47>* _keyBindingInfos; // 0x338
		::MoleMole::UIKeyBindingContext* _context; // 0x340
