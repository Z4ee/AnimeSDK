...
#define MOLEMOLE_UIHANDBOOKDAILYWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18ED3DD0)
#define MOLEMOLE_UIHANDBOOKDAILYWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18ED3770)
#define MOLEMOLE_UIHANDBOOKDAILYWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18ED3E60)
#define MOLEMOLE_UIHANDBOOKDAILYWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18ED3130)
#define MOLEMOLE_UIHANDBOOKDAILYWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18ED3460)
#define MOLEMOLE_UIHANDBOOKDAILYWIDGETCONTROLLER_REFRESHREWARDBUFFVIEW_OFFSET UNITYSDK_OFFSET(0x18ED3950)
#define MOLEMOLE_UIHANDBOOKDAILYWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18ED3EE0)
#define MOLEMOLE_UIHANDBOOKDAILYWIDGETCONTROLLER__ONUIINIT_B__3_0_OFFSET UNITYSDK_OFFSET(0x18ED3FC0)
#define MOLEMOLE_UIHANDBOOKDAILYWIDGETCONTROLLER__ONUIINIT_B__3_1_OFFSET UNITYSDK_OFFSET(0x18ED3FE0)
#define MOLEMOLE_UIHANDBOOKDAILYWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18ED4000)
#define MOLEMOLE_UIHANDBOOKDAILYWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18ED4090)
#define MOLEMOLE_UIHANDBOOKDAILYWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18ED4130)
#define MOLEMOLE_UIHANDBOOKDAILYWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18ED41C0)
#define MOLEMOLE_UIHANDBOOKDAILYWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18ED4250)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookDailyWidgetController_TypeDefinitionIndex = 44691;

	class UIHandBookDailyWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_208CC9941471731A_917* _entry; // 0x2C0
		::Class_2_79AE422BA06F6D26_49* _view; // 0x2C8
