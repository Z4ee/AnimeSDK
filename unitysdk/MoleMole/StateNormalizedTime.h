...
#define MOLEMOLE_STATENORMALIZEDTIME_METHOD_4_03037A8F3F9539FB_OFFSET UNITYSDK_OFFSET(0x1642DD50)
#define MOLEMOLE_STATENORMALIZEDTIME_METHOD_4_2DB8CABC5F9281CC_1_OFFSET UNITYSDK_OFFSET(0x1642E450)
#define MOLEMOLE_STATENORMALIZEDTIME_METHOD_4_2DB8CABC5F9281CC_OFFSET UNITYSDK_OFFSET(0x1642E440)
#define MOLEMOLE_STATENORMALIZEDTIME_METHOD_4_A00C48FA484938DC_OFFSET UNITYSDK_OFFSET(0x1642D890)
#define MOLEMOLE_STATENORMALIZEDTIME_METHOD_4_DB213501C0A63F20_OFFSET UNITYSDK_OFFSET(0x1642D560)
#define MOLEMOLE_STATENORMALIZEDTIME_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x1642D300)
#define MOLEMOLE_STATENORMALIZEDTIME_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1642DCC0)
#define MOLEMOLE_STATENORMALIZEDTIME__CCTOR_OFFSET UNITYSDK_OFFSET(0x1642E3D0)
#define MOLEMOLE_STATENORMALIZEDTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1642E370)

namespace MoleMole
{
	inline static constexpr unsigned int StateNormalizedTime_TypeDefinitionIndex = 42133;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(StateNormalizedTime_TypeDefinitionIndex)->GetStaticField(0x126E0);
		}
		static ::System::Int32* StaticGet_normalizedTimeParamHash()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(StateNormalizedTime_TypeDefinitionIndex)->GetStaticField(0x126E4);
		}
