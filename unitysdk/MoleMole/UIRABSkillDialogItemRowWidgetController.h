...
#define MOLEMOLE_UIRABSKILLDIALOGITEMROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15614D80)
#define MOLEMOLE_UIRABSKILLDIALOGITEMROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15614DF0)
#define MOLEMOLE_UIRABSKILLDIALOGITEMROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15614E90)
#define MOLEMOLE_UIRABSKILLDIALOGITEMROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15615090)
#define MOLEMOLE_UIRABSKILLDIALOGITEMROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x156150F0)
#define MOLEMOLE_UIRABSKILLDIALOGITEMROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15615190)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABSkillDialogItemRowWidgetController_TypeDefinitionIndex = 45894;
