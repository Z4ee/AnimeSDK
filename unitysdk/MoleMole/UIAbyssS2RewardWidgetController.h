...
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1610CC10)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x1610CD20)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1610CD90)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1610CCA0)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1610CA20)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1610D6B0)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1610D840)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x1610D8D0)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1610D920)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1610D980)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1610DA10)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2RewardWidgetController_TypeDefinitionIndex = 66740;
	...
	public:
		...
		::Class_3_6EF456A21AE85EEC_329* TurntableItem; // 0x2F8
