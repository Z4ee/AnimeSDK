...
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12B36640)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x12B36750)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x12B367C0)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12B366D0)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12B36450)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12B370D0)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12B37260)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x12B372F0)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x12B37340)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12B373A0)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12B37430)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2RewardWidgetController_TypeDefinitionIndex = 73820;

	class UIAbyssS2RewardWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_E3273D40BBA403A7_1* _view; // 0x2E8
		::Class_3_6EF456A21AE85EEC_306* TurntableItem; // 0x2F0
