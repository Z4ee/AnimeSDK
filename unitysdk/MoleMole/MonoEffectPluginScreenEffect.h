...
#define MOLEMOLE_MONOEFFECTPLUGINSCREENEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19095FF0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginScreenEffect_TypeDefinitionIndex = 89452;
