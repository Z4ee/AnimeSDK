...
#define MOLEMOLE_UIFAKECANVASSCALER_GET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x16F42B30)
#define MOLEMOLE_UIFAKECANVASSCALER_SET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x16F42B50)
#define MOLEMOLE_UIFAKECANVASSCALER_UPDATEPARAMS_OFFSET UNITYSDK_OFFSET(0x16F42BB0)
#define MOLEMOLE_UIFAKECANVASSCALER__CTOR_OFFSET UNITYSDK_OFFSET(0x16F42E20)

namespace MoleMole
{
	inline static constexpr unsigned int UIFakeCanvasScaler_TypeDefinitionIndex = 56666;
