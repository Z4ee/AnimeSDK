...
#define MOLEMOLE_UIFAKECANVASSCALER_GET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x15F63290)
#define MOLEMOLE_UIFAKECANVASSCALER_SET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x15F632B0)
#define MOLEMOLE_UIFAKECANVASSCALER_UPDATEPARAMS_OFFSET UNITYSDK_OFFSET(0x15F63310)
#define MOLEMOLE_UIFAKECANVASSCALER__CTOR_OFFSET UNITYSDK_OFFSET(0x15F63580)

namespace MoleMole
{
	inline static constexpr unsigned int UIFakeCanvasScaler_TypeDefinitionIndex = 49063;
