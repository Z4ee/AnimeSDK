...
#define MOLEMOLE_UISUIBIANTEMPLEMAINPAGECONTROLLER___C__DISPLAYCLASS28_0__CTOR_OFFSET UNITYSDK_OFFSET(0x175B6000)
#define MOLEMOLE_UISUIBIANTEMPLEMAINPAGECONTROLLER___C__DISPLAYCLASS28_0__OPENDAILY_B__0_OFFSET UNITYSDK_OFFSET(0x175B6010)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleMainPageController___c__DisplayClass28_0_TypeDefinitionIndex = 89149;

	class UISuibianTempleMainPageController___c__DisplayClass28_0 : public ::System::Object
	{
	public:
		::MoleMole::SuibianTempleDailyPaperContext* context; // 0x10
