...
#define MOLEMOLE_VOLUMETRICFOGPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x14106EA0)
#define MOLEMOLE_VOLUMETRICFOGPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x14106FE0)
#define MOLEMOLE_VOLUMETRICFOGPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x14106DC0)
#define MOLEMOLE_VOLUMETRICFOGPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x14106F60)
#define MOLEMOLE_VOLUMETRICFOGPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x14106DB0)
#define MOLEMOLE_VOLUMETRICFOGPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x14107100)
#define MOLEMOLE_VOLUMETRICFOGPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x14107190)
#define MOLEMOLE_VOLUMETRICFOGPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x14107220)
#define MOLEMOLE_VOLUMETRICFOGPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x141072B0)

namespace MoleMole
{
	inline static constexpr unsigned int VolumetricFogProfile_TypeDefinitionIndex = 74633;
