...
#define MOLEMOLE_MESSAGEPUMPSHOWONGOING_GET_ISPENETRATE_OFFSET UNITYSDK_OFFSET(0x1908EE00)
#define MOLEMOLE_MESSAGEPUMPSHOWONGOING_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1908EE10)
#define MOLEMOLE_MESSAGEPUMPSHOWONGOING_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x1908EE50)
#define MOLEMOLE_MESSAGEPUMPSHOWONGOING__CTOR_OFFSET UNITYSDK_OFFSET(0x1908EE20)

namespace MoleMole
{
	inline static constexpr unsigned int MessagePumpShowOngoing_TypeDefinitionIndex = 70361;
