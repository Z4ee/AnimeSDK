...
#define MOLEMOLE_UIURBANMAPTRACKLINEWIDGETCONTEXT__GETWORLDPOINTSINMAINCITY_ASYNC_D__29_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x82EC50)
#define MOLEMOLE_UIURBANMAPTRACKLINEWIDGETCONTEXT__GETWORLDPOINTSINMAINCITY_ASYNC_D__29_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapTrackLineWidgetContext__GetWorldPointsInMainCity_Async_d__29_TypeDefinitionIndex = 54326;
	...
	struct alignas(8) UIUrbanMapTrackLineWidgetContext__GetWorldPointsInMainCity_Async_d__29
	{
		...
		::UnityEngine::Vector3 _targetNavPos_5__2; // 0x4C
