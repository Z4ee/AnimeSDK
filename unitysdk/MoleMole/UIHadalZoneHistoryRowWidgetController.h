...
#define MOLEMOLE_UIHADALZONEHISTORYROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18810970)
#define MOLEMOLE_UIHADALZONEHISTORYROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18810A40)
#define MOLEMOLE_UIHADALZONEHISTORYROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x18810B00)
#define MOLEMOLE_UIHADALZONEHISTORYROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x188109E0)
#define MOLEMOLE_UIHADALZONEHISTORYROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18810CA0)
#define MOLEMOLE_UIHADALZONEHISTORYROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18810CB0)
#define MOLEMOLE_UIHADALZONEHISTORYROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x18810D50)
#define MOLEMOLE_UIHADALZONEHISTORYROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18810DF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZoneHistoryRowWidgetController_TypeDefinitionIndex = 87530;
