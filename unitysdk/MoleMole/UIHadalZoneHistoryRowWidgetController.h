...
class Class_2_9A803EAB5CB0D4EC;
namespace MoleMole { class UIControlReference; }
namespace System { class Object; }

#define MOLEMOLE_UIHADALZONEHISTORYROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15CAF820)
#define MOLEMOLE_UIHADALZONEHISTORYROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15CAF8F0)
#define MOLEMOLE_UIHADALZONEHISTORYROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15CAF9B0)
#define MOLEMOLE_UIHADALZONEHISTORYROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15CAF890)
#define MOLEMOLE_UIHADALZONEHISTORYROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15CAFB50)
#define MOLEMOLE_UIHADALZONEHISTORYROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15CAFB60)
#define MOLEMOLE_UIHADALZONEHISTORYROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15CAFC00)
#define MOLEMOLE_UIHADALZONEHISTORYROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15CAFCA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZoneHistoryRowWidgetController_TypeDefinitionIndex = 75612;
	...
	public:
		...
		::Class_2_9A803EAB5CB0D4EC* get__viewModel()
		{
			return ((::Class_2_9A803EAB5CB0D4EC*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALZONEHISTORYROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
