...
#define MOLEMOLE_UIMAINCITYMENUSPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x15565AD0)
#define MOLEMOLE_UIMAINCITYMENUSPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15565AC0)
#define MOLEMOLE_UIMAINCITYMENUSPOPWINDOWCONTROLLER_INITSUNDRYVIEW_OFFSET UNITYSDK_OFFSET(0x155663E0)
#define MOLEMOLE_UIMAINCITYMENUSPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15565B30)
#define MOLEMOLE_UIMAINCITYMENUSPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x15566750)
#define MOLEMOLE_UIMAINCITYMENUSPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15565BC0)
#define MOLEMOLE_UIMAINCITYMENUSPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15565AE0)
#define MOLEMOLE_UIMAINCITYMENUSPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15565E40)
#define MOLEMOLE_UIMAINCITYMENUSPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15566910)
#define MOLEMOLE_UIMAINCITYMENUSPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x155669D0)
#define MOLEMOLE_UIMAINCITYMENUSPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x15566A60)
#define MOLEMOLE_UIMAINCITYMENUSPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15566A90)
#define MOLEMOLE_UIMAINCITYMENUSPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15566AA0)
#define MOLEMOLE_UIMAINCITYMENUSPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15566AB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityMenusPopWindowController_TypeDefinitionIndex = 68070;

	class UIMainCityMenusPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_95B29E984A609629* _view; // 0x310
		::MonoUITableScrollV2* _scroll; // 0x318
		::Enum_3_A8FC943A2182F177 _type; // 0x320
		::System::Collections::Generic::List_1<::System::Int32>* _sundryIndexs; // 0x328
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_771*>* _teleportDatas; // 0x330
