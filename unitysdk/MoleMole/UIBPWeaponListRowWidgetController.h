...
#define MOLEMOLE_UIBPWEAPONLISTROWWIDGETCONTROLLER_ONCLICKBPITEM_OFFSET UNITYSDK_OFFSET(0x172B9AC0)
#define MOLEMOLE_UIBPWEAPONLISTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x172B96E0)
#define MOLEMOLE_UIBPWEAPONLISTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x172B97F0)
#define MOLEMOLE_UIBPWEAPONLISTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x172B9770)
#define MOLEMOLE_UIBPWEAPONLISTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x172B9560)
#define MOLEMOLE_UIBPWEAPONLISTROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x172B9670)
#define MOLEMOLE_UIBPWEAPONLISTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x172B9B50)
#define MOLEMOLE_UIBPWEAPONLISTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x172B9B60)
#define MOLEMOLE_UIBPWEAPONLISTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x172B9BF0)
#define MOLEMOLE_UIBPWEAPONLISTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x172B9C90)
#define MOLEMOLE_UIBPWEAPONLISTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x172B9D20)
#define MOLEMOLE_UIBPWEAPONLISTROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x172B9DB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBPWeaponListRowWidgetController_TypeDefinitionIndex = 45055;
