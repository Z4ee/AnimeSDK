...
#define MOLEMOLE_POINTERCLICKFORWARDER_ATTACHTOSCROLLVIEWVIEWPORT_OFFSET UNITYSDK_OFFSET(0x13EB0730)
#define MOLEMOLE_POINTERCLICKFORWARDER_METHOD_5_160E21E8613C239F_OFFSET UNITYSDK_OFFSET(0x13EB0EE0)
#define MOLEMOLE_POINTERCLICKFORWARDER_METHOD_5_7135FE2B887E93E6_OFFSET UNITYSDK_OFFSET(0x13EB1560)
#define MOLEMOLE_POINTERCLICKFORWARDER_METHOD_5_90E066A4ED51851F_OFFSET UNITYSDK_OFFSET(0x13EB1450)
#define MOLEMOLE_POINTERCLICKFORWARDER_METHOD_5_C66EC3AEC1ED57FE_OFFSET UNITYSDK_OFFSET(0x13EB1200)
#define MOLEMOLE_POINTERCLICKFORWARDER_ONPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x13EB0420)
#define MOLEMOLE_POINTERCLICKFORWARDER_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x13EB0480)
#define MOLEMOLE_POINTERCLICKFORWARDER_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x13EB04D0)
#define MOLEMOLE_POINTERCLICKFORWARDER__CTOR_OFFSET UNITYSDK_OFFSET(0x13EB1510)

namespace MoleMole
{
	inline static constexpr unsigned int PointerClickForwarder_TypeDefinitionIndex = 69317;
