...
#define MOLEMOLE_UICINEMACOLLECTASSESSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15B639E0)
#define MOLEMOLE_UICINEMACOLLECTASSESSWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15B63AF0)
#define MOLEMOLE_UICINEMACOLLECTASSESSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15B63A70)
#define MOLEMOLE_UICINEMACOLLECTASSESSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15B63980)
#define MOLEMOLE_UICINEMACOLLECTASSESSWIDGETCONTROLLER_REFRESHASSESS_OFFSET UNITYSDK_OFFSET(0x15B63BF0)
#define MOLEMOLE_UICINEMACOLLECTASSESSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15B63F40)
#define MOLEMOLE_UICINEMACOLLECTASSESSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15B63F50)
#define MOLEMOLE_UICINEMACOLLECTASSESSWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15B63FE0)
#define MOLEMOLE_UICINEMACOLLECTASSESSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15B64080)
#define MOLEMOLE_UICINEMACOLLECTASSESSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15B64110)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaCollectAssessWidgetController_TypeDefinitionIndex = 58802;
