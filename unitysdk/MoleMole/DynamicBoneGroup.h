...
#define MOLEMOLE_DYNAMICBONEGROUP_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A375810)
#define MOLEMOLE_DYNAMICBONEGROUP_EMPTY_OFFSET UNITYSDK_OFFSET(0x1A3759E0)
#define MOLEMOLE_DYNAMICBONEGROUP_GETCOMPONENTSAFELY_OFFSET UNITYSDK_OFFSET(0x1A375AF0)
#define MOLEMOLE_DYNAMICBONEGROUP_MANUALFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1A376300)
#define MOLEMOLE_DYNAMICBONEGROUP_MANUALLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A3764F0)
#define MOLEMOLE_DYNAMICBONEGROUP_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0x1A376480)
#define MOLEMOLE_DYNAMICBONEGROUP_MANUALWAITFORFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1A3763E0)
#define MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x1A376750)
#define MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_151E25A63D14DDB0_1_OFFSET UNITYSDK_OFFSET(0x1A376110)
#define MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x1A375940)
#define MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x1A376280)
#define MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_3DD9CDD21849C79E_OFFSET UNITYSDK_OFFSET(0x1A375890)
#define MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_7DB49B5407C8FD68_OFFSET UNITYSDK_OFFSET(0x1A376C40)
#define MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_87318FF00D6BC7EB_OFFSET UNITYSDK_OFFSET(0x1A376600)
#define MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_C6A2F37261C7C003_OFFSET UNITYSDK_OFFSET(0x1A375DF0)
#define MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_D9F5295DDC8EAB8A_OFFSET UNITYSDK_OFFSET(0x1A376A10)
#define MOLEMOLE_DYNAMICBONEGROUP_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A375EE0)
#define MOLEMOLE_DYNAMICBONEGROUP_ONDYNAMICBONEDATAREADY_OFFSET UNITYSDK_OFFSET(0x1A376800)
#define MOLEMOLE_DYNAMICBONEGROUP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A375C20)
#define MOLEMOLE_DYNAMICBONEGROUP_START_OFFSET UNITYSDK_OFFSET(0x1A3758E0)
#define MOLEMOLE_DYNAMICBONEGROUP_SWITCHLOD_OFFSET UNITYSDK_OFFSET(0x1A376590)
#define MOLEMOLE_DYNAMICBONEGROUP_TRYSYNCTIMESCALE_OFFSET UNITYSDK_OFFSET(0x1A3761B0)
#define MOLEMOLE_DYNAMICBONEGROUP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A376970)
#define MOLEMOLE_DYNAMICBONEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3768D0)

namespace MoleMole
{
	inline static constexpr unsigned int DynamicBoneGroup_TypeDefinitionIndex = 68876;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::DynamicBoneGroup*>**)Il2CppClass::FromTypeDefinitionIndex(DynamicBoneGroup_TypeDefinitionIndex)->GetStaticField(0x4D800);
		}
