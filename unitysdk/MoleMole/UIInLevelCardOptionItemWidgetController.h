...
#define MOLEMOLE_UIINLEVELCARDOPTIONITEMWIDGETCONTROLLER_CHECKCARDISNEW_OFFSET UNITYSDK_OFFSET(0x19C6AAA0)
#define MOLEMOLE_UIINLEVELCARDOPTIONITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x19C6A990)
#define MOLEMOLE_UIINLEVELCARDOPTIONITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19C6AE60)
#define MOLEMOLE_UIINLEVELCARDOPTIONITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x19C6AE90)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelCardOptionItemWidgetController_TypeDefinitionIndex = 47311;
