...
#define MOLEMOLE_UIINLEVELCARDOPTIONITEMWIDGETCONTROLLER_CHECKCARDISNEW_OFFSET UNITYSDK_OFFSET(0x16BDCB10)
#define MOLEMOLE_UIINLEVELCARDOPTIONITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16BDCA00)
#define MOLEMOLE_UIINLEVELCARDOPTIONITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16BDCEC0)
#define MOLEMOLE_UIINLEVELCARDOPTIONITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16BDCEF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelCardOptionItemWidgetController_TypeDefinitionIndex = 66385;
