...
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER_EMPTYROWDATA_OFFSET UNITYSDK_OFFSET(0x178B2350)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER_GETMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x178B21D0)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER_GETOVERRIDEMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x178B23E0)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x178B2130)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER_REFRESHREWARDVIEW_OFFSET UNITYSDK_OFFSET(0x178B2920)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER_ROWDATA_OFFSET UNITYSDK_OFFSET(0x178B2240)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x178B3550)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER___BASE_GETMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x178B3560)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER___BASE_GETOVERRIDEMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x178B3590)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x178B3620)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER___BASE_REFRESHREWARDVIEW_OFFSET UNITYSDK_OFFSET(0x178B3630)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechResultPageController_TypeDefinitionIndex = 80318;
