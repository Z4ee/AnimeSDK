...
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER_EMPTYROWDATA_OFFSET UNITYSDK_OFFSET(0x15573E90)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER_GETMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x15573D10)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER_GETOVERRIDEMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x15573F20)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15573C70)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER_REFRESHREWARDVIEW_OFFSET UNITYSDK_OFFSET(0x15574460)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER_ROWDATA_OFFSET UNITYSDK_OFFSET(0x15573D80)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x155750A0)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER___BASE_GETMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x155750B0)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER___BASE_GETOVERRIDEMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x155750E0)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15575170)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER___BASE_REFRESHREWARDVIEW_OFFSET UNITYSDK_OFFSET(0x15575180)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechResultPageController_TypeDefinitionIndex = 68635;
