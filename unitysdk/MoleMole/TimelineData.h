...
#define MOLEMOLE_TIMELINEDATA_GETDEFAULTNEEDDISPLAYTIMELINERESOVERRIDE_OFFSET UNITYSDK_OFFSET(0x17E24CF0)
#define MOLEMOLE_TIMELINEDATA_GETIGNORETIMELINERESOVERRIDE_OFFSET UNITYSDK_OFFSET(0x17E24CB0)
#define MOLEMOLE_TIMELINEDATA_GET_AUDIORESPATH_OFFSET UNITYSDK_OFFSET(0x17E24B80)
#define MOLEMOLE_TIMELINEDATA_GET_FINALTIMELINERESPATH_OFFSET UNITYSDK_OFFSET(0x17E24B90)
#define MOLEMOLE_TIMELINEDATA_GET_RESPATH_OFFSET UNITYSDK_OFFSET(0x17E24B70)
#define MOLEMOLE_TIMELINEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x17E24D40)
#define MOLEMOLE_TIMELINEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17E24D30)

namespace MoleMole
{
	inline static constexpr unsigned int TimelineData_TypeDefinitionIndex = 71710;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(TimelineData_TypeDefinitionIndex)->GetStaticField(0x37AA0);
		}
