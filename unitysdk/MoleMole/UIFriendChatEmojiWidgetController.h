...
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_ADD_ONSELECTEMOJI_OFFSET UNITYSDK_OFFSET(0x183F27E0)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_CLOSEWIDGET_OFFSET UNITYSDK_OFFSET(0x183F1FD0)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x183F27C0)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_INITWIDGET_OFFSET UNITYSDK_OFFSET(0x183F1DE0)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_ONCLICKEMOJIGROUPITEM_OFFSET UNITYSDK_OFFSET(0x183F23F0)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_ONCLICKEMOJIITEM_OFFSET UNITYSDK_OFFSET(0x183F2220)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x183F1CD0)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x183F1D60)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x183F1340)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x183F1C60)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_READCURRENTEMOJIGROUPREDDOTS_OFFSET UNITYSDK_OFFSET(0x183F21B0)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_REMOVE_ONSELECTEMOJI_OFFSET UNITYSDK_OFFSET(0x183F2860)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_SET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x183F27D0)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_SHOWWIDGET_OFFSET UNITYSDK_OFFSET(0x183F1E30)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_TRYGETEMOJIGROUPID_OFFSET UNITYSDK_OFFSET(0x183F2730)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_UPDATEFAVEMOJI_OFFSET UNITYSDK_OFFSET(0x183F19F0)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER__CLOSEWIDGET_B__9_0_OFFSET UNITYSDK_OFFSET(0x183F2940)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x183F28E0)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x183F2950)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x183F29E0)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x183F2A70)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x183F2B00)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendChatEmojiWidgetController_TypeDefinitionIndex = 88203;

	class UIFriendChatEmojiWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_0C34F81D61279A93* _view; // 0x2C0
		::Class_2_2F3C7D4EFC74D485* _model; // 0x2C8
		::System::Boolean _isShow; // 0x2D0
		::System::Collections::Generic::List_1<::Class_1_26706B50B8C579CA*>* _emojiGroupDataList; // 0x2D8
		::System::Boolean _isFavGroup; // 0x2E0
		::System::Int32 _currentEmojiGroupId; // 0x2E4
		::System::Collections::Generic::List_1<::Class_1_A09FD06BA66A78D7*>* _displayEmojiDataList; // 0x2E8
		::System::Action_1<::System::Int32>* OnSelectEmoji; // 0x2F0
		...
		::System::Void ReadCurrentEmojiGroupRedDots()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_READCURRENTEMOJIGROUPREDDOTS_OFFSET))(this);
		}

		::System::Boolean TryGetEmojiGroupId(::Class_1_26706B50B8C579CA* groupData, ::System::Int32& groupId)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_26706B50B8C579CA*, ::System::Int32&))((::PBYTE)hIl2Cpp + MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_TRYGETEMOJIGROUPID_OFFSET))(this, groupData, groupId);
		}
