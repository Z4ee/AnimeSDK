...
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_ADD_ONSELECTEMOJI_OFFSET UNITYSDK_OFFSET(0x18445620)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_CLOSEWIDGET_OFFSET UNITYSDK_OFFSET(0x18445040)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x18445600)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_INITWIDGET_OFFSET UNITYSDK_OFFSET(0x18444E50)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_ONCLICKEMOJIGROUPITEM_OFFSET UNITYSDK_OFFSET(0x18445390)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_ONCLICKEMOJIITEM_OFFSET UNITYSDK_OFFSET(0x184451C0)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18444D40)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18444DD0)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x184443B0)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18444CD0)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_REMOVE_ONSELECTEMOJI_OFFSET UNITYSDK_OFFSET(0x184456A0)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_SET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x18445610)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_SHOWWIDGET_OFFSET UNITYSDK_OFFSET(0x18444EA0)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_UPDATEFAVEMOJI_OFFSET UNITYSDK_OFFSET(0x18444A60)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER__CLOSEWIDGET_B__9_0_OFFSET UNITYSDK_OFFSET(0x18445780)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18445720)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18445790)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18445820)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x184458B0)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18445940)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendChatEmojiWidgetController_TypeDefinitionIndex = 57278;
