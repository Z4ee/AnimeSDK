...
#define MOLEMOLE_NOTIFICATIONBADGE_BINDNOTIFICATIONNODE_OFFSET UNITYSDK_OFFSET(0x12B0B960)
#define MOLEMOLE_NOTIFICATIONBADGE_CHANGEBADGETYPE_OFFSET UNITYSDK_OFFSET(0x12B0AA70)
#define MOLEMOLE_NOTIFICATIONBADGE_CHANGEBADGEVIEWSTYLE_OFFSET UNITYSDK_OFFSET(0x12B0B780)
#define MOLEMOLE_NOTIFICATIONBADGE_CLEAR_OFFSET UNITYSDK_OFFSET(0x12B0ABF0)
#define MOLEMOLE_NOTIFICATIONBADGE_DISABLEWIDGET_OFFSET UNITYSDK_OFFSET(0x12B0ADC0)
#define MOLEMOLE_NOTIFICATIONBADGE_DOCOPYRESET_OFFSET UNITYSDK_OFFSET(0x12B0B910)
#define MOLEMOLE_NOTIFICATIONBADGE_ENABLEWEIGHT_OFFSET UNITYSDK_OFFSET(0x12B0AD60)
#define MOLEMOLE_NOTIFICATIONBADGE_GET_INITED_OFFSET UNITYSDK_OFFSET(0x12B0A360)
#define MOLEMOLE_NOTIFICATIONBADGE_GET_NOTIFICATIONNODE_OFFSET UNITYSDK_OFFSET(0x12B0A370)
#define MOLEMOLE_NOTIFICATIONBADGE_GET_NOTIFICATIONSHOWTYPE_OFFSET UNITYSDK_OFFSET(0x12B0A380)
#define MOLEMOLE_NOTIFICATIONBADGE_HIDE_OFFSET UNITYSDK_OFFSET(0x12B0ACA0)
#define MOLEMOLE_NOTIFICATIONBADGE_METHOD_5_10054BB010E03EDD_OFFSET UNITYSDK_OFFSET(0x12B0A570)
#define MOLEMOLE_NOTIFICATIONBADGE_METHOD_5_3F524323935909F6_OFFSET UNITYSDK_OFFSET(0x12B0BB50)
#define MOLEMOLE_NOTIFICATIONBADGE_METHOD_5_5D6194E16F7D8385_OFFSET UNITYSDK_OFFSET(0x12B0BCC0)
#define MOLEMOLE_NOTIFICATIONBADGE_METHOD_5_EE78BC891AD0F064_OFFSET UNITYSDK_OFFSET(0x12B0BAB0)
#define MOLEMOLE_NOTIFICATIONBADGE_METHOD_5_F2B94768004EB1C1_OFFSET UNITYSDK_OFFSET(0x12B0A770)
#define MOLEMOLE_NOTIFICATIONBADGE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x12B0A500)
#define MOLEMOLE_NOTIFICATIONBADGE_ONNOTIFY_OFFSET UNITYSDK_OFFSET(0x12B0A8A0)
#define MOLEMOLE_NOTIFICATIONBADGE_REGISTERNOTIFY_OFFSET UNITYSDK_OFFSET(0x12B0AE80)
#define MOLEMOLE_NOTIFICATIONBADGE_REGISTERSINGLESUBNOTIFY_OFFSET UNITYSDK_OFFSET(0x12B0B4F0)
#define MOLEMOLE_NOTIFICATIONBADGE_REGISTERSUBNOTIFY_OFFSET UNITYSDK_OFFSET(0x12B0B040)
#define MOLEMOLE_NOTIFICATIONBADGE_RESETNOTIFY_OFFSET UNITYSDK_OFFSET(0x12B0AC50)
#define MOLEMOLE_NOTIFICATIONBADGE_SETARRAYINDEX_OFFSET UNITYSDK_OFFSET(0x12B0AFF0)
#define MOLEMOLE_NOTIFICATIONBADGE_SETDYNAMICTYPE_OFFSET UNITYSDK_OFFSET(0x12B0AE20)
#define MOLEMOLE_NOTIFICATIONBADGE_SETINVOKESTATECHGCBONSAMESTATE_OFFSET UNITYSDK_OFFSET(0x12B0A850)
#define MOLEMOLE_NOTIFICATIONBADGE_SHOW_OFFSET UNITYSDK_OFFSET(0x12B0AD00)
#define MOLEMOLE_NOTIFICATIONBADGE_START_OFFSET UNITYSDK_OFFSET(0x12B0A390)
#define MOLEMOLE_NOTIFICATIONBADGE__CTOR_OFFSET UNITYSDK_OFFSET(0x12B0BA60)

namespace MoleMole
{
	inline static constexpr unsigned int NotificationBadge_TypeDefinitionIndex = 47927;
	...
	public:
		...
		::Class_1_CA1C390EF4AF39B6* Field_5_9; // 0x58
		::Class_1_1EA8435E138F2E03* Field_5_10; // 0x60
