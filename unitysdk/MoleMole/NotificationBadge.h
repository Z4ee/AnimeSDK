...
#define MOLEMOLE_NOTIFICATIONBADGE_BINDNOTIFICATIONNODE_OFFSET UNITYSDK_OFFSET(0x160E0330)
#define MOLEMOLE_NOTIFICATIONBADGE_CHANGEBADGETYPE_OFFSET UNITYSDK_OFFSET(0x160DF450)
#define MOLEMOLE_NOTIFICATIONBADGE_CHANGEBADGEVIEWSTYLE_OFFSET UNITYSDK_OFFSET(0x160E0150)
#define MOLEMOLE_NOTIFICATIONBADGE_CLEAR_OFFSET UNITYSDK_OFFSET(0x160DF5D0)
#define MOLEMOLE_NOTIFICATIONBADGE_DISABLEWIDGET_OFFSET UNITYSDK_OFFSET(0x160DF7A0)
#define MOLEMOLE_NOTIFICATIONBADGE_DOCOPYRESET_OFFSET UNITYSDK_OFFSET(0x160E02E0)
#define MOLEMOLE_NOTIFICATIONBADGE_ENABLEWEIGHT_OFFSET UNITYSDK_OFFSET(0x160DF740)
#define MOLEMOLE_NOTIFICATIONBADGE_GET_INITED_OFFSET UNITYSDK_OFFSET(0x160DED40)
#define MOLEMOLE_NOTIFICATIONBADGE_GET_NOTIFICATIONNODE_OFFSET UNITYSDK_OFFSET(0x160DED50)
#define MOLEMOLE_NOTIFICATIONBADGE_GET_NOTIFICATIONSHOWTYPE_OFFSET UNITYSDK_OFFSET(0x160DED60)
#define MOLEMOLE_NOTIFICATIONBADGE_HIDE_OFFSET UNITYSDK_OFFSET(0x160DF680)
#define MOLEMOLE_NOTIFICATIONBADGE_METHOD_5_10054BB010E03EDD_OFFSET UNITYSDK_OFFSET(0x160DEF50)
#define MOLEMOLE_NOTIFICATIONBADGE_METHOD_5_3F524323935909F6_OFFSET UNITYSDK_OFFSET(0x160E0480)
#define MOLEMOLE_NOTIFICATIONBADGE_METHOD_5_5D6194E16F7D8385_OFFSET UNITYSDK_OFFSET(0x160E0690)
#define MOLEMOLE_NOTIFICATIONBADGE_METHOD_5_EE78BC891AD0F064_OFFSET UNITYSDK_OFFSET(0x160E05F0)
#define MOLEMOLE_NOTIFICATIONBADGE_METHOD_5_F2B94768004EB1C1_OFFSET UNITYSDK_OFFSET(0x160DF150)
#define MOLEMOLE_NOTIFICATIONBADGE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x160DEEE0)
#define MOLEMOLE_NOTIFICATIONBADGE_ONNOTIFY_OFFSET UNITYSDK_OFFSET(0x160DF280)
#define MOLEMOLE_NOTIFICATIONBADGE_REGISTERNOTIFY_OFFSET UNITYSDK_OFFSET(0x160DF860)
#define MOLEMOLE_NOTIFICATIONBADGE_REGISTERSINGLESUBNOTIFY_OFFSET UNITYSDK_OFFSET(0x160DFEC0)
#define MOLEMOLE_NOTIFICATIONBADGE_REGISTERSUBNOTIFY_OFFSET UNITYSDK_OFFSET(0x160DFA20)
#define MOLEMOLE_NOTIFICATIONBADGE_RESETNOTIFY_OFFSET UNITYSDK_OFFSET(0x160DF630)
#define MOLEMOLE_NOTIFICATIONBADGE_SETARRAYINDEX_OFFSET UNITYSDK_OFFSET(0x160DF9D0)
#define MOLEMOLE_NOTIFICATIONBADGE_SETDYNAMICTYPE_OFFSET UNITYSDK_OFFSET(0x160DF800)
#define MOLEMOLE_NOTIFICATIONBADGE_SETINVOKESTATECHGCBONSAMESTATE_OFFSET UNITYSDK_OFFSET(0x160DF230)
#define MOLEMOLE_NOTIFICATIONBADGE_SHOW_OFFSET UNITYSDK_OFFSET(0x160DF6E0)
#define MOLEMOLE_NOTIFICATIONBADGE_START_OFFSET UNITYSDK_OFFSET(0x160DED70)
#define MOLEMOLE_NOTIFICATIONBADGE__CTOR_OFFSET UNITYSDK_OFFSET(0x160E0430)

namespace MoleMole
{
	inline static constexpr unsigned int NotificationBadge_TypeDefinitionIndex = 82721;
