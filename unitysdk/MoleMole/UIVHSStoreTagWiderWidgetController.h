...
#define MOLEMOLE_UIVHSSTORETAGWIDERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17D793B0)
#define MOLEMOLE_UIVHSSTORETAGWIDERWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17D794C0)
#define MOLEMOLE_UIVHSSTORETAGWIDERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17D79440)
#define MOLEMOLE_UIVHSSTORETAGWIDERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17D79760)
#define MOLEMOLE_UIVHSSTORETAGWIDERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17D79770)
#define MOLEMOLE_UIVHSSTORETAGWIDERWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17D79800)
#define MOLEMOLE_UIVHSSTORETAGWIDERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17D798A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSStoreTagWiderWidgetController_TypeDefinitionIndex = 59664;

	class UIVHSStoreTagWiderWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_0096754AC2F6E253_25* _view; // 0x2F0
