...
#define MOLEMOLE_UIABREWARDAVATARWIDGETCONTROLLER___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1643A770)
#define MOLEMOLE_UIABREWARDAVATARWIDGETCONTROLLER___C__DISPLAYCLASS3_0__ONUIINIT_B__0_OFFSET UNITYSDK_OFFSET(0x1643A780)
#define MOLEMOLE_UIABREWARDAVATARWIDGETCONTROLLER___C__DISPLAYCLASS3_0__ONUIINIT_B__1_OFFSET UNITYSDK_OFFSET(0x1643A810)

namespace MoleMole
{
	inline static constexpr unsigned int UIABRewardAvatarWidgetController___c__DisplayClass3_0_TypeDefinitionIndex = 53787;
