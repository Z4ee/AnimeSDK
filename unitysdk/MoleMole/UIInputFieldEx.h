...
#define MOLEMOLE_UIINPUTFIELDEX_AWAKE_OFFSET UNITYSDK_OFFSET(0x146B65D0)
#define MOLEMOLE_UIINPUTFIELDEX_BIND_OFFSET UNITYSDK_OFFSET(0x146B6840)
#define MOLEMOLE_UIINPUTFIELDEX_CANCELSELECT_OFFSET UNITYSDK_OFFSET(0x146B67B0)
#define MOLEMOLE_UIINPUTFIELDEX_METHOD_8_3923AB821AB9D6A6_OFFSET UNITYSDK_OFFSET(0x146B6BD0)
#define MOLEMOLE_UIINPUTFIELDEX_ONDESELECT_OFFSET UNITYSDK_OFFSET(0x146B6700)
#define MOLEMOLE_UIINPUTFIELDEX_ONSELECT_OFFSET UNITYSDK_OFFSET(0x146B6640)
#define MOLEMOLE_UIINPUTFIELDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x146B69F0)
#define MOLEMOLE_UIINPUTFIELDEX___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x146B6A50)
#define MOLEMOLE_UIINPUTFIELDEX___BASE_ONDESELECT_OFFSET UNITYSDK_OFFSET(0x146B6A60)
#define MOLEMOLE_UIINPUTFIELDEX___BASE_ONSELECT_OFFSET UNITYSDK_OFFSET(0x146B6B10)

namespace MoleMole
{
	inline static constexpr unsigned int UIInputFieldEx_TypeDefinitionIndex = 44173;
