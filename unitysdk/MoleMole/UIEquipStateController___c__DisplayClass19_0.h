...
#define MOLEMOLE_UIEQUIPSTATECONTROLLER___C__DISPLAYCLASS19_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1677E970)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER___C__DISPLAYCLASS19_0__TOGGLELOCK_B__0_OFFSET UNITYSDK_OFFSET(0x1677E980)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER___C__DISPLAYCLASS19_0__TOGGLELOCK_B__1_OFFSET UNITYSDK_OFFSET(0x1677E9E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIEquipStateController___c__DisplayClass19_0_TypeDefinitionIndex = 46191;
