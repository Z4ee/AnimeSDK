...
#define MOLEMOLE_UIEQUIPSTATECONTROLLER___C__DISPLAYCLASS19_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16491100)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER___C__DISPLAYCLASS19_0__TOGGLELOCK_B__0_OFFSET UNITYSDK_OFFSET(0x16491110)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER___C__DISPLAYCLASS19_0__TOGGLELOCK_B__1_OFFSET UNITYSDK_OFFSET(0x16491170)

namespace MoleMole
{
	inline static constexpr unsigned int UIEquipStateController___c__DisplayClass19_0_TypeDefinitionIndex = 67837;
