...
#define MOLEMOLE_CAMERASHOTDATA_GET_ADDTYPE_OFFSET UNITYSDK_OFFSET(0x10CD2590)
#define MOLEMOLE_CAMERASHOTDATA_GET_APPLYENTITYTIMESCALE_OFFSET UNITYSDK_OFFSET(0x10CD25E0)
#define MOLEMOLE_CAMERASHOTDATA_GET_BLENDDEFINITIONENTER_OFFSET UNITYSDK_OFFSET(0x10CD2630)
#define MOLEMOLE_CAMERASHOTDATA_GET_BLENDDEFINITIONEXIT_OFFSET UNITYSDK_OFFSET(0x10CD2640)
#define MOLEMOLE_CAMERASHOTDATA_GET_CINEPREFABPATH_OFFSET UNITYSDK_OFFSET(0x10CD2550)
#define MOLEMOLE_CAMERASHOTDATA_GET_DURATIONBYEVENT_OFFSET UNITYSDK_OFFSET(0x10CD25C0)
#define MOLEMOLE_CAMERASHOTDATA_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x10CD25B0)
#define MOLEMOLE_CAMERASHOTDATA_GET_FOLLOWROOTROT_OFFSET UNITYSDK_OFFSET(0x10CD2610)
#define MOLEMOLE_CAMERASHOTDATA_GET_INGORECAMCOLLIDERDETECT_OFFSET UNITYSDK_OFFSET(0x10CD25F0)
#define MOLEMOLE_CAMERASHOTDATA_GET_INGORETIMESCALE_OFFSET UNITYSDK_OFFSET(0x10CD25D0)
#define MOLEMOLE_CAMERASHOTDATA_GET_LOOKATTYPE_OFFSET UNITYSDK_OFFSET(0x10CD2620)
#define MOLEMOLE_CAMERASHOTDATA_GET_LOOPINITTIME_OFFSET UNITYSDK_OFFSET(0x10CD25A0)
#define MOLEMOLE_CAMERASHOTDATA_GET_PARENTTYPE_OFFSET UNITYSDK_OFFSET(0x10CD2600)
#define MOLEMOLE_CAMERASHOTDATA_GET_SKIPBANNERFADEIN_OFFSET UNITYSDK_OFFSET(0x10CD2570)
#define MOLEMOLE_CAMERASHOTDATA_GET_USEBANNER_OFFSET UNITYSDK_OFFSET(0x10CD2560)
#define MOLEMOLE_CAMERASHOTDATA_GET_VIDEOTYPE_OFFSET UNITYSDK_OFFSET(0x10CD2580)
#define MOLEMOLE_CAMERASHOTDATA_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x10CD2760)
#define MOLEMOLE_CAMERASHOTDATA_METHOD_1_BE0C2A5B39FEF128_OFFSET UNITYSDK_OFFSET(0x10CD2930)
#define MOLEMOLE_CAMERASHOTDATA_METHOD_1_CA8D2C39D135A2C2_OFFSET UNITYSDK_OFFSET(0x10CD2830)
#define MOLEMOLE_CAMERASHOTDATA_METHOD_1_DB546B80269157CF_OFFSET UNITYSDK_OFFSET(0x10CD27E0)
#define MOLEMOLE_CAMERASHOTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x10CD2650)

namespace MoleMole
{
	inline static constexpr unsigned int CameraShotData_TypeDefinitionIndex = 84620;
