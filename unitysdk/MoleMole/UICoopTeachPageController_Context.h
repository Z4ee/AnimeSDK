...
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x170AF0C0)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopTeachPageController_Context_TypeDefinitionIndex = 72012;
