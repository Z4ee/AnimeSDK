...
#define MOLEMOLE_UILEVELRESULTPAGECONTEXT_ISADDITIONAUPITEM_OFFSET UNITYSDK_OFFSET(0x150E8050)
#define MOLEMOLE_UILEVELRESULTPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x150E80B0)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultPageContext_TypeDefinitionIndex = 53531;

	class UILevelResultPageContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::Class_1_516A565475879095<::System::UInt32, ::Class_3_1A345EAE5F749316_11*>* RawRewardReasonItemMap; // 0x28
		::Class_3_AE02BC8285203464_6* dungeonDoneRet; // 0x30
		::System::Action* OnFairyBtnAction; // 0x38
		::Class_1_516A565475879095<::System::UInt32, ::Class_3_D0B68EB9E337E202_1*>* RawRewardItemReasonMap; // 0x40
		::System::Action* OnRestartBattleAction; // 0x48
		::System::Action* OnStartFadeInFinsh; // 0x50
		::System::Collections::Generic::HashSet_1<::System::Int32>* additionalUpItemSet; // 0x58
		::System::Collections::Generic::IDictionary_2<::System::UInt32, ::Class_3_452E05BC28CF3B11*>* FightRewards; // 0x60
		::System::Action* OnContinueAction; // 0x68
		::System::Action* OnExitBattleAction; // 0x70
		::Enum_3_3FDE76C86672FDDC ShowType; // 0x78
		::System::Boolean enableDelayExit; // 0x7C
		::System::Boolean canRevive; // 0x7D
		::System::Single delayExitTime; // 0x80
		::System::Boolean IsOvernight; // 0x84
		::System::Boolean isWin; // 0x85
		::System::Boolean Procedure; // 0x86
