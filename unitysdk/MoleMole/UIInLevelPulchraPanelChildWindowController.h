...
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER_COLLECTALLANIMATIONCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x177CA7F0)
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER_GET_ISARRIVEMAXATTACKTIME_OFFSET UNITYSDK_OFFSET(0x177C9D50)
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x177C9D40)
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER_HANDLEALLCUSTOMPROPERTIESONSHOW_OFFSET UNITYSDK_OFFSET(0x177C9F80)
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER_HANDLECURATTACKTIME_OFFSET UNITYSDK_OFFSET(0x177CA1F0)
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER_HANDLECUSTOMPROPERTY_OFFSET UNITYSDK_OFFSET(0x177CA080)
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER_HANDLEISENHANCE_OFFSET UNITYSDK_OFFSET(0x177CA830)
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER_HANDLEMAXATTACKTIME_OFFSET UNITYSDK_OFFSET(0x177CA380)
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x177CA770)
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x177C9E20)
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x177C9EB0)
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x177CA9A0)
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER___BASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x177CAA30)
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x177CAAC0)
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x177CAB50)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPulchraPanelChildWindowController_TypeDefinitionIndex = 59115;

	class UIInLevelPulchraPanelChildWindowController : public ::MonoCustomPropertyUIControllerBase
	{
	public:
		::Class_2_5E2FBACADDB625B7_25* _view; // 0x350
