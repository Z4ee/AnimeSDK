...
#define MOLEMOLE_SHADOWQUALITYSETTINGENTRY_GET_PROFILETYPE_OFFSET UNITYSDK_OFFSET(0x18714FE0)
#define MOLEMOLE_SHADOWQUALITYSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x18714FD0)
#define MOLEMOLE_SHADOWQUALITYSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x18714FF0)

namespace MoleMole
{
	inline static constexpr unsigned int ShadowQualitySettingEntry_TypeDefinitionIndex = 47883;
