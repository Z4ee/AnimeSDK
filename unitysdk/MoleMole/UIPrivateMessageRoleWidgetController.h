...
#define MOLEMOLE_UIPRIVATEMESSAGEROLEWIDGETCONTROLLER_CANCELNEW_OFFSET UNITYSDK_OFFSET(0x17A0E770)
#define MOLEMOLE_UIPRIVATEMESSAGEROLEWIDGETCONTROLLER_EXPAND_OFFSET UNITYSDK_OFFSET(0x17A0E7D0)
#define MOLEMOLE_UIPRIVATEMESSAGEROLEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17A0D620)
#define MOLEMOLE_UIPRIVATEMESSAGEROLEWIDGETCONTROLLER_ONFINISHMESSAGEGROUP_OFFSET UNITYSDK_OFFSET(0x17A0EC20)
#define MOLEMOLE_UIPRIVATEMESSAGEROLEWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x17A0D800)
#define MOLEMOLE_UIPRIVATEMESSAGEROLEWIDGETCONTROLLER_ONNOTIFICATIONCOUNTCHANGE_OFFSET UNITYSDK_OFFSET(0x17A0FC80)
#define MOLEMOLE_UIPRIVATEMESSAGEROLEWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17A0D890)
#define MOLEMOLE_UIPRIVATEMESSAGEROLEWIDGETCONTROLLER_ONSHOWCURMESSAGE_OFFSET UNITYSDK_OFFSET(0x17A0EB30)
#define MOLEMOLE_UIPRIVATEMESSAGEROLEWIDGETCONTROLLER_ONSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x17A0E320)
#define MOLEMOLE_UIPRIVATEMESSAGEROLEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17A0D6B0)
#define MOLEMOLE_UIPRIVATEMESSAGEROLEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17A0D1D0)
#define MOLEMOLE_UIPRIVATEMESSAGEROLEWIDGETCONTROLLER_SETMESSAGETEXT_OFFSET UNITYSDK_OFFSET(0x17A0F520)
#define MOLEMOLE_UIPRIVATEMESSAGEROLEWIDGETCONTROLLER_SHOWBUBBLE_OFFSET UNITYSDK_OFFSET(0x17A0ED90)
#define MOLEMOLE_UIPRIVATEMESSAGEROLEWIDGETCONTROLLER_SHOWCONTACTUSERDATA_OFFSET UNITYSDK_OFFSET(0x17A0DF80)
#define MOLEMOLE_UIPRIVATEMESSAGEROLEWIDGETCONTROLLER_SHOWCONTACTUSERMESSAGE_OFFSET UNITYSDK_OFFSET(0x17A0E590)
#define MOLEMOLE_UIPRIVATEMESSAGEROLEWIDGETCONTROLLER_SHOWMESSAGE_OFFSET UNITYSDK_OFFSET(0x17A0E450)
#define MOLEMOLE_UIPRIVATEMESSAGEROLEWIDGETCONTROLLER_SHOWMISSIONICON_OFFSET UNITYSDK_OFFSET(0x17A0FCE0)
#define MOLEMOLE_UIPRIVATEMESSAGEROLEWIDGETCONTROLLER_SHOWTEXTELLIPSE_OFFSET UNITYSDK_OFFSET(0x17A0F3D0)
#define MOLEMOLE_UIPRIVATEMESSAGEROLEWIDGETCONTROLLER_SHOWUSERDATA_OFFSET UNITYSDK_OFFSET(0x17A0DD20)
#define MOLEMOLE_UIPRIVATEMESSAGEROLEWIDGETCONTROLLER_SHRINK_OFFSET UNITYSDK_OFFSET(0x17A0E980)
#define MOLEMOLE_UIPRIVATEMESSAGEROLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17A0FF50)
#define MOLEMOLE_UIPRIVATEMESSAGEROLEWIDGETCONTROLLER__SETMESSAGETEXT_G__SETCOLOR_27_0_OFFSET UNITYSDK_OFFSET(0x17A0FED0)
#define MOLEMOLE_UIPRIVATEMESSAGEROLEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17A0FF60)
#define MOLEMOLE_UIPRIVATEMESSAGEROLEWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x17A0FFF0)
#define MOLEMOLE_UIPRIVATEMESSAGEROLEWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17A10080)
#define MOLEMOLE_UIPRIVATEMESSAGEROLEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17A10120)
#define MOLEMOLE_UIPRIVATEMESSAGEROLEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17A101B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPrivateMessageRoleWidgetController_TypeDefinitionIndex = 43170;

	class UIPrivateMessageRoleWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_31* _view; // 0x2F0
		::Class_1_794BA983EDDBCFDE_Class_1_2C0963FB259F05B7* _myData; // 0x2F8
		::Class_2_50D4513E183E3E1B* _messageModel; // 0x300
