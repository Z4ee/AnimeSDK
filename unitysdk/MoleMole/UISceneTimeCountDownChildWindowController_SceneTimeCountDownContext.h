...
#define MOLEMOLE_UISCENETIMECOUNTDOWNCHILDWINDOWCONTROLLER_SCENETIMECOUNTDOWNCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1616D410)

namespace MoleMole
{
	inline static constexpr unsigned int UISceneTimeCountDownChildWindowController_SceneTimeCountDownContext_TypeDefinitionIndex = 55432;

	class UISceneTimeCountDownChildWindowController_SceneTimeCountDownContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::Class_0_16E4307DCC419505_409* Support; // 0x28
