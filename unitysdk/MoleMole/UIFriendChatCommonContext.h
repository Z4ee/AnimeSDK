...
#define MOLEMOLE_UIFRIENDCHATCOMMONCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F322D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendChatCommonContext_TypeDefinitionIndex = 55904;
