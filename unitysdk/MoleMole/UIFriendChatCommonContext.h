...
#define MOLEMOLE_UIFRIENDCHATCOMMONCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18D7CD30)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendChatCommonContext_TypeDefinitionIndex = 76750;
