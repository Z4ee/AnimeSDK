...
#define MOLEMOLE_UIACTIVITYSELECTLEVELDOUBLEICONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1676A960)
#define MOLEMOLE_UIACTIVITYSELECTLEVELDOUBLEICONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1676B050)
#define MOLEMOLE_UIACTIVITYSELECTLEVELDOUBLEICONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1676A890)
#define MOLEMOLE_UIACTIVITYSELECTLEVELDOUBLEICONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1676A8F0)
#define MOLEMOLE_UIACTIVITYSELECTLEVELDOUBLEICONWIDGETCONTROLLER_SETCLICKACTION_OFFSET UNITYSDK_OFFSET(0x1676AF30)
#define MOLEMOLE_UIACTIVITYSELECTLEVELDOUBLEICONWIDGETCONTROLLER_SETID_OFFSET UNITYSDK_OFFSET(0x1676A9F0)
#define MOLEMOLE_UIACTIVITYSELECTLEVELDOUBLEICONWIDGETCONTROLLER_SETISPARTNERVIEW_OFFSET UNITYSDK_OFFSET(0x167612D0)
#define MOLEMOLE_UIACTIVITYSELECTLEVELDOUBLEICONWIDGETCONTROLLER_SETMAINTEXTVIEW_OFFSET UNITYSDK_OFFSET(0x1676AD80)
#define MOLEMOLE_UIACTIVITYSELECTLEVELDOUBLEICONWIDGETCONTROLLER_SETPARTNERTEXTVIEW_OFFSET UNITYSDK_OFFSET(0x1676ABD0)
#define MOLEMOLE_UIACTIVITYSELECTLEVELDOUBLEICONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1676B0D0)
#define MOLEMOLE_UIACTIVITYSELECTLEVELDOUBLEICONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1676B1B0)
#define MOLEMOLE_UIACTIVITYSELECTLEVELDOUBLEICONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1676B240)
#define MOLEMOLE_UIACTIVITYSELECTLEVELDOUBLEICONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1676B2D0)
#define MOLEMOLE_UIACTIVITYSELECTLEVELDOUBLEICONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1676B360)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivitySelectLevelDoubleIconWidgetController_TypeDefinitionIndex = 45495;

	class UIActivitySelectLevelDoubleIconWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_BA39D6ED91527A4D* _view; // 0x2B8
		::UnityEngine::UI::GridLayoutGroup_Corner StartCorner; // 0x2C0
		::System::Collections::Generic::List_1<::MoleMole::UIGeneralHeadRowWidgetController*>* heads; // 0x2C8
