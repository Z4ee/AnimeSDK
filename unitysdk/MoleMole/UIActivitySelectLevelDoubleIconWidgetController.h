...
#define MOLEMOLE_UIACTIVITYSELECTLEVELDOUBLEICONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1A1F5400)
#define MOLEMOLE_UIACTIVITYSELECTLEVELDOUBLEICONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1A1F5AF0)
#define MOLEMOLE_UIACTIVITYSELECTLEVELDOUBLEICONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1A1F5330)
#define MOLEMOLE_UIACTIVITYSELECTLEVELDOUBLEICONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1A1F5390)
#define MOLEMOLE_UIACTIVITYSELECTLEVELDOUBLEICONWIDGETCONTROLLER_SETCLICKACTION_OFFSET UNITYSDK_OFFSET(0x1A1F59D0)
#define MOLEMOLE_UIACTIVITYSELECTLEVELDOUBLEICONWIDGETCONTROLLER_SETID_OFFSET UNITYSDK_OFFSET(0x1A1F5490)
#define MOLEMOLE_UIACTIVITYSELECTLEVELDOUBLEICONWIDGETCONTROLLER_SETISPARTNERVIEW_OFFSET UNITYSDK_OFFSET(0x1A1EBD60)
#define MOLEMOLE_UIACTIVITYSELECTLEVELDOUBLEICONWIDGETCONTROLLER_SETMAINTEXTVIEW_OFFSET UNITYSDK_OFFSET(0x1A1F5820)
#define MOLEMOLE_UIACTIVITYSELECTLEVELDOUBLEICONWIDGETCONTROLLER_SETPARTNERTEXTVIEW_OFFSET UNITYSDK_OFFSET(0x1A1F5670)
#define MOLEMOLE_UIACTIVITYSELECTLEVELDOUBLEICONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1F5B70)
#define MOLEMOLE_UIACTIVITYSELECTLEVELDOUBLEICONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1A1F5C50)
#define MOLEMOLE_UIACTIVITYSELECTLEVELDOUBLEICONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1A1F5CE0)
#define MOLEMOLE_UIACTIVITYSELECTLEVELDOUBLEICONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1A1F5D70)
#define MOLEMOLE_UIACTIVITYSELECTLEVELDOUBLEICONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1A1F5E00)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivitySelectLevelDoubleIconWidgetController_TypeDefinitionIndex = 79595;
