...
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16D68300)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16D683C0)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16D68230)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16D68290)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER_SETREWARDACTIVE_OFFSET UNITYSDK_OFFSET(0x16D68440)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER_SETREWARDMES_OFFSET UNITYSDK_OFFSET(0x16D684B0)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER_SETTITLEANDDES_OFFSET UNITYSDK_OFFSET(0x16D68560)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16D68A30)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16D68B10)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16D68BA0)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16D68C30)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16D68CC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMissionRow03WidgetController_TypeDefinitionIndex = 48828;

	class UIHollowMissionRow03WidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_C9DDE9730C6BE395_4* _view; // 0x2C0
