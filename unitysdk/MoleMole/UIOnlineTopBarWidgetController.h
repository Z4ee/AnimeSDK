...
class Class_2_151D990416311EA2_Class_2_47F94C3827CAB3BB_6;
...
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_BUILDDATABINDING_OFFSET UNITYSDK_OFFSET(0x17466200)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_GETONLINETOPBARAIDINGMAT_OFFSET UNITYSDK_OFFSET(0x17465E30)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_GETONLINETOPBARDYINGMAT_OFFSET UNITYSDK_OFFSET(0x17465C50)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x174659D0)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17465A90)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17465B20)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17465890)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17465960)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_REFRESHAIDINGVIEW_OFFSET UNITYSDK_OFFSET(0x174668A0)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_REFRESHHELPERS_OFFSET UNITYSDK_OFFSET(0x17466F80)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_REFRESHLEFTTIME_OFFSET UNITYSDK_OFFSET(0x17466D20)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_REFRESHPLAYER_OFFSET UNITYSDK_OFFSET(0x17467190)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_REFRESHPROGRESS_OFFSET UNITYSDK_OFFSET(0x17466A60)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_REFRESHRATIO_OFFSET UNITYSDK_OFFSET(0x17466E50)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_SETUPAVATARICON_OFFSET UNITYSDK_OFFSET(0x174665C0)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_SETUPENTITY_OFFSET UNITYSDK_OFFSET(0x17466010)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER__BUILDDATABINDING_B__19_0_OFFSET UNITYSDK_OFFSET(0x174674E0)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER__BUILDDATABINDING_B__19_1_OFFSET UNITYSDK_OFFSET(0x174678C0)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER__BUILDDATABINDING_B__19_2_OFFSET UNITYSDK_OFFSET(0x174679F0)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17467480)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x17467B20)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17467BB0)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17467C40)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17467CD0)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17467D60)

namespace MoleMole
{
	inline static constexpr unsigned int UIOnlineTopBarWidgetController_TypeDefinitionIndex = 53166;
	...
	public:
		...
		::System::Void RefreshPlayer(::MoleMole::EntityHandle entity, ::Class_2_0D31A1661D004892<::Class_2_151D990416311EA2_Class_2_47F94C3827CAB3BB_6*>* Player)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::EntityHandle, ::Class_2_0D31A1661D004892<::Class_2_151D990416311EA2_Class_2_47F94C3827CAB3BB_6*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_REFRESHPLAYER_OFFSET))(this, entity, Player);
		}
