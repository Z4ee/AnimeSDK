...
#define MOLEMOLE_UIRABEXPTOPTIPSPOPWINDOWCONTROLLER__PLAYEXPTHENCLOSE_D__15_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x15BFB6D0)
#define MOLEMOLE_UIRABEXPTOPTIPSPOPWINDOWCONTROLLER__PLAYEXPTHENCLOSE_D__15_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15BFBA20)
#define MOLEMOLE_UIRABEXPTOPTIPSPOPWINDOWCONTROLLER__PLAYEXPTHENCLOSE_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15BFBA80)
#define MOLEMOLE_UIRABEXPTOPTIPSPOPWINDOWCONTROLLER__PLAYEXPTHENCLOSE_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x15BFBA30)
#define MOLEMOLE_UIRABEXPTOPTIPSPOPWINDOWCONTROLLER__PLAYEXPTHENCLOSE_D__15_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15BFB6C0)
#define MOLEMOLE_UIRABEXPTOPTIPSPOPWINDOWCONTROLLER__PLAYEXPTHENCLOSE_D__15__CTOR_OFFSET UNITYSDK_OFFSET(0x15BFB6B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABExpTopTipsPopWindowController__PlayExpThenClose_d__15_TypeDefinitionIndex = 68489;

	class UIRABExpTopTipsPopWindowController__PlayExpThenClose_d__15 : public ::System::Object
	{
	public:
		::MoleMole::UIRABExpTopTipsPopWindowController* __4__this; // 0x10
		::System::Collections::Generic::IEnumerator_1<::System::Single>* _seq_5__2; // 0x18
