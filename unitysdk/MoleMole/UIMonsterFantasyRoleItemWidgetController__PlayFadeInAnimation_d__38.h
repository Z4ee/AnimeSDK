...
#define MOLEMOLE_UIMONSTERFANTASYROLEITEMWIDGETCONTROLLER__PLAYFADEINANIMATION_D__38_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x79ECA0)
#define MOLEMOLE_UIMONSTERFANTASYROLEITEMWIDGETCONTROLLER__PLAYFADEINANIMATION_D__38_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2661E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyRoleItemWidgetController__PlayFadeInAnimation_d__38_TypeDefinitionIndex = 54699;
	...
	struct alignas(8) UIMonsterFantasyRoleItemWidgetController__PlayFadeInAnimation_d__38
	{
		...
		::Cysharp::Threading::Tasks::YieldAwaitable_Awaiter __u__1; // 0x4C
