...
#define MOLEMOLE_UIVIRTUALPLAYBTNBASECONTROLLER_UIBUTTONVIEW_GET_BTN_OFFSET UNITYSDK_OFFSET(0x12C8BF00)
#define MOLEMOLE_UIVIRTUALPLAYBTNBASECONTROLLER_UIBUTTONVIEW_GET_BUTTONAREA_OFFSET UNITYSDK_OFFSET(0x12C8C0A0)
#define MOLEMOLE_UIVIRTUALPLAYBTNBASECONTROLLER_UIBUTTONVIEW_GET_BUTTONROOT_OFFSET UNITYSDK_OFFSET(0x12C8BF20)
#define MOLEMOLE_UIVIRTUALPLAYBTNBASECONTROLLER_UIBUTTONVIEW_GET_MAXDRAGAREA_OFFSET UNITYSDK_OFFSET(0x12C8BFA0)
#define MOLEMOLE_UIVIRTUALPLAYBTNBASECONTROLLER_UIBUTTONVIEW_GET_MINDRAGAREA_OFFSET UNITYSDK_OFFSET(0x12C8C020)
#define MOLEMOLE_UIVIRTUALPLAYBTNBASECONTROLLER_UIBUTTONVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x12C8C120)

namespace MoleMole
{
	inline static constexpr unsigned int UIVirtualPlayBtnBaseController_UIButtonView_TypeDefinitionIndex = 63501;
