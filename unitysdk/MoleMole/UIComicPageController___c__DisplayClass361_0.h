...
#define MOLEMOLE_UICOMICPAGECONTROLLER___C__DISPLAYCLASS361_0__CTOR_OFFSET UNITYSDK_OFFSET(0x172DD8E0)
#define MOLEMOLE_UICOMICPAGECONTROLLER___C__DISPLAYCLASS361_0__SHOWSPLITSCREENPERFORMANCE_B__0_OFFSET UNITYSDK_OFFSET(0x172DD8F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIComicPageController___c__DisplayClass361_0_TypeDefinitionIndex = 46626;
