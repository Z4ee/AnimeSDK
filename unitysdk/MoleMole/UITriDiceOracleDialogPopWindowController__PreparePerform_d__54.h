...
#define MOLEMOLE_UITRIDICEORACLEDIALOGPOPWINDOWCONTROLLER__PREPAREPERFORM_D__54_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x817370)
#define MOLEMOLE_UITRIDICEORACLEDIALOGPOPWINDOWCONTROLLER__PREPAREPERFORM_D__54_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

namespace MoleMole
{
	inline static constexpr unsigned int UITriDiceOracleDialogPopWindowController__PreparePerform_d__54_TypeDefinitionIndex = 89293;
