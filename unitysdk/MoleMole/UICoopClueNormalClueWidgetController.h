...
#define MOLEMOLE_UICOOPCLUENORMALCLUEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16060610)
#define MOLEMOLE_UICOOPCLUENORMALCLUEWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16060680)
#define MOLEMOLE_UICOOPCLUENORMALCLUEWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16060740)
#define MOLEMOLE_UICOOPCLUENORMALCLUEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16060870)
#define MOLEMOLE_UICOOPCLUENORMALCLUEWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16060880)
#define MOLEMOLE_UICOOPCLUENORMALCLUEWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x160608D0)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopClueNormalClueWidgetController_TypeDefinitionIndex = 54566;
	...
	public:
		...
		{
			return ((::Class_2_EC28E1D3A39EE7DE_16*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UICOOPCLUENORMALCLUEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
