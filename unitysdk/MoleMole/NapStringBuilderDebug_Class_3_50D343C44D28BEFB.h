...
#define MOLEMOLE_NAPSTRINGBUILDERDEBUG_CLASS_3_50D343C44D28BEFB_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A02DBB0)
#define MOLEMOLE_NAPSTRINGBUILDERDEBUG_CLASS_3_50D343C44D28BEFB_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A02DBE0)
#define MOLEMOLE_NAPSTRINGBUILDERDEBUG_CLASS_3_50D343C44D28BEFB_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A02D910)
#define MOLEMOLE_NAPSTRINGBUILDERDEBUG_CLASS_3_50D343C44D28BEFB__CTOR_OFFSET UNITYSDK_OFFSET(0x1A02D900)

namespace MoleMole
{
	inline static constexpr unsigned int NapStringBuilderDebug_Class_3_50D343C44D28BEFB_TypeDefinitionIndex = 7864;
