...
#define MOLEMOLE_UIGENERALMISSIONCOMPLETEDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x19E84D60)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralMissionCompleteDialogContext_TypeDefinitionIndex = 47555;
	...
	public:
		...
		::System::Collections::Generic::List_1<::System::Int32>* idList; // 0x40
		::System::String* replaceClickBtnText; // 0x48
