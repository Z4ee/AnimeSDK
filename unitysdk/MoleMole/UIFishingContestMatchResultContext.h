...
#define MOLEMOLE_UIFISHINGCONTESTMATCHRESULTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x19F9D2A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFishingContestMatchResultContext_TypeDefinitionIndex = 62544;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_1_451601B8BB62C38C_11*>* PlayerInfos; // 0x30
