...
#define MOLEMOLE_UIMUSICBATTLEINLEVELTOOLBARBOSSWIDGETCONTROLLER_LEVELBOSSHUDWIDGETVIEWMODEL_MULTIHPVIEW_MULTIHPNUMPANELVIEW_GET_ANIM_OFFSET UNITYSDK_OFFSET(0x174EC1B0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELTOOLBARBOSSWIDGETCONTROLLER_LEVELBOSSHUDWIDGETVIEWMODEL_MULTIHPVIEW_MULTIHPNUMPANELVIEW_GET_NUM_OFFSET UNITYSDK_OFFSET(0x174EC100)
#define MOLEMOLE_UIMUSICBATTLEINLEVELTOOLBARBOSSWIDGETCONTROLLER_LEVELBOSSHUDWIDGETVIEWMODEL_MULTIHPVIEW_MULTIHPNUMPANELVIEW_GET_ROOT_OFFSET UNITYSDK_OFFSET(0x174EC270)
#define MOLEMOLE_UIMUSICBATTLEINLEVELTOOLBARBOSSWIDGETCONTROLLER_LEVELBOSSHUDWIDGETVIEWMODEL_MULTIHPVIEW_MULTIHPNUMPANELVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x174EC320)

namespace MoleMole
{
	inline static constexpr unsigned int UIMusicBattleInLevelToolBarBossWidgetController_LevelBossHudWidgetViewModel_MultiHPView_MultiHPNumPanelView_TypeDefinitionIndex = 56004;
