...
#define MOLEMOLE_BPREWARDINFOWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x150D9C20)

namespace MoleMole
{
	inline static constexpr unsigned int BPRewardInfoWidgetContext_TypeDefinitionIndex = 71860;
