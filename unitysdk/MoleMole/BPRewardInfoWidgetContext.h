...
#define MOLEMOLE_BPREWARDINFOWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x17023400)

namespace MoleMole
{
	inline static constexpr unsigned int BPRewardInfoWidgetContext_TypeDefinitionIndex = 65999;
