...
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_CLEARMOVESPEED_OFFSET UNITYSDK_OFFSET(0x17144FF0)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_GETPOS_OFFSET UNITYSDK_OFFSET(0x17145B40)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x171435A0)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_INITCONTEXT_OFFSET UNITYSDK_OFFSET(0x17143CB0)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_MOVEOBJ_OFFSET UNITYSDK_OFFSET(0x171456F0)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17144BD0)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x17145240)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_ONMOVEOBJ_OFFSET UNITYSDK_OFFSET(0x17145420)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17143C60)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17144C60)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x171435B0)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17144700)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_SETCAMBYKEY_OFFSET UNITYSDK_OFFSET(0x17143F10)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_SETDATABYVO_OFFSET UNITYSDK_OFFSET(0x17144030)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_SETUPTAB_OFFSET UNITYSDK_OFFSET(0x171447F0)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_SWITCHOBJ_OFFSET UNITYSDK_OFFSET(0x17145C20)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_TRYSENDEVENTTOOPENVO_OFFSET UNITYSDK_OFFSET(0x17145070)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_TRYSENDEVENT_OFFSET UNITYSDK_OFFSET(0x17145990)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17145D60)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17145D70)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x17145E00)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17145E30)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17145E40)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17145E50)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17145E60)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityMovableChildWindowController_TypeDefinitionIndex = 55461;
	...
	public:
		...
		::Enum_3_E36C894DCA3F304A_1 curObjDir; // 0x388
		...
		::System::Void TrySendEvent(::Enum_3_FBFD6F7304B717CB graphEvent)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_FBFD6F7304B717CB))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_TRYSENDEVENT_OFFSET))(this, graphEvent);
		}

		::System::Void TrySendEventToOpenVo(::Enum_3_FBFD6F7304B717CB graphEvent)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_FBFD6F7304B717CB))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_TRYSENDEVENTTOOPENVO_OFFSET))(this, graphEvent);
		}
