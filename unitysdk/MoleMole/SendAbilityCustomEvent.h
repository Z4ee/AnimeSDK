...
#define MOLEMOLE_SENDABILITYCUSTOMEVENT_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x129D9870)
#define MOLEMOLE_SENDABILITYCUSTOMEVENT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x129D99C0)
#define MOLEMOLE_SENDABILITYCUSTOMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x129D9C50)
#define MOLEMOLE_SENDABILITYCUSTOMEVENT___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x129D9D00)
#define MOLEMOLE_SENDABILITYCUSTOMEVENT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x129D9D90)

namespace MoleMole
{
	inline static constexpr unsigned int SendAbilityCustomEvent_TypeDefinitionIndex = 79949;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedString* AbilityCustomEventKey; // 0x70
