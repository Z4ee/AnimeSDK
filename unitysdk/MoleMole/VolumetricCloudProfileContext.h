...
#define MOLEMOLE_VOLUMETRICCLOUDPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x14DA8A80)

namespace MoleMole
{
	inline static constexpr unsigned int VolumetricCloudProfileContext_TypeDefinitionIndex = 57525;
