...
#define MOLEMOLE_UICPPROPDATASHOTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1C37AFF0)
#define MOLEMOLE_UICPPROPDATASHOTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1C37B080)
#define MOLEMOLE_UICPPROPDATASHOTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1C37AF00)
#define MOLEMOLE_UICPPROPDATASHOTROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1C37AF70)
#define MOLEMOLE_UICPPROPDATASHOTROWWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x1C37B110)
#define MOLEMOLE_UICPPROPDATASHOTROWWIDGETCONTROLLER_UPDATEDATA_OFFSET UNITYSDK_OFFSET(0x1C37B180)
#define MOLEMOLE_UICPPROPDATASHOTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C37B4C0)
#define MOLEMOLE_UICPPROPDATASHOTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1C37B520)
#define MOLEMOLE_UICPPROPDATASHOTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1C37B5B0)
#define MOLEMOLE_UICPPROPDATASHOTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1C37B640)
#define MOLEMOLE_UICPPROPDATASHOTROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1C37B6D0)

namespace MoleMole
{
	inline static constexpr unsigned int UICpPropDataShotRowWidgetController_TypeDefinitionIndex = 85256;

	class UICpPropDataShotRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_3688AEE03FC427B3* _view; // 0x2B8
