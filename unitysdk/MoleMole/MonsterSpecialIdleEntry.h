...
#define MOLEMOLE_MONSTERSPECIALIDLEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x10BE0890)

namespace MoleMole
{
	inline static constexpr unsigned int MonsterSpecialIdleEntry_TypeDefinitionIndex = 81748;
