...
#define MOLEMOLE_MONSTERSPECIALIDLEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1737E310)

namespace MoleMole
{
	inline static constexpr unsigned int MonsterSpecialIdleEntry_TypeDefinitionIndex = 58088;
