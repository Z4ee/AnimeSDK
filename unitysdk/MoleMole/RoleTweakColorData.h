...
#define MOLEMOLE_ROLETWEAKCOLORDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x190A81F0)

namespace MoleMole
{
	inline static constexpr unsigned int RoleTweakColorData_TypeDefinitionIndex = 90453;
