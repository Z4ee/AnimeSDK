...
#define MOLEMOLE_ROLETWEAKCOLORDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17DE14E0)

namespace MoleMole
{
	inline static constexpr unsigned int RoleTweakColorData_TypeDefinitionIndex = 43880;
