...
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_ADDPRICE_OFFSET UNITYSDK_OFFSET(0x112C45B0)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_CHECKVALID_OFFSET UNITYSDK_OFFSET(0x112C3FB0)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_GETSCORERATIO_OFFSET UNITYSDK_OFFSET(0x112C3AD0)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x112C49D0)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_GET__HASDOACTION_OFFSET UNITYSDK_OFFSET(0x112C4A80)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_MINUSPRICE_OFFSET UNITYSDK_OFFSET(0x112C4730)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_ONCONTEXTCHANGE_OFFSET UNITYSDK_OFFSET(0x112C4000)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x112C39C0)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_ONHASDOACTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x112C44C0)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x112C3A50)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x112C37B0)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_ONVHSMODULEENERGYCHANGE_OFFSET UNITYSDK_OFFSET(0x112C4940)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_ONVHSMODULERANDOMPLAYUPDATE_OFFSET UNITYSDK_OFFSET(0x112C48B0)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_REFRESHBUTTONSTATE_OFFSET UNITYSDK_OFFSET(0x112C4270)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_REFRESHHASDOACTION_OFFSET UNITYSDK_OFFSET(0x112C41D0)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_SET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x112C49E0)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_SET__HASDOACTION_OFFSET UNITYSDK_OFFSET(0x112C4510)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x112C4A90)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x112C4AF0)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x112C4B80)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x112C4C10)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSStoreLimitBtnsWidgetController_TypeDefinitionIndex = 49729;
	...
	public:
		...
		::Class_2_6D99A03C58ED2B6E_6* _activityRandomPlayTemplate; // 0x2D0
		::System::Boolean __hasDoAction; // 0x2D8
		...
		static ::System::Single GetScoreRatio(::System::Collections::Generic::IReadOnlyList_1<::Class_3_B6A6E344CE687278_15*>* optionRecordList, ::System::Int32 activityID)
		{
			return ((::System::Single(*)(::System::Collections::Generic::IReadOnlyList_1<::Class_3_B6A6E344CE687278_15*>*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_GETSCORERATIO_OFFSET))(optionRecordList, activityID);
		}
