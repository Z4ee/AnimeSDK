...
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_ADDPRICE_OFFSET UNITYSDK_OFFSET(0x108986B0)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_CHECKVALID_OFFSET UNITYSDK_OFFSET(0x108980B0)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_GETSCORERATIO_OFFSET UNITYSDK_OFFSET(0x10897BB0)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x10898AD0)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_GET__HASDOACTION_OFFSET UNITYSDK_OFFSET(0x10898B80)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_MINUSPRICE_OFFSET UNITYSDK_OFFSET(0x10898830)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_ONCONTEXTCHANGE_OFFSET UNITYSDK_OFFSET(0x10898100)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x10897AA0)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_ONHASDOACTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x108985C0)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x10897B30)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x10897890)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_ONVHSMODULEENERGYCHANGE_OFFSET UNITYSDK_OFFSET(0x10898A40)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_ONVHSMODULERANDOMPLAYUPDATE_OFFSET UNITYSDK_OFFSET(0x108989B0)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_REFRESHBUTTONSTATE_OFFSET UNITYSDK_OFFSET(0x10898370)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_REFRESHHASDOACTION_OFFSET UNITYSDK_OFFSET(0x108982D0)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_SET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x10898AE0)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_SET__HASDOACTION_OFFSET UNITYSDK_OFFSET(0x10898610)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x10898B90)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x10898BF0)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x10898C80)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x10898D10)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSStoreLimitBtnsWidgetController_TypeDefinitionIndex = 74613;
	...
	public:
		...
		::Class_2_6D99A03C58ED2B6E* _activityRandomPlayTemplate; // 0x2D0
		...
		static ::System::Single GetScoreRatio(::System::Collections::Generic::IReadOnlyList_1<::Class_3_B6A6E344CE687278_2*>* optionRecordList, ::System::Int32 activityID)
		{
			return ((::System::Single(*)(::System::Collections::Generic::IReadOnlyList_1<::Class_3_B6A6E344CE687278_2*>*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_GETSCORERATIO_OFFSET))(optionRecordList, activityID);
		}
