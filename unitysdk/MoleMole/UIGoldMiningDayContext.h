...
#define MOLEMOLE_UIGOLDMININGDAYCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x199CB7B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGoldMiningDayContext_TypeDefinitionIndex = 90847;
