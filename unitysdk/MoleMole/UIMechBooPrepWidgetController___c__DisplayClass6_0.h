...
#define MOLEMOLE_UIMECHBOOPREPWIDGETCONTROLLER___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0x152F6730)
#define MOLEMOLE_UIMECHBOOPREPWIDGETCONTROLLER___C__DISPLAYCLASS6_0__REFRESHVIEW_B__0_OFFSET UNITYSDK_OFFSET(0x152F6740)
#define MOLEMOLE_UIMECHBOOPREPWIDGETCONTROLLER___C__DISPLAYCLASS6_0__REFRESHVIEW_B__1_OFFSET UNITYSDK_OFFSET(0x152F6770)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechBooPrepWidgetController___c__DisplayClass6_0_TypeDefinitionIndex = 53218;

	class UIMechBooPrepWidgetController___c__DisplayClass6_0 : public ::System::Object
	{
	public:
		::System::Action_1<::Class_0_16E4307DCC419505_169*>* onClickScriptBtn; // 0x10
		::MoleMole::UIMechBooPrepWidgetController* __4__this; // 0x18
