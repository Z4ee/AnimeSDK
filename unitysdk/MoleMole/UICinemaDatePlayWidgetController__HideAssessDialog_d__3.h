...
#define MOLEMOLE_UICINEMADATEPLAYWIDGETCONTROLLER__HIDEASSESSDIALOG_D__3_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x893590)
#define MOLEMOLE_UICINEMADATEPLAYWIDGETCONTROLLER__HIDEASSESSDIALOG_D__3_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaDatePlayWidgetController__HideAssessDialog_d__3_TypeDefinitionIndex = 66830;
	...
	struct alignas(8) UICinemaDatePlayWidgetController__HideAssessDialog_d__3
	{
		...
		::Class_2_0D31A1661D004892<::Class_2_D0F43E2E93E0D88C_Class_2_789DB209FB3DF9F3*>* _assess_5__2; // 0x28
		::MoleMole::UICinemaDatePlayWidgetController* __4__this; // 0x30
