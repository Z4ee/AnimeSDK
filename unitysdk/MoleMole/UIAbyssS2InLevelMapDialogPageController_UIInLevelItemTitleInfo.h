...
#define MOLEMOLE_UIABYSSS2INLEVELMAPDIALOGPAGECONTROLLER_UIINLEVELITEMTITLEINFO_GETTEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x12F236A0)
#define MOLEMOLE_UIABYSSS2INLEVELMAPDIALOGPAGECONTROLLER_UIINLEVELITEMTITLEINFO_SETBRIEF_OFFSET UNITYSDK_OFFSET(0x12F236E0)
#define MOLEMOLE_UIABYSSS2INLEVELMAPDIALOGPAGECONTROLLER_UIINLEVELITEMTITLEINFO_SETSELECT_OFFSET UNITYSDK_OFFSET(0x12F23730)
#define MOLEMOLE_UIABYSSS2INLEVELMAPDIALOGPAGECONTROLLER_UIINLEVELITEMTITLEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x12F23780)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2InLevelMapDialogPageController_UIInLevelItemTitleInfo_TypeDefinitionIndex = 45602;
