...
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_CHECKTEAMHASLOCK_OFFSET UNITYSDK_OFFSET(0x15697300)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_CREATTEAMEDITROW_OFFSET UNITYSDK_OFFSET(0x156930E0)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_GETAVATARISLOCKED_OFFSET UNITYSDK_OFFSET(0x15694E40)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_GETBUDDYISLOCKED_OFFSET UNITYSDK_OFFSET(0x15694F10)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_GETTEAMDATA_OFFSET UNITYSDK_OFFSET(0x15696BC0)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15692A80)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONBUDDYSELECT_OFFSET UNITYSDK_OFFSET(0x15695480)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONBUDYEDITORCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x15693E10)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONCLOSECLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x15693310)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15695200)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONGOBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x15696870)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONQUICKTEAMUPDATE_OFFSET UNITYSDK_OFFSET(0x15696800)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONREWARDFOCUSCHANGE_OFFSET UNITYSDK_OFFSET(0x15694340)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONROLEEDITORCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x15693660)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONSELECTAVATAR_OFFSET UNITYSDK_OFFSET(0x15695DF0)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONSELECTBUDDYRSP_OFFSET UNITYSDK_OFFSET(0x15695A30)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONTEAMCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x156942B0)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONTEAMICONCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x156935F0)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x156975E0)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15692A90)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15694FE0)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_SETMUTISELECT_OFFSET UNITYSDK_OFFSET(0x156946C0)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15697A50)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER__ONCLOSECLICKHANDLE_B__16_0_OFFSET UNITYSDK_OFFSET(0x15697C90)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER__ONCLOSECLICKHANDLE_B__16_1_OFFSET UNITYSDK_OFFSET(0x15697CA0)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15697D30)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15697DC0)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15697DD0)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15697DE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuickEditPopWindowController_TypeDefinitionIndex = 51847;

	class UIQuickEditPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_9EF3F803680CDCC7* _view; // 0x318
		...
		::System::Void OnSelectBuddyRsp(::Class_0_16E4307DCC419505_29* rcvMessage)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_29*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONSELECTBUDDYRSP_OFFSET))(this, rcvMessage);
		}
