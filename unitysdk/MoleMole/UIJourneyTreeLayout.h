...
#define MOLEMOLE_UIJOURNEYTREELAYOUT_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x15D3F960)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_CALCULATELAYOUTINPUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x15D3F9C0)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_GETCHILDPOS_OFFSET UNITYSDK_OFFSET(0x15D3FEB0)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_GETCHILDSITEBYPOSX_OFFSET UNITYSDK_OFFSET(0x15D40130)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_GETHORIZONMINMAX_OFFSET UNITYSDK_OFFSET(0x15D40030)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_GETLASTCELLMINMAX_OFFSET UNITYSDK_OFFSET(0x15D3FFD0)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_SETCHILDPOS_OFFSET UNITYSDK_OFFSET(0x15D3FAE0)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x15D3FA10)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x15D3FC10)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_SETLISTMAXSIZE_OFFSET UNITYSDK_OFFSET(0x15D3FC50)
#define MOLEMOLE_UIJOURNEYTREELAYOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x15D401D0)
#define MOLEMOLE_UIJOURNEYTREELAYOUT___BASE_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x15D40240)

namespace MoleMole
{
	inline static constexpr unsigned int UIJourneyTreeLayout_TypeDefinitionIndex = 42468;
