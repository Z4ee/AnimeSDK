...
#define MOLEMOLE_UIJOURNEYTREELAYOUT_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x174C75D0)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_CALCULATELAYOUTINPUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x174C7630)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_GETCHILDPOS_OFFSET UNITYSDK_OFFSET(0x174C7B20)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_GETCHILDSITEBYPOSX_OFFSET UNITYSDK_OFFSET(0x174C7DA0)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_GETHORIZONMINMAX_OFFSET UNITYSDK_OFFSET(0x174C7CA0)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_GETLASTCELLMINMAX_OFFSET UNITYSDK_OFFSET(0x174C7C40)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_SETCHILDPOS_OFFSET UNITYSDK_OFFSET(0x174C7750)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x174C7680)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x174C7880)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_SETLISTMAXSIZE_OFFSET UNITYSDK_OFFSET(0x174C78C0)
#define MOLEMOLE_UIJOURNEYTREELAYOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x174C7E40)
#define MOLEMOLE_UIJOURNEYTREELAYOUT___BASE_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x174C7EB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIJourneyTreeLayout_TypeDefinitionIndex = 71679;
