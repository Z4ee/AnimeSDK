...
#define MOLEMOLE_UIADAPTORPARAMS_GET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x17E2AB30)
#define MOLEMOLE_UIADAPTORPARAMS_SET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x17E2AB50)
#define MOLEMOLE_UIADAPTORPARAMS_UPDATEPARAMS_OFFSET UNITYSDK_OFFSET(0x17E2AC30)
#define MOLEMOLE_UIADAPTORPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x17E2ABB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAdaptorParams_TypeDefinitionIndex = 66412;
