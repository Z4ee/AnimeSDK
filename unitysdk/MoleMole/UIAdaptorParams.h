...
#define MOLEMOLE_UIADAPTORPARAMS_GET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x15B8B480)
#define MOLEMOLE_UIADAPTORPARAMS_SET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x15B8B4A0)
#define MOLEMOLE_UIADAPTORPARAMS_UPDATEPARAMS_OFFSET UNITYSDK_OFFSET(0x15B8B580)
#define MOLEMOLE_UIADAPTORPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x15B8B500)

namespace MoleMole
{
	inline static constexpr unsigned int UIAdaptorParams_TypeDefinitionIndex = 47253;
