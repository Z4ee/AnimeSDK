...
#define MOLEMOLE_UIPRIVATEMESSAGEREPLYWIDGETCONTROLLER___C__DISPLAYCLASS26_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1613CBE0)
#define MOLEMOLE_UIPRIVATEMESSAGEREPLYWIDGETCONTROLLER___C__DISPLAYCLASS26_0__OPENPERSONALQUEST_B__0_OFFSET UNITYSDK_OFFSET(0x1613CBF0)
#define MOLEMOLE_UIPRIVATEMESSAGEREPLYWIDGETCONTROLLER___C__DISPLAYCLASS26_0__OPENPERSONALQUEST_B__1_OFFSET UNITYSDK_OFFSET(0x1613CEC0)
#define MOLEMOLE_UIPRIVATEMESSAGEREPLYWIDGETCONTROLLER___C__DISPLAYCLASS26_0__OPENPERSONALQUEST_B__2_OFFSET UNITYSDK_OFFSET(0x1613D010)

namespace MoleMole
{
	inline static constexpr unsigned int UIPrivateMessageReplyWidgetController___c__DisplayClass26_0_TypeDefinitionIndex = 81755;
