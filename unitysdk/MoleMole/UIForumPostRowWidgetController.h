...
class Class_2_FCA310AE514554AA;
namespace MoleMole { class UIControlReference; }
namespace System { class Object; }

#define MOLEMOLE_UIFORUMPOSTROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15A65840)
#define MOLEMOLE_UIFORUMPOSTROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15A658B0)
#define MOLEMOLE_UIFORUMPOSTROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x15A65B50)
#define MOLEMOLE_UIFORUMPOSTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15A65970)
#define MOLEMOLE_UIFORUMPOSTROWWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x15A65DE0)
#define MOLEMOLE_UIFORUMPOSTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15A65E80)
#define MOLEMOLE_UIFORUMPOSTROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15A65E90)
#define MOLEMOLE_UIFORUMPOSTROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x15A65F30)
#define MOLEMOLE_UIFORUMPOSTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15A65FC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIForumPostRowWidgetController_TypeDefinitionIndex = 59691;
	...
	public:
		...
		::Class_2_FCA310AE514554AA* get__viewModel()
		{
			return ((::Class_2_FCA310AE514554AA*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIFORUMPOSTROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
