...
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS56_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17AE8E40)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS56_0__SHOW3DMODEL_G__OPENMODELDIALOG_0_OFFSET UNITYSDK_OFFSET(0x17AE8E50)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityChatPlayWidgetController___c__DisplayClass56_0_TypeDefinitionIndex = 77920;
