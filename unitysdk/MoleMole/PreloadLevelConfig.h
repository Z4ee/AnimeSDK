...
#define MOLEMOLE_PRELOADLEVELCONFIG_BUILDPRELOADLEVELCONFIG_OFFSET UNITYSDK_OFFSET(0x16428DF0)
#define MOLEMOLE_PRELOADLEVELCONFIG_SHOWLOWMEMORYEFFECTPATHS_OFFSET UNITYSDK_OFFSET(0x1642A880)
#define MOLEMOLE_PRELOADLEVELCONFIG_SHOWMAYINVALIDPATHS_OFFSET UNITYSDK_OFFSET(0x1642A840)
#define MOLEMOLE_PRELOADLEVELCONFIG_VIEWCOMMONGROUP_OFFSET UNITYSDK_OFFSET(0x1642A530)
#define MOLEMOLE_PRELOADLEVELCONFIG_VIEWSINGLEGROUP_OFFSET UNITYSDK_OFFSET(0x16428EA0)
#define MOLEMOLE_PRELOADLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1642A8C0)

namespace MoleMole
{
	inline static constexpr unsigned int PreloadLevelConfig_TypeDefinitionIndex = 46341;
