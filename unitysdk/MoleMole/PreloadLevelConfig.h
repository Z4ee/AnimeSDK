...
#define MOLEMOLE_PRELOADLEVELCONFIG_BUILDPRELOADLEVELCONFIG_OFFSET UNITYSDK_OFFSET(0x15858E90)
#define MOLEMOLE_PRELOADLEVELCONFIG_SHOWLOWMEMORYEFFECTPATHS_OFFSET UNITYSDK_OFFSET(0x1585A920)
#define MOLEMOLE_PRELOADLEVELCONFIG_SHOWMAYINVALIDPATHS_OFFSET UNITYSDK_OFFSET(0x1585A8E0)
#define MOLEMOLE_PRELOADLEVELCONFIG_VIEWCOMMONGROUP_OFFSET UNITYSDK_OFFSET(0x1585A5D0)
#define MOLEMOLE_PRELOADLEVELCONFIG_VIEWSINGLEGROUP_OFFSET UNITYSDK_OFFSET(0x15858F40)
#define MOLEMOLE_PRELOADLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1585A960)

namespace MoleMole
{
	inline static constexpr unsigned int PreloadLevelConfig_TypeDefinitionIndex = 42407;
