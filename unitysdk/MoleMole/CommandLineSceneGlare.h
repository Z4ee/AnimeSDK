...
#define MOLEMOLE_COMMANDLINESCENEGLARE_METHOD_2_B1618326A96071B9_OFFSET UNITYSDK_OFFSET(0x12B1E6B0)
#define MOLEMOLE_COMMANDLINESCENEGLARE_METHOD_2_F7972A50AC4D3FFB_OFFSET UNITYSDK_OFFSET(0x12B1E7C0)
#define MOLEMOLE_COMMANDLINESCENEGLARE__CTOR_OFFSET UNITYSDK_OFFSET(0x12B1E780)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineSceneGlare_TypeDefinitionIndex = 72236;
