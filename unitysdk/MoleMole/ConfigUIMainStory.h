...
#define MOLEMOLE_CONFIGUIMAINSTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x181F0D10)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIMainStory_TypeDefinitionIndex = 77560;
