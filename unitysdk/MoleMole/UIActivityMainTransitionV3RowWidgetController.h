...
#define MOLEMOLE_UIACTIVITYMAINTRANSITIONV3ROWWIDGETCONTROLLER_BINDINFOBTNCLICKACTION_OFFSET UNITYSDK_OFFSET(0x18657420)
#define MOLEMOLE_UIACTIVITYMAINTRANSITIONV3ROWWIDGETCONTROLLER_GETGENERALBTN_OFFSET UNITYSDK_OFFSET(0x18657670)
#define MOLEMOLE_UIACTIVITYMAINTRANSITIONV3ROWWIDGETCONTROLLER_GETVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18657380)
#define MOLEMOLE_UIACTIVITYMAINTRANSITIONV3ROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x186570C0)
#define MOLEMOLE_UIACTIVITYMAINTRANSITIONV3ROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18657130)
#define MOLEMOLE_UIACTIVITYMAINTRANSITIONV3ROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x186571D0)
#define MOLEMOLE_UIACTIVITYMAINTRANSITIONV3ROWWIDGETCONTROLLER_SETIMAGE_OFFSET UNITYSDK_OFFSET(0x18657C10)
#define MOLEMOLE_UIACTIVITYMAINTRANSITIONV3ROWWIDGETCONTROLLER_SETINFOTEXTKEY_OFFSET UNITYSDK_OFFSET(0x18657840)
#define MOLEMOLE_UIACTIVITYMAINTRANSITIONV3ROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18657E00)
#define MOLEMOLE_UIACTIVITYMAINTRANSITIONV3ROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18657E60)
#define MOLEMOLE_UIACTIVITYMAINTRANSITIONV3ROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18657F00)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityMainTransitionV3RowWidgetController_TypeDefinitionIndex = 57927;
