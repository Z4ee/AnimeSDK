...
#define MOLEMOLE_CONFIGTEMPLELEVELUPSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x17E46C20)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigTempleLevelUpSetting_TypeDefinitionIndex = 58241;
