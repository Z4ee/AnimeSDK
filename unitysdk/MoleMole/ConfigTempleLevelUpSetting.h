...
#define MOLEMOLE_CONFIGTEMPLELEVELUPSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x16B53AF0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigTempleLevelUpSetting_TypeDefinitionIndex = 55205;
