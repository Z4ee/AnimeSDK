...
#define MOLEMOLE_UIWORKBENCHMAINPAGEBIGBTNWIDGETCONTROLLER_ONBTNCALLBACK_OFFSET UNITYSDK_OFFSET(0x12E4CF40)
#define MOLEMOLE_UIWORKBENCHMAINPAGEBIGBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12E4CE30)
#define MOLEMOLE_UIWORKBENCHMAINPAGEBIGBTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12E4CEC0)
#define MOLEMOLE_UIWORKBENCHMAINPAGEBIGBTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12E4CC10)
#define MOLEMOLE_UIWORKBENCHMAINPAGEBIGBTNWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12E4CDC0)
#define MOLEMOLE_UIWORKBENCHMAINPAGEBIGBTNWIDGETCONTROLLER_REGISTERONCLICK_OFFSET UNITYSDK_OFFSET(0x12E4B7F0)
#define MOLEMOLE_UIWORKBENCHMAINPAGEBIGBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12E4CFA0)
#define MOLEMOLE_UIWORKBENCHMAINPAGEBIGBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12E4D000)
#define MOLEMOLE_UIWORKBENCHMAINPAGEBIGBTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12E4D090)
#define MOLEMOLE_UIWORKBENCHMAINPAGEBIGBTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12E4D120)
#define MOLEMOLE_UIWORKBENCHMAINPAGEBIGBTNWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12E4D1B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkbenchMainPageBigBtnWidgetController_TypeDefinitionIndex = 72118;
