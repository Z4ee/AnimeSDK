...
#define MOLEMOLE_CHARACTERCOMMONDATAS__CTOR_OFFSET UNITYSDK_OFFSET(0x14358C20)

namespace MoleMole
{
	inline static constexpr unsigned int CharacterCommonDatas_TypeDefinitionIndex = 71578;
