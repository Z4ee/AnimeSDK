...
#define MOLEMOLE_UICINEMAPREPV2PAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x176F9100)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaPrepV2PageContext_TypeDefinitionIndex = 57702;
