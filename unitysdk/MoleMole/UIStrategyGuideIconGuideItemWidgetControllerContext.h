...
#define MOLEMOLE_UISTRATEGYGUIDEICONGUIDEITEMWIDGETCONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x13819E00)

namespace MoleMole
{
	inline static constexpr unsigned int UIStrategyGuideIconGuideItemWidgetControllerContext_TypeDefinitionIndex = 70652;
	...
	public:
		...
		::Class_2_208CC9941471731A_899* Config; // 0x30
