...
#define MOLEMOLE_UIGENERALRECHARGEPOPWINDOWCONTEXT_GET_FROMRECHARGETYPEID_OFFSET UNITYSDK_OFFSET(0x15F8FB50)
#define MOLEMOLE_UIGENERALRECHARGEPOPWINDOWCONTEXT_GET_FROMRECHARGETYPETEMPLATE_OFFSET UNITYSDK_OFFSET(0x15F8FB90)
#define MOLEMOLE_UIGENERALRECHARGEPOPWINDOWCONTEXT_GET_TORECHARGETYPEID_OFFSET UNITYSDK_OFFSET(0x15F8FB70)
#define MOLEMOLE_UIGENERALRECHARGEPOPWINDOWCONTEXT_GET_TORECHARGETYPETEMPLATE_OFFSET UNITYSDK_OFFSET(0x15F8FBB0)
#define MOLEMOLE_UIGENERALRECHARGEPOPWINDOWCONTEXT_SET_FROMRECHARGETYPEID_OFFSET UNITYSDK_OFFSET(0x15F8FB60)
#define MOLEMOLE_UIGENERALRECHARGEPOPWINDOWCONTEXT_SET_FROMRECHARGETYPETEMPLATE_OFFSET UNITYSDK_OFFSET(0x15F8FBA0)
#define MOLEMOLE_UIGENERALRECHARGEPOPWINDOWCONTEXT_SET_TORECHARGETYPEID_OFFSET UNITYSDK_OFFSET(0x15F8FB80)
#define MOLEMOLE_UIGENERALRECHARGEPOPWINDOWCONTEXT_SET_TORECHARGETYPETEMPLATE_OFFSET UNITYSDK_OFFSET(0x15F8FBC0)
#define MOLEMOLE_UIGENERALRECHARGEPOPWINDOWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15F8FBD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralRechargePopWindowContext_TypeDefinitionIndex = 65415;

	class UIGeneralRechargePopWindowContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::Action_1<::System::UInt32>* OnNotEnoughCallback; // 0x28
		::Class_2_208CC9941471731A_131* _fromRechargeTypeTemplate_k__BackingField; // 0x30
