...
#define MOLEMOLE_UIHANDBOOKCHANGEWISHLISTTARGETPOPWINDOWCONTROLLER___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17DADCC0)
#define MOLEMOLE_UIHANDBOOKCHANGEWISHLISTTARGETPOPWINDOWCONTROLLER___C__DISPLAYCLASS16_0__ONCLICKSETTARGETBTN_B__0_OFFSET UNITYSDK_OFFSET(0x17DADEC0)
#define MOLEMOLE_UIHANDBOOKCHANGEWISHLISTTARGETPOPWINDOWCONTROLLER___C__DISPLAYCLASS16_0__ONCLICKSETTARGETBTN_B__1_OFFSET UNITYSDK_OFFSET(0x17DADCD0)
#define MOLEMOLE_UIHANDBOOKCHANGEWISHLISTTARGETPOPWINDOWCONTROLLER___C__DISPLAYCLASS16_0__ONCLICKSETTARGETBTN_B__2_OFFSET UNITYSDK_OFFSET(0x17DADE10)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookChangeWishlistTargetPopWindowController___c__DisplayClass16_0_TypeDefinitionIndex = 55136;
