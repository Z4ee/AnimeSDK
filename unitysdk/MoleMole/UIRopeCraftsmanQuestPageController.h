...
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x12290830)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_INITANDNPCREDSIGN_OFFSET UNITYSDK_OFFSET(0x12292890)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ISCANSHOWENDDESC_OFFSET UNITYSDK_OFFSET(0x12291D30)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ONCLICKTASK_OFFSET UNITYSDK_OFFSET(0x12291540)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12290840)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x12291420)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ONGOMAPBUTTON_OFFSET UNITYSDK_OFFSET(0x12291FE0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ONINFOBTN_OFFSET UNITYSDK_OFFSET(0x12291F10)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x12290E30)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x122911F0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x122911A0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12290B80)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_OPENPANEL_OFFSET UNITYSDK_OFFSET(0x12292160)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_REFRESHPANEL_OFFSET UNITYSDK_OFFSET(0x12290C70)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_SETGOTOTASKBUTTONENABLE_OFFSET UNITYSDK_OFFSET(0x12291EA0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_SHOWGOTOACTIVITYBUTTON_OFFSET UNITYSDK_OFFSET(0x12291260)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12292BA0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER__ONGOMAPBUTTON_B__18_0_OFFSET UNITYSDK_OFFSET(0x12292BB0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12292D90)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER___BASE_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x12292E20)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x12292F10)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12292FD0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12292FE0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12292FF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRopeCraftsmanQuestPageController_TypeDefinitionIndex = 56429;

	class UIRopeCraftsmanQuestPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79EB9A268E300B2A* _view; // 0x318
		::MoleMole::UIRopeCraftsmanQuestPageController_PanelData* _panelData; // 0x320
		::UIWidgetGroup* _itemGroup; // 0x328
		::MoleMole::UIRopeCraftsmanQuestPageController_ItemData* _currentItemData; // 0x330
		::MoleMole::UIActivityCompRewardBtnGroupWidgetController* _gotoActivityButtonGroup; // 0x338
