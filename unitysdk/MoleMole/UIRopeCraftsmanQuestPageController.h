...
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x17E48AA0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_INITANDNPCREDSIGN_OFFSET UNITYSDK_OFFSET(0x17E4AB30)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ISCANSHOWENDDESC_OFFSET UNITYSDK_OFFSET(0x17E49FB0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ONCLICKTASK_OFFSET UNITYSDK_OFFSET(0x17E497B0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17E48AB0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x17E49690)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ONGOMAPBUTTON_OFFSET UNITYSDK_OFFSET(0x17E4A260)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ONINFOBTN_OFFSET UNITYSDK_OFFSET(0x17E4A190)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17E490A0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17E49470)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17E49420)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17E48DF0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_OPENPANEL_OFFSET UNITYSDK_OFFSET(0x17E4A3E0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_REFRESHPANEL_OFFSET UNITYSDK_OFFSET(0x17E48EE0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_SETGOTOTASKBUTTONENABLE_OFFSET UNITYSDK_OFFSET(0x17E4A120)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_SHOWGOTOACTIVITYBUTTON_OFFSET UNITYSDK_OFFSET(0x17E494E0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17E4AE80)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER__ONGOMAPBUTTON_B__18_0_OFFSET UNITYSDK_OFFSET(0x17E4AE90)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17E4B070)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER___BASE_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x17E4B100)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17E4B1F0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17E4B2B0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17E4B2C0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17E4B2D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRopeCraftsmanQuestPageController_TypeDefinitionIndex = 60786;
