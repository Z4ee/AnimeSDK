...
#define MOLEMOLE_MAINCITYPHOTOPOPCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x12624030)

namespace MoleMole
{
	inline static constexpr unsigned int MainCityPhotoPopContext_TypeDefinitionIndex = 55346;

	class MainCityPhotoPopContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::String* desc2; // 0x28
		::UnityEngine::RenderTexture* PhotoTex; // 0x30
		::System::String* desc1; // 0x38
		::System::Action_1<::System::String*>* shareBtnClickCallback; // 0x40
