...
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER_GET_ITEMFADEIN_OFFSET UNITYSDK_OFFSET(0x15CEF620)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER_GET_ITEMFADEOUT_OFFSET UNITYSDK_OFFSET(0x15CEF670)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER_GET_ITEMLOOP_OFFSET UNITYSDK_OFFSET(0x15CEF660)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER_GET_LIGHTUPANIM_OFFSET UNITYSDK_OFFSET(0x15CEF6E0)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER_GET_LIGHTUPGO_OFFSET UNITYSDK_OFFSET(0x15CEF6D0)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER_GET_MAXANIM_OFFSET UNITYSDK_OFFSET(0x15CEF710)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER_GET_POINTMAXFADEIN_OFFSET UNITYSDK_OFFSET(0x15CEF6B0)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER_GET_POINTMAXFADEOUT_OFFSET UNITYSDK_OFFSET(0x15CEF6C0)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15CEF7F0)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15CEF880)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15CEF720)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15CEF780)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15CEF900)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15CEF960)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15CEF9F0)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15CEFA80)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15CEFB10)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelCissiaWidgetController_TypeDefinitionIndex = 82119;

	class UIInLevelCissiaWidgetController : public ::MoleMole::UIInLevelLightUpPointsItemControllerBase
	{
	public:
		::Class_2_7ABF2118692E7A85_13* _view; // 0x2C8
