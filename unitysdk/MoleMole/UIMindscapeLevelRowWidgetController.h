...
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x147C7B80)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_ONPOPUPSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x147C7870)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_ONSKINCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x147C7C10)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x147C7760)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x147C7F00)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x147C7470)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x147C7620)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x147C5E80)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x147C60D0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_PLAYUNLOCKEFFECT_OFFSET UNITYSDK_OFFSET(0x147C65E0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x147C7CA0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_SETCLICKACTION_OFFSET UNITYSDK_OFFSET(0x147C4030)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_SETDATA_OFFSET UNITYSDK_OFFSET(0x147C5210)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_SETLEVELROWCOLOR_OFFSET UNITYSDK_OFFSET(0x147C4080)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_SETUNLOCKSTATE_OFFSET UNITYSDK_OFFSET(0x147C78D0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x147C8010)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER__PLAYFADEIN_B__21_0_OFFSET UNITYSDK_OFFSET(0x147C80A0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER__SETDATA_B__17_0_OFFSET UNITYSDK_OFFSET(0x147C8070)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x147C8110)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x147C81A0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x147C81B0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x147C8240)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x147C82D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMindscapeLevelRowWidgetController_TypeDefinitionIndex = 52172;

	class UIMindscapeLevelRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_141* _view; // 0x2B8
		::Class_2_1824EF69C8E376A3* _avatarItemData; // 0x2C0
		::System::Int32 _currentSlot; // 0x2C8
		::Class_2_208CC9941471731A_665* _talentCfg; // 0x2D0
		::System::Action_1<::System::Int32>* _clickHandle; // 0x2D8
		::System::Boolean isShowRedPoint; // 0x2E0
		::System::Single fadeInLen; // 0x2E4
		::Foundation::Coroutine::CoroutineHandle fadeinHandle; // 0x2E8
		...
		::System::Boolean _SetData_b__17_0(::Class_2_208CC9941471731A_665* o)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_2_208CC9941471731A_665*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER__SETDATA_B__17_0_OFFSET))(this, o);
		}
