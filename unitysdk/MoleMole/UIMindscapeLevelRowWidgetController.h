...
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x183BA800)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_ONPOPUPSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x183BA4D0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_ONSKINCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x183BA890)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x183BA3C0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x183BAB80)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x183BA0B0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x183BA270)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x183B8AE0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x183B8D30)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_PLAYUNLOCKEFFECT_OFFSET UNITYSDK_OFFSET(0x183B9230)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x183BA920)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_SETCLICKACTION_OFFSET UNITYSDK_OFFSET(0x183B6850)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_SETDATA_OFFSET UNITYSDK_OFFSET(0x183B7C40)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_SETLEVELROWCOLOR_OFFSET UNITYSDK_OFFSET(0x183B68A0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_SETUNLOCKSTATE_OFFSET UNITYSDK_OFFSET(0x183BA530)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x183BAC90)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER__PLAYFADEIN_B__21_0_OFFSET UNITYSDK_OFFSET(0x183BAD20)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER__SETDATA_B__17_0_OFFSET UNITYSDK_OFFSET(0x183BACF0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x183BAD90)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x183BAE20)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x183BAE30)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x183BAEC0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x183BAF50)

namespace MoleMole
{
	inline static constexpr unsigned int UIMindscapeLevelRowWidgetController_TypeDefinitionIndex = 40369;
	...
	public:
		...
		::Class_2_208CC9941471731A_767* _talentCfg; // 0x2D8
		...
		::System::Boolean _SetData_b__17_0(::Class_2_208CC9941471731A_767* o)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_2_208CC9941471731A_767*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER__SETDATA_B__17_0_OFFSET))(this, o);
		}
