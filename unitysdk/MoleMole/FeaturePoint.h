...
#define MOLEMOLE_FEATUREPOINT_METHOD_1_40E490E2772D5D75_OFFSET UNITYSDK_OFFSET(0x15806C00)
#define MOLEMOLE_FEATUREPOINT_METHOD_1_4AD015C8B128B3A0_OFFSET UNITYSDK_OFFSET(0x15806C60)
#define MOLEMOLE_FEATUREPOINT_METHOD_1_FF11A7936E830212_OFFSET UNITYSDK_OFFSET(0x15806A10)
#define MOLEMOLE_FEATUREPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x158069F0)

namespace MoleMole
{
	inline static constexpr unsigned int FeaturePoint_TypeDefinitionIndex = 74400;
