...
#define MOLEMOLE_UISUMMERFISHAQUARIUMSTARWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x157BE380)
#define MOLEMOLE_UISUMMERFISHAQUARIUMSTARWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x157BE410)
#define MOLEMOLE_UISUMMERFISHAQUARIUMSTARWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x157BE100)
#define MOLEMOLE_UISUMMERFISHAQUARIUMSTARWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x157BE310)
#define MOLEMOLE_UISUMMERFISHAQUARIUMSTARWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x157BE490)
#define MOLEMOLE_UISUMMERFISHAQUARIUMSTARWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x157BE5A0)
#define MOLEMOLE_UISUMMERFISHAQUARIUMSTARWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x157BE680)
#define MOLEMOLE_UISUMMERFISHAQUARIUMSTARWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x157BE710)
#define MOLEMOLE_UISUMMERFISHAQUARIUMSTARWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x157BE7A0)
#define MOLEMOLE_UISUMMERFISHAQUARIUMSTARWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x157BE830)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerFishAquariumStarWidgetController_TypeDefinitionIndex = 45987;

	class UISummerFishAquariumStarWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_94C9713A8E4B253E* _view; // 0x2C0
