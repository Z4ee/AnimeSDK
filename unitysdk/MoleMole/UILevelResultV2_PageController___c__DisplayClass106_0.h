...
#define MOLEMOLE_UILEVELRESULTV2_PAGECONTROLLER___C__DISPLAYCLASS106_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15A6EAF0)
#define MOLEMOLE_UILEVELRESULTV2_PAGECONTROLLER___C__DISPLAYCLASS106_0___REFRESHBATTLERANKING_MSG_B__0_OFFSET UNITYSDK_OFFSET(0x15A6EB00)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultV2_PageController___c__DisplayClass106_0_TypeDefinitionIndex = 58840;
