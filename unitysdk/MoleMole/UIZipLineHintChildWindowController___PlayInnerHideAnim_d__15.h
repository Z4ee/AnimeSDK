...
#define MOLEMOLE_UIZIPLINEHINTCHILDWINDOWCONTROLLER___PLAYINNERHIDEANIM_D__15_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x7BE500)
#define MOLEMOLE_UIZIPLINEHINTCHILDWINDOWCONTROLLER___PLAYINNERHIDEANIM_D__15_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x283610)

namespace MoleMole
{
	inline static constexpr unsigned int UIZipLineHintChildWindowController___PlayInnerHideAnim_d__15_TypeDefinitionIndex = 52732;
	...
	struct alignas(8) UIZipLineHintChildWindowController___PlayInnerHideAnim_d__15
	{
		...
		::MoleMole::UIZipLineHintChildWindowController* __4__this; // 0x28
