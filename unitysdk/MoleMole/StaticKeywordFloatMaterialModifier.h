...
#define MOLEMOLE_STATICKEYWORDFLOATMATERIALMODIFIER_METHOD_2_6881D6F4F5133271_OFFSET UNITYSDK_OFFSET(0x813FE0)
#define MOLEMOLE_STATICKEYWORDFLOATMATERIALMODIFIER_METHOD_2_C446CE6A5E1982BC_OFFSET UNITYSDK_OFFSET(0x814040)
#define MOLEMOLE_STATICKEYWORDFLOATMATERIALMODIFIER_METHOD_2_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x813FF0)
#define MOLEMOLE_STATICKEYWORDFLOATMATERIALMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x813F50)

namespace MoleMole
{
	inline static constexpr unsigned int StaticKeywordFloatMaterialModifier_TypeDefinitionIndex = 49457;
	...
	struct alignas(8) StaticKeywordFloatMaterialModifier
	{
		...
		::Class_1_A0B58236B258B7B2* Method_2_6881D6F4F5133271(::Enum_3_7F4644768973D415 a1, ::MoleMole::MonoRenderHandler* a2)
		{
			return ((::Class_1_A0B58236B258B7B2*(*)(::PVOID, ::Enum_3_7F4644768973D415, ::MoleMole::MonoRenderHandler*))((::PBYTE)hIl2Cpp + MOLEMOLE_STATICKEYWORDFLOATMATERIALMODIFIER_METHOD_2_6881D6F4F5133271_OFFSET))(this, a1, a2);
		}
