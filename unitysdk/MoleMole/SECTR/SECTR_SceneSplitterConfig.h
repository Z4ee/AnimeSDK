...
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG_ADDNEWLAYER_OFFSET UNITYSDK_OFFSET(0x125ECD70)
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG_ADDNEWTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x125ECED0)
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG_COMPARELAYERCONFIG_OFFSET UNITYSDK_OFFSET(0x125ECD10)
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG_GETALLCONFIGS_OFFSET UNITYSDK_OFFSET(0x125ECC10)
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG_GETTHRESHOLDBYNAME_OFFSET UNITYSDK_OFFSET(0x125ED020)
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG_INIT_OFFSET UNITYSDK_OFFSET(0x125EC820)
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG_REMOVELAYER_OFFSET UNITYSDK_OFFSET(0x125ECE40)
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG_REMOVETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x125ECF90)
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG_SORTCONFIGS_OFFSET UNITYSDK_OFFSET(0x125ECB00)
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x125ED110)

namespace MoleMole::SECTR
{
	inline static constexpr unsigned int SECTR_SceneSplitterConfig_TypeDefinitionIndex = 62053;
