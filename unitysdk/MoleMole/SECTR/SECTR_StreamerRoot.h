...
#define MOLEMOLE_SECTR_SECTR_STREAMERROOT__CTOR_OFFSET UNITYSDK_OFFSET(0x14500EC0)

namespace MoleMole::SECTR
{
	inline static constexpr unsigned int SECTR_StreamerRoot_TypeDefinitionIndex = 90947;
