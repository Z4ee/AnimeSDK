...
#define MOLEMOLE_SECTR_SECTR_NOSTREAMING__CTOR_OFFSET UNITYSDK_OFFSET(0x1809CAA0)

namespace MoleMole::SECTR
{
	inline static constexpr unsigned int SECTR_NoStreaming_TypeDefinitionIndex = 83015;
