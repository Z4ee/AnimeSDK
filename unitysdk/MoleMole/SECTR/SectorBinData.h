...
#define MOLEMOLE_SECTR_SECTORBINDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x141A45C0)

namespace MoleMole::SECTR
{
	inline static constexpr unsigned int SectorBinData_TypeDefinitionIndex = 60203;
