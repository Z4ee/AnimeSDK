...
#define MOLEMOLE_UIFULLSCREENVIDEOV2POPINLOADINGWINDOWCONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x185853F0)
#define MOLEMOLE_UIFULLSCREENVIDEOV2POPINLOADINGWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18585520)
#define MOLEMOLE_UIFULLSCREENVIDEOV2POPINLOADINGWINDOWCONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x18585530)

namespace MoleMole
{
	inline static constexpr unsigned int UIFullScreenVideoV2PopInLoadingWindowController_TypeDefinitionIndex = 87720;
