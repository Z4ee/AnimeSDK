...
#define MOLEMOLE_UILINEUPSELECTCONTEXT_ONGETROLESELECTCONTEXTDEL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x182D3810)
#define MOLEMOLE_UILINEUPSELECTCONTEXT_ONGETROLESELECTCONTEXTDEL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x182D3890)
#define MOLEMOLE_UILINEUPSELECTCONTEXT_ONGETROLESELECTCONTEXTDEL_INVOKE_OFFSET UNITYSDK_OFFSET(0x182D34F0)
#define MOLEMOLE_UILINEUPSELECTCONTEXT_ONGETROLESELECTCONTEXTDEL__CTOR_OFFSET UNITYSDK_OFFSET(0x182D34D0)

namespace MoleMole
{
	inline static constexpr unsigned int UILineupSelectContext_OnGetRoleSelectContextDel_TypeDefinitionIndex = 52591;
