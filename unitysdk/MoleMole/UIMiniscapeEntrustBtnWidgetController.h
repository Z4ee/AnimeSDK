...
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER_GETRARITYICONPATH_OFFSET UNITYSDK_OFFSET(0x1866F270)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER_GET_TASKID_OFFSET UNITYSDK_OFFSET(0x1866F210)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x1866DE20)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER_ONCLICKBTN_OFFSET UNITYSDK_OFFSET(0x1866F550)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1866DF40)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1866DFD0)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1866DD40)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1866DDA0)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER_PLAYREFRESHANIM_OFFSET UNITYSDK_OFFSET(0x1866EFE0)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1866E0B0)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER_SETQUEST_OFFSET UNITYSDK_OFFSET(0x1866E050)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER_TRYREFRESHTASK_OFFSET UNITYSDK_OFFSET(0x1866F410)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1866FB50)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1866FBB0)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1866FC40)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1866FCD0)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1866FD60)

namespace MoleMole
{
	inline static constexpr unsigned int UIMiniscapeEntrustBtnWidgetController_TypeDefinitionIndex = 66672;

	class UIMiniscapeEntrustBtnWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_A8C94EA612F5CBF3_1* _view; // 0x2C0
		::Class_3_5139B0F7496B8379_4* _task; // 0x2C8
