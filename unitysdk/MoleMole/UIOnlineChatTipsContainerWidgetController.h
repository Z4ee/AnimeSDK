...
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1716EF30)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_GET__ONLINECHATOPERATEDATAMODIFYQUEUE_OFFSET UNITYSDK_OFFSET(0x1716DA10)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_GET__ONLINECHATOPERATEDATAS_OFFSET UNITYSDK_OFFSET(0x1716DAE0)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_ISSHOWTIP_OFFSET UNITYSDK_OFFSET(0x1716F000)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_MOVEOPERATEUITOFRONT_OFFSET UNITYSDK_OFFSET(0x1716EB50)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1716E270)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_ONRECEIVEMULTIPLAYERCHATMESSAGE_OFFSET UNITYSDK_OFFSET(0x1716E330)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1716E2C0)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1716DBD0)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1716E1A0)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_PROCESSONLINECHATOPERATEDATAMODIFYQUEUE_OFFSET UNITYSDK_OFFSET(0x1716E700)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1716F0A0)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_REMOVEOPERATEDATA_OFFSET UNITYSDK_OFFSET(0x1716ED10)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_RESUME_OFFSET UNITYSDK_OFFSET(0x1716EFC0)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_SETCONSOLEACTIVE_OFFSET UNITYSDK_OFFSET(0x1716ED90)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1716E6B0)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1716F0F0)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1716F2E0)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1716F370)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1716F400)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1716F490)

namespace MoleMole
{
	inline static constexpr unsigned int UIOnlineChatTipsContainerWidgetController_TypeDefinitionIndex = 76025;
