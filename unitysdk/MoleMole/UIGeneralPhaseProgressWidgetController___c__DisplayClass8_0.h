...
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x167A6080)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__PROGRESSBARANIM_B__0_OFFSET UNITYSDK_OFFSET(0x167A6090)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__PROGRESSBARANIM_B__1_OFFSET UNITYSDK_OFFSET(0x167A6170)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__PROGRESSBARANIM_B__2_OFFSET UNITYSDK_OFFSET(0x167A6400)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralPhaseProgressWidgetController___c__DisplayClass8_0_TypeDefinitionIndex = 67909;
