...
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15A20C30)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__PROGRESSBARANIM_B__0_OFFSET UNITYSDK_OFFSET(0x15A20C40)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__PROGRESSBARANIM_B__1_OFFSET UNITYSDK_OFFSET(0x15A20D20)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__PROGRESSBARANIM_B__2_OFFSET UNITYSDK_OFFSET(0x15A20FB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralPhaseProgressWidgetController___c__DisplayClass8_0_TypeDefinitionIndex = 54598;
