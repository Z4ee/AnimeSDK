...
#define MOLEMOLE_LAUNCHER_CLASS_1_2BEF04B0321A2B95_1_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x136BA350)
#define MOLEMOLE_LAUNCHER_CLASS_1_2BEF04B0321A2B95_1_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x136BA450)
#define MOLEMOLE_LAUNCHER_CLASS_1_2BEF04B0321A2B95_1_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x136BA4B0)
#define MOLEMOLE_LAUNCHER_CLASS_1_2BEF04B0321A2B95_1_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x136BA460)
#define MOLEMOLE_LAUNCHER_CLASS_1_2BEF04B0321A2B95_1_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x136BA340)
#define MOLEMOLE_LAUNCHER_CLASS_1_2BEF04B0321A2B95_1__CTOR_OFFSET UNITYSDK_OFFSET(0x136BA330)

namespace MoleMole
{
	inline static constexpr unsigned int Launcher_Class_1_2BEF04B0321A2B95_1_TypeDefinitionIndex = 42429;

	class Launcher_Class_1_2BEF04B0321A2B95_1 : public ::System::Object
	{
	public:
		::MoleMole::Launcher* Field_1_0; // 0x10
