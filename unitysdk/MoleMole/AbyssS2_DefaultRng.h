...
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_GET_RNGSEED_OFFSET UNITYSDK_OFFSET(0x11444700)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_NEXTBOOL_OFFSET UNITYSDK_OFFSET(0x11444720)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_NEXTFLOAT_OFFSET UNITYSDK_OFFSET(0x114447F0)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_NEXTINT_OFFSET UNITYSDK_OFFSET(0x11444790)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_NEXTLONG_OFFSET UNITYSDK_OFFSET(0x11444850)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_NEXTUINT_OFFSET UNITYSDK_OFFSET(0x114448D0)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_NEXTULONG_OFFSET UNITYSDK_OFFSET(0x11444930)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_RANGEINT_OFFSET UNITYSDK_OFFSET(0x11444980)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_SET_RNGSEED_OFFSET UNITYSDK_OFFSET(0x11444710)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG__CTOR_OFFSET UNITYSDK_OFFSET(0x114446A0)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_DefaultRng_TypeDefinitionIndex = 87609;
