...
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_GET_RNGSEED_OFFSET UNITYSDK_OFFSET(0x12C47A50)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_NEXTBOOL_OFFSET UNITYSDK_OFFSET(0x12C47A70)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_NEXTFLOAT_OFFSET UNITYSDK_OFFSET(0x12C47B40)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_NEXTINT_OFFSET UNITYSDK_OFFSET(0x12C47AE0)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_NEXTLONG_OFFSET UNITYSDK_OFFSET(0x12C47BA0)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_NEXTUINT_OFFSET UNITYSDK_OFFSET(0x12C47C20)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_NEXTULONG_OFFSET UNITYSDK_OFFSET(0x12C47C80)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_RANGEINT_OFFSET UNITYSDK_OFFSET(0x12C47CD0)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_SET_RNGSEED_OFFSET UNITYSDK_OFFSET(0x12C47A60)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG__CTOR_OFFSET UNITYSDK_OFFSET(0x12C479F0)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_DefaultRng_TypeDefinitionIndex = 85693;
