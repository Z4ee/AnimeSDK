...
#define MOLEMOLE_UIMAINSTORYREWARDDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x169C5320)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainStoryRewardDialogContext_TypeDefinitionIndex = 49767;
