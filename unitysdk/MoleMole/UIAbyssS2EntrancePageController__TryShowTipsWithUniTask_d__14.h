...
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER__TRYSHOWTIPSWITHUNITASK_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x8A5E90)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER__TRYSHOWTIPSWITHUNITASK_D__14_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x7DEF30)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2EntrancePageController__TryShowTipsWithUniTask_d__14_TypeDefinitionIndex = 64832;
