...
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER__TRYSHOWTIPSWITHUNITASK_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x814540)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER__TRYSHOWTIPSWITHUNITASK_D__14_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x6CBFE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2EntrancePageController__TryShowTipsWithUniTask_d__14_TypeDefinitionIndex = 54800;
	...
	struct alignas(8) UIAbyssS2EntrancePageController__TryShowTipsWithUniTask_d__14
	{
		...
		::Cysharp::Threading::Tasks::UniTask_1_Awaiter<::System::Int32> __u__2; // 0x18
		...
		::System::Int32 _reminderID_5__2; // 0x5C
