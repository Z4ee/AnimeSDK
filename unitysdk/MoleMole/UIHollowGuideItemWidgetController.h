...
#define MOLEMOLE_UIHOLLOWGUIDEITEMWIDGETCONTROLLER_GET_FULLSCREENRECTTRANS_OFFSET UNITYSDK_OFFSET(0x1813A650)
#define MOLEMOLE_UIHOLLOWGUIDEITEMWIDGETCONTROLLER_GET_ISPLAYERVISIBLE_OFFSET UNITYSDK_OFFSET(0x1813A620)
#define MOLEMOLE_UIHOLLOWGUIDEITEMWIDGETCONTROLLER_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x1813A630)
#define MOLEMOLE_UIHOLLOWGUIDEITEMWIDGETCONTROLLER_HIDEVIEW_OFFSET UNITYSDK_OFFSET(0x1813B1F0)
#define MOLEMOLE_UIHOLLOWGUIDEITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1813A7D0)
#define MOLEMOLE_UIHOLLOWGUIDEITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1813A860)
#define MOLEMOLE_UIHOLLOWGUIDEITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1813A670)
#define MOLEMOLE_UIHOLLOWGUIDEITEMWIDGETCONTROLLER_RESETVIEWSTATE_OFFSET UNITYSDK_OFFSET(0x1813A8E0)
#define MOLEMOLE_UIHOLLOWGUIDEITEMWIDGETCONTROLLER_SET_FULLSCREENRECTTRANS_OFFSET UNITYSDK_OFFSET(0x1813A660)
#define MOLEMOLE_UIHOLLOWGUIDEITEMWIDGETCONTROLLER_SET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x1813A640)
#define MOLEMOLE_UIHOLLOWGUIDEITEMWIDGETCONTROLLER_SHOWVIEW_OFFSET UNITYSDK_OFFSET(0x1813B0C0)
#define MOLEMOLE_UIHOLLOWGUIDEITEMWIDGETCONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0x1813A9A0)
#define MOLEMOLE_UIHOLLOWGUIDEITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1813B6E0)
#define MOLEMOLE_UIHOLLOWGUIDEITEMWIDGETCONTROLLER__HIDEVIEW_B__17_0_OFFSET UNITYSDK_OFFSET(0x1813B8D0)
#define MOLEMOLE_UIHOLLOWGUIDEITEMWIDGETCONTROLLER__ONUIINIT_B__10_0_OFFSET UNITYSDK_OFFSET(0x1813B750)
#define MOLEMOLE_UIHOLLOWGUIDEITEMWIDGETCONTROLLER__TICK_G___UPDATEPOS_15_0_OFFSET UNITYSDK_OFFSET(0x1813B2C0)
#define MOLEMOLE_UIHOLLOWGUIDEITEMWIDGETCONTROLLER__TICK_G___UPDATEROT_15_1_OFFSET UNITYSDK_OFFSET(0x1813B4B0)
#define MOLEMOLE_UIHOLLOWGUIDEITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1813BB10)
#define MOLEMOLE_UIHOLLOWGUIDEITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1813BBA0)
#define MOLEMOLE_UIHOLLOWGUIDEITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1813BC30)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowGuideItemWidgetController_TypeDefinitionIndex = 72159;
