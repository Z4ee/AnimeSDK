...
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_CREATEITEMICON_OFFSET UNITYSDK_OFFSET(0x175EB960)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x175EAD60)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x175EAF90)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_ONCLICKITEMBTN_OFFSET UNITYSDK_OFFSET(0x175EBAA0)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175EB350)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x175EB3E0)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x175EAD70)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x175EAE50)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_OPENEQUIPDETAIL_OFFSET UNITYSDK_OFFSET(0x175EBEA0)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x175EB450)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_SETTIP_OFFSET UNITYSDK_OFFSET(0x175BD000)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x175EC2A0)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175EC2D0)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x175EC360)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x175EC370)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x175EC380)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralUpDialogPopWindowController_TypeDefinitionIndex = 43511;

	class UIGeneralUpDialogPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_08996034AAFF91A2* _view; // 0x318
		::Class_2_03F4D9B3111E6159* _itemModel; // 0x320
