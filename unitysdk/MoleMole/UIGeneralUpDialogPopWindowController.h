...
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_CREATEITEMICON_OFFSET UNITYSDK_OFFSET(0x14EF1820)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x14EF0C30)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x14EF0E60)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_ONCLICKITEMBTN_OFFSET UNITYSDK_OFFSET(0x14EF1960)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14EF1220)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14EF12B0)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14EF0C40)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14EF0D20)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_OPENEQUIPDETAIL_OFFSET UNITYSDK_OFFSET(0x14EF1CB0)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x14EF1320)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_SETTIP_OFFSET UNITYSDK_OFFSET(0x14EC3B70)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14EF2060)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14EF2090)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14EF2120)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14EF2130)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14EF2140)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralUpDialogPopWindowController_TypeDefinitionIndex = 51599;

	class UIGeneralUpDialogPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_08996034AAFF91A2* _view; // 0x310
		::Class_2_9D9172C07F82DDAE* _itemModel; // 0x318
		...
		::System::Boolean _useCustomInfo; // 0x330
		::System::Collections::Generic::List_1<::Class_1_0D6706375CDAAE8C*>* _customItemList; // 0x338
		::System::String* _customTitle; // 0x340
		::System::String* _customTitleEn; // 0x348
		::System::String* _tipInfo; // 0x350
