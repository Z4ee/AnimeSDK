...
#define MOLEMOLE_UIMECHBOOPREPPAGECONTROLLER_CLICKSCRIPTACTION_OFFSET UNITYSDK_OFFSET(0x18333CB0)
#define MOLEMOLE_UIMECHBOOPREPPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x18332910)
#define MOLEMOLE_UIMECHBOOPREPPAGECONTROLLER_GOTOSCRIPT_OFFSET UNITYSDK_OFFSET(0x18334670)
#define MOLEMOLE_UIMECHBOOPREPPAGECONTROLLER_ONCLICKTABBTN_OFFSET UNITYSDK_OFFSET(0x18333460)
#define MOLEMOLE_UIMECHBOOPREPPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18332920)
#define MOLEMOLE_UIMECHBOOPREPPAGECONTROLLER_ONOPENTIPSPANELBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x183347E0)
#define MOLEMOLE_UIMECHBOOPREPPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x183333F0)
#define MOLEMOLE_UIMECHBOOPREPPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x183329B0)
#define MOLEMOLE_UIMECHBOOPREPPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18332F10)
#define MOLEMOLE_UIMECHBOOPREPPAGECONTROLLER_REFRESHSCRIPTLISTVIEW_OFFSET UNITYSDK_OFFSET(0x18333550)
#define MOLEMOLE_UIMECHBOOPREPPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x18333350)
#define MOLEMOLE_UIMECHBOOPREPPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x183348B0)
#define MOLEMOLE_UIMECHBOOPREPPAGECONTROLLER__ONUIINIT_B__7_0_OFFSET UNITYSDK_OFFSET(0x18334950)
#define MOLEMOLE_UIMECHBOOPREPPAGECONTROLLER__ONUIINIT_B__7_1_OFFSET UNITYSDK_OFFSET(0x18334960)
#define MOLEMOLE_UIMECHBOOPREPPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18334970)
#define MOLEMOLE_UIMECHBOOPREPPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18334A00)
#define MOLEMOLE_UIMECHBOOPREPPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18334A10)
#define MOLEMOLE_UIMECHBOOPREPPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18334A20)
#define MOLEMOLE_UIMECHBOOPREPPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x18334A30)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechBooPrepPageController_TypeDefinitionIndex = 53947;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_181*>* _curLevels; // 0x338
		...
		::System::Void ClickScriptAction(::Class_0_16E4307DCC419505_181* levelInfo)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_181*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMECHBOOPREPPAGECONTROLLER_CLICKSCRIPTACTION_OFFSET))(this, levelInfo);
		}
