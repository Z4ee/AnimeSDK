...
#define MOLEMOLE_UILEVELINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14D2F230)
#define MOLEMOLE_UILEVELINFOWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x14D2F2C0)
#define MOLEMOLE_UILEVELINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14D2F5A0)
#define MOLEMOLE_UILEVELINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14D2F060)
#define MOLEMOLE_UILEVELINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14D2F1C0)
#define MOLEMOLE_UILEVELINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14D2F620)
#define MOLEMOLE_UILEVELINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14D2F630)
#define MOLEMOLE_UILEVELINFOWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x14D2F6C0)
#define MOLEMOLE_UILEVELINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14D2F760)
#define MOLEMOLE_UILEVELINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14D2F7F0)
#define MOLEMOLE_UILEVELINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14D2F880)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelInfoWidgetController_TypeDefinitionIndex = 42695;

	class UILevelInfoWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_27C81EA3CFB263AC_1* _view; // 0x2E8
