...
#define MOLEMOLE_MONODIALALONGUPTRAIT_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x161FDF00)
#define MOLEMOLE_MONODIALALONGUPTRAIT_ONDOUPDATE_OFFSET UNITYSDK_OFFSET(0x161FE260)
#define MOLEMOLE_MONODIALALONGUPTRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x161FE5A0)
#define MOLEMOLE_MONODIALALONGUPTRAIT___BASE_ONDOUPDATE_OFFSET UNITYSDK_OFFSET(0x161FE640)

namespace MoleMole
{
	inline static constexpr unsigned int MonoDialAlongUpTrait_TypeDefinitionIndex = 85970;

	class MonoDialAlongUpTrait : public ::MoleMole::MonoPartySceneObject
	{
	public:
		::System::Single Field_8_0; // 0x30
		::System::Single Field_8_1; // 0x34
		::UnityEngine::Vector3 Field_8_2; // 0x38
		::UnityEngine::Quaternion Field_8_3; // 0x44
		::UnityEngine::Rigidbody* Field_8_4; // 0x58
