...
#define MOLEMOLE_UIOPERATIONYUMTABWIDGETCONTROLLER_GET_TABBUTTON_OFFSET UNITYSDK_OFFSET(0x174EFED0)
#define MOLEMOLE_UIOPERATIONYUMTABWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x174F0020)
#define MOLEMOLE_UIOPERATIONYUMTABWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x174F00B0)
#define MOLEMOLE_UIOPERATIONYUMTABWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x174EFEF0)
#define MOLEMOLE_UIOPERATIONYUMTABWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x174F0190)
#define MOLEMOLE_UIOPERATIONYUMTABWIDGETCONTROLLER_SETINDEXANDPERIODID_OFFSET UNITYSDK_OFFSET(0x174F0130)
#define MOLEMOLE_UIOPERATIONYUMTABWIDGETCONTROLLER_SETSELECT_OFFSET UNITYSDK_OFFSET(0x174F0420)
#define MOLEMOLE_UIOPERATIONYUMTABWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x174F04F0)
#define MOLEMOLE_UIOPERATIONYUMTABWIDGETCONTROLLER__ONUIINIT_B__6_0_OFFSET UNITYSDK_OFFSET(0x174F0550)
#define MOLEMOLE_UIOPERATIONYUMTABWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x174F0560)
#define MOLEMOLE_UIOPERATIONYUMTABWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x174F05F0)
#define MOLEMOLE_UIOPERATIONYUMTABWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x174F0680)

namespace MoleMole
{
	inline static constexpr unsigned int UIOperationYumTabWidgetController_TypeDefinitionIndex = 68546;
