...
#define MOLEMOLE_UIOPERATIONYUMTABWIDGETCONTROLLER_GET_TABBUTTON_OFFSET UNITYSDK_OFFSET(0x17467DF0)
#define MOLEMOLE_UIOPERATIONYUMTABWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17467F40)
#define MOLEMOLE_UIOPERATIONYUMTABWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17467FD0)
#define MOLEMOLE_UIOPERATIONYUMTABWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17467E10)
#define MOLEMOLE_UIOPERATIONYUMTABWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x174680B0)
#define MOLEMOLE_UIOPERATIONYUMTABWIDGETCONTROLLER_SETINDEXANDPERIODID_OFFSET UNITYSDK_OFFSET(0x17468050)
#define MOLEMOLE_UIOPERATIONYUMTABWIDGETCONTROLLER_SETSELECT_OFFSET UNITYSDK_OFFSET(0x17468340)
#define MOLEMOLE_UIOPERATIONYUMTABWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17468410)
#define MOLEMOLE_UIOPERATIONYUMTABWIDGETCONTROLLER__ONUIINIT_B__6_0_OFFSET UNITYSDK_OFFSET(0x17468470)
#define MOLEMOLE_UIOPERATIONYUMTABWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17468480)
#define MOLEMOLE_UIOPERATIONYUMTABWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17468510)
#define MOLEMOLE_UIOPERATIONYUMTABWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x174685A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIOperationYumTabWidgetController_TypeDefinitionIndex = 78505;

	class UIOperationYumTabWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_30776A4C6D5D6FC5* _view; // 0x2C0
		::System::Action_1<::System::Int32>* OnSelect; // 0x2C8
		::System::Int32 _periodID; // 0x2D0
		::System::Int32 _index; // 0x2D4
