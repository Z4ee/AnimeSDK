...
#define MOLEMOLE_UIBOTTLELOGINDIALOGPOPWINDOWCONTROLLER__SETTHROWBOTTLE_D__21_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x7AD920)
#define MOLEMOLE_UIBOTTLELOGINDIALOGPOPWINDOWCONTROLLER__SETTHROWBOTTLE_D__21_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x6069D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBottleLoginDialogPopWindowController__SetThrowBottle_d__21_TypeDefinitionIndex = 39483;
