...
#define MOLEMOLE_UIBOTTLELOGINDIALOGPOPWINDOWCONTROLLER__SETTHROWBOTTLE_D__21_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x85AC20)
#define MOLEMOLE_UIBOTTLELOGINDIALOGPOPWINDOWCONTROLLER__SETTHROWBOTTLE_D__21_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x6CB1D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBottleLoginDialogPopWindowController__SetThrowBottle_d__21_TypeDefinitionIndex = 63112;

	struct alignas(8) UIBottleLoginDialogPopWindowController__SetThrowBottle_d__21
	{
		::MoleMole::UIBottleLoginDialogPopWindowController* __4__this; // 0x10
