...
#define MOLEMOLE_COMICSCREENINFO_ANIMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B79F350)

namespace MoleMole
{
	inline static constexpr unsigned int ComicScreenInfo_AnimInfo_TypeDefinitionIndex = 30585;
