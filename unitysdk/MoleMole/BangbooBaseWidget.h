...
#define MOLEMOLE_BANGBOOBASEWIDGET_GETLEFTBTNTEXT_OFFSET UNITYSDK_OFFSET(0x12CA1260)
#define MOLEMOLE_BANGBOOBASEWIDGET_GETRIGHTBTNTEXT_OFFSET UNITYSDK_OFFSET(0x12CA12B0)
#define MOLEMOLE_BANGBOOBASEWIDGET_GETTIPSTEXT_OFFSET UNITYSDK_OFFSET(0x12CA1300)
#define MOLEMOLE_BANGBOOBASEWIDGET_GET_PARENTDEVELOPUI_OFFSET UNITYSDK_OFFSET(0x12CA1110)
#define MOLEMOLE_BANGBOOBASEWIDGET_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x12CA10F0)
#define MOLEMOLE_BANGBOOBASEWIDGET_LEFTBTNCALL_OFFSET UNITYSDK_OFFSET(0x12CA13E0)
#define MOLEMOLE_BANGBOOBASEWIDGET_ONHIDE_OFFSET UNITYSDK_OFFSET(0x12CA1470)
#define MOLEMOLE_BANGBOOBASEWIDGET_RIGHTBTNCALL_OFFSET UNITYSDK_OFFSET(0x12CA13A0)
#define MOLEMOLE_BANGBOOBASEWIDGET_SETATTRIBUTEFUNC_OFFSET UNITYSDK_OFFSET(0x12CA1190)
#define MOLEMOLE_BANGBOOBASEWIDGET_SETBANGBOODATA_OFFSET UNITYSDK_OFFSET(0x12CA1350)
#define MOLEMOLE_BANGBOOBASEWIDGET_SETPARENTVIEW_OFFSET UNITYSDK_OFFSET(0x12CA1420)
#define MOLEMOLE_BANGBOOBASEWIDGET_SETPROGRESSMAT_OFFSET UNITYSDK_OFFSET(0x12CA11E0)
#define MOLEMOLE_BANGBOOBASEWIDGET_SET_PARENT_OFFSET UNITYSDK_OFFSET(0x12CA1100)
#define MOLEMOLE_BANGBOOBASEWIDGET_UPDATEUI_OFFSET UNITYSDK_OFFSET(0x12CA1220)
#define MOLEMOLE_BANGBOOBASEWIDGET__CTOR_OFFSET UNITYSDK_OFFSET(0x12CA14E0)
#define MOLEMOLE_BANGBOOBASEWIDGET___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x12CA1540)

namespace MoleMole
{
	inline static constexpr unsigned int BangbooBaseWidget_TypeDefinitionIndex = 69796;

	class BangbooBaseWidget : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_3BB4FDB082E23A99* _data; // 0x2C0
		...
		::System::Void SetBangbooData(::Class_2_3BB4FDB082E23A99* data)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_3BB4FDB082E23A99*))((::PBYTE)hIl2Cpp + MOLEMOLE_BANGBOOBASEWIDGET_SETBANGBOODATA_OFFSET))(this, data);
		}
