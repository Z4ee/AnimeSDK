...
#define MOLEMOLE_FISHUPLEVELSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x11603A70)
#define MOLEMOLE_FISHUPLEVELSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x11603B00)
#define MOLEMOLE_FISHUPLEVELSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x11603A80)

namespace MoleMole
{
	inline static constexpr unsigned int FishUpLevelShow_TypeDefinitionIndex = 63304;
