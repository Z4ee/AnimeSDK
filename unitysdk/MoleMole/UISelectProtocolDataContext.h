...
#define MOLEMOLE_UISELECTPROTOCOLDATACONTEXT_ADDPROTOCOLROWITEM_OFFSET UNITYSDK_OFFSET(0x145811A0)
#define MOLEMOLE_UISELECTPROTOCOLDATACONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x14581270)

namespace MoleMole
{
	inline static constexpr unsigned int UISelectProtocolDataContext_TypeDefinitionIndex = 74858;
