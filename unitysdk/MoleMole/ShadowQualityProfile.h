...
#define MOLEMOLE_SHADOWQUALITYPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x130468D0)
#define MOLEMOLE_SHADOWQUALITYPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x13046A10)
#define MOLEMOLE_SHADOWQUALITYPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x130467F0)
#define MOLEMOLE_SHADOWQUALITYPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x13046990)
#define MOLEMOLE_SHADOWQUALITYPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x130467E0)
#define MOLEMOLE_SHADOWQUALITYPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x13046B30)
#define MOLEMOLE_SHADOWQUALITYPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x13046BC0)
#define MOLEMOLE_SHADOWQUALITYPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x13046C50)
#define MOLEMOLE_SHADOWQUALITYPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x13046CE0)

namespace MoleMole
{
	inline static constexpr unsigned int ShadowQualityProfile_TypeDefinitionIndex = 64698;
