...
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_CHANGETEAMDATAS_OFFSET UNITYSDK_OFFSET(0xFF09BF0)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_CHECKNEEDREALODAVATAR_OFFSET UNITYSDK_OFFSET(0xFF089B0)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_GETAVATARPROPERTYMAP_OFFSET UNITYSDK_OFFSET(0xFF0A2A0)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_GET_FORCEOPENTEAM_OFFSET UNITYSDK_OFFSET(0xFF07640)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_GET_ISCUSTOMTEAM_OFFSET UNITYSDK_OFFSET(0xFF07660)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_GET_SKIPLOADINGREPLACE_OFFSET UNITYSDK_OFFSET(0xFF07680)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_HIDEBATTLEBUDDY_OFFSET UNITYSDK_OFFSET(0xFF0AB80)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_INITPREDATA_OFFSET UNITYSDK_OFFSET(0xFF081F0)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_ISAVATARAWAKENDIFFERENT_OFFSET UNITYSDK_OFFSET(0xFF08AA0)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_ISAVATARITEMDIFFERENT_OFFSET UNITYSDK_OFFSET(0xFF08C60)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_ISAVATARSKINDIFFERENT_OFFSET UNITYSDK_OFFSET(0xFF08D70)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_ISBUDDYITEMDIFFERENT_OFFSET UNITYSDK_OFFSET(0xFF08B00)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_ISEQUIPMENDATASDIFFERENT_OFFSET UNITYSDK_OFFSET(0xFF095F0)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_ISEQUIPMENSUITDIFFERENT_OFFSET UNITYSDK_OFFSET(0xFF08E80)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_ISPROPERTYDIFFERENT_OFFSET UNITYSDK_OFFSET(0xFF09B20)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_ISWEAPONDATADIFFERENT_OFFSET UNITYSDK_OFFSET(0xFF09280)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xFF0AE80)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0xFF0A560)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_ONEVTLEVELREPLACETEAMAVATARCOMPLETE_OFFSET UNITYSDK_OFFSET(0xFF0AB30)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_ONUIROLESELECTCHANGESTATE_OFFSET UNITYSDK_OFFSET(0xFF07EE0)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xFF07B30)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_PLAYMATEFFECTREPLACEFINISH_OFFSET UNITYSDK_OFFSET(0xFF0ACC0)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_REGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0xFF076A0)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_REGISTERSKIPLOADINGREPLACE_OFFSET UNITYSDK_OFFSET(0xFF07E60)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_REGISTERUIEVENTNOTIFYTYPE_OFFSET UNITYSDK_OFFSET(0xFF07920)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_SET_FORCEOPENTEAM_OFFSET UNITYSDK_OFFSET(0xFF07650)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_SET_ISCUSTOMTEAM_OFFSET UNITYSDK_OFFSET(0xFF07670)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_SET_SKIPLOADINGREPLACE_OFFSET UNITYSDK_OFFSET(0xFF07690)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM_UNREGISTERSKIPLOADINGREPLACE_OFFSET UNITYSDK_OFFSET(0xFF07EA0)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0xFF0B120)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM__REGISTERUIEVENTNOTIFYTYPE_B__29_0_OFFSET UNITYSDK_OFFSET(0xFF0B180)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM__REGISTERUIEVENTNOTIFYTYPE_B__29_1_OFFSET UNITYSDK_OFFSET(0xFF0B1A0)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xFF0B3F0)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM___BASE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0xFF0B480)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xFF0B510)
#define MOLEMOLE_BIGSCENETEAMREPLACESUBSYSTEM___BASE_REGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0xFF0B5A0)

namespace MoleMole
{
	inline static constexpr unsigned int BigSceneTeamReplaceSubsystem_TypeDefinitionIndex = 65581;
	...
	public:
		...
		::System::Collections::Generic::List_1<::System::UInt32>* _avatarsAwakenChangeRecord; // 0x20
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_2_2DFDAF0B881128C6_Class_1_E2EAEB159D32F976*>* _preEquipmentDatas; // 0x28
		::System::Collections::Generic::List_1<::Class_2_1824EF69C8E376A3*>* _preAvatarItemList; // 0x30
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Int32>*>* _prePropertyMap; // 0x38
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Collections::Generic::List_1<::Class_2_2DFDAF0B881128C6_Class_1_73C31DDA126AE455*>*>* _preSuitDatas; // 0x40
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Int32>* _preAvatarSkinDatas; // 0x48
		::System::Single _reportTime; // 0x50
		::System::Boolean _IsCustomTeam_k__BackingField; // 0x54
		::System::Boolean _forceCheckReload; // 0x55
		::System::Boolean _SkipLoadingReplace_k__BackingField; // 0x56
		::System::Boolean _curIsMainUIHide; // 0x57
		::System::Boolean _ForceOpenTeam_k__BackingField; // 0x58
