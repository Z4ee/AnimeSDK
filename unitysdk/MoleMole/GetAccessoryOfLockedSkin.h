...
#define MOLEMOLE_GETACCESSORYOFLOCKEDSKIN_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x179056C0)
#define MOLEMOLE_GETACCESSORYOFLOCKEDSKIN_ONCLICKGO_OFFSET UNITYSDK_OFFSET(0x17905AF0)
#define MOLEMOLE_GETACCESSORYOFLOCKEDSKIN_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x17905710)
#define MOLEMOLE_GETACCESSORYOFLOCKEDSKIN__CTOR_OFFSET UNITYSDK_OFFSET(0x179056D0)

namespace MoleMole
{
	inline static constexpr unsigned int GetAccessoryOfLockedSkin_TypeDefinitionIndex = 43958;
