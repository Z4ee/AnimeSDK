...
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x168822F0)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER_ONITEMCHANGED_OFFSET UNITYSDK_OFFSET(0x168830D0)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16881C50)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16882380)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16881140)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16881590)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER_REFRESHBOSSREWARD_OFFSET UNITYSDK_OFFSET(0x16882400)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0x16881810)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER_REFRESHREWARDBUFFVIEW_OFFSET UNITYSDK_OFFSET(0x16881E30)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16883120)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER__ONUIINIT_B__3_0_OFFSET UNITYSDK_OFFSET(0x16883200)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER__ONUIINIT_B__3_1_OFFSET UNITYSDK_OFFSET(0x16883220)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16883240)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x168832D0)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16883370)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16883400)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16883490)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookBossWidgetController_TypeDefinitionIndex = 57368;
