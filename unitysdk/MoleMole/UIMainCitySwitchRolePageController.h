...
#define MOLEMOLE_UIMAINCITYSWITCHROLEPAGECONTROLLER_GETANDSELECTSKINNEWBIEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x17146D90)
#define MOLEMOLE_UIMAINCITYSWITCHROLEPAGECONTROLLER_GETDEFAULTTABINDEX_OFFSET UNITYSDK_OFFSET(0x17147700)
#define MOLEMOLE_UIMAINCITYSWITCHROLEPAGECONTROLLER_GETNEWBIEDYNAMICOBJECT_OFFSET UNITYSDK_OFFSET(0x17146AA0)
#define MOLEMOLE_UIMAINCITYSWITCHROLEPAGECONTROLLER_GET_TOPANIM_OFFSET UNITYSDK_OFFSET(0x171462C0)
#define MOLEMOLE_UIMAINCITYSWITCHROLEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x171462B0)
#define MOLEMOLE_UIMAINCITYSWITCHROLEPAGECONTROLLER_ISSKINSWITCHMUIPLOCKED_OFFSET UNITYSDK_OFFSET(0x17146EE0)
#define MOLEMOLE_UIMAINCITYSWITCHROLEPAGECONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0x17147010)
#define MOLEMOLE_UIMAINCITYSWITCHROLEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17147B10)
#define MOLEMOLE_UIMAINCITYSWITCHROLEPAGECONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x17147C10)
#define MOLEMOLE_UIMAINCITYSWITCHROLEPAGECONTROLLER_ONNEWBIECLOSE_OFFSET UNITYSDK_OFFSET(0x17146E00)
#define MOLEMOLE_UIMAINCITYSWITCHROLEPAGECONTROLLER_ONPOSTPAGESHOWED_OFFSET UNITYSDK_OFFSET(0x17147A60)
#define MOLEMOLE_UIMAINCITYSWITCHROLEPAGECONTROLLER_ONPRECHECKSWITCHAVATAR_OFFSET UNITYSDK_OFFSET(0x17147D90)
#define MOLEMOLE_UIMAINCITYSWITCHROLEPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17147C80)
#define MOLEMOLE_UIMAINCITYSWITCHROLEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17147BA0)
#define MOLEMOLE_UIMAINCITYSWITCHROLEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x171462E0)
#define MOLEMOLE_UIMAINCITYSWITCHROLEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x171475F0)
#define MOLEMOLE_UIMAINCITYSWITCHROLEPAGECONTROLLER_REFRESHRUNTIMEINPUTACTION_OFFSET UNITYSDK_OFFSET(0x17146920)
#define MOLEMOLE_UIMAINCITYSWITCHROLEPAGECONTROLLER_SHOWORHIDEWIDGET_OFFSET UNITYSDK_OFFSET(0x17147540)
#define MOLEMOLE_UIMAINCITYSWITCHROLEPAGECONTROLLER_TRYTRIGGERNEWBIE_OFFSET UNITYSDK_OFFSET(0x17147AD0)
#define MOLEMOLE_UIMAINCITYSWITCHROLEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x171481D0)
#define MOLEMOLE_UIMAINCITYSWITCHROLEPAGECONTROLLER___BASE_GETNEWBIEDYNAMICOBJECT_OFFSET UNITYSDK_OFFSET(0x17148290)
#define MOLEMOLE_UIMAINCITYSWITCHROLEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17148320)
#define MOLEMOLE_UIMAINCITYSWITCHROLEPAGECONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x171483B0)
#define MOLEMOLE_UIMAINCITYSWITCHROLEPAGECONTROLLER___BASE_ONPOSTPAGESHOWED_OFFSET UNITYSDK_OFFSET(0x17148440)
#define MOLEMOLE_UIMAINCITYSWITCHROLEPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17148450)
#define MOLEMOLE_UIMAINCITYSWITCHROLEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17148460)
#define MOLEMOLE_UIMAINCITYSWITCHROLEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17148470)
#define MOLEMOLE_UIMAINCITYSWITCHROLEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17148480)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCitySwitchRolePageController_TypeDefinitionIndex = 79446;
