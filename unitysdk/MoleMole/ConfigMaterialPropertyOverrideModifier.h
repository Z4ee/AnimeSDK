...
#define MOLEMOLE_CONFIGMATERIALPROPERTYOVERRIDEMODIFIER_DOAFTERONENTER_OFFSET UNITYSDK_OFFSET(0xE985070)
#define MOLEMOLE_CONFIGMATERIALPROPERTYOVERRIDEMODIFIER_DOONENTER_OFFSET UNITYSDK_OFFSET(0xE984F90)
#define MOLEMOLE_CONFIGMATERIALPROPERTYOVERRIDEMODIFIER_DOWARMUP_OFFSET UNITYSDK_OFFSET(0xE985BB0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYOVERRIDEMODIFIER_PREPAREONENTER_OFFSET UNITYSDK_OFFSET(0xE984CF0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYOVERRIDEMODIFIER_PREPAREONEXIT_OFFSET UNITYSDK_OFFSET(0xE985180)
#define MOLEMOLE_CONFIGMATERIALPROPERTYOVERRIDEMODIFIER_PROCESSENTER_OFFSET UNITYSDK_OFFSET(0xE9850D0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYOVERRIDEMODIFIER_PROCESSEXIT_OFFSET UNITYSDK_OFFSET(0xE9851D0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYOVERRIDEMODIFIER_PROCESSKEEP_OFFSET UNITYSDK_OFFSET(0xE985520)
#define MOLEMOLE_CONFIGMATERIALPROPERTYOVERRIDEMODIFIER_SYNCENABLES_OFFSET UNITYSDK_OFFSET(0xE985410)
#define MOLEMOLE_CONFIGMATERIALPROPERTYOVERRIDEMODIFIER_SYNCVALUES_OFFSET UNITYSDK_OFFSET(0xE985320)
#define MOLEMOLE_CONFIGMATERIALPROPERTYOVERRIDEMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0xE985C40)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigMaterialPropertyOverrideModifier_TypeDefinitionIndex = 53096;
