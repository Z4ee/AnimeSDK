...
#define MOLEMOLE_MONOINLEVELBASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x13EA4240)
#define MOLEMOLE_MONOINLEVELBASE_LOADSPRITEASYNC_OFFSET UNITYSDK_OFFSET(0x13EA4B70)
#define MOLEMOLE_MONOINLEVELBASE_LOADSPRITE_OFFSET UNITYSDK_OFFSET(0x13EA4850)
#define MOLEMOLE_MONOINLEVELBASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x13EA42E0)
#define MOLEMOLE_MONOINLEVELBASE_SETUPIMAGESPRITE_1_OFFSET UNITYSDK_OFFSET(0x13EA4AC0)
#define MOLEMOLE_MONOINLEVELBASE_SETUPIMAGESPRITE_OFFSET UNITYSDK_OFFSET(0x13EA44D0)
#define MOLEMOLE_MONOINLEVELBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x13EA4C70)

namespace MoleMole
{
	inline static constexpr unsigned int MonoInLevelBase_TypeDefinitionIndex = 63903;
