...
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16942D40)

namespace MoleMole
{
	inline static constexpr unsigned int UIMarcelNameWidgetController_Context_TypeDefinitionIndex = 79093;
