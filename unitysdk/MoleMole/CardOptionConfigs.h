...
#define MOLEMOLE_CARDOPTIONCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x12C53B00)

namespace MoleMole
{
	inline static constexpr unsigned int CardOptionConfigs_TypeDefinitionIndex = 61475;
