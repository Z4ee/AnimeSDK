...
#define MOLEMOLE_CARDOPTIONCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x11451380)

namespace MoleMole
{
	inline static constexpr unsigned int CardOptionConfigs_TypeDefinitionIndex = 49101;
