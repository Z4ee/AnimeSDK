...
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x199CE5F0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_DOBUY_OFFSET UNITYSDK_OFFSET(0x199CD0A0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_GETITEMGAMEPADLIST_OFFSET UNITYSDK_OFFSET(0x199CEDD0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x199CC320)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_INITSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x199CCCD0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_INITTABBTNGROUP_OFFSET UNITYSDK_OFFSET(0x199CC8A0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x199CC460)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_ONCLICKTABLEFT_OFFSET UNITYSDK_OFFSET(0x199CD550)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_ONCLICKTABRIGHT_OFFSET UNITYSDK_OFFSET(0x199CD6E0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0x199CD5B0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_ONCOSTREFRESHSHOP_OFFSET UNITYSDK_OFFSET(0x199CE6F0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x199CCB60)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_ONTABDATAUPDATE_OFFSET UNITYSDK_OFFSET(0x199CD750)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x199CCBF0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x199CC330)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x199CC750)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_REQUESTNEWTIME_OFFSET UNITYSDK_OFFSET(0x199CE680)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_SELECTEDGOODS_OFFSET UNITYSDK_OFFSET(0x199CCFA0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_SETCURGOODSLIST_OFFSET UNITYSDK_OFFSET(0x199CDAE0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_SETLOCK_OFFSET UNITYSDK_OFFSET(0x199CCEA0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_SHOWCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x199CE230)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_SHOWGOODSLOCKTIPS_OFFSET UNITYSDK_OFFSET(0x199CD2A0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_SHOWREFRESH_OFFSET UNITYSDK_OFFSET(0x199CDFD0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_SHOWTABLOCKTIPS_OFFSET UNITYSDK_OFFSET(0x199CD8B0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_SHOWTAB_OFFSET UNITYSDK_OFFSET(0x199CDDD0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x199CEE30)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER__INITSCROLLVIEW_B__20_0_OFFSET UNITYSDK_OFFSET(0x199CEFB0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER__INITVIEW_B__19_0_OFFSET UNITYSDK_OFFSET(0x199CEEB0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x199CF090)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x199CF120)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x199CF130)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x199CF140)

namespace MoleMole
{
	inline static constexpr unsigned int UIGroceryChildWindowController_TypeDefinitionIndex = 88162;
	...
	public:
		...
		::Class_2_A3D4B0969489E4FC_Class_2_D505CD89E0E69761* _tabBtnView; // 0x358
