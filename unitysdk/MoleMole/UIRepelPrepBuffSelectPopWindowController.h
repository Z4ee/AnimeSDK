...
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER_BUILDVIEWMODELDATABINDING_OFFSET UNITYSDK_OFFSET(0x17E34D10)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x17E348E0)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17E348F0)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17E34960)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17E34B60)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17E34FD0)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER__BUILDVIEWMODELDATABINDING_B__10_0_OFFSET UNITYSDK_OFFSET(0x17E35070)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER__BUILDVIEWMODELDATABINDING_B__10_1_OFFSET UNITYSDK_OFFSET(0x17E351C0)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17E35060)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17E35350)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17E353F0)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17E35400)

namespace MoleMole
{
	inline static constexpr unsigned int UIRepelPrepBuffSelectPopWindowController_TypeDefinitionIndex = 51335;
	...
	public:
		...
		::Class_2_15B27E259D99036B* _model; // 0x330
