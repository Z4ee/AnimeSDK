...
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x163839B0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER___C__DISPLAYCLASS13_0__PLAYGRIDCOLLECTIONDATA_G____EFFECTFINISHCALLBACK_0_OFFSET UNITYSDK_OFFSET(0x163839C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowItemCollectWidgetController___c__DisplayClass13_0_TypeDefinitionIndex = 70391;
