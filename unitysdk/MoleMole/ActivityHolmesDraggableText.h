...
#define MOLEMOLE_ACTIVITYHOLMESDRAGGABLETEXT_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x16233A20)
#define MOLEMOLE_ACTIVITYHOLMESDRAGGABLETEXT_ONDRAG_OFFSET UNITYSDK_OFFSET(0x16234280)
#define MOLEMOLE_ACTIVITYHOLMESDRAGGABLETEXT_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x162345B0)
#define MOLEMOLE_ACTIVITYHOLMESDRAGGABLETEXT_SETUP_OFFSET UNITYSDK_OFFSET(0x162337C0)
#define MOLEMOLE_ACTIVITYHOLMESDRAGGABLETEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16234890)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityHolmesDraggableText_TypeDefinitionIndex = 47772;
	...
	public:
		...
		::System::Int32 Field_5_0; // 0x28
		::UnityEngine::RectTransform* Field_5_7; // 0x30
		::UnityEngine::RectTransform* Field_5_6; // 0x38
		::System::Action* Field_5_5; // 0x40
		::UnityEngine::CanvasGroup* Field_5_4; // 0x48
		::UnityEngine::GameObject* Field_5_11; // 0x50
