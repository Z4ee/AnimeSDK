...
#define MOLEMOLE_ANISOTROPICSAMPLINGPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x159BA9B0)
#define MOLEMOLE_ANISOTROPICSAMPLINGPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x159BAAF0)
#define MOLEMOLE_ANISOTROPICSAMPLINGPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x159BA8D0)
#define MOLEMOLE_ANISOTROPICSAMPLINGPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x159BAA70)
#define MOLEMOLE_ANISOTROPICSAMPLINGPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x159BA8C0)
#define MOLEMOLE_ANISOTROPICSAMPLINGPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x159BAC10)
#define MOLEMOLE_ANISOTROPICSAMPLINGPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x159BACA0)
#define MOLEMOLE_ANISOTROPICSAMPLINGPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x159BAD30)
#define MOLEMOLE_ANISOTROPICSAMPLINGPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x159BADC0)

namespace MoleMole
{
	inline static constexpr unsigned int AnisotropicSamplingProfile_TypeDefinitionIndex = 80170;
