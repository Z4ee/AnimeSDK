...
#define MOLEMOLE_GAMEPLAYSIDEBARPCKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x161F3540)
#define MOLEMOLE_GAMEPLAYSIDEBARPCKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x161F3550)
#define MOLEMOLE_GAMEPLAYSIDEBARPCKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x161F3560)

namespace MoleMole
{
	inline static constexpr unsigned int GameplaySideBarPCKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 62123;
