...
#define MOLEMOLE_UIRIGIDBODY_ADDFORCE_OFFSET UNITYSDK_OFFSET(0x16687950)
#define MOLEMOLE_UIRIGIDBODY_AWAKE_OFFSET UNITYSDK_OFFSET(0x1668B4F0)
#define MOLEMOLE_UIRIGIDBODY_BEGINDRAGLOGIC_OFFSET UNITYSDK_OFFSET(0x16688830)
#define MOLEMOLE_UIRIGIDBODY_DRAGLOGIC_OFFSET UNITYSDK_OFFSET(0x1668A780)
#define MOLEMOLE_UIRIGIDBODY_ENDDRAGLOGIC_OFFSET UNITYSDK_OFFSET(0x16687FB0)
#define MOLEMOLE_UIRIGIDBODY_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1668BFE0)
#define MOLEMOLE_UIRIGIDBODY_GETMASS_OFFSET UNITYSDK_OFFSET(0x166879D0)
#define MOLEMOLE_UIRIGIDBODY_GET_DRAGING_OFFSET UNITYSDK_OFFSET(0x166874F0)
#define MOLEMOLE_UIRIGIDBODY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1668B460)
#define MOLEMOLE_UIRIGIDBODY_METHOD_6_2DE8115E31073885_OFFSET UNITYSDK_OFFSET(0x16689090)
#define MOLEMOLE_UIRIGIDBODY_METHOD_6_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0x1668B380)
#define MOLEMOLE_UIRIGIDBODY_METHOD_6_6DD25DF274ED24AE_OFFSET UNITYSDK_OFFSET(0x16687780)
#define MOLEMOLE_UIRIGIDBODY_METHOD_6_7372A42B6CDBB2D4_OFFSET UNITYSDK_OFFSET(0x1668CA10)
#define MOLEMOLE_UIRIGIDBODY_METHOD_6_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x1668D4F0)
#define MOLEMOLE_UIRIGIDBODY_METHOD_6_8F266B1E21740308_OFFSET UNITYSDK_OFFSET(0x1668D500)
#define MOLEMOLE_UIRIGIDBODY_METHOD_6_BA8E7A7AEECAD72C_OFFSET UNITYSDK_OFFSET(0x1668B160)
#define MOLEMOLE_UIRIGIDBODY_METHOD_6_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x1668B2E0)
#define MOLEMOLE_UIRIGIDBODY_ONAPPLICATIONFOCUS_OFFSET UNITYSDK_OFFSET(0x1668B400)
#define MOLEMOLE_UIRIGIDBODY_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x166885D0)
#define MOLEMOLE_UIRIGIDBODY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1668CC90)
#define MOLEMOLE_UIRIGIDBODY_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1668A520)
#define MOLEMOLE_UIRIGIDBODY_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x1668B4A0)
#define MOLEMOLE_UIRIGIDBODY_ONPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x16687500)
#define MOLEMOLE_UIRIGIDBODY_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x16687A30)
#define MOLEMOLE_UIRIGIDBODY_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x16687F50)
#define MOLEMOLE_UIRIGIDBODY_RESETANGLE_OFFSET UNITYSDK_OFFSET(0x1668CEC0)
#define MOLEMOLE_UIRIGIDBODY_SETDRAGANCHOR_OFFSET UNITYSDK_OFFSET(0x16687CB0)
#define MOLEMOLE_UIRIGIDBODY_TRYTRIGGERCLICK_OFFSET UNITYSDK_OFFSET(0x16687560)
#define MOLEMOLE_UIRIGIDBODY__CTOR_OFFSET UNITYSDK_OFFSET(0x1668D230)
#define MOLEMOLE_UIRIGIDBODY___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1668D3D0)
#define MOLEMOLE_UIRIGIDBODY___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1668D460)

namespace MoleMole
{
	inline static constexpr unsigned int UIRigidbody_TypeDefinitionIndex = 49609;
	...
	public:
		...
		::System::Int32 Field_6_14; // 0x44
		::System::Collections::Generic::List_1<::UnityEngine::BoxCollider2D*>* Field_6_15; // 0x48
		::System::Single Field_6_16; // 0x50
		::System::Single Field_6_17; // 0x54
		...
		::UnityEngine::TargetJoint2D* Field_6_25; // 0x88
		::UnityEngine::FixedJoint2D* Field_6_26; // 0x90
		::UnityEngine::Vector2 Field_6_27; // 0x98
		::UnityEngine::Vector3 Field_6_28; // 0xA0
		::UnityEngine::TargetJoint2D* Field_6_29; // 0xB0
		...
		::System::UInt32 Field_6_34; // 0xD8
		::System::Boolean Interactable; // 0xDC
		::DG::Tweening::Tweener* Field_6_36; // 0xE0
		::UnityEngine::Rigidbody2D* Field_6_37; // 0xE8
		::System::Collections::Generic::List_1<::MoleMole::UIRigidbody*>* Field_6_38; // 0xF0
		::Il2CppArray<::UnityEngine::Vector3>* Field_6_39; // 0xF8
