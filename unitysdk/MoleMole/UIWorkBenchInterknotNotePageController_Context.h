...
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_CONTEXT_GET_USEGENERALBG_OFFSET UNITYSDK_OFFSET(0x12EA5500)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_CONTEXT_SET_USEGENERALBG_OFFSET UNITYSDK_OFFSET(0x12EA5510)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x12EA5520)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkBenchInterknotNotePageController_Context_TypeDefinitionIndex = 53658;
