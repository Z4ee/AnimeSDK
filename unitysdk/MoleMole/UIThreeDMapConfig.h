...
#define MOLEMOLE_UITHREEDMAPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1629FAE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIThreeDMapConfig_TypeDefinitionIndex = 75867;
