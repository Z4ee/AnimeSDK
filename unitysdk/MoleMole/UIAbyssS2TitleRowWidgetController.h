...
#define MOLEMOLE_UIABYSSS2TITLEROWWIDGETCONTROLLER_ONCLICK_OFFSET UNITYSDK_OFFSET(0x11D97A40)
#define MOLEMOLE_UIABYSSS2TITLEROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x11D97790)
#define MOLEMOLE_UIABYSSS2TITLEROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x11D978A0)
#define MOLEMOLE_UIABYSSS2TITLEROWWIDGETCONTROLLER_ONSELECT_OFFSET UNITYSDK_OFFSET(0x11D97A80)
#define MOLEMOLE_UIABYSSS2TITLEROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x11D97820)
#define MOLEMOLE_UIABYSSS2TITLEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x11D976C0)
#define MOLEMOLE_UIABYSSS2TITLEROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x11D97720)
#define MOLEMOLE_UIABYSSS2TITLEROWWIDGETCONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0x11D97940)
#define MOLEMOLE_UIABYSSS2TITLEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11D97AD0)
#define MOLEMOLE_UIABYSSS2TITLEROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x11D97AE0)
#define MOLEMOLE_UIABYSSS2TITLEROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x11D97B70)
#define MOLEMOLE_UIABYSSS2TITLEROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x11D97C10)
#define MOLEMOLE_UIABYSSS2TITLEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x11D97CA0)
#define MOLEMOLE_UIABYSSS2TITLEROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x11D97D30)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2TitleRowWidgetController_TypeDefinitionIndex = 43736;

	class UIAbyssS2TitleRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_0096754AC2F6E253_6* _view; // 0x2F0
