...
#define MOLEMOLE_MONOLOGICMOVEMENT_GET_OWNER_OFFSET UNITYSDK_OFFSET(0x15B3EE50)
#define MOLEMOLE_MONOLOGICMOVEMENT_METHOD_5_D9EF75A2D048B8A1_OFFSET UNITYSDK_OFFSET(0x15B3ED50)
#define MOLEMOLE_MONOLOGICMOVEMENT_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0x15B3EE60)
#define MOLEMOLE_MONOLOGICMOVEMENT_SET_OWNER_OFFSET UNITYSDK_OFFSET(0x15B3ED00)
#define MOLEMOLE_MONOLOGICMOVEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x15B3EF40)

namespace MoleMole
{
	inline static constexpr unsigned int MonoLogicMovement_TypeDefinitionIndex = 69837;
