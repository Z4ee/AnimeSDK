...
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E9A16B0)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1E9A16F0)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER___C___CCTOR_B__40_0_OFFSET UNITYSDK_OFFSET(0x1E9A1700)

namespace MoleMole
{
	inline static constexpr unsigned int UICpRoleSelectChildWindowController___c_TypeDefinitionIndex = 94768;
	...
	public:
		...
		{
			return (::MoleMole::UICpRoleSelectChildWindowController___c**)Il2CppClass::FromTypeDefinitionIndex(UICpRoleSelectChildWindowController___c_TypeDefinitionIndex)->GetStaticField(0x52740);
		}
