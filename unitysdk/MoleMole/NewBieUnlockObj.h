...
#define MOLEMOLE_NEWBIEUNLOCKOBJ_ADDUNLOCKGROUP_OFFSET UNITYSDK_OFFSET(0x123641A0)
#define MOLEMOLE_NEWBIEUNLOCKOBJ_ADDUNLOCKLIST_OFFSET UNITYSDK_OFFSET(0x12364200)
#define MOLEMOLE_NEWBIEUNLOCKOBJ_GET_FROMGM_OFFSET UNITYSDK_OFFSET(0x123640B0)
#define MOLEMOLE_NEWBIEUNLOCKOBJ_GET_ISTRIGGERINLOADING_OFFSET UNITYSDK_OFFSET(0x12364090)
#define MOLEMOLE_NEWBIEUNLOCKOBJ_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x123640A0)
#define MOLEMOLE_NEWBIEUNLOCKOBJ_GET_TRIGGER_OFFSET UNITYSDK_OFFSET(0x123640D0)
#define MOLEMOLE_NEWBIEUNLOCKOBJ_HASUNLOCKNEWBIEID_1_OFFSET UNITYSDK_OFFSET(0x123643A0)
#define MOLEMOLE_NEWBIEUNLOCKOBJ_HASUNLOCKNEWBIEID_OFFSET UNITYSDK_OFFSET(0x12364340)
#define MOLEMOLE_NEWBIEUNLOCKOBJ_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x12364770)
#define MOLEMOLE_NEWBIEUNLOCKOBJ_SETFROMGM_OFFSET UNITYSDK_OFFSET(0x12364160)
#define MOLEMOLE_NEWBIEUNLOCKOBJ_SET_FROMGM_OFFSET UNITYSDK_OFFSET(0x123640C0)
#define MOLEMOLE_NEWBIEUNLOCKOBJ_SET_TRIGGER_OFFSET UNITYSDK_OFFSET(0x123640E0)
#define MOLEMOLE_NEWBIEUNLOCKOBJ__CTOR_OFFSET UNITYSDK_OFFSET(0x123640F0)

namespace MoleMole
{
	inline static constexpr unsigned int NewBieUnlockObj_TypeDefinitionIndex = 57395;
