...
#define MOLEMOLE_MONOGAMEPADBASELIST_ADDITEMSELECTOPERATION_OFFSET UNITYSDK_OFFSET(0x12630570)
#define MOLEMOLE_MONOGAMEPADBASELIST_CHANGERESETINDEXONFOCUS_OFFSET UNITYSDK_OFFSET(0x1262E630)
#define MOLEMOLE_MONOGAMEPADBASELIST_CLEARCACHESELECTEDINDEX_OFFSET UNITYSDK_OFFSET(0x1262E890)
#define MOLEMOLE_MONOGAMEPADBASELIST_GETINDEX_OFFSET UNITYSDK_OFFSET(0x12630390)
#define MOLEMOLE_MONOGAMEPADBASELIST_GET_CACHEDSELECTEDINDEX_OFFSET UNITYSDK_OFFSET(0x1262E620)
#define MOLEMOLE_MONOGAMEPADBASELIST_GET_ISHANDLEBYNESTEDLISTDELEGATE_OFFSET UNITYSDK_OFFSET(0x1262E6B0)
#define MOLEMOLE_MONOGAMEPADBASELIST_GET_SCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x1262E6A0)
#define MOLEMOLE_MONOGAMEPADBASELIST_ISALLOWLOOPBYINPUT_OFFSET UNITYSDK_OFFSET(0x1262F710)
#define MOLEMOLE_MONOGAMEPADBASELIST_ISDRIVENBYSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x1262F640)
#define MOLEMOLE_MONOGAMEPADBASELIST_ISLISTTAB_OFFSET UNITYSDK_OFFSET(0x1262F520)
#define MOLEMOLE_MONOGAMEPADBASELIST_ISUSESELECTEDINDEXFROMSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x1262F570)
#define MOLEMOLE_MONOGAMEPADBASELIST_LISTISEMPTY_OFFSET UNITYSDK_OFFSET(0x1262E6D0)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_126EC2032660D76C_OFFSET UNITYSDK_OFFSET(0x12631620)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_1DC460290C5CAF79_OFFSET UNITYSDK_OFFSET(0x126317F0)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_1FB330E3F81EE55F_OFFSET UNITYSDK_OFFSET(0x1262EF10)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_20487879979618C8_1_OFFSET UNITYSDK_OFFSET(0x12630D90)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_20487879979618C8_OFFSET UNITYSDK_OFFSET(0x126301A0)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_23A91AD216EE3DAE_OFFSET UNITYSDK_OFFSET(0x1262FAC0)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_38E7EA0094712D4D_OFFSET UNITYSDK_OFFSET(0x12630FB0)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x1262ED00)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_491D44226596AEA3_OFFSET UNITYSDK_OFFSET(0x1262ED50)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_49D3E821006373F3_OFFSET UNITYSDK_OFFSET(0x126319E0)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_631089883ED84009_OFFSET UNITYSDK_OFFSET(0x12631140)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_6A7DFCE9E3822F30_OFFSET UNITYSDK_OFFSET(0x1262F4C0)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_6B707ED7E427E085_OFFSET UNITYSDK_OFFSET(0x1262EE10)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_6C84A58A15601E10_OFFSET UNITYSDK_OFFSET(0x12631850)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_84024AA3B92C6350_OFFSET UNITYSDK_OFFSET(0x1262F1E0)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_8715A2F9EE93B07F_OFFSET UNITYSDK_OFFSET(0x12631C20)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_88D1101B5D710834_OFFSET UNITYSDK_OFFSET(0x12631A80)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_8B637789328B6E08_OFFSET UNITYSDK_OFFSET(0x126313B0)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_AF14DA40989B84AA_OFFSET UNITYSDK_OFFSET(0x1262EE90)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x1262E760)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_BBB2CB9B2C1D9711_OFFSET UNITYSDK_OFFSET(0x1262E960)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_C50A2293958CA940_OFFSET UNITYSDK_OFFSET(0x1262EC50)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_CBE6C06BFBD16B25_OFFSET UNITYSDK_OFFSET(0x12630060)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_D8B63DBB24B374A4_OFFSET UNITYSDK_OFFSET(0x1262FFB0)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_E0F43AEFBFDEBC67_1_OFFSET UNITYSDK_OFFSET(0x126303E0)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_E0F43AEFBFDEBC67_OFFSET UNITYSDK_OFFSET(0x12630C00)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_E8B56723988BA453_1_OFFSET UNITYSDK_OFFSET(0x12630F30)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_E8B56723988BA453_OFFSET UNITYSDK_OFFSET(0x1262E8E0)
#define MOLEMOLE_MONOGAMEPADBASELIST_MUTECACHESELECTEDINDEX_OFFSET UNITYSDK_OFFSET(0x126306B0)
#define MOLEMOLE_MONOGAMEPADBASELIST_RESETKEEPINDEX_OFFSET UNITYSDK_OFFSET(0x12630600)
#define MOLEMOLE_MONOGAMEPADBASELIST_SETALLOWLOOP_OFFSET UNITYSDK_OFFSET(0x1262E710)
#define MOLEMOLE_MONOGAMEPADBASELIST_SETCACHESELECTEDINDEXENABLED_OFFSET UNITYSDK_OFFSET(0x1262E830)
#define MOLEMOLE_MONOGAMEPADBASELIST_SETMUTESELECTAUTOCLICKITEM_OFFSET UNITYSDK_OFFSET(0x12630340)
#define MOLEMOLE_MONOGAMEPADBASELIST_SETSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x12630660)
#define MOLEMOLE_MONOGAMEPADBASELIST_SETSELECTEDINDEXFORUSER_OFFSET UNITYSDK_OFFSET(0x12630120)
#define MOLEMOLE_MONOGAMEPADBASELIST_SET_ISHANDLEBYNESTEDLISTDELEGATE_OFFSET UNITYSDK_OFFSET(0x1262E6C0)
#define MOLEMOLE_MONOGAMEPADBASELIST_TRYCACHESELECTEDINDEX_OFFSET UNITYSDK_OFFSET(0x12630780)
#define MOLEMOLE_MONOGAMEPADBASELIST_UPDATENAVEVENT_OFFSET UNITYSDK_OFFSET(0x12630800)
#define MOLEMOLE_MONOGAMEPADBASELIST__CCTOR_OFFSET UNITYSDK_OFFSET(0x12630A30)
#define MOLEMOLE_MONOGAMEPADBASELIST__CTOR_OFFSET UNITYSDK_OFFSET(0x126308B0)
#define MOLEMOLE_MONOGAMEPADBASELIST___BASE_GETGAMEPADSELECTABLE_OFFSET UNITYSDK_OFFSET(0x12630A40)
#define MOLEMOLE_MONOGAMEPADBASELIST___BASE_LOGICEVENTTONAVDIR_OFFSET UNITYSDK_OFFSET(0x12630AD0)
#define MOLEMOLE_MONOGAMEPADBASELIST___BASE_ONMODULECLEAR_OFFSET UNITYSDK_OFFSET(0x12630B60)
#define MOLEMOLE_MONOGAMEPADBASELIST___BASE_SETBTNFOCUSSTATE_OFFSET UNITYSDK_OFFSET(0x12630BF0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGamepadBaseList_TypeDefinitionIndex = 62500;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(MonoGamepadBaseList_TypeDefinitionIndex)->GetStaticField(0xB010);
		}
		static ::System::Boolean* StaticGet_GlobalUseSelectedIndexFromScrollView()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(MonoGamepadBaseList_TypeDefinitionIndex)->GetStaticField(0xB011);
		}
