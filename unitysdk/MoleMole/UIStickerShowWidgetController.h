...
#define MOLEMOLE_UISTICKERSHOWWIDGETCONTROLLER_GET_IMAGESIZE_OFFSET UNITYSDK_OFFSET(0x16AB2050)
#define MOLEMOLE_UISTICKERSHOWWIDGETCONTROLLER_GET_STICKERID_OFFSET UNITYSDK_OFFSET(0x16AB2180)
#define MOLEMOLE_UISTICKERSHOWWIDGETCONTROLLER_GET_STICKERINDEX_OFFSET UNITYSDK_OFFSET(0x16AB22D0)
#define MOLEMOLE_UISTICKERSHOWWIDGETCONTROLLER_GET_STICKERRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x16AB2110)
#define MOLEMOLE_UISTICKERSHOWWIDGETCONTROLLER_GET_VISIBLE_OFFSET UNITYSDK_OFFSET(0x16AB2420)
#define MOLEMOLE_UISTICKERSHOWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16AB1FE0)
#define MOLEMOLE_UISTICKERSHOWWIDGETCONTROLLER_ONAPPLICATIONFOCUS_OFFSET UNITYSDK_OFFSET(0x16AB29C0)
#define MOLEMOLE_UISTICKERSHOWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16AB24E0)
#define MOLEMOLE_UISTICKERSHOWWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x16AB27E0)
#define MOLEMOLE_UISTICKERSHOWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16AB2580)
#define MOLEMOLE_UISTICKERSHOWWIDGETCONTROLLER_STARTDRAG_OFFSET UNITYSDK_OFFSET(0x16AB2A80)
#define MOLEMOLE_UISTICKERSHOWWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x16AB28C0)
#define MOLEMOLE_UISTICKERSHOWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16AB2B40)
#define MOLEMOLE_UISTICKERSHOWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16AB2BA0)
#define MOLEMOLE_UISTICKERSHOWWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x16AB2C40)
#define MOLEMOLE_UISTICKERSHOWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16AB2CD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIStickerShowWidgetController_TypeDefinitionIndex = 72335;
