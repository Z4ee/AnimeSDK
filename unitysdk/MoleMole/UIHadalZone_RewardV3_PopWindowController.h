...
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x169D7F10)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x169D7F20)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER_ONCLICKLEFTTAB_OFFSET UNITYSDK_OFFSET(0x169D96C0)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x169D8FF0)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x169D97B0)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x169D9080)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x169D7F30)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x169D8050)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x169D9A90)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER__CREATEROWLAYERREWARD_OFFSET UNITYSDK_OFFSET(0x169D95C0)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x169D9A00)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER__ONEKEYGETREWARD_OFFSET UNITYSDK_OFFSET(0x169D90F0)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER__ONUIOPEN_B__12_0_OFFSET UNITYSDK_OFFSET(0x169D9C10)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER__ONUIOPEN_B__12_1_OFFSET UNITYSDK_OFFSET(0x169D9C20)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER__UPDATEONEKEYSTATUS_OFFSET UNITYSDK_OFFSET(0x169D8C60)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER__UPDATEREWARDS_OFFSET UNITYSDK_OFFSET(0x169D82B0)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x169D9DD0)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x169D9E60)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x169D9EF0)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x169D9F00)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x169D9F10)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER___CREATEROWLAYERREWARD_B__19_0_OFFSET UNITYSDK_OFFSET(0x169D9DC0)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER___ONEKEYGETREWARD_B__16_0_OFFSET UNITYSDK_OFFSET(0x169D9C30)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER___UPDATEREWARDS_G__GETZONENAMETEXTKEY_18_1_OFFSET UNITYSDK_OFFSET(0x169D94E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_RewardV3_PopWindowController_TypeDefinitionIndex = 40652;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(UIHadalZone_RewardV3_PopWindowController_TypeDefinitionIndex)->GetStaticField(0x3CA40);
		}
		::MoleMole::UIHadalZone_RewardV3_PopWindowController_RewardContext* _ctx; // 0x318
		::Class_2_A6415ACD2BAEC3D4* _view; // 0x320
		::Class_2_468A4FBF2E9F527C* _hadalZoneModel; // 0x328
		::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::MoleMole::UIHadalZone_RewardV3_PopWindowController_HadalRewardData>*>* _scrollDataList; // 0x330
		::System::Int32 _currSelectTabIdx; // 0x338
		...
		::System::Void __OneKeyGetReward_b__16_0(::Class_3_025FF4981524A424_164* rsp)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_025FF4981524A424_164*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER___ONEKEYGETREWARD_B__16_0_OFFSET))(this, rsp);
		}

		static ::System::String* __UpdateRewards_g__GetZoneNameTextKey_18_1(::Class_1_5DA2E7556103D5A3_399* zoneInfo, ::System::Int32 index)
		{
			return ((::System::String*(*)(::Class_1_5DA2E7556103D5A3_399*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER___UPDATEREWARDS_G__GETZONENAMETEXTKEY_18_1_OFFSET))(zoneInfo, index);
		}
