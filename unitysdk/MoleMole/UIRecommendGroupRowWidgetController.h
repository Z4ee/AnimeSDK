...
#define MOLEMOLE_UIRECOMMENDGROUPROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15C943B0)
#define MOLEMOLE_UIRECOMMENDGROUPROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15C94440)
#define MOLEMOLE_UIRECOMMENDGROUPROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15C94280)
#define MOLEMOLE_UIRECOMMENDGROUPROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15C942E0)
#define MOLEMOLE_UIRECOMMENDGROUPROWWIDGETCONTROLLER_REFRESHUI_OFFSET UNITYSDK_OFFSET(0x15C94990)
#define MOLEMOLE_UIRECOMMENDGROUPROWWIDGETCONTROLLER_REFRESHVIEWFORPROPERTY_OFFSET UNITYSDK_OFFSET(0x15C94C40)
#define MOLEMOLE_UIRECOMMENDGROUPROWWIDGETCONTROLLER_REFRESHVIEWFORSUIT_OFFSET UNITYSDK_OFFSET(0x15C944C0)
#define MOLEMOLE_UIRECOMMENDGROUPROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15C951E0)
#define MOLEMOLE_UIRECOMMENDGROUPROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15C951F0)
#define MOLEMOLE_UIRECOMMENDGROUPROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15C95280)
#define MOLEMOLE_UIRECOMMENDGROUPROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15C95310)
#define MOLEMOLE_UIRECOMMENDGROUPROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15C953A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRecommendGroupRowWidgetController_TypeDefinitionIndex = 51381;

	class UIRecommendGroupRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_16396D88BA38E0AB_2* _view; // 0x2E8
		::MoleMole::UIRoleEquipRecommendPopContext_1<::Class_2_12BDE7300F0E061C*>* _context; // 0x2F0
		::MoleMole::UIRecommendTypeSuitRowWidgetController* _curOpSuitRowWidgetController; // 0x2F8
		::MoleMole::UIRecommendTypePropertyRowWidgetController* _curOpPropertyRowWidgetController; // 0x300
		::MoleMole::UIRecommendGroupRowWidgetController_RecommendGroupRowType _recommendType; // 0x308
