...
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ALLOCRTUNIT_OFFSET UNITYSDK_OFFSET(0x15285130)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_APPLYAVATARSHOWSETTINGFORGO_OFFSET UNITYSDK_OFFSET(0x152896B0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_CREATECACHEENTITY_OFFSET UNITYSDK_OFFSET(0x15286910)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_DESTROYALLCACHEENTITIES_OFFSET UNITYSDK_OFFSET(0x15285BC0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_DOPROCESSUIPREFAB_OFFSET UNITYSDK_OFFSET(0x15288BB0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ENABLEOVERRIDEMAINLIGHT_OFFSET UNITYSDK_OFFSET(0x15289510)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_GETENTITYTYPEFORITEM_OFFSET UNITYSDK_OFFSET(0x152867A0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_GETSCENELIGHT_OFFSET UNITYSDK_OFFSET(0x1528ACE0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_GETSCENEVOLUME_OFFSET UNITYSDK_OFFSET(0x1528ABC0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_GETUIAVATARGRAPHICS_OFFSET UNITYSDK_OFFSET(0x152898A0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_GETUIPREFABPATHFORITEM_OFFSET UNITYSDK_OFFSET(0x15286810)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_GETVISUALENVIRONMENTECOMP_OFFSET UNITYSDK_OFFSET(0x1528AA40)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_INITCAMERADATA_OFFSET UNITYSDK_OFFSET(0x15284C90)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_LOADRTMODELFINISHED_OFFSET UNITYSDK_OFFSET(0x1528AE60)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15284B80)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x15288180)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ONPREPAREHIDE_OFFSET UNITYSDK_OFFSET(0x15288B30)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15284E40)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x152882A0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x152883F0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15284C10)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSAVATARMODEL_1_OFFSET UNITYSDK_OFFSET(0x1528B0F0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSAVATARMODEL_OFFSET UNITYSDK_OFFSET(0x1528B080)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSMAINPAGEGO_OFFSET UNITYSDK_OFFSET(0x152861A0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSMAINPAGEITEM_OFFSET UNITYSDK_OFFSET(0x15286700)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSUIAVATAR_1_OFFSET UNITYSDK_OFFSET(0x15288FB0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSUIAVATAR_OFFSET UNITYSDK_OFFSET(0x152865D0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSUIBUDDY_OFFSET UNITYSDK_OFFSET(0x15289050)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSUIPERFORM_OFFSET UNITYSDK_OFFSET(0x15286CC0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSUISKIN_OFFSET UNITYSDK_OFFSET(0x15289110)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_REALLOCRTUNIT_OFFSET UNITYSDK_OFFSET(0x152850E0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_REBINDSHOWTIMELINE_OFFSET UNITYSDK_OFFSET(0x15289C90)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_REFRESHCAMERADATA_OFFSET UNITYSDK_OFFSET(0x15287CF0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x15285300)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_RELEASERTUNIT_OFFSET UNITYSDK_OFFSET(0x15288A70)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_RELEASEUIMODELS_OFFSET UNITYSDK_OFFSET(0x15288240)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_RESETCAMERADATA_OFFSET UNITYSDK_OFFSET(0x15288110)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_SETHAIRSHADOWOFFSETS_OFFSET UNITYSDK_OFFSET(0x15289370)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_SETVIEWLIGHTROTOFFSET_OFFSET UNITYSDK_OFFSET(0x152891B0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__GETRANDOMCOUNT_59_0_OFFSET UNITYSDK_OFFSET(0x1528B3C0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__GETRANDOMINT_59_1_OFFSET UNITYSDK_OFFSET(0x1528B710)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__HANDLESHADERUIOUTLINE_59_8_OFFSET UNITYSDK_OFFSET(0x1528B780)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__PLAYAVATARANIMATIONBYSETTING_59_6_OFFSET UNITYSDK_OFFSET(0x1528C090)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__SETANIMATORRANDOMINT_59_7_OFFSET UNITYSDK_OFFSET(0x1528C5D0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__SETAVATARANIMATION_59_5_OFFSET UNITYSDK_OFFSET(0x1528BA80)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__SETAVATARSHADERPROPERTYBYRENDERS_59_4_OFFSET UNITYSDK_OFFSET(0x1528BE40)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__SETAVATARSHADERPROPERTY_59_3_OFFSET UNITYSDK_OFFSET(0x1528B7B0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__SETAVATAR_59_2_OFFSET UNITYSDK_OFFSET(0x1528B740)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1528BE00)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1528BD00)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1528C840)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x1528C8D0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER___BASE_ONPREPAREHIDE_OFFSET UNITYSDK_OFFSET(0x1528C960)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1528C970)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x1528C980)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1528CA40)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1528CA50)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainPageBG3DModelController_TypeDefinitionIndex = 86896;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMainPageBG3DModelController_TypeDefinitionIndex)->GetStaticField(0xE590);
		}
		...
		::MoleMole::AvatarShowSetting* _avatarShowSetting; // 0x368
		::MoleMole::UIMainPageBGContext* uIMainPageBGContext; // 0x370
		::System::String* mainPagePrefabPath; // 0x378
		::UnityEngine::GameObject* mainPagePrefabModelGo; // 0x380
		::UnityEngine::Rendering::Universal::UniversalAdditionalCameraData* cameraData; // 0x388
		::System::Single lastRenderScale; // 0x390
		::System::Boolean applyLutAfterEverything; // 0x394
		::System::Boolean renderVolumetricFog; // 0x395
		::System::Boolean renderWater; // 0x396
		::UnityEngine::Animator* cameraAnimator; // 0x398
		::UnityEngine::Animation* cameraAnimation; // 0x3A0
		::System::String* cameraAnimationName; // 0x3A8
		::System::String* animationClipPath; // 0x3B0
		::System::String* animatorControllerPath; // 0x3B8
		::System::String* avatarShowTlPath; // 0x3C0
		::UnityEngine::GameObject* avatarShowTl; // 0x3C8
		::Class_2_58619A0893665D06_2* _view; // 0x3D0
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::Battle::Entity*>* _cacheEntityDic; // 0x3D8
