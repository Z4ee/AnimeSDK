...
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ALLOCRTUNIT_OFFSET UNITYSDK_OFFSET(0x16521560)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_APPLYAVATARSHOWSETTINGFORGO_OFFSET UNITYSDK_OFFSET(0x16525B10)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_CREATECACHEENTITY_OFFSET UNITYSDK_OFFSET(0x16522D70)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_DESTROYALLCACHEENTITIES_OFFSET UNITYSDK_OFFSET(0x16522020)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_DOPROCESSUIPREFAB_OFFSET UNITYSDK_OFFSET(0x16525000)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ENABLEOVERRIDEMAINLIGHT_OFFSET UNITYSDK_OFFSET(0x16525970)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_GETENTITYTYPEFORITEM_OFFSET UNITYSDK_OFFSET(0x16522C00)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_GETSCENELIGHT_OFFSET UNITYSDK_OFFSET(0x16527170)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_GETSCENEVOLUME_OFFSET UNITYSDK_OFFSET(0x16527050)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_GETUIAVATARGRAPHICS_OFFSET UNITYSDK_OFFSET(0x16525D30)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_GETUIPREFABPATHFORITEM_OFFSET UNITYSDK_OFFSET(0x16522C70)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_GETVISUALENVIRONMENTECOMP_OFFSET UNITYSDK_OFFSET(0x16526ED0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_INITCAMERADATA_OFFSET UNITYSDK_OFFSET(0x165210C0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_LOADRTMODELFINISHED_OFFSET UNITYSDK_OFFSET(0x165272F0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16520FB0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x165245D0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ONPREPAREHIDE_OFFSET UNITYSDK_OFFSET(0x16524F80)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16521270)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x165246F0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16524840)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16521040)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSAVATARMODEL_1_OFFSET UNITYSDK_OFFSET(0x16527580)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSAVATARMODEL_OFFSET UNITYSDK_OFFSET(0x16527510)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSMAINPAGEGO_OFFSET UNITYSDK_OFFSET(0x16522610)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSMAINPAGEITEM_OFFSET UNITYSDK_OFFSET(0x16522B60)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSUIAVATAR_1_OFFSET UNITYSDK_OFFSET(0x16525410)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSUIAVATAR_OFFSET UNITYSDK_OFFSET(0x16522A40)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSUIBUDDY_OFFSET UNITYSDK_OFFSET(0x165254B0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSUIPERFORM_OFFSET UNITYSDK_OFFSET(0x16523130)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSUISKIN_OFFSET UNITYSDK_OFFSET(0x16525570)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_REALLOCRTUNIT_OFFSET UNITYSDK_OFFSET(0x16521510)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_REBINDSHOWTIMELINE_OFFSET UNITYSDK_OFFSET(0x16526120)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_REFRESHCAMERADATA_OFFSET UNITYSDK_OFFSET(0x16524140)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x16521730)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_RELEASERTUNIT_OFFSET UNITYSDK_OFFSET(0x16524EC0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_RELEASEUIMODELS_OFFSET UNITYSDK_OFFSET(0x16524690)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_RESETCAMERADATA_OFFSET UNITYSDK_OFFSET(0x16524560)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_SETHAIRSHADOWOFFSETS_OFFSET UNITYSDK_OFFSET(0x165257D0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_SETVIEWLIGHTROTOFFSET_OFFSET UNITYSDK_OFFSET(0x16525610)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__GETRANDOMCOUNT_59_0_OFFSET UNITYSDK_OFFSET(0x16527850)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__GETRANDOMINT_59_1_OFFSET UNITYSDK_OFFSET(0x16527B80)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__HANDLESHADERUIOUTLINE_59_8_OFFSET UNITYSDK_OFFSET(0x16527BF0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__PLAYAVATARANIMATIONBYSETTING_59_6_OFFSET UNITYSDK_OFFSET(0x16528520)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__SETANIMATORRANDOMINT_59_7_OFFSET UNITYSDK_OFFSET(0x16528A60)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__SETAVATARANIMATION_59_5_OFFSET UNITYSDK_OFFSET(0x16527F20)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__SETAVATARSHADERPROPERTYBYRENDERS_59_4_OFFSET UNITYSDK_OFFSET(0x165282E0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__SETAVATARSHADERPROPERTY_59_3_OFFSET UNITYSDK_OFFSET(0x16527C40)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__SETAVATAR_59_2_OFFSET UNITYSDK_OFFSET(0x16527BB0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x165282A0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x165281A0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16528CC0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x16528D50)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER___BASE_ONPREPAREHIDE_OFFSET UNITYSDK_OFFSET(0x16528DE0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16528DF0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x16528E00)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16528EC0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16528ED0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainPageBG3DModelController_TypeDefinitionIndex = 40749;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMainPageBG3DModelController_TypeDefinitionIndex)->GetStaticField(0xE520);
		}
		...
		::Class_2_58619A0893665D06* _view; // 0x3D0
