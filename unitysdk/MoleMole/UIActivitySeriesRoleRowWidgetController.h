...
#define MOLEMOLE_UIACTIVITYSERIESROLEROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1A1F5F60)
#define MOLEMOLE_UIACTIVITYSERIESROLEROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1A1F5FF0)
#define MOLEMOLE_UIACTIVITYSERIESROLEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1A1F5E90)
#define MOLEMOLE_UIACTIVITYSERIESROLEROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1A1F5EF0)
#define MOLEMOLE_UIACTIVITYSERIESROLEROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1A1F6070)
#define MOLEMOLE_UIACTIVITYSERIESROLEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1F6150)
#define MOLEMOLE_UIACTIVITYSERIESROLEROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1A1F61B0)
#define MOLEMOLE_UIACTIVITYSERIESROLEROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1A1F6240)
#define MOLEMOLE_UIACTIVITYSERIESROLEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1A1F62D0)
#define MOLEMOLE_UIACTIVITYSERIESROLEROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1A1F6360)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivitySeriesRoleRowWidgetController_TypeDefinitionIndex = 47073;

	class UIActivitySeriesRoleRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_8469E7523673A92C_2* _view; // 0x2C0
