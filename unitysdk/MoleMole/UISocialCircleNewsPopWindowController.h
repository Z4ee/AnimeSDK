...
#define MOLEMOLE_UISOCIALCIRCLENEWSPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x14803A00)
#define MOLEMOLE_UISOCIALCIRCLENEWSPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x14803A10)
#define MOLEMOLE_UISOCIALCIRCLENEWSPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x14803A80)
#define MOLEMOLE_UISOCIALCIRCLENEWSPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x14803B40)
#define MOLEMOLE_UISOCIALCIRCLENEWSPOPWINDOWCONTROLLER_TRYOVERRIDESHOULDIGNOREITEM_OFFSET UNITYSDK_OFFSET(0x14803CD0)
#define MOLEMOLE_UISOCIALCIRCLENEWSPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14803DB0)
#define MOLEMOLE_UISOCIALCIRCLENEWSPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x14803DC0)
#define MOLEMOLE_UISOCIALCIRCLENEWSPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x14803E60)
#define MOLEMOLE_UISOCIALCIRCLENEWSPOPWINDOWCONTROLLER___BASE_TRYOVERRIDESHOULDIGNOREITEM_OFFSET UNITYSDK_OFFSET(0x14803E70)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleNewsPopWindowController_TypeDefinitionIndex = 59766;
