...
#define MOLEMOLE_UISOCIALCIRCLENEWSPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x138192E0)
#define MOLEMOLE_UISOCIALCIRCLENEWSPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x138192F0)
#define MOLEMOLE_UISOCIALCIRCLENEWSPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x13819360)
#define MOLEMOLE_UISOCIALCIRCLENEWSPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x13819420)
#define MOLEMOLE_UISOCIALCIRCLENEWSPOPWINDOWCONTROLLER_TRYOVERRIDESHOULDIGNOREITEM_OFFSET UNITYSDK_OFFSET(0x138195B0)
#define MOLEMOLE_UISOCIALCIRCLENEWSPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x13819690)
#define MOLEMOLE_UISOCIALCIRCLENEWSPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x138196A0)
#define MOLEMOLE_UISOCIALCIRCLENEWSPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x13819740)
#define MOLEMOLE_UISOCIALCIRCLENEWSPOPWINDOWCONTROLLER___BASE_TRYOVERRIDESHOULDIGNOREITEM_OFFSET UNITYSDK_OFFSET(0x13819750)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleNewsPopWindowController_TypeDefinitionIndex = 58188;
