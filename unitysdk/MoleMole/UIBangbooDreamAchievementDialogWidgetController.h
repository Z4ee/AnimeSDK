...
#define MOLEMOLE_UIBANGBOODREAMACHIEVEMENTDIALOGWIDGETCONTROLLER_GETBADGEMAP_OFFSET UNITYSDK_OFFSET(0x192A5030)
#define MOLEMOLE_UIBANGBOODREAMACHIEVEMENTDIALOGWIDGETCONTROLLER_GETCARDLIST_OFFSET UNITYSDK_OFFSET(0x192A5510)
#define MOLEMOLE_UIBANGBOODREAMACHIEVEMENTDIALOGWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x192A5560)
#define MOLEMOLE_UIBANGBOODREAMACHIEVEMENTDIALOGWIDGETCONTROLLER___BASE_GETBADGEMAP_OFFSET UNITYSDK_OFFSET(0x192A5570)
#define MOLEMOLE_UIBANGBOODREAMACHIEVEMENTDIALOGWIDGETCONTROLLER___BASE_GETCARDLIST_OFFSET UNITYSDK_OFFSET(0x192A5580)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooDreamAchievementDialogWidgetController_TypeDefinitionIndex = 62172;
