...
#define MOLEMOLE_UIBANGBOODREAMACHIEVEMENTDIALOGWIDGETCONTROLLER_GETBADGEMAP_OFFSET UNITYSDK_OFFSET(0x12B6A310)
#define MOLEMOLE_UIBANGBOODREAMACHIEVEMENTDIALOGWIDGETCONTROLLER_GETCARDLIST_OFFSET UNITYSDK_OFFSET(0x12B6A7F0)
#define MOLEMOLE_UIBANGBOODREAMACHIEVEMENTDIALOGWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12B6A840)
#define MOLEMOLE_UIBANGBOODREAMACHIEVEMENTDIALOGWIDGETCONTROLLER___BASE_GETBADGEMAP_OFFSET UNITYSDK_OFFSET(0x12B6A850)
#define MOLEMOLE_UIBANGBOODREAMACHIEVEMENTDIALOGWIDGETCONTROLLER___BASE_GETCARDLIST_OFFSET UNITYSDK_OFFSET(0x12B6A860)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooDreamAchievementDialogWidgetController_TypeDefinitionIndex = 45507;
