...
#define MOLEMOLE_AUDIOMIXERDEVICESETTINGCONTEXT_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0x12AF5140)
#define MOLEMOLE_AUDIOMIXERDEVICESETTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x12AF53E0)
#define MOLEMOLE_AUDIOMIXERDEVICESETTINGCONTEXT___BASE_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0x12AF5400)

namespace MoleMole
{
	inline static constexpr unsigned int AudioMixerDeviceSettingContext_TypeDefinitionIndex = 52768;
