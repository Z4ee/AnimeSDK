...
#define MOLEMOLE_AUDIOMIXERDEVICESETTINGCONTEXT_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0x12CFB5C0)
#define MOLEMOLE_AUDIOMIXERDEVICESETTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x12CFB860)
#define MOLEMOLE_AUDIOMIXERDEVICESETTINGCONTEXT___BASE_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0x12CFB880)

namespace MoleMole
{
	inline static constexpr unsigned int AudioMixerDeviceSettingContext_TypeDefinitionIndex = 51900;
