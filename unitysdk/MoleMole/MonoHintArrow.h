...
#define MOLEMOLE_MONOHINTARROW_AWAKE_OFFSET UNITYSDK_OFFSET(0x183053F0)
#define MOLEMOLE_MONOHINTARROW_GET_MASKED_OFFSET UNITYSDK_OFFSET(0x183053E0)
#define MOLEMOLE_MONOHINTARROW_GET_STATE_OFFSET UNITYSDK_OFFSET(0x18305210)
#define MOLEMOLE_MONOHINTARROW_METHOD_5_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x183056A0)
#define MOLEMOLE_MONOHINTARROW_METHOD_5_1CD1133DC003C11C_OFFSET UNITYSDK_OFFSET(0x18305280)
#define MOLEMOLE_MONOHINTARROW_METHOD_5_9D9CF8F6C2342EE5_OFFSET UNITYSDK_OFFSET(0x18305710)
#define MOLEMOLE_MONOHINTARROW_METHOD_5_E374F6C9CEE8E680_OFFSET UNITYSDK_OFFSET(0x183057B0)
#define MOLEMOLE_MONOHINTARROW_SET_MASKED_OFFSET UNITYSDK_OFFSET(0x18305220)
#define MOLEMOLE_MONOHINTARROW_START_OFFSET UNITYSDK_OFFSET(0x183055C0)
#define MOLEMOLE_MONOHINTARROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18305610)

namespace MoleMole
{
	inline static constexpr unsigned int MonoHintArrow_TypeDefinitionIndex = 60276;
