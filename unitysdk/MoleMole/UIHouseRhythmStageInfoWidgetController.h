...
#define MOLEMOLE_UIHOUSERHYTHMSTAGEINFOWIDGETCONTROLLER_BINDSCOREMODELDATA_OFFSET UNITYSDK_OFFSET(0x14B57E60)
#define MOLEMOLE_UIHOUSERHYTHMSTAGEINFOWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x14B57D50)
#define MOLEMOLE_UIHOUSERHYTHMSTAGEINFOWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x14B57DC0)
#define MOLEMOLE_UIHOUSERHYTHMSTAGEINFOWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x14B58060)
#define MOLEMOLE_UIHOUSERHYTHMSTAGEINFOWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x14B580B0)
#define MOLEMOLE_UIHOUSERHYTHMSTAGEINFOWIDGETCONTROLLER_PLAYFEVEREXPRESSIONANIMATION_OFFSET UNITYSDK_OFFSET(0x14B57FB0)
#define MOLEMOLE_UIHOUSERHYTHMSTAGEINFOWIDGETCONTROLLER_PLAYFULLCOMBOANIMATION_OFFSET UNITYSDK_OFFSET(0x14B57F00)
#define MOLEMOLE_UIHOUSERHYTHMSTAGEINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14B581A0)
#define MOLEMOLE_UIHOUSERHYTHMSTAGEINFOWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x14B58200)
#define MOLEMOLE_UIHOUSERHYTHMSTAGEINFOWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x14B582A0)
#define MOLEMOLE_UIHOUSERHYTHMSTAGEINFOWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x14B58340)

namespace MoleMole
{
	inline static constexpr unsigned int UIHouseRhythmStageInfoWidgetController_TypeDefinitionIndex = 58231;
	...
	public:
		...
		::Class_2_5815023ED2AD11A9_1* get__viewModel()
		{
			return ((::Class_2_5815023ED2AD11A9_1*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHOUSERHYTHMSTAGEINFOWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
