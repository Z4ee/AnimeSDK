...
#define MOLEMOLE_UIHOLLOWCARDOPTIONSDIALOGV2POPWINDOWCONTROLLER__REFRESHTASK_D__19_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x78F200)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSDIALOGV2POPWINDOWCONTROLLER__REFRESHTASK_D__19_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2661E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCardOptionsDialogV2PopWindowController__RefreshTask_d__19_TypeDefinitionIndex = 51596;
