...
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_CANTAKEVITALITYREWARD_OFFSET UNITYSDK_OFFSET(0x16EFDA00)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_CREATEDOUBLEWEEKBINGOROW_OFFSET UNITYSDK_OFFSET(0x16EFC740)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_CREATENORMALROW_OFFSET UNITYSDK_OFFSET(0x16EFC5E0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_CREATESCHEDULEPLANROW_OFFSET UNITYSDK_OFFSET(0x16EFC690)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_GETTEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x16EFC3C0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x16EFB2E0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16EFC2B0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16EFB780)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16EFC340)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16EFB120)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16EFB4A0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_OPENREWARDSPREVIEW_OFFSET UNITYSDK_OFFSET(0x16EFE680)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_PLAYPROGRESSANIM_OFFSET UNITYSDK_OFFSET(0x16EFE340)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_PLAYPROGRESSPOINTCANTAKEEFFECT_OFFSET UNITYSDK_OFFSET(0x16EFDD40)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_PLAYPROGRESSPOINTDONEEFFECT_OFFSET UNITYSDK_OFFSET(0x16EFDED0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_REFRESHPROGRESSVIEW_OFFSET UNITYSDK_OFFSET(0x16EFC7F0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_REFRESHREWARDSTATE_OFFSET UNITYSDK_OFFSET(0x16EFCEF0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x16EFB810)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_SETPROGRESS_OFFSET UNITYSDK_OFFSET(0x16EFD1F0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_SHOWGETITEMLIST_OFFSET UNITYSDK_OFFSET(0x16EFE110)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_TRYPLAYCANTAKEREWARDEFFECT_OFFSET UNITYSDK_OFFSET(0x16EFB520)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_TRYTAKEVITALITYREWARDS_OFFSET UNITYSDK_OFFSET(0x16EFD760)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16EFE7D0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0x16EFE830)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER__ONUIINIT_B__1_1_OFFSET UNITYSDK_OFFSET(0x16EFE860)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER__ONUIINIT_B__1_2_OFFSET UNITYSDK_OFFSET(0x16EFE880)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16EFE8B0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16EFE940)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16EFE9E0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16EFEA70)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16EFEB00)

namespace MoleMole
{
	inline static constexpr unsigned int UIDailyQuestHandBookWidgetController_TypeDefinitionIndex = 85069;

	class UIDailyQuestHandBookWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_D3704D04572A8616* _view; // 0x2C0
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_811*>* _dailyQuests; // 0x2C8
