...
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER___C__DISPLAYCLASS91_0__CTOR_OFFSET UNITYSDK_OFFSET(0x164CB960)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER___C__DISPLAYCLASS91_0__TRYGENCHESSBOARD_B__0_OFFSET UNITYSDK_OFFSET(0x164CB970)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowChessboard3DModelController___c__DisplayClass91_0_TypeDefinitionIndex = 63278;
	...
	public:
		...
		::System::Action_1<::Class_5_DCFF91E03A93C03C*>* buildCallBack; // 0x18
		...
		::System::Void _TryGenChessboard_b__0(::Class_5_DCFF91E03A93C03C* c)
		{
			return ((::System::Void(*)(::PVOID, ::Class_5_DCFF91E03A93C03C*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER___C__DISPLAYCLASS91_0__TRYGENCHESSBOARD_B__0_OFFSET))(this, c);
		}
	};
}
