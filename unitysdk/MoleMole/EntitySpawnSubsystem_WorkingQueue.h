...
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_WORKINGQUEUE_ADD_OFFSET UNITYSDK_OFFSET(0x149D1C40)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_WORKINGQUEUE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x149D1C20)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_WORKINGQUEUE_PEEK_OFFSET UNITYSDK_OFFSET(0x149D1DE0)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_WORKINGQUEUE_POP_OFFSET UNITYSDK_OFFSET(0x149D1E70)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_WORKINGQUEUE_REMOVE_OFFSET UNITYSDK_OFFSET(0x149D1D50)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_WORKINGQUEUE__CTOR_OFFSET UNITYSDK_OFFSET(0x149D1F20)

namespace MoleMole
{
	inline static constexpr unsigned int EntitySpawnSubsystem_WorkingQueue_TypeDefinitionIndex = 82968;
