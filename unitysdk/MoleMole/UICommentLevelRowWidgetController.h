...
#define MOLEMOLE_UICOMMENTLEVELROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15252AD0)
#define MOLEMOLE_UICOMMENTLEVELROWWIDGETCONTROLLER_ONGENERALLEVELCHANGE_OFFSET UNITYSDK_OFFSET(0x152533B0)
#define MOLEMOLE_UICOMMENTLEVELROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15252BE0)
#define MOLEMOLE_UICOMMENTLEVELROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15252B60)
#define MOLEMOLE_UICOMMENTLEVELROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15252800)
#define MOLEMOLE_UICOMMENTLEVELROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x15252CF0)
#define MOLEMOLE_UICOMMENTLEVELROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15253470)
#define MOLEMOLE_UICOMMENTLEVELROWWIDGETCONTROLLER__ONUIINIT_B__4_0_OFFSET UNITYSDK_OFFSET(0x15253480)
#define MOLEMOLE_UICOMMENTLEVELROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15253500)
#define MOLEMOLE_UICOMMENTLEVELROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15253590)
#define MOLEMOLE_UICOMMENTLEVELROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15253630)
#define MOLEMOLE_UICOMMENTLEVELROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x152536C0)

namespace MoleMole
{
	inline static constexpr unsigned int UICommentLevelRowWidgetController_TypeDefinitionIndex = 73787;
