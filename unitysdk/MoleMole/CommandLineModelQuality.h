...
#define MOLEMOLE_COMMANDLINEMODELQUALITY_METHOD_2_5CA9975A94142337_OFFSET UNITYSDK_OFFSET(0xE958EA0)
#define MOLEMOLE_COMMANDLINEMODELQUALITY_METHOD_2_B9EC7AC2EE2F0687_OFFSET UNITYSDK_OFFSET(0xE958FD0)
#define MOLEMOLE_COMMANDLINEMODELQUALITY__CTOR_OFFSET UNITYSDK_OFFSET(0xE958F90)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineModelQuality_TypeDefinitionIndex = 58445;
