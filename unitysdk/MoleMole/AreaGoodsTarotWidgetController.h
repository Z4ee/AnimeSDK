...
#define MOLEMOLE_AREAGOODSTAROTWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x13E9EFE0)
#define MOLEMOLE_AREAGOODSTAROTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x13E9F290)
#define MOLEMOLE_AREAGOODSTAROTWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x13E9F2C0)

namespace MoleMole
{
	inline static constexpr unsigned int AreaGoodsTarotWidgetController_TypeDefinitionIndex = 44029;
