...
#define MOLEMOLE_AREAGOODSTAROTWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x14DFA240)
#define MOLEMOLE_AREAGOODSTAROTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14DFA4F0)
#define MOLEMOLE_AREAGOODSTAROTWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x14DFA520)

namespace MoleMole
{
	inline static constexpr unsigned int AreaGoodsTarotWidgetController_TypeDefinitionIndex = 71020;
