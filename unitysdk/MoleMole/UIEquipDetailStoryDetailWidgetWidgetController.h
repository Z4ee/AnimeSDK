...
#define MOLEMOLE_UIEQUIPDETAILSTORYDETAILWIDGETWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x170BCDA0)
#define MOLEMOLE_UIEQUIPDETAILSTORYDETAILWIDGETWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x170BD320)
#define MOLEMOLE_UIEQUIPDETAILSTORYDETAILWIDGETWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x170BD450)
#define MOLEMOLE_UIEQUIPDETAILSTORYDETAILWIDGETWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x170BD3B0)
#define MOLEMOLE_UIEQUIPDETAILSTORYDETAILWIDGETWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x170BCC00)
#define MOLEMOLE_UIEQUIPDETAILSTORYDETAILWIDGETWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x170BCC60)
#define MOLEMOLE_UIEQUIPDETAILSTORYDETAILWIDGETWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x170BD4E0)
#define MOLEMOLE_UIEQUIPDETAILSTORYDETAILWIDGETWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x170BD540)
#define MOLEMOLE_UIEQUIPDETAILSTORYDETAILWIDGETWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x170BD5D0)
#define MOLEMOLE_UIEQUIPDETAILSTORYDETAILWIDGETWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x170BD600)
#define MOLEMOLE_UIEQUIPDETAILSTORYDETAILWIDGETWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x170BD650)
#define MOLEMOLE_UIEQUIPDETAILSTORYDETAILWIDGETWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x170BD6E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIEquipDetailStoryDetailWidgetWidgetController_TypeDefinitionIndex = 58691;

	class UIEquipDetailStoryDetailWidgetWidgetController : public ::MoleMole::UIBaseDynamicTipsWidgetController
	{
	public:
		::Class_2_F85E6314FDA1E41A* _view; // 0x2D0
		::MoleMole::UIEquipDetailStoryDetailTipsContext* _context; // 0x2D8
