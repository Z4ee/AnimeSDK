...
#define MOLEMOLE_UIEQUIPDETAILSTORYDETAILWIDGETWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x153094B0)
#define MOLEMOLE_UIEQUIPDETAILSTORYDETAILWIDGETWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15309A30)
#define MOLEMOLE_UIEQUIPDETAILSTORYDETAILWIDGETWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x15309B60)
#define MOLEMOLE_UIEQUIPDETAILSTORYDETAILWIDGETWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15309AC0)
#define MOLEMOLE_UIEQUIPDETAILSTORYDETAILWIDGETWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15309310)
#define MOLEMOLE_UIEQUIPDETAILSTORYDETAILWIDGETWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15309370)
#define MOLEMOLE_UIEQUIPDETAILSTORYDETAILWIDGETWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15309BF0)
#define MOLEMOLE_UIEQUIPDETAILSTORYDETAILWIDGETWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15309C50)
#define MOLEMOLE_UIEQUIPDETAILSTORYDETAILWIDGETWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x15309CE0)
#define MOLEMOLE_UIEQUIPDETAILSTORYDETAILWIDGETWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15309D10)
#define MOLEMOLE_UIEQUIPDETAILSTORYDETAILWIDGETWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15309D60)
#define MOLEMOLE_UIEQUIPDETAILSTORYDETAILWIDGETWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15309DF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIEquipDetailStoryDetailWidgetWidgetController_TypeDefinitionIndex = 39121;

	class UIEquipDetailStoryDetailWidgetWidgetController : public ::MoleMole::UIBaseDynamicTipsWidgetController
	{
	public:
		::Class_2_F85E6314FDA1E41A* _view; // 0x2C0
		::MoleMole::UIEquipDetailStoryDetailTipsContext* _context; // 0x2C8
