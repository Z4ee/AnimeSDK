...
#define MOLEMOLE_UIAUTOBATTLEPVETABBTNROWWIDGETCONTROLLER_GETTABBUTTON_OFFSET UNITYSDK_OFFSET(0x192F77C0)
#define MOLEMOLE_UIAUTOBATTLEPVETABBTNROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x192F76B0)
#define MOLEMOLE_UIAUTOBATTLEPVETABBTNROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x192F7740)
#define MOLEMOLE_UIAUTOBATTLEPVETABBTNROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x192F75E0)
#define MOLEMOLE_UIAUTOBATTLEPVETABBTNROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x192F7640)
#define MOLEMOLE_UIAUTOBATTLEPVETABBTNROWWIDGETCONTROLLER_SETRANK_OFFSET UNITYSDK_OFFSET(0x192F7910)
#define MOLEMOLE_UIAUTOBATTLEPVETABBTNROWWIDGETCONTROLLER_SETTEXT_OFFSET UNITYSDK_OFFSET(0x192F7820)
#define MOLEMOLE_UIAUTOBATTLEPVETABBTNROWWIDGETCONTROLLER_SHOWPOPUP_OFFSET UNITYSDK_OFFSET(0x192F7A20)
#define MOLEMOLE_UIAUTOBATTLEPVETABBTNROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x192F7D30)
#define MOLEMOLE_UIAUTOBATTLEPVETABBTNROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x192F7F30)
#define MOLEMOLE_UIAUTOBATTLEPVETABBTNROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x192F7FC0)
#define MOLEMOLE_UIAUTOBATTLEPVETABBTNROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x192F8050)
#define MOLEMOLE_UIAUTOBATTLEPVETABBTNROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x192F80E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAutoBattlePveTabBtnRowWidgetController_TypeDefinitionIndex = 72043;
