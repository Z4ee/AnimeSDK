...
#define MOLEMOLE_UISUIBIANTEMPLEDEPLOYBANGBOOPOPWINDOWCONTROLLER__DORECYCLETEMPLEBUDDIES_D__28_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x875E00)
#define MOLEMOLE_UISUIBIANTEMPLEDEPLOYBANGBOOPOPWINDOWCONTROLLER__DORECYCLETEMPLEBUDDIES_D__28_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleDeployBangbooPopWindowController__DoRecycleTempleBuddies_d__28_TypeDefinitionIndex = 61607;

	struct alignas(8) UISuibianTempleDeployBangbooPopWindowController__DoRecycleTempleBuddies_d__28
	{
		::MoleMole::UISuibianTempleDeployBangbooPopWindowController* __4__this; // 0x10
