...
#define MOLEMOLE_UIMONSTERFANTASYREWARDPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x155FA600)
#define MOLEMOLE_UIMONSTERFANTASYREWARDPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x155FA610)
#define MOLEMOLE_UIMONSTERFANTASYREWARDPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x155FA680)
#define MOLEMOLE_UIMONSTERFANTASYREWARDPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x155FA740)
#define MOLEMOLE_UIMONSTERFANTASYREWARDPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x155FA830)
#define MOLEMOLE_UIMONSTERFANTASYREWARDPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x155FA840)
#define MOLEMOLE_UIMONSTERFANTASYREWARDPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x155FA8E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyRewardPageController_TypeDefinitionIndex = 53551;
