...
#define MOLEMOLE_UIMONSTERFANTASYREWARDPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x13DEF610)
#define MOLEMOLE_UIMONSTERFANTASYREWARDPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x13DEF620)
#define MOLEMOLE_UIMONSTERFANTASYREWARDPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x13DEF690)
#define MOLEMOLE_UIMONSTERFANTASYREWARDPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x13DEF750)
#define MOLEMOLE_UIMONSTERFANTASYREWARDPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x13DEF840)
#define MOLEMOLE_UIMONSTERFANTASYREWARDPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x13DEF850)
#define MOLEMOLE_UIMONSTERFANTASYREWARDPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x13DEF8F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyRewardPageController_TypeDefinitionIndex = 65062;
