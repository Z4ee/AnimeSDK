...
#define MOLEMOLE_UICAFEITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15ACC1A0)
#define MOLEMOLE_UICAFEITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x15ACCCC0)
#define MOLEMOLE_UICAFEITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15ACC350)
#define MOLEMOLE_UICAFEITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15ACC2D0)
#define MOLEMOLE_UICAFEITEMWIDGETCONTROLLER_SETTRANSGRAY_OFFSET UNITYSDK_OFFSET(0x15ACCA10)
#define MOLEMOLE_UICAFEITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15ACCDA0)
#define MOLEMOLE_UICAFEITEMWIDGETCONTROLLER__ONCREATEVIEW_B__2_0_OFFSET UNITYSDK_OFFSET(0x15ACCDB0)
#define MOLEMOLE_UICAFEITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15ACCDC0)
#define MOLEMOLE_UICAFEITEMWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x15ACCE50)
#define MOLEMOLE_UICAFEITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15ACCEE0)
#define MOLEMOLE_UICAFEITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15ACCF80)

namespace MoleMole
{
	inline static constexpr unsigned int UICafeItemWidgetController_TypeDefinitionIndex = 57885;

	class UICafeItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_94D5884806027679_3* _view; // 0x2E8
