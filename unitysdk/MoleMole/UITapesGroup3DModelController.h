...
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_CANCELSHOWCURTAPE_OFFSET UNITYSDK_OFFSET(0x161908E0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_CIRCLEINDEX_OFFSET UNITYSDK_OFFSET(0x161956B0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_CIRCLETAPEGROUP_OFFSET UNITYSDK_OFFSET(0x1618ECF0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_CIRCLETAPE_OFFSET UNITYSDK_OFFSET(0x1618FBB0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_CLAMPDRAGDELTA_OFFSET UNITYSDK_OFFSET(0x161950A0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_CREATESCROLLTAPES_OFFSET UNITYSDK_OFFSET(0x1618E1A0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_CREATETAPESNOPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x1618D5B0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_CREATETAPESWITHPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x1618B940)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_DOCREATETAPES_OFFSET UNITYSDK_OFFSET(0x16191CC0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_DOFIXTAPEPOS_OFFSET UNITYSDK_OFFSET(0x161951D0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_DOSHOWTAPE_OFFSET UNITYSDK_OFFSET(0x16190480)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_FILTERCENTERTAPE_OFFSET UNITYSDK_OFFSET(0x1618A560)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_FIXTAPEPOS_OFFSET UNITYSDK_OFFSET(0x16195650)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_GETALLTAPES_OFFSET UNITYSDK_OFFSET(0x16190CC0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_GETSHOWINGVHSTEMPLATEIDS_OFFSET UNITYSDK_OFFSET(0x16191360)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_GETSINGLEPRESSSPEED_OFFSET UNITYSDK_OFFSET(0x16195000)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_GETTAPEBYTEMPLATE_OFFSET UNITYSDK_OFFSET(0x16190B20)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_GET_GETCURSHOWINGTAPEINDEX_OFFSET UNITYSDK_OFFSET(0x16189030)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_GET_TAPESCOUNT_OFFSET UNITYSDK_OFFSET(0x16188FD0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_INITDUMMYSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x16192880)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ISSHOWINGONETAPE_OFFSET UNITYSDK_OFFSET(0x1618ECA0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1618A8E0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_LIFTTAPES_OFFSET UNITYSDK_OFFSET(0x16193F60)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONAPPLICATIONFOCUS_OFFSET UNITYSDK_OFFSET(0x1618F090)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x1618EFE0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONCLICKTAPE_OFFSET UNITYSDK_OFFSET(0x1618FF80)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x161891A0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1618EBE0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x1618F0E0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONGAMEPADMOVE_OFFSET UNITYSDK_OFFSET(0x161947C0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x161948A0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONPERFORMANCEDONE_OFFSET UNITYSDK_OFFSET(0x16193D80)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONPOINTUP_OFFSET UNITYSDK_OFFSET(0x1618FE00)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x16189590)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16189620)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16189230)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x161894D0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_PERFORMANCEEXPAND_OFFSET UNITYSDK_OFFSET(0x161930B0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_PERFORMANCESHRINK_OFFSET UNITYSDK_OFFSET(0x16193780)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_REDIRECTTAPE_OFFSET UNITYSDK_OFFSET(0x16190FE0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_REFRESHCOVERVIEW_OFFSET UNITYSDK_OFFSET(0x16192F20)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_SELECTEASINGSTARTTAPE_OFFSET UNITYSDK_OFFSET(0x1618F8B0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_SHOWTAPEBYINDEX_OFFSET UNITYSDK_OFFSET(0x16191190)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_SHOWTAPEBYTEMPLATEID_OFFSET UNITYSDK_OFFSET(0x16190D20)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_STARTPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x1618D2F0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_SWITCHARCHIVETYPE_OFFSET UNITYSDK_OFFSET(0x1618A940)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_SWITCHPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x1618AA60)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_TRYLOADTAPES_OFFSET UNITYSDK_OFFSET(0x1618C410)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_UPDATECIRCLECORDON_OFFSET UNITYSDK_OFFSET(0x16192460)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_UPDATESHRINKTAPESTATE_OFFSET UNITYSDK_OFFSET(0x16191560)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_UPDATETAPESTATE_OFFSET UNITYSDK_OFFSET(0x16189EC0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x16189730)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__CANCELSHOWCURTAPE_B__24_0_OFFSET UNITYSDK_OFFSET(0x16195970)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__CANCELSHOWCURTAPE_B__24_1_OFFSET UNITYSDK_OFFSET(0x161959E0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x16195960)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16195740)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__DOSHOWTAPE_B__56_0_OFFSET UNITYSDK_OFFSET(0x16195F10)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__INITDUMMYSCROLLVIEW_B__36_0_OFFSET UNITYSDK_OFFSET(0x16195A60)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__INITDUMMYSCROLLVIEW_B__36_1_OFFSET UNITYSDK_OFFSET(0x16195AF0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__ONINPUTACTION_B__46_0_OFFSET UNITYSDK_OFFSET(0x16195F00)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__ONINPUTACTION_B__46_1_OFFSET UNITYSDK_OFFSET(0x16195EF0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__ONPERFORMANCEDONE_B__43_0_OFFSET UNITYSDK_OFFSET(0x16195CC0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16195F90)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x16196020)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x161960E0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x161960F0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16196100)

namespace MoleMole
{
	inline static constexpr unsigned int UITapesGroup3DModelController_TypeDefinitionIndex = 72702;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UITapesGroup3DModelController_TypeDefinitionIndex)->GetStaticField(0xDCC0);
		}
		...
		::Class_1_C376DB68B1C74261* _scriptableAnimationPlayer; // 0x3F8
