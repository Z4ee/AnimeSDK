...
#define MOLEMOLE_MONOGHOSTEFFECT_CREATEISOLATEDGHOST_OFFSET UNITYSDK_OFFSET(0x1263B150)
#define MOLEMOLE_MONOGHOSTEFFECT_EMPTY_OFFSET UNITYSDK_OFFSET(0x12638A20)
#define MOLEMOLE_MONOGHOSTEFFECT_GETCOMPONENTSAFELY_OFFSET UNITYSDK_OFFSET(0x12638B30)
#define MOLEMOLE_MONOGHOSTEFFECT_GET_ECHOTIME_OFFSET UNITYSDK_OFFSET(0x12638F80)
#define MOLEMOLE_MONOGHOSTEFFECT_GET_IGNOREOWNERTIMESCALE_OFFSET UNITYSDK_OFFSET(0x12639460)
#define MOLEMOLE_MONOGHOSTEFFECT_GET_IGNOREWORLDTIMESCALE_OFFSET UNITYSDK_OFFSET(0x12639230)
#define MOLEMOLE_MONOGHOSTEFFECT_GET_LIFETIME_OFFSET UNITYSDK_OFFSET(0x12638FF0)
#define MOLEMOLE_MONOGHOSTEFFECT_GET_MAXGHOSTCOUNT_OFFSET UNITYSDK_OFFSET(0x12638D70)
#define MOLEMOLE_MONOGHOSTEFFECT_GET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0x126394D0)
#define MOLEMOLE_MONOGHOSTEFFECT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x12639CA0)
#define MOLEMOLE_MONOGHOSTEFFECT_METHOD_5_0A17961F2C7839AC_OFFSET UNITYSDK_OFFSET(0x12639080)
#define MOLEMOLE_MONOGHOSTEFFECT_METHOD_5_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x12640700)
#define MOLEMOLE_MONOGHOSTEFFECT_METHOD_5_21378A7EB1BCB13B_OFFSET UNITYSDK_OFFSET(0x1263AA40)
#define MOLEMOLE_MONOGHOSTEFFECT_METHOD_5_26C5221AC22B6534_OFFSET UNITYSDK_OFFSET(0x1263F010)
#define MOLEMOLE_MONOGHOSTEFFECT_METHOD_5_2A1A0DC3332BB4CD_OFFSET UNITYSDK_OFFSET(0x12638DE0)
#define MOLEMOLE_MONOGHOSTEFFECT_METHOD_5_33ED1D695A028734_OFFSET UNITYSDK_OFFSET(0x12639C00)
#define MOLEMOLE_MONOGHOSTEFFECT_METHOD_5_37B1A315712743DC_OFFSET UNITYSDK_OFFSET(0x1263D670)
#define MOLEMOLE_MONOGHOSTEFFECT_METHOD_5_4256453CFEAAC957_OFFSET UNITYSDK_OFFSET(0x1263E320)
#define MOLEMOLE_MONOGHOSTEFFECT_METHOD_5_5B94350BBAC6A35E_OFFSET UNITYSDK_OFFSET(0x12639A90)
#define MOLEMOLE_MONOGHOSTEFFECT_METHOD_5_7272DB0445BC9CB0_OFFSET UNITYSDK_OFFSET(0x1263D790)
#define MOLEMOLE_MONOGHOSTEFFECT_METHOD_5_7BCE151B405796FB_OFFSET UNITYSDK_OFFSET(0x1263C160)
#define MOLEMOLE_MONOGHOSTEFFECT_METHOD_5_86ADBB4228161C74_OFFSET UNITYSDK_OFFSET(0x1263EDE0)
#define MOLEMOLE_MONOGHOSTEFFECT_METHOD_5_89A73E9731D84A94_OFFSET UNITYSDK_OFFSET(0x1263AC30)
#define MOLEMOLE_MONOGHOSTEFFECT_METHOD_5_91A773A85E497E9E_OFFSET UNITYSDK_OFFSET(0x126408A0)
#define MOLEMOLE_MONOGHOSTEFFECT_METHOD_5_923D2292AD68A88F_OFFSET UNITYSDK_OFFSET(0x1263D570)
#define MOLEMOLE_MONOGHOSTEFFECT_METHOD_5_92EF378E5C246C05_OFFSET UNITYSDK_OFFSET(0x1263F180)
#define MOLEMOLE_MONOGHOSTEFFECT_METHOD_5_A41BBC1FFFE80811_OFFSET UNITYSDK_OFFSET(0x12640550)
#define MOLEMOLE_MONOGHOSTEFFECT_METHOD_5_AE80CBC984AADFD5_OFFSET UNITYSDK_OFFSET(0x1263CE40)
#define MOLEMOLE_MONOGHOSTEFFECT_METHOD_5_BF9BB9E2BBF3B6F4_OFFSET UNITYSDK_OFFSET(0x126392A0)
#define MOLEMOLE_MONOGHOSTEFFECT_METHOD_5_D0B68C1DD4B91F49_OFFSET UNITYSDK_OFFSET(0x12640710)
#define MOLEMOLE_MONOGHOSTEFFECT_METHOD_5_D7952B26E014026F_OFFSET UNITYSDK_OFFSET(0x1263CDE0)
#define MOLEMOLE_MONOGHOSTEFFECT_METHOD_5_E2BCD1B56132A826_OFFSET UNITYSDK_OFFSET(0x1263BA60)
#define MOLEMOLE_MONOGHOSTEFFECT_METHOD_5_E35EDDEF9577BCE6_OFFSET UNITYSDK_OFFSET(0x1263E630)
#define MOLEMOLE_MONOGHOSTEFFECT_METHOD_5_E876C8B6D3B840A6_OFFSET UNITYSDK_OFFSET(0x1263D9F0)
#define MOLEMOLE_MONOGHOSTEFFECT_METHOD_5_EDA3923B891A3359_OFFSET UNITYSDK_OFFSET(0x1263E2B0)
#define MOLEMOLE_MONOGHOSTEFFECT_METHOD_5_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x12640940)
#define MOLEMOLE_MONOGHOSTEFFECT_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x12640930)
#define MOLEMOLE_MONOGHOSTEFFECT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1263ABE0)
#define MOLEMOLE_MONOGHOSTEFFECT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1263A8C0)
#define MOLEMOLE_MONOGHOSTEFFECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x12638C60)
#define MOLEMOLE_MONOGHOSTEFFECT_ONENTITYREMOVE_OFFSET UNITYSDK_OFFSET(0x1263CBE0)
#define MOLEMOLE_MONOGHOSTEFFECT_SET_ECHOTIME_OFFSET UNITYSDK_OFFSET(0x12638F90)
#define MOLEMOLE_MONOGHOSTEFFECT_SET_IGNOREOWNERTIMESCALE_OFFSET UNITYSDK_OFFSET(0x12639470)
#define MOLEMOLE_MONOGHOSTEFFECT_SET_IGNOREWORLDTIMESCALE_OFFSET UNITYSDK_OFFSET(0x12639240)
#define MOLEMOLE_MONOGHOSTEFFECT_SET_LIFETIME_OFFSET UNITYSDK_OFFSET(0x12639000)
#define MOLEMOLE_MONOGHOSTEFFECT_SET_MAXGHOSTCOUNT_OFFSET UNITYSDK_OFFSET(0x12638D80)
#define MOLEMOLE_MONOGHOSTEFFECT_SET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0x126394E0)
#define MOLEMOLE_MONOGHOSTEFFECT_STARTANDACTIVEGHOSTEFFECT_OFFSET UNITYSDK_OFFSET(0x1263C050)
#define MOLEMOLE_MONOGHOSTEFFECT_STARTGHOSTMOVE_OFFSET UNITYSDK_OFFSET(0x1263C8B0)
#define MOLEMOLE_MONOGHOSTEFFECT_STOPGHOSTEFFECT_OFFSET UNITYSDK_OFFSET(0x1263C5C0)
#define MOLEMOLE_MONOGHOSTEFFECT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1263CD10)
#define MOLEMOLE_MONOGHOSTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1263CC30)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGhostEffect_TypeDefinitionIndex = 79985;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::MonoGhostEffect*>**)Il2CppClass::FromTypeDefinitionIndex(MonoGhostEffect_TypeDefinitionIndex)->GetStaticField(0x30820);
		}
		static ::System::Int32* StaticGet_Field_5_35()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoGhostEffect_TypeDefinitionIndex)->GetStaticField(0xB020);
		}
		static ::System::Int32* StaticGet_Field_5_36()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoGhostEffect_TypeDefinitionIndex)->GetStaticField(0xB024);
		}
