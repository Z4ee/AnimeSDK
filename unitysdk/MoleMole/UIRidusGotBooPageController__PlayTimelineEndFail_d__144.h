...
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__PLAYTIMELINEENDFAIL_D__144_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x853600)
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__PLAYTIMELINEENDFAIL_D__144_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooPageController__PlayTimelineEndFail_d__144_TypeDefinitionIndex = 91523;
