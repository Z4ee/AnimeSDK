...
#define MOLEMOLE_CAMERAS_NAPCAMERASHOT_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x16C23BC0)
#define MOLEMOLE_CAMERAS_NAPCAMERASHOT_GATHERPROPERTIES_OFFSET UNITYSDK_OFFSET(0x16C23DC0)
#define MOLEMOLE_CAMERAS_NAPCAMERASHOT__CTOR_OFFSET UNITYSDK_OFFSET(0x16C24650)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int NapCameraShot_TypeDefinitionIndex = 49262;
