...
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0xFAE7190)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_GET_AVATARPREPAREDATA_OFFSET UNITYSDK_OFFSET(0xFAE6C70)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_GET_CURRENTCAMSTATE_OFFSET UNITYSDK_OFFSET(0xFAE6D10)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_GET_EXTERNALSTR_OFFSET UNITYSDK_OFFSET(0xFAE7040)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_GET_LOCKFEATURETARGET_OFFSET UNITYSDK_OFFSET(0xFAE6D00)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_GET_LOCKTARGET_OFFSET UNITYSDK_OFFSET(0xFAE6C90)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_GET_PREAVATARPREPAREDATA_OFFSET UNITYSDK_OFFSET(0xFAE6C50)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_03BFDB1C3240A55A_OFFSET UNITYSDK_OFFSET(0xFAE83F0)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_06D2228B483124DF_OFFSET UNITYSDK_OFFSET(0xFAEE830)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_0C498EE2EA2CF96A_OFFSET UNITYSDK_OFFSET(0xFAEED80)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_148D7A98EB871977_1_OFFSET UNITYSDK_OFFSET(0xFAEB900)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_148D7A98EB871977_OFFSET UNITYSDK_OFFSET(0xFAEB2D0)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_14992E39298B9D27_OFFSET UNITYSDK_OFFSET(0xFAEB200)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_153DB45DA48D91A6_OFFSET UNITYSDK_OFFSET(0xFAEB720)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_17C2C73EDCBB5629_OFFSET UNITYSDK_OFFSET(0xFAEB6C0)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xFAEB270)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_245D7FBFF19F784E_OFFSET UNITYSDK_OFFSET(0xFAE9410)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_2C5D04531262A697_OFFSET UNITYSDK_OFFSET(0xFAEDC30)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_30197B07F99B681E_OFFSET UNITYSDK_OFFSET(0xFAE9D10)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_33ACA6CB2ABC73F7_1_OFFSET UNITYSDK_OFFSET(0xFAEA310)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0xFAE9AA0)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_363148F355523F24_OFFSET UNITYSDK_OFFSET(0xFAE9730)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_37011B6DDBE4CF26_OFFSET UNITYSDK_OFFSET(0xFAEA8B0)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_37BF2F32FDE645A4_OFFSET UNITYSDK_OFFSET(0xFAEE930)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_39A9FE040505BFA5_1_OFFSET UNITYSDK_OFFSET(0xFAEE4F0)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_39A9FE040505BFA5_OFFSET UNITYSDK_OFFSET(0xFAEBC90)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_3B4AC28BC20E9CD8_OFFSET UNITYSDK_OFFSET(0xFAEC1F0)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_3B6DE532CA77D7C1_OFFSET UNITYSDK_OFFSET(0xFAEE250)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_42C5BADE1C9EFC80_OFFSET UNITYSDK_OFFSET(0xFAEB0A0)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_477268E8180E05C5_OFFSET UNITYSDK_OFFSET(0xFAEB8A0)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_5110E061C0DF5692_OFFSET UNITYSDK_OFFSET(0xFAE9B80)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_522663341B4E5003_1_OFFSET UNITYSDK_OFFSET(0xFAEC920)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_522663341B4E5003_OFFSET UNITYSDK_OFFSET(0xFAE79C0)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_534661913E3766CA_OFFSET UNITYSDK_OFFSET(0xFAED3F0)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_538706B04C2A4407_OFFSET UNITYSDK_OFFSET(0xFAE8150)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_54BDA1C01D683A47_OFFSET UNITYSDK_OFFSET(0xFAEA290)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_62131DF2D3A09864_OFFSET UNITYSDK_OFFSET(0xFAED940)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_650F473FFDE608B9_1_OFFSET UNITYSDK_OFFSET(0xFAE7C30)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_650F473FFDE608B9_2_OFFSET UNITYSDK_OFFSET(0xFAECB90)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_650F473FFDE608B9_OFFSET UNITYSDK_OFFSET(0xFAE7E60)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_65479C04535824AE_OFFSET UNITYSDK_OFFSET(0xFAEA690)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_6BB86695870EFBD1_OFFSET UNITYSDK_OFFSET(0xFAE8290)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_7E61AB0326C9D6AE_OFFSET UNITYSDK_OFFSET(0xFAECF10)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_7E832D0C2C340C33_OFFSET UNITYSDK_OFFSET(0xFAEA190)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_861970C5F2C21AB2_OFFSET UNITYSDK_OFFSET(0xFAE8090)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_92EB806315DCB90E_OFFSET UNITYSDK_OFFSET(0xFAEE8D0)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_945C3AC4300E4FA3_1_OFFSET UNITYSDK_OFFSET(0xFAED780)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_945C3AC4300E4FA3_OFFSET UNITYSDK_OFFSET(0xFAED720)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0xFAEA700)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_A8F6F688241E6DBC_OFFSET UNITYSDK_OFFSET(0xFAEEE00)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_AA69FB9485F94D4F_OFFSET UNITYSDK_OFFSET(0xFAEC710)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_ABE7CF9FA1B8CCA3_1_OFFSET UNITYSDK_OFFSET(0xFAEDCD0)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_ABE7CF9FA1B8CCA3_OFFSET UNITYSDK_OFFSET(0xFAE8B30)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_AE639D8AB1549F54_OFFSET UNITYSDK_OFFSET(0xFAEEBF0)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_AECF8BEC293ED42A_1_OFFSET UNITYSDK_OFFSET(0xFAE78F0)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_AECF8BEC293ED42A_2_OFFSET UNITYSDK_OFFSET(0xFAE90E0)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_AECF8BEC293ED42A_3_OFFSET UNITYSDK_OFFSET(0xFAEBCF0)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_AECF8BEC293ED42A_4_OFFSET UNITYSDK_OFFSET(0xFAEE410)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_AECF8BEC293ED42A_OFFSET UNITYSDK_OFFSET(0xFAE77E0)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xFAEA830)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_B6BB704B01BCC35B_OFFSET UNITYSDK_OFFSET(0xFAEE550)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_BB5C538354FD3393_1_OFFSET UNITYSDK_OFFSET(0xFAEC790)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_BB5C538354FD3393_OFFSET UNITYSDK_OFFSET(0xFAE8F50)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_BC745DD3D5619033_OFFSET UNITYSDK_OFFSET(0xFAEE010)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_BCB087DFB7399B96_OFFSET UNITYSDK_OFFSET(0xFAEB800)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_C0424C3F296FC41E_1_OFFSET UNITYSDK_OFFSET(0xFAEAC70)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_C0424C3F296FC41E_OFFSET UNITYSDK_OFFSET(0xFAE91B0)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_C4C4701D503698C5_OFFSET UNITYSDK_OFFSET(0xFAEBDF0)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_C6C6033AD8273C6E_OFFSET UNITYSDK_OFFSET(0xFAEAF30)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_CBACBF33B55CA258_1_OFFSET UNITYSDK_OFFSET(0xFAE9FA0)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_CBACBF33B55CA258_2_OFFSET UNITYSDK_OFFSET(0xFAEAA80)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_CBACBF33B55CA258_3_OFFSET UNITYSDK_OFFSET(0xFAEC000)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_CBACBF33B55CA258_4_OFFSET UNITYSDK_OFFSET(0xFAED200)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_CBACBF33B55CA258_OFFSET UNITYSDK_OFFSET(0xFAE9DB0)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_CEDFC005CF62CD75_OFFSET UNITYSDK_OFFSET(0xFAEEE60)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_CFC10D722DB70A50_1_OFFSET UNITYSDK_OFFSET(0xFAEB420)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_CFC10D722DB70A50_OFFSET UNITYSDK_OFFSET(0xFAEBA50)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_CFFAFB6FF11557B5_OFFSET UNITYSDK_OFFSET(0xFAEC380)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_DB659701005BBAF8_OFFSET UNITYSDK_OFFSET(0xFAEB660)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_DF76843B906CABFF_1_OFFSET UNITYSDK_OFFSET(0xFAEE5E0)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_DF76843B906CABFF_OFFSET UNITYSDK_OFFSET(0xFAEA440)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_E3D1A129DD9A7B23_OFFSET UNITYSDK_OFFSET(0xFAED7E0)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_EC9C71CF50EEA7C5_OFFSET UNITYSDK_OFFSET(0xFAEC640)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_F24770EBEBE4C788_OFFSET UNITYSDK_OFFSET(0xFAEDB30)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_F7667B5003121159_OFFSET UNITYSDK_OFFSET(0xFAE95E0)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_SET_AVATARPREPAREDATA_OFFSET UNITYSDK_OFFSET(0xFAE6C80)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_SET_CURRENTCAMSTATE_OFFSET UNITYSDK_OFFSET(0xFAE7030)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_SET_PREAVATARPREPAREDATA_OFFSET UNITYSDK_OFFSET(0xFAE6C60)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR__CCTOR_OFFSET UNITYSDK_OFFSET(0xFAE7610)
#define MOLEMOLE_CAMERAS_CAMERADATAACCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xFAE7340)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int CameraDataAccessor_TypeDefinitionIndex = 65587;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Collections::Generic::List_1<::System::String*>*>**)Il2CppClass::FromTypeDefinitionIndex(CameraDataAccessor_TypeDefinitionIndex)->GetStaticField(0x44460);
		}
		...
		::Struct_2_6E1B724B14572104_6 CamGlobalCommonData; // 0x2C0
		...
		::Class_1_5738DDFE3F32F812* Method_1_AECF8BEC293ED42A_2()
		{
			return ((::Class_1_5738DDFE3F32F812*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_AECF8BEC293ED42A_2_OFFSET))(this);
		}
		...
		::Class_1_BB84B938A7E58DA3* Method_1_AECF8BEC293ED42A_3()
		{
			return ((::Class_1_BB84B938A7E58DA3*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_AECF8BEC293ED42A_3_OFFSET))(this);
		}
		...
		::System::Boolean Method_1_945C3AC4300E4FA3(::Class_1_1DAC1F9F4B999C38_Struct_2_2673E6B37CEF07BF_1 a1)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_1DAC1F9F4B999C38_Struct_2_2673E6B37CEF07BF_1))((::PBYTE)hIl2Cpp + MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_945C3AC4300E4FA3_OFFSET))(this, a1);
		}

		::System::Boolean Method_1_945C3AC4300E4FA3_1(::Class_1_FF2ECD13EC40B5E1_Struct_2_2673E6B37CEF07BF a1)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_FF2ECD13EC40B5E1_Struct_2_2673E6B37CEF07BF))((::PBYTE)hIl2Cpp + MOLEMOLE_CAMERAS_CAMERADATAACCESSOR_METHOD_1_945C3AC4300E4FA3_1_OFFSET))(this, a1);
		}
