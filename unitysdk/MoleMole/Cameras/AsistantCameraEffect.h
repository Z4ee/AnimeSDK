...
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xECE89F0)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0xECE8620)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0xECE8830)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0xECE86E0)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_TEST_OFFSET UNITYSDK_OFFSET(0xECE8B40)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_UPDATEALLPROGRESS_OFFSET UNITYSDK_OFFSET(0xECE8890)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xECE8D20)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT__TEST_B__8_1_OFFSET UNITYSDK_OFFSET(0xECE8D70)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int AsistantCameraEffect_TypeDefinitionIndex = 50778;
