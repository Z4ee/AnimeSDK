...
#define MOLEMOLE_CAMERAS_CAMERAMISCSETTING_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x1742B6A0)
#define MOLEMOLE_CAMERAS_CAMERAMISCSETTING_LERP_OFFSET UNITYSDK_OFFSET(0x1742B520)
#define MOLEMOLE_CAMERAS_CAMERAMISCSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1742B690)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int CameraMiscSetting_TypeDefinitionIndex = 59754;
