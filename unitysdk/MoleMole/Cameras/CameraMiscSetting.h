...
#define MOLEMOLE_CAMERAS_CAMERAMISCSETTING_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x17025FC0)
#define MOLEMOLE_CAMERAS_CAMERAMISCSETTING_LERP_OFFSET UNITYSDK_OFFSET(0x17025E40)
#define MOLEMOLE_CAMERAS_CAMERAMISCSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x17025FB0)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int CameraMiscSetting_TypeDefinitionIndex = 51739;
