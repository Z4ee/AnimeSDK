...
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_FORCECAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0xFF102E0)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_FORCECAMERASTATE_OFFSET UNITYSDK_OFFSET(0xFF10050)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_FORCEUPDATE_OFFSET UNITYSDK_OFFSET(0xFF11500)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_GET_CHILDCAMERAS_OFFSET UNITYSDK_OFFSET(0x17D035F0)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0xFF0FE70)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_GET_FOLLOW_OFFSET UNITYSDK_OFFSET(0xFF10100)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_GET_FRAMECOUNT_OFFSET UNITYSDK_OFFSET(0xFF0FE00)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_GET_LIVECHILD_OFFSET UNITYSDK_OFFSET(0xFF0FFE0)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_GET_LOOKAT_OFFSET UNITYSDK_OFFSET(0xFF100E0)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_GET_NAPCAMERAMOVESTATE_OFFSET UNITYSDK_OFFSET(0xFF0FE10)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_GET_STATE_OFFSET UNITYSDK_OFFSET(0xFF100B0)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_INTERNALUPDATECAMERASTATE_OFFSET UNITYSDK_OFFSET(0xFF105E0)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_ISLIVECHILD_OFFSET UNITYSDK_OFFSET(0xFF0FFF0)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_METHOD_6_361E6D3C3EE446E9_OFFSET UNITYSDK_OFFSET(0x17D051D0)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_METHOD_6_36B653DB2482528C_OFFSET UNITYSDK_OFFSET(0x17D04920)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_METHOD_6_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0x17D046C0)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_METHOD_6_5528DFFF3D752BB6_OFFSET UNITYSDK_OFFSET(0x17D03610)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_METHOD_6_9BE08FEF2631B790_OFFSET UNITYSDK_OFFSET(0x17D04B40)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_METHOD_6_AC5B7D11B23DE6F5_OFFSET UNITYSDK_OFFSET(0x17D051C0)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_METHOD_6_B13DAADAAC62955E_OFFSET UNITYSDK_OFFSET(0x17D04910)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_METHOD_6_C114A1F8E08B6F92_OFFSET UNITYSDK_OFFSET(0x17D051B0)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x17D033C0)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x17D03420)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17D03130)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_ONTARGETOBJECTWARPED_OFFSET UNITYSDK_OFFSET(0xFF10120)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_ONTRANSFORMCHILDRENCHANGED_OFFSET UNITYSDK_OFFSET(0x17D03580)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_ONTRANSITIONFROMCAMERA_OFFSET UNITYSDK_OFFSET(0xFF104F0)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_SET_FOLLOW_OFFSET UNITYSDK_OFFSET(0xFF10110)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_SET_LIVECHILD_OFFSET UNITYSDK_OFFSET(0xFF0FFD0)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_SET_LOOKAT_OFFSET UNITYSDK_OFFSET(0xFF100F0)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_UPDATEPARENTCAMERAMOVE_OFFSET UNITYSDK_OFFSET(0x17D03DD0)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA_VALIDATEINSTRUCTIONS_OFFSET UNITYSDK_OFFSET(0x17D038D0)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA__CCTOR_OFFSET UNITYSDK_OFFSET(0x17D04240)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x17D03F20)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA___BASE_FORCECAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0x17D043E0)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA___BASE_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x17D044D0)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA___BASE_ISLIVECHILD_OFFSET UNITYSDK_OFFSET(0x17D04510)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x17D04520)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17D04590)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA___BASE_ONTARGETOBJECTWARPED_OFFSET UNITYSDK_OFFSET(0x17D045A0)
#define MOLEMOLE_CAMERAS_NAPACTIONVIRTUALSTATEDRIVENCAMERA___BASE_ONTRANSITIONFROMCAMERA_OFFSET UNITYSDK_OFFSET(0x17D04670)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int NapActionVirtualStateDrivenCamera_TypeDefinitionIndex = 57951;
	...
	public:
		...
		{
			return (::Struct_2_455336A079B58DD3*)Il2CppClass::FromTypeDefinitionIndex(NapActionVirtualStateDrivenCamera_TypeDefinitionIndex)->GetStaticField(0x47410);
		}
		static ::Il2CppArray<::System::String*>** StaticGet_Field_6_10()
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(NapActionVirtualStateDrivenCamera_TypeDefinitionIndex)->GetStaticField(0x47430);
		}
		static ::UnityEngine::Vector3* StaticGet_DebugOverridePosition()
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(NapActionVirtualStateDrivenCamera_TypeDefinitionIndex)->GetStaticField(0x11270);
		}
		static ::System::Boolean* StaticGet_DebugOverride()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(NapActionVirtualStateDrivenCamera_TypeDefinitionIndex)->GetStaticField(0x1127C);
		}
		static ::System::Single* StaticGet_DebugOverrideAlpha()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(NapActionVirtualStateDrivenCamera_TypeDefinitionIndex)->GetStaticField(0x11280);
		}
		static ::UnityEngine::Quaternion* StaticGet_DebugOverrideRotation()
		{
			return (::UnityEngine::Quaternion*)Il2CppClass::FromTypeDefinitionIndex(NapActionVirtualStateDrivenCamera_TypeDefinitionIndex)->GetStaticField(0x11284);
		}
