...
#define MOLEMOLE_CAMERAS_ENTITYCAMERAVIEWCONFIGBYATTACHPOINTS_METHOD_1_EA727EED653D961C_OFFSET UNITYSDK_OFFSET(0x16291490)
#define MOLEMOLE_CAMERAS_ENTITYCAMERAVIEWCONFIGBYATTACHPOINTS__CTOR_OFFSET UNITYSDK_OFFSET(0x16291480)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int EntityCameraViewConfigByAttachPoints_TypeDefinitionIndex = 46876;
