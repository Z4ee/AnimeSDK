...
#define MOLEMOLE_CAMERAS_CAMERAFOLLOWCALCDATA_GET_ANCHORELEVATION_OFFSET UNITYSDK_OFFSET(0x6E8AA0)
#define MOLEMOLE_CAMERAS_CAMERAFOLLOWCALCDATA_GET_ANCHORPOLAR_OFFSET UNITYSDK_OFFSET(0x3B3000)
#define MOLEMOLE_CAMERAS_CAMERAFOLLOWCALCDATA_GET_FINALANCHORELEVATIONRATIO_OFFSET UNITYSDK_OFFSET(0x7595F0)
#define MOLEMOLE_CAMERAS_CAMERAFOLLOWCALCDATA_GET_FINALRADIUSAPPEND_OFFSET UNITYSDK_OFFSET(0x759600)
#define MOLEMOLE_CAMERAS_CAMERAFOLLOWCALCDATA_GET_ROTATIONCAMZDELTA_OFFSET UNITYSDK_OFFSET(0x58C110)
#define MOLEMOLE_CAMERAS_CAMERAFOLLOWCALCDATA_METHOD_2_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x759630)
#define MOLEMOLE_CAMERAS_CAMERAFOLLOWCALCDATA_METHOD_2_E107726B9FF92036_OFFSET UNITYSDK_OFFSET(0x759620)
#define MOLEMOLE_CAMERAS_CAMERAFOLLOWCALCDATA_SET_ANCHORELEVATION_OFFSET UNITYSDK_OFFSET(0x7595E0)
#define MOLEMOLE_CAMERAS_CAMERAFOLLOWCALCDATA_SET_ANCHORPOLAR_OFFSET UNITYSDK_OFFSET(0x7595D0)
#define MOLEMOLE_CAMERAS_CAMERAFOLLOWCALCDATA_SET_ROTATIONCAMZDELTA_OFFSET UNITYSDK_OFFSET(0x58C120)
#define MOLEMOLE_CAMERAS_CAMERAFOLLOWCALCDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x759610)
#define MOLEMOLE_CAMERAS_CAMERAFOLLOWCALCDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x12D00300)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int CameraFollowCalcData_TypeDefinitionIndex = 49189;

	struct alignas(4) CameraFollowCalcData
	{
		static ::MoleMole::Cameras::CameraFollowCalcData* StaticGet_Default()
		{
			return (::MoleMole::Cameras::CameraFollowCalcData*)Il2CppClass::FromTypeDefinitionIndex(CameraFollowCalcData_TypeDefinitionIndex)->GetStaticField(0x10420);
		}
