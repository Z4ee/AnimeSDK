...
#define MOLEMOLE_CAMERAS_DEV_DEVMULTICHATCAMERA_SYNC_OFFSET UNITYSDK_OFFSET(0x10CD4330)
#define MOLEMOLE_CAMERAS_DEV_DEVMULTICHATCAMERA_UPDATE_OFFSET UNITYSDK_OFFSET(0x10CD42E0)
#define MOLEMOLE_CAMERAS_DEV_DEVMULTICHATCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x10CD47F0)

namespace MoleMole::Cameras::Dev
{
	inline static constexpr unsigned int DevMultiChatCamera_TypeDefinitionIndex = 51780;
