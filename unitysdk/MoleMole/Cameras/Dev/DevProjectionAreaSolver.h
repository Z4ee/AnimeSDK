...
#define MOLEMOLE_CAMERAS_DEV_DEVPROJECTIONAREASOLVER_METHOD_5_0C048562DB2D3787_OFFSET UNITYSDK_OFFSET(0x134D5BF0)
#define MOLEMOLE_CAMERAS_DEV_DEVPROJECTIONAREASOLVER_METHOD_5_355360541FC2B14C_OFFSET UNITYSDK_OFFSET(0x134D4D30)
#define MOLEMOLE_CAMERAS_DEV_DEVPROJECTIONAREASOLVER_METHOD_5_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x134D9860)
#define MOLEMOLE_CAMERAS_DEV_DEVPROJECTIONAREASOLVER_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x134D95E0)
#define MOLEMOLE_CAMERAS_DEV_DEVPROJECTIONAREASOLVER_UPDATE_OFFSET UNITYSDK_OFFSET(0x134D4A60)
#define MOLEMOLE_CAMERAS_DEV_DEVPROJECTIONAREASOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x134D97B0)

namespace MoleMole::Cameras::Dev
{
	inline static constexpr unsigned int DevProjectionAreaSolver_TypeDefinitionIndex = 51426;
	...
	public:
		...
		::System::Collections::Generic::List_1<::UnityEngine::Vector3>* Field_5_5; // 0x38
