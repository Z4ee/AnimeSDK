...
#define MOLEMOLE_CAMERAS_DEV_DEVPROJECTIONAREASOLVER_METHOD_5_0C048562DB2D3787_OFFSET UNITYSDK_OFFSET(0x159C7F00)
#define MOLEMOLE_CAMERAS_DEV_DEVPROJECTIONAREASOLVER_METHOD_5_355360541FC2B14C_OFFSET UNITYSDK_OFFSET(0x159C7040)
#define MOLEMOLE_CAMERAS_DEV_DEVPROJECTIONAREASOLVER_METHOD_5_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x159CBAF0)
#define MOLEMOLE_CAMERAS_DEV_DEVPROJECTIONAREASOLVER_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x159CB880)
#define MOLEMOLE_CAMERAS_DEV_DEVPROJECTIONAREASOLVER_UPDATE_OFFSET UNITYSDK_OFFSET(0x159C6D70)
#define MOLEMOLE_CAMERAS_DEV_DEVPROJECTIONAREASOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x159CBA40)

namespace MoleMole::Cameras::Dev
{
	inline static constexpr unsigned int DevProjectionAreaSolver_TypeDefinitionIndex = 38464;
