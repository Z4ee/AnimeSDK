...
#define MOLEMOLE_CAMERAS_CAMERAINFO_GET_CORRECTEDORIENTATION_OFFSET UNITYSDK_OFFSET(0x6B00B0)
#define MOLEMOLE_CAMERAS_CAMERAINFO_GET_CORRECTEDPOSITION_OFFSET UNITYSDK_OFFSET(0x61EBD0)
#define MOLEMOLE_CAMERAS_CAMERAINFO_GET_FINALORIENTATION_OFFSET UNITYSDK_OFFSET(0x6B00B0)
#define MOLEMOLE_CAMERAS_CAMERAINFO_GET_FINALPOSITION_OFFSET UNITYSDK_OFFSET(0x61EBD0)
#define MOLEMOLE_CAMERAS_CAMERAINFO_GET_ORIENTATIONCORRECTION_OFFSET UNITYSDK_OFFSET(0x458A70)
#define MOLEMOLE_CAMERAS_CAMERAINFO_GET_POSITIONCORRECTION_OFFSET UNITYSDK_OFFSET(0x3FFA00)
#define MOLEMOLE_CAMERAS_CAMERAINFO_GET_RAWORIENTATION_OFFSET UNITYSDK_OFFSET(0x6B0080)
#define MOLEMOLE_CAMERAS_CAMERAINFO_METHOD_2_DB077F204DC28C2A_OFFSET UNITYSDK_OFFSET(0x6B01A0)
#define MOLEMOLE_CAMERAS_CAMERAINFO_SET_ORIENTATIONCORRECTION_OFFSET UNITYSDK_OFFSET(0x6B00A0)
#define MOLEMOLE_CAMERAS_CAMERAINFO_SET_POSITIONCORRECTION_OFFSET UNITYSDK_OFFSET(0x61EA70)
#define MOLEMOLE_CAMERAS_CAMERAINFO_SET_RAWORIENTATION_OFFSET UNITYSDK_OFFSET(0x6B0090)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int CameraInfo_TypeDefinitionIndex = 67560;
