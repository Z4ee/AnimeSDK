...
#define MOLEMOLE_CAMERAS_CAMERAINFO_GET_CORRECTEDORIENTATION_OFFSET UNITYSDK_OFFSET(0x7C3AC0)
#define MOLEMOLE_CAMERAS_CAMERAINFO_GET_CORRECTEDPOSITION_OFFSET UNITYSDK_OFFSET(0x7C3A60)
#define MOLEMOLE_CAMERAS_CAMERAINFO_GET_FINALORIENTATION_OFFSET UNITYSDK_OFFSET(0x7C3AC0)
#define MOLEMOLE_CAMERAS_CAMERAINFO_GET_FINALPOSITION_OFFSET UNITYSDK_OFFSET(0x7C3A60)
#define MOLEMOLE_CAMERAS_CAMERAINFO_GET_ORIENTATIONCORRECTION_OFFSET UNITYSDK_OFFSET(0x451E30)
#define MOLEMOLE_CAMERAS_CAMERAINFO_GET_POSITIONCORRECTION_OFFSET UNITYSDK_OFFSET(0x457AA0)
#define MOLEMOLE_CAMERAS_CAMERAINFO_GET_RAWORIENTATION_OFFSET UNITYSDK_OFFSET(0x7C3A90)
#define MOLEMOLE_CAMERAS_CAMERAINFO_METHOD_2_DB077F204DC28C2A_OFFSET UNITYSDK_OFFSET(0x7C3BB0)
#define MOLEMOLE_CAMERAS_CAMERAINFO_SET_ORIENTATIONCORRECTION_OFFSET UNITYSDK_OFFSET(0x7C3AB0)
#define MOLEMOLE_CAMERAS_CAMERAINFO_SET_POSITIONCORRECTION_OFFSET UNITYSDK_OFFSET(0x7C3A50)
#define MOLEMOLE_CAMERAS_CAMERAINFO_SET_RAWORIENTATION_OFFSET UNITYSDK_OFFSET(0x7C3AA0)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int CameraInfo_TypeDefinitionIndex = 47213;
