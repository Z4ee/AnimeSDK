...
#define MOLEMOLE_CAMERAS_TOPVIEWCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17430F90)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int TopViewCameraConfig_TypeDefinitionIndex = 71371;
