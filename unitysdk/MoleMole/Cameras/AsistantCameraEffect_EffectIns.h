...
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_GET_CURRENTVALUE_OFFSET UNITYSDK_OFFSET(0x177B3360)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x177B3460)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_SET_CURRENTVALUE_OFFSET UNITYSDK_OFFSET(0x177B33D0)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_TEST_OFFSET UNITYSDK_OFFSET(0x177B3C50)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_TICK_OFFSET UNITYSDK_OFFSET(0x177B3BB0)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_UPDATEPROGRESS_OFFSET UNITYSDK_OFFSET(0x177B3740)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_UPDATEPROP_1_OFFSET UNITYSDK_OFFSET(0x177B3980)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_UPDATEPROP_OFFSET UNITYSDK_OFFSET(0x177B3830)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS__CTOR_OFFSET UNITYSDK_OFFSET(0x177B3DD0)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS__TEST_B__19_0_OFFSET UNITYSDK_OFFSET(0x177B3E60)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS__TEST_B__19_1_OFFSET UNITYSDK_OFFSET(0x177B3E70)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int AsistantCameraEffect_EffectIns_TypeDefinitionIndex = 46977;
