...
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_GET_CURRENTVALUE_OFFSET UNITYSDK_OFFSET(0xFF0B9C0)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_ONENABLE_OFFSET UNITYSDK_OFFSET(0xFF0BAC0)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_SET_CURRENTVALUE_OFFSET UNITYSDK_OFFSET(0xFF0BA30)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_TEST_OFFSET UNITYSDK_OFFSET(0xFF0C2B0)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_TICK_OFFSET UNITYSDK_OFFSET(0xFF0C210)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_UPDATEPROGRESS_OFFSET UNITYSDK_OFFSET(0xFF0BDA0)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_UPDATEPROP_1_OFFSET UNITYSDK_OFFSET(0xFF0BFE0)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_UPDATEPROP_OFFSET UNITYSDK_OFFSET(0xFF0BE90)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS__CTOR_OFFSET UNITYSDK_OFFSET(0xFF0C430)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS__TEST_B__19_0_OFFSET UNITYSDK_OFFSET(0xFF0C4C0)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS__TEST_B__19_1_OFFSET UNITYSDK_OFFSET(0xFF0C4D0)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int AsistantCameraEffect_EffectIns_TypeDefinitionIndex = 50779;
