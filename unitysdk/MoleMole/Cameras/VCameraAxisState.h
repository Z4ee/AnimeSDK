...
#define MOLEMOLE_CAMERAS_VCAMERAAXISSTATE_GET_CURRENTSPEED_OFFSET UNITYSDK_OFFSET(0x6D5120)
#define MOLEMOLE_CAMERAS_VCAMERAAXISSTATE_METHOD_2_34EFA4157E7AE41F_OFFSET UNITYSDK_OFFSET(0x6D5190)
#define MOLEMOLE_CAMERAS_VCAMERAAXISSTATE_METHOD_2_3735E71D7B6AFF5B_OFFSET UNITYSDK_OFFSET(0x6D52A0)
#define MOLEMOLE_CAMERAS_VCAMERAAXISSTATE_METHOD_2_4F602D3B9C6B3EFC_OFFSET UNITYSDK_OFFSET(0x6D51B0)
#define MOLEMOLE_CAMERAS_VCAMERAAXISSTATE_METHOD_2_705AF43C01ED360A_OFFSET UNITYSDK_OFFSET(0x6D51D0)
#define MOLEMOLE_CAMERAS_VCAMERAAXISSTATE_METHOD_2_76F7CA8BB59F9F60_1_OFFSET UNITYSDK_OFFSET(0x6D51C0)
#define MOLEMOLE_CAMERAS_VCAMERAAXISSTATE_METHOD_2_76F7CA8BB59F9F60_OFFSET UNITYSDK_OFFSET(0x6D51A0)
#define MOLEMOLE_CAMERAS_VCAMERAAXISSTATE_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x6D5250)
#define MOLEMOLE_CAMERAS_VCAMERAAXISSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x6D5130)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int VCameraAxisState_TypeDefinitionIndex = 47005;
