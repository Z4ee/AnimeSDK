...
#define MOLEMOLE_CAMERAS_NAPTIMELINEVIRTUALCAMERA_SYNCCAMERASTATE_OFFSET UNITYSDK_OFFSET(0x134D98C0)
#define MOLEMOLE_CAMERAS_NAPTIMELINEVIRTUALCAMERA__CCTOR_OFFSET UNITYSDK_OFFSET(0x134D9B50)
#define MOLEMOLE_CAMERAS_NAPTIMELINEVIRTUALCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x134D9B40)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int NapTimelineVirtualCamera_TypeDefinitionIndex = 61974;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(NapTimelineVirtualCamera_TypeDefinitionIndex)->GetStaticField(0x4BD80);
		}
