...
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT_APPLYTOCAMERAS_OFFSET UNITYSDK_OFFSET(0x134E6420)
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT_CALCMAXELVANGLE_OFFSET UNITYSDK_OFFSET(0x134E5520)
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT_GET_CURRENTELEANGLE_OFFSET UNITYSDK_OFFSET(0x134E5510)
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT_ROTATE_OFFSET UNITYSDK_OFFSET(0x134E6220)
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT_SETTLELAYOUT_OFFSET UNITYSDK_OFFSET(0x134E56D0)
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT_TRYGETAVALIABLEELEANGLE_OFFSET UNITYSDK_OFFSET(0x134E55B0)
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x134E6710)
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT___BASE_SETTLELAYOUT_OFFSET UNITYSDK_OFFSET(0x134E6730)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int VCamerasSphericalTreePointPanLayout_TypeDefinitionIndex = 70609;
	...
	public:
		...
		::System::Single mRadius; // 0x24
		::System::Single currentEleAngle; // 0x28
