...
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT_APPLYTOCAMERAS_OFFSET UNITYSDK_OFFSET(0x159D72F0)
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT_CALCMAXELVANGLE_OFFSET UNITYSDK_OFFSET(0x159D6320)
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT_GET_CURRENTELEANGLE_OFFSET UNITYSDK_OFFSET(0x159D6310)
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT_ROTATE_OFFSET UNITYSDK_OFFSET(0x159D70E0)
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT_SETTLELAYOUT_OFFSET UNITYSDK_OFFSET(0x159D64D0)
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT_TRYGETAVALIABLEELEANGLE_OFFSET UNITYSDK_OFFSET(0x159D63B0)
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x159D7610)
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT___BASE_SETTLELAYOUT_OFFSET UNITYSDK_OFFSET(0x159D7630)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int VCamerasSphericalTreePointPanLayout_TypeDefinitionIndex = 47922;
	...
	public:
		...
		::System::Single mRadius; // 0x18
		::System::Single mmaxElvAngle; // 0x1C
		::System::Boolean applyElvAngleCurve; // 0x20
		::System::Single currentEleAngle; // 0x24
		::System::Single initEleAngle; // 0x28
