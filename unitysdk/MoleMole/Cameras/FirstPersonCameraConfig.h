...
#define MOLEMOLE_CAMERAS_FIRSTPERSONCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1623AF70)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int FirstPersonCameraConfig_TypeDefinitionIndex = 63771;
