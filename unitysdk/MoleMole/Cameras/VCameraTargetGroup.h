...
#define MOLEMOLE_CAMERAS_VCAMERATARGETGROUP_ADDMEMBER_OFFSET UNITYSDK_OFFSET(0x167ECD70)
#define MOLEMOLE_CAMERAS_VCAMERATARGETGROUP_DOUPDATE_OFFSET UNITYSDK_OFFSET(0x167ED620)
#define MOLEMOLE_CAMERAS_VCAMERATARGETGROUP_FINDMEMBER_OFFSET UNITYSDK_OFFSET(0x167ED010)
#define MOLEMOLE_CAMERAS_VCAMERATARGETGROUP_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x167ED850)
#define MOLEMOLE_CAMERAS_VCAMERATARGETGROUP_GETVIEWSPACEANGULARBOUNDS_OFFSET UNITYSDK_OFFSET(0x167ED950)
#define MOLEMOLE_CAMERAS_VCAMERATARGETGROUP_GETVIEWSPACEBOUNDINGBOX_OFFSET UNITYSDK_OFFSET(0x167ED1E0)
#define MOLEMOLE_CAMERAS_VCAMERATARGETGROUP_GETWEIGHTEDBOUNDSFORMEMBER_OFFSET UNITYSDK_OFFSET(0x167ED110)
#define MOLEMOLE_CAMERAS_VCAMERATARGETGROUP_GET_BOUNDINGBOX_OFFSET UNITYSDK_OFFSET(0x167EC9A0)
#define MOLEMOLE_CAMERAS_VCAMERATARGETGROUP_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x167ECAC0)
#define MOLEMOLE_CAMERAS_VCAMERATARGETGROUP_GET_SPHERE_OFFSET UNITYSDK_OFFSET(0x167EC9C0)
#define MOLEMOLE_CAMERAS_VCAMERATARGETGROUP_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x167EC990)
#define MOLEMOLE_CAMERAS_VCAMERATARGETGROUP_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x167ED900)
#define MOLEMOLE_CAMERAS_VCAMERATARGETGROUP_METHOD_5_2987AC27B6C98151_OFFSET UNITYSDK_OFFSET(0x1A491480)
#define MOLEMOLE_CAMERAS_VCAMERATARGETGROUP_METHOD_5_580E7E6201D1B663_OFFSET UNITYSDK_OFFSET(0x1A491470)
#define MOLEMOLE_CAMERAS_VCAMERATARGETGROUP_METHOD_5_96A01D0549EAADF2_OFFSET UNITYSDK_OFFSET(0x1A4911B0)
#define MOLEMOLE_CAMERAS_VCAMERATARGETGROUP_METHOD_5_AE5BACADF1D7C804_OFFSET UNITYSDK_OFFSET(0x1A490DB0)
#define MOLEMOLE_CAMERAS_VCAMERATARGETGROUP_METHOD_5_E09F706651574B73_OFFSET UNITYSDK_OFFSET(0x1A491860)
#define MOLEMOLE_CAMERAS_VCAMERATARGETGROUP_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x167ED790)
#define MOLEMOLE_CAMERAS_VCAMERATARGETGROUP_REMOVEALLMEMBERS_OFFSET UNITYSDK_OFFSET(0x167ECEA0)
#define MOLEMOLE_CAMERAS_VCAMERATARGETGROUP_REMOVEMEMBER_OFFSET UNITYSDK_OFFSET(0x167ECF20)
#define MOLEMOLE_CAMERAS_VCAMERATARGETGROUP_SETMEMBERSRADIUS_OFFSET UNITYSDK_OFFSET(0x167ECCE0)
#define MOLEMOLE_CAMERAS_VCAMERATARGETGROUP_UPDATE_OFFSET UNITYSDK_OFFSET(0x167ED8A0)
#define MOLEMOLE_CAMERAS_VCAMERATARGETGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A490D30)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int VCameraTargetGroup_TypeDefinitionIndex = 62756;
