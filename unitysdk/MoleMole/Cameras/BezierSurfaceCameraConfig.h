...
#define MOLEMOLE_CAMERAS_BEZIERSURFACECAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x12400940)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int BezierSurfaceCameraConfig_TypeDefinitionIndex = 59717;
