...
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT_APPLYTOCAMERAS_OFFSET UNITYSDK_OFFSET(0x1100CA30)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT_CALCMAXELVANGLE_OFFSET UNITYSDK_OFFSET(0x1100B840)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT_GETENTITYCONFIGID_OFFSET UNITYSDK_OFFSET(0x1100BAE0)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT_GET_CURRENTELEANGLE_OFFSET UNITYSDK_OFFSET(0x1100B830)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT_ROTATE_OFFSET UNITYSDK_OFFSET(0x1100C820)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT_SETTLELAYOUT_OFFSET UNITYSDK_OFFSET(0x1100BDF0)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT_TRYGETAVALIABLEELEANGLE_OFFSET UNITYSDK_OFFSET(0x1100B8E0)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1100CD50)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT___BASE_SETTLELAYOUT_OFFSET UNITYSDK_OFFSET(0x1100CD70)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int VCameraSphericalAutoLayout_TypeDefinitionIndex = 57698;

	class VCameraSphericalAutoLayout : public ::MoleMole::Cameras::VCamerasBaseLayout
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::Cameras::VCameraOverrideLayoutParam*>* overrideParamDic; // 0x10
		::UnityEngine::AnimationCurve* maxElvAngleCurve; // 0x18
		::System::Single mmaxElvAngle; // 0x20
		::System::Single currentEleAngle; // 0x24
		::System::Boolean applyElvAngleCurve; // 0x28
		::System::Single initEleAngle; // 0x2C
		::System::Single mRadius; // 0x30
