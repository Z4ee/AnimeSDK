...
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT_APPLYTOCAMERAS_OFFSET UNITYSDK_OFFSET(0x13EC5000)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT_CALCMAXELVANGLE_OFFSET UNITYSDK_OFFSET(0x13EC3E10)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT_GETENTITYCONFIGID_OFFSET UNITYSDK_OFFSET(0x13EC40B0)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT_GET_CURRENTELEANGLE_OFFSET UNITYSDK_OFFSET(0x13EC3E00)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT_ROTATE_OFFSET UNITYSDK_OFFSET(0x13EC4DF0)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT_SETTLELAYOUT_OFFSET UNITYSDK_OFFSET(0x13EC43C0)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT_TRYGETAVALIABLEELEANGLE_OFFSET UNITYSDK_OFFSET(0x13EC3EB0)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x13EC5320)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT___BASE_SETTLELAYOUT_OFFSET UNITYSDK_OFFSET(0x13EC5340)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int VCameraSphericalAutoLayout_TypeDefinitionIndex = 78627;
	...
	public:
		...
		::System::Single initEleAngle; // 0x24
		::System::Boolean applyElvAngleCurve; // 0x28
		::System::Single mmaxElvAngle; // 0x2C
		::System::Single currentEleAngle; // 0x30
