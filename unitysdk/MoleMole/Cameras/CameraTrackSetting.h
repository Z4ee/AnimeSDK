...
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x17D26B80)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING_ISNEARLYEQUAL_OFFSET UNITYSDK_OFFSET(0x17D26630)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING_ISVALID_OFFSET UNITYSDK_OFFSET(0x17D25E20)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING_LERP_OFFSET UNITYSDK_OFFSET(0x17D25E90)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING__CCTOR_OFFSET UNITYSDK_OFFSET(0x17D26C40)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x17D26570)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING__ISNEARLYEQUAL_G__NEARLYEQUAL_7_0_OFFSET UNITYSDK_OFFSET(0x17D26B50)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING__LERP_G__LERP_6_0_OFFSET UNITYSDK_OFFSET(0x17D265D0)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int CameraTrackSetting_TypeDefinitionIndex = 43875;
	...
	public:
		...
		{
			return (::MoleMole::Cameras::CameraTrackSetting**)Il2CppClass::FromTypeDefinitionIndex(CameraTrackSetting_TypeDefinitionIndex)->GetStaticField(0x38600);
		}
