...
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x122DE900)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING_ISNEARLYEQUAL_OFFSET UNITYSDK_OFFSET(0x122DE3B0)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING_ISVALID_OFFSET UNITYSDK_OFFSET(0x122DDBA0)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING_LERP_OFFSET UNITYSDK_OFFSET(0x122DDC10)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING__CCTOR_OFFSET UNITYSDK_OFFSET(0x122DE9C0)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x122DE2F0)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING__ISNEARLYEQUAL_G__NEARLYEQUAL_7_0_OFFSET UNITYSDK_OFFSET(0x122DE8D0)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING__LERP_G__LERP_6_0_OFFSET UNITYSDK_OFFSET(0x122DE350)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int CameraTrackSetting_TypeDefinitionIndex = 80916;
	...
	public:
		...
		{
			return (::MoleMole::Cameras::CameraTrackSetting**)Il2CppClass::FromTypeDefinitionIndex(CameraTrackSetting_TypeDefinitionIndex)->GetStaticField(0x3C0F0);
		}
