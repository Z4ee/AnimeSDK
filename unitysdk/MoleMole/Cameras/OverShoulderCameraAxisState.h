...
#define MOLEMOLE_CAMERAS_OVERSHOULDERCAMERAAXISSTATE_GET_MCURRENTSPEED_OFFSET UNITYSDK_OFFSET(0x416EC0)
#define MOLEMOLE_CAMERAS_OVERSHOULDERCAMERAAXISSTATE_METHOD_2_7395EEBD9E4D21B1_OFFSET UNITYSDK_OFFSET(0x7C9030)
#define MOLEMOLE_CAMERAS_OVERSHOULDERCAMERAAXISSTATE_SET_MCURRENTSPEED_OFFSET UNITYSDK_OFFSET(0x5CC490)
#define MOLEMOLE_CAMERAS_OVERSHOULDERCAMERAAXISSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x7C9010)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int OverShoulderCameraAxisState_TypeDefinitionIndex = 81649;
