...
#define MOLEMOLE_CAMERAS_VNOISESETTINGS_GETCOMBINEDFILTERRESULTS_OFFSET UNITYSDK_OFFSET(0x12EE3150)
#define MOLEMOLE_CAMERAS_VNOISESETTINGS_GETSIGNAL_OFFSET UNITYSDK_OFFSET(0x12EE32E0)
#define MOLEMOLE_CAMERAS_VNOISESETTINGS_GET_SIGNALDURATION_OFFSET UNITYSDK_OFFSET(0x12EE32D0)
#define MOLEMOLE_CAMERAS_VNOISESETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x12EE3400)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int VNoiseSettings_TypeDefinitionIndex = 46013;
