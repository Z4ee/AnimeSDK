...
#define MOLEMOLE_CAMERAS_VNOISESETTINGS_GETCOMBINEDFILTERRESULTS_OFFSET UNITYSDK_OFFSET(0xF95E5A0)
#define MOLEMOLE_CAMERAS_VNOISESETTINGS_GETSIGNAL_OFFSET UNITYSDK_OFFSET(0xF95E730)
#define MOLEMOLE_CAMERAS_VNOISESETTINGS_GET_SIGNALDURATION_OFFSET UNITYSDK_OFFSET(0xF95E720)
#define MOLEMOLE_CAMERAS_VNOISESETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0xF95E860)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int VNoiseSettings_TypeDefinitionIndex = 70041;
