...
#define MOLEMOLE_CAMERAS_VARIABLECAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x12D12710)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int VariableCameraConfig_TypeDefinitionIndex = 47637;
