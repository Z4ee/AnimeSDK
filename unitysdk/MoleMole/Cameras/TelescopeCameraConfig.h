...
#define MOLEMOLE_CAMERAS_TELESCOPECAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x12CA8370)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int TelescopeCameraConfig_TypeDefinitionIndex = 48317;
