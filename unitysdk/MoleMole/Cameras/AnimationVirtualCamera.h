...
#define MOLEMOLE_CAMERAS_ANIMATIONVIRTUALCAMERA_BLENDCAMERAOVERRIDE_OFFSET UNITYSDK_OFFSET(0xF95CCA0)
#define MOLEMOLE_CAMERAS_ANIMATIONVIRTUALCAMERA_GET_STATE_OFFSET UNITYSDK_OFFSET(0xF95CC70)
#define MOLEMOLE_CAMERAS_ANIMATIONVIRTUALCAMERA_INTERNALUPDATECAMERASTATE_OFFSET UNITYSDK_OFFSET(0xF95CEE0)
#define MOLEMOLE_CAMERAS_ANIMATIONVIRTUALCAMERA_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0xF95CFF0)
#define MOLEMOLE_CAMERAS_ANIMATIONVIRTUALCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xF95D040)
#define MOLEMOLE_CAMERAS_ANIMATIONVIRTUALCAMERA___BASE_INTERNALUPDATECAMERASTATE_OFFSET UNITYSDK_OFFSET(0xF95D390)
#define MOLEMOLE_CAMERAS_ANIMATIONVIRTUALCAMERA___BASE_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0xF95D3C0)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int AnimationVirtualCamera_TypeDefinitionIndex = 68126;
