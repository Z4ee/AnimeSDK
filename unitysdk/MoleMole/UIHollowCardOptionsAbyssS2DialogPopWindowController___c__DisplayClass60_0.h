...
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS60_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17810DB0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS60_0__REFRESHINFOTASK_B__0_OFFSET UNITYSDK_OFFSET(0x17810DC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCardOptionsAbyssS2DialogPopWindowController___c__DisplayClass60_0_TypeDefinitionIndex = 58277;
