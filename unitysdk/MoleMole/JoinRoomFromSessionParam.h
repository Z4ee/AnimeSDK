...
#define MOLEMOLE_JOINROOMFROMSESSIONPARAM_METHOD_1_5D2407D2674205CA_OFFSET UNITYSDK_OFFSET(0x1908BDE0)
#define MOLEMOLE_JOINROOMFROMSESSIONPARAM_METHOD_1_A4F84CDC5C4AD200_OFFSET UNITYSDK_OFFSET(0x1908BC60)
#define MOLEMOLE_JOINROOMFROMSESSIONPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1908BC50)

namespace MoleMole
{
	inline static constexpr unsigned int JoinRoomFromSessionParam_TypeDefinitionIndex = 73009;
