...
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1936BE80)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x1936C7E0)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1936BF90)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1936BF10)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1936BB60)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1936BDC0)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER_REFRESHREDPOINTBYDATA_OFFSET UNITYSDK_OFFSET(0x1936CA50)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER_REFRESHREDPOINT_OFFSET UNITYSDK_OFFSET(0x1936CAA0)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER_SETBRANCHICON_OFFSET UNITYSDK_OFFSET(0x1936C600)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1936CC60)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1936CC70)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x1936CD00)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1936CD90)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1936CE30)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1936CEC0)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1936CF50)

namespace MoleMole
{
	inline static constexpr unsigned int UIBranchRelicWidgetController_TypeDefinitionIndex = 77255;
