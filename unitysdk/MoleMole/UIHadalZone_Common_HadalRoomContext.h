...
#define MOLEMOLE_UIHADALZONE_COMMON_HADALROOMCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18AF72B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_Common_HadalRoomContext_TypeDefinitionIndex = 43789;
	...
	public:
		...
		::Class_2_208CC9941471731A_462* activityBattleQuestCfg; // 0x30
		::System::Collections::Generic::List_1<::System::Int32>* cardIDList; // 0x38
		::Class_2_0A55B5A82A61DAFA_2* questCfg; // 0x40
		::Class_2_14E7CE92E8A3183F* abyssDungeonCfg; // 0x48
		::System::Boolean hideMonsterLevel; // 0x50
		::System::Int32 monsterLevel; // 0x54
		::MoleMole::UIMonsterCardInfoPopWindowController_ShowType showType; // 0x58
		::Enum_3_DB663931210BBC27_38 playType; // 0x5C
		::System::Int32 roomID; // 0x60
		::System::Int32 questID; // 0x64
		::System::Int32 GroupChallengeID; // 0x68
		::System::Int32 roomIndex; // 0x6C
