...
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER___C__DISPLAYCLASS23_0__CTOR_OFFSET UNITYSDK_OFFSET(0x199D8810)
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER___C__DISPLAYCLASS23_0___TRYRALLYNEXT_B__0_OFFSET UNITYSDK_OFFSET(0x199D8820)
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER___C__DISPLAYCLASS23_0___TRYRALLYNEXT_B__1_OFFSET UNITYSDK_OFFSET(0x199D8B00)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowResultPageController___c__DisplayClass23_0_TypeDefinitionIndex = 41926;
