...
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_BINDCLICK_OFFSET UNITYSDK_OFFSET(0x176CC970)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_GETLANGUAGENUMSTR_OFFSET UNITYSDK_OFFSET(0x176CE670)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_ONCLICKINFOICONBTN_OFFSET UNITYSDK_OFFSET(0x176CDEC0)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x176CC7C0)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x176CC8F0)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x176CC6F0)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x176CC750)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_REFRESHINFOICONBTN_OFFSET UNITYSDK_OFFSET(0x176CCB50)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_REFRESHNUM_1_OFFSET UNITYSDK_OFFSET(0x176CD3F0)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_REFRESHNUM_OFFSET UNITYSDK_OFFSET(0x176CD020)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_REFRESHRATINGICON_OFFSET UNITYSDK_OFFSET(0x176CD1C0)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_REFRESHSTYLISHNOHIT_OFFSET UNITYSDK_OFFSET(0x176CD930)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_REFRESHSTYLISHSKILL_OFFSET UNITYSDK_OFFSET(0x176CD600)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_REFRESHTITLE_OFFSET UNITYSDK_OFFSET(0x176CCBF0)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_REFRESHVIEW_1_OFFSET UNITYSDK_OFFSET(0x176CD310)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_REFRESHVIEW_2_OFFSET UNITYSDK_OFFSET(0x176CD550)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_REFRESHVIEW_3_OFFSET UNITYSDK_OFFSET(0x176CE2B0)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x176CC9F0)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_REPLACEINFOCONTENT_OFFSET UNITYSDK_OFFSET(0x176CE160)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x176CCAC0)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_SETNUMSTRCOLOR_OFFSET UNITYSDK_OFFSET(0x176CE5D0)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_SETNUMSTRPREFIX_OFFSET UNITYSDK_OFFSET(0x176CE4A0)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_SHOULDIGNORE_OFFSET UNITYSDK_OFFSET(0x176CE0C0)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x176CE730)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x176CEB50)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x176CEBE0)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x176CEC70)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x176CED00)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerTrickScoreRowWidgetController_TypeDefinitionIndex = 68184;
