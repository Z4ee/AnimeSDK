...
#define MOLEMOLE_UIGACHACOMMONBGWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19AB6CD0)
#define MOLEMOLE_UIGACHACOMMONBGWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19AB6D60)
#define MOLEMOLE_UIGACHACOMMONBGWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19AB6C00)
#define MOLEMOLE_UIGACHACOMMONBGWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19AB6C60)
#define MOLEMOLE_UIGACHACOMMONBGWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19AB6DE0)
#define MOLEMOLE_UIGACHACOMMONBGWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19AB6E40)
#define MOLEMOLE_UIGACHACOMMONBGWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19AB6ED0)
#define MOLEMOLE_UIGACHACOMMONBGWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19AB6F60)
#define MOLEMOLE_UIGACHACOMMONBGWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19AB6FF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaCommonBgWidgetController_TypeDefinitionIndex = 54697;

	class UIGachaCommonBgWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_60638234271CCDB8_78* _view; // 0x2C0
