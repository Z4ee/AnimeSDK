...
#define MOLEMOLE_UINPCBUBBLEPERFORM_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x174ECD50)
#define MOLEMOLE_UINPCBUBBLEPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x174ECD00)

namespace MoleMole
{
	inline static constexpr unsigned int UINpcBubblePerform_TypeDefinitionIndex = 71757;
