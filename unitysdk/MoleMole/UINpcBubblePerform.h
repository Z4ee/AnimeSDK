...
#define MOLEMOLE_UINPCBUBBLEPERFORM_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x15D62AE0)
#define MOLEMOLE_UINPCBUBBLEPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x15D62A90)

namespace MoleMole
{
	inline static constexpr unsigned int UINpcBubblePerform_TypeDefinitionIndex = 63590;
