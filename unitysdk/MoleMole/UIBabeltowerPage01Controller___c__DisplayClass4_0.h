...
#define MOLEMOLE_UIBABELTOWERPAGE01CONTROLLER___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17F47C70)
#define MOLEMOLE_UIBABELTOWERPAGE01CONTROLLER___C__DISPLAYCLASS4_0__ONPOSTREFRESHVIEW_B__0_OFFSET UNITYSDK_OFFSET(0x17F47C80)
#define MOLEMOLE_UIBABELTOWERPAGE01CONTROLLER___C__DISPLAYCLASS4_0__ONPOSTREFRESHVIEW_B__1_OFFSET UNITYSDK_OFFSET(0x17F47F90)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerPage01Controller___c__DisplayClass4_0_TypeDefinitionIndex = 69189;
