...
#define MOLEMOLE_MINDSCAPEAVATARENTRANCECFG__CTOR_OFFSET UNITYSDK_OFFSET(0x182F9AC0)

namespace MoleMole
{
	inline static constexpr unsigned int MindscapeAvatarEntranceCfg_TypeDefinitionIndex = 47798;
