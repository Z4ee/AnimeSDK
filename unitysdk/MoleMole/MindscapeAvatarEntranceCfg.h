...
#define MOLEMOLE_MINDSCAPEAVATARENTRANCECFG__CTOR_OFFSET UNITYSDK_OFFSET(0x199530C0)

namespace MoleMole
{
	inline static constexpr unsigned int MindscapeAvatarEntranceCfg_TypeDefinitionIndex = 90260;
