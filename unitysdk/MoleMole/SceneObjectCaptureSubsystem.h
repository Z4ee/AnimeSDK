...
#define MOLEMOLE_SCENEOBJECTCAPTURESUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x13ACFCC0)
#define MOLEMOLE_SCENEOBJECTCAPTURESUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x13ACFD20)
#define MOLEMOLE_SCENEOBJECTCAPTURESUBSYSTEM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x13ACFDA0)
#define MOLEMOLE_SCENEOBJECTCAPTURESUBSYSTEM_TRYGETCAPTUREDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x13ACFE00)
#define MOLEMOLE_SCENEOBJECTCAPTURESUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x13AD00F0)
#define MOLEMOLE_SCENEOBJECTCAPTURESUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x13AD0110)
#define MOLEMOLE_SCENEOBJECTCAPTURESUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x13AD01A0)
#define MOLEMOLE_SCENEOBJECTCAPTURESUBSYSTEM___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x13AD0230)

namespace MoleMole
{
	inline static constexpr unsigned int SceneObjectCaptureSubsystem_TypeDefinitionIndex = 73093;
