...
#define MOLEMOLE_PRELOADSINGLEGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1385D390)

namespace MoleMole
{
	inline static constexpr unsigned int PreloadSingleGroupConfig_TypeDefinitionIndex = 48491;
