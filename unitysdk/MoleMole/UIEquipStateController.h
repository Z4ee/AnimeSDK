...
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_GET_CURITEMDATA_OFFSET UNITYSDK_OFFSET(0x1697D760)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_HIDEBTNS_OFFSET UNITYSDK_OFFSET(0x1697A730)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1697D770)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_REALDELETE_OFFSET UNITYSDK_OFFSET(0x1697E2A0)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_REFRESHTOGGLESTATE_OFFSET UNITYSDK_OFFSET(0x1697E6C0)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_SETITEMDATA_OFFSET UNITYSDK_OFFSET(0x1697A6C0)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_SETONITEMDATANULLHIDEBTNS_OFFSET UNITYSDK_OFFSET(0x1697E670)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_TOGGLEDELETE_OFFSET UNITYSDK_OFFSET(0x1697DF40)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_TOGGLELOCK_OFFSET UNITYSDK_OFFSET(0x1697DAD0)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_TRIGGERTOGGLEAUDIO_OFFSET UNITYSDK_OFFSET(0x1697E470)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1697FEB0)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1697FF60)

namespace MoleMole
{
	inline static constexpr unsigned int UIEquipStateController_TypeDefinitionIndex = 67836;
