...
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_GET_CURITEMDATA_OFFSET UNITYSDK_OFFSET(0x16F14650)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_HIDEBTNS_OFFSET UNITYSDK_OFFSET(0x16F11670)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x16F14660)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_REALDELETE_OFFSET UNITYSDK_OFFSET(0x16F15180)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_REFRESHTOGGLESTATE_OFFSET UNITYSDK_OFFSET(0x16F155A0)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_SETITEMDATA_OFFSET UNITYSDK_OFFSET(0x16F11600)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_SETONITEMDATANULLHIDEBTNS_OFFSET UNITYSDK_OFFSET(0x16F15550)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_TOGGLEDELETE_OFFSET UNITYSDK_OFFSET(0x16F14E20)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_TOGGLELOCK_OFFSET UNITYSDK_OFFSET(0x16F149C0)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_TRIGGERTOGGLEAUDIO_OFFSET UNITYSDK_OFFSET(0x16F15350)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16F16E10)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x16F16EC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIEquipStateController_TypeDefinitionIndex = 46190;
