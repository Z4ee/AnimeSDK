...
#define MOLEMOLE_SCROLLVIEWITEMWIDGETCONTROLLER_GETITEMSIZEATAXIS_OFFSET UNITYSDK_OFFSET(0x160EB240)
#define MOLEMOLE_SCROLLVIEWITEMWIDGETCONTROLLER_GET_CURDATAINDEX_OFFSET UNITYSDK_OFFSET(0x160EB100)
#define MOLEMOLE_SCROLLVIEWITEMWIDGETCONTROLLER_GET_DESTROYGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x160EB230)
#define MOLEMOLE_SCROLLVIEWITEMWIDGETCONTROLLER_GET_ISINPOOL_OFFSET UNITYSDK_OFFSET(0x160EB120)
#define MOLEMOLE_SCROLLVIEWITEMWIDGETCONTROLLER_GET_ISSELECT_OFFSET UNITYSDK_OFFSET(0x160EB140)
#define MOLEMOLE_SCROLLVIEWITEMWIDGETCONTROLLER_MOLEMOLE_IMONOUISCROLLVIEWITEM_SETSELECTFORCE_OFFSET UNITYSDK_OFFSET(0x160EB8E0)
#define MOLEMOLE_SCROLLVIEWITEMWIDGETCONTROLLER_MOLEMOLE_IMONOUISCROLLVIEWITEM_SETSELECT_OFFSET UNITYSDK_OFFSET(0x160EB6E0)
#define MOLEMOLE_SCROLLVIEWITEMWIDGETCONTROLLER_ONAFTERSETSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x160EB520)
#define MOLEMOLE_SCROLLVIEWITEMWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x160EB560)
#define MOLEMOLE_SCROLLVIEWITEMWIDGETCONTROLLER_ONFADEINFINISH_OFFSET UNITYSDK_OFFSET(0x160EBE60)
#define MOLEMOLE_SCROLLVIEWITEMWIDGETCONTROLLER_ONITEMRESELECT_OFFSET UNITYSDK_OFFSET(0x160EBA70)
#define MOLEMOLE_SCROLLVIEWITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x160EBA20)
#define MOLEMOLE_SCROLLVIEWITEMWIDGETCONTROLLER_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0x160EB440)
#define MOLEMOLE_SCROLLVIEWITEMWIDGETCONTROLLER_ONSCROLLITEMREUSE_OFFSET UNITYSDK_OFFSET(0x160EB400)
#define MOLEMOLE_SCROLLVIEWITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x160EB280)
#define MOLEMOLE_SCROLLVIEWITEMWIDGETCONTROLLER_ONSCROLLVIEWITEMMOVE_OFFSET UNITYSDK_OFFSET(0x160EB480)
#define MOLEMOLE_SCROLLVIEWITEMWIDGETCONTROLLER_PLAYFADEANIM_OFFSET UNITYSDK_OFFSET(0x160EBAB0)
#define MOLEMOLE_SCROLLVIEWITEMWIDGETCONTROLLER_SCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0x160EB370)
#define MOLEMOLE_SCROLLVIEWITEMWIDGETCONTROLLER_SCROLLITEMREUSE_OFFSET UNITYSDK_OFFSET(0x160EB2E0)
#define MOLEMOLE_SCROLLVIEWITEMWIDGETCONTROLLER_SETSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x160EB4C0)
#define MOLEMOLE_SCROLLVIEWITEMWIDGETCONTROLLER_SET_CURDATAINDEX_OFFSET UNITYSDK_OFFSET(0x160EB110)
#define MOLEMOLE_SCROLLVIEWITEMWIDGETCONTROLLER_SET_ISINPOOL_OFFSET UNITYSDK_OFFSET(0x160EB130)
#define MOLEMOLE_SCROLLVIEWITEMWIDGETCONTROLLER_STOPFADEANIM_OFFSET UNITYSDK_OFFSET(0x160EBDE0)
#define MOLEMOLE_SCROLLVIEWITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x160EBEA0)

namespace MoleMole
{
	inline static constexpr unsigned int ScrollViewItemWidgetController_TypeDefinitionIndex = 84483;

	class ScrollViewItemWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::System::Int32 _CurDataIndex_k__BackingField; // 0x2C0
