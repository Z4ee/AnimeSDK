...
#define MOLEMOLE_UIACTIVITYDETECTIVEFMPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18BC74F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityDetectiveFMPopWindowController_Context_TypeDefinitionIndex = 76635;
