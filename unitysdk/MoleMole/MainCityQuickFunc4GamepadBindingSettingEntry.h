...
#define MOLEMOLE_MAINCITYQUICKFUNC4GAMEPADBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x13EFA9A0)
#define MOLEMOLE_MAINCITYQUICKFUNC4GAMEPADBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x13EFA9B0)
#define MOLEMOLE_MAINCITYQUICKFUNC4GAMEPADBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x13EFA9C0)

namespace MoleMole
{
	inline static constexpr unsigned int MainCityQuickFunc4GamepadBindingSettingEntry_TypeDefinitionIndex = 83811;
