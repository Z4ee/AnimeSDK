...
#define MOLEMOLE_UIMATERIALANIMATION_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x147BFED0)
#define MOLEMOLE_UIMATERIALANIMATION_METHOD_5_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x147BFDD0)
#define MOLEMOLE_UIMATERIALANIMATION_METHOD_5_3D32A8D32FBB901A_OFFSET UNITYSDK_OFFSET(0x147C0400)
#define MOLEMOLE_UIMATERIALANIMATION_METHOD_5_78037B64B814568E_OFFSET UNITYSDK_OFFSET(0x147BF8E0)
#define MOLEMOLE_UIMATERIALANIMATION_METHOD_5_D7852DE078ACC1F1_OFFSET UNITYSDK_OFFSET(0x147C0830)
#define MOLEMOLE_UIMATERIALANIMATION_METHOD_5_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0x147C01C0)
#define MOLEMOLE_UIMATERIALANIMATION_PLAYDEFAULTBYLOADMATERIAL_OFFSET UNITYSDK_OFFSET(0x147BF4C0)
#define MOLEMOLE_UIMATERIALANIMATION_PLAYUIMATANIBYLOAD_OFFSET UNITYSDK_OFFSET(0x147BF530)
#define MOLEMOLE_UIMATERIALANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x147C06F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMaterialAnimation_TypeDefinitionIndex = 80296;
