...
#define MOLEMOLE_UILEVEL_HADALRESULT_POPWINDOWCONTROLLER_ACQUIRETITLETEXT_OFFSET UNITYSDK_OFFSET(0x17446B00)
#define MOLEMOLE_UILEVEL_HADALRESULT_POPWINDOWCONTROLLER_GETBUTTONCOMBINESTATE_OFFSET UNITYSDK_OFFSET(0x17446950)
#define MOLEMOLE_UILEVEL_HADALRESULT_POPWINDOWCONTROLLER_GETPANELSTATE_OFFSET UNITYSDK_OFFSET(0x17446AB0)
#define MOLEMOLE_UILEVEL_HADALRESULT_POPWINDOWCONTROLLER_ONPOPSHOWED_OFFSET UNITYSDK_OFFSET(0x174472C0)
#define MOLEMOLE_UILEVEL_HADALRESULT_POPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17447BF0)
#define MOLEMOLE_UILEVEL_HADALRESULT_POPWINDOWCONTROLLER__FILLCUSTOMRANKING_OFFSET UNITYSDK_OFFSET(0x17446C20)
#define MOLEMOLE_UILEVEL_HADALRESULT_POPWINDOWCONTROLLER__HADALRATINGTORATING_OFFSET UNITYSDK_OFFSET(0x17446BC0)
#define MOLEMOLE_UILEVEL_HADALRESULT_POPWINDOWCONTROLLER__ON_CUSTOMUI_DELAY_MESSAGE_OFFSET UNITYSDK_OFFSET(0x17447050)
#define MOLEMOLE_UILEVEL_HADALRESULT_POPWINDOWCONTROLLER___BASE__ON_CUSTOMUI_DELAY_MESSAGE_OFFSET UNITYSDK_OFFSET(0x17447C80)
#define MOLEMOLE_UILEVEL_HADALRESULT_POPWINDOWCONTROLLER___FILLCUSTOMRANKING_G____RANKING_7_0_OFFSET UNITYSDK_OFFSET(0x17446CD0)

namespace MoleMole
{
	inline static constexpr unsigned int UILevel_HadalResult_PopWindowController_TypeDefinitionIndex = 80295;
	...
	public:
		...
		{
			return ((::Class_1_451601B8BB62C38C_Enum_3_F05C56E76E4AE95C(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UILEVEL_HADALRESULT_POPWINDOWCONTROLLER_GETPANELSTATE_OFFSET))(this);
		}
		...
		::MoleMole::Level::RatingType _HadalRatingToRating(::Enum_3_4608E37A1B3D374A_12 hadalRatingType)
		{
			return ((::MoleMole::Level::RatingType(*)(::PVOID, ::Enum_3_4608E37A1B3D374A_12))((::PBYTE)hIl2Cpp + MOLEMOLE_UILEVEL_HADALRESULT_POPWINDOWCONTROLLER__HADALRATINGTORATING_OFFSET))(this, hadalRatingType);
		}
