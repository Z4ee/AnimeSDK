...
#define MOLEMOLE_UILEVEL_HADALRESULT_POPWINDOWCONTROLLER_ACQUIRETITLETEXT_OFFSET UNITYSDK_OFFSET(0x15D46B30)
#define MOLEMOLE_UILEVEL_HADALRESULT_POPWINDOWCONTROLLER_GETBUTTONCOMBINESTATE_OFFSET UNITYSDK_OFFSET(0x15D46980)
#define MOLEMOLE_UILEVEL_HADALRESULT_POPWINDOWCONTROLLER_GETPANELSTATE_OFFSET UNITYSDK_OFFSET(0x15D46AE0)
#define MOLEMOLE_UILEVEL_HADALRESULT_POPWINDOWCONTROLLER_ONPOPSHOWED_OFFSET UNITYSDK_OFFSET(0x15D472B0)
#define MOLEMOLE_UILEVEL_HADALRESULT_POPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15D47BD0)
#define MOLEMOLE_UILEVEL_HADALRESULT_POPWINDOWCONTROLLER__FILLCUSTOMRANKING_OFFSET UNITYSDK_OFFSET(0x15D46C50)
#define MOLEMOLE_UILEVEL_HADALRESULT_POPWINDOWCONTROLLER__HADALRATINGTORATING_OFFSET UNITYSDK_OFFSET(0x15D46BF0)
#define MOLEMOLE_UILEVEL_HADALRESULT_POPWINDOWCONTROLLER__ON_CUSTOMUI_DELAY_MESSAGE_OFFSET UNITYSDK_OFFSET(0x15D47040)
#define MOLEMOLE_UILEVEL_HADALRESULT_POPWINDOWCONTROLLER___BASE__ON_CUSTOMUI_DELAY_MESSAGE_OFFSET UNITYSDK_OFFSET(0x15D47C60)
#define MOLEMOLE_UILEVEL_HADALRESULT_POPWINDOWCONTROLLER___FILLCUSTOMRANKING_G____RANKING_7_0_OFFSET UNITYSDK_OFFSET(0x15D46D00)

namespace MoleMole
{
	inline static constexpr unsigned int UILevel_HadalResult_PopWindowController_TypeDefinitionIndex = 60182;
	...
	public:
		...
		::System::Collections::Generic::List_1<::MoleMole::UIHadalZoneLayer_RankingRowWidgetController*>* _rankingRowWidgets; // 0x378
		::Class_2_468A4FBF2E9F527C* _hadalZoneModel; // 0x380
		...
		{
			return ((::Class_1_451601B8BB62C38C_Enum_3_3DCE6AAF7E47B319(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UILEVEL_HADALRESULT_POPWINDOWCONTROLLER_GETBUTTONCOMBINESTATE_OFFSET))(this);
		}

		::Class_1_451601B8BB62C38C_Enum_3_A188519F532ACB95 GetPanelState()
		{
			return ((::Class_1_451601B8BB62C38C_Enum_3_A188519F532ACB95(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UILEVEL_HADALRESULT_POPWINDOWCONTROLLER_GETPANELSTATE_OFFSET))(this);
		}
		...
		::MoleMole::Level::RatingType _HadalRatingToRating(::Enum_3_4608E37A1B3D374A_15 hadalRatingType)
		{
			return ((::MoleMole::Level::RatingType(*)(::PVOID, ::Enum_3_4608E37A1B3D374A_15))((::PBYTE)hIl2Cpp + MOLEMOLE_UILEVEL_HADALRESULT_POPWINDOWCONTROLLER__HADALRATINGTORATING_OFFSET))(this, hadalRatingType);
		}
