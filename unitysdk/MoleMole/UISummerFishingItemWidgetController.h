...
#define MOLEMOLE_UISUMMERFISHINGITEMWIDGETCONTROLLER_GETCURFISHDATA_OFFSET UNITYSDK_OFFSET(0x19145340)
#define MOLEMOLE_UISUMMERFISHINGITEMWIDGETCONTROLLER_GET_ISSELECTED_OFFSET UNITYSDK_OFFSET(0x19145300)
#define MOLEMOLE_UISUMMERFISHINGITEMWIDGETCONTROLLER_GET_ISSELLSELECTED_OFFSET UNITYSDK_OFFSET(0x19145320)
#define MOLEMOLE_UISUMMERFISHINGITEMWIDGETCONTROLLER_GET__ISLOCKED_OFFSET UNITYSDK_OFFSET(0x191451A0)
#define MOLEMOLE_UISUMMERFISHINGITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x191447A0)
#define MOLEMOLE_UISUMMERFISHINGITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x191448B0)
#define MOLEMOLE_UISUMMERFISHINGITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19144830)
#define MOLEMOLE_UISUMMERFISHINGITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19144500)
#define MOLEMOLE_UISUMMERFISHINGITEMWIDGETCONTROLLER_REFRESHICONVIEW_OFFSET UNITYSDK_OFFSET(0x19144E20)
#define MOLEMOLE_UISUMMERFISHINGITEMWIDGETCONTROLLER_REFRESHLOCKEDVIEW_OFFSET UNITYSDK_OFFSET(0x19145020)
#define MOLEMOLE_UISUMMERFISHINGITEMWIDGETCONTROLLER_REFRESHNEWVIEW_1_OFFSET UNITYSDK_OFFSET(0x19145210)
#define MOLEMOLE_UISUMMERFISHINGITEMWIDGETCONTROLLER_REFRESHNEWVIEW_OFFSET UNITYSDK_OFFSET(0x19144CF0)
#define MOLEMOLE_UISUMMERFISHINGITEMWIDGETCONTROLLER_REFRESHSELECTEDVIEW_OFFSET UNITYSDK_OFFSET(0x191450E0)
#define MOLEMOLE_UISUMMERFISHINGITEMWIDGETCONTROLLER_REFRESHSTARVIEW_OFFSET UNITYSDK_OFFSET(0x19144DB0)
#define MOLEMOLE_UISUMMERFISHINGITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x19144B00)
#define MOLEMOLE_UISUMMERFISHINGITEMWIDGETCONTROLLER_SET_ISSELECTED_OFFSET UNITYSDK_OFFSET(0x19145310)
#define MOLEMOLE_UISUMMERFISHINGITEMWIDGETCONTROLLER_SET_ISSELLSELECTED_OFFSET UNITYSDK_OFFSET(0x19145330)
#define MOLEMOLE_UISUMMERFISHINGITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19145390)
#define MOLEMOLE_UISUMMERFISHINGITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x191453A0)
#define MOLEMOLE_UISUMMERFISHINGITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x19145430)
#define MOLEMOLE_UISUMMERFISHINGITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x191454D0)
#define MOLEMOLE_UISUMMERFISHINGITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19145560)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerFishingItemWidgetController_TypeDefinitionIndex = 69411;

	class UISummerFishingItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_60638234271CCDB8_136* _view; // 0x2F0
