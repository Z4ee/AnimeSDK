...
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS68_1__CTOR_OFFSET UNITYSDK_OFFSET(0x19DC6290)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS68_1__PLAYSWITCHSCENENODE_INNER_B__10_OFFSET UNITYSDK_OFFSET(0x19DF26D0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS68_1__PLAYSWITCHSCENENODE_INNER_B__9_OFFSET UNITYSDK_OFFSET(0x19DF2300)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgamePageController___c__DisplayClass68_1_TypeDefinitionIndex = 54887;

	class UIGalgamePageController___c__DisplayClass68_1 : public ::System::Object
	{
	public:
		::System::String* talkText; // 0x10
		::Class_2_A98F487E59440D0B* textNode; // 0x18
		::MoleMole::UIGalgamePageController___c__DisplayClass68_0* CS___8__locals1; // 0x20
