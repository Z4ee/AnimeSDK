...
#define MOLEMOLE_UICINEMADATEPLAYWIDGETCONTROLLER__PLAYSWITCHFAVOURLEVELIMAGE_D__21_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x87F770)
#define MOLEMOLE_UICINEMADATEPLAYWIDGETCONTROLLER__PLAYSWITCHFAVOURLEVELIMAGE_D__21_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaDatePlayWidgetController__PlaySwitchFavourLevelImage_d__21_TypeDefinitionIndex = 66832;
	...
	struct alignas(8) UICinemaDatePlayWidgetController__PlaySwitchFavourLevelImage_d__21
	{
		...
		::Class_2_D0F43E2E93E0D88C_Class_2_2CB68109B13467D8_1* _progressView_5__2; // 0x38
		::System::Threading::CancellationTokenSource* tokenSource; // 0x40
