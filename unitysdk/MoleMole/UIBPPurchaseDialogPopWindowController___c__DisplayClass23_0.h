...
#define MOLEMOLE_UIBPPURCHASEDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS23_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17E604E0)
#define MOLEMOLE_UIBPPURCHASEDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS23_0__SHOWNONEPURCHASEBPSHOP_B__0_OFFSET UNITYSDK_OFFSET(0x17E604F0)
#define MOLEMOLE_UIBPPURCHASEDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS23_0__SHOWNONEPURCHASEBPSHOP_B__1_OFFSET UNITYSDK_OFFSET(0x17E605B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBPPurchaseDialogPopWindowController___c__DisplayClass23_0_TypeDefinitionIndex = 46368;
	...
	public:
		...
		::Class_1_D12E4BF61CBE42EF* luxuryItem; // 0x20
		::MoleMole::UIBPPurchaseDialogPopWindowController* __4__this; // 0x28
