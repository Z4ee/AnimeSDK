...
#define MOLEMOLE_MECHBOOITEMDIALOGCONTEXTV1_GETPARTBUILDLIST_OFFSET UNITYSDK_OFFSET(0x107FC280)
#define MOLEMOLE_MECHBOOITEMDIALOGCONTEXTV1_ISVALIDTEMPLATE_OFFSET UNITYSDK_OFFSET(0x107FC210)
#define MOLEMOLE_MECHBOOITEMDIALOGCONTEXTV1_OVERRIDETABTITLE_OFFSET UNITYSDK_OFFSET(0x107FC1C0)
#define MOLEMOLE_MECHBOOITEMDIALOGCONTEXTV1__CTOR_OFFSET UNITYSDK_OFFSET(0x107FC6A0)
#define MOLEMOLE_MECHBOOITEMDIALOGCONTEXTV1___BASE_ISVALIDTEMPLATE_OFFSET UNITYSDK_OFFSET(0x107FC6F0)

namespace MoleMole
{
	inline static constexpr unsigned int MechBooItemDialogContextV1_TypeDefinitionIndex = 78663;
