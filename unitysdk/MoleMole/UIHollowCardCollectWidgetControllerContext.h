...
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x190E7560)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCardCollectWidgetControllerContext_TypeDefinitionIndex = 79370;
