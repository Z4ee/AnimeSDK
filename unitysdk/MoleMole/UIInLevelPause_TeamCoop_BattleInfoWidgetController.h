...
#define MOLEMOLE_UIINLEVELPAUSE_TEAMCOOP_BATTLEINFOWIDGETCONTROLLER_GETBINDMODULES_OFFSET UNITYSDK_OFFSET(0x1469C940)
#define MOLEMOLE_UIINLEVELPAUSE_TEAMCOOP_BATTLEINFOWIDGETCONTROLLER_GETNESTEDLISTDELEGATEGOLIST_OFFSET UNITYSDK_OFFSET(0x1469CCD0)
#define MOLEMOLE_UIINLEVELPAUSE_TEAMCOOP_BATTLEINFOWIDGETCONTROLLER_REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0x1469C380)
#define MOLEMOLE_UIINLEVELPAUSE_TEAMCOOP_BATTLEINFOWIDGETCONTROLLER_REFRESHSCOREINFO_OFFSET UNITYSDK_OFFSET(0x1469C3F0)
#define MOLEMOLE_UIINLEVELPAUSE_TEAMCOOP_BATTLEINFOWIDGETCONTROLLER_REFRESHTRICK_OFFSET UNITYSDK_OFFSET(0x1469C830)
#define MOLEMOLE_UIINLEVELPAUSE_TEAMCOOP_BATTLEINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1469D1E0)
#define MOLEMOLE_UIINLEVELPAUSE_TEAMCOOP_BATTLEINFOWIDGETCONTROLLER___BASE_GETBINDMODULES_OFFSET UNITYSDK_OFFSET(0x1469D1F0)
#define MOLEMOLE_UIINLEVELPAUSE_TEAMCOOP_BATTLEINFOWIDGETCONTROLLER___BASE_GETNESTEDLISTDELEGATEGOLIST_OFFSET UNITYSDK_OFFSET(0x1469D280)
#define MOLEMOLE_UIINLEVELPAUSE_TEAMCOOP_BATTLEINFOWIDGETCONTROLLER___BASE_REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0x1469D310)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPause_TeamCoop_BattleInfoWidgetController_TypeDefinitionIndex = 51279;
	...
	{
	public:
		::MoleMole::UIActivityTrickPauseWidgetController* _scoreInfoWidgetController; // 0x2F0
