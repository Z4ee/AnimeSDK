...
#define MOLEMOLE_UIINLEVELPAUSE_TEAMCOOP_BATTLEINFOWIDGETCONTROLLER_GETBINDMODULES_OFFSET UNITYSDK_OFFSET(0x146B0660)
#define MOLEMOLE_UIINLEVELPAUSE_TEAMCOOP_BATTLEINFOWIDGETCONTROLLER_GETNESTEDLISTDELEGATEGOLIST_OFFSET UNITYSDK_OFFSET(0x146B09F0)
#define MOLEMOLE_UIINLEVELPAUSE_TEAMCOOP_BATTLEINFOWIDGETCONTROLLER_REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0x146B0050)
#define MOLEMOLE_UIINLEVELPAUSE_TEAMCOOP_BATTLEINFOWIDGETCONTROLLER_REFRESHSCOREINFO_OFFSET UNITYSDK_OFFSET(0x146B00C0)
#define MOLEMOLE_UIINLEVELPAUSE_TEAMCOOP_BATTLEINFOWIDGETCONTROLLER_REFRESHTRICK_OFFSET UNITYSDK_OFFSET(0x146B0560)
#define MOLEMOLE_UIINLEVELPAUSE_TEAMCOOP_BATTLEINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x146B0F10)
#define MOLEMOLE_UIINLEVELPAUSE_TEAMCOOP_BATTLEINFOWIDGETCONTROLLER___BASE_GETBINDMODULES_OFFSET UNITYSDK_OFFSET(0x146B0F20)
#define MOLEMOLE_UIINLEVELPAUSE_TEAMCOOP_BATTLEINFOWIDGETCONTROLLER___BASE_GETNESTEDLISTDELEGATEGOLIST_OFFSET UNITYSDK_OFFSET(0x146B0FB0)
#define MOLEMOLE_UIINLEVELPAUSE_TEAMCOOP_BATTLEINFOWIDGETCONTROLLER___BASE_REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0x146B1040)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPause_TeamCoop_BattleInfoWidgetController_TypeDefinitionIndex = 73512;
