...
#define MOLEMOLE_UIONTRANSFORMCHILDRENCHANGEDHANDLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x13012790)
#define MOLEMOLE_UIONTRANSFORMCHILDRENCHANGEDHANDLER_ONTRANSFORMCHILDRENCHANGED_OFFSET UNITYSDK_OFFSET(0x13012710)
#define MOLEMOLE_UIONTRANSFORMCHILDRENCHANGEDHANDLER_REGISTERONTRANSFORMCHILDRENCHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x130126C0)
#define MOLEMOLE_UIONTRANSFORMCHILDRENCHANGEDHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x130127E0)
#define MOLEMOLE_UIONTRANSFORMCHILDRENCHANGEDHANDLER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x13012830)

namespace MoleMole
{
	inline static constexpr unsigned int UIOnTransformChildrenChangedHandler_TypeDefinitionIndex = 44563;
