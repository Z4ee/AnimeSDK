...
#define MOLEMOLE_UIONTRANSFORMCHILDRENCHANGEDHANDLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x186808A0)
#define MOLEMOLE_UIONTRANSFORMCHILDRENCHANGEDHANDLER_ONTRANSFORMCHILDRENCHANGED_OFFSET UNITYSDK_OFFSET(0x18680820)
#define MOLEMOLE_UIONTRANSFORMCHILDRENCHANGEDHANDLER_REGISTERONTRANSFORMCHILDRENCHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x186807D0)
#define MOLEMOLE_UIONTRANSFORMCHILDRENCHANGEDHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x186808F0)
#define MOLEMOLE_UIONTRANSFORMCHILDRENCHANGEDHANDLER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18680940)

namespace MoleMole
{
	inline static constexpr unsigned int UIOnTransformChildrenChangedHandler_TypeDefinitionIndex = 71730;
