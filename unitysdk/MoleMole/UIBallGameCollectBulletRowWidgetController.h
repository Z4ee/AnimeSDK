...
#define MOLEMOLE_UIBALLGAMECOLLECTBULLETROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17094510)
#define MOLEMOLE_UIBALLGAMECOLLECTBULLETROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17094580)
#define MOLEMOLE_UIBALLGAMECOLLECTBULLETROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x17094AD0)
#define MOLEMOLE_UIBALLGAMECOLLECTBULLETROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17094710)
#define MOLEMOLE_UIBALLGAMECOLLECTBULLETROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17094B80)
#define MOLEMOLE_UIBALLGAMECOLLECTBULLETROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17094B90)
#define MOLEMOLE_UIBALLGAMECOLLECTBULLETROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x17094C30)
#define MOLEMOLE_UIBALLGAMECOLLECTBULLETROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17094CC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBallGameCollectBulletRowWidgetController_TypeDefinitionIndex = 43521;
	...
	public:
		...
		{
			return ((::Class_2_A6272C10C4E9B18E*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBALLGAMECOLLECTBULLETROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
