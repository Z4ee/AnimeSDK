...
#define MOLEMOLE_TAROTCARDINITDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16891320)

namespace MoleMole
{
	inline static constexpr unsigned int TarotCardInitData_TypeDefinitionIndex = 54231;
