...
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15217950)

namespace MoleMole
{
	inline static constexpr unsigned int UIAreaShopPageController_Context_TypeDefinitionIndex = 72935;
