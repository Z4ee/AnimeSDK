...
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x14E52590)

namespace MoleMole
{
	inline static constexpr unsigned int UIAreaShopPageController_Context_TypeDefinitionIndex = 75406;
