...
#define MOLEMOLE_UISELECTFRIENDLISTPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1616D4D0)
#define MOLEMOLE_UISELECTFRIENDLISTPOPWINDOWCONTROLLER_ONCLICKSENDMSGBTN_OFFSET UNITYSDK_OFFSET(0x1616D810)
#define MOLEMOLE_UISELECTFRIENDLISTPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1616D8F0)
#define MOLEMOLE_UISELECTFRIENDLISTPOPWINDOWCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x1616D9F0)
#define MOLEMOLE_UISELECTFRIENDLISTPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1616D980)
#define MOLEMOLE_UISELECTFRIENDLISTPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1616D4E0)
#define MOLEMOLE_UISELECTFRIENDLISTPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1616D600)
#define MOLEMOLE_UISELECTFRIENDLISTPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1616DA90)
#define MOLEMOLE_UISELECTFRIENDLISTPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1616DAA0)
#define MOLEMOLE_UISELECTFRIENDLISTPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x1616DB30)
#define MOLEMOLE_UISELECTFRIENDLISTPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1616DBC0)
#define MOLEMOLE_UISELECTFRIENDLISTPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1616DBD0)
#define MOLEMOLE_UISELECTFRIENDLISTPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1616DBE0)

namespace MoleMole
{
	inline static constexpr unsigned int UISelectFriendListPopWindowController_TypeDefinitionIndex = 54116;
