...
#define MOLEMOLE_CONFIGCHESSENTITYMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x158CB410)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigChessEntityMap_TypeDefinitionIndex = 74111;
