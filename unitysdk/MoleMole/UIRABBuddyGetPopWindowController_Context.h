...
#define MOLEMOLE_UIRABBUDDYGETPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1717E4D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABBuddyGetPopWindowController_Context_TypeDefinitionIndex = 79356;
