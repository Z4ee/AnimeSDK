...
#define MOLEMOLE_UIPHOTOTASKROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1529F6D0)
#define MOLEMOLE_UIPHOTOTASKROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1529F8C0)
#define MOLEMOLE_UIPHOTOTASKROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1529F760)
#define MOLEMOLE_UIPHOTOTASKROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1529F840)
#define MOLEMOLE_UIPHOTOTASKROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1529F670)
#define MOLEMOLE_UIPHOTOTASKROWWIDGETCONTROLLER_SETSHOWBG_OFFSET UNITYSDK_OFFSET(0x1529FB70)
#define MOLEMOLE_UIPHOTOTASKROWWIDGETCONTROLLER_SHOWRECORD_OFFSET UNITYSDK_OFFSET(0x1529FA00)
#define MOLEMOLE_UIPHOTOTASKROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1529FBE0)
#define MOLEMOLE_UIPHOTOTASKROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1529FBF0)
#define MOLEMOLE_UIPHOTOTASKROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1529FC80)
#define MOLEMOLE_UIPHOTOTASKROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1529FD20)
#define MOLEMOLE_UIPHOTOTASKROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1529FDC0)
#define MOLEMOLE_UIPHOTOTASKROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1529FE50)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoTaskRowWidgetController_TypeDefinitionIndex = 45878;

	class UIPhotoTaskRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_E17D44E1D4CD83D1_1* _view; // 0x2F0
