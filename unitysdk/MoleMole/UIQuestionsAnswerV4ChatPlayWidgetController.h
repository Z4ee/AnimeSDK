...
#define MOLEMOLE_UIQUESTIONSANSWERV4CHATPLAYWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12E163D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerV4ChatPlayWidgetController_TypeDefinitionIndex = 66179;
