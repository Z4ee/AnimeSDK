...
#define MOLEMOLE_COMMANDLINEMIRRORREFLECTION_METHOD_2_2362E43632123EB3_OFFSET UNITYSDK_OFFSET(0x10CE5EF0)
#define MOLEMOLE_COMMANDLINEMIRRORREFLECTION_METHOD_2_95F4C07DAEF4C457_OFFSET UNITYSDK_OFFSET(0x10CE6040)
#define MOLEMOLE_COMMANDLINEMIRRORREFLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x10CE6000)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineMirrorReflection_TypeDefinitionIndex = 62418;
