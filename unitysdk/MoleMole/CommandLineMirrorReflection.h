...
#define MOLEMOLE_COMMANDLINEMIRRORREFLECTION_METHOD_2_2362E43632123EB3_OFFSET UNITYSDK_OFFSET(0x116E0D10)
#define MOLEMOLE_COMMANDLINEMIRRORREFLECTION_METHOD_2_95F4C07DAEF4C457_OFFSET UNITYSDK_OFFSET(0x116E0E60)
#define MOLEMOLE_COMMANDLINEMIRRORREFLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x116E0E20)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineMirrorReflection_TypeDefinitionIndex = 56635;
