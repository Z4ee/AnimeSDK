...
#define MOLEMOLE_BABELTOWERRANKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x134C81A0)

namespace MoleMole
{
	inline static constexpr unsigned int BabelTowerRankConfig_TypeDefinitionIndex = 55082;
