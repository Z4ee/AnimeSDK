...
#define MOLEMOLE_UIACTIVITYDETECTIVESTOREPAGECONTROLLER_CONTEXT_APPLYJUMPPARAS_OFFSET UNITYSDK_OFFSET(0x196E8820)
#define MOLEMOLE_UIACTIVITYDETECTIVESTOREPAGECONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x196E8940)
#define MOLEMOLE_UIACTIVITYDETECTIVESTOREPAGECONTROLLER_CONTEXT___BASE_APPLYJUMPPARAS_OFFSET UNITYSDK_OFFSET(0x196E8990)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityDetectiveStorePageController_Context_TypeDefinitionIndex = 90616;
