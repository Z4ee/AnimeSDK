...
#define MOLEMOLE_UISMASHBROINLEVELPAUSEBATTLEWIDGETCONTROLLER_GETSHOWREWARDLIST_OFFSET UNITYSDK_OFFSET(0x15E8E5E0)
#define MOLEMOLE_UISMASHBROINLEVELPAUSEBATTLEWIDGETCONTROLLER_REFRESHACTCHALLENGELIST_OFFSET UNITYSDK_OFFSET(0x15E8E150)
#define MOLEMOLE_UISMASHBROINLEVELPAUSEBATTLEWIDGETCONTROLLER_REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0x15E8DA40)
#define MOLEMOLE_UISMASHBROINLEVELPAUSEBATTLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15E8E8E0)
#define MOLEMOLE_UISMASHBROINLEVELPAUSEBATTLEWIDGETCONTROLLER___BASE_GETSHOWREWARDLIST_OFFSET UNITYSDK_OFFSET(0x15E8E8F0)
#define MOLEMOLE_UISMASHBROINLEVELPAUSEBATTLEWIDGETCONTROLLER___BASE_REFRESHACTCHALLENGELIST_OFFSET UNITYSDK_OFFSET(0x15E8E900)
#define MOLEMOLE_UISMASHBROINLEVELPAUSEBATTLEWIDGETCONTROLLER___BASE_REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0x15E8E910)

namespace MoleMole
{
	inline static constexpr unsigned int UISmashBroInLevelPauseBattleWidgetController_TypeDefinitionIndex = 76625;

	class UISmashBroInLevelPauseBattleWidgetController : public ::MoleMole::UIInLevelPauseBattleInfoWidgetController
	{
	public:
		::Class_1_BF64A3E806610DD3_8_Class_0_16E7307DCC43CB2C_35* _challengeFetcher; // 0x2E8
