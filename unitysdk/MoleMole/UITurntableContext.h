...
#define MOLEMOLE_UITURNTABLECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x113309B0)

namespace MoleMole
{
	inline static constexpr unsigned int UITurntableContext_TypeDefinitionIndex = 59687;
