...
#define MOLEMOLE_HOLLOWCHESSBOARD_COLORPROPERTYDATA_APPLY_OFFSET UNITYSDK_OFFSET(0x17812D90)
#define MOLEMOLE_HOLLOWCHESSBOARD_COLORPROPERTYDATA_CLONE_OFFSET UNITYSDK_OFFSET(0x17812CF0)
#define MOLEMOLE_HOLLOWCHESSBOARD_COLORPROPERTYDATA_GETVALUE_OFFSET UNITYSDK_OFFSET(0x17812C70)
#define MOLEMOLE_HOLLOWCHESSBOARD_COLORPROPERTYDATA_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x17812C20)
#define MOLEMOLE_HOLLOWCHESSBOARD_COLORPROPERTYDATA_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x17812C30)
#define MOLEMOLE_HOLLOWCHESSBOARD_COLORPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17812C40)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int ColorPropertyData_TypeDefinitionIndex = 65391;
