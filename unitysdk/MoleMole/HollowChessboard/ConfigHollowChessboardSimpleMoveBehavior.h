...
#define MOLEMOLE_HOLLOWCHESSBOARD_CONFIGHOLLOWCHESSBOARDSIMPLEMOVEBEHAVIOR_INITFORMCONFIG_OFFSET UNITYSDK_OFFSET(0x19255600)
#define MOLEMOLE_HOLLOWCHESSBOARD_CONFIGHOLLOWCHESSBOARDSIMPLEMOVEBEHAVIOR_MOLEMOLE_HOLLOWCHESSBOARD_ICONFIGHOLLOWCHESSBOARDBEHAVIOR_INITFORMCONFIG_OFFSET UNITYSDK_OFFSET(0x19255A20)
#define MOLEMOLE_HOLLOWCHESSBOARD_CONFIGHOLLOWCHESSBOARDSIMPLEMOVEBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19255A10)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int ConfigHollowChessboardSimpleMoveBehavior_TypeDefinitionIndex = 85628;
