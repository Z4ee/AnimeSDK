...
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCHESSBOARDEFFECTEVENTBASE_GET_CUSTOMEVENT_OFFSET UNITYSDK_OFFSET(0x118D9D80)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCHESSBOARDEFFECTEVENTBASE_SET_CUSTOMEVENT_OFFSET UNITYSDK_OFFSET(0x118D9D90)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCHESSBOARDEFFECTEVENTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x118D9DA0)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int HollowChessboardEffectEventBase_TypeDefinitionIndex = 51886;
