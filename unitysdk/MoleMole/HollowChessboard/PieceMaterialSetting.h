...
#define MOLEMOLE_HOLLOWCHESSBOARD_PIECEMATERIALSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x16E5AC00)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int PieceMaterialSetting_TypeDefinitionIndex = 50978;
