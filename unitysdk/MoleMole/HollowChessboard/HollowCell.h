...
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x7E2F50)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_EQUALS_OFFSET UNITYSDK_OFFSET(0x7E2EE0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7E2F60)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_ISVALIDCELL_OFFSET UNITYSDK_OFFSET(0x7E2FD0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_ADDITION_1_OFFSET UNITYSDK_OFFSET(0x1821CA90)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_ADDITION_2_OFFSET UNITYSDK_OFFSET(0x1821CC70)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1821C9F0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1821CD90)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1821CE10)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_SUBTRACTION_1_OFFSET UNITYSDK_OFFSET(0x1821CBD0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_SUBTRACTION_2_OFFSET UNITYSDK_OFFSET(0x1821CD00)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1821CB30)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_TOSTRING_OFFSET UNITYSDK_OFFSET(0x7E2FC0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1821D130)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3EABD0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x7E2DF0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x7E3060)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7E30D0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x7E2FE0)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int HollowCell_TypeDefinitionIndex = 79080;

	struct alignas(4) HollowCell
	{
		static ::MoleMole::HollowChessboard::HollowCell* StaticGet_InvalidCell()
		{
			return (::MoleMole::HollowChessboard::HollowCell*)Il2CppClass::FromTypeDefinitionIndex(HollowCell_TypeDefinitionIndex)->GetStaticField(0x95D0);
		}
		::System::Int32 x; // 0x10
		::System::Int32 y; // 0x14
		::System::Int32 z; // 0x18
