...
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x88DF10)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_EQUALS_OFFSET UNITYSDK_OFFSET(0x88DEA0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x88DF20)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_ISVALIDCELL_OFFSET UNITYSDK_OFFSET(0x88DF90)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_ADDITION_1_OFFSET UNITYSDK_OFFSET(0x19087F50)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_ADDITION_2_OFFSET UNITYSDK_OFFSET(0x19088130)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x19087EB0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x19088250)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x190882D0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_SUBTRACTION_1_OFFSET UNITYSDK_OFFSET(0x19088090)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_SUBTRACTION_2_OFFSET UNITYSDK_OFFSET(0x190881C0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x19087FF0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_TOSTRING_OFFSET UNITYSDK_OFFSET(0x88DF80)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL__CCTOR_OFFSET UNITYSDK_OFFSET(0x190885F0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x586780)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x88DDB0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x88E020)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x88E090)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x88DFA0)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int HollowCell_TypeDefinitionIndex = 74224;

	struct alignas(4) HollowCell
	{
		static ::MoleMole::HollowChessboard::HollowCell* StaticGet_InvalidCell()
		{
			return (::MoleMole::HollowChessboard::HollowCell*)Il2CppClass::FromTypeDefinitionIndex(HollowCell_TypeDefinitionIndex)->GetStaticField(0xA040);
		}
		::System::Int32 x; // 0x10
		::System::Int32 y; // 0x14
		::System::Int32 z; // 0x18
