...
#define MOLEMOLE_HOLLOWCHESSBOARD_VECTORPROPERTYDATA_APPLY_OFFSET UNITYSDK_OFFSET(0x1233E140)
#define MOLEMOLE_HOLLOWCHESSBOARD_VECTORPROPERTYDATA_CLONE_OFFSET UNITYSDK_OFFSET(0x1233E090)
#define MOLEMOLE_HOLLOWCHESSBOARD_VECTORPROPERTYDATA_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1233E010)
#define MOLEMOLE_HOLLOWCHESSBOARD_VECTORPROPERTYDATA_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1233DFC0)
#define MOLEMOLE_HOLLOWCHESSBOARD_VECTORPROPERTYDATA_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1233DFE0)
#define MOLEMOLE_HOLLOWCHESSBOARD_VECTORPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1233DFF0)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int VectorPropertyData_TypeDefinitionIndex = 43993;
