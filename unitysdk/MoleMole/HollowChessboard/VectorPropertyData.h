...
#define MOLEMOLE_HOLLOWCHESSBOARD_VECTORPROPERTYDATA_APPLY_OFFSET UNITYSDK_OFFSET(0x13EF1080)
#define MOLEMOLE_HOLLOWCHESSBOARD_VECTORPROPERTYDATA_CLONE_OFFSET UNITYSDK_OFFSET(0x13EF0FD0)
#define MOLEMOLE_HOLLOWCHESSBOARD_VECTORPROPERTYDATA_GETVALUE_OFFSET UNITYSDK_OFFSET(0x13EF0F50)
#define MOLEMOLE_HOLLOWCHESSBOARD_VECTORPROPERTYDATA_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x13EF0F00)
#define MOLEMOLE_HOLLOWCHESSBOARD_VECTORPROPERTYDATA_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x13EF0F20)
#define MOLEMOLE_HOLLOWCHESSBOARD_VECTORPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x13EF0F30)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int VectorPropertyData_TypeDefinitionIndex = 52752;
