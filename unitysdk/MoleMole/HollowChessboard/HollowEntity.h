...
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16050560)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int HollowEntity_TypeDefinitionIndex = 61698;
