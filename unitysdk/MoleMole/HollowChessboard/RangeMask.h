...
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK_CHECKBIT_OFFSET UNITYSDK_OFFSET(0x88EF10)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x88EFB0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK_EQUALS_OFFSET UNITYSDK_OFFSET(0x88EF60)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x88EFC0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x19256570)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x192565F0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK_SETBIT_OFFSET UNITYSDK_OFFSET(0x88EEA0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x88F010)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x88F070)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int RangeMask_TypeDefinitionIndex = 83318;
