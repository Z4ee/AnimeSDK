...
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK_CHECKBIT_OFFSET UNITYSDK_OFFSET(0x77F310)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x77F3B0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK_EQUALS_OFFSET UNITYSDK_OFFSET(0x77F360)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x77F3C0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x14290510)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x14290590)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK_SETBIT_OFFSET UNITYSDK_OFFSET(0x77F2A0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x77F410)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x77F470)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int RangeMask_TypeDefinitionIndex = 44002;
