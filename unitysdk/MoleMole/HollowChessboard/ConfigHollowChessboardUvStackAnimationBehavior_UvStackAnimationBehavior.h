...
#define MOLEMOLE_HOLLOWCHESSBOARD_CONFIGHOLLOWCHESSBOARDUVSTACKANIMATIONBEHAVIOR_UVSTACKANIMATIONBEHAVIOR_BUILD_OFFSET UNITYSDK_OFFSET(0x130234E0)
#define MOLEMOLE_HOLLOWCHESSBOARD_CONFIGHOLLOWCHESSBOARDUVSTACKANIMATIONBEHAVIOR_UVSTACKANIMATIONBEHAVIOR_TRYADDBLACKBOARDITEM_OFFSET UNITYSDK_OFFSET(0x13023570)
#define MOLEMOLE_HOLLOWCHESSBOARD_CONFIGHOLLOWCHESSBOARDUVSTACKANIMATIONBEHAVIOR_UVSTACKANIMATIONBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x130234D0)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int ConfigHollowChessboardUvStackAnimationBehavior_UvStackAnimationBehavior_TypeDefinitionIndex = 40939;
