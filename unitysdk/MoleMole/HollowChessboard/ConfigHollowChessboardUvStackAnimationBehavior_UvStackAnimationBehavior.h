...
#define MOLEMOLE_HOLLOWCHESSBOARD_CONFIGHOLLOWCHESSBOARDUVSTACKANIMATIONBEHAVIOR_UVSTACKANIMATIONBEHAVIOR_BUILD_OFFSET UNITYSDK_OFFSET(0x1737CC30)
#define MOLEMOLE_HOLLOWCHESSBOARD_CONFIGHOLLOWCHESSBOARDUVSTACKANIMATIONBEHAVIOR_UVSTACKANIMATIONBEHAVIOR_TRYADDBLACKBOARDITEM_OFFSET UNITYSDK_OFFSET(0x1737CCC0)
#define MOLEMOLE_HOLLOWCHESSBOARD_CONFIGHOLLOWCHESSBOARDUVSTACKANIMATIONBEHAVIOR_UVSTACKANIMATIONBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1737CC20)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int ConfigHollowChessboardUvStackAnimationBehavior_UvStackAnimationBehavior_TypeDefinitionIndex = 60952;
