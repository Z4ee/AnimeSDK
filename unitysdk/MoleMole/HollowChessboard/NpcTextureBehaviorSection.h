...
#define MOLEMOLE_HOLLOWCHESSBOARD_NPCTEXTUREBEHAVIORSECTION_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x13A948A0)
#define MOLEMOLE_HOLLOWCHESSBOARD_NPCTEXTUREBEHAVIORSECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x13A94940)
#define MOLEMOLE_HOLLOWCHESSBOARD_NPCTEXTUREBEHAVIORSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x13A94930)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int NpcTextureBehaviorSection_TypeDefinitionIndex = 53352;
	...
	public:
		...
		{
			return (::MoleMole::HollowChessboard::RenderSequenceSectionType*)Il2CppClass::FromTypeDefinitionIndex(NpcTextureBehaviorSection_TypeDefinitionIndex)->GetStaticField(0x106E0);
		}
