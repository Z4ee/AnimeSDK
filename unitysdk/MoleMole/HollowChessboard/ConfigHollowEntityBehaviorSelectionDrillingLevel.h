...
#define MOLEMOLE_HOLLOWCHESSBOARD_CONFIGHOLLOWENTITYBEHAVIORSELECTIONDRILLINGLEVEL_EVALUATE_OFFSET UNITYSDK_OFFSET(0x11758990)
#define MOLEMOLE_HOLLOWCHESSBOARD_CONFIGHOLLOWENTITYBEHAVIORSELECTIONDRILLINGLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x11758B40)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int ConfigHollowEntityBehaviorSelectionDrillingLevel_TypeDefinitionIndex = 42728;
