...
#define MOLEMOLE_HOLLOWCHESSBOARD_VERTICALELEVATOREFF_METHOD_5_2CBE0B79DD36047E_OFFSET UNITYSDK_OFFSET(0x17813CA0)
#define MOLEMOLE_HOLLOWCHESSBOARD_VERTICALELEVATOREFF_METHOD_5_63CFAA60FA3D87ED_OFFSET UNITYSDK_OFFSET(0x17813A20)
#define MOLEMOLE_HOLLOWCHESSBOARD_VERTICALELEVATOREFF_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x17813C50)
#define MOLEMOLE_HOLLOWCHESSBOARD_VERTICALELEVATOREFF_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17813B10)
#define MOLEMOLE_HOLLOWCHESSBOARD_VERTICALELEVATOREFF_REBUILD_OFFSET UNITYSDK_OFFSET(0x17813320)
#define MOLEMOLE_HOLLOWCHESSBOARD_VERTICALELEVATOREFF__CTOR_OFFSET UNITYSDK_OFFSET(0x17813BA0)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int VerticalElevatorEff_TypeDefinitionIndex = 75095;
