...
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE_COMPARETO_OFFSET UNITYSDK_OFFSET(0x805540)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8055B0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x8054D0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x805350)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE_GETRENDERSTATUES_OFFSET UNITYSDK_OFFSET(0x805470)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x424ED0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE_GET_SERIALNUMBER_OFFSET UNITYSDK_OFFSET(0x325570)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE_ISSET_OFFSET UNITYSDK_OFFSET(0x805400)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE_ISVALID_OFFSET UNITYSDK_OFFSET(0x805460)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x149EFD30)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x149EFDE0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x149EFEB0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x5C4280)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x805270)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x8055C0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x805630)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int RenderDataHandle_TypeDefinitionIndex = 56456;

	struct alignas(8) RenderDataHandle
	{
		static ::MoleMole::HollowChessboard::RenderDataHandle* StaticGet_Default()
		{
			return (::MoleMole::HollowChessboard::RenderDataHandle*)Il2CppClass::FromTypeDefinitionIndex(RenderDataHandle_TypeDefinitionIndex)->GetStaticField(0x31590);
		}
