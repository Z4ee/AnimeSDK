...
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_LINEINFO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x701D30)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_LINEINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x701C70)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_LINEINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x701D40)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_LINEINFO_GETLINETYPE_OFFSET UNITYSDK_OFFSET(0x701B60)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_LINEINFO_ISVALID_OFFSET UNITYSDK_OFFSET(0x701C00)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_LINEINFO___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x701DD0)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_LINEINFO___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x701E40)

namespace MoleMole::HollowChessboard::ChessboardView
{
	inline static constexpr unsigned int LineInfo_TypeDefinitionIndex = 53129;
