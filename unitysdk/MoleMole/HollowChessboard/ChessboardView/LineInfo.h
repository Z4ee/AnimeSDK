...
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_LINEINFO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8717A0)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_LINEINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x8716E0)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_LINEINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8717B0)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_LINEINFO_GETLINETYPE_OFFSET UNITYSDK_OFFSET(0x8715D0)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_LINEINFO_ISVALID_OFFSET UNITYSDK_OFFSET(0x871670)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_LINEINFO___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x871850)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_LINEINFO___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8718C0)

namespace MoleMole::HollowChessboard::ChessboardView
{
	inline static constexpr unsigned int LineInfo_TypeDefinitionIndex = 42447;
