...
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_CHESSPIECELOCALMOVEEFFECT_GET_TOTALDURATION_OFFSET UNITYSDK_OFFSET(0x15132D90)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_CHESSPIECELOCALMOVEEFFECT_ONONCEFINISH_OFFSET UNITYSDK_OFFSET(0x15133470)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_CHESSPIECELOCALMOVEEFFECT_RUN_OFFSET UNITYSDK_OFFSET(0x15132E60)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_CHESSPIECELOCALMOVEEFFECT_SEARCHINNEEDCHANGE_OFFSET UNITYSDK_OFFSET(0x15132DA0)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_CHESSPIECELOCALMOVEEFFECT_SETNEEDCHANGE_OFFSET UNITYSDK_OFFSET(0x15133420)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_CHESSPIECELOCALMOVEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x151334D0)

namespace MoleMole::HollowChessboard::ChessboardView
{
	inline static constexpr unsigned int ChessPieceLocalMoveEffect_TypeDefinitionIndex = 49300;
