...
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWRENDERSEQUENCECONFIGTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x144DB6A0)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int HollowRenderSequenceConfigTable_TypeDefinitionIndex = 90222;
