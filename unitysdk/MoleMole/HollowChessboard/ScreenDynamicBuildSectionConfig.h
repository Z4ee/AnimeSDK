...
#define MOLEMOLE_HOLLOWCHESSBOARD_SCREENDYNAMICBUILDSECTIONCONFIG_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x11623E90)
#define MOLEMOLE_HOLLOWCHESSBOARD_SCREENDYNAMICBUILDSECTIONCONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0x11623EE0)
#define MOLEMOLE_HOLLOWCHESSBOARD_SCREENDYNAMICBUILDSECTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x11623ED0)
#define MOLEMOLE_HOLLOWCHESSBOARD_SCREENDYNAMICBUILDSECTIONCONFIG___BASE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x11623EF0)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int ScreenDynamicBuildSectionConfig_TypeDefinitionIndex = 62408;
	...
	public:
		...
		{
			return (::MoleMole::HollowChessboard::RenderSequenceSectionType*)Il2CppClass::FromTypeDefinitionIndex(ScreenDynamicBuildSectionConfig_TypeDefinitionIndex)->GetStaticField(0x11030);
		}
