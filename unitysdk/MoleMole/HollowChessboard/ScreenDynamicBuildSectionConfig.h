...
#define MOLEMOLE_HOLLOWCHESSBOARD_SCREENDYNAMICBUILDSECTIONCONFIG_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x14291170)
#define MOLEMOLE_HOLLOWCHESSBOARD_SCREENDYNAMICBUILDSECTIONCONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0x142911C0)
#define MOLEMOLE_HOLLOWCHESSBOARD_SCREENDYNAMICBUILDSECTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x142911B0)
#define MOLEMOLE_HOLLOWCHESSBOARD_SCREENDYNAMICBUILDSECTIONCONFIG___BASE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x142911D0)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int ScreenDynamicBuildSectionConfig_TypeDefinitionIndex = 45294;
	...
	public:
		...
		{
			return (::MoleMole::HollowChessboard::RenderSequenceSectionType*)Il2CppClass::FromTypeDefinitionIndex(ScreenDynamicBuildSectionConfig_TypeDefinitionIndex)->GetStaticField(0x10CC0);
		}
