...
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWTIPITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x16D4D180)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int HollowTipItem_TypeDefinitionIndex = 57928;
