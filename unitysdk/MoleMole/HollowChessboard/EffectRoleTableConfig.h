...
#define MOLEMOLE_HOLLOWCHESSBOARD_EFFECTROLETABLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B29820)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int EffectRoleTableConfig_TypeDefinitionIndex = 73730;
