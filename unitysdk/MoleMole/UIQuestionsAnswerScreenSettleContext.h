...
#define MOLEMOLE_UIQUESTIONSANSWERSCREENSETTLECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x19894310)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerScreenSettleContext_TypeDefinitionIndex = 75138;
