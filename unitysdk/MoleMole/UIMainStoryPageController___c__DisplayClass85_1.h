...
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS85_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1693DE00)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS85_1__INITPERSONALLINE_B__0_OFFSET UNITYSDK_OFFSET(0x1693DE10)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS85_1__INITPERSONALLINE_B__1_OFFSET UNITYSDK_OFFSET(0x1693E540)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainStoryPageController___c__DisplayClass85_1_TypeDefinitionIndex = 76816;
