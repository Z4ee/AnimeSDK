...
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_CLICKSELECT_OFFSET UNITYSDK_OFFSET(0x18814F80)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18814A20)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x18814C80)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18814CD0)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18814AB0)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18814C10)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_SETARROW_OFFSET UNITYSDK_OFFSET(0x18814DC0)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_SETBYTEMPLATE_OFFSET UNITYSDK_OFFSET(0x18814F30)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_SETCB_OFFSET UNITYSDK_OFFSET(0x18814EE0)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_SETSHOWCONTENT_OFFSET UNITYSDK_OFFSET(0x18814D50)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18815100)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x188150A0)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18815120)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x188151B0)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x188151C0)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18815250)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x188152E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralShopDescWidgetController_TypeDefinitionIndex = 64449;
	...
	public:
		...
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(UIGeneralShopDescWidgetController_TypeDefinitionIndex)->GetStaticField(0xEBF0);
		}
		static ::UnityEngine::Vector3* StaticGet_selectArrow()
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(UIGeneralShopDescWidgetController_TypeDefinitionIndex)->GetStaticField(0xEBFC);
		}
