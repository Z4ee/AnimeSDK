...
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_CLICKSELECT_OFFSET UNITYSDK_OFFSET(0x16A9EA20)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16A9E4C0)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x16A9E720)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16A9E770)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16A9E550)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16A9E6B0)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_SETARROW_OFFSET UNITYSDK_OFFSET(0x16A9E860)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_SETBYTEMPLATE_OFFSET UNITYSDK_OFFSET(0x16A9E9D0)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_SETCB_OFFSET UNITYSDK_OFFSET(0x16A9E980)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_SETSHOWCONTENT_OFFSET UNITYSDK_OFFSET(0x16A9E7F0)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x16A9EBA0)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16A9EB40)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16A9EBC0)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x16A9EC50)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16A9EC60)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16A9ECF0)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16A9ED80)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralShopDescWidgetController_TypeDefinitionIndex = 42011;
	...
	public:
		...
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(UIGeneralShopDescWidgetController_TypeDefinitionIndex)->GetStaticField(0xF390);
		}
		static ::UnityEngine::Vector3* StaticGet_noSelectArrow()
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(UIGeneralShopDescWidgetController_TypeDefinitionIndex)->GetStaticField(0xF39C);
		}
		::Class_2_93B82063FE922515* _view; // 0x2C0
		::System::Boolean _isSelect; // 0x2C8
		::System::Action_1<::MoleMole::UIGeneralShopDescWidgetController*>* _clickCallback; // 0x2D0
