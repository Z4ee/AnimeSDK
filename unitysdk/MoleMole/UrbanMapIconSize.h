...
#define MOLEMOLE_URBANMAPICONSIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x10D8A7B0)

namespace MoleMole
{
	inline static constexpr unsigned int UrbanMapIconSize_TypeDefinitionIndex = 76600;
