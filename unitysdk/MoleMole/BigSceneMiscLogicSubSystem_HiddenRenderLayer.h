...
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_HIDDENRENDERLAYER_SWITCH_OFFSET UNITYSDK_OFFSET(0x11C860C0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_HIDDENRENDERLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x11C86300)

namespace MoleMole
{
	inline static constexpr unsigned int BigSceneMiscLogicSubSystem_HiddenRenderLayer_TypeDefinitionIndex = 66893;
