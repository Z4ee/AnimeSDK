...
#define MOLEMOLE_UIQUESTIONSANSWERTIPSLISTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x198943C0)
#define MOLEMOLE_UIQUESTIONSANSWERTIPSLISTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x198944D0)
#define MOLEMOLE_UIQUESTIONSANSWERTIPSLISTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19894450)
#define MOLEMOLE_UIQUESTIONSANSWERTIPSLISTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19894360)
#define MOLEMOLE_UIQUESTIONSANSWERTIPSLISTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19894620)
#define MOLEMOLE_UIQUESTIONSANSWERTIPSLISTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19894700)
#define MOLEMOLE_UIQUESTIONSANSWERTIPSLISTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x19894790)
#define MOLEMOLE_UIQUESTIONSANSWERTIPSLISTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19894830)
#define MOLEMOLE_UIQUESTIONSANSWERTIPSLISTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x198948C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerTipsListRowWidgetController_TypeDefinitionIndex = 88555;
	...
	public:
		...
		::Class_2_7BEEB90214042948_22* _view; // 0x2F8
