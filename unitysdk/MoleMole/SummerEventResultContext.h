...
#define MOLEMOLE_SUMMEREVENTRESULTCONTEXT_ADD_OFFSET UNITYSDK_OFFSET(0x18716F60)
#define MOLEMOLE_SUMMEREVENTRESULTCONTEXT_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18716FF0)
#define MOLEMOLE_SUMMEREVENTRESULTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18716EB0)

namespace MoleMole
{
	inline static constexpr unsigned int SummerEventResultContext_TypeDefinitionIndex = 83914;
	...
	public:
		...
		::Class_0_16E4307DCC419505_648* _title; // 0x30
		::System::Action* _exit; // 0x38

		::System::Void _ctor(::Class_0_16E4307DCC419505_648* title, ::System::Action* exit)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_648*, ::System::Action*))((::PBYTE)hIl2Cpp + MOLEMOLE_SUMMEREVENTRESULTCONTEXT__CTOR_OFFSET))(this, title, exit);
		}
