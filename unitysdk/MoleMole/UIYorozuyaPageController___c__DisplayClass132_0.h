...
#define MOLEMOLE_UIYOROZUYAPAGECONTROLLER___C__DISPLAYCLASS132_0__CTOR_OFFSET UNITYSDK_OFFSET(0x12EAD8E0)
#define MOLEMOLE_UIYOROZUYAPAGECONTROLLER___C__DISPLAYCLASS132_0__SETSCROLLVIEW_B__0_OFFSET UNITYSDK_OFFSET(0x12EAD8F0)
#define MOLEMOLE_UIYOROZUYAPAGECONTROLLER___C__DISPLAYCLASS132_0__SETSCROLLVIEW_B__3_OFFSET UNITYSDK_OFFSET(0x12EADD10)

namespace MoleMole
{
	inline static constexpr unsigned int UIYorozuyaPageController___c__DisplayClass132_0_TypeDefinitionIndex = 79306;
