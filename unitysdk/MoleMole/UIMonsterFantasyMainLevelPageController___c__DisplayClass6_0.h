...
#define MOLEMOLE_UIMONSTERFANTASYMAINLEVELPAGECONTROLLER___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0x13FDD170)
#define MOLEMOLE_UIMONSTERFANTASYMAINLEVELPAGECONTROLLER___C__DISPLAYCLASS6_0__ONUIOPEN_B__0_OFFSET UNITYSDK_OFFSET(0x13FDD180)
#define MOLEMOLE_UIMONSTERFANTASYMAINLEVELPAGECONTROLLER___C__DISPLAYCLASS6_0__ONUIOPEN_B__1_OFFSET UNITYSDK_OFFSET(0x13FDD250)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyMainLevelPageController___c__DisplayClass6_0_TypeDefinitionIndex = 41415;
	...
	public:
		...
		::MoleMole::UIMonsterFantasyMainLevelPageController_Context* inputContext; // 0x20
