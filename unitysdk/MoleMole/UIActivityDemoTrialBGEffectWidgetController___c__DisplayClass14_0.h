...
#define MOLEMOLE_UIACTIVITYDEMOTRIALBGEFFECTWIDGETCONTROLLER___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17E3FD40)
#define MOLEMOLE_UIACTIVITYDEMOTRIALBGEFFECTWIDGETCONTROLLER___C__DISPLAYCLASS14_0__PLAYBGANIMATION_B__0_OFFSET UNITYSDK_OFFSET(0x17E3FD50)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityDemoTrialBGEffectWidgetController___c__DisplayClass14_0_TypeDefinitionIndex = 70214;
