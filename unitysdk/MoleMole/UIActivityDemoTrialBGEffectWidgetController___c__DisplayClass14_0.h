...
#define MOLEMOLE_UIACTIVITYDEMOTRIALBGEFFECTWIDGETCONTROLLER___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6E86D0)
#define MOLEMOLE_UIACTIVITYDEMOTRIALBGEFFECTWIDGETCONTROLLER___C__DISPLAYCLASS14_0__PLAYBGANIMATION_B__0_OFFSET UNITYSDK_OFFSET(0x1B6E86E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityDemoTrialBGEffectWidgetController___c__DisplayClass14_0_TypeDefinitionIndex = 82580;
