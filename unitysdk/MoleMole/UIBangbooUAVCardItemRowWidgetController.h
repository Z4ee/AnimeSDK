...
#define MOLEMOLE_UIBANGBOOUAVCARDITEMROWWIDGETCONTROLLER_ISCOLLECT_OFFSET UNITYSDK_OFFSET(0x1851DB50)
#define MOLEMOLE_UIBANGBOOUAVCARDITEMROWWIDGETCONTROLLER_ONCLICK_OFFSET UNITYSDK_OFFSET(0x1851DE90)
#define MOLEMOLE_UIBANGBOOUAVCARDITEMROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1851D660)
#define MOLEMOLE_UIBANGBOOUAVCARDITEMROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x1851E0C0)
#define MOLEMOLE_UIBANGBOOUAVCARDITEMROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1851D6F0)
#define MOLEMOLE_UIBANGBOOUAVCARDITEMROWWIDGETCONTROLLER_REFRESHNEW_OFFSET UNITYSDK_OFFSET(0x1851DD00)
#define MOLEMOLE_UIBANGBOOUAVCARDITEMROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1851E160)
#define MOLEMOLE_UIBANGBOOUAVCARDITEMROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1851E170)
#define MOLEMOLE_UIBANGBOOUAVCARDITEMROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x1851E200)
#define MOLEMOLE_UIBANGBOOUAVCARDITEMROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1851E290)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooUAVCardItemRowWidgetController_TypeDefinitionIndex = 59171;
	...
	public:
		...
		::Class_2_208CC9941471731A_207* m_cfg; // 0x2F8
