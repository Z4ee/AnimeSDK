...
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x14E9DCE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFashionStoreMainPageController_Context_TypeDefinitionIndex = 62345;
