...
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1526A6E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFashionStoreMainPageController_Context_TypeDefinitionIndex = 62608;
