...
#define MOLEMOLE_DEVICESETTINGDEVICEMODELPREDICATE_GETPREDICATESTRING_OFFSET UNITYSDK_OFFSET(0x14883340)
#define MOLEMOLE_DEVICESETTINGDEVICEMODELPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x14883390)
#define MOLEMOLE_DEVICESETTINGDEVICEMODELPREDICATE___BASE_GETPREDICATESTRING_OFFSET UNITYSDK_OFFSET(0x14883410)

namespace MoleMole
{
	inline static constexpr unsigned int DeviceSettingDeviceModelPredicate_TypeDefinitionIndex = 86212;
