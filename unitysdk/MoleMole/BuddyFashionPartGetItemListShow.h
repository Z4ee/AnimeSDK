...
#define MOLEMOLE_BUDDYFASHIONPARTGETITEMLISTSHOW_DOPROCESS_OFFSET UNITYSDK_OFFSET(0xFAE66B0)
#define MOLEMOLE_BUDDYFASHIONPARTGETITEMLISTSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0xFAE66A0)
#define MOLEMOLE_BUDDYFASHIONPARTGETITEMLISTSHOW___BASE_DOPROCESS_OFFSET UNITYSDK_OFFSET(0xFAE6A20)

namespace MoleMole
{
	inline static constexpr unsigned int BuddyFashionPartGetItemListShow_TypeDefinitionIndex = 60298;
