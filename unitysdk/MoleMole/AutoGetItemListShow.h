...
#define MOLEMOLE_AUTOGETITEMLISTSHOW_DIRECTSHOW_OFFSET UNITYSDK_OFFSET(0x17796490)
#define MOLEMOLE_AUTOGETITEMLISTSHOW_DOPROCESS_OFFSET UNITYSDK_OFFSET(0x177964E0)
#define MOLEMOLE_AUTOGETITEMLISTSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x17796280)
#define MOLEMOLE_AUTOGETITEMLISTSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x17796440)
#define MOLEMOLE_AUTOGETITEMLISTSHOW_SETGOBTN_OFFSET UNITYSDK_OFFSET(0x177963E0)
#define MOLEMOLE_AUTOGETITEMLISTSHOW_SETMESSAGECONFIG_OFFSET UNITYSDK_OFFSET(0x17796380)
#define MOLEMOLE_AUTOGETITEMLISTSHOW_SHOWREWARDWINDOW_OFFSET UNITYSDK_OFFSET(0x17796530)
#define MOLEMOLE_AUTOGETITEMLISTSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x17796290)
#define MOLEMOLE_AUTOGETITEMLISTSHOW___BASE_SETMESSAGECONFIG_OFFSET UNITYSDK_OFFSET(0x17796860)

namespace MoleMole
{
	inline static constexpr unsigned int AutoGetItemListShow_TypeDefinitionIndex = 68887;
