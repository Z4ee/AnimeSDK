...
#define MOLEMOLE_MONOCINEMACAMERALIGHTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19959310)

namespace MoleMole
{
	inline static constexpr unsigned int MonoCinemaCameraLightConfig_TypeDefinitionIndex = 67930;
