...
#define MOLEMOLE_UICOMICPAGECONTROLLER___C__DISPLAYCLASS352_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18544C00)
#define MOLEMOLE_UICOMICPAGECONTROLLER___C__DISPLAYCLASS352_0__SHOWBUBBLE_B__0_OFFSET UNITYSDK_OFFSET(0x18544C10)
#define MOLEMOLE_UICOMICPAGECONTROLLER___C__DISPLAYCLASS352_0__SHOWBUBBLE_B__1_OFFSET UNITYSDK_OFFSET(0x18544C50)
#define MOLEMOLE_UICOMICPAGECONTROLLER___C__DISPLAYCLASS352_0__SHOWBUBBLE_B__2_OFFSET UNITYSDK_OFFSET(0x18544CA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIComicPageController___c__DisplayClass352_0_TypeDefinitionIndex = 87095;
