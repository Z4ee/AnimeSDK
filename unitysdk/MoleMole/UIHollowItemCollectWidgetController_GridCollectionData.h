...
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_GRIDCOLLECTIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17323AA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowItemCollectWidgetController_GridCollectionData_TypeDefinitionIndex = 54636;
