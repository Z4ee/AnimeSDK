...
#define MOLEMOLE_UIHOLLOWCLUECOLLECTWIDGETCONTROLLER___C__DISPLAYCLASS15_0__CTOR_OFFSET UNITYSDK_OFFSET(0x162EA140)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTWIDGETCONTROLLER___C__DISPLAYCLASS15_0__ONCLICKGOTOAGENCY_B__0_OFFSET UNITYSDK_OFFSET(0x162EA150)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowClueCollectWidgetController___c__DisplayClass15_0_TypeDefinitionIndex = 53538;

	class UIHollowClueCollectWidgetController___c__DisplayClass15_0 : public ::System::Object
	{
	public:
		::Class_1_72108342D7142693_Class_2_B57A8ED4EE569CA0* runningParas; // 0x10
