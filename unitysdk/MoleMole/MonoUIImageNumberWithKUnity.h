...
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_GET_OPENSCORERANDOM_OFFSET UNITYSDK_OFFSET(0x15B432B0)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_ISFULLRANDOM_OFFSET UNITYSDK_OFFSET(0x15B432D0)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_ISSPLITRANDOM_OFFSET UNITYSDK_OFFSET(0x15B43320)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_SETNUMBER_OFFSET UNITYSDK_OFFSET(0x15B434F0)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_SET_OPENSCORERANDOM_OFFSET UNITYSDK_OFFSET(0x15B432C0)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_STARTNORMALRANDOM_OFFSET UNITYSDK_OFFSET(0x15B44060)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_STARTROLLTOTARGET_OFFSET UNITYSDK_OFFSET(0x15B44310)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_UPDATE_OFFSET UNITYSDK_OFFSET(0x15B43990)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__CTOR_OFFSET UNITYSDK_OFFSET(0x15B445A0)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__FLUSHRUNDIGITSTONUM_OFFSET UNITYSDK_OFFSET(0x15B441D0)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__FULLANYRANDOM_OFFSET UNITYSDK_OFFSET(0x15B43C50)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__GETCURVEDURATION_OFFSET UNITYSDK_OFFSET(0x15B44260)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__GETMAXNUMBERTAG_OFFSET UNITYSDK_OFFSET(0x15B43370)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__GETPARTINTERVAL_OFFSET UNITYSDK_OFFSET(0x15B440D0)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__ONTOTALDIGIT_OFFSET UNITYSDK_OFFSET(0x15B43260)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__SETREALNUMBER_OFFSET UNITYSDK_OFFSET(0x15B435D0)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__SPLITRANDOM_OFFSET UNITYSDK_OFFSET(0x15B43D00)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__TRYRANDOM_OFFSET UNITYSDK_OFFSET(0x15B43BE0)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__TRYROLLTOTARGET_OFFSET UNITYSDK_OFFSET(0x15B43A40)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY___FULLANYRANDOM_G____GETCURVALUE_41_0_OFFSET UNITYSDK_OFFSET(0x15B44810)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY___FULLANYRANDOM_G____GETRANDOMINTERVAL_41_1_OFFSET UNITYSDK_OFFSET(0x15B440B0)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY___TRYROLLTOTARGET_G___ROLLPART_51_0_OFFSET UNITYSDK_OFFSET(0x15B443A0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIImageNumberWithKUnity_TypeDefinitionIndex = 46003;
