...
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_GET_OPENSCORERANDOM_OFFSET UNITYSDK_OFFSET(0x17DDA550)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_ISFULLRANDOM_OFFSET UNITYSDK_OFFSET(0x17DDA570)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_ISSPLITRANDOM_OFFSET UNITYSDK_OFFSET(0x17DDA5C0)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_SETNUMBER_OFFSET UNITYSDK_OFFSET(0x17DDA790)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_SET_OPENSCORERANDOM_OFFSET UNITYSDK_OFFSET(0x17DDA560)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_STARTNORMALRANDOM_OFFSET UNITYSDK_OFFSET(0x17DDB300)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_STARTROLLTOTARGET_OFFSET UNITYSDK_OFFSET(0x17DDB5B0)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_UPDATE_OFFSET UNITYSDK_OFFSET(0x17DDAC30)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__CTOR_OFFSET UNITYSDK_OFFSET(0x17DDB840)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__FLUSHRUNDIGITSTONUM_OFFSET UNITYSDK_OFFSET(0x17DDB470)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__FULLANYRANDOM_OFFSET UNITYSDK_OFFSET(0x17DDAEF0)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__GETCURVEDURATION_OFFSET UNITYSDK_OFFSET(0x17DDB500)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__GETMAXNUMBERTAG_OFFSET UNITYSDK_OFFSET(0x17DDA610)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__GETPARTINTERVAL_OFFSET UNITYSDK_OFFSET(0x17DDB370)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__ONTOTALDIGIT_OFFSET UNITYSDK_OFFSET(0x17DDA500)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__SETREALNUMBER_OFFSET UNITYSDK_OFFSET(0x17DDA870)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__SPLITRANDOM_OFFSET UNITYSDK_OFFSET(0x17DDAFA0)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__TRYRANDOM_OFFSET UNITYSDK_OFFSET(0x17DDAE80)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__TRYROLLTOTARGET_OFFSET UNITYSDK_OFFSET(0x17DDACE0)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY___FULLANYRANDOM_G____GETCURVALUE_41_0_OFFSET UNITYSDK_OFFSET(0x17DDBAB0)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY___FULLANYRANDOM_G____GETRANDOMINTERVAL_41_1_OFFSET UNITYSDK_OFFSET(0x17DDB350)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY___TRYROLLTOTARGET_G___ROLLPART_51_0_OFFSET UNITYSDK_OFFSET(0x17DDB640)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIImageNumberWithKUnity_TypeDefinitionIndex = 41977;
