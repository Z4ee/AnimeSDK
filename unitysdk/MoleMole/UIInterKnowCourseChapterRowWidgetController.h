...
#define MOLEMOLE_UIINTERKNOWCOURSECHAPTERROWWIDGETCONTROLLER_ONCLICKCHAPTERITEM_OFFSET UNITYSDK_OFFSET(0x146B8360)
#define MOLEMOLE_UIINTERKNOWCOURSECHAPTERROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x146B7F30)
#define MOLEMOLE_UIINTERKNOWCOURSECHAPTERROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x146B8040)
#define MOLEMOLE_UIINTERKNOWCOURSECHAPTERROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x146B7FC0)
#define MOLEMOLE_UIINTERKNOWCOURSECHAPTERROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x146B7DD0)
#define MOLEMOLE_UIINTERKNOWCOURSECHAPTERROWWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x146B8260)
#define MOLEMOLE_UIINTERKNOWCOURSECHAPTERROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x146B83C0)
#define MOLEMOLE_UIINTERKNOWCOURSECHAPTERROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x146B83D0)
#define MOLEMOLE_UIINTERKNOWCOURSECHAPTERROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x146B8460)
#define MOLEMOLE_UIINTERKNOWCOURSECHAPTERROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x146B8500)
#define MOLEMOLE_UIINTERKNOWCOURSECHAPTERROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x146B8590)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnowCourseChapterRowWidgetController_TypeDefinitionIndex = 84680;

	class UIInterKnowCourseChapterRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_E7D93FA3DEF63A86* _view; // 0x2F0
		::Class_1_84288157D4F72E4C* chapterData; // 0x2F8
