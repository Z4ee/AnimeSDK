...
#define MOLEMOLE_UIINTERKNOWCOURSECHAPTERROWWIDGETCONTROLLER_ONCLICKCHAPTERITEM_OFFSET UNITYSDK_OFFSET(0x164F2160)
#define MOLEMOLE_UIINTERKNOWCOURSECHAPTERROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x164F1D30)
#define MOLEMOLE_UIINTERKNOWCOURSECHAPTERROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x164F1E40)
#define MOLEMOLE_UIINTERKNOWCOURSECHAPTERROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x164F1DC0)
#define MOLEMOLE_UIINTERKNOWCOURSECHAPTERROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x164F1BD0)
#define MOLEMOLE_UIINTERKNOWCOURSECHAPTERROWWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x164F2060)
#define MOLEMOLE_UIINTERKNOWCOURSECHAPTERROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x164F21C0)
#define MOLEMOLE_UIINTERKNOWCOURSECHAPTERROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x164F21D0)
#define MOLEMOLE_UIINTERKNOWCOURSECHAPTERROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x164F2260)
#define MOLEMOLE_UIINTERKNOWCOURSECHAPTERROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x164F2300)
#define MOLEMOLE_UIINTERKNOWCOURSECHAPTERROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x164F2390)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnowCourseChapterRowWidgetController_TypeDefinitionIndex = 47086;
