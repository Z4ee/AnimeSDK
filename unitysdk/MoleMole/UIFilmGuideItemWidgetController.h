...
#define MOLEMOLE_UIFILMGUIDEITEMWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18054400)
#define MOLEMOLE_UIFILMGUIDEITEMWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18054470)
#define MOLEMOLE_UIFILMGUIDEITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x18054510)
#define MOLEMOLE_UIFILMGUIDEITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18054640)
#define MOLEMOLE_UIFILMGUIDEITEMWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18054650)
#define MOLEMOLE_UIFILMGUIDEITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x180546F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFilmGuideItemWidgetController_TypeDefinitionIndex = 80525;
