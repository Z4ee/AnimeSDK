...
#define MOLEMOLE_UIFILMGUIDEITEMWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x166C8BD0)
#define MOLEMOLE_UIFILMGUIDEITEMWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x166C8C40)
#define MOLEMOLE_UIFILMGUIDEITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x166C8CE0)
#define MOLEMOLE_UIFILMGUIDEITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x166C8E10)
#define MOLEMOLE_UIFILMGUIDEITEMWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x166C8E20)
#define MOLEMOLE_UIFILMGUIDEITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x166C8EC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFilmGuideItemWidgetController_TypeDefinitionIndex = 40645;
