...
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_FILTERAUDIOEVENTLIST_OFFSET UNITYSDK_OFFSET(0x16A95750)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_FORCESTOPPLAYVOICE_OFFSET UNITYSDK_OFFSET(0x16A964D0)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_GETLASTPLAYEDROWIDX_OFFSET UNITYSDK_OFFSET(0x16A937D0)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_GET_ISLASTAUDIOFINISH_OFFSET UNITYSDK_OFFSET(0x16A93400)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_GET__ISPLAYINGAUDIO_OFFSET UNITYSDK_OFFSET(0x16A956F0)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x16A93A30)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_MUTEBTNCLICKSOUND_OFFSET UNITYSDK_OFFSET(0x16A96520)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_ONCLICKPLAYSOUND_OFFSET UNITYSDK_OFFSET(0x16A95510)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_ONCLICKSHOWMODEL_OFFSET UNITYSDK_OFFSET(0x16A94F80)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16A941E0)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_ONGAMEPADITEMSELECTED_OFFSET UNITYSDK_OFFSET(0x16A94270)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16A93850)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_ONSTOPAUDIOEVENTLIST_OFFSET UNITYSDK_OFFSET(0x16A96430)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_ONSTOPVOICE_OFFSET UNITYSDK_OFFSET(0x16A96390)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_PLAYAUDIOEVENTLIST_OFFSET UNITYSDK_OFFSET(0x16A95950)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_PLAYVOICE_OFFSET UNITYSDK_OFFSET(0x16A95C90)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0x16A93960)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_SETPLAYVOICEBTNSTATE_OFFSET UNITYSDK_OFFSET(0x16A96120)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_SETTEXT_OFFSET UNITYSDK_OFFSET(0x16A94320)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_SETVOICEICONSTATE_OFFSET UNITYSDK_OFFSET(0x16A94A10)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_STOPALLAUDIOINSELECTEDROW_OFFSET UNITYSDK_OFFSET(0x16A93490)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x16A96640)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16A96630)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16A966C0)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16A96750)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgameReviewRowWidgetController_TypeDefinitionIndex = 62010;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(UIGalgameReviewRowWidgetController_TypeDefinitionIndex)->GetStaticField(0x3F0E0);
		}
		static ::System::UInt32* StaticGet_lastItemVoicePendingId()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(UIGalgameReviewRowWidgetController_TypeDefinitionIndex)->GetStaticField(0xF380);
		}
		static ::System::Boolean* StaticGet_isLastVoiceFinish()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UIGalgameReviewRowWidgetController_TypeDefinitionIndex)->GetStaticField(0xF384);
		}
		static ::System::Boolean* StaticGet_isLastAudioEventListFinish()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UIGalgameReviewRowWidgetController_TypeDefinitionIndex)->GetStaticField(0xF385);
		}
		static ::System::Int32* StaticGet_lastPlayedRowIndex()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIGalgameReviewRowWidgetController_TypeDefinitionIndex)->GetStaticField(0xF388);
		}
		::Class_2_0946524052D5EA18_1* _view; // 0x2F0
