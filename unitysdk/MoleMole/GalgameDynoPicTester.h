...
#define MOLEMOLE_GALGAMEDYNOPICTESTER_METHOD_5_50B0C51E91B23365_OFFSET UNITYSDK_OFFSET(0x10D4D5F0)
#define MOLEMOLE_GALGAMEDYNOPICTESTER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x10D4D760)
#define MOLEMOLE_GALGAMEDYNOPICTESTER__CTOR_OFFSET UNITYSDK_OFFSET(0x10D4D5A0)

namespace MoleMole
{
	inline static constexpr unsigned int GalgameDynoPicTester_TypeDefinitionIndex = 82249;
