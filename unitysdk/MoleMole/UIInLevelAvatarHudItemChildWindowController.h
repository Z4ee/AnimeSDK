...
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_GETBUFFICONGAMEOBJECTBYBUFF_OFFSET UNITYSDK_OFFSET(0x14FDE6F0)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_GETSTUNSTRING_OFFSET UNITYSDK_OFFSET(0x14FDE970)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14FDE220)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x14FDE4F0)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14FDE580)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14FDE2B0)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14FDE480)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_REFRESHSHIELDARMORTEXT_OFFSET UNITYSDK_OFFSET(0x14FDE930)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_REORDERBUFFLIST_OFFSET UNITYSDK_OFFSET(0x14FDE8F0)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_SETDISABLE_OFFSET UNITYSDK_OFFSET(0x14FDE630)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x14FDE5F0)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14FDEA20)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14FDEA80)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x14FDEB10)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14FDEBD0)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14FDEBE0)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14FDEC80)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER___BASE_SETDISABLE_OFFSET UNITYSDK_OFFSET(0x14FDED10)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelAvatarHudItemChildWindowController_TypeDefinitionIndex = 42680;
	...
	public:
		...
		::System::Collections::Generic::List_1<::MoleMole::MonoBuffIcon*>* _BuffIconMap; // 0x368
		::System::Collections::Generic::List_1<::MoleMole::MonoBuffIcon*>* _UnUsedBuffIcons; // 0x370
		::System::Boolean _isHeavyAttackShow; // 0x378
		::System::Single _shieldSliderOriginVal; // 0x37C
		::System::Single _armorSliderOriginVal; // 0x380
		::System::Single _hpSliderOriginVal; // 0x384
		::UnityEngine::Transform* _newHudFollowTrans; // 0x388
		::Class_2_15880D2539860D46_Enum_3_9DBA21A6F4C405AF _stunMixinState; // 0x390
		::UnityEngine::Color _stunRecoverTextColor; // 0x394
		::UnityEngine::Color _stunNormalTextColor; // 0x3A4
		::Class_2_04388CC5C7B39D21* _view; // 0x3B8
