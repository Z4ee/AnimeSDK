...
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_GETBUFFICONGAMEOBJECTBYBUFF_OFFSET UNITYSDK_OFFSET(0x1732B3B0)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_GETSTUNSTRING_OFFSET UNITYSDK_OFFSET(0x1732B630)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1732AEE0)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x1732B1B0)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1732B240)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1732AF70)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1732B140)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_REFRESHSHIELDARMORTEXT_OFFSET UNITYSDK_OFFSET(0x1732B5F0)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_REORDERBUFFLIST_OFFSET UNITYSDK_OFFSET(0x1732B5B0)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_SETDISABLE_OFFSET UNITYSDK_OFFSET(0x1732B2F0)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1732B2B0)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1732B6E0)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1732B740)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x1732B7D0)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1732B890)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1732B8A0)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1732B940)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER___BASE_SETDISABLE_OFFSET UNITYSDK_OFFSET(0x1732B9D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelAvatarHudItemChildWindowController_TypeDefinitionIndex = 42089;
