...
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSORVIEWRECTCALLBACK_GET_ONMOVECONTENT_OFFSET UNITYSDK_OFFSET(0x136DD6D0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSORVIEWRECTCALLBACK_MOVECONTENT_1_OFFSET UNITYSDK_OFFSET(0x136DD780)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSORVIEWRECTCALLBACK_MOVECONTENT_OFFSET UNITYSDK_OFFSET(0x136DD6F0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSORVIEWRECTCALLBACK_SET_ONMOVECONTENT_OFFSET UNITYSDK_OFFSET(0x136DD6E0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSORVIEWRECTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x136DD820)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGamepadVirtualCursorViewRectCallback_TypeDefinitionIndex = 89188;
