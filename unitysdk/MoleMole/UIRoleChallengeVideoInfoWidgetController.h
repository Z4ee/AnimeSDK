...
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_CLOSEVIDEO_OFFSET UNITYSDK_OFFSET(0x147F5410)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_GETYOROZUYAVIDEOURL_OFFSET UNITYSDK_OFFSET(0x147F4E70)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x147F3460)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x147F5C80)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x147F5D00)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x147F34F0)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x147F38D0)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_OVERRIDELOOPTEXT_OFFSET UNITYSDK_OFFSET(0x147F5660)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_PLAYMAPLOGO_OFFSET UNITYSDK_OFFSET(0x147F5B50)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_SETLEVELINFO_OFFSET UNITYSDK_OFFSET(0x147F3D60)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_SETLOGOINFO_OFFSET UNITYSDK_OFFSET(0x147F44F0)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_SETNOISE_OFFSET UNITYSDK_OFFSET(0x147F56B0)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_SETPROGRESS_OFFSET UNITYSDK_OFFSET(0x147F4670)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_SETTIMECOST_OFFSET UNITYSDK_OFFSET(0x147F52C0)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_SETVIDEINFO_OFFSET UNITYSDK_OFFSET(0x147F3FD0)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_UPDATELEFTVIEW_OFFSET UNITYSDK_OFFSET(0x147F3940)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x147F60A0)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER__CLOSEVIDEO_B__14_0_OFFSET UNITYSDK_OFFSET(0x147F6100)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x147F5F60)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER__SETVIDEINFO_B__7_0_OFFSET UNITYSDK_OFFSET(0x147F60C0)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x147F6130)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x147F61C0)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x147F6250)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x147F62E0)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x147F6370)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleChallengeVideoInfoWidgetController_TypeDefinitionIndex = 58545;
	...
	public:
		...
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(UIRoleChallengeVideoInfoWidgetController_TypeDefinitionIndex)->GetStaticField(0x102B0);
		}
		...
		::Class_2_79AE422BA06F6D26_176* _view; // 0x2B8
		::System::Int32 hangState; // 0x2C0
		::System::Collections::Generic::List_1<::Class_1_7F489DAFAFC6BD02*>* challInfoList; // 0x2C8
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* lastSelectVideoDir; // 0x2D0
		::UnityEngine::UI::RawImage* _videoRawImg; // 0x2D8
		::Foundation::AssetRequestHandle _videoRequest; // 0x2E0
		::Class_1_E9529ED64113E4E9* _playerHelper; // 0x300
		::Il2CppArray<::Class_2_1A39E1B51756BF41*>* _rewardTypeIcons; // 0x308
		::Class_2_0A55B5A82A61DAFA_2* _selectQuestConfig; // 0x310
		::Class_2_208CC9941471731A_832* _selectHollowExcelConfig; // 0x318
		::Class_1_A047EA5169B6B30F* _selectQuestInfo; // 0x320
		::Class_2_E664D9FA0EBE07B0* questModel; // 0x328
		::Class_2_47BEEACD66EA947F* _yorozuyaModel; // 0x330
		::System::Boolean isOpenVideoPanel; // 0x338
		::System::UInt32 leftVideoSoundPlayID; // 0x33C
		::MoleMole::UIHollowTaskDialogPopWindowController* _taskDialog; // 0x340
		::UnityEngine::Material* difficutyVideoMaterial; // 0x348
		::Foundation::AssetRequestHandle _aniCloneMatHandle; // 0x350
		::System::String* lastNeedleType; // 0x370
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_0A55B5A82A61DAFA_2*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_UPDATELEFTVIEW_OFFSET))(this, _questConfig);
		}
