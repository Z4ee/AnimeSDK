...
class Class_2_F9471F3BB5949932_17;
...
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_CLOSEVIDEO_OFFSET UNITYSDK_OFFSET(0x15F6D720)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_GETYOROZUYAVIDEOURL_OFFSET UNITYSDK_OFFSET(0x15F6D180)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15F6B780)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x15F6DF90)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15F6E010)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15F6B810)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15F6BBF0)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_OVERRIDELOOPTEXT_OFFSET UNITYSDK_OFFSET(0x15F6D970)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_PLAYMAPLOGO_OFFSET UNITYSDK_OFFSET(0x15F6DE60)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_SETLEVELINFO_OFFSET UNITYSDK_OFFSET(0x15F6C080)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_SETLOGOINFO_OFFSET UNITYSDK_OFFSET(0x15F6C810)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_SETNOISE_OFFSET UNITYSDK_OFFSET(0x15F6D9C0)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_SETPROGRESS_OFFSET UNITYSDK_OFFSET(0x15F6C990)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_SETTIMECOST_OFFSET UNITYSDK_OFFSET(0x15F6D5D0)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_SETVIDEINFO_OFFSET UNITYSDK_OFFSET(0x15F6C2F0)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER_UPDATELEFTVIEW_OFFSET UNITYSDK_OFFSET(0x15F6BC60)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x15F6E3B0)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER__CLOSEVIDEO_B__14_0_OFFSET UNITYSDK_OFFSET(0x15F6E410)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15F6E270)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER__SETVIDEINFO_B__7_0_OFFSET UNITYSDK_OFFSET(0x15F6E3D0)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15F6E440)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x15F6E4D0)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15F6E560)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15F6E5F0)
#define MOLEMOLE_UIROLECHALLENGEVIDEOINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15F6E680)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleChallengeVideoInfoWidgetController_TypeDefinitionIndex = 76734;
	...
	public:
		...
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(UIRoleChallengeVideoInfoWidgetController_TypeDefinitionIndex)->GetStaticField(0x11ED0);
		}
		...
		::Class_2_F9471F3BB5949932_17* _view; // 0x2C0
		::System::Int32 hangState; // 0x2C8
		::System::Collections::Generic::List_1<::Class_1_3437E8F8CEFA7AE1*>* challInfoList; // 0x2D0
		...
		::Class_2_208CC9941471731A_893* _selectHollowExcelConfig; // 0x320
		::Class_1_F24A790D52CF0024* _selectQuestInfo; // 0x328
		::Class_2_696E0C6E8A7D9C84* questModel; // 0x330
