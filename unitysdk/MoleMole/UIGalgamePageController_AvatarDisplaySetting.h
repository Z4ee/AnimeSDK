...
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_CLEARASSEMBLYNPCGO_OFFSET UNITYSDK_OFFSET(0x13E9AC50)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_CLEARAVATARVIDEOPLAYER_OFFSET UNITYSDK_OFFSET(0x13E9A240)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_CLEAREFFECTENTITIES_OFFSET UNITYSDK_OFFSET(0x14FABE00)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_CLEARFILTER_OFFSET UNITYSDK_OFFSET(0x14FABDB0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_CLEARROLEINFO_1_OFFSET UNITYSDK_OFFSET(0x13E9A660)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_CLEARROLEINFO_OFFSET UNITYSDK_OFFSET(0x13E9A430)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_CLEARUIWIDGET_OFFSET UNITYSDK_OFFSET(0x14FAC3B0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_CLEARWINKITEM_OFFSET UNITYSDK_OFFSET(0x13E9A360)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_CLEAR_OFFSET UNITYSDK_OFFSET(0x14FAC530)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_ASSEMBLYNPCGO_OFFSET UNITYSDK_OFFSET(0x13E999B0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_CHARACTERTEXTURESHEETNAME_OFFSET UNITYSDK_OFFSET(0x13E99B20)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_FACIALKEY_OFFSET UNITYSDK_OFFSET(0x13E99960)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_FILTER_OFFSET UNITYSDK_OFFSET(0x13E99B40)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_INITSHOWSETTING_OFFSET UNITYSDK_OFFSET(0x13E99B60)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_ISASSEMBLYNPC_OFFSET UNITYSDK_OFFSET(0x13E999D0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_ISUSINGTEXTURESHEET_OFFSET UNITYSDK_OFFSET(0x13E99AE0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_ISVIDEO_OFFSET UNITYSDK_OFFSET(0x13E999A0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_POSEKEY_OFFSET UNITYSDK_OFFSET(0x13E99940)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_ROLEINFO_OFFSET UNITYSDK_OFFSET(0x13E99920)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_TEXTURESHEETNODEPATH_OFFSET UNITYSDK_OFFSET(0x13E99B00)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_VIDEOPLAYER_OFFSET UNITYSDK_OFFSET(0x13E99980)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_WINKITEM_OFFSET UNITYSDK_OFFSET(0x13E99900)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_INITTEXTURESHEETUSING_OFFSET UNITYSDK_OFFSET(0x13E99BF0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETASSEMBLYNPCGO_OFFSET UNITYSDK_OFFSET(0x13E9A0F0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETAVATARVIDEOPLAYER_OFFSET UNITYSDK_OFFSET(0x13E9A0A0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETEFFECTLIST_OFFSET UNITYSDK_OFFSET(0x13E99F20)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETFACIALKEY_OFFSET UNITYSDK_OFFSET(0x13E9A1A0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETFILTER_OFFSET UNITYSDK_OFFSET(0x13E9A1F0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETINITSHOWSETTING_OFFSET UNITYSDK_OFFSET(0x13E99B80)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETPOSEKEY_OFFSET UNITYSDK_OFFSET(0x13E9A150)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETROLEINFO_OFFSET UNITYSDK_OFFSET(0x13E9A040)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETUIWIDGET_OFFSET UNITYSDK_OFFSET(0x13E99F90)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETWINKITEM_OFFSET UNITYSDK_OFFSET(0x13E99FE0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_ASSEMBLYNPCGO_OFFSET UNITYSDK_OFFSET(0x13E999C0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_CHARACTERTEXTURESHEETNAME_OFFSET UNITYSDK_OFFSET(0x13E99B30)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_FACIALKEY_OFFSET UNITYSDK_OFFSET(0x13E99970)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_FILTER_OFFSET UNITYSDK_OFFSET(0x13E99B50)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_INITSHOWSETTING_OFFSET UNITYSDK_OFFSET(0x13E99B70)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_ISUSINGTEXTURESHEET_OFFSET UNITYSDK_OFFSET(0x13E99AF0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_POSEKEY_OFFSET UNITYSDK_OFFSET(0x13E99950)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_ROLEINFO_OFFSET UNITYSDK_OFFSET(0x13E99930)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_TEXTURESHEETNODEPATH_OFFSET UNITYSDK_OFFSET(0x13E99B10)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_VIDEOPLAYER_OFFSET UNITYSDK_OFFSET(0x13E99990)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_WINKITEM_OFFSET UNITYSDK_OFFSET(0x13E99910)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_TRYRESETGENERALTEXTURESHEETCOMPONENT_OFFSET UNITYSDK_OFFSET(0x13E9A6F0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x13E99BD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgamePageController_AvatarDisplaySetting_TypeDefinitionIndex = 41813;

	class UIGalgamePageController_AvatarDisplaySetting : public ::System::Object
	{
	public:
		::MoleMole::AvatarShowSetting* _initShowSetting_k__BackingField; // 0x10
		::System::String* _CharacterTextureSheetName_k__BackingField; // 0x18
		::System::String* _poseKey_k__BackingField; // 0x20
		::System::String* _TextureSheetNodePath_k__BackingField; // 0x28
		::System::Collections::Generic::List_1<::MoleMole::EntityHandle>* longLiveEffectEntities; // 0x30
		::MoleMole::UIGalgamePageController_UIRoleInfo* _roleInfo_k__BackingField; // 0x38
		::MoleMole::IVideoPlayer* _videoPlayer_k__BackingField; // 0x40
		::System::String* _facialKey_k__BackingField; // 0x48
		::Class_1_9CFBC14B74B66E2C* _winkItem_k__BackingField; // 0x50
		::System::Action_1<::Class_1_9CFBC14B74B66E2C*>* winkItemRetrieveAction; // 0x58
		::System::Action_1<::MoleMole::UIGalgamePageController_UIRoleInfo*>* roleInfoRetrieveAction; // 0x60
		::MoleMole::UIWidgetController* uiWidget; // 0x68
		::System::Action* OnClear; // 0x70
		::UnityEngine::GameObject* _assemblyNpcGO_k__BackingField; // 0x78
		::Class_1_39F32ADA6528F94C* _filter_k__BackingField; // 0x80
		::System::UInt32 entityID; // 0x88
		::System::Int32 actorId; // 0x8C
		::System::Int32 emotionIdx; // 0x90
		::System::Boolean _NPCGoUseSelfLightSetting; // 0x94
		::System::Boolean _IsUsingTextureSheet_k__BackingField; // 0x95
		::System::Boolean isAvatarShowing; // 0x96
		::System::Boolean enableForbiddenMaterialEffect; // 0x97
		...
		::Class_1_39F32ADA6528F94C* get_filter()
		{
			return ((::Class_1_39F32ADA6528F94C*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_FILTER_OFFSET))(this);
		}

		::System::Void set_filter(::Class_1_39F32ADA6528F94C* value)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_39F32ADA6528F94C*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_FILTER_OFFSET))(this, value);
		}
		...
		::System::Void SetFilter(::Class_1_39F32ADA6528F94C* filter)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_39F32ADA6528F94C*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETFILTER_OFFSET))(this, filter);
		}
