...
#define MOLEMOLE_SHOPPINGMALLRECOMMENDATIONCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x11DF89E0)

namespace MoleMole
{
	inline static constexpr unsigned int ShoppingMallRecommendationContext_TypeDefinitionIndex = 68260;
	...
	public:
		...
		::Class_2_B4378B46E0020E85* Down_BuyBtn; // 0x70
