...
#define MOLEMOLE_SHOPPINGMALLRECOMMENDATIONCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x11D70400)

namespace MoleMole
{
	inline static constexpr unsigned int ShoppingMallRecommendationContext_TypeDefinitionIndex = 81371;

	class ShoppingMallRecommendationContext : public ::MoleMole::ShoppingMallBaseContextBase
	{
	public:
		::Class_1_E43D938AEBE01021* tabData; // 0x58
		::Class_2_B4378B46E0020E85* Down_BuyBtn; // 0x60
		::Class_2_B4378B46E0020E85* Down_PreviewBtn; // 0x68
