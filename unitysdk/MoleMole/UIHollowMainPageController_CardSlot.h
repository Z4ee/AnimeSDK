...
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_CARDSLOT_REFRESHMUTE_OFFSET UNITYSDK_OFFSET(0x19618BA0)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_CARDSLOT_SETCARD_OFFSET UNITYSDK_OFFSET(0x19618A80)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_CARDSLOT_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x19618A00)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_CARDSLOT_SETSCALE_OFFSET UNITYSDK_OFFSET(0x19618B10)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_CARDSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x19618850)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMainPageController_CardSlot_TypeDefinitionIndex = 73678;
