...
#define MOLEMOLE_UIGENERALSETTINGSWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x167A8090)
#define MOLEMOLE_UIGENERALSETTINGSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x167A89E0)
#define MOLEMOLE_UIGENERALSETTINGSWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x167A8AF0)
#define MOLEMOLE_UIGENERALSETTINGSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x167A8A70)
#define MOLEMOLE_UIGENERALSETTINGSWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x167A7F60)
#define MOLEMOLE_UIGENERALSETTINGSWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x167A8B50)
#define MOLEMOLE_UIGENERALSETTINGSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x167A8BA0)
#define MOLEMOLE_UIGENERALSETTINGSWIDGETCONTROLLER__ONUIOPEN_B__1_0_OFFSET UNITYSDK_OFFSET(0x167A8C80)
#define MOLEMOLE_UIGENERALSETTINGSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x167A8D20)
#define MOLEMOLE_UIGENERALSETTINGSWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x167A8DB0)
#define MOLEMOLE_UIGENERALSETTINGSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x167A8E40)
#define MOLEMOLE_UIGENERALSETTINGSWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x167A8ED0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralSettingsWidgetController_TypeDefinitionIndex = 39659;
