...
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_ACTIVATEBONUS_OFFSET UNITYSDK_OFFSET(0x15F0A050)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_ACTIVATEFEVER_OFFSET UNITYSDK_OFFSET(0x15F09DD0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_ADDTICK_OFFSET UNITYSDK_OFFSET(0x15F09F50)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_GETSCORERANKINFO_OFFSET UNITYSDK_OFFSET(0x15F09CB0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_INITDATA_OFFSET UNITYSDK_OFFSET(0x15F08A20)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_INITSCORERANK_OFFSET UNITYSDK_OFFSET(0x15F09110)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x15F08E80)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15F08AA0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_ONSHOOTSCORECHANGE_OFFSET UNITYSDK_OFFSET(0x15F095E0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15F08B30)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15F08660)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15F088E0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_REFRESHSCORERANKINFO_OFFSET UNITYSDK_OFFSET(0x15F09720)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_REMOVETICK_OFFSET UNITYSDK_OFFSET(0x15F0A0C0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_SETCOREPROGRESS_OFFSET UNITYSDK_OFFSET(0x15F09920)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_SETGLOW_OFFSET UNITYSDK_OFFSET(0x15F09E60)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0x15F0A1C0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15F0A270)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15F0A580)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15F0A610)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15F0A6A0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15F0A730)

namespace MoleMole
{
	inline static constexpr unsigned int UIMusicBattleInLevelScoreActionWidgetController_TypeDefinitionIndex = 68734;

	class UIMusicBattleInLevelScoreActionWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_724B3079070B9259_5* _view; // 0x2C0
