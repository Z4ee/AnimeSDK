...
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS69_1__CTOR_OFFSET UNITYSDK_OFFSET(0x19139B30)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS69_1__SHOWNARRATORSCREEN_G__PLAYGALEFFECT_5_OFFSET UNITYSDK_OFFSET(0x19139B40)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityChatPlayWidgetController___c__DisplayClass69_1_TypeDefinitionIndex = 77930;
	...
	public:
		...
		::MoleMole::UIMainCityChatPlayWidgetController___c__DisplayClass69_0* CS___8__locals1; // 0x18
