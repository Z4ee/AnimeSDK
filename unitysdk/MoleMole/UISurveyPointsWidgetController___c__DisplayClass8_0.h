...
#define MOLEMOLE_UISURVEYPOINTSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x191549E0)
#define MOLEMOLE_UISURVEYPOINTSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__REFRESHCONTROBUTEVIEW_B__1_OFFSET UNITYSDK_OFFSET(0x191549F0)
#define MOLEMOLE_UISURVEYPOINTSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__REFRESHCONTROBUTEVIEW_B__2_OFFSET UNITYSDK_OFFSET(0x19154EB0)
#define MOLEMOLE_UISURVEYPOINTSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__REFRESHCONTROBUTEVIEW_B__3_OFFSET UNITYSDK_OFFSET(0x19155100)
#define MOLEMOLE_UISURVEYPOINTSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__REFRESHCONTROBUTEVIEW_B__4_OFFSET UNITYSDK_OFFSET(0x191553A0)
#define MOLEMOLE_UISURVEYPOINTSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__REFRESHCONTROBUTEVIEW_B__6_OFFSET UNITYSDK_OFFSET(0x191555F0)
#define MOLEMOLE_UISURVEYPOINTSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__REFRESHCONTROBUTEVIEW_B__7_OFFSET UNITYSDK_OFFSET(0x19155670)
#define MOLEMOLE_UISURVEYPOINTSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__REFRESHCONTROBUTEVIEW_B__8_OFFSET UNITYSDK_OFFSET(0x19155900)
#define MOLEMOLE_UISURVEYPOINTSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__REFRESHCONTROBUTEVIEW_G__ONPROGRESS_0_OFFSET UNITYSDK_OFFSET(0x19154C90)

namespace MoleMole
{
	inline static constexpr unsigned int UISurveyPointsWidgetController___c__DisplayClass8_0_TypeDefinitionIndex = 76737;

	class UISurveyPointsWidgetController___c__DisplayClass8_0 : public ::System::Object
	{
	public:
		::System::Action* __9__6; // 0x10
		::MoleMole::UISurveyPointsWidgetController* __4__this; // 0x18
		::System::Action* __9__7; // 0x20
		::System::Action* __9__8; // 0x28
		::System::Int32 curLevel; // 0x30
		::System::Single realExpProgressDuration; // 0x34
		::System::Single curRatio; // 0x38
		::System::Int32 currentAbyssPoint; // 0x3C
		::System::Single minRatio; // 0x40
		::System::Int32 levelNeedExp; // 0x44
		::System::ValueTuple_3<::System::Boolean, ::System::Int32, ::System::Int32> progressData; // 0x48
		::System::Single timer; // 0x54
		::System::Int32 lastExp; // 0x58
		::System::Boolean isMaxLevel; // 0x5C
		::System::Single prvRatio; // 0x60
