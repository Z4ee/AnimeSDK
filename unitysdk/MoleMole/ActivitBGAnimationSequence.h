...
#define MOLEMOLE_ACTIVITBGANIMATIONSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x17513030)

namespace MoleMole
{
	inline static constexpr unsigned int ActivitBGAnimationSequence_TypeDefinitionIndex = 63679;
