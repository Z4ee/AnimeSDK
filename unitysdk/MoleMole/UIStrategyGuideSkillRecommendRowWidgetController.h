...
class Class_2_741FF4CEF6E2E89E_1;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }

#define MOLEMOLE_UISTRATEGYGUIDESKILLRECOMMENDROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1847C3B0)
#define MOLEMOLE_UISTRATEGYGUIDESKILLRECOMMENDROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1847C440)
#define MOLEMOLE_UISTRATEGYGUIDESKILLRECOMMENDROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1847C2E0)
#define MOLEMOLE_UISTRATEGYGUIDESKILLRECOMMENDROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1847C340)
#define MOLEMOLE_UISTRATEGYGUIDESKILLRECOMMENDROWWIDGETCONTROLLER_REFRESHSKILLICON_OFFSET UNITYSDK_OFFSET(0x1847C4C0)
#define MOLEMOLE_UISTRATEGYGUIDESKILLRECOMMENDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1847C7D0)
#define MOLEMOLE_UISTRATEGYGUIDESKILLRECOMMENDROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1847C830)
#define MOLEMOLE_UISTRATEGYGUIDESKILLRECOMMENDROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1847C8C0)
#define MOLEMOLE_UISTRATEGYGUIDESKILLRECOMMENDROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1847C950)
#define MOLEMOLE_UISTRATEGYGUIDESKILLRECOMMENDROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1847C9E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIStrategyGuideSkillRecommendRowWidgetController_TypeDefinitionIndex = 89829;

	class UIStrategyGuideSkillRecommendRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_741FF4CEF6E2E89E_1* _view; // 0x2C0
