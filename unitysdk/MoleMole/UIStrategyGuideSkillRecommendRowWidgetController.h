...
#define MOLEMOLE_UISTRATEGYGUIDESKILLRECOMMENDROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16DC6170)
#define MOLEMOLE_UISTRATEGYGUIDESKILLRECOMMENDROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16DC6200)
#define MOLEMOLE_UISTRATEGYGUIDESKILLRECOMMENDROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16DC60A0)
#define MOLEMOLE_UISTRATEGYGUIDESKILLRECOMMENDROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16DC6100)
#define MOLEMOLE_UISTRATEGYGUIDESKILLRECOMMENDROWWIDGETCONTROLLER_REFRESHSKILLICON_OFFSET UNITYSDK_OFFSET(0x16DC6280)
#define MOLEMOLE_UISTRATEGYGUIDESKILLRECOMMENDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16DC6590)
#define MOLEMOLE_UISTRATEGYGUIDESKILLRECOMMENDROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16DC65F0)
#define MOLEMOLE_UISTRATEGYGUIDESKILLRECOMMENDROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16DC6680)
#define MOLEMOLE_UISTRATEGYGUIDESKILLRECOMMENDROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16DC6710)
#define MOLEMOLE_UISTRATEGYGUIDESKILLRECOMMENDROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16DC67A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIStrategyGuideSkillRecommendRowWidgetController_TypeDefinitionIndex = 77212;
