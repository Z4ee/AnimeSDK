...
#define MOLEMOLE_UIARCADEACHIEVEMENTPOPWINDOWCONTROLLER_CREATEACHIEVEMENT_OFFSET UNITYSDK_OFFSET(0x1589D700)
#define MOLEMOLE_UIARCADEACHIEVEMENTPOPWINDOWCONTROLLER_GETARCADEGAMEPARAMS_OFFSET UNITYSDK_OFFSET(0x1589B7B0)
#define MOLEMOLE_UIARCADEACHIEVEMENTPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1589B360)
#define MOLEMOLE_UIARCADEACHIEVEMENTPOPWINDOWCONTROLLER_ONACHIEVEMENTUPDATE_OFFSET UNITYSDK_OFFSET(0x1589D6B0)
#define MOLEMOLE_UIARCADEACHIEVEMENTPOPWINDOWCONTROLLER_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1589D470)
#define MOLEMOLE_UIARCADEACHIEVEMENTPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1589CA70)
#define MOLEMOLE_UIARCADEACHIEVEMENTPOPWINDOWCONTROLLER_ONDROPDOWNCHANGE_OFFSET UNITYSDK_OFFSET(0x1589D7B0)
#define MOLEMOLE_UIARCADEACHIEVEMENTPOPWINDOWCONTROLLER_ONRECEIVEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1589D4C0)
#define MOLEMOLE_UIARCADEACHIEVEMENTPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1589CB00)
#define MOLEMOLE_UIARCADEACHIEVEMENTPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1589B370)
#define MOLEMOLE_UIARCADEACHIEVEMENTPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1589B570)
#define MOLEMOLE_UIARCADEACHIEVEMENTPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1589BDA0)
#define MOLEMOLE_UIARCADEACHIEVEMENTPOPWINDOWCONTROLLER_SETTITLE_OFFSET UNITYSDK_OFFSET(0x1589CCF0)
#define MOLEMOLE_UIARCADEACHIEVEMENTPOPWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1589D840)
#define MOLEMOLE_UIARCADEACHIEVEMENTPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1589D830)
#define MOLEMOLE_UIARCADEACHIEVEMENTPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1589D890)
#define MOLEMOLE_UIARCADEACHIEVEMENTPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1589D920)
#define MOLEMOLE_UIARCADEACHIEVEMENTPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1589D930)
#define MOLEMOLE_UIARCADEACHIEVEMENTPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1589D940)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeAchievementPopWindowController_TypeDefinitionIndex = 41358;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIArcadeAchievementPopWindowController_TypeDefinitionIndex)->GetStaticField(0x495E0);
		}
		static ::System::String** StaticGet__iconPath1()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIArcadeAchievementPopWindowController_TypeDefinitionIndex)->GetStaticField(0x495E8);
		}
		::Class_2_79AE422BA06F6D26_56* _view; // 0x310
		::System::Int32 _arcadeGameID; // 0x318
		::System::Collections::Generic::List_1<::Class_1_7807B2B04302CD7B_5*>* _achievementIDList; // 0x320
		::System::Int32 _lockNum; // 0x328
		::Class_1_4E1DB51D0780DCEB* _dropDown; // 0x330
		::System::Collections::Generic::List_1<::System::Int32>* _dropDownIds; // 0x338
		::MoleMole::UIItemIconBtnSmallWidgetController* _titleItemWidget; // 0x340
