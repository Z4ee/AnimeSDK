...
#define MOLEMOLE_BASEUIFLOWERSHOPTASKPAGECONTROLLER_GETCURRENTSHOWDATA_OFFSET UNITYSDK_OFFSET(0x12C4A0F0)
#define MOLEMOLE_BASEUIFLOWERSHOPTASKPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x12C49A00)
#define MOLEMOLE_BASEUIFLOWERSHOPTASKPAGECONTROLLER_ISOPENBYTYPE_OFFSET UNITYSDK_OFFSET(0x12C4A3D0)
#define MOLEMOLE_BASEUIFLOWERSHOPTASKPAGECONTROLLER_ONCLICKGOTOTASKBUTTON_OFFSET UNITYSDK_OFFSET(0x12C4AFA0)
#define MOLEMOLE_BASEUIFLOWERSHOPTASKPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12C49A10)
#define MOLEMOLE_BASEUIFLOWERSHOPTASKPAGECONTROLLER_ONFLOWERSHOPDATACHANGEEVENT_OFFSET UNITYSDK_OFFSET(0x12C4B050)
#define MOLEMOLE_BASEUIFLOWERSHOPTASKPAGECONTROLLER_ONFLOWERSHOPTASKCHANGEEVENT_OFFSET UNITYSDK_OFFSET(0x12C4AFF0)
#define MOLEMOLE_BASEUIFLOWERSHOPTASKPAGECONTROLLER_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x12C4ABB0)
#define MOLEMOLE_BASEUIFLOWERSHOPTASKPAGECONTROLLER_ONGOTOTASKBUTTON_OFFSET UNITYSDK_OFFSET(0x12C4AE40)
#define MOLEMOLE_BASEUIFLOWERSHOPTASKPAGECONTROLLER_ONSELECTITEM_OFFSET UNITYSDK_OFFSET(0x12C4AD10)
#define MOLEMOLE_BASEUIFLOWERSHOPTASKPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12C4A360)
#define MOLEMOLE_BASEUIFLOWERSHOPTASKPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12C49B70)
#define MOLEMOLE_BASEUIFLOWERSHOPTASKPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12C49ED0)
#define MOLEMOLE_BASEUIFLOWERSHOPTASKPAGECONTROLLER_SELECTITEMBYDATA_OFFSET UNITYSDK_OFFSET(0x12C4A2F0)
#define MOLEMOLE_BASEUIFLOWERSHOPTASKPAGECONTROLLER_SELECTITEMBYID_OFFSET UNITYSDK_OFFSET(0x12C4A540)
#define MOLEMOLE_BASEUIFLOWERSHOPTASKPAGECONTROLLER_SHOWALLITEMBYTYPE_OFFSET UNITYSDK_OFFSET(0x12C4A020)
#define MOLEMOLE_BASEUIFLOWERSHOPTASKPAGECONTROLLER_SHOWPANELBYITEMDATA_OFFSET UNITYSDK_OFFSET(0x12C4A6A0)
#define MOLEMOLE_BASEUIFLOWERSHOPTASKPAGECONTROLLER_SORTMETHOD_OFFSET UNITYSDK_OFFSET(0x12C4A4A0)
#define MOLEMOLE_BASEUIFLOWERSHOPTASKPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12C4B0A0)
#define MOLEMOLE_BASEUIFLOWERSHOPTASKPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12C4B130)
#define MOLEMOLE_BASEUIFLOWERSHOPTASKPAGECONTROLLER___BASE_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x12C4B1C0)
#define MOLEMOLE_BASEUIFLOWERSHOPTASKPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12C4B2B0)
#define MOLEMOLE_BASEUIFLOWERSHOPTASKPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12C4B2C0)
#define MOLEMOLE_BASEUIFLOWERSHOPTASKPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12C4B2D0)

namespace MoleMole
{
	inline static constexpr unsigned int BaseUIFlowerShopTaskPageController_TypeDefinitionIndex = 58534;

	class BaseUIFlowerShopTaskPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_8FCB22336286BF09_1* _view; // 0x318
		::Class_2_923BB6EA0D9B637B* _model; // 0x320
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_584*>* _dataList; // 0x328
		::Class_2_208CC9941471731A_584* _currentData; // 0x330
		...
		::Class_2_208CC9941471731A_584* GetCurrentShowData()
		{
			return ((::Class_2_208CC9941471731A_584*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_BASEUIFLOWERSHOPTASKPAGECONTROLLER_GETCURRENTSHOWDATA_OFFSET))(this);
		}

		::System::Int32 SortMethod(::Class_2_208CC9941471731A_584* a, ::Class_2_208CC9941471731A_584* b)
		{
			return ((::System::Int32(*)(::PVOID, ::Class_2_208CC9941471731A_584*, ::Class_2_208CC9941471731A_584*))((::PBYTE)hIl2Cpp + MOLEMOLE_BASEUIFLOWERSHOPTASKPAGECONTROLLER_SORTMETHOD_OFFSET))(this, a, b);
		}
		...
		::System::Void SelectItemByData(::Class_2_208CC9941471731A_584* data)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_584*))((::PBYTE)hIl2Cpp + MOLEMOLE_BASEUIFLOWERSHOPTASKPAGECONTROLLER_SELECTITEMBYDATA_OFFSET))(this, data);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_584*))((::PBYTE)hIl2Cpp + MOLEMOLE_BASEUIFLOWERSHOPTASKPAGECONTROLLER_ONCLICKGOTOTASKBUTTON_OFFSET))(this, currentData);
		}
