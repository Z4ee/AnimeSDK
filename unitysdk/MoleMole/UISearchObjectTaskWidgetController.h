...
#define MOLEMOLE_UISEARCHOBJECTTASKWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17B84510)
#define MOLEMOLE_UISEARCHOBJECTTASKWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17B84620)
#define MOLEMOLE_UISEARCHOBJECTTASKWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17B845A0)
#define MOLEMOLE_UISEARCHOBJECTTASKWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17B843B0)
#define MOLEMOLE_UISEARCHOBJECTTASKWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17B84680)
#define MOLEMOLE_UISEARCHOBJECTTASKWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17B84690)
#define MOLEMOLE_UISEARCHOBJECTTASKWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17B84720)
#define MOLEMOLE_UISEARCHOBJECTTASKWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17B847C0)
#define MOLEMOLE_UISEARCHOBJECTTASKWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17B84850)

namespace MoleMole
{
	inline static constexpr unsigned int UISearchObjectTaskWidgetController_TypeDefinitionIndex = 55023;
