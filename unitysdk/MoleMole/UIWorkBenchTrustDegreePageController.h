...
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_BINDEVENT_BUTTON_OFFSET UNITYSDK_OFFSET(0x16E08E90)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_BINDEVENT_NOTIFY_OFFSET UNITYSDK_OFFSET(0x16E09580)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_BINDEVENT_SCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x16E09310)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_BINDEVENT_TABBUTTONGROUP_OFFSET UNITYSDK_OFFSET(0x16E09050)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_BUILDPARTNERDATA_OFFSET UNITYSDK_OFFSET(0x16E0BF30)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x16E08D80)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_INITPARTNERCAMPDATA_OFFSET UNITYSDK_OFFSET(0x16E09FC0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_INITPARTNERDATA_OFFSET UNITYSDK_OFFSET(0x16E0BC50)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_INITWIDGET_OFFSET UNITYSDK_OFFSET(0x16E09620)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16E08D90)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x16E0B200)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x16E0B300)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_ONSELECTCAMPTYPE_OFFSET UNITYSDK_OFFSET(0x16E0B6A0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x16E0B400)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16E0B190)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16E08E20)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16E096C0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_ONWORKBENCHDATAUPDATE_OFFSET UNITYSDK_OFFSET(0x16E0C590)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_SELECTEDCAMP_OFFSET UNITYSDK_OFFSET(0x16E0B8A0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_SELECTEDTRUSTDEGREEITEM_OFFSET UNITYSDK_OFFSET(0x16E0C260)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_TRYREADLASTPARTNERPOPUPS_OFFSET UNITYSDK_OFFSET(0x16E0C3C0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER__BINDEVENT_BUTTON_B__11_0_OFFSET UNITYSDK_OFFSET(0x16E0C740)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16E0C5E0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER__ONUIOPEN_G__GETCAMPINDEX_6_1_OFFSET UNITYSDK_OFFSET(0x16E0AE20)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER__ONUIOPEN_G__GETCAMPTYPEINDEX_6_0_OFFSET UNITYSDK_OFFSET(0x16E0AD30)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER__ONUIOPEN_G__GETPARTNERINDEX_6_2_OFFSET UNITYSDK_OFFSET(0x16E0AFF0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16E0C840)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x16E0C8D0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x16E0C960)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x16E0C9F0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16E0CAB0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16E0CAC0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16E0CAD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkBenchTrustDegreePageController_TypeDefinitionIndex = 50970;

	class UIWorkBenchTrustDegreePageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_57F4F2E1F75850CE* _view; // 0x318
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::Class_2_6D99A03C58ED2B6E_2*>*>* _partnerCampConfigTemplateDatas; // 0x320
