...
#define MOLEMOLE_UIRABTRAINEXPGAINTOPTIP_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x152AAE40)
#define MOLEMOLE_UIRABTRAINEXPGAINTOPTIP__CTOR_OFFSET UNITYSDK_OFFSET(0x152AAE20)
#define MOLEMOLE_UIRABTRAINEXPGAINTOPTIP___BASE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x152AB0C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABTrainExpGainTopTip_TypeDefinitionIndex = 73745;
