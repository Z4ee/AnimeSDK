...
#define MOLEMOLE_UIRABMONSTERHUDWIDGETCONTROLLER_CLONEMATERIALS_OFFSET UNITYSDK_OFFSET(0x16750580)
#define MOLEMOLE_UIRABMONSTERHUDWIDGETCONTROLLER_DISPOSEMATERIALS_OFFSET UNITYSDK_OFFSET(0x167504C0)
#define MOLEMOLE_UIRABMONSTERHUDWIDGETCONTROLLER_GETBUFFTEMPLATEOBJECT_OFFSET UNITYSDK_OFFSET(0x16750F40)
#define MOLEMOLE_UIRABMONSTERHUDWIDGETCONTROLLER_GETHPANIMATION_OFFSET UNITYSDK_OFFSET(0x16750FA0)
#define MOLEMOLE_UIRABMONSTERHUDWIDGETCONTROLLER_GET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x16750E10)
#define MOLEMOLE_UIRABMONSTERHUDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16750850)
#define MOLEMOLE_UIRABMONSTERHUDWIDGETCONTROLLER_ONSHOWELEMENTADVANTAGE_OFFSET UNITYSDK_OFFSET(0x16750E70)
#define MOLEMOLE_UIRABMONSTERHUDWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x16750990)
#define MOLEMOLE_UIRABMONSTERHUDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x167508E0)
#define MOLEMOLE_UIRABMONSTERHUDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16750360)
#define MOLEMOLE_UIRABMONSTERHUDWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16750800)
#define MOLEMOLE_UIRABMONSTERHUDWIDGETCONTROLLER_REFRESHVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16750A40)
#define MOLEMOLE_UIRABMONSTERHUDWIDGETCONTROLLER_TOGGLEDRAG_OFFSET UNITYSDK_OFFSET(0x16750CE0)
#define MOLEMOLE_UIRABMONSTERHUDWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x167509E0)
#define MOLEMOLE_UIRABMONSTERHUDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16751000)
#define MOLEMOLE_UIRABMONSTERHUDWIDGETCONTROLLER___BASE_GETBUFFTEMPLATEOBJECT_OFFSET UNITYSDK_OFFSET(0x16751020)
#define MOLEMOLE_UIRABMONSTERHUDWIDGETCONTROLLER___BASE_GETHPANIMATION_OFFSET UNITYSDK_OFFSET(0x167510B0)
#define MOLEMOLE_UIRABMONSTERHUDWIDGETCONTROLLER___BASE_GET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x16751010)
#define MOLEMOLE_UIRABMONSTERHUDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16751140)
#define MOLEMOLE_UIRABMONSTERHUDWIDGETCONTROLLER___BASE_ONSHOWELEMENTADVANTAGE_OFFSET UNITYSDK_OFFSET(0x167511D0)
#define MOLEMOLE_UIRABMONSTERHUDWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x16751270)
#define MOLEMOLE_UIRABMONSTERHUDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16751280)
#define MOLEMOLE_UIRABMONSTERHUDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16751380)
#define MOLEMOLE_UIRABMONSTERHUDWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16751390)
#define MOLEMOLE_UIRABMONSTERHUDWIDGETCONTROLLER___BASE_REFRESHVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x167513A0)
#define MOLEMOLE_UIRABMONSTERHUDWIDGETCONTROLLER___BASE_TOGGLEDRAG_OFFSET UNITYSDK_OFFSET(0x16751470)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABMonsterHudWidgetController_TypeDefinitionIndex = 49758;
	...
	public:
		...
		::Class_2_3A2CE11EFCE3C592_Class_2_7D6483DC96481CD2* _barView; // 0x340
		...
		::System::Void CloneMaterials(::Class_2_3A2CE11EFCE3C592_Class_2_7D6483DC96481CD2* view, ::UnityEngine::Material*& hpFill, ::UnityEngine::Material*& mpFill)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_3A2CE11EFCE3C592_Class_2_7D6483DC96481CD2*, ::UnityEngine::Material*&, ::UnityEngine::Material*&))((::PBYTE)hIl2Cpp + MOLEMOLE_UIRABMONSTERHUDWIDGETCONTROLLER_CLONEMATERIALS_OFFSET))(this, view, hpFill, mpFill);
		}
