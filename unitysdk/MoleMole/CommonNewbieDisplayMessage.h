...
#define MOLEMOLE_COMMONNEWBIEDISPLAYMESSAGE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x177C2A60)
#define MOLEMOLE_COMMONNEWBIEDISPLAYMESSAGE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x177C2A70)
#define MOLEMOLE_COMMONNEWBIEDISPLAYMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x177C2A10)

namespace MoleMole
{
	inline static constexpr unsigned int CommonNewbieDisplayMessage_TypeDefinitionIndex = 52909;
