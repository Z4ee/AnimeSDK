...
#define MOLEMOLE_COMMONNEWBIEDISPLAYMESSAGE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1A0559C0)
#define MOLEMOLE_COMMONNEWBIEDISPLAYMESSAGE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x1A0559D0)
#define MOLEMOLE_COMMONNEWBIEDISPLAYMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A055970)

namespace MoleMole
{
	inline static constexpr unsigned int CommonNewbieDisplayMessage_TypeDefinitionIndex = 53080;
