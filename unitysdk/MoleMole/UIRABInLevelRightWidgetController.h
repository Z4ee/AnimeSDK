...
#define MOLEMOLE_UIRABINLEVELRIGHTWIDGETCONTROLLER_BINDVIEW_OFFSET UNITYSDK_OFFSET(0x1845B870)
#define MOLEMOLE_UIRABINLEVELRIGHTWIDGETCONTROLLER_CLOSEBANGBOOINFO_OFFSET UNITYSDK_OFFSET(0x1845BD60)
#define MOLEMOLE_UIRABINLEVELRIGHTWIDGETCONTROLLER_CLOSEDATASTAT_OFFSET UNITYSDK_OFFSET(0x1845BF10)
#define MOLEMOLE_UIRABINLEVELRIGHTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1845B760)
#define MOLEMOLE_UIRABINLEVELRIGHTWIDGETCONTROLLER_ONRIGHTAREATYPECHANGED_OFFSET UNITYSDK_OFFSET(0x1845BA30)
#define MOLEMOLE_UIRABINLEVELRIGHTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1845B7F0)
#define MOLEMOLE_UIRABINLEVELRIGHTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1845B5F0)
#define MOLEMOLE_UIRABINLEVELRIGHTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1845B6F0)
#define MOLEMOLE_UIRABINLEVELRIGHTWIDGETCONTROLLER_OPENBANGBOOINFO_OFFSET UNITYSDK_OFFSET(0x1845C3B0)
#define MOLEMOLE_UIRABINLEVELRIGHTWIDGETCONTROLLER_OPENDATASTAT_OFFSET UNITYSDK_OFFSET(0x1845C0C0)
#define MOLEMOLE_UIRABINLEVELRIGHTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1845C6F0)
#define MOLEMOLE_UIRABINLEVELRIGHTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1845C750)
#define MOLEMOLE_UIRABINLEVELRIGHTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1845C7E0)
#define MOLEMOLE_UIRABINLEVELRIGHTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1845C870)
#define MOLEMOLE_UIRABINLEVELRIGHTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1845C900)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABInLevelRightWidgetController_TypeDefinitionIndex = 51310;

	class UIRABInLevelRightWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_60638234271CCDB8_62* _view; // 0x2C0
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_742C838C9195275D*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIRABINLEVELRIGHTWIDGETCONTROLLER_OPENBANGBOOINFO_OFFSET))(this, slotData);
		}
