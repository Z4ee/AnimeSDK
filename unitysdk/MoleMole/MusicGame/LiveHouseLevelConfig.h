...
#define MOLEMOLE_MUSICGAME_LIVEHOUSELEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x129D6A90)

namespace MoleMole::MusicGame
{
	inline static constexpr unsigned int LiveHouseLevelConfig_TypeDefinitionIndex = 45406;
