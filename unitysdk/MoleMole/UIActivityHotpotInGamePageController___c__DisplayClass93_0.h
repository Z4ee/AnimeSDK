...
#define MOLEMOLE_UIACTIVITYHOTPOTINGAMEPAGECONTROLLER___C__DISPLAYCLASS93_0__CTOR_OFFSET UNITYSDK_OFFSET(0x164596C0)
#define MOLEMOLE_UIACTIVITYHOTPOTINGAMEPAGECONTROLLER___C__DISPLAYCLASS93_0__ONROUNDEND_B__0_OFFSET UNITYSDK_OFFSET(0x164596D0)
#define MOLEMOLE_UIACTIVITYHOTPOTINGAMEPAGECONTROLLER___C__DISPLAYCLASS93_0__ONROUNDEND_B__1_OFFSET UNITYSDK_OFFSET(0x164597F0)
#define MOLEMOLE_UIACTIVITYHOTPOTINGAMEPAGECONTROLLER___C__DISPLAYCLASS93_0__ONROUNDEND_B__3_OFFSET UNITYSDK_OFFSET(0x16459810)
#define MOLEMOLE_UIACTIVITYHOTPOTINGAMEPAGECONTROLLER___C__DISPLAYCLASS93_0__ONROUNDEND_B__4_OFFSET UNITYSDK_OFFSET(0x16459C00)
#define MOLEMOLE_UIACTIVITYHOTPOTINGAMEPAGECONTROLLER___C__DISPLAYCLASS93_0__ONROUNDEND_G__ONREPORTSUCCESS_2_OFFSET UNITYSDK_OFFSET(0x164597A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityHotpotInGamePageController___c__DisplayClass93_0_TypeDefinitionIndex = 75063;
