...
#define MOLEMOLE_UIACTIVITYHOTPOTINGAMEPAGECONTROLLER___C__DISPLAYCLASS93_0__CTOR_OFFSET UNITYSDK_OFFSET(0x180CC500)
#define MOLEMOLE_UIACTIVITYHOTPOTINGAMEPAGECONTROLLER___C__DISPLAYCLASS93_0__ONROUNDEND_B__0_OFFSET UNITYSDK_OFFSET(0x180CC510)
#define MOLEMOLE_UIACTIVITYHOTPOTINGAMEPAGECONTROLLER___C__DISPLAYCLASS93_0__ONROUNDEND_B__1_OFFSET UNITYSDK_OFFSET(0x180CC630)
#define MOLEMOLE_UIACTIVITYHOTPOTINGAMEPAGECONTROLLER___C__DISPLAYCLASS93_0__ONROUNDEND_B__3_OFFSET UNITYSDK_OFFSET(0x180CC650)
#define MOLEMOLE_UIACTIVITYHOTPOTINGAMEPAGECONTROLLER___C__DISPLAYCLASS93_0__ONROUNDEND_B__4_OFFSET UNITYSDK_OFFSET(0x180CCA40)
#define MOLEMOLE_UIACTIVITYHOTPOTINGAMEPAGECONTROLLER___C__DISPLAYCLASS93_0__ONROUNDEND_G__ONREPORTSUCCESS_2_OFFSET UNITYSDK_OFFSET(0x180CC5E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityHotpotInGamePageController___c__DisplayClass93_0_TypeDefinitionIndex = 87258;
