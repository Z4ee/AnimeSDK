...
#define MOLEMOLE_UIAVATARHEADWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1645AEA0)
#define MOLEMOLE_UIAVATARHEADWIDGETCONTROLLER_SHOWAVATARHEAD_OFFSET UNITYSDK_OFFSET(0x1645AFA0)
#define MOLEMOLE_UIAVATARHEADWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1645B550)
#define MOLEMOLE_UIAVATARHEADWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1645B540)
#define MOLEMOLE_UIAVATARHEADWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1645B560)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarHeadWidgetController_TypeDefinitionIndex = 74061;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIAvatarHeadWidgetController_TypeDefinitionIndex)->GetStaticField(0x10290);
		}
