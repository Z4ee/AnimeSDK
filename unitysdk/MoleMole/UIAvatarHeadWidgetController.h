...
#define MOLEMOLE_UIAVATARHEADWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1A62B100)
#define MOLEMOLE_UIAVATARHEADWIDGETCONTROLLER_SHOWAVATARHEAD_OFFSET UNITYSDK_OFFSET(0x1A62B200)
#define MOLEMOLE_UIAVATARHEADWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A62B7C0)
#define MOLEMOLE_UIAVATARHEADWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A62B7B0)
#define MOLEMOLE_UIAVATARHEADWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1A62B7D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarHeadWidgetController_TypeDefinitionIndex = 70066;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIAvatarHeadWidgetController_TypeDefinitionIndex)->GetStaticField(0x11EA0);
		}
