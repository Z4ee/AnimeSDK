...
#define MOLEMOLE_FREEBUFFERTRIMOPTIMIZATIONPOSTPROCESSPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x136A2330)
#define MOLEMOLE_FREEBUFFERTRIMOPTIMIZATIONPOSTPROCESSPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x136A23A0)
#define MOLEMOLE_FREEBUFFERTRIMOPTIMIZATIONPOSTPROCESSPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x136A23B0)

namespace MoleMole
{
	inline static constexpr unsigned int FreeBufferTrimOptimizationPostProcessProfile_TypeDefinitionIndex = 86285;
