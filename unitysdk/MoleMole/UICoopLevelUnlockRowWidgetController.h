...
#define MOLEMOLE_UICOOPLEVELUNLOCKROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17A5CB40)
#define MOLEMOLE_UICOOPLEVELUNLOCKROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17A5CBB0)
#define MOLEMOLE_UICOOPLEVELUNLOCKROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17A5CC70)
#define MOLEMOLE_UICOOPLEVELUNLOCKROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17A5CEB0)
#define MOLEMOLE_UICOOPLEVELUNLOCKROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x17A5CD30)
#define MOLEMOLE_UICOOPLEVELUNLOCKROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17A5CF50)
#define MOLEMOLE_UICOOPLEVELUNLOCKROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17A5CF60)
#define MOLEMOLE_UICOOPLEVELUNLOCKROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17A5D000)
#define MOLEMOLE_UICOOPLEVELUNLOCKROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17A5D0A0)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopLevelUnlockRowWidgetController_TypeDefinitionIndex = 75817;
