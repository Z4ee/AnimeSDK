...
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER___C__DISPLAYCLASS57_1__CTOR_OFFSET UNITYSDK_OFFSET(0x15DCAC90)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER___C__DISPLAYCLASS57_1__REFRESHSKILLVIEW_B__1_OFFSET UNITYSDK_OFFSET(0x15DCACA0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER___C__DISPLAYCLASS57_1__REFRESHSKILLVIEW_B__2_OFFSET UNITYSDK_OFFSET(0x15DCB250)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyBossInfoPageController___c__DisplayClass57_1_TypeDefinitionIndex = 79952;

	class UIMonsterFantasyBossInfoPageController___c__DisplayClass57_1 : public ::System::Object
	{
	public:
		::System::Action* __9__2; // 0x10
		::Class_2_208CC9941471731A_637* skillTemplate; // 0x18
