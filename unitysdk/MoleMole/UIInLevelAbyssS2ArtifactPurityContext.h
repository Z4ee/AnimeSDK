...
#define MOLEMOLE_UIINLEVELABYSSS2ARTIFACTPURITYCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x162F02C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelAbyssS2ArtifactPurityContext_TypeDefinitionIndex = 63919;
