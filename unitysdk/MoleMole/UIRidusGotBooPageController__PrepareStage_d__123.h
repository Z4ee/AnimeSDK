...
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__PREPARESTAGE_D__123_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x86B550)
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__PREPARESTAGE_D__123_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooPageController__PrepareStage_d__123_TypeDefinitionIndex = 91542;

	struct alignas(8) UIRidusGotBooPageController__PrepareStage_d__123
	{
		::Cysharp::Threading::Tasks::UniTask_Awaiter __u__1; // 0x10
		::MoleMole::UIRidusGotBooPageController___c__DisplayClass123_0* __8__1; // 0x20
		::Cysharp::Threading::Tasks::CompilerServices::AsyncUniTaskMethodBuilder __t__builder; // 0x28
		::MoleMole::UIRidusGotBooPageController* __4__this; // 0x38
		::Class_2_208CC9941471731A_352* _npcTransform_5__4; // 0x40
		::System::Int32 _i_5__2; // 0x48
		::System::Int32 _buddyID_5__3; // 0x4C
