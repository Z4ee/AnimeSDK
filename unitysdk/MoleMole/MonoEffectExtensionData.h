...
#define MOLEMOLE_MONOEFFECTEXTENSIONDATA_GETBOOLDATA_OFFSET UNITYSDK_OFFSET(0x15E47200)
#define MOLEMOLE_MONOEFFECTEXTENSIONDATA_GETCOLORDATA_OFFSET UNITYSDK_OFFSET(0x15E473D0)
#define MOLEMOLE_MONOEFFECTEXTENSIONDATA_GETFLOATDATA_OFFSET UNITYSDK_OFFSET(0x15E47110)
#define MOLEMOLE_MONOEFFECTEXTENSIONDATA_GETINTDATA_OFFSET UNITYSDK_OFFSET(0x15E47020)
#define MOLEMOLE_MONOEFFECTEXTENSIONDATA_GETSTRINGDATA_OFFSET UNITYSDK_OFFSET(0x15E472F0)
#define MOLEMOLE_MONOEFFECTEXTENSIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x15E47500)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectExtensionData_TypeDefinitionIndex = 80658;
