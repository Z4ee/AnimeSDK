...
#define MOLEMOLE_MONOEFFECTEXTENSIONDATA_GETBOOLDATA_OFFSET UNITYSDK_OFFSET(0x17E8E480)
#define MOLEMOLE_MONOEFFECTEXTENSIONDATA_GETCOLORDATA_OFFSET UNITYSDK_OFFSET(0x17E8E640)
#define MOLEMOLE_MONOEFFECTEXTENSIONDATA_GETFLOATDATA_OFFSET UNITYSDK_OFFSET(0x17E8E390)
#define MOLEMOLE_MONOEFFECTEXTENSIONDATA_GETINTDATA_OFFSET UNITYSDK_OFFSET(0x17E8E2A0)
#define MOLEMOLE_MONOEFFECTEXTENSIONDATA_GETSTRINGDATA_OFFSET UNITYSDK_OFFSET(0x17E8E560)
#define MOLEMOLE_MONOEFFECTEXTENSIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17E8E770)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectExtensionData_TypeDefinitionIndex = 73576;
