...
#define MOLEMOLE_BLENDTEXTURESHEETDATA_CREATEPLAYER_OFFSET UNITYSDK_OFFSET(0x14840A80)
#define MOLEMOLE_BLENDTEXTURESHEETDATA_GET_HASONEPLAYSLOT_OFFSET UNITYSDK_OFFSET(0x148408E0)
#define MOLEMOLE_BLENDTEXTURESHEETDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x14840AD0)

namespace MoleMole
{
	inline static constexpr unsigned int BlendTextureSheetData_TypeDefinitionIndex = 82612;

	class BlendTextureSheetData : public ::System::Object
	{
	public:
		::MoleMole::TextureSheetAnimCurveParam* TextureSheetFadeOut; // 0x10
		::MoleMole::TextureSheetAnimCurveParam* FadeIn; // 0x18
		::MoleMole::TextureSheetAnimCurveParam* FadeOut; // 0x20
		...
		{
			return ((::Class_1_5A6771CD0CA2718D*(*)(::PVOID, ::Class_0_16E4307DCC419505_512*))((::PBYTE)hIl2Cpp + MOLEMOLE_BLENDTEXTURESHEETDATA_CREATEPLAYER_OFFSET))(this, textureSheetImpl);
		}
	};
}
