...
#define MOLEMOLE_UIACTIVITYSKYWIDGETCONTROLLER_CREATEREWARD_OFFSET UNITYSDK_OFFSET(0x12C08840)
#define MOLEMOLE_UIACTIVITYSKYWIDGETCONTROLLER_FINDFOCUSINDEX_OFFSET UNITYSDK_OFFSET(0x12C08EC0)
#define MOLEMOLE_UIACTIVITYSKYWIDGETCONTROLLER_GETTAGTEXT_OFFSET UNITYSDK_OFFSET(0x12C08CD0)
#define MOLEMOLE_UIACTIVITYSKYWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12C08390)
#define MOLEMOLE_UIACTIVITYSKYWIDGETCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x12C08D70)
#define MOLEMOLE_UIACTIVITYSKYWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x12C07A90)
#define MOLEMOLE_UIACTIVITYSKYWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12C08420)
#define MOLEMOLE_UIACTIVITYSKYWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12C078A0)
#define MOLEMOLE_UIACTIVITYSKYWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12C07A20)
#define MOLEMOLE_UIACTIVITYSKYWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x12C07B20)
#define MOLEMOLE_UIACTIVITYSKYWIDGETCONTROLLER_REMOVEREWARD_OFFSET UNITYSDK_OFFSET(0x12C084D0)
#define MOLEMOLE_UIACTIVITYSKYWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12C08F80)
#define MOLEMOLE_UIACTIVITYSKYWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12C090D0)
#define MOLEMOLE_UIACTIVITYSKYWIDGETCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x12C09160)
#define MOLEMOLE_UIACTIVITYSKYWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x12C091F0)
#define MOLEMOLE_UIACTIVITYSKYWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12C09290)
#define MOLEMOLE_UIACTIVITYSKYWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12C09320)
#define MOLEMOLE_UIACTIVITYSKYWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12C093B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivitySkyWidgetController_TypeDefinitionIndex = 52662;
