...
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A212A0)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15A213B0)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A21330)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A21240)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15A214D0)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A214E0)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15A21570)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A21610)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A216A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralScrollViewTestItemWidgetController_TypeDefinitionIndex = 49685;

	class UIGeneralScrollViewTestItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_D68EC59F0214DAC2* _view; // 0x2E8
		::UnityEngine::Color _color; // 0x2F0
