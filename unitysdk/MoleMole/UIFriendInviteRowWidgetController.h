...
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER_BINDPLATFORMICONBTNLONGPRESS_OFFSET UNITYSDK_OFFSET(0x186BA6C0)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER_INITPLATFORMUIVIEW_OFFSET UNITYSDK_OFFSET(0x186BA070)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x186B9480)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x186B9590)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER_ONSWITCHPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0x186BA950)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x186B9510)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x186B93C0)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER_SHOWPLATFORMUI_OFFSET UNITYSDK_OFFSET(0x186BA410)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x186BA9F0)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER__INITPLATFORMUIVIEW_G__SETUPPLATFORMUI_6_0_OFFSET UNITYSDK_OFFSET(0x186BA620)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x186BAA00)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x186BAA90)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x186BAB30)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x186BABC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendInviteRowWidgetController_TypeDefinitionIndex = 71561;
