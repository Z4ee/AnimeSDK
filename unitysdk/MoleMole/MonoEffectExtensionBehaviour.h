...
#define MOLEMOLE_MONOEFFECTEXTENSIONBEHAVIOUR_AWAKE_OFFSET UNITYSDK_OFFSET(0x136DA3B0)
#define MOLEMOLE_MONOEFFECTEXTENSIONBEHAVIOUR_GET_ANIMATORS_OFFSET UNITYSDK_OFFSET(0x136DA110)
#define MOLEMOLE_MONOEFFECTEXTENSIONBEHAVIOUR_GET_ISALLCOMPONENTSCACHED_OFFSET UNITYSDK_OFFSET(0x136DA060)
#define MOLEMOLE_MONOEFFECTEXTENSIONBEHAVIOUR_GET_XWEAPONS_OFFSET UNITYSDK_OFFSET(0x136DA260)
#define MOLEMOLE_MONOEFFECTEXTENSIONBEHAVIOUR_METHOD_5_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x136DA540)
#define MOLEMOLE_MONOEFFECTEXTENSIONBEHAVIOUR_UPDATECACHESERIALIZEDATA_OFFSET UNITYSDK_OFFSET(0x136DA450)
#define MOLEMOLE_MONOEFFECTEXTENSIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x136DA5F0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectExtensionBehaviour_TypeDefinitionIndex = 82266;
