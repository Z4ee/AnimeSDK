...
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_BINDNOTIFICATIONCOUNTNODE_1_OFFSET UNITYSDK_OFFSET(0x19570210)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_BINDNOTIFICATIONCOUNTNODE_OFFSET UNITYSDK_OFFSET(0x1956FFD0)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_BINDNOTIFICATIONNODE_1_OFFSET UNITYSDK_OFFSET(0x1956F990)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_BINDNOTIFICATIONNODE_OFFSET UNITYSDK_OFFSET(0x1956F750)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_DISABLEBADGEWIDGET_OFFSET UNITYSDK_OFFSET(0x1956FE10)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_ENABLEBADGEWIDGET_OFFSET UNITYSDK_OFFSET(0x1956FBC0)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_GET_TABBUTTON_OFFSET UNITYSDK_OFFSET(0x1956F2F0)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_LAZYLOADNOTIFICATIONBADGEEXCOUNT_OFFSET UNITYSDK_OFFSET(0x19570070)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_LAZYLOADNOTIFICATIONBADGEEX_OFFSET UNITYSDK_OFFSET(0x1956F7F0)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x195702F0)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19570380)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_SETICON_1_OFFSET UNITYSDK_OFFSET(0x1956F470)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_SETICON_2_OFFSET UNITYSDK_OFFSET(0x1956F590)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_SETICON_OFFSET UNITYSDK_OFFSET(0x1956F3B0)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_SETLIGHT_OFFSET UNITYSDK_OFFSET(0x19570280)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_SETNOTIFICATIONBADGE_OFFSET UNITYSDK_OFFSET(0x1956FA00)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19570400)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19570460)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x195704F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangkovTabBtn01RowWidgetController_TypeDefinitionIndex = 90397;
