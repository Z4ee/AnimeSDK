...
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_BINDNOTIFICATIONCOUNTNODE_1_OFFSET UNITYSDK_OFFSET(0x158BE3F0)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_BINDNOTIFICATIONCOUNTNODE_OFFSET UNITYSDK_OFFSET(0x158BE1C0)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_BINDNOTIFICATIONNODE_1_OFFSET UNITYSDK_OFFSET(0x158BDB80)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_BINDNOTIFICATIONNODE_OFFSET UNITYSDK_OFFSET(0x158BD950)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_DISABLEBADGEWIDGET_OFFSET UNITYSDK_OFFSET(0x158BE000)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_ENABLEBADGEWIDGET_OFFSET UNITYSDK_OFFSET(0x158BDDB0)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_GET_TABBUTTON_OFFSET UNITYSDK_OFFSET(0x158BD4F0)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_LAZYLOADNOTIFICATIONBADGEEXCOUNT_OFFSET UNITYSDK_OFFSET(0x158BE250)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_LAZYLOADNOTIFICATIONBADGEEX_OFFSET UNITYSDK_OFFSET(0x158BD9E0)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x158BE4D0)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x158BE560)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_SETICON_1_OFFSET UNITYSDK_OFFSET(0x158BD670)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_SETICON_2_OFFSET UNITYSDK_OFFSET(0x158BD790)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_SETICON_OFFSET UNITYSDK_OFFSET(0x158BD5B0)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_SETLIGHT_OFFSET UNITYSDK_OFFSET(0x158BE460)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER_SETNOTIFICATIONBADGE_OFFSET UNITYSDK_OFFSET(0x158BDBF0)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x158BE5E0)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x158BE640)
#define MOLEMOLE_UIBANGKOVTABBTN01ROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x158BE6D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangkovTabBtn01RowWidgetController_TypeDefinitionIndex = 55415;

	class UIBangkovTabBtn01RowWidgetController : public ::MoleMole::UITabBtnController
	{
	public:
		::Class_2_0549787B82F1ACBE* _view; // 0x2C0
