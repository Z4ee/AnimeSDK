...
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER_GET_RATIO_OFFSET UNITYSDK_OFFSET(0x1B265F10)
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER_GET_REFERENCERESOLUTION_OFFSET UNITYSDK_OFFSET(0x1B266080)
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER_GET_VALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1B265EF0)
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER_MARKVALUECHANGE_OFFSET UNITYSDK_OFFSET(0x1B2660A0)
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER_SET_RATIO_OFFSET UNITYSDK_OFFSET(0x1B265FC0)
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER_SET_REFERENCERESOLUTION_OFFSET UNITYSDK_OFFSET(0x1B266090)
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER_SET_VALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1B265F00)
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2660E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAdaptorFakeCanvasScaler_TypeDefinitionIndex = 69432;
