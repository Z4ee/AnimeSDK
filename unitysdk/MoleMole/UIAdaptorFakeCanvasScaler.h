...
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER_GET_RATIO_OFFSET UNITYSDK_OFFSET(0x18C67AC0)
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER_GET_REFERENCERESOLUTION_OFFSET UNITYSDK_OFFSET(0x18C67C30)
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER_GET_VALUECHANGED_OFFSET UNITYSDK_OFFSET(0x18C67AA0)
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER_MARKVALUECHANGE_OFFSET UNITYSDK_OFFSET(0x18C67C50)
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER_SET_RATIO_OFFSET UNITYSDK_OFFSET(0x18C67B70)
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER_SET_REFERENCERESOLUTION_OFFSET UNITYSDK_OFFSET(0x18C67C40)
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER_SET_VALUECHANGED_OFFSET UNITYSDK_OFFSET(0x18C67AB0)
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER__CTOR_OFFSET UNITYSDK_OFFSET(0x18C67C90)

namespace MoleMole
{
	inline static constexpr unsigned int UIAdaptorFakeCanvasScaler_TypeDefinitionIndex = 45828;
