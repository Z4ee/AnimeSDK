...
#define MOLEMOLE_UILEVELRESULTV2_VR_DOUBLEELITE_PAGECONTROLLER_GET_REWARDBUFFGAMETAG_OFFSET UNITYSDK_OFFSET(0x152791B0)
#define MOLEMOLE_UILEVELRESULTV2_VR_DOUBLEELITE_PAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x152791C0)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultV2_VR_DoubleElite_PageController_TypeDefinitionIndex = 79473;
