...
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_CLASS_1_117D5B6A04BC9CED_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x144F3D40)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_CLASS_1_117D5B6A04BC9CED_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x144F45B0)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_CLASS_1_117D5B6A04BC9CED_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x144F4610)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_CLASS_1_117D5B6A04BC9CED_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x144F45C0)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_CLASS_1_117D5B6A04BC9CED_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x144F3D30)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_CLASS_1_117D5B6A04BC9CED__CTOR_OFFSET UNITYSDK_OFFSET(0x144F3D20)

namespace MoleMole
{
	inline static constexpr unsigned int MonoScrollerFadeManager_Class_1_117D5B6A04BC9CED_TypeDefinitionIndex = 47135;

	class MonoScrollerFadeManager_Class_1_117D5B6A04BC9CED : public ::System::Object
	{
	public:
		::System::Object* Field_1_1; // 0x10
		::MoleMole::MonoScrollerFadeManager* Field_1_7; // 0x18
		::System::Collections::Generic::List_1<::UnityEngine::RectTransform*>* Field_1_6; // 0x20
		::System::Collections::Generic::List_1<::UnityEngine::CanvasGroup*>* Field_1_11; // 0x28
