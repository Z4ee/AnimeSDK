...
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_CLASS_1_117D5B6A04BC9CED_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x142B15E0)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_CLASS_1_117D5B6A04BC9CED_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x142B1E40)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_CLASS_1_117D5B6A04BC9CED_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x142B1EA0)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_CLASS_1_117D5B6A04BC9CED_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x142B1E50)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_CLASS_1_117D5B6A04BC9CED_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x142B15D0)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_CLASS_1_117D5B6A04BC9CED__CTOR_OFFSET UNITYSDK_OFFSET(0x142B15C0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoScrollerFadeManager_Class_1_117D5B6A04BC9CED_TypeDefinitionIndex = 80635;
