...
#define MOLEMOLE_IMGTEXTPARSERBASE_METHOD_5_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x1A036E60)
#define MOLEMOLE_IMGTEXTPARSERBASE_METHOD_5_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x1A036DF0)
#define MOLEMOLE_IMGTEXTPARSERBASE_METHOD_5_8F68D3DD3F7032DF_OFFSET UNITYSDK_OFFSET(0x1A036440)
#define MOLEMOLE_IMGTEXTPARSERBASE_METHOD_5_BCC281DC419BB5B6_OFFSET UNITYSDK_OFFSET(0x1A036D50)
#define MOLEMOLE_IMGTEXTPARSERBASE_SETCOLOR_OFFSET UNITYSDK_OFFSET(0x1A0362A0)
#define MOLEMOLE_IMGTEXTPARSERBASE_SETKEY_OFFSET UNITYSDK_OFFSET(0x1A0366C0)
#define MOLEMOLE_IMGTEXTPARSERBASE_SETTEXTFUNCNOTCLEARFUNC_OFFSET UNITYSDK_OFFSET(0x1A036780)
#define MOLEMOLE_IMGTEXTPARSERBASE_SETTEXTFUNC_OFFSET UNITYSDK_OFFSET(0x1A036600)
#define MOLEMOLE_IMGTEXTPARSERBASE_SETTEXTNOTCLEARFUNC_OFFSET UNITYSDK_OFFSET(0x1A036B60)
#define MOLEMOLE_IMGTEXTPARSERBASE_SETTEXT_OFFSET UNITYSDK_OFFSET(0x1A036970)
#define MOLEMOLE_IMGTEXTPARSERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A036DA0)

namespace MoleMole
{
	inline static constexpr unsigned int ImgTextParserBase_TypeDefinitionIndex = 56736;
