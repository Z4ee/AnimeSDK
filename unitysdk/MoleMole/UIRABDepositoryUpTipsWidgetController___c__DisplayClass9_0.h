...
#define MOLEMOLE_UIRABDEPOSITORYUPTIPSWIDGETCONTROLLER___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17D38F40)
#define MOLEMOLE_UIRABDEPOSITORYUPTIPSWIDGETCONTROLLER___C__DISPLAYCLASS9_0__ONFADEPLAYFINISH_B__0_OFFSET UNITYSDK_OFFSET(0x17D38F50)
#define MOLEMOLE_UIRABDEPOSITORYUPTIPSWIDGETCONTROLLER___C__DISPLAYCLASS9_0__ONFADEPLAYFINISH_B__1_OFFSET UNITYSDK_OFFSET(0x17D38F60)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABDepositoryUpTipsWidgetController___c__DisplayClass9_0_TypeDefinitionIndex = 52807;
