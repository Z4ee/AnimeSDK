...
#define MOLEMOLE_UIHARDCOREBOSSENTRANCEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1720B330)
#define MOLEMOLE_UIHARDCOREBOSSENTRANCEWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1720B3A0)
#define MOLEMOLE_UIHARDCOREBOSSENTRANCEWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1720B440)
#define MOLEMOLE_UIHARDCOREBOSSENTRANCEWIDGETCONTROLLER_SETENTRANCEVIDEOFOCUS_OFFSET UNITYSDK_OFFSET(0x1720B6B0)
#define MOLEMOLE_UIHARDCOREBOSSENTRANCEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1720B760)
#define MOLEMOLE_UIHARDCOREBOSSENTRANCEWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1720B7C0)
#define MOLEMOLE_UIHARDCOREBOSSENTRANCEWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1720B860)

namespace MoleMole
{
	inline static constexpr unsigned int UIHardCoreBossEntranceWidgetController_TypeDefinitionIndex = 61335;
