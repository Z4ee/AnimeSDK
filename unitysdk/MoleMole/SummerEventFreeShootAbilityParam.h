...
#define MOLEMOLE_SUMMEREVENTFREESHOOTABILITYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1793D070)

namespace MoleMole
{
	inline static constexpr unsigned int SummerEventFreeShootAbilityParam_TypeDefinitionIndex = 47810;
