...
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1956C380)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1956C410)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1956C2B0)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1956C310)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_REFRESHVIEW_1_OFFSET UNITYSDK_OFFSET(0x1956CA00)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1956C490)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x1956C660)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_SETLEFTRIGHTDESC_OFFSET UNITYSDK_OFFSET(0x1956C810)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_SETNAME_OFFSET UNITYSDK_OFFSET(0x1956C760)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_SETNEW_OFFSET UNITYSDK_OFFSET(0x1956C6F0)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_SETSIMPLEDESC_OFFSET UNITYSDK_OFFSET(0x1956C8F0)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_SETUPARROW_OFFSET UNITYSDK_OFFSET(0x1956C990)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1956CB40)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1956CBA0)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1956CC30)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1956CCC0)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1956CD50)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooDreamGoodsAttrItemWidgetController_TypeDefinitionIndex = 73386;

	class UIBangbooDreamGoodsAttrItemWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_DCAC1CE478D28EC0_2* _view; // 0x2C0
