...
#define MOLEMOLE_MONOEFFECTSHAPE_GETRELATIVEPATH_OFFSET UNITYSDK_OFFSET(0x144E5880)
#define MOLEMOLE_MONOEFFECTSHAPE_METHOD_5_BC32755818CA4F24_OFFSET UNITYSDK_OFFSET(0x144E5E90)
#define MOLEMOLE_MONOEFFECTSHAPE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x144E6050)
#define MOLEMOLE_MONOEFFECTSHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x144E6150)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectShape_TypeDefinitionIndex = 88836;
