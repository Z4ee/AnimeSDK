...
#define MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x161232B0)
#define MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16123320)
#define MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x161233C0)
#define MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x16123480)
#define MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16123530)
#define MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16123540)
#define MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x161235E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoStickerRowWidgetController_TypeDefinitionIndex = 48066;
