...
class Class_2_4011E16A276EB833;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIPhotoStickerRowWidgetController_Data; }
namespace System { class Object; }

#define MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1788BE40)
#define MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1788BEB0)
#define MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1788BF50)
#define MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1788C010)
#define MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1788C0C0)
#define MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1788C0D0)
#define MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1788C170)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoStickerRowWidgetController_TypeDefinitionIndex = 82442;
	...
	public:
		...
		::Class_2_4011E16A276EB833* get__viewModel()
		{
			return ((::Class_2_4011E16A276EB833*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
