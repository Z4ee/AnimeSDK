...
#define MOLEMOLE_GLOBALILLUMINATIONPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16857FF0)

namespace MoleMole
{
	inline static constexpr unsigned int GlobalIlluminationProfileContext_TypeDefinitionIndex = 90909;
