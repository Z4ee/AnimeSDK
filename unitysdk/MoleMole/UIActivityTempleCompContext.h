...
#define MOLEMOLE_UIACTIVITYTEMPLECOMPCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x192E9ED0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityTempleCompContext_TypeDefinitionIndex = 44591;
