...
class Class_3_6EF456A21AE85EEC_309;
class Class_3_8B38DDDE25B29A1E_1;
namespace System { class String; }
namespace System::Collections::Generic { template <typename T1, typename T2> class Dictionary_2; }

#define MOLEMOLE_SUMMERSHOOTINGLOGSUBSYSTEM_BULLETCREATE_OFFSET UNITYSDK_OFFSET(0x17DF0FD0)
#define MOLEMOLE_SUMMERSHOOTINGLOGSUBSYSTEM_BULLETHITTARGETRECORD_OFFSET UNITYSDK_OFFSET(0x17DF17F0)
#define MOLEMOLE_SUMMERSHOOTINGLOGSUBSYSTEM_BULLETHIT_OFFSET UNITYSDK_OFFSET(0x17DF1380)
#define MOLEMOLE_SUMMERSHOOTINGLOGSUBSYSTEM_CLEARBULLETRECORD_OFFSET UNITYSDK_OFFSET(0x17DF0440)
#define MOLEMOLE_SUMMERSHOOTINGLOGSUBSYSTEM_CREATEPATTERN_OFFSET UNITYSDK_OFFSET(0x17DF0B00)
#define MOLEMOLE_SUMMERSHOOTINGLOGSUBSYSTEM_ENCODE_1_OFFSET UNITYSDK_OFFSET(0x17DF23E0)
#define MOLEMOLE_SUMMERSHOOTINGLOGSUBSYSTEM_ENCODE_OFFSET UNITYSDK_OFFSET(0x17DF2320)
#define MOLEMOLE_SUMMERSHOOTINGLOGSUBSYSTEM_FINISHANDSENDREQUEST_OFFSET UNITYSDK_OFFSET(0x17DF1DC0)
#define MOLEMOLE_SUMMERSHOOTINGLOGSUBSYSTEM_FINISHPATTERN_OFFSET UNITYSDK_OFFSET(0x17DF1C60)
#define MOLEMOLE_SUMMERSHOOTINGLOGSUBSYSTEM_GETGENERALLEVELID_OFFSET UNITYSDK_OFFSET(0x17DF04E0)
#define MOLEMOLE_SUMMERSHOOTINGLOGSUBSYSTEM_KILLENTITY_OFFSET UNITYSDK_OFFSET(0x17DF0C30)
#define MOLEMOLE_SUMMERSHOOTINGLOGSUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x17DF02B0)
#define MOLEMOLE_SUMMERSHOOTINGLOGSUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17DF02F0)
#define MOLEMOLE_SUMMERSHOOTINGLOGSUBSYSTEM_RECORDCHALLENGE_OFFSET UNITYSDK_OFFSET(0x17DF24A0)
#define MOLEMOLE_SUMMERSHOOTINGLOGSUBSYSTEM_STARTBEATMAP_OFFSET UNITYSDK_OFFSET(0x17DF0700)
#define MOLEMOLE_SUMMERSHOOTINGLOGSUBSYSTEM_USESKILL_OFFSET UNITYSDK_OFFSET(0x17DF0DA0)
#define MOLEMOLE_SUMMERSHOOTINGLOGSUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x17DF2500)
#define MOLEMOLE_SUMMERSHOOTINGLOGSUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x17DF2520)
#define MOLEMOLE_SUMMERSHOOTINGLOGSUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17DF25B0)

namespace MoleMole
{
	inline static constexpr unsigned int SummerShootingLogSubsystem_TypeDefinitionIndex = 47326;

	class SummerShootingLogSubsystem : public ::MoleMole::GameSubsystemBaseEx_1<::MoleMole::SummerShootingLogSubsystem*>
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::Dictionary_2<::System::String*, ::Class_3_0886A771C4D53727_14*>*>* ShootInfoDic; // 0x10
		::Class_3_8B38DDDE25B29A1E_1* _data; // 0x18
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::Class_3_2DA56329B5538F5A*>* _patterns; // 0x20
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::Class_3_6EF456A21AE85EEC_309*>* ShootSkillInfo; // 0x28
		...
		::System::Void KillEntity(::System::Int32 instanceId, ::Struct_2_4C8453486C91E3A1_11 info)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::Struct_2_4C8453486C91E3A1_11))((::PBYTE)hIl2Cpp + MOLEMOLE_SUMMERSHOOTINGLOGSUBSYSTEM_KILLENTITY_OFFSET))(this, instanceId, info);
		}
