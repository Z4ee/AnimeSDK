...
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_CONTEXT_GET_MAXVALUE_OFFSET UNITYSDK_OFFSET(0x148467A0)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_CONTEXT_GET_MINVALUE_OFFSET UNITYSDK_OFFSET(0x14846720)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_CONTEXT_GET_OVERRIDEMOBILEBUTTONPANEL_OFFSET UNITYSDK_OFFSET(0x148462F0)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_CONTEXT_GET_RUNTIMEVALUE_OFFSET UNITYSDK_OFFSET(0x148465A0)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_CONTEXT_SET_RUNTIMEVALUE_OFFSET UNITYSDK_OFFSET(0x14846650)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x148463F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMobileButtonSettingWidgetController_Context_TypeDefinitionIndex = 44682;
