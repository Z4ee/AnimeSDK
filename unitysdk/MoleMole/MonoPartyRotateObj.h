...
#define MOLEMOLE_MONOPARTYROTATEOBJ_AWAKE_OFFSET UNITYSDK_OFFSET(0x13851ED0)
#define MOLEMOLE_MONOPARTYROTATEOBJ_CALCURROTVALUE_OFFSET UNITYSDK_OFFSET(0x138521C0)
#define MOLEMOLE_MONOPARTYROTATEOBJ_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x13852060)
#define MOLEMOLE_MONOPARTYROTATEOBJ_ONDOUPDATE_OFFSET UNITYSDK_OFFSET(0x13852230)
#define MOLEMOLE_MONOPARTYROTATEOBJ_SYNCROTATION_OFFSET UNITYSDK_OFFSET(0x13851F20)
#define MOLEMOLE_MONOPARTYROTATEOBJ__CTOR_OFFSET UNITYSDK_OFFSET(0x13852580)
#define MOLEMOLE_MONOPARTYROTATEOBJ___BASE_ONDOUPDATE_OFFSET UNITYSDK_OFFSET(0x13852620)

namespace MoleMole
{
	inline static constexpr unsigned int MonoPartyRotateObj_TypeDefinitionIndex = 86126;
	...
	public:
		...
		::UnityEngine::Vector3 Field_8_0; // 0x3C
		::UnityEngine::Rigidbody* Field_8_7; // 0x48
