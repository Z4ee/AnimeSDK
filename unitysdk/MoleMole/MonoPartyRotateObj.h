...
#define MOLEMOLE_MONOPARTYROTATEOBJ_AWAKE_OFFSET UNITYSDK_OFFSET(0x12BD2F20)
#define MOLEMOLE_MONOPARTYROTATEOBJ_CALCURROTVALUE_OFFSET UNITYSDK_OFFSET(0x12BD3220)
#define MOLEMOLE_MONOPARTYROTATEOBJ_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x12BD30C0)
#define MOLEMOLE_MONOPARTYROTATEOBJ_ONDOUPDATE_OFFSET UNITYSDK_OFFSET(0x12BD3290)
#define MOLEMOLE_MONOPARTYROTATEOBJ_SYNCROTATION_OFFSET UNITYSDK_OFFSET(0x12BD2F70)
#define MOLEMOLE_MONOPARTYROTATEOBJ__CTOR_OFFSET UNITYSDK_OFFSET(0x12BD35E0)
#define MOLEMOLE_MONOPARTYROTATEOBJ___BASE_ONDOUPDATE_OFFSET UNITYSDK_OFFSET(0x12BD3680)

namespace MoleMole
{
	inline static constexpr unsigned int MonoPartyRotateObj_TypeDefinitionIndex = 75587;
