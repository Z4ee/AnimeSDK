...
#define MOLEMOLE_ACTIVITYCOMBATPAUSECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x12EDCCF0)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityCombatPauseContext_TypeDefinitionIndex = 58742;
