...
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___C__DISPLAYCLASS57_0__CTOR_OFFSET UNITYSDK_OFFSET(0x178DA0E0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___C__DISPLAYCLASS57_0__SETFULLSCREENCONNECTCUTSCENE_B__0_OFFSET UNITYSDK_OFFSET(0x178DA0F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPerformPageController___c__DisplayClass57_0_TypeDefinitionIndex = 85286;
