...
#define MOLEMOLE_UIINLEVELSKILLBUTTONBRANCHBASECONTROLLER_GETSHOWCOLOR_OFFSET UNITYSDK_OFFSET(0x1964FF80)
#define MOLEMOLE_UIINLEVELSKILLBUTTONBRANCHBASECONTROLLER_GET_BUTTONSKILLNAME_OFFSET UNITYSDK_OFFSET(0x1964FFF0)
#define MOLEMOLE_UIINLEVELSKILLBUTTONBRANCHBASECONTROLLER_GET_KEYBUTTONCODE_OFFSET UNITYSDK_OFFSET(0x19650030)
#define MOLEMOLE_UIINLEVELSKILLBUTTONBRANCHBASECONTROLLER_ONHIDEBTN_OFFSET UNITYSDK_OFFSET(0x196502E0)
#define MOLEMOLE_UIINLEVELSKILLBUTTONBRANCHBASECONTROLLER_ONSHOWBTN_OFFSET UNITYSDK_OFFSET(0x19650230)
#define MOLEMOLE_UIINLEVELSKILLBUTTONBRANCHBASECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1964FE50)
#define MOLEMOLE_UIINLEVELSKILLBUTTONBRANCHBASECONTROLLER_SETSHOWCOLOR_OFFSET UNITYSDK_OFFSET(0x1964FF00)
#define MOLEMOLE_UIINLEVELSKILLBUTTONBRANCHBASECONTROLLER_SHOULDSKILLBUTTONHANDLEINPUT_OFFSET UNITYSDK_OFFSET(0x19650040)
#define MOLEMOLE_UIINLEVELSKILLBUTTONBRANCHBASECONTROLLER_STARTBLOCK_OFFSET UNITYSDK_OFFSET(0x19650180)
#define MOLEMOLE_UIINLEVELSKILLBUTTONBRANCHBASECONTROLLER_STOPBLOCK_OFFSET UNITYSDK_OFFSET(0x196501D0)
#define MOLEMOLE_UIINLEVELSKILLBUTTONBRANCHBASECONTROLLER_WAITUNTILNOBLOCK_OFFSET UNITYSDK_OFFSET(0x196500A0)
#define MOLEMOLE_UIINLEVELSKILLBUTTONBRANCHBASECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x196503A0)
#define MOLEMOLE_UIINLEVELSKILLBUTTONBRANCHBASECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19650420)
#define MOLEMOLE_UIINLEVELSKILLBUTTONBRANCHBASECONTROLLER___BASE_SHOULDSKILLBUTTONHANDLEINPUT_OFFSET UNITYSDK_OFFSET(0x19650430)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelSkillButtonBranchBaseController_TypeDefinitionIndex = 75717;
	...
	public:
		...
		::System::Boolean _isBlocking; // 0x438
		::System::Action* _afterBlock; // 0x440
		::Class_1_88757C352B68BC6A* _container; // 0x448
