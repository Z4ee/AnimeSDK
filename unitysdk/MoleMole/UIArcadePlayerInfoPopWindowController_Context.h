...
#define MOLEMOLE_UIARCADEPLAYERINFOPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x181CBC60)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadePlayerInfoPopWindowController_Context_TypeDefinitionIndex = 56668;
