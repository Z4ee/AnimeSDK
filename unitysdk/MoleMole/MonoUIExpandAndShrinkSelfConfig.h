...
#define MOLEMOLE_MONOUIEXPANDANDSHRINKSELFCONFIG_AWAKE_OFFSET UNITYSDK_OFFSET(0x1419E030)
#define MOLEMOLE_MONOUIEXPANDANDSHRINKSELFCONFIG_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1419E1A0)
#define MOLEMOLE_MONOUIEXPANDANDSHRINKSELFCONFIG_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1419DF90)
#define MOLEMOLE_MONOUIEXPANDANDSHRINKSELFCONFIG_SETSIZERATIOBYPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1419E2C0)
#define MOLEMOLE_MONOUIEXPANDANDSHRINKSELFCONFIG_SETSIZERATIOBYSIZEDELTA_OFFSET UNITYSDK_OFFSET(0x1419E1F0)
#define MOLEMOLE_MONOUIEXPANDANDSHRINKSELFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1419E380)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIExpandAndShrinkSelfConfig_TypeDefinitionIndex = 55120;
