...
#define MOLEMOLE_MONOUIEXPANDANDSHRINKSELFCONFIG_AWAKE_OFFSET UNITYSDK_OFFSET(0x10818570)
#define MOLEMOLE_MONOUIEXPANDANDSHRINKSELFCONFIG_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x108186E0)
#define MOLEMOLE_MONOUIEXPANDANDSHRINKSELFCONFIG_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x108184D0)
#define MOLEMOLE_MONOUIEXPANDANDSHRINKSELFCONFIG_SETSIZERATIOBYPROCESSOR_OFFSET UNITYSDK_OFFSET(0x10818800)
#define MOLEMOLE_MONOUIEXPANDANDSHRINKSELFCONFIG_SETSIZERATIOBYSIZEDELTA_OFFSET UNITYSDK_OFFSET(0x10818730)
#define MOLEMOLE_MONOUIEXPANDANDSHRINKSELFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x108188C0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIExpandAndShrinkSelfConfig_TypeDefinitionIndex = 76395;
