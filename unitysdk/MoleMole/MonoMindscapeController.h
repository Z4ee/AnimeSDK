...
#define MOLEMOLE_MONOMINDSCAPECONTROLLER_GET_ISCORNERSVALID_OFFSET UNITYSDK_OFFSET(0x14A10DB0)
#define MOLEMOLE_MONOMINDSCAPECONTROLLER_GET_REFRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x14A10C20)
#define MOLEMOLE_MONOMINDSCAPECONTROLLER_METHOD_5_460F8AE6EF9687FD_OFFSET UNITYSDK_OFFSET(0x14A112D0)
#define MOLEMOLE_MONOMINDSCAPECONTROLLER_METHOD_5_BB881F05E41D3A04_OFFSET UNITYSDK_OFFSET(0x14A10E70)
#define MOLEMOLE_MONOMINDSCAPECONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x14A10F10)
#define MOLEMOLE_MONOMINDSCAPECONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x14A10E10)
#define MOLEMOLE_MONOMINDSCAPECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x14A10EC0)
#define MOLEMOLE_MONOMINDSCAPECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14A111E0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoMindscapeController_TypeDefinitionIndex = 64652;
