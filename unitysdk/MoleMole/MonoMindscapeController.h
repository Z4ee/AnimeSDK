...
#define MOLEMOLE_MONOMINDSCAPECONTROLLER_GET_ISCORNERSVALID_OFFSET UNITYSDK_OFFSET(0x13EA51E0)
#define MOLEMOLE_MONOMINDSCAPECONTROLLER_GET_REFRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x13EA5050)
#define MOLEMOLE_MONOMINDSCAPECONTROLLER_METHOD_5_460F8AE6EF9687FD_OFFSET UNITYSDK_OFFSET(0x13EA5700)
#define MOLEMOLE_MONOMINDSCAPECONTROLLER_METHOD_5_BB881F05E41D3A04_OFFSET UNITYSDK_OFFSET(0x13EA52A0)
#define MOLEMOLE_MONOMINDSCAPECONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x13EA5340)
#define MOLEMOLE_MONOMINDSCAPECONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x13EA5240)
#define MOLEMOLE_MONOMINDSCAPECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x13EA52F0)
#define MOLEMOLE_MONOMINDSCAPECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x13EA5610)

namespace MoleMole
{
	inline static constexpr unsigned int MonoMindscapeController_TypeDefinitionIndex = 44631;
