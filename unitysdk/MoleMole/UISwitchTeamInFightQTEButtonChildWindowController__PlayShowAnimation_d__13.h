...
#define MOLEMOLE_UISWITCHTEAMINFIGHTQTEBUTTONCHILDWINDOWCONTROLLER__PLAYSHOWANIMATION_D__13_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x791E70)
#define MOLEMOLE_UISWITCHTEAMINFIGHTQTEBUTTONCHILDWINDOWCONTROLLER__PLAYSHOWANIMATION_D__13_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2661E0)

namespace MoleMole
{
	inline static constexpr unsigned int UISwitchTeamInFightQTEButtonChildWindowController__PlayShowAnimation_d__13_TypeDefinitionIndex = 49066;
