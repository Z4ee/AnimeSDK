...
#define MOLEMOLE_UIBOSSRUSHREWARDCOMPROWWIDGETCONTROLLER___C__DISPLAYCLASS10_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1604C2B0)
#define MOLEMOLE_UIBOSSRUSHREWARDCOMPROWWIDGETCONTROLLER___C__DISPLAYCLASS10_0__GETVIEWDATAS_B__0_OFFSET UNITYSDK_OFFSET(0x1604C2C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBossRushRewardCompRowWidgetController___c__DisplayClass10_0_TypeDefinitionIndex = 55732;
