...
#define MOLEMOLE_GLOBALPADDINGDATA_METHOD_1_E06B7E07D5241CFE_1_OFFSET UNITYSDK_OFFSET(0x16CAEC00)
#define MOLEMOLE_GLOBALPADDINGDATA_METHOD_1_E06B7E07D5241CFE_2_OFFSET UNITYSDK_OFFSET(0x16CAECA0)
#define MOLEMOLE_GLOBALPADDINGDATA_METHOD_1_E06B7E07D5241CFE_3_OFFSET UNITYSDK_OFFSET(0x16CAED40)
#define MOLEMOLE_GLOBALPADDINGDATA_METHOD_1_E06B7E07D5241CFE_OFFSET UNITYSDK_OFFSET(0x16CAEB50)
#define MOLEMOLE_GLOBALPADDINGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16CAEB40)

namespace MoleMole
{
	inline static constexpr unsigned int GlobalPaddingData_TypeDefinitionIndex = 48169;
