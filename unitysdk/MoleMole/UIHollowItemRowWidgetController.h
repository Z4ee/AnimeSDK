...
#define MOLEMOLE_UIHOLLOWITEMROWWIDGETCONTROLLER_BINDCLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x14688340)
#define MOLEMOLE_UIHOLLOWITEMROWWIDGETCONTROLLER_GET_SELECTIMG_OFFSET UNITYSDK_OFFSET(0x14687790)
#define MOLEMOLE_UIHOLLOWITEMROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14687820)
#define MOLEMOLE_UIHOLLOWITEMROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x146878B0)
#define MOLEMOLE_UIHOLLOWITEMROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x146877C0)
#define MOLEMOLE_UIHOLLOWITEMROWWIDGETCONTROLLER_REFRESHMUTE_OFFSET UNITYSDK_OFFSET(0x146879A0)
#define MOLEMOLE_UIHOLLOWITEMROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x14687D00)
#define MOLEMOLE_UIHOLLOWITEMROWWIDGETCONTROLLER_SETBTNINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x14687930)
#define MOLEMOLE_UIHOLLOWITEMROWWIDGETCONTROLLER_SHOWLOCK_OFFSET UNITYSDK_OFFSET(0x146882B0)
#define MOLEMOLE_UIHOLLOWITEMROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14688460)
#define MOLEMOLE_UIHOLLOWITEMROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x146884C0)
#define MOLEMOLE_UIHOLLOWITEMROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14688550)
#define MOLEMOLE_UIHOLLOWITEMROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x146885E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowItemRowWidgetController_TypeDefinitionIndex = 55517;

	class UIHollowItemRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_2655FBB72F5F5E2B* _view; // 0x2B8
