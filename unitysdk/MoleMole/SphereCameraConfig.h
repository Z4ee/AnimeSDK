...
#define MOLEMOLE_SPHERECAMERACONFIG_GET_OVERRIDEFOCUSPOINTHEIGHTVALUE_OFFSET UNITYSDK_OFFSET(0x15BB6340)
#define MOLEMOLE_SPHERECAMERACONFIG_SET_OVERRIDEFOCUSPOINTHEIGHTVALUE_OFFSET UNITYSDK_OFFSET(0x15BB6350)
#define MOLEMOLE_SPHERECAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x15BB63B0)

namespace MoleMole
{
	inline static constexpr unsigned int SphereCameraConfig_TypeDefinitionIndex = 46455;
