...
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_GETCARDID_OFFSET UNITYSDK_OFFSET(0x14EA5070)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x14EA5290)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14EA4920)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_ONREQUESTFLIPCARDSUCCESS_OFFSET UNITYSDK_OFFSET(0x14EA54F0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x14EA4A30)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14EA49B0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14EA4650)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x14EA4B30)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_SHOWFLIPEDCARDREWARDPOPWINDOW_OFFSET UNITYSDK_OFFSET(0x14EA5110)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14EA5660)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER__ONREQUESTFLIPCARDSUCCESS_B__16_0_OFFSET UNITYSDK_OFFSET(0x14EA5670)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x14EA56B0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14EA56C0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x14EA5750)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14EA57F0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14EA5880)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlipCardGameZhaoRowWidgetController_TypeDefinitionIndex = 72001;
	...
	public:
		...
		::Class_2_D330081BF2BADC34* _view; // 0x310
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_11*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_ONREQUESTFLIPCARDSUCCESS_OFFSET))(this, rcvmessage);
		}
