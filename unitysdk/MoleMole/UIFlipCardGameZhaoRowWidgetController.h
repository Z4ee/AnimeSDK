...
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_GETCARDID_OFFSET UNITYSDK_OFFSET(0x15271C20)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x15271E40)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x152714D0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_ONREQUESTFLIPCARDSUCCESS_OFFSET UNITYSDK_OFFSET(0x152720A0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x152715E0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15271560)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15271200)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x152716E0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_SHOWFLIPEDCARDREWARDPOPWINDOW_OFFSET UNITYSDK_OFFSET(0x15271CC0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15272210)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER__ONREQUESTFLIPCARDSUCCESS_B__16_0_OFFSET UNITYSDK_OFFSET(0x15272220)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x15272260)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15272270)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15272300)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x152723A0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15272430)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlipCardGameZhaoRowWidgetController_TypeDefinitionIndex = 65277;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_29*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_ONREQUESTFLIPCARDSUCCESS_OFFSET))(this, rcvmessage);
		}
