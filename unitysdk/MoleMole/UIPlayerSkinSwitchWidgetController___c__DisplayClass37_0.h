...
#define MOLEMOLE_UIPLAYERSKINSWITCHWIDGETCONTROLLER___C__DISPLAYCLASS37_0__CTOR_OFFSET UNITYSDK_OFFSET(0x14D5CF50)
#define MOLEMOLE_UIPLAYERSKINSWITCHWIDGETCONTROLLER___C__DISPLAYCLASS37_0__SWITCHTOAVATAR_B__0_OFFSET UNITYSDK_OFFSET(0x14D5CF60)
#define MOLEMOLE_UIPLAYERSKINSWITCHWIDGETCONTROLLER___C__DISPLAYCLASS37_0__SWITCHTOAVATAR_B__1_OFFSET UNITYSDK_OFFSET(0x14D5D0D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPlayerSkinSwitchWidgetController___c__DisplayClass37_0_TypeDefinitionIndex = 60436;
