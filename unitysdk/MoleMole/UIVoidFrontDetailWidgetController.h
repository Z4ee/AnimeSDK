...
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_ISLEFTLIMIT_OFFSET UNITYSDK_OFFSET(0x1610CE80)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_ISRIGHTLIMIT_OFFSET UNITYSDK_OFFSET(0x1610CEF0)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_ONCLOSEBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x1610BC30)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1610CD70)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_ONINFOBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x1610BCC0)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_ONLEFTARROWBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x1610BE90)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_ONRIGHTARROWBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x1610C690)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1610CE00)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1610B780)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1610C710)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1610C780)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_SETCLOSEACTION_OFFSET UNITYSDK_OFFSET(0x1610BBE0)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_SETNODESTATE_OFFSET UNITYSDK_OFFSET(0x1610C080)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_TRIGGERCLOSEBTN_OFFSET UNITYSDK_OFFSET(0x1610CBF0)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_UPDATEARROW_OFFSET UNITYSDK_OFFSET(0x1610C8E0)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1610CFA0)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER__ONUIINIT_B__6_0_OFFSET UNITYSDK_OFFSET(0x1610D000)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER__ONUIINIT_B__6_1_OFFSET UNITYSDK_OFFSET(0x1610D010)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1610D020)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1610D0B0)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1610D140)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1610D1D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVoidFrontDetailWidgetController_TypeDefinitionIndex = 45748;
