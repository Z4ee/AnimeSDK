...
#define MOLEMOLE_UIGACHAWEAPONPANELWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18451A10)
#define MOLEMOLE_UIGACHAWEAPONPANELWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18451520)
#define MOLEMOLE_UIGACHAWEAPONPANELWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18451AA0)
#define MOLEMOLE_UIGACHAWEAPONPANELWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18451450)
#define MOLEMOLE_UIGACHAWEAPONPANELWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x184514B0)
#define MOLEMOLE_UIGACHAWEAPONPANELWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x18451610)
#define MOLEMOLE_UIGACHAWEAPONPANELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18451B20)
#define MOLEMOLE_UIGACHAWEAPONPANELWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18451B80)
#define MOLEMOLE_UIGACHAWEAPONPANELWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18451C10)
#define MOLEMOLE_UIGACHAWEAPONPANELWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18451CB0)
#define MOLEMOLE_UIGACHAWEAPONPANELWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18451D40)
#define MOLEMOLE_UIGACHAWEAPONPANELWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18451DD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaWeaponPanelWidgetController_TypeDefinitionIndex = 43919;
