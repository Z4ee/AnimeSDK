...
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_CHECKADDNEWENTITY_OFFSET UNITYSDK_OFFSET(0x1737CE80)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_CHECKCANLINKHATREDLINE_OFFSET UNITYSDK_OFFSET(0x1737D950)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_CHECKVALIDENTITY_OFFSET UNITYSDK_OFFSET(0x1737D450)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_FETCHNEEDPROCESSDATA_OFFSET UNITYSDK_OFFSET(0x1737D720)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_LINKTARGETHEAD_OFFSET UNITYSDK_OFFSET(0x15155170)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_LOADHEADQUADRESOBJ_OFFSET UNITYSDK_OFFSET(0x1737DB60)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_LOADRESOBJ_OFFSET UNITYSDK_OFFSET(0x1737DA80)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x151539A0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x151556D0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x1737CD70)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_ONMONSTERREMOVE_OFFSET UNITYSDK_OFFSET(0x1737D070)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x15153E40)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_REFRESHHATREDLINESTATE_OFFSET UNITYSDK_OFFSET(0x15154C80)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_REGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0x1737C950)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_RELEASEHATREDLINEGAMEOBJECTTOPOOL_OFFSET UNITYSDK_OFFSET(0x1737DC40)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_RELEASEHATREDLINE_OFFSET UNITYSDK_OFFSET(0x1737D5A0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_RELEASELINKTARGETHEAD_OFFSET UNITYSDK_OFFSET(0x15154A60)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_SETENTITYLINKINFO_OFFSET UNITYSDK_OFFSET(0x15154710)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_TICKHATREDLINE_OFFSET UNITYSDK_OFFSET(0x151543C0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_TICKWAITINGENTITY_OFFSET UNITYSDK_OFFSET(0x151541E0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_UNREGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0x1737CBF0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1737DCE0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1737E040)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1737E0D0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1737E160)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM___BASE_REGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0x1737E1F0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM___BASE_UNREGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0x1737E280)

namespace MoleMole
{
	inline static constexpr unsigned int MonsterHatredLineSubSystem_TypeDefinitionIndex = 51852;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Int32>* linkedTargetRecord; // 0x10
		::System::Collections::Generic::List_1<::MoleMole::Battle::Entity*>* waittingList; // 0x18
		::Foundation::AssetPath quadResPath; // 0x20
		::Foundation::AssetPath lineResPath; // 0x30
		::Foundation::AssetRequestHandle lineResHandle; // 0x40
		::System::String* hetredLineEnableAnimatorZoneTag; // 0x60
		::System::Collections::Generic::Queue_1<::UnityEngine::GameObject*>* hatredLineObjectPool; // 0x68
		::System::Collections::Generic::Queue_1<::UnityEngine::GameObject*>* headQuadObjectPool; // 0x70
		::System::Collections::Generic::List_1<::MoleMole::MonsterHatredLineSubSystem_HatredLineLinkData*>* newAddHatredDataList; // 0x78
		::Foundation::AssetRequestHandle quadResHandle; // 0x80
		::System::String* hideHetredLineAnimatorZoneTag; // 0xA0
		::System::String* playerAttachPointName; // 0xA8
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::ScreenSpaceQuadRenderer*>* linkHeadDic; // 0xB0
		::System::String* enemyAttachPointName; // 0xB8
		::System::Collections::Generic::List_1<::MoleMole::MonsterHatredLineSubSystem_HatredLineLinkData*>* hatredLineDataList; // 0xC0
