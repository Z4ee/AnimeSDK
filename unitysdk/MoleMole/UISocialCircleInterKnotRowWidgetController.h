...
#define MOLEMOLE_UISOCIALCIRCLEINTERKNOTROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xEBA73A0)
#define MOLEMOLE_UISOCIALCIRCLEINTERKNOTROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xEBA7410)
#define MOLEMOLE_UISOCIALCIRCLEINTERKNOTROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xEBA7690)
#define MOLEMOLE_UISOCIALCIRCLEINTERKNOTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xEBA74D0)
#define MOLEMOLE_UISOCIALCIRCLEINTERKNOTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xEBA7AD0)
#define MOLEMOLE_UISOCIALCIRCLEINTERKNOTROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xEBA7AE0)
#define MOLEMOLE_UISOCIALCIRCLEINTERKNOTROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xEBA7B80)
#define MOLEMOLE_UISOCIALCIRCLEINTERKNOTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xEBA7C10)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleInterKnotRowWidgetController_TypeDefinitionIndex = 46210;
