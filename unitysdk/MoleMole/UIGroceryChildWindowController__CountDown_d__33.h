...
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER__COUNTDOWN_D__33_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1880FF10)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER__COUNTDOWN_D__33_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x188102D0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER__COUNTDOWN_D__33_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18810330)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER__COUNTDOWN_D__33_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x188102E0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER__COUNTDOWN_D__33_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1880FF00)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER__COUNTDOWN_D__33__CTOR_OFFSET UNITYSDK_OFFSET(0x1880FEF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGroceryChildWindowController__CountDown_d__33_TypeDefinitionIndex = 76225;
