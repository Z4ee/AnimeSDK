...
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER__COUNTDOWN_D__33_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19F094B0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER__COUNTDOWN_D__33_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19F09870)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER__COUNTDOWN_D__33_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19F098D0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER__COUNTDOWN_D__33_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19F09880)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER__COUNTDOWN_D__33_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19F094A0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER__COUNTDOWN_D__33__CTOR_OFFSET UNITYSDK_OFFSET(0x19F09490)

namespace MoleMole
{
	inline static constexpr unsigned int UIGroceryChildWindowController__CountDown_d__33_TypeDefinitionIndex = 88166;
