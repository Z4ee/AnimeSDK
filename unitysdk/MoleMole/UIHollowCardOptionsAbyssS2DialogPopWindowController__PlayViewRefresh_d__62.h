...
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER__PLAYVIEWREFRESH_D__62_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x823C40)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER__PLAYVIEWREFRESH_D__62_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x283610)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCardOptionsAbyssS2DialogPopWindowController__PlayViewRefresh_d__62_TypeDefinitionIndex = 58268;
	...
	struct alignas(8) UIHollowCardOptionsAbyssS2DialogPopWindowController__PlayViewRefresh_d__62
	{
		...
		::Cysharp::Threading::Tasks::UniTask _playTask_5__2; // 0x30
		::MoleMole::UIHollowCardOptionsAbyssS2DialogPopWindowController* __4__this; // 0x40
