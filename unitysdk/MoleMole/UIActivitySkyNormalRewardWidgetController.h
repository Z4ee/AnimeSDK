...
#define MOLEMOLE_UIACTIVITYSKYNORMALREWARDWIDGETCONTROLLER_ENSUREREWARDWIDGETS_OFFSET UNITYSDK_OFFSET(0x1933F160)
#define MOLEMOLE_UIACTIVITYSKYNORMALREWARDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1933EC70)
#define MOLEMOLE_UIACTIVITYSKYNORMALREWARDWIDGETCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x1933F700)
#define MOLEMOLE_UIACTIVITYSKYNORMALREWARDWIDGETCONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x1933F690)
#define MOLEMOLE_UIACTIVITYSKYNORMALREWARDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1933ED00)
#define MOLEMOLE_UIACTIVITYSKYNORMALREWARDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1933EA80)
#define MOLEMOLE_UIACTIVITYSKYNORMALREWARDWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1933EC00)
#define MOLEMOLE_UIACTIVITYSKYNORMALREWARDWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1933F770)
#define MOLEMOLE_UIACTIVITYSKYNORMALREWARDWIDGETCONTROLLER_TAKEREWARD_OFFSET UNITYSDK_OFFSET(0x1933EF80)
#define MOLEMOLE_UIACTIVITYSKYNORMALREWARDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x193400F0)
#define MOLEMOLE_UIACTIVITYSKYNORMALREWARDWIDGETCONTROLLER__REFRESHVIEW_B__14_0_OFFSET UNITYSDK_OFFSET(0x193401F0)
#define MOLEMOLE_UIACTIVITYSKYNORMALREWARDWIDGETCONTROLLER__TAKEREWARD_B__10_0_OFFSET UNITYSDK_OFFSET(0x193401D0)
#define MOLEMOLE_UIACTIVITYSKYNORMALREWARDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x193402B0)
#define MOLEMOLE_UIACTIVITYSKYNORMALREWARDWIDGETCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x19340340)
#define MOLEMOLE_UIACTIVITYSKYNORMALREWARDWIDGETCONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x193403D0)
#define MOLEMOLE_UIACTIVITYSKYNORMALREWARDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19340460)
#define MOLEMOLE_UIACTIVITYSKYNORMALREWARDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x193404F0)
#define MOLEMOLE_UIACTIVITYSKYNORMALREWARDWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19340580)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivitySkyNormalRewardWidgetController_TypeDefinitionIndex = 48334;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_AE02BC8285203464_18*, ::System::Action*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIACTIVITYSKYNORMALREWARDWIDGETCONTROLLER_REFRESHVIEW_OFFSET))(this, task, takeRewardCallback, tagText);
		}
