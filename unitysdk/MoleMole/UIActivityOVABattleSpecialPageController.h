...
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1645DA20)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0x1645DB80)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1645DA30)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER_ONSELECTITEM_OFFSET UNITYSDK_OFFSET(0x1645EA10)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1645DAC0)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1645E9A0)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1645E000)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER_REFRESHTABNEW_OFFSET UNITYSDK_OFFSET(0x1645E3E0)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1645DC80)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1645EB50)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER__ONUIINIT_B__10_0_OFFSET UNITYSDK_OFFSET(0x1645EB60)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER__ONUIINIT_B__10_1_OFFSET UNITYSDK_OFFSET(0x1645EC60)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER__ONUIINIT_B__10_2_OFFSET UNITYSDK_OFFSET(0x1645EC70)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1645EC80)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1645ED10)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1645ED20)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1645ED30)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityOVABattleSpecialPageController_TypeDefinitionIndex = 58387;
