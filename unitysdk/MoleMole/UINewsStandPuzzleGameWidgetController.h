...
class Class_2_31F529D6A0323528;
...
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_CHECKCOMPLETE_OFFSET UNITYSDK_OFFSET(0x184383F0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_CHECKNEWBIE_OFFSET UNITYSDK_OFFSET(0x1843CF30)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_GENFINISHREQ_OFFSET UNITYSDK_OFFSET(0x1843A650)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_GET_CHAPTERS_OFFSET UNITYSDK_OFFSET(0x18435C40)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_GET_CURRENTCHAPTER_OFFSET UNITYSDK_OFFSET(0x18435BA0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_GET_ISCURCHAPTERCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1843AD90)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_GET_PRESSEDCOLOR_OFFSET UNITYSDK_OFFSET(0x18435C50)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_INITCHAPTERVIEW_OFFSET UNITYSDK_OFFSET(0x1843CCF0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_INITCURCHAPTERPIECES_OFFSET UNITYSDK_OFFSET(0x1843B4C0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_INITDATA_OFFSET UNITYSDK_OFFSET(0x18436940)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x18439230)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_ONCONSOLEMOVING_OFFSET UNITYSDK_OFFSET(0x18438EA0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18437000)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0x18439600)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x18439C70)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x184372B0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x18437AD0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x18437CE0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_ONPREPAREHIDE_OFFSET UNITYSDK_OFFSET(0x18437090)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18436020)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18437A50)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18435D10)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18435FB0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_REFRESHROWONWIN_OFFSET UNITYSDK_OFFSET(0x1843D4C0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_REFRESHTAB_OFFSET UNITYSDK_OFFSET(0x1843CD50)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_RESETCHAPTERCACHE_OFFSET UNITYSDK_OFFSET(0x1843AF10)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_SELECTWIDGET_OFFSET UNITYSDK_OFFSET(0x18438A20)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_SENDFINISHONCLOSE_OFFSET UNITYSDK_OFFSET(0x1843A250)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_SENDFINISH_OFFSET UNITYSDK_OFFSET(0x1843A4D0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_SETTOPTABINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x18436120)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_STOPSELECTFORCONSOLE_OFFSET UNITYSDK_OFFSET(0x18437B60)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_SWAPPIECES_OFFSET UNITYSDK_OFFSET(0x18438F20)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_TOGGLECHAPTER_OFFSET UNITYSDK_OFFSET(0x1843D190)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_TOGGLEPREVIEW_OFFSET UNITYSDK_OFFSET(0x18437800)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1843D590)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER__ONUIINIT_B__25_0_OFFSET UNITYSDK_OFFSET(0x1843D5F0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER__ONUIINIT_B__25_1_OFFSET UNITYSDK_OFFSET(0x1843D600)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER__ONUIINIT_B__25_2_OFFSET UNITYSDK_OFFSET(0x1843D610)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER__ONUIINIT_B__25_3_OFFSET UNITYSDK_OFFSET(0x1843D620)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER__ONUIINIT_B__25_4_OFFSET UNITYSDK_OFFSET(0x1843D6F0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1843D920)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x1843D9B0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1843DA40)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x1843DA70)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER___BASE_ONPREPAREHIDE_OFFSET UNITYSDK_OFFSET(0x1843DB00)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1843DB90)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1843DC30)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1843DCC0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1843DD50)

namespace MoleMole
{
	inline static constexpr unsigned int UINewsStandPuzzleGameWidgetController_TypeDefinitionIndex = 50637;

	class UINewsStandPuzzleGameWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_31F529D6A0323528* _view; // 0x2C0
		::MoleMole::UINewsStandPuzzleGameContext* _context; // 0x2C8
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_1099*>* chapters; // 0x2D0
		...
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_1099*>* get_Chapters()
		{
			return ((::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_1099*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_GET_CHAPTERS_OFFSET))(this);
		}
