...
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER_ONADDFRIENDGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x173DB320)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x173DB080)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x173DB000)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x173DB1A0)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER_ONINPUTCHANGED_OFFSET UNITYSDK_OFFSET(0x173DC3E0)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER_ONINPUTFIELDDESELECT_OFFSET UNITYSDK_OFFSET(0x173DC1E0)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER_ONINPUTFIELDSELECT_OFFSET UNITYSDK_OFFSET(0x173DC060)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER_ONRECEIVEADDFRIENDREQUESTLIST_OFFSET UNITYSDK_OFFSET(0x173DB3C0)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x173DADA0)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x173DB110)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x173DA300)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER_ONUPDATEREQUESTLIST_OFFSET UNITYSDK_OFFSET(0x173DB2A0)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER_SETUPPARENTCONTROLLER_OFFSET UNITYSDK_OFFSET(0x173DB250)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER_UPDATEFRIENDLIST_OFFSET UNITYSDK_OFFSET(0x173DAF00)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x173DC470)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER__ONUIINIT_B__2_0_OFFSET UNITYSDK_OFFSET(0x173DC4D0)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER__ONUIINIT_B__2_1_OFFSET UNITYSDK_OFFSET(0x173DC540)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER__ONUIINIT_B__2_2_OFFSET UNITYSDK_OFFSET(0x173DC610)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER__ONUIINIT_B__2_3_OFFSET UNITYSDK_OFFSET(0x173DC670)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER__ONUIINIT_B__2_4_OFFSET UNITYSDK_OFFSET(0x173DC8C0)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER__ONUIINIT_B__2_5_OFFSET UNITYSDK_OFFSET(0x173DC920)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER__ONUIINIT_B__2_6_OFFSET UNITYSDK_OFFSET(0x173DC5B0)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER__UPDATEFRIENDLIST_B__11_0_OFFSET UNITYSDK_OFFSET(0x173DC980)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x173DC9E0)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x173DCA70)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x173DCB00)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x173DCB30)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x173DCBD0)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x173DCC60)

namespace MoleMole
{
	inline static constexpr unsigned int UIAddFriendWidgetController_TypeDefinitionIndex = 62617;
