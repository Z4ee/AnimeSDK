...
#define MOLEMOLE_UISURFTURNLEFTCHILDWINDOWCONTROLLER_GET_BUTTON_OFFSET UNITYSDK_OFFSET(0x17BB64E0)
#define MOLEMOLE_UISURFTURNLEFTCHILDWINDOWCONTROLLER_GET_ENABLEDRAGINPUTINSKILLBUTTON_OFFSET UNITYSDK_OFFSET(0x17BB64F0)
#define MOLEMOLE_UISURFTURNLEFTCHILDWINDOWCONTROLLER_GET_EVENT_OFFSET UNITYSDK_OFFSET(0x17BB64D0)
#define MOLEMOLE_UISURFTURNLEFTCHILDWINDOWCONTROLLER_GET_KEYPANELROOT_OFFSET UNITYSDK_OFFSET(0x17BB64B0)
#define MOLEMOLE_UISURFTURNLEFTCHILDWINDOWCONTROLLER_GET_SKILLBUTTON_OFFSET UNITYSDK_OFFSET(0x17BB6490)
#define MOLEMOLE_UISURFTURNLEFTCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17BB6500)

namespace MoleMole
{
	inline static constexpr unsigned int UISurfTurnLeftChildWindowController_TypeDefinitionIndex = 57709;
