...
#define MOLEMOLE_UISURFTURNLEFTCHILDWINDOWCONTROLLER_GET_BUTTON_OFFSET UNITYSDK_OFFSET(0x11B7E860)
#define MOLEMOLE_UISURFTURNLEFTCHILDWINDOWCONTROLLER_GET_ENABLEDRAGINPUTINSKILLBUTTON_OFFSET UNITYSDK_OFFSET(0x11B7E870)
#define MOLEMOLE_UISURFTURNLEFTCHILDWINDOWCONTROLLER_GET_EVENT_OFFSET UNITYSDK_OFFSET(0x11B7E850)
#define MOLEMOLE_UISURFTURNLEFTCHILDWINDOWCONTROLLER_GET_KEYPANELROOT_OFFSET UNITYSDK_OFFSET(0x11B7E830)
#define MOLEMOLE_UISURFTURNLEFTCHILDWINDOWCONTROLLER_GET_SKILLBUTTON_OFFSET UNITYSDK_OFFSET(0x11B7E810)
#define MOLEMOLE_UISURFTURNLEFTCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11B7E880)

namespace MoleMole
{
	inline static constexpr unsigned int UISurfTurnLeftChildWindowController_TypeDefinitionIndex = 56078;

	class UISurfTurnLeftChildWindowController : public ::MoleMole::UISurfAutoSkillButton_1<::Class_2_0C1EE8A3BE8526FC_6*>
	{
	public:
		::System::Void _ctor()
		{
