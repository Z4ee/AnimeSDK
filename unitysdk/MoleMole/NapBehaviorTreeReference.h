...
#define MOLEMOLE_NAPBEHAVIORTREEREFERENCE_GETEXTERNALBEHAVIORS_OFFSET UNITYSDK_OFFSET(0x17926C30)
#define MOLEMOLE_NAPBEHAVIORTREEREFERENCE_LOADPATHBEHAVIORTREE_OFFSET UNITYSDK_OFFSET(0x17926CD0)
#define MOLEMOLE_NAPBEHAVIORTREEREFERENCE_ONPREPAREEXTERNALBEHAVIORS_OFFSET UNITYSDK_OFFSET(0x17926B30)
#define MOLEMOLE_NAPBEHAVIORTREEREFERENCE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x17926C70)
#define MOLEMOLE_NAPBEHAVIORTREEREFERENCE_TRYLOADNULLBEHAVIORTREE_OFFSET UNITYSDK_OFFSET(0x17927130)
#define MOLEMOLE_NAPBEHAVIORTREEREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x17927490)
#define MOLEMOLE_NAPBEHAVIORTREEREFERENCE__DOCUSTOMLOAD_OFFSET UNITYSDK_OFFSET(0x17927450)
#define MOLEMOLE_NAPBEHAVIORTREEREFERENCE__LOADEXTERNALBEHAVIORS_OFFSET UNITYSDK_OFFSET(0x17926BC0)
#define MOLEMOLE_NAPBEHAVIORTREEREFERENCE___BASE_GETEXTERNALBEHAVIORS_OFFSET UNITYSDK_OFFSET(0x17927520)
#define MOLEMOLE_NAPBEHAVIORTREEREFERENCE___BASE_ONPREPAREEXTERNALBEHAVIORS_OFFSET UNITYSDK_OFFSET(0x179275B0)
#define MOLEMOLE_NAPBEHAVIORTREEREFERENCE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x17927640)

namespace MoleMole
{
	inline static constexpr unsigned int NapBehaviorTreeReference_TypeDefinitionIndex = 58053;
