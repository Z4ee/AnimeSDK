...
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER_CLEARNULLCOLOR_OFFSET UNITYSDK_OFFSET(0x192CE490)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER_CLEAR_OFFSET UNITYSDK_OFFSET(0x192CCEB0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER_CLICK_OFFSET UNITYSDK_OFFSET(0x192CFE60)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER_DESELECT_OFFSET UNITYSDK_OFFSET(0x192CFCF0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER_GET_NEEDUNLOCK_OFFSET UNITYSDK_OFFSET(0x192CD6B0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER_GET_NODE_OFFSET UNITYSDK_OFFSET(0x192CCC50)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x192CD4C0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER_ONBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x192CFEB0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x192CE2F0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER_ONNODERESET_OFFSET UNITYSDK_OFFSET(0x192CF9D0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x192CEB40)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x192CECC0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x192CD750)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x192CE3C0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER_PLAYANIM_OFFSET UNITYSDK_OFFSET(0x192D0FF0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER_READCOLOR_OFFSET UNITYSDK_OFFSET(0x192CE050)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x192CEAA0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER_REVERSENODE_OFFSET UNITYSDK_OFFSET(0x192CFAB0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER_ROTATENODE_OFFSET UNITYSDK_OFFSET(0x192D02A0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER_SELECT_OFFSET UNITYSDK_OFFSET(0x192CFB30)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER_SETSTATE_OFFSET UNITYSDK_OFFSET(0x192CF510)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER_SETTERMCOLOR_OFFSET UNITYSDK_OFFSET(0x192CED40)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER_SET_NODE_OFFSET UNITYSDK_OFFSET(0x192CCC60)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER_SWITCHLIGHT_OFFSET UNITYSDK_OFFSET(0x192D1100)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER_TOGGLENODEACTIVE_OFFSET UNITYSDK_OFFSET(0x192D0AB0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER_TOGGLESTATEPANEL_OFFSET UNITYSDK_OFFSET(0x192D12A0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x192D13A0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x192D1340)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER__INITVIEW_G__INITNODE_46_1_OFFSET UNITYSDK_OFFSET(0x19F90CF0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER__INITVIEW_G__INITNULL_46_0_OFFSET UNITYSDK_OFFSET(0x192D0330)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER__SETSTATE_B__51_0_OFFSET UNITYSDK_OFFSET(0x19F91890)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19F918D0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x19F91960)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19F91970)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19F91A00)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19F91A90)

namespace MoleMole
{
	inline static constexpr unsigned int UIDataFixNodeWidgetController_TypeDefinitionIndex = 50793;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(UIDataFixNodeWidgetController_TypeDefinitionIndex)->GetStaticField(0xF350);
		}
		static ::System::Single* StaticGet_UpdateInterval()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(UIDataFixNodeWidgetController_TypeDefinitionIndex)->GetStaticField(0xF354);
		}
		static ::System::Single* StaticGet_NullNodeTotalTime()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(UIDataFixNodeWidgetController_TypeDefinitionIndex)->GetStaticField(0xF358);
		}
		::Class_2_79AE422BA06F6D26_112* _view; // 0x2C0
		::Class_1_AEB5FD209BA140DF* _node; // 0x2C8
		::Class_3_AA801472CE8A39B1* _model; // 0x2D0
		...
		::Class_1_AEB5FD209BA140DF* get_Node()
		{
			return ((::Class_1_AEB5FD209BA140DF*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER_GET_NODE_OFFSET))(this);
		}

		::System::Void set_Node(::Class_1_AEB5FD209BA140DF* value)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_AEB5FD209BA140DF*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER_SET_NODE_OFFSET))(this, value);
		}
