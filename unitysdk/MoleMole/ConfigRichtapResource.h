...
#define MOLEMOLE_CONFIGRICHTAPRESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C486230)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigRichtapResource_TypeDefinitionIndex = 46050;
