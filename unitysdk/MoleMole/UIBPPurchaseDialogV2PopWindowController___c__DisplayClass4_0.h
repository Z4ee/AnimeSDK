...
#define MOLEMOLE_UIBPPURCHASEDIALOGV2POPWINDOWCONTROLLER___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0x13E40570)
#define MOLEMOLE_UIBPPURCHASEDIALOGV2POPWINDOWCONTROLLER___C__DISPLAYCLASS4_0__SHOWNONEPURCHASEBPSHOP_B__0_OFFSET UNITYSDK_OFFSET(0x13E40580)
#define MOLEMOLE_UIBPPURCHASEDIALOGV2POPWINDOWCONTROLLER___C__DISPLAYCLASS4_0__SHOWNONEPURCHASEBPSHOP_B__1_OFFSET UNITYSDK_OFFSET(0x13E40640)

namespace MoleMole
{
	inline static constexpr unsigned int UIBPPurchaseDialogV2PopWindowController___c__DisplayClass4_0_TypeDefinitionIndex = 45456;

	class UIBPPurchaseDialogV2PopWindowController___c__DisplayClass4_0 : public ::System::Object
	{
	public:
		::Class_1_D12E4BF61CBE42EF* luxuryItem; // 0x10
		::Class_2_222A145CFB71510C* battlePassModel; // 0x18
		::MoleMole::UIBPPurchaseDialogV2PopWindowController* __4__this; // 0x20
		::Class_1_D12E4BF61CBE42EF* advanceItem; // 0x28
