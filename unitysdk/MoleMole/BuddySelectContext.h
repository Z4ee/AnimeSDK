...
#define MOLEMOLE_BUDDYSELECTCONTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0xDB87160)
#define MOLEMOLE_BUDDYSELECTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xDB87100)

namespace MoleMole
{
	inline static constexpr unsigned int BuddySelectContext_TypeDefinitionIndex = 48973;
	...
	public:
		...
		::System::Action* OnBuddyChange; // 0x30
		::Il2CppArray<::System::Int32>* initBuddys; // 0x38
		::Il2CppArray<::System::Int32>* OutputSelectBuddy; // 0x40
		::System::Func_2<::System::Int32, ::System::Boolean>* buddyLockCheckFunc; // 0x48
		::System::String* buddyLockTipTextMapId; // 0x50
		::Class_2_F69D29AB796376C2* QuestCfg; // 0x58
		::System::Boolean IsShowBuddySelect; // 0x60
		::System::Boolean IsRobotBuddy; // 0x61
		::System::Boolean IsStoryMode; // 0x62
