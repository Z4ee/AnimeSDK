...
#define MOLEMOLE_UISETTINGPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15113F00)

namespace MoleMole
{
	inline static constexpr unsigned int UISettingPageContext_TypeDefinitionIndex = 63671;
