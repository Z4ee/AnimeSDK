...
#define MOLEMOLE_GENERICSCORESUBSYSTEM_GETSCOREDETAIL_OFFSET UNITYSDK_OFFSET(0x16E597E0)
#define MOLEMOLE_GENERICSCORESUBSYSTEM_GETSCORERATIO_OFFSET UNITYSDK_OFFSET(0x16E59980)
#define MOLEMOLE_GENERICSCORESUBSYSTEM_GETSCORERECOVER_OFFSET UNITYSDK_OFFSET(0x16E59A90)
#define MOLEMOLE_GENERICSCORESUBSYSTEM_GETSCORE_OFFSET UNITYSDK_OFFSET(0x16E45900)
#define MOLEMOLE_GENERICSCORESUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x16E59440)
#define MOLEMOLE_GENERICSCORESUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x16E59540)
#define MOLEMOLE_GENERICSCORESUBSYSTEM_REGISTERGENERICSCOREMIXIN_OFFSET UNITYSDK_OFFSET(0x16E59620)
#define MOLEMOLE_GENERICSCORESUBSYSTEM_TRYGETSCORE_OFFSET UNITYSDK_OFFSET(0x16E59BA0)
#define MOLEMOLE_GENERICSCORESUBSYSTEM_UNREGISTERGENERICSCOREMIXIN_OFFSET UNITYSDK_OFFSET(0x16E59750)
#define MOLEMOLE_GENERICSCORESUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x16E59D10)
#define MOLEMOLE_GENERICSCORESUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x16E59D30)
#define MOLEMOLE_GENERICSCORESUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x16E59DC0)

namespace MoleMole
{
	inline static constexpr unsigned int GenericScoreSubsystem_TypeDefinitionIndex = 74854;
