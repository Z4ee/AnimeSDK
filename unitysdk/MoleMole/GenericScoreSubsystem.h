...
#define MOLEMOLE_GENERICSCORESUBSYSTEM_GETSCOREDETAIL_OFFSET UNITYSDK_OFFSET(0x10D4DBF0)
#define MOLEMOLE_GENERICSCORESUBSYSTEM_GETSCORERATIO_OFFSET UNITYSDK_OFFSET(0x10D4DD90)
#define MOLEMOLE_GENERICSCORESUBSYSTEM_GETSCORERECOVER_OFFSET UNITYSDK_OFFSET(0x10D4DEA0)
#define MOLEMOLE_GENERICSCORESUBSYSTEM_GETSCORE_OFFSET UNITYSDK_OFFSET(0x10D39C20)
#define MOLEMOLE_GENERICSCORESUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x10D4D850)
#define MOLEMOLE_GENERICSCORESUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x10D4D950)
#define MOLEMOLE_GENERICSCORESUBSYSTEM_REGISTERGENERICSCOREMIXIN_OFFSET UNITYSDK_OFFSET(0x10D4DA30)
#define MOLEMOLE_GENERICSCORESUBSYSTEM_TRYGETSCORE_OFFSET UNITYSDK_OFFSET(0x10D4DFB0)
#define MOLEMOLE_GENERICSCORESUBSYSTEM_UNREGISTERGENERICSCOREMIXIN_OFFSET UNITYSDK_OFFSET(0x10D4DB60)
#define MOLEMOLE_GENERICSCORESUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x10D4E120)
#define MOLEMOLE_GENERICSCORESUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x10D4E140)
#define MOLEMOLE_GENERICSCORESUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x10D4E1D0)

namespace MoleMole
{
	inline static constexpr unsigned int GenericScoreSubsystem_TypeDefinitionIndex = 64265;
