...
#define MOLEMOLE_VEHICLE_MONOSURFVEHICLE__CTOR_OFFSET UNITYSDK_OFFSET(0xF80DE10)

namespace MoleMole::Vehicle
{
	inline static constexpr unsigned int MonoSurfVehicle_TypeDefinitionIndex = 38950;
