...
#define MOLEMOLE_VEHICLE_VEHICLECONFIG_METHOD_1_623160C745FC10C0_OFFSET UNITYSDK_OFFSET(0x112EA420)
#define MOLEMOLE_VEHICLE_VEHICLECONFIG_METHOD_1_8C97CA3BAB7FB2D7_OFFSET UNITYSDK_OFFSET(0x112EA340)
#define MOLEMOLE_VEHICLE_VEHICLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x112E9990)

namespace MoleMole::Vehicle
{
	inline static constexpr unsigned int VehicleConfig_TypeDefinitionIndex = 47006;
