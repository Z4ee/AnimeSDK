...
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLTRIGGERABILITY_CLEANUP_OFFSET UNITYSDK_OFFSET(0x11D71F10)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLTRIGGERABILITY_INIT_OFFSET UNITYSDK_OFFSET(0x11D71B40)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLTRIGGERABILITY_ISINSTANTSKILLTYPE_OFFSET UNITYSDK_OFFSET(0x11D71FA0)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLTRIGGERABILITY_ONADD_OFFSET UNITYSDK_OFFSET(0x11D71C70)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLTRIGGERABILITY_ONRECYCLE_OFFSET UNITYSDK_OFFSET(0x11D72000)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLTRIGGERABILITY_ONREMOVED_OFFSET UNITYSDK_OFFSET(0x11D71DD0)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLTRIGGERABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x11D72090)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLTRIGGERABILITY___BASE_CLEANUP_OFFSET UNITYSDK_OFFSET(0x11D720B0)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLTRIGGERABILITY___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x11D72160)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLTRIGGERABILITY___BASE_ISINSTANTSKILLTYPE_OFFSET UNITYSDK_OFFSET(0x11D72230)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLTRIGGERABILITY___BASE_ONADD_OFFSET UNITYSDK_OFFSET(0x11D722C0)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLTRIGGERABILITY___BASE_ONREMOVED_OFFSET UNITYSDK_OFFSET(0x11D72350)

namespace MoleMole
{
	inline static constexpr unsigned int SummerEventDroneSubsystem_WeaponSkillTriggerAbility_TypeDefinitionIndex = 47061;
