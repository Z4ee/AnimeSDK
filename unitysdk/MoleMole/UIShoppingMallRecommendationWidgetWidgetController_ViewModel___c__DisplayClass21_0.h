...
#define MOLEMOLE_UISHOPPINGMALLRECOMMENDATIONWIDGETWIDGETCONTROLLER_VIEWMODEL___C__DISPLAYCLASS21_0__CTOR_OFFSET UNITYSDK_OFFSET(0x152B4260)
#define MOLEMOLE_UISHOPPINGMALLRECOMMENDATIONWIDGETWIDGETCONTROLLER_VIEWMODEL___C__DISPLAYCLASS21_0__CUSTOMCREATEPROPERTY_B__0_OFFSET UNITYSDK_OFFSET(0x152B4270)
#define MOLEMOLE_UISHOPPINGMALLRECOMMENDATIONWIDGETWIDGETCONTROLLER_VIEWMODEL___C__DISPLAYCLASS21_0__CUSTOMCREATEPROPERTY_B__1_OFFSET UNITYSDK_OFFSET(0x152B4420)

namespace MoleMole
{
	inline static constexpr unsigned int UIShoppingMallRecommendationWidgetWidgetController_ViewModel___c__DisplayClass21_0_TypeDefinitionIndex = 43886;
