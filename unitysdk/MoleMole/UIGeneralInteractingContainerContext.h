...
#define MOLEMOLE_UIGENERALINTERACTINGCONTAINERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x17651F80)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralInteractingContainerContext_TypeDefinitionIndex = 50148;
