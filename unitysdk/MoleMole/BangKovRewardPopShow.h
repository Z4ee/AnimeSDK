...
#define MOLEMOLE_BANGKOVREWARDPOPSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x122D1E90)
#define MOLEMOLE_BANGKOVREWARDPOPSHOW_SETMESSAGECONFIG_OFFSET UNITYSDK_OFFSET(0x122D1E30)
#define MOLEMOLE_BANGKOVREWARDPOPSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x122D1D70)
#define MOLEMOLE_BANGKOVREWARDPOPSHOW__ONPROCESS_B__4_1_OFFSET UNITYSDK_OFFSET(0x122D2220)
#define MOLEMOLE_BANGKOVREWARDPOPSHOW___BASE_SETMESSAGECONFIG_OFFSET UNITYSDK_OFFSET(0x122D2250)

namespace MoleMole
{
	inline static constexpr unsigned int BangKovRewardPopShow_TypeDefinitionIndex = 38507;
