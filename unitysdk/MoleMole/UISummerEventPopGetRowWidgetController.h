...
#define MOLEMOLE_UISUMMEREVENTPOPGETROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x160F0510)
#define MOLEMOLE_UISUMMEREVENTPOPGETROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x160F05E0)
#define MOLEMOLE_UISUMMEREVENTPOPGETROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x160F06A0)
#define MOLEMOLE_UISUMMEREVENTPOPGETROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x160F0580)
#define MOLEMOLE_UISUMMEREVENTPOPGETROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x160F0870)
#define MOLEMOLE_UISUMMEREVENTPOPGETROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x160F0880)
#define MOLEMOLE_UISUMMEREVENTPOPGETROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x160F0920)
#define MOLEMOLE_UISUMMEREVENTPOPGETROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x160F09C0)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerEventPopGetRowWidgetController_TypeDefinitionIndex = 77615;
