...
#define MOLEMOLE_VOPERFORMSUBSYSTEM___C__DISPLAYCLASS17_0__CTOR_OFFSET UNITYSDK_OFFSET(0x126CEF20)
#define MOLEMOLE_VOPERFORMSUBSYSTEM___C__DISPLAYCLASS17_0___OPENBLACKCURTAIN_B__1_OFFSET UNITYSDK_OFFSET(0x126CEF30)

namespace MoleMole
{
	inline static constexpr unsigned int VOPerformSubSystem___c__DisplayClass17_0_TypeDefinitionIndex = 54628;
