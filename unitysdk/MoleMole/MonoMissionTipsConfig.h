...
#define MOLEMOLE_MONOMISSIONTIPSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x142AC6A0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoMissionTipsConfig_TypeDefinitionIndex = 57393;
