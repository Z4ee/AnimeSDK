...
#define MOLEMOLE_MAINCITYMESSAGEPUMPSHOW_GET_ISPENETRATE_OFFSET UNITYSDK_OFFSET(0x17909E20)
#define MOLEMOLE_MAINCITYMESSAGEPUMPSHOW_GET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x17909E40)
#define MOLEMOLE_MAINCITYMESSAGEPUMPSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x17909E30)
#define MOLEMOLE_MAINCITYMESSAGEPUMPSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x1790A0A0)
#define MOLEMOLE_MAINCITYMESSAGEPUMPSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1790A070)
#define MOLEMOLE_MAINCITYMESSAGEPUMPSHOW___BASE_GET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x1790A190)

namespace MoleMole
{
	inline static constexpr unsigned int MainCityMessagePumpShow_TypeDefinitionIndex = 67276;
