...
#define MOLEMOLE_UINEOGOLDENMECHAGROUPTABWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x13DEF990)
#define MOLEMOLE_UINEOGOLDENMECHAGROUPTABWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x13DEFA00)
#define MOLEMOLE_UINEOGOLDENMECHAGROUPTABWIDGETCONTROLLER_SETGENERALGROUP_OFFSET UNITYSDK_OFFSET(0x13DEFAC0)
#define MOLEMOLE_UINEOGOLDENMECHAGROUPTABWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x13DEFB70)
#define MOLEMOLE_UINEOGOLDENMECHAGROUPTABWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x13DEFBD0)

namespace MoleMole
{
	inline static constexpr unsigned int UINeoGoldenMechaGroupTabWidgetController_TypeDefinitionIndex = 56508;
