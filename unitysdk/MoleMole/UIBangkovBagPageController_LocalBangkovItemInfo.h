...
namespace MoleMole
{
	inline static constexpr unsigned int UIBangkovBagPageController_LocalBangkovItemInfo_TypeDefinitionIndex = 40335;
	...
	struct alignas(8) UIBangkovBagPageController_LocalBangkovItemInfo
	{
		...
		::Class_3_C3F0E3B5AB5977AE* KovBagIndex; // 0x20
	};
}
