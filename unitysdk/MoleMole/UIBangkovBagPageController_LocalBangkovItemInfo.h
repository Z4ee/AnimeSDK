...
namespace MoleMole
{
	inline static constexpr unsigned int UIBangkovBagPageController_LocalBangkovItemInfo_TypeDefinitionIndex = 61472;
	...
	struct alignas(8) UIBangkovBagPageController_LocalBangkovItemInfo
	{
		...
		::Class_3_C3F0E3B5AB5977AE_29* KovBagIndex; // 0x20
	};
}
