...
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSPANELCONTROLLERBASE_GET_ISARRIVEMAXPOINT_OFFSET UNITYSDK_OFFSET(0x19848730)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSPANELCONTROLLERBASE_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x19848720)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSPANELCONTROLLERBASE_HANDLEALLCUSTOMPROPERTIESONSHOW_OFFSET UNITYSDK_OFFSET(0x19848890)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSPANELCONTROLLERBASE_HANDLEARRIVEMAXPOINTCHANGED_OFFSET UNITYSDK_OFFSET(0x198493D0)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSPANELCONTROLLERBASE_HANDLECURPOINT_OFFSET UNITYSDK_OFFSET(0x198491E0)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSPANELCONTROLLERBASE_HANDLECUSTOMPROPERTY_OFFSET UNITYSDK_OFFSET(0x198489A0)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSPANELCONTROLLERBASE_HANDLEMAXPOINT_OFFSET UNITYSDK_OFFSET(0x19848BA0)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSPANELCONTROLLERBASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x19848B20)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSPANELCONTROLLERBASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x198487E0)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSPANELCONTROLLERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19849540)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSPANELCONTROLLERBASE___BASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x19849670)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSPANELCONTROLLERBASE___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x198495D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelLightUpPointsPanelControllerBase_TypeDefinitionIndex = 72036;
