...
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16696AC0)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_INPUTACTIONCHECK_OFFSET UNITYSDK_OFFSET(0x16697670)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16696B30)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_ONINPUTCHANGED_OFFSET UNITYSDK_OFFSET(0x16697EF0)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_ONINPUTFIELDDESELECT_OFFSET UNITYSDK_OFFSET(0x16697A40)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_ONINPUTFIELDSELECT_OFFSET UNITYSDK_OFFSET(0x166976F0)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x166970F0)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16697600)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x166981E0)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER__ONCREATEVIEWMODEL_B__4_0_OFFSET UNITYSDK_OFFSET(0x16698240)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16698320)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x166983C0)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16698460)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleRecruitWidgetController_TypeDefinitionIndex = 50911;
