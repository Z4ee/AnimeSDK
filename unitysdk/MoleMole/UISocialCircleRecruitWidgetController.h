...
class Class_2_22F3A306F2546923;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }
namespace System { class String; }

#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x179C5B00)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_INPUTACTIONCHECK_OFFSET UNITYSDK_OFFSET(0x179C66C0)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x179C5B70)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_ONINPUTCHANGED_OFFSET UNITYSDK_OFFSET(0x179C6F40)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_ONINPUTFIELDDESELECT_OFFSET UNITYSDK_OFFSET(0x179C6A90)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_ONINPUTFIELDSELECT_OFFSET UNITYSDK_OFFSET(0x179C6740)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x179C6130)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x179C6650)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x179C7230)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER__ONCREATEVIEWMODEL_B__4_0_OFFSET UNITYSDK_OFFSET(0x179C7290)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x179C7370)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x179C7410)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x179C74B0)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleRecruitWidgetController_TypeDefinitionIndex = 86649;

	class UISocialCircleRecruitWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_1_D7C05CE3854E5916* handler; // 0x2C0
		::Class_2_1E2C28EB5494586C* TextValidate; // 0x2C8
		...
		::Class_2_22F3A306F2546923* get__viewModel()
		{
			return ((::Class_2_22F3A306F2546923*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
