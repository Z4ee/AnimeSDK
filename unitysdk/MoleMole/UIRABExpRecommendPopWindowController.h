...
#define MOLEMOLE_UIRABEXPRECOMMENDPOPWINDOWCONTROLLER_CALLBACK_OFFSET UNITYSDK_OFFSET(0x18218150)
#define MOLEMOLE_UIRABEXPRECOMMENDPOPWINDOWCONTROLLER_GET__LOGICDELEGATE_OFFSET UNITYSDK_OFFSET(0x18218080)
#define MOLEMOLE_UIRABEXPRECOMMENDPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18218090)
#define MOLEMOLE_UIRABEXPRECOMMENDPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18218200)
#define MOLEMOLE_UIRABEXPRECOMMENDPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18218290)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABExpRecommendPopWindowController_TypeDefinitionIndex = 65113;
