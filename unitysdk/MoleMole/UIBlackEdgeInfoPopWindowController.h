...
#define MOLEMOLE_UIBLACKEDGEINFOPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1A640930)
#define MOLEMOLE_UIBLACKEDGEINFOPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1A640F50)
#define MOLEMOLE_UIBLACKEDGEINFOPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1A640FE0)
#define MOLEMOLE_UIBLACKEDGEINFOPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1A640940)
#define MOLEMOLE_UIBLACKEDGEINFOPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1A640EE0)
#define MOLEMOLE_UIBLACKEDGEINFOPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A641050)
#define MOLEMOLE_UIBLACKEDGEINFOPOPWINDOWCONTROLLER__ONUIINIT_G__GETBLACKEDGETYPE_3_0_OFFSET UNITYSDK_OFFSET(0x1A640E70)
#define MOLEMOLE_UIBLACKEDGEINFOPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1A641060)
#define MOLEMOLE_UIBLACKEDGEINFOPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1A6410F0)
#define MOLEMOLE_UIBLACKEDGEINFOPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1A641100)
#define MOLEMOLE_UIBLACKEDGEINFOPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1A641110)

namespace MoleMole
{
	inline static constexpr unsigned int UIBlackEdgeInfoPopWindowController_TypeDefinitionIndex = 85580;

	class UIBlackEdgeInfoPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_7BEEB90214042948_10* _view; // 0x318
