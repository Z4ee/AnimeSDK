...
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER_GET_CONFIRMBTN_OFFSET UNITYSDK_OFFSET(0x190EB620)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER_GET_SCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x190EB640)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER_INITSELECTGAMEPAD_OFFSET UNITYSDK_OFFSET(0x190EBE50)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER_INITUPGRADEGAMEPAD_OFFSET UNITYSDK_OFFSET(0x190EC140)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER_ISMUTISELECTMODE_OFFSET UNITYSDK_OFFSET(0x190EBDF0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER_ONCLICKCONFIRM_OFFSET UNITYSDK_OFFSET(0x190EB830)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x190EB900)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x190EB990)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x190EB660)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x190EB890)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER_REFRESHCONFIRM_OFFSET UNITYSDK_OFFSET(0x190EBA10)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER_REGISTERCLICKCONFIRMCALLBACK_OFFSET UNITYSDK_OFFSET(0x190EB7E0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x190EC310)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x190EC370)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x190EC400)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x190EC490)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x190EC520)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCardOptionsRelicPanelWidgetController_TypeDefinitionIndex = 70514;
