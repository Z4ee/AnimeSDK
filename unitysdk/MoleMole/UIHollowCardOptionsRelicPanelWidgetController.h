...
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER_GET_CONFIRMBTN_OFFSET UNITYSDK_OFFSET(0x1637F0D0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER_GET_SCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x1637F0F0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER_INITSELECTGAMEPAD_OFFSET UNITYSDK_OFFSET(0x1637F910)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER_INITUPGRADEGAMEPAD_OFFSET UNITYSDK_OFFSET(0x1637FC00)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER_ISMUTISELECTMODE_OFFSET UNITYSDK_OFFSET(0x1637F8B0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER_ONCLICKCONFIRM_OFFSET UNITYSDK_OFFSET(0x1637F2E0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1637F3B0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1637F440)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1637F110)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1637F340)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER_REFRESHCONFIRM_OFFSET UNITYSDK_OFFSET(0x1637F4C0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER_REGISTERCLICKCONFIRMCALLBACK_OFFSET UNITYSDK_OFFSET(0x1637F290)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1637FDD0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1637FE30)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1637FEC0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1637FF50)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSRELICPANELWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1637FFE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCardOptionsRelicPanelWidgetController_TypeDefinitionIndex = 66317;

	class UIHollowCardOptionsRelicPanelWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_D27E2863F5099D68* _view; // 0x2B8
		::System::Action* _onGiveUpAction; // 0x2C0
		::System::Action* OnClickConfirmAction; // 0x2C8
