...
#define MOLEMOLE_TITLENMEDALTABCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1871CC50)

namespace MoleMole
{
	inline static constexpr unsigned int TitleNMedalTabContext_TypeDefinitionIndex = 51836;
