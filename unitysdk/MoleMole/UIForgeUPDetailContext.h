...
#define MOLEMOLE_UIFORGEUPDETAILCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16CC4D00)

namespace MoleMole
{
	inline static constexpr unsigned int UIForgeUPDetailContext_TypeDefinitionIndex = 41238;
