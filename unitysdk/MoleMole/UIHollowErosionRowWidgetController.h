...
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_HASCOLLECTTHISCURSE_1_OFFSET UNITYSDK_OFFSET(0x169EC410)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_HASCOLLECTTHISCURSE_OFFSET UNITYSDK_OFFSET(0x169EC2A0)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x169EC540)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x169EBAF0)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x169EBD10)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x169EC5D0)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x169EB940)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x169EC300)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_REFRESHREDPOINTBYDATA_OFFSET UNITYSDK_OFFSET(0x169EC3C0)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_REFRESHREDPOINT_OFFSET UNITYSDK_OFFSET(0x169EC0E0)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x169EBE10)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x169EC650)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x169EC660)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x169EC6F0)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x169EC780)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x169EC820)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x169EC8B0)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x169EC940)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowErosionRowWidgetController_TypeDefinitionIndex = 71649;
