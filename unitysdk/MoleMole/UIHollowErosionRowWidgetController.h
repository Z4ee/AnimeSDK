...
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_HASCOLLECTTHISCURSE_1_OFFSET UNITYSDK_OFFSET(0x186E7F40)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_HASCOLLECTTHISCURSE_OFFSET UNITYSDK_OFFSET(0x186E7DD0)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x186E8070)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x186E7610)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x186E7830)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x186E8100)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x186E7460)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x186E7E30)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_REFRESHREDPOINTBYDATA_OFFSET UNITYSDK_OFFSET(0x186E7EF0)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_REFRESHREDPOINT_OFFSET UNITYSDK_OFFSET(0x186E7C10)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x186E7930)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x186E8180)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x186E8190)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x186E8220)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x186E82B0)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x186E8350)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x186E83E0)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x186E8470)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowErosionRowWidgetController_TypeDefinitionIndex = 52810;

	class UIHollowErosionRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_C9DDE9730C6BE395_4* _view; // 0x2F0
		::Class_2_542A772D07AFD4EA* m_curseCfg; // 0x2F8
