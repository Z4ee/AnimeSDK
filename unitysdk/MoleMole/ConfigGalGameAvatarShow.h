...
#define MOLEMOLE_CONFIGGALGAMEAVATARSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x19215470)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigGalGameAvatarShow_TypeDefinitionIndex = 59034;
