...
#define MOLEMOLE_LOGINGACHAVIDEOPOPSHOW_GET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x12F95370)
#define MOLEMOLE_LOGINGACHAVIDEOPOPSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x12F95360)
#define MOLEMOLE_LOGINGACHAVIDEOPOPSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x12F95450)
#define MOLEMOLE_LOGINGACHAVIDEOPOPSHOW_SETMESSAGECONFIG_OFFSET UNITYSDK_OFFSET(0x12F95400)
#define MOLEMOLE_LOGINGACHAVIDEOPOPSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x12F957B0)
#define MOLEMOLE_LOGINGACHAVIDEOPOPSHOW___BASE_SETMESSAGECONFIG_OFFSET UNITYSDK_OFFSET(0x12F957C0)

namespace MoleMole
{
	inline static constexpr unsigned int LoginGachaVideoPopShow_TypeDefinitionIndex = 42349;
