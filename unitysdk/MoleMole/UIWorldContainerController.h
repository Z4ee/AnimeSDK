...
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER_GET_ISIGNOREINPUT_OFFSET UNITYSDK_OFFSET(0x11654010)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x11654000)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x11654150)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER_ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x116541A0)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x11654660)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER_SETCANVASDIRTY_OFFSET UNITYSDK_OFFSET(0x11654760)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x11654020)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x116547B0)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER__ONUIOPEN_B__6_0_OFFSET UNITYSDK_OFFSET(0x116547C0)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER__ONUIOPEN_B__6_1_OFFSET UNITYSDK_OFFSET(0x11654810)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x11654860)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x116548F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorldContainerController_TypeDefinitionIndex = 76239;
