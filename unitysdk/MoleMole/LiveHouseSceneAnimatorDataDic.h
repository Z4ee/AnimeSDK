...
#define MOLEMOLE_LIVEHOUSESCENEANIMATORDATADIC__CTOR_OFFSET UNITYSDK_OFFSET(0x19B2DAA0)

namespace MoleMole
{
	inline static constexpr unsigned int LiveHouseSceneAnimatorDataDic_TypeDefinitionIndex = 80358;
