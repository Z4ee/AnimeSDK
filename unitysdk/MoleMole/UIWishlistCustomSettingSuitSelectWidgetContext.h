...
#define MOLEMOLE_UIWISHLISTCUSTOMSETTINGSUITSELECTWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x126ADAF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWishlistCustomSettingSuitSelectWidgetContext_TypeDefinitionIndex = 67543;
