...
#define MOLEMOLE_UIACTIVITYRETURNTASKROWWIDGETCONTROLLER___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1758B750)
#define MOLEMOLE_UIACTIVITYRETURNTASKROWWIDGETCONTROLLER___C__DISPLAYCLASS8_0__REFRESHREWARDINFO_B__0_OFFSET UNITYSDK_OFFSET(0x1758B760)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityReturnTaskRowWidgetController___c__DisplayClass8_0_TypeDefinitionIndex = 41587;
