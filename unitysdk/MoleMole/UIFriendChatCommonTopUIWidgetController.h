...
#define MOLEMOLE_UIFRIENDCHATCOMMONTOPUIWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x15194DB0)
#define MOLEMOLE_UIFRIENDCHATCOMMONTOPUIWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x151953D0)
#define MOLEMOLE_UIFRIENDCHATCOMMONTOPUIWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15194C90)
#define MOLEMOLE_UIFRIENDCHATCOMMONTOPUIWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15195460)
#define MOLEMOLE_UIFRIENDCHATCOMMONTOPUIWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15194C30)
#define MOLEMOLE_UIFRIENDCHATCOMMONTOPUIWIDGETCONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0x151954E0)
#define MOLEMOLE_UIFRIENDCHATCOMMONTOPUIWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15195540)
#define MOLEMOLE_UIFRIENDCHATCOMMONTOPUIWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x151955A0)
#define MOLEMOLE_UIFRIENDCHATCOMMONTOPUIWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15195630)
#define MOLEMOLE_UIFRIENDCHATCOMMONTOPUIWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x151956D0)
#define MOLEMOLE_UIFRIENDCHATCOMMONTOPUIWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15195760)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendChatCommonTopUIWidgetController_TypeDefinitionIndex = 75476;

	class UIFriendChatCommonTopUIWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_7382653E970C5F93_3* _view; // 0x2B8
		::Class_1_B1CC8F53861C28C2* _data; // 0x2C0
		::Class_1_9EDE5D0623B668B8* _item; // 0x2C8
