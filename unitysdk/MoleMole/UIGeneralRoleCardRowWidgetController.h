...
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_GETGAMEPADSELECTABLE_OFFSET UNITYSDK_OFFSET(0x171E2620)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x171E2140)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x171E21B0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_ONFOCUSSTATECHANGEDFORGAMEPADMODULE_OFFSET UNITYSDK_OFFSET(0x171E2DA0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_ONFOCUSSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x171E2DF0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x171E3590)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x171E3E00)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x171E3F40)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x171E26F0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x171E3330)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x171E4400)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x171E2470)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x171E2900)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_RESETSELECTOBJALPHA_OFFSET UNITYSDK_OFFSET(0x171E33B0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_SETBTNCLICKEDACTION_OFFSET UNITYSDK_OFFSET(0x171E3400)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_SETFOCUSSTATE_OFFSET UNITYSDK_OFFSET(0x171E40A0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_SETSELECTOBJALPHA_OFFSET UNITYSDK_OFFSET(0x171E2F60)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x171E4610)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x171E4620)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x171E46C0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x171E4750)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x171E47E0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x171E4880)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x171E4920)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x171E4930)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x171E49C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralRoleCardRowWidgetController_TypeDefinitionIndex = 57640;
