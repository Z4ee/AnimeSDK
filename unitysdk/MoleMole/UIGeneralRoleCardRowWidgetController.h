...
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_GETGAMEPADSELECTABLE_OFFSET UNITYSDK_OFFSET(0x151B9E30)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x151B9950)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x151B99C0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_ONFOCUSSTATECHANGEDFORGAMEPADMODULE_OFFSET UNITYSDK_OFFSET(0x151BA5B0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_ONFOCUSSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x151BA600)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x151BADA0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x151BB610)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x151BB750)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x151B9F00)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x151BAB40)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x151BBBC0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x151B9C80)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x151BA110)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_RESETSELECTOBJALPHA_OFFSET UNITYSDK_OFFSET(0x151BABC0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_SETBTNCLICKEDACTION_OFFSET UNITYSDK_OFFSET(0x151BAC10)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_SETFOCUSSTATE_OFFSET UNITYSDK_OFFSET(0x151BB860)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER_SETSELECTOBJALPHA_OFFSET UNITYSDK_OFFSET(0x151BA770)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x151BBDD0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x151BBDE0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x151BBE80)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x151BBF10)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x151BBFA0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x151BC040)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x151BC0E0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x151BC0F0)
#define MOLEMOLE_UIGENERALROLECARDROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x151BC180)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralRoleCardRowWidgetController_TypeDefinitionIndex = 55561;
