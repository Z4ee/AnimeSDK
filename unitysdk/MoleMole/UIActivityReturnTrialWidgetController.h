...
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_BINDPAGEBTN_OFFSET UNITYSDK_OFFSET(0x15893BD0)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_CONFRIMSELECT_OFFSET UNITYSDK_OFFSET(0x15894D40)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_CREATEBACKFLOWROLELIST_OFFSET UNITYSDK_OFFSET(0x158937F0)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_GETSERVERSELECT_OFFSET UNITYSDK_OFFSET(0x15895200)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15893AB0)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_ONSELECTTARGETROLEWIDGET_OFFSET UNITYSDK_OFFSET(0x158954E0)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15893B40)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15893EE0)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15893620)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x158936C0)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_OPENPREVIEW_OFFSET UNITYSDK_OFFSET(0x15894850)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_PLAYLEFTSELECT_OFFSET UNITYSDK_OFFSET(0x15894C60)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_PLAYRIGHTSELECT_OFFSET UNITYSDK_OFFSET(0x15894CD0)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_UPDATEAVATARTEXT_OFFSET UNITYSDK_OFFSET(0x158941A0)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0x15893F60)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15895760)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER__ONUIINIT_B__9_0_OFFSET UNITYSDK_OFFSET(0x15895860)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15895870)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15895900)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x158959A0)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15895A30)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15895A40)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityReturnTrialWidgetController_TypeDefinitionIndex = 50979;

	class UIActivityReturnTrialWidgetController : public ::MoleMole::BackFlowWidget
	{
	public:
		::Class_2_6D5460742E9C0095* _view; // 0x2D8
		::MoleMole::UIBackFlowContext* _context; // 0x2E0
		::MoleMole::UIBackFlowActivitySelectAvatarWidgetController* current; // 0x2E8
		::MoleMole::UIBackFlowActivitySelectAvatarWidgetController* serverSelect; // 0x2F0
		::System::Collections::Generic::List_1<::MoleMole::UIBackFlowActivitySelectAvatarWidgetController*>* allSelectItem; // 0x2F8
		::Class_2_79AE422BA06F6D26_133* pageView; // 0x300
		::System::String* LeftAni; // 0x308
		::System::String* RightAni; // 0x310
		::System::Int32 lastIndex; // 0x318
