...
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x17D66C60)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17D659B0)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x17D66B30)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17D65AC0)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17D65A40)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17D65800)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x17D65E70)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_SETCLICKCHECKACTION_OFFSET UNITYSDK_OFFSET(0x17D66A10)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x17D65BF0)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_UPDATECOOPUP_OFFSET UNITYSDK_OFFSET(0x17D66A60)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17D66D10)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x17D66D20)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17D66D30)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x17D66DC0)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17D66E50)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17D66EF0)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17D66F80)

namespace MoleMole
{
	inline static constexpr unsigned int UITabBtnRoleListRowWidgetController_TypeDefinitionIndex = 53082;

	class UITabBtnRoleListRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_129* _view; // 0x2F0
		::Class_1_2CCC5D7984CDCED4* _data; // 0x2F8
		::System::Func_2<::System::Int32, ::System::Boolean>* _clickCheckAction; // 0x300
		::System::Func_2<::System::Int32, ::System::Boolean>* _getIsCoopUpFunc; // 0x308
