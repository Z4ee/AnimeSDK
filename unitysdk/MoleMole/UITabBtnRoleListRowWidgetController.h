...
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x156C7A90)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x156C6800)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x156C7960)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x156C6910)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x156C6890)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x156C6650)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x156C6CC0)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_SETCLICKCHECKACTION_OFFSET UNITYSDK_OFFSET(0x156C7830)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x156C6A40)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_UPDATECOOPUP_OFFSET UNITYSDK_OFFSET(0x156C7880)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x156C7B40)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x156C7B50)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x156C7B60)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x156C7BF0)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x156C7C80)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x156C7D20)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x156C7DB0)

namespace MoleMole
{
	inline static constexpr unsigned int UITabBtnRoleListRowWidgetController_TypeDefinitionIndex = 54559;
