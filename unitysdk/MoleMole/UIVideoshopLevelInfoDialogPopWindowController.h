...
#define MOLEMOLE_UIVIDEOSHOPLEVELINFODIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15535260)
#define MOLEMOLE_UIVIDEOSHOPLEVELINFODIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15535270)
#define MOLEMOLE_UIVIDEOSHOPLEVELINFODIALOGPOPWINDOWCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x15535F60)
#define MOLEMOLE_UIVIDEOSHOPLEVELINFODIALOGPOPWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x15535E60)
#define MOLEMOLE_UIVIDEOSHOPLEVELINFODIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15535EF0)
#define MOLEMOLE_UIVIDEOSHOPLEVELINFODIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15535300)
#define MOLEMOLE_UIVIDEOSHOPLEVELINFODIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15535DF0)
#define MOLEMOLE_UIVIDEOSHOPLEVELINFODIALOGPOPWINDOWCONTROLLER_REFRESHLAYOUT_OFFSET UNITYSDK_OFFSET(0x15535D60)
#define MOLEMOLE_UIVIDEOSHOPLEVELINFODIALOGPOPWINDOWCONTROLLER_UPDATELEVELITEM_OFFSET UNITYSDK_OFFSET(0x15535A10)
#define MOLEMOLE_UIVIDEOSHOPLEVELINFODIALOGPOPWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x15536340)
#define MOLEMOLE_UIVIDEOSHOPLEVELINFODIALOGPOPWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x15536580)
#define MOLEMOLE_UIVIDEOSHOPLEVELINFODIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15536570)
#define MOLEMOLE_UIVIDEOSHOPLEVELINFODIALOGPOPWINDOWCONTROLLER__UPDATELEVELITEM_B__10_0_OFFSET UNITYSDK_OFFSET(0x15536590)
#define MOLEMOLE_UIVIDEOSHOPLEVELINFODIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x155367D0)
#define MOLEMOLE_UIVIDEOSHOPLEVELINFODIALOGPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x15536860)
#define MOLEMOLE_UIVIDEOSHOPLEVELINFODIALOGPOPWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x15536910)
#define MOLEMOLE_UIVIDEOSHOPLEVELINFODIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x155369D0)
#define MOLEMOLE_UIVIDEOSHOPLEVELINFODIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x155369E0)
#define MOLEMOLE_UIVIDEOSHOPLEVELINFODIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x155369F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVideoshopLevelInfoDialogPopWindowController_TypeDefinitionIndex = 61641;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIVideoshopLevelInfoDialogPopWindowController_TypeDefinitionIndex)->GetStaticField(0xACB0);
		}
		::UnityEngine::RectTransform* ScrollViewRect; // 0x310
		::System::Int32 _curSelectLevel; // 0x318
