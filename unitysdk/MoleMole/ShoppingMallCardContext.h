...
#define MOLEMOLE_SHOPPINGMALLCARDCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x12BE0D30)

namespace MoleMole
{
	inline static constexpr unsigned int ShoppingMallCardContext_TypeDefinitionIndex = 42637;

	class ShoppingMallCardContext : public ::MoleMole::ShoppingMallBaseContextBase
	{
	public:
		::Class_2_B4378B46E0020E85* buyBtn; // 0x58
		::Class_2_B4378B46E0020E85* infoBtn; // 0x60
		::UnityEngine::UI::Extension::UILocalizationText* priceText; // 0x68
		::Class_2_B4378B46E0020E85* infoConsoleBtn; // 0x70
