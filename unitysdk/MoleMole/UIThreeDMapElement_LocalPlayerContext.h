...
#define MOLEMOLE_UITHREEDMAPELEMENT_LOCALPLAYERCONTEXT_GETWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x1551E380)
#define MOLEMOLE_UITHREEDMAPELEMENT_LOCALPLAYERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1551E600)
#define MOLEMOLE_UITHREEDMAPELEMENT_LOCALPLAYERCONTEXT___BASE_GETWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x1551E610)

namespace MoleMole
{
	inline static constexpr unsigned int UIThreeDMapElement_LocalPlayerContext_TypeDefinitionIndex = 82122;
