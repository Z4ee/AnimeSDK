...
#define MOLEMOLE_UIMANUALQTEPOPWINDOWCONTROLLER___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17149E90)
#define MOLEMOLE_UIMANUALQTEPOPWINDOWCONTROLLER___C__DISPLAYCLASS9_0__ONCONFIRMBTNCLICKED_B__0_OFFSET UNITYSDK_OFFSET(0x17149EA0)
#define MOLEMOLE_UIMANUALQTEPOPWINDOWCONTROLLER___C__DISPLAYCLASS9_0__ONCONFIRMBTNCLICKED_B__1_OFFSET UNITYSDK_OFFSET(0x1714A070)

namespace MoleMole
{
	inline static constexpr unsigned int UIManualQTEPopWindowController___c__DisplayClass9_0_TypeDefinitionIndex = 54638;
