...
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_DEALFRIENDINVITEMSG_OFFSET UNITYSDK_OFFSET(0x177EED90)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_DNAUTOOPEN_OFFSET UNITYSDK_OFFSET(0x177EF5D0)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x177EDFB0)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_ISALLOWJUMPTOINVITETEAMROOM_OFFSET UNITYSDK_OFFSET(0x177F1700)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_ISALLOWSHOWINVITE_OFFSET UNITYSDK_OFFSET(0x177F1620)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_ONCLICKMARCELADVENTURE_OFFSET UNITYSDK_OFFSET(0x177F0C90)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_ONCLICKREWARDPANEL_OFFSET UNITYSDK_OFFSET(0x177F0B50)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_ONCLICKRIDUBOO_OFFSET UNITYSDK_OFFSET(0x177F0F70)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x177EDFC0)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_ONGOLDMININGDAYACTIVITYSYNC_OFFSET UNITYSDK_OFFSET(0x177EEAE0)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x177F1200)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x177EE900)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x177F1420)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x177EE050)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x177EF510)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_SETTIME_OFFSET UNITYSDK_OFFSET(0x177F08D0)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_SHOWALLPROGRESSBTN_OFFSET UNITYSDK_OFFSET(0x177F04A0)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_SHOWCOLLECTIONBTN_OFFSET UNITYSDK_OFFSET(0x177EF710)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_SHOWINVITE_OFFSET UNITYSDK_OFFSET(0x177F1740)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_SHOWMARCELADVENTUREBTN_OFFSET UNITYSDK_OFFSET(0x177EF770)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_SHOWRIDUBOOBTN_OFFSET UNITYSDK_OFFSET(0x177EFE00)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_SHOWTODOLISTBTN_OFFSET UNITYSDK_OFFSET(0x177EF6B0)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_TRYJOINMARCELADVENTURE_OFFSET UNITYSDK_OFFSET(0x177F1840)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x177F2140)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER__ISALLOWSHOWINVITE_B__22_0_OFFSET UNITYSDK_OFFSET(0x177F2240)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER__ONUIINIT_B__10_1_OFFSET UNITYSDK_OFFSET(0x177F2150)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER__SETTIME_B__14_0_OFFSET UNITYSDK_OFFSET(0x177F2200)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x177F2250)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x177F22E0)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x177F2370)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x177F2410)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x177F2420)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x177F2430)

namespace MoleMole
{
	inline static constexpr unsigned int UIGoldMiningDayMainPageController_TypeDefinitionIndex = 76876;

	class UIGoldMiningDayMainPageController : public ::MoleMole::UIMainCityStorePageController
	{
	public:
		::Class_2_C7387D40D4120A48_18* _view; // 0x328
