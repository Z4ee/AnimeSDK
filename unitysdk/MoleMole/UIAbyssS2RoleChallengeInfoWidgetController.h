...
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER_ONBUILDBTNCLICK_OFFSET UNITYSDK_OFFSET(0x183BC960)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x183BC6E0)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x183BC540)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER_ONMONSTERCARDBTNCLICK_OFFSET UNITYSDK_OFFSET(0x183BC770)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x183BC100)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x183BC4D0)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER_REFRESHBUFFVIEW_OFFSET UNITYSDK_OFFSET(0x183BCE00)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER_REFRESHCHALLENGEVIEW_OFFSET UNITYSDK_OFFSET(0x183BCC10)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER_REFRESHGRADEVIEW_OFFSET UNITYSDK_OFFSET(0x183BD310)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER_REFRESHITEMVIEW_OFFSET UNITYSDK_OFFSET(0x183BD0C0)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER_REFRESHMONSTERCARDVIEW_OFFSET UNITYSDK_OFFSET(0x183BDF70)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER_REFRESHVIDEOINFOVIEW_OFFSET UNITYSDK_OFFSET(0x183BDA40)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x183BE310)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x183BE3F0)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x183BE540)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x183BE5D0)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x183BE660)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x183BE6F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2RoleChallengeInfoWidgetController_TypeDefinitionIndex = 64324;

	class UIAbyssS2RoleChallengeInfoWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_60638234271CCDB8_49* _view; // 0x2C0
		::Class_2_E621E51D351EB960* _abyssModel; // 0x2C8
		::Class_1_A76EAD5D385CC920* _data; // 0x2D0
		::Class_2_0A55B5A82A61DAFA* _questConfig; // 0x2D8
