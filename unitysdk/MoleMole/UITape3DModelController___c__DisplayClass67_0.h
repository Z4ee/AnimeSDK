...
#define MOLEMOLE_UITAPE3DMODELCONTROLLER___C__DISPLAYCLASS67_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1677F550)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER___C__DISPLAYCLASS67_0__PUSHBOOKPERFORMANCE_B__0_OFFSET UNITYSDK_OFFSET(0x1677F560)

namespace MoleMole
{
	inline static constexpr unsigned int UITape3DModelController___c__DisplayClass67_0_TypeDefinitionIndex = 63857;
