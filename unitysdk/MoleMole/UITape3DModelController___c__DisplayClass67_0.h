...
#define MOLEMOLE_UITAPE3DMODELCONTROLLER___C__DISPLAYCLASS67_0__CTOR_OFFSET UNITYSDK_OFFSET(0x12C7C560)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER___C__DISPLAYCLASS67_0__PUSHBOOKPERFORMANCE_B__0_OFFSET UNITYSDK_OFFSET(0x12C7C570)

namespace MoleMole
{
	inline static constexpr unsigned int UITape3DModelController___c__DisplayClass67_0_TypeDefinitionIndex = 68359;
