...
#define MOLEMOLE_UIROLESELECTPAGECONTEXT_ONHANDLEROLESELECT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x130053C0)
#define MOLEMOLE_UIROLESELECTPAGECONTEXT_ONHANDLEROLESELECT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x130053F0)
#define MOLEMOLE_UIROLESELECTPAGECONTEXT_ONHANDLEROLESELECT_INVOKE_OFFSET UNITYSDK_OFFSET(0x13004EA0)
#define MOLEMOLE_UIROLESELECTPAGECONTEXT_ONHANDLEROLESELECT__CTOR_OFFSET UNITYSDK_OFFSET(0x13004E80)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleSelectPageContext_OnHandleRoleSelect_TypeDefinitionIndex = 82569;
