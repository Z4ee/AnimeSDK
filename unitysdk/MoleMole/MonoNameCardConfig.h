...
#define MOLEMOLE_MONONAMECARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x11D53AD0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoNameCardConfig_TypeDefinitionIndex = 78208;
