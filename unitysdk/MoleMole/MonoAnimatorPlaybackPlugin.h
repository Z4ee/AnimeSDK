...
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_AWAKE_OFFSET UNITYSDK_OFFSET(0x15E449A0)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x15E45A50)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x15E44B60)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x15E45950)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_PLAYANDMUTEINTERACT_OFFSET UNITYSDK_OFFSET(0x15E45AB0)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_PLAYBACKWARD_OFFSET UNITYSDK_OFFSET(0x15E45700)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_PLAYFORWARD_OFFSET UNITYSDK_OFFSET(0x15E44E90)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_PLAYSOUND_OFFSET UNITYSDK_OFFSET(0x15E45020)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_SETANIMTOFINISH_OFFSET UNITYSDK_OFFSET(0x15E45890)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_SETDATA_OFFSET UNITYSDK_OFFSET(0x15E44D70)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_STARTFROMTIME_OFFSET UNITYSDK_OFFSET(0x15E44DF0)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x15E45C70)

namespace MoleMole
{
	inline static constexpr unsigned int MonoAnimatorPlaybackPlugin_TypeDefinitionIndex = 52617;
