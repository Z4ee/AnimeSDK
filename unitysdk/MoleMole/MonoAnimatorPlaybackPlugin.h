...
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_AWAKE_OFFSET UNITYSDK_OFFSET(0x19BFF4E0)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x19C005A0)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19BFF6A0)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19C004A0)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_PLAYANDMUTEINTERACT_OFFSET UNITYSDK_OFFSET(0x19C00600)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_PLAYBACKWARD_OFFSET UNITYSDK_OFFSET(0x19C00250)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_PLAYFORWARD_OFFSET UNITYSDK_OFFSET(0x19BFF9D0)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_PLAYSOUND_OFFSET UNITYSDK_OFFSET(0x19BFFB60)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_SETANIMTOFINISH_OFFSET UNITYSDK_OFFSET(0x19C003E0)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_SETDATA_OFFSET UNITYSDK_OFFSET(0x19BFF8B0)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_STARTFROMTIME_OFFSET UNITYSDK_OFFSET(0x19BFF930)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x19C007C0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoAnimatorPlaybackPlugin_TypeDefinitionIndex = 80454;
	...
	public:
		...
		::System::UInt32 Field_5_13; // 0x60
		::System::UInt32 Field_5_12; // 0x64
		::UnityEngine::GameObject* Field_5_19; // 0x68
