...
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x178EAC80)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER___C__DISPLAYCLASS13_0__STARTSHOWGETRAMENCUTSCENE_B__0_OFFSET UNITYSDK_OFFSET(0x178EAC90)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER___C__DISPLAYCLASS13_0__STARTSHOWGETRAMENCUTSCENE_B__1_OFFSET UNITYSDK_OFFSET(0x178EACC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRamenStoreWidgetController___c__DisplayClass13_0_TypeDefinitionIndex = 47810;
