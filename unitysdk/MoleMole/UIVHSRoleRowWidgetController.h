...
#define MOLEMOLE_UIVHSROLEROWWIDGETCONTROLLER_BINDEVENT_BUTTON_OFFSET UNITYSDK_OFFSET(0x16105050)
#define MOLEMOLE_UIVHSROLEROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x161051B0)
#define MOLEMOLE_UIVHSROLEROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x161052A0)
#define MOLEMOLE_UIVHSROLEROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16105310)
#define MOLEMOLE_UIVHSROLEROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16105240)
#define MOLEMOLE_UIVHSROLEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16105000)
#define MOLEMOLE_UIVHSROLEROWWIDGETCONTROLLER_SETSELECTMARK_OFFSET UNITYSDK_OFFSET(0x16105870)
#define MOLEMOLE_UIVHSROLEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x161058E0)
#define MOLEMOLE_UIVHSROLEROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x161058F0)
#define MOLEMOLE_UIVHSROLEROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x16105980)
#define MOLEMOLE_UIVHSROLEROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16105A10)
#define MOLEMOLE_UIVHSROLEROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16105AB0)
#define MOLEMOLE_UIVHSROLEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16105B40)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSRoleRowWidgetController_TypeDefinitionIndex = 44024;

	class UIVHSRoleRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_43* _view; // 0x2F0
