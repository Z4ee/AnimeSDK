...
#define MOLEMOLE_UIFRIENDSYSTEMWIDGETCONTROLLER_ADD_ONUPDATEADDFRIENDTABTRIGGER_OFFSET UNITYSDK_OFFSET(0x186BC7F0)
#define MOLEMOLE_UIFRIENDSYSTEMWIDGETCONTROLLER_BINDEVENT_OFFSET UNITYSDK_OFFSET(0x186BB6E0)
#define MOLEMOLE_UIFRIENDSYSTEMWIDGETCONTROLLER_CLEARADDFRIENDTABNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x186BC450)
#define MOLEMOLE_UIFRIENDSYSTEMWIDGETCONTROLLER_FOCUSINNERWIDGETGAMEPADMODULE_OFFSET UNITYSDK_OFFSET(0x186BC870)
#define MOLEMOLE_UIFRIENDSYSTEMWIDGETCONTROLLER_GETDISPLAYTAB_OFFSET UNITYSDK_OFFSET(0x186BCB50)
#define MOLEMOLE_UIFRIENDSYSTEMWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x186BBD00)
#define MOLEMOLE_UIFRIENDSYSTEMWIDGETCONTROLLER_ONCLICKACCEPTALL_OFFSET UNITYSDK_OFFSET(0x186BD110)
#define MOLEMOLE_UIFRIENDSYSTEMWIDGETCONTROLLER_ONCLICKREJECTALL_OFFSET UNITYSDK_OFFSET(0x186BD1D0)
#define MOLEMOLE_UIFRIENDSYSTEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x186BC260)
#define MOLEMOLE_UIFRIENDSYSTEMWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x186BC560)
#define MOLEMOLE_UIFRIENDSYSTEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x186BC2F0)
#define MOLEMOLE_UIFRIENDSYSTEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x186BB570)
#define MOLEMOLE_UIFRIENDSYSTEMWIDGETCONTROLLER_RECORDUPDATEOFADDFRIENDNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x186BC630)
#define MOLEMOLE_UIFRIENDSYSTEMWIDGETCONTROLLER_REFRESHTOPTABNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x186BC4E0)
#define MOLEMOLE_UIFRIENDSYSTEMWIDGETCONTROLLER_REMOVE_ONUPDATEADDFRIENDTABTRIGGER_OFFSET UNITYSDK_OFFSET(0x186BC770)
#define MOLEMOLE_UIFRIENDSYSTEMWIDGETCONTROLLER_SELECTTAB_OFFSET UNITYSDK_OFFSET(0x186BCBA0)
#define MOLEMOLE_UIFRIENDSYSTEMWIDGETCONTROLLER_SHOWRECOMMENDMOREBTN_OFFSET UNITYSDK_OFFSET(0x186BD4C0)
#define MOLEMOLE_UIFRIENDSYSTEMWIDGETCONTROLLER_UPDATEREQUESTUIELEMENT_OFFSET UNITYSDK_OFFSET(0x186BD290)
#define MOLEMOLE_UIFRIENDSYSTEMWIDGETCONTROLLER__BINDEVENT_B__10_2_OFFSET UNITYSDK_OFFSET(0x186BD790)
#define MOLEMOLE_UIFRIENDSYSTEMWIDGETCONTROLLER__BINDEVENT_B__10_3_OFFSET UNITYSDK_OFFSET(0x186BD7B0)
#define MOLEMOLE_UIFRIENDSYSTEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x186BD6B0)
#define MOLEMOLE_UIFRIENDSYSTEMWIDGETCONTROLLER__ONCLICKACCEPTALL_B__15_0_OFFSET UNITYSDK_OFFSET(0x186BD800)
#define MOLEMOLE_UIFRIENDSYSTEMWIDGETCONTROLLER__ONCLICKREJECTALL_B__16_0_OFFSET UNITYSDK_OFFSET(0x186BD870)
#define MOLEMOLE_UIFRIENDSYSTEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x186BD8E0)
#define MOLEMOLE_UIFRIENDSYSTEMWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x186BD970)
#define MOLEMOLE_UIFRIENDSYSTEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x186BDA10)
#define MOLEMOLE_UIFRIENDSYSTEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x186BDAA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendSystemWidgetController_TypeDefinitionIndex = 45914;
