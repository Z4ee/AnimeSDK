...
#define MOLEMOLE_UIAVATARSHOWTYPE_GETAVATARSHOWUITYPE_OFFSET UNITYSDK_OFFSET(0x12B55DD0)
#define MOLEMOLE_UIAVATARSHOWTYPE_GET_UITYPE_OFFSET UNITYSDK_OFFSET(0x12B55C20)
#define MOLEMOLE_UIAVATARSHOWTYPE_ONUITYPEVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x12B56090)
#define MOLEMOLE_UIAVATARSHOWTYPE_SET_UITYPE_OFFSET UNITYSDK_OFFSET(0x12B55D60)
#define MOLEMOLE_UIAVATARSHOWTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x12B56100)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarShowType_TypeDefinitionIndex = 40001;
