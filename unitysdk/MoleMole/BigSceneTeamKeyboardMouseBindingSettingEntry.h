...
#define MOLEMOLE_BIGSCENETEAMKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x106ACE40)
#define MOLEMOLE_BIGSCENETEAMKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x106ACE50)
#define MOLEMOLE_BIGSCENETEAMKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x106ACE60)

namespace MoleMole
{
	inline static constexpr unsigned int BigSceneTeamKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 83123;
