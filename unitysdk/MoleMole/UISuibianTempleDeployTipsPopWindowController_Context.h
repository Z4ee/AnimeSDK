...
#define MOLEMOLE_UISUIBIANTEMPLEDEPLOYTIPSPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x156B9BE0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleDeployTipsPopWindowController_Context_TypeDefinitionIndex = 62431;
	...
	public:
		...
		::System::Int32 PrvLevel; // 0x30
		::System::Int32 CurLevel; // 0x34
