...
#define MOLEMOLE_DISPLAYCASE_DISPLAYBASETRANSFORMDATA_EQUALS_OFFSET UNITYSDK_OFFSET(0x7BF5A0)
#define MOLEMOLE_DISPLAYCASE_DISPLAYBASETRANSFORMDATA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7BF6A0)
#define MOLEMOLE_DISPLAYCASE_DISPLAYBASETRANSFORMDATA_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x16ABAA70)
#define MOLEMOLE_DISPLAYCASE_DISPLAYBASETRANSFORMDATA_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x16ABABD0)
#define MOLEMOLE_DISPLAYCASE_DISPLAYBASETRANSFORMDATA___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x7BF6B0)
#define MOLEMOLE_DISPLAYCASE_DISPLAYBASETRANSFORMDATA___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7BF720)

namespace MoleMole::DisplayCase
{
	inline static constexpr unsigned int DisplayBaseTransformData_TypeDefinitionIndex = 47683;
