...
#define MOLEMOLE_EMPTYVIDEOPLAYER_CALLBACK_ONPREPARECOMPLETED_OFFSET UNITYSDK_OFFSET(0x158049C0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_CALLBACK_ONSEEKCOMPLETED_OFFSET UNITYSDK_OFFSET(0x15804A80)
#define MOLEMOLE_EMPTYVIDEOPLAYER_CALLBACK_PLAYFINISH_OFFSET UNITYSDK_OFFSET(0x15804A30)
#define MOLEMOLE_EMPTYVIDEOPLAYER_CALLBACK_PLAYSTART_OFFSET UNITYSDK_OFFSET(0x15804CD0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_CHECKINITMOVIECONTROLLER_OFFSET UNITYSDK_OFFSET(0x15803760)
#define MOLEMOLE_EMPTYVIDEOPLAYER_CHECKLOGVIDEOVALID_OFFSET UNITYSDK_OFFSET(0x158057F0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_CLIPCHANGED_OFFSET UNITYSDK_OFFSET(0x15805B50)
#define MOLEMOLE_EMPTYVIDEOPLAYER_DESTROYMOVIE_OFFSET UNITYSDK_OFFSET(0x15803DD0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GETTARGETRENDER_OFFSET UNITYSDK_OFFSET(0x15806520)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_CLIPDATA_OFFSET UNITYSDK_OFFSET(0x15803690)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0x15803540)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x15805760)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_ENABLEUPDATELOG_OFFSET UNITYSDK_OFFSET(0x15803520)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_FRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x158050E0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_FRAMERATE_OFFSET UNITYSDK_OFFSET(0x15805100)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_FRAME_OFFSET UNITYSDK_OFFSET(0x158050C0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x15805170)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_ISCANRENDER_OFFSET UNITYSDK_OFFSET(0x15804E40)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_ISLOOPING_OFFSET UNITYSDK_OFFSET(0x15805010)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0x15804A10)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0x15804E20)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_ISPREPARED_OFFSET UNITYSDK_OFFSET(0x15804EA0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x15805070)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_PLAYBACKSPEED_OFFSET UNITYSDK_OFFSET(0x15803D40)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_PLAYONAWAKE_OFFSET UNITYSDK_OFFSET(0x15805030)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_RENDERMODE_OFFSET UNITYSDK_OFFSET(0x158051F0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_SIMULATE_OFFSET UNITYSDK_OFFSET(0x158036B0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_TARGETMATERIALPROPERTY_OFFSET UNITYSDK_OFFSET(0x15805230)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_TARGETMATERIALRENDERER_OFFSET UNITYSDK_OFFSET(0x158051D0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_TARGETTEXTURE_OFFSET UNITYSDK_OFFSET(0x15805210)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_TEXTURE_OFFSET UNITYSDK_OFFSET(0x158051C0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_TIME_OFFSET UNITYSDK_OFFSET(0x158050A0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_URL_OFFSET UNITYSDK_OFFSET(0x15805000)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_WAITFORFIRSTFRAME_OFFSET UNITYSDK_OFFSET(0x15805050)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0x15805120)
#define MOLEMOLE_EMPTYVIDEOPLAYER_INTERNALCALLPLAYEND_OFFSET UNITYSDK_OFFSET(0x15804120)
#define MOLEMOLE_EMPTYVIDEOPLAYER_INTERNALCALLPREPARED_OFFSET UNITYSDK_OFFSET(0x158041F0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_INTERNALCALLSTOP_OFFSET UNITYSDK_OFFSET(0x15804010)
#define MOLEMOLE_EMPTYVIDEOPLAYER_INTERNALPLAY_OFFSET UNITYSDK_OFFSET(0x15804D20)
#define MOLEMOLE_EMPTYVIDEOPLAYER_ISERROR_OFFSET UNITYSDK_OFFSET(0x15805CB0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_ISINITMOVIE_OFFSET UNITYSDK_OFFSET(0x15803840)
#define MOLEMOLE_EMPTYVIDEOPLAYER_ISREADY_OFFSET UNITYSDK_OFFSET(0x15805C30)
#define MOLEMOLE_EMPTYVIDEOPLAYER_ISVIDEOSOURCEVALID_OFFSET UNITYSDK_OFFSET(0x158067B0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x15805CF0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_LOGERROR_OFFSET UNITYSDK_OFFSET(0x158035F0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_LOGUPDATE_OFFSET UNITYSDK_OFFSET(0x15803550)
#define MOLEMOLE_EMPTYVIDEOPLAYER_LOG_OFFSET UNITYSDK_OFFSET(0x158035A0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x158062B0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_ONLOOPPOINTREACHED_OFFSET UNITYSDK_OFFSET(0x158041A0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_ONSTATUSPLAYEND_OFFSET UNITYSDK_OFFSET(0x158040D0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_ONSTATUSSTOP_OFFSET UNITYSDK_OFFSET(0x15803FC0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_PAUSE_1_OFFSET UNITYSDK_OFFSET(0x15804F60)
#define MOLEMOLE_EMPTYVIDEOPLAYER_PAUSE_OFFSET UNITYSDK_OFFSET(0x15804F00)
#define MOLEMOLE_EMPTYVIDEOPLAYER_PLAY_OFFSET UNITYSDK_OFFSET(0x15804BA0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_PREPARE_OFFSET UNITYSDK_OFFSET(0x15804AD0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_PRINTONSCREEN_OFFSET UNITYSDK_OFFSET(0x15803640)
#define MOLEMOLE_EMPTYVIDEOPLAYER_RELEASETEXTURE_OFFSET UNITYSDK_OFFSET(0x158063A0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SEEKFRAME_OFFSET UNITYSDK_OFFSET(0x15805780)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SEEKTIME_OFFSET UNITYSDK_OFFSET(0x15805940)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SETAUDIOMODENONE_OFFSET UNITYSDK_OFFSET(0x15803880)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SETCALLBACK_OFFSET UNITYSDK_OFFSET(0x15803AF0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SETDEFAULTPARAM_OFFSET UNITYSDK_OFFSET(0x158039A0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SETFILEINTERNAL_OFFSET UNITYSDK_OFFSET(0x158038C0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SETRENDERPROPERTY_OFFSET UNITYSDK_OFFSET(0x15805240)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SETRENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0x15804270)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SETURL_OFFSET UNITYSDK_OFFSET(0x15805AD0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SETVIDEOCLIP_OFFSET UNITYSDK_OFFSET(0x158059C0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SET_CLIPDATA_OFFSET UNITYSDK_OFFSET(0x158036A0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x15805770)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SET_ENABLEUPDATELOG_OFFSET UNITYSDK_OFFSET(0x15803530)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SET_ISLOOPING_OFFSET UNITYSDK_OFFSET(0x15803CE0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SET_PLAYBACKSPEED_OFFSET UNITYSDK_OFFSET(0x15803D60)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SET_PLAYONAWAKE_OFFSET UNITYSDK_OFFSET(0x15805040)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SET_RENDERMODE_OFFSET UNITYSDK_OFFSET(0x15805200)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SET_SIMULATE_OFFSET UNITYSDK_OFFSET(0x158036C0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SET_TARGETMATERIALPROPERTY_OFFSET UNITYSDK_OFFSET(0x15803C90)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SET_TARGETMATERIALRENDERER_OFFSET UNITYSDK_OFFSET(0x158051E0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SET_TARGETTEXTURE_OFFSET UNITYSDK_OFFSET(0x15805220)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SET_WAITFORFIRSTFRAME_OFFSET UNITYSDK_OFFSET(0x15805060)
#define MOLEMOLE_EMPTYVIDEOPLAYER_STATUSCHANGEEVENTFUNC_OFFSET UNITYSDK_OFFSET(0x15806810)
#define MOLEMOLE_EMPTYVIDEOPLAYER_STEPFORWARD_OFFSET UNITYSDK_OFFSET(0x15805A90)
#define MOLEMOLE_EMPTYVIDEOPLAYER_STOP_OFFSET UNITYSDK_OFFSET(0x158061C0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_UNSETCALLBACK_OFFSET UNITYSDK_OFFSET(0x15803E20)
#define MOLEMOLE_EMPTYVIDEOPLAYER__CCTOR_OFFSET UNITYSDK_OFFSET(0x158068D0)
#define MOLEMOLE_EMPTYVIDEOPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x158036D0)
#define MOLEMOLE_EMPTYVIDEOPLAYER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x158068E0)

namespace MoleMole
{
	inline static constexpr unsigned int EmptyVideoPlayer_TypeDefinitionIndex = 74075;
	...
	public:
		...
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(EmptyVideoPlayer_TypeDefinitionIndex)->GetStaticField(0xEC50);
		}
		::UnityEngine::RenderTexture* _targetTexture; // 0x48
		::Class_1_21DCD4640D389503_1* _Simulate_k__BackingField; // 0x50
		::UnityEngine::RenderTexture* _texture; // 0x58
		::System::String* m_movieFile; // 0x60
		::System::String* m_url; // 0x68
		::System::String* _targetMaterialProperty; // 0x70
		::UnityEngine::Renderer* _targetMaterialRenderer; // 0x78
		::System::Boolean isSeeking; // 0x80
		::System::Boolean _playOnAwake; // 0x81
		::System::Boolean isInitCallback; // 0x82
		::System::Boolean _enabled; // 0x83
		::System::Boolean isStopAndCallPlay; // 0x84
		::System::Boolean m_isFileExist; // 0x85
		::System::Boolean m_CanStartRendering; // 0x86
		::System::Int64 currentFrameNo; // 0x88
		::System::Boolean isStopAndCallPrepare; // 0x90
		::System::Boolean _waitForFirstFrame_k__BackingField; // 0x91
		::System::Boolean m_PlayPending; // 0x92
		::System::Boolean _isLoop; // 0x93
		::UnityEngine::Video::VideoRenderMode _renderMode_k__BackingField; // 0x94
		::System::Single _playbackSpeed; // 0x98
		::System::Int32 seekFrame; // 0x9C
		::System::Boolean isCallStop; // 0xA0
		::System::Boolean m_CanStartPlaying; // 0xA1
		::System::Boolean _isCallPause; // 0xA2
		::System::Boolean m_PrepareInProgress; // 0xA3
		::Struct_2_071C692C54C58954 _ClipData_k__BackingField; // 0xA4
