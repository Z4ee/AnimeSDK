...
#define MOLEMOLE_UIRESOURCELOADWIDGETCONTROLLER___C__DISPLAYCLASS42_1__CTOR_OFFSET UNITYSDK_OFFSET(0x15792840)
#define MOLEMOLE_UIRESOURCELOADWIDGETCONTROLLER___C__DISPLAYCLASS42_1__STARTLOADGAMECONFIGASSETSBYLOADER_B__1_OFFSET UNITYSDK_OFFSET(0x15792850)

namespace MoleMole
{
	inline static constexpr unsigned int UIResourceLoadWidgetController___c__DisplayClass42_1_TypeDefinitionIndex = 59150;
