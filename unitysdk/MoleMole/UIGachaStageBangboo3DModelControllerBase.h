...
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLERBASE_GETCHARACTERLIGHTSTLPATH_OFFSET UNITYSDK_OFFSET(0x166E7C10)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLERBASE_GETLIGHTIDS_OFFSET UNITYSDK_OFFSET(0x166E7BB0)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLERBASE_GET_BLUEPRINT_NAME_OFFSET UNITYSDK_OFFSET(0x166E7D50)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLERBASE_GET_RARITY_TV_INDEX_OFFSET UNITYSDK_OFFSET(0x166E7D40)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLERBASE_GET_TOTAL_TV_NUM_OFFSET UNITYSDK_OFFSET(0x166E7D30)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLERBASE_HANDLEONOPEN_OFFSET UNITYSDK_OFFSET(0x166E66F0)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLERBASE_HANDLEUPDATE_OFFSET UNITYSDK_OFFSET(0x166E67D0)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLERBASE_INITLIGHTS_OFFSET UNITYSDK_OFFSET(0x166E7970)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLERBASE_ISVIDEOTVINDEX_OFFSET UNITYSDK_OFFSET(0x166E7920)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLERBASE_ONCAMERASHAKE_OFFSET UNITYSDK_OFFSET(0x166E7C70)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLERBASE_ONREFRESHSTAGE_OFFSET UNITYSDK_OFFSET(0x166E6A20)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLERBASE_PRELOADSTAGEBEFOREPLAY_OFFSET UNITYSDK_OFFSET(0x166E6830)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x166E7D90)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLERBASE___BASE_HANDLEONOPEN_OFFSET UNITYSDK_OFFSET(0x166E7E00)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLERBASE___BASE_HANDLEUPDATE_OFFSET UNITYSDK_OFFSET(0x166E7E10)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLERBASE___BASE_ISVIDEOTVINDEX_OFFSET UNITYSDK_OFFSET(0x166E7EA0)
#define MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLERBASE___BASE_ONCAMERASHAKE_OFFSET UNITYSDK_OFFSET(0x166E7F30)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaStageBangboo3DModelControllerBase_TypeDefinitionIndex = 77271;
	...
	public:
		...
		::Class_2_208CC9941471731A_630* _bangbooPerformTemplate; // 0x6E8
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_385*, ::System::Action*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGACHASTAGEBANGBOO3DMODELCONTROLLERBASE_PRELOADSTAGEBEFOREPLAY_OFFSET))(this, template_, preloadComplete);
		}
