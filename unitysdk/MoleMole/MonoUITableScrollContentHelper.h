...
#define MOLEMOLE_MONOUITABLESCROLLCONTENTHELPER_METHOD_5_EC86C2D7EFDB13CE_OFFSET UNITYSDK_OFFSET(0x1177EB30)
#define MOLEMOLE_MONOUITABLESCROLLCONTENTHELPER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1177EAA0)
#define MOLEMOLE_MONOUITABLESCROLLCONTENTHELPER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1177EAE0)
#define MOLEMOLE_MONOUITABLESCROLLCONTENTHELPER_REFRESHDRIVENRECTTRANSFORMTRACKER_OFFSET UNITYSDK_OFFSET(0x1177ECC0)
#define MOLEMOLE_MONOUITABLESCROLLCONTENTHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1177ED10)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUITableScrollContentHelper_TypeDefinitionIndex = 70811;
