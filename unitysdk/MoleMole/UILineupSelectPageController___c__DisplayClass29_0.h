...
#define MOLEMOLE_UILINEUPSELECTPAGECONTROLLER___C__DISPLAYCLASS29_0__CTOR_OFFSET UNITYSDK_OFFSET(0x150EABB0)
#define MOLEMOLE_UILINEUPSELECTPAGECONTROLLER___C__DISPLAYCLASS29_0__KICKPLAYER_B__0_OFFSET UNITYSDK_OFFSET(0x150EABC0)

namespace MoleMole
{
	inline static constexpr unsigned int UILineupSelectPageController___c__DisplayClass29_0_TypeDefinitionIndex = 56011;

	class UILineupSelectPageController___c__DisplayClass29_0 : public ::System::Object
	{
	public:
		::Struct_2_B6BE0E422E1288EE playerData; // 0x10
