...
#define MOLEMOLE_CONFIGHOLLOWCHESSBOARDCAMERADRAGSPEEDITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B56AF10)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigHollowChessboardCameraDragSpeedItem_TypeDefinitionIndex = 80751;
	...
	public:
		...
		::System::Single MouseDragSpeedRatio; // 0x24
