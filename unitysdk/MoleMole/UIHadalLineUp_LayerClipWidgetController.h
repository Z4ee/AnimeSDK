...
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER_GETCLIPDATA_OFFSET UNITYSDK_OFFSET(0x16700DD0)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER_GET_ISSELECTED_OFFSET UNITYSDK_OFFSET(0x16700A30)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER_MARKSELECTED_OFFSET UNITYSDK_OFFSET(0x16700E20)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER_MARKUNSELECTED_OFFSET UNITYSDK_OFFSET(0x16700EA0)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16700C00)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0x167013F0)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16700F60)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16700C90)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16700A40)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16700AA0)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER_SETCLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x16701440)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16701490)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER__ONUIOPEN_B__6_0_OFFSET UNITYSDK_OFFSET(0x167014A0)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER__SETEMPTY_OFFSET UNITYSDK_OFFSET(0x16700F20)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16701500)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER___BASE_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0x16701590)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16701620)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x167016C0)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16701750)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x167017E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalLineUp_LayerClipWidgetController_TypeDefinitionIndex = 62605;
	...
	public:
		...
		::Class_1_5DA2E7556103D5A3_399* _curData; // 0x300
		...
		::Class_1_5DA2E7556103D5A3_399* GetClipData()
		{
			return ((::Class_1_5DA2E7556103D5A3_399*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER_GETCLIPDATA_OFFSET))(this);
		}
