...
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER_GETCLIPDATA_OFFSET UNITYSDK_OFFSET(0x1581AE60)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER_GET_ISSELECTED_OFFSET UNITYSDK_OFFSET(0x1581AAC0)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER_MARKSELECTED_OFFSET UNITYSDK_OFFSET(0x1581AEB0)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER_MARKUNSELECTED_OFFSET UNITYSDK_OFFSET(0x1581AF30)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1581AC90)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0x1581B490)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1581AFF0)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1581AD20)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1581AAD0)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1581AB30)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER_SETCLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x1581B4E0)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1581B530)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER__ONUIOPEN_B__6_0_OFFSET UNITYSDK_OFFSET(0x1581B540)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER__SETEMPTY_OFFSET UNITYSDK_OFFSET(0x1581AFB0)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1581B5A0)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER___BASE_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0x1581B630)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1581B6C0)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1581B760)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1581B7F0)
#define MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1581B880)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalLineUp_LayerClipWidgetController_TypeDefinitionIndex = 71585;

	class UIHadalLineUp_LayerClipWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_12758EFCB74270F1_1* _view; // 0x2E8
		::System::Boolean _isLocked; // 0x2F0
		::System::Boolean _isSelected; // 0x2F1
		::Class_1_5DA2E7556103D5A3_336* _curData; // 0x2F8
		::System::Action_1<::MoleMole::UIHadalLineUp_LayerClipWidgetController*>* _clickCallback; // 0x300
		...
		::Class_1_5DA2E7556103D5A3_336* GetClipData()
		{
			return ((::Class_1_5DA2E7556103D5A3_336*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALLINEUP_LAYERCLIPWIDGETCONTROLLER_GETCLIPDATA_OFFSET))(this);
		}
