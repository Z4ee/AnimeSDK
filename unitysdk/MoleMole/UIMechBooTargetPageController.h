...
#define MOLEMOLE_UIMECHBOOTARGETPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x174DD210)
#define MOLEMOLE_UIMECHBOOTARGETPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x174DD710)
#define MOLEMOLE_UIMECHBOOTARGETPAGECONTROLLER_ONCLICKOKBTN_OFFSET UNITYSDK_OFFSET(0x174DEF30)
#define MOLEMOLE_UIMECHBOOTARGETPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x174DD220)
#define MOLEMOLE_UIMECHBOOTARGETPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x174DED70)
#define MOLEMOLE_UIMECHBOOTARGETPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x174DED00)
#define MOLEMOLE_UIMECHBOOTARGETPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x174DD360)
#define MOLEMOLE_UIMECHBOOTARGETPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x174DD620)
#define MOLEMOLE_UIMECHBOOTARGETPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x174DF030)
#define MOLEMOLE_UIMECHBOOTARGETPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x174DF040)
#define MOLEMOLE_UIMECHBOOTARGETPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x174DF0D0)
#define MOLEMOLE_UIMECHBOOTARGETPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x174DF100)
#define MOLEMOLE_UIMECHBOOTARGETPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x174DF110)
#define MOLEMOLE_UIMECHBOOTARGETPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x174DF120)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechBooTargetPageController_TypeDefinitionIndex = 59476;

	class UIMechBooTargetPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79AE422BA06F6D26_35* _view; // 0x318
