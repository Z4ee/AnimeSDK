...
#define MOLEMOLE_UISETTINGRESOURCEDOWNLOADDIALOGPOPWINDOWCONTROLLER__CALCULATESIZE_ASYNC_D__10_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x79BF70)
#define MOLEMOLE_UISETTINGRESOURCEDOWNLOADDIALOGPOPWINDOWCONTROLLER__CALCULATESIZE_ASYNC_D__10_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2661E0)

namespace MoleMole
{
	inline static constexpr unsigned int UISettingResourceDownloadDialogPopWindowController__CalculateSize_Async_d__10_TypeDefinitionIndex = 72682;
	...
	struct alignas(8) UISettingResourceDownloadDialogPopWindowController__CalculateSize_Async_d__10
	{
		...
		::Class_2_08FFAF9759A4ED46_1* picker; // 0x28
		::System::Exception* _ex_5__7; // 0x30
		::System::Collections::Generic::IEnumerable_1<::Enum_3_34F7035555410463_1>* _fullPackages_5__4; // 0x38
		::System::Action_2<::System::Int64, ::System::Int64>* finishCallback; // 0x40
		...
		::System::Int64 _totalSize_5__5; // 0x60
