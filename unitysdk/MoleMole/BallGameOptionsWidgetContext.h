...
#define MOLEMOLE_BALLGAMEOPTIONSWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1F3E84A0)

namespace MoleMole
{
	inline static constexpr unsigned int BallGameOptionsWidgetContext_TypeDefinitionIndex = 93383;
	...
	public:
		...
		::Class_3_6F28FFD006F2B451* world; // 0x40
		::System::Int32 EventID; // 0x48
		::System::Int32 EventType; // 0x4C
