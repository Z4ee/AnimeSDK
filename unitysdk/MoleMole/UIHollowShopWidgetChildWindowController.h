...
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_BUYHOLLOWITEM_OFFSET UNITYSDK_OFFSET(0x16ADF430)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_BUYPCFUNC_OFFSET UNITYSDK_OFFSET(0x16AD0D20)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_CANBUY_OFFSET UNITYSDK_OFFSET(0x16ADEDC0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_CLEAREFFECT_OFFSET UNITYSDK_OFFSET(0x16ADB890)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_CLOSEPANEL_OFFSET UNITYSDK_OFFSET(0x16AD07B0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_DIRECTCLOSEPANEL_OFFSET UNITYSDK_OFFSET(0x16AD0500)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_FORCEREBUILD_OFFSET UNITYSDK_OFFSET(0x16AD3C30)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GETANIMLENGTH_OFFSET UNITYSDK_OFFSET(0x16AD0E80)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GETCURRENCYCOUNT_OFFSET UNITYSDK_OFFSET(0x16AD5450)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GETCURRENCYTYPE_OFFSET UNITYSDK_OFFSET(0x16AD5EA0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GETCURRENTSHOPITEMS_OFFSET UNITYSDK_OFFSET(0x16AD5270)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GETDICBYCURRENTPOSITION_OFFSET UNITYSDK_OFFSET(0x16ADB300)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GETGOODSVALUE_OFFSET UNITYSDK_OFFSET(0x16AD4F70)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GETITEMBYSHOPTYPE_OFFSET UNITYSDK_OFFSET(0x16AD4D50)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x16AD4160)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GETSHOPICON_OFFSET UNITYSDK_OFFSET(0x16AD5040)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GETSHOPTYPEBYCURRENTPOSITION_OFFSET UNITYSDK_OFFSET(0x16AD5E10)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GETSHOPTYPEBYPOSITION_OFFSET UNITYSDK_OFFSET(0x16ADB2B0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x16ACD640)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GET__POSITION_OFFSET UNITYSDK_OFFSET(0x16AE0080)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GOBACKTOMAIN_OFFSET UNITYSDK_OFFSET(0x16AD41B0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GOTOCARDSHOP_OFFSET UNITYSDK_OFFSET(0x16ADB760)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GOTOCURSESHOP_OFFSET UNITYSDK_OFFSET(0x16ADB500)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GOTODISCOUNTSHOP_OFFSET UNITYSDK_OFFSET(0x16ADB180)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GOTOGACHASHOP_OFFSET UNITYSDK_OFFSET(0x16AD9D50)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GOTOHOLLOWITEMSHOP_OFFSET UNITYSDK_OFFSET(0x16ADB630)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GOTOITEMSHOP_OFFSET UNITYSDK_OFFSET(0x16AD0050)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GOTOUPGRADESHOP_OFFSET UNITYSDK_OFFSET(0x16ACFF20)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_INITDETIAL_OFFSET UNITYSDK_OFFSET(0x16ACFC10)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_INITSHOP_OFFSET UNITYSDK_OFFSET(0x16AD1740)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_INITTRANSFERCONFIG_OFFSET UNITYSDK_OFFSET(0x16ACDA50)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_INITUPGRADECARD_OFFSET UNITYSDK_OFFSET(0x16ACDE00)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x16ACEF10)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x16ACEAC0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_ISHPCURRENCY_OFFSET UNITYSDK_OFFSET(0x16AD1610)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_ISITEMSOLDOUT_OFFSET UNITYSDK_OFFSET(0x16ADB400)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16AD0180)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_ONEVENTCLICK_OFFSET UNITYSDK_OFFSET(0x16AD0C50)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x16AD1100)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_ONTEXTSHOWFINISH_OFFSET UNITYSDK_OFFSET(0x16AD10B0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16AD0210)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16ACD650)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16ACE3F0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_OPENINI_OFFSET UNITYSDK_OFFSET(0x16ADF090)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_REALGOTOSHOP_OFFSET UNITYSDK_OFFSET(0x16AD9E80)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_REFRESHALL_OFFSET UNITYSDK_OFFSET(0x16ADEEA0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_REFRESHCONTEXT_OFFSET UNITYSDK_OFFSET(0x16ADEE20)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_REFRESHGOODS_OFFSET UNITYSDK_OFFSET(0x16ADBC60)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_REFRESHSHOPTITLE_OFFSET UNITYSDK_OFFSET(0x16AD2970)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_RESETARCANAANIM_OFFSET UNITYSDK_OFFSET(0x16AD7C60)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_RESETBUYANIM_OFFSET UNITYSDK_OFFSET(0x16AD47C0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_RESTSHOPBTNANIM_OFFSET UNITYSDK_OFFSET(0x16AD4BC0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_SETARCANAANIM_OFFSET UNITYSDK_OFFSET(0x16AD8100)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_SETDISCOUNT_OFFSET UNITYSDK_OFFSET(0x16AD5F10)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_SETITEMSOLDOUTSTATE_OFFSET UNITYSDK_OFFSET(0x16AD8EE0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_SETMAINSELECTSTATE_OFFSET UNITYSDK_OFFSET(0x16ACFDD0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_SETPRICECOLOR_OFFSET UNITYSDK_OFFSET(0x16AD6520)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_SETPRICETXT_OFFSET UNITYSDK_OFFSET(0x16AD65A0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_SETVERTICALLAYOUTSTATE_OFFSET UNITYSDK_OFFSET(0x16AD3DD0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_SET__POSITION_OFFSET UNITYSDK_OFFSET(0x16AE0090)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_SHOWTEXT_OFFSET UNITYSDK_OFFSET(0x16AD09B0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_UPDATEALLPAYPANEL_OFFSET UNITYSDK_OFFSET(0x16AD8760)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_UPDATEPRICE_OFFSET UNITYSDK_OFFSET(0x16ADFF00)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER__BUY_OFFSET UNITYSDK_OFFSET(0x16ADF700)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER__CLOSEPANEL_B__11_0_OFFSET UNITYSDK_OFFSET(0x16AE03D0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16AE00A0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER__GOBACKTOMAIN_B__23_0_OFFSET UNITYSDK_OFFSET(0x16AE0510)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER__GOBACKTOMAIN_B__23_1_OFFSET UNITYSDK_OFFSET(0x16AE0560)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER__INIT_B__21_0_OFFSET UNITYSDK_OFFSET(0x16AE0500)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER__INTERNALCLOSE_OFFSET UNITYSDK_OFFSET(0x16AD0720)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER__ISPLACEHOLDER_OFFSET UNITYSDK_OFFSET(0x16AD7BD0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER__ONARCANAANIM_OFFSET UNITYSDK_OFFSET(0x16AD86C0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER__ONUIOPEN_B__6_0_OFFSET UNITYSDK_OFFSET(0x16AE0330)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER__WAITBEFOREANIMEXIT_OFFSET UNITYSDK_OFFSET(0x16AD4B00)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER__WAITHIDEDETIAL_OFFSET UNITYSDK_OFFSET(0x16AD0E00)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16AE0570)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x16AE0600)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16AE0630)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16AE0640)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16AE0650)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowShopWidgetChildWindowController_TypeDefinitionIndex = 66342;
	...
	public:
		...
		::Class_1_7807B2B04302CD7B_28* translateRatio; // 0x318
		...
		::Class_2_1B1C05BC0A38A2D5_6* _view; // 0x330
