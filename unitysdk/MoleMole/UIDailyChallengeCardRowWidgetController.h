...
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_BINDEVENT_OFFSET UNITYSDK_OFFSET(0x15E77720)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_ENABLEIMGOFFSET_OFFSET UNITYSDK_OFFSET(0x15E77E80)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_FORCEINITLOOPTEXT_OFFSET UNITYSDK_OFFSET(0x15E778E0)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_GETLOOPTEXTRUNINGTIME_OFFSET UNITYSDK_OFFSET(0x15E77ED0)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15E775C0)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_GET__VIEW_OFFSET UNITYSDK_OFFSET(0x15E77630)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_ONBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x15E7A3E0)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15E77AC0)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15E776A0)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0x15E7A570)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x15E78130)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SAMPLEANIMATION_OFFSET UNITYSDK_OFFSET(0x15E7A630)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SETALWAYSINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x15E780D0)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SETBUTTONENABLE_OFFSET UNITYSDK_OFFSET(0x15E79DA0)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SETCONSOLEKEY_OFFSET UNITYSDK_OFFSET(0x15E77D90)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SETDATA_1_OFFSET UNITYSDK_OFFSET(0x15E79C00)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SETDATA_OFFSET UNITYSDK_OFFSET(0x15E79A70)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SETDOUBLETIP_OFFSET UNITYSDK_OFFSET(0x15E7A100)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SETEMPTYLOCK_OFFSET UNITYSDK_OFFSET(0x15E78030)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SETENABLEADD_OFFSET UNITYSDK_OFFSET(0x15E77FE0)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SETENABLECOOLDOWN_OFFSET UNITYSDK_OFFSET(0x15E77B50)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SETIGNORESHOWSPOILED_OFFSET UNITYSDK_OFFSET(0x15E78080)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SETOVERRIDELOCKSTATE_OFFSET UNITYSDK_OFFSET(0x15E79E00)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SETREWARDBUFFICON_OFFSET UNITYSDK_OFFSET(0x15E79E50)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SETUPICON_OFFSET UNITYSDK_OFFSET(0x15E79FE0)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SYNCANIMATION_OFFSET UNITYSDK_OFFSET(0x15E77BA0)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15E7A6C0)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15E7A720)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15E7A7C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIDailyChallengeCardRowWidgetController_TypeDefinitionIndex = 77753;
