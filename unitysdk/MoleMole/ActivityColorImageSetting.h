...
#define MOLEMOLE_ACTIVITYCOLORIMAGESETTING__CTOR_OFFSET UNITYSDK_OFFSET(0xF95A9D0)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityColorImageSetting_TypeDefinitionIndex = 41107;
