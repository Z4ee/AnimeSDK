...
#define MOLEMOLE_CONFIGUII18NIMAGEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x181F0CC0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUII18NImageItem_TypeDefinitionIndex = 58732;
