...
#define MOLEMOLE_UISOCIALCIRCLEMAINTAGWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15A2CED0)
#define MOLEMOLE_UISOCIALCIRCLEMAINTAGWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15A2CFA0)
#define MOLEMOLE_UISOCIALCIRCLEMAINTAGWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15A2D060)
#define MOLEMOLE_UISOCIALCIRCLEMAINTAGWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15A2D2A0)
#define MOLEMOLE_UISOCIALCIRCLEMAINTAGWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A2CF40)
#define MOLEMOLE_UISOCIALCIRCLEMAINTAGWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x15A2D120)
#define MOLEMOLE_UISOCIALCIRCLEMAINTAGWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15A2D350)
#define MOLEMOLE_UISOCIALCIRCLEMAINTAGWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15A2D360)
#define MOLEMOLE_UISOCIALCIRCLEMAINTAGWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15A2D400)
#define MOLEMOLE_UISOCIALCIRCLEMAINTAGWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15A2D4A0)
#define MOLEMOLE_UISOCIALCIRCLEMAINTAGWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A2D540)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleMainTagWidgetController_TypeDefinitionIndex = 71339;
