...
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_HIDEALL_OFFSET UNITYSDK_OFFSET(0x160D2AB0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x160D28E0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x160D2C10)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x160D29F0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_ONSERVERFORMDATACHANGED_OFFSET UNITYSDK_OFFSET(0x160D1BC0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x160D2970)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x160D1A20)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_REFRESHBYCONTEXT_OFFSET UNITYSDK_OFFSET(0x160D1DC0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_REFRESHFORM_OFFSET UNITYSDK_OFFSET(0x160D2680)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x160D2DC0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x160D2DB0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER__ONUIINIT_B__2_0_OFFSET UNITYSDK_OFFSET(0x160D2DD0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x160D2E50)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x160D2EE0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x160D2F70)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x160D3010)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x160D30A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCitySwitchRoleCardWidgetController_TypeDefinitionIndex = 45351;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMainCitySwitchRoleCardWidgetController_TypeDefinitionIndex)->GetStaticField(0xABA0);
		}
		::Class_2_126D16B1AF601722* _view; // 0x2E8
		::MoleMole::UIMainCitySwitchRoleCardWidgetController_Context* _context; // 0x2F0
		::System::Action_1<::MoleMole::UIMainCitySwitchRoleCardWidgetController_Context*>* _clickAction; // 0x2F8
