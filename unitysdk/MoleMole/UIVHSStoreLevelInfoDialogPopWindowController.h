...
#define MOLEMOLE_UIVHSSTORELEVELINFODIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x14DDC810)
#define MOLEMOLE_UIVHSSTORELEVELINFODIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14DDD5A0)
#define MOLEMOLE_UIVHSSTORELEVELINFODIALOGPOPWINDOWCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x14DDD6A0)
#define MOLEMOLE_UIVHSSTORELEVELINFODIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14DDD630)
#define MOLEMOLE_UIVHSSTORELEVELINFODIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14DDC820)
#define MOLEMOLE_UIVHSSTORELEVELINFODIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14DDD530)
#define MOLEMOLE_UIVHSSTORELEVELINFODIALOGPOPWINDOWCONTROLLER_REFRESHLAYOUT_OFFSET UNITYSDK_OFFSET(0x14DDD180)
#define MOLEMOLE_UIVHSSTORELEVELINFODIALOGPOPWINDOWCONTROLLER_SCROLLTOTARGET_OFFSET UNITYSDK_OFFSET(0x14DDD240)
#define MOLEMOLE_UIVHSSTORELEVELINFODIALOGPOPWINDOWCONTROLLER_UPDATELEVELITEM_OFFSET UNITYSDK_OFFSET(0x14DDCE40)
#define MOLEMOLE_UIVHSSTORELEVELINFODIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14DDDA80)
#define MOLEMOLE_UIVHSSTORELEVELINFODIALOGPOPWINDOWCONTROLLER__UPDATELEVELITEM_B__8_0_OFFSET UNITYSDK_OFFSET(0x14DDDA90)
#define MOLEMOLE_UIVHSSTORELEVELINFODIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14DDDC50)
#define MOLEMOLE_UIVHSSTORELEVELINFODIALOGPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x14DDDCE0)
#define MOLEMOLE_UIVHSSTORELEVELINFODIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14DDDD90)
#define MOLEMOLE_UIVHSSTORELEVELINFODIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14DDDDA0)
#define MOLEMOLE_UIVHSSTORELEVELINFODIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14DDDDB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSStoreLevelInfoDialogPopWindowController_TypeDefinitionIndex = 40747;
