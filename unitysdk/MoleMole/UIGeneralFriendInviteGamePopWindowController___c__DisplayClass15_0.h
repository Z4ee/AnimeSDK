...
#define MOLEMOLE_UIGENERALFRIENDINVITEGAMEPOPWINDOWCONTROLLER___C__DISPLAYCLASS15_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19FAC5E0)
#define MOLEMOLE_UIGENERALFRIENDINVITEGAMEPOPWINDOWCONTROLLER___C__DISPLAYCLASS15_0__ONCLICKCHECKBTN_B__3_OFFSET UNITYSDK_OFFSET(0x19FAC5F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralFriendInviteGamePopWindowController___c__DisplayClass15_0_TypeDefinitionIndex = 51053;

	class UIGeneralFriendInviteGamePopWindowController___c__DisplayClass15_0 : public ::System::Object
	{
	public:
		::System::Action* callOnCompleteAction; // 0x10
		::Class_1_81D34D116310A358* currSelectInvite; // 0x18
		::System::Action* onAcceptShowAction; // 0x20
