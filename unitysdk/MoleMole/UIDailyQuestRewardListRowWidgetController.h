...
#define MOLEMOLE_UIDAILYQUESTREWARDLISTROWWIDGETCONTROLLER_CLEARREWARDS_OFFSET UNITYSDK_OFFSET(0x15E7CAE0)
#define MOLEMOLE_UIDAILYQUESTREWARDLISTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15E7C2A0)
#define MOLEMOLE_UIDAILYQUESTREWARDLISTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15E7C3D0)
#define MOLEMOLE_UIDAILYQUESTREWARDLISTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15E7C350)
#define MOLEMOLE_UIDAILYQUESTREWARDLISTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15E7CC60)
#define MOLEMOLE_UIDAILYQUESTREWARDLISTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15E7CCF0)
#define MOLEMOLE_UIDAILYQUESTREWARDLISTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15E7CD80)
#define MOLEMOLE_UIDAILYQUESTREWARDLISTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15E7CE20)

namespace MoleMole
{
	inline static constexpr unsigned int UIDailyQuestRewardListRowWidgetController_TypeDefinitionIndex = 47148;
