...
#define MOLEMOLE_PRELOADGHOSTEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x12650F20)

namespace MoleMole
{
	inline static constexpr unsigned int PreloadGhostEffectConfig_TypeDefinitionIndex = 74893;
