...
#define MOLEMOLE_UIHOLLOWRESULTINFOROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x178157A0)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x178158B0)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17815830)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17815740)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWWIDGETCONTROLLER_SETDATA_OFFSET UNITYSDK_OFFSET(0x17815970)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17817AB0)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17817AC0)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17817B50)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17817BF0)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17817C80)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowResultInfoRowWidgetController_TypeDefinitionIndex = 59920;

	class UIHollowResultInfoRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_94911C7709AE6562_6* _view; // 0x2F0
