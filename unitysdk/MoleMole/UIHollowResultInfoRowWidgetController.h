...
#define MOLEMOLE_UIHOLLOWRESULTINFOROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x155DEE90)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x155DEFA0)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x155DEF20)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x155DEE30)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x155E1100)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x155E1110)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x155E11A0)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x155E1240)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x155E12D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowResultInfoRowWidgetController_TypeDefinitionIndex = 47411;

	class UIHollowResultInfoRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_94911C7709AE6562_3* _view; // 0x2E8
