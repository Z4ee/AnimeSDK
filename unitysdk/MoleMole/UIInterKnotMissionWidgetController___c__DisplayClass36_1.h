...
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER___C__DISPLAYCLASS36_1__CTOR_OFFSET UNITYSDK_OFFSET(0x164F0CD0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER___C__DISPLAYCLASS36_1__ONTRACKBTNCLICKHANDLE_B__5_OFFSET UNITYSDK_OFFSET(0x164F0CE0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER___C__DISPLAYCLASS36_1__ONTRACKBTNCLICKHANDLE_B__6_OFFSET UNITYSDK_OFFSET(0x164F0EF0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER___C__DISPLAYCLASS36_1__ONTRACKBTNCLICKHANDLE_B__7_OFFSET UNITYSDK_OFFSET(0x164F0F50)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotMissionWidgetController___c__DisplayClass36_1_TypeDefinitionIndex = 91290;
