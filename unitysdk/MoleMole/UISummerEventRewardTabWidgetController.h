...
#define MOLEMOLE_UISUMMEREVENTREWARDTABWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xEBC6EC0)
#define MOLEMOLE_UISUMMEREVENTREWARDTABWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xEBC6F90)
#define MOLEMOLE_UISUMMEREVENTREWARDTABWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xEBC7220)
#define MOLEMOLE_UISUMMEREVENTREWARDTABWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xEBC7050)
#define MOLEMOLE_UISUMMEREVENTREWARDTABWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xEBC6F30)
#define MOLEMOLE_UISUMMEREVENTREWARDTABWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xEBC73E0)
#define MOLEMOLE_UISUMMEREVENTREWARDTABWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xEBC73F0)
#define MOLEMOLE_UISUMMEREVENTREWARDTABWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xEBC7490)
#define MOLEMOLE_UISUMMEREVENTREWARDTABWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xEBC7520)
#define MOLEMOLE_UISUMMEREVENTREWARDTABWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xEBC75C0)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerEventRewardTabWidgetController_TypeDefinitionIndex = 77783;
