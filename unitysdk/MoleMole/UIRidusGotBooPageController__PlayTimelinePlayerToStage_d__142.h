...
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__PLAYTIMELINEPLAYERTOSTAGE_D__142_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x84CC60)
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__PLAYTIMELINEPLAYERTOSTAGE_D__142_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooPageController__PlayTimelinePlayerToStage_d__142_TypeDefinitionIndex = 91515;
