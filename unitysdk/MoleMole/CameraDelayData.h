...
#define MOLEMOLE_CAMERADELAYDATA_CLONE_OFFSET UNITYSDK_OFFSET(0x10CD1840)
#define MOLEMOLE_CAMERADELAYDATA_LERP_OFFSET UNITYSDK_OFFSET(0x10CD1460)
#define MOLEMOLE_CAMERADELAYDATA_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x10CD13F0)
#define MOLEMOLE_CAMERADELAYDATA_ZERO_OFFSET UNITYSDK_OFFSET(0x10CD13A0)
#define MOLEMOLE_CAMERADELAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x10CD1790)

namespace MoleMole
{
	inline static constexpr unsigned int CameraDelayData_TypeDefinitionIndex = 51450;
