...
#define MOLEMOLE_UIMAINCITYSIDEBARITEMWIDGETCONTROLLER_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0x16E934C0)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16E93450)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16E936A0)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16E93760)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16E93640)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16E93890)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16E938A0)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16E93940)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16E939E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCitySidebarItemWidgetController_TypeDefinitionIndex = 76295;
