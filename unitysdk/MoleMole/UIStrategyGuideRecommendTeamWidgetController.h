...
#define MOLEMOLE_UISTRATEGYGUIDERECOMMENDTEAMWIDGETCONTROLLER_CLEARROLECARDROWS_OFFSET UNITYSDK_OFFSET(0x16DC4EB0)
#define MOLEMOLE_UISTRATEGYGUIDERECOMMENDTEAMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16DC4D90)
#define MOLEMOLE_UISTRATEGYGUIDERECOMMENDTEAMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16DC50D0)
#define MOLEMOLE_UISTRATEGYGUIDERECOMMENDTEAMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16DC4E20)
#define MOLEMOLE_UISTRATEGYGUIDERECOMMENDTEAMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16DC4D30)
#define MOLEMOLE_UISTRATEGYGUIDERECOMMENDTEAMWIDGETCONTROLLER_REFRESHAVATARLISTROOT_OFFSET UNITYSDK_OFFSET(0x16DC5840)
#define MOLEMOLE_UISTRATEGYGUIDERECOMMENDTEAMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16DC5DC0)
#define MOLEMOLE_UISTRATEGYGUIDERECOMMENDTEAMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16DC5E50)
#define MOLEMOLE_UISTRATEGYGUIDERECOMMENDTEAMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16DC5EE0)
#define MOLEMOLE_UISTRATEGYGUIDERECOMMENDTEAMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16DC5F80)
#define MOLEMOLE_UISTRATEGYGUIDERECOMMENDTEAMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16DC6010)

namespace MoleMole
{
	inline static constexpr unsigned int UIStrategyGuideRecommendTeamWidgetController_TypeDefinitionIndex = 49417;

	class UIStrategyGuideRecommendTeamWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_754022533D501C3E_4* _view; // 0x2F0
