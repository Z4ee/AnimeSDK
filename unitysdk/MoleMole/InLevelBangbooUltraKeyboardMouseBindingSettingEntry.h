...
#define MOLEMOLE_INLEVELBANGBOOULTRAKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x125D2720)
#define MOLEMOLE_INLEVELBANGBOOULTRAKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x125D2730)
#define MOLEMOLE_INLEVELBANGBOOULTRAKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x125D2740)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelBangbooUltraKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 60686;
