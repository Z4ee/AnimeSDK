...
#define MOLEMOLE_UIAUTOBATTLEPVPPLAYERROWWIDGETCONTROLLER___C__DISPLAYCLASS19_0__BINDINVITEBTN_B__0_OFFSET UNITYSDK_OFFSET(0x18A4ED10)
#define MOLEMOLE_UIAUTOBATTLEPVPPLAYERROWWIDGETCONTROLLER___C__DISPLAYCLASS19_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18A4ED00)

namespace MoleMole
{
	inline static constexpr unsigned int UIAutoBattlePVPPlayerRowWidgetController___c__DisplayClass19_0_TypeDefinitionIndex = 82651;
