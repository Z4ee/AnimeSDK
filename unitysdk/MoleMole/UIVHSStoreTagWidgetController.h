...
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_AFTERTAGIDCHANGE_OFFSET UNITYSDK_OFFSET(0x12E3B030)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_CALALLTAGSUCCESS_OFFSET UNITYSDK_OFFSET(0x12E3AC00)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_CALTAGLAYER_OFFSET UNITYSDK_OFFSET(0x12E3A6C0)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_CALVHSATLEASTMATCHONETAG_OFFSET UNITYSDK_OFFSET(0x12E3AA60)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_GET__DATA_OFFSET UNITYSDK_OFFSET(0x12E3B170)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12E3A0D0)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x12E3A220)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12E3A160)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12E3A000)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12E3A060)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_PLAYHIGHLIGHTTAGANIM_OFFSET UNITYSDK_OFFSET(0x12E3AF80)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_REFRESHLAYER_OFFSET UNITYSDK_OFFSET(0x12E3A460)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_REFRESHTAGLAYER_OFFSET UNITYSDK_OFFSET(0x12E389F0)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_SET__DATA_OFFSET UNITYSDK_OFFSET(0x12E3A3D0)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x12E3B1F0)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12E3B180)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12E3B230)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x12E3B2C0)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12E3B360)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12E3B3F0)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12E3B480)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSStoreTagWidgetController_TypeDefinitionIndex = 75926;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIVHSStoreTagWidgetController_TypeDefinitionIndex)->GetStaticField(0x3A970);
		}
		...
		::System::Void RefreshTagLayer(::System::Collections::Generic::IReadOnlyList_1<::Class_2_2B34123E20497912_Class_1_A6660CA21D7C1066_Class_1_C277D6FBDA93149D*>* selectedVhs, ::System::Single animDelayTime, ::System::Boolean skipAnim)
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::IReadOnlyList_1<::Class_2_2B34123E20497912_Class_1_A6660CA21D7C1066_Class_1_C277D6FBDA93149D*>*, ::System::Single, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_REFRESHTAGLAYER_OFFSET))(this, selectedVhs, animDelayTime, skipAnim);
		}
