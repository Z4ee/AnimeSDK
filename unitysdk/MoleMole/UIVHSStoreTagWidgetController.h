...
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_AFTERTAGIDCHANGE_OFFSET UNITYSDK_OFFSET(0x12E4E4B0)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_CALALLTAGSUCCESS_OFFSET UNITYSDK_OFFSET(0x12E4E050)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_CALTAGLAYER_OFFSET UNITYSDK_OFFSET(0x12E4DB10)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_CALVHSATLEASTMATCHONETAG_OFFSET UNITYSDK_OFFSET(0x12E4DEB0)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_GET__DATA_OFFSET UNITYSDK_OFFSET(0x12E4E5F0)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12E4D530)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x12E4D680)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12E4D5C0)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12E4D460)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12E4D4C0)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_PLAYHIGHLIGHTTAGANIM_OFFSET UNITYSDK_OFFSET(0x12E4E3F0)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_REFRESHLAYER_OFFSET UNITYSDK_OFFSET(0x12E4D8C0)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_REFRESHTAGLAYER_OFFSET UNITYSDK_OFFSET(0x12E4BDE0)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_SET__DATA_OFFSET UNITYSDK_OFFSET(0x12E4D820)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x12E4E670)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12E4E600)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12E4E6B0)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x12E4E740)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12E4E7E0)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12E4E870)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12E4E900)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSStoreTagWidgetController_TypeDefinitionIndex = 40453;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIVHSStoreTagWidgetController_TypeDefinitionIndex)->GetStaticField(0x355A0);
		}
		::Class_2_6C1130EE789A61BA* _view; // 0x2E8
		::System::Boolean _first; // 0x2F0
		::MoleMole::UIVHSStoreTagWidgetController_Data* __data; // 0x2F8
		::System::Int32 _trendingLayer; // 0x300
		::System::Threading::CancellationTokenSource* _tagRefreshCts; // 0x308
		::System::Boolean _tagRefreshDone; // 0x310
