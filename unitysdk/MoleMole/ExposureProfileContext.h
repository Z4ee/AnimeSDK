...
#define MOLEMOLE_EXPOSUREPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18200FA0)

namespace MoleMole
{
	inline static constexpr unsigned int ExposureProfileContext_TypeDefinitionIndex = 80374;
