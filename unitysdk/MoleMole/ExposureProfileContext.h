...
#define MOLEMOLE_EXPOSUREPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B82B050)

namespace MoleMole
{
	inline static constexpr unsigned int ExposureProfileContext_TypeDefinitionIndex = 72434;
