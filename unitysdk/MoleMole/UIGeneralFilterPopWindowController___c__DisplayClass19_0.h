...
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER___C__DISPLAYCLASS19_0__CTOR_OFFSET UNITYSDK_OFFSET(0x193939B0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER___C__DISPLAYCLASS19_0__ONUIOPEN_B__0_OFFSET UNITYSDK_OFFSET(0x193968A0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER___C__DISPLAYCLASS19_0__ONUIOPEN_B__1_OFFSET UNITYSDK_OFFSET(0x193968E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralFilterPopWindowController___c__DisplayClass19_0_TypeDefinitionIndex = 46961;
