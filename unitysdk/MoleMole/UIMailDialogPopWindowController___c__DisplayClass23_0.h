...
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS23_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16E87B00)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS23_0__TRYGETMAILAWARD_B__0_OFFSET UNITYSDK_OFFSET(0x16E87B10)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS23_0__TRYGETMAILAWARD_B__2_OFFSET UNITYSDK_OFFSET(0x16E880E0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS23_0__TRYGETMAILAWARD_G__TRYADDMAILTOGETAWARDLIST_1_OFFSET UNITYSDK_OFFSET(0x16E88100)

namespace MoleMole
{
	inline static constexpr unsigned int UIMailDialogPopWindowController___c__DisplayClass23_0_TypeDefinitionIndex = 39651;

	class UIMailDialogPopWindowController___c__DisplayClass23_0 : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::Class_1_0A0B50D6899733CD*>* getAwardList; // 0x10
