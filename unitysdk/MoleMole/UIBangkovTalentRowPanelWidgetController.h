...
#define MOLEMOLE_UIBANGKOVTALENTROWPANELWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17607510)
#define MOLEMOLE_UIBANGKOVTALENTROWPANELWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17607580)
#define MOLEMOLE_UIBANGKOVTALENTROWPANELWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17607620)
#define MOLEMOLE_UIBANGKOVTALENTROWPANELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x176077D0)
#define MOLEMOLE_UIBANGKOVTALENTROWPANELWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17607830)
#define MOLEMOLE_UIBANGKOVTALENTROWPANELWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x176078D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangkovTalentRowPanelWidgetController_TypeDefinitionIndex = 59463;
