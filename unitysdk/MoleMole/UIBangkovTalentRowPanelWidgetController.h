...
#define MOLEMOLE_UIBANGKOVTALENTROWPANELWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18E47690)
#define MOLEMOLE_UIBANGKOVTALENTROWPANELWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18E47700)
#define MOLEMOLE_UIBANGKOVTALENTROWPANELWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18E477A0)
#define MOLEMOLE_UIBANGKOVTALENTROWPANELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18E47960)
#define MOLEMOLE_UIBANGKOVTALENTROWPANELWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18E479C0)
#define MOLEMOLE_UIBANGKOVTALENTROWPANELWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18E47A60)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangkovTalentRowPanelWidgetController_TypeDefinitionIndex = 57442;
