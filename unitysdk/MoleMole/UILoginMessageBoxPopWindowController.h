...
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_BTNCONFIRMACTION_OFFSET UNITYSDK_OFFSET(0x182A6350)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_BTNCONFIRM_OFFSET UNITYSDK_OFFSET(0x182A63D0)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x182A4670)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_GET_ISFORCEIGNORESDKPANEL_OFFSET UNITYSDK_OFFSET(0x182A4690)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x182A4680)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_HIDECANCEL_OFFSET UNITYSDK_OFFSET(0x182A6190)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_HIDECONFIRM_OFFSET UNITYSDK_OFFSET(0x182A6200)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_MASKCLOSE_OFFSET UNITYSDK_OFFSET(0x182A4E20)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x182A4B30)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x182A4D90)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x182A4C30)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x182A4BC0)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x182A46A0)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_SETCANCELBTNTEXT_OFFSET UNITYSDK_OFFSET(0x182A5DA0)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_SETCANCELINTERACT_OFFSET UNITYSDK_OFFSET(0x182A6270)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_SETCONFIRMINTERACT_OFFSET UNITYSDK_OFFSET(0x182A62E0)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_SETOKBTN_OFFSET UNITYSDK_OFFSET(0x182A5B60)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_SETTITLECONTENTTEXT_OFFSET UNITYSDK_OFFSET(0x182A5FE0)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_SHOWERRORCODE_OFFSET UNITYSDK_OFFSET(0x182A4FD0)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_SHOWMESSAGEBOX_OFFSET UNITYSDK_OFFSET(0x182A52C0)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x182A64A0)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER__ONUIINIT_B__10_0_OFFSET UNITYSDK_OFFSET(0x182A64B0)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER__ONUIINIT_B__10_1_OFFSET UNITYSDK_OFFSET(0x182A64D0)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER___BASE_MASKCLOSE_OFFSET UNITYSDK_OFFSET(0x182A64F0)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x182A6580)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x182A6610)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x182A6640)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x182A6650)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x182A6660)

namespace MoleMole
{
	inline static constexpr unsigned int UILoginMessageBoxPopWindowController_TypeDefinitionIndex = 70097;
