...
#define MOLEMOLE_UIINLEVELABYSSS2ARTIFACTDISAPPEARCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18858DB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelAbyssS2ArtifactDisappearContext_TypeDefinitionIndex = 75684;

	class UIInLevelAbyssS2ArtifactDisappearContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::Class_1_0D6706375CDAAE8C* SourceItemData; // 0x28
