...
#define MOLEMOLE_UIRABDEPOSITORYPROPERTYDESCITEMROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15699C60)
#define MOLEMOLE_UIRABDEPOSITORYPROPERTYDESCITEMROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15699CD0)
#define MOLEMOLE_UIRABDEPOSITORYPROPERTYDESCITEMROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15699D70)
#define MOLEMOLE_UIRABDEPOSITORYPROPERTYDESCITEMROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x15699E30)
#define MOLEMOLE_UIRABDEPOSITORYPROPERTYDESCITEMROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15699FB0)
#define MOLEMOLE_UIRABDEPOSITORYPROPERTYDESCITEMROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15699FC0)
#define MOLEMOLE_UIRABDEPOSITORYPROPERTYDESCITEMROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1569A060)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABDepositoryPropertyDescItemRowWidgetController_TypeDefinitionIndex = 46491;
