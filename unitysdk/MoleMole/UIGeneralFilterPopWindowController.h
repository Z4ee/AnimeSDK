...
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_CREATEITEM_OFFSET UNITYSDK_OFFSET(0x19395220)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_GETADVANCEDOPTIONMATCHCOUNT_OFFSET UNITYSDK_OFFSET(0x19395830)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_GETFILTERITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x19395DC0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_GETFILTEROPTIONSTATE_OFFSET UNITYSDK_OFFSET(0x19395AC0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_GETOWNFILTERGROUPINDEX_OFFSET UNITYSDK_OFFSET(0x193939C0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x19391D00)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x19391CF0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_HIDEPOPUP_OFFSET UNITYSDK_OFFSET(0x19395040)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x19391DC0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONCANCEL_OFFSET UNITYSDK_OFFSET(0x193955C0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONCLICKPOPUPBTN_OFFSET UNITYSDK_OFFSET(0x19395530)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONCLICKPOPUP_OFFSET UNITYSDK_OFFSET(0x19395450)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONCLICKRESET_OFFSET UNITYSDK_OFFSET(0x19395320)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONCLOSEFILTER_OFFSET UNITYSDK_OFFSET(0x19396270)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19394320)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONGROUPITEMCLICK_OFFSET UNITYSDK_OFFSET(0x19395620)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x193943B0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x19394580)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONLANGUAGECHANGE_OFFSET UNITYSDK_OFFSET(0x19392350)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONOPENFILTER_OFFSET UNITYSDK_OFFSET(0x19396100)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONSORTINVERSECLICK_OFFSET UNITYSDK_OFFSET(0x19396040)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONSORTOPTIONSELECTED_OFFSET UNITYSDK_OFFSET(0x19395F90)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19394500)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19391D10)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x193924C0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_REFRESHADVANCEDMATCHITEMSLANGUAGECONTENT_OFFSET UNITYSDK_OFFSET(0x193923A0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x19393CC0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_SCROLLTOTARGET_OFFSET UNITYSDK_OFFSET(0x19394740)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_SETFILTERSTATEANDREFRESH_OFFSET UNITYSDK_OFFSET(0x193958F0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_SHOWPOPUP_OFFSET UNITYSDK_OFFSET(0x193954D0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19396460)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x193963D0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER__HIDEPOPUP_B__34_0_OFFSET UNITYSDK_OFFSET(0x19396600)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER__INITVIEW_B__26_0_OFFSET UNITYSDK_OFFSET(0x193965C0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER__INITVIEW_B__26_1_OFFSET UNITYSDK_OFFSET(0x193965D0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER__INITVIEW_B__26_2_OFFSET UNITYSDK_OFFSET(0x193965E0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER__INITVIEW_B__26_3_OFFSET UNITYSDK_OFFSET(0x193965F0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x193966A0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x19396730)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x193967C0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x193967F0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19396800)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19396810)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralFilterPopWindowController_TypeDefinitionIndex = 46959;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIGeneralFilterPopWindowController_TypeDefinitionIndex)->GetStaticField(0x4C580);
		}
		static ::Il2CppArray<::System::String*>** StaticGet_advancedMatchItems()
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(UIGeneralFilterPopWindowController_TypeDefinitionIndex)->GetStaticField(0x4C588);
		}
		static ::System::String** StaticGet_CONFIRM_TEXT()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIGeneralFilterPopWindowController_TypeDefinitionIndex)->GetStaticField(0x4C590);
		}
		// static const ::System::String* BtnsPopupAniFadeOut; // 0x0
		::Class_2_79AE422BA06F6D26_85* _view; // 0x318
		::Class_0_16E4307DCC419505_372* _filterInstance; // 0x320
		...
		::Class_1_C3C988A67054887E* _sortWidgetData; // 0x340
		::Class_1_917BAA24A53AF106* _sortOptionsDropDown; // 0x348
