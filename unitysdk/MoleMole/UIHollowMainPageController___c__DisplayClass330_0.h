...
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS330_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16ACC490)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS330_0__SHOWOVERLOADANIM_B__0_OFFSET UNITYSDK_OFFSET(0x16ACC6A0)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS330_0__SHOWOVERLOADANIM_B__1_OFFSET UNITYSDK_OFFSET(0x16ACC4A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMainPageController___c__DisplayClass330_0_TypeDefinitionIndex = 78284;
