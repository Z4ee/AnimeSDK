...
#define MOLEMOLE_UIABINLEVELGENERALWIDGETCONTROLLER___C__DISPLAYCLASS23_0__BINDVIEW_B__0_OFFSET UNITYSDK_OFFSET(0x189245C0)
#define MOLEMOLE_UIABINLEVELGENERALWIDGETCONTROLLER___C__DISPLAYCLASS23_0__BINDVIEW_B__1_OFFSET UNITYSDK_OFFSET(0x18924700)
#define MOLEMOLE_UIABINLEVELGENERALWIDGETCONTROLLER___C__DISPLAYCLASS23_0__BINDVIEW_B__2_OFFSET UNITYSDK_OFFSET(0x18924840)
#define MOLEMOLE_UIABINLEVELGENERALWIDGETCONTROLLER___C__DISPLAYCLASS23_0__BINDVIEW_B__3_OFFSET UNITYSDK_OFFSET(0x18924B80)
#define MOLEMOLE_UIABINLEVELGENERALWIDGETCONTROLLER___C__DISPLAYCLASS23_0__BINDVIEW_B__4_OFFSET UNITYSDK_OFFSET(0x18924CD0)
#define MOLEMOLE_UIABINLEVELGENERALWIDGETCONTROLLER___C__DISPLAYCLASS23_0__CTOR_OFFSET UNITYSDK_OFFSET(0x189245B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIABInLevelGeneralWidgetController___c__DisplayClass23_0_TypeDefinitionIndex = 68007;
	...
	public:
		...
		::Class_2_80486DA64C1484CD* inLevelData; // 0x18
		::Class_1_F0E4E2848B1D52CE* viewModel; // 0x20
		::Class_2_C5C4037080416954_Class_2_CF95F81DB4449032_1* lpView; // 0x28
