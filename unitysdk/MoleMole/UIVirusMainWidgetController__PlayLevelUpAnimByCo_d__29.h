...
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER__PLAYLEVELUPANIMBYCO_D__29_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x10EFD370)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER__PLAYLEVELUPANIMBYCO_D__29_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x10EFD930)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER__PLAYLEVELUPANIMBYCO_D__29_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x10EFD990)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER__PLAYLEVELUPANIMBYCO_D__29_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x10EFD940)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER__PLAYLEVELUPANIMBYCO_D__29_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10EFD360)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER__PLAYLEVELUPANIMBYCO_D__29__CTOR_OFFSET UNITYSDK_OFFSET(0x10EFD350)

namespace MoleMole
{
	inline static constexpr unsigned int UIVirusMainWidgetController__PlayLevelUpAnimByCo_d__29_TypeDefinitionIndex = 77830;
	...
	public:
		...
		::Class_2_8019553DE28C70A1* _virusModel_5__2; // 0x18
