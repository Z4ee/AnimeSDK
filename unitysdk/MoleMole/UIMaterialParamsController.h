...
#define MOLEMOLE_UIMATERIALPARAMSCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x16942FC0)
#define MOLEMOLE_UIMATERIALPARAMSCONTROLLER_METHOD_5_1B3D8773D1869301_OFFSET UNITYSDK_OFFSET(0x16942E30)
#define MOLEMOLE_UIMATERIALPARAMSCONTROLLER_METHOD_5_704FAC4600717444_OFFSET UNITYSDK_OFFSET(0x169430A0)
#define MOLEMOLE_UIMATERIALPARAMSCONTROLLER_METHOD_5_7B32E6463125895B_OFFSET UNITYSDK_OFFSET(0x16943690)
#define MOLEMOLE_UIMATERIALPARAMSCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x16943640)
#define MOLEMOLE_UIMATERIALPARAMSCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x16943880)
#define MOLEMOLE_UIMATERIALPARAMSCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16942D90)
#define MOLEMOLE_UIMATERIALPARAMSCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x16943050)
#define MOLEMOLE_UIMATERIALPARAMSCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x169438D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMaterialParamsController_TypeDefinitionIndex = 76380;
