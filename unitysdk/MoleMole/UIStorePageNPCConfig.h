...
#define MOLEMOLE_UISTOREPAGENPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x179C7540)

namespace MoleMole
{
	inline static constexpr unsigned int UIStorePageNPCConfig_TypeDefinitionIndex = 51306;
