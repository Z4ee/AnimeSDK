...
#define MOLEMOLE_UISTOREPAGENPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x14588070)

namespace MoleMole
{
	inline static constexpr unsigned int UIStorePageNPCConfig_TypeDefinitionIndex = 47752;
