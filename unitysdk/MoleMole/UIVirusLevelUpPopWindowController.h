...
#define MOLEMOLE_UIVIRUSLEVELUPPOPWINDOWCONTROLLER_GETABILITYITEM_OFFSET UNITYSDK_OFFSET(0x12C8CE70)
#define MOLEMOLE_UIVIRUSLEVELUPPOPWINDOWCONTROLLER_GETDETAILSITEM_OFFSET UNITYSDK_OFFSET(0x12C8CD40)
#define MOLEMOLE_UIVIRUSLEVELUPPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x12C8C130)
#define MOLEMOLE_UIVIRUSLEVELUPPOPWINDOWCONTROLLER_ONCLICKPROPERTYINFOBTN_OFFSET UNITYSDK_OFFSET(0x12C8CFA0)
#define MOLEMOLE_UIVIRUSLEVELUPPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12C8C140)
#define MOLEMOLE_UIVIRUSLEVELUPPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12C8C300)
#define MOLEMOLE_UIVIRUSLEVELUPPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12C8C370)
#define MOLEMOLE_UIVIRUSLEVELUPPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12C8D1C0)
#define MOLEMOLE_UIVIRUSLEVELUPPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12C8D2A0)
#define MOLEMOLE_UIVIRUSLEVELUPPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12C8D330)
#define MOLEMOLE_UIVIRUSLEVELUPPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12C8D340)

namespace MoleMole
{
	inline static constexpr unsigned int UIVirusLevelUpPopWindowController_TypeDefinitionIndex = 47846;
