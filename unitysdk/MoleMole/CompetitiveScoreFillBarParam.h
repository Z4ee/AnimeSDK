...
#define MOLEMOLE_COMPETITIVESCOREFILLBARPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1484A980)

namespace MoleMole
{
	inline static constexpr unsigned int CompetitiveScoreFillBarParam_TypeDefinitionIndex = 69213;
