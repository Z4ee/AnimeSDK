...
#define MOLEMOLE_CONFIGHIDEMENUGALGAMELIST__CTOR_OFFSET UNITYSDK_OFFSET(0x19215740)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigHideMenuGalgameList_TypeDefinitionIndex = 62071;
