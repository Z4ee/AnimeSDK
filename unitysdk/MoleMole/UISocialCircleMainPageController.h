...
#define MOLEMOLE_UISOCIALCIRCLEMAINPAGECONTROLLER_GETBOTTOMTIPSROOT_OFFSET UNITYSDK_OFFSET(0x137874E0)
#define MOLEMOLE_UISOCIALCIRCLEMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x137873A0)
#define MOLEMOLE_UISOCIALCIRCLEMAINPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x137873B0)
#define MOLEMOLE_UISOCIALCIRCLEMAINPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x13787420)
#define MOLEMOLE_UISOCIALCIRCLEMAINPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x13787580)
#define MOLEMOLE_UISOCIALCIRCLEMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x13787760)
#define MOLEMOLE_UISOCIALCIRCLEMAINPAGECONTROLLER___BASE_GETBOTTOMTIPSROOT_OFFSET UNITYSDK_OFFSET(0x13787770)
#define MOLEMOLE_UISOCIALCIRCLEMAINPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x13787800)
#define MOLEMOLE_UISOCIALCIRCLEMAINPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x137878A0)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleMainPageController_TypeDefinitionIndex = 72281;
