...
#define MOLEMOLE_UISOCIALCIRCLEMAINPAGECONTROLLER_GETBOTTOMTIPSROOT_OFFSET UNITYSDK_OFFSET(0x16170D50)
#define MOLEMOLE_UISOCIALCIRCLEMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x16170C10)
#define MOLEMOLE_UISOCIALCIRCLEMAINPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16170C20)
#define MOLEMOLE_UISOCIALCIRCLEMAINPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16170C90)
#define MOLEMOLE_UISOCIALCIRCLEMAINPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16170DF0)
#define MOLEMOLE_UISOCIALCIRCLEMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16170FD0)
#define MOLEMOLE_UISOCIALCIRCLEMAINPAGECONTROLLER___BASE_GETBOTTOMTIPSROOT_OFFSET UNITYSDK_OFFSET(0x16170FE0)
#define MOLEMOLE_UISOCIALCIRCLEMAINPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16171070)
#define MOLEMOLE_UISOCIALCIRCLEMAINPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16171110)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleMainPageController_TypeDefinitionIndex = 62256;
