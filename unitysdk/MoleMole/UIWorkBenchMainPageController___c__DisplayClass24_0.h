...
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER___C__DISPLAYCLASS24_0__CTOR_OFFSET UNITYSDK_OFFSET(0x156E69A0)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER___C__DISPLAYCLASS24_0__SELECTEDAPPICON_G__TRANSITION_0_OFFSET UNITYSDK_OFFSET(0x156E69B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkBenchMainPageController___c__DisplayClass24_0_TypeDefinitionIndex = 47423;

	class UIWorkBenchMainPageController___c__DisplayClass24_0 : public ::System::Object
	{
	public:
		::Class_2_208CC9941471731A_993* templateData; // 0x10
