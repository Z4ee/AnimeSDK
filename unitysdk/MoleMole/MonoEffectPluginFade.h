...
#define MOLEMOLE_MONOEFFECTPLUGINFADE__CTOR_OFFSET UNITYSDK_OFFSET(0x17913720)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginFade_TypeDefinitionIndex = 78104;
