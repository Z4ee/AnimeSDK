...
#define MOLEMOLE_SUIBIANTEMPLEUPGRADEDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1304AD50)

namespace MoleMole
{
	inline static constexpr unsigned int SuibianTempleUpgradeDialogContext_TypeDefinitionIndex = 59622;
