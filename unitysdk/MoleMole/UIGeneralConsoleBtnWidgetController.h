...
#define MOLEMOLE_UIGENERALCONSOLEBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19FA9580)
#define MOLEMOLE_UIGENERALCONSOLEBTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19FA9610)
#define MOLEMOLE_UIGENERALCONSOLEBTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19FA94B0)
#define MOLEMOLE_UIGENERALCONSOLEBTNWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19FA9510)
#define MOLEMOLE_UIGENERALCONSOLEBTNWIDGETCONTROLLER_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x19FA9690)
#define MOLEMOLE_UIGENERALCONSOLEBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19FA9700)
#define MOLEMOLE_UIGENERALCONSOLEBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19FA9760)
#define MOLEMOLE_UIGENERALCONSOLEBTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19FA97F0)
#define MOLEMOLE_UIGENERALCONSOLEBTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19FA9880)
#define MOLEMOLE_UIGENERALCONSOLEBTNWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19FA9910)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralConsoleBtnWidgetController_TypeDefinitionIndex = 48618;
