...
#define MOLEMOLE_CONFIGAVATARDYNAMICCHECKTREENODE_CREATE_OFFSET UNITYSDK_OFFSET(0x1C47C540)
#define MOLEMOLE_CONFIGAVATARDYNAMICCHECKTREENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C47C5D0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigAvatarDynamicCheckTreeNode_TypeDefinitionIndex = 69087;
	...
	public:
		...
		{
			return ((::Class_1_688FBF6C0FC439E7_Class_1_7E14AFCE0E4315E7*(*)(::PVOID, ::Class_1_BFC2F9D5895EB2FB*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIGAVATARDYNAMICCHECKTREENODE_CREATE_OFFSET))(this, overrideMap);
		}
	};
}
