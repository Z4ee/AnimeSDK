...
#define MOLEMOLE_SHADERQUALITYBYANDROIDGPUMODELPOSTPROCESSORPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1190D6C0)
#define MOLEMOLE_SHADERQUALITYBYANDROIDGPUMODELPOSTPROCESSORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1190D730)
#define MOLEMOLE_SHADERQUALITYBYANDROIDGPUMODELPOSTPROCESSORPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1190D7B0)

namespace MoleMole
{
	inline static constexpr unsigned int ShaderQualityByAndroidGPUModelPostProcessorProfile_TypeDefinitionIndex = 76373;
