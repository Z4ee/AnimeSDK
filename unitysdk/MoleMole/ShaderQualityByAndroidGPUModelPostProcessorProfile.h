...
#define MOLEMOLE_SHADERQUALITYBYANDROIDGPUMODELPOSTPROCESSORPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x10E4F8B0)
#define MOLEMOLE_SHADERQUALITYBYANDROIDGPUMODELPOSTPROCESSORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x10E4F920)
#define MOLEMOLE_SHADERQUALITYBYANDROIDGPUMODELPOSTPROCESSORPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x10E4F9A0)

namespace MoleMole
{
	inline static constexpr unsigned int ShaderQualityByAndroidGPUModelPostProcessorProfile_TypeDefinitionIndex = 72183;
