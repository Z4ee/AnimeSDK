...
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER_ACTIVELOADINGUI_OFFSET UNITYSDK_OFFSET(0x16E86290)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER_GET_ALLOWASSETPROXYUNLOADRES_OFFSET UNITYSDK_OFFSET(0x16E85ED0)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x16E85EF0)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER_GET_PERMANENT_OFFSET UNITYSDK_OFFSET(0x16E85F00)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x16E85EE0)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16E870F0)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16E85F10)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16E86220)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER_SETCORNER_OFFSET UNITYSDK_OFFSET(0x16E87180)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER_SETLOADINGVIEW_OFFSET UNITYSDK_OFFSET(0x16E86460)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x16E86FC0)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER_UNACTIVELOADINGUI_OFFSET UNITYSDK_OFFSET(0x16E86E00)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16E87420)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16E87430)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16E874C0)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16E874D0)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x16E87560)

namespace MoleMole
{
	inline static constexpr unsigned int UILoadingPopWindowController_TypeDefinitionIndex = 59267;
	...
	public:
		...
		::System::Void SetCorner(::Class_2_208CC9941471731A_903* loadingPage, ::Class_2_1A39E1B51756BF41* cornerIcon, ::UnityEngine::UI::Extension::UILocalizationText* numberText, ::UnityEngine::UI::Extension::UILocalizationText* tagText)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_903*, ::Class_2_1A39E1B51756BF41*, ::UnityEngine::UI::Extension::UILocalizationText*, ::UnityEngine::UI::Extension::UILocalizationText*))((::PBYTE)hIl2Cpp + MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER_SETCORNER_OFFSET))(this, loadingPage, cornerIcon, numberText, tagText);
		}
