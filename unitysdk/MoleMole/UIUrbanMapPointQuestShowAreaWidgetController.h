...
#define MOLEMOLE_UIURBANMAPPOINTQUESTSHOWAREAWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12E484C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapPointQuestShowAreaWidgetController_TypeDefinitionIndex = 74946;
