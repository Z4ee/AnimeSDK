...
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_CLEARBAGITEMSELECT_OFFSET UNITYSDK_OFFSET(0x12B66570)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_CLEAREDITORSTATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x12B65BF0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_CLEARPACKAGEENABLE_OFFSET UNITYSDK_OFFSET(0x12B68740)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_CREATECOMPONENTWIDGET_OFFSET UNITYSDK_OFFSET(0x12B66DC0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ENABLEMASKSELECT_OFFSET UNITYSDK_OFFSET(0x12B66670)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ENABLESELECTWIDGET_OFFSET UNITYSDK_OFFSET(0x12B64FF0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_FORCEFOUCSSELECTITEM_OFFSET UNITYSDK_OFFSET(0x12B69380)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_FORCEFOUCSSELELCTBAG_OFFSET UNITYSDK_OFFSET(0x12B690D0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_GETBAGFIRSTCOMPONENT_OFFSET UNITYSDK_OFFSET(0x12B638D0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_GETCOMPONENTWIDGET_OFFSET UNITYSDK_OFFSET(0x12B63800)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_GETFILTEINDEX_OFFSET UNITYSDK_OFFSET(0x12B68220)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_GETGAMEPADSELECT_OFFSET UNITYSDK_OFFSET(0x12B68F70)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_GETTOUCHCOMPONENT_OFFSET UNITYSDK_OFFSET(0x12B68A20)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_GET_DIYCOMPONENTWIDGETCONTROLLERS_OFFSET UNITYSDK_OFFSET(0x12B69880)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_INITBAGCOMPONENT_OFFSET UNITYSDK_OFFSET(0x12B63940)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_INITCURRENTPAGEINSTALLCOMPONENT_OFFSET UNITYSDK_OFFSET(0x12B63E70)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_INITGRIDS_OFFSET UNITYSDK_OFFSET(0x12B62CF0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x12B62880)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ISBAGSCROLLDRAGING_OFFSET UNITYSDK_OFFSET(0x12B69060)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x12B659A0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONBAGCOMPONENTUPDATE_OFFSET UNITYSDK_OFFSET(0x12B627C0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONBAGITEMSELECT_OFFSET UNITYSDK_OFFSET(0x12B66520)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONBUDDYCOMPONENTDELETE_OFFSET UNITYSDK_OFFSET(0x12B66ED0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONBUDDYCOMPONENTINSTALLFROMBAG_OFFSET UNITYSDK_OFFSET(0x12B66860)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONBUDDYEDITOR_OFFSET UNITYSDK_OFFSET(0x12B65400)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONBUDDYSWITCHPACKAGESCRSP_OFFSET UNITYSDK_OFFSET(0x12B68860)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONCLICKCURRENTPACAKGEENABLE_OFFSET UNITYSDK_OFFSET(0x12B68390)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONCLICKINSTALLBTN_OFFSET UNITYSDK_OFFSET(0x12B65D70)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONCLICKRIGHTMASK_OFFSET UNITYSDK_OFFSET(0x12B650E0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONCOMPONENTEDITOR_OFFSET UNITYSDK_OFFSET(0x12B665C0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12B64B60)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONDELETEBTN_OFFSET UNITYSDK_OFFSET(0x12B675D0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONDRAGEND_OFFSET UNITYSDK_OFFSET(0x12B68E00)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONDRAGITEM_OFFSET UNITYSDK_OFFSET(0x12B68530)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONDRAGSTART_OFFSET UNITYSDK_OFFSET(0x12B68D80)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONFILTERDROPCHANGE_OFFSET UNITYSDK_OFFSET(0x12B65850)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x12B69680)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x12B69820)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x12B64660)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x12B68FC0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONINPUTNAME_OFFSET UNITYSDK_OFFSET(0x12B674B0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONLONGPRESSBAGITEM_OFFSET UNITYSDK_OFFSET(0x12B68E80)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONOPENCOMPONENTSHOP_OFFSET UNITYSDK_OFFSET(0x12B67970)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONPACKAGECLEAR_OFFSET UNITYSDK_OFFSET(0x12B685D0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONPACKAGEENABLE_OFFSET UNITYSDK_OFFSET(0x12B67790)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONRENAMEBTN_OFFSET UNITYSDK_OFFSET(0x12B67160)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONRENAME_OFFSET UNITYSDK_OFFSET(0x12B68580)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONSELECTITEMTOEDITOR_OFFSET UNITYSDK_OFFSET(0x12B65F80)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONSERVERCONFRIMCOMPONENTINSTALL_OFFSET UNITYSDK_OFFSET(0x12B66800)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONTEMPLATEDROPCHANGE_OFFSET UNITYSDK_OFFSET(0x12B682C0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONTVTOUCHCLICKDOWN_OFFSET UNITYSDK_OFFSET(0x12B68990)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONTVTOUCHCLICKUP_OFFSET UNITYSDK_OFFSET(0x12B68CE0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONTVTOUCHDRAG_OFFSET UNITYSDK_OFFSET(0x12B688B0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12B64D80)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12B616E0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONUNINSTALLCOMPONENT_OFFSET UNITYSDK_OFFSET(0x12B686B0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_SETDATA_OFFSET UNITYSDK_OFFSET(0x12B62C20)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_SETSELECTCOMPONENTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x12B64750)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_SETTVTARGET_OFFSET UNITYSDK_OFFSET(0x12B640A0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_SHOWFILTERDROPDOWN_OFFSET UNITYSDK_OFFSET(0x12B67E50)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_SHOWTEMPLATEDROPDOWN_OFFSET UNITYSDK_OFFSET(0x12B67B50)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_UPDATECURRENTBAGM_OFFSET UNITYSDK_OFFSET(0x12B68700)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_UPDATEPAKAGETEMPLATEDESC_OFFSET UNITYSDK_OFFSET(0x12B64430)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0x12B628D0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x12B667C0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12B69890)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0x12B69C00)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER__ONUIINIT_B__1_1_OFFSET UNITYSDK_OFFSET(0x12B69C70)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12B69F60)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x12B69FF0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x12B6A080)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x12B6A110)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x12B6A1C0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12B6A1F0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12B6A280)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooDIYWidgetWidgetController_TypeDefinitionIndex = 40767;

	class UIBangbooDIYWidgetWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		// static const ::System::Int32 ShopId = 0x2; // 0x0
		::Class_2_79AE422BA06F6D26_49* _view; // 0x2B8
		::System::Int32 moveIndex; // 0x2C0
		::System::Boolean startMove; // 0x2C4
		::Class_2_F53404D9C01CAAB5* _data; // 0x2C8
		::System::Collections::Generic::List_1<::Class_1_2CB185F86C732591*>* grids; // 0x2D0
		::UnityEngine::UI::GridLayoutGroup* gridRoot; // 0x2D8
		::UnityEngine::UI::GridLayoutGroup* bagGrid; // 0x2E0
		::Class_1_A59025D696FD25CD* editorComponent; // 0x2E8
		::System::Collections::Generic::List_1<::MoleMole::UIBuddyDIYBagItemWidgetController*>* bagItems; // 0x2F0
		::MoleMole::UIGeneralDynamicTipsPopWindowController* _templateSelect; // 0x2F8
		::MoleMole::UIGeneralDynamicTipsPopWindowController* _filterSelect; // 0x300
		::System::Collections::Generic::List_1<::MoleMole::UIBuddyDIYComponentWidgetController*>* _diyComponentWidgetControllers; // 0x308
		::System::Collections::Generic::List_1<::Enum_3_D5E55949F51D9DD0>* _rarityTypes; // 0x310
		::System::Collections::Generic::List_1<::System::String*>* _rarityTextKey; // 0x318
		::Enum_3_D5E55949F51D9DD0 _filterType; // 0x320
		::System::Collections::Generic::List_1<::Class_1_A59025D696FD25CD*>* filterComponents; // 0x328
		::UIToWorldRTOutput* _uiToWorldRoot; // 0x330
		::UnityEngine::GameObject* tvScreen; // 0x338
		::Class_1_B2973E4A3ABA7D3E* _padNavigat; // 0x340
		::MoleMole::UIBuddyBagDragWidgetController* _dragWidget; // 0x348
		::MoleMole::UIBuddyDIYBagItemWidgetController* selectController; // 0x350
		::MoleMole::MonoGamepadCustomList* itemBagModule; // 0x358
