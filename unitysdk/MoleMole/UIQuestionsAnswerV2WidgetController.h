...
#define MOLEMOLE_UIQUESTIONSANSWERV2WIDGETCONTROLLER_CREATEUIQUESTIONSANSWERCARDITEMROWWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x13DFA460)
#define MOLEMOLE_UIQUESTIONSANSWERV2WIDGETCONTROLLER_CREATEUIQUESTIONSANSWERCHATPLAYWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x13DFA3B0)
#define MOLEMOLE_UIQUESTIONSANSWERV2WIDGETCONTROLLER_ENABLECHEETBUTTON_OFFSET UNITYSDK_OFFSET(0x13DFA510)
#define MOLEMOLE_UIQUESTIONSANSWERV2WIDGETCONTROLLER_GETBUFFTOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x13DFA5C0)
#define MOLEMOLE_UIQUESTIONSANSWERV2WIDGETCONTROLLER_GETBUFFVIEW_OFFSET UNITYSDK_OFFSET(0x13DFA610)
#define MOLEMOLE_UIQUESTIONSANSWERV2WIDGETCONTROLLER_GETSTARTBLACKTEXT_OFFSET UNITYSDK_OFFSET(0x13DFA550)
#define MOLEMOLE_UIQUESTIONSANSWERV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x13DFA6B0)
#define MOLEMOLE_UIQUESTIONSANSWERV2WIDGETCONTROLLER___BASE_CREATEUIQUESTIONSANSWERCARDITEMROWWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x13DFA9A0)
#define MOLEMOLE_UIQUESTIONSANSWERV2WIDGETCONTROLLER___BASE_CREATEUIQUESTIONSANSWERCHATPLAYWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x13DFAA60)
#define MOLEMOLE_UIQUESTIONSANSWERV2WIDGETCONTROLLER___BASE_ENABLECHEETBUTTON_OFFSET UNITYSDK_OFFSET(0x13DFAB20)
#define MOLEMOLE_UIQUESTIONSANSWERV2WIDGETCONTROLLER___BASE_GETBUFFTOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x13DFABA0)
#define MOLEMOLE_UIQUESTIONSANSWERV2WIDGETCONTROLLER___BASE_GETBUFFVIEW_OFFSET UNITYSDK_OFFSET(0x13DFAC40)
#define MOLEMOLE_UIQUESTIONSANSWERV2WIDGETCONTROLLER___BASE_GETSTARTBLACKTEXT_OFFSET UNITYSDK_OFFSET(0x13DFACE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerV2WidgetController_TypeDefinitionIndex = 47168;
