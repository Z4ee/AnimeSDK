...
#define MOLEMOLE_UIQUESTIONSANSWERV2WIDGETCONTROLLER_CREATEUIQUESTIONSANSWERCARDITEMROWWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x15605FF0)
#define MOLEMOLE_UIQUESTIONSANSWERV2WIDGETCONTROLLER_CREATEUIQUESTIONSANSWERCHATPLAYWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x15605F40)
#define MOLEMOLE_UIQUESTIONSANSWERV2WIDGETCONTROLLER_ENABLECHEETBUTTON_OFFSET UNITYSDK_OFFSET(0x156060A0)
#define MOLEMOLE_UIQUESTIONSANSWERV2WIDGETCONTROLLER_GETBUFFTOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x15606150)
#define MOLEMOLE_UIQUESTIONSANSWERV2WIDGETCONTROLLER_GETBUFFVIEW_OFFSET UNITYSDK_OFFSET(0x156061A0)
#define MOLEMOLE_UIQUESTIONSANSWERV2WIDGETCONTROLLER_GETSTARTBLACKTEXT_OFFSET UNITYSDK_OFFSET(0x156060E0)
#define MOLEMOLE_UIQUESTIONSANSWERV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15606240)
#define MOLEMOLE_UIQUESTIONSANSWERV2WIDGETCONTROLLER___BASE_CREATEUIQUESTIONSANSWERCARDITEMROWWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x15606530)
#define MOLEMOLE_UIQUESTIONSANSWERV2WIDGETCONTROLLER___BASE_CREATEUIQUESTIONSANSWERCHATPLAYWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x156065F0)
#define MOLEMOLE_UIQUESTIONSANSWERV2WIDGETCONTROLLER___BASE_ENABLECHEETBUTTON_OFFSET UNITYSDK_OFFSET(0x156066B0)
#define MOLEMOLE_UIQUESTIONSANSWERV2WIDGETCONTROLLER___BASE_GETBUFFTOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x15606730)
#define MOLEMOLE_UIQUESTIONSANSWERV2WIDGETCONTROLLER___BASE_GETBUFFVIEW_OFFSET UNITYSDK_OFFSET(0x156067D0)
#define MOLEMOLE_UIQUESTIONSANSWERV2WIDGETCONTROLLER___BASE_GETSTARTBLACKTEXT_OFFSET UNITYSDK_OFFSET(0x15606870)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerV2WidgetController_TypeDefinitionIndex = 56717;
