...
#define MOLEMOLE_UIHOUSERHYTHMVIEWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1488D5E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHouseRhythmViewContext_TypeDefinitionIndex = 78594;
