...
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTMAINTABWIDGETCONTROLLER_GETTAB_OFFSET UNITYSDK_OFFSET(0x191E7D80)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTMAINTABWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x191E7EB0)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTMAINTABWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x191E7F40)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTMAINTABWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x191E7DE0)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTMAINTABWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x191E7E40)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTMAINTABWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x191E7FC0)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTMAINTABWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x191E8020)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTMAINTABWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x191E80B0)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTMAINTABWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x191E8140)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTMAINTABWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x191E81D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityHotPotCollectMainTabWidgetController_TypeDefinitionIndex = 69150;
