...
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTMAINTABWIDGETCONTROLLER_GETTAB_OFFSET UNITYSDK_OFFSET(0x15E874E0)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTMAINTABWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15E87610)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTMAINTABWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15E876A0)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTMAINTABWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15E87540)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTMAINTABWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15E875A0)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTMAINTABWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15E87720)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTMAINTABWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15E87780)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTMAINTABWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15E87810)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTMAINTABWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15E878A0)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTMAINTABWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15E87930)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityHotPotCollectMainTabWidgetController_TypeDefinitionIndex = 57541;

	class UIActivityHotPotCollectMainTabWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_989B2E952320ACB1* _view; // 0x2B8
