...
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER___C__DISPLAYCLASS71_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1938E9F0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER___C__DISPLAYCLASS71_1__ONRECEIVEFRIENDCHATLIST_B__1_OFFSET UNITYSDK_OFFSET(0x1938EA00)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendChatPopWindowController___c__DisplayClass71_1_TypeDefinitionIndex = 66607;
