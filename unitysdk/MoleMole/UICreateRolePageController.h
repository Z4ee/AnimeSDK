...
#define MOLEMOLE_UICREATEROLEPAGECONTROLLER_BINDEVENT_OFFSET UNITYSDK_OFFSET(0x16CAD5B0)
#define MOLEMOLE_UICREATEROLEPAGECONTROLLER_CHECCKSELECT_OFFSET UNITYSDK_OFFSET(0x16CADC00)
#define MOLEMOLE_UICREATEROLEPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x16CACD10)
#define MOLEMOLE_UICREATEROLEPAGECONTROLLER_GET_MESSAGEMATCHPAGE_OFFSET UNITYSDK_OFFSET(0x16CACDB0)
#define MOLEMOLE_UICREATEROLEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x16CACD00)
#define MOLEMOLE_UICREATEROLEPAGECONTROLLER_ONCONFRIMMAN_OFFSET UNITYSDK_OFFSET(0x16CAD2C0)
#define MOLEMOLE_UICREATEROLEPAGECONTROLLER_ONCONFRIMWOMAN_OFFSET UNITYSDK_OFFSET(0x16CADEB0)
#define MOLEMOLE_UICREATEROLEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16CACD20)
#define MOLEMOLE_UICREATEROLEPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16CACEA0)
#define MOLEMOLE_UICREATEROLEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16CADAF0)
#define MOLEMOLE_UICREATEROLEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16CAD380)
#define MOLEMOLE_UICREATEROLEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16CACDC0)
#define MOLEMOLE_UICREATEROLEPAGECONTROLLER_OPENINPUTNAMEVIEW_OFFSET UNITYSDK_OFFSET(0x16CADF20)
#define MOLEMOLE_UICREATEROLEPAGECONTROLLER_PLAYSPLITVIDEO_OFFSET UNITYSDK_OFFSET(0x16CAD0F0)
#define MOLEMOLE_UICREATEROLEPAGECONTROLLER_RESETCLICKSTATE_OFFSET UNITYSDK_OFFSET(0x16CAE010)
#define MOLEMOLE_UICREATEROLEPAGECONTROLLER_SETCONFIG_OFFSET UNITYSDK_OFFSET(0x16CAD330)
#define MOLEMOLE_UICREATEROLEPAGECONTROLLER_SHOWROLENPCNAME_OFFSET UNITYSDK_OFFSET(0x16CAD890)
#define MOLEMOLE_UICREATEROLEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16CAE080)
#define MOLEMOLE_UICREATEROLEPAGECONTROLLER__PLAYSPLITVIDEO_B__10_1_OFFSET UNITYSDK_OFFSET(0x16CAE1D0)
#define MOLEMOLE_UICREATEROLEPAGECONTROLLER__PLAYSPLITVIDEO_G__ONVIDEOSTART_10_0_OFFSET UNITYSDK_OFFSET(0x16CAE130)
#define MOLEMOLE_UICREATEROLEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16CAE240)
#define MOLEMOLE_UICREATEROLEPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16CAE2D0)
#define MOLEMOLE_UICREATEROLEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16CAE2E0)
#define MOLEMOLE_UICREATEROLEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16CAE2F0)
#define MOLEMOLE_UICREATEROLEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16CAE300)

namespace MoleMole
{
	inline static constexpr unsigned int UICreateRolePageController_TypeDefinitionIndex = 55284;
	...
	public:
		...
		::Class_2_79F6D62CE30E3F8E_114* _view; // 0x310
		::System::Collections::Generic::List_1<::System::Object*>* options; // 0x318
		::System::Boolean _isInputName; // 0x320
		::System::String* _inputName; // 0x328
		::System::Int32 _curStartVideo; // 0x330
		::MoleMole::UIVideoWidgetController* fullScreen; // 0x338
		::System::Boolean isClickSelect; // 0x340
		::Class_2_30798CA871D0A37F* _procedureConfig; // 0x348
		::System::Int32 _selectTag; // 0x350
		::System::Int32 _beforeSelect; // 0x354
		::Class_1_E9529ED64113E4E9* rightVideo; // 0x358
		::Class_1_E9529ED64113E4E9* leftVideo; // 0x360
		::System::String* left_url; // 0x368
		::System::String* right_url; // 0x370
		...
		::System::Void SetConfig(::Class_2_30798CA871D0A37F* config)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_30798CA871D0A37F*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICREATEROLEPAGECONTROLLER_SETCONFIG_OFFSET))(this, config);
		}
