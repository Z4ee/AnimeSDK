...
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x19301CA0)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_GOMAIN_OFFSET UNITYSDK_OFFSET(0x19303170)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_ONBABELRANKSELECT_OFFSET UNITYSDK_OFFSET(0x19303260)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_ONBABELTOWERUPDATERANK_OFFSET UNITYSDK_OFFSET(0x19304020)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19301CB0)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19302720)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19301D40)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19302810)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_OPENINFO_OFFSET UNITYSDK_OFFSET(0x193036B0)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_REFRESHAVATARLIST_OFFSET UNITYSDK_OFFSET(0x19303780)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0x19303300)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_REFRESHTIME_OFFSET UNITYSDK_OFFSET(0x19303CB0)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_REFRESHTITLE_OFFSET UNITYSDK_OFFSET(0x193023B0)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x19302930)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x19304070)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x193040C0)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER__ONUIINIT_B__10_0_OFFSET UNITYSDK_OFFSET(0x193040D0)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER__ONUIINIT_B__10_1_OFFSET UNITYSDK_OFFSET(0x193041D0)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER__REFRESHTIME_B__23_0_OFFSET UNITYSDK_OFFSET(0x19304250)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19304260)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x193042F0)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19304300)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19304310)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerRankPageController_TypeDefinitionIndex = 81339;
