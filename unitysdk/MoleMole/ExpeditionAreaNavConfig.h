...
#define MOLEMOLE_EXPEDITIONAREANAVCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x149824E0)

namespace MoleMole
{
	inline static constexpr unsigned int ExpeditionAreaNavConfig_TypeDefinitionIndex = 61941;
