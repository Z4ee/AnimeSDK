...
#define MOLEMOLE_UIINLEVELPAUSELONGFIGHTLEVELINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19C89140)
#define MOLEMOLE_UIINLEVELPAUSELONGFIGHTLEVELINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19C891D0)
#define MOLEMOLE_UIINLEVELPAUSELONGFIGHTLEVELINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19C88A80)
#define MOLEMOLE_UIINLEVELPAUSELONGFIGHTLEVELINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19C88AE0)
#define MOLEMOLE_UIINLEVELPAUSELONGFIGHTLEVELINFOWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x19C88B60)
#define MOLEMOLE_UIINLEVELPAUSELONGFIGHTLEVELINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19C89470)
#define MOLEMOLE_UIINLEVELPAUSELONGFIGHTLEVELINFOWIDGETCONTROLLER__GET_LEVELINFOTITLE_OFFSET UNITYSDK_OFFSET(0x19C89250)
#define MOLEMOLE_UIINLEVELPAUSELONGFIGHTLEVELINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19C89550)
#define MOLEMOLE_UIINLEVELPAUSELONGFIGHTLEVELINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19C895E0)
#define MOLEMOLE_UIINLEVELPAUSELONGFIGHTLEVELINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19C89670)
#define MOLEMOLE_UIINLEVELPAUSELONGFIGHTLEVELINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19C89700)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseLongFightLevelInfoWidgetController_TypeDefinitionIndex = 71011;
