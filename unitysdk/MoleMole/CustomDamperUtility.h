...
#define MOLEMOLE_CUSTOMDAMPERUTILITY_CRITICAL_FREQUENCY_OFFSET UNITYSDK_OFFSET(0x157DA160)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_CRITICAL_HALFLIFE_OFFSET UNITYSDK_OFFSET(0x157D9FF0)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DAMPER_1_OFFSET UNITYSDK_OFFSET(0x157D8D70)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DAMPER_OFFSET UNITYSDK_OFFSET(0x157D8BA0)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DAMPER_SPRING_CRITICAL_NOGOALSPEED_1_OFFSET UNITYSDK_OFFSET(0x157D9B70)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DAMPER_SPRING_CRITICAL_NOGOALSPEED_OFFSET UNITYSDK_OFFSET(0x157D99A0)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DAMPER_SPRING_CRITICAL_OFFSET UNITYSDK_OFFSET(0x157D9790)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DAMPER_SPRING_OFFSET UNITYSDK_OFFSET(0x157D8F60)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DAMPING_TO_HALFLIFE_OFFSET UNITYSDK_OFFSET(0x157DA100)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DOUBLE_SPRING_DAMPER_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x157D9F10)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DOUBLE_SPRING_DAMPER_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x157D9E00)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_FAST_NEGEXP_OFFSET UNITYSDK_OFFSET(0x157D8CE0)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_FREQUENCY_TO_STIFFNESS_OFFSET UNITYSDK_OFFSET(0x157D96B0)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_HALFLIFE_TO_DAMPING_OFFSET UNITYSDK_OFFSET(0x157D9730)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_SQUAREF_OFFSET UNITYSDK_OFFSET(0x157D8F10)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_STIFFNESS_TO_FREQUENCY_OFFSET UNITYSDK_OFFSET(0x157DA2B0)
#define MOLEMOLE_CUSTOMDAMPERUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x157DA320)

namespace MoleMole
{
	inline static constexpr unsigned int CustomDamperUtility_TypeDefinitionIndex = 50963;
