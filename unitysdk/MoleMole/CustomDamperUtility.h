...
#define MOLEMOLE_CUSTOMDAMPERUTILITY_CRITICAL_FREQUENCY_OFFSET UNITYSDK_OFFSET(0x175516F0)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_CRITICAL_HALFLIFE_OFFSET UNITYSDK_OFFSET(0x17551580)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DAMPER_1_OFFSET UNITYSDK_OFFSET(0x17550300)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DAMPER_OFFSET UNITYSDK_OFFSET(0x17550130)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DAMPER_SPRING_CRITICAL_NOGOALSPEED_1_OFFSET UNITYSDK_OFFSET(0x17551100)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DAMPER_SPRING_CRITICAL_NOGOALSPEED_OFFSET UNITYSDK_OFFSET(0x17550F30)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DAMPER_SPRING_CRITICAL_OFFSET UNITYSDK_OFFSET(0x17550D20)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DAMPER_SPRING_OFFSET UNITYSDK_OFFSET(0x175504F0)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DAMPING_TO_HALFLIFE_OFFSET UNITYSDK_OFFSET(0x17551690)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DOUBLE_SPRING_DAMPER_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x175514A0)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DOUBLE_SPRING_DAMPER_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x17551390)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_FAST_NEGEXP_OFFSET UNITYSDK_OFFSET(0x17550270)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_FREQUENCY_TO_STIFFNESS_OFFSET UNITYSDK_OFFSET(0x17550C40)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_HALFLIFE_TO_DAMPING_OFFSET UNITYSDK_OFFSET(0x17550CC0)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_SQUAREF_OFFSET UNITYSDK_OFFSET(0x175504A0)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_STIFFNESS_TO_FREQUENCY_OFFSET UNITYSDK_OFFSET(0x17551840)
#define MOLEMOLE_CUSTOMDAMPERUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x175518B0)

namespace MoleMole
{
	inline static constexpr unsigned int CustomDamperUtility_TypeDefinitionIndex = 49078;
