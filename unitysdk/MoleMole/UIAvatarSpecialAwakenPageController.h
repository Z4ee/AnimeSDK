...
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER_CREATEBTNROW_OFFSET UNITYSDK_OFFSET(0x176C3FB0)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x176C3BD0)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x176C3BE0)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x176C3C50)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x176C4070)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x176C3D10)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER_RESETSHOWCONTEXT_OFFSET UNITYSDK_OFFSET(0x176C3EE0)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER_SETSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x176C3D60)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x176C43C0)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x176C43D0)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x176C4470)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x176C4480)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarSpecialAwakenPageController_TypeDefinitionIndex = 81132;
