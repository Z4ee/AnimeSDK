...
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER_CREATEBTNROW_OFFSET UNITYSDK_OFFSET(0x18BF2400)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x18BF2020)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18BF2030)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18BF20A0)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18BF24C0)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18BF2160)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER_RESETSHOWCONTEXT_OFFSET UNITYSDK_OFFSET(0x18BF2330)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER_SETSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x18BF21B0)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18BF2810)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18BF2820)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18BF28C0)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18BF28D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarSpecialAwakenPageController_TypeDefinitionIndex = 87580;

	class UIAvatarSpecialAwakenPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_1824EF69C8E376A3* m_avatarItemData; // 0x318
		...
		::Class_3_C301626F1864278D* get__viewModel()
		{
			return ((::Class_3_C301626F1864278D*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
