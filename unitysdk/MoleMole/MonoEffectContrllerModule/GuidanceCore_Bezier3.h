...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCECORE_BEZIER3_GENERATEPATH_OFFSET UNITYSDK_OFFSET(0x10BCE810)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCECORE_BEZIER3__CTOR_OFFSET UNITYSDK_OFFSET(0x10BCF430)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCECORE_BEZIER3___BASE_GENERATEPATH_OFFSET UNITYSDK_OFFSET(0x10BCF450)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int GuidanceCore_Bezier3_TypeDefinitionIndex = 51394;
