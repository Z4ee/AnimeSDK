...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_PREVIEWMODULE_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x15E46EB0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_PREVIEWMODULE_ONCREATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x15E46DA0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_PREVIEWMODULE_ONDESTROYCONTROLLER_OFFSET UNITYSDK_OFFSET(0x15E46DF0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_PREVIEWMODULE_ONUPDATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x15E46E40)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_PREVIEWMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x15E46E90)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int PreviewModule_TypeDefinitionIndex = 64726;
