...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_PREVIEWMODULE_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x191A5420)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_PREVIEWMODULE_ONCREATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x191A5310)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_PREVIEWMODULE_ONDESTROYCONTROLLER_OFFSET UNITYSDK_OFFSET(0x191A5360)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_PREVIEWMODULE_ONUPDATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x191A53B0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_PREVIEWMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x191A5400)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int PreviewModule_TypeDefinitionIndex = 64419;
