...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_EXECUTEFRAGMENT_OFFSET UNITYSDK_OFFSET(0x86C070)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_EXECUTEFRAGMENT_RECURSION_OFFSET UNITYSDK_OFFSET(0x86C080)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_GENERATEDNEXTFRAGMENT_OFFSET UNITYSDK_OFFSET(0x86C0A0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_GETCURBULLETPOSITION_OFFSET UNITYSDK_OFFSET(0x86C040)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_INITNEXTFRAGMENT_OFFSET UNITYSDK_OFFSET(0x86C090)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_ONCREATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x86BF10)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_ONDESTROYCONTROLLER_OFFSET UNITYSDK_OFFSET(0x86BF20)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_ONUPDATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x86BF90)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_PROCESSGUIDANCEMOVE_OFFSET UNITYSDK_OFFSET(0x86C000)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_PROCESSRUNTIMETRACKMOVE_OFFSET UNITYSDK_OFFSET(0x86C030)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_PROCESSRUNTIMETRACK_FIXEDSPEED_OFFSET UNITYSDK_OFFSET(0x86C0E0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_PROCESSRUNTIMETRACK_IMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x86C0F0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_PROCESSTRACK_OFFSET UNITYSDK_OFFSET(0x86C010)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_SYNCPOSITIONFROMBULLET_OFFSET UNITYSDK_OFFSET(0x86BFF0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_TRACEDATA_OFFSET UNITYSDK_OFFSET(0x86C060)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_UPDATETRACKSTATE_OFFSET UNITYSDK_OFFSET(0x86C020)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int TraceModule_TypeDefinitionIndex = 76484;
