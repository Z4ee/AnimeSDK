...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_APPLYINERTIALVELOCITY_OFFSET UNITYSDK_OFFSET(0x19DD07D0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_EXECUTEFRAGMENT_OFFSET UNITYSDK_OFFSET(0x8AC7F0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_EXECUTEFRAGMENT_RECURSION_OFFSET UNITYSDK_OFFSET(0x8AC800)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_GENERATEDNEXTFRAGMENT_OFFSET UNITYSDK_OFFSET(0x8AC820)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_GETCURBULLETPOSITION_OFFSET UNITYSDK_OFFSET(0x8AC7C0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_INITNEXTFRAGMENT_OFFSET UNITYSDK_OFFSET(0x8AC810)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_ONCREATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x8AC690)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_ONDESTROYCONTROLLER_OFFSET UNITYSDK_OFFSET(0x8AC6A0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_ONUPDATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x8AC710)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_PROCESSGUIDANCEMOVE_OFFSET UNITYSDK_OFFSET(0x8AC780)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_PROCESSRUNTIMETRACKMOVE_OFFSET UNITYSDK_OFFSET(0x8AC7B0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_PROCESSRUNTIMETRACK_FIXEDSPEED_OFFSET UNITYSDK_OFFSET(0x8AC860)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_PROCESSRUNTIMETRACK_IMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x8AC870)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_PROCESSTRACK_OFFSET UNITYSDK_OFFSET(0x8AC790)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_SYNCPOSITIONFROMBULLET_OFFSET UNITYSDK_OFFSET(0x8AC770)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_TRACEDATA_OFFSET UNITYSDK_OFFSET(0x8AC7E0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_UPDATETRACKSTATE_OFFSET UNITYSDK_OFFSET(0x8AC7A0)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int TraceModule_TypeDefinitionIndex = 47456;
	...
	struct alignas(8) TraceModule
	{
		...
		/*
		static ::System::Void ApplyInertialVelocity(::Struct_2_24DBEDA547C4BE1D& context, ::UnityEngine::ParticleSystem_Particle& particle)
		{
			return ((::System::Void(*)(::Struct_2_24DBEDA547C4BE1D&, ::UnityEngine::ParticleSystem_Particle&))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_APPLYINERTIALVELOCITY_OFFSET))(context, particle);
		}
		*/
