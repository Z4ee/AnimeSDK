...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEGROUPCONFIG_ONCREATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x142A4990)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEGROUPCONFIG_ONDESTROYCONTROLLER_OFFSET UNITYSDK_OFFSET(0x142A4A10)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEGROUPCONFIG_ONUPDATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x142A4AB0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x142A4BA0)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int TraceGroupConfig_TypeDefinitionIndex = 76728;
