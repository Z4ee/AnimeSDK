...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_MONOEFFECTPLUGINCONTROLLER_CLASS_3_913B648DA43C02EE_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x154319C0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_MONOEFFECTPLUGINCONTROLLER_CLASS_3_913B648DA43C02EE_READMEMBER_OFFSET UNITYSDK_OFFSET(0x154319D0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_MONOEFFECTPLUGINCONTROLLER_CLASS_3_913B648DA43C02EE_WRITE_OFFSET UNITYSDK_OFFSET(0x15431B00)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_MONOEFFECTPLUGINCONTROLLER_CLASS_3_913B648DA43C02EE__CCTOR_OFFSET UNITYSDK_OFFSET(0x15431C40)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_MONOEFFECTPLUGINCONTROLLER_CLASS_3_913B648DA43C02EE__CTOR_OFFSET UNITYSDK_OFFSET(0x15431C00)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int MonoEffectPluginController_Class_3_913B648DA43C02EE_TypeDefinitionIndex = 53125;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::MonoEffectContrllerModule::SetupModule>**)Il2CppClass::FromTypeDefinitionIndex(MonoEffectPluginController_Class_3_913B648DA43C02EE_TypeDefinitionIndex)->GetStaticField(0x34C40);
		}
