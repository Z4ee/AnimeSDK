...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCECORE_BEZIERCUSTOM_GENERATEPATH_OFFSET UNITYSDK_OFFSET(0x17822D10)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCECORE_BEZIERCUSTOM__CTOR_OFFSET UNITYSDK_OFFSET(0x17822FB0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCECORE_BEZIERCUSTOM___BASE_GENERATEPATH_OFFSET UNITYSDK_OFFSET(0x17822FC0)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int GuidanceCore_BezierCustom_TypeDefinitionIndex = 42557;
