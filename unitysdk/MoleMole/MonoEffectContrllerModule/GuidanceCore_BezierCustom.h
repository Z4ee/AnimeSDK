...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCECORE_BEZIERCUSTOM_GENERATEPATH_OFFSET UNITYSDK_OFFSET(0x18301160)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCECORE_BEZIERCUSTOM__CTOR_OFFSET UNITYSDK_OFFSET(0x18301400)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCECORE_BEZIERCUSTOM___BASE_GENERATEPATH_OFFSET UNITYSDK_OFFSET(0x18301410)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int GuidanceCore_BezierCustom_TypeDefinitionIndex = 61896;
