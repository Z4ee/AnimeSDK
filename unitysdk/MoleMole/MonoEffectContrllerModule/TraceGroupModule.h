...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEGROUPMODULE_ONCREATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x74CA90)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEGROUPMODULE_ONDESTROYCONTROLLER_OFFSET UNITYSDK_OFFSET(0x74CAA0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEGROUPMODULE_ONUPDATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x74CB10)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int TraceGroupModule_TypeDefinitionIndex = 66143;
