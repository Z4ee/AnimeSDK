...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEGROUPMODULE_ONCREATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x7A3430)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEGROUPMODULE_ONDESTROYCONTROLLER_OFFSET UNITYSDK_OFFSET(0x7A3440)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEGROUPMODULE_ONUPDATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x7A34B0)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int TraceGroupModule_TypeDefinitionIndex = 51675;
