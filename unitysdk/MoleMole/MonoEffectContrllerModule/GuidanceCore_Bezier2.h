...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCECORE_BEZIER2_GENERATEPATH_OFFSET UNITYSDK_OFFSET(0x17383E30)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCECORE_BEZIER2__CTOR_OFFSET UNITYSDK_OFFSET(0x17383FF0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCECORE_BEZIER2___BASE_GENERATEPATH_OFFSET UNITYSDK_OFFSET(0x17384000)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int GuidanceCore_Bezier2_TypeDefinitionIndex = 55395;
