...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCECORE_BEZIER2_GENERATEPATH_OFFSET UNITYSDK_OFFSET(0x1302A530)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCECORE_BEZIER2__CTOR_OFFSET UNITYSDK_OFFSET(0x1302A6F0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCECORE_BEZIER2___BASE_GENERATEPATH_OFFSET UNITYSDK_OFFSET(0x1302A700)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int GuidanceCore_Bezier2_TypeDefinitionIndex = 62291;
