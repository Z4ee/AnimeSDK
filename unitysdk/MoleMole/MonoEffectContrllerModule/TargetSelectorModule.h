...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TARGETSELECTORMODULE_METHOD_2_5C3FF0B49C55F5F0_OFFSET UNITYSDK_OFFSET(0x6F6100)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TARGETSELECTORMODULE_METHOD_2_5DB6065F6B429689_OFFSET UNITYSDK_OFFSET(0x6F60F0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TARGETSELECTORMODULE_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x6F6120)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TARGETSELECTORMODULE_ONCREATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x6F5F60)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TARGETSELECTORMODULE_ONDESTROYCONTROLLER_OFFSET UNITYSDK_OFFSET(0x6F5FF0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TARGETSELECTORMODULE_ONUPDATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x6F60A0)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int TargetSelectorModule_TypeDefinitionIndex = 54152;

	struct alignas(8) TargetSelectorModule
	{
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_253*>* FeatureTargets; // 0x10
		::Class_0_16E4307DCC419505_253* MainTarget; // 0x18
		...
		::Class_0_16E4307DCC419505_253* Method_2_5DB6065F6B429689()
		{
			return ((::Class_0_16E4307DCC419505_253*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TARGETSELECTORMODULE_METHOD_2_5DB6065F6B429689_OFFSET))(this);
		}
