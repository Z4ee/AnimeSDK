...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCEMODULE_GETCURRENTCONFIG_OFFSET UNITYSDK_OFFSET(0x7CF1E0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCEMODULE_INIT_OFFSET UNITYSDK_OFFSET(0x7CF1A0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCEMODULE_ONCREATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x7CF260)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCEMODULE_ONDESTROYCONTROLLER_OFFSET UNITYSDK_OFFSET(0x7CF270)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCEMODULE_ONUPDATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x7CF350)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int GuidanceModule_TypeDefinitionIndex = 53708;
