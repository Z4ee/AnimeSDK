...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_ENDSHAPE_SAMPLEPOINT_OFFSET UNITYSDK_OFFSET(0x7F92C0)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int EndShape_TypeDefinitionIndex = 62219;
