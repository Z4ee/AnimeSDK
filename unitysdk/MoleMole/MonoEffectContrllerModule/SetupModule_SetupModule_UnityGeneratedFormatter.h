...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_SETUPMODULE_SETUPMODULE_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x15E46EF0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_SETUPMODULE_SETUPMODULE_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x15E46F00)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_SETUPMODULE_SETUPMODULE_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x15E46F70)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_SETUPMODULE_SETUPMODULE_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x15E46FC0)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int SetupModule_SetupModule_UnityGeneratedFormatter_TypeDefinitionIndex = 43532;
