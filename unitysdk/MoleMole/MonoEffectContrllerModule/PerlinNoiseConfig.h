...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_PERLINNOISECONFIG_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x15431E70)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_PERLINNOISECONFIG_NOISEPOINT_OFFSET UNITYSDK_OFFSET(0x15431CA0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_PERLINNOISECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x154320B0)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int PerlinNoiseConfig_TypeDefinitionIndex = 79330;
