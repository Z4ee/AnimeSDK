...
#define MOLEMOLE_UIGRANDMARCELRULEDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x167ADE70)
#define MOLEMOLE_UIGRANDMARCELRULEDIALOGPOPWINDOWCONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0x167B04D0)
#define MOLEMOLE_UIGRANDMARCELRULEDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x167AFF50)
#define MOLEMOLE_UIGRANDMARCELRULEDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x167AFFE0)
#define MOLEMOLE_UIGRANDMARCELRULEDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x167ADE80)
#define MOLEMOLE_UIGRANDMARCELRULEDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x167AE140)
#define MOLEMOLE_UIGRANDMARCELRULEDIALOGPOPWINDOWCONTROLLER_REFRESHRANKRULEPANEL_OFFSET UNITYSDK_OFFSET(0x167B0060)
#define MOLEMOLE_UIGRANDMARCELRULEDIALOGPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x167AE200)
#define MOLEMOLE_UIGRANDMARCELRULEDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x167B0530)
#define MOLEMOLE_UIGRANDMARCELRULEDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x167B06E0)
#define MOLEMOLE_UIGRANDMARCELRULEDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x167B0770)
#define MOLEMOLE_UIGRANDMARCELRULEDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x167B0780)
#define MOLEMOLE_UIGRANDMARCELRULEDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x167B0790)

namespace MoleMole
{
	inline static constexpr unsigned int UIGrandMarcelRuleDialogPopWindowController_TypeDefinitionIndex = 51755;

	class UIGrandMarcelRuleDialogPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_7B15B3118FE590CD_18* _view; // 0x318
		...
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_872*>* _curRaceConfigs; // 0x330
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_872*>* _curSurviveConfigs; // 0x338
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_872*>* _rankType1Configs; // 0x340
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_872*>* _rankType2Configs; // 0x348
