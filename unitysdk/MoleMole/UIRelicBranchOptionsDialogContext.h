...
#define MOLEMOLE_UIRELICBRANCHOPTIONSDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x14D66980)

namespace MoleMole
{
	inline static constexpr unsigned int UIRelicBranchOptionsDialogContext_TypeDefinitionIndex = 70078;
