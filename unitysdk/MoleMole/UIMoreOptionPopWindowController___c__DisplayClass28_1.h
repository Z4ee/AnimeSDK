...
#define MOLEMOLE_UIMOREOPTIONPOPWINDOWCONTROLLER___C__DISPLAYCLASS28_1__CTOR_OFFSET UNITYSDK_OFFSET(0x14D4FF90)
#define MOLEMOLE_UIMOREOPTIONPOPWINDOWCONTROLLER___C__DISPLAYCLASS28_1__OPENCOLLECTIONCABINETPAGE_B__3_OFFSET UNITYSDK_OFFSET(0x14D4FFA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMoreOptionPopWindowController___c__DisplayClass28_1_TypeDefinitionIndex = 42127;
