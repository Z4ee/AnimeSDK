...
#define MOLEMOLE_UIAVATARRANKROWWIDGETCONTROLLER_ONCLICKGETBTN_OFFSET UNITYSDK_OFFSET(0x14BD70B0)
#define MOLEMOLE_UIAVATARRANKROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14BD62B0)
#define MOLEMOLE_UIAVATARRANKROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x14BD63C0)
#define MOLEMOLE_UIAVATARRANKROWWIDGETCONTROLLER_ONTAKERAWARDHANDLE_OFFSET UNITYSDK_OFFSET(0x14BD7240)
#define MOLEMOLE_UIAVATARRANKROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14BD6340)
#define MOLEMOLE_UIAVATARRANKROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14BD60F0)
#define MOLEMOLE_UIAVATARRANKROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x14BD65F0)
#define MOLEMOLE_UIAVATARRANKROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14BD72F0)
#define MOLEMOLE_UIAVATARRANKROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14BD7380)
#define MOLEMOLE_UIAVATARRANKROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x14BD73D0)
#define MOLEMOLE_UIAVATARRANKROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14BD7470)
#define MOLEMOLE_UIAVATARRANKROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14BD74B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarRankRowWidgetController_TypeDefinitionIndex = 40080;
	...
	public:
		...
		::Class_2_208CC9941471731A_640* rankCfg; // 0x2F8
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_29*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIAVATARRANKROWWIDGETCONTROLLER_ONTAKERAWARDHANDLE_OFFSET))(this, rcvMessage);
		}
