...
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGOPENCARDWIDGETCONTROLLER_GETBADGEMAP_OFFSET UNITYSDK_OFFSET(0x15CB5180)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGOPENCARDWIDGETCONTROLLER_GETCARDLIST_OFFSET UNITYSDK_OFFSET(0x15CB55D0)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGOPENCARDWIDGETCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x15CB4780)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGOPENCARDWIDGETCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15CB4790)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGOPENCARDWIDGETCONTROLLER_INITTABLIST_OFFSET UNITYSDK_OFFSET(0x15CB4BC0)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGOPENCARDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15CB49B0)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGOPENCARDWIDGETCONTROLLER_ONTABCLICK_OFFSET UNITYSDK_OFFSET(0x15CB5660)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGOPENCARDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15CB47A0)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGOPENCARDWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15CB4A40)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGOPENCARDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15CB58D0)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGOPENCARDWIDGETCONTROLLER__ONUIINIT_B__5_0_OFFSET UNITYSDK_OFFSET(0x15CB5B10)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGOPENCARDWIDGETCONTROLLER__ONUIINIT_B__5_1_OFFSET UNITYSDK_OFFSET(0x15CB5BF0)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGOPENCARDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15CB5CD0)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGOPENCARDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15CB5D60)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGOPENCARDWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15CB5D70)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowAchievementDialogOpenCardWidgetController_TypeDefinitionIndex = 80194;

	class UIHollowAchievementDialogOpenCardWidgetController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_36134FF29855BCB0* _view; // 0x310
		::MoleMole::UIHollowAchievementCardWidgetV2WidgetController* widget; // 0x318
		::System::Collections::Generic::List_1<::Class_1_0D6706375CDAAE8C*>* currentSelectList; // 0x320
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::List_1<::Class_1_0D6706375CDAAE8C*>*>* badgeMap; // 0x328
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::UIBadgeItemIconWidgetChildWindowController*>* currentRenderBadegtItem; // 0x330
		::System::Collections::Generic::List_1<::System::String*>* badgeTypeList; // 0x338
		::UnityEngine::UI::Extension::UITabButtonGroup* tabBtns; // 0x340
		::System::Collections::Generic::List_1<::Class_1_0D6706375CDAAE8C*>* cardList; // 0x348
		::System::Int32 questID; // 0x350
		::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::UI::Extension::UITabButton*>* typeTabs; // 0x358
