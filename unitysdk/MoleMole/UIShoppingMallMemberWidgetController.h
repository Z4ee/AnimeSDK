...
#define MOLEMOLE_UISHOPPINGMALLMEMBERWIDGETCONTROLLER_CLICKSHOWRULE_OFFSET UNITYSDK_OFFSET(0x160DDA70)
#define MOLEMOLE_UISHOPPINGMALLMEMBERWIDGETCONTROLLER_ONCLICKBUY_OFFSET UNITYSDK_OFFSET(0x160DDB90)
#define MOLEMOLE_UISHOPPINGMALLMEMBERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x160DD7C0)
#define MOLEMOLE_UISHOPPINGMALLMEMBERWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x160DE040)
#define MOLEMOLE_UISHOPPINGMALLMEMBERWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x160DD850)
#define MOLEMOLE_UISHOPPINGMALLMEMBERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x160DD9F0)
#define MOLEMOLE_UISHOPPINGMALLMEMBERWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x160DCC10)
#define MOLEMOLE_UISHOPPINGMALLMEMBERWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x160DCFF0)
#define MOLEMOLE_UISHOPPINGMALLMEMBERWIDGETCONTROLLER_SHOWITEMTIPS_OFFSET UNITYSDK_OFFSET(0x160DDCE0)
#define MOLEMOLE_UISHOPPINGMALLMEMBERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x160DE390)
#define MOLEMOLE_UISHOPPINGMALLMEMBERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x160DE3F0)
#define MOLEMOLE_UISHOPPINGMALLMEMBERWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x160DE480)
#define MOLEMOLE_UISHOPPINGMALLMEMBERWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x160DE4B0)
#define MOLEMOLE_UISHOPPINGMALLMEMBERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x160DE540)
#define MOLEMOLE_UISHOPPINGMALLMEMBERWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x160DE5D0)
#define MOLEMOLE_UISHOPPINGMALLMEMBERWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x160DE660)

namespace MoleMole
{
	inline static constexpr unsigned int UIShoppingMallMemberWidgetController_TypeDefinitionIndex = 81626;
	...
	public:
		...
		::Class_0_16E4307DCC419505_180* data; // 0x2D8
