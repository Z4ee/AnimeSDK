...
#define MOLEMOLE_UIACTIVITYHOTPOTCOMBATPAGECONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x11DA5BB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityHotPotCombatPageController_Context_TypeDefinitionIndex = 85109;
