...
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_AWAKE_OFFSET UNITYSDK_OFFSET(0x11085930)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_GETBGNODESBYLOCATION_OFFSET UNITYSDK_OFFSET(0x110887E0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_GETIMGDECOROOT_OFFSET UNITYSDK_OFFSET(0x1108A070)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_GETIMGMOVEVECTORWHENSPLITSCREEN_OFFSET UNITYSDK_OFFSET(0x11089FC0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_GETIMGOBJBYPART_OFFSET UNITYSDK_OFFSET(0x11087E30)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_GET_ASSETPATH_OFFSET UNITYSDK_OFFSET(0x11085910)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_GET_SELFGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x11087A70)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_GET_SELFRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x11087BF0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_INITBYSTYLECONFIG_OFFSET UNITYSDK_OFFSET(0x11086F10)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_ISPLAYINGANIMATION_OFFSET UNITYSDK_OFFSET(0x11088940)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_METHOD_7_20B279F6D0EB86A9_OFFSET UNITYSDK_OFFSET(0x1108A500)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_METHOD_7_342DC7A5BDA9FE13_OFFSET UNITYSDK_OFFSET(0x11086D20)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_METHOD_7_3BCF0226A6CDC13B_OFFSET UNITYSDK_OFFSET(0x11089170)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_METHOD_7_41782CE468D1B24D_OFFSET UNITYSDK_OFFSET(0x11086670)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_METHOD_7_62DABBB79241EF26_OFFSET UNITYSDK_OFFSET(0x1108A1A0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_METHOD_7_6E1B2E1E77EF6FF4_OFFSET UNITYSDK_OFFSET(0x1108A0F0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_METHOD_7_84D0BB0CCF9E43EA_OFFSET UNITYSDK_OFFSET(0x11086AF0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_METHOD_7_8542E37E74FDE1B5_OFFSET UNITYSDK_OFFSET(0x11088CF0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_METHOD_7_9C2166EC68C0CC08_OFFSET UNITYSDK_OFFSET(0x11086F80)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_METHOD_7_DAA4EEDAA322BB3A_OFFSET UNITYSDK_OFFSET(0x1108A5F0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x11087DE0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_RECORDNODESFORCURTAIN_OFFSET UNITYSDK_OFFSET(0x11089720)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_RESETCURTAINSTATETODEFAULT_OFFSET UNITYSDK_OFFSET(0x11089A50)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x11085BA0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_RESET_OFFSET UNITYSDK_OFFSET(0x11086EC0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_SAMESTYLE_OFFSET UNITYSDK_OFFSET(0x11087D80)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_SETIMAGELIST_OFFSET UNITYSDK_OFFSET(0x11087F70)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_SET_ASSETPATH_OFFSET UNITYSDK_OFFSET(0x11085920)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_SIMULATEANIMPROGRESSFOROUTER_OFFSET UNITYSDK_OFFSET(0x1108A010)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_STARTCOMICANIMATION_OFFSET UNITYSDK_OFFSET(0x11088990)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_STARTCURTAINANIMATION_OFFSET UNITYSDK_OFFSET(0x110899A0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_TRIGGERWHENSPLITSCREENFINISH_OFFSET UNITYSDK_OFFSET(0x110895F0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_UPDATETIME_OFFSET UNITYSDK_OFFSET(0x110859D0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1108A330)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT___BASE_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x1108A3B0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT___BASE_UPDATETIME_OFFSET UNITYSDK_OFFSET(0x1108A460)

namespace MoleMole::Comic
{
	inline static constexpr unsigned int MonoComicImgComponent_TypeDefinitionIndex = 52319;
