...
#define MOLEMOLE_COMIC_COMICBUBBLEIMGTYPEPICCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3D88B0)

namespace MoleMole::Comic
{
	inline static constexpr unsigned int ComicBubbleImgTypePicConfig_TypeDefinitionIndex = 32147;
