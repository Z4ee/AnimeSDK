...
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT_ENDPLAY_OFFSET UNITYSDK_OFFSET(0xF12CB50)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT_INITSHAKEITEMLIST_OFFSET UNITYSDK_OFFSET(0xF12CA30)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0xF12C830)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0xF12CA80)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT_STARTPLAY_OFFSET UNITYSDK_OFFSET(0xF12CBC0)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT_UPDATETIME_OFFSET UNITYSDK_OFFSET(0xF12CDA0)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xF12CE90)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT___BASE_ENDPLAY_OFFSET UNITYSDK_OFFSET(0xF12CEE0)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT___BASE_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0xF12CF70)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT___BASE_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0xF12D020)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT___BASE_STARTPLAY_OFFSET UNITYSDK_OFFSET(0xF12D0C0)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT___BASE_UPDATETIME_OFFSET UNITYSDK_OFFSET(0xF12D150)

namespace MoleMole::Comic
{
	inline static constexpr unsigned int RuntimeComicShakeEvent_TypeDefinitionIndex = 50891;

	class RuntimeComicShakeEvent : public ::MoleMole::Comic::RuntimeComicLogicEventBase
	{
	public:
		::UnityEngine::Timeline::ComicShakeEvent* Field_7_3; // 0x58
		::MoleMole::ConfigComicShakeData* Field_7_2; // 0x60
		::System::Collections::Generic::List_1<::UnityEngine::RectTransform*>* Field_7_1; // 0x68
		::Class_1_F59E313BD7302AC0* Field_7_0; // 0x70
