...
#define MOLEMOLE_COMIC_UTIL_COMICIMGSTYLECONFIGEXTENSION_MATCHCOMICIMGPARTTYPE_OFFSET UNITYSDK_OFFSET(0x1DFA5E90)
#define MOLEMOLE_COMIC_UTIL_COMICIMGSTYLECONFIGEXTENSION_TONAME_OFFSET UNITYSDK_OFFSET(0x1DFA5E40)

namespace MoleMole::Comic::Util
{
	inline static constexpr unsigned int ComicImgStyleConfigExtension_TypeDefinitionIndex = 32153;
