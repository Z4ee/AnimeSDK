...
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_CLASS_1_CFCD595834949C8D_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B53B030)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_CLASS_1_CFCD595834949C8D_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B53B2D0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_CLASS_1_CFCD595834949C8D_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B53B330)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_CLASS_1_CFCD595834949C8D_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B53B2E0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_CLASS_1_CFCD595834949C8D_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B53B020)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_CLASS_1_CFCD595834949C8D__CTOR_OFFSET UNITYSDK_OFFSET(0x1B53B010)

namespace MoleMole::Comic
{
	inline static constexpr unsigned int MonoComicBubble_Class_1_CFCD595834949C8D_TypeDefinitionIndex = 71736;

	class MonoComicBubble_Class_1_CFCD595834949C8D : public ::System::Object
	{
	public:
		::UnityEngine::Timeline::BubbleEvent* Field_1_7; // 0x10
		::MoleMole::Comic::MonoComicBubble* Field_1_0; // 0x18
