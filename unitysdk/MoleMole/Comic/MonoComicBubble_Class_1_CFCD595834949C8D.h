...
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_CLASS_1_CFCD595834949C8D_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x12D18CC0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_CLASS_1_CFCD595834949C8D_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x12D18F60)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_CLASS_1_CFCD595834949C8D_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x12D18FC0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_CLASS_1_CFCD595834949C8D_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x12D18F70)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_CLASS_1_CFCD595834949C8D_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x12D18CB0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_CLASS_1_CFCD595834949C8D__CTOR_OFFSET UNITYSDK_OFFSET(0x12D18CA0)

namespace MoleMole::Comic
{
	inline static constexpr unsigned int MonoComicBubble_Class_1_CFCD595834949C8D_TypeDefinitionIndex = 81332;
