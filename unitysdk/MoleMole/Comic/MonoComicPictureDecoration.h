...
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_AWAKE_OFFSET UNITYSDK_OFFSET(0x17D335F0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_EDITORAWAKE_OFFSET UNITYSDK_OFFSET(0x17D34ED0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_GETFADEINANIMTIME_OFFSET UNITYSDK_OFFSET(0x17D34860)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_GETPICRECTTRANS_OFFSET UNITYSDK_OFFSET(0x17D34E20)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_INITINEDITOR_OFFSET UNITYSDK_OFFSET(0x17D35030)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0x17D33730)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_METHOD_7_0EFA57F70A2452C7_OFFSET UNITYSDK_OFFSET(0x17D33840)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_METHOD_7_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x17D34720)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_METHOD_7_479759059E440327_1_OFFSET UNITYSDK_OFFSET(0x17D34610)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_METHOD_7_479759059E440327_OFFSET UNITYSDK_OFFSET(0x17D34550)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_METHOD_7_6AF96BBFE90AF125_OFFSET UNITYSDK_OFFSET(0x17D33AE0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_METHOD_7_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0x17D34AC0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_METHOD_7_F4F1E7D1CC26024A_OFFSET UNITYSDK_OFFSET(0x17D34010)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_METHOD_7_F9D8AF4B91BAC175_OFFSET UNITYSDK_OFFSET(0x17D34C70)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_PLAYEXIT_OFFSET UNITYSDK_OFFSET(0x17D34A10)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_PLAYFADEINANIM_OFFSET UNITYSDK_OFFSET(0x17D341A0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x17D33DF0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_SETWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x17D33C90)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_SIMULATEANIMPROGRESSFOROUTER_OFFSET UNITYSDK_OFFSET(0x17D34E70)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_STARTPLAY_OFFSET UNITYSDK_OFFSET(0x17D33E40)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_UPDATETIME_OFFSET UNITYSDK_OFFSET(0x17D34350)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION__CTOR_OFFSET UNITYSDK_OFFSET(0x17D350B0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION___BASE_GETFADEINANIMTIME_OFFSET UNITYSDK_OFFSET(0x17D35100)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION___BASE_GETFADEOUTTIME_OFFSET UNITYSDK_OFFSET(0x17D35190)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION___BASE_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0x17D35220)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION___BASE_JUMPTOFINAL_OFFSET UNITYSDK_OFFSET(0x17D35230)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION___BASE_PLAYFADEINANIM_OFFSET UNITYSDK_OFFSET(0x17D352C0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION___BASE_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x17D35350)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION___BASE_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x17D353E0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION___BASE_STARTPLAY_OFFSET UNITYSDK_OFFSET(0x17D353F0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION___BASE_UPDATETIME_OFFSET UNITYSDK_OFFSET(0x17D35480)

namespace MoleMole::Comic
{
	inline static constexpr unsigned int MonoComicPictureDecoration_TypeDefinitionIndex = 58905;
