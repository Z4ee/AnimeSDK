...
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_AWAKE_OFFSET UNITYSDK_OFFSET(0x17281FB0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_EDITORAWAKE_OFFSET UNITYSDK_OFFSET(0x17283890)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_GETFADEINANIMTIME_OFFSET UNITYSDK_OFFSET(0x17283220)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_GETPICRECTTRANS_OFFSET UNITYSDK_OFFSET(0x172837E0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_INITINEDITOR_OFFSET UNITYSDK_OFFSET(0x172839F0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0x172820F0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_METHOD_7_0EFA57F70A2452C7_OFFSET UNITYSDK_OFFSET(0x17282200)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_METHOD_7_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x172830E0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_METHOD_7_479759059E440327_1_OFFSET UNITYSDK_OFFSET(0x17282F10)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_METHOD_7_479759059E440327_OFFSET UNITYSDK_OFFSET(0x17282FD0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_METHOD_7_6AF96BBFE90AF125_OFFSET UNITYSDK_OFFSET(0x172824A0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_METHOD_7_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0x17283480)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_METHOD_7_F4F1E7D1CC26024A_OFFSET UNITYSDK_OFFSET(0x172829D0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_METHOD_7_F9D8AF4B91BAC175_OFFSET UNITYSDK_OFFSET(0x17283630)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_PLAYEXIT_OFFSET UNITYSDK_OFFSET(0x172833D0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_PLAYFADEINANIM_OFFSET UNITYSDK_OFFSET(0x17282B60)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x172827B0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_SETWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x17282650)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_SIMULATEANIMPROGRESSFOROUTER_OFFSET UNITYSDK_OFFSET(0x17283830)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_STARTPLAY_OFFSET UNITYSDK_OFFSET(0x17282800)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_UPDATETIME_OFFSET UNITYSDK_OFFSET(0x17282D10)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION__CTOR_OFFSET UNITYSDK_OFFSET(0x17283A70)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION___BASE_GETFADEINANIMTIME_OFFSET UNITYSDK_OFFSET(0x17283AC0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION___BASE_GETFADEOUTTIME_OFFSET UNITYSDK_OFFSET(0x17283B50)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION___BASE_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0x17283BE0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION___BASE_JUMPTOFINAL_OFFSET UNITYSDK_OFFSET(0x17283BF0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION___BASE_PLAYFADEINANIM_OFFSET UNITYSDK_OFFSET(0x17283C80)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION___BASE_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x17283D10)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION___BASE_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x17283DA0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION___BASE_STARTPLAY_OFFSET UNITYSDK_OFFSET(0x17283DB0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION___BASE_UPDATETIME_OFFSET UNITYSDK_OFFSET(0x17283E40)

namespace MoleMole::Comic
{
	inline static constexpr unsigned int MonoComicPictureDecoration_TypeDefinitionIndex = 86645;
	...
	public:
		...
		::UnityEngine::Timeline::PictureDecorateEvent* Field_7_7; // 0x90
		::UnityEngine::Animation* Field_7_6; // 0x98
		::UnityEngine::AnimationCurve* Field_7_11; // 0xA0
		::System::Single Field_7_10; // 0xA8
		::System::Single Field_7_9; // 0xAC
		::UnityEngine::CanvasGroup* Field_7_8; // 0xB0
		::UnityEngine::RectTransform* Field_7_15; // 0xB8
		::UnityEngine::Vector2 Field_7_14; // 0xC0
		::UnityEngine::Vector3 Field_7_13; // 0xC8
		::UnityEngine::Vector2 Field_7_12; // 0xD4
		::UnityEngine::Vector3 Field_7_19; // 0xDC
		::UnityEngine::Vector2 Field_7_18; // 0xE8
		...
		::System::Void Method_7_0EFA57F70A2452C7(::UnityEngine::Timeline::PictureDecorateEvent* a1)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Timeline::PictureDecorateEvent*))((::PBYTE)hIl2Cpp + MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_METHOD_7_0EFA57F70A2452C7_OFFSET))(this, a1);
		}
	};
}
