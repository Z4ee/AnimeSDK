...
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_ADD_ONINITFINISH_OFFSET UNITYSDK_OFFSET(0x17D2AB40)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_ADD_ONSHRINKFINISH_OFFSET UNITYSDK_OFFSET(0x17D2AC40)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_AWAKE_OFFSET UNITYSDK_OFFSET(0x17D2AD40)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_CLEARBUBBLERANGELIST_OFFSET UNITYSDK_OFFSET(0x17D2C480)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_ENDPLAY_OFFSET UNITYSDK_OFFSET(0x17D2E140)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_FINISHTEXTPLAY_OFFSET UNITYSDK_OFFSET(0x17D2EBC0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_GETFADEINANIMTIME_OFFSET UNITYSDK_OFFSET(0x17D2DFA0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_GETFADEOUTANIMTIME_OFFSET UNITYSDK_OFFSET(0x17D2E520)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_GETHIDEINDEX_OFFSET UNITYSDK_OFFSET(0x17D2CAD0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_GET_GO_OFFSET UNITYSDK_OFFSET(0x17D2C670)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_GET_HIDEWHENSPLITSCREEN_OFFSET UNITYSDK_OFFSET(0x17D2F740)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_GET_MOVEWHENSPLITSCREEN_OFFSET UNITYSDK_OFFSET(0x17D2F750)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_GET_RECTTRAN_OFFSET UNITYSDK_OFFSET(0x17D2C540)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_GET_SCROLLVIEWACTIVE_OFFSET UNITYSDK_OFFSET(0x17D2F760)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_INITIMGCONFIG_OFFSET UNITYSDK_OFFSET(0x17D2C700)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_INITRANGEINFO_OFFSET UNITYSDK_OFFSET(0x17D2C680)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0x17D2B860)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_ISAUTOFINISH_OFFSET UNITYSDK_OFFSET(0x17D2C420)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_ISPLAYTEXT_OFFSET UNITYSDK_OFFSET(0x17D2EA50)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_JUMPTOFINALSTATE_OFFSET UNITYSDK_OFFSET(0x17D2F540)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_1B9CC121BDC8766D_OFFSET UNITYSDK_OFFSET(0x17D2FE80)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_218124418542E081_OFFSET UNITYSDK_OFFSET(0x17D314D0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_231675EAC57B4014_OFFSET UNITYSDK_OFFSET(0x17D31AD0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_261DF843E298B71B_OFFSET UNITYSDK_OFFSET(0x17D2C9B0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_27419209AD7EE29A_OFFSET UNITYSDK_OFFSET(0x17D2C170)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_2BCDDB2C8831E231_OFFSET UNITYSDK_OFFSET(0x17D2D440)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_31C12715685B9E2F_OFFSET UNITYSDK_OFFSET(0x17D30FD0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_36AC4BD395BFF6C6_OFFSET UNITYSDK_OFFSET(0x17D301F0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x17D32210)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_4755BFE651CF9635_OFFSET UNITYSDK_OFFSET(0x17D2C920)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_497833CF065C1894_OFFSET UNITYSDK_OFFSET(0x17D2FF30)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_61C393831AD81194_OFFSET UNITYSDK_OFFSET(0x17D31710)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0x17D2DCF0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_6CAAEFBA0DFA82C0_OFFSET UNITYSDK_OFFSET(0x17D2D6E0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_70A280A8B20B1E91_OFFSET UNITYSDK_OFFSET(0x17D2BA40)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_712AD358A3B4473E_OFFSET UNITYSDK_OFFSET(0x17D303B0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_771A6E6C128346EF_OFFSET UNITYSDK_OFFSET(0x17D30870)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_7B26CD82688F4AA2_OFFSET UNITYSDK_OFFSET(0x17D2FC70)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_937F8473216A3162_OFFSET UNITYSDK_OFFSET(0x17D2C750)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_9E0A3606DECE56CE_OFFSET UNITYSDK_OFFSET(0x17D31F40)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_C74E50CBD41F0264_1_OFFSET UNITYSDK_OFFSET(0x17D2FF20)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_C74E50CBD41F0264_2_OFFSET UNITYSDK_OFFSET(0x17D31700)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x17D2F590)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x17D2F6E0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_DAAF2880478C42FF_OFFSET UNITYSDK_OFFSET(0x17D313E0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_E52129E82CD2D7F8_OFFSET UNITYSDK_OFFSET(0x17D33410)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_EC188688BC2EC74F_OFFSET UNITYSDK_OFFSET(0x17D30270)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_EC9F8B8EC6EF4CAF_OFFSET UNITYSDK_OFFSET(0x17D333F0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_EF02B42E56E87182_OFFSET UNITYSDK_OFFSET(0x17D32260)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x17D2F730)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17D2E6C0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_PLAYFADEINANIM_OFFSET UNITYSDK_OFFSET(0x17D2DB50)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_PLAYFADEOUTANIM_OFFSET UNITYSDK_OFFSET(0x17D2E190)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_PLAYFOCUSANIM_OFFSET UNITYSDK_OFFSET(0x17D2F250)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_PLAYLOSEFOCUSANIM_OFFSET UNITYSDK_OFFSET(0x17D2F3D0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_REMOVE_ONINITFINISH_OFFSET UNITYSDK_OFFSET(0x17D2ABC0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_REMOVE_ONSHRINKFINISH_OFFSET UNITYSDK_OFFSET(0x17D2ACC0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x17D2F5A0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_SETHIDEINDEX_OFFSET UNITYSDK_OFFSET(0x17D2CA80)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_SETMOVEPARAMS_OFFSET UNITYSDK_OFFSET(0x17D2F100)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_SETPARENT_OFFSET UNITYSDK_OFFSET(0x17D2C550)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_SETVOICEPARAM_OFFSET UNITYSDK_OFFSET(0x17D2CA30)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_SHOWARROW_OFFSET UNITYSDK_OFFSET(0x17D2DA40)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_SHOWBUBBLEWIDGET_OFFSET UNITYSDK_OFFSET(0x17D2BE00)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_SIMULATEMOVEPROCESS_OFFSET UNITYSDK_OFFSET(0x17D2D240)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_STARTPLAY_OFFSET UNITYSDK_OFFSET(0x17D2DB00)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_UPDATETIME_OFFSET UNITYSDK_OFFSET(0x17D2CB20)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x17D2C1D0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x17D2F830)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x17D2F770)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE___BASE_ENDPLAY_OFFSET UNITYSDK_OFFSET(0x17D2F8C0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE___BASE_GETFADEINANIMTIME_OFFSET UNITYSDK_OFFSET(0x17D2F950)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE___BASE_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0x17D2F9E0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE___BASE_ISAUTOFINISH_OFFSET UNITYSDK_OFFSET(0x17D2F9F0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE___BASE_PLAYFADEINANIM_OFFSET UNITYSDK_OFFSET(0x17D2FA00)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE___BASE_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x17D2FA90)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE___BASE_STARTPLAY_OFFSET UNITYSDK_OFFSET(0x17D2FB40)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE___BASE_UPDATETIME_OFFSET UNITYSDK_OFFSET(0x17D2FBD0)

namespace MoleMole::Comic
{
	inline static constexpr unsigned int MonoComicBubble_TypeDefinitionIndex = 62372;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::MoleMole::Comic::MonoComicBubble_Class_1_4F7EA480540242DA*>**)Il2CppClass::FromTypeDefinitionIndex(MonoComicBubble_TypeDefinitionIndex)->GetStaticField(0x371C0);
		}
