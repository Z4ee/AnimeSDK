...
#define MOLEMOLE_COMIC_RUNTIMECOMICCLEAREVENT_CLEAREVENTSWITHTAG_OFFSET UNITYSDK_OFFSET(0x12B1E070)
#define MOLEMOLE_COMIC_RUNTIMECOMICCLEAREVENT_ENDPLAY_OFFSET UNITYSDK_OFFSET(0x12B1DEB0)
#define MOLEMOLE_COMIC_RUNTIMECOMICCLEAREVENT_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0x12B1DB10)
#define MOLEMOLE_COMIC_RUNTIMECOMICCLEAREVENT_STARTPLAY_OFFSET UNITYSDK_OFFSET(0x12B1DC60)
#define MOLEMOLE_COMIC_RUNTIMECOMICCLEAREVENT_UPDATETIME_OFFSET UNITYSDK_OFFSET(0x12B1DF10)
#define MOLEMOLE_COMIC_RUNTIMECOMICCLEAREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x12B1E370)
#define MOLEMOLE_COMIC_RUNTIMECOMICCLEAREVENT___BASE_ENDPLAY_OFFSET UNITYSDK_OFFSET(0x12B1E440)
#define MOLEMOLE_COMIC_RUNTIMECOMICCLEAREVENT___BASE_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0x12B1E4D0)
#define MOLEMOLE_COMIC_RUNTIMECOMICCLEAREVENT___BASE_STARTPLAY_OFFSET UNITYSDK_OFFSET(0x12B1E580)
#define MOLEMOLE_COMIC_RUNTIMECOMICCLEAREVENT___BASE_UPDATETIME_OFFSET UNITYSDK_OFFSET(0x12B1E610)

namespace MoleMole::Comic
{
	inline static constexpr unsigned int RuntimeComicClearEvent_TypeDefinitionIndex = 84378;
