...
#define MOLEMOLE_COMIC_DIALOGUEAUDIOCONTENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C16BD90)

namespace MoleMole::Comic
{
	inline static constexpr unsigned int DialogueAudioContent_TypeDefinitionIndex = 30600;
