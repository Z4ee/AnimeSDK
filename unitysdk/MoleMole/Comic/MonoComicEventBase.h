...
#define MOLEMOLE_COMIC_MONOCOMICEVENTBASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x10CE53B0)
#define MOLEMOLE_COMIC_MONOCOMICEVENTBASE_ENDPLAY_OFFSET UNITYSDK_OFFSET(0x10CE5CF0)
#define MOLEMOLE_COMIC_MONOCOMICEVENTBASE_GETFADEINANIMTIME_OFFSET UNITYSDK_OFFSET(0x10CE5CB0)
#define MOLEMOLE_COMIC_MONOCOMICEVENTBASE_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0x10CE54B0)
#define MOLEMOLE_COMIC_MONOCOMICEVENTBASE_ISAUTOFINISH_OFFSET UNITYSDK_OFFSET(0x10CE5BB0)
#define MOLEMOLE_COMIC_MONOCOMICEVENTBASE_ISDELAYING_OFFSET UNITYSDK_OFFSET(0x10CE5A90)
#define MOLEMOLE_COMIC_MONOCOMICEVENTBASE_ISFINISH_OFFSET UNITYSDK_OFFSET(0x10CE5B50)
#define MOLEMOLE_COMIC_MONOCOMICEVENTBASE_ISPLAYING_OFFSET UNITYSDK_OFFSET(0x10CE5AF0)
#define MOLEMOLE_COMIC_MONOCOMICEVENTBASE_METHOD_5_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x10CE5620)
#define MOLEMOLE_COMIC_MONOCOMICEVENTBASE_METHOD_5_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0x10CE5440)
#define MOLEMOLE_COMIC_MONOCOMICEVENTBASE_METHOD_5_7E692C4823C131A7_OFFSET UNITYSDK_OFFSET(0x10CE56C0)
#define MOLEMOLE_COMIC_MONOCOMICEVENTBASE_METHOD_5_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x10CE5DE0)
#define MOLEMOLE_COMIC_MONOCOMICEVENTBASE_METHOD_5_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x10CE53A0)
#define MOLEMOLE_COMIC_MONOCOMICEVENTBASE_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x10CE5E90)
#define MOLEMOLE_COMIC_MONOCOMICEVENTBASE_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x10CE5390)
#define MOLEMOLE_COMIC_MONOCOMICEVENTBASE_METHOD_5_F2D473764762AC90_OFFSET UNITYSDK_OFFSET(0x10CE5670)
#define MOLEMOLE_COMIC_MONOCOMICEVENTBASE_PLAYFADEINANIM_OFFSET UNITYSDK_OFFSET(0x10CE5C70)
#define MOLEMOLE_COMIC_MONOCOMICEVENTBASE_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x10CE5D30)
#define MOLEMOLE_COMIC_MONOCOMICEVENTBASE_SETACTIVE_OFFSET UNITYSDK_OFFSET(0x10CE58A0)
#define MOLEMOLE_COMIC_MONOCOMICEVENTBASE_SETPARENT_OFFSET UNITYSDK_OFFSET(0x10CE5710)
#define MOLEMOLE_COMIC_MONOCOMICEVENTBASE_STARTPLAY_OFFSET UNITYSDK_OFFSET(0x10CE5C30)
#define MOLEMOLE_COMIC_MONOCOMICEVENTBASE_UPDATETIME_OFFSET UNITYSDK_OFFSET(0x10CE5A30)
#define MOLEMOLE_COMIC_MONOCOMICEVENTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x10CE5D90)

namespace MoleMole::Comic
{
	inline static constexpr unsigned int MonoComicEventBase_TypeDefinitionIndex = 67142;
