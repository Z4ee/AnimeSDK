...
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_INITGRAPHICPARAMS_OFFSET UNITYSDK_OFFSET(0x12B14FA0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_INITIMGCONFIG_OFFSET UNITYSDK_OFFSET(0x12B19140)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_METHOD_9_0764E01E2137A098_OFFSET UNITYSDK_OFFSET(0x12B1CFC0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_METHOD_9_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x12B15660)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_METHOD_9_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x12B16C40)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_METHOD_9_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0x12B156B0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_METHOD_9_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0x12B190E0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_METHOD_9_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x12B15B60)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_METHOD_9_4411199993DF6425_OFFSET UNITYSDK_OFFSET(0x12B1C440)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_METHOD_9_4B52176A6D5FB435_OFFSET UNITYSDK_OFFSET(0x12B19910)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_METHOD_9_5FB96F24B721AEA4_OFFSET UNITYSDK_OFFSET(0x12B19390)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_METHOD_9_608FC9EA0D8581C7_OFFSET UNITYSDK_OFFSET(0x12B1CD20)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_METHOD_9_6DB41C3EEBB33D1B_OFFSET UNITYSDK_OFFSET(0x12B1A240)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_METHOD_9_724540B4D546CEE4_OFFSET UNITYSDK_OFFSET(0x12B1D620)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_METHOD_9_7BC6179181D7B050_OFFSET UNITYSDK_OFFSET(0x12B1CB90)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_METHOD_9_8184976F02A874EE_OFFSET UNITYSDK_OFFSET(0x12B1D3E0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_METHOD_9_95A91FDC3076B1C3_OFFSET UNITYSDK_OFFSET(0x12B16CC0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_METHOD_9_A23131F66C6A15C2_OFFSET UNITYSDK_OFFSET(0x12B1C530)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_METHOD_9_A7AAACFF88243D85_OFFSET UNITYSDK_OFFSET(0x12B1C800)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_METHOD_9_CB1C9D48897FC6C6_OFFSET UNITYSDK_OFFSET(0x12B19AE0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_METHOD_9_CEA32FF190776922_OFFSET UNITYSDK_OFFSET(0x12B15190)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_METHOD_9_D70F0ABF7623198F_OFFSET UNITYSDK_OFFSET(0x12B15BD0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_METHOD_9_D8E8A2AA5D1E44E6_OFFSET UNITYSDK_OFFSET(0x12B1CC70)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_METHOD_9_DE7CF4FAEAA6D373_OFFSET UNITYSDK_OFFSET(0x12B1C840)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_METHOD_9_ED23625483EB73ED_OFFSET UNITYSDK_OFFSET(0x12B166D0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_METHOD_9_F6FD2E653D0EF4CE_OFFSET UNITYSDK_OFFSET(0x12B1C390)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_METHOD_9_FA56723697B9BABB_OFFSET UNITYSDK_OFFSET(0x12B18800)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_METHOD_9_FD2C657B5478CBD4_OFFSET UNITYSDK_OFFSET(0x12B1C9A0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x12B15720)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE__CCTOR_OFFSET UNITYSDK_OFFSET(0x12B192A0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x12B19190)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE___BASE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x12B19380)

namespace MoleMole::Comic
{
	inline static constexpr unsigned int MonoComicBubbleImage_TypeDefinitionIndex = 61631;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Vector2>**)Il2CppClass::FromTypeDefinitionIndex(MonoComicBubbleImage_TypeDefinitionIndex)->GetStaticField(0x4BB40);
		}
		...
		::UnityEngine::Vector2 Method_9_8184976F02A874EE(::System::Single a1, ::System::Boolean a2, ::System::Single& a3, ::MoleMole::Comic::MonoComicBubbleImage_Struct_2_D7E5D2F89431C32A& a4)
		{
			return ((::UnityEngine::Vector2(*)(::PVOID, ::System::Single, ::System::Boolean, ::System::Single&, ::MoleMole::Comic::MonoComicBubbleImage_Struct_2_D7E5D2F89431C32A&))((::PBYTE)hIl2Cpp + MOLEMOLE_COMIC_MONOCOMICBUBBLEIMAGE_METHOD_9_8184976F02A874EE_OFFSET))(this, a1, a2, a3, a4);
		}
