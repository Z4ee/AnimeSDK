...
#define MOLEMOLE_COMIC_MONOCOMICBGEXCHANGEDECORATION_INITBGNODES_OFFSET UNITYSDK_OFFSET(0x14359BC0)
#define MOLEMOLE_COMIC_MONOCOMICBGEXCHANGEDECORATION_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0x143596B0)
#define MOLEMOLE_COMIC_MONOCOMICBGEXCHANGEDECORATION_METHOD_7_071850D2764E9D4C_OFFSET UNITYSDK_OFFSET(0x14359EF0)
#define MOLEMOLE_COMIC_MONOCOMICBGEXCHANGEDECORATION_METHOD_7_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x1435A600)
#define MOLEMOLE_COMIC_MONOCOMICBGEXCHANGEDECORATION_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x1435A290)
#define MOLEMOLE_COMIC_MONOCOMICBGEXCHANGEDECORATION_STARTPLAY_OFFSET UNITYSDK_OFFSET(0x1435A2F0)
#define MOLEMOLE_COMIC_MONOCOMICBGEXCHANGEDECORATION_UPDATETIME_OFFSET UNITYSDK_OFFSET(0x1435A4A0)
#define MOLEMOLE_COMIC_MONOCOMICBGEXCHANGEDECORATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1435A6E0)
#define MOLEMOLE_COMIC_MONOCOMICBGEXCHANGEDECORATION___BASE_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0x1435A730)
#define MOLEMOLE_COMIC_MONOCOMICBGEXCHANGEDECORATION___BASE_JUMPTOFINAL_OFFSET UNITYSDK_OFFSET(0x1435A740)
#define MOLEMOLE_COMIC_MONOCOMICBGEXCHANGEDECORATION___BASE_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x1435A7D0)
#define MOLEMOLE_COMIC_MONOCOMICBGEXCHANGEDECORATION___BASE_STARTPLAY_OFFSET UNITYSDK_OFFSET(0x1435A7E0)
#define MOLEMOLE_COMIC_MONOCOMICBGEXCHANGEDECORATION___BASE_UPDATETIME_OFFSET UNITYSDK_OFFSET(0x1435A870)

namespace MoleMole::Comic
{
	inline static constexpr unsigned int MonoComicBGExchangeDecoration_TypeDefinitionIndex = 58280;
	...
	public:
		...
		::UnityEngine::Timeline::ImageExchangeEventZoneVer* Field_7_7; // 0x88
		::UnityEngine::Sprite* Field_7_6; // 0x90
		::System::Single Field_7_5; // 0x98
		::UnityEngine::AnimationCurve* Field_7_4; // 0xA0
		::UnityEngine::Transform* Field_7_11; // 0xA8
		::UnityEngine::CanvasGroup* Field_7_10; // 0xB0
		::UnityEngine::Transform* Field_7_9; // 0xB8
