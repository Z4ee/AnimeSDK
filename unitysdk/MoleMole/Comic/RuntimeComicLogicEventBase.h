...
#define MOLEMOLE_COMIC_RUNTIMECOMICLOGICEVENTBASE_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0x122ED660)
#define MOLEMOLE_COMIC_RUNTIMECOMICLOGICEVENTBASE_JUMPTOFINALSTATE_OFFSET UNITYSDK_OFFSET(0x122ED720)
#define MOLEMOLE_COMIC_RUNTIMECOMICLOGICEVENTBASE_JUMPTOFINAL_OFFSET UNITYSDK_OFFSET(0x122ED770)
#define MOLEMOLE_COMIC_RUNTIMECOMICLOGICEVENTBASE_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x122ED6C0)
#define MOLEMOLE_COMIC_RUNTIMECOMICLOGICEVENTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x122ED7B0)
#define MOLEMOLE_COMIC_RUNTIMECOMICLOGICEVENTBASE___BASE_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x122ED800)

namespace MoleMole::Comic
{
	inline static constexpr unsigned int RuntimeComicLogicEventBase_TypeDefinitionIndex = 73833;
