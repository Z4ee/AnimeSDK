...
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_CLEARALLCACHE_OFFSET UNITYSDK_OFFSET(0x1EF65850)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_CREATEBUBBLE_OFFSET UNITYSDK_OFFSET(0x1EF66400)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_CREATEDECORATIONNODE_OFFSET UNITYSDK_OFFSET(0x1EF67960)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_CREATETEMPNODE_OFFSET UNITYSDK_OFFSET(0x1EF656C0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GETBUBBLENODE_OFFSET UNITYSDK_OFFSET(0x1EF66420)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GETIMAGE01TRANS_OFFSET UNITYSDK_OFFSET(0x1EF64B30)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GETSUBSPRITEROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1EF64710)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GETTEMPLATENODE_OFFSET UNITYSDK_OFFSET(0x1EF654B0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GETTEMPLATEPARTIMG_OFFSET UNITYSDK_OFFSET(0x1EF64FD0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GETTRANSNAMEDDFS_OFFSET UNITYSDK_OFFSET(0x1EF652B0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GET_ADAPTERTYPE_OFFSET UNITYSDK_OFFSET(0x1EF67A50)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GET_ARROWTARGETPOINTSPRITE_OFFSET UNITYSDK_OFFSET(0x1EF67A40)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GET_COMICIMGSTYLECONFIG_OFFSET UNITYSDK_OFFSET(0x1EF67950)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1EF62280)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_INITBUBBLE_OFFSET UNITYSDK_OFFSET(0x1EF66410)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_INIT_OFFSET UNITYSDK_OFFSET(0x1EF62410)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_JUSTGETTEMPLATENODE_OFFSET UNITYSDK_OFFSET(0x1EF656D0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SETARROWTARGETPOINTPOS_OFFSET UNITYSDK_OFFSET(0x1EF67300)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SHOWARROWTARGETPOINTOFKEY_OFFSET UNITYSDK_OFFSET(0x1EF67660)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SHOWBUBBLEGROUP_OFFSET UNITYSDK_OFFSET(0x1EF65C40)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SHOWDECORATIONGROUP_OFFSET UNITYSDK_OFFSET(0x1EF665F0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SHOWPICDECOGROUP_OFFSET UNITYSDK_OFFSET(0x1EF66AB0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SWICTHBUBBLERANGESHOWER_OFFSET UNITYSDK_OFFSET(0x1EF64E00)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SWITCHBUBBLESTATE_OFFSET UNITYSDK_OFFSET(0x1EF66100)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SWITCHDECORATIONNODESTATE_OFFSET UNITYSDK_OFFSET(0x1EF66FC0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SWITCHMASKSTATE_OFFSET UNITYSDK_OFFSET(0x1EF64B40)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SWITCHPICTUREDECORATIONNODESTATE_OFFSET UNITYSDK_OFFSET(0x1EF672B0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SWITCHVOICEDECORATIONNODESTATE_OFFSET UNITYSDK_OFFSET(0x1EF66F70)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EF67A60)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF62380)

namespace MoleMole::Comic
{
	inline static constexpr unsigned int ComicBehaviorMgr_TypeDefinitionIndex = 32769;
	...
	public:
		...
		{
			return (::MoleMole::Comic::ComicBehaviorMgr**)Il2CppClass::FromTypeDefinitionIndex(ComicBehaviorMgr_TypeDefinitionIndex)->GetStaticField(0x28230);
		}
		static ::UnityEngine::Sprite** StaticGet__arrowTargetPointSprite()
		{
			return (::UnityEngine::Sprite**)Il2CppClass::FromTypeDefinitionIndex(ComicBehaviorMgr_TypeDefinitionIndex)->GetStaticField(0x28238);
		}
		...
		::UnityEngine::Transform* m_stPicDecoRoot; // 0x10
		::UnityEngine::Transform* m_stDecorationRoot; // 0x18
		::UnityEngine::Transform* m_stBubbleRangeShower; // 0x20
		::UnityEngine::Transform* m_stTemplateRoot; // 0x28
		::UnityEngine::Transform* m_stATPRoot; // 0x30
		::UnityEngine::Transform* m_stSubSpriteRoot; // 0x38
		::UnityEngine::Transform* m_stImage01; // 0x40
		::System::Type* m_stAdapterType; // 0x48
		::UnityEngine::Transform* m_stBubbleRoot; // 0x50
		::MoleMole::ComicImgStyleConfig* m_stStyleConfig; // 0x58
		::System::Func_4<::UnityEngine::Transform*, ::System::String*, ::UnityEngine::Timeline::BubbleEvent*, ::UnityEngine::Transform*>* m_fcCreateBubble; // 0x60
		::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::GameObject*>* m_stDecorationPrefabMap; // 0x68
