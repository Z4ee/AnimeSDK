...
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS65_0__CTOR_OFFSET UNITYSDK_OFFSET(0x184BC000)
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS65_0__SETHOLLOWQUESTCONTEXT_B__0_OFFSET UNITYSDK_OFFSET(0x184BC010)
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS65_0__SETHOLLOWQUESTCONTEXT_G__ONPOSTGETBUDDYSELECTCONTEXT_1_OFFSET UNITYSDK_OFFSET(0x184BC370)

namespace MoleMole
{
	inline static constexpr unsigned int UILineupSelectContext___c__DisplayClass65_0_TypeDefinitionIndex = 52589;
