...
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS65_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1783B610)
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS65_0__SETHOLLOWQUESTCONTEXT_B__0_OFFSET UNITYSDK_OFFSET(0x1783B620)
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS65_0__SETHOLLOWQUESTCONTEXT_G__ONPOSTGETBUDDYSELECTCONTEXT_1_OFFSET UNITYSDK_OFFSET(0x1783B970)

namespace MoleMole
{
	inline static constexpr unsigned int UILineupSelectContext___c__DisplayClass65_0_TypeDefinitionIndex = 60187;
