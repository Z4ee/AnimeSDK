...
#define MOLEMOLE_COMICDATAUTIL_GETCOMICPARTINFOFROMTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1F1906C0)
#define MOLEMOLE_COMICDATAUTIL_GETIMGTRANS_OFFSET UNITYSDK_OFFSET(0x1F190480)
#define MOLEMOLE_COMICDATAUTIL_GETTRANSNAMEDDFS_OFFSET UNITYSDK_OFFSET(0x1F1904C0)
#define MOLEMOLE_COMICDATAUTIL_NAMETOPARTTYPE_OFFSET UNITYSDK_OFFSET(0x1F1901F0)
#define MOLEMOLE_COMICDATAUTIL_PARTTYPETONAME_OFFSET UNITYSDK_OFFSET(0x1F190340)
#define MOLEMOLE_COMICDATAUTIL_ROOTGETIMGTRANS_OFFSET UNITYSDK_OFFSET(0x1F190390)

namespace MoleMole
{
	inline static constexpr unsigned int ComicDataUtil_TypeDefinitionIndex = 32755;
