...
#define MOLEMOLE_UIRABDEPOSITORYBANGBOOROWWIDGETCONTROLLER_GET_CONTEXTVALUE_OFFSET UNITYSDK_OFFSET(0x17A1BDA0)
#define MOLEMOLE_UIRABDEPOSITORYBANGBOOROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17A1BD30)
#define MOLEMOLE_UIRABDEPOSITORYBANGBOOROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17A1BEE0)
#define MOLEMOLE_UIRABDEPOSITORYBANGBOOROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17A1C140)
#define MOLEMOLE_UIRABDEPOSITORYBANGBOOROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17A1BF80)
#define MOLEMOLE_UIRABDEPOSITORYBANGBOOROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17A1C310)
#define MOLEMOLE_UIRABDEPOSITORYBANGBOOROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17A1C320)
#define MOLEMOLE_UIRABDEPOSITORYBANGBOOROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17A1C3C0)
#define MOLEMOLE_UIRABDEPOSITORYBANGBOOROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17A1C460)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABDepositoryBangbooRowWidgetController_TypeDefinitionIndex = 46881;
