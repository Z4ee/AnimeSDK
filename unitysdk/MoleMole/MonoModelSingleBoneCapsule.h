...
#define MOLEMOLE_MONOMODELSINGLEBONECAPSULE_GET_FLAG_OFFSET UNITYSDK_OFFSET(0x18CE77E0)
#define MOLEMOLE_MONOMODELSINGLEBONECAPSULE_GET_SHAPE_OFFSET UNITYSDK_OFFSET(0x18CE77F0)
#define MOLEMOLE_MONOMODELSINGLEBONECAPSULE_METHOD_2_0A9F8627F6BE695B_OFFSET UNITYSDK_OFFSET(0x18CE7E30)
#define MOLEMOLE_MONOMODELSINGLEBONECAPSULE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CE7E20)

namespace MoleMole
{
	inline static constexpr unsigned int MonoModelSingleBoneCapsule_TypeDefinitionIndex = 84428;
