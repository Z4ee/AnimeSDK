...
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS50_1__CTOR_OFFSET UNITYSDK_OFFSET(0x16519BE0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS50_1__SHOWCUSTOMTRANSITION_B__0_OFFSET UNITYSDK_OFFSET(0x16519BF0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS50_1__SHOWCUSTOMTRANSITION_B__1_OFFSET UNITYSDK_OFFSET(0x16519CC0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS50_1__SHOWCUSTOMTRANSITION_B__2_OFFSET UNITYSDK_OFFSET(0x16519D90)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityChatPlayWidgetController___c__DisplayClass50_1_TypeDefinitionIndex = 77912;
	...
	public:
		...
		::UnityEngine::Events::UnityAction* selectAction; // 0x20
