...
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS50_1__CTOR_OFFSET UNITYSDK_OFFSET(0x14D38400)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS50_1__SHOWCUSTOMTRANSITION_B__0_OFFSET UNITYSDK_OFFSET(0x14D38410)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS50_1__SHOWCUSTOMTRANSITION_B__1_OFFSET UNITYSDK_OFFSET(0x14D384E0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS50_1__SHOWCUSTOMTRANSITION_B__2_OFFSET UNITYSDK_OFFSET(0x14D385B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityChatPlayWidgetController___c__DisplayClass50_1_TypeDefinitionIndex = 47779;

	class UIMainCityChatPlayWidgetController___c__DisplayClass50_1 : public ::System::Object
	{
	public:
		::UnityEngine::Events::UnityAction* selectAction; // 0x10
		::UnityEngine::UI::Extension::UILocalizationText* txt; // 0x18
		::MoleMole::UIMainCityChatPlayWidgetController___c__DisplayClass50_0* CS___8__locals1; // 0x20
