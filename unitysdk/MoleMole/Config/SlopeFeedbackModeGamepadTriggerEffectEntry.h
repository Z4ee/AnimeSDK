...
#define MOLEMOLE_CONFIG_SLOPEFEEDBACKMODEGAMEPADTRIGGEREFFECTENTRY_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x1B927670)
#define MOLEMOLE_CONFIG_SLOPEFEEDBACKMODEGAMEPADTRIGGEREFFECTENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B927700)
#define MOLEMOLE_CONFIG_SLOPEFEEDBACKMODEGAMEPADTRIGGEREFFECTENTRY___BASE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x1B927710)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SlopeFeedbackModeGamepadTriggerEffectEntry_TypeDefinitionIndex = 71283;
