...
#define MOLEMOLE_CONFIG_CONFIGUISCRIPTABLEANIMATIONV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA651E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUIScriptableAnimationV2_TypeDefinitionIndex = 60816;
