...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_EXECUTEGLOBAL_CONFIGSOUNDACTION_EXECUTEGLOBAL_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x16A9C820)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_EXECUTEGLOBAL_CONFIGSOUNDACTION_EXECUTEGLOBAL_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x16A9C830)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_EXECUTEGLOBAL_CONFIGSOUNDACTION_EXECUTEGLOBAL_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x16A9CA10)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_EXECUTEGLOBAL_CONFIGSOUNDACTION_EXECUTEGLOBAL_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x16A9CBB0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_EXECUTEGLOBAL_CONFIGSOUNDACTION_EXECUTEGLOBAL_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x16A9CB70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_ExecuteGlobal_ConfigSoundAction_ExecuteGlobal_UnityGeneratedFormatter_TypeDefinitionIndex = 54310;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigSoundAction_ExecuteGlobal_ConfigSoundAction_ExecuteGlobal_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x31FE0);
		}
