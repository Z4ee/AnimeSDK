...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORFLOATPARAM_CLONE_OFFSET UNITYSDK_OFFSET(0x106CCC70)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORFLOATPARAM_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x106CCC20)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORFLOATPARAM_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x106CD250)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORFLOATPARAM_FROMFLX_OFFSET UNITYSDK_OFFSET(0x106CCDE0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORFLOATPARAM_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x106CCD70)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORFLOATPARAM_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x106CD2B0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORFLOATPARAM_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x106CCE60)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORFLOATPARAM_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x106CD450)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORFLOATPARAM_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x106CD0F0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORFLOATPARAM_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0x106CCAD0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORFLOATPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x106CD600)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicValueListAnimatorFloatParam_TypeDefinitionIndex = 56447;
