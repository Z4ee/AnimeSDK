...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORFLOATPARAM_CLONE_OFFSET UNITYSDK_OFFSET(0x186AFA20)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORFLOATPARAM_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x186AF9D0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORFLOATPARAM_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x186B0000)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORFLOATPARAM_FROMFLX_OFFSET UNITYSDK_OFFSET(0x186AFB90)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORFLOATPARAM_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x186AFB20)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORFLOATPARAM_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x186B0060)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORFLOATPARAM_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x186AFC10)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORFLOATPARAM_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x186B0200)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORFLOATPARAM_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x186AFEA0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORFLOATPARAM_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0x186AF880)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORFLOATPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x186B03B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicValueListAnimatorFloatParam_TypeDefinitionIndex = 56625;
