...
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTBOOL_CLONE_OFFSET UNITYSDK_OFFSET(0x1A342440)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTBOOL_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x1A3423F0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTBOOL_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A342990)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTBOOL_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1A3425B0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTBOOL_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x1A342540)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTBOOL_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A3429F0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTBOOL_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x1A342630)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTBOOL_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A342C50)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTBOOL_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x1A342830)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTBOOL_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0x1A3422A0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A342E00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynmaicValueListBool_TypeDefinitionIndex = 55654;
