...
#define MOLEMOLE_CONFIG_HOLLOWNPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1705E020)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HollowNpcConfig_TypeDefinitionIndex = 54619;
