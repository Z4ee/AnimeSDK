...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDCAMERASHAKE_GETSHAKETYPELISTVALUEDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1109F000)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDCAMERASHAKE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x1109EF40)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDCAMERASHAKE__CTOR_OFFSET UNITYSDK_OFFSET(0x1109F260)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardCameraShake_TypeDefinitionIndex = 61171;
