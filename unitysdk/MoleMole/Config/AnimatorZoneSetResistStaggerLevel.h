...
#define MOLEMOLE_CONFIG_ANIMATORZONESETRESISTSTAGGERLEVEL_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x19290FF0)
#define MOLEMOLE_CONFIG_ANIMATORZONESETRESISTSTAGGERLEVEL_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x19290A00)
#define MOLEMOLE_CONFIG_ANIMATORZONESETRESISTSTAGGERLEVEL_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x19290CF0)
#define MOLEMOLE_CONFIG_ANIMATORZONESETRESISTSTAGGERLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19291080)
#define MOLEMOLE_CONFIG_ANIMATORZONESETRESISTSTAGGERLEVEL___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x19291090)
#define MOLEMOLE_CONFIG_ANIMATORZONESETRESISTSTAGGERLEVEL___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x19291160)
#define MOLEMOLE_CONFIG_ANIMATORZONESETRESISTSTAGGERLEVEL___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x19291210)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneSetResistStaggerLevel_TypeDefinitionIndex = 74457;
