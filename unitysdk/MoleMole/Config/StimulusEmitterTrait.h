...
#define MOLEMOLE_CONFIG_STIMULUSEMITTERTRAIT_CLONE_OFFSET UNITYSDK_OFFSET(0x1B567DA0)
#define MOLEMOLE_CONFIG_STIMULUSEMITTERTRAIT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x1B567D50)
#define MOLEMOLE_CONFIG_STIMULUSEMITTERTRAIT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B568310)
#define MOLEMOLE_CONFIG_STIMULUSEMITTERTRAIT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1B567EB0)
#define MOLEMOLE_CONFIG_STIMULUSEMITTERTRAIT_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B568710)
#define MOLEMOLE_CONFIG_STIMULUSEMITTERTRAIT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x1B567EA0)
#define MOLEMOLE_CONFIG_STIMULUSEMITTERTRAIT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B568370)
#define MOLEMOLE_CONFIG_STIMULUSEMITTERTRAIT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x1B567F30)
#define MOLEMOLE_CONFIG_STIMULUSEMITTERTRAIT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B568560)
#define MOLEMOLE_CONFIG_STIMULUSEMITTERTRAIT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x1B5681B0)
#define MOLEMOLE_CONFIG_STIMULUSEMITTERTRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5687B0)
#define MOLEMOLE_CONFIG_STIMULUSEMITTERTRAIT___BASE_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B5687C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int StimulusEmitterTrait_TypeDefinitionIndex = 73800;
	...
	public:
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_BE29B49AC03370B6*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_STIMULUSEMITTERTRAIT_GENERATECOMPONENT_OFFSET))(this, buildContext);
		}

		::System::Boolean __base_GenerateComponent(::Class_1_BE29B49AC03370B6* P0)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_BE29B49AC03370B6*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_STIMULUSEMITTERTRAIT___BASE_GENERATECOMPONENT_OFFSET))(this, P0);
		}
	};
}
