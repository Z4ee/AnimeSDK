...
#define MOLEMOLE_CONFIG_CONFIGTELEPORTSELECTIONTRAIT_BUILDENTITYCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1BD65100)
#define MOLEMOLE_CONFIG_CONFIGTELEPORTSELECTIONTRAIT_CLONE_OFFSET UNITYSDK_OFFSET(0x1BD63700)
#define MOLEMOLE_CONFIG_CONFIGTELEPORTSELECTIONTRAIT_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x1BD63800)
#define MOLEMOLE_CONFIG_CONFIGTELEPORTSELECTIONTRAIT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x1BD63690)
#define MOLEMOLE_CONFIG_CONFIGTELEPORTSELECTIONTRAIT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BD64B00)
#define MOLEMOLE_CONFIG_CONFIGTELEPORTSELECTIONTRAIT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1BD63ED0)
#define MOLEMOLE_CONFIG_CONFIGTELEPORTSELECTIONTRAIT_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1BD65300)
#define MOLEMOLE_CONFIG_CONFIGTELEPORTSELECTIONTRAIT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x1BD637F0)
#define MOLEMOLE_CONFIG_CONFIGTELEPORTSELECTIONTRAIT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BD64B60)
#define MOLEMOLE_CONFIG_CONFIGTELEPORTSELECTIONTRAIT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x1BD63F50)
#define MOLEMOLE_CONFIG_CONFIGTELEPORTSELECTIONTRAIT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BD64F70)
#define MOLEMOLE_CONFIG_CONFIGTELEPORTSELECTIONTRAIT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x1BD649C0)
#define MOLEMOLE_CONFIG_CONFIGTELEPORTSELECTIONTRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD65350)
#define MOLEMOLE_CONFIG_CONFIGTELEPORTSELECTIONTRAIT___BASE_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x1BD65360)
#define MOLEMOLE_CONFIG_CONFIGTELEPORTSELECTIONTRAIT___BASE_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1BD65370)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTeleportSelectionTrait_TypeDefinitionIndex = 63106;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_198*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGTELEPORTSELECTIONTRAIT_EXPOSEMEMBER_OFFSET))(this, processor, prefix);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_BE29B49AC03370B6*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGTELEPORTSELECTIONTRAIT_GENERATECOMPONENT_OFFSET))(this, buildContext);
		}

		::System::Void __base_ExposeMember(::Class_0_16E4307DCC419505_198* P0, ::System::String* P1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_198*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGTELEPORTSELECTIONTRAIT___BASE_EXPOSEMEMBER_OFFSET))(this, P0, P1);
		}

		::System::Boolean __base_GenerateComponent(::Class_1_BE29B49AC03370B6* P0)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_BE29B49AC03370B6*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGTELEPORTSELECTIONTRAIT___BASE_GENERATECOMPONENT_OFFSET))(this, P0);
		}
	};
}
