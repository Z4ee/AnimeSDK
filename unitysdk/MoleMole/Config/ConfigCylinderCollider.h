...
#define MOLEMOLE_CONFIG_CONFIGCYLINDERCOLLIDER_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x134F71E0)
#define MOLEMOLE_CONFIG_CONFIGCYLINDERCOLLIDER_CLEAN_OFFSET UNITYSDK_OFFSET(0x134F7390)
#define MOLEMOLE_CONFIG_CONFIGCYLINDERCOLLIDER_DEALLOCATE_OFFSET UNITYSDK_OFFSET(0x134F7270)
#define MOLEMOLE_CONFIG_CONFIGCYLINDERCOLLIDER_GETCOLLIDERTYPE_OFFSET UNITYSDK_OFFSET(0x134F7400)
#define MOLEMOLE_CONFIG_CONFIGCYLINDERCOLLIDER_GETLAYERMASK_OFFSET UNITYSDK_OFFSET(0x134F74D0)
#define MOLEMOLE_CONFIG_CONFIGCYLINDERCOLLIDER_GETPREFABNAME_OFFSET UNITYSDK_OFFSET(0x134F7450)
#define MOLEMOLE_CONFIG_CONFIGCYLINDERCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x134F7560)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCylinderCollider_TypeDefinitionIndex = 75657;
