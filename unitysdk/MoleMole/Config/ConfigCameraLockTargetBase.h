...
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETBASE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A061300)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETBASE_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1A0610C0)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETBASE_METHOD_1_0BD393E566CD3D4A_OFFSET UNITYSDK_OFFSET(0x1A061140)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETBASE_METHOD_1_A42B0141BE94FABE_OFFSET UNITYSDK_OFFSET(0x1A061360)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A061550)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraLockTargetBase_TypeDefinitionIndex = 64176;
