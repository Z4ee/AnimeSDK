...
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETBASE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x177D4F50)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETBASE_FROMFLX_OFFSET UNITYSDK_OFFSET(0x177D4D30)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETBASE_METHOD_1_0BD393E566CD3D4A_OFFSET UNITYSDK_OFFSET(0x177D4DB0)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETBASE_METHOD_1_A42B0141BE94FABE_OFFSET UNITYSDK_OFFSET(0x177D4FB0)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x177D51A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraLockTargetBase_TypeDefinitionIndex = 75985;
