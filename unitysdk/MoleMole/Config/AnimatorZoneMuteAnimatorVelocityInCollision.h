...
#define MOLEMOLE_CONFIG_ANIMATORZONEMUTEANIMATORVELOCITYINCOLLISION_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x12EF5340)
#define MOLEMOLE_CONFIG_ANIMATORZONEMUTEANIMATORVELOCITYINCOLLISION_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x12EF53B0)
#define MOLEMOLE_CONFIG_ANIMATORZONEMUTEANIMATORVELOCITYINCOLLISION__CTOR_OFFSET UNITYSDK_OFFSET(0x12EF5420)
#define MOLEMOLE_CONFIG_ANIMATORZONEMUTEANIMATORVELOCITYINCOLLISION___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x12EF5430)
#define MOLEMOLE_CONFIG_ANIMATORZONEMUTEANIMATORVELOCITYINCOLLISION___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x12EF54E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneMuteAnimatorVelocityInCollision_TypeDefinitionIndex = 57209;
