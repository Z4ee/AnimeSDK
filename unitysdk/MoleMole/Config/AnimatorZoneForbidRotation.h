...
#define MOLEMOLE_CONFIG_ANIMATORZONEFORBIDROTATION_DOFORBIDCONTROLROTATION_OFFSET UNITYSDK_OFFSET(0x177C6770)
#define MOLEMOLE_CONFIG_ANIMATORZONEFORBIDROTATION_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x177C6620)
#define MOLEMOLE_CONFIG_ANIMATORZONEFORBIDROTATION_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x177C6960)
#define MOLEMOLE_CONFIG_ANIMATORZONEFORBIDROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x177C6AC0)
#define MOLEMOLE_CONFIG_ANIMATORZONEFORBIDROTATION___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x177C6AD0)
#define MOLEMOLE_CONFIG_ANIMATORZONEFORBIDROTATION___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x177C6B80)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneForbidRotation_TypeDefinitionIndex = 46208;

	class AnimatorZoneForbidRotation : public ::MoleMole::Config::AnimatorZone
	{
	public:
		::System::Boolean ForbidLockTargetRotation; // 0x50
		::System::Boolean ForbidInputControlRotation; // 0x51
