...
#define MOLEMOLE_CONFIG_CONFIGENTITYSKILLS__CTOR_OFFSET UNITYSDK_OFFSET(0x162AB860)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntitySkills_TypeDefinitionIndex = 68542;
