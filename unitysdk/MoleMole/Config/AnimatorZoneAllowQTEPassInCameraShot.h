...
#define MOLEMOLE_CONFIG_ANIMATORZONEALLOWQTEPASSINCAMERASHOT_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x177C3F30)
#define MOLEMOLE_CONFIG_ANIMATORZONEALLOWQTEPASSINCAMERASHOT_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x177C4070)
#define MOLEMOLE_CONFIG_ANIMATORZONEALLOWQTEPASSINCAMERASHOT__CTOR_OFFSET UNITYSDK_OFFSET(0x177C41C0)
#define MOLEMOLE_CONFIG_ANIMATORZONEALLOWQTEPASSINCAMERASHOT___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x177C41D0)
#define MOLEMOLE_CONFIG_ANIMATORZONEALLOWQTEPASSINCAMERASHOT___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x177C4280)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneAllowQTEPassInCameraShot_TypeDefinitionIndex = 54169;
