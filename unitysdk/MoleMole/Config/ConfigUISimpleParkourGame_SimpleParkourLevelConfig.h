...
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SIMPLEPARKOURLEVELCONFIG_CALCULATETOTALNODECOUNT_OFFSET UNITYSDK_OFFSET(0x12722910)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SIMPLEPARKOURLEVELCONFIG_CALCULATETOTALSCORE_OFFSET UNITYSDK_OFFSET(0x12722590)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SIMPLEPARKOURLEVELCONFIG_GETGLOBALCONFIG_OFFSET UNITYSDK_OFFSET(0x12722B40)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SIMPLEPARKOURLEVELCONFIG_GET_TOTALNODECOUNT_OFFSET UNITYSDK_OFFSET(0x12722900)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SIMPLEPARKOURLEVELCONFIG_GET_TOTALSCORE_OFFSET UNITYSDK_OFFSET(0x12722580)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SIMPLEPARKOURLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x12722D60)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUISimpleParkourGame_SimpleParkourLevelConfig_TypeDefinitionIndex = 72947;
