...
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SIMPLEPARKOURLEVELCONFIG_CALCULATETOTALNODECOUNT_OFFSET UNITYSDK_OFFSET(0x13509E30)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SIMPLEPARKOURLEVELCONFIG_CALCULATETOTALSCORE_OFFSET UNITYSDK_OFFSET(0x13509AB0)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SIMPLEPARKOURLEVELCONFIG_GETGLOBALCONFIG_OFFSET UNITYSDK_OFFSET(0x1350A060)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SIMPLEPARKOURLEVELCONFIG_GET_TOTALNODECOUNT_OFFSET UNITYSDK_OFFSET(0x13509E20)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SIMPLEPARKOURLEVELCONFIG_GET_TOTALSCORE_OFFSET UNITYSDK_OFFSET(0x13509AA0)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SIMPLEPARKOURLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1350A280)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUISimpleParkourGame_SimpleParkourLevelConfig_TypeDefinitionIndex = 73974;
