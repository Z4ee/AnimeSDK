...
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETAMBIENTGRADIENT_OFFSET UNITYSDK_OFFSET(0x12B38B10)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETAMBIENT_OFFSET UNITYSDK_OFFSET(0x12B382F0)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETBLUE_OFFSET UNITYSDK_OFFSET(0x12B39990)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETCONTRAST_OFFSET UNITYSDK_OFFSET(0x12B38D40)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETCUSTOMGAMMA_OFFSET UNITYSDK_OFFSET(0x12B395E0)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETENABLE_OFFSET UNITYSDK_OFFSET(0x12B392E0)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETFRONTTINT_OFFSET UNITYSDK_OFFSET(0x12B38430)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETGAIN_OFFSET UNITYSDK_OFFSET(0x12B397A0)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETGAMMA_OFFSET UNITYSDK_OFFSET(0x12B39700)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETGREEN_OFFSET UNITYSDK_OFFSET(0x12B39920)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETHUEVSHUE_OFFSET UNITYSDK_OFFSET(0x12B39A00)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETHUEVSSAT_OFFSET UNITYSDK_OFFSET(0x12B39A70)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETLIFT_OFFSET UNITYSDK_OFFSET(0x12B39660)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETLUMVSSAT_OFFSET UNITYSDK_OFFSET(0x12B39B50)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETMASTER_OFFSET UNITYSDK_OFFSET(0x12B39840)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETOUTLINETINT_OFFSET UNITYSDK_OFFSET(0x12B38C20)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETPOSTEXPOSURE_OFFSET UNITYSDK_OFFSET(0x12B38CC0)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETRED_OFFSET UNITYSDK_OFFSET(0x12B398B0)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETREVERTSATURATION_OFFSET UNITYSDK_OFFSET(0x12B38E40)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETRIMGLOWCOLORFORCHARACTER_OFFSET UNITYSDK_OFFSET(0x12B39040)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETRIMGLOWINTENSITYFORCHARA_OFFSET UNITYSDK_OFFSET(0x12B38F40)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETRIMGLOWSTYLEFORCHARACTER01_OFFSET UNITYSDK_OFFSET(0x12B390E0)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETRIMGLOWSTYLEFORCHARACTER02_OFFSET UNITYSDK_OFFSET(0x12B39160)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETRIMGLOWSTYLEFORCHARACTER03_OFFSET UNITYSDK_OFFSET(0x12B391E0)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETRIMGLOWSTYLEFORCHARACTER04_OFFSET UNITYSDK_OFFSET(0x12B39260)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETRIMGLOWWIDTHFORCHARACTER_OFFSET UNITYSDK_OFFSET(0x12B38FC0)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETSATURATION_OFFSET UNITYSDK_OFFSET(0x12B38DC0)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETSATVSSAT_OFFSET UNITYSDK_OFFSET(0x12B39AE0)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETSHADOWFADETINT_OFFSET UNITYSDK_OFFSET(0x12B38A70)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETSHADOWTINT_OFFSET UNITYSDK_OFFSET(0x12B38930)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETSHALLOWFADETINT_OFFSET UNITYSDK_OFFSET(0x12B387F0)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETSHALLOWTINT_OFFSET UNITYSDK_OFFSET(0x12B386B0)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETSHOULDERANGLE_OFFSET UNITYSDK_OFFSET(0x12B39560)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETSHOULDERLENGTH_OFFSET UNITYSDK_OFFSET(0x12B394E0)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETSHOULDERSTRENGTH_OFFSET UNITYSDK_OFFSET(0x12B39460)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETSKINFRONTTINT_OFFSET UNITYSDK_OFFSET(0x12B38390)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETSKINSHADOWFADETINT_OFFSET UNITYSDK_OFFSET(0x12B389D0)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETSKINSHADOWTINT_OFFSET UNITYSDK_OFFSET(0x12B38890)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETSKINSHALLOWFADETINT_OFFSET UNITYSDK_OFFSET(0x12B38750)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETSKINSHALLOWTINT_OFFSET UNITYSDK_OFFSET(0x12B38610)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETSKINSSSTINT_OFFSET UNITYSDK_OFFSET(0x12B384D0)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETSSSTINT_OFFSET UNITYSDK_OFFSET(0x12B38570)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETTOELENGTH_OFFSET UNITYSDK_OFFSET(0x12B393E0)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETTOESTRENGTH_OFFSET UNITYSDK_OFFSET(0x12B39360)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETUSESHADOWTINTASOUTLINE_OFFSET UNITYSDK_OFFSET(0x12B38BB0)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION_GETWEAPONUSECUSTOMLIGHTPROPERTY_OFFSET UNITYSDK_OFFSET(0x12B38EC0)
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x12B39BC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityAvatarColorCorrection_TypeDefinitionIndex = 49664;

	class ConfigEntityAvatarColorCorrection : public ::MoleMole::Config::ConfigEntityScreenEffectBase
	{
	public:
		::MoleMole::Config::ScreenEffectColor* outlineTint; // 0x40
		::MoleMole::Config::ScreenEffectFloat* shoulderAngle; // 0x48
		::MoleMole::Config::ScreenEffectColor* ambient; // 0x50
		::MoleMole::Config::ScreenEffectColor* shallowTint; // 0x58
		::MoleMole::Config::ScreenEffectColor* skinShadowTint; // 0x60
		::MoleMole::Config::ScreenEffectFloat* toeStrength; // 0x68
		::UnityEngine::NAPRenderPipeline0::TextureCurve* master; // 0x70
		::MoleMole::Config::ScreenEffectFloat* rimGlowStyleForCharacter04; // 0x78
		::MoleMole::Config::ScreenEffectVector4* gain; // 0x80
		::MoleMole::Config::ScreenEffectFloat* rimGlowStyleForCharacter03; // 0x88
		::UnityEngine::NAPRenderPipeline0::TextureCurve* hueVsHue; // 0x90
		::MoleMole::Config::ScreenEffectColor* skinShadowFadeTint; // 0x98
		::MoleMole::Config::ScreenEffectColor* skinFrontTint; // 0xA0
		::MoleMole::Config::ScreenEffectBool* enable; // 0xA8
		::MoleMole::Config::ScreenEffectColor* skinShallowTint; // 0xB0
		::MoleMole::Config::ScreenEffectFloat* rimGlowWidthForCharacter; // 0xB8
		::MoleMole::Config::ScreenEffectBool* revertSaturation; // 0xC0
		::MoleMole::Config::ScreenEffectColor* shadowFadeTint; // 0xC8
		::UnityEngine::NAPRenderPipeline0::TextureCurve* satVsSat; // 0xD0
		::MoleMole::Config::ScreenEffectColor* ambientGradient; // 0xD8
		::MoleMole::Config::ScreenEffectColor* skinShallowFadeTint; // 0xE0
		::MoleMole::Config::ScreenEffectVector4* lift; // 0xE8
		::MoleMole::Config::ScreenEffectFloat* rimGlowIntensityForChara; // 0xF0
		::UnityEngine::NAPRenderPipeline0::TextureCurve* hueVsSat; // 0xF8
		::MoleMole::Config::ScreenEffectVector4* gamma; // 0x100
		::MoleMole::Config::ScreenEffectColor* shallowFadeTint; // 0x108
		::MoleMole::Config::ScreenEffectFloat* shoulderStrength; // 0x110
		::MoleMole::Config::ScreenEffectFloat* contrast; // 0x118
		::UnityEngine::NAPRenderPipeline0::TextureCurve* blue; // 0x120
		::UnityEngine::NAPRenderPipeline0::TextureCurve* red; // 0x128
		::MoleMole::Config::ScreenEffectFloat* rimGlowStyleForCharacter01; // 0x130
		::MoleMole::Config::ScreenEffectFloat* rimGlowStyleForCharacter02; // 0x138
		::MoleMole::Config::ScreenEffectFloat* customGamma; // 0x140
		::MoleMole::Config::ScreenEffectFloat* postExposure; // 0x148
		::MoleMole::Config::ScreenEffectBool* weaponUseCustomLightProperty; // 0x150
		::MoleMole::Config::ScreenEffectColor* rimGlowColorForCharacter; // 0x158
		::MoleMole::Config::ScreenEffectColor* frontTint; // 0x160
		::MoleMole::Config::ScreenEffectColor* shadowTint; // 0x168
		::MoleMole::Config::ScreenEffectFloat* saturation; // 0x170
		::MoleMole::Config::ScreenEffectFloat* shoulderLength; // 0x178
		::UnityEngine::NAPRenderPipeline0::TextureCurve* green; // 0x180
		::UnityEngine::NAPRenderPipeline0::TextureCurve* lumVsSat; // 0x188
		::MoleMole::Config::ScreenEffectFloat* toeLength; // 0x190
		::MoleMole::Config::ScreenEffectColor* skinSssTint; // 0x198
		::MoleMole::Config::ScreenEffectColor* sssTint; // 0x1A0
		::MoleMole::Config::ScreenEffectFieldHandleType weaponUseCustomLightPropertyHandleType; // 0x1A8
		::MoleMole::Config::ScreenEffectFieldHandleType rimGlowStyleForCharacter02HandleType; // 0x1AC
		::MoleMole::Config::ScreenEffectFieldHandleType skinShadowTintHandleType; // 0x1B0
		::MoleMole::Config::ScreenEffectFieldHandleType hueVsHueHandleType; // 0x1B4
		::MoleMole::Config::ScreenEffectFieldHandleType customGammaHandleType; // 0x1B8
		::MoleMole::Config::ScreenEffectFieldHandleType ambientHandleType; // 0x1BC
		::MoleMole::Config::ScreenEffectFieldHandleType contrastHandleType; // 0x1C0
		::MoleMole::Config::ScreenEffectFieldHandleType skinShallowFadeTintHandleType; // 0x1C4
		::MoleMole::Config::ScreenEffectFieldHandleType ambientGradientHandleType; // 0x1C8
		::MoleMole::Config::ScreenEffectFieldHandleType enableHandleType; // 0x1CC
		::MoleMole::Config::ScreenEffectFieldHandleType postExposureHandleType; // 0x1D0
		::MoleMole::Config::ScreenEffectFieldHandleType rimGlowStyleForCharacter04HandleType; // 0x1D4
		::MoleMole::Config::ScreenEffectFieldHandleType frontTintHandleType; // 0x1D8
		::MoleMole::Config::ScreenEffectFieldHandleType shoulderAngleHandleType; // 0x1DC
		::MoleMole::Config::ScreenEffectFieldHandleType liftHandleType; // 0x1E0
		::MoleMole::Config::ScreenEffectFieldHandleType greenHandleType; // 0x1E4
		::MoleMole::Config::ScreenEffectFieldHandleType rimGlowStyleForCharacter03HandleType; // 0x1E8
		::MoleMole::Config::ScreenEffectFieldHandleType toeLengthHandleType; // 0x1EC
		::MoleMole::Config::ScreenEffectFieldHandleType useShadowTintAsOutlineHandleType; // 0x1F0
		::MoleMole::Config::ScreenEffectFieldHandleType skinFrontTintHandleType; // 0x1F4
		::MoleMole::Config::ScreenEffectFieldHandleType rimGlowColorForCharacterHandleType; // 0x1F8
		::System::Boolean useShadowTintAsOutline; // 0x1FC
		::MoleMole::Config::ScreenEffectFieldHandleType shallowTintHandleType; // 0x200
		::MoleMole::Config::ScreenEffectFieldHandleType revertSaturationHandleType; // 0x204
		::MoleMole::Config::ScreenEffectFieldHandleType toeStrengthHandleType; // 0x208
		::MoleMole::Config::ScreenEffectFieldHandleType shoulderLengthHandleType; // 0x20C
		::MoleMole::Config::ScreenEffectFieldHandleType lumVsSatHandleType; // 0x210
		::MoleMole::Config::ScreenEffectFieldHandleType skinShallowTintHandleType; // 0x214
		::MoleMole::Config::ScreenEffectFieldHandleType shallowFadeTintHandleType; // 0x218
		::MoleMole::Config::ScreenEffectFieldHandleType shoulderStrengthHandleType; // 0x21C
		::MoleMole::Config::ScreenEffectFieldHandleType masterHandleType; // 0x220
		::MoleMole::Config::ScreenEffectFieldHandleType redHandleType; // 0x224
		::MoleMole::Config::ScreenEffectFieldHandleType outlineTintHandleType; // 0x228
		::MoleMole::Config::ScreenEffectFieldHandleType skinShadowFadeTintHandleType; // 0x22C
		::MoleMole::Config::ScreenEffectFieldHandleType rimGlowStyleForCharacter01HandleType; // 0x230
		::MoleMole::Config::ScreenEffectFieldHandleType shadowFadeTintHandleType; // 0x234
		::MoleMole::Config::ScreenEffectFieldHandleType rimGlowWidthForCharacterHandleType; // 0x238
		::MoleMole::Config::ScreenEffectFieldHandleType sssTintHandleType; // 0x23C
		::MoleMole::Config::ScreenEffectFieldHandleType rimGlowIntensityForCharaHandleType; // 0x240
		::MoleMole::Config::ScreenEffectFieldHandleType saturationHandleType; // 0x244
		::MoleMole::Config::ScreenEffectFieldHandleType blueHandleType; // 0x248
		::MoleMole::Config::ScreenEffectFieldHandleType shadowTintHandleType; // 0x24C
		::MoleMole::Config::ScreenEffectFieldHandleType gammaHandleType; // 0x250
		::MoleMole::Config::ScreenEffectFieldHandleType hueVsSatHandleType; // 0x254
		::MoleMole::Config::ScreenEffectFieldHandleType gainHandleType; // 0x258
		::MoleMole::Config::ScreenEffectFieldHandleType satVsSatHandleType; // 0x25C
		::MoleMole::Config::ScreenEffectFieldHandleType skinSssTintHandleType; // 0x260
