...
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0x12D34290)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_ISMATCH_OFFSET UNITYSDK_OFFSET(0x12D34330)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_RESET_OFFSET UNITYSDK_OFFSET(0x12D342E0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x12D34440)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraScopedFrontOverrideEffector_TypeDefinitionIndex = 78078;
