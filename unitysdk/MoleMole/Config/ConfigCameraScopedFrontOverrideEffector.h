...
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0x12B349F0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_ISMATCH_OFFSET UNITYSDK_OFFSET(0x12B34A90)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_RESET_OFFSET UNITYSDK_OFFSET(0x12B34A40)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x12B34BA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraScopedFrontOverrideEffector_TypeDefinitionIndex = 49624;
