...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWENABLEREFRESHPLAYERON_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x1424BAD0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWENABLEREFRESHPLAYERON__CTOR_OFFSET UNITYSDK_OFFSET(0x1424BB90)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowEnableRefreshPlayerOn_TypeDefinitionIndex = 60577;
