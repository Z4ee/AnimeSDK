...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDGROUPCHESSANIM_CUSTOMADDFUNCTION_OFFSET UNITYSDK_OFFSET(0xF97A370)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDGROUPCHESSANIM_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xF97A2B0)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDGROUPCHESSANIM__CTOR_OFFSET UNITYSDK_OFFSET(0xF97A3E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardGroupChessAnim_TypeDefinitionIndex = 42314;
	...
	public:
		...
		::System::Boolean UseCustomPivot; // 0x28
		::System::Boolean UseSpecific; // 0x29
		::System::Single OverrideWaitTime; // 0x2C
		::UnityEngine::Vector2 RadiateWaveTimeRange; // 0x30
		::MoleMole::Vector2Int RelativePos; // 0x38
		::MoleMole::Config::ConfigSetSection_Order ConfigOrder; // 0x40
		::UnityEngine::Vector2 InWaveTimeRange; // 0x44
