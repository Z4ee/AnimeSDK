...
#define MOLEMOLE_CONFIG_VOSTATEAUDIOPORTALCONDITION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17D6D630)
#define MOLEMOLE_CONFIG_VOSTATEAUDIOPORTALCONDITION_FROMFLX_OFFSET UNITYSDK_OFFSET(0x17D6D120)
#define MOLEMOLE_CONFIG_VOSTATEAUDIOPORTALCONDITION_METHOD_1_DF413489329CBAF8_OFFSET UNITYSDK_OFFSET(0x17D6D1A0)
#define MOLEMOLE_CONFIG_VOSTATEAUDIOPORTALCONDITION_METHOD_1_FC98BB22B7077EE4_OFFSET UNITYSDK_OFFSET(0x17D6D690)
#define MOLEMOLE_CONFIG_VOSTATEAUDIOPORTALCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x17D6D960)

namespace MoleMole::Config
{
	inline static constexpr unsigned int VOStateAudioPortalCondition_TypeDefinitionIndex = 62297;
