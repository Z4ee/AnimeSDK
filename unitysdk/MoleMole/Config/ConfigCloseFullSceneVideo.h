...
#define MOLEMOLE_CONFIG_CONFIGCLOSEFULLSCENEVIDEO_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x162A8C90)
#define MOLEMOLE_CONFIG_CONFIGCLOSEFULLSCENEVIDEO__CTOR_OFFSET UNITYSDK_OFFSET(0x162A8D50)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCloseFullSceneVideo_TypeDefinitionIndex = 39563;
