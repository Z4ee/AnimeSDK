...
#define MOLEMOLE_CONFIG_ETHEREYESOBJECTCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x8629C0)
#define MOLEMOLE_CONFIG_ETHEREYESOBJECTCONFIG_FROMFLX_OFFSET UNITYSDK_OFFSET(0x862930)
#define MOLEMOLE_CONFIG_ETHEREYESOBJECTCONFIG_METHOD_2_723D4849983651D2_OFFSET UNITYSDK_OFFSET(0x862A20)
#define MOLEMOLE_CONFIG_ETHEREYESOBJECTCONFIG_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x862A30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int EtherEyesObjectConfig_TypeDefinitionIndex = 77178;
