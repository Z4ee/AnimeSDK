...
#define MOLEMOLE_CONFIG_CAMPTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x10CF9730)

namespace MoleMole::Config
{
	inline static constexpr unsigned int CampTypeConfig_TypeDefinitionIndex = 59169;
