...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICOBJECTCOLLIDER_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x1BD55BC0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICOBJECTCOLLIDER_CLEAN_OFFSET UNITYSDK_OFFSET(0x1BD55D60)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICOBJECTCOLLIDER_DEALLOCATE_OFFSET UNITYSDK_OFFSET(0x1BD55C50)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICOBJECTCOLLIDER_GETCOLLIDERTYPE_OFFSET UNITYSDK_OFFSET(0x1BD55E40)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICOBJECTCOLLIDER_GETLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1BD55E90)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICOBJECTCOLLIDER_GETPREFABNAME_OFFSET UNITYSDK_OFFSET(0x1BD55DD0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICOBJECTCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD55F20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicObjectCollider_TypeDefinitionIndex = 90253;
