...
#define MOLEMOLE_CONFIG_ANIMATORZONECAMERAMOVEMENTCONFIGMODE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x17032A50)
#define MOLEMOLE_CONFIG_ANIMATORZONECAMERAMOVEMENTCONFIGMODE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x170323E0)
#define MOLEMOLE_CONFIG_ANIMATORZONECAMERAMOVEMENTCONFIGMODE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x17032940)
#define MOLEMOLE_CONFIG_ANIMATORZONECAMERAMOVEMENTCONFIGMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x17032AE0)
#define MOLEMOLE_CONFIG_ANIMATORZONECAMERAMOVEMENTCONFIGMODE___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x17032AF0)
#define MOLEMOLE_CONFIG_ANIMATORZONECAMERAMOVEMENTCONFIGMODE___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x17032BC0)
#define MOLEMOLE_CONFIG_ANIMATORZONECAMERAMOVEMENTCONFIGMODE___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x17032C70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneCameraMovementConfigMode_TypeDefinitionIndex = 47089;
