...
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_CLONE_OFFSET UNITYSDK_OFFSET(0x172A0850)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x172A0800)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x172A0D10)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_FROMFLX_OFFSET UNITYSDK_OFFSET(0x172A0960)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x172A0950)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x172A0D70)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x172A09E0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x172A0F00)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x172A0BB0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0x172A06B0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x172A10B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynmaicValueListGameplayTag_TypeDefinitionIndex = 45549;
