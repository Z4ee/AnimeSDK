...
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_CLONE_OFFSET UNITYSDK_OFFSET(0x123053E0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x12305390)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x12305930)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_FROMFLX_OFFSET UNITYSDK_OFFSET(0x12305550)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x123054E0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x12305990)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x123055D0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x12305B20)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x123057D0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0x12305240)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x12305CD0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynmaicValueListGameplayTag_TypeDefinitionIndex = 60828;
