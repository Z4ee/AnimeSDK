...
#define MOLEMOLE_CONFIG_CHESSBOARDGICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19295580)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ChessboardGIConfig_TypeDefinitionIndex = 85104;
