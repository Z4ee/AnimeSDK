...
#define MOLEMOLE_CONFIG_CONFIGENTITYDISTORTIONEFFECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x177DC370)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityDistortionEffects_TypeDefinitionIndex = 80074;
