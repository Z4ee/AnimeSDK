...
#define MOLEMOLE_CONFIG_BASEDATATRAIT_CLONE_OFFSET UNITYSDK_OFFSET(0x16256550)
#define MOLEMOLE_CONFIG_BASEDATATRAIT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x16256500)
#define MOLEMOLE_CONFIG_BASEDATATRAIT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16256A30)
#define MOLEMOLE_CONFIG_BASEDATATRAIT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x16256660)
#define MOLEMOLE_CONFIG_BASEDATATRAIT_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x16256EE0)
#define MOLEMOLE_CONFIG_BASEDATATRAIT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x16256650)
#define MOLEMOLE_CONFIG_BASEDATATRAIT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x16256A90)
#define MOLEMOLE_CONFIG_BASEDATATRAIT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x162566E0)
#define MOLEMOLE_CONFIG_BASEDATATRAIT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x16256D30)
#define MOLEMOLE_CONFIG_BASEDATATRAIT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x162568D0)
#define MOLEMOLE_CONFIG_BASEDATATRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x16256F80)
#define MOLEMOLE_CONFIG_BASEDATATRAIT___BASE_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x16256F90)

namespace MoleMole::Config
{
	inline static constexpr unsigned int BaseDataTrait_TypeDefinitionIndex = 68836;
	...
	public:
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_BE29B49AC03370B6*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_BASEDATATRAIT_GENERATECOMPONENT_OFFSET))(this, buildContext);
		}

		::System::Boolean __base_GenerateComponent(::Class_1_BE29B49AC03370B6* P0)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_BE29B49AC03370B6*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_BASEDATATRAIT___BASE_GENERATECOMPONENT_OFFSET))(this, P0);
		}
	};
}
