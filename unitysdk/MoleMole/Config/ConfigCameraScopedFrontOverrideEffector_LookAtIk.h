...
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_LOOKATIK_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0xF979CE0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_LOOKATIK_RESET_OFFSET UNITYSDK_OFFSET(0xF979D60)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_LOOKATIK__CTOR_OFFSET UNITYSDK_OFFSET(0xF979E10)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_LOOKATIK___BASE_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0xF979E20)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_LOOKATIK___BASE_RESET_OFFSET UNITYSDK_OFFSET(0xF979EB0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraScopedFrontOverrideEffector_LookAtIk_TypeDefinitionIndex = 38934;
