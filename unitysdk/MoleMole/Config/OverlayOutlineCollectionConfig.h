...
#define MOLEMOLE_CONFIG_OVERLAYOUTLINECOLLECTIONCONFIG_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B926150)
#define MOLEMOLE_CONFIG_OVERLAYOUTLINECOLLECTIONCONFIG_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B925F50)
#define MOLEMOLE_CONFIG_OVERLAYOUTLINECOLLECTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9263F0)
#define MOLEMOLE_CONFIG_OVERLAYOUTLINECOLLECTIONCONFIG___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B926550)
#define MOLEMOLE_CONFIG_OVERLAYOUTLINECOLLECTIONCONFIG___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B926560)

namespace MoleMole::Config
{
	inline static constexpr unsigned int OverlayOutlineCollectionConfig_TypeDefinitionIndex = 43457;
