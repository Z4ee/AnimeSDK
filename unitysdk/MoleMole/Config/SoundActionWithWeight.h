...
#define MOLEMOLE_CONFIG_SOUNDACTIONWITHWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9277A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SoundActionWithWeight_TypeDefinitionIndex = 51161;
