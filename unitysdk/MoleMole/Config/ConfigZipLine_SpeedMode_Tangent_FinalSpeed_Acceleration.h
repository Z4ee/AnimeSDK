...
#define MOLEMOLE_CONFIG_CONFIGZIPLINE_SPEEDMODE_TANGENT_FINALSPEED_ACCELERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x10D0DAC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigZipLine_SpeedMode_Tangent_FinalSpeed_Acceleration_TypeDefinitionIndex = 51240;
