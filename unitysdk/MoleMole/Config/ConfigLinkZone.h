...
#define MOLEMOLE_CONFIG_CONFIGLINKZONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A069610)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigLinkZone_TypeDefinitionIndex = 57776;
