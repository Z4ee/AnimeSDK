...
#define MOLEMOLE_CONFIG_CONFIGLINKZONE__CTOR_OFFSET UNITYSDK_OFFSET(0x177DF1B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigLinkZone_TypeDefinitionIndex = 81048;
