...
#define MOLEMOLE_CONFIG_CONFIGCOOPVFXQUALITYSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B548280)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCoopVFXQualitySetting_TypeDefinitionIndex = 78936;
