...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDINDICATORLIGHT__CCTOR_OFFSET UNITYSDK_OFFSET(0x11474AE0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDINDICATORLIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x11474A00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboardIndicatorLight_TypeDefinitionIndex = 60083;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ConfigHollowChessboardIndicatorLight_TypeDefinitionIndex)->GetStaticField(0x46C10);
		}
