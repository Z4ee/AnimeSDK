...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDINDICATORLIGHT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AA516E0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDINDICATORLIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA51600)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboardIndicatorLight_TypeDefinitionIndex = 72418;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ConfigHollowChessboardIndicatorLight_TypeDefinitionIndex)->GetStaticField(0x42C10);
		}
