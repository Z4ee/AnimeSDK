...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORINTPARAM_CLONE_OFFSET UNITYSDK_OFFSET(0xF97AAF0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORINTPARAM_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0xF97AAA0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORINTPARAM_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xF97B0D0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORINTPARAM_FROMFLX_OFFSET UNITYSDK_OFFSET(0xF97AC60)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORINTPARAM_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0xF97ABF0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORINTPARAM_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0xF97B130)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORINTPARAM_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0xF97ACE0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORINTPARAM_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0xF97B2D0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORINTPARAM_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0xF97AF70)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORINTPARAM_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0xF97A950)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORINTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xF97B480)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicValueListAnimatorIntParam_TypeDefinitionIndex = 55514;
