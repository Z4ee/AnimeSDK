...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORINTPARAM_CLONE_OFFSET UNITYSDK_OFFSET(0x1109FAE0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORINTPARAM_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x1109FA90)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORINTPARAM_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x110A00C0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORINTPARAM_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1109FC50)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORINTPARAM_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x1109FBE0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORINTPARAM_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x110A0120)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORINTPARAM_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x1109FCD0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORINTPARAM_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x110A02C0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORINTPARAM_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x1109FF60)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORINTPARAM_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0x1109F940)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORINTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x110A0470)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicValueListAnimatorIntParam_TypeDefinitionIndex = 81716;
