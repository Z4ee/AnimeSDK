...
#define MOLEMOLE_CONFIG_CONFIGATTACHMENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1485C930)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAttachments_TypeDefinitionIndex = 48396;
