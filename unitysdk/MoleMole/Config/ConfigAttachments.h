...
#define MOLEMOLE_CONFIG_CONFIGATTACHMENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x19295D40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAttachments_TypeDefinitionIndex = 45199;
