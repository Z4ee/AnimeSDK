...
#define MOLEMOLE_CONFIG_ANIMATORZONESETBUDDYCONTROLMOVEY_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x144D1550)
#define MOLEMOLE_CONFIG_ANIMATORZONESETBUDDYCONTROLMOVEY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x144D1BC0)
#define MOLEMOLE_CONFIG_ANIMATORZONESETBUDDYCONTROLMOVEY_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x144D15E0)
#define MOLEMOLE_CONFIG_ANIMATORZONESETBUDDYCONTROLMOVEY_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x144D1E60)
#define MOLEMOLE_CONFIG_ANIMATORZONESETBUDDYCONTROLMOVEY__CTOR_OFFSET UNITYSDK_OFFSET(0x144D1F90)
#define MOLEMOLE_CONFIG_ANIMATORZONESETBUDDYCONTROLMOVEY___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x144D1FA0)
#define MOLEMOLE_CONFIG_ANIMATORZONESETBUDDYCONTROLMOVEY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x144D2070)
#define MOLEMOLE_CONFIG_ANIMATORZONESETBUDDYCONTROLMOVEY___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x144D2130)
#define MOLEMOLE_CONFIG_ANIMATORZONESETBUDDYCONTROLMOVEY___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x144D21E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneSetBuddyControlMoveY_TypeDefinitionIndex = 58832;

	class AnimatorZoneSetBuddyControlMoveY : public ::MoleMole::Config::AnimatorZone
	{
	public:
		::System::String* speedAnimatorParameter; // 0x50
		::System::Single targetSpeed; // 0x58
