...
#define MOLEMOLE_CONFIG_CONFIGFLOWCANVAS__CTOR_OFFSET UNITYSDK_OFFSET(0x175356D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigFlowCanvas_TypeDefinitionIndex = 38225;
