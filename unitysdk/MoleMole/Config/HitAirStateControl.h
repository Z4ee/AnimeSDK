...
#define MOLEMOLE_CONFIG_HITAIRSTATECONTROL_CLONE_OFFSET UNITYSDK_OFFSET(0x12436E60)
#define MOLEMOLE_CONFIG_HITAIRSTATECONTROL_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x12436E50)
#define MOLEMOLE_CONFIG_HITAIRSTATECONTROL_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x12437370)
#define MOLEMOLE_CONFIG_HITAIRSTATECONTROL_FROMFLX_OFFSET UNITYSDK_OFFSET(0x12436FD0)
#define MOLEMOLE_CONFIG_HITAIRSTATECONTROL_GETCONTROLTIMEPOINTLIST_OFFSET UNITYSDK_OFFSET(0x124376E0)
#define MOLEMOLE_CONFIG_HITAIRSTATECONTROL_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x12436F60)
#define MOLEMOLE_CONFIG_HITAIRSTATECONTROL_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x124373D0)
#define MOLEMOLE_CONFIG_HITAIRSTATECONTROL_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x12437050)
#define MOLEMOLE_CONFIG_HITAIRSTATECONTROL_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x12437530)
#define MOLEMOLE_CONFIG_HITAIRSTATECONTROL_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x12437210)
#define MOLEMOLE_CONFIG_HITAIRSTATECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x12437860)
#define MOLEMOLE_CONFIG_HITAIRSTATECONTROL___BASE_GETCONTROLTIMEPOINTLIST_OFFSET UNITYSDK_OFFSET(0x12437870)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HitAirStateControl_TypeDefinitionIndex = 62732;
