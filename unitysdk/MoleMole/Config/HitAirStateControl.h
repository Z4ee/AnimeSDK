...
#define MOLEMOLE_CONFIG_HITAIRSTATECONTROL_CLONE_OFFSET UNITYSDK_OFFSET(0x1C46CB40)
#define MOLEMOLE_CONFIG_HITAIRSTATECONTROL_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x1C46CB30)
#define MOLEMOLE_CONFIG_HITAIRSTATECONTROL_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C46CFD0)
#define MOLEMOLE_CONFIG_HITAIRSTATECONTROL_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1C46CC50)
#define MOLEMOLE_CONFIG_HITAIRSTATECONTROL_GETCONTROLTIMEPOINTLIST_OFFSET UNITYSDK_OFFSET(0x1C46D340)
#define MOLEMOLE_CONFIG_HITAIRSTATECONTROL_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x1C46CC40)
#define MOLEMOLE_CONFIG_HITAIRSTATECONTROL_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C46D030)
#define MOLEMOLE_CONFIG_HITAIRSTATECONTROL_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x1C46CCD0)
#define MOLEMOLE_CONFIG_HITAIRSTATECONTROL_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C46D190)
#define MOLEMOLE_CONFIG_HITAIRSTATECONTROL_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x1C46CE70)
#define MOLEMOLE_CONFIG_HITAIRSTATECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C46D4C0)
#define MOLEMOLE_CONFIG_HITAIRSTATECONTROL___BASE_GETCONTROLTIMEPOINTLIST_OFFSET UNITYSDK_OFFSET(0x1C46D4D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HitAirStateControl_TypeDefinitionIndex = 57895;
