...
#define MOLEMOLE_CONFIG_CONFIGCOLLIDERREGISTERDATA_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x8296A0)
#define MOLEMOLE_CONFIG_CONFIGCOLLIDERREGISTERDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x829740)
#define MOLEMOLE_CONFIG_CONFIGCOLLIDERREGISTERDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x8296B0)
#define MOLEMOLE_CONFIG_CONFIGCOLLIDERREGISTERDATA_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x8297A0)
#define MOLEMOLE_CONFIG_CONFIGCOLLIDERREGISTERDATA_METHOD_2_F777B3BEDBE68D53_OFFSET UNITYSDK_OFFSET(0x8297D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigColliderRegisterData_TypeDefinitionIndex = 46930;
	...
	struct alignas(8) ConfigColliderRegisterData
	{
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_175*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGCOLLIDERREGISTERDATA_EXPOSEMEMBER_OFFSET))(this, a1, a2);
		}
