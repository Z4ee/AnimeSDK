...
#define MOLEMOLE_CONFIG_CONFIGENTITYSHAREDANIMEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x159EC5D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntitySharedAnimEvents_TypeDefinitionIndex = 52295;
