...
#define MOLEMOLE_CONFIG_CONFIGANIMATORTRIGGERPARAM_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x7B9600)
#define MOLEMOLE_CONFIG_CONFIGANIMATORTRIGGERPARAM_FROMFLX_OFFSET UNITYSDK_OFFSET(0x7B9570)
#define MOLEMOLE_CONFIG_CONFIGANIMATORTRIGGERPARAM_METHOD_2_ADFCC0DC85F98B9C_OFFSET UNITYSDK_OFFSET(0x7B9660)
#define MOLEMOLE_CONFIG_CONFIGANIMATORTRIGGERPARAM_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x7B9670)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAnimatorTriggerParam_TypeDefinitionIndex = 51164;
