...
#define MOLEMOLE_CONFIG_CONFIGOVERLORDFEAST__CTOR_OFFSET UNITYSDK_OFFSET(0x159F3CF0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigOverlordFeast_TypeDefinitionIndex = 77935;
