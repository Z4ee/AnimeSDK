...
#define MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17D4A260)
#define MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x17D49E50)
#define MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENT_METHOD_1_1A0B790695E07CE5_OFFSET UNITYSDK_OFFSET(0x17D4A2C0)
#define MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENT_METHOD_1_5B0202969299569F_OFFSET UNITYSDK_OFFSET(0x17D49ED0)
#define MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x17D4A4D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAbilityFragment_TypeDefinitionIndex = 56586;
