...
#define MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x123001E0)
#define MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x122FFDD0)
#define MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENT_METHOD_1_1A0B790695E07CE5_OFFSET UNITYSDK_OFFSET(0x12300240)
#define MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENT_METHOD_1_5B0202969299569F_OFFSET UNITYSDK_OFFSET(0x122FFE50)
#define MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x12300450)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAbilityFragment_TypeDefinitionIndex = 49680;
