...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEEMPTY_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0x186AEB90)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEEMPTY__CTOR_OFFSET UNITYSDK_OFFSET(0x186AEC30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicValueEmpty_TypeDefinitionIndex = 42284;
