...
#define MOLEMOLE_CONFIG_WINDFIELDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1487DCE0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int WindFieldConfig_TypeDefinitionIndex = 78322;
