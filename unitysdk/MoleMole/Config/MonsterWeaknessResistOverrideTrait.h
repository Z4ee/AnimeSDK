...
#define MOLEMOLE_CONFIG_MONSTERWEAKNESSRESISTOVERRIDETRAIT_CLONE_OFFSET UNITYSDK_OFFSET(0x19FF6F40)
#define MOLEMOLE_CONFIG_MONSTERWEAKNESSRESISTOVERRIDETRAIT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x19FF6F30)
#define MOLEMOLE_CONFIG_MONSTERWEAKNESSRESISTOVERRIDETRAIT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19FF7480)
#define MOLEMOLE_CONFIG_MONSTERWEAKNESSRESISTOVERRIDETRAIT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x19FF70B0)
#define MOLEMOLE_CONFIG_MONSTERWEAKNESSRESISTOVERRIDETRAIT_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x19FF7950)
#define MOLEMOLE_CONFIG_MONSTERWEAKNESSRESISTOVERRIDETRAIT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x19FF7040)
#define MOLEMOLE_CONFIG_MONSTERWEAKNESSRESISTOVERRIDETRAIT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x19FF74E0)
#define MOLEMOLE_CONFIG_MONSTERWEAKNESSRESISTOVERRIDETRAIT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x19FF7130)
#define MOLEMOLE_CONFIG_MONSTERWEAKNESSRESISTOVERRIDETRAIT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x19FF7750)
#define MOLEMOLE_CONFIG_MONSTERWEAKNESSRESISTOVERRIDETRAIT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x19FF7320)
#define MOLEMOLE_CONFIG_MONSTERWEAKNESSRESISTOVERRIDETRAIT_POSTBUILDENTITYCOMPONENT_OFFSET UNITYSDK_OFFSET(0x19FF7900)
#define MOLEMOLE_CONFIG_MONSTERWEAKNESSRESISTOVERRIDETRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF79F0)
#define MOLEMOLE_CONFIG_MONSTERWEAKNESSRESISTOVERRIDETRAIT___BASE_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x19FF7A00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int MonsterWeaknessResistOverrideTrait_TypeDefinitionIndex = 64784;
	...
	public:
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_53842913455A8556*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_MONSTERWEAKNESSRESISTOVERRIDETRAIT_GENERATECOMPONENT_OFFSET))(this, buildContext);
		}

		::System::Boolean __base_GenerateComponent(::Class_1_53842913455A8556* P0)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_53842913455A8556*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_MONSTERWEAKNESSRESISTOVERRIDETRAIT___BASE_GENERATECOMPONENT_OFFSET))(this, P0);
		}
	};
}
