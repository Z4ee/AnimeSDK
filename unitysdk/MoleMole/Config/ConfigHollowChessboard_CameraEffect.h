...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_CAMERAEFFECT_GETSUPPORTEDDURATIONTYPE_OFFSET UNITYSDK_OFFSET(0x12717560)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_CAMERAEFFECT_GET_TOTALDURATION_OFFSET UNITYSDK_OFFSET(0x12717550)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_CAMERAEFFECT_RUN_OFFSET UNITYSDK_OFFSET(0x12717450)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_CAMERAEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x127175B0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_CAMERAEFFECT___BASE_GETSUPPORTEDDURATIONTYPE_OFFSET UNITYSDK_OFFSET(0x127175C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_CameraEffect_TypeDefinitionIndex = 64418;
