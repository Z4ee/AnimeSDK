...
#define MOLEMOLE_CONFIG_CONFIGPATROLPOINTSET_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x1A06CA50)
#define MOLEMOLE_CONFIG_CONFIGPATROLPOINTSET_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A06D940)
#define MOLEMOLE_CONFIG_CONFIGPATROLPOINTSET_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1A06CC60)
#define MOLEMOLE_CONFIG_CONFIGPATROLPOINTSET_METHOD_1_0BD393E566CD3D4A_OFFSET UNITYSDK_OFFSET(0x1A06CCE0)
#define MOLEMOLE_CONFIG_CONFIGPATROLPOINTSET_METHOD_1_2D08867FA34F8CAE_OFFSET UNITYSDK_OFFSET(0x1A06D9A0)
#define MOLEMOLE_CONFIG_CONFIGPATROLPOINTSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A06DE40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPatrolPointSet_TypeDefinitionIndex = 59255;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_175*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPATROLPOINTSET_EXPOSEMEMBER_OFFSET))(this, a1, a2);
		}
