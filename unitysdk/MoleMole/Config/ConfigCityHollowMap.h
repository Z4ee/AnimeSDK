...
#define MOLEMOLE_CONFIG_CONFIGCITYHOLLOWMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1729DA00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCityHollowMap_TypeDefinitionIndex = 74221;
