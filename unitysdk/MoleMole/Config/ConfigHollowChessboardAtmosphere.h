...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDATMOSPHERE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD5D9D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboardAtmosphere_TypeDefinitionIndex = 53089;
