...
#define MOLEMOLE_CONFIG_CONFIGENTITYAUTOEXPOSUREEFFECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x12713D00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityAutoExposureEffects_TypeDefinitionIndex = 84285;
