...
#define MOLEMOLE_CONFIG_CONFIGUIENDFUNCTIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA64D70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUIEndFunctionNode_TypeDefinitionIndex = 76507;
