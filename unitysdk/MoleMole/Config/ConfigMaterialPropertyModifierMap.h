...
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYMODIFIERMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x183C32C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMaterialPropertyModifierMap_TypeDefinitionIndex = 66435;
