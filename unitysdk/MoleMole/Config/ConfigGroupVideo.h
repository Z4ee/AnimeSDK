...
#define MOLEMOLE_CONFIG_CONFIGGROUPVIDEO__CTOR_OFFSET UNITYSDK_OFFSET(0x11709DD0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigGroupVideo_TypeDefinitionIndex = 62212;
