...
#define MOLEMOLE_CONFIG_UIACHIEVEMENTANIMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1487D630)

namespace MoleMole::Config
{
	inline static constexpr unsigned int UIAchievementAnimConfig_TypeDefinitionIndex = 79480;
