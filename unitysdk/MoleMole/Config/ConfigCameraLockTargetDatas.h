...
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETDATAS_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1BD50330)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETDATAS_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1BD4FFA0)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETDATAS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD50750)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETDATAS___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1BD50970)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETDATAS___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1BD50980)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraLockTargetDatas_TypeDefinitionIndex = 79377;
