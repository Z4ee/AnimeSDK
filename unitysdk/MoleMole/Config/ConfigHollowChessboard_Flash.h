...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_FLASH_GETSUPPORTEDDURATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1BD5D720)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_FLASH_GET_TOTALDURATION_OFFSET UNITYSDK_OFFSET(0x1BD5D710)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_FLASH_RUN_OFFSET UNITYSDK_OFFSET(0x1BD5D580)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_FLASH__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD5D770)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_FLASH___BASE_GETSUPPORTEDDURATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1BD5D890)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_Flash_TypeDefinitionIndex = 59289;
