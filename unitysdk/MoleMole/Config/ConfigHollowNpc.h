...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x16A90D40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowNpc_TypeDefinitionIndex = 69631;
