...
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_CONTROLLER_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0x10CFCD90)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_CONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0x10CFCE10)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_CONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x10CFCEC0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_CONTROLLER___BASE_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0x10CFCED0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_CONTROLLER___BASE_RESET_OFFSET UNITYSDK_OFFSET(0x10CFCF60)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraScopedFrontOverrideEffector_Controller_TypeDefinitionIndex = 78075;
