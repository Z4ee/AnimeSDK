...
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_CONTROLLER_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0x116FC4D0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_CONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0x116FC550)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_CONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x116FC600)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_CONTROLLER___BASE_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0x116FC610)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_CONTROLLER___BASE_RESET_OFFSET UNITYSDK_OFFSET(0x116FC6A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraScopedFrontOverrideEffector_Controller_TypeDefinitionIndex = 87867;
