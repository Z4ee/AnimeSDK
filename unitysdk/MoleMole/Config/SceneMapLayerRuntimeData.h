...
#define MOLEMOLE_CONFIG_SCENEMAPLAYERRUNTIMEDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x11CB7BB0)
#define MOLEMOLE_CONFIG_SCENEMAPLAYERRUNTIMEDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x11CB77D0)
#define MOLEMOLE_CONFIG_SCENEMAPLAYERRUNTIMEDATA_METHOD_1_25996F1180FB0C28_OFFSET UNITYSDK_OFFSET(0x11CB7C10)
#define MOLEMOLE_CONFIG_SCENEMAPLAYERRUNTIMEDATA_METHOD_1_5B0202969299569F_OFFSET UNITYSDK_OFFSET(0x11CB7850)
#define MOLEMOLE_CONFIG_SCENEMAPLAYERRUNTIMEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x11CB7EC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SceneMapLayerRuntimeData_TypeDefinitionIndex = 80336;
