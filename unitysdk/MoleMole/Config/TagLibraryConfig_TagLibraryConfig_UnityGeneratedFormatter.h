...
#define MOLEMOLE_CONFIG_TAGLIBRARYCONFIG_TAGLIBRARYCONFIG_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x170CE7C0)
#define MOLEMOLE_CONFIG_TAGLIBRARYCONFIG_TAGLIBRARYCONFIG_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x170CE7D0)
#define MOLEMOLE_CONFIG_TAGLIBRARYCONFIG_TAGLIBRARYCONFIG_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x170CE9B0)
#define MOLEMOLE_CONFIG_TAGLIBRARYCONFIG_TAGLIBRARYCONFIG_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x170CEB50)
#define MOLEMOLE_CONFIG_TAGLIBRARYCONFIG_TAGLIBRARYCONFIG_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x170CEB10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int TagLibraryConfig_TagLibraryConfig_UnityGeneratedFormatter_TypeDefinitionIndex = 67703;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::List_1<::System::String*>*>*>**)Il2CppClass::FromTypeDefinitionIndex(TagLibraryConfig_TagLibraryConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x48470);
		}
