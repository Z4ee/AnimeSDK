...
#define MOLEMOLE_CONFIG_CONFIGPITYFILLINGGROUPREGISTERRULE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x175390B0)
#define MOLEMOLE_CONFIG_CONFIGPITYFILLINGGROUPREGISTERRULE_FROMFLX_OFFSET UNITYSDK_OFFSET(0x17538E30)
#define MOLEMOLE_CONFIG_CONFIGPITYFILLINGGROUPREGISTERRULE_METHOD_2_157E312840A3BD00_OFFSET UNITYSDK_OFFSET(0x17539110)
#define MOLEMOLE_CONFIG_CONFIGPITYFILLINGGROUPREGISTERRULE_METHOD_2_5B0202969299569F_OFFSET UNITYSDK_OFFSET(0x17538EB0)
#define MOLEMOLE_CONFIG_CONFIGPITYFILLINGGROUPREGISTERRULE_METHOD_2_6704D57D4F412560_OFFSET UNITYSDK_OFFSET(0x17538CC0)
#define MOLEMOLE_CONFIG_CONFIGPITYFILLINGGROUPREGISTERRULE_METHOD_2_820393D543EA4470_OFFSET UNITYSDK_OFFSET(0x17539530)
#define MOLEMOLE_CONFIG_CONFIGPITYFILLINGGROUPREGISTERRULE_METHOD_2_8C3810F9F6A2DA66_OFFSET UNITYSDK_OFFSET(0x17539380)
#define MOLEMOLE_CONFIG_CONFIGPITYFILLINGGROUPREGISTERRULE_METHOD_2_B73F62522113F21F_OFFSET UNITYSDK_OFFSET(0x17538C70)
#define MOLEMOLE_CONFIG_CONFIGPITYFILLINGGROUPREGISTERRULE_METHOD_2_C444D4C8B9D548AF_OFFSET UNITYSDK_OFFSET(0x17538DC0)
#define MOLEMOLE_CONFIG_CONFIGPITYFILLINGGROUPREGISTERRULE__CTOR_OFFSET UNITYSDK_OFFSET(0x17539370)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPityFillingGroupRegisterRule_TypeDefinitionIndex = 38640;
