...
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYBODYSIZEANDSECTION_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x10CF96A0)
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYBODYSIZEANDSECTION_PASS_OFFSET UNITYSDK_OFFSET(0x10CF94D0)
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYBODYSIZEANDSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x10CF96B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int CameraStoryDataActiveConditionByBodySizeAndSection_TypeDefinitionIndex = 43562;
