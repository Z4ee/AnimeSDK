...
#define MOLEMOLE_CONFIG_CONFIGSPECIALEFFECTHITWALL__CTOR_OFFSET UNITYSDK_OFFSET(0x1753C400)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSpecialEffectHitWall_TypeDefinitionIndex = 42457;
