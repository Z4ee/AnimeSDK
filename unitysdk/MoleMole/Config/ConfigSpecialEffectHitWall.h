...
#define MOLEMOLE_CONFIG_CONFIGSPECIALEFFECTHITWALL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD62FC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSpecialEffectHitWall_TypeDefinitionIndex = 76745;
