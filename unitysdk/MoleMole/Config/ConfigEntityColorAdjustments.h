...
#define MOLEMOLE_CONFIG_CONFIGENTITYCOLORADJUSTMENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD5AAA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityColorAdjustments_TypeDefinitionIndex = 86108;
