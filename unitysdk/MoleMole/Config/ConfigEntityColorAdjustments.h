...
#define MOLEMOLE_CONFIG_CONFIGENTITYCOLORADJUSTMENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x144DDF20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityColorAdjustments_TypeDefinitionIndex = 45318;
