...
#define MOLEMOLE_CONFIG_CONFIGCAMERAZOOMS__CTOR_OFFSET UNITYSDK_OFFSET(0x17D4C5C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraZooms_TypeDefinitionIndex = 44987;
