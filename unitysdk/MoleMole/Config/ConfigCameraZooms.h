...
#define MOLEMOLE_CONFIG_CONFIGCAMERAZOOMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1729D010)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraZooms_TypeDefinitionIndex = 55760;
