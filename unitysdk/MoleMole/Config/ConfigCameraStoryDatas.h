...
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_GETCONFIGINTERNAL_1_OFFSET UNITYSDK_OFFSET(0x14367E40)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_GETCONFIGINTERNAL_OFFSET UNITYSDK_OFFSET(0x14367A80)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_GETCONFIGKEYS_OFFSET UNITYSDK_OFFSET(0x14367F30)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_GETCONFIG_1_OFFSET UNITYSDK_OFFSET(0x14367A00)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_GETCONFIG_OFFSET UNITYSDK_OFFSET(0x14367710)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_GETFIXEDCAMERACONFIG_OFFSET UNITYSDK_OFFSET(0x14367830)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_GETFRAMETWOSHAPECONFIG_OFFSET UNITYSDK_OFFSET(0x14367910)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x14367FB0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS__CTOR_OFFSET UNITYSDK_OFFSET(0x143681F0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x143684B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraStoryDatas_TypeDefinitionIndex = 68148;
