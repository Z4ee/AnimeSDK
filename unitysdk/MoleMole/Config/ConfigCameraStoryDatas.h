...
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_GETCONFIGINTERNAL_1_OFFSET UNITYSDK_OFFSET(0x16A829E0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_GETCONFIGINTERNAL_OFFSET UNITYSDK_OFFSET(0x16A82620)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_GETCONFIGKEYS_OFFSET UNITYSDK_OFFSET(0x16A82AD0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_GETCONFIG_1_OFFSET UNITYSDK_OFFSET(0x16A825A0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_GETCONFIG_OFFSET UNITYSDK_OFFSET(0x16A822B0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_GETFIXEDCAMERACONFIG_OFFSET UNITYSDK_OFFSET(0x16A823D0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_GETFRAMETWOSHAPECONFIG_OFFSET UNITYSDK_OFFSET(0x16A824B0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x16A82B50)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS__CTOR_OFFSET UNITYSDK_OFFSET(0x16A82D90)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x16A83050)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraStoryDatas_TypeDefinitionIndex = 68903;
