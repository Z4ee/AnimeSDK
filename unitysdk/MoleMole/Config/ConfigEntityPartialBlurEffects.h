...
#define MOLEMOLE_CONFIG_CONFIGENTITYPARTIALBLUREFFECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x11028C00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityPartialBlurEffects_TypeDefinitionIndex = 59435;
