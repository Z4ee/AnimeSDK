...
#define MOLEMOLE_CONFIG_CONFIGENTITYPARTIALBLUREFFECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x18F33030)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityPartialBlurEffects_TypeDefinitionIndex = 79979;
