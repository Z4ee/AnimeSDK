...
#define MOLEMOLE_CONFIG_CONFIGUICAMERA_CONFIGUICAMERA_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x18AD9BB0)
#define MOLEMOLE_CONFIG_CONFIGUICAMERA_CONFIGUICAMERA_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x18AD9BC0)
#define MOLEMOLE_CONFIG_CONFIGUICAMERA_CONFIGUICAMERA_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x18AD9E60)
#define MOLEMOLE_CONFIG_CONFIGUICAMERA_CONFIGUICAMERA_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18ADA050)
#define MOLEMOLE_CONFIG_CONFIGUICAMERA_CONFIGUICAMERA_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18ADA010)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUICamera_ConfigUICamera_UnityGeneratedFormatter_TypeDefinitionIndex = 78065;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::Config::ConfigUICameraStretch*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigUICamera_ConfigUICamera_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x39C40);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::Config::UICameraSettingData*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigUICamera_ConfigUICamera_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x39C48);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::Config::ConfigPageCameraBase*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigUICamera_ConfigUICamera_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x39C50);
		}
