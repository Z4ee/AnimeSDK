...
#define MOLEMOLE_CONFIG_CONFIGENTITYFXCOMICDOTEFFECT_GETPIXELATIONON_OFFSET UNITYSDK_OFFSET(0x106D6590)
#define MOLEMOLE_CONFIG_CONFIGENTITYFXCOMICDOTEFFECT_GETPIXELSIZE_OFFSET UNITYSDK_OFFSET(0x106D6610)
#define MOLEMOLE_CONFIG_CONFIGENTITYFXCOMICDOTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x106D6690)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityFXComicDotEffect_TypeDefinitionIndex = 43955;
