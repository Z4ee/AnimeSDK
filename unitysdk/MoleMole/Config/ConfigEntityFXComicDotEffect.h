...
#define MOLEMOLE_CONFIG_CONFIGENTITYFXCOMICDOTEFFECT_GETPIXELATIONON_OFFSET UNITYSDK_OFFSET(0x1A4AF1F0)
#define MOLEMOLE_CONFIG_CONFIGENTITYFXCOMICDOTEFFECT_GETPIXELSIZE_OFFSET UNITYSDK_OFFSET(0x1A4AF270)
#define MOLEMOLE_CONFIG_CONFIGENTITYFXCOMICDOTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4AF2F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityFXComicDotEffect_TypeDefinitionIndex = 69795;
