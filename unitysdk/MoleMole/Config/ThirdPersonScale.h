...
#define MOLEMOLE_CONFIG_THIRDPERSONSCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x13516210)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ThirdPersonScale_TypeDefinitionIndex = 70131;
