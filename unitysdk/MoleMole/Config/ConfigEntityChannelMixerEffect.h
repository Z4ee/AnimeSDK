...
#define MOLEMOLE_CONFIG_CONFIGENTITYCHANNELMIXEREFFECT_GETBLUEOUTBLUEIN_OFFSET UNITYSDK_OFFSET(0x134FA300)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHANNELMIXEREFFECT_GETBLUEOUTGREENIN_OFFSET UNITYSDK_OFFSET(0x134FA280)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHANNELMIXEREFFECT_GETBLUEOUTREDIN_OFFSET UNITYSDK_OFFSET(0x134FA200)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHANNELMIXEREFFECT_GETGREENOUTBLUEIN_OFFSET UNITYSDK_OFFSET(0x134FA180)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHANNELMIXEREFFECT_GETGREENOUTGREENIN_OFFSET UNITYSDK_OFFSET(0x134FA100)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHANNELMIXEREFFECT_GETGREENOUTREDIN_OFFSET UNITYSDK_OFFSET(0x134FA080)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHANNELMIXEREFFECT_GETREDOUTBLUEIN_OFFSET UNITYSDK_OFFSET(0x134FA000)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHANNELMIXEREFFECT_GETREDOUTGREENIN_OFFSET UNITYSDK_OFFSET(0x134F9F80)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHANNELMIXEREFFECT_GETREDOUTREDIN_OFFSET UNITYSDK_OFFSET(0x134F9D10)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHANNELMIXEREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x134FA380)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityChannelMixerEffect_TypeDefinitionIndex = 84545;

	class ConfigEntityChannelMixerEffect : public ::MoleMole::Config::ConfigEntityScreenEffectBase
	{
	public:
		::MoleMole::Config::ScreenEffectFloat* redOutRedIn; // 0x40
		::MoleMole::Config::ScreenEffectFloat* redOutBlueIn; // 0x48
		::MoleMole::Config::ScreenEffectFloat* blueOutBlueIn; // 0x50
		::MoleMole::Config::ScreenEffectFloat* redOutGreenIn; // 0x58
		::MoleMole::Config::ScreenEffectFloat* greenOutGreenIn; // 0x60
		::MoleMole::Config::ScreenEffectFloat* greenOutBlueIn; // 0x68
		::MoleMole::Config::ScreenEffectFloat* blueOutRedIn; // 0x70
		::MoleMole::Config::ScreenEffectFloat* greenOutRedIn; // 0x78
		::MoleMole::Config::ScreenEffectFloat* blueOutGreenIn; // 0x80
		::MoleMole::Config::ScreenEffectFieldHandleType greenOutBlueInHandleType; // 0x88
		::MoleMole::Config::ScreenEffectFieldHandleType greenOutRedInHandleType; // 0x8C
		::MoleMole::Config::ScreenEffectFieldHandleType redOutRedInHandleType; // 0x90
		::MoleMole::Config::ScreenEffectFieldHandleType greenOutGreenInHandleType; // 0x94
		::MoleMole::Config::ScreenEffectFieldHandleType redOutBlueInHandleType; // 0x98
		::MoleMole::Config::ScreenEffectFieldHandleType redOutGreenInHandleType; // 0x9C
		::MoleMole::Config::ScreenEffectFieldHandleType blueOutGreenInHandleType; // 0xA0
		::MoleMole::Config::ScreenEffectFieldHandleType blueOutRedInHandleType; // 0xA4
		::MoleMole::Config::ScreenEffectFieldHandleType blueOutBlueInHandleType; // 0xA8
