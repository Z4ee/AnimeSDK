...
#define MOLEMOLE_CONFIG_CONFIGREALTIMEQTE_CONFIGREALTIMEQTE_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x158B2080)
#define MOLEMOLE_CONFIG_CONFIGREALTIMEQTE_CONFIGREALTIMEQTE_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x158B2090)
#define MOLEMOLE_CONFIG_CONFIGREALTIMEQTE_CONFIGREALTIMEQTE_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x158B2270)
#define MOLEMOLE_CONFIG_CONFIGREALTIMEQTE_CONFIGREALTIMEQTE_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x158B2410)
#define MOLEMOLE_CONFIG_CONFIGREALTIMEQTE_CONFIGREALTIMEQTE_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x158B23D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigRealtimeQTE_ConfigRealtimeQTE_UnityGeneratedFormatter_TypeDefinitionIndex = 49080;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::Config::RealtimeQTETaskEntryBase*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigRealtimeQTE_ConfigRealtimeQTE_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x33EB0);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::Config::RealtimeQTEStyleEntryBase*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigRealtimeQTE_ConfigRealtimeQTE_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x33EB8);
		}
