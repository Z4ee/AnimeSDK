...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWMOVEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xF13BE50)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowMoveEvent_TypeDefinitionIndex = 55735;
