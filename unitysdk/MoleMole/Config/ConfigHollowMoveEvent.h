...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWMOVEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xFB06670)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowMoveEvent_TypeDefinitionIndex = 48729;
