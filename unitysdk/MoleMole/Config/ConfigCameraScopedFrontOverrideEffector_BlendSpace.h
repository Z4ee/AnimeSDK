...
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_BLENDSPACE_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0x1703A8B0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_BLENDSPACE_RESET_OFFSET UNITYSDK_OFFSET(0x1703A930)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_BLENDSPACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1703A9E0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_BLENDSPACE___BASE_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0x1703A9F0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_BLENDSPACE___BASE_RESET_OFFSET UNITYSDK_OFFSET(0x1703AA80)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraScopedFrontOverrideEffector_BlendSpace_TypeDefinitionIndex = 47799;
