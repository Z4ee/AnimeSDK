...
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_BLENDSPACE_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0x1743E650)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_BLENDSPACE_RESET_OFFSET UNITYSDK_OFFSET(0x1743E6D0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_BLENDSPACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1743E780)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_BLENDSPACE___BASE_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0x1743E790)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_BLENDSPACE___BASE_RESET_OFFSET UNITYSDK_OFFSET(0x1743E820)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraScopedFrontOverrideEffector_BlendSpace_TypeDefinitionIndex = 39411;
