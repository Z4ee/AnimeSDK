...
#define MOLEMOLE_CONFIG_STIMULUSEVENTITEM_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x8348D0)
#define MOLEMOLE_CONFIG_STIMULUSEVENTITEM_FROMFLX_OFFSET UNITYSDK_OFFSET(0x834840)
#define MOLEMOLE_CONFIG_STIMULUSEVENTITEM_METHOD_2_1F4AF917A1653551_OFFSET UNITYSDK_OFFSET(0x834960)
#define MOLEMOLE_CONFIG_STIMULUSEVENTITEM_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x834930)

namespace MoleMole::Config
{
	inline static constexpr unsigned int StimulusEventItem_TypeDefinitionIndex = 61456;
