...
#define MOLEMOLE_CONFIG_STIMULUSEVENTITEM_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x7475A0)
#define MOLEMOLE_CONFIG_STIMULUSEVENTITEM_FROMFLX_OFFSET UNITYSDK_OFFSET(0x747510)
#define MOLEMOLE_CONFIG_STIMULUSEVENTITEM_METHOD_2_1F4AF917A1653551_OFFSET UNITYSDK_OFFSET(0x747600)
#define MOLEMOLE_CONFIG_STIMULUSEVENTITEM_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x747610)

namespace MoleMole::Config
{
	inline static constexpr unsigned int StimulusEventItem_TypeDefinitionIndex = 42028;
