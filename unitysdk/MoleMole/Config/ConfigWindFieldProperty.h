...
#define MOLEMOLE_CONFIG_CONFIGWINDFIELDPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x158B9970)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigWindFieldProperty_TypeDefinitionIndex = 53348;

	class ConfigWindFieldProperty : public ::System::Object
	{
	public:
		::System::String* MassVelocityCurve; // 0x10
		::Il2CppArray<::System::String*>* ZoneTagsTemplateBlacklist; // 0x18
		::Il2CppArray<::System::String*>* ZoneTagsBlacklist; // 0x20
		::MoleMole::Config::PatternShape* WindDetectPattern; // 0x28
		::System::String* DistanceVelocityCurve; // 0x30
		...
		::System::Boolean Neutral; // 0x51
		::System::Boolean Enemy; // 0x52
		::System::Boolean ForceAttackInvincibleTarget; // 0x53
		::MoleMole::Config::WindDirectionType directionType; // 0x54
		::MoleMole::Config::HitForwardType WindForwardType; // 0x58
