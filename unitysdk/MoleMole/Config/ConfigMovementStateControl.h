...
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSTATECONTROL_CLONE_OFFSET UNITYSDK_OFFSET(0x1B910C50)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSTATECONTROL_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x1B910C40)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSTATECONTROL_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B910EA0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSTATECONTROL_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1B910D60)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSTATECONTROL_GETALLOWCHECKFALLDOWNNORMALIZEDTIME_OFFSET UNITYSDK_OFFSET(0x1B911050)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSTATECONTROL_GETCONTROLTIMEPOINTLIST_OFFSET UNITYSDK_OFFSET(0x1B911010)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSTATECONTROL_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x1B910D50)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSTATECONTROL_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B910EB0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSTATECONTROL_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x1B910DC0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSTATECONTROL_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B910EC0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSTATECONTROL_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x1B910DD0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSTATECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B911090)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMovementStateControl_TypeDefinitionIndex = 85024;
