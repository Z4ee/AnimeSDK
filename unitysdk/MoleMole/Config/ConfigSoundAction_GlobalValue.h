...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_GLOBALVALUE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1B7F8510)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_GLOBALVALUE_GET_INSPECTORLABEL_OFFSET UNITYSDK_OFFSET(0x1B7F8330)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_GLOBALVALUE_GET_PARAMHINT_OFFSET UNITYSDK_OFFSET(0x1B7F8370)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_GLOBALVALUE_ISMATCH_OFFSET UNITYSDK_OFFSET(0x1B7F8C40)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_GLOBALVALUE_WALK_OFFSET UNITYSDK_OFFSET(0x1B7F8DF0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_GLOBALVALUE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B7F9010)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_GLOBALVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7F8FD0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_GLOBALVALUE___BASE_GET_PARAMHINT_OFFSET UNITYSDK_OFFSET(0x1B7F9170)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_GLOBALVALUE___BASE_ISMATCH_OFFSET UNITYSDK_OFFSET(0x1B7F9180)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_GLOBALVALUE___BASE_WALK_OFFSET UNITYSDK_OFFSET(0x1B7F9190)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_GlobalValue_TypeDefinitionIndex = 85078;
	...
	public:
		...
		{
			return (::System::Collections::IEnumerable**)Il2CppClass::FromTypeDefinitionIndex(ConfigSoundAction_GlobalValue_TypeDefinitionIndex)->GetStaticField(0x4A570);
		}
