...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDMUTEAUDIONODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x1BD54420)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDMUTEAUDIONODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD544E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardMuteAudioNode_TypeDefinitionIndex = 55578;
