...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDMUTEAUDIONODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x1752E520)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDMUTEAUDIONODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1752E5E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardMuteAudioNode_TypeDefinitionIndex = 73830;
