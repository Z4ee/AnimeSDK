...
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER_CLONE_OFFSET UNITYSDK_OFFSET(0x1270EAF0)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1270E820)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1270E190)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1270E880)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x1270E210)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER_LERP_OFFSET UNITYSDK_OFFSET(0x1270EBF0)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1270EB10)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1270EB80)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER_ZERO_OFFSET UNITYSDK_OFFSET(0x1270EAA0)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1270ED10)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1270ED00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraComposer_TypeDefinitionIndex = 85650;
	...
	public:
		...
		{
			return (::MoleMole::Config::ConfigCameraComposer**)Il2CppClass::FromTypeDefinitionIndex(ConfigCameraComposer_TypeDefinitionIndex)->GetStaticField(0x4AA80);
		}
		::System::Single BiasY; // 0x10
		::System::Single ScreenY; // 0x14
		::System::Single ScreenX; // 0x18
		::System::Single BiasX; // 0x1C
