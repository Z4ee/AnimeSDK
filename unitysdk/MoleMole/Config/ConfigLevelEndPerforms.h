...
#define MOLEMOLE_CONFIG_CONFIGLEVELENDPERFORMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1102C170)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigLevelEndPerforms_TypeDefinitionIndex = 43116;
