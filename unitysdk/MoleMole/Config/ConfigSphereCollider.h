...
#define MOLEMOLE_CONFIG_CONFIGSPHERECOLLIDER_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x192A8F90)
#define MOLEMOLE_CONFIG_CONFIGSPHERECOLLIDER_CLEAN_OFFSET UNITYSDK_OFFSET(0x192A9140)
#define MOLEMOLE_CONFIG_CONFIGSPHERECOLLIDER_DEALLOCATE_OFFSET UNITYSDK_OFFSET(0x192A9020)
#define MOLEMOLE_CONFIG_CONFIGSPHERECOLLIDER_GETCOLLIDERTYPE_OFFSET UNITYSDK_OFFSET(0x192A91B0)
#define MOLEMOLE_CONFIG_CONFIGSPHERECOLLIDER_GETLAYERMASK_OFFSET UNITYSDK_OFFSET(0x192A9280)
#define MOLEMOLE_CONFIG_CONFIGSPHERECOLLIDER_GETPREFABNAME_OFFSET UNITYSDK_OFFSET(0x192A9200)
#define MOLEMOLE_CONFIG_CONFIGSPHERECOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x192A9310)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSphereCollider_TypeDefinitionIndex = 71280;
