...
#define MOLEMOLE_CONFIG_CONFIGSPHERECOLLIDER_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x11CB55B0)
#define MOLEMOLE_CONFIG_CONFIGSPHERECOLLIDER_CLEAN_OFFSET UNITYSDK_OFFSET(0x11CB5760)
#define MOLEMOLE_CONFIG_CONFIGSPHERECOLLIDER_DEALLOCATE_OFFSET UNITYSDK_OFFSET(0x11CB5640)
#define MOLEMOLE_CONFIG_CONFIGSPHERECOLLIDER_GETCOLLIDERTYPE_OFFSET UNITYSDK_OFFSET(0x11CB57D0)
#define MOLEMOLE_CONFIG_CONFIGSPHERECOLLIDER_GETLAYERMASK_OFFSET UNITYSDK_OFFSET(0x11CB58A0)
#define MOLEMOLE_CONFIG_CONFIGSPHERECOLLIDER_GETPREFABNAME_OFFSET UNITYSDK_OFFSET(0x11CB5820)
#define MOLEMOLE_CONFIG_CONFIGSPHERECOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x11CB5930)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSphereCollider_TypeDefinitionIndex = 55203;
