...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_REFRESHCHESSPIECEBYSERVERINFO_GET_TOTALDURATION_OFFSET UNITYSDK_OFFSET(0x10D09B70)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_REFRESHCHESSPIECEBYSERVERINFO_RUN_OFFSET UNITYSDK_OFFSET(0x10D09B80)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_REFRESHCHESSPIECEBYSERVERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x10D09CF0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_RefreshChessPieceByServerInfo_TypeDefinitionIndex = 64413;
