...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORTRIGGERPARAM_CLONE_OFFSET UNITYSDK_OFFSET(0x1BD560F0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORTRIGGERPARAM_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x1BD560A0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORTRIGGERPARAM_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BD56650)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORTRIGGERPARAM_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1BD56200)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORTRIGGERPARAM_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x1BD561F0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORTRIGGERPARAM_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BD566B0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORTRIGGERPARAM_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x1BD56280)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORTRIGGERPARAM_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BD56850)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORTRIGGERPARAM_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x1BD564F0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORTRIGGERPARAM_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0x1BD55F50)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORTRIGGERPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD56A00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicValueListAnimatorTriggerParam_TypeDefinitionIndex = 72280;
