...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWHACKERGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x175368A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowHackerGame_TypeDefinitionIndex = 66312;
