...
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG_ISINUPDATE_OFFSET UNITYSDK_OFFSET(0x18ADC180)
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG_ISPOSTEND_OFFSET UNITYSDK_OFFSET(0x18ADC210)
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG_ISPOSTSTART_OFFSET UNITYSDK_OFFSET(0x18ADC0F0)
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18ADC280)
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG__ONFRAMECHANGED_OFFSET UNITYSDK_OFFSET(0x18ADC070)

namespace MoleMole::Config
{
	inline static constexpr unsigned int EffectTimeSegmentConfig_TypeDefinitionIndex = 72777;
