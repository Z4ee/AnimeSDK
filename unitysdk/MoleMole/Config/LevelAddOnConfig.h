...
#define MOLEMOLE_CONFIG_LEVELADDONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD703A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int LevelAddOnConfig_TypeDefinitionIndex = 44746;
