...
#define MOLEMOLE_CONFIG_LEVELADDONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17545360)

namespace MoleMole::Config
{
	inline static constexpr unsigned int LevelAddOnConfig_TypeDefinitionIndex = 71815;
