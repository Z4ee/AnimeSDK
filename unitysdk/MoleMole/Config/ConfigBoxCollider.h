...
#define MOLEMOLE_CONFIG_CONFIGBOXCOLLIDER_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x17D4BF80)
#define MOLEMOLE_CONFIG_CONFIGBOXCOLLIDER_CLEAN_OFFSET UNITYSDK_OFFSET(0x17D4BF00)
#define MOLEMOLE_CONFIG_CONFIGBOXCOLLIDER_DEALLOCATE_OFFSET UNITYSDK_OFFSET(0x17D4C010)
#define MOLEMOLE_CONFIG_CONFIGBOXCOLLIDER_GETCOLLIDERTYPE_OFFSET UNITYSDK_OFFSET(0x17D4C140)
#define MOLEMOLE_CONFIG_CONFIGBOXCOLLIDER_GETLAYERMASK_OFFSET UNITYSDK_OFFSET(0x17D4C210)
#define MOLEMOLE_CONFIG_CONFIGBOXCOLLIDER_GETPREFABNAME_OFFSET UNITYSDK_OFFSET(0x17D4C190)
#define MOLEMOLE_CONFIG_CONFIGBOXCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x17D4C2A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigBoxCollider_TypeDefinitionIndex = 50908;
