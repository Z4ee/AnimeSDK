...
#define MOLEMOLE_CONFIG_CONFIGGACHAPERFORMANCESENDCMDWITHOUTPARAMSNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x1424B560)
#define MOLEMOLE_CONFIG_CONFIGGACHAPERFORMANCESENDCMDWITHOUTPARAMSNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1424B5D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigGachaPerformanceSendCmdWithoutParamsNode_TypeDefinitionIndex = 69453;
