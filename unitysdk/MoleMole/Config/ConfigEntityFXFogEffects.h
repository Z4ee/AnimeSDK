...
#define MOLEMOLE_CONFIG_CONFIGENTITYFXFOGEFFECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x106D7310)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityFXFogEffects_TypeDefinitionIndex = 64763;
