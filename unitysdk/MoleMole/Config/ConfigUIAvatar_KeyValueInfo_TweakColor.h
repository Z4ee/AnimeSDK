...
#define MOLEMOLE_CONFIG_CONFIGUIAVATAR_KEYVALUEINFO_TWEAKCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x12722450)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUIAvatar_KeyValueInfo_TweakColor_TypeDefinitionIndex = 48021;
