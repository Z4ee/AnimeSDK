...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_PREPARE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x170B65E0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_PREPARE_GET_INSPECTORLABEL_OFFSET UNITYSDK_OFFSET(0x170B6490)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_PREPARE_GET_PARAMHINT_OFFSET UNITYSDK_OFFSET(0x170B64D0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_PREPARE_ISMATCH_OFFSET UNITYSDK_OFFSET(0x170B6870)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_PREPARE__CTOR_OFFSET UNITYSDK_OFFSET(0x170B6A40)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_PREPARE___BASE_GET_PARAMHINT_OFFSET UNITYSDK_OFFSET(0x170B6A80)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_PREPARE___BASE_ISMATCH_OFFSET UNITYSDK_OFFSET(0x170B6A90)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_Prepare_TypeDefinitionIndex = 61675;
