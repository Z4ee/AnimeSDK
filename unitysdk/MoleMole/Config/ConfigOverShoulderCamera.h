...
#define MOLEMOLE_CONFIG_CONFIGOVERSHOULDERCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x110A4E80)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigOverShoulderCamera_TypeDefinitionIndex = 46165;
