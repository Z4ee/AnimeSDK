...
#define MOLEMOLE_CONFIG_CONFIGOVERSHOULDERCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4CF420)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigOverShoulderCamera_TypeDefinitionIndex = 49492;
