...
#define MOLEMOLE_CONFIG_PERFECTSWITCHTAGCANDIDATESELECTOR_METHOD_2_77080AF97C54AF23_OFFSET UNITYSDK_OFFSET(0x16C5D2B0)
#define MOLEMOLE_CONFIG_PERFECTSWITCHTAGCANDIDATESELECTOR_METHOD_2_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x16C5D4A0)
#define MOLEMOLE_CONFIG_PERFECTSWITCHTAGCANDIDATESELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16C5D4E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int PerfectSwitchTagCandidateSelector_TypeDefinitionIndex = 57403;
