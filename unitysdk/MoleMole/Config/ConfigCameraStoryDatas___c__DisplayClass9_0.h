...
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16259990)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS___C__DISPLAYCLASS9_0__GETCONFIGINTERNAL_B__0_OFFSET UNITYSDK_OFFSET(0x162599A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraStoryDatas___c__DisplayClass9_0_TypeDefinitionIndex = 68151;
