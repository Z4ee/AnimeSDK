...
#define MOLEMOLE_CONFIG_CONFIGPARTNERAVATARADDDECOR_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17050480)
#define MOLEMOLE_CONFIG_CONFIGPARTNERAVATARADDDECOR_FROMFLX_OFFSET UNITYSDK_OFFSET(0x17050080)
#define MOLEMOLE_CONFIG_CONFIGPARTNERAVATARADDDECOR_METHOD_2_020D79381203C043_OFFSET UNITYSDK_OFFSET(0x170504E0)
#define MOLEMOLE_CONFIG_CONFIGPARTNERAVATARADDDECOR_METHOD_2_2C463ED601F44ECA_OFFSET UNITYSDK_OFFSET(0x17050910)
#define MOLEMOLE_CONFIG_CONFIGPARTNERAVATARADDDECOR_METHOD_2_39F50C378BB4FA60_OFFSET UNITYSDK_OFFSET(0x17050840)
#define MOLEMOLE_CONFIG_CONFIGPARTNERAVATARADDDECOR_METHOD_2_81438D3AF9EEE8D8_OFFSET UNITYSDK_OFFSET(0x1704FF10)
#define MOLEMOLE_CONFIG_CONFIGPARTNERAVATARADDDECOR_METHOD_2_B1E9A48DECC8E612_OFFSET UNITYSDK_OFFSET(0x17050B00)
#define MOLEMOLE_CONFIG_CONFIGPARTNERAVATARADDDECOR_METHOD_2_B73F62522113F21F_OFFSET UNITYSDK_OFFSET(0x1704FEC0)
#define MOLEMOLE_CONFIG_CONFIGPARTNERAVATARADDDECOR_METHOD_2_C444D4C8B9D548AF_OFFSET UNITYSDK_OFFSET(0x17050010)
#define MOLEMOLE_CONFIG_CONFIGPARTNERAVATARADDDECOR_METHOD_2_DABB3DBC802BA80C_OFFSET UNITYSDK_OFFSET(0x170509A0)
#define MOLEMOLE_CONFIG_CONFIGPARTNERAVATARADDDECOR_METHOD_2_DF413489329CBAF8_OFFSET UNITYSDK_OFFSET(0x17050100)
#define MOLEMOLE_CONFIG_CONFIGPARTNERAVATARADDDECOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17050900)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPartnerAvatarAddDecor_TypeDefinitionIndex = 62329;
	...
	public:
		...
		{
			return ((::System::Int32(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPARTNERAVATARADDDECOR_METHOD_2_C444D4C8B9D548AF_OFFSET))(this);
		}
