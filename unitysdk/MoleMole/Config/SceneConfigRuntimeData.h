...
#define MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x12728DC0)
#define MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x12728250)
#define MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATA_GET_CURAREANAME_OFFSET UNITYSDK_OFFSET(0x12729210)
#define MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATA_GET_CURRENTAREA_OFFSET UNITYSDK_OFFSET(0x12729310)
#define MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATA_GET_CURRENTBATTLEREGIONINDEX_OFFSET UNITYSDK_OFFSET(0x127293B0)
#define MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATA_GET_TOTALAREACOUNT_OFFSET UNITYSDK_OFFSET(0x12729410)
#define MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATA_METHOD_1_0BD393E566CD3D4A_OFFSET UNITYSDK_OFFSET(0x127282D0)
#define MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATA_METHOD_1_0BDFAC56E6B704CB_OFFSET UNITYSDK_OFFSET(0x1272A0B0)
#define MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATA_METHOD_1_4C149FCF039BA7FB_OFFSET UNITYSDK_OFFSET(0x12728E20)
#define MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATA_METHOD_1_571BB03219A716AE_OFFSET UNITYSDK_OFFSET(0x12729630)
#define MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATA_METHOD_1_C9E3340606BF1654_OFFSET UNITYSDK_OFFSET(0x127295A0)
#define MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATA_METHOD_1_EA0BA3E4AF50C583_OFFSET UNITYSDK_OFFSET(0x127296E0)
#define MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATA_METHOD_1_ECF44733EE59F889_OFFSET UNITYSDK_OFFSET(0x12729FF0)
#define MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x127294A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SceneConfigRuntimeData_TypeDefinitionIndex = 70364;
