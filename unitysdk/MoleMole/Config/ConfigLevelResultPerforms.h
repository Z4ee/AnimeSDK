...
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS_DEBUGLEVELEND_OFFSET UNITYSDK_OFFSET(0xFB07110)
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS_DUMP_OFFSET UNITYSDK_OFFSET(0xFB066E0)
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS_GETRATINGEFFECTPREFAB_OFFSET UNITYSDK_OFFSET(0xFB06FB0)
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS_GET_OPENLEVELRESULTPERFORM_OFFSET UNITYSDK_OFFSET(0xFB066D0)
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS_GET_PLAYTYPEMAP_OFFSET UNITYSDK_OFFSET(0xFB06940)
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS__CTOR_OFFSET UNITYSDK_OFFSET(0xFB071C0)
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS__DEBUGLEVELEND_B__59_0_OFFSET UNITYSDK_OFFSET(0xFB072F0)
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS__OPENWINDOW_OFFSET UNITYSDK_OFFSET(0xFB070D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigLevelResultPerforms_TypeDefinitionIndex = 70812;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigLevelResultPerforms_TypeDefinitionIndex)->GetStaticField(0x44610);
		}
