...
#define MOLEMOLE_CONFIG_CONFIGTRIGGERCACHES_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x177E3620)
#define MOLEMOLE_CONFIG_CONFIGTRIGGERCACHES_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x177E3940)
#define MOLEMOLE_CONFIG_CONFIGTRIGGERCACHES__CTOR_OFFSET UNITYSDK_OFFSET(0x177E3B20)
#define MOLEMOLE_CONFIG_CONFIGTRIGGERCACHES___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x177E3C40)
#define MOLEMOLE_CONFIG_CONFIGTRIGGERCACHES___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x177E3C50)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTriggerCaches_TypeDefinitionIndex = 69735;
