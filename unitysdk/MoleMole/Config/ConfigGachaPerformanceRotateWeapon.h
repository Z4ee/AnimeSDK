...
#define MOLEMOLE_CONFIG_CONFIGGACHAPERFORMANCEROTATEWEAPON_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xFB052D0)
#define MOLEMOLE_CONFIG_CONFIGGACHAPERFORMANCEROTATEWEAPON__CTOR_OFFSET UNITYSDK_OFFSET(0xFB05340)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigGachaPerformanceRotateWeapon_TypeDefinitionIndex = 69026;
