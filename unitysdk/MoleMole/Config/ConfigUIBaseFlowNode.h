...
#define MOLEMOLE_CONFIG_CONFIGUIBASEFLOWNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x148765D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUIBaseFlowNode_TypeDefinitionIndex = 67966;
