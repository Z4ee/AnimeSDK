...
#define MOLEMOLE_CONFIG_FLOORSTREAMINGLAYERLOADGROUPSTATEENTRY_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x14948280)
#define MOLEMOLE_CONFIG_FLOORSTREAMINGLAYERLOADGROUPSTATEENTRY_FROMFLX_OFFSET UNITYSDK_OFFSET(0x14947C00)
#define MOLEMOLE_CONFIG_FLOORSTREAMINGLAYERLOADGROUPSTATEENTRY_METHOD_1_213D736C0BF38CDB_OFFSET UNITYSDK_OFFSET(0x149482E0)
#define MOLEMOLE_CONFIG_FLOORSTREAMINGLAYERLOADGROUPSTATEENTRY_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0x14947C80)
#define MOLEMOLE_CONFIG_FLOORSTREAMINGLAYERLOADGROUPSTATEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x149486B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int FloorStreamingLayerLoadGroupStateEntry_TypeDefinitionIndex = 70034;
