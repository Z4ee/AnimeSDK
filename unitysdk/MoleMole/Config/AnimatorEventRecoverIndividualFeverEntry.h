...
#define MOLEMOLE_CONFIG_ANIMATOREVENTRECOVERINDIVIDUALFEVERENTRY_CREATEANIMATIONEVENT_OFFSET UNITYSDK_OFFSET(0xF12DEC0)
#define MOLEMOLE_CONFIG_ANIMATOREVENTRECOVERINDIVIDUALFEVERENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xF12DF40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorEventRecoverIndividualFeverEntry_TypeDefinitionIndex = 64276;
