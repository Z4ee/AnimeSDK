...
#define MOLEMOLE_CONFIG_SCENEPERFORMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x11CB7ED0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ScenePerformConfig_TypeDefinitionIndex = 81578;
