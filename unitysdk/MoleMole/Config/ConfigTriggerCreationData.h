...
#define MOLEMOLE_CONFIG_CONFIGTRIGGERCREATIONDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x879220)
#define MOLEMOLE_CONFIG_CONFIGTRIGGERCREATIONDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x879190)
#define MOLEMOLE_CONFIG_CONFIGTRIGGERCREATIONDATA_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x879280)
#define MOLEMOLE_CONFIG_CONFIGTRIGGERCREATIONDATA_METHOD_2_E4D020DE71A7D4FC_OFFSET UNITYSDK_OFFSET(0x8792B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTriggerCreationData_TypeDefinitionIndex = 44320;
