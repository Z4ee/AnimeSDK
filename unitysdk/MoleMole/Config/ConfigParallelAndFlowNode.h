...
#define MOLEMOLE_CONFIG_CONFIGPARALLELANDFLOWNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x1102E940)
#define MOLEMOLE_CONFIG_CONFIGPARALLELANDFLOWNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1102EA30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigParallelAndFlowNode_TypeDefinitionIndex = 49187;
