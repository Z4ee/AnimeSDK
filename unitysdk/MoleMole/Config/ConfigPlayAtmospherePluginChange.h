...
#define MOLEMOLE_CONFIG_CONFIGPLAYATMOSPHEREPLUGINCHANGE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x1A06DEB0)
#define MOLEMOLE_CONFIG_CONFIGPLAYATMOSPHEREPLUGINCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A06DF70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPlayAtmospherePluginChange_TypeDefinitionIndex = 71242;
