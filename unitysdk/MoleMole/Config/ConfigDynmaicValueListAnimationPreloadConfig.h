...
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTANIMATIONPRELOADCONFIG_CLONE_OFFSET UNITYSDK_OFFSET(0x1703DB20)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTANIMATIONPRELOADCONFIG_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x1703DAD0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTANIMATIONPRELOADCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1703E100)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTANIMATIONPRELOADCONFIG_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1703DC90)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTANIMATIONPRELOADCONFIG_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x1703DC20)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTANIMATIONPRELOADCONFIG_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1703E160)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTANIMATIONPRELOADCONFIG_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x1703DD10)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTANIMATIONPRELOADCONFIG_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1703E300)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTANIMATIONPRELOADCONFIG_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x1703DFA0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTANIMATIONPRELOADCONFIG_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0x1703D980)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTANIMATIONPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1703E4B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynmaicValueListAnimationPreloadConfig_TypeDefinitionIndex = 55687;
