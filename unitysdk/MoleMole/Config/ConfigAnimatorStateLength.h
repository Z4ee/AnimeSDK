...
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_AVATARFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0xF136FD0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_BUDDYFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0xF137730)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_FRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0xF138270)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_MAINCITYAVATARFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0xF137370)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_MONSTERFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0xF137550)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_SCENEOBJECTFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0xF137910)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_UIAVATARFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0xF1371A0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_UIBUDDYFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0xF137CD0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_UIMODELFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0xF138090)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_UIMONSTERFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0xF137AF0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_UIWEAPONFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0xF137EB0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__CTOR_OFFSET UNITYSDK_OFFSET(0xF138450)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_AVATARFRAMELENDICDATAS_B__3_0_OFFSET UNITYSDK_OFFSET(0xF1384B0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_BUDDYFRAMELENDICDATAS_B__19_0_OFFSET UNITYSDK_OFFSET(0xF1384F0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_FRAMELENDICDATAS_B__43_0_OFFSET UNITYSDK_OFFSET(0xF138550)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_MAINCITYAVATARFRAMELENDICDATAS_B__11_0_OFFSET UNITYSDK_OFFSET(0xF1384D0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_MONSTERFRAMELENDICDATAS_B__15_0_OFFSET UNITYSDK_OFFSET(0xF1384E0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_SCENEOBJECTFRAMELENDICDATAS_B__23_0_OFFSET UNITYSDK_OFFSET(0xF138500)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_UIAVATARFRAMELENDICDATAS_B__7_0_OFFSET UNITYSDK_OFFSET(0xF1384C0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_UIBUDDYFRAMELENDICDATAS_B__31_0_OFFSET UNITYSDK_OFFSET(0xF138520)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_UIMODELFRAMELENDICDATAS_B__39_0_OFFSET UNITYSDK_OFFSET(0xF138540)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_UIMONSTERFRAMELENDICDATAS_B__27_0_OFFSET UNITYSDK_OFFSET(0xF138510)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_UIWEAPONFRAMELENDICDATAS_B__35_0_OFFSET UNITYSDK_OFFSET(0xF138530)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAnimatorStateLength_TypeDefinitionIndex = 88043;
