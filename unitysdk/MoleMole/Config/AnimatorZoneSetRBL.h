...
#define MOLEMOLE_CONFIG_ANIMATORZONESETRBL_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x16C34580)
#define MOLEMOLE_CONFIG_ANIMATORZONESETRBL_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x16C34250)
#define MOLEMOLE_CONFIG_ANIMATORZONESETRBL_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x16C343D0)
#define MOLEMOLE_CONFIG_ANIMATORZONESETRBL__CTOR_OFFSET UNITYSDK_OFFSET(0x16C34610)
#define MOLEMOLE_CONFIG_ANIMATORZONESETRBL___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x16C34620)
#define MOLEMOLE_CONFIG_ANIMATORZONESETRBL___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x16C346F0)
#define MOLEMOLE_CONFIG_ANIMATORZONESETRBL___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x16C347A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneSetRBL_TypeDefinitionIndex = 40909;
