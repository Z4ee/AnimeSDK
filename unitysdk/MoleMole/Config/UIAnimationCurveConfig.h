...
#define MOLEMOLE_CONFIG_UIANIMATIONCURVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF7A50)

namespace MoleMole::Config
{
	inline static constexpr unsigned int UIAnimationCurveConfig_TypeDefinitionIndex = 86138;
