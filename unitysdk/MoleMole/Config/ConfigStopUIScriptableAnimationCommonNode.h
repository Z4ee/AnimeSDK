...
#define MOLEMOLE_CONFIG_CONFIGSTOPUISCRIPTABLEANIMATIONCOMMONNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x144E6930)
#define MOLEMOLE_CONFIG_CONFIGSTOPUISCRIPTABLEANIMATIONCOMMONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x144E69A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigStopUIScriptableAnimationCommonNode_TypeDefinitionIndex = 86998;
	...
	public:
		...
		::MoleMole::Config::StringUISpecialNum* PlayerKey; // 0x20
		::MoleMole::Config::StringUISpecialNum* AnimationKey; // 0x28
