...
#define MOLEMOLE_CONFIG_MONOSURFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF61C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int MonoSurfConfig_TypeDefinitionIndex = 52658;
