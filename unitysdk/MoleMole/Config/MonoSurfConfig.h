...
#define MOLEMOLE_CONFIG_MONOSURFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x181D8CC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int MonoSurfConfig_TypeDefinitionIndex = 69248;
