...
#define MOLEMOLE_CONFIG_CONFIGSWITCHTEAMACTIVITY__CTOR_OFFSET UNITYSDK_OFFSET(0x10D0CD10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSwitchTeamActivity_TypeDefinitionIndex = 86849;
