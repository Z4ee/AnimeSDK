...
#define MOLEMOLE_CONFIG_CONFIGTELEPORTSELECTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD65400)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTeleportSelections_TypeDefinitionIndex = 54374;
