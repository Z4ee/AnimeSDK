...
#define MOLEMOLE_CONFIG_READONLYDYNAMICINT_GET_DYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x12727690)
#define MOLEMOLE_CONFIG_READONLYDYNAMICINT_GET_FIXEDVALUE_OFFSET UNITYSDK_OFFSET(0x127276B0)
#define MOLEMOLE_CONFIG_READONLYDYNAMICINT_GET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x12727670)
#define MOLEMOLE_CONFIG_READONLYDYNAMICINT_SET_DYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x127276A0)
#define MOLEMOLE_CONFIG_READONLYDYNAMICINT_SET_FIXEDVALUE_OFFSET UNITYSDK_OFFSET(0x127276C0)
#define MOLEMOLE_CONFIG_READONLYDYNAMICINT_SET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x12727680)
#define MOLEMOLE_CONFIG_READONLYDYNAMICINT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x12727600)
#define MOLEMOLE_CONFIG_READONLYDYNAMICINT__CTOR_OFFSET UNITYSDK_OFFSET(0x127275A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ReadonlyDynamicInt_TypeDefinitionIndex = 83423;
