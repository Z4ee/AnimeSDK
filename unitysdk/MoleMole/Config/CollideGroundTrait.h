...
#define MOLEMOLE_CONFIG_COLLIDEGROUNDTRAIT_CLONE_OFFSET UNITYSDK_OFFSET(0x134F4020)
#define MOLEMOLE_CONFIG_COLLIDEGROUNDTRAIT_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x134F4120)
#define MOLEMOLE_CONFIG_COLLIDEGROUNDTRAIT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x134F4010)
#define MOLEMOLE_CONFIG_COLLIDEGROUNDTRAIT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x134F4AA0)
#define MOLEMOLE_CONFIG_COLLIDEGROUNDTRAIT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x134F4480)
#define MOLEMOLE_CONFIG_COLLIDEGROUNDTRAIT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x134F4110)
#define MOLEMOLE_CONFIG_COLLIDEGROUNDTRAIT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x134F4B00)
#define MOLEMOLE_CONFIG_COLLIDEGROUNDTRAIT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x134F4500)
#define MOLEMOLE_CONFIG_COLLIDEGROUNDTRAIT_ONPOSTENTITYREADY_OFFSET UNITYSDK_OFFSET(0x134F5060)
#define MOLEMOLE_CONFIG_COLLIDEGROUNDTRAIT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x134F4ED0)
#define MOLEMOLE_CONFIG_COLLIDEGROUNDTRAIT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x134F4960)
#define MOLEMOLE_CONFIG_COLLIDEGROUNDTRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x134F51C0)
#define MOLEMOLE_CONFIG_COLLIDEGROUNDTRAIT___BASE_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x134F51D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int CollideGroundTrait_TypeDefinitionIndex = 54801;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_198*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_COLLIDEGROUNDTRAIT_EXPOSEMEMBER_OFFSET))(this, processor, prefix);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_198*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_COLLIDEGROUNDTRAIT___BASE_EXPOSEMEMBER_OFFSET))(this, P0, P1);
		}
	};
}
