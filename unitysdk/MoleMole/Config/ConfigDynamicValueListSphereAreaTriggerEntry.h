...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTSPHEREAREATRIGGERENTRY_CLONE_OFFSET UNITYSDK_OFFSET(0x1A4AB8B0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTSPHEREAREATRIGGERENTRY_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x1A4AB860)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTSPHEREAREATRIGGERENTRY_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A4ABD60)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTSPHEREAREATRIGGERENTRY_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1A4AB9C0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTSPHEREAREATRIGGERENTRY_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x1A4AB9B0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTSPHEREAREATRIGGERENTRY_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A4ABDC0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTSPHEREAREATRIGGERENTRY_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x1A4ABA40)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTSPHEREAREATRIGGERENTRY_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A4ABF70)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTSPHEREAREATRIGGERENTRY_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x1A4ABC00)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTSPHEREAREATRIGGERENTRY_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0x1A4AB710)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTSPHEREAREATRIGGERENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4AC120)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicValueListSphereAreaTriggerEntry_TypeDefinitionIndex = 80493;
