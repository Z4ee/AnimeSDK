...
#define MOLEMOLE_CONFIG_LANGUAGESIZEFONTBRUSHSTYLE_GET_BOLDNESS_OFFSET UNITYSDK_OFFSET(0x7A30D0)
#define MOLEMOLE_CONFIG_LANGUAGESIZEFONTBRUSHSTYLE_GET_SHARPNESS_OFFSET UNITYSDK_OFFSET(0x7A3150)
#define MOLEMOLE_CONFIG_LANGUAGESIZEFONTBRUSHSTYLE_SET_BOLDNESS_OFFSET UNITYSDK_OFFSET(0x7A30E0)
#define MOLEMOLE_CONFIG_LANGUAGESIZEFONTBRUSHSTYLE_SET_SHARPNESS_OFFSET UNITYSDK_OFFSET(0x7A3160)

namespace MoleMole::Config
{
	inline static constexpr unsigned int LanguageSizeFontBrushStyle_TypeDefinitionIndex = 39485;
