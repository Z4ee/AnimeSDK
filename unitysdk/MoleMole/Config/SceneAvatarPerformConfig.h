...
#define MOLEMOLE_CONFIG_SCENEAVATARPERFORMCONFIG_INIT_OFFSET UNITYSDK_OFFSET(0x17548E20)
#define MOLEMOLE_CONFIG_SCENEAVATARPERFORMCONFIG_MOLEMOLE_CONFIG_ISCENEPERFORMCONFIG_GET_FLOWCANVASDELAYTIME_OFFSET UNITYSDK_OFFSET(0x17549020)
#define MOLEMOLE_CONFIG_SCENEAVATARPERFORMCONFIG_MOLEMOLE_CONFIG_ISCENEPERFORMCONFIG_GET_INPUTMUTEDELAYTIME_OFFSET UNITYSDK_OFFSET(0x17548FD0)
#define MOLEMOLE_CONFIG_SCENEAVATARPERFORMCONFIG_MOLEMOLE_CONFIG_ISCENEPERFORMCONFIG_GET_SHOWUIDELAYTIME_OFFSET UNITYSDK_OFFSET(0x17549070)
#define MOLEMOLE_CONFIG_SCENEAVATARPERFORMCONFIG_MOLEMOLE_CONFIG_ISCENEPERFORMCONFIG_SETUP_OFFSET UNITYSDK_OFFSET(0x175490C0)
#define MOLEMOLE_CONFIG_SCENEAVATARPERFORMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175491D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SceneAvatarPerformConfig_TypeDefinitionIndex = 43879;
	...
	public:
		...
		::System::Boolean IsGroupShotData; // 0x28
		::System::Boolean EntityVisible; // 0x29
		::MoleMole::Config::CutSceneEndMode finishMode; // 0x2A
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_227*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_SCENEAVATARPERFORMCONFIG_MOLEMOLE_CONFIG_ISCENEPERFORMCONFIG_SETUP_OFFSET))(this, node);
		}
	};
}
