...
#define MOLEMOLE_CONFIG_AUDIOBASEPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x17298EF0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AudioBasePath_TypeDefinitionIndex = 61206;
