...
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_CALCULATEFIXEDHOLDTIMER_OFFSET UNITYSDK_OFFSET(0x159EA9A0)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETCURVEVALUE_1_OFFSET UNITYSDK_OFFSET(0x159EB6B0)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETCURVEVALUE_2_OFFSET UNITYSDK_OFFSET(0x159EB940)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETCURVEVALUE_3_OFFSET UNITYSDK_OFFSET(0x159EBBF0)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETCURVEVALUE_4_OFFSET UNITYSDK_OFFSET(0x159EBE60)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETCURVEVALUE_OFFSET UNITYSDK_OFFSET(0x159EB420)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETENDVALUE_1_OFFSET UNITYSDK_OFFSET(0x159EC050)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETENDVALUE_2_OFFSET UNITYSDK_OFFSET(0x159EC0C0)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETENDVALUE_3_OFFSET UNITYSDK_OFFSET(0x159EC130)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETENDVALUE_4_OFFSET UNITYSDK_OFFSET(0x159EC1C0)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETENDVALUE_5_OFFSET UNITYSDK_OFFSET(0x159EC260)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETENDVALUE_6_OFFSET UNITYSDK_OFFSET(0x159EC2E0)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETENDVALUE_7_OFFSET UNITYSDK_OFFSET(0x159EC3F0)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETENDVALUE_8_OFFSET UNITYSDK_OFFSET(0x159EC4E0)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETENDVALUE_OFFSET UNITYSDK_OFFSET(0x159EBFE0)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETHOLDVALUE_1_OFFSET UNITYSDK_OFFSET(0x159EAA50)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETHOLDVALUE_2_OFFSET UNITYSDK_OFFSET(0x159EA130)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETHOLDVALUE_3_OFFSET UNITYSDK_OFFSET(0x159EAC60)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETHOLDVALUE_4_OFFSET UNITYSDK_OFFSET(0x159EADA0)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETHOLDVALUE_5_OFFSET UNITYSDK_OFFSET(0x159EAF20)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETHOLDVALUE_6_OFFSET UNITYSDK_OFFSET(0x159EB090)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETHOLDVALUE_OFFSET UNITYSDK_OFFSET(0x159EA830)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETSTARTVALUE_1_OFFSET UNITYSDK_OFFSET(0x159EB2D0)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETSTARTVALUE_2_OFFSET UNITYSDK_OFFSET(0x159EB330)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETSTARTVALUE_3_OFFSET UNITYSDK_OFFSET(0x159EB390)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETSTARTVALUE_4_OFFSET UNITYSDK_OFFSET(0x159EB590)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETSTARTVALUE_5_OFFSET UNITYSDK_OFFSET(0x159EB630)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETSTARTVALUE_6_OFFSET UNITYSDK_OFFSET(0x159EB830)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETSTARTVALUE_7_OFFSET UNITYSDK_OFFSET(0x159EBB00)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETSTARTVALUE_8_OFFSET UNITYSDK_OFFSET(0x159EBD70)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE_GETSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x159EB270)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x159EA740)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityScreenEffectBase_TypeDefinitionIndex = 77986;
	...
	public:
		...
		::System::Single HoldTime; // 0x20
		::System::Single EndTime; // 0x24
		::System::Single StartTime; // 0x28
		::System::Single HoldLoopDuration; // 0x2C
		::System::Boolean IgnoreOwnerTimescale; // 0x30
		::System::Boolean EnablePermanent; // 0x31
		::System::Boolean EnableInterrupt; // 0x32
		::System::Int32 Priority; // 0x34
		::System::Boolean IgnoreWitchTimescale; // 0x38
		::System::Boolean IgnoreWorldTimescale; // 0x39
		::System::Boolean HoldPermanently; // 0x3A
		::System::Boolean ValidInBlackCurtain; // 0x3B
