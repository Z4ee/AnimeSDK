...
#define MOLEMOLE_CONFIG_CONFIGDELAYEDACTIVATEATMOSPHEREANDFILTER_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x10CFEB40)
#define MOLEMOLE_CONFIG_CONFIGDELAYEDACTIVATEATMOSPHEREANDFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x10CFEC00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDelayedActivateAtmosphereAndFilter_TypeDefinitionIndex = 46038;
