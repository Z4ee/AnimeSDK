...
#define MOLEMOLE_CONFIG_ANIMATORZONEFACEMAINCITYAVATAR_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x12B9C2C0)
#define MOLEMOLE_CONFIG_ANIMATORZONEFACEMAINCITYAVATAR_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x12B9BC00)
#define MOLEMOLE_CONFIG_ANIMATORZONEFACEMAINCITYAVATAR_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x12B9C1F0)
#define MOLEMOLE_CONFIG_ANIMATORZONEFACEMAINCITYAVATAR_TICKROTATETOTARGET_OFFSET UNITYSDK_OFFSET(0x12B9C340)
#define MOLEMOLE_CONFIG_ANIMATORZONEFACEMAINCITYAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x12B9C3E0)
#define MOLEMOLE_CONFIG_ANIMATORZONEFACEMAINCITYAVATAR___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x12B9C3F0)
#define MOLEMOLE_CONFIG_ANIMATORZONEFACEMAINCITYAVATAR___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x12B9C4B0)
#define MOLEMOLE_CONFIG_ANIMATORZONEFACEMAINCITYAVATAR___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x12B9C560)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneFaceMainCityAvatar_TypeDefinitionIndex = 82742;
