...
#define MOLEMOLE_CONFIG_MOUSEINPUTCODESETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1350EC90)

namespace MoleMole::Config
{
	inline static constexpr unsigned int MouseInputCodeSetting_TypeDefinitionIndex = 48482;
