...
#define MOLEMOLE_CONFIG_CONFIGENTITYTONEMAPPINGEFFECT_GETCUSTOMGAMMA_OFFSET UNITYSDK_OFFSET(0x16A8C2F0)
#define MOLEMOLE_CONFIG_CONFIGENTITYTONEMAPPINGEFFECT_GETMODE_OFFSET UNITYSDK_OFFSET(0x16A8C000)
#define MOLEMOLE_CONFIG_CONFIGENTITYTONEMAPPINGEFFECT_GETSHOULDERANGLE_OFFSET UNITYSDK_OFFSET(0x16A8C270)
#define MOLEMOLE_CONFIG_CONFIGENTITYTONEMAPPINGEFFECT_GETSHOULDERLENGTH_OFFSET UNITYSDK_OFFSET(0x16A8C1F0)
#define MOLEMOLE_CONFIG_CONFIGENTITYTONEMAPPINGEFFECT_GETSHOULDERSTRENGTH_OFFSET UNITYSDK_OFFSET(0x16A8C170)
#define MOLEMOLE_CONFIG_CONFIGENTITYTONEMAPPINGEFFECT_GETTOELENGTH_OFFSET UNITYSDK_OFFSET(0x16A8C0F0)
#define MOLEMOLE_CONFIG_CONFIGENTITYTONEMAPPINGEFFECT_GETTOESTRENGTH_OFFSET UNITYSDK_OFFSET(0x16A8C070)
#define MOLEMOLE_CONFIG_CONFIGENTITYTONEMAPPINGEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16A8C370)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityTonemappingEffect_TypeDefinitionIndex = 78289;

	class ConfigEntityTonemappingEffect : public ::MoleMole::Config::ConfigEntityScreenEffectBase
	{
	public:
		::MoleMole::Config::ScreenEffectFloat* shoulderAngle; // 0x40
		::MoleMole::Config::ScreenEffectFloat* shoulderLength; // 0x48
		::MoleMole::Config::ScreenEffectFloat* toeLength; // 0x50
		::MoleMole::Config::ScreenEffectFloat* customGamma; // 0x58
		::MoleMole::Config::ScreenEffectFloat* shoulderStrength; // 0x60
		::MoleMole::Config::ScreenEffectFloat* toeStrength; // 0x68
		::MoleMole::Config::ScreenEffectFieldHandleType shoulderAngleHandleType; // 0x70
		::MoleMole::Config::ScreenEffectFieldHandleType modeHandleType; // 0x74
		::MoleMole::Config::ScreenEffectFieldHandleType shoulderStrengthHandleType; // 0x78
		::UnityEngine::NAPRenderPipeline0::TonemappingMode mode; // 0x7C
		::MoleMole::Config::ScreenEffectFieldHandleType toeLengthHandleType; // 0x80
		::MoleMole::Config::ScreenEffectFieldHandleType customGammaHandleType; // 0x84
		::MoleMole::Config::ScreenEffectFieldHandleType toeStrengthHandleType; // 0x88
		::MoleMole::Config::ScreenEffectFieldHandleType shoulderLengthHandleType; // 0x8C
