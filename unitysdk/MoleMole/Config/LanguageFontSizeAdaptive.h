...
#define MOLEMOLE_CONFIG_LANGUAGEFONTSIZEADAPTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x192AC9E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int LanguageFontSizeAdaptive_TypeDefinitionIndex = 72172;
