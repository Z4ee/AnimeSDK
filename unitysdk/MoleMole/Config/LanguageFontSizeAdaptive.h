...
#define MOLEMOLE_CONFIG_LANGUAGEFONTSIZEADAPTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1487A5C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int LanguageFontSizeAdaptive_TypeDefinitionIndex = 41837;
