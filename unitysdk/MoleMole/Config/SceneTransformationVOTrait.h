...
#define MOLEMOLE_CONFIG_SCENETRANSFORMATIONVOTRAIT_CLONE_OFFSET UNITYSDK_OFFSET(0x17E39BC0)
#define MOLEMOLE_CONFIG_SCENETRANSFORMATIONVOTRAIT_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x17E39D20)
#define MOLEMOLE_CONFIG_SCENETRANSFORMATIONVOTRAIT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x17E39B70)
#define MOLEMOLE_CONFIG_SCENETRANSFORMATIONVOTRAIT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17E3A4C0)
#define MOLEMOLE_CONFIG_SCENETRANSFORMATIONVOTRAIT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x17E39E50)
#define MOLEMOLE_CONFIG_SCENETRANSFORMATIONVOTRAIT_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x17E3AB00)
#define MOLEMOLE_CONFIG_SCENETRANSFORMATIONVOTRAIT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x17E39CB0)
#define MOLEMOLE_CONFIG_SCENETRANSFORMATIONVOTRAIT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x17E3A520)
#define MOLEMOLE_CONFIG_SCENETRANSFORMATIONVOTRAIT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x17E39ED0)
#define MOLEMOLE_CONFIG_SCENETRANSFORMATIONVOTRAIT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x17E3A960)
#define MOLEMOLE_CONFIG_SCENETRANSFORMATIONVOTRAIT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x17E3A380)
#define MOLEMOLE_CONFIG_SCENETRANSFORMATIONVOTRAIT_POSTPROCESSENTITY_OFFSET UNITYSDK_OFFSET(0x17E3ABB0)
#define MOLEMOLE_CONFIG_SCENETRANSFORMATIONVOTRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x17E3AC70)
#define MOLEMOLE_CONFIG_SCENETRANSFORMATIONVOTRAIT___BASE_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x17E3AC80)
#define MOLEMOLE_CONFIG_SCENETRANSFORMATIONVOTRAIT___BASE_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x17E3AC90)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SceneTransformationVOTrait_TypeDefinitionIndex = 52788;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_175*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_SCENETRANSFORMATIONVOTRAIT_EXPOSEMEMBER_OFFSET))(this, processor, prefix);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_53842913455A8556*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_SCENETRANSFORMATIONVOTRAIT_GENERATECOMPONENT_OFFSET))(this, buildContext);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_175*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_SCENETRANSFORMATIONVOTRAIT___BASE_EXPOSEMEMBER_OFFSET))(this, P0, P1);
		}

		::System::Boolean __base_GenerateComponent(::Class_1_53842913455A8556* P0)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_53842913455A8556*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_SCENETRANSFORMATIONVOTRAIT___BASE_GENERATECOMPONENT_OFFSET))(this, P0);
		}
	};
}
