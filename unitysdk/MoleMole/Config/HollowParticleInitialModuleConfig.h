...
#define MOLEMOLE_CONFIG_HOLLOWPARTICLEINITIALMODULECONFIG_CREATEMODULE_OFFSET UNITYSDK_OFFSET(0x1AA6E090)
#define MOLEMOLE_CONFIG_HOLLOWPARTICLEINITIALMODULECONFIG_GETMODULEID_OFFSET UNITYSDK_OFFSET(0x1AA6E170)
#define MOLEMOLE_CONFIG_HOLLOWPARTICLEINITIALMODULECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA6E240)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HollowParticleInitialModuleConfig_TypeDefinitionIndex = 72175;
