...
#define MOLEMOLE_CONFIG_ANIMATORZONEALLOWTRANSFORM_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x1BD45620)
#define MOLEMOLE_CONFIG_ANIMATORZONEALLOWTRANSFORM_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x1BD45690)
#define MOLEMOLE_CONFIG_ANIMATORZONEALLOWTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD45700)
#define MOLEMOLE_CONFIG_ANIMATORZONEALLOWTRANSFORM___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x1BD45750)
#define MOLEMOLE_CONFIG_ANIMATORZONEALLOWTRANSFORM___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x1BD45800)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneAllowTransform_TypeDefinitionIndex = 73074;
