...
#define MOLEMOLE_CONFIG_CONFIGFOCUSCAMERA_CONFIGFOCUSCAMERA_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x1AA502E0)
#define MOLEMOLE_CONFIG_CONFIGFOCUSCAMERA_CONFIGFOCUSCAMERA_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x1AA502F0)
#define MOLEMOLE_CONFIG_CONFIGFOCUSCAMERA_CONFIGFOCUSCAMERA_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x1AA504D0)
#define MOLEMOLE_CONFIG_CONFIGFOCUSCAMERA_CONFIGFOCUSCAMERA_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AA50670)
#define MOLEMOLE_CONFIG_CONFIGFOCUSCAMERA_CONFIGFOCUSCAMERA_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA50630)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigFocusCamera_ConfigFocusCamera_UnityGeneratedFormatter_TypeDefinitionIndex = 53453;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::Config::ConfigFocusCameraEntry*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigFocusCamera_ConfigFocusCamera_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x42C08);
		}
