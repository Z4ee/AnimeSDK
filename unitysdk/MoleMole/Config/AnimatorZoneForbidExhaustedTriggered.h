...
#define MOLEMOLE_CONFIG_ANIMATORZONEFORBIDEXHAUSTEDTRIGGERED_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x12A467D0)
#define MOLEMOLE_CONFIG_ANIMATORZONEFORBIDEXHAUSTEDTRIGGERED_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x12A46950)
#define MOLEMOLE_CONFIG_ANIMATORZONEFORBIDEXHAUSTEDTRIGGERED__CTOR_OFFSET UNITYSDK_OFFSET(0x12A46AF0)
#define MOLEMOLE_CONFIG_ANIMATORZONEFORBIDEXHAUSTEDTRIGGERED___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x12A46B00)
#define MOLEMOLE_CONFIG_ANIMATORZONEFORBIDEXHAUSTEDTRIGGERED___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x12A46B70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneForbidExhaustedTriggered_TypeDefinitionIndex = 77825;
