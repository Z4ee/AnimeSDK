...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_OBJECTVALUE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x10D0B2E0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_OBJECTVALUE_GET_INSPECTORLABEL_OFFSET UNITYSDK_OFFSET(0x10D0B2A0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_OBJECTVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x10D0B720)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundActionTriggerCondition_ObjectValue_TypeDefinitionIndex = 51094;
