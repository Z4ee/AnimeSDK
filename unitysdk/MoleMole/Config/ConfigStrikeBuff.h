...
#define MOLEMOLE_CONFIG_CONFIGSTRIKEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1424E380)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigStrikeBuff_TypeDefinitionIndex = 53939;
