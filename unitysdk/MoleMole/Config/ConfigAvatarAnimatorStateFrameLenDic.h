...
#define MOLEMOLE_CONFIG_CONFIGAVATARANIMATORSTATEFRAMELENDIC__CTOR_OFFSET UNITYSDK_OFFSET(0x116F9DF0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAvatarAnimatorStateFrameLenDic_TypeDefinitionIndex = 56451;
