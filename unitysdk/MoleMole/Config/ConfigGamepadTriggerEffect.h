...
#define MOLEMOLE_CONFIG_CONFIGGAMEPADTRIGGEREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7EC970)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigGamepadTriggerEffect_TypeDefinitionIndex = 50713;
