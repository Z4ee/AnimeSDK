...
#define MOLEMOLE_CONFIG_ANIMATORZONEDESTRUCTIONDESTROY_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x1624DAF0)
#define MOLEMOLE_CONFIG_ANIMATORZONEDESTRUCTIONDESTROY_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x1624DD40)
#define MOLEMOLE_CONFIG_ANIMATORZONEDESTRUCTIONDESTROY__CTOR_OFFSET UNITYSDK_OFFSET(0x1624DEA0)
#define MOLEMOLE_CONFIG_ANIMATORZONEDESTRUCTIONDESTROY___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x1624DF60)
#define MOLEMOLE_CONFIG_ANIMATORZONEDESTRUCTIONDESTROY___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x1624E010)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneDestructionDestroy_TypeDefinitionIndex = 90841;
