...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STATEBRANCH_EXECUTE_OFFSET UNITYSDK_OFFSET(0x170B75A0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STATEBRANCH_GET_INSPECTORLABEL_OFFSET UNITYSDK_OFFSET(0x170B7550)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STATEBRANCH_GET_PARAMHINT_OFFSET UNITYSDK_OFFSET(0x170B7590)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STATEBRANCH_ISMATCH_OFFSET UNITYSDK_OFFSET(0x170B77F0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STATEBRANCH_WALK_OFFSET UNITYSDK_OFFSET(0x170B7A30)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STATEBRANCH__CTOR_OFFSET UNITYSDK_OFFSET(0x170B7C50)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STATEBRANCH___BASE_ISMATCH_OFFSET UNITYSDK_OFFSET(0x170B7C90)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STATEBRANCH___BASE_WALK_OFFSET UNITYSDK_OFFSET(0x170B7CA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_StateBranch_TypeDefinitionIndex = 41015;
