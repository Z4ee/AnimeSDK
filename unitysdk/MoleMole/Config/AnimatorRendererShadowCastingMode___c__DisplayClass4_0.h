...
#define MOLEMOLE_CONFIG_ANIMATORRENDERERSHADOWCASTINGMODE___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1484C180)
#define MOLEMOLE_CONFIG_ANIMATORRENDERERSHADOWCASTINGMODE___C__DISPLAYCLASS4_0__ONZONEENTER_B__0_OFFSET UNITYSDK_OFFSET(0x1484C190)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorRendererShadowCastingMode___c__DisplayClass4_0_TypeDefinitionIndex = 58405;
