...
#define MOLEMOLE_CONFIG_GUIDEPOINT_AUTOGENSTRATEGY_GETTARGETREACHDISTANCE_OFFSET UNITYSDK_OFFSET(0x8CD300)
#define MOLEMOLE_CONFIG_GUIDEPOINT_AUTOGENSTRATEGY_GET_INSERTSUBSECTIONLENGTH_OFFSET UNITYSDK_OFFSET(0x8CD290)
#define MOLEMOLE_CONFIG_GUIDEPOINT_AUTOGENSTRATEGY_GET_SUBSECTIONBACKTRACEDISTANCE_OFFSET UNITYSDK_OFFSET(0x8CD290)
#define MOLEMOLE_CONFIG_GUIDEPOINT_AUTOGENSTRATEGY_ISTARGETREACHED_OFFSET UNITYSDK_OFFSET(0x8CD350)
#define MOLEMOLE_CONFIG_GUIDEPOINT_AUTOGENSTRATEGY_ISVALID_OFFSET UNITYSDK_OFFSET(0x8CD2A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int GuidePoint_AutoGenStrategy_TypeDefinitionIndex = 77202;
	...
	struct alignas(8) GuidePoint_AutoGenStrategy
	{
		...
		::System::Boolean disableGuideUI; // 0x58
