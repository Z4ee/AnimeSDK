...
#define MOLEMOLE_CONFIG_ANIMATORZONECONTROLSLIDING_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x1A49E720)
#define MOLEMOLE_CONFIG_ANIMATORZONECONTROLSLIDING_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x1A49E7F0)
#define MOLEMOLE_CONFIG_ANIMATORZONECONTROLSLIDING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A49E880)
#define MOLEMOLE_CONFIG_ANIMATORZONECONTROLSLIDING___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x1A49E890)
#define MOLEMOLE_CONFIG_ANIMATORZONECONTROLSLIDING___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x1A49E940)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneControlSliding_TypeDefinitionIndex = 68399;
