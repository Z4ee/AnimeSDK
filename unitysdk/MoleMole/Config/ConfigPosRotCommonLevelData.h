...
#define MOLEMOLE_CONFIG_CONFIGPOSROTCOMMONLEVELDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A352BA0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTCOMMONLEVELDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1A352830)
#define MOLEMOLE_CONFIG_CONFIGPOSROTCOMMONLEVELDATA_METHOD_2_0AFE2382BF92DEC7_OFFSET UNITYSDK_OFFSET(0x1A352C00)
#define MOLEMOLE_CONFIG_CONFIGPOSROTCOMMONLEVELDATA_METHOD_2_5B0202969299569F_OFFSET UNITYSDK_OFFSET(0x1A3528B0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTCOMMONLEVELDATA_METHOD_2_5C90773220FA8136_OFFSET UNITYSDK_OFFSET(0x1A352630)
#define MOLEMOLE_CONFIG_CONFIGPOSROTCOMMONLEVELDATA_METHOD_2_85C03D244F4D678F_OFFSET UNITYSDK_OFFSET(0x1A353120)
#define MOLEMOLE_CONFIG_CONFIGPOSROTCOMMONLEVELDATA_METHOD_2_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x1A352EB0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTCOMMONLEVELDATA_METHOD_2_929BE9BE915F0B43_OFFSET UNITYSDK_OFFSET(0x1A352F30)
#define MOLEMOLE_CONFIG_CONFIGPOSROTCOMMONLEVELDATA_METHOD_2_A07BBB39DCAC48C7_OFFSET UNITYSDK_OFFSET(0x1A352FC0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTCOMMONLEVELDATA_METHOD_2_C444D4C8B9D548AF_OFFSET UNITYSDK_OFFSET(0x1A3527C0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTCOMMONLEVELDATA_METHOD_2_C9158580CC3C5ACF_OFFSET UNITYSDK_OFFSET(0x1A3526C0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTCOMMONLEVELDATA_METHOD_2_F2962016E737497B_OFFSET UNITYSDK_OFFSET(0x1A352FB0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTCOMMONLEVELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A352F20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPosRotCommonLevelData_TypeDefinitionIndex = 45649;
