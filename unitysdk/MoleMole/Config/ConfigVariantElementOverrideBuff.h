...
#define MOLEMOLE_CONFIG_CONFIGVARIANTELEMENTOVERRIDEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x11CB6830)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigVariantElementOverrideBuff_TypeDefinitionIndex = 79452;
	...
	public:
		...
		::System::Int32 OriginalBuffId; // 0x18
