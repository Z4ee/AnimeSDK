...
#define MOLEMOLE_CONFIG_CONFIGANIMATORZONE__CTOR_OFFSET UNITYSDK_OFFSET(0x116F9D90)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAnimatorZone_TypeDefinitionIndex = 80389;
