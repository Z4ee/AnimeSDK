...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWPOPINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD5E3A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowPopInteract_TypeDefinitionIndex = 43994;
