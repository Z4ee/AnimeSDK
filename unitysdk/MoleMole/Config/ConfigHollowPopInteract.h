...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWPOPINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x17536A80)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowPopInteract_TypeDefinitionIndex = 58868;
