...
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_CALFACEOFFPOSROT_OFFSET UNITYSDK_OFFSET(0x162B78E0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_CHOOSEENTITYORTRANSFORM_OFFSET UNITYSDK_OFFSET(0x162B17A0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_CHOOSEPOSROTTARGETENTITY_OFFSET UNITYSDK_OFFSET(0x162B6350)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_CHOOSESPECIALTRANSFORM_OFFSET UNITYSDK_OFFSET(0x162B5C60)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_CLONE_OFFSET UNITYSDK_OFFSET(0x162B8C90)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x162B8BB0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x162B8210)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_FROMFLX_OFFSET UNITYSDK_OFFSET(0x162B8E00)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_GETABILITYTARGETOFFSETREFERENTITY_OFFSET UNITYSDK_OFFSET(0x162B6560)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_GETATTACHPOINT_OFFSET UNITYSDK_OFFSET(0x162B7ED0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_GETENTITYPOSROTBYTARGET_OFFSET UNITYSDK_OFFSET(0x162B2880)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x162B8D90)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_GETSAVEPOINTPOSROT_OFFSET UNITYSDK_OFFSET(0x162B7B50)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_GETTARGETENTITYPOSROT_OFFSET UNITYSDK_OFFSET(0x162B2470)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_GETTARGETENTITY_OFFSET UNITYSDK_OFFSET(0x162B7DC0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x162B8270)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x162B8E80)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_ISREFERTARGETCAMERA_OFFSET UNITYSDK_OFFSET(0x162B15D0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_ISSAVEPOINTOPTION_OFFSET UNITYSDK_OFFSET(0x162B7D70)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_ISSPECIALITEMOPTION_OFFSET UNITYSDK_OFFSET(0x162B5C10)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x162B8A00)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x162BA4A0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x162BA600)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET___BASE_GETATTACHPOINT_OFFSET UNITYSDK_OFFSET(0x162BA610)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET___BASE_GETENTITYPOSROTBYTARGET_OFFSET UNITYSDK_OFFSET(0x162BA6B0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET___BASE_GETSAVEPOINTPOSROT_OFFSET UNITYSDK_OFFSET(0x162BA7B0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET___BASE_GETTARGETENTITYPOSROT_OFFSET UNITYSDK_OFFSET(0x162BA9E0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET___BASE_GETTARGETENTITY_OFFSET UNITYSDK_OFFSET(0x162BA900)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET___BASE_ISREFERTARGETCAMERA_OFFSET UNITYSDK_OFFSET(0x162BAC60)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET___BASE_ISSAVEPOINTOPTION_OFFSET UNITYSDK_OFFSET(0x162BAD80)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPosRotFaceOffReferTarget_TypeDefinitionIndex = 85973;
