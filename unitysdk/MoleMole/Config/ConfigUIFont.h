...
#define MOLEMOLE_CONFIG_CONFIGUIFONT_AWAKE_OFFSET UNITYSDK_OFFSET(0x158B8F10)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_GETALIGMENTPREF_OFFSET UNITYSDK_OFFSET(0x158B8E20)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_GETFONTPATH_OFFSET UNITYSDK_OFFSET(0x158B8BF0)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_GETLANGUAGEFONTNAME_OFFSET UNITYSDK_OFFSET(0x158B85E0)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_GET_DEFAULTFONTSHADER_OFFSET UNITYSDK_OFFSET(0x158B7850)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_GET_ISDEFAULTFONTSHADERLOAD_OFFSET UNITYSDK_OFFSET(0x158B7A30)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_ISDECORATE_OFFSET UNITYSDK_OFFSET(0x158B7F20)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_ISFONTSHADER_OFFSET UNITYSDK_OFFSET(0x158B7B60)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_ONKFONTALPHAADJUSTBYLUMINANCECHANGED_OFFSET UNITYSDK_OFFSET(0x158B9050)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_SETKFONTALPHAADJUSTBYLUMINANCE_OFFSET UNITYSDK_OFFSET(0x158B8FC0)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_SHOULDUSELIGHTFONT_OFFSET UNITYSDK_OFFSET(0x158B8CF0)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_TRYGETLANGUAGEFONTNAME_OFFSET UNITYSDK_OFFSET(0x158B87A0)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_TRYINITIALIZEDICTCACHE_OFFSET UNITYSDK_OFFSET(0x158B7FE0)
#define MOLEMOLE_CONFIG_CONFIGUIFONT__CCTOR_OFFSET UNITYSDK_OFFSET(0x158B98F0)
#define MOLEMOLE_CONFIG_CONFIGUIFONT__CTOR_OFFSET UNITYSDK_OFFSET(0x158B95E0)
#define MOLEMOLE_CONFIG_CONFIGUIFONT__TRYINITIALIZEDICTCACHE_G__ADDFONT_32_1_OFFSET UNITYSDK_OFFSET(0x158B9100)
#define MOLEMOLE_CONFIG_CONFIGUIFONT__TRYINITIALIZEDICTCACHE_G__REMOVEEXTENSIONNAME_32_2_OFFSET UNITYSDK_OFFSET(0x158B9930)
#define MOLEMOLE_CONFIG_CONFIGUIFONT__TRYINITIALIZEDICTCACHE_G__TRYADDLANGUAGEFONT_32_0_OFFSET UNITYSDK_OFFSET(0x158B9480)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUIFont_TypeDefinitionIndex = 45715;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ConfigUIFont_TypeDefinitionIndex)->GetStaticField(0xCB40);
		}
