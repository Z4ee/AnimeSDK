...
#define MOLEMOLE_CONFIG_CONFIGUIFONT_AWAKE_OFFSET UNITYSDK_OFFSET(0x143836B0)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_GETALIGMENTPREF_OFFSET UNITYSDK_OFFSET(0x143835C0)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_GETFONTPATH_OFFSET UNITYSDK_OFFSET(0x14383390)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_GETLANGUAGEFONTNAME_OFFSET UNITYSDK_OFFSET(0x14382D90)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_GET_DEFAULTFONTSHADER_OFFSET UNITYSDK_OFFSET(0x14382000)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_GET_ISDEFAULTFONTSHADERLOAD_OFFSET UNITYSDK_OFFSET(0x143821E0)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_ISDECORATE_OFFSET UNITYSDK_OFFSET(0x143826D0)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_ISFONTSHADER_OFFSET UNITYSDK_OFFSET(0x14382310)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_ONKFONTALPHAADJUSTBYLUMINANCECHANGED_OFFSET UNITYSDK_OFFSET(0x143837F0)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_SETKFONTALPHAADJUSTBYLUMINANCE_OFFSET UNITYSDK_OFFSET(0x14383760)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_SHOULDUSELIGHTFONT_OFFSET UNITYSDK_OFFSET(0x14383490)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_TRYGETLANGUAGEFONTNAME_OFFSET UNITYSDK_OFFSET(0x14382F50)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_TRYINITIALIZEDICTCACHE_OFFSET UNITYSDK_OFFSET(0x14382790)
#define MOLEMOLE_CONFIG_CONFIGUIFONT__CCTOR_OFFSET UNITYSDK_OFFSET(0x14384080)
#define MOLEMOLE_CONFIG_CONFIGUIFONT__CTOR_OFFSET UNITYSDK_OFFSET(0x14383D70)
#define MOLEMOLE_CONFIG_CONFIGUIFONT__TRYINITIALIZEDICTCACHE_G__ADDFONT_32_1_OFFSET UNITYSDK_OFFSET(0x143838A0)
#define MOLEMOLE_CONFIG_CONFIGUIFONT__TRYINITIALIZEDICTCACHE_G__REMOVEEXTENSIONNAME_32_2_OFFSET UNITYSDK_OFFSET(0x143840C0)
#define MOLEMOLE_CONFIG_CONFIGUIFONT__TRYINITIALIZEDICTCACHE_G__TRYADDLANGUAGEFONT_32_0_OFFSET UNITYSDK_OFFSET(0x14383C20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUIFont_TypeDefinitionIndex = 78189;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ConfigUIFont_TypeDefinitionIndex)->GetStaticField(0xCA40);
		}
