...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDSTOPSECONDARYSCREEN_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x1AA4C040)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDSTOPSECONDARYSCREEN__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA4C100)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardStopSecondaryScreen_TypeDefinitionIndex = 40441;
