...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_POSTEFFECT_GETSUPPORTEDDURATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1744D310)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_POSTEFFECT_GET_TOTALDURATION_OFFSET UNITYSDK_OFFSET(0x1744D300)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_POSTEFFECT_RUN_OFFSET UNITYSDK_OFFSET(0x1744D180)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_POSTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1744D360)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_POSTEFFECT___BASE_GETSUPPORTEDDURATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1744D370)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_PostEffect_TypeDefinitionIndex = 43442;
