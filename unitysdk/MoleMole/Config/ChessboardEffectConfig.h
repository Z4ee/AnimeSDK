...
#define MOLEMOLE_CONFIG_CHESSBOARDEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x158984A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ChessboardEffectConfig_TypeDefinitionIndex = 44579;
