...
#define MOLEMOLE_CONFIG_YOROZUYACONFIGPAGECAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x170CED10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int YorozuyaConfigPageCamera_TypeDefinitionIndex = 51140;
