...
#define MOLEMOLE_CONFIG_HOLLOWEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x11CB6DF0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HollowEffectConfig_TypeDefinitionIndex = 54970;
