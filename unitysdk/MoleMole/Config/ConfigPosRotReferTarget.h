...
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_CHOOSEENTITYORTRANSFORM_OFFSET UNITYSDK_OFFSET(0xF980590)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_CHOOSEPOSROTTARGETENTITY_OFFSET UNITYSDK_OFFSET(0xF9851E0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_CHOOSESPECIALTRANSFORM_OFFSET UNITYSDK_OFFSET(0xF984AE0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_CLONE_OFFSET UNITYSDK_OFFSET(0xF9884F0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0xF988410)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xF987AF0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_FROMFLX_OFFSET UNITYSDK_OFFSET(0xF988660)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_GETABILITYTARGETOFFSETREFERENTITY_OFFSET UNITYSDK_OFFSET(0xF9853F0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_GETATTACHPOINT_OFFSET UNITYSDK_OFFSET(0xF987750)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_GETENTITYPOSROTBYTARGET_OFFSET UNITYSDK_OFFSET(0xF981670)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0xF9885F0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_GETOFFSETREFERTARGET_OFFSET UNITYSDK_OFFSET(0xF987A90)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_GETSAVEPOINTPOSROT_OFFSET UNITYSDK_OFFSET(0xF9868B0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_GETSAVEPOINTROTWITHCOORDS_OFFSET UNITYSDK_OFFSET(0xF986A20)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_GETTARGETENTITYPOSROT_OFFSET UNITYSDK_OFFSET(0xF981260)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_GETTARGETENTITY_OFFSET UNITYSDK_OFFSET(0xF987640)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0xF987B50)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0xF9886E0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_ISREFERTARGETCAMERA_OFFSET UNITYSDK_OFFSET(0xF9803C0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_ISSAVEPOINTOPTION_OFFSET UNITYSDK_OFFSET(0xF9875F0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_ISSPECIALITEMOPTION_OFFSET UNITYSDK_OFFSET(0xF984A90)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0xF988260)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0xF989A90)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0xF989BF0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET___BASE_GETATTACHPOINT_OFFSET UNITYSDK_OFFSET(0xF989C00)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET___BASE_GETENTITYPOSROTBYTARGET_OFFSET UNITYSDK_OFFSET(0xF989CA0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET___BASE_GETOFFSETREFERTARGET_OFFSET UNITYSDK_OFFSET(0xF989DA0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET___BASE_GETSAVEPOINTPOSROT_OFFSET UNITYSDK_OFFSET(0xF989E50)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET___BASE_GETTARGETENTITYPOSROT_OFFSET UNITYSDK_OFFSET(0xF98A080)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET___BASE_GETTARGETENTITY_OFFSET UNITYSDK_OFFSET(0xF989FA0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET___BASE_ISREFERTARGETCAMERA_OFFSET UNITYSDK_OFFSET(0xF98A300)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET___BASE_ISSAVEPOINTOPTION_OFFSET UNITYSDK_OFFSET(0xF98A420)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPosRotReferTarget_TypeDefinitionIndex = 68189;

	class ConfigPosRotReferTarget : public ::MoleMole::Config::PosRotTargetOption
	{
	public:
		::MoleMole::Config::DynamicString* PointName; // 0x10
		...
		::MoleMole::Config::DynamicString* BackupNodePoint; // 0x30
		::MoleMole::Config::DynamicString* BackupPointName; // 0x38
		::MoleMole::Config::DynamicString* BackupCustomKey; // 0x40
		...
		::System::Boolean IsUseAttachPointPos; // 0x55
		::System::Boolean IsUseAttachPointRotation; // 0x56
