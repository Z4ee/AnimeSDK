...
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_CHOOSEENTITYORTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B4CF980)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_CHOOSEPOSROTTARGETENTITY_OFFSET UNITYSDK_OFFSET(0x1B4D43F0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_CHOOSESPECIALTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B4D3CF0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_CLONE_OFFSET UNITYSDK_OFFSET(0x1B4D7410)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x1B4D7320)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B4D69F0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1B4D7520)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_GETABILITYTARGETOFFSETREFERENTITY_OFFSET UNITYSDK_OFFSET(0x1B4D4600)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_GETATTACHPOINT_OFFSET UNITYSDK_OFFSET(0x1B4D6650)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_GETENTITYPOSROTBYTARGET_OFFSET UNITYSDK_OFFSET(0x1B4D0970)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x1B4D7510)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_GETOFFSETREFERTARGET_OFFSET UNITYSDK_OFFSET(0x1B4D6990)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_GETSAVEPOINTPOSROT_OFFSET UNITYSDK_OFFSET(0x1B4D5820)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_GETSAVEPOINTROTWITHCOORDS_OFFSET UNITYSDK_OFFSET(0x1B4D59A0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_GETTARGETENTITYPOSROT_OFFSET UNITYSDK_OFFSET(0x1B4D0560)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_GETTARGETENTITY_OFFSET UNITYSDK_OFFSET(0x1B4D6540)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B4D6A50)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x1B4D75A0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_ISREFERTARGETCAMERA_OFFSET UNITYSDK_OFFSET(0x1B4CF7B0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_ISSAVEPOINTOPTION_OFFSET UNITYSDK_OFFSET(0x1B4D64F0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_ISSPECIALITEMOPTION_OFFSET UNITYSDK_OFFSET(0x1B4D3CA0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B4D7170)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x1B4D89B0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D8B10)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET___BASE_GETATTACHPOINT_OFFSET UNITYSDK_OFFSET(0x1B4D8B30)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET___BASE_GETENTITYPOSROTBYTARGET_OFFSET UNITYSDK_OFFSET(0x1B4D8BD0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET___BASE_GETOFFSETREFERTARGET_OFFSET UNITYSDK_OFFSET(0x1B4D8EE0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET___BASE_GETSAVEPOINTPOSROT_OFFSET UNITYSDK_OFFSET(0x1B4D8FA0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET___BASE_GETTARGETENTITYPOSROT_OFFSET UNITYSDK_OFFSET(0x1B4D92C0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET___BASE_GETTARGETENTITY_OFFSET UNITYSDK_OFFSET(0x1B4D9180)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET___BASE_ISREFERTARGETCAMERA_OFFSET UNITYSDK_OFFSET(0x1B4D9760)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET___BASE_ISSAVEPOINTOPTION_OFFSET UNITYSDK_OFFSET(0x1B4D98C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPosRotReferTarget_TypeDefinitionIndex = 82673;
	...
	public:
		...
		::MoleMole::Config::DynamicString* AttachPoint; // 0x18
		::MoleMole::Config::DynamicString* NodePoint; // 0x20
		::MoleMole::Config::DynamicString* PointName; // 0x28
		::MoleMole::Config::DynamicString* BackupCustomKey; // 0x30
		::MoleMole::Config::DynamicString* BackupNodePoint; // 0x38
		::MoleMole::Config::DynamicString* BackupAttachPoint; // 0x40
		::MoleMole::Config::DynamicString* CustomKey; // 0x48
		::MoleMole::Config::AbilityTargetting OffsetReferTarget; // 0x50
		::System::Boolean FeaturePointFirst; // 0x54
		::System::Boolean IsUseAttachPointRotation; // 0x55
		::System::Boolean IsUseAttachPointPos; // 0x56
		::MoleMole::Config::AbilityTargetting BackupOffsetReferTarget; // 0x58
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Struct_2_FA5F50563E60AFBA, ::MoleMole::Config::ReferTargetCoordsOption, ::MoleMole::Config::ReferTargetCoordsOption, ::MoleMole::Battle::Entity*, ::MoleMole::Battle::Entity*, ::Class_2_14986121AA61AD99*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_ISREFERTARGETCAMERA_OFFSET))(this, sourceEntity, coordsOption, backupCoordsOption, caster, other, instancedAbility, forceUseBackUp);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Struct_2_FA5F50563E60AFBA, ::MoleMole::Config::ReferTargetCoordsOption, ::MoleMole::Config::ReferTargetCoordsOption, ::UnityEngine::Vector3&, ::UnityEngine::Quaternion&, ::Struct_2_FA5F50563E60AFBA&, ::UnityEngine::Transform*&, ::Struct_2_69EDF57FCDC7C5D3&, ::System::Boolean&, ::MoleMole::Battle::Entity*, ::MoleMole::Battle::Entity*, ::Class_2_14986121AA61AD99*, ::MoleMole::Config::DynamicString*, ::MoleMole::Config::DynamicString*, ::MoleMole::Config::DynamicString*, ::MoleMole::Config::DynamicString*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_GETTARGETENTITYPOSROT_OFFSET))(this, sourceEntity, coordsOption, backupCoordsOption, targetPos, targetRot, targetEntity, targetTrans, targetCoods, useDefaultTarget, caster, other, instancedAbility, relativeBaseSavePoint, relativeTargetSavePoint, backupRelativeBaseSavePoint, backupRelativeTargetSavePoint, forceUseBackUp);
		}
		...
		{
			return ((::UnityEngine::Transform*(*)(::PVOID, ::MoleMole::Battle::Entity*, ::MoleMole::Config::AbilityTargetting, ::MoleMole::Config::DynamicString*, ::System::Boolean&, ::Struct_2_FC595D1A561D8C6F_1&, ::Class_2_14986121AA61AD99*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_CHOOSESPECIALTRANSFORM_OFFSET))(this, sourceEntity, referTarget, paramNodePoint, getLogicPos, logicPosRot, instancedAbility);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Struct_2_FA5F50563E60AFBA, ::MoleMole::Config::AbilityTargetting, ::MoleMole::Config::AbilityTargetting, ::MoleMole::Battle::Entity*, ::MoleMole::Battle::Entity*, ::Struct_2_FA5F50563E60AFBA&, ::UnityEngine::Transform*&, ::System::Boolean&, ::System::Boolean&, ::Struct_2_FC595D1A561D8C6F_1&, ::Class_2_14986121AA61AD99*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_CHOOSEENTITYORTRANSFORM_OFFSET))(this, sourceEntity, referTarget, backupTarget, caster, other, targetEntity, targetTransform, useDefaultTarget, useLogicPos, logicPosRot, instancedAbility, forceUseBackUpTarget);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::MoleMole::Battle::Entity*, ::Struct_2_FC595D1A561D8C6F_1&, ::System::Boolean&, ::MoleMole::Config::ReferTargetCoordsOption, ::MoleMole::Battle::Entity*, ::MoleMole::Config::DynamicString*, ::Class_2_14986121AA61AD99*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_GETSAVEPOINTPOSROT_OFFSET))(this, sourceEntity, posRot, useBackUp, coordsOption, caster, relativeBaseSavePoint, instanceAbility);
		}

		static ::System::Boolean GetSavePointRotWithCoords(::MoleMole::Battle::Entity* sourceEntity, ::MoleMole::Battle::Entity* caster, ::MoleMole::Config::ReferTargetCoordsOption coordsOption, ::System::String* pointName, ::Struct_2_FC595D1A561D8C6F_1& posRot, ::MoleMole::Config::DynamicString* relativeBaseSavePoint, ::Class_2_14986121AA61AD99* instanceAbility)
		{
			return ((::System::Boolean(*)(::MoleMole::Battle::Entity*, ::MoleMole::Battle::Entity*, ::MoleMole::Config::ReferTargetCoordsOption, ::System::String*, ::Struct_2_FC595D1A561D8C6F_1&, ::MoleMole::Config::DynamicString*, ::Class_2_14986121AA61AD99*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_GETSAVEPOINTROTWITHCOORDS_OFFSET))(sourceEntity, caster, coordsOption, pointName, posRot, relativeBaseSavePoint, instanceAbility);
		}
		...
		{
			return ((::Struct_2_FA5F50563E60AFBA(*)(::PVOID, ::MoleMole::Battle::Entity*, ::MoleMole::Battle::Entity*, ::MoleMole::Battle::Entity*, ::Class_2_14986121AA61AD99*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_GETTARGETENTITY_OFFSET))(this, sourceEntity, caster, other, instancedAbility);
		}

		::UnityEngine::Transform* GetAttachPoint(::MoleMole::Battle::Entity* sourceEntity, ::Class_2_14986121AA61AD99* instancedAbility)
		{
			return ((::UnityEngine::Transform*(*)(::PVOID, ::MoleMole::Battle::Entity*, ::Class_2_14986121AA61AD99*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_GETATTACHPOINT_OFFSET))(this, sourceEntity, instancedAbility);
		}
		...
		{
			return ((::Struct_2_FA5F50563E60AFBA(*)(::PVOID, ::Struct_2_FA5F50563E60AFBA, ::MoleMole::Config::AbilityTargetting, ::System::Boolean&, ::MoleMole::Battle::Entity*, ::MoleMole::Battle::Entity*, ::Class_2_14986121AA61AD99*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_CHOOSEPOSROTTARGETENTITY_OFFSET))(this, actor, offsetReferTargetType, useDefaultTarget, caster, other, instancedAbility, forceUseBackupTarget);
		}
		...
		{
			return ((::Struct_2_FA5F50563E60AFBA(*)(::PVOID, ::Struct_2_FA5F50563E60AFBA, ::MoleMole::Config::AbilityTargetting, ::MoleMole::Battle::Entity*, ::MoleMole::Battle::Entity*, ::System::Boolean, ::Class_2_14986121AA61AD99*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_GETABILITYTARGETOFFSETREFERENTITY_OFFSET))(this, actor, referTarget, caster, other, isBackUpTarget, instancedAbility);
		}
		...
		{
			return ((::UnityEngine::Transform*(*)(::PVOID, ::MoleMole::Battle::Entity*, ::Class_2_14986121AA61AD99*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET___BASE_GETATTACHPOINT_OFFSET))(this, P0, P1);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Struct_2_FA5F50563E60AFBA, ::Struct_2_FA5F50563E60AFBA, ::MoleMole::Config::ReferTargetCoordsOption, ::UnityEngine::Vector3&, ::UnityEngine::Quaternion&, ::UnityEngine::Transform*&, ::Struct_2_69EDF57FCDC7C5D3&, ::System::Boolean, ::MoleMole::Battle::Entity*, ::MoleMole::Battle::Entity*, ::UnityEngine::Transform*, ::Class_2_14986121AA61AD99*, ::MoleMole::Config::DynamicString*, ::MoleMole::Config::DynamicString*, ::System::Boolean, ::Struct_2_FC595D1A561D8C6F_1))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET___BASE_GETENTITYPOSROTBYTARGET_OFFSET))(this, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::MoleMole::Battle::Entity*, ::Struct_2_FC595D1A561D8C6F_1&, ::System::Boolean&, ::MoleMole::Config::ReferTargetCoordsOption, ::MoleMole::Battle::Entity*, ::MoleMole::Config::DynamicString*, ::Class_2_14986121AA61AD99*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET___BASE_GETSAVEPOINTPOSROT_OFFSET))(this, P0, P1, P2, P3, P4, P5, P6);
		}
		...
		{
			return ((::Struct_2_FA5F50563E60AFBA(*)(::PVOID, ::MoleMole::Battle::Entity*, ::MoleMole::Battle::Entity*, ::MoleMole::Battle::Entity*, ::Class_2_14986121AA61AD99*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET___BASE_GETTARGETENTITY_OFFSET))(this, P0, P1, P2, P3);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Struct_2_FA5F50563E60AFBA, ::MoleMole::Config::ReferTargetCoordsOption, ::MoleMole::Config::ReferTargetCoordsOption, ::UnityEngine::Vector3&, ::UnityEngine::Quaternion&, ::Struct_2_FA5F50563E60AFBA&, ::UnityEngine::Transform*&, ::Struct_2_69EDF57FCDC7C5D3&, ::System::Boolean&, ::MoleMole::Battle::Entity*, ::MoleMole::Battle::Entity*, ::Class_2_14986121AA61AD99*, ::MoleMole::Config::DynamicString*, ::MoleMole::Config::DynamicString*, ::MoleMole::Config::DynamicString*, ::MoleMole::Config::DynamicString*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET___BASE_GETTARGETENTITYPOSROT_OFFSET))(this, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Struct_2_FA5F50563E60AFBA, ::MoleMole::Config::ReferTargetCoordsOption, ::MoleMole::Config::ReferTargetCoordsOption, ::MoleMole::Battle::Entity*, ::MoleMole::Battle::Entity*, ::Class_2_14986121AA61AD99*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET___BASE_ISREFERTARGETCAMERA_OFFSET))(this, P0, P1, P2, P3, P4, P5, P6);
		}
