...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_RTPCBRANCH_EXECUTE_OFFSET UNITYSDK_OFFSET(0x170B6AE0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_RTPCBRANCH_GET_INSPECTORLABEL_OFFSET UNITYSDK_OFFSET(0x170B6AA0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_RTPCBRANCH_ISMATCH_OFFSET UNITYSDK_OFFSET(0x170B70A0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_RTPCBRANCH_WALK_OFFSET UNITYSDK_OFFSET(0x170B7250)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_RTPCBRANCH__CTOR_OFFSET UNITYSDK_OFFSET(0x170B7430)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_RTPCBRANCH___BASE_ISMATCH_OFFSET UNITYSDK_OFFSET(0x170B7470)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_RTPCBRANCH___BASE_WALK_OFFSET UNITYSDK_OFFSET(0x170B7480)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_RtpcBranch_TypeDefinitionIndex = 56020;
