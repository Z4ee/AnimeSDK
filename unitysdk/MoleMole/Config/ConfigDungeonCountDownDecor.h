...
#define MOLEMOLE_CONFIG_CONFIGDUNGEONCOUNTDOWNDECOR_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17D20330)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONCOUNTDOWNDECOR_FROMFLX_OFFSET UNITYSDK_OFFSET(0x17D200C0)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONCOUNTDOWNDECOR_METHOD_2_0F3EBA75648F5ADC_OFFSET UNITYSDK_OFFSET(0x17D20600)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONCOUNTDOWNDECOR_METHOD_2_3068CE0997573AE9_OFFSET UNITYSDK_OFFSET(0x17D20840)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONCOUNTDOWNDECOR_METHOD_2_7821D1D4DDDF7E01_OFFSET UNITYSDK_OFFSET(0x17D20140)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONCOUNTDOWNDECOR_METHOD_2_81438D3AF9EEE8D8_OFFSET UNITYSDK_OFFSET(0x17D1FF50)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONCOUNTDOWNDECOR_METHOD_2_8D1A086498C230B9_OFFSET UNITYSDK_OFFSET(0x17D20690)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONCOUNTDOWNDECOR_METHOD_2_A042C46DE73C3043_OFFSET UNITYSDK_OFFSET(0x17D1FF40)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONCOUNTDOWNDECOR_METHOD_2_C444D4C8B9D548AF_OFFSET UNITYSDK_OFFSET(0x17D20050)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONCOUNTDOWNDECOR_METHOD_2_D39AAF7777560A81_OFFSET UNITYSDK_OFFSET(0x17D20390)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONCOUNTDOWNDECOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17D20680)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDungeonCountDownDecor_TypeDefinitionIndex = 82037;
