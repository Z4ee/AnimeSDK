...
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGETTINGFILTER_MATCHENTITYWITHLIST_OFFSET UNITYSDK_OFFSET(0x18F2EDB0)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGETTINGFILTER_VALUEPASS_OFFSET UNITYSDK_OFFSET(0x18F2DEC0)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGETTINGFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18F2EE90)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAbilityTargettingFilter_TypeDefinitionIndex = 73864;
