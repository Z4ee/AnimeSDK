...
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGETTINGFILTER_MATCHENTITYWITHLIST_OFFSET UNITYSDK_OFFSET(0x11025460)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGETTINGFILTER_VALUEPASS_OFFSET UNITYSDK_OFFSET(0x11024560)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGETTINGFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x11025540)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAbilityTargettingFilter_TypeDefinitionIndex = 47831;
