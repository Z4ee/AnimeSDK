...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEINT_CLONE_OFFSET UNITYSDK_OFFSET(0x106CC0F0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEINT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x106CC0E0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEINT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x106CC600)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEINT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x106CC260)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEINT_GETCONFIGDYNAMICVALUETYPE_OFFSET UNITYSDK_OFFSET(0x106CBF80)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEINT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x106CC1F0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEINT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x106CC660)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEINT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x106CC2E0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEINT_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x106CBFC0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEINT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x106CC890)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEINT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x106CC4A0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEINT_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0x106CBED0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEINT__CTOR_OFFSET UNITYSDK_OFFSET(0x106CC090)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEINT___BASE_GETCONFIGDYNAMICVALUETYPE_OFFSET UNITYSDK_OFFSET(0x106CCA40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicValueInt_TypeDefinitionIndex = 80291;
