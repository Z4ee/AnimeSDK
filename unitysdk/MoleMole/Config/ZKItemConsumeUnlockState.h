...
#define MOLEMOLE_CONFIG_ZKITEMCONSUMEUNLOCKSTATE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x161A2240)
#define MOLEMOLE_CONFIG_ZKITEMCONSUMEUNLOCKSTATE_FROMFLX_OFFSET UNITYSDK_OFFSET(0x161A1E30)
#define MOLEMOLE_CONFIG_ZKITEMCONSUMEUNLOCKSTATE_METHOD_1_0AFE2382BF92DEC7_OFFSET UNITYSDK_OFFSET(0x161A22A0)
#define MOLEMOLE_CONFIG_ZKITEMCONSUMEUNLOCKSTATE_METHOD_1_DF413489329CBAF8_OFFSET UNITYSDK_OFFSET(0x161A1EB0)
#define MOLEMOLE_CONFIG_ZKITEMCONSUMEUNLOCKSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x161A2530)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ZKItemConsumeUnlockState_TypeDefinitionIndex = 70579;
