...
#define MOLEMOLE_CONFIG_DYNAMICSTRING_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17057400)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_FROMFLX_OFFSET UNITYSDK_OFFSET(0x17056FD0)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_FROMJSON_OFFSET UNITYSDK_OFFSET(0x17057110)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_GET_DYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x17056F90)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_GET_FIXEDVALUE_OFFSET UNITYSDK_OFFSET(0x17056FB0)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_GET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x17056F70)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_SET_DYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x17056FA0)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_SET_FIXEDVALUE_OFFSET UNITYSDK_OFFSET(0x17056FC0)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_SET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x17056F80)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_TOJSON_OFFSET UNITYSDK_OFFSET(0x17057280)
#define MOLEMOLE_CONFIG_DYNAMICSTRING__CCTOR_OFFSET UNITYSDK_OFFSET(0x17057680)
#define MOLEMOLE_CONFIG_DYNAMICSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x17057670)

namespace MoleMole::Config
{
	inline static constexpr unsigned int DynamicString_TypeDefinitionIndex = 66395;
	...
	public:
		...
		{
			return (::MoleMole::Config::ReadonlyDynamicString**)Il2CppClass::FromTypeDefinitionIndex(DynamicString_TypeDefinitionIndex)->GetStaticField(0x37350);
		}
