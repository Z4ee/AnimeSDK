...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDENTERBATTLEPREVVIDEO_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x1743E8C0)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDENTERBATTLEPREVVIDEO__CTOR_OFFSET UNITYSDK_OFFSET(0x1743E980)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardEnterBattlePrevVideo_TypeDefinitionIndex = 81394;
