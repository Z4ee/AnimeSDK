...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDENTERBATTLEPREVVIDEO_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x1703AB20)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDENTERBATTLEPREVVIDEO__CTOR_OFFSET UNITYSDK_OFFSET(0x1703ABE0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardEnterBattlePrevVideo_TypeDefinitionIndex = 47717;
