...
#define MOLEMOLE_CONFIG_EFFECTPATTERN_MONOEFFECTPLUGINFOLLOWSODATA_NEW_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x177E5210)
#define MOLEMOLE_CONFIG_EFFECTPATTERN_MONOEFFECTPLUGINFOLLOWSODATA_NEW_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19FF2B30)
#define MOLEMOLE_CONFIG_EFFECTPATTERN_MONOEFFECTPLUGINFOLLOWSODATA_NEW__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF2DE0)

namespace MoleMole::Config::EffectPattern
{
	inline static constexpr unsigned int MonoEffectPluginFollowSoData_New_TypeDefinitionIndex = 86673;
