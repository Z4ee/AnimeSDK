...
#define MOLEMOLE_CONFIG_EFFECTPATTERN_MONOEFFECTPLUGINFOLLOWSODATA_NEW_VALUEDICTWRAPPER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C46A3F0)
#define MOLEMOLE_CONFIG_EFFECTPATTERN_MONOEFFECTPLUGINFOLLOWSODATA_NEW_VALUEDICTWRAPPER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C46A660)
#define MOLEMOLE_CONFIG_EFFECTPATTERN_MONOEFFECTPLUGINFOLLOWSODATA_NEW_VALUEDICTWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C46A940)

namespace MoleMole::Config::EffectPattern
{
	inline static constexpr unsigned int MonoEffectPluginFollowSoData_New_ValueDictWrapper_TypeDefinitionIndex = 86674;
