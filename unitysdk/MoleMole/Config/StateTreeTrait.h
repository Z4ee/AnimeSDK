...
#define MOLEMOLE_CONFIG_STATETREETRAIT_BUILDENTITYCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1A947360)
#define MOLEMOLE_CONFIG_STATETREETRAIT_CLONE_OFFSET UNITYSDK_OFFSET(0x1A946A10)
#define MOLEMOLE_CONFIG_STATETREETRAIT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x1A946A00)
#define MOLEMOLE_CONFIG_STATETREETRAIT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A946EB0)
#define MOLEMOLE_CONFIG_STATETREETRAIT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1A946B20)
#define MOLEMOLE_CONFIG_STATETREETRAIT_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1A947310)
#define MOLEMOLE_CONFIG_STATETREETRAIT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x1A946B10)
#define MOLEMOLE_CONFIG_STATETREETRAIT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A946F10)
#define MOLEMOLE_CONFIG_STATETREETRAIT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x1A946BA0)
#define MOLEMOLE_CONFIG_STATETREETRAIT_ONPOSTENTITYDISSOCIATE_OFFSET UNITYSDK_OFFSET(0x1A947770)
#define MOLEMOLE_CONFIG_STATETREETRAIT_ONPOSTENTITYREADY_OFFSET UNITYSDK_OFFSET(0x1A947470)
#define MOLEMOLE_CONFIG_STATETREETRAIT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A947160)
#define MOLEMOLE_CONFIG_STATETREETRAIT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x1A946D50)
#define MOLEMOLE_CONFIG_STATETREETRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A947940)
#define MOLEMOLE_CONFIG_STATETREETRAIT___BASE_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1A947950)

namespace MoleMole::Config
{
	inline static constexpr unsigned int StateTreeTrait_TypeDefinitionIndex = 87577;
	...
	public:
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_BE29B49AC03370B6*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_STATETREETRAIT_GENERATECOMPONENT_OFFSET))(this, buildContext);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_BE29B49AC03370B6*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_STATETREETRAIT___BASE_GENERATECOMPONENT_OFFSET))(this, P0);
		}
	};
}
