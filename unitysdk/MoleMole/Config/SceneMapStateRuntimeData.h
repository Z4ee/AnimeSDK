...
#define MOLEMOLE_CONFIG_SCENEMAPSTATERUNTIMEDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xFB12880)
#define MOLEMOLE_CONFIG_SCENEMAPSTATERUNTIMEDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0xFB11ED0)
#define MOLEMOLE_CONFIG_SCENEMAPSTATERUNTIMEDATA_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0xFB11F50)
#define MOLEMOLE_CONFIG_SCENEMAPSTATERUNTIMEDATA_METHOD_1_E7B4A536DFAE42AC_OFFSET UNITYSDK_OFFSET(0xFB128E0)
#define MOLEMOLE_CONFIG_SCENEMAPSTATERUNTIMEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xFB12C70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SceneMapStateRuntimeData_TypeDefinitionIndex = 54164;
