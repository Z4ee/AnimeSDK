...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_STATE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x17D5F730)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_STATE_GET_INSPECTORLABEL_OFFSET UNITYSDK_OFFSET(0x17D5F6F0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_STATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17D5F970)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundActionTriggerCondition_State_TypeDefinitionIndex = 86961;
