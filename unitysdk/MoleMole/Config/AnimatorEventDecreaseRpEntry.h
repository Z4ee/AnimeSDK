...
#define MOLEMOLE_CONFIG_ANIMATOREVENTDECREASERPENTRY_CREATEANIMATIONEVENT_OFFSET UNITYSDK_OFFSET(0x17D0FF00)
#define MOLEMOLE_CONFIG_ANIMATOREVENTDECREASERPENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x17D0FF80)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorEventDecreaseRpEntry_TypeDefinitionIndex = 77971;
