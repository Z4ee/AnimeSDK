...
#define MOLEMOLE_CONFIG_ANIMATORZONEMUTEHUD_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x11465220)
#define MOLEMOLE_CONFIG_ANIMATORZONEMUTEHUD_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x11465400)
#define MOLEMOLE_CONFIG_ANIMATORZONEMUTEHUD__CTOR_OFFSET UNITYSDK_OFFSET(0x11465610)
#define MOLEMOLE_CONFIG_ANIMATORZONEMUTEHUD___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x11465620)
#define MOLEMOLE_CONFIG_ANIMATORZONEMUTEHUD___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x114656D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneMuteHUD_TypeDefinitionIndex = 60129;

	class AnimatorZoneMuteHUD : public ::MoleMole::Config::AnimatorZone
	{
	public:
		::System::Boolean IsIgnoreAni_UnActive; // 0x50
