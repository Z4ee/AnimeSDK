...
#define MOLEMOLE_CONFIG_ANIMATIONCURVELIBRARY_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x150E7000)
#define MOLEMOLE_CONFIG_ANIMATIONCURVELIBRARY_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x150E7470)
#define MOLEMOLE_CONFIG_ANIMATIONCURVELIBRARY__CTOR_OFFSET UNITYSDK_OFFSET(0x150E7950)
#define MOLEMOLE_CONFIG_ANIMATIONCURVELIBRARY___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x150E7BB0)
#define MOLEMOLE_CONFIG_ANIMATIONCURVELIBRARY___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x150E7BC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimationCurveLibrary_TypeDefinitionIndex = 90512;
