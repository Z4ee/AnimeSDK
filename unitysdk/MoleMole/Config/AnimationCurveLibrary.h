...
#define MOLEMOLE_CONFIG_ANIMATIONCURVELIBRARY_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x17434AD0)
#define MOLEMOLE_CONFIG_ANIMATIONCURVELIBRARY_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x17434F40)
#define MOLEMOLE_CONFIG_ANIMATIONCURVELIBRARY__CTOR_OFFSET UNITYSDK_OFFSET(0x17435420)
#define MOLEMOLE_CONFIG_ANIMATIONCURVELIBRARY___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x17435680)
#define MOLEMOLE_CONFIG_ANIMATIONCURVELIBRARY___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x17435690)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimationCurveLibrary_TypeDefinitionIndex = 54463;
