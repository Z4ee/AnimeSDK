...
#define MOLEMOLE_CONFIG_CONFIGENTITYVIGNETTES__CTOR_OFFSET UNITYSDK_OFFSET(0x110A2140)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityVignettes_TypeDefinitionIndex = 73642;
