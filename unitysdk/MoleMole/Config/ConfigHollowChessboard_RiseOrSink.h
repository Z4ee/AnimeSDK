...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_RISEORSINK_GETSUPPORTEDDURATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1929D3B0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_RISEORSINK_GET_TOTALDURATION_OFFSET UNITYSDK_OFFSET(0x1929D3A0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_RISEORSINK_RUN_OFFSET UNITYSDK_OFFSET(0x1929D210)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_RISEORSINK__CTOR_OFFSET UNITYSDK_OFFSET(0x1929D450)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_RISEORSINK___BASE_GETSUPPORTEDDURATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1929D460)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_RiseOrSink_TypeDefinitionIndex = 64437;
