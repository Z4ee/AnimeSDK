...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_RISEORSINK_GETSUPPORTEDDURATIONTYPE_OFFSET UNITYSDK_OFFSET(0x14864D60)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_RISEORSINK_GET_TOTALDURATION_OFFSET UNITYSDK_OFFSET(0x14864D50)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_RISEORSINK_RUN_OFFSET UNITYSDK_OFFSET(0x14864BD0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_RISEORSINK__CTOR_OFFSET UNITYSDK_OFFSET(0x14864E00)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_RISEORSINK___BASE_GETSUPPORTEDDURATIONTYPE_OFFSET UNITYSDK_OFFSET(0x14864E10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_RiseOrSink_TypeDefinitionIndex = 59225;
