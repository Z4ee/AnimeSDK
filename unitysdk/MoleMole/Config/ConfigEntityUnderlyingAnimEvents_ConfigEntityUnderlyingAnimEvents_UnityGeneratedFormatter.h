...
#define MOLEMOLE_CONFIG_CONFIGENTITYUNDERLYINGANIMEVENTS_CONFIGENTITYUNDERLYINGANIMEVENTS_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x11029F70)
#define MOLEMOLE_CONFIG_CONFIGENTITYUNDERLYINGANIMEVENTS_CONFIGENTITYUNDERLYINGANIMEVENTS_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x11029F80)
#define MOLEMOLE_CONFIG_CONFIGENTITYUNDERLYINGANIMEVENTS_CONFIGENTITYUNDERLYINGANIMEVENTS_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x1102A220)
#define MOLEMOLE_CONFIG_CONFIGENTITYUNDERLYINGANIMEVENTS_CONFIGENTITYUNDERLYINGANIMEVENTS_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1102A410)
#define MOLEMOLE_CONFIG_CONFIGENTITYUNDERLYINGANIMEVENTS_CONFIGENTITYUNDERLYINGANIMEVENTS_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1102A3D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityUnderlyingAnimEvents_ConfigEntityUnderlyingAnimEvents_UnityGeneratedFormatter_TypeDefinitionIndex = 46451;
