...
#define MOLEMOLE_CONFIG_CONFIGZIPLINE_CFLOATINTENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x17056EA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigZipLine_CFloatIntEntry_TypeDefinitionIndex = 51228;
