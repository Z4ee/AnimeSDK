...
#define MOLEMOLE_CONFIG_MATPROPERTYSETTING_MATPROPERTYSETTING_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x17D6BE20)
#define MOLEMOLE_CONFIG_MATPROPERTYSETTING_MATPROPERTYSETTING_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x17D6BE30)
#define MOLEMOLE_CONFIG_MATPROPERTYSETTING_MATPROPERTYSETTING_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x17D6C140)
#define MOLEMOLE_CONFIG_MATPROPERTYSETTING_MATPROPERTYSETTING_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x17D6C370)
#define MOLEMOLE_CONFIG_MATPROPERTYSETTING_MATPROPERTYSETTING_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x17D6C310)

namespace MoleMole::Config
{
	inline static constexpr unsigned int MatPropertySetting_MatPropertySetting_UnityGeneratedFormatter_TypeDefinitionIndex = 58790;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(MatPropertySetting_MatPropertySetting_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3E9E0);
		}
