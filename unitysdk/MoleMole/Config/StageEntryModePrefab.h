...
#define MOLEMOLE_CONFIG_STAGEENTRYMODEPREFAB__CTOR_OFFSET UNITYSDK_OFFSET(0x172BEAE0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int StageEntryModePrefab_TypeDefinitionIndex = 53363;
