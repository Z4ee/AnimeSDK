...
#define MOLEMOLE_CONFIG_CONFIGSPECIALTRAINING__CTOR_OFFSET UNITYSDK_OFFSET(0x192A8F30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSpecialTraining_TypeDefinitionIndex = 71372;
