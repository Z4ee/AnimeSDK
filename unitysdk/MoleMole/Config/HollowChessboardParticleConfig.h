...
#define MOLEMOLE_CONFIG_HOLLOWCHESSBOARDPARTICLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x123192F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HollowChessboardParticleConfig_TypeDefinitionIndex = 42281;
