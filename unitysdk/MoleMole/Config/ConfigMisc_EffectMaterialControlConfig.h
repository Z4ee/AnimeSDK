...
#define MOLEMOLE_CONFIG_CONFIGMISC_EFFECTMATERIALCONTROLCONFIG_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x730950)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMisc_EffectMaterialControlConfig_TypeDefinitionIndex = 48038;
