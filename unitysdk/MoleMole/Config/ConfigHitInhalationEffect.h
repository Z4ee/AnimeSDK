...
#define MOLEMOLE_CONFIG_CONFIGHITINHALATIONEFFECT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x159ECD50)
#define MOLEMOLE_CONFIG_CONFIGHITINHALATIONEFFECT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x159EC6C0)
#define MOLEMOLE_CONFIG_CONFIGHITINHALATIONEFFECT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x159ECDB0)
#define MOLEMOLE_CONFIG_CONFIGHITINHALATIONEFFECT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x159EC740)
#define MOLEMOLE_CONFIG_CONFIGHITINHALATIONEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x159ED0F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHitInhalationEffect_TypeDefinitionIndex = 68368;

	class ConfigHitInhalationEffect : public ::System::Object
	{
	public:
		::System::Boolean ApplyAttackerFaceDir; // 0x10
		::System::Boolean UseInhalation; // 0x11
		::System::Single MaxInhalationDistance; // 0x14
