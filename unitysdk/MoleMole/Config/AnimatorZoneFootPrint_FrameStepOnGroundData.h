...
#define MOLEMOLE_CONFIG_ANIMATORZONEFOOTPRINT_FRAMESTEPONGROUNDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD4A100)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneFootPrint_FrameStepOnGroundData_TypeDefinitionIndex = 90786;
