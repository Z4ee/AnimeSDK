...
#define MOLEMOLE_CONFIG_ANIMATORZONEFOOTPRINT_FRAMESTEPONGROUNDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x144CE160)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneFootPrint_FrameStepOnGroundData_TypeDefinitionIndex = 75812;
