...
#define MOLEMOLE_CONFIG_ANIMATORZONEMUTEINPUT_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x143619F0)
#define MOLEMOLE_CONFIG_ANIMATORZONEMUTEINPUT_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x14361C80)
#define MOLEMOLE_CONFIG_ANIMATORZONEMUTEINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x14361E30)
#define MOLEMOLE_CONFIG_ANIMATORZONEMUTEINPUT___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x14361EC0)
#define MOLEMOLE_CONFIG_ANIMATORZONEMUTEINPUT___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x14361F70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneMuteInput_TypeDefinitionIndex = 81093;
