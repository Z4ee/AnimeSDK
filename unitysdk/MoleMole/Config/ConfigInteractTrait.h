...
#define MOLEMOLE_CONFIG_CONFIGINTERACTTRAIT_CLONEDATA_OFFSET UNITYSDK_OFFSET(0x14868B40)
#define MOLEMOLE_CONFIG_CONFIGINTERACTTRAIT_CLONE_OFFSET UNITYSDK_OFFSET(0x14866210)
#define MOLEMOLE_CONFIG_CONFIGINTERACTTRAIT_DOLOADDATA_OFFSET UNITYSDK_OFFSET(0x14869000)
#define MOLEMOLE_CONFIG_CONFIGINTERACTTRAIT_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x14866310)
#define MOLEMOLE_CONFIG_CONFIGINTERACTTRAIT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x14866190)
#define MOLEMOLE_CONFIG_CONFIGINTERACTTRAIT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x14867EE0)
#define MOLEMOLE_CONFIG_CONFIGINTERACTTRAIT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x14866BA0)
#define MOLEMOLE_CONFIG_CONFIGINTERACTTRAIT_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x14868790)
#define MOLEMOLE_CONFIG_CONFIGINTERACTTRAIT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x14866300)
#define MOLEMOLE_CONFIG_CONFIGINTERACTTRAIT_GET_INTERACTPRIORITY_OFFSET UNITYSDK_OFFSET(0x14868730)
#define MOLEMOLE_CONFIG_CONFIGINTERACTTRAIT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x14867F40)
#define MOLEMOLE_CONFIG_CONFIGINTERACTTRAIT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x14866C20)
#define MOLEMOLE_CONFIG_CONFIGINTERACTTRAIT_LOADDATA_OFFSET UNITYSDK_OFFSET(0x14868AD0)
#define MOLEMOLE_CONFIG_CONFIGINTERACTTRAIT_LOADGROUPDATALIST_OFFSET UNITYSDK_OFFSET(0x14869380)
#define MOLEMOLE_CONFIG_CONFIGINTERACTTRAIT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x148685A0)
#define MOLEMOLE_CONFIG_CONFIGINTERACTTRAIT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x14867DA0)
#define MOLEMOLE_CONFIG_CONFIGINTERACTTRAIT_TRYLOADRESOURCEFROMCACHE_OFFSET UNITYSDK_OFFSET(0x14869510)
#define MOLEMOLE_CONFIG_CONFIGINTERACTTRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x14869600)
#define MOLEMOLE_CONFIG_CONFIGINTERACTTRAIT___BASE_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x14869680)
#define MOLEMOLE_CONFIG_CONFIGINTERACTTRAIT___BASE_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x14869690)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigInteractTrait_TypeDefinitionIndex = 43847;
	...
	public:
		...
		::System::Single OverrideHoldInputTime; // 0x60
		::Class_1_43BD383C98B4C0C5_49* _mainInteractRunData; // 0x68
		::System::Collections::Generic::List_1<::Class_1_43BD383C98B4C0C5_49*>* _otherInteractRunDataList; // 0x70
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_198*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGINTERACTTRAIT_EXPOSEMEMBER_OFFSET))(this, processor, prefix);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_BE29B49AC03370B6*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGINTERACTTRAIT_GENERATECOMPONENT_OFFSET))(this, buildContext);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_198*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGINTERACTTRAIT___BASE_EXPOSEMEMBER_OFFSET))(this, P0, P1);
		}

		::System::Boolean __base_GenerateComponent(::Class_1_BE29B49AC03370B6* P0)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_BE29B49AC03370B6*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGINTERACTTRAIT___BASE_GENERATECOMPONENT_OFFSET))(this, P0);
		}
	};
}
