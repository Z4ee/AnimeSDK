...
#define MOLEMOLE_CONFIG_CONFIGDIFFICULTYTAGPAIR_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x144D9D90)
#define MOLEMOLE_CONFIG_CONFIGDIFFICULTYTAGPAIR_FROMFLX_OFFSET UNITYSDK_OFFSET(0x144D99A0)
#define MOLEMOLE_CONFIG_CONFIGDIFFICULTYTAGPAIR_METHOD_1_25996F1180FB0C28_OFFSET UNITYSDK_OFFSET(0x144D9DF0)
#define MOLEMOLE_CONFIG_CONFIGDIFFICULTYTAGPAIR_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0x144D9A20)
#define MOLEMOLE_CONFIG_CONFIGDIFFICULTYTAGPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x144DA080)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDifficultyTagPair_TypeDefinitionIndex = 70211;
