...
#define MOLEMOLE_CONFIG_CONFIGDIFFICULTYTAGPAIR_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BD558C0)
#define MOLEMOLE_CONFIG_CONFIGDIFFICULTYTAGPAIR_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1BD55520)
#define MOLEMOLE_CONFIG_CONFIGDIFFICULTYTAGPAIR_METHOD_1_25996F1180FB0C28_OFFSET UNITYSDK_OFFSET(0x1BD55920)
#define MOLEMOLE_CONFIG_CONFIGDIFFICULTYTAGPAIR_METHOD_1_8741A88D50268453_OFFSET UNITYSDK_OFFSET(0x1BD555A0)
#define MOLEMOLE_CONFIG_CONFIGDIFFICULTYTAGPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD55BB0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDifficultyTagPair_TypeDefinitionIndex = 85837;
	...
	public:
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::FlexBuffers::FlxMap))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGDIFFICULTYTAGPAIR_METHOD_1_8741A88D50268453_OFFSET))(this, a1);
		}
	};
}
