...
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYBODYSIZE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x12B32320)
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYBODYSIZE_PASS_OFFSET UNITYSDK_OFFSET(0x12B32220)
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYBODYSIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x12B32330)

namespace MoleMole::Config
{
	inline static constexpr unsigned int CameraStoryDataActiveConditionByBodySize_TypeDefinitionIndex = 52409;
