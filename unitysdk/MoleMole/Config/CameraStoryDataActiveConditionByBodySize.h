...
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYBODYSIZE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x12D31BA0)
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYBODYSIZE_PASS_OFFSET UNITYSDK_OFFSET(0x12D31AA0)
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYBODYSIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x12D31BB0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int CameraStoryDataActiveConditionByBodySize_TypeDefinitionIndex = 71778;
