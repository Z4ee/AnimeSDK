...
#define MOLEMOLE_CONFIG_ANIMATORZONEDRONEVERTICALMOVE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x106BF450)
#define MOLEMOLE_CONFIG_ANIMATORZONEDRONEVERTICALMOVE_GET_ISUPDATEONEFRAME_OFFSET UNITYSDK_OFFSET(0x106BE480)
#define MOLEMOLE_CONFIG_ANIMATORZONEDRONEVERTICALMOVE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x106BE9B0)
#define MOLEMOLE_CONFIG_ANIMATORZONEDRONEVERTICALMOVE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x106BE490)
#define MOLEMOLE_CONFIG_ANIMATORZONEDRONEVERTICALMOVE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x106BF1D0)
#define MOLEMOLE_CONFIG_ANIMATORZONEDRONEVERTICALMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x106BF4E0)
#define MOLEMOLE_CONFIG_ANIMATORZONEDRONEVERTICALMOVE___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x106BF4F0)
#define MOLEMOLE_CONFIG_ANIMATORZONEDRONEVERTICALMOVE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x106BF5C0)
#define MOLEMOLE_CONFIG_ANIMATORZONEDRONEVERTICALMOVE___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x106BF680)
#define MOLEMOLE_CONFIG_ANIMATORZONEDRONEVERTICALMOVE___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x106BF730)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneDroneVerticalMove_TypeDefinitionIndex = 39822;

	class AnimatorZoneDroneVerticalMove : public ::MoleMole::Config::AnimatorZone
	{
	public:
		::System::String* MinHeightBrakingCurve; // 0x50
		::System::String* MaxHeightBrakingCurve; // 0x58
		::System::Single MaxHeightBrakingDistance; // 0x60
		::System::Boolean UseInputMagnitude; // 0x64
		::System::Single InPlaceMovePeriod; // 0x68
		::System::Single Speed; // 0x6C
		::System::Single InPlaceMoveSpeed; // 0x70
		::System::Single Acceleration; // 0x74
		::System::Single MinHeightBrakingDistance; // 0x78
		::System::Single Deceleration; // 0x7C
