...
#define MOLEMOLE_CONFIG_CONFIGSURFGAMEITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C465EB0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSurfGameItemData_TypeDefinitionIndex = 86643;
