...
#define MOLEMOLE_CONFIG_CONFIGGAMEPADRUMBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B54C7E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigGamepadRumble_TypeDefinitionIndex = 66873;
