...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_PIECECHANGESTRUCTCONFIGGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xF13BCE0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_PieceChangeStructConfigGroup_TypeDefinitionIndex = 59259;

	class ConfigHollowChessboard_PieceChangeStructConfigGroup : public ::System::Object
	{
	public:
		::MoleMole::Config::ConfigHollowChessboard_PieceChangeStructConfig* SinkConfig; // 0x10
