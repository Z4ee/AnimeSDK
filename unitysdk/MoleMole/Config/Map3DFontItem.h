...
#define MOLEMOLE_CONFIG_MAP3DFONTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7FE630)

namespace MoleMole::Config
{
	inline static constexpr unsigned int Map3DFontItem_TypeDefinitionIndex = 46697;
