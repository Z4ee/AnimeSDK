...
#define MOLEMOLE_CONFIG_CONFIGTRIGGERCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD65460)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTriggerCache_TypeDefinitionIndex = 69569;
