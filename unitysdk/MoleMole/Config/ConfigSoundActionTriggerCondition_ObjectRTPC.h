...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_OBJECTRTPC_COMPARE_OFFSET UNITYSDK_OFFSET(0x144E4A50)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_OBJECTRTPC_EVALUATE_OFFSET UNITYSDK_OFFSET(0x144E4510)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_OBJECTRTPC_GET_INSPECTORLABEL_OFFSET UNITYSDK_OFFSET(0x144E44D0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_OBJECTRTPC__CTOR_OFFSET UNITYSDK_OFFSET(0x144E4B40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundActionTriggerCondition_ObjectRTPC_TypeDefinitionIndex = 47964;
