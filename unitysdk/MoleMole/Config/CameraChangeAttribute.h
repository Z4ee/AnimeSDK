...
#define MOLEMOLE_CONFIG_CAMERACHANGEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x16257170)

namespace MoleMole::Config
{
	inline static constexpr unsigned int CameraChangeAttribute_TypeDefinitionIndex = 47228;
