...
#define MOLEMOLE_CONFIG_CONFIGSURFGAMEITEMSPEEDCURVEACTION_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19FF24C0)
#define MOLEMOLE_CONFIG_CONFIGSURFGAMEITEMSPEEDCURVEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF26B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSurfGameItemSpeedCurveAction_TypeDefinitionIndex = 69319;
