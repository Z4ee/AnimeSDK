...
#define MOLEMOLE_CONFIG_CONFIGENTITYUNDERLYINGANIMEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0xFB041B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityUnderlyingAnimEvents_TypeDefinitionIndex = 46450;
