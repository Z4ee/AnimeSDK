...
#define MOLEMOLE_CONFIG_CONFIGENTITYUNDERLYINGANIMEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0xE96A560)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityUnderlyingAnimEvents_TypeDefinitionIndex = 55243;
