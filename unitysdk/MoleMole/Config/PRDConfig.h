...
#define MOLEMOLE_CONFIG_PRDCONFIG_CALACPRD_OFFSET UNITYSDK_OFFSET(0x1A35F470)
#define MOLEMOLE_CONFIG_PRDCONFIG_CFROMP_OFFSET UNITYSDK_OFFSET(0x1A35F690)
#define MOLEMOLE_CONFIG_PRDCONFIG_PFROMC_OFFSET UNITYSDK_OFFSET(0x1A35F990)
#define MOLEMOLE_CONFIG_PRDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A35FB00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int PRDConfig_TypeDefinitionIndex = 41982;
