...
#define MOLEMOLE_CONFIG_PRDCONFIG_CALACPRD_OFFSET UNITYSDK_OFFSET(0x183D2780)
#define MOLEMOLE_CONFIG_PRDCONFIG_CFROMP_OFFSET UNITYSDK_OFFSET(0x183D29A0)
#define MOLEMOLE_CONFIG_PRDCONFIG_PFROMC_OFFSET UNITYSDK_OFFSET(0x183D2CA0)
#define MOLEMOLE_CONFIG_PRDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x183D2E10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int PRDConfig_TypeDefinitionIndex = 56695;
