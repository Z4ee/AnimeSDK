...
#define MOLEMOLE_CONFIG_BLACKMASKFADECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17D49110)

namespace MoleMole::Config
{
	inline static constexpr unsigned int BlackMaskFadeConfig_TypeDefinitionIndex = 54407;
