...
#define MOLEMOLE_CONFIG_CONFIGSYSTEMSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x17D63430)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSystemSetting_TypeDefinitionIndex = 67969;
