...
#define MOLEMOLE_CONFIG_ANIMATOREVENTNOOP_METHOD_2_0589B5E7626E6766_1_OFFSET UNITYSDK_OFFSET(0x12D24E70)
#define MOLEMOLE_CONFIG_ANIMATOREVENTNOOP_METHOD_2_0589B5E7626E6766_OFFSET UNITYSDK_OFFSET(0x12D24DD0)
#define MOLEMOLE_CONFIG_ANIMATOREVENTNOOP_METHOD_2_128774387667156B_OFFSET UNITYSDK_OFFSET(0x12D24F50)
#define MOLEMOLE_CONFIG_ANIMATOREVENTNOOP_TOSTRING_OFFSET UNITYSDK_OFFSET(0x12D24C90)
#define MOLEMOLE_CONFIG_ANIMATOREVENTNOOP__CTOR_OFFSET UNITYSDK_OFFSET(0x12D24E60)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorEventNoOp_TypeDefinitionIndex = 76497;
