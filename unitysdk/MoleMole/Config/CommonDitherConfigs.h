...
#define MOLEMOLE_CONFIG_COMMONDITHERCONFIGS_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x116F9220)
#define MOLEMOLE_CONFIG_COMMONDITHERCONFIGS_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x116F8B50)
#define MOLEMOLE_CONFIG_COMMONDITHERCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x116F9A80)
#define MOLEMOLE_CONFIG_COMMONDITHERCONFIGS___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x116F9D70)
#define MOLEMOLE_CONFIG_COMMONDITHERCONFIGS___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x116F9D80)

namespace MoleMole::Config
{
	inline static constexpr unsigned int CommonDitherConfigs_TypeDefinitionIndex = 65815;
