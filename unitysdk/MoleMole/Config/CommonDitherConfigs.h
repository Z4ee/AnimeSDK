...
#define MOLEMOLE_CONFIG_COMMONDITHERCONFIGS_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x10CFA190)
#define MOLEMOLE_CONFIG_COMMONDITHERCONFIGS_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x10CF9AC0)
#define MOLEMOLE_CONFIG_COMMONDITHERCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x10CFA9F0)
#define MOLEMOLE_CONFIG_COMMONDITHERCONFIGS___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x10CFACE0)
#define MOLEMOLE_CONFIG_COMMONDITHERCONFIGS___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x10CFACF0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int CommonDitherConfigs_TypeDefinitionIndex = 67277;
