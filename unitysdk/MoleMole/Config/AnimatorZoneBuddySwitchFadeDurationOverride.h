...
#define MOLEMOLE_CONFIG_ANIMATORZONEBUDDYSWITCHFADEDURATIONOVERRIDE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x13FF9BD0)
#define MOLEMOLE_CONFIG_ANIMATORZONEBUDDYSWITCHFADEDURATIONOVERRIDE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x13FF9E90)
#define MOLEMOLE_CONFIG_ANIMATORZONEBUDDYSWITCHFADEDURATIONOVERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x13FFA0C0)
#define MOLEMOLE_CONFIG_ANIMATORZONEBUDDYSWITCHFADEDURATIONOVERRIDE___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x13FFA0E0)
#define MOLEMOLE_CONFIG_ANIMATORZONEBUDDYSWITCHFADEDURATIONOVERRIDE___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x13FFA190)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneBuddySwitchFadeDurationOverride_TypeDefinitionIndex = 46344;
