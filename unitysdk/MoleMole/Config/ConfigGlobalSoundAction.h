...
#define MOLEMOLE_CONFIG_CONFIGGLOBALSOUNDACTION_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A4B0F00)
#define MOLEMOLE_CONFIG_CONFIGGLOBALSOUNDACTION_RUMTIMERELOAD_OFFSET UNITYSDK_OFFSET(0x1A4B0CB0)
#define MOLEMOLE_CONFIG_CONFIGGLOBALSOUNDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4B10C0)
#define MOLEMOLE_CONFIG_CONFIGGLOBALSOUNDACTION___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A4B1120)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigGlobalSoundAction_TypeDefinitionIndex = 52890;
