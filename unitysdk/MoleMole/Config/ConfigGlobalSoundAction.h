...
#define MOLEMOLE_CONFIG_CONFIGGLOBALSOUNDACTION_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x18AD3D70)
#define MOLEMOLE_CONFIG_CONFIGGLOBALSOUNDACTION_RUMTIMERELOAD_OFFSET UNITYSDK_OFFSET(0x18AD3B20)
#define MOLEMOLE_CONFIG_CONFIGGLOBALSOUNDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18AD3F30)
#define MOLEMOLE_CONFIG_CONFIGGLOBALSOUNDACTION___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x18AD3F90)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigGlobalSoundAction_TypeDefinitionIndex = 41732;
