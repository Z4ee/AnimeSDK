...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTPERCEPTIONSENSECONFIG_CLONE_OFFSET UNITYSDK_OFFSET(0x10D00460)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTPERCEPTIONSENSECONFIG_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x10D00410)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTPERCEPTIONSENSECONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x10D00990)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTPERCEPTIONSENSECONFIG_FROMFLX_OFFSET UNITYSDK_OFFSET(0x10D005D0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTPERCEPTIONSENSECONFIG_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x10D00560)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTPERCEPTIONSENSECONFIG_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x10D009F0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTPERCEPTIONSENSECONFIG_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x10D00650)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTPERCEPTIONSENSECONFIG_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x10D00BA0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTPERCEPTIONSENSECONFIG_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x10D00830)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTPERCEPTIONSENSECONFIG_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0x10D002C0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTPERCEPTIONSENSECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x10D00D50)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicValueListPerceptionSenseConfig_TypeDefinitionIndex = 84247;
