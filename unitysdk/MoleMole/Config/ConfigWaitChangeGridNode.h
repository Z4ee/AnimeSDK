...
#define MOLEMOLE_CONFIG_CONFIGWAITCHANGEGRIDNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x17D2B7B0)
#define MOLEMOLE_CONFIG_CONFIGWAITCHANGEGRIDNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x17D2B870)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigWaitChangeGridNode_TypeDefinitionIndex = 66162;
