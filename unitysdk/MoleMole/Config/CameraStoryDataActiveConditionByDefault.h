...
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYDEFAULT_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1A05F3A0)
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYDEFAULT_PASS_OFFSET UNITYSDK_OFFSET(0x1A05F340)
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYDEFAULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A05F3B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int CameraStoryDataActiveConditionByDefault_TypeDefinitionIndex = 55145;
