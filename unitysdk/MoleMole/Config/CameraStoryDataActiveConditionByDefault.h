...
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYDEFAULT_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x177D33B0)
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYDEFAULT_PASS_OFFSET UNITYSDK_OFFSET(0x177D3350)
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYDEFAULT__CTOR_OFFSET UNITYSDK_OFFSET(0x177D33C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int CameraStoryDataActiveConditionByDefault_TypeDefinitionIndex = 54505;
