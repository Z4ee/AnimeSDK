...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_MOVE_GETSUPPORTEDDURATIONTYPE_OFFSET UNITYSDK_OFFSET(0x14864A70)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_MOVE_GET_TOTALDURATION_OFFSET UNITYSDK_OFFSET(0x14864A60)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_MOVE_RUN_OFFSET UNITYSDK_OFFSET(0x148648E0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_MOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x14864B10)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_MOVE___BASE_GETSUPPORTEDDURATIONTYPE_OFFSET UNITYSDK_OFFSET(0x14864B40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_Move_TypeDefinitionIndex = 59256;
