...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_MOVE_GETSUPPORTEDDURATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1929D0B0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_MOVE_GET_TOTALDURATION_OFFSET UNITYSDK_OFFSET(0x1929D0A0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_MOVE_RUN_OFFSET UNITYSDK_OFFSET(0x1929CF10)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_MOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1929D150)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_MOVE___BASE_GETSUPPORTEDDURATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1929D180)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_Move_TypeDefinitionIndex = 64380;
