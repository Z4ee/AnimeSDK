...
#define MOLEMOLE_CONFIG_CONFIGINDICATEDLIGHTS__CTOR_OFFSET UNITYSDK_OFFSET(0x172A5DD0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigIndicatedLights_TypeDefinitionIndex = 50030;
