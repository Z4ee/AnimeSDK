...
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_APPLYGLOBALCONFIG_OFFSET UNITYSDK_OFFSET(0x162BE760)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_APPLYLEVELCONFIG_OFFSET UNITYSDK_OFFSET(0x162BE9C0)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_CREATEGAMEDATA_OFFSET UNITYSDK_OFFSET(0x162BE4D0)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_ONENABLE_OFFSET UNITYSDK_OFFSET(0x162BDFF0)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_UPDATEPARENTREFERENCES_OFFSET UNITYSDK_OFFSET(0x162BE160)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x162BEBB0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUISimpleParkourGame_TypeDefinitionIndex = 72938;
