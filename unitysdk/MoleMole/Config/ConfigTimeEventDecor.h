...
#define MOLEMOLE_CONFIG_CONFIGTIMEEVENTDECOR_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17456FA0)
#define MOLEMOLE_CONFIG_CONFIGTIMEEVENTDECOR_FROMFLX_OFFSET UNITYSDK_OFFSET(0x17456D30)
#define MOLEMOLE_CONFIG_CONFIGTIMEEVENTDECOR_METHOD_2_7821D1D4DDDF7E01_OFFSET UNITYSDK_OFFSET(0x17456DB0)
#define MOLEMOLE_CONFIG_CONFIGTIMEEVENTDECOR_METHOD_2_81438D3AF9EEE8D8_OFFSET UNITYSDK_OFFSET(0x17456BC0)
#define MOLEMOLE_CONFIG_CONFIGTIMEEVENTDECOR_METHOD_2_9DF21D3DB8266CAD_OFFSET UNITYSDK_OFFSET(0x17457280)
#define MOLEMOLE_CONFIG_CONFIGTIMEEVENTDECOR_METHOD_2_A042C46DE73C3043_OFFSET UNITYSDK_OFFSET(0x17456BB0)
#define MOLEMOLE_CONFIG_CONFIGTIMEEVENTDECOR_METHOD_2_C444D4C8B9D548AF_OFFSET UNITYSDK_OFFSET(0x17456CC0)
#define MOLEMOLE_CONFIG_CONFIGTIMEEVENTDECOR_METHOD_2_D39AAF7777560A81_OFFSET UNITYSDK_OFFSET(0x17457000)
#define MOLEMOLE_CONFIG_CONFIGTIMEEVENTDECOR_METHOD_2_F40873258656DCF1_OFFSET UNITYSDK_OFFSET(0x17457430)
#define MOLEMOLE_CONFIG_CONFIGTIMEEVENTDECOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17457270)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTimeEventDecor_TypeDefinitionIndex = 62947;
