...
#define MOLEMOLE_CONFIG_CONFIGTRAININGROOM__CTOR_OFFSET UNITYSDK_OFFSET(0x16A9E530)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTrainingRoom_TypeDefinitionIndex = 76670;
