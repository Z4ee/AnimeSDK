...
#define MOLEMOLE_CONFIG_CONFIGTRAININGROOM__CTOR_OFFSET UNITYSDK_OFFSET(0x14381F10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTrainingRoom_TypeDefinitionIndex = 55369;
