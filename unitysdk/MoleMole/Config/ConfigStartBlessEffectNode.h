...
#define MOLEMOLE_CONFIG_CONFIGSTARTBLESSEFFECTNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x12721490)
#define MOLEMOLE_CONFIG_CONFIGSTARTBLESSEFFECTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x12721550)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigStartBlessEffectNode_TypeDefinitionIndex = 44705;
