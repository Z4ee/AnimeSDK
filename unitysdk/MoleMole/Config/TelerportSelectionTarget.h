...
#define MOLEMOLE_CONFIG_TELERPORTSELECTIONTARGET_METHOD_2_3CD672CDD3381762_OFFSET UNITYSDK_OFFSET(0x157D3A20)
#define MOLEMOLE_CONFIG_TELERPORTSELECTIONTARGET_METHOD_2_6783D6CE95762415_OFFSET UNITYSDK_OFFSET(0x157D3E30)
#define MOLEMOLE_CONFIG_TELERPORTSELECTIONTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x157D3E20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int TelerportSelectionTarget_TypeDefinitionIndex = 84568;
