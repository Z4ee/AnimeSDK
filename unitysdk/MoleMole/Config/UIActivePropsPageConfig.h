...
#define MOLEMOLE_CONFIG_UIACTIVEPROPSPAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF7A00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int UIActivePropsPageConfig_TypeDefinitionIndex = 51491;
