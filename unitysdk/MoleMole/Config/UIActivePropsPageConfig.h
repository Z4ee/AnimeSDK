...
#define MOLEMOLE_CONFIG_UIACTIVEPROPSPAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0770B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int UIActivePropsPageConfig_TypeDefinitionIndex = 57831;
