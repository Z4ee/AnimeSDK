...
#define MOLEMOLE_CONFIG_READONLYDYNAMICFLOAT_GET_DYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x16AA8410)
#define MOLEMOLE_CONFIG_READONLYDYNAMICFLOAT_GET_FIXEDVALUE_OFFSET UNITYSDK_OFFSET(0x16AA8430)
#define MOLEMOLE_CONFIG_READONLYDYNAMICFLOAT_GET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x16AA83F0)
#define MOLEMOLE_CONFIG_READONLYDYNAMICFLOAT_SET_DYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x16AA8420)
#define MOLEMOLE_CONFIG_READONLYDYNAMICFLOAT_SET_FIXEDVALUE_OFFSET UNITYSDK_OFFSET(0x16AA8440)
#define MOLEMOLE_CONFIG_READONLYDYNAMICFLOAT_SET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x16AA8400)
#define MOLEMOLE_CONFIG_READONLYDYNAMICFLOAT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x16AA8370)
#define MOLEMOLE_CONFIG_READONLYDYNAMICFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x16AA8300)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ReadonlyDynamicFloat_TypeDefinitionIndex = 74034;
