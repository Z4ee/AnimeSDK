...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_CAMERASHAKE_GETSUPPORTEDDURATIONTYPE_OFFSET UNITYSDK_OFFSET(0x17049310)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_CAMERASHAKE_GET_TOTALDURATION_OFFSET UNITYSDK_OFFSET(0x17049300)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_CAMERASHAKE_RUN_OFFSET UNITYSDK_OFFSET(0x17049200)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_CAMERASHAKE__CTOR_OFFSET UNITYSDK_OFFSET(0x17049360)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_CAMERASHAKE___BASE_GETSUPPORTEDDURATIONTYPE_OFFSET UNITYSDK_OFFSET(0x17049370)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_CameraShake_TypeDefinitionIndex = 64423;
