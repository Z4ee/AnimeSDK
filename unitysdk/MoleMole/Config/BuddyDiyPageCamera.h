...
#define MOLEMOLE_CONFIG_BUDDYDIYPAGECAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xF131FA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int BuddyDiyPageCamera_TypeDefinitionIndex = 47706;
