...
#define MOLEMOLE_CONFIG_CONFIGDECORBASE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A3419D0)
#define MOLEMOLE_CONFIG_CONFIGDECORBASE_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1A341790)
#define MOLEMOLE_CONFIG_CONFIGDECORBASE_METHOD_1_0BD393E566CD3D4A_OFFSET UNITYSDK_OFFSET(0x1A341810)
#define MOLEMOLE_CONFIG_CONFIGDECORBASE_METHOD_1_17C19F1FFDE0D888_OFFSET UNITYSDK_OFFSET(0x1A341DD0)
#define MOLEMOLE_CONFIG_CONFIGDECORBASE_METHOD_1_2C463ED601F44ECA_OFFSET UNITYSDK_OFFSET(0x1A341C20)
#define MOLEMOLE_CONFIG_CONFIGDECORBASE_METHOD_1_81438D3AF9EEE8D8_OFFSET UNITYSDK_OFFSET(0x1A341620)
#define MOLEMOLE_CONFIG_CONFIGDECORBASE_METHOD_1_939448457A24CB1A_OFFSET UNITYSDK_OFFSET(0x1A341C80)
#define MOLEMOLE_CONFIG_CONFIGDECORBASE_METHOD_1_A042C46DE73C3043_OFFSET UNITYSDK_OFFSET(0x1A341610)
#define MOLEMOLE_CONFIG_CONFIGDECORBASE_METHOD_1_A42B0141BE94FABE_OFFSET UNITYSDK_OFFSET(0x1A341A30)
#define MOLEMOLE_CONFIG_CONFIGDECORBASE_METHOD_1_C444D4C8B9D548AF_OFFSET UNITYSDK_OFFSET(0x1A341720)
#define MOLEMOLE_CONFIG_CONFIGDECORBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A341C70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDecorBase_TypeDefinitionIndex = 84650;
