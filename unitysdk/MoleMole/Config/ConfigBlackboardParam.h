...
#define MOLEMOLE_CONFIG_CONFIGBLACKBOARDPARAM_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x633870)
#define MOLEMOLE_CONFIG_CONFIGBLACKBOARDPARAM_FROMFLX_OFFSET UNITYSDK_OFFSET(0x6337E0)
#define MOLEMOLE_CONFIG_CONFIGBLACKBOARDPARAM_METHOD_2_1F8314262457963A_OFFSET UNITYSDK_OFFSET(0x633910)
#define MOLEMOLE_CONFIG_CONFIGBLACKBOARDPARAM_METHOD_2_280F9DEC4448E988_OFFSET UNITYSDK_OFFSET(0x6337D0)
#define MOLEMOLE_CONFIG_CONFIGBLACKBOARDPARAM_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x6338E0)
#define MOLEMOLE_CONFIG_CONFIGBLACKBOARDPARAM_METHOD_2_DFBF488726E6829A_OFFSET UNITYSDK_OFFSET(0x6338D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigBlackboardParam_TypeDefinitionIndex = 67145;
	...
	struct alignas(8) ConfigBlackboardParam
	{
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_131*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGBLACKBOARDPARAM_METHOD_2_280F9DEC4448E988_OFFSET))(this, a1, a2);
		}
