...
#define MOLEMOLE_CONFIG_CONFIGPLAYTIMELINECOMMONNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x1271DCC0)
#define MOLEMOLE_CONFIG_CONFIGPLAYTIMELINECOMMONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1271DD30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPlayTimelineCommonNode_TypeDefinitionIndex = 79175;
	...
	public:
		...
		::MoleMole::Config::StringUISpecialNum* TimelineKey; // 0x28
