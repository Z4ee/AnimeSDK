...
#define MOLEMOLE_CONFIG_REACHIKCONFIG_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x8C5180)
#define MOLEMOLE_CONFIG_REACHIKCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x8C5220)
#define MOLEMOLE_CONFIG_REACHIKCONFIG_FROMFLX_OFFSET UNITYSDK_OFFSET(0x8C5190)
#define MOLEMOLE_CONFIG_REACHIKCONFIG_METHOD_2_A7FD4B676C8A33C1_OFFSET UNITYSDK_OFFSET(0x8C52B0)
#define MOLEMOLE_CONFIG_REACHIKCONFIG_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x8C5280)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ReachIKConfig_TypeDefinitionIndex = 54414;
	...
	struct alignas(8) ReachIKConfig
	{
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_198*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_REACHIKCONFIG_EXPOSEMEMBER_OFFSET))(this, a1, a2);
		}
