...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWINTERACTCONDITIONRELATIVEPOSITION_CREATECONDITION_OFFSET UNITYSDK_OFFSET(0x17536990)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWINTERACTCONDITIONRELATIVEPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x17536A70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowInteractConditionRelativePosition_TypeDefinitionIndex = 58888;
