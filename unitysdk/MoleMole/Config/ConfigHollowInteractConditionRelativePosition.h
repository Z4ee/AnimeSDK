...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWINTERACTCONDITIONRELATIVEPOSITION_CREATECONDITION_OFFSET UNITYSDK_OFFSET(0x1BD5E2B0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWINTERACTCONDITIONRELATIVEPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD5E390)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowInteractConditionRelativePosition_TypeDefinitionIndex = 78807;
