...
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_CLONE_OFFSET UNITYSDK_OFFSET(0x1AA5F100)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x1AA5F0F0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AA603E0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1AA5F270)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x1AA5F200)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AA60440)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x1AA5F2F0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AA60870)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x1AA60280)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_PROCESS_OFFSET UNITYSDK_OFFSET(0x1AA5E860)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_SETUP_OFFSET UNITYSDK_OFFSET(0x1AA5E7D0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA5E770)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE___BASE_SETUP_OFFSET UNITYSDK_OFFSET(0x1AA60A20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigRotationSimple_TypeDefinitionIndex = 58567;

	class ConfigRotationSimple : public ::MoleMole::Config::ConfigRotation
	{
	public:
		::UnityEngine::AnimationCurve* AngleAccelerationCurveY; // 0x28
		::UnityEngine::AnimationCurve* InitAngleVelocityCurveY; // 0x30
		::UnityEngine::AnimationCurve* InitAngleVelocityCurveZ; // 0x38
		::UnityEngine::AnimationCurve* AngleAccelerationCurveX; // 0x40
		::UnityEngine::AnimationCurve* AngleAccelerationCurveZ; // 0x48
		::UnityEngine::AnimationCurve* InitAngleVelocityCurveX; // 0x50
		::System::Single ScaleRatio; // 0x58
		::System::Boolean UseCurve; // 0x5C
		::UnityEngine::Vector3 InitAngleVelocity; // 0x60
		::Enum_3_AF4D3A3041939147 CoordinateType; // 0x6C
		::UnityEngine::Vector3 AngleAcceleration; // 0x70
