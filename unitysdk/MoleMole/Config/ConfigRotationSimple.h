...
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_CLONE_OFFSET UNITYSDK_OFFSET(0x1C460920)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x1C460910)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C461B60)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1C460A30)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x1C460A20)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C461BC0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x1C460AB0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C461FF0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x1C461A00)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_PROCESS_OFFSET UNITYSDK_OFFSET(0x1C460080)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_SETUP_OFFSET UNITYSDK_OFFSET(0x1C45FFF0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C45FF90)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE___BASE_SETUP_OFFSET UNITYSDK_OFFSET(0x1C4621A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigRotationSimple_TypeDefinitionIndex = 53144;

	class ConfigRotationSimple : public ::MoleMole::Config::ConfigRotation
	{
	public:
		::UnityEngine::AnimationCurve* AngleAccelerationCurveZ; // 0x28
		::UnityEngine::AnimationCurve* AngleAccelerationCurveY; // 0x30
		::UnityEngine::AnimationCurve* InitAngleVelocityCurveX; // 0x38
		::UnityEngine::AnimationCurve* InitAngleVelocityCurveY; // 0x40
		::UnityEngine::AnimationCurve* AngleAccelerationCurveX; // 0x48
		::UnityEngine::AnimationCurve* InitAngleVelocityCurveZ; // 0x50
		::Enum_3_AF4D3A3041939147 CoordinateType; // 0x58
		::System::Boolean UseCurve; // 0x5C
		::UnityEngine::Vector3 AngleAcceleration; // 0x60
		::UnityEngine::Vector3 InitAngleVelocity; // 0x6C
		::System::Single ScaleRatio; // 0x78
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_248DACE3BB3053DD*, ::MoleMole::Battle::Entity*, ::Class_3_248DACE3BB3053DD_Enum_3_208B758CC2D6E4CF&, ::MoleMole::Battle::Entity*, ::Class_2_14986121AA61AD99*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_SETUP_OFFSET))(this, movementComponent, other, rotateState, caster, instancedAbility);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_C93CC3D2C2AC4067*, ::Class_3_248DACE3BB3053DD*, ::System::Single))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_PROCESS_OFFSET))(this, modelComponent, movementComponent, deltaTime);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_248DACE3BB3053DD*, ::MoleMole::Battle::Entity*, ::Class_3_248DACE3BB3053DD_Enum_3_208B758CC2D6E4CF&, ::MoleMole::Battle::Entity*, ::Class_2_14986121AA61AD99*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE___BASE_SETUP_OFFSET))(this, P0, P1, P2, P3, P4);
		}
	};
}
