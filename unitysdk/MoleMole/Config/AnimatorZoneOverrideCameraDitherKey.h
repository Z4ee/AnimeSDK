...
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERRIDECAMERADITHERKEY_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x134F09A0)
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERRIDECAMERADITHERKEY_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x134F04A0)
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERRIDECAMERADITHERKEY_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x134F0710)
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERRIDECAMERADITHERKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x134F0A30)
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERRIDECAMERADITHERKEY___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x134F0A40)
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERRIDECAMERADITHERKEY___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x134F0B10)
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERRIDECAMERADITHERKEY___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x134F0BC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneOverrideCameraDitherKey_TypeDefinitionIndex = 47471;
