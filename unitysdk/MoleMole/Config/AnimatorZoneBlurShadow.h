...
#define MOLEMOLE_CONFIG_ANIMATORZONEBLURSHADOW_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x10CE9090)
#define MOLEMOLE_CONFIG_ANIMATORZONEBLURSHADOW_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x10CE92F0)
#define MOLEMOLE_CONFIG_ANIMATORZONEBLURSHADOW__CTOR_OFFSET UNITYSDK_OFFSET(0x10CE9550)
#define MOLEMOLE_CONFIG_ANIMATORZONEBLURSHADOW___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x10CE9570)
#define MOLEMOLE_CONFIG_ANIMATORZONEBLURSHADOW___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x10CE9620)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneBlurShadow_TypeDefinitionIndex = 50131;
