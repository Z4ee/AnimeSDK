...
#define MOLEMOLE_CONFIG_CONFIGENTITYCHANNELMIXEREFFECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x12EFF2A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityChannelMixerEffects_TypeDefinitionIndex = 67757;
