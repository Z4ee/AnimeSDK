...
#define MOLEMOLE_CONFIG_CONFIGTIMEDRIVENATTACKCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x162BDFB0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTimeDrivenAttackCollider_TypeDefinitionIndex = 63935;
