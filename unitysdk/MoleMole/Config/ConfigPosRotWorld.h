...
#define MOLEMOLE_CONFIG_CONFIGPOSROTWORLD_CLONE_OFFSET UNITYSDK_OFFSET(0x170515B0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTWORLD_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x17051560)
#define MOLEMOLE_CONFIG_CONFIGPOSROTWORLD_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x170511C0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTWORLD_FROMFLX_OFFSET UNITYSDK_OFFSET(0x17051720)
#define MOLEMOLE_CONFIG_CONFIGPOSROTWORLD_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x170516B0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTWORLD_GETTARGETENTITYPOSROT_OFFSET UNITYSDK_OFFSET(0x17050EB0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTWORLD_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x17051220)
#define MOLEMOLE_CONFIG_CONFIGPOSROTWORLD_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x170517A0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTWORLD_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x170513B0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTWORLD_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x170519A0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTWORLD__CTOR_OFFSET UNITYSDK_OFFSET(0x17051B00)
#define MOLEMOLE_CONFIG_CONFIGPOSROTWORLD___BASE_GETTARGETENTITYPOSROT_OFFSET UNITYSDK_OFFSET(0x17051B10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPosRotWorld_TypeDefinitionIndex = 52030;
