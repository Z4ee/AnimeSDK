...
#define MOLEMOLE_CONFIG_INDEXCHUNKREF_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1231A530)
#define MOLEMOLE_CONFIG_INDEXCHUNKREF_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1231A170)
#define MOLEMOLE_CONFIG_INDEXCHUNKREF_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x1231A740)
#define MOLEMOLE_CONFIG_INDEXCHUNKREF_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0x1231A1F0)
#define MOLEMOLE_CONFIG_INDEXCHUNKREF_METHOD_1_9144040ECD391705_OFFSET UNITYSDK_OFFSET(0x1231A590)
#define MOLEMOLE_CONFIG_INDEXCHUNKREF_TOSTRING_OFFSET UNITYSDK_OFFSET(0x12319E30)
#define MOLEMOLE_CONFIG_INDEXCHUNKREF__CTOR_OFFSET UNITYSDK_OFFSET(0x1231A730)

namespace MoleMole::Config
{
	inline static constexpr unsigned int IndexChunkRef_TypeDefinitionIndex = 42394;
