...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEFLOAT_CLONE_OFFSET UNITYSDK_OFFSET(0xE9682A0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEFLOAT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0xE968290)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEFLOAT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xE9687B0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEFLOAT_FROMFLX_OFFSET UNITYSDK_OFFSET(0xE968410)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEFLOAT_GETCONFIGDYNAMICVALUETYPE_OFFSET UNITYSDK_OFFSET(0xE968110)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEFLOAT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0xE9683A0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEFLOAT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0xE968810)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEFLOAT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0xE968490)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEFLOAT_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0xE968160)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEFLOAT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0xE968970)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEFLOAT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0xE968650)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEFLOAT_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0xE968050)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0xE968240)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEFLOAT___BASE_GETCONFIGDYNAMICVALUETYPE_OFFSET UNITYSDK_OFFSET(0xE968B20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicValueFloat_TypeDefinitionIndex = 46265;
