...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEFLOAT_CLONE_OFFSET UNITYSDK_OFFSET(0xF139150)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEFLOAT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0xF139140)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEFLOAT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xF1395E0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEFLOAT_FROMFLX_OFFSET UNITYSDK_OFFSET(0xF139260)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEFLOAT_GETCONFIGDYNAMICVALUETYPE_OFFSET UNITYSDK_OFFSET(0xF138FC0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEFLOAT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0xF139250)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEFLOAT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0xF139640)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEFLOAT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0xF1392E0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEFLOAT_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0xF139010)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEFLOAT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0xF1397A0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEFLOAT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0xF139480)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEFLOAT_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0xF138F00)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0xF1390F0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEFLOAT___BASE_GETCONFIGDYNAMICVALUETYPE_OFFSET UNITYSDK_OFFSET(0xF139950)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicValueFloat_TypeDefinitionIndex = 51095;
