...
#define MOLEMOLE_CONFIG_CONFIGLEVELGLOBALAIBTREEDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AA52B80)
#define MOLEMOLE_CONFIG_CONFIGLEVELGLOBALAIBTREEDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1AA52410)
#define MOLEMOLE_CONFIG_CONFIGLEVELGLOBALAIBTREEDATA_METHOD_1_C7F9ED430E054F62_OFFSET UNITYSDK_OFFSET(0x1AA52BE0)
#define MOLEMOLE_CONFIG_CONFIGLEVELGLOBALAIBTREEDATA_METHOD_1_DF413489329CBAF8_OFFSET UNITYSDK_OFFSET(0x1AA52490)
#define MOLEMOLE_CONFIG_CONFIGLEVELGLOBALAIBTREEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA531C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigLevelGlobalAIBTreeData_TypeDefinitionIndex = 42067;
