...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_SCENETAG_EVALUATE_OFFSET UNITYSDK_OFFSET(0x170B50E0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_SCENETAG_GET_INSPECTORLABEL_OFFSET UNITYSDK_OFFSET(0x170B50A0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_SCENETAG_METHOD_1_9F141027EF20D345_OFFSET UNITYSDK_OFFSET(0x170B5360)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_SCENETAG__CTOR_OFFSET UNITYSDK_OFFSET(0x170B5410)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundActionTriggerCondition_SceneTag_TypeDefinitionIndex = 44056;
