...
#define MOLEMOLE_CONFIG_CONFIGTURNBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B919860)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTurnback_TypeDefinitionIndex = 76567;

	class ConfigTurnback : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::System::String*>* animatorStateNameList; // 0x10
		::System::Int32 triggerResetCounter; // 0x18
		::System::Int32 characterCmpAngle; // 0x1C
		::System::Int32 maxCacheFrameCnt; // 0x20
		::System::Boolean triggerResetLogSwitch; // 0x24
		::System::Int32 inputCmpAngle; // 0x28
