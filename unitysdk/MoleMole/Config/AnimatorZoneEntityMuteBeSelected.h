...
#define MOLEMOLE_CONFIG_ANIMATORZONEENTITYMUTEBESELECTED_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A058D70)
#define MOLEMOLE_CONFIG_ANIMATORZONEENTITYMUTEBESELECTED_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x1A058A10)
#define MOLEMOLE_CONFIG_ANIMATORZONEENTITYMUTEBESELECTED_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x1A058BB0)
#define MOLEMOLE_CONFIG_ANIMATORZONEENTITYMUTEBESELECTED__CTOR_OFFSET UNITYSDK_OFFSET(0x1A058E00)
#define MOLEMOLE_CONFIG_ANIMATORZONEENTITYMUTEBESELECTED___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A058E40)
#define MOLEMOLE_CONFIG_ANIMATORZONEENTITYMUTEBESELECTED___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x1A058F10)
#define MOLEMOLE_CONFIG_ANIMATORZONEENTITYMUTEBESELECTED___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x1A058FC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneEntityMuteBeSelected_TypeDefinitionIndex = 66033;
