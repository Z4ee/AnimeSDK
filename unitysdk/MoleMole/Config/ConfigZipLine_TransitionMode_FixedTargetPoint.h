...
#define MOLEMOLE_CONFIG_CONFIGZIPLINE_TRANSITIONMODE_FIXEDTARGETPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A35D550)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigZipLine_TransitionMode_FixedTargetPoint_TypeDefinitionIndex = 51236;
