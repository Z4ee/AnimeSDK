...
#define MOLEMOLE_CONFIG_STAGEENTRY_AFTERSCENELOADED2_OFFSET UNITYSDK_OFFSET(0x1754A0E0)
#define MOLEMOLE_CONFIG_STAGEENTRY_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x17549710)
#define MOLEMOLE_CONFIG_STAGEENTRY_CALCSTREAMINGSCENENAME_OFFSET UNITYSDK_OFFSET(0x1754AAA0)
#define MOLEMOLE_CONFIG_STAGEENTRY_CALCSTREAMINGV2SCENENAME_OFFSET UNITYSDK_OFFSET(0x1754ADB0)
#define MOLEMOLE_CONFIG_STAGEENTRY_GETREALSCENENAMEFORLOADING_OFFSET UNITYSDK_OFFSET(0x1754A090)
#define MOLEMOLE_CONFIG_STAGEENTRY_GETSTAGELOCATIONNAME_OFFSET UNITYSDK_OFFSET(0x1754A590)
#define MOLEMOLE_CONFIG_STAGEENTRY_GETSTREAMINGSCENENAME_OFFSET UNITYSDK_OFFSET(0x1754AC50)
#define MOLEMOLE_CONFIG_STAGEENTRY_GET_CUSTOMDATA_OFFSET UNITYSDK_OFFSET(0x17549690)
#define MOLEMOLE_CONFIG_STAGEENTRY_GET_ENVPREFABPATH_OFFSET UNITYSDK_OFFSET(0x175496E0)
#define MOLEMOLE_CONFIG_STAGEENTRY_GET_SCENEASYNCOPTION_OFFSET UNITYSDK_OFFSET(0x175496F0)
#define MOLEMOLE_CONFIG_STAGEENTRY_GET_SKIPLOADSCENE_OFFSET UNITYSDK_OFFSET(0x17549520)
#define MOLEMOLE_CONFIG_STAGEENTRY_GET_STAGEAVATARCAMERAKEY_OFFSET UNITYSDK_OFFSET(0x175496C0)
#define MOLEMOLE_CONFIG_STAGEENTRY_GET_STAGENAME_OFFSET UNITYSDK_OFFSET(0x175496A0)
#define MOLEMOLE_CONFIG_STAGEENTRY_GET_STAGESCENEPATH_OFFSET UNITYSDK_OFFSET(0x175496B0)
#define MOLEMOLE_CONFIG_STAGEENTRY_GET_STAGESCRIPTPATH_OFFSET UNITYSDK_OFFSET(0x175496D0)
#define MOLEMOLE_CONFIG_STAGEENTRY_LOADPERPSTAGE_OFFSET UNITYSDK_OFFSET(0x17549B50)
#define MOLEMOLE_CONFIG_STAGEENTRY_LOADSTAGEENV_OFFSET UNITYSDK_OFFSET(0x1754A5E0)
#define MOLEMOLE_CONFIG_STAGEENTRY_MODIFYMEMORYSETTINGSAFTERSCENELOAD_OFFSET UNITYSDK_OFFSET(0x1754AA50)
#define MOLEMOLE_CONFIG_STAGEENTRY_SETSKIPLOADSCENE_OFFSET UNITYSDK_OFFSET(0x17549620)
#define MOLEMOLE_CONFIG_STAGEENTRY_UNLOADSTAGE_1_OFFSET UNITYSDK_OFFSET(0x17549920)
#define MOLEMOLE_CONFIG_STAGEENTRY_UNLOADSTAGE_OFFSET UNITYSDK_OFFSET(0x17549760)
#define MOLEMOLE_CONFIG_STAGEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1754AEB0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int StageEntry_TypeDefinitionIndex = 39945;

	class StageEntry : public ::System::Object
	{
	public:
		::Il2CppArray<::System::String*>* stageScriptPath; // 0x10
		...
		::System::String* stageAvatarCamerakey; // 0x28
		...
		{
			return ((::MoleMole::Config::StageEntry*(*)(::Class_2_208CC9941471731A_454*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_STAGEENTRY_ALLOCATE_OFFSET))(configTemplateExt);
		}
