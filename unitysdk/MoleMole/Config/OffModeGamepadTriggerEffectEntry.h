...
#define MOLEMOLE_CONFIG_OFFMODEGAMEPADTRIGGEREFFECTENTRY_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x17E380B0)
#define MOLEMOLE_CONFIG_OFFMODEGAMEPADTRIGGEREFFECTENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x17E38140)
#define MOLEMOLE_CONFIG_OFFMODEGAMEPADTRIGGEREFFECTENTRY___BASE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x17E38150)

namespace MoleMole::Config
{
	inline static constexpr unsigned int OffModeGamepadTriggerEffectEntry_TypeDefinitionIndex = 77290;
