...
#define MOLEMOLE_CONFIG_CONFIGDFSCRIPTTRAIT_CLONE_OFFSET UNITYSDK_OFFSET(0x1146CAA0)
#define MOLEMOLE_CONFIG_CONFIGDFSCRIPTTRAIT_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x1146CBA0)
#define MOLEMOLE_CONFIG_CONFIGDFSCRIPTTRAIT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x1146CA30)
#define MOLEMOLE_CONFIG_CONFIGDFSCRIPTTRAIT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1146D4F0)
#define MOLEMOLE_CONFIG_CONFIGDFSCRIPTTRAIT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1146CE20)
#define MOLEMOLE_CONFIG_CONFIGDFSCRIPTTRAIT_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1146DA10)
#define MOLEMOLE_CONFIG_CONFIGDFSCRIPTTRAIT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x1146CB90)
#define MOLEMOLE_CONFIG_CONFIGDFSCRIPTTRAIT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1146D550)
#define MOLEMOLE_CONFIG_CONFIGDFSCRIPTTRAIT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x1146CEA0)
#define MOLEMOLE_CONFIG_CONFIGDFSCRIPTTRAIT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1146D880)
#define MOLEMOLE_CONFIG_CONFIGDFSCRIPTTRAIT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x1146D3B0)
#define MOLEMOLE_CONFIG_CONFIGDFSCRIPTTRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1146DBE0)
#define MOLEMOLE_CONFIG_CONFIGDFSCRIPTTRAIT___BASE_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x1146DBF0)
#define MOLEMOLE_CONFIG_CONFIGDFSCRIPTTRAIT___BASE_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1146DC00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDFScriptTrait_TypeDefinitionIndex = 46127;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_198*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGDFSCRIPTTRAIT_EXPOSEMEMBER_OFFSET))(this, processor, prefix);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_BE29B49AC03370B6*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGDFSCRIPTTRAIT_GENERATECOMPONENT_OFFSET))(this, buildContext);
		}

		::System::Void __base_ExposeMember(::Class_0_16E4307DCC419505_198* P0, ::System::String* P1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_198*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGDFSCRIPTTRAIT___BASE_EXPOSEMEMBER_OFFSET))(this, P0, P1);
		}

		::System::Boolean __base_GenerateComponent(::Class_1_BE29B49AC03370B6* P0)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_BE29B49AC03370B6*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGDFSCRIPTTRAIT___BASE_GENERATECOMPONENT_OFFSET))(this, P0);
		}
	};
}
