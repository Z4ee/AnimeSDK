...
#define MOLEMOLE_CONFIG_ANIMATORZONEBUDDYSWITCHMOVESTATE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x1A49D770)
#define MOLEMOLE_CONFIG_ANIMATORZONEBUDDYSWITCHMOVESTATE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x1A49D8F0)
#define MOLEMOLE_CONFIG_ANIMATORZONEBUDDYSWITCHMOVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A49DA90)
#define MOLEMOLE_CONFIG_ANIMATORZONEBUDDYSWITCHMOVESTATE___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x1A49DAA0)
#define MOLEMOLE_CONFIG_ANIMATORZONEBUDDYSWITCHMOVESTATE___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x1A49DB50)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneBuddySwitchMoveState_TypeDefinitionIndex = 57004;

	class AnimatorZoneBuddySwitchMoveState : public ::MoleMole::Config::AnimatorZone
	{
	public:
		::MoleMole::Battle::BuddyMoveStatus exitMoveStatus; // 0x50
