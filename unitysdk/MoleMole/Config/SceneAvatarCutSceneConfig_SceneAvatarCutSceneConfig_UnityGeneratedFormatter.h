...
#define MOLEMOLE_CONFIG_SCENEAVATARCUTSCENECONFIG_SCENEAVATARCUTSCENECONFIG_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x181DE1B0)
#define MOLEMOLE_CONFIG_SCENEAVATARCUTSCENECONFIG_SCENEAVATARCUTSCENECONFIG_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x181DE1C0)
#define MOLEMOLE_CONFIG_SCENEAVATARCUTSCENECONFIG_SCENEAVATARCUTSCENECONFIG_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x181DE460)
#define MOLEMOLE_CONFIG_SCENEAVATARCUTSCENECONFIG_SCENEAVATARCUTSCENECONFIG_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x181DE650)
#define MOLEMOLE_CONFIG_SCENEAVATARCUTSCENECONFIG_SCENEAVATARCUTSCENECONFIG_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x181DE610)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SceneAvatarCutSceneConfig_SceneAvatarCutSceneConfig_UnityGeneratedFormatter_TypeDefinitionIndex = 70861;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::Config::SceneChessboardCutSceneConfig*>**)Il2CppClass::FromTypeDefinitionIndex(SceneAvatarCutSceneConfig_SceneAvatarCutSceneConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x486E0);
		}
		static ::Sirenix::Serialization::Serializer_1<::MoleMole::Config::SceneEntityCutSceneConfig*>** StaticGet_CachedSerializer0()
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::Config::SceneEntityCutSceneConfig*>**)Il2CppClass::FromTypeDefinitionIndex(SceneAvatarCutSceneConfig_SceneAvatarCutSceneConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x486E8);
		}
