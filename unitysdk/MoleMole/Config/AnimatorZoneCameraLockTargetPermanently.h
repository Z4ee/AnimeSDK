...
#define MOLEMOLE_CONFIG_ANIMATORZONECAMERALOCKTARGETPERMANENTLY_DOZONEENTER_OFFSET UNITYSDK_OFFSET(0x1145E970)
#define MOLEMOLE_CONFIG_ANIMATORZONECAMERALOCKTARGETPERMANENTLY_DOZONEEXIT_OFFSET UNITYSDK_OFFSET(0x1145EB70)
#define MOLEMOLE_CONFIG_ANIMATORZONECAMERALOCKTARGETPERMANENTLY_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x1145E8E0)
#define MOLEMOLE_CONFIG_ANIMATORZONECAMERALOCKTARGETPERMANENTLY_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x1145EAC0)
#define MOLEMOLE_CONFIG_ANIMATORZONECAMERALOCKTARGETPERMANENTLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1145ED20)
#define MOLEMOLE_CONFIG_ANIMATORZONECAMERALOCKTARGETPERMANENTLY___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x1145ED30)
#define MOLEMOLE_CONFIG_ANIMATORZONECAMERALOCKTARGETPERMANENTLY___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x1145EDE0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneCameraLockTargetPermanently_TypeDefinitionIndex = 89165;
