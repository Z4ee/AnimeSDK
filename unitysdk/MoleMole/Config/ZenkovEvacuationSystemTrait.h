...
#define MOLEMOLE_CONFIG_ZENKOVEVACUATIONSYSTEMTRAIT_CLONE_OFFSET UNITYSDK_OFFSET(0x1B929160)
#define MOLEMOLE_CONFIG_ZENKOVEVACUATIONSYSTEMTRAIT_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x1B929260)
#define MOLEMOLE_CONFIG_ZENKOVEVACUATIONSYSTEMTRAIT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x1B929110)
#define MOLEMOLE_CONFIG_ZENKOVEVACUATIONSYSTEMTRAIT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B92B540)
#define MOLEMOLE_CONFIG_ZENKOVEVACUATIONSYSTEMTRAIT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1B929F30)
#define MOLEMOLE_CONFIG_ZENKOVEVACUATIONSYSTEMTRAIT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x1B929250)
#define MOLEMOLE_CONFIG_ZENKOVEVACUATIONSYSTEMTRAIT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B92B5A0)
#define MOLEMOLE_CONFIG_ZENKOVEVACUATIONSYSTEMTRAIT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x1B929FB0)
#define MOLEMOLE_CONFIG_ZENKOVEVACUATIONSYSTEMTRAIT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B92BEC0)
#define MOLEMOLE_CONFIG_ZENKOVEVACUATIONSYSTEMTRAIT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x1B92B400)
#define MOLEMOLE_CONFIG_ZENKOVEVACUATIONSYSTEMTRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B92C050)
#define MOLEMOLE_CONFIG_ZENKOVEVACUATIONSYSTEMTRAIT___BASE_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x1B92C060)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ZenkovEvacuationSystemTrait_TypeDefinitionIndex = 80058;
	...
	public:
		...
		::System::Int32 UnevacuableCountdown; // 0x3C
		::System::Int32 ZenkovQuestID; // 0x40
		::System::Int32 ZKMiddleTipID_NearTriggerable; // 0x44
		::System::Int32 ZKMiddleTipID_Triggerable; // 0x48
		::System::Int32 ZKMiddleTipID_Evacuable; // 0x4C
		::System::Int32 ZKMiddleTipID_NearEvacuableClosing; // 0x50
		::System::Int32 ZKMiddleTipID_Unevacuable; // 0x54
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_198*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_ZENKOVEVACUATIONSYSTEMTRAIT_EXPOSEMEMBER_OFFSET))(this, processor, prefix);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_198*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_ZENKOVEVACUATIONSYSTEMTRAIT___BASE_EXPOSEMEMBER_OFFSET))(this, P0, P1);
		}
	};
}
