...
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLEWAVECONFIG_ADDDODGENODE_OFFSET UNITYSDK_OFFSET(0x192A9C10)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLEWAVECONFIG_ADDHOLDNODE_OFFSET UNITYSDK_OFFSET(0x192A9CC0)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLEWAVECONFIG_ADDTAPNODE_OFFSET UNITYSDK_OFFSET(0x192A9B60)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLEWAVECONFIG_ADDTOUCHNODE_OFFSET UNITYSDK_OFFSET(0x192A9D70)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLEWAVECONFIG_GETWAVEDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x192A9FB0)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLEWAVECONFIG_TOWAVECONFIG_OFFSET UNITYSDK_OFFSET(0x192A9E20)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLEWAVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x192AA160)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUISimpleParkourGame_SerializableWaveConfig_TypeDefinitionIndex = 72945;
