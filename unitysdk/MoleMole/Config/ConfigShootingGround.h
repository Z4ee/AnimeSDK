...
#define MOLEMOLE_CONFIG_CONFIGSHOOTINGGROUND__CTOR_OFFSET UNITYSDK_OFFSET(0x172AED10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigShootingGround_TypeDefinitionIndex = 66407;
