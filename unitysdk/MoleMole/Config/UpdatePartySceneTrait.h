...
#define MOLEMOLE_CONFIG_UPDATEPARTYSCENETRAIT_BUILDENTITYCOMPONENT_OFFSET UNITYSDK_OFFSET(0x161A1DA0)
#define MOLEMOLE_CONFIG_UPDATEPARTYSCENETRAIT_CLONE_OFFSET UNITYSDK_OFFSET(0x161A1750)
#define MOLEMOLE_CONFIG_UPDATEPARTYSCENETRAIT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x161A1740)
#define MOLEMOLE_CONFIG_UPDATEPARTYSCENETRAIT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x161A1AD0)
#define MOLEMOLE_CONFIG_UPDATEPARTYSCENETRAIT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x161A18C0)
#define MOLEMOLE_CONFIG_UPDATEPARTYSCENETRAIT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x161A1850)
#define MOLEMOLE_CONFIG_UPDATEPARTYSCENETRAIT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x161A1B60)
#define MOLEMOLE_CONFIG_UPDATEPARTYSCENETRAIT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x161A1940)
#define MOLEMOLE_CONFIG_UPDATEPARTYSCENETRAIT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x161A1BC0)
#define MOLEMOLE_CONFIG_UPDATEPARTYSCENETRAIT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x161A1970)
#define MOLEMOLE_CONFIG_UPDATEPARTYSCENETRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x161A1E20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int UpdatePartySceneTrait_TypeDefinitionIndex = 68835;
