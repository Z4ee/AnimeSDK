...
#define MOLEMOLE_CONFIG_CONFIGAUDIOBASEPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x114698B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAudioBasePath_TypeDefinitionIndex = 71534;
