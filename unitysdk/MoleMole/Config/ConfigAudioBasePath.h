...
#define MOLEMOLE_CONFIG_CONFIGAUDIOBASEPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA49120)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAudioBasePath_TypeDefinitionIndex = 68985;
