...
#define MOLEMOLE_CONFIG_CONFIGUIAVATAR_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1753F620)
#define MOLEMOLE_CONFIG_CONFIGUIAVATAR_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1753E720)
#define MOLEMOLE_CONFIG_CONFIGUIAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x175403E0)
#define MOLEMOLE_CONFIG_CONFIGUIAVATAR___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x17540690)
#define MOLEMOLE_CONFIG_CONFIGUIAVATAR___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x175406A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUIAvatar_TypeDefinitionIndex = 75621;
