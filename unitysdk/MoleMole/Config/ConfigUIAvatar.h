...
#define MOLEMOLE_CONFIG_CONFIGUIAVATAR_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x144E99D0)
#define MOLEMOLE_CONFIG_CONFIGUIAVATAR_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x144E8AF0)
#define MOLEMOLE_CONFIG_CONFIGUIAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x144EA780)
#define MOLEMOLE_CONFIG_CONFIGUIAVATAR___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x144EAA20)
#define MOLEMOLE_CONFIG_CONFIGUIAVATAR___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x144EAA30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUIAvatar_TypeDefinitionIndex = 48017;
