...
#define MOLEMOLE_CONFIG_CONFIGINTERACTENTRY_SELECTCARD_CHECKACTIONCONTENT_OFFSET UNITYSDK_OFFSET(0x17049720)
#define MOLEMOLE_CONFIG_CONFIGINTERACTENTRY_SELECTCARD_CHECKVALUECONTENT_OFFSET UNITYSDK_OFFSET(0x170497F0)
#define MOLEMOLE_CONFIG_CONFIGINTERACTENTRY_SELECTCARD_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x17049690)
#define MOLEMOLE_CONFIG_CONFIGINTERACTENTRY_SELECTCARD__CTOR_OFFSET UNITYSDK_OFFSET(0x17049890)
#define MOLEMOLE_CONFIG_CONFIGINTERACTENTRY_SELECTCARD___BASE_CHECKACTIONCONTENT_OFFSET UNITYSDK_OFFSET(0x170498F0)
#define MOLEMOLE_CONFIG_CONFIGINTERACTENTRY_SELECTCARD___BASE_CHECKVALUECONTENT_OFFSET UNITYSDK_OFFSET(0x17049980)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigInteractEntry_SelectCard_TypeDefinitionIndex = 69785;
