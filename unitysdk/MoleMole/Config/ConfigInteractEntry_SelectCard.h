...
#define MOLEMOLE_CONFIG_CONFIGINTERACTENTRY_SELECTCARD_CHECKACTIONCONTENT_OFFSET UNITYSDK_OFFSET(0x1B90A710)
#define MOLEMOLE_CONFIG_CONFIGINTERACTENTRY_SELECTCARD_CHECKVALUECONTENT_OFFSET UNITYSDK_OFFSET(0x1B90A7E0)
#define MOLEMOLE_CONFIG_CONFIGINTERACTENTRY_SELECTCARD_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1B90A680)
#define MOLEMOLE_CONFIG_CONFIGINTERACTENTRY_SELECTCARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B90A880)
#define MOLEMOLE_CONFIG_CONFIGINTERACTENTRY_SELECTCARD___BASE_CHECKACTIONCONTENT_OFFSET UNITYSDK_OFFSET(0x1B90A8E0)
#define MOLEMOLE_CONFIG_CONFIGINTERACTENTRY_SELECTCARD___BASE_CHECKVALUECONTENT_OFFSET UNITYSDK_OFFSET(0x1B90A970)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigInteractEntry_SelectCard_TypeDefinitionIndex = 89986;
	...
	public:
		...
		{
			return ((::Class_1_816D4E2238E8C24A*(*)(::PVOID, ::MoleMole::Config::InteractEntry*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGINTERACTENTRY_SELECTCARD_CREATEINSTANCE_OFFSET))(this, entry);
		}
