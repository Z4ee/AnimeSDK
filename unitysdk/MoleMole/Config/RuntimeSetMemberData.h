...
#define MOLEMOLE_CONFIG_RUNTIMESETMEMBERDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x7D6A10)
#define MOLEMOLE_CONFIG_RUNTIMESETMEMBERDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x7D6980)
#define MOLEMOLE_CONFIG_RUNTIMESETMEMBERDATA_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x7D6A80)
#define MOLEMOLE_CONFIG_RUNTIMESETMEMBERDATA_METHOD_2_E4D020DE71A7D4FC_OFFSET UNITYSDK_OFFSET(0x7D6A70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int RuntimeSetMemberData_TypeDefinitionIndex = 51634;
