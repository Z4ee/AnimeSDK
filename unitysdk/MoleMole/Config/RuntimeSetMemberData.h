...
#define MOLEMOLE_CONFIG_RUNTIMESETMEMBERDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x800130)
#define MOLEMOLE_CONFIG_RUNTIMESETMEMBERDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x8000A0)
#define MOLEMOLE_CONFIG_RUNTIMESETMEMBERDATA_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x800190)
#define MOLEMOLE_CONFIG_RUNTIMESETMEMBERDATA_METHOD_2_E4D020DE71A7D4FC_OFFSET UNITYSDK_OFFSET(0x8001C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int RuntimeSetMemberData_TypeDefinitionIndex = 75561;
