...
#define MOLEMOLE_CONFIG_SKINPREVIEWDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x14257B30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SkinPreviewData_TypeDefinitionIndex = 42634;
