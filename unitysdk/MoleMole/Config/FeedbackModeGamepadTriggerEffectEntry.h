...
#define MOLEMOLE_CONFIG_FEEDBACKMODEGAMEPADTRIGGEREFFECTENTRY_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x158BB7A0)
#define MOLEMOLE_CONFIG_FEEDBACKMODEGAMEPADTRIGGEREFFECTENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x158BB830)
#define MOLEMOLE_CONFIG_FEEDBACKMODEGAMEPADTRIGGEREFFECTENTRY___BASE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x158BB840)

namespace MoleMole::Config
{
	inline static constexpr unsigned int FeedbackModeGamepadTriggerEffectEntry_TypeDefinitionIndex = 76761;
