...
#define MOLEMOLE_CONFIG_FEEDBACKMODEGAMEPADTRIGGEREFFECTENTRY_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x1A93DE20)
#define MOLEMOLE_CONFIG_FEEDBACKMODEGAMEPADTRIGGEREFFECTENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A93DEB0)
#define MOLEMOLE_CONFIG_FEEDBACKMODEGAMEPADTRIGGEREFFECTENTRY___BASE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x1A93DEC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int FeedbackModeGamepadTriggerEffectEntry_TypeDefinitionIndex = 60966;
