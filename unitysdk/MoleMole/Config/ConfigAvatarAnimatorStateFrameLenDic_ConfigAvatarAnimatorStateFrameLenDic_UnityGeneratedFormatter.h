...
#define MOLEMOLE_CONFIG_CONFIGAVATARANIMATORSTATEFRAMELENDIC_CONFIGAVATARANIMATORSTATEFRAMELENDIC_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x1AA49180)
#define MOLEMOLE_CONFIG_CONFIGAVATARANIMATORSTATEFRAMELENDIC_CONFIGAVATARANIMATORSTATEFRAMELENDIC_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x1AA49190)
#define MOLEMOLE_CONFIG_CONFIGAVATARANIMATORSTATEFRAMELENDIC_CONFIGAVATARANIMATORSTATEFRAMELENDIC_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x1AA49370)
#define MOLEMOLE_CONFIG_CONFIGAVATARANIMATORSTATEFRAMELENDIC_CONFIGAVATARANIMATORSTATEFRAMELENDIC_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AA49510)
#define MOLEMOLE_CONFIG_CONFIGAVATARANIMATORSTATEFRAMELENDIC_CONFIGAVATARANIMATORSTATEFRAMELENDIC_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA494D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAvatarAnimatorStateFrameLenDic_ConfigAvatarAnimatorStateFrameLenDic_UnityGeneratedFormatter_TypeDefinitionIndex = 71398;
