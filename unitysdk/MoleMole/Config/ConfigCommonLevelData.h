...
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x12D34CB0)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x12D34A30)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_METHOD_1_0F9C98D2F5805479_OFFSET UNITYSDK_OFFSET(0x12D350A0)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_METHOD_1_142140140DE19A6A_OFFSET UNITYSDK_OFFSET(0x12D34EA0)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_METHOD_1_42E1B0366D8D72CF_OFFSET UNITYSDK_OFFSET(0x12D34D10)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_METHOD_1_5B0202969299569F_OFFSET UNITYSDK_OFFSET(0x12D34AB0)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_METHOD_1_5EBDB8BDCDAABB87_OFFSET UNITYSDK_OFFSET(0x12D34F30)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_METHOD_1_84DB1A1A4D6A2661_OFFSET UNITYSDK_OFFSET(0x12D351F0)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_METHOD_1_B73F62522113F21F_OFFSET UNITYSDK_OFFSET(0x12D34870)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_METHOD_1_C444D4C8B9D548AF_OFFSET UNITYSDK_OFFSET(0x12D349C0)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_METHOD_1_C9158580CC3C5ACF_OFFSET UNITYSDK_OFFSET(0x12D348C0)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x12D34F20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCommonLevelData_TypeDefinitionIndex = 47451;
