...
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B7E4A30)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1B7E47E0)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_METHOD_1_0F9C98D2F5805479_OFFSET UNITYSDK_OFFSET(0x1B7E4D80)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_METHOD_1_142140140DE19A6A_OFFSET UNITYSDK_OFFSET(0x1B7E4C20)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_METHOD_1_42E1B0366D8D72CF_OFFSET UNITYSDK_OFFSET(0x1B7E4A90)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_METHOD_1_5B0202969299569F_OFFSET UNITYSDK_OFFSET(0x1B7E4860)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_METHOD_1_5EBDB8BDCDAABB87_OFFSET UNITYSDK_OFFSET(0x1B7E4ED0)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_METHOD_1_84DB1A1A4D6A2661_OFFSET UNITYSDK_OFFSET(0x1B7E4CB0)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_METHOD_1_B73F62522113F21F_OFFSET UNITYSDK_OFFSET(0x1B7E4680)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_METHOD_1_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x1B7E47D0)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_METHOD_1_C9158580CC3C5ACF_OFFSET UNITYSDK_OFFSET(0x1B7E46D0)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7E4CA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCommonLevelData_TypeDefinitionIndex = 73718;
	...
	public:
		...
		{
			return ((::System::Int32(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_METHOD_1_C74CF020AA42ED85_OFFSET))(this);
		}
