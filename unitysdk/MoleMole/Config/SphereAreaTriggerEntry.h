...
#define MOLEMOLE_CONFIG_SPHEREAREATRIGGERENTRY_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1272B620)
#define MOLEMOLE_CONFIG_SPHEREAREATRIGGERENTRY_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1272AC00)
#define MOLEMOLE_CONFIG_SPHEREAREATRIGGERENTRY_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0x1272AC80)
#define MOLEMOLE_CONFIG_SPHEREAREATRIGGERENTRY_METHOD_1_AB1851855FC4CE08_OFFSET UNITYSDK_OFFSET(0x1272B680)
#define MOLEMOLE_CONFIG_SPHEREAREATRIGGERENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1272BA60)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SphereAreaTriggerEntry_TypeDefinitionIndex = 83926;
