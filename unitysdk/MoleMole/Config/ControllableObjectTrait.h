...
class Class_3_CE5C26A6592CE017;
namespace System { class Object; }
namespace System { class String; }
namespace System { template <typename T> class Action_1; }

#define MOLEMOLE_CONFIG_CONTROLLABLEOBJECTTRAIT_BUILDENTITYCOMPONENT_OFFSET UNITYSDK_OFFSET(0x170BA650)
#define MOLEMOLE_CONFIG_CONTROLLABLEOBJECTTRAIT_CLONE_OFFSET UNITYSDK_OFFSET(0x170B8830)
#define MOLEMOLE_CONFIG_CONTROLLABLEOBJECTTRAIT_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x170B8990)
#define MOLEMOLE_CONFIG_CONTROLLABLEOBJECTTRAIT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x170B87B0)
#define MOLEMOLE_CONFIG_CONTROLLABLEOBJECTTRAIT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x170B9DE0)
#define MOLEMOLE_CONFIG_CONTROLLABLEOBJECTTRAIT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x170B8BA0)
#define MOLEMOLE_CONFIG_CONTROLLABLEOBJECTTRAIT_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x170BA520)
#define MOLEMOLE_CONFIG_CONTROLLABLEOBJECTTRAIT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x170B8920)
#define MOLEMOLE_CONFIG_CONTROLLABLEOBJECTTRAIT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x170B9E40)
#define MOLEMOLE_CONFIG_CONTROLLABLEOBJECTTRAIT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x170B8C20)
#define MOLEMOLE_CONFIG_CONTROLLABLEOBJECTTRAIT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x170BA380)
#define MOLEMOLE_CONFIG_CONTROLLABLEOBJECTTRAIT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x170B9CA0)
#define MOLEMOLE_CONFIG_CONTROLLABLEOBJECTTRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x170BA700)
#define MOLEMOLE_CONFIG_CONTROLLABLEOBJECTTRAIT___BASE_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x170BA710)
#define MOLEMOLE_CONFIG_CONTROLLABLEOBJECTTRAIT___BASE_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x170BA720)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ControllableObjectTrait_TypeDefinitionIndex = 83546;
	...
	public:
		...
		::Class_3_CE5C26A6592CE017* voCameraHackObjectComponent; // 0x58
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_175*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONTROLLABLEOBJECTTRAIT_EXPOSEMEMBER_OFFSET))(this, processor, prefix);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_53842913455A8556*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONTROLLABLEOBJECTTRAIT_GENERATECOMPONENT_OFFSET))(this, buildContext);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_175*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONTROLLABLEOBJECTTRAIT___BASE_EXPOSEMEMBER_OFFSET))(this, P0, P1);
		}

		::System::Boolean __base_GenerateComponent(::Class_1_53842913455A8556* P0)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_53842913455A8556*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONTROLLABLEOBJECTTRAIT___BASE_GENERATECOMPONENT_OFFSET))(this, P0);
		}
	};
}
