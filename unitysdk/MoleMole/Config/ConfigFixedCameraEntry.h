...
#define MOLEMOLE_CONFIG_CONFIGFIXEDCAMERAENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x144DFA40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigFixedCameraEntry_TypeDefinitionIndex = 72860;
