...
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYEXCLUSIVITY_CONFIGMATERIALPROPERTYEXCLUSIVITY_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x144E11B0)
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYEXCLUSIVITY_CONFIGMATERIALPROPERTYEXCLUSIVITY_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x144E11C0)
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYEXCLUSIVITY_CONFIGMATERIALPROPERTYEXCLUSIVITY_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x144E13A0)
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYEXCLUSIVITY_CONFIGMATERIALPROPERTYEXCLUSIVITY_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x144E1540)
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYEXCLUSIVITY_CONFIGMATERIALPROPERTYEXCLUSIVITY_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x144E1500)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMaterialPropertyExclusivity_ConfigMaterialPropertyExclusivity_UnityGeneratedFormatter_TypeDefinitionIndex = 68388;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::HashSet_1<::System::String*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigMaterialPropertyExclusivity_ConfigMaterialPropertyExclusivity_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3C240);
		}
