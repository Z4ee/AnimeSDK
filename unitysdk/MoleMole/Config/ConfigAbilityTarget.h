...
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_0CAA490423B456C6_OFFSET UNITYSDK_OFFSET(0x1399BDC0)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_20599A32E5B0202C_OFFSET UNITYSDK_OFFSET(0x1399D950)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_2C9AAEB4E287676D_OFFSET UNITYSDK_OFFSET(0x1399E000)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x1399C640)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_445F2DD6F75361B1_OFFSET UNITYSDK_OFFSET(0x1399C4A0)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_473360D382EBE9C6_OFFSET UNITYSDK_OFFSET(0x1399D880)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_4A2C8AEE9BCA2A94_OFFSET UNITYSDK_OFFSET(0x1399D230)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_5B9D1016DF183D97_OFFSET UNITYSDK_OFFSET(0x1399DB60)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_65FECDA418990652_OFFSET UNITYSDK_OFFSET(0x1399D2E0)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_8677661FEF71549A_1_OFFSET UNITYSDK_OFFSET(0x1399DDD0)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_8677661FEF71549A_OFFSET UNITYSDK_OFFSET(0x1399D0A0)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_C48BED042BE91786_OFFSET UNITYSDK_OFFSET(0x1399CDD0)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_D83985000E1AD3F1_OFFSET UNITYSDK_OFFSET(0x1399DC10)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_F179115F8A73AE42_1_OFFSET UNITYSDK_OFFSET(0x1399DF60)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_F179115F8A73AE42_OFFSET UNITYSDK_OFFSET(0x1399DAC0)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_FCABC4212A3F7F6F_OFFSET UNITYSDK_OFFSET(0x1399D570)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_FD67B0C6EFC9560B_OFFSET UNITYSDK_OFFSET(0x1399C690)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET__CCTOR_OFFSET UNITYSDK_OFFSET(0x1399CDC0)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1399CDB0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAbilityTarget_TypeDefinitionIndex = 72635;
	...
	public:
		...
		{
			return (::MoleMole::Config::ConfigAbilityTarget_Struct_2_AB79962F241E0778*)Il2CppClass::FromTypeDefinitionIndex(ConfigAbilityTarget_TypeDefinitionIndex)->GetStaticField(0x41880);
		}
		static ::MoleMole::Config::ConfigAbilityTarget_Struct_2_9BE0823C1225EE82* StaticGet_entityFeatureTargetWrapSortComparer()
		{
			return (::MoleMole::Config::ConfigAbilityTarget_Struct_2_9BE0823C1225EE82*)Il2CppClass::FromTypeDefinitionIndex(ConfigAbilityTarget_TypeDefinitionIndex)->GetStaticField(0x418A0);
		}
		static ::MoleMole::Config::ConfigAbilityTarget_Struct_2_D9676FC67296675D* StaticGet_entitySortComparer()
		{
			return (::MoleMole::Config::ConfigAbilityTarget_Struct_2_D9676FC67296675D*)Il2CppClass::FromTypeDefinitionIndex(ConfigAbilityTarget_TypeDefinitionIndex)->GetStaticField(0x418C0);
		}
