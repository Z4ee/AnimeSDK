...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_TOGGLEPLAYMIX_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1242E4B0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_TOGGLEPLAYMIX_GETPLAYMIXDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1242E840)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_TOGGLEPLAYMIX_GET_INSPECTORLABEL_OFFSET UNITYSDK_OFFSET(0x1242E370)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_TOGGLEPLAYMIX_GET_PARAMHINT_OFFSET UNITYSDK_OFFSET(0x1242E3B0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_TOGGLEPLAYMIX_ISMATCH_OFFSET UNITYSDK_OFFSET(0x1242EA80)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_TOGGLEPLAYMIX__CTOR_OFFSET UNITYSDK_OFFSET(0x1242EB80)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_TOGGLEPLAYMIX__EXECUTEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1242E700)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_TOGGLEPLAYMIX___BASE_GET_PARAMHINT_OFFSET UNITYSDK_OFFSET(0x1242EBC0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_TOGGLEPLAYMIX___BASE_ISMATCH_OFFSET UNITYSDK_OFFSET(0x1242EBD0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_TogglePlayMix_TypeDefinitionIndex = 47563;

	class ConfigSoundAction_TogglePlayMix : public ::MoleMole::Config::ConfigSoundActionGeneral
	{
	public:
		::System::Int32 playMix; // 0x20
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_147*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGSOUNDACTION_TOGGLEPLAYMIX_EXECUTE_OFFSET))(this, context);
		}
