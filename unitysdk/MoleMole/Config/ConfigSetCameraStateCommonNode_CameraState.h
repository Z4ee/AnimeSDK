...
#define MOLEMOLE_CONFIG_CONFIGSETCAMERASTATECOMMONNODE_CAMERASTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x181D3A20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSetCameraStateCommonNode_CameraState_TypeDefinitionIndex = 72910;
