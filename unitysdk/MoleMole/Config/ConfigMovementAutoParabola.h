...
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTAUTOPARABOLA_CLONE_OFFSET UNITYSDK_OFFSET(0x1AA54310)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTAUTOPARABOLA_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x1AA54280)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTAUTOPARABOLA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AA55B20)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTAUTOPARABOLA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1AA54480)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTAUTOPARABOLA_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x1AA54410)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTAUTOPARABOLA_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AA55B80)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTAUTOPARABOLA_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x1AA54500)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTAUTOPARABOLA_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AA560A0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTAUTOPARABOLA_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x1AA559C0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTAUTOPARABOLA_PROCESSRIGIDBODY_OFFSET UNITYSDK_OFFSET(0x1AA53550)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTAUTOPARABOLA_SETUPLOGICMOVEMENT_OFFSET UNITYSDK_OFFSET(0x1AA536C0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTAUTOPARABOLA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA56250)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTAUTOPARABOLA___BASE_SETUPLOGICMOVEMENT_OFFSET UNITYSDK_OFFSET(0x1AA56260)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMovementAutoParabola_TypeDefinitionIndex = 40400;

	class ConfigMovementAutoParabola : public ::MoleMole::Config::ConfigMovement
	{
	public:
		::MoleMole::Config::ConfigPosRot* TargetPosRot; // 0x38
		::System::Single Accelerated; // 0x40
		::System::Single TargetRotLimitAngleLeft; // 0x44
		::System::Single MinAngle; // 0x48
		::System::Single MaxSpeed; // 0x4C
		::System::Single MinSpeed; // 0x50
		::System::Single ExpectTime; // 0x54
		::System::Single DefaultRotAngle; // 0x58
		::System::Int32 ExpectAngle; // 0x5C
		::System::Single MaxAngle; // 0x60
		::UnityEngine::Vector3 DefaultOffset; // 0x64
		::System::Single TargetRotLimitAngleRight; // 0x70
		::System::Single ExpectSpeed; // 0x74
