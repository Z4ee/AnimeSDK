...
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x12B9CCD0)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT_GET_ISUPDATEONEFRAME_OFFSET UNITYSDK_OFFSET(0x12B9CCC0)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x12B9DB30)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x12B9CD60)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x12B9DA60)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT__CCTOR_OFFSET UNITYSDK_OFFSET(0x12B9E9D0)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x12B9E920)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT__HANDLEHITDATA_OFFSET UNITYSDK_OFFSET(0x12B9D790)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT__PREPARE_OFFSET UNITYSDK_OFFSET(0x12B9D270)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT__PRINTRAY_OFFSET UNITYSDK_OFFSET(0x12B9D9C0)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT__TRYCREATERAYCHECK_OFFSET UNITYSDK_OFFSET(0x12B9D550)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT__TRYCREATESCRATCHEFFECTS_OFFSET UNITYSDK_OFFSET(0x12B9E270)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT__TRYCREATETRIGGEREFFECT_OFFSET UNITYSDK_OFFSET(0x12B9DC10)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x12B9EBC0)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x12B9EC90)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x12B9ED50)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x12B9EE00)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT___TRYCREATESCRATCHEFFECTS_B__31_0_OFFSET UNITYSDK_OFFSET(0x12B9EB00)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT___TRYCREATETRIGGEREFFECT_B__30_0_OFFSET UNITYSDK_OFFSET(0x12B9EA40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneHitWallEffect_TypeDefinitionIndex = 71464;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AnimatorZoneHitWallEffect_TypeDefinitionIndex)->GetStaticField(0xCAE0);
		}
		::Class_3_DFD5D1FDB9D2A4AC* _characterModel; // 0x50
		::Class_2_96760AAAA04943EC* _zoneInfo; // 0x58
		::System::Collections::Generic::List_1<::UnityEngine::RaycastHit>* _zoneHits; // 0x60
		...
		::System::Collections::Generic::List_1<::System::String*>* ScratchSpecialEffects; // 0x80
		...
		::MoleMole::Config::Vector3Range StartSpecialEffectsRange; // 0x98
		::System::Int32 _frameCurCount; // 0xB0
		::System::Int32 hitRayFrameUpdateInterval; // 0xB4
		::MoleMole::Config::Vector3Range ScratchSpecialEffectsRange; // 0xB8
