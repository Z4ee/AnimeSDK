...
#define MOLEMOLE_CONFIG_ANIMATORZONEAVATAREXQTESTATE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x12B9A6D0)
#define MOLEMOLE_CONFIG_ANIMATORZONEAVATAREXQTESTATE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x12B9A3B0)
#define MOLEMOLE_CONFIG_ANIMATORZONEAVATAREXQTESTATE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x12B9A520)
#define MOLEMOLE_CONFIG_ANIMATORZONEAVATAREXQTESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x12B9A760)
#define MOLEMOLE_CONFIG_ANIMATORZONEAVATAREXQTESTATE___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x12B9A770)
#define MOLEMOLE_CONFIG_ANIMATORZONEAVATAREXQTESTATE___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x12B9A840)
#define MOLEMOLE_CONFIG_ANIMATORZONEAVATAREXQTESTATE___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x12B9A8F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneAvatarExQTEState_TypeDefinitionIndex = 51546;
