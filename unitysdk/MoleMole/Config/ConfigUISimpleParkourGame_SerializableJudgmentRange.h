...
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLEJUDGMENTRANGE_TOJUDGMENTRANGE_OFFSET UNITYSDK_OFFSET(0x127224F0)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLEJUDGMENTRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x127224E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUISimpleParkourGame_SerializableJudgmentRange_TypeDefinitionIndex = 72942;
