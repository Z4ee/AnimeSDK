...
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG_EFFECTTIMESEGMENTCONFIG_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x170BCE00)
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG_EFFECTTIMESEGMENTCONFIG_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x170BCE10)
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG_EFFECTTIMESEGMENTCONFIG_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x170BD400)
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG_EFFECTTIMESEGMENTCONFIG_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x170BD7B0)
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG_EFFECTTIMESEGMENTCONFIG_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x170BD770)

namespace MoleMole::Config
{
	inline static constexpr unsigned int EffectTimeSegmentConfig_EffectTimeSegmentConfig_UnityGeneratedFormatter_TypeDefinitionIndex = 72778;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(EffectTimeSegmentConfig_EffectTimeSegmentConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x483C0);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Int32>** StaticGet_CachedSerializer1()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(EffectTimeSegmentConfig_EffectTimeSegmentConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x483C8);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Boolean>** StaticGet_CachedSerializer2()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(EffectTimeSegmentConfig_EffectTimeSegmentConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x483D0);
		}
