...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SETSTATE_CONFIGSOUNDACTION_SETSTATE_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x12315D20)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SETSTATE_CONFIGSOUNDACTION_SETSTATE_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x12315D30)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SETSTATE_CONFIGSOUNDACTION_SETSTATE_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x12315FD0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SETSTATE_CONFIGSOUNDACTION_SETSTATE_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x123161C0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SETSTATE_CONFIGSOUNDACTION_SETSTATE_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x12316180)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_SetState_ConfigSoundAction_SetState_UnityGeneratedFormatter_TypeDefinitionIndex = 44817;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigSoundAction_SetState_ConfigSoundAction_SetState_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3C430);
		}
