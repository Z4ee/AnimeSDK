...
#define MOLEMOLE_CONFIG_CONFIGPOSROT_CHOOSEENTITYPOSROTBYTARGET_OFFSET UNITYSDK_OFFSET(0x12B3E170)
#define MOLEMOLE_CONFIG_CONFIGPOSROT_CHOOSEENTITYPOSROT_OFFSET UNITYSDK_OFFSET(0x12B3DE20)
#define MOLEMOLE_CONFIG_CONFIGPOSROT_DORAYCASTGROUND_OFFSET UNITYSDK_OFFSET(0x19FEACB0)
#define MOLEMOLE_CONFIG_CONFIGPOSROT_DRAWPOSROT_OFFSET UNITYSDK_OFFSET(0x12B3DA40)
#define MOLEMOLE_CONFIG_CONFIGPOSROT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19FEBD90)
#define MOLEMOLE_CONFIG_CONFIGPOSROT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x19FEC2E0)
#define MOLEMOLE_CONFIG_CONFIGPOSROT_GETATTACHPOINT_OFFSET UNITYSDK_OFFSET(0x19FEB2B0)
#define MOLEMOLE_CONFIG_CONFIGPOSROT_GETFINALPOSROT_OFFSET UNITYSDK_OFFSET(0x19FE9D10)
#define MOLEMOLE_CONFIG_CONFIGPOSROT_GETPOSROOTANDRESULT_OFFSET UNITYSDK_OFFSET(0x12B3F9E0)
#define MOLEMOLE_CONFIG_CONFIGPOSROT_GETPOSROTBYTARGETENTITY_OFFSET UNITYSDK_OFFSET(0x12B3F5D0)
#define MOLEMOLE_CONFIG_CONFIGPOSROT_GETPOSROTINFO_OFFSET UNITYSDK_OFFSET(0x19FEB370)
#define MOLEMOLE_CONFIG_CONFIGPOSROT_GETPOSROT_1_OFFSET UNITYSDK_OFFSET(0x12B3E610)
#define MOLEMOLE_CONFIG_CONFIGPOSROT_GETPOSROT_OFFSET UNITYSDK_OFFSET(0x12B3DCA0)
#define MOLEMOLE_CONFIG_CONFIGPOSROT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x19FEBDF0)
#define MOLEMOLE_CONFIG_CONFIGPOSROT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x19FEC360)
#define MOLEMOLE_CONFIG_CONFIGPOSROT_ISREFERTARGETCAMERA_OFFSET UNITYSDK_OFFSET(0x19FEBC80)
#define MOLEMOLE_CONFIG_CONFIGPOSROT_RAWGETPOSROOT_OFFSET UNITYSDK_OFFSET(0x12B3ED40)
#define MOLEMOLE_CONFIG_CONFIGPOSROT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19FEBC30)
#define MOLEMOLE_CONFIG_CONFIGPOSROT_TRYGETTARGETENTITY_OFFSET UNITYSDK_OFFSET(0x12B3E480)
#define MOLEMOLE_CONFIG_CONFIGPOSROT__CCTOR_OFFSET UNITYSDK_OFFSET(0x19FED330)
#define MOLEMOLE_CONFIG_CONFIGPOSROT__CTOR_OFFSET UNITYSDK_OFFSET(0x12AEC2F0)
#define MOLEMOLE_CONFIG_CONFIGPOSROT___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19FED4A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPosRot_TypeDefinitionIndex = 73276;
	...
	public:
		...
		{
			return (::MoleMole::Config::ConfigPosRot**)Il2CppClass::FromTypeDefinitionIndex(ConfigPosRot_TypeDefinitionIndex)->GetStaticField(0x36100);
		}
		static ::Struct_2_FC595D1A561D8C6F* StaticGet_cachedPosRot()
		{
			return (::Struct_2_FC595D1A561D8C6F*)Il2CppClass::FromTypeDefinitionIndex(ConfigPosRot_TypeDefinitionIndex)->GetStaticField(0xD590);
		}
		// static const ::System::Single DEFAULT_RAYCAST_LENGTH; // 0x0
		::MoleMole::Config::DynamicString* BackupRelativeTargetSavePoint; // 0x10
		::MoleMole::Config::DynamicString* RelativeTargetSavePoint; // 0x18
		::MoleMole::Config::OffsetGroup* Offset; // 0x20
		::MoleMole::Config::DynamicString* RelativeBaseSavePoint; // 0x28
		::MoleMole::Config::DynamicString* BackupRelativeBaseSavePoint; // 0x30
		::MoleMole::Config::PosRotTargetOption* TargetOption; // 0x38
		::MoleMole::Config::ReferTargetCoordsOption CoordsOption; // 0x40
		::System::Single RaycastGroundOffset; // 0x44
		::MoleMole::Config::ReferTargetCoordsOption BackupCoordsOption; // 0x48
		::UnityEngine::RaycastHit _hitInfo; // 0x4C
		::System::Boolean NeedRaycastGround; // 0x80
