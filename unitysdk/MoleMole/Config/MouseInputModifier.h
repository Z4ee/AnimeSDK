...
#define MOLEMOLE_CONFIG_MOUSEINPUTMODIFIER_MAKEDEFAULT_OFFSET UNITYSDK_OFFSET(0x158BF660)

namespace MoleMole::Config
{
	inline static constexpr unsigned int MouseInputModifier_TypeDefinitionIndex = 43735;
