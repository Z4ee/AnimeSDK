...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SETLISTENINGPERSPECTIVE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1170D130)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SETLISTENINGPERSPECTIVE_GET_INSPECTORLABEL_OFFSET UNITYSDK_OFFSET(0x1170D0F0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SETLISTENINGPERSPECTIVE_ISMATCH_OFFSET UNITYSDK_OFFSET(0x1170D240)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SETLISTENINGPERSPECTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1170D290)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SETLISTENINGPERSPECTIVE___BASE_ISMATCH_OFFSET UNITYSDK_OFFSET(0x1170D2D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_SetListeningPerspective_TypeDefinitionIndex = 86167;
