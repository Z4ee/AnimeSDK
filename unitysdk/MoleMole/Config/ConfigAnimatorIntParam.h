...
#define MOLEMOLE_CONFIG_CONFIGANIMATORINTPARAM_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x7A2D70)
#define MOLEMOLE_CONFIG_CONFIGANIMATORINTPARAM_FROMFLX_OFFSET UNITYSDK_OFFSET(0x7A2CE0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORINTPARAM_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x7A2DD0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORINTPARAM_METHOD_2_F777B3BEDBE68D53_OFFSET UNITYSDK_OFFSET(0x7A2E00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAnimatorIntParam_TypeDefinitionIndex = 48557;
