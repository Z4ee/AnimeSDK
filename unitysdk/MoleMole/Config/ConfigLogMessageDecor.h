...
#define MOLEMOLE_CONFIG_CONFIGLOGMESSAGEDECOR_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x11CAD8F0)
#define MOLEMOLE_CONFIG_CONFIGLOGMESSAGEDECOR_FROMFLX_OFFSET UNITYSDK_OFFSET(0x11CAD660)
#define MOLEMOLE_CONFIG_CONFIGLOGMESSAGEDECOR_METHOD_2_0AFE2382BF92DEC7_OFFSET UNITYSDK_OFFSET(0x11CAD950)
#define MOLEMOLE_CONFIG_CONFIGLOGMESSAGEDECOR_METHOD_2_16902267D4DA4F5F_OFFSET UNITYSDK_OFFSET(0x11CADB30)
#define MOLEMOLE_CONFIG_CONFIGLOGMESSAGEDECOR_METHOD_2_2C463ED601F44ECA_OFFSET UNITYSDK_OFFSET(0x11CADBE0)
#define MOLEMOLE_CONFIG_CONFIGLOGMESSAGEDECOR_METHOD_2_7821D1D4DDDF7E01_OFFSET UNITYSDK_OFFSET(0x11CAD6E0)
#define MOLEMOLE_CONFIG_CONFIGLOGMESSAGEDECOR_METHOD_2_81438D3AF9EEE8D8_OFFSET UNITYSDK_OFFSET(0x11CAD4F0)
#define MOLEMOLE_CONFIG_CONFIGLOGMESSAGEDECOR_METHOD_2_B6B10C6F1ED2C48D_OFFSET UNITYSDK_OFFSET(0x11CADC70)
#define MOLEMOLE_CONFIG_CONFIGLOGMESSAGEDECOR_METHOD_2_B73F62522113F21F_OFFSET UNITYSDK_OFFSET(0x11CAD4A0)
#define MOLEMOLE_CONFIG_CONFIGLOGMESSAGEDECOR_METHOD_2_C444D4C8B9D548AF_OFFSET UNITYSDK_OFFSET(0x11CAD5F0)
#define MOLEMOLE_CONFIG_CONFIGLOGMESSAGEDECOR_METHOD_2_D830C4D9D0A72C29_OFFSET UNITYSDK_OFFSET(0x11CADDD0)
#define MOLEMOLE_CONFIG_CONFIGLOGMESSAGEDECOR__CTOR_OFFSET UNITYSDK_OFFSET(0x11CADBD0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigLogMessageDecor_TypeDefinitionIndex = 56068;
