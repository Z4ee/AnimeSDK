...
#define MOLEMOLE_CONFIG_CONFIGTURNBASEBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x10D0D180)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTurnBaseBattle_TypeDefinitionIndex = 84920;
