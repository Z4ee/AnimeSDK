...
#define MOLEMOLE_CONFIG_CONFIGTURNBASEBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1170EC40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTurnBaseBattle_TypeDefinitionIndex = 62034;
