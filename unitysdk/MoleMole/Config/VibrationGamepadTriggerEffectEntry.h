...
#define MOLEMOLE_CONFIG_VIBRATIONGAMEPADTRIGGEREFFECTENTRY_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x1C47B610)
#define MOLEMOLE_CONFIG_VIBRATIONGAMEPADTRIGGEREFFECTENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C47B6C0)
#define MOLEMOLE_CONFIG_VIBRATIONGAMEPADTRIGGEREFFECTENTRY___BASE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x1C47B6D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int VibrationGamepadTriggerEffectEntry_TypeDefinitionIndex = 90409;
