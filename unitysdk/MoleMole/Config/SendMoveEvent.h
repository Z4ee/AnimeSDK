...
#define MOLEMOLE_CONFIG_SENDMOVEEVENT_ONINTERACTINTERNAL_OFFSET UNITYSDK_OFFSET(0x16AA8730)
#define MOLEMOLE_CONFIG_SENDMOVEEVENT_ONSTOP_OFFSET UNITYSDK_OFFSET(0x16AA86E0)
#define MOLEMOLE_CONFIG_SENDMOVEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16AA87B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SendMoveEvent_TypeDefinitionIndex = 64740;
