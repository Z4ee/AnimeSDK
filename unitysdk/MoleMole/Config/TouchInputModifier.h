...
#define MOLEMOLE_CONFIG_TOUCHINPUTMODIFIER_MAKEDEFAULT_OFFSET UNITYSDK_OFFSET(0x1A077050)

namespace MoleMole::Config
{
	inline static constexpr unsigned int TouchInputModifier_TypeDefinitionIndex = 56504;
