...
#define MOLEMOLE_CONFIG_TOUCHINPUTMODIFIER_MAKEDEFAULT_OFFSET UNITYSDK_OFFSET(0x19FF79A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int TouchInputModifier_TypeDefinitionIndex = 45443;
