...
#define MOLEMOLE_CONFIG_CONFIGPOSROTSAVEPOINT_CLONE_OFFSET UNITYSDK_OFFSET(0x1A06E3E0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTSAVEPOINT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x1A06E390)
#define MOLEMOLE_CONFIG_CONFIGPOSROTSAVEPOINT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A06DFF0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTSAVEPOINT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1A06E550)
#define MOLEMOLE_CONFIG_CONFIGPOSROTSAVEPOINT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x1A06E4E0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTSAVEPOINT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A06E050)
#define MOLEMOLE_CONFIG_CONFIGPOSROTSAVEPOINT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x1A06E5D0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTSAVEPOINT_ISSAVEPOINTOPTION_OFFSET UNITYSDK_OFFSET(0x1A06DFB0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTSAVEPOINT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A06E1E0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTSAVEPOINT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x1A06E7D0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTSAVEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A06E930)
#define MOLEMOLE_CONFIG_CONFIGPOSROTSAVEPOINT___BASE_ISSAVEPOINTOPTION_OFFSET UNITYSDK_OFFSET(0x1A06E940)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPosRotSavePoint_TypeDefinitionIndex = 44850;
