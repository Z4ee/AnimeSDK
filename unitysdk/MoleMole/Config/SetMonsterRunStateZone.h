...
#define MOLEMOLE_CONFIG_SETMONSTERRUNSTATEZONE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x170CACC0)
#define MOLEMOLE_CONFIG_SETMONSTERRUNSTATEZONE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x170CAD90)
#define MOLEMOLE_CONFIG_SETMONSTERRUNSTATEZONE__CTOR_OFFSET UNITYSDK_OFFSET(0x170CAE60)
#define MOLEMOLE_CONFIG_SETMONSTERRUNSTATEZONE___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x170CAE70)
#define MOLEMOLE_CONFIG_SETMONSTERRUNSTATEZONE___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x170CAF20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SetMonsterRunStateZone_TypeDefinitionIndex = 57135;
