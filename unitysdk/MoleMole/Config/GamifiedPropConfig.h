...
#define MOLEMOLE_CONFIG_GAMIFIEDPROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x149486C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int GamifiedPropConfig_TypeDefinitionIndex = 66655;
