...
#define MOLEMOLE_CONFIG_GAMIFIEDPROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x170C0730)

namespace MoleMole::Config
{
	inline static constexpr unsigned int GamifiedPropConfig_TypeDefinitionIndex = 86100;
