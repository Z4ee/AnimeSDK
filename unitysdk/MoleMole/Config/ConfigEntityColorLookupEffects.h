...
#define MOLEMOLE_CONFIG_CONFIGENTITYCOLORLOOKUPEFFECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A067C50)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityColorLookupEffects_TypeDefinitionIndex = 75957;
