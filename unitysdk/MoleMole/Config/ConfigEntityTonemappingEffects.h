...
#define MOLEMOLE_CONFIG_CONFIGENTITYTONEMAPPINGEFFECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x158A4F50)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityTonemappingEffects_TypeDefinitionIndex = 87608;
