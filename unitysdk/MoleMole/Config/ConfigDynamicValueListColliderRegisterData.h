...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTCOLLIDERREGISTERDATA_CLONE_OFFSET UNITYSDK_OFFSET(0x17D22060)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTCOLLIDERREGISTERDATA_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x17D22010)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTCOLLIDERREGISTERDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17D22640)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTCOLLIDERREGISTERDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x17D221D0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTCOLLIDERREGISTERDATA_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x17D22160)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTCOLLIDERREGISTERDATA_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x17D226A0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTCOLLIDERREGISTERDATA_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x17D22250)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTCOLLIDERREGISTERDATA_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x17D22840)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTCOLLIDERREGISTERDATA_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x17D224E0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTCOLLIDERREGISTERDATA_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0x17D21EC0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTCOLLIDERREGISTERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17D229F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicValueListColliderRegisterData_TypeDefinitionIndex = 42644;
