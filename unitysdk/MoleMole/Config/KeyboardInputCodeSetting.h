...
#define MOLEMOLE_CONFIG_KEYBOARDINPUTCODESETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1619CD90)

namespace MoleMole::Config
{
	inline static constexpr unsigned int KeyboardInputCodeSetting_TypeDefinitionIndex = 54733;
