...
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGETDATA_BRIDGEONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x106C8380)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGETDATA_BRIDGEONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x106C7DD0)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGETDATA_GETVALUETYPEENUM_OFFSET UNITYSDK_OFFSET(0x106C80E0)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGETDATA_GETVALUETYPE_OFFSET UNITYSDK_OFFSET(0x106C86F0)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGETDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x106C88E0)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGETDATA___BASE_BRIDGEONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x106C8B10)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGETDATA___BASE_BRIDGEONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x106C8BA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAbilityTargetData_TypeDefinitionIndex = 43337;
