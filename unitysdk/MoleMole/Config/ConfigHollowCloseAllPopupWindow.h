...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCLOSEALLPOPUPWINDOW_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x16A90C40)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCLOSEALLPOPUPWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0x16A90D00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowCloseAllPopupWindow_TypeDefinitionIndex = 51862;
