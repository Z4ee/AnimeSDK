...
#define MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENTPARAM_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x1A33E1D0)
#define MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENTPARAM_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A33ED10)
#define MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENTPARAM_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1A33E370)
#define MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENTPARAM_METHOD_1_5DAF3CA1F13D8B5E_OFFSET UNITYSDK_OFFSET(0x1A33ED70)
#define MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENTPARAM_METHOD_1_8741A88D50268453_OFFSET UNITYSDK_OFFSET(0x1A33E3F0)
#define MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A33F1C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAbilityFragmentParam_TypeDefinitionIndex = 40942;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_175*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENTPARAM_EXPOSEMEMBER_OFFSET))(this, a1, a2);
		}
