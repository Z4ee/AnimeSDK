...
#define MOLEMOLE_CONFIG_CONFIGETHEREYES__CTOR_OFFSET UNITYSDK_OFFSET(0x141F06F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEtherEyes_TypeDefinitionIndex = 65668;
