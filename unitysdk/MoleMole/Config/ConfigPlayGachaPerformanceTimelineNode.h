...
#define MOLEMOLE_CONFIG_CONFIGPLAYGACHAPERFORMANCETIMELINENODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x1B7EEBC0)
#define MOLEMOLE_CONFIG_CONFIGPLAYGACHAPERFORMANCETIMELINENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7EEC30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPlayGachaPerformanceTimelineNode_TypeDefinitionIndex = 49620;
