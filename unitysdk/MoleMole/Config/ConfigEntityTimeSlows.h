...
#define MOLEMOLE_CONFIG_CONFIGENTITYTIMESLOWS_BRIDGEONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x11CA88B0)
#define MOLEMOLE_CONFIG_CONFIGENTITYTIMESLOWS_BRIDGEONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x11CA8460)
#define MOLEMOLE_CONFIG_CONFIGENTITYTIMESLOWS_GETVALUETYPEENUM_OFFSET UNITYSDK_OFFSET(0x11CA8780)
#define MOLEMOLE_CONFIG_CONFIGENTITYTIMESLOWS_GETVALUETYPE_OFFSET UNITYSDK_OFFSET(0x11CA8C20)
#define MOLEMOLE_CONFIG_CONFIGENTITYTIMESLOWS__CTOR_OFFSET UNITYSDK_OFFSET(0x11CA8D60)
#define MOLEMOLE_CONFIG_CONFIGENTITYTIMESLOWS___BASE_BRIDGEONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x11CA8F90)
#define MOLEMOLE_CONFIG_CONFIGENTITYTIMESLOWS___BASE_BRIDGEONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x11CA9020)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityTimeSlows_TypeDefinitionIndex = 68914;
