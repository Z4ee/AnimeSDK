...
#define MOLEMOLE_CONFIG_ANIMATORZONEALLOWVELOCITY_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x1BD45C70)
#define MOLEMOLE_CONFIG_ANIMATORZONEALLOWVELOCITY_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x1BD458C0)
#define MOLEMOLE_CONFIG_ANIMATORZONEALLOWVELOCITY_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x1BD45A90)
#define MOLEMOLE_CONFIG_ANIMATORZONEALLOWVELOCITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD45D00)
#define MOLEMOLE_CONFIG_ANIMATORZONEALLOWVELOCITY___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x1BD45D10)
#define MOLEMOLE_CONFIG_ANIMATORZONEALLOWVELOCITY___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x1BD45DE0)
#define MOLEMOLE_CONFIG_ANIMATORZONEALLOWVELOCITY___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x1BD45E90)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneAllowVelocity_TypeDefinitionIndex = 43854;

	class AnimatorZoneAllowVelocity : public ::MoleMole::Config::AnimatorZone
	{
	public:
		::System::Boolean KinematicAllowed; // 0x50
		::System::Boolean AnimatorAllowed; // 0x51
		::System::Boolean LogicAllowed; // 0x52
