...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_FRONTENDGAME_EVALUATE_OFFSET UNITYSDK_OFFSET(0x144E4290)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_FRONTENDGAME_GET_INSPECTORLABEL_OFFSET UNITYSDK_OFFSET(0x144E4250)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_FRONTENDGAME_ISFRONTENDGAME_OFFSET UNITYSDK_OFFSET(0x144E42F0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_FRONTENDGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x144E44C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundActionTriggerCondition_FrontEndGame_TypeDefinitionIndex = 75944;
