...
#define MOLEMOLE_CONFIG_CONFIGFLOWCANVASDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16A8E790)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigFlowCanvasData_TypeDefinitionIndex = 53164;
