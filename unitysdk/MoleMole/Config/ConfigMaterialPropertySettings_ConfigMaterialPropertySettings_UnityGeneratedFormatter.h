...
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYSETTINGS_CONFIGMATERIALPROPERTYSETTINGS_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x127199F0)
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYSETTINGS_CONFIGMATERIALPROPERTYSETTINGS_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x12719A00)
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYSETTINGS_CONFIGMATERIALPROPERTYSETTINGS_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x12719CA0)
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYSETTINGS_CONFIGMATERIALPROPERTYSETTINGS_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x12719E90)
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYSETTINGS_CONFIGMATERIALPROPERTYSETTINGS_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x12719E50)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMaterialPropertySettings_ConfigMaterialPropertySettings_UnityGeneratedFormatter_TypeDefinitionIndex = 84544;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::MoleMole::Config::MaterialPropertyType, ::System::String*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigMaterialPropertySettings_ConfigMaterialPropertySettings_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x4CAF0);
		}
