...
#define MOLEMOLE_CONFIG_SCENEPERFORMCONFIG_SCENEPERFORMITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x153D3CC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ScenePerformConfig_ScenePerformItem_TypeDefinitionIndex = 81580;
