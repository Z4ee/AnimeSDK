...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_WHEN_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1102FA90)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_WHEN_GET_INSPECTORLABEL_OFFSET UNITYSDK_OFFSET(0x1102F9D0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_WHEN_GET_PARAMHINT_OFFSET UNITYSDK_OFFSET(0x1102FA10)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_WHEN_ISMATCH_OFFSET UNITYSDK_OFFSET(0x1102FBD0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_WHEN_WALK_OFFSET UNITYSDK_OFFSET(0x1102FC50)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_WHEN__CTOR_OFFSET UNITYSDK_OFFSET(0x1102FD30)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_WHEN___BASE_GET_PARAMHINT_OFFSET UNITYSDK_OFFSET(0x1102FD70)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_WHEN___BASE_ISMATCH_OFFSET UNITYSDK_OFFSET(0x1102FD80)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_WHEN___BASE_WALK_OFFSET UNITYSDK_OFFSET(0x1102FD90)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_When_TypeDefinitionIndex = 79254;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_147*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGSOUNDACTION_WHEN_EXECUTE_OFFSET))(this, context);
		}
