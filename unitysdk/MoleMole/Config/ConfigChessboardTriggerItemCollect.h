...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDTRIGGERITEMCOLLECT_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x1AA4C140)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDTRIGGERITEMCOLLECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA4C200)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardTriggerItemCollect_TypeDefinitionIndex = 52201;
