...
#define MOLEMOLE_CONFIG_RANGERANDOMENEMYABILITYTARGET_METHOD_2_30887E4ABF39ADEB_OFFSET UNITYSDK_OFFSET(0x14255940)
#define MOLEMOLE_CONFIG_RANGERANDOMENEMYABILITYTARGET_METHOD_2_C45B3D125C3112F9_OFFSET UNITYSDK_OFFSET(0x14256130)
#define MOLEMOLE_CONFIG_RANGERANDOMENEMYABILITYTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x142562A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int RangeRandomEnemyAbilityTarget_TypeDefinitionIndex = 82960;
