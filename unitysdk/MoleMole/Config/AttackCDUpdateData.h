...
#define MOLEMOLE_CONFIG_ATTACKCDUPDATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x12D2F9A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AttackCDUpdateData_TypeDefinitionIndex = 41168;
