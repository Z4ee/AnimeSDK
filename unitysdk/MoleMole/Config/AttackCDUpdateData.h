...
#define MOLEMOLE_CONFIG_ATTACKCDUPDATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x12B2DC30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AttackCDUpdateData_TypeDefinitionIndex = 46281;
