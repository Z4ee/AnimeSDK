...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDCHECKISINFAKELOADING_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x1A341430)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDCHECKISINFAKELOADING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3414F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardCheckIsInFakeLoading_TypeDefinitionIndex = 47209;
