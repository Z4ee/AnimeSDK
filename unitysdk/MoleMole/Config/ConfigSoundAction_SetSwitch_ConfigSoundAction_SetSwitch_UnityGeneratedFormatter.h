...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SETSWITCH_CONFIGSOUNDACTION_SETSWITCH_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x19FF1C20)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SETSWITCH_CONFIGSOUNDACTION_SETSWITCH_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x19FF1C30)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SETSWITCH_CONFIGSOUNDACTION_SETSWITCH_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x19FF1ED0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SETSWITCH_CONFIGSOUNDACTION_SETSWITCH_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19FF20C0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SETSWITCH_CONFIGSOUNDACTION_SETSWITCH_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF2080)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_SetSwitch_ConfigSoundAction_SetSwitch_UnityGeneratedFormatter_TypeDefinitionIndex = 75893;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigSoundAction_SetSwitch_ConfigSoundAction_SetSwitch_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x4BD10);
		}
