...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SETSWITCH_CONFIGSOUNDACTION_SETSWITCH_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x181D5270)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SETSWITCH_CONFIGSOUNDACTION_SETSWITCH_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x181D5280)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SETSWITCH_CONFIGSOUNDACTION_SETSWITCH_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x181D5520)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SETSWITCH_CONFIGSOUNDACTION_SETSWITCH_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x181D5710)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SETSWITCH_CONFIGSOUNDACTION_SETSWITCH_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x181D56D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_SetSwitch_ConfigSoundAction_SetSwitch_UnityGeneratedFormatter_TypeDefinitionIndex = 42085;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigSoundAction_SetSwitch_ConfigSoundAction_SetSwitch_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x486C0);
		}
