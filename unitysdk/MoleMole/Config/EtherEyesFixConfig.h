...
#define MOLEMOLE_CONFIG_ETHEREYESFIXCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x90CFD0)
#define MOLEMOLE_CONFIG_ETHEREYESFIXCONFIG_FROMFLX_OFFSET UNITYSDK_OFFSET(0x90CF40)
#define MOLEMOLE_CONFIG_ETHEREYESFIXCONFIG_METHOD_2_782A6BFBCB1628EC_OFFSET UNITYSDK_OFFSET(0x90D060)
#define MOLEMOLE_CONFIG_ETHEREYESFIXCONFIG_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x90D030)

namespace MoleMole::Config
{
	inline static constexpr unsigned int EtherEyesFixConfig_TypeDefinitionIndex = 48096;
