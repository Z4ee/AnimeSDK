...
#define MOLEMOLE_CONFIG_ETHEREYESFIXCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x881FD0)
#define MOLEMOLE_CONFIG_ETHEREYESFIXCONFIG_FROMFLX_OFFSET UNITYSDK_OFFSET(0x881F40)
#define MOLEMOLE_CONFIG_ETHEREYESFIXCONFIG_METHOD_2_782A6BFBCB1628EC_OFFSET UNITYSDK_OFFSET(0x882030)
#define MOLEMOLE_CONFIG_ETHEREYESFIXCONFIG_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x882040)

namespace MoleMole::Config
{
	inline static constexpr unsigned int EtherEyesFixConfig_TypeDefinitionIndex = 47453;
