...
#define MOLEMOLE_CONFIG_CONFIGWAITACTIONNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x14877230)
#define MOLEMOLE_CONFIG_CONFIGWAITACTIONNODE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x14877300)
#define MOLEMOLE_CONFIG_CONFIGWAITACTIONNODE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x148773C0)
#define MOLEMOLE_CONFIG_CONFIGWAITACTIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x14877400)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigWaitActionNode_TypeDefinitionIndex = 86636;

	class ConfigWaitActionNode : public ::MoleMole::Config::ConfigUIBaseActionNode
	{
	public:
		::MoleMole::Config::FloatUISpecialNum* RandomOffsetMax; // 0x18
		::MoleMole::Config::FloatUISpecialNum* WaitSeconds; // 0x20
