...
#define MOLEMOLE_CONFIG_CONFIGWAITACTIONNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x11CB6980)
#define MOLEMOLE_CONFIG_CONFIGWAITACTIONNODE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x11CB6A50)
#define MOLEMOLE_CONFIG_CONFIGWAITACTIONNODE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x11CB6B10)
#define MOLEMOLE_CONFIG_CONFIGWAITACTIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x11CB6B50)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigWaitActionNode_TypeDefinitionIndex = 79433;
