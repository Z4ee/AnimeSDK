...
#define MOLEMOLE_CONFIG_ANIMATOREVENTPATTERN_CHECKENTRIES_OFFSET UNITYSDK_OFFSET(0x150E7DE0)
#define MOLEMOLE_CONFIG_ANIMATOREVENTPATTERN_ONPATTERNNAMECHANGED_OFFSET UNITYSDK_OFFSET(0x150E7D90)
#define MOLEMOLE_CONFIG_ANIMATOREVENTPATTERN_ONREMOVETAG_OFFSET UNITYSDK_OFFSET(0x150E7E80)
#define MOLEMOLE_CONFIG_ANIMATOREVENTPATTERN__CTOR_OFFSET UNITYSDK_OFFSET(0x150E7ED0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorEventPattern_TypeDefinitionIndex = 54912;

	class AnimatorEventPattern : public ::System::Object
	{
	public:
		::Il2CppArray<::MoleMole::Config::AnimatorEventEntry*>* entries; // 0x10
		::Il2CppArray<::MoleMole::Config::AnimatorEvent*>* animatorEvents; // 0x18
		::System::String* _prevName; // 0x20
