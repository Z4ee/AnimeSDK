...
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERVOLUMEPROXYEFFECT_GETINDOORWEIGHT_OFFSET UNITYSDK_OFFSET(0x186B4FD0)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERVOLUMEPROXYEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x186B5050)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityCharacterVolumeProxyEffect_TypeDefinitionIndex = 61613;
