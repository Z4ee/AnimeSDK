...
#define MOLEMOLE_CONFIG_CONFIGSTOPSEQUENCEVENODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x1753C460)
#define MOLEMOLE_CONFIG_CONFIGSTOPSEQUENCEVENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1753C520)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigStopSequenceVENode_TypeDefinitionIndex = 65063;
