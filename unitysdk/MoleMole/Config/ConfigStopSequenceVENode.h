...
#define MOLEMOLE_CONFIG_CONFIGSTOPSEQUENCEVENODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x144E6830)
#define MOLEMOLE_CONFIG_CONFIGSTOPSEQUENCEVENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x144E68F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigStopSequenceVENode_TypeDefinitionIndex = 82789;
