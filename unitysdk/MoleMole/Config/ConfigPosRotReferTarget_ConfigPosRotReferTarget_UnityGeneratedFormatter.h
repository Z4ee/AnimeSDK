...
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_CONFIGPOSROTREFERTARGET_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x1A3532D0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_CONFIGPOSROTREFERTARGET_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x1A3532E0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_CONFIGPOSROTREFERTARGET_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x1A353C10)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_CONFIGPOSROTREFERTARGET_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A354180)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERTARGET_CONFIGPOSROTREFERTARGET_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A354140)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPosRotReferTarget_ConfigPosRotReferTarget_UnityGeneratedFormatter_TypeDefinitionIndex = 71440;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::Config::AbilityTargetting>**)Il2CppClass::FromTypeDefinitionIndex(ConfigPosRotReferTarget_ConfigPosRotReferTarget_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x4D6C0);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Boolean>** StaticGet_CachedSerializer1()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(ConfigPosRotReferTarget_ConfigPosRotReferTarget_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x4D6C8);
		}
		static ::Sirenix::Serialization::Serializer_1<::MoleMole::Config::DynamicString*>** StaticGet_CachedSerializer2()
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::Config::DynamicString*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigPosRotReferTarget_ConfigPosRotReferTarget_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x4D6D0);
		}
