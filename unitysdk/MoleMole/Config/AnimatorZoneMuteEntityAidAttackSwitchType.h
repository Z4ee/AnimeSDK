...
#define MOLEMOLE_CONFIG_ANIMATORZONEMUTEENTITYAIDATTACKSWITCHTYPE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x12A474E0)
#define MOLEMOLE_CONFIG_ANIMATORZONEMUTEENTITYAIDATTACKSWITCHTYPE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x12A47610)
#define MOLEMOLE_CONFIG_ANIMATORZONEMUTEENTITYAIDATTACKSWITCHTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x12A47740)
#define MOLEMOLE_CONFIG_ANIMATORZONEMUTEENTITYAIDATTACKSWITCHTYPE___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x12A47750)
#define MOLEMOLE_CONFIG_ANIMATORZONEMUTEENTITYAIDATTACKSWITCHTYPE___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x12A477C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneMuteEntityAidAttackSwitchType_TypeDefinitionIndex = 46585;
