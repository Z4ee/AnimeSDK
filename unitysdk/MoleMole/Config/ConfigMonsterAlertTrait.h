...
#define MOLEMOLE_CONFIG_CONFIGMONSTERALERTTRAIT_CLONE_OFFSET UNITYSDK_OFFSET(0x1B90AC00)
#define MOLEMOLE_CONFIG_CONFIGMONSTERALERTTRAIT_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x1B90AD00)
#define MOLEMOLE_CONFIG_CONFIGMONSTERALERTTRAIT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x1B90ABB0)
#define MOLEMOLE_CONFIG_CONFIGMONSTERALERTTRAIT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B90CE00)
#define MOLEMOLE_CONFIG_CONFIGMONSTERALERTTRAIT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1B90B900)
#define MOLEMOLE_CONFIG_CONFIGMONSTERALERTTRAIT_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B90D810)
#define MOLEMOLE_CONFIG_CONFIGMONSTERALERTTRAIT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x1B90ACF0)
#define MOLEMOLE_CONFIG_CONFIGMONSTERALERTTRAIT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B90CE60)
#define MOLEMOLE_CONFIG_CONFIGMONSTERALERTTRAIT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x1B90B980)
#define MOLEMOLE_CONFIG_CONFIGMONSTERALERTTRAIT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B90D680)
#define MOLEMOLE_CONFIG_CONFIGMONSTERALERTTRAIT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x1B90CCC0)
#define MOLEMOLE_CONFIG_CONFIGMONSTERALERTTRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B90D8A0)
#define MOLEMOLE_CONFIG_CONFIGMONSTERALERTTRAIT___BASE_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x1B90D8B0)
#define MOLEMOLE_CONFIG_CONFIGMONSTERALERTTRAIT___BASE_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B90D8C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMonsterAlertTrait_TypeDefinitionIndex = 72238;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_198*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGMONSTERALERTTRAIT_EXPOSEMEMBER_OFFSET))(this, processor, prefix);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_BE29B49AC03370B6*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGMONSTERALERTTRAIT_GENERATECOMPONENT_OFFSET))(this, buildContext);
		}

		::System::Void __base_ExposeMember(::Class_0_16E4307DCC419505_198* P0, ::System::String* P1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_198*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGMONSTERALERTTRAIT___BASE_EXPOSEMEMBER_OFFSET))(this, P0, P1);
		}

		::System::Boolean __base_GenerateComponent(::Class_1_BE29B49AC03370B6* P0)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_BE29B49AC03370B6*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGMONSTERALERTTRAIT___BASE_GENERATECOMPONENT_OFFSET))(this, P0);
		}
	};
}
