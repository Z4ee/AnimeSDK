...
#define MOLEMOLE_CONFIG_CONFIGTALENTBGCOLOR_METHOD_1_60983406819BC07A_OFFSET UNITYSDK_OFFSET(0x1424EB50)
#define MOLEMOLE_CONFIG_CONFIGTALENTBGCOLOR_METHOD_1_C4706E206E236330_OFFSET UNITYSDK_OFFSET(0x1424E8C0)
#define MOLEMOLE_CONFIG_CONFIGTALENTBGCOLOR_METHOD_1_FC021F44C9E0792B_OFFSET UNITYSDK_OFFSET(0x1424EA40)
#define MOLEMOLE_CONFIG_CONFIGTALENTBGCOLOR_METHOD_1_FE21C5936EF8FC82_OFFSET UNITYSDK_OFFSET(0x1424E830)
#define MOLEMOLE_CONFIG_CONFIGTALENTBGCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1424E7A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTalentBGColor_TypeDefinitionIndex = 73920;
