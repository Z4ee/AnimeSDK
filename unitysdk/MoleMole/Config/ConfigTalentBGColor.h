...
#define MOLEMOLE_CONFIG_CONFIGTALENTBGCOLOR_METHOD_1_60983406819BC07A_OFFSET UNITYSDK_OFFSET(0x10D0D090)
#define MOLEMOLE_CONFIG_CONFIGTALENTBGCOLOR_METHOD_1_C4706E206E236330_OFFSET UNITYSDK_OFFSET(0x10D0CE00)
#define MOLEMOLE_CONFIG_CONFIGTALENTBGCOLOR_METHOD_1_FC021F44C9E0792B_OFFSET UNITYSDK_OFFSET(0x10D0CF80)
#define MOLEMOLE_CONFIG_CONFIGTALENTBGCOLOR_METHOD_1_FE21C5936EF8FC82_OFFSET UNITYSDK_OFFSET(0x10D0D0F0)
#define MOLEMOLE_CONFIG_CONFIGTALENTBGCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x10D0CD70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTalentBGColor_TypeDefinitionIndex = 55568;
