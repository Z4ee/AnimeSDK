...
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLEJUDGMENTCONFIG_GET_HASGOODRANGE_OFFSET UNITYSDK_OFFSET(0x11031C90)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLEJUDGMENTCONFIG_GET_HASPERFECTRANGE_OFFSET UNITYSDK_OFFSET(0x11031C80)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLEJUDGMENTCONFIG_TOJUDGMENTCONFIG_OFFSET UNITYSDK_OFFSET(0x11031CA0)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLEJUDGMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x11032100)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUISimpleParkourGame_SerializableJudgmentConfig_TypeDefinitionIndex = 43822;
