...
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLEJUDGMENTCONFIG_GET_HASGOODRANGE_OFFSET UNITYSDK_OFFSET(0x16266C40)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLEJUDGMENTCONFIG_GET_HASPERFECTRANGE_OFFSET UNITYSDK_OFFSET(0x16266C30)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLEJUDGMENTCONFIG_TOJUDGMENTCONFIG_OFFSET UNITYSDK_OFFSET(0x16266C50)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLEJUDGMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x162670B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUISimpleParkourGame_SerializableJudgmentConfig_TypeDefinitionIndex = 73979;
