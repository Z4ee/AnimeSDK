...
#define MOLEMOLE_CONFIG_CONFIGCOOPVFXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x162A8DD0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCoopVFXConfig_TypeDefinitionIndex = 54981;
