...
#define MOLEMOLE_CONFIG_CONFIGCOOPVFXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16C3BD90)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCoopVFXConfig_TypeDefinitionIndex = 53975;
