...
#define MOLEMOLE_CONFIG_CONFIGLOCKTARGETS_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x110A3D60)
#define MOLEMOLE_CONFIG_CONFIGLOCKTARGETS_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x110A39D0)
#define MOLEMOLE_CONFIG_CONFIGLOCKTARGETS__CTOR_OFFSET UNITYSDK_OFFSET(0x110A4110)
#define MOLEMOLE_CONFIG_CONFIGLOCKTARGETS___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x110A4330)
#define MOLEMOLE_CONFIG_CONFIGLOCKTARGETS___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x110A4340)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigLockTargets_TypeDefinitionIndex = 62985;
