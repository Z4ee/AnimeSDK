...
#define MOLEMOLE_CONFIG_ASSETINDEXCONTAINER_CLASS_1_18022CE16F7A069A__CTOR_OFFSET UNITYSDK_OFFSET(0x127071B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AssetIndexContainer_Class_1_18022CE16F7A069A_TypeDefinitionIndex = 40837;
	...
	public:
		...
		::Il2CppArray<::MoleMole::Config::IndexBlockRef*>* Field_1_3; // 0x18
		::Il2CppArray<::System::Byte>* Field_1_1; // 0x20
		::Il2CppArray<::MoleMole::Config::IndexBundleRef*>* Field_1_4; // 0x28
		::Il2CppArray<::MoleMole::Config::IndexAssetRef*>* Field_1_2; // 0x30
