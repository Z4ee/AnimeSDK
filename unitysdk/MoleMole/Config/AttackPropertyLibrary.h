...
#define MOLEMOLE_CONFIG_ATTACKPROPERTYLIBRARY__CTOR_OFFSET UNITYSDK_OFFSET(0x12B2DC40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AttackPropertyLibrary_TypeDefinitionIndex = 60000;
