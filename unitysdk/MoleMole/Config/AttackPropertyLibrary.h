...
#define MOLEMOLE_CONFIG_ATTACKPROPERTYLIBRARY__CTOR_OFFSET UNITYSDK_OFFSET(0x12D2F9B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AttackPropertyLibrary_TypeDefinitionIndex = 76848;
