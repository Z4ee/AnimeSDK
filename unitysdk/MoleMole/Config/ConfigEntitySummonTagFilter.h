...
#define MOLEMOLE_CONFIG_CONFIGENTITYSUMMONTAGFILTER_MATCHSUMMONTAG_OFFSET UNITYSDK_OFFSET(0x1744B820)
#define MOLEMOLE_CONFIG_CONFIGENTITYSUMMONTAGFILTER_VALUEPASS_OFFSET UNITYSDK_OFFSET(0x1744B770)
#define MOLEMOLE_CONFIG_CONFIGENTITYSUMMONTAGFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1744BCD0)
#define MOLEMOLE_CONFIG_CONFIGENTITYSUMMONTAGFILTER__MATCHSUMMONTAG_G__CHECKISSAMESUMMONER_4_1_OFFSET UNITYSDK_OFFSET(0x1744BD10)
#define MOLEMOLE_CONFIG_CONFIGENTITYSUMMONTAGFILTER__MATCHSUMMONTAG_G__CHECKISSELFSUMMONER_4_2_OFFSET UNITYSDK_OFFSET(0x1744BCE0)
#define MOLEMOLE_CONFIG_CONFIGENTITYSUMMONTAGFILTER__MATCHSUMMONTAG_G__CHECKSUMMONER_4_0_OFFSET UNITYSDK_OFFSET(0x1744BC50)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntitySummonTagFilter_TypeDefinitionIndex = 64246;
