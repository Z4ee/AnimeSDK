...
#define MOLEMOLE_CONFIG_DROPITEMTRAIT_BUILDENTITY_OFFSET UNITYSDK_OFFSET(0x1B7FC9A0)
#define MOLEMOLE_CONFIG_DROPITEMTRAIT_CLONE_OFFSET UNITYSDK_OFFSET(0x1B7FBA80)
#define MOLEMOLE_CONFIG_DROPITEMTRAIT_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x1B7FBB80)
#define MOLEMOLE_CONFIG_DROPITEMTRAIT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x1B7FBA70)
#define MOLEMOLE_CONFIG_DROPITEMTRAIT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B7FC2D0)
#define MOLEMOLE_CONFIG_DROPITEMTRAIT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1B7FBE00)
#define MOLEMOLE_CONFIG_DROPITEMTRAIT_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B7FC830)
#define MOLEMOLE_CONFIG_DROPITEMTRAIT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x1B7FBB70)
#define MOLEMOLE_CONFIG_DROPITEMTRAIT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B7FC330)
#define MOLEMOLE_CONFIG_DROPITEMTRAIT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x1B7FBE80)
#define MOLEMOLE_CONFIG_DROPITEMTRAIT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B7FC6A0)
#define MOLEMOLE_CONFIG_DROPITEMTRAIT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x1B7FC190)
#define MOLEMOLE_CONFIG_DROPITEMTRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7FCF80)
#define MOLEMOLE_CONFIG_DROPITEMTRAIT___BASE_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x1B7FCF90)
#define MOLEMOLE_CONFIG_DROPITEMTRAIT___BASE_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B7FCFA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int DropItemTrait_TypeDefinitionIndex = 57922;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_198*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_DROPITEMTRAIT_EXPOSEMEMBER_OFFSET))(this, processor, prefix);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_BE29B49AC03370B6*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_DROPITEMTRAIT_GENERATECOMPONENT_OFFSET))(this, buildContext);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_198*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_DROPITEMTRAIT___BASE_EXPOSEMEMBER_OFFSET))(this, P0, P1);
		}

		::System::Boolean __base_GenerateComponent(::Class_1_BE29B49AC03370B6* P0)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_BE29B49AC03370B6*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_DROPITEMTRAIT___BASE_GENERATECOMPONENT_OFFSET))(this, P0);
		}
	};
}
