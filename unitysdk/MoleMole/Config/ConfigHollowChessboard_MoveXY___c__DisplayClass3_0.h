...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_MOVEXY___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7ED050)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_MOVEXY___C__DISPLAYCLASS3_0__RUN_B__0_OFFSET UNITYSDK_OFFSET(0x1B7ED060)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_MoveXY___c__DisplayClass3_0_TypeDefinitionIndex = 59240;

	class ConfigHollowChessboard_MoveXY___c__DisplayClass3_0 : public ::System::Object
	{
	public:
		::MoleMole::Config::ConfigHollowChessboard_MoveXY* __4__this; // 0x10
