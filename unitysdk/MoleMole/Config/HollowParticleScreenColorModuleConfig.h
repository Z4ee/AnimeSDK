...
#define MOLEMOLE_CONFIG_HOLLOWPARTICLESCREENCOLORMODULECONFIG_CREATEMODULE_OFFSET UNITYSDK_OFFSET(0x186C27A0)
#define MOLEMOLE_CONFIG_HOLLOWPARTICLESCREENCOLORMODULECONFIG_GETMODULEID_OFFSET UNITYSDK_OFFSET(0x186C2940)
#define MOLEMOLE_CONFIG_HOLLOWPARTICLESCREENCOLORMODULECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x186C2A10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HollowParticleScreenColorModuleConfig_TypeDefinitionIndex = 48110;
