...
#define MOLEMOLE_CONFIG_INDEXFILEREF_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x170C39D0)
#define MOLEMOLE_CONFIG_INDEXFILEREF_FROMFLX_OFFSET UNITYSDK_OFFSET(0x170C35F0)
#define MOLEMOLE_CONFIG_INDEXFILEREF_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x170C3C30)
#define MOLEMOLE_CONFIG_INDEXFILEREF_METHOD_1_5B0202969299569F_OFFSET UNITYSDK_OFFSET(0x170C3670)
#define MOLEMOLE_CONFIG_INDEXFILEREF_METHOD_1_FE68BBC7DCCBEB6D_OFFSET UNITYSDK_OFFSET(0x170C3A30)
#define MOLEMOLE_CONFIG_INDEXFILEREF_TOSTRING_OFFSET UNITYSDK_OFFSET(0x170C31A0)
#define MOLEMOLE_CONFIG_INDEXFILEREF__CTOR_OFFSET UNITYSDK_OFFSET(0x170C3C20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int IndexFileRef_TypeDefinitionIndex = 81451;
