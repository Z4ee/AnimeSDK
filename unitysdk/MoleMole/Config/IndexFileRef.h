...
#define MOLEMOLE_CONFIG_INDEXFILEREF_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1494B950)
#define MOLEMOLE_CONFIG_INDEXFILEREF_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1494B570)
#define MOLEMOLE_CONFIG_INDEXFILEREF_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x1494BBB0)
#define MOLEMOLE_CONFIG_INDEXFILEREF_METHOD_1_5B0202969299569F_OFFSET UNITYSDK_OFFSET(0x1494B5F0)
#define MOLEMOLE_CONFIG_INDEXFILEREF_METHOD_1_FE68BBC7DCCBEB6D_OFFSET UNITYSDK_OFFSET(0x1494B9B0)
#define MOLEMOLE_CONFIG_INDEXFILEREF_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1494B120)
#define MOLEMOLE_CONFIG_INDEXFILEREF__CTOR_OFFSET UNITYSDK_OFFSET(0x1494BBA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int IndexFileRef_TypeDefinitionIndex = 77573;
