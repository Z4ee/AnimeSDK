...
#define MOLEMOLE_CONFIG_PERCEPTIONTRAIT_BUILDENTITYCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1487B0A0)
#define MOLEMOLE_CONFIG_PERCEPTIONTRAIT_CLONE_OFFSET UNITYSDK_OFFSET(0x1487A620)
#define MOLEMOLE_CONFIG_PERCEPTIONTRAIT_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x1487A720)
#define MOLEMOLE_CONFIG_PERCEPTIONTRAIT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x1487A5D0)
#define MOLEMOLE_CONFIG_PERCEPTIONTRAIT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1487AC70)
#define MOLEMOLE_CONFIG_PERCEPTIONTRAIT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1487A8C0)
#define MOLEMOLE_CONFIG_PERCEPTIONTRAIT_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1487B050)
#define MOLEMOLE_CONFIG_PERCEPTIONTRAIT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x1487A710)
#define MOLEMOLE_CONFIG_PERCEPTIONTRAIT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1487ACD0)
#define MOLEMOLE_CONFIG_PERCEPTIONTRAIT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x1487A940)
#define MOLEMOLE_CONFIG_PERCEPTIONTRAIT_ONPOSTENTITYDISSOCIATE_OFFSET UNITYSDK_OFFSET(0x1487B520)
#define MOLEMOLE_CONFIG_PERCEPTIONTRAIT_ONPOSTENTITYREADY_OFFSET UNITYSDK_OFFSET(0x1487B130)
#define MOLEMOLE_CONFIG_PERCEPTIONTRAIT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1487AEC0)
#define MOLEMOLE_CONFIG_PERCEPTIONTRAIT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x1487AB30)
#define MOLEMOLE_CONFIG_PERCEPTIONTRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1487B7E0)
#define MOLEMOLE_CONFIG_PERCEPTIONTRAIT___BASE_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x1487B7F0)
#define MOLEMOLE_CONFIG_PERCEPTIONTRAIT___BASE_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1487B800)

namespace MoleMole::Config
{
	inline static constexpr unsigned int PerceptionTrait_TypeDefinitionIndex = 53702;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_198*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_PERCEPTIONTRAIT_EXPOSEMEMBER_OFFSET))(this, processor, prefix);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_BE29B49AC03370B6*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_PERCEPTIONTRAIT_GENERATECOMPONENT_OFFSET))(this, buildContext);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_198*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_PERCEPTIONTRAIT___BASE_EXPOSEMEMBER_OFFSET))(this, P0, P1);
		}

		::System::Boolean __base_GenerateComponent(::Class_1_BE29B49AC03370B6* P0)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_BE29B49AC03370B6*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_PERCEPTIONTRAIT___BASE_GENERATECOMPONENT_OFFSET))(this, P0);
		}
	};
}
