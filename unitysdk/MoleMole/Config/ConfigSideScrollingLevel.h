...
#define MOLEMOLE_CONFIG_CONFIGSIDESCROLLINGLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x16B3FD00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSideScrollingLevel_TypeDefinitionIndex = 70115;
