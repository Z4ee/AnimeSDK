...
#define MOLEMOLE_CONFIG_ANIMATOREVENT_GET_NEEDHANDLEBEFOREPHYSICS_OFFSET UNITYSDK_OFFSET(0x17286CB0)
#define MOLEMOLE_CONFIG_ANIMATOREVENT_GET_NEEDPRELOAD_OFFSET UNITYSDK_OFFSET(0x17286D00)
#define MOLEMOLE_CONFIG_ANIMATOREVENT_METHOD_1_0589B5E7626E6766_1_OFFSET UNITYSDK_OFFSET(0x17286F40)
#define MOLEMOLE_CONFIG_ANIMATOREVENT_METHOD_1_0589B5E7626E6766_OFFSET UNITYSDK_OFFSET(0x17286EB0)
#define MOLEMOLE_CONFIG_ANIMATOREVENT_METHOD_1_0DB0990807B30DBB_OFFSET UNITYSDK_OFFSET(0x17287CA0)
#define MOLEMOLE_CONFIG_ANIMATOREVENT_METHOD_1_13A81F491916B387_OFFSET UNITYSDK_OFFSET(0x17287070)
#define MOLEMOLE_CONFIG_ANIMATOREVENT_METHOD_1_64A7857BCFE98A49_OFFSET UNITYSDK_OFFSET(0x17287980)
#define MOLEMOLE_CONFIG_ANIMATOREVENT_METHOD_1_68551447D07390F7_OFFSET UNITYSDK_OFFSET(0x17287B70)
#define MOLEMOLE_CONFIG_ANIMATOREVENT_METHOD_1_CC205ACED071A76F_OFFSET UNITYSDK_OFFSET(0x17286E60)
#define MOLEMOLE_CONFIG_ANIMATOREVENT_METHOD_1_DE8FDF9C87F3AA65_OFFSET UNITYSDK_OFFSET(0x17287010)
#define MOLEMOLE_CONFIG_ANIMATOREVENT_METHOD_1_FB6392A8F30862C7_OFFSET UNITYSDK_OFFSET(0x17286FD0)
#define MOLEMOLE_CONFIG_ANIMATOREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x17286D50)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorEvent_TypeDefinitionIndex = 80120;
