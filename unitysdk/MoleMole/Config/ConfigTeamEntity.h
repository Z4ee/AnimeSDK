...
#define MOLEMOLE_CONFIG_CONFIGTEAMENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x174566D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTeamEntity_TypeDefinitionIndex = 57998;
