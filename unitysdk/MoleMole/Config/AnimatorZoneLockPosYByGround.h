...
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKPOSYBYGROUND_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x12EF4AD0)
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKPOSYBYGROUND_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x12EF45F0)
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKPOSYBYGROUND_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x12EF4360)
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKPOSYBYGROUND_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x12EF48D0)
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKPOSYBYGROUND__CTOR_OFFSET UNITYSDK_OFFSET(0x12EF4B60)
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKPOSYBYGROUND___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x12EF4B70)
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKPOSYBYGROUND___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x12EF4C40)
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKPOSYBYGROUND___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x12EF4D00)
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKPOSYBYGROUND___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x12EF4DB0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneLockPosYByGround_TypeDefinitionIndex = 73560;
