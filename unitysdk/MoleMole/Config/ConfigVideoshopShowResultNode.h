...
#define MOLEMOLE_CONFIG_CONFIGVIDEOSHOPSHOWRESULTNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x123182F0)
#define MOLEMOLE_CONFIG_CONFIGVIDEOSHOPSHOWRESULTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x12318360)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigVideoshopShowResultNode_TypeDefinitionIndex = 39480;
