...
#define MOLEMOLE_CONFIG_CONFIGDISPLAYCASE_CONFIGDISPLAYCASE_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x17D1F790)
#define MOLEMOLE_CONFIG_CONFIGDISPLAYCASE_CONFIGDISPLAYCASE_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x17D1F7A0)
#define MOLEMOLE_CONFIG_CONFIGDISPLAYCASE_CONFIGDISPLAYCASE_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x17D1FBB0)
#define MOLEMOLE_CONFIG_CONFIGDISPLAYCASE_CONFIGDISPLAYCASE_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x17D1FE60)
#define MOLEMOLE_CONFIG_CONFIGDISPLAYCASE_CONFIGDISPLAYCASE_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x17D1FE20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDisplayCase_ConfigDisplayCase_UnityGeneratedFormatter_TypeDefinitionIndex = 40773;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::Config::DisplayCase::DisplayBoundsCfgData>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigDisplayCase_ConfigDisplayCase_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x47690);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::MoleMole::Config::DisplayCase::DisplayColliderCfgData>*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigDisplayCase_ConfigDisplayCase_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x47698);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::MoleMole::DisplayCase::EDisplayItemSubType, ::MoleMole::Config::DisplayCase::DisplayManualCfg>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigDisplayCase_ConfigDisplayCase_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x476A0);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::Config::DisplayCase::DisplayCaseCfgData>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigDisplayCase_ConfigDisplayCase_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x476A8);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::Config::DisplayCase::DisplayManualCfg>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigDisplayCase_ConfigDisplayCase_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x476B0);
		}
