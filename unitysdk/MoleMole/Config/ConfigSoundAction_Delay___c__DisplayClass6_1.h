...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_DELAY___C__DISPLAYCLASS6_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1437F920)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_DELAY___C__DISPLAYCLASS6_1__EXECUTE_B__0_OFFSET UNITYSDK_OFFSET(0x1437F930)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_Delay___c__DisplayClass6_1_TypeDefinitionIndex = 75360;

	class ConfigSoundAction_Delay___c__DisplayClass6_1 : public ::System::Object
	{
	public:
		::MoleMole::Config::ConfigSoundAction_Delay___c__DisplayClass6_0* CS___8__locals1; // 0x10
