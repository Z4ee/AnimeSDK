...
#define MOLEMOLE_CONFIG_BEHAVIORBETWEENPLAYERANDTARGET_CHECK_OFFSET UNITYSDK_OFFSET(0x106C6360)
#define MOLEMOLE_CONFIG_BEHAVIORBETWEENPLAYERANDTARGET_FINISH_OFFSET UNITYSDK_OFFSET(0x106C6880)
#define MOLEMOLE_CONFIG_BEHAVIORBETWEENPLAYERANDTARGET_ONINTERACTINTERNAL_OFFSET UNITYSDK_OFFSET(0x106C5E60)
#define MOLEMOLE_CONFIG_BEHAVIORBETWEENPLAYERANDTARGET_ONSTOP_OFFSET UNITYSDK_OFFSET(0x106C6460)
#define MOLEMOLE_CONFIG_BEHAVIORBETWEENPLAYERANDTARGET_PLAYBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x106C5F00)
#define MOLEMOLE_CONFIG_BEHAVIORBETWEENPLAYERANDTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x106C68D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int BehaviorBetweenPlayerAndTarget_TypeDefinitionIndex = 63817;

	class BehaviorBetweenPlayerAndTarget : public ::MoleMole::Config::HollowInteractEffectImpBase
	{
	public:
		::System::String* TargetBehavior; // 0x20
		::System::Collections::Generic::List_1<::Struct_2_C87A89B4261FDC79>* handles; // 0x28
		::System::Collections::Generic::List_1<::Class_2_6D8377DB91A00B0F*>* workingDatas; // 0x30
