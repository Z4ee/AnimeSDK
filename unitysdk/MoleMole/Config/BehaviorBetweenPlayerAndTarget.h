...
#define MOLEMOLE_CONFIG_BEHAVIORBETWEENPLAYERANDTARGET_CHECK_OFFSET UNITYSDK_OFFSET(0x1A4A4910)
#define MOLEMOLE_CONFIG_BEHAVIORBETWEENPLAYERANDTARGET_FINISH_OFFSET UNITYSDK_OFFSET(0x1A4A4E50)
#define MOLEMOLE_CONFIG_BEHAVIORBETWEENPLAYERANDTARGET_ONINTERACTINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A4A4400)
#define MOLEMOLE_CONFIG_BEHAVIORBETWEENPLAYERANDTARGET_ONSTOP_OFFSET UNITYSDK_OFFSET(0x1A4A4A10)
#define MOLEMOLE_CONFIG_BEHAVIORBETWEENPLAYERANDTARGET_PLAYBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1A4A44A0)
#define MOLEMOLE_CONFIG_BEHAVIORBETWEENPLAYERANDTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4A4EA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int BehaviorBetweenPlayerAndTarget_TypeDefinitionIndex = 81641;

	class BehaviorBetweenPlayerAndTarget : public ::MoleMole::Config::HollowInteractEffectImpBase
	{
	public:
		::System::Collections::Generic::List_1<::Struct_2_C87A89B4261FDC79>* handles; // 0x20
		::System::String* PlayerBehavior; // 0x28
		::System::String* TargetBehavior; // 0x30
		::System::Collections::Generic::List_1<::Class_2_6D8377DB91A00B0F*>* workingDatas; // 0x38
