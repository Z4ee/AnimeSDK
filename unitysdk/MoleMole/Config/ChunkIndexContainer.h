...
#define MOLEMOLE_CONFIG_CHUNKINDEXCONTAINER_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17D495F0)
#define MOLEMOLE_CONFIG_CHUNKINDEXCONTAINER_FROMFLX_OFFSET UNITYSDK_OFFSET(0x17D49320)
#define MOLEMOLE_CONFIG_CHUNKINDEXCONTAINER_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x17D49830)
#define MOLEMOLE_CONFIG_CHUNKINDEXCONTAINER_METHOD_1_157E312840A3BD00_OFFSET UNITYSDK_OFFSET(0x17D49650)
#define MOLEMOLE_CONFIG_CHUNKINDEXCONTAINER_METHOD_1_39F8E53C91EAFE69_OFFSET UNITYSDK_OFFSET(0x17D49950)
#define MOLEMOLE_CONFIG_CHUNKINDEXCONTAINER_METHOD_1_5B0202969299569F_OFFSET UNITYSDK_OFFSET(0x17D493A0)
#define MOLEMOLE_CONFIG_CHUNKINDEXCONTAINER_METHOD_1_CA31659CE304C271_OFFSET UNITYSDK_OFFSET(0x17D49870)
#define MOLEMOLE_CONFIG_CHUNKINDEXCONTAINER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17D491D0)
#define MOLEMOLE_CONFIG_CHUNKINDEXCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x17D49820)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ChunkIndexContainer_TypeDefinitionIndex = 65151;
