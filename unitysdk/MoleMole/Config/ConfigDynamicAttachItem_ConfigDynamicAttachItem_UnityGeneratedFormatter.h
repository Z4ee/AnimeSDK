...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICATTACHITEM_CONFIGDYNAMICATTACHITEM_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x1A341EA0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICATTACHITEM_CONFIGDYNAMICATTACHITEM_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x1A341EB0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICATTACHITEM_CONFIGDYNAMICATTACHITEM_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x1A342090)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICATTACHITEM_CONFIGDYNAMICATTACHITEM_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A342230)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICATTACHITEM_CONFIGDYNAMICATTACHITEM_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3421F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicAttachItem_ConfigDynamicAttachItem_UnityGeneratedFormatter_TypeDefinitionIndex = 45440;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigDynamicAttachItem_ConfigDynamicAttachItem_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x4D4D0);
		}
