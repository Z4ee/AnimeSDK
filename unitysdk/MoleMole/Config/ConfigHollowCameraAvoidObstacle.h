...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCAMERAAVOIDOBSTACLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1929C840)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowCameraAvoidObstacle_TypeDefinitionIndex = 54916;
	...
	public:
		...
		::System::Boolean Obstacle; // 0x20
		::System::Boolean OnlyColliderCheck; // 0x21
