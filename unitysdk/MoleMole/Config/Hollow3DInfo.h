...
#define MOLEMOLE_CONFIG_HOLLOW3DINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C46D560)

namespace MoleMole::Config
{
	inline static constexpr unsigned int Hollow3DInfo_TypeDefinitionIndex = 45662;
