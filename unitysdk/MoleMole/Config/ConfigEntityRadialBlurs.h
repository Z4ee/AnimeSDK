...
#define MOLEMOLE_CONFIG_CONFIGENTITYRADIALBLURS__CTOR_OFFSET UNITYSDK_OFFSET(0x12B3B920)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityRadialBlurs_TypeDefinitionIndex = 58084;
