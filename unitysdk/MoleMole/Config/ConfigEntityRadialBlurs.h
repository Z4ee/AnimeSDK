...
#define MOLEMOLE_CONFIG_CONFIGENTITYRADIALBLURS__CTOR_OFFSET UNITYSDK_OFFSET(0x181C99F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityRadialBlurs_TypeDefinitionIndex = 41752;
