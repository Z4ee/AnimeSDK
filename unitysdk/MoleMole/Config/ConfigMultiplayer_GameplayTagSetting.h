...
#define MOLEMOLE_CONFIG_CONFIGMULTIPLAYER_GAMEPLAYTAGSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1437D2E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMultiplayer_GameplayTagSetting_TypeDefinitionIndex = 61662;
