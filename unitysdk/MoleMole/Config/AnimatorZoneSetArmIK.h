...
#define MOLEMOLE_CONFIG_ANIMATORZONESETARMIK_GETARMIK_OFFSET UNITYSDK_OFFSET(0x12A48310)
#define MOLEMOLE_CONFIG_ANIMATORZONESETARMIK_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x12A48110)
#define MOLEMOLE_CONFIG_ANIMATORZONESETARMIK_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x12A48270)
#define MOLEMOLE_CONFIG_ANIMATORZONESETARMIK_SETARMIKWEIGHT_OFFSET UNITYSDK_OFFSET(0x12A481A0)
#define MOLEMOLE_CONFIG_ANIMATORZONESETARMIK__CTOR_OFFSET UNITYSDK_OFFSET(0x12A48520)
#define MOLEMOLE_CONFIG_ANIMATORZONESETARMIK___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x12A48530)
#define MOLEMOLE_CONFIG_ANIMATORZONESETARMIK___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x12A485A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneSetArmIK_TypeDefinitionIndex = 63788;
