...
#define MOLEMOLE_CONFIG_ZIPLINE_OPTIONALMOVEDIRECTIONTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x170CFD70)

namespace MoleMole::Config::ZipLine
{
	inline static constexpr unsigned int OptionalMoveDirectionType_TypeDefinitionIndex = 65348;
