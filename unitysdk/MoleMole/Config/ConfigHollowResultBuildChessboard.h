...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWRESULTBUILDCHESSBOARD_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x1AA522B0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWRESULTBUILDCHESSBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA52320)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowResultBuildChessboard_TypeDefinitionIndex = 78788;
