...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWRESULTBUILDCHESSBOARD_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x11474DF0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWRESULTBUILDCHESSBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x11474E60)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowResultBuildChessboard_TypeDefinitionIndex = 88988;
