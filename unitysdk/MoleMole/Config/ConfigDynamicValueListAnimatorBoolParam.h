...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORBOOLPARAM_CLONE_OFFSET UNITYSDK_OFFSET(0x1625A710)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORBOOLPARAM_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x1625A6C0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORBOOLPARAM_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1625AC70)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORBOOLPARAM_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1625A820)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORBOOLPARAM_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x1625A810)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORBOOLPARAM_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1625ACD0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORBOOLPARAM_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x1625A8A0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORBOOLPARAM_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1625AE70)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORBOOLPARAM_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x1625AB10)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORBOOLPARAM_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0x1625A570)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORBOOLPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1625B020)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicValueListAnimatorBoolParam_TypeDefinitionIndex = 64085;
