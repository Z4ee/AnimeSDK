...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORBOOLPARAM_CLONE_OFFSET UNITYSDK_OFFSET(0x110271B0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORBOOLPARAM_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x11027160)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORBOOLPARAM_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x11027790)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORBOOLPARAM_FROMFLX_OFFSET UNITYSDK_OFFSET(0x11027320)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORBOOLPARAM_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x110272B0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORBOOLPARAM_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x110277F0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORBOOLPARAM_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x110273A0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORBOOLPARAM_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x11027990)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORBOOLPARAM_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x11027630)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORBOOLPARAM_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0x11027010)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORBOOLPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x11027B40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicValueListAnimatorBoolParam_TypeDefinitionIndex = 79862;
