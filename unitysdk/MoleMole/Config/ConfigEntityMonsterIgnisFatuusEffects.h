...
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x14861260)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityMonsterIgnisFatuusEffects_TypeDefinitionIndex = 73845;
