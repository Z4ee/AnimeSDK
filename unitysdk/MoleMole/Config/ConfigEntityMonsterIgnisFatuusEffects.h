...
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x19299F20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityMonsterIgnisFatuusEffects_TypeDefinitionIndex = 78321;
