...
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENSPACEREFLECTIONEFFECT_GETDEPTHBUFFERTHICKNESS_OFFSET UNITYSDK_OFFSET(0xFB03C90)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENSPACEREFLECTIONEFFECT_GETENABLED_OFFSET UNITYSDK_OFFSET(0xFB03B90)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENSPACEREFLECTIONEFFECT_GETINTENSITY_OFFSET UNITYSDK_OFFSET(0xFB03C10)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENSPACEREFLECTIONEFFECT_GETOVERRIDEGLOBALPLANARREFLECTIONCONFIG_OFFSET UNITYSDK_OFFSET(0xFB03E00)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENSPACEREFLECTIONEFFECT_GETPLANARREFLECTIONBLURAMOUNT_OFFSET UNITYSDK_OFFSET(0xFB03E80)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENSPACEREFLECTIONEFFECT_GETQUALITY_OFFSET UNITYSDK_OFFSET(0xFB03D90)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENSPACEREFLECTIONEFFECT_GETSCREENFADEDISTANCE_OFFSET UNITYSDK_OFFSET(0xFB03D10)
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENSPACEREFLECTIONEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xFB03F00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityScreenSpaceReflectionEffect_TypeDefinitionIndex = 73256;

	class ConfigEntityScreenSpaceReflectionEffect : public ::MoleMole::Config::ConfigEntityScreenEffectBase
	{
	public:
		::MoleMole::Config::ScreenEffectFloat* depthBufferThickness; // 0x40
		...
		::MoleMole::Config::ScreenEffectFloat* screenFadeDistance; // 0x68
		::MoleMole::Config::ScreenEffectFieldHandleType qualityHandleType; // 0x70
		::MoleMole::Config::ScreenEffectFieldHandleType overrideGlobalPlanarReflectionConfigHandleType; // 0x74
		::MoleMole::Config::ScreenEffectFieldHandleType screenFadeDistanceHandleType; // 0x78
		::MoleMole::Config::ScreenEffectFieldHandleType intensityHandleType; // 0x7C
		::UnityEngine::NAPRenderPipeline0::SsrQuality quality; // 0x80
		::MoleMole::Config::ScreenEffectFieldHandleType depthBufferThicknessHandleType; // 0x84
		::MoleMole::Config::ScreenEffectFieldHandleType planarReflectionBlurAmountHandleType; // 0x88
		::MoleMole::Config::ScreenEffectFieldHandleType enabledHandleType; // 0x8C
