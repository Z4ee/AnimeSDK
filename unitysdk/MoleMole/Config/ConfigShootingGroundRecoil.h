...
#define MOLEMOLE_CONFIG_CONFIGSHOOTINGGROUNDRECOIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7F6FF0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigShootingGroundRecoil_TypeDefinitionIndex = 73109;
