...
#define MOLEMOLE_CONFIG_ATTACKPATTERNBINDANIMATORSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x106C5E50)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AttackPatternBindAnimatorState_TypeDefinitionIndex = 58073;
	...
	public:
		...
		::System::Boolean MaxStartFrame; // 0x21
