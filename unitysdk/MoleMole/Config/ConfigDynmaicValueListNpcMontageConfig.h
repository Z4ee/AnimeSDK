...
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTNPCMONTAGECONFIG_CLONE_OFFSET UNITYSDK_OFFSET(0x134F9120)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTNPCMONTAGECONFIG_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x134F90D0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTNPCMONTAGECONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x134F95D0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTNPCMONTAGECONFIG_FROMFLX_OFFSET UNITYSDK_OFFSET(0x134F9230)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTNPCMONTAGECONFIG_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x134F9220)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTNPCMONTAGECONFIG_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x134F9630)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTNPCMONTAGECONFIG_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x134F92B0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTNPCMONTAGECONFIG_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x134F97E0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTNPCMONTAGECONFIG_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x134F9470)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTNPCMONTAGECONFIG_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0x134F8F80)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTNPCMONTAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x134F9990)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynmaicValueListNpcMontageConfig_TypeDefinitionIndex = 79775;
