...
#define MOLEMOLE_CONFIG_NPCACCESSORYVOCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A074CC0)
#define MOLEMOLE_CONFIG_NPCACCESSORYVOCONFIG_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1A074890)
#define MOLEMOLE_CONFIG_NPCACCESSORYVOCONFIG_METHOD_1_1A0B790695E07CE5_OFFSET UNITYSDK_OFFSET(0x1A074D20)
#define MOLEMOLE_CONFIG_NPCACCESSORYVOCONFIG_METHOD_1_DF413489329CBAF8_OFFSET UNITYSDK_OFFSET(0x1A074910)
#define MOLEMOLE_CONFIG_NPCACCESSORYVOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A074F10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int NpcAccessoryVoConfig_TypeDefinitionIndex = 80231;
