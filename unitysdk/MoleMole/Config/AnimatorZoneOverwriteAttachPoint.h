...
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERWRITEATTACHPOINT_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x13FFE5F0)
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERWRITEATTACHPOINT_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x13FFE790)
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERWRITEATTACHPOINT_TRYSETOVERWRITEATTACHPOINT_OFFSET UNITYSDK_OFFSET(0x13FFE680)
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERWRITEATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x13FFE830)
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERWRITEATTACHPOINT___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x13FFE870)
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERWRITEATTACHPOINT___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x13FFE920)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneOverwriteAttachPoint_TypeDefinitionIndex = 71909;
