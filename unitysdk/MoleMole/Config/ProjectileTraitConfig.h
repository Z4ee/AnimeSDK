...
#define MOLEMOLE_CONFIG_PROJECTILETRAITCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x7FFFE0)
#define MOLEMOLE_CONFIG_PROJECTILETRAITCONFIG_FROMFLX_OFFSET UNITYSDK_OFFSET(0x7FFF50)
#define MOLEMOLE_CONFIG_PROJECTILETRAITCONFIG_METHOD_2_03482897E56BA861_OFFSET UNITYSDK_OFFSET(0x800040)
#define MOLEMOLE_CONFIG_PROJECTILETRAITCONFIG_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x800050)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ProjectileTraitConfig_TypeDefinitionIndex = 82565;
