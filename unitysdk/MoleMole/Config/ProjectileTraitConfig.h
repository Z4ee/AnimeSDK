...
#define MOLEMOLE_CONFIG_PROJECTILETRAITCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x7D68C0)
#define MOLEMOLE_CONFIG_PROJECTILETRAITCONFIG_FROMFLX_OFFSET UNITYSDK_OFFSET(0x7D6830)
#define MOLEMOLE_CONFIG_PROJECTILETRAITCONFIG_METHOD_2_03482897E56BA861_OFFSET UNITYSDK_OFFSET(0x7D6950)
#define MOLEMOLE_CONFIG_PROJECTILETRAITCONFIG_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x7D6920)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ProjectileTraitConfig_TypeDefinitionIndex = 45768;
