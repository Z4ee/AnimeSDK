...
#define MOLEMOLE_CONFIG_CONFIGFLOORDSCRIPTSERVERDECOR_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x158A6870)
#define MOLEMOLE_CONFIG_CONFIGFLOORDSCRIPTSERVERDECOR_FROMFLX_OFFSET UNITYSDK_OFFSET(0x158A62C0)
#define MOLEMOLE_CONFIG_CONFIGFLOORDSCRIPTSERVERDECOR_METHOD_2_55E75AEF0A8C6926_OFFSET UNITYSDK_OFFSET(0x158A6DA0)
#define MOLEMOLE_CONFIG_CONFIGFLOORDSCRIPTSERVERDECOR_METHOD_2_5C90773220FA8136_OFFSET UNITYSDK_OFFSET(0x158A60E0)
#define MOLEMOLE_CONFIG_CONFIGFLOORDSCRIPTSERVERDECOR_METHOD_2_67CB24BB9ED7D9E0_OFFSET UNITYSDK_OFFSET(0x158A6C40)
#define MOLEMOLE_CONFIG_CONFIGFLOORDSCRIPTSERVERDECOR_METHOD_2_72BF6AD1701A5726_OFFSET UNITYSDK_OFFSET(0x158A68D0)
#define MOLEMOLE_CONFIG_CONFIGFLOORDSCRIPTSERVERDECOR_METHOD_2_7821D1D4DDDF7E01_OFFSET UNITYSDK_OFFSET(0x158A6340)
#define MOLEMOLE_CONFIG_CONFIGFLOORDSCRIPTSERVERDECOR_METHOD_2_81438D3AF9EEE8D8_OFFSET UNITYSDK_OFFSET(0x158A6150)
#define MOLEMOLE_CONFIG_CONFIGFLOORDSCRIPTSERVERDECOR_METHOD_2_C444D4C8B9D548AF_OFFSET UNITYSDK_OFFSET(0x158A6250)
#define MOLEMOLE_CONFIG_CONFIGFLOORDSCRIPTSERVERDECOR__CTOR_OFFSET UNITYSDK_OFFSET(0x158A6C30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigFloorDScriptServerDecor_TypeDefinitionIndex = 63824;
