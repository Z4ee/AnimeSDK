...
#define MOLEMOLE_CONFIG_EFFECTPATTERNINFOCONFIG_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x17D64D70)
#define MOLEMOLE_CONFIG_EFFECTPATTERNINFOCONFIG_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x17D64F50)
#define MOLEMOLE_CONFIG_EFFECTPATTERNINFOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17D65140)
#define MOLEMOLE_CONFIG_EFFECTPATTERNINFOCONFIG___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x17D652F0)
#define MOLEMOLE_CONFIG_EFFECTPATTERNINFOCONFIG___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x17D65300)

namespace MoleMole::Config
{
	inline static constexpr unsigned int EffectPatternInfoConfig_TypeDefinitionIndex = 78992;
