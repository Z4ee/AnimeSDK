...
#define MOLEMOLE_CONFIG_CONFIGFLOORSTREAMINGLAYERLOADDECOR_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x170484C0)
#define MOLEMOLE_CONFIG_CONFIGFLOORSTREAMINGLAYERLOADDECOR_FROMFLX_OFFSET UNITYSDK_OFFSET(0x17048230)
#define MOLEMOLE_CONFIG_CONFIGFLOORSTREAMINGLAYERLOADDECOR_METHOD_2_0AFE2382BF92DEC7_OFFSET UNITYSDK_OFFSET(0x17048520)
#define MOLEMOLE_CONFIG_CONFIGFLOORSTREAMINGLAYERLOADDECOR_METHOD_2_13C223CE1A73736D_OFFSET UNITYSDK_OFFSET(0x17048A00)
#define MOLEMOLE_CONFIG_CONFIGFLOORSTREAMINGLAYERLOADDECOR_METHOD_2_16902267D4DA4F5F_OFFSET UNITYSDK_OFFSET(0x17048710)
#define MOLEMOLE_CONFIG_CONFIGFLOORSTREAMINGLAYERLOADDECOR_METHOD_2_2C463ED601F44ECA_OFFSET UNITYSDK_OFFSET(0x17048970)
#define MOLEMOLE_CONFIG_CONFIGFLOORSTREAMINGLAYERLOADDECOR_METHOD_2_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0x170482B0)
#define MOLEMOLE_CONFIG_CONFIGFLOORSTREAMINGLAYERLOADDECOR_METHOD_2_81438D3AF9EEE8D8_OFFSET UNITYSDK_OFFSET(0x170480C0)
#define MOLEMOLE_CONFIG_CONFIGFLOORSTREAMINGLAYERLOADDECOR_METHOD_2_B73F62522113F21F_OFFSET UNITYSDK_OFFSET(0x17048070)
#define MOLEMOLE_CONFIG_CONFIGFLOORSTREAMINGLAYERLOADDECOR_METHOD_2_C444D4C8B9D548AF_OFFSET UNITYSDK_OFFSET(0x170481C0)
#define MOLEMOLE_CONFIG_CONFIGFLOORSTREAMINGLAYERLOADDECOR_METHOD_2_EF044302ED56B461_OFFSET UNITYSDK_OFFSET(0x170487C0)
#define MOLEMOLE_CONFIG_CONFIGFLOORSTREAMINGLAYERLOADDECOR__CTOR_OFFSET UNITYSDK_OFFSET(0x170487B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigFloorStreamingLayerLoadDecor_TypeDefinitionIndex = 76391;
