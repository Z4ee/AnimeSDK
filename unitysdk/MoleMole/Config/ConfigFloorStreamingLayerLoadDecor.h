...
#define MOLEMOLE_CONFIG_CONFIGFLOORSTREAMINGLAYERLOADDECOR_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B909980)
#define MOLEMOLE_CONFIG_CONFIGFLOORSTREAMINGLAYERLOADDECOR_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1B909710)
#define MOLEMOLE_CONFIG_CONFIGFLOORSTREAMINGLAYERLOADDECOR_METHOD_2_0AFE2382BF92DEC7_OFFSET UNITYSDK_OFFSET(0x1B9099E0)
#define MOLEMOLE_CONFIG_CONFIGFLOORSTREAMINGLAYERLOADDECOR_METHOD_2_13C223CE1A73736D_OFFSET UNITYSDK_OFFSET(0x1B909C80)
#define MOLEMOLE_CONFIG_CONFIGFLOORSTREAMINGLAYERLOADDECOR_METHOD_2_16902267D4DA4F5F_OFFSET UNITYSDK_OFFSET(0x1B909BD0)
#define MOLEMOLE_CONFIG_CONFIGFLOORSTREAMINGLAYERLOADDECOR_METHOD_2_2C463ED601F44ECA_OFFSET UNITYSDK_OFFSET(0x1B909F90)
#define MOLEMOLE_CONFIG_CONFIGFLOORSTREAMINGLAYERLOADDECOR_METHOD_2_5B0202969299569F_OFFSET UNITYSDK_OFFSET(0x1B909790)
#define MOLEMOLE_CONFIG_CONFIGFLOORSTREAMINGLAYERLOADDECOR_METHOD_2_81438D3AF9EEE8D8_OFFSET UNITYSDK_OFFSET(0x1B909600)
#define MOLEMOLE_CONFIG_CONFIGFLOORSTREAMINGLAYERLOADDECOR_METHOD_2_B73F62522113F21F_OFFSET UNITYSDK_OFFSET(0x1B9095B0)
#define MOLEMOLE_CONFIG_CONFIGFLOORSTREAMINGLAYERLOADDECOR_METHOD_2_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x1B909700)
#define MOLEMOLE_CONFIG_CONFIGFLOORSTREAMINGLAYERLOADDECOR_METHOD_2_EF044302ED56B461_OFFSET UNITYSDK_OFFSET(0x1B909DE0)
#define MOLEMOLE_CONFIG_CONFIGFLOORSTREAMINGLAYERLOADDECOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B909C70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigFloorStreamingLayerLoadDecor_TypeDefinitionIndex = 54901;
	...
	public:
		...
		{
			return ((::System::Int32(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGFLOORSTREAMINGLAYERLOADDECOR_METHOD_2_C74CF020AA42ED85_OFFSET))(this);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::FlexBuffers::FlxMap))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGFLOORSTREAMINGLAYERLOADDECOR_METHOD_2_5B0202969299569F_OFFSET))(this, a1);
		}
