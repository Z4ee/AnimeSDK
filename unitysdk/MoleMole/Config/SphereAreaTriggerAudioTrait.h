...
#define MOLEMOLE_CONFIG_SPHEREAREATRIGGERAUDIOTRAIT_CLONE_OFFSET UNITYSDK_OFFSET(0x1B4F2F20)
#define MOLEMOLE_CONFIG_SPHEREAREATRIGGERAUDIOTRAIT_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x1B4F3020)
#define MOLEMOLE_CONFIG_SPHEREAREATRIGGERAUDIOTRAIT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x1B4F2EB0)
#define MOLEMOLE_CONFIG_SPHEREAREATRIGGERAUDIOTRAIT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B4F4370)
#define MOLEMOLE_CONFIG_SPHEREAREATRIGGERAUDIOTRAIT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1B4F36F0)
#define MOLEMOLE_CONFIG_SPHEREAREATRIGGERAUDIOTRAIT_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B4F4A50)
#define MOLEMOLE_CONFIG_SPHEREAREATRIGGERAUDIOTRAIT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x1B4F3010)
#define MOLEMOLE_CONFIG_SPHEREAREATRIGGERAUDIOTRAIT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B4F43D0)
#define MOLEMOLE_CONFIG_SPHEREAREATRIGGERAUDIOTRAIT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x1B4F3770)
#define MOLEMOLE_CONFIG_SPHEREAREATRIGGERAUDIOTRAIT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B4F48C0)
#define MOLEMOLE_CONFIG_SPHEREAREATRIGGERAUDIOTRAIT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x1B4F4230)
#define MOLEMOLE_CONFIG_SPHEREAREATRIGGERAUDIOTRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4F4B50)
#define MOLEMOLE_CONFIG_SPHEREAREATRIGGERAUDIOTRAIT___BASE_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x1B4F4B70)
#define MOLEMOLE_CONFIG_SPHEREAREATRIGGERAUDIOTRAIT___BASE_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B4F4B80)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SphereAreaTriggerAudioTrait_TypeDefinitionIndex = 82487;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_198*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_SPHEREAREATRIGGERAUDIOTRAIT_EXPOSEMEMBER_OFFSET))(this, processor, prefix);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_BE29B49AC03370B6*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_SPHEREAREATRIGGERAUDIOTRAIT_GENERATECOMPONENT_OFFSET))(this, buildContext);
		}

		::System::Void __base_ExposeMember(::Class_0_16E4307DCC419505_198* P0, ::System::String* P1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_198*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_SPHEREAREATRIGGERAUDIOTRAIT___BASE_EXPOSEMEMBER_OFFSET))(this, P0, P1);
		}

		::System::Boolean __base_GenerateComponent(::Class_1_BE29B49AC03370B6* P0)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_BE29B49AC03370B6*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_SPHEREAREATRIGGERAUDIOTRAIT___BASE_GENERATECOMPONENT_OFFSET))(this, P0);
		}
	};
}
