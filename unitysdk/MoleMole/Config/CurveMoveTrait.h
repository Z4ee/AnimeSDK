...
#define MOLEMOLE_CONFIG_CURVEMOVETRAIT_CLONE_OFFSET UNITYSDK_OFFSET(0x1AA65B20)
#define MOLEMOLE_CONFIG_CURVEMOVETRAIT_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x1AA65C80)
#define MOLEMOLE_CONFIG_CURVEMOVETRAIT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x1AA65AA0)
#define MOLEMOLE_CONFIG_CURVEMOVETRAIT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AA66AF0)
#define MOLEMOLE_CONFIG_CURVEMOVETRAIT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1AA65E30)
#define MOLEMOLE_CONFIG_CURVEMOVETRAIT_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1AA67150)
#define MOLEMOLE_CONFIG_CURVEMOVETRAIT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x1AA65C10)
#define MOLEMOLE_CONFIG_CURVEMOVETRAIT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AA66B50)
#define MOLEMOLE_CONFIG_CURVEMOVETRAIT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x1AA65EB0)
#define MOLEMOLE_CONFIG_CURVEMOVETRAIT_ONPOSTENTITYREADY_OFFSET UNITYSDK_OFFSET(0x1AA67230)
#define MOLEMOLE_CONFIG_CURVEMOVETRAIT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AA66FB0)
#define MOLEMOLE_CONFIG_CURVEMOVETRAIT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x1AA669B0)
#define MOLEMOLE_CONFIG_CURVEMOVETRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA67590)
#define MOLEMOLE_CONFIG_CURVEMOVETRAIT___BASE_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x1AA675A0)
#define MOLEMOLE_CONFIG_CURVEMOVETRAIT___BASE_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1AA675B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int CurveMoveTrait_TypeDefinitionIndex = 83667;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_175*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CURVEMOVETRAIT_EXPOSEMEMBER_OFFSET))(this, processor, prefix);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_53842913455A8556*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CURVEMOVETRAIT_GENERATECOMPONENT_OFFSET))(this, buildContext);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_175*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CURVEMOVETRAIT___BASE_EXPOSEMEMBER_OFFSET))(this, P0, P1);
		}

		::System::Boolean __base_GenerateComponent(::Class_1_53842913455A8556* P0)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_53842913455A8556*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CURVEMOVETRAIT___BASE_GENERATECOMPONENT_OFFSET))(this, P0);
		}
	};
}
