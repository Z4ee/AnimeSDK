...
#define MOLEMOLE_CONFIG_BASEHOLLOWCAMERAPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16256FE0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int BaseHollowCameraPredicate_TypeDefinitionIndex = 77718;
