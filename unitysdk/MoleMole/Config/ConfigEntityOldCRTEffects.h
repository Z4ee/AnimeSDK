...
#define MOLEMOLE_CONFIG_CONFIGENTITYOLDCRTEFFECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x158A4AF0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityOldCRTEffects_TypeDefinitionIndex = 85712;
