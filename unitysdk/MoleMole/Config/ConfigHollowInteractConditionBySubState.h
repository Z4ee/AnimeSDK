...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWINTERACTCONDITIONBYSUBSTATE_CREATECONDITION_OFFSET UNITYSDK_OFFSET(0x1B7ED7C0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWINTERACTCONDITIONBYSUBSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7ED8A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowInteractConditionBySubState_TypeDefinitionIndex = 55412;
