...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWINTERACTCONDITIONBYSUBSTATE_CREATECONDITION_OFFSET UNITYSDK_OFFSET(0x12B3CA10)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWINTERACTCONDITIONBYSUBSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x12B3CAF0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowInteractConditionBySubState_TypeDefinitionIndex = 42508;
