...
#define MOLEMOLE_CONFIG_QUESTSHOWAREADATA_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x8821C0)
#define MOLEMOLE_CONFIG_QUESTSHOWAREADATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x882260)
#define MOLEMOLE_CONFIG_QUESTSHOWAREADATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x8821D0)
#define MOLEMOLE_CONFIG_QUESTSHOWAREADATA_METHOD_2_2A2B8F84DBD45997_OFFSET UNITYSDK_OFFSET(0x8822F0)
#define MOLEMOLE_CONFIG_QUESTSHOWAREADATA_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x8822C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int QuestShowAreaData_TypeDefinitionIndex = 70545;
	...
	struct alignas(8) QuestShowAreaData
	{
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_175*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_QUESTSHOWAREADATA_EXPOSEMEMBER_OFFSET))(this, a1, a2);
		}
