...
#define MOLEMOLE_CONFIG_GADGETPROGRESSUITRAIT_BUILDENTITYCOMPONENT_OFFSET UNITYSDK_OFFSET(0x157CB170)
#define MOLEMOLE_CONFIG_GADGETPROGRESSUITRAIT_CLONE_OFFSET UNITYSDK_OFFSET(0x144EE560)
#define MOLEMOLE_CONFIG_GADGETPROGRESSUITRAIT_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x144EE6C0)
#define MOLEMOLE_CONFIG_GADGETPROGRESSUITRAIT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x144EE4F0)
#define MOLEMOLE_CONFIG_GADGETPROGRESSUITRAIT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x157CACF0)
#define MOLEMOLE_CONFIG_GADGETPROGRESSUITRAIT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x144EE800)
#define MOLEMOLE_CONFIG_GADGETPROGRESSUITRAIT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x144EE650)
#define MOLEMOLE_CONFIG_GADGETPROGRESSUITRAIT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x157CAD50)
#define MOLEMOLE_CONFIG_GADGETPROGRESSUITRAIT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x144EE880)
#define MOLEMOLE_CONFIG_GADGETPROGRESSUITRAIT_ONPOSTENTITYREADY_OFFSET UNITYSDK_OFFSET(0x157CB200)
#define MOLEMOLE_CONFIG_GADGETPROGRESSUITRAIT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x157CAFD0)
#define MOLEMOLE_CONFIG_GADGETPROGRESSUITRAIT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x144EED80)
#define MOLEMOLE_CONFIG_GADGETPROGRESSUITRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x157CB250)
#define MOLEMOLE_CONFIG_GADGETPROGRESSUITRAIT___BASE_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x157CB260)

namespace MoleMole::Config
{
	inline static constexpr unsigned int GadgetProgressUITrait_TypeDefinitionIndex = 78997;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_175*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_GADGETPROGRESSUITRAIT_EXPOSEMEMBER_OFFSET))(this, processor, prefix);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_175*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_GADGETPROGRESSUITRAIT___BASE_EXPOSEMEMBER_OFFSET))(this, P0, P1);
		}
	};
}
