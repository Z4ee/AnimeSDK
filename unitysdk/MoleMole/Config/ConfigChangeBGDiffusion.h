...
#define MOLEMOLE_CONFIG_CONFIGCHANGEBGDIFFUSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1270F370)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChangeBGDiffusion_TypeDefinitionIndex = 55701;
