...
#define MOLEMOLE_CONFIG_HOLLOWNPCCONFIGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7FE190)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HollowNpcConfigData_TypeDefinitionIndex = 86635;
