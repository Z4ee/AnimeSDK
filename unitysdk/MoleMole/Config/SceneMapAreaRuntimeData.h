...
#define MOLEMOLE_CONFIG_SCENEMAPAREARUNTIMEDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x159FE360)
#define MOLEMOLE_CONFIG_SCENEMAPAREARUNTIMEDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x159FDDD0)
#define MOLEMOLE_CONFIG_SCENEMAPAREARUNTIMEDATA_METHOD_1_C68CB15A07D0E2EF_OFFSET UNITYSDK_OFFSET(0x159FE3C0)
#define MOLEMOLE_CONFIG_SCENEMAPAREARUNTIMEDATA_METHOD_1_DF413489329CBAF8_OFFSET UNITYSDK_OFFSET(0x159FDE50)
#define MOLEMOLE_CONFIG_SCENEMAPAREARUNTIMEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x159FE710)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SceneMapAreaRuntimeData_TypeDefinitionIndex = 64121;
