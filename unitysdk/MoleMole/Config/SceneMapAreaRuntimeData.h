...
#define MOLEMOLE_CONFIG_SCENEMAPAREARUNTIMEDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1272A820)
#define MOLEMOLE_CONFIG_SCENEMAPAREARUNTIMEDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1272A290)
#define MOLEMOLE_CONFIG_SCENEMAPAREARUNTIMEDATA_METHOD_1_C68CB15A07D0E2EF_OFFSET UNITYSDK_OFFSET(0x1272A880)
#define MOLEMOLE_CONFIG_SCENEMAPAREARUNTIMEDATA_METHOD_1_DF413489329CBAF8_OFFSET UNITYSDK_OFFSET(0x1272A310)
#define MOLEMOLE_CONFIG_SCENEMAPAREARUNTIMEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1272ABD0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SceneMapAreaRuntimeData_TypeDefinitionIndex = 73565;
