...
#define MOLEMOLE_CONFIG_ANIMATORZONELOOKIKINMAINCITY_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x11464370)
#define MOLEMOLE_CONFIG_ANIMATORZONELOOKIKINMAINCITY_ISVALIDENTITYTYPE_OFFSET UNITYSDK_OFFSET(0x11463540)
#define MOLEMOLE_CONFIG_ANIMATORZONELOOKIKINMAINCITY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x11463B60)
#define MOLEMOLE_CONFIG_ANIMATORZONELOOKIKINMAINCITY_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x11462FC0)
#define MOLEMOLE_CONFIG_ANIMATORZONELOOKIKINMAINCITY_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x11463A10)
#define MOLEMOLE_CONFIG_ANIMATORZONELOOKIKINMAINCITY_SETOVERRIDE_OFFSET UNITYSDK_OFFSET(0x114635A0)
#define MOLEMOLE_CONFIG_ANIMATORZONELOOKIKINMAINCITY_TRYGETNPCTARGETENTITY_OFFSET UNITYSDK_OFFSET(0x114641C0)
#define MOLEMOLE_CONFIG_ANIMATORZONELOOKIKINMAINCITY_TRYGETPLAYERTARGETENTITY_OFFSET UNITYSDK_OFFSET(0x11463EB0)
#define MOLEMOLE_CONFIG_ANIMATORZONELOOKIKINMAINCITY_TRYSETLOOKIK_OFFSET UNITYSDK_OFFSET(0x114637A0)
#define MOLEMOLE_CONFIG_ANIMATORZONELOOKIKINMAINCITY_TRYSETLOOKTARGET_OFFSET UNITYSDK_OFFSET(0x114642C0)
#define MOLEMOLE_CONFIG_ANIMATORZONELOOKIKINMAINCITY__CTOR_OFFSET UNITYSDK_OFFSET(0x11464400)
#define MOLEMOLE_CONFIG_ANIMATORZONELOOKIKINMAINCITY___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x11464410)
#define MOLEMOLE_CONFIG_ANIMATORZONELOOKIKINMAINCITY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x114644E0)
#define MOLEMOLE_CONFIG_ANIMATORZONELOOKIKINMAINCITY___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x114645A0)
#define MOLEMOLE_CONFIG_ANIMATORZONELOOKIKINMAINCITY___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x11464650)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneLookIKInMainCity_TypeDefinitionIndex = 69665;
	...
	public:
		...
		::System::Single overridePitchDown; // 0x58
		::System::Boolean enableOverrideAngle; // 0x5C
		::System::Boolean enableOverrideSpeed; // 0x5D
		::System::Single overrideYawRight; // 0x60
		::System::Single overridespeedOnLockingTarget; // 0x64
		::System::Single overridePitchUp; // 0x68
		::System::Single overridespeedOnGetTarget; // 0x6C
		::MoleMole::Config::Boolean Enable; // 0x70
		::System::Single overrideYawLeft; // 0x74
