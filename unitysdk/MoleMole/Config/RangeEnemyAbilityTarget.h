...
#define MOLEMOLE_CONFIG_RANGEENEMYABILITYTARGET_METHOD_2_C45B3D125C3112F9_OFFSET UNITYSDK_OFFSET(0x1920DA90)
#define MOLEMOLE_CONFIG_RANGEENEMYABILITYTARGET_METHOD_2_D1F6165D31C25D17_OFFSET UNITYSDK_OFFSET(0x1920CF40)
#define MOLEMOLE_CONFIG_RANGEENEMYABILITYTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1920DC00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int RangeEnemyAbilityTarget_TypeDefinitionIndex = 90020;
