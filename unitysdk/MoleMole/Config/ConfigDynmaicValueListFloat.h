...
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTFLOAT_CLONE_OFFSET UNITYSDK_OFFSET(0x144DB140)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTFLOAT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x144DB0F0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTFLOAT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x144DB690)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTFLOAT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x144DB2B0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTFLOAT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x144DB240)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTFLOAT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x144DB6F0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTFLOAT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x144DB330)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTFLOAT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x144DB950)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTFLOAT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x144DB530)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTFLOAT_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0x144DAFA0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x144DBB00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynmaicValueListFloat_TypeDefinitionIndex = 56301;
