...
#define MOLEMOLE_CONFIG_RUNTIMEPOLYGONBOUND_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x88EBD0)
#define MOLEMOLE_CONFIG_RUNTIMEPOLYGONBOUND_FROMFLX_OFFSET UNITYSDK_OFFSET(0x88EB40)
#define MOLEMOLE_CONFIG_RUNTIMEPOLYGONBOUND_METHOD_2_3338E25D676DBB67_OFFSET UNITYSDK_OFFSET(0x88ED30)
#define MOLEMOLE_CONFIG_RUNTIMEPOLYGONBOUND_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x88EC30)
#define MOLEMOLE_CONFIG_RUNTIMEPOLYGONBOUND_METHOD_2_5CC415752F05F246_OFFSET UNITYSDK_OFFSET(0x88ECD0)
#define MOLEMOLE_CONFIG_RUNTIMEPOLYGONBOUND_METHOD_2_674524A234498963_OFFSET UNITYSDK_OFFSET(0x88ECA0)
#define MOLEMOLE_CONFIG_RUNTIMEPOLYGONBOUND_METHOD_2_C1DAD850E2998E73_OFFSET UNITYSDK_OFFSET(0x88EC80)
#define MOLEMOLE_CONFIG_RUNTIMEPOLYGONBOUND_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x88ED00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int RuntimePolygonBound_TypeDefinitionIndex = 72195;
