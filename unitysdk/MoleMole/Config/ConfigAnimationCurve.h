...
#define MOLEMOLE_CONFIG_CONFIGANIMATIONCURVE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x737E80)
#define MOLEMOLE_CONFIG_CONFIGANIMATIONCURVE_FROMFLX_OFFSET UNITYSDK_OFFSET(0x737DF0)
#define MOLEMOLE_CONFIG_CONFIGANIMATIONCURVE_GET_CURVE_OFFSET UNITYSDK_OFFSET(0x737EE0)
#define MOLEMOLE_CONFIG_CONFIGANIMATIONCURVE_METHOD_2_ADFCC0DC85F98B9C_OFFSET UNITYSDK_OFFSET(0x737F20)
#define MOLEMOLE_CONFIG_CONFIGANIMATIONCURVE_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x737EF0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAnimationCurve_TypeDefinitionIndex = 62001;
