...
#define MOLEMOLE_CONFIG_CONFIGENABLEBLACKCURTAINNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x1241AFE0)
#define MOLEMOLE_CONFIG_CONFIGENABLEBLACKCURTAINNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1241B050)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEnableBlackCurtainNode_TypeDefinitionIndex = 60033;
