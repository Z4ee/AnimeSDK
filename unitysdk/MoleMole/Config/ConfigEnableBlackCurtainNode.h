...
#define MOLEMOLE_CONFIG_CONFIGENABLEBLACKCURTAINNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x1AA4EE80)
#define MOLEMOLE_CONFIG_CONFIGENABLEBLACKCURTAINNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA4EEF0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEnableBlackCurtainNode_TypeDefinitionIndex = 55463;
