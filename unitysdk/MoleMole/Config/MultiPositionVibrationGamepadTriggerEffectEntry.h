...
#define MOLEMOLE_CONFIG_MULTIPOSITIONVIBRATIONGAMEPADTRIGGEREFFECTENTRY_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x1B4EB280)
#define MOLEMOLE_CONFIG_MULTIPOSITIONVIBRATIONGAMEPADTRIGGEREFFECTENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4EB320)
#define MOLEMOLE_CONFIG_MULTIPOSITIONVIBRATIONGAMEPADTRIGGEREFFECTENTRY___BASE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x1B4EB330)

namespace MoleMole::Config
{
	inline static constexpr unsigned int MultiPositionVibrationGamepadTriggerEffectEntry_TypeDefinitionIndex = 74670;
