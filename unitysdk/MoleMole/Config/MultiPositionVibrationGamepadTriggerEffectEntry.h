...
#define MOLEMOLE_CONFIG_MULTIPOSITIONVIBRATIONGAMEPADTRIGGEREFFECTENTRY_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x170C56D0)
#define MOLEMOLE_CONFIG_MULTIPOSITIONVIBRATIONGAMEPADTRIGGEREFFECTENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x170C5770)
#define MOLEMOLE_CONFIG_MULTIPOSITIONVIBRATIONGAMEPADTRIGGEREFFECTENTRY___BASE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x170C5780)

namespace MoleMole::Config
{
	inline static constexpr unsigned int MultiPositionVibrationGamepadTriggerEffectEntry_TypeDefinitionIndex = 56180;
