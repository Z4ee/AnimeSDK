...
#define MOLEMOLE_CONFIG_TIMELINEABILITYTARGET_METHOD_2_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x115E9EC0)
#define MOLEMOLE_CONFIG_TIMELINEABILITYTARGET_METHOD_2_8A316FECF3911D9F_OFFSET UNITYSDK_OFFSET(0x115E9840)
#define MOLEMOLE_CONFIG_TIMELINEABILITYTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x115E9F20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int TimelineAbilityTarget_TypeDefinitionIndex = 41880;
