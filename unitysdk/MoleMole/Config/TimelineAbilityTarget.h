...
#define MOLEMOLE_CONFIG_TIMELINEABILITYTARGET_METHOD_2_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x19212230)
#define MOLEMOLE_CONFIG_TIMELINEABILITYTARGET_METHOD_2_8A316FECF3911D9F_OFFSET UNITYSDK_OFFSET(0x19211BA0)
#define MOLEMOLE_CONFIG_TIMELINEABILITYTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x19212290)

namespace MoleMole::Config
{
	inline static constexpr unsigned int TimelineAbilityTarget_TypeDefinitionIndex = 63258;
