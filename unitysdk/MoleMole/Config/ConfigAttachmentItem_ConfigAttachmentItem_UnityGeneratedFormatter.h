...
#define MOLEMOLE_CONFIG_CONFIGATTACHMENTITEM_CONFIGATTACHMENTITEM_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x162A64F0)
#define MOLEMOLE_CONFIG_CONFIGATTACHMENTITEM_CONFIGATTACHMENTITEM_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x162A6500)
#define MOLEMOLE_CONFIG_CONFIGATTACHMENTITEM_CONFIGATTACHMENTITEM_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x162A66E0)
#define MOLEMOLE_CONFIG_CONFIGATTACHMENTITEM_CONFIGATTACHMENTITEM_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x162A6880)
#define MOLEMOLE_CONFIG_CONFIGATTACHMENTITEM_CONFIGATTACHMENTITEM_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x162A6840)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAttachmentItem_ConfigAttachmentItem_UnityGeneratedFormatter_TypeDefinitionIndex = 67775;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigAttachmentItem_ConfigAttachmentItem_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x449F0);
		}
