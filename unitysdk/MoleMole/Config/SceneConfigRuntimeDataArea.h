...
#define MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATAAREA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x78ECB0)
#define MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATAAREA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x78EC20)
#define MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATAAREA_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x78ED10)
#define MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATAAREA_METHOD_2_507A61720F3CF5FF_OFFSET UNITYSDK_OFFSET(0x78ED70)
#define MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATAAREA_METHOD_2_674524A234498963_OFFSET UNITYSDK_OFFSET(0x78EDD0)
#define MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATAAREA_METHOD_2_C1DAD850E2998E73_OFFSET UNITYSDK_OFFSET(0x78ED80)
#define MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATAAREA_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x78EDA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SceneConfigRuntimeDataArea_TypeDefinitionIndex = 75976;
	...
	struct alignas(8) SceneConfigRuntimeDataArea
	{
		...
		::System::Collections::Generic::List_1<::MoleMole::Config::RuntimePolygonBound>* areas; // 0x30
		::System::Collections::Generic::List_1<::MoleMole::Config::RuntimePolygonBound>* areaExcluded; // 0x38
		::System::Collections::Generic::List_1<::MoleMole::Config::RuntimePolygonBound>* battleRegion; // 0x40
		...
		*/
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_236FD73ABC492E3F*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATAAREA_METHOD_2_507A61720F3CF5FF_OFFSET))(this, a1, a2);
		}
