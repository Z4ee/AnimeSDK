...
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERRIDEBEPERFECTSWITCHPOSROT_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x106C4B10)
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERRIDEBEPERFECTSWITCHPOSROT_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x106C50E0)
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERRIDEBEPERFECTSWITCHPOSROT__CTOR_OFFSET UNITYSDK_OFFSET(0x106C5340)
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERRIDEBEPERFECTSWITCHPOSROT___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x106C5450)
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERRIDEBEPERFECTSWITCHPOSROT___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x106C5500)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneOverrideBePerfectSwitchPosRot_TypeDefinitionIndex = 51099;
