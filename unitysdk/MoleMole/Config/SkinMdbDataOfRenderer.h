...
#define MOLEMOLE_CONFIG_SKINMDBDATAOFRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x115E8750)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SkinMdbDataOfRenderer_TypeDefinitionIndex = 48636;
