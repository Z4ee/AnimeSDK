...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GETANIMLISTVALUEDROPDOWN_OFFSET UNITYSDK_OFFSET(0x139A5010)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GETCHESSBOARDPATHZDELTA_OFFSET UNITYSDK_OFFSET(0x139A5100)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GETCHESSBOARDPATHZ_OFFSET UNITYSDK_OFFSET(0x139A5090)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GETCONVEYERBELTCAMERAMOVECURVE_OFFSET UNITYSDK_OFFSET(0x139A4E10)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GETPUSHDISTANCECAMERAMOVECURVE_OFFSET UNITYSDK_OFFSET(0x139A4D40)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GETSPRINGCAMERAMOVECURVE_OFFSET UNITYSDK_OFFSET(0x139A4EE0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GET_CORETVOVERLAYEFFS_OFFSET UNITYSDK_OFFSET(0x139A4A00)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GET_DEFAULTPATHLINKRES_OFFSET UNITYSDK_OFFSET(0x139A4FB0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GET_NORMALTVOVERLAYEFFS_OFFSET UNITYSDK_OFFSET(0x139A46F0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GET_TVSCC_OFFSET UNITYSDK_OFFSET(0x139A4D10)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_TESTFILTER_OFFSET UNITYSDK_OFFSET(0x139A52D0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x139A5520)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_TypeDefinitionIndex = 43408;
