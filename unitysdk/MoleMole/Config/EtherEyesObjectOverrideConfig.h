...
#define MOLEMOLE_CONFIG_ETHEREYESOBJECTOVERRIDECONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x640790)
#define MOLEMOLE_CONFIG_ETHEREYESOBJECTOVERRIDECONFIG_FROMFLX_OFFSET UNITYSDK_OFFSET(0x640700)
#define MOLEMOLE_CONFIG_ETHEREYESOBJECTOVERRIDECONFIG_METHOD_2_B3B892B7B0ACCBE5_OFFSET UNITYSDK_OFFSET(0x640820)
#define MOLEMOLE_CONFIG_ETHEREYESOBJECTOVERRIDECONFIG_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x6407F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int EtherEyesObjectOverrideConfig_TypeDefinitionIndex = 62220;
