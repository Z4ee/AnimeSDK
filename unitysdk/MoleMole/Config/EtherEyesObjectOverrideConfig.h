...
#define MOLEMOLE_CONFIG_ETHEREYESOBJECTOVERRIDECONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x8A9660)
#define MOLEMOLE_CONFIG_ETHEREYESOBJECTOVERRIDECONFIG_FROMFLX_OFFSET UNITYSDK_OFFSET(0x8A95D0)
#define MOLEMOLE_CONFIG_ETHEREYESOBJECTOVERRIDECONFIG_METHOD_2_B3B892B7B0ACCBE5_OFFSET UNITYSDK_OFFSET(0x8A96F0)
#define MOLEMOLE_CONFIG_ETHEREYESOBJECTOVERRIDECONFIG_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x8A96C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int EtherEyesObjectOverrideConfig_TypeDefinitionIndex = 61347;
