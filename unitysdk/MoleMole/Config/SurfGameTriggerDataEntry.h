...
#define MOLEMOLE_CONFIG_SURFGAMETRIGGERDATAENTRY_ISVALID_OFFSET UNITYSDK_OFFSET(0x802A30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SurfGameTriggerDataEntry_TypeDefinitionIndex = 64370;
