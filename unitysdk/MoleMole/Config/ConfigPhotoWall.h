...
#define MOLEMOLE_CONFIG_CONFIGPHOTOWALL__CTOR_OFFSET UNITYSDK_OFFSET(0x16B36160)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPhotoWall_TypeDefinitionIndex = 68118;
