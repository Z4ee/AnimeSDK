...
#define MOLEMOLE_CONFIG_ANIMATOREVENTWRITEAIPARAM_METHOD_2_0589B5E7626E6766_OFFSET UNITYSDK_OFFSET(0x106BAD80)
#define MOLEMOLE_CONFIG_ANIMATOREVENTWRITEAIPARAM_METHOD_2_128774387667156B_OFFSET UNITYSDK_OFFSET(0x106BACB0)
#define MOLEMOLE_CONFIG_ANIMATOREVENTWRITEAIPARAM_METHOD_2_2D02FB2CBE7A9A71_OFFSET UNITYSDK_OFFSET(0x106BAB40)
#define MOLEMOLE_CONFIG_ANIMATOREVENTWRITEAIPARAM_METHOD_2_A0646B40A733EA40_OFFSET UNITYSDK_OFFSET(0x106BAA10)
#define MOLEMOLE_CONFIG_ANIMATOREVENTWRITEAIPARAM_METHOD_2_DE8FDF9C87F3AA65_OFFSET UNITYSDK_OFFSET(0x106BAE60)
#define MOLEMOLE_CONFIG_ANIMATOREVENTWRITEAIPARAM_METHOD_2_E5E25A707659582A_OFFSET UNITYSDK_OFFSET(0x106BA620)
#define MOLEMOLE_CONFIG_ANIMATOREVENTWRITEAIPARAM_METHOD_2_FB6392A8F30862C7_OFFSET UNITYSDK_OFFSET(0x106BACF0)
#define MOLEMOLE_CONFIG_ANIMATOREVENTWRITEAIPARAM_TOSTRING_OFFSET UNITYSDK_OFFSET(0x106BA530)
#define MOLEMOLE_CONFIG_ANIMATOREVENTWRITEAIPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x106BACA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorEventWriteAIParam_TypeDefinitionIndex = 43900;
