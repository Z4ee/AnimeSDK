...
#define MOLEMOLE_CONFIG_ANIMATORZONELOOKIKINMAINCITY___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0xF970D80)
#define MOLEMOLE_CONFIG_ANIMATORZONELOOKIKINMAINCITY___C__DISPLAYCLASS13_0__ONZONEENTER_B__3_OFFSET UNITYSDK_OFFSET(0xF970D90)
#define MOLEMOLE_CONFIG_ANIMATORZONELOOKIKINMAINCITY___C__DISPLAYCLASS13_0__ONZONEENTER_B__4_OFFSET UNITYSDK_OFFSET(0xF970FF0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneLookIKInMainCity___c__DisplayClass13_0_TypeDefinitionIndex = 69983;
