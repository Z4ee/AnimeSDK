...
#define MOLEMOLE_CONFIG_CONFIGDUNGEONENDRULEDECOR_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AA4DBA0)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONENDRULEDECOR_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1AA4D770)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONENDRULEDECOR_METHOD_2_5C90773220FA8136_OFFSET UNITYSDK_OFFSET(0x1AA4D590)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONENDRULEDECOR_METHOD_2_5C9725213F2A79F5_OFFSET UNITYSDK_OFFSET(0x1AA4E140)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONENDRULEDECOR_METHOD_2_81438D3AF9EEE8D8_OFFSET UNITYSDK_OFFSET(0x1AA4D600)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONENDRULEDECOR_METHOD_2_AC7502C279CCBC25_OFFSET UNITYSDK_OFFSET(0x1AA4DFE0)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONENDRULEDECOR_METHOD_2_C444D4C8B9D548AF_OFFSET UNITYSDK_OFFSET(0x1AA4D700)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONENDRULEDECOR_METHOD_2_DF413489329CBAF8_OFFSET UNITYSDK_OFFSET(0x1AA4D7F0)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONENDRULEDECOR_METHOD_2_F1153A4377815E0F_OFFSET UNITYSDK_OFFSET(0x1AA4DC00)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONENDRULEDECOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA4DFD0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDungeonEndRuleDecor_TypeDefinitionIndex = 74276;
