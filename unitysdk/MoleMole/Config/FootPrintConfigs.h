...
#define MOLEMOLE_CONFIG_FOOTPRINTCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x14250FF0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int FootPrintConfigs_TypeDefinitionIndex = 60853;
