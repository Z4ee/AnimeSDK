...
#define MOLEMOLE_CONFIG_SCENEMAP3DVISUALCONFIG_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A4BE8D0)
#define MOLEMOLE_CONFIG_SCENEMAP3DVISUALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4BE910)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SceneMap3DVisualConfig_TypeDefinitionIndex = 65512;
