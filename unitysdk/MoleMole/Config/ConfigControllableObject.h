...
#define MOLEMOLE_CONFIG_CONFIGCONTROLLABLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x106CA660)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigControllableObject_TypeDefinitionIndex = 41437;
