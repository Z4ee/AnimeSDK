...
#define MOLEMOLE_CONFIG_HACKCHARGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A074010)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HackChargeConfig_TypeDefinitionIndex = 71903;
