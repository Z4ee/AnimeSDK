...
#define MOLEMOLE_CONFIG_ZKREWARDSTATEENTRY_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19BA3120)
#define MOLEMOLE_CONFIG_ZKREWARDSTATEENTRY_FROMFLX_OFFSET UNITYSDK_OFFSET(0x19BA2AC0)
#define MOLEMOLE_CONFIG_ZKREWARDSTATEENTRY_METHOD_1_213D736C0BF38CDB_OFFSET UNITYSDK_OFFSET(0x19BA3180)
#define MOLEMOLE_CONFIG_ZKREWARDSTATEENTRY_METHOD_1_DF413489329CBAF8_OFFSET UNITYSDK_OFFSET(0x19BA2B40)
#define MOLEMOLE_CONFIG_ZKREWARDSTATEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x19BA3550)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ZKRewardStateEntry_TypeDefinitionIndex = 51512;
