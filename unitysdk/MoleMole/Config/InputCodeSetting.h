...
#define MOLEMOLE_CONFIG_INPUTCODESETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF4FA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int InputCodeSetting_TypeDefinitionIndex = 87124;
