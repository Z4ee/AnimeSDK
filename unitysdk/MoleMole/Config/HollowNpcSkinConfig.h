...
#define MOLEMOLE_CONFIG_HOLLOWNPCSKINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x11033D10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HollowNpcSkinConfig_TypeDefinitionIndex = 64324;
