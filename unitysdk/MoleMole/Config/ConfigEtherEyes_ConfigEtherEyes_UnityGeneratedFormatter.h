...
#define MOLEMOLE_CONFIG_CONFIGETHEREYES_CONFIGETHEREYES_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x158A5930)
#define MOLEMOLE_CONFIG_CONFIGETHEREYES_CONFIGETHEREYES_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x158A5940)
#define MOLEMOLE_CONFIG_CONFIGETHEREYES_CONFIGETHEREYES_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x158A5D50)
#define MOLEMOLE_CONFIG_CONFIGETHEREYES_CONFIGETHEREYES_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x158A6000)
#define MOLEMOLE_CONFIG_CONFIGETHEREYES_CONFIGETHEREYES_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x158A5FC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEtherEyes_ConfigEtherEyes_UnityGeneratedFormatter_TypeDefinitionIndex = 60050;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::MoleMole::EtherEyesHintInfoType, ::System::String*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigEtherEyes_ConfigEtherEyes_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x33DE0);
		}
