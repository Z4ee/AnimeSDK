...
#define MOLEMOLE_CONFIG_FLOORSTREAMINGLAYERLOADENTRY_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16C57600)
#define MOLEMOLE_CONFIG_FLOORSTREAMINGLAYERLOADENTRY_FROMFLX_OFFSET UNITYSDK_OFFSET(0x16C57250)
#define MOLEMOLE_CONFIG_FLOORSTREAMINGLAYERLOADENTRY_METHOD_1_1A0B790695E07CE5_OFFSET UNITYSDK_OFFSET(0x16C57660)
#define MOLEMOLE_CONFIG_FLOORSTREAMINGLAYERLOADENTRY_METHOD_1_5B0202969299569F_OFFSET UNITYSDK_OFFSET(0x16C572D0)
#define MOLEMOLE_CONFIG_FLOORSTREAMINGLAYERLOADENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x16C57870)

namespace MoleMole::Config
{
	inline static constexpr unsigned int FloorStreamingLayerLoadEntry_TypeDefinitionIndex = 59200;
