...
#define MOLEMOLE_CONFIG_FLOORSTREAMINGLAYERLOADENTRY_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17E34C10)
#define MOLEMOLE_CONFIG_FLOORSTREAMINGLAYERLOADENTRY_FROMFLX_OFFSET UNITYSDK_OFFSET(0x162C0520)
#define MOLEMOLE_CONFIG_FLOORSTREAMINGLAYERLOADENTRY_METHOD_1_1A0B790695E07CE5_OFFSET UNITYSDK_OFFSET(0x17E34C70)
#define MOLEMOLE_CONFIG_FLOORSTREAMINGLAYERLOADENTRY_METHOD_1_5B0202969299569F_OFFSET UNITYSDK_OFFSET(0x17E34E90)
#define MOLEMOLE_CONFIG_FLOORSTREAMINGLAYERLOADENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x17E34E80)

namespace MoleMole::Config
{
	inline static constexpr unsigned int FloorStreamingLayerLoadEntry_TypeDefinitionIndex = 84025;
