...
#define MOLEMOLE_CONFIG_CONFIGENTITYTIMESLOW_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x139A2C40)
#define MOLEMOLE_CONFIG_CONFIGENTITYTIMESLOW_METHOD_2_5323F2DF46A044DA_OFFSET UNITYSDK_OFFSET(0x139A2CB0)
#define MOLEMOLE_CONFIG_CONFIGENTITYTIMESLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x139A2C90)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityTimeSlow_TypeDefinitionIndex = 41471;
