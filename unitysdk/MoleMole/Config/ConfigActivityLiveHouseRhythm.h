...
#define MOLEMOLE_CONFIG_CONFIGACTIVITYLIVEHOUSERHYTHM_CHECKEMOJIDATACHARACTERDATA_OFFSET UNITYSDK_OFFSET(0x12A4D6B0)
#define MOLEMOLE_CONFIG_CONFIGACTIVITYLIVEHOUSERHYTHM_CHECKEMOJIDATAEMOJITYPEDATA_OFFSET UNITYSDK_OFFSET(0x12A4D800)
#define MOLEMOLE_CONFIG_CONFIGACTIVITYLIVEHOUSERHYTHM_CHECKEMOJIDATAEMOJITYPEPATHCOUNT_OFFSET UNITYSDK_OFFSET(0x12A4DAB0)
#define MOLEMOLE_CONFIG_CONFIGACTIVITYLIVEHOUSERHYTHM__CTOR_OFFSET UNITYSDK_OFFSET(0x12A4DD70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigActivityLiveHouseRhythm_TypeDefinitionIndex = 73434;
