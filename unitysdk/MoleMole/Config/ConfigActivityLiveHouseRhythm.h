...
#define MOLEMOLE_CONFIG_CONFIGACTIVITYLIVEHOUSERHYTHM_CHECKEMOJIDATACHARACTERDATA_OFFSET UNITYSDK_OFFSET(0x12B32F00)
#define MOLEMOLE_CONFIG_CONFIGACTIVITYLIVEHOUSERHYTHM_CHECKEMOJIDATAEMOJITYPEDATA_OFFSET UNITYSDK_OFFSET(0x12B33050)
#define MOLEMOLE_CONFIG_CONFIGACTIVITYLIVEHOUSERHYTHM_CHECKEMOJIDATAEMOJITYPEPATHCOUNT_OFFSET UNITYSDK_OFFSET(0x12B33300)
#define MOLEMOLE_CONFIG_CONFIGACTIVITYLIVEHOUSERHYTHM__CTOR_OFFSET UNITYSDK_OFFSET(0x12B335C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigActivityLiveHouseRhythm_TypeDefinitionIndex = 68820;
