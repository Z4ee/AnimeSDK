...
#define MOLEMOLE_CONFIG_DEVICEPERFORMANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x12432270)

namespace MoleMole::Config
{
	inline static constexpr unsigned int DevicePerformanceConfig_TypeDefinitionIndex = 77405;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::PerformanceSettingProfile*>* PerformanceSettingProfileDict; // 0x28
