...
#define MOLEMOLE_CONFIG_CHANGEFGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x10CF9830)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ChangeFGItem_TypeDefinitionIndex = 53935;
