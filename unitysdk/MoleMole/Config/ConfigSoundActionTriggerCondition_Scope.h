...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_SCOPE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x10D0B770)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_SCOPE_GET_INSPECTORLABEL_OFFSET UNITYSDK_OFFSET(0x10D0B730)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_SCOPE__CTOR_OFFSET UNITYSDK_OFFSET(0x10D0B990)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundActionTriggerCondition_Scope_TypeDefinitionIndex = 81773;
