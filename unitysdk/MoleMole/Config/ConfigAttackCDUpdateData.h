...
#define MOLEMOLE_CONFIG_CONFIGATTACKCDUPDATEDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x12B33F40)
#define MOLEMOLE_CONFIG_CONFIGATTACKCDUPDATEDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x12B33B80)
#define MOLEMOLE_CONFIG_CONFIGATTACKCDUPDATEDATA_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0x12B33C00)
#define MOLEMOLE_CONFIG_CONFIGATTACKCDUPDATEDATA_METHOD_1_9144040ECD391705_OFFSET UNITYSDK_OFFSET(0x12B33FA0)
#define MOLEMOLE_CONFIG_CONFIGATTACKCDUPDATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x12B34140)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAttackCDUpdateData_TypeDefinitionIndex = 65110;
