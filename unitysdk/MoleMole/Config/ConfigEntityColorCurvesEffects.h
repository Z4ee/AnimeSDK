...
#define MOLEMOLE_CONFIG_CONFIGENTITYCOLORCURVESEFFECTS__CTOR_OFFSET UNITYSDK_OFFSET(0xF97C8B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityColorCurvesEffects_TypeDefinitionIndex = 39417;
