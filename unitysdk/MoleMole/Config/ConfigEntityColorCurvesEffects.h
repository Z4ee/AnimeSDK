...
#define MOLEMOLE_CONFIG_CONFIGENTITYCOLORCURVESEFFECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x110A18A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityColorCurvesEffects_TypeDefinitionIndex = 39692;
