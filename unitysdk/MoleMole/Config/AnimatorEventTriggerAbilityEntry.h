...
#define MOLEMOLE_CONFIG_ANIMATOREVENTTRIGGERABILITYENTRY_CREATEANIMATIONEVENT_OFFSET UNITYSDK_OFFSET(0x177C3D70)
#define MOLEMOLE_CONFIG_ANIMATOREVENTTRIGGERABILITYENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x177C3DF0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorEventTriggerAbilityEntry_TypeDefinitionIndex = 64048;

	class AnimatorEventTriggerAbilityEntry : public ::MoleMole::Config::AnimatorEventEntry
	{
	public:
		::System::String* AbilityName; // 0x58
		::System::Collections::Generic::List_1<::MoleMole::Config::AnimatorEventTriggerAbilityEntry_AbilitySpecialValueEntry*>* InitAbilitySpecialList; // 0x60
