...
#define MOLEMOLE_CONFIG_CONFIGCHAOSBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x12418B60)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChaosBuff_TypeDefinitionIndex = 53069;
