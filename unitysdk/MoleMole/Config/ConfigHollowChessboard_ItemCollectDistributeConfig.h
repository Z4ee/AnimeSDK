...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_ITEMCOLLECTDISTRIBUTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x11471F10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_ItemCollectDistributeConfig_TypeDefinitionIndex = 59285;
