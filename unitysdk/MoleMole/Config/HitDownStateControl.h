...
#define MOLEMOLE_CONFIG_HITDOWNSTATECONTROL_CLONE_OFFSET UNITYSDK_OFFSET(0x14251B20)
#define MOLEMOLE_CONFIG_HITDOWNSTATECONTROL_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x14251B10)
#define MOLEMOLE_CONFIG_HITDOWNSTATECONTROL_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x14251E20)
#define MOLEMOLE_CONFIG_HITDOWNSTATECONTROL_FROMFLX_OFFSET UNITYSDK_OFFSET(0x14251C90)
#define MOLEMOLE_CONFIG_HITDOWNSTATECONTROL_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x14251C20)
#define MOLEMOLE_CONFIG_HITDOWNSTATECONTROL_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x14251E30)
#define MOLEMOLE_CONFIG_HITDOWNSTATECONTROL_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x14251CF0)
#define MOLEMOLE_CONFIG_HITDOWNSTATECONTROL_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x14251E40)
#define MOLEMOLE_CONFIG_HITDOWNSTATECONTROL_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x14251D00)
#define MOLEMOLE_CONFIG_HITDOWNSTATECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x14251FA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HitDownStateControl_TypeDefinitionIndex = 48988;
