...
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSACTIVE_OFFSET UNITYSDK_OFFSET(0x17046160)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSBLURPOW2_OFFSET UNITYSDK_OFFSET(0x170475E0)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSBLURPOW_OFFSET UNITYSDK_OFFSET(0x17046C70)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSCOLOR2_OFFSET UNITYSDK_OFFSET(0x17046D70)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSCOLORBLENDMODE_OFFSET UNITYSDK_OFFSET(0x17046320)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSCOLORDISTORTIONINTENSITY2_OFFSET UNITYSDK_OFFSET(0x17047660)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSCOLORDISTORTIONINTENSITY_OFFSET UNITYSDK_OFFSET(0x17046CF0)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSCOLORTEXTURE2_OFFSET UNITYSDK_OFFSET(0x17047010)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSCOLORTEXTUREUVSCALE2_OFFSET UNITYSDK_OFFSET(0x17047080)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSCOLORTEXTUREUVSCALE_OFFSET UNITYSDK_OFFSET(0x17046710)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSCOLORTEXTUREUVSPEED2_OFFSET UNITYSDK_OFFSET(0x17047100)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSCOLORTEXTUREUVSPEED_OFFSET UNITYSDK_OFFSET(0x17046790)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSCOLORTEXTURE_OFFSET UNITYSDK_OFFSET(0x170466A0)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSCOLOR_OFFSET UNITYSDK_OFFSET(0x17046400)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSDEPTHMASKOFFSET_OFFSET UNITYSDK_OFFSET(0x170462B0)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSDISAPPEAREND_OFFSET UNITYSDK_OFFSET(0x17047860)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSDISAPPEARSTART_OFFSET UNITYSDK_OFFSET(0x170477E0)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSDISTORTIONINTENSITY2_OFFSET UNITYSDK_OFFSET(0x170474E0)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSDISTORTIONINTENSITY_OFFSET UNITYSDK_OFFSET(0x17046B70)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSDISTORTIONOFFSET2_OFFSET UNITYSDK_OFFSET(0x17047560)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSDISTORTIONOFFSET_OFFSET UNITYSDK_OFFSET(0x17046BF0)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSDOWNSAMPLE_OFFSET UNITYSDK_OFFSET(0x170461D0)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSFADEIN_OFFSET UNITYSDK_OFFSET(0x170478E0)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSFADEOUT_OFFSET UNITYSDK_OFFSET(0x17047960)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSNOISETEXTURE2_OFFSET UNITYSDK_OFFSET(0x17047370)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSNOISETEXTUREUVSCALE2_OFFSET UNITYSDK_OFFSET(0x170473E0)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSNOISETEXTUREUVSCALE_OFFSET UNITYSDK_OFFSET(0x17046A70)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSNOISETEXTUREUVSPEED2_OFFSET UNITYSDK_OFFSET(0x17047460)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSNOISETEXTUREUVSPEED_OFFSET UNITYSDK_OFFSET(0x17046AF0)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSNOISETEXTURE_OFFSET UNITYSDK_OFFSET(0x17046A00)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSSELFMASK_OFFSET UNITYSDK_OFFSET(0x17046240)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSSOFTEDGEPOW_OFFSET UNITYSDK_OFFSET(0x170476E0)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETCHARACTERIGNISFATUUSSOFTEDGERANGE_OFFSET UNITYSDK_OFFSET(0x17047760)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GETUSEIGNISFATUUSCOLORTEXTUREALPHA_OFFSET UNITYSDK_OFFSET(0x17046390)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GET_CHARACTERIGNISFATUUSCOLORTEXTURE2_OFFSET UNITYSDK_OFFSET(0x17046E10)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GET_CHARACTERIGNISFATUUSCOLORTEXTURE_OFFSET UNITYSDK_OFFSET(0x170464A0)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GET_CHARACTERIGNISFATUUSNOISETEXTURE2_OFFSET UNITYSDK_OFFSET(0x17047180)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT_GET_CHARACTERIGNISFATUUSNOISETEXTURE_OFFSET UNITYSDK_OFFSET(0x17046810)
#define MOLEMOLE_CONFIG_CONFIGENTITYCHARACTERIGNISFATUUSEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x170479E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityCharacterIgnisFatuusEffect_TypeDefinitionIndex = 39551;

	class ConfigEntityCharacterIgnisFatuusEffect : public ::MoleMole::Config::ConfigEntityScreenEffectBase
	{
	public:
		::MoleMole::Config::ScreenEffectFloat* characterIgnisFatuusDistortionIntensity; // 0x40
		::UnityEngine::Texture2D* _characterIgnisFatuusNoiseTexture; // 0x48
		::MoleMole::Config::ScreenEffectFloat* characterIgnisFatuusSoftEdgePow; // 0x50
		::UnityEngine::Texture2D* _characterIgnisFatuusNoiseTexture2; // 0x58
		::MoleMole::Config::ScreenEffectFloat* characterIgnisFatuusDistortionOffset; // 0x60
		::MoleMole::Config::ScreenEffectFloat* characterIgnisFatuusDisappearEnd; // 0x68
		::MoleMole::Config::ScreenEffectVector2* characterIgnisFatuusNoiseTextureUVScale2; // 0x70
		::MoleMole::Config::ScreenEffectVector2* characterIgnisFatuusColorTextureUVScale2; // 0x78
		::MoleMole::Config::ScreenEffectFloat* characterIgnisFatuusColorDistortionIntensity2; // 0x80
		::UnityEngine::Texture2D* _characterIgnisFatuusColorTexture; // 0x88
		::System::String* characterIgnisFatuusNoiseTexturePath; // 0x90
		::MoleMole::Config::ScreenEffectFloat* characterIgnisFatuusColorDistortionIntensity; // 0x98
		::MoleMole::Config::ScreenEffectFloat* characterIgnisFatuusSoftEdgeRange; // 0xA0
		::MoleMole::Config::ScreenEffectFloat* characterIgnisFatuusBlurPow; // 0xA8
		::MoleMole::Config::ScreenEffectVector2* characterIgnisFatuusNoiseTextureUVScale; // 0xB0
		::MoleMole::Config::ScreenEffectColor* characterIgnisFatuusColor2; // 0xB8
		::MoleMole::Config::ScreenEffectFloat* characterIgnisFatuusDistortionIntensity2; // 0xC0
		::MoleMole::Config::ScreenEffectVector2* characterIgnisFatuusNoiseTextureUVSpeed2; // 0xC8
		::MoleMole::Config::ScreenEffectFloat* characterIgnisFatuusBlurPow2; // 0xD0
		::MoleMole::Config::ScreenEffectFloat* characterIgnisFatuusFadeIn; // 0xD8
		::MoleMole::Config::ScreenEffectFloat* characterIgnisFatuusDisappearStart; // 0xE0
		::MoleMole::Config::ScreenEffectVector2* characterIgnisFatuusColorTextureUVSpeed; // 0xE8
		::MoleMole::Config::ScreenEffectVector2* characterIgnisFatuusColorTextureUVScale; // 0xF0
		::System::String* characterIgnisFatuusColorTexturePath; // 0xF8
		::UnityEngine::Texture2D* _characterIgnisFatuusColorTexture2; // 0x100
		::MoleMole::Config::ScreenEffectVector2* characterIgnisFatuusColorTextureUVSpeed2; // 0x108
		::System::String* characterIgnisFatuusColorTexture2Path; // 0x110
		::MoleMole::Config::ScreenEffectFloat* characterIgnisFatuusDistortionOffset2; // 0x118
		::MoleMole::Config::ScreenEffectColor* characterIgnisFatuusColor; // 0x120
		::MoleMole::Config::ScreenEffectVector2* characterIgnisFatuusNoiseTextureUVSpeed; // 0x128
		::MoleMole::Config::ScreenEffectFloat* characterIgnisFatuusFadeOut; // 0x130
		::System::String* characterIgnisFatuusNoiseTexture2Path; // 0x138
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusDownSampleHandleType; // 0x140
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusFadeOutHandleType; // 0x144
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusNoiseTextureHandleType; // 0x148
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusActiveHandleType; // 0x14C
		::MoleMole::Config::ScreenEffectFieldHandleType useIgnisFatuusColorTextureAlphaHandleType; // 0x150
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusColor2HandleType; // 0x154
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusDistortionOffsetHandleType; // 0x158
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusColorDistortionIntensity2HandleType; // 0x15C
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusDisappearStartHandleType; // 0x160
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusColorTextureHandleType; // 0x164
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusBlurPowHandleType; // 0x168
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusBlurPow2HandleType; // 0x16C
		::System::Single characterIgnisFatuusDepthMaskOffset; // 0x170
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusColorBlendModeHandleType; // 0x174
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusDisappearEndHandleType; // 0x178
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusDistortionOffset2HandleType; // 0x17C
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusColorTextureUVSpeedHandleType; // 0x180
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusSelfMaskHandleType; // 0x184
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusColorTextureUVScale2HandleType; // 0x188
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusNoiseTextureUVScale2HandleType; // 0x18C
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusColorTexture2HandleType; // 0x190
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusSoftEdgePowHandleType; // 0x194
		::System::Boolean characterIgnisFatuusActive; // 0x198
		::System::Boolean useIgnisFatuusColorTextureAlpha; // 0x199
		::System::Boolean characterIgnisFatuusSelfMask; // 0x19A
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusNoiseTextureUVSpeedHandleType; // 0x19C
		::System::Int32 characterIgnisFatuusDownSample; // 0x1A0
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusColorHandleType; // 0x1A4
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusColorDistortionIntensityHandleType; // 0x1A8
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusNoiseTextureUVScaleHandleType; // 0x1AC
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusFadeInHandleType; // 0x1B0
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusNoiseTextureUVSpeed2HandleType; // 0x1B4
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusDistortionIntensityHandleType; // 0x1B8
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusSoftEdgeRangeHandleType; // 0x1BC
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusDepthMaskOffsetHandleType; // 0x1C0
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusNoiseTexture2HandleType; // 0x1C4
		::UnityEngine::Rendering::Universal::BlendModes characterIgnisFatuusColorBlendMode; // 0x1C8
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusDistortionIntensity2HandleType; // 0x1CC
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusColorTextureUVSpeed2HandleType; // 0x1D0
		::MoleMole::Config::ScreenEffectFieldHandleType characterIgnisFatuusColorTextureUVScaleHandleType; // 0x1D4
