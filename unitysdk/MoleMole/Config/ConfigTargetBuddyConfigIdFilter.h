...
#define MOLEMOLE_CONFIG_CONFIGTARGETBUDDYCONFIGIDFILTER_COMPAREBUDDY_OFFSET UNITYSDK_OFFSET(0x17055470)
#define MOLEMOLE_CONFIG_CONFIGTARGETBUDDYCONFIGIDFILTER_VALUEPASS_OFFSET UNITYSDK_OFFSET(0x17055330)
#define MOLEMOLE_CONFIG_CONFIGTARGETBUDDYCONFIGIDFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x170555D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTargetBuddyConfigIdFilter_TypeDefinitionIndex = 65774;
