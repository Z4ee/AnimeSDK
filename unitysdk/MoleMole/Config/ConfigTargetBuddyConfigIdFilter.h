...
#define MOLEMOLE_CONFIG_CONFIGTARGETBUDDYCONFIGIDFILTER_COMPAREBUDDY_OFFSET UNITYSDK_OFFSET(0x1B9188B0)
#define MOLEMOLE_CONFIG_CONFIGTARGETBUDDYCONFIGIDFILTER_VALUEPASS_OFFSET UNITYSDK_OFFSET(0x1B918770)
#define MOLEMOLE_CONFIG_CONFIGTARGETBUDDYCONFIGIDFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B918A10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTargetBuddyConfigIdFilter_TypeDefinitionIndex = 76322;
