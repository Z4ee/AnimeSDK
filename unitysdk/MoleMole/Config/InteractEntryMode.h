...
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_CHECKACTIONCONTENT_OFFSET UNITYSDK_OFFSET(0x186C2B20)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_CHECKVALUECONTENT_OFFSET UNITYSDK_OFFSET(0x186C2B60)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_GETEFFINTERACTRANGE_OFFSET UNITYSDK_OFFSET(0x186C2AD0)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_GET_ACTIONLIST_OFFSET UNITYSDK_OFFSET(0x186C2A90)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_GET_ISSUPPORTREPEAT_OFFSET UNITYSDK_OFFSET(0x186C2FA0)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_GET_VALUELIST_OFFSET UNITYSDK_OFFSET(0x186C2AB0)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_INITACTIONLIST_OFFSET UNITYSDK_OFFSET(0x186C2BA0)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_INITVALUELIST_OFFSET UNITYSDK_OFFSET(0x186C2CB0)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_SETACTION_OFFSET UNITYSDK_OFFSET(0x186C2DC0)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x186C2EB0)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x186C2FB0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int InteractEntryMode_TypeDefinitionIndex = 40624;
