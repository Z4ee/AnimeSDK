...
#define MOLEMOLE_CONFIG_CONFIGDUNGEONDIFFICULTYDECOR_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17440110)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONDIFFICULTYDECOR_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1743FD60)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONDIFFICULTYDECOR_METHOD_2_1FAC9B543EF43496_OFFSET UNITYSDK_OFFSET(0x17440170)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONDIFFICULTYDECOR_METHOD_2_2C463ED601F44ECA_OFFSET UNITYSDK_OFFSET(0x17440710)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONDIFFICULTYDECOR_METHOD_2_7821D1D4DDDF7E01_OFFSET UNITYSDK_OFFSET(0x1743FDE0)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONDIFFICULTYDECOR_METHOD_2_81438D3AF9EEE8D8_OFFSET UNITYSDK_OFFSET(0x1743FBF0)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONDIFFICULTYDECOR_METHOD_2_A042C46DE73C3043_OFFSET UNITYSDK_OFFSET(0x1743FBE0)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONDIFFICULTYDECOR_METHOD_2_ADEB76DF2BBE9491_OFFSET UNITYSDK_OFFSET(0x17440560)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONDIFFICULTYDECOR_METHOD_2_C444D4C8B9D548AF_OFFSET UNITYSDK_OFFSET(0x1743FCF0)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONDIFFICULTYDECOR_METHOD_2_C69D596A06700576_OFFSET UNITYSDK_OFFSET(0x174404B0)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONDIFFICULTYDECOR_METHOD_2_F499484FDA6C2149_OFFSET UNITYSDK_OFFSET(0x174407A0)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONDIFFICULTYDECOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17440550)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDungeonDifficultyDecor_TypeDefinitionIndex = 41182;
