...
#define MOLEMOLE_CONFIG_DYNAMICENTITYMGRTRAIT_CLONE_OFFSET UNITYSDK_OFFSET(0x18ADB590)
#define MOLEMOLE_CONFIG_DYNAMICENTITYMGRTRAIT_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x18ADB6F0)
#define MOLEMOLE_CONFIG_DYNAMICENTITYMGRTRAIT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x18ADB540)
#define MOLEMOLE_CONFIG_DYNAMICENTITYMGRTRAIT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18ADBBB0)
#define MOLEMOLE_CONFIG_DYNAMICENTITYMGRTRAIT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x18ADB7D0)
#define MOLEMOLE_CONFIG_DYNAMICENTITYMGRTRAIT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x18ADB680)
#define MOLEMOLE_CONFIG_DYNAMICENTITYMGRTRAIT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x18ADBC10)
#define MOLEMOLE_CONFIG_DYNAMICENTITYMGRTRAIT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x18ADB850)
#define MOLEMOLE_CONFIG_DYNAMICENTITYMGRTRAIT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x18ADBEB0)
#define MOLEMOLE_CONFIG_DYNAMICENTITYMGRTRAIT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x18ADBA70)
#define MOLEMOLE_CONFIG_DYNAMICENTITYMGRTRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x18ADC050)
#define MOLEMOLE_CONFIG_DYNAMICENTITYMGRTRAIT___BASE_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x18ADC060)

namespace MoleMole::Config
{
	inline static constexpr unsigned int DynamicEntityMgrTrait_TypeDefinitionIndex = 67987;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_175*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_DYNAMICENTITYMGRTRAIT_EXPOSEMEMBER_OFFSET))(this, processor, prefix);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_175*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_DYNAMICENTITYMGRTRAIT___BASE_EXPOSEMEMBER_OFFSET))(this, P0, P1);
		}
	};
}
