...
#define MOLEMOLE_CONFIG_INDEXASSETREF_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x12319A70)
#define MOLEMOLE_CONFIG_INDEXASSETREF_FROMFLX_OFFSET UNITYSDK_OFFSET(0x123196B0)
#define MOLEMOLE_CONFIG_INDEXASSETREF_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x12319D40)
#define MOLEMOLE_CONFIG_INDEXASSETREF_METHOD_1_297EA0FD117460C4_OFFSET UNITYSDK_OFFSET(0x12319AD0)
#define MOLEMOLE_CONFIG_INDEXASSETREF_METHOD_1_3FA063706A9B5149_OFFSET UNITYSDK_OFFSET(0x122FB810)
#define MOLEMOLE_CONFIG_INDEXASSETREF_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0x12319730)
#define MOLEMOLE_CONFIG_INDEXASSETREF_METHOD_1_A8C27B239C77A1A6_OFFSET UNITYSDK_OFFSET(0x12319D80)
#define MOLEMOLE_CONFIG_INDEXASSETREF_TOSTRING_OFFSET UNITYSDK_OFFSET(0x12319370)
#define MOLEMOLE_CONFIG_INDEXASSETREF__CTOR_OFFSET UNITYSDK_OFFSET(0x12319D30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int IndexAssetRef_TypeDefinitionIndex = 64237;
	...
	public:
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::FlexBuffers::FlxMap))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_INDEXASSETREF_METHOD_1_4E5AC15A8307DCD8_OFFSET))(this, a1);
		}
