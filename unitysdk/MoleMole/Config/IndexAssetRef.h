...
#define MOLEMOLE_CONFIG_INDEXASSETREF_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17D6AE30)
#define MOLEMOLE_CONFIG_INDEXASSETREF_FROMFLX_OFFSET UNITYSDK_OFFSET(0x17D6AA70)
#define MOLEMOLE_CONFIG_INDEXASSETREF_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x17D6B100)
#define MOLEMOLE_CONFIG_INDEXASSETREF_METHOD_1_297EA0FD117460C4_OFFSET UNITYSDK_OFFSET(0x17D6AE90)
#define MOLEMOLE_CONFIG_INDEXASSETREF_METHOD_1_3FA063706A9B5149_OFFSET UNITYSDK_OFFSET(0x17D45900)
#define MOLEMOLE_CONFIG_INDEXASSETREF_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0x17D6AAF0)
#define MOLEMOLE_CONFIG_INDEXASSETREF_METHOD_1_A8C27B239C77A1A6_OFFSET UNITYSDK_OFFSET(0x17D6B140)
#define MOLEMOLE_CONFIG_INDEXASSETREF_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17D6A730)
#define MOLEMOLE_CONFIG_INDEXASSETREF__CTOR_OFFSET UNITYSDK_OFFSET(0x17D6B0F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int IndexAssetRef_TypeDefinitionIndex = 78083;
