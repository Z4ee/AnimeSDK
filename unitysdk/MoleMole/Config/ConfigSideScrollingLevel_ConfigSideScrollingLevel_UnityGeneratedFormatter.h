...
#define MOLEMOLE_CONFIG_CONFIGSIDESCROLLINGLEVEL_CONFIGSIDESCROLLINGLEVEL_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x1A06EBB0)
#define MOLEMOLE_CONFIG_CONFIGSIDESCROLLINGLEVEL_CONFIGSIDESCROLLINGLEVEL_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x1A06EBC0)
#define MOLEMOLE_CONFIG_CONFIGSIDESCROLLINGLEVEL_CONFIGSIDESCROLLINGLEVEL_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x1A06EF20)
#define MOLEMOLE_CONFIG_CONFIGSIDESCROLLINGLEVEL_CONFIGSIDESCROLLINGLEVEL_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A06F170)
#define MOLEMOLE_CONFIG_CONFIGSIDESCROLLINGLEVEL_CONFIGSIDESCROLLINGLEVEL_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A06F130)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSideScrollingLevel_ConfigSideScrollingLevel_UnityGeneratedFormatter_TypeDefinitionIndex = 71512;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::MoleMole::Battle::SideScrollingHeatKillMonsterType, ::System::Int32>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigSideScrollingLevel_ConfigSideScrollingLevel_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x49BA0);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::MoleMole::Battle::SideScrollingScoreGetType, ::System::Single>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigSideScrollingLevel_ConfigSideScrollingLevel_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x49BA8);
		}
		static ::Sirenix::Serialization::Serializer_1<::MoleMole::Config::ConfigPosRot*>** StaticGet_CachedSerializer1()
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::Config::ConfigPosRot*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigSideScrollingLevel_ConfigSideScrollingLevel_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x49BB0);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::Config::ConfigSideScrollingCamera*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigSideScrollingLevel_ConfigSideScrollingLevel_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x49BB8);
		}
