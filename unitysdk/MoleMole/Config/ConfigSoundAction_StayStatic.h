...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STAYSTATIC_EXECUTE_OFFSET UNITYSDK_OFFSET(0x172B1C30)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STAYSTATIC_GET_INSPECTORLABEL_OFFSET UNITYSDK_OFFSET(0x172B1BF0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STAYSTATIC_ISMATCH_OFFSET UNITYSDK_OFFSET(0x172B2320)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STAYSTATIC_WALK_OFFSET UNITYSDK_OFFSET(0x172B23A0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STAYSTATIC__CTOR_OFFSET UNITYSDK_OFFSET(0x172B2480)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STAYSTATIC___BASE_ISMATCH_OFFSET UNITYSDK_OFFSET(0x172B24C0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STAYSTATIC___BASE_WALK_OFFSET UNITYSDK_OFFSET(0x172B24D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_StayStatic_TypeDefinitionIndex = 80805;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_197*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STAYSTATIC_EXECUTE_OFFSET))(this, context);
		}
