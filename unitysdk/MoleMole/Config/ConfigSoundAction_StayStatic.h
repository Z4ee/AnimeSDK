...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STAYSTATIC_EXECUTE_OFFSET UNITYSDK_OFFSET(0x17D61D50)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STAYSTATIC_GET_INSPECTORLABEL_OFFSET UNITYSDK_OFFSET(0x17D61D10)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STAYSTATIC_ISMATCH_OFFSET UNITYSDK_OFFSET(0x17D62430)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STAYSTATIC_WALK_OFFSET UNITYSDK_OFFSET(0x17D624B0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STAYSTATIC__CTOR_OFFSET UNITYSDK_OFFSET(0x17D62590)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STAYSTATIC___BASE_ISMATCH_OFFSET UNITYSDK_OFFSET(0x17D625D0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STAYSTATIC___BASE_WALK_OFFSET UNITYSDK_OFFSET(0x17D625E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_StayStatic_TypeDefinitionIndex = 52082;
