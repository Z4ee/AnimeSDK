...
#define MOLEMOLE_CONFIG_CONFIGUIBASEFUNCTIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x162BDFE0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUIBaseFunctionNode_TypeDefinitionIndex = 59742;
