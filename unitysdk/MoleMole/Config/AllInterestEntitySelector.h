...
#define MOLEMOLE_CONFIG_ALLINTERESTENTITYSELECTOR_METHOD_2_1418E9B6808528A4_OFFSET UNITYSDK_OFFSET(0x106B9180)
#define MOLEMOLE_CONFIG_ALLINTERESTENTITYSELECTOR_METHOD_2_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x106B9280)
#define MOLEMOLE_CONFIG_ALLINTERESTENTITYSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x106B92C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AllInterestEntitySelector_TypeDefinitionIndex = 61442;
