...
#define MOLEMOLE_CONFIG_CONFIGTEAMINSPIREZONE__CTOR_OFFSET UNITYSDK_OFFSET(0x181D5D10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTeamInspireZone_TypeDefinitionIndex = 82010;
