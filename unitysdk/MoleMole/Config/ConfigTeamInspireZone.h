...
#define MOLEMOLE_CONFIG_CONFIGTEAMINSPIREZONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7FA6D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTeamInspireZone_TypeDefinitionIndex = 83588;
