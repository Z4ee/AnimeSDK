...
#define MOLEMOLE_CONFIG_ANIMATORZONECHARACTERATTACHMENTS_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x192810B0)
#define MOLEMOLE_CONFIG_ANIMATORZONECHARACTERATTACHMENTS_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x19280D40)
#define MOLEMOLE_CONFIG_ANIMATORZONECHARACTERATTACHMENTS_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x19280F50)
#define MOLEMOLE_CONFIG_ANIMATORZONECHARACTERATTACHMENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x19281140)
#define MOLEMOLE_CONFIG_ANIMATORZONECHARACTERATTACHMENTS___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x19281150)
#define MOLEMOLE_CONFIG_ANIMATORZONECHARACTERATTACHMENTS___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x19281220)
#define MOLEMOLE_CONFIG_ANIMATORZONECHARACTERATTACHMENTS___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x192812D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneCharacterAttachments_TypeDefinitionIndex = 56958;
