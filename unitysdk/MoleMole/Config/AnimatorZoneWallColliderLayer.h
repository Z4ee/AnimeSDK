...
#define MOLEMOLE_CONFIG_ANIMATORZONEWALLCOLLIDERLAYER_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A05E360)
#define MOLEMOLE_CONFIG_ANIMATORZONEWALLCOLLIDERLAYER_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x1A05DEB0)
#define MOLEMOLE_CONFIG_ANIMATORZONEWALLCOLLIDERLAYER_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x1A05E110)
#define MOLEMOLE_CONFIG_ANIMATORZONEWALLCOLLIDERLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A05E3F0)
#define MOLEMOLE_CONFIG_ANIMATORZONEWALLCOLLIDERLAYER___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A05E400)
#define MOLEMOLE_CONFIG_ANIMATORZONEWALLCOLLIDERLAYER___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x1A05E4D0)
#define MOLEMOLE_CONFIG_ANIMATORZONEWALLCOLLIDERLAYER___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x1A05E580)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneWallColliderLayer_TypeDefinitionIndex = 43551;
