...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_CALCULATEBACKGROUNDRECT_OFFSET UNITYSDK_OFFSET(0x14376830)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_CALCULATEFONTUVRECT_OFFSET UNITYSDK_OFFSET(0x14376410)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_CALCULATEICONUVRECT_OFFSET UNITYSDK_OFFSET(0x14376610)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_GET_BACKGROUNDRESOLUTION_OFFSET UNITYSDK_OFFSET(0x14376390)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_GET_BACKGROUNDTEXTUREPATH_OFFSET UNITYSDK_OFFSET(0x14376330)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_GET_FONTRESOLUTION_OFFSET UNITYSDK_OFFSET(0x14376370)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_GET_TEXTFONTTEXTUREPATH_OFFSET UNITYSDK_OFFSET(0x14376350)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_ONPARAMCHANGED_OFFSET UNITYSDK_OFFSET(0x143763B0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI__CTOR_OFFSET UNITYSDK_OFFSET(0x14376A10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboardScreenUI_TypeDefinitionIndex = 68579;
