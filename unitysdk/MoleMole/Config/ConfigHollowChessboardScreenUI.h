...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_CALCULATEBACKGROUNDRECT_OFFSET UNITYSDK_OFFSET(0x158A9860)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_CALCULATEFONTUVRECT_OFFSET UNITYSDK_OFFSET(0x158A93E0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_CALCULATEICONUVRECT_OFFSET UNITYSDK_OFFSET(0x158A9610)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_GET_BACKGROUNDRESOLUTION_OFFSET UNITYSDK_OFFSET(0x158A9360)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_GET_BACKGROUNDTEXTUREPATH_OFFSET UNITYSDK_OFFSET(0x158A9300)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_GET_FONTRESOLUTION_OFFSET UNITYSDK_OFFSET(0x158A9340)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_GET_TEXTFONTTEXTUREPATH_OFFSET UNITYSDK_OFFSET(0x158A9320)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_ONPARAMCHANGED_OFFSET UNITYSDK_OFFSET(0x158A9380)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI__CTOR_OFFSET UNITYSDK_OFFSET(0x158A9A70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboardScreenUI_TypeDefinitionIndex = 45767;
