...
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYMODIFIERKEYBELONGMAP_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x192A1990)
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYMODIFIERKEYBELONGMAP_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x192A1C60)
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYMODIFIERKEYBELONGMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x192A1F50)
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYMODIFIERKEYBELONGMAP___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x192A1FB0)
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYMODIFIERKEYBELONGMAP___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x192A1FC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMaterialPropertyModifierKeyBelongMap_TypeDefinitionIndex = 50450;
