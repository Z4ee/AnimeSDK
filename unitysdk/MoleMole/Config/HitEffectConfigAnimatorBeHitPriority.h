...
#define MOLEMOLE_CONFIG_HITEFFECTCONFIGANIMATORBEHITPRIORITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B562F80)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HitEffectConfigAnimatorBeHitPriority_TypeDefinitionIndex = 47922;
	...
	public:
		...
		::MoleMole::Config::AnimatorGroundHitType attackFrameGroundHitType; // 0x20
