...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_BRANCH_EXECUTE_OFFSET UNITYSDK_OFFSET(0x162BB300)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_BRANCH_GET_INSPECTORLABEL_OFFSET UNITYSDK_OFFSET(0x162BB220)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_BRANCH_GET_PARAMHINT_OFFSET UNITYSDK_OFFSET(0x162BB260)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_BRANCH_ISMATCH_OFFSET UNITYSDK_OFFSET(0x162BB660)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_BRANCH_WALK_OFFSET UNITYSDK_OFFSET(0x162BB850)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_BRANCH__CTOR_OFFSET UNITYSDK_OFFSET(0x162BBA70)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_BRANCH___BASE_GET_PARAMHINT_OFFSET UNITYSDK_OFFSET(0x162BBAB0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_BRANCH___BASE_ISMATCH_OFFSET UNITYSDK_OFFSET(0x162BBAC0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_BRANCH___BASE_WALK_OFFSET UNITYSDK_OFFSET(0x162BBAD0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_Branch_TypeDefinitionIndex = 62007;
	...
	public:
		...
		::System::String* _curScopeValue; // 0x30
