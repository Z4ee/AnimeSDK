...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUIATLAS_CONFIGHOLLOWCHESSBOARDSCREENUIATLAS_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x110A2AD0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUIATLAS_CONFIGHOLLOWCHESSBOARDSCREENUIATLAS_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x110A2AE0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUIATLAS_CONFIGHOLLOWCHESSBOARDSCREENUIATLAS_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x110A2CC0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUIATLAS_CONFIGHOLLOWCHESSBOARDSCREENUIATLAS_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x110A2E60)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUIATLAS_CONFIGHOLLOWCHESSBOARDSCREENUIATLAS_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x110A2E20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboardScreenUIAtlas_ConfigHollowChessboardScreenUIAtlas_UnityGeneratedFormatter_TypeDefinitionIndex = 75952;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::Config::ScreenUIAtlasRectData*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigHollowChessboardScreenUIAtlas_ConfigHollowChessboardScreenUIAtlas_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x48380);
		}
