...
#define MOLEMOLE_CONFIG_CONFIGWAITINLEVELPOPNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x17D2B8B0)
#define MOLEMOLE_CONFIG_CONFIGWAITINLEVELPOPNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x17D2B920)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigWaitInLevelPopNode_TypeDefinitionIndex = 56524;
