...
#define MOLEMOLE_CONFIG_ANIMATORZONEFOOTPRINT_BUILDEXTRAANIMATORZONEINFOS_OFFSET UNITYSDK_OFFSET(0x17032D30)
#define MOLEMOLE_CONFIG_ANIMATORZONEFOOTPRINT_FINDNEXTSEGMENTINDEX_OFFSET UNITYSDK_OFFSET(0x17033F80)
#define MOLEMOLE_CONFIG_ANIMATORZONEFOOTPRINT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x17033600)
#define MOLEMOLE_CONFIG_ANIMATORZONEFOOTPRINT_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x17033520)
#define MOLEMOLE_CONFIG_ANIMATORZONEFOOTPRINT_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x17033590)
#define MOLEMOLE_CONFIG_ANIMATORZONEFOOTPRINT__CTOR_OFFSET UNITYSDK_OFFSET(0x17034150)
#define MOLEMOLE_CONFIG_ANIMATORZONEFOOTPRINT___BASE_BUILDEXTRAANIMATORZONEINFOS_OFFSET UNITYSDK_OFFSET(0x17034260)
#define MOLEMOLE_CONFIG_ANIMATORZONEFOOTPRINT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x17034300)
#define MOLEMOLE_CONFIG_ANIMATORZONEFOOTPRINT___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x170343C0)
#define MOLEMOLE_CONFIG_ANIMATORZONEFOOTPRINT___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x17034470)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneFootPrint_TypeDefinitionIndex = 75810;
