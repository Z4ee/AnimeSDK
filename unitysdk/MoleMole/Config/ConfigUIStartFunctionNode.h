...
#define MOLEMOLE_CONFIG_CONFIGUISTARTFUNCTIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x18F3CE40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUIStartFunctionNode_TypeDefinitionIndex = 63082;
