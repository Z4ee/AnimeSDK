...
#define MOLEMOLE_CONFIG_CONFIGHITEFFECT_CONFIGHITEFFECT_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x1A3469E0)
#define MOLEMOLE_CONFIG_CONFIGHITEFFECT_CONFIGHITEFFECT_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x1A3469F0)
#define MOLEMOLE_CONFIG_CONFIGHITEFFECT_CONFIGHITEFFECT_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x1A347130)
#define MOLEMOLE_CONFIG_CONFIGHITEFFECT_CONFIGHITEFFECT_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A347590)
#define MOLEMOLE_CONFIG_CONFIGHITEFFECT_CONFIGHITEFFECT_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A347550)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHitEffect_ConfigHitEffect_UnityGeneratedFormatter_TypeDefinitionIndex = 59166;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::Config::AnimatorGroundHitType>**)Il2CppClass::FromTypeDefinitionIndex(ConfigHitEffect_ConfigHitEffect_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x4D4E0);
		}
		static ::Sirenix::Serialization::Serializer_1<::MoleMole::Config::AnimatorAirHitType>** StaticGet_CachedSerializer2()
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::Config::AnimatorAirHitType>**)Il2CppClass::FromTypeDefinitionIndex(ConfigHitEffect_ConfigHitEffect_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x4D4E8);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::String*>** StaticGet_CachedSerializer3()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigHitEffect_ConfigHitEffect_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x4D4F0);
		}
		static ::Sirenix::Serialization::Serializer_1<::MoleMole::Config::ConfigHitInhalationEffect*>** StaticGet_CachedSerializer4()
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::Config::ConfigHitInhalationEffect*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigHitEffect_ConfigHitEffect_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x4D4F8);
		}
		static ::Sirenix::Serialization::Serializer_1<::MoleMole::Config::AnimatorHitEffect>** StaticGet_CachedSerializer0()
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::Config::AnimatorHitEffect>**)Il2CppClass::FromTypeDefinitionIndex(ConfigHitEffect_ConfigHitEffect_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x4D500);
		}
