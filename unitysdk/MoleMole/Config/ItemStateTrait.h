...
#define MOLEMOLE_CONFIG_ITEMSTATETRAIT_CLONE_OFFSET UNITYSDK_OFFSET(0x170C45F0)
#define MOLEMOLE_CONFIG_ITEMSTATETRAIT_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x170C4750)
#define MOLEMOLE_CONFIG_ITEMSTATETRAIT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x170C45A0)
#define MOLEMOLE_CONFIG_ITEMSTATETRAIT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x170C4C90)
#define MOLEMOLE_CONFIG_ITEMSTATETRAIT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x170C4830)
#define MOLEMOLE_CONFIG_ITEMSTATETRAIT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x170C46E0)
#define MOLEMOLE_CONFIG_ITEMSTATETRAIT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x170C4CF0)
#define MOLEMOLE_CONFIG_ITEMSTATETRAIT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x170C48B0)
#define MOLEMOLE_CONFIG_ITEMSTATETRAIT_ONPOSTENTITYREADY_OFFSET UNITYSDK_OFFSET(0x170C5080)
#define MOLEMOLE_CONFIG_ITEMSTATETRAIT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x170C4EE0)
#define MOLEMOLE_CONFIG_ITEMSTATETRAIT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x170C4B50)
#define MOLEMOLE_CONFIG_ITEMSTATETRAIT_UPDATEITEMSTATE_OFFSET UNITYSDK_OFFSET(0x170C5340)
#define MOLEMOLE_CONFIG_ITEMSTATETRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x170C5680)
#define MOLEMOLE_CONFIG_ITEMSTATETRAIT___BASE_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x170C5690)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ItemStateTrait_TypeDefinitionIndex = 68757;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_175*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_ITEMSTATETRAIT_EXPOSEMEMBER_OFFSET))(this, processor, prefix);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_175*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_ITEMSTATETRAIT___BASE_EXPOSEMEMBER_OFFSET))(this, P0, P1);
		}
	};
}
