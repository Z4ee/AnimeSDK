...
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELABILITYDECOR_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17440D50)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELABILITYDECOR_FROMFLX_OFFSET UNITYSDK_OFFSET(0x17440AC0)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELABILITYDECOR_METHOD_2_05FE06546AE39B32_OFFSET UNITYSDK_OFFSET(0x174410F0)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELABILITYDECOR_METHOD_2_0AFE2382BF92DEC7_OFFSET UNITYSDK_OFFSET(0x17440DB0)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELABILITYDECOR_METHOD_2_2C463ED601F44ECA_OFFSET UNITYSDK_OFFSET(0x17441690)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELABILITYDECOR_METHOD_2_7821D1D4DDDF7E01_OFFSET UNITYSDK_OFFSET(0x17440B40)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELABILITYDECOR_METHOD_2_7B967A5F80D0340A_OFFSET UNITYSDK_OFFSET(0x17441530)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELABILITYDECOR_METHOD_2_81438D3AF9EEE8D8_OFFSET UNITYSDK_OFFSET(0x17440950)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELABILITYDECOR_METHOD_2_B73F62522113F21F_OFFSET UNITYSDK_OFFSET(0x17440900)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELABILITYDECOR_METHOD_2_C444D4C8B9D548AF_OFFSET UNITYSDK_OFFSET(0x17440A50)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELABILITYDECOR_METHOD_2_C69D596A06700576_OFFSET UNITYSDK_OFFSET(0x17441050)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELABILITYDECOR_METHOD_2_D2F055AB814A7D50_OFFSET UNITYSDK_OFFSET(0x17441380)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELABILITYDECOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17441370)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDungeonLevelAbilityDecor_TypeDefinitionIndex = 81786;
