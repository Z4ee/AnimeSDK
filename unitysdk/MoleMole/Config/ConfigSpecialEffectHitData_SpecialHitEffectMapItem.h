...
#define MOLEMOLE_CONFIG_CONFIGSPECIALEFFECTHITDATA_SPECIALHITEFFECTMAPITEM_MATCHANIMATORSTATE_OFFSET UNITYSDK_OFFSET(0x186BEBC0)
#define MOLEMOLE_CONFIG_CONFIGSPECIALEFFECTHITDATA_SPECIALHITEFFECTMAPITEM_MATCH_OFFSET UNITYSDK_OFFSET(0x186BEAF0)
#define MOLEMOLE_CONFIG_CONFIGSPECIALEFFECTHITDATA_SPECIALHITEFFECTMAPITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x186BEC10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSpecialEffectHitData_SpecialHitEffectMapItem_TypeDefinitionIndex = 65787;
	...
	public:
		...
		::MoleMole::Config::AnimatorGroundHitType specialHitGroundHitType; // 0x1C
		::MoleMole::Config::AnimatorHitEffect specialHitEffect; // 0x20
		::MoleMole::Config::AnimatorAirHitType attackFrameAirHitType; // 0x24
		::MoleMole::Config::AnimatorGroundHitType attackFrameGroundHitType; // 0x28
