...
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_CLONE_OFFSET UNITYSDK_OFFSET(0x1C45ED90)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x1C45ED20)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C45E890)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1C45EEA0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_GETENTITYPOSROTBYTARGET_OFFSET UNITYSDK_OFFSET(0x1C45D950)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x1C45EE90)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_GETLEVELPOINTPOSROT_OFFSET UNITYSDK_OFFSET(0x1C45C030)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_GETPOINTNAME_OFFSET UNITYSDK_OFFSET(0x1C45E770)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_GETTARGETENTITYPOSROT_OFFSET UNITYSDK_OFFSET(0x1C45BDE0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C45E8F0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x1C45EF20)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C45EB70)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x1C45F4E0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_PROCESSGETLEVELPOINT_OFFSET UNITYSDK_OFFSET(0x1C45DB80)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C45F640)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT___BASE_GETENTITYPOSROTBYTARGET_OFFSET UNITYSDK_OFFSET(0x1C45F650)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT___BASE_GETTARGETENTITYPOSROT_OFFSET UNITYSDK_OFFSET(0x1C45F750)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPosRotReferLevelPoint_TypeDefinitionIndex = 55692;
	...
	public:
		...
		::MoleMole::Config::DynamicString* LevelPointName; // 0x18
		::MoleMole::Config::LevelPointType BackupPointType; // 0x20
		::MoleMole::Config::LevelPointType LevelPointType; // 0x24
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Struct_2_FA5F50563E60AFBA, ::MoleMole::Config::ReferTargetCoordsOption, ::MoleMole::Config::ReferTargetCoordsOption, ::UnityEngine::Vector3&, ::UnityEngine::Quaternion&, ::UnityEngine::Transform*&, ::System::Boolean&, ::Struct_2_69EDF57FCDC7C5D3&, ::MoleMole::Battle::Entity*, ::MoleMole::Battle::Entity*, ::UnityEngine::Transform*, ::Class_2_14986121AA61AD99*, ::MoleMole::Config::DynamicString*, ::MoleMole::Config::DynamicString*, ::MoleMole::Config::DynamicString*, ::MoleMole::Config::DynamicString*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_GETLEVELPOINTPOSROT_OFFSET))(this, sourceEntity, coordsOption, backupCoordsOption, targetPos, targetRot, targetTrans, useDefault, targetCoods, caster, other, findTargetTransform, instancedAbility, relativeBaseSavePoint, relativeTargetSavePoint, backupRelativeBaseSavePoint, backupRelativeTargetSavePoint, forceUseBackUp);
		}

		::System::Boolean ProcessGetLevelPoint(::MoleMole::Battle::Entity* sourceEntity, ::Class_2_14986121AA61AD99* instancedAbility, ::System::Boolean forceBackup, ::System::Boolean& useDefault, ::UnityEngine::Vector3& pos, ::UnityEngine::Quaternion& rot)
		{
			return ((::System::Boolean(*)(::PVOID, ::MoleMole::Battle::Entity*, ::Class_2_14986121AA61AD99*, ::System::Boolean, ::System::Boolean&, ::UnityEngine::Vector3&, ::UnityEngine::Quaternion&))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_PROCESSGETLEVELPOINT_OFFSET))(this, sourceEntity, instancedAbility, forceBackup, useDefault, pos, rot);
		}

		::System::String* GetPointName(::Class_2_14986121AA61AD99* instancedAbility, ::MoleMole::Config::DynamicString* pointName)
		{
			return ((::System::String*(*)(::PVOID, ::Class_2_14986121AA61AD99*, ::MoleMole::Config::DynamicString*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_GETPOINTNAME_OFFSET))(this, instancedAbility, pointName);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Struct_2_FA5F50563E60AFBA, ::Struct_2_FA5F50563E60AFBA, ::MoleMole::Config::ReferTargetCoordsOption, ::UnityEngine::Vector3&, ::UnityEngine::Quaternion&, ::UnityEngine::Transform*&, ::Struct_2_69EDF57FCDC7C5D3&, ::System::Boolean, ::MoleMole::Battle::Entity*, ::MoleMole::Battle::Entity*, ::UnityEngine::Transform*, ::Class_2_14986121AA61AD99*, ::MoleMole::Config::DynamicString*, ::MoleMole::Config::DynamicString*, ::System::Boolean, ::Struct_2_FC595D1A561D8C6F_1))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT___BASE_GETENTITYPOSROTBYTARGET_OFFSET))(this, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Struct_2_FA5F50563E60AFBA, ::MoleMole::Config::ReferTargetCoordsOption, ::MoleMole::Config::ReferTargetCoordsOption, ::UnityEngine::Vector3&, ::UnityEngine::Quaternion&, ::Struct_2_FA5F50563E60AFBA&, ::UnityEngine::Transform*&, ::Struct_2_69EDF57FCDC7C5D3&, ::System::Boolean&, ::MoleMole::Battle::Entity*, ::MoleMole::Battle::Entity*, ::Class_2_14986121AA61AD99*, ::MoleMole::Config::DynamicString*, ::MoleMole::Config::DynamicString*, ::MoleMole::Config::DynamicString*, ::MoleMole::Config::DynamicString*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT___BASE_GETTARGETENTITYPOSROT_OFFSET))(this, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16);
		}
	};
}
