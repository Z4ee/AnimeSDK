...
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_CLONE_OFFSET UNITYSDK_OFFSET(0x12429650)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x124295E0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x12429150)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x124297C0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_GETENTITYPOSROTBYTARGET_OFFSET UNITYSDK_OFFSET(0x12428210)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x12429750)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_GETLEVELPOINTPOSROT_OFFSET UNITYSDK_OFFSET(0x124268A0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_GETPOINTNAME_OFFSET UNITYSDK_OFFSET(0x12429030)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_GETTARGETENTITYPOSROT_OFFSET UNITYSDK_OFFSET(0x12426650)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x124291B0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x12429840)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x12429430)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x12429E30)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT_PROCESSGETLEVELPOINT_OFFSET UNITYSDK_OFFSET(0x12428440)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x12429F90)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT___BASE_GETENTITYPOSROTBYTARGET_OFFSET UNITYSDK_OFFSET(0x12429FA0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTREFERLEVELPOINT___BASE_GETTARGETENTITYPOSROT_OFFSET UNITYSDK_OFFSET(0x1242A0A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPosRotReferLevelPoint_TypeDefinitionIndex = 38170;
