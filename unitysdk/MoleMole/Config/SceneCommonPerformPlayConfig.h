...
#define MOLEMOLE_CONFIG_SCENECOMMONPERFORMPLAYCONFIG_MOLEMOLE_CONFIG_ISCENEPERFORMCONFIG_GET_FLOWCANVASDELAYTIME_OFFSET UNITYSDK_OFFSET(0x1A076880)
#define MOLEMOLE_CONFIG_SCENECOMMONPERFORMPLAYCONFIG_MOLEMOLE_CONFIG_ISCENEPERFORMCONFIG_GET_INPUTMUTEDELAYTIME_OFFSET UNITYSDK_OFFSET(0x1A076840)
#define MOLEMOLE_CONFIG_SCENECOMMONPERFORMPLAYCONFIG_MOLEMOLE_CONFIG_ISCENEPERFORMCONFIG_GET_SHOWUIDELAYTIME_OFFSET UNITYSDK_OFFSET(0x1A0768C0)
#define MOLEMOLE_CONFIG_SCENECOMMONPERFORMPLAYCONFIG_MOLEMOLE_CONFIG_ISCENEPERFORMCONFIG_SETUP_OFFSET UNITYSDK_OFFSET(0x1A076900)
#define MOLEMOLE_CONFIG_SCENECOMMONPERFORMPLAYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A076ED0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SceneCommonPerformPlayConfig_TypeDefinitionIndex = 74525;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_463*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_SCENECOMMONPERFORMPLAYCONFIG_MOLEMOLE_CONFIG_ISCENEPERFORMCONFIG_SETUP_OFFSET))(this, node);
		}
	};
}
