...
#define MOLEMOLE_CONFIG_SCENECOMMONPERFORMPLAYCONFIG_MOLEMOLE_CONFIG_ISCENEPERFORMCONFIG_GET_FLOWCANVASDELAYTIME_OFFSET UNITYSDK_OFFSET(0x17D2FFD0)
#define MOLEMOLE_CONFIG_SCENECOMMONPERFORMPLAYCONFIG_MOLEMOLE_CONFIG_ISCENEPERFORMCONFIG_GET_INPUTMUTEDELAYTIME_OFFSET UNITYSDK_OFFSET(0x17D2FF90)
#define MOLEMOLE_CONFIG_SCENECOMMONPERFORMPLAYCONFIG_MOLEMOLE_CONFIG_ISCENEPERFORMCONFIG_GET_SHOWUIDELAYTIME_OFFSET UNITYSDK_OFFSET(0x17D30010)
#define MOLEMOLE_CONFIG_SCENECOMMONPERFORMPLAYCONFIG_MOLEMOLE_CONFIG_ISCENEPERFORMCONFIG_SETUP_OFFSET UNITYSDK_OFFSET(0x17D30050)
#define MOLEMOLE_CONFIG_SCENECOMMONPERFORMPLAYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17D30610)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SceneCommonPerformPlayConfig_TypeDefinitionIndex = 61671;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_227*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_SCENECOMMONPERFORMPLAYCONFIG_MOLEMOLE_CONFIG_ISCENEPERFORMCONFIG_SETUP_OFFSET))(this, node);
		}
	};
}
