...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_FLASH___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0x175364F0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_FLASH___C__DISPLAYCLASS3_0__RUN_B__0_OFFSET UNITYSDK_OFFSET(0x17536710)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_Flash___c__DisplayClass3_0_TypeDefinitionIndex = 43448;
