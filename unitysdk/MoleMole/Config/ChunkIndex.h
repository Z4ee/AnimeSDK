...
#define MOLEMOLE_CONFIG_CHUNKINDEX_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x12A4D3B0)
#define MOLEMOLE_CONFIG_CHUNKINDEX_FROMFLX_OFFSET UNITYSDK_OFFSET(0x12A4D000)
#define MOLEMOLE_CONFIG_CHUNKINDEX_METHOD_1_0CB3D614A4DB34A1_OFFSET UNITYSDK_OFFSET(0x12A4D080)
#define MOLEMOLE_CONFIG_CHUNKINDEX_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x12A4D650)
#define MOLEMOLE_CONFIG_CHUNKINDEX_METHOD_1_8F38D1E0FC0C448C_OFFSET UNITYSDK_OFFSET(0x12A4D410)
#define MOLEMOLE_CONFIG_CHUNKINDEX_TOSTRING_OFFSET UNITYSDK_OFFSET(0x12A4CC20)
#define MOLEMOLE_CONFIG_CHUNKINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x12A4D640)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ChunkIndex_TypeDefinitionIndex = 90195;
