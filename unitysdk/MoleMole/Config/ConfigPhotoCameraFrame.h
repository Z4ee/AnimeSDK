...
#define MOLEMOLE_CONFIG_CONFIGPHOTOCAMERAFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1A352510)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPhotoCameraFrame_TypeDefinitionIndex = 73021;
