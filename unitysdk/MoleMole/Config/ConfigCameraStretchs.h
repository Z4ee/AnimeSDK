...
#define MOLEMOLE_CONFIG_CONFIGCAMERASTRETCHS__CTOR_OFFSET UNITYSDK_OFFSET(0x1589F100)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraStretchs_TypeDefinitionIndex = 42181;
