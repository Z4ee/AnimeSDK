...
#define MOLEMOLE_CONFIG_CONFIGCAMERASTRETCHS__CTOR_OFFSET UNITYSDK_OFFSET(0x16A86690)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraStretchs_TypeDefinitionIndex = 46423;
