...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SEQUENCE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1AA62130)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SEQUENCE_GET_INSPECTORLABEL_OFFSET UNITYSDK_OFFSET(0x1AA61FA0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SEQUENCE_GET_PARAMHINT_OFFSET UNITYSDK_OFFSET(0x1AA61FE0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SEQUENCE_ISMATCH_OFFSET UNITYSDK_OFFSET(0x1AA623A0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SEQUENCE_WALK_OFFSET UNITYSDK_OFFSET(0x1AA62500)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA626D0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SEQUENCE___BASE_GET_PARAMHINT_OFFSET UNITYSDK_OFFSET(0x1AA62710)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SEQUENCE___BASE_ISMATCH_OFFSET UNITYSDK_OFFSET(0x1AA62720)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SEQUENCE___BASE_WALK_OFFSET UNITYSDK_OFFSET(0x1AA62730)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_Sequence_TypeDefinitionIndex = 49651;
