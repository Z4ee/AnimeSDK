...
#define MOLEMOLE_CONFIG_CONFIGMAINSTORYPUSHCENTERTAPENODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x17D24B60)
#define MOLEMOLE_CONFIG_CONFIGMAINSTORYPUSHCENTERTAPENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x17D24BD0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMainStoryPushCenterTapeNode_TypeDefinitionIndex = 81209;
