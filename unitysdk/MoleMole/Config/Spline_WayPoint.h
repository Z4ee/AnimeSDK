...
#define MOLEMOLE_CONFIG_SPLINE_WAYPOINT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x79E160)
#define MOLEMOLE_CONFIG_SPLINE_WAYPOINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x79E0C0)
#define MOLEMOLE_CONFIG_SPLINE_WAYPOINT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x79E2D0)
#define MOLEMOLE_CONFIG_SPLINE_WAYPOINT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x79E240)
#define MOLEMOLE_CONFIG_SPLINE_WAYPOINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x79E170)
#define MOLEMOLE_CONFIG_SPLINE_WAYPOINT_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x153D3E10)
#define MOLEMOLE_CONFIG_SPLINE_WAYPOINT_METHOD_2_217BB3FC4AC50D8F_OFFSET UNITYSDK_OFFSET(0x79E430)
#define MOLEMOLE_CONFIG_SPLINE_WAYPOINT_METHOD_2_6D0360BD23602584_OFFSET UNITYSDK_OFFSET(0x79E330)
#define MOLEMOLE_CONFIG_SPLINE_WAYPOINT_METHOD_2_74D2DB51E1B704B6_1_OFFSET UNITYSDK_OFFSET(0x153D49A0)
#define MOLEMOLE_CONFIG_SPLINE_WAYPOINT_METHOD_2_74D2DB51E1B704B6_OFFSET UNITYSDK_OFFSET(0x153D4770)
#define MOLEMOLE_CONFIG_SPLINE_WAYPOINT_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x79E3D0)
#define MOLEMOLE_CONFIG_SPLINE_WAYPOINT_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x79E3A0)
#define MOLEMOLE_CONFIG_SPLINE_WAYPOINT_METHOD_2_F777B3BEDBE68D53_OFFSET UNITYSDK_OFFSET(0x79E4C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int Spline_WayPoint_TypeDefinitionIndex = 72218;
