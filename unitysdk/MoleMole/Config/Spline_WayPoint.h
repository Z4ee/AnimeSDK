...
#define MOLEMOLE_CONFIG_SPLINE_WAYPOINT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8CD430)
#define MOLEMOLE_CONFIG_SPLINE_WAYPOINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x8CD390)
#define MOLEMOLE_CONFIG_SPLINE_WAYPOINT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x8CD5B0)
#define MOLEMOLE_CONFIG_SPLINE_WAYPOINT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x8CD520)
#define MOLEMOLE_CONFIG_SPLINE_WAYPOINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8CD440)
#define MOLEMOLE_CONFIG_SPLINE_WAYPOINT_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x1B9277B0)
#define MOLEMOLE_CONFIG_SPLINE_WAYPOINT_METHOD_2_217BB3FC4AC50D8F_OFFSET UNITYSDK_OFFSET(0x8CD610)
#define MOLEMOLE_CONFIG_SPLINE_WAYPOINT_METHOD_2_6D0360BD23602584_OFFSET UNITYSDK_OFFSET(0x8CD6D0)
#define MOLEMOLE_CONFIG_SPLINE_WAYPOINT_METHOD_2_74D2DB51E1B704B6_1_OFFSET UNITYSDK_OFFSET(0x1B928230)
#define MOLEMOLE_CONFIG_SPLINE_WAYPOINT_METHOD_2_74D2DB51E1B704B6_OFFSET UNITYSDK_OFFSET(0x1B9280C0)
#define MOLEMOLE_CONFIG_SPLINE_WAYPOINT_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x8CD750)
#define MOLEMOLE_CONFIG_SPLINE_WAYPOINT_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x8CD6A0)
#define MOLEMOLE_CONFIG_SPLINE_WAYPOINT_METHOD_2_F777B3BEDBE68D53_OFFSET UNITYSDK_OFFSET(0x8CD740)

namespace MoleMole::Config
{
	inline static constexpr unsigned int Spline_WayPoint_TypeDefinitionIndex = 84193;
