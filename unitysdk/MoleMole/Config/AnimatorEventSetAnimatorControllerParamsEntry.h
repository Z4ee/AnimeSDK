...
#define MOLEMOLE_CONFIG_ANIMATOREVENTSETANIMATORCONTROLLERPARAMSENTRY_CREATEANIMATIONEVENT_OFFSET UNITYSDK_OFFSET(0x11C8F2F0)
#define MOLEMOLE_CONFIG_ANIMATOREVENTSETANIMATORCONTROLLERPARAMSENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x11C8F370)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorEventSetAnimatorControllerParamsEntry_TypeDefinitionIndex = 65216;

	class AnimatorEventSetAnimatorControllerParamsEntry : public ::MoleMole::Config::AnimatorEventEntry
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int32>* IntParams; // 0x58
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Single>* FloatParams; // 0x60
