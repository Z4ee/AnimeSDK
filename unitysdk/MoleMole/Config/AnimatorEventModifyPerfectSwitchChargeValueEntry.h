...
#define MOLEMOLE_CONFIG_ANIMATOREVENTMODIFYPERFECTSWITCHCHARGEVALUEENTRY_CREATEANIMATIONEVENT_OFFSET UNITYSDK_OFFSET(0x13ECEAC0)
#define MOLEMOLE_CONFIG_ANIMATOREVENTMODIFYPERFECTSWITCHCHARGEVALUEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x13ECEB40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorEventModifyPerfectSwitchChargeValueEntry_TypeDefinitionIndex = 69318;
