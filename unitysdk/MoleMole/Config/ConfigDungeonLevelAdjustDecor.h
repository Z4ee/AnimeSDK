...
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELADJUSTDECOR_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x186AE170)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELADJUSTDECOR_FROMFLX_OFFSET UNITYSDK_OFFSET(0x186ADEE0)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELADJUSTDECOR_METHOD_2_0AFE2382BF92DEC7_OFFSET UNITYSDK_OFFSET(0x186AE1D0)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELADJUSTDECOR_METHOD_2_2C463ED601F44ECA_OFFSET UNITYSDK_OFFSET(0x186AE790)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELADJUSTDECOR_METHOD_2_3AEAB3533756E9A9_OFFSET UNITYSDK_OFFSET(0x186AE510)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELADJUSTDECOR_METHOD_2_7821D1D4DDDF7E01_OFFSET UNITYSDK_OFFSET(0x186ADF60)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELADJUSTDECOR_METHOD_2_81438D3AF9EEE8D8_OFFSET UNITYSDK_OFFSET(0x186ADD70)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELADJUSTDECOR_METHOD_2_B73F62522113F21F_OFFSET UNITYSDK_OFFSET(0x186ADD20)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELADJUSTDECOR_METHOD_2_C444D4C8B9D548AF_OFFSET UNITYSDK_OFFSET(0x186ADE70)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELADJUSTDECOR_METHOD_2_C69D596A06700576_OFFSET UNITYSDK_OFFSET(0x186AE470)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELADJUSTDECOR_METHOD_2_C8F7CFE08BFB88F7_OFFSET UNITYSDK_OFFSET(0x186AE820)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELADJUSTDECOR_METHOD_2_EF95093855EE7003_OFFSET UNITYSDK_OFFSET(0x186AE9D0)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELADJUSTDECOR__CTOR_OFFSET UNITYSDK_OFFSET(0x186AE780)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDungeonLevelAdjustDecor_TypeDefinitionIndex = 38516;
	...
	public:
		...
		{
			return ((::System::Int32(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELADJUSTDECOR_METHOD_2_C444D4C8B9D548AF_OFFSET))(this);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::FlexBuffers::FlxMap))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELADJUSTDECOR_METHOD_2_7821D1D4DDDF7E01_OFFSET))(this, a1);
		}
