...
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELADJUSTDECOR_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x106CB3C0)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELADJUSTDECOR_FROMFLX_OFFSET UNITYSDK_OFFSET(0x106CB130)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELADJUSTDECOR_METHOD_2_0AFE2382BF92DEC7_OFFSET UNITYSDK_OFFSET(0x106CB420)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELADJUSTDECOR_METHOD_2_2C463ED601F44ECA_OFFSET UNITYSDK_OFFSET(0x106CBCF0)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELADJUSTDECOR_METHOD_2_3AEAB3533756E9A9_OFFSET UNITYSDK_OFFSET(0x106CB760)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELADJUSTDECOR_METHOD_2_7821D1D4DDDF7E01_OFFSET UNITYSDK_OFFSET(0x106CB1B0)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELADJUSTDECOR_METHOD_2_81438D3AF9EEE8D8_OFFSET UNITYSDK_OFFSET(0x106CAFC0)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELADJUSTDECOR_METHOD_2_B73F62522113F21F_OFFSET UNITYSDK_OFFSET(0x106CAF70)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELADJUSTDECOR_METHOD_2_C444D4C8B9D548AF_OFFSET UNITYSDK_OFFSET(0x106CB0C0)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELADJUSTDECOR_METHOD_2_C69D596A06700576_OFFSET UNITYSDK_OFFSET(0x106CB6C0)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELADJUSTDECOR_METHOD_2_C8F7CFE08BFB88F7_OFFSET UNITYSDK_OFFSET(0x106CBB40)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELADJUSTDECOR_METHOD_2_EF95093855EE7003_OFFSET UNITYSDK_OFFSET(0x106CB9E0)
#define MOLEMOLE_CONFIG_CONFIGDUNGEONLEVELADJUSTDECOR__CTOR_OFFSET UNITYSDK_OFFSET(0x106CB9D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDungeonLevelAdjustDecor_TypeDefinitionIndex = 71667;
