...
#define MOLEMOLE_CONFIG_ASSETINDEXCONTAINER_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x10CF64B0)
#define MOLEMOLE_CONFIG_ASSETINDEXCONTAINER_FROMFLX_OFFSET UNITYSDK_OFFSET(0x10CF61E0)
#define MOLEMOLE_CONFIG_ASSETINDEXCONTAINER_METHOD_1_02A12E3EB78B97E4_OFFSET UNITYSDK_OFFSET(0x10CF87F0)
#define MOLEMOLE_CONFIG_ASSETINDEXCONTAINER_METHOD_1_05E10F4A3388E492_OFFSET UNITYSDK_OFFSET(0x10CF8670)
#define MOLEMOLE_CONFIG_ASSETINDEXCONTAINER_METHOD_1_0B5620D138D7F197_OFFSET UNITYSDK_OFFSET(0x10CF77C0)
#define MOLEMOLE_CONFIG_ASSETINDEXCONTAINER_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x10CF87B0)
#define MOLEMOLE_CONFIG_ASSETINDEXCONTAINER_METHOD_1_12AFB229059D08D7_OFFSET UNITYSDK_OFFSET(0x10CF8590)
#define MOLEMOLE_CONFIG_ASSETINDEXCONTAINER_METHOD_1_157E312840A3BD00_OFFSET UNITYSDK_OFFSET(0x10CF6510)
#define MOLEMOLE_CONFIG_ASSETINDEXCONTAINER_METHOD_1_1A27B6D09FE50326_OFFSET UNITYSDK_OFFSET(0x10CF6910)
#define MOLEMOLE_CONFIG_ASSETINDEXCONTAINER_METHOD_1_2A2408D9CB219D81_1_OFFSET UNITYSDK_OFFSET(0x10CF8710)
#define MOLEMOLE_CONFIG_ASSETINDEXCONTAINER_METHOD_1_2A2408D9CB219D81_OFFSET UNITYSDK_OFFSET(0x10CF85E0)
#define MOLEMOLE_CONFIG_ASSETINDEXCONTAINER_METHOD_1_3096E66776FB7F38_OFFSET UNITYSDK_OFFSET(0x10CF8240)
#define MOLEMOLE_CONFIG_ASSETINDEXCONTAINER_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x10CF8520)
#define MOLEMOLE_CONFIG_ASSETINDEXCONTAINER_METHOD_1_5B0202969299569F_OFFSET UNITYSDK_OFFSET(0x10CF6260)
#define MOLEMOLE_CONFIG_ASSETINDEXCONTAINER_METHOD_1_8B37865E8A16378E_OFFSET UNITYSDK_OFFSET(0x10CF6860)
#define MOLEMOLE_CONFIG_ASSETINDEXCONTAINER_METHOD_1_CA31659CE304C271_OFFSET UNITYSDK_OFFSET(0x10CF6790)
#define MOLEMOLE_CONFIG_ASSETINDEXCONTAINER_METHOD_1_CCB11C3744AAA431_OFFSET UNITYSDK_OFFSET(0x10CF8840)
#define MOLEMOLE_CONFIG_ASSETINDEXCONTAINER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x10CF6090)
#define MOLEMOLE_CONFIG_ASSETINDEXCONTAINER__CCTOR_OFFSET UNITYSDK_OFFSET(0x10CF66F0)
#define MOLEMOLE_CONFIG_ASSETINDEXCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x10CF66E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AssetIndexContainer_TypeDefinitionIndex = 40835;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::Foundation::ResourceFileType, ::System::ValueTuple_2<::System::UInt64, ::MoleMole::Config::AssetIndexContainer*>>**)Il2CppClass::FromTypeDefinitionIndex(AssetIndexContainer_TypeDefinitionIndex)->GetStaticField(0x36AF0);
		}
