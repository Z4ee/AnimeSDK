...
#define MOLEMOLE_CONFIG_ANIMATORZONEAVATARSWITCHOUTDELAY_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0xF12E3D0)
#define MOLEMOLE_CONFIG_ANIMATORZONEAVATARSWITCHOUTDELAY_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0xF12E550)
#define MOLEMOLE_CONFIG_ANIMATORZONEAVATARSWITCHOUTDELAY__CTOR_OFFSET UNITYSDK_OFFSET(0xF12E6C0)
#define MOLEMOLE_CONFIG_ANIMATORZONEAVATARSWITCHOUTDELAY___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0xF12E6D0)
#define MOLEMOLE_CONFIG_ANIMATORZONEAVATARSWITCHOUTDELAY___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0xF12E780)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneAvatarSwitchOutDelay_TypeDefinitionIndex = 53911;

	class AnimatorZoneAvatarSwitchOutDelay : public ::MoleMole::Config::AnimatorZone
	{
	public:
		::System::Boolean muteVanish; // 0x50
		::System::Boolean needOverrideMinVanishDelay; // 0x51
		::System::Boolean needOverrideMaxVanishDelay; // 0x52
		::System::Single minVanishDelay; // 0x54
