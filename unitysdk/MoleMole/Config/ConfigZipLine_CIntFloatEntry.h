...
#define MOLEMOLE_CONFIG_CONFIGZIPLINE_CINTFLOATENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x17056EC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigZipLine_CIntFloatEntry_TypeDefinitionIndex = 51250;
