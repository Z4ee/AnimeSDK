...
#define MOLEMOLE_CONFIG_STREAMINGSTAGEENTRY_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x19FFDE50)
#define MOLEMOLE_CONFIG_STREAMINGSTAGEENTRY_GET_CUSTOMDATA_OFFSET UNITYSDK_OFFSET(0x19FFDE40)
#define MOLEMOLE_CONFIG_STREAMINGSTAGEENTRY_GET_STAGESCENEPATH_OFFSET UNITYSDK_OFFSET(0x19FFDE30)
#define MOLEMOLE_CONFIG_STREAMINGSTAGEENTRY_LOADSTAGEENV_OFFSET UNITYSDK_OFFSET(0x19FFDF00)
#define MOLEMOLE_CONFIG_STREAMINGSTAGEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x19FFDEF0)
#define MOLEMOLE_CONFIG_STREAMINGSTAGEENTRY___BASE_LOADSTAGEENV_OFFSET UNITYSDK_OFFSET(0x19FFE3C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int StreamingStageEntry_TypeDefinitionIndex = 44455;
