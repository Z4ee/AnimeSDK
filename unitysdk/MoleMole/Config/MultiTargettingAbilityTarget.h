...
#define MOLEMOLE_CONFIG_MULTITARGETTINGABILITYTARGET_METHOD_2_68B51C25928CE98A_OFFSET UNITYSDK_OFFSET(0x1B7FFF90)
#define MOLEMOLE_CONFIG_MULTITARGETTINGABILITYTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B800470)

namespace MoleMole::Config
{
	inline static constexpr unsigned int MultiTargettingAbilityTarget_TypeDefinitionIndex = 91495;
