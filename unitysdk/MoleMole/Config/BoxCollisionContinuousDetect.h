...
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT_APPLYVALUESTOCOLLIDERCFG_OFFSET UNITYSDK_OFFSET(0x1BD4EF50)
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT_ATTACHPATTERNMETHODWITHGROUPID_OFFSET UNITYSDK_OFFSET(0x1BD4EE40)
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT_ATTACHPATTERNMETHOD_OFFSET UNITYSDK_OFFSET(0x1BD4ED80)
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT_COLLIDERCFGFILTERGETTER_OFFSET UNITYSDK_OFFSET(0x1BD4F100)
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1BD4EF00)
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1BD4F050)
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BD4F090)
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD4ECF0)
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT___BASE_ATTACHPATTERNMETHOD_OFFSET UNITYSDK_OFFSET(0x1BD4F220)
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BD4F2B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int BoxCollisionContinuousDetect_TypeDefinitionIndex = 61643;
