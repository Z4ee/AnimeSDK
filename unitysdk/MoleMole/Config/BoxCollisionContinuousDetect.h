...
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT_APPLYVALUESTOCOLLIDERCFG_OFFSET UNITYSDK_OFFSET(0x17529150)
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT_ATTACHPATTERNMETHODWITHGROUPID_OFFSET UNITYSDK_OFFSET(0x17529040)
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT_ATTACHPATTERNMETHOD_OFFSET UNITYSDK_OFFSET(0x17528F80)
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT_COLLIDERCFGFILTERGETTER_OFFSET UNITYSDK_OFFSET(0x17529300)
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x17529100)
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x17529250)
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17529290)
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT__CTOR_OFFSET UNITYSDK_OFFSET(0x17528EF0)
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT___BASE_ATTACHPATTERNMETHOD_OFFSET UNITYSDK_OFFSET(0x17529420)
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x175294B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int BoxCollisionContinuousDetect_TypeDefinitionIndex = 58001;
