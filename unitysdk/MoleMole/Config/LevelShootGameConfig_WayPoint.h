...
#define MOLEMOLE_CONFIG_LEVELSHOOTGAMECONFIG_WAYPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4EA610)

namespace MoleMole::Config
{
	inline static constexpr unsigned int LevelShootGameConfig_WayPoint_TypeDefinitionIndex = 52694;
