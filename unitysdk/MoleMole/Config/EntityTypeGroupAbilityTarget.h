...
#define MOLEMOLE_CONFIG_ENTITYTYPEGROUPABILITYTARGET_METHOD_3_A2C4327E28F3EBBC_OFFSET UNITYSDK_OFFSET(0x11711830)
#define MOLEMOLE_CONFIG_ENTITYTYPEGROUPABILITYTARGET_METHOD_3_AA1449B8ACF66DDA_OFFSET UNITYSDK_OFFSET(0x11711BD0)
#define MOLEMOLE_CONFIG_ENTITYTYPEGROUPABILITYTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x11711B40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int EntityTypeGroupAbilityTarget_TypeDefinitionIndex = 73112;
