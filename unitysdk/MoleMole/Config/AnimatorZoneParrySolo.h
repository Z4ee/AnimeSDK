...
#define MOLEMOLE_CONFIG_ANIMATORZONEPARRYSOLO_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x1B541F50)
#define MOLEMOLE_CONFIG_ANIMATORZONEPARRYSOLO_ONEVTHITTINGOTHERINSTANTLY_OFFSET UNITYSDK_OFFSET(0x1B541FE0)
#define MOLEMOLE_CONFIG_ANIMATORZONEPARRYSOLO_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x1B5418B0)
#define MOLEMOLE_CONFIG_ANIMATORZONEPARRYSOLO_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x1B541C10)
#define MOLEMOLE_CONFIG_ANIMATORZONEPARRYSOLO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5429E0)
#define MOLEMOLE_CONFIG_ANIMATORZONEPARRYSOLO___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x1B542A70)
#define MOLEMOLE_CONFIG_ANIMATORZONEPARRYSOLO___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x1B542B40)
#define MOLEMOLE_CONFIG_ANIMATORZONEPARRYSOLO___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x1B542BF0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneParrySolo_TypeDefinitionIndex = 88114;
