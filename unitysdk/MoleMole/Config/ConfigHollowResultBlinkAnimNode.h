...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWRESULTBLINKANIMNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x1230C2D0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWRESULTBLINKANIMNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1230C340)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowResultBlinkAnimNode_TypeDefinitionIndex = 63114;
