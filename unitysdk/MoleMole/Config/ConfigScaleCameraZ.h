...
#define MOLEMOLE_CONFIG_CONFIGSCALECAMERAZ__CTOR_OFFSET UNITYSDK_OFFSET(0x10D0B240)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigScaleCameraZ_TypeDefinitionIndex = 56985;
