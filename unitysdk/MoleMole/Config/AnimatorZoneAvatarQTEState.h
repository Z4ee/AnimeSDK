...
#define MOLEMOLE_CONFIG_ANIMATORZONEAVATARQTESTATE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x12703910)
#define MOLEMOLE_CONFIG_ANIMATORZONEAVATARQTESTATE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x127035F0)
#define MOLEMOLE_CONFIG_ANIMATORZONEAVATARQTESTATE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x12703760)
#define MOLEMOLE_CONFIG_ANIMATORZONEAVATARQTESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x127039A0)
#define MOLEMOLE_CONFIG_ANIMATORZONEAVATARQTESTATE___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x127039B0)
#define MOLEMOLE_CONFIG_ANIMATORZONEAVATARQTESTATE___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x12703A80)
#define MOLEMOLE_CONFIG_ANIMATORZONEAVATARQTESTATE___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x12703B30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneAvatarQTEState_TypeDefinitionIndex = 81044;
