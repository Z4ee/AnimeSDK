...
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION_CLONE_OFFSET UNITYSDK_OFFSET(0x192A7560)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x192A74F0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x192A78E0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION_FROMFLX_OFFSET UNITYSDK_OFFSET(0x192A76D0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x192A7660)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION_GETROTATIONDIR_OFFSET UNITYSDK_OFFSET(0x192A7460)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x192A7970)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x192A7750)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x192A79D0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x192A7780)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION_RECORDPOSROTPARAM_OFFSET UNITYSDK_OFFSET(0x192A71A0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x192A7150)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION___BASE_GETROTATIONDIR_OFFSET UNITYSDK_OFFSET(0x192A7BB0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION___BASE_RECORDPOSROTPARAM_OFFSET UNITYSDK_OFFSET(0x192A7BE0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigRotationToTargetRotation_TypeDefinitionIndex = 83106;
