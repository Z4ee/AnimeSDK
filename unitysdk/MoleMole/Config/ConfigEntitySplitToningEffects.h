...
#define MOLEMOLE_CONFIG_CONFIGENTITYSPLITTONINGEFFECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x114703B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntitySplitToningEffects_TypeDefinitionIndex = 81987;
