...
#define MOLEMOLE_CONFIG_CONFIGTRAININGROOM_CONFIGTRAININGROOM_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x1A35B900)
#define MOLEMOLE_CONFIG_CONFIGTRAININGROOM_CONFIGTRAININGROOM_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x1A35B910)
#define MOLEMOLE_CONFIG_CONFIGTRAININGROOM_CONFIGTRAININGROOM_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x1A35BBB0)
#define MOLEMOLE_CONFIG_CONFIGTRAININGROOM_CONFIGTRAININGROOM_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A35BDB0)
#define MOLEMOLE_CONFIG_CONFIGTRAININGROOM_CONFIGTRAININGROOM_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A35BD70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTrainingRoom_ConfigTrainingRoom_UnityGeneratedFormatter_TypeDefinitionIndex = 43018;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::List_1<::MoleMole::AvatarInitData*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigTrainingRoom_ConfigTrainingRoom_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x4D700);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::MoleMole::Config::ETrainingRoomItemType, ::System::String*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigTrainingRoom_ConfigTrainingRoom_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x4D708);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::List_1<::MoleMole::Config::ConfigSpecialTraining*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigTrainingRoom_ConfigTrainingRoom_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x4D710);
		}
