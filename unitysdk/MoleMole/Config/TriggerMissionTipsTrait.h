...
#define MOLEMOLE_CONFIG_TRIGGERMISSIONTIPSTRAIT_CLONE_OFFSET UNITYSDK_OFFSET(0x158C5FE0)
#define MOLEMOLE_CONFIG_TRIGGERMISSIONTIPSTRAIT_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x158C6140)
#define MOLEMOLE_CONFIG_TRIGGERMISSIONTIPSTRAIT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x158C5F60)
#define MOLEMOLE_CONFIG_TRIGGERMISSIONTIPSTRAIT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x158C6E10)
#define MOLEMOLE_CONFIG_TRIGGERMISSIONTIPSTRAIT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x158C62E0)
#define MOLEMOLE_CONFIG_TRIGGERMISSIONTIPSTRAIT_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x158C75C0)
#define MOLEMOLE_CONFIG_TRIGGERMISSIONTIPSTRAIT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x158C60D0)
#define MOLEMOLE_CONFIG_TRIGGERMISSIONTIPSTRAIT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x158C6E70)
#define MOLEMOLE_CONFIG_TRIGGERMISSIONTIPSTRAIT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x158C6360)
#define MOLEMOLE_CONFIG_TRIGGERMISSIONTIPSTRAIT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x158C7420)
#define MOLEMOLE_CONFIG_TRIGGERMISSIONTIPSTRAIT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x158C6CD0)
#define MOLEMOLE_CONFIG_TRIGGERMISSIONTIPSTRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x158C7670)
#define MOLEMOLE_CONFIG_TRIGGERMISSIONTIPSTRAIT___BASE_EXPOSEMEMBER_OFFSET UNITYSDK_OFFSET(0x158C7680)
#define MOLEMOLE_CONFIG_TRIGGERMISSIONTIPSTRAIT___BASE_GENERATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x158C7690)

namespace MoleMole::Config
{
	inline static constexpr unsigned int TriggerMissionTipsTrait_TypeDefinitionIndex = 50608;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_175*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_TRIGGERMISSIONTIPSTRAIT_EXPOSEMEMBER_OFFSET))(this, processor, prefix);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_53842913455A8556*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_TRIGGERMISSIONTIPSTRAIT_GENERATECOMPONENT_OFFSET))(this, buildContext);
		}

		::System::Void __base_ExposeMember(::Class_0_16E4307DCC419505_175* P0, ::System::String* P1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_175*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_TRIGGERMISSIONTIPSTRAIT___BASE_EXPOSEMEMBER_OFFSET))(this, P0, P1);
		}

		::System::Boolean __base_GenerateComponent(::Class_1_53842913455A8556* P0)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_1_53842913455A8556*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_TRIGGERMISSIONTIPSTRAIT___BASE_GENERATECOMPONENT_OFFSET))(this, P0);
		}
	};
}
