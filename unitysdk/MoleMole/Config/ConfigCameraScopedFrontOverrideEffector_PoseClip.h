...
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_POSECLIP_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0x159E59B0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_POSECLIP_RESET_OFFSET UNITYSDK_OFFSET(0x159E5A30)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_POSECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x159E5AE0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_POSECLIP___BASE_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0x159E5AF0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_POSECLIP___BASE_RESET_OFFSET UNITYSDK_OFFSET(0x159E5B80)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraScopedFrontOverrideEffector_PoseClip_TypeDefinitionIndex = 40922;
