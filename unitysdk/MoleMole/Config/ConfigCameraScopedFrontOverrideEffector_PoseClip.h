...
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_POSECLIP_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0x1270ED50)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_POSECLIP_RESET_OFFSET UNITYSDK_OFFSET(0x1270EDD0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_POSECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1270EE80)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_POSECLIP___BASE_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0x1270EE90)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_POSECLIP___BASE_RESET_OFFSET UNITYSDK_OFFSET(0x1270EF20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraScopedFrontOverrideEffector_PoseClip_TypeDefinitionIndex = 52653;
