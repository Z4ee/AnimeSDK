...
#define MOLEMOLE_CONFIG_CONFIGPLAYBGSEQUENCEVENODE_GETALLVEKEY_OFFSET UNITYSDK_OFFSET(0x1B7EEA60)
#define MOLEMOLE_CONFIG_CONFIGPLAYBGSEQUENCEVENODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x1B7EE9E0)
#define MOLEMOLE_CONFIG_CONFIGPLAYBGSEQUENCEVENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7EEAE0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPlayBGSequenceVENode_TypeDefinitionIndex = 50443;

	class ConfigPlayBGSequenceVENode : public ::MoleMole::Config::ConfigUIBaseActionNode
	{
	public:
		::System::String* ChangeVEEffectPath; // 0x18
		::UnityEngine::AnimationCurve* AlphaCurve; // 0x20
		::System::String* SwitchEndEffectPath; // 0x28
		::System::Collections::Generic::List_1<::System::String*>* VEPool; // 0x30
