...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_GLOBALRTPC_EVALUATE_OFFSET UNITYSDK_OFFSET(0xE978DF0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_GLOBALRTPC_GET_INSPECTORLABEL_OFFSET UNITYSDK_OFFSET(0xE978DB0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_GLOBALRTPC_METHOD_1_F76B7A1AB354B377_OFFSET UNITYSDK_OFFSET(0xE979120)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_GLOBALRTPC__CTOR_OFFSET UNITYSDK_OFFSET(0xE979210)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundActionTriggerCondition_GlobalRTPC_TypeDefinitionIndex = 68670;
