...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_GLOBALRTPC_EVALUATE_OFFSET UNITYSDK_OFFSET(0xFB0AAF0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_GLOBALRTPC_GET_INSPECTORLABEL_OFFSET UNITYSDK_OFFSET(0xFB0AAB0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_GLOBALRTPC_METHOD_1_F76B7A1AB354B377_OFFSET UNITYSDK_OFFSET(0xFB0AE20)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_GLOBALRTPC__CTOR_OFFSET UNITYSDK_OFFSET(0xFB0AF10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundActionTriggerCondition_GlobalRTPC_TypeDefinitionIndex = 50984;
	...
	public:
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_0_16E4307DCC419505_147*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_GLOBALRTPC_EVALUATE_OFFSET))(this, a1);
		}
