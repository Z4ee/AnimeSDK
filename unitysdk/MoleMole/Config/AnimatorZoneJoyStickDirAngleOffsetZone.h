...
#define MOLEMOLE_CONFIG_ANIMATORZONEJOYSTICKDIRANGLEOFFSETZONE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x144CF340)
#define MOLEMOLE_CONFIG_ANIMATORZONEJOYSTICKDIRANGLEOFFSETZONE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x144CEDD0)
#define MOLEMOLE_CONFIG_ANIMATORZONEJOYSTICKDIRANGLEOFFSETZONE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x144CF090)
#define MOLEMOLE_CONFIG_ANIMATORZONEJOYSTICKDIRANGLEOFFSETZONE__CTOR_OFFSET UNITYSDK_OFFSET(0x144CF3D0)
#define MOLEMOLE_CONFIG_ANIMATORZONEJOYSTICKDIRANGLEOFFSETZONE___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x144CF3E0)
#define MOLEMOLE_CONFIG_ANIMATORZONEJOYSTICKDIRANGLEOFFSETZONE___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x144CF4B0)
#define MOLEMOLE_CONFIG_ANIMATORZONEJOYSTICKDIRANGLEOFFSETZONE___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x144CF560)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneJoyStickDirAngleOffsetZone_TypeDefinitionIndex = 46476;
