...
#define MOLEMOLE_CONFIG_SUMMONERABILITYTARGET_METHOD_2_4B906FE82244ECD0_OFFSET UNITYSDK_OFFSET(0x16AA9450)
#define MOLEMOLE_CONFIG_SUMMONERABILITYTARGET_METHOD_2_EC39254A2A7DF615_OFFSET UNITYSDK_OFFSET(0x16AA9310)
#define MOLEMOLE_CONFIG_SUMMONERABILITYTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16AA9700)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SummonerAbilityTarget_TypeDefinitionIndex = 61202;
