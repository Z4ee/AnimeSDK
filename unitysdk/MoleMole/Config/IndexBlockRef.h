...
#define MOLEMOLE_CONFIG_INDEXBLOCKREF_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A35ECC0)
#define MOLEMOLE_CONFIG_INDEXBLOCKREF_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1A35E900)
#define MOLEMOLE_CONFIG_INDEXBLOCKREF_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x1A35EF80)
#define MOLEMOLE_CONFIG_INDEXBLOCKREF_METHOD_1_1D8C60247E81BA7F_OFFSET UNITYSDK_OFFSET(0x1A35ED20)
#define MOLEMOLE_CONFIG_INDEXBLOCKREF_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0x1A35E980)
#define MOLEMOLE_CONFIG_INDEXBLOCKREF_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A35E5C0)
#define MOLEMOLE_CONFIG_INDEXBLOCKREF__CTOR_OFFSET UNITYSDK_OFFSET(0x1A35EF70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int IndexBlockRef_TypeDefinitionIndex = 68730;
