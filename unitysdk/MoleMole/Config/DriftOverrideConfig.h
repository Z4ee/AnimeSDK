...
#define MOLEMOLE_CONFIG_DRIFTOVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17D64D60)

namespace MoleMole::Config
{
	inline static constexpr unsigned int DriftOverrideConfig_TypeDefinitionIndex = 71869;
