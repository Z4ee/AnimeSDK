...
#define MOLEMOLE_CONFIG_DRIFTOVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x172B43F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int DriftOverrideConfig_TypeDefinitionIndex = 79196;
