...
#define MOLEMOLE_CONFIG_READONLYDYNAMICSTRING_GET_DYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x183D3640)
#define MOLEMOLE_CONFIG_READONLYDYNAMICSTRING_GET_FIXEDVALUE_OFFSET UNITYSDK_OFFSET(0x183D3660)
#define MOLEMOLE_CONFIG_READONLYDYNAMICSTRING_GET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x183D3620)
#define MOLEMOLE_CONFIG_READONLYDYNAMICSTRING_SET_DYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x183D3650)
#define MOLEMOLE_CONFIG_READONLYDYNAMICSTRING_SET_FIXEDVALUE_OFFSET UNITYSDK_OFFSET(0x183D3670)
#define MOLEMOLE_CONFIG_READONLYDYNAMICSTRING_SET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x183D3630)
#define MOLEMOLE_CONFIG_READONLYDYNAMICSTRING__CTOR_1_OFFSET UNITYSDK_OFFSET(0x183D35B0)
#define MOLEMOLE_CONFIG_READONLYDYNAMICSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x183D3550)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ReadonlyDynamicString_TypeDefinitionIndex = 49580;
