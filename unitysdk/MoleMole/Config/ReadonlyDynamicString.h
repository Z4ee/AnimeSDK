...
#define MOLEMOLE_CONFIG_READONLYDYNAMICSTRING_GET_DYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1B566D20)
#define MOLEMOLE_CONFIG_READONLYDYNAMICSTRING_GET_FIXEDVALUE_OFFSET UNITYSDK_OFFSET(0x1B566D40)
#define MOLEMOLE_CONFIG_READONLYDYNAMICSTRING_GET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x1B566D00)
#define MOLEMOLE_CONFIG_READONLYDYNAMICSTRING_SET_DYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1B566D30)
#define MOLEMOLE_CONFIG_READONLYDYNAMICSTRING_SET_FIXEDVALUE_OFFSET UNITYSDK_OFFSET(0x1B566D50)
#define MOLEMOLE_CONFIG_READONLYDYNAMICSTRING_SET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x1B566D10)
#define MOLEMOLE_CONFIG_READONLYDYNAMICSTRING__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B566C90)
#define MOLEMOLE_CONFIG_READONLYDYNAMICSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B566C30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ReadonlyDynamicString_TypeDefinitionIndex = 83748;
