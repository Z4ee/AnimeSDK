...
#define MOLEMOLE_CONFIG_ANIMATORZONECOLLISIONDETECTIONMODE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x134EBF60)
#define MOLEMOLE_CONFIG_ANIMATORZONECOLLISIONDETECTIONMODE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x134EC030)
#define MOLEMOLE_CONFIG_ANIMATORZONECOLLISIONDETECTIONMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x134EC100)
#define MOLEMOLE_CONFIG_ANIMATORZONECOLLISIONDETECTIONMODE___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x134EC110)
#define MOLEMOLE_CONFIG_ANIMATORZONECOLLISIONDETECTIONMODE___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x134EC1C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneCollisionDetectionMode_TypeDefinitionIndex = 46249;
