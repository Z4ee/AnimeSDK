...
#define MOLEMOLE_CONFIG_MULTIPOSITIONFEEDBACKMODEGAMEPADTRIGGEREFFECTENTRY_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x157CDA10)
#define MOLEMOLE_CONFIG_MULTIPOSITIONFEEDBACKMODEGAMEPADTRIGGEREFFECTENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x157CDAA0)
#define MOLEMOLE_CONFIG_MULTIPOSITIONFEEDBACKMODEGAMEPADTRIGGEREFFECTENTRY___BASE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x157CDAB0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int MultiPositionFeedbackModeGamepadTriggerEffectEntry_TypeDefinitionIndex = 74832;
