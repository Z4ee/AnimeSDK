...
#define MOLEMOLE_CONFIG_MULTIPOSITIONFEEDBACKMODEGAMEPADTRIGGEREFFECTENTRY_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x1BD70490)
#define MOLEMOLE_CONFIG_MULTIPOSITIONFEEDBACKMODEGAMEPADTRIGGEREFFECTENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD70520)
#define MOLEMOLE_CONFIG_MULTIPOSITIONFEEDBACKMODEGAMEPADTRIGGEREFFECTENTRY___BASE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x1BD70530)

namespace MoleMole::Config
{
	inline static constexpr unsigned int MultiPositionFeedbackModeGamepadTriggerEffectEntry_TypeDefinitionIndex = 74399;
