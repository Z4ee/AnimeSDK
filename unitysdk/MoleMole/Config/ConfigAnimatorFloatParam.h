...
#define MOLEMOLE_CONFIG_CONFIGANIMATORFLOATPARAM_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x7C3F10)
#define MOLEMOLE_CONFIG_CONFIGANIMATORFLOATPARAM_FROMFLX_OFFSET UNITYSDK_OFFSET(0x7C3E80)
#define MOLEMOLE_CONFIG_CONFIGANIMATORFLOATPARAM_METHOD_2_18055626D7B524E1_OFFSET UNITYSDK_OFFSET(0x7C3FA0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORFLOATPARAM_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x7C3F70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAnimatorFloatParam_TypeDefinitionIndex = 90301;
