...
#define MOLEMOLE_CONFIG_HOLLOWPARTICLETEXTURESHEETANIMMODULECONFIG_CREATEMODULE_OFFSET UNITYSDK_OFFSET(0x19FF5D90)
#define MOLEMOLE_CONFIG_HOLLOWPARTICLETEXTURESHEETANIMMODULECONFIG_GETMODULEID_OFFSET UNITYSDK_OFFSET(0x19FF5EC0)
#define MOLEMOLE_CONFIG_HOLLOWPARTICLETEXTURESHEETANIMMODULECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF5F90)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HollowParticleTextureSheetAnimModuleConfig_TypeDefinitionIndex = 83537;
