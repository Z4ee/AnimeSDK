...
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS_CONFIGLEVELRESULTPERFORMEFFECT_ONSTARTFRAMEVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x7D57D0)
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS_CONFIGLEVELRESULTPERFORMEFFECT_ONSTARTTIMEVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x7D5830)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigLevelResultPerforms_ConfigLevelResultPerformEffect_TypeDefinitionIndex = 65850;
