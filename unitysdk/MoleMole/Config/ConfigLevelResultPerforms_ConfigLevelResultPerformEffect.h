...
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS_CONFIGLEVELRESULTPERFORMEFFECT_ONSTARTFRAMEVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x8D8C30)
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS_CONFIGLEVELRESULTPERFORMEFFECT_ONSTARTTIMEVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x8D8C90)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigLevelResultPerforms_ConfigLevelResultPerformEffect_TypeDefinitionIndex = 73018;
