...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUIATLAS_TRYGETFONTATLASRECT_OFFSET UNITYSDK_OFFSET(0x11CAAE20)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUIATLAS_TRYGETFONTBGATLASRECT_OFFSET UNITYSDK_OFFSET(0x11CAB100)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUIATLAS_TRYGETICONATLASRECT_OFFSET UNITYSDK_OFFSET(0x11CAAF90)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUIATLAS__CTOR_OFFSET UNITYSDK_OFFSET(0x11CAB270)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboardScreenUIAtlas_TypeDefinitionIndex = 69508;
