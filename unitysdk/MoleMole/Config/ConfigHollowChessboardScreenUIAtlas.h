...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUIATLAS_TRYGETFONTATLASRECT_OFFSET UNITYSDK_OFFSET(0x1929DAC0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUIATLAS_TRYGETFONTBGATLASRECT_OFFSET UNITYSDK_OFFSET(0x1929DDA0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUIATLAS_TRYGETICONATLASRECT_OFFSET UNITYSDK_OFFSET(0x1929DC30)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUIATLAS__CTOR_OFFSET UNITYSDK_OFFSET(0x1929DF10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboardScreenUIAtlas_TypeDefinitionIndex = 75951;
