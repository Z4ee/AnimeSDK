...
#define MOLEMOLE_CONFIG_WEAPONMODEGAMEPADTRIGGEREFFECTENTRY_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x19FFE3D0)
#define MOLEMOLE_CONFIG_WEAPONMODEGAMEPADTRIGGEREFFECTENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x19FFE480)
#define MOLEMOLE_CONFIG_WEAPONMODEGAMEPADTRIGGEREFFECTENTRY___BASE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x19FFE490)

namespace MoleMole::Config
{
	inline static constexpr unsigned int WeaponModeGamepadTriggerEffectEntry_TypeDefinitionIndex = 82026;
