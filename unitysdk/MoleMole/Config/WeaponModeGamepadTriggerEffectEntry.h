...
#define MOLEMOLE_CONFIG_WEAPONMODEGAMEPADTRIGGEREFFECTENTRY_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x181DF3F0)
#define MOLEMOLE_CONFIG_WEAPONMODEGAMEPADTRIGGEREFFECTENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x181DF4A0)
#define MOLEMOLE_CONFIG_WEAPONMODEGAMEPADTRIGGEREFFECTENTRY___BASE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x181DF4B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int WeaponModeGamepadTriggerEffectEntry_TypeDefinitionIndex = 65139;
