...
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLESPHERICAL_CLONE_OFFSET UNITYSDK_OFFSET(0x12311C70)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLESPHERICAL_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x12311BE0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLESPHERICAL_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x123127E0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLESPHERICAL_FROMFLX_OFFSET UNITYSDK_OFFSET(0x12311DE0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLESPHERICAL_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x12311D70)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLESPHERICAL_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x12312840)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLESPHERICAL_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x12311E60)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLESPHERICAL_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x12312D10)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLESPHERICAL_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x12312680)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLESPHERICAL_PROCESSRIGIDBODY_OFFSET UNITYSDK_OFFSET(0x12311AD0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLESPHERICAL_SETUPLOGICMOVEMENT_OFFSET UNITYSDK_OFFSET(0x12311880)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLESPHERICAL__CTOR_OFFSET UNITYSDK_OFFSET(0x12312EC0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLESPHERICAL___BASE_SETUPLOGICMOVEMENT_OFFSET UNITYSDK_OFFSET(0x12312ED0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMovementSimpleSpherical_TypeDefinitionIndex = 79494;
