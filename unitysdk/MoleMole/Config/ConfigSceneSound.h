...
#define MOLEMOLE_CONFIG_CONFIGSCENESOUND__CTOR_OFFSET UNITYSDK_OFFSET(0x192A7DB0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSceneSound_TypeDefinitionIndex = 71551;
