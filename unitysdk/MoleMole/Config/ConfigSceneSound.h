...
#define MOLEMOLE_CONFIG_CONFIGSCENESOUND__CTOR_OFFSET UNITYSDK_OFFSET(0x11CB43D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSceneSound_TypeDefinitionIndex = 42218;
