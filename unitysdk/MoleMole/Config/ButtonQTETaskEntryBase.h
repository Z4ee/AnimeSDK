...
#define MOLEMOLE_CONFIG_BUTTONQTETASKENTRYBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x106C6A20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ButtonQTETaskEntryBase_TypeDefinitionIndex = 68636;
