...
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLEWAVECONFIG___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0x192A9FA0)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLEWAVECONFIG___C__DISPLAYCLASS6_0__TOWAVECONFIG_B__0_OFFSET UNITYSDK_OFFSET(0x192AA1E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUISimpleParkourGame_SerializableWaveConfig___c__DisplayClass6_0_TypeDefinitionIndex = 72946;
