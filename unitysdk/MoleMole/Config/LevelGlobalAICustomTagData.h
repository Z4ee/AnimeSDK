...
#define MOLEMOLE_CONFIG_LEVELGLOBALAICUSTOMTAGDATA_GET_CUSTOMKEYLIST_OFFSET UNITYSDK_OFFSET(0x1C46DDF0)
#define MOLEMOLE_CONFIG_LEVELGLOBALAICUSTOMTAGDATA_READDATA_OFFSET UNITYSDK_OFFSET(0x1C46DDB0)
#define MOLEMOLE_CONFIG_LEVELGLOBALAICUSTOMTAGDATA_VALIDATECUSTOMKEYLIST_OFFSET UNITYSDK_OFFSET(0x1C46DE60)
#define MOLEMOLE_CONFIG_LEVELGLOBALAICUSTOMTAGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C46E100)

namespace MoleMole::Config
{
	inline static constexpr unsigned int LevelGlobalAICustomTagData_TypeDefinitionIndex = 69784;
