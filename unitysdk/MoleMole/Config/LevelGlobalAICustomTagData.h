...
#define MOLEMOLE_CONFIG_LEVELGLOBALAICUSTOMTAGDATA_GET_CUSTOMKEYLIST_OFFSET UNITYSDK_OFFSET(0x12438190)
#define MOLEMOLE_CONFIG_LEVELGLOBALAICUSTOMTAGDATA_READDATA_OFFSET UNITYSDK_OFFSET(0x12438150)
#define MOLEMOLE_CONFIG_LEVELGLOBALAICUSTOMTAGDATA_VALIDATECUSTOMKEYLIST_OFFSET UNITYSDK_OFFSET(0x12438200)
#define MOLEMOLE_CONFIG_LEVELGLOBALAICUSTOMTAGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x124384A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int LevelGlobalAICustomTagData_TypeDefinitionIndex = 75087;
