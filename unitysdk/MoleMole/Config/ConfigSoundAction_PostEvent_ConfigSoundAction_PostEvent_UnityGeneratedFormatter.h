...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_POSTEVENT_CONFIGSOUNDACTION_POSTEVENT_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x1271F360)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_POSTEVENT_CONFIGSOUNDACTION_POSTEVENT_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x1271F370)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_POSTEVENT_CONFIGSOUNDACTION_POSTEVENT_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x1271F550)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_POSTEVENT_CONFIGSOUNDACTION_POSTEVENT_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1271F6F0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_POSTEVENT_CONFIGSOUNDACTION_POSTEVENT_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1271F6B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_PostEvent_ConfigSoundAction_PostEvent_UnityGeneratedFormatter_TypeDefinitionIndex = 64731;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigSoundAction_PostEvent_ConfigSoundAction_PostEvent_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x4CB50);
		}
