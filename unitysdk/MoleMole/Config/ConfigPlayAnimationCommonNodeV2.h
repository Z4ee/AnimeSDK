...
#define MOLEMOLE_CONFIG_CONFIGPLAYANIMATIONCOMMONNODEV2_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x162B1520)
#define MOLEMOLE_CONFIG_CONFIGPLAYANIMATIONCOMMONNODEV2__CTOR_OFFSET UNITYSDK_OFFSET(0x162B1590)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPlayAnimationCommonNodeV2_TypeDefinitionIndex = 79013;
	...
	public:
		...
		::System::String* AnimationName4Blackboard; // 0x28
