...
#define MOLEMOLE_CONFIG_CONFIGTESTRANDOMGROUPREGISTERRULE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x12721EF0)
#define MOLEMOLE_CONFIG_CONFIGTESTRANDOMGROUPREGISTERRULE_FROMFLX_OFFSET UNITYSDK_OFFSET(0x12721AE0)
#define MOLEMOLE_CONFIG_CONFIGTESTRANDOMGROUPREGISTERRULE_METHOD_2_6704D57D4F412560_OFFSET UNITYSDK_OFFSET(0x12721970)
#define MOLEMOLE_CONFIG_CONFIGTESTRANDOMGROUPREGISTERRULE_METHOD_2_B73F62522113F21F_OFFSET UNITYSDK_OFFSET(0x12721920)
#define MOLEMOLE_CONFIG_CONFIGTESTRANDOMGROUPREGISTERRULE_METHOD_2_C444D4C8B9D548AF_OFFSET UNITYSDK_OFFSET(0x12721A70)
#define MOLEMOLE_CONFIG_CONFIGTESTRANDOMGROUPREGISTERRULE_METHOD_2_D4C21B672AF27EB8_OFFSET UNITYSDK_OFFSET(0x12722290)
#define MOLEMOLE_CONFIG_CONFIGTESTRANDOMGROUPREGISTERRULE_METHOD_2_DF413489329CBAF8_OFFSET UNITYSDK_OFFSET(0x12721B60)
#define MOLEMOLE_CONFIG_CONFIGTESTRANDOMGROUPREGISTERRULE_METHOD_2_E5BDE724A7C61D22_OFFSET UNITYSDK_OFFSET(0x12722130)
#define MOLEMOLE_CONFIG_CONFIGTESTRANDOMGROUPREGISTERRULE_METHOD_2_FE68BBC7DCCBEB6D_OFFSET UNITYSDK_OFFSET(0x12721F50)
#define MOLEMOLE_CONFIG_CONFIGTESTRANDOMGROUPREGISTERRULE__CTOR_OFFSET UNITYSDK_OFFSET(0x12722120)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTestRandomGroupRegisterRule_TypeDefinitionIndex = 45549;
