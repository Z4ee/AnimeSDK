...
#define MOLEMOLE_CONFIG_HOTPOTFORCEFIELDCONFIG_GET_HASADDITIONALFORCEFIELD_OFFSET UNITYSDK_OFFSET(0x1619CA10)
#define MOLEMOLE_CONFIG_HOTPOTFORCEFIELDCONFIG_GET_HASNOISEFORCEFIELD_OFFSET UNITYSDK_OFFSET(0x1619CA80)
#define MOLEMOLE_CONFIG_HOTPOTFORCEFIELDCONFIG_GET_ISRING_OFFSET UNITYSDK_OFFSET(0x1619CA00)
#define MOLEMOLE_CONFIG_HOTPOTFORCEFIELDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1619CAF0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HotPotForceFieldConfig_TypeDefinitionIndex = 63918;
