...
#define MOLEMOLE_CONFIG_HOTPOTFORCEFIELDCONFIG_GET_HASADDITIONALFORCEFIELD_OFFSET UNITYSDK_OFFSET(0x153D0C50)
#define MOLEMOLE_CONFIG_HOTPOTFORCEFIELDCONFIG_GET_HASNOISEFORCEFIELD_OFFSET UNITYSDK_OFFSET(0x153D0CC0)
#define MOLEMOLE_CONFIG_HOTPOTFORCEFIELDCONFIG_GET_ISRING_OFFSET UNITYSDK_OFFSET(0x153D0C40)
#define MOLEMOLE_CONFIG_HOTPOTFORCEFIELDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x153D0D30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HotPotForceFieldConfig_TypeDefinitionIndex = 45207;
