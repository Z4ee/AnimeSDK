...
#define MOLEMOLE_CONFIG_CONFIGRESETOVERRIDEBUBBLESETTINGNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x18AD7450)
#define MOLEMOLE_CONFIG_CONFIGRESETOVERRIDEBUBBLESETTINGNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x18AD7510)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigResetOverrideBubbleSettingNode_TypeDefinitionIndex = 46717;
