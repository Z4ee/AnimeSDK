...
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_CLONE_OFFSET UNITYSDK_OFFSET(0x1C45AEA0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_FINDBULLETENTITYBYTAG_OFFSET UNITYSDK_OFFSET(0x1147C050)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x1C45AE20)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C45A8A0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1C45AFB0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_GETENTITYPOSROTBYTARGET_OFFSET UNITYSDK_OFFSET(0x1147C250)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x1C45AFA0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_GETTARGETENTITYPOSROT_OFFSET UNITYSDK_OFFSET(0x1147B670)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_GETTARGETENTITY_OFFSET UNITYSDK_OFFSET(0x1147C480)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C45A900)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x1C45B030)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C45AC70)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x1C45B800)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_RESOLVETARGETENTITY_OFFSET UNITYSDK_OFFSET(0x1C4596B0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C45B960)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG___BASE_GETENTITYPOSROTBYTARGET_OFFSET UNITYSDK_OFFSET(0x1C45B970)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG___BASE_GETTARGETENTITYPOSROT_OFFSET UNITYSDK_OFFSET(0x1C45BB50)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG___BASE_GETTARGETENTITY_OFFSET UNITYSDK_OFFSET(0x1C45BA70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPosRotBulletTag_TypeDefinitionIndex = 85127;
	...
	public:
		...
		{
			return ((::Struct_2_FA5F50563E60AFBA(*)(::PVOID, ::MoleMole::Battle::Entity*, ::MoleMole::Battle::Entity*, ::MoleMole::Battle::Entity*, ::Class_2_14986121AA61AD99*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_GETTARGETENTITY_OFFSET))(this, sourceEntity, caster, other, instancedAbility);
		}
		...
		::Struct_2_FA5F50563E60AFBA ResolveTargetEntity(::Struct_2_FA5F50563E60AFBA actor, ::MoleMole::Config::AbilityTargetting referTarget, ::MoleMole::Battle::Entity* caster, ::MoleMole::Battle::Entity* other, ::MoleMole::Config::DynamicString* customKey, ::Class_2_14986121AA61AD99* instancedAbility)
		{
			return ((::Struct_2_FA5F50563E60AFBA(*)(::PVOID, ::Struct_2_FA5F50563E60AFBA, ::MoleMole::Config::AbilityTargetting, ::MoleMole::Battle::Entity*, ::MoleMole::Battle::Entity*, ::MoleMole::Config::DynamicString*, ::Class_2_14986121AA61AD99*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_RESOLVETARGETENTITY_OFFSET))(this, actor, referTarget, caster, other, customKey, instancedAbility);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Struct_2_FA5F50563E60AFBA, ::Struct_2_FA5F50563E60AFBA, ::MoleMole::Config::ReferTargetCoordsOption, ::UnityEngine::Vector3&, ::UnityEngine::Quaternion&, ::UnityEngine::Transform*&, ::Struct_2_69EDF57FCDC7C5D3&, ::System::Boolean, ::MoleMole::Battle::Entity*, ::MoleMole::Battle::Entity*, ::UnityEngine::Transform*, ::Class_2_14986121AA61AD99*, ::MoleMole::Config::DynamicString*, ::MoleMole::Config::DynamicString*, ::System::Boolean, ::Struct_2_FC595D1A561D8C6F_1))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG___BASE_GETENTITYPOSROTBYTARGET_OFFSET))(this, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15);
		}
		...
		{
			return ((::Struct_2_FA5F50563E60AFBA(*)(::PVOID, ::MoleMole::Battle::Entity*, ::MoleMole::Battle::Entity*, ::MoleMole::Battle::Entity*, ::Class_2_14986121AA61AD99*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG___BASE_GETTARGETENTITY_OFFSET))(this, P0, P1, P2, P3);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Struct_2_FA5F50563E60AFBA, ::MoleMole::Config::ReferTargetCoordsOption, ::MoleMole::Config::ReferTargetCoordsOption, ::UnityEngine::Vector3&, ::UnityEngine::Quaternion&, ::Struct_2_FA5F50563E60AFBA&, ::UnityEngine::Transform*&, ::Struct_2_69EDF57FCDC7C5D3&, ::System::Boolean&, ::MoleMole::Battle::Entity*, ::MoleMole::Battle::Entity*, ::Class_2_14986121AA61AD99*, ::MoleMole::Config::DynamicString*, ::MoleMole::Config::DynamicString*, ::MoleMole::Config::DynamicString*, ::MoleMole::Config::DynamicString*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG___BASE_GETTARGETENTITYPOSROT_OFFSET))(this, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16);
		}
	};
}
