...
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_CLONE_OFFSET UNITYSDK_OFFSET(0x1AA59AD0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_FINDBULLETENTITYBYTAG_OFFSET UNITYSDK_OFFSET(0x1AA57BC0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x1AA59A50)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AA594D0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1AA59C40)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_GETENTITYPOSROTBYTARGET_OFFSET UNITYSDK_OFFSET(0x1AA591A0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x1AA59BD0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_GETTARGETENTITYPOSROT_OFFSET UNITYSDK_OFFSET(0x1AA57170)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_GETTARGETENTITY_OFFSET UNITYSDK_OFFSET(0x1AA593D0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AA59530)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x1AA59CC0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AA598A0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x1AA5A4D0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG_RESOLVETARGETENTITY_OFFSET UNITYSDK_OFFSET(0x1AA57DC0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA5A630)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG___BASE_GETENTITYPOSROTBYTARGET_OFFSET UNITYSDK_OFFSET(0x1AA5A640)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG___BASE_GETTARGETENTITYPOSROT_OFFSET UNITYSDK_OFFSET(0x1AA5A820)
#define MOLEMOLE_CONFIG_CONFIGPOSROTBULLETTAG___BASE_GETTARGETENTITY_OFFSET UNITYSDK_OFFSET(0x1AA5A740)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPosRotBulletTag_TypeDefinitionIndex = 74496;
	...
	public:
		...
		::MoleMole::Config::AbilityTargetting OffsetReferTarget; // 0x28
		::System::Boolean IsUseAttachPoint; // 0x2C
