...
#define MOLEMOLE_CONFIG_CONFIGANIMATORBOOLPARAM_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x7D5D90)
#define MOLEMOLE_CONFIG_CONFIGANIMATORBOOLPARAM_FROMFLX_OFFSET UNITYSDK_OFFSET(0x7D5D00)
#define MOLEMOLE_CONFIG_CONFIGANIMATORBOOLPARAM_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x7D5DF0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORBOOLPARAM_METHOD_2_F777B3BEDBE68D53_OFFSET UNITYSDK_OFFSET(0x7D5E20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAnimatorBoolParam_TypeDefinitionIndex = 72324;
