...
#define MOLEMOLE_CONFIG_CONFIGANIMATORBOOLPARAM_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x8CCE00)
#define MOLEMOLE_CONFIG_CONFIGANIMATORBOOLPARAM_FROMFLX_OFFSET UNITYSDK_OFFSET(0x8CCD70)
#define MOLEMOLE_CONFIG_CONFIGANIMATORBOOLPARAM_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x8CCE70)
#define MOLEMOLE_CONFIG_CONFIGANIMATORBOOLPARAM_METHOD_2_F777B3BEDBE68D53_OFFSET UNITYSDK_OFFSET(0x8CCE60)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAnimatorBoolParam_TypeDefinitionIndex = 61446;
