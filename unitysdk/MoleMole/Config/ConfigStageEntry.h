...
#define MOLEMOLE_CONFIG_CONFIGSTAGEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x183CE690)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigStageEntry_TypeDefinitionIndex = 37965;
