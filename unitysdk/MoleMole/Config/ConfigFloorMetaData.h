...
#define MOLEMOLE_CONFIG_CONFIGFLOORMETADATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1102B090)
#define MOLEMOLE_CONFIG_CONFIGFLOORMETADATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1102AB70)
#define MOLEMOLE_CONFIG_CONFIGFLOORMETADATA_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0x1102ABF0)
#define MOLEMOLE_CONFIG_CONFIGFLOORMETADATA_METHOD_1_BF50AF6BCBDE0EBC_OFFSET UNITYSDK_OFFSET(0x1102B0F0)
#define MOLEMOLE_CONFIG_CONFIGFLOORMETADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1102B430)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigFloorMetaData_TypeDefinitionIndex = 61803;
