...
#define MOLEMOLE_CONFIG_CONFIGUIVIRTUALJOYSTICK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA656B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUIVirtualJoystick_TypeDefinitionIndex = 80043;
