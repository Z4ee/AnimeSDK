...
#define MOLEMOLE_CONFIG_CONFIGGACHAPERFORMANCEROTATECAM_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x143758F0)
#define MOLEMOLE_CONFIG_CONFIGGACHAPERFORMANCEROTATECAM__CTOR_OFFSET UNITYSDK_OFFSET(0x14375960)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigGachaPerformanceRotateCam_TypeDefinitionIndex = 47021;
