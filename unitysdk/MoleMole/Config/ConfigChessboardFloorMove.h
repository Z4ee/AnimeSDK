...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDFLOORMOVE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x12B35ED0)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDFLOORMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x12B35F50)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardFloorMove_TypeDefinitionIndex = 48248;
