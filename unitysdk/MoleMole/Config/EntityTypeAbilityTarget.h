...
#define MOLEMOLE_CONFIG_ENTITYTYPEABILITYTARGET_METHOD_3_78BB607F43B05857_OFFSET UNITYSDK_OFFSET(0x12432A50)
#define MOLEMOLE_CONFIG_ENTITYTYPEABILITYTARGET_METHOD_3_7D517655F72D87C3_OFFSET UNITYSDK_OFFSET(0x12432900)
#define MOLEMOLE_CONFIG_ENTITYTYPEABILITYTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x12432A40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int EntityTypeAbilityTarget_TypeDefinitionIndex = 81909;
