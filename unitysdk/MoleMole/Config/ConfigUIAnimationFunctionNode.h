...
#define MOLEMOLE_CONFIG_CONFIGUIANIMATIONFUNCTIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x16266BA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUIAnimationFunctionNode_TypeDefinitionIndex = 65470;
	...
	public:
		...
		::System::Collections::Generic::List_1<::System::Int32>* InputIndexList; // 0x28
