...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_QUEST_EVALUATE_OFFSET UNITYSDK_OFFSET(0x177E2380)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_QUEST_GET_INSPECTORLABEL_OFFSET UNITYSDK_OFFSET(0x177E2340)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_QUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x177E2720)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundActionTriggerCondition_Quest_TypeDefinitionIndex = 90404;
