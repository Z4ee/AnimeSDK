...
#define MOLEMOLE_CONFIG_CONFIGOPENLEVELRESULTNODE_COMMITVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1A352300)
#define MOLEMOLE_CONFIG_CONFIGOPENLEVELRESULTNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x1A352350)
#define MOLEMOLE_CONFIG_CONFIGOPENLEVELRESULTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3523C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigOpenLevelResultNode_TypeDefinitionIndex = 74820;
