...
#define MOLEMOLE_CONFIG_LIGHTBREATHDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1350E2E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int LightBreathData_TypeDefinitionIndex = 46507;
