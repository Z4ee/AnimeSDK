...
#define MOLEMOLE_CONFIG_CONFIGDAMAGESTAGGERLEVEL_DAMAGESTAGGERLEVELITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x11026BF0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDamageStaggerLevel_DamageStaggerLevelItem_TypeDefinitionIndex = 79437;

	class ConfigDamageStaggerLevel_DamageStaggerLevelItem : public ::System::Object
	{
	public:
		::MoleMole::Config::AnimatorHitEffect attackFrameHitEffect; // 0x10
