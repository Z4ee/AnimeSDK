...
#define MOLEMOLE_CONFIG_CONFIGINTERACTENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xF97E1C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigInteractEntry_TypeDefinitionIndex = 49110;
