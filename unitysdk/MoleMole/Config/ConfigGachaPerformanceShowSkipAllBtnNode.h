...
#define MOLEMOLE_CONFIG_CONFIGGACHAPERFORMANCESHOWSKIPALLBTNNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x139A2DC0)
#define MOLEMOLE_CONFIG_CONFIGGACHAPERFORMANCESHOWSKIPALLBTNNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x139A2E30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigGachaPerformanceShowSkipAllBtnNode_TypeDefinitionIndex = 45826;
