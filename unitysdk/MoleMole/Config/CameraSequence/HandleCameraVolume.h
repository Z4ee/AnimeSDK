...
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_HANDLECAMERAVOLUME_BUILDRUNTIMEDATAPROVIDERDATAPATH_OFFSET UNITYSDK_OFFSET(0x13999E80)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_HANDLECAMERAVOLUME_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x13999EF0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_HANDLECAMERAVOLUME_GETRATESCALE_OFFSET UNITYSDK_OFFSET(0x1399A0A0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_HANDLECAMERAVOLUME_GETSEQUENCEDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x1399A140)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_HANDLECAMERAVOLUME_GETSEQUENCELENGTH_OFFSET UNITYSDK_OFFSET(0x1399A050)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_HANDLECAMERAVOLUME_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1399A130)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_HANDLECAMERAVOLUME_ISLOOP_OFFSET UNITYSDK_OFFSET(0x1399A0F0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_HANDLECAMERAVOLUME_METHOD_5_0FAC3EB0A072AD38_OFFSET UNITYSDK_OFFSET(0x1399A8E0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_HANDLECAMERAVOLUME_METHOD_5_83ED25F6A8C66D20_OFFSET UNITYSDK_OFFSET(0x1399A830)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_HANDLECAMERAVOLUME__CCTOR_OFFSET UNITYSDK_OFFSET(0x1399A7B0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_HANDLECAMERAVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x1399A750)

namespace MoleMole::Config::CameraSequence
{
	inline static constexpr unsigned int HandleCameraVolume_TypeDefinitionIndex = 82686;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(HandleCameraVolume_TypeDefinitionIndex)->GetStaticField(0xFE40);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_NearClipPlane()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(HandleCameraVolume_TypeDefinitionIndex)->GetStaticField(0xFE48);
		}
