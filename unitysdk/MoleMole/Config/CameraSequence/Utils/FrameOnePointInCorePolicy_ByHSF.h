...
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYHSF_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0xFAFD5F0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYHSF_GETDATA_OFFSET UNITYSDK_OFFSET(0xFAFD790)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYHSF_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0xFAFDFC0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYHSF_METHOD_4_0BC937355C326A37_OFFSET UNITYSDK_OFFSET(0xFAFE270)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYHSF_METHOD_4_439B588EB4881570_OFFSET UNITYSDK_OFFSET(0xFAFE4C0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYHSF_METHOD_4_5A60CCF7370A1875_OFFSET UNITYSDK_OFFSET(0xFAFE550)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYHSF_METHOD_4_834919B5E4C42716_OFFSET UNITYSDK_OFFSET(0xFAFE410)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYHSF_METHOD_4_83ED25F6A8C66D20_OFFSET UNITYSDK_OFFSET(0xFAFE1C0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYHSF_METHOD_4_C1397965C8E8E75A_1_OFFSET UNITYSDK_OFFSET(0xFAFE640)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYHSF_METHOD_4_C1397965C8E8E75A_OFFSET UNITYSDK_OFFSET(0xFAFE110)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYHSF_SETPATH_OFFSET UNITYSDK_OFFSET(0xFAFD550)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYHSF__CCTOR_OFFSET UNITYSDK_OFFSET(0xFAFE030)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYHSF__CTOR_OFFSET UNITYSDK_OFFSET(0xFAFDFD0)

namespace MoleMole::Config::CameraSequence::Utils
{
	inline static constexpr unsigned int FrameOnePointInCorePolicy_ByHSF_TypeDefinitionIndex = 61918;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOnePointInCorePolicy_ByHSF_TypeDefinitionIndex)->GetStaticField(0x104B0);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_fieldOfView()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOnePointInCorePolicy_ByHSF_TypeDefinitionIndex)->GetStaticField(0x104B8);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_heightRatio()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOnePointInCorePolicy_ByHSF_TypeDefinitionIndex)->GetStaticField(0x104C0);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_screenOffset()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOnePointInCorePolicy_ByHSF_TypeDefinitionIndex)->GetStaticField(0x104C8);
		}
