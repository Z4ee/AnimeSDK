...
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_CAMERAROTATIONBASEDONENTITYPOLICY_BYEULEROFFSET_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1AA48520)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_CAMERAROTATIONBASEDONENTITYPOLICY_BYEULEROFFSET_GETDATA_OFFSET UNITYSDK_OFFSET(0x1AA486D0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_CAMERAROTATIONBASEDONENTITYPOLICY_BYEULEROFFSET_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1AA486C0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_CAMERAROTATIONBASEDONENTITYPOLICY_BYEULEROFFSET_METHOD_4_439B588EB4881570_OFFSET UNITYSDK_OFFSET(0x1AA48A20)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_CAMERAROTATIONBASEDONENTITYPOLICY_BYEULEROFFSET_METHOD_4_5A60CCF7370A1875_OFFSET UNITYSDK_OFFSET(0x1AA488B0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_CAMERAROTATIONBASEDONENTITYPOLICY_BYEULEROFFSET_METHOD_4_C4E80F21AB9896CD_OFFSET UNITYSDK_OFFSET(0x1AA489A0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_CAMERAROTATIONBASEDONENTITYPOLICY_BYEULEROFFSET_SETPATH_OFFSET UNITYSDK_OFFSET(0x1AA48480)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_CAMERAROTATIONBASEDONENTITYPOLICY_BYEULEROFFSET__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AA48800)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_CAMERAROTATIONBASEDONENTITYPOLICY_BYEULEROFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA487E0)

namespace MoleMole::Config::CameraSequence::Utils
{
	inline static constexpr unsigned int CameraRotationBasedOnEntityPolicy_ByEulerOffset_TypeDefinitionIndex = 43952;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraRotationBasedOnEntityPolicy_ByEulerOffset_TypeDefinitionIndex)->GetStaticField(0xDA20);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_rollOffset()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraRotationBasedOnEntityPolicy_ByEulerOffset_TypeDefinitionIndex)->GetStaticField(0xDA28);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_pitchOffset()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraRotationBasedOnEntityPolicy_ByEulerOffset_TypeDefinitionIndex)->GetStaticField(0xDA30);
		}
