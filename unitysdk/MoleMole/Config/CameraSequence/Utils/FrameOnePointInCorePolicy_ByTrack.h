...
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYTRACK_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0xF135030)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYTRACK_GETDATA_OFFSET UNITYSDK_OFFSET(0xF1351D0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYTRACK_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0xF136000)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYTRACK_METHOD_4_3A4F5AFDD5EDA7E8_OFFSET UNITYSDK_OFFSET(0xF136A60)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYTRACK_METHOD_4_439B588EB4881570_OFFSET UNITYSDK_OFFSET(0xF1369D0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYTRACK_METHOD_4_5A60CCF7370A1875_OFFSET UNITYSDK_OFFSET(0xF136D90)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYTRACK_METHOD_4_7BF10D4C7D9273A9_OFFSET UNITYSDK_OFFSET(0xF1364C0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYTRACK_METHOD_4_82BB2091A09B39AA_OFFSET UNITYSDK_OFFSET(0xF136240)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYTRACK_METHOD_4_83ED25F6A8C66D20_1_OFFSET UNITYSDK_OFFSET(0xF136920)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYTRACK_METHOD_4_83ED25F6A8C66D20_OFFSET UNITYSDK_OFFSET(0xF136870)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYTRACK_METHOD_4_BB096144B8EC6BDD_OFFSET UNITYSDK_OFFSET(0xF136570)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYTRACK_METHOD_4_C1397965C8E8E75A_OFFSET UNITYSDK_OFFSET(0xF136E80)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYTRACK_METHOD_4_C1CB23F7C9B9A9B2_OFFSET UNITYSDK_OFFSET(0xF136C50)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYTRACK_METHOD_4_FA27288D2ACD8E44_1_OFFSET UNITYSDK_OFFSET(0xF1366B0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYTRACK_METHOD_4_FA27288D2ACD8E44_OFFSET UNITYSDK_OFFSET(0xF1362F0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYTRACK_SETPATH_OFFSET UNITYSDK_OFFSET(0xF134F90)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYTRACK__CCTOR_OFFSET UNITYSDK_OFFSET(0xF136130)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xF136010)

namespace MoleMole::Config::CameraSequence::Utils
{
	inline static constexpr unsigned int FrameOnePointInCorePolicy_ByTrack_TypeDefinitionIndex = 86848;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOnePointInCorePolicy_ByTrack_TypeDefinitionIndex)->GetStaticField(0x12C60);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_ElevationRatio()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOnePointInCorePolicy_ByTrack_TypeDefinitionIndex)->GetStaticField(0x12C68);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_PolarAngle()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOnePointInCorePolicy_ByTrack_TypeDefinitionIndex)->GetStaticField(0x12C70);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_screenOffset()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOnePointInCorePolicy_ByTrack_TypeDefinitionIndex)->GetStaticField(0x12C78);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_fieldOfView()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOnePointInCorePolicy_ByTrack_TypeDefinitionIndex)->GetStaticField(0x12C80);
		}
