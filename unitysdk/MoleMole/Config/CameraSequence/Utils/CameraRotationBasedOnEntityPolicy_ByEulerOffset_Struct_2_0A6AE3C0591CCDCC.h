...
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_CAMERAROTATIONBASEDONENTITYPOLICY_BYEULEROFFSET_STRUCT_2_0A6AE3C0591CCDCC_METHOD_2_4754F71558997746_OFFSET UNITYSDK_OFFSET(0x86ED70)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_CAMERAROTATIONBASEDONENTITYPOLICY_BYEULEROFFSET_STRUCT_2_0A6AE3C0591CCDCC__CTOR_OFFSET UNITYSDK_OFFSET(0x86ED60)

namespace MoleMole::Config::CameraSequence::Utils
{
	inline static constexpr unsigned int CameraRotationBasedOnEntityPolicy_ByEulerOffset_Struct_2_0A6AE3C0591CCDCC_TypeDefinitionIndex = 88645;
