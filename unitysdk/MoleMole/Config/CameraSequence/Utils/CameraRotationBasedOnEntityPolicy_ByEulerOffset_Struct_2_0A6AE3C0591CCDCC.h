...
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_CAMERAROTATIONBASEDONENTITYPOLICY_BYEULEROFFSET_STRUCT_2_0A6AE3C0591CCDCC_METHOD_2_4754F71558997746_OFFSET UNITYSDK_OFFSET(0x7D5CA0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_CAMERAROTATIONBASEDONENTITYPOLICY_BYEULEROFFSET_STRUCT_2_0A6AE3C0591CCDCC__CTOR_OFFSET UNITYSDK_OFFSET(0x7D5C90)

namespace MoleMole::Config::CameraSequence::Utils
{
	inline static constexpr unsigned int CameraRotationBasedOnEntityPolicy_ByEulerOffset_Struct_2_0A6AE3C0591CCDCC_TypeDefinitionIndex = 68520;
