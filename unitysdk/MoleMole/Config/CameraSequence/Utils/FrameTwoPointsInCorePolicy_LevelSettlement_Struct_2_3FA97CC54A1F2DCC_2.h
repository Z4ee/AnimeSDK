...
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMETWOPOINTSINCOREPOLICY_LEVELSETTLEMENT_STRUCT_2_3FA97CC54A1F2DCC_2_COMPARE_OFFSET UNITYSDK_OFFSET(0x7F6A70)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMETWOPOINTSINCOREPOLICY_LEVELSETTLEMENT_STRUCT_2_3FA97CC54A1F2DCC_2_GET_MAXPITCH_OFFSET UNITYSDK_OFFSET(0x7F6AD0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMETWOPOINTSINCOREPOLICY_LEVELSETTLEMENT_STRUCT_2_3FA97CC54A1F2DCC_2_GET_MINPITCH_OFFSET UNITYSDK_OFFSET(0x7F6AC0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMETWOPOINTSINCOREPOLICY_LEVELSETTLEMENT_STRUCT_2_3FA97CC54A1F2DCC_2__CTOR_OFFSET UNITYSDK_OFFSET(0x7F69D0)

namespace MoleMole::Config::CameraSequence::Utils
{
	inline static constexpr unsigned int FrameTwoPointsInCorePolicy_LevelSettlement_Struct_2_3FA97CC54A1F2DCC_2_TypeDefinitionIndex = 65188;
