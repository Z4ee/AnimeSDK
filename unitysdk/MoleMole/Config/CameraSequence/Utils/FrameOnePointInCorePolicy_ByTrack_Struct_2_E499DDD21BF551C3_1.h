...
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYTRACK_STRUCT_2_E499DDD21BF551C3_1_COMPARE_OFFSET UNITYSDK_OFFSET(0x640130)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYTRACK_STRUCT_2_E499DDD21BF551C3_1_GET_MAXPITCH_OFFSET UNITYSDK_OFFSET(0x640190)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYTRACK_STRUCT_2_E499DDD21BF551C3_1_GET_MINPITCH_OFFSET UNITYSDK_OFFSET(0x640180)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYTRACK_STRUCT_2_E499DDD21BF551C3_1__CTOR_OFFSET UNITYSDK_OFFSET(0x6400F0)

namespace MoleMole::Config::CameraSequence::Utils
{
	inline static constexpr unsigned int FrameOnePointInCorePolicy_ByTrack_Struct_2_E499DDD21BF551C3_1_TypeDefinitionIndex = 65744;
