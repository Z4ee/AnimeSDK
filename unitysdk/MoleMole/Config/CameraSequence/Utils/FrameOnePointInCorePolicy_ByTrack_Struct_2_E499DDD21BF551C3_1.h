...
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYTRACK_STRUCT_2_E499DDD21BF551C3_1_COMPARE_OFFSET UNITYSDK_OFFSET(0x76F010)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYTRACK_STRUCT_2_E499DDD21BF551C3_1_GET_MAXPITCH_OFFSET UNITYSDK_OFFSET(0x6FC3C0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYTRACK_STRUCT_2_E499DDD21BF551C3_1_GET_MINPITCH_OFFSET UNITYSDK_OFFSET(0x6FC3B0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYTRACK_STRUCT_2_E499DDD21BF551C3_1__CTOR_OFFSET UNITYSDK_OFFSET(0x6FC320)

namespace MoleMole::Config::CameraSequence::Utils
{
	inline static constexpr unsigned int FrameOnePointInCorePolicy_ByTrack_Struct_2_E499DDD21BF551C3_1_TypeDefinitionIndex = 62116;
