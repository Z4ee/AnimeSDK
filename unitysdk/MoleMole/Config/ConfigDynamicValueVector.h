...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEVECTOR_CLONE_OFFSET UNITYSDK_OFFSET(0x110A0730)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEVECTOR_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x110A0720)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEVECTOR_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x110A0C20)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEVECTOR_FROMFLX_OFFSET UNITYSDK_OFFSET(0x110A08A0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEVECTOR_GETCONFIGDYNAMICVALUETYPE_OFFSET UNITYSDK_OFFSET(0x110A0590)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEVECTOR_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x110A0830)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEVECTOR_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x110A0C80)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEVECTOR_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x110A0920)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEVECTOR_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x110A05E0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEVECTOR_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x110A0DE0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEVECTOR_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x110A0AC0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEVECTOR_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0x110A04C0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x110A06D0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEVECTOR___BASE_GETCONFIGDYNAMICVALUETYPE_OFFSET UNITYSDK_OFFSET(0x110A0F90)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicValueVector_TypeDefinitionIndex = 61686;
