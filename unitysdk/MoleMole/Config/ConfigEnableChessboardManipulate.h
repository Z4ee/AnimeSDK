...
#define MOLEMOLE_CONFIG_CONFIGENABLECHESSBOARDMANIPULATE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x12712C20)
#define MOLEMOLE_CONFIG_CONFIGENABLECHESSBOARDMANIPULATE__CTOR_OFFSET UNITYSDK_OFFSET(0x12712CE0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEnableChessboardManipulate_TypeDefinitionIndex = 41785;
