...
#define MOLEMOLE_CONFIG_CONFIGTARGETBUDDYTYPEFILTER_COMPAREBUDDYTYPE_OFFSET UNITYSDK_OFFSET(0x186BF220)
#define MOLEMOLE_CONFIG_CONFIGTARGETBUDDYTYPEFILTER_VALUEPASS_OFFSET UNITYSDK_OFFSET(0x186BF110)
#define MOLEMOLE_CONFIG_CONFIGTARGETBUDDYTYPEFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x186BF380)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTargetBuddyTypeFilter_TypeDefinitionIndex = 54023;
