...
#define MOLEMOLE_CONFIG_GOALPATHTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xFB0F400)

namespace MoleMole::Config
{
	inline static constexpr unsigned int GoalPathTypeConfig_TypeDefinitionIndex = 41556;
