...
#define MOLEMOLE_CONFIG_GOALPATHTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19ACE410)

namespace MoleMole::Config
{
	inline static constexpr unsigned int GoalPathTypeConfig_TypeDefinitionIndex = 78979;
