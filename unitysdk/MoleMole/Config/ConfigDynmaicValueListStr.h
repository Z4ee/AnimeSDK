...
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_CLONE_OFFSET UNITYSDK_OFFSET(0x162AA790)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x162AA740)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x162AACE0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_FROMFLX_OFFSET UNITYSDK_OFFSET(0x162AA900)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x162AA890)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x162AAD40)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x162AA980)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x162AAFA0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x162AAB80)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0x162AA5F0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR__CTOR_OFFSET UNITYSDK_OFFSET(0x162AB150)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynmaicValueListStr_TypeDefinitionIndex = 72465;
