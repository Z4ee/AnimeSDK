...
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_CLONE_OFFSET UNITYSDK_OFFSET(0x139A1A90)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x139A1A40)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x139A1FE0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_FROMFLX_OFFSET UNITYSDK_OFFSET(0x139A1C00)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x139A1B90)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x139A2040)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x139A1C80)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x139A22A0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x139A1E80)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0x139A18F0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR__CTOR_OFFSET UNITYSDK_OFFSET(0x139A2450)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynmaicValueListStr_TypeDefinitionIndex = 53334;
