...
#define MOLEMOLE_CONFIG_CONFIGGADGETMETADATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17048C10)
#define MOLEMOLE_CONFIG_CONFIGGADGETMETADATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x17048BA0)
#define MOLEMOLE_CONFIG_CONFIGGADGETMETADATA_METHOD_1_9B00DC6B301F3F39_OFFSET UNITYSDK_OFFSET(0x17048C20)
#define MOLEMOLE_CONFIG_CONFIGGADGETMETADATA_METHOD_1_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x17048C00)
#define MOLEMOLE_CONFIG_CONFIGGADGETMETADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17048C30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigGadgetMetaData_TypeDefinitionIndex = 58582;
