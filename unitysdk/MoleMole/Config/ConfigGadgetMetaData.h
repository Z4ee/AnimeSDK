...
#define MOLEMOLE_CONFIG_CONFIGGADGETMETADATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1744C990)
#define MOLEMOLE_CONFIG_CONFIGGADGETMETADATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1744C920)
#define MOLEMOLE_CONFIG_CONFIGGADGETMETADATA_METHOD_1_9B00DC6B301F3F39_OFFSET UNITYSDK_OFFSET(0x1744C9A0)
#define MOLEMOLE_CONFIG_CONFIGGADGETMETADATA_METHOD_1_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x1744C980)
#define MOLEMOLE_CONFIG_CONFIGGADGETMETADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1744C9B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigGadgetMetaData_TypeDefinitionIndex = 52097;
