...
#define MOLEMOLE_CONFIG_CONFIGMATERIALKEYWORDCONDITION_CHECK_OFFSET UNITYSDK_OFFSET(0x1B54EB40)
#define MOLEMOLE_CONFIG_CONFIGMATERIALKEYWORDCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B54ED40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMaterialKeywordCondition_TypeDefinitionIndex = 88838;
