...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEPATROLPOINTSET_CLONE_OFFSET UNITYSDK_OFFSET(0xF139B80)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEPATROLPOINTSET_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0xF139B30)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEPATROLPOINTSET_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xF13A0B0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEPATROLPOINTSET_FROMFLX_OFFSET UNITYSDK_OFFSET(0xF139C90)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEPATROLPOINTSET_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0xF139C80)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEPATROLPOINTSET_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0xF13A110)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEPATROLPOINTSET_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0xF139D10)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEPATROLPOINTSET_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0xF13A2E0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEPATROLPOINTSET_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0xF139F50)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEPATROLPOINTSET_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0xF1399E0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEPATROLPOINTSET__CTOR_OFFSET UNITYSDK_OFFSET(0xF13A490)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicValuePatrolPointSet_TypeDefinitionIndex = 84310;
