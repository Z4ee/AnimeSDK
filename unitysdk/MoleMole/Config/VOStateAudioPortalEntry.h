...
#define MOLEMOLE_CONFIG_VOSTATEAUDIOPORTALENTRY_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1272C150)
#define MOLEMOLE_CONFIG_VOSTATEAUDIOPORTALENTRY_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1272BA90)
#define MOLEMOLE_CONFIG_VOSTATEAUDIOPORTALENTRY_METHOD_1_03482897E56BA861_OFFSET UNITYSDK_OFFSET(0x1272C1B0)
#define MOLEMOLE_CONFIG_VOSTATEAUDIOPORTALENTRY_METHOD_1_DF413489329CBAF8_OFFSET UNITYSDK_OFFSET(0x1272BB10)
#define MOLEMOLE_CONFIG_VOSTATEAUDIOPORTALENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1272C4F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int VOStateAudioPortalEntry_TypeDefinitionIndex = 61390;
