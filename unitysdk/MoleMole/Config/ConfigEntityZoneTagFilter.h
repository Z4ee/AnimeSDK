...
#define MOLEMOLE_CONFIG_CONFIGENTITYZONETAGFILTER_MATCHZONETAG_OFFSET UNITYSDK_OFFSET(0x1625D690)
#define MOLEMOLE_CONFIG_CONFIGENTITYZONETAGFILTER_VALUEPASS_OFFSET UNITYSDK_OFFSET(0x1625D5E0)
#define MOLEMOLE_CONFIG_CONFIGENTITYZONETAGFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1625D7A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityZoneTagFilter_TypeDefinitionIndex = 90160;
