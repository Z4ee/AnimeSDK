...
#define MOLEMOLE_CONFIG_CONFIGENTITYZONETAGFILTER_MATCHZONETAG_OFFSET UNITYSDK_OFFSET(0x18F34E10)
#define MOLEMOLE_CONFIG_CONFIGENTITYZONETAGFILTER_VALUEPASS_OFFSET UNITYSDK_OFFSET(0x18F34D60)
#define MOLEMOLE_CONFIG_CONFIGENTITYZONETAGFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18F34F20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityZoneTagFilter_TypeDefinitionIndex = 83165;
