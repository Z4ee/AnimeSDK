...
#define MOLEMOLE_CONFIG_CONFIGENTITYALIVESTATEFILTER_VALUEPASS_OFFSET UNITYSDK_OFFSET(0x16A87520)
#define MOLEMOLE_CONFIG_CONFIGENTITYALIVESTATEFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x16A876C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityAliveStateFilter_TypeDefinitionIndex = 69761;
