...
#define MOLEMOLE_CONFIG_CONFIGSHOWBLESSITEMTIPSNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x16B3FC00)
#define MOLEMOLE_CONFIG_CONFIGSHOWBLESSITEMTIPSNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x16B3FCC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigShowBlessItemTipsNode_TypeDefinitionIndex = 46244;
