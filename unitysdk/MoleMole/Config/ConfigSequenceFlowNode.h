...
#define MOLEMOLE_CONFIG_CONFIGSEQUENCEFLOWNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xF98A560)
#define MOLEMOLE_CONFIG_CONFIGSEQUENCEFLOWNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xF98A650)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSequenceFlowNode_TypeDefinitionIndex = 81267;
