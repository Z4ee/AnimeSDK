...
#define MOLEMOLE_CONFIG_ANIMATORZONEPUSHALLIESDITHERLOCKZONE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x14362630)
#define MOLEMOLE_CONFIG_ANIMATORZONEPUSHALLIESDITHERLOCKZONE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x143626C0)
#define MOLEMOLE_CONFIG_ANIMATORZONEPUSHALLIESDITHERLOCKZONE__CTOR_OFFSET UNITYSDK_OFFSET(0x14362750)
#define MOLEMOLE_CONFIG_ANIMATORZONEPUSHALLIESDITHERLOCKZONE___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x14362760)
#define MOLEMOLE_CONFIG_ANIMATORZONEPUSHALLIESDITHERLOCKZONE___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x14362810)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZonePushAlliesDitherLockZone_TypeDefinitionIndex = 88540;
