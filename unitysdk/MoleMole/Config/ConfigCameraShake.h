...
#define MOLEMOLE_CONFIG_CONFIGCAMERASHAKE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x177D76C0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASHAKE_FROMFLX_OFFSET UNITYSDK_OFFSET(0x177D51B0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASHAKE_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x177D7720)
#define MOLEMOLE_CONFIG_CONFIGCAMERASHAKE_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x177D5230)
#define MOLEMOLE_CONFIG_CONFIGCAMERASHAKE__CTOR_OFFSET UNITYSDK_OFFSET(0x177D7F40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraShake_TypeDefinitionIndex = 72480;
	...
	public:
		...
		::System::String* FadeInCurve; // 0x28
		::System::String* FadeOutCurve; // 0x30
		::System::String* StandardConfigKey; // 0x38
		::System::Single NoiseAngle; // 0x40
		::System::Single PitchAmplitude; // 0x44
		::System::Single ShakeTotalTime; // 0x48
		::System::Int32 PlayPriority; // 0x4C
		::System::Single Frequency; // 0x50
		::MoleMole::Config::ShakeType ShakeType; // 0x54
		::System::Boolean IngoreTimeScale; // 0x58
		::System::Boolean RealtimeVibration; // 0x59
		::System::Single DistanceToPlane; // 0x5C
		::System::Single FadeOutDuration; // 0x60
		::MoleMole::Config::DissipationMode DissipationMode; // 0x64
		::MoleMole::Config::ConfigDataPriority DataPriority; // 0x68
		::System::Single AngleVertical; // 0x6C
		::System::Single RadiusLength; // 0x70
		::MoleMole::Config::ConfigDataPlayStacking PlayStackingType; // 0x74
		::System::Single ImpactRadius; // 0x78
		::System::Single NoiseRatio; // 0x7C
		::System::Single DissipationDistance; // 0x80
		::MoleMole::Config::AttackPropConfigType CameraShakePropConfigEnum; // 0x84
		::System::Single RollAmplitude; // 0x88
		::System::Single FadeInDuration; // 0x8C
		::System::Single YawAmplitude; // 0x90
