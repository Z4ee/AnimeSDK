...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWWATERFLOWQTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B54E950)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowWaterFlowQTE_TypeDefinitionIndex = 71637;
