...
#define MOLEMOLE_NAPCAMERAS_UTILS_DEBUGDRAW_AWAKE_OFFSET UNITYSDK_OFFSET(0x164231A0)
#define MOLEMOLE_NAPCAMERAS_UTILS_DEBUGDRAW_UPDATE_OFFSET UNITYSDK_OFFSET(0x16423340)
#define MOLEMOLE_NAPCAMERAS_UTILS_DEBUGDRAW__CCTOR_OFFSET UNITYSDK_OFFSET(0x164235C0)
#define MOLEMOLE_NAPCAMERAS_UTILS_DEBUGDRAW__CTOR_OFFSET UNITYSDK_OFFSET(0x16423570)

namespace MoleMole::NAPCameras::Utils
{
	inline static constexpr unsigned int DebugDraw_TypeDefinitionIndex = 61928;
	...
	public:
		...
		{
			return (::MoleMole::NAPCameras::Utils::DebugDraw**)Il2CppClass::FromTypeDefinitionIndex(DebugDraw_TypeDefinitionIndex)->GetStaticField(0x4CDC0);
		}
		static ::System::Boolean* StaticGet_Enabled()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(DebugDraw_TypeDefinitionIndex)->GetStaticField(0x126A0);
		}
