...
#define MOLEMOLE_KEYBOARDMOUSEKEYBINDINGSETTINGENTRY_GET_SETTINGRAWINPUTDEVICELIST_OFFSET UNITYSDK_OFFSET(0x10BC5D40)
#define MOLEMOLE_KEYBOARDMOUSEKEYBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x10BC5D10)
#define MOLEMOLE_KEYBOARDMOUSEKEYBINDINGSETTINGENTRY___BASE_GET_SETTINGRAWINPUTDEVICELIST_OFFSET UNITYSDK_OFFSET(0x10BC5E10)

namespace MoleMole
{
	inline static constexpr unsigned int KeyboardMouseKeyBindingSettingEntry_TypeDefinitionIndex = 39304;
