...
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___ONBATTLEREADY_G__COMATCHREADY_49_0_D_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x12F3BDD0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___ONBATTLEREADY_G__COMATCHREADY_49_0_D_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x12F3C090)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___ONBATTLEREADY_G__COMATCHREADY_49_0_D_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x12F3C0F0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___ONBATTLEREADY_G__COMATCHREADY_49_0_D_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x12F3C0A0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___ONBATTLEREADY_G__COMATCHREADY_49_0_D_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x12F3BDC0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___ONBATTLEREADY_G__COMATCHREADY_49_0_D__CTOR_OFFSET UNITYSDK_OFFSET(0x12F3BDB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeTeamChildWindowController___OnBattleReady_g__CoMatchReady_49_0_d_TypeDefinitionIndex = 77469;

	class UIArcadeTeamChildWindowController___OnBattleReady_g__CoMatchReady_49_0_d : public ::System::Object
	{
	public:
		::System::Action* callback; // 0x10
		::MoleMole::UIArcadeTeamChildWindowController___c__DisplayClass49_0* __8__1; // 0x18
