...
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___ONBATTLEREADY_G__COMATCHREADY_49_0_D_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1600AD00)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___ONBATTLEREADY_G__COMATCHREADY_49_0_D_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1600AFD0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___ONBATTLEREADY_G__COMATCHREADY_49_0_D_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1600B030)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___ONBATTLEREADY_G__COMATCHREADY_49_0_D_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1600AFE0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___ONBATTLEREADY_G__COMATCHREADY_49_0_D_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1600ACF0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___ONBATTLEREADY_G__COMATCHREADY_49_0_D__CTOR_OFFSET UNITYSDK_OFFSET(0x1600ACE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeTeamChildWindowController___OnBattleReady_g__CoMatchReady_49_0_d_TypeDefinitionIndex = 65756;
