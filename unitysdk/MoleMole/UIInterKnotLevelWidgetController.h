...
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER_CALPREVYOROZUYALV_OFFSET UNITYSDK_OFFSET(0x16091EC0)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16091820)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER_ONPROGRESS_OFFSET UNITYSDK_OFFSET(0x16092C70)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x160918B0)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x160916F0)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x160917B0)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER_REFRESHLEVELTXTVIEW_1_OFFSET UNITYSDK_OFFSET(0x16091F90)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER_REFRESHLEVELTXTVIEW_2_OFFSET UNITYSDK_OFFSET(0x16092F20)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER_REFRESHLEVELTXTVIEW_OFFSET UNITYSDK_OFFSET(0x16091A40)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER_SETADDEXP_OFFSET UNITYSDK_OFFSET(0x16092B80)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER_SETLEVELTEXT_OFFSET UNITYSDK_OFFSET(0x16093A80)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16093B00)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16093B60)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16093BF0)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16093C80)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16093D10)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotLevelWidgetController_TypeDefinitionIndex = 63853;

	class UIInterKnotLevelWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_507DDA3332D1FC73* _view; // 0x2B8
		::System::Single _progressOffset; // 0x2C0
		::System::Single _maxProgressValue; // 0x2C4
