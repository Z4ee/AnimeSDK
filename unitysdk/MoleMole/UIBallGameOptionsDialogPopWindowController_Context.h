...
#define MOLEMOLE_UIBALLGAMEOPTIONSDIALOGPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0A0700)

namespace MoleMole
{
	inline static constexpr unsigned int UIBallGameOptionsDialogPopWindowController_Context_TypeDefinitionIndex = 89326;
	...
	public:
		...
		::Il2CppArray<::Struct_2_A725E4562D03EA4E_5>* Options; // 0x30
		::System::Int32 EventID; // 0x38
		::System::Boolean IsEventTypeOptions; // 0x3C
