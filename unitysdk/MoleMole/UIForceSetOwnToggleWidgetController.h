...
#define MOLEMOLE_UIFORCESETOWNTOGGLEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1579A6B0)
#define MOLEMOLE_UIFORCESETOWNTOGGLEWIDGETCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x1579A720)
#define MOLEMOLE_UIFORCESETOWNTOGGLEWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1579A7E0)
#define MOLEMOLE_UIFORCESETOWNTOGGLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1579A8A0)
#define MOLEMOLE_UIFORCESETOWNTOGGLEWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1579A900)

namespace MoleMole
{
	inline static constexpr unsigned int UIForceSetOwnToggleWidgetController_TypeDefinitionIndex = 72098;
