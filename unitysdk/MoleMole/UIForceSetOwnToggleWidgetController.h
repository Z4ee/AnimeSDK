...
#define MOLEMOLE_UIFORCESETOWNTOGGLEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x186B6490)
#define MOLEMOLE_UIFORCESETOWNTOGGLEWIDGETCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x186B6500)
#define MOLEMOLE_UIFORCESETOWNTOGGLEWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x186B65C0)
#define MOLEMOLE_UIFORCESETOWNTOGGLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x186B6680)
#define MOLEMOLE_UIFORCESETOWNTOGGLEWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x186B66E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIForceSetOwnToggleWidgetController_TypeDefinitionIndex = 89577;
