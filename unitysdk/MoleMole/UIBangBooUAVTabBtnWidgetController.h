...
#define MOLEMOLE_UIBANGBOOUAVTABBTNWIDGETCONTROLLER_GETRANKSTRICON_OFFSET UNITYSDK_OFFSET(0x18A631E0)
#define MOLEMOLE_UIBANGBOOUAVTABBTNWIDGETCONTROLLER_GETRANKSTR_OFFSET UNITYSDK_OFFSET(0x18A63370)
#define MOLEMOLE_UIBANGBOOUAVTABBTNWIDGETCONTROLLER_ISPERFECT_OFFSET UNITYSDK_OFFSET(0x18A62FB0)
#define MOLEMOLE_UIBANGBOOUAVTABBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18A61E20)
#define MOLEMOLE_UIBANGBOOUAVTABBTNWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x18A61F20)
#define MOLEMOLE_UIBANGBOOUAVTABBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18A634D0)
#define MOLEMOLE_UIBANGBOOUAVTABBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18A634E0)
#define MOLEMOLE_UIBANGBOOUAVTABBTNWIDGETCONTROLLER___BASE_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x18A635B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangBooUAVTabBtnWidgetController_TypeDefinitionIndex = 71117;
