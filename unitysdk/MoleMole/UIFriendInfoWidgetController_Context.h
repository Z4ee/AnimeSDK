...
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x177DF530)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendInfoWidgetController_Context_TypeDefinitionIndex = 55001;
