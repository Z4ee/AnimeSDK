...
#define MOLEMOLE_CAMERAMODULELOCKROTATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDB871D0)

namespace MoleMole
{
	inline static constexpr unsigned int CameraModuleLockRotateData_TypeDefinitionIndex = 72382;
