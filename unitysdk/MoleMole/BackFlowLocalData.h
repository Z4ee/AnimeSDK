...
#define MOLEMOLE_BACKFLOWLOCALDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17797E20)

namespace MoleMole
{
	inline static constexpr unsigned int BackFlowLocalData_TypeDefinitionIndex = 73478;
