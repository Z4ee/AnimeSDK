...
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER_CLEARMATERIALS_OFFSET UNITYSDK_OFFSET(0x1690B770)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER_DETAILFADEOUT_OFFSET UNITYSDK_OFFSET(0x16910E00)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER_EXITCHOICEEVENT_OFFSET UNITYSDK_OFFSET(0x1690F820)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER_GETSIMPLETEXT_OFFSET UNITYSDK_OFFSET(0x1690CC90)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER_GETVIEW_OFFSET UNITYSDK_OFFSET(0x1690BA30)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER_GET_ANIM_OFFSET UNITYSDK_OFFSET(0x1690BA80)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x16910E50)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1690B100)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER_INITCHOICEOBJ_OFFSET UNITYSDK_OFFSET(0x1690DEB0)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1690B580)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1690B610)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1690B110)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1690B240)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER_PLAYDETAILFADEIN_OFFSET UNITYSDK_OFFSET(0x16910BF0)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER_PLAYDETAILFADEOUT_OFFSET UNITYSDK_OFFSET(0x169108F0)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER_PLAYDIALOGFADEIN_OFFSET UNITYSDK_OFFSET(0x1690BB40)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x1690BD50)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER_PLAYFRAMETEXTUREFAIRY_OFFSET UNITYSDK_OFFSET(0x1690FAC0)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER_PLAYSWITCHFADEOUT_OFFSET UNITYSDK_OFFSET(0x1690C2A0)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER_REBUILD_OFFSET UNITYSDK_OFFSET(0x1690D360)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER_REFRESHCHOICEDESC_OFFSET UNITYSDK_OFFSET(0x1690FDC0)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1690D730)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER_SETBGSTATE_OFFSET UNITYSDK_OFFSET(0x16910870)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER_SETUI_OFFSET UNITYSDK_OFFSET(0x1690C3D0)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER_SET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x16910E60)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER_SHOWDESC_OFFSET UNITYSDK_OFFSET(0x1690CE50)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1690D490)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x16910F70)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16910E70)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER__EXITCHOICEEVENT_B__22_0_OFFSET UNITYSDK_OFFSET(0x16911020)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16911050)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x169110E0)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x169110F0)
#define MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16911100)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowEventWidgetChildWindowController_TypeDefinitionIndex = 56238;
	...
	public:
		...
		{
			return (::System::Text::RegularExpressions::Regex**)Il2CppClass::FromTypeDefinitionIndex(UIHollowEventWidgetChildWindowController_TypeDefinitionIndex)->GetStaticField(0x4CE40);
		}
		// static const ::System::Single REFRESH_CD_TIME; // 0x0
		::Enum_3_BF73F764A6192785 State; // 0x318
		::System::Boolean IsDialogFadeIn; // 0x31C
		::Class_2_79F6D62CE30E3F8E_30* _view; // 0x320
		...
		::Class_1_2EF69FD7F867E7F6* _context_k__BackingField; // 0x348
		...
		::Class_2_79F6D62CE30E3F8E_30* GetView()
		{
			return ((::Class_2_79F6D62CE30E3F8E_30*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHOLLOWEVENTWIDGETCHILDWINDOWCONTROLLER_GETVIEW_OFFSET))(this);
		}
