...
#define MOLEMOLE_UIOVERLORDFEASTPHASEITEMWIDGETCONTROLLER_GET_TABBTN_OFFSET UNITYSDK_OFFSET(0x15DC14D0)
#define MOLEMOLE_UIOVERLORDFEASTPHASEITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15DC1140)
#define MOLEMOLE_UIOVERLORDFEASTPHASEITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x15DC1250)
#define MOLEMOLE_UIOVERLORDFEASTPHASEITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15DC0C80)
#define MOLEMOLE_UIOVERLORDFEASTPHASEITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15DC11D0)
#define MOLEMOLE_UIOVERLORDFEASTPHASEITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15DC0BB0)
#define MOLEMOLE_UIOVERLORDFEASTPHASEITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15DC0C10)
#define MOLEMOLE_UIOVERLORDFEASTPHASEITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x15DC1090)
#define MOLEMOLE_UIOVERLORDFEASTPHASEITEMWIDGETCONTROLLER_SETIMAGE_OFFSET UNITYSDK_OFFSET(0x15DC14F0)
#define MOLEMOLE_UIOVERLORDFEASTPHASEITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15DC15E0)
#define MOLEMOLE_UIOVERLORDFEASTPHASEITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15DC1650)
#define MOLEMOLE_UIOVERLORDFEASTPHASEITEMWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x15DC16E0)
#define MOLEMOLE_UIOVERLORDFEASTPHASEITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15DC1770)
#define MOLEMOLE_UIOVERLORDFEASTPHASEITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15DC1810)
#define MOLEMOLE_UIOVERLORDFEASTPHASEITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15DC18A0)
#define MOLEMOLE_UIOVERLORDFEASTPHASEITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15DC1930)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastPhaseItemWidgetController_TypeDefinitionIndex = 45123;
