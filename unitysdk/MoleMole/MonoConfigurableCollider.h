...
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_CLEANUP_OFFSET UNITYSDK_OFFSET(0x16D56C20)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_CLEAN_OFFSET UNITYSDK_OFFSET(0x16D57580)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_DRAWLINE_OFFSET UNITYSDK_OFFSET(0x16D56C60)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_GETCONFIGCOLLIDERPARAMS_OFFSET UNITYSDK_OFFSET(0x16D57950)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_GET_COLLIDERTYPE_OFFSET UNITYSDK_OFFSET(0x16D57560)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_GET_CONFIGURABLECOLTYPE_OFFSET UNITYSDK_OFFSET(0x16D57530)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_GET_OWNERCOLLIDER_OFFSET UNITYSDK_OFFSET(0x16D57540)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_GET_OWNER_OFFSET UNITYSDK_OFFSET(0x16D57380)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_GET_ROOTGO_OFFSET UNITYSDK_OFFSET(0x16D57570)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_METHOD_5_2337B33FCDD17495_OFFSET UNITYSDK_OFFSET(0x16D56EF0)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x16D57300)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_METHOD_5_73E0841D266A58AF_OFFSET UNITYSDK_OFFSET(0x16D56950)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_METHOD_5_96080D6BFFAB381B_OFFSET UNITYSDK_OFFSET(0x16D57BE0)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_METHOD_5_CCBE730AF445BBD4_OFFSET UNITYSDK_OFFSET(0x16D56FA0)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x16D56CB0)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x16D57000)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_SETUPCOLLIDER_OFFSET UNITYSDK_OFFSET(0x16D568E0)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_SETUPINSTANCEDCOLLIDER_OFFSET UNITYSDK_OFFSET(0x16D56840)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_SETUPTIMEDRIVENCOLLIDER_OFFSET UNITYSDK_OFFSET(0x16D567C0)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_SET_COLLIDERTYPE_OFFSET UNITYSDK_OFFSET(0x16D57550)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_SET_CONFIGURABLECOLTYPE_OFFSET UNITYSDK_OFFSET(0x16D57520)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_SET_OWNER_OFFSET UNITYSDK_OFFSET(0x16D57240)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x16D57B80)

namespace MoleMole
{
	inline static constexpr unsigned int MonoConfigurableCollider_TypeDefinitionIndex = 80954;
	...
	public:
		...
		::MoleMole::LayerMaskStatic_Enum_3_C3BBA2B066959E6E Field_5_3; // 0x34
		...
		::System::Void SetupTimeDrivenCollider(::UnityEngine::GameObject* a1, ::MoleMole::Config::ConfigTimeDrivenAttackCollider* a2, ::UnityEngine::LayerMask a3, ::MoleMole::LayerMaskStatic_Enum_3_C3BBA2B066959E6E a4)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::GameObject*, ::MoleMole::Config::ConfigTimeDrivenAttackCollider*, ::UnityEngine::LayerMask, ::MoleMole::LayerMaskStatic_Enum_3_C3BBA2B066959E6E))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOCONFIGURABLECOLLIDER_SETUPTIMEDRIVENCOLLIDER_OFFSET))(this, a1, a2, a3, a4);
		}

		::System::Void SetupInstancedCollider(::System::String* a1, ::UnityEngine::GameObject* a2, ::MoleMole::Config::ConfigTimeDrivenAttackCollider* a3, ::UnityEngine::LayerMask a4, ::MoleMole::LayerMaskStatic_Enum_3_C3BBA2B066959E6E a5)
		{
			return ((::System::Void(*)(::PVOID, ::System::String*, ::UnityEngine::GameObject*, ::MoleMole::Config::ConfigTimeDrivenAttackCollider*, ::UnityEngine::LayerMask, ::MoleMole::LayerMaskStatic_Enum_3_C3BBA2B066959E6E))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOCONFIGURABLECOLLIDER_SETUPINSTANCEDCOLLIDER_OFFSET))(this, a1, a2, a3, a4, a5);
		}
		...
		::System::Void Method_5_73E0841D266A58AF(::MoleMole::Config::ConfigTimeDrivenAttackCollider* a1, ::UnityEngine::LayerMask a2, ::MoleMole::LayerMaskStatic_Enum_3_C3BBA2B066959E6E a3)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::Config::ConfigTimeDrivenAttackCollider*, ::UnityEngine::LayerMask, ::MoleMole::LayerMaskStatic_Enum_3_C3BBA2B066959E6E))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOCONFIGURABLECOLLIDER_METHOD_5_73E0841D266A58AF_OFFSET))(this, a1, a2, a3);
		}
