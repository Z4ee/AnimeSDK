...
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1262BE70)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_CLEAN_OFFSET UNITYSDK_OFFSET(0x1262CA70)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_DRAWLINE_OFFSET UNITYSDK_OFFSET(0x1262BEB0)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_GETCONFIGCOLLIDERPARAMS_OFFSET UNITYSDK_OFFSET(0x1262CE40)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_GET_COLLIDERTYPE_OFFSET UNITYSDK_OFFSET(0x1262CA50)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_GET_CONFIGURABLECOLTYPE_OFFSET UNITYSDK_OFFSET(0x1262CA20)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_GET_OWNERCOLLIDER_OFFSET UNITYSDK_OFFSET(0x1262CA30)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_GET_OWNER_OFFSET UNITYSDK_OFFSET(0x1262C870)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_GET_ROOTGO_OFFSET UNITYSDK_OFFSET(0x1262CA60)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_METHOD_5_2337B33FCDD17495_OFFSET UNITYSDK_OFFSET(0x1262C3E0)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1262C7F0)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_METHOD_5_73E0841D266A58AF_OFFSET UNITYSDK_OFFSET(0x1262BBA0)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_METHOD_5_96080D6BFFAB381B_OFFSET UNITYSDK_OFFSET(0x1262D0D0)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_METHOD_5_CCBE730AF445BBD4_OFFSET UNITYSDK_OFFSET(0x1262C490)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1262C050)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1262BF00)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1262C1A0)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x1262C4F0)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_SETUPCOLLIDER_OFFSET UNITYSDK_OFFSET(0x1262BB30)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_SETUPINSTANCEDCOLLIDER_OFFSET UNITYSDK_OFFSET(0x1262BA90)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_SETUPTIMEDRIVENCOLLIDER_OFFSET UNITYSDK_OFFSET(0x1262BA10)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_SET_COLLIDERTYPE_OFFSET UNITYSDK_OFFSET(0x1262CA40)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_SET_CONFIGURABLECOLTYPE_OFFSET UNITYSDK_OFFSET(0x1262CA10)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_SET_OWNER_OFFSET UNITYSDK_OFFSET(0x1262C730)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1262D070)

namespace MoleMole
{
	inline static constexpr unsigned int MonoConfigurableCollider_TypeDefinitionIndex = 86856;
