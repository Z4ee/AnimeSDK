...
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER_GET_PARTNERID_OFFSET UNITYSDK_OFFSET(0x17DEA890)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17DE9FC0)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17DEA050)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17DE9DF0)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17DE9F50)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER_REFRESHPARTNERDATEVIEW_OFFSET UNITYSDK_OFFSET(0x17DEA500)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x17DEA150)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER_SETTEXT_OFFSET UNITYSDK_OFFSET(0x17DEA3C0)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER_SETTIP_OFFSET UNITYSDK_OFFSET(0x17DEA7B0)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER_UPDATEINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x17DEA0D0)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17DEA8A0)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER__ONUIINIT_B__2_0_OFFSET UNITYSDK_OFFSET(0x17DEA900)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER__ONUIINIT_B__2_1_OFFSET UNITYSDK_OFFSET(0x17DEA930)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17DEA960)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17DEA9F0)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17DEAA80)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17DEAB10)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityPersonalOutWidgetController_TypeDefinitionIndex = 87357;

	class UIMainCityPersonalOutWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_137DB615CC6A5FB0_1* _view; // 0x2C0
