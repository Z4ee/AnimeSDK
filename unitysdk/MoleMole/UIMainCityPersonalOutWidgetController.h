...
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER_GET_PARTNERID_OFFSET UNITYSDK_OFFSET(0x163CEF80)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x163CE7A0)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x163CE830)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x163CE5D0)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x163CE730)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER_REFRESHPARTNERDATEVIEW_OFFSET UNITYSDK_OFFSET(0x163CEC40)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x163CE930)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER_SETTEXT_OFFSET UNITYSDK_OFFSET(0x163CEBA0)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER_SETTIP_OFFSET UNITYSDK_OFFSET(0x163CEEE0)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER_UPDATEINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x163CE8B0)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x163CEF90)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER__ONUIINIT_B__2_0_OFFSET UNITYSDK_OFFSET(0x163CEFF0)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER__ONUIINIT_B__2_1_OFFSET UNITYSDK_OFFSET(0x163CF020)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x163CF050)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x163CF0E0)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x163CF170)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x163CF200)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityPersonalOutWidgetController_TypeDefinitionIndex = 63802;

	class UIMainCityPersonalOutWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_137DB615CC6A5FB0_2* _view; // 0x2B8
		::Class_1_2427A3A85F3C7D26* _interactableAdvanced; // 0x2C0
		::System::Int32 _partnerID; // 0x2C8
