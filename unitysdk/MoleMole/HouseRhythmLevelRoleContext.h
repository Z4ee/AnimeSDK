...
#define MOLEMOLE_HOUSERHYTHMLEVELROLECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x19BF6AD0)

namespace MoleMole
{
	inline static constexpr unsigned int HouseRhythmLevelRoleContext_TypeDefinitionIndex = 74771;
