...
#define MOLEMOLE_UICHATEMOJICOLLECTIONPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1524D7C0)
#define MOLEMOLE_UICHATEMOJICOLLECTIONPOPWINDOWCONTROLLER_INITEMOJIUI_OFFSET UNITYSDK_OFFSET(0x1524DB10)
#define MOLEMOLE_UICHATEMOJICOLLECTIONPOPWINDOWCONTROLLER_ONCLICKEMOJIICON_OFFSET UNITYSDK_OFFSET(0x1524E160)
#define MOLEMOLE_UICHATEMOJICOLLECTIONPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1524E060)
#define MOLEMOLE_UICHATEMOJICOLLECTIONPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1524E0F0)
#define MOLEMOLE_UICHATEMOJICOLLECTIONPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1524D7D0)
#define MOLEMOLE_UICHATEMOJICOLLECTIONPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1524DFF0)
#define MOLEMOLE_UICHATEMOJICOLLECTIONPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1524E610)
#define MOLEMOLE_UICHATEMOJICOLLECTIONPOPWINDOWCONTROLLER__ONUIINIT_B__4_0_OFFSET UNITYSDK_OFFSET(0x1524E750)
#define MOLEMOLE_UICHATEMOJICOLLECTIONPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1524E8E0)
#define MOLEMOLE_UICHATEMOJICOLLECTIONPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1524E970)
#define MOLEMOLE_UICHATEMOJICOLLECTIONPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1524E980)
#define MOLEMOLE_UICHATEMOJICOLLECTIONPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1524E990)

namespace MoleMole
{
	inline static constexpr unsigned int UIChatEmojiCollectionPopWindowController_TypeDefinitionIndex = 83549;
