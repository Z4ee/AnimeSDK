...
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER___C__DISPLAYCLASS49_1__CTOR_OFFSET UNITYSDK_OFFSET(0x157CD280)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER___C__DISPLAYCLASS49_1__PLAYGETCOINANIM_B__0_OFFSET UNITYSDK_OFFSET(0x157CD290)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMainBottomWidgetController___c__DisplayClass49_1_TypeDefinitionIndex = 57759;

	class UIHollowMainBottomWidgetController___c__DisplayClass49_1 : public ::System::Object
	{
	public:
		::MoleMole::UIHollowMainBottomWidgetController___c__DisplayClass49_0* CS___8__locals1; // 0x10
