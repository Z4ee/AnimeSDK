...
#define MOLEMOLE_UISUIBIANTEMPLEDEPLOYBANGBOODETAILWIDGETCONTROLLER__CLOSETALENTSKILLDETAIL_D__20_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x81C370)
#define MOLEMOLE_UISUIBIANTEMPLEDEPLOYBANGBOODETAILWIDGETCONTROLLER__CLOSETALENTSKILLDETAIL_D__20_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x283610)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleDeployBangbooDetailWidgetController__CloseTalentSkillDetail_d__20_TypeDefinitionIndex = 67887;
