...
#define MOLEMOLE_MAINCITYQUICKFUNC3KEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x182F6A40)
#define MOLEMOLE_MAINCITYQUICKFUNC3KEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x182F6A50)
#define MOLEMOLE_MAINCITYQUICKFUNC3KEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x182F6A60)

namespace MoleMole
{
	inline static constexpr unsigned int MainCityQuickFunc3KeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 51863;
