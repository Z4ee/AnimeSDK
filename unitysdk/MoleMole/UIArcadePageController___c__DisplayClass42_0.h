...
#define MOLEMOLE_UIARCADEPAGECONTROLLER___C__DISPLAYCLASS42_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16125A50)
#define MOLEMOLE_UIARCADEPAGECONTROLLER___C__DISPLAYCLASS42_0__ENTERENTRANCEPHASEFROMSPINNINGTABLE_B__0_OFFSET UNITYSDK_OFFSET(0x16125A60)
#define MOLEMOLE_UIARCADEPAGECONTROLLER___C__DISPLAYCLASS42_0__ENTERENTRANCEPHASEFROMSPINNINGTABLE_B__1_OFFSET UNITYSDK_OFFSET(0x16125AE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadePageController___c__DisplayClass42_0_TypeDefinitionIndex = 60569;
