...
#define MOLEMOLE_SUIBIANTEMPLEDAILYPAPERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x13EB7510)

namespace MoleMole
{
	inline static constexpr unsigned int SuibianTempleDailyPaperContext_TypeDefinitionIndex = 53511;
