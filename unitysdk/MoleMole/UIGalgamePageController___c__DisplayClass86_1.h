...
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS86_1__CTOR_OFFSET UNITYSDK_OFFSET(0x177E1520)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS86_1__PLAYSTORYNODE_B__8_OFFSET UNITYSDK_OFFSET(0x177E1530)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS86_1__PLAYSTORYNODE_B__9_OFFSET UNITYSDK_OFFSET(0x177E1610)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgamePageController___c__DisplayClass86_1_TypeDefinitionIndex = 54842;
