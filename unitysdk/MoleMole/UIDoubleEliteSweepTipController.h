...
#define MOLEMOLE_UIDOUBLEELITESWEEPTIPCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1578ED10)
#define MOLEMOLE_UIDOUBLEELITESWEEPTIPCONTROLLER_ONCLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x1578F260)
#define MOLEMOLE_UIDOUBLEELITESWEEPTIPCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1578F310)
#define MOLEMOLE_UIDOUBLEELITESWEEPTIPCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1578F3A0)
#define MOLEMOLE_UIDOUBLEELITESWEEPTIPCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1578EDB0)
#define MOLEMOLE_UIDOUBLEELITESWEEPTIPCONTROLLER_REFRESHMAX_OFFSET UNITYSDK_OFFSET(0x1578F590)
#define MOLEMOLE_UIDOUBLEELITESWEEPTIPCONTROLLER_REFRESHNUM_OFFSET UNITYSDK_OFFSET(0x1578FB90)
#define MOLEMOLE_UIDOUBLEELITESWEEPTIPCONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x1578ED20)
#define MOLEMOLE_UIDOUBLEELITESWEEPTIPCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1578FC90)
#define MOLEMOLE_UIDOUBLEELITESWEEPTIPCONTROLLER__ONSHOW_B__8_0_OFFSET UNITYSDK_OFFSET(0x1578FDD0)
#define MOLEMOLE_UIDOUBLEELITESWEEPTIPCONTROLLER__ONUIINIT_B__5_0_OFFSET UNITYSDK_OFFSET(0x1578FCA0)
#define MOLEMOLE_UIDOUBLEELITESWEEPTIPCONTROLLER__ONUIINIT_B__5_1_OFFSET UNITYSDK_OFFSET(0x1578FCB0)
#define MOLEMOLE_UIDOUBLEELITESWEEPTIPCONTROLLER__ONUIINIT_B__5_2_OFFSET UNITYSDK_OFFSET(0x1578FD50)
#define MOLEMOLE_UIDOUBLEELITESWEEPTIPCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1578FDE0)
#define MOLEMOLE_UIDOUBLEELITESWEEPTIPCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1578FE70)
#define MOLEMOLE_UIDOUBLEELITESWEEPTIPCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1578FE80)
#define MOLEMOLE_UIDOUBLEELITESWEEPTIPCONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x1578FE90)

namespace MoleMole
{
	inline static constexpr unsigned int UIDoubleEliteSweepTipController_TypeDefinitionIndex = 77427;
