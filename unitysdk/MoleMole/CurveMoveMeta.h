...
#define MOLEMOLE_CURVEMOVEMETA_GET_IGNOREINCURVEMOVE_OFFSET UNITYSDK_OFFSET(0x1922CA90)
#define MOLEMOLE_CURVEMOVEMETA_GET_REVERTORIENTATIONAXIS_OFFSET UNITYSDK_OFFSET(0x1922CAA0)
#define MOLEMOLE_CURVEMOVEMETA_METHOD_7_77E3CF907BA6F8B7_OFFSET UNITYSDK_OFFSET(0x1922CBD0)
#define MOLEMOLE_CURVEMOVEMETA_METHOD_7_BDBA00FB43D83ECB_OFFSET UNITYSDK_OFFSET(0x1922CB30)
#define MOLEMOLE_CURVEMOVEMETA__CTOR_OFFSET UNITYSDK_OFFSET(0x1922CB80)

namespace MoleMole
{
	inline static constexpr unsigned int CurveMoveMeta_TypeDefinitionIndex = 62709;
