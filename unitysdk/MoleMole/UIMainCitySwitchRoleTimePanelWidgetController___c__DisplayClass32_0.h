...
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER___C__DISPLAYCLASS32_0__CTOR_OFFSET UNITYSDK_OFFSET(0x147BBB10)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER___C__DISPLAYCLASS32_0__ONCLICKSENDTIME_B__0_OFFSET UNITYSDK_OFFSET(0x147BBB20)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER___C__DISPLAYCLASS32_0__ONCLICKSENDTIME_G__ONMODTIMERSP_1_OFFSET UNITYSDK_OFFSET(0x147BBC60)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCitySwitchRoleTimePanelWidgetController___c__DisplayClass32_0_TypeDefinitionIndex = 42565;
