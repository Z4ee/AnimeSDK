...
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS47_5__CTOR_OFFSET UNITYSDK_OFFSET(0x18324050)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS47_5__SHOWTRANSITION_B__8_OFFSET UNITYSDK_OFFSET(0x18324060)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS47_5__SHOWTRANSITION_B__9_OFFSET UNITYSDK_OFFSET(0x18324250)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityChatPlayWidgetController___c__DisplayClass47_5_TypeDefinitionIndex = 77929;

	class UIMainCityChatPlayWidgetController___c__DisplayClass47_5 : public ::System::Object
	{
	public:
		::MoleMole::GalGame::MainCityChatTransitionDisplayItem* config; // 0x10
