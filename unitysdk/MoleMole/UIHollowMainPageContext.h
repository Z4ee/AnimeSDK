...
#define MOLEMOLE_UIHOLLOWMAINPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18366DB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMainPageContext_TypeDefinitionIndex = 57000;
