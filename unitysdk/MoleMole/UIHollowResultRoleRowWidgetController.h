...
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19FF2860)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19FF28F0)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19FF25D0)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19FF27F0)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER_REFRESHCONTRIBUTION_OFFSET UNITYSDK_OFFSET(0x18298510)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER_REFRESHTEAM_OFFSET UNITYSDK_OFFSET(0x18298610)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x18297EA0)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER_SETAVATARHPPERCENT_OFFSET UNITYSDK_OFFSET(0x18298B00)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER_SETCONTRIBUTIONTEXTSTATE_OFFSET UNITYSDK_OFFSET(0x18298E70)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x18298A80)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER_SETLIGHTERSUPPORT_OFFSET UNITYSDK_OFFSET(0x18298D30)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER_SETLIKE_OFFSET UNITYSDK_OFFSET(0x182989E0)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER_SETMVPIMAGESTATE_OFFSET UNITYSDK_OFFSET(0x18298EE0)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18298FC0)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER__GETROLEICONPATH_OFFSET UNITYSDK_OFFSET(0x18298480)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18299020)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x182990B0)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18299140)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x182991D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowResultRoleRowWidgetController_TypeDefinitionIndex = 47490;

	class UIHollowResultRoleRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_73* _view; // 0x2C0
