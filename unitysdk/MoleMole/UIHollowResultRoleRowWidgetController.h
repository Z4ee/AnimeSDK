...
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14B4FF50)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14B4FFE0)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14B4FCD0)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14B4FEE0)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER_REFRESHCONTRIBUTION_OFFSET UNITYSDK_OFFSET(0x14B50890)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER_REFRESHTEAM_OFFSET UNITYSDK_OFFSET(0x14B50990)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x14B50220)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER_SETAVATARHPPERCENT_OFFSET UNITYSDK_OFFSET(0x14B50E80)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER_SETCONTRIBUTIONTEXTSTATE_OFFSET UNITYSDK_OFFSET(0x14B511D0)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x14B50E00)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER_SETLIGHTERSUPPORT_OFFSET UNITYSDK_OFFSET(0x14B510B0)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER_SETLIKE_OFFSET UNITYSDK_OFFSET(0x14B50D60)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER_SETMVPIMAGESTATE_OFFSET UNITYSDK_OFFSET(0x14B51240)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14B51320)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER__GETROLEICONPATH_OFFSET UNITYSDK_OFFSET(0x14B50800)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14B51380)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14B51410)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14B514A0)
#define MOLEMOLE_UIHOLLOWRESULTROLEROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14B51530)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowResultRoleRowWidgetController_TypeDefinitionIndex = 68727;

	class UIHollowResultRoleRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_151* _view; // 0x2B8
		::UnityEngine::Material* hpMaterial; // 0x2C0
		::System::Int32 contribution; // 0x2C8
