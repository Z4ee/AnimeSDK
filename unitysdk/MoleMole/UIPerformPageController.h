...
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_CACHEGROUPSALPHA_OFFSET UNITYSDK_OFFSET(0x17884600)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_DOSKIP_OFFSET UNITYSDK_OFFSET(0x178882F0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x17887B40)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x178843F0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_GET_ISALLOWINPUTPASS_OFFSET UNITYSDK_OFFSET(0x17884480)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_GET_ISIGNOREINPUT_OFFSET UNITYSDK_OFFSET(0x17884400)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_GET_MESSAGEMATCHPAGE_OFFSET UNITYSDK_OFFSET(0x17884410)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_GET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x1788B1F0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_GET_PERFORMTYPE_OFFSET UNITYSDK_OFFSET(0x17884A50)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_GET_UICURSORHIDESTATE_OFFSET UNITYSDK_OFFSET(0x17884420)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x178843E0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_INITSKIPBTNSETTING_OFFSET UNITYSDK_OFFSET(0x17885900)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_ISALLOWINPUTPASSBYACTION_OFFSET UNITYSDK_OFFSET(0x17884490)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_LOADTIMELINEINITWORLDPOS_OFFSET UNITYSDK_OFFSET(0x17889AB0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_ONAPPLICATIONFOCUS_OFFSET UNITYSDK_OFFSET(0x17888520)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_ONCLOSEPERFORMPAGEFROMOUTSIDE_OFFSET UNITYSDK_OFFSET(0x1788A9B0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17884510)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_ONPLAYCGEND_OFFSET UNITYSDK_OFFSET(0x178893C0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_ONREALSTARTPERFORM_OFFSET UNITYSDK_OFFSET(0x178891B0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17884A70)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_ONSKIPBTNLONGPRESSTRIGGER_OFFSET UNITYSDK_OFFSET(0x17888250)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_ONSKIPBTNLONGPRESSUP_OFFSET UNITYSDK_OFFSET(0x178882A0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_ONSKIP_OFFSET UNITYSDK_OFFSET(0x1788A120)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17886D00)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x178845A0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17887B90)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_PLAYCAMERASHOT_OFFSET UNITYSDK_OFFSET(0x17885E80)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_PLAYCHAPTERTIMELINE_OFFSET UNITYSDK_OFFSET(0x17886820)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_PLAYFADEINANIMATION_OFFSET UNITYSDK_OFFSET(0x1788AC70)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_PLAYFADEOUTANIMATION_OFFSET UNITYSDK_OFFSET(0x1788AEA0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_PLAYTIMELINECUTSCENE_OFFSET UNITYSDK_OFFSET(0x178869B0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_PLAYVIDEO_OFFSET UNITYSDK_OFFSET(0x17886150)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_POSTRELEASEUI_OFFSET UNITYSDK_OFFSET(0x17887950)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_PRESTARTPERFORM_OFFSET UNITYSDK_OFFSET(0x17888900)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_RECOVERTIMELINEWORLDPOS_OFFSET UNITYSDK_OFFSET(0x17889FA0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_RESETGROUPSALPHA_OFFSET UNITYSDK_OFFSET(0x17888050)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_SENDENDCOMMTOSERVER_OFFSET UNITYSDK_OFFSET(0x1788A6D0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_SENDSTARTCOMMTOSERVER_OFFSET UNITYSDK_OFFSET(0x17886B80)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_SETFULLSCREENCONNECTCUTSCENE_OFFSET UNITYSDK_OFFSET(0x1788AA90)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_SETIGNOREINPUT_OFFSET UNITYSDK_OFFSET(0x17885E00)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_SETONSKIPACTION_OFFSET UNITYSDK_OFFSET(0x1788AA40)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_SETPRESSSKIPBTNTIME_OFFSET UNITYSDK_OFFSET(0x17887F80)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_SETVIDEOACTIVE_OFFSET UNITYSDK_OFFSET(0x178886C0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_SET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x1788B200)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_SET_PERFORMTYPE_OFFSET UNITYSDK_OFFSET(0x17884A60)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_SHOWBLACKMASK_OFFSET UNITYSDK_OFFSET(0x17884930)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_SHOWSKIP_OFFSET UNITYSDK_OFFSET(0x17888860)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_SHOWWHITEMASK_OFFSET UNITYSDK_OFFSET(0x178849C0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_SKIPFADEINANIMATION_OFFSET UNITYSDK_OFFSET(0x1788ADE0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_STOPPERFORM_OFFSET UNITYSDK_OFFSET(0x17886FD0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_TRIGGERCALLBACKSWHENSTARTFADEOUT_OFFSET UNITYSDK_OFFSET(0x1788A840)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_TRYCLOSEPOPTIP_OFFSET UNITYSDK_OFFSET(0x17887590)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_TRYTRIGGERPLOTPLAYPERFORMJUMP_OFFSET UNITYSDK_OFFSET(0x1788A570)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_UPDATELONGPRESSSKIP_OFFSET UNITYSDK_OFFSET(0x17887D10)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x17887CC0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__CACHECLEAN_OFFSET UNITYSDK_OFFSET(0x178879A0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1788B2C0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1788B210)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__ONREALSTARTPERFORM_B__46_0_OFFSET UNITYSDK_OFFSET(0x1788B5E0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__ONREALSTARTPERFORM_B__46_1_OFFSET UNITYSDK_OFFSET(0x1788B620)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__ONSKIP_B__49_0_OFFSET UNITYSDK_OFFSET(0x1788B630)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__ONUIOPEN_B__27_0_OFFSET UNITYSDK_OFFSET(0x1788B300)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__ONUIOPEN_B__27_1_OFFSET UNITYSDK_OFFSET(0x1788B310)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__ONUIOPEN_B__27_2_OFFSET UNITYSDK_OFFSET(0x1788B380)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__PLAYCHAPTERTIMELINE_B__39_0_OFFSET UNITYSDK_OFFSET(0x1788B3F0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__PLAYFADEINANIMATION_B__59_0_OFFSET UNITYSDK_OFFSET(0x1788B670)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__PLAYTIMELINECUTSCENE_B__40_1_OFFSET UNITYSDK_OFFSET(0x1788B400)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__PLAYTIMELINECUTSCENE_B__40_2_OFFSET UNITYSDK_OFFSET(0x1788B410)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__PLAYTIMELINECUTSCENE_G__INFORMTIMELINEMANAGERTOSTART_40_0_OFFSET UNITYSDK_OFFSET(0x17889DB0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__PLAYVIDEO_B__45_0_OFFSET UNITYSDK_OFFSET(0x1788B4C0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__PLAYVIDEO_B__45_1_OFFSET UNITYSDK_OFFSET(0x1788B4F0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__SENDSTARTCOMMTOSERVER_B__106_0_OFFSET UNITYSDK_OFFSET(0x1788B6A0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___BASE_GET_UICURSORHIDESTATE_OFFSET UNITYSDK_OFFSET(0x1788B6B0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___BASE_ISALLOWINPUTPASSBYACTION_OFFSET UNITYSDK_OFFSET(0x1788B6C0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1788B770)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1788B800)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x1788B810)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1788B8D0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1788B8E0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___BASE_POSTRELEASEUI_OFFSET UNITYSDK_OFFSET(0x1788B970)

namespace MoleMole
{
	inline static constexpr unsigned int UIPerformPageController_TypeDefinitionIndex = 85282;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIPerformPageController_TypeDefinitionIndex)->GetStaticField(0x30FC0);
		}
		...
		::Class_2_79AE422BA06F6D26_247* _view; // 0x348
		...
		::Class_1_43BD383C98B4C0C5_43* param; // 0x388
		...
		::Class_1_43BD383C98B4C0C5_43* GetContext()
		{
			return ((::Class_1_43BD383C98B4C0C5_43*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIPERFORMPAGECONTROLLER_GETCONTEXT_OFFSET))(this);
		}
