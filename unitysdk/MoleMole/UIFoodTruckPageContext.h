...
#define MOLEMOLE_UIFOODTRUCKPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18805310)

namespace MoleMole
{
	inline static constexpr unsigned int UIFoodTruckPageContext_TypeDefinitionIndex = 84502;
