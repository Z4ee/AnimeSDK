...
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER__CLICKHIGHLIGHT_D__73_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x178F9FC0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER__CLICKHIGHLIGHT_D__73_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x178FA070)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER__CLICKHIGHLIGHT_D__73_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x178FA0D0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER__CLICKHIGHLIGHT_D__73_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x178FA080)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER__CLICKHIGHLIGHT_D__73_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x178F9FB0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER__CLICKHIGHLIGHT_D__73__CTOR_OFFSET UNITYSDK_OFFSET(0x178F9FA0)

namespace MoleMole
{
	inline static constexpr unsigned int UISkillButtonBaseController__ClickHighLight_d__73_TypeDefinitionIndex = 83325;
