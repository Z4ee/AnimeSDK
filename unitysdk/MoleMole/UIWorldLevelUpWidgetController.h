...
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17BD6310)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0x17BD6420)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER_ONINTERRUPT_OFFSET UNITYSDK_OFFSET(0x17BD6520)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17BD63A0)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17BD5A00)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17BD5B10)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x17BD5C00)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17BD65C0)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER__ONFADEPLAYFINISH_B__6_0_OFFSET UNITYSDK_OFFSET(0x17BD6620)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER__ONFADEPLAYFINISH_B__6_1_OFFSET UNITYSDK_OFFSET(0x17BD6690)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER__ONINTERRUPT_B__8_0_OFFSET UNITYSDK_OFFSET(0x17BD66B0)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17BD66D0)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER___BASE_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0x17BD6760)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17BD6770)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17BD6800)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17BD6890)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorldLevelUpWidgetController_TypeDefinitionIndex = 75393;
