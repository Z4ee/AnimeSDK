...
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER___C__DISPLAYCLASS9_2__CTOR_OFFSET UNITYSDK_OFFSET(0x17DAE120)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER___C__DISPLAYCLASS9_2__ONSCROLLITEMUPDATE_B__7_OFFSET UNITYSDK_OFFSET(0x17DAE130)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookItemWidgetController___c__DisplayClass9_2_TypeDefinitionIndex = 70476;
