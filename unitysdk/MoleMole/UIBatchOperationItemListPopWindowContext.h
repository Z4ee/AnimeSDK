...
#define MOLEMOLE_UIBATCHOPERATIONITEMLISTPOPWINDOWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x176DC0A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBatchOperationItemListPopWindowContext_TypeDefinitionIndex = 42850;
