...
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_GAMEFINISH_OFFSET UNITYSDK_OFFSET(0x19A7BBE0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_GETBUBBLEWIDGET_OFFSET UNITYSDK_OFFSET(0x19A7A3B0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x19A79730)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x19A7B880)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19A7A6A0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0x19A7B170)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x19A7B390)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x19A7B5E0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x19A7AB00)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONTIMEOUT_OFFSET UNITYSDK_OFFSET(0x19A7BA80)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x19A7A730)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19A7A960)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19A79740)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19A79E10)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_OPENBUBBLEROW_OFFSET UNITYSDK_OFFSET(0x19A7A570)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_OPENTIMECOUNTDOWNUI_OFFSET UNITYSDK_OFFSET(0x19A7AD70)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_RECORDGAMETIME_OFFSET UNITYSDK_OFFSET(0x19A7BE10)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19A7BF50)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER__GAMEFINISH_B__31_0_OFFSET UNITYSDK_OFFSET(0x19A7BFB0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER__GAMEFINISH_B__31_1_OFFSET UNITYSDK_OFFSET(0x19A7C030)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19A7C140)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER___BASE_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0x19A7C1D0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x19A7C1E0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x19A7C270)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x19A7C2A0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x19A7C2B0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19A7C370)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19A7C380)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19A7C390)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooCountGamePopWindowController_TypeDefinitionIndex = 55095;

	class UIBangbooCountGamePopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_11* _view; // 0x318
		::MoleMole::UIBangbooCountGameContext* _context; // 0x320
		::MoleMole::UIPhotoModePlayerMoveChildWindowController* _joystickCtrl; // 0x328
		::Class_2_CE2ADEB86822B8EC* _cameraControl; // 0x330
		::MoleMole::UIInLevelCountDownUIChildWindowController* _countDownController; // 0x338
		::System::String* _lastBGMSpecialState; // 0x340
		::Enum_3_0F5D0B7399907DA1 _result; // 0x348
		...
		::System::Void _GameFinish_b__31_0(::Class_1_5A17F85799580BCA_Enum_3_6E0E8267CDDC65CF _)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_5A17F85799580BCA_Enum_3_6E0E8267CDDC65CF))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER__GAMEFINISH_B__31_0_OFFSET))(this, _);
		}
