...
#define MOLEMOLE_SELECTTARGET_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1385F630)
#define MOLEMOLE_SELECTTARGET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1385F7E0)
#define MOLEMOLE_SELECTTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1385FE60)
#define MOLEMOLE_SELECTTARGET___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x13860070)
#define MOLEMOLE_SELECTTARGET___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x13860100)

namespace MoleMole
{
	inline static constexpr unsigned int SelectTarget_TypeDefinitionIndex = 54582;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedBool* EnableDistanceFilter; // 0x68
		::System::String* DistanceEntityAttachPoint; // 0x70
		::Il2CppArray<::MoleMole::Config::MonsterFunctionType>* monsterFunctionTypeArray; // 0x78
		::BehaviorDesigner::Runtime::SharedBool* OverrideSelectConditionWithAbilityTargetKey; // 0x80
		...
		::BehaviorDesigner::Runtime::SharedBool* IsFailClearTarget; // 0x98
		::Class_1_3169BBF21D83DEAB* _selectTargetPara; // 0xA0
		::BehaviorDesigner::Runtime::SharedBool* ExcludeExitBattleTarget; // 0xA8
		::System::String* DistanceEntityCustomKey; // 0xB0
		::BehaviorDesigner::Runtime::SharedBool* IsAreaDetect; // 0xB8
		::MoleMole::Battle::Entity* ownerEntity; // 0xC0
		::BehaviorDesigner::Runtime::SharedFloat* ValidDistance; // 0xC8
		::MoleMole::AIMoveTargetType DistanceCenterEntity; // 0xD0
		::System::Boolean isSelectAllied; // 0xD4
		::System::Boolean isLocalAvatarFirst; // 0xD5
		::System::Boolean isSelectEnemy; // 0xD6
		::System::Boolean isSelectNeutral; // 0xD7
