...
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_CHANGETODETAIL_OFFSET UNITYSDK_OFFSET(0x17178C40)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_CHANGETOSETTLE_OFFSET UNITYSDK_OFFSET(0x171790D0)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_CHANGETOSTANDBY_OFFSET UNITYSDK_OFFSET(0x17178B00)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_DIRECTCHANGETOSETTLE_OFFSET UNITYSDK_OFFSET(0x17178ED0)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_GETQUESTIONANSWERSCREENUIPAGEDETAILFADEIN_OFFSET UNITYSDK_OFFSET(0x17179200)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_GETQUESTIONANSWERSCREENUIPAGEDETAILFADEOUT_OFFSET UNITYSDK_OFFSET(0x17179190)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_GETQUESTIONANSWERSCREENUIPAGESETTLEMENTFADEIN_OFFSET UNITYSDK_OFFSET(0x171792E0)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_GETQUESTIONANSWERSCREENUIPAGESETTLEMENTFADEOUT_OFFSET UNITYSDK_OFFSET(0x17179270)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_GETQUESTIONSANSWERSCREENUIPAGESTANDBYFADEIN_OFFSET UNITYSDK_OFFSET(0x17179350)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_GETQUESTIONSANSWERSCREENUIPAGESTANDBYFADEOUT_OFFSET UNITYSDK_OFFSET(0x171793C0)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_HIDEALL_OFFSET UNITYSDK_OFFSET(0x17178CF0)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_HIDESTANDBY_OFFSET UNITYSDK_OFFSET(0x17178BA0)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x171789F0)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17178A80)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x171787D0)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17178980)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17179430)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17179490)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17179520)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x171795B0)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17179640)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerScreenWidgetController_TypeDefinitionIndex = 49062;
