...
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_CHANGETODETAIL_OFFSET UNITYSDK_OFFSET(0x147E90A0)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_CHANGETOSETTLE_OFFSET UNITYSDK_OFFSET(0x147E9530)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_CHANGETOSTANDBY_OFFSET UNITYSDK_OFFSET(0x147E8F60)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_DIRECTCHANGETOSETTLE_OFFSET UNITYSDK_OFFSET(0x147E9330)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_GETQUESTIONANSWERSCREENUIPAGEDETAILFADEIN_OFFSET UNITYSDK_OFFSET(0x147E9660)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_GETQUESTIONANSWERSCREENUIPAGEDETAILFADEOUT_OFFSET UNITYSDK_OFFSET(0x147E95F0)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_GETQUESTIONANSWERSCREENUIPAGESETTLEMENTFADEIN_OFFSET UNITYSDK_OFFSET(0x147E9740)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_GETQUESTIONANSWERSCREENUIPAGESETTLEMENTFADEOUT_OFFSET UNITYSDK_OFFSET(0x147E96D0)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_GETQUESTIONSANSWERSCREENUIPAGESTANDBYFADEIN_OFFSET UNITYSDK_OFFSET(0x147E97B0)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_GETQUESTIONSANSWERSCREENUIPAGESTANDBYFADEOUT_OFFSET UNITYSDK_OFFSET(0x147E9820)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_HIDEALL_OFFSET UNITYSDK_OFFSET(0x147E9150)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_HIDESTANDBY_OFFSET UNITYSDK_OFFSET(0x147E9000)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x147E8E50)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x147E8EE0)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x147E8C30)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x147E8DE0)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x147E9890)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x147E98F0)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x147E9980)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x147E9A10)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x147E9AA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerScreenWidgetController_TypeDefinitionIndex = 44828;

	class UIQuestionsAnswerScreenWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_2CBC8051822D14AC* _view; // 0x2B8
		::MoleMole::UIQuestionsAnswerScreenStandbyWidgetController* Standby; // 0x2C0
		::MoleMole::UIQuestionsAnswerScreenDetailWidgetController* Detail; // 0x2C8
		::MoleMole::UIQuestionsAnswerScreenSettleWidgetController* Settlement; // 0x2D0
