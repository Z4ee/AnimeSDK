...
#define MOLEMOLE_UIGENERALNUMTABBTNWIDGETCONTROLLER_GENERALNUMTABBTNDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x15249690)
#define MOLEMOLE_UIGENERALNUMTABBTNWIDGETCONTROLLER_GENERALNUMTABBTNDATA__CTOR_2_OFFSET UNITYSDK_OFFSET(0x152496B0)
#define MOLEMOLE_UIGENERALNUMTABBTNWIDGETCONTROLLER_GENERALNUMTABBTNDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x15249670)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralNumTabBtnWidgetController_GeneralNumTabBtnData_TypeDefinitionIndex = 39476;
	...
	public:
		...
		::System::Action_1<::MoleMole::NotificationBadge*>* m_badgeAction; // 0x20
		::System::String* m_numLeft; // 0x28
		::System::String* m_tabText; // 0x30
