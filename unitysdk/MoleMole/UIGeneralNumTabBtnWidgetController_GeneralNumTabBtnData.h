...
#define MOLEMOLE_UIGENERALNUMTABBTNWIDGETCONTROLLER_GENERALNUMTABBTNDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17D9D290)
#define MOLEMOLE_UIGENERALNUMTABBTNWIDGETCONTROLLER_GENERALNUMTABBTNDATA__CTOR_2_OFFSET UNITYSDK_OFFSET(0x17D9D2B0)
#define MOLEMOLE_UIGENERALNUMTABBTNWIDGETCONTROLLER_GENERALNUMTABBTNDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17D9D270)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralNumTabBtnWidgetController_GeneralNumTabBtnData_TypeDefinitionIndex = 50004;

	class UIGeneralNumTabBtnWidgetController_GeneralNumTabBtnData : public ::System::Object
	{
	public:
		::System::String* m_tabText; // 0x10
		::System::String* m_numLeft; // 0x18
		::System::String* m_numRight; // 0x20
