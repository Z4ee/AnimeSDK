...
#define MOLEMOLE_UIYOROZUYADIFFICULTYLISTWIDGETWIDGETCONTROLLER_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x112CA0B0)
#define MOLEMOLE_UIYOROZUYADIFFICULTYLISTWIDGETWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x112C97F0)
#define MOLEMOLE_UIYOROZUYADIFFICULTYLISTWIDGETWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x112C9900)
#define MOLEMOLE_UIYOROZUYADIFFICULTYLISTWIDGETWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x112C9880)
#define MOLEMOLE_UIYOROZUYADIFFICULTYLISTWIDGETWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x112C95A0)
#define MOLEMOLE_UIYOROZUYADIFFICULTYLISTWIDGETWIDGETCONTROLLER_REFRESHUIBYPOINTROOTSTATE_OFFSET UNITYSDK_OFFSET(0x112C9AB0)
#define MOLEMOLE_UIYOROZUYADIFFICULTYLISTWIDGETWIDGETCONTROLLER_SELECTHEATBUFF_OFFSET UNITYSDK_OFFSET(0x112CA2A0)
#define MOLEMOLE_UIYOROZUYADIFFICULTYLISTWIDGETWIDGETCONTROLLER_SETHEATID_OFFSET UNITYSDK_OFFSET(0x112C9A40)
#define MOLEMOLE_UIYOROZUYADIFFICULTYLISTWIDGETWIDGETCONTROLLER_SETSELECTSTATE_OFFSET UNITYSDK_OFFSET(0x112CA8E0)
#define MOLEMOLE_UIYOROZUYADIFFICULTYLISTWIDGETWIDGETCONTROLLER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0x112CAA40)
#define MOLEMOLE_UIYOROZUYADIFFICULTYLISTWIDGETWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x112CAD90)
#define MOLEMOLE_UIYOROZUYADIFFICULTYLISTWIDGETWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x112CADA0)
#define MOLEMOLE_UIYOROZUYADIFFICULTYLISTWIDGETWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x112CAE30)
#define MOLEMOLE_UIYOROZUYADIFFICULTYLISTWIDGETWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x112CAED0)
#define MOLEMOLE_UIYOROZUYADIFFICULTYLISTWIDGETWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x112CAF60)

namespace MoleMole
{
	inline static constexpr unsigned int UIYorozuyaDifficultyListWidgetWidgetController_TypeDefinitionIndex = 77476;

	class UIYorozuyaDifficultyListWidgetWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_724B3079070B9259_7* _view; // 0x2F0
		...
		::Class_2_208CC9941471731A_287* _heatConfig; // 0x320
		...
		::System::Void SetHeatID(::Class_2_208CC9941471731A_287* _heatConfig, ::System::Int32 index)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_287*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIYOROZUYADIFFICULTYLISTWIDGETWIDGETCONTROLLER_SETHEATID_OFFSET))(this, _heatConfig, index);
		}
