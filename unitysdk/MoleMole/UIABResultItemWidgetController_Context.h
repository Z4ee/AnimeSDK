...
#define MOLEMOLE_UIABRESULTITEMWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x11D86D80)

namespace MoleMole
{
	inline static constexpr unsigned int UIABResultItemWidgetController_Context_TypeDefinitionIndex = 47591;
