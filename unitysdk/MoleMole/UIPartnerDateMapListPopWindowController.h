...
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER_CLEARDROPDOWN_OFFSET UNITYSDK_OFFSET(0x14C6C3E0)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER_GETDEFAULTSELECTIDX_OFFSET UNITYSDK_OFFSET(0x14C6D350)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER_GETNOAVAILABLESECTIONTEXTKEY_OFFSET UNITYSDK_OFFSET(0x14C6D100)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x14C6C440)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER_INITDROPDOWN_OFFSET UNITYSDK_OFFSET(0x14C6BF50)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14C6CDC0)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14C6CE50)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14C6C450)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14C6C710)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x14C6C810)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER_SHOULDSHOWLIKEICON_OFFSET UNITYSDK_OFFSET(0x14C6CF10)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14C6D6C0)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER__INITDROPDOWN_B__0_0_OFFSET UNITYSDK_OFFSET(0x14C6D6D0)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER__ONUIINIT_B__8_0_OFFSET UNITYSDK_OFFSET(0x14C6D750)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER__ONUIINIT_B__8_1_OFFSET UNITYSDK_OFFSET(0x14C6D7D0)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER__ONUIINIT_B__8_2_OFFSET UNITYSDK_OFFSET(0x14C6D980)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14C6E2E0)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14C6E370)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14C6E380)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14C6E390)

namespace MoleMole
{
	inline static constexpr unsigned int UIPartnerDateMapListPopWindowController_TypeDefinitionIndex = 70280;

	class UIPartnerDateMapListPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_1_754E7605A8C1951A* _dropDownViewModel; // 0x318
		...
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_159*>* _partnerSections; // 0x338
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_692*>* _freeModeAimList; // 0x340
		::System::Int32 _curFreeModeAimIdx; // 0x348
		::Class_2_208CC9941471731A_692* _curFreeModeAim; // 0x350
