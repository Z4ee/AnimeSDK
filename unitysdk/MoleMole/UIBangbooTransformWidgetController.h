...
#define MOLEMOLE_UIBANGBOOTRANSFORMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16EDA1B0)
#define MOLEMOLE_UIBANGBOOTRANSFORMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16EDA240)
#define MOLEMOLE_UIBANGBOOTRANSFORMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16ED9EC0)
#define MOLEMOLE_UIBANGBOOTRANSFORMWIDGETCONTROLLER_OPENEDITORPANEL_OFFSET UNITYSDK_OFFSET(0x16EDA2C0)
#define MOLEMOLE_UIBANGBOOTRANSFORMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16EDA410)
#define MOLEMOLE_UIBANGBOOTRANSFORMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16EDA470)
#define MOLEMOLE_UIBANGBOOTRANSFORMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16EDA500)
#define MOLEMOLE_UIBANGBOOTRANSFORMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16EDA590)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooTransformWidgetController_TypeDefinitionIndex = 81632;
