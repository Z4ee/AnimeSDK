...
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER_CREATEFUNC_OFFSET UNITYSDK_OFFSET(0x178836C0)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0x178841A0)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x178828F0)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17882900)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0x17883400)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER_ONOKBTNCLICK_OFFSET UNITYSDK_OFFSET(0x17883780)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17882CB0)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17882990)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER_SETDATA_OFFSET UNITYSDK_OFFSET(0x178837D0)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17884310)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER__ONUIDESTROY_G__SHOULDOPENMAINPAGE_8_0_OFFSET UNITYSDK_OFFSET(0x17883030)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17884320)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER___BASE_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0x178843B0)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x178843C0)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x178843D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastSettlementPageController_TypeDefinitionIndex = 57240;
	...
	public:
		...
		{
			return ((::MoleMole::ScrollViewItemWidgetController*(*)(::PVOID, ::Enum_3_7A4252233BCEB3A9, ::System::Func_1<::MoleMole::UIControlReference*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER_CREATEFUNC_OFFSET))(this, arg1, arg2);
		}
		...
		::System::Void SetData(::Class_3_88D140F5E09465E1_8* rsp)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_88D140F5E09465E1_8*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER_SETDATA_OFFSET))(this, rsp);
		}
