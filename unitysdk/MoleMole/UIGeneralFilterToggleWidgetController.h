...
#define MOLEMOLE_UIGENERALFILTERTOGGLEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x187F4450)
#define MOLEMOLE_UIGENERALFILTERTOGGLEWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x187F44C0)
#define MOLEMOLE_UIGENERALFILTERTOGGLEWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x187F4580)
#define MOLEMOLE_UIGENERALFILTERTOGGLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x187F46E0)
#define MOLEMOLE_UIGENERALFILTERTOGGLEWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x187F4740)
#define MOLEMOLE_UIGENERALFILTERTOGGLEWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x187F47E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralFilterToggleWidgetController_TypeDefinitionIndex = 84072;
