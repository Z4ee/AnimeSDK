...
#define MOLEMOLE_TEAMPROPERTYENUMCOMPARER_TEAMPROPERTYENUMCOMPARER_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x187179C0)
#define MOLEMOLE_TEAMPROPERTYENUMCOMPARER_TEAMPROPERTYENUMCOMPARER_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x187179D0)
#define MOLEMOLE_TEAMPROPERTYENUMCOMPARER_TEAMPROPERTYENUMCOMPARER_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x18717A40)
#define MOLEMOLE_TEAMPROPERTYENUMCOMPARER_TEAMPROPERTYENUMCOMPARER_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18717A90)

namespace MoleMole
{
	inline static constexpr unsigned int TeamPropertyEnumComparer_TeamPropertyEnumComparer_UnityGeneratedFormatter_TypeDefinitionIndex = 42805;
