...
class Class_2_D6BCF098B26738D7_2;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }

#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17E10900)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17E10990)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17E10830)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17E10890)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER_REFRESHITEMVIEW_OFFSET UNITYSDK_OFFSET(0x17E10A10)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER_REFRESHPLAYERSTATUS_OFFSET UNITYSDK_OFFSET(0x17E10EC0)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17E11200)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17E11260)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17E112F0)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17E11380)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17E11410)

namespace MoleMole
{
	inline static constexpr unsigned int UIOnlinePlayerItemWidgetController_TypeDefinitionIndex = 84497;

	class UIOnlinePlayerItemWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_D6BCF098B26738D7_2* _view; // 0x2C0
