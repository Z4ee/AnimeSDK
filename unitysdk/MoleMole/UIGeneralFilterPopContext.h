...
#define MOLEMOLE_UIGENERALFILTERPOPCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15A1E530)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralFilterPopContext_TypeDefinitionIndex = 51696;

	class UIGeneralFilterPopContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::Class_1_9BDF216942FFF5D1* sortData; // 0x28
		::System::Action* onWindowFadeout; // 0x30
		::Class_0_16E4307DCC419505_194* filterInstance; // 0x38
		::System::Action* onChanged; // 0x40
		::System::Action* onOpen; // 0x48
		::System::String* advancedFilterSubTitle; // 0x50
