...
#define MOLEMOLE_UIMUSICBATTLEINLEVELTOOLBARBOSSWIDGETCONTROLLER__SETACTIVEINTERNAL_D__32_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x8172F0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELTOOLBARBOSSWIDGETCONTROLLER__SETACTIVEINTERNAL_D__32_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

namespace MoleMole
{
	inline static constexpr unsigned int UIMusicBattleInLevelToolBarBossWidgetController__SetActiveInternal_d__32_TypeDefinitionIndex = 77654;
