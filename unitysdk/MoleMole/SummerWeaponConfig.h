...
#define MOLEMOLE_SUMMERWEAPONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1606D0A0)

namespace MoleMole
{
	inline static constexpr unsigned int SummerWeaponConfig_TypeDefinitionIndex = 51877;
