...
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_CLEARCURVESANIMATEDTAG_OFFSET UNITYSDK_OFFSET(0x150FE170)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_CLEARCURVESOPENTAG_OFFSET UNITYSDK_OFFSET(0x150FE540)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_GETANIMATIONTIME_OFFSET UNITYSDK_OFFSET(0x150FE4D0)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_GETONEROWDATABYCOLUMNINDEX_OFFSET UNITYSDK_OFFSET(0x151000B0)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_GETPERTALENTBYINDEX_OFFSET UNITYSDK_OFFSET(0x150FE7B0)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_GETPERTALENTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x15100650)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_GETTALENTCOUNTBYCOLUMNINDEX_OFFSET UNITYSDK_OFFSET(0x150FE330)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x150FBE10)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_ISCANSHOWRESETBUTTON_OFFSET UNITYSDK_OFFSET(0x150FFA20)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_ISHAVEZEROTALENT_OFFSET UNITYSDK_OFFSET(0x150FD510)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_ONADDTALENTEVENT_OFFSET UNITYSDK_OFFSET(0x150FFDD0)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_ONCREATEALLITEM_OFFSET UNITYSDK_OFFSET(0x150FD770)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x150FBE20)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_ONOKBTN_OFFSET UNITYSDK_OFFSET(0x150FE6A0)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_ONPERTALENTCLICK_OFFSET UNITYSDK_OFFSET(0x150FE990)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_ONRESETBTN_OFFSET UNITYSDK_OFFSET(0x150FE5B0)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_ONRESETTALENTEVENT_OFFSET UNITYSDK_OFFSET(0x150FFE70)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_ONTOGGLE_OFFSET UNITYSDK_OFFSET(0x150FCF80)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x150FD160)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x150FBF60)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0x150FD300)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_PLAYCURVEFILLANIMATION_OFFSET UNITYSDK_OFFSET(0x150FE440)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_REFRESHBUTTON_OFFSET UNITYSDK_OFFSET(0x150FEF00)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_REFRESHLINEMESH_OFFSET UNITYSDK_OFFSET(0x150FE1E0)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_SETLINE_OFFSET UNITYSDK_OFFSET(0x150FE250)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_SETNEXTTALENTINDEXBYPRETALENTIDLIST_OFFSET UNITYSDK_OFFSET(0x151004E0)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_SETNEXTTALENTINDEX_OFFSET UNITYSDK_OFFSET(0x15100240)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_SETPANELDATA_OFFSET UNITYSDK_OFFSET(0x150FC7A0)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_SHOWRESETBTN_OFFSET UNITYSDK_OFFSET(0x150FD470)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_SORTPANELDATALIST_OFFSET UNITYSDK_OFFSET(0x15100460)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_STOPANIMATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x150FD1D0)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x15100870)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15100730)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER__ONRESETBTN_B__32_0_OFFSET UNITYSDK_OFFSET(0x151009A0)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER__PLAYANIMATION_B__22_0_OFFSET UNITYSDK_OFFSET(0x15100880)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER__PLAYANIMATION_B__22_1_OFFSET UNITYSDK_OFFSET(0x15100910)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x151009D0)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15100A60)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15100A70)

namespace MoleMole
{
	inline static constexpr unsigned int UIMiniscapeTalentPageController_TypeDefinitionIndex = 63120;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UIMiniscapeTalentPageController_TypeDefinitionIndex)->GetStaticField(0xD0E0);
		}
		// static const ::System::String* _talentPageBg1; // 0x0
		// static const ::System::String* _talentPageBg2; // 0x0
		::System::Collections::Generic::List_1<::System::String*>* _talentPageBgList; // 0x310
		::Class_2_79AE422BA06F6D26_199* _view; // 0x318
		::Class_2_8607800D97BB03E5* _model; // 0x320
		::MoleMole::UIMiniscapeTalentPiontWidgetController* _rightTalentTemplate; // 0x328
		::MoleMole::UIMiniscapeTalentPiontWidgetController* _rightTalentTemplateBg; // 0x330
		::UnityEngine::Coroutine* _animationCallBack; // 0x338
		::UnityEngine::Coroutine* _animationCallBackBg; // 0x340
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::MoleMole::UIMiniscapeTalentPageController_MiniscapeTalentOneRowData*>*>* _panelDataMap; // 0x348
		::System::Collections::Generic::List_1<::System::Int32>* _avatarList; // 0x350
		::MoleMole::UIMiniscapeTalentPiontWidgetController* _cacheTalentTemplate; // 0x358
		::System::UInt32 _currentAvatarId; // 0x360
		::System::UInt32 _currentTalentId; // 0x364
