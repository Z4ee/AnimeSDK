...
#define MOLEMOLE_UIACTIVITYSKINREWARDWIDGETCONTROLLER_GETVIEW_OFFSET UNITYSDK_OFFSET(0x173D8ED0)
#define MOLEMOLE_UIACTIVITYSKINREWARDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x173D8DC0)
#define MOLEMOLE_UIACTIVITYSKINREWARDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x173D8E50)
#define MOLEMOLE_UIACTIVITYSKINREWARDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x173D8B70)
#define MOLEMOLE_UIACTIVITYSKINREWARDWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x173D8D50)
#define MOLEMOLE_UIACTIVITYSKINREWARDWIDGETCONTROLLER_SETSKINREWARDSTATE_OFFSET UNITYSDK_OFFSET(0x173D8F20)
#define MOLEMOLE_UIACTIVITYSKINREWARDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x173D9210)
#define MOLEMOLE_UIACTIVITYSKINREWARDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x173D9270)
#define MOLEMOLE_UIACTIVITYSKINREWARDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x173D9300)
#define MOLEMOLE_UIACTIVITYSKINREWARDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x173D9390)
#define MOLEMOLE_UIACTIVITYSKINREWARDWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x173D9420)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivitySkinRewardWidgetController_TypeDefinitionIndex = 70316;

	class UIActivitySkinRewardWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_E6B1B73EBD006A98* _view; // 0x2C0
		::System::Collections::Generic::List_1<::Class_2_E6B1B73EBD006A98_Class_2_D72E10CE1BC97618*>* roleImageView; // 0x2C8
