...
#define MOLEMOLE_SERIALIZABLEDECALAREADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1688FCC0)

namespace MoleMole
{
	inline static constexpr unsigned int SerializableDecalAreaData_TypeDefinitionIndex = 75164;
