...
#define MOLEMOLE_MONOLEVELTRIGGERACTION_ACTIONSETTINGS_METHOD_2_D67C01E967FCF1F8_OFFSET UNITYSDK_OFFSET(0x74CDE0)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_ACTIONSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x74CD70)

namespace MoleMole
{
	inline static constexpr unsigned int MonoLevelTriggerAction_ActionSettings_TypeDefinitionIndex = 60983;
