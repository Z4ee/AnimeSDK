...
#define MOLEMOLE_UIGENERALBATTLEQUICKTASKWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x177E31D0)
#define MOLEMOLE_UIGENERALBATTLEQUICKTASKWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x177E3240)
#define MOLEMOLE_UIGENERALBATTLEQUICKTASKWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x177E32E0)
#define MOLEMOLE_UIGENERALBATTLEQUICKTASKWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x177E3490)
#define MOLEMOLE_UIGENERALBATTLEQUICKTASKWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x177E34F0)
#define MOLEMOLE_UIGENERALBATTLEQUICKTASKWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x177E3590)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralBattleQuickTaskWidgetController_TypeDefinitionIndex = 82735;
