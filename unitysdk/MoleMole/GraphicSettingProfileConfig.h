...
#define MOLEMOLE_GRAPHICSETTINGPROFILECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x161F3DD0)

namespace MoleMole
{
	inline static constexpr unsigned int GraphicSettingProfileConfig_TypeDefinitionIndex = 79596;
