...
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x14D81890)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_GOACCESS_OFFSET UNITYSDK_OFFSET(0xE4587C0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_ONCLICKITEMBTN_OFFSET UNITYSDK_OFFSET(0x14D81AA0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14D81D70)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14D81E00)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14D818A0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14D81C00)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_PLAYSCORECHANGE_OFFSET UNITYSDK_OFFSET(0xE4584D0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_SETACCESS_OFFSET UNITYSDK_OFFSET(0xE4586F0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_SETAREA_OFFSET UNITYSDK_OFFSET(0xE458770)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_SETREAWRDLIST_OFFSET UNITYSDK_OFFSET(0x14D81E70)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xE458880)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__8_0_OFFSET UNITYSDK_OFFSET(0xE4589C0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER__ONUIOPEN_B__10_0_OFFSET UNITYSDK_OFFSET(0xE458AC0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER__ONUIOPEN_B__10_1_OFFSET UNITYSDK_OFFSET(0xE458B20)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xE458BE0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xE458C70)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xE458C80)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xE458C90)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleExpeditionResultDialogPopWindowController_TypeDefinitionIndex = 45903;

	class UISuibianTempleExpeditionResultDialogPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79AE422BA06F6D26_58* _view; // 0x310
		::System::Collections::Generic::List_1<::Class_1_0D6706375CDAAE8C*>* _curShowItems; // 0x318
		::System::Collections::Generic::List_1<::Class_1_1685EC66FBD28897*>* _curSortShowItem; // 0x320
		::System::Collections::Generic::List_1<::UnityEngine::GameObject*>* _gamePadGameObjects; // 0x328
		::System::Int32 accessID; // 0x330
		::System::Int32 area; // 0x334
