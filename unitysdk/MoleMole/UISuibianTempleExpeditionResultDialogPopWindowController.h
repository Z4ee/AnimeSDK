...
class Class_2_79AE422BA06F6D26_257;
...
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x151A15F0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_GOACCESS_OFFSET UNITYSDK_OFFSET(0x151A2BF0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_ONCLICKITEMBTN_OFFSET UNITYSDK_OFFSET(0x151A1800)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x151A1AD0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x151A1B60)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x151A1600)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x151A1960)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_PLAYSCORECHANGE_OFFSET UNITYSDK_OFFSET(0x151A2900)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_SETACCESS_OFFSET UNITYSDK_OFFSET(0x151A2B20)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_SETAREA_OFFSET UNITYSDK_OFFSET(0x151A2BA0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_SETREAWRDLIST_OFFSET UNITYSDK_OFFSET(0x151A1BD0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x151A2C90)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__8_0_OFFSET UNITYSDK_OFFSET(0x151A2DD0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER__ONUIOPEN_B__10_0_OFFSET UNITYSDK_OFFSET(0x151A2ED0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER__ONUIOPEN_B__10_1_OFFSET UNITYSDK_OFFSET(0x151A2F40)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x151A3000)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x151A3090)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x151A30A0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x151A30B0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleExpeditionResultDialogPopWindowController_TypeDefinitionIndex = 76551;

	class UISuibianTempleExpeditionResultDialogPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79AE422BA06F6D26_257* _view; // 0x318
