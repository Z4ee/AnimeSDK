...
#define MOLEMOLE_UIVIDEOWIDGETCONTEXT_GET_ACCELERATION_OFFSET UNITYSDK_OFFSET(0x15534F80)
#define MOLEMOLE_UIVIDEOWIDGETCONTEXT_GET_VIDEOSKIP_OFFSET UNITYSDK_OFFSET(0x15534FA0)
#define MOLEMOLE_UIVIDEOWIDGETCONTEXT_SET_ACCELERATION_OFFSET UNITYSDK_OFFSET(0x15534F90)
#define MOLEMOLE_UIVIDEOWIDGETCONTEXT_SET_VIDEOSKIP_OFFSET UNITYSDK_OFFSET(0x15534FB0)
#define MOLEMOLE_UIVIDEOWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15534FC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVideoWidgetContext_TypeDefinitionIndex = 54363;

	class UIVideoWidgetContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::Class_1_D00124C4966CEBFC* _Acceleration_k__BackingField; // 0x28
		::UnityEngine::Video::VideoClip* clip; // 0x30
		::System::Action* OnPlayEnd; // 0x38
		::System::Action* OnVideoDestroy; // 0x40
		::System::Action* OnRealPlay; // 0x48
		::System::Action* OnSkip; // 0x50
		::Class_1_F7E58FEB09AEC901* _VideoSkip_k__BackingField; // 0x58
		::System::String* audioTimeline; // 0x60
		::Class_2_208CC9941471731A_299* performTemplate; // 0x68
		::System::Action* OnSetPlayData; // 0x70
		...
		::Enum_3_43038093CB6347E9 fadeMode; // 0x90
		::UnityEngine::UI::AspectRatioFitter_AspectMode aspectMode; // 0x94
		::System::Boolean isPlayOnAwake; // 0x98
		::System::Boolean IsSkip; // 0x99
