...
#define MOLEMOLE_MONOEFFECTFORUI_AWAKE_OFFSET UNITYSDK_OFFSET(0x16E70190)
#define MOLEMOLE_MONOEFFECTFORUI_GET_PARTICLESYS_OFFSET UNITYSDK_OFFSET(0x16E700B0)
#define MOLEMOLE_MONOEFFECTFORUI_GET_RENDERERS_OFFSET UNITYSDK_OFFSET(0x16E6FFD0)
#define MOLEMOLE_MONOEFFECTFORUI_METHOD_5_A5B6063FFC26FC8F_OFFSET UNITYSDK_OFFSET(0x16E70290)
#define MOLEMOLE_MONOEFFECTFORUI_UPDATEALPHA_OFFSET UNITYSDK_OFFSET(0x16E708C0)
#define MOLEMOLE_MONOEFFECTFORUI_UPDATE_OFFSET UNITYSDK_OFFSET(0x16E70240)
#define MOLEMOLE_MONOEFFECTFORUI__CTOR_OFFSET UNITYSDK_OFFSET(0x16E70D40)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectForUI_TypeDefinitionIndex = 52286;
