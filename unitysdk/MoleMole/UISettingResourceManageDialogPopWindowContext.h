...
#define MOLEMOLE_UISETTINGRESOURCEMANAGEDIALOGPOPWINDOWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x14876C30)

namespace MoleMole
{
	inline static constexpr unsigned int UISettingResourceManageDialogPopWindowContext_TypeDefinitionIndex = 59679;
	...
	public:
		...
		::Enum_3_C6855DE1E2953473 PageType; // 0x3C
		::System::Int32 BranchId; // 0x40
