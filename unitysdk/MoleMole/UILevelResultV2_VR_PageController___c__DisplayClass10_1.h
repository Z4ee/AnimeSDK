...
#define MOLEMOLE_UILEVELRESULTV2_VR_PAGECONTROLLER___C__DISPLAYCLASS10_1__CTOR_OFFSET UNITYSDK_OFFSET(0x15279250)
#define MOLEMOLE_UILEVELRESULTV2_VR_PAGECONTROLLER___C__DISPLAYCLASS10_1__REFRESHFAIRYBTNSTATE_B__20_OFFSET UNITYSDK_OFFSET(0x15279260)
#define MOLEMOLE_UILEVELRESULTV2_VR_PAGECONTROLLER___C__DISPLAYCLASS10_1__REFRESHFAIRYBTNSTATE_B__21_OFFSET UNITYSDK_OFFSET(0x15279290)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultV2_VR_PageController___c__DisplayClass10_1_TypeDefinitionIndex = 55215;
