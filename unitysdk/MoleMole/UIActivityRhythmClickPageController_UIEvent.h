...
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER_UIEVENT_ADDEVENT_OFFSET UNITYSDK_OFFSET(0x18E22530)
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER_UIEVENT_CLEAR_OFFSET UNITYSDK_OFFSET(0x18E224A0)
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER_UIEVENT_FINISH_OFFSET UNITYSDK_OFFSET(0x18E22790)
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER_UIEVENT_START_OFFSET UNITYSDK_OFFSET(0x18E22630)
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER_UIEVENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x18E22680)
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER_UIEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18E22410)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityRhythmClickPageController_UIEvent_TypeDefinitionIndex = 87488;
