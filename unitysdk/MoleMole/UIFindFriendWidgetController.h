...
#define MOLEMOLE_UIFINDFRIENDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18579D00)
#define MOLEMOLE_UIFINDFRIENDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18579D90)
#define MOLEMOLE_UIFINDFRIENDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18579C30)
#define MOLEMOLE_UIFINDFRIENDWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18579C90)
#define MOLEMOLE_UIFINDFRIENDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18579E10)
#define MOLEMOLE_UIFINDFRIENDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18579E70)
#define MOLEMOLE_UIFINDFRIENDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18579F00)
#define MOLEMOLE_UIFINDFRIENDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18579F90)
#define MOLEMOLE_UIFINDFRIENDWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1857A020)

namespace MoleMole
{
	inline static constexpr unsigned int UIFindFriendWidgetController_TypeDefinitionIndex = 59695;
