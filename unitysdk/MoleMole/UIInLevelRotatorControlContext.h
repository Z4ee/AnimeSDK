...
#define MOLEMOLE_UIINLEVELROTATORCONTROLCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x17DDF4E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelRotatorControlContext_TypeDefinitionIndex = 74503;
