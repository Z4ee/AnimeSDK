...
#define MOLEMOLE_UIBOSSCHALLENGEBADGEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x172C9550)
#define MOLEMOLE_UIBOSSCHALLENGEBADGEWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x172C95C0)
#define MOLEMOLE_UIBOSSCHALLENGEBADGEWIDGETCONTROLLER_SETMEDALID_OFFSET UNITYSDK_OFFSET(0x172C9680)
#define MOLEMOLE_UIBOSSCHALLENGEBADGEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x172C9800)
#define MOLEMOLE_UIBOSSCHALLENGEBADGEWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x172C9860)

namespace MoleMole
{
	inline static constexpr unsigned int UIBossChallengeBadgeWidgetController_TypeDefinitionIndex = 62009;
