...
#define MOLEMOLE_MONOUIPORTRAITCONFIG_GET_REALKEY_OFFSET UNITYSDK_OFFSET(0x136E12C0)
#define MOLEMOLE_MONOUIPORTRAITCONFIG_SETUPIMAGECONFIG_OFFSET UNITYSDK_OFFSET(0x136E14E0)
#define MOLEMOLE_MONOUIPORTRAITCONFIG_SETUPPREFABCONFIG_OFFSET UNITYSDK_OFFSET(0x136E17E0)
#define MOLEMOLE_MONOUIPORTRAITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x136E1A70)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIPortraitConfig_TypeDefinitionIndex = 46667;
