...
#define MOLEMOLE_UIPLAYERACCESSORYPAGECONTROLLER___C__DISPLAYCLASS42_0__CTOR_OFFSET UNITYSDK_OFFSET(0x178DA4B0)
#define MOLEMOLE_UIPLAYERACCESSORYPAGECONTROLLER___C__DISPLAYCLASS42_0__SENDCHANGESKIN_B__1_OFFSET UNITYSDK_OFFSET(0x178DA4E0)
#define MOLEMOLE_UIPLAYERACCESSORYPAGECONTROLLER___C__DISPLAYCLASS42_0__SENDCHANGESKIN_B__4_OFFSET UNITYSDK_OFFSET(0x178DA4C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPlayerAccessoryPageController___c__DisplayClass42_0_TypeDefinitionIndex = 44134;
