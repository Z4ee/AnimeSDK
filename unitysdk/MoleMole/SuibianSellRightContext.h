...
#define MOLEMOLE_SUIBIANSELLRIGHTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18716DC0)

namespace MoleMole
{
	inline static constexpr unsigned int SuibianSellRightContext_TypeDefinitionIndex = 79661;
