...
#define MOLEMOLE_SUIBIANSELLRIGHTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15E5BC60)

namespace MoleMole
{
	inline static constexpr unsigned int SuibianSellRightContext_TypeDefinitionIndex = 70562;
