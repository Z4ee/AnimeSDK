...
#define MOLEMOLE_UIHANDBOOKTABBTNSTIPSWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x190E4370)
#define MOLEMOLE_UIHANDBOOKTABBTNSTIPSWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x190E43E0)
#define MOLEMOLE_UIHANDBOOKTABBTNSTIPSWIDGETCONTROLLER_SETTABTYPE_OFFSET UNITYSDK_OFFSET(0x190E41F0)
#define MOLEMOLE_UIHANDBOOKTABBTNSTIPSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x190E44A0)
#define MOLEMOLE_UIHANDBOOKTABBTNSTIPSWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x190E4500)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookTabBtnsTipsWidgetController_TypeDefinitionIndex = 54084;
