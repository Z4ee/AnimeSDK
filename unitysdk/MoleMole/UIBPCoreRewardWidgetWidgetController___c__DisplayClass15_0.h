...
#define MOLEMOLE_UIBPCOREREWARDWIDGETWIDGETCONTROLLER___C__DISPLAYCLASS15_0__CTOR_OFFSET UNITYSDK_OFFSET(0x175A3590)
#define MOLEMOLE_UIBPCOREREWARDWIDGETWIDGETCONTROLLER___C__DISPLAYCLASS15_0__TAKESELECTCOREREWARD_B__0_OFFSET UNITYSDK_OFFSET(0x175A3B60)

namespace MoleMole
{
	inline static constexpr unsigned int UIBPCoreRewardWidgetWidgetController___c__DisplayClass15_0_TypeDefinitionIndex = 78935;
