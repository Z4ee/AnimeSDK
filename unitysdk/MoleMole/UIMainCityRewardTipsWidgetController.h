...
#define MOLEMOLE_UIMAINCITYREWARDTIPSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1483C8C0)
#define MOLEMOLE_UIMAINCITYREWARDTIPSWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x1483CA30)
#define MOLEMOLE_UIMAINCITYREWARDTIPSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1483CBB0)
#define MOLEMOLE_UIMAINCITYREWARDTIPSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1483C860)
#define MOLEMOLE_UIMAINCITYREWARDTIPSWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1483C9C0)
#define MOLEMOLE_UIMAINCITYREWARDTIPSWIDGETCONTROLLER_PLAYFRAMETEXTURE_OFFSET UNITYSDK_OFFSET(0x1483D100)
#define MOLEMOLE_UIMAINCITYREWARDTIPSWIDGETCONTROLLER_PLAYREWARDFADEIN_OFFSET UNITYSDK_OFFSET(0x1483D230)
#define MOLEMOLE_UIMAINCITYREWARDTIPSWIDGETCONTROLLER_PLAYREWARDFADEOUT_OFFSET UNITYSDK_OFFSET(0x1483D590)
#define MOLEMOLE_UIMAINCITYREWARDTIPSWIDGETCONTROLLER_REFRESHCHANGE_OFFSET UNITYSDK_OFFSET(0x1483D180)
#define MOLEMOLE_UIMAINCITYREWARDTIPSWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1483CD50)
#define MOLEMOLE_UIMAINCITYREWARDTIPSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1483D870)
#define MOLEMOLE_UIMAINCITYREWARDTIPSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1483D8D0)
#define MOLEMOLE_UIMAINCITYREWARDTIPSWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x1483D960)
#define MOLEMOLE_UIMAINCITYREWARDTIPSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1483D970)
#define MOLEMOLE_UIMAINCITYREWARDTIPSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1483DA00)
#define MOLEMOLE_UIMAINCITYREWARDTIPSWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1483DA90)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityRewardTipsWidgetController_TypeDefinitionIndex = 67515;

	class UIMainCityRewardTipsWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_1_0D6706375CDAAE8C* _itemData; // 0x2B8
		::Class_2_75FB4A09078427E5_1* _view; // 0x2C0
		::Foundation::Coroutine::CoroutineHandle fadeOutHandle; // 0x2C8
		::Foundation::Coroutine::CoroutineHandle fadeInHandle; // 0x2CC
		::UnityEngine::RectTransform* rectTransform; // 0x2D0
