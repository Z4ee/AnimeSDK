...
#define MOLEMOLE_GLOBALMAPRESPONSE_METHOD_5_0B63A0EF42BD601E_OFFSET UNITYSDK_OFFSET(0x12338190)
#define MOLEMOLE_GLOBALMAPRESPONSE_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x12338050)
#define MOLEMOLE_GLOBALMAPRESPONSE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x12338010)
#define MOLEMOLE_GLOBALMAPRESPONSE_ONDRAG_OFFSET UNITYSDK_OFFSET(0x123380A0)
#define MOLEMOLE_GLOBALMAPRESPONSE_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x123380F0)
#define MOLEMOLE_GLOBALMAPRESPONSE_ONPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x12337FC0)
#define MOLEMOLE_GLOBALMAPRESPONSE_UPDATE_OFFSET UNITYSDK_OFFSET(0x12337D80)
#define MOLEMOLE_GLOBALMAPRESPONSE__CTOR_OFFSET UNITYSDK_OFFSET(0x12338140)

namespace MoleMole
{
	inline static constexpr unsigned int GlobalMapResponse_TypeDefinitionIndex = 62390;
