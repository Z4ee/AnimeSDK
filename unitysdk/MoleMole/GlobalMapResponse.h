...
#define MOLEMOLE_GLOBALMAPRESPONSE_METHOD_5_0B63A0EF42BD601E_OFFSET UNITYSDK_OFFSET(0x136A8CE0)
#define MOLEMOLE_GLOBALMAPRESPONSE_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x136A8BA0)
#define MOLEMOLE_GLOBALMAPRESPONSE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x136A8B60)
#define MOLEMOLE_GLOBALMAPRESPONSE_ONDRAG_OFFSET UNITYSDK_OFFSET(0x136A8BF0)
#define MOLEMOLE_GLOBALMAPRESPONSE_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x136A8C40)
#define MOLEMOLE_GLOBALMAPRESPONSE_ONPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x136A8B10)
#define MOLEMOLE_GLOBALMAPRESPONSE_UPDATE_OFFSET UNITYSDK_OFFSET(0x136A88D0)
#define MOLEMOLE_GLOBALMAPRESPONSE__CTOR_OFFSET UNITYSDK_OFFSET(0x136A8C90)

namespace MoleMole
{
	inline static constexpr unsigned int GlobalMapResponse_TypeDefinitionIndex = 41247;

	class GlobalMapResponse : public ::UnityEngine::MonoBehaviour
	{
	public:
		::UnityEngine::Vector3 Field_5_1; // 0x18
		::UnityEngine::Vector3 Field_5_0; // 0x24
		::UnityEngine::Vector2 Field_5_7; // 0x30
