...
#define MOLEMOLE_DISTORTIONPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x18F4EC40)
#define MOLEMOLE_DISTORTIONPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x18F4ED80)
#define MOLEMOLE_DISTORTIONPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x18F4EB60)
#define MOLEMOLE_DISTORTIONPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x18F4ED00)
#define MOLEMOLE_DISTORTIONPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x18F4EB50)
#define MOLEMOLE_DISTORTIONPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x18F4EEA0)
#define MOLEMOLE_DISTORTIONPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x18F4EF30)
#define MOLEMOLE_DISTORTIONPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x18F4EFC0)
#define MOLEMOLE_DISTORTIONPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x18F4F050)

namespace MoleMole
{
	inline static constexpr unsigned int DistortionProfile_TypeDefinitionIndex = 50364;
