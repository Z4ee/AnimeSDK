...
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_BUDDYFADEGROUP___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0x189CD170)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_BUDDYFADEGROUP___C__DISPLAYCLASS14_0__START_B__0_OFFSET UNITYSDK_OFFSET(0x189CD180)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_BUDDYFADEGROUP___C__DISPLAYCLASS14_0__START_B__1_OFFSET UNITYSDK_OFFSET(0x189CD270)

namespace MoleMole
{
	inline static constexpr unsigned int UIModificationShop3DModelController_BuddyFadeGroup___c__DisplayClass14_0_TypeDefinitionIndex = 67402;

	class UIModificationShop3DModelController_BuddyFadeGroup___c__DisplayClass14_0 : public ::System::Object
	{
	public:
		::MoleMole::UIModificationShop3DModelController_BuddyFadeGroup* __4__this; // 0x10
