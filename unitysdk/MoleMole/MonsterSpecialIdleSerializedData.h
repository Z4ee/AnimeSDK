...
#define MOLEMOLE_MONSTERSPECIALIDLESERIALIZEDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17924A00)

namespace MoleMole
{
	inline static constexpr unsigned int MonsterSpecialIdleSerializedData_TypeDefinitionIndex = 59314;
