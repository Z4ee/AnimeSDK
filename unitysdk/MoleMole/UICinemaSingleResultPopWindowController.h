...
class Class_2_017FF2ACAA778DB1;
...
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x170AA850)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER_INITDATALINES_OFFSET UNITYSDK_OFFSET(0x170AB560)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER_INITDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x170ABBF0)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER_INITMOVEIMG_OFFSET UNITYSDK_OFFSET(0x170AB3D0)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER_INITUI_OFFSET UNITYSDK_OFFSET(0x170AAB00)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER_ONCLICKCLOSE_OFFSET UNITYSDK_OFFSET(0x170AB0B0)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER_ONCLICKRESTART_OFFSET UNITYSDK_OFFSET(0x170ABF20)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x170AAFA0)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x170AB030)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x170AB150)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x170AA860)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x170AAA20)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x170ABF90)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER__ONCLICKCLOSE_B__16_0_OFFSET UNITYSDK_OFFSET(0x170ABFA0)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x170AC0A0)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x170AC130)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x170AC160)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x170AC170)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x170AC180)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaSingleResultPopWindowController_TypeDefinitionIndex = 49295;
	...
	public:
		...
		::Class_2_017FF2ACAA778DB1* _view; // 0x318
