...
#define MOLEMOLE_UIACTIVITYVIDEOTABWIDGETCONTROLLER_INITTABS_OFFSET UNITYSDK_OFFSET(0x17590A90)
#define MOLEMOLE_UIACTIVITYVIDEOTABWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17590880)
#define MOLEMOLE_UIACTIVITYVIDEOTABWIDGETCONTROLLER_ONTABCLICKED_OFFSET UNITYSDK_OFFSET(0x17591190)
#define MOLEMOLE_UIACTIVITYVIDEOTABWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17590910)
#define MOLEMOLE_UIACTIVITYVIDEOTABWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17590750)
#define MOLEMOLE_UIACTIVITYVIDEOTABWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17590810)
#define MOLEMOLE_UIACTIVITYVIDEOTABWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x175909A0)
#define MOLEMOLE_UIACTIVITYVIDEOTABWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x175918A0)
#define MOLEMOLE_UIACTIVITYVIDEOTABWIDGETCONTROLLER__ONUIINIT_B__8_0_OFFSET UNITYSDK_OFFSET(0x17591900)
#define MOLEMOLE_UIACTIVITYVIDEOTABWIDGETCONTROLLER__ONUIINIT_B__8_1_OFFSET UNITYSDK_OFFSET(0x175919B0)
#define MOLEMOLE_UIACTIVITYVIDEOTABWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17591A50)
#define MOLEMOLE_UIACTIVITYVIDEOTABWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17591AE0)
#define MOLEMOLE_UIACTIVITYVIDEOTABWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17591B70)
#define MOLEMOLE_UIACTIVITYVIDEOTABWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17591C00)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityVideoTabWidgetController_TypeDefinitionIndex = 46572;
	...
	public:
		...
		::Class_2_208CC9941471731A_818* _questRuleTemplate; // 0x2E0
