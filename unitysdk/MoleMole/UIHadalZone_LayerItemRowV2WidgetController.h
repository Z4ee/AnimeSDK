...
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_GET_CURRENTLAYERINFOINDEX_OFFSET UNITYSDK_OFFSET(0x19E9A180)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_GET_CURRENTZONELAYERINFO_OFFSET UNITYSDK_OFFSET(0x19E9A170)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_GET_UNLOCKANIM_OFFSET UNITYSDK_OFFSET(0x19E9BB80)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_MARKSELECTSTATUS_OFFSET UNITYSDK_OFFSET(0x19E9A970)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19E9A280)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x19E9A770)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0x19E9B9B0)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x19E9BBF0)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x19E9A310)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19E9A480)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19E9A1B0)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19E9A210)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_SETONACTIVECALLBACK_OFFSET UNITYSDK_OFFSET(0x19E9B910)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_SETONCLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x19E9A920)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_SETONUNLOCKCALLBACK_OFFSET UNITYSDK_OFFSET(0x19E9B960)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_SETPARENTWINDOWFADEINDONEFUNC_OFFSET UNITYSDK_OFFSET(0x19E9CEB0)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER__CLOSEALLSTATEOBJECTS_OFFSET UNITYSDK_OFFSET(0x19E9C480)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER__COLLECTSELECTGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x19E9AD50)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E9D150)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER__GETDIGITSPRITE_OFFSET UNITYSDK_OFFSET(0x19E9B820)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER__ISINMODEA_OFFSET UNITYSDK_OFFSET(0x19E9A8D0)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER__TRYPLAYUNLOCKLAYERANIM_OFFSET UNITYSDK_OFFSET(0x19E9C5E0)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER__TRYSHOWTRACKICON_OFFSET UNITYSDK_OFFSET(0x19E9CC10)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER__UNLOCLAYERCOROUTINE_OFFSET UNITYSDK_OFFSET(0x19E9CF00)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER__UPDATESTATELAYERINFO_OFFSET UNITYSDK_OFFSET(0x19E9AFE0)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19E9D1B0)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x19E9D240)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER___BASE_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0x19E9D2D0)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x19E9D360)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x19E9D400)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19E9D4A0)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19E9D530)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19E9D5C0)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER___TRYSHOWTRACKICON_G___CHECKTRACK_45_0_OFFSET UNITYSDK_OFFSET(0x19E9CF80)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_LayerItemRowV2WidgetController_TypeDefinitionIndex = 78143;
	...
	public:
		...
		::Class_1_5DA2E7556103D5A3_446* _zoneInfo; // 0x2F8
		...
		::Class_1_5DA2E7556103D5A3_446* get_CurrentZoneLayerInfo()
		{
			return ((::Class_1_5DA2E7556103D5A3_446*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_GET_CURRENTZONELAYERINFO_OFFSET))(this);
		}
		...
		::System::Void _UpdateStateLayerInfo(::Class_1_5DA2E7556103D5A3_446* infoTemplate, ::UnityEngine::GameObject* targetObject)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_5DA2E7556103D5A3_446*, ::UnityEngine::GameObject*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER__UPDATESTATELAYERINFO_OFFSET))(this, infoTemplate, targetObject);
		}
