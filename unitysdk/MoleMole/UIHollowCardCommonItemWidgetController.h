...
#define MOLEMOLE_UIHOLLOWCARDCOMMONITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1720BA40)
#define MOLEMOLE_UIHOLLOWCARDCOMMONITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1720BAD0)
#define MOLEMOLE_UIHOLLOWCARDCOMMONITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1720B970)
#define MOLEMOLE_UIHOLLOWCARDCOMMONITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1720B9D0)
#define MOLEMOLE_UIHOLLOWCARDCOMMONITEMWIDGETCONTROLLER_REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0x1720C220)
#define MOLEMOLE_UIHOLLOWCARDCOMMONITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1720BB50)
#define MOLEMOLE_UIHOLLOWCARDCOMMONITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1720C680)
#define MOLEMOLE_UIHOLLOWCARDCOMMONITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1720C6E0)
#define MOLEMOLE_UIHOLLOWCARDCOMMONITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1720C770)
#define MOLEMOLE_UIHOLLOWCARDCOMMONITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1720C800)
#define MOLEMOLE_UIHOLLOWCARDCOMMONITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1720C890)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCardCommonItemWidgetController_TypeDefinitionIndex = 86642;

	class UIHollowCardCommonItemWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_61* _view; // 0x2C0
