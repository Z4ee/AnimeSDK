...
#define MOLEMOLE_UIGENERALBUBBLECHATCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1730B410)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralBubbleChatContext_TypeDefinitionIndex = 66366;
