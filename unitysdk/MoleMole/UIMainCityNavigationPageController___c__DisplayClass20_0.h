...
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER___C__DISPLAYCLASS20_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16D960B0)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER___C__DISPLAYCLASS20_0__ONUIOPEN_B__0_OFFSET UNITYSDK_OFFSET(0x16D960C0)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER___C__DISPLAYCLASS20_0__ONUIOPEN_B__1_OFFSET UNITYSDK_OFFSET(0x16D96180)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER___C__DISPLAYCLASS20_0__ONUIOPEN_B__2_OFFSET UNITYSDK_OFFSET(0x16D96250)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityNavigationPageController___c__DisplayClass20_0_TypeDefinitionIndex = 47562;
