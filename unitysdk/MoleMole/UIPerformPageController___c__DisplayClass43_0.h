...
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___C__DISPLAYCLASS43_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17889F90)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___C__DISPLAYCLASS43_0__LOADTIMELINEINITWORLDPOS_B__0_OFFSET UNITYSDK_OFFSET(0x1788B980)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___C__DISPLAYCLASS43_0__LOADTIMELINEINITWORLDPOS_B__1_OFFSET UNITYSDK_OFFSET(0x1788B9A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPerformPageController___c__DisplayClass43_0_TypeDefinitionIndex = 85285;
