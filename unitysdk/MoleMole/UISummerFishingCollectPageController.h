...
#define MOLEMOLE_UISUMMERFISHINGCOLLECTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x157C0650)
#define MOLEMOLE_UISUMMERFISHINGCOLLECTPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x157C0660)
#define MOLEMOLE_UISUMMERFISHINGCOLLECTPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x157C06D0)
#define MOLEMOLE_UISUMMERFISHINGCOLLECTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x157C0790)
#define MOLEMOLE_UISUMMERFISHINGCOLLECTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x157C0840)
#define MOLEMOLE_UISUMMERFISHINGCOLLECTPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x157C0850)
#define MOLEMOLE_UISUMMERFISHINGCOLLECTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x157C08F0)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerFishingCollectPageController_TypeDefinitionIndex = 47393;
