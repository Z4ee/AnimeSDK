...
#define MOLEMOLE_UIBANGKOVTALENTROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1802BA00)
#define MOLEMOLE_UIBANGKOVTALENTROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1802BA70)
#define MOLEMOLE_UIBANGKOVTALENTROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1802BB10)
#define MOLEMOLE_UIBANGKOVTALENTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1802BCD0)
#define MOLEMOLE_UIBANGKOVTALENTROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1802BD30)
#define MOLEMOLE_UIBANGKOVTALENTROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1802BDD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangkovTalentRowWidgetController_TypeDefinitionIndex = 55423;
