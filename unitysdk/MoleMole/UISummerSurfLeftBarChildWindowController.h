...
#define MOLEMOLE_UISUMMERSURFLEFTBARCHILDWINDOWCONTROLLER_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x151AE7F0)
#define MOLEMOLE_UISUMMERSURFLEFTBARCHILDWINDOWCONTROLLER_GET_FILLMAT_OFFSET UNITYSDK_OFFSET(0x151AE7E0)
#define MOLEMOLE_UISUMMERSURFLEFTBARCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x151AE5C0)
#define MOLEMOLE_UISUMMERSURFLEFTBARCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x151AE770)
#define MOLEMOLE_UISUMMERSURFLEFTBARCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x151AE810)
#define MOLEMOLE_UISUMMERSURFLEFTBARCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x151AE870)
#define MOLEMOLE_UISUMMERSURFLEFTBARCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x151AE900)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerSurfLeftBarChildWindowController_TypeDefinitionIndex = 78867;
