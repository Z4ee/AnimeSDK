...
#define MOLEMOLE_UIINLEVELFRIENDCARDROWWIDGETCONTROLLER_FORBIDDENCHAT_OFFSET UNITYSDK_OFFSET(0x19625980)
#define MOLEMOLE_UIINLEVELFRIENDCARDROWWIDGETCONTROLLER_ISFORBIDDEN_OFFSET UNITYSDK_OFFSET(0x196256E0)
#define MOLEMOLE_UIINLEVELFRIENDCARDROWWIDGETCONTROLLER_ONBANBTNCALLBACK_OFFSET UNITYSDK_OFFSET(0x19626890)
#define MOLEMOLE_UIINLEVELFRIENDCARDROWWIDGETCONTROLLER_ONREFRESHFORBIDDENCHATCHANGE_OFFSET UNITYSDK_OFFSET(0x196261B0)
#define MOLEMOLE_UIINLEVELFRIENDCARDROWWIDGETCONTROLLER_ONSELFINFOCALLBACK_OFFSET UNITYSDK_OFFSET(0x19626310)
#define MOLEMOLE_UIINLEVELFRIENDCARDROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19625FB0)
#define MOLEMOLE_UIINLEVELFRIENDCARDROWWIDGETCONTROLLER_REFRESHDATA_OFFSET UNITYSDK_OFFSET(0x19625C00)
#define MOLEMOLE_UIINLEVELFRIENDCARDROWWIDGETCONTROLLER_REFRESHFORBIDDENUI_OFFSET UNITYSDK_OFFSET(0x19626BF0)
#define MOLEMOLE_UIINLEVELFRIENDCARDROWWIDGETCONTROLLER_REFRESHFORBIDDEN_OFFSET UNITYSDK_OFFSET(0x19626260)
#define MOLEMOLE_UIINLEVELFRIENDCARDROWWIDGETCONTROLLER_REFRESHUI_OFFSET UNITYSDK_OFFSET(0x19625D40)
#define MOLEMOLE_UIINLEVELFRIENDCARDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19626C60)
#define MOLEMOLE_UIINLEVELFRIENDCARDROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19626C80)
#define MOLEMOLE_UIINLEVELFRIENDCARDROWWIDGETCONTROLLER___BASE_REFRESHUI_OFFSET UNITYSDK_OFFSET(0x19626C90)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelFriendCardRowWidgetController_TypeDefinitionIndex = 57428;
