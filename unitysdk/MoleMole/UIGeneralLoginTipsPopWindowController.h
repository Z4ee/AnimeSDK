...
#define MOLEMOLE_UIGENERALLOGINTIPSPOPWINDOWCONTROLLER_CLOSETEXT_OFFSET UNITYSDK_OFFSET(0x185A4A50)
#define MOLEMOLE_UIGENERALLOGINTIPSPOPWINDOWCONTROLLER_FADEIN_OFFSET UNITYSDK_OFFSET(0x185A44C0)
#define MOLEMOLE_UIGENERALLOGINTIPSPOPWINDOWCONTROLLER_FADEOUT_OFFSET UNITYSDK_OFFSET(0x185A4550)
#define MOLEMOLE_UIGENERALLOGINTIPSPOPWINDOWCONTROLLER_GETVIEW_OFFSET UNITYSDK_OFFSET(0x185A4B80)
#define MOLEMOLE_UIGENERALLOGINTIPSPOPWINDOWCONTROLLER_GET_ISIGNOREINPUT_OFFSET UNITYSDK_OFFSET(0x185A41B0)
#define MOLEMOLE_UIGENERALLOGINTIPSPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x185A41A0)
#define MOLEMOLE_UIGENERALLOGINTIPSPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x185A4220)
#define MOLEMOLE_UIGENERALLOGINTIPSPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x185A4450)
#define MOLEMOLE_UIGENERALLOGINTIPSPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x185A41C0)
#define MOLEMOLE_UIGENERALLOGINTIPSPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x185A42B0)
#define MOLEMOLE_UIGENERALLOGINTIPSPOPWINDOWCONTROLLER_SETIMAGE_OFFSET UNITYSDK_OFFSET(0x185A4900)
#define MOLEMOLE_UIGENERALLOGINTIPSPOPWINDOWCONTROLLER_SETTEXT_OFFSET UNITYSDK_OFFSET(0x185A4660)
#define MOLEMOLE_UIGENERALLOGINTIPSPOPWINDOWCONTROLLER_SHOWLOGINSUCCESS_OFFSET UNITYSDK_OFFSET(0x185A4B40)
#define MOLEMOLE_UIGENERALLOGINTIPSPOPWINDOWCONTROLLER_SHOWTOTAS_OFFSET UNITYSDK_OFFSET(0x185A4B00)
#define MOLEMOLE_UIGENERALLOGINTIPSPOPWINDOWCONTROLLER__CLOSETEXT_B__14_0_OFFSET UNITYSDK_OFFSET(0x185A4BE0)
#define MOLEMOLE_UIGENERALLOGINTIPSPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x185A4BD0)
#define MOLEMOLE_UIGENERALLOGINTIPSPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x185A4CB0)
#define MOLEMOLE_UIGENERALLOGINTIPSPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x185A4D40)
#define MOLEMOLE_UIGENERALLOGINTIPSPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x185A4D50)
#define MOLEMOLE_UIGENERALLOGINTIPSPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x185A4D60)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralLoginTipsPopWindowController_TypeDefinitionIndex = 48747;
