...
#define MOLEMOLE_LIMITITEMMAXMESSAGE_DIRECTSHOW_OFFSET UNITYSDK_OFFSET(0x10BC68E0)
#define MOLEMOLE_LIMITITEMMAXMESSAGE_DOPROCESS_OFFSET UNITYSDK_OFFSET(0x10BC6930)
#define MOLEMOLE_LIMITITEMMAXMESSAGE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x10BC6550)
#define MOLEMOLE_LIMITITEMMAXMESSAGE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x10BC6890)
#define MOLEMOLE_LIMITITEMMAXMESSAGE_SHOWREWARDWINDOW_OFFSET UNITYSDK_OFFSET(0x10BC6980)
#define MOLEMOLE_LIMITITEMMAXMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x10BC6560)

namespace MoleMole
{
	inline static constexpr unsigned int LimitItemMaxMessage_TypeDefinitionIndex = 82776;
