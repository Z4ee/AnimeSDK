...
#define MOLEMOLE_LIMITITEMMAXMESSAGE_DIRECTSHOW_OFFSET UNITYSDK_OFFSET(0x15135100)
#define MOLEMOLE_LIMITITEMMAXMESSAGE_DOPROCESS_OFFSET UNITYSDK_OFFSET(0x15135150)
#define MOLEMOLE_LIMITITEMMAXMESSAGE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x15134D70)
#define MOLEMOLE_LIMITITEMMAXMESSAGE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x151350B0)
#define MOLEMOLE_LIMITITEMMAXMESSAGE_SHOWREWARDWINDOW_OFFSET UNITYSDK_OFFSET(0x151351A0)
#define MOLEMOLE_LIMITITEMMAXMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x15134D80)

namespace MoleMole
{
	inline static constexpr unsigned int LimitItemMaxMessage_TypeDefinitionIndex = 48164;
