...
#define MOLEMOLE_FRAMERATEPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x118C5CE0)
#define MOLEMOLE_FRAMERATEPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x118C5E20)
#define MOLEMOLE_FRAMERATEPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x118C5C00)
#define MOLEMOLE_FRAMERATEPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x118C5DA0)
#define MOLEMOLE_FRAMERATEPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x118C5BF0)
#define MOLEMOLE_FRAMERATEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x118C5F40)
#define MOLEMOLE_FRAMERATEPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x118C5FE0)
#define MOLEMOLE_FRAMERATEPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x118C6080)
#define MOLEMOLE_FRAMERATEPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x118C6120)

namespace MoleMole
{
	inline static constexpr unsigned int FrameRateProfile_TypeDefinitionIndex = 78446;
