...
#define MOLEMOLE_FRAMERATEPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x18B30D90)
#define MOLEMOLE_FRAMERATEPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x18B30ED0)
#define MOLEMOLE_FRAMERATEPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x18B30CB0)
#define MOLEMOLE_FRAMERATEPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x18B30E50)
#define MOLEMOLE_FRAMERATEPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x18B30CA0)
#define MOLEMOLE_FRAMERATEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B30FF0)
#define MOLEMOLE_FRAMERATEPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x18B31090)
#define MOLEMOLE_FRAMERATEPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x18B31130)
#define MOLEMOLE_FRAMERATEPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x18B311D0)

namespace MoleMole
{
	inline static constexpr unsigned int FrameRateProfile_TypeDefinitionIndex = 49324;
