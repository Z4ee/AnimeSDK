...
#define MOLEMOLE_FRAMERATEPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x10E19CE0)
#define MOLEMOLE_FRAMERATEPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x10E19E20)
#define MOLEMOLE_FRAMERATEPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x10E19C00)
#define MOLEMOLE_FRAMERATEPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x10E19DA0)
#define MOLEMOLE_FRAMERATEPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x10E19BF0)
#define MOLEMOLE_FRAMERATEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x10E19F40)
#define MOLEMOLE_FRAMERATEPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x10E19FE0)
#define MOLEMOLE_FRAMERATEPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x10E1A080)
#define MOLEMOLE_FRAMERATEPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x10E1A120)

namespace MoleMole
{
	inline static constexpr unsigned int FrameRateProfile_TypeDefinitionIndex = 69489;
