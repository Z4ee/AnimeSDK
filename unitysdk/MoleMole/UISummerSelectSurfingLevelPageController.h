...
#define MOLEMOLE_UISUMMERSELECTSURFINGLEVELPAGECONTROLLER_CREATELEVELRANKWIDGETGROUP_OFFSET UNITYSDK_OFFSET(0x152453B0)
#define MOLEMOLE_UISUMMERSELECTSURFINGLEVELPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15245440)
#define MOLEMOLE_UISUMMERSELECTSURFINGLEVELPAGECONTROLLER___BASE_CREATELEVELRANKWIDGETGROUP_OFFSET UNITYSDK_OFFSET(0x152454E0)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerSelectSurfingLevelPageController_TypeDefinitionIndex = 47164;
