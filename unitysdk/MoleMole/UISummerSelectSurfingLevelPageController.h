...
#define MOLEMOLE_UISUMMERSELECTSURFINGLEVELPAGECONTROLLER_CREATELEVELRANKWIDGETGROUP_OFFSET UNITYSDK_OFFSET(0x122BE760)
#define MOLEMOLE_UISUMMERSELECTSURFINGLEVELPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x122BE7F0)
#define MOLEMOLE_UISUMMERSELECTSURFINGLEVELPAGECONTROLLER___BASE_CREATELEVELRANKWIDGETGROUP_OFFSET UNITYSDK_OFFSET(0x122BE890)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerSelectSurfingLevelPageController_TypeDefinitionIndex = 45913;
