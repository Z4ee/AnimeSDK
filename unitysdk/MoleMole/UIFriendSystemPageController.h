...
#define MOLEMOLE_UIFRIENDSYSTEMPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15A102A0)
#define MOLEMOLE_UIFRIENDSYSTEMPAGECONTROLLER_INITACTIVETABS_OFFSET UNITYSDK_OFFSET(0x15A106E0)
#define MOLEMOLE_UIFRIENDSYSTEMPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A102B0)
#define MOLEMOLE_UIFRIENDSYSTEMPAGECONTROLLER_ONFRIENDTABCLICK_OFFSET UNITYSDK_OFFSET(0x15A104B0)
#define MOLEMOLE_UIFRIENDSYSTEMPAGECONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x15A109E0)
#define MOLEMOLE_UIFRIENDSYSTEMPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A10BE0)
#define MOLEMOLE_UIFRIENDSYSTEMPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A10340)
#define MOLEMOLE_UIFRIENDSYSTEMPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15A10510)
#define MOLEMOLE_UIFRIENDSYSTEMPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15A10C50)
#define MOLEMOLE_UIFRIENDSYSTEMPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A10C60)
#define MOLEMOLE_UIFRIENDSYSTEMPAGECONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x15A10CF0)
#define MOLEMOLE_UIFRIENDSYSTEMPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A10D80)
#define MOLEMOLE_UIFRIENDSYSTEMPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A10D90)
#define MOLEMOLE_UIFRIENDSYSTEMPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15A10DA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendSystemPageController_TypeDefinitionIndex = 63689;

	class UIFriendSystemPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_14B8F1A93C1DC200* _view; // 0x310
		::MoleMole::UIFriendSystemWidgetController* _friendSystemWidgetController; // 0x318
