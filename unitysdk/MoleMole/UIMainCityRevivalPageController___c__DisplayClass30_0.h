...
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER___C__DISPLAYCLASS30_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16C0E7D0)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER___C__DISPLAYCLASS30_0__REFRESHMATERIALPROGRESSVIEW_B__1_OFFSET UNITYSDK_OFFSET(0x16C0E7E0)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER___C__DISPLAYCLASS30_0__REFRESHMATERIALPROGRESSVIEW_B__3_OFFSET UNITYSDK_OFFSET(0x16C0E840)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityRevivalPageController___c__DisplayClass30_0_TypeDefinitionIndex = 61392;
