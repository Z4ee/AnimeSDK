...
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS63_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1783B2E0)
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS63_0__SETARCHIVEBATTLEQUESTCONTEXT_B__0_OFFSET UNITYSDK_OFFSET(0x1783B2F0)

namespace MoleMole
{
	inline static constexpr unsigned int UILineupSelectContext___c__DisplayClass63_0_TypeDefinitionIndex = 60183;

	class UILineupSelectContext___c__DisplayClass63_0 : public ::System::Object
	{
	public:
		::Class_2_0A55B5A82A61DAFA_1* questTemp; // 0x10
