...
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS63_0__CTOR_OFFSET UNITYSDK_OFFSET(0x150049E0)
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS63_0__SETARCHIVEBATTLEQUESTCONTEXT_B__0_OFFSET UNITYSDK_OFFSET(0x150049F0)

namespace MoleMole
{
	inline static constexpr unsigned int UILineupSelectContext___c__DisplayClass63_0_TypeDefinitionIndex = 57534;
