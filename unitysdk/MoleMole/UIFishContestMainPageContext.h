...
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15270EA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFishContestMainPageContext_TypeDefinitionIndex = 75589;
