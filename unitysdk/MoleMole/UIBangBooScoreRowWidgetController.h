...
#define MOLEMOLE_UIBANGBOOSCOREROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18BFDD10)
#define MOLEMOLE_UIBANGBOOSCOREROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18BFDDA0)
#define MOLEMOLE_UIBANGBOOSCOREROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18BFDC40)
#define MOLEMOLE_UIBANGBOOSCOREROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18BFDCA0)
#define MOLEMOLE_UIBANGBOOSCOREROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x18BFDE20)
#define MOLEMOLE_UIBANGBOOSCOREROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18BFDFF0)
#define MOLEMOLE_UIBANGBOOSCOREROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18BFE050)
#define MOLEMOLE_UIBANGBOOSCOREROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18BFE0E0)
#define MOLEMOLE_UIBANGBOOSCOREROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18BFE170)
#define MOLEMOLE_UIBANGBOOSCOREROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18BFE200)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangBooScoreRowWidgetController_TypeDefinitionIndex = 78256;
