...
#define MOLEMOLE_UISOCIALCIRCLEINVITEROWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x122AF8F0)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleInviteRowContext_TypeDefinitionIndex = 40133;
