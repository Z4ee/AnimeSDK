...
#define MOLEMOLE_UIHANDBOOKWEEKENDBOSSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x149F8C30)
#define MOLEMOLE_UIHANDBOOKWEEKENDBOSSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x149F8CC0)
#define MOLEMOLE_UIHANDBOOKWEEKENDBOSSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x149F8B60)
#define MOLEMOLE_UIHANDBOOKWEEKENDBOSSWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x149F8BC0)
#define MOLEMOLE_UIHANDBOOKWEEKENDBOSSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x149F8D40)
#define MOLEMOLE_UIHANDBOOKWEEKENDBOSSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x149F8DA0)
#define MOLEMOLE_UIHANDBOOKWEEKENDBOSSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x149F8E30)
#define MOLEMOLE_UIHANDBOOKWEEKENDBOSSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x149F8EC0)
#define MOLEMOLE_UIHANDBOOKWEEKENDBOSSWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x149F8F50)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookWeekendBossWidgetController_TypeDefinitionIndex = 71290;

	class UIHandBookWeekendBossWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_3B0594C973D57E5F* _view; // 0x2B8
