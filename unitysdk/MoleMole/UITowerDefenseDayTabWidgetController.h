...
#define MOLEMOLE_UITOWERDEFENSEDAYTABWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x152DA270)
#define MOLEMOLE_UITOWERDEFENSEDAYTABWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x152DA300)
#define MOLEMOLE_UITOWERDEFENSEDAYTABWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x152DA1A0)
#define MOLEMOLE_UITOWERDEFENSEDAYTABWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x152DA200)
#define MOLEMOLE_UITOWERDEFENSEDAYTABWIDGETCONTROLLER_REFRESHENTRY_OFFSET UNITYSDK_OFFSET(0x152DA380)
#define MOLEMOLE_UITOWERDEFENSEDAYTABWIDGETCONTROLLER_SETINDEX_OFFSET UNITYSDK_OFFSET(0x152DA890)
#define MOLEMOLE_UITOWERDEFENSEDAYTABWIDGETCONTROLLER_SETLOCKSTATE_OFFSET UNITYSDK_OFFSET(0x152DA840)
#define MOLEMOLE_UITOWERDEFENSEDAYTABWIDGETCONTROLLER_SETSTATE_OFFSET UNITYSDK_OFFSET(0x152DA7E0)
#define MOLEMOLE_UITOWERDEFENSEDAYTABWIDGETCONTROLLER_UPDATESTATE_OFFSET UNITYSDK_OFFSET(0x152DA670)
#define MOLEMOLE_UITOWERDEFENSEDAYTABWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x152DAF70)
#define MOLEMOLE_UITOWERDEFENSEDAYTABWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x152DAFD0)
#define MOLEMOLE_UITOWERDEFENSEDAYTABWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x152DB060)
#define MOLEMOLE_UITOWERDEFENSEDAYTABWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x152DB0F0)
#define MOLEMOLE_UITOWERDEFENSEDAYTABWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x152DB180)

namespace MoleMole
{
	inline static constexpr unsigned int UITowerDefenseDayTabWidgetController_TypeDefinitionIndex = 40801;

	class UITowerDefenseDayTabWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_1CC0E2699D5FB1A6_1* _view; // 0x2C0
