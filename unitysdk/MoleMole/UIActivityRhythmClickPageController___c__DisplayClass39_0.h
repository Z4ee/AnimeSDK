...
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER___C__DISPLAYCLASS39_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19761720)
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER___C__DISPLAYCLASS39_0__TRIGGERLONGPRESSGUIDESTARTFADEINUIACTION_B__0_OFFSET UNITYSDK_OFFSET(0x19761730)
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER___C__DISPLAYCLASS39_0__TRIGGERLONGPRESSGUIDESTARTFADEINUIACTION_B__1_OFFSET UNITYSDK_OFFSET(0x19761780)
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER___C__DISPLAYCLASS39_0__TRIGGERLONGPRESSGUIDESTARTFADEINUIACTION_B__2_OFFSET UNITYSDK_OFFSET(0x197617D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityRhythmClickPageController___c__DisplayClass39_0_TypeDefinitionIndex = 87490;
	...
	public:
		...
		::System::Single startTriggerFadeOutTime; // 0x1C
