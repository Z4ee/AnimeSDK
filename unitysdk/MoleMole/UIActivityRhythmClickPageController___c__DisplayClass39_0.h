...
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER___C__DISPLAYCLASS39_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1561D340)
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER___C__DISPLAYCLASS39_0__TRIGGERLONGPRESSGUIDESTARTFADEINUIACTION_B__0_OFFSET UNITYSDK_OFFSET(0x1561D350)
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER___C__DISPLAYCLASS39_0__TRIGGERLONGPRESSGUIDESTARTFADEINUIACTION_B__1_OFFSET UNITYSDK_OFFSET(0x1561D3A0)
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER___C__DISPLAYCLASS39_0__TRIGGERLONGPRESSGUIDESTARTFADEINUIACTION_B__2_OFFSET UNITYSDK_OFFSET(0x1561D3F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityRhythmClickPageController___c__DisplayClass39_0_TypeDefinitionIndex = 46820;
