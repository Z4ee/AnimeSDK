...
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x11329210)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT_EQUALS_OFFSET UNITYSDK_OFFSET(0x11329090)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT_GETICONWIDGETNAME_OFFSET UNITYSDK_OFFSET(0x11328E80)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT_GETMAPICON_OFFSET UNITYSDK_OFFSET(0x11329300)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT_GETWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x11328F70)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT_ISENABLE_OFFSET UNITYSDK_OFFSET(0x11328EF0)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x11328F30)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x113293F0)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x11329400)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT___BASE_GETICONWIDGETNAME_OFFSET UNITYSDK_OFFSET(0x11329410)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT___BASE_GETMAPICON_OFFSET UNITYSDK_OFFSET(0x113294A0)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT___BASE_GETWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x113294D0)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT___BASE_ISENABLE_OFFSET UNITYSDK_OFFSET(0x113295B0)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT___BASE_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x113295C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIThreeDMapElement_LiftIconContext_TypeDefinitionIndex = 43863;
