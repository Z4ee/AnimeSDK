...
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x138306A0)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT_EQUALS_OFFSET UNITYSDK_OFFSET(0x13830520)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT_GETICONWIDGETNAME_OFFSET UNITYSDK_OFFSET(0x13830310)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT_GETMAPICON_OFFSET UNITYSDK_OFFSET(0x13830790)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT_GETWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x13830400)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT_ISENABLE_OFFSET UNITYSDK_OFFSET(0x13830380)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x138303C0)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x13830880)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x138308D0)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT___BASE_GETICONWIDGETNAME_OFFSET UNITYSDK_OFFSET(0x138308E0)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT___BASE_GETMAPICON_OFFSET UNITYSDK_OFFSET(0x13830970)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT___BASE_GETWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x138309A0)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT___BASE_ISENABLE_OFFSET UNITYSDK_OFFSET(0x13830A80)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT___BASE_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x13830A90)

namespace MoleMole
{
	inline static constexpr unsigned int UIThreeDMapElement_LiftIconContext_TypeDefinitionIndex = 54251;
