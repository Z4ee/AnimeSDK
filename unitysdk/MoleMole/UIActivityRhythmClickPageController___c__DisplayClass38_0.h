...
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER___C__DISPLAYCLASS38_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19761660)
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER___C__DISPLAYCLASS38_0__TRIGGERCLICKGUIDESTARTFADEINUIACTIONWHENAUDIOVIDEOMODIFY_B__0_OFFSET UNITYSDK_OFFSET(0x19761670)
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER___C__DISPLAYCLASS38_0__TRIGGERCLICKGUIDESTARTFADEINUIACTIONWHENAUDIOVIDEOMODIFY_B__1_OFFSET UNITYSDK_OFFSET(0x197616C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityRhythmClickPageController___c__DisplayClass38_0_TypeDefinitionIndex = 87487;
