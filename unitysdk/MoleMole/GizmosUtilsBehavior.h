...
#define MOLEMOLE_GIZMOSUTILSBEHAVIOR_CLEARINSTANCE_OFFSET UNITYSDK_OFFSET(0x16D4A3E0)
#define MOLEMOLE_GIZMOSUTILSBEHAVIOR_FINDINSTANCE_OFFSET UNITYSDK_OFFSET(0x16D4A1B0)
#define MOLEMOLE_GIZMOSUTILSBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16D4A5C0)

namespace MoleMole
{
	inline static constexpr unsigned int GizmosUtilsBehavior_TypeDefinitionIndex = 53341;
