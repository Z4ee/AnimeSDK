...
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_GETCOLLECTSHOWITEM_OFFSET UNITYSDK_OFFSET(0x10411930)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_GET_SELECTQUESTID_OFFSET UNITYSDK_OFFSET(0x1040F7C0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_HIDEALLSHOWITEM_OFFSET UNITYSDK_OFFSET(0x10411770)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_MOVETOLEVELPROCESS_OFFSET UNITYSDK_OFFSET(0x10410D80)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONCLICKLEVELBTN_OFFSET UNITYSDK_OFFSET(0x10411A60)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONCLICKQUEST_OFFSET UNITYSDK_OFFSET(0x10410F20)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1040F820)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0x1040FE50)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x10410E30)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x1040FDE0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONSELECTQUEST_OFFSET UNITYSDK_OFFSET(0x10411270)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1040FBA0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1040FA40)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1040FC20)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_PLAYLEVELUPANIMBYCO_OFFSET UNITYSDK_OFFSET(0x10410CF0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_PLAYLEVELUPANIM_OFFSET UNITYSDK_OFFSET(0x1040FEE0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_RECORDTABSHOW_OFFSET UNITYSDK_OFFSET(0x104106E0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_REFRESHLEVEL_OFFSET UNITYSDK_OFFSET(0x10410120)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_REFRESHQUESTS_OFFSET UNITYSDK_OFFSET(0x10410330)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_REFRESHVIRUSCOLLECTTIPS_OFFSET UNITYSDK_OFFSET(0x10411390)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_REFRESHWIDGET_OFFSET UNITYSDK_OFFSET(0x10410090)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_SETLEVEL_OFFSET UNITYSDK_OFFSET(0x10410BA0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_SETPOINT_OFFSET UNITYSDK_OFFSET(0x104108B0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_SETVIRUSCOLLECTTIPS_OFFSET UNITYSDK_OFFSET(0x10411520)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x10411BB0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x10411D00)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER___BASE_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0x10411D90)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x10411DA0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x10411E50)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x10411EE0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x10411F70)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x10412000)

namespace MoleMole
{
	inline static constexpr unsigned int UIVirusMainWidgetController_TypeDefinitionIndex = 67814;

	class UIVirusMainWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_7CD0CB2DB1477D73* _view; // 0x2C0
