...
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERINFOPAGECONTROLLER_GETINITSELECTTAB_OFFSET UNITYSDK_OFFSET(0x15A66F10)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERINFOPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15A66900)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERINFOPAGECONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0x15A67280)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERINFOPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A66910)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERINFOPAGECONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x15A67170)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERINFOPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A67210)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERINFOPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A669A0)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERINFOPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15A66BC0)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERINFOPAGECONTROLLER_SHOWPERSONALINFO_OFFSET UNITYSDK_OFFSET(0x15A674E0)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERINFOPAGECONTROLLER_SHOWROPEMAKER_OFFSET UNITYSDK_OFFSET(0x15A67430)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERINFOPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15A675B0)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERINFOPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A675C0)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERINFOPAGECONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x15A67650)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERINFOPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A676E0)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERINFOPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A676F0)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERINFOPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15A67700)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendSystemPlayerInfoPageController_TypeDefinitionIndex = 54348;
