...
#define MOLEMOLE_UIHOLLOWINFOREPORTROWWIDGETCONTROLLER_HIDEALL_OFFSET UNITYSDK_OFFSET(0x190EE5F0)
#define MOLEMOLE_UIHOLLOWINFOREPORTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x190ECA10)
#define MOLEMOLE_UIHOLLOWINFOREPORTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x190ECD00)
#define MOLEMOLE_UIHOLLOWINFOREPORTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x190ECAA0)
#define MOLEMOLE_UIHOLLOWINFOREPORTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x190EC9B0)
#define MOLEMOLE_UIHOLLOWINFOREPORTROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x190ECDC0)
#define MOLEMOLE_UIHOLLOWINFOREPORTROWWIDGETCONTROLLER_SCENEVAR_OFFSET UNITYSDK_OFFSET(0x190EDFB0)
#define MOLEMOLE_UIHOLLOWINFOREPORTROWWIDGETCONTROLLER_SHOWPOPWINDOWICON_OFFSET UNITYSDK_OFFSET(0x190EE120)
#define MOLEMOLE_UIHOLLOWINFOREPORTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x190EE6B0)
#define MOLEMOLE_UIHOLLOWINFOREPORTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x190EE740)
#define MOLEMOLE_UIHOLLOWINFOREPORTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x190EE7D0)
#define MOLEMOLE_UIHOLLOWINFOREPORTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x190EE870)
#define MOLEMOLE_UIHOLLOWINFOREPORTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x190EE900)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowInfoReportRowWidgetController_TypeDefinitionIndex = 67863;
