...
#define MOLEMOLE_UIHOLLOWINFOREPORTROWWIDGETCONTROLLER_HIDEALL_OFFSET UNITYSDK_OFFSET(0x172129F0)
#define MOLEMOLE_UIHOLLOWINFOREPORTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17210DD0)
#define MOLEMOLE_UIHOLLOWINFOREPORTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x172110D0)
#define MOLEMOLE_UIHOLLOWINFOREPORTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17210E60)
#define MOLEMOLE_UIHOLLOWINFOREPORTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17210D70)
#define MOLEMOLE_UIHOLLOWINFOREPORTROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x172111C0)
#define MOLEMOLE_UIHOLLOWINFOREPORTROWWIDGETCONTROLLER_SCENEVAR_OFFSET UNITYSDK_OFFSET(0x172123C0)
#define MOLEMOLE_UIHOLLOWINFOREPORTROWWIDGETCONTROLLER_SHOWPOPWINDOWICON_OFFSET UNITYSDK_OFFSET(0x17212530)
#define MOLEMOLE_UIHOLLOWINFOREPORTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17212AB0)
#define MOLEMOLE_UIHOLLOWINFOREPORTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17212B40)
#define MOLEMOLE_UIHOLLOWINFOREPORTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17212BD0)
#define MOLEMOLE_UIHOLLOWINFOREPORTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17212C70)
#define MOLEMOLE_UIHOLLOWINFOREPORTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17212D00)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowInfoReportRowWidgetController_TypeDefinitionIndex = 53306;

	class UIHollowInfoReportRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_7F8B43B7EEA2AD07* _view; // 0x2F0
		::System::Collections::Generic::List_1<::UnityEngine::Material*>* _loadedMats; // 0x2F8
		::Class_1_6C2E46293F2AE988* uiFrameTextureSheetPlayer; // 0x300
