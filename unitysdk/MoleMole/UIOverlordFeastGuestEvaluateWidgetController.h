...
#define MOLEMOLE_UIOVERLORDFEASTGUESTEVALUATEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12FD9800)
#define MOLEMOLE_UIOVERLORDFEASTGUESTEVALUATEWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x12FD9890)
#define MOLEMOLE_UIOVERLORDFEASTGUESTEVALUATEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12FD9EC0)
#define MOLEMOLE_UIOVERLORDFEASTGUESTEVALUATEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12FD96A0)
#define MOLEMOLE_UIOVERLORDFEASTGUESTEVALUATEWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x12FD99A0)
#define MOLEMOLE_UIOVERLORDFEASTGUESTEVALUATEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12FD9F40)
#define MOLEMOLE_UIOVERLORDFEASTGUESTEVALUATEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12FD9F50)
#define MOLEMOLE_UIOVERLORDFEASTGUESTEVALUATEWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x12FD9FE0)
#define MOLEMOLE_UIOVERLORDFEASTGUESTEVALUATEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12FDA080)
#define MOLEMOLE_UIOVERLORDFEASTGUESTEVALUATEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12FDA110)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastGuestEvaluateWidgetController_TypeDefinitionIndex = 79559;
