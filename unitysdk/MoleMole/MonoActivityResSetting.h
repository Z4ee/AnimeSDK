...
#define MOLEMOLE_MONOACTIVITYRESSETTING_TRYGETSETTINGCOLOR_OFFSET UNITYSDK_OFFSET(0x13F0CD40)
#define MOLEMOLE_MONOACTIVITYRESSETTING_TRYGETSETTINGMATERIAL_OFFSET UNITYSDK_OFFSET(0x13F0CE60)
#define MOLEMOLE_MONOACTIVITYRESSETTING_TRYSETCOLORGROUP_OFFSET UNITYSDK_OFFSET(0x13F0CFE0)
#define MOLEMOLE_MONOACTIVITYRESSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x13F0D290)

namespace MoleMole
{
	inline static constexpr unsigned int MonoActivityResSetting_TypeDefinitionIndex = 49887;
