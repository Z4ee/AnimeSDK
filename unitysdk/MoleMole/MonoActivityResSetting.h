...
#define MOLEMOLE_MONOACTIVITYRESSETTING_TRYGETSETTINGCOLOR_OFFSET UNITYSDK_OFFSET(0x123568F0)
#define MOLEMOLE_MONOACTIVITYRESSETTING_TRYGETSETTINGMATERIAL_OFFSET UNITYSDK_OFFSET(0x12356A10)
#define MOLEMOLE_MONOACTIVITYRESSETTING_TRYSETCOLORGROUP_OFFSET UNITYSDK_OFFSET(0x12356B90)
#define MOLEMOLE_MONOACTIVITYRESSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x12356E40)

namespace MoleMole
{
	inline static constexpr unsigned int MonoActivityResSetting_TypeDefinitionIndex = 81899;
