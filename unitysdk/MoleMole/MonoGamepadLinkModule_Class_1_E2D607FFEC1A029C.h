...
#define MOLEMOLE_MONOGAMEPADLINKMODULE_CLASS_1_E2D607FFEC1A029C_METHOD_1_96A00CE49069174B_OFFSET UNITYSDK_OFFSET(0x138580D0)
#define MOLEMOLE_MONOGAMEPADLINKMODULE_CLASS_1_E2D607FFEC1A029C__CTOR_OFFSET UNITYSDK_OFFSET(0x138580C0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGamepadLinkModule_Class_1_E2D607FFEC1A029C_TypeDefinitionIndex = 52732;
