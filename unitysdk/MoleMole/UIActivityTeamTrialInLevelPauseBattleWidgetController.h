...
#define MOLEMOLE_UIACTIVITYTEAMTRIALINLEVELPAUSEBATTLEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15B899A0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALINLEVELPAUSEBATTLEWIDGETCONTROLLER_REFRESHACTCHALLENGELIST_OFFSET UNITYSDK_OFFSET(0x15B89D60)
#define MOLEMOLE_UIACTIVITYTEAMTRIALINLEVELPAUSEBATTLEWIDGETCONTROLLER_REFRESHACTVIEW_OFFSET UNITYSDK_OFFSET(0x15B89B40)
#define MOLEMOLE_UIACTIVITYTEAMTRIALINLEVELPAUSEBATTLEWIDGETCONTROLLER_REFRESHSHOWREWARDLIST_OFFSET UNITYSDK_OFFSET(0x15B8A3E0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALINLEVELPAUSEBATTLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15B8A8D0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALINLEVELPAUSEBATTLEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15B8A8E0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALINLEVELPAUSEBATTLEWIDGETCONTROLLER___BASE_REFRESHACTCHALLENGELIST_OFFSET UNITYSDK_OFFSET(0x15B8A9B0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALINLEVELPAUSEBATTLEWIDGETCONTROLLER___BASE_REFRESHACTVIEW_OFFSET UNITYSDK_OFFSET(0x15B8A9C0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALINLEVELPAUSEBATTLEWIDGETCONTROLLER___BASE_REFRESHSHOWREWARDLIST_OFFSET UNITYSDK_OFFSET(0x15B8A9D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityTeamTrialInLevelPauseBattleWidgetController_TypeDefinitionIndex = 42237;

	class UIActivityTeamTrialInLevelPauseBattleWidgetController : public ::MoleMole::UIInLevelPauseBattleInfoWidgetController
	{
	public:
		::MoleMole::UIActivityTeamTrialInLevelPauseBuffInfoWidgetController* _buffInfoWidgetController; // 0x2E0
		::MoleMole::UIInLevelPauseAdditionalWidgetController* _additionalWidgetController; // 0x2E8
