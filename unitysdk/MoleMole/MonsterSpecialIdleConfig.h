...
#define MOLEMOLE_MONSTERSPECIALIDLECONFIG_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x15BA5150)
#define MOLEMOLE_MONSTERSPECIALIDLECONFIG_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x15BA4AE0)
#define MOLEMOLE_MONSTERSPECIALIDLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x15BA5520)
#define MOLEMOLE_MONSTERSPECIALIDLECONFIG___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x15BA5680)
#define MOLEMOLE_MONSTERSPECIALIDLECONFIG___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x15BA5690)

namespace MoleMole
{
	inline static constexpr unsigned int MonsterSpecialIdleConfig_TypeDefinitionIndex = 65979;
