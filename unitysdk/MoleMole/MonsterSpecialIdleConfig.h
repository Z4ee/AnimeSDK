...
#define MOLEMOLE_MONSTERSPECIALIDLECONFIG_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x10D743D0)
#define MOLEMOLE_MONSTERSPECIALIDLECONFIG_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x10D73D70)
#define MOLEMOLE_MONSTERSPECIALIDLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x10D747A0)
#define MOLEMOLE_MONSTERSPECIALIDLECONFIG___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x10D74900)
#define MOLEMOLE_MONSTERSPECIALIDLECONFIG___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x10D74910)

namespace MoleMole
{
	inline static constexpr unsigned int MonsterSpecialIdleConfig_TypeDefinitionIndex = 82482;
