...
#define MOLEMOLE_UIRABDEPOSITORYPROPERTYDESCWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19895400)
#define MOLEMOLE_UIRABDEPOSITORYPROPERTYDESCWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19895470)
#define MOLEMOLE_UIRABDEPOSITORYPROPERTYDESCWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x19895970)
#define MOLEMOLE_UIRABDEPOSITORYPROPERTYDESCWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x19895510)
#define MOLEMOLE_UIRABDEPOSITORYPROPERTYDESCWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19895A10)
#define MOLEMOLE_UIRABDEPOSITORYPROPERTYDESCWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19895A70)
#define MOLEMOLE_UIRABDEPOSITORYPROPERTYDESCWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x19895B10)
#define MOLEMOLE_UIRABDEPOSITORYPROPERTYDESCWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x19895BA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABDepositoryPropertyDescWidgetController_TypeDefinitionIndex = 64867;
