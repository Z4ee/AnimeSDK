...
#define MOLEMOLE_UIABYSSS2TALENTPAGECONTROLLER___C__DISPLAYCLASS42_0__CTOR_OFFSET UNITYSDK_OFFSET(0x12F25010)
#define MOLEMOLE_UIABYSSS2TALENTPAGECONTROLLER___C__DISPLAYCLASS42_0__ONTALENTACTIVEHANDLE_B__1_OFFSET UNITYSDK_OFFSET(0x12F25020)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2TalentPageController___c__DisplayClass42_0_TypeDefinitionIndex = 53249;
