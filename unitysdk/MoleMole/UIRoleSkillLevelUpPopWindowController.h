...
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_BINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x175A2BE0)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_GETBTNTEXT_OFFSET UNITYSDK_OFFSET(0x175A49E0)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x175A2A30)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x175A2A20)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_ONCLICKCONSOLECHECKCONSUMEBTN_OFFSET UNITYSDK_OFFSET(0x175A5290)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_ONCLICKCONSUMEICONBTN_OFFSET UNITYSDK_OFFSET(0x175A51F0)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175A2A40)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_ONINFOCLICKED_OFFSET UNITYSDK_OFFSET(0x175A4BA0)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_ONITEMCHANGEHANDLE_OFFSET UNITYSDK_OFFSET(0x175A48E0)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_ONLEVELUPOKCLICKED_OFFSET UNITYSDK_OFFSET(0x175A4D80)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x175A31B0)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x175A2FF0)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x175A2AD0)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x175A30E0)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x175A3280)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_SHOWLEVELUPERRORHINT_OFFSET UNITYSDK_OFFSET(0x175A4AE0)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x175A5380)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER__ONLEVELUPOKCLICKED_B__37_0_OFFSET UNITYSDK_OFFSET(0x175A54D0)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER__ONLEVELUPOKCLICKED_B__37_1_OFFSET UNITYSDK_OFFSET(0x175A5490)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175A56E0)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x175A5770)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x175A5780)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x175A5790)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x175A57A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleSkillLevelUpPopWindowController_TypeDefinitionIndex = 68717;
	...
	public:
		...
		::Class_2_79F6D62CE30E3F8E_90* _view; // 0x318
