...
#define MOLEMOLE_UIINLEVELROLEHUDWIDGETCHILDWINDOWCONTROLLER___C__DISPLAYCLASS41_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1699F250)
#define MOLEMOLE_UIINLEVELROLEHUDWIDGETCHILDWINDOWCONTROLLER___C__DISPLAYCLASS41_0__ONLOCALAVATARCHANGED_B__0_OFFSET UNITYSDK_OFFSET(0x1699F260)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelRoleHudWidgetChildWindowController___c__DisplayClass41_0_TypeDefinitionIndex = 40210;
