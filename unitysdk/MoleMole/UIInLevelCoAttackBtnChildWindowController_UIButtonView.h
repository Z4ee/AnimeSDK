...
#define MOLEMOLE_UIINLEVELCOATTACKBTNCHILDWINDOWCONTROLLER_UIBUTTONVIEW_GET_BTN_OFFSET UNITYSDK_OFFSET(0x177BC5B0)
#define MOLEMOLE_UIINLEVELCOATTACKBTNCHILDWINDOWCONTROLLER_UIBUTTONVIEW_GET_BUTTONAREA_OFFSET UNITYSDK_OFFSET(0x177BC850)
#define MOLEMOLE_UIINLEVELCOATTACKBTNCHILDWINDOWCONTROLLER_UIBUTTONVIEW_GET_BUTTONROOT_OFFSET UNITYSDK_OFFSET(0x177BC5E0)
#define MOLEMOLE_UIINLEVELCOATTACKBTNCHILDWINDOWCONTROLLER_UIBUTTONVIEW_GET_MAXDRAGAREA_OFFSET UNITYSDK_OFFSET(0x177BC6B0)
#define MOLEMOLE_UIINLEVELCOATTACKBTNCHILDWINDOWCONTROLLER_UIBUTTONVIEW_GET_MINDRAGAREA_OFFSET UNITYSDK_OFFSET(0x177BC780)
#define MOLEMOLE_UIINLEVELCOATTACKBTNCHILDWINDOWCONTROLLER_UIBUTTONVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x177BC920)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelCoAttackBtnChildWindowController_UIButtonView_TypeDefinitionIndex = 85752;
