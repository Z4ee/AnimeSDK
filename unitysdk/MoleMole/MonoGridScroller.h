...
#define MOLEMOLE_MONOGRIDSCROLLER_ADDCHILDREN_OFFSET UNITYSDK_OFFSET(0x180745B0)
#define MOLEMOLE_MONOGRIDSCROLLER_CENTERITEMBYINDEXMULTI_OFFSET UNITYSDK_OFFSET(0x180777A0)
#define MOLEMOLE_MONOGRIDSCROLLER_CENTERITEMBYINDEX_OFFSET UNITYSDK_OFFSET(0x18077240)
#define MOLEMOLE_MONOGRIDSCROLLER_GETGRIDREALCHILDCOUNT_OFFSET UNITYSDK_OFFSET(0x1807ABC0)
#define MOLEMOLE_MONOGRIDSCROLLER_GETITEMDICT_OFFSET UNITYSDK_OFFSET(0x1807A5F0)
#define MOLEMOLE_MONOGRIDSCROLLER_GETITEMTRANSBYINDEX_OFFSET UNITYSDK_OFFSET(0x18078520)
#define MOLEMOLE_MONOGRIDSCROLLER_GETMAXITEMCOUNTWITHOUSCROLL_OFFSET UNITYSDK_OFFSET(0x18078600)
#define MOLEMOLE_MONOGRIDSCROLLER_GETNORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0x18076B20)
#define MOLEMOLE_MONOGRIDSCROLLER_GETPERFECTSHOWITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x18078650)
#define MOLEMOLE_MONOGRIDSCROLLER_GETSHOWITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x180786A0)
#define MOLEMOLE_MONOGRIDSCROLLER_GET_GRIDLAYOUT_OFFSET UNITYSDK_OFFSET(0x1807B760)
#define MOLEMOLE_MONOGRIDSCROLLER_GET_ITEMSIZE_OFFSET UNITYSDK_OFFSET(0x180741E0)
#define MOLEMOLE_MONOGRIDSCROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x18074210)
#define MOLEMOLE_MONOGRIDSCROLLER_ISCHILDPARTIALLYINVISIBLE_OFFSET UNITYSDK_OFFSET(0x1807A630)
#define MOLEMOLE_MONOGRIDSCROLLER_LEFTMOVEITEM_OFFSET UNITYSDK_OFFSET(0x18078BA0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_0869E1192F8E01DF_OFFSET UNITYSDK_OFFSET(0x18074D70)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_235563648AB4317F_OFFSET UNITYSDK_OFFSET(0x1807BFB0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_4A0A4692E3EEF246_OFFSET UNITYSDK_OFFSET(0x1807BA00)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_4EC65E6D54E9EC81_OFFSET UNITYSDK_OFFSET(0x18074510)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_52C18C0DA8AC23E5_OFFSET UNITYSDK_OFFSET(0x18075430)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_56CE4AFC5339F746_OFFSET UNITYSDK_OFFSET(0x18079000)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_67329C1ADD73615D_OFFSET UNITYSDK_OFFSET(0x1807B910)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_6E25B78546488E1D_OFFSET UNITYSDK_OFFSET(0x180766E0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_7619D212F4D762A1_OFFSET UNITYSDK_OFFSET(0x18076CF0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0x18074FB0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x18077DC0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_ABE7715DB28B2DD1_OFFSET UNITYSDK_OFFSET(0x18075E80)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_AE231BEA38F773A1_OFFSET UNITYSDK_OFFSET(0x18077E20)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_BEA1E94C012235B1_OFFSET UNITYSDK_OFFSET(0x180763E0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_C467FE94E295849F_OFFSET UNITYSDK_OFFSET(0x180778C0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_CCD88C0D86A5A786_OFFSET UNITYSDK_OFFSET(0x18079220)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_D2AEF5214D16E243_OFFSET UNITYSDK_OFFSET(0x18074810)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_D8DF982F4E85DEF4_OFFSET UNITYSDK_OFFSET(0x1807BB10)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_DA6C1E0DEF87D3F0_OFFSET UNITYSDK_OFFSET(0x1807C020)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_DB869E38C008252C_OFFSET UNITYSDK_OFFSET(0x18078330)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_E0A8AF5B699D0682_OFFSET UNITYSDK_OFFSET(0x180793A0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_F978A1D172468895_OFFSET UNITYSDK_OFFSET(0x18075210)
#define MOLEMOLE_MONOGRIDSCROLLER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x1807A340)
#define MOLEMOLE_MONOGRIDSCROLLER_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x180774D0)
#define MOLEMOLE_MONOGRIDSCROLLER_REFRESHCURRENTBYINDEX_OFFSET UNITYSDK_OFFSET(0x18076A00)
#define MOLEMOLE_MONOGRIDSCROLLER_REFRESHCURRENT_OFFSET UNITYSDK_OFFSET(0x18074B40)
#define MOLEMOLE_MONOGRIDSCROLLER_REFRESHINDEXSET_OFFSET UNITYSDK_OFFSET(0x180780F0)
#define MOLEMOLE_MONOGRIDSCROLLER_REMOVECHILDREN_OFFSET UNITYSDK_OFFSET(0x180746B0)
#define MOLEMOLE_MONOGRIDSCROLLER_SCROLLTOBEGIN_OFFSET UNITYSDK_OFFSET(0x18077050)
#define MOLEMOLE_MONOGRIDSCROLLER_SCROLLTOEND_OFFSET UNITYSDK_OFFSET(0x18077150)
#define MOLEMOLE_MONOGRIDSCROLLER_SCROLLTONEXTITEM_OFFSET UNITYSDK_OFFSET(0x18076FE0)
#define MOLEMOLE_MONOGRIDSCROLLER_SCROLLTONEXTPAGEWITHANIMATION_OFFSET UNITYSDK_OFFSET(0x18077840)
#define MOLEMOLE_MONOGRIDSCROLLER_SCROLLTONEXTPAGE_OFFSET UNITYSDK_OFFSET(0x18076F00)
#define MOLEMOLE_MONOGRIDSCROLLER_SCROLLTOPREITEM_OFFSET UNITYSDK_OFFSET(0x18076F70)
#define MOLEMOLE_MONOGRIDSCROLLER_SCROLLTOPREVPAGEWITHANIMATION_OFFSET UNITYSDK_OFFSET(0x18077BB0)
#define MOLEMOLE_MONOGRIDSCROLLER_SCROLLTOPREVPAGE_OFFSET UNITYSDK_OFFSET(0x18076C80)
#define MOLEMOLE_MONOGRIDSCROLLER_SETNORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0x18076BA0)
#define MOLEMOLE_MONOGRIDSCROLLER_TURNSCROLLON_OFFSET UNITYSDK_OFFSET(0x18078F70)
#define MOLEMOLE_MONOGRIDSCROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x18077C30)
#define MOLEMOLE_MONOGRIDSCROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1807B770)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGridScroller_TypeDefinitionIndex = 87762;
	...
	public:
		...
		::System::Collections::Generic::List_1<::System::Int32>* Field_5_14; // 0x58
		::System::Collections::Generic::List_1<::System::Int32>* Field_5_13; // 0x60
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::UnityEngine::RectTransform*>* Field_5_12; // 0x68
		::MoleMole::MonoGridScroller_Class_3_EC572F192137EBDA* Field_5_19; // 0x70
		::MoleMole::MonoGridScroller_Class_3_EC572F192137EBDA* Field_5_18; // 0x78
		::System::Boolean Field_5_17; // 0x80
		::System::Boolean Field_5_16; // 0x81
		::System::Int32 Field_5_23; // 0x84
		::System::Single scrollSpeed; // 0x88
		::System::Boolean Field_5_21; // 0x8C
		::System::Single Field_5_20; // 0x90
		::System::Single Field_5_27; // 0x94
		::System::Int32 Field_5_26; // 0x98
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_0869E1192F8E01DF_OFFSET))(this);
		}
		...
		::System::Void Method_5_E0A8AF5B699D0682(::System::Int32 a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_E0A8AF5B699D0682_OFFSET))(this, a1);
		}
		...
		::System::Boolean Method_5_BEA1E94C012235B1(::System::Int32 a1)
		{
			return ((::System::Boolean(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_BEA1E94C012235B1_OFFSET))(this, a1);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_CCD88C0D86A5A786_OFFSET))(this);
		}
