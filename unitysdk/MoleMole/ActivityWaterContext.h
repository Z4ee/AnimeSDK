...
#define MOLEMOLE_ACTIVITYWATERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x167D4B50)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityWaterContext_TypeDefinitionIndex = 87999;
