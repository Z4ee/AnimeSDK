...
#define MOLEMOLE_ACTIVITYWATERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x106AA9E0)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityWaterContext_TypeDefinitionIndex = 41667;
