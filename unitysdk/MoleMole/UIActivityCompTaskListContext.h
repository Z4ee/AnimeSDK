...
#define MOLEMOLE_UIACTIVITYCOMPTASKLISTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x17E3FD20)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityCompTaskListContext_TypeDefinitionIndex = 67650;
