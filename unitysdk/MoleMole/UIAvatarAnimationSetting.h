...
#define MOLEMOLE_UIAVATARANIMATIONSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1955E220)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarAnimationSetting_TypeDefinitionIndex = 61004;
