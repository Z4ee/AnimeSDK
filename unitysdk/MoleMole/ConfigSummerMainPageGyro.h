...
#define MOLEMOLE_CONFIGSUMMERMAINPAGEGYRO__CTOR_OFFSET UNITYSDK_OFFSET(0x19FFB6F0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigSummerMainPageGyro_TypeDefinitionIndex = 76351;
