...
#define MOLEMOLE_SETFLOATPARAMETER__RESETVALUE_D__11_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1606CD20)
#define MOLEMOLE_SETFLOATPARAMETER__RESETVALUE_D__11_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1606CDD0)
#define MOLEMOLE_SETFLOATPARAMETER__RESETVALUE_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1606CE30)
#define MOLEMOLE_SETFLOATPARAMETER__RESETVALUE_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1606CDE0)
#define MOLEMOLE_SETFLOATPARAMETER__RESETVALUE_D__11_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1606CD10)
#define MOLEMOLE_SETFLOATPARAMETER__RESETVALUE_D__11__CTOR_OFFSET UNITYSDK_OFFSET(0x1606CD00)

namespace MoleMole
{
	inline static constexpr unsigned int SetFloatParameter__ResetValue_d__11_TypeDefinitionIndex = 52725;

	class SetFloatParameter__ResetValue_d__11 : public ::System::Object
	{
	public:
		::Class_3_F33F9DC5F4112336* animatorComponent; // 0x10
		::MoleMole::SetFloatParameter* __4__this; // 0x18
