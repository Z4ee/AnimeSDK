...
#define MOLEMOLE_SETFLOATPARAMETER__RESETVALUE_D__11_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x12BE0AE0)
#define MOLEMOLE_SETFLOATPARAMETER__RESETVALUE_D__11_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x12BE0B90)
#define MOLEMOLE_SETFLOATPARAMETER__RESETVALUE_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x12BE0BF0)
#define MOLEMOLE_SETFLOATPARAMETER__RESETVALUE_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x12BE0BA0)
#define MOLEMOLE_SETFLOATPARAMETER__RESETVALUE_D__11_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x12BE0AD0)
#define MOLEMOLE_SETFLOATPARAMETER__RESETVALUE_D__11__CTOR_OFFSET UNITYSDK_OFFSET(0x12BE0AC0)

namespace MoleMole
{
	inline static constexpr unsigned int SetFloatParameter__ResetValue_d__11_TypeDefinitionIndex = 68470;
