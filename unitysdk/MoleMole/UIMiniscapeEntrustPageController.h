...
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_GETGENERALCHALLENGEREWARDLIST_OFFSET UNITYSDK_OFFSET(0x13004040)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_GETREWARDINFODATALIST_OFFSET UNITYSDK_OFFSET(0x130049C0)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x13002870)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_GOTOTASK_OFFSET UNITYSDK_OFFSET(0x13005180)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_INITGAMEPADCUSTOMLIST_OFFSET UNITYSDK_OFFSET(0x13003540)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x13002960)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x13002880)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_ONREWARDINFOCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x13004760)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x130038F0)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x13002910)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x13002C60)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_REFRESHGAINDESC_OFFSET UNITYSDK_OFFSET(0x13003A50)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x13002CF0)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_TAKEREWARDS_OFFSET UNITYSDK_OFFSET(0x13004CA0)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x130053E0)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER__INITVIEW_B__7_0_OFFSET UNITYSDK_OFFSET(0x13005470)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER__INITVIEW_B__7_1_OFFSET UNITYSDK_OFFSET(0x130054C0)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER__INITVIEW_B__7_2_OFFSET UNITYSDK_OFFSET(0x130054D0)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER__INITVIEW_B__7_3_OFFSET UNITYSDK_OFFSET(0x130054E0)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER__INITVIEW_B__7_4_OFFSET UNITYSDK_OFFSET(0x13005550)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x13005670)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x13005700)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x13005710)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x13005720)

namespace MoleMole
{
	inline static constexpr unsigned int UIMiniscapeEntrustPageController_TypeDefinitionIndex = 69034;

	class UIMiniscapeEntrustPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_2F788DFAB5136192* _view; // 0x310
		::System::Collections::Generic::List_1<::MoleMole::UIMiniscapeEntrustBtnWidgetController*>* _taskWidgets; // 0x318
		::MoleMole::UIGeneralBottomRewardInfoWidgetController* _rewardInfoWidget; // 0x320
