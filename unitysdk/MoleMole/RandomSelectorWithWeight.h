...
#define MOLEMOLE_RANDOMSELECTORWITHWEIGHT_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1585C2C0)
#define MOLEMOLE_RANDOMSELECTORWITHWEIGHT_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1585C270)
#define MOLEMOLE_RANDOMSELECTORWITHWEIGHT_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1585BD80)
#define MOLEMOLE_RANDOMSELECTORWITHWEIGHT_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1585C320)
#define MOLEMOLE_RANDOMSELECTORWITHWEIGHT_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x1585C390)
#define MOLEMOLE_RANDOMSELECTORWITHWEIGHT_ONEND_OFFSET UNITYSDK_OFFSET(0x1585C410)
#define MOLEMOLE_RANDOMSELECTORWITHWEIGHT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1585C480)
#define MOLEMOLE_RANDOMSELECTORWITHWEIGHT_ONSTART_OFFSET UNITYSDK_OFFSET(0x1585BE40)
#define MOLEMOLE_RANDOMSELECTORWITHWEIGHT_SHUFFLECHILDREN_OFFSET UNITYSDK_OFFSET(0x1585BE90)
#define MOLEMOLE_RANDOMSELECTORWITHWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x1585C4D0)
#define MOLEMOLE_RANDOMSELECTORWITHWEIGHT___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1585C620)
#define MOLEMOLE_RANDOMSELECTORWITHWEIGHT___BASE_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1585C6B0)
#define MOLEMOLE_RANDOMSELECTORWITHWEIGHT___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1585C740)
#define MOLEMOLE_RANDOMSELECTORWITHWEIGHT___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1585C7D0)
#define MOLEMOLE_RANDOMSELECTORWITHWEIGHT___BASE_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x1585C860)
#define MOLEMOLE_RANDOMSELECTORWITHWEIGHT___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1585C8F0)
#define MOLEMOLE_RANDOMSELECTORWITHWEIGHT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1585C980)
#define MOLEMOLE_RANDOMSELECTORWITHWEIGHT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1585CA10)

namespace MoleMole
{
	inline static constexpr unsigned int RandomSelectorWithWeight_TypeDefinitionIndex = 39881;
