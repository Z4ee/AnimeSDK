...
#define MOLEMOLE_UIBALLGAMEICONCARDWIDGETCONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x1F200F70)
#define MOLEMOLE_UIBALLGAMEICONCARDWIDGETCONTROLLER_INITBULLET_OFFSET UNITYSDK_OFFSET(0x1F2009B0)
#define MOLEMOLE_UIBALLGAMEICONCARDWIDGETCONTROLLER_ONBALLPITCHOICEUPGRADEBULLET_OFFSET UNITYSDK_OFFSET(0x1F201680)
#define MOLEMOLE_UIBALLGAMEICONCARDWIDGETCONTROLLER_ONBALLPITLEVELRESTART_OFFSET UNITYSDK_OFFSET(0x1F201610)
#define MOLEMOLE_UIBALLGAMEICONCARDWIDGETCONTROLLER_ONBALLPITPLAYEREXPCHANGE_OFFSET UNITYSDK_OFFSET(0x1F201160)
#define MOLEMOLE_UIBALLGAMEICONCARDWIDGETCONTROLLER_ONBALLPITREFRESHBULLET_OFFSET UNITYSDK_OFFSET(0x1F2011B0)
#define MOLEMOLE_UIBALLGAMEICONCARDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1F200E50)
#define MOLEMOLE_UIBALLGAMEICONCARDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1F200EE0)
#define MOLEMOLE_UIBALLGAMEICONCARDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1F1FFF50)
#define MOLEMOLE_UIBALLGAMEICONCARDWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1F200300)
#define MOLEMOLE_UIBALLGAMEICONCARDWIDGETCONTROLLER_ONUPGRADE_OFFSET UNITYSDK_OFFSET(0x1F201030)
#define MOLEMOLE_UIBALLGAMEICONCARDWIDGETCONTROLLER_REFRESHBULLET_OFFSET UNITYSDK_OFFSET(0x1F201200)
#define MOLEMOLE_UIBALLGAMEICONCARDWIDGETCONTROLLER_REFRESHEXP_OFFSET UNITYSDK_OFFSET(0x1F2004C0)
#define MOLEMOLE_UIBALLGAMEICONCARDWIDGETCONTROLLER_SETSELECT_OFFSET UNITYSDK_OFFSET(0x1F2016F0)
#define MOLEMOLE_UIBALLGAMEICONCARDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F201910)
#define MOLEMOLE_UIBALLGAMEICONCARDWIDGETCONTROLLER__ONUIINIT_B__8_0_OFFSET UNITYSDK_OFFSET(0x1F2019F0)
#define MOLEMOLE_UIBALLGAMEICONCARDWIDGETCONTROLLER__ONUIINIT_B__8_1_OFFSET UNITYSDK_OFFSET(0x1F201B80)
#define MOLEMOLE_UIBALLGAMEICONCARDWIDGETCONTROLLER__ONUIOPEN_B__9_0_OFFSET UNITYSDK_OFFSET(0x1F201C90)
#define MOLEMOLE_UIBALLGAMEICONCARDWIDGETCONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x1F201E50)
#define MOLEMOLE_UIBALLGAMEICONCARDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1F201EE0)
#define MOLEMOLE_UIBALLGAMEICONCARDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1F201F70)
#define MOLEMOLE_UIBALLGAMEICONCARDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1F202000)
#define MOLEMOLE_UIBALLGAMEICONCARDWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1F202090)

namespace MoleMole
{
	inline static constexpr unsigned int UIBallGameIconCardWidgetController_TypeDefinitionIndex = 93470;
