...
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_APPLYANIMATORPARAM_OFFSET UNITYSDK_OFFSET(0x12782D20)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_CLEARPATHPOINTDATA_OFFSET UNITYSDK_OFFSET(0x12783CD0)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_CLEARREFRESHMOVEDIRECTIONTIMER_OFFSET UNITYSDK_OFFSET(0x12780A00)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_DISABLEFORCEAUTOLOOKAT_OFFSET UNITYSDK_OFFSET(0x1277EED0)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_DISABLEOVERRIDEAVATARMOVEDIRECTION_OFFSET UNITYSDK_OFFSET(0x12781600)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_ENABLEFORCEAUTOLOOKAT_OFFSET UNITYSDK_OFFSET(0x1277EE00)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_ENABLEREFRESHMOVEDIRECTIONTIMER_OFFSET UNITYSDK_OFFSET(0x12780A50)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_ENDVENTCRAWL_OFFSET UNITYSDK_OFFSET(0x12783360)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_ENTERVENTCRAWLCAMERA_OFFSET UNITYSDK_OFFSET(0x1277F0B0)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_EXITVENTCRAWLCAMERA_OFFSET UNITYSDK_OFFSET(0x1277FA50)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_FORCEENDVENTCRAWL_OFFSET UNITYSDK_OFFSET(0x127819B0)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_GETCAMERAMOVEFOLLOWPOSITION_OFFSET UNITYSDK_OFFSET(0x1277F750)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_GETENDPATHPOINTDATA_OFFSET UNITYSDK_OFFSET(0x12784220)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_GETSTARTPATHPOINTDATA_OFFSET UNITYSDK_OFFSET(0x12783D40)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_GET_CURFROMPATHPOINTPOSITION_OFFSET UNITYSDK_OFFSET(0x12780DC0)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_GET_CURTARGETPATHPOINTPOSITION_OFFSET UNITYSDK_OFFSET(0x12780AA0)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_GET_ISPATHPOINTDATAVALID_OFFSET UNITYSDK_OFFSET(0x1277F9E0)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_INITPATHPOINTDATA_OFFSET UNITYSDK_OFFSET(0x12781860)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_MOVETONEXTPATHPOINT_OFFSET UNITYSDK_OFFSET(0x12780BC0)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x12781810)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x12781940)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x12781A00)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_REALENABLEVENTCRAWL_OFFSET UNITYSDK_OFFSET(0x127830D0)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_RECREATEPATHPOINTDATA_OFFSET UNITYSDK_OFFSET(0x12782680)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_REFRESHAUTOLOOKAT_OFFSET UNITYSDK_OFFSET(0x1277E900)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_REFRESHNEXTPATHPOINT_OFFSET UNITYSDK_OFFSET(0x1277FFD0)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_REFRESHOVERRIDEAVATARMOVEDIRECTION_OFFSET UNITYSDK_OFFSET(0x12780380)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_SETACTENTITYTRANSFORM_OFFSET UNITYSDK_OFFSET(0x12783FA0)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_SETTARGETLOOKATDIRECTION_OFFSET UNITYSDK_OFFSET(0x1277EF60)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_STARTVENTCRAWL_1_OFFSET UNITYSDK_OFFSET(0x12781F30)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_STARTVENTCRAWL_OFFSET UNITYSDK_OFFSET(0x12781EE0)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_TICKCAMERA_OFFSET UNITYSDK_OFFSET(0x1277E610)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_TICKFORCEAUTOLOOKAT_OFFSET UNITYSDK_OFFSET(0x1277E810)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_TICKMOVE_OFFSET UNITYSDK_OFFSET(0x1277FDB0)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_TICKSTATE_OFFSET UNITYSDK_OFFSET(0x12781A60)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_TRIGGERACTINGENTITYDITHER_OFFSET UNITYSDK_OFFSET(0x12782E30)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_TRIGGERMOVEDIRECTIONSOUNDACTION_OFFSET UNITYSDK_OFFSET(0x12780EE0)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM_TRYREFRESHMOVEDIRECTION_OFFSET UNITYSDK_OFFSET(0x1277FF20)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x127844A0)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM__ENTERVENTCRAWLCAMERA_B__12_0_OFFSET UNITYSDK_OFFSET(0x12784510)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM__ENTERVENTCRAWLCAMERA_B__12_1_OFFSET UNITYSDK_OFFSET(0x12784540)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM__ENTERVENTCRAWLCAMERA_B__12_2_OFFSET UNITYSDK_OFFSET(0x127844D0)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x12784560)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x127845F0)
#define MOLEMOLE_VENTCRAWLSUBSYSTEM___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x12784680)

namespace MoleMole
{
	inline static constexpr unsigned int VentCrawlSubSystem_TypeDefinitionIndex = 56581;
	...
	public:
		...
		::System::Collections::Generic::List_1<::UnityEngine::Vector3>* _pathPointList; // 0x28
		::System::String* _activeTag; // 0x30
		::UnityEngine::Quaternion _curLookAtRotation; // 0x38
		::System::Single _forceAutoLookAtTimer; // 0x48
		::System::Single _startActingDelayTimer; // 0x4C
		::System::Single _refreshMoveDirectionTimer; // 0x50
		::UnityEngine::Quaternion _targetLookAtRotation; // 0x54
		::System::Int32 _curPathPointIndex; // 0x64
		::System::Boolean _forceAutoLookAt; // 0x68
		::Enum_3_95A845D4DB09FB20 _ventCrawlState; // 0x6C
