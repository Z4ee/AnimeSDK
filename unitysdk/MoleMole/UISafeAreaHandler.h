...
#define MOLEMOLE_UISAFEAREAHANDLER_GETSAFEAREARECT_OFFSET UNITYSDK_OFFSET(0x11BAA5D0)
#define MOLEMOLE_UISAFEAREAHANDLER_METHOD_6_0CEE9868CF9CA474_OFFSET UNITYSDK_OFFSET(0x11BAB030)
#define MOLEMOLE_UISAFEAREAHANDLER_METHOD_6_32ACF43E680D75A6_OFFSET UNITYSDK_OFFSET(0x11BAAA40)
#define MOLEMOLE_UISAFEAREAHANDLER_METHOD_6_4B72F72501001F72_OFFSET UNITYSDK_OFFSET(0x11BABF60)
#define MOLEMOLE_UISAFEAREAHANDLER_METHOD_6_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x11BAC160)
#define MOLEMOLE_UISAFEAREAHANDLER_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x11BAB150)
#define MOLEMOLE_UISAFEAREAHANDLER_METHOD_6_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x11BAC170)
#define MOLEMOLE_UISAFEAREAHANDLER_METHOD_6_FAADEE08E4E52BA5_OFFSET UNITYSDK_OFFSET(0x11BAB190)
#define MOLEMOLE_UISAFEAREAHANDLER_METHOD_6_FC924E2ADB89532B_OFFSET UNITYSDK_OFFSET(0x11BAC180)
#define MOLEMOLE_UISAFEAREAHANDLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x11BAA2F0)
#define MOLEMOLE_UISAFEAREAHANDLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x11BAA150)
#define MOLEMOLE_UISAFEAREAHANDLER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x11BAA440)
#define MOLEMOLE_UISAFEAREAHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11BAAF50)
#define MOLEMOLE_UISAFEAREAHANDLER___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x11BAAFA0)

namespace MoleMole
{
	inline static constexpr unsigned int UISafeAreaHandler_TypeDefinitionIndex = 61531;
