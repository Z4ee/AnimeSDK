...
#define MOLEMOLE_UICPSCORETIPSCRIPTNEW_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B2742C0)
#define MOLEMOLE_UICPSCORETIPSCRIPTNEW_INITDATA_OFFSET UNITYSDK_OFFSET(0x1B2757E0)
#define MOLEMOLE_UICPSCORETIPSCRIPTNEW_METHOD_5_21886A8411E71157_OFFSET UNITYSDK_OFFSET(0x1B274310)
#define MOLEMOLE_UICPSCORETIPSCRIPTNEW_REFRESH_OFFSET UNITYSDK_OFFSET(0x1B275390)
#define MOLEMOLE_UICPSCORETIPSCRIPTNEW_SETEXCLAMATIONMARK_OFFSET UNITYSDK_OFFSET(0x1B275C30)
#define MOLEMOLE_UICPSCORETIPSCRIPTNEW_SETGLODMARK_OFFSET UNITYSDK_OFFSET(0x1B275B40)
#define MOLEMOLE_UICPSCORETIPSCRIPTNEW_SETLOADER_OFFSET UNITYSDK_OFFSET(0x1B275790)
#define MOLEMOLE_UICPSCORETIPSCRIPTNEW_SETNUM_OFFSET UNITYSDK_OFFSET(0x1B275E90)
#define MOLEMOLE_UICPSCORETIPSCRIPTNEW_SETPROPSPRITE_OFFSET UNITYSDK_OFFSET(0x1B275950)
#define MOLEMOLE_UICPSCORETIPSCRIPTNEW_SETRIGHTROOTACTIVE_OFFSET UNITYSDK_OFFSET(0x1B275E30)
#define MOLEMOLE_UICPSCORETIPSCRIPTNEW_SETSYMBOL_OFFSET UNITYSDK_OFFSET(0x1B275D10)
#define MOLEMOLE_UICPSCORETIPSCRIPTNEW_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B275FA0)
#define MOLEMOLE_UICPSCORETIPSCRIPTNEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2760A0)

namespace MoleMole
{
	inline static constexpr unsigned int UICpScoreTipScriptNew_TypeDefinitionIndex = 85319;
