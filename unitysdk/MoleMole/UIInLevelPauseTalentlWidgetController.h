...
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER_GETAVATARID_OFFSET UNITYSDK_OFFSET(0x15D1F830)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER_INITROLEBTN_OFFSET UNITYSDK_OFFSET(0x15D1EC60)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15D1F6F0)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15D1F780)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15D1EB20)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15D1EB80)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER_REFRESHAVATARTALENTINFO_OFFSET UNITYSDK_OFFSET(0x15D1F940)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER_SETSELECTEDAVATARID_OFFSET UNITYSDK_OFFSET(0x15D20270)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER_SWITCHSELECTEDAVATAR_OFFSET UNITYSDK_OFFSET(0x15D1F8B0)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x15D205A0)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15D20340)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER__INITROLEBTN_B__7_0_OFFSET UNITYSDK_OFFSET(0x15D205C0)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER__ONUIOPEN_B__3_0_OFFSET UNITYSDK_OFFSET(0x15D205B0)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15D205D0)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15D20660)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15D206F0)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15D20780)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseTalentlWidgetController_TypeDefinitionIndex = 53062;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelPauseTalentlWidgetController_TypeDefinitionIndex)->GetStaticField(0x11300);
		}
		// static const ::System::Int32 MAX_TALENT = 0x8; // 0x0
		::Class_2_FCF7034E4F06A146_1* _view; // 0x2B8
		::System::Collections::Generic::List_1<::Foundation::Coroutine::CoroutineHandle>* handleList; // 0x2C0
		::System::Collections::Generic::List_1<::MoleMole::UIInLevelPauseTalentRowWidgetController*>* talentRowList; // 0x2C8
		::System::Collections::Generic::List_1<::System::Int32>* avatarIDList; // 0x2D0
		::System::Collections::Generic::List_1<::Class_2_1824EF69C8E376A3*>* avatarItemList; // 0x2D8
		::System::Collections::Generic::List_1<::Class_2_A3533EA2DA4533F9*>* _dBattleAvatars; // 0x2E0
		::System::Int32 _curAvatarID; // 0x2E8
		::System::Int32 _curIndex; // 0x2EC
		::System::Collections::Generic::List_1<::MoleMole::UITabBtnRoleRowWidgetController*>* roleTabBtns; // 0x2F0
