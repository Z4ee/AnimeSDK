...
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER_GETAVATARID_OFFSET UNITYSDK_OFFSET(0x196405B0)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER_INITROLEBTN_OFFSET UNITYSDK_OFFSET(0x1963F950)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19640470)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19640500)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1963F810)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1963F870)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER_REFRESHAVATARTALENTINFO_OFFSET UNITYSDK_OFFSET(0x196406C0)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER_SETSELECTEDAVATARID_OFFSET UNITYSDK_OFFSET(0x19640FF0)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER_SWITCHSELECTEDAVATAR_OFFSET UNITYSDK_OFFSET(0x19640630)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19641310)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x196410C0)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER__INITROLEBTN_B__7_0_OFFSET UNITYSDK_OFFSET(0x19641330)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER__ONUIOPEN_B__3_0_OFFSET UNITYSDK_OFFSET(0x19641320)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19641340)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x196413D0)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19641460)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x196414F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseTalentlWidgetController_TypeDefinitionIndex = 40690;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelPauseTalentlWidgetController_TypeDefinitionIndex)->GetStaticField(0x100C0);
		}
