...
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_BUILDGROUPCHALLENGEENDCSREQ_OFFSET UNITYSDK_OFFSET(0x12339640)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_BUILDMULTIPLAYERFLOORCHALLENGEINFOCSNOTIFY_OFFSET UNITYSDK_OFFSET(0x12338550)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_BUILDMULTIPLAYERGROUPCHALLENGEINFOCSNOTIFY_OFFSET UNITYSDK_OFFSET(0x12338950)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_CANCELGROUPCHALLENGEBYID_OFFSET UNITYSDK_OFFSET(0x1233B710)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_FINISHGROUPCHALLENGEBYID_OFFSET UNITYSDK_OFFSET(0x1233B910)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_HANDLEEVTLEVELCONDITION_OFFSET UNITYSDK_OFFSET(0x1233A520)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_MAPPINGFLAGSTOREPORTREASON_OFFSET UNITYSDK_OFFSET(0x12339510)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_ONCHALLENGEBEGIN_OFFSET UNITYSDK_OFFSET(0x12339880)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_ONCHALLENGECANCEL_OFFSET UNITYSDK_OFFSET(0x12339490)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_ONCHALLENGEEND_OFFSET UNITYSDK_OFFSET(0x12338E00)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_ONCHALLENGEFINISH_OFFSET UNITYSDK_OFFSET(0x12338D60)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_ONCHALLENGEPROGRESSCHANGED_OFFSET UNITYSDK_OFFSET(0x12338220)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1233A9E0)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x1233A4B0)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1233AC00)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_REGISTERCUSTOMCHALLENGECONDITION_OFFSET UNITYSDK_OFFSET(0x12339A00)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_REGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0x12339F90)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_REGISTERGROUPCHALLENGE_OFFSET UNITYSDK_OFFSET(0x1233B2D0)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_REGISTERLEVELCONDITION_OFFSET UNITYSDK_OFFSET(0x1233A650)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_TRIGGERCUSTOMCHALLENGECONDITION_OFFSET UNITYSDK_OFFSET(0x12339E30)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_TRYGETGROUPCHALLENGERECORD_1_OFFSET UNITYSDK_OFFSET(0x1233B1C0)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_TRYGETGROUPCHALLENGERECORD_2_OFFSET UNITYSDK_OFFSET(0x1233BA20)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_TRYGETGROUPCHALLENGERECORD_3_OFFSET UNITYSDK_OFFSET(0x1233B5F0)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_TRYGETGROUPCHALLENGERECORD_OFFSET UNITYSDK_OFFSET(0x1233B0E0)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_UNREGISTERCUSTOMCHALLENGECONDITION_OFFSET UNITYSDK_OFFSET(0x12339C30)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_UNREGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0x1233A290)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_UNREGISTERLEVELCONDITION_OFFSET UNITYSDK_OFFSET(0x1233A830)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1233BB20)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1233BC80)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM___BASE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x1233BCC0)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1233BD60)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM___BASE_REGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0x1233BDA0)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM___BASE_UNREGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0x1233BDE0)

namespace MoleMole
{
	inline static constexpr unsigned int GroupChallengeSubsystem_TypeDefinitionIndex = 54287;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::Struct_2_429077904A4ECF2B, ::MoleMole::GroupChallengeSubsystem_CustomConditionCallback*>* _callbackMap; // 0x18
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::GroupChallengeSubsystem_LevelConditionCallback*>* _levelConditionCallbackMap; // 0x20
		...
		::Class_3_4EE04B418903C4E1_6* BuildMultiPlayerGroupChallengeInfoCsNotify(::Class_1_6178B3CA1C4EB604* challenge, ::Enum_3_DB663931210BBC27_40 state)
		{
			return ((::Class_3_4EE04B418903C4E1_6*(*)(::PVOID, ::Class_1_6178B3CA1C4EB604*, ::Enum_3_DB663931210BBC27_40))((::PBYTE)hIl2Cpp + MOLEMOLE_GROUPCHALLENGESUBSYSTEM_BUILDMULTIPLAYERGROUPCHALLENGEINFOCSNOTIFY_OFFSET))(this, challenge, state);
		}

		::Class_3_1A345EAE5F749316_100* BuildMultiPlayerFloorChallengeInfoCsNotify(::Class_1_6178B3CA1C4EB604* challenge, ::Enum_3_DB663931210BBC27_40 state)
		{
			return ((::Class_3_1A345EAE5F749316_100*(*)(::PVOID, ::Class_1_6178B3CA1C4EB604*, ::Enum_3_DB663931210BBC27_40))((::PBYTE)hIl2Cpp + MOLEMOLE_GROUPCHALLENGESUBSYSTEM_BUILDMULTIPLAYERFLOORCHALLENGEINFOCSNOTIFY_OFFSET))(this, challenge, state);
		}
		...
		::Class_3_9F091E965E210217_12* BuildGroupChallengeEndCsReq(::Class_1_6178B3CA1C4EB604* challenge, ::System::Boolean isSuccess, ::Enum_3_3ED7CD02351A6F35 endReportReason)
		{
			return ((::Class_3_9F091E965E210217_12*(*)(::PVOID, ::Class_1_6178B3CA1C4EB604*, ::System::Boolean, ::Enum_3_3ED7CD02351A6F35))((::PBYTE)hIl2Cpp + MOLEMOLE_GROUPCHALLENGESUBSYSTEM_BUILDGROUPCHALLENGEENDCSREQ_OFFSET))(this, challenge, isSuccess, endReportReason);
		}
