...
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1483BEB0)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER___C__DISPLAYCLASS9_0__SHOWCURRENTMISSIONFINISHANDSWITCH_B__0_OFFSET UNITYSDK_OFFSET(0x1483BEC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityMissionWidgetController___c__DisplayClass9_0_TypeDefinitionIndex = 52947;
