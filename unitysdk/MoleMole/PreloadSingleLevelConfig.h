...
#define MOLEMOLE_PRELOADSINGLELEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x10E4C230)

namespace MoleMole
{
	inline static constexpr unsigned int PreloadSingleLevelConfig_TypeDefinitionIndex = 37920;
