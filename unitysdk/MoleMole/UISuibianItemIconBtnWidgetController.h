...
#define MOLEMOLE_UISUIBIANITEMICONBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x103DA3B0)
#define MOLEMOLE_UISUIBIANITEMICONBTNWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x103DA4C0)
#define MOLEMOLE_UISUIBIANITEMICONBTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x103DA440)
#define MOLEMOLE_UISUIBIANITEMICONBTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x103DA200)
#define MOLEMOLE_UISUIBIANITEMICONBTNWIDGETCONTROLLER_REFRESHVIEWINNER_OFFSET UNITYSDK_OFFSET(0x103DB6A0)
#define MOLEMOLE_UISUIBIANITEMICONBTNWIDGETCONTROLLER_REFRESHVIEW_1_OFFSET UNITYSDK_OFFSET(0x103DB8B0)
#define MOLEMOLE_UISUIBIANITEMICONBTNWIDGETCONTROLLER_REFRESHVIEW_2_OFFSET UNITYSDK_OFFSET(0x103DB4E0)
#define MOLEMOLE_UISUIBIANITEMICONBTNWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x103DA580)
#define MOLEMOLE_UISUIBIANITEMICONBTNWIDGETCONTROLLER_SETEMPTYSTATE_OFFSET UNITYSDK_OFFSET(0x103DAFC0)
#define MOLEMOLE_UISUIBIANITEMICONBTNWIDGETCONTROLLER_SETITEMINFO_OFFSET UNITYSDK_OFFSET(0x103DBD40)
#define MOLEMOLE_UISUIBIANITEMICONBTNWIDGETCONTROLLER_SETLOCK_OFFSET UNITYSDK_OFFSET(0x103DBA90)
#define MOLEMOLE_UISUIBIANITEMICONBTNWIDGETCONTROLLER_SETMASKSTATE_OFFSET UNITYSDK_OFFSET(0x103DBBA0)
#define MOLEMOLE_UISUIBIANITEMICONBTNWIDGETCONTROLLER_SETTRANSGRAY_OFFSET UNITYSDK_OFFSET(0x103DBC30)
#define MOLEMOLE_UISUIBIANITEMICONBTNWIDGETCONTROLLER_SETUPSTATE_OFFSET UNITYSDK_OFFSET(0x103DBCD0)
#define MOLEMOLE_UISUIBIANITEMICONBTNWIDGETCONTROLLER_TRYSHOWNEGATIVE_OFFSET UNITYSDK_OFFSET(0x103DCD40)
#define MOLEMOLE_UISUIBIANITEMICONBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x103DCDC0)
#define MOLEMOLE_UISUIBIANITEMICONBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x103DCDD0)
#define MOLEMOLE_UISUIBIANITEMICONBTNWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x103DCE60)
#define MOLEMOLE_UISUIBIANITEMICONBTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x103DCF00)
#define MOLEMOLE_UISUIBIANITEMICONBTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x103DCF90)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianItemIconBtnWidgetController_TypeDefinitionIndex = 85209;

	class UISuibianItemIconBtnWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_206* _view; // 0x2F0
		::Class_0_16E4307DCC419505_460* _itemView; // 0x2F8
		...
		::System::Void RefreshView(::Class_0_16E4307DCC419505_460* itemView)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_460*))((::PBYTE)hIl2Cpp + MOLEMOLE_UISUIBIANITEMICONBTNWIDGETCONTROLLER_REFRESHVIEW_OFFSET))(this, itemView);
		}

		::System::Void RefreshViewInner(::Class_0_16E4307DCC419505_460* itemView, ::System::Int32 curCount)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_460*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UISUIBIANITEMICONBTNWIDGETCONTROLLER_REFRESHVIEWINNER_OFFSET))(this, itemView, curCount);
		}
