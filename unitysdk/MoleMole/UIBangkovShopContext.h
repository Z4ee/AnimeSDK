...
#define MOLEMOLE_UIBANGKOVSHOPCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x19367A30)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangkovShopContext_TypeDefinitionIndex = 60068;
