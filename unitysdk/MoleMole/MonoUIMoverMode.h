...
#define MOLEMOLE_MONOUIMOVERMODE_AWAKE_OFFSET UNITYSDK_OFFSET(0x10D72960)
#define MOLEMOLE_MONOUIMOVERMODE_CLEARHANDLER_OFFSET UNITYSDK_OFFSET(0x10D72D80)
#define MOLEMOLE_MONOUIMOVERMODE_METHOD_5_0FD0EC313FAAB75A_OFFSET UNITYSDK_OFFSET(0x10D72FC0)
#define MOLEMOLE_MONOUIMOVERMODE_METHOD_5_10054BB010E03EDD_OFFSET UNITYSDK_OFFSET(0x10D72AF0)
#define MOLEMOLE_MONOUIMOVERMODE_METHOD_5_218124418542E081_OFFSET UNITYSDK_OFFSET(0x10D735D0)
#define MOLEMOLE_MONOUIMOVERMODE_METHOD_5_29352E75304CF2A0_OFFSET UNITYSDK_OFFSET(0x10D731F0)
#define MOLEMOLE_MONOUIMOVERMODE_METHOD_5_8CA88D55ECEFAD59_OFFSET UNITYSDK_OFFSET(0x10D72E50)
#define MOLEMOLE_MONOUIMOVERMODE_METHOD_5_E69AA2E64A20143D_OFFSET UNITYSDK_OFFSET(0x10D73260)
#define MOLEMOLE_MONOUIMOVERMODE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x10D72B40)
#define MOLEMOLE_MONOUIMOVERMODE_SETMOVETYPE_OFFSET UNITYSDK_OFFSET(0x10D72C60)
#define MOLEMOLE_MONOUIMOVERMODE_SETPINGPONGTYPE_OFFSET UNITYSDK_OFFSET(0x10D72CF0)
#define MOLEMOLE_MONOUIMOVERMODE_STOPMOVE_OFFSET UNITYSDK_OFFSET(0x10D72BA0)
#define MOLEMOLE_MONOUIMOVERMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x10D72DE0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIMoverMode_TypeDefinitionIndex = 41721;
