...
#define MOLEMOLE_UIMAINCITYMINIMENUINPUTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x155679F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityMiniMenuInputConfig_TypeDefinitionIndex = 74951;
