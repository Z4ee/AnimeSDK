...
class Class_2_3BEB019E352B28D9_Class_2_A56950714DAA0424;
...
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_BUILDSPHELPER_OFFSET UNITYSDK_OFFSET(0x16726E80)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_CLEARSPBARSTEP_OFFSET UNITYSDK_OFFSET(0x16726010)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_GET_CURINFOCFG_OFFSET UNITYSDK_OFFSET(0x16728720)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x182FF6E0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x182FF6F0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_HANDLEMOUSESCROLL_OFFSET UNITYSDK_OFFSET(0x16723570)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_INITSP_OFFSET UNITYSDK_OFFSET(0x16725340)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x16724460)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONBEFOREOPENNEWBIE_OFFSET UNITYSDK_OFFSET(0x16728090)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x182FF760)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONFIGHTER_PROPERTYVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x16728410)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x167223C0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x16723F20)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONPREVIEWCHANGE_OFFSET UNITYSDK_OFFSET(0x16726380)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONPROPERTYCHANGE_OFFSET UNITYSDK_OFFSET(0x167284C0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONSKILLINPUTMUTE_OFFSET UNITYSDK_OFFSET(0x16727F00)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16722370)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x182FF9D0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x182FF820)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONUNITCHANGE_OFFSET UNITYSDK_OFFSET(0x167237B0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONUNITCHANGE_PANEL_OFFSET UNITYSDK_OFFSET(0x16725640)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONUNITMODIFIED_OFFSET UNITYSDK_OFFSET(0x16727030)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONUNITSELECTED_OFFSET UNITYSDK_OFFSET(0x16727B10)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONUNITTRYSELECT_OFFSET UNITYSDK_OFFSET(0x16727620)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_RESETCAMERALOCK_OFFSET UNITYSDK_OFFSET(0x16722E30)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x16725F00)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_SETSPBARMATERIAL_OFFSET UNITYSDK_OFFSET(0x16726920)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_SHOWSKILLINFO_OFFSET UNITYSDK_OFFSET(0x16723220)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_SWITCHLOCKTARGET_OFFSET UNITYSDK_OFFSET(0x16722B70)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x16728620)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x167287D0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16728750)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER__HANDLEMOUSESCROLL_B__53_0_OFFSET UNITYSDK_OFFSET(0x16728980)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16728990)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x16728A30)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16728A60)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16728A70)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16728A80)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasySkillPanelChildWindowController_TypeDefinitionIndex = 89064;
	...
	public:
		...
		{
			return (::Il2CppArray<::MoleMole::LogicButtonInputType>**)Il2CppClass::FromTypeDefinitionIndex(UIMonsterFantasySkillPanelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x51AC0);
		}
		static ::Il2CppArray<::MoleMole::InputLogicEventType>** StaticGet_BUTTON_INPUT_EVENT()
		{
			return (::Il2CppArray<::MoleMole::InputLogicEventType>**)Il2CppClass::FromTypeDefinitionIndex(UIMonsterFantasySkillPanelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x51AC8);
		}
		static ::System::Int32* StaticGet_WaveHeightShaderParamID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMonsterFantasySkillPanelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x12DF0);
		}
		static ::System::Int32* StaticGet_StepPosShaderParamID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMonsterFantasySkillPanelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x12DF4);
		}
		static ::System::Int32* StaticGet_StepColorAShaderParamID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMonsterFantasySkillPanelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x12DF8);
		}
		static ::System::Int32* StaticGet_StepColorBShaderParamID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMonsterFantasySkillPanelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x12DFC);
		}
		...
		::Class_3_4CC9DF6D10E3002D_Class_4_70913AC4DAB8FEAC_5* _spBarView; // 0x338
		...
		::Class_2_3BEB019E352B28D9* _hudHelper_sp; // 0x358
		::Class_2_3BEB019E352B28D9_Class_2_A56950714DAA0424* _spIDataBindModel; // 0x360
		...
		::Class_2_208CC9941471731A_370* get_CurInfoCfg()
		{
			return ((::Class_2_208CC9941471731A_370*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_GET_CURINFOCFG_OFFSET))(this);
		}

		::System::Void ShowSkillInfo(::Class_2_208CC9941471731A_370* cfg)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_370*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_SHOWSKILLINFO_OFFSET))(this, cfg);
		}
