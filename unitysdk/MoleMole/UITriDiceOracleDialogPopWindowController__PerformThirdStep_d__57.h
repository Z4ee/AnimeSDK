...
#define MOLEMOLE_UITRIDICEORACLEDIALOGPOPWINDOWCONTROLLER__PERFORMTHIRDSTEP_D__57_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x816FF0)
#define MOLEMOLE_UITRIDICEORACLEDIALOGPOPWINDOWCONTROLLER__PERFORMTHIRDSTEP_D__57_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

namespace MoleMole
{
	inline static constexpr unsigned int UITriDiceOracleDialogPopWindowController__PerformThirdStep_d__57_TypeDefinitionIndex = 89296;
