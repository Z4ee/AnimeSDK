...
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_03F1CD50928B7BED_OFFSET UNITYSDK_OFFSET(0x16EF8760)
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x16EF8520)
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x16EF7F50)
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_30A2382C3FCC5386_OFFSET UNITYSDK_OFFSET(0x16EF67F0)
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x16EF7D10)
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_4B72F72501001F72_OFFSET UNITYSDK_OFFSET(0x16EF7D50)
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_6B6F54163E59B1A5_OFFSET UNITYSDK_OFFSET(0x16EF8580)
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_ABFE6A357B89C69A_OFFSET UNITYSDK_OFFSET(0x16EF70D0)
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0x16EF7510)
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_C5045C8922E9AC72_OFFSET UNITYSDK_OFFSET(0x16EF7FA0)
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x16EF7090)
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_D2809205008ACF99_OFFSET UNITYSDK_OFFSET(0x16EF7730)
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_E41B6A823556FEEA_OFFSET UNITYSDK_OFFSET(0x16EF7AF0)
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_F530CA3FA28BEDE8_OFFSET UNITYSDK_OFFSET(0x16EF8DD0)
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_FF8DCC945805E32B_OFFSET UNITYSDK_OFFSET(0x16EF71C0)
#define MOLEMOLE_UIFULLSCREENHANDLER_ONBEFORETRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0x16EF6B30)
#define MOLEMOLE_UIFULLSCREENHANDLER_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x16EF6AE0)
#define MOLEMOLE_UIFULLSCREENHANDLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x16EF6990)
#define MOLEMOLE_UIFULLSCREENHANDLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16EF68D0)
#define MOLEMOLE_UIFULLSCREENHANDLER_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x16EF6A00)
#define MOLEMOLE_UIFULLSCREENHANDLER_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x16EF6A70)
#define MOLEMOLE_UIFULLSCREENHANDLER_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x16EF67A0)
#define MOLEMOLE_UIFULLSCREENHANDLER_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0x16EF6940)
#define MOLEMOLE_UIFULLSCREENHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16EF6B80)
#define MOLEMOLE_UIFULLSCREENHANDLER___BASE_ONBEFORETRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0x16EF6C10)
#define MOLEMOLE_UIFULLSCREENHANDLER___BASE_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x16EF6CA0)
#define MOLEMOLE_UIFULLSCREENHANDLER___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x16EF6D30)
#define MOLEMOLE_UIFULLSCREENHANDLER___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16EF6DC0)
#define MOLEMOLE_UIFULLSCREENHANDLER___BASE_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x16EF6E50)
#define MOLEMOLE_UIFULLSCREENHANDLER___BASE_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x16EF6EE0)
#define MOLEMOLE_UIFULLSCREENHANDLER___BASE_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x16EF6F70)
#define MOLEMOLE_UIFULLSCREENHANDLER___BASE_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0x16EF7000)

namespace MoleMole
{
	inline static constexpr unsigned int UIFullScreenHandler_TypeDefinitionIndex = 39913;
