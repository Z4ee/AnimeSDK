...
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x12C04ED0)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12C04EE0)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x12C04F70)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12C05530)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12C05240)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x12C05490)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12C055A0)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12C055B0)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x12C05640)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12C056E0)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12C056F0)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x12C05700)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityOperationalPageController_TypeDefinitionIndex = 66744;

	class UIActivityOperationalPageController : public ::MoleMole::UIMainCityStorePageController
	{
	public:
		::Class_2_C832474F3EB70101_2* _view; // 0x328
