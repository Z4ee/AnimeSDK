...
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x12F39CF0)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12F39D00)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x12F39D90)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12F3A460)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12F3A070)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x12F3A3C0)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12F3A4D0)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12F3A4E0)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x12F3A530)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12F3A5D0)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12F3A5E0)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x12F3A5F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityOperationalPageController_TypeDefinitionIndex = 67159;

	class UIActivityOperationalPageController : public ::MoleMole::UIMainCityStorePageController
	{
	public:
		::Class_2_C832474F3EB70101_2* _view; // 0x320
		::MoleMole::UIActivityChainV2WidgetController* _activityChainV2Widget; // 0x328
