...
#define MOLEMOLE_UIBLURCONFIGCURVEDATAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6427F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBlurConfigCurveDataInfo_TypeDefinitionIndex = 53201;
