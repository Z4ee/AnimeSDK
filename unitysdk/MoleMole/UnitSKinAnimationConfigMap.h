...
#define MOLEMOLE_UNITSKINANIMATIONCONFIGMAP__CTOR_OFFSET UNITYSDK_OFFSET(0xEBD51A0)

namespace MoleMole
{
	inline static constexpr unsigned int UnitSKinAnimationConfigMap_TypeDefinitionIndex = 57568;
