...
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_AFTERCREATEITEMDATA_OFFSET UNITYSDK_OFFSET(0x1588CD90)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_CANSELECT_OFFSET UNITYSDK_OFFSET(0x1588CF30)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_CREATEITEM_OFFSET UNITYSDK_OFFSET(0x1588C620)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1588BF30)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_INITSCROLLLIST_OFFSET UNITYSDK_OFFSET(0x1588C570)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ISEQUIPED_OFFSET UNITYSDK_OFFSET(0x1588C7D0)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ISLOCK_OFFSET UNITYSDK_OFFSET(0x1588CE90)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ISSELECT_OFFSET UNITYSDK_OFFSET(0x1588D310)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ONBEFORESELECT_OFFSET UNITYSDK_OFFSET(0x1588CEE0)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ONCONFIRMBTN_OFFSET UNITYSDK_OFFSET(0x1588C4D0)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ONCONFIRM_OFFSET UNITYSDK_OFFSET(0x1588C530)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1588C3D0)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ONSELECT_OFFSET UNITYSDK_OFFSET(0x1588CFC0)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1588C460)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1588BF40)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1588C060)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_REFRESHDATALIST_OFFSET UNITYSDK_OFFSET(0x1588C830)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_REFRESHDATA_OFFSET UNITYSDK_OFFSET(0x1588C260)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER__AFTERCREATEITEMDATA_B__14_0_OFFSET UNITYSDK_OFFSET(0x1588D500)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1588D370)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER__INITSCROLLLIST_B__11_0_OFFSET UNITYSDK_OFFSET(0x1588D480)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1588D7C0)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1588D850)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1588D860)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1588D870)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityItemListDialogPopWindowController_TypeDefinitionIndex = 40764;

	class UIActivityItemListDialogPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_DAA2287413BF9E42* _view; // 0x310
		::System::Int32 questid; // 0x318
		::MoleMole::UITowerBuffListDialogContext* context; // 0x320
		::System::Int32 MAXCOUNT; // 0x328
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::UIBuffListItemRowWidgetController_BuffListItemData*>* buffDataDic; // 0x330
		::System::Collections::Generic::List_1<::System::Int32>* EquipedData; // 0x338
		::System::Collections::Generic::List_1<::System::Int32>* NewEquipedData; // 0x340
