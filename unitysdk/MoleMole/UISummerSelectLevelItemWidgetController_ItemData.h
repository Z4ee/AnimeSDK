...
#define MOLEMOLE_UISUMMERSELECTLEVELITEMWIDGETCONTROLLER_ITEMDATA_GETMAXSCORECOUNT_OFFSET UNITYSDK_OFFSET(0x15C38A70)
#define MOLEMOLE_UISUMMERSELECTLEVELITEMWIDGETCONTROLLER_ITEMDATA_GETNAME_OFFSET UNITYSDK_OFFSET(0x15C389C0)
#define MOLEMOLE_UISUMMERSELECTLEVELITEMWIDGETCONTROLLER_ITEMDATA_GETTABLEID_OFFSET UNITYSDK_OFFSET(0x15C38D30)
#define MOLEMOLE_UISUMMERSELECTLEVELITEMWIDGETCONTROLLER_ITEMDATA_GETTIME_OFFSET UNITYSDK_OFFSET(0x15C38CB0)
#define MOLEMOLE_UISUMMERSELECTLEVELITEMWIDGETCONTROLLER_ITEMDATA_ISLOCK_OFFSET UNITYSDK_OFFSET(0x15C38AD0)
#define MOLEMOLE_UISUMMERSELECTLEVELITEMWIDGETCONTROLLER_ITEMDATA_SETRANKICON_OFFSET UNITYSDK_OFFSET(0x15C38B70)
#define MOLEMOLE_UISUMMERSELECTLEVELITEMWIDGETCONTROLLER_ITEMDATA_SORTMETHOD_OFFSET UNITYSDK_OFFSET(0x15C38D80)
#define MOLEMOLE_UISUMMERSELECTLEVELITEMWIDGETCONTROLLER_ITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x15C38E50)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerSelectLevelItemWidgetController_ItemData_TypeDefinitionIndex = 61643;

	class UISummerSelectLevelItemWidgetController_ItemData : public ::System::Object
	{
	public:
		::System::String* ScoreTitleText; // 0x10
		::Class_0_16E4307DCC419505_169* LevelData; // 0x18
		::Class_2_208CC9941471731A_389* TableInfo; // 0x20
