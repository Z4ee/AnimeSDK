...
#define MOLEMOLE_GAMEENGINE_CLASS_1_48FC0950BDBA8F40_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x107EFFB0)
#define MOLEMOLE_GAMEENGINE_CLASS_1_48FC0950BDBA8F40_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x107F03E0)
#define MOLEMOLE_GAMEENGINE_CLASS_1_48FC0950BDBA8F40_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x107F0440)
#define MOLEMOLE_GAMEENGINE_CLASS_1_48FC0950BDBA8F40_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x107F03F0)
#define MOLEMOLE_GAMEENGINE_CLASS_1_48FC0950BDBA8F40_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x107EFFA0)
#define MOLEMOLE_GAMEENGINE_CLASS_1_48FC0950BDBA8F40__CTOR_OFFSET UNITYSDK_OFFSET(0x107EDD00)

namespace MoleMole
{
	inline static constexpr unsigned int GameEngine_Class_1_48FC0950BDBA8F40_TypeDefinitionIndex = 72837;

	class GameEngine_Class_1_48FC0950BDBA8F40 : public ::System::Object
	{
	public:
		::MoleMole::GameEngine* Field_1_0; // 0x10
