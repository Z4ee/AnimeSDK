...
#define MOLEMOLE_UIBALLGAMECOLLECTROLEROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1895DF00)
#define MOLEMOLE_UIBALLGAMECOLLECTROLEROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1895DF70)
#define MOLEMOLE_UIBALLGAMECOLLECTROLEROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x1895E340)
#define MOLEMOLE_UIBALLGAMECOLLECTROLEROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1895E100)
#define MOLEMOLE_UIBALLGAMECOLLECTROLEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1895E3F0)
#define MOLEMOLE_UIBALLGAMECOLLECTROLEROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1895E400)
#define MOLEMOLE_UIBALLGAMECOLLECTROLEROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x1895E4A0)
#define MOLEMOLE_UIBALLGAMECOLLECTROLEROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1895E530)

namespace MoleMole
{
	inline static constexpr unsigned int UIBallGameCollectRoleRowWidgetController_TypeDefinitionIndex = 58727;
