...
#define MOLEMOLE_UIABYSSS2RELICDETAILTEXTROWWIDGETCONTROLLER_BUILDLEVELDESC_OFFSET UNITYSDK_OFFSET(0x1A1D0150)
#define MOLEMOLE_UIABYSSS2RELICDETAILTEXTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1A1CFD50)
#define MOLEMOLE_UIABYSSS2RELICDETAILTEXTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1A1CFDE0)
#define MOLEMOLE_UIABYSSS2RELICDETAILTEXTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1A1CFCF0)
#define MOLEMOLE_UIABYSSS2RELICDETAILTEXTROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1A1CFE60)
#define MOLEMOLE_UIABYSSS2RELICDETAILTEXTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1D05E0)
#define MOLEMOLE_UIABYSSS2RELICDETAILTEXTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1A1D0640)
#define MOLEMOLE_UIABYSSS2RELICDETAILTEXTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1A1D06D0)
#define MOLEMOLE_UIABYSSS2RELICDETAILTEXTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1A1D0760)
#define MOLEMOLE_UIABYSSS2RELICDETAILTEXTROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1A1D07F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2RelicDetailTextRowWidgetController_TypeDefinitionIndex = 53947;
	...
	public:
		...
		{
			return ((::System::String*(*)(::PVOID, ::Class_2_208CC9941471731A_732*, ::System::Boolean, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABYSSS2RELICDETAILTEXTROWWIDGETCONTROLLER_BUILDLEVELDESC_OFFSET))(this, levelConfig, light, hideLevel);
		}
