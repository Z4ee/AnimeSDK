...
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTWIDGETCONTROLLER_INITSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x14FB2BE0)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14FB3210)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14FB32A0)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14FB29B0)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTWIDGETCONTROLLER_SETAFTERHIDECALLBACK_OFFSET UNITYSDK_OFFSET(0x14FB3320)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14FB3370)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0x14FB3450)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14FB3480)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14FB3510)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14FB35A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralScrollViewTestWidgetController_TypeDefinitionIndex = 41285;

	class UIGeneralScrollViewTestWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_8506D464D89CF597* _view; // 0x2B8
		::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::MoleMole::UIGeneralScrollViewTestWidgetController_Data*>*>* _datas; // 0x2C0
		::System::Action* _afterHideCallback; // 0x2C8
