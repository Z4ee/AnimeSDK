...
#define MOLEMOLE_MONOITEMICON_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x16875050)
#define MOLEMOLE_MONOITEMICON_METHOD_5_9718385E4E3EEC17_OFFSET UNITYSDK_OFFSET(0x16874AA0)
#define MOLEMOLE_MONOITEMICON_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x16875010)
#define MOLEMOLE_MONOITEMICON_METHOD_5_D0CD9A971CA3B1CF_OFFSET UNITYSDK_OFFSET(0x16874E00)
#define MOLEMOLE_MONOITEMICON_ONPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x16874F50)
#define MOLEMOLE_MONOITEMICON_REGISTERCALLBACKS_OFFSET UNITYSDK_OFFSET(0x16874D30)
#define MOLEMOLE_MONOITEMICON_SELECTITEM_OFFSET UNITYSDK_OFFSET(0x16874EB0)
#define MOLEMOLE_MONOITEMICON_SETUPVIEW_1_OFFSET UNITYSDK_OFFSET(0x16874BF0)
#define MOLEMOLE_MONOITEMICON_SETUPVIEW_2_OFFSET UNITYSDK_OFFSET(0x16874C80)
#define MOLEMOLE_MONOITEMICON_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x16874A20)
#define MOLEMOLE_MONOITEMICON_UNSELECTITEM_OFFSET UNITYSDK_OFFSET(0x16874D70)
#define MOLEMOLE_MONOITEMICON__CTOR_OFFSET UNITYSDK_OFFSET(0x16874FC0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoItemIcon_TypeDefinitionIndex = 82000;
