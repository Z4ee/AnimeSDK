...
#define MOLEMOLE_MODELQUALITYPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x17383330)

namespace MoleMole
{
	inline static constexpr unsigned int ModelQualityProfileContext_TypeDefinitionIndex = 43834;
