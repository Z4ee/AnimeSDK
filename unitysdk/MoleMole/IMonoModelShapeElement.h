...
#define MOLEMOLE_IMONOMODELSHAPEELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x11624F40)

namespace MoleMole
{
	inline static constexpr unsigned int IMonoModelShapeElement_TypeDefinitionIndex = 46123;
