...
class Class_2_0C1EE8A3BE8526FC_11;
class Class_2_B4378B46E0020E85;
namespace UnityEngine { class RectTransform; }

#define MOLEMOLE_UISURFJUMPCHILDWINDOWCONTROLLER_GET_BUTTON_OFFSET UNITYSDK_OFFSET(0x15F8CF60)
#define MOLEMOLE_UISURFJUMPCHILDWINDOWCONTROLLER_GET_EVENT_OFFSET UNITYSDK_OFFSET(0x15F8CF50)
#define MOLEMOLE_UISURFJUMPCHILDWINDOWCONTROLLER_GET_KEYPANELROOT_OFFSET UNITYSDK_OFFSET(0x15F8CF30)
#define MOLEMOLE_UISURFJUMPCHILDWINDOWCONTROLLER_GET_SKILLBUTTON_OFFSET UNITYSDK_OFFSET(0x15F8CF10)
#define MOLEMOLE_UISURFJUMPCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15F8CF70)

namespace MoleMole
{
	inline static constexpr unsigned int UISurfJumpChildWindowController_TypeDefinitionIndex = 82958;

	class UISurfJumpChildWindowController : public ::MoleMole::UISurfAutoSkillButton_1<::Class_2_0C1EE8A3BE8526FC_11*>
	{
	public:
		::System::Void _ctor()
		{
