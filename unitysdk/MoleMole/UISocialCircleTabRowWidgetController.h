...
#define MOLEMOLE_UISOCIALCIRCLETABROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15F7C020)
#define MOLEMOLE_UISOCIALCIRCLETABROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15F7C0F0)
#define MOLEMOLE_UISOCIALCIRCLETABROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15F7C1B0)
#define MOLEMOLE_UISOCIALCIRCLETABROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15F7C090)
#define MOLEMOLE_UISOCIALCIRCLETABROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15F7C380)
#define MOLEMOLE_UISOCIALCIRCLETABROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15F7C390)
#define MOLEMOLE_UISOCIALCIRCLETABROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15F7C430)
#define MOLEMOLE_UISOCIALCIRCLETABROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15F7C4D0)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleTabRowWidgetController_TypeDefinitionIndex = 70363;
