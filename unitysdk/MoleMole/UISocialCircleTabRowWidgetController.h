...
#define MOLEMOLE_UISOCIALCIRCLETABROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x138198B0)
#define MOLEMOLE_UISOCIALCIRCLETABROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x13819980)
#define MOLEMOLE_UISOCIALCIRCLETABROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x13819A40)
#define MOLEMOLE_UISOCIALCIRCLETABROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x13819920)
#define MOLEMOLE_UISOCIALCIRCLETABROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x13819C00)
#define MOLEMOLE_UISOCIALCIRCLETABROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x13819C10)
#define MOLEMOLE_UISOCIALCIRCLETABROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x13819CB0)
#define MOLEMOLE_UISOCIALCIRCLETABROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x13819D50)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleTabRowWidgetController_TypeDefinitionIndex = 45983;
	...
	public:
		...
		{
			return ((::Class_2_00C447E56FB5F788*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UISOCIALCIRCLETABROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
