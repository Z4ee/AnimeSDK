...
#define MOLEMOLE_SERIALIZEDSCRIPTABLEOBJECTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x17DEA620)

namespace MoleMole
{
	inline static constexpr unsigned int SerializedScriptableObjectBase_TypeDefinitionIndex = 51131;
