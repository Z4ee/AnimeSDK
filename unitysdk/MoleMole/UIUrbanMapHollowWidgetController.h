...
#define MOLEMOLE_UIURBANMAPHOLLOWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15F9D9C0)
#define MOLEMOLE_UIURBANMAPHOLLOWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15F9DA30)
#define MOLEMOLE_UIURBANMAPHOLLOWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15F9DAF0)
#define MOLEMOLE_UIURBANMAPHOLLOWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15F9DC70)
#define MOLEMOLE_UIURBANMAPHOLLOWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15F9DCD0)
#define MOLEMOLE_UIURBANMAPHOLLOWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15F9DD70)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapHollowWidgetController_TypeDefinitionIndex = 51073;
