...
#define MOLEMOLE_CHESSSTATEMACHINE_ENTITYSENDEVENTACTION_RUNINNER_OFFSET UNITYSDK_OFFSET(0x1B5391E0)
#define MOLEMOLE_CHESSSTATEMACHINE_ENTITYSENDEVENTACTION_RUN_OFFSET UNITYSDK_OFFSET(0x1B539180)
#define MOLEMOLE_CHESSSTATEMACHINE_ENTITYSENDEVENTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5394C0)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int EntitySendEventAction_TypeDefinitionIndex = 60632;
