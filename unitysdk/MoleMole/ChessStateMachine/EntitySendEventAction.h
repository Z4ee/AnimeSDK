...
#define MOLEMOLE_CHESSSTATEMACHINE_ENTITYSENDEVENTACTION_RUNINNER_OFFSET UNITYSDK_OFFSET(0x13FF4130)
#define MOLEMOLE_CHESSSTATEMACHINE_ENTITYSENDEVENTACTION_RUN_OFFSET UNITYSDK_OFFSET(0x13FF40D0)
#define MOLEMOLE_CHESSSTATEMACHINE_ENTITYSENDEVENTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x13FF4400)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int EntitySendEventAction_TypeDefinitionIndex = 55284;
