...
#define MOLEMOLE_CHESSSTATEMACHINE_SETISBLACKSCREENACTION_FORCESTOP_OFFSET UNITYSDK_OFFSET(0x12A2E850)
#define MOLEMOLE_CHESSSTATEMACHINE_SETISBLACKSCREENACTION_GET_ISINSTANT_OFFSET UNITYSDK_OFFSET(0x12A2E600)
#define MOLEMOLE_CHESSSTATEMACHINE_SETISBLACKSCREENACTION_RUN_OFFSET UNITYSDK_OFFSET(0x12A2E610)
#define MOLEMOLE_CHESSSTATEMACHINE_SETISBLACKSCREENACTION_STOP_OFFSET UNITYSDK_OFFSET(0x12A2E890)
#define MOLEMOLE_CHESSSTATEMACHINE_SETISBLACKSCREENACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x12A2E8D0)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int SetIsBlackScreenAction_TypeDefinitionIndex = 51727;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_43BD383C98B4C0C5_31*))((::PBYTE)hIl2Cpp + MOLEMOLE_CHESSSTATEMACHINE_SETISBLACKSCREENACTION_RUN_OFFSET))(this, context);
		}
