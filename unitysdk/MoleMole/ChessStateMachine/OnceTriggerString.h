...
#define MOLEMOLE_CHESSSTATEMACHINE_ONCETRIGGERSTRING_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x177BF760)
#define MOLEMOLE_CHESSSTATEMACHINE_ONCETRIGGERSTRING_EQUALS_OFFSET UNITYSDK_OFFSET(0x177BF6E0)
#define MOLEMOLE_CHESSSTATEMACHINE_ONCETRIGGERSTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x177BF890)
#define MOLEMOLE_CHESSSTATEMACHINE_ONCETRIGGERSTRING_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x177BF960)
#define MOLEMOLE_CHESSSTATEMACHINE_ONCETRIGGERSTRING_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x177BEBD0)
#define MOLEMOLE_CHESSSTATEMACHINE_ONCETRIGGERSTRING_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x177BFA60)
#define MOLEMOLE_CHESSSTATEMACHINE_ONCETRIGGERSTRING_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x177BF9E0)
#define MOLEMOLE_CHESSSTATEMACHINE_ONCETRIGGERSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x177BFAE0)
#define MOLEMOLE_CHESSSTATEMACHINE_ONCETRIGGERSTRING___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x177BFAF0)
#define MOLEMOLE_CHESSSTATEMACHINE_ONCETRIGGERSTRING___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x177BFB00)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int OnceTriggerString_TypeDefinitionIndex = 82537;
