...
#define MOLEMOLE_CHESSSTATEMACHINE_CHESSENTITYEVENTNODE_FORCESTOP_OFFSET UNITYSDK_OFFSET(0x122DF5A0)
#define MOLEMOLE_CHESSSTATEMACHINE_CHESSENTITYEVENTNODE_GET_ISINSTANT_OFFSET UNITYSDK_OFFSET(0x122DF620)
#define MOLEMOLE_CHESSSTATEMACHINE_CHESSENTITYEVENTNODE_RUN_OFFSET UNITYSDK_OFFSET(0x122DF430)
#define MOLEMOLE_CHESSSTATEMACHINE_CHESSENTITYEVENTNODE_STOP_OFFSET UNITYSDK_OFFSET(0x122DF5E0)
#define MOLEMOLE_CHESSSTATEMACHINE_CHESSENTITYEVENTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x122DF630)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int ChessEntityEventNode_TypeDefinitionIndex = 61789;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_43BD383C98B4C0C5_20*))((::PBYTE)hIl2Cpp + MOLEMOLE_CHESSSTATEMACHINE_CHESSENTITYEVENTNODE_RUN_OFFSET))(this, context);
		}
