...
#define MOLEMOLE_CHESSSTATEMACHINE_LOCALMOVEANIMACTION___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0x177BF4E0)
#define MOLEMOLE_CHESSSTATEMACHINE_LOCALMOVEANIMACTION___C__DISPLAYCLASS6_0__DORISEORSINKBYCONFIG_B__0_OFFSET UNITYSDK_OFFSET(0x177BF4F0)
#define MOLEMOLE_CHESSSTATEMACHINE_LOCALMOVEANIMACTION___C__DISPLAYCLASS6_0__DORISEORSINKBYCONFIG_B__1_OFFSET UNITYSDK_OFFSET(0x177BF570)
#define MOLEMOLE_CHESSSTATEMACHINE_LOCALMOVEANIMACTION___C__DISPLAYCLASS6_0__DORISEORSINKBYCONFIG_B__2_OFFSET UNITYSDK_OFFSET(0x177BF5F0)
#define MOLEMOLE_CHESSSTATEMACHINE_LOCALMOVEANIMACTION___C__DISPLAYCLASS6_0__DORISEORSINKBYCONFIG_B__3_OFFSET UNITYSDK_OFFSET(0x177BF670)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int LocalMoveAnimAction___c__DisplayClass6_0_TypeDefinitionIndex = 79084;
