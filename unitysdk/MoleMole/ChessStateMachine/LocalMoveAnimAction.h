...
#define MOLEMOLE_CHESSSTATEMACHINE_LOCALMOVEANIMACTION_ACTIONOVER_OFFSET UNITYSDK_OFFSET(0x141DC260)
#define MOLEMOLE_CHESSSTATEMACHINE_LOCALMOVEANIMACTION_BUILDLOCALMOVEEFFECT_OFFSET UNITYSDK_OFFSET(0x141DB660)
#define MOLEMOLE_CHESSSTATEMACHINE_LOCALMOVEANIMACTION_CHECKISBIGTVMOVE_OFFSET UNITYSDK_OFFSET(0x141DB590)
#define MOLEMOLE_CHESSSTATEMACHINE_LOCALMOVEANIMACTION_DORISEORSINKBYCONFIG_OFFSET UNITYSDK_OFFSET(0x141DB700)
#define MOLEMOLE_CHESSSTATEMACHINE_LOCALMOVEANIMACTION_FORCESTOP_OFFSET UNITYSDK_OFFSET(0x141DC100)
#define MOLEMOLE_CHESSSTATEMACHINE_LOCALMOVEANIMACTION_GETCHANGESTRUCTCONFIG_1_OFFSET UNITYSDK_OFFSET(0x141DC030)
#define MOLEMOLE_CHESSSTATEMACHINE_LOCALMOVEANIMACTION_GETCHANGESTRUCTCONFIG_OFFSET UNITYSDK_OFFSET(0x141DB9F0)
#define MOLEMOLE_CHESSSTATEMACHINE_LOCALMOVEANIMACTION_GET_ISINSTANT_OFFSET UNITYSDK_OFFSET(0x141DC2B0)
#define MOLEMOLE_CHESSSTATEMACHINE_LOCALMOVEANIMACTION_ONSTOP_OFFSET UNITYSDK_OFFSET(0x141DC180)
#define MOLEMOLE_CHESSSTATEMACHINE_LOCALMOVEANIMACTION_RUNINNER_OFFSET UNITYSDK_OFFSET(0x141DB530)
#define MOLEMOLE_CHESSSTATEMACHINE_LOCALMOVEANIMACTION_RUN_OFFSET UNITYSDK_OFFSET(0x141DB300)
#define MOLEMOLE_CHESSSTATEMACHINE_LOCALMOVEANIMACTION_STOP_OFFSET UNITYSDK_OFFSET(0x141DC140)
#define MOLEMOLE_CHESSSTATEMACHINE_LOCALMOVEANIMACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x141DC2C0)
#define MOLEMOLE_CHESSSTATEMACHINE_LOCALMOVEANIMACTION___BASE_ACTIONOVER_OFFSET UNITYSDK_OFFSET(0x141DC2D0)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int LocalMoveAnimAction_TypeDefinitionIndex = 46235;
