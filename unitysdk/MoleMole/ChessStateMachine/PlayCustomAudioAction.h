...
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYCUSTOMAUDIOACTION_FORCESTOP_OFFSET UNITYSDK_OFFSET(0x162455B0)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYCUSTOMAUDIOACTION_GET_ISINSTANT_OFFSET UNITYSDK_OFFSET(0x16245510)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYCUSTOMAUDIOACTION_RUN_OFFSET UNITYSDK_OFFSET(0x16245520)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYCUSTOMAUDIOACTION_STOP_OFFSET UNITYSDK_OFFSET(0x162455F0)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYCUSTOMAUDIOACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16245630)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int PlayCustomAudioAction_TypeDefinitionIndex = 51808;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_43BD383C98B4C0C5_31*))((::PBYTE)hIl2Cpp + MOLEMOLE_CHESSSTATEMACHINE_PLAYCUSTOMAUDIOACTION_RUN_OFFSET))(this, context);
		}
