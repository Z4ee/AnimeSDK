...
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_CHECKTYPEVALID_OFFSET UNITYSDK_OFFSET(0x177C0260)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_CHECKVALUE_1_OFFSET UNITYSDK_OFFSET(0x177C0560)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_CHECKVALUE_2_OFFSET UNITYSDK_OFFSET(0x177C05B0)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_CHECKVALUE_OFFSET UNITYSDK_OFFSET(0x177C04A0)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_CLEARCACHEDATA_OFFSET UNITYSDK_OFFSET(0x177C0660)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_DRAWVALUESET_OFFSET UNITYSDK_OFFSET(0x177C0220)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_GETVALUE_1_OFFSET UNITYSDK_OFFSET(0x177C0400)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_GETVALUE_2_OFFSET UNITYSDK_OFFSET(0x177C0450)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_GETVALUE_OFFSET UNITYSDK_OFFSET(0x177C03B0)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_GET_PARAMSTYPE_1_OFFSET UNITYSDK_OFFSET(0x177C0650)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_GET_PARAMSTYPE_OFFSET UNITYSDK_OFFSET(0x177BFB10)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x177BFB70)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_INITVALUE_OFFSET UNITYSDK_OFFSET(0x177BFB20)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_RESETAFTERCHECKVALID_OFFSET UNITYSDK_OFFSET(0x177C06E0)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_SETVALUE_1_OFFSET UNITYSDK_OFFSET(0x177C0310)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_SETVALUE_2_OFFSET UNITYSDK_OFFSET(0x177C0360)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_SETVALUE_OFFSET UNITYSDK_OFFSET(0x177C02B0)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS__CTOR_OFFSET UNITYSDK_OFFSET(0x177C0760)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int ParamsClass_TypeDefinitionIndex = 48818;
