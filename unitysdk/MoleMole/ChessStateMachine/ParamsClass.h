...
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_CHECKTYPEVALID_OFFSET UNITYSDK_OFFSET(0x17D0CF90)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_CHECKVALUE_1_OFFSET UNITYSDK_OFFSET(0x17D0D2A0)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_CHECKVALUE_2_OFFSET UNITYSDK_OFFSET(0x17D0D2F0)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_CHECKVALUE_OFFSET UNITYSDK_OFFSET(0x17D0D1D0)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_CLEARCACHEDATA_OFFSET UNITYSDK_OFFSET(0x17D0D3B0)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_DRAWVALUESET_OFFSET UNITYSDK_OFFSET(0x17D0CF50)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_GETVALUE_1_OFFSET UNITYSDK_OFFSET(0x17D0D130)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_GETVALUE_2_OFFSET UNITYSDK_OFFSET(0x17D0D180)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_GETVALUE_OFFSET UNITYSDK_OFFSET(0x17D0D0E0)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_GET_PARAMSTYPE_1_OFFSET UNITYSDK_OFFSET(0x17D0D3A0)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_GET_PARAMSTYPE_OFFSET UNITYSDK_OFFSET(0x17D0C820)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x17D0C880)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_INITVALUE_OFFSET UNITYSDK_OFFSET(0x17D0C830)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_RESETAFTERCHECKVALID_OFFSET UNITYSDK_OFFSET(0x17D0D430)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_SETVALUE_1_OFFSET UNITYSDK_OFFSET(0x17D0D040)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_SETVALUE_2_OFFSET UNITYSDK_OFFSET(0x17D0D090)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_SETVALUE_OFFSET UNITYSDK_OFFSET(0x17D0CFE0)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS__CTOR_OFFSET UNITYSDK_OFFSET(0x17D0D4B0)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int ParamsClass_TypeDefinitionIndex = 62917;
