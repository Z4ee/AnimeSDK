...
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYERONAUTOSLEEPACTION_ACTIONOVER_OFFSET UNITYSDK_OFFSET(0x12B0E9D0)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYERONAUTOSLEEPACTION_RUN_OFFSET UNITYSDK_OFFSET(0x12B0E890)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYERONAUTOSLEEPACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x12B0EAB0)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYERONAUTOSLEEPACTION__RUN_G____SENDTIMEROUTEVENT_2_0_OFFSET UNITYSDK_OFFSET(0x12B0E980)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYERONAUTOSLEEPACTION___BASE_ACTIONOVER_OFFSET UNITYSDK_OFFSET(0x12B0EAC0)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYERONAUTOSLEEPACTION___BASE_RUN_OFFSET UNITYSDK_OFFSET(0x12B0EB50)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int PlayerOnAutoSleepAction_TypeDefinitionIndex = 54774;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_43BD383C98B4C0C5_24*))((::PBYTE)hIl2Cpp + MOLEMOLE_CHESSSTATEMACHINE_PLAYERONAUTOSLEEPACTION_RUN_OFFSET))(this, context);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_43BD383C98B4C0C5_24*))((::PBYTE)hIl2Cpp + MOLEMOLE_CHESSSTATEMACHINE_PLAYERONAUTOSLEEPACTION___BASE_RUN_OFFSET))(this, P0);
		}
	};
}
