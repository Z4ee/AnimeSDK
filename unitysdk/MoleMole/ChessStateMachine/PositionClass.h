...
#define MOLEMOLE_CHESSSTATEMACHINE_POSITIONCLASS_FORCESTOP_OFFSET UNITYSDK_OFFSET(0x10CE2E50)
#define MOLEMOLE_CHESSSTATEMACHINE_POSITIONCLASS_GET_ISINSTANT_OFFSET UNITYSDK_OFFSET(0x10CE2FD0)
#define MOLEMOLE_CHESSSTATEMACHINE_POSITIONCLASS_RUN_OFFSET UNITYSDK_OFFSET(0x10CE2C70)
#define MOLEMOLE_CHESSSTATEMACHINE_POSITIONCLASS_STOP_OFFSET UNITYSDK_OFFSET(0x10CE2F10)
#define MOLEMOLE_CHESSSTATEMACHINE_POSITIONCLASS__CTOR_OFFSET UNITYSDK_OFFSET(0x10CE2FE0)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int PositionClass_TypeDefinitionIndex = 46194;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_43BD383C98B4C0C5_24*))((::PBYTE)hIl2Cpp + MOLEMOLE_CHESSSTATEMACHINE_POSITIONCLASS_RUN_OFFSET))(this, context);
		}
