...
#define MOLEMOLE_CHESSSTATEMACHINE_POSITIONCLASS_FORCESTOP_OFFSET UNITYSDK_OFFSET(0x116DDA80)
#define MOLEMOLE_CHESSSTATEMACHINE_POSITIONCLASS_GET_ISINSTANT_OFFSET UNITYSDK_OFFSET(0x116DDC00)
#define MOLEMOLE_CHESSSTATEMACHINE_POSITIONCLASS_RUN_OFFSET UNITYSDK_OFFSET(0x116DD8A0)
#define MOLEMOLE_CHESSSTATEMACHINE_POSITIONCLASS_STOP_OFFSET UNITYSDK_OFFSET(0x116DDB40)
#define MOLEMOLE_CHESSSTATEMACHINE_POSITIONCLASS__CTOR_OFFSET UNITYSDK_OFFSET(0x116DDC10)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int PositionClass_TypeDefinitionIndex = 52208;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_43BD383C98B4C0C5_31*))((::PBYTE)hIl2Cpp + MOLEMOLE_CHESSSTATEMACHINE_POSITIONCLASS_RUN_OFFSET))(this, context);
		}
