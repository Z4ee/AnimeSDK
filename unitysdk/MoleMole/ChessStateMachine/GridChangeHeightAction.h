...
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDCHANGEHEIGHTACTION_DOCHANGESTRUCTANIM_OFFSET UNITYSDK_OFFSET(0x12B0E2E0)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDCHANGEHEIGHTACTION_NEEDCHANGESTRUCTBETWEENRISE_OFFSET UNITYSDK_OFFSET(0x12B0E280)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDCHANGEHEIGHTACTION_RUN_OFFSET UNITYSDK_OFFSET(0x12B0E180)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDCHANGEHEIGHTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x12B0E800)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDCHANGEHEIGHTACTION__DOCHANGESTRUCTANIM_B__3_0_OFFSET UNITYSDK_OFFSET(0x12B0E820)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int GridChangeHeightAction_TypeDefinitionIndex = 82978;
