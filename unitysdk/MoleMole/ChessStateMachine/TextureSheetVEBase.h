...
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVEBASE_FINDBLENDTEXTURESHEETDATA_OFFSET UNITYSDK_OFFSET(0x1A054240)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVEBASE_FINDTEXTURESHEETDATABYKEY_OFFSET UNITYSDK_OFFSET(0x1A0542D0)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVEBASE_FORCESTOP_OFFSET UNITYSDK_OFFSET(0x1A054500)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVEBASE_GET_ISINSTANT_OFFSET UNITYSDK_OFFSET(0x1A054680)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVEBASE_RANDOMTEXTURESHEETKEY_OFFSET UNITYSDK_OFFSET(0x1A0541A0)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVEBASE_RUN_OFFSET UNITYSDK_OFFSET(0x1A0545F0)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVEBASE_STOP_OFFSET UNITYSDK_OFFSET(0x1A054640)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A054550)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int TextureSheetVEBase_TypeDefinitionIndex = 72520;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_43BD383C98B4C0C5_24*))((::PBYTE)hIl2Cpp + MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVEBASE_RUN_OFFSET))(this, context);
		}
