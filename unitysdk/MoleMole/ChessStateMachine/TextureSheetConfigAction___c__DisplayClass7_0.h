...
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETCONFIGACTION___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0xFAF2D20)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETCONFIGACTION___C__DISPLAYCLASS7_0__RUN_B__1_OFFSET UNITYSDK_OFFSET(0xFAF2D30)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETCONFIGACTION___C__DISPLAYCLASS7_0__RUN_B__2_OFFSET UNITYSDK_OFFSET(0xFAF30C0)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETCONFIGACTION___C__DISPLAYCLASS7_0__RUN_B__3_OFFSET UNITYSDK_OFFSET(0xFAF3140)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETCONFIGACTION___C__DISPLAYCLASS7_0__RUN_B__4_OFFSET UNITYSDK_OFFSET(0xFAF31C0)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int TextureSheetConfigAction___c__DisplayClass7_0_TypeDefinitionIndex = 80729;
