...
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETCONFIGACTION___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0xE957D30)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETCONFIGACTION___C__DISPLAYCLASS7_0__RUN_B__1_OFFSET UNITYSDK_OFFSET(0xE957D40)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETCONFIGACTION___C__DISPLAYCLASS7_0__RUN_B__2_OFFSET UNITYSDK_OFFSET(0xE9580D0)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETCONFIGACTION___C__DISPLAYCLASS7_0__RUN_B__3_OFFSET UNITYSDK_OFFSET(0xE958150)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETCONFIGACTION___C__DISPLAYCLASS7_0__RUN_B__4_OFFSET UNITYSDK_OFFSET(0xE9581D0)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int TextureSheetConfigAction___c__DisplayClass7_0_TypeDefinitionIndex = 85447;
