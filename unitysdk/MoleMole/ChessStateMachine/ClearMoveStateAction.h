...
#define MOLEMOLE_CHESSSTATEMACHINE_CLEARMOVESTATEACTION_CLEARMOVESTATE_OFFSET UNITYSDK_OFFSET(0xFAF2B20)
#define MOLEMOLE_CHESSSTATEMACHINE_CLEARMOVESTATEACTION_FORCESTOP_OFFSET UNITYSDK_OFFSET(0xFAF2BA0)
#define MOLEMOLE_CHESSSTATEMACHINE_CLEARMOVESTATEACTION_GET_ISINSTANT_OFFSET UNITYSDK_OFFSET(0xFAF28F0)
#define MOLEMOLE_CHESSSTATEMACHINE_CLEARMOVESTATEACTION_RUN_OFFSET UNITYSDK_OFFSET(0xFAF2900)
#define MOLEMOLE_CHESSSTATEMACHINE_CLEARMOVESTATEACTION_STOP_OFFSET UNITYSDK_OFFSET(0xFAF2B60)
#define MOLEMOLE_CHESSSTATEMACHINE_CLEARMOVESTATEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xFAF2D10)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int ClearMoveStateAction_TypeDefinitionIndex = 38105;
