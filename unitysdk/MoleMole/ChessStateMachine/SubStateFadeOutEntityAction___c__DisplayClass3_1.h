...
#define MOLEMOLE_CHESSSTATEMACHINE_SUBSTATEFADEOUTENTITYACTION___C__DISPLAYCLASS3_1__CTOR_OFFSET UNITYSDK_OFFSET(0x17D0DAB0)
#define MOLEMOLE_CHESSSTATEMACHINE_SUBSTATEFADEOUTENTITYACTION___C__DISPLAYCLASS3_1__RUN_B__3_OFFSET UNITYSDK_OFFSET(0x17D0DAE0)
#define MOLEMOLE_CHESSSTATEMACHINE_SUBSTATEFADEOUTENTITYACTION___C__DISPLAYCLASS3_1__RUN_B__4_OFFSET UNITYSDK_OFFSET(0x17D0DB10)
#define MOLEMOLE_CHESSSTATEMACHINE_SUBSTATEFADEOUTENTITYACTION___C__DISPLAYCLASS3_1__RUN_B__5_OFFSET UNITYSDK_OFFSET(0x17D0DAC0)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int SubStateFadeOutEntityAction___c__DisplayClass3_1_TypeDefinitionIndex = 70329;

	class SubStateFadeOutEntityAction___c__DisplayClass3_1 : public ::System::Object
	{
	public:
		::Class_1_4A40FFFAB0E20E45* pieceMultiPlayerHelper; // 0x10
