...
#define MOLEMOLE_CHESSSTATEMACHINE_SUBSTATEFADEOUTENTITYACTION___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0xFE99FA0)
#define MOLEMOLE_CHESSSTATEMACHINE_SUBSTATEFADEOUTENTITYACTION___C__DISPLAYCLASS3_0__RUN_B__0_OFFSET UNITYSDK_OFFSET(0xFE99FB0)
#define MOLEMOLE_CHESSSTATEMACHINE_SUBSTATEFADEOUTENTITYACTION___C__DISPLAYCLASS3_0__RUN_B__2_OFFSET UNITYSDK_OFFSET(0xFE9A150)
#define MOLEMOLE_CHESSSTATEMACHINE_SUBSTATEFADEOUTENTITYACTION___C__DISPLAYCLASS3_0__RUN_G____CLOSESUBSTATE_1_OFFSET UNITYSDK_OFFSET(0xFE99FE0)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int SubStateFadeOutEntityAction___c__DisplayClass3_0_TypeDefinitionIndex = 70330;

	class SubStateFadeOutEntityAction___c__DisplayClass3_0 : public ::System::Object
	{
	public:
		::MoleMole::ChessStateMachine::SubStateFadeOutEntityAction* __4__this; // 0x10
		::Class_4_DA19DD65175B97CF* chessPieceProxy; // 0x18
