...
#define MOLEMOLE_UICOOPPAGECONTROLLER_BINDBADGE_OFFSET UNITYSDK_OFFSET(0x16377F60)
#define MOLEMOLE_UICOOPPAGECONTROLLER_BINDBTNS_OFFSET UNITYSDK_OFFSET(0x16377840)
#define MOLEMOLE_UICOOPPAGECONTROLLER_BINDEVENTS_OFFSET UNITYSDK_OFFSET(0x16377E90)
#define MOLEMOLE_UICOOPPAGECONTROLLER_GET_MODEL_OFFSET UNITYSDK_OFFSET(0x16379670)
#define MOLEMOLE_UICOOPPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x16377450)
#define MOLEMOLE_UICOOPPAGECONTROLLER_GOTOMAPQUEST_OFFSET UNITYSDK_OFFSET(0x157D4BA0)
#define MOLEMOLE_UICOOPPAGECONTROLLER_INITSPACELISTDEFAULTINDEX_OFFSET UNITYSDK_OFFSET(0x16377660)
#define MOLEMOLE_UICOOPPAGECONTROLLER_ONCLICKBATTLE_OFFSET UNITYSDK_OFFSET(0x16379A60)
#define MOLEMOLE_UICOOPPAGECONTROLLER_ONCLICKCLUEBOARD_OFFSET UNITYSDK_OFFSET(0x16379C80)
#define MOLEMOLE_UICOOPPAGECONTROLLER_ONCLICKEMOJI_OFFSET UNITYSDK_OFFSET(0x16379DA0)
#define MOLEMOLE_UICOOPPAGECONTROLLER_ONCLICKEQUIP_OFFSET UNITYSDK_OFFSET(0x157D4240)
#define MOLEMOLE_UICOOPPAGECONTROLLER_ONCLICKINFO_OFFSET UNITYSDK_OFFSET(0x157D43D0)
#define MOLEMOLE_UICOOPPAGECONTROLLER_ONCLICKLEVELREWARD_OFFSET UNITYSDK_OFFSET(0x163798D0)
#define MOLEMOLE_UICOOPPAGECONTROLLER_ONCLICKSETTING_OFFSET UNITYSDK_OFFSET(0x16379740)
#define MOLEMOLE_UICOOPPAGECONTROLLER_ONCLICKSTORY_OFFSET UNITYSDK_OFFSET(0x157D4450)
#define MOLEMOLE_UICOOPPAGECONTROLLER_ONCLICKTASK_OFFSET UNITYSDK_OFFSET(0x157D4570)
#define MOLEMOLE_UICOOPPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16377460)
#define MOLEMOLE_UICOOPPAGECONTROLLER_ONLEVELREWARDNOTIFICATIONNODECHANGE_OFFSET UNITYSDK_OFFSET(0x163799F0)
#define MOLEMOLE_UICOOPPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16379510)
#define MOLEMOLE_UICOOPPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x157D4FE0)
#define MOLEMOLE_UICOOPPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x163774F0)
#define MOLEMOLE_UICOOPPAGECONTROLLER_OPENMAP_OFFSET UNITYSDK_OFFSET(0x157D4EA0)
#define MOLEMOLE_UICOOPPAGECONTROLLER_REFRESHCONTRIBUTION_OFFSET UNITYSDK_OFFSET(0x16378940)
#define MOLEMOLE_UICOOPPAGECONTROLLER_REFRESHCOOPLOCK_OFFSET UNITYSDK_OFFSET(0x16379600)
#define MOLEMOLE_UICOOPPAGECONTROLLER_REFRESHCOOPTIPS_OFFSET UNITYSDK_OFFSET(0x163792C0)
#define MOLEMOLE_UICOOPPAGECONTROLLER_REFRESHLEVEL_OFFSET UNITYSDK_OFFSET(0x16378540)
#define MOLEMOLE_UICOOPPAGECONTROLLER_REFRESHREWARDBTN_OFFSET UNITYSDK_OFFSET(0x16378F80)
#define MOLEMOLE_UICOOPPAGECONTROLLER_REFRESHTASK_OFFSET UNITYSDK_OFFSET(0x16378E40)
#define MOLEMOLE_UICOOPPAGECONTROLLER__BINDEVENTS_B__17_0_OFFSET UNITYSDK_OFFSET(0x157D53E0)
#define MOLEMOLE_UICOOPPAGECONTROLLER__BINDEVENTS_B__17_1_OFFSET UNITYSDK_OFFSET(0x157D53F0)
#define MOLEMOLE_UICOOPPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x157D5160)
#define MOLEMOLE_UICOOPPAGECONTROLLER__ONCLICKBATTLE_B__26_0_OFFSET UNITYSDK_OFFSET(0x157D5400)
#define MOLEMOLE_UICOOPPAGECONTROLLER__ONCLICKBATTLE_B__26_1_OFFSET UNITYSDK_OFFSET(0x157D56D0)
#define MOLEMOLE_UICOOPPAGECONTROLLER__ONCLICKBATTLE_B__26_2_OFFSET UNITYSDK_OFFSET(0x157D5460)
#define MOLEMOLE_UICOOPPAGECONTROLLER__ONCLICKCLUEBOARD_B__27_0_OFFSET UNITYSDK_OFFSET(0x157D57A0)
#define MOLEMOLE_UICOOPPAGECONTROLLER__ONCLICKLEVELREWARD_B__16_0_OFFSET UNITYSDK_OFFSET(0x157D5170)
#define MOLEMOLE_UICOOPPAGECONTROLLER__ONCLICKSTORY_B__31_0_OFFSET UNITYSDK_OFFSET(0x157D5A10)
#define MOLEMOLE_UICOOPPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x157D5C80)
#define MOLEMOLE_UICOOPPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x157D5D10)
#define MOLEMOLE_UICOOPPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x157D5DB0)
#define MOLEMOLE_UICOOPPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x157D5DC0)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopPageController_TypeDefinitionIndex = 46612;
	...
	public:
		...
		::Class_2_60638234271CCDB8_50* _view; // 0x320
		::MoleMole::UIActivityCompWeekRewardBtnWidgetController* _rewardBtn; // 0x328
		::MoleMole::MonoGamepadSpaceList* _spaceList; // 0x330
