...
#define MOLEMOLE_UIBOSSBATTLEDATAROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1564BE50)
#define MOLEMOLE_UIBOSSBATTLEDATAROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1564BEC0)
#define MOLEMOLE_UIBOSSBATTLEDATAROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1564BF60)
#define MOLEMOLE_UIBOSSBATTLEDATAROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1564C020)
#define MOLEMOLE_UIBOSSBATTLEDATAROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1564C220)
#define MOLEMOLE_UIBOSSBATTLEDATAROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1564C230)
#define MOLEMOLE_UIBOSSBATTLEDATAROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1564C2D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBossBattleDataRowWidgetController_TypeDefinitionIndex = 41498;
