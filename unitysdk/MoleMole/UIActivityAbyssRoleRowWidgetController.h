...
#define MOLEMOLE_UIACTIVITYABYSSROLEROWWIDGETCONTROLLER_ONCLICKROW_OFFSET UNITYSDK_OFFSET(0x15B77A10)
#define MOLEMOLE_UIACTIVITYABYSSROLEROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15B77450)
#define MOLEMOLE_UIACTIVITYABYSSROLEROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15B77560)
#define MOLEMOLE_UIACTIVITYABYSSROLEROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15B774E0)
#define MOLEMOLE_UIACTIVITYABYSSROLEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15B77280)
#define MOLEMOLE_UIACTIVITYABYSSROLEROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15B773E0)
#define MOLEMOLE_UIACTIVITYABYSSROLEROWWIDGETCONTROLLER_SETROLEINFO_OFFSET UNITYSDK_OFFSET(0x15B776C0)
#define MOLEMOLE_UIACTIVITYABYSSROLEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15B77FC0)
#define MOLEMOLE_UIACTIVITYABYSSROLEROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15B77FD0)
#define MOLEMOLE_UIACTIVITYABYSSROLEROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15B78060)
#define MOLEMOLE_UIACTIVITYABYSSROLEROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15B78100)
#define MOLEMOLE_UIACTIVITYABYSSROLEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15B78190)
#define MOLEMOLE_UIACTIVITYABYSSROLEROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15B78220)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityAbyssRoleRowWidgetController_TypeDefinitionIndex = 37985;

	class UIActivityAbyssRoleRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_A573A65F0E1E9B93* _view; // 0x2E8
		::Class_1_C1067BB4CC216C9A* roleData; // 0x2F0
