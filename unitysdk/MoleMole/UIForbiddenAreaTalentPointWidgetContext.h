...
#define MOLEMOLE_UIFORBIDDENAREATALENTPOINTWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x186B6430)

namespace MoleMole
{
	inline static constexpr unsigned int UIForbiddenAreaTalentPointWidgetContext_TypeDefinitionIndex = 65980;
