...
#define MOLEMOLE_UIFORBIDDENAREATALENTPOINTWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x17713170)

namespace MoleMole
{
	inline static constexpr unsigned int UIForbiddenAreaTalentPointWidgetContext_TypeDefinitionIndex = 63415;
