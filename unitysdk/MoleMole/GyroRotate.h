...
#define MOLEMOLE_GYROROTATE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1DA3DFF0)
#define MOLEMOLE_GYROROTATE_METHOD_6_189C865264480324_OFFSET UNITYSDK_OFFSET(0x1DA3E040)
#define MOLEMOLE_GYROROTATE_METHOD_6_7D3DB889EB40A97B_OFFSET UNITYSDK_OFFSET(0x1DA3E960)
#define MOLEMOLE_GYROROTATE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1DA3DF50)
#define MOLEMOLE_GYROROTATE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1DA3DCB0)
#define MOLEMOLE_GYROROTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA3E8E0)

namespace MoleMole
{
	inline static constexpr unsigned int GyroRotate_TypeDefinitionIndex = 7797;
