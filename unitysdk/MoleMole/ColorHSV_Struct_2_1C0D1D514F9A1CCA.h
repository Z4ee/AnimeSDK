...
#define MOLEMOLE_COLORHSV_STRUCT_2_1C0D1D514F9A1CCA_METHOD_2_0B62749CB8B776DF_OFFSET UNITYSDK_OFFSET(0x707BD0)
#define MOLEMOLE_COLORHSV_STRUCT_2_1C0D1D514F9A1CCA_METHOD_2_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x707AF0)
#define MOLEMOLE_COLORHSV_STRUCT_2_1C0D1D514F9A1CCA__CTOR_OFFSET UNITYSDK_OFFSET(0x5D9040)

namespace MoleMole
{
	inline static constexpr unsigned int ColorHSV_Struct_2_1C0D1D514F9A1CCA_TypeDefinitionIndex = 57757;
