...
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER_GETTEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x1581E0F0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1581CC50)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1581DC10)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1581E550)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1581DCA0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1581CC60)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1581CD80)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__CREATEROWLAYERREWARD_OFFSET UNITYSDK_OFFSET(0x1581E450)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__CREATEROWLAYERTITLE_OFFSET UNITYSDK_OFFSET(0x1581E3A0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1581EC40)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__GAMEPADITEMSUBMIT_OFFSET UNITYSDK_OFFSET(0x1581E960)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__GAMEPADSELECTNAVLISTITEM_OFFSET UNITYSDK_OFFSET(0x1581E630)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__GETCURGAMEPADSELECTROW_OFFSET UNITYSDK_OFFSET(0x1581E9C0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__INITGAMEPADSELECT_OFFSET UNITYSDK_OFFSET(0x1581E1F0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__ONEKEYGETREWARD_OFFSET UNITYSDK_OFFSET(0x1581DD10)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__ONSCROLLEND_OFFSET UNITYSDK_OFFSET(0x1581E360)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__ONSCROLL_OFFSET UNITYSDK_OFFSET(0x1581E2F0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__ONUIOPEN_B__5_0_OFFSET UNITYSDK_OFFSET(0x1581ECB0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__ONUIOPEN_B__5_1_OFFSET UNITYSDK_OFFSET(0x1581ECC0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__UPDATEONEKEYSTATUS_OFFSET UNITYSDK_OFFSET(0x1581D880)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__UPDATEREWARDS_OFFSET UNITYSDK_OFFSET(0x1581CF90)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1581EE70)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1581EF00)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1581EF30)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1581EF40)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1581EF50)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___CREATEROWLAYERREWARD_B__16_0_OFFSET UNITYSDK_OFFSET(0x1581EE60)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___ONEKEYGETREWARD_B__9_0_OFFSET UNITYSDK_OFFSET(0x1581ECD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_RewardV2_PopWindowController_TypeDefinitionIndex = 59977;
	...
	public:
		...
		::Class_2_C6E5760570AAB360* _view; // 0x310
		::Class_2_468A4FBF2E9F527C* _hadalZoneModel; // 0x318
		::System::Collections::Generic::List_1<::MoleMole::UIHadalZone_RewardV2_PopWindowController_HadalRewardData>* listData; // 0x320
		...
		::System::Void __OneKeyGetReward_b__9_0(::Class_3_025FF4981524A424_526* rsp)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_025FF4981524A424_526*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___ONEKEYGETREWARD_B__9_0_OFFSET))(this, rsp);
		}
