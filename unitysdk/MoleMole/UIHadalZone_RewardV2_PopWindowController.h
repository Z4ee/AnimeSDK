...
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER_GETTEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x18ED0F00)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x18ECFA30)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18ED0A10)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x18ED1360)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18ED0AA0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18ECFA40)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18ECFB60)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__CREATEROWLAYERREWARD_OFFSET UNITYSDK_OFFSET(0x18ED1260)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__CREATEROWLAYERTITLE_OFFSET UNITYSDK_OFFSET(0x18ED11B0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18ED1A60)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__GAMEPADITEMSUBMIT_OFFSET UNITYSDK_OFFSET(0x18ED1780)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__GAMEPADSELECTNAVLISTITEM_OFFSET UNITYSDK_OFFSET(0x18ED1440)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__GETCURGAMEPADSELECTROW_OFFSET UNITYSDK_OFFSET(0x18ED17E0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__INITGAMEPADSELECT_OFFSET UNITYSDK_OFFSET(0x18ED1000)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__ONEKEYGETREWARD_OFFSET UNITYSDK_OFFSET(0x18ED0B10)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__ONSCROLLEND_OFFSET UNITYSDK_OFFSET(0x18ED1170)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__ONSCROLL_OFFSET UNITYSDK_OFFSET(0x18ED1100)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__ONUIOPEN_B__5_0_OFFSET UNITYSDK_OFFSET(0x18ED1AD0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__ONUIOPEN_B__5_1_OFFSET UNITYSDK_OFFSET(0x18ED1AE0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__UPDATEONEKEYSTATUS_OFFSET UNITYSDK_OFFSET(0x18ED0690)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__UPDATEREWARDS_OFFSET UNITYSDK_OFFSET(0x18ECFD70)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18ED1C90)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x18ED1D20)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18ED1D50)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18ED1D60)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18ED1D70)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___CREATEROWLAYERREWARD_B__16_0_OFFSET UNITYSDK_OFFSET(0x18ED1C80)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___ONEKEYGETREWARD_B__9_0_OFFSET UNITYSDK_OFFSET(0x18ED1AF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_RewardV2_PopWindowController_TypeDefinitionIndex = 73047;
	...
	public:
		...
		::System::Void __OneKeyGetReward_b__9_0(::Class_3_025FF4981524A424_601* rsp)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_025FF4981524A424_601*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___ONEKEYGETREWARD_B__9_0_OFFSET))(this, rsp);
		}
