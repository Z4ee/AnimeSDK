...
#define MOLEMOLE_UICOOPMATCHMAPROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17F6EDA0)
#define MOLEMOLE_UICOOPMATCHMAPROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17F6EE10)
#define MOLEMOLE_UICOOPMATCHMAPROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17F6F030)
#define MOLEMOLE_UICOOPMATCHMAPROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x17F6F0D0)
#define MOLEMOLE_UICOOPMATCHMAPROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17F6F250)
#define MOLEMOLE_UICOOPMATCHMAPROWWIDGETCONTROLLER__ONCREATEVIEWMODEL_B__3_0_OFFSET UNITYSDK_OFFSET(0x17F6F260)
#define MOLEMOLE_UICOOPMATCHMAPROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17F6F5E0)
#define MOLEMOLE_UICOOPMATCHMAPROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17F6F680)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopMatchMapRowWidgetController_TypeDefinitionIndex = 49483;
