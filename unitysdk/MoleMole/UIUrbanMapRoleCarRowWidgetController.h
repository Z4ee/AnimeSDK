...
#define MOLEMOLE_UIURBANMAPROLECARROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x12C84280)
#define MOLEMOLE_UIURBANMAPROLECARROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x12C842F0)
#define MOLEMOLE_UIURBANMAPROLECARROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x12C843B0)
#define MOLEMOLE_UIURBANMAPROLECARROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12C84580)
#define MOLEMOLE_UIURBANMAPROLECARROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x12C845E0)
#define MOLEMOLE_UIURBANMAPROLECARROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x12C84680)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapRoleCarRowWidgetController_TypeDefinitionIndex = 80970;
