...
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__STARTLEVEL_D__205_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x7FF700)
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__STARTLEVEL_D__205_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x283610)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooPageController__StartLevel_d__205_TypeDefinitionIndex = 40736;
