...
#define MOLEMOLE_UIROLESELECTPAGECONTROLLER___C__DISPLAYCLASS82_0__CTOR_OFFSET UNITYSDK_OFFSET(0x12E1EE40)
#define MOLEMOLE_UIROLESELECTPAGECONTROLLER___C__DISPLAYCLASS82_0__ONSELECTCAMPIDLEACTIVITY_B__0_OFFSET UNITYSDK_OFFSET(0x12E1EE50)
#define MOLEMOLE_UIROLESELECTPAGECONTROLLER___C__DISPLAYCLASS82_0__ONSELECTCAMPIDLEACTIVITY_B__1_OFFSET UNITYSDK_OFFSET(0x12E1EF70)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleSelectPageController___c__DisplayClass82_0_TypeDefinitionIndex = 39211;
