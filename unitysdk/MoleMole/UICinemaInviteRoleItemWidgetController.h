...
#define MOLEMOLE_UICINEMAINVITEROLEITEMWIDGETCONTROLLER_ONCLICKROLEITEM_OFFSET UNITYSDK_OFFSET(0x19580000)
#define MOLEMOLE_UICINEMAINVITEROLEITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1957F4D0)
#define MOLEMOLE_UICINEMAINVITEROLEITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1957F630)
#define MOLEMOLE_UICINEMAINVITEROLEITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1957F560)
#define MOLEMOLE_UICINEMAINVITEROLEITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1957F370)
#define MOLEMOLE_UICINEMAINVITEROLEITEMWIDGETCONTROLLER_REFRESHROLESTATE_OFFSET UNITYSDK_OFFSET(0x1957FA20)
#define MOLEMOLE_UICINEMAINVITEROLEITEMWIDGETCONTROLLER_SETITEMSELECT_OFFSET UNITYSDK_OFFSET(0x19580110)
#define MOLEMOLE_UICINEMAINVITEROLEITEMWIDGETCONTROLLER_SETUICINEMAROLESTATE_OFFSET UNITYSDK_OFFSET(0x1957F770)
#define MOLEMOLE_UICINEMAINVITEROLEITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19580180)
#define MOLEMOLE_UICINEMAINVITEROLEITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19580190)
#define MOLEMOLE_UICINEMAINVITEROLEITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x19580220)
#define MOLEMOLE_UICINEMAINVITEROLEITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x195802C0)
#define MOLEMOLE_UICINEMAINVITEROLEITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19580350)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaInviteRoleItemWidgetController_TypeDefinitionIndex = 54474;
