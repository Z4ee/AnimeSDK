...
#define MOLEMOLE_EXPEDITIONREWARDLISTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15400330)

namespace MoleMole
{
	inline static constexpr unsigned int ExpeditionRewardListContext_TypeDefinitionIndex = 45115;
