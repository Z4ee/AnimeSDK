...
#define MOLEMOLE_CONFIGCHESSENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A077CF0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigChessEntity_TypeDefinitionIndex = 83038;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::Share::GridDir, ::MoleMole::ConfigChessEntity_StateMachineParamsWrapper>* enterMoveState; // 0x18
		::MoleMole::ConfigChessEntity_StateMachineParamsWrapper baseStateParams; // 0x20
