...
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_GET_POSSYNCTARGET_OFFSET UNITYSDK_OFFSET(0x12BCF570)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_GET_STATEPLAYMESSAGE_OFFSET UNITYSDK_OFFSET(0x12BCF660)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_ISTRANSITIONALLOWED_OFFSET UNITYSDK_OFFSET(0x12BCFC50)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_METHOD_7_6E6F865C6BBBA8DD_OFFSET UNITYSDK_OFFSET(0x12BCF780)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_METHOD_7_8DB98345F9A815B2_OFFSET UNITYSDK_OFFSET(0x12BD0220)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_METHOD_7_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x12BD03C0)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_METHOD_7_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x12BCF1F0)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_METHOD_7_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0x12BCFEE0)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x12BCF0F0)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_ONINPUTPOSITION_OFFSET UNITYSDK_OFFSET(0x12BCF240)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_ONSTATEMESSAGE_OFFSET UNITYSDK_OFFSET(0x12BCF6A0)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_PLAYANIMATIONBYSTATE_OFFSET UNITYSDK_OFFSET(0x12BCF980)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x12BD00C0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginSyncEntityPos_TypeDefinitionIndex = 59947;
	...
	public:
		...
		::INapLevel_SyncAvatarPos* Field_7_9; // 0xA0
