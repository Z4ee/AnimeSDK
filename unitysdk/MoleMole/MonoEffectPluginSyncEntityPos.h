...
class INapSyncAvatarPos;
namespace System { class String; }
namespace System::Collections::Generic { template <typename T1, typename T2> class Dictionary_2; }
namespace System::Collections::Generic { template <typename T> class List_1; }
namespace UnityEngine { class Animation; }

#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_GET_POSSYNCTARGET_OFFSET UNITYSDK_OFFSET(0x16059990)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_GET_STATEPLAYMESSAGE_OFFSET UNITYSDK_OFFSET(0x16059A80)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_ISTRANSITIONALLOWED_OFFSET UNITYSDK_OFFSET(0x1605A0A0)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_METHOD_7_6E6F865C6BBBA8DD_OFFSET UNITYSDK_OFFSET(0x16059BA0)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_METHOD_7_8DB98345F9A815B2_OFFSET UNITYSDK_OFFSET(0x1605A670)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_METHOD_7_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1605A810)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_METHOD_7_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x160596D0)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_METHOD_7_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0x1605A330)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x160595D0)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_ONINPUTPOSITION_OFFSET UNITYSDK_OFFSET(0x16059720)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_ONSTATEMESSAGE_OFFSET UNITYSDK_OFFSET(0x16059AC0)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_PLAYANIMATIONBYSTATE_OFFSET UNITYSDK_OFFSET(0x16059DA0)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x1605A510)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginSyncEntityPos_TypeDefinitionIndex = 66087;
	...
	public:
		...
		::INapSyncAvatarPos* Field_7_9; // 0xA0
		...
		::INapSyncAvatarPos* get_posSyncTarget()
		{
			return ((::INapSyncAvatarPos*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_GET_POSSYNCTARGET_OFFSET))(this);
		}
