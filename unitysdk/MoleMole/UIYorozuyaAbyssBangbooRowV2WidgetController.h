...
#define MOLEMOLE_UIYOROZUYAABYSSBANGBOOROWV2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x10A1BE20)
#define MOLEMOLE_UIYOROZUYAABYSSBANGBOOROWV2WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x10A1BF30)
#define MOLEMOLE_UIYOROZUYAABYSSBANGBOOROWV2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x10A1BEB0)
#define MOLEMOLE_UIYOROZUYAABYSSBANGBOOROWV2WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x10A1BDC0)
#define MOLEMOLE_UIYOROZUYAABYSSBANGBOOROWV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x10A1C110)
#define MOLEMOLE_UIYOROZUYAABYSSBANGBOOROWV2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x10A1C120)
#define MOLEMOLE_UIYOROZUYAABYSSBANGBOOROWV2WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x10A1C1B0)
#define MOLEMOLE_UIYOROZUYAABYSSBANGBOOROWV2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x10A1C250)
#define MOLEMOLE_UIYOROZUYAABYSSBANGBOOROWV2WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x10A1C2E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIYorozuyaAbyssBangbooRowV2WidgetController_TypeDefinitionIndex = 82610;

	class UIYorozuyaAbyssBangbooRowV2WidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_72679ED639CF4AB4_1* _view; // 0x2E8
