...
#define MOLEMOLE_UICOMICPAGECONTROLLER___C__DISPLAYCLASS340_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19AA3C20)
#define MOLEMOLE_UICOMICPAGECONTROLLER___C__DISPLAYCLASS340_0__STARTMOVE_B__0_OFFSET UNITYSDK_OFFSET(0x19AA3C30)
#define MOLEMOLE_UICOMICPAGECONTROLLER___C__DISPLAYCLASS340_0__STARTMOVE_B__1_OFFSET UNITYSDK_OFFSET(0x19AA3C60)

namespace MoleMole
{
	inline static constexpr unsigned int UIComicPageController___c__DisplayClass340_0_TypeDefinitionIndex = 87087;
