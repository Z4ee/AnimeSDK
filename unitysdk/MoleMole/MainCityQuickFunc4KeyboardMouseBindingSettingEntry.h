...
#define MOLEMOLE_MAINCITYQUICKFUNC4KEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x10E28FF0)
#define MOLEMOLE_MAINCITYQUICKFUNC4KEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x10E29000)
#define MOLEMOLE_MAINCITYQUICKFUNC4KEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x10E29010)

namespace MoleMole
{
	inline static constexpr unsigned int MainCityQuickFunc4KeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 53365;
