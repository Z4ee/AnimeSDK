...
#define MOLEMOLE_DAILYQUESTSCHEDULEPLANCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A94EB30)

namespace MoleMole
{
	inline static constexpr unsigned int DailyQuestSchedulePlanContext_TypeDefinitionIndex = 52832;
