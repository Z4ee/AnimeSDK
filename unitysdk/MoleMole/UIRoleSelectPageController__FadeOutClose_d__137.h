...
#define MOLEMOLE_UIROLESELECTPAGECONTROLLER__FADEOUTCLOSE_D__137_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x160D99F0)
#define MOLEMOLE_UIROLESELECTPAGECONTROLLER__FADEOUTCLOSE_D__137_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x160D9AF0)
#define MOLEMOLE_UIROLESELECTPAGECONTROLLER__FADEOUTCLOSE_D__137_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x160D9B50)
#define MOLEMOLE_UIROLESELECTPAGECONTROLLER__FADEOUTCLOSE_D__137_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x160D9B00)
#define MOLEMOLE_UIROLESELECTPAGECONTROLLER__FADEOUTCLOSE_D__137_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x160D99E0)
#define MOLEMOLE_UIROLESELECTPAGECONTROLLER__FADEOUTCLOSE_D__137__CTOR_OFFSET UNITYSDK_OFFSET(0x160D99D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleSelectPageController__FadeOutClose_d__137_TypeDefinitionIndex = 47743;
