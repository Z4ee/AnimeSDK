...
#define MOLEMOLE_DEVICESETTINGRAMPREDICATE_GETPREDICATEFLOAT_OFFSET UNITYSDK_OFFSET(0x15A07E60)
#define MOLEMOLE_DEVICESETTINGRAMPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15A07EB0)
#define MOLEMOLE_DEVICESETTINGRAMPREDICATE___BASE_GETPREDICATEFLOAT_OFFSET UNITYSDK_OFFSET(0x15A07F30)

namespace MoleMole
{
	inline static constexpr unsigned int DeviceSettingRAMPredicate_TypeDefinitionIndex = 52034;
