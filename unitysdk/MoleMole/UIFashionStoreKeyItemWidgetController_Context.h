...
#define MOLEMOLE_UIFASHIONSTOREKEYITEMWIDGETCONTROLLER_CONTEXT_GET_FASHIONSTOREKEYDATA_OFFSET UNITYSDK_OFFSET(0x1677EF10)
#define MOLEMOLE_UIFASHIONSTOREKEYITEMWIDGETCONTROLLER_CONTEXT_SET_FASHIONSTOREKEYDATA_OFFSET UNITYSDK_OFFSET(0x1677EF20)
#define MOLEMOLE_UIFASHIONSTOREKEYITEMWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1677EF30)

namespace MoleMole
{
	inline static constexpr unsigned int UIFashionStoreKeyItemWidgetController_Context_TypeDefinitionIndex = 66048;
	...
	public:
		...
		::Class_2_720FD421F092FF93_Class_2_550F633C31EC92A2* _FashionStoreKeyData_k__BackingField; // 0x30
