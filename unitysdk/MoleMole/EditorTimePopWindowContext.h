...
#define MOLEMOLE_EDITORTIMEPOPWINDOWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xE9878F0)

namespace MoleMole
{
	inline static constexpr unsigned int EditorTimePopWindowContext_TypeDefinitionIndex = 72585;
	...
	public:
		...
		::Class_1_83DE381565FB61D2* EditorLayer; // 0x30
		::System::Action_1<::System::Int32>* ApplyCallback; // 0x38
		::System::Collections::Generic::List_1<::System::Int32>* RightList; // 0x40
