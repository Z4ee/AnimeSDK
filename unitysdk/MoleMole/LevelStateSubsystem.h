...
#define MOLEMOLE_LEVELSTATESUBSYSTEM_GETLEVELSTATE_OFFSET UNITYSDK_OFFSET(0x17E841C0)
#define MOLEMOLE_LEVELSTATESUBSYSTEM_REGISTERONLEVELSTAGECHANGED_OFFSET UNITYSDK_OFFSET(0x17E842F0)
#define MOLEMOLE_LEVELSTATESUBSYSTEM_UNREGISTERONLEVELSTAGECHANGED_OFFSET UNITYSDK_OFFSET(0x17E843A0)
#define MOLEMOLE_LEVELSTATESUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x17E84450)

namespace MoleMole
{
	inline static constexpr unsigned int LevelStateSubsystem_TypeDefinitionIndex = 72302;
