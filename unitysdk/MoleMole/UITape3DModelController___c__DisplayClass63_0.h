...
#define MOLEMOLE_UITAPE3DMODELCONTROLLER___C__DISPLAYCLASS63_0__CTOR_OFFSET UNITYSDK_OFFSET(0x12C7C4E0)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER___C__DISPLAYCLASS63_0__TRANSLATE_B__0_OFFSET UNITYSDK_OFFSET(0x12C7C4F0)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER___C__DISPLAYCLASS63_0__TRANSLATE_B__1_OFFSET UNITYSDK_OFFSET(0x12C7C500)

namespace MoleMole
{
	inline static constexpr unsigned int UITape3DModelController___c__DisplayClass63_0_TypeDefinitionIndex = 68361;
