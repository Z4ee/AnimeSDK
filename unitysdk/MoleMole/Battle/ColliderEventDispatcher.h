...
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_AWAKE_OFFSET UNITYSDK_OFFSET(0xECE4490)
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_GET_ISDESTROYED_OFFSET UNITYSDK_OFFSET(0xECE43F0)
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_GET_LAYERMASK_OFFSET UNITYSDK_OFFSET(0xECE4480)
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_GET_OBSERVETAG_OFFSET UNITYSDK_OFFSET(0xECE4420)
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_GET_SELFCOLLIDER_OFFSET UNITYSDK_OFFSET(0xECE4410)
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_METHOD_5_6772AF2CA56C6F2D_OFFSET UNITYSDK_OFFSET(0xECE4650)
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0xECE45A0)
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_ONCOLLISIONEXIT_OFFSET UNITYSDK_OFFSET(0xECE4B50)
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xECE4560)
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xECE4C00)
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0xECE4CB0)
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_SETCOLLIDERENABLE_OFFSET UNITYSDK_OFFSET(0xECE4D60)
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_SET_ISDESTROYED_OFFSET UNITYSDK_OFFSET(0xECE4400)
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_SET_OBSERVETAG_OFFSET UNITYSDK_OFFSET(0xECE4430)
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER__CTOR_OFFSET UNITYSDK_OFFSET(0xECE4DC0)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int ColliderEventDispatcher_TypeDefinitionIndex = 45582;
