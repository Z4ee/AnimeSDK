...
#define MOLEMOLE_BATTLE_ANIMATORBUTTONCONTROL_ADDBOOLEAN_OFFSET UNITYSDK_OFFSET(0x123F9030)
#define MOLEMOLE_BATTLE_ANIMATORBUTTONCONTROL_ADDINTEGER_OFFSET UNITYSDK_OFFSET(0x123F8FC0)
#define MOLEMOLE_BATTLE_ANIMATORBUTTONCONTROL_ADDTRIGGER_OFFSET UNITYSDK_OFFSET(0x123F8F50)
#define MOLEMOLE_BATTLE_ANIMATORBUTTONCONTROL_PROCESSANIMATORPARAMCONTROL_OFFSET UNITYSDK_OFFSET(0x123F90A0)
#define MOLEMOLE_BATTLE_ANIMATORBUTTONCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x123F8F00)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int AnimatorButtonControl_TypeDefinitionIndex = 69533;
