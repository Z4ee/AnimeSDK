...
#define MOLEMOLE_BATTLE_RBDBEHITTRIGGERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xF11D4D0)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int RBDBehitTriggerData_TypeDefinitionIndex = 86511;
