...
#define MOLEMOLE_BATTLE_FIELDINFO_MONSTERINFO_METHOD_2_65585810E2458BA4_OFFSET UNITYSDK_OFFSET(0x7B4930)
#define MOLEMOLE_BATTLE_FIELDINFO_MONSTERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x7B47E0)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int FieldInfo_MonsterInfo_TypeDefinitionIndex = 42045;
