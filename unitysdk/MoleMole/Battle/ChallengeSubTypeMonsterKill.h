...
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL_GETCURRENTCOUNT_OFFSET UNITYSDK_OFFSET(0xFE8B950)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL_GETPROGRESSSTRING_OFFSET UNITYSDK_OFFSET(0xFE8B9E0)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0xFE8B990)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL_GET_ISSUCCESS_OFFSET UNITYSDK_OFFSET(0xFE8B900)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0xFE8BED0)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xFE8BDA0)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL__CREATECOUNTER_OFFSET UNITYSDK_OFFSET(0xFE8BD10)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL__CTOR_OFFSET UNITYSDK_OFFSET(0xFE8B820)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL__INCREASECOUNTER_OFFSET UNITYSDK_OFFSET(0xFE8BAD0)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL__TRYCALCKILLCOUNT_OFFSET UNITYSDK_OFFSET(0xFE8BB60)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL___BASE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0xFE8CD80)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xFE8CE10)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int ChallengeSubTypeMonsterKill_TypeDefinitionIndex = 41240;

	class ChallengeSubTypeMonsterKill : public ::MoleMole::Battle::ChallengeSubTypeItem
	{
	public:
		::System::Collections::Generic::HashSet_1<::System::UInt32>* _countedKills; // 0x20
		::Class_1_A71FF9B2461C0AD1* _hitDataCounter; // 0x28
		::System::Int32 challengeKillCount; // 0x30
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_807*))((::PBYTE)hIl2Cpp + MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL__CTOR_OFFSET))(this, inTemplate);
		}
