...
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL_GETCURRENTCOUNT_OFFSET UNITYSDK_OFFSET(0x12B88610)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL_GETPROGRESSSTRING_OFFSET UNITYSDK_OFFSET(0x12B886A0)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0x12B88650)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL_GET_ISSUCCESS_OFFSET UNITYSDK_OFFSET(0x12B885C0)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x12B88B90)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x12B88A60)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL__CREATECOUNTER_OFFSET UNITYSDK_OFFSET(0x12B889D0)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x12B884E0)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL__INCREASECOUNTER_OFFSET UNITYSDK_OFFSET(0x12B88790)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL__TRYCALCKILLCOUNT_OFFSET UNITYSDK_OFFSET(0x12B88820)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL___BASE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x12B89A30)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x12B89AC0)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int ChallengeSubTypeMonsterKill_TypeDefinitionIndex = 85308;
	...
	public:
		...
		::System::Int32 currentKillCount; // 0x38

		::System::Void _ctor(::Class_2_208CC9941471731A_373* inTemplate)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_373*))((::PBYTE)hIl2Cpp + MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL__CTOR_OFFSET))(this, inTemplate);
		}
