...
#define MOLEMOLE_BATTLE_RBDEFFECTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x13FEF510)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int RBDEffectData_TypeDefinitionIndex = 87478;
