...
#define MOLEMOLE_BATTLE_RBDEFFECTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x141D6590)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int RBDEffectData_TypeDefinitionIndex = 72284;
