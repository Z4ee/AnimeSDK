...
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEOCCUPYINTERACTIVE_GETCURRENTCOUNT_OFFSET UNITYSDK_OFFSET(0xF11AAB0)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEOCCUPYINTERACTIVE_GETPROGRESSSTRING_OFFSET UNITYSDK_OFFSET(0xF11AB50)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEOCCUPYINTERACTIVE_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0xF11AAF0)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEOCCUPYINTERACTIVE_GET_ISSUCCESS_OFFSET UNITYSDK_OFFSET(0xF11AA60)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEOCCUPYINTERACTIVE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0xF11A970)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEOCCUPYINTERACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0xF11A910)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEOCCUPYINTERACTIVE___BASE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0xF11AC30)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int ChallengeSubTypeOccupyInteractive_TypeDefinitionIndex = 75204;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_566*))((::PBYTE)hIl2Cpp + MOLEMOLE_BATTLE_CHALLENGESUBTYPEOCCUPYINTERACTIVE__CTOR_OFFSET))(this, inTemplate);
		}
