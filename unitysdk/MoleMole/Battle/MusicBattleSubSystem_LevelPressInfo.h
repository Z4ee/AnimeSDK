...
#define MOLEMOLE_BATTLE_MUSICBATTLESUBSYSTEM_LEVELPRESSINFO_DOCHECKCLOSEEVADE_OFFSET UNITYSDK_OFFSET(0x1742A260)
#define MOLEMOLE_BATTLE_MUSICBATTLESUBSYSTEM_LEVELPRESSINFO_DOCHECKOPENEVADE_OFFSET UNITYSDK_OFFSET(0x1742A0F0)
#define MOLEMOLE_BATTLE_MUSICBATTLESUBSYSTEM_LEVELPRESSINFO_DOCLOSEINPUT_OFFSET UNITYSDK_OFFSET(0x1742A340)
#define MOLEMOLE_BATTLE_MUSICBATTLESUBSYSTEM_LEVELPRESSINFO_DOHINT_OFFSET UNITYSDK_OFFSET(0x17429F70)
#define MOLEMOLE_BATTLE_MUSICBATTLESUBSYSTEM_LEVELPRESSINFO_DOOPENINPUT_OFFSET UNITYSDK_OFFSET(0x1742A1D0)
#define MOLEMOLE_BATTLE_MUSICBATTLESUBSYSTEM_LEVELPRESSINFO_GETNEEDWAIT_OFFSET UNITYSDK_OFFSET(0x17429F10)
#define MOLEMOLE_BATTLE_MUSICBATTLESUBSYSTEM_LEVELPRESSINFO_GETRESULT_OFFSET UNITYSDK_OFFSET(0x17429D80)
#define MOLEMOLE_BATTLE_MUSICBATTLESUBSYSTEM_LEVELPRESSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1742A3D0)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int MusicBattleSubSystem_LevelPressInfo_TypeDefinitionIndex = 62567;

	class MusicBattleSubSystem_LevelPressInfo : public ::System::Object
	{
	public:
		::System::Double recordClickTime; // 0x10
		::System::Double earliestCheckTime; // 0x18
		::MoleMole::Config::MusicBattleMarkerNodeType nodeType; // 0x20
		::System::Double hintTime; // 0x28
		::System::Boolean needOpenEvadeInput; // 0x30
		::System::Boolean CheckedOpen; // 0x31
		::System::Boolean CheckedClose; // 0x32
		::System::Boolean needCloseEvadeInput; // 0x33
		::MoleMole::LogicButtonInputType inputType; // 0x34
		::System::Double perfectTime; // 0x38
