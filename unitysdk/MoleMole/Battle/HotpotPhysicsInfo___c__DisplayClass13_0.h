...
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x13EBE050)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO___C__DISPLAYCLASS13_0__GENERATEPOINTSINRING_B__0_OFFSET UNITYSDK_OFFSET(0x13EBE060)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int HotpotPhysicsInfo___c__DisplayClass13_0_TypeDefinitionIndex = 67756;

	class HotpotPhysicsInfo___c__DisplayClass13_0 : public ::System::Object
	{
	public:
		::System::Func_2<::UnityEngine::Vector2, ::System::Boolean>* posValidFunc; // 0x10
		::MoleMole::Battle::HotpotPhysicsInfo* __4__this; // 0x18
