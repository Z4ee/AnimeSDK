...
#define MOLEMOLE_BATTLE_MATERIALPROPERTYMODIFIEREXTRAPARAMS_CREATEFROMCONFIG_OFFSET UNITYSDK_OFFSET(0x123FA220)
#define MOLEMOLE_BATTLE_MATERIALPROPERTYMODIFIEREXTRAPARAMS_EQUALS_OFFSET UNITYSDK_OFFSET(0x749AA0)
#define MOLEMOLE_BATTLE_MATERIALPROPERTYMODIFIEREXTRAPARAMS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x749BB0)
#define MOLEMOLE_BATTLE_MATERIALPROPERTYMODIFIEREXTRAPARAMS_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x123F9DD0)
#define MOLEMOLE_BATTLE_MATERIALPROPERTYMODIFIEREXTRAPARAMS_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x123F9EC0)
#define MOLEMOLE_BATTLE_MATERIALPROPERTYMODIFIEREXTRAPARAMS___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x749BC0)
#define MOLEMOLE_BATTLE_MATERIALPROPERTYMODIFIEREXTRAPARAMS___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x749C30)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int MaterialPropertyModifierExtraParams_TypeDefinitionIndex = 52897;
