...
#define MOLEMOLE_BATTLE_XWEAPONTRAILCUSTOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1E91A770)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int XWeaponTrailCustom_TypeDefinitionIndex = 39964;
