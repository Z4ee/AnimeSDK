...
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_ASSUREEDGECOLLIDER_OFFSET UNITYSDK_OFFSET(0xE947730)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_CHECKBOUNDSVALID_OFFSET UNITYSDK_OFFSET(0xE9476F0)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_DRAWCIRCLE_OFFSET UNITYSDK_OFFSET(0xE948FA0)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_DRAWCOLLISIONEDGE_OFFSET UNITYSDK_OFFSET(0xE948620)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_DRAWGENERATEDPOINTS_OFFSET UNITYSDK_OFFSET(0xE9493A0)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_GENERATECOLLISIONAREA_OFFSET UNITYSDK_OFFSET(0xE9478B0)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_GENERATEPOINTSINRING_1_OFFSET UNITYSDK_OFFSET(0xE947CE0)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_GENERATEPOINTSINRING_OFFSET UNITYSDK_OFFSET(0xE947C20)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_GETCIRCLEPOINT_OFFSET UNITYSDK_OFFSET(0xE949560)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_GETFOODAABB_OFFSET UNITYSDK_OFFSET(0xE9484C0)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_GETWORLDRADIUS_OFFSET UNITYSDK_OFFSET(0xE949640)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_ISFOODINCIRCLE_OFFSET UNITYSDK_OFFSET(0xE948000)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_ISFOODOUTOFCIRCLE_OFFSET UNITYSDK_OFFSET(0xE948200)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_ISINBOUND_OFFSET UNITYSDK_OFFSET(0xE947F90)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_ISINCIRCLE_OFFSET UNITYSDK_OFFSET(0xE9483E0)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xE948570)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xE949820)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int HotpotPhysicsInfo_TypeDefinitionIndex = 67755;
