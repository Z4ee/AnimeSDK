...
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_ASSUREEDGECOLLIDER_OFFSET UNITYSDK_OFFSET(0xFAE3470)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_CHECKBOUNDSVALID_OFFSET UNITYSDK_OFFSET(0xFAE3430)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_DRAWCIRCLE_OFFSET UNITYSDK_OFFSET(0xFAE4CD0)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_DRAWCOLLISIONEDGE_OFFSET UNITYSDK_OFFSET(0xFAE4350)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_DRAWGENERATEDPOINTS_OFFSET UNITYSDK_OFFSET(0xFAE50D0)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_GENERATECOLLISIONAREA_OFFSET UNITYSDK_OFFSET(0xFAE35F0)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_GENERATEPOINTSINRING_1_OFFSET UNITYSDK_OFFSET(0xFAE3A20)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_GENERATEPOINTSINRING_OFFSET UNITYSDK_OFFSET(0xFAE3960)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_GETCIRCLEPOINT_OFFSET UNITYSDK_OFFSET(0xFAE5290)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_GETFOODAABB_OFFSET UNITYSDK_OFFSET(0xFAE41F0)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_GETWORLDRADIUS_OFFSET UNITYSDK_OFFSET(0xFAE5370)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_ISFOODINCIRCLE_OFFSET UNITYSDK_OFFSET(0xFAE3D30)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_ISFOODOUTOFCIRCLE_OFFSET UNITYSDK_OFFSET(0xFAE3F30)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_ISINBOUND_OFFSET UNITYSDK_OFFSET(0xFAE3CC0)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_ISINCIRCLE_OFFSET UNITYSDK_OFFSET(0xFAE4110)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xFAE42A0)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xFAE5550)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int HotpotPhysicsInfo_TypeDefinitionIndex = 61103;
