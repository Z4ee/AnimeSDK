...
#define MOLEMOLE_BATTLE_MONOSTEERNEAR_GETWEIGHT_OFFSET UNITYSDK_OFFSET(0x11C85D40)
#define MOLEMOLE_BATTLE_MONOSTEERNEAR_ONSTEERCREATE_OFFSET UNITYSDK_OFFSET(0x11C85C30)
#define MOLEMOLE_BATTLE_MONOSTEERNEAR__CTOR_OFFSET UNITYSDK_OFFSET(0x11C85E40)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int MonoSteerNear_TypeDefinitionIndex = 56691;
