...
#define MOLEMOLE_BATTLE_FIELDINFO_EVENTINFO___C_METHOD_1_29C35AC68C60BE89_OFFSET UNITYSDK_OFFSET(0x12C4C190)
#define MOLEMOLE_BATTLE_FIELDINFO_EVENTINFO___C_METHOD_1_EA832B32C7C17B2D_1_OFFSET UNITYSDK_OFFSET(0x12C4C210)
#define MOLEMOLE_BATTLE_FIELDINFO_EVENTINFO___C_METHOD_1_EA832B32C7C17B2D_OFFSET UNITYSDK_OFFSET(0x12C4C1F0)
#define MOLEMOLE_BATTLE_FIELDINFO_EVENTINFO___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x12C4C140)
#define MOLEMOLE_BATTLE_FIELDINFO_EVENTINFO___C__CTOR_OFFSET UNITYSDK_OFFSET(0x12C4C180)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int FieldInfo_EventInfo___c_TypeDefinitionIndex = 81536;
	...
	public:
		...
		{
			return (::System::Comparison_1<::MoleMole::Battle::FieldInfo_EventInfo_K_Count>**)Il2CppClass::FromTypeDefinitionIndex(FieldInfo_EventInfo___c_TypeDefinitionIndex)->GetStaticField(0x3C080);
		}
		static ::MoleMole::Battle::FieldInfo_EventInfo___c** StaticGet___9()
		{
			return (::MoleMole::Battle::FieldInfo_EventInfo___c**)Il2CppClass::FromTypeDefinitionIndex(FieldInfo_EventInfo___c_TypeDefinitionIndex)->GetStaticField(0x3C088);
		}
		static ::System::Comparison_1<::MoleMole::Battle::FieldInfo_EventInfo_K_Count>** StaticGet___9__7_0()
		{
			return (::System::Comparison_1<::MoleMole::Battle::FieldInfo_EventInfo_K_Count>**)Il2CppClass::FromTypeDefinitionIndex(FieldInfo_EventInfo___c_TypeDefinitionIndex)->GetStaticField(0x3C090);
		}
		static ::System::Comparison_1<::MoleMole::Battle::FieldInfo_EventInfo_K_Count>** StaticGet___9__13_0()
		{
			return (::System::Comparison_1<::MoleMole::Battle::FieldInfo_EventInfo_K_Count>**)Il2CppClass::FromTypeDefinitionIndex(FieldInfo_EventInfo___c_TypeDefinitionIndex)->GetStaticField(0x3C098);
		}
