...
#define MOLEMOLE_BATTLE_ENTITY_GET_ISAUTHORITY_OFFSET UNITYSDK_OFFSET(0x11C84EC0)
#define MOLEMOLE_BATTLE_ENTITY_GET_ISDISABLE_OFFSET UNITYSDK_OFFSET(0x11C85410)
#define MOLEMOLE_BATTLE_ENTITY_GET_ROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x11C84EB0)
#define MOLEMOLE_BATTLE_ENTITY_GET_ROOT_OFFSET UNITYSDK_OFFSET(0x11C84D30)
#define MOLEMOLE_BATTLE_ENTITY_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x11C85510)
#define MOLEMOLE_BATTLE_ENTITY_SETAUTHORITY_OFFSET UNITYSDK_OFFSET(0x11C84ED0)
#define MOLEMOLE_BATTLE_ENTITY_SETDISABLEBYALIVESTATUS_OFFSET UNITYSDK_OFFSET(0x11C85470)
#define MOLEMOLE_BATTLE_ENTITY_SETDISABLEBYNET_OFFSET UNITYSDK_OFFSET(0x11C854C0)
#define MOLEMOLE_BATTLE_ENTITY_SET_ROOT_OFFSET UNITYSDK_OFFSET(0x11C84D40)
#define MOLEMOLE_BATTLE_ENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x11C85740)
#define MOLEMOLE_BATTLE_ENTITY___BASE_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x11C857B0)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int Entity_TypeDefinitionIndex = 44140;
	...
	public:
		...
		::System::Boolean _isDisableByNet; // 0x50
		::System::Boolean _isAuthority; // 0x51
