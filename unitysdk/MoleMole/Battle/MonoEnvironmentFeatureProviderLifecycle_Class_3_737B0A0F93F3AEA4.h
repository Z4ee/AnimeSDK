...
#define MOLEMOLE_BATTLE_MONOENVIRONMENTFEATUREPROVIDERLIFECYCLE_CLASS_3_737B0A0F93F3AEA4_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x11C85B90)
#define MOLEMOLE_BATTLE_MONOENVIRONMENTFEATUREPROVIDERLIFECYCLE_CLASS_3_737B0A0F93F3AEA4_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11C85C20)
#define MOLEMOLE_BATTLE_MONOENVIRONMENTFEATUREPROVIDERLIFECYCLE_CLASS_3_737B0A0F93F3AEA4_INVOKE_OFFSET UNITYSDK_OFFSET(0x11C85850)
#define MOLEMOLE_BATTLE_MONOENVIRONMENTFEATUREPROVIDERLIFECYCLE_CLASS_3_737B0A0F93F3AEA4__CTOR_OFFSET UNITYSDK_OFFSET(0x11C85840)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int MonoEnvironmentFeatureProviderLifecycle_Class_3_737B0A0F93F3AEA4_TypeDefinitionIndex = 71208;
