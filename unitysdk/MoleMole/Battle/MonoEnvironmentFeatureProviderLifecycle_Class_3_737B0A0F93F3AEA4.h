...
#define MOLEMOLE_BATTLE_MONOENVIRONMENTFEATUREPROVIDERLIFECYCLE_CLASS_3_737B0A0F93F3AEA4_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x14E00FB0)
#define MOLEMOLE_BATTLE_MONOENVIRONMENTFEATUREPROVIDERLIFECYCLE_CLASS_3_737B0A0F93F3AEA4_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x14E01040)
#define MOLEMOLE_BATTLE_MONOENVIRONMENTFEATUREPROVIDERLIFECYCLE_CLASS_3_737B0A0F93F3AEA4_INVOKE_OFFSET UNITYSDK_OFFSET(0x14E00C50)
#define MOLEMOLE_BATTLE_MONOENVIRONMENTFEATUREPROVIDERLIFECYCLE_CLASS_3_737B0A0F93F3AEA4__CTOR_OFFSET UNITYSDK_OFFSET(0x14E00F90)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int MonoEnvironmentFeatureProviderLifecycle_Class_3_737B0A0F93F3AEA4_TypeDefinitionIndex = 55925;
