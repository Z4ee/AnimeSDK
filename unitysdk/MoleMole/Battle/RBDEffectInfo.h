...
#define MOLEMOLE_BATTLE_RBDEFFECTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xFAE56B0)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int RBDEffectInfo_TypeDefinitionIndex = 74677;
