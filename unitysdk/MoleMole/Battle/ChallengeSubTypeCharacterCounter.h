...
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPECHARACTERCOUNTER_GETCURRENTCOUNT_OFFSET UNITYSDK_OFFSET(0x1358C2B0)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPECHARACTERCOUNTER_GETPROGRESSSTRING_OFFSET UNITYSDK_OFFSET(0x1358C340)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPECHARACTERCOUNTER_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0x1358C2F0)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPECHARACTERCOUNTER_GET_ISSUCCESS_OFFSET UNITYSDK_OFFSET(0x1358C260)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPECHARACTERCOUNTER_ONANIMATORZONETAGCHANGED_OFFSET UNITYSDK_OFFSET(0x1358C220)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPECHARACTERCOUNTER_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x1358B6D0)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPECHARACTERCOUNTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1358B5A0)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPECHARACTERCOUNTER__LISTENHITCALLBACK_OFFSET UNITYSDK_OFFSET(0x1358BDD0)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPECHARACTERCOUNTER__ONANIMATORZONECHANGED_OFFSET UNITYSDK_OFFSET(0x1358C080)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPECHARACTERCOUNTER__UNLISTENHITCALLBACK_OFFSET UNITYSDK_OFFSET(0x1358BED0)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPECHARACTERCOUNTER___BASE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x1358C430)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int ChallengeSubTypeCharacterCounter_TypeDefinitionIndex = 48538;

	class ChallengeSubTypeCharacterCounter : public ::MoleMole::Battle::ChallengeSubTypeItem
	{
	public:
		::MoleMole::Battle::Entity* _curAvatar; // 0x20
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_2_E275F6568FBD98FA*>* _cacheSkillSource; // 0x28
		::MoleMole::Battle::Entity* _listenEntity; // 0x30
		::System::Single _lastCalcTime; // 0x38
		::System::Int32 _currentCount; // 0x3C
		::System::Boolean _isInListen; // 0x40
		::System::Int32 _challengeCount; // 0x44
		::MoleMole::Battle::ChallengeSubTypeCharacterCounter_StatusTypeCounter counterType; // 0x48
		::System::UInt32 _attackerID; // 0x4C

		::System::Void _ctor(::Class_2_208CC9941471731A_373* inTemplate)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_373*))((::PBYTE)hIl2Cpp + MOLEMOLE_BATTLE_CHALLENGESUBTYPECHARACTERCOUNTER__CTOR_OFFSET))(this, inTemplate);
		}
