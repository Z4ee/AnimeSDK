...
#define MOLEMOLE_BATTLE_LEVELENVIRONMENTFEATURESUBSYSTEM_INNERPULLDATASERVICE_GET_PULLDATA_OFFSET UNITYSDK_OFFSET(0xFAE5600)
#define MOLEMOLE_BATTLE_LEVELENVIRONMENTFEATURESUBSYSTEM_INNERPULLDATASERVICE_SET_PULLDATA_OFFSET UNITYSDK_OFFSET(0xFAE5610)
#define MOLEMOLE_BATTLE_LEVELENVIRONMENTFEATURESUBSYSTEM_INNERPULLDATASERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xFAE5620)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int LevelEnvironmentFeatureSubsystem_InnerPullDataService_TypeDefinitionIndex = 70897;
