...
#define MOLEMOLE_UIINLEVELHOLLOWCARDOPTIONSDIALOGV2POPWINDOWCONTROLLER_GETCOMBINECARDCTRL_OFFSET UNITYSDK_OFFSET(0x177D2270)
#define MOLEMOLE_UIINLEVELHOLLOWCARDOPTIONSDIALOGV2POPWINDOWCONTROLLER_ONCOMBINECARDCREATE_OFFSET UNITYSDK_OFFSET(0x177D2180)
#define MOLEMOLE_UIINLEVELHOLLOWCARDOPTIONSDIALOGV2POPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x177D2310)
#define MOLEMOLE_UIINLEVELHOLLOWCARDOPTIONSDIALOGV2POPWINDOWCONTROLLER_SCROLLWIDGETFUNC_OFFSET UNITYSDK_OFFSET(0x177D20D0)
#define MOLEMOLE_UIINLEVELHOLLOWCARDOPTIONSDIALOGV2POPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x177D2710)
#define MOLEMOLE_UIINLEVELHOLLOWCARDOPTIONSDIALOGV2POPWINDOWCONTROLLER___BASE_GETCOMBINECARDCTRL_OFFSET UNITYSDK_OFFSET(0x177D2770)
#define MOLEMOLE_UIINLEVELHOLLOWCARDOPTIONSDIALOGV2POPWINDOWCONTROLLER___BASE_ONCOMBINECARDCREATE_OFFSET UNITYSDK_OFFSET(0x177D2860)
#define MOLEMOLE_UIINLEVELHOLLOWCARDOPTIONSDIALOGV2POPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x177D28F0)
#define MOLEMOLE_UIINLEVELHOLLOWCARDOPTIONSDIALOGV2POPWINDOWCONTROLLER___BASE_SCROLLWIDGETFUNC_OFFSET UNITYSDK_OFFSET(0x177D2900)

namespace MoleMole
{
	inline static constexpr unsigned int UIInlevelHollowCardOptionsDialogV2PopWindowController_TypeDefinitionIndex = 49549;
