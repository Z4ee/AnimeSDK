...
#define MOLEMOLE_UICOOPHISTORYTABWIDGETCONTROLLER_DOCLICK_OFFSET UNITYSDK_OFFSET(0x172E1FF0)
#define MOLEMOLE_UICOOPHISTORYTABWIDGETCONTROLLER_GETTIMETEXT_OFFSET UNITYSDK_OFFSET(0x172E1700)
#define MOLEMOLE_UICOOPHISTORYTABWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x172E15F0)
#define MOLEMOLE_UICOOPHISTORYTABWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x172E1660)
#define MOLEMOLE_UICOOPHISTORYTABWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x172E1EF0)
#define MOLEMOLE_UICOOPHISTORYTABWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x172E1A80)
#define MOLEMOLE_UICOOPHISTORYTABWIDGETCONTROLLER_SETWEAKFOCUSANIM_OFFSET UNITYSDK_OFFSET(0x172E20B0)
#define MOLEMOLE_UICOOPHISTORYTABWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x172E2250)
#define MOLEMOLE_UICOOPHISTORYTABWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x172E2260)
#define MOLEMOLE_UICOOPHISTORYTABWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x172E2300)
#define MOLEMOLE_UICOOPHISTORYTABWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x172E2390)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopHistoryTabWidgetController_TypeDefinitionIndex = 48738;
