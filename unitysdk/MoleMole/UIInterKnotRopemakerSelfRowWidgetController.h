...
#define MOLEMOLE_UIINTERKNOTROPEMAKERSELFROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17C163B0)
#define MOLEMOLE_UIINTERKNOTROPEMAKERSELFROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17C164E0)
#define MOLEMOLE_UIINTERKNOTROPEMAKERSELFROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17C16440)
#define MOLEMOLE_UIINTERKNOTROPEMAKERSELFROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17C162E0)
#define MOLEMOLE_UIINTERKNOTROPEMAKERSELFROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17C16340)
#define MOLEMOLE_UIINTERKNOTROPEMAKERSELFROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17C17080)
#define MOLEMOLE_UIINTERKNOTROPEMAKERSELFROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17C17090)
#define MOLEMOLE_UIINTERKNOTROPEMAKERSELFROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17C17120)
#define MOLEMOLE_UIINTERKNOTROPEMAKERSELFROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17C171C0)
#define MOLEMOLE_UIINTERKNOTROPEMAKERSELFROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17C17250)
#define MOLEMOLE_UIINTERKNOTROPEMAKERSELFROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17C172E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotRopemakerSelfRowWidgetController_TypeDefinitionIndex = 86980;
