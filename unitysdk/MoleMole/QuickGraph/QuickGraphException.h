...
#define MOLEMOLE_QUICKGRAPH_QUICKGRAPHEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E5B25D0)
#define MOLEMOLE_QUICKGRAPH_QUICKGRAPHEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E5B26E0)
#define MOLEMOLE_QUICKGRAPH_QUICKGRAPHEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1E5B27C0)
#define MOLEMOLE_QUICKGRAPH_QUICKGRAPHEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5B24D0)

namespace MoleMole::QuickGraph
{
	inline static constexpr unsigned int QuickGraphException_TypeDefinitionIndex = 28036;
