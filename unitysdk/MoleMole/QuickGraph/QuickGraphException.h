...
#define MOLEMOLE_QUICKGRAPH_QUICKGRAPHEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C265770)
#define MOLEMOLE_QUICKGRAPH_QUICKGRAPHEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C265880)
#define MOLEMOLE_QUICKGRAPH_QUICKGRAPHEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C265960)
#define MOLEMOLE_QUICKGRAPH_QUICKGRAPHEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C265670)

namespace MoleMole::QuickGraph
{
	inline static constexpr unsigned int QuickGraphException_TypeDefinitionIndex = 25584;
