...
#define MOLEMOLE_QUICKGRAPH_NONACYCLICGRAPHEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C2656F0)
#define MOLEMOLE_QUICKGRAPH_NONACYCLICGRAPHEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C2657F0)
#define MOLEMOLE_QUICKGRAPH_NONACYCLICGRAPHEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C265910)
#define MOLEMOLE_QUICKGRAPH_NONACYCLICGRAPHEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2655F0)

namespace MoleMole::QuickGraph
{
	inline static constexpr unsigned int NonAcyclicGraphException_TypeDefinitionIndex = 25804;
