...
#define MOLEMOLE_QUICKGRAPH_NONACYCLICGRAPHEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F9BDE40)
#define MOLEMOLE_QUICKGRAPH_NONACYCLICGRAPHEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1F9BDF40)
#define MOLEMOLE_QUICKGRAPH_NONACYCLICGRAPHEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1F9BE060)
#define MOLEMOLE_QUICKGRAPH_NONACYCLICGRAPHEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1F9BDD40)

namespace MoleMole::QuickGraph
{
	inline static constexpr unsigned int NonAcyclicGraphException_TypeDefinitionIndex = 28842;
