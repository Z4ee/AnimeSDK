...
{
	inline static constexpr unsigned int SourceFirstBidirectionalTopologicalSortAlgorithm_2_TypeDefinitionIndex = 28650;

	template <typename TVertex, typename TEdge>
	class SourceFirstBidirectionalTopologicalSortAlgorithm_2 : public ::MoleMole::QuickGraph::Algorithm::AlgorithmBase_1<::Class_0_16E4307DCC41950C_6<TVertex, TEdge>*>
	{
	public:
