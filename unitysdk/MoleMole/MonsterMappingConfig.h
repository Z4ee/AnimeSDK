...
#define MOLEMOLE_MONSTERMAPPINGCONFIG_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1783C0A0)
#define MOLEMOLE_MONSTERMAPPINGCONFIG_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1783BEA0)
#define MOLEMOLE_MONSTERMAPPINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1783C340)
#define MOLEMOLE_MONSTERMAPPINGCONFIG___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1783C4A0)
#define MOLEMOLE_MONSTERMAPPINGCONFIG___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1783C4B0)

namespace MoleMole
{
	inline static constexpr unsigned int MonsterMappingConfig_TypeDefinitionIndex = 73264;
