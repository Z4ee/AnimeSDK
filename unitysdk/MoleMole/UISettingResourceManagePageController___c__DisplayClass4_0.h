...
#define MOLEMOLE_UISETTINGRESOURCEMANAGEPAGECONTROLLER___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0x137852B0)
#define MOLEMOLE_UISETTINGRESOURCEMANAGEPAGECONTROLLER___C__DISPLAYCLASS4_0__ONUIINIT_B__10_OFFSET UNITYSDK_OFFSET(0x137852C0)

namespace MoleMole
{
	inline static constexpr unsigned int UISettingResourceManagePageController___c__DisplayClass4_0_TypeDefinitionIndex = 43664;
