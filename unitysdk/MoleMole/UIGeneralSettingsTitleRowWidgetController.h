...
#define MOLEMOLE_UIGENERALSETTINGSTITLEROWWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x162CB540)
#define MOLEMOLE_UIGENERALSETTINGSTITLEROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x162CB5E0)
#define MOLEMOLE_UIGENERALSETTINGSTITLEROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x162CB670)
#define MOLEMOLE_UIGENERALSETTINGSTITLEROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x162CB410)
#define MOLEMOLE_UIGENERALSETTINGSTITLEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x162CB6F0)
#define MOLEMOLE_UIGENERALSETTINGSTITLEROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x162CB750)
#define MOLEMOLE_UIGENERALSETTINGSTITLEROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x162CB7E0)
#define MOLEMOLE_UIGENERALSETTINGSTITLEROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x162CB870)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralSettingsTitleRowWidgetController_TypeDefinitionIndex = 41056;

	class UIGeneralSettingsTitleRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_0096754AC2F6E253_3* _view; // 0x2B8
		::System::String* _smallTitleTextCode; // 0x2C0
		::System::String* _smallTitleEnTextCode; // 0x2C8
