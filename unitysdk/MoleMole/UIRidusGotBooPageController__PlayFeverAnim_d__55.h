...
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__PLAYFEVERANIM_D__55_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x816F70)
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__PLAYFEVERANIM_D__55_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooPageController__PlayFeverAnim_d__55_TypeDefinitionIndex = 91514;
	...
	struct alignas(8) UIRidusGotBooPageController__PlayFeverAnim_d__55
	{
		...
		::System::Collections::Generic::List_1<::System::Int32>* _animsList_5__2; // 0x30
