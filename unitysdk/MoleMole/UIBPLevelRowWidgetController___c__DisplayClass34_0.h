...
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER___C__DISPLAYCLASS34_0__CTOR_OFFSET UNITYSDK_OFFSET(0x156331A0)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER___C__DISPLAYCLASS34_0__STARTSECONDINCREASE_B__1_OFFSET UNITYSDK_OFFSET(0x156331B0)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER___C__DISPLAYCLASS34_0__STARTSECONDINCREASE_B__2_OFFSET UNITYSDK_OFFSET(0x156332E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBPLevelRowWidgetController___c__DisplayClass34_0_TypeDefinitionIndex = 78159;
