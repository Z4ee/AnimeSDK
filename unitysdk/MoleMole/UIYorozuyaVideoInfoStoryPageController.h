...
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_GETYOROZUYAVIDEOURL_OFFSET UNITYSDK_OFFSET(0x15151E20)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_GET_ISSHOW2DUI_OFFSET UNITYSDK_OFFSET(0x15152760)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1514ED30)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1514F2E0)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1514F610)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1514ED40)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_OVERRIDELOOPTEXT_OFFSET UNITYSDK_OFFSET(0x15151AC0)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_PLAYMAPLOGO_OFFSET UNITYSDK_OFFSET(0x15152610)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_REFRESHPROGRESS_OFFSET UNITYSDK_OFFSET(0x15150E80)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_REFRESHRECOMMENDEDHITTYPES_OFFSET UNITYSDK_OFFSET(0x15151290)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_REFRESHVIDEOVIEW_OFFSET UNITYSDK_OFFSET(0x15152270)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_SETCOMPLEXITYINFO_OFFSET UNITYSDK_OFFSET(0x151506C0)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_SETLEVELINFO_OFFSET UNITYSDK_OFFSET(0x15151850)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_SETNOISE_OFFSET UNITYSDK_OFFSET(0x1514F3C0)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_SETVIDEINFO_OFFSET UNITYSDK_OFFSET(0x151509B0)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_SET_ISSHOW2DUI_OFFSET UNITYSDK_OFFSET(0x15152750)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_UPDATELEFTVIEW_OFFSET UNITYSDK_OFFSET(0x1514F870)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15152770)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER__REFRESHVIDEOVIEW_B__15_0_OFFSET UNITYSDK_OFFSET(0x151528E0)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER__SETCOMPLEXITYINFO_G__SETTIMECOST_10_0_OFFSET UNITYSDK_OFFSET(0x15151D20)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER__SETVIDEINFO_B__11_0_OFFSET UNITYSDK_OFFSET(0x151528A0)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER__VIDEOPLAYER_PREPARECOMPLETED_OFFSET UNITYSDK_OFFSET(0x1514F370)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x151528F0)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15152980)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15152A10)

namespace MoleMole
{
	inline static constexpr unsigned int UIYorozuyaVideoInfoStoryPageController_TypeDefinitionIndex = 44882;
	...
	public:
		...
		::Class_2_79F6D62CE30E3F8E_10* _view; // 0x2C0
		...
		::Class_1_F24A790D52CF0024* _selectQuestInfo; // 0x388
		::Class_2_696E0C6E8A7D9C84* questModel; // 0x390
		::Class_2_47BEEACD66EA947F* _yorozuyaModel; // 0x398
		::Il2CppArray<::Class_2_1A39E1B51756BF41*>* _rewardTypeIcons; // 0x3A0
		::Class_2_0A55B5A82A61DAFA_2* _selectQuestConfig; // 0x3A8
