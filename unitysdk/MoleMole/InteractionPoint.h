...
#define MOLEMOLE_INTERACTIONPOINT_GETINTERACTDIRECTION_OFFSET UNITYSDK_OFFSET(0x16CB0CF0)
#define MOLEMOLE_INTERACTIONPOINT_GETPOINTPOS_OFFSET UNITYSDK_OFFSET(0x16CB0B00)
#define MOLEMOLE_INTERACTIONPOINT_GET_ACCURATE_OFFSET UNITYSDK_OFFSET(0x16CB0FA0)
#define MOLEMOLE_INTERACTIONPOINT_GET_MAXANGLE_OFFSET UNITYSDK_OFFSET(0x16CB0FC0)
#define MOLEMOLE_INTERACTIONPOINT_GET_MINANGLE_OFFSET UNITYSDK_OFFSET(0x16CB0FB0)
#define MOLEMOLE_INTERACTIONPOINT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x16CB0AC0)
#define MOLEMOLE_INTERACTIONPOINT_GET_RANGE_OFFSET UNITYSDK_OFFSET(0x16CB0FE0)
#define MOLEMOLE_INTERACTIONPOINT_GET_USENAVMESH_OFFSET UNITYSDK_OFFSET(0x16CB0FD0)
#define MOLEMOLE_INTERACTIONPOINT_METHOD_1_40E490E2772D5D75_OFFSET UNITYSDK_OFFSET(0x16CB0FF0)
#define MOLEMOLE_INTERACTIONPOINT_SET_NAME_OFFSET UNITYSDK_OFFSET(0x16CB0AD0)
#define MOLEMOLE_INTERACTIONPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x16CB0AE0)

namespace MoleMole
{
	inline static constexpr unsigned int InteractionPoint_TypeDefinitionIndex = 60709;
