...
#define MOLEMOLE_INTERACTIONPOINT_GETINTERACTDIRECTION_OFFSET UNITYSDK_OFFSET(0x13A94CE0)
#define MOLEMOLE_INTERACTIONPOINT_GETPOINTPOS_OFFSET UNITYSDK_OFFSET(0x13A94AF0)
#define MOLEMOLE_INTERACTIONPOINT_GET_ACCURATE_OFFSET UNITYSDK_OFFSET(0x13A94F80)
#define MOLEMOLE_INTERACTIONPOINT_GET_MAXANGLE_OFFSET UNITYSDK_OFFSET(0x13A94FA0)
#define MOLEMOLE_INTERACTIONPOINT_GET_MINANGLE_OFFSET UNITYSDK_OFFSET(0x13A94F90)
#define MOLEMOLE_INTERACTIONPOINT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x13A94AB0)
#define MOLEMOLE_INTERACTIONPOINT_GET_RANGE_OFFSET UNITYSDK_OFFSET(0x13A94FC0)
#define MOLEMOLE_INTERACTIONPOINT_GET_USENAVMESH_OFFSET UNITYSDK_OFFSET(0x13A94FB0)
#define MOLEMOLE_INTERACTIONPOINT_METHOD_1_40E490E2772D5D75_OFFSET UNITYSDK_OFFSET(0x13A94FD0)
#define MOLEMOLE_INTERACTIONPOINT_SET_NAME_OFFSET UNITYSDK_OFFSET(0x13A94AC0)
#define MOLEMOLE_INTERACTIONPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x13A94AD0)

namespace MoleMole
{
	inline static constexpr unsigned int InteractionPoint_TypeDefinitionIndex = 60835;
