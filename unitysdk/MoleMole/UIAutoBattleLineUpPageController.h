...
#define MOLEMOLE_UIAUTOBATTLELINEUPPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1866E6F0)
#define MOLEMOLE_UIAUTOBATTLELINEUPPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1866E700)
#define MOLEMOLE_UIAUTOBATTLELINEUPPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1866E770)
#define MOLEMOLE_UIAUTOBATTLELINEUPPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1866E830)
#define MOLEMOLE_UIAUTOBATTLELINEUPPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1866E8D0)
#define MOLEMOLE_UIAUTOBATTLELINEUPPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1866EAD0)
#define MOLEMOLE_UIAUTOBATTLELINEUPPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1866EAE0)
#define MOLEMOLE_UIAUTOBATTLELINEUPPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1866EB80)
#define MOLEMOLE_UIAUTOBATTLELINEUPPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1866EB90)

namespace MoleMole
{
	inline static constexpr unsigned int UIAutoBattleLineUpPageController_TypeDefinitionIndex = 73889;
