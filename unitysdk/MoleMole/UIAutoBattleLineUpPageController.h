...
#define MOLEMOLE_UIAUTOBATTLELINEUPPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1B705650)
#define MOLEMOLE_UIAUTOBATTLELINEUPPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B705660)
#define MOLEMOLE_UIAUTOBATTLELINEUPPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B7056D0)
#define MOLEMOLE_UIAUTOBATTLELINEUPPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1B705790)
#define MOLEMOLE_UIAUTOBATTLELINEUPPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1B705830)
#define MOLEMOLE_UIAUTOBATTLELINEUPPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B705A30)
#define MOLEMOLE_UIAUTOBATTLELINEUPPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B705A40)
#define MOLEMOLE_UIAUTOBATTLELINEUPPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1B705AE0)
#define MOLEMOLE_UIAUTOBATTLELINEUPPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1B705AF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAutoBattleLineUpPageController_TypeDefinitionIndex = 90240;
