...
#define MOLEMOLE_UIQUESTIONSANSWERCHATPLAYCONTEXT_VALID_OFFSET UNITYSDK_OFFSET(0x17E16800)
#define MOLEMOLE_UIQUESTIONSANSWERCHATPLAYCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x17E16870)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerChatPlayContext_TypeDefinitionIndex = 78500;
	...
	public:
		...
		::System::Boolean DetailUIMode; // 0x44
		::System::Int32 CurrentDisplayIndex; // 0x48
