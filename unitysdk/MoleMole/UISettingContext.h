...
#define MOLEMOLE_UISETTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1518CA00)

namespace MoleMole
{
	inline static constexpr unsigned int UISettingContext_TypeDefinitionIndex = 47500;
