...
#define MOLEMOLE_UIVHSSTOREPROMOTERPREFERITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x10D65510)
#define MOLEMOLE_UIVHSSTOREPROMOTERPREFERITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x10D65620)
#define MOLEMOLE_UIVHSSTOREPROMOTERPREFERITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x10D655A0)
#define MOLEMOLE_UIVHSSTOREPROMOTERPREFERITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x10D654B0)
#define MOLEMOLE_UIVHSSTOREPROMOTERPREFERITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x10D65700)
#define MOLEMOLE_UIVHSSTOREPROMOTERPREFERITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x10D65710)
#define MOLEMOLE_UIVHSSTOREPROMOTERPREFERITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x10D657A0)
#define MOLEMOLE_UIVHSSTOREPROMOTERPREFERITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x10D65840)
#define MOLEMOLE_UIVHSSTOREPROMOTERPREFERITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x10D658D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSStorePromoterPreferItemWidgetController_TypeDefinitionIndex = 58616;

	class UIVHSStorePromoterPreferItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_0096754AC2F6E253_18* _view; // 0x2E8
