...
#define MOLEMOLE_UIVHSSTOREPROMOTERPREFERITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A78A00)
#define MOLEMOLE_UIVHSSTOREPROMOTERPREFERITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15A78B10)
#define MOLEMOLE_UIVHSSTOREPROMOTERPREFERITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A78A90)
#define MOLEMOLE_UIVHSSTOREPROMOTERPREFERITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A789A0)
#define MOLEMOLE_UIVHSSTOREPROMOTERPREFERITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15A78BF0)
#define MOLEMOLE_UIVHSSTOREPROMOTERPREFERITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A78C00)
#define MOLEMOLE_UIVHSSTOREPROMOTERPREFERITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15A78C90)
#define MOLEMOLE_UIVHSSTOREPROMOTERPREFERITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A78D30)
#define MOLEMOLE_UIVHSSTOREPROMOTERPREFERITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A78DC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSStorePromoterPreferItemWidgetController_TypeDefinitionIndex = 79101;
