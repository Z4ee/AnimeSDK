...
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_CLOSECOUNTUPTIMER_OFFSET UNITYSDK_OFFSET(0x19140750)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_CREATENAVMAPCONTROLLER_OFFSET UNITYSDK_OFFSET(0x1913F600)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_GETMETALPATH_OFFSET UNITYSDK_OFFSET(0x1913E650)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_GET_CAMERADELTA_OFFSET UNITYSDK_OFFSET(0x1913E0F0)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_GET_DRIFT_OFFSET UNITYSDK_OFFSET(0x1913DF00)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_GET_MOVE_OFFSET UNITYSDK_OFFSET(0x1913E060)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_GET_ONGOINGCONTROLLER_OFFSET UNITYSDK_OFFSET(0x1913DE70)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_GET_SLOWDOWN_OFFSET UNITYSDK_OFFSET(0x1913DEF0)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_GET_SPEEDUP_OFFSET UNITYSDK_OFFSET(0x1913DE90)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_GET_UICURSORHIDESTATE_OFFSET UNITYSDK_OFFSET(0x1913DE60)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1913DE50)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1913EDE0)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_ONEXITGAME_OFFSET UNITYSDK_OFFSET(0x19140310)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1913FDF0)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_ONLOGICINLEVELCAMERAMOVE_OFFSET UNITYSDK_OFFSET(0x19140020)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_ONOPERATECOUNTTIMERSTATE_OFFSET UNITYSDK_OFFSET(0x19140430)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_ONPERFORMNOTIFY_OFFSET UNITYSDK_OFFSET(0x1913F8D0)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_ONRESTARTGAME_OFFSET UNITYSDK_OFFSET(0x191403A0)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1913FA70)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1913EE70)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_OPENCOUNTUPTIMERWIDGET_OFFSET UNITYSDK_OFFSET(0x191407C0)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_PAUSEGAME_OFFSET UNITYSDK_OFFSET(0x191402A0)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_PLAYEQUIPEFFECT_OFFSET UNITYSDK_OFFSET(0x1913DFA0)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_PLAYFINISHTIP_OFFSET UNITYSDK_OFFSET(0x1913E1F0)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_PLAYSTARTTIP_OFFSET UNITYSDK_OFFSET(0x1913E100)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_SET_ENABLESKILL_OFFSET UNITYSDK_OFFSET(0x1913E000)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_SET_ONGOINGCONTROLLER_OFFSET UNITYSDK_OFFSET(0x1913DE80)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_SET_SKILLRATIO_OFFSET UNITYSDK_OFFSET(0x1913DF30)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_SHOWMISSIONTIPIFREFRESHMINIMALTIMECOST_OFFSET UNITYSDK_OFFSET(0x1913E940)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_SHOWMISSION_OFFSET UNITYSDK_OFFSET(0x1913E2A0)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_UPDATESPEED_OFFSET UNITYSDK_OFFSET(0x1913FD00)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1913FB40)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x191409B0)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER__PLAYSTARTTIP_G__STARTGAME_42_0_OFFSET UNITYSDK_OFFSET(0x19140A10)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19140AD0)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x19140B60)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19140B90)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19140BA0)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerEventSurfMainPageController_TypeDefinitionIndex = 64325;
