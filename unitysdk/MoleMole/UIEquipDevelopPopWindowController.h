...
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ALLOCRTUNIT_OFFSET UNITYSDK_OFFSET(0x170C24B0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_CALCURITEMMAX_OFFSET UNITYSDK_OFFSET(0x170CB8A0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_CALEQUIPLEFTEXP_OFFSET UNITYSDK_OFFSET(0x170CA290)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_CALWEAPONLEFTEXP_OFFSET UNITYSDK_OFFSET(0x170CAF10)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_CLEARMATERIAL_OFFSET UNITYSDK_OFFSET(0x170C78A0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_DOREFRESHSTARUPVIEW_OFFSET UNITYSDK_OFFSET(0x170C5AC0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_DOREFRESHVIEWCOMMON_OFFSET UNITYSDK_OFFSET(0x170CD010)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_DOSETSTARUPCONSUME_OFFSET UNITYSDK_OFFSET(0x170C5DE0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GETALLSELECTLEVELUPMATERIAL_OFFSET UNITYSDK_OFFSET(0x170C4FC0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GETHASSELECTMATERIAL_OFFSET UNITYSDK_OFFSET(0x170C4EC0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GETLEVELUPITEMS_OFFSET UNITYSDK_OFFSET(0x170C3570)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GETREALADDEDVALUE_OFFSET UNITYSDK_OFFSET(0x170C5750)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GETSELECTLEVELUPMATERIALEXCEPTI_OFFSET UNITYSDK_OFFSET(0x170CBB00)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GETWEAPONRTANIMATOR_OFFSET UNITYSDK_OFFSET(0x170CE080)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x170BF800)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x170BD770)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_HANDLEZHENZHENWEAPONSTART_OFFSET UNITYSDK_OFFSET(0x170CDCF0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_INITLEVELUPVIEW_OFFSET UNITYSDK_OFFSET(0x170C3F50)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_INITSTARUPVIEW_OFFSET UNITYSDK_OFFSET(0x170C3FA0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x170BE000)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ISLEVELUPMATERIALITEMEMPTY_OFFSET UNITYSDK_OFFSET(0x170CAFE0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONAUTOBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x170C44C0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONBEFOREWORLDUPDATE_OFFSET UNITYSDK_OFFSET(0x170C01C0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONCLICKCONSOLECHECKCONSUMEBTN_OFFSET UNITYSDK_OFFSET(0x170CBE30)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONCLICKCONSUMEICONBTN_OFFSET UNITYSDK_OFFSET(0x170CBD90)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONCLICKEQUIPLEVELBTN_OFFSET UNITYSDK_OFFSET(0x170C71B0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONCLICKEQUIPSTARBTN_OFFSET UNITYSDK_OFFSET(0x170C3FF0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONCLICKINFOBTN_OFFSET UNITYSDK_OFFSET(0x170C7680)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONCLICKSPINFOBTN_OFFSET UNITYSDK_OFFSET(0x170C1160)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x170BF770)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONEQUIPRTLOADED_OFFSET UNITYSDK_OFFSET(0x170CE330)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x170BFC30)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x170C0AD0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONITEMCHANGE_OFFSET UNITYSDK_OFFSET(0x170C3160)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x170BF810)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONLEVELUPMATCHANGED_OFFSET UNITYSDK_OFFSET(0x170CB120)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONSTARUPANIMATIONFINISH_OFFSET UNITYSDK_OFFSET(0x170C5490)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONSTARUPHANDLE_OFFSET UNITYSDK_OFFSET(0x170C52D0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONSTORYINFOBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x170CBF90)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x170C1AA0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x170BD780)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x170BDE80)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONWEAPONLEVELUPRSP_OFFSET UNITYSDK_OFFSET(0x170C3DF0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONWEAPONRTLOADED_OFFSET UNITYSDK_OFFSET(0x170CD770)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REALLOCRTUNIT_OFFSET UNITYSDK_OFFSET(0x170BFB90)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHLEVELUPINPUTKEY_OFFSET UNITYSDK_OFFSET(0x170BFD50)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHLEVELUPVIEWFOREQUIP_OFFSET UNITYSDK_OFFSET(0x170C7960)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHLEVELUPVIEWFORWEAPON_OFFSET UNITYSDK_OFFSET(0x170C9220)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHLEVELUPVIEW_OFFSET UNITYSDK_OFFSET(0x170C3690)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHSTARUPVIEW_OFFSET UNITYSDK_OFFSET(0x170C37E0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHVIEWFOREQUIP_OFFSET UNITYSDK_OFFSET(0x170CC720)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHVIEWFORWEAPON_OFFSET UNITYSDK_OFFSET(0x170CCA80)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x170BF6E0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_RELEASERTUNIT_OFFSET UNITYSDK_OFFSET(0x170CBF20)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_SETEQUIPDEVELOPCONTENT_OFFSET UNITYSDK_OFFSET(0x170C2660)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_SETLEVELUPCONSUME_OFFSET UNITYSDK_OFFSET(0x170CA4E0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_SETPROGRESS_OFFSET UNITYSDK_OFFSET(0x170CA360)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_SETSTARUPCONSUME_OFFSET UNITYSDK_OFFSET(0x170C55B0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_SHOULDWEAPONSHOWSP_OFFSET UNITYSDK_OFFSET(0x170CD700)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_SHOWBACKITEMLISTDIALOG_OFFSET UNITYSDK_OFFSET(0x170C2300)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_TICKRTROTATING_OFFSET UNITYSDK_OFFSET(0x170C1400)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_TRIGGERGAMEPADADDBTN_OFFSET UNITYSDK_OFFSET(0x170C0270)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_TRIGGERGAMEPADREDUCEBTN_OFFSET UNITYSDK_OFFSET(0x170C06A0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_TRIGGERSTARTWEAPONPERFORM_OFFSET UNITYSDK_OFFSET(0x170CDA20)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x170C13B0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x170CECC0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x170CEAA0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__DOSETSTARUPCONSUME_B__49_1_OFFSET UNITYSDK_OFFSET(0x170CEDB0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__ONCLICKEQUIPSTARBTN_B__38_0_OFFSET UNITYSDK_OFFSET(0x170CED50)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__ONCLICKEQUIPSTARBTN_B__38_1_OFFSET UNITYSDK_OFFSET(0x170CED10)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__ONCLICKSPINFOBTN_B__74_0_OFFSET UNITYSDK_OFFSET(0x170CEFB0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__ONCLICKSPINFOBTN_B__74_1_OFFSET UNITYSDK_OFFSET(0x170CEFE0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__ONSTORYINFOBTNCLICKED_B__73_0_OFFSET UNITYSDK_OFFSET(0x170CEDD0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__TRIGGERSTARTWEAPONPERFORM_B__81_0_OFFSET UNITYSDK_OFFSET(0x170CF010)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x170CF150)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x170CF1E0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x170CF290)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x170CF2C0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x170CF350)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x170CF360)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x170CF370)

namespace MoleMole
{
	inline static constexpr unsigned int UIEquipDevelopPopWindowController_TypeDefinitionIndex = 70945;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIEquipDevelopPopWindowController_TypeDefinitionIndex)->GetStaticField(0x100A0);
		}
		static ::System::Int32* StaticGet_BaseMap()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIEquipDevelopPopWindowController_TypeDefinitionIndex)->GetStaticField(0x100A4);
		}
		...
		::Class_2_79F6D62CE30E3F8E_92* _view; // 0x368
		...
		::Class_2_5E8E56AB26D3F10E* _equipmentDataProxy; // 0x388
		...
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_477*>* GetLevelupItems()
		{
			return ((::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_477*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GETLEVELUPITEMS_OFFSET))(this);
		}
		...
		::System::Void DoRefreshViewCommon(::System::Int32 templateID, ::Class_2_208CC9941471731A_477* itemConfig, ::System::UInt32 avatarUID, ::System::String* iconPath, ::System::Boolean isEquip, ::System::Boolean isRefreshRT)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::Class_2_208CC9941471731A_477*, ::System::UInt32, ::System::String*, ::System::Boolean, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_DOREFRESHVIEWCOMMON_OFFSET))(this, templateID, itemConfig, avatarUID, iconPath, isEquip, isRefreshRT);
		}
