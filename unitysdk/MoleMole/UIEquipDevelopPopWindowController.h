...
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ALLOCRTUNIT_OFFSET UNITYSDK_OFFSET(0x15F5E090)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_CALCURITEMMAX_OFFSET UNITYSDK_OFFSET(0x15F5D900)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_CALEQUIPLEFTEXP_OFFSET UNITYSDK_OFFSET(0x15F5C1F0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_CALWEAPONLEFTEXP_OFFSET UNITYSDK_OFFSET(0x15F5CEB0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_CLEARMATERIAL_OFFSET UNITYSDK_OFFSET(0x15F59750)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_DOREFRESHSTARUPVIEW_OFFSET UNITYSDK_OFFSET(0x15310ED0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_DOREFRESHVIEWCOMMON_OFFSET UNITYSDK_OFFSET(0x15F5F560)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_DOSETSTARUPCONSUME_OFFSET UNITYSDK_OFFSET(0x15311210)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GETALLSELECTLEVELUPMATERIAL_OFFSET UNITYSDK_OFFSET(0x15F590D0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GETHASSELECTMATERIAL_OFFSET UNITYSDK_OFFSET(0x153105D0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GETLEVELUPITEMS_OFFSET UNITYSDK_OFFSET(0x15F5D7E0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GETREALADDEDVALUE_OFFSET UNITYSDK_OFFSET(0x15310B60)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GETSELECTLEVELUPMATERIALEXCEPTI_OFFSET UNITYSDK_OFFSET(0x15F5DB60)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GETWEAPONRTANIMATOR_OFFSET UNITYSDK_OFFSET(0x15F605F0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x1530BE70)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15309E80)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_HANDLEZHENZHENWEAPONSTART_OFFSET UNITYSDK_OFFSET(0x15F60260)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_INITLEVELUPVIEW_OFFSET UNITYSDK_OFFSET(0x1530F660)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_INITSTARUPVIEW_OFFSET UNITYSDK_OFFSET(0x1530F6B0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x1530A700)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ISLEVELUPMATERIALITEMEMPTY_OFFSET UNITYSDK_OFFSET(0x15F5CF80)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONAUTOBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x1530FBD0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONBEFOREWORLDUPDATE_OFFSET UNITYSDK_OFFSET(0x1530C7A0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONCLICKCONSOLECHECKCONSUMEBTN_OFFSET UNITYSDK_OFFSET(0x15F5DE90)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONCLICKCONSUMEICONBTN_OFFSET UNITYSDK_OFFSET(0x15F5DDF0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONCLICKEQUIPLEVELBTN_OFFSET UNITYSDK_OFFSET(0x15F58BF0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONCLICKEQUIPSTARBTN_OFFSET UNITYSDK_OFFSET(0x1530F700)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONCLICKINFOBTN_OFFSET UNITYSDK_OFFSET(0x15F593E0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONCLICKSPINFOBTN_OFFSET UNITYSDK_OFFSET(0x15F5E970)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1530BDE0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONEQUIPRTLOADED_OFFSET UNITYSDK_OFFSET(0x15F60F90)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x1530C200)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1530D0B0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONITEMCHANGE_OFFSET UNITYSDK_OFFSET(0x1530EAD0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x1530BE80)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONLEVELUPMATCHANGED_OFFSET UNITYSDK_OFFSET(0x15F5D0C0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONSTARUPANIMATIONFINISH_OFFSET UNITYSDK_OFFSET(0x15310890)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONSTARUPHANDLE_OFFSET UNITYSDK_OFFSET(0x153106D0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONSTORYINFOBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x15F5E230)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1530D780)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15309E90)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1530A580)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONWEAPONLEVELUPRSP_OFFSET UNITYSDK_OFFSET(0x1530F500)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONWEAPONRTLOADED_OFFSET UNITYSDK_OFFSET(0x15F5FCE0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REALLOCRTUNIT_OFFSET UNITYSDK_OFFSET(0x15F5DF80)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHLEVELUPINPUTKEY_OFFSET UNITYSDK_OFFSET(0x1530C320)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHLEVELUPVIEWFOREQUIP_OFFSET UNITYSDK_OFFSET(0x15F59960)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHLEVELUPVIEWFORWEAPON_OFFSET UNITYSDK_OFFSET(0x15F5B190)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHLEVELUPVIEW_OFFSET UNITYSDK_OFFSET(0x15F59810)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHSTARUPVIEW_OFFSET UNITYSDK_OFFSET(0x1530EEF0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHVIEWFOREQUIP_OFFSET UNITYSDK_OFFSET(0x15F5EC50)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHVIEWFORWEAPON_OFFSET UNITYSDK_OFFSET(0x15F5EFB0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x15F5EBC0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_RELEASERTUNIT_OFFSET UNITYSDK_OFFSET(0x15F5E020)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_SETEQUIPDEVELOPCONTENT_OFFSET UNITYSDK_OFFSET(0x1530DFE0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_SETLEVELUPCONSUME_OFFSET UNITYSDK_OFFSET(0x15F5C440)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_SETPROGRESS_OFFSET UNITYSDK_OFFSET(0x15F5C2C0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_SETSTARUPCONSUME_OFFSET UNITYSDK_OFFSET(0x153109B0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_SHOULDWEAPONSHOWSP_OFFSET UNITYSDK_OFFSET(0x15F5FC70)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_SHOWBACKITEMLISTDIALOG_OFFSET UNITYSDK_OFFSET(0x15F595A0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_TICKRTROTATING_OFFSET UNITYSDK_OFFSET(0x15F608A0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_TRIGGERGAMEPADADDBTN_OFFSET UNITYSDK_OFFSET(0x1530C850)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_TRIGGERGAMEPADREDUCEBTN_OFFSET UNITYSDK_OFFSET(0x1530CC80)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_TRIGGERSTARTWEAPONPERFORM_OFFSET UNITYSDK_OFFSET(0x15F5FF90)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1530D730)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x15F619A0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15F61700)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__DOSETSTARUPCONSUME_B__49_1_OFFSET UNITYSDK_OFFSET(0x15F61A90)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__ONCLICKEQUIPSTARBTN_B__38_0_OFFSET UNITYSDK_OFFSET(0x15F61A30)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__ONCLICKEQUIPSTARBTN_B__38_1_OFFSET UNITYSDK_OFFSET(0x15F619F0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__ONCLICKSPINFOBTN_B__74_0_OFFSET UNITYSDK_OFFSET(0x15F61CA0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__ONCLICKSPINFOBTN_B__74_1_OFFSET UNITYSDK_OFFSET(0x15F61CD0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__ONSTORYINFOBTNCLICKED_B__73_0_OFFSET UNITYSDK_OFFSET(0x15F61AB0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__TRIGGERSTARTWEAPONPERFORM_B__81_0_OFFSET UNITYSDK_OFFSET(0x15F61D00)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15F61E40)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x15F61ED0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x15F61F80)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x15F61FB0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15F62040)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15F62050)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15F62060)

namespace MoleMole
{
	inline static constexpr unsigned int UIEquipDevelopPopWindowController_TypeDefinitionIndex = 44459;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIEquipDevelopPopWindowController_TypeDefinitionIndex)->GetStaticField(0x112E0);
		}
		static ::System::Int32* StaticGet_BaseMap()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIEquipDevelopPopWindowController_TypeDefinitionIndex)->GetStaticField(0x112E4);
		}
		...
		::System::Int32 firstUnenoughID; // 0x310
		::System::Boolean isJumpToCompose; // 0x314
		::System::Int32 jumpToItemID; // 0x318
		::System::Int32 jumpTabIndex; // 0x31C
		::System::Int32 composeNeedCount; // 0x320
		::System::Boolean isSuggestUseMaterialConversion; // 0x324
		::MoleMole::UIGeneralConversionTipsPopWindowContext* conversionContext; // 0x328
		::System::Boolean isSuggestUseMaterialConversionAndAdaptive; // 0x330
		::System::Boolean isSuggestUseAdaptiveMaterial; // 0x331
		::System::Boolean isUseAdaptiveMaterial; // 0x332
		::System::Int32 useAdaptiveItemID; // 0x334
		::System::Int32 useAdaptiveItemCount; // 0x338
		::Foundation::Coroutine::CoroutineHandle okBtnDisableHandle; // 0x33C
		::System::Boolean isStarUping; // 0x340
		...
		::System::Int32 lastRandomPropertyCount; // 0x358
		::Class_2_79F6D62CE30E3F8E_44* _view; // 0x360
		::MoleMole::UIEquipDevelopContext* _context; // 0x368
		::Enum_3_B9002106B360C669 _curDevelopType; // 0x370
		::Class_1_0D6706375CDAAE8C* _curItemData; // 0x378
		::Class_2_2DFDAF0B881128C6* _equipmentDataProxy; // 0x380
		::Class_2_A63C194229EB6BF2* _equipmentModel; // 0x388
		::Class_2_9D9172C07F82DDAE* _itemModel; // 0x390
		::System::Collections::Generic::List_1<::MoleMole::UIItemIconBtnWidgetController*>* _levelUpMats; // 0x398
		::System::Collections::Generic::List_1<::MoleMole::UIItemIconBtnWidgetController*>* _equipStarUpMats; // 0x3A0
		::System::Collections::Generic::List_1<::Class_1_C5FDB00B12827EE9*>* _equipBasePropertyItems; // 0x3A8
		::System::Collections::Generic::List_1<::Class_1_C5FDB00B12827EE9*>* _equipRandomPropertyItems; // 0x3B0
		::System::Collections::Generic::List_1<::MonoUILoopBGText*>* _loopTxtList; // 0x3B8
		::System::Single _allNeedCountpercent; // 0x3C0
		::System::Single _curCountPercent; // 0x3C4
		::System::Boolean _isDevelopedUp; // 0x3C8
		::System::Boolean _isEquipLevelUpMaxLevel; // 0x3C9
		::UnityEngine::Material* _processMaterial; // 0x3D0
		::System::Int32 curLeftExp; // 0x3D8
		::System::Int32 weaponToMaxLvNeedExp; // 0x3DC
		::System::Int32 equipToNextLvNeedExp; // 0x3E0
		::MoleMole::MonoGamepadCustomList* _monoGamepadCustomList; // 0x3E8
		::System::Int32 _gamepadAddSelectIndex; // 0x3F0
		::System::Int32 _gamepadReduceSelectIndex; // 0x3F4
		::System::Boolean _isGamepadAddBtnPressed; // 0x3F8
		::System::Boolean _isGamepadReduceBtnPressed; // 0x3F9
		::System::Collections::Generic::List_1<::Class_1_0D6706375CDAAE8C*>* backItemList; // 0x400
		::System::Int32 _consumeItemID; // 0x408
		::Class_2_C2B4B123B5A9B78A* _iconRTUnit; // 0x410
		::System::Boolean hasWeaponFirstRefreshed; // 0x418
		::System::Boolean shouldShowSP; // 0x419
		::System::Boolean isSPInfoExpand; // 0x41A
		::Foundation::Coroutine::CoroutineHandle _weaponTransformTriggerResetHandle; // 0x41C
		::System::Single _weaponTransformTriggerRotateCounter; // 0x420
		::System::String* DefaultTipsTextTextMap; // 0x428
