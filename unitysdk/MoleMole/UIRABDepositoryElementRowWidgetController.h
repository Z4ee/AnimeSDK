...
#define MOLEMOLE_UIRABDEPOSITORYELEMENTROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x14C7A710)
#define MOLEMOLE_UIRABDEPOSITORYELEMENTROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x14C7A780)
#define MOLEMOLE_UIRABDEPOSITORYELEMENTROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x14C7A820)
#define MOLEMOLE_UIRABDEPOSITORYELEMENTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14C7A9D0)
#define MOLEMOLE_UIRABDEPOSITORYELEMENTROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x14C7AA30)
#define MOLEMOLE_UIRABDEPOSITORYELEMENTROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x14C7AAD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABDepositoryElementRowWidgetController_TypeDefinitionIndex = 70714;
