...
#define MOLEMOLE_UILEVELRESULTCHALLENGEROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14C2DEE0)
#define MOLEMOLE_UILEVELRESULTCHALLENGEROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x14C2DFF0)
#define MOLEMOLE_UILEVELRESULTCHALLENGEROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14C2DF70)
#define MOLEMOLE_UILEVELRESULTCHALLENGEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14C2DE80)
#define MOLEMOLE_UILEVELRESULTCHALLENGEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14C2E5F0)
#define MOLEMOLE_UILEVELRESULTCHALLENGEROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14C2E600)
#define MOLEMOLE_UILEVELRESULTCHALLENGEROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x14C2E690)
#define MOLEMOLE_UILEVELRESULTCHALLENGEROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14C2E730)
#define MOLEMOLE_UILEVELRESULTCHALLENGEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14C2E7C0)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultChallengeRowWidgetController_TypeDefinitionIndex = 77687;
