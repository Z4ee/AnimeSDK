...
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTDISHTABBTNROWWIDGETCONTROLLER_GETTABBUTTON_OFFSET UNITYSDK_OFFSET(0x180CA830)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTDISHTABBTNROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x180CA320)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTDISHTABBTNROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x180CA430)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTDISHTABBTNROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x180CA3B0)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTDISHTABBTNROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x180CA250)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTDISHTABBTNROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x180CA2B0)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTDISHTABBTNROWWIDGETCONTROLLER_REFRESHLOCK_OFFSET UNITYSDK_OFFSET(0x180CA930)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTDISHTABBTNROWWIDGETCONTROLLER_REFRESHTEXT_OFFSET UNITYSDK_OFFSET(0x180CA890)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTDISHTABBTNROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x180CA540)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTDISHTABBTNROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x180CA9C0)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTDISHTABBTNROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x180CA9D0)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTDISHTABBTNROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x180CAA60)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTDISHTABBTNROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x180CAB00)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTDISHTABBTNROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x180CAB90)
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTDISHTABBTNROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x180CAC20)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityHotPotCollectDishTabBtnRowWidgetController_TypeDefinitionIndex = 81304;
