...
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17794A50)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x17794EB0)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER_ONGET_OFFSET UNITYSDK_OFFSET(0x17796840)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER_ONLEVELREWARDCLAIMED_OFFSET UNITYSDK_OFFSET(0x17796A70)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER_ONMISSIONMODIFY_OFFSET UNITYSDK_OFFSET(0x177967A0)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17794920)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17794E30)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17794720)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17794810)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER_REFRESHPROXYLEVEL_OFFSET UNITYSDK_OFFSET(0x177953E0)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER_REFRESHPROXYQUEST_OFFSET UNITYSDK_OFFSET(0x17795D80)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER_REFRESHQUESTDATA_OFFSET UNITYSDK_OFFSET(0x17795190)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER_REFRESHSTATE_OFFSET UNITYSDK_OFFSET(0x17795F50)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x177949F0)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17796B40)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER__ONGET_B__13_0_OFFSET UNITYSDK_OFFSET(0x17796BA0)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17796BB0)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x17796C40)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17796CD0)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17796D70)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17796E00)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17796E90)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookRopeMakerWidgetController_TypeDefinitionIndex = 57642;

	class UIHandBookRopeMakerWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_105* _view; // 0x2C0
