...
#define MOLEMOLE_ACTIVITYBANGBOOGALH5INFO_PROGRESSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x11002A80)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityBangbooGalH5Info_ProgressInfo_TypeDefinitionIndex = 50571;
