...
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER_BINDBUTTON_OFFSET UNITYSDK_OFFSET(0x18BEE900)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER_CREATECHALLENGEITEMROW_OFFSET UNITYSDK_OFFSET(0x18BEF410)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER_CREATENORMALITEMROW_OFFSET UNITYSDK_OFFSET(0x18BEF290)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER_GETTEMPLATEINDEXFROMDATA_OFFSET UNITYSDK_OFFSET(0x18BEF110)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x18BEE770)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18BEE780)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18BEE7F0)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18BEE8B0)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18BEEC30)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18BEF590)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18BEF5A0)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18BEF640)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18BEF650)

namespace MoleMole
{
	inline static constexpr unsigned int UIAutoBattlePVEPageController_TypeDefinitionIndex = 89350;
