...
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_METHOD_6_0089E869E2D4144B_OFFSET UNITYSDK_OFFSET(0x1908FD20)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_METHOD_6_4DFE64B6A1B8E9ED_OFFSET UNITYSDK_OFFSET(0x1908FB50)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_METHOD_6_AE0F903074744335_OFFSET UNITYSDK_OFFSET(0x190901E0)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_METHOD_6_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x190901D0)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0x1908FFC0)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_PLAY_1_OFFSET UNITYSDK_OFFSET(0x1908F670)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_PLAY_OFFSET UNITYSDK_OFFSET(0x1908F3E0)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_SAMPLEANIMATION_OFFSET UNITYSDK_OFFSET(0x1908FDB0)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_STOPCURFADE_OFFSET UNITYSDK_OFFSET(0x1908F580)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_STOP_OFFSET UNITYSDK_OFFSET(0x19090340)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR__CTOR_OFFSET UNITYSDK_OFFSET(0x19090480)

namespace MoleMole
{
	inline static constexpr unsigned int MonoAnimationPluginMirror_TypeDefinitionIndex = 87268;
	...
	public:
		...
		::System::Action* Field_6_0; // 0x28
		::Foundation::Coroutine::CoroutineHandle Field_6_7; // 0x30
		::System::String* Field_6_6; // 0x38
		...
		::System::Void Method_6_AE0F903074744335()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOANIMATIONPLUGINMIRROR_METHOD_6_AE0F903074744335_OFFSET))(this);
		}
