...
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_METHOD_6_0089E869E2D4144B_OFFSET UNITYSDK_OFFSET(0x15B32570)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_METHOD_6_4DFE64B6A1B8E9ED_OFFSET UNITYSDK_OFFSET(0x15B323A0)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_METHOD_6_896FA9EAB4C29FB4_OFFSET UNITYSDK_OFFSET(0x15B32A30)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_METHOD_6_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x15B32A20)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0x15B32810)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_PLAY_1_OFFSET UNITYSDK_OFFSET(0x15B31EC0)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_PLAY_OFFSET UNITYSDK_OFFSET(0x15B31C30)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_SAMPLEANIMATION_OFFSET UNITYSDK_OFFSET(0x15B32600)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_STOPCURFADE_OFFSET UNITYSDK_OFFSET(0x15B31DD0)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_STOP_OFFSET UNITYSDK_OFFSET(0x15B32B90)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR__CTOR_OFFSET UNITYSDK_OFFSET(0x15B32CD0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoAnimationPluginMirror_TypeDefinitionIndex = 49041;
