...
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1302EC00)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1302EAA0)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1302EC90)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1302E800)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1302EA30)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1302ED10)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1302ED70)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1302EE00)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1302EEA0)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1302EF30)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1302EFC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIShoppingMallLimitedCard03RowWidgetController_TypeDefinitionIndex = 42121;

	class UIShoppingMallLimitedCard03RowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_1AE7AA27121819AA* _view; // 0x2B8
