...
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x11BAEF70)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x11BAEE10)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x11BAF000)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x11BAEB70)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x11BAEDA0)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11BAF080)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x11BAF0E0)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x11BAF170)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x11BAF210)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x11BAF2A0)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x11BAF330)

namespace MoleMole
{
	inline static constexpr unsigned int UIShoppingMallLimitedCard03RowWidgetController_TypeDefinitionIndex = 79582;
