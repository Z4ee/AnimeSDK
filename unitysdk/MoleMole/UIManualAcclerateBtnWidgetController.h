...
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER_ACCELERATIONVIEW_OFFSET UNITYSDK_OFFSET(0x19CA0ED0)
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER_GET_ISMANUALACCELERATIONON_OFFSET UNITYSDK_OFFSET(0x19CA0B00)
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER_LOCKVIEW_OFFSET UNITYSDK_OFFSET(0x19CA1030)
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER_MANUALACCELERATE_OFFSET UNITYSDK_OFFSET(0x19CA0CF0)
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER_NOACCELERATIONVIEW_OFFSET UNITYSDK_OFFSET(0x19CA0F80)
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19CA0DC0)
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19CA0E50)
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19CA0B30)
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19CA0D50)
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19CA10E0)
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER__ONUIINIT_B__3_0_OFFSET UNITYSDK_OFFSET(0x19CA1140)
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19CA1360)
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19CA13F0)
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19CA1480)
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19CA1510)

namespace MoleMole
{
	inline static constexpr unsigned int UIManualAcclerateBtnWidgetController_TypeDefinitionIndex = 83553;
