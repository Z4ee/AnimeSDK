...
#define MOLEMOLE_CPUQUALITYLEVELBYCPUNAMEPOSTPROCESSORPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x19D6DFB0)
#define MOLEMOLE_CPUQUALITYLEVELBYCPUNAMEPOSTPROCESSORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x19D6E020)
#define MOLEMOLE_CPUQUALITYLEVELBYCPUNAMEPOSTPROCESSORPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x19D6E1A0)

namespace MoleMole
{
	inline static constexpr unsigned int CpuQualityLevelByCPUNamePostProcessorProfile_TypeDefinitionIndex = 72425;

	class CpuQualityLevelByCPUNamePostProcessorProfile : public ::MoleMole::PerformanceSettingPostProcessProfileBase
	{
	public:
		::System::Collections::Generic::List_1<::System::String*>* LowCPUNameRegexList; // 0x10
		...
		::System::Collections::Generic::List_1<::System::String*>* MediumCPUNameRegexList; // 0x28
