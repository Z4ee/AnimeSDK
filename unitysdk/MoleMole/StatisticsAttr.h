...
#define MOLEMOLE_STATISTICSATTR_METHOD_1_094E85B034039595_OFFSET UNITYSDK_OFFSET(0x1817AC30)
#define MOLEMOLE_STATISTICSATTR_METHOD_1_117C627844A89315_OFFSET UNITYSDK_OFFSET(0x1817A200)
#define MOLEMOLE_STATISTICSATTR_METHOD_1_18A3BFC9738829A7_OFFSET UNITYSDK_OFFSET(0x181792E0)
#define MOLEMOLE_STATISTICSATTR_METHOD_1_33743D5333D90F94_OFFSET UNITYSDK_OFFSET(0x1817A8B0)
#define MOLEMOLE_STATISTICSATTR_METHOD_1_4117615613B825D8_OFFSET UNITYSDK_OFFSET(0x18178C30)
#define MOLEMOLE_STATISTICSATTR_METHOD_1_611D00A0EB5D7DE6_OFFSET UNITYSDK_OFFSET(0x18179550)
#define MOLEMOLE_STATISTICSATTR_METHOD_1_7043B9A9D77FB306_OFFSET UNITYSDK_OFFSET(0x18179CE0)
#define MOLEMOLE_STATISTICSATTR_METHOD_1_7889E856344009E9_OFFSET UNITYSDK_OFFSET(0x1817A190)
#define MOLEMOLE_STATISTICSATTR_METHOD_1_90D0DC11D34D7114_OFFSET UNITYSDK_OFFSET(0x181796E0)
#define MOLEMOLE_STATISTICSATTR_METHOD_1_A36150C5DCC8409E_1_OFFSET UNITYSDK_OFFSET(0x1817A860)
#define MOLEMOLE_STATISTICSATTR_METHOD_1_A36150C5DCC8409E_2_OFFSET UNITYSDK_OFFSET(0x1817A940)
#define MOLEMOLE_STATISTICSATTR_METHOD_1_A36150C5DCC8409E_3_OFFSET UNITYSDK_OFFSET(0x1817A990)
#define MOLEMOLE_STATISTICSATTR_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x18178BE0)
#define MOLEMOLE_STATISTICSATTR_METHOD_1_ACEC1E3085AC43BE_OFFSET UNITYSDK_OFFSET(0x1817A6D0)
#define MOLEMOLE_STATISTICSATTR_METHOD_1_AFD7CB1F3D8E9C9F_OFFSET UNITYSDK_OFFSET(0x18179850)
#define MOLEMOLE_STATISTICSATTR_METHOD_1_B67DCF72B717FA9F_OFFSET UNITYSDK_OFFSET(0x18179E20)
#define MOLEMOLE_STATISTICSATTR_METHOD_1_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0x18179F60)
#define MOLEMOLE_STATISTICSATTR_METHOD_1_C21F7B27F4CE53CB_OFFSET UNITYSDK_OFFSET(0x1817A9E0)
#define MOLEMOLE_STATISTICSATTR_METHOD_1_D73DAA7FC3D80F47_OFFSET UNITYSDK_OFFSET(0x181793C0)
#define MOLEMOLE_STATISTICSATTR_METHOD_1_D908BB9767125138_OFFSET UNITYSDK_OFFSET(0x18179B60)
#define MOLEMOLE_STATISTICSATTR_METHOD_1_FCCBC857CD61BCE8_OFFSET UNITYSDK_OFFSET(0x1817A520)
#define MOLEMOLE_STATISTICSATTR__CCTOR_OFFSET UNITYSDK_OFFSET(0x18178AC0)
#define MOLEMOLE_STATISTICSATTR__CTOR_OFFSET UNITYSDK_OFFSET(0x181788C0)

namespace MoleMole
{
	inline static constexpr unsigned int StatisticsAttr_TypeDefinitionIndex = 50537;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Reflection::FieldInfo*>**)Il2CppClass::FromTypeDefinitionIndex(StatisticsAttr_TypeDefinitionIndex)->GetStaticField(0x42FF0);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Reflection::PropertyInfo*>** StaticGet_propertyInfoCache()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Reflection::PropertyInfo*>**)Il2CppClass::FromTypeDefinitionIndex(StatisticsAttr_TypeDefinitionIndex)->GetStaticField(0x42FF8);
		}
