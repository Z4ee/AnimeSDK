...
#define MOLEMOLE_UIACTIVITWEEKREWARDCOMPONENTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x180C4E10)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivitWeekRewardComponentContext_TypeDefinitionIndex = 82489;
