...
class Class_1_AE8977CC8DFA35ED;
...
#define MOLEMOLE_SLIDINGSUBSYSTEM_ADDCHECKINGENTITY_OFFSET UNITYSDK_OFFSET(0x12B1B0E0)
#define MOLEMOLE_SLIDINGSUBSYSTEM_ADDCONTROLENTITY_OFFSET UNITYSDK_OFFSET(0x12B1A890)
#define MOLEMOLE_SLIDINGSUBSYSTEM_ADDDEBUGGER_OFFSET UNITYSDK_OFFSET(0x12B190D0)
#define MOLEMOLE_SLIDINGSUBSYSTEM_ADDROTATIONENTITY_OFFSET UNITYSDK_OFFSET(0x12B1AB40)
#define MOLEMOLE_SLIDINGSUBSYSTEM_ADDVELOCITY_OFFSET UNITYSDK_OFFSET(0x12B19530)
#define MOLEMOLE_SLIDINGSUBSYSTEM_ENTRYSLIDINGSTATE_OFFSET UNITYSDK_OFFSET(0x12B19E50)
#define MOLEMOLE_SLIDINGSUBSYSTEM_FIXEDUPDATECHECKINGCONTEXT_OFFSET UNITYSDK_OFFSET(0x12B1B5F0)
#define MOLEMOLE_SLIDINGSUBSYSTEM_FIXEDUPDATECONTROLCONTEXT_OFFSET UNITYSDK_OFFSET(0x12B1B540)
#define MOLEMOLE_SLIDINGSUBSYSTEM_FIXEDUPDATEROTATIONCONTEXT_OFFSET UNITYSDK_OFFSET(0x12B1B6B0)
#define MOLEMOLE_SLIDINGSUBSYSTEM_GETCURRENTVELOCITY_OFFSET UNITYSDK_OFFSET(0x12B1A1F0)
#define MOLEMOLE_SLIDINGSUBSYSTEM_GETORCREATECOMMONCONTEXT_OFFSET UNITYSDK_OFFSET(0x12B1A410)
#define MOLEMOLE_SLIDINGSUBSYSTEM_ISCHECKINGENTITY_OFFSET UNITYSDK_OFFSET(0x12B1A130)
#define MOLEMOLE_SLIDINGSUBSYSTEM_ISSLIDINGENTITY_OFFSET UNITYSDK_OFFSET(0x12B19F70)
#define MOLEMOLE_SLIDINGSUBSYSTEM_MULTIPLYVELOCITY_OFFSET UNITYSDK_OFFSET(0x12B19D10)
#define MOLEMOLE_SLIDINGSUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x12B18D90)
#define MOLEMOLE_SLIDINGSUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x12B19050)
#define MOLEMOLE_SLIDINGSUBSYSTEM_ONFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x12B1B400)
#define MOLEMOLE_SLIDINGSUBSYSTEM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x12B1B720)
#define MOLEMOLE_SLIDINGSUBSYSTEM_POPMAXSPEEDXZ_OFFSET UNITYSDK_OFFSET(0x12B1A630)
#define MOLEMOLE_SLIDINGSUBSYSTEM_POPSLIDINGFLINGTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x12B1A710)
#define MOLEMOLE_SLIDINGSUBSYSTEM_PUSHMAXSPEEDXZ_OFFSET UNITYSDK_OFFSET(0x12B1A380)
#define MOLEMOLE_SLIDINGSUBSYSTEM_PUSHSLIDINGFLINGTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x12B1A5A0)
#define MOLEMOLE_SLIDINGSUBSYSTEM_REFRESHEXITVELOCITY_OFFSET UNITYSDK_OFFSET(0x12B1A7F0)
#define MOLEMOLE_SLIDINGSUBSYSTEM_REMOVECHECKINGENTITY_OFFSET UNITYSDK_OFFSET(0x12B1B240)
#define MOLEMOLE_SLIDINGSUBSYSTEM_REMOVECONTROLENTITY_OFFSET UNITYSDK_OFFSET(0x12B1AE30)
#define MOLEMOLE_SLIDINGSUBSYSTEM_REMOVEDEBUGGER_OFFSET UNITYSDK_OFFSET(0x12B19300)
#define MOLEMOLE_SLIDINGSUBSYSTEM_REMOVEROTATIONENTITY_OFFSET UNITYSDK_OFFSET(0x12B1ACD0)
#define MOLEMOLE_SLIDINGSUBSYSTEM_RESETSLIDINGDIRECTION_OFFSET UNITYSDK_OFFSET(0x12B19BC0)
#define MOLEMOLE_SLIDINGSUBSYSTEM_RESETSURFACE_OFFSET UNITYSDK_OFFSET(0x12B1B980)
#define MOLEMOLE_SLIDINGSUBSYSTEM_SETSLIDINGDIRECTION_OFFSET UNITYSDK_OFFSET(0x12B19670)
#define MOLEMOLE_SLIDINGSUBSYSTEM_SETSURFACE_OFFSET UNITYSDK_OFFSET(0x12B1B830)
#define MOLEMOLE_SLIDINGSUBSYSTEM_SETVELOCITY_OFFSET UNITYSDK_OFFSET(0x12B19810)
#define MOLEMOLE_SLIDINGSUBSYSTEM_SWITCHINTOFLYING_OFFSET UNITYSDK_OFFSET(0x12B19A40)
#define MOLEMOLE_SLIDINGSUBSYSTEM_SWITCHINTOSLIDING_OFFSET UNITYSDK_OFFSET(0x12B1B2C0)
#define MOLEMOLE_SLIDINGSUBSYSTEM_UPDATECONTROLCONTEXT_OFFSET UNITYSDK_OFFSET(0x12B1B7C0)
#define MOLEMOLE_SLIDINGSUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x12B1BB40)
#define MOLEMOLE_SLIDINGSUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x12B1BB60)
#define MOLEMOLE_SLIDINGSUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x12B1BBF0)
#define MOLEMOLE_SLIDINGSUBSYSTEM___BASE_ONFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x12B1BC80)
#define MOLEMOLE_SLIDINGSUBSYSTEM___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x12B1BD20)

namespace MoleMole
{
	inline static constexpr unsigned int SlidingSubsystem_TypeDefinitionIndex = 65334;

	class SlidingSubsystem : public ::MoleMole::GameSubsystemBaseEx_1<::MoleMole::SlidingSubsystem*>
	{
	public:
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_653*>* _debuggers; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_AE8977CC8DFA35ED*>* _checkingContexts; // 0x18
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_823894195270E22F*>* _commonContexts; // 0x20
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_685AC11A7FB5C953*>* _controlContexts; // 0x28
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_E4E9271419E7BF1D*>* _rotationContexts; // 0x30
		...
		::System::Void AddDebugger(::Class_0_16E4307DCC419505_653* debugger)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_653*))((::PBYTE)hIl2Cpp + MOLEMOLE_SLIDINGSUBSYSTEM_ADDDEBUGGER_OFFSET))(this, debugger);
		}

		::System::Void RemoveDebugger(::Class_0_16E4307DCC419505_653* debugger)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_653*))((::PBYTE)hIl2Cpp + MOLEMOLE_SLIDINGSUBSYSTEM_REMOVEDEBUGGER_OFFSET))(this, debugger);
		}
		...
		static ::System::Void FixedUpdateCheckingContext(::System::UInt32 entityId, ::Class_1_AE8977CC8DFA35ED* context, ::System::Single deltaTime)
		{
			return ((::System::Void(*)(::System::UInt32, ::Class_1_AE8977CC8DFA35ED*, ::System::Single))((::PBYTE)hIl2Cpp + MOLEMOLE_SLIDINGSUBSYSTEM_FIXEDUPDATECHECKINGCONTEXT_OFFSET))(entityId, context, deltaTime);
		}
