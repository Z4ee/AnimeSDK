...
#define MOLEMOLE_UINONSAFEAREAHANDLER_METHOD_6_4B72F72501001F72_OFFSET UNITYSDK_OFFSET(0x16A6AB40)
#define MOLEMOLE_UINONSAFEAREAHANDLER_METHOD_6_777C630B90A28EF1_OFFSET UNITYSDK_OFFSET(0x16A69A70)
#define MOLEMOLE_UINONSAFEAREAHANDLER_METHOD_6_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x16A6AD40)
#define MOLEMOLE_UINONSAFEAREAHANDLER_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x16A6AD50)
#define MOLEMOLE_UINONSAFEAREAHANDLER_METHOD_6_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x16A6AD90)
#define MOLEMOLE_UINONSAFEAREAHANDLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16A69760)
#define MOLEMOLE_UINONSAFEAREAHANDLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x16A697F0)
#define MOLEMOLE_UINONSAFEAREAHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16A69990)
#define MOLEMOLE_UINONSAFEAREAHANDLER___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16A699E0)

namespace MoleMole
{
	inline static constexpr unsigned int UINonSafeAreaHandler_TypeDefinitionIndex = 81467;

	class UINonSafeAreaHandler : public ::UnityEngine::EventSystems::UIBehaviour
	{
	public:
		::UnityEngine::Canvas* Field_6_2; // 0x18
		::System::Boolean Field_6_1; // 0x20
		::System::Boolean Field_6_0; // 0x21
