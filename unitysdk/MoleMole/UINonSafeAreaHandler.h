...
#define MOLEMOLE_UINONSAFEAREAHANDLER_METHOD_6_4B72F72501001F72_OFFSET UNITYSDK_OFFSET(0x13DF0CA0)
#define MOLEMOLE_UINONSAFEAREAHANDLER_METHOD_6_777C630B90A28EF1_OFFSET UNITYSDK_OFFSET(0x13DF0EB0)
#define MOLEMOLE_UINONSAFEAREAHANDLER_METHOD_6_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x13DF0EA0)
#define MOLEMOLE_UINONSAFEAREAHANDLER_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x13DF0C60)
#define MOLEMOLE_UINONSAFEAREAHANDLER_METHOD_6_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x13DF0C50)
#define MOLEMOLE_UINONSAFEAREAHANDLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x13DF0950)
#define MOLEMOLE_UINONSAFEAREAHANDLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x13DF09E0)
#define MOLEMOLE_UINONSAFEAREAHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x13DF0B70)
#define MOLEMOLE_UINONSAFEAREAHANDLER___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x13DF0BC0)

namespace MoleMole
{
	inline static constexpr unsigned int UINonSafeAreaHandler_TypeDefinitionIndex = 49313;
