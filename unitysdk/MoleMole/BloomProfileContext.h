...
#define MOLEMOLE_BLOOMPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x12C53900)

namespace MoleMole
{
	inline static constexpr unsigned int BloomProfileContext_TypeDefinitionIndex = 41235;
