...
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_AWAKE_OFFSET UNITYSDK_OFFSET(0x10D820E0)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_CHECKSKIPSTATE_OFFSET UNITYSDK_OFFSET(0x10D83840)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_CLEAR_OFFSET UNITYSDK_OFFSET(0x10D828B0)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_GETMYSTATE_OFFSET UNITYSDK_OFFSET(0x10D82CA0)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_GETNAVMESHMARKTYPE_OFFSET UNITYSDK_OFFSET(0x1A1A8680)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_GETOBJECTTAG_OFFSET UNITYSDK_OFFSET(0x1A1A81A0)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_GETOBJECT_OFFSET UNITYSDK_OFFSET(0x1A1A82A0)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_GETTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A1A86D0)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_GET_CURRENTSTATE_OFFSET UNITYSDK_OFFSET(0x10D820B0)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_GET_PLAYERDEBUGER_OFFSET UNITYSDK_OFFSET(0x10D820D0)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_GET_SCREENPLAYER_OFFSET UNITYSDK_OFFSET(0x10D820C0)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_INITSTATE_OFFSET UNITYSDK_OFFSET(0x10D82730)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_ISAIMOVEAVATAR_OFFSET UNITYSDK_OFFSET(0x10D83890)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_ISTRIGGERMAINAVATAR_OFFSET UNITYSDK_OFFSET(0x10D83A50)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_METHOD_5_39590AB2089F9F4D_OFFSET UNITYSDK_OFFSET(0x1A1A91A0)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_METHOD_5_4AE12A74BA72900C_OFFSET UNITYSDK_OFFSET(0x1A1A9160)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_METHOD_5_8CE0803574BB66D7_OFFSET UNITYSDK_OFFSET(0x1A1A9260)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1A1A8B10)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_METHOD_5_B877181B6123B7F6_OFFSET UNITYSDK_OFFSET(0x1A1A8BE0)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_METHOD_5_BE3D9E3E7CF500DE_OFFSET UNITYSDK_OFFSET(0x1A1A8A50)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_METHOD_5_BF3A97FF800F0C24_OFFSET UNITYSDK_OFFSET(0x1A1A9100)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_METHOD_5_D574BC288810C776_OFFSET UNITYSDK_OFFSET(0x1A1A8770)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_METHOD_5_D81F2F1683EA3F25_OFFSET UNITYSDK_OFFSET(0x1A1A92C0)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_METHOD_5_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0x1A1A93D0)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_METHOD_5_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0x1A1A7F80)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_ONBECAMEINVISIBLE_OFFSET UNITYSDK_OFFSET(0x1A1A7E10)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_ONBECAMEVISIBLE_OFFSET UNITYSDK_OFFSET(0x10D840A0)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x10D84050)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x10D83380)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_ONENABLE_OFFSET UNITYSDK_OFFSET(0x10D83230)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_ONLEAVESCENE_OFFSET UNITYSDK_OFFSET(0x10D83C60)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x10D834D0)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_REGISTERWIDGET_OFFSET UNITYSDK_OFFSET(0x10D822B0)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_RESETACTIVE_OFFSET UNITYSDK_OFFSET(0x1A1A8570)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_RESETINITSTATE_OFFSET UNITYSDK_OFFSET(0x1A1A7E80)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_RESETPOSITION_OFFSET UNITYSDK_OFFSET(0x1A1A7ED0)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_RUNINCG_OFFSET UNITYSDK_OFFSET(0x10D82910)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_SETACCESSORYLODLEVEL_OFFSET UNITYSDK_OFFSET(0x1A1A85D0)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_SETACTIVE_OFFSET UNITYSDK_OFFSET(0x1A1A82F0)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_SETDYNAMICWIDGET_OFFSET UNITYSDK_OFFSET(0x10D82590)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_SETMAINCITYID_OFFSET UNITYSDK_OFFSET(0x10D82800)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_STARTWIDGETLOGIC_OFFSET UNITYSDK_OFFSET(0x10D82540)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_START_OFFSET UNITYSDK_OFFSET(0x10D824F0)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_STOPWITHTIMELINE_OFFSET UNITYSDK_OFFSET(0x10D82C10)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_SWITCHSTATE_1_OFFSET UNITYSDK_OFFSET(0x10D83610)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_SWITCHSTATE_OFFSET UNITYSDK_OFFSET(0x10D83520)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET_UPDATEWITHTIMELINE_OFFSET UNITYSDK_OFFSET(0x10D82BB0)
#define MOLEMOLE_SCENEOBJECTSTATEWIDGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A8720)

namespace MoleMole
{
	inline static constexpr unsigned int SceneObjectStateWidget_TypeDefinitionIndex = 74522;
