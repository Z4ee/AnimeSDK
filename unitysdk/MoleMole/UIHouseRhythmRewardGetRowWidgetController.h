...
#define MOLEMOLE_UIHOUSERHYTHMREWARDGETROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15FB4480)
#define MOLEMOLE_UIHOUSERHYTHMREWARDGETROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15FB44F0)
#define MOLEMOLE_UIHOUSERHYTHMREWARDGETROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15FB4590)
#define MOLEMOLE_UIHOUSERHYTHMREWARDGETROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x15FB4650)
#define MOLEMOLE_UIHOUSERHYTHMREWARDGETROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15FB47D0)
#define MOLEMOLE_UIHOUSERHYTHMREWARDGETROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15FB47E0)
#define MOLEMOLE_UIHOUSERHYTHMREWARDGETROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15FB4880)

namespace MoleMole
{
	inline static constexpr unsigned int UIHouseRhythmRewardGetRowWidgetController_TypeDefinitionIndex = 63545;
