...
#define MOLEMOLE_UIHOUSERHYTHMREWARDGETROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16F95140)
#define MOLEMOLE_UIHOUSERHYTHMREWARDGETROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16F951B0)
#define MOLEMOLE_UIHOUSERHYTHMREWARDGETROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16F95250)
#define MOLEMOLE_UIHOUSERHYTHMREWARDGETROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x16F95310)
#define MOLEMOLE_UIHOUSERHYTHMREWARDGETROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16F95490)
#define MOLEMOLE_UIHOUSERHYTHMREWARDGETROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16F954A0)
#define MOLEMOLE_UIHOUSERHYTHMREWARDGETROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16F95540)

namespace MoleMole
{
	inline static constexpr unsigned int UIHouseRhythmRewardGetRowWidgetController_TypeDefinitionIndex = 63714;
