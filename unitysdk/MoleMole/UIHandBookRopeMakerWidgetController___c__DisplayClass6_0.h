...
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1882B1F0)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER___C__DISPLAYCLASS6_0__ONGAMEPADMODULEFOCUS_B__0_OFFSET UNITYSDK_OFFSET(0x1882B200)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER___C__DISPLAYCLASS6_0__ONGAMEPADMODULEFOCUS_B__1_OFFSET UNITYSDK_OFFSET(0x1882B280)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookRopeMakerWidgetController___c__DisplayClass6_0_TypeDefinitionIndex = 67603;
