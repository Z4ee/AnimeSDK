...
#define MOLEMOLE_TWEENALPHA_BEGIN_OFFSET UNITYSDK_OFFSET(0x15E61DD0)
#define MOLEMOLE_TWEENALPHA_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x15E61940)
#define MOLEMOLE_TWEENALPHA_METHOD_7_0B99C03107E8A6B9_OFFSET UNITYSDK_OFFSET(0x15E61B90)
#define MOLEMOLE_TWEENALPHA_METHOD_7_50C397B5C3CE86EA_OFFSET UNITYSDK_OFFSET(0x15E62010)
#define MOLEMOLE_TWEENALPHA_METHOD_7_71AD79076E016A6C_OFFSET UNITYSDK_OFFSET(0x15E61CF0)
#define MOLEMOLE_TWEENALPHA_METHOD_7_CD2EC0D03CAA1ECD_OFFSET UNITYSDK_OFFSET(0x15E619C0)
#define MOLEMOLE_TWEENALPHA_METHOD_7_F46FD0FF6D95C209_OFFSET UNITYSDK_OFFSET(0x15E617B0)
#define MOLEMOLE_TWEENALPHA_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x15E61950)
#define MOLEMOLE_TWEENALPHA_START_OFFSET UNITYSDK_OFFSET(0x15E61610)
#define MOLEMOLE_TWEENALPHA__CTOR_OFFSET UNITYSDK_OFFSET(0x15E61F50)
#define MOLEMOLE_TWEENALPHA___BASE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x15E61F70)
#define MOLEMOLE_TWEENALPHA___BASE_START_OFFSET UNITYSDK_OFFSET(0x15E61F80)

namespace MoleMole
{
	inline static constexpr unsigned int TweenAlpha_TypeDefinitionIndex = 65773;
