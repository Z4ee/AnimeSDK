...
#define MOLEMOLE_DYNAMICOBJECT_GETOBJECTTAG_OFFSET UNITYSDK_OFFSET(0x15A08110)
#define MOLEMOLE_DYNAMICOBJECT_GETOBJECT_OFFSET UNITYSDK_OFFSET(0x15A08220)
#define MOLEMOLE_DYNAMICOBJECT_RESETACTIVE_OFFSET UNITYSDK_OFFSET(0x15A084C0)
#define MOLEMOLE_DYNAMICOBJECT_SETACTIVE_OFFSET UNITYSDK_OFFSET(0x15A08270)
#define MOLEMOLE_DYNAMICOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x15A08500)

namespace MoleMole
{
	inline static constexpr unsigned int DynamicObject_TypeDefinitionIndex = 39995;
