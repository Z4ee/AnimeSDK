...
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER_CHECKEQUIPSAVE_OFFSET UNITYSDK_OFFSET(0x17BD2620)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER_GETMAXSKILLLEVEL_OFFSET UNITYSDK_OFFSET(0x17BD1720)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER_GETSKILLLEVEL_OFFSET UNITYSDK_OFFSET(0x17BD1690)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x17BCC680)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER_ONCLICKPROPERTYTABBTN_OFFSET UNITYSDK_OFFSET(0x17BD2BE0)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER_ONCLICKSUITTABBTN_OFFSET UNITYSDK_OFFSET(0x17BD2B60)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17BCCBA0)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x17BCCC30)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER_ONROLETOGGLEVALUE_OFFSET UNITYSDK_OFFSET(0x17BD1050)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17BCD040)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17BCC690)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17BCC920)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER_ONWEAPONTOGGLEVALUE_OFFSET UNITYSDK_OFFSET(0x17BD1370)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER_REFRESHAVATARTYPEVIEW_OFFSET UNITYSDK_OFFSET(0x17BCD0B0)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER_REFRESHPROPERTYINFOVIEW_OFFSET UNITYSDK_OFFSET(0x17BD1D60)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER_REFRESHSKILLTYPEVIEW_OFFSET UNITYSDK_OFFSET(0x17BCE850)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER_REFRESHSLOTPROPERTYINFO_OFFSET UNITYSDK_OFFSET(0x17BD2150)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER_REFRESHSUITINFOVIEW_OFFSET UNITYSDK_OFFSET(0x17BD1AB0)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER_REFRESHSUITTYPEVIEW_OFFSET UNITYSDK_OFFSET(0x17BCFDC0)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x17BCCA10)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER_SAVECUSTOMPLAN_OFFSET UNITYSDK_OFFSET(0x17BD2420)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17BD2C60)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER__SAVECUSTOMPLAN_B__29_0_OFFSET UNITYSDK_OFFSET(0x17BD2C70)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER__SAVECUSTOMPLAN_B__29_1_OFFSET UNITYSDK_OFFSET(0x17BD3390)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER__SAVECUSTOMPLAN_B__29_2_OFFSET UNITYSDK_OFFSET(0x17BD33A0)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER__SAVECUSTOMPLAN_B__29_3_OFFSET UNITYSDK_OFFSET(0x17BD33B0)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17BD33C0)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x17BD3450)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17BD3500)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17BD3510)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17BD3520)

namespace MoleMole
{
	inline static constexpr unsigned int UIWishlistCustomPlanSettingPopWindowController_TypeDefinitionIndex = 87236;

	class UIWishlistCustomPlanSettingPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_21A7ACA4473668F9_1* _view; // 0x318
		::MoleMole::UIWishlistCustomPlanSettingPopWindowContext* _context; // 0x320
		::Class_2_1824EF69C8E376A3* _avatarData; // 0x328
		::Class_3_36FF8167703D4259* _wishlistCustomPlan; // 0x330
