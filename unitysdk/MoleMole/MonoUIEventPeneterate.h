...
#define MOLEMOLE_MONOUIEVENTPENETERATE_ONPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x16CDD750)
#define MOLEMOLE_MONOUIEVENTPENETERATE_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x16CDD880)
#define MOLEMOLE_MONOUIEVENTPENETERATE_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x16CDD980)
#define MOLEMOLE_MONOUIEVENTPENETERATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16CDDA80)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIEventPeneterate_TypeDefinitionIndex = 85206;
