...
class Class_2_4AE56F9D3AA15D7C;
namespace MoleMole { class UIControlReference; }
namespace System { class Object; }

#define MOLEMOLE_UIBOSSCHALLENGEHISTORYROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15ACA1E0)
#define MOLEMOLE_UIBOSSCHALLENGEHISTORYROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15ACA2B0)
#define MOLEMOLE_UIBOSSCHALLENGEHISTORYROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15ACA370)
#define MOLEMOLE_UIBOSSCHALLENGEHISTORYROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15ACA250)
#define MOLEMOLE_UIBOSSCHALLENGEHISTORYROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15ACA510)
#define MOLEMOLE_UIBOSSCHALLENGEHISTORYROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15ACA520)
#define MOLEMOLE_UIBOSSCHALLENGEHISTORYROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15ACA5C0)
#define MOLEMOLE_UIBOSSCHALLENGEHISTORYROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15ACA660)

namespace MoleMole
{
	inline static constexpr unsigned int UIBossChallengeHistoryRowWidgetController_TypeDefinitionIndex = 44844;
	...
	public:
		...
		::Class_2_4AE56F9D3AA15D7C* get__viewModel()
		{
			return ((::Class_2_4AE56F9D3AA15D7C*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBOSSCHALLENGEHISTORYROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
