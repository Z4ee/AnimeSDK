...
#define MOLEMOLE_SLIDINGCONFIG_GETACCELERATION_OFFSET UNITYSDK_OFFSET(0x11DF9610)
#define MOLEMOLE_SLIDINGCONFIG_GETCHECKINGRAYCASTLENGTH_OFFSET UNITYSDK_OFFSET(0x11DF9A20)
#define MOLEMOLE_SLIDINGCONFIG_GETFRICTION_OFFSET UNITYSDK_OFFSET(0x11DF9490)
#define MOLEMOLE_SLIDINGCONFIG_GETGRAVITY_OFFSET UNITYSDK_OFFSET(0x11DF9B40)
#define MOLEMOLE_SLIDINGCONFIG_GETMAXDELTAANGLEPERSECONDINAIR_OFFSET UNITYSDK_OFFSET(0x11DF99C0)
#define MOLEMOLE_SLIDINGCONFIG_GETMAXDELTAANGLEPERSECOND_OFFSET UNITYSDK_OFFSET(0x11DF9880)
#define MOLEMOLE_SLIDINGCONFIG_GETMAXXZSPEEDTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x11DF97D0)
#define MOLEMOLE_SLIDINGCONFIG_GETMAXYSPEEDTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x11DF9820)
#define MOLEMOLE_SLIDINGCONFIG_GETMINVELOCITYTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x11DF9780)
#define MOLEMOLE_SLIDINGCONFIG_GETSLIDINGDELTATHRESHOLD_OFFSET UNITYSDK_OFFSET(0x11DF9CE0)
#define MOLEMOLE_SLIDINGCONFIG_GETSLIDINGRAYCASTLENGTH2_OFFSET UNITYSDK_OFFSET(0x11DF9A80)
#define MOLEMOLE_SLIDINGCONFIG_GETSLIDINGRAYCASTLENGTH_OFFSET UNITYSDK_OFFSET(0x11DF9AE0)
#define MOLEMOLE_SLIDINGCONFIG_RELOADFROMFILEASYNC_OFFSET UNITYSDK_OFFSET(0x11DF93A0)
#define MOLEMOLE_SLIDINGCONFIG_RELOADFROMFILE_OFFSET UNITYSDK_OFFSET(0x11DF9180)
#define MOLEMOLE_SLIDINGCONFIG_SLIDINGSMOOTHVALUE_OFFSET UNITYSDK_OFFSET(0x11DF9BA0)
#define MOLEMOLE_SLIDINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x11DF9D40)

namespace MoleMole
{
	inline static constexpr unsigned int SlidingConfig_TypeDefinitionIndex = 60260;
	...
	public:
		...
		{
			return (::MoleMole::SlidingConfig**)Il2CppClass::FromTypeDefinitionIndex(SlidingConfig_TypeDefinitionIndex)->GetStaticField(0x3EC10);
		}
