...
#define MOLEMOLE_SLIDINGCONFIG_GETACCELERATION_OFFSET UNITYSDK_OFFSET(0x11D70BF0)
#define MOLEMOLE_SLIDINGCONFIG_GETCHECKINGRAYCASTLENGTH_OFFSET UNITYSDK_OFFSET(0x11D71000)
#define MOLEMOLE_SLIDINGCONFIG_GETFRICTION_OFFSET UNITYSDK_OFFSET(0x11D70A70)
#define MOLEMOLE_SLIDINGCONFIG_GETGRAVITY_OFFSET UNITYSDK_OFFSET(0x11D71120)
#define MOLEMOLE_SLIDINGCONFIG_GETMAXDELTAANGLEPERSECONDINAIR_OFFSET UNITYSDK_OFFSET(0x11D70FA0)
#define MOLEMOLE_SLIDINGCONFIG_GETMAXDELTAANGLEPERSECOND_OFFSET UNITYSDK_OFFSET(0x11D70E60)
#define MOLEMOLE_SLIDINGCONFIG_GETMAXXZSPEEDTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x11D70DB0)
#define MOLEMOLE_SLIDINGCONFIG_GETMAXYSPEEDTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x11D70E00)
#define MOLEMOLE_SLIDINGCONFIG_GETMINVELOCITYTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x11D70D60)
#define MOLEMOLE_SLIDINGCONFIG_GETSLIDINGDELTATHRESHOLD_OFFSET UNITYSDK_OFFSET(0x11D712C0)
#define MOLEMOLE_SLIDINGCONFIG_GETSLIDINGRAYCASTLENGTH2_OFFSET UNITYSDK_OFFSET(0x11D71060)
#define MOLEMOLE_SLIDINGCONFIG_GETSLIDINGRAYCASTLENGTH_OFFSET UNITYSDK_OFFSET(0x11D710C0)
#define MOLEMOLE_SLIDINGCONFIG_RELOADFROMFILEASYNC_OFFSET UNITYSDK_OFFSET(0x11D70980)
#define MOLEMOLE_SLIDINGCONFIG_RELOADFROMFILE_OFFSET UNITYSDK_OFFSET(0x11D70760)
#define MOLEMOLE_SLIDINGCONFIG_SLIDINGSMOOTHVALUE_OFFSET UNITYSDK_OFFSET(0x11D71180)
#define MOLEMOLE_SLIDINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x11D71320)

namespace MoleMole
{
	inline static constexpr unsigned int SlidingConfig_TypeDefinitionIndex = 58770;
	...
	public:
		...
		{
			return (::MoleMole::SlidingConfig**)Il2CppClass::FromTypeDefinitionIndex(SlidingConfig_TypeDefinitionIndex)->GetStaticField(0x427F0);
		}
