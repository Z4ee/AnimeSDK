...
#define MOLEMOLE_UIBABELTOWERMENUPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x18C82F90)
#define MOLEMOLE_UIBABELTOWERMENUPAGECONTROLLER_ONBABELTOWERCLICK_OFFSET UNITYSDK_OFFSET(0x18C842B0)
#define MOLEMOLE_UIBABELTOWERMENUPAGECONTROLLER_ONBABELTOWERUPDATE_OFFSET UNITYSDK_OFFSET(0x18C84110)
#define MOLEMOLE_UIBABELTOWERMENUPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18C83040)
#define MOLEMOLE_UIBABELTOWERMENUPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x18C845F0)
#define MOLEMOLE_UIBABELTOWERMENUPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18C84640)
#define MOLEMOLE_UIBABELTOWERMENUPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18C831A0)
#define MOLEMOLE_UIBABELTOWERMENUPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18C830D0)
#define MOLEMOLE_UIBABELTOWERMENUPAGECONTROLLER_REFRESHNEW_OFFSET UNITYSDK_OFFSET(0x18C83600)
#define MOLEMOLE_UIBABELTOWERMENUPAGECONTROLLER_REFRESHREDPOINT_OFFSET UNITYSDK_OFFSET(0x18C83CA0)
#define MOLEMOLE_UIBABELTOWERMENUPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x18C82FA0)
#define MOLEMOLE_UIBABELTOWERMENUPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18C846B0)
#define MOLEMOLE_UIBABELTOWERMENUPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18C846C0)
#define MOLEMOLE_UIBABELTOWERMENUPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x18C84750)
#define MOLEMOLE_UIBABELTOWERMENUPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18C84760)
#define MOLEMOLE_UIBABELTOWERMENUPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18C84770)
#define MOLEMOLE_UIBABELTOWERMENUPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18C84780)
#define MOLEMOLE_UIBABELTOWERMENUPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x18C84790)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerMenuPageController_TypeDefinitionIndex = 63502;
