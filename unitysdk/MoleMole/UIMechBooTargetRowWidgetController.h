...
#define MOLEMOLE_UIMECHBOOTARGETROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14D84C40)
#define MOLEMOLE_UIMECHBOOTARGETROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14D84CD0)
#define MOLEMOLE_UIMECHBOOTARGETROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14D84B70)
#define MOLEMOLE_UIMECHBOOTARGETROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14D84BD0)
#define MOLEMOLE_UIMECHBOOTARGETROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x14D84D50)
#define MOLEMOLE_UIMECHBOOTARGETROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14D84FD0)
#define MOLEMOLE_UIMECHBOOTARGETROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14D85030)
#define MOLEMOLE_UIMECHBOOTARGETROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14D850C0)
#define MOLEMOLE_UIMECHBOOTARGETROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14D85150)
#define MOLEMOLE_UIMECHBOOTARGETROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14D851E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechBooTargetRowWidgetController_TypeDefinitionIndex = 82962;

	class UIMechBooTargetRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_E97FB7F54C9FC5B2* _view; // 0x2B8
