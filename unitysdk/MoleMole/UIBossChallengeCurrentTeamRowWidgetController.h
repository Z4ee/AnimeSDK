...
#define MOLEMOLE_UIBOSSCHALLENGECURRENTTEAMROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17F5A5D0)
#define MOLEMOLE_UIBOSSCHALLENGECURRENTTEAMROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17F5A640)
#define MOLEMOLE_UIBOSSCHALLENGECURRENTTEAMROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17F5A700)
#define MOLEMOLE_UIBOSSCHALLENGECURRENTTEAMROWWIDGETCONTROLLER_SETLAYER_OFFSET UNITYSDK_OFFSET(0x17F5A810)
#define MOLEMOLE_UIBOSSCHALLENGECURRENTTEAMROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17F5AAA0)
#define MOLEMOLE_UIBOSSCHALLENGECURRENTTEAMROWWIDGETCONTROLLER__ONUIINIT_B__3_0_OFFSET UNITYSDK_OFFSET(0x17F5AB00)
#define MOLEMOLE_UIBOSSCHALLENGECURRENTTEAMROWWIDGETCONTROLLER__ONUIINIT_B__3_1_OFFSET UNITYSDK_OFFSET(0x17F5AB70)
#define MOLEMOLE_UIBOSSCHALLENGECURRENTTEAMROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17F5ABE0)
#define MOLEMOLE_UIBOSSCHALLENGECURRENTTEAMROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17F5AC80)

namespace MoleMole
{
	inline static constexpr unsigned int UIBossChallengeCurrentTeamRowWidgetController_TypeDefinitionIndex = 71365;
