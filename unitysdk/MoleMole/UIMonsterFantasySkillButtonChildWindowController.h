...
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x19017D90)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19017DA0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_INITBTN_OFFSET UNITYSDK_OFFSET(0x19018B50)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_ISSHOWCURSKILLINFO_OFFSET UNITYSDK_OFFSET(0x19019D40)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19017EB0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_ONLONGPRESSING_OFFSET UNITYSDK_OFFSET(0x12FCD340)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_ONPREVIEWCHANGE_OFFSET UNITYSDK_OFFSET(0x190196F0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x19017E10)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_ONSPCHANGE_OFFSET UNITYSDK_OFFSET(0x19019310)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19018640)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_RESETPRESS_OFFSET UNITYSDK_OFFSET(0x12FCD650)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_SETIMGMATERIAL_OFFSET UNITYSDK_OFFSET(0x190193F0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_TOGGLESKILLINFO_OFFSET UNITYSDK_OFFSET(0x19019BF0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_TRIGGERCLICK_OFFSET UNITYSDK_OFFSET(0x12FCD2D0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12FCD820)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER__INITBTN_B__26_0_OFFSET UNITYSDK_OFFSET(0x12FCDFF0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER__INITBTN_B__26_1_OFFSET UNITYSDK_OFFSET(0x12FCED90)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER__ONCREATEVIEWMODEL_B__24_0_OFFSET UNITYSDK_OFFSET(0x12FCDBE0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER__ONCREATEVIEWMODEL_B__24_1_OFFSET UNITYSDK_OFFSET(0x12FCDBF0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER__ONCREATEVIEWMODEL_B__24_2_OFFSET UNITYSDK_OFFSET(0x12FCDC20)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER__ONCREATEVIEWMODEL_B__24_3_OFFSET UNITYSDK_OFFSET(0x12FCDEA0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x12FCF040)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x12FCF0E0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12FCF0F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasySkillButtonChildWindowController_TypeDefinitionIndex = 82312;
