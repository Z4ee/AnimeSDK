...
#define MOLEMOLE_SPLINE_NAPPOINTMETAPLUGIN_CURVEMOVE_GET_IGNOREWHENMOVE_OFFSET UNITYSDK_OFFSET(0x13049A70)
#define MOLEMOLE_SPLINE_NAPPOINTMETAPLUGIN_CURVEMOVE_GET_NAME_1_OFFSET UNITYSDK_OFFSET(0x13049A30)
#define MOLEMOLE_SPLINE_NAPPOINTMETAPLUGIN_CURVEMOVE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x130499F0)
#define MOLEMOLE_SPLINE_NAPPOINTMETAPLUGIN_CURVEMOVE_GET_REVERTORIENTATIONAXIS_OFFSET UNITYSDK_OFFSET(0x13049A80)
#define MOLEMOLE_SPLINE_NAPPOINTMETAPLUGIN_CURVEMOVE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x13049CC0)
#define MOLEMOLE_SPLINE_NAPPOINTMETAPLUGIN_CURVEMOVE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x13049AE0)
#define MOLEMOLE_SPLINE_NAPPOINTMETAPLUGIN_CURVEMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x13049E90)
#define MOLEMOLE_SPLINE_NAPPOINTMETAPLUGIN_CURVEMOVE___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x13049F30)
#define MOLEMOLE_SPLINE_NAPPOINTMETAPLUGIN_CURVEMOVE___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x13049F40)

namespace MoleMole::Spline
{
	inline static constexpr unsigned int NapPointMetaPlugin_CurveMove_TypeDefinitionIndex = 69314;
