...
#define MOLEMOLE_SPLINE_NAPSPLINEMETAPLUGIN_ZIPLINE_GET_INVALID_OFFSET UNITYSDK_OFFSET(0x16890250)
#define MOLEMOLE_SPLINE_NAPSPLINEMETAPLUGIN_ZIPLINE_GET_NAME_1_OFFSET UNITYSDK_OFFSET(0x16890210)
#define MOLEMOLE_SPLINE_NAPSPLINEMETAPLUGIN_ZIPLINE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x168901D0)
#define MOLEMOLE_SPLINE_NAPSPLINEMETAPLUGIN_ZIPLINE_POPBACKSTAGECOMPONENT_OFFSET UNITYSDK_OFFSET(0x16890320)
#define MOLEMOLE_SPLINE_NAPSPLINEMETAPLUGIN_ZIPLINE_PUSHBACKSTAGECOMPONENT_OFFSET UNITYSDK_OFFSET(0x16890270)
#define MOLEMOLE_SPLINE_NAPSPLINEMETAPLUGIN_ZIPLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x168903B0)

namespace MoleMole::Spline
{
	inline static constexpr unsigned int NAPSplineMetaPlugin_ZipLine_TypeDefinitionIndex = 79272;

	class NAPSplineMetaPlugin_ZipLine : public ::MoleMole::Spline::NAPSplineMetaPluginBase
	{
	public:
		::System::String* patternKey; // 0x38
		::System::Boolean MuteSwitch; // 0x40
		::System::Boolean MuteTurnBack; // 0x41
		::System::Boolean MuteExit; // 0x42
		::System::Boolean BlockGroupStreaming; // 0x43
		::System::Collections::Generic::List_1<::Class_3_EE08C76A2B86637F*>* Field_8_11; // 0x48
