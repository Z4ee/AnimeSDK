...
#define MOLEMOLE_UITOKENDIALOGCONFIG_GET_UITYPE_OFFSET UNITYSDK_OFFSET(0x126A6120)
#define MOLEMOLE_UITOKENDIALOGCONFIG_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x126A64F0)
#define MOLEMOLE_UITOKENDIALOGCONFIG_METHOD_1_AC258D21B34819E7_OFFSET UNITYSDK_OFFSET(0x126A62A0)
#define MOLEMOLE_UITOKENDIALOGCONFIG_SET_UITYPE_OFFSET UNITYSDK_OFFSET(0x126A6220)
#define MOLEMOLE_UITOKENDIALOGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x126A6290)

namespace MoleMole
{
	inline static constexpr unsigned int UITokenDialogConfig_TypeDefinitionIndex = 47385;
