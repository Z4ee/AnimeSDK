...
#define MOLEMOLE_DYNAMICBONEPARASWITCH_AWAKE_OFFSET UNITYSDK_OFFSET(0x14883A50)
#define MOLEMOLE_DYNAMICBONEPARASWITCH_CHANGEIMMPART_OFFSET UNITYSDK_OFFSET(0x148836B0)
#define MOLEMOLE_DYNAMICBONEPARASWITCH_DEALDAMPINGUPDATE_OFFSET UNITYSDK_OFFSET(0x14883D10)
#define MOLEMOLE_DYNAMICBONEPARASWITCH_DEALELASTICITY_OFFSET UNITYSDK_OFFSET(0x14883E30)
#define MOLEMOLE_DYNAMICBONEPARASWITCH_DEALINERT_OFFSET UNITYSDK_OFFSET(0x14884070)
#define MOLEMOLE_DYNAMICBONEPARASWITCH_DEALSTIFFNESS_OFFSET UNITYSDK_OFFSET(0x14883F50)
#define MOLEMOLE_DYNAMICBONEPARASWITCH_DORECORD_OFFSET UNITYSDK_OFFSET(0x148837F0)
#define MOLEMOLE_DYNAMICBONEPARASWITCH_SWITCHTOKEY_OFFSET UNITYSDK_OFFSET(0x148834F0)
#define MOLEMOLE_DYNAMICBONEPARASWITCH_TRYTEST_OFFSET UNITYSDK_OFFSET(0x148834A0)
#define MOLEMOLE_DYNAMICBONEPARASWITCH_UPDATE_OFFSET UNITYSDK_OFFSET(0x14883C20)
#define MOLEMOLE_DYNAMICBONEPARASWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x14884190)

namespace MoleMole
{
	inline static constexpr unsigned int DynamicBoneParaSwitch_TypeDefinitionIndex = 48162;
