...
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_CREATEFUNC_OFFSET UNITYSDK_OFFSET(0x15D67650)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_CREATEITEMFUNC_OFFSET UNITYSDK_OFFSET(0x15D68330)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_GETDEFAULTINDEX_OFFSET UNITYSDK_OFFSET(0x15D68140)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_GETITEMWIDGET_OFFSET UNITYSDK_OFFSET(0x15D677B0)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15D66500)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_ONCLICKSUBLIMEBTN_OFFSET UNITYSDK_OFFSET(0x15D683F0)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15D66510)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x15D67220)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_ONSELECTCHILD_OFFSET UNITYSDK_OFFSET(0x15D67710)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15D67480)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15D665A0)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15D66A20)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_REFRESHMESSAGELIST_OFFSET UNITYSDK_OFFSET(0x15D67090)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_REFRESHRIGHTINFO_OFFSET UNITYSDK_OFFSET(0x15D679B0)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_REFRESHTOKENITEM_OFFSET UNITYSDK_OFFSET(0x15D66B10)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15D686A0)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER__ONCLICKSUBLIMEBTN_B__21_0_OFFSET UNITYSDK_OFFSET(0x15D688E0)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER__REFRESHMESSAGELIST_B__18_0_OFFSET UNITYSDK_OFFSET(0x15D68730)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15D68B30)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x15D68BC0)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15D68C50)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15D68C60)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15D68C70)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastMessagePageController_TypeDefinitionIndex = 59629;
	...
	public:
		...
		::Class_2_736D160283864BFA* _view; // 0x310
		::Class_2_B1555FA59A3F87CE* _model; // 0x318
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_34*>* _curList; // 0x320
		::MoleMole::UIOverlordFeastMessageRowWidgetController* _curSelectRow; // 0x328
		::MoleMole::UIOverlordFeastMessagePageContext* _context; // 0x330
		...
		{
			return ((::MoleMole::ScrollViewItemWidgetController*(*)(::PVOID, ::Enum_3_81A3942BCC6E42B5, ::System::Func_1<::MoleMole::UIControlReference*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_CREATEFUNC_OFFSET))(this, arg1, arg2);
		}
		...
		::System::Void RefreshRightInfo(::Class_2_208CC9941471731A_34* devConfig)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_34*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_REFRESHRIGHTINFO_OFFSET))(this, devConfig);
		}
		...
		::System::Int32 _RefreshMessageList_b__18_0(::Class_2_208CC9941471731A_34* a, ::Class_2_208CC9941471731A_34* b)
		{
			return ((::System::Int32(*)(::PVOID, ::Class_2_208CC9941471731A_34*, ::Class_2_208CC9941471731A_34*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER__REFRESHMESSAGELIST_B__18_0_OFFSET))(this, a, b);
		}
