...
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_DOPLAYPROGRESSANIM_OFFSET UNITYSDK_OFFSET(0x1673CF20)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_DOREFRESHVIEWWITHLEVELUPGRADE_OFFSET UNITYSDK_OFFSET(0x1673CC10)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_DOREFRESHVIEWWITHOUTLEVELUPGRADE_OFFSET UNITYSDK_OFFSET(0x1673C3D0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_GETLEVELICONSTATE_OFFSET UNITYSDK_OFFSET(0x1673D210)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_GETNUMIMGPATH_OFFSET UNITYSDK_OFFSET(0x1673D270)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_GETREMAPPEDPROGRESS_OFFSET UNITYSDK_OFFSET(0x1673D570)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1673C0B0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x1673C1C0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1673C140)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1673BFB0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1673C040)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_PLAYPROGRESSANIM_OFFSET UNITYSDK_OFFSET(0x1673CD10)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1673C310)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_SETPROGRESS_OFFSET UNITYSDK_OFFSET(0x1673D470)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1673D5F0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER__DOREFRESHVIEWWITHOUTLEVELUPGRADE_B__9_0_OFFSET UNITYSDK_OFFSET(0x1673D650)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER__DOREFRESHVIEWWITHOUTLEVELUPGRADE_G__GETRAWIMAGEPATH_9_1_OFFSET UNITYSDK_OFFSET(0x1673D3A0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1673D6B0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x1673D740)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1673D750)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1673D7E0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1673D870)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastLevelWidgetController_TypeDefinitionIndex = 49693;
