...
#define MOLEMOLE_MONOCOLLIDERSMODIFIABLECONTACTS_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1913A560)
#define MOLEMOLE_MONOCOLLIDERSMODIFIABLECONTACTS_START_OFFSET UNITYSDK_OFFSET(0x1913A3C0)
#define MOLEMOLE_MONOCOLLIDERSMODIFIABLECONTACTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1913A700)

namespace MoleMole
{
	inline static constexpr unsigned int MonoCollidersModifiableContacts_TypeDefinitionIndex = 61159;
