...
#define MOLEMOLE_UIQUESTIONSANSWERCONFIGMONO_EMOJIPOSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x13017FB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerConfigMono_EmojiPosInfo_TypeDefinitionIndex = 51760;
