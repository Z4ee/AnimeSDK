...
#define MOLEMOLE_UIRABBOSSTOPTABWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1757B9B0)
#define MOLEMOLE_UIRABBOSSTOPTABWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1757BA20)
#define MOLEMOLE_UIRABBOSSTOPTABWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1757BAC0)
#define MOLEMOLE_UIRABBOSSTOPTABWIDGETCONTROLLER_SETCONTEXT_OFFSET UNITYSDK_OFFSET(0x1757BC80)
#define MOLEMOLE_UIRABBOSSTOPTABWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1757BE00)
#define MOLEMOLE_UIRABBOSSTOPTABWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1757BE60)
#define MOLEMOLE_UIRABBOSSTOPTABWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1757BF00)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABBossTopTabWidgetController_TypeDefinitionIndex = 55276;
