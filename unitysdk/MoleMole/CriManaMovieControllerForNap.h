...
#define MOLEMOLE_CRIMANAMOVIECONTROLLERFORNAP_CLEARPLAYINFO_OFFSET UNITYSDK_OFFSET(0x11040370)
#define MOLEMOLE_CRIMANAMOVIECONTROLLERFORNAP_GET_FILEURL_OFFSET UNITYSDK_OFFSET(0x11040300)
#define MOLEMOLE_CRIMANAMOVIECONTROLLERFORNAP_GET_ISMONOBEHAVIOURSTARTCALLED_OFFSET UNITYSDK_OFFSET(0x11040360)
#define MOLEMOLE_CRIMANAMOVIECONTROLLERFORNAP_GET_VIDEOHEIGHT_OFFSET UNITYSDK_OFFSET(0x11040340)
#define MOLEMOLE_CRIMANAMOVIECONTROLLERFORNAP_GET_VIDEOWIDTH_OFFSET UNITYSDK_OFFSET(0x11040320)
#define MOLEMOLE_CRIMANAMOVIECONTROLLERFORNAP_SET_FILEURL_OFFSET UNITYSDK_OFFSET(0x11040310)
#define MOLEMOLE_CRIMANAMOVIECONTROLLERFORNAP_SET_VIDEOHEIGHT_OFFSET UNITYSDK_OFFSET(0x11040350)
#define MOLEMOLE_CRIMANAMOVIECONTROLLERFORNAP_SET_VIDEOWIDTH_OFFSET UNITYSDK_OFFSET(0x11040330)
#define MOLEMOLE_CRIMANAMOVIECONTROLLERFORNAP__CTOR_OFFSET UNITYSDK_OFFSET(0x110403C0)

namespace MoleMole
{
	inline static constexpr unsigned int CriManaMovieControllerForNap_TypeDefinitionIndex = 38416;
