...
#define MOLEMOLE_CONFIGDYNAMICCHECKTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD7D8D0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigDynamicCheckTree_TypeDefinitionIndex = 62518;
