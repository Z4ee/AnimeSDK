...
#define MOLEMOLE_UIGENERALNEWHINTWIDGETCONTROLLER_ENABLENEW_OFFSET UNITYSDK_OFFSET(0x16A9C390)
#define MOLEMOLE_UIGENERALNEWHINTWIDGETCONTROLLER_GET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x16A9C300)
#define MOLEMOLE_UIGENERALNEWHINTWIDGETCONTROLLER_ISENABLE_OFFSET UNITYSDK_OFFSET(0x16A9CAD0)
#define MOLEMOLE_UIGENERALNEWHINTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16A9C7A0)
#define MOLEMOLE_UIGENERALNEWHINTWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x16A9C8B0)
#define MOLEMOLE_UIGENERALNEWHINTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16A9C830)
#define MOLEMOLE_UIGENERALNEWHINTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16A9C320)
#define MOLEMOLE_UIGENERALNEWHINTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16A9C730)
#define MOLEMOLE_UIGENERALNEWHINTWIDGETCONTROLLER_SETREFNOTIFICATIONNODE_OFFSET UNITYSDK_OFFSET(0x16A9CA80)
#define MOLEMOLE_UIGENERALNEWHINTWIDGETCONTROLLER_SET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x16A9C310)
#define MOLEMOLE_UIGENERALNEWHINTWIDGETCONTROLLER_SHOWREDPOINT_OFFSET UNITYSDK_OFFSET(0x16A9C970)
#define MOLEMOLE_UIGENERALNEWHINTWIDGETCONTROLLER__CACHECLEAN_OFFSET UNITYSDK_OFFSET(0x16A9C920)
#define MOLEMOLE_UIGENERALNEWHINTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16A9CB90)
#define MOLEMOLE_UIGENERALNEWHINTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16A9CC00)
#define MOLEMOLE_UIGENERALNEWHINTWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x16A9CC90)
#define MOLEMOLE_UIGENERALNEWHINTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16A9CCA0)
#define MOLEMOLE_UIGENERALNEWHINTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16A9CD30)
#define MOLEMOLE_UIGENERALNEWHINTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16A9CDC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralNewHintWidgetController_TypeDefinitionIndex = 70908;

	class UIGeneralNewHintWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_670AC8E9FAE34B3B_2* _view; // 0x2C0
