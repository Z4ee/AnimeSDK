...
#define MOLEMOLE_SPINESKELETONRENDERTEXTUREBASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1792E410)
#define MOLEMOLE_SPINESKELETONRENDERTEXTUREBASE_CREATESPINERENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0x1792E740)
#define MOLEMOLE_SPINESKELETONRENDERTEXTUREBASE_METHOD_5_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0x1792E900)
#define MOLEMOLE_SPINESKELETONRENDERTEXTUREBASE_METHOD_5_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0x1792EF70)
#define MOLEMOLE_SPINESKELETONRENDERTEXTUREBASE_METHOD_5_DFFF3EBEA7DBE379_OFFSET UNITYSDK_OFFSET(0x1792F050)
#define MOLEMOLE_SPINESKELETONRENDERTEXTUREBASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1792E4B0)
#define MOLEMOLE_SPINESKELETONRENDERTEXTUREBASE_RELEASESPINERENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0x1792E6D0)
#define MOLEMOLE_SPINESKELETONRENDERTEXTUREBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1792E8A0)

namespace MoleMole
{
	inline static constexpr unsigned int SpineSkeletonRenderTextureBase_TypeDefinitionIndex = 68371;
	...
	public:
		...
		::UnityEngine::Mesh* Field_5_5; // 0x30
		...
		::UnityEngine::Rendering::CommandBuffer* Field_5_9; // 0x50
		::MoleMole::Vector2Int Field_5_8; // 0x58
		::MoleMole::Vector2Int Field_5_15; // 0x60
		::MoleMole::Vector2Int Field_5_14; // 0x68
		::UnityEngine::Vector2 Field_5_13; // 0x70
		...
		::UnityEngine::Vector2 Field_5_23; // 0xB0
		::UnityEngine::Vector2 Field_5_22; // 0xB8
		::UnityEngine::Vector2 Field_5_21; // 0xC0
