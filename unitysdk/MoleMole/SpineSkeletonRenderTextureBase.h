...
#define MOLEMOLE_SPINESKELETONRENDERTEXTUREBASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x10BE9FE0)
#define MOLEMOLE_SPINESKELETONRENDERTEXTUREBASE_CREATESPINERENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0x10BEA310)
#define MOLEMOLE_SPINESKELETONRENDERTEXTUREBASE_METHOD_5_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0x10BEABB0)
#define MOLEMOLE_SPINESKELETONRENDERTEXTUREBASE_METHOD_5_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0x10BEAAD0)
#define MOLEMOLE_SPINESKELETONRENDERTEXTUREBASE_METHOD_5_DFFF3EBEA7DBE379_OFFSET UNITYSDK_OFFSET(0x10BEA4D0)
#define MOLEMOLE_SPINESKELETONRENDERTEXTUREBASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x10BEA080)
#define MOLEMOLE_SPINESKELETONRENDERTEXTUREBASE_RELEASESPINERENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0x10BEA2A0)
#define MOLEMOLE_SPINESKELETONRENDERTEXTUREBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x10BEA470)

namespace MoleMole
{
	inline static constexpr unsigned int SpineSkeletonRenderTextureBase_TypeDefinitionIndex = 71276;
