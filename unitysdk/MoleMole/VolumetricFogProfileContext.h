...
#define MOLEMOLE_VOLUMETRICFOGPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xF3ADB50)

namespace MoleMole
{
	inline static constexpr unsigned int VolumetricFogProfileContext_TypeDefinitionIndex = 48028;
