...
#define MOLEMOLE_VOLUMETRICFOGPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1042B450)

namespace MoleMole
{
	inline static constexpr unsigned int VolumetricFogProfileContext_TypeDefinitionIndex = 67236;
