...
class Class_2_79F6D62CE30E3F8E_187;
...
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_BIND_OFFSET UNITYSDK_OFFSET(0x12E43AE0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_CLEARCARDCONTROLLERS_OFFSET UNITYSDK_OFFSET(0x12E471A0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_CREATESORT_OFFSET UNITYSDK_OFFSET(0x12E45640)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_GETCHILDBOUNDS_OFFSET UNITYSDK_OFFSET(0x12E450B0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_GETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x12E47440)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_GET_ISCARDFOLD_OFFSET UNITYSDK_OFFSET(0x12E47350)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_GET_ISCURSEFOLD_OFFSET UNITYSDK_OFFSET(0x12E47C90)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_GET_ISEFFECTFOLD_OFFSET UNITYSDK_OFFSET(0x12E47BA0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_INITCARD_OFFSET UNITYSDK_OFFSET(0x12E46710)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_INITCURSE_OFFSET UNITYSDK_OFFSET(0x12E43FD0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_INITFOLDBTNSTATE_OFFSET UNITYSDK_OFFSET(0x12E43F60)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_INITHEAT_OFFSET UNITYSDK_OFFSET(0x12E44470)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12E44FA0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_ONFILTERDROPCHANGE_OFFSET UNITYSDK_OFFSET(0x12E46440)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12E45030)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12E43880)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12E438E0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_SETFOLDSTATE_OFFSET UNITYSDK_OFFSET(0x12E47660)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER__BIND_B__9_0_OFFSET UNITYSDK_OFFSET(0x12E48070)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER__BIND_B__9_1_OFFSET UNITYSDK_OFFSET(0x12E480A0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER__BIND_B__9_2_OFFSET UNITYSDK_OFFSET(0x12E480D0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER__CREATESORT_B__7_0_OFFSET UNITYSDK_OFFSET(0x12E47FF0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12E47D80)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12E48100)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12E48190)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12E48220)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12E482B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWholeEffectWidgetController_TypeDefinitionIndex = 89256;

	class UIWholeEffectWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_187* _view; // 0x2C0
