...
#define MOLEMOLE_CAMERAMODULEAVATARDATACONFIG_INNERINIT_OFFSET UNITYSDK_OFFSET(0x17025BC0)
#define MOLEMOLE_CAMERAMODULEAVATARDATACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17025C20)

namespace MoleMole
{
	inline static constexpr unsigned int CameraModuleAvatarDataConfig_TypeDefinitionIndex = 41466;
