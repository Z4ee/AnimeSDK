...
#define MOLEMOLE_CAMERAMODULEAVATARDATACONFIG_INNERINIT_OFFSET UNITYSDK_OFFSET(0x150DC6C0)
#define MOLEMOLE_CAMERAMODULEAVATARDATACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x150DC720)

namespace MoleMole
{
	inline static constexpr unsigned int CameraModuleAvatarDataConfig_TypeDefinitionIndex = 47384;
