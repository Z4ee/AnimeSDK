...
#define MOLEMOLE_SIMPLESTRINGARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x10E4FA60)

namespace MoleMole
{
	inline static constexpr unsigned int SimpleStringArray_TypeDefinitionIndex = 53021;
