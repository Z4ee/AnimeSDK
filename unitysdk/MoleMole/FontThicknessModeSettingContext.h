...
#define MOLEMOLE_FONTTHICKNESSMODESETTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x149E8E10)

namespace MoleMole
{
	inline static constexpr unsigned int FontThicknessModeSettingContext_TypeDefinitionIndex = 51238;
