...
class Class_2_F0D4DDB18AB4637E_Class_1_8C92669D4140023D_2;
namespace MoleMole { class UIControlReference; }
namespace System { class Object; }

#define MOLEMOLE_UIGENERALCLAIMITEMWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18452E40)
#define MOLEMOLE_UIGENERALCLAIMITEMWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18452F10)
#define MOLEMOLE_UIGENERALCLAIMITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x184534E0)
#define MOLEMOLE_UIGENERALCLAIMITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x18453120)
#define MOLEMOLE_UIGENERALCLAIMITEMWIDGETCONTROLLER_ONSETGLOBALDATA_OFFSET UNITYSDK_OFFSET(0x184536A0)
#define MOLEMOLE_UIGENERALCLAIMITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18452EB0)
#define MOLEMOLE_UIGENERALCLAIMITEMWIDGETCONTROLLER_SETGOTICON_OFFSET UNITYSDK_OFFSET(0x18453330)
#define MOLEMOLE_UIGENERALCLAIMITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18453790)
#define MOLEMOLE_UIGENERALCLAIMITEMWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x184537A0)
#define MOLEMOLE_UIGENERALCLAIMITEMWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x18453840)
#define MOLEMOLE_UIGENERALCLAIMITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x184538D0)
#define MOLEMOLE_UIGENERALCLAIMITEMWIDGETCONTROLLER___BASE_ONSETGLOBALDATA_OFFSET UNITYSDK_OFFSET(0x18453970)
#define MOLEMOLE_UIGENERALCLAIMITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18453A00)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralClaimItemWidgetController_TypeDefinitionIndex = 81121;

	class UIGeneralClaimItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_F0D4DDB18AB4637E_Class_1_8C92669D4140023D_2* _scrollViewGlobalData; // 0x2F0
