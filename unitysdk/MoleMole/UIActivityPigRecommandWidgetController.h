...
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_APPLYDAILYNUMONLY_OFFSET UNITYSDK_OFFSET(0x1A619EC0)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_APPLYDEPOSITEDANDMAX_ANIM_OFFSET UNITYSDK_OFFSET(0x1A61AC90)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_APPLYDEPOSITEDANDMAX_OFFSET UNITYSDK_OFFSET(0x1A619F40)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_APPLYDISPLAYNUMBERS_OFFSET UNITYSDK_OFFSET(0x1A619B10)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_APPLYEFFECTPROHEIGHT_OFFSET UNITYSDK_OFFSET(0x1A619BA0)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_CANCELNUMANIMCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1A618D50)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_CANCELTVNUMBERANIMATIONDELAY_OFFSET UNITYSDK_OFFSET(0x1A618CC0)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_CHECKANDPLAYANI_OFFSET UNITYSDK_OFFSET(0x1A61A560)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_COMPUTEDISPLAYNUMBERSCORE_OFFSET UNITYSDK_OFFSET(0x1A618E80)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_DEPOSITEDNUMSCROLLCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1A61B020)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_ENSUREGENERALTIPSCLOSELISTENER_OFFSET UNITYSDK_OFFSET(0x1A61A8B0)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_GETDAILYREWARD_OFFSET UNITYSDK_OFFSET(0x1A61C150)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_GETDEPOSITREWARD_OFFSET UNITYSDK_OFFSET(0x1A61A730)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1A6189F0)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_ONDAILYREWARDTIPSCLOSEDBYCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A61B480)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_ONGENERALTIPSCLOSED_OFFSET UNITYSDK_OFFSET(0x1A61B110)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1A617C70)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1A618A80)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1A617AC0)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1A618980)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_ONUNLOCKTIPSCLOSEDBYCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A61B1F0)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_REFRESHUI_OFFSET UNITYSDK_OFFSET(0x1A617D70)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_REFRESHUNLOCKEDDATAWITHOUTHIDINGLOCK_OFFSET UNITYSDK_OFFSET(0x1A61B4D0)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_REGISTERDAILYREWARDTIPSCLOSE_OFFSET UNITYSDK_OFFSET(0x1A61A9E0)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_REGISTERUNLOCKTIPSCLOSE_OFFSET UNITYSDK_OFFSET(0x1A618E20)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_REQUESTCLAIMALLANDREGISTERFORTVANIMATION_OFFSET UNITYSDK_OFFSET(0x1A61AA40)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_RUNTVNUMBERANIMATIONAFTERCLOSES_OFFSET UNITYSDK_OFFSET(0x1A61B8F0)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_SCHEDULEACTIVITYEXPIRECHECK_OFFSET UNITYSDK_OFFSET(0x1A618660)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_SHOWNOTBUY_OFFSET UNITYSDK_OFFSET(0x1A618DE0)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_TRYCOMPUTEDISPLAYNUMBERS_OFFSET UNITYSDK_OFFSET(0x1A619DF0)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_TRYREMOVEGENERALTIPSCLOSELISTENER_OFFSET UNITYSDK_OFFSET(0x1A61A960)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_UNREGISTERDAILYREWARDTIPSCLOSE_OFFSET UNITYSDK_OFFSET(0x1A618B80)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_UNREGISTERUNLOCKTIPSCLOSE_OFFSET UNITYSDK_OFFSET(0x1A618C20)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_UPDATEDAILYREWARDBUTTONSTATE_OFFSET UNITYSDK_OFFSET(0x1A61A3E0)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER_UPDATETAKEDISPOSTBTN_OFFSET UNITYSDK_OFFSET(0x1A619730)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A61C3A0)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER__GETDAILYREWARD_B__53_0_OFFSET UNITYSDK_OFFSET(0x1A61CD10)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER__GETDAILYREWARD_B__53_1_OFFSET UNITYSDK_OFFSET(0x1A61D4C0)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER__GETDEPOSITREWARD_B__34_0_OFFSET UNITYSDK_OFFSET(0x1A61C400)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER__ONUNLOCKTIPSCLOSEDBYCALLBACK_B__49_0_OFFSET UNITYSDK_OFFSET(0x1A61CC10)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER__REQUESTCLAIMALLANDREGISTERFORTVANIMATION_B__39_0_OFFSET UNITYSDK_OFFSET(0x1A61C410)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER__REQUESTCLAIMALLANDREGISTERFORTVANIMATION_B__39_1_OFFSET UNITYSDK_OFFSET(0x1A61CB50)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1A61D580)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1A61D610)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1A61D6B0)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1A61D740)
#define MOLEMOLE_UIACTIVITYPIGRECOMMANDWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1A61D7D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityPigRecommandWidgetController_TypeDefinitionIndex = 52155;
