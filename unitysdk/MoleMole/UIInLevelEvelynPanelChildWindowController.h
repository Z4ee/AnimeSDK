...
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_CHANGELIGHTMAT_OFFSET UNITYSDK_OFFSET(0x16D7A820)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_CHANGEMATERIAL_OFFSET UNITYSDK_OFFSET(0x16D7AB60)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_COLLECTALLANIMATIONCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x16D7A630)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x16D79510)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_HANDLEALLCUSTOMPROPERTIESONSHOW_OFFSET UNITYSDK_OFFSET(0x16D799F0)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_HANDLECUSTOMPROPERTY_OFFSET UNITYSDK_OFFSET(0x16D79B50)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x16D79640)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16D79520)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16D795B0)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_SETTHRESHOLDLINEPOSITION_OFFSET UNITYSDK_OFFSET(0x16D79860)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16D7ABA0)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER___BASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x16D7ABB0)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16D7AC40)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16D7ACD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelEvelynPanelChildWindowController_TypeDefinitionIndex = 57939;
	...
	public:
		...
		::Class_2_F79521A937A96176* _view; // 0x350
