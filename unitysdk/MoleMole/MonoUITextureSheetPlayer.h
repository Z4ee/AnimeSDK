...
#define MOLEMOLE_MONOUITEXTURESHEETPLAYER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1687B6A0)
#define MOLEMOLE_MONOUITEXTURESHEETPLAYER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1687BC60)
#define MOLEMOLE_MONOUITEXTURESHEETPLAYER_STARTPLAYTEXTURESHEET_OFFSET UNITYSDK_OFFSET(0x1687B6F0)
#define MOLEMOLE_MONOUITEXTURESHEETPLAYER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1687BD40)
#define MOLEMOLE_MONOUITEXTURESHEETPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1687BDA0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUITextureSheetPlayer_TypeDefinitionIndex = 70653;
