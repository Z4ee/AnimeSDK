...
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_ASPECTWH_GET_MINASPECT_OFFSET UNITYSDK_OFFSET(0x7F5620)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_ASPECTWH_GET_RATIO_OFFSET UNITYSDK_OFFSET(0x7F55C0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_ASPECTWH_METHOD_2_B31A23B75E1D102F_OFFSET UNITYSDK_OFFSET(0x1513EFF0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginAttachToCamera_AspectWH_TypeDefinitionIndex = 51515;
