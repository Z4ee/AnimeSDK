...
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_ASPECTWH_GET_MINASPECT_OFFSET UNITYSDK_OFFSET(0x871B70)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_ASPECTWH_GET_RATIO_OFFSET UNITYSDK_OFFSET(0x871B10)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_ASPECTWH_METHOD_2_B31A23B75E1D102F_OFFSET UNITYSDK_OFFSET(0x17913640)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginAttachToCamera_AspectWH_TypeDefinitionIndex = 56273;
