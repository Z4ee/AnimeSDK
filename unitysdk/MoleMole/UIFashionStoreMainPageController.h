...
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_CLEARALLPRODUCTNEWNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x187DA220)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_CONVERTLISTIDXTOPAIRIDX_OFFSET UNITYSDK_OFFSET(0x187DBF00)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_CONVERTPAIRIDXTOLISTIDX_OFFSET UNITYSDK_OFFSET(0x187DB120)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_CONVERTPRODUCTLISTINTOSHIELFLIST_OFFSET UNITYSDK_OFFSET(0x187DA3D0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x187D96A0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x187D9A50)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONCLICKBUYBTN_OFFSET UNITYSDK_OFFSET(0x187DB730)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONCLICKCOSTITEMBTN_OFFSET UNITYSDK_OFFSET(0x187DB550)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x187D96B0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONFAILBUYINGPRODUCT_OFFSET UNITYSDK_OFFSET(0x187DBEC0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONSELECTPRODUCT_OFFSET UNITYSDK_OFFSET(0x187DA800)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x187D9ED0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONSUCCESSBUYINGPRODUCT_OFFSET UNITYSDK_OFFSET(0x187DBCE0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONTIMELINEPERFORMSTART_OFFSET UNITYSDK_OFFSET(0x187DBF90)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x187DA1B0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x187D9740)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x187D9990)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_SHOWFIRSTOPENPERFORM_OFFSET UNITYSDK_OFFSET(0x187D9FD0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_UPDATECOSTMATERIALCOUNT_OFFSET UNITYSDK_OFFSET(0x187DB1C0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x187DC190)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER__ONUIINIT_B__6_0_OFFSET UNITYSDK_OFFSET(0x187DC1A0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER__SHOWFIRSTOPENPERFORM_B__21_0_OFFSET UNITYSDK_OFFSET(0x187DC390)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x187DC6C0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x187DC750)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x187DC7F0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x187DC800)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x187DC810)

namespace MoleMole
{
	inline static constexpr unsigned int UIFashionStoreMainPageController_TypeDefinitionIndex = 62606;
	...
	public:
		...
		::Class_2_3F6C09E90314E9AB* _model; // 0x338
