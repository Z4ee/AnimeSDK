...
#define MOLEMOLE_MONOTERRAINSUBZONE3D_CONTAINS_OFFSET UNITYSDK_OFFSET(0x15852630)
#define MOLEMOLE_MONOTERRAINSUBZONE3D_METHOD_6_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x158526C0)
#define MOLEMOLE_MONOTERRAINSUBZONE3D__CTOR_OFFSET UNITYSDK_OFFSET(0x15852810)
#define MOLEMOLE_MONOTERRAINSUBZONE3D___BASE_CONTAINS_OFFSET UNITYSDK_OFFSET(0x15852870)

namespace MoleMole
{
	inline static constexpr unsigned int MonoTerrainSubZone3D_TypeDefinitionIndex = 82933;
