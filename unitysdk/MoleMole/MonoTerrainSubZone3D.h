...
#define MOLEMOLE_MONOTERRAINSUBZONE3D_CONTAINS_OFFSET UNITYSDK_OFFSET(0x180912C0)
#define MOLEMOLE_MONOTERRAINSUBZONE3D_METHOD_6_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x18091350)
#define MOLEMOLE_MONOTERRAINSUBZONE3D__CTOR_OFFSET UNITYSDK_OFFSET(0x180914A0)
#define MOLEMOLE_MONOTERRAINSUBZONE3D___BASE_CONTAINS_OFFSET UNITYSDK_OFFSET(0x18091500)

namespace MoleMole
{
	inline static constexpr unsigned int MonoTerrainSubZone3D_TypeDefinitionIndex = 44502;
