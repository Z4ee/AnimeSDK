...
#define MOLEMOLE_UIDAILYQUESTNORMALROWWIDGETCONTROLLER___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15E7C110)
#define MOLEMOLE_UIDAILYQUESTNORMALROWWIDGETCONTROLLER___C__DISPLAYCLASS7_0__SETSTATE_B__1_OFFSET UNITYSDK_OFFSET(0x15E7C1C0)
#define MOLEMOLE_UIDAILYQUESTNORMALROWWIDGETCONTROLLER___C__DISPLAYCLASS7_0__SETSTATE_G__JUMP_0_OFFSET UNITYSDK_OFFSET(0x15E7C120)

namespace MoleMole
{
	inline static constexpr unsigned int UIDailyQuestNormalRowWidgetController___c__DisplayClass7_0_TypeDefinitionIndex = 85418;
