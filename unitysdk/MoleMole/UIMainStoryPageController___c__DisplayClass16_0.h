...
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16D968F0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS16_0__ONSHOWTAPE_B__0_OFFSET UNITYSDK_OFFSET(0x16D96900)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS16_0__ONSHOWTAPE_B__1_OFFSET UNITYSDK_OFFSET(0x16D969C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainStoryPageController___c__DisplayClass16_0_TypeDefinitionIndex = 76834;
