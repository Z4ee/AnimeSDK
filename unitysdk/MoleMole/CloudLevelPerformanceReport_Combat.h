...
#define MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT_GET_LEVELID_OFFSET UNITYSDK_OFFSET(0x127006A0)
#define MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT_GET_SCENENAME_OFFSET UNITYSDK_OFFSET(0x12700680)
#define MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT_METHOD_1_2A887DFC7A5BB2CB_OFFSET UNITYSDK_OFFSET(0x127006C0)
#define MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT_METHOD_1_64090C0E8BCAD89E_OFFSET UNITYSDK_OFFSET(0x12700B70)
#define MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT_SET_LEVELID_OFFSET UNITYSDK_OFFSET(0x127006B0)
#define MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT_SET_SCENENAME_OFFSET UNITYSDK_OFFSET(0x12700690)
#define MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT__CTOR_OFFSET UNITYSDK_OFFSET(0x12700CE0)

namespace MoleMole
{
	inline static constexpr unsigned int CloudLevelPerformanceReport_Combat_TypeDefinitionIndex = 52830;
