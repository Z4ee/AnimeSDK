...
#define MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT_GET_LEVELID_OFFSET UNITYSDK_OFFSET(0x159D8E50)
#define MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT_GET_SCENENAME_OFFSET UNITYSDK_OFFSET(0x159D8E30)
#define MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT_METHOD_1_2A887DFC7A5BB2CB_OFFSET UNITYSDK_OFFSET(0x159D8E70)
#define MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT_METHOD_1_64090C0E8BCAD89E_OFFSET UNITYSDK_OFFSET(0x159D9340)
#define MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT_SET_LEVELID_OFFSET UNITYSDK_OFFSET(0x159D8E60)
#define MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT_SET_SCENENAME_OFFSET UNITYSDK_OFFSET(0x159D8E40)
#define MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT__CTOR_OFFSET UNITYSDK_OFFSET(0x159D94B0)

namespace MoleMole
{
	inline static constexpr unsigned int CloudLevelPerformanceReport_Combat_TypeDefinitionIndex = 76838;
