...
#define MOLEMOLE_INTERKNOTPOSTHEIGHTDIC__CTOR_OFFSET UNITYSDK_OFFSET(0x13845960)

namespace MoleMole
{
	inline static constexpr unsigned int InterknotPostHeightDic_TypeDefinitionIndex = 70749;
