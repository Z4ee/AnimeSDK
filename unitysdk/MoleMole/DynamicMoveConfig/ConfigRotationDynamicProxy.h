...
#define MOLEMOLE_DYNAMICMOVECONFIG_CONFIGROTATIONDYNAMICPROXY_GET_INS_OFFSET UNITYSDK_OFFSET(0x170D56C0)
#define MOLEMOLE_DYNAMICMOVECONFIG_CONFIGROTATIONDYNAMICPROXY_PROCESS_OFFSET UNITYSDK_OFFSET(0x170D5800)
#define MOLEMOLE_DYNAMICMOVECONFIG_CONFIGROTATIONDYNAMICPROXY_SETUP_OFFSET UNITYSDK_OFFSET(0x170D5750)
#define MOLEMOLE_DYNAMICMOVECONFIG_CONFIGROTATIONDYNAMICPROXY__CCTOR_OFFSET UNITYSDK_OFFSET(0x170D5890)
#define MOLEMOLE_DYNAMICMOVECONFIG_CONFIGROTATIONDYNAMICPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x170D56A0)
#define MOLEMOLE_DYNAMICMOVECONFIG_CONFIGROTATIONDYNAMICPROXY___BASE_SETUP_OFFSET UNITYSDK_OFFSET(0x170D58A0)

namespace MoleMole::DynamicMoveConfig
{
	inline static constexpr unsigned int ConfigRotationDynamicProxy_TypeDefinitionIndex = 62422;
	...
	public:
		...
		{
			return (::MoleMole::DynamicMoveConfig::ConfigRotationDynamicProxy**)Il2CppClass::FromTypeDefinitionIndex(ConfigRotationDynamicProxy_TypeDefinitionIndex)->GetStaticField(0x484C0);
		}
