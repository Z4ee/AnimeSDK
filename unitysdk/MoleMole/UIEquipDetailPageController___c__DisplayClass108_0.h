...
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER___C__DISPLAYCLASS108_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16490D80)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER___C__DISPLAYCLASS108_0__PLAYVIDEOFORWEAPON_B__1_OFFSET UNITYSDK_OFFSET(0x16490D90)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER___C__DISPLAYCLASS108_0__PLAYVIDEOFORWEAPON_G__SETSTATE_0_OFFSET UNITYSDK_OFFSET(0x16490E90)

namespace MoleMole
{
	inline static constexpr unsigned int UIEquipDetailPageController___c__DisplayClass108_0_TypeDefinitionIndex = 38190;
