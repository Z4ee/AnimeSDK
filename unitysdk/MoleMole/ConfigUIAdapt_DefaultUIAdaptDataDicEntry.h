...
#define MOLEMOLE_CONFIGUIADAPT_DEFAULTUIADAPTDATADICENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x153E0350)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIAdapt_DefaultUIAdaptDataDicEntry_TypeDefinitionIndex = 75577;
