...
#define MOLEMOLE_VEHICLESPLINESEGMENT__CTOR_OFFSET UNITYSDK_OFFSET(0xE86EE90)

namespace MoleMole
{
	inline static constexpr unsigned int VehicleSplineSegment_TypeDefinitionIndex = 41266;
