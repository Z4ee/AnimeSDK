...
#define MOLEMOLE_UIFLOWERMAIN_RIGHTWIDGETCONTROLLER___C__DISPLAYCLASS27_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1762DDA0)
#define MOLEMOLE_UIFLOWERMAIN_RIGHTWIDGETCONTROLLER___C__DISPLAYCLASS27_0__SORTFLOWERDATA_G__SORTEDFUNC_0_OFFSET UNITYSDK_OFFSET(0x1762DDB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerMain_RightWidgetController___c__DisplayClass27_0_TypeDefinitionIndex = 83293;
	...
	public:
		...
		::System::Boolean gentleSelected; // 0x1A
