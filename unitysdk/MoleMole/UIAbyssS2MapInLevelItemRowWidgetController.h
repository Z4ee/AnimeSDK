...
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_BUILDBRANCHDESC_OFFSET UNITYSDK_OFFSET(0x1631B3D0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_BUILDLEVELDESC_OFFSET UNITYSDK_OFFSET(0x1631AAE0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_CHANGEEXPAND_OFFSET UNITYSDK_OFFSET(0x16318020)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_CLEANDYNAMICINFO_OFFSET UNITYSDK_OFFSET(0x16318BE0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_GETARTIFACTDESC_OFFSET UNITYSDK_OFFSET(0x16319140)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_GETCARDDESC_OFFSET UNITYSDK_OFFSET(0x1631BC30)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INITBANGBOODREAMITEMVIEW_OFFSET UNITYSDK_OFFSET(0x163191A0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INITCOOPEQUIPVIEW_OFFSET UNITYSDK_OFFSET(0x16319490)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INITITEMVIEW_OFFSET UNITYSDK_OFFSET(0x163187F0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INITRELICVIEW_1_OFFSET UNITYSDK_OFFSET(0x16319540)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INITRELICVIEW_2_OFFSET UNITYSDK_OFFSET(0x16319890)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INITRELICVIEW_OFFSET UNITYSDK_OFFSET(0x16318FF0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INSERTBRANCHVIEW_OFFSET UNITYSDK_OFFSET(0x1631A400)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INSERTLEVELVIEW_OFFSET UNITYSDK_OFFSET(0x16319F10)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INSERTRELICSKILLVIEW_OFFSET UNITYSDK_OFFSET(0x16319AC0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_ONBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x16317F40)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_ONCLICK_OFFSET UNITYSDK_OFFSET(0x1631BD80)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x163182D0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x163183E0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_ONSELECT_OFFSET UNITYSDK_OFFSET(0x1631BD00)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16318360)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16317D90)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16318260)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_REFRESHICONVIEW_OFFSET UNITYSDK_OFFSET(0x16318DC0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0x16318480)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_SETEXPAND_OFFSET UNITYSDK_OFFSET(0x16318080)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1631BDD0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1631BE60)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1631BEF0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1631BF90)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1631C020)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1631C0B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2MapInLevelItemRowWidgetController_TypeDefinitionIndex = 43255;

	class UIAbyssS2MapInLevelItemRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_22F360303C414CB0* _view; // 0x2E8
		::MoleMole::UIGeneralIconCardRarityWidgetController* _cardIcon; // 0x2F0
		::System::Collections::Generic::List_1<::UnityEngine::GameObject*>* _cacheDyncmic; // 0x2F8
		::System::Action_1<::MoleMole::UIAbyssS2MapInLevelItemRowWidgetController*>* ClickHandle; // 0x300
		::MoleMole::UIAbyssS2InLevelMapDialogPageController_UIInLevelItemPackageInfo* _info; // 0x308
		::Class_1_0D6706375CDAAE8C* _itemData; // 0x310
		::Class_2_208CC9941471731A_131* _itemConfig; // 0x318
		...
		::System::Void InsertLevelView(::Class_2_208CC9941471731A_578* levelConfig, ::System::Boolean divide, ::System::Boolean light, ::System::Boolean hideLevel, ::System::Boolean briefDesc)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_578*, ::System::Boolean, ::System::Boolean, ::System::Boolean, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INSERTLEVELVIEW_OFFSET))(this, levelConfig, divide, light, hideLevel, briefDesc);
		}
		...
		::System::String* BuildLevelDesc(::Class_2_208CC9941471731A_578* levelConfig, ::MoleMole::GradientColor* gradientColor, ::System::Boolean light, ::System::Boolean hideLevel, ::System::Boolean briefDesc)
		{
			return ((::System::String*(*)(::PVOID, ::Class_2_208CC9941471731A_578*, ::MoleMole::GradientColor*, ::System::Boolean, ::System::Boolean, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_BUILDLEVELDESC_OFFSET))(this, levelConfig, gradientColor, light, hideLevel, briefDesc);
		}
