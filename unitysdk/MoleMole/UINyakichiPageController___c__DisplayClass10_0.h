...
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER___C__DISPLAYCLASS10_0__CTOR_OFFSET UNITYSDK_OFFSET(0x155FD090)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER___C__DISPLAYCLASS10_0__ONTAKEREWARD_B__0_OFFSET UNITYSDK_OFFSET(0x155FD0A0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER___C__DISPLAYCLASS10_0__ONTAKEREWARD_B__1_OFFSET UNITYSDK_OFFSET(0x155FD550)

namespace MoleMole
{
	inline static constexpr unsigned int UINyakichiPageController___c__DisplayClass10_0_TypeDefinitionIndex = 76054;
	...
	public:
		...
		::Class_3_4A628DAD59F70BCB_1* value; // 0x18
