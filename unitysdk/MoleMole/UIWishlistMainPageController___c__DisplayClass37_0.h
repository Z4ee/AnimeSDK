...
#define MOLEMOLE_UIWISHLISTMAINPAGECONTROLLER___C__DISPLAYCLASS37_0__CTOR_OFFSET UNITYSDK_OFFSET(0x10AEA850)
#define MOLEMOLE_UIWISHLISTMAINPAGECONTROLLER___C__DISPLAYCLASS37_0__SHOWSKILLSPECIALITEMPROCESS_B__0_OFFSET UNITYSDK_OFFSET(0x10AEA860)
#define MOLEMOLE_UIWISHLISTMAINPAGECONTROLLER___C__DISPLAYCLASS37_0__SHOWSKILLSPECIALITEMPROCESS_B__1_OFFSET UNITYSDK_OFFSET(0x10AEA8E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWishlistMainPageController___c__DisplayClass37_0_TypeDefinitionIndex = 65462;
