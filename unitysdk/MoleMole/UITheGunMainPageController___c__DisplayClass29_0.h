...
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER___C__DISPLAYCLASS29_0__CTOR_OFFSET UNITYSDK_OFFSET(0x152469F0)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER___C__DISPLAYCLASS29_0__TRACKQUESTGROUP_B__0_OFFSET UNITYSDK_OFFSET(0x15246A00)

namespace MoleMole
{
	inline static constexpr unsigned int UITheGunMainPageController___c__DisplayClass29_0_TypeDefinitionIndex = 81506;
