...
#define MOLEMOLE_ANTIALIASPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x13586640)
#define MOLEMOLE_ANTIALIASPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x13586780)
#define MOLEMOLE_ANTIALIASPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x13586560)
#define MOLEMOLE_ANTIALIASPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x13586700)
#define MOLEMOLE_ANTIALIASPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x13586550)
#define MOLEMOLE_ANTIALIASPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x135868A0)
#define MOLEMOLE_ANTIALIASPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x13586930)
#define MOLEMOLE_ANTIALIASPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x135869C0)
#define MOLEMOLE_ANTIALIASPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x13586A50)

namespace MoleMole
{
	inline static constexpr unsigned int AntiAliasProfile_TypeDefinitionIndex = 72404;
