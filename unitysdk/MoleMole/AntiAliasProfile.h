...
#define MOLEMOLE_ANTIALIASPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x17791530)
#define MOLEMOLE_ANTIALIASPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x17791670)
#define MOLEMOLE_ANTIALIASPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x17791450)
#define MOLEMOLE_ANTIALIASPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x177915F0)
#define MOLEMOLE_ANTIALIASPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x17791440)
#define MOLEMOLE_ANTIALIASPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x17791790)
#define MOLEMOLE_ANTIALIASPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x17791820)
#define MOLEMOLE_ANTIALIASPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x177918B0)
#define MOLEMOLE_ANTIALIASPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x17791940)

namespace MoleMole
{
	inline static constexpr unsigned int AntiAliasProfile_TypeDefinitionIndex = 54467;
