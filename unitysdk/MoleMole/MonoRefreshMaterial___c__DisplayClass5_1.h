...
#define MOLEMOLE_MONOREFRESHMATERIAL___C__DISPLAYCLASS5_1__CTOR_OFFSET UNITYSDK_OFFSET(0x142B1310)
#define MOLEMOLE_MONOREFRESHMATERIAL___C__DISPLAYCLASS5_1__PLAYITEMICONADDANI_B__0_OFFSET UNITYSDK_OFFSET(0x142B1320)
#define MOLEMOLE_MONOREFRESHMATERIAL___C__DISPLAYCLASS5_1__PLAYITEMICONADDANI_B__1_OFFSET UNITYSDK_OFFSET(0x142B1360)

namespace MoleMole
{
	inline static constexpr unsigned int MonoRefreshMaterial___c__DisplayClass5_1_TypeDefinitionIndex = 82364;
