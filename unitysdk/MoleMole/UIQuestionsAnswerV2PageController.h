...
#define MOLEMOLE_UIQUESTIONSANSWERV2PAGECONTROLLER_CREATEUIQUESTIONSANSWER3D3DMODELCONTROLLER_OFFSET UNITYSDK_OFFSET(0x17179830)
#define MOLEMOLE_UIQUESTIONSANSWERV2PAGECONTROLLER_CREATEUIQUESTIONSANSWERWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x17179780)
#define MOLEMOLE_UIQUESTIONSANSWERV2PAGECONTROLLER_CREATEUIQUESTIONSLISTWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x171796D0)
#define MOLEMOLE_UIQUESTIONSANSWERV2PAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x171798C0)
#define MOLEMOLE_UIQUESTIONSANSWERV2PAGECONTROLLER___BASE_CREATEUIQUESTIONSANSWER3D3DMODELCONTROLLER_OFFSET UNITYSDK_OFFSET(0x171798D0)
#define MOLEMOLE_UIQUESTIONSANSWERV2PAGECONTROLLER___BASE_CREATEUIQUESTIONSANSWERWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x171799A0)
#define MOLEMOLE_UIQUESTIONSANSWERV2PAGECONTROLLER___BASE_CREATEUIQUESTIONSLISTWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x171799B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerV2PageController_TypeDefinitionIndex = 78479;
