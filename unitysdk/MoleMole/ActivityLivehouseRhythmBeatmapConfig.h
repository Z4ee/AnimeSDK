...
#define MOLEMOLE_ACTIVITYLIVEHOUSERHYTHMBEATMAPCONFIG_GET_AUDIOOFFSETSECONDS_OFFSET UNITYSDK_OFFSET(0x11079CA0)
#define MOLEMOLE_ACTIVITYLIVEHOUSERHYTHMBEATMAPCONFIG_METHOD_3_15E82C5C62701F51_OFFSET UNITYSDK_OFFSET(0x1107A100)
#define MOLEMOLE_ACTIVITYLIVEHOUSERHYTHMBEATMAPCONFIG_METHOD_3_284A00008B880FD6_OFFSET UNITYSDK_OFFSET(0x1107A1E0)
#define MOLEMOLE_ACTIVITYLIVEHOUSERHYTHMBEATMAPCONFIG_METHOD_3_5DB88A6B329F3A46_OFFSET UNITYSDK_OFFSET(0x11079FB0)
#define MOLEMOLE_ACTIVITYLIVEHOUSERHYTHMBEATMAPCONFIG_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1107A0A0)
#define MOLEMOLE_ACTIVITYLIVEHOUSERHYTHMBEATMAPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x11079CB0)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityLivehouseRhythmBeatmapConfig_TypeDefinitionIndex = 62054;
