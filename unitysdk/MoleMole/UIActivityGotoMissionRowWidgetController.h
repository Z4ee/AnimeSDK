...
#define MOLEMOLE_UIACTIVITYGOTOMISSIONROWWIDGETCONTROLLER_DOACCESSJUMP_OFFSET UNITYSDK_OFFSET(0x15E871C0)
#define MOLEMOLE_UIACTIVITYGOTOMISSIONROWWIDGETCONTROLLER_GETVIEW_OFFSET UNITYSDK_OFFSET(0x15E86E70)
#define MOLEMOLE_UIACTIVITYGOTOMISSIONROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15E86C80)
#define MOLEMOLE_UIACTIVITYGOTOMISSIONROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15E86D90)
#define MOLEMOLE_UIACTIVITYGOTOMISSIONROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15E86D10)
#define MOLEMOLE_UIACTIVITYGOTOMISSIONROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15E86C20)
#define MOLEMOLE_UIACTIVITYGOTOMISSIONROWWIDGETCONTROLLER_SETACCESSID_OFFSET UNITYSDK_OFFSET(0x15E87000)
#define MOLEMOLE_UIACTIVITYGOTOMISSIONROWWIDGETCONTROLLER_SETGOMISSIONTESTANDACTION_OFFSET UNITYSDK_OFFSET(0x15E86EC0)
#define MOLEMOLE_UIACTIVITYGOTOMISSIONROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15E87280)
#define MOLEMOLE_UIACTIVITYGOTOMISSIONROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15E87290)
#define MOLEMOLE_UIACTIVITYGOTOMISSIONROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15E87320)
#define MOLEMOLE_UIACTIVITYGOTOMISSIONROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15E873C0)
#define MOLEMOLE_UIACTIVITYGOTOMISSIONROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15E87450)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityGotoMissionRowWidgetController_TypeDefinitionIndex = 58404;

	class UIActivityGotoMissionRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_90A61AE005F824B1_2* _view; // 0x2E8
		::System::Int32 accessID; // 0x2F0
