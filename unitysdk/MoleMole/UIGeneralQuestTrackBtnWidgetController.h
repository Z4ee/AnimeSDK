...
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER_BINDGAMEPADBUTTON_OFFSET UNITYSDK_OFFSET(0x186C75B0)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER_DOTOGGLETRACK_OFFSET UNITYSDK_OFFSET(0x186C85C0)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x186C74A0)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x186C7530)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x186C72D0)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x186C7430)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x186C7750)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x186C8A00)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER__DOTOGGLETRACK_B__8_0_OFFSET UNITYSDK_OFFSET(0x186C8B40)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER__REFRESHVIEW_B__7_0_OFFSET UNITYSDK_OFFSET(0x186C8AE0)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER__REFRESHVIEW_B__7_2_OFFSET UNITYSDK_OFFSET(0x186C8A60)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER__REFRESHVIEW_G__SETGRAPHICALPHA_7_1_OFFSET UNITYSDK_OFFSET(0x186C8500)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x186C8B60)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x186C8BF0)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x186C8C80)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x186C8D10)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralQuestTrackBtnWidgetController_TypeDefinitionIndex = 40527;
