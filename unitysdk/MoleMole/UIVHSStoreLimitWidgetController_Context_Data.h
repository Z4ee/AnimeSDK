...
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_CONTEXT_DATA_GET_CURTAGLIST_OFFSET UNITYSDK_OFFSET(0x12E4A750)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_CONTEXT_DATA_GET_CURTAGWITHOUTHIDING_OFFSET UNITYSDK_OFFSET(0x12E4A820)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_CONTEXT_DATA_GET_CURVHSSLOTLIST_OFFSET UNITYSDK_OFFSET(0x12E4AA00)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_CONTEXT_DATA_GET_ENERGY_OFFSET UNITYSDK_OFFSET(0x12E4A340)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_CONTEXT_DATA_GET_OPTIONRECORDLIST_OFFSET UNITYSDK_OFFSET(0x12E4A410)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_CONTEXT_DATA_GET_RECOMMENDROUND_OFFSET UNITYSDK_OFFSET(0x12E4A5B0)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_CONTEXT_DATA_GET_SCORE_OFFSET UNITYSDK_OFFSET(0x12E4A4E0)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_CONTEXT_DATA_GET_VHSRECOMMENDROUNDMAP_OFFSET UNITYSDK_OFFSET(0x12E4A680)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_CONTEXT_DATA_GET_WAITREFRESHTAGIDX_OFFSET UNITYSDK_OFFSET(0x12E4AAD0)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_CONTEXT_DATA_GET_WAITREFRESHTAGNEW_OFFSET UNITYSDK_OFFSET(0x12E4ABA0)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_CONTEXT_DATA__CTOR_OFFSET UNITYSDK_OFFSET(0x12E4AC70)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSStoreLimitWidgetController_Context_Data_TypeDefinitionIndex = 74352;
	...
	public:
		...
		::System::Collections::Generic::IReadOnlyList_1<::Class_3_B6A6E344CE687278_12*>* get_OptionRecordList()
		{
			return ((::System::Collections::Generic::IReadOnlyList_1<::Class_3_B6A6E344CE687278_12*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_CONTEXT_DATA_GET_OPTIONRECORDLIST_OFFSET))(this);
		}
