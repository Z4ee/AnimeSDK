...
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER_CHECKSHOWEXCHANGEBTN_OFFSET UNITYSDK_OFFSET(0x161151D0)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER_DOCHANGETAB_OFFSET UNITYSDK_OFFSET(0x16114370)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER_INITTABSPRITES_OFFSET UNITYSDK_OFFSET(0x16112CB0)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER_INITTABUIVIEW_OFFSET UNITYSDK_OFFSET(0x16113B10)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER_ONCLICKEXCHANGEBTN_OFFSET UNITYSDK_OFFSET(0x16115920)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER_ONCLICKFETCHALLTASK_OFFSET UNITYSDK_OFFSET(0x16114A50)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER_ONCLICKTABLEROW_OFFSET UNITYSDK_OFFSET(0x161154E0)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0x16114140)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x161135A0)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16113140)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16113630)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x161128B0)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16112970)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER_REFRESHFETCHALLBTN_OFFSET UNITYSDK_OFFSET(0x16114E00)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER_REFRESHREMAINTIMERTEXT_OFFSET UNITYSDK_OFFSET(0x16115100)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER_REFRESHSHOWTABLE_OFFSET UNITYSDK_OFFSET(0x161131D0)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER_SHOWTABLEUIVIEWEMPTY_OFFSET UNITYSDK_OFFSET(0x16114040)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER_SHOWTABLEUIVIEW_OFFSET UNITYSDK_OFFSET(0x161147D0)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0x16114DB0)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x16113A90)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER__CHECKSHOWEXCHANGEBTN_B__37_0_OFFSET UNITYSDK_OFFSET(0x16115F00)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16115D60)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER__ONCLICKFETCHALLTASK_B__29_0_OFFSET UNITYSDK_OFFSET(0x16115EB0)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER__ONCLICKTABLEROW_B__36_0_OFFSET UNITYSDK_OFFSET(0x16115EF0)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER__REFRESHREMAINTIMERTEXT_B__34_0_OFFSET UNITYSDK_OFFSET(0x16115EC0)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16115F50)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16115FE0)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16116080)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16116110)
#define MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x161161A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityChainV2WidgetController_TypeDefinitionIndex = 47892;
	...
	public:
		...
		::Class_2_7E6D72F133378CF7* _view; // 0x2C8
		...
		::System::Void _OnClickFetchAllTask_b__29_0(::Class_0_16E4307DCC419505_29* rspMsg)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_29*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER__ONCLICKFETCHALLTASK_B__29_0_OFFSET))(this, rspMsg);
		}
		...
		::System::Void _OnClickTableRow_b__36_0(::Class_0_16E4307DCC419505_29* rspMsg)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_29*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIACTIVITYCHAINV2WIDGETCONTROLLER__ONCLICKTABLEROW_B__36_0_OFFSET))(this, rspMsg);
		}
