...
#define MOLEMOLE_HOTPOTLEVELENDDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1737DE10)

namespace MoleMole
{
	inline static constexpr unsigned int HotPotLevelEndDialogContext_TypeDefinitionIndex = 63159;

	class HotPotLevelEndDialogContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::Collections::Generic::List_1<::Class_1_7807B2B04302CD7B_23*>* Rows; // 0x28
