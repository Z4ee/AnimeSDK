...
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0x152A98C0)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER___C__DISPLAYCLASS7_0__REFRESHVIEW_B__0_OFFSET UNITYSDK_OFFSET(0x152A98D0)
#define MOLEMOLE_UIMAINCITYPERSONALOUTWIDGETCONTROLLER___C__DISPLAYCLASS7_0__REFRESHVIEW_G__ONCLICKBTN_1_OFFSET UNITYSDK_OFFSET(0x152A99F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityPersonalOutWidgetController___c__DisplayClass7_0_TypeDefinitionIndex = 63803;
