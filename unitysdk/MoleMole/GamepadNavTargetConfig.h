...
#define MOLEMOLE_GAMEPADNAVTARGETCONFIG_GET_NULLTARGET_OFFSET UNITYSDK_OFFSET(0x107F04B0)
#define MOLEMOLE_GAMEPADNAVTARGETCONFIG_GET_TARGETMODULEWRAPPER_OFFSET UNITYSDK_OFFSET(0x259D70)
#define MOLEMOLE_GAMEPADNAVTARGETCONFIG_METHOD_2_5FFB353256AF4026_OFFSET UNITYSDK_OFFSET(0x6B81F0)
#define MOLEMOLE_GAMEPADNAVTARGETCONFIG_METHOD_2_AA972BE565DAF9E3_OFFSET UNITYSDK_OFFSET(0x6B81D0)
#define MOLEMOLE_GAMEPADNAVTARGETCONFIG_METHOD_2_CA8FE7098187A6E6_OFFSET UNITYSDK_OFFSET(0x6B81E0)
#define MOLEMOLE_GAMEPADNAVTARGETCONFIG_SET_TARGETMODULEWRAPPER_OFFSET UNITYSDK_OFFSET(0x6B81C0)

namespace MoleMole
{
	inline static constexpr unsigned int GamepadNavTargetConfig_TypeDefinitionIndex = 56782;
