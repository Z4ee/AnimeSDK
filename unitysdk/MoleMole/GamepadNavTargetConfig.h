...
#define MOLEMOLE_GAMEPADNAVTARGETCONFIG_GET_NULLTARGET_OFFSET UNITYSDK_OFFSET(0x1417C9C0)
#define MOLEMOLE_GAMEPADNAVTARGETCONFIG_GET_TARGETMODULEWRAPPER_OFFSET UNITYSDK_OFFSET(0x246290)
#define MOLEMOLE_GAMEPADNAVTARGETCONFIG_METHOD_2_5FFB353256AF4026_OFFSET UNITYSDK_OFFSET(0x7CECF0)
#define MOLEMOLE_GAMEPADNAVTARGETCONFIG_METHOD_2_AA972BE565DAF9E3_OFFSET UNITYSDK_OFFSET(0x7CED60)
#define MOLEMOLE_GAMEPADNAVTARGETCONFIG_METHOD_2_CA8FE7098187A6E6_OFFSET UNITYSDK_OFFSET(0x7CED50)
#define MOLEMOLE_GAMEPADNAVTARGETCONFIG_SET_TARGETMODULEWRAPPER_OFFSET UNITYSDK_OFFSET(0x7CECE0)

namespace MoleMole
{
	inline static constexpr unsigned int GamepadNavTargetConfig_TypeDefinitionIndex = 86146;
