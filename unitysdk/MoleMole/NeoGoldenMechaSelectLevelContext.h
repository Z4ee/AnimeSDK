...
#define MOLEMOLE_NEOGOLDENMECHASELECTLEVELCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x17036E00)

namespace MoleMole
{
	inline static constexpr unsigned int NeoGoldenMechaSelectLevelContext_TypeDefinitionIndex = 51010;
