...
#define MOLEMOLE_UIHANDBOOKHADALWIDGETWIDGETCONTROLLER___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16CF58E0)
#define MOLEMOLE_UIHANDBOOKHADALWIDGETWIDGETCONTROLLER___C__DISPLAYCLASS8_0__ONSHOPBTNCLICK_B__0_OFFSET UNITYSDK_OFFSET(0x16CF58F0)
#define MOLEMOLE_UIHANDBOOKHADALWIDGETWIDGETCONTROLLER___C__DISPLAYCLASS8_0__ONSHOPBTNCLICK_B__1_OFFSET UNITYSDK_OFFSET(0x16CF5BE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookHadalWidgetWidgetController___c__DisplayClass8_0_TypeDefinitionIndex = 70183;
