...
#define MOLEMOLE_UIHOLLOWCARDOPTIONITEMWIDGETCONTROLLER___C__DISPLAYCLASS23_0__CHANGEINFOSTATE_B__0_OFFSET UNITYSDK_OFFSET(0x1525CB60)
#define MOLEMOLE_UIHOLLOWCARDOPTIONITEMWIDGETCONTROLLER___C__DISPLAYCLASS23_0__CHANGEINFOSTATE_B__1_OFFSET UNITYSDK_OFFSET(0x1525CCA0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONITEMWIDGETCONTROLLER___C__DISPLAYCLASS23_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1525CB50)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCardOptionItemWidgetController___c__DisplayClass23_0_TypeDefinitionIndex = 41924;
