...
#define MOLEMOLE_UITRIDICEITEMCOLLECTWIDGETCONTROLLER_ONCLICKSELECTITEM_OFFSET UNITYSDK_OFFSET(0x11A008F0)
#define MOLEMOLE_UITRIDICEITEMCOLLECTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x11A01670)
#define MOLEMOLE_UITRIDICEITEMCOLLECTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x11A00770)
#define MOLEMOLE_UITRIDICEITEMCOLLECTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x11A01700)
#define MOLEMOLE_UITRIDICEITEMCOLLECTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x11A00500)
#define MOLEMOLE_UITRIDICEITEMCOLLECTWIDGETCONTROLLER_REFRESHTOPTIP_OFFSET UNITYSDK_OFFSET(0x11A017E0)
#define MOLEMOLE_UITRIDICEITEMCOLLECTWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x11A018B0)
#define MOLEMOLE_UITRIDICEITEMCOLLECTWIDGETCONTROLLER_SETDATA_OFFSET UNITYSDK_OFFSET(0x11A01780)
#define MOLEMOLE_UITRIDICEITEMCOLLECTWIDGETCONTROLLER_SHOWRIGHTEMPTYDESC_OFFSET UNITYSDK_OFFSET(0x11A007E0)
#define MOLEMOLE_UITRIDICEITEMCOLLECTWIDGETCONTROLLER_SHOWSAMENAME_OFFSET UNITYSDK_OFFSET(0x11A010B0)
#define MOLEMOLE_UITRIDICEITEMCOLLECTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11A02190)
#define MOLEMOLE_UITRIDICEITEMCOLLECTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x11A02270)
#define MOLEMOLE_UITRIDICEITEMCOLLECTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x11A02300)
#define MOLEMOLE_UITRIDICEITEMCOLLECTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x11A023A0)
#define MOLEMOLE_UITRIDICEITEMCOLLECTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x11A02430)

namespace MoleMole
{
	inline static constexpr unsigned int UITriDiceItemCollectWidgetController_TypeDefinitionIndex = 84763;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_1_451601B8BB62C38C_1*>* _currentDataList; // 0x2D0
