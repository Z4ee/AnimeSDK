...
#define MOLEMOLE_OPENMARCELADVENTUREUI_GET_ISTRIGGERINLOADING_OFFSET UNITYSDK_OFFSET(0x190A6070)
#define MOLEMOLE_OPENMARCELADVENTUREUI_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x190A6090)
#define MOLEMOLE_OPENMARCELADVENTUREUI__CTOR_OFFSET UNITYSDK_OFFSET(0x190A6080)

namespace MoleMole
{
	inline static constexpr unsigned int OpenMarcelAdventureUI_TypeDefinitionIndex = 60338;
