...
#define MOLEMOLE_OPENMARCELADVENTUREUI_GET_ISTRIGGERINLOADING_OFFSET UNITYSDK_OFFSET(0x17DE0030)
#define MOLEMOLE_OPENMARCELADVENTUREUI_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x17DE0050)
#define MOLEMOLE_OPENMARCELADVENTUREUI__CTOR_OFFSET UNITYSDK_OFFSET(0x17DE0040)

namespace MoleMole
{
	inline static constexpr unsigned int OpenMarcelAdventureUI_TypeDefinitionIndex = 77834;
