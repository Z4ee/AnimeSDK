...
#define MOLEMOLE_ZIPLINESUBSYSTEM_CMODEL_GET_CAMERAMODEL_OFFSET UNITYSDK_OFFSET(0x11BEF1D0)
#define MOLEMOLE_ZIPLINESUBSYSTEM_CMODEL_GET_COMMONSKILL_OFFSET UNITYSDK_OFFSET(0x11BEF270)
#define MOLEMOLE_ZIPLINESUBSYSTEM_CMODEL_GET_ENTERPOINT_OFFSET UNITYSDK_OFFSET(0x11BEF1F0)
#define MOLEMOLE_ZIPLINESUBSYSTEM_CMODEL_GET_EXITPOINT_OFFSET UNITYSDK_OFFSET(0x11BEF230)
#define MOLEMOLE_ZIPLINESUBSYSTEM_CMODEL_GET_GROUPSTATE_OFFSET UNITYSDK_OFFSET(0x11BEF290)
#define MOLEMOLE_ZIPLINESUBSYSTEM_CMODEL_GET_HUDMODEL_OFFSET UNITYSDK_OFFSET(0x11BEF250)
#define MOLEMOLE_ZIPLINESUBSYSTEM_CMODEL_GET_MAINSTATE_OFFSET UNITYSDK_OFFSET(0x11BEF1B0)
#define MOLEMOLE_ZIPLINESUBSYSTEM_CMODEL_GET_SWITCHPOINT_OFFSET UNITYSDK_OFFSET(0x11BEF210)
#define MOLEMOLE_ZIPLINESUBSYSTEM_CMODEL_ONCREATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x11BEF2B0)
#define MOLEMOLE_ZIPLINESUBSYSTEM_CMODEL_SET_CAMERAMODEL_OFFSET UNITYSDK_OFFSET(0x11BEF1E0)
#define MOLEMOLE_ZIPLINESUBSYSTEM_CMODEL_SET_COMMONSKILL_OFFSET UNITYSDK_OFFSET(0x11BEF280)
#define MOLEMOLE_ZIPLINESUBSYSTEM_CMODEL_SET_ENTERPOINT_OFFSET UNITYSDK_OFFSET(0x11BEF200)
#define MOLEMOLE_ZIPLINESUBSYSTEM_CMODEL_SET_EXITPOINT_OFFSET UNITYSDK_OFFSET(0x11BEF240)
#define MOLEMOLE_ZIPLINESUBSYSTEM_CMODEL_SET_GROUPSTATE_OFFSET UNITYSDK_OFFSET(0x11BEF2A0)
#define MOLEMOLE_ZIPLINESUBSYSTEM_CMODEL_SET_HUDMODEL_OFFSET UNITYSDK_OFFSET(0x11BEF260)
#define MOLEMOLE_ZIPLINESUBSYSTEM_CMODEL_SET_MAINSTATE_OFFSET UNITYSDK_OFFSET(0x11BEF1C0)
#define MOLEMOLE_ZIPLINESUBSYSTEM_CMODEL_SET_SWITCHPOINT_OFFSET UNITYSDK_OFFSET(0x11BEF220)
#define MOLEMOLE_ZIPLINESUBSYSTEM_CMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x11BEF140)
#define MOLEMOLE_ZIPLINESUBSYSTEM_CMODEL__ONCREATEPROPERTY_B__35_0_OFFSET UNITYSDK_OFFSET(0x11BEF480)
#define MOLEMOLE_ZIPLINESUBSYSTEM_CMODEL__ONCREATEPROPERTY_B__35_1_OFFSET UNITYSDK_OFFSET(0x11BEF520)
#define MOLEMOLE_ZIPLINESUBSYSTEM_CMODEL__ONCREATEPROPERTY_B__35_2_OFFSET UNITYSDK_OFFSET(0x11BEF5C0)
#define MOLEMOLE_ZIPLINESUBSYSTEM_CMODEL__ONCREATEPROPERTY_B__35_3_OFFSET UNITYSDK_OFFSET(0x11BEF660)
#define MOLEMOLE_ZIPLINESUBSYSTEM_CMODEL__ONCREATEPROPERTY_B__35_4_OFFSET UNITYSDK_OFFSET(0x11BEF750)

namespace MoleMole
{
	inline static constexpr unsigned int ZipLineSubSystem_CModel_TypeDefinitionIndex = 74663;

	class ZipLineSubSystem_CModel : public ::Class_1_C331A5DC726F030A
	{
	public:
		::MoleMole::ZipLineSubSystem_CameraModel* _CameraModel_k__BackingField; // 0x60
		::MoleMole::ZipLineSubSystem_ExitPointModel* _ExitPoint_k__BackingField; // 0x68
		::MoleMole::ZipLineSubSystem_GroupState* _GroupState_k__BackingField; // 0x70
		::MoleMole::ZipLineSubSystem_EnterPointModel* _EnterPoint_k__BackingField; // 0x78
		::MoleMole::ZipLineSubSystem_HUDModel* _HUDModel_k__BackingField; // 0x80
		::MoleMole::ZipLineSubSystem* _ownerSubSystem; // 0x88
		::MoleMole::ZipLineSubSystem_MainState* _MainState_k__BackingField; // 0x90
		::MoleMole::ZipLineSubSystem_CommonSkill* _CommonSkill_k__BackingField; // 0x98
		::MoleMole::ZipLineSubSystem_SwitchPointModel* _SwitchPoint_k__BackingField; // 0xA0
		::System::Boolean SomeInit; // 0xA8
