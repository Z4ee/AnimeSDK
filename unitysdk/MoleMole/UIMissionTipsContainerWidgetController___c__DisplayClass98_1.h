...
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS98_1__CTOR_OFFSET UNITYSDK_OFFSET(0x151015E0)
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS98_1__PLAYCHALLENGETIP_B__2_OFFSET UNITYSDK_OFFSET(0x151015F0)
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS98_1__PLAYCHALLENGETIP_B__3_OFFSET UNITYSDK_OFFSET(0x15101700)

namespace MoleMole
{
	inline static constexpr unsigned int UIMissionTipsContainerWidgetController___c__DisplayClass98_1_TypeDefinitionIndex = 55031;
	...
	public:
		...
		::MoleMole::UIMissionTipsContainerWidgetController___c__DisplayClass98_0* CS___8__locals1; // 0x20
