...
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_ADDTARGETENTITY_OFFSET UNITYSDK_OFFSET(0x15CD73E0)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_CREATEMISSIONGUIDEPOINT_OFFSET UNITYSDK_OFFSET(0x15CD6D40)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_HIDEALL_OFFSET UNITYSDK_OFFSET(0x15CD7880)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_HIDEMISSIONGUIDEPOINT_OFFSET UNITYSDK_OFFSET(0x15CD7A90)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15CD7140)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15CD71D0)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15CD6C30)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15CD70D0)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_REMOVETARGETENTITY_OFFSET UNITYSDK_OFFSET(0x15CD76C0)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_SHOWMISSIONGUIDEPOINT_OFFSET UNITYSDK_OFFSET(0x15CD79D0)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0x15CD7250)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15CD7AF0)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15CD7BF0)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15CD7C80)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15CD7D10)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15CD7DA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMissionGuideWidgetController_TypeDefinitionIndex = 42922;
	...
	public:
		...
		::Class_2_60638234271CCDB8_27* _view; // 0x2B8
		::System::Collections::Generic::HashSet_1<::System::UInt32>* _targetEntityIDs; // 0x2C0
		::System::Collections::Generic::List_1<::MoleMole::UIHollowMissionGuidePointWidgetController*>* _guidePointList; // 0x2C8
