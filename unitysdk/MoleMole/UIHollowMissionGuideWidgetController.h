...
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_ADDTARGETENTITY_OFFSET UNITYSDK_OFFSET(0x19F318B0)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_CREATEMISSIONGUIDEPOINT_OFFSET UNITYSDK_OFFSET(0x19F31220)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_HIDEALL_OFFSET UNITYSDK_OFFSET(0x19F31D50)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_HIDEMISSIONGUIDEPOINT_OFFSET UNITYSDK_OFFSET(0x19F31F60)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19F31610)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19F316A0)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19F31110)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19F315A0)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_REMOVETARGETENTITY_OFFSET UNITYSDK_OFFSET(0x19F31B90)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_SHOWMISSIONGUIDEPOINT_OFFSET UNITYSDK_OFFSET(0x19F31EA0)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0x19F31720)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19F31FC0)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19F320B0)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19F32140)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19F321D0)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19F32260)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMissionGuideWidgetController_TypeDefinitionIndex = 86523;
	...
	public:
		...
		::Class_2_60638234271CCDB8_131* _view; // 0x2C0
