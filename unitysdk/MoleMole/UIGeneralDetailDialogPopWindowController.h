...
#define MOLEMOLE_UIGENERALDETAILDIALOGPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x166EA410)
#define MOLEMOLE_UIGENERALDETAILDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x166EA400)
#define MOLEMOLE_UIGENERALDETAILDIALOGPOPWINDOWCONTROLLER_INITIMAGEAREA_OFFSET UNITYSDK_OFFSET(0x166EAD00)
#define MOLEMOLE_UIGENERALDETAILDIALOGPOPWINDOWCONTROLLER_ONCLICKCANCEL_OFFSET UNITYSDK_OFFSET(0x166EB140)
#define MOLEMOLE_UIGENERALDETAILDIALOGPOPWINDOWCONTROLLER_ONCLICKCONFIRM_OFFSET UNITYSDK_OFFSET(0x166EB0D0)
#define MOLEMOLE_UIGENERALDETAILDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x166EAEA0)
#define MOLEMOLE_UIGENERALDETAILDIALOGPOPWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x166EAF30)
#define MOLEMOLE_UIGENERALDETAILDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x166EB060)
#define MOLEMOLE_UIGENERALDETAILDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x166EA420)
#define MOLEMOLE_UIGENERALDETAILDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x166EA5E0)
#define MOLEMOLE_UIGENERALDETAILDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x166EB290)
#define MOLEMOLE_UIGENERALDETAILDIALOGPOPWINDOWCONTROLLER__INITIMAGEAREA_G__DOINITIMAGEAREA_15_0_OFFSET UNITYSDK_OFFSET(0x166EB1B0)
#define MOLEMOLE_UIGENERALDETAILDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x166EB2A0)
#define MOLEMOLE_UIGENERALDETAILDIALOGPOPWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x166EB330)
#define MOLEMOLE_UIGENERALDETAILDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x166EB3F0)
#define MOLEMOLE_UIGENERALDETAILDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x166EB400)
#define MOLEMOLE_UIGENERALDETAILDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x166EB410)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralDetailDialogPopWindowController_TypeDefinitionIndex = 87616;

	class UIGeneralDetailDialogPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_60638234271CCDB8_150* _view; // 0x318
