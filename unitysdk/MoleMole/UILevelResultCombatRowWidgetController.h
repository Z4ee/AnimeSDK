...
#define MOLEMOLE_UILEVELRESULTCOMBATROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1529C640)
#define MOLEMOLE_UILEVELRESULTCOMBATROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1529C750)
#define MOLEMOLE_UILEVELRESULTCOMBATROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1529C6D0)
#define MOLEMOLE_UILEVELRESULTCOMBATROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1529C5E0)
#define MOLEMOLE_UILEVELRESULTCOMBATROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1529CBB0)
#define MOLEMOLE_UILEVELRESULTCOMBATROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1529CBC0)
#define MOLEMOLE_UILEVELRESULTCOMBATROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1529CC50)
#define MOLEMOLE_UILEVELRESULTCOMBATROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1529CCF0)
#define MOLEMOLE_UILEVELRESULTCOMBATROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1529CD80)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultCombatRowWidgetController_TypeDefinitionIndex = 60450;

	class UILevelResultCombatRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_64B8AF843BB0F160* _view; // 0x2E8
