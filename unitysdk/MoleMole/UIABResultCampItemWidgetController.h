...
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x183AD070)
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x183ACBB0)
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x183AD200)
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x183ACCC0)
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x183ACC40)
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x183AC890)
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x183ACD90)
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x183ACFE0)
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x183AD510)
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x183AD520)
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x183AD530)
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x183AD5C0)
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x183AD650)
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x183AD6F0)
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x183AD780)

namespace MoleMole
{
	inline static constexpr unsigned int UIABResultCampItemWidgetController_TypeDefinitionIndex = 57844;
