...
#define MOLEMOLE_UIRABSTAGEREWARDPOPWINDOWCONTROLLER___C__DISPLAYCLASS32_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1569EDC0)
#define MOLEMOLE_UIRABSTAGEREWARDPOPWINDOWCONTROLLER___C__DISPLAYCLASS32_0__ONSTAGEREWARDBTNCLICK_B__0_OFFSET UNITYSDK_OFFSET(0x1569EDD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABStageRewardPopWindowController___c__DisplayClass32_0_TypeDefinitionIndex = 62179;
