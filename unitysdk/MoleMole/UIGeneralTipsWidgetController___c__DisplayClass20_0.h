...
#define MOLEMOLE_UIGENERALTIPSWIDGETCONTROLLER___C__DISPLAYCLASS20_0__CTOR_OFFSET UNITYSDK_OFFSET(0x185AB240)
#define MOLEMOLE_UIGENERALTIPSWIDGETCONTROLLER___C__DISPLAYCLASS20_0__SETTEXT_B__0_OFFSET UNITYSDK_OFFSET(0x185AB250)
#define MOLEMOLE_UIGENERALTIPSWIDGETCONTROLLER___C__DISPLAYCLASS20_0__SETTEXT_B__1_OFFSET UNITYSDK_OFFSET(0x185AB2A0)
#define MOLEMOLE_UIGENERALTIPSWIDGETCONTROLLER___C__DISPLAYCLASS20_0__SETTEXT_B__2_OFFSET UNITYSDK_OFFSET(0x185AB3E0)
#define MOLEMOLE_UIGENERALTIPSWIDGETCONTROLLER___C__DISPLAYCLASS20_0__SETTEXT_B__3_OFFSET UNITYSDK_OFFSET(0x185AB3B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralTipsWidgetController___c__DisplayClass20_0_TypeDefinitionIndex = 91254;
