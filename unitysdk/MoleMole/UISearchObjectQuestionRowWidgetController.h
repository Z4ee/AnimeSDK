...
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x15A27070)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A27230)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15A27340)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A272C0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A26EC0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER_REFRESHBYCONTEXT_OFFSET UNITYSDK_OFFSET(0x15A273A0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER_REFRESHSELECT_OFFSET UNITYSDK_OFFSET(0x15A270D0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x15A27650)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15A276C0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x15A27730)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A27740)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15A277D0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A27870)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A27900)

namespace MoleMole
{
	inline static constexpr unsigned int UISearchObjectQuestionRowWidgetController_TypeDefinitionIndex = 79600;
