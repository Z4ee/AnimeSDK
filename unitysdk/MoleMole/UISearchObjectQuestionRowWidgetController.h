...
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x15339F80)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1533A140)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1533A250)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1533A1D0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15339DD0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER_REFRESHBYCONTEXT_OFFSET UNITYSDK_OFFSET(0x1533A2B0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER_REFRESHSELECT_OFFSET UNITYSDK_OFFSET(0x15339FE0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x1533A570)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1533A5E0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x1533A650)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1533A660)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1533A6F0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1533A790)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1533A820)

namespace MoleMole
{
	inline static constexpr unsigned int UISearchObjectQuestionRowWidgetController_TypeDefinitionIndex = 40690;
	...
	public:
		...
		::System::String* m_animNameSingleFadein; // 0x2F8
		::System::String* m_animNameSingleFadeout; // 0x300
		::System::String* m_animNameMultiFadein; // 0x308
		::System::String* m_animNameMultiFadeout; // 0x310
		::System::Boolean m_useSingleOrMultiple; // 0x318
		::System::Boolean m_isSelected; // 0x319
		::System::Action_2<::System::Int32, ::System::Boolean>* m_selectedChangeCallback; // 0x320
		::System::Int32 m_index; // 0x328
