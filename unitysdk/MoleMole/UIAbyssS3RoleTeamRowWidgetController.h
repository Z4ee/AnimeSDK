...
#define MOLEMOLE_UIABYSSS3ROLETEAMROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18A230E0)
#define MOLEMOLE_UIABYSSS3ROLETEAMROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18A23150)
#define MOLEMOLE_UIABYSSS3ROLETEAMROWWIDGETCONTROLLER_ONSETDATA_OFFSET UNITYSDK_OFFSET(0x18A23210)
#define MOLEMOLE_UIABYSSS3ROLETEAMROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18A232D0)
#define MOLEMOLE_UIABYSSS3ROLETEAMROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18A23330)
#define MOLEMOLE_UIABYSSS3ROLETEAMROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18A23390)
#define MOLEMOLE_UIABYSSS3ROLETEAMROWWIDGETCONTROLLER___BASE_ONSETDATA_OFFSET UNITYSDK_OFFSET(0x18A23430)
#define MOLEMOLE_UIABYSSS3ROLETEAMROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18A234D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS3RoleTeamRowWidgetController_TypeDefinitionIndex = 61716;
