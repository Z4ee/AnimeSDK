...
class Class_2_79AE422BA06F6D26_285;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }

#define MOLEMOLE_UIBALLGAMEROLEHUDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1DE36CE0)
#define MOLEMOLE_UIBALLGAMEROLEHUDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1DE36D70)
#define MOLEMOLE_UIBALLGAMEROLEHUDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1DE36BF0)
#define MOLEMOLE_UIBALLGAMEROLEHUDWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1DE36C60)
#define MOLEMOLE_UIBALLGAMEROLEHUDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE36E00)
#define MOLEMOLE_UIBALLGAMEROLEHUDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1DE36E60)
#define MOLEMOLE_UIBALLGAMEROLEHUDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1DE36EF0)
#define MOLEMOLE_UIBALLGAMEROLEHUDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1DE36F80)
#define MOLEMOLE_UIBALLGAMEROLEHUDWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1DE37010)

namespace MoleMole
{
	inline static constexpr unsigned int UIBallGameRoleHudWidgetController_TypeDefinitionIndex = 93399;

	class UIBallGameRoleHudWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_285* _view; // 0x2C0
