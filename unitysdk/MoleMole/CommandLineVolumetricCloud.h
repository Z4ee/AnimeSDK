...
#define MOLEMOLE_COMMANDLINEVOLUMETRICCLOUD_METHOD_2_3EB198A92CD33CB5_OFFSET UNITYSDK_OFFSET(0x1927F1B0)
#define MOLEMOLE_COMMANDLINEVOLUMETRICCLOUD_METHOD_2_EE1E6C2EB9760399_OFFSET UNITYSDK_OFFSET(0x1927F0A0)
#define MOLEMOLE_COMMANDLINEVOLUMETRICCLOUD__CTOR_OFFSET UNITYSDK_OFFSET(0x1927F170)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineVolumetricCloud_TypeDefinitionIndex = 55094;
