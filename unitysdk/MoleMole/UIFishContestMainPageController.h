...
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_CHANGETOFISHQTE_OFFSET UNITYSDK_OFFSET(0x16983FE0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_CHANGETOSTARTFISH_OFFSET UNITYSDK_OFFSET(0x16983E10)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_CHANGETOWAITFISH_OFFSET UNITYSDK_OFFSET(0x16983B00)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_CLEARALLSTATE_OFFSET UNITYSDK_OFFSET(0x169814E0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_CLOSEMAINCITYSTOREPAGE_OFFSET UNITYSDK_OFFSET(0x16987780)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_CLOSEUI_OFFSET UNITYSDK_OFFSET(0x16987160)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_COMPARISON_OFFSET UNITYSDK_OFFSET(0x16989390)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x169807B0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x16983730)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16980860)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHBEGINWAITIDLEHANDLE_OFFSET UNITYSDK_OFFSET(0x16983CE0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHENDWAITIDLEHANDLE_OFFSET UNITYSDK_OFFSET(0x16983D70)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGBATTLEPROGRESSHANDLE_OFFSET UNITYSDK_OFFSET(0x16984E70)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGENDCOUNTDOWNHANDLE_OFFSET UNITYSDK_OFFSET(0x16987E30)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGENDTIMELINEHANDLE_OFFSET UNITYSDK_OFFSET(0x16987BA0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGFAILPRESSHANDLE_OFFSET UNITYSDK_OFFSET(0x169864D0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGHPUPDATE_OFFSET UNITYSDK_OFFSET(0x16986F70)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGMATCHFINALTIMEHANDLE_OFFSET UNITYSDK_OFFSET(0x169881E0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGMATCHTIMEOUTHANDLE_OFFSET UNITYSDK_OFFSET(0x16988070)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGMATCHTIMEUPDATEHANDLE_OFFSET UNITYSDK_OFFSET(0x16987FA0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGQTERESULTHANDLE_OFFSET UNITYSDK_OFFSET(0x16984690)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGQTETIMERATEHANDLE_OFFSET UNITYSDK_OFFSET(0x16984780)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGQUEUEENDHANDLE_OFFSET UNITYSDK_OFFSET(0x16987080)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGSINGLEBATTLEENDHANDLE_OFFSET UNITYSDK_OFFSET(0x16986B60)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGSTARTBATTLELOOPHANDLE_OFFSET UNITYSDK_OFFSET(0x16984840)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGSTARTCOUNTDOWNHANDLE_OFFSET UNITYSDK_OFFSET(0x16987BF0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGSTARTSINGLEBATTLEHANDLE_OFFSET UNITYSDK_OFFSET(0x16984FB0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGSTARTSKILLHANDLE_OFFSET UNITYSDK_OFFSET(0x16986420)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGSTARTTIMELINEHANDLE_OFFSET UNITYSDK_OFFSET(0x16987B50)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGSUCCESSCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x16986900)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGSUCCESSPRESSHANDLE_OFFSET UNITYSDK_OFFSET(0x169866E0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONGOINGTRIGGER_OFFSET UNITYSDK_OFFSET(0x16989440)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x16984240)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x16982C90)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONMATCHCLOSE_OFFSET UNITYSDK_OFFSET(0x169877D0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x169838F0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x16982540)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16982C20)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16981B30)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x169808F0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x169807C0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_SHOWFOLLOWTIPS_OFFSET UNITYSDK_OFFSET(0x16986210)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_SHOWNEWTIPS_OFFSET UNITYSDK_OFFSET(0x169842A0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_UPDATEFOLLOWTIPSPOS_OFFSET UNITYSDK_OFFSET(0x16982160)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_UPDATEPLAYERINFO_OFFSET UNITYSDK_OFFSET(0x16988280)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x16981DE0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_WAITMESSAGECENTERFREE_OFFSET UNITYSDK_OFFSET(0x16987700)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x169894C0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER__ONFISHINGSTARTCOUNTDOWNHANDLE_B__68_0_OFFSET UNITYSDK_OFFSET(0x16989C90)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER__ONFISHINGSTARTSINGLEBATTLEHANDLE_B__49_0_OFFSET UNITYSDK_OFFSET(0x16989780)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER__ONFISHINGSTARTSINGLEBATTLEHANDLE_B__49_1_OFFSET UNITYSDK_OFFSET(0x16989850)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER__ONFISHINGSTARTSINGLEBATTLEHANDLE_B__49_2_OFFSET UNITYSDK_OFFSET(0x16989920)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER__ONFISHINGSTARTSINGLEBATTLEHANDLE_B__49_3_OFFSET UNITYSDK_OFFSET(0x169899F0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER__ONMATCHCLOSE_B__65_0_OFFSET UNITYSDK_OFFSET(0x16989AF0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER__ONUIINIT_B__33_0_OFFSET UNITYSDK_OFFSET(0x16989640)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER__ONUIOPEN_B__32_0_OFFSET UNITYSDK_OFFSET(0x169895C0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER__SHOWFOLLOWTIPS_B__59_0_OFFSET UNITYSDK_OFFSET(0x16989AC0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER___BASE_CLOSEMAINCITYSTOREPAGE_OFFSET UNITYSDK_OFFSET(0x16989CD0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16989CE0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x16989D70)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x16989E00)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16989E30)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x16989ED0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16989EE0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16989EF0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16989F00)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x16989F10)

namespace MoleMole
{
	inline static constexpr unsigned int UIFishContestMainPageController_TypeDefinitionIndex = 56741;

	class UIFishContestMainPageController : public ::MoleMole::UIMainCityStorePageController
	{
	public:
		::Class_2_60638234271CCDB8_26* _view; // 0x320
		::MoleMole::UIFishContestMainPageController_EState _state; // 0x328
		::Class_2_3CC769D284A54927_Enum_3_059D0CF60338BF04 _mode; // 0x32C
		::System::Int32 _leftOrRight; // 0x330
		::System::Single _battleProgress; // 0x334
		::System::String* _currentTips; // 0x338
		::UnityEngine::Vector3 _followTipsPos; // 0x340
		::UnityEngine::Coroutine* _animCoroutine; // 0x350
		::MoleMole::UIFishClickButtonWidgetController* _leftButtonController; // 0x358
		::MoleMole::UIFishClickButtonWidgetController* _rightButtonController; // 0x360
		::Foundation::Coroutine::CoroutineHandle _rowAnimationHandle; // 0x368
		::Foundation::Coroutine::CoroutineHandle _waitMessageCenterHandle; // 0x36C
		::UnityEngine::Coroutine* _pressLoopHandle; // 0x370
		::System::Collections::Generic::List_1<::Class_1_451601B8BB62C38C_6*>* _viewPlayerInfos; // 0x378
		::System::Collections::Generic::List_1<::Class_1_451601B8BB62C38C_6*>* _addList; // 0x380
		::System::Collections::Generic::List_1<::Class_1_451601B8BB62C38C_6*>* _removeList; // 0x388
		::Foundation::Coroutine::CoroutineHandle _matchPlayerHandle; // 0x390
		::System::Boolean _waitAutoRestart; // 0x394
		::System::Boolean _oldDebugMode; // 0x395
		::System::Int32 _oldDebugFishId; // 0x398
		::System::Int32 _oldLevelId; // 0x39C
		::System::UInt32 _oldInteractId; // 0x3A0
		::System::String* _lastSoundState; // 0x3A8
		::System::Boolean _startFishDown; // 0x3B0
		::System::Boolean _startFishCurrentDown; // 0x3B1
		::Class_1_677BD2A1DAB39F39* _chatPlayer; // 0x3B8
		...
		::System::Int32 Comparison(::Class_1_451601B8BB62C38C_6* x, ::Class_1_451601B8BB62C38C_6* y)
		{
			return ((::System::Int32(*)(::PVOID, ::Class_1_451601B8BB62C38C_6*, ::Class_1_451601B8BB62C38C_6*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_COMPARISON_OFFSET))(this, x, y);
		}
		...
		::Class_0_16E4307DCC419505_336* _OnUIOpen_b__32_0()
		{
			return ((::Class_0_16E4307DCC419505_336*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER__ONUIOPEN_B__32_0_OFFSET))(this);
		}
