...
class Class_2_60638234271CCDB8_59_Class_2_CC03AAEE6FCC732C_10;
class Class_2_60638234271CCDB8_59_Class_2_EF16346D79C18F15_7;
...
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER_CHECKNEWBIE_OFFSET UNITYSDK_OFFSET(0x14E5BB20)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x14E5B690)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER_INITBUFF_OFFSET UNITYSDK_OFFSET(0x14E5C450)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER_ONCARDSET_OFFSET UNITYSDK_OFFSET(0x14E5DB60)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14E5D350)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER_ONNEWBIECLOSE_OFFSET UNITYSDK_OFFSET(0x14E5BA80)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14E5D3E0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14E5B6A0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14E5B7C0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER_REFRESHBUFFSET_OFFSET UNITYSDK_OFFSET(0x14E5D4F0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER_SETCANCELCALLBACK_OFFSET UNITYSDK_OFFSET(0x14E5D4A0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER_SETCLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x14E5D450)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER_TRIGGERNEWBIE_OFFSET UNITYSDK_OFFSET(0x14E5BB90)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER_UPDATEFLOORINDEX_OFFSET UNITYSDK_OFFSET(0x14E5BE50)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14E5DDA0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER__INITBUFF_G__SETATTR_9_1_OFFSET UNITYSDK_OFFSET(0x14E5DE60)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER__INITBUFF_G__UPDATEATTRIBUTE_9_0_OFFSET UNITYSDK_OFFSET(0x14E5C630)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER__ONUIOPEN_B__4_0_OFFSET UNITYSDK_OFFSET(0x14E5DE30)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14E5DF40)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14E5DFD0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14E5DFE0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14E5DFF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerFightingBuffPopWindowController_TypeDefinitionIndex = 48303;
	...
	public:
		...
		::Class_2_60638234271CCDB8_59* _view; // 0x310
		::System::Action* cancel; // 0x318
		::System::Action* callback; // 0x320
		::System::Int32 towerid; // 0x328
		::System::UInt32 currentFloor; // 0x32C
		::Class_2_08E43914789BE5F3* babelTowerModel; // 0x330
		::System::Collections::Generic::List_1<::MoleMole::UIBabeltowerFightingBuffItemWidgetController*>* buffs; // 0x338
		...
		static ::System::Void _InitBuff_g__SetAttr_9_1(::Class_2_0D31A1661D004892<::Class_2_60638234271CCDB8_59_Class_2_EF16346D79C18F15_7*>* iconView, ::Class_2_0D31A1661D004892<::Class_2_60638234271CCDB8_59_Class_2_CC03AAEE6FCC732C_10*>* nameView, ::Class_2_208CC9941471731A_1043* template_)
		{
			return ((::System::Void(*)(::Class_2_0D31A1661D004892<::Class_2_60638234271CCDB8_59_Class_2_EF16346D79C18F15_7*>*, ::Class_2_0D31A1661D004892<::Class_2_60638234271CCDB8_59_Class_2_CC03AAEE6FCC732C_10*>*, ::Class_2_208CC9941471731A_1043*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER__INITBUFF_G__SETATTR_9_1_OFFSET))(iconView, nameView, template_);
		}
