...
#define MOLEMOLE_UIBOSSCHALLENGEPAGECONTROLLER_LAYERINFODATA_EQUALS_OFFSET UNITYSDK_OFFSET(0x75AEF0)
#define MOLEMOLE_UIBOSSCHALLENGEPAGECONTROLLER_LAYERINFODATA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x75AF00)
#define MOLEMOLE_UIBOSSCHALLENGEPAGECONTROLLER_LAYERINFODATA_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x12F748A0)
#define MOLEMOLE_UIBOSSCHALLENGEPAGECONTROLLER_LAYERINFODATA_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x12F748F0)
#define MOLEMOLE_UIBOSSCHALLENGEPAGECONTROLLER_LAYERINFODATA___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x75AF10)
#define MOLEMOLE_UIBOSSCHALLENGEPAGECONTROLLER_LAYERINFODATA___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x75AF70)

namespace MoleMole
{
	inline static constexpr unsigned int UIBossChallengePageController_LayerInfoData_TypeDefinitionIndex = 56294;
