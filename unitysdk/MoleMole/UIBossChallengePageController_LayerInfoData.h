...
#define MOLEMOLE_UIBOSSCHALLENGEPAGECONTROLLER_LAYERINFODATA_EQUALS_OFFSET UNITYSDK_OFFSET(0x7EA390)
#define MOLEMOLE_UIBOSSCHALLENGEPAGECONTROLLER_LAYERINFODATA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7EA3A0)
#define MOLEMOLE_UIBOSSCHALLENGEPAGECONTROLLER_LAYERINFODATA_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x14C061F0)
#define MOLEMOLE_UIBOSSCHALLENGEPAGECONTROLLER_LAYERINFODATA_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x14C06240)
#define MOLEMOLE_UIBOSSCHALLENGEPAGECONTROLLER_LAYERINFODATA___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x7EA3B0)
#define MOLEMOLE_UIBOSSCHALLENGEPAGECONTROLLER_LAYERINFODATA___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7EA410)

namespace MoleMole
{
	inline static constexpr unsigned int UIBossChallengePageController_LayerInfoData_TypeDefinitionIndex = 42487;
