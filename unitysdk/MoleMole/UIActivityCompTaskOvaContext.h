...
#define MOLEMOLE_UIACTIVITYCOMPTASKOVACONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x17E3FD30)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityCompTaskOvaContext_TypeDefinitionIndex = 61822;
