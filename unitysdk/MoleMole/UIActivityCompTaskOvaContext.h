...
#define MOLEMOLE_UIACTIVITYCOMPTASKOVACONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18651700)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityCompTaskOvaContext_TypeDefinitionIndex = 76958;
