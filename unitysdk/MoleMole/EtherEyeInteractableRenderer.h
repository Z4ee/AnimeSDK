...
#define MOLEMOLE_ETHEREYEINTERACTABLERENDERER_CLOSEVISION_OFFSET UNITYSDK_OFFSET(0x116022A0)
#define MOLEMOLE_ETHEREYEINTERACTABLERENDERER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x11602A10)
#define MOLEMOLE_ETHEREYEINTERACTABLERENDERER_METHOD_5_2839AE123F8ECAA7_OFFSET UNITYSDK_OFFSET(0x11602A60)
#define MOLEMOLE_ETHEREYEINTERACTABLERENDERER_METHOD_5_3C927B51D2142A24_1_OFFSET UNITYSDK_OFFSET(0x116038A0)
#define MOLEMOLE_ETHEREYEINTERACTABLERENDERER_METHOD_5_3C927B51D2142A24_2_OFFSET UNITYSDK_OFFSET(0x11603900)
#define MOLEMOLE_ETHEREYEINTERACTABLERENDERER_METHOD_5_3C927B51D2142A24_3_OFFSET UNITYSDK_OFFSET(0x11603960)
#define MOLEMOLE_ETHEREYEINTERACTABLERENDERER_METHOD_5_3C927B51D2142A24_4_OFFSET UNITYSDK_OFFSET(0x11603A20)
#define MOLEMOLE_ETHEREYEINTERACTABLERENDERER_METHOD_5_3C927B51D2142A24_OFFSET UNITYSDK_OFFSET(0x11603870)
#define MOLEMOLE_ETHEREYEINTERACTABLERENDERER_METHOD_5_660474B0F8C5FECE_1_OFFSET UNITYSDK_OFFSET(0x11601740)
#define MOLEMOLE_ETHEREYEINTERACTABLERENDERER_METHOD_5_660474B0F8C5FECE_OFFSET UNITYSDK_OFFSET(0x11601AB0)
#define MOLEMOLE_ETHEREYEINTERACTABLERENDERER_METHOD_5_B2C52ACF9D9B435B_OFFSET UNITYSDK_OFFSET(0x11600B40)
#define MOLEMOLE_ETHEREYEINTERACTABLERENDERER_METHOD_5_FB4BE762B6186C23_1_OFFSET UNITYSDK_OFFSET(0x11603930)
#define MOLEMOLE_ETHEREYEINTERACTABLERENDERER_METHOD_5_FB4BE762B6186C23_2_OFFSET UNITYSDK_OFFSET(0x11603990)
#define MOLEMOLE_ETHEREYEINTERACTABLERENDERER_METHOD_5_FB4BE762B6186C23_3_OFFSET UNITYSDK_OFFSET(0x116039C0)
#define MOLEMOLE_ETHEREYEINTERACTABLERENDERER_METHOD_5_FB4BE762B6186C23_4_OFFSET UNITYSDK_OFFSET(0x116039F0)
#define MOLEMOLE_ETHEREYEINTERACTABLERENDERER_METHOD_5_FB4BE762B6186C23_OFFSET UNITYSDK_OFFSET(0x116038D0)
#define MOLEMOLE_ETHEREYEINTERACTABLERENDERER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x11601E20)
#define MOLEMOLE_ETHEREYEINTERACTABLERENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x116016F0)
#define MOLEMOLE_ETHEREYEINTERACTABLERENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x11600AF0)
#define MOLEMOLE_ETHEREYEINTERACTABLERENDERER_OPENVISION_OFFSET UNITYSDK_OFFSET(0x11601E70)
#define MOLEMOLE_ETHEREYEINTERACTABLERENDERER_TRIGGERINTERACT_OFFSET UNITYSDK_OFFSET(0x116026E0)
#define MOLEMOLE_ETHEREYEINTERACTABLERENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x11603620)

namespace MoleMole
{
	inline static constexpr unsigned int EtherEyeInteractableRenderer_TypeDefinitionIndex = 56091;
	...
	public:
		...
		{
			return (::Foundation::AssetRequestHandle*)Il2CppClass::FromTypeDefinitionIndex(EtherEyeInteractableRenderer_TypeDefinitionIndex)->GetStaticField(0x46780);
		}
		static ::UnityEngine::Material** StaticGet_Field_5_3()
		{
			return (::UnityEngine::Material**)Il2CppClass::FromTypeDefinitionIndex(EtherEyeInteractableRenderer_TypeDefinitionIndex)->GetStaticField(0x467A0);
		}
		static ::Foundation::AssetRequestHandle* StaticGet_Field_5_5()
		{
			return (::Foundation::AssetRequestHandle*)Il2CppClass::FromTypeDefinitionIndex(EtherEyeInteractableRenderer_TypeDefinitionIndex)->GetStaticField(0x467A8);
		}
		static ::UnityEngine::Material** StaticGet_Field_5_4()
		{
			return (::UnityEngine::Material**)Il2CppClass::FromTypeDefinitionIndex(EtherEyeInteractableRenderer_TypeDefinitionIndex)->GetStaticField(0x467C8);
		}
