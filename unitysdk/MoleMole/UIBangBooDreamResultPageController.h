...
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_CALCULATEEXPMAP_OFFSET UNITYSDK_OFFSET(0x175A9E00)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_GETBUTTONCOMBINESTATE_OFFSET UNITYSDK_OFFSET(0x175AA410)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_GETCHALLENGETIME_OFFSET UNITYSDK_OFFSET(0x175A95E0)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_GETPANELSTATE_OFFSET UNITYSDK_OFFSET(0x175AA460)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_GETRANKINGSCORE_OFFSET UNITYSDK_OFFSET(0x175AA4B0)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_GETRATINGTYPE_OFFSET UNITYSDK_OFFSET(0x175A93A0)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175A9930)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_ONFADEINANIMEVENT_OFFSET UNITYSDK_OFFSET(0x175A9A80)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_ONPOPSHOWED_OFFSET UNITYSDK_OFFSET(0x175AA630)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_ONPREPARESHOW_OFFSET UNITYSDK_OFFSET(0x175AA510)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x175A9A30)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_REFRESHCARD_OFFSET UNITYSDK_OFFSET(0x175AA6A0)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_REFRESHDAMAGE_OFFSET UNITYSDK_OFFSET(0x175A9B90)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x175AB300)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER__REFRESHABYSSPOINT2_OFFSET UNITYSDK_OFFSET(0x175AAA90)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER___BASE_GETCHALLENGETIME_OFFSET UNITYSDK_OFFSET(0x175AB320)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER___BASE_GETRANKINGSCORE_OFFSET UNITYSDK_OFFSET(0x175AB330)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER___BASE_GETRATINGTYPE_OFFSET UNITYSDK_OFFSET(0x175AB3C0)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175AB3D0)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER___BASE_ONPREPARESHOW_OFFSET UNITYSDK_OFFSET(0x175AB4A0)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x175AB530)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER___BASE__REFRESHABYSSPOINT2_OFFSET UNITYSDK_OFFSET(0x175AB310)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangBooDreamResultPageController_TypeDefinitionIndex = 66290;

	class UIBangBooDreamResultPageController : public ::MoleMole::UILevelResultV2_PageController
	{
	public:
		::Class_2_60638234271CCDB8_91* _view; // 0x3C8
		...
		{
			return ((::Class_1_451601B8BB62C38C_3_Enum_3_3DCE6AAF7E47B319(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_GETBUTTONCOMBINESTATE_OFFSET))(this);
		}

		::Class_1_451601B8BB62C38C_3_Enum_3_A188519F532ACB95 GetPanelState()
		{
			return ((::Class_1_451601B8BB62C38C_3_Enum_3_A188519F532ACB95(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_GETPANELSTATE_OFFSET))(this);
		}
