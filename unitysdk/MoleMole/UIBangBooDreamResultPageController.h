...
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_CALCULATEEXPMAP_OFFSET UNITYSDK_OFFSET(0x14EB6920)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_GETBUTTONCOMBINESTATE_OFFSET UNITYSDK_OFFSET(0x14EB6F30)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_GETCHALLENGETIME_OFFSET UNITYSDK_OFFSET(0x14EB60F0)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_GETPANELSTATE_OFFSET UNITYSDK_OFFSET(0x14EB6F80)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_GETRANKINGSCORE_OFFSET UNITYSDK_OFFSET(0x14EB6FD0)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_GETRATINGTYPE_OFFSET UNITYSDK_OFFSET(0x14EB5EB0)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14EB6450)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_ONFADEINANIMEVENT_OFFSET UNITYSDK_OFFSET(0x14EB65A0)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_ONPOPSHOWED_OFFSET UNITYSDK_OFFSET(0x14EB7150)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_ONPREPARESHOW_OFFSET UNITYSDK_OFFSET(0x14EB7030)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14EB6550)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_REFRESHCARD_OFFSET UNITYSDK_OFFSET(0x14EB71C0)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_REFRESHDAMAGE_OFFSET UNITYSDK_OFFSET(0x14EB66B0)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14EB7DD0)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER__REFRESHABYSSPOINT2_OFFSET UNITYSDK_OFFSET(0x14EB75B0)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER___BASE_GETCHALLENGETIME_OFFSET UNITYSDK_OFFSET(0x14EB7DF0)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER___BASE_GETRANKINGSCORE_OFFSET UNITYSDK_OFFSET(0x14EB7E00)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER___BASE_GETRATINGTYPE_OFFSET UNITYSDK_OFFSET(0x14EB7E90)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14EB7EA0)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER___BASE_ONPREPARESHOW_OFFSET UNITYSDK_OFFSET(0x14EB7F70)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14EB8000)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER___BASE__REFRESHABYSSPOINT2_OFFSET UNITYSDK_OFFSET(0x14EB7DE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangBooDreamResultPageController_TypeDefinitionIndex = 63527;

	class UIBangBooDreamResultPageController : public ::MoleMole::UILevelResultV2_PageController
	{
	public:
		::Class_2_60638234271CCDB8_70* _view; // 0x3C0
		::MoleMole::UIGeneralExpProgressWidgetController* _expCtroller; // 0x3C8
		...
		{
			return ((::Class_1_451601B8BB62C38C_Enum_3_A188519F532ACB95(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_GETPANELSTATE_OFFSET))(this);
		}
