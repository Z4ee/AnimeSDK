...
#define MOLEMOLE_SHOPPINGMALLGIFTPACKCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x191B8F50)

namespace MoleMole
{
	inline static constexpr unsigned int ShoppingMallGiftPackContext_TypeDefinitionIndex = 83152;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_179*>*, ::MoleMole::MonoGamepadRegion*, ::Class_2_B4378B46E0020E85*, ::System::Action_1<::System::Int32>*))((::PBYTE)hIl2Cpp + MOLEMOLE_SHOPPINGMALLGIFTPACKCONTEXT__CTOR_OFFSET))(this, goods, region, Down_DetailBtn, onClick);
		}
	};
}
