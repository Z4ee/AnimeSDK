...
#define MOLEMOLE_UIRECYCLESMARTSETDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS40_0__CTOR_OFFSET UNITYSDK_OFFSET(0x152ABB10)
#define MOLEMOLE_UIRECYCLESMARTSETDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS40_0__ONOKBTNCLICK_B__0_OFFSET UNITYSDK_OFFSET(0x152ABB20)

namespace MoleMole
{
	inline static constexpr unsigned int UIRecycleSmartSetDialogPopWindowController___c__DisplayClass40_0_TypeDefinitionIndex = 48759;
	...
	public:
		...
		::MoleMole::UIRecycleSmartSetDialogPopWindowController* __4__this; // 0x18
