...
#define MOLEMOLE_UIDAILYQUESTREWARDLISTDIALOGPOPWINDOWCONTROLLER_DAILYQUESTREWARDROWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18042D80)

namespace MoleMole
{
	inline static constexpr unsigned int UIDailyQuestRewardListDialogPopWindowController_DailyQuestRewardRowContext_TypeDefinitionIndex = 78453;
