...
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175D3400)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_ONGETREWARDBUTTON_OFFSET UNITYSDK_OFFSET(0x175D3B30)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x175D35C0)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_ONTAKECOMMONREWARDEVENT_OFFSET UNITYSDK_OFFSET(0x175D3C00)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x175D3540)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x175D31A0)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x175D3390)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_REFRESHPANEL_OFFSET UNITYSDK_OFFSET(0x175D3680)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x175D3C50)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175D3C60)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x175D3CF0)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x175D3D90)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x175D3E20)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x175D3EB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerShopRewardItemWidgetController_TypeDefinitionIndex = 68331;
	...
	public:
		...
		::Class_2_208CC9941471731A_381* _tableInfo; // 0x300
