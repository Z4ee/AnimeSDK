...
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14ED9B90)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_ONGETREWARDBUTTON_OFFSET UNITYSDK_OFFSET(0x14EDA2C0)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x14ED9D50)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_ONTAKECOMMONREWARDEVENT_OFFSET UNITYSDK_OFFSET(0x14EDA390)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14ED9CD0)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14ED9930)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14ED9B20)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_REFRESHPANEL_OFFSET UNITYSDK_OFFSET(0x14ED9E10)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14EDA3E0)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14EDA3F0)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x14EDA480)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14EDA520)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14EDA5B0)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14EDA640)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerShopRewardItemWidgetController_TypeDefinitionIndex = 40202;

	class UIFlowerShopRewardItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_A3D97EDF9C99B3C3* _view; // 0x2E8
		::Class_2_923BB6EA0D9B637B* _model; // 0x2F0
		::Class_2_208CC9941471731A_312* _tableInfo; // 0x2F8
