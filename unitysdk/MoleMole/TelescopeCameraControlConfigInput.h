...
#define MOLEMOLE_TELESCOPECAMERACONTROLCONFIGINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x14509140)

namespace MoleMole
{
	inline static constexpr unsigned int TelescopeCameraControlConfigInput_TypeDefinitionIndex = 47275;
