...
#define MOLEMOLE_GBUFFERPREZOPTBYGPUMODELPOSTPROCESSORPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1737B230)
#define MOLEMOLE_GBUFFERPREZOPTBYGPUMODELPOSTPROCESSORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1737B2A0)
#define MOLEMOLE_GBUFFERPREZOPTBYGPUMODELPOSTPROCESSORPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1737B320)

namespace MoleMole
{
	inline static constexpr unsigned int GbufferPreZOptByGPUModelPostProcessorProfile_TypeDefinitionIndex = 44569;
