...
#define MOLEMOLE_GBUFFERPREZOPTBYGPUMODELPOSTPROCESSORPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x13022C20)
#define MOLEMOLE_GBUFFERPREZOPTBYGPUMODELPOSTPROCESSORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x13022C90)
#define MOLEMOLE_GBUFFERPREZOPTBYGPUMODELPOSTPROCESSORPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x13022D10)

namespace MoleMole
{
	inline static constexpr unsigned int GbufferPreZOptByGPUModelPostProcessorProfile_TypeDefinitionIndex = 73903;
