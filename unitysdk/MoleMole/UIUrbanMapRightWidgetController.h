...
#define MOLEMOLE_UIURBANMAPRIGHTWIDGETCONTROLLER_APPLYBANGKOVITEMINFOTOREWARDITEMS_OFFSET UNITYSDK_OFFSET(0x1655CF20)
#define MOLEMOLE_UIURBANMAPRIGHTWIDGETCONTROLLER_CREATITEMICON_OFFSET UNITYSDK_OFFSET(0x1655D460)
#define MOLEMOLE_UIURBANMAPRIGHTWIDGETCONTROLLER_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x1655E290)
#define MOLEMOLE_UIURBANMAPRIGHTWIDGETCONTROLLER_GET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x1655CCF0)
#define MOLEMOLE_UIURBANMAPRIGHTWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1655D8F0)
#define MOLEMOLE_UIURBANMAPRIGHTWIDGETCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1655D7D0)
#define MOLEMOLE_UIURBANMAPRIGHTWIDGETCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x1655D270)
#define MOLEMOLE_UIURBANMAPRIGHTWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x1655E1A0)
#define MOLEMOLE_UIURBANMAPRIGHTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1655DAA0)
#define MOLEMOLE_UIURBANMAPRIGHTWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x1655D5D0)
#define MOLEMOLE_UIURBANMAPRIGHTWIDGETCONTROLLER_POINTWIDGETCONTEXT_OFFSET UNITYSDK_OFFSET(0x1655E370)
#define MOLEMOLE_UIURBANMAPRIGHTWIDGETCONTROLLER_SETSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x1655CD00)
#define MOLEMOLE_UIURBANMAPRIGHTWIDGETCONTROLLER_SHOWEMPTYLABEL_OFFSET UNITYSDK_OFFSET(0x1655D590)
#define MOLEMOLE_UIURBANMAPRIGHTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1655E410)
#define MOLEMOLE_UIURBANMAPRIGHTWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1655E470)
#define MOLEMOLE_UIURBANMAPRIGHTWIDGETCONTROLLER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1655E510)
#define MOLEMOLE_UIURBANMAPRIGHTWIDGETCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x1655E520)
#define MOLEMOLE_UIURBANMAPRIGHTWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x1655E5D0)
#define MOLEMOLE_UIURBANMAPRIGHTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1655E660)
#define MOLEMOLE_UIURBANMAPRIGHTWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x1655E700)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapRightWidgetController_TypeDefinitionIndex = 82052;
	...
	public:
		...
		::System::Boolean _setScrollview; // 0x2E8
		::MonoUITableScrollV2* _rewardScrollView; // 0x2F0
