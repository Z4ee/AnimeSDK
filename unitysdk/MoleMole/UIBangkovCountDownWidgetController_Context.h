...
#define MOLEMOLE_UIBANGKOVCOUNTDOWNWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1646B820)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangkovCountDownWidgetController_Context_TypeDefinitionIndex = 47545;
