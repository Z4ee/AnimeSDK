...
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_BINDEVENT_BUTTON_OFFSET UNITYSDK_OFFSET(0xE851700)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_BINDEVENT_NOTIFY_OFFSET UNITYSDK_OFFSET(0xE851D50)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_BINDEVENT_SCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xE851A10)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_BUILDUNLOCKEDCOLLECTIONS_OFFSET UNITYSDK_OFFSET(0xE853B70)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_GET_CURRENTFOCUSVHSCOLLECTIONID_OFFSET UNITYSDK_OFFSET(0xE853A20)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_GET_TYPESELECTHEIGHT_OFFSET UNITYSDK_OFFSET(0xE8542A0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_GET_TYPESELECTWIDTH_OFFSET UNITYSDK_OFFSET(0xE854220)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xE8513F0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_INITDATA_OFFSET UNITYSDK_OFFSET(0xE851FF0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xE852B70)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ISSELECTEDVHSCOLLECTION_OFFSET UNITYSDK_OFFSET(0xE853430)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ISSELECTFULLVHS_OFFSET UNITYSDK_OFFSET(0xE853540)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONAFTERCURRENTSELECTCOLLECTIONIDCHANGED_OFFSET UNITYSDK_OFFSET(0xE851EA0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONAFTERVHSSELECTCHANGE_OFFSET UNITYSDK_OFFSET(0xE8536A0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONAUTOSELECTBTNCLICK_OFFSET UNITYSDK_OFFSET(0xE854110)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xE851400)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xE8531E0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xE853020)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONOKBTNCLICK_OFFSET UNITYSDK_OFFSET(0xE8540B0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xE852F20)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xE852FB0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xE851490)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xE851B70)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_REFRESHOKBTN_OFFSET UNITYSDK_OFFSET(0xE8536F0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_REFRESHTAGSPREVIEW_OFFSET UNITYSDK_OFFSET(0xE853B10)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_SELECTVHSCOLLECTION_OFFSET UNITYSDK_OFFSET(0xE8539D0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_SETOPTIONTEXT_OFFSET UNITYSDK_OFFSET(0xE8533C0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER__BINDEVENT_NOTIFY_B__13_0_OFFSET UNITYSDK_OFFSET(0xE8547D0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER__BINDEVENT_NOTIFY_B__13_1_OFFSET UNITYSDK_OFFSET(0xE854970)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xE854320)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER__INITDATA_G__GETALLLEVELTAG_21_1_OFFSET UNITYSDK_OFFSET(0xE854B10)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER__ONUIINIT_B__3_0_OFFSET UNITYSDK_OFFSET(0xE854430)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER__ONUIINIT_B__3_1_OFFSET UNITYSDK_OFFSET(0xE854760)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xE854B90)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xE854C20)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xE854CD0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xE854D00)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xE854DC0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xE854DD0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xE854DE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSStoreDialogV2PopWindowController_TypeDefinitionIndex = 67889;
	...
	public:
		...
		::MoleMole::UIVHSStoreDialogContext* _context; // 0x310
		::System::Collections::Generic::HashSet_1<::System::Int32>* _filterTag; // 0x318
		::System::Collections::Generic::HashSet_1<::System::Int32>* _filterTagLv; // 0x320
		::Class_2_79F6D62CE30E3F8E_66* _view; // 0x328
		::System::Collections::Generic::List_1<::MoleMole::UIVHSStorePicBtnWidgetController_Data*>* _unlockedCollectionsV2; // 0x330
		::MonoUIVHSDialogParam* _param; // 0x338
		::System::Collections::Generic::List_1<::MoleMole::UIVHSStoreTypeV2WidgetController*>* _childTypeControllers; // 0x340
		::MoleMole::UIVHSStoreVHSDetailWidgetController* _vhsDetailWidget; // 0x348
		::MoleMole::UIVHSStoreDropDownBtnWidgetController* _dropDownBtnWidget; // 0x350
		::MoleMole::UIVHSStoreDialogV2PopWindowController_Logic* _logic; // 0x358
		...
		static ::System::Int32 _InitData_g__GetAllLevelTag_21_1(::Class_2_208CC9941471731A_962* collectionTemplateExt)
		{
			return ((::System::Int32(*)(::Class_2_208CC9941471731A_962*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER__INITDATA_G__GETALLLEVELTAG_21_1_OFFSET))(collectionTemplateExt);
		}
