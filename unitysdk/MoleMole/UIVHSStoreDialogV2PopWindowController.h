...
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_BINDEVENT_BUTTON_OFFSET UNITYSDK_OFFSET(0x11BD9D60)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_BINDEVENT_NOTIFY_OFFSET UNITYSDK_OFFSET(0x11BDA3B0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_BINDEVENT_SCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x11BDA060)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_BUILDUNLOCKEDCOLLECTIONS_OFFSET UNITYSDK_OFFSET(0x11BDC240)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_GET_CURRENTFOCUSVHSCOLLECTIONID_OFFSET UNITYSDK_OFFSET(0x11BDC0F0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_GET_TYPESELECTHEIGHT_OFFSET UNITYSDK_OFFSET(0x11BDC970)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_GET_TYPESELECTWIDTH_OFFSET UNITYSDK_OFFSET(0x11BDC8F0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x11BD9A50)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_INITDATA_OFFSET UNITYSDK_OFFSET(0x11BDA650)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x11BDB1D0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ISSELECTEDVHSCOLLECTION_OFFSET UNITYSDK_OFFSET(0x11BDBB10)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ISSELECTFULLVHS_OFFSET UNITYSDK_OFFSET(0x11BDBC20)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONAFTERCURRENTSELECTCOLLECTIONIDCHANGED_OFFSET UNITYSDK_OFFSET(0x11BDA500)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONAFTERVHSSELECTCHANGE_OFFSET UNITYSDK_OFFSET(0x11BDBD80)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONAUTOSELECTBTNCLICK_OFFSET UNITYSDK_OFFSET(0x11BDC7E0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x11BD9A60)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x11BDB890)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x11BDB6D0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONOKBTNCLICK_OFFSET UNITYSDK_OFFSET(0x11BDC780)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x11BDB5D0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x11BDB660)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x11BD9AF0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x11BDA1D0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_REFRESHOKBTN_OFFSET UNITYSDK_OFFSET(0x11BDBDD0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_REFRESHTAGSPREVIEW_OFFSET UNITYSDK_OFFSET(0x11BDC1E0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_SELECTVHSCOLLECTION_OFFSET UNITYSDK_OFFSET(0x11BDC0A0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_SETOPTIONTEXT_OFFSET UNITYSDK_OFFSET(0x11BDBA70)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER__BINDEVENT_NOTIFY_B__13_0_OFFSET UNITYSDK_OFFSET(0x11BDCEF0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER__BINDEVENT_NOTIFY_B__13_1_OFFSET UNITYSDK_OFFSET(0x11BDD080)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11BDC9F0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER__INITDATA_G__GETALLLEVELTAG_21_1_OFFSET UNITYSDK_OFFSET(0x11BDD210)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER__ONUIINIT_B__3_0_OFFSET UNITYSDK_OFFSET(0x11BDCB00)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER__ONUIINIT_B__3_1_OFFSET UNITYSDK_OFFSET(0x11BDCE80)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x11BDD290)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x11BDD320)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x11BDD3D0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x11BDD400)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x11BDD4C0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x11BDD4D0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x11BDD4E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSStoreDialogV2PopWindowController_TypeDefinitionIndex = 68737;
	...
	public:
		...
		::Class_2_79F6D62CE30E3F8E_165* _view; // 0x330
		...
		static ::System::Int32 _InitData_g__GetAllLevelTag_21_1(::Class_2_208CC9941471731A_1093* collectionTemplateExt)
		{
			return ((::System::Int32(*)(::Class_2_208CC9941471731A_1093*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER__INITDATA_G__GETALLLEVELTAG_21_1_OFFSET))(collectionTemplateExt);
		}
