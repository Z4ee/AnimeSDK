...
#define MOLEMOLE_UIROLEEQUIPREPLACEWIDGETCONTROLLER___C__DISPLAYCLASS160_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17E3B280)
#define MOLEMOLE_UIROLEEQUIPREPLACEWIDGETCONTROLLER___C__DISPLAYCLASS160_0__ENSUREEQUIPEDITEMINLIST_B__0_OFFSET UNITYSDK_OFFSET(0x17E3B290)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleEquipReplaceWidgetController___c__DisplayClass160_0_TypeDefinitionIndex = 52770;
