...
#define MOLEMOLE_DOWNLOADMANIFEST_METHOD_1_92C46EC231D398A9_OFFSET UNITYSDK_OFFSET(0x1A010480)
#define MOLEMOLE_DOWNLOADMANIFEST_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A010290)
#define MOLEMOLE_DOWNLOADMANIFEST_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A010250)
#define MOLEMOLE_DOWNLOADMANIFEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1A010470)

namespace MoleMole
{
	inline static constexpr unsigned int DownloadManifest_TypeDefinitionIndex = 58330;
