...
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER_COLLECTALLANIMATIONCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x169F8EB0)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER_GET_PLACEHOLDERKEY_CURCHARGEPOINT_OFFSET UNITYSDK_OFFSET(0x169F7770)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER_GET_PLACEHOLDERKEY_ISENHANCE_OFFSET UNITYSDK_OFFSET(0x169F77B0)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER_GET_PLACEHOLDERKEY_MAXCHARGEPOINT_OFFSET UNITYSDK_OFFSET(0x169F77F0)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x169F7760)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER_HANDLEALLCUSTOMPROPERTIESONSHOW_OFFSET UNITYSDK_OFFSET(0x169F79C0)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER_HANDLECUSTOMPROPERTY_OFFSET UNITYSDK_OFFSET(0x169F7BA0)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER_HANDLEITEMMAT_OFFSET UNITYSDK_OFFSET(0x169F8600)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER_ISARRIVEMAXVALUE_OFFSET UNITYSDK_OFFSET(0x169F8820)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER_ISITEMALREADYFADEIN_OFFSET UNITYSDK_OFFSET(0x169F8590)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER_ISITEMFULL_OFFSET UNITYSDK_OFFSET(0x169F88E0)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x169F8A30)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x169F7830)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x169F78C0)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x169F8F70)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER___BASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x169F9010)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x169F90A0)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x169F9130)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelAlicePanelChildWindowController_TypeDefinitionIndex = 56100;
	...
	public:
		...
		::Class_2_DD249427878F7751* _view; // 0x350
