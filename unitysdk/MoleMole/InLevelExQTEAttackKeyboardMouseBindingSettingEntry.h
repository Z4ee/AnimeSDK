...
#define MOLEMOLE_INLEVELEXQTEATTACKKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x11758CB0)
#define MOLEMOLE_INLEVELEXQTEATTACKKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x11758CC0)
#define MOLEMOLE_INLEVELEXQTEATTACKKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x11758CD0)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelExQTEAttackKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 53219;
