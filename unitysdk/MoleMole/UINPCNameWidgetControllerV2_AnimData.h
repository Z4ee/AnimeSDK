...
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ANIMDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15D629C0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ANIMDATA_GET_GAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x15D62590)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ANIMDATA_PLAY_OFFSET UNITYSDK_OFFSET(0x15D626C0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ANIMDATA_SAMPLETOFADEANIMATION_OFFSET UNITYSDK_OFFSET(0x15D627C0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ANIMDATA_SAMPLETOFADEIN_OFFSET UNITYSDK_OFFSET(0x15D62820)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ANIMDATA_SAMPLETOFADEOUT_OFFSET UNITYSDK_OFFSET(0x15D628F0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ANIMDATA_SETANIMNAME_OFFSET UNITYSDK_OFFSET(0x15D62660)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ANIMDATA_SET_GAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x15D625A0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ANIMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x15D625B0)

namespace MoleMole
{
	inline static constexpr unsigned int UINPCNameWidgetControllerV2_AnimData_TypeDefinitionIndex = 63050;

	class UINPCNameWidgetControllerV2_AnimData : public ::System::Object
	{
	public:
		::System::String* _fadeInAnim; // 0x10
		::System::String* _fadeOutAnim; // 0x18
