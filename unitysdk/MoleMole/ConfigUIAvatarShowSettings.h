...
#define MOLEMOLE_CONFIGUIAVATARSHOWSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x190D3DE0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIAvatarShowSettings_TypeDefinitionIndex = 42728;
