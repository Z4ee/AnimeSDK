...
#define MOLEMOLE_GAMEGOTOPARAM_METHOD_1_0AF278B86D0A237C_OFFSET UNITYSDK_OFFSET(0x15130CA0)
#define MOLEMOLE_GAMEGOTOPARAM_METHOD_1_4A0CFEBE0C9DF506_OFFSET UNITYSDK_OFFSET(0x15130980)
#define MOLEMOLE_GAMEGOTOPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x15130970)

namespace MoleMole
{
	inline static constexpr unsigned int GamegotoParam_TypeDefinitionIndex = 61116;
