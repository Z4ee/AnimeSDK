...
#define MOLEMOLE_ROLERARITYICONITEMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x191B29B0)

namespace MoleMole
{
	inline static constexpr unsigned int RoleRarityIconItemConfig_TypeDefinitionIndex = 41817;
