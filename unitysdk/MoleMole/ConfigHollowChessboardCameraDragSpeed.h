...
#define MOLEMOLE_CONFIGHOLLOWCHESSBOARDCAMERADRAGSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1A94AAC0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigHollowChessboardCameraDragSpeed_TypeDefinitionIndex = 77199;
