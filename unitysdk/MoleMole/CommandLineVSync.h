...
#define MOLEMOLE_COMMANDLINEVSYNC_METHOD_2_B56A04952F869EF9_OFFSET UNITYSDK_OFFSET(0x12C58550)
#define MOLEMOLE_COMMANDLINEVSYNC_METHOD_2_BBEB22AFF699E501_OFFSET UNITYSDK_OFFSET(0x12C58440)
#define MOLEMOLE_COMMANDLINEVSYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x12C58510)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineVSync_TypeDefinitionIndex = 73338;
