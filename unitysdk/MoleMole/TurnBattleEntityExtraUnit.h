...
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT_CANTRANSFERTONEXTROUND_OFFSET UNITYSDK_OFFSET(0x160724F0)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT_GET_ENDROUNDINDEX_OFFSET UNITYSDK_OFFSET(0x160724C0)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT_GET_SOURCEUNIT_OFFSET UNITYSDK_OFFSET(0x160724E0)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT_ONTURNOVER_OFFSET UNITYSDK_OFFSET(0x16072780)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT_ONTURNSTART_OFFSET UNITYSDK_OFFSET(0x16072720)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT_SET_ENDROUNDINDEX_OFFSET UNITYSDK_OFFSET(0x160724D0)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT_TRYEXCHANGEENDROUNDINDEX_OFFSET UNITYSDK_OFFSET(0x160725F0)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT__CCTOR_OFFSET UNITYSDK_OFFSET(0x160727E0)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x16072550)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT___BASE_ONTURNOVER_OFFSET UNITYSDK_OFFSET(0x160727F0)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT___BASE_ONTURNSTART_OFFSET UNITYSDK_OFFSET(0x16072880)

namespace MoleMole
{
	inline static constexpr unsigned int TurnBattleEntityExtraUnit_TypeDefinitionIndex = 63287;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(TurnBattleEntityExtraUnit_TypeDefinitionIndex)->GetStaticField(0xEDD0);
		}
