...
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT_CANTRANSFERTONEXTROUND_OFFSET UNITYSDK_OFFSET(0x13866330)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT_GET_ENDROUNDINDEX_OFFSET UNITYSDK_OFFSET(0x13866300)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT_GET_SOURCEUNIT_OFFSET UNITYSDK_OFFSET(0x13866320)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT_ONTURNOVER_OFFSET UNITYSDK_OFFSET(0x13866610)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT_ONTURNSTART_OFFSET UNITYSDK_OFFSET(0x138665B0)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT_SET_ENDROUNDINDEX_OFFSET UNITYSDK_OFFSET(0x13866310)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT_TRYEXCHANGEENDROUNDINDEX_OFFSET UNITYSDK_OFFSET(0x13866440)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT__CCTOR_OFFSET UNITYSDK_OFFSET(0x13866670)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x13866390)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT___BASE_ONTURNOVER_OFFSET UNITYSDK_OFFSET(0x13866680)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT___BASE_ONTURNSTART_OFFSET UNITYSDK_OFFSET(0x13866710)

namespace MoleMole
{
	inline static constexpr unsigned int TurnBattleEntityExtraUnit_TypeDefinitionIndex = 51254;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(TurnBattleEntityExtraUnit_TypeDefinitionIndex)->GetStaticField(0xEBC0);
		}
