...
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_FINISH_OFFSET UNITYSDK_OFFSET(0x176D67F0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_GETCANAUTONEXT_OFFSET UNITYSDK_OFFSET(0x176D6B70)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_GETCHATSYNCDATA_OFFSET UNITYSDK_OFFSET(0x176D9610)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_GETISRUNNINGSKIP_OFFSET UNITYSDK_OFFSET(0x176D6970)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_GETNPCTAGBYCHATCONFIGAVATARID_OFFSET UNITYSDK_OFFSET(0x176D8820)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_GETTALKEMOSYNC_OFFSET UNITYSDK_OFFSET(0x176DB500)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_GETTALKENTITY_OFFSET UNITYSDK_OFFSET(0x176DB2C0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_GET_CAMERAWRAPPER_OFFSET UNITYSDK_OFFSET(0x176D6840)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_GET_ISFINISH_OFFSET UNITYSDK_OFFSET(0x176D67E0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_GET_OPENCONTEXT_OFFSET UNITYSDK_OFFSET(0x176D6830)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_INITNPCIK_OFFSET UNITYSDK_OFFSET(0x176D6D10)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_ISINMAINCITY_OFFSET UNITYSDK_OFFSET(0x176D74A0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_MODIFYTIME_OFFSET UNITYSDK_OFFSET(0x176D9D40)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_ONNODERUN_OFFSET UNITYSDK_OFFSET(0x176D6860)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_OVERRIDENEARCLIPDIS_OFFSET UNITYSDK_OFFSET(0x176D91A0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0x176D8C10)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_PLAYAVATARANIMATION_OFFSET UNITYSDK_OFFSET(0x176D8990)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_PLAYEMOSYNC_OFFSET UNITYSDK_OFFSET(0x176DB630)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_POSTFACIALANI_OFFSET UNITYSDK_OFFSET(0x176DBAE0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_POSTFACIALBUBBLE_OFFSET UNITYSDK_OFFSET(0x176DBCF0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_PROCESSCHATIK_OFFSET UNITYSDK_OFFSET(0x176D71E0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_PROCESSCONDITION_OFFSET UNITYSDK_OFFSET(0x176DADB0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_PRVCHECKSYNCINTERACTIONTOSERVER_OFFSET UNITYSDK_OFFSET(0x176D9930)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_RECORDDYNAMICOBJECTVISIBILITY_OFFSET UNITYSDK_OFFSET(0x176D93C0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_RECORDMEMBERIKOPERATION_OFFSET UNITYSDK_OFFSET(0x176D7520)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_RECORDNPCIKOPERATION_OFFSET UNITYSDK_OFFSET(0x176D7150)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_RECORDNPCVISIBILITY_OFFSET UNITYSDK_OFFSET(0x176D9340)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_RECORDPLAYERTRANSFORM_OFFSET UNITYSDK_OFFSET(0x176D7940)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_RESTORENPCIK_OFFSET UNITYSDK_OFFSET(0x176D77B0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_RESTOREPLAYERTRANSFORM_OFFSET UNITYSDK_OFFSET(0x176D7EF0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_SETANIMATORPARAM_OFFSET UNITYSDK_OFFSET(0x176D8F20)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_SETATTACHEFFECT_OFFSET UNITYSDK_OFFSET(0x176D8450)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_SETDYNAMICOBJECTVISIBLE_OFFSET UNITYSDK_OFFSET(0x176DA9D0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_SETJUMP_OFFSET UNITYSDK_OFFSET(0x176DB200)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_SETNEXT_OFFSET UNITYSDK_OFFSET(0x176DAD40)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_SETNPC_OFFSET UNITYSDK_OFFSET(0x176D6C80)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_SETSPECIALS_OFFSET UNITYSDK_OFFSET(0x176D9440)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_SETTAGVISIBLE_OFFSET UNITYSDK_OFFSET(0x176DA200)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_SET_CAMERAWRAPPER_OFFSET UNITYSDK_OFFSET(0x176D6850)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_SKIPSTORYPLAY_OFFSET UNITYSDK_OFFSET(0x176D6A00)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_STARTSKIPCHAT_OFFSET UNITYSDK_OFFSET(0x176D68B0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_STOPSKIPCHAT_OFFSET UNITYSDK_OFFSET(0x176D6910)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_TRYNOOPTIONSYNCINTERACTIONTOSERVER_OFFSET UNITYSDK_OFFSET(0x176D9A70)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_TRYOPTIONSYNCINTERACTIONTOSERVER_OFFSET UNITYSDK_OFFSET(0x176D9660)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_UPDATESKIPSTATE_OFFSET UNITYSDK_OFFSET(0x176D6B20)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x176DBF00)

namespace MoleMole
{
	inline static constexpr unsigned int UIBaseChatPlayController_TypeDefinitionIndex = 42193;
	...
	public:
		...
		::Class_1_9BA9DD31C0C37FC0* _chatNodePlayer; // 0x320
		...
		::Class_1_D65512A83CF70AB7* _chatRecordSyncData; // 0x368
		...
		{
			return ((::miHoYoEmotion::EmoSync*(*)(::PVOID, ::System::Int32, ::System::String*, ::System::UInt32&))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBASECHATPLAYCONTROLLER_GETTALKEMOSYNC_OFFSET))(this, speakerNpcTag, speakerMember, entityID);
		}
		...
		::System::Void PostFacialAni(::MoleMole::Battle::Entity* entity, ::System::String* facialKey)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::Battle::Entity*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBASECHATPLAYCONTROLLER_POSTFACIALANI_OFFSET))(this, entity, facialKey);
		}
