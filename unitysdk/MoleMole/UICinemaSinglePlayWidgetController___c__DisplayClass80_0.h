...
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS80_0__CTOR_OFFSET UNITYSDK_OFFSET(0x183D0870)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS80_0__SHOWSUPERBUBBLE_B__0_OFFSET UNITYSDK_OFFSET(0x183D0880)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS80_0__SHOWSUPERBUBBLE_B__1_OFFSET UNITYSDK_OFFSET(0x183D0A40)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS80_0__SHOWSUPERBUBBLE_B__2_OFFSET UNITYSDK_OFFSET(0x183D0B40)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS80_0__SHOWSUPERBUBBLE_B__3_OFFSET UNITYSDK_OFFSET(0x183D0C70)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS80_0__SHOWSUPERBUBBLE_B__4_OFFSET UNITYSDK_OFFSET(0x183D09F0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS80_0__SHOWSUPERBUBBLE_B__5_OFFSET UNITYSDK_OFFSET(0x183D0AF0)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaSinglePlayWidgetController___c__DisplayClass80_0_TypeDefinitionIndex = 46357;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_81* controllerView; // 0x20
