...
#define MOLEMOLE_UIARCADEPAGECONTROLLER___C__DISPLAYCLASS63_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A628C30)
#define MOLEMOLE_UIARCADEPAGECONTROLLER___C__DISPLAYCLASS63_0__SHOWINVITE_B__0_OFFSET UNITYSDK_OFFSET(0x1A628C40)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadePageController___c__DisplayClass63_0_TypeDefinitionIndex = 83505;
