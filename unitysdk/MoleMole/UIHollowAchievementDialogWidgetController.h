...
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGWIDGETCONTROLLER_DOFADEOUT_OFFSET UNITYSDK_OFFSET(0x162E35E0)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGWIDGETCONTROLLER_GETALPHA_OFFSET UNITYSDK_OFFSET(0x162E3300)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGWIDGETCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x162E2DB0)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGWIDGETCONTROLLER_INITACHIEVEMENT_OFFSET UNITYSDK_OFFSET(0x162E3E90)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGWIDGETCONTROLLER_INITCURSE_OFFSET UNITYSDK_OFFSET(0x162E37D0)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGWIDGETCONTROLLER_INITTABS_OFFSET UNITYSDK_OFFSET(0x162E3130)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x162E2F80)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x162E3290)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x162E2DC0)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x162E3010)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x162E4080)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGWIDGETCONTROLLER__INITTABS_G__INITCURSE_8_0_OFFSET UNITYSDK_OFFSET(0x162E3370)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGWIDGETCONTROLLER__ONUIINIT_B__3_0_OFFSET UNITYSDK_OFFSET(0x162E4090)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGWIDGETCONTROLLER__ONUIINIT_B__3_1_OFFSET UNITYSDK_OFFSET(0x162E4180)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x162E4270)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x162E4300)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x162E4310)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTDIALOGWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x162E4320)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowAchievementDialogWidgetController_TypeDefinitionIndex = 43098;

	class UIHollowAchievementDialogWidgetController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_36134FF29855BCB0* _view; // 0x310
		::MoleMole::UIWidgetController* lastWidget; // 0x318
		::System::Collections::Generic::List_1<::Class_1_0D6706375CDAAE8C*>* cardList; // 0x320
		::System::Collections::Generic::List_1<::Class_1_0D6706375CDAAE8C*>* blessList; // 0x328
		::System::Boolean isInHollow; // 0x330
		::System::Boolean isArpeggio; // 0x331
		::System::Int32 startIndex; // 0x334
