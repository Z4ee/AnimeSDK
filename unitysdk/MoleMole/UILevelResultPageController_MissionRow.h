...
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_MISSIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x184BB750)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultPageController_MissionRow_TypeDefinitionIndex = 69277;
