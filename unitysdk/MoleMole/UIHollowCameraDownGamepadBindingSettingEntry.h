...
#define MOLEMOLE_UIHOLLOWCAMERADOWNGAMEPADBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x17807350)
#define MOLEMOLE_UIHOLLOWCAMERADOWNGAMEPADBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x17807360)
#define MOLEMOLE_UIHOLLOWCAMERADOWNGAMEPADBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x17807370)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCameraDownGamepadBindingSettingEntry_TypeDefinitionIndex = 61623;
