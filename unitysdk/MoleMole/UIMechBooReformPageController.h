...
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_GETCOMPONENTSBYTABINDEX_OFFSET UNITYSDK_OFFSET(0x160FDBA0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_GET_MODEL_OFFSET UNITYSDK_OFFSET(0x160FDE10)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_GET_M_ALLCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x160FDD10)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x160FC570)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_INITTABS_OFFSET UNITYSDK_OFFSET(0x160FCC60)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ISTABSELECTED_OFFSET UNITYSDK_OFFSET(0x160FE6C0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONCLICKREFORM_OFFSET UNITYSDK_OFFSET(0x160FDA10)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONCLICKSETASTARGET_OFFSET UNITYSDK_OFFSET(0x160FDB60)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0x160FE3B0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x160FC580)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONSELECTCOMPONENT_OFFSET UNITYSDK_OFFSET(0x160FDC90)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONSERVERDATAUPDATE_OFFSET UNITYSDK_OFFSET(0x160FD360)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x160FE710)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x160FC610)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x160FC660)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_REFRESHITEMS_OFFSET UNITYSDK_OFFSET(0x160FD800)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_REFRESHPERFORMENCE_OFFSET UNITYSDK_OFFSET(0x160FE2C0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_REFRESHPROPERTIES_OFFSET UNITYSDK_OFFSET(0x160FDEE0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_REFRESHTABSELECTED_OFFSET UNITYSDK_OFFSET(0x160FE550)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_REFRESHUI_OFFSET UNITYSDK_OFFSET(0x160FD3C0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x160FE780)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER__ONCLICKTAB_B__22_0_OFFSET UNITYSDK_OFFSET(0x160FE950)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x160FE9D0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x160FEA60)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x160FEA70)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x160FEA80)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechBooReformPageController_TypeDefinitionIndex = 74810;

	class UIMechBooReformPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_8600CAA49EEC9D0F* _view; // 0x310
		::System::Int32 m_scriptID; // 0x318
		::MoleMole::Project::Config::MechaConfigTemplateExt* m_scriptCfg; // 0x320
		::Class_3_54181161AD221142_1* m_levelInfo; // 0x328
		::Class_2_35EE3F274435ACD1* m_curComponent; // 0x330
		::System::Collections::Generic::List_1<::MoleMole::UIMechBooReformTaskRowWidgetController*>* m_propertyCtrlList; // 0x338
		::System::Collections::Generic::List_1<::Class_2_31D08DC027B35B8F_Enum_3_BCA662D3210575AB>* m_propertyTypeList; // 0x340
		::Class_2_31D08DC027B35B8F_Enum_3_94F3E8DA9C14F011 m_curTabIndex; // 0x348
		::System::Collections::Generic::Dictionary_2<::Class_2_31D08DC027B35B8F_Enum_3_94F3E8DA9C14F011, ::Il2CppArray<::Class_2_35EE3F274435ACD1*>*>* m_allComponentsDict; // 0x350
		::System::Collections::Generic::List_1<::MoleMole::UIMechBooTabWidgetController*>* m_tabs; // 0x358
		::Class_2_31D08DC027B35B8F* _model; // 0x360
