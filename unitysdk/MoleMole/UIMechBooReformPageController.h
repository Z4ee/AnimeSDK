...
class Class_2_5E96E55EA9DF5E51;
...
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_GETCOMPONENTSBYTABINDEX_OFFSET UNITYSDK_OFFSET(0x184E6020)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_GET_MODEL_OFFSET UNITYSDK_OFFSET(0x184E6290)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_GET_M_ALLCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x184E6190)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x184E4980)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_INITTABS_OFFSET UNITYSDK_OFFSET(0x184E5080)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ISTABSELECTED_OFFSET UNITYSDK_OFFSET(0x184E6BB0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONCLICKREFORM_OFFSET UNITYSDK_OFFSET(0x184E5E90)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONCLICKSETASTARGET_OFFSET UNITYSDK_OFFSET(0x184E5FE0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0x184E68B0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x184E4990)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONSELECTCOMPONENT_OFFSET UNITYSDK_OFFSET(0x184E6110)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONSERVERDATAUPDATE_OFFSET UNITYSDK_OFFSET(0x184E57E0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x184E6C00)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x184E4A20)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x184E4A70)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_REFRESHITEMS_OFFSET UNITYSDK_OFFSET(0x184E5C80)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_REFRESHPERFORMENCE_OFFSET UNITYSDK_OFFSET(0x184E6780)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_REFRESHPROPERTIES_OFFSET UNITYSDK_OFFSET(0x184E6350)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_REFRESHTABSELECTED_OFFSET UNITYSDK_OFFSET(0x184E6A40)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_REFRESHUI_OFFSET UNITYSDK_OFFSET(0x184E5840)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x184E6C70)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER__ONCLICKTAB_B__22_0_OFFSET UNITYSDK_OFFSET(0x184E6E40)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x184E6EF0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x184E6F80)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x184E6F90)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x184E6FA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechBooReformPageController_TypeDefinitionIndex = 50384;

	class UIMechBooReformPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_5E96E55EA9DF5E51* _view; // 0x318
		::System::Int32 m_scriptID; // 0x320
		::MoleMole::Project::Config::MechaConfigTemplateExt* m_scriptCfg; // 0x328
		::Class_3_54181161AD221142_1* m_levelInfo; // 0x330
