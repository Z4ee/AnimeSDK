...
#define MOLEMOLE_LIVEHOUSEUNLOCKAVATARPOPSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x12F94540)
#define MOLEMOLE_LIVEHOUSEUNLOCKAVATARPOPSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x12F94590)
#define MOLEMOLE_LIVEHOUSEUNLOCKAVATARPOPSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x12F94550)

namespace MoleMole
{
	inline static constexpr unsigned int LiveHouseUnlockAvatarPopShow_TypeDefinitionIndex = 56236;
