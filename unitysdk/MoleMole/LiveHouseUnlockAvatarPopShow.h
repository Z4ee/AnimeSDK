...
#define MOLEMOLE_LIVEHOUSEUNLOCKAVATARPOPSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x107FA120)
#define MOLEMOLE_LIVEHOUSEUNLOCKAVATARPOPSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x107FA170)
#define MOLEMOLE_LIVEHOUSEUNLOCKAVATARPOPSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x107FA130)

namespace MoleMole
{
	inline static constexpr unsigned int LiveHouseUnlockAvatarPopShow_TypeDefinitionIndex = 61754;
