...
#define MOLEMOLE_UIFLOWERTIMELINEPAGECONTROLLER_CONTEXT_GET_FLOWERSHOP3DMODELCONTROLLER_OFFSET UNITYSDK_OFFSET(0x172DE730)
#define MOLEMOLE_UIFLOWERTIMELINEPAGECONTROLLER_CONTEXT_GET_FLOWERSTATES_OFFSET UNITYSDK_OFFSET(0x172DE750)
#define MOLEMOLE_UIFLOWERTIMELINEPAGECONTROLLER_CONTEXT_GET_FLOWERTIMLINEINFORMDATA_OFFSET UNITYSDK_OFFSET(0x172DE770)
#define MOLEMOLE_UIFLOWERTIMELINEPAGECONTROLLER_CONTEXT_GET_HIDETAG_OFFSET UNITYSDK_OFFSET(0x172DE7B0)
#define MOLEMOLE_UIFLOWERTIMELINEPAGECONTROLLER_CONTEXT_GET_PARTNERID_OFFSET UNITYSDK_OFFSET(0x172DE790)
#define MOLEMOLE_UIFLOWERTIMELINEPAGECONTROLLER_CONTEXT_SET_FLOWERSHOP3DMODELCONTROLLER_OFFSET UNITYSDK_OFFSET(0x172DE740)
#define MOLEMOLE_UIFLOWERTIMELINEPAGECONTROLLER_CONTEXT_SET_FLOWERSTATES_OFFSET UNITYSDK_OFFSET(0x172DE760)
#define MOLEMOLE_UIFLOWERTIMELINEPAGECONTROLLER_CONTEXT_SET_FLOWERTIMLINEINFORMDATA_OFFSET UNITYSDK_OFFSET(0x172DE780)
#define MOLEMOLE_UIFLOWERTIMELINEPAGECONTROLLER_CONTEXT_SET_HIDETAG_OFFSET UNITYSDK_OFFSET(0x172DE7C0)
#define MOLEMOLE_UIFLOWERTIMELINEPAGECONTROLLER_CONTEXT_SET_PARTNERID_OFFSET UNITYSDK_OFFSET(0x172DE7A0)
#define MOLEMOLE_UIFLOWERTIMELINEPAGECONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x172DE7D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerTimeLinePageController_Context_TypeDefinitionIndex = 62485;
