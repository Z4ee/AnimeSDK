...
#define MOLEMOLE_UIHACKERMINIGAMEPOINTWIDGETCONTROLLER_DOANIM_OFFSET UNITYSDK_OFFSET(0x167B7D60)
#define MOLEMOLE_UIHACKERMINIGAMEPOINTWIDGETCONTROLLER_DOROTATE_OFFSET UNITYSDK_OFFSET(0x167B8030)
#define MOLEMOLE_UIHACKERMINIGAMEPOINTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x167B7F20)
#define MOLEMOLE_UIHACKERMINIGAMEPOINTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x167B7FB0)
#define MOLEMOLE_UIHACKERMINIGAMEPOINTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x167B7880)
#define MOLEMOLE_UIHACKERMINIGAMEPOINTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x167B7EB0)
#define MOLEMOLE_UIHACKERMINIGAMEPOINTWIDGETCONTROLLER_ROTATETARGET_OFFSET UNITYSDK_OFFSET(0x167B80C0)
#define MOLEMOLE_UIHACKERMINIGAMEPOINTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x167B8500)
#define MOLEMOLE_UIHACKERMINIGAMEPOINTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x167B8560)
#define MOLEMOLE_UIHACKERMINIGAMEPOINTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x167B85F0)
#define MOLEMOLE_UIHACKERMINIGAMEPOINTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x167B8680)
#define MOLEMOLE_UIHACKERMINIGAMEPOINTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x167B8710)

namespace MoleMole
{
	inline static constexpr unsigned int UIHackerMiniGamePointWidgetController_TypeDefinitionIndex = 63643;
