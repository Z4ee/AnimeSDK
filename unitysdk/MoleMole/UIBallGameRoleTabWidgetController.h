...
#define MOLEMOLE_UIBALLGAMEROLETABWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1895E5D0)
#define MOLEMOLE_UIBALLGAMEROLETABWIDGETCONTROLLER_ONCLICKROLETABBUTTON_OFFSET UNITYSDK_OFFSET(0x1895EB10)
#define MOLEMOLE_UIBALLGAMEROLETABWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1895E640)
#define MOLEMOLE_UIBALLGAMEROLETABWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1895E860)
#define MOLEMOLE_UIBALLGAMEROLETABWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1895E6E0)
#define MOLEMOLE_UIBALLGAMEROLETABWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1895E920)
#define MOLEMOLE_UIBALLGAMEROLETABWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1895EDE0)
#define MOLEMOLE_UIBALLGAMEROLETABWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1895EDF0)
#define MOLEMOLE_UIBALLGAMEROLETABWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1895EE90)
#define MOLEMOLE_UIBALLGAMEROLETABWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1895EF30)

namespace MoleMole
{
	inline static constexpr unsigned int UIBallGameRoleTabWidgetController_TypeDefinitionIndex = 76062;
