...
#define MOLEMOLE_GRAPHICSETTINGPROFILECONTEXTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x16B91530)

namespace MoleMole
{
	inline static constexpr unsigned int GraphicSettingProfileContextBase_TypeDefinitionIndex = 71907;
