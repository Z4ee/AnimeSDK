...
#define MOLEMOLE_MONOEFFECTPLUGINHITWALL_CALCHITDIR_OFFSET UNITYSDK_OFFSET(0x19092D80)
#define MOLEMOLE_MONOEFFECTPLUGINHITWALL_GET_EFFECTLENGTH_OFFSET UNITYSDK_OFFSET(0x19092C60)
#define MOLEMOLE_MONOEFFECTPLUGINHITWALL_METHOD_6_871AC6DBEB0AF4F3_OFFSET UNITYSDK_OFFSET(0x19093100)
#define MOLEMOLE_MONOEFFECTPLUGINHITWALL__CTOR_OFFSET UNITYSDK_OFFSET(0x190930A0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginHitWall_TypeDefinitionIndex = 45183;
