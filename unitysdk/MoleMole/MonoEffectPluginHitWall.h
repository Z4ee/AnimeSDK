...
#define MOLEMOLE_MONOEFFECTPLUGINHITWALL_CALCHITDIR_OFFSET UNITYSDK_OFFSET(0x15B350A0)
#define MOLEMOLE_MONOEFFECTPLUGINHITWALL_GET_EFFECTLENGTH_OFFSET UNITYSDK_OFFSET(0x15B34F50)
#define MOLEMOLE_MONOEFFECTPLUGINHITWALL_METHOD_6_871AC6DBEB0AF4F3_OFFSET UNITYSDK_OFFSET(0x15B35440)
#define MOLEMOLE_MONOEFFECTPLUGINHITWALL__CTOR_OFFSET UNITYSDK_OFFSET(0x15B353E0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginHitWall_TypeDefinitionIndex = 76718;
