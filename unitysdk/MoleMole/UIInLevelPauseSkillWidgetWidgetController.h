...
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER_CLEARAVATARSKILLINFO_OFFSET UNITYSDK_OFFSET(0x14FF0F90)
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER_CLEARBUDDYSKILLINFO_OFFSET UNITYSDK_OFFSET(0x14FF0B90)
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER_GETAVATARID_OFFSET UNITYSDK_OFFSET(0x14FEF8B0)
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER_GETBUDDYID_OFFSET UNITYSDK_OFFSET(0x14FF18D0)
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER_INITBUDDYBTN_OFFSET UNITYSDK_OFFSET(0x14FF1390)
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER_INITROLEBTN_OFFSET UNITYSDK_OFFSET(0x14FEED00)
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER_ISBATTLEBUDDY_OFFSET UNITYSDK_OFFSET(0x14FF1A00)
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER_ONCLICKDROPDOWN_OFFSET UNITYSDK_OFFSET(0x14FF06D0)
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14FEF730)
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER_ONDROPDOWNCHANGE_OFFSET UNITYSDK_OFFSET(0x14FF0AE0)
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14FEF7C0)
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14FEE2D0)
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14FEE330)
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER_REFRESHAVATARSKILLINFO_OFFSET UNITYSDK_OFFSET(0x14FEF9D0)
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER_REFRESHBUDDYSKILLINFO_OFFSET UNITYSDK_OFFSET(0x14FF1F80)
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER_SETBUDDYINFO_OFFSET UNITYSDK_OFFSET(0x14FEE6B0)
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER_SETSELECTEDAVATARID_OFFSET UNITYSDK_OFFSET(0x14FF0300)
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER_SWITCHSELECTEDAVATAR_OFFSET UNITYSDK_OFFSET(0x14FEF930)
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER_SWITCHSELECTEDBUDDY_OFFSET UNITYSDK_OFFSET(0x14FF1950)
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER_TRYHANDLEGAMEPADSELECT_OFFSET UNITYSDK_OFFSET(0x14FF03D0)
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x14FF2D30)
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14FF29B0)
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER__INITBUDDYBTN_B__32_0_OFFSET UNITYSDK_OFFSET(0x14FF2DB0)
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER__INITROLEBTN_B__7_0_OFFSET UNITYSDK_OFFSET(0x14FF2DA0)
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER__ONUIOPEN_B__3_0_OFFSET UNITYSDK_OFFSET(0x14FF2D90)
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14FF2DC0)
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14FF2E50)
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14FF2EE0)
#define MOLEMOLE_UIINLEVELPAUSESKILLWIDGETWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14FF2F70)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseSkillWidgetWidgetController_TypeDefinitionIndex = 63173;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIInLevelPauseSkillWidgetWidgetController_TypeDefinitionIndex)->GetStaticField(0x489E0);
		}
		static ::System::String** StaticGet_BUDDY_NAME()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIInLevelPauseSkillWidgetWidgetController_TypeDefinitionIndex)->GetStaticField(0x489E8);
		}
		static ::System::Int32* StaticGet_MAX_BUDDY_NUM()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelPauseSkillWidgetWidgetController_TypeDefinitionIndex)->GetStaticField(0x117C0);
		}
		static ::System::Int32* StaticGet_MAX_AVATAR_NUM()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelPauseSkillWidgetWidgetController_TypeDefinitionIndex)->GetStaticField(0x117C4);
		}
		::Class_2_F034913F0CE169E2* _view; // 0x2B8
		::System::Collections::Generic::List_1<::Foundation::Coroutine::CoroutineHandle>* handleList; // 0x2C0
		::System::Collections::Generic::List_1<::MoleMole::UIInLevelPauseSkillRowWidgetController*>* skillRowList; // 0x2C8
		::System::Collections::Generic::List_1<::MoleMole::UITabBtnRoleRowWidgetController*>* roleTabBtns; // 0x2D0
		...
		::System::Int32 _curAvatarID; // 0x2E8
		::System::Int32 _curIndex; // 0x2EC
		::System::Collections::Generic::List_1<::MoleMole::UIInLevelPauseSkillWidgetWidgetController_SkillItem*>* _skillItemList; // 0x2F0
		::MoleMole::UIGeneralDynamicTipsPopWindowController* _dropDown; // 0x2F8
		::MoleMole::UIInLevelPauseSkillWidgetWidgetController_EShowType _curType; // 0x300
		::System::Collections::Generic::List_1<::MoleMole::UIInLevelPauseBangbooSkillRowWidgetController*>* _buddySkillRowList; // 0x308
		::System::Collections::Generic::List_1<::System::Int32>* buddyIDList; // 0x310
		::System::Collections::Generic::List_1<::Class_1_893417714B2AA846*>* buddyItemList; // 0x318
		::System::Int32 _curBuddyID; // 0x320
		::System::Int32 _curBuddyIndex; // 0x324
		::System::Collections::Generic::List_1<::MoleMole::UIInLevelPauseSkillWidgetWidgetController_BuddySkillItem*>* _buddySkillItemList; // 0x328
		::System::Collections::Generic::List_1<::MoleMole::UITabBtnRoleRowWidgetController*>* _buddyTabBtns; // 0x330
