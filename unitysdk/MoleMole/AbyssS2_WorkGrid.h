...
#define MOLEMOLE_ABYSSS2_WORKGRID_ADDLINE_1_OFFSET UNITYSDK_OFFSET(0x150D5C60)
#define MOLEMOLE_ABYSSS2_WORKGRID_ADDLINE_OFFSET UNITYSDK_OFFSET(0x150D5A30)
#define MOLEMOLE_ABYSSS2_WORKGRID_DELLINE_OFFSET UNITYSDK_OFFSET(0x150D5D10)
#define MOLEMOLE_ABYSSS2_WORKGRID_GET_CURRENTLINES_OFFSET UNITYSDK_OFFSET(0x150D5320)
#define MOLEMOLE_ABYSSS2_WORKGRID_GET_ISSNAPSHOT_OFFSET UNITYSDK_OFFSET(0x150D5370)
#define MOLEMOLE_ABYSSS2_WORKGRID_HASINTERSECT_1_OFFSET UNITYSDK_OFFSET(0x150D5800)
#define MOLEMOLE_ABYSSS2_WORKGRID_HASINTERSECT_OFFSET UNITYSDK_OFFSET(0x150D5570)
#define MOLEMOLE_ABYSSS2_WORKGRID_ISCOLLINEARANDOVERLAP_OFFSET UNITYSDK_OFFSET(0x150D6540)
#define MOLEMOLE_ABYSSS2_WORKGRID_ISINTERSECTED_OFFSET UNITYSDK_OFFSET(0x150D6200)
#define MOLEMOLE_ABYSSS2_WORKGRID_ISLINESAME_OFFSET UNITYSDK_OFFSET(0x150D6010)
#define MOLEMOLE_ABYSSS2_WORKGRID_ISPOINTONSEGMENT_OFFSET UNITYSDK_OFFSET(0x150D6880)
#define MOLEMOLE_ABYSSS2_WORKGRID_LINEINTERSECT_OFFSET UNITYSDK_OFFSET(0x150D5790)
#define MOLEMOLE_ABYSSS2_WORKGRID_MARKSNAPSHOT_OFFSET UNITYSDK_OFFSET(0x150D5390)
#define MOLEMOLE_ABYSSS2_WORKGRID_NEGATIVE_OFFSET UNITYSDK_OFFSET(0x150D67C0)
#define MOLEMOLE_ABYSSS2_WORKGRID_ROLLBACKSNAPSHOT_OFFSET UNITYSDK_OFFSET(0x150D5430)
#define MOLEMOLE_ABYSSS2_WORKGRID_SET_ISSNAPSHOT_OFFSET UNITYSDK_OFFSET(0x150D5380)
#define MOLEMOLE_ABYSSS2_WORKGRID_SUBMITSNAPSHOT_OFFSET UNITYSDK_OFFSET(0x150D54A0)
#define MOLEMOLE_ABYSSS2_WORKGRID_VECTORPRODUCT_OFFSET UNITYSDK_OFFSET(0x150D6820)
#define MOLEMOLE_ABYSSS2_WORKGRID__CHECK_INTERSECT_OFFSET UNITYSDK_OFFSET(0x150D5F70)
#define MOLEMOLE_ABYSSS2_WORKGRID__CTOR_OFFSET UNITYSDK_OFFSET(0x150D6910)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_WorkGrid_TypeDefinitionIndex = 87610;

	class AbyssS2_WorkGrid : public ::System::Object
	{
	public:
		// static const ::System::Double ZERO; // 0x0
		::System::Collections::Generic::List_1<::MoleMole::AbyssS2_WorkGrid_Line>* _currentLines; // 0x10
		::System::Collections::Generic::List_1<::MoleMole::AbyssS2_WorkGrid_Line>* _snapShotLines; // 0x18
