...
#define MOLEMOLE_ABYSSS2_WORKGRID_ADDLINE_1_OFFSET UNITYSDK_OFFSET(0x1701E610)
#define MOLEMOLE_ABYSSS2_WORKGRID_ADDLINE_OFFSET UNITYSDK_OFFSET(0x1701E3E0)
#define MOLEMOLE_ABYSSS2_WORKGRID_DELLINE_OFFSET UNITYSDK_OFFSET(0x1701E6C0)
#define MOLEMOLE_ABYSSS2_WORKGRID_GET_CURRENTLINES_OFFSET UNITYSDK_OFFSET(0x1701DCD0)
#define MOLEMOLE_ABYSSS2_WORKGRID_GET_ISSNAPSHOT_OFFSET UNITYSDK_OFFSET(0x1701DD20)
#define MOLEMOLE_ABYSSS2_WORKGRID_HASINTERSECT_1_OFFSET UNITYSDK_OFFSET(0x1701E1B0)
#define MOLEMOLE_ABYSSS2_WORKGRID_HASINTERSECT_OFFSET UNITYSDK_OFFSET(0x1701DF20)
#define MOLEMOLE_ABYSSS2_WORKGRID_ISCOLLINEARANDOVERLAP_OFFSET UNITYSDK_OFFSET(0x1701EF10)
#define MOLEMOLE_ABYSSS2_WORKGRID_ISINTERSECTED_OFFSET UNITYSDK_OFFSET(0x1701EBB0)
#define MOLEMOLE_ABYSSS2_WORKGRID_ISLINESAME_OFFSET UNITYSDK_OFFSET(0x1701E9C0)
#define MOLEMOLE_ABYSSS2_WORKGRID_ISPOINTONSEGMENT_OFFSET UNITYSDK_OFFSET(0x1701F260)
#define MOLEMOLE_ABYSSS2_WORKGRID_LINEINTERSECT_OFFSET UNITYSDK_OFFSET(0x1701E140)
#define MOLEMOLE_ABYSSS2_WORKGRID_MARKSNAPSHOT_OFFSET UNITYSDK_OFFSET(0x1701DD40)
#define MOLEMOLE_ABYSSS2_WORKGRID_NEGATIVE_OFFSET UNITYSDK_OFFSET(0x1701F1A0)
#define MOLEMOLE_ABYSSS2_WORKGRID_ROLLBACKSNAPSHOT_OFFSET UNITYSDK_OFFSET(0x1701DDE0)
#define MOLEMOLE_ABYSSS2_WORKGRID_SET_ISSNAPSHOT_OFFSET UNITYSDK_OFFSET(0x1701DD30)
#define MOLEMOLE_ABYSSS2_WORKGRID_SUBMITSNAPSHOT_OFFSET UNITYSDK_OFFSET(0x1701DE50)
#define MOLEMOLE_ABYSSS2_WORKGRID_VECTORPRODUCT_OFFSET UNITYSDK_OFFSET(0x1701F200)
#define MOLEMOLE_ABYSSS2_WORKGRID__CHECK_INTERSECT_OFFSET UNITYSDK_OFFSET(0x1701E920)
#define MOLEMOLE_ABYSSS2_WORKGRID__CTOR_OFFSET UNITYSDK_OFFSET(0x1701F300)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_WorkGrid_TypeDefinitionIndex = 85684;
