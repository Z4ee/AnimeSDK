...
#define MOLEMOLE_UIHOLLOWCAMERARESETGAMEPADBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x17807390)
#define MOLEMOLE_UIHOLLOWCAMERARESETGAMEPADBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x178073A0)
#define MOLEMOLE_UIHOLLOWCAMERARESETGAMEPADBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x178073B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCameraResetGamepadBindingSettingEntry_TypeDefinitionIndex = 51338;
