...
#define MOLEMOLE_CONFIGMATERIALPROPERTYSPECIALWEAPONEMISSIONMODIFIER_DOAFTERONENTER_OFFSET UNITYSDK_OFFSET(0x192267B0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYSPECIALWEAPONEMISSIONMODIFIER_DOONENTER_FORUSER_OFFSET UNITYSDK_OFFSET(0x19228710)
#define MOLEMOLE_CONFIGMATERIALPROPERTYSPECIALWEAPONEMISSIONMODIFIER_DOONENTER_OFFSET UNITYSDK_OFFSET(0x192266F0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYSPECIALWEAPONEMISSIONMODIFIER_DOWARMUP_OFFSET UNITYSDK_OFFSET(0x19228530)
#define MOLEMOLE_CONFIGMATERIALPROPERTYSPECIALWEAPONEMISSIONMODIFIER_ONDONE_OFFSET UNITYSDK_OFFSET(0x19228780)
#define MOLEMOLE_CONFIGMATERIALPROPERTYSPECIALWEAPONEMISSIONMODIFIER_PREPAREONENTER_OFFSET UNITYSDK_OFFSET(0x19226590)
#define MOLEMOLE_CONFIGMATERIALPROPERTYSPECIALWEAPONEMISSIONMODIFIER_PREPAREONEXIT_OFFSET UNITYSDK_OFFSET(0x192268A0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYSPECIALWEAPONEMISSIONMODIFIER_PROCESSENTER_OFFSET UNITYSDK_OFFSET(0x19226810)
#define MOLEMOLE_CONFIGMATERIALPROPERTYSPECIALWEAPONEMISSIONMODIFIER_PROCESSEXIT_OFFSET UNITYSDK_OFFSET(0x192268E0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYSPECIALWEAPONEMISSIONMODIFIER_PROCESSKEEP_OFFSET UNITYSDK_OFFSET(0x192272C0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYSPECIALWEAPONEMISSIONMODIFIER_SYNCENABLES_OFFSET UNITYSDK_OFFSET(0x19226E30)
#define MOLEMOLE_CONFIGMATERIALPROPERTYSPECIALWEAPONEMISSIONMODIFIER_SYNCVALUES_OFFSET UNITYSDK_OFFSET(0x192269D0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYSPECIALWEAPONEMISSIONMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x19228800)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigMaterialPropertySpecialWeaponEmissionModifier_TypeDefinitionIndex = 44727;
	...
	public:
		...
		::MoleMole::MaterialPropertyModifierValueVector _SpecialWeaponMergeParam03; // 0xBC
		::MoleMole::MaterialPropertyModifierValueBool _SpecialWeaponEmission; // 0xD4
		::MoleMole::MaterialPropertyModifierValueVector _SpecialWeaponEmissionTexSpeed; // 0xD8
		::MoleMole::MaterialPropertyModifierValueVector _SpecialWeaponMergeParam01; // 0xF0
		::MoleMole::MaterialPropertyModifierValueVector _SpecialWeaponMergeParam02; // 0x108
		::MoleMole::MaterialPropertyModifierValueColor _SpecialWeaponEmissionColor; // 0x120
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_413B2BDBE645DB66*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIGMATERIALPROPERTYSPECIALWEAPONEMISSIONMODIFIER_DOONENTER_FORUSER_OFFSET))(this, instance);
		}

		::System::Void OnDone(::Class_1_413B2BDBE645DB66* instance)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_413B2BDBE645DB66*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIGMATERIALPROPERTYSPECIALWEAPONEMISSIONMODIFIER_ONDONE_OFFSET))(this, instance);
		}
	};
}
