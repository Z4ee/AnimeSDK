...
#define MOLEMOLE_UIBUTTONPOSHANDLER_APPLYLAYOUTRESULT_OFFSET UNITYSDK_OFFSET(0x13E5EBB0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x13E5B1E0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_CALCULATELAYOUT_OFFSET UNITYSDK_OFFSET(0x13E5B6E0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_GETLAYOUTRESULT_1_OFFSET UNITYSDK_OFFSET(0x13E5D550)
#define MOLEMOLE_UIBUTTONPOSHANDLER_GETLAYOUTRESULT_OFFSET UNITYSDK_OFFSET(0x13E5EFE0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_GETPOSHANDLER_OFFSET UNITYSDK_OFFSET(0x13E5AF30)
#define MOLEMOLE_UIBUTTONPOSHANDLER_GET_BUTTONTYPE_OFFSET UNITYSDK_OFFSET(0x13E5AE70)
#define MOLEMOLE_UIBUTTONPOSHANDLER_GET_POSITIONTYPE_OFFSET UNITYSDK_OFFSET(0x13E5AE90)
#define MOLEMOLE_UIBUTTONPOSHANDLER_GET_SCENETYPE_OFFSET UNITYSDK_OFFSET(0x13E5AE80)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_09B8F368BEF6ADA5_OFFSET UNITYSDK_OFFSET(0x13E610B0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_1CCA9681CE0AE7A7_OFFSET UNITYSDK_OFFSET(0x13E5F770)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_2F117730B6ABAEDE_OFFSET UNITYSDK_OFFSET(0x13E61330)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_37D0382D0C30A2DC_OFFSET UNITYSDK_OFFSET(0x13E60580)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_4B72F72501001F72_OFFSET UNITYSDK_OFFSET(0x13E5CCB0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_4BCD51618C77AD95_OFFSET UNITYSDK_OFFSET(0x13E61020)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_5304726C363652C1_OFFSET UNITYSDK_OFFSET(0x13E5D350)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_5A19431060A597D2_OFFSET UNITYSDK_OFFSET(0x13E60E50)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_74166AE1162C06DF_1_OFFSET UNITYSDK_OFFSET(0x13E5D040)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_74166AE1162C06DF_OFFSET UNITYSDK_OFFSET(0x13E5CEC0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_882649FD9513E63E_OFFSET UNITYSDK_OFFSET(0x13E5D1C0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_8A9A7CCD2DCA2CF8_1_OFFSET UNITYSDK_OFFSET(0x13E60610)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_8A9A7CCD2DCA2CF8_OFFSET UNITYSDK_OFFSET(0x13E61140)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_9E570C2DADF4691D_1_OFFSET UNITYSDK_OFFSET(0x13E607E0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_9E570C2DADF4691D_OFFSET UNITYSDK_OFFSET(0x13E5FDE0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_A8270C103EB5FD67_OFFSET UNITYSDK_OFFSET(0x13E5C5E0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_A871253BFD471C99_OFFSET UNITYSDK_OFFSET(0x13E5C320)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_B6B10A3BCDE37B6E_OFFSET UNITYSDK_OFFSET(0x13E5C700)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_BBB00239B96BCEDC_1_OFFSET UNITYSDK_OFFSET(0x13E5F440)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_BBB00239B96BCEDC_OFFSET UNITYSDK_OFFSET(0x13E5F100)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_C1016C3FD846CDBF_1_OFFSET UNITYSDK_OFFSET(0x13E60260)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_C1016C3FD846CDBF_OFFSET UNITYSDK_OFFSET(0x13E5FAC0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x13E61310)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x13E60E10)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_E1A38AE09BB51EC6_OFFSET UNITYSDK_OFFSET(0x13E5C580)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x13E61320)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_F95FBE5CF2CC8D6E_1_OFFSET UNITYSDK_OFFSET(0x13E5F430)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_F95FBE5CF2CC8D6E_OFFSET UNITYSDK_OFFSET(0x13E5F0F0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x13E5B430)
#define MOLEMOLE_UIBUTTONPOSHANDLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x13E5B2B0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x13E5B5B0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_SETBUTTONTYPE_OFFSET UNITYSDK_OFFSET(0x13E5AEA0)
#define MOLEMOLE_UIBUTTONPOSHANDLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x13E5F870)
#define MOLEMOLE_UIBUTTONPOSHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x13E5F820)
#define MOLEMOLE_UIBUTTONPOSHANDLER___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x13E5F910)
#define MOLEMOLE_UIBUTTONPOSHANDLER___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x13E5F9A0)
#define MOLEMOLE_UIBUTTONPOSHANDLER___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x13E5FA30)

namespace MoleMole
{
	inline static constexpr unsigned int UIButtonPosHandler_TypeDefinitionIndex = 70125;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::MoleMole::UIButtonPosHandler*>**)Il2CppClass::FromTypeDefinitionIndex(UIButtonPosHandler_TypeDefinitionIndex)->GetStaticField(0x48970);
		}
		static ::System::Single* StaticGet_Field_6_7()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(UIButtonPosHandler_TypeDefinitionIndex)->GetStaticField(0x11790);
		}
		static ::UnityEngine::Vector2* StaticGet_Field_6_6()
		{
			return (::UnityEngine::Vector2*)Il2CppClass::FromTypeDefinitionIndex(UIButtonPosHandler_TypeDefinitionIndex)->GetStaticField(0x11794);
		}
