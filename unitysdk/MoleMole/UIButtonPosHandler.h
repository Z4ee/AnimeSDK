...
#define MOLEMOLE_UIBUTTONPOSHANDLER_APPLYLAYOUTRESULT_OFFSET UNITYSDK_OFFSET(0x19322BE0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1931F0E0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_CALCULATELAYOUT_OFFSET UNITYSDK_OFFSET(0x1931F640)
#define MOLEMOLE_UIBUTTONPOSHANDLER_GETLAYOUTRESULT_1_OFFSET UNITYSDK_OFFSET(0x19321580)
#define MOLEMOLE_UIBUTTONPOSHANDLER_GETLAYOUTRESULT_OFFSET UNITYSDK_OFFSET(0x19323010)
#define MOLEMOLE_UIBUTTONPOSHANDLER_GETPOSHANDLER_OFFSET UNITYSDK_OFFSET(0x1931EE40)
#define MOLEMOLE_UIBUTTONPOSHANDLER_GET_BUTTONTYPE_OFFSET UNITYSDK_OFFSET(0x1931ED80)
#define MOLEMOLE_UIBUTTONPOSHANDLER_GET_POSITIONTYPE_OFFSET UNITYSDK_OFFSET(0x1931EDA0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_GET_SCENETYPE_OFFSET UNITYSDK_OFFSET(0x1931ED90)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_09B8F368BEF6ADA5_OFFSET UNITYSDK_OFFSET(0x19324F60)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_1CCA9681CE0AE7A7_OFFSET UNITYSDK_OFFSET(0x193237A0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_1ED778BEE5C0B0B6_1_OFFSET UNITYSDK_OFFSET(0x19324C40)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_1ED778BEE5C0B0B6_OFFSET UNITYSDK_OFFSET(0x19324920)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_37D0382D0C30A2DC_OFFSET UNITYSDK_OFFSET(0x19324420)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_4B72F72501001F72_OFFSET UNITYSDK_OFFSET(0x19320CE0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_5304726C363652C1_OFFSET UNITYSDK_OFFSET(0x19321380)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_59E16470DACBC6BB_1_OFFSET UNITYSDK_OFFSET(0x19323130)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_59E16470DACBC6BB_OFFSET UNITYSDK_OFFSET(0x19323470)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_5D04307A86675370_OFFSET UNITYSDK_OFFSET(0x19323AE0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_5DEA19B34BC85FA0_OFFSET UNITYSDK_OFFSET(0x19320660)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_74166AE1162C06DF_1_OFFSET UNITYSDK_OFFSET(0x19321070)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_74166AE1162C06DF_OFFSET UNITYSDK_OFFSET(0x19320EF0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_882649FD9513E63E_OFFSET UNITYSDK_OFFSET(0x193211F0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_8A9A7CCD2DCA2CF8_1_OFFSET UNITYSDK_OFFSET(0x19324250)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_8A9A7CCD2DCA2CF8_OFFSET UNITYSDK_OFFSET(0x19325000)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_9625FB5C8624788A_OFFSET UNITYSDK_OFFSET(0x193244B0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_9E570C2DADF4691D_OFFSET UNITYSDK_OFFSET(0x193251E0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_A0FB610937DDCECC_OFFSET UNITYSDK_OFFSET(0x193241B0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_A8270C103EB5FD67_OFFSET UNITYSDK_OFFSET(0x193205E0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_A871253BFD471C99_OFFSET UNITYSDK_OFFSET(0x19320320)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_B6B10A3BCDE37B6E_OFFSET UNITYSDK_OFFSET(0x193206B0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x193241A0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x19325830)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_E1A38AE09BB51EC6_OFFSET UNITYSDK_OFFSET(0x19320580)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_EB1FBCCF65ECC7D3_OFFSET UNITYSDK_OFFSET(0x19323FD0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x193251D0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_F95FBE5CF2CC8D6E_1_OFFSET UNITYSDK_OFFSET(0x19323120)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_F95FBE5CF2CC8D6E_OFFSET UNITYSDK_OFFSET(0x19323460)
#define MOLEMOLE_UIBUTTONPOSHANDLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1931F360)
#define MOLEMOLE_UIBUTTONPOSHANDLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1931F1B0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1931F510)
#define MOLEMOLE_UIBUTTONPOSHANDLER_SETBUTTONTYPE_OFFSET UNITYSDK_OFFSET(0x1931EDB0)
#define MOLEMOLE_UIBUTTONPOSHANDLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x193238A0)
#define MOLEMOLE_UIBUTTONPOSHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19323850)
#define MOLEMOLE_UIBUTTONPOSHANDLER___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x19323930)
#define MOLEMOLE_UIBUTTONPOSHANDLER___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x193239C0)
#define MOLEMOLE_UIBUTTONPOSHANDLER___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19323A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIButtonPosHandler_TypeDefinitionIndex = 57590;

	class UIButtonPosHandler : public ::UnityEngine::EventSystems::UIBehaviour
	{
	public:
		static ::System::Collections::Generic::List_1<::MoleMole::UIButtonPosHandler*>** StaticGet_Field_6_15()
		{
			return (::System::Collections::Generic::List_1<::MoleMole::UIButtonPosHandler*>**)Il2CppClass::FromTypeDefinitionIndex(UIButtonPosHandler_TypeDefinitionIndex)->GetStaticField(0x4AC00);
		}
		static ::System::Single* StaticGet_Field_6_9()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(UIButtonPosHandler_TypeDefinitionIndex)->GetStaticField(0x113A0);
		}
		static ::UnityEngine::Vector2* StaticGet_Field_6_10()
		{
			return (::UnityEngine::Vector2*)Il2CppClass::FromTypeDefinitionIndex(UIButtonPosHandler_TypeDefinitionIndex)->GetStaticField(0x113A4);
		}
		...
		::UnityEngine::Canvas* Field_6_14; // 0x88
		::System::Boolean Field_6_13; // 0x90
		::System::Boolean Field_6_12; // 0x91
		::System::Boolean Field_6_19; // 0x92
		::System::Boolean Field_6_18; // 0x93
		::System::Boolean Field_6_17; // 0x94
		...
		::UnityEngine::Vector2 Method_6_5D04307A86675370()
		{
			return ((::UnityEngine::Vector2(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_5D04307A86675370_OFFSET))(this);
		}
		...
		::UnityEngine::Vector2 Method_6_59E16470DACBC6BB()
		{
			return ((::UnityEngine::Vector2(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_59E16470DACBC6BB_OFFSET))(this);
		}
		...
		::UnityEngine::Vector2 Method_6_59E16470DACBC6BB_1()
		{
			return ((::UnityEngine::Vector2(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_59E16470DACBC6BB_1_OFFSET))(this);
		}
		...
		::MoleMole::UserLocalDataItem_OverrideMobileButtonPanel* Method_6_1ED778BEE5C0B0B6()
		{
			return ((::MoleMole::UserLocalDataItem_OverrideMobileButtonPanel*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_1ED778BEE5C0B0B6_OFFSET))(this);
		}

		::UnityEngine::Vector2 Method_6_9625FB5C8624788A()
		{
			return ((::UnityEngine::Vector2(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_9625FB5C8624788A_OFFSET))(this);
		}

		::System::Int32 Method_6_A0FB610937DDCECC()
		{
			return ((::System::Int32(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_A0FB610937DDCECC_OFFSET))(this);
		}
		...
		{
			return ((::MoleMole::ConfigUICommon_Input_ConfigMobilePanelLayout*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_EB1FBCCF65ECC7D3_OFFSET))(this);
		}
		...
		::MoleMole::UserLocalDataItem_OverrideMobileButtonPanel* Method_6_1ED778BEE5C0B0B6_1()
		{
			return ((::MoleMole::UserLocalDataItem_OverrideMobileButtonPanel*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_1ED778BEE5C0B0B6_1_OFFSET))(this);
		}
	};
}
