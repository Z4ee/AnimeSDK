...
#define MOLEMOLE_CHESSBOARDTEXTURETAGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x116DEC30)

namespace MoleMole
{
	inline static constexpr unsigned int ChessboardTextureTagConfig_TypeDefinitionIndex = 66893;
