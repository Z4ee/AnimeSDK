...
#define MOLEMOLE_CHESSBOARDTEXTURETAGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x10CE4000)

namespace MoleMole
{
	inline static constexpr unsigned int ChessboardTextureTagConfig_TypeDefinitionIndex = 85007;
