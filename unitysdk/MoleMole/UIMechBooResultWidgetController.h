...
#define MOLEMOLE_UIMECHBOORESULTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1986D4C0)
#define MOLEMOLE_UIMECHBOORESULTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1986D550)
#define MOLEMOLE_UIMECHBOORESULTWIDGETCONTROLLER_SETCONTEXT_OFFSET UNITYSDK_OFFSET(0x1986D5D0)
#define MOLEMOLE_UIMECHBOORESULTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1986D650)
#define MOLEMOLE_UIMECHBOORESULTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1986D6B0)
#define MOLEMOLE_UIMECHBOORESULTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1986D740)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechBooResultWidgetController_TypeDefinitionIndex = 41579;
