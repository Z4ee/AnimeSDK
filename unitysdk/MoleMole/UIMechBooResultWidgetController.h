...
#define MOLEMOLE_UIMECHBOORESULTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x150FBA80)
#define MOLEMOLE_UIMECHBOORESULTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x150FBB10)
#define MOLEMOLE_UIMECHBOORESULTWIDGETCONTROLLER_SETCONTEXT_OFFSET UNITYSDK_OFFSET(0x150FBB90)
#define MOLEMOLE_UIMECHBOORESULTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x150FBC10)
#define MOLEMOLE_UIMECHBOORESULTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x150FBC70)
#define MOLEMOLE_UIMECHBOORESULTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x150FBD00)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechBooResultWidgetController_TypeDefinitionIndex = 75985;

	class UIMechBooResultWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_0096754AC2F6E253_23* _view; // 0x2B8
