...
#define MOLEMOLE_UIABYSSS2INLEVELMAPAREAWIDGETCONTROLLER__PLAYREFRESHMAPANIM_D__7_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x79EFD0)
#define MOLEMOLE_UIABYSSS2INLEVELMAPAREAWIDGETCONTROLLER__PLAYREFRESHMAPANIM_D__7_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2661E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2InlevelMapAreaWidgetController__PlayRefreshMapAnim_d__7_TypeDefinitionIndex = 45759;
