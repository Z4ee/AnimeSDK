...
#define MOLEMOLE_UIABRESULTITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x183AD870)
#define MOLEMOLE_UIABRESULTITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x183AD980)
#define MOLEMOLE_UIABRESULTITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x183AD900)
#define MOLEMOLE_UIABRESULTITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x183AD810)
#define MOLEMOLE_UIABRESULTITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x183ADAA0)
#define MOLEMOLE_UIABRESULTITEMWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x183ADBC0)
#define MOLEMOLE_UIABRESULTITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x183ADC50)
#define MOLEMOLE_UIABRESULTITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x183ADC60)
#define MOLEMOLE_UIABRESULTITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x183ADCF0)
#define MOLEMOLE_UIABRESULTITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x183ADD90)
#define MOLEMOLE_UIABRESULTITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x183ADE20)

namespace MoleMole
{
	inline static constexpr unsigned int UIABResultItemWidgetController_TypeDefinitionIndex = 74746;

	class UIABResultItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_8469E7523673A92C_15* _view; // 0x2F0
