...
#define MOLEMOLE_UIURBANMAPLEFTLOCATIONCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16DF00C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapLeftLocationContext_TypeDefinitionIndex = 71821;
	...
	public:
		...
		::System::Action_3<::System::Boolean, ::System::Boolean, ::System::Action_2<::System::Boolean, ::System::Boolean>*>* OnSetExpand; // 0x40
		::System::Int32 InitIndex; // 0x48
		::System::Single OtherHeight; // 0x4C
		::System::Boolean DefaultExpand; // 0x50
		::System::Boolean EnableExpand; // 0x51
		::System::Boolean Mode2d; // 0x52
