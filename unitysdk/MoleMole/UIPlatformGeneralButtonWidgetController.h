...
#define MOLEMOLE_UIPLATFORMGENERALBUTTONWIDGETCONTROLLER_GET_GENERALBUTTONCONTROLLER_OFFSET UNITYSDK_OFFSET(0x1531B310)
#define MOLEMOLE_UIPLATFORMGENERALBUTTONWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1531B380)
#define MOLEMOLE_UIPLATFORMGENERALBUTTONWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1531B3F0)
#define MOLEMOLE_UIPLATFORMGENERALBUTTONWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1531B490)
#define MOLEMOLE_UIPLATFORMGENERALBUTTONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1531B6C0)
#define MOLEMOLE_UIPLATFORMGENERALBUTTONWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1531B720)
#define MOLEMOLE_UIPLATFORMGENERALBUTTONWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1531B7C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPlatformGeneralButtonWidgetController_TypeDefinitionIndex = 72432;
