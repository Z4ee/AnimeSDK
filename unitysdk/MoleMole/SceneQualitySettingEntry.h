...
#define MOLEMOLE_SCENEQUALITYSETTINGENTRY_GET_PROFILETYPE_OFFSET UNITYSDK_OFFSET(0x17DE1770)
#define MOLEMOLE_SCENEQUALITYSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x17DE1760)
#define MOLEMOLE_SCENEQUALITYSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x17DE1780)

namespace MoleMole
{
	inline static constexpr unsigned int SceneQualitySettingEntry_TypeDefinitionIndex = 47236;
