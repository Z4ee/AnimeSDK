...
#define MOLEMOLE_UIBOSSBATTLEDATATABROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1564C370)
#define MOLEMOLE_UIBOSSBATTLEDATATABROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1564C3E0)
#define MOLEMOLE_UIBOSSBATTLEDATATABROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x1564C740)
#define MOLEMOLE_UIBOSSBATTLEDATATABROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1564C480)
#define MOLEMOLE_UIBOSSBATTLEDATATABROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1564C540)
#define MOLEMOLE_UIBOSSBATTLEDATATABROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1564C830)
#define MOLEMOLE_UIBOSSBATTLEDATATABROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1564C840)
#define MOLEMOLE_UIBOSSBATTLEDATATABROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x1564C8E0)
#define MOLEMOLE_UIBOSSBATTLEDATATABROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1564C970)

namespace MoleMole
{
	inline static constexpr unsigned int UIBossBattleDataTabRowWidgetController_TypeDefinitionIndex = 79823;
