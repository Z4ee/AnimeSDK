...
#define MOLEMOLE_UIROLETEAMROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x160D9C00)
#define MOLEMOLE_UIROLETEAMROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x160D9D10)
#define MOLEMOLE_UIROLETEAMROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x160D9C90)
#define MOLEMOLE_UIROLETEAMROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x160D9BA0)
#define MOLEMOLE_UIROLETEAMROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x160D9DF0)
#define MOLEMOLE_UIROLETEAMROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x160D9E00)
#define MOLEMOLE_UIROLETEAMROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x160D9E90)
#define MOLEMOLE_UIROLETEAMROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x160D9F30)
#define MOLEMOLE_UIROLETEAMROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x160D9FC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleTeamRowWidgetController_TypeDefinitionIndex = 59476;

	class UIRoleTeamRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_0096754AC2F6E253_7* _view; // 0x2F0
