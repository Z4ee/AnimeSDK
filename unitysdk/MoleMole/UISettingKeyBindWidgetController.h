...
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x138163A0)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER_ONBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x13816950)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x13816610)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER_ONKEYBINDINGDIALOGCLOSE_OFFSET UNITYSDK_OFFSET(0x13816B00)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER_ONSETTINGONUIDISABLESTATECHANGED_OFFSET UNITYSDK_OFFSET(0x13816B70)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x138166A0)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x138160C0)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x138161B0)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER_REFRESHSETTINGONUIDISABLESTATE_OFFSET UNITYSDK_OFFSET(0x13816790)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x13816720)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x13816C30)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER__ONUIOPEN_B__2_0_OFFSET UNITYSDK_OFFSET(0x13816C90)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER__ONUIOPEN_B__2_1_OFFSET UNITYSDK_OFFSET(0x13816D00)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER__ONUIOPEN_B__2_2_OFFSET UNITYSDK_OFFSET(0x13816D70)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER__ONUIOPEN_B__2_3_OFFSET UNITYSDK_OFFSET(0x13816E10)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x13816FF0)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x13817080)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x13817110)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x138171A0)

namespace MoleMole
{
	inline static constexpr unsigned int UISettingKeyBindWidgetController_TypeDefinitionIndex = 67956;
