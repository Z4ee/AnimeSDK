...
#define MOLEMOLE_CONFIGLEVELCONDITIONDYNAMICWRAPPER_CREATE_OFFSET UNITYSDK_OFFSET(0x77F1D0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigLevelConditionDynamicWrapper_TypeDefinitionIndex = 68761;
	...
	struct alignas(8) ConfigLevelConditionDynamicWrapper
	{
		...
		::Class_1_688FBF6C0FC439E7_Class_0_16E7307DCC43CB2C_9* Create(::Class_1_663AFC2250EC21C9* argMap)
		{
			return ((::Class_1_688FBF6C0FC439E7_Class_0_16E7307DCC43CB2C_9*(*)(::PVOID, ::Class_1_663AFC2250EC21C9*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIGLEVELCONDITIONDYNAMICWRAPPER_CREATE_OFFSET))(this, argMap);
		}
	};
}
