...
#define MOLEMOLE_CHESSENTITY_CREATEHOLLOWENTITY_OFFSET UNITYSDK_OFFSET(0x1A051D20)
#define MOLEMOLE_CHESSENTITY_GETCUSTOMDATAFLOAT_OFFSET UNITYSDK_OFFSET(0x1A0520C0)
#define MOLEMOLE_CHESSENTITY_GETCUSTOMDATASTRING_OFFSET UNITYSDK_OFFSET(0x1A052270)
#define MOLEMOLE_CHESSENTITY_GET_BINDENTITY_OFFSET UNITYSDK_OFFSET(0x1A052360)
#define MOLEMOLE_CHESSENTITY_GET_CHESSBOARD_OFFSET UNITYSDK_OFFSET(0x1A050F40)
#define MOLEMOLE_CHESSENTITY_GET_HOLLOWENTITY_OFFSET UNITYSDK_OFFSET(0x1A050930)
#define MOLEMOLE_CHESSENTITY_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A050B20)
#define MOLEMOLE_CHESSENTITY_GET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1A050880)
#define MOLEMOLE_CHESSENTITY_GET_VECTOR2POSITION_OFFSET UNITYSDK_OFFSET(0x1A050E90)
#define MOLEMOLE_CHESSENTITY_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x1A051E90)
#define MOLEMOLE_CHESSENTITY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A051B90)
#define MOLEMOLE_CHESSENTITY_MOVE_1_OFFSET UNITYSDK_OFFSET(0x1A051350)
#define MOLEMOLE_CHESSENTITY_MOVE_OFFSET UNITYSDK_OFFSET(0x1A050F60)
#define MOLEMOLE_CHESSENTITY_ONADDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A051F30)
#define MOLEMOLE_CHESSENTITY_ONADD_OFFSET UNITYSDK_OFFSET(0x1A051D90)
#define MOLEMOLE_CHESSENTITY_ONINITINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A051EE0)
#define MOLEMOLE_CHESSENTITY_ONINIT_OFFSET UNITYSDK_OFFSET(0x1A051C10)
#define MOLEMOLE_CHESSENTITY_ONMOVE_OFFSET UNITYSDK_OFFSET(0x1A0515E0)
#define MOLEMOLE_CHESSENTITY_ONREMOVEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A051F70)
#define MOLEMOLE_CHESSENTITY_ONREMOVE_OFFSET UNITYSDK_OFFSET(0x1A051E10)
#define MOLEMOLE_CHESSENTITY_ONUPDATEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A051FB0)
#define MOLEMOLE_CHESSENTITY_PLAYMOVEANIM_OFFSET UNITYSDK_OFFSET(0x1A051620)
#define MOLEMOLE_CHESSENTITY_POSTLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A051BD0)
#define MOLEMOLE_CHESSENTITY_PRELATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A051B50)
#define MOLEMOLE_CHESSENTITY_SETCUSTOMDATA_1_OFFSET UNITYSDK_OFFSET(0x1A0521B0)
#define MOLEMOLE_CHESSENTITY_SETCUSTOMDATA_OFFSET UNITYSDK_OFFSET(0x1A051FF0)
#define MOLEMOLE_CHESSENTITY_SET_BINDENTITY_OFFSET UNITYSDK_OFFSET(0x1A052370)
#define MOLEMOLE_CHESSENTITY_SET_CHESSBOARD_OFFSET UNITYSDK_OFFSET(0x1A050F50)
#define MOLEMOLE_CHESSENTITY_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A050D00)
#define MOLEMOLE_CHESSENTITY_SET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1A050A80)
#define MOLEMOLE_CHESSENTITY_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A051B00)
#define MOLEMOLE_CHESSENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A050780)

namespace MoleMole
{
	inline static constexpr unsigned int ChessEntity_TypeDefinitionIndex = 39798;

	class ChessEntity : public ::System::Object
	{
	public:
		::Class_5_FCAF801AC482D3B5* _Chessboard_k__BackingField; // 0x10
		...
		::MoleMole::ConfigChessEntity* config; // 0x28
		::System::UInt32 _BindEntity_k__BackingField; // 0x30
		::System::Int32 _runtimeID; // 0x34
		::System::Boolean removed; // 0x38
		::System::Boolean isToBeRemoved; // 0x39
		::System::Boolean isRemoved; // 0x3A
		...
		::Class_5_FCAF801AC482D3B5* get_Chessboard()
		{
			return ((::Class_5_FCAF801AC482D3B5*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_CHESSENTITY_GET_CHESSBOARD_OFFSET))(this);
		}

		::System::Void set_Chessboard(::Class_5_FCAF801AC482D3B5* value)
		{
			return ((::System::Void(*)(::PVOID, ::Class_5_FCAF801AC482D3B5*))((::PBYTE)hIl2Cpp + MOLEMOLE_CHESSENTITY_SET_CHESSBOARD_OFFSET))(this, value);
		}
		...
		::System::Void OnInit(::MoleMole::ConfigChessEntity* configChessEntity, ::MoleMole::HollowChessboard::HollowCell chessIndex, ::Class_5_FCAF801AC482D3B5* currentChessboard)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::ConfigChessEntity*, ::MoleMole::HollowChessboard::HollowCell, ::Class_5_FCAF801AC482D3B5*))((::PBYTE)hIl2Cpp + MOLEMOLE_CHESSENTITY_ONINIT_OFFSET))(this, configChessEntity, chessIndex, currentChessboard);
		}
