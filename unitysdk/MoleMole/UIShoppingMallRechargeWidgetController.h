...
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_GET_GOODS_OFFSET UNITYSDK_OFFSET(0x179C4250)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_GET_SHOPPINGMALLRECHARGEWIDGET_MODULE_OFFSET UNITYSDK_OFFSET(0x179C41F0)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x179C42E0)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_ONCLICKGOODS_OFFSET UNITYSDK_OFFSET(0x179C4B70)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x179C47A0)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_ONCUSTOMERBTN_OFFSET UNITYSDK_OFFSET(0x179C4A80)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x179C4830)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x179C4A00)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x179C4270)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x179C4730)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_REFRESHUI_OFFSET UNITYSDK_OFFSET(0x179C4920)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_REGISTERONCLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x179C4BD0)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_SET_GOODS_OFFSET UNITYSDK_OFFSET(0x179C4260)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x179C4C20)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER__INITVIEW_B__14_0_OFFSET UNITYSDK_OFFSET(0x179C4D00)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x179C4DB0)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x179C4E40)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x179C4EE0)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x179C4F70)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x179C5000)

namespace MoleMole
{
	inline static constexpr unsigned int UIShoppingMallRechargeWidgetController_TypeDefinitionIndex = 86428;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_179*>* _Goods_k__BackingField; // 0x2D8
		...
		{
			return ((::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_179*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_GET_GOODS_OFFSET))(this);
		}

		::System::Void set_Goods(::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_179*>* value)
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_179*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_SET_GOODS_OFFSET))(this, value);
		}
