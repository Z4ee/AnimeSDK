...
#define MOLEMOLE_TLSTARTENDENTITYANIMATORPARAMCONTROL_ISBLENDINVALID_OFFSET UNITYSDK_OFFSET(0x152AC060)
#define MOLEMOLE_TLSTARTENDENTITYANIMATORPARAMCONTROL_ISBLENDOUTVALID_OFFSET UNITYSDK_OFFSET(0x152AC0C0)
#define MOLEMOLE_TLSTARTENDENTITYANIMATORPARAMCONTROL_ISENABLEANIMBLENDTARGETV2_OFFSET UNITYSDK_OFFSET(0x152AC120)
#define MOLEMOLE_TLSTARTENDENTITYANIMATORPARAMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x152AC210)

namespace MoleMole
{
	inline static constexpr unsigned int TLStartEndEntityAnimatorParamControl_TypeDefinitionIndex = 73588;
