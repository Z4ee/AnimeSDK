...
#define MOLEMOLE_UICOOPTEAM3DMODELCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18A7C2B0)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopTeam3DModelController_Context_TypeDefinitionIndex = 46179;
