...
#define MOLEMOLE_UICOOPTEAM3DMODELCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18AA9910)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopTeam3DModelController_Context_TypeDefinitionIndex = 90465;
