...
#define MOLEMOLE_UIMONSTERFANTASYBOSSROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x183429A0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18342A10)
#define MOLEMOLE_UIMONSTERFANTASYBOSSROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x18342AD0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18342C80)
#define MOLEMOLE_UIMONSTERFANTASYBOSSROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18342C90)
#define MOLEMOLE_UIMONSTERFANTASYBOSSROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x18342D30)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyBossRowWidgetController_TypeDefinitionIndex = 42251;
