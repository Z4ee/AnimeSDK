...
#define MOLEMOLE_PERFORMANCESETTINGPOSTPROCESSPROFILEBASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x11D5A880)
#define MOLEMOLE_PERFORMANCESETTINGPOSTPROCESSPROFILEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x11D5A800)

namespace MoleMole
{
	inline static constexpr unsigned int PerformanceSettingPostProcessProfileBase_TypeDefinitionIndex = 63450;
