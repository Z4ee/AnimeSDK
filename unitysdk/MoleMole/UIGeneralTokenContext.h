...
#define MOLEMOLE_UIGENERALTOKENCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18AE7380)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralTokenContext_TypeDefinitionIndex = 77128;
