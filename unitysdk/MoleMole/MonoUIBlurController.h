...
#define MOLEMOLE_MONOUIBLURCONTROLLER_HANDLEEVENTS_OFFSET UNITYSDK_OFFSET(0x12BD4C70)
#define MOLEMOLE_MONOUIBLURCONTROLLER_METHOD_5_39202E9846AE8B5F_OFFSET UNITYSDK_OFFSET(0x12BD4AC0)
#define MOLEMOLE_MONOUIBLURCONTROLLER_METHOD_5_5D296A533150C284_1_OFFSET UNITYSDK_OFFSET(0x12BD5330)
#define MOLEMOLE_MONOUIBLURCONTROLLER_METHOD_5_5D296A533150C284_OFFSET UNITYSDK_OFFSET(0x12BD52A0)
#define MOLEMOLE_MONOUIBLURCONTROLLER_METHOD_5_ADF4AD3331B4D7AD_OFFSET UNITYSDK_OFFSET(0x12BD5100)
#define MOLEMOLE_MONOUIBLURCONTROLLER_METHOD_5_BED35D89A6A10D7A_OFFSET UNITYSDK_OFFSET(0x12BD5150)
#define MOLEMOLE_MONOUIBLURCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x12BD4870)
#define MOLEMOLE_MONOUIBLURCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x12BD45F0)
#define MOLEMOLE_MONOUIBLURCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x12BD4400)
#define MOLEMOLE_MONOUIBLURCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12BD50B0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIBlurController_TypeDefinitionIndex = 48370;
