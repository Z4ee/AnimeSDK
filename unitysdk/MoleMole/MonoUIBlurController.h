...
#define MOLEMOLE_MONOUIBLURCONTROLLER_HANDLEEVENTS_OFFSET UNITYSDK_OFFSET(0x13853EC0)
#define MOLEMOLE_MONOUIBLURCONTROLLER_METHOD_5_39202E9846AE8B5F_OFFSET UNITYSDK_OFFSET(0x13853D10)
#define MOLEMOLE_MONOUIBLURCONTROLLER_METHOD_5_5D296A533150C284_1_OFFSET UNITYSDK_OFFSET(0x13854530)
#define MOLEMOLE_MONOUIBLURCONTROLLER_METHOD_5_5D296A533150C284_OFFSET UNITYSDK_OFFSET(0x138544A0)
#define MOLEMOLE_MONOUIBLURCONTROLLER_METHOD_5_ADF4AD3331B4D7AD_OFFSET UNITYSDK_OFFSET(0x138545C0)
#define MOLEMOLE_MONOUIBLURCONTROLLER_METHOD_5_BED35D89A6A10D7A_OFFSET UNITYSDK_OFFSET(0x13854350)
#define MOLEMOLE_MONOUIBLURCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x13853AC0)
#define MOLEMOLE_MONOUIBLURCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x13853840)
#define MOLEMOLE_MONOUIBLURCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x13853650)
#define MOLEMOLE_MONOUIBLURCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x13854300)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIBlurController_TypeDefinitionIndex = 80816;
