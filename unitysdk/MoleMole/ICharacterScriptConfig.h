...
#define MOLEMOLE_ICHARACTERSCRIPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x13A94970)

namespace MoleMole
{
	inline static constexpr unsigned int ICharacterScriptConfig_TypeDefinitionIndex = 42485;
