...
#define MOLEMOLE_UTILS_NAPCAMERASEQUENCECONTEXT_GETCURRENTASPECTRATIO_OFFSET UNITYSDK_OFFSET(0x13B41160)
#define MOLEMOLE_UTILS_NAPCAMERASEQUENCECONTEXT_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0x13B40910)
#define MOLEMOLE_UTILS_NAPCAMERASEQUENCECONTEXT_GET_CAMERACOLLISIONCONFIGDATA_OFFSET UNITYSDK_OFFSET(0x13B41000)
#define MOLEMOLE_UTILS_NAPCAMERASEQUENCECONTEXT_GET_INSTIGATORID_OFFSET UNITYSDK_OFFSET(0x13B41110)
#define MOLEMOLE_UTILS_NAPCAMERASEQUENCECONTEXT_GET_LASTCAMERADATA_OFFSET UNITYSDK_OFFSET(0x13B40A90)
#define MOLEMOLE_UTILS_NAPCAMERASEQUENCECONTEXT_GET_NEARCLIPPLANE_OFFSET UNITYSDK_OFFSET(0x13B40EE0)
#define MOLEMOLE_UTILS_NAPCAMERASEQUENCECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x13B41290)

namespace MoleMole::Utils
{
	inline static constexpr unsigned int NapCameraSequenceContext_TypeDefinitionIndex = 41105;
