...
#define MOLEMOLE_UTILS_CLOSEUPDATATABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x126CE9E0)

namespace MoleMole::Utils
{
	inline static constexpr unsigned int CloseUpDataTable_TypeDefinitionIndex = 59517;
