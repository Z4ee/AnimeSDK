...
#define MOLEMOLE_UTILS_STRETCHDATATABLEENTRY_GET_FORWARDOFFSET_OFFSET UNITYSDK_OFFSET(0xFAF10F0)
#define MOLEMOLE_UTILS_STRETCHDATATABLEENTRY_GET_UPOFFSET_OFFSET UNITYSDK_OFFSET(0xFAF1160)
#define MOLEMOLE_UTILS_STRETCHDATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_BUILDCONTEXT_OFFSET UNITYSDK_OFFSET(0xFAF11D0)
#define MOLEMOLE_UTILS_STRETCHDATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_GETBLENDINSETTING_OFFSET UNITYSDK_OFFSET(0xFAF1250)
#define MOLEMOLE_UTILS_STRETCHDATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_GETBLENDOUTSETTING_OFFSET UNITYSDK_OFFSET(0xFAF1340)
#define MOLEMOLE_UTILS_STRETCHDATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_GETDURATION_OFFSET UNITYSDK_OFFSET(0xFAF1430)
#define MOLEMOLE_UTILS_STRETCHDATATABLEENTRY_SET_FORWARDOFFSET_OFFSET UNITYSDK_OFFSET(0xFAF1100)
#define MOLEMOLE_UTILS_STRETCHDATATABLEENTRY_SET_UPOFFSET_OFFSET UNITYSDK_OFFSET(0xFAF1170)
#define MOLEMOLE_UTILS_STRETCHDATATABLEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xFAF1480)

namespace MoleMole::Utils
{
	inline static constexpr unsigned int StretchDataTableEntry_TypeDefinitionIndex = 71184;
