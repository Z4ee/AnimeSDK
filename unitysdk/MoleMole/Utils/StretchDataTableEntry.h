...
#define MOLEMOLE_UTILS_STRETCHDATATABLEENTRY_GET_FORWARDOFFSET_OFFSET UNITYSDK_OFFSET(0x11C2F350)
#define MOLEMOLE_UTILS_STRETCHDATATABLEENTRY_GET_UPOFFSET_OFFSET UNITYSDK_OFFSET(0x11C2F3C0)
#define MOLEMOLE_UTILS_STRETCHDATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_BUILDCONTEXT_OFFSET UNITYSDK_OFFSET(0x11C2F430)
#define MOLEMOLE_UTILS_STRETCHDATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_GETBLENDINSETTING_OFFSET UNITYSDK_OFFSET(0x11C2F4B0)
#define MOLEMOLE_UTILS_STRETCHDATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_GETBLENDOUTSETTING_OFFSET UNITYSDK_OFFSET(0x11C2F5A0)
#define MOLEMOLE_UTILS_STRETCHDATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_GETDURATION_OFFSET UNITYSDK_OFFSET(0x11C2F690)
#define MOLEMOLE_UTILS_STRETCHDATATABLEENTRY_SET_FORWARDOFFSET_OFFSET UNITYSDK_OFFSET(0x11C2F360)
#define MOLEMOLE_UTILS_STRETCHDATATABLEENTRY_SET_UPOFFSET_OFFSET UNITYSDK_OFFSET(0x11C2F3D0)
#define MOLEMOLE_UTILS_STRETCHDATATABLEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x11C2F6E0)

namespace MoleMole::Utils
{
	inline static constexpr unsigned int StretchDataTableEntry_TypeDefinitionIndex = 58060;
