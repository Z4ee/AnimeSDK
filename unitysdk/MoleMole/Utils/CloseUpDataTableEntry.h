...
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_BUILDCONTEXT_OFFSET UNITYSDK_OFFSET(0x10D8EA00)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_GET_ELEVATIONRATIO_OFFSET UNITYSDK_OFFSET(0x10D8E860)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_GET_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x10D8E7D0)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_GET_HEIGHTRATIO_OFFSET UNITYSDK_OFFSET(0x10D8E7B0)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_GET_MAINTAINROTATIONCHANNEL_OFFSET UNITYSDK_OFFSET(0x10D8E810)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_GET_OVERRIDEEULER_OFFSET UNITYSDK_OFFSET(0x10D8E830)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_GET_POLARANGLE_OFFSET UNITYSDK_OFFSET(0x10D8E930)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_GET_SCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x10D8E7F0)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_GETBLENDINSETTING_OFFSET UNITYSDK_OFFSET(0x10D8EA80)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_GETBLENDOUTSETTING_OFFSET UNITYSDK_OFFSET(0x10D8EB70)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_GETDURATION_OFFSET UNITYSDK_OFFSET(0x10D8EC60)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_SET_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x10D8E7E0)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_SET_HEIGHTRATIO_OFFSET UNITYSDK_OFFSET(0x10D8E7C0)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_SET_MAINTAINROTATIONCHANNEL_OFFSET UNITYSDK_OFFSET(0x10D8E820)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_SET_OVERRIDEEULER_OFFSET UNITYSDK_OFFSET(0x10D8E850)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_SET_SCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x10D8E800)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x10D8ECB0)

namespace MoleMole::Utils
{
	inline static constexpr unsigned int CloseUpDataTableEntry_TypeDefinitionIndex = 38656;
