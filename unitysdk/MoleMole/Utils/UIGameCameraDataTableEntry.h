...
#define MOLEMOLE_UTILS_UIGAMECAMERADATATABLEENTRY_GET_SCREENOFFSET_OFFSET UNITYSDK_OFFSET(0xD07F650)
#define MOLEMOLE_UTILS_UIGAMECAMERADATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_BUILDCONTEXT_OFFSET UNITYSDK_OFFSET(0xD07F7E0)
#define MOLEMOLE_UTILS_UIGAMECAMERADATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_GETBLENDINSETTING_OFFSET UNITYSDK_OFFSET(0xD07F860)
#define MOLEMOLE_UTILS_UIGAMECAMERADATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_GETBLENDOUTSETTING_OFFSET UNITYSDK_OFFSET(0xD07F8B0)
#define MOLEMOLE_UTILS_UIGAMECAMERADATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_GETDURATION_OFFSET UNITYSDK_OFFSET(0xD07F900)
#define MOLEMOLE_UTILS_UIGAMECAMERADATATABLEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xD07F950)

namespace MoleMole::Utils
{
	inline static constexpr unsigned int UIGameCameraDataTableEntry_TypeDefinitionIndex = 79035;
