...
#define MOLEMOLE_UTILS_UIGAMECAMERADATATABLEENTRY_GET_SCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x11665CF0)
#define MOLEMOLE_UTILS_UIGAMECAMERADATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_BUILDCONTEXT_OFFSET UNITYSDK_OFFSET(0x11665E80)
#define MOLEMOLE_UTILS_UIGAMECAMERADATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_GETBLENDINSETTING_OFFSET UNITYSDK_OFFSET(0x11665F00)
#define MOLEMOLE_UTILS_UIGAMECAMERADATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_GETBLENDOUTSETTING_OFFSET UNITYSDK_OFFSET(0x11665F50)
#define MOLEMOLE_UTILS_UIGAMECAMERADATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_GETDURATION_OFFSET UNITYSDK_OFFSET(0x11665FA0)
#define MOLEMOLE_UTILS_UIGAMECAMERADATATABLEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x11665FF0)

namespace MoleMole::Utils
{
	inline static constexpr unsigned int UIGameCameraDataTableEntry_TypeDefinitionIndex = 60472;
