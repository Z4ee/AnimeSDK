...
#define MOLEMOLE_UTILS_INTERNALUNITASKCOMPLETIONSOURCE_MOLEMOLE_UTILS_ITYPEERASEDCOMPLETIONSOURCE_GETNEXTTASK_OFFSET UNITYSDK_OFFSET(0x19509D40)
#define MOLEMOLE_UTILS_INTERNALUNITASKCOMPLETIONSOURCE_MOLEMOLE_UTILS_ITYPEERASEDCOMPLETIONSOURCE_GETTASK_OFFSET UNITYSDK_OFFSET(0x19509C80)
#define MOLEMOLE_UTILS_INTERNALUNITASKCOMPLETIONSOURCE_MOLEMOLE_UTILS_ITYPEERASEDCOMPLETIONSOURCE_TRYSETCANCELED_OFFSET UNITYSDK_OFFSET(0x19509B40)
#define MOLEMOLE_UTILS_INTERNALUNITASKCOMPLETIONSOURCE_MOLEMOLE_UTILS_ITYPEERASEDCOMPLETIONSOURCE_TRYSETEXCEPTION_OFFSET UNITYSDK_OFFSET(0x19509BE0)
#define MOLEMOLE_UTILS_INTERNALUNITASKCOMPLETIONSOURCE_MOLEMOLE_UTILS_ITYPEERASEDCOMPLETIONSOURCE_TRYSETRESULT_OFFSET UNITYSDK_OFFSET(0x19509E00)
#define MOLEMOLE_UTILS_INTERNALUNITASKCOMPLETIONSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x19509E90)

namespace MoleMole::Utils
{
	inline static constexpr unsigned int InternalUniTaskCompletionSource_TypeDefinitionIndex = 60997;
