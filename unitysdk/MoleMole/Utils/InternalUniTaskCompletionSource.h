...
#define MOLEMOLE_UTILS_INTERNALUNITASKCOMPLETIONSOURCE_MOLEMOLE_UTILS_ITYPEERASEDCOMPLETIONSOURCE_GETNEXTTASK_OFFSET UNITYSDK_OFFSET(0x1149DAD0)
#define MOLEMOLE_UTILS_INTERNALUNITASKCOMPLETIONSOURCE_MOLEMOLE_UTILS_ITYPEERASEDCOMPLETIONSOURCE_GETTASK_OFFSET UNITYSDK_OFFSET(0x1149DA10)
#define MOLEMOLE_UTILS_INTERNALUNITASKCOMPLETIONSOURCE_MOLEMOLE_UTILS_ITYPEERASEDCOMPLETIONSOURCE_TRYSETCANCELED_OFFSET UNITYSDK_OFFSET(0x1149D8D0)
#define MOLEMOLE_UTILS_INTERNALUNITASKCOMPLETIONSOURCE_MOLEMOLE_UTILS_ITYPEERASEDCOMPLETIONSOURCE_TRYSETEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1149D970)
#define MOLEMOLE_UTILS_INTERNALUNITASKCOMPLETIONSOURCE_MOLEMOLE_UTILS_ITYPEERASEDCOMPLETIONSOURCE_TRYSETRESULT_OFFSET UNITYSDK_OFFSET(0x1149DB90)
#define MOLEMOLE_UTILS_INTERNALUNITASKCOMPLETIONSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1149DC20)

namespace MoleMole::Utils
{
	inline static constexpr unsigned int InternalUniTaskCompletionSource_TypeDefinitionIndex = 49176;
