...
#define MOLEMOLE_UTILS_TYPEERASEDCOMPLETIONSOURCEIMPL_GETNEXTTASK_OFFSET UNITYSDK_OFFSET(0x744940)
#define MOLEMOLE_UTILS_TYPEERASEDCOMPLETIONSOURCEIMPL_GETTASK_OFFSET UNITYSDK_OFFSET(0x744870)
#define MOLEMOLE_UTILS_TYPEERASEDCOMPLETIONSOURCEIMPL_ISTRIGGERED_OFFSET UNITYSDK_OFFSET(0x744800)
#define MOLEMOLE_UTILS_TYPEERASEDCOMPLETIONSOURCEIMPL_TRYSETCANCELED_OFFSET UNITYSDK_OFFSET(0x744850)
#define MOLEMOLE_UTILS_TYPEERASEDCOMPLETIONSOURCEIMPL_TRYSETEXCEPTION_OFFSET UNITYSDK_OFFSET(0x744860)
#define MOLEMOLE_UTILS_TYPEERASEDCOMPLETIONSOURCEIMPL_TRYSETRESULT_OFFSET UNITYSDK_OFFSET(0x7449C0)
#define MOLEMOLE_UTILS_TYPEERASEDCOMPLETIONSOURCEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x7447B0)

namespace MoleMole::Utils
{
	inline static constexpr unsigned int TypeErasedCompletionSourceImpl_TypeDefinitionIndex = 50728;
