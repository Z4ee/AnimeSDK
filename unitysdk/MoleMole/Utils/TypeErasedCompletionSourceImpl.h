...
#define MOLEMOLE_UTILS_TYPEERASEDCOMPLETIONSOURCEIMPL_GETNEXTTASK_OFFSET UNITYSDK_OFFSET(0x7F2180)
#define MOLEMOLE_UTILS_TYPEERASEDCOMPLETIONSOURCEIMPL_GETTASK_OFFSET UNITYSDK_OFFSET(0x7F20B0)
#define MOLEMOLE_UTILS_TYPEERASEDCOMPLETIONSOURCEIMPL_ISTRIGGERED_OFFSET UNITYSDK_OFFSET(0x7F2040)
#define MOLEMOLE_UTILS_TYPEERASEDCOMPLETIONSOURCEIMPL_TRYSETCANCELED_OFFSET UNITYSDK_OFFSET(0x7F2090)
#define MOLEMOLE_UTILS_TYPEERASEDCOMPLETIONSOURCEIMPL_TRYSETEXCEPTION_OFFSET UNITYSDK_OFFSET(0x7F20A0)
#define MOLEMOLE_UTILS_TYPEERASEDCOMPLETIONSOURCEIMPL_TRYSETRESULT_OFFSET UNITYSDK_OFFSET(0x7F2200)
#define MOLEMOLE_UTILS_TYPEERASEDCOMPLETIONSOURCEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x7F1FF0)

namespace MoleMole::Utils
{
	inline static constexpr unsigned int TypeErasedCompletionSourceImpl_TypeDefinitionIndex = 44956;
