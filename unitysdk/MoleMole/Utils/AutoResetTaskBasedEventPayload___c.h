...
#define MOLEMOLE_UTILS_AUTORESETTASKBASEDEVENTPAYLOAD___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x12B24A30)
#define MOLEMOLE_UTILS_AUTORESETTASKBASEDEVENTPAYLOAD___C__CTOR_OFFSET UNITYSDK_OFFSET(0x12B24A70)
#define MOLEMOLE_UTILS_AUTORESETTASKBASEDEVENTPAYLOAD___C___CCTOR_B__1_0_OFFSET UNITYSDK_OFFSET(0x12B24A80)
#define MOLEMOLE_UTILS_AUTORESETTASKBASEDEVENTPAYLOAD___C___CCTOR_B__1_1_OFFSET UNITYSDK_OFFSET(0x12B24B50)

namespace MoleMole::Utils
{
	inline static constexpr unsigned int AutoResetTaskBasedEventPayload___c_TypeDefinitionIndex = 72056;
	...
	public:
		...
		{
			return (::MoleMole::Utils::AutoResetTaskBasedEventPayload___c**)Il2CppClass::FromTypeDefinitionIndex(AutoResetTaskBasedEventPayload___c_TypeDefinitionIndex)->GetStaticField(0x47430);
		}
		static ::System::Func_1<::MoleMole::Utils::ITypeErasedCompletionSource*>** StaticGet___9__1_1()
		{
			return (::System::Func_1<::MoleMole::Utils::ITypeErasedCompletionSource*>**)Il2CppClass::FromTypeDefinitionIndex(AutoResetTaskBasedEventPayload___c_TypeDefinitionIndex)->GetStaticField(0x47438);
		}
