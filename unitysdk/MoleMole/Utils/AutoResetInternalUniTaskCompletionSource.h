...
#define MOLEMOLE_UTILS_AUTORESETINTERNALUNITASKCOMPLETIONSOURCE_MOLEMOLE_UTILS_ITYPEERASEDCOMPLETIONSOURCE_GETNEXTTASK_OFFSET UNITYSDK_OFFSET(0x10AF9DA0)
#define MOLEMOLE_UTILS_AUTORESETINTERNALUNITASKCOMPLETIONSOURCE_MOLEMOLE_UTILS_ITYPEERASEDCOMPLETIONSOURCE_GETTASK_OFFSET UNITYSDK_OFFSET(0x10AF9CE0)
#define MOLEMOLE_UTILS_AUTORESETINTERNALUNITASKCOMPLETIONSOURCE_MOLEMOLE_UTILS_ITYPEERASEDCOMPLETIONSOURCE_TRYSETCANCELED_OFFSET UNITYSDK_OFFSET(0x10AF9C20)
#define MOLEMOLE_UTILS_AUTORESETINTERNALUNITASKCOMPLETIONSOURCE_MOLEMOLE_UTILS_ITYPEERASEDCOMPLETIONSOURCE_TRYSETEXCEPTION_OFFSET UNITYSDK_OFFSET(0x10AF9C80)
#define MOLEMOLE_UTILS_AUTORESETINTERNALUNITASKCOMPLETIONSOURCE_MOLEMOLE_UTILS_ITYPEERASEDCOMPLETIONSOURCE_TRYSETRESULT_OFFSET UNITYSDK_OFFSET(0x10AF9E60)
#define MOLEMOLE_UTILS_AUTORESETINTERNALUNITASKCOMPLETIONSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x10AF9EB0)

namespace MoleMole::Utils
{
	inline static constexpr unsigned int AutoResetInternalUniTaskCompletionSource_TypeDefinitionIndex = 42686;
