...
#define MOLEMOLE_UTILS_SOFTSCRIPTOBJECTREFERENCE_GETOBJECTPATH_OFFSET UNITYSDK_OFFSET(0x1277E280)
#define MOLEMOLE_UTILS_SOFTSCRIPTOBJECTREFERENCE_LOADASYNC_OFFSET UNITYSDK_OFFSET(0x1277E360)
#define MOLEMOLE_UTILS_SOFTSCRIPTOBJECTREFERENCE_LOADSYNC_OFFSET UNITYSDK_OFFSET(0x1277E2C0)
#define MOLEMOLE_UTILS_SOFTSCRIPTOBJECTREFERENCE_SETOBJECTPATH_OFFSET UNITYSDK_OFFSET(0x1277E230)
#define MOLEMOLE_UTILS_SOFTSCRIPTOBJECTREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1277E450)

namespace MoleMole::Utils
{
	inline static constexpr unsigned int SoftScriptObjectReference_TypeDefinitionIndex = 52627;
