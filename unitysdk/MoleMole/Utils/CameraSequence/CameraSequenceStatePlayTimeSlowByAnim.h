...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOWBYANIM_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x11C2F1E0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOWBYANIM_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x11C2F230)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOWBYANIM_GETNOTIFYNAME_OFFSET UNITYSDK_OFFSET(0x11C2F130)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOWBYANIM_GETTIMESLOWKEY_OFFSET UNITYSDK_OFFSET(0x11C2ED00)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOWBYANIM_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x11C2F1A0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOWBYANIM_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x11C2F220)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOWBYANIM_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x11C2ED70)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOWBYANIM_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0x11C2EF30)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOWBYANIM_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x11C2EED0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOWBYANIM__CCTOR_OFFSET UNITYSDK_OFFSET(0x11C2F2F0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOWBYANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x11C2F2A0)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceStatePlayTimeSlowByAnim_TypeDefinitionIndex = 41368;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStatePlayTimeSlowByAnim_TypeDefinitionIndex)->GetStaticField(0xE5A0);
		}
