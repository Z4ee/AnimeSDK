...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0xEBD6FE0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0xEBD7050)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_FETCH_ENABLELOOKAT_OFFSET UNITYSDK_OFFSET(0xEBD71B0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_FETCH_ENTITYID_OFFSET UNITYSDK_OFFSET(0xEBD7260)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_FETCH_ENTITYWORLD_OFFSET UNITYSDK_OFFSET(0xEBD73C0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_FETCH_LOOKATENTITYID_OFFSET UNITYSDK_OFFSET(0xEBD7310)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0xEBD6770)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0xEBD67B0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0xEBD67C0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0xEBD6C90)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0xEBD6C30)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK__CCTOR_OFFSET UNITYSDK_OFFSET(0xEBD74C0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK__CTOR_OFFSET UNITYSDK_OFFSET(0xEBD7470)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceStateEvent_EnableLookAtIK_TypeDefinitionIndex = 49332;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_EnableLookAtIK_TypeDefinitionIndex)->GetStaticField(0xE740);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_enableLookAt()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_EnableLookAtIK_TypeDefinitionIndex)->GetStaticField(0xE748);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_EntityWorld()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_EnableLookAtIK_TypeDefinitionIndex)->GetStaticField(0xE750);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_entityID()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_EnableLookAtIK_TypeDefinitionIndex)->GetStaticField(0xE758);
		}
