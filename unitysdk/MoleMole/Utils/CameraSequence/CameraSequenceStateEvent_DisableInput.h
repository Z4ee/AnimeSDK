...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEINPUT_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x112E5390)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEINPUT_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x112E53E0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEINPUT_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x112E5350)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEINPUT_GET_INPUTGROUP_OFFSET UNITYSDK_OFFSET(0x112E52B0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEINPUT_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x112E53D0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEINPUT_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x112E5540)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEINPUT_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0x112E5890)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEINPUT_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x112E5830)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEINPUT_SET_INPUTGROUP_OFFSET UNITYSDK_OFFSET(0x112E5300)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x112E5B70)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceStateEvent_DisableInput_TypeDefinitionIndex = 79708;
