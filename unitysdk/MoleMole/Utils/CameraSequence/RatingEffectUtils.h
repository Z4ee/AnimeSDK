...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_APPLYRATINGFOGEFFECTS_OFFSET UNITYSDK_OFFSET(0x11A29390)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_APPLYRATINGFOGEFFECT_OFFSET UNITYSDK_OFFSET(0x11A296D0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_APPLYRATINGSCREENEFFECTS_OFFSET UNITYSDK_OFFSET(0x11A28880)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_APPLYRATINGSCREENEFFECT_OFFSET UNITYSDK_OFFSET(0x11A28BF0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_GETCAMERAEFFECTENTITY_OFFSET UNITYSDK_OFFSET(0x11A2A3E0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_GETRATINGFOGEFFECTS_OFFSET UNITYSDK_OFFSET(0x11A29840)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_GETRATINGSCREENEFFECTS_OFFSET UNITYSDK_OFFSET(0x11A286A0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_GETRATINGTEXTEFFECTMETA_OFFSET UNITYSDK_OFFSET(0x11A29BE0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_GETRATINGTEXTEFFECTNAME_OFFSET UNITYSDK_OFFSET(0x11A29A20)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_GETRATINGTYPE_OFFSET UNITYSDK_OFFSET(0x11A260E0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_INTERRUPTFOGEFFECTS_OFFSET UNITYSDK_OFFSET(0x11A28F70)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_LOGERR_OFFSET UNITYSDK_OFFSET(0x11A2A9E0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_LOGWARN_OFFSET UNITYSDK_OFFSET(0x11A2AA20)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_LOG_OFFSET UNITYSDK_OFFSET(0x11A2A9A0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_TRYCREATERATINGEFFECT_OFFSET UNITYSDK_OFFSET(0x11A2A550)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_UPDATEEFFECTONCE_OFFSET UNITYSDK_OFFSET(0x11A2A490)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int RatingEffectUtils_TypeDefinitionIndex = 68698;
