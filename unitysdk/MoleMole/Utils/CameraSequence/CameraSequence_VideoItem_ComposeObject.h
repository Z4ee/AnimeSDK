...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_VIDEOITEM_COMPOSEOBJECT__AUTOSET_OFFSET UNITYSDK_OFFSET(0x12EAE7E0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_VIDEOITEM_COMPOSEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x12EAE8E0)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequence_VideoItem_ComposeObject_TypeDefinitionIndex = 52845;
