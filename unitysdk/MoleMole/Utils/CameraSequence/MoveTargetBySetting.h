...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_MOVETARGETBYSETTING_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x116BD780)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_MOVETARGETBYSETTING_FETCH_LOCATIONINCAMERASEQUENCE_OFFSET UNITYSDK_OFFSET(0x116BD920)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_MOVETARGETBYSETTING_GETDATA_OFFSET UNITYSDK_OFFSET(0x116BD570)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_MOVETARGETBYSETTING_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x116BD6D0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_MOVETARGETBYSETTING_SETPATH_OFFSET UNITYSDK_OFFSET(0x116BD6E0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_MOVETARGETBYSETTING__CCTOR_OFFSET UNITYSDK_OFFSET(0x116BDA40)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_MOVETARGETBYSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x116BDA20)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_MOVETARGETBYSETTING___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x116BDAA0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_MOVETARGETBYSETTING___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x116BDB90)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int MoveTargetBySetting_TypeDefinitionIndex = 79922;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(MoveTargetBySetting_TypeDefinitionIndex)->GetStaticField(0x123B0);
		}
