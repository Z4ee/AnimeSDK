...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0xFAF0770)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0xFAF07E0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW_FETCH_TIMESLOWKEY_OFFSET UNITYSDK_OFFSET(0xFAF0940)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0xFAF0720)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0xFAF0760)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0xFAF04C0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0xFAF0620)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0xFAF05C0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW__CCTOR_OFFSET UNITYSDK_OFFSET(0xFAF0A40)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW__CTOR_OFFSET UNITYSDK_OFFSET(0xFAF09F0)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceStatePlayTimeSlow_TypeDefinitionIndex = 58987;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStatePlayTimeSlow_TypeDefinitionIndex)->GetStaticField(0xE600);
		}
