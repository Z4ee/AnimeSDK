...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_CREATECUSTOMEFFECBYTIMELINE_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x1089FEE0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_CREATECUSTOMEFFECBYTIMELINE_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1089FF60)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_CREATECUSTOMEFFECBYTIMELINE_CREATECUSTOMEFFECT_OFFSET UNITYSDK_OFFSET(0x1089FB40)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_CREATECUSTOMEFFECBYTIMELINE_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x1089FB00)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_CREATECUSTOMEFFECBYTIMELINE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1089FF50)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_CREATECUSTOMEFFECBYTIMELINE_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x108A00C0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_CREATECUSTOMEFFECBYTIMELINE_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0x108A03C0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_CREATECUSTOMEFFECBYTIMELINE_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x108A0130)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_CREATECUSTOMEFFECBYTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x108A0410)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceStateEvent_CreateCustomEffecByTimeLine_TypeDefinitionIndex = 60833;
