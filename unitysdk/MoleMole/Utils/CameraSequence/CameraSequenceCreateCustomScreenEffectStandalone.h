...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCECREATECUSTOMSCREENEFFECTSTANDALONE_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x112E4680)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCECREATECUSTOMSCREENEFFECTSTANDALONE_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x112E46C0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCECREATECUSTOMSCREENEFFECTSTANDALONE__CTOR_OFFSET UNITYSDK_OFFSET(0x112E4810)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCECREATECUSTOMSCREENEFFECTSTANDALONE___BASE_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x112E4860)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceCreateCustomScreenEffectStandalone_TypeDefinitionIndex = 47235;
