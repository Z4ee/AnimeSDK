...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCECREATECUSTOMSCREENEFFECTSTANDALONE_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0xEBD5240)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCECREATECUSTOMSCREENEFFECTSTANDALONE_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0xEBD5280)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCECREATECUSTOMSCREENEFFECTSTANDALONE__CTOR_OFFSET UNITYSDK_OFFSET(0xEBD53D0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCECREATECUSTOMSCREENEFFECTSTANDALONE___BASE_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0xEBD5420)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceCreateCustomScreenEffectStandalone_TypeDefinitionIndex = 64112;
