...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_STOPPLAYERMOVE_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x138475B0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_STOPPLAYERMOVE_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x13847630)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_STOPPLAYERMOVE_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x13847570)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_STOPPLAYERMOVE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x13847620)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_STOPPLAYERMOVE_RECEIVENOTIFY_OFFSET UNITYSDK_OFFSET(0x13847790)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_STOPPLAYERMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x13847940)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceEvent_StopPlayerMove_TypeDefinitionIndex = 50743;
