...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_STOPPLAYERMOVE_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x15B1F600)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_STOPPLAYERMOVE_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x15B1F680)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_STOPPLAYERMOVE_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x15B1F5C0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_STOPPLAYERMOVE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x15B1F670)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_STOPPLAYERMOVE_RECEIVENOTIFY_OFFSET UNITYSDK_OFFSET(0x15B1F7E0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_STOPPLAYERMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x15B1F990)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceEvent_StopPlayerMove_TypeDefinitionIndex = 70728;
