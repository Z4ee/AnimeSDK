...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_DUMPFLOATVALUE_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0xF966600)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_DUMPFLOATVALUE_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0xF966670)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_DUMPFLOATVALUE_FETCH_RESULT_OFFSET UNITYSDK_OFFSET(0xF9667D0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_DUMPFLOATVALUE_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0xF966460)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_DUMPFLOATVALUE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0xF9664F0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_DUMPFLOATVALUE_RECEIVENOTIFY_OFFSET UNITYSDK_OFFSET(0xF966500)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_DUMPFLOATVALUE__CCTOR_OFFSET UNITYSDK_OFFSET(0xF9668C0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_DUMPFLOATVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0xF966880)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceEvent_DumpFloatValue_TypeDefinitionIndex = 83093;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceEvent_DumpFloatValue_TypeDefinitionIndex)->GetStaticField(0x11620);
		}
