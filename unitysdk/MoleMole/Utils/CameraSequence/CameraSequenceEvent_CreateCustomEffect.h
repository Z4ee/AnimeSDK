...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_CREATECUSTOMEFFECT_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0xE490150)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_CREATECUSTOMEFFECT_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0xE4901D0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_CREATECUSTOMEFFECT_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0xE490110)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_CREATECUSTOMEFFECT_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0xE4901C0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_CREATECUSTOMEFFECT_RECEIVENOTIFY_OFFSET UNITYSDK_OFFSET(0xE490330)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_CREATECUSTOMEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xE490740)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceEvent_CreateCustomEffect_TypeDefinitionIndex = 78927;
