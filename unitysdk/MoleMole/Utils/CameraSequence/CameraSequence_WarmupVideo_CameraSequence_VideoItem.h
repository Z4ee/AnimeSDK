...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_WARMUPVIDEO_CAMERASEQUENCE_VIDEOITEM_TOSTRING_OFFSET UNITYSDK_OFFSET(0x757160)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_WARMUPVIDEO_CAMERASEQUENCE_VIDEOITEM___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x757170)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequence_WarmupVideo_CameraSequence_VideoItem_TypeDefinitionIndex = 85610;
