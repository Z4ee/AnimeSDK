...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTOPRATINGFOGEFFECT_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x13847EB0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTOPRATINGFOGEFFECT_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x13847EF0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTOPRATINGFOGEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x13847FF0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTOPRATINGFOGEFFECT___BASE_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x13848040)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceStopRatingFogEffect_TypeDefinitionIndex = 52221;
