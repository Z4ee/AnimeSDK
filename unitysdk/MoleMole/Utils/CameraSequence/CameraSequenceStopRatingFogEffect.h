...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTOPRATINGFOGEFFECT_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x11340290)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTOPRATINGFOGEFFECT_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x113402D0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTOPRATINGFOGEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x113403D0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTOPRATINGFOGEFFECT___BASE_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x11340420)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceStopRatingFogEffect_TypeDefinitionIndex = 81462;
