...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTOPSCREENEFFECT_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x1277DDA0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTOPSCREENEFFECT_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x1277DDE0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTOPSCREENEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1277E150)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTOPSCREENEFFECT___BASE_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x1277E1A0)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceStopScreenEffect_TypeDefinitionIndex = 76644;
