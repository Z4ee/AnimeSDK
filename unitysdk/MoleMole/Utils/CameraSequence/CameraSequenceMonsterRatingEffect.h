...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEMONSTERRATINGEFFECT_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x11A26360)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEMONSTERRATINGEFFECT_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x11A263D0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEMONSTERRATINGEFFECT_FETCH_PLAYERID_OFFSET UNITYSDK_OFFSET(0x11A26530)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEMONSTERRATINGEFFECT_FETCH_TARGETID_OFFSET UNITYSDK_OFFSET(0x11A265E0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEMONSTERRATINGEFFECT_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x11A251F0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEMONSTERRATINGEFFECT_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x11A25230)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEMONSTERRATINGEFFECT_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x11A25240)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEMONSTERRATINGEFFECT_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0x11A26310)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEMONSTERRATINGEFFECT_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x11A262B0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEMONSTERRATINGEFFECT__CCTOR_OFFSET UNITYSDK_OFFSET(0x11A266E0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEMONSTERRATINGEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x11A26690)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceMonsterRatingEffect_TypeDefinitionIndex = 80183;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceMonsterRatingEffect_TypeDefinitionIndex)->GetStaticField(0xF9B0);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_TargetID()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceMonsterRatingEffect_TypeDefinitionIndex)->GetStaticField(0xF9B8);
		}
