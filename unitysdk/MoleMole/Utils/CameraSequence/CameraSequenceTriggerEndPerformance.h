...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCETRIGGERENDPERFORMANCE_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x12CA6340)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCETRIGGERENDPERFORMANCE_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x12CA6390)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCETRIGGERENDPERFORMANCE_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x12CA6300)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCETRIGGERENDPERFORMANCE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x12CA6380)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCETRIGGERENDPERFORMANCE_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x12CA6400)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCETRIGGERENDPERFORMANCE_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0x12CA6500)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCETRIGGERENDPERFORMANCE_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x12CA64A0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCETRIGGERENDPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x12CA6550)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceTriggerEndPerformance_TypeDefinitionIndex = 78346;
