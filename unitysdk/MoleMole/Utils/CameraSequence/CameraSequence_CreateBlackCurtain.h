...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_CREATEBLACKCURTAIN_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x1149BBD0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_CREATEBLACKCURTAIN_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1149BC20)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_CREATEBLACKCURTAIN_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x1149BB90)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_CREATEBLACKCURTAIN_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1149BC10)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_CREATEBLACKCURTAIN_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x1149BD80)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_CREATEBLACKCURTAIN_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0x1149C0A0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_CREATEBLACKCURTAIN_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x1149C040)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_CREATEBLACKCURTAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1149C0F0)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequence_CreateBlackCurtain_TypeDefinitionIndex = 73563;
