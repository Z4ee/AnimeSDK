...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_WARMUPVIDEO_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x122E04B0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_WARMUPVIDEO_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x122E0500)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_WARMUPVIDEO_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x122E0470)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_WARMUPVIDEO_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x122E04F0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_WARMUPVIDEO_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x122E0660)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_WARMUPVIDEO_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0x122E10E0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_WARMUPVIDEO_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x122E1080)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_WARMUPVIDEO__AUTOCHECK_OFFSET UNITYSDK_OFFSET(0x122E1030)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_WARMUPVIDEO__CTOR_OFFSET UNITYSDK_OFFSET(0x122E1130)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_WARMUPVIDEO__WARMUPVIDEO_OFFSET UNITYSDK_OFFSET(0x122E06E0)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequence_WarmupVideo_TypeDefinitionIndex = 52329;
