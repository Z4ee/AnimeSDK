...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0xEBD75E0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0xEBD7680)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0xEBD75A0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0xEBD7670)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0xEBD77E0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0xEBD81D0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0xEBD8170)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO__AUTOCHECK_OFFSET UNITYSDK_OFFSET(0xEBD7620)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO__CTOR_OFFSET UNITYSDK_OFFSET(0xEBD8220)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO__ONFINISHED_OFFSET UNITYSDK_OFFSET(0xEBD8040)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO__RECEIVENOTIFYBEGIN_G___UPDATESETALPHA_13_0_OFFSET UNITYSDK_OFFSET(0xEBD7FF0)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequence_PlayVideo_TypeDefinitionIndex = 40065;
