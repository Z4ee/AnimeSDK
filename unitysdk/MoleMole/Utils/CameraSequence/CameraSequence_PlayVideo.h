...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x108A1C30)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x108A1CD0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x108A1BF0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x108A1CC0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x108A1E30)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0x108A2820)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x108A27C0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO__AUTOCHECK_OFFSET UNITYSDK_OFFSET(0x108A1C70)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO__CTOR_OFFSET UNITYSDK_OFFSET(0x108A2870)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO__ONFINISHED_OFFSET UNITYSDK_OFFSET(0x108A2690)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO__RECEIVENOTIFYBEGIN_G___UPDATESETALPHA_13_0_OFFSET UNITYSDK_OFFSET(0x108A2640)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequence_PlayVideo_TypeDefinitionIndex = 82294;
