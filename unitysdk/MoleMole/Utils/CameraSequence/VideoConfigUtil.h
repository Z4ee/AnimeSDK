...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_VIDEOCONFIGUTIL_GETPLAYTYPEMATCHCONFIG_OFFSET UNITYSDK_OFFSET(0x115A1BC0)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int VideoConfigUtil_TypeDefinitionIndex = 74384;
