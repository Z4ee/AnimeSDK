...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCERATINGEFFECT_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x19507A60)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCERATINGEFFECT_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x19507AB0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCERATINGEFFECT_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x19507A20)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCERATINGEFFECT_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x19507AA0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCERATINGEFFECT_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x195079D0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCERATINGEFFECT_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0x19507C70)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCERATINGEFFECT_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x19507C10)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCERATINGEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19507930)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceRatingEffect_TypeDefinitionIndex = 70100;
