...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEMOTIONBLUR_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x11E55F80)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEMOTIONBLUR_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x11E56000)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEMOTIONBLUR_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x11E55F40)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEMOTIONBLUR_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x11E55FF0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEMOTIONBLUR_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x11E56160)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEMOTIONBLUR_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0x11E563F0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEMOTIONBLUR_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x11E56390)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEMOTIONBLUR__CCTOR_OFFSET UNITYSDK_OFFSET(0x11E566C0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEMOTIONBLUR__CTOR_OFFSET UNITYSDK_OFFSET(0x11E56670)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceStateEvent_DisableMotionBlur_TypeDefinitionIndex = 58096;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_DisableMotionBlur_TypeDefinitionIndex)->GetStaticField(0x12230);
		}
