...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_STOPNPCPERFORM_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x115A18A0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_STOPNPCPERFORM_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x115A1920)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_STOPNPCPERFORM_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x115A1860)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_STOPNPCPERFORM_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x115A1910)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_STOPNPCPERFORM_RECEIVENOTIFY_OFFSET UNITYSDK_OFFSET(0x115A1A80)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_STOPNPCPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x115A1B80)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceEvent_StopNPCPerform_TypeDefinitionIndex = 44886;
