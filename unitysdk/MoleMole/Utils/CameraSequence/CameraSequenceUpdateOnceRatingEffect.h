...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEUPDATEONCERATINGEFFECT_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x1149BA60)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEUPDATEONCERATINGEFFECT_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x1149BAA0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEUPDATEONCERATINGEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1149BAF0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEUPDATEONCERATINGEFFECT___BASE_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x1149BB40)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceUpdateOnceRatingEffect_TypeDefinitionIndex = 82517;
