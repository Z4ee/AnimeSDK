...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x126CDB70)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x126CDBE0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_FETCH_DUMPRESULT_OFFSET UNITYSDK_OFFSET(0x126CDDD0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_FETCH_SHAKEOFFSET_OFFSET UNITYSDK_OFFSET(0x126CDD40)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_FETCH_STARTOFFSET_OFFSET UNITYSDK_OFFSET(0x126CDE80)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_GET_CURDUMPKEY_OFFSET UNITYSDK_OFFSET(0x126CD700)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x126CD6B0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x126CD6F0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x126CD780)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0x126CDA10)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x126CD9B0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x126CDF90)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x126CDF30)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceStateEvent_DumpVector_TypeDefinitionIndex = 71857;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_DumpVector_TypeDefinitionIndex)->GetStaticField(0x11850);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_DumpResult()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_DumpVector_TypeDefinitionIndex)->GetStaticField(0x11858);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_ShakeOffset()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_DumpVector_TypeDefinitionIndex)->GetStaticField(0x11860);
		}
