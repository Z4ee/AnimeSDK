...
#define MOLEMOLE_MONOSPIN_METHOD_5_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x144F4670)
#define MOLEMOLE_MONOSPIN_METHOD_5_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x144F4860)
#define MOLEMOLE_MONOSPIN_UPDATE_OFFSET UNITYSDK_OFFSET(0x144F4620)
#define MOLEMOLE_MONOSPIN__CTOR_OFFSET UNITYSDK_OFFSET(0x144F4810)

namespace MoleMole
{
	inline static constexpr unsigned int MonoSpin_TypeDefinitionIndex = 63841;
