...
#define MOLEMOLE_UIARCADEGAMINGSCOREWIDGETCONTROLLER_GETVIEW_OFFSET UNITYSDK_OFFSET(0x152DC8D0)
#define MOLEMOLE_UIARCADEGAMINGSCOREWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x152DC7C0)
#define MOLEMOLE_UIARCADEGAMINGSCOREWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x152DC850)
#define MOLEMOLE_UIARCADEGAMINGSCOREWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x152DC6F0)
#define MOLEMOLE_UIARCADEGAMINGSCOREWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x152DC750)
#define MOLEMOLE_UIARCADEGAMINGSCOREWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x152DC920)
#define MOLEMOLE_UIARCADEGAMINGSCOREWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x152DC980)
#define MOLEMOLE_UIARCADEGAMINGSCOREWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x152DCA10)
#define MOLEMOLE_UIARCADEGAMINGSCOREWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x152DCAA0)
#define MOLEMOLE_UIARCADEGAMINGSCOREWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x152DCB30)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeGamingScoreWidgetController_TypeDefinitionIndex = 68357;

	class UIArcadeGamingScoreWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_8D0895B2D04B2FAF* _view; // 0x2B8
