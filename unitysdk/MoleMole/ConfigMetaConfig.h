...
#define MOLEMOLE_CONFIGMETACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x14957AA0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigMetaConfig_TypeDefinitionIndex = 78852;
