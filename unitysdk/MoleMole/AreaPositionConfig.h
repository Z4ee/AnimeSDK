...
#define MOLEMOLE_AREAPOSITIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x134C66C0)

namespace MoleMole
{
	inline static constexpr unsigned int AreaPositionConfig_TypeDefinitionIndex = 43541;
	...
	public:
		...
		::UnityEngine::Vector2 ConsolePosition; // 0x28
