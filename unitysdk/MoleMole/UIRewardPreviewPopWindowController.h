...
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER_BINDEVENT_OFFSET UNITYSDK_OFFSET(0x13764300)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x13764580)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x13764250)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x13764480)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x13764590)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x13764260)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x13764510)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x137642B0)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x13764600)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER_SETDATA_OFFSET UNITYSDK_OFFSET(0x137648B0)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x13764C00)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x13764C10)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x13764CA0)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x13764D30)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x13764D40)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x13764D50)

namespace MoleMole
{
	inline static constexpr unsigned int UIRewardPreviewPopWindowController_TypeDefinitionIndex = 65889;

	class UIRewardPreviewPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_7C86492618AE1202_1* _view; // 0x310
		::System::Collections::Generic::List_1<::Class_1_C4CB11A2FD957208_Struct_2_98E057419FFAAB00>* _dataList; // 0x318
		::System::String* _title; // 0x320
		::System::String* _subTitle; // 0x328
