...
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x168FA9B0)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x168FA510)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x168FAA40)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x168FA0F0)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x168FA150)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER_REFRESHBYCONTEXT_OFFSET UNITYSDK_OFFSET(0x168FA2B0)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER_SETCLICK_OFFSET UNITYSDK_OFFSET(0x168FA6D0)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x168FAAC0)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER__ONSCROLLITEMUPDATE_B__6_0_OFFSET UNITYSDK_OFFSET(0x168FAAF0)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER__ONUIOPEN_B__5_0_OFFSET UNITYSDK_OFFSET(0x168FAAD0)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER__UPDATECARD_OFFSET UNITYSDK_OFFSET(0x168FA720)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x168FAB10)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x168FABA0)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x168FAC40)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x168FACD0)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x168FAD60)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_LevelInfo_BossCard_V2_WidgetController_TypeDefinitionIndex = 42366;

	class UIHadalZone_LevelInfo_BossCard_V2_WidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_EC707217DE7794EF* _view; // 0x2F0
