...
#define MOLEMOLE_UISOCIALCIRCLEMEMBER_REPORTWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18875CE0)
#define MOLEMOLE_UISOCIALCIRCLEMEMBER_REPORTWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18875D50)
#define MOLEMOLE_UISOCIALCIRCLEMEMBER_REPORTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18875DF0)
#define MOLEMOLE_UISOCIALCIRCLEMEMBER_REPORTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18875FB0)
#define MOLEMOLE_UISOCIALCIRCLEMEMBER_REPORTWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18876010)
#define MOLEMOLE_UISOCIALCIRCLEMEMBER_REPORTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x188760B0)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleMember_ReportWidgetController_TypeDefinitionIndex = 40906;
