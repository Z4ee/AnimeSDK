...
#define MOLEMOLE_UIRIDUSGOTBOOFEVERTIPSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15F68C40)
#define MOLEMOLE_UIRIDUSGOTBOOFEVERTIPSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15F68CD0)
#define MOLEMOLE_UIRIDUSGOTBOOFEVERTIPSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15F68AC0)
#define MOLEMOLE_UIRIDUSGOTBOOFEVERTIPSWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15F68BD0)
#define MOLEMOLE_UIRIDUSGOTBOOFEVERTIPSWIDGETCONTROLLER_PLAYANIM_OFFSET UNITYSDK_OFFSET(0x15F68B20)
#define MOLEMOLE_UIRIDUSGOTBOOFEVERTIPSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15F68D50)
#define MOLEMOLE_UIRIDUSGOTBOOFEVERTIPSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15F68DE0)
#define MOLEMOLE_UIRIDUSGOTBOOFEVERTIPSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15F68E70)
#define MOLEMOLE_UIRIDUSGOTBOOFEVERTIPSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15F68F00)
#define MOLEMOLE_UIRIDUSGOTBOOFEVERTIPSWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15F68F90)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooFeverTipsWidgetController_TypeDefinitionIndex = 69860;
