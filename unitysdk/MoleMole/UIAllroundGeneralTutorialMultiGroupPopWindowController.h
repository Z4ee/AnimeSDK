...
#define MOLEMOLE_UIALLROUNDGENERALTUTORIALMULTIGROUPPOPWINDOWCONTROLLER_GET__LOGICDELEGATE_OFFSET UNITYSDK_OFFSET(0x158A20E0)
#define MOLEMOLE_UIALLROUNDGENERALTUTORIALMULTIGROUPPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x158A20F0)
#define MOLEMOLE_UIALLROUNDGENERALTUTORIALMULTIGROUPPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x158A2140)
#define MOLEMOLE_UIALLROUNDGENERALTUTORIALMULTIGROUPPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x158A2190)
#define MOLEMOLE_UIALLROUNDGENERALTUTORIALMULTIGROUPPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x158A2220)
#define MOLEMOLE_UIALLROUNDGENERALTUTORIALMULTIGROUPPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x158A2230)

namespace MoleMole
{
	inline static constexpr unsigned int UIAllroundGeneralTutorialMultiGroupPopWindowController_TypeDefinitionIndex = 47753;
	...
	{
	public:
		::MoleMole::UIAllroundGeneralTutorialPopWindowController_LogicDelegate* _m_logicDelegate_Multi; // 0x340
