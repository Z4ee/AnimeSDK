...
#define MOLEMOLE_UIDOWNLOADPOPWINDOWCONTROLLER___C__DISPLAYCLASS25_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15A41D50)
#define MOLEMOLE_UIDOWNLOADPOPWINDOWCONTROLLER___C__DISPLAYCLASS25_0__SHOWDOWNLOADSUCCESS_B__0_OFFSET UNITYSDK_OFFSET(0x15A41EB0)
#define MOLEMOLE_UIDOWNLOADPOPWINDOWCONTROLLER___C__DISPLAYCLASS25_0__SHOWDOWNLOADSUCCESS_B__1_OFFSET UNITYSDK_OFFSET(0x15A41EE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIDownloadPopWindowController___c__DisplayClass25_0_TypeDefinitionIndex = 68926;
