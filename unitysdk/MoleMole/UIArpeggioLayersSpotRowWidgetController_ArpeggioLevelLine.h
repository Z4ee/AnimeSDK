...
#define MOLEMOLE_UIARPEGGIOLAYERSSPOTROWWIDGETCONTROLLER_ARPEGGIOLEVELLINE_SETACTIVE_OFFSET UNITYSDK_OFFSET(0x18009330)
#define MOLEMOLE_UIARPEGGIOLAYERSSPOTROWWIDGETCONTROLLER_ARPEGGIOLEVELLINE_SETL1STATE_OFFSET UNITYSDK_OFFSET(0x18009390)
#define MOLEMOLE_UIARPEGGIOLAYERSSPOTROWWIDGETCONTROLLER_ARPEGGIOLEVELLINE_SETL2STATE_OFFSET UNITYSDK_OFFSET(0x18009430)
#define MOLEMOLE_UIARPEGGIOLAYERSSPOTROWWIDGETCONTROLLER_ARPEGGIOLEVELLINE_SETSKIN_OFFSET UNITYSDK_OFFSET(0x18008E60)
#define MOLEMOLE_UIARPEGGIOLAYERSSPOTROWWIDGETCONTROLLER_ARPEGGIOLEVELLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x180094D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIArpeggioLayersSpotRowWidgetController_ArpeggioLevelLine_TypeDefinitionIndex = 60107;

	class UIArpeggioLayersSpotRowWidgetController_ArpeggioLevelLine : public ::System::Object
	{
	public:
		::UnityEngine::GameObject* L1_Lock; // 0x10
		::UnityEngine::GameObject* L2_Unlock; // 0x18
		::UnityEngine::GameObject* L1_Unlock; // 0x20
		::UnityEngine::GameObject* L2; // 0x28
		::UnityEngine::GameObject* L2_Lock; // 0x30
		::UnityEngine::GameObject* L1; // 0x38
		::UnityEngine::GameObject* Skin; // 0x40
