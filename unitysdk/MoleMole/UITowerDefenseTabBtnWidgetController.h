...
#define MOLEMOLE_UITOWERDEFENSETABBTNWIDGETCONTROLLER_GETTABBUTTON_OFFSET UNITYSDK_OFFSET(0x15EBB1F0)
#define MOLEMOLE_UITOWERDEFENSETABBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15EBB0E0)
#define MOLEMOLE_UITOWERDEFENSETABBTNWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15EBB250)
#define MOLEMOLE_UITOWERDEFENSETABBTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15EBB170)
#define MOLEMOLE_UITOWERDEFENSETABBTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15EBB080)
#define MOLEMOLE_UITOWERDEFENSETABBTNWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x15EBB350)
#define MOLEMOLE_UITOWERDEFENSETABBTNWIDGETCONTROLLER_SETCLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x15EBBD40)
#define MOLEMOLE_UITOWERDEFENSETABBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15EBBD90)
#define MOLEMOLE_UITOWERDEFENSETABBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15EBBDA0)
#define MOLEMOLE_UITOWERDEFENSETABBTNWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15EBBE30)
#define MOLEMOLE_UITOWERDEFENSETABBTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15EBBED0)
#define MOLEMOLE_UITOWERDEFENSETABBTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15EBBF60)

namespace MoleMole
{
	inline static constexpr unsigned int UITowerDefenseTabBtnWidgetController_TypeDefinitionIndex = 63716;
	...
	public:
		...
		::System::Action_1<::Class_1_7807B2B04302CD7B_11*>* clickCallback; // 0x300
		...
		::System::Void SetClickCallback(::System::Action_1<::Class_1_7807B2B04302CD7B_11*>* action)
		{
			return ((::System::Void(*)(::PVOID, ::System::Action_1<::Class_1_7807B2B04302CD7B_11*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UITOWERDEFENSETABBTNWIDGETCONTROLLER_SETCLICKCALLBACK_OFFSET))(this, action);
		}
