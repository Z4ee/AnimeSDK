...
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_COMPAREPLAYPARAMS_OFFSET UNITYSDK_OFFSET(0x18A0D4F0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_DOSTOPUNTILCHESSBOARDLOADINGFINISH_OFFSET UNITYSDK_OFFSET(0x18A0D2C0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_CURPLAYTYPE_OFFSET UNITYSDK_OFFSET(0x18A0BF70)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_CURRENTVIDEOPLAYERHELPER_OFFSET UNITYSDK_OFFSET(0x18A0BF10)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_CURVIDEOPATH_OFFSET UNITYSDK_OFFSET(0x18A0BE10)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x18A0BE80)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x18A0BAB0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x18A0BC00)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0x18A0BD20)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_ISREADY_OFFSET UNITYSDK_OFFSET(0x18A0BD80)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_ISVIDEOSHOW_OFFSET UNITYSDK_OFFSET(0x18A0C0F0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_PERMANENT_OFFSET UNITYSDK_OFFSET(0x18A0BBF0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_VIDEOPLAYER_OFFSET UNITYSDK_OFFSET(0x18A0C100)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x18A0BAA0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_INITVIDEOPLAYER_1_OFFSET UNITYSDK_OFFSET(0x18A0C580)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_INITVIDEOPLAYER_OFFSET UNITYSDK_OFFSET(0x18A0C440)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18A0C1B0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_ONPREPAREFAKELOADING_OFFSET UNITYSDK_OFFSET(0x18A0D560)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18A0C240)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18A0C110)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_PLAY_OFFSET UNITYSDK_OFFSET(0x18A0D340)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x18A0BAC0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_SET_CURPLAYTYPE_OFFSET UNITYSDK_OFFSET(0x18A0BF80)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_SET_CURVIDEOPATH_OFFSET UNITYSDK_OFFSET(0x18A0BE70)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_SET_ISVIDEOSHOW_OFFSET UNITYSDK_OFFSET(0x18A0BF90)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_STOPANDHIDE_OFFSET UNITYSDK_OFFSET(0x18A0C920)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_STOPIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x18A0CD80)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_UPDATEALPHABYISVIDEOSHOW_OFFSET UNITYSDK_OFFSET(0x18A0C060)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18A0D600)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18A0D5B0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER__STOPANDHIDE_B__49_0_OFFSET UNITYSDK_OFFSET(0x18A0D690)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18A0D760)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18A0D7F0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18A0D800)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x18A0D810)

namespace MoleMole
{
	inline static constexpr unsigned int UILoadingTransferPopWindowController_TypeDefinitionIndex = 85304;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UILoadingTransferPopWindowController_TypeDefinitionIndex)->GetStaticField(0x43DD0);
		}
		static ::System::String** StaticGet_kBattle2ChessboardPath()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UILoadingTransferPopWindowController_TypeDefinitionIndex)->GetStaticField(0x43DD8);
		}
		static ::System::String** StaticGet_kToBattleFakeLoadingPath()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UILoadingTransferPopWindowController_TypeDefinitionIndex)->GetStaticField(0x43DE0);
		}
		static ::System::String** StaticGet_kBattle2ChessboardFakeLoadingPath()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UILoadingTransferPopWindowController_TypeDefinitionIndex)->GetStaticField(0x43DE8);
		}
		static ::System::String** StaticGet_kToBattlePath()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UILoadingTransferPopWindowController_TypeDefinitionIndex)->GetStaticField(0x43DF0);
		}
