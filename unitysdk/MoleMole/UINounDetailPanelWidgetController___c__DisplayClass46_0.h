...
#define MOLEMOLE_UINOUNDETAILPANELWIDGETCONTROLLER___C__DISPLAYCLASS46_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1867BAA0)
#define MOLEMOLE_UINOUNDETAILPANELWIDGETCONTROLLER___C__DISPLAYCLASS46_0__PLAYCLIPASYNC_B__0_OFFSET UNITYSDK_OFFSET(0x1867BAB0)

namespace MoleMole
{
	inline static constexpr unsigned int UINounDetailPanelWidgetController___c__DisplayClass46_0_TypeDefinitionIndex = 55922;
