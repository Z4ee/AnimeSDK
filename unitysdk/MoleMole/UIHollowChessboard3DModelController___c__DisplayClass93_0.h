...
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER___C__DISPLAYCLASS93_0__CTOR_OFFSET UNITYSDK_OFFSET(0x14694220)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER___C__DISPLAYCLASS93_0__TRYRETURN2PERSISTFOCUSCAMERA_B__0_OFFSET UNITYSDK_OFFSET(0x14694230)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER___C__DISPLAYCLASS93_0__TRYRETURN2PERSISTFOCUSCAMERA_G__ONREACHTARGETPOS_1_OFFSET UNITYSDK_OFFSET(0x14694500)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowChessboard3DModelController___c__DisplayClass93_0_TypeDefinitionIndex = 58384;

	class UIHollowChessboard3DModelController___c__DisplayClass93_0 : public ::System::Object
	{
	public:
		::Class_3_AB9E23F58C71A630_1* focusStateNet; // 0x10
