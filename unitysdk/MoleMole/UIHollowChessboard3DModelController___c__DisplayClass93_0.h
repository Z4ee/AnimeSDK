...
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER___C__DISPLAYCLASS93_0__CTOR_OFFSET UNITYSDK_OFFSET(0x14681E50)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER___C__DISPLAYCLASS93_0__TRYRETURN2PERSISTFOCUSCAMERA_B__0_OFFSET UNITYSDK_OFFSET(0x14681E60)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER___C__DISPLAYCLASS93_0__TRYRETURN2PERSISTFOCUSCAMERA_G__ONREACHTARGETPOS_1_OFFSET UNITYSDK_OFFSET(0x14682140)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowChessboard3DModelController___c__DisplayClass93_0_TypeDefinitionIndex = 44030;

	class UIHollowChessboard3DModelController___c__DisplayClass93_0 : public ::System::Object
	{
	public:
		::Class_3_AB9E23F58C71A630* focusStateNet; // 0x10
