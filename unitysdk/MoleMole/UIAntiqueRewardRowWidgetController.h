...
#define MOLEMOLE_UIANTIQUEREWARDROWWIDGETCONTROLLER_ADDITEMICONBTNSMALLWIDGET_OFFSET UNITYSDK_OFFSET(0x15EC6C20)
#define MOLEMOLE_UIANTIQUEREWARDROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15EC6A90)
#define MOLEMOLE_UIANTIQUEREWARDROWWIDGETCONTROLLER_ONGETREWARDBUTTON_OFFSET UNITYSDK_OFFSET(0x15EC7100)
#define MOLEMOLE_UIANTIQUEREWARDROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15EC6DD0)
#define MOLEMOLE_UIANTIQUEREWARDROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15EC6D40)
#define MOLEMOLE_UIANTIQUEREWARDROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15EC6CE0)
#define MOLEMOLE_UIANTIQUEREWARDROWWIDGETCONTROLLER_REFRESHPANEL_OFFSET UNITYSDK_OFFSET(0x15EC6ED0)
#define MOLEMOLE_UIANTIQUEREWARDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15EC75B0)
#define MOLEMOLE_UIANTIQUEREWARDROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15EC75C0)
#define MOLEMOLE_UIANTIQUEREWARDROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15EC7650)
#define MOLEMOLE_UIANTIQUEREWARDROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15EC76F0)
#define MOLEMOLE_UIANTIQUEREWARDROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15EC7780)

namespace MoleMole
{
	inline static constexpr unsigned int UIAntiqueRewardRowWidgetController_TypeDefinitionIndex = 45510;

	class UIAntiqueRewardRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_407C0CCB827E7EB7* _view; // 0x2E8
		::Class_1_9532C712260DD3D3* _data; // 0x2F0
		...
		{
			return ((::MoleMole::UIItemIconBtnSmallWidgetController*(*)(::PVOID, ::Enum_3_81A3942BCC6E42B5, ::System::Func_1<::MoleMole::UIControlReference*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIANTIQUEREWARDROWWIDGETCONTROLLER_ADDITEMICONBTNSMALLWIDGET_OFFSET))(this, ctrl, arg);
		}
