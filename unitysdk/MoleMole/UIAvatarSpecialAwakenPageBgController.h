...
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGEBGCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x196FA070)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarSpecialAwakenPageBgController_TypeDefinitionIndex = 60262;
