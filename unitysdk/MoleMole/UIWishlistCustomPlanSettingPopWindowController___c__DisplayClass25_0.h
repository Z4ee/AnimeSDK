...
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER___C__DISPLAYCLASS25_0__CTOR_OFFSET UNITYSDK_OFFSET(0x11BDEE10)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER___C__DISPLAYCLASS25_0__REFRESHSUITTYPEVIEW_B__0_OFFSET UNITYSDK_OFFSET(0x11BDF0D0)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER___C__DISPLAYCLASS25_0__REFRESHSUITTYPEVIEW_B__1_OFFSET UNITYSDK_OFFSET(0x11BDEE20)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER___C__DISPLAYCLASS25_0__REFRESHSUITTYPEVIEW_B__2_OFFSET UNITYSDK_OFFSET(0x11BDEF40)

namespace MoleMole
{
	inline static constexpr unsigned int UIWishlistCustomPlanSettingPopWindowController___c__DisplayClass25_0_TypeDefinitionIndex = 87238;

	class UIWishlistCustomPlanSettingPopWindowController___c__DisplayClass25_0 : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::MoleMole::UIWishlistCustomSettingSlotPropertySelectWidgetController*>* propertySelectWidgetList; // 0x10
		::System::Action_2<::System::Int32, ::System::UInt32>* __9__2; // 0x18
		::MoleMole::UIWishlistCustomPlanSettingPopWindowController* __4__this; // 0x20
