...
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER___C__DISPLAYCLASS25_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15146260)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER___C__DISPLAYCLASS25_0__REFRESHSUITTYPEVIEW_B__0_OFFSET UNITYSDK_OFFSET(0x15146510)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER___C__DISPLAYCLASS25_0__REFRESHSUITTYPEVIEW_B__1_OFFSET UNITYSDK_OFFSET(0x15146270)
#define MOLEMOLE_UIWISHLISTCUSTOMPLANSETTINGPOPWINDOWCONTROLLER___C__DISPLAYCLASS25_0__REFRESHSUITTYPEVIEW_B__2_OFFSET UNITYSDK_OFFSET(0x15146390)

namespace MoleMole
{
	inline static constexpr unsigned int UIWishlistCustomPlanSettingPopWindowController___c__DisplayClass25_0_TypeDefinitionIndex = 60361;
