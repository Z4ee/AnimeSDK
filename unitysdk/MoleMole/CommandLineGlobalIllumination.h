...
#define MOLEMOLE_COMMANDLINEGLOBALILLUMINATION_METHOD_2_1B4C5B2FC2BD492F_OFFSET UNITYSDK_OFFSET(0x12C580F0)
#define MOLEMOLE_COMMANDLINEGLOBALILLUMINATION_METHOD_2_B5437EAA905A208A_OFFSET UNITYSDK_OFFSET(0x12C58200)
#define MOLEMOLE_COMMANDLINEGLOBALILLUMINATION__CTOR_OFFSET UNITYSDK_OFFSET(0x12C581C0)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineGlobalIllumination_TypeDefinitionIndex = 59861;
