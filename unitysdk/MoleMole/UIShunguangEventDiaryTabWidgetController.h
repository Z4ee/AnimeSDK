...
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x122AE590)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x122AE6A0)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x122AE620)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x122AE440)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x122AE760)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x122AE970)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x122AE980)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x122AEA10)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x122AEAB0)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x122AEB40)

namespace MoleMole
{
	inline static constexpr unsigned int UIShunguangEventDiaryTabWidgetController_TypeDefinitionIndex = 63657;
