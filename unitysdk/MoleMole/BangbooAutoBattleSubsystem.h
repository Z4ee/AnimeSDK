...
#define MOLEMOLE_BANGBOOAUTOBATTLESUBSYSTEM_GET_NETWORKHANDLER_OFFSET UNITYSDK_OFFSET(0x11C77E20)
#define MOLEMOLE_BANGBOOAUTOBATTLESUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x11C77E40)
#define MOLEMOLE_BANGBOOAUTOBATTLESUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x11C77FF0)
#define MOLEMOLE_BANGBOOAUTOBATTLESUBSYSTEM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x11C77E80)
#define MOLEMOLE_BANGBOOAUTOBATTLESUBSYSTEM_SET_NETWORKHANDLER_OFFSET UNITYSDK_OFFSET(0x11C77E30)
#define MOLEMOLE_BANGBOOAUTOBATTLESUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x11C78050)
#define MOLEMOLE_BANGBOOAUTOBATTLESUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x11C78070)
#define MOLEMOLE_BANGBOOAUTOBATTLESUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x11C78100)
#define MOLEMOLE_BANGBOOAUTOBATTLESUBSYSTEM___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x11C78190)

namespace MoleMole
{
	inline static constexpr unsigned int BangbooAutoBattleSubsystem_TypeDefinitionIndex = 56860;
