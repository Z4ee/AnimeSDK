...
#define MOLEMOLE_BANGBOOAUTOBATTLESUBSYSTEM_GET_NETWORKHANDLER_OFFSET UNITYSDK_OFFSET(0x13468800)
#define MOLEMOLE_BANGBOOAUTOBATTLESUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x13468820)
#define MOLEMOLE_BANGBOOAUTOBATTLESUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x134689D0)
#define MOLEMOLE_BANGBOOAUTOBATTLESUBSYSTEM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x13468860)
#define MOLEMOLE_BANGBOOAUTOBATTLESUBSYSTEM_SET_NETWORKHANDLER_OFFSET UNITYSDK_OFFSET(0x13468810)
#define MOLEMOLE_BANGBOOAUTOBATTLESUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x13468A30)
#define MOLEMOLE_BANGBOOAUTOBATTLESUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x13468A50)
#define MOLEMOLE_BANGBOOAUTOBATTLESUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x13468AE0)
#define MOLEMOLE_BANGBOOAUTOBATTLESUBSYSTEM___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x13468B70)

namespace MoleMole
{
	inline static constexpr unsigned int BangbooAutoBattleSubsystem_TypeDefinitionIndex = 83108;
