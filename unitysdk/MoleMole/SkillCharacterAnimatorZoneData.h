...
#define MOLEMOLE_SKILLCHARACTERANIMATORZONEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x129DA370)

namespace MoleMole
{
	inline static constexpr unsigned int SkillCharacterAnimatorZoneData_TypeDefinitionIndex = 57933;
