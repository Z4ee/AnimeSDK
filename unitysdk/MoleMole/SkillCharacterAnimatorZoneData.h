...
#define MOLEMOLE_SKILLCHARACTERANIMATORZONEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x173FD5D0)

namespace MoleMole
{
	inline static constexpr unsigned int SkillCharacterAnimatorZoneData_TypeDefinitionIndex = 69156;
