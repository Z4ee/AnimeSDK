...
#define MOLEMOLE_MONOMODELANIMATORSWITCHER_CHECKDELAYDISABLE_OFFSET UNITYSDK_OFFSET(0x13F13B20)
#define MOLEMOLE_MONOMODELANIMATORSWITCHER_GETMODELSETINDEX_OFFSET UNITYSDK_OFFSET(0x13F13A00)
#define MOLEMOLE_MONOMODELANIMATORSWITCHER_GET_NEEDUPDATEDELAYANIMATORDISABLE_OFFSET UNITYSDK_OFFSET(0x13F139E0)
#define MOLEMOLE_MONOMODELANIMATORSWITCHER_METHOD_5_7A2E89572E7E9DB4_OFFSET UNITYSDK_OFFSET(0x13F13CA0)
#define MOLEMOLE_MONOMODELANIMATORSWITCHER_SETMODELSETACTIVE_OFFSET UNITYSDK_OFFSET(0x13F13DA0)
#define MOLEMOLE_MONOMODELANIMATORSWITCHER_SET_NEEDUPDATEDELAYANIMATORDISABLE_OFFSET UNITYSDK_OFFSET(0x13F139F0)
#define MOLEMOLE_MONOMODELANIMATORSWITCHER_SWITCHMODELSET_OFFSET UNITYSDK_OFFSET(0x13F13D00)
#define MOLEMOLE_MONOMODELANIMATORSWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x13F13FE0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoModelAnimatorSwitcher_TypeDefinitionIndex = 75542;
