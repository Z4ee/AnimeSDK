...
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER_GETLOGICBUTTONNEWKEYCODE_OFFSET UNITYSDK_OFFSET(0x189ED0A0)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x189ECA50)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x189EC940)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x189EC9D0)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x189EC7D0)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x189EC830)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x189ED420)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x189ED4B0)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER__ONUIOPEN_B__2_0_OFFSET UNITYSDK_OFFSET(0x189ED510)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER__ONUIOPEN_B__2_1_OFFSET UNITYSDK_OFFSET(0x189ED520)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x189ED530)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x189ED5C0)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x189ED650)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x189ED6E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIKeyBindingConflictRowWidgetController_TypeDefinitionIndex = 85812;

	class UIKeyBindingConflictRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_122* _view; // 0x2C0
		::MoleMole::UIKeyBindingContext* _context; // 0x2C8
		::Class_1_00CE3360E2CE5BB6* _keyPanelItem; // 0x2D0
		::Class_1_00CE3360E2CE5BB6* _keyPanelItem02; // 0x2D8
		::Class_1_00CE3360E2CE5BB6* _comboKeyPanelItem; // 0x2E0
		::Class_1_00CE3360E2CE5BB6* _comboKeyPanelItem02; // 0x2E8
