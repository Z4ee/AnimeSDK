...
#define MOLEMOLE_UIGENERALMISSIONGETPOINTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x169B83F0)
#define MOLEMOLE_UIGENERALMISSIONGETPOINTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x169B8480)
#define MOLEMOLE_UIGENERALMISSIONGETPOINTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x169B8320)
#define MOLEMOLE_UIGENERALMISSIONGETPOINTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x169B8380)
#define MOLEMOLE_UIGENERALMISSIONGETPOINTWIDGETCONTROLLER_SETSELECT_OFFSET UNITYSDK_OFFSET(0x169B8270)
#define MOLEMOLE_UIGENERALMISSIONGETPOINTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x169B8500)
#define MOLEMOLE_UIGENERALMISSIONGETPOINTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x169B8560)
#define MOLEMOLE_UIGENERALMISSIONGETPOINTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x169B85F0)
#define MOLEMOLE_UIGENERALMISSIONGETPOINTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x169B8680)
#define MOLEMOLE_UIGENERALMISSIONGETPOINTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x169B8710)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralMissionGetPointWidgetController_TypeDefinitionIndex = 74533;

	class UIGeneralMissionGetPointWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_D68EC59F0214DAC2_7* _view; // 0x2B8
