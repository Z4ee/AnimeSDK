...
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS78_0__CTOR_OFFSET UNITYSDK_OFFSET(0x152F6720)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS78_0__SHOWBADBUBBLE_B__1_OFFSET UNITYSDK_OFFSET(0x152F6730)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS78_0__SHOWBADBUBBLE_B__2_OFFSET UNITYSDK_OFFSET(0x152F6940)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS78_0__SHOWBADBUBBLE_B__3_OFFSET UNITYSDK_OFFSET(0x152F68D0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS78_0__SHOWBADBUBBLE_B__4_OFFSET UNITYSDK_OFFSET(0x152F6B40)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaSinglePlayWidgetController___c__DisplayClass78_0_TypeDefinitionIndex = 66478;

	class UICinemaSinglePlayWidgetController___c__DisplayClass78_0 : public ::System::Object
	{
	public:
		::System::Func_1<::System::Int32>* onClick; // 0x10
		::System::Action* __9__3; // 0x18
		::System::Action* __9__4; // 0x20
		::MoleMole::UICinemaSingleBadBubbleWidgetController* bubbleWidget; // 0x28
		::Class_2_7341BF3E408F4DA8_Class_2_5F3C14FED1CE4C5F_2* locationView; // 0x30
		::MoleMole::UICinemaSinglePlayWidgetController* __4__this; // 0x38
		::System::Int32 bubbleLocation; // 0x40
		::MoleMole::CinemaSingleBeatMapConfig_BeatMap_BeatItem item; // 0x44
