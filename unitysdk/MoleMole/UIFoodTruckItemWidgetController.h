...
#define MOLEMOLE_UIFOODTRUCKITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x176306B0)
#define MOLEMOLE_UIFOODTRUCKITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x176307C0)
#define MOLEMOLE_UIFOODTRUCKITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17630740)
#define MOLEMOLE_UIFOODTRUCKITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17630500)
#define MOLEMOLE_UIFOODTRUCKITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17630A00)
#define MOLEMOLE_UIFOODTRUCKITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17630A10)
#define MOLEMOLE_UIFOODTRUCKITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17630AA0)
#define MOLEMOLE_UIFOODTRUCKITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17630B40)
#define MOLEMOLE_UIFOODTRUCKITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17630BD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFoodTruckItemWidgetController_TypeDefinitionIndex = 78685;

	class UIFoodTruckItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_C9DDE9730C6BE395_8* _view; // 0x2F0
