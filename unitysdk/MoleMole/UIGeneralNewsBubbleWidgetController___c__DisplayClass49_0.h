...
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER___C__DISPLAYCLASS49_0__CTOR_OFFSET UNITYSDK_OFFSET(0x175E6ED0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER___C__DISPLAYCLASS49_0__PAUSEBUBBLEGROUP_B__0_OFFSET UNITYSDK_OFFSET(0x175E6EE0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER___C__DISPLAYCLASS49_0__PAUSEBUBBLEGROUP_B__1_OFFSET UNITYSDK_OFFSET(0x175E6FB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralNewsBubbleWidgetController___c__DisplayClass49_0_TypeDefinitionIndex = 54503;
