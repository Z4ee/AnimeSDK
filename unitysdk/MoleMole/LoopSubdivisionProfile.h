...
#define MOLEMOLE_LOOPSUBDIVISIONPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x182F6150)
#define MOLEMOLE_LOOPSUBDIVISIONPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x182F6290)
#define MOLEMOLE_LOOPSUBDIVISIONPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x182F6070)
#define MOLEMOLE_LOOPSUBDIVISIONPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x182F6210)
#define MOLEMOLE_LOOPSUBDIVISIONPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x182F6060)
#define MOLEMOLE_LOOPSUBDIVISIONPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x182F63B0)
#define MOLEMOLE_LOOPSUBDIVISIONPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x182F6440)
#define MOLEMOLE_LOOPSUBDIVISIONPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x182F64D0)
#define MOLEMOLE_LOOPSUBDIVISIONPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x182F6560)

namespace MoleMole
{
	inline static constexpr unsigned int LoopSubdivisionProfile_TypeDefinitionIndex = 79650;
