...
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER_CREATWEAPONITEM_OFFSET UNITYSDK_OFFSET(0x17D46CE0)
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x17D460A0)
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER_GOTODETAIL_OFFSET UNITYSDK_OFFSET(0x17D47DF0)
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x17D46160)
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER_ONCANCEL_OFFSET UNITYSDK_OFFSET(0x17D47C00)
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER_ONCLICKEQUIPBTN_OFFSET UNITYSDK_OFFSET(0x17D48030)
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER_ONCLICKSCROLLVIEWITEM_OFFSET UNITYSDK_OFFSET(0x17D46DF0)
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17D46A70)
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x17D47C60)
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER_ONITEMCHANGE_OFFSET UNITYSDK_OFFSET(0x17D480B0)
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17D46910)
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17D46B00)
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17D460B0)
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17D46560)
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER_REFRESHJUMPITEMS_OFFSET UNITYSDK_OFFSET(0x17D476B0)
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x17D469D0)
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER_SETBTNSSTATE_OFFSET UNITYSDK_OFFSET(0x17D46C50)
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER_SETDATAEMPTYSTATE_OFFSET UNITYSDK_OFFSET(0x17D46B70)
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER_SETROLEICON_OFFSET UNITYSDK_OFFSET(0x17D46780)
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17D48320)
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER__ONUIOPEN_B__7_0_OFFSET UNITYSDK_OFFSET(0x17D48330)
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER__ONUIOPEN_B__7_1_OFFSET UNITYSDK_OFFSET(0x17D48540)
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17D48550)
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x17D485E0)
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17D48690)
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17D486A0)
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17D486B0)
#define MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17D486C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleWeaponRecommendPopWindowController_TypeDefinitionIndex = 61168;
	...
	public:
		...
		::MoleMole::ScrollViewItemWidgetController* CreatWeaponItem(::Enum_3_DBF2701137F18AA6 arg1, ::System::Func_1<::MoleMole::UIControlReference*>* arg2)
		{
			return ((::MoleMole::ScrollViewItemWidgetController*(*)(::PVOID, ::Enum_3_DBF2701137F18AA6, ::System::Func_1<::MoleMole::UIControlReference*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIROLEWEAPONRECOMMENDPOPWINDOWCONTROLLER_CREATWEAPONITEM_OFFSET))(this, arg1, arg2);
		}
