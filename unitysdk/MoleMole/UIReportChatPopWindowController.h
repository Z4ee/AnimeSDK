...
#define MOLEMOLE_UIREPORTCHATPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1667D9C0)
#define MOLEMOLE_UIREPORTCHATPOPWINDOWCONTROLLER_INITWITHDATA_OFFSET UNITYSDK_OFFSET(0x1667DDF0)
#define MOLEMOLE_UIREPORTCHATPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1667DCB0)
#define MOLEMOLE_UIREPORTCHATPOPWINDOWCONTROLLER_ONSELECTITEM_OFFSET UNITYSDK_OFFSET(0x1667EA30)
#define MOLEMOLE_UIREPORTCHATPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1667DD40)
#define MOLEMOLE_UIREPORTCHATPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1667D9D0)
#define MOLEMOLE_UIREPORTCHATPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1667DA20)
#define MOLEMOLE_UIREPORTCHATPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1667EB20)
#define MOLEMOLE_UIREPORTCHATPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1667EB30)
#define MOLEMOLE_UIREPORTCHATPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1667EBC0)
#define MOLEMOLE_UIREPORTCHATPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1667EBD0)
#define MOLEMOLE_UIREPORTCHATPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1667EBE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIReportChatPopWindowController_TypeDefinitionIndex = 61213;
	...
	public:
		...
		::System::Void InitWithData(::MoleMole::UIReportChatPopWindowController_Mode mode, ::System::Collections::Generic::IReadOnlyList_1<::Class_1_89120A467F7A010D_1*>* reportMsgDataList, ::System::Int32 maxSelectCount, ::System::Action_1<::System::Int32>* closeCallback)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::UIReportChatPopWindowController_Mode, ::System::Collections::Generic::IReadOnlyList_1<::Class_1_89120A467F7A010D_1*>*, ::System::Int32, ::System::Action_1<::System::Int32>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIREPORTCHATPOPWINDOWCONTROLLER_INITWITHDATA_OFFSET))(this, mode, reportMsgDataList, maxSelectCount, closeCallback);
		}
