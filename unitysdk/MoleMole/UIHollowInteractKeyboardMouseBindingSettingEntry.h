...
#define MOLEMOLE_UIHOLLOWINTERACTKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_LOCKEDSETTINGRAWINPUTDEVICELIST_OFFSET UNITYSDK_OFFSET(0x14B4D1A0)
#define MOLEMOLE_UIHOLLOWINTERACTKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x14B4D180)
#define MOLEMOLE_UIHOLLOWINTERACTKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x14B4D190)
#define MOLEMOLE_UIHOLLOWINTERACTKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x14B4D230)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowInteractKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 76173;
