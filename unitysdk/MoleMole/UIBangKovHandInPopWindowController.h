...
#define MOLEMOLE_UIBANGKOVHANDINPOPWINDOWCONTROLLER_APPLYBANGKOVITEMINFOTOWISHLIST_OFFSET UNITYSDK_OFFSET(0x152E68E0)
#define MOLEMOLE_UIBANGKOVHANDINPOPWINDOWCONTROLLER_FINDMANUALIDBYCURRENTQUESTID_OFFSET UNITYSDK_OFFSET(0x152E7D90)
#define MOLEMOLE_UIBANGKOVHANDINPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x152E6020)
#define MOLEMOLE_UIBANGKOVHANDINPOPWINDOWCONTROLLER_ONCLICKADDWISHLISTBTN_OFFSET UNITYSDK_OFFSET(0x152E7510)
#define MOLEMOLE_UIBANGKOVHANDINPOPWINDOWCONTROLLER_ONCLICKBACKBTN_OFFSET UNITYSDK_OFFSET(0x152E7C90)
#define MOLEMOLE_UIBANGKOVHANDINPOPWINDOWCONTROLLER_ONCLICKMOVEBTN_OFFSET UNITYSDK_OFFSET(0x152E7C30)
#define MOLEMOLE_UIBANGKOVHANDINPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x152E6030)
#define MOLEMOLE_UIBANGKOVHANDINPOPWINDOWCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x152E70D0)
#define MOLEMOLE_UIBANGKOVHANDINPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x152E7410)
#define MOLEMOLE_UIBANGKOVHANDINPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x152E6340)
#define MOLEMOLE_UIBANGKOVHANDINPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x152E6DB0)
#define MOLEMOLE_UIBANGKOVHANDINPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x152E61B0)
#define MOLEMOLE_UIBANGKOVHANDINPOPWINDOWCONTROLLER_OPENBANGKOVITEMINFOFROMWISHLISTICON_OFFSET UNITYSDK_OFFSET(0x152E6EA0)
#define MOLEMOLE_UIBANGKOVHANDINPOPWINDOWCONTROLLER_REFRESHWISHLISTBTNSTATE_OFFSET UNITYSDK_OFFSET(0x152E6AA0)
#define MOLEMOLE_UIBANGKOVHANDINPOPWINDOWCONTROLLER_SETCANCELCALLBACK_OFFSET UNITYSDK_OFFSET(0x152E7D40)
#define MOLEMOLE_UIBANGKOVHANDINPOPWINDOWCONTROLLER_SETSUBMITCALLBACK_OFFSET UNITYSDK_OFFSET(0x152E7CF0)
#define MOLEMOLE_UIBANGKOVHANDINPOPWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x152E7070)
#define MOLEMOLE_UIBANGKOVHANDINPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x152E8020)
#define MOLEMOLE_UIBANGKOVHANDINPOPWINDOWCONTROLLER__ONCLICKADDWISHLISTBTN_B__14_0_OFFSET UNITYSDK_OFFSET(0x152E80D0)
#define MOLEMOLE_UIBANGKOVHANDINPOPWINDOWCONTROLLER__ONCLICKADDWISHLISTBTN_B__14_2_OFFSET UNITYSDK_OFFSET(0x152E80E0)
#define MOLEMOLE_UIBANGKOVHANDINPOPWINDOWCONTROLLER__OPENBANGKOVITEMINFOFROMWISHLISTICON_B__10_0_OFFSET UNITYSDK_OFFSET(0x152E80B0)
#define MOLEMOLE_UIBANGKOVHANDINPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x152E80F0)
#define MOLEMOLE_UIBANGKOVHANDINPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x152E8180)
#define MOLEMOLE_UIBANGKOVHANDINPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x152E8230)
#define MOLEMOLE_UIBANGKOVHANDINPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x152E8260)
#define MOLEMOLE_UIBANGKOVHANDINPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x152E8270)
#define MOLEMOLE_UIBANGKOVHANDINPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x152E8280)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangKovHandInPopWindowController_TypeDefinitionIndex = 64951;

	class UIBangKovHandInPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_B2F1B54A6BC70F07* _view; // 0x310
		::Class_1_61933880828D8052* _bangkovItemInfo; // 0x318
		::System::Collections::Generic::List_1<::Class_1_1685EC66FBD28897*>* _ItemDatas; // 0x320
