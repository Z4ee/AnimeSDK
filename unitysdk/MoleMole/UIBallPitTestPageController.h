...
#define MOLEMOLE_UIBALLPITTESTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x14BD9F40)
#define MOLEMOLE_UIBALLPITTESTPAGECONTROLLER_ONBALLPITLEVELFINISH_OFFSET UNITYSDK_OFFSET(0x14BDA340)
#define MOLEMOLE_UIBALLPITTESTPAGECONTROLLER_ONBALLPITWAVEINIT_OFFSET UNITYSDK_OFFSET(0x14BDA5F0)
#define MOLEMOLE_UIBALLPITTESTPAGECONTROLLER_ONBALLPITWAVEUPDATE_OFFSET UNITYSDK_OFFSET(0x14BDA390)
#define MOLEMOLE_UIBALLPITTESTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14BD9F50)
#define MOLEMOLE_UIBALLPITTESTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14BDA2D0)
#define MOLEMOLE_UIBALLPITTESTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14BD9FE0)
#define MOLEMOLE_UIBALLPITTESTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14BDA0F0)
#define MOLEMOLE_UIBALLPITTESTPAGECONTROLLER_SETWAVEIMAGE_OFFSET UNITYSDK_OFFSET(0x14BDA400)
#define MOLEMOLE_UIBALLPITTESTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14BDA940)
#define MOLEMOLE_UIBALLPITTESTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14BDA9E0)
#define MOLEMOLE_UIBALLPITTESTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14BDAA30)
#define MOLEMOLE_UIBALLPITTESTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14BDAA40)
#define MOLEMOLE_UIBALLPITTESTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14BDAA50)

namespace MoleMole
{
	inline static constexpr unsigned int UIBallPitTestPageController_TypeDefinitionIndex = 64123;

	class UIBallPitTestPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_22FEBBA7FA4D4D4A_6* _view; // 0x318
