...
#define MOLEMOLE_CONFIGVOICETOEVENT_TRYGETRULELIST_OFFSET UNITYSDK_OFFSET(0x181F0DD0)
#define MOLEMOLE_CONFIGVOICETOEVENT_TRYGETWWISEEVENT_OFFSET UNITYSDK_OFFSET(0x181F1040)
#define MOLEMOLE_CONFIGVOICETOEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x181F1310)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigVoiceToEvent_TypeDefinitionIndex = 54466;
