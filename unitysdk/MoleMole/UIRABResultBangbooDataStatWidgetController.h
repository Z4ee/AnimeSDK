...
#define MOLEMOLE_UIRABRESULTBANGBOODATASTATWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x152AA4F0)
#define MOLEMOLE_UIRABRESULTBANGBOODATASTATWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x152AA560)
#define MOLEMOLE_UIRABRESULTBANGBOODATASTATWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x152AA600)
#define MOLEMOLE_UIRABRESULTBANGBOODATASTATWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x152AA830)
#define MOLEMOLE_UIRABRESULTBANGBOODATASTATWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x152AA890)
#define MOLEMOLE_UIRABRESULTBANGBOODATASTATWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x152AA930)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABResultBangbooDataStatWidgetController_TypeDefinitionIndex = 82228;
