...
#define MOLEMOLE_UIHOLLOWCARDOPTIONSDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS24_0__CTOR_OFFSET UNITYSDK_OFFSET(0x164CB5A0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS24_0__INITCHOICEOBJ_B__0_OFFSET UNITYSDK_OFFSET(0x164CB5B0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS24_0__INITCHOICEOBJ_B__1_OFFSET UNITYSDK_OFFSET(0x164CB870)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS24_0__INITCHOICEOBJ_B__2_OFFSET UNITYSDK_OFFSET(0x164CB890)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS24_0__INITCHOICEOBJ_B__3_OFFSET UNITYSDK_OFFSET(0x164CB940)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCardOptionsDialogPopWindowController___c__DisplayClass24_0_TypeDefinitionIndex = 87599;
