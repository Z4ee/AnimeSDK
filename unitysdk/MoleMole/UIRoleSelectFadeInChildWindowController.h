...
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_ANIMATIONFINISH_OFFSET UNITYSDK_OFFSET(0x13813790)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x13813C70)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_GETCANVASINFO_OFFSET UNITYSDK_OFFSET(0x13813810)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_GETFADEININFO_OFFSET UNITYSDK_OFFSET(0x13813710)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x13812920)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_INITUIANIMATION_OFFSET UNITYSDK_OFFSET(0x13812D90)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x13812980)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x13812F70)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x13813B90)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x13813C20)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x13812930)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x13813B20)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x13813560)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_SETAVATARID_OFFSET UNITYSDK_OFFSET(0x138131D0)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_SETCOMPLETEACT_OFFSET UNITYSDK_OFFSET(0x13813130)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_SETELEMENTCOLOR_OFFSET UNITYSDK_OFFSET(0x13813260)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_SETMIRRORX_OFFSET UNITYSDK_OFFSET(0x138135B0)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_SETUISTOPACT_OFFSET UNITYSDK_OFFSET(0x13813180)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x13813000)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x13814290)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x138142A0)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x13814330)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x138143F0)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x13814400)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x13814410)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x138144A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleSelectFadeInChildWindowController_TypeDefinitionIndex = 85020;
	...
	public:
		...
		::Class_2_1C00730466C60BCB* _view; // 0x320
