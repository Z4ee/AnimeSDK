...
class Class_2_778D9E84A450E098;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }

#define MOLEMOLE_UIURBANMAPDISTRICTWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x13414480)
#define MOLEMOLE_UIURBANMAPDISTRICTWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x134144F0)
#define MOLEMOLE_UIURBANMAPDISTRICTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x134145B0)
#define MOLEMOLE_UIURBANMAPDISTRICTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x13414730)
#define MOLEMOLE_UIURBANMAPDISTRICTWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x13414790)
#define MOLEMOLE_UIURBANMAPDISTRICTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x13414830)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapDistrictWidgetController_TypeDefinitionIndex = 50166;
	...
	public:
		...
		::Class_2_778D9E84A450E098* get__viewModel()
		{
			return ((::Class_2_778D9E84A450E098*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIURBANMAPDISTRICTWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
