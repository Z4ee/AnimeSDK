...
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_CLEAN_OFFSET UNITYSDK_OFFSET(0x1841F300)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_GETANIMSCROLLSFORTAB_OFFSET UNITYSDK_OFFSET(0x1841E950)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_GETFIRSTINTERACTABLETAB_OFFSET UNITYSDK_OFFSET(0x1841D690)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_GETTACTICS_OFFSET UNITYSDK_OFFSET(0x1841E470)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x1841B210)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1841B220)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_INITTACTICSNODE_OFFSET UNITYSDK_OFFSET(0x1841CAC0)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_ISNEWBIERUNNINGANYPLATFORM_OFFSET UNITYSDK_OFFSET(0x1841F6D0)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_ISTABSELECTABLE_OFFSET UNITYSDK_OFFSET(0x1841F920)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_ISTABVISIBLE_OFFSET UNITYSDK_OFFSET(0x1841F750)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1841DF00)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_ONREQUIRECLOSEHANDBOOK_OFFSET UNITYSDK_OFFSET(0x1841E4C0)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1841CF20)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_ONTACTICSNODE_OFFSET UNITYSDK_OFFSET(0x1841F9C0)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1841DF90)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1841B230)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1841D080)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_OPENREWARDTAB_OFFSET UNITYSDK_OFFSET(0x1841D7D0)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_REFRESHCONSUMEPANELVISIBILITY_OFFSET UNITYSDK_OFFSET(0x1841F490)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_REFRESHLOCK_OFFSET UNITYSDK_OFFSET(0x1841C180)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_SETREWARDINPUTKEYHINT_OFFSET UNITYSDK_OFFSET(0x1841E380)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x1841E410)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_SHOWTAB_OFFSET UNITYSDK_OFFSET(0x1841EE70)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_TRYCLEANPREVTABNOTIFY_OFFSET UNITYSDK_OFFSET(0x1841E230)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18420000)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1841FEE0)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER__ONUIINIT_B__34_0_OFFSET UNITYSDK_OFFSET(0x18420210)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER__ONUIINIT_B__34_1_OFFSET UNITYSDK_OFFSET(0x18420220)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER__ONUIINIT_B__34_2_OFFSET UNITYSDK_OFFSET(0x18420230)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER__ONUIINIT_B__34_3_OFFSET UNITYSDK_OFFSET(0x18420240)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER__ONUIINIT_B__34_4_OFFSET UNITYSDK_OFFSET(0x18420250)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18420260)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x184202F0)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18420300)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18420310)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18420320)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x184203B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookPopWindowController_TypeDefinitionIndex = 85074;
	...
	public:
		...
		{
			return (::System::Collections::Generic::HashSet_1<::MoleMole::UIHandBookPopWindowController_EHandBookTab>**)Il2CppClass::FromTypeDefinitionIndex(UIHandBookPopWindowController_TypeDefinitionIndex)->GetStaticField(0x4EB60);
		}
		...
		// static const ::System::Int32 BangbooMicroWebNewbieId = 0x152; // 0x0
		// static const ::System::Int32 BangbooMicroWebNewbieConsoleId = 0x53A; // 0x0
		// static const ::System::Int32 BangbooMicroWebNewbiePcId = 0x922; // 0x0
		// static const ::System::Int32 HB_RAB_NEWBIE_ID = 0x139; // 0x0
		// static const ::System::Int32 HB_RAB_NEWBIE_PC_ID = 0x909; // 0x0
		// static const ::System::Int32 HB_RAB_NEWBIE_CONSOLE_ID = 0x521; // 0x0
		// static const ::System::Int32 HB_RECORD_ID_PROXY = 0x7; // 0x0
		// static const ::System::Int32 HB_RECORD_ID_DAILY = 0x8; // 0x0
		::Class_2_C7387D40D4120A48_9* _view; // 0x318
		...
		::System::Boolean IsTabVisible(::System::Int32 idx)
		{
			return ((::System::Boolean(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_ISTABVISIBLE_OFFSET))(this, idx);
		}

		::System::Boolean IsTabSelectable(::System::Int32 idx)
		{
			return ((::System::Boolean(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_ISTABSELECTABLE_OFFSET))(this, idx);
		}
		...
		::System::Void _OnUIInit_b__34_0()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER__ONUIINIT_B__34_0_OFFSET))(this);
		}

		::System::Void _OnUIInit_b__34_1()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER__ONUIINIT_B__34_1_OFFSET))(this);
		}

		::System::Void _OnUIInit_b__34_2()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER__ONUIINIT_B__34_2_OFFSET))(this);
		}

		::System::Void _OnUIInit_b__34_3()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER__ONUIINIT_B__34_3_OFFSET))(this);
		}

		::System::Void _OnUIInit_b__34_4()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER__ONUIINIT_B__34_4_OFFSET))(this);
		}
