...
#define MOLEMOLE_UIQUESTIONSLISTV4WIDGETCONTROLLER_ONSETCREATEFUNC_OFFSET UNITYSDK_OFFSET(0x17A16D00)
#define MOLEMOLE_UIQUESTIONSLISTV4WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17A16DC0)
#define MOLEMOLE_UIQUESTIONSLISTV4WIDGETCONTROLLER___BASE_ONSETCREATEFUNC_OFFSET UNITYSDK_OFFSET(0x17A16DD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsListV4WidgetController_TypeDefinitionIndex = 65156;
