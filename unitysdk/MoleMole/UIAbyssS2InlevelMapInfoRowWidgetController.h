...
#define MOLEMOLE_UIABYSSS2INLEVELMAPINFOROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x13ED5C30)
#define MOLEMOLE_UIABYSSS2INLEVELMAPINFOROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x13ED5CC0)
#define MOLEMOLE_UIABYSSS2INLEVELMAPINFOROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x13ED5B60)
#define MOLEMOLE_UIABYSSS2INLEVELMAPINFOROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x13ED5BC0)
#define MOLEMOLE_UIABYSSS2INLEVELMAPINFOROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x13ED5D40)
#define MOLEMOLE_UIABYSSS2INLEVELMAPINFOROWWIDGETCONTROLLER_SETCOLOR_1_OFFSET UNITYSDK_OFFSET(0x13ED5F70)
#define MOLEMOLE_UIABYSSS2INLEVELMAPINFOROWWIDGETCONTROLLER_SETCOLOR_OFFSET UNITYSDK_OFFSET(0x13ED5EA0)
#define MOLEMOLE_UIABYSSS2INLEVELMAPINFOROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x13ED6080)
#define MOLEMOLE_UIABYSSS2INLEVELMAPINFOROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x13ED60E0)
#define MOLEMOLE_UIABYSSS2INLEVELMAPINFOROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x13ED6170)
#define MOLEMOLE_UIABYSSS2INLEVELMAPINFOROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x13ED6200)
#define MOLEMOLE_UIABYSSS2INLEVELMAPINFOROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x13ED6290)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2InlevelMapInfoRowWidgetController_TypeDefinitionIndex = 58719;

	class UIAbyssS2InlevelMapInfoRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_7BEEB90214042948_2* _view; // 0x2B8
