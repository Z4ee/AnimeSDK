...
#define MOLEMOLE_UIRABLEVELENEMYROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16ECAA50)
#define MOLEMOLE_UIRABLEVELENEMYROWWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x16ECB050)
#define MOLEMOLE_UIRABLEVELENEMYROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16ECAAC0)
#define MOLEMOLE_UIRABLEVELENEMYROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16ECAB60)
#define MOLEMOLE_UIRABLEVELENEMYROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16ECADA0)
#define MOLEMOLE_UIRABLEVELENEMYROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x16ECAC20)
#define MOLEMOLE_UIRABLEVELENEMYROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16ECB0A0)
#define MOLEMOLE_UIRABLEVELENEMYROWWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x16ECB0B0)
#define MOLEMOLE_UIRABLEVELENEMYROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16ECB0C0)
#define MOLEMOLE_UIRABLEVELENEMYROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16ECB160)
#define MOLEMOLE_UIRABLEVELENEMYROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16ECB200)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABLevelEnemyRowWidgetController_TypeDefinitionIndex = 58827;
