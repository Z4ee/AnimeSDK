...
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERLEVELPOPWINDOWCONTROLLER___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0x166D13C0)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERLEVELPOPWINDOWCONTROLLER___C__DISPLAYCLASS7_0__INITINTERKNOTREWARDS_B__0_OFFSET UNITYSDK_OFFSET(0x166D13D0)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERLEVELPOPWINDOWCONTROLLER___C__DISPLAYCLASS7_0__INITINTERKNOTREWARDS_B__1_OFFSET UNITYSDK_OFFSET(0x166D13F0)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERLEVELPOPWINDOWCONTROLLER___C__DISPLAYCLASS7_0__INITINTERKNOTREWARDS_B__3_OFFSET UNITYSDK_OFFSET(0x166D1410)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERLEVELPOPWINDOWCONTROLLER___C__DISPLAYCLASS7_0__INITINTERKNOTREWARDS_B__4_OFFSET UNITYSDK_OFFSET(0x166D14A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendSystemPlayerLevelPopWindowController___c__DisplayClass7_0_TypeDefinitionIndex = 80981;
