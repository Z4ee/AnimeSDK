...
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERLEVELPOPWINDOWCONTROLLER___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1805BF50)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERLEVELPOPWINDOWCONTROLLER___C__DISPLAYCLASS7_0__INITINTERKNOTREWARDS_B__0_OFFSET UNITYSDK_OFFSET(0x1805BF60)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERLEVELPOPWINDOWCONTROLLER___C__DISPLAYCLASS7_0__INITINTERKNOTREWARDS_B__1_OFFSET UNITYSDK_OFFSET(0x1805BF80)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERLEVELPOPWINDOWCONTROLLER___C__DISPLAYCLASS7_0__INITINTERKNOTREWARDS_B__3_OFFSET UNITYSDK_OFFSET(0x1805BFA0)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERLEVELPOPWINDOWCONTROLLER___C__DISPLAYCLASS7_0__INITINTERKNOTREWARDS_B__4_OFFSET UNITYSDK_OFFSET(0x1805C030)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendSystemPlayerLevelPopWindowController___c__DisplayClass7_0_TypeDefinitionIndex = 81436;
