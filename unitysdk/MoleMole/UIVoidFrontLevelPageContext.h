...
#define MOLEMOLE_UIVOIDFRONTLEVELPAGECONTEXT_GENTONODEDETAILCONTEXT_OFFSET UNITYSDK_OFFSET(0x126ACFF0)
#define MOLEMOLE_UIVOIDFRONTLEVELPAGECONTEXT_GENTONODELISTCONTEXT_OFFSET UNITYSDK_OFFSET(0x126ACF50)
#define MOLEMOLE_UIVOIDFRONTLEVELPAGECONTEXT_RESETCONTEXT_OFFSET UNITYSDK_OFFSET(0x126ACF00)
#define MOLEMOLE_UIVOIDFRONTLEVELPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x126ACFE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVoidFrontLevelPageContext_TypeDefinitionIndex = 54225;
	...
	public:
		...
		::Enum_3_7A61FE75AFF4E240 difficulty; // 0x30
		::System::Int32 battleId; // 0x34
