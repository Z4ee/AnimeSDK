...
#define MOLEMOLE_TIMELINE_VIGNETTETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x190CBCB0)
#define MOLEMOLE_TIMELINE_VIGNETTETRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x190CBF60)
#define MOLEMOLE_TIMELINE_VIGNETTETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x190CBF00)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int VignetteTrack_TypeDefinitionIndex = 81075;
	...
	public:
		::System::Void _ctor()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_VIGNETTETRACK__CTOR_OFFSET))(this);
		}
