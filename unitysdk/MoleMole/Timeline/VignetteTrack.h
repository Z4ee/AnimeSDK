...
#define MOLEMOLE_TIMELINE_VIGNETTETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x17E05000)
#define MOLEMOLE_TIMELINE_VIGNETTETRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x17E052B0)
#define MOLEMOLE_TIMELINE_VIGNETTETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x17E05250)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int VignetteTrack_TypeDefinitionIndex = 64777;
