...
#define MOLEMOLE_TIMELINE_CHATPLUSDIALOGBEHAVIOUR_CLASS_1_F93C2B18E0102FFF_METHOD_1_01FAE893E5F900C6_OFFSET UNITYSDK_OFFSET(0x187183F0)
#define MOLEMOLE_TIMELINE_CHATPLUSDIALOGBEHAVIOUR_CLASS_1_F93C2B18E0102FFF_METHOD_1_19C80757D4D74851_OFFSET UNITYSDK_OFFSET(0x18718470)
#define MOLEMOLE_TIMELINE_CHATPLUSDIALOGBEHAVIOUR_CLASS_1_F93C2B18E0102FFF_METHOD_1_1FB70D28415DD975_OFFSET UNITYSDK_OFFSET(0x18718380)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ChatPlusDialogBehaviour_Class_1_F93C2B18E0102FFF_TypeDefinitionIndex = 53333;

	class ChatPlusDialogBehaviour_Class_1_F93C2B18E0102FFF : public ::System::Object
	{
	public:
		static ::MoleMole::Timeline::ChatPlusDialogBehaviour** StaticGet_Field_1_0()
		{
			return (::MoleMole::Timeline::ChatPlusDialogBehaviour**)Il2CppClass::FromTypeDefinitionIndex(ChatPlusDialogBehaviour_Class_1_F93C2B18E0102FFF_TypeDefinitionIndex)->GetStaticField(0x44F00);
		}
		static ::System::UInt32* StaticGet_Field_1_1()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(ChatPlusDialogBehaviour_Class_1_F93C2B18E0102FFF_TypeDefinitionIndex)->GetStaticField(0x10AD0);
		}
