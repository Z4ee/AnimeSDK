...
#define MOLEMOLE_TIMELINE_MONOCUTSCENETIMEPERIODCONTROL_GETCURTIMEOFDAY_OFFSET UNITYSDK_OFFSET(0x158637B0)
#define MOLEMOLE_TIMELINE_MONOCUTSCENETIMEPERIODCONTROL_ONACTIONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x15863760)
#define MOLEMOLE_TIMELINE_MONOCUTSCENETIMEPERIODCONTROL_TRYSWITCHTIME_OFFSET UNITYSDK_OFFSET(0x15863900)
#define MOLEMOLE_TIMELINE_MONOCUTSCENETIMEPERIODCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x15863F30)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MonoCutsceneTimePeriodControl_TypeDefinitionIndex = 62821;
