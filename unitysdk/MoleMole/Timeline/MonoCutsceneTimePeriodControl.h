...
#define MOLEMOLE_TIMELINE_MONOCUTSCENETIMEPERIODCONTROL_GETCURTIMEOFDAY_OFFSET UNITYSDK_OFFSET(0x180A6350)
#define MOLEMOLE_TIMELINE_MONOCUTSCENETIMEPERIODCONTROL_ONACTIONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x180A6300)
#define MOLEMOLE_TIMELINE_MONOCUTSCENETIMEPERIODCONTROL_TRYSWITCHTIME_OFFSET UNITYSDK_OFFSET(0x180A64B0)
#define MOLEMOLE_TIMELINE_MONOCUTSCENETIMEPERIODCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x180A6A90)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MonoCutsceneTimePeriodControl_TypeDefinitionIndex = 91588;
