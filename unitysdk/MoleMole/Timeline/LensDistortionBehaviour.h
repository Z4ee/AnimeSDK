...
#include "unitysdk/MoleMole/Timeline/LensDistortionBehaviour_Struct_2_52AD02145F5FCE36_5.h"
...
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x1A1BCFA0)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x1A1BD720)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x1A1BE6E0)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x1A1BE6B0)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x1A1BE6D0)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x1A1BE6C0)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_METHOD_4_E170F8E6C5ADD9FA_OFFSET UNITYSDK_OFFSET(0x1A1BD250)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1A1BD640)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1A1BE100)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1A1BE2F0)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1BE670)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int LensDistortionBehaviour_TypeDefinitionIndex = 45385;

	class LensDistortionBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::LensDistortionBehaviour_Struct_2_52AD02145F5FCE36_5 _methodParm; // 0x18
