...
#include "unitysdk/MoleMole/Timeline/LensDistortionBehaviour_Struct_2_52AD02145F5FCE36_18.h"
...
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x168A0490)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x168A0C10)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x168A1BA0)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x168A1B80)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x168A1BB0)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x168A1B90)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_METHOD_4_E170F8E6C5ADD9FA_OFFSET UNITYSDK_OFFSET(0x168A0740)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x168A0B30)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x168A15D0)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x168A17C0)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x168A1B40)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int LensDistortionBehaviour_TypeDefinitionIndex = 67758;

	class LensDistortionBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::LensDistortionBehaviour_Struct_2_52AD02145F5FCE36_18 _methodParm; // 0x18
