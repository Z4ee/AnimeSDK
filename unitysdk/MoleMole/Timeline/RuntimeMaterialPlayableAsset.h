...
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x191BE160)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x191BE150)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALPLAYABLEASSET_METHOD_4_19A05AA5B9E9DB20_OFFSET UNITYSDK_OFFSET(0x191BE0D0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALPLAYABLEASSET_METHOD_4_C433AF37CE9D6E5B_OFFSET UNITYSDK_OFFSET(0x191BE3D0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x191BE2B0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int RuntimeMaterialPlayableAsset_TypeDefinitionIndex = 49957;
