...
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B20C480)
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B20C470)
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B20C660)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int NapContactShadowClip_TypeDefinitionIndex = 45350;
