...
#define MOLEMOLE_TIMELINE_LOOPSUBDIVISIONDATAHOLDERCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1917EC00)
#define MOLEMOLE_TIMELINE_LOOPSUBDIVISIONDATAHOLDERCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1917EBF0)
#define MOLEMOLE_TIMELINE_LOOPSUBDIVISIONDATAHOLDERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1917EDC0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int LoopSubdivisionDataHolderClip_TypeDefinitionIndex = 78759;
