...
#define MOLEMOLE_TIMELINE_LOOPSUBDIVISIONDATAHOLDERCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x10E55DF0)
#define MOLEMOLE_TIMELINE_LOOPSUBDIVISIONDATAHOLDERCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x10E55DE0)
#define MOLEMOLE_TIMELINE_LOOPSUBDIVISIONDATAHOLDERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x10E55FB0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int LoopSubdivisionDataHolderClip_TypeDefinitionIndex = 55560;
