...
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_CHECKRENDERERMATERIALINDEX_OFFSET UNITYSDK_OFFSET(0x1E4B5FF0)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_GETALLRENDERERS_OFFSET UNITYSDK_OFFSET(0x1E4B65D0)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_GET_INSTANCEMATERIALS_OFFSET UNITYSDK_OFFSET(0x1E4B5DC0)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_GET_MATERIALINFODIC_OFFSET UNITYSDK_OFFSET(0x1E4B4DE0)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_INIT_OFFSET UNITYSDK_OFFSET(0x1E4B50F0)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_MATERIALCHANGED_OFFSET UNITYSDK_OFFSET(0x1E4B5470)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1E4B6B20)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1E4B6B10)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0x1E4B6990)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_ONPLAY_OFFSET UNITYSDK_OFFSET(0x1E4B65C0)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_ONPROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1E4B6B00)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_RECORDMESHRENDERS_OFFSET UNITYSDK_OFFSET(0x1E4B5B80)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_RECOVERINSTANCEMESHRENDERS_OFFSET UNITYSDK_OFFSET(0x1E4B6B30)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_RECOVERMESHRENDERS_OFFSET UNITYSDK_OFFSET(0x1E4B5890)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E4B6CE0)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4B6C60)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SceneMaterialRecorderBehavior_TypeDefinitionIndex = 32199;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::UnityEngine::GameObject*, ::Il2CppArray<::UnityEngine::Renderer*>*>**)Il2CppClass::FromTypeDefinitionIndex(SceneMaterialRecorderBehavior_TypeDefinitionIndex)->GetStaticField(0x26B10);
		}
