...
#define MOLEMOLE_TIMELINE_PERFORMNOTIFYMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1B20CF30)
#define MOLEMOLE_TIMELINE_PERFORMNOTIFYMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1B20CF70)
#define MOLEMOLE_TIMELINE_PERFORMNOTIFYMARKER_METHOD_4_567EC27AC5C589E5_OFFSET UNITYSDK_OFFSET(0x1B20CF80)
#define MOLEMOLE_TIMELINE_PERFORMNOTIFYMARKER_METHOD_4_AC0F8B3B35DDB97D_OFFSET UNITYSDK_OFFSET(0x1B20CC70)
#define MOLEMOLE_TIMELINE_PERFORMNOTIFYMARKER_METHOD_4_D78B51BFDA4B8B32_OFFSET UNITYSDK_OFFSET(0x1B20CD70)
#define MOLEMOLE_TIMELINE_PERFORMNOTIFYMARKER_METHOD_4_EC61203F1514A6AF_OFFSET UNITYSDK_OFFSET(0x1B20CE70)
#define MOLEMOLE_TIMELINE_PERFORMNOTIFYMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1B20CEE0)
#define MOLEMOLE_TIMELINE_PERFORMNOTIFYMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B20D010)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int PerformNotifyMarker_TypeDefinitionIndex = 45235;
