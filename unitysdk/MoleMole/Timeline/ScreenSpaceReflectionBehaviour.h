...
#include "unitysdk/MoleMole/Timeline/ScreenSpaceReflectionBehaviour_Struct_2_52AD02145F5FCE36_5.h"
...
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x168A2A30)
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x168A3170)
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x168A4260)
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x168A4270)
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONBEHAVIOUR_METHOD_4_A1D297DB1DC8C02B_OFFSET UNITYSDK_OFFSET(0x168A2CA0)
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x168A4250)
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x168A4240)
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x168A3090)
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x168A3C80)
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x168A3E70)
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x168A4210)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ScreenSpaceReflectionBehaviour_TypeDefinitionIndex = 47246;

	class ScreenSpaceReflectionBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::ScreenSpaceReflectionBehaviour_Struct_2_52AD02145F5FCE36_5 _methodParm; // 0x18
