...
#include "unitysdk/MoleMole/Timeline/ScreenSpaceReflectionBehaviour_Struct_2_52AD02145F5FCE36_43.h"
...
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x15BC8080)
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x15BC87C0)
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x15BC98E0)
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x15BC98C0)
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONBEHAVIOUR_METHOD_4_A1D297DB1DC8C02B_OFFSET UNITYSDK_OFFSET(0x15BC82F0)
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x15BC98F0)
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x15BC98D0)
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x15BC86E0)
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x15BC9300)
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x15BC94F0)
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x15BC9890)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ScreenSpaceReflectionBehaviour_TypeDefinitionIndex = 81490;

	class ScreenSpaceReflectionBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::ScreenSpaceReflectionBehaviour_Struct_2_52AD02145F5FCE36_43 _methodParm; // 0x18
