...
#define MOLEMOLE_TIMELINE_EDITOR_EDITORSUBTITLEOVERLAY_CLEARCONTENT_OFFSET UNITYSDK_OFFSET(0x1795D1F0)
#define MOLEMOLE_TIMELINE_EDITOR_EDITORSUBTITLEOVERLAY_GET_CURRENTPOSITION_OFFSET UNITYSDK_OFFSET(0x1795CCB0)
#define MOLEMOLE_TIMELINE_EDITOR_EDITORSUBTITLEOVERLAY_GET_CURRENTSPEAKER_OFFSET UNITYSDK_OFFSET(0x1795CC90)
#define MOLEMOLE_TIMELINE_EDITOR_EDITORSUBTITLEOVERLAY_GET_CURRENTSUBTITLE_OFFSET UNITYSDK_OFFSET(0x1795CC70)
#define MOLEMOLE_TIMELINE_EDITOR_EDITORSUBTITLEOVERLAY_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1795CC60)
#define MOLEMOLE_TIMELINE_EDITOR_EDITORSUBTITLEOVERLAY_GET_ISSHOWING_OFFSET UNITYSDK_OFFSET(0x1795CCD0)
#define MOLEMOLE_TIMELINE_EDITOR_EDITORSUBTITLEOVERLAY_METHOD_5_87318FF00D6BC7EB_OFFSET UNITYSDK_OFFSET(0x1795D840)
#define MOLEMOLE_TIMELINE_EDITOR_EDITORSUBTITLEOVERLAY_METHOD_5_8C97CA3BAB7FB2D7_OFFSET UNITYSDK_OFFSET(0x1795E000)
#define MOLEMOLE_TIMELINE_EDITOR_EDITORSUBTITLEOVERLAY_METHOD_5_9B9952A6A2080A5E_OFFSET UNITYSDK_OFFSET(0x1795EB20)
#define MOLEMOLE_TIMELINE_EDITOR_EDITORSUBTITLEOVERLAY_METHOD_5_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0x1795D000)
#define MOLEMOLE_TIMELINE_EDITOR_EDITORSUBTITLEOVERLAY_METHOD_5_E053C78196EC85C1_OFFSET UNITYSDK_OFFSET(0x1795DE90)
#define MOLEMOLE_TIMELINE_EDITOR_EDITORSUBTITLEOVERLAY_METHOD_5_E4ED84AD38043267_OFFSET UNITYSDK_OFFSET(0x1795E0B0)
#define MOLEMOLE_TIMELINE_EDITOR_EDITORSUBTITLEOVERLAY_METHOD_5_EBEDCF85ED8A64C5_OFFSET UNITYSDK_OFFSET(0x1795E820)
#define MOLEMOLE_TIMELINE_EDITOR_EDITORSUBTITLEOVERLAY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1795CF50)
#define MOLEMOLE_TIMELINE_EDITOR_EDITORSUBTITLEOVERLAY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1795CCF0)
#define MOLEMOLE_TIMELINE_EDITOR_EDITORSUBTITLEOVERLAY_ONGUI_OFFSET UNITYSDK_OFFSET(0x1795D250)
#define MOLEMOLE_TIMELINE_EDITOR_EDITORSUBTITLEOVERLAY_SET_CURRENTPOSITION_OFFSET UNITYSDK_OFFSET(0x1795CCC0)
#define MOLEMOLE_TIMELINE_EDITOR_EDITORSUBTITLEOVERLAY_SET_CURRENTSPEAKER_OFFSET UNITYSDK_OFFSET(0x1795CCA0)
#define MOLEMOLE_TIMELINE_EDITOR_EDITORSUBTITLEOVERLAY_SET_CURRENTSUBTITLE_OFFSET UNITYSDK_OFFSET(0x1795CC80)
#define MOLEMOLE_TIMELINE_EDITOR_EDITORSUBTITLEOVERLAY_SET_ISSHOWING_OFFSET UNITYSDK_OFFSET(0x1795CCE0)
#define MOLEMOLE_TIMELINE_EDITOR_EDITORSUBTITLEOVERLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1795E730)

namespace MoleMole::Timeline::Editor
{
	inline static constexpr unsigned int EditorSubtitleOverlay_TypeDefinitionIndex = 52013;

	class EditorSubtitleOverlay : public ::UnityEngine::MonoBehaviour
	{
	public:
		static ::MoleMole::Timeline::Editor::EditorSubtitleOverlay** StaticGet_Field_5_1()
		{
			return (::MoleMole::Timeline::Editor::EditorSubtitleOverlay**)Il2CppClass::FromTypeDefinitionIndex(EditorSubtitleOverlay_TypeDefinitionIndex)->GetStaticField(0x42870);
		}
		::System::String* Field_5_0; // 0x18
		::System::String* Field_5_7; // 0x20
		::System::Int32 Field_5_6; // 0x28
		::System::Boolean Field_5_5; // 0x2C
		...
		::UnityEngine::GUIStyle* Field_5_23; // 0x98
		::UnityEngine::GUIStyle* Field_5_22; // 0xA0
		::UnityEngine::Texture2D* Field_5_21; // 0xA8
		::UnityEngine::Color Field_5_20; // 0xB0
		::UnityEngine::Color Field_5_27; // 0xC0
		::UnityEngine::Color Field_5_26; // 0xD0
		::System::Int32 Field_5_25; // 0xE0
		::System::Int32 Field_5_24; // 0xE4
		::UnityEngine::Color Field_5_31; // 0xE8
		::System::Int32 Field_5_30; // 0xF8
		...
		static ::UnityEngine::Texture2D* Method_5_EBEDCF85ED8A64C5(::System::Int32 a1, ::System::Int32 a2, ::UnityEngine::Color a3)
		{
			return ((::UnityEngine::Texture2D*(*)(::System::Int32, ::System::Int32, ::UnityEngine::Color))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_EDITOR_EDITORSUBTITLEOVERLAY_METHOD_5_EBEDCF85ED8A64C5_OFFSET))(a1, a2, a3);
		}
		...
		::System::Void Method_5_E4ED84AD38043267(::UnityEngine::Rect a1, ::System::String* a2, ::UnityEngine::GUIStyle* a3, ::UnityEngine::Color a4)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Rect, ::System::String*, ::UnityEngine::GUIStyle*, ::UnityEngine::Color))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_EDITOR_EDITORSUBTITLEOVERLAY_METHOD_5_E4ED84AD38043267_OFFSET))(this, a1, a2, a3, a4);
		}
