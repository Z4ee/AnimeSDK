...
#define MOLEMOLE_TIMELINE_POSTPROCESSTRACK_METHOD_5_A88C36BE891242D7_OFFSET UNITYSDK_OFFSET(0x13EC56F0)
#define MOLEMOLE_TIMELINE_POSTPROCESSTRACK_METHOD_5_B9EC3F44C1BFC5EF_OFFSET UNITYSDK_OFFSET(0x13EC5670)
#define MOLEMOLE_TIMELINE_POSTPROCESSTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x13EC5610)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int PostProcessTrack_TypeDefinitionIndex = 68907;
