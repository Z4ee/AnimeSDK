...
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x17E02060)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_METHOD_4_581AA6833287C7E2_OFFSET UNITYSDK_OFFSET(0x17E01CA0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_METHOD_4_70589F89E4D22649_OFFSET UNITYSDK_OFFSET(0x17E01B80)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_METHOD_4_79ED6854413CA2F4_1_OFFSET UNITYSDK_OFFSET(0x17E01F40)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_METHOD_4_79ED6854413CA2F4_2_OFFSET UNITYSDK_OFFSET(0x17E02070)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_METHOD_4_79ED6854413CA2F4_OFFSET UNITYSDK_OFFSET(0x17E01B60)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_METHOD_4_94C26E8746F69EE8_OFFSET UNITYSDK_OFFSET(0x17E010C0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_METHOD_4_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0x17E01F50)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_METHOD_4_CCD88C0D86A5A786_OFFSET UNITYSDK_OFFSET(0x17E00CD0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_METHOD_4_E5E342154D4EA5F5_OFFSET UNITYSDK_OFFSET(0x17E01B70)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x17E01470)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x17E00A50)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x17E01900)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_PREPAREDATA_OFFSET UNITYSDK_OFFSET(0x17E009D0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x17E01110)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR__CCTOR_OFFSET UNITYSDK_OFFSET(0x17E01AC0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x17E01AB0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TVTextureSequenceGroupBehaviour_TypeDefinitionIndex = 73422;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::List_1<::UnityEngine::Texture2D*>*>**)Il2CppClass::FromTypeDefinitionIndex(TVTextureSequenceGroupBehaviour_TypeDefinitionIndex)->GetStaticField(0x4BF30);
		}
