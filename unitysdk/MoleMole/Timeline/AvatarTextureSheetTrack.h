...
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x145096A0)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETTRACK_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x14509B70)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETTRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x14509BE0)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x14509B80)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int AvatarTextureSheetTrack_TypeDefinitionIndex = 54386;
