...
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x170408D0)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETTRACK_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x17040DA0)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETTRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x17040E10)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x17040DB0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int AvatarTextureSheetTrack_TypeDefinitionIndex = 47441;
