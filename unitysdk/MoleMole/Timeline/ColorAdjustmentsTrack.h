...
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x180A29A0)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSTRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x180A2C50)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x180A2BF0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ColorAdjustmentsTrack_TypeDefinitionIndex = 40886;
