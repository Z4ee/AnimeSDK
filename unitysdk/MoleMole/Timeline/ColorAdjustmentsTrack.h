...
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x15860110)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSTRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x158603C0)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x15860360)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ColorAdjustmentsTrack_TypeDefinitionIndex = 38721;
