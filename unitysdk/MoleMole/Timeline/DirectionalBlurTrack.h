...
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x18718F60)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURTRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x18719210)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x187191B0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int DirectionalBlurTrack_TypeDefinitionIndex = 47248;
