...
#define MOLEMOLE_TIMELINE_TVTEXTURESHEETCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x129E8B90)
#define MOLEMOLE_TIMELINE_TVTEXTURESHEETCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x129E8B80)
#define MOLEMOLE_TIMELINE_TVTEXTURESHEETCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x129E8D70)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TVTextureSheetClip_TypeDefinitionIndex = 80354;
