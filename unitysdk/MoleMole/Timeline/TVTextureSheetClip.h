...
#define MOLEMOLE_TIMELINE_TVTEXTURESHEETCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1740BD10)
#define MOLEMOLE_TIMELINE_TVTEXTURESHEETCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1740BD00)
#define MOLEMOLE_TIMELINE_TVTEXTURESHEETCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1740BEF0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TVTextureSheetClip_TypeDefinitionIndex = 65913;
