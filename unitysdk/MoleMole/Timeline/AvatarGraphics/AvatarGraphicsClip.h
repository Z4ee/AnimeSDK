...
#define MOLEMOLE_TIMELINE_AVATARGRAPHICS_AVATARGRAPHICSCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x12BE1A70)
#define MOLEMOLE_TIMELINE_AVATARGRAPHICS_AVATARGRAPHICSCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x12BE1A60)
#define MOLEMOLE_TIMELINE_AVATARGRAPHICS_AVATARGRAPHICSCLIP_METHOD_4_DF8DA585FF3B5AEC_OFFSET UNITYSDK_OFFSET(0x12BE1C50)
#define MOLEMOLE_TIMELINE_AVATARGRAPHICS_AVATARGRAPHICSCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x12BE1BC0)

namespace MoleMole::Timeline::AvatarGraphics
{
	inline static constexpr unsigned int AvatarGraphicsClip_TypeDefinitionIndex = 77934;
