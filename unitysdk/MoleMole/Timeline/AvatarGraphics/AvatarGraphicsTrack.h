...
#define MOLEMOLE_TIMELINE_AVATARGRAPHICS_AVATARGRAPHICSTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x117835D0)
#define MOLEMOLE_TIMELINE_AVATARGRAPHICS_AVATARGRAPHICSTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x11783820)
#define MOLEMOLE_TIMELINE_AVATARGRAPHICS_AVATARGRAPHICSTRACK_METHOD_5_652F102150AC9967_OFFSET UNITYSDK_OFFSET(0x117839E0)
#define MOLEMOLE_TIMELINE_AVATARGRAPHICS_AVATARGRAPHICSTRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x11783A20)
#define MOLEMOLE_TIMELINE_AVATARGRAPHICS_AVATARGRAPHICSTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x11783980)

namespace MoleMole::Timeline::AvatarGraphics
{
	inline static constexpr unsigned int AvatarGraphicsTrack_TypeDefinitionIndex = 58457;
