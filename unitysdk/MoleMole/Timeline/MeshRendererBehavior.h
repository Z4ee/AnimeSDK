...
#define MOLEMOLE_TIMELINE_MESHRENDERERBEHAVIOR_INITDATA_OFFSET UNITYSDK_OFFSET(0x1C16BFF0)
#define MOLEMOLE_TIMELINE_MESHRENDERERBEHAVIOR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1C16C580)
#define MOLEMOLE_TIMELINE_MESHRENDERERBEHAVIOR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1C16C310)
#define MOLEMOLE_TIMELINE_MESHRENDERERBEHAVIOR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1C16C6A0)
#define MOLEMOLE_TIMELINE_MESHRENDERERBEHAVIOR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1C16C440)
#define MOLEMOLE_TIMELINE_MESHRENDERERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C16C7C0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MeshRendererBehavior_TypeDefinitionIndex = 30663;
