...
#define MOLEMOLE_TIMELINE_VREFFECTSTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x16439820)
#define MOLEMOLE_TIMELINE_VREFFECTSTRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x16439AD0)
#define MOLEMOLE_TIMELINE_VREFFECTSTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x16439A70)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int VREffectsTrack_TypeDefinitionIndex = 66428;
