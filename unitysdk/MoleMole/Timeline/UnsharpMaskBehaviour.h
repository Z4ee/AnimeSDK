...
#include "unitysdk/MoleMole/Timeline/UnsharpMaskBehaviour_Struct_2_52AD02145F5FCE36_43.h"
...
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x17E035A0)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_METHOD_4_12EA49035F00FC4D_OFFSET UNITYSDK_OFFSET(0x17E037F0)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x17E03CB0)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x17E04D00)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x17E04D30)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x17E04D20)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x17E04D10)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x17E03BE0)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x17E04790)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x17E04970)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x17E04CE0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int UnsharpMaskBehaviour_TypeDefinitionIndex = 87422;

	class UnsharpMaskBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::UnsharpMaskBehaviour_Struct_2_52AD02145F5FCE36_43 _methodParm; // 0x18
