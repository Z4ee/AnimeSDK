...
#define MOLEMOLE_TIMELINE_ACTIVEEXTERNALBEHAVIOUR_METHOD_2_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x160F1CC0)
#define MOLEMOLE_TIMELINE_ACTIVEEXTERNALBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0x160F1C50)
#define MOLEMOLE_TIMELINE_ACTIVEEXTERNALBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x160F1CA0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ActiveExternalBehaviour_TypeDefinitionIndex = 79420;
