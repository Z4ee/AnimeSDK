...
#define MOLEMOLE_TIMELINE_IKBINDTARGETCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x173B9900)
#define MOLEMOLE_TIMELINE_IKBINDTARGETCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x173B98F0)
#define MOLEMOLE_TIMELINE_IKBINDTARGETCLIP_METHOD_4_ADAAD18C696D4E4D_OFFSET UNITYSDK_OFFSET(0x173B9B60)
#define MOLEMOLE_TIMELINE_IKBINDTARGETCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x173B9B00)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int IKBindTargetClip_TypeDefinitionIndex = 60183;
