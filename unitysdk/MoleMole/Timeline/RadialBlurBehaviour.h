...
#include "unitysdk/MoleMole/Timeline/RadialBlurBehaviour_Struct_2_52AD02145F5FCE36_35.h"
...
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x167BEE40)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x167C1FA0)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x167C1F90)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_METHOD_4_7B8EE725A8526397_OFFSET UNITYSDK_OFFSET(0x167BF2D0)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_METHOD_4_8DC55F996A78F0A1_OFFSET UNITYSDK_OFFSET(0x167BF8D0)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x167C1F80)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x167C1F70)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x167BF6C0)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x167C1460)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x167C1780)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x167C1EA0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int RadialBlurBehaviour_TypeDefinitionIndex = 74209;

	class RadialBlurBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::RadialBlurBehaviour_Struct_2_52AD02145F5FCE36_35 _methodParm; // 0x18
