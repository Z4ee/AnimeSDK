...
#include "unitysdk/MoleMole/Timeline/RadialBlurBehaviour_Struct_2_52AD02145F5FCE36_7.h"
...
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x17963340)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x18DEA690)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x18DEA680)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x18DEA650)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_METHOD_4_7B8EE725A8526397_OFFSET UNITYSDK_OFFSET(0x18DEC220)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x18DEA670)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x18DEA660)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x179637D0)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x179639E0)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x18DE9E60)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x18DEA580)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int RadialBlurBehaviour_TypeDefinitionIndex = 50802;

	class RadialBlurBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::RadialBlurBehaviour_Struct_2_52AD02145F5FCE36_7 _methodParm; // 0x18
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET))(this);
		}
