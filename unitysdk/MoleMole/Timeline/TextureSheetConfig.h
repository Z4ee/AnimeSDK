...
#define MOLEMOLE_TIMELINE_TEXTURESHEETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5F2810)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TextureSheetConfig_TypeDefinitionIndex = 43059;
