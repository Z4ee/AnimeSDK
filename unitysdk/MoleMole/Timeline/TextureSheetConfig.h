...
#define MOLEMOLE_TIMELINE_TEXTURESHEETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x13F33000)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TextureSheetConfig_TypeDefinitionIndex = 44064;
