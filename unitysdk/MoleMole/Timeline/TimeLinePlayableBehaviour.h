...
#define MOLEMOLE_TIMELINE_TIMELINEPLAYABLEBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x1F112640)
#define MOLEMOLE_TIMELINE_TIMELINEPLAYABLEBEHAVIOUR_GET_DONTRESETACTIVE_OFFSET UNITYSDK_OFFSET(0x1F1125F0)
#define MOLEMOLE_TIMELINE_TIMELINEPLAYABLEBEHAVIOUR_GET_DONTRESETWHENDESTROY_OFFSET UNITYSDK_OFFSET(0x1F1125D0)
#define MOLEMOLE_TIMELINE_TIMELINEPLAYABLEBEHAVIOUR_GET_STOPPLAYABLEBEHAVIOUR_OFFSET UNITYSDK_OFFSET(0x1F1125E0)
#define MOLEMOLE_TIMELINE_TIMELINEPLAYABLEBEHAVIOUR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1F112620)
#define MOLEMOLE_TIMELINE_TIMELINEPLAYABLEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1F112630)
#define MOLEMOLE_TIMELINE_TIMELINEPLAYABLEBEHAVIOUR_SETTIMELINEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1F112600)
#define MOLEMOLE_TIMELINE_TIMELINEPLAYABLEBEHAVIOUR_SETVALUE_1_OFFSET UNITYSDK_OFFSET(0x1F112770)
#define MOLEMOLE_TIMELINE_TIMELINEPLAYABLEBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1F112650)
#define MOLEMOLE_TIMELINE_TIMELINEPLAYABLEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1F112780)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TimeLinePlayableBehaviour_TypeDefinitionIndex = 32785;
