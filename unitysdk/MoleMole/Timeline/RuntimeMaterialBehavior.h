...
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALBEHAVIOR_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x12FBF380)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALBEHAVIOR_GET_REFERENCETARGET_OFFSET UNITYSDK_OFFSET(0x12FBF440)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALBEHAVIOR_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x12FBF2C0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALBEHAVIOR_METHOD_3_1F2E3BA521ACDDA9_OFFSET UNITYSDK_OFFSET(0x12FC0D50)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALBEHAVIOR_METHOD_3_324AEE341AAA7A1B_1_OFFSET UNITYSDK_OFFSET(0x12FC09A0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALBEHAVIOR_METHOD_3_324AEE341AAA7A1B_2_OFFSET UNITYSDK_OFFSET(0x12FC0D40)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALBEHAVIOR_METHOD_3_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x12FC0770)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALBEHAVIOR_METHOD_3_3C029C534AE1FB6B_OFFSET UNITYSDK_OFFSET(0x12FC0790)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALBEHAVIOR_METHOD_3_4A57793288C41D3F_OFFSET UNITYSDK_OFFSET(0x12FBFD10)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALBEHAVIOR_METHOD_3_7F5959D5B740D04C_OFFSET UNITYSDK_OFFSET(0x12FBFA50)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALBEHAVIOR_METHOD_3_832295EC279E5994_1_OFFSET UNITYSDK_OFFSET(0x12FC0780)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALBEHAVIOR_METHOD_3_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x12FC0750)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALBEHAVIOR_METHOD_3_931BBBB6FD587723_OFFSET UNITYSDK_OFFSET(0x12FBF8F0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALBEHAVIOR_METHOD_3_ABFF7E45AF55C372_OFFSET UNITYSDK_OFFSET(0x12FC09B0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALBEHAVIOR_METHOD_3_C0C55A50D445828C_OFFSET UNITYSDK_OFFSET(0x12FC0450)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALBEHAVIOR_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x12FBF8B0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALBEHAVIOR_METHOD_3_EB4AEB5445AFFDCA_OFFSET UNITYSDK_OFFSET(0x12FC1060)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALBEHAVIOR_METHOD_3_ECD7C40F3C2E43AC_OFFSET UNITYSDK_OFFSET(0x12FC0010)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALBEHAVIOR_METHOD_3_ED01C45E2F8DB392_OFFSET UNITYSDK_OFFSET(0x12FC0760)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALBEHAVIOR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0x12FBF730)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALBEHAVIOR_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x12FBF7E0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALBEHAVIOR_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0x12FBF6E0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALBEHAVIOR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x12FBF840)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALBEHAVIOR_ONPLAY_OFFSET UNITYSDK_OFFSET(0x12FBF780)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALBEHAVIOR_ONPROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x12FBF460)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALBEHAVIOR_SET_REFERENCETARGET_OFFSET UNITYSDK_OFFSET(0x12FBF450)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x12FBFC90)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int RuntimeMaterialBehavior_TypeDefinitionIndex = 79224;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_RUNTIMEMATERIALBEHAVIOR_METHOD_3_3C029C534AE1FB6B_OFFSET))(this);
		}
