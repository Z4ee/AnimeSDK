...
#define MOLEMOLE_TIMELINE_AUTOEXPOSURETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1795C630)
#define MOLEMOLE_TIMELINE_AUTOEXPOSURETRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x1795C8E0)
#define MOLEMOLE_TIMELINE_AUTOEXPOSURETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1795C880)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int AutoExposureTrack_TypeDefinitionIndex = 53830;
