...
#define MOLEMOLE_TIMELINE_BASETIMELINE_BASETIMELINEBEHAVIOR_BASEONPAUSE_OFFSET UNITYSDK_OFFSET(0x1BFA51E0)
#define MOLEMOLE_TIMELINE_BASETIMELINE_BASETIMELINEBEHAVIOR_BASEONPLAY_OFFSET UNITYSDK_OFFSET(0x1BFA51C0)
#define MOLEMOLE_TIMELINE_BASETIMELINE_BASETIMELINEBEHAVIOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1BFA5230)
#define MOLEMOLE_TIMELINE_BASETIMELINE_BASETIMELINEBEHAVIOR_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1BFA5210)
#define MOLEMOLE_TIMELINE_BASETIMELINE_BASETIMELINEBEHAVIOR_ONPLAY_OFFSET UNITYSDK_OFFSET(0x1BFA5200)
#define MOLEMOLE_TIMELINE_BASETIMELINE_BASETIMELINEBEHAVIOR_ONPROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1BFA5220)
#define MOLEMOLE_TIMELINE_BASETIMELINE_BASETIMELINEBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFA5240)

namespace MoleMole::Timeline::BaseTimeline
{
	inline static constexpr unsigned int BaseTimelineBehavior_TypeDefinitionIndex = 30686;
