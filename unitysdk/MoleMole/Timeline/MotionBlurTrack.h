...
#define MOLEMOLE_TIMELINE_MOTIONBLURTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x183A2F60)
#define MOLEMOLE_TIMELINE_MOTIONBLURTRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x183A3210)
#define MOLEMOLE_TIMELINE_MOTIONBLURTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x183A31B0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MotionBlurTrack_TypeDefinitionIndex = 77389;
