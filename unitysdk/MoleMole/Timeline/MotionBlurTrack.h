...
#define MOLEMOLE_TIMELINE_MOTIONBLURTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x11D7B900)
#define MOLEMOLE_TIMELINE_MOTIONBLURTRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x11D7BBB0)
#define MOLEMOLE_TIMELINE_MOTIONBLURTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x11D7BB50)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MotionBlurTrack_TypeDefinitionIndex = 90939;
