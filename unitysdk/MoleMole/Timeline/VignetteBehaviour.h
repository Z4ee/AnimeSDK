...
#include "unitysdk/MoleMole/Timeline/VignetteBehaviour_Struct_2_52AD02145F5FCE36_25.h"
...
#define MOLEMOLE_TIMELINE_VIGNETTEBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x141BBB30)
#define MOLEMOLE_TIMELINE_VIGNETTEBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x141BC250)
#define MOLEMOLE_TIMELINE_VIGNETTEBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x141BD170)
#define MOLEMOLE_TIMELINE_VIGNETTEBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x141BD190)
#define MOLEMOLE_TIMELINE_VIGNETTEBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x141BD1A0)
#define MOLEMOLE_TIMELINE_VIGNETTEBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x141BD180)
#define MOLEMOLE_TIMELINE_VIGNETTEBEHAVIOUR_METHOD_4_C94BFD63C57EEA33_OFFSET UNITYSDK_OFFSET(0x141BBD90)
#define MOLEMOLE_TIMELINE_VIGNETTEBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x141BC180)
#define MOLEMOLE_TIMELINE_VIGNETTEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x141BCBB0)
#define MOLEMOLE_TIMELINE_VIGNETTEBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x141BCD90)
#define MOLEMOLE_TIMELINE_VIGNETTEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x141BD130)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int VignetteBehaviour_TypeDefinitionIndex = 64692;

	class VignetteBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::VignetteBehaviour_Struct_2_52AD02145F5FCE36_25 _methodParm; // 0x18
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_VIGNETTEBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET))(this);
		}
		...
		::UnityEngine::Rendering::Universal::Vignette* Method_4_C94BFD63C57EEA33(::System::Object* a1)
		{
			return ((::UnityEngine::Rendering::Universal::Vignette*(*)(::PVOID, ::System::Object*))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_VIGNETTEBEHAVIOUR_METHOD_4_C94BFD63C57EEA33_OFFSET))(this, a1);
		}
