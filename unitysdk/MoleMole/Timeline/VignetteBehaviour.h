...
#include "unitysdk/MoleMole/Timeline/VignetteBehaviour_Struct_2_52AD02145F5FCE36_6.h"
...
#define MOLEMOLE_TIMELINE_VIGNETTEBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x19797300)
#define MOLEMOLE_TIMELINE_VIGNETTEBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x19797A20)
#define MOLEMOLE_TIMELINE_VIGNETTEBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x19798930)
#define MOLEMOLE_TIMELINE_VIGNETTEBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x19798920)
#define MOLEMOLE_TIMELINE_VIGNETTEBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x19798950)
#define MOLEMOLE_TIMELINE_VIGNETTEBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x19798940)
#define MOLEMOLE_TIMELINE_VIGNETTEBEHAVIOUR_METHOD_4_C94BFD63C57EEA33_OFFSET UNITYSDK_OFFSET(0x19797560)
#define MOLEMOLE_TIMELINE_VIGNETTEBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x19797950)
#define MOLEMOLE_TIMELINE_VIGNETTEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x19798360)
#define MOLEMOLE_TIMELINE_VIGNETTEBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x19798540)
#define MOLEMOLE_TIMELINE_VIGNETTEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x197988E0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int VignetteBehaviour_TypeDefinitionIndex = 48053;

	class VignetteBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::VignetteBehaviour_Struct_2_52AD02145F5FCE36_6 _methodParm; // 0x18
