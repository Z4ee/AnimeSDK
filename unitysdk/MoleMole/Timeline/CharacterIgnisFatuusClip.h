...
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x13879BE0)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x13879BD0)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x13879DC0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int CharacterIgnisFatuusClip_TypeDefinitionIndex = 48863;
