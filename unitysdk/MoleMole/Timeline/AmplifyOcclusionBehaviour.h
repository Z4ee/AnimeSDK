...
#include "unitysdk/MoleMole/Timeline/AmplifyOcclusionBehaviour_Struct_2_52AD02145F5FCE36_40.h"
...
#define MOLEMOLE_TIMELINE_AMPLIFYOCCLUSIONBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x18914D60)
#define MOLEMOLE_TIMELINE_AMPLIFYOCCLUSIONBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x18915760)
#define MOLEMOLE_TIMELINE_AMPLIFYOCCLUSIONBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x18917A40)
#define MOLEMOLE_TIMELINE_AMPLIFYOCCLUSIONBEHAVIOUR_METHOD_4_598135D05796BD05_OFFSET UNITYSDK_OFFSET(0x18915190)
#define MOLEMOLE_TIMELINE_AMPLIFYOCCLUSIONBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x18917A50)
#define MOLEMOLE_TIMELINE_AMPLIFYOCCLUSIONBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x18917A70)
#define MOLEMOLE_TIMELINE_AMPLIFYOCCLUSIONBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x18917A60)
#define MOLEMOLE_TIMELINE_AMPLIFYOCCLUSIONBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x18915580)
#define MOLEMOLE_TIMELINE_AMPLIFYOCCLUSIONBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x18916FE0)
#define MOLEMOLE_TIMELINE_AMPLIFYOCCLUSIONBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x189172E0)
#define MOLEMOLE_TIMELINE_AMPLIFYOCCLUSIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x189179A0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int AmplifyOcclusionBehaviour_TypeDefinitionIndex = 89055;

	class AmplifyOcclusionBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::AmplifyOcclusionBehaviour_Struct_2_52AD02145F5FCE36_40 _methodParm; // 0x18
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_AMPLIFYOCCLUSIONBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET))(this);
		}
	};
}
