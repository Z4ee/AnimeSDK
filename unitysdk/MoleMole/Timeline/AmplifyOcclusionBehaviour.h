...
#include "unitysdk/MoleMole/Timeline/AmplifyOcclusionBehaviour_Struct_2_52AD02145F5FCE36_21.h"
...
#define MOLEMOLE_TIMELINE_AMPLIFYOCCLUSIONBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x1265C530)
#define MOLEMOLE_TIMELINE_AMPLIFYOCCLUSIONBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x1265F270)
#define MOLEMOLE_TIMELINE_AMPLIFYOCCLUSIONBEHAVIOUR_METHOD_4_598135D05796BD05_OFFSET UNITYSDK_OFFSET(0x1265C960)
#define MOLEMOLE_TIMELINE_AMPLIFYOCCLUSIONBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x1265F250)
#define MOLEMOLE_TIMELINE_AMPLIFYOCCLUSIONBEHAVIOUR_METHOD_4_8DC55F996A78F0A1_OFFSET UNITYSDK_OFFSET(0x1265CF30)
#define MOLEMOLE_TIMELINE_AMPLIFYOCCLUSIONBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x1265F280)
#define MOLEMOLE_TIMELINE_AMPLIFYOCCLUSIONBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x1265F260)
#define MOLEMOLE_TIMELINE_AMPLIFYOCCLUSIONBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1265CD50)
#define MOLEMOLE_TIMELINE_AMPLIFYOCCLUSIONBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1265E7F0)
#define MOLEMOLE_TIMELINE_AMPLIFYOCCLUSIONBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1265EAF0)
#define MOLEMOLE_TIMELINE_AMPLIFYOCCLUSIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1265F1B0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int AmplifyOcclusionBehaviour_TypeDefinitionIndex = 61904;

	class AmplifyOcclusionBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::AmplifyOcclusionBehaviour_Struct_2_52AD02145F5FCE36_21 _methodParm; // 0x18
