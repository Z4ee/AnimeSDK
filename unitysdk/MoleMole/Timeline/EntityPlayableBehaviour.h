...
#define MOLEMOLE_TIMELINE_ENTITYPLAYABLEBEHAVIOUR_METHOD_2_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x1839D8B0)
#define MOLEMOLE_TIMELINE_ENTITYPLAYABLEBEHAVIOUR_METHOD_2_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x1839DBB0)
#define MOLEMOLE_TIMELINE_ENTITYPLAYABLEBEHAVIOUR_METHOD_2_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x1839DAA0)
#define MOLEMOLE_TIMELINE_ENTITYPLAYABLEBEHAVIOUR_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1839D700)
#define MOLEMOLE_TIMELINE_ENTITYPLAYABLEBEHAVIOUR_METHOD_2_79ED6854413CA2F4_1_OFFSET UNITYSDK_OFFSET(0x1839DBD0)
#define MOLEMOLE_TIMELINE_ENTITYPLAYABLEBEHAVIOUR_METHOD_2_79ED6854413CA2F4_OFFSET UNITYSDK_OFFSET(0x1839DBC0)
#define MOLEMOLE_TIMELINE_ENTITYPLAYABLEBEHAVIOUR_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x1839D530)
#define MOLEMOLE_TIMELINE_ENTITYPLAYABLEBEHAVIOUR_METHOD_2_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x1839D570)
#define MOLEMOLE_TIMELINE_ENTITYPLAYABLEBEHAVIOUR_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1839D4F0)
#define MOLEMOLE_TIMELINE_ENTITYPLAYABLEBEHAVIOUR_METHOD_2_E5E342154D4EA5F5_OFFSET UNITYSDK_OFFSET(0x1839DBA0)
#define MOLEMOLE_TIMELINE_ENTITYPLAYABLEBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1839D630)
#define MOLEMOLE_TIMELINE_ENTITYPLAYABLEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1839D5B0)
#define MOLEMOLE_TIMELINE_ENTITYPLAYABLEBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1839DB40)
#define MOLEMOLE_TIMELINE_ENTITYPLAYABLEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1839D760)
#define MOLEMOLE_TIMELINE_ENTITYPLAYABLEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1839DB90)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int EntityPlayableBehaviour_TypeDefinitionIndex = 47066;
