...
#define MOLEMOLE_TIMELINE_CHARACTERMATERIALTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x17DF27E0)
#define MOLEMOLE_TIMELINE_CHARACTERMATERIALTRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x17DF2DC0)
#define MOLEMOLE_TIMELINE_CHARACTERMATERIALTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x17DF2D60)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int CharacterMaterialTrack_TypeDefinitionIndex = 72406;
