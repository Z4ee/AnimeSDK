...
#include "unitysdk/MoleMole/Timeline/DepthOfFieldBehaviour_Struct_2_52AD02145F5FCE36_23.h"
...
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x152AEAF0)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_METHOD_4_236B13DADDAA2EAD_OFFSET UNITYSDK_OFFSET(0x152AEEE0)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x152B1510)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x152B1500)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_METHOD_4_8DC55F996A78F0A1_OFFSET UNITYSDK_OFFSET(0x152AF490)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x152B1520)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x152B14F0)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x152AF2D0)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x152B0B50)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x152B0E20)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x152B1430)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int DepthOfFieldBehaviour_TypeDefinitionIndex = 60322;

	class DepthOfFieldBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::DepthOfFieldBehaviour_Struct_2_52AD02145F5FCE36_23 _methodParm; // 0x18
