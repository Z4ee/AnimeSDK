...
#include "unitysdk/MoleMole/Timeline/DepthOfFieldBehaviour_Struct_2_52AD02145F5FCE36_20.h"
...
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x173AC950)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x173AD2F0)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_METHOD_4_236B13DADDAA2EAD_OFFSET UNITYSDK_OFFSET(0x173ACD40)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x173AF340)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x173AF310)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x173AF330)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x173AF320)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x173AD130)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x173AE970)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x173AEC40)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x173AF250)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int DepthOfFieldBehaviour_TypeDefinitionIndex = 68460;

	class DepthOfFieldBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::DepthOfFieldBehaviour_Struct_2_52AD02145F5FCE36_20 _methodParm; // 0x18
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET))(this);
		}
