...
#define MOLEMOLE_TIMELINE_LIGHTCOMPBEHAVIOUR_METHOD_2_478A02E8B590B953_OFFSET UNITYSDK_OFFSET(0x1A1BEC90)
#define MOLEMOLE_TIMELINE_LIGHTCOMPBEHAVIOUR_METHOD_2_79ED6854413CA2F4_1_OFFSET UNITYSDK_OFFSET(0x1A1BEC80)
#define MOLEMOLE_TIMELINE_LIGHTCOMPBEHAVIOUR_METHOD_2_79ED6854413CA2F4_2_OFFSET UNITYSDK_OFFSET(0x1A1BEDC0)
#define MOLEMOLE_TIMELINE_LIGHTCOMPBEHAVIOUR_METHOD_2_79ED6854413CA2F4_OFFSET UNITYSDK_OFFSET(0x1A1BEC70)
#define MOLEMOLE_TIMELINE_LIGHTCOMPBEHAVIOUR_METHOD_2_E5E342154D4EA5F5_OFFSET UNITYSDK_OFFSET(0x1A1BEDD0)
#define MOLEMOLE_TIMELINE_LIGHTCOMPBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1A1BEB80)
#define MOLEMOLE_TIMELINE_LIGHTCOMPBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1A1BE9A0)
#define MOLEMOLE_TIMELINE_LIGHTCOMPBEHAVIOUR_PREPAREFRAME_OFFSET UNITYSDK_OFFSET(0x1A1BEB00)
#define MOLEMOLE_TIMELINE_LIGHTCOMPBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1A1BEA40)
#define MOLEMOLE_TIMELINE_LIGHTCOMPBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1BEC20)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int LightCompBehaviour_TypeDefinitionIndex = 69087;
