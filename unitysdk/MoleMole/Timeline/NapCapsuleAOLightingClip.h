...
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x15B5F950)
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x15B5F940)
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x15B5FB30)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int NapCapsuleAOLightingClip_TypeDefinitionIndex = 52151;
