...
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x12BE5D60)
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x12BE5C00)
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERTRACK_METHOD_5_652F102150AC9967_OFFSET UNITYSDK_OFFSET(0x12BE6000)
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERTRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x12BE5FC0)
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x12BE5F60)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int UnitCompManagerTrack_TypeDefinitionIndex = 63913;
