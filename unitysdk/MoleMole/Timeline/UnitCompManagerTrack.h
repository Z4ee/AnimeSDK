...
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x13865990)
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x13865830)
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERTRACK_METHOD_5_652F102150AC9967_OFFSET UNITYSDK_OFFSET(0x13865BF0)
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERTRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x13865C30)
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x13865B90)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int UnitCompManagerTrack_TypeDefinitionIndex = 68554;
