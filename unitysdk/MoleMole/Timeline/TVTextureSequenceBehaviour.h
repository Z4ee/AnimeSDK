...
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_11D7AB38B006624A_OFFSET UNITYSDK_OFFSET(0x160FE420)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x160FE3A0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_7A4DA50406643EC6_OFFSET UNITYSDK_OFFSET(0x160FD6B0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_830C8E34300646A6_OFFSET UNITYSDK_OFFSET(0x160FE3B0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_832295EC279E5994_1_OFFSET UNITYSDK_OFFSET(0x160FE410)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x160FE400)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_94C26E8746F69EE8_OFFSET UNITYSDK_OFFSET(0x160FDC80)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_A2F71555A1437C8A_OFFSET UNITYSDK_OFFSET(0x160FE170)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_B4E487BFAD3802C2_OFFSET UNITYSDK_OFFSET(0x160FD8F0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_ED01C45E2F8DB392_OFFSET UNITYSDK_OFFSET(0x160FE160)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x160FDE80)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x160FDF40)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_ONPLAY_OFFSET UNITYSDK_OFFSET(0x160FD4D0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_ONPROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x160FDCD0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x160FE0F0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TVTextureSequenceBehaviour_TypeDefinitionIndex = 45786;
