...
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_11D7AB38B006624A_OFFSET UNITYSDK_OFFSET(0x1999CF80)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x1999D230)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_7A4DA50406643EC6_OFFSET UNITYSDK_OFFSET(0x1999C220)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_830C8E34300646A6_OFFSET UNITYSDK_OFFSET(0x1999CF20)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_832295EC279E5994_1_OFFSET UNITYSDK_OFFSET(0x1999D220)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x1999CF70)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_94C26E8746F69EE8_OFFSET UNITYSDK_OFFSET(0x1999C7F0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_A2F71555A1437C8A_OFFSET UNITYSDK_OFFSET(0x1999CCE0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_B4E487BFAD3802C2_OFFSET UNITYSDK_OFFSET(0x1999C460)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_ED01C45E2F8DB392_OFFSET UNITYSDK_OFFSET(0x1999CF10)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1999CA00)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1999CAC0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_ONPLAY_OFFSET UNITYSDK_OFFSET(0x1999C040)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_ONPROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1999C840)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1999CC70)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TVTextureSequenceBehaviour_TypeDefinitionIndex = 64896;
