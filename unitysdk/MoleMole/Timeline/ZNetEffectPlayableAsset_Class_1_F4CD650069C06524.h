...
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_CLASS_1_F4CD650069C06524_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B6CB2C0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_CLASS_1_F4CD650069C06524_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_MONOBEHAVIOUR__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B6CB520)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_CLASS_1_F4CD650069C06524_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_MONOBEHAVIOUR__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B6CB4B0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_CLASS_1_F4CD650069C06524_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B6CB5A0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_CLASS_1_F4CD650069C06524_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B6CB510)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_CLASS_1_F4CD650069C06524_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B6CB4C0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_CLASS_1_F4CD650069C06524_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B6CB2B0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_CLASS_1_F4CD650069C06524__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6CB290)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ZNetEffectPlayableAsset_Class_1_F4CD650069C06524_TypeDefinitionIndex = 70259;

	class ZNetEffectPlayableAsset_Class_1_F4CD650069C06524 : public ::System::Object
	{
	public:
		::UnityEngine::MonoBehaviour* Field_1_2; // 0x10
		::UnityEngine::GameObject* Field_1_7; // 0x18
		::Il2CppArray<::UnityEngine::MonoBehaviour*>* Field_1_6; // 0x20
