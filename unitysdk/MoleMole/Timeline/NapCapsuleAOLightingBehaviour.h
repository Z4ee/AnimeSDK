...
#include "unitysdk/MoleMole/Timeline/NapCapsuleAOLightingBehaviour_Struct_2_52AD02145F5FCE36_42.h"
...
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x158642A0)
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x15864980)
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x15865720)
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGBEHAVIOUR_METHOD_4_3818ABA68CC3854A_OFFSET UNITYSDK_OFFSET(0x158644D0)
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x15865740)
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x15865750)
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x15865730)
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x158648C0)
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x158651F0)
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x158653D0)
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x158656F0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int NapCapsuleAOLightingBehaviour_TypeDefinitionIndex = 80862;

	class NapCapsuleAOLightingBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::NapCapsuleAOLightingBehaviour_Struct_2_52AD02145F5FCE36_42 _methodParm; // 0x18
