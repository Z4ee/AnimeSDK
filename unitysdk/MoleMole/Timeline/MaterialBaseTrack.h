...
#define MOLEMOLE_TIMELINE_MATERIALBASETRACK_AFTERCREATEPLAYABLEGRAPH_OFFSET UNITYSDK_OFFSET(0x1C287C30)
#define MOLEMOLE_TIMELINE_MATERIALBASETRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1C287A80)
#define MOLEMOLE_TIMELINE_MATERIALBASETRACK_GETKFRAMETRACK_OFFSET UNITYSDK_OFFSET(0x1C2879A0)
#define MOLEMOLE_TIMELINE_MATERIALBASETRACK_ONCURVEWASMODIFIED_OFFSET UNITYSDK_OFFSET(0x1C287720)
#define MOLEMOLE_TIMELINE_MATERIALBASETRACK_TRACKCREATEINIT_OFFSET UNITYSDK_OFFSET(0x1C287830)
#define MOLEMOLE_TIMELINE_MATERIALBASETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C288100)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MaterialBaseTrack_TypeDefinitionIndex = 30626;
