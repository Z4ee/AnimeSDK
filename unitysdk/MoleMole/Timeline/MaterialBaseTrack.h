...
#define MOLEMOLE_TIMELINE_MATERIALBASETRACK_AFTERCREATEPLAYABLEGRAPH_OFFSET UNITYSDK_OFFSET(0x1E5A70E0)
#define MOLEMOLE_TIMELINE_MATERIALBASETRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1E5A6F30)
#define MOLEMOLE_TIMELINE_MATERIALBASETRACK_GETKFRAMETRACK_OFFSET UNITYSDK_OFFSET(0x1E5A6E50)
#define MOLEMOLE_TIMELINE_MATERIALBASETRACK_ONCURVEWASMODIFIED_OFFSET UNITYSDK_OFFSET(0x1E5A6BD0)
#define MOLEMOLE_TIMELINE_MATERIALBASETRACK_TRACKCREATEINIT_OFFSET UNITYSDK_OFFSET(0x1E5A6CE0)
#define MOLEMOLE_TIMELINE_MATERIALBASETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5A75B0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MaterialBaseTrack_TypeDefinitionIndex = 32172;
