...
#define MOLEMOLE_TIMELINE_MIHOYOEFFECTTAGCONTROLTRACK_METHOD_5_832295EC279E5994_1_OFFSET UNITYSDK_OFFSET(0x174072C0)
#define MOLEMOLE_TIMELINE_MIHOYOEFFECTTAGCONTROLTRACK_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x174072B0)
#define MOLEMOLE_TIMELINE_MIHOYOEFFECTTAGCONTROLTRACK_ONAFTERTRACKDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x17406E60)
#define MOLEMOLE_TIMELINE_MIHOYOEFFECTTAGCONTROLTRACK_ONBEFORETRACKSERIALIZE_OFFSET UNITYSDK_OFFSET(0x17406B10)
#define MOLEMOLE_TIMELINE_MIHOYOEFFECTTAGCONTROLTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x17407190)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MihoyoEffectTagControlTrack_TypeDefinitionIndex = 60159;
