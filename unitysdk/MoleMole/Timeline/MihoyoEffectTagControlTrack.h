...
#define MOLEMOLE_TIMELINE_MIHOYOEFFECTTAGCONTROLTRACK_METHOD_5_832295EC279E5994_1_OFFSET UNITYSDK_OFFSET(0x1178AEF0)
#define MOLEMOLE_TIMELINE_MIHOYOEFFECTTAGCONTROLTRACK_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x1178AEE0)
#define MOLEMOLE_TIMELINE_MIHOYOEFFECTTAGCONTROLTRACK_ONAFTERTRACKDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1178AA90)
#define MOLEMOLE_TIMELINE_MIHOYOEFFECTTAGCONTROLTRACK_ONBEFORETRACKSERIALIZE_OFFSET UNITYSDK_OFFSET(0x1178A740)
#define MOLEMOLE_TIMELINE_MIHOYOEFFECTTAGCONTROLTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1178ADC0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MihoyoEffectTagControlTrack_TypeDefinitionIndex = 62979;
