...
#define MOLEMOLE_TIMELINE_ACTIVEEXTERNALTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x173AA150)
#define MOLEMOLE_TIMELINE_ACTIVEEXTERNALTRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x173AA310)
#define MOLEMOLE_TIMELINE_ACTIVEEXTERNALTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x173AA2B0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ActiveExternalTrack_TypeDefinitionIndex = 85481;
	...
	public:
		::System::Void _ctor()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_ACTIVEEXTERNALTRACK__CTOR_OFFSET))(this);
		}
