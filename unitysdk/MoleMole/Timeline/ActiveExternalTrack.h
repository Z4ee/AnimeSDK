...
#define MOLEMOLE_TIMELINE_ACTIVEEXTERNALTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1304BB20)
#define MOLEMOLE_TIMELINE_ACTIVEEXTERNALTRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x1304BCE0)
#define MOLEMOLE_TIMELINE_ACTIVEEXTERNALTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1304BC80)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ActiveExternalTrack_TypeDefinitionIndex = 39717;
