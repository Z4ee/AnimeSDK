...
#include "unitysdk/MoleMole/Timeline/CausticsBehaviour_Struct_2_52AD02145F5FCE3A_12.h"
...
#define MOLEMOLE_TIMELINE_CAUSTICSBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x1606D8F0)
#define MOLEMOLE_TIMELINE_CAUSTICSBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x1606FD60)
#define MOLEMOLE_TIMELINE_CAUSTICSBEHAVIOUR_METHOD_4_3A9F5C9005A04C91_OFFSET UNITYSDK_OFFSET(0x1606DE20)
#define MOLEMOLE_TIMELINE_CAUSTICSBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x1606FD30)
#define MOLEMOLE_TIMELINE_CAUSTICSBEHAVIOUR_METHOD_4_8DC55F996A78F0A1_OFFSET UNITYSDK_OFFSET(0x1606E3A0)
#define MOLEMOLE_TIMELINE_CAUSTICSBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x1606FD50)
#define MOLEMOLE_TIMELINE_CAUSTICSBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x1606FD40)
#define MOLEMOLE_TIMELINE_CAUSTICSBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1606E210)
#define MOLEMOLE_TIMELINE_CAUSTICSBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1606F4C0)
#define MOLEMOLE_TIMELINE_CAUSTICSBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1606F760)
#define MOLEMOLE_TIMELINE_CAUSTICSBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1606FCD0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int CausticsBehaviour_TypeDefinitionIndex = 52815;

	class CausticsBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::CausticsBehaviour_Struct_2_52AD02145F5FCE3A_12 _methodParm; // 0x18
