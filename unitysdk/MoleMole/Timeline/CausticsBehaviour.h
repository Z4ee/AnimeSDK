...
#include "unitysdk/MoleMole/Timeline/CausticsBehaviour_Struct_2_52AD02145F5FCE3A_2.h"
...
#define MOLEMOLE_TIMELINE_CAUSTICSBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x138618F0)
#define MOLEMOLE_TIMELINE_CAUSTICSBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x138623A0)
#define MOLEMOLE_TIMELINE_CAUSTICSBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x13863D00)
#define MOLEMOLE_TIMELINE_CAUSTICSBEHAVIOUR_METHOD_4_3A9F5C9005A04C91_OFFSET UNITYSDK_OFFSET(0x13861E20)
#define MOLEMOLE_TIMELINE_CAUSTICSBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x13863D10)
#define MOLEMOLE_TIMELINE_CAUSTICSBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x13863CF0)
#define MOLEMOLE_TIMELINE_CAUSTICSBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x13863CE0)
#define MOLEMOLE_TIMELINE_CAUSTICSBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x13862210)
#define MOLEMOLE_TIMELINE_CAUSTICSBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x13863470)
#define MOLEMOLE_TIMELINE_CAUSTICSBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x13863710)
#define MOLEMOLE_TIMELINE_CAUSTICSBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x13863C80)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int CausticsBehaviour_TypeDefinitionIndex = 44664;

	class CausticsBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::CausticsBehaviour_Struct_2_52AD02145F5FCE3A_2 _methodParm; // 0x18
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_CAUSTICSBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET))(this);
		}
	};
}
