...
#define MOLEMOLE_TIMELINE_MIHOYOPOSTPROCESSBEHAVIOR_GET_SCALECURVEWHENCLIPTIMECHANGEINFOMSG_OFFSET UNITYSDK_OFFSET(0x13F2A150)
#define MOLEMOLE_TIMELINE_MIHOYOPOSTPROCESSBEHAVIOR_METHOD_2_29A494D59164912A_OFFSET UNITYSDK_OFFSET(0x13F2A270)
#define MOLEMOLE_TIMELINE_MIHOYOPOSTPROCESSBEHAVIOR_METHOD_2_79ED6854413CA2F4_1_OFFSET UNITYSDK_OFFSET(0x13F2AD50)
#define MOLEMOLE_TIMELINE_MIHOYOPOSTPROCESSBEHAVIOR_METHOD_2_79ED6854413CA2F4_OFFSET UNITYSDK_OFFSET(0x13F2AD30)
#define MOLEMOLE_TIMELINE_MIHOYOPOSTPROCESSBEHAVIOR_METHOD_2_E5E342154D4EA5F5_OFFSET UNITYSDK_OFFSET(0x13F2AD40)
#define MOLEMOLE_TIMELINE_MIHOYOPOSTPROCESSBEHAVIOR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x13F2A480)
#define MOLEMOLE_TIMELINE_MIHOYOPOSTPROCESSBEHAVIOR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x13F2A1D0)
#define MOLEMOLE_TIMELINE_MIHOYOPOSTPROCESSBEHAVIOR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x13F2A640)
#define MOLEMOLE_TIMELINE_MIHOYOPOSTPROCESSBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x13F2ACB0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MihoyoPostProcessBehavior_TypeDefinitionIndex = 52169;
