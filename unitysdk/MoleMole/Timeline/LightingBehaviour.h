...
#include "unitysdk/MoleMole/Timeline/LightingBehaviour_Struct_2_52AD02145F5FCE36_12.h"
...
#define MOLEMOLE_TIMELINE_LIGHTINGBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x1082DC10)
#define MOLEMOLE_TIMELINE_LIGHTINGBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x1082EA90)
#define MOLEMOLE_TIMELINE_LIGHTINGBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x10832A60)
#define MOLEMOLE_TIMELINE_LIGHTINGBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x10832A70)
#define MOLEMOLE_TIMELINE_LIGHTINGBEHAVIOUR_METHOD_4_9A5C744E6CF1666D_OFFSET UNITYSDK_OFFSET(0x1082E320)
#define MOLEMOLE_TIMELINE_LIGHTINGBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x10832A90)
#define MOLEMOLE_TIMELINE_LIGHTINGBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x10832A80)
#define MOLEMOLE_TIMELINE_LIGHTINGBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1082E710)
#define MOLEMOLE_TIMELINE_LIGHTINGBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x10831A10)
#define MOLEMOLE_TIMELINE_LIGHTINGBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x10831EA0)
#define MOLEMOLE_TIMELINE_LIGHTINGBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x10832940)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int LightingBehaviour_TypeDefinitionIndex = 56934;

	class LightingBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::LightingBehaviour_Struct_2_52AD02145F5FCE36_12 _methodParm; // 0x18
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_LIGHTINGBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET))(this);
		}
	};
}
