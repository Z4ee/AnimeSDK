...
#define MOLEMOLE_TIMELINE_SHOTACTIVEBEHAVIOUR_GET_DURATIONTIME_OFFSET UNITYSDK_OFFSET(0x11D7D9D0)
#define MOLEMOLE_TIMELINE_SHOTACTIVEBEHAVIOUR_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x11D7D9A0)
#define MOLEMOLE_TIMELINE_SHOTACTIVEBEHAVIOUR_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x11D7D980)
#define MOLEMOLE_TIMELINE_SHOTACTIVEBEHAVIOUR_METHOD_2_0043BC75B602D2E3_OFFSET UNITYSDK_OFFSET(0x11D7DA00)
#define MOLEMOLE_TIMELINE_SHOTACTIVEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x11D7D9F0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ShotActiveBehaviour_TypeDefinitionIndex = 62480;
