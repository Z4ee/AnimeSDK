...
#define MOLEMOLE_TIMELINE_HANDLEADDITIVESCENETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1B6B60E0)
#define MOLEMOLE_TIMELINE_HANDLEADDITIVESCENETRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x1B6B62A0)
#define MOLEMOLE_TIMELINE_HANDLEADDITIVESCENETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6B6240)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int HandleAdditiveSceneTrack_TypeDefinitionIndex = 57052;
	...
	public:
		::System::Void _ctor()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_HANDLEADDITIVESCENETRACK__CTOR_OFFSET))(this);
		}
