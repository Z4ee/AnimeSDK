...
#define MOLEMOLE_TIMELINE_HANDLEADDITIVESCENETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1917E9F0)
#define MOLEMOLE_TIMELINE_HANDLEADDITIVESCENETRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x1917EBB0)
#define MOLEMOLE_TIMELINE_HANDLEADDITIVESCENETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1917EB50)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int HandleAdditiveSceneTrack_TypeDefinitionIndex = 77528;
