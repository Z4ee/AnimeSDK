...
#include "unitysdk/MoleMole/Timeline/MotionBlurBehaviour_Struct_2_52AD02145F5FCE36_6.h"
...
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x12FBC820)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_METHOD_4_109E86D9431100FF_OFFSET UNITYSDK_OFFSET(0x12FBCA70)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x12FBCF30)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x12FBDDE0)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x12FBDE00)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x12FBDDF0)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x12FBDDD0)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x12FBCE60)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x12FBD840)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x12FBDA30)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x12FBDD90)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MotionBlurBehaviour_TypeDefinitionIndex = 42145;

	class MotionBlurBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::MotionBlurBehaviour_Struct_2_52AD02145F5FCE36_6 _methodParm; // 0x18
