...
#include "unitysdk/MoleMole/Timeline/MotionBlurBehaviour_Struct_2_52AD02145F5FCE36_1.h"
...
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x1978DE10)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_METHOD_4_109E86D9431100FF_OFFSET UNITYSDK_OFFSET(0x1978E060)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x1978E520)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x1978F3B0)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x1978F3C0)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x1978F3A0)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x1978F390)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1978E450)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1978EE00)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1978EFF0)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1978F350)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MotionBlurBehaviour_TypeDefinitionIndex = 43279;

	class MotionBlurBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::MotionBlurBehaviour_Struct_2_52AD02145F5FCE36_1 _methodParm; // 0x18
