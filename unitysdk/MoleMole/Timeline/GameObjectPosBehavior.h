...
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSBEHAVIOR_INITDATA_OFFSET UNITYSDK_OFFSET(0x1F23D8A0)
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSBEHAVIOR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1F23DBA0)
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSBEHAVIOR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1F23D590)
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSBEHAVIOR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1F23DBC0)
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSBEHAVIOR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1F23DBB0)
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSBEHAVIOR_RECORDERINITTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1F23DB30)
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSBEHAVIOR_RECORDPOS_OFFSET UNITYSDK_OFFSET(0x1F23D290)
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSBEHAVIOR_RECOVERRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1F23D410)
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSBEHAVIOR_SETRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1F23D5A0)
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSBEHAVIOR_SETTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1F23D720)
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1F23DBD0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int GameObjectPosBehavior_TypeDefinitionIndex = 32851;
