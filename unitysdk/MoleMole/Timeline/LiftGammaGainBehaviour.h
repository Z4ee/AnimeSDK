...
#define MOLEMOLE_TIMELINE_LIFTGAMMAGAINBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x1387BA20)
#define MOLEMOLE_TIMELINE_LIFTGAMMAGAINBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x1387CC70)
#define MOLEMOLE_TIMELINE_LIFTGAMMAGAINBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x1387CC60)
#define MOLEMOLE_TIMELINE_LIFTGAMMAGAINBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x1387CC80)
#define MOLEMOLE_TIMELINE_LIFTGAMMAGAINBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x1387CC50)
#define MOLEMOLE_TIMELINE_LIFTGAMMAGAINBEHAVIOUR_METHOD_4_D33218A492B26449_OFFSET UNITYSDK_OFFSET(0x1387C0F0)
#define MOLEMOLE_TIMELINE_LIFTGAMMAGAINBEHAVIOUR_METHOD_4_E436924AA7D2B939_OFFSET UNITYSDK_OFFSET(0x1387BC50)
#define MOLEMOLE_TIMELINE_LIFTGAMMAGAINBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1387C040)
#define MOLEMOLE_TIMELINE_LIFTGAMMAGAINBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1387C6B0)
#define MOLEMOLE_TIMELINE_LIFTGAMMAGAINBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1387C870)
#define MOLEMOLE_TIMELINE_LIFTGAMMAGAINBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1387CC20)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int LiftGammaGainBehaviour_TypeDefinitionIndex = 77677;
