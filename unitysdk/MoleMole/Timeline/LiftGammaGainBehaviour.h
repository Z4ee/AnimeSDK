...
#include "unitysdk/MoleMole/Timeline/LiftGammaGainBehaviour_Struct_2_E9B2CF29B4D7A350.h"
...
#define MOLEMOLE_TIMELINE_LIFTGAMMAGAINBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x181820A0)
#define MOLEMOLE_TIMELINE_LIFTGAMMAGAINBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x181832F0)
#define MOLEMOLE_TIMELINE_LIFTGAMMAGAINBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x18183300)
#define MOLEMOLE_TIMELINE_LIFTGAMMAGAINBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x181832E0)
#define MOLEMOLE_TIMELINE_LIFTGAMMAGAINBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x181832D0)
#define MOLEMOLE_TIMELINE_LIFTGAMMAGAINBEHAVIOUR_METHOD_4_D33218A492B26449_OFFSET UNITYSDK_OFFSET(0x18182770)
#define MOLEMOLE_TIMELINE_LIFTGAMMAGAINBEHAVIOUR_METHOD_4_E436924AA7D2B939_OFFSET UNITYSDK_OFFSET(0x181822D0)
#define MOLEMOLE_TIMELINE_LIFTGAMMAGAINBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x181826C0)
#define MOLEMOLE_TIMELINE_LIFTGAMMAGAINBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x18182D30)
#define MOLEMOLE_TIMELINE_LIFTGAMMAGAINBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x18182EF0)
#define MOLEMOLE_TIMELINE_LIFTGAMMAGAINBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x181832A0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int LiftGammaGainBehaviour_TypeDefinitionIndex = 67159;

	class LiftGammaGainBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::LiftGammaGainBehaviour_Struct_2_E9B2CF29B4D7A350 _methodParm; // 0x18
