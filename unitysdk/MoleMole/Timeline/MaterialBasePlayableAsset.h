...
#define MOLEMOLE_TIMELINE_MATERIALBASEPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1E748660)
#define MOLEMOLE_TIMELINE_MATERIALBASEPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1E748650)
#define MOLEMOLE_TIMELINE_MATERIALBASEPLAYABLEASSET_GET_RECORDER_OFFSET UNITYSDK_OFFSET(0x1E7485E0)
#define MOLEMOLE_TIMELINE_MATERIALBASEPLAYABLEASSET_INITDATA_OFFSET UNITYSDK_OFFSET(0x1E7485F0)
#define MOLEMOLE_TIMELINE_MATERIALBASEPLAYABLEASSET_RELOADGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1E748640)
#define MOLEMOLE_TIMELINE_MATERIALBASEPLAYABLEASSET_REVERTATTR_OFFSET UNITYSDK_OFFSET(0x1E748750)
#define MOLEMOLE_TIMELINE_MATERIALBASEPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7487A0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MaterialBasePlayableAsset_TypeDefinitionIndex = 32171;
