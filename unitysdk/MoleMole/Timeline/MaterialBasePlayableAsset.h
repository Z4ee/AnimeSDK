...
#define MOLEMOLE_TIMELINE_MATERIALBASEPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1FB1FD80)
#define MOLEMOLE_TIMELINE_MATERIALBASEPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1FB1FD70)
#define MOLEMOLE_TIMELINE_MATERIALBASEPLAYABLEASSET_GET_RECORDER_OFFSET UNITYSDK_OFFSET(0x1FB1FD00)
#define MOLEMOLE_TIMELINE_MATERIALBASEPLAYABLEASSET_INITDATA_OFFSET UNITYSDK_OFFSET(0x1FB1FD10)
#define MOLEMOLE_TIMELINE_MATERIALBASEPLAYABLEASSET_RELOADGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1FB1FD60)
#define MOLEMOLE_TIMELINE_MATERIALBASEPLAYABLEASSET_REVERTATTR_OFFSET UNITYSDK_OFFSET(0x1FB1FE70)
#define MOLEMOLE_TIMELINE_MATERIALBASEPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1FB1FEC0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MaterialBasePlayableAsset_TypeDefinitionIndex = 32801;
