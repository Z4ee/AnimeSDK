...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_NOSEAMLESSBASEREFERENCECOMPINFO_CHECKISVALID_OFFSET UNITYSDK_OFFSET(0x10E56BA0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_NOSEAMLESSBASEREFERENCECOMPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x10E56BF0)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int NoSeamlessBaseReferenceCompInfo_TypeDefinitionIndex = 49359;
