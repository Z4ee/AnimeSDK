...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEDATAOVERLAY_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x12FC3310)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEDATAOVERLAY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x12FC4EB0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEDATAOVERLAY_METHOD_5_10AD0834AEF29F17_OFFSET UNITYSDK_OFFSET(0x12FC5760)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEDATAOVERLAY_METHOD_5_24A3E783DDC27C78_OFFSET UNITYSDK_OFFSET(0x12FC3480)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEDATAOVERLAY_METHOD_5_2B5881023D1BCA42_OFFSET UNITYSDK_OFFSET(0x12FC4F90)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEDATAOVERLAY_METHOD_5_3DCCEE5DA06D6079_OFFSET UNITYSDK_OFFSET(0x12FC5820)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEDATAOVERLAY_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x12FC3420)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEDATAOVERLAY_METHOD_5_D155D4917B3D2C6A_OFFSET UNITYSDK_OFFSET(0x12FC4B30)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEDATAOVERLAY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x12FC5490)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEDATAOVERLAY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x12FC4F00)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEDATAOVERLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x12FC56D0)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int RuntimeTimelineDataOverlay_TypeDefinitionIndex = 55999;

	class RuntimeTimelineDataOverlay : public ::UnityEngine::MonoBehaviour
	{
	public:
		static ::UnityEngine::Canvas** StaticGet_Field_5_4()
		{
			return (::UnityEngine::Canvas**)Il2CppClass::FromTypeDefinitionIndex(RuntimeTimelineDataOverlay_TypeDefinitionIndex)->GetStaticField(0x469E0);
		}
		static ::System::Boolean* StaticGet_Field_5_5()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(RuntimeTimelineDataOverlay_TypeDefinitionIndex)->GetStaticField(0x11050);
		}
		// static const ::System::String* Field_5_0; // 0x0
		// static const ::System::String* Field_5_1; // 0x0
		::UnityEngine::Playables::PlayableDirector* Field_5_2; // 0x18
		::System::String* Field_5_3; // 0x20
		::UnityEngine::GameObject* Field_5_6; // 0x28
		::UnityEngine::UI::Image* Field_5_7; // 0x30
		::UnityEngine::UI::Text* Field_5_8; // 0x38
