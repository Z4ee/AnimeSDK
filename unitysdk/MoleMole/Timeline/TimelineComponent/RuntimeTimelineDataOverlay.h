...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEDATAOVERLAY_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x141B91E0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEDATAOVERLAY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x141BAD80)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEDATAOVERLAY_METHOD_5_10AD0834AEF29F17_OFFSET UNITYSDK_OFFSET(0x141BB630)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEDATAOVERLAY_METHOD_5_24A3E783DDC27C78_OFFSET UNITYSDK_OFFSET(0x141B9350)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEDATAOVERLAY_METHOD_5_2B5881023D1BCA42_OFFSET UNITYSDK_OFFSET(0x141BAE60)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEDATAOVERLAY_METHOD_5_3DCCEE5DA06D6079_OFFSET UNITYSDK_OFFSET(0x141BB6F0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEDATAOVERLAY_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x141B92F0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEDATAOVERLAY_METHOD_5_D155D4917B3D2C6A_OFFSET UNITYSDK_OFFSET(0x141BAA00)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEDATAOVERLAY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x141BB360)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEDATAOVERLAY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x141BADD0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEDATAOVERLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x141BB5A0)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int RuntimeTimelineDataOverlay_TypeDefinitionIndex = 67604;
	...
	public:
		...
		{
			return (::UnityEngine::Canvas**)Il2CppClass::FromTypeDefinitionIndex(RuntimeTimelineDataOverlay_TypeDefinitionIndex)->GetStaticField(0x48640);
		}
		static ::System::Boolean* StaticGet_Field_5_5()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(RuntimeTimelineDataOverlay_TypeDefinitionIndex)->GetStaticField(0x11570);
		}
