...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_APPLYBRANCHGROUP_OFFSET UNITYSDK_OFFSET(0x1237E5B0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_APPLYTRACKSTATES_OFFSET UNITYSDK_OFFSET(0x1237F290)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_CLEARALLTRACKRUNTIMEMUTE_OFFSET UNITYSDK_OFFSET(0x1237E9D0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_CLEARSELFALLTRACKRUNTIMEMUTE_OFFSET UNITYSDK_OFFSET(0x1237EAF0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_GETACTIVEGROUPNAME_OFFSET UNITYSDK_OFFSET(0x1237F5B0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_GETALLBRANCHGROUPNAMES_OFFSET UNITYSDK_OFFSET(0x1237F5F0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_GETBRANCHGROUP_OFFSET UNITYSDK_OFFSET(0x1237F7C0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_GETBRANCHPLAYABLEDIRECTORS_OFFSET UNITYSDK_OFFSET(0x1237E460)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_GET_BRANCHGROUPDIC_OFFSET UNITYSDK_OFFSET(0x1237DAD0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_INITIALIZEBRANCHGROUPS_OFFSET UNITYSDK_OFFSET(0x1237DDB0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1237DD60)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_RESETALLTRACKSTATES_OFFSET UNITYSDK_OFFSET(0x1237EEB0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_SET_BRANCHGROUPDIC_OFFSET UNITYSDK_OFFSET(0x1237DD50)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_SWITCHBRANCH_OFFSET UNITYSDK_OFFSET(0x1237E810)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_UPDATEBRANCHGROUPS_OFFSET UNITYSDK_OFFSET(0x1237DAF0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1237F8B0)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int RuntimeTimelineBranchManager_TypeDefinitionIndex = 67426;
