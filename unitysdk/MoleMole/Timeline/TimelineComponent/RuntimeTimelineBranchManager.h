...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_APPLYBRANCHGROUP_OFFSET UNITYSDK_OFFSET(0x13F33B20)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_APPLYTRACKSTATES_OFFSET UNITYSDK_OFFSET(0x13F34800)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_CLEARALLTRACKRUNTIMEMUTE_OFFSET UNITYSDK_OFFSET(0x13F33F40)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_CLEARSELFALLTRACKRUNTIMEMUTE_OFFSET UNITYSDK_OFFSET(0x13F34060)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_GETACTIVEGROUPNAME_OFFSET UNITYSDK_OFFSET(0x13F34B20)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_GETALLBRANCHGROUPNAMES_OFFSET UNITYSDK_OFFSET(0x13F34B60)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_GETBRANCHGROUP_OFFSET UNITYSDK_OFFSET(0x13F34D30)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_GETBRANCHPLAYABLEDIRECTORS_OFFSET UNITYSDK_OFFSET(0x13F33990)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_GET_BRANCHGROUPDIC_OFFSET UNITYSDK_OFFSET(0x13F33010)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_INITIALIZEBRANCHGROUPS_OFFSET UNITYSDK_OFFSET(0x13F332E0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x13F33290)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_RESETALLTRACKSTATES_OFFSET UNITYSDK_OFFSET(0x13F34420)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_SET_BRANCHGROUPDIC_OFFSET UNITYSDK_OFFSET(0x13F33280)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_SWITCHBRANCH_OFFSET UNITYSDK_OFFSET(0x13F33D80)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_UPDATEBRANCHGROUPS_OFFSET UNITYSDK_OFFSET(0x13F33030)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x13F34E20)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int RuntimeTimelineBranchManager_TypeDefinitionIndex = 58765;
