...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP_CLEAR_OFFSET UNITYSDK_OFFSET(0x191BEAE0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP_GETROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x191BF720)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP_GETSEAMLESSGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x191C0150)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP_GET_PDCOMP_OFFSET UNITYSDK_OFFSET(0x191BEA00)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x191C01A0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP_REBINDNONSEAMLESS_OFFSET UNITYSDK_OFFSET(0x191BED30)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP_REBINDSEAMLESS_1_OFFSET UNITYSDK_OFFSET(0x191BFA10)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP_REBINDSEAMLESS_OFFSET UNITYSDK_OFFSET(0x191BF8A0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP_SETOVERRIDEROOT_OFFSET UNITYSDK_OFFSET(0x191BEA90)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP__CTOR_OFFSET UNITYSDK_OFFSET(0x191C0250)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int RuntimeTimelineRebindComp_TypeDefinitionIndex = 87843;
