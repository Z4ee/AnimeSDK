...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_SEAMLESSBASEREFERENCECOMPINFO_INITBASEINFO_OFFSET UNITYSDK_OFFSET(0x1A1C2450)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_SEAMLESSBASEREFERENCECOMPINFO_REBIND_OFFSET UNITYSDK_OFFSET(0x1A1C2CC0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_SEAMLESSBASEREFERENCECOMPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1C1CF0)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int SeamlessBaseReferenceCompInfo_TypeDefinitionIndex = 56115;
