...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_PARTICLESYSTEMSYNCINFO_CHECKISVALID_OFFSET UNITYSDK_OFFSET(0x15B682A0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_PARTICLESYSTEMSYNCINFO_INITINFO_OFFSET UNITYSDK_OFFSET(0x15B678A0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_PARTICLESYSTEMSYNCINFO_REBIND_OFFSET UNITYSDK_OFFSET(0x15B67AD0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_PARTICLESYSTEMSYNCINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x15B67840)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_PARTICLESYSTEMSYNCINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x15B677F0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_PARTICLESYSTEMSYNCINFO___BASE_CHECKISVALID_OFFSET UNITYSDK_OFFSET(0x15B68890)

namespace MoleMole::Timeline::TimelineComponent::RebindComps
{
	inline static constexpr unsigned int ParticleSystemSyncInfo_TypeDefinitionIndex = 52463;
