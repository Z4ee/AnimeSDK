...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_SEAMLESSPARTICLESYSTEMSYNCINFO_INITBASEINFO_OFFSET UNITYSDK_OFFSET(0x15BCAC40)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_SEAMLESSPARTICLESYSTEMSYNCINFO_INITINFO_OFFSET UNITYSDK_OFFSET(0x15BCAD30)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_SEAMLESSPARTICLESYSTEMSYNCINFO_REBIND_OFFSET UNITYSDK_OFFSET(0x15BCB330)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_SEAMLESSPARTICLESYSTEMSYNCINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x15BCABA0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_SEAMLESSPARTICLESYSTEMSYNCINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x15BCAAF0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_SEAMLESSPARTICLESYSTEMSYNCINFO___BASE_INITBASEINFO_OFFSET UNITYSDK_OFFSET(0x15BCBA70)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_SEAMLESSPARTICLESYSTEMSYNCINFO___BASE_REBIND_OFFSET UNITYSDK_OFFSET(0x15BCBAE0)

namespace MoleMole::Timeline::TimelineComponent::RebindComps
{
	inline static constexpr unsigned int SeamlessParticleSystemSyncInfo_TypeDefinitionIndex = 81795;
