...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_MONOSYNCTRANSFORMSYNCINFO_INITINFO_OFFSET UNITYSDK_OFFSET(0x141B89F0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_MONOSYNCTRANSFORMSYNCINFO_REBIND_OFFSET UNITYSDK_OFFSET(0x141B8C80)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_MONOSYNCTRANSFORMSYNCINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x141B89A0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_MONOSYNCTRANSFORMSYNCINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x141B8960)

namespace MoleMole::Timeline::TimelineComponent::RebindComps
{
	inline static constexpr unsigned int MonoSyncTransformSyncInfo_TypeDefinitionIndex = 51469;
