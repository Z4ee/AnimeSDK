...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_MONOSYNCTRANSFORMSYNCINFO_INITINFO_OFFSET UNITYSDK_OFFSET(0x197941B0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_MONOSYNCTRANSFORMSYNCINFO_REBIND_OFFSET UNITYSDK_OFFSET(0x19794440)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_MONOSYNCTRANSFORMSYNCINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19794160)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_MONOSYNCTRANSFORMSYNCINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19794120)

namespace MoleMole::Timeline::TimelineComponent::RebindComps
{
	inline static constexpr unsigned int MonoSyncTransformSyncInfo_TypeDefinitionIndex = 80418;
