...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_SEAMLESSMONOSYNCTRANSFORMSYNCINFO_INITBASEINFO_OFFSET UNITYSDK_OFFSET(0x15E2FF50)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_SEAMLESSMONOSYNCTRANSFORMSYNCINFO_INITINFO_OFFSET UNITYSDK_OFFSET(0x15E30070)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_SEAMLESSMONOSYNCTRANSFORMSYNCINFO_REBIND_OFFSET UNITYSDK_OFFSET(0x15E302F0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_SEAMLESSMONOSYNCTRANSFORMSYNCINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x15E2FEB0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_SEAMLESSMONOSYNCTRANSFORMSYNCINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x15E2FE30)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_SEAMLESSMONOSYNCTRANSFORMSYNCINFO___BASE_INITBASEINFO_OFFSET UNITYSDK_OFFSET(0x15E30850)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_SEAMLESSMONOSYNCTRANSFORMSYNCINFO___BASE_REBIND_OFFSET UNITYSDK_OFFSET(0x15E30910)

namespace MoleMole::Timeline::TimelineComponent::RebindComps
{
	inline static constexpr unsigned int SeamlessMonoSyncTransformSyncInfo_TypeDefinitionIndex = 63983;
