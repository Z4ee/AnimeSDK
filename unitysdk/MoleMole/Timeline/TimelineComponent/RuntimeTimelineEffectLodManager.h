...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEEFFECTLODMANAGER_COLLECTPARTICLESYSTEM_OFFSET UNITYSDK_OFFSET(0x138925B0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEEFFECTLODMANAGER_START_OFFSET UNITYSDK_OFFSET(0x13892D60)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEEFFECTLODMANAGER_UPDATELOD_OFFSET UNITYSDK_OFFSET(0x13892AD0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEEFFECTLODMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x13892DB0)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int RuntimeTimelineEffectLodManager_TypeDefinitionIndex = 71508;
