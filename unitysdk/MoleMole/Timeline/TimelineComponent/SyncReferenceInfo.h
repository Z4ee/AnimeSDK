...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_SYNCREFERENCEINFO_INITBASEINFO_OFFSET UNITYSDK_OFFSET(0x158691B0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_SYNCREFERENCEINFO_REBIND_OFFSET UNITYSDK_OFFSET(0x15868DE0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_SYNCREFERENCEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x158692E0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_SYNCREFERENCEINFO___BASE_INITBASEINFO_OFFSET UNITYSDK_OFFSET(0x15869360)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_SYNCREFERENCEINFO___BASE_REBIND_OFFSET UNITYSDK_OFFSET(0x15869420)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int SyncReferenceInfo_TypeDefinitionIndex = 69345;
