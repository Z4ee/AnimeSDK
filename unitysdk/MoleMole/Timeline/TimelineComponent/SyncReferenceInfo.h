...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_SYNCREFERENCEINFO_INITBASEINFO_OFFSET UNITYSDK_OFFSET(0x16439300)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_SYNCREFERENCEINFO_REBIND_OFFSET UNITYSDK_OFFSET(0x16438F30)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_SYNCREFERENCEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16439430)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_SYNCREFERENCEINFO___BASE_INITBASEINFO_OFFSET UNITYSDK_OFFSET(0x164394B0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_SYNCREFERENCEINFO___BASE_REBIND_OFFSET UNITYSDK_OFFSET(0x16439570)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int SyncReferenceInfo_TypeDefinitionIndex = 74850;
