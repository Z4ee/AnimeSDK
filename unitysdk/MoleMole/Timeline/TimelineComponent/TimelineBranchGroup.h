...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_TIMELINEBRANCHGROUP_GET_BRANCHTRACK_OFFSET UNITYSDK_OFFSET(0x12B29B00)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_TIMELINEBRANCHGROUP_METHOD_1_3016C1136D90757E_OFFSET UNITYSDK_OFFSET(0x12B2A390)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_TIMELINEBRANCHGROUP_METHOD_1_E52129E82CD2D7F8_1_OFFSET UNITYSDK_OFFSET(0x12B29E90)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_TIMELINEBRANCHGROUP_METHOD_1_E52129E82CD2D7F8_OFFSET UNITYSDK_OFFSET(0x12B29CB0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_TIMELINEBRANCHGROUP_METHOD_1_EDFD49C942C75D6C_1_OFFSET UNITYSDK_OFFSET(0x12B2A070)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_TIMELINEBRANCHGROUP_METHOD_1_EDFD49C942C75D6C_2_OFFSET UNITYSDK_OFFSET(0x12B2A200)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_TIMELINEBRANCHGROUP_METHOD_1_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0x12B29B20)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_TIMELINEBRANCHGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x12B29B10)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int TimelineBranchGroup_TypeDefinitionIndex = 72499;
