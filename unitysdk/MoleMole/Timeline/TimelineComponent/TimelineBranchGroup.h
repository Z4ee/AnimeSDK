...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_TIMELINEBRANCHGROUP_GET_BRANCHTRACK_OFFSET UNITYSDK_OFFSET(0x160FE860)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_TIMELINEBRANCHGROUP_METHOD_1_3016C1136D90757E_OFFSET UNITYSDK_OFFSET(0x160FE880)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_TIMELINEBRANCHGROUP_METHOD_1_E52129E82CD2D7F8_1_OFFSET UNITYSDK_OFFSET(0x160FF0A0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_TIMELINEBRANCHGROUP_METHOD_1_E52129E82CD2D7F8_OFFSET UNITYSDK_OFFSET(0x160FEBA0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_TIMELINEBRANCHGROUP_METHOD_1_EDFD49C942C75D6C_1_OFFSET UNITYSDK_OFFSET(0x160FEF10)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_TIMELINEBRANCHGROUP_METHOD_1_EDFD49C942C75D6C_2_OFFSET UNITYSDK_OFFSET(0x160FF280)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_TIMELINEBRANCHGROUP_METHOD_1_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0x160FED80)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_TIMELINEBRANCHGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x160FE870)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int TimelineBranchGroup_TypeDefinitionIndex = 62035;
