...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_NORMALSYNCREFERENCEINFO_CHECKISVALID_OFFSET UNITYSDK_OFFSET(0x12668FA0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_NORMALSYNCREFERENCEINFO_REBIND_OFFSET UNITYSDK_OFFSET(0x12668D10)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_NORMALSYNCREFERENCEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x12668CA0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_NORMALSYNCREFERENCEINFO___BASE_CHECKISVALID_OFFSET UNITYSDK_OFFSET(0x126692B0)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int NormalSyncReferenceInfo_TypeDefinitionIndex = 53240;
