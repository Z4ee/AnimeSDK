...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEEFFECTLODMANAGER_RUNTIMETIMELINEEFFECTLODMANAGER_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x167C22F0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEEFFECTLODMANAGER_RUNTIMETIMELINEEFFECTLODMANAGER_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x167C2300)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEEFFECTLODMANAGER_RUNTIMETIMELINEEFFECTLODMANAGER_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x167C24E0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEEFFECTLODMANAGER_RUNTIMETIMELINEEFFECTLODMANAGER_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x167C2680)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEEFFECTLODMANAGER_RUNTIMETIMELINEEFFECTLODMANAGER_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x167C2640)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int RuntimeTimelineEffectLodManager_RuntimeTimelineEffectLodManager_UnityGeneratedFormatter_TypeDefinitionIndex = 71509;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::UnityEngine::ParticleSystem*, ::MoleMole::Config::EffectLODType>*>**)Il2CppClass::FromTypeDefinitionIndex(RuntimeTimelineEffectLodManager_RuntimeTimelineEffectLodManager_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3EC60);
		}
