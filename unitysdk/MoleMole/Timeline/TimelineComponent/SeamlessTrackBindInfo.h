...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_SEAMLESSTRACKBINDINFO_GETSYNCENTITYTAGID_OFFSET UNITYSDK_OFFSET(0x152BE0C0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_SEAMLESSTRACKBINDINFO_GET_REFERENCENAME_OFFSET UNITYSDK_OFFSET(0x152BE060)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_SEAMLESSTRACKBINDINFO_REBIND_OFFSET UNITYSDK_OFFSET(0x152BE440)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_SEAMLESSTRACKBINDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x152BEAB0)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int SeamlessTrackBindInfo_TypeDefinitionIndex = 64440;
