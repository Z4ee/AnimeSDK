...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEMAP_APPLYUNITOBJFROMSERIALIZEDREFERENCEMAP_OFFSET UNITYSDK_OFFSET(0x1973EB70)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEMAP_GETSKINANDACCESSORYCONFIG_OFFSET UNITYSDK_OFFSET(0x1973EF00)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEMAP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1973EB20)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1973F210)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int RuntimeTimelineMap_TypeDefinitionIndex = 50220;
