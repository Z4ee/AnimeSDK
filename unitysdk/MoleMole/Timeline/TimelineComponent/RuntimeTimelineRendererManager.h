...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINERENDERERMANAGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x173AAA70)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINERENDERERMANAGER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x173AA920)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINERENDERERMANAGER_RESET_OFFSET UNITYSDK_OFFSET(0x173AA540)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINERENDERERMANAGER_SET_OFFSET UNITYSDK_OFFSET(0x173AA160)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINERENDERERMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x173AAAB0)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int RuntimeTimelineRendererManager_TypeDefinitionIndex = 85856;
