...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINERENDERERMANAGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x167C3000)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINERENDERERMANAGER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x167C2EB0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINERENDERERMANAGER_RESET_OFFSET UNITYSDK_OFFSET(0x167C2AD0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINERENDERERMANAGER_SET_OFFSET UNITYSDK_OFFSET(0x167C26F0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINERENDERERMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x167C3040)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int RuntimeTimelineRendererManager_TypeDefinitionIndex = 68986;
