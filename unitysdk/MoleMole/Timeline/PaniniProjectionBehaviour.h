...
#define MOLEMOLE_TIMELINE_PANINIPROJECTIONBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x129E45D0)
#define MOLEMOLE_TIMELINE_PANINIPROJECTIONBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x129E5480)
#define MOLEMOLE_TIMELINE_PANINIPROJECTIONBEHAVIOUR_METHOD_4_5FC63A1AC659F0AE_OFFSET UNITYSDK_OFFSET(0x129E4C20)
#define MOLEMOLE_TIMELINE_PANINIPROJECTIONBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x129E54A0)
#define MOLEMOLE_TIMELINE_PANINIPROJECTIONBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x129E5490)
#define MOLEMOLE_TIMELINE_PANINIPROJECTIONBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x129E5470)
#define MOLEMOLE_TIMELINE_PANINIPROJECTIONBEHAVIOUR_METHOD_4_CBB3E29629343F37_OFFSET UNITYSDK_OFFSET(0x129E47A0)
#define MOLEMOLE_TIMELINE_PANINIPROJECTIONBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x129E4B90)
#define MOLEMOLE_TIMELINE_PANINIPROJECTIONBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x129E5090)
#define MOLEMOLE_TIMELINE_PANINIPROJECTIONBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x129E5240)
#define MOLEMOLE_TIMELINE_PANINIPROJECTIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x129E5450)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int PaniniProjectionBehaviour_TypeDefinitionIndex = 58335;
