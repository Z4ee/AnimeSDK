...
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_24B05D2E15A5C3C8_OFFSET UNITYSDK_OFFSET(0x12660330)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x12660880)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_6103E5D7CF046E3B_OFFSET UNITYSDK_OFFSET(0x12660470)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_61C8F16B1C785762_OFFSET UNITYSDK_OFFSET(0x12660070)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_64F3965CE4C4DB47_OFFSET UNITYSDK_OFFSET(0x12660930)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_66655BFAAD3D9E8B_OFFSET UNITYSDK_OFFSET(0x12661CB0)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_66F42CE2EDA79734_1_OFFSET UNITYSDK_OFFSET(0x12661950)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_66F42CE2EDA79734_OFFSET UNITYSDK_OFFSET(0x126605E0)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_775B6D644F07B554_OFFSET UNITYSDK_OFFSET(0x12661BF0)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_9809C99861C91775_OFFSET UNITYSDK_OFFSET(0x12660BF0)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_9E38127F40B34F1F_OFFSET UNITYSDK_OFFSET(0x12660B90)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_A5809AB80389F7DE_OFFSET UNITYSDK_OFFSET(0x12660E20)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_C8E2469222842786_OFFSET UNITYSDK_OFFSET(0x12660890)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x12662150)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x12661C70)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_F0BD65B017F2AC0B_OFFSET UNITYSDK_OFFSET(0x12660410)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_F620DD2FD48DDF53_OFFSET UNITYSDK_OFFSET(0x12660000)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1265F4B0)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1265FED0)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1265FDC0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int AvatarTextureSheetBehaviour_TypeDefinitionIndex = 52218;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::MoleMole::Timeline::AvatarTextureSheetBehaviour*>*>**)Il2CppClass::FromTypeDefinitionIndex(AvatarTextureSheetBehaviour_TypeDefinitionIndex)->GetStaticField(0x308B0);
		}
		static ::System::String** StaticGet_TvIconTextureSheetRoot()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(AvatarTextureSheetBehaviour_TypeDefinitionIndex)->GetStaticField(0x308B8);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::MoleMole::Timeline::AvatarTextureSheetBehaviour*>*>**)Il2CppClass::FromTypeDefinitionIndex(AvatarTextureSheetBehaviour_TypeDefinitionIndex)->GetStaticField(0x308C0);
		}
		...
		::Class_2_208CC9941471731A_965* templateConfig; // 0x68
