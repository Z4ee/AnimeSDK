...
#define MOLEMOLE_TIMELINE_EDDIALOGBEHAVIOUR_METHOD_2_324AEE341AAA7A1B_1_OFFSET UNITYSDK_OFFSET(0x1B6B60B0)
#define MOLEMOLE_TIMELINE_EDDIALOGBEHAVIOUR_METHOD_2_324AEE341AAA7A1B_2_OFFSET UNITYSDK_OFFSET(0x1B6B60C0)
#define MOLEMOLE_TIMELINE_EDDIALOGBEHAVIOUR_METHOD_2_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x1B6B60A0)
#define MOLEMOLE_TIMELINE_EDDIALOGBEHAVIOUR_METHOD_2_79ED6854413CA2F4_1_OFFSET UNITYSDK_OFFSET(0x1B6B60D0)
#define MOLEMOLE_TIMELINE_EDDIALOGBEHAVIOUR_METHOD_2_79ED6854413CA2F4_OFFSET UNITYSDK_OFFSET(0x1B6B6090)
#define MOLEMOLE_TIMELINE_EDDIALOGBEHAVIOUR_METHOD_2_E5E342154D4EA5F5_OFFSET UNITYSDK_OFFSET(0x1B6B6080)
#define MOLEMOLE_TIMELINE_EDDIALOGBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1B6B5F10)
#define MOLEMOLE_TIMELINE_EDDIALOGBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1B6B5E90)
#define MOLEMOLE_TIMELINE_EDDIALOGBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0x1B6B5DF0)
#define MOLEMOLE_TIMELINE_EDDIALOGBEHAVIOUR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0x1B6B5E40)
#define MOLEMOLE_TIMELINE_EDDIALOGBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1B6B6020)
#define MOLEMOLE_TIMELINE_EDDIALOGBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1B6B5F90)
#define MOLEMOLE_TIMELINE_EDDIALOGBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6B6070)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int EDDialogBehaviour_TypeDefinitionIndex = 67586;
