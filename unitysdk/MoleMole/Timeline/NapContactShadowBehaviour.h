...
#include "unitysdk/MoleMole/Timeline/NapContactShadowBehaviour_Struct_2_AA4EE15A8D4DB005_3.h"
...
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x12FBDE10)
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x12FBF000)
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWBEHAVIOUR_METHOD_4_3C37862761792B91_OFFSET UNITYSDK_OFFSET(0x12FBE480)
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x12FBEFF0)
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWBEHAVIOUR_METHOD_4_72B32D0255A32FB9_OFFSET UNITYSDK_OFFSET(0x12FBDFF0)
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x12FBF020)
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x12FBF010)
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x12FBE3E0)
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x12FBEB80)
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x12FBED30)
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x12FBEFD0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int NapContactShadowBehaviour_TypeDefinitionIndex = 63720;

	class NapContactShadowBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::NapContactShadowBehaviour_Struct_2_AA4EE15A8D4DB005_3 _methodParm; // 0x18
