...
#define MOLEMOLE_TIMELINE_RUNTIMEPRELOADCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x190C6C70)
#define MOLEMOLE_TIMELINE_RUNTIMEPRELOADCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x190C6C60)
#define MOLEMOLE_TIMELINE_RUNTIMEPRELOADCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x190C6E30)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int RuntimePreLoadClip_TypeDefinitionIndex = 88466;
