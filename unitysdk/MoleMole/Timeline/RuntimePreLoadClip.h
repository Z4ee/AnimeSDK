...
#define MOLEMOLE_TIMELINE_RUNTIMEPRELOADCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x17DFFF80)
#define MOLEMOLE_TIMELINE_RUNTIMEPRELOADCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x17DFFF70)
#define MOLEMOLE_TIMELINE_RUNTIMEPRELOADCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x17E00140)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int RuntimePreLoadClip_TypeDefinitionIndex = 43136;
