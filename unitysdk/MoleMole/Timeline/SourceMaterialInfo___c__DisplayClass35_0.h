...
#define MOLEMOLE_TIMELINE_SOURCEMATERIALINFO___C__DISPLAYCLASS35_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF6F940)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALINFO___C__DISPLAYCLASS35_0__RECORDERALTER_B__0_OFFSET UNITYSDK_OFFSET(0x1EF749C0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALINFO___C__DISPLAYCLASS35_0__RECORDERALTER_B__1_OFFSET UNITYSDK_OFFSET(0x1EF74940)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SourceMaterialInfo___c__DisplayClass35_0_TypeDefinitionIndex = 32824;
