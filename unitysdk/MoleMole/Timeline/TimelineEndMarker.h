...
#define MOLEMOLE_TIMELINE_TIMELINEENDMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1973F930)
#define MOLEMOLE_TIMELINE_TIMELINEENDMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1973F970)
#define MOLEMOLE_TIMELINE_TIMELINEENDMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1973F8E0)
#define MOLEMOLE_TIMELINE_TIMELINEENDMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1973F980)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TimelineEndMarker_TypeDefinitionIndex = 89949;
