...
#define MOLEMOLE_TIMELINE_MONOSYNCTRANSFORM_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x15B5EF80)
#define MOLEMOLE_TIMELINE_MONOSYNCTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x15B5F350)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MonoSyncTransform_TypeDefinitionIndex = 56898;
