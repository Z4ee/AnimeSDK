...
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSBEHAVIOR_UIADAPTORRECTTRANSFORM_REINITFROMRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1BC63280)
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSBEHAVIOR_UIADAPTORRECTTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC63270)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int GameObjectPosBehavior_UIAdaptorRectTransform_TypeDefinitionIndex = 30675;
