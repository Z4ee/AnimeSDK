...
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSBEHAVIOR_UIADAPTORRECTTRANSFORM_REINITFROMRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1DFA6920)
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSBEHAVIOR_UIADAPTORRECTTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1DFA6910)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int GameObjectPosBehavior_UIAdaptorRectTransform_TypeDefinitionIndex = 32222;
