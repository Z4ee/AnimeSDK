...
#define MOLEMOLE_TIMELINE_SUBTITLETRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x141B7EF0)
#define MOLEMOLE_TIMELINE_SUBTITLETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x141B7D90)
#define MOLEMOLE_TIMELINE_SUBTITLETRACK_METHOD_5_652F102150AC9967_OFFSET UNITYSDK_OFFSET(0x141B8050)
#define MOLEMOLE_TIMELINE_SUBTITLETRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x141B8010)
#define MOLEMOLE_TIMELINE_SUBTITLETRACK__CCTOR_OFFSET UNITYSDK_OFFSET(0x141B8000)
#define MOLEMOLE_TIMELINE_SUBTITLETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x141B7FA0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SubtitleTrack_TypeDefinitionIndex = 76218;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(SubtitleTrack_TypeDefinitionIndex)->GetStaticField(0x13130);
		}
