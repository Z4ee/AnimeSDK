...
#define MOLEMOLE_TIMELINE_SUBTITLETRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x197936A0)
#define MOLEMOLE_TIMELINE_SUBTITLETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x19793540)
#define MOLEMOLE_TIMELINE_SUBTITLETRACK_METHOD_5_652F102150AC9967_OFFSET UNITYSDK_OFFSET(0x19793800)
#define MOLEMOLE_TIMELINE_SUBTITLETRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x197937C0)
#define MOLEMOLE_TIMELINE_SUBTITLETRACK__CCTOR_OFFSET UNITYSDK_OFFSET(0x197937B0)
#define MOLEMOLE_TIMELINE_SUBTITLETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19793750)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SubtitleTrack_TypeDefinitionIndex = 75311;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(SubtitleTrack_TypeDefinitionIndex)->GetStaticField(0x136E0);
		}
		::System::Int32 languageType; // 0xB0

		::System::Void _ctor()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_SUBTITLETRACK__CTOR_OFFSET))(this);
		}

		static ::System::Void _cctor()
		{
			return ((::System::Void(*)())((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_SUBTITLETRACK__CCTOR_OFFSET))();
		}

		::UnityEngine::Playables::Playable CreateTrackMixer(::UnityEngine::Playables::PlayableGraph a1, ::UnityEngine::GameObject* a2, ::System::Int32 a3)
		{
			return ((::UnityEngine::Playables::Playable(*)(::PVOID, ::UnityEngine::Playables::PlayableGraph, ::UnityEngine::GameObject*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_SUBTITLETRACK_CREATETRACKMIXER_OFFSET))(this, a1, a2, a3);
		}
