...
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1C387D20)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1C387E00)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERPLAYABLEASSET_GET_RECORDER_OFFSET UNITYSDK_OFFSET(0x1C387D10)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERPLAYABLEASSET_INITDATA_OFFSET UNITYSDK_OFFSET(0x1C387E10)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1C387E20)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SceneMaterialRecorderPlayableAsset_TypeDefinitionIndex = 30654;
