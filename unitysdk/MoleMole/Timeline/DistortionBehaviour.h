...
#include "unitysdk/MoleMole/Timeline/DistortionBehaviour_Struct_2_52AD02145F5FCE36_11.h"
...
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x152B1530)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x152B3030)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_METHOD_4_579B76B44596F9BB_OFFSET UNITYSDK_OFFSET(0x152B17D0)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x152B3000)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_METHOD_4_68160D9981ECFFF0_OFFSET UNITYSDK_OFFSET(0x152B1CB0)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x152B3020)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x152B3010)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x152B1BC0)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x152B29F0)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x152B2BF0)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x152B2FE0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int DistortionBehaviour_TypeDefinitionIndex = 48161;

	class DistortionBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::DistortionBehaviour_Struct_2_52AD02145F5FCE36_11 _methodParm; // 0x18
