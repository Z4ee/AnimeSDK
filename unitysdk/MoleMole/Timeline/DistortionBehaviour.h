...
#include "unitysdk/MoleMole/Timeline/DistortionBehaviour_Struct_2_52AD02145F5FCE36_36.h"
...
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x173AF350)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x173B0E10)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_METHOD_4_579B76B44596F9BB_OFFSET UNITYSDK_OFFSET(0x173AF5F0)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x173B0E00)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_METHOD_4_68160D9981ECFFF0_OFFSET UNITYSDK_OFFSET(0x173AFAD0)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x173B0E30)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x173B0E20)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x173AF9E0)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x173B07F0)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x173B09F0)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x173B0DE0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int DistortionBehaviour_TypeDefinitionIndex = 87896;

	class DistortionBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::DistortionBehaviour_Struct_2_52AD02145F5FCE36_36 _methodParm; // 0x18
