...
#include "unitysdk/MoleMole/Timeline/VREffectsBehaviour_Struct_2_52AD02145F5FCE3A_7.h"
...
#define MOLEMOLE_TIMELINE_VREFFECTSBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x1917FB80)
#define MOLEMOLE_TIMELINE_VREFFECTSBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x19192F90)
#define MOLEMOLE_TIMELINE_VREFFECTSBEHAVIOUR_METHOD_4_47EA092FA95FD8DA_OFFSET UNITYSDK_OFFSET(0x19181E20)
#define MOLEMOLE_TIMELINE_VREFFECTSBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x19192FA0)
#define MOLEMOLE_TIMELINE_VREFFECTSBEHAVIOUR_METHOD_4_95F0B0E4A30C4E0A_OFFSET UNITYSDK_OFFSET(0x191830F0)
#define MOLEMOLE_TIMELINE_VREFFECTSBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x19192F80)
#define MOLEMOLE_TIMELINE_VREFFECTSBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x19192F70)
#define MOLEMOLE_TIMELINE_VREFFECTSBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x19182210)
#define MOLEMOLE_TIMELINE_VREFFECTSBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1918EB80)
#define MOLEMOLE_TIMELINE_VREFFECTSBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1918FB80)
#define MOLEMOLE_TIMELINE_VREFFECTSBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x19192C40)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int VREffectsBehaviour_TypeDefinitionIndex = 51669;

	class VREffectsBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::VREffectsBehaviour_Struct_2_52AD02145F5FCE3A_7 _methodParm; // 0x18
