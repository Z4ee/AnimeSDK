...
#define MOLEMOLE_TIMELINE_SOURCEFRAMERECORDER_CLEARDATA_OFFSET UNITYSDK_OFFSET(0x1C0BE470)
#define MOLEMOLE_TIMELINE_SOURCEFRAMERECORDER_GETMATERIALKEY_OFFSET UNITYSDK_OFFSET(0x1C0C0880)
#define MOLEMOLE_TIMELINE_SOURCEFRAMERECORDER_RECORDERFRAMEINFO_OFFSET UNITYSDK_OFFSET(0x1C0BE5A0)
#define MOLEMOLE_TIMELINE_SOURCEFRAMERECORDER_RECORDERFRAME_OFFSET UNITYSDK_OFFSET(0x1C0BE570)
#define MOLEMOLE_TIMELINE_SOURCEFRAMERECORDER_SETINSTANCEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1C0BF610)
#define MOLEMOLE_TIMELINE_SOURCEFRAMERECORDER_SETMATERIALPROPERTYBLOCK_OFFSET UNITYSDK_OFFSET(0x1C0BEEC0)
#define MOLEMOLE_TIMELINE_SOURCEFRAMERECORDER_UPDATEINSTANCEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1C0BF550)
#define MOLEMOLE_TIMELINE_SOURCEFRAMERECORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0C0940)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SourceFrameRecorder_TypeDefinitionIndex = 30644;
