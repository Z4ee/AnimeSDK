...
#define MOLEMOLE_TIMELINE_MULTIRENDERERCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1BC63550)
#define MOLEMOLE_TIMELINE_MULTIRENDERERCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1BC63540)
#define MOLEMOLE_TIMELINE_MULTIRENDERERCLIP_GET_REFERENCES_OFFSET UNITYSDK_OFFSET(0x1BC63500)
#define MOLEMOLE_TIMELINE_MULTIRENDERERCLIP_SET_REFERENCES_OFFSET UNITYSDK_OFFSET(0x1BC63520)
#define MOLEMOLE_TIMELINE_MULTIRENDERERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC63650)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MultiRendererClip_TypeDefinitionIndex = 30668;
