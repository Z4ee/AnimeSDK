...
#define MOLEMOLE_TIMELINE_SUBTITLECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x170611E0)
#define MOLEMOLE_TIMELINE_SUBTITLECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x170611C0)
#define MOLEMOLE_TIMELINE_SUBTITLECLIP_GET_CLIPTYPE_OFFSET UNITYSDK_OFFSET(0x170611D0)
#define MOLEMOLE_TIMELINE_SUBTITLECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x17061470)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SubtitleClip_TypeDefinitionIndex = 50568;
