...
#define MOLEMOLE_TIMELINE_FXCOMICDOTTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x17405DC0)
#define MOLEMOLE_TIMELINE_FXCOMICDOTTRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x17406070)
#define MOLEMOLE_TIMELINE_FXCOMICDOTTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x17406010)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int FXComicDotTrack_TypeDefinitionIndex = 79256;
