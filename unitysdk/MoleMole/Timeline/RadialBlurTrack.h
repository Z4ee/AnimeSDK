...
#define MOLEMOLE_TIMELINE_RADIALBLURTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x187196C0)
#define MOLEMOLE_TIMELINE_RADIALBLURTRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x18719970)
#define MOLEMOLE_TIMELINE_RADIALBLURTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18719910)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int RadialBlurTrack_TypeDefinitionIndex = 65867;
