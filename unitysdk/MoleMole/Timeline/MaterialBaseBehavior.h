...
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_CLEARCOMPRECORDERINFO_OFFSET UNITYSDK_OFFSET(0x1C387770)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_FINDRELATIVEMESHRENDERER_OFFSET UNITYSDK_OFFSET(0x1C3871F0)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_GETALLRENDERERS_OFFSET UNITYSDK_OFFSET(0x1C386230)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_GETCOMPRECORDERINFO_OFFSET UNITYSDK_OFFSET(0x1C387880)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x1C3857F0)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_GET_REFERENCETARGET_OFFSET UNITYSDK_OFFSET(0x1C385880)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1C385770)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_INIT_OFFSET UNITYSDK_OFFSET(0x1C385C70)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_LOADKFRAMESFROMANIMATOR_OFFSET UNITYSDK_OFFSET(0x1C385A60)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0x1C385A70)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1C385BB0)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0x1C385A50)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1C385C50)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_ONPLAY_OFFSET UNITYSDK_OFFSET(0x1C385A80)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_ONPROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1C3858A0)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_RECORDMESHRENDERSFROMBATCH_OFFSET UNITYSDK_OFFSET(0x1C386A50)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_RECORDMESHRENDERS_OFFSET UNITYSDK_OFFSET(0x1C386360)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_RECOVERMESHRENDERS_OFFSET UNITYSDK_OFFSET(0x1C387590)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_REFRESHMONORENDERENTITY_OFFSET UNITYSDK_OFFSET(0x1C385B20)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_REINIT_OFFSET UNITYSDK_OFFSET(0x1C386220)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_RELOADMESHRENDERERS_OFFSET UNITYSDK_OFFSET(0x1C386010)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_REVERTATTR_OFFSET UNITYSDK_OFFSET(0x1C386D00)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_SET_REFERENCETARGET_OFFSET UNITYSDK_OFFSET(0x1C385890)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_UPDATEMESHRENDERERS_OFFSET UNITYSDK_OFFSET(0x1C3866A0)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C387B60)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C387AD0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MaterialBaseBehavior_TypeDefinitionIndex = 30620;
	...
	public:
		...
		{
			return (::MoleMole::Timeline::MaterialBaseBehavior_DeleteAnimationFrames**)Il2CppClass::FromTypeDefinitionIndex(MaterialBaseBehavior_TypeDefinitionIndex)->GetStaticField(0x24DB0);
		}
		static ::System::Reflection::MethodInfo** StaticGet_mbpRefresh()
		{
			return (::System::Reflection::MethodInfo**)Il2CppClass::FromTypeDefinitionIndex(MaterialBaseBehavior_TypeDefinitionIndex)->GetStaticField(0x24DB8);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>** StaticGet_RealKeyPathDic()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(MaterialBaseBehavior_TypeDefinitionIndex)->GetStaticField(0x24DC0);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>** StaticGet_MatchStrDic()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(MaterialBaseBehavior_TypeDefinitionIndex)->GetStaticField(0x24DC8);
		}
		static ::System::Int32* StaticGet_delayTime()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MaterialBaseBehavior_TypeDefinitionIndex)->GetStaticField(0x7A20);
		}
