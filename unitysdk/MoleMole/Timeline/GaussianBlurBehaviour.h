...
#include "unitysdk/MoleMole/Timeline/GaussianBlurBehaviour_Struct_2_52AD02145F5FCE3A_17.h"
...
#define MOLEMOLE_TIMELINE_GAUSSIANBLURBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x12662AB0)
#define MOLEMOLE_TIMELINE_GAUSSIANBLURBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x126631E0)
#define MOLEMOLE_TIMELINE_GAUSSIANBLURBEHAVIOUR_METHOD_4_1A8D9D2CD3FD3B22_OFFSET UNITYSDK_OFFSET(0x12662D10)
#define MOLEMOLE_TIMELINE_GAUSSIANBLURBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x126641C0)
#define MOLEMOLE_TIMELINE_GAUSSIANBLURBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x126641B0)
#define MOLEMOLE_TIMELINE_GAUSSIANBLURBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x126641E0)
#define MOLEMOLE_TIMELINE_GAUSSIANBLURBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x126641D0)
#define MOLEMOLE_TIMELINE_GAUSSIANBLURBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x12663100)
#define MOLEMOLE_TIMELINE_GAUSSIANBLURBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x12663C40)
#define MOLEMOLE_TIMELINE_GAUSSIANBLURBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x12663E30)
#define MOLEMOLE_TIMELINE_GAUSSIANBLURBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x12664180)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int GaussianBlurBehaviour_TypeDefinitionIndex = 64143;

	class GaussianBlurBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::GaussianBlurBehaviour_Struct_2_52AD02145F5FCE3A_17 _methodParm; // 0x18
