...
#define MOLEMOLE_TIMELINE_MONORENDERENTITYBEHAVIOR_METHOD_3_354822E56E8237B0_OFFSET UNITYSDK_OFFSET(0x12375C00)
#define MOLEMOLE_TIMELINE_MONORENDERENTITYBEHAVIOR_METHOD_3_832295EC279E5994_1_OFFSET UNITYSDK_OFFSET(0x12375DE0)
#define MOLEMOLE_TIMELINE_MONORENDERENTITYBEHAVIOR_METHOD_3_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x12375AF0)
#define MOLEMOLE_TIMELINE_MONORENDERENTITYBEHAVIOR_METHOD_3_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x12375DF0)
#define MOLEMOLE_TIMELINE_MONORENDERENTITYBEHAVIOR_METHOD_3_927B092C347D3361_OFFSET UNITYSDK_OFFSET(0x12375B00)
#define MOLEMOLE_TIMELINE_MONORENDERENTITYBEHAVIOR_METHOD_3_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0x12375870)
#define MOLEMOLE_TIMELINE_MONORENDERENTITYBEHAVIOR_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x12375970)
#define MOLEMOLE_TIMELINE_MONORENDERENTITYBEHAVIOR_ONPLAY_OFFSET UNITYSDK_OFFSET(0x12375700)
#define MOLEMOLE_TIMELINE_MONORENDERENTITYBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x12375AB0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MonoRenderEntityBehavior_TypeDefinitionIndex = 47257;
