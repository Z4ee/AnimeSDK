...
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERBEHAVIOR_INITDATA_OFFSET UNITYSDK_OFFSET(0x1E4B6D80)
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERBEHAVIOR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1E4B7410)
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERBEHAVIOR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1E4B71A0)
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERBEHAVIOR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1E4B7530)
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERBEHAVIOR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1E4B72D0)
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4B7650)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SkinnedMeshRendererBehavior_TypeDefinitionIndex = 32217;
