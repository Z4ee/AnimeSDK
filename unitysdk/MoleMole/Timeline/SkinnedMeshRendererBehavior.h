...
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERBEHAVIOR_INITDATA_OFFSET UNITYSDK_OFFSET(0x1C16E770)
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERBEHAVIOR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1C16EDF0)
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERBEHAVIOR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1C16EB80)
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERBEHAVIOR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1C16EF10)
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERBEHAVIOR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1C16ECB0)
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C16F030)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SkinnedMeshRendererBehavior_TypeDefinitionIndex = 30670;
