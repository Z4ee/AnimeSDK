...
#define MOLEMOLE_TIMELINE_EMOSYNCANIMATIONBEHAVIOR_METHOD_3_832295EC279E5994_1_OFFSET UNITYSDK_OFFSET(0x1A1AF380)
#define MOLEMOLE_TIMELINE_EMOSYNCANIMATIONBEHAVIOR_METHOD_3_832295EC279E5994_2_OFFSET UNITYSDK_OFFSET(0x1A1AF390)
#define MOLEMOLE_TIMELINE_EMOSYNCANIMATIONBEHAVIOR_METHOD_3_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x1A1AF370)
#define MOLEMOLE_TIMELINE_EMOSYNCANIMATIONBEHAVIOR_METHOD_3_ED01C45E2F8DB392_OFFSET UNITYSDK_OFFSET(0x1A1AF360)
#define MOLEMOLE_TIMELINE_EMOSYNCANIMATIONBEHAVIOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A1AF2C0)
#define MOLEMOLE_TIMELINE_EMOSYNCANIMATIONBEHAVIOR_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1A1AECF0)
#define MOLEMOLE_TIMELINE_EMOSYNCANIMATIONBEHAVIOR_ONPLAY_OFFSET UNITYSDK_OFFSET(0x1A1AE8B0)
#define MOLEMOLE_TIMELINE_EMOSYNCANIMATIONBEHAVIOR_ONPROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1A1AF080)
#define MOLEMOLE_TIMELINE_EMOSYNCANIMATIONBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1AF310)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int EmoSyncAnimationBehavior_TypeDefinitionIndex = 61101;
