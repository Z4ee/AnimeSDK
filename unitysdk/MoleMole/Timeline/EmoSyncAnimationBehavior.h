...
#define MOLEMOLE_TIMELINE_EMOSYNCANIMATIONBEHAVIOR_METHOD_3_832295EC279E5994_1_OFFSET UNITYSDK_OFFSET(0x15BB8930)
#define MOLEMOLE_TIMELINE_EMOSYNCANIMATIONBEHAVIOR_METHOD_3_832295EC279E5994_2_OFFSET UNITYSDK_OFFSET(0x15BB8940)
#define MOLEMOLE_TIMELINE_EMOSYNCANIMATIONBEHAVIOR_METHOD_3_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x15BB8920)
#define MOLEMOLE_TIMELINE_EMOSYNCANIMATIONBEHAVIOR_METHOD_3_ED01C45E2F8DB392_OFFSET UNITYSDK_OFFSET(0x15BB8950)
#define MOLEMOLE_TIMELINE_EMOSYNCANIMATIONBEHAVIOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x15BB8880)
#define MOLEMOLE_TIMELINE_EMOSYNCANIMATIONBEHAVIOR_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x15BB82B0)
#define MOLEMOLE_TIMELINE_EMOSYNCANIMATIONBEHAVIOR_ONPLAY_OFFSET UNITYSDK_OFFSET(0x15BB7E70)
#define MOLEMOLE_TIMELINE_EMOSYNCANIMATIONBEHAVIOR_ONPROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x15BB8640)
#define MOLEMOLE_TIMELINE_EMOSYNCANIMATIONBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x15BB88D0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int EmoSyncAnimationBehavior_TypeDefinitionIndex = 65683;
