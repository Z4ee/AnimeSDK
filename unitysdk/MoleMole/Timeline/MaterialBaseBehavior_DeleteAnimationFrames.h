...
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_DELETEANIMATIONFRAMES_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DD94420)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_DELETEANIMATIONFRAMES_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DD94460)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_DELETEANIMATIONFRAMES_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DD93EA0)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_DELETEANIMATIONFRAMES__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD93E80)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MaterialBaseBehavior_DeleteAnimationFrames_TypeDefinitionIndex = 32167;
