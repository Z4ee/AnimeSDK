...
#define MOLEMOLE_TIMELINE_WWISESWITCHBEHAVIOUR_METHOD_3_258333C2E3556047_OFFSET UNITYSDK_OFFSET(0x15E31D10)
#define MOLEMOLE_TIMELINE_WWISESWITCHBEHAVIOUR_METHOD_3_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x15E32360)
#define MOLEMOLE_TIMELINE_WWISESWITCHBEHAVIOUR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x15E31FB0)
#define MOLEMOLE_TIMELINE_WWISESWITCHBEHAVIOUR_METHOD_3_ACE4204EBB1CE487_OFFSET UNITYSDK_OFFSET(0x15E32060)
#define MOLEMOLE_TIMELINE_WWISESWITCHBEHAVIOUR_METHOD_3_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x15E32370)
#define MOLEMOLE_TIMELINE_WWISESWITCHBEHAVIOUR_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x15E322D0)
#define MOLEMOLE_TIMELINE_WWISESWITCHBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0x15E32010)
#define MOLEMOLE_TIMELINE_WWISESWITCHBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x15E322C0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int WwiseSwitchBehaviour_TypeDefinitionIndex = 64597;
