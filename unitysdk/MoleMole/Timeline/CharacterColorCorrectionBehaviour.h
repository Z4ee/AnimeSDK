...
#include "unitysdk/MoleMole/Timeline/CharacterColorCorrectionBehaviour_Struct_2_52AD02145F5FCE3A_5.h"
...
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x160F1DD0)
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_1_OFFSET UNITYSDK_OFFSET(0x160F8A90)
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x160F8A50)
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x160F8A70)
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONBEHAVIOUR_METHOD_4_8DC55F996A78F0A1_OFFSET UNITYSDK_OFFSET(0x160F3220)
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONBEHAVIOUR_METHOD_4_93082AD116A0F4EE_OFFSET UNITYSDK_OFFSET(0x160F28E0)
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x160F8A80)
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x160F8A60)
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONBEHAVIOUR_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0x160F1CD0)
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x160F2CD0)
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x160F6D60)
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x160F73C0)
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x160F8860)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int CharacterColorCorrectionBehaviour_TypeDefinitionIndex = 49899;

	class CharacterColorCorrectionBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::CharacterColorCorrectionBehaviour_Struct_2_52AD02145F5FCE3A_5 _methodParm; // 0x18
