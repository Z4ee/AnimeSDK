...
#define MOLEMOLE_TIMELINE_FXCOLORCORRECTIONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x11DFDDD0)
#define MOLEMOLE_TIMELINE_FXCOLORCORRECTIONCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x11DFDDC0)
#define MOLEMOLE_TIMELINE_FXCOLORCORRECTIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x11DFDFB0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int FXColorCorrectionClip_TypeDefinitionIndex = 46042;
