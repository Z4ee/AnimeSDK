...
#define MOLEMOLE_TIMELINE_FXCOLORCORRECTIONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1839DBF0)
#define MOLEMOLE_TIMELINE_FXCOLORCORRECTIONCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1839DBE0)
#define MOLEMOLE_TIMELINE_FXCOLORCORRECTIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1839DDD0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int FXColorCorrectionClip_TypeDefinitionIndex = 49102;
