...
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_ANIMATIONCLIPINFO_UNLOADACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E5A86F0)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_ANIMATIONCLIPINFO_UNLOADACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E5A8720)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_ANIMATIONCLIPINFO_UNLOADACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E5A81F0)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_ANIMATIONCLIPINFO_UNLOADACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5A81D0)

namespace MoleMole::Timeline::OverrideAnimation
{
	inline static constexpr unsigned int AnimationClipInfo_UnloadAction_TypeDefinitionIndex = 32233;
