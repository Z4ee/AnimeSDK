...
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_CONFIGSKINMAPANIMATIONCLIPDATA_GETSKINIDACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DE5F2D0)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_CONFIGSKINMAPANIMATIONCLIPDATA_GETSKINIDACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DE5F340)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_CONFIGSKINMAPANIMATIONCLIPDATA_GETSKINIDACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DE5EFE0)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_CONFIGSKINMAPANIMATIONCLIPDATA_GETSKINIDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE5EFC0)

namespace MoleMole::Timeline::OverrideAnimation
{
	inline static constexpr unsigned int ConfigSkinMapAnimationClipData_GetSkinIDAction_TypeDefinitionIndex = 32230;
