...
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_CONFIGSKINMAPANIMATIONCLIPDATA_GETSKINIDACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BB0AF60)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_CONFIGSKINMAPANIMATIONCLIPDATA_GETSKINIDACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BB0AFD0)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_CONFIGSKINMAPANIMATIONCLIPDATA_GETSKINIDACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BB0AC60)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_CONFIGSKINMAPANIMATIONCLIPDATA_GETSKINIDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB0AC50)

namespace MoleMole::Timeline::OverrideAnimation
{
	inline static constexpr unsigned int ConfigSkinMapAnimationClipData_GetSkinIDAction_TypeDefinitionIndex = 30679;
