...
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_ANIMATIONCLIPINFO_LOADASSETSYNCACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B79F9E0)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_ANIMATIONCLIPINFO_LOADASSETSYNCACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B79FA10)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_ANIMATIONCLIPINFO_LOADASSETSYNCACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B79F4A0)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_ANIMATIONCLIPINFO_LOADASSETSYNCACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B79F490)

namespace MoleMole::Timeline::OverrideAnimation
{
	inline static constexpr unsigned int AnimationClipInfo_LoadAssetSyncAction_TypeDefinitionIndex = 30681;
