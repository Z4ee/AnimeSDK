...
#include "unitysdk/MoleMole/Timeline/ColorCurvesBehaviour_Struct_2_52AD02145F5FCE3A_21.h"
...
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x15860400)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x15860BF0)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_METHOD_4_14A23FA2A72FB463_OFFSET UNITYSDK_OFFSET(0x158606D0)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x15861CD0)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x15861CF0)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x15861D00)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x15861CE0)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x15860AC0)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x15861770)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x158619B0)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x15861CC0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ColorCurvesBehaviour_TypeDefinitionIndex = 66873;

	class ColorCurvesBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::ColorCurvesBehaviour_Struct_2_52AD02145F5FCE3A_21 _methodParm; // 0x18
