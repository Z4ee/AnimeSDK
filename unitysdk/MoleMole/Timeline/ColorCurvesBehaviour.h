...
#include "unitysdk/MoleMole/Timeline/ColorCurvesBehaviour_Struct_2_52AD02145F5FCE3A_30.h"
...
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x180A2C90)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x180A3480)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_METHOD_4_14A23FA2A72FB463_OFFSET UNITYSDK_OFFSET(0x180A2F60)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x180A4520)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x180A4530)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x180A4510)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x180A4500)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x180A3350)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x180A3FA0)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x180A41E0)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x180A44F0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ColorCurvesBehaviour_TypeDefinitionIndex = 85056;

	class ColorCurvesBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::ColorCurvesBehaviour_Struct_2_52AD02145F5FCE3A_30 _methodParm; // 0x18
