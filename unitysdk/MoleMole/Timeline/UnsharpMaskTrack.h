...
#define MOLEMOLE_TIMELINE_UNSHARPMASKTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x173AADA0)
#define MOLEMOLE_TIMELINE_UNSHARPMASKTRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x173AB050)
#define MOLEMOLE_TIMELINE_UNSHARPMASKTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x173AAFF0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int UnsharpMaskTrack_TypeDefinitionIndex = 61897;
