...
#define MOLEMOLE_TIMELINE_CALLCAMERAEFFECTMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1817FD20)
#define MOLEMOLE_TIMELINE_CALLCAMERAEFFECTMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1817F520)
#define MOLEMOLE_TIMELINE_CALLCAMERAEFFECTMARKER_METHOD_4_111E3F406ABDDAA7_OFFSET UNITYSDK_OFFSET(0x1817FD60)
#define MOLEMOLE_TIMELINE_CALLCAMERAEFFECTMARKER_METHOD_4_9C6221085838BD79_OFFSET UNITYSDK_OFFSET(0x1817F530)
#define MOLEMOLE_TIMELINE_CALLCAMERAEFFECTMARKER_METHOD_4_AA94FB72678389C0_OFFSET UNITYSDK_OFFSET(0x1817FC80)
#define MOLEMOLE_TIMELINE_CALLCAMERAEFFECTMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1817FCD0)
#define MOLEMOLE_TIMELINE_CALLCAMERAEFFECTMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1817FDB0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int CallCameraEffectMarker_TypeDefinitionIndex = 65915;
	...
	public:
		...
		::System::Void Method_4_9C6221085838BD79(::Struct_2_6CC2897B74C41026_1 a1)
		{
			return ((::System::Void(*)(::PVOID, ::Struct_2_6CC2897B74C41026_1))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_CALLCAMERAEFFECTMARKER_METHOD_4_9C6221085838BD79_OFFSET))(this, a1);
		}

		::System::Void Method_4_AA94FB72678389C0(::Struct_2_6CC2897B74C41026_1 a1, ::System::Boolean a2)
		{
			return ((::System::Void(*)(::PVOID, ::Struct_2_6CC2897B74C41026_1, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_CALLCAMERAEFFECTMARKER_METHOD_4_AA94FB72678389C0_OFFSET))(this, a1, a2);
		}
