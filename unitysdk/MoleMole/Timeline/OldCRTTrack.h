...
#define MOLEMOLE_TIMELINE_OLDCRTTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x18D144C0)
#define MOLEMOLE_TIMELINE_OLDCRTTRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x18D14770)
#define MOLEMOLE_TIMELINE_OLDCRTTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18D14710)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int OldCRTTrack_TypeDefinitionIndex = 59790;
