...
#define MOLEMOLE_TIMELINE_RTXVOLUMETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x174086A0)
#define MOLEMOLE_TIMELINE_RTXVOLUMETRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x17408950)
#define MOLEMOLE_TIMELINE_RTXVOLUMETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x174088F0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int RTXVolumeTrack_TypeDefinitionIndex = 64308;
