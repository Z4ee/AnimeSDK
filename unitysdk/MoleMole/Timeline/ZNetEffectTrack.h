...
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_CANCUSTOMRECORD_OFFSET UNITYSDK_OFFSET(0x19194E90)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19193CC0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x191952C0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_CUSTOMGETRECORDANIMCLIPIMP_OFFSET UNITYSDK_OFFSET(0x19195010)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_CUSTOMGETSCENEGAMEOBJECTIMP_OFFSET UNITYSDK_OFFSET(0x19194F70)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_ERRORMSG_OFFSET UNITYSDK_OFFSET(0x19194B70)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_GATHERPROPERTIES_OFFSET UNITYSDK_OFFSET(0x19195370)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_ISCUSTOMGETRECORDANIMCLIP_OFFSET UNITYSDK_OFFSET(0x19194FD0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_ISCUSTOMGETSCENEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x19194F30)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_064D173F66ED9F75_OFFSET UNITYSDK_OFFSET(0x19195700)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_088F4E9DF96E14A7_OFFSET UNITYSDK_OFFSET(0x19194640)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x19195710)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_652F102150AC9967_OFFSET UNITYSDK_OFFSET(0x191956A0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_6D83AFEC7098FD7A_OFFSET UNITYSDK_OFFSET(0x191956E0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_6FF3EF6F619F22E9_OFFSET UNITYSDK_OFFSET(0x19194AD0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x19195610)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_9CA5A80F6B5B9E01_OFFSET UNITYSDK_OFFSET(0x19195670)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x19195630)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_BC46FCF99873D9DD_OFFSET UNITYSDK_OFFSET(0x19194E50)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_CC634B4673437CA3_OFFSET UNITYSDK_OFFSET(0x19195620)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x19195690)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_F0088C88851A7DFB_2_OFFSET UNITYSDK_OFFSET(0x191956F0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x19195680)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_ONDUPLICATETRACK_OFFSET UNITYSDK_OFFSET(0x19195280)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_ONMUTESTATECHANGE_OFFSET UNITYSDK_OFFSET(0x19195230)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x191955B0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ZNetEffectTrack_TypeDefinitionIndex = 44166;
