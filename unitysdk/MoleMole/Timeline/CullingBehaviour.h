...
#include "unitysdk/MoleMole/Timeline/CullingBehaviour_Struct_2_52AD02145F5FCE36_37.h"
...
#define MOLEMOLE_TIMELINE_CULLINGBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x1917B670)
#define MOLEMOLE_TIMELINE_CULLINGBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x1917E4D0)
#define MOLEMOLE_TIMELINE_CULLINGBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x1917E4E0)
#define MOLEMOLE_TIMELINE_CULLINGBEHAVIOUR_METHOD_4_8DC55F996A78F0A1_OFFSET UNITYSDK_OFFSET(0x1917C040)
#define MOLEMOLE_TIMELINE_CULLINGBEHAVIOUR_METHOD_4_9B97EC47CC6F2369_OFFSET UNITYSDK_OFFSET(0x1917BAE0)
#define MOLEMOLE_TIMELINE_CULLINGBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x1917E4F0)
#define MOLEMOLE_TIMELINE_CULLINGBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x1917E4C0)
#define MOLEMOLE_TIMELINE_CULLINGBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1917BED0)
#define MOLEMOLE_TIMELINE_CULLINGBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1917DB20)
#define MOLEMOLE_TIMELINE_CULLINGBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1917DDA0)
#define MOLEMOLE_TIMELINE_CULLINGBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1917E480)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int CullingBehaviour_TypeDefinitionIndex = 78004;

	class CullingBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::CullingBehaviour_Struct_2_52AD02145F5FCE36_37 _methodParm; // 0x18
