...
#define MOLEMOLE_TIMELINE_SENDABILITYCUSTOMEVENTMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1B2199C0)
#define MOLEMOLE_TIMELINE_SENDABILITYCUSTOMEVENTMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1B219A00)
#define MOLEMOLE_TIMELINE_SENDABILITYCUSTOMEVENTMARKER_METHOD_4_09E78DEC01D6F816_OFFSET UNITYSDK_OFFSET(0x1B2198D0)
#define MOLEMOLE_TIMELINE_SENDABILITYCUSTOMEVENTMARKER_METHOD_4_0E3D8071A5930FA8_OFFSET UNITYSDK_OFFSET(0x1B2194D0)
#define MOLEMOLE_TIMELINE_SENDABILITYCUSTOMEVENTMARKER_METHOD_4_567EC27AC5C589E5_OFFSET UNITYSDK_OFFSET(0x1B219A10)
#define MOLEMOLE_TIMELINE_SENDABILITYCUSTOMEVENTMARKER_METHOD_4_E651218EB2CC654F_OFFSET UNITYSDK_OFFSET(0x1B219480)
#define MOLEMOLE_TIMELINE_SENDABILITYCUSTOMEVENTMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1B219940)
#define MOLEMOLE_TIMELINE_SENDABILITYCUSTOMEVENTMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B219AA0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SendAbilityCustomEventMarker_TypeDefinitionIndex = 40843;
