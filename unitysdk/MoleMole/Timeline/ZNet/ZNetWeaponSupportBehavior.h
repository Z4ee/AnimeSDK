...
#define MOLEMOLE_TIMELINE_ZNET_ZNETWEAPONSUPPORTBEHAVIOR_METHOD_2_E5E342154D4EA5F5_OFFSET UNITYSDK_OFFSET(0x152C08E0)
#define MOLEMOLE_TIMELINE_ZNET_ZNETWEAPONSUPPORTBEHAVIOR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x152C0530)
#define MOLEMOLE_TIMELINE_ZNET_ZNETWEAPONSUPPORTBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x152C08D0)

namespace MoleMole::Timeline::ZNet
{
	inline static constexpr unsigned int ZNetWeaponSupportBehavior_TypeDefinitionIndex = 82085;
