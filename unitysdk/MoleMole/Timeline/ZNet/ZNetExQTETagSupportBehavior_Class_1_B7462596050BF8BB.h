...
#define MOLEMOLE_TIMELINE_ZNET_ZNETEXQTETAGSUPPORTBEHAVIOR_CLASS_1_B7462596050BF8BB_METHOD_1_CDBDCC08F9B3AFF8_OFFSET UNITYSDK_OFFSET(0x1586A0F0)
#define MOLEMOLE_TIMELINE_ZNET_ZNETEXQTETAGSUPPORTBEHAVIOR_CLASS_1_B7462596050BF8BB__CTOR_OFFSET UNITYSDK_OFFSET(0x1586A0E0)

namespace MoleMole::Timeline::ZNet
{
	inline static constexpr unsigned int ZNetExQTETagSupportBehavior_Class_1_B7462596050BF8BB_TypeDefinitionIndex = 51014;
