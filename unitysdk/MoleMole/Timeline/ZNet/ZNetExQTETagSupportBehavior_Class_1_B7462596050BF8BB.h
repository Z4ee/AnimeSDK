...
#define MOLEMOLE_TIMELINE_ZNET_ZNETEXQTETAGSUPPORTBEHAVIOR_CLASS_1_B7462596050BF8BB_METHOD_1_CDBDCC08F9B3AFF8_OFFSET UNITYSDK_OFFSET(0x19193A90)
#define MOLEMOLE_TIMELINE_ZNET_ZNETEXQTETAGSUPPORTBEHAVIOR_CLASS_1_B7462596050BF8BB__CTOR_OFFSET UNITYSDK_OFFSET(0x19193A80)

namespace MoleMole::Timeline::ZNet
{
	inline static constexpr unsigned int ZNetExQTETagSupportBehavior_Class_1_B7462596050BF8BB_TypeDefinitionIndex = 80701;
