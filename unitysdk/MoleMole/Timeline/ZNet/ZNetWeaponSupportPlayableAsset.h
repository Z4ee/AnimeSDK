...
#define MOLEMOLE_TIMELINE_ZNET_ZNETWEAPONSUPPORTPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x13896B00)
#define MOLEMOLE_TIMELINE_ZNET_ZNETWEAPONSUPPORTPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x13896AF0)
#define MOLEMOLE_TIMELINE_ZNET_ZNETWEAPONSUPPORTPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x13896C50)

namespace MoleMole::Timeline::ZNet
{
	inline static constexpr unsigned int ZNetWeaponSupportPlayableAsset_TypeDefinitionIndex = 78536;
