...
#define MOLEMOLE_TIMELINE_ZNET_ZNETCAMERASUPPORTTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x15B6A6D0)
#define MOLEMOLE_TIMELINE_ZNET_ZNETCAMERASUPPORTTRACK_METHOD_5_652F102150AC9967_OFFSET UNITYSDK_OFFSET(0x15B6AB50)
#define MOLEMOLE_TIMELINE_ZNET_ZNETCAMERASUPPORTTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x15B6AAF0)

namespace MoleMole::Timeline::ZNet
{
	inline static constexpr unsigned int ZNetCameraSupportTrack_TypeDefinitionIndex = 81691;
