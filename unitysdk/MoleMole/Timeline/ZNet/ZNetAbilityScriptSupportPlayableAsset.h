...
#define MOLEMOLE_TIMELINE_ZNET_ZNETABILITYSCRIPTSUPPORTPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x15BCC4F0)
#define MOLEMOLE_TIMELINE_ZNET_ZNETABILITYSCRIPTSUPPORTPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x15BCC4E0)
#define MOLEMOLE_TIMELINE_ZNET_ZNETABILITYSCRIPTSUPPORTPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x15BCC640)

namespace MoleMole::Timeline::ZNet
{
	inline static constexpr unsigned int ZNetAbilityScriptSupportPlayableAsset_TypeDefinitionIndex = 46671;
