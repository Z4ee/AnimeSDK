...
#define MOLEMOLE_TIMELINE_ZNET_ZNETABILITYSCRIPTSUPPORTPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x168A6E50)
#define MOLEMOLE_TIMELINE_ZNET_ZNETABILITYSCRIPTSUPPORTPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x168A6E40)
#define MOLEMOLE_TIMELINE_ZNET_ZNETABILITYSCRIPTSUPPORTPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x168A6FA0)

namespace MoleMole::Timeline::ZNet
{
	inline static constexpr unsigned int ZNetAbilityScriptSupportPlayableAsset_TypeDefinitionIndex = 64752;
