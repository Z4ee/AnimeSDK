...
#define MOLEMOLE_TIMELINE_ZNET_ZNETWEAPONSUPPORTTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x126699E0)
#define MOLEMOLE_TIMELINE_ZNET_ZNETWEAPONSUPPORTTRACK_METHOD_5_652F102150AC9967_OFFSET UNITYSDK_OFFSET(0x12669AF0)
#define MOLEMOLE_TIMELINE_ZNET_ZNETWEAPONSUPPORTTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x12669A90)

namespace MoleMole::Timeline::ZNet
{
	inline static constexpr unsigned int ZNetWeaponSupportTrack_TypeDefinitionIndex = 41394;
