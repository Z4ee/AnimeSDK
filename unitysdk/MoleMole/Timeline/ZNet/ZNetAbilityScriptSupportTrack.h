...
#define MOLEMOLE_TIMELINE_ZNET_ZNETABILITYSCRIPTSUPPORTTRACK_CANMOVEBYUSERINTIMELINE_OFFSET UNITYSDK_OFFSET(0x13F36630)
#define MOLEMOLE_TIMELINE_ZNET_ZNETABILITYSCRIPTSUPPORTTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x13F36580)
#define MOLEMOLE_TIMELINE_ZNET_ZNETABILITYSCRIPTSUPPORTTRACK_METHOD_5_652F102150AC9967_OFFSET UNITYSDK_OFFSET(0x13F366D0)
#define MOLEMOLE_TIMELINE_ZNET_ZNETABILITYSCRIPTSUPPORTTRACK_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x13F36710)
#define MOLEMOLE_TIMELINE_ZNET_ZNETABILITYSCRIPTSUPPORTTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x13F36670)

namespace MoleMole::Timeline::ZNet
{
	inline static constexpr unsigned int ZNetAbilityScriptSupportTrack_TypeDefinitionIndex = 43997;
