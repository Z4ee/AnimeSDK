...
#define MOLEMOLE_TIMELINE_ZNET_ZNETCAMERASUPPORTBEHAVIOR_METHOD_2_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x15E32E60)
#define MOLEMOLE_TIMELINE_ZNET_ZNETCAMERASUPPORTBEHAVIOR_METHOD_2_79ED6854413CA2F4_1_OFFSET UNITYSDK_OFFSET(0x15E32E40)
#define MOLEMOLE_TIMELINE_ZNET_ZNETCAMERASUPPORTBEHAVIOR_METHOD_2_79ED6854413CA2F4_OFFSET UNITYSDK_OFFSET(0x15E32E30)
#define MOLEMOLE_TIMELINE_ZNET_ZNETCAMERASUPPORTBEHAVIOR_METHOD_2_8F54650C0C7FD373_OFFSET UNITYSDK_OFFSET(0x15E32B50)
#define MOLEMOLE_TIMELINE_ZNET_ZNETCAMERASUPPORTBEHAVIOR_METHOD_2_D54168B31758A2FD_OFFSET UNITYSDK_OFFSET(0x15E326A0)
#define MOLEMOLE_TIMELINE_ZNET_ZNETCAMERASUPPORTBEHAVIOR_METHOD_2_E5E342154D4EA5F5_OFFSET UNITYSDK_OFFSET(0x15E32E50)
#define MOLEMOLE_TIMELINE_ZNET_ZNETCAMERASUPPORTBEHAVIOR_METHOD_2_F136A0FCD546DBA6_OFFSET UNITYSDK_OFFSET(0x15E32990)
#define MOLEMOLE_TIMELINE_ZNET_ZNETCAMERASUPPORTBEHAVIOR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x15E32D00)
#define MOLEMOLE_TIMELINE_ZNET_ZNETCAMERASUPPORTBEHAVIOR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x15E32DA0)
#define MOLEMOLE_TIMELINE_ZNET_ZNETCAMERASUPPORTBEHAVIOR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x15E32CA0)
#define MOLEMOLE_TIMELINE_ZNET_ZNETCAMERASUPPORTBEHAVIOR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x15E32400)
#define MOLEMOLE_TIMELINE_ZNET_ZNETCAMERASUPPORTBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x15E32E20)

namespace MoleMole::Timeline::ZNet
{
	inline static constexpr unsigned int ZNetCameraSupportBehavior_TypeDefinitionIndex = 66767;
