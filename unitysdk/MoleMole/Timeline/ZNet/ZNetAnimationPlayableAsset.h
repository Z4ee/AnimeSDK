...
#define MOLEMOLE_TIMELINE_ZNET_ZNETANIMATIONPLAYABLEASSET_METHOD_5_C50A2293958CA940_1_OFFSET UNITYSDK_OFFSET(0x13865E90)
#define MOLEMOLE_TIMELINE_ZNET_ZNETANIMATIONPLAYABLEASSET_METHOD_5_C50A2293958CA940_OFFSET UNITYSDK_OFFSET(0x13865E10)
#define MOLEMOLE_TIMELINE_ZNET_ZNETANIMATIONPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x13865C70)

namespace MoleMole::Timeline::ZNet
{
	inline static constexpr unsigned int ZNetAnimationPlayableAsset_TypeDefinitionIndex = 42275;
