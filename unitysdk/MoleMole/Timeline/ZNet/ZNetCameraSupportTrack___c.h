...
#define MOLEMOLE_TIMELINE_ZNET_ZNETCAMERASUPPORTTRACK___C_METHOD_1_735B19F2BDC753A9_OFFSET UNITYSDK_OFFSET(0x17066940)
#define MOLEMOLE_TIMELINE_ZNET_ZNETCAMERASUPPORTTRACK___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x170668F0)
#define MOLEMOLE_TIMELINE_ZNET_ZNETCAMERASUPPORTTRACK___C__CTOR_OFFSET UNITYSDK_OFFSET(0x17066930)

namespace MoleMole::Timeline::ZNet
{
	inline static constexpr unsigned int ZNetCameraSupportTrack___c_TypeDefinitionIndex = 81692;
	...
	public:
		...
		{
			return (::MoleMole::Timeline::ZNet::ZNetCameraSupportTrack___c**)Il2CppClass::FromTypeDefinitionIndex(ZNetCameraSupportTrack___c_TypeDefinitionIndex)->GetStaticField(0x34CA0);
		}
		static ::System::Func_2<::MoleMole::Timeline::ZNet::ZNetGroupTrack*, ::System::Boolean>** StaticGet___9__0_1()
		{
			return (::System::Func_2<::MoleMole::Timeline::ZNet::ZNetGroupTrack*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(ZNetCameraSupportTrack___c_TypeDefinitionIndex)->GetStaticField(0x34CA8);
		}
