...
#define MOLEMOLE_TIMELINE_ZNET_ZNETEXQTETAGSUPPORTTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x141BE8D0)
#define MOLEMOLE_TIMELINE_ZNET_ZNETEXQTETAGSUPPORTTRACK_METHOD_5_652F102150AC9967_OFFSET UNITYSDK_OFFSET(0x141BEF40)
#define MOLEMOLE_TIMELINE_ZNET_ZNETEXQTETAGSUPPORTTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x141BEEE0)

namespace MoleMole::Timeline::ZNet
{
	inline static constexpr unsigned int ZNetExQTETagSupportTrack_TypeDefinitionIndex = 45839;
