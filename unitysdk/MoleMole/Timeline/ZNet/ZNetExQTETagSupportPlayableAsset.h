...
#define MOLEMOLE_TIMELINE_ZNET_ZNETEXQTETAGSUPPORTPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B6CB0A0)
#define MOLEMOLE_TIMELINE_ZNET_ZNETEXQTETAGSUPPORTPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B6CB090)
#define MOLEMOLE_TIMELINE_ZNET_ZNETEXQTETAGSUPPORTPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6CB1F0)

namespace MoleMole::Timeline::ZNet
{
	inline static constexpr unsigned int ZNetExQTETagSupportPlayableAsset_TypeDefinitionIndex = 84055;
