...
#define MOLEMOLE_TIMELINE_ZNET_ZNETEXQTETAGSUPPORTPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19193AD0)
#define MOLEMOLE_TIMELINE_ZNET_ZNETEXQTETAGSUPPORTPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19193AC0)
#define MOLEMOLE_TIMELINE_ZNET_ZNETEXQTETAGSUPPORTPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x19193C20)

namespace MoleMole::Timeline::ZNet
{
	inline static constexpr unsigned int ZNetExQTETagSupportPlayableAsset_TypeDefinitionIndex = 46439;
