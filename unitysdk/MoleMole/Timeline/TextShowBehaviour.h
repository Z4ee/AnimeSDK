...
#define MOLEMOLE_TIMELINE_TEXTSHOWBEHAVIOUR_METHOD_2_79ED6854413CA2F4_OFFSET UNITYSDK_OFFSET(0x15A71E10)
#define MOLEMOLE_TIMELINE_TEXTSHOWBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x15A71D80)
#define MOLEMOLE_TIMELINE_TEXTSHOWBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x15A71E00)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TextShowBehaviour_TypeDefinitionIndex = 57192;
