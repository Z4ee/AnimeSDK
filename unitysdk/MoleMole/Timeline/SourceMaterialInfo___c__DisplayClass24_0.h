...
#define MOLEMOLE_TIMELINE_SOURCEMATERIALINFO___C__DISPLAYCLASS24_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C447F50)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALINFO___C__DISPLAYCLASS24_0__RECOVER_B__0_OFFSET UNITYSDK_OFFSET(0x1C447F60)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SourceMaterialInfo___c__DisplayClass24_0_TypeDefinitionIndex = 30646;
