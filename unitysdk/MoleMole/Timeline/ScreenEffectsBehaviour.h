...
#include "unitysdk/MoleMole/Timeline/ScreenEffectsBehaviour_Struct_2_52AD02145F5FCE3A_16.h"
...
#define MOLEMOLE_TIMELINE_SCREENEFFECTSBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x1B20D180)
#define MOLEMOLE_TIMELINE_SCREENEFFECTSBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x1B219450)
#define MOLEMOLE_TIMELINE_SCREENEFFECTSBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x1B219440)
#define MOLEMOLE_TIMELINE_SCREENEFFECTSBEHAVIOUR_METHOD_4_68160D9981ECFFF0_OFFSET UNITYSDK_OFFSET(0x1B20F070)
#define MOLEMOLE_TIMELINE_SCREENEFFECTSBEHAVIOUR_METHOD_4_9A07A7A56A979E43_OFFSET UNITYSDK_OFFSET(0x1B20E310)
#define MOLEMOLE_TIMELINE_SCREENEFFECTSBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x1B219470)
#define MOLEMOLE_TIMELINE_SCREENEFFECTSBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x1B219460)
#define MOLEMOLE_TIMELINE_SCREENEFFECTSBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1B20E700)
#define MOLEMOLE_TIMELINE_SCREENEFFECTSBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1B216900)
#define MOLEMOLE_TIMELINE_SCREENEFFECTSBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1B217380)
#define MOLEMOLE_TIMELINE_SCREENEFFECTSBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2192E0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ScreenEffectsBehaviour_TypeDefinitionIndex = 57750;

	class ScreenEffectsBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::ScreenEffectsBehaviour_Struct_2_52AD02145F5FCE3A_16 _methodParm; // 0x18
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_SCREENEFFECTSBEHAVIOUR_METHOD_4_68160D9981ECFFF0_OFFSET))(this);
		}
