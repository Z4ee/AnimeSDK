...
#include "unitysdk/MoleMole/Timeline/ScreenEffectsBehaviour_Struct_2_52AD02145F5FCE3A_23.h"
...
#define MOLEMOLE_TIMELINE_SCREENEFFECTSBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x170543E0)
#define MOLEMOLE_TIMELINE_SCREENEFFECTSBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x17060730)
#define MOLEMOLE_TIMELINE_SCREENEFFECTSBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x17060710)
#define MOLEMOLE_TIMELINE_SCREENEFFECTSBEHAVIOUR_METHOD_4_95F0B0E4A30C4E0A_OFFSET UNITYSDK_OFFSET(0x170562D0)
#define MOLEMOLE_TIMELINE_SCREENEFFECTSBEHAVIOUR_METHOD_4_9A07A7A56A979E43_OFFSET UNITYSDK_OFFSET(0x17055570)
#define MOLEMOLE_TIMELINE_SCREENEFFECTSBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x17060740)
#define MOLEMOLE_TIMELINE_SCREENEFFECTSBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x17060720)
#define MOLEMOLE_TIMELINE_SCREENEFFECTSBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x17055960)
#define MOLEMOLE_TIMELINE_SCREENEFFECTSBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1705DBD0)
#define MOLEMOLE_TIMELINE_SCREENEFFECTSBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1705E650)
#define MOLEMOLE_TIMELINE_SCREENEFFECTSBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x170605B0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ScreenEffectsBehaviour_TypeDefinitionIndex = 72866;

	class ScreenEffectsBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::ScreenEffectsBehaviour_Struct_2_52AD02145F5FCE3A_23 _methodParm; // 0x18
