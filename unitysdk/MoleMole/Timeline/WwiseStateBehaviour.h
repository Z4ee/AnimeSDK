...
#define MOLEMOLE_TIMELINE_WWISESTATEBEHAVIOUR_METHOD_2_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x1871C850)
#define MOLEMOLE_TIMELINE_WWISESTATEBEHAVIOUR_METHOD_2_79ED6854413CA2F4_OFFSET UNITYSDK_OFFSET(0x1871C860)
#define MOLEMOLE_TIMELINE_WWISESTATEBEHAVIOUR_METHOD_2_C638E91FC0D3A13A_OFFSET UNITYSDK_OFFSET(0x1871C5C0)
#define MOLEMOLE_TIMELINE_WWISESTATEBEHAVIOUR_METHOD_2_E5E342154D4EA5F5_OFFSET UNITYSDK_OFFSET(0x1871C840)
#define MOLEMOLE_TIMELINE_WWISESTATEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1871C530)
#define MOLEMOLE_TIMELINE_WWISESTATEBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0x1871C4E0)
#define MOLEMOLE_TIMELINE_WWISESTATEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1871C780)
#define MOLEMOLE_TIMELINE_WWISESTATEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1871C830)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int WwiseStateBehaviour_TypeDefinitionIndex = 58850;
