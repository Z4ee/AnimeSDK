...
class Class_2_B7243C9C64DCB5EF_Class_0_16E7307DCC43CB2C_6;
namespace System { class String; }

#define MOLEMOLE_TIMELINE_SUBTITLEBEHAVIOUR_METHOD_2_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x12B28190)
#define MOLEMOLE_TIMELINE_SUBTITLEBEHAVIOUR_METHOD_2_79ED6854413CA2F4_1_OFFSET UNITYSDK_OFFSET(0x12B28180)
#define MOLEMOLE_TIMELINE_SUBTITLEBEHAVIOUR_METHOD_2_79ED6854413CA2F4_OFFSET UNITYSDK_OFFSET(0x12B28170)
#define MOLEMOLE_TIMELINE_SUBTITLEBEHAVIOUR_METHOD_2_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0x12B27E10)
#define MOLEMOLE_TIMELINE_SUBTITLEBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x12B28010)
#define MOLEMOLE_TIMELINE_SUBTITLEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x12B27EB0)
#define MOLEMOLE_TIMELINE_SUBTITLEBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0x12B27CE0)
#define MOLEMOLE_TIMELINE_SUBTITLEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x12B28160)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SubtitleBehaviour_TypeDefinitionIndex = 39493;
	...
	public:
		...
		::Class_2_B7243C9C64DCB5EF_Class_0_16E7307DCC43CB2C_6* _subtitleViewer; // 0x20
