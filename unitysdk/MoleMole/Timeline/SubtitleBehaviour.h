...
#define MOLEMOLE_TIMELINE_SUBTITLEBEHAVIOUR_METHOD_2_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x160FCD90)
#define MOLEMOLE_TIMELINE_SUBTITLEBEHAVIOUR_METHOD_2_79ED6854413CA2F4_1_OFFSET UNITYSDK_OFFSET(0x160FCDB0)
#define MOLEMOLE_TIMELINE_SUBTITLEBEHAVIOUR_METHOD_2_79ED6854413CA2F4_OFFSET UNITYSDK_OFFSET(0x160FCDA0)
#define MOLEMOLE_TIMELINE_SUBTITLEBEHAVIOUR_METHOD_2_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0x160FCA30)
#define MOLEMOLE_TIMELINE_SUBTITLEBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x160FCC30)
#define MOLEMOLE_TIMELINE_SUBTITLEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x160FCAD0)
#define MOLEMOLE_TIMELINE_SUBTITLEBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0x160FC900)
#define MOLEMOLE_TIMELINE_SUBTITLEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x160FCD80)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SubtitleBehaviour_TypeDefinitionIndex = 61325;
	...
	public:
		...
		::Class_2_B7243C9C64DCB5EF_Class_0_16E7307DCC43CB2C_30* _subtitleViewer; // 0x20
