...
#include "unitysdk/MoleMole/Timeline/TonemappingBehaviour_Struct_2_52AD02145F5FCE36_21.h"
...
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x138946D0)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_METHOD_4_09FB03FCB9CD7B02_OFFSET UNITYSDK_OFFSET(0x13894960)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x13894E40)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x13895E50)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x13895E70)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x13895E80)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x13895E60)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x13894D50)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x13895870)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x13895A80)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x13895E20)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TonemappingBehaviour_TypeDefinitionIndex = 59277;

	class TonemappingBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::TonemappingBehaviour_Struct_2_52AD02145F5FCE36_21 _methodParm; // 0x18
