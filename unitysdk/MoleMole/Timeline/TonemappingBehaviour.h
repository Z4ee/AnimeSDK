...
#include "unitysdk/MoleMole/Timeline/TonemappingBehaviour_Struct_2_52AD02145F5FCE36_26.h"
...
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x1973F9E0)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_METHOD_4_09FB03FCB9CD7B02_OFFSET UNITYSDK_OFFSET(0x1973FC70)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x19740150)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x19741140)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x19741130)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x19741150)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x19741120)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x19740060)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x19740B40)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x19740D50)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x197410F0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TonemappingBehaviour_TypeDefinitionIndex = 73343;

	class TonemappingBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::TonemappingBehaviour_Struct_2_52AD02145F5FCE36_26 _methodParm; // 0x18
