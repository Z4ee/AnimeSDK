...
#include "unitysdk/MoleMole/Timeline/TonemappingBehaviour_Struct_2_52AD02145F5FCE36_41.h"
...
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x1819A560)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_METHOD_4_09FB03FCB9CD7B02_OFFSET UNITYSDK_OFFSET(0x1819A7F0)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x1819ACD0)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x1819BD10)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x1819BCE0)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x1819BD00)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x1819BCF0)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1819ABE0)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1819B700)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1819B910)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1819BCB0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TonemappingBehaviour_TypeDefinitionIndex = 84437;

	class TonemappingBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::TonemappingBehaviour_Struct_2_52AD02145F5FCE36_41 _methodParm; // 0x18
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET))(this);
		}

		::UnityEngine::Rendering::Universal::Tonemapping* Method_4_09FB03FCB9CD7B02(::System::Object* a1)
		{
			return ((::UnityEngine::Rendering::Universal::Tonemapping*(*)(::PVOID, ::System::Object*))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_METHOD_4_09FB03FCB9CD7B02_OFFSET))(this, a1);
		}
