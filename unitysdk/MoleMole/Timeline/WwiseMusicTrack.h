...
#define MOLEMOLE_TIMELINE_WWISEMUSICTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x17E22620)
#define MOLEMOLE_TIMELINE_WWISEMUSICTRACK_METHOD_5_67D41ACFEF39E84E_OFFSET UNITYSDK_OFFSET(0x17E22830)
#define MOLEMOLE_TIMELINE_WWISEMUSICTRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x17E22A50)
#define MOLEMOLE_TIMELINE_WWISEMUSICTRACK_METHOD_5_E69AA2E64A20143D_OFFSET UNITYSDK_OFFSET(0x17E22A90)
#define MOLEMOLE_TIMELINE_WWISEMUSICTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x17E22780)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int WwiseMusicTrack_TypeDefinitionIndex = 65149;
