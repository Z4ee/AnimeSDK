...
#define MOLEMOLE_TIMELINE_EMOSYNCANIMATIONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1387B280)
#define MOLEMOLE_TIMELINE_EMOSYNCANIMATIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1387B3D0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int EmoSyncAnimationClip_TypeDefinitionIndex = 80502;
