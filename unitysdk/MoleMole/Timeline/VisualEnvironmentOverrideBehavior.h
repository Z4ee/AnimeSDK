...
#define MOLEMOLE_TIMELINE_VISUALENVIRONMENTOVERRIDEBEHAVIOR_GET_REALPRIORITY_OFFSET UNITYSDK_OFFSET(0x11E06710)
#define MOLEMOLE_TIMELINE_VISUALENVIRONMENTOVERRIDEBEHAVIOR_METHOD_3_832295EC279E5994_1_OFFSET UNITYSDK_OFFSET(0x11E06D20)
#define MOLEMOLE_TIMELINE_VISUALENVIRONMENTOVERRIDEBEHAVIOR_METHOD_3_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x11E06D10)
#define MOLEMOLE_TIMELINE_VISUALENVIRONMENTOVERRIDEBEHAVIOR_METHOD_3_ED01C45E2F8DB392_OFFSET UNITYSDK_OFFSET(0x11E06D30)
#define MOLEMOLE_TIMELINE_VISUALENVIRONMENTOVERRIDEBEHAVIOR_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x11E068D0)
#define MOLEMOLE_TIMELINE_VISUALENVIRONMENTOVERRIDEBEHAVIOR_ONPLAY_OFFSET UNITYSDK_OFFSET(0x11E06720)
#define MOLEMOLE_TIMELINE_VISUALENVIRONMENTOVERRIDEBEHAVIOR_ONPROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x11E06A80)
#define MOLEMOLE_TIMELINE_VISUALENVIRONMENTOVERRIDEBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x11E06D00)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int VisualEnvironmentOverrideBehavior_TypeDefinitionIndex = 76345;
