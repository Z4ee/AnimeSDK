...
#include "unitysdk/MoleMole/Timeline/FilmGrainBehaviour_Struct_2_FFFE9480B3B5BA7A.h"
...
#define MOLEMOLE_TIMELINE_FILMGRAINBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x16432440)
#define MOLEMOLE_TIMELINE_FILMGRAINBEHAVIOUR_METHOD_4_2913D2774D363840_OFFSET UNITYSDK_OFFSET(0x16432650)
#define MOLEMOLE_TIMELINE_FILMGRAINBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x16433680)
#define MOLEMOLE_TIMELINE_FILMGRAINBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x16433670)
#define MOLEMOLE_TIMELINE_FILMGRAINBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x16433660)
#define MOLEMOLE_TIMELINE_FILMGRAINBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x16433650)
#define MOLEMOLE_TIMELINE_FILMGRAINBEHAVIOUR_METHOD_4_BC76C3D43591A39D_OFFSET UNITYSDK_OFFSET(0x16432AF0)
#define MOLEMOLE_TIMELINE_FILMGRAINBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x16432A40)
#define MOLEMOLE_TIMELINE_FILMGRAINBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x164331A0)
#define MOLEMOLE_TIMELINE_FILMGRAINBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x16433370)
#define MOLEMOLE_TIMELINE_FILMGRAINBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x16433630)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int FilmGrainBehaviour_TypeDefinitionIndex = 60818;

	class FilmGrainBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::FilmGrainBehaviour_Struct_2_FFFE9480B3B5BA7A _methodParm; // 0x18
