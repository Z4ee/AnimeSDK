...
#define MOLEMOLE_TIMELINE_FILMGRAINBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x158622F0)
#define MOLEMOLE_TIMELINE_FILMGRAINBEHAVIOUR_METHOD_4_2913D2774D363840_OFFSET UNITYSDK_OFFSET(0x15862500)
#define MOLEMOLE_TIMELINE_FILMGRAINBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x15863530)
#define MOLEMOLE_TIMELINE_FILMGRAINBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x15863520)
#define MOLEMOLE_TIMELINE_FILMGRAINBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x15863510)
#define MOLEMOLE_TIMELINE_FILMGRAINBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x15863500)
#define MOLEMOLE_TIMELINE_FILMGRAINBEHAVIOUR_METHOD_4_BC76C3D43591A39D_OFFSET UNITYSDK_OFFSET(0x158629A0)
#define MOLEMOLE_TIMELINE_FILMGRAINBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x158628F0)
#define MOLEMOLE_TIMELINE_FILMGRAINBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x15863050)
#define MOLEMOLE_TIMELINE_FILMGRAINBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x15863220)
#define MOLEMOLE_TIMELINE_FILMGRAINBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x158634E0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int FilmGrainBehaviour_TypeDefinitionIndex = 50536;
