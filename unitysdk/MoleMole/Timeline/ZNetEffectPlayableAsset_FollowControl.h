...
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_GET_BINDINGTRANS_OFFSET UNITYSDK_OFFSET(0x168A71C0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_GET_UNATTACHENDFRAME_OFFSET UNITYSDK_OFFSET(0x168A83A0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_GET_UNATTACHMAXENDFRAME_OFFSET UNITYSDK_OFFSET(0x168A80B0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_GET_USEUNATTACHCONFIG_OFFSET UNITYSDK_OFFSET(0x168A7CB0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_METHOD_1_0B1EB5C9B94BAB66_OFFSET UNITYSDK_OFFSET(0x168A7520)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_METHOD_1_0C29AEF00864BB0B_OFFSET UNITYSDK_OFFSET(0x168A8740)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_METHOD_1_160E725E42D4E74E_OFFSET UNITYSDK_OFFSET(0x168A86F0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x168A7670)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_METHOD_1_688F76EE272C1B51_OFFSET UNITYSDK_OFFSET(0x168A7A90)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_METHOD_1_9A90429BA583E7C4_OFFSET UNITYSDK_OFFSET(0x168A7DA0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x168A8070)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_SET_BINDINGTRANS_OFFSET UNITYSDK_OFFSET(0x168A76D0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_SET_UNATTACHENDFRAME_OFFSET UNITYSDK_OFFSET(0x168A84E0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_SET_UNATTACHMAXENDFRAME_OFFSET UNITYSDK_OFFSET(0x168A81F0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_SET_USEUNATTACHCONFIG_OFFSET UNITYSDK_OFFSET(0x168A7DF0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x168A8690)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ZNetEffectPlayableAsset_FollowControl_TypeDefinitionIndex = 70264;
