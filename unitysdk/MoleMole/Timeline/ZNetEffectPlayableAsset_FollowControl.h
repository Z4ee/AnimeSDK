...
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_GET_BINDINGTRANS_OFFSET UNITYSDK_OFFSET(0x1A1C39F0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_GET_UNATTACHENDFRAME_OFFSET UNITYSDK_OFFSET(0x1A1C4BC0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_GET_UNATTACHMAXENDFRAME_OFFSET UNITYSDK_OFFSET(0x1A1C48D0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_GET_USEUNATTACHCONFIG_OFFSET UNITYSDK_OFFSET(0x1A1C44E0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_METHOD_1_0B1EB5C9B94BAB66_OFFSET UNITYSDK_OFFSET(0x1A1C3D50)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_METHOD_1_0C29AEF00864BB0B_OFFSET UNITYSDK_OFFSET(0x1A1C4F10)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_METHOD_1_160E725E42D4E74E_OFFSET UNITYSDK_OFFSET(0x1A1C4F70)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x1A1C3EA0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_METHOD_1_688F76EE272C1B51_OFFSET UNITYSDK_OFFSET(0x1A1C42C0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_METHOD_1_9A90429BA583E7C4_OFFSET UNITYSDK_OFFSET(0x1A1C45D0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1A1C4890)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_SET_BINDINGTRANS_OFFSET UNITYSDK_OFFSET(0x1A1C3F00)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_SET_UNATTACHENDFRAME_OFFSET UNITYSDK_OFFSET(0x1A1C4D00)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_SET_UNATTACHMAXENDFRAME_OFFSET UNITYSDK_OFFSET(0x1A1C4A10)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL_SET_USEUNATTACHCONFIG_OFFSET UNITYSDK_OFFSET(0x1A1C4620)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_FOLLOWCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1C4EB0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ZNetEffectPlayableAsset_FollowControl_TypeDefinitionIndex = 44685;
