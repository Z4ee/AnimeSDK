...
#define MOLEMOLE_TIMELINE_TEXTURESHEET_TV_WALLBEHAVIOUR_METHOD_2_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x15868560)
#define MOLEMOLE_TIMELINE_TEXTURESHEET_TV_WALLBEHAVIOUR_METHOD_2_2C95AFAD0256302F_OFFSET UNITYSDK_OFFSET(0x158687B0)
#define MOLEMOLE_TIMELINE_TEXTURESHEET_TV_WALLBEHAVIOUR_METHOD_2_324AEE341AAA7A1B_1_OFFSET UNITYSDK_OFFSET(0x15868610)
#define MOLEMOLE_TIMELINE_TEXTURESHEET_TV_WALLBEHAVIOUR_METHOD_2_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x15868600)
#define MOLEMOLE_TIMELINE_TEXTURESHEET_TV_WALLBEHAVIOUR_METHOD_2_4DA6D4A624E42CAB_OFFSET UNITYSDK_OFFSET(0x15868620)
#define MOLEMOLE_TIMELINE_TEXTURESHEET_TV_WALLBEHAVIOUR_METHOD_2_67F9C05362EADEEE_OFFSET UNITYSDK_OFFSET(0x15868690)
#define MOLEMOLE_TIMELINE_TEXTURESHEET_TV_WALLBEHAVIOUR_METHOD_2_E5E342154D4EA5F5_OFFSET UNITYSDK_OFFSET(0x158688D0)
#define MOLEMOLE_TIMELINE_TEXTURESHEET_TV_WALLBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0x15868410)
#define MOLEMOLE_TIMELINE_TEXTURESHEET_TV_WALLBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x15868460)
#define MOLEMOLE_TIMELINE_TEXTURESHEET_TV_WALLBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x158681F0)
#define MOLEMOLE_TIMELINE_TEXTURESHEET_TV_WALLBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x15868550)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TextureSheet_TV_WallBehaviour_TypeDefinitionIndex = 68791;
