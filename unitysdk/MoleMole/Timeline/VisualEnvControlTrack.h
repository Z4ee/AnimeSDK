...
#define MOLEMOLE_TIMELINE_VISUALENVCONTROLTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19799B60)
#define MOLEMOLE_TIMELINE_VISUALENVCONTROLTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x19799A00)
#define MOLEMOLE_TIMELINE_VISUALENVCONTROLTRACK_METHOD_6_652F102150AC9967_OFFSET UNITYSDK_OFFSET(0x19799F10)
#define MOLEMOLE_TIMELINE_VISUALENVCONTROLTRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x19799ED0)
#define MOLEMOLE_TIMELINE_VISUALENVCONTROLTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19799E70)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int VisualEnvControlTrack_TypeDefinitionIndex = 84897;
