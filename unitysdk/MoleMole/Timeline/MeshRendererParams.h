...
#define MOLEMOLE_TIMELINE_MESHRENDERERPARAMS_LAYERMASHSELECT_OFFSET UNITYSDK_OFFSET(0x1FB32CF0)
#define MOLEMOLE_TIMELINE_MESHRENDERERPARAMS_LAYERSELECT_OFFSET UNITYSDK_OFFSET(0x1FB32BD0)
#define MOLEMOLE_TIMELINE_MESHRENDERERPARAMS_SETSKINNEDMESHRENDERER_OFFSET UNITYSDK_OFFSET(0x1FB33360)
#define MOLEMOLE_TIMELINE_MESHRENDERERPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1FB330E0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MeshRendererParams_TypeDefinitionIndex = 32848;
