...
#include "unitysdk/MoleMole/Timeline/DirectionalBlurBehaviour_Struct_2_52AD02145F5FCE36_41.h"
...
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x11D747A0)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x11D74E90)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_METHOD_4_2A2F4871A4F10FFC_OFFSET UNITYSDK_OFFSET(0x11D749E0)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x11D75D30)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x11D75D20)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x11D75D10)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x11D75D00)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x11D74DD0)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x11D757B0)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x11D75980)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x11D75CC0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int DirectionalBlurBehaviour_TypeDefinitionIndex = 89422;

	class DirectionalBlurBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::DirectionalBlurBehaviour_Struct_2_52AD02145F5FCE36_41 _methodParm; // 0x18
