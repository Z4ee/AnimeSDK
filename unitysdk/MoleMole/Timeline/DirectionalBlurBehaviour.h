...
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x11DFC100)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x11DFC7F0)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_METHOD_4_2A2F4871A4F10FFC_OFFSET UNITYSDK_OFFSET(0x11DFC340)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x11DFD680)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x11DFD6B0)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x11DFD6A0)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x11DFD690)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x11DFC730)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x11DFD130)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x11DFD300)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x11DFD640)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int DirectionalBlurBehaviour_TypeDefinitionIndex = 60147;
