...
#define MOLEMOLE_TIMELINE_MATERIALGLITCHBEHAVIOR_INITDATA_OFFSET UNITYSDK_OFFSET(0x1FB31E50)
#define MOLEMOLE_TIMELINE_MATERIALGLITCHBEHAVIOR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1FB32430)
#define MOLEMOLE_TIMELINE_MATERIALGLITCHBEHAVIOR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1FB31E60)
#define MOLEMOLE_TIMELINE_MATERIALGLITCHBEHAVIOR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1FB32670)
#define MOLEMOLE_TIMELINE_MATERIALGLITCHBEHAVIOR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1FB32100)
#define MOLEMOLE_TIMELINE_MATERIALGLITCHBEHAVIOR_SETCLONEGAMEOBJECTPARAMS_OFFSET UNITYSDK_OFFSET(0x1FB31FB0)
#define MOLEMOLE_TIMELINE_MATERIALGLITCHBEHAVIOR_SETGLITCHPARAMS_OFFSET UNITYSDK_OFFSET(0x1FB32250)
#define MOLEMOLE_TIMELINE_MATERIALGLITCHBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1FB32930)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MaterialGlitchBehavior_TypeDefinitionIndex = 32836;
