...
#define MOLEMOLE_TIMELINE_MATERIALGLITCHBEHAVIOR_INITDATA_OFFSET UNITYSDK_OFFSET(0x1E755600)
#define MOLEMOLE_TIMELINE_MATERIALGLITCHBEHAVIOR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1E755BF0)
#define MOLEMOLE_TIMELINE_MATERIALGLITCHBEHAVIOR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1E755610)
#define MOLEMOLE_TIMELINE_MATERIALGLITCHBEHAVIOR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1E755E30)
#define MOLEMOLE_TIMELINE_MATERIALGLITCHBEHAVIOR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1E7558B0)
#define MOLEMOLE_TIMELINE_MATERIALGLITCHBEHAVIOR_SETCLONEGAMEOBJECTPARAMS_OFFSET UNITYSDK_OFFSET(0x1E755760)
#define MOLEMOLE_TIMELINE_MATERIALGLITCHBEHAVIOR_SETGLITCHPARAMS_OFFSET UNITYSDK_OFFSET(0x1E755A00)
#define MOLEMOLE_TIMELINE_MATERIALGLITCHBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7560F0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MaterialGlitchBehavior_TypeDefinitionIndex = 32206;
