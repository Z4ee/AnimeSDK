...
#define MOLEMOLE_TIMELINE_BATCHUNACTIVATIONTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x10826A90)
#define MOLEMOLE_TIMELINE_BATCHUNACTIVATIONTRACK_METHOD_5_14014646206E49EF_OFFSET UNITYSDK_OFFSET(0x10827160)
#define MOLEMOLE_TIMELINE_BATCHUNACTIVATIONTRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x108272E0)
#define MOLEMOLE_TIMELINE_BATCHUNACTIVATIONTRACK_METHOD_5_F7662FE9CCCA35A7_OFFSET UNITYSDK_OFFSET(0x10826E00)
#define MOLEMOLE_TIMELINE_BATCHUNACTIVATIONTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x108270C0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int BatchUnActivationTrack_TypeDefinitionIndex = 49014;
