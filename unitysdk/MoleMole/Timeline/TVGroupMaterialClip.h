...
#define MOLEMOLE_TIMELINE_TVGROUPMATERIALCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19793850)
#define MOLEMOLE_TIMELINE_TVGROUPMATERIALCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19793840)
#define MOLEMOLE_TIMELINE_TVGROUPMATERIALCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19793A30)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TVGroupMaterialClip_TypeDefinitionIndex = 78149;
