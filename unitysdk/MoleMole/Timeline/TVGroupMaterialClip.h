...
#define MOLEMOLE_TIMELINE_TVGROUPMATERIALCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x12FC21D0)
#define MOLEMOLE_TIMELINE_TVGROUPMATERIALCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x12FC21C0)
#define MOLEMOLE_TIMELINE_TVGROUPMATERIALCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x12FC23B0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TVGroupMaterialClip_TypeDefinitionIndex = 72405;
