...
#define MOLEMOLE_TIMELINE_FLOATARRAYRECORDERUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C531D20)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int FloatArrayRecorderUnit_TypeDefinitionIndex = 30640;
