...
#include "unitysdk/MoleMole/Timeline/FXFogBehaviour_Struct_2_52AD02145F5FCE36_18.h"
...
#define MOLEMOLE_TIMELINE_FXFOGBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x11DFE050)
#define MOLEMOLE_TIMELINE_FXFOGBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x11E02E70)
#define MOLEMOLE_TIMELINE_FXFOGBEHAVIOUR_METHOD_4_633B57D9E42D768A_OFFSET UNITYSDK_OFFSET(0x11DFE740)
#define MOLEMOLE_TIMELINE_FXFOGBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x11E02E60)
#define MOLEMOLE_TIMELINE_FXFOGBEHAVIOUR_METHOD_4_8DC55F996A78F0A1_OFFSET UNITYSDK_OFFSET(0x11DFEDF0)
#define MOLEMOLE_TIMELINE_FXFOGBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x11E02E80)
#define MOLEMOLE_TIMELINE_FXFOGBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x11E02E50)
#define MOLEMOLE_TIMELINE_FXFOGBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x11DFEB30)
#define MOLEMOLE_TIMELINE_FXFOGBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x11E01070)
#define MOLEMOLE_TIMELINE_FXFOGBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x11E01450)
#define MOLEMOLE_TIMELINE_FXFOGBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x11E02D20)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int FXFogBehaviour_TypeDefinitionIndex = 55301;

	class FXFogBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::FXFogBehaviour_Struct_2_52AD02145F5FCE36_18 _methodParm; // 0x18
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_FXFOGBEHAVIOUR_METHOD_4_8DC55F996A78F0A1_OFFSET))(this);
		}
