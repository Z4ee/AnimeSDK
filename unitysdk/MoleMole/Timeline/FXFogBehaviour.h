...
#include "unitysdk/MoleMole/Timeline/FXFogBehaviour_Struct_2_52AD02145F5FCE36_26.h"
...
#define MOLEMOLE_TIMELINE_FXFOGBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x1839DE70)
#define MOLEMOLE_TIMELINE_FXFOGBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x183A2C90)
#define MOLEMOLE_TIMELINE_FXFOGBEHAVIOUR_METHOD_4_633B57D9E42D768A_OFFSET UNITYSDK_OFFSET(0x1839E560)
#define MOLEMOLE_TIMELINE_FXFOGBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x183A2C80)
#define MOLEMOLE_TIMELINE_FXFOGBEHAVIOUR_METHOD_4_8DC55F996A78F0A1_OFFSET UNITYSDK_OFFSET(0x1839EC10)
#define MOLEMOLE_TIMELINE_FXFOGBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x183A2CA0)
#define MOLEMOLE_TIMELINE_FXFOGBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x183A2C70)
#define MOLEMOLE_TIMELINE_FXFOGBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1839E950)
#define MOLEMOLE_TIMELINE_FXFOGBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x183A0E90)
#define MOLEMOLE_TIMELINE_FXFOGBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x183A1270)
#define MOLEMOLE_TIMELINE_FXFOGBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x183A2B40)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int FXFogBehaviour_TypeDefinitionIndex = 64938;

	class FXFogBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::FXFogBehaviour_Struct_2_52AD02145F5FCE36_26 _methodParm; // 0x18
