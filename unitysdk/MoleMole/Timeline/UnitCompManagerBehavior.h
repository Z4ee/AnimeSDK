...
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERBEHAVIOR_METHOD_3_0ED1963A672FB61E_OFFSET UNITYSDK_OFFSET(0x19741370)
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERBEHAVIOR_METHOD_3_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x197414F0)
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERBEHAVIOR_METHOD_3_832295EC279E5994_1_OFFSET UNITYSDK_OFFSET(0x19741510)
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERBEHAVIOR_METHOD_3_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x19741500)
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERBEHAVIOR_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x19741220)
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERBEHAVIOR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x19741280)
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERBEHAVIOR_ONPLAY_OFFSET UNITYSDK_OFFSET(0x197411C0)
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19741320)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int UnitCompManagerBehavior_TypeDefinitionIndex = 73014;
