...
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERBEHAVIOR_METHOD_3_0ED1963A672FB61E_OFFSET UNITYSDK_OFFSET(0x1819BF40)
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERBEHAVIOR_METHOD_3_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x1819C0D0)
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERBEHAVIOR_METHOD_3_832295EC279E5994_1_OFFSET UNITYSDK_OFFSET(0x1819C0C0)
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERBEHAVIOR_METHOD_3_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x1819BF30)
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERBEHAVIOR_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1819BDE0)
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERBEHAVIOR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1819BE40)
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERBEHAVIOR_ONPLAY_OFFSET UNITYSDK_OFFSET(0x1819BD80)
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1819BEE0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int UnitCompManagerBehavior_TypeDefinitionIndex = 75784;
