...
#define MOLEMOLE_TIMELINE_MATERIALRECORDERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA16F30)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MaterialRecorderBehavior_TypeDefinitionIndex = 30649;
