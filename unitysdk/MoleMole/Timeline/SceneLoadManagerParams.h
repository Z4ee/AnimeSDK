...
#define MOLEMOLE_TIMELINE_SCENELOADMANAGERPARAMS_METHOD_1_B9A97467188E4B69_OFFSET UNITYSDK_OFFSET(0x18195060)
#define MOLEMOLE_TIMELINE_SCENELOADMANAGERPARAMS_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x181951D0)
#define MOLEMOLE_TIMELINE_SCENELOADMANAGERPARAMS_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x18195020)
#define MOLEMOLE_TIMELINE_SCENELOADMANAGERPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x18195010)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SceneLoadManagerParams_TypeDefinitionIndex = 83330;
