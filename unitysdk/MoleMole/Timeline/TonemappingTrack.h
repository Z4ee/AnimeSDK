...
#define MOLEMOLE_TIMELINE_TONEMAPPINGTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x15A71E20)
#define MOLEMOLE_TIMELINE_TONEMAPPINGTRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x15A720D0)
#define MOLEMOLE_TIMELINE_TONEMAPPINGTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x15A72070)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TonemappingTrack_TypeDefinitionIndex = 55832;
