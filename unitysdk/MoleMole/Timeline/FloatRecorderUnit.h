...
#define MOLEMOLE_TIMELINE_FLOATRECORDERUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1F8B1990)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int FloatRecorderUnit_TypeDefinitionIndex = 32815;
