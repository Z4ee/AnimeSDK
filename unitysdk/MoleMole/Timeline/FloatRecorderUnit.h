...
#define MOLEMOLE_TIMELINE_FLOATRECORDERUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4B4590)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int FloatRecorderUnit_TypeDefinitionIndex = 32185;
