...
#include "unitysdk/MoleMole/Timeline/ScreenSpaceAmbientOcclusionBehaviour_Struct_2_52AD02145F5FCE36_38.h"
...
#define MOLEMOLE_TIMELINE_SCREENSPACEAMBIENTOCCLUSIONBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x18195500)
#define MOLEMOLE_TIMELINE_SCREENSPACEAMBIENTOCCLUSIONBEHAVIOUR_METHOD_4_18480E145D53E972_OFFSET UNITYSDK_OFFSET(0x181958E0)
#define MOLEMOLE_TIMELINE_SCREENSPACEAMBIENTOCCLUSIONBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x18198140)
#define MOLEMOLE_TIMELINE_SCREENSPACEAMBIENTOCCLUSIONBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x18198150)
#define MOLEMOLE_TIMELINE_SCREENSPACEAMBIENTOCCLUSIONBEHAVIOUR_METHOD_4_8DC55F996A78F0A1_OFFSET UNITYSDK_OFFSET(0x18195E70)
#define MOLEMOLE_TIMELINE_SCREENSPACEAMBIENTOCCLUSIONBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x18198170)
#define MOLEMOLE_TIMELINE_SCREENSPACEAMBIENTOCCLUSIONBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x18198160)
#define MOLEMOLE_TIMELINE_SCREENSPACEAMBIENTOCCLUSIONBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x18195CD0)
#define MOLEMOLE_TIMELINE_SCREENSPACEAMBIENTOCCLUSIONBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x18197800)
#define MOLEMOLE_TIMELINE_SCREENSPACEAMBIENTOCCLUSIONBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x18197AC0)
#define MOLEMOLE_TIMELINE_SCREENSPACEAMBIENTOCCLUSIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x181980D0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ScreenSpaceAmbientOcclusionBehaviour_TypeDefinitionIndex = 78025;

	class ScreenSpaceAmbientOcclusionBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::ScreenSpaceAmbientOcclusionBehaviour_Struct_2_52AD02145F5FCE36_38 _methodParm; // 0x18
