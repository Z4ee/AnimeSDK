...
#include "unitysdk/MoleMole/Timeline/MonsterIgnisFatuusBehaviour_Struct_2_52AD02145F5FCE3A_7.h"
...
#define MOLEMOLE_TIMELINE_MONSTERIGNISFATUUSBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x170445F0)
#define MOLEMOLE_TIMELINE_MONSTERIGNISFATUUSBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x17049B20)
#define MOLEMOLE_TIMELINE_MONSTERIGNISFATUUSBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x17049B50)
#define MOLEMOLE_TIMELINE_MONSTERIGNISFATUUSBEHAVIOUR_METHOD_4_8DC55F996A78F0A1_OFFSET UNITYSDK_OFFSET(0x170455B0)
#define MOLEMOLE_TIMELINE_MONSTERIGNISFATUUSBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x17049B40)
#define MOLEMOLE_TIMELINE_MONSTERIGNISFATUUSBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x17049B30)
#define MOLEMOLE_TIMELINE_MONSTERIGNISFATUUSBEHAVIOUR_METHOD_4_B1B2A61BD0D6C04F_OFFSET UNITYSDK_OFFSET(0x17044DE0)
#define MOLEMOLE_TIMELINE_MONSTERIGNISFATUUSBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x170451D0)
#define MOLEMOLE_TIMELINE_MONSTERIGNISFATUUSBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x170487F0)
#define MOLEMOLE_TIMELINE_MONSTERIGNISFATUUSBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x17048CE0)
#define MOLEMOLE_TIMELINE_MONSTERIGNISFATUUSBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x17049960)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MonsterIgnisFatuusBehaviour_TypeDefinitionIndex = 48887;

	class MonsterIgnisFatuusBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::MonsterIgnisFatuusBehaviour_Struct_2_52AD02145F5FCE3A_7 _methodParm; // 0x18
