...
#define MOLEMOLE_TIMELINE_DIALOGTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1B6B5BF0)
#define MOLEMOLE_TIMELINE_DIALOGTRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x1B6B5DB0)
#define MOLEMOLE_TIMELINE_DIALOGTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6B5D50)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int DialogTrack_TypeDefinitionIndex = 91405;
