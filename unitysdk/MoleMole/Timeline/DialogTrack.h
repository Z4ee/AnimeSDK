...
#define MOLEMOLE_TIMELINE_DIALOGTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1917E500)
#define MOLEMOLE_TIMELINE_DIALOGTRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x1917E6C0)
#define MOLEMOLE_TIMELINE_DIALOGTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1917E660)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int DialogTrack_TypeDefinitionIndex = 74645;
