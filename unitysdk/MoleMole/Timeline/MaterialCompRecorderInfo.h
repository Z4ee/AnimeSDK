...
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_CHECKANDUPDATEMATERIALS_OFFSET UNITYSDK_OFFSET(0x1F70EB60)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_CHECKISSCREENMATERIAL_OFFSET UNITYSDK_OFFSET(0x1F70ABB0)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_CHECKMATERIALINDEXVALID_OFFSET UNITYSDK_OFFSET(0x1F70D590)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_CLEARFRAMEALTERS_OFFSET UNITYSDK_OFFSET(0x1F70C170)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_FINDPROPERTYALTERS_OFFSET UNITYSDK_OFFSET(0x1F70B570)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_GETATTRALTERS_OFFSET UNITYSDK_OFFSET(0x1F70DD00)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_GETFRAMETIMES_OFFSET UNITYSDK_OFFSET(0x1F70CCC0)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_GETKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1F70B980)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_GETMULTIMATERIALPATTERN_OFFSET UNITYSDK_OFFSET(0x1F70D650)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x1F70E730)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_GET_INSTANCEMATERIALS_OFFSET UNITYSDK_OFFSET(0x1F70A1A0)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1F70C700)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_RECORDERFRAMES_OFFSET UNITYSDK_OFFSET(0x1F70CA30)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_RECORDERMATERIALLEN_OFFSET UNITYSDK_OFFSET(0x1F70E820)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_RECORDMESHRENDERS_OFFSET UNITYSDK_OFFSET(0x1F70A530)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_RECOVERFRAME_OFFSET UNITYSDK_OFFSET(0x1F70C3B0)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_RECOVERMESHRENDERS_OFFSET UNITYSDK_OFFSET(0x1F70ABC0)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_RELOADMESHRENDERERCHANGE_OFFSET UNITYSDK_OFFSET(0x1F70B360)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_RELOADMESHRENDERERUNCHANGE_OFFSET UNITYSDK_OFFSET(0x1F70B230)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_RELOADMESHRENDERER_OFFSET UNITYSDK_OFFSET(0x1F70AF60)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_REVERTATTRALTERS_OFFSET UNITYSDK_OFFSET(0x1F70E720)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_REVERTATTR_OFFSET UNITYSDK_OFFSET(0x1F70C210)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_REVERTSOURCEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1F70A7F0)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_UPDATEADDEDMATERIALINFO_OFFSET UNITYSDK_OFFSET(0x1F70E950)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_UPDATEALTERS_OFFSET UNITYSDK_OFFSET(0x1F70D420)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_UPDATEMATERIALONINSPECTORGUI_OFFSET UNITYSDK_OFFSET(0x1F70C7F0)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F70EE30)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1F70A3D0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MaterialCompRecorderInfo_TypeDefinitionIndex = 32803;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(MaterialCompRecorderInfo_TypeDefinitionIndex)->GetStaticField(0x27DF0);
		}
		static ::System::Collections::Generic::List_1<::System::String*>** StaticGet_MultiMaterialKeyList()
		{
			return (::System::Collections::Generic::List_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(MaterialCompRecorderInfo_TypeDefinitionIndex)->GetStaticField(0x27DF8);
		}
		static ::System::Int32* StaticGet_layerIdColor()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MaterialCompRecorderInfo_TypeDefinitionIndex)->GetStaticField(0x7E80);
		}
