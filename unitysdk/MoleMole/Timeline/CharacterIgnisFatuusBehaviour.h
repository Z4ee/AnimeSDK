...
#include "unitysdk/MoleMole/Timeline/CharacterIgnisFatuusBehaviour_Struct_2_52AD02145F5FCE3A_25.h"
...
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x129DCFD0)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_METHOD_4_042ACE89AB98D68C_OFFSET UNITYSDK_OFFSET(0x129DD7C0)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x129DDF90)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x129E2520)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x129E2510)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x129E2530)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x129E2500)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x129DDBB0)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x129E11D0)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x129E16C0)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x129E2340)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int CharacterIgnisFatuusBehaviour_TypeDefinitionIndex = 69632;

	class CharacterIgnisFatuusBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::CharacterIgnisFatuusBehaviour_Struct_2_52AD02145F5FCE3A_25 _methodParm; // 0x18
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET))(this);
		}
