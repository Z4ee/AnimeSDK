...
#include "unitysdk/MoleMole/Timeline/CharacterIgnisFatuusBehaviour_Struct_2_52AD02145F5FCE3A_30.h"
...
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x17400230)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_METHOD_4_042ACE89AB98D68C_OFFSET UNITYSDK_OFFSET(0x17400A20)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x17405760)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x17405770)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_METHOD_4_8DC55F996A78F0A1_OFFSET UNITYSDK_OFFSET(0x174011F0)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x17405790)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x17405780)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x17400E10)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x17404430)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x17404920)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x174055A0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int CharacterIgnisFatuusBehaviour_TypeDefinitionIndex = 81353;

	class CharacterIgnisFatuusBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::CharacterIgnisFatuusBehaviour_Struct_2_52AD02145F5FCE3A_30 _methodParm; // 0x18
