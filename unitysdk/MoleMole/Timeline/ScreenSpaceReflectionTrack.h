...
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x191BE710)
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONTRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x191BE9C0)
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x191BE960)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ScreenSpaceReflectionTrack_TypeDefinitionIndex = 77384;
