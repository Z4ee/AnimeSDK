...
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19739EF0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1973A210)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALTRACK_GETKFRAMETRACK_OFFSET UNITYSDK_OFFSET(0x1973A0F0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALTRACK_METHOD_5_652F102150AC9967_OFFSET UNITYSDK_OFFSET(0x1973A410)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALTRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x1973A450)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALTRACK_ONCURVEWASMODIFIED_OFFSET UNITYSDK_OFFSET(0x1973A370)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1973A3B0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int RuntimeMaterialTrack_TypeDefinitionIndex = 91001;
	...
	public:
		...
		{
			return ((::UnityEngine::Playables::Playable(*)(::PVOID, ::UnityEngine::Playables::PlayableGraph, ::UnityEngine::GameObject*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_RUNTIMEMATERIALTRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET))(this, a1, a2, a3);
		}
	};
}
