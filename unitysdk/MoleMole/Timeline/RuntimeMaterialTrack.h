...
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1388E2E0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1388E600)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALTRACK_GETKFRAMETRACK_OFFSET UNITYSDK_OFFSET(0x1388E4E0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALTRACK_METHOD_5_652F102150AC9967_OFFSET UNITYSDK_OFFSET(0x1388E840)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALTRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x1388E800)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALTRACK_ONCURVEWASMODIFIED_OFFSET UNITYSDK_OFFSET(0x1388E760)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1388E7A0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int RuntimeMaterialTrack_TypeDefinitionIndex = 38468;
