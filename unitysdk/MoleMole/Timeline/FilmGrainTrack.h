...
#define MOLEMOLE_TIMELINE_FILMGRAINTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x15BC59F0)
#define MOLEMOLE_TIMELINE_FILMGRAINTRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x15BC5CA0)
#define MOLEMOLE_TIMELINE_FILMGRAINTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x15BC5C40)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int FilmGrainTrack_TypeDefinitionIndex = 55326;
