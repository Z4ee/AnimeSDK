...
#define MOLEMOLE_TIMELINE_FILMGRAINTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x168A01A0)
#define MOLEMOLE_TIMELINE_FILMGRAINTRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x168A0450)
#define MOLEMOLE_TIMELINE_FILMGRAINTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x168A03F0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int FilmGrainTrack_TypeDefinitionIndex = 55372;
