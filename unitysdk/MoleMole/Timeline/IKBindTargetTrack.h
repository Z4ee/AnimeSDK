...
#define MOLEMOLE_TIMELINE_IKBINDTARGETTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x18181C60)
#define MOLEMOLE_TIMELINE_IKBINDTARGETTRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x18182060)
#define MOLEMOLE_TIMELINE_IKBINDTARGETTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18182000)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int IKBindTargetTrack_TypeDefinitionIndex = 40272;
