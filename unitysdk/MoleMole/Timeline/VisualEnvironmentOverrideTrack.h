...
#define MOLEMOLE_TIMELINE_VISUALENVIRONMENTOVERRIDETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x12380440)
#define MOLEMOLE_TIMELINE_VISUALENVIRONMENTOVERRIDETRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x12380600)
#define MOLEMOLE_TIMELINE_VISUALENVIRONMENTOVERRIDETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x123805A0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int VisualEnvironmentOverrideTrack_TypeDefinitionIndex = 51510;
