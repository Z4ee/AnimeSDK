...
#define MOLEMOLE_TIMELINE_VISIBILITYPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1A5F4700)
#define MOLEMOLE_TIMELINE_VISIBILITYPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1A5F46F0)
#define MOLEMOLE_TIMELINE_VISIBILITYPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5F4870)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int VisibilityPlayableAsset_TypeDefinitionIndex = 58292;
