...
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x17DFA470)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_GET_FRAMEATTRS_OFFSET UNITYSDK_OFFSET(0x17DF9540)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_GET_INSTANCEMATERIALS_OFFSET UNITYSDK_OFFSET(0x17DF92D0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x17DFA450)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_03BFDB1C3240A55A_OFFSET UNITYSDK_OFFSET(0x17DFC890)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_092CD57850778EFC_OFFSET UNITYSDK_OFFSET(0x17DFF7F0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_1AF357BC8EC348BD_OFFSET UNITYSDK_OFFSET(0x17DFF670)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_22E26A255EB831DA_OFFSET UNITYSDK_OFFSET(0x17DFA4A0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_2A564F70387767F8_OFFSET UNITYSDK_OFFSET(0x17DFD350)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_2D331162118AACA5_OFFSET UNITYSDK_OFFSET(0x17DFEDB0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_3060617FE14209CC_OFFSET UNITYSDK_OFFSET(0x17DFDED0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_367B9590522079D1_OFFSET UNITYSDK_OFFSET(0x17DFA990)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_37C87C00722A8F4B_OFFSET UNITYSDK_OFFSET(0x17DFECB0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_414C8F92528E4746_OFFSET UNITYSDK_OFFSET(0x17DFF080)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_493D6328E01546D4_OFFSET UNITYSDK_OFFSET(0x17DFF350)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_49AD48FB799E2E42_OFFSET UNITYSDK_OFFSET(0x17DFAC80)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_4DC7D80C2275A666_OFFSET UNITYSDK_OFFSET(0x17DFBF50)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_4F7257DB3153C8CF_OFFSET UNITYSDK_OFFSET(0x17DFB3A0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_5531F30DCA0CB07B_OFFSET UNITYSDK_OFFSET(0x17DFA160)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_571FA3C9F915CC8F_OFFSET UNITYSDK_OFFSET(0x17DFEB10)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_6167403524611113_OFFSET UNITYSDK_OFFSET(0x17DFE180)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_6D6B58868C572AE8_OFFSET UNITYSDK_OFFSET(0x17DFD290)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_72DCA587D9B741B5_OFFSET UNITYSDK_OFFSET(0x17DFAC40)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_749CA2576B2ED62D_OFFSET UNITYSDK_OFFSET(0x17DFF2F0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_7A4EB7A4DA062DE3_OFFSET UNITYSDK_OFFSET(0x17DFDAD0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_7BAB733FDCDD2CC7_OFFSET UNITYSDK_OFFSET(0x17DFE890)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_82D569F11803399A_OFFSET UNITYSDK_OFFSET(0x17DFE260)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_9339CF0298A5CC7D_OFFSET UNITYSDK_OFFSET(0x17DFFB20)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_9E8F031DC61EDEFE_OFFSET UNITYSDK_OFFSET(0x17DFE6A0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_BB02C484ADDCDD8A_OFFSET UNITYSDK_OFFSET(0x17DFBEE0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_C638E91FC0D3A13A_OFFSET UNITYSDK_OFFSET(0x17DFAF90)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_C8C2BBB8EE38E9A8_OFFSET UNITYSDK_OFFSET(0x17DFFD80)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_D0749CF6E87B297A_OFFSET UNITYSDK_OFFSET(0x17DFD4E0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_D1B42C039BBC3ECE_OFFSET UNITYSDK_OFFSET(0x17DFCA70)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_EAE8161D6C1EE982_OFFSET UNITYSDK_OFFSET(0x17DFB430)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_EE7339DA6ECF5F6D_OFFSET UNITYSDK_OFFSET(0x17DFC750)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_F2935B4A36EE90BA_OFFSET UNITYSDK_OFFSET(0x17DFA620)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_FFDA4DC3E9BF4C47_OFFSET UNITYSDK_OFFSET(0x17DFD680)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17DF9CE0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int RuntimeMaterialCompRecorderInfo_TypeDefinitionIndex = 69302;
	...
	public:
		...
		::System::Void Method_1_82D569F11803399A(::System::Double a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Double))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_82D569F11803399A_OFFSET))(this, a1);
		}
		...
		static ::System::Int32 Method_1_7BAB733FDCDD2CC7(::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::Timeline::KeyframeMBP*>* a1)
		{
			return ((::System::Int32(*)(::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::Timeline::KeyframeMBP*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_7BAB733FDCDD2CC7_OFFSET))(a1);
		}
