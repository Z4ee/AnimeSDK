...
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x11D741C0)
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONTRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x11D74470)
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x11D74410)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int CharacterColorCorrectionTrack_TypeDefinitionIndex = 55101;
