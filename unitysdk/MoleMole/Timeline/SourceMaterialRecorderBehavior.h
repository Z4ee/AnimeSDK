...
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_CHECKMATERIALINDEXVALID_OFFSET UNITYSDK_OFFSET(0x1C3E01C0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_CLEARFRAMEALTERS_OFFSET UNITYSDK_OFFSET(0x1C3DFC10)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_FINDPROPERTYALTERS_OFFSET UNITYSDK_OFFSET(0x1C3DFF00)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_GETFRAMETIMES_OFFSET UNITYSDK_OFFSET(0x1C3E0510)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_GETKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1C3DF2F0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_GETMULTIMATERIALPATTERN_OFFSET UNITYSDK_OFFSET(0x1C3E0160)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x1C3DEE20)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_GET_FRAMEENDTIME_OFFSET UNITYSDK_OFFSET(0x1C3DEFA0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_GET_FRAMESTARTTIME_OFFSET UNITYSDK_OFFSET(0x1C3DEEB0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1C3DEDA0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_INIT_OFFSET UNITYSDK_OFFSET(0x1C3DF090)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_LOADKFRAMESFROMANIMATOR_OFFSET UNITYSDK_OFFSET(0x1C3DF0C0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1C3DF0F0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_ONPLAY_OFFSET UNITYSDK_OFFSET(0x1C3DF0D0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_ONPROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1C3DFCB0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_RECORDERFRAMES_OFFSET UNITYSDK_OFFSET(0x1C3E0320)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_RECORDER_OFFSET UNITYSDK_OFFSET(0x1C3DFC00)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_RECOVERMESHRENDERS_OFFSET UNITYSDK_OFFSET(0x1C3DFB00)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_UPDATEALTERS_OFFSET UNITYSDK_OFFSET(0x1C3E0C60)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_UPDATEMATERIALONINSPECTORGUI_OFFSET UNITYSDK_OFFSET(0x1C3DF110)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C3E0DB0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3E0CD0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SourceMaterialRecorderBehavior_TypeDefinitionIndex = 30656;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(SourceMaterialRecorderBehavior_TypeDefinitionIndex)->GetStaticField(0x250C0);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>** StaticGet_MatchStrDic()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(SourceMaterialRecorderBehavior_TypeDefinitionIndex)->GetStaticField(0x250C8);
		}
