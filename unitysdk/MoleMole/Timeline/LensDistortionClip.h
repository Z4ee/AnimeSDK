...
#define MOLEMOLE_TIMELINE_LENSDISTORTIONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x15BC7440)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x15BC7430)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x15BC7620)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int LensDistortionClip_TypeDefinitionIndex = 68473;
