...
#define MOLEMOLE_TIMELINE_MATERIALGLITCHCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1DD94480)
#define MOLEMOLE_TIMELINE_MATERIALGLITCHCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1DD94470)
#define MOLEMOLE_TIMELINE_MATERIALGLITCHCLIP_INITDATA_OFFSET UNITYSDK_OFFSET(0x1DD94550)
#define MOLEMOLE_TIMELINE_MATERIALGLITCHCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD94570)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MaterialGlitchClip_TypeDefinitionIndex = 32207;
