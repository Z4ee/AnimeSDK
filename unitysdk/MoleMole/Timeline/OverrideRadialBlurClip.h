...
#define MOLEMOLE_TIMELINE_OVERRIDERADIALBLURCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B20CA00)
#define MOLEMOLE_TIMELINE_OVERRIDERADIALBLURCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B20C9F0)
#define MOLEMOLE_TIMELINE_OVERRIDERADIALBLURCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B20CBE0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int OverrideRadialBlurClip_TypeDefinitionIndex = 71587;
