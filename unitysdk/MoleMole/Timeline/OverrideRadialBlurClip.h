...
#define MOLEMOLE_TIMELINE_OVERRIDERADIALBLURCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x18D147C0)
#define MOLEMOLE_TIMELINE_OVERRIDERADIALBLURCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x18D147B0)
#define MOLEMOLE_TIMELINE_OVERRIDERADIALBLURCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x18D149A0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int OverrideRadialBlurClip_TypeDefinitionIndex = 75692;
