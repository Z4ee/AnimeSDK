...
#include "unitysdk/MoleMole/Timeline/AutoExposureBehaviour_Struct_2_52AD02145F5FCE36_36.h"
...
#define MOLEMOLE_TIMELINE_AUTOEXPOSUREBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x13876E60)
#define MOLEMOLE_TIMELINE_AUTOEXPOSUREBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x138775F0)
#define MOLEMOLE_TIMELINE_AUTOEXPOSUREBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x13878590)
#define MOLEMOLE_TIMELINE_AUTOEXPOSUREBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x13878580)
#define MOLEMOLE_TIMELINE_AUTOEXPOSUREBEHAVIOUR_METHOD_4_9C5D24A8F010A8AB_OFFSET UNITYSDK_OFFSET(0x13877120)
#define MOLEMOLE_TIMELINE_AUTOEXPOSUREBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x138785B0)
#define MOLEMOLE_TIMELINE_AUTOEXPOSUREBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x138785A0)
#define MOLEMOLE_TIMELINE_AUTOEXPOSUREBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x13877510)
#define MOLEMOLE_TIMELINE_AUTOEXPOSUREBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x13877FB0)
#define MOLEMOLE_TIMELINE_AUTOEXPOSUREBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x138781A0)
#define MOLEMOLE_TIMELINE_AUTOEXPOSUREBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x13878540)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int AutoExposureBehaviour_TypeDefinitionIndex = 76045;

	class AutoExposureBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::AutoExposureBehaviour_Struct_2_52AD02145F5FCE36_36 _methodParm; // 0x18
