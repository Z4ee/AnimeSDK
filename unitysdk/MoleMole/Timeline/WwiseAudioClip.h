...
#define MOLEMOLE_TIMELINE_WWISEAUDIOCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x13F35BC0)
#define MOLEMOLE_TIMELINE_WWISEAUDIOCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x13F35BB0)
#define MOLEMOLE_TIMELINE_WWISEAUDIOCLIP_METHOD_4_0B1EB5C9B94BAB66_OFFSET UNITYSDK_OFFSET(0x13F35E80)
#define MOLEMOLE_TIMELINE_WWISEAUDIOCLIP_METHOD_4_CF8BA38996D09531_OFFSET UNITYSDK_OFFSET(0x13F35F60)
#define MOLEMOLE_TIMELINE_WWISEAUDIOCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x13F35FC0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int WwiseAudioClip_TypeDefinitionIndex = 56705;
