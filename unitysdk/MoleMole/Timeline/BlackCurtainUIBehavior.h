...
#define MOLEMOLE_TIMELINE_BLACKCURTAINUIBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x12662380)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int BlackCurtainUIBehavior_TypeDefinitionIndex = 85867;
