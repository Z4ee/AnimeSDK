...
#define MOLEMOLE_TIMELINE_CHARACTERMATERIALCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x19997020)
#define MOLEMOLE_TIMELINE_CHARACTERMATERIALCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19997010)
#define MOLEMOLE_TIMELINE_CHARACTERMATERIALCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19997200)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int CharacterMaterialClip_TypeDefinitionIndex = 76147;
