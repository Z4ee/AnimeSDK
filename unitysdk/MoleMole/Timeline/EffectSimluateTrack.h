...
#define MOLEMOLE_TIMELINE_EFFECTSIMLUATETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1387A3A0)
#define MOLEMOLE_TIMELINE_EFFECTSIMLUATETRACK_GATHERPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1387AA40)
#define MOLEMOLE_TIMELINE_EFFECTSIMLUATETRACK_METHOD_5_064D173F66ED9F75_OFFSET UNITYSDK_OFFSET(0x1387B270)
#define MOLEMOLE_TIMELINE_EFFECTSIMLUATETRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x1387B230)
#define MOLEMOLE_TIMELINE_EFFECTSIMLUATETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1387B1C0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int EffectSimluateTrack_TypeDefinitionIndex = 44368;
