...
#include "unitysdk/MoleMole/Timeline/ChromaticAberrationBehaviour_Struct_2_52AD02145F5FCE36_3.h"
...
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x19997590)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_METHOD_4_0BD16411986206A8_OFFSET UNITYSDK_OFFSET(0x199978D0)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x19997E10)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x199993F0)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x199993C0)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x199993E0)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x199993D0)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x19997CC0)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x19998B50)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x19998DB0)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x19999340)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ChromaticAberrationBehaviour_TypeDefinitionIndex = 45614;

	class ChromaticAberrationBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::ChromaticAberrationBehaviour_Struct_2_52AD02145F5FCE36_3 _methodParm; // 0x18
