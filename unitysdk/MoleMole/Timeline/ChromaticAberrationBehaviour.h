...
#include "unitysdk/MoleMole/Timeline/ChromaticAberrationBehaviour_Struct_2_52AD02145F5FCE36_17.h"
...
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x12B24100)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_METHOD_4_0BD16411986206A8_OFFSET UNITYSDK_OFFSET(0x12B24440)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x12B24980)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x12B25F90)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x12B25FA0)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x12B25FB0)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x12B25F80)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x12B24830)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x12B25710)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x12B25970)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x12B25F00)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ChromaticAberrationBehaviour_TypeDefinitionIndex = 54483;

	class ChromaticAberrationBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::ChromaticAberrationBehaviour_Struct_2_52AD02145F5FCE36_17 _methodParm; // 0x18
