...
#define MOLEMOLE_TIMELINE_AUTOGENERATECOMPS_COMPTIMELINEBASECONFIG_METHOD_1_1374F5C8C30BDCEE_OFFSET UNITYSDK_OFFSET(0x13EC03B0)
#define MOLEMOLE_TIMELINE_AUTOGENERATECOMPS_COMPTIMELINEBASECONFIG_METHOD_1_97FA89D8D3694CF1_OFFSET UNITYSDK_OFFSET(0x13EC0320)
#define MOLEMOLE_TIMELINE_AUTOGENERATECOMPS_COMPTIMELINEBASECONFIG_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x13EC02E0)
#define MOLEMOLE_TIMELINE_AUTOGENERATECOMPS_COMPTIMELINEBASECONFIG_METHOD_1_D635BC10208DDAB9_OFFSET UNITYSDK_OFFSET(0x13EC0220)
#define MOLEMOLE_TIMELINE_AUTOGENERATECOMPS_COMPTIMELINEBASECONFIG_METHOD_1_F6F1C3E6461A192E_OFFSET UNITYSDK_OFFSET(0x13EC0290)
#define MOLEMOLE_TIMELINE_AUTOGENERATECOMPS_COMPTIMELINEBASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x13EC03A0)

namespace MoleMole::Timeline::AutoGenerateComps
{
	inline static constexpr unsigned int CompTimelineBaseConfig_TypeDefinitionIndex = 81592;
