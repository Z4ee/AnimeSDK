...
#define MOLEMOLE_TIMELINE_AUTOGENERATECOMPS_COMPTIMELINEBASECONFIG_METHOD_1_1374F5C8C30BDCEE_OFFSET UNITYSDK_OFFSET(0x1265F420)
#define MOLEMOLE_TIMELINE_AUTOGENERATECOMPS_COMPTIMELINEBASECONFIG_METHOD_1_97FA89D8D3694CF1_OFFSET UNITYSDK_OFFSET(0x1265F390)
#define MOLEMOLE_TIMELINE_AUTOGENERATECOMPS_COMPTIMELINEBASECONFIG_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1265F350)
#define MOLEMOLE_TIMELINE_AUTOGENERATECOMPS_COMPTIMELINEBASECONFIG_METHOD_1_D635BC10208DDAB9_OFFSET UNITYSDK_OFFSET(0x1265F290)
#define MOLEMOLE_TIMELINE_AUTOGENERATECOMPS_COMPTIMELINEBASECONFIG_METHOD_1_F6F1C3E6461A192E_OFFSET UNITYSDK_OFFSET(0x1265F300)
#define MOLEMOLE_TIMELINE_AUTOGENERATECOMPS_COMPTIMELINEBASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1265F410)

namespace MoleMole::Timeline::AutoGenerateComps
{
	inline static constexpr unsigned int CompTimelineBaseConfig_TypeDefinitionIndex = 62479;
