...
#define MOLEMOLE_TIMELINE_AUTOGENERATECOMPS_COMPCONTROLBEHAVIOR_GET_COMPTIMELINECONFIG_OFFSET UNITYSDK_OFFSET(0x1585EFF0)
#define MOLEMOLE_TIMELINE_AUTOGENERATECOMPS_COMPCONTROLBEHAVIOR_METHOD_2_7A391CCE1142AE06_OFFSET UNITYSDK_OFFSET(0x1585F000)
#define MOLEMOLE_TIMELINE_AUTOGENERATECOMPS_COMPCONTROLBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1585F040)

namespace MoleMole::Timeline::AutoGenerateComps
{
	inline static constexpr unsigned int CompControlBehavior_TypeDefinitionIndex = 44562;
