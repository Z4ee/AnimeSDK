...
#define MOLEMOLE_TIMELINE_AUTOGENERATECOMPS_COMPCONTROLBEHAVIOR_GET_COMPTIMELINECONFIG_OFFSET UNITYSDK_OFFSET(0x1642F140)
#define MOLEMOLE_TIMELINE_AUTOGENERATECOMPS_COMPCONTROLBEHAVIOR_METHOD_2_7A391CCE1142AE06_OFFSET UNITYSDK_OFFSET(0x1642F150)
#define MOLEMOLE_TIMELINE_AUTOGENERATECOMPS_COMPCONTROLBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1642F190)

namespace MoleMole::Timeline::AutoGenerateComps
{
	inline static constexpr unsigned int CompControlBehavior_TypeDefinitionIndex = 78022;
