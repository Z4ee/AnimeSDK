...
#define MOLEMOLE_TIMELINE_SCENELOADMANAGERTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1237CFC0)
#define MOLEMOLE_TIMELINE_SCENELOADMANAGERTRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x1237D180)
#define MOLEMOLE_TIMELINE_SCENELOADMANAGERTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1237D120)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SceneLoadManagerTrack_TypeDefinitionIndex = 40664;
