...
#define MOLEMOLE_TIMELINE_MULTIRENDERERBEHAVIOR_INITDATA_OFFSET UNITYSDK_OFFSET(0x1BB0A130)
#define MOLEMOLE_TIMELINE_MULTIRENDERERBEHAVIOR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1BB0A990)
#define MOLEMOLE_TIMELINE_MULTIRENDERERBEHAVIOR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1BB0A720)
#define MOLEMOLE_TIMELINE_MULTIRENDERERBEHAVIOR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1BB0AAB0)
#define MOLEMOLE_TIMELINE_MULTIRENDERERBEHAVIOR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1BB0A850)
#define MOLEMOLE_TIMELINE_MULTIRENDERERBEHAVIOR_SELECTREFERENCES_OFFSET UNITYSDK_OFFSET(0x1BB09EA0)
#define MOLEMOLE_TIMELINE_MULTIRENDERERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB0ABD0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MultiRendererBehavior_TypeDefinitionIndex = 30667;
