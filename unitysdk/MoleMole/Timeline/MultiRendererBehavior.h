...
#define MOLEMOLE_TIMELINE_MULTIRENDERERBEHAVIOR_INITDATA_OFFSET UNITYSDK_OFFSET(0x1DE5E4A0)
#define MOLEMOLE_TIMELINE_MULTIRENDERERBEHAVIOR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1DE5ED00)
#define MOLEMOLE_TIMELINE_MULTIRENDERERBEHAVIOR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1DE5EA90)
#define MOLEMOLE_TIMELINE_MULTIRENDERERBEHAVIOR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1DE5EE20)
#define MOLEMOLE_TIMELINE_MULTIRENDERERBEHAVIOR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1DE5EBC0)
#define MOLEMOLE_TIMELINE_MULTIRENDERERBEHAVIOR_SELECTREFERENCES_OFFSET UNITYSDK_OFFSET(0x1DE5E210)
#define MOLEMOLE_TIMELINE_MULTIRENDERERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE5EF40)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MultiRendererBehavior_TypeDefinitionIndex = 32213;
