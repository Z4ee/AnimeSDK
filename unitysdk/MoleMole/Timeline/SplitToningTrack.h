...
#define MOLEMOLE_TIMELINE_SPLITTONINGTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1973D8F0)
#define MOLEMOLE_TIMELINE_SPLITTONINGTRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x1973DBA0)
#define MOLEMOLE_TIMELINE_SPLITTONINGTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1973DB40)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SplitToningTrack_TypeDefinitionIndex = 54046;
