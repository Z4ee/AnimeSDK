...
#define MOLEMOLE_TIMELINE_SPLITTONINGTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x13891CF0)
#define MOLEMOLE_TIMELINE_SPLITTONINGTRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x13891FA0)
#define MOLEMOLE_TIMELINE_SPLITTONINGTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x13891F40)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SplitToningTrack_TypeDefinitionIndex = 46383;
