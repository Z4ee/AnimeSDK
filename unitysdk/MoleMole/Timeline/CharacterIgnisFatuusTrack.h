...
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1839BC40)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSTRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x1839BEF0)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1839BE90)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int CharacterIgnisFatuusTrack_TypeDefinitionIndex = 41198;
