...
#include "unitysdk/MoleMole/Timeline/LensDirtBehaviour_Struct_2_52AD02145F5FCE3A_11.h"
...
#define MOLEMOLE_TIMELINE_LENSDIRTBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x1450BDB0)
#define MOLEMOLE_TIMELINE_LENSDIRTBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x1450C5F0)
#define MOLEMOLE_TIMELINE_LENSDIRTBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x1450D7C0)
#define MOLEMOLE_TIMELINE_LENSDIRTBEHAVIOUR_METHOD_4_6350DE3AC1B8C899_OFFSET UNITYSDK_OFFSET(0x1450C0F0)
#define MOLEMOLE_TIMELINE_LENSDIRTBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x1450D7A0)
#define MOLEMOLE_TIMELINE_LENSDIRTBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x1450D7D0)
#define MOLEMOLE_TIMELINE_LENSDIRTBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x1450D7B0)
#define MOLEMOLE_TIMELINE_LENSDIRTBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1450C4E0)
#define MOLEMOLE_TIMELINE_LENSDIRTBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1450D0F0)
#define MOLEMOLE_TIMELINE_LENSDIRTBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1450D310)
#define MOLEMOLE_TIMELINE_LENSDIRTBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1450D750)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int LensDirtBehaviour_TypeDefinitionIndex = 51972;

	class LensDirtBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::LensDirtBehaviour_Struct_2_52AD02145F5FCE3A_11 _methodParm; // 0x18
