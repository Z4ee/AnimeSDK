...
#define MOLEMOLE_TIMELINE_TVGROUPTEXTURESHEETCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x160FCDD0)
#define MOLEMOLE_TIMELINE_TVGROUPTEXTURESHEETCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x160FCDC0)
#define MOLEMOLE_TIMELINE_TVGROUPTEXTURESHEETCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x160FCFB0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TVGroupTextureSheetClip_TypeDefinitionIndex = 45285;
