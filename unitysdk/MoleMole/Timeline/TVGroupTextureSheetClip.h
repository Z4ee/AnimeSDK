...
#define MOLEMOLE_TIMELINE_TVGROUPTEXTURESHEETCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x12B281B0)
#define MOLEMOLE_TIMELINE_TVGROUPTEXTURESHEETCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x12B281A0)
#define MOLEMOLE_TIMELINE_TVGROUPTEXTURESHEETCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x12B28390)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TVGroupTextureSheetClip_TypeDefinitionIndex = 71843;
