...
#define MOLEMOLE_TIMELINE_AMPLIFYOCCLUSIONTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1917B380)
#define MOLEMOLE_TIMELINE_AMPLIFYOCCLUSIONTRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x1917B630)
#define MOLEMOLE_TIMELINE_AMPLIFYOCCLUSIONTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1917B5D0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int AmplifyOcclusionTrack_TypeDefinitionIndex = 62669;
