...
#define MOLEMOLE_TIMELINE_WHITEBALANCETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x129EA1B0)
#define MOLEMOLE_TIMELINE_WHITEBALANCETRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x129EA460)
#define MOLEMOLE_TIMELINE_WHITEBALANCETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x129EA400)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int WhiteBalanceTrack_TypeDefinitionIndex = 44463;
