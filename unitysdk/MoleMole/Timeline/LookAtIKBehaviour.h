...
#define MOLEMOLE_TIMELINE_LOOKATIKBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x1795F0A0)
#define MOLEMOLE_TIMELINE_LOOKATIKBEHAVIOUR_METHOD_3_0868EF727040C390_OFFSET UNITYSDK_OFFSET(0x1795FC10)
#define MOLEMOLE_TIMELINE_LOOKATIKBEHAVIOUR_METHOD_3_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x1795FD80)
#define MOLEMOLE_TIMELINE_LOOKATIKBEHAVIOUR_METHOD_3_5E0C1E5BA618F87E_OFFSET UNITYSDK_OFFSET(0x1795F270)
#define MOLEMOLE_TIMELINE_LOOKATIKBEHAVIOUR_METHOD_3_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x1795FD70)
#define MOLEMOLE_TIMELINE_LOOKATIKBEHAVIOUR_METHOD_3_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x1795FD60)
#define MOLEMOLE_TIMELINE_LOOKATIKBEHAVIOUR_METHOD_3_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x1795FDA0)
#define MOLEMOLE_TIMELINE_LOOKATIKBEHAVIOUR_METHOD_3_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x1795FD90)
#define MOLEMOLE_TIMELINE_LOOKATIKBEHAVIOUR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1795F760)
#define MOLEMOLE_TIMELINE_LOOKATIKBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1795F7A0)
#define MOLEMOLE_TIMELINE_LOOKATIKBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1795F580)
#define MOLEMOLE_TIMELINE_LOOKATIKBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1795F980)
#define MOLEMOLE_TIMELINE_LOOKATIKBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1795FBF0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int LookAtIKBehaviour_TypeDefinitionIndex = 53451;
