...
#define MOLEMOLE_TIMELINE_WWISEMUSICBEHAVIOUR_METHOD_2_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x1871C4C0)
#define MOLEMOLE_TIMELINE_WWISEMUSICBEHAVIOUR_METHOD_2_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0x1871C2C0)
#define MOLEMOLE_TIMELINE_WWISEMUSICBEHAVIOUR_METHOD_2_79ED6854413CA2F4_OFFSET UNITYSDK_OFFSET(0x1871C4D0)
#define MOLEMOLE_TIMELINE_WWISEMUSICBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1871C230)
#define MOLEMOLE_TIMELINE_WWISEMUSICBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0x1871C1E0)
#define MOLEMOLE_TIMELINE_WWISEMUSICBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1871C4B0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int WwiseMusicBehaviour_TypeDefinitionIndex = 46280;
