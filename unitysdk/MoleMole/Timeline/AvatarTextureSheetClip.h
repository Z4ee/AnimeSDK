...
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x13ADEA00)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x13ADE9F0)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x13ADEBE0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int AvatarTextureSheetClip_TypeDefinitionIndex = 70478;
