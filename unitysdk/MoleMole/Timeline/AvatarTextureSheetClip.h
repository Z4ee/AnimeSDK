...
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1817E830)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1817E820)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1817EA10)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int AvatarTextureSheetClip_TypeDefinitionIndex = 78238;
