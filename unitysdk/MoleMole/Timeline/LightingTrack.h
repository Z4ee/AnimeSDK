...
#define MOLEMOLE_TIMELINE_LIGHTINGTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x18183310)
#define MOLEMOLE_TIMELINE_LIGHTINGTRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x181835C0)
#define MOLEMOLE_TIMELINE_LIGHTINGTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18183560)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int LightingTrack_TypeDefinitionIndex = 68812;
