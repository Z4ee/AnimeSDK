...
#define MOLEMOLE_TIMELINE_LIGHTINGTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x19728910)
#define MOLEMOLE_TIMELINE_LIGHTINGTRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x19728BC0)
#define MOLEMOLE_TIMELINE_LIGHTINGTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19728B60)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int LightingTrack_TypeDefinitionIndex = 73326;
