...
#define MOLEMOLE_TIMELINE_CAMLOOKATFOLLOWTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1304BD20)
#define MOLEMOLE_TIMELINE_CAMLOOKATFOLLOWTRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x1304BEE0)
#define MOLEMOLE_TIMELINE_CAMLOOKATFOLLOWTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1304BE80)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int CamLookAtFollowTrack_TypeDefinitionIndex = 62544;
