...
#define MOLEMOLE_TIMELINE_TVMATERIALBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x18921450)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TVMaterialBehaviour_TypeDefinitionIndex = 86970;
