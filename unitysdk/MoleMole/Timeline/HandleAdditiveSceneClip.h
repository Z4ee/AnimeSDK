...
#define MOLEMOLE_TIMELINE_HANDLEADDITIVESCENECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x17042590)
#define MOLEMOLE_TIMELINE_HANDLEADDITIVESCENECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x17042580)
#define MOLEMOLE_TIMELINE_HANDLEADDITIVESCENECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x17042770)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int HandleAdditiveSceneClip_TypeDefinitionIndex = 47232;
