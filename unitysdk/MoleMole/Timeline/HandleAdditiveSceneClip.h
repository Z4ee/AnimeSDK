...
#define MOLEMOLE_TIMELINE_HANDLEADDITIVESCENECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1450BB40)
#define MOLEMOLE_TIMELINE_HANDLEADDITIVESCENECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1450BB30)
#define MOLEMOLE_TIMELINE_HANDLEADDITIVESCENECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1450BD20)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int HandleAdditiveSceneClip_TypeDefinitionIndex = 52799;
