...
#define MOLEMOLE_TIMELINE_URPBEHAVIOR_METHOD_2_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x15E31750)
#define MOLEMOLE_TIMELINE_URPBEHAVIOR_METHOD_2_79ED6854413CA2F4_1_OFFSET UNITYSDK_OFFSET(0x15E31760)
#define MOLEMOLE_TIMELINE_URPBEHAVIOR_METHOD_2_79ED6854413CA2F4_2_OFFSET UNITYSDK_OFFSET(0x15E31770)
#define MOLEMOLE_TIMELINE_URPBEHAVIOR_METHOD_2_79ED6854413CA2F4_OFFSET UNITYSDK_OFFSET(0x15E31740)
#define MOLEMOLE_TIMELINE_URPBEHAVIOR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x15E315F0)
#define MOLEMOLE_TIMELINE_URPBEHAVIOR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x15E31460)
#define MOLEMOLE_TIMELINE_URPBEHAVIOR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x15E31690)
#define MOLEMOLE_TIMELINE_URPBEHAVIOR_PREPAREFRAME_OFFSET UNITYSDK_OFFSET(0x15E31550)
#define MOLEMOLE_TIMELINE_URPBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x15E31700)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int URPBehavior_TypeDefinitionIndex = 71641;
