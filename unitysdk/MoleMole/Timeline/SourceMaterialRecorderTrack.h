...
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1F8B4B40)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1F8B4A60)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERTRACK_GETKFRAMETRACK_OFFSET UNITYSDK_OFFSET(0x1F8B4ED0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERTRACK_ONAFTERTRACKDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1F8B4B30)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERTRACK_ONCURVEWASMODIFIED_OFFSET UNITYSDK_OFFSET(0x1F8B50F0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERTRACK_TRACKCREATEINIT_OFFSET UNITYSDK_OFFSET(0x1F8B4FB0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1F8B51D0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SourceMaterialRecorderTrack_TypeDefinitionIndex = 32835;
