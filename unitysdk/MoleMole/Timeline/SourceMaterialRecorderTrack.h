...
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1E4B7740)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1E4B7660)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERTRACK_GETKFRAMETRACK_OFFSET UNITYSDK_OFFSET(0x1E4B7AD0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERTRACK_ONAFTERTRACKDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E4B7730)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERTRACK_ONCURVEWASMODIFIED_OFFSET UNITYSDK_OFFSET(0x1E4B7CF0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERTRACK_TRACKCREATEINIT_OFFSET UNITYSDK_OFFSET(0x1E4B7BB0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4B7DD0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SourceMaterialRecorderTrack_TypeDefinitionIndex = 32205;
