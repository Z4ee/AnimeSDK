...
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1999ADA0)
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1999AD90)
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1999AF80)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ScreenSpaceReflectionClip_TypeDefinitionIndex = 49751;
