...
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x160FC220)
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x160FC210)
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x160FC400)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ScreenSpaceReflectionClip_TypeDefinitionIndex = 65323;
