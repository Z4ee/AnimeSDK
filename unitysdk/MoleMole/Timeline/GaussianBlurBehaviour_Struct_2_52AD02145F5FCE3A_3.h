...
{
	inline static constexpr unsigned int GaussianBlurBehaviour_Struct_2_52AD02145F5FCE3A_3_TypeDefinitionIndex = 44735;

	struct alignas(8) GaussianBlurBehaviour_Struct_2_52AD02145F5FCE3A_3
	{
		...
		::UnityEngine::Texture* Field_2_4; // 0x28
