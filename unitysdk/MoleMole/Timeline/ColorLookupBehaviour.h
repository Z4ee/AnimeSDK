...
#define MOLEMOLE_TIMELINE_COLORLOOKUPBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x18D01690)
#define MOLEMOLE_TIMELINE_COLORLOOKUPBEHAVIOUR_METHOD_4_31EB9898477203D4_OFFSET UNITYSDK_OFFSET(0x18D01850)
#define MOLEMOLE_TIMELINE_COLORLOOKUPBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x18D02500)
#define MOLEMOLE_TIMELINE_COLORLOOKUPBEHAVIOUR_METHOD_4_5FC63A1AC659F0AE_OFFSET UNITYSDK_OFFSET(0x18D01CD0)
#define MOLEMOLE_TIMELINE_COLORLOOKUPBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x18D024E0)
#define MOLEMOLE_TIMELINE_COLORLOOKUPBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x18D024F0)
#define MOLEMOLE_TIMELINE_COLORLOOKUPBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x18D024D0)
#define MOLEMOLE_TIMELINE_COLORLOOKUPBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x18D01C40)
#define MOLEMOLE_TIMELINE_COLORLOOKUPBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x18D02150)
#define MOLEMOLE_TIMELINE_COLORLOOKUPBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x18D02300)
#define MOLEMOLE_TIMELINE_COLORLOOKUPBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x18D024B0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ColorLookupBehaviour_TypeDefinitionIndex = 45130;
