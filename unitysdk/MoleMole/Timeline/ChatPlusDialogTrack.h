...
#define MOLEMOLE_TIMELINE_CHATPLUSDIALOGTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x129E2540)
#define MOLEMOLE_TIMELINE_CHATPLUSDIALOGTRACK_METHOD_5_652F102150AC9967_OFFSET UNITYSDK_OFFSET(0x129E2B20)
#define MOLEMOLE_TIMELINE_CHATPLUSDIALOGTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x129E2AB0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ChatPlusDialogTrack_TypeDefinitionIndex = 75312;
