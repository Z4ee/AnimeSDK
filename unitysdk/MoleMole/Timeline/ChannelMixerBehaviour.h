...
#include "unitysdk/MoleMole/Timeline/ChannelMixerBehaviour_Struct_2_52AD02145F5FCE36_28.h"
...
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x152AC6F0)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x152ACF00)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x152AE250)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_METHOD_4_3ECED01F1E339890_OFFSET UNITYSDK_OFFSET(0x152AC9E0)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x152AE270)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x152AE260)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x152AE240)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x152ACDD0)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x152ADB80)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x152ADDD0)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x152AE210)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ChannelMixerBehaviour_TypeDefinitionIndex = 68795;

	class ChannelMixerBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::ChannelMixerBehaviour_Struct_2_52AD02145F5FCE36_28 _methodParm; // 0x18
