...
#include "unitysdk/MoleMole/Timeline/ChannelMixerBehaviour_Struct_2_52AD02145F5FCE36_22.h"
...
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x173AA5B0)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x173AADC0)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x173AC0C0)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_METHOD_4_3ECED01F1E339890_OFFSET UNITYSDK_OFFSET(0x173AA8A0)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x173AC0B0)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x173AC0D0)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x173AC0A0)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x173AAC90)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x173AB9E0)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x173ABC30)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x173AC070)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ChannelMixerBehaviour_TypeDefinitionIndex = 70927;

	class ChannelMixerBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::ChannelMixerBehaviour_Struct_2_52AD02145F5FCE36_22 _methodParm; // 0x18
