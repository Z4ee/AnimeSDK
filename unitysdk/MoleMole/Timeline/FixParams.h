...
#define MOLEMOLE_TIMELINE_FIXPARAMS_METHOD_1_C638E91FC0D3A13A_1_OFFSET UNITYSDK_OFFSET(0x15B5DD60)
#define MOLEMOLE_TIMELINE_FIXPARAMS_METHOD_1_C638E91FC0D3A13A_2_OFFSET UNITYSDK_OFFSET(0x15B5DEC0)
#define MOLEMOLE_TIMELINE_FIXPARAMS_METHOD_1_C638E91FC0D3A13A_OFFSET UNITYSDK_OFFSET(0x15B5DC00)
#define MOLEMOLE_TIMELINE_FIXPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x15B5DBF0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int FixParams_TypeDefinitionIndex = 51808;
