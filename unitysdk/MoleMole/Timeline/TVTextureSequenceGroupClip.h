...
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x190C8D70)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x190C8D60)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x190C8EC0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TVTextureSequenceGroupClip_TypeDefinitionIndex = 68401;
