...
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x12FCA580)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_GATHERPROPERTIES_OFFSET UNITYSDK_OFFSET(0x12FC9060)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_GET_CANSHOWINTAG_OFFSET UNITYSDK_OFFSET(0x12FCA4F0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x12FC9010)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_GET_CONTROLLINGDIRECTORS_OFFSET UNITYSDK_OFFSET(0x12FC8F60)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_GET_CONTROLLINGPARTICLES_OFFSET UNITYSDK_OFFSET(0x12FC8F80)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x12FC9000)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_GET_RENDERERPARTINFOSHOWER_OFFSET UNITYSDK_OFFSET(0x12FCA510)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_05ED597505047531_1_OFFSET UNITYSDK_OFFSET(0x12FCE6F0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_05ED597505047531_OFFSET UNITYSDK_OFFSET(0x12FCE4B0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_081E84DBAB5CA72B_OFFSET UNITYSDK_OFFSET(0x12FD24D0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_0CA0F288E4E9F674_OFFSET UNITYSDK_OFFSET(0x12FCD7F0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_0F6313DD539D12A9_OFFSET UNITYSDK_OFFSET(0x12FCE930)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_134C08C528037F25_OFFSET UNITYSDK_OFFSET(0x12FD1440)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_19AA0F51EA6A528E_OFFSET UNITYSDK_OFFSET(0x12FD0660)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x12FCFDA0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_1FDFC6F104A579C1_OFFSET UNITYSDK_OFFSET(0x12FD0F30)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_21B2ADC3AAD50EB9_OFFSET UNITYSDK_OFFSET(0x12FCC310)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_28129A7F028AA224_OFFSET UNITYSDK_OFFSET(0x12FCFD00)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_366F3A58C5AC297C_OFFSET UNITYSDK_OFFSET(0x12FD19D0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x12FD25B0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_4B7E39834DB70AE3_OFFSET UNITYSDK_OFFSET(0x12FCC1E0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_5BA1B24E6C88A48A_OFFSET UNITYSDK_OFFSET(0x12FCDC10)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_637DBA7901C3991A_OFFSET UNITYSDK_OFFSET(0x12FCFA80)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_6B6AE2B3E1C3264F_OFFSET UNITYSDK_OFFSET(0x12FD13F0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_75E95797F163FF56_OFFSET UNITYSDK_OFFSET(0x12FCFE00)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_76E4B3C7EEDD63B4_OFFSET UNITYSDK_OFFSET(0x12FD1210)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_7A39A89E91C09395_OFFSET UNITYSDK_OFFSET(0x12FD1760)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_87D9A35F3F9238B9_OFFSET UNITYSDK_OFFSET(0x12FCDFB0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_901B80B762847998_OFFSET UNITYSDK_OFFSET(0x12FD0730)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_90418C74D914D125_OFFSET UNITYSDK_OFFSET(0x12FCF950)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_98327DE548306CA0_OFFSET UNITYSDK_OFFSET(0x12FCD030)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_9B92C44D5842AA8A_OFFSET UNITYSDK_OFFSET(0x12FD0BA0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_A195F8BDC5254662_OFFSET UNITYSDK_OFFSET(0x12FD12A0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_A47D52AAE5BCA60D_OFFSET UNITYSDK_OFFSET(0x12FCFF20)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_AA428D7312DF3BD0_OFFSET UNITYSDK_OFFSET(0x12FCEF90)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_B15C78DCB8B2B821_OFFSET UNITYSDK_OFFSET(0x12FD0260)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_B2DD3DBFA5C381E0_OFFSET UNITYSDK_OFFSET(0x12FCA1E0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_B877181B6123B7F6_OFFSET UNITYSDK_OFFSET(0x12FCF9A0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_C7BF9C1E6A78DCAB_OFFSET UNITYSDK_OFFSET(0x12FD0C00)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_C923407A53F704A1_OFFSET UNITYSDK_OFFSET(0x12FD0B20)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x12FD13A0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_CCBE730AF445BBD4_OFFSET UNITYSDK_OFFSET(0x12FD15D0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_CFB3155BE3C972D1_OFFSET UNITYSDK_OFFSET(0x12FD0330)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_D02B40A063807E13_OFFSET UNITYSDK_OFFSET(0x12FD0000)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_DE37EEDCAEB4CE8D_OFFSET UNITYSDK_OFFSET(0x12FCEB70)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_E4298D7611E3A6CD_OFFSET UNITYSDK_OFFSET(0x12FCD1B0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_E469629AED66F717_OFFSET UNITYSDK_OFFSET(0x12FCF890)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_E47EEE8FF1774C6E_1_OFFSET UNITYSDK_OFFSET(0x12FCA150)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_E47EEE8FF1774C6E_OFFSET UNITYSDK_OFFSET(0x12FCD760)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_F1F3BF871799E806_OFFSET UNITYSDK_OFFSET(0x12FD1650)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_F54117E1DDB9296B_OFFSET UNITYSDK_OFFSET(0x12FD09E0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_METHOD_4_F942C04D48B3F6D7_OFFSET UNITYSDK_OFFSET(0x12FD17F0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_ONENABLE_OFFSET UNITYSDK_OFFSET(0x12FC8FA0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_SET_CANSHOWINTAG_OFFSET UNITYSDK_OFFSET(0x12FCA500)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_SET_CONTROLLINGDIRECTORS_OFFSET UNITYSDK_OFFSET(0x12FC8F70)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_SET_CONTROLLINGPARTICLES_OFFSET UNITYSDK_OFFSET(0x12FC8F90)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_SET_RENDERERPARTINFOSHOWER_OFFSET UNITYSDK_OFFSET(0x12FCA570)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET__CCTOR_OFFSET UNITYSDK_OFFSET(0x12FCF4C0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x12FCF1A0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ZNetEffectPlayableAsset_TypeDefinitionIndex = 79661;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::ParticleSystem*>**)Il2CppClass::FromTypeDefinitionIndex(ZNetEffectPlayableAsset_TypeDefinitionIndex)->GetStaticField(0x469F0);
		}
		...
		{
			return (::Sirenix::OdinInspector::ValueDropdownList_1<::MoleMole::Timeline::ZNetEffectPlayableAsset_Enum_3_575048837920F2D6>**)Il2CppClass::FromTypeDefinitionIndex(ZNetEffectPlayableAsset_TypeDefinitionIndex)->GetStaticField(0x469F8);
		}
		static ::System::Collections::Generic::HashSet_1<::UnityEngine::GameObject*>** StaticGet_s_CreatedPrefabs()
		{
			return (::System::Collections::Generic::HashSet_1<::UnityEngine::GameObject*>**)Il2CppClass::FromTypeDefinitionIndex(ZNetEffectPlayableAsset_TypeDefinitionIndex)->GetStaticField(0x46A00);
		}
		static ::System::Collections::Generic::List_1<::UnityEngine::Playables::PlayableDirector*>** StaticGet_k_EmptyDirectorsList()
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Playables::PlayableDirector*>**)Il2CppClass::FromTypeDefinitionIndex(ZNetEffectPlayableAsset_TypeDefinitionIndex)->GetStaticField(0x46A08);
		}
		static ::System::Collections::Generic::HashSet_1<::UnityEngine::Playables::PlayableDirector*>** StaticGet_s_ProcessedDirectors()
		{
			return (::System::Collections::Generic::HashSet_1<::UnityEngine::Playables::PlayableDirector*>**)Il2CppClass::FromTypeDefinitionIndex(ZNetEffectPlayableAsset_TypeDefinitionIndex)->GetStaticField(0x46A10);
		}
