...
#include "unitysdk/MoleMole/Timeline/RTXVolumeBehaviour_Struct_2_52AD02145F5FCE3A_29.h"
...
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x13F2B520)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_METHOD_4_21687F330C2D11B4_OFFSET UNITYSDK_OFFSET(0x13F2C480)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x13F32250)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x13F32260)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_METHOD_4_8DC55F996A78F0A1_OFFSET UNITYSDK_OFFSET(0x13F2CDC0)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x13F32270)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x13F32240)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x13F2C870)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x13F30C40)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x13F312A0)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x13F32120)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int RTXVolumeBehaviour_TypeDefinitionIndex = 80360;

	class RTXVolumeBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::RTXVolumeBehaviour_Struct_2_52AD02145F5FCE3A_29 _methodParm; // 0x18
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_METHOD_4_8DC55F996A78F0A1_OFFSET))(this);
		}
