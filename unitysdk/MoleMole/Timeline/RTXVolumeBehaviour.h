...
#include "unitysdk/MoleMole/Timeline/RTXVolumeBehaviour_Struct_2_52AD02145F5FCE3A_5.h"
...
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x12375FD0)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_METHOD_4_21687F330C2D11B4_OFFSET UNITYSDK_OFFSET(0x12376F30)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x1237CD10)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x1237CD20)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_METHOD_4_8DC55F996A78F0A1_OFFSET UNITYSDK_OFFSET(0x12377870)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x1237CD00)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x1237CCF0)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x12377320)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1237B6F0)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1237BD50)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1237CBD0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int RTXVolumeBehaviour_TypeDefinitionIndex = 41651;

	class RTXVolumeBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::RTXVolumeBehaviour_Struct_2_52AD02145F5FCE3A_5 _methodParm; // 0x18
