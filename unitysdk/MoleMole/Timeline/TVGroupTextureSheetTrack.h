...
#define MOLEMOLE_TIMELINE_TVGROUPTEXTURESHEETTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x19793AE0)
#define MOLEMOLE_TIMELINE_TVGROUPTEXTURESHEETTRACK_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x19794070)
#define MOLEMOLE_TIMELINE_TVGROUPTEXTURESHEETTRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x197940E0)
#define MOLEMOLE_TIMELINE_TVGROUPTEXTURESHEETTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19794080)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TVGroupTextureSheetTrack_TypeDefinitionIndex = 56982;
