...
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVFOGCONTROLASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x11D7ECD0)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVFOGCONTROLASSET_METHOD_4_2F2C11EE837C55A9_OFFSET UNITYSDK_OFFSET(0x11D7EEB0)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVFOGCONTROLASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x11D7EE20)

namespace MoleMole::Timeline::VisualEnvCompTracks
{
	inline static constexpr unsigned int VisualEnvFogControlAsset_TypeDefinitionIndex = 58225;
