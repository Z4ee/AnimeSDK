...
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVWATERMARKCONTROLBEHAVIOR_GET_COMPTIMELINECONFIG_OFFSET UNITYSDK_OFFSET(0x1643A0A0)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVWATERMARKCONTROLBEHAVIOR_METHOD_3_28D339477F611571_OFFSET UNITYSDK_OFFSET(0x1643A0B0)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVWATERMARKCONTROLBEHAVIOR_METHOD_3_29DFCCC291F2C3F0_OFFSET UNITYSDK_OFFSET(0x1643A140)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVWATERMARKCONTROLBEHAVIOR_METHOD_3_7A391CCE1142AE06_OFFSET UNITYSDK_OFFSET(0x1643A1F0)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVWATERMARKCONTROLBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1643A130)

namespace MoleMole::Timeline::VisualEnvCompTracks
{
	inline static constexpr unsigned int VisualEnvWaterMarkControlBehavior_TypeDefinitionIndex = 54281;
