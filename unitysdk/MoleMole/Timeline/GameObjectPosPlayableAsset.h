...
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1DD08D40)
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1DD08D30)
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSPLAYABLEASSET_INITDATA_OFFSET UNITYSDK_OFFSET(0x1DD08F00)
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD08F20)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int GameObjectPosPlayableAsset_TypeDefinitionIndex = 32223;
