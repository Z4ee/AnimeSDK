...
#include "unitysdk/MoleMole/Timeline/WhiteBalanceBehaviour_Struct_2_E658502528B7C034.h"
...
#define MOLEMOLE_TIMELINE_WHITEBALANCEBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x11E06D40)
#define MOLEMOLE_TIMELINE_WHITEBALANCEBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x11E07BE0)
#define MOLEMOLE_TIMELINE_WHITEBALANCEBEHAVIOUR_METHOD_4_5FC63A1AC659F0AE_OFFSET UNITYSDK_OFFSET(0x11E07390)
#define MOLEMOLE_TIMELINE_WHITEBALANCEBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x11E07C00)
#define MOLEMOLE_TIMELINE_WHITEBALANCEBEHAVIOUR_METHOD_4_ABC5185E6C0BFAA3_OFFSET UNITYSDK_OFFSET(0x11E06F10)
#define MOLEMOLE_TIMELINE_WHITEBALANCEBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x11E07C10)
#define MOLEMOLE_TIMELINE_WHITEBALANCEBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x11E07BF0)
#define MOLEMOLE_TIMELINE_WHITEBALANCEBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x11E07300)
#define MOLEMOLE_TIMELINE_WHITEBALANCEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x11E07810)
#define MOLEMOLE_TIMELINE_WHITEBALANCEBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x11E079C0)
#define MOLEMOLE_TIMELINE_WHITEBALANCEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x11E07BD0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int WhiteBalanceBehaviour_TypeDefinitionIndex = 46921;

	class WhiteBalanceBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::WhiteBalanceBehaviour_Struct_2_E658502528B7C034 _methodParm; // 0x18
