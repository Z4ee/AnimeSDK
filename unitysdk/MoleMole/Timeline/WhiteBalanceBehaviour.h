...
#include "unitysdk/MoleMole/Timeline/WhiteBalanceBehaviour_Struct_2_E658502528B7C034_9.h"
...
#define MOLEMOLE_TIMELINE_WHITEBALANCEBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x183A6BF0)
#define MOLEMOLE_TIMELINE_WHITEBALANCEBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x183A7AA0)
#define MOLEMOLE_TIMELINE_WHITEBALANCEBEHAVIOUR_METHOD_4_5FC63A1AC659F0AE_OFFSET UNITYSDK_OFFSET(0x183A7240)
#define MOLEMOLE_TIMELINE_WHITEBALANCEBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x183A7AB0)
#define MOLEMOLE_TIMELINE_WHITEBALANCEBEHAVIOUR_METHOD_4_ABC5185E6C0BFAA3_OFFSET UNITYSDK_OFFSET(0x183A6DC0)
#define MOLEMOLE_TIMELINE_WHITEBALANCEBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x183A7AC0)
#define MOLEMOLE_TIMELINE_WHITEBALANCEBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x183A7A90)
#define MOLEMOLE_TIMELINE_WHITEBALANCEBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x183A71B0)
#define MOLEMOLE_TIMELINE_WHITEBALANCEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x183A76C0)
#define MOLEMOLE_TIMELINE_WHITEBALANCEBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x183A7870)
#define MOLEMOLE_TIMELINE_WHITEBALANCEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x183A7A80)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int WhiteBalanceBehaviour_TypeDefinitionIndex = 65494;

	class WhiteBalanceBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::WhiteBalanceBehaviour_Struct_2_E658502528B7C034_9 _methodParm; // 0x18
