...
#define MOLEMOLE_TIMELINE_SHOTACTIVETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x12B278A0)
#define MOLEMOLE_TIMELINE_SHOTACTIVETRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x12B27CA0)
#define MOLEMOLE_TIMELINE_SHOTACTIVETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x12B27C40)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ShotActiveTrack_TypeDefinitionIndex = 44297;
