...
#define MOLEMOLE_TIMELINE_SHOTACTIVETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x160FC4C0)
#define MOLEMOLE_TIMELINE_SHOTACTIVETRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x160FC8C0)
#define MOLEMOLE_TIMELINE_SHOTACTIVETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x160FC860)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ShotActiveTrack_TypeDefinitionIndex = 87226;
