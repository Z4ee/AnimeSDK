...
#include "unitysdk/MoleMole/Timeline/ColorAdjustmentsBehaviour_Struct_2_52AD02145F5FCE3A_18.h"
...
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x190B9970)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x190BA480)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x190BC300)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_METHOD_4_5DF3C0714D769175_OFFSET UNITYSDK_OFFSET(0x190B9EB0)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x190BC2F0)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x190BC320)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x190BC310)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x190BA2A0)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x190BB940)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x190BBC30)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x190BC270)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ColorAdjustmentsBehaviour_TypeDefinitionIndex = 58474;

	class ColorAdjustmentsBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::ColorAdjustmentsBehaviour_Struct_2_52AD02145F5FCE3A_18 _methodParm; // 0x18
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET))(this);
		}
	};
}
