...
#include "unitysdk/MoleMole/Timeline/ColorAdjustmentsBehaviour_Struct_2_52AD02145F5FCE3A_19.h"
...
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x15B59D90)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x15B5C770)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_METHOD_4_5DF3C0714D769175_OFFSET UNITYSDK_OFFSET(0x15B5A2D0)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x15B5C790)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_METHOD_4_8DC55F996A78F0A1_OFFSET UNITYSDK_OFFSET(0x15B5A8A0)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x15B5C7A0)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x15B5C780)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x15B5A6C0)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x15B5BDC0)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x15B5C0B0)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x15B5C6F0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ColorAdjustmentsBehaviour_TypeDefinitionIndex = 63060;

	class ColorAdjustmentsBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::ColorAdjustmentsBehaviour_Struct_2_52AD02145F5FCE3A_19 _methodParm; // 0x18
