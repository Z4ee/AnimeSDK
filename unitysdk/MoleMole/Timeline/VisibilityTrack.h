...
#define MOLEMOLE_TIMELINE_VISIBILITYTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x12669680)
#define MOLEMOLE_TIMELINE_VISIBILITYTRACK_GET_POSTPLAYBACKSTATE_OFFSET UNITYSDK_OFFSET(0x12669560)
#define MOLEMOLE_TIMELINE_VISIBILITYTRACK_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x12669610)
#define MOLEMOLE_TIMELINE_VISIBILITYTRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x126699A0)
#define MOLEMOLE_TIMELINE_VISIBILITYTRACK_METHOD_5_F3B5D2FFB3A112AC_OFFSET UNITYSDK_OFFSET(0x12669990)
#define MOLEMOLE_TIMELINE_VISIBILITYTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x126698B0)
#define MOLEMOLE_TIMELINE_VISIBILITYTRACK_SET_POSTPLAYBACKSTATE_OFFSET UNITYSDK_OFFSET(0x12669570)
#define MOLEMOLE_TIMELINE_VISIBILITYTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x12669930)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int VisibilityTrack_TypeDefinitionIndex = 78895;
