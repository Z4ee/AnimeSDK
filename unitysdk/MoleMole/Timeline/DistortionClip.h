...
#define MOLEMOLE_TIMELINE_DISTORTIONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1891B010)
#define MOLEMOLE_TIMELINE_DISTORTIONCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1891B000)
#define MOLEMOLE_TIMELINE_DISTORTIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1891B1F0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int DistortionClip_TypeDefinitionIndex = 43031;
