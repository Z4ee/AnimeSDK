...
#define MOLEMOLE_TIMELINE_CHARACTERVOLUMEPROXYCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x136F2EB0)
#define MOLEMOLE_TIMELINE_CHARACTERVOLUMEPROXYCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x136F2EA0)
#define MOLEMOLE_TIMELINE_CHARACTERVOLUMEPROXYCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x136F3090)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int CharacterVolumeProxyClip_TypeDefinitionIndex = 63447;
