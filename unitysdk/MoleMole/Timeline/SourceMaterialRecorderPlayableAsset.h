...
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1BA18250)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1BA18200)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERPLAYABLEASSET_INITDATA_OFFSET UNITYSDK_OFFSET(0x1BA18210)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA18330)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SourceMaterialRecorderPlayableAsset_TypeDefinitionIndex = 30658;
