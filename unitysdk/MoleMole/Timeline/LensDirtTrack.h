...
#define MOLEMOLE_TIMELINE_LENSDIRTTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x15B5E020)
#define MOLEMOLE_TIMELINE_LENSDIRTTRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x15B5E2D0)
#define MOLEMOLE_TIMELINE_LENSDIRTTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x15B5E270)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int LensDirtTrack_TypeDefinitionIndex = 38030;
