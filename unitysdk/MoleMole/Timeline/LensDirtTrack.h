...
#define MOLEMOLE_TIMELINE_LENSDIRTTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x17DF70A0)
#define MOLEMOLE_TIMELINE_LENSDIRTTRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x17DF7350)
#define MOLEMOLE_TIMELINE_LENSDIRTTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x17DF72F0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int LensDirtTrack_TypeDefinitionIndex = 75790;
