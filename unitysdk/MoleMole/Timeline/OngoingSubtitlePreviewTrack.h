...
#define MOLEMOLE_TIMELINE_ONGOINGSUBTITLEPREVIEWTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x173A4B40)
#define MOLEMOLE_TIMELINE_ONGOINGSUBTITLEPREVIEWTRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x173A4D00)
#define MOLEMOLE_TIMELINE_ONGOINGSUBTITLEPREVIEWTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x173A4CA0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int OngoingSubtitlePreviewTrack_TypeDefinitionIndex = 71133;
