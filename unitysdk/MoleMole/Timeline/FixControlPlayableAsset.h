...
#define MOLEMOLE_TIMELINE_FIXCONTROLPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x180A5D60)
#define MOLEMOLE_TIMELINE_FIXCONTROLPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x180A5D50)
#define MOLEMOLE_TIMELINE_FIXCONTROLPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x180A5EB0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int FixControlPlayableAsset_TypeDefinitionIndex = 46036;
