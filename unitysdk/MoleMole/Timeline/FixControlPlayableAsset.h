...
#define MOLEMOLE_TIMELINE_FIXCONTROLPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x15863550)
#define MOLEMOLE_TIMELINE_FIXCONTROLPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x15863540)
#define MOLEMOLE_TIMELINE_FIXCONTROLPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x158636A0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int FixControlPlayableAsset_TypeDefinitionIndex = 52300;
