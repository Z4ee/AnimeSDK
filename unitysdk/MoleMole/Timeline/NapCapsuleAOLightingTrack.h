...
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1B6B65B0)
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGTRACK_METHOD_6_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x1B6B6860)
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6B6800)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int NapCapsuleAOLightingTrack_TypeDefinitionIndex = 52485;
