...
#define MOLEMOLE_TIMELINE_FIXEDTIMESTEPBEHAVIOR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1F98DA80)
#define MOLEMOLE_TIMELINE_FIXEDTIMESTEPBEHAVIOR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1F98D9C0)
#define MOLEMOLE_TIMELINE_FIXEDTIMESTEPBEHAVIOR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1F98DB10)
#define MOLEMOLE_TIMELINE_FIXEDTIMESTEPBEHAVIOR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1F98DA30)
#define MOLEMOLE_TIMELINE_FIXEDTIMESTEPBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1F98DBA0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int FixedTimeStepBehavior_TypeDefinitionIndex = 32786;
