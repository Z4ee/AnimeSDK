...
#define MOLEMOLE_TIMELINE_FIXEDTIMESTEPBEHAVIOR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1C2872C0)
#define MOLEMOLE_TIMELINE_FIXEDTIMESTEPBEHAVIOR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1C287200)
#define MOLEMOLE_TIMELINE_FIXEDTIMESTEPBEHAVIOR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1C287350)
#define MOLEMOLE_TIMELINE_FIXEDTIMESTEPBEHAVIOR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1C287270)
#define MOLEMOLE_TIMELINE_FIXEDTIMESTEPBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2873E0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int FixedTimeStepBehavior_TypeDefinitionIndex = 30610;
