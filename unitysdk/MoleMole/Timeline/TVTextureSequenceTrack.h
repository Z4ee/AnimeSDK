...
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCETRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x17061500)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x17061760)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCETRACK_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x17061750)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCETRACK_METHOD_5_652F102150AC9967_OFFSET UNITYSDK_OFFSET(0x17061920)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCETRACK_METHOD_5_B1CEB44F8026DA0D_OFFSET UNITYSDK_OFFSET(0x17061960)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x170618C0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TVTextureSequenceTrack_TypeDefinitionIndex = 57987;
