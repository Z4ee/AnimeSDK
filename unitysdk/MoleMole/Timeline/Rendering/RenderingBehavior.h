...
#define MOLEMOLE_TIMELINE_RENDERING_RENDERINGBEHAVIOR_METHOD_2_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x1999AD80)
#define MOLEMOLE_TIMELINE_RENDERING_RENDERINGBEHAVIOR_METHOD_2_79ED6854413CA2F4_1_OFFSET UNITYSDK_OFFSET(0x1999AD60)
#define MOLEMOLE_TIMELINE_RENDERING_RENDERINGBEHAVIOR_METHOD_2_79ED6854413CA2F4_2_OFFSET UNITYSDK_OFFSET(0x1999AD70)
#define MOLEMOLE_TIMELINE_RENDERING_RENDERINGBEHAVIOR_METHOD_2_79ED6854413CA2F4_OFFSET UNITYSDK_OFFSET(0x1999AD50)
#define MOLEMOLE_TIMELINE_RENDERING_RENDERINGBEHAVIOR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1999ABF0)
#define MOLEMOLE_TIMELINE_RENDERING_RENDERINGBEHAVIOR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1999AA60)
#define MOLEMOLE_TIMELINE_RENDERING_RENDERINGBEHAVIOR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1999AC90)
#define MOLEMOLE_TIMELINE_RENDERING_RENDERINGBEHAVIOR_PREPAREFRAME_OFFSET UNITYSDK_OFFSET(0x1999AB50)
#define MOLEMOLE_TIMELINE_RENDERING_RENDERINGBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1999AD00)

namespace MoleMole::Timeline::Rendering
{
	inline static constexpr unsigned int RenderingBehavior_TypeDefinitionIndex = 89411;
