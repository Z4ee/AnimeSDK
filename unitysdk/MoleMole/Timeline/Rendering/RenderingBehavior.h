...
#define MOLEMOLE_TIMELINE_RENDERING_RENDERINGBEHAVIOR_METHOD_2_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x160FC1D0)
#define MOLEMOLE_TIMELINE_RENDERING_RENDERINGBEHAVIOR_METHOD_2_79ED6854413CA2F4_1_OFFSET UNITYSDK_OFFSET(0x160FC1F0)
#define MOLEMOLE_TIMELINE_RENDERING_RENDERINGBEHAVIOR_METHOD_2_79ED6854413CA2F4_2_OFFSET UNITYSDK_OFFSET(0x160FC200)
#define MOLEMOLE_TIMELINE_RENDERING_RENDERINGBEHAVIOR_METHOD_2_79ED6854413CA2F4_OFFSET UNITYSDK_OFFSET(0x160FC1E0)
#define MOLEMOLE_TIMELINE_RENDERING_RENDERINGBEHAVIOR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x160FC070)
#define MOLEMOLE_TIMELINE_RENDERING_RENDERINGBEHAVIOR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x160FBEE0)
#define MOLEMOLE_TIMELINE_RENDERING_RENDERINGBEHAVIOR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x160FC110)
#define MOLEMOLE_TIMELINE_RENDERING_RENDERINGBEHAVIOR_PREPAREFRAME_OFFSET UNITYSDK_OFFSET(0x160FBFD0)
#define MOLEMOLE_TIMELINE_RENDERING_RENDERINGBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x160FC180)

namespace MoleMole::Timeline::Rendering
{
	inline static constexpr unsigned int RenderingBehavior_TypeDefinitionIndex = 79748;
