...
#define MOLEMOLE_TIMELINE_RENDERING_RENDERINGSETTING_METHOD_1_E2BCD1B56132A826_1_OFFSET UNITYSDK_OFFSET(0x13EC5C90)
#define MOLEMOLE_TIMELINE_RENDERING_RENDERINGSETTING_METHOD_1_E2BCD1B56132A826_OFFSET UNITYSDK_OFFSET(0x13EC5840)
#define MOLEMOLE_TIMELINE_RENDERING_RENDERINGSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x13EC5830)

namespace MoleMole::Timeline::Rendering
{
	inline static constexpr unsigned int RenderingSetting_TypeDefinitionIndex = 76157;
