...
#define MOLEMOLE_TIMELINE_RENDERING_RENDERINGTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x11D7BBF0)

namespace MoleMole::Timeline::Rendering
{
	inline static constexpr unsigned int RenderingTrack_TypeDefinitionIndex = 84935;
