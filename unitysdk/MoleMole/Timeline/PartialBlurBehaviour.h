...
#include "unitysdk/MoleMole/Timeline/PartialBlurBehaviour_Struct_2_52AD02145F5FCE36_13.h"
...
#define MOLEMOLE_TIMELINE_PARTIALBLURBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x173A4D40)
#define MOLEMOLE_TIMELINE_PARTIALBLURBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x173A5420)
#define MOLEMOLE_TIMELINE_PARTIALBLURBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x173A6340)
#define MOLEMOLE_TIMELINE_PARTIALBLURBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x173A6310)
#define MOLEMOLE_TIMELINE_PARTIALBLURBEHAVIOUR_METHOD_4_8B5B005CCA79FEBC_OFFSET UNITYSDK_OFFSET(0x173A4F70)
#define MOLEMOLE_TIMELINE_PARTIALBLURBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x173A6330)
#define MOLEMOLE_TIMELINE_PARTIALBLURBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x173A6320)
#define MOLEMOLE_TIMELINE_PARTIALBLURBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x173A5360)
#define MOLEMOLE_TIMELINE_PARTIALBLURBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x173A5DF0)
#define MOLEMOLE_TIMELINE_PARTIALBLURBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x173A5FC0)
#define MOLEMOLE_TIMELINE_PARTIALBLURBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x173A62F0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int PartialBlurBehaviour_TypeDefinitionIndex = 56171;

	class PartialBlurBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::PartialBlurBehaviour_Struct_2_52AD02145F5FCE36_13 _methodParm; // 0x18
