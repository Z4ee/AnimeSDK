...
#include "unitysdk/MoleMole/Timeline/PartialBlurBehaviour_Struct_2_52AD02145F5FCE36_12.h"
...
#define MOLEMOLE_TIMELINE_PARTIALBLURBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x167BD290)
#define MOLEMOLE_TIMELINE_PARTIALBLURBEHAVIOUR_METHOD_4_146BFCE7108816B9_OFFSET UNITYSDK_OFFSET(0x167BD970)
#define MOLEMOLE_TIMELINE_PARTIALBLURBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x167BE880)
#define MOLEMOLE_TIMELINE_PARTIALBLURBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x167BE890)
#define MOLEMOLE_TIMELINE_PARTIALBLURBEHAVIOUR_METHOD_4_8B5B005CCA79FEBC_OFFSET UNITYSDK_OFFSET(0x167BD4C0)
#define MOLEMOLE_TIMELINE_PARTIALBLURBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x167BE870)
#define MOLEMOLE_TIMELINE_PARTIALBLURBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x167BE860)
#define MOLEMOLE_TIMELINE_PARTIALBLURBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x167BD8B0)
#define MOLEMOLE_TIMELINE_PARTIALBLURBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x167BE340)
#define MOLEMOLE_TIMELINE_PARTIALBLURBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x167BE510)
#define MOLEMOLE_TIMELINE_PARTIALBLURBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x167BE840)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int PartialBlurBehaviour_TypeDefinitionIndex = 48323;

	class PartialBlurBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::PartialBlurBehaviour_Struct_2_52AD02145F5FCE36_12 _methodParm; // 0x18
