...
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_156861AFEC568115_OFFSET UNITYSDK_OFFSET(0x1B21D3A0)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_324AEE341AAA7A1B_1_OFFSET UNITYSDK_OFFSET(0x1B21D7A0)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_324AEE341AAA7A1B_2_OFFSET UNITYSDK_OFFSET(0x1B21D950)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x1B21D5E0)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_637BB645FA4F6E89_OFFSET UNITYSDK_OFFSET(0x1B21D7B0)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_79ED6854413CA2F4_1_OFFSET UNITYSDK_OFFSET(0x1B21D930)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_79ED6854413CA2F4_OFFSET UNITYSDK_OFFSET(0x1B21D920)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_81459141CB11ADC8_OFFSET UNITYSDK_OFFSET(0x1B21D5F0)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_9B2E710EB9D49BA6_OFFSET UNITYSDK_OFFSET(0x1B21C540)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_AB88190D695EBEA9_OFFSET UNITYSDK_OFFSET(0x1B21C050)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_BE18C04CD91E0748_OFFSET UNITYSDK_OFFSET(0x1B21D750)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_E5E342154D4EA5F5_OFFSET UNITYSDK_OFFSET(0x1B21D940)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1B21C4B0)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1B21BFC0)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0x1B21B2D0)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0x1B21BA70)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1B21D540)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1B21C8E0)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B21D590)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int WwiseAudioBehaviour_TypeDefinitionIndex = 86031;
	...
	public:
		...
		::Class_2_60C8FB52ACCBBF05_Class_0_16E7307DCC43CB2C_79* _subtitleViewer; // 0x70
