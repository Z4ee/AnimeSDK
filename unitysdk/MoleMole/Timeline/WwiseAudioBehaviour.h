...
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_156861AFEC568115_OFFSET UNITYSDK_OFFSET(0x17064510)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_324AEE341AAA7A1B_1_OFFSET UNITYSDK_OFFSET(0x17064760)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_324AEE341AAA7A1B_2_OFFSET UNITYSDK_OFFSET(0x17064780)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x17064750)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_637BB645FA4F6E89_OFFSET UNITYSDK_OFFSET(0x17064960)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_79ED6854413CA2F4_1_OFFSET UNITYSDK_OFFSET(0x17064950)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_79ED6854413CA2F4_OFFSET UNITYSDK_OFFSET(0x17064770)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_81459141CB11ADC8_OFFSET UNITYSDK_OFFSET(0x17064790)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_9B2E710EB9D49BA6_OFFSET UNITYSDK_OFFSET(0x17063800)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_AB88190D695EBEA9_OFFSET UNITYSDK_OFFSET(0x17063320)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_BE18C04CD91E0748_OFFSET UNITYSDK_OFFSET(0x17064900)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_E5E342154D4EA5F5_OFFSET UNITYSDK_OFFSET(0x170648F0)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x17063770)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x17063290)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0x170625A0)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0x17062D40)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x170646B0)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x17063BA0)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x17064700)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int WwiseAudioBehaviour_TypeDefinitionIndex = 65986;
	...
	public:
		...
		::Class_2_60C8FB52ACCBBF05_Class_0_16E7307DCC43CB2C_23* _subtitleViewer; // 0x70
