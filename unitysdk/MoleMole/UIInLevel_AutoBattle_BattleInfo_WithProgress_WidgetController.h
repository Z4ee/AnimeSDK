...
#define MOLEMOLE_UIINLEVEL_AUTOBATTLE_BATTLEINFO_WITHPROGRESS_WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x164F00E0)
#define MOLEMOLE_UIINLEVEL_AUTOBATTLE_BATTLEINFO_WITHPROGRESS_WIDGETCONTROLLER__GETINFOSTATUS_OFFSET UNITYSDK_OFFSET(0x164EFBC0)
#define MOLEMOLE_UIINLEVEL_AUTOBATTLE_BATTLEINFO_WITHPROGRESS_WIDGETCONTROLLER__REFRESHCUSTOM_OFFSET UNITYSDK_OFFSET(0x164EFC10)
#define MOLEMOLE_UIINLEVEL_AUTOBATTLE_BATTLEINFO_WITHPROGRESS_WIDGETCONTROLLER___BASE__GETINFOSTATUS_OFFSET UNITYSDK_OFFSET(0x164F00F0)
#define MOLEMOLE_UIINLEVEL_AUTOBATTLE_BATTLEINFO_WITHPROGRESS_WIDGETCONTROLLER___BASE__REFRESHCUSTOM_OFFSET UNITYSDK_OFFSET(0x164F0180)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevel_AutoBattle_BattleInfo_WithProgress_WidgetController_TypeDefinitionIndex = 46554;
