...
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER___C__DISPLAYCLASS48_1__CTOR_OFFSET UNITYSDK_OFFSET(0x174D2020)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER___C__DISPLAYCLASS48_1__INITVIDEOPLAYER_B__2_OFFSET UNITYSDK_OFFSET(0x174D2030)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER___C__DISPLAYCLASS48_1__INITVIDEOPLAYER_B__3_OFFSET UNITYSDK_OFFSET(0x174D2060)

namespace MoleMole
{
	inline static constexpr unsigned int UILoadingTransferPopWindowController___c__DisplayClass48_1_TypeDefinitionIndex = 67539;
