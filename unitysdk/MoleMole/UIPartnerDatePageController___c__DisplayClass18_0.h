...
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER___C__DISPLAYCLASS18_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15596C90)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER___C__DISPLAYCLASS18_0__SHOWSELECTWIDGET_B__0_OFFSET UNITYSDK_OFFSET(0x15596CA0)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER___C__DISPLAYCLASS18_0__SHOWSELECTWIDGET_B__1_OFFSET UNITYSDK_OFFSET(0x15597140)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER___C__DISPLAYCLASS18_0__SHOWSELECTWIDGET_G__SETSTATE_2_OFFSET UNITYSDK_OFFSET(0x15596D10)

namespace MoleMole
{
	inline static constexpr unsigned int UIPartnerDatePageController___c__DisplayClass18_0_TypeDefinitionIndex = 46489;

	class UIPartnerDatePageController___c__DisplayClass18_0 : public ::System::Object
	{
	public:
		::System::Action* changeState; // 0x10
