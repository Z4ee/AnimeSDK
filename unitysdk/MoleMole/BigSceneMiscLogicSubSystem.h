...
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_ADDCOMMONSKILLRUNTIMETAG_OFFSET UNITYSDK_OFFSET(0x12C53060)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_ADDSKILL_OFFSET UNITYSDK_OFFSET(0x12C52C90)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_BIGSCENETELEPORTFADEOUTBEGIN_OFFSET UNITYSDK_OFFSET(0x12C4DA20)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_BIGSCENETELEPORTFADEOUTEND_OFFSET UNITYSDK_OFFSET(0x12C4DC00)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_CALLSIMPLEMOVETASKCALLBACK_OFFSET UNITYSDK_OFFSET(0x12C524F0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_CHECKISCURRTRACKEDQUESTSTORYMODELOCKED_OFFSET UNITYSDK_OFFSET(0x12C4E280)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_CLEARHIDDENRENDERLAYERON_OFFSET UNITYSDK_OFFSET(0x12C4D0F0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_CLEARTWOGROUPSVISIBILITY_OFFSET UNITYSDK_OFFSET(0x12C4D140)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_COMMONSKILLONAWAKE_OFFSET UNITYSDK_OFFSET(0x12C4CB80)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_COMMONSKILLONDESTROY_OFFSET UNITYSDK_OFFSET(0x12C4D190)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_DISPATCHABILITYEVENT_OFFSET UNITYSDK_OFFSET(0x12C4EA30)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_DISPATCHGROUPABILITYEVENT_OFFSET UNITYSDK_OFFSET(0x12C4EC10)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_ENTERBATTLESTATISTICS_OFFSET UNITYSDK_OFFSET(0x12C4F850)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_EXITBATTLESTATISTICS_OFFSET UNITYSDK_OFFSET(0x12C4FDF0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_FLIPBATTLESTATISTICSWHENTEAMRELOAD_OFFSET UNITYSDK_OFFSET(0x12C51AC0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_GETACTIVATEDCOMMONSKILLTYPE_OFFSET UNITYSDK_OFFSET(0x12C53280)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_GETLOADINGPAGETIPSTITLEBYTRANSITIONID_OFFSET UNITYSDK_OFFSET(0x12C4DE00)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_GETMAXACCUMULATIONADJUSTMENT_OFFSET UNITYSDK_OFFSET(0x12C4E550)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_GETPROPERTYADJUSTMENT_OFFSET UNITYSDK_OFFSET(0x12C4E020)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_GETSTORYMODEMONSTERADJUSTMENTFLAGS_OFFSET UNITYSDK_OFFSET(0x12C4DFC0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_GET_LASTTELEPORTEVENT_OFFSET UNITYSDK_OFFSET(0x12C4DDE0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_HASINBATTLEENEMYMONSTERALIVE_OFFSET UNITYSDK_OFFSET(0x12C51600)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_ONANYSIMPLEMOVETASKFINISHED_OFFSET UNITYSDK_OFFSET(0x12C50190)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x12C4CAD0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x12C4CE60)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_ONDYNAMICEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x12C50230)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_ONENTITYENTERBATTLESTATECHANGED_OFFSET UNITYSDK_OFFSET(0x12C4FF70)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x12C4F1E0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_ONTELEPORTCOMPLETED_OFFSET UNITYSDK_OFFSET(0x12C4D230)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_POPHIDDENRENDERLAYERON_OFFSET UNITYSDK_OFFSET(0x12C526D0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_POPSCENEGAMEOBJECTSSWITCHER_OFFSET UNITYSDK_OFFSET(0x12C52AA0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_POPTWOGROUPSVISIBILITY_OFFSET UNITYSDK_OFFSET(0x12C527B0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_PUSHHIDDENRENDERLAYERON_OFFSET UNITYSDK_OFFSET(0x12C52660)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_PUSHSCENEGAMEOBJECTSSWITCHER_OFFSET UNITYSDK_OFFSET(0x12C52820)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_PUSHTWOGROUPSVISIBILITY_OFFSET UNITYSDK_OFFSET(0x12C52740)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_REFRESHACTIVATEDSKILL_OFFSET UNITYSDK_OFFSET(0x12C52F90)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_REGISTERABILITYEVENTLISTENER_OFFSET UNITYSDK_OFFSET(0x12C4E830)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_REGISTERBASEEVENTLISTENER_OFFSET UNITYSDK_OFFSET(0x12C50670)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_REGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0x12C4EE50)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_REMOVECOMMONSKILLRUNTIMETAG_OFFSET UNITYSDK_OFFSET(0x12C53200)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_REMOVESIMPLEMOVETASKGRAPHCALLBACK_OFFSET UNITYSDK_OFFSET(0x12C521C0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_REMOVESKILL_OFFSET UNITYSDK_OFFSET(0x12C52E00)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_SENDTELEPORTEVENT_OFFSET UNITYSDK_OFFSET(0x12C4D410)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_SETSIMPLEMOVETASKGRAPHCALLBACK_OFFSET UNITYSDK_OFFSET(0x12C52010)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_SET_LASTTELEPORTEVENT_OFFSET UNITYSDK_OFFSET(0x12C4DDF0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_SHOWTELEPORTPOINTNAMETIP_OFFSET UNITYSDK_OFFSET(0x12C4DEC0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_SPECIALCOOPUPLOADSTATISTICS_OFFSET UNITYSDK_OFFSET(0x12C51870)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_TRYSHOWTELEPORTPOINTNAMETIP_OFFSET UNITYSDK_OFFSET(0x12C4D2A0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_UNREGISTERABILITYEVENTLISTENER_OFFSET UNITYSDK_OFFSET(0x12C4E9A0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_UNREGISTERBASEEVENTLISTENER_OFFSET UNITYSDK_OFFSET(0x12C50DE0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x12C532E0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM__GENUPLOAD_OFFSET UNITYSDK_OFFSET(0x12C51500)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM__SENDAVATARCHANGE_OFFSET UNITYSDK_OFFSET(0x12C4E6F0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x12C536C0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x12C53750)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM___BASE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x12C537E0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM___BASE_REGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0x12C53870)

namespace MoleMole
{
	inline static constexpr unsigned int BigSceneMiscLogicSubSystem_TypeDefinitionIndex = 57038;
	...
	public:
		...
		::MoleMole::EntityHandle _localAvatar; // 0x18
		::System::Collections::Generic::List_1<::Foundation::Unreal::FGameplayTag>* _runtimeTags; // 0x28
		::MoleMole::BigSceneMiscLogicSubSystem_DebugView* _debugView; // 0x30
		::MoleMole::BigSceneMiscLogicSubSystem_HiddenRenderLayer* _hiddenRenderLayer; // 0x38
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::List_1<::System::Int32>*>* SceneGameObjectsSwitcherStack; // 0x40
		::System::Collections::Generic::HashSet_1<::System::UInt32>* _inBattleMonsters; // 0x48
		::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::MonoSceneGameObjectsSwitcher*>* SceneGameObjectsSwitchers; // 0x50
		::System::Action_1<::Class_1_B7E341C5F1A6F199*>* _dynamicEventDelegate; // 0x58
		::System::Collections::Generic::List_1<::MoleMole::BigSceneMiscLogicSubSystem_BigSceneCommonSkill*>* _skills; // 0x60
		::System::Collections::Generic::List_1<::Class_1_D9E0C80DACE89226*>* _abilityEventListenerMap; // 0x68
		::Class_1_534AF681CC2BD5FD_255<::System::UInt16, ::Struct_2_53CBFE47A73426AB>* _dynamicEventListenerMap; // 0x70
		::System::Collections::Generic::Dictionary_2<::System::Object*, ::System::ValueTuple_3<::Foundation::ViewObject::ViewObjectHandle, ::System::Int32, ::System::Action*>>* _simpleMoveTaskGraphCallbacks; // 0x78
		::MoleMole::BigSceneMiscLogicSubSystem_BigSceneCommonSkill* _activatedSkill; // 0x80
		::Struct_2_9E75F47F2670B678 _dynamicEventMask; // 0x88
		::System::Boolean _isInBattle; // 0xC8
		::MoleMole::BigSceneMiscLogicSubSystem_StoryModeMonsterAdjustmentFlags _storyModeMonsterAdjustmentFlags; // 0xC9
		::System::Int32 _teleportNewsBubbleTipID; // 0xCC
		::System::ValueTuple_2<::Enum_3_FBFD6F7304B717CB, ::System::Int32> _LastTeleportEvent_k__BackingField; // 0xD0
		::Struct_2_9E75F47F2670B678 _cachedEventMask; // 0xD8
		...
		::System::ValueTuple_2<::Enum_3_FBFD6F7304B717CB, ::System::Int32> get_LastTeleportEvent()
		{
			return ((::System::ValueTuple_2<::Enum_3_FBFD6F7304B717CB, ::System::Int32>(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_GET_LASTTELEPORTEVENT_OFFSET))(this);
		}

		::System::Void set_LastTeleportEvent(::System::ValueTuple_2<::Enum_3_FBFD6F7304B717CB, ::System::Int32> value)
		{
			return ((::System::Void(*)(::PVOID, ::System::ValueTuple_2<::Enum_3_FBFD6F7304B717CB, ::System::Int32>))((::PBYTE)hIl2Cpp + MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_SET_LASTTELEPORTEVENT_OFFSET))(this, value);
		}

		::System::Void SendTeleportEvent(::Enum_3_FBFD6F7304B717CB graphEvent, ::System::Int32 teleportID)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_FBFD6F7304B717CB, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_SENDTELEPORTEVENT_OFFSET))(this, graphEvent, teleportID);
		}
		...
		static ::System::Boolean CheckIsCurrTrackedQuestStoryModeLocked(::Class_2_208CC9941471731A_741*& curPresetRule, ::System::Boolean isStrict)
		{
			return ((::System::Boolean(*)(::Class_2_208CC9941471731A_741*&, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_CHECKISCURRTRACKEDQUESTSTORYMODELOCKED_OFFSET))(curPresetRule, isStrict);
		}
		...
		::System::Void RegisterAbilityEventListener(::Class_1_D9E0C80DACE89226* listener)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_D9E0C80DACE89226*))((::PBYTE)hIl2Cpp + MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_REGISTERABILITYEVENTLISTENER_OFFSET))(this, listener);
		}

		::System::Void UnregisterAbilityEventListener(::Class_1_D9E0C80DACE89226* listener)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_D9E0C80DACE89226*))((::PBYTE)hIl2Cpp + MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_UNREGISTERABILITYEVENTLISTENER_OFFSET))(this, listener);
		}
		...
		::System::ValueTuple_2<::Class_3_BE75AAF0F7C40C75*, ::Enum_3_DB663931210BBC27_18> _GenUpload(::System::Boolean avatarAllKilled)
		{
			return ((::System::ValueTuple_2<::Class_3_BE75AAF0F7C40C75*, ::Enum_3_DB663931210BBC27_18>(*)(::PVOID, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM__GENUPLOAD_OFFSET))(this, avatarAllKilled);
		}
		...
		::Enum_3_04C7107E01AF7B0E GetActivatedCommonSkillType()
		{
			return ((::Enum_3_04C7107E01AF7B0E(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_GETACTIVATEDCOMMONSKILLTYPE_OFFSET))(this);
		}
