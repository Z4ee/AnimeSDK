...
#define MOLEMOLE_BATTLEEVALUTEBGCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x126ED160)

namespace MoleMole
{
	inline static constexpr unsigned int BattleEvaluteBgColor_TypeDefinitionIndex = 59213;
