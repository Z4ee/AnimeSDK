...
#define MOLEMOLE_MONOREFRESHMATERIAL_ONLYREFRESHCURRENTCOUNT_OFFSET UNITYSDK_OFFSET(0x13864AD0)
#define MOLEMOLE_MONOREFRESHMATERIAL_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x13864CE0)
#define MOLEMOLE_MONOREFRESHMATERIAL_PLAYITEMICONADDANI_OFFSET UNITYSDK_OFFSET(0x13863E00)
#define MOLEMOLE_MONOREFRESHMATERIAL_REFRESHITEMICON_OFFSET UNITYSDK_OFFSET(0x13863920)
#define MOLEMOLE_MONOREFRESHMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x13864DD0)
#define MOLEMOLE_MONOREFRESHMATERIAL___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x13864E80)

namespace MoleMole
{
	inline static constexpr unsigned int MonoRefreshMaterial_TypeDefinitionIndex = 82362;
