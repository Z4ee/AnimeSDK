...
#define MOLEMOLE_MONOREFRESHMATERIAL_ONLYREFRESHCURRENTCOUNT_OFFSET UNITYSDK_OFFSET(0x13AC43C0)
#define MOLEMOLE_MONOREFRESHMATERIAL_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x13AC45D0)
#define MOLEMOLE_MONOREFRESHMATERIAL_PLAYITEMICONADDANI_OFFSET UNITYSDK_OFFSET(0x13AC36E0)
#define MOLEMOLE_MONOREFRESHMATERIAL_REFRESHITEMICON_OFFSET UNITYSDK_OFFSET(0x13AC3200)
#define MOLEMOLE_MONOREFRESHMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x13AC46C0)
#define MOLEMOLE_MONOREFRESHMATERIAL___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x13AC4770)

namespace MoleMole
{
	inline static constexpr unsigned int MonoRefreshMaterial_TypeDefinitionIndex = 48750;
