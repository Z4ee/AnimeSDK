...
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER_GET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x17BCD030)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER_GET_SELECTED_OFFSET UNITYSDK_OFFSET(0x17BCD470)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17BCD980)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17BCDA10)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17BCDDD0)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER_SETACTIVECONSOLETIP_OFFSET UNITYSDK_OFFSET(0x17BCD910)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER_SETONCLICK_OFFSET UNITYSDK_OFFSET(0x17BCD650)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER_SET_BUTTONENABLED_OFFSET UNITYSDK_OFFSET(0x17BCD510)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER_SET_BUTTONVISIBLE_OFFSET UNITYSDK_OFFSET(0x17BCD5B0)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER_SET_COLOR_OFFSET UNITYSDK_OFFSET(0x17BCD3F0)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x17BCD330)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER_SET_SELECTED_OFFSET UNITYSDK_OFFSET(0x17BCD4A0)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER_SET_TITLE_OFFSET UNITYSDK_OFFSET(0x17BCD040)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER_SHOWNUMBER_OFFSET UNITYSDK_OFFSET(0x17BCD720)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17BCDE50)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17BCDEB0)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17BCDF40)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17BCDF50)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralFilterItemRowWidgetController_TypeDefinitionIndex = 80352;
