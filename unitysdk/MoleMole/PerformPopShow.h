...
#define MOLEMOLE_PERFORMPOPSHOW_DOWAIT_OFFSET UNITYSDK_OFFSET(0x17382260)
#define MOLEMOLE_PERFORMPOPSHOW_ENABLESTATE_OFFSET UNITYSDK_OFFSET(0x17382A00)
#define MOLEMOLE_PERFORMPOPSHOW_GET_ISTRIGGERINLOADING_OFFSET UNITYSDK_OFFSET(0x17381FA0)
#define MOLEMOLE_PERFORMPOPSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x17381FB0)
#define MOLEMOLE_PERFORMPOPSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x173821B0)
#define MOLEMOLE_PERFORMPOPSHOW_PLAY_OFFSET UNITYSDK_OFFSET(0x173824C0)
#define MOLEMOLE_PERFORMPOPSHOW__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17382080)
#define MOLEMOLE_PERFORMPOPSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x17381FC0)
#define MOLEMOLE_PERFORMPOPSHOW__ONPROCESS_B__15_0_OFFSET UNITYSDK_OFFSET(0x17382AD0)

namespace MoleMole
{
	inline static constexpr unsigned int PerformPopShow_TypeDefinitionIndex = 86888;
	...
	public:
		...
		::System::Boolean _useBlackOrWhiteMaskFadeOut; // 0x40
		::System::Boolean _blackMaskFadein; // 0x41
		::System::Boolean _useWhiteMaskFadeOut; // 0x42
		...
		::System::Void _OnProcess_b__15_0()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_PERFORMPOPSHOW__ONPROCESS_B__15_0_OFFSET))(this);
		}
	};
}
