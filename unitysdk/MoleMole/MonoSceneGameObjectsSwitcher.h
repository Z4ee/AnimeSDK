...
#define MOLEMOLE_MONOSCENEGAMEOBJECTSSWITCHER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x10D6EDD0)
#define MOLEMOLE_MONOSCENEGAMEOBJECTSSWITCHER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x10D6EC20)
#define MOLEMOLE_MONOSCENEGAMEOBJECTSSWITCHER_SWITCHVISIBILITY_OFFSET UNITYSDK_OFFSET(0x10D6EB00)
#define MOLEMOLE_MONOSCENEGAMEOBJECTSSWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x10D6EE70)

namespace MoleMole
{
	inline static constexpr unsigned int MonoSceneGameObjectsSwitcher_TypeDefinitionIndex = 55207;
