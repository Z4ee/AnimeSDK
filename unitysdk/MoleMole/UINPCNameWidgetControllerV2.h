...
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_APPLYVISUALSTATE_OFFSET UNITYSDK_OFFSET(0x18201A80)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_CHECKOCCLUSIONPHYSICSHIT_OFFSET UNITYSDK_OFFSET(0x181FDEA0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_CLEARALLANIMATION_OFFSET UNITYSDK_OFFSET(0x181FC4F0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_FINISHALLANIMATION_OFFSET UNITYSDK_OFFSET(0x181FD460)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_FINISHROOTANIMATION_OFFSET UNITYSDK_OFFSET(0x18201D00)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_GETTRACKICONFADEANI_OFFSET UNITYSDK_OFFSET(0x181FDA00)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_GET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x181FB7F0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ISDOORLEAVESTATE_OFFSET UNITYSDK_OFFSET(0x181FFA80)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ONBEFOREONDISABLE_OFFSET UNITYSDK_OFFSET(0x181FD2D0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ONBEFOREONENABLE_OFFSET UNITYSDK_OFFSET(0x181FCA70)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ONBUILDINTERACTMAP_OFFSET UNITYSDK_OFFSET(0x18204B10)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ONCLOSENPCTRACK_OFFSET UNITYSDK_OFFSET(0x18205330)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x181FC130)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ONFADEINTRACKICON_OFFSET UNITYSDK_OFFSET(0x181FCCA0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ONFADEOUTTRACKICON_OFFSET UNITYSDK_OFFSET(0x181FCF30)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ONFUNCTIONUNLOCKED_OFFSET UNITYSDK_OFFSET(0x18204D10)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ONHIDENPCCHATUI_OFFSET UNITYSDK_OFFSET(0x182042D0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ONHIDENPCCHAT_OFFSET UNITYSDK_OFFSET(0x18204280)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ONINNPCCHATDISTANCE_OFFSET UNITYSDK_OFFSET(0x18204460)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ONMAINCITYSHOWSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x18204C00)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ONNPCINTERACTED_OFFSET UNITYSDK_OFFSET(0x18204CA0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ONNPCSPECIALHINTUPDATE_OFFSET UNITYSDK_OFFSET(0x18205230)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ONNPCSTARTINTERACT_OFFSET UNITYSDK_OFFSET(0x18204B90)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ONOUTNPCCHATDISTANCE_OFFSET UNITYSDK_OFFSET(0x182044F0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ONQUESTTRACKUPDATE_OFFSET UNITYSDK_OFFSET(0x182051E0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ONQUESTUPDATE_OFFSET UNITYSDK_OFFSET(0x18205190)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ONSHOWNPCCHATUI_1_OFFSET UNITYSDK_OFFSET(0x182040B0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ONSHOWNPCCHATUI_OFFSET UNITYSDK_OFFSET(0x18204670)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ONSHOWNPCCHAT_OFFSET UNITYSDK_OFFSET(0x18203F50)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x181FC770)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x181FC200)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x181FB810)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ONUIREUSE_OFFSET UNITYSDK_OFFSET(0x181FD640)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ONUNLOCKINTERACTED_OFFSET UNITYSDK_OFFSET(0x182050D0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ONUPDATE2D_OFFSET UNITYSDK_OFFSET(0x18200CF0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_ONUPDATEINTERACT_OFFSET UNITYSDK_OFFSET(0x182046D0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_PLAYARROWANIM_OFFSET UNITYSDK_OFFSET(0x18204720)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_PLAYARROWINTERACTFADEOUT_OFFSET UNITYSDK_OFFSET(0x18204870)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_PLAYCHATBUBBLEANIM_OFFSET UNITYSDK_OFFSET(0x18202F60)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_PLAYDIFFTRACKICONANIM_OFFSET UNITYSDK_OFFSET(0x18202340)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_PLAYEMOSYNC_OFFSET UNITYSDK_OFFSET(0x18203C10)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_PLAYNAMETEXTANIM_OFFSET UNITYSDK_OFFSET(0x18202E60)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_PLAYTRACKICONANIM_1_OFFSET UNITYSDK_OFFSET(0x18202260)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_PLAYTRACKICONANIM_OFFSET UNITYSDK_OFFSET(0x181FCE90)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_PLAYTRACKICONNEARANIM_OFFSET UNITYSDK_OFFSET(0x182028B0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_PLAYVOICE_OFFSET UNITYSDK_OFFSET(0x182033A0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_REFRESHNAME_OFFSET UNITYSDK_OFFSET(0x181FE160)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_REFRESHSPECIALHINT_OFFSET UNITYSDK_OFFSET(0x181FE4F0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_REFRESHTRACKICON_OFFSET UNITYSDK_OFFSET(0x181FFCF0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_REFRESHUNLOCK_OFFSET UNITYSDK_OFFSET(0x181FE390)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_SAMPLEALLTOFADEIN_OFFSET UNITYSDK_OFFSET(0x181FC7D0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_SAMPLEANIM_OFFSET UNITYSDK_OFFSET(0x181FDAA0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_SAMPLETOFADEANIMATION_OFFSET UNITYSDK_OFFSET(0x182021B0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_SETCHATBUBBLETEXT_OFFSET UNITYSDK_OFFSET(0x18203210)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_SETDOORNAME_OFFSET UNITYSDK_OFFSET(0x18204A70)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_SETENTITY_OFFSET UNITYSDK_OFFSET(0x181FDB70)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_SETNAMETEXT_OFFSET UNITYSDK_OFFSET(0x181FF8E0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_SETNULLNAMETEXT_OFFSET UNITYSDK_OFFSET(0x18202BC0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_SETSPACINGACTIVE_OFFSET UNITYSDK_OFFSET(0x181FF710)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_SET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x181FB800)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_STOPALLCOROUTINES_OFFSET UNITYSDK_OFFSET(0x181FC970)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_UNACTIVETRACKICON_1_OFFSET UNITYSDK_OFFSET(0x18202A90)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_UNACTIVETRACKICON_OFFSET UNITYSDK_OFFSET(0x18202A30)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_UPDATEALLANIMATION_OFFSET UNITYSDK_OFFSET(0x181FCAD0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_UPDATEARROWVISIBILITY_OFFSET UNITYSDK_OFFSET(0x181FE550)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_UPDATENAMETEXTVISIBILITY_OFFSET UNITYSDK_OFFSET(0x182010C0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_UPDATEOCCLUSION_OFFSET UNITYSDK_OFFSET(0x181FDF00)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_UPDATEOFFSET_OFFSET UNITYSDK_OFFSET(0x18202E00)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_UPDATERECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x182014F0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_UPDATEROOTANIMATION_OFFSET UNITYSDK_OFFSET(0x18202130)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2_UPDATETRACKICONVISIBILITY_OFFSET UNITYSDK_OFFSET(0x181FEAD0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2__CTOR_OFFSET UNITYSDK_OFFSET(0x18205400)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2__ONFADEOUTTRACKICON_B__12_0_OFFSET UNITYSDK_OFFSET(0x18205460)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2__ONFADEOUTTRACKICON_B__12_1_OFFSET UNITYSDK_OFFSET(0x18205490)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2__PLAYARROWINTERACTFADEOUT_B__79_0_OFFSET UNITYSDK_OFFSET(0x182055B0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2__PLAYNAMETEXTANIM_B__62_0_OFFSET UNITYSDK_OFFSET(0x18205590)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2__REFRESHTRACKICON_G__SETTRACKICONIMAGE_40_0_OFFSET UNITYSDK_OFFSET(0x18200BD0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2__REFRESHTRACKICON_G__SETTRACKROLEIMAGE_40_1_OFFSET UNITYSDK_OFFSET(0x18200960)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2__UPDATETRACKICONVISIBILITY_B__51_0_OFFSET UNITYSDK_OFFSET(0x182054C0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2__UPDATETRACKICONVISIBILITY_B__51_1_OFFSET UNITYSDK_OFFSET(0x18205530)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x182055C0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x18205650)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18205660)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x182056F0)
#define MOLEMOLE_UINPCNAMEWIDGETCONTROLLERV2___BASE_ONUIREUSE_OFFSET UNITYSDK_OFFSET(0x18205780)

namespace MoleMole
{
	inline static constexpr unsigned int UINPCNameWidgetControllerV2_TypeDefinitionIndex = 43123;
	...
	public:
		...
		::Class_2_5918EB2C42062A7B* _view; // 0x2D0
