...
#define MOLEMOLE_CONFIGUIACTIVITYRHYTHMCLICK__CTOR_OFFSET UNITYSDK_OFFSET(0x189E4550)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIActivityRhythmClick_TypeDefinitionIndex = 69972;
