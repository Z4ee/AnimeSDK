...
#define MOLEMOLE_UICINEMAREWARDCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15250370)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaRewardContext_TypeDefinitionIndex = 44944;
