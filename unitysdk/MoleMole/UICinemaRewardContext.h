...
#define MOLEMOLE_UICINEMAREWARDCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x14E84240)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaRewardContext_TypeDefinitionIndex = 66976;
