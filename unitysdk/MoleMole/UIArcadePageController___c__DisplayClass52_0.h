...
#define MOLEMOLE_UIARCADEPAGECONTROLLER___C__DISPLAYCLASS52_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16125BA0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER___C__DISPLAYCLASS52_0__ENTERARCADEMACHINEPHASEFROMENTRANCE_B__0_OFFSET UNITYSDK_OFFSET(0x16125BB0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER___C__DISPLAYCLASS52_0__ENTERARCADEMACHINEPHASEFROMENTRANCE_B__1_OFFSET UNITYSDK_OFFSET(0x16125C40)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadePageController___c__DisplayClass52_0_TypeDefinitionIndex = 60565;
