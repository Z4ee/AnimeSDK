...
#define MOLEMOLE_UITOWERDEFENSERESULTPAGECONTROLLER_ACQUIRETITLETEXT_OFFSET UNITYSDK_OFFSET(0x15F96E10)
#define MOLEMOLE_UITOWERDEFENSERESULTPAGECONTROLLER_GETBUTTONCOMBINESTATE_OFFSET UNITYSDK_OFFSET(0x15F96D70)
#define MOLEMOLE_UITOWERDEFENSERESULTPAGECONTROLLER_GETPANELSTATE_OFFSET UNITYSDK_OFFSET(0x15F96DC0)
#define MOLEMOLE_UITOWERDEFENSERESULTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15F96890)
#define MOLEMOLE_UITOWERDEFENSERESULTPAGECONTROLLER_ONPOPSHOWED_OFFSET UNITYSDK_OFFSET(0x15F96E80)
#define MOLEMOLE_UITOWERDEFENSERESULTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15F96BE0)
#define MOLEMOLE_UITOWERDEFENSERESULTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15F96990)
#define MOLEMOLE_UITOWERDEFENSERESULTPAGECONTROLLER_REFRESHEXP_OFFSET UNITYSDK_OFFSET(0x15F97120)
#define MOLEMOLE_UITOWERDEFENSERESULTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15F97C90)
#define MOLEMOLE_UITOWERDEFENSERESULTPAGECONTROLLER__ONANIMEVENT_OFFSET UNITYSDK_OFFSET(0x15F97B80)
#define MOLEMOLE_UITOWERDEFENSERESULTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15F97CA0)
#define MOLEMOLE_UITOWERDEFENSERESULTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15F97D70)
#define MOLEMOLE_UITOWERDEFENSERESULTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15F97D80)

namespace MoleMole
{
	inline static constexpr unsigned int UITowerDefenseResultPageController_TypeDefinitionIndex = 81921;
	...
	public:
		...
		::Class_2_79F6D62CE30E3F8E_141* _view; // 0x388
		...
		{
			return ((::Class_1_451601B8BB62C38C_Enum_3_F05C56E76E4AE95C(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UITOWERDEFENSERESULTPAGECONTROLLER_GETPANELSTATE_OFFSET))(this);
		}
