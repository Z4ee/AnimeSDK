...
#define MOLEMOLE_UIHADALZONE_IMPACTBATTLE_LINEUPWIDGETCONTROLLER___C__DISPLAYCLASS5_0__BINDBTNS_B__4_OFFSET UNITYSDK_OFFSET(0x151D2190)
#define MOLEMOLE_UIHADALZONE_IMPACTBATTLE_LINEUPWIDGETCONTROLLER___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x151D2180)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_ImpactBattle_LineupWidgetController___c__DisplayClass5_0_TypeDefinitionIndex = 51563;
	...
	public:
		...
		::Class_2_468A4FBF2E9F527C* hadalZoneModel; // 0x18
