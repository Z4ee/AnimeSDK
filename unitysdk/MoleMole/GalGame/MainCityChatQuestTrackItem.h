...
#define MOLEMOLE_GALGAME_MAINCITYCHATQUESTTRACKITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x144D9CA0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatQuestTrackItem_TypeDefinitionIndex = 89171;
