...
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMPASSTHROUGH_MAINCITYCHATCAMERAPARAMPASSTHROUGH_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x16CACCA0)
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMPASSTHROUGH_MAINCITYCHATCAMERAPARAMPASSTHROUGH_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x16CACCB0)
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMPASSTHROUGH_MAINCITYCHATCAMERAPARAMPASSTHROUGH_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x16CACDE0)
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMPASSTHROUGH_MAINCITYCHATCAMERAPARAMPASSTHROUGH_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x16CACF20)
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMPASSTHROUGH_MAINCITYCHATCAMERAPARAMPASSTHROUGH_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x16CACEE0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatCameraParamPassThrough_MainCityChatCameraParamPassThrough_UnityGeneratedFormatter_TypeDefinitionIndex = 70498;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::GalGame::MainCityChatCameraPassThroughTarget>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatCameraParamPassThrough_MainCityChatCameraParamPassThrough_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x42E50);
		}
