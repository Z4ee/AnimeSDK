...
#define MOLEMOLE_GALGAME_MAINCITYCHATBRANCHITEM_MAINCITYCHATBRANCHITEM_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x18219830)
#define MOLEMOLE_GALGAME_MAINCITYCHATBRANCHITEM_MAINCITYCHATBRANCHITEM_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x18219840)
#define MOLEMOLE_GALGAME_MAINCITYCHATBRANCHITEM_MAINCITYCHATBRANCHITEM_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x18219A20)
#define MOLEMOLE_GALGAME_MAINCITYCHATBRANCHITEM_MAINCITYCHATBRANCHITEM_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18219BC0)
#define MOLEMOLE_GALGAME_MAINCITYCHATBRANCHITEM_MAINCITYCHATBRANCHITEM_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18219B80)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatBranchItem_MainCityChatBranchItem_UnityGeneratedFormatter_TypeDefinitionIndex = 38094;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatBranchItem_MainCityChatBranchItem_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x48760);
		}
