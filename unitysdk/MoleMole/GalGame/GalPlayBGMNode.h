...
#define MOLEMOLE_GALGAME_GALPLAYBGMNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x144D86C0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalPlayBGMNode_TypeDefinitionIndex = 64886;
