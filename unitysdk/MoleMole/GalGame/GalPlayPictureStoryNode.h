...
#define MOLEMOLE_GALGAME_GALPLAYPICTURESTORYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x11617DA0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalPlayPictureStoryNode_TypeDefinitionIndex = 41569;
