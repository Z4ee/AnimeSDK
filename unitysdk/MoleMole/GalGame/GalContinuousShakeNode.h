...
#define MOLEMOLE_GALGAME_GALCONTINUOUSSHAKENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x15426640)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalContinuousShakeNode_TypeDefinitionIndex = 65220;
