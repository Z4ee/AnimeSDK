...
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWUICONFIG_ONCLOSEWITHINDEX_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x170D1F10)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWUICONFIG_ONCLOSEWITHINDEX_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x170D1F80)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWUICONFIG_ONCLOSEWITHINDEX_INVOKE_OFFSET UNITYSDK_OFFSET(0x170D1980)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWUICONFIG_ONCLOSEWITHINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x170D1F00)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatShowUIConfig_OnCloseWithIndex_TypeDefinitionIndex = 70881;
