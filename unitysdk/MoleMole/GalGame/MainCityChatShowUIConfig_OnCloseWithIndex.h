...
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWUICONFIG_ONCLOSEWITHINDEX_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19DBF1D0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWUICONFIG_ONCLOSEWITHINDEX_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19DBF240)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWUICONFIG_ONCLOSEWITHINDEX_INVOKE_OFFSET UNITYSDK_OFFSET(0x19DBEBE0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWUICONFIG_ONCLOSEWITHINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x19DBF1B0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatShowUIConfig_OnCloseWithIndex_TypeDefinitionIndex = 45411;
