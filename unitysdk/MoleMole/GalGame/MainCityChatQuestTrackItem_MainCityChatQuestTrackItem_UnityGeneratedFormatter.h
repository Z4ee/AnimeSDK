...
#define MOLEMOLE_GALGAME_MAINCITYCHATQUESTTRACKITEM_MAINCITYCHATQUESTTRACKITEM_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x125CCAE0)
#define MOLEMOLE_GALGAME_MAINCITYCHATQUESTTRACKITEM_MAINCITYCHATQUESTTRACKITEM_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x125CCAF0)
#define MOLEMOLE_GALGAME_MAINCITYCHATQUESTTRACKITEM_MAINCITYCHATQUESTTRACKITEM_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x125CCD90)
#define MOLEMOLE_GALGAME_MAINCITYCHATQUESTTRACKITEM_MAINCITYCHATQUESTTRACKITEM_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x125CCF80)
#define MOLEMOLE_GALGAME_MAINCITYCHATQUESTTRACKITEM_MAINCITYCHATQUESTTRACKITEM_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x125CCF40)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatQuestTrackItem_MainCityChatQuestTrackItem_UnityGeneratedFormatter_TypeDefinitionIndex = 71123;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatQuestTrackItem_MainCityChatQuestTrackItem_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x47970);
		}
