...
#define MOLEMOLE_GALGAME_GALGAMENPCACTIONBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x16E55ED0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalGameNPCActionBase_TypeDefinitionIndex = 78223;

	class GalGameNPCActionBase : public ::MoleMole::GalGame::GalGameActionBase
	{
	public:
		::System::String* avatarPoseKey; // 0x10
