...
#define MOLEMOLE_GALGAME_TAGBOOLPAIR_TAGBOOLPAIR_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x13EE0E80)
#define MOLEMOLE_GALGAME_TAGBOOLPAIR_TAGBOOLPAIR_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x13EE0E90)
#define MOLEMOLE_GALGAME_TAGBOOLPAIR_TAGBOOLPAIR_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x13EE1070)
#define MOLEMOLE_GALGAME_TAGBOOLPAIR_TAGBOOLPAIR_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x13EE1210)
#define MOLEMOLE_GALGAME_TAGBOOLPAIR_TAGBOOLPAIR_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x13EE11D0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int TagBoolPair_TagBoolPair_UnityGeneratedFormatter_TypeDefinitionIndex = 77797;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(TagBoolPair_TagBoolPair_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x4D930);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Int32>** StaticGet_CachedSerializer0()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(TagBoolPair_TagBoolPair_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x4D938);
		}
