...
#define MOLEMOLE_GALGAME_GALSWITCHSCENENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1924D420)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalSwitchSceneNode_TypeDefinitionIndex = 49662;
