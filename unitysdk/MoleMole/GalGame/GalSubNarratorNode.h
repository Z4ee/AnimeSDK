...
#define MOLEMOLE_GALGAME_GALSUBNARRATORNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x15427900)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalSubNarratorNode_TypeDefinitionIndex = 53088;
