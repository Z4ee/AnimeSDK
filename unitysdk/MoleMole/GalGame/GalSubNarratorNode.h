...
#define MOLEMOLE_GALGAME_GALSUBNARRATORNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x144D86D0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalSubNarratorNode_TypeDefinitionIndex = 65070;

	class GalSubNarratorNode : public ::MoleMole::GalGame::GalPlayableNodeBase
	{
	public:
		::System::String* dialogueKey; // 0x20
		::System::String* audioKey; // 0x28
