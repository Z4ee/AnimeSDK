...
#define MOLEMOLE_GALGAME_SWITCHSCENECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B19150)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int SwitchSceneConfig_TypeDefinitionIndex = 45783;
