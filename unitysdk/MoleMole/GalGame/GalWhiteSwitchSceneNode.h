...
#define MOLEMOLE_GALGAME_GALWHITESWITCHSCENENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x125CC480)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalWhiteSwitchSceneNode_TypeDefinitionIndex = 82279;
