...
#define MOLEMOLE_GALGAME_GALWHITESWITCHSCENENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x13020870)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalWhiteSwitchSceneNode_TypeDefinitionIndex = 79008;
