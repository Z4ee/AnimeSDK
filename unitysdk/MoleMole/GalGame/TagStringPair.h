...
#define MOLEMOLE_GALGAME_TAGSTRINGPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x16E58BA0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int TagStringPair_TypeDefinitionIndex = 61813;
