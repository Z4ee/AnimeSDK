...
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWRANKLISTCONFIG_MAINCITYCHATSHOWRANKLISTCONFIG_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x1604D930)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWRANKLISTCONFIG_MAINCITYCHATSHOWRANKLISTCONFIG_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x1604D940)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWRANKLISTCONFIG_MAINCITYCHATSHOWRANKLISTCONFIG_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x1604DA70)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWRANKLISTCONFIG_MAINCITYCHATSHOWRANKLISTCONFIG_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1604DBB0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWRANKLISTCONFIG_MAINCITYCHATSHOWRANKLISTCONFIG_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1604DB70)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatShowRankListConfig_MainCityChatShowRankListConfig_UnityGeneratedFormatter_TypeDefinitionIndex = 57860;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatShowRankListConfig_MainCityChatShowRankListConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3C770);
		}
