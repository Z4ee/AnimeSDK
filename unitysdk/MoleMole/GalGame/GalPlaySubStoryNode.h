...
#define MOLEMOLE_GALGAME_GALPLAYSUBSTORYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x149E98A0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalPlaySubStoryNode_TypeDefinitionIndex = 89494;
	...
	public:
		...
		::System::Collections::Generic::List_1<::MoleMole::GalGame::AudioEventItem*>* audioEventItems; // 0x48
