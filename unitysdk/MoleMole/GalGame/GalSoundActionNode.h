...
#define MOLEMOLE_GALGAME_GALSOUNDACTIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x11752DD0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalSoundActionNode_TypeDefinitionIndex = 57701;
