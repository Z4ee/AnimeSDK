...
#define MOLEMOLE_GALGAME_GALSOUNDACTIONNODE_GALSOUNDACTIONNODE_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x12BBF0E0)
#define MOLEMOLE_GALGAME_GALSOUNDACTIONNODE_GALSOUNDACTIONNODE_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x12BBF0F0)
#define MOLEMOLE_GALGAME_GALSOUNDACTIONNODE_GALSOUNDACTIONNODE_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x12BBF440)
#define MOLEMOLE_GALGAME_GALSOUNDACTIONNODE_GALSOUNDACTIONNODE_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x12BBF690)
#define MOLEMOLE_GALGAME_GALSOUNDACTIONNODE_GALSOUNDACTIONNODE_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x12BBF650)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalSoundActionNode_GalSoundActionNode_UnityGeneratedFormatter_TypeDefinitionIndex = 65033;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(GalSoundActionNode_GalSoundActionNode_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3ECA0);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Int32>** StaticGet_CachedSerializer1()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(GalSoundActionNode_GalSoundActionNode_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3ECA8);
		}
		static ::Sirenix::Serialization::Serializer_1<::MoleMole::GalGame::GalPlayableNodeType>** StaticGet_CachedSerializer0()
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::GalGame::GalPlayableNodeType>**)Il2CppClass::FromTypeDefinitionIndex(GalSoundActionNode_GalSoundActionNode_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3ECB0);
		}
