...
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGEITEM_MAINCITYCHATSHOWMESSAGEITEM_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x125CD970)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGEITEM_MAINCITYCHATSHOWMESSAGEITEM_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x125CD980)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGEITEM_MAINCITYCHATSHOWMESSAGEITEM_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x125CDAB0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGEITEM_MAINCITYCHATSHOWMESSAGEITEM_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x125CDBF0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGEITEM_MAINCITYCHATSHOWMESSAGEITEM_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x125CDBB0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatShowMessageItem_MainCityChatShowMessageItem_UnityGeneratedFormatter_TypeDefinitionIndex = 53332;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatShowMessageItem_MainCityChatShowMessageItem_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x47990);
		}
