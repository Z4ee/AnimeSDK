...
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG_GETNEXTSHOW_OFFSET UNITYSDK_OFFSET(0x19BF1180)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG_GET_ANIMATIONID_OFFSET UNITYSDK_OFFSET(0x19BF1860)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG_GET_CAMERA1POS_OFFSET UNITYSDK_OFFSET(0x19BF1A10)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG_GET_CAMERA2POS_OFFSET UNITYSDK_OFFSET(0x19BF1A90)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG_GET_CAMERARELAAVATAR_OFFSET UNITYSDK_OFFSET(0x19BF1CB0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG_GET_CAMERARELANPCID_OFFSET UNITYSDK_OFFSET(0x19BF1CA0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG_GET_FOVANDBLEND_OFFSET UNITYSDK_OFFSET(0x19BF1AD0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG_GET_FOV_OFFSET UNITYSDK_OFFSET(0x19BF1B50)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG_GET_NOISEDURATION_OFFSET UNITYSDK_OFFSET(0x19BF1C00)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG_GET_NOISE_OFFSET UNITYSDK_OFFSET(0x19BF1B60)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG_GET_OVERRIDECAMERANEARCLIP_OFFSET UNITYSDK_OFFSET(0x19BF1C50)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG_GET_UICTRL_OFFSET UNITYSDK_OFFSET(0x19BF1170)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG_ONOPEN_OFFSET UNITYSDK_OFFSET(0x19BF1330)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BF1CC0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatShowMessageConfig_TypeDefinitionIndex = 85914;
	...
	public:
		...
		{
			return ((::Enum_3_DBF2701137F18AA6(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG_GET_UICTRL_OFFSET))(this);
		}
