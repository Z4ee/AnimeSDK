...
#define MOLEMOLE_GALGAME_MINIGAMERECORDNODE_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0x1924E670)
#define MOLEMOLE_GALGAME_MINIGAMERECORDNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1924E660)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MiniGameRecordNode_TypeDefinitionIndex = 55034;
