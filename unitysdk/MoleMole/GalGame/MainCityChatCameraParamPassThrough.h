...
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMPASSTHROUGH_GENERATECAMERAFUNC_OFFSET UNITYSDK_OFFSET(0x18B31DC0)
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMPASSTHROUGH__CTOR_OFFSET UNITYSDK_OFFSET(0x18B31E60)
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMPASSTHROUGH__GENERATECAMERAFUNC_B__1_0_OFFSET UNITYSDK_OFFSET(0x18B31E70)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatCameraParamPassThrough_TypeDefinitionIndex = 70497;
