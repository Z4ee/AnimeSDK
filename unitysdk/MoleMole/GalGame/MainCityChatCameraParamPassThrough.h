...
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMPASSTHROUGH_GENERATECAMERAFUNC_OFFSET UNITYSDK_OFFSET(0x10E1AD10)
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMPASSTHROUGH__CTOR_OFFSET UNITYSDK_OFFSET(0x10E1ADB0)
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMPASSTHROUGH__GENERATECAMERAFUNC_B__1_0_OFFSET UNITYSDK_OFFSET(0x10E1ADC0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatCameraParamPassThrough_TypeDefinitionIndex = 42746;
