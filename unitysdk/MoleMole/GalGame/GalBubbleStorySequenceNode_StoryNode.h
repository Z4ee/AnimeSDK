...
#define MOLEMOLE_GALGAME_GALBUBBLESTORYSEQUENCENODE_STORYNODE_GET_GETNPCSTIMULUSID_OFFSET UNITYSDK_OFFSET(0x129A36C0)
#define MOLEMOLE_GALGAME_GALBUBBLESTORYSEQUENCENODE_STORYNODE_GET_GETSPEAKER_OFFSET UNITYSDK_OFFSET(0x129A3810)
#define MOLEMOLE_GALGAME_GALBUBBLESTORYSEQUENCENODE_STORYNODE_GET_GETTEXT_OFFSET UNITYSDK_OFFSET(0x129A36D0)
#define MOLEMOLE_GALGAME_GALBUBBLESTORYSEQUENCENODE_STORYNODE_GET_GETVOICEOREVENT_OFFSET UNITYSDK_OFFSET(0x129A36E0)
#define MOLEMOLE_GALGAME_GALBUBBLESTORYSEQUENCENODE_STORYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x129A3820)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalBubbleStorySequenceNode_StoryNode_TypeDefinitionIndex = 59080;
	...
	public:
		...
		{
			return ((::System::String*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_GALGAME_GALBUBBLESTORYSEQUENCENODE_STORYNODE_GET_GETSPEAKER_OFFSET))(this);
		}
	};
}
