...
#define MOLEMOLE_GALGAME_GALGAMEPICTUREDISPLAYACTION_GALGAMEPICTUREDISPLAYACTION_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x161F1A30)
#define MOLEMOLE_GALGAME_GALGAMEPICTUREDISPLAYACTION_GALGAMEPICTUREDISPLAYACTION_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x161F1A40)
#define MOLEMOLE_GALGAME_GALGAMEPICTUREDISPLAYACTION_GALGAMEPICTUREDISPLAYACTION_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x161F1B70)
#define MOLEMOLE_GALGAME_GALGAMEPICTUREDISPLAYACTION_GALGAMEPICTUREDISPLAYACTION_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x161F1CB0)
#define MOLEMOLE_GALGAME_GALGAMEPICTUREDISPLAYACTION_GALGAMEPICTUREDISPLAYACTION_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x161F1C70)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalGamePictureDisplayAction_GalGamePictureDisplayAction_UnityGeneratedFormatter_TypeDefinitionIndex = 78344;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(GalGamePictureDisplayAction_GalGamePictureDisplayAction_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x37630);
		}
