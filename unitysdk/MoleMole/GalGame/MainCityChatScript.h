...
#define MOLEMOLE_GALGAME_MAINCITYCHATSCRIPT__CTOR_OFFSET UNITYSDK_OFFSET(0x19085EC0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatScript_TypeDefinitionIndex = 51692;
