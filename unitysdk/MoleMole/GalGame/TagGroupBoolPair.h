...
#define MOLEMOLE_GALGAME_TAGGROUPBOOLPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x149A7090)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int TagGroupBoolPair_TypeDefinitionIndex = 64397;
