...
#define MOLEMOLE_GALGAME_TAGGROUPBOOLPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x14170440)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int TagGroupBoolPair_TypeDefinitionIndex = 58956;
