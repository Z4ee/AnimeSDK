...
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWJOURNEYCONFIG_MAINCITYCHATSHOWJOURNEYCONFIG_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x1512C6A0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWJOURNEYCONFIG_MAINCITYCHATSHOWJOURNEYCONFIG_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x1512C6B0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWJOURNEYCONFIG_MAINCITYCHATSHOWJOURNEYCONFIG_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x1512C890)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWJOURNEYCONFIG_MAINCITYCHATSHOWJOURNEYCONFIG_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1512CA30)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWJOURNEYCONFIG_MAINCITYCHATSHOWJOURNEYCONFIG_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1512C9F0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatShowJourneyConfig_MainCityChatShowJourneyConfig_UnityGeneratedFormatter_TypeDefinitionIndex = 50110;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatShowJourneyConfig_MainCityChatShowJourneyConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x41080);
		}
