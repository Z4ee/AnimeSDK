...
#define MOLEMOLE_GALGAME_TAGGROUPBOOLPAIR_TAGGROUPBOOLPAIR_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x12BC18E0)
#define MOLEMOLE_GALGAME_TAGGROUPBOOLPAIR_TAGGROUPBOOLPAIR_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x12BC18F0)
#define MOLEMOLE_GALGAME_TAGGROUPBOOLPAIR_TAGGROUPBOOLPAIR_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x12BC1AD0)
#define MOLEMOLE_GALGAME_TAGGROUPBOOLPAIR_TAGGROUPBOOLPAIR_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x12BC1C70)
#define MOLEMOLE_GALGAME_TAGGROUPBOOLPAIR_TAGGROUPBOOLPAIR_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x12BC1C30)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int TagGroupBoolPair_TagGroupBoolPair_UnityGeneratedFormatter_TypeDefinitionIndex = 58957;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(TagGroupBoolPair_TagGroupBoolPair_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3ED50);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::String*>** StaticGet_CachedSerializer0()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(TagGroupBoolPair_TagGroupBoolPair_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3ED58);
		}
