...
#define MOLEMOLE_GALGAME_GALJUMPCHAPTERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x136A4060)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalJumpChapterNode_TypeDefinitionIndex = 42037;
