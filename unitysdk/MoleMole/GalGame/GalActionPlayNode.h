...
#define MOLEMOLE_GALGAME_GALACTIONPLAYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1924C860)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalActionPlayNode_TypeDefinitionIndex = 72827;
