...
#define MOLEMOLE_GALGAME_GALNARRATORITEMICONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x15823D60)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalNarratorItemIconNode_TypeDefinitionIndex = 43254;
