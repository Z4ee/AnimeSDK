...
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG___C__DISPLAYCLASS14_1__CTOR_OFFSET UNITYSDK_OFFSET(0x16E57F10)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG___C__DISPLAYCLASS14_1__ONOPEN_B__0_OFFSET UNITYSDK_OFFSET(0x16E57F20)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG___C__DISPLAYCLASS14_1__ONOPEN_B__1_OFFSET UNITYSDK_OFFSET(0x16E580B0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatShowPostConfig___c__DisplayClass14_1_TypeDefinitionIndex = 44352;

	class MainCityChatShowPostConfig___c__DisplayClass14_1 : public ::System::Object
	{
	public:
		::Class_3_E342D954CB576697* post; // 0x10
		::MoleMole::GalGame::MainCityChatShowPostConfig___c__DisplayClass14_0* CS___8__locals1; // 0x18
