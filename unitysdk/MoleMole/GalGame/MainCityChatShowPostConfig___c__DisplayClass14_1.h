...
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG___C__DISPLAYCLASS14_1__CTOR_OFFSET UNITYSDK_OFFSET(0x168569F0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG___C__DISPLAYCLASS14_1__ONOPEN_B__0_OFFSET UNITYSDK_OFFSET(0x16856A00)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG___C__DISPLAYCLASS14_1__ONOPEN_B__1_OFFSET UNITYSDK_OFFSET(0x16856BF0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatShowPostConfig___c__DisplayClass14_1_TypeDefinitionIndex = 67267;
