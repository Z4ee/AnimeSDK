...
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWJOURNEYCONFIG_GET_UICTRL_OFFSET UNITYSDK_OFFSET(0x170D1790)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWJOURNEYCONFIG_ONOPEN_OFFSET UNITYSDK_OFFSET(0x170D17A0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWJOURNEYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x170D1C80)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatShowJourneyConfig_TypeDefinitionIndex = 39802;
	...
	public:
		...
		{
			return ((::Enum_3_81A3942BCC6E42B5(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_GALGAME_MAINCITYCHATSHOWJOURNEYCONFIG_GET_UICTRL_OFFSET))(this);
		}
