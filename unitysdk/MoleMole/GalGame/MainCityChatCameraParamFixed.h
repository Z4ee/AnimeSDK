...
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMFIXED_GENERATECAMERAFUNC_OFFSET UNITYSDK_OFFSET(0x182E1050)
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMFIXED__CTOR_OFFSET UNITYSDK_OFFSET(0x182E10E0)
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMFIXED__GENERATECAMERAFUNC_B__3_0_OFFSET UNITYSDK_OFFSET(0x182E10F0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatCameraParamFixed_TypeDefinitionIndex = 63356;
