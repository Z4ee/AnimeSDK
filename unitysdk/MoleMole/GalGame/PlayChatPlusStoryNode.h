...
#define MOLEMOLE_GALGAME_PLAYCHATPLUSSTORYNODE_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0x14170330)
#define MOLEMOLE_GALGAME_PLAYCHATPLUSSTORYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x14170230)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int PlayChatPlusStoryNode_TypeDefinitionIndex = 78789;

	class PlayChatPlusStoryNode : public ::MoleMole::GalGame::MainCityChatPlayableNodeBase
	{
	public:
		::System::Collections::Generic::List_1<::MoleMole::GalGame::TagGroupAniPair*>* GroupAniParams; // 0x18
		::System::Collections::Generic::List_1<::MoleMole::GalGame::TagAniPair*>* TagAniParams; // 0x20
		::System::String* avatarFacialKey; // 0x28
		::System::String* avatarPoseKey; // 0x30
		::System::String* SoundEvent; // 0x38
		::System::String* SpeakerMember; // 0x40
		::System::String* DialogueKey; // 0x48
		::System::String* ExternalVoiceKey; // 0x50
		::System::String* NpcName; // 0x58
		::System::Single AutoDoNextDelay; // 0x60
		::System::Boolean AutoDoNext; // 0x64
		::System::Single SpeakSpeed; // 0x68
		::System::Int32 SpeakerNpcTag; // 0x6C
		::System::Single ClickTime; // 0x70
