...
#define MOLEMOLE_GALGAME_MAINCITYCHATRANDOMCHOICENODE_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0x1383F680)
#define MOLEMOLE_GALGAME_MAINCITYCHATRANDOMCHOICENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1383F670)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatRandomChoiceNode_TypeDefinitionIndex = 47220;
	...
	public:
		...
		{
			return ((::Class_1_2D5DADE6FF36AA79*(*)(::PVOID, ::MoleMole::UIBaseChatPlayController*, ::MoleMole::UIMainCityChatPlayContext*))((::PBYTE)hIl2Cpp + MOLEMOLE_GALGAME_MAINCITYCHATRANDOMCHOICENODE_INSTANTIATE_OFFSET))(this, controller, context);
		}
	};
}
