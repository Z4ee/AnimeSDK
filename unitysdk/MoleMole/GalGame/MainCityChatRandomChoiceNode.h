...
#define MOLEMOLE_GALGAME_MAINCITYCHATRANDOMCHOICENODE_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0x12BC0C60)
#define MOLEMOLE_GALGAME_MAINCITYCHATRANDOMCHOICENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x12BC0C50)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatRandomChoiceNode_TypeDefinitionIndex = 82301;
