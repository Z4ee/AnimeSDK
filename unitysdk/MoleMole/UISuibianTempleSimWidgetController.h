...
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_GET_FADEANIMATIONNAME_OFFSET UNITYSDK_OFFSET(0x1629C250)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_GET_FADEINTIME_OFFSET UNITYSDK_OFFSET(0x1629C270)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_GET_FADEOUTTIME_OFFSET UNITYSDK_OFFSET(0x1629C260)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_ONENTERDETAIL_OFFSET UNITYSDK_OFFSET(0x1629C8F0)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_ONEXITDETAIL_OFFSET UNITYSDK_OFFSET(0x1629C930)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_ONOPENMANAGEINFO_OFFSET UNITYSDK_OFFSET(0x1629C970)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_ONTEMPLEFADEINFINISHED_OFFSET UNITYSDK_OFFSET(0x1629C760)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_ONTEMPLEFADEOUTFINISHED_OFFSET UNITYSDK_OFFSET(0x1629C8B0)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_PLAYTEMPLEANIMATION_OFFSET UNITYSDK_OFFSET(0x1629C390)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_PLAYTEMPLEFADEINANIMATION_OFFSET UNITYSDK_OFFSET(0x1629C280)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_PLAYTEMPLEFADEOUTANIMATION_OFFSET UNITYSDK_OFFSET(0x1629C7A0)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1629C9C0)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER__PLAYTEMPLEFADEINANIMATION_B__11_0_OFFSET UNITYSDK_OFFSET(0x1629CA30)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER__PLAYTEMPLEFADEOUTANIMATION_B__13_0_OFFSET UNITYSDK_OFFSET(0x1629CA50)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleSimWidgetController_TypeDefinitionIndex = 71974;
