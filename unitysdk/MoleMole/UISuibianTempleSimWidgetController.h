...
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_GET_FADEANIMATIONNAME_OFFSET UNITYSDK_OFFSET(0x166A59F0)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_GET_FADEINTIME_OFFSET UNITYSDK_OFFSET(0x166A5A10)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_GET_FADEOUTTIME_OFFSET UNITYSDK_OFFSET(0x166A5A00)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_ONENTERDETAIL_OFFSET UNITYSDK_OFFSET(0x166A6090)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_ONEXITDETAIL_OFFSET UNITYSDK_OFFSET(0x166A60D0)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_ONOPENMANAGEINFO_OFFSET UNITYSDK_OFFSET(0x166A6110)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_ONTEMPLEFADEINFINISHED_OFFSET UNITYSDK_OFFSET(0x166A5F00)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_ONTEMPLEFADEOUTFINISHED_OFFSET UNITYSDK_OFFSET(0x166A6050)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_PLAYTEMPLEANIMATION_OFFSET UNITYSDK_OFFSET(0x166A5B30)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_PLAYTEMPLEFADEINANIMATION_OFFSET UNITYSDK_OFFSET(0x166A5A20)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_PLAYTEMPLEFADEOUTANIMATION_OFFSET UNITYSDK_OFFSET(0x166A5F40)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x166A6160)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER__PLAYTEMPLEFADEINANIMATION_B__11_0_OFFSET UNITYSDK_OFFSET(0x166A61D0)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER__PLAYTEMPLEFADEOUTANIMATION_B__13_0_OFFSET UNITYSDK_OFFSET(0x166A61F0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleSimWidgetController_TypeDefinitionIndex = 74278;

	class UISuibianTempleSimWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::System::String* _FadeAnimationName_k__BackingField; // 0x2C0
		::System::Single _FadeOutTime_k__BackingField; // 0x2C8
		::System::Single _FadeInTime_k__BackingField; // 0x2CC
		::Enum_3_F4F5EB014916907D templateAnimState; // 0x2D0
		::MoleMole::UISuibianTempleManageDetailPageController* DetailPage; // 0x2D8
