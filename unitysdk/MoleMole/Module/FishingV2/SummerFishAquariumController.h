...
#define MOLEMOLE_MODULE_FISHINGV2_SUMMERFISHAQUARIUMCONTROLLER_GETFISHTANKTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1418CD10)
#define MOLEMOLE_MODULE_FISHINGV2_SUMMERFISHAQUARIUMCONTROLLER_GETFISHTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1418C9B0)
#define MOLEMOLE_MODULE_FISHINGV2_SUMMERFISHAQUARIUMCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1418CE80)
#define MOLEMOLE_MODULE_FISHINGV2_SUMMERFISHAQUARIUMCONTROLLER_METHOD_5_2C1FE282BA2BA531_OFFSET UNITYSDK_OFFSET(0x1418DA50)
#define MOLEMOLE_MODULE_FISHINGV2_SUMMERFISHAQUARIUMCONTROLLER_METHOD_5_4434761CB9BE21F7_OFFSET UNITYSDK_OFFSET(0x1418D700)
#define MOLEMOLE_MODULE_FISHINGV2_SUMMERFISHAQUARIUMCONTROLLER_METHOD_5_7DBE4BF81A0D0238_OFFSET UNITYSDK_OFFSET(0x1418CEE0)
#define MOLEMOLE_MODULE_FISHINGV2_SUMMERFISHAQUARIUMCONTROLLER_METHOD_5_9E38127F40B34F1F_OFFSET UNITYSDK_OFFSET(0x1418BFD0)
#define MOLEMOLE_MODULE_FISHINGV2_SUMMERFISHAQUARIUMCONTROLLER_METHOD_5_AA08720895458700_OFFSET UNITYSDK_OFFSET(0x1418D980)
#define MOLEMOLE_MODULE_FISHINGV2_SUMMERFISHAQUARIUMCONTROLLER_METHOD_5_B43C848B078B3C34_OFFSET UNITYSDK_OFFSET(0x1418B5D0)
#define MOLEMOLE_MODULE_FISHINGV2_SUMMERFISHAQUARIUMCONTROLLER_METHOD_5_BE696DA51BEC84E8_OFFSET UNITYSDK_OFFSET(0x1418DA00)
#define MOLEMOLE_MODULE_FISHINGV2_SUMMERFISHAQUARIUMCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1418C510)
#define MOLEMOLE_MODULE_FISHINGV2_SUMMERFISHAQUARIUMCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1418B060)
#define MOLEMOLE_MODULE_FISHINGV2_SUMMERFISHAQUARIUMCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1418D6A0)

namespace MoleMole::Module::FishingV2
{
	inline static constexpr unsigned int SummerFishAquariumController_TypeDefinitionIndex = 66164;
