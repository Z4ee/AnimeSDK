...
#define MOLEMOLE_UIBABELTOWERMENUCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x181D2350)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerMenuContext_TypeDefinitionIndex = 51750;
