...
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS42_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16DEAD00)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS42_0__PERFORMANCESHRINK_B__2_OFFSET UNITYSDK_OFFSET(0x16DEAE70)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS42_0__PERFORMANCESHRINK_G__GETOFFSET_0_OFFSET UNITYSDK_OFFSET(0x16DEAD10)

namespace MoleMole
{
	inline static constexpr unsigned int UITapesGroup3DModelController___c__DisplayClass42_0_TypeDefinitionIndex = 72716;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::UITape3DModelController*>* tapes; // 0x20
		::MoleMole::UITapesGroup3DModelController* __4__this; // 0x28
		::System::Action* onDone; // 0x30
		::System::Int32 finishCount; // 0x38
		::System::Single duration; // 0x3C
		::UnityEngine::Vector3 centerTapePosition; // 0x40
		::System::Int32 totalNum; // 0x4C
