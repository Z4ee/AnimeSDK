...
#define MOLEMOLE_NEOGOLDENMECHASHOWOBJ_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x14A1AE30)
#define MOLEMOLE_NEOGOLDENMECHASHOWOBJ__CTOR_OFFSET UNITYSDK_OFFSET(0x14A1ADF0)
#define MOLEMOLE_NEOGOLDENMECHASHOWOBJ__ONPROCESS_B__2_0_OFFSET UNITYSDK_OFFSET(0x14A1B000)

namespace MoleMole
{
	inline static constexpr unsigned int NeoGoldenMechaShowObj_TypeDefinitionIndex = 65196;
