...
#define MOLEMOLE_NEOGOLDENMECHASHOWOBJ_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x1264E2B0)
#define MOLEMOLE_NEOGOLDENMECHASHOWOBJ__CTOR_OFFSET UNITYSDK_OFFSET(0x1264E270)
#define MOLEMOLE_NEOGOLDENMECHASHOWOBJ__ONPROCESS_B__2_0_OFFSET UNITYSDK_OFFSET(0x1264E480)

namespace MoleMole
{
	inline static constexpr unsigned int NeoGoldenMechaShowObj_TypeDefinitionIndex = 40284;
