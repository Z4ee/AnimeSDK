...
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER_CHANGETOGAMEPREFAB_OFFSET UNITYSDK_OFFSET(0x17D2FB90)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER_CREATEUIQUESTIONSANSWERSCREENWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x17D2FAE0)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER_GET_AUTOPROCESSCAMERA_OFFSET UNITYSDK_OFFSET(0x17D2FAD0)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER_GET_SCREENWIDGET_OFFSET UNITYSDK_OFFSET(0x17D2FAB0)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER_GET_SHOW3DSCENEENTITIES_OFFSET UNITYSDK_OFFSET(0x17D2FAC0)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x17D2FAA0)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17D30EF0)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17D30F80)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17D305F0)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17D30D70)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER_REVERTSCENEPREFAB_OFFSET UNITYSDK_OFFSET(0x17D30370)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER_SETCAMERAACTIVE_OFFSET UNITYSDK_OFFSET(0x17D31110)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x17D30DC0)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x17D31290)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17D31190)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17D312B0)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17D31340)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17D31350)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17D31360)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswer3D3DModelController_TypeDefinitionIndex = 88999;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIQuestionsAnswer3D3DModelController_TypeDefinitionIndex)->GetStaticField(0x11BD0);
		}
		static ::System::Int32* StaticGet_RTHeight()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIQuestionsAnswer3D3DModelController_TypeDefinitionIndex)->GetStaticField(0x11BD4);
		}
		// static const ::System::Int32 ScreenWidth = 0x8; // 0x0
		// static const ::System::Int32 ScreenHeight = 0x5; // 0x0
		::Class_2_489F32D82235B6BA* _view; // 0x360
