...
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_ADDNPCCOMPLETED_OFFSET UNITYSDK_OFFSET(0x16ECF3B0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_CREATEUIANIMATORENTITY_OFFSET UNITYSDK_OFFSET(0x16ECF210)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_DOSTOREEXITINTERACTPERFORM_OFFSET UNITYSDK_OFFSET(0x16ECFE90)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_GET_AUTOPROCESSCAMERA_OFFSET UNITYSDK_OFFSET(0x16ECD1C0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_GET_CAMERAOVERLAYINDEX_OFFSET UNITYSDK_OFFSET(0x16ECD1A0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_GET_CAMERARENDERTYPE_OFFSET UNITYSDK_OFFSET(0x16ECD1D0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_GET_SHOW3DSCENEENTITIES_OFFSET UNITYSDK_OFFSET(0x16ECD1B0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x16ECD190)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_INITMAINVIRTUALCAMERA_OFFSET UNITYSDK_OFFSET(0x16ECD9E0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_LOADUISTOREPAGENPCS_OFFSET UNITYSDK_OFFSET(0x16ECED50)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16ECE210)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16ECD1E0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16ECDB40)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_REFRESHUICAMERASETTINGINFO_OFFSET UNITYSDK_OFFSET(0x16ECDC80)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_REMOVEALLUIANIMATORENTITIES_OFFSET UNITYSDK_OFFSET(0x16ECE7C0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_SETALLNPCACTIVE_OFFSET UNITYSDK_OFFSET(0x16ECF7F0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_SETCAMERARENDERTYPE2BASE_OFFSET UNITYSDK_OFFSET(0x16ECDA20)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_SETCINEMACHINERECOMPOSERPAN_OFFSET UNITYSDK_OFFSET(0x16ED0190)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_SETMODELCAMERA_OFFSET UNITYSDK_OFFSET(0x16ECD430)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_SETNPCCONFIG_OFFSET UNITYSDK_OFFSET(0x16ECEC30)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_SETNPCTRIGGER_OFFSET UNITYSDK_OFFSET(0x16ECFBA0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_SYNCTRANSFORMPOS_OFFSET UNITYSDK_OFFSET(0x16ECEBF0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_TRYGETCAMERATRANSFORMINFO_OFFSET UNITYSDK_OFFSET(0x16ECF940)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16ED0510)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER__ONUIOPEN_B__23_0_OFFSET UNITYSDK_OFFSET(0x16ED0580)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER__SETCINEMACHINERECOMPOSERPAN_B__36_0_OFFSET UNITYSDK_OFFSET(0x16ED0760)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER__SETTOPAN_OFFSET UNITYSDK_OFFSET(0x16ED04A0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16ED0780)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16ED0790)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16ED07A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBase3DModelController_TypeDefinitionIndex = 64386;

	class UIBase3DModelController : public ::MoleMole::UIWindowController
	{
	public:
		::UnityEngine::Camera* ModelCamera; // 0x310
		::UnityEngine::Rendering::Universal::UniversalAdditionalCameraData* ModelCameraData; // 0x318
		::Cinemachine::CinemachineVirtualCamera* MainVirtualCamera; // 0x320
		::CinemachineRecomposer* _cinemachineRecomposer; // 0x328
		::System::Collections::Generic::List_1<::Foundation::Tuple_2<::System::String*, ::UnityEngine::GameObject*>>* _allLoadedNPCModels; // 0x330
		::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::UIStorePageNPCConfig*>* npcConfigDict; // 0x338
		::System::Collections::Generic::List_1<::System::UInt32>* _2DSound; // 0x340
		::System::Collections::Generic::List_1<::System::UInt32>* _cachedEntityIDs; // 0x348
		::System::String* _parentControllerName; // 0x350
