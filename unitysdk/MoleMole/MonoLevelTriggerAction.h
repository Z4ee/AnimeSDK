...
#define MOLEMOLE_MONOLEVELTRIGGERACTION_METHOD_5_235F2F68A3E18565_OFFSET UNITYSDK_OFFSET(0x1605CD60)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_METHOD_5_4BEB176192B034ED_OFFSET UNITYSDK_OFFSET(0x1605D320)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_METHOD_5_C24205EEE527C3A3_OFFSET UNITYSDK_OFFSET(0x1605CEC0)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0x1605CFA0)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_ONCOLLISIONEXIT_OFFSET UNITYSDK_OFFSET(0x1605D010)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1605D080)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1605CCF0)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x1605CE50)
#define MOLEMOLE_MONOLEVELTRIGGERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1605D0C0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoLevelTriggerAction_TypeDefinitionIndex = 60982;
