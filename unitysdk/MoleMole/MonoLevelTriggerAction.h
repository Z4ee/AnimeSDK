...
#define MOLEMOLE_MONOLEVELTRIGGERACTION_METHOD_5_235F2F68A3E18565_OFFSET UNITYSDK_OFFSET(0x12BD1E80)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_METHOD_5_4BEB176192B034ED_OFFSET UNITYSDK_OFFSET(0x12BD2440)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_METHOD_5_C24205EEE527C3A3_OFFSET UNITYSDK_OFFSET(0x12BD1FE0)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0x12BD20C0)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_ONCOLLISIONEXIT_OFFSET UNITYSDK_OFFSET(0x12BD2130)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x12BD21A0)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x12BD1E10)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x12BD1F70)
#define MOLEMOLE_MONOLEVELTRIGGERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x12BD21E0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoLevelTriggerAction_TypeDefinitionIndex = 51682;
	...
	public:
		...
		::System::Collections::Generic::HashSet_1<::UnityEngine::GameObject*>* Field_5_7; // 0x88
