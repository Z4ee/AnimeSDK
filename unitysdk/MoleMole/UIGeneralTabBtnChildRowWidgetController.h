...
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x185A9D30)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER_ONITEMRESELECT_OFFSET UNITYSDK_OFFSET(0x185AA320)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x185AA2D0)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x185A9E40)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x185A9DC0)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x185A9B20)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x185A9CC0)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER_REFRESHSELECTSTATE_OFFSET UNITYSDK_OFFSET(0x185AA220)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER_SETUPNOTIFICATIONBADGE_1_OFFSET UNITYSDK_OFFSET(0x185AA190)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER_SETUPNOTIFICATIONBADGE_OFFSET UNITYSDK_OFFSET(0x185AA370)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x185AA3D0)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x185AA3E0)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER___BASE_ONITEMRESELECT_OFFSET UNITYSDK_OFFSET(0x185AA470)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x185AA500)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x185AA590)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x185AA630)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x185AA6C0)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x185AA750)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralTabBtnChildRowWidgetController_TypeDefinitionIndex = 55092;
