...
#define MOLEMOLE_GRAPHICSETTINGPROFILEBASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x118C6030)
#define MOLEMOLE_GRAPHICSETTINGPROFILEBASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x118C60D0)
#define MOLEMOLE_GRAPHICSETTINGPROFILEBASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x118C61A0)
#define MOLEMOLE_GRAPHICSETTINGPROFILEBASE_GETPOWERCOST_OFFSET UNITYSDK_OFFSET(0x118CC780)
#define MOLEMOLE_GRAPHICSETTINGPROFILEBASE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x118CC770)
#define MOLEMOLE_GRAPHICSETTINGPROFILEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x118C5FD0)

namespace MoleMole
{
	inline static constexpr unsigned int GraphicSettingProfileBase_TypeDefinitionIndex = 48073;
