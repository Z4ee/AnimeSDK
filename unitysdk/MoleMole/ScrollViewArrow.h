...
#define MOLEMOLE_SCROLLVIEWARROW_AWAKE_OFFSET UNITYSDK_OFFSET(0x13EB38A0)
#define MOLEMOLE_SCROLLVIEWARROW_HIDEARROW_OFFSET UNITYSDK_OFFSET(0x13EB3B70)
#define MOLEMOLE_SCROLLVIEWARROW_METHOD_5_19CCC07C980409E4_1_OFFSET UNITYSDK_OFFSET(0x13EB45F0)
#define MOLEMOLE_SCROLLVIEWARROW_METHOD_5_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x13EB4570)
#define MOLEMOLE_SCROLLVIEWARROW_METHOD_5_37D3D9A3F3244B90_OFFSET UNITYSDK_OFFSET(0x13EB39E0)
#define MOLEMOLE_SCROLLVIEWARROW_METHOD_5_D0ACB47B641DF879_OFFSET UNITYSDK_OFFSET(0x13EB3BC0)
#define MOLEMOLE_SCROLLVIEWARROW_METHOD_5_F5DB273ED755EDAF_OFFSET UNITYSDK_OFFSET(0x13EB4180)
#define MOLEMOLE_SCROLLVIEWARROW_METHOD_5_F6EB917C5A67C7BA_OFFSET UNITYSDK_OFFSET(0x13EB3980)
#define MOLEMOLE_SCROLLVIEWARROW_SETARROWSTATE_OFFSET UNITYSDK_OFFSET(0x13EB38F0)
#define MOLEMOLE_SCROLLVIEWARROW_SETENDHINT_OFFSET UNITYSDK_OFFSET(0x13EB3EC0)
#define MOLEMOLE_SCROLLVIEWARROW_SETSTARTHINT_OFFSET UNITYSDK_OFFSET(0x13EB3C50)
#define MOLEMOLE_SCROLLVIEWARROW_SHOWARROW_OFFSET UNITYSDK_OFFSET(0x13EB3B20)
#define MOLEMOLE_SCROLLVIEWARROW__CTOR_OFFSET UNITYSDK_OFFSET(0x13EB4130)

namespace MoleMole
{
	inline static constexpr unsigned int ScrollViewArrow_TypeDefinitionIndex = 58908;
