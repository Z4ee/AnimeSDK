...
#define MOLEMOLE_UIBASECHATPLUSCONTROLLER_ENSUREPREVIOUSNODEFADEOUT_OFFSET UNITYSDK_OFFSET(0x17F578D0)
#define MOLEMOLE_UIBASECHATPLUSCONTROLLER_GET_LONGPRESSBTN_OFFSET UNITYSDK_OFFSET(0x17F57870)
#define MOLEMOLE_UIBASECHATPLUSCONTROLLER_PLAYLASTNODEFINISH_OFFSET UNITYSDK_OFFSET(0x17F57A50)
#define MOLEMOLE_UIBASECHATPLUSCONTROLLER_PLAYMASKFADEIN_OFFSET UNITYSDK_OFFSET(0x17F57D80)
#define MOLEMOLE_UIBASECHATPLUSCONTROLLER_PLAYMASKFADEOUT_OFFSET UNITYSDK_OFFSET(0x17F58060)
#define MOLEMOLE_UIBASECHATPLUSCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17F58350)
#define MOLEMOLE_UIBASECHATPLUSCONTROLLER__PLAYLASTNODEFINISH_B__11_0_OFFSET UNITYSDK_OFFSET(0x17F58360)
#define MOLEMOLE_UIBASECHATPLUSCONTROLLER__PLAYLASTNODEFINISH_B__11_1_OFFSET UNITYSDK_OFFSET(0x17F583A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBaseChatPlusController_TypeDefinitionIndex = 61574;
	...
	public:
		...
		::Class_2_60638234271CCDB8_17* _view; // 0x3C0
		::Foundation::Coroutine::CoroutineHandle _fadeCoroutineHandle; // 0x3C8
