...
#define MOLEMOLE_NONGACHAPERFORMSHOW_DIRECTSHOW_OFFSET UNITYSDK_OFFSET(0x19171D70)
#define MOLEMOLE_NONGACHAPERFORMSHOW_DOPROCESS_OFFSET UNITYSDK_OFFSET(0x19171DC0)
#define MOLEMOLE_NONGACHAPERFORMSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x19171CC0)
#define MOLEMOLE_NONGACHAPERFORMSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x19171D20)
#define MOLEMOLE_NONGACHAPERFORMSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x19171CD0)

namespace MoleMole
{
	inline static constexpr unsigned int NonGachaPerformShow_TypeDefinitionIndex = 68647;
