...
#define MOLEMOLE_NONGACHAPERFORMSHOW_DIRECTSHOW_OFFSET UNITYSDK_OFFSET(0x11906510)
#define MOLEMOLE_NONGACHAPERFORMSHOW_DOPROCESS_OFFSET UNITYSDK_OFFSET(0x11906560)
#define MOLEMOLE_NONGACHAPERFORMSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x11906460)
#define MOLEMOLE_NONGACHAPERFORMSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x119064C0)
#define MOLEMOLE_NONGACHAPERFORMSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x11906470)

namespace MoleMole
{
	inline static constexpr unsigned int NonGachaPerformShow_TypeDefinitionIndex = 59428;
