...
#define MOLEMOLE_MONOITEMICON_CLASS_3_89DE316B64AEDB12_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x191ACF90)
#define MOLEMOLE_MONOITEMICON_CLASS_3_89DE316B64AEDB12_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x191AD060)
#define MOLEMOLE_MONOITEMICON_CLASS_3_89DE316B64AEDB12_INVOKE_OFFSET UNITYSDK_OFFSET(0x191ACC20)
#define MOLEMOLE_MONOITEMICON_CLASS_3_89DE316B64AEDB12__CTOR_OFFSET UNITYSDK_OFFSET(0x191ACC00)

namespace MoleMole
{
	inline static constexpr unsigned int MonoItemIcon_Class_3_89DE316B64AEDB12_TypeDefinitionIndex = 82001;
