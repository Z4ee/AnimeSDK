...
#define MOLEMOLE_MAINCITYQUICKFUNC1GAMEPADBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x16D4F490)
#define MOLEMOLE_MAINCITYQUICKFUNC1GAMEPADBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x16D4F4A0)
#define MOLEMOLE_MAINCITYQUICKFUNC1GAMEPADBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x16D4F4B0)

namespace MoleMole
{
	inline static constexpr unsigned int MainCityQuickFunc1GamepadBindingSettingEntry_TypeDefinitionIndex = 69971;
