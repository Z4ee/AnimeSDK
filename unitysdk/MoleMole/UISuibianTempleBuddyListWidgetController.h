...
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLISTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x119EEBD0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLISTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x119EEC60)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLISTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x119EEB00)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLISTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x119EEB60)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLISTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x119EECE0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLISTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x119EED40)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLISTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x119EEDD0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLISTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x119EEE60)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLISTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x119EEEF0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleBuddyListWidgetController_TypeDefinitionIndex = 81491;
