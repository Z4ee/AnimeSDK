...
#define MOLEMOLE_UIABYSSBUFFROWWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x197AE370)
#define MOLEMOLE_UIABYSSBUFFROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x197AE0A0)
#define MOLEMOLE_UIABYSSBUFFROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x197AE660)
#define MOLEMOLE_UIABYSSBUFFROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x197AE1B0)
#define MOLEMOLE_UIABYSSBUFFROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x197AE130)
#define MOLEMOLE_UIABYSSBUFFROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x197ADE40)
#define MOLEMOLE_UIABYSSBUFFROWWIDGETCONTROLLER_SETCONSOLESELECTEF_OFFSET UNITYSDK_OFFSET(0x197AE5F0)
#define MOLEMOLE_UIABYSSBUFFROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x197AE8E0)
#define MOLEMOLE_UIABYSSBUFFROWWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x197AE8F0)
#define MOLEMOLE_UIABYSSBUFFROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x197AE900)
#define MOLEMOLE_UIABYSSBUFFROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x197AE990)
#define MOLEMOLE_UIABYSSBUFFROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x197AEA20)
#define MOLEMOLE_UIABYSSBUFFROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x197AEAC0)
#define MOLEMOLE_UIABYSSBUFFROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x197AEB50)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssBuffRowWidgetController_TypeDefinitionIndex = 44459;
	...
	public:
		...
		::Class_2_208CC9941471731A_1048* _config; // 0x308
