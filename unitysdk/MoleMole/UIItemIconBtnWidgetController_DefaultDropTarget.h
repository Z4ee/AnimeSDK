...
#define MOLEMOLE_UIITEMICONBTNWIDGETCONTROLLER_DEFAULTDROPTARGET_CANACCEPTDROP_OFFSET UNITYSDK_OFFSET(0x16929EE0)
#define MOLEMOLE_UIITEMICONBTNWIDGETCONTROLLER_DEFAULTDROPTARGET_ONDROP_OFFSET UNITYSDK_OFFSET(0x16929F40)
#define MOLEMOLE_UIITEMICONBTNWIDGETCONTROLLER_DEFAULTDROPTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16929ED0)

namespace MoleMole
{
	inline static constexpr unsigned int UIItemIconBtnWidgetController_DefaultDropTarget_TypeDefinitionIndex = 79871;
