...
#define MOLEMOLE_UIITEMICONBTNWIDGETCONTROLLER_DEFAULTDROPTARGET_CANACCEPTDROP_OFFSET UNITYSDK_OFFSET(0x189B1370)
#define MOLEMOLE_UIITEMICONBTNWIDGETCONTROLLER_DEFAULTDROPTARGET_ONDROP_OFFSET UNITYSDK_OFFSET(0x189B13D0)
#define MOLEMOLE_UIITEMICONBTNWIDGETCONTROLLER_DEFAULTDROPTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x189B1360)

namespace MoleMole
{
	inline static constexpr unsigned int UIItemIconBtnWidgetController_DefaultDropTarget_TypeDefinitionIndex = 53266;
