...
#define MOLEMOLE_UIHUDTWEENBARCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x188B1DE0)
#define MOLEMOLE_UIHUDTWEENBARCONTROLLER_REFRESHBARVIEW_OFFSET UNITYSDK_OFFSET(0x188B2220)
#define MOLEMOLE_UIHUDTWEENBARCONTROLLER_SETCURRENTVALUETOEND_OFFSET UNITYSDK_OFFSET(0x188B1E30)
#define MOLEMOLE_UIHUDTWEENBARCONTROLLER_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x188B1FB0)
#define MOLEMOLE_UIHUDTWEENBARCONTROLLER_SETVALUEIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x188B2010)
#define MOLEMOLE_UIHUDTWEENBARCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x188B25A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHudTweenBarController_TypeDefinitionIndex = 65035;
