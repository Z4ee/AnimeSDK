...
#define MOLEMOLE_UIHUDTWEENBARCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x163FD0E0)
#define MOLEMOLE_UIHUDTWEENBARCONTROLLER_REFRESHBARVIEW_OFFSET UNITYSDK_OFFSET(0x163FD520)
#define MOLEMOLE_UIHUDTWEENBARCONTROLLER_SETCURRENTVALUETOEND_OFFSET UNITYSDK_OFFSET(0x163FD130)
#define MOLEMOLE_UIHUDTWEENBARCONTROLLER_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x163FD2B0)
#define MOLEMOLE_UIHUDTWEENBARCONTROLLER_SETVALUEIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x163FD310)
#define MOLEMOLE_UIHUDTWEENBARCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x163FD8A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHudTweenBarController_TypeDefinitionIndex = 40126;
