...
#define MOLEMOLE_MONOTWEENANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x14A15760)

namespace MoleMole
{
	inline static constexpr unsigned int MonoTweenAnimation_TypeDefinitionIndex = 83026;
