...
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1681BC40)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONEQUIPSLOTCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x1681B870)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONFOCUSSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x1681B080)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x1681B1A0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x1681B2F0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONROLEICONBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x1681B6F0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONROWCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x1681BB40)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15179B80)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1681AB20)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1681BBD0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_PLAYCHANGEEQUIPANI_OFFSET UNITYSDK_OFFSET(0x15178EF0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_REFRESHDRESSSTATE_OFFSET UNITYSDK_OFFSET(0x1681BF70)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_REFRESHEQUIPVIEW_OFFSET UNITYSDK_OFFSET(0x151792A0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_REFRESHSELECTEDSTATE_OFFSET UNITYSDK_OFFSET(0x1681B4D0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_SETAVATARDATA_OFFSET UNITYSDK_OFFSET(0x1681BE00)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_SETROBOTDATA_OFFSET UNITYSDK_OFFSET(0x1681BCD0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_SETROLEICONSTATE_OFFSET UNITYSDK_OFFSET(0x1681C200)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_SETSELECTALPHA_OFFSET UNITYSDK_OFFSET(0x1681B0D0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_SETSELECTSTATE_OFFSET UNITYSDK_OFFSET(0x1681B970)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_SETSLOTCLICKACTION_OFFSET UNITYSDK_OFFSET(0x1681B920)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_SETUISTATE_OFFSET UNITYSDK_OFFSET(0x1681C1A0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15179C90)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15179D70)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x15179E00)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x15179E90)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15179F20)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15179FB0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1517A040)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopEquipGroupWidgetController_TypeDefinitionIndex = 45220;

	class UICoopEquipGroupWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		// static const ::System::Int32 _equipSlotID = 0x1; // 0x0
		::Class_2_E55F60BF63BB02E0* _view; // 0x2B8
		::Class_2_C04F87C132BA9A06* _coopModel; // 0x2C0
		::System::Collections::Generic::List_1<::MoleMole::UICoopEquipRowWidgetController*>* _rowWidgets; // 0x2C8
		::System::Action_1<::System::Int32>* _slotCkickAcction; // 0x2D0
		::System::Int32 _selectedSlotID; // 0x2D8
		::System::Int32 _avatarID; // 0x2DC
		::System::Int32 _robotID; // 0x2E0
		::MoleMole::UIGeneralIconCardRarityWidgetController* _rarityWidget; // 0x2E8
		::System::Boolean _isAvatarType; // 0x2F0
		::Foundation::Coroutine::CoroutineHandle _fadeCoroutineHandle; // 0x2F4
		::System::Int32 _lastEquipID; // 0x2F8
