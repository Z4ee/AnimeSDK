...
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER___C__DISPLAYCLASS20_0___STARTEXPPROGRESS_G____FILL_EXP_0_D_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x18453AB0)
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER___C__DISPLAYCLASS20_0___STARTEXPPROGRESS_G____FILL_EXP_0_D_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x184540F0)
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER___C__DISPLAYCLASS20_0___STARTEXPPROGRESS_G____FILL_EXP_0_D_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18454150)
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER___C__DISPLAYCLASS20_0___STARTEXPPROGRESS_G____FILL_EXP_0_D_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x18454100)
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER___C__DISPLAYCLASS20_0___STARTEXPPROGRESS_G____FILL_EXP_0_D_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18453AA0)
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER___C__DISPLAYCLASS20_0___STARTEXPPROGRESS_G____FILL_EXP_0_D__CTOR_OFFSET UNITYSDK_OFFSET(0x18453A90)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralExpProgressWidgetController___c__DisplayClass20_0___StartExpProgress_g____Fill_Exp_0_d_TypeDefinitionIndex = 57323;
