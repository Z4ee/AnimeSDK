...
#define MOLEMOLE_UIBABELTOWERREWARDCOMPROWWIDGETCONTROLLER_ONTAKEREWARDHANDLE_OFFSET UNITYSDK_OFFSET(0x175F98B0)
#define MOLEMOLE_UIBABELTOWERREWARDCOMPROWWIDGETCONTROLLER_REFRESHBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x175F8760)
#define MOLEMOLE_UIBABELTOWERREWARDCOMPROWWIDGETCONTROLLER_REFRESHPROGRESS_OFFSET UNITYSDK_OFFSET(0x175F8B00)
#define MOLEMOLE_UIBABELTOWERREWARDCOMPROWWIDGETCONTROLLER_REFRESHREWARDINFO_OFFSET UNITYSDK_OFFSET(0x175F8590)
#define MOLEMOLE_UIBABELTOWERREWARDCOMPROWWIDGETCONTROLLER_REFRESHROWSTATE_OFFSET UNITYSDK_OFFSET(0x175F8320)
#define MOLEMOLE_UIBABELTOWERREWARDCOMPROWWIDGETCONTROLLER_SENDREWARDREQ_OFFSET UNITYSDK_OFFSET(0x175F9720)
#define MOLEMOLE_UIBABELTOWERREWARDCOMPROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x175F99C0)
#define MOLEMOLE_UIBABELTOWERREWARDCOMPROWWIDGETCONTROLLER___BASE_REFRESHROWSTATE_OFFSET UNITYSDK_OFFSET(0x175F99D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabelTowerRewardCompRowWidgetController_TypeDefinitionIndex = 57570;
