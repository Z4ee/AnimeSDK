...
#define MOLEMOLE_ABYSSS2_GENROUTEMAPCONFIG_GETROUTEMAPTEMPLATE_OFFSET UNITYSDK_OFFSET(0x12AF4360)
#define MOLEMOLE_ABYSSS2_GENROUTEMAPCONFIG_ONCHANGED_OFFSET UNITYSDK_OFFSET(0x12AF4C50)
#define MOLEMOLE_ABYSSS2_GENROUTEMAPCONFIG_REFRESHROUTECOUNT_OFFSET UNITYSDK_OFFSET(0x12AF4230)
#define MOLEMOLE_ABYSSS2_GENROUTEMAPCONFIG_RUNTIMERELOADBYCONFIG_OFFSET UNITYSDK_OFFSET(0x12AF4480)
#define MOLEMOLE_ABYSSS2_GENROUTEMAPCONFIG_VALIDATE_OFFSET UNITYSDK_OFFSET(0x12AF4190)
#define MOLEMOLE_ABYSSS2_GENROUTEMAPCONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0x12AF4CD0)
#define MOLEMOLE_ABYSSS2_GENROUTEMAPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x12AF4170)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_GenRouteMapConfig_TypeDefinitionIndex = 85688;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AbyssS2_GenRouteMapConfig_TypeDefinitionIndex)->GetStaticField(0x11FB0);
		}
		...
		::Class_2_208CC9941471731A_265* GetRouteMapTemplate()
		{
			return ((::Class_2_208CC9941471731A_265*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_ABYSSS2_GENROUTEMAPCONFIG_GETROUTEMAPTEMPLATE_OFFSET))(this);
		}
