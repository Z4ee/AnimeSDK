...
#define MOLEMOLE_ABYSSS2_GENROUTEMAPCONFIG_GETROUTEMAPTEMPLATE_OFFSET UNITYSDK_OFFSET(0x12A11C90)
#define MOLEMOLE_ABYSSS2_GENROUTEMAPCONFIG_ONCHANGED_OFFSET UNITYSDK_OFFSET(0x12A12590)
#define MOLEMOLE_ABYSSS2_GENROUTEMAPCONFIG_REFRESHROUTECOUNT_OFFSET UNITYSDK_OFFSET(0x12A11B60)
#define MOLEMOLE_ABYSSS2_GENROUTEMAPCONFIG_RUNTIMERELOADBYCONFIG_OFFSET UNITYSDK_OFFSET(0x12A11DB0)
#define MOLEMOLE_ABYSSS2_GENROUTEMAPCONFIG_VALIDATE_OFFSET UNITYSDK_OFFSET(0x12A11AC0)
#define MOLEMOLE_ABYSSS2_GENROUTEMAPCONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0x12A12610)
#define MOLEMOLE_ABYSSS2_GENROUTEMAPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x12A11AA0)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_GenRouteMapConfig_TypeDefinitionIndex = 87627;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AbyssS2_GenRouteMapConfig_TypeDefinitionIndex)->GetStaticField(0x11090);
		}
		...
		::Class_2_208CC9941471731A_47* GetRouteMapTemplate()
		{
			return ((::Class_2_208CC9941471731A_47*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_ABYSSS2_GENROUTEMAPCONFIG_GETROUTEMAPTEMPLATE_OFFSET))(this);
		}
