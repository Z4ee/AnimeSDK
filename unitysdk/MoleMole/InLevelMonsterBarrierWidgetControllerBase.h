...
#define MOLEMOLE_INLEVELMONSTERBARRIERWIDGETCONTROLLERBASE_ATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x1908B040)
#define MOLEMOLE_INLEVELMONSTERBARRIERWIDGETCONTROLLERBASE_GETNORMALIZEDHPPERCENT_OFFSET UNITYSDK_OFFSET(0x1908AFA0)
#define MOLEMOLE_INLEVELMONSTERBARRIERWIDGETCONTROLLERBASE_GET_ISHPTWEENING_OFFSET UNITYSDK_OFFSET(0x19089630)
#define MOLEMOLE_INLEVELMONSTERBARRIERWIDGETCONTROLLERBASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19089690)
#define MOLEMOLE_INLEVELMONSTERBARRIERWIDGETCONTROLLERBASE_STARTHPTWEEN_OFFSET UNITYSDK_OFFSET(0x1908A9B0)
#define MOLEMOLE_INLEVELMONSTERBARRIERWIDGETCONTROLLERBASE_UPDATEHPSHIELD_OFFSET UNITYSDK_OFFSET(0x19089730)
#define MOLEMOLE_INLEVELMONSTERBARRIERWIDGETCONTROLLERBASE_UPDATEHPTWEENTARGET_OFFSET UNITYSDK_OFFSET(0x1908A390)
#define MOLEMOLE_INLEVELMONSTERBARRIERWIDGETCONTROLLERBASE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1908A340)
#define MOLEMOLE_INLEVELMONSTERBARRIERWIDGETCONTROLLERBASE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1908B270)
#define MOLEMOLE_INLEVELMONSTERBARRIERWIDGETCONTROLLERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1908B210)
#define MOLEMOLE_INLEVELMONSTERBARRIERWIDGETCONTROLLERBASE__STARTHPTWEEN_B__34_0_OFFSET UNITYSDK_OFFSET(0x1908B6E0)
#define MOLEMOLE_INLEVELMONSTERBARRIERWIDGETCONTROLLERBASE__STARTHPTWEEN_B__34_1_OFFSET UNITYSDK_OFFSET(0x1908B6F0)
#define MOLEMOLE_INLEVELMONSTERBARRIERWIDGETCONTROLLERBASE__UPDATEHPSHIELD_B__33_1_OFFSET UNITYSDK_OFFSET(0x1908B2C0)
#define MOLEMOLE_INLEVELMONSTERBARRIERWIDGETCONTROLLERBASE__UPDATEHPSHIELD_B__33_2_OFFSET UNITYSDK_OFFSET(0x1908B2D0)
#define MOLEMOLE_INLEVELMONSTERBARRIERWIDGETCONTROLLERBASE__UPDATEHPSHIELD_B__33_4_OFFSET UNITYSDK_OFFSET(0x1908B4D0)
#define MOLEMOLE_INLEVELMONSTERBARRIERWIDGETCONTROLLERBASE__UPDATEHPSHIELD_B__33_5_OFFSET UNITYSDK_OFFSET(0x1908B4E0)
#define MOLEMOLE_INLEVELMONSTERBARRIERWIDGETCONTROLLERBASE__UPDATEHPTWEENTARGET_B__35_0_OFFSET UNITYSDK_OFFSET(0x1908B7A0)
#define MOLEMOLE_INLEVELMONSTERBARRIERWIDGETCONTROLLERBASE__UPDATEHPTWEENTARGET_B__35_1_OFFSET UNITYSDK_OFFSET(0x1908B7B0)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelMonsterBarrierWidgetControllerBase_TypeDefinitionIndex = 67108;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(InLevelMonsterBarrierWidgetControllerBase_TypeDefinitionIndex)->GetStaticField(0x11330);
		}
		static ::System::Int32* StaticGet_WaveHeightParamID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(InLevelMonsterBarrierWidgetControllerBase_TypeDefinitionIndex)->GetStaticField(0x11334);
		}
		...
		::Enum_3_7609C87F8335DE37_1 _monsterHpShieldShowType; // 0x2C8
