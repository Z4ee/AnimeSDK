...
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER_ONCLICKLOCKED_OFFSET UNITYSDK_OFFSET(0x17090D30)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER_ONCLICKRECEIVE_OFFSET UNITYSDK_OFFSET(0x17090B00)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1708F800)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0x1708F910)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1708F990)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1708F890)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1708F720)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER_REFRESHREDDOT_OFFSET UNITYSDK_OFFSET(0x17090A80)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER_REFRESHTASKPROGRESS_OFFSET UNITYSDK_OFFSET(0x170906D0)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER_REFRESHTASKSTATUS_OFFSET UNITYSDK_OFFSET(0x1708FF80)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER_REFRESHTASKTYPE_OFFSET UNITYSDK_OFFSET(0x1708FBC0)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER_SETREWARD_OFFSET UNITYSDK_OFFSET(0x170907C0)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17090DE0)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17090DF0)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER___BASE_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0x17090E80)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17090F10)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17090FB0)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17091040)

namespace MoleMole
{
	inline static constexpr unsigned int UIBPTaskRowWidgetController_TypeDefinitionIndex = 46077;

	class UIBPTaskRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_59* _view; // 0x2F0
		::Class_3_4666E61F66433B1E_2* refBPTask; // 0x2F8
