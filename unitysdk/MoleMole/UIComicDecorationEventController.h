...
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_GETHIDEINDEX_OFFSET UNITYSDK_OFFSET(0x17A5A5D0)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_GET_HIDEWHENSPLITSCREEN_OFFSET UNITYSDK_OFFSET(0x17A5A330)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_GET_MOVEWHENSPLITSCREEN_OFFSET UNITYSDK_OFFSET(0x17A5A350)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0x17A5A410)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_JUMPTOFINALSTATE_OFFSET UNITYSDK_OFFSET(0x17A5A890)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_JUMPTOFINAL_OFFSET UNITYSDK_OFFSET(0x17A5A8E0)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_MOLEMOLE_COMIC_ICOMICEVENTMOVEABLE_ISMOVING_OFFSET UNITYSDK_OFFSET(0x17A5A920)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17A5A3C0)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17A5A370)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x17A5A4E0)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_SETHIDEINDEX_OFFSET UNITYSDK_OFFSET(0x17A5A560)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_SETMOVEPARAMS_OFFSET UNITYSDK_OFFSET(0x17A5A7D0)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_SET_HIDEWHENSPLITSCREEN_OFFSET UNITYSDK_OFFSET(0x17A5A340)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_SET_MOVEWHENSPLITSCREEN_OFFSET UNITYSDK_OFFSET(0x17A5A360)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_SIMULATEMOVEPROCESS_OFFSET UNITYSDK_OFFSET(0x17A5A6D0)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_UPDATEMOVE_OFFSET UNITYSDK_OFFSET(0x17A5A620)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17A5A9A0)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER___BASE_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0x17A5AA00)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17A5AA10)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17A5AA20)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER___BASE_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x17A5AA30)

namespace MoleMole
{
	inline static constexpr unsigned int UIComicDecorationEventController_TypeDefinitionIndex = 58670;
