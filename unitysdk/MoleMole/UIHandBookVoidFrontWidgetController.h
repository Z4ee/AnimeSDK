...
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18AFB5F0)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER_ONENTRANCECHANGE_OFFSET UNITYSDK_OFFSET(0x18AFB7D0)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18AFB680)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18AFABE0)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18AFB050)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x18AFB130)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER_SHOWDETAILPOPUP_OFFSET UNITYSDK_OFFSET(0x18AFB700)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18AFB820)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER__ONUIINIT_B__2_1_OFFSET UNITYSDK_OFFSET(0x18AFB880)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18AFB900)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18AFB990)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18AFBA20)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18AFBAB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookVoidFrontWidgetController_TypeDefinitionIndex = 79475;
