...
#define MOLEMOLE_MAINCITYQUICKFUNC1KEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x14188760)
#define MOLEMOLE_MAINCITYQUICKFUNC1KEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x14188770)
#define MOLEMOLE_MAINCITYQUICKFUNC1KEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x14188780)

namespace MoleMole
{
	inline static constexpr unsigned int MainCityQuickFunc1KeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 59749;
