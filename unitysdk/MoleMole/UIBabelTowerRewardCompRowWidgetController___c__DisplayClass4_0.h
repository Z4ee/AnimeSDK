...
#define MOLEMOLE_UIBABELTOWERREWARDCOMPROWWIDGETCONTROLLER___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0x175A3C40)
#define MOLEMOLE_UIBABELTOWERREWARDCOMPROWWIDGETCONTROLLER___C__DISPLAYCLASS4_0__REFRESHREWARDINFO_B__0_OFFSET UNITYSDK_OFFSET(0x175A3C50)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabelTowerRewardCompRowWidgetController___c__DisplayClass4_0_TypeDefinitionIndex = 57571;
