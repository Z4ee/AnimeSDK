...
#define MOLEMOLE_UIBABELTOWERREWARDCOMPROWWIDGETCONTROLLER___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19353CA0)
#define MOLEMOLE_UIBABELTOWERREWARDCOMPROWWIDGETCONTROLLER___C__DISPLAYCLASS4_0__REFRESHREWARDINFO_B__0_OFFSET UNITYSDK_OFFSET(0x19353CB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabelTowerRewardCompRowWidgetController___c__DisplayClass4_0_TypeDefinitionIndex = 88730;
