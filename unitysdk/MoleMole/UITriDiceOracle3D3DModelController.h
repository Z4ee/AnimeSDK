...
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_GET_CAMERARENDERTYPE_OFFSET UNITYSDK_OFFSET(0x1275D0F0)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_GET_CAMERA_OFFSET UNITYSDK_OFFSET(0x1275D140)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_GET_CONTROLROOT_OFFSET UNITYSDK_OFFSET(0x1275D120)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_GET_MODELROOT_OFFSET UNITYSDK_OFFSET(0x1275D100)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_GET_SHOW3DSCENEENTITIES_OFFSET UNITYSDK_OFFSET(0x1275D160)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1275D0E0)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_INITCAMERA_OFFSET UNITYSDK_OFFSET(0x1275DF20)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_INITMODELTRANS_OFFSET UNITYSDK_OFFSET(0x1275D650)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1275D8E0)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1275D970)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1275D170)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1275D890)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_SHOWCAMERA_OFFSET UNITYSDK_OFFSET(0x1275E570)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1275E670)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1275E600)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1275E680)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1275E710)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1275E720)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1275E730)

namespace MoleMole
{
	inline static constexpr unsigned int UITriDiceOracle3D3DModelController_TypeDefinitionIndex = 46000;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UITriDiceOracle3D3DModelController_TypeDefinitionIndex)->GetStaticField(0x11C00);
		}
		...
		::Class_2_954ED73DC0C031B6* _view; // 0x358
		::UnityEngine::NAPRenderPipeline0::RTHandle* _rt; // 0x360
		::UnityEngine::GameObject* ModelGameObject; // 0x368
		::MoleMole::Battle::Entity* ModelEntity; // 0x370
		::UnityEngine::GameObject* DiceGameObject; // 0x378
		::MoleMole::Battle::Entity* DiceEntity; // 0x380
