...
#define MOLEMOLE_BLOOMPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x16C22CC0)
#define MOLEMOLE_BLOOMPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x16C22E00)
#define MOLEMOLE_BLOOMPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x16C22BE0)
#define MOLEMOLE_BLOOMPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x16C22D80)
#define MOLEMOLE_BLOOMPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x16C22BD0)
#define MOLEMOLE_BLOOMPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x16C22F20)
#define MOLEMOLE_BLOOMPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x16C22FB0)
#define MOLEMOLE_BLOOMPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x16C23040)
#define MOLEMOLE_BLOOMPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x16C230D0)

namespace MoleMole
{
	inline static constexpr unsigned int BloomProfile_TypeDefinitionIndex = 60583;
