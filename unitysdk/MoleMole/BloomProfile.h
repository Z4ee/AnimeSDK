...
#define MOLEMOLE_BLOOMPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x13988210)
#define MOLEMOLE_BLOOMPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x13988350)
#define MOLEMOLE_BLOOMPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x13988130)
#define MOLEMOLE_BLOOMPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x139882D0)
#define MOLEMOLE_BLOOMPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x13988120)
#define MOLEMOLE_BLOOMPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x13988470)
#define MOLEMOLE_BLOOMPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x13988500)
#define MOLEMOLE_BLOOMPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x13988590)
#define MOLEMOLE_BLOOMPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x13988620)

namespace MoleMole
{
	inline static constexpr unsigned int BloomProfile_TypeDefinitionIndex = 40944;
