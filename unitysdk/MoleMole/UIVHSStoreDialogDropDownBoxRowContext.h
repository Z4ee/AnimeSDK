...
#define MOLEMOLE_UIVHSSTOREDIALOGDROPDOWNBOXROWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x126A82C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSStoreDialogDropDownBoxRowContext_TypeDefinitionIndex = 48893;
	...
	public:
		...
		::System::Int32 typeSelectHeight; // 0x48
		::System::Int32 typeSelectWidth; // 0x4C
		::System::Int32 typeSelectOffsetY; // 0x50
		::System::Int32 typeSelectOffsetX; // 0x54
