...
#define MOLEMOLE_COURSEREWARDPOPWINDOWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x17D39140)

namespace MoleMole
{
	inline static constexpr unsigned int CourseRewardPopWindowContext_TypeDefinitionIndex = 53668;
