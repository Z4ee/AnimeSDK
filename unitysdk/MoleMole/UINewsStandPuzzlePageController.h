...
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER_CLEAN_OFFSET UNITYSDK_OFFSET(0x13FE1220)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER_DOBACK_OFFSET UNITYSDK_OFFSET(0x13FE1090)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER_GETPERFORMID_OFFSET UNITYSDK_OFFSET(0x13FE09F0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER_GET_PHASE_OFFSET UNITYSDK_OFFSET(0x13FDFEA0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x13FDFE90)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER_INITACTIVITY_OFFSET UNITYSDK_OFFSET(0x13FE0200)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER_INITGAMES_OFFSET UNITYSDK_OFFSET(0x13FE1590)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER_INITLEVELDATA_OFFSET UNITYSDK_OFFSET(0x13FE1870)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER_INITLEVELS_OFFSET UNITYSDK_OFFSET(0x13FE1490)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x13FDFF70)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER_ISCHAPTERCOMPLETED_OFFSET UNITYSDK_OFFSET(0x13FE0F80)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER_ISCHAPTERUNANIMATED_OFFSET UNITYSDK_OFFSET(0x13FE0EC0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER_ISCHAPTERUNFINISHED_OFFSET UNITYSDK_OFFSET(0x13FDFB70)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER_ONACTIVITYCHANGEINFO_OFFSET UNITYSDK_OFFSET(0x13FE23D0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER_ONCLICKSTAGE_OFFSET UNITYSDK_OFFSET(0x13FDFAE0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x13FDFFE0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER_ONSTAGEEND_OFFSET UNITYSDK_OFFSET(0x13FE0E40)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x13FE0610)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x13FE0D30)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x13FE00C0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x13FE0070)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x13FE0DA0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER_SET_PHASE_OFFSET UNITYSDK_OFFSET(0x13FDFEB0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER_UPDATECHAPTERSTATUS_OFFSET UNITYSDK_OFFSET(0x13FE0FE0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER__CLEAN_B__27_0_OFFSET UNITYSDK_OFFSET(0x13FE25F0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x13FE2480)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER__DOBACK_B__26_0_OFFSET UNITYSDK_OFFSET(0x13FE2550)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER__DOBACK_B__26_1_OFFSET UNITYSDK_OFFSET(0x13FE2580)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER__INITGAMES_B__30_0_OFFSET UNITYSDK_OFFSET(0x13FE2620)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER__INITLEVELDATA_B__32_1_OFFSET UNITYSDK_OFFSET(0x13FE2650)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x13FE2680)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x13FE2710)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x13FE2720)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x13FE2730)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x13FE2740)
#define MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x13FE2750)

namespace MoleMole
{
	inline static constexpr unsigned int UINewsStandPuzzlePageController_TypeDefinitionIndex = 48669;

	class UINewsStandPuzzlePageController : public ::MoleMole::UIMainCityStorePageController
	{
	public:
		::Class_2_BA30EE5D91DB6889* _view; // 0x320
		::MoleMole::UINewsStandPuzzleGameWidgetController* gameWidget; // 0x328
		::MoleMole::UIActivityCompWeekRewardBtnWidgetController* _rewardBtn; // 0x330
		::MoleMole::UINewsStandPuzzlePageController_EPuzzlePhase _phase; // 0x338
		::System::Int32 curStage; // 0x33C
		::System::Collections::Generic::HashSet_1<::System::Int32>* completedChapters; // 0x340
		::System::Collections::Generic::HashSet_1<::System::Int32>* unanimatedChapters; // 0x348
		::System::Collections::Generic::List_1<::Class_1_5002A338EA6818A8*>* allStages; // 0x350
		...
		::System::Void OnClickStage(::Class_1_5002A338EA6818A8* data)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_5002A338EA6818A8*))((::PBYTE)hIl2Cpp + MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER_ONCLICKSTAGE_OFFSET))(this, data);
		}
		...
		::System::Boolean _DoBack_b__26_0(::Class_2_208CC9941471731A_1008* c)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_2_208CC9941471731A_1008*))((::PBYTE)hIl2Cpp + MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER__DOBACK_B__26_0_OFFSET))(this, c);
		}
		...
		::System::Boolean _InitLevelData_b__32_1(::Class_2_208CC9941471731A_1008* c)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_2_208CC9941471731A_1008*))((::PBYTE)hIl2Cpp + MOLEMOLE_UINEWSSTANDPUZZLEPAGECONTROLLER__INITLEVELDATA_B__32_1_OFFSET))(this, c);
		}
