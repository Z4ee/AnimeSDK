...
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER_BINDNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x13789690)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER_BINDTOBASELEVEL_OFFSET UNITYSDK_OFFSET(0x13789700)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER_BINDVIEWCALLBACK_OFFSET UNITYSDK_OFFSET(0x1378A2C0)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x137890F0)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x13789580)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x13789610)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x13789190)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x13789510)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER_REFRESHLEVEL_1_OFFSET UNITYSDK_OFFSET(0x1378A100)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER_REFRESHLEVEL_OFFSET UNITYSDK_OFFSET(0x137899A0)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1378A380)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x1378A530)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1378A5C0)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1378A650)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1378A6E0)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1378A770)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianLevelWidgetController_TypeDefinitionIndex = 43999;

	class UISuibianLevelWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_80* _view; // 0x2B8
		::System::Collections::Generic::List_1<::UnityEngine::UI::Extension::UILocalizationText*>* textList; // 0x2C0
		::System::Collections::Generic::List_1<::UnityEngine::RectTransform*>* effectList; // 0x2C8
		::System::Collections::Generic::List_1<::UnityEngine::RectTransform*>* effectBGList; // 0x2D0
