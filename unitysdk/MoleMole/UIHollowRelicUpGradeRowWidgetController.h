...
#define MOLEMOLE_UIHOLLOWRELICUPGRADEROWWIDGETCONTROLLER_CREATEITEMWIDGET_OFFSET UNITYSDK_OFFSET(0x17329780)
#define MOLEMOLE_UIHOLLOWRELICUPGRADEROWWIDGETCONTROLLER_REFRESHITEMVIEW_OFFSET UNITYSDK_OFFSET(0x173298A0)
#define MOLEMOLE_UIHOLLOWRELICUPGRADEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17329950)
#define MOLEMOLE_UIHOLLOWRELICUPGRADEROWWIDGETCONTROLLER___BASE_CREATEITEMWIDGET_OFFSET UNITYSDK_OFFSET(0x17329960)
#define MOLEMOLE_UIHOLLOWRELICUPGRADEROWWIDGETCONTROLLER___BASE_REFRESHITEMVIEW_OFFSET UNITYSDK_OFFSET(0x17329970)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowRelicUpGradeRowWidgetController_TypeDefinitionIndex = 60651;
