...
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_GETACTUALNPCNAME_OFFSET UNITYSDK_OFFSET(0x13DF4180)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_GETNPCNAMEBYID_OFFSET UNITYSDK_OFFSET(0x13DF4490)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x13DF2480)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_INITTABS_OFFSET UNITYSDK_OFFSET(0x13DF2A10)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x13DF2490)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_ONINFOBTNCLICK_OFFSET UNITYSDK_OFFSET(0x13DF43C0)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x13DF3170)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x13DF3330)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x13DF2520)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x13DF2E20)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_PLAYWIDGETANIMATION_OFFSET UNITYSDK_OFFSET(0x13DF3050)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x13DF33A0)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x13DF45D0)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER__INITTABS_B__21_0_OFFSET UNITYSDK_OFFSET(0x13DF4830)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER__ONUIINIT_B__17_0_OFFSET UNITYSDK_OFFSET(0x13DF4660)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER__ONUIINIT_B__17_1_OFFSET UNITYSDK_OFFSET(0x13DF47A0)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x13DF4960)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x13DF49F0)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x13DF4AB0)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x13DF4AC0)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x13DF4AD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIOperationYumPageController_TypeDefinitionIndex = 40376;

	class UIOperationYumPageController : public ::MoleMole::UIWindowController
	{
	public:
		// static const ::System::Int32 TAB_COUNT = 0x5; // 0x0
		::Class_2_C9AC68D5E8DE2708* _view; // 0x310
		::MoleMole::UIActivityCompWeekRewardBtnWidgetController* _limitTimeTaskBtnWidgetController; // 0x318
		::Class_2_6EC930B690591576* _operationYumModel; // 0x320
		::MoleMole::UIOperationYumMainWidgetController* _mainWidget1; // 0x328
		::MoleMole::UIOperationYumMainWidgetController* _mainWidget2; // 0x330
		::MoleMole::UIOperationYumMainWidgetController* _mainWidget3; // 0x338
		::System::Collections::Generic::List_1<::MoleMole::UIOperationYumTabWidgetController*>* _tabBtns; // 0x340
		::System::Boolean _needPlayRefresh; // 0x348
		::System::Single _fadeInAniLength; // 0x34C
		::System::Single _refreshAniLength; // 0x350
		::System::Int32 _curSelectIndex; // 0x354
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::Class_2_6EC930B690591576_Class_1_EA06DA1092863621*>* _npcNameDic; // 0x358
