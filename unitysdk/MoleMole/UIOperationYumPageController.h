...
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_GETACTUALNPCNAME_OFFSET UNITYSDK_OFFSET(0x155FF390)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_GETNPCNAMEBYID_OFFSET UNITYSDK_OFFSET(0x155FF6A0)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x155FD590)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_INITTABS_OFFSET UNITYSDK_OFFSET(0x155FDB20)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x155FD5A0)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_ONINFOBTNCLICK_OFFSET UNITYSDK_OFFSET(0x155FF5D0)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x155FE280)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x155FE440)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x155FD630)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x155FDF30)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_PLAYWIDGETANIMATION_OFFSET UNITYSDK_OFFSET(0x155FE160)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x155FE4B0)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x155FF7E0)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER__INITTABS_B__21_0_OFFSET UNITYSDK_OFFSET(0x155FFA40)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER__ONUIINIT_B__17_0_OFFSET UNITYSDK_OFFSET(0x155FF870)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER__ONUIINIT_B__17_1_OFFSET UNITYSDK_OFFSET(0x155FF9B0)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x155FFB70)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x155FFC00)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x155FFCC0)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x155FFCD0)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x155FFCE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIOperationYumPageController_TypeDefinitionIndex = 84402;
