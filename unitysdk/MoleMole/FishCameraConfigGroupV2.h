...
#define MOLEMOLE_FISHCAMERACONFIGGROUPV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1B596E10)

namespace MoleMole
{
	inline static constexpr unsigned int FishCameraConfigGroupV2_TypeDefinitionIndex = 76679;
