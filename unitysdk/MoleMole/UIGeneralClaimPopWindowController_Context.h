...
#define MOLEMOLE_UIGENERALCLAIMPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x186AF780)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralClaimPopWindowController_Context_TypeDefinitionIndex = 56855;
	...
	public:
		...
		::System::Collections::Generic::List_1<::System::Int32>* ShowGotIndices; // 0x40
		::Enum_3_92BB5F3881865EA5 ClaimType; // 0x48
		::System::Int32 SourceItemID; // 0x4C
		::System::Boolean ShowOkBtn; // 0x50
