...
#define MOLEMOLE_MONOSPAWNPOINT_GET_FORWARD_OFFSET UNITYSDK_OFFSET(0x16CDCF00)
#define MOLEMOLE_MONOSPAWNPOINT_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x16CA3330)
#define MOLEMOLE_MONOSPAWNPOINT_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x16CA3390)
#define MOLEMOLE_MONOSPAWNPOINT_GET_SCENETOFINDOBJECT_OFFSET UNITYSDK_OFFSET(0x16CDD080)
#define MOLEMOLE_MONOSPAWNPOINT_GET_TRIGGERPARAM_OFFSET UNITYSDK_OFFSET(0x16CDD070)
#define MOLEMOLE_MONOSPAWNPOINT_GET_XZPOSITION_OFFSET UNITYSDK_OFFSET(0x16CDCE00)
#define MOLEMOLE_MONOSPAWNPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x16CDD160)

namespace MoleMole
{
	inline static constexpr unsigned int MonoSpawnPoint_TypeDefinitionIndex = 59612;
