...
#define MOLEMOLE_MAINCITYSIDEBARITEMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BF75A0)

namespace MoleMole
{
	inline static constexpr unsigned int MainCitySidebarItemConfig_TypeDefinitionIndex = 57137;
