...
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ACTIVEINPUT_OFFSET UNITYSDK_OFFSET(0x17AD5CF0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_BINDPROPERTY_OFFSET UNITYSDK_OFFSET(0x17ACBB00)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_BIND_OFFSET UNITYSDK_OFFSET(0x17ACF780)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_CHECKSOCIALUNLOCK_OFFSET UNITYSDK_OFFSET(0x17ACC190)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_CHECKSOCIAL_OFFSET UNITYSDK_OFFSET(0x17AD8AE0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_CLEARCURRENTMULTINEW_OFFSET UNITYSDK_OFFSET(0x17AD78F0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_CLEAR_OFFSET UNITYSDK_OFFSET(0x17AD7BD0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_CLOSEGUIDEUI_OFFSET UNITYSDK_OFFSET(0x17AD6FC0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_CLOSEINTERKNOT_OFFSET UNITYSDK_OFFSET(0x17ADB820)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_DEACTIVEINPUT_OFFSET UNITYSDK_OFFSET(0x17AD5F70)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_DOEXPANIMATION_OFFSET UNITYSDK_OFFSET(0x17ACC4D0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_FILTERSORT_OFFSET UNITYSDK_OFFSET(0x17AD8040)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_FOCUSCONFRIM_OFFSET UNITYSDK_OFFSET(0x17AD5BB0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_FOCUSINPUT_OFFSET UNITYSDK_OFFSET(0x17AD5960)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_GETBOTTOMTIPSROOT_OFFSET UNITYSDK_OFFSET(0x17AD7FE0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_GETJUMPMANUALTIME_OFFSET UNITYSDK_OFFSET(0x17AD3F90)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_GETNEWBIEDYNAMICOBJECT_OFFSET UNITYSDK_OFFSET(0x17AD29C0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_GETREWARDLISTBYREWARDQUESTID_OFFSET UNITYSDK_OFFSET(0x17AD76C0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_GETREWARDQUESTIDBYQUESTGROUPID_OFFSET UNITYSDK_OFFSET(0x17AD7450)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_GETTABINDEX_OFFSET UNITYSDK_OFFSET(0x17AD3A40)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_GET_CANOPENNEWBIEMASK_OFFSET UNITYSDK_OFFSET(0x17ACB5B0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_GET_MESSAGEMATCHPAGE_OFFSET UNITYSDK_OFFSET(0x17ACB5C0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x17ACB5A0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_GONEWBIE_OFFSET UNITYSDK_OFFSET(0x17AD3EF0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_HASFILTERSELECTION_OFFSET UNITYSDK_OFFSET(0x17AD17D0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_HASQUESTKNOTPOST_OFFSET UNITYSDK_OFFSET(0x17AD7150)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x17ACB5D0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_INITINTERKNOTREWARDS_OFFSET UNITYSDK_OFFSET(0x17ADA590)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_INITINTERKNOTTYPENAME_OFFSET UNITYSDK_OFFSET(0x17ACF080)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_INITPLAYEREXPBTN_OFFSET UNITYSDK_OFFSET(0x17ACF280)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_INITSOCIALSHOP_OFFSET UNITYSDK_OFFSET(0x17AD0680)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_INITSORT_OFFSET UNITYSDK_OFFSET(0x17ACEB90)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ISCIRCLEOPEN_OFFSET UNITYSDK_OFFSET(0x17ACC380)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ISNEEDGUID_OFFSET UNITYSDK_OFFSET(0x17AD3F40)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ISNEEDSETNAME_OFFSET UNITYSDK_OFFSET(0x17AD04D0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ISPOSTOPEN_OFFSET UNITYSDK_OFFSET(0x17ACC230)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ISTRACKINGPERSONALQUEST_OFFSET UNITYSDK_OFFSET(0x17ADBA00)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ISTRACKKNOTPOST_OFFSET UNITYSDK_OFFSET(0x17AD44C0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_NORMALSETNAMEUI_OFFSET UNITYSDK_OFFSET(0x17AD6200)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17ACB670)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONDROPDOWNSELECT_OFFSET UNITYSDK_OFFSET(0x17AD1C10)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONENDEDITCALL_OFFSET UNITYSDK_OFFSET(0x17AD66D0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONEXPGROWTH_OFFSET UNITYSDK_OFFSET(0x17ADB6A0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONFITTERUNLOCK_OFFSET UNITYSDK_OFFSET(0x17ADB960)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x17AD4F30)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONGAMEPADMODULEIGNORESETFOCUS_OFFSET UNITYSDK_OFFSET(0x17AD54D0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x17AD53C0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x17AD4C90)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONHOME_OFFSET UNITYSDK_OFFSET(0x17AD9730)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x17AD5630)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONINPUTNAMECHANGED_OFFSET UNITYSDK_OFFSET(0x17AD6DC0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONINTERKNOTPOSTCHANGE_OFFSET UNITYSDK_OFFSET(0x17AD4E00)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONINTERKNOTPOSTSELECT_OFFSET UNITYSDK_OFFSET(0x17ACD3A0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONINTERKNOTREWARDS_OFFSET UNITYSDK_OFFSET(0x17ADA320)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONITEMGET_OFFSET UNITYSDK_OFFSET(0x17ADB190)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x17ACD420)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONLEVELUP_OFFSET UNITYSDK_OFFSET(0x17ADB350)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONMISSION_OFFSET UNITYSDK_OFFSET(0x17AD9F20)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONREFRESHSOCIAL_OFFSET UNITYSDK_OFFSET(0x17AD1E20)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONSCROLLBEGIN_OFFSET UNITYSDK_OFFSET(0x17AD20D0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONSCROLLEND_OFFSET UNITYSDK_OFFSET(0x17AD22D0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONSETTABBTNSPAGEINDEX_OFFSET UNITYSDK_OFFSET(0x17AD96C0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17AD2D80)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONSOCIAL_OFFSET UNITYSDK_OFFSET(0x17AD8E40)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17AD23C0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17ACE2A0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17ACB700)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_ONVALIDATEINPUT_OFFSET UNITYSDK_OFFSET(0x17AD6980)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_OPENFILTER_OFFSET UNITYSDK_OFFSET(0x17AD4950)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_OPENGUIDUI_OFFSET UNITYSDK_OFFSET(0x17AD3AA0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_OPENSHOP_OFFSET UNITYSDK_OFFSET(0x17AD8220)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_QUESTUNLOCKANDNOTINPERSONAL_OFFSET UNITYSDK_OFFSET(0x17AD47D0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_REFRESHKNOTPOSTFOLLOWQUESTHINT_OFFSET UNITYSDK_OFFSET(0x17ACF570)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_REFRESHONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x17ACE100)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_REFRESHRUNTIMEINPUTACTION_OFFSET UNITYSDK_OFFSET(0x17ACD710)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_REFRESHSOCIALBTNSTATE_OFFSET UNITYSDK_OFFSET(0x17AD0BC0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_REFRESHTAKEALLREWARDSBTN_OFFSET UNITYSDK_OFFSET(0x17ADAEB0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_SAMPLEANIM_OFFSET UNITYSDK_OFFSET(0x17ADB0C0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_SAVESORT_OFFSET UNITYSDK_OFFSET(0x17AD26C0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_SETFORUMPANELSHOW_OFFSET UNITYSDK_OFFSET(0x17ACD890)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_SETNAMELIMITHINT_OFFSET UNITYSDK_OFFSET(0x17AD6AC0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_SETNEWSREWARDSTATE_OFFSET UNITYSDK_OFFSET(0x17AD52B0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_SETTABBTNSPAGEINDEX_OFFSET UNITYSDK_OFFSET(0x17AD9610)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_SETTABCLICK_OFFSET UNITYSDK_OFFSET(0x17AD21B0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_SETUPFOCUSITEMSTYLE_OFFSET UNITYSDK_OFFSET(0x17AD1A50)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_SHOULDREFRESHONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x17AD1BA0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_SHOWINTERKNOTUI_OFFSET UNITYSDK_OFFSET(0x17AD4B10)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_TOPSWITCHTOSOCIAL_OFFSET UNITYSDK_OFFSET(0x17AD8330)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_TRANSITIONORCLOSE_OFFSET UNITYSDK_OFFSET(0x17ADB8C0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_TRIMVALIDVALUE_OFFSET UNITYSDK_OFFSET(0x17AD6790)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_U13SETNAMEUI_OFFSET UNITYSDK_OFFSET(0x17ACDC10)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER__BINDPROPERTY_B__29_0_OFFSET UNITYSDK_OFFSET(0x17ADBD60)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER__BINDPROPERTY_B__29_1_OFFSET UNITYSDK_OFFSET(0x17ADC190)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER__BINDPROPERTY_B__29_2_OFFSET UNITYSDK_OFFSET(0x17ADC7E0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER__BINDPROPERTY_B__29_3_OFFSET UNITYSDK_OFFSET(0x17ADCE20)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER__BIND_B__81_0_OFFSET UNITYSDK_OFFSET(0x17ADD760)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER__BIND_B__81_10_OFFSET UNITYSDK_OFFSET(0x17ADD960)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER__BIND_B__81_11_OFFSET UNITYSDK_OFFSET(0x17ADD980)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER__BIND_B__81_5_OFFSET UNITYSDK_OFFSET(0x17ADD990)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x17ADBBF0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER__CLOSEGUIDEUI_B__66_0_OFFSET UNITYSDK_OFFSET(0x17ADD090)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER__CLOSEGUIDEUI_B__66_1_OFFSET UNITYSDK_OFFSET(0x17ADD3A0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17ADBA40)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER__INITINTERKNOTREWARDS_B__106_0_OFFSET UNITYSDK_OFFSET(0x17ADDD90)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER__INITINTERKNOTREWARDS_B__106_1_OFFSET UNITYSDK_OFFSET(0x17ADDDA0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER__INITINTERKNOTREWARDS_B__106_3_OFFSET UNITYSDK_OFFSET(0x17ADDDB0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER__INITSORT_B__86_0_OFFSET UNITYSDK_OFFSET(0x17ADD9A0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER__ONREFRESHSOCIAL_B__96_0_OFFSET UNITYSDK_OFFSET(0x17ADDCB0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER__ONREFRESHSOCIAL_B__96_2_OFFSET UNITYSDK_OFFSET(0x17ADDD80)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER__ONREFRESHSOCIAL_G__REFRESH_96_1_OFFSET UNITYSDK_OFFSET(0x17AD8730)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER__ONUIINIT_B__33_0_OFFSET UNITYSDK_OFFSET(0x17ADD000)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER__ONUIINIT_B__33_1_OFFSET UNITYSDK_OFFSET(0x17ADD010)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER__ONUIOPEN_B__27_0_OFFSET UNITYSDK_OFFSET(0x17ADBD50)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER__OPENFILTER_B__77_0_OFFSET UNITYSDK_OFFSET(0x17ADD460)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER__SETFORUMPANELSHOW_B__80_0_OFFSET UNITYSDK_OFFSET(0x17ADD6F0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER__TOPSWITCHTOSOCIAL_B__93_0_OFFSET UNITYSDK_OFFSET(0x17ADDC30)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER__TOPSWITCHTOSOCIAL_B__93_1_OFFSET UNITYSDK_OFFSET(0x17ADDC70)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER__TRANSITIONORCLOSE_B__112_0_OFFSET UNITYSDK_OFFSET(0x17ADE0D0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER___BASE_GETBOTTOMTIPSROOT_OFFSET UNITYSDK_OFFSET(0x17ADE680)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER___BASE_GETNEWBIEDYNAMICOBJECT_OFFSET UNITYSDK_OFFSET(0x17ADE710)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x17ADE7A0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17ADE830)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x17ADE8C0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER___BASE_ONGAMEPADMODULEIGNORESETFOCUS_OFFSET UNITYSDK_OFFSET(0x17ADE950)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x17ADE9F0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x17ADEA80)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x17ADEB10)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x17ADEB40)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17ADEBD0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17ADEBE0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17ADEBF0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17ADEC00)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotV3PageController_TypeDefinitionIndex = 52603;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(UIInterKnotV3PageController_TypeDefinitionIndex)->GetStaticField(0x30BA0);
		}
		...
		::Class_2_79F6D62CE30E3F8E_76* _view; // 0x328
		...
		::Class_2_9B614D02A0AA9182<::Class_0_16E4307DCC419505_255*>* _sorter; // 0x450
		...
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_255*>* FilterSort(::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_255*>* knots)
		{
			return ((::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_255*>*(*)(::PVOID, ::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_255*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER_FILTERSORT_OFFSET))(this, knots);
		}
