...
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRLONGPRESSMODE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x144F6730)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRLONGPRESSMODE_ONEVENTTRIGGER_OFFSET UNITYSDK_OFFSET(0x144F5E00)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRLONGPRESSMODE_ONFIREPRESSEND_OFFSET UNITYSDK_OFFSET(0x144F6540)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRLONGPRESSMODE_ONFIREPRESSSTART_OFFSET UNITYSDK_OFFSET(0x144F6390)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRLONGPRESSMODE_ONHITTARGET_OFFSET UNITYSDK_OFFSET(0x144F6350)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRLONGPRESSMODE_ONSHOOTSTART_OFFSET UNITYSDK_OFFSET(0x144F61A0)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRLONGPRESSMODE_PLAYANIMATIONBYINDEX_OFFSET UNITYSDK_OFFSET(0x144F5EF0)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRLONGPRESSMODE_RESETPLYANIMATION_OFFSET UNITYSDK_OFFSET(0x144F5FB0)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRLONGPRESSMODE_SETEVENTMODE_OFFSET UNITYSDK_OFFSET(0x144F5D70)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRLONGPRESSMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x144F6820)

namespace MoleMole
{
	inline static constexpr unsigned int MonoSummerEventCrossHairLongPressMode_TypeDefinitionIndex = 77520;
