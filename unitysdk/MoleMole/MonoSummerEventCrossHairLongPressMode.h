...
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRLONGPRESSMODE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x17033270)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRLONGPRESSMODE_ONEVENTTRIGGER_OFFSET UNITYSDK_OFFSET(0x17032940)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRLONGPRESSMODE_ONFIREPRESSEND_OFFSET UNITYSDK_OFFSET(0x17033080)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRLONGPRESSMODE_ONFIREPRESSSTART_OFFSET UNITYSDK_OFFSET(0x17032ED0)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRLONGPRESSMODE_ONHITTARGET_OFFSET UNITYSDK_OFFSET(0x17032E90)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRLONGPRESSMODE_ONSHOOTSTART_OFFSET UNITYSDK_OFFSET(0x17032CE0)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRLONGPRESSMODE_PLAYANIMATIONBYINDEX_OFFSET UNITYSDK_OFFSET(0x17032A30)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRLONGPRESSMODE_RESETPLYANIMATION_OFFSET UNITYSDK_OFFSET(0x17032AF0)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRLONGPRESSMODE_SETEVENTMODE_OFFSET UNITYSDK_OFFSET(0x170328B0)
#define MOLEMOLE_MONOSUMMEREVENTCROSSHAIRLONGPRESSMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x17033360)

namespace MoleMole
{
	inline static constexpr unsigned int MonoSummerEventCrossHairLongPressMode_TypeDefinitionIndex = 45184;
