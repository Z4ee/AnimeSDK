...
#define MOLEMOLE_MONOTUBERENDERER_AWAKE_OFFSET UNITYSDK_OFFSET(0x14199E90)
#define MOLEMOLE_MONOTUBERENDERER_FORCEUPDATE_OFFSET UNITYSDK_OFFSET(0x14199BA0)
#define MOLEMOLE_MONOTUBERENDERER_GETLENGTHATPOINT_OFFSET UNITYSDK_OFFSET(0x14199E10)
#define MOLEMOLE_MONOTUBERENDERER_GETROTATIONATPOINT_OFFSET UNITYSDK_OFFSET(0x14199D70)
#define MOLEMOLE_MONOTUBERENDERER_GET_CALCULATETANGENTS_OFFSET UNITYSDK_OFFSET(0x141999A0)
#define MOLEMOLE_MONOTUBERENDERER_GET_EDGECOUNT_OFFSET UNITYSDK_OFFSET(0x141998D0)
#define MOLEMOLE_MONOTUBERENDERER_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x14199B80)
#define MOLEMOLE_MONOTUBERENDERER_GET_MESH_OFFSET UNITYSDK_OFFSET(0x14199B90)
#define MOLEMOLE_MONOTUBERENDERER_GET_POINTS_OFFSET UNITYSDK_OFFSET(0x14199560)
#define MOLEMOLE_MONOTUBERENDERER_GET_RADIUSES_OFFSET UNITYSDK_OFFSET(0x14199700)
#define MOLEMOLE_MONOTUBERENDERER_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x141997B0)
#define MOLEMOLE_MONOTUBERENDERER_GET_UVANTISTRETCHING_OFFSET UNITYSDK_OFFSET(0x14199B10)
#define MOLEMOLE_MONOTUBERENDERER_GET_UVRECT_OFFSET UNITYSDK_OFFSET(0x14199A80)
#define MOLEMOLE_MONOTUBERENDERER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x14199BF0)
#define MOLEMOLE_MONOTUBERENDERER_MARKDYNAMIC_OFFSET UNITYSDK_OFFSET(0x14199D00)
#define MOLEMOLE_MONOTUBERENDERER_METHOD_5_805C56F44231AEF9_OFFSET UNITYSDK_OFFSET(0x1419A5D0)
#define MOLEMOLE_MONOTUBERENDERER_METHOD_5_8714CF4AE9195CA2_OFFSET UNITYSDK_OFFSET(0x1419C1C0)
#define MOLEMOLE_MONOTUBERENDERER_METHOD_5_A40475C44AA8CEAB_OFFSET UNITYSDK_OFFSET(0x1419D170)
#define MOLEMOLE_MONOTUBERENDERER_METHOD_5_B2C0ADBFEA309440_OFFSET UNITYSDK_OFFSET(0x1419CDC0)
#define MOLEMOLE_MONOTUBERENDERER_METHOD_5_C72B925A491E9859_OFFSET UNITYSDK_OFFSET(0x1419BCD0)
#define MOLEMOLE_MONOTUBERENDERER_METHOD_5_CD9F3CEFB366C27A_OFFSET UNITYSDK_OFFSET(0x1419A750)
#define MOLEMOLE_MONOTUBERENDERER_METHOD_5_D308836DB54415C3_OFFSET UNITYSDK_OFFSET(0x1419C4D0)
#define MOLEMOLE_MONOTUBERENDERER_METHOD_5_DAEB67F34AF80609_OFFSET UNITYSDK_OFFSET(0x1419D7C0)
#define MOLEMOLE_MONOTUBERENDERER_METHOD_5_DE5BCBAF4D29B552_OFFSET UNITYSDK_OFFSET(0x141996B0)
#define MOLEMOLE_MONOTUBERENDERER_SET_CALCULATETANGENTS_OFFSET UNITYSDK_OFFSET(0x141999B0)
#define MOLEMOLE_MONOTUBERENDERER_SET_EDGECOUNT_OFFSET UNITYSDK_OFFSET(0x141998E0)
#define MOLEMOLE_MONOTUBERENDERER_SET_POINTS_OFFSET UNITYSDK_OFFSET(0x14199570)
#define MOLEMOLE_MONOTUBERENDERER_SET_RADIUSES_OFFSET UNITYSDK_OFFSET(0x14199710)
#define MOLEMOLE_MONOTUBERENDERER_SET_RADIUS_OFFSET UNITYSDK_OFFSET(0x141997C0)
#define MOLEMOLE_MONOTUBERENDERER_SET_UVANTISTRETCHING_OFFSET UNITYSDK_OFFSET(0x14199B20)
#define MOLEMOLE_MONOTUBERENDERER_SET_UVRECT_OFFSET UNITYSDK_OFFSET(0x14199A90)
#define MOLEMOLE_MONOTUBERENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x1419D6F0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoTubeRenderer_TypeDefinitionIndex = 57843;
