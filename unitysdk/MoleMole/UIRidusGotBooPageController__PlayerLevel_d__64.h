...
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__PLAYERLEVEL_D__64_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x816F80)
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__PLAYERLEVEL_D__64_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooPageController__PlayerLevel_d__64_TypeDefinitionIndex = 91533;
	...
	struct alignas(8) UIRidusGotBooPageController__PlayerLevel_d__64
	{
		...
		::System::Single _playerInteractTime_5__3; // 0x40
