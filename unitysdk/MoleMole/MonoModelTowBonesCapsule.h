...
#define MOLEMOLE_MONOMODELTOWBONESCAPSULE_GET_FLAG_OFFSET UNITYSDK_OFFSET(0x119015D0)
#define MOLEMOLE_MONOMODELTOWBONESCAPSULE_GET_SHAPE_OFFSET UNITYSDK_OFFSET(0x11901160)
#define MOLEMOLE_MONOMODELTOWBONESCAPSULE__CTOR_OFFSET UNITYSDK_OFFSET(0x119015E0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoModelTowBonesCapsule_TypeDefinitionIndex = 44685;
