...
#define MOLEMOLE_UITOWERDEFENSEPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16782BE0)

namespace MoleMole
{
	inline static constexpr unsigned int UITowerDefensePageContext_TypeDefinitionIndex = 45286;
