...
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER__PLAYFEVERSTARTEFFECT_D__16_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x81E8D0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER__PLAYFEVERSTARTEFFECT_D__16_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x283610)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaSinglePlayWidgetController__PlayFeverStartEffect_d__16_TypeDefinitionIndex = 71502;
