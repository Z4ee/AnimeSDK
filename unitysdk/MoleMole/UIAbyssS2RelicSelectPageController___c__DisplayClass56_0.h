...
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER___C__DISPLAYCLASS56_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18BBE230)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2RelicSelectPageController___c__DisplayClass56_0_TypeDefinitionIndex = 51183;

	class UIAbyssS2RelicSelectPageController___c__DisplayClass56_0 : public ::System::Object
	{
	public:
		::MoleMole::UIAbyssS2RelicSelectPageController* __4__this; // 0x10
		::System::String* localKey; // 0x18
		::MoleMole::UserLocalDataItem* localData; // 0x20
