...
#define MOLEMOLE_MONOLAYOUTTWEEN_CLASS_1_924F6C7A5B3689B2_METHOD_1_3C927B51D2142A24_OFFSET UNITYSDK_OFFSET(0x18CE76F0)
#define MOLEMOLE_MONOLAYOUTTWEEN_CLASS_1_924F6C7A5B3689B2_METHOD_1_FB4BE762B6186C23_OFFSET UNITYSDK_OFFSET(0x18CE7720)
#define MOLEMOLE_MONOLAYOUTTWEEN_CLASS_1_924F6C7A5B3689B2__CTOR_OFFSET UNITYSDK_OFFSET(0x18CE76E0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoLayoutTween_Class_1_924F6C7A5B3689B2_TypeDefinitionIndex = 42438;
