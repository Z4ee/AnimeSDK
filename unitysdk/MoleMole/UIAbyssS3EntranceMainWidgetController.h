...
#define MOLEMOLE_UIABYSSS3ENTRANCEMAINWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1926C510)
#define MOLEMOLE_UIABYSSS3ENTRANCEMAINWIDGETCONTROLLER_ONCLICKBTN_OFFSET UNITYSDK_OFFSET(0x1926D4D0)
#define MOLEMOLE_UIABYSSS3ENTRANCEMAINWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1926C580)
#define MOLEMOLE_UIABYSSS3ENTRANCEMAINWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1926C720)
#define MOLEMOLE_UIABYSSS3ENTRANCEMAINWIDGETCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x1926CE30)
#define MOLEMOLE_UIABYSSS3ENTRANCEMAINWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1926D580)
#define MOLEMOLE_UIABYSSS3ENTRANCEMAINWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1926D730)
#define MOLEMOLE_UIABYSSS3ENTRANCEMAINWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1926D7D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS3EntranceMainWidgetController_TypeDefinitionIndex = 60390;
	...
	public:
		...
		::Class_2_208CC9941471731A_155* _entranceConfig; // 0x2D0
		::System::Collections::Generic::List_1<::Class_2_14E7CE92E8A3183F*>* _dungeonConfigList; // 0x2D8
		::Class_2_0A55B5A82A61DAFA_2* _currSelectQuestConfig; // 0x2E0
