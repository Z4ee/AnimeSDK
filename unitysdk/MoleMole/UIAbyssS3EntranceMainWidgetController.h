...
#define MOLEMOLE_UIABYSSS3ENTRANCEMAINWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1610DAF0)
#define MOLEMOLE_UIABYSSS3ENTRANCEMAINWIDGETCONTROLLER_ONCLICKBTN_OFFSET UNITYSDK_OFFSET(0x1610EAB0)
#define MOLEMOLE_UIABYSSS3ENTRANCEMAINWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1610DB60)
#define MOLEMOLE_UIABYSSS3ENTRANCEMAINWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1610DD00)
#define MOLEMOLE_UIABYSSS3ENTRANCEMAINWIDGETCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x1610E410)
#define MOLEMOLE_UIABYSSS3ENTRANCEMAINWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1610EB60)
#define MOLEMOLE_UIABYSSS3ENTRANCEMAINWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1610ED10)
#define MOLEMOLE_UIABYSSS3ENTRANCEMAINWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1610EDB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS3EntranceMainWidgetController_TypeDefinitionIndex = 59903;

	class UIAbyssS3EntranceMainWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::System::Int32 _entranceID; // 0x2C0
		::Class_2_E621E51D351EB960* _abyssModel; // 0x2C8
		::Class_2_208CC9941471731A_629* _entranceConfig; // 0x2D0
		::System::Collections::Generic::List_1<::Class_2_14E7CE92E8A3183F*>* _dungeonConfigList; // 0x2D8
		::Class_2_0A55B5A82A61DAFA* _currSelectQuestConfig; // 0x2E0
		::Class_2_14E7CE92E8A3183F* _currSelectDungeonConfig; // 0x2E8
