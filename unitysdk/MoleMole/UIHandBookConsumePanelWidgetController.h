...
#define MOLEMOLE_UIHANDBOOKCONSUMEPANELWIDGETCONTROLLER_ONCONSOLEBTN_OFFSET UNITYSDK_OFFSET(0x18980880)
#define MOLEMOLE_UIHANDBOOKCONSUMEPANELWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18980650)
#define MOLEMOLE_UIHANDBOOKCONSUMEPANELWIDGETCONTROLLER_ONITEMCHANGED_OFFSET UNITYSDK_OFFSET(0x18980760)
#define MOLEMOLE_UIHANDBOOKCONSUMEPANELWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x189806E0)
#define MOLEMOLE_UIHANDBOOKCONSUMEPANELWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1897FDE0)
#define MOLEMOLE_UIHANDBOOKCONSUMEPANELWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18980100)
#define MOLEMOLE_UIHANDBOOKCONSUMEPANELWIDGETCONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0x189801E0)
#define MOLEMOLE_UIHANDBOOKCONSUMEPANELWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18980E10)
#define MOLEMOLE_UIHANDBOOKCONSUMEPANELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18980DB0)
#define MOLEMOLE_UIHANDBOOKCONSUMEPANELWIDGETCONTROLLER__ONUIINIT_B__2_0_OFFSET UNITYSDK_OFFSET(0x18980E90)
#define MOLEMOLE_UIHANDBOOKCONSUMEPANELWIDGETCONTROLLER__ONUIINIT_B__2_1_OFFSET UNITYSDK_OFFSET(0x18980F00)
#define MOLEMOLE_UIHANDBOOKCONSUMEPANELWIDGETCONTROLLER__ONUIINIT_B__2_2_OFFSET UNITYSDK_OFFSET(0x18980F70)
#define MOLEMOLE_UIHANDBOOKCONSUMEPANELWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18980FE0)
#define MOLEMOLE_UIHANDBOOKCONSUMEPANELWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18981070)
#define MOLEMOLE_UIHANDBOOKCONSUMEPANELWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18981100)
#define MOLEMOLE_UIHANDBOOKCONSUMEPANELWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18981190)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookConsumePanelWidgetController_TypeDefinitionIndex = 72878;
	...
	public:
		...
		{
			return (::System::Collections::Generic::HashSet_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(UIHandBookConsumePanelWidgetController_TypeDefinitionIndex)->GetStaticField(0x4C5A0);
		}
		::Class_2_BB18B5C1205C80C6_2* _view; // 0x2C0
