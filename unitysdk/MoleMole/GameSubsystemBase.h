...
#define MOLEMOLE_GAMESUBSYSTEMBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x161F3530)

namespace MoleMole
{
	inline static constexpr unsigned int GameSubsystemBase_TypeDefinitionIndex = 55316;
