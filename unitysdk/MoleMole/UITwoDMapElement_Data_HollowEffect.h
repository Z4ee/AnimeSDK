...
#define MOLEMOLE_UITWODMAPELEMENT_DATA_HOLLOWEFFECT_CREATEUICONTROLLER_OFFSET UNITYSDK_OFFSET(0x1303E6B0)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_HOLLOWEFFECT_GETICONSIZE_OFFSET UNITYSDK_OFFSET(0x1303E580)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_HOLLOWEFFECT_GETICONTYPE_OFFSET UNITYSDK_OFFSET(0x1303E520)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_HOLLOWEFFECT_GETOFFSETPOSITION_OFFSET UNITYSDK_OFFSET(0x1303E620)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_HOLLOWEFFECT_GET_FORCEACTIVE_OFFSET UNITYSDK_OFFSET(0x1303E440)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_HOLLOWEFFECT_GET_ICONID_OFFSET UNITYSDK_OFFSET(0x1303E570)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_HOLLOWEFFECT_GET_ROOTNAME_OFFSET UNITYSDK_OFFSET(0x1303E7D0)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_HOLLOWEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1303E450)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_HOLLOWEFFECT___BASE_GETICONSIZE_OFFSET UNITYSDK_OFFSET(0x1303E810)

namespace MoleMole
{
	inline static constexpr unsigned int UITwoDMapElement_Data_HollowEffect_TypeDefinitionIndex = 88169;

	class UITwoDMapElement_Data_HollowEffect : public ::MoleMole::UITwoDMapElement_Data
	{
	public:
		::UnityEngine::Vector2 Offset; // 0x58
		::UnityEngine::Vector2 Offset2; // 0x60
		::System::Int32 _id; // 0x68
		::System::Int32 _effectType; // 0x6C

		::System::Void _ctor(::System::Int32 id, ::System::Int32 effectType, ::Class_0_16E4307DCC419505_364* posProvider)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::System::Int32, ::Class_0_16E4307DCC419505_364*))((::PBYTE)hIl2Cpp + MOLEMOLE_UITWODMAPELEMENT_DATA_HOLLOWEFFECT__CTOR_OFFSET))(this, id, effectType, posProvider);
		}
