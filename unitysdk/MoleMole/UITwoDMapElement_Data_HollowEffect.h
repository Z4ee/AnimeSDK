...
#define MOLEMOLE_UITWODMAPELEMENT_DATA_HOLLOWEFFECT_CREATEUICONTROLLER_OFFSET UNITYSDK_OFFSET(0x10896170)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_HOLLOWEFFECT_GETICONSIZE_OFFSET UNITYSDK_OFFSET(0x10896040)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_HOLLOWEFFECT_GETICONTYPE_OFFSET UNITYSDK_OFFSET(0x10895FE0)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_HOLLOWEFFECT_GETOFFSETPOSITION_OFFSET UNITYSDK_OFFSET(0x108960E0)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_HOLLOWEFFECT_GET_FORCEACTIVE_OFFSET UNITYSDK_OFFSET(0x10895F00)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_HOLLOWEFFECT_GET_ICONID_OFFSET UNITYSDK_OFFSET(0x10896030)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_HOLLOWEFFECT_GET_ROOTNAME_OFFSET UNITYSDK_OFFSET(0x10896270)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_HOLLOWEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x10895F10)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_HOLLOWEFFECT___BASE_GETICONSIZE_OFFSET UNITYSDK_OFFSET(0x108962B0)

namespace MoleMole
{
	inline static constexpr unsigned int UITwoDMapElement_Data_HollowEffect_TypeDefinitionIndex = 42434;

	class UITwoDMapElement_Data_HollowEffect : public ::MoleMole::UITwoDMapElement_Data
	{
	public:
		::System::Int32 _id; // 0x58
		::System::Int32 _effectType; // 0x5C
		::UnityEngine::Vector2 Offset2; // 0x60
		::UnityEngine::Vector2 Offset; // 0x68

		::System::Void _ctor(::System::Int32 id, ::System::Int32 effectType, ::Class_0_16E4307DCC419505_274* posProvider)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::System::Int32, ::Class_0_16E4307DCC419505_274*))((::PBYTE)hIl2Cpp + MOLEMOLE_UITWODMAPELEMENT_DATA_HOLLOWEFFECT__CTOR_OFFSET))(this, id, effectType, posProvider);
		}
