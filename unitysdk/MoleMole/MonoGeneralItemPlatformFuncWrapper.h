...
#define MOLEMOLE_MONOGENERALITEMPLATFORMFUNCWRAPPER_INIT_OFFSET UNITYSDK_OFFSET(0x164020D0)
#define MOLEMOLE_MONOGENERALITEMPLATFORMFUNCWRAPPER_METHOD_5_0B4B9CF894B38303_OFFSET UNITYSDK_OFFSET(0x16402F90)
#define MOLEMOLE_MONOGENERALITEMPLATFORMFUNCWRAPPER_METHOD_5_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0x164027C0)
#define MOLEMOLE_MONOGENERALITEMPLATFORMFUNCWRAPPER_METHOD_5_6F73A40265D5B980_OFFSET UNITYSDK_OFFSET(0x16402960)
#define MOLEMOLE_MONOGENERALITEMPLATFORMFUNCWRAPPER_METHOD_5_70CD9A040B4290BE_OFFSET UNITYSDK_OFFSET(0x16402140)
#define MOLEMOLE_MONOGENERALITEMPLATFORMFUNCWRAPPER_METHOD_5_890F5FC885825F9E_OFFSET UNITYSDK_OFFSET(0x16402DA0)
#define MOLEMOLE_MONOGENERALITEMPLATFORMFUNCWRAPPER_METHOD_5_F3FE4B1C21DCE6C1_OFFSET UNITYSDK_OFFSET(0x16402920)
#define MOLEMOLE_MONOGENERALITEMPLATFORMFUNCWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x164028D0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGeneralItemPlatformFuncWrapper_TypeDefinitionIndex = 72586;
	...
	public:
		...
		::MoleMole::UIBaseController* Field_5_7; // 0x50
		::Class_1_BE6BF7909AD9D940* Field_5_8; // 0x58
		::System::Boolean Field_5_9; // 0x60
		::System::Boolean Field_5_10; // 0x61
		::UnityEngine::UI::Extension::UILocalizationText* Field_5_11; // 0x68
