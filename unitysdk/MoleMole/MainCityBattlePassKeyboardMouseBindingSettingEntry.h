...
#define MOLEMOLE_MAINCITYBATTLEPASSKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x16B93260)
#define MOLEMOLE_MAINCITYBATTLEPASSKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x16B93270)
#define MOLEMOLE_MAINCITYBATTLEPASSKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x16B93280)

namespace MoleMole
{
	inline static constexpr unsigned int MainCityBattlePassKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 46243;
