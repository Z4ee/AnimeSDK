...
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x13EDC780)
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x13EDC890)
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x13EDC810)
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x13EDC5D0)
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER_SHOWROW_OFFSET UNITYSDK_OFFSET(0x13EDC9F0)
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x13EDCC90)
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x13EDCCA0)
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x13EDCD30)
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x13EDCDD0)
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x13EDCE60)

namespace MoleMole
{
	inline static constexpr unsigned int UIActRowWidgetController_TypeDefinitionIndex = 48506;

	class UIActRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_FB90F8F234309AE5* _view; // 0x2E8
		::Class_1_730A101C592B37EC* _selfieMotion; // 0x2F0
