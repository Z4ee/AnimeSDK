...
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1731C770)
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1731C880)
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1731C800)
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1731C5C0)
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER_SHOWROW_OFFSET UNITYSDK_OFFSET(0x1731C9E0)
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1731CCD0)
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1731CCE0)
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1731CD70)
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1731CE10)
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1731CEA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActRowWidgetController_TypeDefinitionIndex = 66324;
