...
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__REFRESHCHESSBOARDVIEW_D__24_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x155F4C70)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__REFRESHCHESSBOARDVIEW_D__24_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x155F6190)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__REFRESHCHESSBOARDVIEW_D__24_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x155F61F0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__REFRESHCHESSBOARDVIEW_D__24_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x155F61A0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__REFRESHCHESSBOARDVIEW_D__24_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x155F4C60)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__REFRESHCHESSBOARDVIEW_D__24__CTOR_OFFSET UNITYSDK_OFFSET(0x155F4C50)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultPageController__RefreshChessboardView_d__24_TypeDefinitionIndex = 68602;
	...
	public:
		...
		::System::Int32 _coinBaseNum_5__4; // 0x1C
		::System::Int32 __1__state; // 0x20
		::System::Int32 _coinNum_5__3; // 0x24
