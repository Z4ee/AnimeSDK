...
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__REFRESHCHESSBOARDVIEW_D__24_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x17C190B0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__REFRESHCHESSBOARDVIEW_D__24_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x168AC220)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__REFRESHCHESSBOARDVIEW_D__24_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x168AC280)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__REFRESHCHESSBOARDVIEW_D__24_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x168AC230)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__REFRESHCHESSBOARDVIEW_D__24_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17C190A0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__REFRESHCHESSBOARDVIEW_D__24__CTOR_OFFSET UNITYSDK_OFFSET(0x17C19090)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultPageController__RefreshChessboardView_d__24_TypeDefinitionIndex = 69280;
	...
	public:
		...
		::System::Int32 _coinNum_5__3; // 0x1C
		::System::Single __2__current; // 0x20
		::System::Boolean _isEndBattle_5__2; // 0x24
		::System::Int32 _coinBaseNum_5__4; // 0x28
