...
#define MOLEMOLE_MONOMULTIINPUTKEY_CLEARGENERALKEYPANEL_OFFSET UNITYSDK_OFFSET(0x178288B0)
#define MOLEMOLE_MONOMULTIINPUTKEY_DOCOPYRESET_OFFSET UNITYSDK_OFFSET(0x17828AE0)
#define MOLEMOLE_MONOMULTIINPUTKEY_GET_PRIORITYLEVEL_OFFSET UNITYSDK_OFFSET(0x178279C0)
#define MOLEMOLE_MONOMULTIINPUTKEY_INITGENERALKEYPANEL_OFFSET UNITYSDK_OFFSET(0x178279D0)
#define MOLEMOLE_MONOMULTIINPUTKEY_METHOD_5_724025AF880C2293_OFFSET UNITYSDK_OFFSET(0x17827A20)
#define MOLEMOLE_MONOMULTIINPUTKEY_METHOD_5_745F93A8744358B2_OFFSET UNITYSDK_OFFSET(0x178283F0)
#define MOLEMOLE_MONOMULTIINPUTKEY_METHOD_5_F8AE343EE3AC451D_OFFSET UNITYSDK_OFFSET(0x17828E80)
#define MOLEMOLE_MONOMULTIINPUTKEY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17828AA0)
#define MOLEMOLE_MONOMULTIINPUTKEY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17828A50)
#define MOLEMOLE_MONOMULTIINPUTKEY_SETENABLE_OFFSET UNITYSDK_OFFSET(0x178283A0)
#define MOLEMOLE_MONOMULTIINPUTKEY__CCTOR_OFFSET UNITYSDK_OFFSET(0x17828CD0)
#define MOLEMOLE_MONOMULTIINPUTKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x17828B60)

namespace MoleMole
{
	inline static constexpr unsigned int MonoMultiInputKey_TypeDefinitionIndex = 70631;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::Enum_3_C0E4561226F6DD72, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(MonoMultiInputKey_TypeDefinitionIndex)->GetStaticField(0x447E0);
		}
