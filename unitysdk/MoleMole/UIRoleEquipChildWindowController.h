...
class Class_2_CB67534E2D18D04F;
...
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_CHANGEMATERIAL_OFFSET UNITYSDK_OFFSET(0x15F71220)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_CHANGESIGNATUREHANDLE_OFFSET UNITYSDK_OFFSET(0x15F735B0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_GETROLEINFOEQUIPWIDGETGAMEPADNESTLIST_OFFSET UNITYSDK_OFFSET(0x15F6FDC0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_GETWEAPONTOGGLEUNLOCK_OFFSET UNITYSDK_OFFSET(0x15F71410)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_GET_TRIGGERNEWBIEONSHOW_OFFSET UNITYSDK_OFFSET(0x15F6E960)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15F6E950)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_HIDETOGGLECONSOLEKEY_OFFSET UNITYSDK_OFFSET(0x15F72F60)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_INITANIMGROUP_OFFSET UNITYSDK_OFFSET(0x15F6E9C0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x15F6EE50)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_INITWEAPONVIDEOSCREEN_OFFSET UNITYSDK_OFFSET(0x15F713B0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_ISTRAININGROOM_OFFSET UNITYSDK_OFFSET(0x15F73390)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_NESTEDLISTSELECTITEMRECURSIVELY_OFFSET UNITYSDK_OFFSET(0x15F70160)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_ONCLICKEQUIPSLOTBTN_OFFSET UNITYSDK_OFFSET(0x15F73D30)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_ONCLICKWEAPONBTN_OFFSET UNITYSDK_OFFSET(0x15F73BC0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15F6F280)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_ONEQUIPCHANGED_OFFSET UNITYSDK_OFFSET(0x15F6FAF0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x15F6FB90)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15F6F940)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15F6EDF0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15F6F310)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_ONWEAPONTOGGLEHANDLE_OFFSET UNITYSDK_OFFSET(0x15F73050)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_PLAYAUTODRESSANIM_OFFSET UNITYSDK_OFFSET(0x15F73A10)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_PROCESSUIAVATAR_OFFSET UNITYSDK_OFFSET(0x15F6FB40)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_REFRESHICONVIEW_OFFSET UNITYSDK_OFFSET(0x15F716A0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_REFRESHROLEINFOEQUIPWIDGETWITHWEAPONGAMEPADSELECTINFO_OFFSET UNITYSDK_OFFSET(0x15F70390)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x15F6F5A0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_RESETALLSLOTSELECTEDSTATE_OFFSET UNITYSDK_OFFSET(0x15F73860)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_RESETROLEINFOEQUIPWIDGETWITHWEAPONGAMEPADENABLED_OFFSET UNITYSDK_OFFSET(0x15F6FF30)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETAUTODRESSMODE_OFFSET UNITYSDK_OFFSET(0x15F70FD0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETAVATARDATA_OFFSET UNITYSDK_OFFSET(0x15F70A90)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETBLOCKSELECTEDANIM_OFFSET UNITYSDK_OFFSET(0x15F70B70)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETBLOCKWEAPON_OFFSET UNITYSDK_OFFSET(0x15F70D00)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETCLICKEQUIPCALLBACK_OFFSET UNITYSDK_OFFSET(0x15F73810)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETCLICKWEAPONCALLBACK_OFFSET UNITYSDK_OFFSET(0x15F737C0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETEQUIPSLOTSELECTED_OFFSET UNITYSDK_OFFSET(0x15F705B0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETFORGEVIEW_OFFSET UNITYSDK_OFFSET(0x15F70DF0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETGAMEPADSELECTEQUIPCALLBACK_OFFSET UNITYSDK_OFFSET(0x15F73770)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETGAMEPADSELECTWEAPONCALLBACK_OFFSET UNITYSDK_OFFSET(0x15F73720)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETLVINFOVISIBLITY_OFFSET UNITYSDK_OFFSET(0x15F71020)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETROLEINFOEQUIPWIDGETGAMEPADENABLED_OFFSET UNITYSDK_OFFSET(0x15F6FD50)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETROLEINFOEQUIPWIDGETWITHWEAPONGAMEPADENABLED_OFFSET UNITYSDK_OFFSET(0x15F6FEC0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETTOGGLESTATE_OFFSET UNITYSDK_OFFSET(0x15F71590)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETWEAPONSLOTSELECTED_OFFSET UNITYSDK_OFFSET(0x15F70530)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SHOWTOGGLECONSOLEKEY_OFFSET UNITYSDK_OFFSET(0x15F72FD0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15F74240)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER__ONUIOPEN_B__8_0_OFFSET UNITYSDK_OFFSET(0x15F742E0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER__ONUIOPEN_B__8_1_OFFSET UNITYSDK_OFFSET(0x15F742F0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER__PLAYAUTODRESSANIM_B__41_0_OFFSET UNITYSDK_OFFSET(0x15F74300)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER___BASE_GET_TRIGGERNEWBIEONSHOW_OFFSET UNITYSDK_OFFSET(0x15F743C0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15F743D0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x15F74460)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15F74510)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15F74520)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15F74530)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleEquipChildWindowController_TypeDefinitionIndex = 83916;
	...
	public:
		...
		::Class_2_1B1C05BC0A38A2D5_1* _view; // 0x320
		::Class_2_1824EF69C8E376A3* _avatarData; // 0x328
		::Class_2_5E8E56AB26D3F10E* _equipmentDataProxy; // 0x330
		::Class_2_44CD689CB0C62F50* _robotDataProxy; // 0x338
		::System::Collections::Generic::List_1<::Class_2_CB67534E2D18D04F*>* _equipSlotItems; // 0x340
