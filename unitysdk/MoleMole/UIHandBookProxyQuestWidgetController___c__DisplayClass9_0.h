...
#define MOLEMOLE_UIHANDBOOKPROXYQUESTWIDGETCONTROLLER___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x167BBAB0)
#define MOLEMOLE_UIHANDBOOKPROXYQUESTWIDGETCONTROLLER___C__DISPLAYCLASS9_0__REFRESHSTATE_B__0_OFFSET UNITYSDK_OFFSET(0x167BBAC0)
#define MOLEMOLE_UIHANDBOOKPROXYQUESTWIDGETCONTROLLER___C__DISPLAYCLASS9_0__REFRESHSTATE_B__1_OFFSET UNITYSDK_OFFSET(0x167BBB40)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookProxyQuestWidgetController___c__DisplayClass9_0_TypeDefinitionIndex = 59042;
