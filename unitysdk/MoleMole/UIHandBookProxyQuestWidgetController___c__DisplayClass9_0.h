...
#define MOLEMOLE_UIHANDBOOKPROXYQUESTWIDGETCONTROLLER___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18AF89E0)
#define MOLEMOLE_UIHANDBOOKPROXYQUESTWIDGETCONTROLLER___C__DISPLAYCLASS9_0__REFRESHSTATE_B__0_OFFSET UNITYSDK_OFFSET(0x18AF89F0)
#define MOLEMOLE_UIHANDBOOKPROXYQUESTWIDGETCONTROLLER___C__DISPLAYCLASS9_0__REFRESHSTATE_B__1_OFFSET UNITYSDK_OFFSET(0x18AF8A70)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookProxyQuestWidgetController___c__DisplayClass9_0_TypeDefinitionIndex = 79449;
