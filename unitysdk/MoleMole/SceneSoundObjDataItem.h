...
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_AWAKE_OFFSET UNITYSDK_OFFSET(0x136EC040)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_GET_SOUNDACTIONSOURCEHINT_OFFSET UNITYSDK_OFFSET(0x136EBFE0)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_GET_SOUNDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x136EBFD0)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_INIT_OFFSET UNITYSDK_OFFSET(0x136EC0D0)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_METHOD_5_19844080C13BA28F_OFFSET UNITYSDK_OFFSET(0x136EC4F0)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_METHOD_5_85377D41FEE05B66_OFFSET UNITYSDK_OFFSET(0x136EC7F0)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x136EC110)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_ONITEMACTIVECHANGED_OFFSET UNITYSDK_OFFSET(0x136EC180)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_ONSCENELEAVE_OFFSET UNITYSDK_OFFSET(0x136EC3E0)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_ONSCENETAGCHANGED_OFFSET UNITYSDK_OFFSET(0x136EC1E0)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_RUNTIMERESET_OFFSET UNITYSDK_OFFSET(0x136ECA10)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_RUNTIMETOGGLEACTIVE_OFFSET UNITYSDK_OFFSET(0x136ECA70)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_SETDEACTIVEBYBINDINGOBJECT_OFFSET UNITYSDK_OFFSET(0x136EC450)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x136ECAF0)

namespace MoleMole
{
	inline static constexpr unsigned int SceneSoundObjDataItem_TypeDefinitionIndex = 76215;
