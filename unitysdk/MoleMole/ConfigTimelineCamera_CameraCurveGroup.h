...
#define MOLEMOLE_CONFIGTIMELINECAMERA_CAMERACURVEGROUP_GETCURVEDICT_OFFSET UNITYSDK_OFFSET(0x1A371780)
#define MOLEMOLE_CONFIGTIMELINECAMERA_CAMERACURVEGROUP_GETCURVE_OFFSET UNITYSDK_OFFSET(0x1A3719C0)
#define MOLEMOLE_CONFIGTIMELINECAMERA_CAMERACURVEGROUP_SETCURVE_OFFSET UNITYSDK_OFFSET(0x1A371AB0)
#define MOLEMOLE_CONFIGTIMELINECAMERA_CAMERACURVEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A371C00)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigTimelineCamera_CameraCurveGroup_TypeDefinitionIndex = 47288;
