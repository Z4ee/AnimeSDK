...
#define MOLEMOLE_SUIBIANPRODUCTIONRIGHTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x180A1360)

namespace MoleMole
{
	inline static constexpr unsigned int SuibianProductionRightContext_TypeDefinitionIndex = 45670;
