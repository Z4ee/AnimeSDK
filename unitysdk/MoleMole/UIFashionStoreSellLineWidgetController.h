...
class Class_2_61F297ED27C3382F_4;
...
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER_CANCELSCROLLVIEWSELECT_OFFSET UNITYSDK_OFFSET(0x16CC31A0)
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER_INITSELECTMANUALLY_OFFSET UNITYSDK_OFFSET(0x16CC30B0)
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER_ISROW_OFFSET UNITYSDK_OFFSET(0x16CC3140)
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16CC2CA0)
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16CC2DB0)
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16CC2D30)
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16CC2B90)
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16CC3200)
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER__ONSCROLLITEMUPDATE_B__5_0_OFFSET UNITYSDK_OFFSET(0x16CC3210)
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16CC3280)
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16CC3310)
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16CC33B0)
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16CC3440)

namespace MoleMole
{
	inline static constexpr unsigned int UIFashionStoreSellLineWidgetController_TypeDefinitionIndex = 52170;

	class UIFashionStoreSellLineWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_61F297ED27C3382F_4* _view; // 0x2E8
		::System::Collections::Generic::List_1<::Class_1_BD2BE7927F889C7B*>* _productList; // 0x2F0
		::System::Action_2<::System::Int32, ::System::Int32>* onClickProduct; // 0x2F8
		::MoleMole::UIFashionStoreSellLineWidgetController_Context* _context; // 0x300
