...
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_APPLYEQUIPFORCEFLAGS_OFFSET UNITYSDK_OFFSET(0x14BFBF20)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_AUTOCLICKBASICBTN_OFFSET UNITYSDK_OFFSET(0x14BFBE40)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_AUTOCLICKEQUIPBTN_OFFSET UNITYSDK_OFFSET(0x14BFBEB0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_AUTOCLICKSKILLBTN_OFFSET UNITYSDK_OFFSET(0x14BFC0C0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_CLOSESUBTYPE_OFFSET UNITYSDK_OFFSET(0x14C02FF0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_FINISHCURRENTNEWBIEHANDLE_OFFSET UNITYSDK_OFFSET(0x14C01150)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_GETAWAKENLEVELPICPATH_OFFSET UNITYSDK_OFFSET(0x14C005E0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_GETFADEOUTTIMEDETAIL_OFFSET UNITYSDK_OFFSET(0x14BFE780)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_GETOVERRIDEFADEINANIM_OFFSET UNITYSDK_OFFSET(0x14BFCB60)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_GETSUBCTRLNAME_1_OFFSET UNITYSDK_OFFSET(0x14BFBDF0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_GETSUBCTRLNAME_OFFSET UNITYSDK_OFFSET(0x14C039B0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_GETSUBTYPECONTROL_OFFSET UNITYSDK_OFFSET(0x14C04FB0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_GETSUBTYPESHOWCONTEXT_OFFSET UNITYSDK_OFFSET(0x14BFE590)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x14BFB330)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_GET_LASTCONTEXT_OFFSET UNITYSDK_OFFSET(0x14BFB350)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_GET_SWITCHINTERVAL_OFFSET UNITYSDK_OFFSET(0x14BFD8D0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_GET_TABBUTTONGROUP_OFFSET UNITYSDK_OFFSET(0x14BFB340)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_GET_TRIGGERNEWBIEONSHOW_OFFSET UNITYSDK_OFFSET(0x14BFB2D0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x14BFB2C0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_HIDEFORMODELCAMERAKITTOOL_OFFSET UNITYSDK_OFFSET(0x14C04B00)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_INITANIMGROUP_OFFSET UNITYSDK_OFFSET(0x14BFE3F0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x14BFF1C0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ISHOLLOWGAMEROOM_OFFSET UNITYSDK_OFFSET(0x14C049E0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ISTRAININGROOM_OFFSET UNITYSDK_OFFSET(0x14C048C0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x14C04860)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_LOADRTMODELFINISHED_OFFSET UNITYSDK_OFFSET(0x14BFE200)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ONAVATARCHANGEHANDLE_OFFSET UNITYSDK_OFFSET(0x14BFCC20)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ONCLICKBACKBTN_OFFSET UNITYSDK_OFFSET(0x14C02C40)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ONCLICKBASICBTN_OFFSET UNITYSDK_OFFSET(0x14C03410)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ONCLICKENTERAVATARAWAKE_OFFSET UNITYSDK_OFFSET(0x14BFFD30)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ONCLICKEQUIPBTN_OFFSET UNITYSDK_OFFSET(0x14C040B0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ONCLICKMAINBTN_OFFSET UNITYSDK_OFFSET(0x14C02C00)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ONCLICKSKILLBTN_OFFSET UNITYSDK_OFFSET(0x14C03B10)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14BFB360)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ONEQUIPCHANGED_OFFSET UNITYSDK_OFFSET(0x14C008E0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x14BFE7D0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ONHINTCLICKED_OFFSET UNITYSDK_OFFSET(0x14C00930)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ONINFOBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x14C04790)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x14C02A40)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ONINTERNALPAGECHANGED_OFFSET UNITYSDK_OFFSET(0x14C00C90)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ONITEMCHANGED_OFFSET UNITYSDK_OFFSET(0x14C00C40)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x14C04B90)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ONLVBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x14C01970)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ONMINDSCAPECLOSEHANDLE_OFFSET UNITYSDK_OFFSET(0x14C01EF0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ONMINDSCAPECLOSEOVERHANDLE_OFFSET UNITYSDK_OFFSET(0x14C01B50)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ONSHOWFRIENDPREVIEWMODEHINT_OFFSET UNITYSDK_OFFSET(0x14C01060)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ONSHOWPREVIEWMODEHINT_OFFSET UNITYSDK_OFFSET(0x14C00F70)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x14BFB3F0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ONSTRATEGYBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x14BFFD90)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14C01730)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14BFEE30)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14C00670)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_PLAYFADEANIMDETAIL_OFFSET UNITYSDK_OFFSET(0x14BFC9C0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_PROCESSUIAVATAR_OFFSET UNITYSDK_OFFSET(0x14BFDA90)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_RECORDEQUIPTABHINTED_OFFSET UNITYSDK_OFFSET(0x14BFD680)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_REDUCEMODELBLOCKINPUT_OFFSET UNITYSDK_OFFSET(0x14BFE150)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_REFRESHAWAKENLEVELINFO_OFFSET UNITYSDK_OFFSET(0x14C00170)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_REFRESHMAINCITYBTN_OFFSET UNITYSDK_OFFSET(0x14C02000)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_REFRESHREDPOINT_OFFSET UNITYSDK_OFFSET(0x14BFDF40)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_REFRESHSKILLVIEW_OFFSET UNITYSDK_OFFSET(0x14C01CB0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x14BFC130)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_RESETAVATARINFO_OFFSET UNITYSDK_OFFSET(0x14BFD7C0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_RESETAVATARMODEL_OFFSET UNITYSDK_OFFSET(0x14BFD9D0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_RESETCOUNTDOWNTIMER_OFFSET UNITYSDK_OFFSET(0x14BFDFF0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_SAVESUBTYPEINDEX_OFFSET UNITYSDK_OFFSET(0x14C03AB0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_SETBGCOLORBYCURAVATAR_OFFSET UNITYSDK_OFFSET(0x14C01F50)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_SETBGLINECOLOR_OFFSET UNITYSDK_OFFSET(0x14C02270)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_SETBLOCKINPUT_OFFSET UNITYSDK_OFFSET(0x14BFE650)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_SETLEFTLINECOLOR_OFFSET UNITYSDK_OFFSET(0x14C021E0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_SETROLEJUMPDATA_OFFSET UNITYSDK_OFFSET(0x14C04E10)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_SETRTSHADOW_OFFSET UNITYSDK_OFFSET(0x14BFBCD0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_SETSELECTIONAVATAR_OFFSET UNITYSDK_OFFSET(0x14BFDF90)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_UPDATEINFOBTNTEXT_OFFSET UNITYSDK_OFFSET(0x14C04650)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_UPDATESTRATEGYBTNSTATE_OFFSET UNITYSDK_OFFSET(0x14BFFFB0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x14C05180)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14C05040)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER__ONAVATARCHANGEHANDLE_B__44_0_OFFSET UNITYSDK_OFFSET(0x14C05190)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER__ONAVATARCHANGEHANDLE_B__44_1_OFFSET UNITYSDK_OFFSET(0x14C051D0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER__ONCLICKBACKBTN_B__100_1_OFFSET UNITYSDK_OFFSET(0x14C05580)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER__ONLVBTNCLICKHANDLE_B__89_0_OFFSET UNITYSDK_OFFSET(0x14C052E0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER__ONUIINIT_B__73_0_OFFSET UNITYSDK_OFFSET(0x14C051E0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER__PROCESSUIAVATAR_B__115_0_OFFSET UNITYSDK_OFFSET(0x14C057F0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER__SETBLOCKINPUT_B__107_0_OFFSET UNITYSDK_OFFSET(0x14C05720)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER___BASE_GETOVERRIDEFADEINANIM_OFFSET UNITYSDK_OFFSET(0x14C058B0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER___BASE_GET_TRIGGERNEWBIEONSHOW_OFFSET UNITYSDK_OFFSET(0x14C058A0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14C058C0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x14C05950)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x14C059E0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x14C05A10)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x14C05AA0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14C05AB0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14C05AC0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14C05AD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleInfoPageController_TypeDefinitionIndex = 67728;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIRoleInfoPageController_TypeDefinitionIndex)->GetStaticField(0xC5A0);
		}
		...
		::System::Collections::Generic::Dictionary_2<::MoleMole::UIRoleInfoPageController_UIRoleInfo_SubType, ::MoleMole::UIBaseController*>* _roleSubType; // 0x310
		::Class_2_C2B4B123B5A9B78A* _roleUnit; // 0x318
		::MoleMole::UIRoleInfoPageController_UIRoleInfo_SubType _curSubType; // 0x320
		::MoleMole::UIRoleInfoPageController_UIRoleInfo_SubType _targetSubType; // 0x324
		::Class_2_1824EF69C8E376A3* _avatarData; // 0x328
		::System::String* _fromType; // 0x330
		::UnityEngine::UI::Extension::UITabButtonGroup* _tabButtonGroup; // 0x338
		::UnityEngine::Animation* _animation; // 0x340
		::System::Single _fadeOutTime; // 0x348
		::System::Single _fadeOutTimeDetail; // 0x34C
		::System::Boolean _previewMode; // 0x350
		::System::Boolean _friendPreviewMode; // 0x351
		::System::Boolean _hideMainButton; // 0x352
		::MoleMole::UIRoleInfoPageContext* _lastContext; // 0x358
		::System::Collections::Generic::List_1<::Class_1_2CCC5D7984CDCED4*>* allItems; // 0x360
		::System::Collections::Generic::Dictionary_2<::MoleMole::UIRoleInfoPageController_UIRoleInfo_SubType, ::MoleMole::UIGeneralPopUpHintWidgetController*>* _popUpHintCtrlDict; // 0x368
		::MoleMole::UIRoleChangeWidgetController* _roleChangeWidget; // 0x370
		::MoleMole::UIMindscapeWidgetController* _mindscapeWidget; // 0x378
		::System::Boolean _internalPageOpen; // 0x380
		::MoleMole::UIRoleInfoPageController_LeftLogic m_leftLogic; // 0x384
		::MoleMole::UIRoleInfoPageController_RightLogic m_rightLogic; // 0x388
		::System::Boolean _isLoadingRTModel; // 0x38C
		::System::Single m_countDownTimer; // 0x390
		::System::Boolean m_modelBlockInput; // 0x394
		::UIControllerExtensionData* m_ctrlData; // 0x398
		::MoleMole::UIRoleInfoPageController_AnimationFadeOutFadeInGroup* m_allAnimGroup; // 0x3A0
		::MoleMole::UIRoleInfoPageController_AnimationFadeOutFadeInGroup* m_infoAnimGroup; // 0x3A8
		::MoleMole::UIRoleInfoPageController_AnimationFadeOutFadeInGroup* m_modelAnimGroup; // 0x3B0
		::System::Boolean m_useNewSwitchLogic; // 0x3B8
		::System::Single m_resetAvatarDeley; // 0x3BC
		::System::Boolean m_avatarSettled; // 0x3C0
		::Foundation::Coroutine::CoroutineHandle resetAvatarHandle; // 0x3C4
		::Foundation::Coroutine::CoroutineHandle changeColorHandle; // 0x3C8
		::MoleMole::MonoBPLevelAnimation* m_colorAnim; // 0x3D0
		::System::Boolean m_hideSkillTabHint; // 0x3D8
		::Foundation::Coroutine::CoroutineHandle m_countDownCoroutine; // 0x3DC
		::Class_2_11B3F578B206B5B7_1* _view; // 0x3E0
		::MoleMole::UIBPPageTopBtnWidgetController* _strategyBtnWidget; // 0x3E8
		...
		{
			return ((::System::String*(*)(::PVOID, ::MoleMole::UIFadeConfig*, ::Enum_3_81A3942BCC6E42B5))((::PBYTE)hIl2Cpp + MOLEMOLE_UIROLEINFOPAGECONTROLLER_GETOVERRIDEFADEINANIM_OFFSET))(this, fadeData, fromCtrl);
		}
		...
		{
			return ((::System::String*(*)(::PVOID, ::MoleMole::UIFadeConfig*, ::Enum_3_81A3942BCC6E42B5))((::PBYTE)hIl2Cpp + MOLEMOLE_UIROLEINFOPAGECONTROLLER___BASE_GETOVERRIDEFADEINANIM_OFFSET))(this, P0, P1);
		}
