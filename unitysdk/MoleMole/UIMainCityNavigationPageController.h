...
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_ADDSCROLLVIEWAREA_OFFSET UNITYSDK_OFFSET(0x179E8340)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_GETAREAQUESTINFO_OFFSET UNITYSDK_OFFSET(0x179E9EC0)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_GETCENTERITEMDATAINDEX_OFFSET UNITYSDK_OFFSET(0x179E73D0)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_GETKICHISECTIONINFO_OFFSET UNITYSDK_OFFSET(0x179E9D80)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_GETQUESTPARTNERID_OFFSET UNITYSDK_OFFSET(0x179EA650)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_GETSELECTITEM_OFFSET UNITYSDK_OFFSET(0x179E9860)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_GETSELECTSECTIONID_OFFSET UNITYSDK_OFFSET(0x179E8BA0)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x179E94F0)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_GET_TRACKHINTTELEPORTINDEX_OFFSET UNITYSDK_OFFSET(0x179E9260)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x179E6000)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_ISSIDEQUESTINAREA_OFFSET UNITYSDK_OFFSET(0x179EA3E0)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x179E6FB0)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_ONAREAITEMSELECTHANDLE_OFFSET UNITYSDK_OFFSET(0x179E62F0)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_ONBACKBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x179EA7E0)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x179E6010)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_ONDETAILBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x179EA960)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x179E9940)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x179E9B60)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x179E60A0)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_ONMAINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x179EA830)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x179E7230)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x179E9280)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x179E8420)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x179E64C0)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x179E8490)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_PLAYNEXTUNLOCKANIMATION_OFFSET UNITYSDK_OFFSET(0x179E9500)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_REFRESHAREAINFOPANEL_OFFSET UNITYSDK_OFFSET(0x179E9220)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_REFRESHRUNTIMEINPUTACTION_OFFSET UNITYSDK_OFFSET(0x179E6340)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_SELECTAREA_OFFSET UNITYSDK_OFFSET(0x179E7690)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_SET_TRACKHINTTELEPORTINDEX_OFFSET UNITYSDK_OFFSET(0x179E9270)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_STOPUNLOCKANIMATION_OFFSET UNITYSDK_OFFSET(0x179E97C0)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x179EAAB0)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x179EABA0)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x179EAC30)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x179EACC0)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x179EAD50)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x179EADE0)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x179EAEA0)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x179EAEB0)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x179EAEC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityNavigationPageController_TypeDefinitionIndex = 57194;
	...
	public:
		...
		::Class_2_79F6D62CE30E3F8E_120* _view; // 0x318
		...
		static ::System::ValueTuple_2<::System::Int32, ::System::Collections::Generic::List_1<::System::Int32>*> GetAreaQuestInfo(::Class_2_534AF681CC2BD5FD_206* areaTemplate)
		{
			return ((::System::ValueTuple_2<::System::Int32, ::System::Collections::Generic::List_1<::System::Int32>*>(*)(::Class_2_534AF681CC2BD5FD_206*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_GETAREAQUESTINFO_OFFSET))(areaTemplate);
		}

		static ::System::Boolean IsSideQuestInArea(::System::Int32 questID, ::Class_2_534AF681CC2BD5FD_206* areaTemplate)
		{
			return ((::System::Boolean(*)(::System::Int32, ::Class_2_534AF681CC2BD5FD_206*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_ISSIDEQUESTINAREA_OFFSET))(questID, areaTemplate);
		}

		static ::System::Int32 GetQuestPartnerID(::Class_3_C5245CCA4822DD39_10* partnerInfo, ::Class_2_534AF681CC2BD5FD_206* areaTemplate)
		{
			return ((::System::Int32(*)(::Class_3_C5245CCA4822DD39_10*, ::Class_2_534AF681CC2BD5FD_206*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER_GETQUESTPARTNERID_OFFSET))(partnerInfo, areaTemplate);
		}
