...
#define MOLEMOLE_UIHOLLOWCURSEWIDGETCONTROLLER___DELAY_D__6_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x155DAA10)
#define MOLEMOLE_UIHOLLOWCURSEWIDGETCONTROLLER___DELAY_D__6_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x155DABA0)
#define MOLEMOLE_UIHOLLOWCURSEWIDGETCONTROLLER___DELAY_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x155DAC00)
#define MOLEMOLE_UIHOLLOWCURSEWIDGETCONTROLLER___DELAY_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x155DABB0)
#define MOLEMOLE_UIHOLLOWCURSEWIDGETCONTROLLER___DELAY_D__6_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x155DAA00)
#define MOLEMOLE_UIHOLLOWCURSEWIDGETCONTROLLER___DELAY_D__6__CTOR_OFFSET UNITYSDK_OFFSET(0x155DA9F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCurseWidgetController___Delay_d__6_TypeDefinitionIndex = 52359;
