...
#define MOLEMOLE_UIROLESELECTPAGECONTROLLER___C__DISPLAYCLASS85_0__CTOR_OFFSET UNITYSDK_OFFSET(0xEB9C7C0)
#define MOLEMOLE_UIROLESELECTPAGECONTROLLER___C__DISPLAYCLASS85_0__FADEOUTANDCLOSE_B__0_OFFSET UNITYSDK_OFFSET(0xEB9C7D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleSelectPageController___c__DisplayClass85_0_TypeDefinitionIndex = 39208;
