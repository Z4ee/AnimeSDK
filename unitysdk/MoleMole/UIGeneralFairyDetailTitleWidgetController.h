...
#define MOLEMOLE_UIGENERALFAIRYDETAILTITLEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19391800)
#define MOLEMOLE_UIGENERALFAIRYDETAILTITLEWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x19391910)
#define MOLEMOLE_UIGENERALFAIRYDETAILTITLEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19391890)
#define MOLEMOLE_UIGENERALFAIRYDETAILTITLEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x193917A0)
#define MOLEMOLE_UIGENERALFAIRYDETAILTITLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19391A90)
#define MOLEMOLE_UIGENERALFAIRYDETAILTITLEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19391AA0)
#define MOLEMOLE_UIGENERALFAIRYDETAILTITLEWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x19391B30)
#define MOLEMOLE_UIGENERALFAIRYDETAILTITLEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19391BD0)
#define MOLEMOLE_UIGENERALFAIRYDETAILTITLEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19391C60)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralFairyDetailTitleWidgetController_TypeDefinitionIndex = 70223;

	class UIGeneralFairyDetailTitleWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_0096754AC2F6E253_27* _view; // 0x2F0
