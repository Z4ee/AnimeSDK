...
#define MOLEMOLE_PIPELINECAMERATIMELINETRANSFORMCALCULATOR_PROCESSS_OFFSET UNITYSDK_OFFSET(0x1792A500)
#define MOLEMOLE_PIPELINECAMERATIMELINETRANSFORMCALCULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1792A840)
#define MOLEMOLE_PIPELINECAMERATIMELINETRANSFORMCALCULATOR___BASE_PROCESSS_OFFSET UNITYSDK_OFFSET(0x1792A850)

namespace MoleMole
{
	inline static constexpr unsigned int PipelineCameraTimelineTransformCalculator_TypeDefinitionIndex = 61038;
