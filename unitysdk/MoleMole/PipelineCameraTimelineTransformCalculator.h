...
#define MOLEMOLE_PIPELINECAMERATIMELINETRANSFORMCALCULATOR_PROCESSS_OFFSET UNITYSDK_OFFSET(0x10BE5FF0)
#define MOLEMOLE_PIPELINECAMERATIMELINETRANSFORMCALCULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x10BE6330)
#define MOLEMOLE_PIPELINECAMERATIMELINETRANSFORMCALCULATOR___BASE_PROCESSS_OFFSET UNITYSDK_OFFSET(0x10BE6340)

namespace MoleMole
{
	inline static constexpr unsigned int PipelineCameraTimelineTransformCalculator_TypeDefinitionIndex = 80049;
