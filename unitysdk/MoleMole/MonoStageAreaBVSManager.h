...
#define MOLEMOLE_MONOSTAGEAREABVSMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0x15851AC0)
#define MOLEMOLE_MONOSTAGEAREABVSMANAGER_CURRENTBOUNDVALID_OFFSET UNITYSDK_OFFSET(0x15852080)
#define MOLEMOLE_MONOSTAGEAREABVSMANAGER_ISINCURRENTBOUND_OFFSET UNITYSDK_OFFSET(0x158520C0)
#define MOLEMOLE_MONOSTAGEAREABVSMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x15852140)
#define MOLEMOLE_MONOSTAGEAREABVSMANAGER_START_OFFSET UNITYSDK_OFFSET(0x15851B10)
#define MOLEMOLE_MONOSTAGEAREABVSMANAGER_UPDATECURRENTBOUND_OFFSET UNITYSDK_OFFSET(0x15851EA0)
#define MOLEMOLE_MONOSTAGEAREABVSMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x15852190)

namespace MoleMole
{
	inline static constexpr unsigned int MonoStageAreaBVSManager_TypeDefinitionIndex = 39849;
	...
	public:
		...
		{
			return (::MoleMole::MonoStageAreaBVSManager**)Il2CppClass::FromTypeDefinitionIndex(MonoStageAreaBVSManager_TypeDefinitionIndex)->GetStaticField(0x47E10);
		}
