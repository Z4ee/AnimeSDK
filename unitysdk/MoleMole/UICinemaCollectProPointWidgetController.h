...
#define MOLEMOLE_UICINEMACOLLECTPROPOINTWIDGETCONTROLLER_ONCLICKBUTTON_OFFSET UNITYSDK_OFFSET(0x18560A70)
#define MOLEMOLE_UICINEMACOLLECTPROPOINTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18560960)
#define MOLEMOLE_UICINEMACOLLECTPROPOINTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x185609F0)
#define MOLEMOLE_UICINEMACOLLECTPROPOINTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x185604F0)
#define MOLEMOLE_UICINEMACOLLECTPROPOINTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18560550)
#define MOLEMOLE_UICINEMACOLLECTPROPOINTWIDGETCONTROLLER_REFRESHITEMSTATE_OFFSET UNITYSDK_OFFSET(0x18560640)
#define MOLEMOLE_UICINEMACOLLECTPROPOINTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18560BE0)
#define MOLEMOLE_UICINEMACOLLECTPROPOINTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18560C40)
#define MOLEMOLE_UICINEMACOLLECTPROPOINTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18560CD0)
#define MOLEMOLE_UICINEMACOLLECTPROPOINTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18560D60)
#define MOLEMOLE_UICINEMACOLLECTPROPOINTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18560DF0)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaCollectProPointWidgetController_TypeDefinitionIndex = 68423;

	class UICinemaCollectProPointWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_C5C76936C9D491E6* _view; // 0x2C0
