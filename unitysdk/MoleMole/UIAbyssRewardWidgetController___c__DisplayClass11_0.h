...
#define MOLEMOLE_UIABYSSREWARDWIDGETCONTROLLER___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x141D3920)
#define MOLEMOLE_UIABYSSREWARDWIDGETCONTROLLER___C__DISPLAYCLASS11_0__ONSCROLLITEMUPDATE_B__0_OFFSET UNITYSDK_OFFSET(0x141D3930)
#define MOLEMOLE_UIABYSSREWARDWIDGETCONTROLLER___C__DISPLAYCLASS11_0__ONSCROLLITEMUPDATE_B__1_OFFSET UNITYSDK_OFFSET(0x141D39B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssRewardWidgetController___c__DisplayClass11_0_TypeDefinitionIndex = 66622;
