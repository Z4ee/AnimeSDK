...
#define MOLEMOLE_MONOSHOOTINGWAVE_CLASS_1_575928BF31B9DC17_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x158518A0)
#define MOLEMOLE_MONOSHOOTINGWAVE_CLASS_1_575928BF31B9DC17_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15851A50)
#define MOLEMOLE_MONOSHOOTINGWAVE_CLASS_1_575928BF31B9DC17_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15851AB0)
#define MOLEMOLE_MONOSHOOTINGWAVE_CLASS_1_575928BF31B9DC17_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x15851A60)
#define MOLEMOLE_MONOSHOOTINGWAVE_CLASS_1_575928BF31B9DC17_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15851890)
#define MOLEMOLE_MONOSHOOTINGWAVE_CLASS_1_575928BF31B9DC17__CTOR_OFFSET UNITYSDK_OFFSET(0x15851880)

namespace MoleMole
{
	inline static constexpr unsigned int MonoShootingWave_Class_1_575928BF31B9DC17_TypeDefinitionIndex = 43518;

	class MonoShootingWave_Class_1_575928BF31B9DC17 : public ::System::Object
	{
	public:
		::MoleMole::MonoShootingWave* Field_1_2; // 0x10
