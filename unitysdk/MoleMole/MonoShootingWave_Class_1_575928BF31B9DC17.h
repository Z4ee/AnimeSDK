...
#define MOLEMOLE_MONOSHOOTINGWAVE_CLASS_1_575928BF31B9DC17_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19976BF0)
#define MOLEMOLE_MONOSHOOTINGWAVE_CLASS_1_575928BF31B9DC17_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19976DB0)
#define MOLEMOLE_MONOSHOOTINGWAVE_CLASS_1_575928BF31B9DC17_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19976E10)
#define MOLEMOLE_MONOSHOOTINGWAVE_CLASS_1_575928BF31B9DC17_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19976DC0)
#define MOLEMOLE_MONOSHOOTINGWAVE_CLASS_1_575928BF31B9DC17_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19976BE0)
#define MOLEMOLE_MONOSHOOTINGWAVE_CLASS_1_575928BF31B9DC17__CTOR_OFFSET UNITYSDK_OFFSET(0x19976BD0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoShootingWave_Class_1_575928BF31B9DC17_TypeDefinitionIndex = 48234;

	class MonoShootingWave_Class_1_575928BF31B9DC17 : public ::System::Object
	{
	public:
		::System::Object* Field_1_2; // 0x10
		::MoleMole::MonoShootingWave* Field_1_1; // 0x18
