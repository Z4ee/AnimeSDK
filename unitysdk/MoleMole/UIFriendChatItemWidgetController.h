...
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_GET__MODEL_OFFSET UNITYSDK_OFFSET(0x186B6D30)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x186B7010)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_ONITEMRESELECT_OFFSET UNITYSDK_OFFSET(0x186B7360)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x186B7280)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x186B74E0)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_ONSWITCHCIRCLEMUTEMSGBTN_OFFSET UNITYSDK_OFFSET(0x186B6DF0)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_ONSWITCHFRIENDMUTEMSGBTN_OFFSET UNITYSDK_OFFSET(0x186B6BD0)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x186B7460)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x186B6920)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_REFRESHPCSELECTSTATE_OFFSET UNITYSDK_OFFSET(0x186B7100)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_REFRESHSELECTSTATE_OFFSET UNITYSDK_OFFSET(0x186B70A0)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_SHOWCIRCLEUIELEMENT_OFFSET UNITYSDK_OFFSET(0x186B87D0)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_SHOWCIRCLEUI_OFFSET UNITYSDK_OFFSET(0x186B7DD0)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_SHOWEMPTY_OFFSET UNITYSDK_OFFSET(0x186B76D0)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_SHOWFRIENDUIELEMENT_OFFSET UNITYSDK_OFFSET(0x186B8900)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_SHOWFRIENDUI_OFFSET UNITYSDK_OFFSET(0x186B77F0)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_SHOWUSERDATA_OFFSET UNITYSDK_OFFSET(0x186B7760)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x186B89B0)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x186B89C0)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER___BASE_ONITEMRESELECT_OFFSET UNITYSDK_OFFSET(0x186B8A50)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x186B8AE0)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x186B8B70)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x186B8C10)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x186B8CA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendChatItemWidgetController_TypeDefinitionIndex = 61957;

	class UIFriendChatItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_15* _view; // 0x2F0
