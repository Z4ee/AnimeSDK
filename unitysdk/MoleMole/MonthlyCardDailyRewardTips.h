...
#define MOLEMOLE_MONTHLYCARDDAILYREWARDTIPS_GET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x15B45A30)
#define MOLEMOLE_MONTHLYCARDDAILYREWARDTIPS_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x15B45A20)
#define MOLEMOLE_MONTHLYCARDDAILYREWARDTIPS_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x15B45B20)
#define MOLEMOLE_MONTHLYCARDDAILYREWARDTIPS_SETPOPPRIORITY_OFFSET UNITYSDK_OFFSET(0x15B45AD0)
#define MOLEMOLE_MONTHLYCARDDAILYREWARDTIPS__CTOR_OFFSET UNITYSDK_OFFSET(0x15B45AC0)

namespace MoleMole
{
	inline static constexpr unsigned int MonthlyCardDailyRewardTips_TypeDefinitionIndex = 50311;
