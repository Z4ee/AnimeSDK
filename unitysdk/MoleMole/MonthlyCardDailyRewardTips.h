...
#define MOLEMOLE_MONTHLYCARDDAILYREWARDTIPS_GET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x190A0CE0)
#define MOLEMOLE_MONTHLYCARDDAILYREWARDTIPS_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x190A0CD0)
#define MOLEMOLE_MONTHLYCARDDAILYREWARDTIPS_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x190A0DD0)
#define MOLEMOLE_MONTHLYCARDDAILYREWARDTIPS_SETPOPPRIORITY_OFFSET UNITYSDK_OFFSET(0x190A0D80)
#define MOLEMOLE_MONTHLYCARDDAILYREWARDTIPS__CTOR_OFFSET UNITYSDK_OFFSET(0x190A0D70)

namespace MoleMole
{
	inline static constexpr unsigned int MonthlyCardDailyRewardTips_TypeDefinitionIndex = 78060;
