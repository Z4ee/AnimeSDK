...
#define MOLEMOLE_MONOQTEBTNCOUNTDOWN_PLAYQTEFADEINOVERANIMEVENT_OFFSET UNITYSDK_OFFSET(0x17DD7590)
#define MOLEMOLE_MONOQTEBTNCOUNTDOWN_PLAYQTEFADEOUTOVERANIMEVENT_OFFSET UNITYSDK_OFFSET(0x17DD7710)
#define MOLEMOLE_MONOQTEBTNCOUNTDOWN_PLAYQTETWEENBARANIMEVENT_OFFSET UNITYSDK_OFFSET(0x17DD73F0)
#define MOLEMOLE_MONOQTEBTNCOUNTDOWN_SETMONOQTESWITCHAVATARPANEL_OFFSET UNITYSDK_OFFSET(0x17DD73A0)
#define MOLEMOLE_MONOQTEBTNCOUNTDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x17DD78B0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoQTEBtnCountdown_TypeDefinitionIndex = 44389;
