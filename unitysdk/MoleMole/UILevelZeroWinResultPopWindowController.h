...
#define MOLEMOLE_UILEVELZEROWINRESULTPOPWINDOWCONTROLLER_ACQUIRETITLETEXT_OFFSET UNITYSDK_OFFSET(0x14B88510)
#define MOLEMOLE_UILEVELZEROWINRESULTPOPWINDOWCONTROLLER_GETBUTTONCOMBINESTATE_OFFSET UNITYSDK_OFFSET(0x14B88430)
#define MOLEMOLE_UILEVELZEROWINRESULTPOPWINDOWCONTROLLER_GETPANELSTATE_OFFSET UNITYSDK_OFFSET(0x14B88480)
#define MOLEMOLE_UILEVELZEROWINRESULTPOPWINDOWCONTROLLER_ONPOPSHOWED_OFFSET UNITYSDK_OFFSET(0x14B884D0)
#define MOLEMOLE_UILEVELZEROWINRESULTPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14B885E0)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelZeroWinResultPopWindowController_TypeDefinitionIndex = 49910;
	...
	public:
		...
		{
			return ((::Class_1_451601B8BB62C38C_Enum_3_A188519F532ACB95(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UILEVELZEROWINRESULTPOPWINDOWCONTROLLER_GETPANELSTATE_OFFSET))(this);
		}
