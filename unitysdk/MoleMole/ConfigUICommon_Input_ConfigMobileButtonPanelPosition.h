...
#define MOLEMOLE_CONFIGUICOMMON_INPUT_CONFIGMOBILEBUTTONPANELPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B21DE10)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUICommon_Input_ConfigMobileButtonPanelPosition_TypeDefinitionIndex = 61660;
