...
#define MOLEMOLE_CONFIGUICOMMON_INPUT_CONFIGMOBILEBUTTONPANELPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C528F70)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUICommon_Input_ConfigMobileButtonPanelPosition_TypeDefinitionIndex = 91100;
