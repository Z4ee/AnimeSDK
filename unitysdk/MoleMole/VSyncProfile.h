...
#define MOLEMOLE_VSYNCPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x14DA85B0)
#define MOLEMOLE_VSYNCPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x14DA86F0)
#define MOLEMOLE_VSYNCPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x14DA84D0)
#define MOLEMOLE_VSYNCPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x14DA8670)
#define MOLEMOLE_VSYNCPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x14DA84C0)
#define MOLEMOLE_VSYNCPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x14DA8810)
#define MOLEMOLE_VSYNCPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x14DA88A0)
#define MOLEMOLE_VSYNCPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x14DA8930)
#define MOLEMOLE_VSYNCPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x14DA89C0)

namespace MoleMole
{
	inline static constexpr unsigned int VSyncProfile_TypeDefinitionIndex = 46273;
