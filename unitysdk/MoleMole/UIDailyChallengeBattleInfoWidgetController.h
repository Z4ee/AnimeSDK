...
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER_ADDITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x152FE790)
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER_FILLCARDLIST_OFFSET UNITYSDK_OFFSET(0x152FE090)
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER_FILLREWARDMAP_OFFSET UNITYSDK_OFFSET(0x152FE1F0)
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER_GETMACHINELEVELID_OFFSET UNITYSDK_OFFSET(0x152FDF50)
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0x152FDAD0)
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x152FE840)
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER__GETPROGRESS_G__GETCURPROGRESS_0_0_OFFSET UNITYSDK_OFFSET(0x152FDD30)
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER__GETPROGRESS_G__GETTOTALNUM_0_1_OFFSET UNITYSDK_OFFSET(0x152FDE30)
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER___BASE_GETMACHINELEVELID_OFFSET UNITYSDK_OFFSET(0x152FE850)
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER___BASE_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0x152FE8E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIDailyChallengeBattleInfoWidgetController_TypeDefinitionIndex = 68689;
