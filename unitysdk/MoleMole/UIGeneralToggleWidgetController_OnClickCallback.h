...
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER_ONCLICKCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A31A070)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER_ONCLICKCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A31A100)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER_ONCLICKCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A3199D0)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER_ONCLICKCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A31A050)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralToggleWidgetController_OnClickCallback_TypeDefinitionIndex = 89479;
