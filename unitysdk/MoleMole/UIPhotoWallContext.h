...
#define MOLEMOLE_UIPHOTOWALLCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15295670)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoWallContext_TypeDefinitionIndex = 61468;
