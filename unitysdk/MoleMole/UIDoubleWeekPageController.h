...
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_BINDNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x15E7EAC0)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_DOREFRESHBINGOFORSINGLEGRID_OFFSET UNITYSDK_OFFSET(0x15E80B30)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x15E7EAB0)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15E7D690)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x15E7D850)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15E7D6A0)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_ONITEMCHANGED_OFFSET UNITYSDK_OFFSET(0x15E7F440)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_ONSELECTGRID_OFFSET UNITYSDK_OFFSET(0x15E7F5C0)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15E7E550)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_ONTAKEGRIDREWARDS_OFFSET UNITYSDK_OFFSET(0x15E81230)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_ONTAKESCOREREWARDS_OFFSET UNITYSDK_OFFSET(0x15E811E0)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15E7DFF0)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15E7D800)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15E7E450)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_OPENINFO_OFFSET UNITYSDK_OFFSET(0x15E80330)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_REFRESHBINGOFORGRID_OFFSET UNITYSDK_OFFSET(0x15E80530)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_REFRESHBINGOTARGET_OFFSET UNITYSDK_OFFSET(0x15E7F490)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_REFRESHCURRENCY_OFFSET UNITYSDK_OFFSET(0x15E7F130)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_REFRESHGRIDS_OFFSET UNITYSDK_OFFSET(0x15E7EC70)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_REFRESHSCORE_OFFSET UNITYSDK_OFFSET(0x15E7EBF0)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x15E7E5B0)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x15E7E4C0)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_TAKEALLGRIDREWARDS_OFFSET UNITYSDK_OFFSET(0x15E80FA0)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_TRYTAKESPECIALREWARDS_OFFSET UNITYSDK_OFFSET(0x15E7E070)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15E81290)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER__INITVIEW_B__11_1_OFFSET UNITYSDK_OFFSET(0x15E812A0)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER__INITVIEW_B__11_2_OFFSET UNITYSDK_OFFSET(0x15E81300)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER__INITVIEW_B__11_3_OFFSET UNITYSDK_OFFSET(0x15E81350)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER__INITVIEW_B__11_4_OFFSET UNITYSDK_OFFSET(0x15E813C0)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15E813D0)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15E81460)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15E81470)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15E81480)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15E81490)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x15E81520)

namespace MoleMole
{
	inline static constexpr unsigned int UIDoubleWeekPageController_TypeDefinitionIndex = 52186;

	class UIDoubleWeekPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_60638234271CCDB8_78* _view; // 0x318
		::Class_2_80EC5A94E858E47B* _integralRewardHandler; // 0x320
		::System::Collections::Generic::List_1<::Class_3_31FA216B8128BBFD_5*>* _grids; // 0x328
