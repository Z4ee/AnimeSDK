...
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER__ONRESET_D__17_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x170B7CF0)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER__ONRESET_D__17_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x170B8050)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER__ONRESET_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x170B80B0)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER__ONRESET_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x170B8060)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER__ONRESET_D__17_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x170B7CE0)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER__ONRESET_D__17__CTOR_OFFSET UNITYSDK_OFFSET(0x170B7CD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIDataFixOuterRenderWidgetController__OnReset_d__17_TypeDefinitionIndex = 58414;
	...
	public:
		...
		::System::Single _ratio_5__5; // 0x20
		::System::Single _panelEndY_5__3; // 0x24
		::System::Single _panelStartY_5__2; // 0x28
		::System::Int32 _i_5__6; // 0x2C
