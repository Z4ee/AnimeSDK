...
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_V3CURVE_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x3E3D10)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_V3CURVE_GET_STARTVALUE_OFFSET UNITYSDK_OFFSET(0x412DC0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_V3CURVE_GET_STOPVALUE_OFFSET UNITYSDK_OFFSET(0x7CF3B0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_V3CURVE_METHOD_2_2C825E716CE9F2F9_OFFSET UNITYSDK_OFFSET(0x7CF510)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_V3CURVE_METHOD_2_B4859502A23E740B_OFFSET UNITYSDK_OFFSET(0x1418FF50)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_V3CURVE_METHOD_2_DF64B90BA25AAE64_OFFSET UNITYSDK_OFFSET(0x7CF3E0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_V3CURVE_SET_DURATION_OFFSET UNITYSDK_OFFSET(0x775AF0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_V3CURVE_SET_STARTVALUE_OFFSET UNITYSDK_OFFSET(0x7CF3A0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_V3CURVE_SET_STOPVALUE_OFFSET UNITYSDK_OFFSET(0x7CF3D0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginAttachToCamera_V3Curve_TypeDefinitionIndex = 51511;
