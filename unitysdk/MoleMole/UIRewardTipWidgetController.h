...
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x179B1BE0)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x179B1EC0)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x179B1F50)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x179B1BF0)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x179B1E50)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER_REFRESHUI_OFFSET UNITYSDK_OFFSET(0x179B2120)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER_SETANIMMOVE_OFFSET UNITYSDK_OFFSET(0x179B2570)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER__CALLDELAYCLOSE_OFFSET UNITYSDK_OFFSET(0x179B2390)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x179B27E0)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER__ONDELAYCALLBACK_OFFSET UNITYSDK_OFFSET(0x179B2490)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER__SETANIMMOVE_B__24_0_OFFSET UNITYSDK_OFFSET(0x179B28C0)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER__SETANIMMOVE_B__24_1_OFFSET UNITYSDK_OFFSET(0x179B2B40)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x179B2D30)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x179B2DC0)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x179B2E50)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x179B2EE0)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER___ONDELAYCALLBACK_B__23_0_OFFSET UNITYSDK_OFFSET(0x179B28A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRewardTipWidgetController_TypeDefinitionIndex = 83963;

	class UIRewardTipWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_75FB4A09078427E5_1* _view; // 0x2C0
		::System::Single _waitingTime; // 0x2C8
		::System::Boolean _isFinished; // 0x2CC
		::System::Boolean _isInDelaying; // 0x2CD
		::System::Single _waitingMarkTime; // 0x2D0
		::System::Boolean isFirstEnter; // 0x2D4
		::UnityEngine::Vector2 startAnchorPos; // 0x2D8
		::UnityEngine::Vector2 targetAnchorPos; // 0x2E0
		::UnityEngine::AnimationCurve* motionCurve; // 0x2E8
		::System::Single totalTime; // 0x2F0
		::System::Single passTime; // 0x2F4
		::UnityEngine::RectTransform* rectTrans; // 0x2F8
		::Foundation::Coroutine::CoroutineHandle moveCoroutine; // 0x300
		::System::Action* OnFnish; // 0x308
		::Class_1_C4CB11A2FD957208_Class_1_A983ED79C549CB78* _prevItem; // 0x310
