...
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x16683AC0)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16683DA0)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16683E30)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16683AD0)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16683D30)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER_REFRESHUI_OFFSET UNITYSDK_OFFSET(0x16684000)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER_SETANIMMOVE_OFFSET UNITYSDK_OFFSET(0x16684450)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER__CALLDELAYCLOSE_OFFSET UNITYSDK_OFFSET(0x16684270)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x166846B0)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER__ONDELAYCALLBACK_OFFSET UNITYSDK_OFFSET(0x16684370)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER__SETANIMMOVE_B__24_0_OFFSET UNITYSDK_OFFSET(0x16684790)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER__SETANIMMOVE_B__24_1_OFFSET UNITYSDK_OFFSET(0x16684A10)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16684C00)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16684C90)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16684D20)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16684DB0)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER___ONDELAYCALLBACK_B__23_0_OFFSET UNITYSDK_OFFSET(0x16684770)

namespace MoleMole
{
	inline static constexpr unsigned int UIRewardTipWidgetController_TypeDefinitionIndex = 52369;

	class UIRewardTipWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_75FB4A09078427E5_3* _view; // 0x2C0
