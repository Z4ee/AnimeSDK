...
#define MOLEMOLE_SUIBIANTEMPLEMANAGEDETAILCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x125F3380)

namespace MoleMole
{
	inline static constexpr unsigned int SuibianTempleManageDetailContext_TypeDefinitionIndex = 53542;
