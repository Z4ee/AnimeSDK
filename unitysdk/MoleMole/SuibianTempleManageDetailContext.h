...
#define MOLEMOLE_SUIBIANTEMPLEMANAGEDETAILCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1304AD00)

namespace MoleMole
{
	inline static constexpr unsigned int SuibianTempleManageDetailContext_TypeDefinitionIndex = 85244;
