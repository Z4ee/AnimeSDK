...
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER___C__DISPLAYCLASS48_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16E875F0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER___C__DISPLAYCLASS48_0__INITVIDEOPLAYER_B__0_OFFSET UNITYSDK_OFFSET(0x16E87600)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER___C__DISPLAYCLASS48_0__INITVIDEOPLAYER_G__INVOKEPREPARED_1_OFFSET UNITYSDK_OFFSET(0x16E87920)

namespace MoleMole
{
	inline static constexpr unsigned int UILoadingTransferPopWindowController___c__DisplayClass48_0_TypeDefinitionIndex = 67540;
	...
	public:
		...
		::MoleMole::UILoadingTransferPopWindowController* __4__this; // 0x18
