...
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER__LOADNXTLEVELFAKELOADINGVIEW_D__302_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x190F18E0)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER__LOADNXTLEVELFAKELOADINGVIEW_D__302_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x190F1C00)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER__LOADNXTLEVELFAKELOADINGVIEW_D__302_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x190F1C60)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER__LOADNXTLEVELFAKELOADINGVIEW_D__302_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x190F1C10)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER__LOADNXTLEVELFAKELOADINGVIEW_D__302_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x190F18D0)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER__LOADNXTLEVELFAKELOADINGVIEW_D__302__CTOR_OFFSET UNITYSDK_OFFSET(0x190F18C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMainPageController__LoadNxtLevelFakeLoadingView_d__302_TypeDefinitionIndex = 73679;
