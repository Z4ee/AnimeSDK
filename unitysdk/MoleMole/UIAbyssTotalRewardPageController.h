...
#define MOLEMOLE_UIABYSSTOTALREWARDPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x17A2FB60)
#define MOLEMOLE_UIABYSSTOTALREWARDPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17A2FB70)
#define MOLEMOLE_UIABYSSTOTALREWARDPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17A2FBE0)
#define MOLEMOLE_UIABYSSTOTALREWARDPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17A2FEB0)
#define MOLEMOLE_UIABYSSTOTALREWARDPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17A2FF60)
#define MOLEMOLE_UIABYSSTOTALREWARDPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17A2FC80)
#define MOLEMOLE_UIABYSSTOTALREWARDPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17A30060)
#define MOLEMOLE_UIABYSSTOTALREWARDPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17A30070)
#define MOLEMOLE_UIABYSSTOTALREWARDPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17A30110)
#define MOLEMOLE_UIABYSSTOTALREWARDPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17A30120)
#define MOLEMOLE_UIABYSSTOTALREWARDPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17A301E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssTotalRewardPageController_TypeDefinitionIndex = 84750;
