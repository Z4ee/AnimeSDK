...
#define MOLEMOLE_UIMAINCITYACTIONTIPSWIDGETCONTROLLER_ONAFTERPARENTSHOW_OFFSET UNITYSDK_OFFSET(0x160B82D0)
#define MOLEMOLE_UIMAINCITYACTIONTIPSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x160B8240)
#define MOLEMOLE_UIMAINCITYACTIONTIPSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x160B8340)
#define MOLEMOLE_UIMAINCITYACTIONTIPSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x160B8170)
#define MOLEMOLE_UIMAINCITYACTIONTIPSWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x160B81D0)
#define MOLEMOLE_UIMAINCITYACTIONTIPSWIDGETCONTROLLER_REFRESHVIEWANDSHOW_OFFSET UNITYSDK_OFFSET(0x160B83C0)
#define MOLEMOLE_UIMAINCITYACTIONTIPSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x160B8580)
#define MOLEMOLE_UIMAINCITYACTIONTIPSWIDGETCONTROLLER__REFRESHVIEWANDSHOW_B__8_0_OFFSET UNITYSDK_OFFSET(0x160B85E0)
#define MOLEMOLE_UIMAINCITYACTIONTIPSWIDGETCONTROLLER___BASE_ONAFTERPARENTSHOW_OFFSET UNITYSDK_OFFSET(0x160B8690)
#define MOLEMOLE_UIMAINCITYACTIONTIPSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x160B8720)
#define MOLEMOLE_UIMAINCITYACTIONTIPSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x160B87B0)
#define MOLEMOLE_UIMAINCITYACTIONTIPSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x160B8840)
#define MOLEMOLE_UIMAINCITYACTIONTIPSWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x160B88D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityActionTipsWidgetController_TypeDefinitionIndex = 71795;

	class UIMainCityActionTipsWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_0096754AC2F6E253_40* _view; // 0x2B8
		::Enum_3_ECA55F8CE94C29A8 _curState; // 0x2C0
