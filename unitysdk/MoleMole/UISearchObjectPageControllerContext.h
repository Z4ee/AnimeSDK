...
#define MOLEMOLE_UISEARCHOBJECTPAGECONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x17E528A0)

namespace MoleMole
{
	inline static constexpr unsigned int UISearchObjectPageControllerContext_TypeDefinitionIndex = 81632;
