...
#define MOLEMOLE_INLEVELBANGBOOSKILLGAMEPADBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x10BC5BB0)
#define MOLEMOLE_INLEVELBANGBOOSKILLGAMEPADBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x10BC5BC0)
#define MOLEMOLE_INLEVELBANGBOOSKILLGAMEPADBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x10BC5BD0)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelBangbooSkillGamepadBindingSettingEntry_TypeDefinitionIndex = 66626;
