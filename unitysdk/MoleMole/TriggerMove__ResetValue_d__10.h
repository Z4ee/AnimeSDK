...
#define MOLEMOLE_TRIGGERMOVE__RESETVALUE_D__10_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x161040A0)
#define MOLEMOLE_TRIGGERMOVE__RESETVALUE_D__10_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16104140)
#define MOLEMOLE_TRIGGERMOVE__RESETVALUE_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x161041A0)
#define MOLEMOLE_TRIGGERMOVE__RESETVALUE_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x16104150)
#define MOLEMOLE_TRIGGERMOVE__RESETVALUE_D__10_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16104090)
#define MOLEMOLE_TRIGGERMOVE__RESETVALUE_D__10__CTOR_OFFSET UNITYSDK_OFFSET(0x16104080)

namespace MoleMole
{
	inline static constexpr unsigned int TriggerMove__ResetValue_d__10_TypeDefinitionIndex = 83072;
