...
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_LOGIC_GETISCDFUNC_OFFSET UNITYSDK_OFFSET(0xF62BBC0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_LOGIC_GETISMULTISELECTFULLFUNC_OFFSET UNITYSDK_OFFSET(0xF62BB80)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_LOGIC_GETISSELECTEDVHSCOLLECTIONFUNC_OFFSET UNITYSDK_OFFSET(0xF62BB40)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_LOGIC_OKBTNISINTERACTABLE_OFFSET UNITYSDK_OFFSET(0xF62BA10)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_LOGIC_OKBTNTEXTMAPKEY_OFFSET UNITYSDK_OFFSET(0xF62BA50)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_LOGIC_ONOKBTNCLICK_OFFSET UNITYSDK_OFFSET(0xF62BB00)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_LOGIC_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xF62B9D0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_LOGIC_REFRESHTAGSPREVIEW_OFFSET UNITYSDK_OFFSET(0xF62BAC0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_LOGIC__CTOR_OFFSET UNITYSDK_OFFSET(0xF62B9C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSStoreDialogV2PopWindowController_Logic_TypeDefinitionIndex = 67893;
