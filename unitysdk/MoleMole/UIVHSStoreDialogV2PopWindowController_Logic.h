...
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_LOGIC_GETISCDFUNC_OFFSET UNITYSDK_OFFSET(0x11A05A20)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_LOGIC_GETISMULTISELECTFULLFUNC_OFFSET UNITYSDK_OFFSET(0x11A059E0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_LOGIC_GETISSELECTEDVHSCOLLECTIONFUNC_OFFSET UNITYSDK_OFFSET(0x11A059A0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_LOGIC_OKBTNISINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x11A05870)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_LOGIC_OKBTNTEXTMAPKEY_OFFSET UNITYSDK_OFFSET(0x11A058B0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_LOGIC_ONOKBTNCLICK_OFFSET UNITYSDK_OFFSET(0x11A05960)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_LOGIC_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x11A05830)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_LOGIC_REFRESHTAGSPREVIEW_OFFSET UNITYSDK_OFFSET(0x11A05920)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_LOGIC__CTOR_OFFSET UNITYSDK_OFFSET(0x11A05820)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSStoreDialogV2PopWindowController_Logic_TypeDefinitionIndex = 55342;
