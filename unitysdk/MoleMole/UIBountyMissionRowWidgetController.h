...
#define MOLEMOLE_UIBOUNTYMISSIONROWWIDGETCONTROLLER_ONCLICKCHALLENGEBTN_OFFSET UNITYSDK_OFFSET(0x15B59DA0)
#define MOLEMOLE_UIBOUNTYMISSIONROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15B58E40)
#define MOLEMOLE_UIBOUNTYMISSIONROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15B58F50)
#define MOLEMOLE_UIBOUNTYMISSIONROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15B58ED0)
#define MOLEMOLE_UIBOUNTYMISSIONROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15B58C70)
#define MOLEMOLE_UIBOUNTYMISSIONROWWIDGETCONTROLLER_SENDRESETPHOTOMAINCITYQUEST_OFFSET UNITYSDK_OFFSET(0x15B5A190)
#define MOLEMOLE_UIBOUNTYMISSIONROWWIDGETCONTROLLER_SHOWGRADEINFO_OFFSET UNITYSDK_OFFSET(0x15B594A0)
#define MOLEMOLE_UIBOUNTYMISSIONROWWIDGETCONTROLLER_SHOWQUESTSTATE_OFFSET UNITYSDK_OFFSET(0x15B59B50)
#define MOLEMOLE_UIBOUNTYMISSIONROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15B5A3D0)
#define MOLEMOLE_UIBOUNTYMISSIONROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15B5A3E0)
#define MOLEMOLE_UIBOUNTYMISSIONROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15B5A470)
#define MOLEMOLE_UIBOUNTYMISSIONROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15B5A510)
#define MOLEMOLE_UIBOUNTYMISSIONROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15B5A5A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBountyMissionRowWidgetController_TypeDefinitionIndex = 53000;
	...
	public:
		...
		::Class_2_70814665657ACDC9* _model; // 0x308
