...
#define MOLEMOLE_UICINEMAPLAYBUBBLE04WIDGETCONTROLLER_DOWIDGETHIDE_OFFSET UNITYSDK_OFFSET(0x15E6E9E0)
#define MOLEMOLE_UICINEMAPLAYBUBBLE04WIDGETCONTROLLER_GETVIEW_OFFSET UNITYSDK_OFFSET(0x15E6E7F0)
#define MOLEMOLE_UICINEMAPLAYBUBBLE04WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15E6E6E0)
#define MOLEMOLE_UICINEMAPLAYBUBBLE04WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15E6E770)
#define MOLEMOLE_UICINEMAPLAYBUBBLE04WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15E6E610)
#define MOLEMOLE_UICINEMAPLAYBUBBLE04WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15E6E670)
#define MOLEMOLE_UICINEMAPLAYBUBBLE04WIDGETCONTROLLER_PLAYBUBBLEANIMATION_OFFSET UNITYSDK_OFFSET(0x15E6E840)
#define MOLEMOLE_UICINEMAPLAYBUBBLE04WIDGETCONTROLLER_PLAYRIGHTSTATEANIMATION_OFFSET UNITYSDK_OFFSET(0x15E6E8D0)
#define MOLEMOLE_UICINEMAPLAYBUBBLE04WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15E6EAC0)
#define MOLEMOLE_UICINEMAPLAYBUBBLE04WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15E6EB20)
#define MOLEMOLE_UICINEMAPLAYBUBBLE04WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15E6EBB0)
#define MOLEMOLE_UICINEMAPLAYBUBBLE04WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15E6EC40)
#define MOLEMOLE_UICINEMAPLAYBUBBLE04WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15E6ECD0)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaPlayBubble04WidgetController_TypeDefinitionIndex = 45028;

	class UICinemaPlayBubble04WidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_382A906A6D92F5A5* _view; // 0x2C0
