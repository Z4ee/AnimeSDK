...
#define MOLEMOLE_UIMONSTERFANTASYCURRENTROLEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15166660)
#define MOLEMOLE_UIMONSTERFANTASYCURRENTROLEWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x151666D0)
#define MOLEMOLE_UIMONSTERFANTASYCURRENTROLEWIDGETCONTROLLER_ONUNITTURNSTART_OFFSET UNITYSDK_OFFSET(0x15166F00)
#define MOLEMOLE_UIMONSTERFANTASYCURRENTROLEWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x15166940)
#define MOLEMOLE_UIMONSTERFANTASYCURRENTROLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15167080)
#define MOLEMOLE_UIMONSTERFANTASYCURRENTROLEWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x151670E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyCurrentRoleWidgetController_TypeDefinitionIndex = 87738;
