...
#define MOLEMOLE_UIRECYCLEINFODIALOGPOPWINDOWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18866C60)

namespace MoleMole
{
	inline static constexpr unsigned int UIRecycleInfoDialogPopWindowContext_TypeDefinitionIndex = 48649;
