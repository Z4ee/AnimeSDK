...
#define MOLEMOLE_UIINLEVELAIDATTACKBTNCHILDWINDOWCONTROLLER_UIBUTTONVIEW_GET_BTN_OFFSET UNITYSDK_OFFSET(0x1691C490)
#define MOLEMOLE_UIINLEVELAIDATTACKBTNCHILDWINDOWCONTROLLER_UIBUTTONVIEW_GET_BUTTONAREA_OFFSET UNITYSDK_OFFSET(0x1691C730)
#define MOLEMOLE_UIINLEVELAIDATTACKBTNCHILDWINDOWCONTROLLER_UIBUTTONVIEW_GET_BUTTONROOT_OFFSET UNITYSDK_OFFSET(0x1691C4C0)
#define MOLEMOLE_UIINLEVELAIDATTACKBTNCHILDWINDOWCONTROLLER_UIBUTTONVIEW_GET_MAXDRAGAREA_OFFSET UNITYSDK_OFFSET(0x1691C590)
#define MOLEMOLE_UIINLEVELAIDATTACKBTNCHILDWINDOWCONTROLLER_UIBUTTONVIEW_GET_MINDRAGAREA_OFFSET UNITYSDK_OFFSET(0x1691C660)
#define MOLEMOLE_UIINLEVELAIDATTACKBTNCHILDWINDOWCONTROLLER_UIBUTTONVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1691C800)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelAidAttackBtnChildWindowController_UIButtonView_TypeDefinitionIndex = 58203;
