...
#define MOLEMOLE_SCENESOUNDPORTALDATA_GETOPENINGCENTER_OFFSET UNITYSDK_OFFSET(0x18CFDD20)
#define MOLEMOLE_SCENESOUNDPORTALDATA_GETOPENINGCORNERSWORLD_OFFSET UNITYSDK_OFFSET(0x18CFDDC0)
#define MOLEMOLE_SCENESOUNDPORTALDATA_METHOD_5_992EAF95E88449BA_1_OFFSET UNITYSDK_OFFSET(0x18CFE620)
#define MOLEMOLE_SCENESOUNDPORTALDATA_METHOD_5_992EAF95E88449BA_OFFSET UNITYSDK_OFFSET(0x18CFE3C0)
#define MOLEMOLE_SCENESOUNDPORTALDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18CFE350)

namespace MoleMole
{
	inline static constexpr unsigned int SceneSoundPortalData_TypeDefinitionIndex = 63972;
