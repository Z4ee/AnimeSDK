...
#define MOLEMOLE_CONFIGCHATPLUSTIMELINEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17D6E730)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigChatPlusTimelineData_TypeDefinitionIndex = 79222;
