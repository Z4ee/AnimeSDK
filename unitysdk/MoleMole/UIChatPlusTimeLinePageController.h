...
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_DESTROYEFFECTENTITY_OFFSET UNITYSDK_OFFSET(0x17F61640)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_DESTROYSPEEDUPEFFECTS_OFFSET UNITYSDK_OFFSET(0x17F615C0)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_DOSTARTSKIPCHAT_OFFSET UNITYSDK_OFFSET(0x17F600C0)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_ENSUREEAVESDROPCTRL_OFFSET UNITYSDK_OFFSET(0x17F61C30)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_GET_EAVESDROPCTRL_OFFSET UNITYSDK_OFFSET(0x17F5E9A0)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x17F5E980)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_GET_ISFINISH_OFFSET UNITYSDK_OFFSET(0x17F5E990)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x17F5E970)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_HIDESPEEDUPEFFECTS_OFFSET UNITYSDK_OFFSET(0x17F5FF10)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x17F5F1D0)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_ONCONTINUEBTNDOWN_OFFSET UNITYSDK_OFFSET(0x17F60F50)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_ONCONTINUEBTNUP_OFFSET UNITYSDK_OFFSET(0x17F60FC0)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17F5E9B0)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_ONEAVESDROPOPEN_OFFSET UNITYSDK_OFFSET(0x17F61980)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_ONNORMALGRAPHEXIT_OFFSET UNITYSDK_OFFSET(0x17F602D0)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_ONSPEEDUPBTNCLICK_OFFSET UNITYSDK_OFFSET(0x17F607B0)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17F5F7C0)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17F616E0)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17F5EAB0)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17F5EFC0)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_PLAYCHATPLUSDIALOG_OFFSET UNITYSDK_OFFSET(0x17F61230)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_PLAYTIMELINE_OFFSET UNITYSDK_OFFSET(0x17F605D0)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_REFRESHSKIPBTNINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x17F60250)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_RESTORETIMELINESPEED_OFFSET UNITYSDK_OFFSET(0x17F5FA50)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_SETEFFECTVISIBLE_OFFSET UNITYSDK_OFFSET(0x17F61010)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x17F5EA40)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_SPEEDUPTIMELINE_OFFSET UNITYSDK_OFFSET(0x17F60810)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_STOPSPEEDUP_OFFSET UNITYSDK_OFFSET(0x17F611E0)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER_STOPTIMELINE_OFFSET UNITYSDK_OFFSET(0x17F5FF80)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17F61E40)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER__INITVIEW_B__35_0_OFFSET UNITYSDK_OFFSET(0x17F61EB0)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER__ONUIINIT_B__31_0_OFFSET UNITYSDK_OFFSET(0x17F61EA0)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER__RESTORETIMELINESPEED_B__43_0_OFFSET UNITYSDK_OFFSET(0x17F61EC0)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17F61F20)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17F61FB0)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17F62070)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17F62080)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17F62090)
#define MOLEMOLE_UICHATPLUSTIMELINEPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x17F62120)

namespace MoleMole
{
	inline static constexpr unsigned int UIChatPlusTimeLinePageController_TypeDefinitionIndex = 65460;
	...
	public:
		...
		::MoleMole::ChatPlusTimeLinePlayContext* _plusOpenContext; // 0x3D0
		::System::Action_1<::Class_1_D65512A83CF70AB7*>* _callback; // 0x3D8
		::System::Int64 _currChatUid; // 0x3E0
		::Class_3_A26677E63C832BEF* _normalGraph; // 0x3E8
		::Class_1_76E0C108A0F7FA7D* _chatSkipBtnItem; // 0x3F0
		::System::Boolean _isFinish; // 0x3F8
		::System::String* CurrentTimelineKey; // 0x400
		::Class_2_A944C35C433158AC* _currentTask; // 0x408
		::Class_1_D65512A83CF70AB7* _chatRecordSyncData; // 0x410
		::System::Int32 _endTransitionID; // 0x418
		::System::Int32 _currentDialogInstanceId; // 0x41C
		::System::Boolean _isSpeedUp; // 0x420
		::DG::Tweening::Tween* _speedUpTipFadeTweener; // 0x428
		::System::Boolean _canUseSkip; // 0x430
		::MoleMole::UIInLevelEavesdropChildWindowController* _eavesdropCtrl; // 0x438
		::MoleMole::Battle::Entity* _speedUpEffectEntity1; // 0x440
		::MoleMole::Battle::Entity* _speedUpEffectEntity2; // 0x448
