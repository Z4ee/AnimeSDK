...
#define MOLEMOLE_UIINLEVELSUMMERWIDGETCONTROLLER_DOREFRESHITEMSHOWSTATE_OFFSET UNITYSDK_OFFSET(0x148B38D0)
#define MOLEMOLE_UIINLEVELSUMMERWIDGETCONTROLLER_GET_ITEMFADEIN_OFFSET UNITYSDK_OFFSET(0x148B35F0)
#define MOLEMOLE_UIINLEVELSUMMERWIDGETCONTROLLER_GET_ITEMFADEOUT_OFFSET UNITYSDK_OFFSET(0x148B3640)
#define MOLEMOLE_UIINLEVELSUMMERWIDGETCONTROLLER_GET_ITEMLOOP_OFFSET UNITYSDK_OFFSET(0x148B3630)
#define MOLEMOLE_UIINLEVELSUMMERWIDGETCONTROLLER_GET_LIGHTUPANIM_OFFSET UNITYSDK_OFFSET(0x148B36B0)
#define MOLEMOLE_UIINLEVELSUMMERWIDGETCONTROLLER_GET_LIGHTUPGO_OFFSET UNITYSDK_OFFSET(0x148B36A0)
#define MOLEMOLE_UIINLEVELSUMMERWIDGETCONTROLLER_GET_MAXANIM_OFFSET UNITYSDK_OFFSET(0x148B36E0)
#define MOLEMOLE_UIINLEVELSUMMERWIDGETCONTROLLER_GET_POINTMAXFADEIN_OFFSET UNITYSDK_OFFSET(0x148B3680)
#define MOLEMOLE_UIINLEVELSUMMERWIDGETCONTROLLER_GET_POINTMAXFADEOUT_OFFSET UNITYSDK_OFFSET(0x148B3690)
#define MOLEMOLE_UIINLEVELSUMMERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x148B37C0)
#define MOLEMOLE_UIINLEVELSUMMERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x148B3850)
#define MOLEMOLE_UIINLEVELSUMMERWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x148B36F0)
#define MOLEMOLE_UIINLEVELSUMMERWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x148B3750)
#define MOLEMOLE_UIINLEVELSUMMERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x148B3A60)
#define MOLEMOLE_UIINLEVELSUMMERWIDGETCONTROLLER___BASE_DOREFRESHITEMSHOWSTATE_OFFSET UNITYSDK_OFFSET(0x148B3AC0)
#define MOLEMOLE_UIINLEVELSUMMERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x148B3AD0)
#define MOLEMOLE_UIINLEVELSUMMERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x148B3B60)
#define MOLEMOLE_UIINLEVELSUMMERWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x148B3BF0)
#define MOLEMOLE_UIINLEVELSUMMERWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x148B3C80)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelSummerWidgetController_TypeDefinitionIndex = 51408;

	class UIInLevelSummerWidgetController : public ::MoleMole::UIInLevelLightUpPointsItemControllerBase
	{
	public:
		::Class_2_7AA01DA713CC33A9_2* _view; // 0x2C8
