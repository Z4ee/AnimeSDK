...
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER___WAITBEFOREANIMEXIT_D__26_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x15CEA9B0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER___WAITBEFOREANIMEXIT_D__26_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15CEB040)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER___WAITBEFOREANIMEXIT_D__26_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15CEB0A0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER___WAITBEFOREANIMEXIT_D__26_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x15CEB050)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER___WAITBEFOREANIMEXIT_D__26_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15CEA9A0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER___WAITBEFOREANIMEXIT_D__26__CTOR_OFFSET UNITYSDK_OFFSET(0x15CEA990)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowShopWidgetChildWindowController___WaitBeforeAnimExit_d__26_TypeDefinitionIndex = 51858;

	class UIHollowShopWidgetChildWindowController___WaitBeforeAnimExit_d__26 : public ::System::Object
	{
	public:
		::System::String* nextName; // 0x10
		::MoleMole::UIHollowShopWidgetChildWindowController* __4__this; // 0x18
		::System::Action* onFirstAnimExit; // 0x20
		::System::String* firstName; // 0x28
		::System::Action* onNextAnimEnter; // 0x30
		::System::Boolean _first_5__2; // 0x38
