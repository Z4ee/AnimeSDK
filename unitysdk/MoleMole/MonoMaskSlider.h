...
#define MOLEMOLE_MONOMASKSLIDER_AWAKE_OFFSET UNITYSDK_OFFSET(0x12FA2580)
#define MOLEMOLE_MONOMASKSLIDER_GETRATIO_OFFSET UNITYSDK_OFFSET(0x12FA2A60)
#define MOLEMOLE_MONOMASKSLIDER_INITIALIZED_OFFSET UNITYSDK_OFFSET(0x12FA25D0)
#define MOLEMOLE_MONOMASKSLIDER_UPDATEVALUE_OFFSET UNITYSDK_OFFSET(0x12FA26E0)
#define MOLEMOLE_MONOMASKSLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x12FA2AD0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoMaskSlider_TypeDefinitionIndex = 61991;
