...
#define MOLEMOLE_NEOGOLDENMECHAMODULECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1264E220)

namespace MoleMole
{
	inline static constexpr unsigned int NeoGoldenMechaModuleContext_TypeDefinitionIndex = 77650;
