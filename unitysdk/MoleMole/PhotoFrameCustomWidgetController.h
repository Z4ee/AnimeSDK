...
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_GET_CUSTOMVIEW_OFFSET UNITYSDK_OFFSET(0x18095DA0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x18095E20)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_GET_PHOTOLOGO_CLOUDGAME_OFFSET UNITYSDK_OFFSET(0x18095FA0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_GET_PHOTOLOGO_OFFSET UNITYSDK_OFFSET(0x18095F40)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_GET_STAGENAME_OFFSET UNITYSDK_OFFSET(0x18095E80)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_GET_TEXTID_OFFSET UNITYSDK_OFFSET(0x18095DC0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_GET_VERID_TEXT_OFFSET UNITYSDK_OFFSET(0x18095EE0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18098320)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x18098270)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_ONPHOTOPLAYERINFOCHANGE_OFFSET UNITYSDK_OFFSET(0x18096150)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18096620)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x180982D0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18096000)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x180965B0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_SETPHOTOLOGO_OFFSET UNITYSDK_OFFSET(0x18098370)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_SET_CUSTOMVIEW_OFFSET UNITYSDK_OFFSET(0x18095DB0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_SHOWNICKNAME_OFFSET UNITYSDK_OFFSET(0x18096720)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_SHOWUID_OFFSET UNITYSDK_OFFSET(0x18096BB0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_SHOWWITHCONTEXT_OFFSET UNITYSDK_OFFSET(0x18096FB0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_UPDATEPLAYERINFO_OFFSET UNITYSDK_OFFSET(0x180961B0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18098A80)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18098AE0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x18098AF0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18098B80)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x18098C20)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18098C30)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18098CC0)

namespace MoleMole
{
	inline static constexpr unsigned int PhotoFrameCustomWidgetController_TypeDefinitionIndex = 51101;
