...
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER_CLICKPROPERTY_OFFSET UNITYSDK_OFFSET(0x13410920)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1340FB50)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER_ONCLICKBANGBOO_OFFSET UNITYSDK_OFFSET(0x13410AD0)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1340FB60)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x13410480)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x134107D0)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1340FBF0)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER_REFRESHBUDDYPROPERTYVIEW_OFFSET UNITYSDK_OFFSET(0x13411370)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER_REFRESHBUDDYRT_OFFSET UNITYSDK_OFFSET(0x13411A50)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1340FEC0)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER_RELEASEUIMODELS_OFFSET UNITYSDK_OFFSET(0x134108B0)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x13411DA0)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER__ONUIINIT_B__4_0_OFFSET UNITYSDK_OFFSET(0x13411DB0)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER__REFRESHBUDDYRT_B__11_0_OFFSET UNITYSDK_OFFSET(0x13411E30)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x13411EA0)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x13411F30)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x13411FC0)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x13411FD0)

namespace MoleMole
{
	inline static constexpr unsigned int UITowerDefenseBangbooPageController_TypeDefinitionIndex = 54754;

	class UITowerDefenseBangbooPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_60638234271CCDB8_93* _view; // 0x310
		::System::Int32 towerDefenseBuddyID; // 0x318
		::Class_2_1DE31F486C9C83AD* towerModel; // 0x320
		::Il2CppArray<::MoleMole::UIBangbooInfoBasicAttributeRowWidgetController*>* _propertyViewItems; // 0x328
		::Class_2_C2B4B123B5A9B78A* _buddyUnit; // 0x330
