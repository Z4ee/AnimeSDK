...
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER_CLICKPROPERTY_OFFSET UNITYSDK_OFFSET(0x162A1E30)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x162A1050)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER_ONCLICKBANGBOO_OFFSET UNITYSDK_OFFSET(0x162A1FE0)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x162A1060)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x162A1990)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x162A1CE0)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x162A10F0)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER_REFRESHBUDDYPROPERTYVIEW_OFFSET UNITYSDK_OFFSET(0x162A2A40)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER_REFRESHBUDDYRT_OFFSET UNITYSDK_OFFSET(0x162A31A0)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x162A13C0)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER_RELEASEUIMODELS_OFFSET UNITYSDK_OFFSET(0x162A1DC0)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x162A34F0)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER__ONUIINIT_B__4_0_OFFSET UNITYSDK_OFFSET(0x162A3500)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER__REFRESHBUDDYRT_B__11_0_OFFSET UNITYSDK_OFFSET(0x162A3580)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x162A35F0)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x162A3680)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x162A3710)
#define MOLEMOLE_UITOWERDEFENSEBANGBOOPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x162A3720)

namespace MoleMole
{
	inline static constexpr unsigned int UITowerDefenseBangbooPageController_TypeDefinitionIndex = 69846;

	class UITowerDefenseBangbooPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_60638234271CCDB8_137* _view; // 0x318
