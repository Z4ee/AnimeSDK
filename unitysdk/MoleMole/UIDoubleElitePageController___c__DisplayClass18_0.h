...
#define MOLEMOLE_UIDOUBLEELITEPAGECONTROLLER___C__DISPLAYCLASS18_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19F9B560)
#define MOLEMOLE_UIDOUBLEELITEPAGECONTROLLER___C__DISPLAYCLASS18_0__ONUIOPEN_B__0_OFFSET UNITYSDK_OFFSET(0x19F9B570)
#define MOLEMOLE_UIDOUBLEELITEPAGECONTROLLER___C__DISPLAYCLASS18_0__ONUIOPEN_B__1_OFFSET UNITYSDK_OFFSET(0x19F9B630)
#define MOLEMOLE_UIDOUBLEELITEPAGECONTROLLER___C__DISPLAYCLASS18_0__ONUIOPEN_B__2_OFFSET UNITYSDK_OFFSET(0x19F9B7C0)
#define MOLEMOLE_UIDOUBLEELITEPAGECONTROLLER___C__DISPLAYCLASS18_0__ONUIOPEN_B__3_OFFSET UNITYSDK_OFFSET(0x19F9B7E0)
#define MOLEMOLE_UIDOUBLEELITEPAGECONTROLLER___C__DISPLAYCLASS18_0__ONUIOPEN_B__5_OFFSET UNITYSDK_OFFSET(0x19F9B800)

namespace MoleMole
{
	inline static constexpr unsigned int UIDoubleElitePageController___c__DisplayClass18_0_TypeDefinitionIndex = 59304;
