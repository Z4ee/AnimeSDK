...
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_GET_CLICKACTION_OFFSET UNITYSDK_OFFSET(0x17146120)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_GET_HANDLESELECT_OFFSET UNITYSDK_OFFSET(0x171460C0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x171460A0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_GET_ISMASK_OFFSET UNITYSDK_OFFSET(0x171460E0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_GET_SHOWNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x17146100)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_SETBTNCLICKACTION_OFFSET UNITYSDK_OFFSET(0x17146260)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_SETHANDLESELECT_OFFSET UNITYSDK_OFFSET(0x171461B0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_SETMASK_OFFSET UNITYSDK_OFFSET(0x17146210)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_SET_CLICKACTION_OFFSET UNITYSDK_OFFSET(0x17146130)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_SET_HANDLESELECT_OFFSET UNITYSDK_OFFSET(0x171460D0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_SET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x171460B0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_SET_ISMASK_OFFSET UNITYSDK_OFFSET(0x171460F0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_SET_SHOWNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x17146110)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x17146140)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCitySwitchRoleCardWidgetController_Context_TypeDefinitionIndex = 42283;
	...
	public:
		...
		::System::Boolean _HandleSelect_k__BackingField; // 0x38
		::System::Boolean IsBtnInteractable; // 0x39
