...
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER___C__DISPLAYCLASS30_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16D96300)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER___C__DISPLAYCLASS30_0__PLAYNEXTUNLOCKANIMATION_B__0_OFFSET UNITYSDK_OFFSET(0x16D96310)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityNavigationPageController___c__DisplayClass30_0_TypeDefinitionIndex = 47568;
