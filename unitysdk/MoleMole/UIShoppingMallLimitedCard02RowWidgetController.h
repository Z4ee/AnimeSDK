...
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD02ROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17A32450)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD02ROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17A322F0)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD02ROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17A324E0)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD02ROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17A32050)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD02ROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17A32280)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD02ROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17A32560)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD02ROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17A325C0)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD02ROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17A32650)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD02ROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17A326F0)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD02ROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17A32780)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD02ROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17A32810)

namespace MoleMole
{
	inline static constexpr unsigned int UIShoppingMallLimitedCard02RowWidgetController_TypeDefinitionIndex = 58988;

	class UIShoppingMallLimitedCard02RowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_C8D1480001B76C22* _view; // 0x2C0
