...
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD02ROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x157A0FF0)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD02ROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x157A0E90)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD02ROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x157A1080)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD02ROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x157A0BF0)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD02ROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x157A0E20)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD02ROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x157A1100)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD02ROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x157A1160)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD02ROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x157A11F0)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD02ROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x157A1290)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD02ROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x157A1320)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD02ROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x157A13B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIShoppingMallLimitedCard02RowWidgetController_TypeDefinitionIndex = 55867;
