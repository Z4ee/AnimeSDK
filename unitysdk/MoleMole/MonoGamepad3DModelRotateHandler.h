...
#define MOLEMOLE_MONOGAMEPAD3DMODELROTATEHANDLER_ISTEMPWORKABLE_OFFSET UNITYSDK_OFFSET(0x17E937A0)
#define MOLEMOLE_MONOGAMEPAD3DMODELROTATEHANDLER_METHOD_6_0B1EB5C9B94BAB66_OFFSET UNITYSDK_OFFSET(0x17E93640)
#define MOLEMOLE_MONOGAMEPAD3DMODELROTATEHANDLER_METHOD_6_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x17E93EA0)
#define MOLEMOLE_MONOGAMEPAD3DMODELROTATEHANDLER_METHOD_6_AB021B10FFDC6C17_OFFSET UNITYSDK_OFFSET(0x17E93920)
#define MOLEMOLE_MONOGAMEPAD3DMODELROTATEHANDLER_METHOD_6_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x17E93E50)
#define MOLEMOLE_MONOGAMEPAD3DMODELROTATEHANDLER_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x17E93E00)
#define MOLEMOLE_MONOGAMEPAD3DMODELROTATEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17E93B90)
#define MOLEMOLE_MONOGAMEPAD3DMODELROTATEHANDLER___BASE_ISTEMPWORKABLE_OFFSET UNITYSDK_OFFSET(0x17E93C30)
#define MOLEMOLE_MONOGAMEPAD3DMODELROTATEHANDLER___BASE_ISWORKABLEINNER_OFFSET UNITYSDK_OFFSET(0x17E93CC0)
#define MOLEMOLE_MONOGAMEPAD3DMODELROTATEHANDLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x17E93D50)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGamepad3DModelRotateHandler_TypeDefinitionIndex = 63807;
