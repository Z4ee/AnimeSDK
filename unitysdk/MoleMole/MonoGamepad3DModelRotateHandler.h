...
#define MOLEMOLE_MONOGAMEPAD3DMODELROTATEHANDLER_ISTEMPWORKABLE_OFFSET UNITYSDK_OFFSET(0x191AA180)
#define MOLEMOLE_MONOGAMEPAD3DMODELROTATEHANDLER_METHOD_6_0B1EB5C9B94BAB66_OFFSET UNITYSDK_OFFSET(0x191AA020)
#define MOLEMOLE_MONOGAMEPAD3DMODELROTATEHANDLER_METHOD_6_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x191AA870)
#define MOLEMOLE_MONOGAMEPAD3DMODELROTATEHANDLER_METHOD_6_AB021B10FFDC6C17_OFFSET UNITYSDK_OFFSET(0x191AA300)
#define MOLEMOLE_MONOGAMEPAD3DMODELROTATEHANDLER_METHOD_6_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x191AA820)
#define MOLEMOLE_MONOGAMEPAD3DMODELROTATEHANDLER_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x191AA7D0)
#define MOLEMOLE_MONOGAMEPAD3DMODELROTATEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x191AA560)
#define MOLEMOLE_MONOGAMEPAD3DMODELROTATEHANDLER___BASE_ISTEMPWORKABLE_OFFSET UNITYSDK_OFFSET(0x191AA600)
#define MOLEMOLE_MONOGAMEPAD3DMODELROTATEHANDLER___BASE_ISWORKABLEINNER_OFFSET UNITYSDK_OFFSET(0x191AA690)
#define MOLEMOLE_MONOGAMEPAD3DMODELROTATEHANDLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x191AA720)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGamepad3DModelRotateHandler_TypeDefinitionIndex = 90177;
