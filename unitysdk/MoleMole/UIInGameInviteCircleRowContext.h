...
#define MOLEMOLE_UIINGAMEINVITECIRCLEROWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1481C5E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInGameInviteCircleRowContext_TypeDefinitionIndex = 77825;
