...
#define MOLEMOLE_UIAVATARCOMMONLIGTOPENTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x16352E20)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarCommonLigtOpenType_TypeDefinitionIndex = 81093;
