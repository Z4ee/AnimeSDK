...
#define MOLEMOLE_UIAVATARCOMMONLIGTOPENTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x18015D90)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarCommonLigtOpenType_TypeDefinitionIndex = 66563;
