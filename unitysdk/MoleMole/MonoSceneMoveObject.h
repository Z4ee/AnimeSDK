...
#define MOLEMOLE_MONOSCENEMOVEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x10D6EED0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoSceneMoveObject_TypeDefinitionIndex = 61014;
