...
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_ADDPOP_OFFSET UNITYSDK_OFFSET(0x157BB790)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_ADDTEMPLATEPOP_OFFSET UNITYSDK_OFFSET(0x157BB830)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_BINDTIPBTN_OFFSET UNITYSDK_OFFSET(0x157B5CD0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_CREATEPOPDATA_OFFSET UNITYSDK_OFFSET(0x157BB000)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_FINISHCURRENTPOP_OFFSET UNITYSDK_OFFSET(0x157BAAB0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_GETORCREATECOINCTRL_OFFSET UNITYSDK_OFFSET(0x157B9E50)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_GET_FADEANIMATIONNAME_OFFSET UNITYSDK_OFFSET(0x157B50F0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_GET_FADEOUTTIME_OFFSET UNITYSDK_OFFSET(0x157B5130)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x157B4E30)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x157B58E0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_INITDESK_OFFSET UNITYSDK_OFFSET(0x157B5BB0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_INITPOP_OFFSET UNITYSDK_OFFSET(0x157B60E0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_ONCLICKHEAD_OFFSET UNITYSDK_OFFSET(0x157BC420)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x157B51D0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0x157B8660)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_ONENTERDETAIL_OFFSET UNITYSDK_OFFSET(0x157B4E40)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_ONEXITDETAIL_OFFSET UNITYSDK_OFFSET(0x157B4F40)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x157B6D60)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_ONSELECTBUDDY_OFFSET UNITYSDK_OFFSET(0x157BC780)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x157B6E20)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_ONTAKESMALLCHANGE_OFFSET UNITYSDK_OFFSET(0x157B9F90)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_ONTEMPLEFADEINFINISHED_OFFSET UNITYSDK_OFFSET(0x157B7020)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_ONTEMPLESELLBUBBLEREFRESH_OFFSET UNITYSDK_OFFSET(0x157BA970)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x157B6DD0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x157B6230)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x157B5980)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x157B6390)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_RECYCLEALLCOINCTRL_OFFSET UNITYSDK_OFFSET(0x157BA280)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_RECYCLECOINCTRL_OFFSET UNITYSDK_OFFSET(0x157BA100)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_RECYCLESMALLCHANGE_OFFSET UNITYSDK_OFFSET(0x157BA000)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_REFRESHBUDDYENERGYWITHTALENT_OFFSET UNITYSDK_OFFSET(0x157B92D0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_REFRESHBUDDYENERGY_OFFSET UNITYSDK_OFFSET(0x157B8D60)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_REFRESHBUDDYSPINE_OFFSET UNITYSDK_OFFSET(0x157B70A0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_REFRESHBUDDY_OFFSET UNITYSDK_OFFSET(0x157B8940)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_REFRESHCURRENTPOP_OFFSET UNITYSDK_OFFSET(0x157B84C0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_REFRESHDESK_OFFSET UNITYSDK_OFFSET(0x157B6920)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_REFRESHSMALLCHANGELIST_OFFSET UNITYSDK_OFFSET(0x157B7440)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_REFRESHTAKESMALLCHANGETIMES_OFFSET UNITYSDK_OFFSET(0x157B9690)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0x157BCEB0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_RESTOREPARAS_OFFSET UNITYSDK_OFFSET(0x157BCEF0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_SETBUDDYSTATEASYNC_OFFSET UNITYSDK_OFFSET(0x157B8CE0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_SETPOPINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x157BBAE0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_SETSIMSELLER_OFFSET UNITYSDK_OFFSET(0x157BCCC0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_SHOWCOIN_OFFSET UNITYSDK_OFFSET(0x157B99E0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_SHOWPOPVIEW_OFFSET UNITYSDK_OFFSET(0x157BBE70)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_SHOWSMALLCHANGETIPS_OFFSET UNITYSDK_OFFSET(0x157BA4D0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_STOPSMALLCHANGETIPSHANDLER_OFFSET UNITYSDK_OFFSET(0x157BA600)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_TAKEALLSMALLCHANGE_OFFSET UNITYSDK_OFFSET(0x157B8840)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_TRYTRIGGERNEWBIE_OFFSET UNITYSDK_OFFSET(0x157B6EB0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_UPDATEPOP_OFFSET UNITYSDK_OFFSET(0x157BA7D0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x157BA780)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER__BINDTIPBTN_B__28_0_OFFSET UNITYSDK_OFFSET(0x157BD1D0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER__BINDTIPBTN_B__28_1_OFFSET UNITYSDK_OFFSET(0x157BD1E0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x157BCF30)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER__FINISHCURRENTPOP_B__66_0_OFFSET UNITYSDK_OFFSET(0x157BD310)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER__FINISHCURRENTPOP_B__66_1_OFFSET UNITYSDK_OFFSET(0x157BD360)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER__FINISHCURRENTPOP_B__66_2_OFFSET UNITYSDK_OFFSET(0x157BD3B0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER__INITPOP_B__62_0_OFFSET UNITYSDK_OFFSET(0x157BD300)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER__ONUIINIT_B__27_0_OFFSET UNITYSDK_OFFSET(0x157BD1C0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER__REFRESHCURRENTPOP_B__35_0_OFFSET UNITYSDK_OFFSET(0x157BD1F0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER__REFRESHSMALLCHANGELIST_B__46_1_OFFSET UNITYSDK_OFFSET(0x157BD260)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER__SHOWPOPVIEW_B__69_0_OFFSET UNITYSDK_OFFSET(0x157BD400)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER__SHOWPOPVIEW_B__69_1_OFFSET UNITYSDK_OFFSET(0x157BD470)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER__SHOWPOPVIEW_B__69_2_OFFSET UNITYSDK_OFFSET(0x157BD4E0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER__SHOWSMALLCHANGETIPS_B__53_0_OFFSET UNITYSDK_OFFSET(0x157BD2D0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x157BD550)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x157BD5E0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER___BASE_ONENTERDETAIL_OFFSET UNITYSDK_OFFSET(0x157BD670)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER___BASE_ONEXITDETAIL_OFFSET UNITYSDK_OFFSET(0x157BD700)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x157BD790)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x157BD7C0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER___BASE_ONTEMPLEFADEINFINISHED_OFFSET UNITYSDK_OFFSET(0x157BD860)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x157BD8F0)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x157BD900)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x157BD990)
#define MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x157BDA20)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleSellWidgetController_TypeDefinitionIndex = 69127;

	class UISuibianTempleSellWidgetController : public ::MoleMole::UISuibianTempleSimWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_222* _view; // 0x2E0
		...
		{
			return ((::Class_1_0D6F9C507D2BC133_Class_1_D8C08C94211C11A1*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UISUIBIANTEMPLESELLWIDGETCONTROLLER_RESTOREPARAS_OFFSET))(this);
		}
