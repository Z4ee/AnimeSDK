...
#define MOLEMOLE_UIPARTNERDATEREWARDPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x169571A0)
#define MOLEMOLE_UIPARTNERDATEREWARDPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x169575C0)
#define MOLEMOLE_UIPARTNERDATEREWARDPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16957650)
#define MOLEMOLE_UIPARTNERDATEREWARDPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x169571B0)
#define MOLEMOLE_UIPARTNERDATEREWARDPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16957360)
#define MOLEMOLE_UIPARTNERDATEREWARDPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x16957450)
#define MOLEMOLE_UIPARTNERDATEREWARDPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x169576C0)
#define MOLEMOLE_UIPARTNERDATEREWARDPOPWINDOWCONTROLLER__ONUIINIT_B__4_0_OFFSET UNITYSDK_OFFSET(0x169576D0)
#define MOLEMOLE_UIPARTNERDATEREWARDPOPWINDOWCONTROLLER__ONUIINIT_B__4_1_OFFSET UNITYSDK_OFFSET(0x16957750)
#define MOLEMOLE_UIPARTNERDATEREWARDPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16957760)
#define MOLEMOLE_UIPARTNERDATEREWARDPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x169577F0)
#define MOLEMOLE_UIPARTNERDATEREWARDPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16957800)
#define MOLEMOLE_UIPARTNERDATEREWARDPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16957810)

namespace MoleMole
{
	inline static constexpr unsigned int UIPartnerDateRewardPopWindowController_TypeDefinitionIndex = 52517;

	class UIPartnerDateRewardPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_68D38DAD1613A778_2* _view; // 0x318
		::System::Int32 _partnerID; // 0x320
