...
#define MOLEMOLE_UILINEUPLISTROWWIDGETCONTROLLER___C__DISPLAYCLASS20_0__CTOR_OFFSET UNITYSDK_OFFSET(0x14D33C40)
#define MOLEMOLE_UILINEUPLISTROWWIDGETCONTROLLER___C__DISPLAYCLASS20_0__ONCLICKRESETBTN_B__0_OFFSET UNITYSDK_OFFSET(0x14D33C50)

namespace MoleMole
{
	inline static constexpr unsigned int UILineupListRowWidgetController___c__DisplayClass20_0_TypeDefinitionIndex = 52365;
