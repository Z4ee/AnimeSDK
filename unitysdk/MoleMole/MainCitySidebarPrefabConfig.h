...
#define MOLEMOLE_MAINCITYSIDEBARPREFABCONFIG_GET_DEFAULTICONWIDGETPREFAB_OFFSET UNITYSDK_OFFSET(0x10BC7050)
#define MOLEMOLE_MAINCITYSIDEBARPREFABCONFIG_GET_GATHERPREFAB_OFFSET UNITYSDK_OFFSET(0x10BC7010)
#define MOLEMOLE_MAINCITYSIDEBARPREFABCONFIG_GET_PARENTFOLDER_OFFSET UNITYSDK_OFFSET(0x10BC6F90)
#define MOLEMOLE_MAINCITYSIDEBARPREFABCONFIG_GET_TITLEPREFAB_OFFSET UNITYSDK_OFFSET(0x10BC6FD0)
#define MOLEMOLE_MAINCITYSIDEBARPREFABCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x10BC7090)

namespace MoleMole
{
	inline static constexpr unsigned int MainCitySidebarPrefabConfig_TypeDefinitionIndex = 72334;
