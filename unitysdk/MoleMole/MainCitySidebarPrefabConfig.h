...
#define MOLEMOLE_MAINCITYSIDEBARPREFABCONFIG_GET_DEFAULTICONWIDGETPREFAB_OFFSET UNITYSDK_OFFSET(0x151358A0)
#define MOLEMOLE_MAINCITYSIDEBARPREFABCONFIG_GET_GATHERPREFAB_OFFSET UNITYSDK_OFFSET(0x15135860)
#define MOLEMOLE_MAINCITYSIDEBARPREFABCONFIG_GET_PARENTFOLDER_OFFSET UNITYSDK_OFFSET(0x151357E0)
#define MOLEMOLE_MAINCITYSIDEBARPREFABCONFIG_GET_TITLEPREFAB_OFFSET UNITYSDK_OFFSET(0x15135820)
#define MOLEMOLE_MAINCITYSIDEBARPREFABCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x151358E0)

namespace MoleMole
{
	inline static constexpr unsigned int MainCitySidebarPrefabConfig_TypeDefinitionIndex = 46670;
