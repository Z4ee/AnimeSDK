...
#define MOLEMOLE_UIAVATARSPECIALAWAKENROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18957450)
#define MOLEMOLE_UIAVATARSPECIALAWAKENROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x189574C0)
#define MOLEMOLE_UIAVATARSPECIALAWAKENROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18957580)
#define MOLEMOLE_UIAVATARSPECIALAWAKENROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x189576E0)
#define MOLEMOLE_UIAVATARSPECIALAWAKENROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18957740)
#define MOLEMOLE_UIAVATARSPECIALAWAKENROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x189577E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarSpecialAwakenRowWidgetController_TypeDefinitionIndex = 57228;
