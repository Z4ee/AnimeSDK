...
#define MOLEMOLE_DEVBUDDYINITDATA_CREATEBUDDYINITDATA_OFFSET UNITYSDK_OFFSET(0x1B935BF0)
#define MOLEMOLE_DEVBUDDYINITDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B935CA0)

namespace MoleMole
{
	inline static constexpr unsigned int DevBuddyInitData_TypeDefinitionIndex = 86534;

	class DevBuddyInitData : public ::System::Object
	{
	public:
		::System::Int32 Rank; // 0x10
		::System::Int32 Star; // 0x14
