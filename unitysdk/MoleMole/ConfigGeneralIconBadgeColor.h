...
#define MOLEMOLE_CONFIGGENERALICONBADGECOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA79AF0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigGeneralIconBadgeColor_TypeDefinitionIndex = 41874;
