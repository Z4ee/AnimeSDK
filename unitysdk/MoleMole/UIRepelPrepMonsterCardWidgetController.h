...
#define MOLEMOLE_UIREPELPREPMONSTERCARDWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15329540)
#define MOLEMOLE_UIREPELPREPMONSTERCARDWIDGETCONTROLLER_ONCLICK_OFFSET UNITYSDK_OFFSET(0x15329670)
#define MOLEMOLE_UIREPELPREPMONSTERCARDWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x153295B0)
#define MOLEMOLE_UIREPELPREPMONSTERCARDWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x153296B0)
#define MOLEMOLE_UIREPELPREPMONSTERCARDWIDGETCONTROLLER_SETCARDCLICK_OFFSET UNITYSDK_OFFSET(0x15329750)
#define MOLEMOLE_UIREPELPREPMONSTERCARDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x153298A0)
#define MOLEMOLE_UIREPELPREPMONSTERCARDWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x153298B0)
#define MOLEMOLE_UIREPELPREPMONSTERCARDWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15329950)

namespace MoleMole
{
	inline static constexpr unsigned int UIRepelPrepMonsterCardWidgetController_TypeDefinitionIndex = 62411;
