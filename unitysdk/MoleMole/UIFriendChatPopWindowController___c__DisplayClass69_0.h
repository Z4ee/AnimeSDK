...
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER___C__DISPLAYCLASS69_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15A660E0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER___C__DISPLAYCLASS69_0__ONUPDATEFRIENDINFO_B__0_OFFSET UNITYSDK_OFFSET(0x15A660F0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER___C__DISPLAYCLASS69_0__ONUPDATEFRIENDINFO_B__1_OFFSET UNITYSDK_OFFSET(0x15A66170)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendChatPopWindowController___c__DisplayClass69_0_TypeDefinitionIndex = 81245;
