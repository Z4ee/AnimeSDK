...
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS59_0__CREATECHANGELAYERTEMPCHESSBOARD_B__0_OFFSET UNITYSDK_OFFSET(0x1899A190)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS59_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1899A180)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMainPageController___c__DisplayClass59_0_TypeDefinitionIndex = 73697;
