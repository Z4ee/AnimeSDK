...
#define MOLEMOLE_SUMMEREVENTTRIGGERABILITYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x126569D0)

namespace MoleMole
{
	inline static constexpr unsigned int SummerEventTriggerAbilityParam_TypeDefinitionIndex = 63964;
