...
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS44_1__CTOR_OFFSET UNITYSDK_OFFSET(0x16DEB1A0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS44_1__LIFTTAPES_B__0_OFFSET UNITYSDK_OFFSET(0x16DEB1B0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS44_1__LIFTTAPES_B__1_OFFSET UNITYSDK_OFFSET(0x16DEB320)

namespace MoleMole
{
	inline static constexpr unsigned int UITapesGroup3DModelController___c__DisplayClass44_1_TypeDefinitionIndex = 72707;
