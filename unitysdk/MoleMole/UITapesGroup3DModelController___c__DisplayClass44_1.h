...
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS44_1__CTOR_OFFSET UNITYSDK_OFFSET(0x126A28C0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS44_1__LIFTTAPES_B__0_OFFSET UNITYSDK_OFFSET(0x126A28D0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS44_1__LIFTTAPES_B__1_OFFSET UNITYSDK_OFFSET(0x126A2A40)

namespace MoleMole
{
	inline static constexpr unsigned int UITapesGroup3DModelController___c__DisplayClass44_1_TypeDefinitionIndex = 46601;

	class UITapesGroup3DModelController___c__DisplayClass44_1 : public ::System::Object
	{
	public:
		::MoleMole::UITape3DModelController* rightTape; // 0x10
		::MoleMole::UITape3DModelController* leftTape; // 0x18
