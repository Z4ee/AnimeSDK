...
#define MOLEMOLE_UIROLESELECTPAGECONTROLLER___C__DISPLAYCLASS102_1__CTOR_OFFSET UNITYSDK_OFFSET(0x147FEEA0)
#define MOLEMOLE_UIROLESELECTPAGECONTROLLER___C__DISPLAYCLASS102_1__ONFAVORITEBTNCLICKED_B__0_OFFSET UNITYSDK_OFFSET(0x147FEEB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleSelectPageController___c__DisplayClass102_1_TypeDefinitionIndex = 39206;
	...
	public:
		...
		::MoleMole::UIRoleSelectPageController___c__DisplayClass102_0* CS___8__locals1; // 0x18
