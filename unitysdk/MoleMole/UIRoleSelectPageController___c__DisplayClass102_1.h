...
#define MOLEMOLE_UIROLESELECTPAGECONTROLLER___C__DISPLAYCLASS102_1__CTOR_OFFSET UNITYSDK_OFFSET(0x15F771D0)
#define MOLEMOLE_UIROLESELECTPAGECONTROLLER___C__DISPLAYCLASS102_1__ONFAVORITEBTNCLICKED_B__0_OFFSET UNITYSDK_OFFSET(0x15F771E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleSelectPageController___c__DisplayClass102_1_TypeDefinitionIndex = 47744;
