...
#define MOLEMOLE_URBANMAPMESHLAYERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x12B24900)

namespace MoleMole
{
	inline static constexpr unsigned int UrbanMapMeshLayerInfo_TypeDefinitionIndex = 53660;
