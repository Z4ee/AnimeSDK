...
#define MOLEMOLE_UIINTERKNOTNEWSDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16D862F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotNewsDialogContext_TypeDefinitionIndex = 62135;
