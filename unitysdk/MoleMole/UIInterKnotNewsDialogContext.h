...
#define MOLEMOLE_UIINTERKNOTNEWSDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x150E4A10)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotNewsDialogContext_TypeDefinitionIndex = 72300;
