...
#define MOLEMOLE_TURNBATTLEENTITYTEMPORARYUNIT_GET_SORTWEIGHT_OFFSET UNITYSDK_OFFSET(0x1586A120)
#define MOLEMOLE_TURNBATTLEENTITYTEMPORARYUNIT_GET_SOURCEUNIT_OFFSET UNITYSDK_OFFSET(0x1586A130)
#define MOLEMOLE_TURNBATTLEENTITYTEMPORARYUNIT_ONTURNOVER_OFFSET UNITYSDK_OFFSET(0x1586A1B0)
#define MOLEMOLE_TURNBATTLEENTITYTEMPORARYUNIT_ONTURNSTART_OFFSET UNITYSDK_OFFSET(0x1586A150)
#define MOLEMOLE_TURNBATTLEENTITYTEMPORARYUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1586A140)
#define MOLEMOLE_TURNBATTLEENTITYTEMPORARYUNIT___BASE_ONTURNOVER_OFFSET UNITYSDK_OFFSET(0x1586A210)
#define MOLEMOLE_TURNBATTLEENTITYTEMPORARYUNIT___BASE_ONTURNSTART_OFFSET UNITYSDK_OFFSET(0x1586A2A0)

namespace MoleMole
{
	inline static constexpr unsigned int TurnBattleEntityTemporaryUnit_TypeDefinitionIndex = 38658;
