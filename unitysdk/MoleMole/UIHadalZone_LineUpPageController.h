...
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1A320D10)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1A320D20)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER_ONSELECTAVATAR_OFFSET UNITYSDK_OFFSET(0x1A321D70)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1A322040)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1A320DB0)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1A320E00)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER__CLOSEPREV_RANKINGWIDGETS_OFFSET UNITYSDK_OFFSET(0x1A322470)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER__CREATERANKINGWIDGET_OFFSET UNITYSDK_OFFSET(0x1A322670)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A322770)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER__GO_OFFSET UNITYSDK_OFFSET(0x1A321F10)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER__ONLAYERCLIPCLICK_OFFSET UNITYSDK_OFFSET(0x1A3220B0)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER__ONSELECTAVATAR_B__9_0_OFFSET UNITYSDK_OFFSET(0x1A3229D0)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER__ONUIOPEN_B__8_1_OFFSET UNITYSDK_OFFSET(0x1A3228B0)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER__REFRESHBTNS_OFFSET UNITYSDK_OFFSET(0x1A321300)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER__REFRESHLAYER_OFFSET UNITYSDK_OFFSET(0x1A3215E0)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER__REFRESHOTHERLAYERS_OFFSET UNITYSDK_OFFSET(0x1A3214F0)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER__SCROLLTOINDEX_OFFSET UNITYSDK_OFFSET(0x1A321E10)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1A322AD0)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1A322B60)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1A322B70)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1A322B80)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER___REFRESHBTNS_B__11_0_OFFSET UNITYSDK_OFFSET(0x1A322AC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_LineUpPageController_TypeDefinitionIndex = 85986;

	class UIHadalZone_LineUpPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_168* _view; // 0x318
		...
		::System::Collections::Generic::List_1<::Class_1_5DA2E7556103D5A3_446*>* _zoneLayers; // 0x350
		::Class_1_5DA2E7556103D5A3_344* _lastLayerInfo; // 0x358
		...
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::Level::RatingType, ::Class_1_5DA2E7556103D5A3_446*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER__CREATERANKINGWIDGET_OFFSET))(this, type, zoneInfo);
		}
