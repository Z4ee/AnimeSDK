...
#define MOLEMOLE_DYNAMICOVERRIDEWEATHERV2ENTRY_ISVALID_OFFSET UNITYSDK_OFFSET(0x77F220)

namespace MoleMole
{
	inline static constexpr unsigned int DynamicOverrideWeatherV2Entry_TypeDefinitionIndex = 39117;
