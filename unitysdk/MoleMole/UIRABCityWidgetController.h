...
#define MOLEMOLE_UIRABCITYWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17E1A7E0)
#define MOLEMOLE_UIRABCITYWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17E1A850)
#define MOLEMOLE_UIRABCITYWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x17E1AE20)
#define MOLEMOLE_UIRABCITYWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17E1ABE0)
#define MOLEMOLE_UIRABCITYWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17E1A8F0)
#define MOLEMOLE_UIRABCITYWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x17E1ACA0)
#define MOLEMOLE_UIRABCITYWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17E1AFA0)
#define MOLEMOLE_UIRABCITYWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17E1AFB0)
#define MOLEMOLE_UIRABCITYWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x17E1B050)
#define MOLEMOLE_UIRABCITYWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17E1B0E0)
#define MOLEMOLE_UIRABCITYWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17E1B180)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABCityWidgetController_TypeDefinitionIndex = 80537;
