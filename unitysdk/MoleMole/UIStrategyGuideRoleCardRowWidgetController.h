...
#define MOLEMOLE_UISTRATEGYGUIDEROLECARDROWWIDGETCONTROLLER_ONBUTTONSELFCLICK_OFFSET UNITYSDK_OFFSET(0x15F492C0)
#define MOLEMOLE_UISTRATEGYGUIDEROLECARDROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15F49140)
#define MOLEMOLE_UISTRATEGYGUIDEROLECARDROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15F491D0)
#define MOLEMOLE_UISTRATEGYGUIDEROLECARDROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15F48720)
#define MOLEMOLE_UISTRATEGYGUIDEROLECARDROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15F48880)
#define MOLEMOLE_UISTRATEGYGUIDEROLECARDROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x15F48970)
#define MOLEMOLE_UISTRATEGYGUIDEROLECARDROWWIDGETCONTROLLER_SETCONTEXT_OFFSET UNITYSDK_OFFSET(0x15F49260)
#define MOLEMOLE_UISTRATEGYGUIDEROLECARDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15F49570)
#define MOLEMOLE_UISTRATEGYGUIDEROLECARDROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15F495D0)
#define MOLEMOLE_UISTRATEGYGUIDEROLECARDROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15F49660)
#define MOLEMOLE_UISTRATEGYGUIDEROLECARDROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15F496F0)
#define MOLEMOLE_UISTRATEGYGUIDEROLECARDROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15F49780)

namespace MoleMole
{
	inline static constexpr unsigned int UIStrategyGuideRoleCardRowWidgetController_TypeDefinitionIndex = 78031;
