...
#define MOLEMOLE_UIRECOMMENDWEAPONROWWIDGETCONTROLLER_COMPAREWEAPONPRIORITY_OFFSET UNITYSDK_OFFSET(0x188666B0)
#define MOLEMOLE_UIRECOMMENDWEAPONROWWIDGETCONTROLLER_GETEQUIPSCORE_OFFSET UNITYSDK_OFFSET(0x18866860)
#define MOLEMOLE_UIRECOMMENDWEAPONROWWIDGETCONTROLLER_GETWEAPONID_OFFSET UNITYSDK_OFFSET(0x18866610)
#define MOLEMOLE_UIRECOMMENDWEAPONROWWIDGETCONTROLLER_GETWEAPONUID_OFFSET UNITYSDK_OFFSET(0x188665C0)
#define MOLEMOLE_UIRECOMMENDWEAPONROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18865830)
#define MOLEMOLE_UIRECOMMENDWEAPONROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x18865CB0)
#define MOLEMOLE_UIRECOMMENDWEAPONROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x18865940)
#define MOLEMOLE_UIRECOMMENDWEAPONROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x188658C0)
#define MOLEMOLE_UIRECOMMENDWEAPONROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x188655D0)
#define MOLEMOLE_UIRECOMMENDWEAPONROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x188657C0)
#define MOLEMOLE_UIRECOMMENDWEAPONROWWIDGETCONTROLLER_REFRESHAVATARINFO_OFFSET UNITYSDK_OFFSET(0x18866110)
#define MOLEMOLE_UIRECOMMENDWEAPONROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x18865A30)
#define MOLEMOLE_UIRECOMMENDWEAPONROWWIDGETCONTROLLER_SETAVATARID_OFFSET UNITYSDK_OFFSET(0x18866660)
#define MOLEMOLE_UIRECOMMENDWEAPONROWWIDGETCONTROLLER_SETROLEICON_OFFSET UNITYSDK_OFFSET(0x18866510)
#define MOLEMOLE_UIRECOMMENDWEAPONROWWIDGETCONTROLLER_SETWEAPON_OFFSET UNITYSDK_OFFSET(0x18865D50)
#define MOLEMOLE_UIRECOMMENDWEAPONROWWIDGETCONTROLLER_SHOWEMPTY_OFFSET UNITYSDK_OFFSET(0x18866460)
#define MOLEMOLE_UIRECOMMENDWEAPONROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x188668E0)
#define MOLEMOLE_UIRECOMMENDWEAPONROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x188668F0)
#define MOLEMOLE_UIRECOMMENDWEAPONROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x18866980)
#define MOLEMOLE_UIRECOMMENDWEAPONROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x18866A10)
#define MOLEMOLE_UIRECOMMENDWEAPONROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18866AB0)
#define MOLEMOLE_UIRECOMMENDWEAPONROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18866B40)
#define MOLEMOLE_UIRECOMMENDWEAPONROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18866BD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRecommendWeaponRowWidgetController_TypeDefinitionIndex = 88545;
	...
	public:
		...
		static ::System::Int32 CompareWeaponPriority(::Class_2_F7CAAD54879BD084* a, ::Class_2_F7CAAD54879BD084* b, ::System::UInt32 avatarId)
		{
			return ((::System::Int32(*)(::Class_2_F7CAAD54879BD084*, ::Class_2_F7CAAD54879BD084*, ::System::UInt32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIRECOMMENDWEAPONROWWIDGETCONTROLLER_COMPAREWEAPONPRIORITY_OFFSET))(a, b, avatarId);
		}

		static ::System::Int32 GetEquipScore(::Class_2_F7CAAD54879BD084* w, ::System::UInt32 avatarId)
		{
			return ((::System::Int32(*)(::Class_2_F7CAAD54879BD084*, ::System::UInt32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIRECOMMENDWEAPONROWWIDGETCONTROLLER_GETEQUIPSCORE_OFFSET))(w, avatarId);
		}
