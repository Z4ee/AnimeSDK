...
#define MOLEMOLE_UIURBANMAPNAVIGATIONPAGECONTROLLER___C__DISPLAYCLASS33_0__CTOR_OFFSET UNITYSDK_OFFSET(0x138396A0)
#define MOLEMOLE_UIURBANMAPNAVIGATIONPAGECONTROLLER___C__DISPLAYCLASS33_0__ONSKIPFADEINANIMATION_B__0_OFFSET UNITYSDK_OFFSET(0x138396B0)
#define MOLEMOLE_UIURBANMAPNAVIGATIONPAGECONTROLLER___C__DISPLAYCLASS33_0__ONSKIPFADEINANIMATION_B__1_OFFSET UNITYSDK_OFFSET(0x1383C220)
#define MOLEMOLE_UIURBANMAPNAVIGATIONPAGECONTROLLER___C__DISPLAYCLASS33_0__ONSKIPFADEINANIMATION_G__TRYSTARTNAVIGATIONPAGEFADEIN_2_OFFSET UNITYSDK_OFFSET(0x138396C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapNavigationPageController___c__DisplayClass33_0_TypeDefinitionIndex = 67402;
	...
	public:
		...
		::System::Boolean portalDataReady; // 0x18
		::System::Boolean areaDataReady; // 0x19
