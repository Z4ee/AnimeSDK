...
#define MOLEMOLE_UIACTIVITYRETURNREWARDPOLYCHROMESWIDGETCONTROLLER__PLAYPROGRESSCHANGEANIM_D__1_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x89D730)
#define MOLEMOLE_UIACTIVITYRETURNREWARDPOLYCHROMESWIDGETCONTROLLER__PLAYPROGRESSCHANGEANIM_D__1_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityReturnRewardPolychromesWidgetController__PlayProgressChangeAnim_d__1_TypeDefinitionIndex = 82329;
	...
	struct alignas(8) UIActivityReturnRewardPolychromesWidgetController__PlayProgressChangeAnim_d__1
	{
		...
		::UnityEngine::AnimationCurve* _curve_5__4; // 0x30
		::MoleMole::UIActivityReturnRewardPolychromesWidgetController* __4__this; // 0x38
		::Class_2_6055A71771138631_Class_2_DCA97181A2D1354C* _finalView_5__3; // 0x40
		::System::Single _totalTime_5__5; // 0x48
		::System::Single _passTime_5__2; // 0x4C
		::System::UInt32 targetNum; // 0x50
		::System::Int32 __1__state; // 0x54
		::System::UInt32 _oriNum_5__7; // 0x58
		::System::Single _maxLimit_5__6; // 0x5C
