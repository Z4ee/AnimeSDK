...
#define MOLEMOLE_MONOFOLLOWJOINTMOVEELEMENT_AWAKE_OFFSET UNITYSDK_OFFSET(0x129B48B0)
#define MOLEMOLE_MONOFOLLOWJOINTMOVEELEMENT_GETBACKDISTANCE_OFFSET UNITYSDK_OFFSET(0x129B5040)
#define MOLEMOLE_MONOFOLLOWJOINTMOVEELEMENT_GETFRONTDISTANCE_OFFSET UNITYSDK_OFFSET(0x129B4EB0)
#define MOLEMOLE_MONOFOLLOWJOINTMOVEELEMENT_SET_OFFSET UNITYSDK_OFFSET(0x129B4430)
#define MOLEMOLE_MONOFOLLOWJOINTMOVEELEMENT_UPDATEKINEMATICELEMENTS_OFFSET UNITYSDK_OFFSET(0x129B3BF0)
#define MOLEMOLE_MONOFOLLOWJOINTMOVEELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x129B51D0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoFollowJointMoveElement_TypeDefinitionIndex = 61057;
