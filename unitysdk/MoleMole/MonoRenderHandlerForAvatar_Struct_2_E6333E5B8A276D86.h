...
#define MOLEMOLE_MONORENDERHANDLERFORAVATAR_STRUCT_2_E6333E5B8A276D86_METHOD_2_1435D5A3459C003C_OFFSET UNITYSDK_OFFSET(0x138528C0)
#define MOLEMOLE_MONORENDERHANDLERFORAVATAR_STRUCT_2_E6333E5B8A276D86_METHOD_2_91461C72E6BA24E6_OFFSET UNITYSDK_OFFSET(0x7D3690)

namespace MoleMole
{
	inline static constexpr unsigned int MonoRenderHandlerForAvatar_Struct_2_E6333E5B8A276D86_TypeDefinitionIndex = 61512;
	...
	struct alignas(4) MonoRenderHandlerForAvatar_Struct_2_E6333E5B8A276D86
	{
		...
		::UnityEngine::Rendering::Universal::ForwardRendererData_ShaderFeature Field_2_0; // 0x1C
