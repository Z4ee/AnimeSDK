...
#define MOLEMOLE_UIGENERALENHANCEBUFFWIDGETCONTROLLER_UIGENERALENHANCEBUFFCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15902730)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralEnhanceBuffWidgetController_UIGeneralEnhanceBuffContext_TypeDefinitionIndex = 49567;
	...
	public:
		...
		::System::Boolean IsRecommend; // 0x19
		::System::Boolean IsLock; // 0x1A
		::System::Boolean IsEmpty; // 0x1B
