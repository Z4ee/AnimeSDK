...
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER__TRYSHOWNEWEQUIPTIPSASYNC_D__26_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x840930)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER__TRYSHOWNEWEQUIPTIPSASYNC_D__26_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x283610)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangBooUAVLevelPageController__TryShowNewEquipTipsAsync_d__26_TypeDefinitionIndex = 61530;
	...
	struct alignas(8) UIBangBooUAVLevelPageController__TryShowNewEquipTipsAsync_d__26
	{
		...
		::MoleMole::UIBangBooUAVLevelPageController* __4__this; // 0x28
