...
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER__TRYSHOWNEWEQUIPTIPSASYNC_D__26_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x88F2A0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER__TRYSHOWNEWEQUIPTIPSASYNC_D__26_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangBooUAVLevelPageController__TryShowNewEquipTipsAsync_d__26_TypeDefinitionIndex = 65632;
	...
	struct alignas(8) UIBangBooUAVLevelPageController__TryShowNewEquipTipsAsync_d__26
	{
		...
		::System::Collections::Generic::Queue_1<::System::Int32>* _equipTipsPopQueue_5__2; // 0x38
