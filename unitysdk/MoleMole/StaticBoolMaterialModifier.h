...
#define MOLEMOLE_STATICBOOLMATERIALMODIFIER_METHOD_2_6881D6F4F5133271_OFFSET UNITYSDK_OFFSET(0x8355B0)
#define MOLEMOLE_STATICBOOLMATERIALMODIFIER_METHOD_2_C446CE6A5E1982BC_OFFSET UNITYSDK_OFFSET(0x8355C0)
#define MOLEMOLE_STATICBOOLMATERIALMODIFIER_METHOD_2_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x835610)
#define MOLEMOLE_STATICBOOLMATERIALMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x835590)

namespace MoleMole
{
	inline static constexpr unsigned int StaticBoolMaterialModifier_TypeDefinitionIndex = 74723;
	...
	struct alignas(8) StaticBoolMaterialModifier
	{
		...
		{
			return ((::Class_1_A0B58236B258B7B2*(*)(::PVOID, ::Enum_3_7F4644768973D415, ::MoleMole::MonoRenderHandler*))((::PBYTE)hIl2Cpp + MOLEMOLE_STATICBOOLMATERIALMODIFIER_METHOD_2_6881D6F4F5133271_OFFSET))(this, a1, a2);
		}
