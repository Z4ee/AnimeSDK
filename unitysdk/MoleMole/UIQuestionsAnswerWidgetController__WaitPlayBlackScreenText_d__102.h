...
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER__WAITPLAYBLACKSCREENTEXT_D__102_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x7FFCB0)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER__WAITPLAYBLACKSCREENTEXT_D__102_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x283610)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerWidgetController__WaitPlayBlackScreenText_d__102_TypeDefinitionIndex = 61878;
