...
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_REFRESHDEL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x11BA67D0)
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_REFRESHDEL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11BA6840)
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_REFRESHDEL_INVOKE_OFFSET UNITYSDK_OFFSET(0x11BA64E0)
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_REFRESHDEL__CTOR_OFFSET UNITYSDK_OFFSET(0x11BA64C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleInfoSkillChildWindowController_SubViewDefine_RefreshDel_TypeDefinitionIndex = 77493;
