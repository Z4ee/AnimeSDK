...
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_REFRESHDEL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1510BCB0)
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_REFRESHDEL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1510BD20)
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_REFRESHDEL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1510B9B0)
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_REFRESHDEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1510B990)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleInfoSkillChildWindowController_SubViewDefine_RefreshDel_TypeDefinitionIndex = 45384;
