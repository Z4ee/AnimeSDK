...
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_CLEARVIDEOSTARTPLAYCB_OFFSET UNITYSDK_OFFSET(0x1303E330)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_DESTROY_OFFSET UNITYSDK_OFFSET(0x1303D600)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_INIT_OFFSET UNITYSDK_OFFSET(0x1303D4F0)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_METHOD_5_0896B79A9E343E83_OFFSET UNITYSDK_OFFSET(0x1303E450)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_METHOD_5_7EAA8879197594BA_OFFSET UNITYSDK_OFFSET(0x1303D840)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_METHOD_5_943BEE88B8C58D7F_OFFSET UNITYSDK_OFFSET(0x1303E570)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_METHOD_5_AFC8215C57A0845A_OFFSET UNITYSDK_OFFSET(0x1303DB30)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_METHOD_5_EBAC71FBE1837205_OFFSET UNITYSDK_OFFSET(0x1303E430)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1303DCE0)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1303D7D0)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_PLAYFRAMETEXTUREONSCREEN_OFFSET UNITYSDK_OFFSET(0x1303DDA0)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_PLAYVIDEOONSCREEN_OFFSET UNITYSDK_OFFSET(0x1303DD30)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_PLAYWEAPONFRAMETEXTUREORVIDEO_OFFSET UNITYSDK_OFFSET(0x1303DE10)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_SETASPECTMODE_OFFSET UNITYSDK_OFFSET(0x1303D780)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_SETVIDEOSTARTPLAYCB_OFFSET UNITYSDK_OFFSET(0x1303E2E0)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_STOP_OFFSET UNITYSDK_OFFSET(0x1303D690)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1303E380)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIWeaponVideoScreenPlayer_TypeDefinitionIndex = 55195;
