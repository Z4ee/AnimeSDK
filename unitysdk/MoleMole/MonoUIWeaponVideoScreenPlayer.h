...
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_CLEARVIDEOSTARTPLAYCB_OFFSET UNITYSDK_OFFSET(0x1739C560)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_DESTROY_OFFSET UNITYSDK_OFFSET(0x1739B840)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_INIT_OFFSET UNITYSDK_OFFSET(0x1739B730)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_METHOD_5_0896B79A9E343E83_OFFSET UNITYSDK_OFFSET(0x1739C660)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_METHOD_5_7EAA8879197594BA_OFFSET UNITYSDK_OFFSET(0x1739BA80)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_METHOD_5_8CD1A6D1096A6CB7_OFFSET UNITYSDK_OFFSET(0x1739C7A0)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_METHOD_5_AFC8215C57A0845A_OFFSET UNITYSDK_OFFSET(0x1739BD70)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_METHOD_5_EBAC71FBE1837205_OFFSET UNITYSDK_OFFSET(0x1739C780)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1739BF20)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1739BA10)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_PLAYFRAMETEXTUREONSCREEN_OFFSET UNITYSDK_OFFSET(0x1739BFE0)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_PLAYVIDEOONSCREEN_OFFSET UNITYSDK_OFFSET(0x1739BF70)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_PLAYWEAPONFRAMETEXTUREORVIDEO_OFFSET UNITYSDK_OFFSET(0x1739C050)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_SETASPECTMODE_OFFSET UNITYSDK_OFFSET(0x1739B9C0)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_SETVIDEOSTARTPLAYCB_OFFSET UNITYSDK_OFFSET(0x1739C510)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_STOP_OFFSET UNITYSDK_OFFSET(0x1739B8D0)
#define MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1739C5B0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIWeaponVideoScreenPlayer_TypeDefinitionIndex = 76645;

	class MonoUIWeaponVideoScreenPlayer : public ::UnityEngine::MonoBehaviour
	{
	public:
		::Class_2_CA67A9CEB871FFD3* Field_5_2; // 0x18
		::Class_2_CA67A9CEB871FFD3* Field_5_1; // 0x20
		::System::String* Field_5_0; // 0x28
		::System::String* Field_5_7; // 0x30
		::MoleMole::MonoUIWeaponVideoScreenPlayer_Enum_3_60BA6CD66500147A Field_5_6; // 0x38
		::System::String* Field_5_5; // 0x40
		::System::String* Field_5_4; // 0x48
		::System::String* Field_5_11; // 0x50
		::Class_1_E9529ED64113E4E9* Field_5_10; // 0x58
		...
		::System::Void Method_5_8CD1A6D1096A6CB7(::Class_1_E9529ED64113E4E9* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_E9529ED64113E4E9*))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOUIWEAPONVIDEOSCREENPLAYER_METHOD_5_8CD1A6D1096A6CB7_OFFSET))(this, a1);
		}
	};
}
