...
#define MOLEMOLE_UICOMBATREADINESSDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x176FAD20)
#define MOLEMOLE_UICOMBATREADINESSDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS8_0__REFRESHMAINSTORYVIEW_B__0_OFFSET UNITYSDK_OFFSET(0x176FAD30)
#define MOLEMOLE_UICOMBATREADINESSDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS8_0__REFRESHMAINSTORYVIEW_B__1_OFFSET UNITYSDK_OFFSET(0x176FADC0)

namespace MoleMole
{
	inline static constexpr unsigned int UICombatReadinessDialogPopWindowController___c__DisplayClass8_0_TypeDefinitionIndex = 80381;

	class UICombatReadinessDialogPopWindowController___c__DisplayClass8_0 : public ::System::Object
	{
	public:
		::System::Action* __9__1; // 0x10
		::Class_2_0A55B5A82A61DAFA_1* template_; // 0x18
		::MoleMole::UICombatReadinessDialogPopWindowController* __4__this; // 0x20
		::Class_2_208CC9941471731A_705* archiveFileQuestTemplateExt; // 0x28
