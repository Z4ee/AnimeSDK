...
#define MOLEMOLE_MONOPARTYSEESAWOBJ2_AWAKE_OFFSET UNITYSDK_OFFSET(0x16414970)
#define MOLEMOLE_MONOPARTYSEESAWOBJ2_METHOD_8_852D8F76817124D8_OFFSET UNITYSDK_OFFSET(0x16414C20)
#define MOLEMOLE_MONOPARTYSEESAWOBJ2_METHOD_8_9C260A5B78AFA0A5_OFFSET UNITYSDK_OFFSET(0x16413F50)
#define MOLEMOLE_MONOPARTYSEESAWOBJ2_ONDOUPDATE_OFFSET UNITYSDK_OFFSET(0x16413D90)
#define MOLEMOLE_MONOPARTYSEESAWOBJ2__CCTOR_OFFSET UNITYSDK_OFFSET(0x16414B40)
#define MOLEMOLE_MONOPARTYSEESAWOBJ2__CTOR_OFFSET UNITYSDK_OFFSET(0x16414A90)
#define MOLEMOLE_MONOPARTYSEESAWOBJ2___BASE_ONDOUPDATE_OFFSET UNITYSDK_OFFSET(0x16414B90)

namespace MoleMole
{
	inline static constexpr unsigned int MonoPartySeesawObj2_TypeDefinitionIndex = 59433;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Collider*>**)Il2CppClass::FromTypeDefinitionIndex(MonoPartySeesawObj2_TypeDefinitionIndex)->GetStaticField(0x4CDA0);
		}
