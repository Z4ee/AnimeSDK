...
#define MOLEMOLE_VOPERFORMSUBSYSTEM_VOGUIDEPOSTARGETSYNCER_INIT_OFFSET UNITYSDK_OFFSET(0x1950AB00)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_VOGUIDEPOSTARGETSYNCER_TRYGETTARGETPOS_OFFSET UNITYSDK_OFFSET(0x19509F80)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_VOGUIDEPOSTARGETSYNCER__CTOR_OFFSET UNITYSDK_OFFSET(0x1950AB50)

namespace MoleMole
{
	inline static constexpr unsigned int VOPerformSubSystem_VOGuidePosTargetSyncer_TypeDefinitionIndex = 69480;
