...
#define MOLEMOLE_VOPERFORMSUBSYSTEM_VOGUIDEPOSTARGETSYNCER_INIT_OFFSET UNITYSDK_OFFSET(0x1149E5E0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_VOGUIDEPOSTARGETSYNCER_TRYGETTARGETPOS_OFFSET UNITYSDK_OFFSET(0x1149DD10)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_VOGUIDEPOSTARGETSYNCER__CTOR_OFFSET UNITYSDK_OFFSET(0x1149E630)

namespace MoleMole
{
	inline static constexpr unsigned int VOPerformSubSystem_VOGuidePosTargetSyncer_TypeDefinitionIndex = 60230;
