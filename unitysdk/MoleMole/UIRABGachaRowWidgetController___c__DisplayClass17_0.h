...
#define MOLEMOLE_UIRABGACHAROWWIDGETCONTROLLER___C__DISPLAYCLASS17_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15F5DE70)
#define MOLEMOLE_UIRABGACHAROWWIDGETCONTROLLER___C__DISPLAYCLASS17_0__ONPULLSUCCESSHANDLE_B__0_OFFSET UNITYSDK_OFFSET(0x15F5DE80)
#define MOLEMOLE_UIRABGACHAROWWIDGETCONTROLLER___C__DISPLAYCLASS17_0__ONPULLSUCCESSHANDLE_B__1_OFFSET UNITYSDK_OFFSET(0x15F5DF00)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABGachaRowWidgetController___c__DisplayClass17_0_TypeDefinitionIndex = 53097;
	...
	public:
		...
		::Class_3_E542FA6AD8EA44A5_2* rsp; // 0x18
		::MoleMole::UIRABAutoBattleBase3DModelController* baseCtrl3D; // 0x20
