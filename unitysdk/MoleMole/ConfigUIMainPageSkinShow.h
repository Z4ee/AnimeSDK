...
#define MOLEMOLE_CONFIGUIMAINPAGESKINSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x14882810)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIMainPageSkinShow_TypeDefinitionIndex = 82629;
