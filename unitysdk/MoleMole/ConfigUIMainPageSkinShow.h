...
#define MOLEMOLE_CONFIGUIMAINPAGESKINSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x11CC17D0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIMainPageSkinShow_TypeDefinitionIndex = 64733;
