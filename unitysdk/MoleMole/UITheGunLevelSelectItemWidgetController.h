...
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_NEEDPLAYUNLOCKANIM_OFFSET UNITYSDK_OFFSET(0x15F92880)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15F90EE0)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_ONFADEINFINISH_OFFSET UNITYSDK_OFFSET(0x15F91FA0)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x15F920E0)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_ONLOCKCONTDOWNEND_OFFSET UNITYSDK_OFFSET(0x15F92CA0)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15F90FF0)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15F90F70)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15F90BC0)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15F90E70)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_PLAYUNLOCKANIM_OFFSET UNITYSDK_OFFSET(0x15F929E0)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_PREPAREUNLOCKANIM_OFFSET UNITYSDK_OFFSET(0x15F91460)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_REFRESHITEM_OFFSET UNITYSDK_OFFSET(0x15F91590)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_REFRESHNEW_OFFSET UNITYSDK_OFFSET(0x15F925A0)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_REFRESHTRACK_OFFSET UNITYSDK_OFFSET(0x15F923C0)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_TRYPLAYUNLOCKANIM_OFFSET UNITYSDK_OFFSET(0x15F92070)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15F92D80)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER__ONLOCKCONTDOWNEND_B__21_0_OFFSET UNITYSDK_OFFSET(0x15F92DA0)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER__ONUIINIT_B__7_0_OFFSET UNITYSDK_OFFSET(0x15F92D90)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15F92E20)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER___BASE_ONFADEINFINISH_OFFSET UNITYSDK_OFFSET(0x15F92EB0)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x15F92F40)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15F92FD0)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15F93070)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15F93100)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15F93190)

namespace MoleMole
{
	inline static constexpr unsigned int UITheGunLevelSelectItemWidgetController_TypeDefinitionIndex = 79517;

	class UITheGunLevelSelectItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_185* _view; // 0x2F0
