...
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER___C__DISPLAYCLASS62_0__CTOR_OFFSET UNITYSDK_OFFSET(0x122C5E80)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER___C__DISPLAYCLASS62_0__ONCOMBOCHANGE_B__0_OFFSET UNITYSDK_OFFSET(0x122C5E90)

namespace MoleMole
{
	inline static constexpr unsigned int UITriggerShootMainPageController___c__DisplayClass62_0_TypeDefinitionIndex = 72114;

	class UITriggerShootMainPageController___c__DisplayClass62_0 : public ::System::Object
	{
	public:
		::UnityEngine::Transform* newTips; // 0x10
		::MoleMole::UITriggerShootMainPageController* __4__this; // 0x18
