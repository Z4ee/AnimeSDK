...
#define MOLEMOLE_GLITCH01FORUISCALE_ADAPTATION_OFFSET UNITYSDK_OFFSET(0x1912D890)
#define MOLEMOLE_GLITCH01FORUISCALE_GETDURATION_OFFSET UNITYSDK_OFFSET(0x1912E040)
#define MOLEMOLE_GLITCH01FORUISCALE_METHOD_6_9AD0A34018F596D0_OFFSET UNITYSDK_OFFSET(0x1912DD40)
#define MOLEMOLE_GLITCH01FORUISCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x1912E6C0)
#define MOLEMOLE_GLITCH01FORUISCALE___BASE_GETDURATION_OFFSET UNITYSDK_OFFSET(0x1912E710)

namespace MoleMole
{
	inline static constexpr unsigned int Glitch01ForUIScale_TypeDefinitionIndex = 40875;
