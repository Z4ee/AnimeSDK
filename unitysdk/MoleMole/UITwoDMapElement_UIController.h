...
#define MOLEMOLE_UITWODMAPELEMENT_UICONTROLLER_GETDATA_OFFSET UNITYSDK_OFFSET(0x11B8EEF0)
#define MOLEMOLE_UITWODMAPELEMENT_UICONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x11B8F530)
#define MOLEMOLE_UITWODMAPELEMENT_UICONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x11B8EF90)
#define MOLEMOLE_UITWODMAPELEMENT_UICONTROLLER_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x11B8F000)
#define MOLEMOLE_UITWODMAPELEMENT_UICONTROLLER_SETSIZE_OFFSET UNITYSDK_OFFSET(0x11B8F1D0)
#define MOLEMOLE_UITWODMAPELEMENT_UICONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11B8F590)
#define MOLEMOLE_UITWODMAPELEMENT_UICONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x11B8F5F0)

namespace MoleMole
{
	inline static constexpr unsigned int UITwoDMapElement_UIController_TypeDefinitionIndex = 74416;

	class UITwoDMapElement_UIController : public ::MoleMole::UIWidgetController
	{
	public:
		::System::Single _scale; // 0x2B8
