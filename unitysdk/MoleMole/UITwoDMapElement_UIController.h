...
#define MOLEMOLE_UITWODMAPELEMENT_UICONTROLLER_GETDATA_OFFSET UNITYSDK_OFFSET(0x11E2BFB0)
#define MOLEMOLE_UITWODMAPELEMENT_UICONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x11E2C5F0)
#define MOLEMOLE_UITWODMAPELEMENT_UICONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x11E2C050)
#define MOLEMOLE_UITWODMAPELEMENT_UICONTROLLER_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x11E2C0C0)
#define MOLEMOLE_UITWODMAPELEMENT_UICONTROLLER_SETSIZE_OFFSET UNITYSDK_OFFSET(0x11E2C290)
#define MOLEMOLE_UITWODMAPELEMENT_UICONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11E2C650)
#define MOLEMOLE_UITWODMAPELEMENT_UICONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x11E2C6B0)

namespace MoleMole
{
	inline static constexpr unsigned int UITwoDMapElement_UIController_TypeDefinitionIndex = 91424;
