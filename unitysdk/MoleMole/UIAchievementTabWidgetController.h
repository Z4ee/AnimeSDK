...
#define MOLEMOLE_UIACHIEVEMENTTABWIDGETCONTROLLER_GETBUTTON_OFFSET UNITYSDK_OFFSET(0x173CAA30)
#define MOLEMOLE_UIACHIEVEMENTTABWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x173CAAE0)
#define MOLEMOLE_UIACHIEVEMENTTABWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x173CA5E0)
#define MOLEMOLE_UIACHIEVEMENTTABWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x173CAB70)
#define MOLEMOLE_UIACHIEVEMENTTABWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x173CA510)
#define MOLEMOLE_UIACHIEVEMENTTABWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x173CA570)
#define MOLEMOLE_UIACHIEVEMENTTABWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x173CABF0)
#define MOLEMOLE_UIACHIEVEMENTTABWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x173CAC50)
#define MOLEMOLE_UIACHIEVEMENTTABWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x173CACE0)
#define MOLEMOLE_UIACHIEVEMENTTABWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x173CAD80)
#define MOLEMOLE_UIACHIEVEMENTTABWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x173CAE10)
#define MOLEMOLE_UIACHIEVEMENTTABWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x173CAEA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAchievementTabWidgetController_TypeDefinitionIndex = 71751;
