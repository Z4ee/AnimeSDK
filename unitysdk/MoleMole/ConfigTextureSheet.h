...
#define MOLEMOLE_CONFIGTEXTURESHEET_GETFORMATTOSERIALIZEAS_OFFSET UNITYSDK_OFFSET(0x1B81D380)
#define MOLEMOLE_CONFIGTEXTURESHEET_GETTEXTURECONFIGFOLDER_OFFSET UNITYSDK_OFFSET(0x1B81D610)
#define MOLEMOLE_CONFIGTEXTURESHEET_GETTEXTURECONFIGPATH_OFFSET UNITYSDK_OFFSET(0x1B81D490)
#define MOLEMOLE_CONFIGTEXTURESHEET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B81D790)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigTextureSheet_TypeDefinitionIndex = 46574;
