...
#define MOLEMOLE_CONFIGTEXTURESHEET_GETFORMATTOSERIALIZEAS_OFFSET UNITYSDK_OFFSET(0x1A00DFA0)
#define MOLEMOLE_CONFIGTEXTURESHEET_GETTEXTURECONFIGFOLDER_OFFSET UNITYSDK_OFFSET(0x1A00E230)
#define MOLEMOLE_CONFIGTEXTURESHEET_GETTEXTURECONFIGPATH_OFFSET UNITYSDK_OFFSET(0x1A00E0B0)
#define MOLEMOLE_CONFIGTEXTURESHEET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A00E3B0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigTextureSheet_TypeDefinitionIndex = 68411;
