...
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xE855C10)

namespace MoleMole
{
	inline static constexpr unsigned int UIVideoShopTipsPopWindowContext_TypeDefinitionIndex = 64133;

	class UIVideoShopTipsPopWindowContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::Action* OnGoToCompose; // 0x28
		::System::String* okBtnTextKey; // 0x30
		...
		::System::Collections::Generic::List_1<::Class_2_40F272A77274ABD0_Struct_2_680BF1744D60EED9_1>* conversionMaterialDataList; // 0x40
