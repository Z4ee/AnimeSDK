...
#define MOLEMOLE_UIABINLEVELCOUNTDOWNWIDGETCONTROLLER_BINDVIEW_OFFSET UNITYSDK_OFFSET(0x18923710)
#define MOLEMOLE_UIABINLEVELCOUNTDOWNWIDGETCONTROLLER_CLEARCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x18923D80)
#define MOLEMOLE_UIABINLEVELCOUNTDOWNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18923600)
#define MOLEMOLE_UIABINLEVELCOUNTDOWNWIDGETCONTROLLER_ONSTAGECHANGE_OFFSET UNITYSDK_OFFSET(0x18923A90)
#define MOLEMOLE_UIABINLEVELCOUNTDOWNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18923690)
#define MOLEMOLE_UIABINLEVELCOUNTDOWNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x189234D0)
#define MOLEMOLE_UIABINLEVELCOUNTDOWNWIDGETCONTROLLER_SETFILL_OFFSET UNITYSDK_OFFSET(0x18923F00)
#define MOLEMOLE_UIABINLEVELCOUNTDOWNWIDGETCONTROLLER_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x18923D10)
#define MOLEMOLE_UIABINLEVELCOUNTDOWNWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x189240D0)
#define MOLEMOLE_UIABINLEVELCOUNTDOWNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x189243A0)
#define MOLEMOLE_UIABINLEVELCOUNTDOWNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18924400)
#define MOLEMOLE_UIABINLEVELCOUNTDOWNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18924490)
#define MOLEMOLE_UIABINLEVELCOUNTDOWNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18924520)

namespace MoleMole
{
	inline static constexpr unsigned int UIABInLevelCountDownWidgetController_TypeDefinitionIndex = 58028;
