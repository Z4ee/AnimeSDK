...
#define MOLEMOLE_UIDYNAMICSCROLLVIEWCELL_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x158EF5F0)
#define MOLEMOLE_UIDYNAMICSCROLLVIEWCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x158EF780)

namespace MoleMole
{
	inline static constexpr unsigned int UIDynamicScrollViewCell_TypeDefinitionIndex = 78500;
