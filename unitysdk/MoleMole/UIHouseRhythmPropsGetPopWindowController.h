...
#define MOLEMOLE_UIHOUSERHYTHMPROPSGETPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x169F71F0)
#define MOLEMOLE_UIHOUSERHYTHMPROPSGETPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x169F7200)
#define MOLEMOLE_UIHOUSERHYTHMPROPSGETPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x169F7270)
#define MOLEMOLE_UIHOUSERHYTHMPROPSGETPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x169F7310)
#define MOLEMOLE_UIHOUSERHYTHMPROPSGETPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x169F7420)
#define MOLEMOLE_UIHOUSERHYTHMPROPSGETPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x169F7430)
#define MOLEMOLE_UIHOUSERHYTHMPROPSGETPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x169F74D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHouseRhythmPropsGetPopWindowController_TypeDefinitionIndex = 84529;
