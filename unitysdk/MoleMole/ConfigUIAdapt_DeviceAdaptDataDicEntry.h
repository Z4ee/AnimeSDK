...
#define MOLEMOLE_CONFIGUIADAPT_DEVICEADAPTDATADICENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA844E0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIAdapt_DeviceAdaptDataDicEntry_TypeDefinitionIndex = 87328;
