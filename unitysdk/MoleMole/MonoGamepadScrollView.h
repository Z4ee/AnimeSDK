...
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_GETITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x15B3AE40)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_GET_SELECTEDINDEX_OFFSET UNITYSDK_OFFSET(0x15B39680)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_ISTEMPWORKABLE_OFFSET UNITYSDK_OFFSET(0x15B397F0)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_0B1EB5C9B94BAB66_OFFSET UNITYSDK_OFFSET(0x15B39690)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_17BD30EFE8176014_OFFSET UNITYSDK_OFFSET(0x15B3A9C0)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_361C06486F56B4E7_OFFSET UNITYSDK_OFFSET(0x15B3B7E0)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_542BC40870A64D2F_OFFSET UNITYSDK_OFFSET(0x15B39970)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_60BAB51FAB46DBD1_OFFSET UNITYSDK_OFFSET(0x15B39DF0)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_7F7EAC60E1D93F7A_OFFSET UNITYSDK_OFFSET(0x15B3A820)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_7F890042F480F391_OFFSET UNITYSDK_OFFSET(0x15B3A920)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x15B3BBC0)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_8B6FD31A446C482F_OFFSET UNITYSDK_OFFSET(0x15B3B310)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_AF0383B32411EDFF_OFFSET UNITYSDK_OFFSET(0x15B3AA20)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_C780AE0E2BA9FEE8_OFFSET UNITYSDK_OFFSET(0x15B3B580)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x15B3BB70)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x15B3B530)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_CA59D119EC839119_OFFSET UNITYSDK_OFFSET(0x15B3BBF0)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_F4DD08A31BA3F883_OFFSET UNITYSDK_OFFSET(0x15B3ABE0)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_SELECTINDEX_OFFSET UNITYSDK_OFFSET(0x15B3ACC0)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x15B3AEB0)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW___BASE_ISTEMPWORKABLE_OFFSET UNITYSDK_OFFSET(0x15B3B070)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW___BASE_ISWORKABLEINNER_OFFSET UNITYSDK_OFFSET(0x15B3B100)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x15B3B190)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW___BASE_ONMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x15B3B240)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW___BASE_ONMODULELATEUPDATE_OFFSET UNITYSDK_OFFSET(0x15B3B250)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW___BASE_ONMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x15B3B300)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGamepadScrollView_TypeDefinitionIndex = 62334;
