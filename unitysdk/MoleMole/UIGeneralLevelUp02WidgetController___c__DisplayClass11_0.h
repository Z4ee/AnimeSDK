...
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18AE16B0)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___C__DISPLAYCLASS11_0__REFRESHLEVELTXTVIEW_B__11_OFFSET UNITYSDK_OFFSET(0x18AE1710)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___C__DISPLAYCLASS11_0__REFRESHLEVELTXTVIEW_B__3_OFFSET UNITYSDK_OFFSET(0x18AE16C0)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___C__DISPLAYCLASS11_0__REFRESHLEVELTXTVIEW_B__7_OFFSET UNITYSDK_OFFSET(0x18AE1760)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___C__DISPLAYCLASS11_0__REFRESHLEVELTXTVIEW_B__8_OFFSET UNITYSDK_OFFSET(0x18AE17B0)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___C__DISPLAYCLASS11_0__REFRESHLEVELTXTVIEW_G__ONPROGRESS_0_OFFSET UNITYSDK_OFFSET(0x18AE17D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralLevelUp02WidgetController___c__DisplayClass11_0_TypeDefinitionIndex = 75473;

	class UIGeneralLevelUp02WidgetController___c__DisplayClass11_0 : public ::System::Object
	{
	public:
		::MoleMole::UIGeneralLevelUp02WidgetController* __4__this; // 0x10
		::System::Action* __9__11; // 0x18
		::System::Int32 expNeededForNxtLv; // 0x20
		::System::Int32 remainExp; // 0x24
