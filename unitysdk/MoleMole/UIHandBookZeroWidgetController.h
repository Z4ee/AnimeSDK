...
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_DOJUMP_OFFSET UNITYSDK_OFFSET(0x1525B0D0)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_HBTOABYSSENUM_OFFSET UNITYSDK_OFFSET(0x1525A1E0)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1525AFC0)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x1525AF30)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_ONREWARDBTNCLICK_OFFSET UNITYSDK_OFFSET(0x1525BF60)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_ONSHOPBTNCLICK_OFFSET UNITYSDK_OFFSET(0x1525C0F0)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1525ACF0)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1525B050)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1525A240)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1525AB90)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_REFRESHBUTTONSTATES_OFFSET UNITYSDK_OFFSET(0x1525BC50)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_REFRESHHIGHLIGHT_OFFSET UNITYSDK_OFFSET(0x1525B3B0)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_REFRESHREDEEM_OFFSET UNITYSDK_OFFSET(0x1525AD80)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1525AC70)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_UILOCKCHANGEDHANDLE_OFFSET UNITYSDK_OFFSET(0x1525C570)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1525C5C0)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER__DOJUMP_B__15_0_OFFSET UNITYSDK_OFFSET(0x1525C6A0)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1525C7D0)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x1525C860)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1525C8F0)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1525C990)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1525CA20)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1525CAB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookZeroWidgetController_TypeDefinitionIndex = 38643;

	class UIHandBookZeroWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_208CC9941471731A_520* _entry; // 0x2B8
		::System::Collections::Generic::List_1<::Class_1_1685EC66FBD28897*>* _rewards; // 0x2C0
		::System::Collections::Generic::IReadOnlyList_1<::Class_2_208CC9941471731A_1027*>* _entries; // 0x2C8
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_1027*>* _scrollEntries; // 0x2D0
		::Class_2_79F6D62CE30E3F8E_9* _view; // 0x2D8
		::MoleMole::UIHandBookZeroWidgetController_HBAbyssEntranceTypeEnum curHighLightEntry; // 0x2E0
		::System::Int32 targetIdx; // 0x2E4
