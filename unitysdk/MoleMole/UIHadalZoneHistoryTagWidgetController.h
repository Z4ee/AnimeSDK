...
#define MOLEMOLE_UIHADALZONEHISTORYTAGWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x168F9950)
#define MOLEMOLE_UIHADALZONEHISTORYTAGWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x168F99C0)
#define MOLEMOLE_UIHADALZONEHISTORYTAGWIDGETCONTROLLER_SETNUM_OFFSET UNITYSDK_OFFSET(0x168F9A80)
#define MOLEMOLE_UIHADALZONEHISTORYTAGWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x168F9D10)
#define MOLEMOLE_UIHADALZONEHISTORYTAGWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x168F9D70)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZoneHistoryTagWidgetController_TypeDefinitionIndex = 46213;
