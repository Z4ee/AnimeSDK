...
#define MOLEMOLE_MONOGMLENTICULAR_AWAKE_OFFSET UNITYSDK_OFFSET(0x117605C0)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x11764390)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_1_OFFSET UNITYSDK_OFFSET(0x11763A10)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_2_OFFSET UNITYSDK_OFFSET(0x11763BE0)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_3_OFFSET UNITYSDK_OFFSET(0x11763DC0)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_4_OFFSET UNITYSDK_OFFSET(0x11763FA0)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_5_OFFSET UNITYSDK_OFFSET(0x11764170)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_6_OFFSET UNITYSDK_OFFSET(0x117643C0)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_7_OFFSET UNITYSDK_OFFSET(0x11764590)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_8_OFFSET UNITYSDK_OFFSET(0x11764770)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_9_OFFSET UNITYSDK_OFFSET(0x11764950)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_OFFSET UNITYSDK_OFFSET(0x11763840)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x11764350)
#define MOLEMOLE_MONOGMLENTICULAR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x11761330)
#define MOLEMOLE_MONOGMLENTICULAR_OPENGMLENTICULAR_OFFSET UNITYSDK_OFFSET(0x11762A90)
#define MOLEMOLE_MONOGMLENTICULAR_RESETDATA_OFFSET UNITYSDK_OFFSET(0x11761380)
#define MOLEMOLE_MONOGMLENTICULAR_UPDATEFINALINPUTVIEW_OFFSET UNITYSDK_OFFSET(0x117633A0)
#define MOLEMOLE_MONOGMLENTICULAR_UPDATEGYROSCOPEVIEW_OFFSET UNITYSDK_OFFSET(0x11762AE0)
#define MOLEMOLE_MONOGMLENTICULAR_UPDATESTICKVIEW_OFFSET UNITYSDK_OFFSET(0x11762F50)
#define MOLEMOLE_MONOGMLENTICULAR__CTOR_OFFSET UNITYSDK_OFFSET(0x117637F0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGMLenticular_TypeDefinitionIndex = 72188;
	...
	public:
		...
		{
			return (::System::Action**)Il2CppClass::FromTypeDefinitionIndex(MonoGMLenticular_TypeDefinitionIndex)->GetStaticField(0x3A5E0);
		}
