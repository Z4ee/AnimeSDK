...
#define MOLEMOLE_MONOGMLENTICULAR_AWAKE_OFFSET UNITYSDK_OFFSET(0x15832960)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x15836560)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_1_OFFSET UNITYSDK_OFFSET(0x15835E00)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_2_OFFSET UNITYSDK_OFFSET(0x15835FE0)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_3_OFFSET UNITYSDK_OFFSET(0x158361B0)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_4_OFFSET UNITYSDK_OFFSET(0x15836390)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_5_OFFSET UNITYSDK_OFFSET(0x15836590)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_6_OFFSET UNITYSDK_OFFSET(0x15836770)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_7_OFFSET UNITYSDK_OFFSET(0x15836950)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_8_OFFSET UNITYSDK_OFFSET(0x15836B30)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_9_OFFSET UNITYSDK_OFFSET(0x15836D00)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_OFFSET UNITYSDK_OFFSET(0x15835BF0)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x15835DC0)
#define MOLEMOLE_MONOGMLENTICULAR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x158336E0)
#define MOLEMOLE_MONOGMLENTICULAR_OPENGMLENTICULAR_OFFSET UNITYSDK_OFFSET(0x15834E40)
#define MOLEMOLE_MONOGMLENTICULAR_RESETDATA_OFFSET UNITYSDK_OFFSET(0x15833730)
#define MOLEMOLE_MONOGMLENTICULAR_UPDATEFINALINPUTVIEW_OFFSET UNITYSDK_OFFSET(0x15835750)
#define MOLEMOLE_MONOGMLENTICULAR_UPDATEGYROSCOPEVIEW_OFFSET UNITYSDK_OFFSET(0x15834E90)
#define MOLEMOLE_MONOGMLENTICULAR_UPDATESTICKVIEW_OFFSET UNITYSDK_OFFSET(0x15835300)
#define MOLEMOLE_MONOGMLENTICULAR__CTOR_OFFSET UNITYSDK_OFFSET(0x15835BA0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGMLenticular_TypeDefinitionIndex = 83538;
	...
	public:
		...
		{
			return (::System::Action**)Il2CppClass::FromTypeDefinitionIndex(MonoGMLenticular_TypeDefinitionIndex)->GetStaticField(0x3C530);
		}
