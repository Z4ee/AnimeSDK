...
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER__PLAYCARDANIMASYNC_D__13_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x821700)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER__PLAYCARDANIMASYNC_D__13_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x283610)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCardOptionsAbyssS2DialogPopWindowController_CombineAnimationHelper__PlayCardAnimAsync_d__13_TypeDefinitionIndex = 58271;
	...
	struct alignas(8) UIHollowCardOptionsAbyssS2DialogPopWindowController_CombineAnimationHelper__PlayCardAnimAsync_d__13
	{
		...
		::System::Collections::Generic::List_1<::UnityEngine::GameObject*>* combineGoList; // 0x20
		...
		::MoleMole::HollowCardCombineConfig* config; // 0x40
		::Cysharp::Threading::Tasks::CompilerServices::AsyncUniTaskMethodBuilder __t__builder; // 0x48
		::System::Boolean _isSecondCombine_5__2; // 0x58
