...
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER___C__DISPLAYCLASS53_2__BUILDCLIENTMONSTERINFO_B__5_OFFSET UNITYSDK_OFFSET(0x15C745E0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER___C__DISPLAYCLASS53_2__CTOR_OFFSET UNITYSDK_OFFSET(0x15C745D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyBossInfoPageController___c__DisplayClass53_2_TypeDefinitionIndex = 79947;
