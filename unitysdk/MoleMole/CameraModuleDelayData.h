...
#define MOLEMOLE_CAMERAMODULEDELAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x11006CA0)

namespace MoleMole
{
	inline static constexpr unsigned int CameraModuleDelayData_TypeDefinitionIndex = 41956;
