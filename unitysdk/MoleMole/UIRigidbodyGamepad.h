...
#define MOLEMOLE_UIRIGIDBODYGAMEPAD_GET_UIRIGIDBODY_OFFSET UNITYSDK_OFFSET(0x11BA14B0)
#define MOLEMOLE_UIRIGIDBODYGAMEPAD_METHOD_6_07280B24DFAC0CA9_OFFSET UNITYSDK_OFFSET(0x11BA1680)
#define MOLEMOLE_UIRIGIDBODYGAMEPAD_METHOD_6_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0x11BA1A20)
#define MOLEMOLE_UIRIGIDBODYGAMEPAD_METHOD_6_5DB69D87501DF7A9_OFFSET UNITYSDK_OFFSET(0x11BA1860)
#define MOLEMOLE_UIRIGIDBODYGAMEPAD_METHOD_6_A205E8B23947BF16_OFFSET UNITYSDK_OFFSET(0x11BA1BE0)
#define MOLEMOLE_UIRIGIDBODYGAMEPAD_METHOD_6_D87A7D8243E04FD7_OFFSET UNITYSDK_OFFSET(0x11BA29B0)
#define MOLEMOLE_UIRIGIDBODYGAMEPAD__CTOR_OFFSET UNITYSDK_OFFSET(0x11BA2BB0)
#define MOLEMOLE_UIRIGIDBODYGAMEPAD___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x11BA2C90)
#define MOLEMOLE_UIRIGIDBODYGAMEPAD___BASE_ONMODULEDESTROY_OFFSET UNITYSDK_OFFSET(0x11BA2D40)
#define MOLEMOLE_UIRIGIDBODYGAMEPAD___BASE_ONMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x11BA2DD0)
#define MOLEMOLE_UIRIGIDBODYGAMEPAD___BASE_ONMODULELATEUPDATE_OFFSET UNITYSDK_OFFSET(0x11BA2DE0)
#define MOLEMOLE_UIRIGIDBODYGAMEPAD___BASE_ONMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x11BA2E90)

namespace MoleMole
{
	inline static constexpr unsigned int UIRigidbodyGamepad_TypeDefinitionIndex = 39706;
