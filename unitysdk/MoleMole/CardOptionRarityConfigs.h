...
#define MOLEMOLE_CARDOPTIONRARITYCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x16C248A0)

namespace MoleMole
{
	inline static constexpr unsigned int CardOptionRarityConfigs_TypeDefinitionIndex = 44659;
