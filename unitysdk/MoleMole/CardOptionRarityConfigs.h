...
#define MOLEMOLE_CARDOPTIONRARITYCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x13989930)

namespace MoleMole
{
	inline static constexpr unsigned int CardOptionRarityConfigs_TypeDefinitionIndex = 47894;
