...
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x14ECAE40)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___C__DISPLAYCLASS11_0__ONCLICKGETREWARD_ASYNC_B__1_OFFSET UNITYSDK_OFFSET(0x14ECAE50)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___C__DISPLAYCLASS11_0__ONCLICKGETREWARD_ASYNC_B__2_OFFSET UNITYSDK_OFFSET(0x14ECAE60)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___C__DISPLAYCLASS11_0__ONCLICKGETREWARD_ASYNC_B__3_OFFSET UNITYSDK_OFFSET(0x14ECAE90)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopLevelRewardRowWidgetController___c__DisplayClass11_0_TypeDefinitionIndex = 49748;
