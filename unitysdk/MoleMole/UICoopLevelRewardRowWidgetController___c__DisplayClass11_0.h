...
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x175C4150)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___C__DISPLAYCLASS11_0__ONCLICKGETREWARD_ASYNC_B__1_OFFSET UNITYSDK_OFFSET(0x175C4160)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___C__DISPLAYCLASS11_0__ONCLICKGETREWARD_ASYNC_B__2_OFFSET UNITYSDK_OFFSET(0x175C4170)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___C__DISPLAYCLASS11_0__ONCLICKGETREWARD_ASYNC_B__3_OFFSET UNITYSDK_OFFSET(0x175C41A0)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopLevelRewardRowWidgetController___c__DisplayClass11_0_TypeDefinitionIndex = 51346;
