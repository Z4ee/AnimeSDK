...
#define MOLEMOLE_UIWISHLISTSKILLITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x10D72830)
#define MOLEMOLE_UIWISHLISTSKILLITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x10D728C0)
#define MOLEMOLE_UIWISHLISTSKILLITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x10D72760)
#define MOLEMOLE_UIWISHLISTSKILLITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x10D727C0)
#define MOLEMOLE_UIWISHLISTSKILLITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x10D72940)
#define MOLEMOLE_UIWISHLISTSKILLITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x10D72AF0)
#define MOLEMOLE_UIWISHLISTSKILLITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x10D72B50)
#define MOLEMOLE_UIWISHLISTSKILLITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x10D72BE0)
#define MOLEMOLE_UIWISHLISTSKILLITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x10D72C70)
#define MOLEMOLE_UIWISHLISTSKILLITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x10D72D00)

namespace MoleMole
{
	inline static constexpr unsigned int UIWishlistSkillItemWidgetController_TypeDefinitionIndex = 60257;

	class UIWishlistSkillItemWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_7BEEB90214042948_11* _view; // 0x2B8
