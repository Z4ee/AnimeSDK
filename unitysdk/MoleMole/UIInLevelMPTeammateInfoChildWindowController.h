...
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER_BUILDDATABINDING_OFFSET UNITYSDK_OFFSET(0x164E3760)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER_GET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x164E2A00)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x164E29F0)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER_HIDEVIEW_OFFSET UNITYSDK_OFFSET(0x164E4430)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x164E2F50)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x164E3010)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER_ONHUDUPDATE_OFFSET UNITYSDK_OFFSET(0x164E4490)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x164E30A0)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x164E2A60)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x164E2DE0)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER_SETTEAMMATEINDEX_OFFSET UNITYSDK_OFFSET(0x164E41B0)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER_SETUPENTITY_OFFSET UNITYSDK_OFFSET(0x164E3970)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x164E3110)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER__BUILDDATABINDING_B__29_0_OFFSET UNITYSDK_OFFSET(0x164E4F40)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x164E4EE0)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x164E4DF0)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER__SETUPFOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x164E3CC0)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER__UPDATEFOLLOWANDVISIBLE_OFFSET UNITYSDK_OFFSET(0x164E4590)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER__UPDATESCALE_OFFSET UNITYSDK_OFFSET(0x164E3160)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x164E5500)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x164E5590)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x164E5620)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x164E5630)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x164E5640)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER___BASE_UPDATE_OFFSET UNITYSDK_OFFSET(0x164E56D0)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER___UPDATEFOLLOWANDVISIBLE_G____AUTOVISIBLE_36_1_OFFSET UNITYSDK_OFFSET(0x164E4B50)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER___UPDATEFOLLOWANDVISIBLE_G____ISPOINTVISIBLE_36_0_OFFSET UNITYSDK_OFFSET(0x164E4880)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelMPTeammateInfoChildWindowController_TypeDefinitionIndex = 67060;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelMPTeammateInfoChildWindowController_TypeDefinitionIndex)->GetStaticField(0xE510);
		}
		static ::System::Int32* StaticGet_ProgressShaderParamID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelMPTeammateInfoChildWindowController_TypeDefinitionIndex)->GetStaticField(0xE514);
		}
		static ::System::Int32* StaticGet_StartColorShaderParamID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelMPTeammateInfoChildWindowController_TypeDefinitionIndex)->GetStaticField(0xE518);
		}
		::Class_2_C5C76936C9D491E6_1* _view; // 0x328
