...
#define MOLEMOLE_UIMECHBOOTARGETPAGECONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x14C3F770)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechBooTargetPageControllerContext_TypeDefinitionIndex = 68432;
