...
#define MOLEMOLE_UIMECHBOOTARGETPAGECONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x182DFFC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechBooTargetPageControllerContext_TypeDefinitionIndex = 72337;
