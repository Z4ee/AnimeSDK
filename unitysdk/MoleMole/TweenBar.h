...
#define MOLEMOLE_TWEENBAR_BEGIN_1_OFFSET UNITYSDK_OFFSET(0x181A0770)
#define MOLEMOLE_TWEENBAR_BEGIN_OFFSET UNITYSDK_OFFSET(0x181A0600)
#define MOLEMOLE_TWEENBAR_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1819FD00)
#define MOLEMOLE_TWEENBAR_INITINFO_OFFSET UNITYSDK_OFFSET(0x181A02C0)
#define MOLEMOLE_TWEENBAR_METHOD_7_09C1B2AAF50AED97_OFFSET UNITYSDK_OFFSET(0x181A0380)
#define MOLEMOLE_TWEENBAR_METHOD_7_8C4AEC0BC1CA0CB4_OFFSET UNITYSDK_OFFSET(0x1819FD80)
#define MOLEMOLE_TWEENBAR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x181A0450)
#define MOLEMOLE_TWEENBAR_RESETSTART_OFFSET UNITYSDK_OFFSET(0x181A0510)
#define MOLEMOLE_TWEENBAR_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1819FD10)
#define MOLEMOLE_TWEENBAR_START_OFFSET UNITYSDK_OFFSET(0x181A0240)
#define MOLEMOLE_TWEENBAR__CTOR_OFFSET UNITYSDK_OFFSET(0x181A08A0)
#define MOLEMOLE_TWEENBAR___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x181A08D0)
#define MOLEMOLE_TWEENBAR___BASE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x181A08C0)
#define MOLEMOLE_TWEENBAR___BASE_START_OFFSET UNITYSDK_OFFSET(0x181A0960)

namespace MoleMole
{
	inline static constexpr unsigned int TweenBar_TypeDefinitionIndex = 59452;
