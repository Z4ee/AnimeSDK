...
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_CREATESUBWIDGET_1_OFFSET UNITYSDK_OFFSET(0x150F66B0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_CREATESUBWIDGET_OFFSET UNITYSDK_OFFSET(0x150F64E0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_DOALPHAOFFSET_OFFSET UNITYSDK_OFFSET(0x150F85E0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GETBATTLETEMPLATEID_OFFSET UNITYSDK_OFFSET(0x150F6370)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GETPERFORMSBEFORESUBID_OFFSET UNITYSDK_OFFSET(0x150F6E30)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GETSUBGOBYSUBID_OFFSET UNITYSDK_OFFSET(0x150F7670)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GET_HASSUBITEM_OFFSET UNITYSDK_OFFSET(0x150F8D60)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GET_SELFSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x150F8D70)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GET_TEMPLATEID_OFFSET UNITYSDK_OFFSET(0x150F7660)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GET_TEMPLATE_OFFSET UNITYSDK_OFFSET(0x150F8FE0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x150F5260)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x150F6260)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_OK_OFFSET UNITYSDK_OFFSET(0x150F7850)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONBTNCLICK_OFFSET UNITYSDK_OFFSET(0x150F5C70)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x150F5270)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONQUESTUPDATE_OFFSET UNITYSDK_OFFSET(0x150F8DA0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONSELECT_OFFSET UNITYSDK_OFFSET(0x150F7060)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x150F5940)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x150F59E0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x150F5300)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x150F58D0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONUNSELECT_OFFSET UNITYSDK_OFFSET(0x150F7180)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_REFRESHCOMPLETEVIEW_OFFSET UNITYSDK_OFFSET(0x150F7230)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_REFRESHINFOVIEW_OFFSET UNITYSDK_OFFSET(0x150F72A0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_REFRESHSCROLLVIEWCONTENTACTIVE_OFFSET UNITYSDK_OFFSET(0x150F7BD0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x150F7E90)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_RESETCOLOR_OFFSET UNITYSDK_OFFSET(0x150F7C50)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_RESETHISTORY_OFFSET UNITYSDK_OFFSET(0x150F6D50)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SELECT_OFFSET UNITYSDK_OFFSET(0x150F86C0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SETALPHAOFFSET_OFFSET UNITYSDK_OFFSET(0x150F8500)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SETROOTSELECTED_OFFSET UNITYSDK_OFFSET(0x150F8360)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SETSTAR_OFFSET UNITYSDK_OFFSET(0x150F7440)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SETSUBITEM_OFFSET UNITYSDK_OFFSET(0x150F5F60)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SET_TEMPLATE_OFFSET UNITYSDK_OFFSET(0x150F8FF0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SHOWINFO_OFFSET UNITYSDK_OFFSET(0x150F8430)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_TRIGGERBTNCLICK_OFFSET UNITYSDK_OFFSET(0x150F5AF0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER__CREATESUBWIDGET_B__9_0_OFFSET UNITYSDK_OFFSET(0x150F90F0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER__CREATESUBWIDGET_G__SETSELECTED_9_1_OFFSET UNITYSDK_OFFSET(0x150F9230)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x150F9000)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER__SETSUBITEM_B__23_0_OFFSET UNITYSDK_OFFSET(0x150F92A0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x150F92E0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x150F9370)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x150F9430)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x150F9440)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x150F9450)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainStoryRow03ChildWindowController_TypeDefinitionIndex = 77169;

	class UIMainStoryRow03ChildWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::MonoUITableScrollV2* parentScrollView; // 0x310
		::Class_2_28BDF4B69EE93815_1* _view; // 0x318
		::System::Int32 _templateID; // 0x320
		::System::Boolean _selected; // 0x324
		::System::Action_1<::System::Int32>* _clickFunc; // 0x328
		::System::Action* _callback; // 0x330
		::Class_2_208CC9941471731A_287* _template_k__BackingField; // 0x338
		::MoleMole::UIMainStoryRow03ChildWindowController_SelectImage* lastSelectItem; // 0x340
		::System::Int32 _curSubID; // 0x348
		::UIMainStoryParam* param; // 0x350
		::System::Boolean _hasSubItem; // 0x358
		::UnityEngine::Material* _selectMaterial; // 0x360
		::System::Collections::Generic::List_1<::MoleMole::UIMainStorySubitemRowChildWindowControllerV2*>* _subitems; // 0x368
		::System::Collections::Generic::List_1<::MoleMole::UIMainStorySubitemRowChildWindowControllerV2*>* selectHistory; // 0x370
		...
		::System::Void CreateSubWidget(::Class_2_208CC9941471731A_287* template_)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_287*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_CREATESUBWIDGET_OFFSET))(this, template_);
		}

		::System::Void CreateSubWidget_1(::Class_2_208CC9941471731A_287* template_, ::System::Action_2<::System::Int32, ::MoleMole::UIMainStorySubitemRowChildWindowControllerV2*>* subBtnCallback)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_287*, ::System::Action_2<::System::Int32, ::MoleMole::UIMainStorySubitemRowChildWindowControllerV2*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_CREATESUBWIDGET_1_OFFSET))(this, template_, subBtnCallback);
		}
		...
		::Class_2_208CC9941471731A_287* get_template()
		{
			return ((::Class_2_208CC9941471731A_287*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GET_TEMPLATE_OFFSET))(this);
		}

		::System::Void set_template(::Class_2_208CC9941471731A_287* value)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_287*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SET_TEMPLATE_OFFSET))(this, value);
		}
