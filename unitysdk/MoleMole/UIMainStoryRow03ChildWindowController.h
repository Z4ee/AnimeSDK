...
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_CREATESUBWIDGET_1_OFFSET UNITYSDK_OFFSET(0x16D98110)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_CREATESUBWIDGET_OFFSET UNITYSDK_OFFSET(0x16D97F40)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_DOALPHAOFFSET_OFFSET UNITYSDK_OFFSET(0x16D9A080)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GETBATTLETEMPLATEID_OFFSET UNITYSDK_OFFSET(0x16D97DD0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GETPERFORMSBEFORESUBID_OFFSET UNITYSDK_OFFSET(0x16D98880)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GETSUBGOBYSUBID_OFFSET UNITYSDK_OFFSET(0x16D990D0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GET_HASSUBITEM_OFFSET UNITYSDK_OFFSET(0x16D9A800)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GET_SELFSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x16D9A810)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GET_TEMPLATEID_OFFSET UNITYSDK_OFFSET(0x16D990C0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GET_TEMPLATE_OFFSET UNITYSDK_OFFSET(0x16D9AA60)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x16D96CB0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x16D97CC0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_OK_OFFSET UNITYSDK_OFFSET(0x16D992B0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONBTNCLICK_OFFSET UNITYSDK_OFFSET(0x16D976D0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16D96CC0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONQUESTUPDATE_OFFSET UNITYSDK_OFFSET(0x16D9A830)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONSELECT_OFFSET UNITYSDK_OFFSET(0x16D98AB0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x16D973A0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16D97440)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16D96D50)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16D97330)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONUNSELECT_OFFSET UNITYSDK_OFFSET(0x16D98BD0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_REFRESHCOMPLETEVIEW_OFFSET UNITYSDK_OFFSET(0x16D98C80)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_REFRESHINFOVIEW_OFFSET UNITYSDK_OFFSET(0x16D98CF0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_REFRESHSCROLLVIEWCONTENTACTIVE_OFFSET UNITYSDK_OFFSET(0x16D99620)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x16D998E0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_RESETCOLOR_OFFSET UNITYSDK_OFFSET(0x16D996A0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_RESETHISTORY_OFFSET UNITYSDK_OFFSET(0x16D987A0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SELECT_OFFSET UNITYSDK_OFFSET(0x16D9A160)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SETALPHAOFFSET_OFFSET UNITYSDK_OFFSET(0x16D99FA0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SETROOTSELECTED_OFFSET UNITYSDK_OFFSET(0x16D99E00)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SETSTAR_OFFSET UNITYSDK_OFFSET(0x16D98E90)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SETSUBITEM_OFFSET UNITYSDK_OFFSET(0x16D979C0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SET_TEMPLATE_OFFSET UNITYSDK_OFFSET(0x16D9AA70)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SHOWINFO_OFFSET UNITYSDK_OFFSET(0x16D99ED0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_TRIGGERBTNCLICK_OFFSET UNITYSDK_OFFSET(0x16D97550)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER__CREATESUBWIDGET_B__9_0_OFFSET UNITYSDK_OFFSET(0x16D9AB60)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER__CREATESUBWIDGET_G__SETSELECTED_9_1_OFFSET UNITYSDK_OFFSET(0x16D9ACA0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16D9AA80)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER__SETSUBITEM_B__23_0_OFFSET UNITYSDK_OFFSET(0x16D9AD10)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16D9AD40)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x16D9ADD0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16D9AE90)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16D9AEA0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16D9AEB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainStoryRow03ChildWindowController_TypeDefinitionIndex = 85162;

	class UIMainStoryRow03ChildWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::MonoUITableScrollV2* parentScrollView; // 0x318
		::Class_2_28BDF4B69EE93815_2* _view; // 0x320
		...
		::Class_2_208CC9941471731A_705* _template_k__BackingField; // 0x340
		...
		::System::Void CreateSubWidget(::Class_2_208CC9941471731A_705* template_)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_705*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_CREATESUBWIDGET_OFFSET))(this, template_);
		}

		::System::Void CreateSubWidget_1(::Class_2_208CC9941471731A_705* template_, ::System::Action_2<::System::Int32, ::MoleMole::UIMainStorySubitemRowChildWindowControllerV2*>* subBtnCallback)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_705*, ::System::Action_2<::System::Int32, ::MoleMole::UIMainStorySubitemRowChildWindowControllerV2*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_CREATESUBWIDGET_1_OFFSET))(this, template_, subBtnCallback);
		}
		...
		::Class_2_208CC9941471731A_705* get_template()
		{
			return ((::Class_2_208CC9941471731A_705*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GET_TEMPLATE_OFFSET))(this);
		}

		::System::Void set_template(::Class_2_208CC9941471731A_705* value)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_705*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SET_TEMPLATE_OFFSET))(this, value);
		}
