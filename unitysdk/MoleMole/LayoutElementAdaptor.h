...
#define MOLEMOLE_LAYOUTELEMENTADAPTOR_GET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x16B92B20)
#define MOLEMOLE_LAYOUTELEMENTADAPTOR_SET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x16B92B40)
#define MOLEMOLE_LAYOUTELEMENTADAPTOR_UPDATEPARAMS_OFFSET UNITYSDK_OFFSET(0x16B92BF0)
#define MOLEMOLE_LAYOUTELEMENTADAPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16B92BA0)

namespace MoleMole
{
	inline static constexpr unsigned int LayoutElementAdaptor_TypeDefinitionIndex = 44096;
