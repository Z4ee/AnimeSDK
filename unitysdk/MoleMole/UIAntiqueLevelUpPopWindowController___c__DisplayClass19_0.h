...
#define MOLEMOLE_UIANTIQUELEVELUPPOPWINDOWCONTROLLER___C__DISPLAYCLASS19_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19763E70)
#define MOLEMOLE_UIANTIQUELEVELUPPOPWINDOWCONTROLLER___C__DISPLAYCLASS19_0__REFRESHLEVELTXTVIEW_B__10_OFFSET UNITYSDK_OFFSET(0x19763ED0)
#define MOLEMOLE_UIANTIQUELEVELUPPOPWINDOWCONTROLLER___C__DISPLAYCLASS19_0__REFRESHLEVELTXTVIEW_B__3_OFFSET UNITYSDK_OFFSET(0x19763E80)
#define MOLEMOLE_UIANTIQUELEVELUPPOPWINDOWCONTROLLER___C__DISPLAYCLASS19_0__REFRESHLEVELTXTVIEW_B__7_OFFSET UNITYSDK_OFFSET(0x19763FC0)
#define MOLEMOLE_UIANTIQUELEVELUPPOPWINDOWCONTROLLER___C__DISPLAYCLASS19_0__REFRESHLEVELTXTVIEW_G__ONPROGRESS_0_OFFSET UNITYSDK_OFFSET(0x19763FE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAntiqueLevelUpPopWindowController___c__DisplayClass19_0_TypeDefinitionIndex = 56800;

	class UIAntiqueLevelUpPopWindowController___c__DisplayClass19_0 : public ::System::Object
	{
	public:
		::MoleMole::UIAntiqueLevelUpPopWindowController* __4__this; // 0x10
