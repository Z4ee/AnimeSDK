...
#define MOLEMOLE_MAINCITYSHOPKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x130272C0)
#define MOLEMOLE_MAINCITYSHOPKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x130272D0)
#define MOLEMOLE_MAINCITYSHOPKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x130272E0)

namespace MoleMole
{
	inline static constexpr unsigned int MainCityShopKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 64203;
