...
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER_CLICKITEMBUTTON_OFFSET UNITYSDK_OFFSET(0x187D8C70)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x187D80E0)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x187D81F0)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x187D8170)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x187D7F80)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x187D8390)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x187D8CC0)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x187D8D00)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x187D8D90)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x187D8E30)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x187D8EC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIEmoticonsTipItemWidgetController_TypeDefinitionIndex = 41062;
