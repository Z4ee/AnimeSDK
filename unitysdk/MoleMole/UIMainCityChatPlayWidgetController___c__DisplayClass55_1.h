...
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS55_1__CTOR_OFFSET UNITYSDK_OFFSET(0x15D73200)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS55_1__SHOWQUESTRECOMMEND_B__4_OFFSET UNITYSDK_OFFSET(0x15D73210)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS55_1__SHOWQUESTRECOMMEND_B__5_OFFSET UNITYSDK_OFFSET(0x15D733A0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS55_1__SHOWQUESTRECOMMEND_B__6_OFFSET UNITYSDK_OFFSET(0x15D734F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityChatPlayWidgetController___c__DisplayClass55_1_TypeDefinitionIndex = 83708;
