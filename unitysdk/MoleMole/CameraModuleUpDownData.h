...
#define MOLEMOLE_CAMERAMODULEUPDOWNDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x167EBD00)

namespace MoleMole
{
	inline static constexpr unsigned int CameraModuleUpDownData_TypeDefinitionIndex = 62377;
