...
#define MOLEMOLE_UICOOPCLUEBROKENCLUEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19589990)
#define MOLEMOLE_UICOOPCLUEBROKENCLUEWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19589A00)
#define MOLEMOLE_UICOOPCLUEBROKENCLUEWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x19589AA0)
#define MOLEMOLE_UICOOPCLUEBROKENCLUEWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x19589BB0)
#define MOLEMOLE_UICOOPCLUEBROKENCLUEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19589C90)
#define MOLEMOLE_UICOOPCLUEBROKENCLUEWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19589CF0)
#define MOLEMOLE_UICOOPCLUEBROKENCLUEWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x19589D90)
#define MOLEMOLE_UICOOPCLUEBROKENCLUEWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x19589E30)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopClueBrokenClueWidgetController_TypeDefinitionIndex = 74247;
