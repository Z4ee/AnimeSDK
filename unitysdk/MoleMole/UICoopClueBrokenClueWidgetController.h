...
#define MOLEMOLE_UICOOPCLUEBROKENCLUEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x158D6B00)
#define MOLEMOLE_UICOOPCLUEBROKENCLUEWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x158D6B70)
#define MOLEMOLE_UICOOPCLUEBROKENCLUEWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x158D6C10)
#define MOLEMOLE_UICOOPCLUEBROKENCLUEWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x158D6D20)
#define MOLEMOLE_UICOOPCLUEBROKENCLUEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x158D6E00)
#define MOLEMOLE_UICOOPCLUEBROKENCLUEWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x158D6E60)
#define MOLEMOLE_UICOOPCLUEBROKENCLUEWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x158D6F00)
#define MOLEMOLE_UICOOPCLUEBROKENCLUEWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x158D6FA0)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopClueBrokenClueWidgetController_TypeDefinitionIndex = 54240;
