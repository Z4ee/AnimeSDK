...
#define MOLEMOLE_CONFIGGALGAMEAVATARSHOWSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4F6E30)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigGalGameAvatarShowSettings_TypeDefinitionIndex = 71767;
