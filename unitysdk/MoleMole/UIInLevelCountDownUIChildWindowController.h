...
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_CLEARTIMEOUTCALLBACK_OFFSET UNITYSDK_OFFSET(0x199ECA50)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_CLOSETIMER_OFFSET UNITYSDK_OFFSET(0x199ED270)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_COUNTDOWNUI_CHANGETIMEWIDGET_OFFSET UNITYSDK_OFFSET(0x199ED500)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x199EC500)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x199EC510)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x199EC7B0)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x199EC850)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x199EC5A0)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x199EC5F0)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_OPENTIMER_OFFSET UNITYSDK_OFFSET(0x199ECFB0)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_PAUSE_OFFSET UNITYSDK_OFFSET(0x199ED470)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_SETTIMEOUTCALLBACK_OFFSET UNITYSDK_OFFSET(0x199ECA00)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_SHOWBONUSTIME_OFFSET UNITYSDK_OFFSET(0x199ED630)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_TICKTIMER_OFFSET UNITYSDK_OFFSET(0x199EC920)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_UPDATEFIXEDTEXT_OFFSET UNITYSDK_OFFSET(0x199ED3D0)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_UPDATETIMER_OFFSET UNITYSDK_OFFSET(0x199ECE00)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x199EC8C0)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x199ED8A0)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER__EASEADDTIME_OFFSET UNITYSDK_OFFSET(0x199ED5A0)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER__GETTIMER_OFFSET UNITYSDK_OFFSET(0x199ECAA0)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER__TRYCORETIMER_OFFSET UNITYSDK_OFFSET(0x199ECD40)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x199ED9D0)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x199EDA60)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x199EDB20)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x199EDB30)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x199EDB40)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER___GETTIMER_B__15_0_OFFSET UNITYSDK_OFFSET(0x199ED910)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER___GETTIMER_B__15_1_OFFSET UNITYSDK_OFFSET(0x199ED970)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelCountDownUIChildWindowController_TypeDefinitionIndex = 43861;
	...
	public:
		...
		::Class_0_16E4307DCC419505_288* _rowContainer; // 0x318
		...
		::Class_2_52D7D0A9B3EFD5B8* _view; // 0x340
