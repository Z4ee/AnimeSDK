...
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___C__DISPLAYCLASS58_0__CTOR_OFFSET UNITYSDK_OFFSET(0x12FDC7E0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___C__DISPLAYCLASS58_0__GETFRIENDNETWORKDATA_B__0_OFFSET UNITYSDK_OFFSET(0x12FDC7F0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___C__DISPLAYCLASS58_0__GETFRIENDNETWORKDATA_B__1_OFFSET UNITYSDK_OFFSET(0x12FDC8D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoWallPageController___c__DisplayClass58_0_TypeDefinitionIndex = 61311;
