...
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___C__DISPLAYCLASS58_0__CTOR_OFFSET UNITYSDK_OFFSET(0xEB7BDE0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___C__DISPLAYCLASS58_0__GETFRIENDNETWORKDATA_B__0_OFFSET UNITYSDK_OFFSET(0xEB7BDF0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___C__DISPLAYCLASS58_0__GETFRIENDNETWORKDATA_B__1_OFFSET UNITYSDK_OFFSET(0xEB7BED0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoWallPageController___c__DisplayClass58_0_TypeDefinitionIndex = 66544;
