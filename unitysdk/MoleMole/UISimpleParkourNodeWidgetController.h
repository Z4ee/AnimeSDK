...
#define MOLEMOLE_UISIMPLEPARKOURNODEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x119E94C0)
#define MOLEMOLE_UISIMPLEPARKOURNODEWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x119E9530)
#define MOLEMOLE_UISIMPLEPARKOURNODEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x119E95D0)
#define MOLEMOLE_UISIMPLEPARKOURNODEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x119E9900)
#define MOLEMOLE_UISIMPLEPARKOURNODEWIDGETCONTROLLER__ONUIINIT_B__6_0_OFFSET UNITYSDK_OFFSET(0x119E9960)
#define MOLEMOLE_UISIMPLEPARKOURNODEWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x119EA0E0)
#define MOLEMOLE_UISIMPLEPARKOURNODEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x119EA180)

namespace MoleMole
{
	inline static constexpr unsigned int UISimpleParkourNodeWidgetController_TypeDefinitionIndex = 64438;
	...
	public:
		...
		{
			return ((::Class_2_EC28E1D3A39EE7DE_7*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UISIMPLEPARKOURNODEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
