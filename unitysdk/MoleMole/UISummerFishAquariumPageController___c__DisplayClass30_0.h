...
#define MOLEMOLE_UISUMMERFISHAQUARIUMPAGECONTROLLER___C__DISPLAYCLASS30_0__CTOR_OFFSET UNITYSDK_OFFSET(0x12C77080)
#define MOLEMOLE_UISUMMERFISHAQUARIUMPAGECONTROLLER___C__DISPLAYCLASS30_0__ONCLICKPUTFISHBTN_B__0_OFFSET UNITYSDK_OFFSET(0x12C77090)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerFishAquariumPageController___c__DisplayClass30_0_TypeDefinitionIndex = 86952;
