...
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_AUTOPUSHINNER_OFFSET UNITYSDK_OFFSET(0x178CCFA0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_CHANGEGUESTPLATE_OFFSET UNITYSDK_OFFSET(0x178D0930)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_CHANGEMODULESTATE_OFFSET UNITYSDK_OFFSET(0x178CA510)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_CLEARDRAGDATA_OFFSET UNITYSDK_OFFSET(0x178CA470)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_CREATEFUNC_OFFSET UNITYSDK_OFFSET(0x178CBEE0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_CREATENEWDISHOBJECT_OFFSET UNITYSDK_OFFSET(0x178CD5D0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_CREATEPREORDERDISHOBJECT_OFFSET UNITYSDK_OFFSET(0x178D1260)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ENDDRAG_OFFSET UNITYSDK_OFFSET(0x178CAE40)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_GETDISHITEMCONTEXT_OFFSET UNITYSDK_OFFSET(0x178CC820)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_GETDISHITEMLISTINDEX_OFFSET UNITYSDK_OFFSET(0x178D1B10)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_GETGUESTDELICIOUSNESS_OFFSET UNITYSDK_OFFSET(0x178D3760)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_GETGUESTHEALTH_OFFSET UNITYSDK_OFFSET(0x178D3920)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_GETITEMWIDGET_OFFSET UNITYSDK_OFFSET(0x178CCB20)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_GETOBJECTCONTROL_OFFSET UNITYSDK_OFFSET(0x178D1F40)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_GETREALINDEX_OFFSET UNITYSDK_OFFSET(0x178CC130)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x178C79D0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x178C79E0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ISGUESTHAVESPECIFICDISHID_OFFSET UNITYSDK_OFFSET(0x178D3AE0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_MODIFYFILLPERCENTCONTENT_OFFSET UNITYSDK_OFFSET(0x178D2E00)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONBEGINDRAGCONTROL_OFFSET UNITYSDK_OFFSET(0x178D2A80)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONCLICKOBJECT_OFFSET UNITYSDK_OFFSET(0x178D2740)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONCLICKREMOVE_OFFSET UNITYSDK_OFFSET(0x178D2130)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0x178D07E0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONCLOSEBTNCLICK_OFFSET UNITYSDK_OFFSET(0x178D3EF0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x178C79F0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONDELBTNCLICK_OFFSET UNITYSDK_OFFSET(0x178D3F90)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONDRAGCONTROL_OFFSET UNITYSDK_OFFSET(0x178D2BC0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONDRAGCUREDITOBJECTCONSOLE_OFFSET UNITYSDK_OFFSET(0x178CACE0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONDRAGFROMCHILD_OFFSET UNITYSDK_OFFSET(0x178CC010)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONDRAGSINGLEOBJECT_OFFSET UNITYSDK_OFFSET(0x178CBCF0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0x178D2C60)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONEMPTYSUBMITTIPBTNCLICK_OFFSET UNITYSDK_OFFSET(0x178CABF0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONENDDRAGCONTROL_OFFSET UNITYSDK_OFFSET(0x178D2CE0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x178D2D90)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x178C9B20)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONNUMCHANGE_OFFSET UNITYSDK_OFFSET(0x178CDEA0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONSELECTCHILD_OFFSET UNITYSDK_OFFSET(0x178CC360)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONSTARTDRAG_OFFSET UNITYSDK_OFFSET(0x178D2B40)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONSUBMITBTNCLICK_OFFSET UNITYSDK_OFFSET(0x178D3BC0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x178CB220)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x178C7A80)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x178C7F00)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_REFRESHGUESTTABINFO_OFFSET UNITYSDK_OFFSET(0x178D3200)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_REFRESHITEMLIST_OFFSET UNITYSDK_OFFSET(0x178C9530)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_REFRESHSUBMITBUTTONSTATE_OFFSET UNITYSDK_OFFSET(0x178D3000)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_REFRESHTABINFO_OFFSET UNITYSDK_OFFSET(0x178C8890)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_REMOVECURPLATEOBJ_OFFSET UNITYSDK_OFFSET(0x178CC8F0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_RESORTITEMLIST_OFFSET UNITYSDK_OFFSET(0x178D19B0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_REVERTDRAGOP_OFFSET UNITYSDK_OFFSET(0x178CA250)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_SCREENTOWORLDPOS_OFFSET UNITYSDK_OFFSET(0x178D2020)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_SETGUESTLIST_OFFSET UNITYSDK_OFFSET(0x178C8790)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_SETREDGREENLIST_OFFSET UNITYSDK_OFFSET(0x178C83B0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_SHOWBOTTOMTIP_OFFSET UNITYSDK_OFFSET(0x178CCD20)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_STARTDRAGCUREDITOBJECTCONSOLE_OFFSET UNITYSDK_OFFSET(0x178CDBE0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_STARTDRAGNEWOBJECT_OFFSET UNITYSDK_OFFSET(0x178CC2F0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_STARTDRAGSINGLEOBJECT_OFFSET UNITYSDK_OFFSET(0x178D1BC0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_STARTEDITSINGLEOBJECT_OFFSET UNITYSDK_OFFSET(0x178CD850)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_STOPEDITSINGLEOBJECT_OFFSET UNITYSDK_OFFSET(0x178D23C0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x178CB670)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x178D4360)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER__ONDELBTNCLICK_B__75_0_OFFSET UNITYSDK_OFFSET(0x178D4A60)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER__ONNUMCHANGE_B__69_0_OFFSET UNITYSDK_OFFSET(0x178D47D0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER__RESORTITEMLIST_B__43_0_OFFSET UNITYSDK_OFFSET(0x178D4550)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER__SHOWBOTTOMTIP_B__80_0_OFFSET UNITYSDK_OFFSET(0x178D4AC0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER__SHOWBOTTOMTIP_B__80_1_OFFSET UNITYSDK_OFFSET(0x178D4B60)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x178D4B90)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x178D4C20)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x178D4C50)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x178D4C60)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x178D4C70)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastServePageController_TypeDefinitionIndex = 46514;

	class UIOverlordFeastServePageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_55* _view; // 0x318
		::MoleMole::UIOverlordFeastServePageContext* _context; // 0x320
		::Class_2_B1555FA59A3F87CE* _model; // 0x328
		::Class_2_208CC9941471731A_364* _gameConfig; // 0x330
		::Class_2_208CC9941471731A_1035* _guestConfig; // 0x338
		...
		{
			return ((::MoleMole::ScrollViewItemWidgetController*(*)(::PVOID, ::Enum_3_7A4252233BCEB3A9, ::System::Func_1<::MoleMole::UIControlReference*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_CREATEFUNC_OFFSET))(this, arg1, arg2);
		}
