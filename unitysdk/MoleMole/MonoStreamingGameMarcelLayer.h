...
#define MOLEMOLE_MONOSTREAMINGGAMEMARCELLAYER_AWAKE_OFFSET UNITYSDK_OFFSET(0x13852CB0)
#define MOLEMOLE_MONOSTREAMINGGAMEMARCELLAYER_ONASSOCIATEDENTITYREMOVED_OFFSET UNITYSDK_OFFSET(0x13853180)
#define MOLEMOLE_MONOSTREAMINGGAMEMARCELLAYER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x13852DC0)
#define MOLEMOLE_MONOSTREAMINGGAMEMARCELLAYER_RESETBLOCKS_OFFSET UNITYSDK_OFFSET(0x13852FD0)
#define MOLEMOLE_MONOSTREAMINGGAMEMARCELLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x13853250)
#define MOLEMOLE_MONOSTREAMINGGAMEMARCELLAYER___BASE_ONASSOCIATEDENTITYREMOVED_OFFSET UNITYSDK_OFFSET(0x138532F0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoStreamingGameMarcelLayer_TypeDefinitionIndex = 63119;
