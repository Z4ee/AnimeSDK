...
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19F052A0)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL___C__DISPLAYCLASS1_0__REFRESHVIEWWITHMODEL_B__0_OFFSET UNITYSDK_OFFSET(0x19F052B0)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL___C__DISPLAYCLASS1_0__REFRESHVIEWWITHMODEL_B__1_OFFSET UNITYSDK_OFFSET(0x19F05460)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralToggleWidgetControllerWithModel___c__DisplayClass1_0_TypeDefinitionIndex = 54120;

	class UIGeneralToggleWidgetControllerWithModel___c__DisplayClass1_0 : public ::System::Object
	{
	public:
		::Class_0_16E4307DCC419505_159<::System::Boolean>* model; // 0x10
		::MoleMole::UIGeneralToggleWidgetControllerWithModel* __4__this; // 0x18
