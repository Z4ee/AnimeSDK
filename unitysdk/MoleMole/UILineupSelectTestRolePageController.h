...
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER_BIND_OFFSET UNITYSDK_OFFSET(0x174D0A60)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER_DESTROYALLUNIT_OFFSET UNITYSDK_OFFSET(0x174D0BF0)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER_GETALLAVATARIDS_OFFSET UNITYSDK_OFFSET(0x174D1890)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER_GETSHOWAVATARID_OFFSET UNITYSDK_OFFSET(0x174D1200)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x174CFF60)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER_INITUI_OFFSET UNITYSDK_OFFSET(0x174D0070)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER_LOADRTMODELFINISHED_OFFSET UNITYSDK_OFFSET(0x174D1840)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x174D0930)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x174CFF70)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x174D0B80)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x174D09C0)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER_SELECTROLE_OFFSET UNITYSDK_OFFSET(0x174D12F0)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER_SETMODELACTIVE_OFFSET UNITYSDK_OFFSET(0x174D0760)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER_SETROLEIMAGEACTIVE_OFFSET UNITYSDK_OFFSET(0x174D0D60)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x174D19A0)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x174D1AE0)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x174D1B70)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x174D1B80)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x174D1B90)

namespace MoleMole
{
	inline static constexpr unsigned int UILineupSelectTestRolePageController_TypeDefinitionIndex = 81537;

	class UILineupSelectTestRolePageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_A0E3DEDE1BCD4C13* _view; // 0x318
