...
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_CUSTOMCONDITIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16CB0280)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_CUSTOMCONDITIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16CB02F0)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_CUSTOMCONDITIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x16CAFF90)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_CUSTOMCONDITIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x16CAFF70)

namespace MoleMole
{
	inline static constexpr unsigned int GroupChallengeSubsystem_CustomConditionCallback_TypeDefinitionIndex = 56540;
