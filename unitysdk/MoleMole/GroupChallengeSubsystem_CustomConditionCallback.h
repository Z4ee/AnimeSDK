...
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_CUSTOMCONDITIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x13A93D00)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_CUSTOMCONDITIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x13A93D70)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_CUSTOMCONDITIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x13A93A00)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_CUSTOMCONDITIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x13A939E0)

namespace MoleMole
{
	inline static constexpr unsigned int GroupChallengeSubsystem_CustomConditionCallback_TypeDefinitionIndex = 48657;
