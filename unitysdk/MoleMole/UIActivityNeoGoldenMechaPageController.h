...
#define MOLEMOLE_UIACTIVITYNEOGOLDENMECHAPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x18E131B0)
#define MOLEMOLE_UIACTIVITYNEOGOLDENMECHAPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18E131C0)
#define MOLEMOLE_UIACTIVITYNEOGOLDENMECHAPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18E13230)
#define MOLEMOLE_UIACTIVITYNEOGOLDENMECHAPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18E132F0)
#define MOLEMOLE_UIACTIVITYNEOGOLDENMECHAPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x18E13450)
#define MOLEMOLE_UIACTIVITYNEOGOLDENMECHAPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18E134F0)
#define MOLEMOLE_UIACTIVITYNEOGOLDENMECHAPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18E13500)
#define MOLEMOLE_UIACTIVITYNEOGOLDENMECHAPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18E135A0)
#define MOLEMOLE_UIACTIVITYNEOGOLDENMECHAPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x18E13640)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityNeoGoldenMechaPageController_TypeDefinitionIndex = 78935;
