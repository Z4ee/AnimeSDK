...
#define MOLEMOLE_UINEWSSTANDCONTENTWIDGETCONTROLLER_CREATESTYLEWIDGETNEW_OFFSET UNITYSDK_OFFSET(0x15DD1A60)
#define MOLEMOLE_UINEWSSTANDCONTENTWIDGETCONTROLLER_ENABLEFOCUS_OFFSET UNITYSDK_OFFSET(0x15DD1E70)
#define MOLEMOLE_UINEWSSTANDCONTENTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15DD1D00)
#define MOLEMOLE_UINEWSSTANDCONTENTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15DD1D90)
#define MOLEMOLE_UINEWSSTANDCONTENTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15DD1870)
#define MOLEMOLE_UINEWSSTANDCONTENTWIDGETCONTROLLER_SHOWDETAILWINDOW_OFFSET UNITYSDK_OFFSET(0x15DD1E10)
#define MOLEMOLE_UINEWSSTANDCONTENTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15DD1ED0)
#define MOLEMOLE_UINEWSSTANDCONTENTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15DD1F30)
#define MOLEMOLE_UINEWSSTANDCONTENTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15DD1FC0)
#define MOLEMOLE_UINEWSSTANDCONTENTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15DD2050)

namespace MoleMole
{
	inline static constexpr unsigned int UINewsStandContentWidgetController_TypeDefinitionIndex = 72143;

	class UINewsStandContentWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_949134FE88CA671F* _view; // 0x2B8
		::MoleMole::UINewsStyleWidgetController* _styleWidget; // 0x2C0
