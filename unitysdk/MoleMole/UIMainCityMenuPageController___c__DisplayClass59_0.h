...
#define MOLEMOLE_UIMAINCITYMENUPAGECONTROLLER___C__DISPLAYCLASS59_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19865D80)
#define MOLEMOLE_UIMAINCITYMENUPAGECONTROLLER___C__DISPLAYCLASS59_0__ONOPENBATTLEPASS_B__0_OFFSET UNITYSDK_OFFSET(0x19865D90)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityMenuPageController___c__DisplayClass59_0_TypeDefinitionIndex = 41748;
