...
#define MOLEMOLE_UIMAINCITYMENUPAGECONTROLLER___C__DISPLAYCLASS59_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16D95FE0)
#define MOLEMOLE_UIMAINCITYMENUPAGECONTROLLER___C__DISPLAYCLASS59_0__ONOPENBATTLEPASS_B__0_OFFSET UNITYSDK_OFFSET(0x16D95FF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityMenuPageController___c__DisplayClass59_0_TypeDefinitionIndex = 84834;
