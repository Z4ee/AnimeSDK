...
#define MOLEMOLE_FLOORSUBSYSTEM_SPLINEMETA_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8157E0)
#define MOLEMOLE_FLOORSUBSYSTEM_SPLINEMETA_EQUALS_OFFSET UNITYSDK_OFFSET(0x815770)
#define MOLEMOLE_FLOORSUBSYSTEM_SPLINEMETA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8157F0)
#define MOLEMOLE_FLOORSUBSYSTEM_SPLINEMETA_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x161CC7A0)
#define MOLEMOLE_FLOORSUBSYSTEM_SPLINEMETA_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x161CC5D0)
#define MOLEMOLE_FLOORSUBSYSTEM_SPLINEMETA_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x161CC560)
#define MOLEMOLE_FLOORSUBSYSTEM_SPLINEMETA_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x161CC850)
#define MOLEMOLE_FLOORSUBSYSTEM_SPLINEMETA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x815740)
#define MOLEMOLE_FLOORSUBSYSTEM_SPLINEMETA__CTOR_OFFSET UNITYSDK_OFFSET(0x815740)
#define MOLEMOLE_FLOORSUBSYSTEM_SPLINEMETA___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x815840)
#define MOLEMOLE_FLOORSUBSYSTEM_SPLINEMETA___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8158B0)

namespace MoleMole
{
	inline static constexpr unsigned int FloorSubsystem_SplineMeta_TypeDefinitionIndex = 40437;
