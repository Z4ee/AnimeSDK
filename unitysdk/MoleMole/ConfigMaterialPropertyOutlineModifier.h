...
#define MOLEMOLE_CONFIGMATERIALPROPERTYOUTLINEMODIFIER_DOAFTERONENTER_OFFSET UNITYSDK_OFFSET(0x1A00D0E0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYOUTLINEMODIFIER_DOONENTER_OFFSET UNITYSDK_OFFSET(0x1A00D020)
#define MOLEMOLE_CONFIGMATERIALPROPERTYOUTLINEMODIFIER_DOWARMUP_OFFSET UNITYSDK_OFFSET(0x1A00DCC0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYOUTLINEMODIFIER_PREPAREONENTER_OFFSET UNITYSDK_OFFSET(0x1A00CEC0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYOUTLINEMODIFIER_PREPAREONEXIT_OFFSET UNITYSDK_OFFSET(0x1A00D1D0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYOUTLINEMODIFIER_PROCESSENTER_OFFSET UNITYSDK_OFFSET(0x1A00D140)
#define MOLEMOLE_CONFIGMATERIALPROPERTYOUTLINEMODIFIER_PROCESSEXIT_OFFSET UNITYSDK_OFFSET(0x1A00D210)
#define MOLEMOLE_CONFIGMATERIALPROPERTYOUTLINEMODIFIER_PROCESSKEEP_OFFSET UNITYSDK_OFFSET(0x1A00D6B0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYOUTLINEMODIFIER_SYNCENABLES_OFFSET UNITYSDK_OFFSET(0x1A00D4B0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYOUTLINEMODIFIER_SYNCVALUES_OFFSET UNITYSDK_OFFSET(0x1A00D300)
#define MOLEMOLE_CONFIGMATERIALPROPERTYOUTLINEMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A00DD50)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigMaterialPropertyOutlineModifier_TypeDefinitionIndex = 65100;

	class ConfigMaterialPropertyOutlineModifier : public ::MoleMole::ConfigMaterialPropertyModifier
	{
	public:
		::MoleMole::MaterialPropertyModifierValueColor _OutlineColor; // 0x48
		::MoleMole::MaterialPropertyModifierValueFloat _MaxOutlineZOffset; // 0x5C
