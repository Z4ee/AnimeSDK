...
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER_GETASSETPATH_OFFSET UNITYSDK_OFFSET(0x152505F0)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15250490)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15250520)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x152503C0)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15250420)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER_SETASSETPATHGETTER_OFFSET UNITYSDK_OFFSET(0x152505A0)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER_SETSHOWLEVEL_OFFSET UNITYSDK_OFFSET(0x15250720)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x152507B0)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15250810)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x152508A0)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15250930)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x152509C0)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaRewardLevelWidgetController_TypeDefinitionIndex = 86209;
