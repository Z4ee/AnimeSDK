...
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER_GETASSETPATH_OFFSET UNITYSDK_OFFSET(0x14E84480)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14E84320)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14E843B0)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14E84250)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14E842B0)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER_SETASSETPATHGETTER_OFFSET UNITYSDK_OFFSET(0x14E84430)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER_SETSHOWLEVEL_OFFSET UNITYSDK_OFFSET(0x14E845B0)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14E84640)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14E846A0)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14E84730)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14E847C0)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14E84850)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaRewardLevelWidgetController_TypeDefinitionIndex = 59831;

	class UICinemaRewardLevelWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_94C9713A8E4B253E_2* _view; // 0x2B8
		::System::Func_3<::System::Int32, ::System::Boolean, ::Foundation::AssetPath>* _assetPathGetter; // 0x2C0
		::System::Threading::CancellationTokenSource* effectTokenSource; // 0x2C8
