...
#define MOLEMOLE_MONOSLIDINGPANEL_CLASS_1_0A3E4B8C39F127F7_DISPOSE_OFFSET UNITYSDK_OFFSET(0x173944F0)
#define MOLEMOLE_MONOSLIDINGPANEL_CLASS_1_0A3E4B8C39F127F7_METHOD_1_154217890BB9535A_OFFSET UNITYSDK_OFFSET(0x17394580)
#define MOLEMOLE_MONOSLIDINGPANEL_CLASS_1_0A3E4B8C39F127F7_METHOD_1_AA6AC38756233BD0_OFFSET UNITYSDK_OFFSET(0x17394530)
#define MOLEMOLE_MONOSLIDINGPANEL_CLASS_1_0A3E4B8C39F127F7_METHOD_1_D937CCF249E8F991_OFFSET UNITYSDK_OFFSET(0x17394640)
#define MOLEMOLE_MONOSLIDINGPANEL_CLASS_1_0A3E4B8C39F127F7__CTOR_OFFSET UNITYSDK_OFFSET(0x173944E0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoSlidingPanel_Class_1_0A3E4B8C39F127F7_TypeDefinitionIndex = 47979;
