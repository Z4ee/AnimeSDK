...
#define MOLEMOLE_MONOSLIDINGPANEL_CLASS_1_0A3E4B8C39F127F7_DISPOSE_OFFSET UNITYSDK_OFFSET(0x164214E0)
#define MOLEMOLE_MONOSLIDINGPANEL_CLASS_1_0A3E4B8C39F127F7_METHOD_1_154217890BB9535A_OFFSET UNITYSDK_OFFSET(0x16421570)
#define MOLEMOLE_MONOSLIDINGPANEL_CLASS_1_0A3E4B8C39F127F7_METHOD_1_AA6AC38756233BD0_OFFSET UNITYSDK_OFFSET(0x16421520)
#define MOLEMOLE_MONOSLIDINGPANEL_CLASS_1_0A3E4B8C39F127F7_METHOD_1_D937CCF249E8F991_OFFSET UNITYSDK_OFFSET(0x16421630)
#define MOLEMOLE_MONOSLIDINGPANEL_CLASS_1_0A3E4B8C39F127F7__CTOR_OFFSET UNITYSDK_OFFSET(0x164214D0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoSlidingPanel_Class_1_0A3E4B8C39F127F7_TypeDefinitionIndex = 43433;

	class MonoSlidingPanel_Class_1_0A3E4B8C39F127F7 : public ::System::Object
	{
	public:
		::Class_1_411D412FA13B6F21<::Struct_2_FBA4730A60751401>* Field_1_0; // 0x10

		::System::Void _ctor(::Class_1_411D412FA13B6F21<::Struct_2_FBA4730A60751401>* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_411D412FA13B6F21<::Struct_2_FBA4730A60751401>*))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOSLIDINGPANEL_CLASS_1_0A3E4B8C39F127F7__CTOR_OFFSET))(this, a1);
		}
