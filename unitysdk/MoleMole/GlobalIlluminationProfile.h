...
#define MOLEMOLE_GLOBALILLUMINATIONPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x1261F1C0)
#define MOLEMOLE_GLOBALILLUMINATIONPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x1261F300)
#define MOLEMOLE_GLOBALILLUMINATIONPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x1261F0E0)
#define MOLEMOLE_GLOBALILLUMINATIONPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1261F280)
#define MOLEMOLE_GLOBALILLUMINATIONPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x1261F0D0)
#define MOLEMOLE_GLOBALILLUMINATIONPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1261F420)
#define MOLEMOLE_GLOBALILLUMINATIONPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x1261F4B0)
#define MOLEMOLE_GLOBALILLUMINATIONPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x1261F540)
#define MOLEMOLE_GLOBALILLUMINATIONPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1261F5D0)

namespace MoleMole
{
	inline static constexpr unsigned int GlobalIlluminationProfile_TypeDefinitionIndex = 71065;
