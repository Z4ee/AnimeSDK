...
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_BUILDCLIENTMONSTERINFO_OFFSET UNITYSDK_OFFSET(0x13FD3240)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_CLOSE_OFFSET UNITYSDK_OFFSET(0x13FD6E60)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_DOLINEUPINDEX_OFFSET UNITYSDK_OFFSET(0x13FDC100)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_GET_ALLMONSTERTURNBASEDTEMPLATES_OFFSET UNITYSDK_OFFSET(0x13FD1FE0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_GET_CURSELECTMONSTERCARDTEMPLATE_OFFSET UNITYSDK_OFFSET(0x13FD1EA0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_GET_CURSELECTMONSTERTEMPLATE_OFFSET UNITYSDK_OFFSET(0x13FD1BE0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_GET_CURTURNBASEDENTITYTEMPLATE_OFFSET UNITYSDK_OFFSET(0x13FD1D30)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_GET_IGNOREFADING_OFFSET UNITYSDK_OFFSET(0x13FD20F0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_GET_ISENABLEFADEINPUTBLOCKING_OFFSET UNITYSDK_OFFSET(0x13FD20E0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x13FD1BD0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONBACKBTNCLICK_OFFSET UNITYSDK_OFFSET(0x13FDB6E0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONCHECKBTNCLICK_OFFSET UNITYSDK_OFFSET(0x13FDB9B0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONCOMPLETEBTNCLICK_OFFSET UNITYSDK_OFFSET(0x13FDB960)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x13FD2100)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONCREATFRIENDCARDITEM_OFFSET UNITYSDK_OFFSET(0x13FDBC90)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x13FD7B20)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONINFOBTNCLICK_OFFSET UNITYSDK_OFFSET(0x13FDBAE0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x13FD7900)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONLINEUPINDEX_OFFSET UNITYSDK_OFFSET(0x13FDBE30)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONRECEIVENEWBIE_OFFSET UNITYSDK_OFFSET(0x13FDC240)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x13FDBEA0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONTABCLICK_OFFSET UNITYSDK_OFFSET(0x13FDBD90)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x13FD75E0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x13FD7890)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x13FD2190)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x13FD2850)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_REFRESHBTNVIEW_OFFSET UNITYSDK_OFFSET(0x13FD8A60)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_REFRESHBUFFVIEW_OFFSET UNITYSDK_OFFSET(0x13FDA500)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_REFRESHRIGHTVIEW_OFFSET UNITYSDK_OFFSET(0x13FD87A0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_REFRESHSKILLVIEW_OFFSET UNITYSDK_OFFSET(0x13FD8E90)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_REFRESHTAGVIEW_OFFSET UNITYSDK_OFFSET(0x13FD7DB0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_REFRESHTITLEANDBG_OFFSET UNITYSDK_OFFSET(0x13FD8660)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x13FD6010)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_SHOULDSHOWBUFFNUMBER_OFFSET UNITYSDK_OFFSET(0x13FD8D50)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_TRYOVERRIDESHOULDIGNOREITEM_OFFSET UNITYSDK_OFFSET(0x13FD7CB0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER__CLOSE_B__46_0_OFFSET UNITYSDK_OFFSET(0x13FDC740)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x13FDC290)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER__ONUIINIT_B__44_0_OFFSET UNITYSDK_OFFSET(0x13FDC2E0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER__ONUIOPEN_B__45_0_OFFSET UNITYSDK_OFFSET(0x13FDC2F0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER__ONUIOPEN_B__45_1_OFFSET UNITYSDK_OFFSET(0x13FDC310)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER__ONUIOPEN_B__45_3_OFFSET UNITYSDK_OFFSET(0x13FDC360)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER__ONUIOPEN_B__45_4_OFFSET UNITYSDK_OFFSET(0x13FDC3E0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER__ONUIOPEN_B__45_5_OFFSET UNITYSDK_OFFSET(0x13FDC550)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER__ONUIOPEN_B__45_6_OFFSET UNITYSDK_OFFSET(0x13FDC5D0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER__REFRESHVIEW_B__52_0_OFFSET UNITYSDK_OFFSET(0x13FDC750)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER___BASE_CLOSE_OFFSET UNITYSDK_OFFSET(0x13FDC7A0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x13FDC7B0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x13FDC840)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x13FDC8F0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x13FDC980)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x13FDCA40)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x13FDCA50)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x13FDCA60)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER___BASE_TRYOVERRIDESHOULDIGNOREITEM_OFFSET UNITYSDK_OFFSET(0x13FDCAF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyBossInfoPageController_TypeDefinitionIndex = 79937;
	...
	public:
		...
		::Class_2_7B15B3118FE590CD_34* _view; // 0x310
		...
		::System::Collections::Generic::List_1<::UnityEngine::Material*>* _colorMats; // 0x380
		::MoleMole::MonoGamepadRegion_ManagedModuleConfig _skillGamePadConfig; // 0x388
		::MoleMole::MonoGamepadRegion_ManagedModuleConfig _buffGamePadConfig; // 0x398
		::MoleMole::MonoGamepadRegion_ManagedModuleConfig _skillGamePadDescConfig; // 0x3A8
		::MoleMole::MonoGamepadRegion_ManagedModuleConfig _buffGamePadDescConfig; // 0x3B8
		...
		::System::Boolean _RefreshView_b__52_0(::Class_2_208CC9941471731A_1037* x)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_2_208CC9941471731A_1037*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER__REFRESHVIEW_B__52_0_OFFSET))(this, x);
		}
