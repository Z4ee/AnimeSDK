...
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_BUILDCLIENTMONSTERINFO_OFFSET UNITYSDK_OFFSET(0x168D75A0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_CLOSE_OFFSET UNITYSDK_OFFSET(0x168DB1F0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_DOLINEUPINDEX_OFFSET UNITYSDK_OFFSET(0x168E0550)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_GET_ALLMONSTERTURNBASEDTEMPLATES_OFFSET UNITYSDK_OFFSET(0x168D6370)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_GET_CURSELECTMONSTERCARDTEMPLATE_OFFSET UNITYSDK_OFFSET(0x168D6220)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_GET_CURSELECTMONSTERTEMPLATE_OFFSET UNITYSDK_OFFSET(0x168D5F60)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_GET_CURTURNBASEDENTITYTEMPLATE_OFFSET UNITYSDK_OFFSET(0x168D60B0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_GET_IGNOREFADING_OFFSET UNITYSDK_OFFSET(0x168D6470)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_GET_ISENABLEFADEINPUTBLOCKING_OFFSET UNITYSDK_OFFSET(0x168D6460)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x168D5F50)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONBACKBTNCLICK_OFFSET UNITYSDK_OFFSET(0x168DFAD0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONCHECKBTNCLICK_OFFSET UNITYSDK_OFFSET(0x168DFDA0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONCOMPLETEBTNCLICK_OFFSET UNITYSDK_OFFSET(0x168DFD50)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x168D6480)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONCREATFRIENDCARDITEM_OFFSET UNITYSDK_OFFSET(0x168E00E0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x168DBEA0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONINFOBTNCLICK_OFFSET UNITYSDK_OFFSET(0x168DFF30)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x168DBC80)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONLINEUPINDEX_OFFSET UNITYSDK_OFFSET(0x168E0280)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONRECEIVENEWBIE_OFFSET UNITYSDK_OFFSET(0x168E0770)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x168E02F0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONTABCLICK_OFFSET UNITYSDK_OFFSET(0x168E01E0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x168DB960)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x168DBC10)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x168D6510)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x168D6BD0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_REFRESHBTNVIEW_OFFSET UNITYSDK_OFFSET(0x168DCDD0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_REFRESHBUFFVIEW_OFFSET UNITYSDK_OFFSET(0x168DE890)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_REFRESHRIGHTVIEW_OFFSET UNITYSDK_OFFSET(0x168DCB10)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_REFRESHSKILLVIEW_OFFSET UNITYSDK_OFFSET(0x168DD200)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_REFRESHTAGVIEW_OFFSET UNITYSDK_OFFSET(0x168DC130)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_REFRESHTITLEANDBG_OFFSET UNITYSDK_OFFSET(0x168DC9D0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x168DA340)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_SHOULDSHOWBUFFNUMBER_OFFSET UNITYSDK_OFFSET(0x168DD0C0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER_TRYOVERRIDESHOULDIGNOREITEM_OFFSET UNITYSDK_OFFSET(0x168DC030)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER__CLOSE_B__46_0_OFFSET UNITYSDK_OFFSET(0x168E0C70)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x168E07C0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER__ONUIINIT_B__44_0_OFFSET UNITYSDK_OFFSET(0x168E0810)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER__ONUIOPEN_B__45_0_OFFSET UNITYSDK_OFFSET(0x168E0820)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER__ONUIOPEN_B__45_1_OFFSET UNITYSDK_OFFSET(0x168E0840)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER__ONUIOPEN_B__45_3_OFFSET UNITYSDK_OFFSET(0x168E0890)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER__ONUIOPEN_B__45_4_OFFSET UNITYSDK_OFFSET(0x168E0910)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER__ONUIOPEN_B__45_5_OFFSET UNITYSDK_OFFSET(0x168E0A80)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER__ONUIOPEN_B__45_6_OFFSET UNITYSDK_OFFSET(0x168E0B00)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER__REFRESHVIEW_B__52_0_OFFSET UNITYSDK_OFFSET(0x168E0C80)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER___BASE_CLOSE_OFFSET UNITYSDK_OFFSET(0x168E0CD0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x168E0CE0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x168E0D70)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x168E0E20)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x168E0EB0)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x168E0F70)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x168E0F80)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x168E0F90)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER___BASE_TRYOVERRIDESHOULDIGNOREITEM_OFFSET UNITYSDK_OFFSET(0x168E1020)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyBossInfoPageController_TypeDefinitionIndex = 49448;
	...
	public:
		...
		::System::Boolean _RefreshView_b__52_0(::Class_2_208CC9941471731A_1184* x)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_2_208CC9941471731A_1184*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER__REFRESHVIEW_B__52_0_OFFSET))(this, x);
		}
