...
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABYSSS2SUDDENEVENTTEMPLATE_CLEAR_OFFSET UNITYSDK_OFFSET(0x16993570)
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABYSSS2SUDDENEVENTTEMPLATE_GET_ADDPROBABILITYLIST_OFFSET UNITYSDK_OFFSET(0x16991F10)
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABYSSS2SUDDENEVENTTEMPLATE_GET_BATTLERANKINGID_OFFSET UNITYSDK_OFFSET(0x16992210)
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABYSSS2SUDDENEVENTTEMPLATE_GET_CHALLENGEID_OFFSET UNITYSDK_OFFSET(0x16992380)
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABYSSS2SUDDENEVENTTEMPLATE_GET_FCPATH_OFFSET UNITYSDK_OFFSET(0x169924F0)
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABYSSS2SUDDENEVENTTEMPLATE_GET_ISLOADALL_OFFSET UNITYSDK_OFFSET(0x16991D70)
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABYSSS2SUDDENEVENTTEMPLATE_GET_NONBATTLEAREAIDINFO_OFFSET UNITYSDK_OFFSET(0x16992610)
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABYSSS2SUDDENEVENTTEMPLATE_GET_RESULTIDLIST_OFFSET UNITYSDK_OFFSET(0x16992730)
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABYSSS2SUDDENEVENTTEMPLATE_GET_REWARDIDLIST_OFFSET UNITYSDK_OFFSET(0x16992850)
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABYSSS2SUDDENEVENTTEMPLATE_GET_SUBTRACTPROBABILITYLIST_OFFSET UNITYSDK_OFFSET(0x16992970)
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABYSSS2SUDDENEVENTTEMPLATE_GET_SUDDENAREATAGLIST_OFFSET UNITYSDK_OFFSET(0x16992C70)
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABYSSS2SUDDENEVENTTEMPLATE_GET_SUDDENEVENTID_OFFSET UNITYSDK_OFFSET(0x16991DA0)
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABYSSS2SUDDENEVENTTEMPLATE_GET_WAVE1_OFFSET UNITYSDK_OFFSET(0x16992ED0)
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABYSSS2SUDDENEVENTTEMPLATE_GET_WAVE2_OFFSET UNITYSDK_OFFSET(0x16992FF0)
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABYSSS2SUDDENEVENTTEMPLATE_GET_WAVE3_OFFSET UNITYSDK_OFFSET(0x16993110)
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABYSSS2SUDDENEVENTTEMPLATE_GET_WAVE4_OFFSET UNITYSDK_OFFSET(0x16993230)
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABYSSS2SUDDENEVENTTEMPLATE_GET_WAVE5_OFFSET UNITYSDK_OFFSET(0x16993350)
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABYSSS2SUDDENEVENTTEMPLATE_LOADANDCHECK_OFFSET UNITYSDK_OFFSET(0x16993470)
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABYSSS2SUDDENEVENTTEMPLATE_SET_ISLOADALL_OFFSET UNITYSDK_OFFSET(0x16991D80)
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABYSSS2SUDDENEVENTTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16991D90)

namespace MoleMole::FlatBuffers::Config
{
	inline static constexpr unsigned int AbyssS2SuddenEventTemplate_TypeDefinitionIndex = 18379;

	class AbyssS2SuddenEventTemplate : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::System::Int32>* m_SubtractProbabilityList; // 0x10
		::System::String* m_NonbattleAreaIDInfo; // 0x18
		::System::String* m_Wave1; // 0x20
		::Class_0_16E4307DCC419505_7* m_Notify; // 0x28
		::System::String* m_ResultIDList; // 0x30
		::System::String* m_RewardIDList; // 0x38
		::System::Collections::Generic::List_1<::System::String*>* m_SuddenAreaTagList; // 0x40
		::System::String* m_Wave3; // 0x48
		::System::Collections::Generic::List_1<::System::Int32>* m_AddProbabilityList; // 0x50
		::System::String* m_Wave4; // 0x58
		::System::String* m_FCPath; // 0x60
		::System::String* m_Wave5; // 0x68
		::Struct_2_3E75877A2888D88A_937 m_Data; // 0x70
		::System::String* m_Wave2; // 0x80
		::System::Byte m_Mask1; // 0x88
		::System::Byte m_VarLoadedCount; // 0x89
		::System::Boolean _IsLoadAll_k__BackingField; // 0x8A
		::System::Byte m_Mask0; // 0x8B
		::System::Int32 m_ChallengeID; // 0x8C
		::System::Int32 m_BattleRankingID; // 0x90
		::System::Int32 m_SuddenEventID; // 0x94

		::System::Void _ctor(::Struct_2_3E75877A2888D88A_937 data, ::Class_0_16E4307DCC419505_7* notify)
		{
			return ((::System::Void(*)(::PVOID, ::Struct_2_3E75877A2888D88A_937, ::Class_0_16E4307DCC419505_7*))((::PBYTE)hIl2Cpp + MOLEMOLE_FLATBUFFERS_CONFIG_ABYSSS2SUDDENEVENTTEMPLATE__CTOR_OFFSET))(this, data, notify);
		}
