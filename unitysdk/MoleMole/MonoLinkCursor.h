...
#define MOLEMOLE_MONOLINKCURSOR_GET_BOTTOMLEFT_OFFSET UNITYSDK_OFFSET(0x13F13910)
#define MOLEMOLE_MONOLINKCURSOR_GET_BOTTOMRIGHT_OFFSET UNITYSDK_OFFSET(0x13F13920)
#define MOLEMOLE_MONOLINKCURSOR_GET_REFERENCECORNERSIZE_OFFSET UNITYSDK_OFFSET(0x13F138D0)
#define MOLEMOLE_MONOLINKCURSOR_GET_REFERENCEFONTSIZE_OFFSET UNITYSDK_OFFSET(0x13F138E0)
#define MOLEMOLE_MONOLINKCURSOR_GET_TOPLEFT_OFFSET UNITYSDK_OFFSET(0x13F138F0)
#define MOLEMOLE_MONOLINKCURSOR_GET_TOPRIGHT_OFFSET UNITYSDK_OFFSET(0x13F13900)
#define MOLEMOLE_MONOLINKCURSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x13F13930)

namespace MoleMole
{
	inline static constexpr unsigned int MonoLinkCursor_TypeDefinitionIndex = 47667;
