...
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_DATACOMPARISON_OFFSET UNITYSDK_OFFSET(0x18211C70)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_GETCURRENTDATA_OFFSET UNITYSDK_OFFSET(0x182123B0)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_GETCURRENTINDEX_OFFSET UNITYSDK_OFFSET(0x18212280)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_GETORCREATECONTEXT_OFFSET UNITYSDK_OFFSET(0x18212470)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x18210940)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_ONCLICKCONFIRMCALLBACK_OFFSET UNITYSDK_OFFSET(0x18212740)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_ONCLICKDELCALLBACK_OFFSET UNITYSDK_OFFSET(0x18212AD0)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_ONCLICKRENAMECALLBACK_OFFSET UNITYSDK_OFFSET(0x18212D80)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18211EB0)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x18211FB0)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x18212060)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_ONSELECTCHILD_OFFSET UNITYSDK_OFFSET(0x18212300)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18210E20)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18211F40)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18210950)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18210DB0)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_PHOTOWALLADDNEWSCHEMEHANDLE_OFFSET UNITYSDK_OFFSET(0x18212EB0)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_REFRESHBTN_OFFSET UNITYSDK_OFFSET(0x182116C0)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_REFRESHSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x18210EE0)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18212F20)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18212FB0)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x18213040)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x182130F0)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x182131E0)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x182131F0)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18213200)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18213210)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoWallSwitchPopWindowController_TypeDefinitionIndex = 52198;
