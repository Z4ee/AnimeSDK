...
#define MOLEMOLE_UIPRIVATEMESSAGEPOPWINDOWCONTROLLER___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x13015970)
#define MOLEMOLE_UIPRIVATEMESSAGEPOPWINDOWCONTROLLER___C__DISPLAYCLASS5_0__REFRESHCONTACTFORSETTINGTOP_B__0_OFFSET UNITYSDK_OFFSET(0x13015980)
#define MOLEMOLE_UIPRIVATEMESSAGEPOPWINDOWCONTROLLER___C__DISPLAYCLASS5_0__REFRESHCONTACTFORSETTINGTOP_B__2_OFFSET UNITYSDK_OFFSET(0x13016070)
#define MOLEMOLE_UIPRIVATEMESSAGEPOPWINDOWCONTROLLER___C__DISPLAYCLASS5_0__REFRESHCONTACTFORSETTINGTOP_B__3_OFFSET UNITYSDK_OFFSET(0x130160E0)
#define MOLEMOLE_UIPRIVATEMESSAGEPOPWINDOWCONTROLLER___C__DISPLAYCLASS5_0__REFRESHCONTACTFORSETTINGTOP_G__SELECTTARGET_1_OFFSET UNITYSDK_OFFSET(0x13015D80)

namespace MoleMole
{
	inline static constexpr unsigned int UIPrivateMessagePopWindowController___c__DisplayClass5_0_TypeDefinitionIndex = 65133;
