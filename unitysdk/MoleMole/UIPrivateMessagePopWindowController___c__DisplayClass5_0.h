...
#define MOLEMOLE_UIPRIVATEMESSAGEPOPWINDOWCONTROLLER___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18683BC0)
#define MOLEMOLE_UIPRIVATEMESSAGEPOPWINDOWCONTROLLER___C__DISPLAYCLASS5_0__REFRESHCONTACTFORSETTINGTOP_B__0_OFFSET UNITYSDK_OFFSET(0x18683BD0)
#define MOLEMOLE_UIPRIVATEMESSAGEPOPWINDOWCONTROLLER___C__DISPLAYCLASS5_0__REFRESHCONTACTFORSETTINGTOP_B__2_OFFSET UNITYSDK_OFFSET(0x186842C0)
#define MOLEMOLE_UIPRIVATEMESSAGEPOPWINDOWCONTROLLER___C__DISPLAYCLASS5_0__REFRESHCONTACTFORSETTINGTOP_B__3_OFFSET UNITYSDK_OFFSET(0x18684330)
#define MOLEMOLE_UIPRIVATEMESSAGEPOPWINDOWCONTROLLER___C__DISPLAYCLASS5_0__REFRESHCONTACTFORSETTINGTOP_G__SELECTTARGET_1_OFFSET UNITYSDK_OFFSET(0x18683FD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPrivateMessagePopWindowController___c__DisplayClass5_0_TypeDefinitionIndex = 48727;
	...
	public:
		...
		::MoleMole::UIPrivateMessageRoleWidgetController* curWidget; // 0x20
