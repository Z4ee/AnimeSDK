...
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER_AFTERSHOW_OFFSET UNITYSDK_OFFSET(0x1467A750)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER_BINDCLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x1467A990)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER_CHANGEONSTATE_OFFSET UNITYSDK_OFFSET(0x1467ACD0)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER_GETISON_OFFSET UNITYSDK_OFFSET(0x1467B280)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER_GET_ISON_OFFSET UNITYSDK_OFFSET(0x1467A560)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER_GET_TOGGLEBUTTON_OFFSET UNITYSDK_OFFSET(0x1467A540)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1467A640)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1467A6D0)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1467A570)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1467A5D0)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER_OVERRIDECLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x1467A890)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1467AAD0)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER_SETISON_OFFSET UNITYSDK_OFFSET(0x1467A7F0)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1467B2D0)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER___BASE_AFTERSHOW_OFFSET UNITYSDK_OFFSET(0x1467B330)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1467B340)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1467B3D0)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1467B460)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1467B4F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralToggleWidgetController_TypeDefinitionIndex = 80943;

	class UIGeneralToggleWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_3E1A0459A6647B99_3* _view; // 0x2C0
