...
#define MOLEMOLE_VEHICLESPLINEPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x12A2B420)

namespace MoleMole
{
	inline static constexpr unsigned int VehicleSplinePath_TypeDefinitionIndex = 65040;
