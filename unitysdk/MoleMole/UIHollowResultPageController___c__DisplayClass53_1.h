...
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER___C__DISPLAYCLASS53_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1836ADC0)
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER___C__DISPLAYCLASS53_1__REFRESHBOSSRUSHVIEW_B__1_OFFSET UNITYSDK_OFFSET(0x1836ADD0)
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER___C__DISPLAYCLASS53_1__REFRESHBOSSRUSHVIEW_B__2_OFFSET UNITYSDK_OFFSET(0x1836AE90)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowResultPageController___c__DisplayClass53_1_TypeDefinitionIndex = 41923;
