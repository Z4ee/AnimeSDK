...
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER___C__DISPLAYCLASS53_1__CTOR_OFFSET UNITYSDK_OFFSET(0x167C8F20)
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER___C__DISPLAYCLASS53_1__REFRESHBOSSRUSHVIEW_B__1_OFFSET UNITYSDK_OFFSET(0x167C8F30)
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER___C__DISPLAYCLASS53_1__REFRESHBOSSRUSHVIEW_B__2_OFFSET UNITYSDK_OFFSET(0x167C8FF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowResultPageController___c__DisplayClass53_1_TypeDefinitionIndex = 57527;
	...
	public:
		...
		::System::Single curRatio; // 0x18
		::System::Single prvRatio; // 0x1C
