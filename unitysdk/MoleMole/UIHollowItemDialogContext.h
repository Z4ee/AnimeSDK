...
#define MOLEMOLE_UIHOLLOWITEMDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18820580)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowItemDialogContext_TypeDefinitionIndex = 70241;
