...
#define MOLEMOLE_UIHOLLOWITEMDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x19F19CA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowItemDialogContext_TypeDefinitionIndex = 41688;
