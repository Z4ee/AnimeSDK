...
#define MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER_CLICKITEM_OFFSET UNITYSDK_OFFSET(0x16928E10)
#define MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER_DISPLAYGOTICON_OFFSET UNITYSDK_OFFSET(0x16929640)
#define MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER_GETGAMEPADSELECTABLE_OFFSET UNITYSDK_OFFSET(0x16928FE0)
#define MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0x16929980)
#define MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x16928D60)
#define MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16928530)
#define MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16928770)
#define MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER_ONSETDATA_OFFSET UNITYSDK_OFFSET(0x169298F0)
#define MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x169286A0)
#define MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x169285C0)
#define MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER_REFRESHVIEW_1_OFFSET UNITYSDK_OFFSET(0x16929040)
#define MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x16928A20)
#define MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER_SETCUSTOMCOUNTTEXT_OFFSET UNITYSDK_OFFSET(0x16929B50)
#define MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x16928860)
#define MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER_SETGET_OFFSET UNITYSDK_OFFSET(0x16929A40)
#define MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER_SETGOTCOLOR_OFFSET UNITYSDK_OFFSET(0x169296B0)
#define MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER_SETITEMCLICKEDACT_OFFSET UNITYSDK_OFFSET(0x16928D10)
#define MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER_SETITEMGRAY_OFFSET UNITYSDK_OFFSET(0x16929880)
#define MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER_SETITEMIDSHOWSTATE_OFFSET UNITYSDK_OFFSET(0x16929990)
#define MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER_SHOWBG_OFFSET UNITYSDK_OFFSET(0x16929810)
#define MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER_SHOWDATAINFO_OFFSET UNITYSDK_OFFSET(0x16929AE0)
#define MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16929BD0)
#define MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x16929BE0)
#define MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16929BF0)
#define MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16929C80)
#define MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER___BASE_ONSETDATA_OFFSET UNITYSDK_OFFSET(0x16929D20)
#define MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16929DB0)
#define MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16929E40)

namespace MoleMole
{
	inline static constexpr unsigned int UIItemIconBtnSmallWidgetController_TypeDefinitionIndex = 55495;

	class UIItemIconBtnSmallWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_8C04CD821B036ED5_1* _view; // 0x2F0
		::Class_0_16E4307DCC419505_460* _itemViewData; // 0x2F8
		...
		::System::Void RefreshView(::Class_0_16E4307DCC419505_460* itemViewData)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_460*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIITEMICONBTNSMALLWIDGETCONTROLLER_REFRESHVIEW_OFFSET))(this, itemViewData);
		}
