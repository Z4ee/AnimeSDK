...
#define MOLEMOLE_SHOPPINGMALLSKINCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x12BE0E00)

namespace MoleMole
{
	inline static constexpr unsigned int ShoppingMallSkinContext_TypeDefinitionIndex = 59272;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_201*>*, ::MoleMole::MonoGamepadRegion*, ::Class_2_B4378B46E0020E85*, ::System::Action_1<::System::Int32>*))((::PBYTE)hIl2Cpp + MOLEMOLE_SHOPPINGMALLSKINCONTEXT__CTOR_OFFSET))(this, goods, region, Down_DetailBtn, onClick);
		}
	};
}
