...
#define MOLEMOLE_UIABYSSS2EVENTLISTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12F21040)
#define MOLEMOLE_UIABYSSS2EVENTLISTWIDGETCONTROLLER_ONINFOBTNCLICK_OFFSET UNITYSDK_OFFSET(0x12F21570)
#define MOLEMOLE_UIABYSSS2EVENTLISTWIDGETCONTROLLER_ONREWARDMISSIONBTNCLICK_OFFSET UNITYSDK_OFFSET(0x12F21640)
#define MOLEMOLE_UIABYSSS2EVENTLISTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12F210D0)
#define MOLEMOLE_UIABYSSS2EVENTLISTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12F20C80)
#define MOLEMOLE_UIABYSSS2EVENTLISTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12F20FD0)
#define MOLEMOLE_UIABYSSS2EVENTLISTWIDGETCONTROLLER_REFRESHMISSIONVIEW_OFFSET UNITYSDK_OFFSET(0x12F212D0)
#define MOLEMOLE_UIABYSSS2EVENTLISTWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x12F21190)
#define MOLEMOLE_UIABYSSS2EVENTLISTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12F21A70)
#define MOLEMOLE_UIABYSSS2EVENTLISTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12F21AD0)
#define MOLEMOLE_UIABYSSS2EVENTLISTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12F21B20)
#define MOLEMOLE_UIABYSSS2EVENTLISTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12F21B60)
#define MOLEMOLE_UIABYSSS2EVENTLISTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12F21BA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2EventListWidgetController_TypeDefinitionIndex = 58554;

	class UIAbyssS2EventListWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_06C2877021BC3D18* _view; // 0x2B8
		::Class_2_E621E51D351EB960* _abyssModel; // 0x2C0
		::System::Collections::Generic::List_1<::Class_2_14E7CE92E8A3183F*>* _dungeonConfigs; // 0x2C8
