...
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS98_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19EB5B50)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS98_0__REFRESHBOTTOMTIPSTEXT_B__0_OFFSET UNITYSDK_OFFSET(0x19EB5B60)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMainPageController___c__DisplayClass98_0_TypeDefinitionIndex = 73665;
