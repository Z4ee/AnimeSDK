...
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM_GET_CONTROLLER_OFFSET UNITYSDK_OFFSET(0x158244C0)
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM_GET_CREATEWIDGET_OFFSET UNITYSDK_OFFSET(0x15824640)
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x15824450)
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM_GET_ICONTYPE_OFFSET UNITYSDK_OFFSET(0x15824490)
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM_GET_REDDOTINFO_OFFSET UNITYSDK_OFFSET(0x158244A0)
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM_GET_TITLE_OFFSET UNITYSDK_OFFSET(0x158243B0)
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM_SET_CREATEWIDGET_OFFSET UNITYSDK_OFFSET(0x15824650)
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM_SET_REDDOTINFO_OFFSET UNITYSDK_OFFSET(0x158244B0)
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM_SHOWTAB_OFFSET UNITYSDK_OFFSET(0x15824660)
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x15824B70)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookPrimerWidgetController_TabItem_TypeDefinitionIndex = 37954;

	class UIHandBookPrimerWidgetController_TabItem : public ::System::Object
	{
	public:
		::Class_2_208CC9941471731A_520* entryTemplate; // 0x10
		::MoleMole::UIBaseController* _controller; // 0x18
		::System::Func_1<::MoleMole::UIBaseController*>* _CreateWidget_k__BackingField; // 0x20
		::System::ValueTuple_2<::Share::ENotificationBadgeType, ::System::UInt32> _RedDotInfo_k__BackingField; // 0x28
