...
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM_GET_CONTROLLER_OFFSET UNITYSDK_OFFSET(0x16709150)
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM_GET_CREATEWIDGET_OFFSET UNITYSDK_OFFSET(0x167092D0)
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x167090E0)
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM_GET_ICONTYPE_OFFSET UNITYSDK_OFFSET(0x16709120)
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM_GET_REDDOTINFO_OFFSET UNITYSDK_OFFSET(0x16709130)
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM_GET_TITLE_OFFSET UNITYSDK_OFFSET(0x16709040)
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM_SET_CREATEWIDGET_OFFSET UNITYSDK_OFFSET(0x167092E0)
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM_SET_REDDOTINFO_OFFSET UNITYSDK_OFFSET(0x16709140)
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM_SHOWTAB_OFFSET UNITYSDK_OFFSET(0x167092F0)
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x16709810)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookPrimerWidgetController_TabItem_TypeDefinitionIndex = 71603;
	...
	public:
		...
		::Il2CppArray<::MonoUITableScrollV2*>* _cachedScrolls; // 0x18
		::Class_2_208CC9941471731A_940* entryTemplate; // 0x20
