...
#define MOLEMOLE_ANIMATORRANDOMINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xFAE2270)

namespace MoleMole
{
	inline static constexpr unsigned int AnimatorRandomIntConfig_TypeDefinitionIndex = 69755;
