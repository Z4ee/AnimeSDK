...
#define MOLEMOLE_MONOUIOCCLUSIONCHECKER_METHOD_5_078D85152011B919_OFFSET UNITYSDK_OFFSET(0x17034700)
#define MOLEMOLE_MONOUIOCCLUSIONCHECKER_METHOD_5_15F779D4C75F340E_OFFSET UNITYSDK_OFFSET(0x17034970)
#define MOLEMOLE_MONOUIOCCLUSIONCHECKER_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x170341D0)
#define MOLEMOLE_MONOUIOCCLUSIONCHECKER_METHOD_5_507A5122CD01412B_OFFSET UNITYSDK_OFFSET(0x17034760)
#define MOLEMOLE_MONOUIOCCLUSIONCHECKER_METHOD_5_5D52379F6FF16D24_OFFSET UNITYSDK_OFFSET(0x17034920)
#define MOLEMOLE_MONOUIOCCLUSIONCHECKER_METHOD_5_85377D41FEE05B66_OFFSET UNITYSDK_OFFSET(0x17034400)
#define MOLEMOLE_MONOUIOCCLUSIONCHECKER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17034180)
#define MOLEMOLE_MONOUIOCCLUSIONCHECKER_SETENTITY_OFFSET UNITYSDK_OFFSET(0x17034280)
#define MOLEMOLE_MONOUIOCCLUSIONCHECKER__CTOR_OFFSET UNITYSDK_OFFSET(0x17034640)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIOcclusionChecker_TypeDefinitionIndex = 69257;
