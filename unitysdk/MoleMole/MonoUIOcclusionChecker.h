...
#define MOLEMOLE_MONOUIOCCLUSIONCHECKER_METHOD_5_078D85152011B919_OFFSET UNITYSDK_OFFSET(0x144F7820)
#define MOLEMOLE_MONOUIOCCLUSIONCHECKER_METHOD_5_15F779D4C75F340E_OFFSET UNITYSDK_OFFSET(0x144F7A40)
#define MOLEMOLE_MONOUIOCCLUSIONCHECKER_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x144F72F0)
#define MOLEMOLE_MONOUIOCCLUSIONCHECKER_METHOD_5_507A5122CD01412B_OFFSET UNITYSDK_OFFSET(0x144F7880)
#define MOLEMOLE_MONOUIOCCLUSIONCHECKER_METHOD_5_5D52379F6FF16D24_OFFSET UNITYSDK_OFFSET(0x144F81C0)
#define MOLEMOLE_MONOUIOCCLUSIONCHECKER_METHOD_5_85377D41FEE05B66_OFFSET UNITYSDK_OFFSET(0x144F7520)
#define MOLEMOLE_MONOUIOCCLUSIONCHECKER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x144F72A0)
#define MOLEMOLE_MONOUIOCCLUSIONCHECKER_SETENTITY_OFFSET UNITYSDK_OFFSET(0x144F73A0)
#define MOLEMOLE_MONOUIOCCLUSIONCHECKER__CTOR_OFFSET UNITYSDK_OFFSET(0x144F7760)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIOcclusionChecker_TypeDefinitionIndex = 56336;

	class MonoUIOcclusionChecker : public ::UnityEngine::MonoBehaviour
	{
	public:
		::System::UInt32 Field_5_1; // 0x18
		::System::Single Field_5_0; // 0x1C
		::UnityEngine::Transform* Field_5_7; // 0x20
		::Foundation::Coroutine::CoroutineHandle Field_5_6; // 0x28
		::System::Boolean Field_5_5; // 0x2C
		::System::Single Field_5_4; // 0x30
		::Il2CppArray<::UnityEngine::RaycastHit>* Field_5_11; // 0x38
