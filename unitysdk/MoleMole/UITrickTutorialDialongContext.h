...
#define MOLEMOLE_UITRICKTUTORIALDIALONGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x162A59B0)

namespace MoleMole
{
	inline static constexpr unsigned int UITrickTutorialDialongContext_TypeDefinitionIndex = 78727;
	...
	public:
		...
		::Class_0_16E4307DCC419505_399* TutorialGetter; // 0x38
