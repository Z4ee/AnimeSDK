...
#define MOLEMOLE_UIRABENEMYROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x156115D0)
#define MOLEMOLE_UIRABENEMYROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15611640)
#define MOLEMOLE_UIRABENEMYROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x156116E0)
#define MOLEMOLE_UIRABENEMYROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15611920)
#define MOLEMOLE_UIRABENEMYROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x156117A0)
#define MOLEMOLE_UIRABENEMYROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15611B70)
#define MOLEMOLE_UIRABENEMYROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15611B80)
#define MOLEMOLE_UIRABENEMYROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15611C20)
#define MOLEMOLE_UIRABENEMYROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15611CC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABEnemyRowWidgetController_TypeDefinitionIndex = 46458;
