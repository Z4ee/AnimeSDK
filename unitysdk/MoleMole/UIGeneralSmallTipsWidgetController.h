...
#define MOLEMOLE_UIGENERALSMALLTIPSWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x162CBC90)
#define MOLEMOLE_UIGENERALSMALLTIPSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x162CB960)
#define MOLEMOLE_UIGENERALSMALLTIPSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x162CB9F0)
#define MOLEMOLE_UIGENERALSMALLTIPSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x162CB900)
#define MOLEMOLE_UIGENERALSMALLTIPSWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x162CBBA0)
#define MOLEMOLE_UIGENERALSMALLTIPSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x162CBE70)
#define MOLEMOLE_UIGENERALSMALLTIPSWIDGETCONTROLLER__INITVIEW_B__5_0_OFFSET UNITYSDK_OFFSET(0x162CBED0)
#define MOLEMOLE_UIGENERALSMALLTIPSWIDGETCONTROLLER__INITVIEW_B__5_1_OFFSET UNITYSDK_OFFSET(0x162CBF70)
#define MOLEMOLE_UIGENERALSMALLTIPSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x162CBF80)
#define MOLEMOLE_UIGENERALSMALLTIPSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x162CC010)
#define MOLEMOLE_UIGENERALSMALLTIPSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x162CC0A0)
#define MOLEMOLE_UIGENERALSMALLTIPSWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x162CC130)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralSmallTipsWidgetController_TypeDefinitionIndex = 77707;

	class UIGeneralSmallTipsWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_F97C2CD3DEC48DD2_1* _view; // 0x2B8
		::MoleMole::UIGeneralSmallTipsContext* _context; // 0x2C0
