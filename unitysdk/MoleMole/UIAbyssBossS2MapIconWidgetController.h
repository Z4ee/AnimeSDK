...
#define MOLEMOLE_UIABYSSBOSSS2MAPICONWIDGETCONTROLLER_INITSTYLEINFO_OFFSET UNITYSDK_OFFSET(0x183AE040)
#define MOLEMOLE_UIABYSSBOSSS2MAPICONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x183AE1C0)
#define MOLEMOLE_UIABYSSBOSSS2MAPICONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x183AE250)
#define MOLEMOLE_UIABYSSBOSSS2MAPICONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x183ADFB0)
#define MOLEMOLE_UIABYSSBOSSS2MAPICONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x183AE150)
#define MOLEMOLE_UIABYSSBOSSS2MAPICONWIDGETCONTROLLER_SETAFFIXICONINTERNAL_OFFSET UNITYSDK_OFFSET(0x183AE370)
#define MOLEMOLE_UIABYSSBOSSS2MAPICONWIDGETCONTROLLER_SETICONINTERNAL_OFFSET UNITYSDK_OFFSET(0x183AE3C0)
#define MOLEMOLE_UIABYSSBOSSS2MAPICONWIDGETCONTROLLER_SWITCHBIGICON_OFFSET UNITYSDK_OFFSET(0x183AE2D0)
#define MOLEMOLE_UIABYSSBOSSS2MAPICONWIDGETCONTROLLER_SWITCHSTYLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x183AE410)
#define MOLEMOLE_UIABYSSBOSSS2MAPICONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x183AE4E0)
#define MOLEMOLE_UIABYSSBOSSS2MAPICONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x183AE5A0)
#define MOLEMOLE_UIABYSSBOSSS2MAPICONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x183AE630)
#define MOLEMOLE_UIABYSSBOSSS2MAPICONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x183AE6C0)
#define MOLEMOLE_UIABYSSBOSSS2MAPICONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x183AE750)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssBossS2MapIconWidgetController_TypeDefinitionIndex = 49946;

	class UIAbyssBossS2MapIconWidgetController : public ::MoleMole::UIAbyssMapIconBaseController
	{
	public:
		::Class_2_1C66F7E56EF1134C_1* _view; // 0x2C8
