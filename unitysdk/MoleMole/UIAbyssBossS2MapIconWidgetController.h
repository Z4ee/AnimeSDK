...
#define MOLEMOLE_UIABYSSBOSSS2MAPICONWIDGETCONTROLLER_INITSTYLEINFO_OFFSET UNITYSDK_OFFSET(0x11E0E090)
#define MOLEMOLE_UIABYSSBOSSS2MAPICONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x11E0E210)
#define MOLEMOLE_UIABYSSBOSSS2MAPICONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x11E0E2A0)
#define MOLEMOLE_UIABYSSBOSSS2MAPICONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x11E0E000)
#define MOLEMOLE_UIABYSSBOSSS2MAPICONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x11E0E1A0)
#define MOLEMOLE_UIABYSSBOSSS2MAPICONWIDGETCONTROLLER_SETAFFIXICONINTERNAL_OFFSET UNITYSDK_OFFSET(0x11E0E3C0)
#define MOLEMOLE_UIABYSSBOSSS2MAPICONWIDGETCONTROLLER_SETICONINTERNAL_OFFSET UNITYSDK_OFFSET(0x11E0E410)
#define MOLEMOLE_UIABYSSBOSSS2MAPICONWIDGETCONTROLLER_SWITCHBIGICON_OFFSET UNITYSDK_OFFSET(0x11E0E320)
#define MOLEMOLE_UIABYSSBOSSS2MAPICONWIDGETCONTROLLER_SWITCHSTYLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x11E0E460)
#define MOLEMOLE_UIABYSSBOSSS2MAPICONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11E0E530)
#define MOLEMOLE_UIABYSSBOSSS2MAPICONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x11E0E5F0)
#define MOLEMOLE_UIABYSSBOSSS2MAPICONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x11E0E680)
#define MOLEMOLE_UIABYSSBOSSS2MAPICONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x11E0E710)
#define MOLEMOLE_UIABYSSBOSSS2MAPICONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x11E0E7A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssBossS2MapIconWidgetController_TypeDefinitionIndex = 46680;

	class UIAbyssBossS2MapIconWidgetController : public ::MoleMole::UIAbyssMapIconBaseController
	{
	public:
		::Class_2_1C66F7E56EF1134C* _view; // 0x2C0
