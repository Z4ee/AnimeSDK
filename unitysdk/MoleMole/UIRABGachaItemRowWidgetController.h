...
#define MOLEMOLE_UIRABGACHAITEMROWWIDGETCONTROLLER_BINDNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x16143400)
#define MOLEMOLE_UIRABGACHAITEMROWWIDGETCONTROLLER_GET_POOLID_OFFSET UNITYSDK_OFFSET(0x161424B0)
#define MOLEMOLE_UIRABGACHAITEMROWWIDGETCONTROLLER_INITHIGHCOSTBUDDYICONS_OFFSET UNITYSDK_OFFSET(0x16142680)
#define MOLEMOLE_UIRABGACHAITEMROWWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x16143E00)
#define MOLEMOLE_UIRABGACHAITEMROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16143770)
#define MOLEMOLE_UIRABGACHAITEMROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x16143D90)
#define MOLEMOLE_UIRABGACHAITEMROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16142CD0)
#define MOLEMOLE_UIRABGACHAITEMROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16143E50)
#define MOLEMOLE_UIRABGACHAITEMROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x161424D0)
#define MOLEMOLE_UIRABGACHAITEMROWWIDGETCONTROLLER_REFRESHHIGHCOSTICON_OFFSET UNITYSDK_OFFSET(0x16143800)
#define MOLEMOLE_UIRABGACHAITEMROWWIDGETCONTROLLER_REFRESHTRACKQUESTBYCURRENTGUIDE_OFFSET UNITYSDK_OFFSET(0x16143540)
#define MOLEMOLE_UIRABGACHAITEMROWWIDGETCONTROLLER_REFRESHTRACKQUEST_OFFSET UNITYSDK_OFFSET(0x16143D00)
#define MOLEMOLE_UIRABGACHAITEMROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x16142DB0)
#define MOLEMOLE_UIRABGACHAITEMROWWIDGETCONTROLLER_SET_POOLID_OFFSET UNITYSDK_OFFSET(0x161424C0)
#define MOLEMOLE_UIRABGACHAITEMROWWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x16143F60)
#define MOLEMOLE_UIRABGACHAITEMROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16143ED0)
#define MOLEMOLE_UIRABGACHAITEMROWWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x16144110)
#define MOLEMOLE_UIRABGACHAITEMROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16144120)
#define MOLEMOLE_UIRABGACHAITEMROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x161441B0)
#define MOLEMOLE_UIRABGACHAITEMROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16144240)
#define MOLEMOLE_UIRABGACHAITEMROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x161442E0)
#define MOLEMOLE_UIRABGACHAITEMROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16144370)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABGachaItemRowWidgetController_TypeDefinitionIndex = 86236;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(UIRABGachaItemRowWidgetController_TypeDefinitionIndex)->GetStaticField(0x37DA0);
		}
		// static const ::System::Int32 HighCostBuddyShowCount = 0x4; // 0x0
		::System::Int32 _PoolID_k__BackingField; // 0x2F0
		::Class_2_60638234271CCDB8_50* _view; // 0x2F8
