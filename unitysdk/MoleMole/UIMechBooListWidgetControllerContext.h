...
#define MOLEMOLE_UIMECHBOOLISTWIDGETCONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x150FBA50)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechBooListWidgetControllerContext_TypeDefinitionIndex = 54200;
