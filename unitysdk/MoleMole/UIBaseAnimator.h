...
#define MOLEMOLE_UIBASEANIMATOR_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x15B51970)
#define MOLEMOLE_UIBASEANIMATOR_GETANIMATOR_OFFSET UNITYSDK_OFFSET(0x15B509E0)
#define MOLEMOLE_UIBASEANIMATOR_INITIALIZEFORCEUPDATE_OFFSET UNITYSDK_OFFSET(0x15B519B0)
#define MOLEMOLE_UIBASEANIMATOR_METHOD_5_1587E27051DE9F65_OFFSET UNITYSDK_OFFSET(0x15B50A30)
#define MOLEMOLE_UIBASEANIMATOR_METHOD_5_CA2A811F88C8CC86_OFFSET UNITYSDK_OFFSET(0x15B51B90)
#define MOLEMOLE_UIBASEANIMATOR_PLAYALLLAYERANIMATION_OFFSET UNITYSDK_OFFSET(0x15B51240)
#define MOLEMOLE_UIBASEANIMATOR_PLAYANIMATION_1_OFFSET UNITYSDK_OFFSET(0x15B515A0)
#define MOLEMOLE_UIBASEANIMATOR_PLAYANIMATION_2_OFFSET UNITYSDK_OFFSET(0x15B51780)
#define MOLEMOLE_UIBASEANIMATOR_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0x15B513F0)
#define MOLEMOLE_UIBASEANIMATOR_SETBOOL_OFFSET UNITYSDK_OFFSET(0x15B50D50)
#define MOLEMOLE_UIBASEANIMATOR_SETFLOAT_OFFSET UNITYSDK_OFFSET(0x15B50EF0)
#define MOLEMOLE_UIBASEANIMATOR_SETINT_OFFSET UNITYSDK_OFFSET(0x15B510A0)
#define MOLEMOLE_UIBASEANIMATOR_SETTRIGGER_OFFSET UNITYSDK_OFFSET(0x15B50BB0)
#define MOLEMOLE_UIBASEANIMATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x15B51B40)

namespace MoleMole
{
	inline static constexpr unsigned int UIBaseAnimator_TypeDefinitionIndex = 62873;
