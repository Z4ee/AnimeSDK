...
#define MOLEMOLE_UIBASEANIMATOR_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x13E52690)
#define MOLEMOLE_UIBASEANIMATOR_GETANIMATOR_OFFSET UNITYSDK_OFFSET(0x13E51700)
#define MOLEMOLE_UIBASEANIMATOR_INITIALIZEFORCEUPDATE_OFFSET UNITYSDK_OFFSET(0x13E526D0)
#define MOLEMOLE_UIBASEANIMATOR_METHOD_5_1587E27051DE9F65_OFFSET UNITYSDK_OFFSET(0x13E51750)
#define MOLEMOLE_UIBASEANIMATOR_METHOD_5_CA2A811F88C8CC86_OFFSET UNITYSDK_OFFSET(0x13E528B0)
#define MOLEMOLE_UIBASEANIMATOR_PLAYALLLAYERANIMATION_OFFSET UNITYSDK_OFFSET(0x13E51F60)
#define MOLEMOLE_UIBASEANIMATOR_PLAYANIMATION_1_OFFSET UNITYSDK_OFFSET(0x13E522C0)
#define MOLEMOLE_UIBASEANIMATOR_PLAYANIMATION_2_OFFSET UNITYSDK_OFFSET(0x13E524A0)
#define MOLEMOLE_UIBASEANIMATOR_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0x13E52110)
#define MOLEMOLE_UIBASEANIMATOR_SETBOOL_OFFSET UNITYSDK_OFFSET(0x13E51A70)
#define MOLEMOLE_UIBASEANIMATOR_SETFLOAT_OFFSET UNITYSDK_OFFSET(0x13E51C10)
#define MOLEMOLE_UIBASEANIMATOR_SETINT_OFFSET UNITYSDK_OFFSET(0x13E51DC0)
#define MOLEMOLE_UIBASEANIMATOR_SETTRIGGER_OFFSET UNITYSDK_OFFSET(0x13E518D0)
#define MOLEMOLE_UIBASEANIMATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x13E52860)

namespace MoleMole
{
	inline static constexpr unsigned int UIBaseAnimator_TypeDefinitionIndex = 53114;
