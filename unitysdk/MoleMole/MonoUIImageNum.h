...
#define MOLEMOLE_MONOUIIMAGENUM_SETNUMBER_OFFSET UNITYSDK_OFFSET(0x11645E40)
#define MOLEMOLE_MONOUIIMAGENUM__CTOR_OFFSET UNITYSDK_OFFSET(0x11645FF0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIImageNum_TypeDefinitionIndex = 53443;
