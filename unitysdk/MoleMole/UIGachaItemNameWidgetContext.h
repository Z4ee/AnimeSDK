...
#define MOLEMOLE_UIGACHAITEMNAMEWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18D81370)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaItemNameWidgetContext_TypeDefinitionIndex = 51536;
