...
#define MOLEMOLE_UIGENERALNUMTABBTN2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16A9DA90)
#define MOLEMOLE_UIGENERALNUMTABBTN2WIDGETCONTROLLER_ONITEMRESELECT_OFFSET UNITYSDK_OFFSET(0x16A9DC30)
#define MOLEMOLE_UIGENERALNUMTABBTN2WIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x16A9DBA0)
#define MOLEMOLE_UIGENERALNUMTABBTN2WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16A9DD20)
#define MOLEMOLE_UIGENERALNUMTABBTN2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16A9DB20)
#define MOLEMOLE_UIGENERALNUMTABBTN2WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16A9D940)
#define MOLEMOLE_UIGENERALNUMTABBTN2WIDGETCONTROLLER_REFRESHTABDATA_OFFSET UNITYSDK_OFFSET(0x16A9DE20)
#define MOLEMOLE_UIGENERALNUMTABBTN2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16A9E0F0)
#define MOLEMOLE_UIGENERALNUMTABBTN2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16A9E100)
#define MOLEMOLE_UIGENERALNUMTABBTN2WIDGETCONTROLLER___BASE_ONITEMRESELECT_OFFSET UNITYSDK_OFFSET(0x16A9E190)
#define MOLEMOLE_UIGENERALNUMTABBTN2WIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x16A9E220)
#define MOLEMOLE_UIGENERALNUMTABBTN2WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16A9E2B0)
#define MOLEMOLE_UIGENERALNUMTABBTN2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16A9E350)
#define MOLEMOLE_UIGENERALNUMTABBTN2WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16A9E3E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralNumTabBtn2WidgetController_TypeDefinitionIndex = 74416;
