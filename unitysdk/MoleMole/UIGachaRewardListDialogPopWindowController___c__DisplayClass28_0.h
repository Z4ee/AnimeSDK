...
#define MOLEMOLE_UIGACHAREWARDLISTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS28_0__CTOR_OFFSET UNITYSDK_OFFSET(0x155AEA30)
#define MOLEMOLE_UIGACHAREWARDLISTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS28_0__ONITEMCLICK_B__0_OFFSET UNITYSDK_OFFSET(0x155AEA40)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaRewardListDialogPopWindowController___c__DisplayClass28_0_TypeDefinitionIndex = 53575;
	...
	public:
		...
		::Enum_3_37CA0C975E67CCBF type; // 0x18
