...
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER___C__DISPLAYCLASS37_1__CTOR_OFFSET UNITYSDK_OFFSET(0x185A5720)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER___C__DISPLAYCLASS37_1__UPDATEPOSITION_B__3_OFFSET UNITYSDK_OFFSET(0x185A5730)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER___C__DISPLAYCLASS37_1__UPDATEPOSITION_B__4_OFFSET UNITYSDK_OFFSET(0x185A5750)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralNewsBubbleWidgetController___c__DisplayClass37_1_TypeDefinitionIndex = 85278;
