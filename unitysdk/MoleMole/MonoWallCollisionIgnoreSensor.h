...
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_BINDENTITY_OFFSET UNITYSDK_OFFSET(0x11904470)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_GET_BOUNDENTITY_OFFSET UNITYSDK_OFFSET(0x11904450)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_GET_BOUNDWALLCOLLIDER_OFFSET UNITYSDK_OFFSET(0x11904460)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_GET_IGNORETAG_OFFSET UNITYSDK_OFFSET(0x11904430)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_METHOD_5_65585810E2458BA4_OFFSET UNITYSDK_OFFSET(0x119050E0)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_METHOD_5_8F9716FCC554E5F2_OFFSET UNITYSDK_OFFSET(0x119050D0)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x11904AF0)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x11904DD0)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_SET_IGNORETAG_OFFSET UNITYSDK_OFFSET(0x11904440)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_UNBINDENTITY_OFFSET UNITYSDK_OFFSET(0x11904810)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x11905080)

namespace MoleMole
{
	inline static constexpr unsigned int MonoWallCollisionIgnoreSensor_TypeDefinitionIndex = 51325;
	...
	public:
		...
		::MoleMole::EntityHandle Field_5_6; // 0x28
		::UnityEngine::Collider* Field_5_5; // 0x38
