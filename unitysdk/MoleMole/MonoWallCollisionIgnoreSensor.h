...
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_BINDENTITY_OFFSET UNITYSDK_OFFSET(0x19170F40)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_GET_BOUNDENTITY_OFFSET UNITYSDK_OFFSET(0x19170F20)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_GET_BOUNDWALLCOLLIDER_OFFSET UNITYSDK_OFFSET(0x19170F30)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_GET_IGNORETAG_OFFSET UNITYSDK_OFFSET(0x19170F00)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_METHOD_5_65585810E2458BA4_OFFSET UNITYSDK_OFFSET(0x19171810)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_METHOD_5_8F9716FCC554E5F2_OFFSET UNITYSDK_OFFSET(0x19171800)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x191714D0)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x19171650)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_SET_IGNORETAG_OFFSET UNITYSDK_OFFSET(0x19170F10)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_UNBINDENTITY_OFFSET UNITYSDK_OFFSET(0x19171280)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x191717B0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoWallCollisionIgnoreSensor_TypeDefinitionIndex = 57573;
