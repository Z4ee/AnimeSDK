...
#define MOLEMOLE_CONFIGSPECIALDAMAGETEXT_ISVALID_OFFSET UNITYSDK_OFFSET(0x843810)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigSpecialDamageText_TypeDefinitionIndex = 81037;
