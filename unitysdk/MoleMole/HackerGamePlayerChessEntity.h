...
#define MOLEMOLE_HACKERGAMEPLAYERCHESSENTITY_ATTACHEFFECT_OFFSET UNITYSDK_OFFSET(0x1912FCC0)
#define MOLEMOLE_HACKERGAMEPLAYERCHESSENTITY_INIT_OFFSET UNITYSDK_OFFSET(0x1912FFD0)
#define MOLEMOLE_HACKERGAMEPLAYERCHESSENTITY_ONEFFECTTYPECHANGED_OFFSET UNITYSDK_OFFSET(0x191301D0)
#define MOLEMOLE_HACKERGAMEPLAYERCHESSENTITY_SETEFFECT_OFFSET UNITYSDK_OFFSET(0x1912FF30)
#define MOLEMOLE_HACKERGAMEPLAYERCHESSENTITY_TAKEDAMAGE_OFFSET UNITYSDK_OFFSET(0x1912FAF0)
#define MOLEMOLE_HACKERGAMEPLAYERCHESSENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x19130380)

namespace MoleMole
{
	inline static constexpr unsigned int HackerGamePlayerChessEntity_TypeDefinitionIndex = 70384;
	...
	public:
		...
		::System::Void Init(::Class_5_FCAF801AC482D3B5* chessboard, ::System::UInt32 entityID, ::Class_1_481C77891EF02060* damageable)
		{
			return ((::System::Void(*)(::PVOID, ::Class_5_FCAF801AC482D3B5*, ::System::UInt32, ::Class_1_481C77891EF02060*))((::PBYTE)hIl2Cpp + MOLEMOLE_HACKERGAMEPLAYERCHESSENTITY_INIT_OFFSET))(this, chessboard, entityID, damageable);
		}
