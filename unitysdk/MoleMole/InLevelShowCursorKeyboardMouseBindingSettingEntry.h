...
#define MOLEMOLE_INLEVELSHOWCURSORKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_LOCKEDSETTINGRAWINPUTDEVICELIST_OFFSET UNITYSDK_OFFSET(0x11625340)
#define MOLEMOLE_INLEVELSHOWCURSORKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x11625320)
#define MOLEMOLE_INLEVELSHOWCURSORKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x11625330)
#define MOLEMOLE_INLEVELSHOWCURSORKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x116253D0)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelShowCursorKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 52708;
