...
#define MOLEMOLE_UIBABELTOWERLIST03WIDGETCONTROLLER_HIDEALL_OFFSET UNITYSDK_OFFSET(0x15ABA050)
#define MOLEMOLE_UIBABELTOWERLIST03WIDGETCONTROLLER_HIDERATING_OFFSET UNITYSDK_OFFSET(0x15ABAE80)
#define MOLEMOLE_UIBABELTOWERLIST03WIDGETCONTROLLER_ONBABELTOWERFLOORFINISHANIMATION_OFFSET UNITYSDK_OFFSET(0x15AB8B40)
#define MOLEMOLE_UIBABELTOWERLIST03WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15AB8A30)
#define MOLEMOLE_UIBABELTOWERLIST03WIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x15ABAFE0)
#define MOLEMOLE_UIBABELTOWERLIST03WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15AB9190)
#define MOLEMOLE_UIBABELTOWERLIST03WIDGETCONTROLLER_ONSHOWBABELTOWERUNLOCK_OFFSET UNITYSDK_OFFSET(0x15AB9620)
#define MOLEMOLE_UIBABELTOWERLIST03WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15AB8AC0)
#define MOLEMOLE_UIBABELTOWERLIST03WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15AB87C0)
#define MOLEMOLE_UIBABELTOWERLIST03WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15AB8920)
#define MOLEMOLE_UIBABELTOWERLIST03WIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x15AB92C0)
#define MOLEMOLE_UIBABELTOWERLIST03WIDGETCONTROLLER_SETCLICKFUNC_OFFSET UNITYSDK_OFFSET(0x15ABB110)
#define MOLEMOLE_UIBABELTOWERLIST03WIDGETCONTROLLER_SETCOMPLETE_OFFSET UNITYSDK_OFFSET(0x15AB8D70)
#define MOLEMOLE_UIBABELTOWERLIST03WIDGETCONTROLLER_UPDATEFLOOR_OFFSET UNITYSDK_OFFSET(0x15ABA3A0)
#define MOLEMOLE_UIBABELTOWERLIST03WIDGETCONTROLLER_UPDATEOFFSET_OFFSET UNITYSDK_OFFSET(0x15ABABA0)
#define MOLEMOLE_UIBABELTOWERLIST03WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15ABB160)
#define MOLEMOLE_UIBABELTOWERLIST03WIDGETCONTROLLER__REFRESHNORMALVIEW_OFFSET UNITYSDK_OFFSET(0x15AB9730)
#define MOLEMOLE_UIBABELTOWERLIST03WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15ABB360)
#define MOLEMOLE_UIBABELTOWERLIST03WIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x15ABB3F0)
#define MOLEMOLE_UIBABELTOWERLIST03WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15ABB480)
#define MOLEMOLE_UIBABELTOWERLIST03WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15ABB520)
#define MOLEMOLE_UIBABELTOWERLIST03WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15ABB5B0)
#define MOLEMOLE_UIBABELTOWERLIST03WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15ABB640)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerList03WidgetController_TypeDefinitionIndex = 46461;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_103* _view; // 0x2E8
		::System::Int32 towerid; // 0x2F0
		::System::UInt32 currentFloor; // 0x2F4
		::System::Boolean isSpecial; // 0x2F8
		...
		::System::Boolean isUnlimitSymbol; // 0x31C
