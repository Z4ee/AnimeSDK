...
#define MOLEMOLE_UIAVATARANIMATORPARAMSSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x17A433C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarAnimatorParamsSetting_TypeDefinitionIndex = 53638;

	class UIAvatarAnimatorParamsSetting : public ::System::Object
	{
	public:
		::MoleMole::UIAvatarAnimationSetting* AvatarAnimationSetting; // 0x10
		...
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Boolean>* TriggerDict; // 0x30
