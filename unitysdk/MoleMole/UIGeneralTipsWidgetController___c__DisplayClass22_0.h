...
#define MOLEMOLE_UIGENERALTIPSWIDGETCONTROLLER___C__DISPLAYCLASS22_0__CLOSETEXT_B__0_OFFSET UNITYSDK_OFFSET(0x171E6FA0)
#define MOLEMOLE_UIGENERALTIPSWIDGETCONTROLLER___C__DISPLAYCLASS22_0__CLOSETEXT_B__1_OFFSET UNITYSDK_OFFSET(0x171E7030)
#define MOLEMOLE_UIGENERALTIPSWIDGETCONTROLLER___C__DISPLAYCLASS22_0__CTOR_OFFSET UNITYSDK_OFFSET(0x171E6F90)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralTipsWidgetController___c__DisplayClass22_0_TypeDefinitionIndex = 84360;
