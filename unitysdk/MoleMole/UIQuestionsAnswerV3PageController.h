...
#define MOLEMOLE_UIQUESTIONSANSWERV3PAGECONTROLLER_CREATEUIQUESTIONSANSWER3D3DMODELCONTROLLER_OFFSET UNITYSDK_OFFSET(0x147EA520)
#define MOLEMOLE_UIQUESTIONSANSWERV3PAGECONTROLLER_CREATEUIQUESTIONSANSWERWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x147EA470)
#define MOLEMOLE_UIQUESTIONSANSWERV3PAGECONTROLLER_CREATEUIQUESTIONSLISTWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x147EA3C0)
#define MOLEMOLE_UIQUESTIONSANSWERV3PAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x147EA5B0)
#define MOLEMOLE_UIQUESTIONSANSWERV3PAGECONTROLLER___BASE_CREATEUIQUESTIONSANSWER3D3DMODELCONTROLLER_OFFSET UNITYSDK_OFFSET(0x147EA5C0)
#define MOLEMOLE_UIQUESTIONSANSWERV3PAGECONTROLLER___BASE_CREATEUIQUESTIONSANSWERWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x147EA690)
#define MOLEMOLE_UIQUESTIONSANSWERV3PAGECONTROLLER___BASE_CREATEUIQUESTIONSLISTWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x147EA6A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerV3PageController_TypeDefinitionIndex = 44776;
