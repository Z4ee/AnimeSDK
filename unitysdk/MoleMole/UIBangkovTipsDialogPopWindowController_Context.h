...
#define MOLEMOLE_UIBANGKOVTIPSDIALOGPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15AC4700)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangkovTipsDialogPopWindowController_Context_TypeDefinitionIndex = 77174;
	...
	public:
		...
		::System::UInt32 SrcType; // 0x34
		::System::UInt32 SrcId; // 0x38
