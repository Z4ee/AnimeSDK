...
#define MOLEMOLE_COMMANDLINERENDERSCALE_METHOD_2_7D8E67F55E5B87EF_OFFSET UNITYSDK_OFFSET(0x16247C90)
#define MOLEMOLE_COMMANDLINERENDERSCALE_METHOD_2_B2A7C6FDE215F575_OFFSET UNITYSDK_OFFSET(0x16247B50)
#define MOLEMOLE_COMMANDLINERENDERSCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x16247C50)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineRenderScale_TypeDefinitionIndex = 70274;
