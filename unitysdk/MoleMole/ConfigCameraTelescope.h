...
#define MOLEMOLE_CONFIGCAMERATELESCOPE__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF7DB0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigCameraTelescope_TypeDefinitionIndex = 42802;
