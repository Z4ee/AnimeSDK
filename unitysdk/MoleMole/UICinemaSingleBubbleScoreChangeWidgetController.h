...
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEWIDGETCONTROLLER_GETCOMBOIMGBYINT_OFFSET UNITYSDK_OFFSET(0x17A58AE0)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17A589D0)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17A58A60)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17A584F0)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17A58550)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEWIDGETCONTROLLER_SHOWSCORECHANGE_OFFSET UNITYSDK_OFFSET(0x17A58630)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17A58CF0)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEWIDGETCONTROLLER__SHOWSCORECHANGE_B__5_0_OFFSET UNITYSDK_OFFSET(0x17A58DA0)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17A58DB0)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17A58E40)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17A58ED0)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17A58F60)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaSingleBubbleScoreChangeWidgetController_TypeDefinitionIndex = 43243;

	class UICinemaSingleBubbleScoreChangeWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_6602603644EF4355* _view; // 0x2C0
