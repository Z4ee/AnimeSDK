...
#define MOLEMOLE_UICINEMAPREPPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1577D610)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaPrepPageContext_TypeDefinitionIndex = 49937;
