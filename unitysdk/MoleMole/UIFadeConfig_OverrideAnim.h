...
#define MOLEMOLE_UIFADECONFIG_OVERRIDEANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x16491650)

namespace MoleMole
{
	inline static constexpr unsigned int UIFadeConfig_OverrideAnim_TypeDefinitionIndex = 64541;
