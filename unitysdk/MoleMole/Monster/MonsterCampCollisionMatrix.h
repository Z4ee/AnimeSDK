...
#define MOLEMOLE_MONSTER_MONSTERCAMPCOLLISIONMATRIX_METHOD_2_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0x13866650)
#define MOLEMOLE_MONSTER_MONSTERCAMPCOLLISIONMATRIX_METHOD_2_5F6398776E49CD87_OFFSET UNITYSDK_OFFSET(0x13866CA0)
#define MOLEMOLE_MONSTER_MONSTERCAMPCOLLISIONMATRIX_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x13866D30)
#define MOLEMOLE_MONSTER_MONSTERCAMPCOLLISIONMATRIX_METHOD_2_AFC923413AD5A282_OFFSET UNITYSDK_OFFSET(0x13866770)
#define MOLEMOLE_MONSTER_MONSTERCAMPCOLLISIONMATRIX_METHOD_2_C9665CE87E0304EF_OFFSET UNITYSDK_OFFSET(0x13866B70)
#define MOLEMOLE_MONSTER_MONSTERCAMPCOLLISIONMATRIX__CTOR_OFFSET UNITYSDK_OFFSET(0x13866410)

namespace MoleMole::Monster
{
	inline static constexpr unsigned int MonsterCampCollisionMatrix_TypeDefinitionIndex = 44070;
