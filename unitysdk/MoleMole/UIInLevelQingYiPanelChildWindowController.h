...
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_CHANGEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1608CAA0)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_CLEARPROGRESS_OFFSET UNITYSDK_OFFSET(0x1608CAF0)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_COLLECTALLANIMATIONCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1608B680)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_GETANIMCLIPLENGTH_OFFSET UNITYSDK_OFFSET(0x1608C5B0)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_GET_MAX_PROGRESS_WIDTH_OFFSET UNITYSDK_OFFSET(0x1608B530)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1608B520)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_HANDLEALLCUSTOMPROPERTIESONSHOW_OFFSET UNITYSDK_OFFSET(0x1608B740)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_HANDLECUSTOMPROPERTY_OFFSET UNITYSDK_OFFSET(0x1608B7F0)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x1608C640)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1608B540)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1608B5D0)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_SETMAT_OFFSET UNITYSDK_OFFSET(0x1608C1E0)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1608CBA0)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER___BASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x1608CBB0)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1608CC40)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1608CCD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelQingYiPanelChildWindowController_TypeDefinitionIndex = 58283;
	...
	public:
		...
		::Class_2_9E7D6F27FE46FBD9* _view; // 0x348
		::UnityEngine::Material* _mat1; // 0x350
		::UnityEngine::Material* _mat2; // 0x358
		::System::WeakReference_1<::ShaderAniHelp*>* _lineEFHelp; // 0x360
		::UnityEngine::Color _lineEFOriginalColor; // 0x368
