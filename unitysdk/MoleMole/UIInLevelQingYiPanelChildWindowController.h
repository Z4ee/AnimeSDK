...
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_CHANGEMATERIAL_OFFSET UNITYSDK_OFFSET(0x199F6640)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_CLEARPROGRESS_OFFSET UNITYSDK_OFFSET(0x199F6690)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_COLLECTALLANIMATIONCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x199F5210)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_GETANIMCLIPLENGTH_OFFSET UNITYSDK_OFFSET(0x199F6150)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_GET_MAX_PROGRESS_WIDTH_OFFSET UNITYSDK_OFFSET(0x199F50C0)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x199F50B0)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_HANDLEALLCUSTOMPROPERTIESONSHOW_OFFSET UNITYSDK_OFFSET(0x199F52D0)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_HANDLECUSTOMPROPERTY_OFFSET UNITYSDK_OFFSET(0x199F5380)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x199F61E0)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x199F50D0)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x199F5160)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_SETMAT_OFFSET UNITYSDK_OFFSET(0x199F5D70)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x199F6740)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER___BASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x199F6750)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x199F67E0)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x199F6870)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelQingYiPanelChildWindowController_TypeDefinitionIndex = 41117;
