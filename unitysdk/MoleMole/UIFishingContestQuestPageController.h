...
#define MOLEMOLE_UIFISHINGCONTESTQUESTPAGECONTROLLER_GETTASKTOGGLEOPENID_OFFSET UNITYSDK_OFFSET(0x15EEF5C0)
#define MOLEMOLE_UIFISHINGCONTESTQUESTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15EEDE90)
#define MOLEMOLE_UIFISHINGCONTESTQUESTPAGECONTROLLER_ISTASKTOGGLEFINISH_OFFSET UNITYSDK_OFFSET(0x15EEF230)
#define MOLEMOLE_UIFISHINGCONTESTQUESTPAGECONTROLLER_ISTASKTOGGLELOCK_OFFSET UNITYSDK_OFFSET(0x15EEF090)
#define MOLEMOLE_UIFISHINGCONTESTQUESTPAGECONTROLLER_ONCLICKTASK_OFFSET UNITYSDK_OFFSET(0x15EEF620)
#define MOLEMOLE_UIFISHINGCONTESTQUESTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15EEDEA0)
#define MOLEMOLE_UIFISHINGCONTESTQUESTPAGECONTROLLER_ONGOTOTASKBUTTON_OFFSET UNITYSDK_OFFSET(0x15EF0490)
#define MOLEMOLE_UIFISHINGCONTESTQUESTPAGECONTROLLER_ONSHOWTIPSBUTTON_OFFSET UNITYSDK_OFFSET(0x15EF0990)
#define MOLEMOLE_UIFISHINGCONTESTQUESTPAGECONTROLLER_ONTOGGLECLICKPRECHECK_OFFSET UNITYSDK_OFFSET(0x15EEF4B0)
#define MOLEMOLE_UIFISHINGCONTESTQUESTPAGECONTROLLER_ONTOGGLE_OFFSET UNITYSDK_OFFSET(0x15EEEB60)
#define MOLEMOLE_UIFISHINGCONTESTQUESTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15EEF3B0)
#define MOLEMOLE_UIFISHINGCONTESTQUESTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15EEDF30)
#define MOLEMOLE_UIFISHINGCONTESTQUESTPAGECONTROLLER_SETPANELDATA_OFFSET UNITYSDK_OFFSET(0x15EEE5F0)
#define MOLEMOLE_UIFISHINGCONTESTQUESTPAGECONTROLLER_SHOWREWARD_OFFSET UNITYSDK_OFFSET(0x15EF0080)
#define MOLEMOLE_UIFISHINGCONTESTQUESTPAGECONTROLLER_SORTMETHOD_OFFSET UNITYSDK_OFFSET(0x15EEF420)
#define MOLEMOLE_UIFISHINGCONTESTQUESTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15EF0A80)
#define MOLEMOLE_UIFISHINGCONTESTQUESTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15EF0BD0)
#define MOLEMOLE_UIFISHINGCONTESTQUESTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15EF0C60)
#define MOLEMOLE_UIFISHINGCONTESTQUESTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15EF0C70)

namespace MoleMole
{
	inline static constexpr unsigned int UIFishingContestQuestPageController_TypeDefinitionIndex = 57929;

	class UIFishingContestQuestPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_8FCB22336286BF09* _view; // 0x310
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_808*>*>* _typeToTaskListMap; // 0x318
		::System::Collections::Generic::List_1<::MoleMole::UIFishingContestQuestListWidgetController*>* _taskTemplateList; // 0x320
		::System::Collections::Generic::List_1<::MoleMole::UIItemIconBtnSmallWidgetController*>* _rewardTemplateList; // 0x328
		::MoleMole::UIFishingContestQuestListWidgetController* _currentTaskTemplateCache; // 0x330
		...
		::System::Int32 SortMethod(::Class_2_208CC9941471731A_808* first, ::Class_2_208CC9941471731A_808* second)
		{
			return ((::System::Int32(*)(::PVOID, ::Class_2_208CC9941471731A_808*, ::Class_2_208CC9941471731A_808*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIFISHINGCONTESTQUESTPAGECONTROLLER_SORTMETHOD_OFFSET))(this, first, second);
		}
