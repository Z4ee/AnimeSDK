...
#define MOLEMOLE_MONOENTITYEFFECTDEBUGGER_METHOD_5_ABE7715DB28B2DD1_OFFSET UNITYSDK_OFFSET(0x13857CB0)
#define MOLEMOLE_MONOENTITYEFFECTDEBUGGER_PLAYEFFECT_OFFSET UNITYSDK_OFFSET(0x13857A50)
#define MOLEMOLE_MONOENTITYEFFECTDEBUGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x13857C30)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEntityEffectDebugger_TypeDefinitionIndex = 58199;
