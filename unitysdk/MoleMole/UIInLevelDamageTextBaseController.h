...
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER_CALCUPOS_OFFSET UNITYSDK_OFFSET(0x19EB9120)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER_GETDAMAGETEXTLENGTH_OFFSET UNITYSDK_OFFSET(0x19EB8D30)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER_GETFINALDISPLAYPOS_OFFSET UNITYSDK_OFFSET(0x19EB8EF0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER_GET_ISTEXTHIDDEN_OFFSET UNITYSDK_OFFSET(0x19EB8AE0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x19EB8AD0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER_HIDETEXT_OFFSET UNITYSDK_OFFSET(0x19EB9290)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x19EB9560)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER_ONPAUSEGAMESTATECHANGED_OFFSET UNITYSDK_OFFSET(0x19EB9C90)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19EB8AF0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER_ONUPDATETEXT_OFFSET UNITYSDK_OFFSET(0x19EB8D80)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x19EB9800)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER_SETPARENTCONTAINER_OFFSET UNITYSDK_OFFSET(0x19EB8DE0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER_SHOWTEXT_OFFSET UNITYSDK_OFFSET(0x19EB8E30)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19EB9D20)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19EB9CE0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19EB9D40)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelDamageTextBaseController_TypeDefinitionIndex = 84305;
	...
	public:
		...
		{
			return (::UnityEngine::Vector2*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelDamageTextBaseController_TypeDefinitionIndex)->GetStaticField(0xB2F0);
		}
		::System::Boolean _isTextHidden; // 0x318
		::MoleMole::Battle::Entity* _attackee; // 0x320
		::Class_3_C93CC3D2C2AC4067* _attackeeModelComponent; // 0x328
