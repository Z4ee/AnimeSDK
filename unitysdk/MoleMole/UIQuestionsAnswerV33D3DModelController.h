...
#define MOLEMOLE_UIQUESTIONSANSWERV33D3DMODELCONTROLLER_CREATEUIQUESTIONSANSWERSCREENWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x18216B20)
#define MOLEMOLE_UIQUESTIONSANSWERV33D3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18216BD0)
#define MOLEMOLE_UIQUESTIONSANSWERV33D3DMODELCONTROLLER___BASE_CREATEUIQUESTIONSANSWERSCREENWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x18216C30)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerV33D3DModelController_TypeDefinitionIndex = 41208;
