...
#define MOLEMOLE_UIQUESTIONSANSWERV33D3DMODELCONTROLLER_CREATEUIQUESTIONSANSWERSCREENWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x1757B130)
#define MOLEMOLE_UIQUESTIONSANSWERV33D3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1757B1E0)
#define MOLEMOLE_UIQUESTIONSANSWERV33D3DMODELCONTROLLER___BASE_CREATEUIQUESTIONSANSWERSCREENWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x1757B240)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerV33D3DModelController_TypeDefinitionIndex = 47470;
