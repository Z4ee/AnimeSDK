...
#define MOLEMOLE_UICOOPMATCHMAPROW02WIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19714290)
#define MOLEMOLE_UICOOPMATCHMAPROW02WIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19714300)
#define MOLEMOLE_UICOOPMATCHMAPROW02WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x19714520)
#define MOLEMOLE_UICOOPMATCHMAPROW02WIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x197145E0)
#define MOLEMOLE_UICOOPMATCHMAPROW02WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19714770)
#define MOLEMOLE_UICOOPMATCHMAPROW02WIDGETCONTROLLER__ONCREATEVIEWMODEL_B__4_0_OFFSET UNITYSDK_OFFSET(0x19714780)
#define MOLEMOLE_UICOOPMATCHMAPROW02WIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19714B30)
#define MOLEMOLE_UICOOPMATCHMAPROW02WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x19714BD0)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopMatchMapRow02WidgetController_TypeDefinitionIndex = 62936;
