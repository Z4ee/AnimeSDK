...
#define MOLEMOLE_UIGACHAPERFORMANCE3DMODELCONTROLLER___C__DISPLAYCLASS12_1__CTOR_OFFSET UNITYSDK_OFFSET(0x17304C60)
#define MOLEMOLE_UIGACHAPERFORMANCE3DMODELCONTROLLER___C__DISPLAYCLASS12_1__PLAYSTAGE_B__2_OFFSET UNITYSDK_OFFSET(0x17304C70)
#define MOLEMOLE_UIGACHAPERFORMANCE3DMODELCONTROLLER___C__DISPLAYCLASS12_1__PLAYSTAGE_B__3_OFFSET UNITYSDK_OFFSET(0x17304E30)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaPerformance3DModelController___c__DisplayClass12_1_TypeDefinitionIndex = 53651;
	...
	public:
		...
		::Class_2_208CC9941471731A_385* capturedTemplate; // 0x18
		::MoleMole::UIGachaStage3DModelControllerBase* capturedCtrler; // 0x20
		::System::Action* __9__3; // 0x28
		::System::Int32 capturedTotalPhaseCount; // 0x30
		::System::Int32 capturedPerformanceId; // 0x34
		::System::Int32 capturedPhaseCount; // 0x38
		::System::Single capturedDuration; // 0x3C
