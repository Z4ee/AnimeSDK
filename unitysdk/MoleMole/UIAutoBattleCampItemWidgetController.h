...
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER_BINDVIEW_OFFSET UNITYSDK_OFFSET(0x12F417A0)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x12F424D0)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12F415F0)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x12F42540)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x12F41700)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12F41680)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12F41440)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12F42760)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x12F42770)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12F42780)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x12F427D0)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x12F42860)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12F42900)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12F42940)

namespace MoleMole
{
	inline static constexpr unsigned int UIAutoBattleCampItemWidgetController_TypeDefinitionIndex = 69014;

	class UIAutoBattleCampItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_65C1A8EF90D57BB1* _view; // 0x2E8
		::MoleMole::UIABInLevelGeneralWidgetController* _parent; // 0x2F0
