...
class Class_2_5EBDDC2A4CBE1553;
namespace MoleMole { class UIABInLevelGeneralWidgetController; }
namespace MoleMole { class UIControlReference; }
namespace System { class Object; }

#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER_BINDVIEW_OFFSET UNITYSDK_OFFSET(0x16010970)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x160116E0)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x160107C0)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x16011750)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x160108D0)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16010850)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16010610)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16011970)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x16011980)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16011990)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x160119E0)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16011A70)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16011B10)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16011B50)

namespace MoleMole
{
	inline static constexpr unsigned int UIAutoBattleCampItemWidgetController_TypeDefinitionIndex = 42702;

	class UIAutoBattleCampItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_5EBDDC2A4CBE1553* _view; // 0x2F0
