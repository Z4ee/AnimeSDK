...
#define MOLEMOLE_UIINLEVELVIVIANCHILDWINDOWCONTROLLER_GET_OUTLINEANIM_OFFSET UNITYSDK_OFFSET(0x1911C350)
#define MOLEMOLE_UIINLEVELVIVIANCHILDWINDOWCONTROLLER_GET_POINTANIM_OFFSET UNITYSDK_OFFSET(0x1911C320)
#define MOLEMOLE_UIINLEVELVIVIANCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1911C310)
#define MOLEMOLE_UIINLEVELVIVIANCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1911C440)
#define MOLEMOLE_UIINLEVELVIVIANCHILDWINDOWCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1911C540)
#define MOLEMOLE_UIINLEVELVIVIANCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1911C4D0)
#define MOLEMOLE_UIINLEVELVIVIANCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1911C380)
#define MOLEMOLE_UIINLEVELVIVIANCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1911C3D0)
#define MOLEMOLE_UIINLEVELVIVIANCHILDWINDOWCONTROLLER_REFRESHCURBUFFCOUNT_OFFSET UNITYSDK_OFFSET(0x1911C820)
#define MOLEMOLE_UIINLEVELVIVIANCHILDWINDOWCONTROLLER_REFRESHCURCHARGEPOINT_OFFSET UNITYSDK_OFFSET(0x1911C5C0)
#define MOLEMOLE_UIINLEVELVIVIANCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1911CA80)
#define MOLEMOLE_UIINLEVELVIVIANCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1911CA90)
#define MOLEMOLE_UIINLEVELVIVIANCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1911CB20)
#define MOLEMOLE_UIINLEVELVIVIANCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1911CB30)
#define MOLEMOLE_UIINLEVELVIVIANCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1911CB40)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelVivianChildWindowController_TypeDefinitionIndex = 55920;
