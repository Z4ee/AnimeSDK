...
#define MOLEMOLE_MONOHINTARROW_CLASS_1_02DF210C0E28496E_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1176B610)
#define MOLEMOLE_MONOHINTARROW_CLASS_1_02DF210C0E28496E_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1176B850)
#define MOLEMOLE_MONOHINTARROW_CLASS_1_02DF210C0E28496E_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1176B8B0)
#define MOLEMOLE_MONOHINTARROW_CLASS_1_02DF210C0E28496E_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1176B860)
#define MOLEMOLE_MONOHINTARROW_CLASS_1_02DF210C0E28496E_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1176B600)
#define MOLEMOLE_MONOHINTARROW_CLASS_1_02DF210C0E28496E__CTOR_OFFSET UNITYSDK_OFFSET(0x1176B5F0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoHintArrow_Class_1_02DF210C0E28496E_TypeDefinitionIndex = 50640;
