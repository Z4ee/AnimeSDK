...
#define MOLEMOLE_UIREPORTCHATCONVERSATIONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1667D2E0)
#define MOLEMOLE_UIREPORTCHATCONVERSATIONWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1667D3F0)
#define MOLEMOLE_UIREPORTCHATCONVERSATIONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1667D370)
#define MOLEMOLE_UIREPORTCHATCONVERSATIONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1667D130)
#define MOLEMOLE_UIREPORTCHATCONVERSATIONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1667D760)
#define MOLEMOLE_UIREPORTCHATCONVERSATIONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1667D770)
#define MOLEMOLE_UIREPORTCHATCONVERSATIONWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1667D800)
#define MOLEMOLE_UIREPORTCHATCONVERSATIONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1667D8A0)
#define MOLEMOLE_UIREPORTCHATCONVERSATIONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1667D930)

namespace MoleMole
{
	inline static constexpr unsigned int UIReportChatConversationWidgetController_TypeDefinitionIndex = 65185;

	class UIReportChatConversationWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_12758EFCB74270F1_1* _view; // 0x2F0
		::Class_1_CFB77E4CE51A29F6* _data; // 0x2F8
