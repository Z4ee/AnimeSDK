...
#define MOLEMOLE_UIREPORTCHATCONVERSATIONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1456D1B0)
#define MOLEMOLE_UIREPORTCHATCONVERSATIONWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1456D2C0)
#define MOLEMOLE_UIREPORTCHATCONVERSATIONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1456D240)
#define MOLEMOLE_UIREPORTCHATCONVERSATIONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1456D000)
#define MOLEMOLE_UIREPORTCHATCONVERSATIONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1456D630)
#define MOLEMOLE_UIREPORTCHATCONVERSATIONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1456D640)
#define MOLEMOLE_UIREPORTCHATCONVERSATIONWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1456D6D0)
#define MOLEMOLE_UIREPORTCHATCONVERSATIONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1456D770)
#define MOLEMOLE_UIREPORTCHATCONVERSATIONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1456D800)

namespace MoleMole
{
	inline static constexpr unsigned int UIReportChatConversationWidgetController_TypeDefinitionIndex = 47194;

	class UIReportChatConversationWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_12758EFCB74270F1* _view; // 0x2E8
		::Class_1_CFB77E4CE51A29F6* _data; // 0x2F0
		::System::Boolean _isSelected; // 0x2F8
