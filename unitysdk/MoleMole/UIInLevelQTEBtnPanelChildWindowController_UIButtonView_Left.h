...
#define MOLEMOLE_UIINLEVELQTEBTNPANELCHILDWINDOWCONTROLLER_UIBUTTONVIEW_LEFT_GET_BTN_OFFSET UNITYSDK_OFFSET(0x1722D140)
#define MOLEMOLE_UIINLEVELQTEBTNPANELCHILDWINDOWCONTROLLER_UIBUTTONVIEW_LEFT_GET_BUTTONAREA_OFFSET UNITYSDK_OFFSET(0x1722D3E0)
#define MOLEMOLE_UIINLEVELQTEBTNPANELCHILDWINDOWCONTROLLER_UIBUTTONVIEW_LEFT_GET_BUTTONROOT_OFFSET UNITYSDK_OFFSET(0x1722D170)
#define MOLEMOLE_UIINLEVELQTEBTNPANELCHILDWINDOWCONTROLLER_UIBUTTONVIEW_LEFT_GET_MAXDRAGAREA_OFFSET UNITYSDK_OFFSET(0x1722D240)
#define MOLEMOLE_UIINLEVELQTEBTNPANELCHILDWINDOWCONTROLLER_UIBUTTONVIEW_LEFT_GET_MINDRAGAREA_OFFSET UNITYSDK_OFFSET(0x1722D310)
#define MOLEMOLE_UIINLEVELQTEBTNPANELCHILDWINDOWCONTROLLER_UIBUTTONVIEW_LEFT__CTOR_OFFSET UNITYSDK_OFFSET(0x1722D4B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelQTEBtnPanelChildWindowController_UIButtonView_Left_TypeDefinitionIndex = 81571;
