...
#define MOLEMOLE_UIINLEVELQTEBTNPANELCHILDWINDOWCONTROLLER_UIBUTTONVIEW_LEFT_GET_BTN_OFFSET UNITYSDK_OFFSET(0x1639C570)
#define MOLEMOLE_UIINLEVELQTEBTNPANELCHILDWINDOWCONTROLLER_UIBUTTONVIEW_LEFT_GET_BUTTONAREA_OFFSET UNITYSDK_OFFSET(0x1639C810)
#define MOLEMOLE_UIINLEVELQTEBTNPANELCHILDWINDOWCONTROLLER_UIBUTTONVIEW_LEFT_GET_BUTTONROOT_OFFSET UNITYSDK_OFFSET(0x1639C5A0)
#define MOLEMOLE_UIINLEVELQTEBTNPANELCHILDWINDOWCONTROLLER_UIBUTTONVIEW_LEFT_GET_MAXDRAGAREA_OFFSET UNITYSDK_OFFSET(0x1639C670)
#define MOLEMOLE_UIINLEVELQTEBTNPANELCHILDWINDOWCONTROLLER_UIBUTTONVIEW_LEFT_GET_MINDRAGAREA_OFFSET UNITYSDK_OFFSET(0x1639C740)
#define MOLEMOLE_UIINLEVELQTEBTNPANELCHILDWINDOWCONTROLLER_UIBUTTONVIEW_LEFT__CTOR_OFFSET UNITYSDK_OFFSET(0x1639C8E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelQTEBtnPanelChildWindowController_UIButtonView_Left_TypeDefinitionIndex = 70188;
