...
#define MOLEMOLE_UIMINDSCAPEDIALOGPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x182E0E20)
#define MOLEMOLE_UIMINDSCAPEDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x182E0E10)
#define MOLEMOLE_UIMINDSCAPEDIALOGPOPWINDOWCONTROLLER_ISTRAININGROOM_OFFSET UNITYSDK_OFFSET(0x182E1CE0)
#define MOLEMOLE_UIMINDSCAPEDIALOGPOPWINDOWCONTROLLER_ONCANCELCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x182E0FB0)
#define MOLEMOLE_UIMINDSCAPEDIALOGPOPWINDOWCONTROLLER_ONCLOSEHANDLE_OFFSET UNITYSDK_OFFSET(0x182E12B0)
#define MOLEMOLE_UIMINDSCAPEDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x182E1420)
#define MOLEMOLE_UIMINDSCAPEDIALOGPOPWINDOWCONTROLLER_ONOKBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x182E1050)
#define MOLEMOLE_UIMINDSCAPEDIALOGPOPWINDOWCONTROLLER_ONTALENTUNLOCKHANDLE_OFFSET UNITYSDK_OFFSET(0x182E1210)
#define MOLEMOLE_UIMINDSCAPEDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x182E2460)
#define MOLEMOLE_UIMINDSCAPEDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x182E0E30)
#define MOLEMOLE_UIMINDSCAPEDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x182E13B0)
#define MOLEMOLE_UIMINDSCAPEDIALOGPOPWINDOWCONTROLLER_ONUNLOCKCLOSEHANDLE_OFFSET UNITYSDK_OFFSET(0x182E1330)
#define MOLEMOLE_UIMINDSCAPEDIALOGPOPWINDOWCONTROLLER_REFRESHMATERIAL_OFFSET UNITYSDK_OFFSET(0x182E1E00)
#define MOLEMOLE_UIMINDSCAPEDIALOGPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x182E1650)
#define MOLEMOLE_UIMINDSCAPEDIALOGPOPWINDOWCONTROLLER_SETAVATARCOLOR_OFFSET UNITYSDK_OFFSET(0x182E1C10)
#define MOLEMOLE_UIMINDSCAPEDIALOGPOPWINDOWCONTROLLER_SETDATA_OFFSET UNITYSDK_OFFSET(0x182E14B0)
#define MOLEMOLE_UIMINDSCAPEDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x182E24D0)
#define MOLEMOLE_UIMINDSCAPEDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x182E2560)
#define MOLEMOLE_UIMINDSCAPEDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x182E25F0)
#define MOLEMOLE_UIMINDSCAPEDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x182E2600)
#define MOLEMOLE_UIMINDSCAPEDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x182E2610)

namespace MoleMole
{
	inline static constexpr unsigned int UIMindscapeDialogPopWindowController_TypeDefinitionIndex = 64248;
	...
	public:
		...
		::Class_2_208CC9941471731A_767* _talentCfg; // 0x338
		...
		::System::Void OnTalentUnLockHandle(::Class_0_16E4307DCC419505_36* rcvMessage)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_36*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMINDSCAPEDIALOGPOPWINDOWCONTROLLER_ONTALENTUNLOCKHANDLE_OFFSET))(this, rcvMessage);
		}
