...
#define MOLEMOLE_ACTIVITYRETURNGIFTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x174258C0)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityReturnGiftContext_TypeDefinitionIndex = 48318;
