...
#define MOLEMOLE_UIACTIVITYCOMBATPAUSEBUFFROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17E3CBA0)
#define MOLEMOLE_UIACTIVITYCOMBATPAUSEBUFFROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17E3CCB0)
#define MOLEMOLE_UIACTIVITYCOMBATPAUSEBUFFROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17E3CC30)
#define MOLEMOLE_UIACTIVITYCOMBATPAUSEBUFFROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17E3CB40)
#define MOLEMOLE_UIACTIVITYCOMBATPAUSEBUFFROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17E3CD90)
#define MOLEMOLE_UIACTIVITYCOMBATPAUSEBUFFROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17E3CDA0)
#define MOLEMOLE_UIACTIVITYCOMBATPAUSEBUFFROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17E3CE30)
#define MOLEMOLE_UIACTIVITYCOMBATPAUSEBUFFROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17E3CED0)
#define MOLEMOLE_UIACTIVITYCOMBATPAUSEBUFFROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17E3CF60)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityCombatPauseBuffRowWidgetController_TypeDefinitionIndex = 71437;

	class UIActivityCombatPauseBuffRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_0096754AC2F6E253_2* _view; // 0x2E8
