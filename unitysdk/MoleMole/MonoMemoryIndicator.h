...
#define MOLEMOLE_MONOMEMORYINDICATOR_AWAKE_OFFSET UNITYSDK_OFFSET(0x1163BAE0)
#define MOLEMOLE_MONOMEMORYINDICATOR_CHECKGENERALUI_OFFSET UNITYSDK_OFFSET(0x1163C960)
#define MOLEMOLE_MONOMEMORYINDICATOR_METHOD_5_19844080C13BA28F_OFFSET UNITYSDK_OFFSET(0x1163F090)
#define MOLEMOLE_MONOMEMORYINDICATOR_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x1163EFC0)
#define MOLEMOLE_MONOMEMORYINDICATOR_METHOD_5_3B258437A86233AC_OFFSET UNITYSDK_OFFSET(0x1163DD40)
#define MOLEMOLE_MONOMEMORYINDICATOR_METHOD_5_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x1163CD40)
#define MOLEMOLE_MONOMEMORYINDICATOR_METHOD_5_5FAD56E9E208220A_OFFSET UNITYSDK_OFFSET(0x1163F400)
#define MOLEMOLE_MONOMEMORYINDICATOR_METHOD_5_B43C848B078B3C34_OFFSET UNITYSDK_OFFSET(0x1163F460)
#define MOLEMOLE_MONOMEMORYINDICATOR_METHOD_5_B64E6D35718AD10A_OFFSET UNITYSDK_OFFSET(0x1163ED60)
#define MOLEMOLE_MONOMEMORYINDICATOR_METHOD_5_DCD9FE8382DA243A_OFFSET UNITYSDK_OFFSET(0x1163ECE0)
#define MOLEMOLE_MONOMEMORYINDICATOR_METHOD_5_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x1163D6A0)
#define MOLEMOLE_MONOMEMORYINDICATOR_METHOD_5_F79D5EC57FBF426E_OFFSET UNITYSDK_OFFSET(0x1163D540)
#define MOLEMOLE_MONOMEMORYINDICATOR_ONANIMATIONCLIPBTNCLICK_OFFSET UNITYSDK_OFFSET(0x1163D860)
#define MOLEMOLE_MONOMEMORYINDICATOR_ONMATERIALBTNCLICK_OFFSET UNITYSDK_OFFSET(0x1163D8B0)
#define MOLEMOLE_MONOMEMORYINDICATOR_ONMESHBTNCLICK_OFFSET UNITYSDK_OFFSET(0x1163D810)
#define MOLEMOLE_MONOMEMORYINDICATOR_ONRENDERTEXTUREBTNCLICK_OFFSET UNITYSDK_OFFSET(0x1163D7C0)
#define MOLEMOLE_MONOMEMORYINDICATOR_ONSTREAMASBCLICK_OFFSET UNITYSDK_OFFSET(0x1163D900)
#define MOLEMOLE_MONOMEMORYINDICATOR_ONTEXTUREBTNCLICK_OFFSET UNITYSDK_OFFSET(0x1163D650)
#define MOLEMOLE_MONOMEMORYINDICATOR_ONTOTALBTNCLICK_OFFSET UNITYSDK_OFFSET(0x1163D5F0)
#define MOLEMOLE_MONOMEMORYINDICATOR_ONUPLOADBTNCLICK_OFFSET UNITYSDK_OFFSET(0x1163DB20)
#define MOLEMOLE_MONOMEMORYINDICATOR_RECORDMEMORY_OFFSET UNITYSDK_OFFSET(0x1163CFE0)
#define MOLEMOLE_MONOMEMORYINDICATOR_RESETMAXMEMORY_OFFSET UNITYSDK_OFFSET(0x1163D950)
#define MOLEMOLE_MONOMEMORYINDICATOR_START_OFFSET UNITYSDK_OFFSET(0x1163CCD0)
#define MOLEMOLE_MONOMEMORYINDICATOR_TRACKCURMEM_OFFSET UNITYSDK_OFFSET(0x1163DAA0)
#define MOLEMOLE_MONOMEMORYINDICATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x1163CE90)
#define MOLEMOLE_MONOMEMORYINDICATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1163DD00)
#define MOLEMOLE_MONOMEMORYINDICATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1163DB60)

namespace MoleMole
{
	inline static constexpr unsigned int MonoMemoryIndicator_TypeDefinitionIndex = 43466;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(MonoMemoryIndicator_TypeDefinitionIndex)->GetStaticField(0x469C0);
		}
		...
		::System::Collections::Generic::Dictionary_2<::Class_1_79204BBCEA1240BB_Enum_3_BA2FF5C66FF53326, ::Class_1_DC08FA4F74036387*>* Field_5_10; // 0x58
		::Class_1_79204BBCEA1240BB_Enum_3_BA2FF5C66FF53326 Field_5_11; // 0x60
