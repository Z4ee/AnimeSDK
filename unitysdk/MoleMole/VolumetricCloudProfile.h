...
#define MOLEMOLE_VOLUMETRICCLOUDPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x1353A4C0)
#define MOLEMOLE_VOLUMETRICCLOUDPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x1353A600)
#define MOLEMOLE_VOLUMETRICCLOUDPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x1353A3E0)
#define MOLEMOLE_VOLUMETRICCLOUDPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1353A580)
#define MOLEMOLE_VOLUMETRICCLOUDPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x1353A3D0)
#define MOLEMOLE_VOLUMETRICCLOUDPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1353A720)
#define MOLEMOLE_VOLUMETRICCLOUDPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x1353A7B0)
#define MOLEMOLE_VOLUMETRICCLOUDPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x1353A840)
#define MOLEMOLE_VOLUMETRICCLOUDPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1353A8D0)

namespace MoleMole
{
	inline static constexpr unsigned int VolumetricCloudProfile_TypeDefinitionIndex = 68730;
