...
#define MOLEMOLE_VOLUMETRICCLOUDPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x12A2B570)
#define MOLEMOLE_VOLUMETRICCLOUDPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x12A2B6B0)
#define MOLEMOLE_VOLUMETRICCLOUDPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x12A2B490)
#define MOLEMOLE_VOLUMETRICCLOUDPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x12A2B630)
#define MOLEMOLE_VOLUMETRICCLOUDPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x12A2B480)
#define MOLEMOLE_VOLUMETRICCLOUDPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x12A2B7D0)
#define MOLEMOLE_VOLUMETRICCLOUDPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x12A2B860)
#define MOLEMOLE_VOLUMETRICCLOUDPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x12A2B8F0)
#define MOLEMOLE_VOLUMETRICCLOUDPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x12A2B980)

namespace MoleMole
{
	inline static constexpr unsigned int VolumetricCloudProfile_TypeDefinitionIndex = 63774;
