...
#define MOLEMOLE_SCENESOUNDDATA_SUBAREACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1385F620)

namespace MoleMole
{
	inline static constexpr unsigned int SceneSoundData_SubAreaConfig_TypeDefinitionIndex = 49904;
