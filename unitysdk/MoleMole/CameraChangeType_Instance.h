...
#define MOLEMOLE_CAMERACHANGETYPE_INSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x141D76B0)

namespace MoleMole
{
	inline static constexpr unsigned int CameraChangeType_Instance_TypeDefinitionIndex = 82302;
