...
#define MOLEMOLE_UIOVERLORDFEASTREWARDPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x17A09000)
#define MOLEMOLE_UIOVERLORDFEASTREWARDPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x17A090F0)
#define MOLEMOLE_UIOVERLORDFEASTREWARDPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17A09010)
#define MOLEMOLE_UIOVERLORDFEASTREWARDPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17A09CA0)
#define MOLEMOLE_UIOVERLORDFEASTREWARDPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17A090A0)
#define MOLEMOLE_UIOVERLORDFEASTREWARDPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17A093B0)
#define MOLEMOLE_UIOVERLORDFEASTREWARDPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x17A09430)
#define MOLEMOLE_UIOVERLORDFEASTREWARDPAGECONTROLLER_TAKEALLREWARDS_OFFSET UNITYSDK_OFFSET(0x17A09D10)
#define MOLEMOLE_UIOVERLORDFEASTREWARDPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17A0A310)
#define MOLEMOLE_UIOVERLORDFEASTREWARDPAGECONTROLLER__TAKEALLREWARDS_B__9_0_OFFSET UNITYSDK_OFFSET(0x17A0A320)
#define MOLEMOLE_UIOVERLORDFEASTREWARDPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17A0A350)
#define MOLEMOLE_UIOVERLORDFEASTREWARDPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17A0A3E0)
#define MOLEMOLE_UIOVERLORDFEASTREWARDPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17A0A3F0)
#define MOLEMOLE_UIOVERLORDFEASTREWARDPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17A0A400)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastRewardPageController_TypeDefinitionIndex = 55257;
