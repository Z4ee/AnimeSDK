...
#define MOLEMOLE_INLEVELBANGBOOATTACKKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x142921E0)
#define MOLEMOLE_INLEVELBANGBOOATTACKKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x142921F0)
#define MOLEMOLE_INLEVELBANGBOOATTACKKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x14292200)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelBangbooAttackKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 75605;
