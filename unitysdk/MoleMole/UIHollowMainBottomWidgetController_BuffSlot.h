...
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_CLEARBUFFID_OFFSET UNITYSDK_OFFSET(0x189977D0)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_CLEARHANDLE_OFFSET UNITYSDK_OFFSET(0x18996570)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_CLEARNEXTBUFFSTATE_OFFSET UNITYSDK_OFFSET(0x189961E0)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_GETPLACEHOLDERCOUNT_OFFSET UNITYSDK_OFFSET(0x18996720)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_GET_END_OFFSET UNITYSDK_OFFSET(0x18994610)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_GET_LOOP02ROOT_OFFSET UNITYSDK_OFFSET(0x18993830)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_GET_LOOP02_OFFSET UNITYSDK_OFFSET(0x189939D0)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_GET_LOOP_OFFSET UNITYSDK_OFFSET(0x18994220)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_GET_START_OFFSET UNITYSDK_OFFSET(0x18994AE0)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_ISSPECIAL_OFFSET UNITYSDK_OFFSET(0x18996B00)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_PLAYBUFFDES_OFFSET UNITYSDK_OFFSET(0x18997330)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_REFRESHSPECIALSTATE_OFFSET UNITYSDK_OFFSET(0x18995370)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_REPLAY_OFFSET UNITYSDK_OFFSET(0x18997A60)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_RESETBUFFID_OFFSET UNITYSDK_OFFSET(0x18997540)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_RESET_OFFSET UNITYSDK_OFFSET(0x18996240)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_SETBUFFID_OFFSET UNITYSDK_OFFSET(0x18996EB0)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_SETNEXTBUFFSTATE_OFFSET UNITYSDK_OFFSET(0x189963B0)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_SETSATURATION_OFFSET UNITYSDK_OFFSET(0x18995BD0)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_SETTOTOP_OFFSET UNITYSDK_OFFSET(0x18995B80)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_SHOWLOOP_OFFSET UNITYSDK_OFFSET(0x18997200)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_UPDATEMUTESTATE_OFFSET UNITYSDK_OFFSET(0x18996960)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT__CLEARBUFFID_B__45_0_OFFSET UNITYSDK_OFFSET(0x18997C80)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18995750)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x18994FB0)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT__DELAY_OFFSET UNITYSDK_OFFSET(0x189972B0)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT__REFRESHSPECIALSTATE_G__UPDATEPARTICLE_38_0_OFFSET UNITYSDK_OFFSET(0x18996B70)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT__SETNEXTBUFFSTATE_B__34_0_OFFSET UNITYSDK_OFFSET(0x18997AD0)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT___DELAY_B__42_0_OFFSET UNITYSDK_OFFSET(0x18997C40)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMainBottomWidgetController_BuffSlot_TypeDefinitionIndex = 83683;

	class UIHollowMainBottomWidgetController_BuffSlot : public ::System::Object
	{
	public:
		::UnityEngine::UI::Text* buffDes; // 0x10
		::MoleMole::UIHollowMainBottomWidgetController* ctrl; // 0x18
		::UnityEngine::GameObject* specialGo; // 0x20
		::MoleMole::UIArpeggioBottomBlessRowWidgetController* _widget; // 0x28
		::System::Collections::Generic::List_1<::Foundation::Coroutine::CoroutineHandle>* handles; // 0x30
		::UnityEngine::Animation* ani; // 0x38
		::UnityEngine::GameObject* normalGo; // 0x40
		::Class_2_416175823F05B577* bless; // 0x48
		::UnityEngine::CanvasGroup* group; // 0x50
		::UnityEngine::RectTransform* transform; // 0x58
		::UnityEngine::Animation* lockAnim; // 0x60
		::System::Action* callback; // 0x68
		::System::Int32 itemid; // 0x70
		::System::Boolean isRemoving; // 0x74
		::System::Boolean ForbidSpecial; // 0x75
		::System::Boolean isNextBuff; // 0x76
		::System::Int32 slotIndex; // 0x78
		::System::Boolean isStarting; // 0x7C
		::System::Boolean isSpecial; // 0x7D
		...
		::System::Void _ctor_1(::System::Int32 i, ::Class_3_826A30478DA34A69<::MoleMole::UIArpeggioBottomBlessRowWidgetController*>* tran, ::MoleMole::UIHollowMainBottomWidgetController* uiHollowMainBottomWidgetController)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::Class_3_826A30478DA34A69<::MoleMole::UIArpeggioBottomBlessRowWidgetController*>*, ::MoleMole::UIHollowMainBottomWidgetController*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT__CTOR_1_OFFSET))(this, i, tran, uiHollowMainBottomWidgetController);
		}
