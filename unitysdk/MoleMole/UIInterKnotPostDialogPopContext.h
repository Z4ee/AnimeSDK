...
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x17AC92F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotPostDialogPopContext_TypeDefinitionIndex = 67855;
