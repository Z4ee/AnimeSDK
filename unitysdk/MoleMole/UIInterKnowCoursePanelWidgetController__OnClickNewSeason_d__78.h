...
#define MOLEMOLE_UIINTERKNOWCOURSEPANELWIDGETCONTROLLER__ONCLICKNEWSEASON_D__78_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x8842E0)
#define MOLEMOLE_UIINTERKNOWCOURSEPANELWIDGETCONTROLLER__ONCLICKNEWSEASON_D__78_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x6D9240)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnowCoursePanelWidgetController__OnClickNewSeason_d__78_TypeDefinitionIndex = 79685;
	...
	struct alignas(8) UIInterKnowCoursePanelWidgetController__OnClickNewSeason_d__78
	{
		...
		::MoleMole::UIInterKnowCoursePanelWidgetController* __4__this; // 0x20
		::System::Threading::CancellationToken _cancelToken_5__2; // 0x28
