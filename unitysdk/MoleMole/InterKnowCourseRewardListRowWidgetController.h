...
#define MOLEMOLE_INTERKNOWCOURSEREWARDLISTROWWIDGETCONTROLLER_CLEARREWARDS_OFFSET UNITYSDK_OFFSET(0x149F1770)
#define MOLEMOLE_INTERKNOWCOURSEREWARDLISTROWWIDGETCONTROLLER_ONCLICKTAKEREWARD_OFFSET UNITYSDK_OFFSET(0x149F18F0)
#define MOLEMOLE_INTERKNOWCOURSEREWARDLISTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x149F0AB0)
#define MOLEMOLE_INTERKNOWCOURSEREWARDLISTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x149F0B40)
#define MOLEMOLE_INTERKNOWCOURSEREWARDLISTROWWIDGETCONTROLLER_ONTAKEREWARDSUCCESS_OFFSET UNITYSDK_OFFSET(0x149F1C50)
#define MOLEMOLE_INTERKNOWCOURSEREWARDLISTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x149F0990)
#define MOLEMOLE_INTERKNOWCOURSEREWARDLISTROWWIDGETCONTROLLER_REFRESHREWARD_OFFSET UNITYSDK_OFFSET(0x149F1250)
#define MOLEMOLE_INTERKNOWCOURSEREWARDLISTROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x149F0E90)
#define MOLEMOLE_INTERKNOWCOURSEREWARDLISTROWWIDGETCONTROLLER_SETROWSTATE_OFFSET UNITYSDK_OFFSET(0x149F0CA0)
#define MOLEMOLE_INTERKNOWCOURSEREWARDLISTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x149F1CA0)
#define MOLEMOLE_INTERKNOWCOURSEREWARDLISTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x149F1D30)
#define MOLEMOLE_INTERKNOWCOURSEREWARDLISTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x149F1DC0)
#define MOLEMOLE_INTERKNOWCOURSEREWARDLISTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x149F1E60)

namespace MoleMole
{
	inline static constexpr unsigned int InterKnowCourseRewardListRowWidgetController_TypeDefinitionIndex = 57512;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_36*))((::PBYTE)hIl2Cpp + MOLEMOLE_INTERKNOWCOURSEREWARDLISTROWWIDGETCONTROLLER_ONTAKEREWARDSUCCESS_OFFSET))(this, rcvMessage);
		}
