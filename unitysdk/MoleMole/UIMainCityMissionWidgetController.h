...
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER_GETQUESTDESCRIPTIONSUFFIX_OFFSET UNITYSDK_OFFSET(0x14B8B790)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14B8A120)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14B8A1B0)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14B89E40)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14B8A0B0)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER_PLAYQUESTTRACKENDANIM_OFFSET UNITYSDK_OFFSET(0x14B8B340)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER_PLAYQUESTTRACKSTARTANIM_OFFSET UNITYSDK_OFFSET(0x14B8B240)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER_PLAYQUESTTRACKSWITCHANIM_OFFSET UNITYSDK_OFFSET(0x14B8AE00)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER_REFRESHQUESTTRACKVIEW_OFFSET UNITYSDK_OFFSET(0x14B8A480)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER_SETFADEOUTSTATE_OFFSET UNITYSDK_OFFSET(0x14B8A230)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER_SHOWCURRENTMISSIONFINISHANDSWITCH_OFFSET UNITYSDK_OFFSET(0x14B8B010)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER_SHOWMISSIONFINISHANDHIDE_OFFSET UNITYSDK_OFFSET(0x14B8ABB0)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER_SHOWMISSIONFINISHANDSETTOTRACKQUEST_OFFSET UNITYSDK_OFFSET(0x14B8A2F0)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER_SHOWMISSIONFINISHANDSWITCHTOCURRENT_OFFSET UNITYSDK_OFFSET(0x14B8AD30)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER_STOPQUESTTRACKANIM_OFFSET UNITYSDK_OFFSET(0x14B8B140)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER_UPDATEMISSIONCONTENTFADEINANIMATION_OFFSET UNITYSDK_OFFSET(0x14B8A7E0)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER_UPDATEMISSIONCONTENTFADEOUTANIMATION_OFFSET UNITYSDK_OFFSET(0x14B8B540)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x14B8BD60)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14B8BD00)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER__REFRESHQUESTTRACKVIEW_B__19_0_OFFSET UNITYSDK_OFFSET(0x14B8BED0)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14B8BFC0)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14B8C050)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14B8C0E0)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14B8C170)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityMissionWidgetController_TypeDefinitionIndex = 52940;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIMainCityMissionWidgetController_TypeDefinitionIndex)->GetStaticField(0x449C0);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::String*>** StaticGet_ConditionKeyMap()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(UIMainCityMissionWidgetController_TypeDefinitionIndex)->GetStaticField(0x449C8);
		}
		::Class_2_38082A0AFC8105A8* _view; // 0x2B8
