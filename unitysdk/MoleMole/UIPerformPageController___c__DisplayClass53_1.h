...
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___C__DISPLAYCLASS53_1__CTOR_OFFSET UNITYSDK_OFFSET(0x178D9DD0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___C__DISPLAYCLASS53_1__ONPLAYCGEND_B__2_OFFSET UNITYSDK_OFFSET(0x178D9DE0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___C__DISPLAYCLASS53_1__ONPLAYCGEND_B__3_OFFSET UNITYSDK_OFFSET(0x178D9E70)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___C__DISPLAYCLASS53_1__ONPLAYCGEND_B__4_OFFSET UNITYSDK_OFFSET(0x178D9F00)

namespace MoleMole
{
	inline static constexpr unsigned int UIPerformPageController___c__DisplayClass53_1_TypeDefinitionIndex = 85283;
	...
	public:
		...
		::MoleMole::UIPerformPageController___c__DisplayClass53_0* CS___8__locals1; // 0x20
		::System::Boolean nextGalgame; // 0x28
		::System::Boolean nextComic; // 0x29
