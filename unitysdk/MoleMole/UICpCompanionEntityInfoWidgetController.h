...
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER_HIDETAGS_OFFSET UNITYSDK_OFFSET(0x1F788AB0)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1F788540)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1F7885D0)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1F788450)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1F7884C0)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER_SETTAGSCRIPT_OFFSET UNITYSDK_OFFSET(0x1F789260)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER_UPDATEDATA_OFFSET UNITYSDK_OFFSET(0x1F788690)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER_UPDATETAGS_OFFSET UNITYSDK_OFFSET(0x1F788B20)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F789400)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1F7894B0)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1F789540)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1F7895D0)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1F789660)

namespace MoleMole
{
	inline static constexpr unsigned int UICpCompanionEntityInfoWidgetController_TypeDefinitionIndex = 94747;
