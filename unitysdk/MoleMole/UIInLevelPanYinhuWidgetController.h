...
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER_GETANIMCLIPLENGTH_OFFSET UNITYSDK_OFFSET(0x14FEAE40)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER_GET_FLAMEANIM_OFFSET UNITYSDK_OFFSET(0x14FEA830)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER_GET_LIGHTANIM_OFFSET UNITYSDK_OFFSET(0x14FEA860)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14FEA900)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x14FEAA10)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14FEA990)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14FEA890)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x14FEAA50)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14FEB0C0)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER__REFRESHVIEW_B__14_0_OFFSET UNITYSDK_OFFSET(0x14FEB0D0)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14FEB1D0)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14FEB260)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14FEB2F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPanYinhuWidgetController_TypeDefinitionIndex = 52626;

	class UIInLevelPanYinhuWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_AC10B9E6C5758982* _view; // 0x2E8
		::Foundation::Coroutine::CoroutineHandle _coroutineHandle; // 0x2F0
		::System::Boolean _isLightOn; // 0x2F4
		::System::Boolean _isFullLightFlameOn; // 0x2F5
