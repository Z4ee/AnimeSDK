...
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER_GETANIMCLIPLENGTH_OFFSET UNITYSDK_OFFSET(0x184A1CA0)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER_GET_FLAMEANIM_OFFSET UNITYSDK_OFFSET(0x184A1690)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER_GET_LIGHTANIM_OFFSET UNITYSDK_OFFSET(0x184A16C0)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x184A1760)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x184A1870)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x184A17F0)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x184A16F0)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x184A18B0)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x184A1F20)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER__REFRESHVIEW_B__14_0_OFFSET UNITYSDK_OFFSET(0x184A1F30)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x184A2030)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x184A20C0)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x184A2150)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPanYinhuWidgetController_TypeDefinitionIndex = 60589;
