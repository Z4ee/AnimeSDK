...
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x16C9EF00)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16C9EF10)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16C9EF80)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER_ONSELFINFOCHAGNED_OFFSET UNITYSDK_OFFSET(0x16C9F440)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16C9F290)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x16C9F340)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16C9F020)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER_SETVIEWRADARCHARTLIST_OFFSET UNITYSDK_OFFSET(0x16C9F5A0)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x16C9F4F0)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16C9F730)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16C9F740)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16C9F7E0)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x16C9F7F0)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16C9F8B0)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaReportPageController_TypeDefinitionIndex = 59829;
