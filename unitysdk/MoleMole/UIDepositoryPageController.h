...
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_CLEARNOWTABREGIST_OFFSET UNITYSDK_OFFSET(0x17F83100)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_CLOSE_OFFSET UNITYSDK_OFFSET(0x17F83AE0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_CREATEFILTERANDSORTDATA_OFFSET UNITYSDK_OFFSET(0x17F81BC0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_CREATEITEM_OFFSET UNITYSDK_OFFSET(0x17F87C30)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_CURITEMHASJUMPITEMS_OFFSET UNITYSDK_OFFSET(0x17F874D0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_GETCURRENTFILTER_OFFSET UNITYSDK_OFFSET(0x17F889A0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_GETITEMSONUSEACTION_OFFSET UNITYSDK_OFFSET(0x17F87B60)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x17F83650)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_GOTODETAIL_OFFSET UNITYSDK_OFFSET(0x17F87700)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_INITDEPOSITORYPREVIEWWIDGET_OFFSET UNITYSDK_OFFSET(0x17F87BA0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x17F83FE0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ISCURRENTTYPEITEM_OFFSET UNITYSDK_OFFSET(0x17F87090)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17F83660)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONDEPOSITORYITEMDELNEWUPDATEBADGE_OFFSET UNITYSDK_OFFSET(0x17F84980)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x17F87460)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x17F87280)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x17F83B80)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONITEMCHANGED_OFFSET UNITYSDK_OFFSET(0x17F831C0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONITEMCREATEDORDESTROYED_OFFSET UNITYSDK_OFFSET(0x17F850C0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONONSYNCBGPOS_OFFSET UNITYSDK_OFFSET(0x17F851D0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONSHOWEQUIPWEAPON_OFFSET UNITYSDK_OFFSET(0x17F87A90)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17F849D0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONSORTERMARKDELETECLICK_OFFSET UNITYSDK_OFFSET(0x17F882D0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONSORTORFILTERCHANGED_OFFSET UNITYSDK_OFFSET(0x17F88270)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONTABBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x17F852A0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17F83930)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17F836F0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17F83D40)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17F83760)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_OPENCOMPOSEUI_OFFSET UNITYSDK_OFFSET(0x17F87E60)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_OPENDISMANTLEUI_OFFSET UNITYSDK_OFFSET(0x17F880B0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_OPENRECYCLEUI_OFFSET UNITYSDK_OFFSET(0x17F87EF0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_OPENSUITFILTERPOPUP_OFFSET UNITYSDK_OFFSET(0x17F887D0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_REFRESHCURTABITEMNUM_OFFSET UNITYSDK_OFFSET(0x17F86330)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_REFRESHCURTABITEMSDATA_OFFSET UNITYSDK_OFFSET(0x17F85310)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_REFRESHFETCHBTN_OFFSET UNITYSDK_OFFSET(0x17F83580)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_REFRESHITEM_OFFSET UNITYSDK_OFFSET(0x17F83390)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_REFRESHPREVIEWBYITEMDATA_OFFSET UNITYSDK_OFFSET(0x17F867E0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_REFRESHTABNOTIFICATIONBADGE_OFFSET UNITYSDK_OFFSET(0x17F82B80)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x17F84B20)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_REQUIREREFRESHONSHOW_OFFSET UNITYSDK_OFFSET(0x17F83330)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_RESETFOCUS_OFFSET UNITYSDK_OFFSET(0x17F84F40)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_SAVEJUMPPARASBYINDEX_OFFSET UNITYSDK_OFFSET(0x17F86EF0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_SAVEJUMPPARAS_OFFSET UNITYSDK_OFFSET(0x17F87880)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_SELECTITEMBYINDEXONITEMUIDCHANGE_OFFSET UNITYSDK_OFFSET(0x17F87E10)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_SELECTITEMBYINDEX_OFFSET UNITYSDK_OFFSET(0x17F861D0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_SETCURRENTTABINDEX_OFFSET UNITYSDK_OFFSET(0x17F82D60)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_SETSCROLLSELECTBYINDEX_OFFSET UNITYSDK_OFFSET(0x17F86C40)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_SETUPTAB_OFFSET UNITYSDK_OFFSET(0x17F81710)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17F88A20)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER__INITVIEW_B__67_0_OFFSET UNITYSDK_OFFSET(0x17F88AE0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER__INITVIEW_B__67_1_OFFSET UNITYSDK_OFFSET(0x17F88AF0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER__INITVIEW_B__67_2_OFFSET UNITYSDK_OFFSET(0x17F88B00)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER__REFRESHCURTABITEMSDATA_G__ADDITEMTOICONLIST_52_0_OFFSET UNITYSDK_OFFSET(0x17F86680)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_CLOSE_OFFSET UNITYSDK_OFFSET(0x17F88C00)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17F88C10)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x17F88CA0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x17F88D30)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x17F88DE0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17F88E10)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17F88E20)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17F88EE0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17F88EF0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17F88F00)

namespace MoleMole
{
	inline static constexpr unsigned int UIDepositoryPageController_TypeDefinitionIndex = 82554;
	...
	public:
		...
		::Class_2_03F4D9B3111E6159* _itemModel; // 0x340
		...
		::Class_2_50F24C840F0D002C<::Class_1_1685EC66FBD28897*>* _sorter; // 0x390
		::MoleMole::UIControllerContextBase* _cachedContext; // 0x398
		::Il2CppArray<::Enum_3_F4064C0F9CEA5153>* _tabSorters; // 0x3A0
		::Il2CppArray<::Class_1_AD45D24679900D19<::Class_1_1685EC66FBD28897*>*>* _filterDataList; // 0x3A8
		::Class_0_16E4307DCC41950C_18<::Class_1_1685EC66FBD28897*>* suitFilterGroupData; // 0x3B0
		...
		{
			return ((::System::ValueTuple_2<::Class_1_AD45D24679900D19<::Class_1_1685EC66FBD28897*>*, ::Il2CppArray<::Struct_2_6AB58C5477BF48DC>*>(*)(::PVOID, ::System::Collections::Generic::List_1<::System::Int32>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_CREATEFILTERANDSORTDATA_OFFSET))(this, classTypes);
		}
		...
		::Class_1_AD45D24679900D19<::Class_1_1685EC66FBD28897*>* GetCurrentFilter()
		{
			return ((::Class_1_AD45D24679900D19<::Class_1_1685EC66FBD28897*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_GETCURRENTFILTER_OFFSET))(this);
		}
