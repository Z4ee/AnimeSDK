...
#define MOLEMOLE_FORBIDDENAREACOLLECTPOPDIALOGSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x161EF740)
#define MOLEMOLE_FORBIDDENAREACOLLECTPOPDIALOGSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x161EF790)
#define MOLEMOLE_FORBIDDENAREACOLLECTPOPDIALOGSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x161EF750)

namespace MoleMole
{
	inline static constexpr unsigned int ForbiddenAreaCollectPopDialogShow_TypeDefinitionIndex = 77014;
