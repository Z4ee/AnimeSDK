...
#define MOLEMOLE_FORBIDDENAREACOLLECTPOPDIALOGSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x144D7F10)
#define MOLEMOLE_FORBIDDENAREACOLLECTPOPDIALOGSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x144D7F60)
#define MOLEMOLE_FORBIDDENAREACOLLECTPOPDIALOGSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x144D7F20)

namespace MoleMole
{
	inline static constexpr unsigned int ForbiddenAreaCollectPopDialogShow_TypeDefinitionIndex = 89073;
