...
#define MOLEMOLE_SCROLLEXPENDABLEVIEW_GET_EXPENDSTATE_OFFSET UNITYSDK_OFFSET(0x18CFE960)
#define MOLEMOLE_SCROLLEXPENDABLEVIEW_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x18CFE880)
#define MOLEMOLE_SCROLLEXPENDABLEVIEW_SET_EXPENDSTATE_OFFSET UNITYSDK_OFFSET(0x18CFE970)
#define MOLEMOLE_SCROLLEXPENDABLEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x18CFE980)
#define MOLEMOLE_SCROLLEXPENDABLEVIEW___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x18CFE990)

namespace MoleMole
{
	inline static constexpr unsigned int ScrollExpendAbleView_TypeDefinitionIndex = 74338;
