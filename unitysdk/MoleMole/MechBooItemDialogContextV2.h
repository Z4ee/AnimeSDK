...
#define MOLEMOLE_MECHBOOITEMDIALOGCONTEXTV2_GETPARTBUILDLIST_OFFSET UNITYSDK_OFFSET(0x16CB2560)
#define MOLEMOLE_MECHBOOITEMDIALOGCONTEXTV2_OVERRIDETABTITLE_OFFSET UNITYSDK_OFFSET(0x16CB2680)
#define MOLEMOLE_MECHBOOITEMDIALOGCONTEXTV2__CTOR_OFFSET UNITYSDK_OFFSET(0x16CB27C0)

namespace MoleMole
{
	inline static constexpr unsigned int MechBooItemDialogContextV2_TypeDefinitionIndex = 78761;
