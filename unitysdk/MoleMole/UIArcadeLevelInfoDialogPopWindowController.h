...
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER_GETCURRENTLEVEL_OFFSET UNITYSDK_OFFSET(0x19206A90)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER_GETDESCTITLEKEY_OFFSET UNITYSDK_OFFSET(0x192078D0)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER_GETMAXLEVEL_OFFSET UNITYSDK_OFFSET(0x19206980)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER_GETTEMPLATE_OFFSET UNITYSDK_OFFSET(0x192073B0)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER_GETTITLEKEY_OFFSET UNITYSDK_OFFSET(0x19207860)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x192061C0)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x192061D0)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x19206FD0)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19206F60)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19206260)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19206EF0)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER_REFRESHLAYOUT_OFFSET UNITYSDK_OFFSET(0x19206E30)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER_UPDATELEVELITEM_OFFSET UNITYSDK_OFFSET(0x19206BB0)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19207940)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER__UPDATELEVELITEM_B__7_0_OFFSET UNITYSDK_OFFSET(0x19207960)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19207B20)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x19207BB0)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19207C60)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19207C70)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19207C80)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeLevelInfoDialogPopWindowController_TypeDefinitionIndex = 43524;
	...
	public:
		...
		::Class_2_208CC9941471731A_986* GetTemplate(::System::Int32 level)
		{
			return ((::Class_2_208CC9941471731A_986*(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER_GETTEMPLATE_OFFSET))(this, level);
		}
