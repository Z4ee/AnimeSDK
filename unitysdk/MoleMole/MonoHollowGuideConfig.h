...
#define MOLEMOLE_MONOHOLLOWGUIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1995DBD0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoHollowGuideConfig_TypeDefinitionIndex = 45928;
