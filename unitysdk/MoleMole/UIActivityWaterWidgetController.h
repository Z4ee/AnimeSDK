...
#define MOLEMOLE_UIACTIVITYWATERWIDGETCONTROLLER_GETREWARD_OFFSET UNITYSDK_OFFSET(0x1561DD20)
#define MOLEMOLE_UIACTIVITYWATERWIDGETCONTROLLER_GET__ROOTACTIVITYDATA_OFFSET UNITYSDK_OFFSET(0x1561DD00)
#define MOLEMOLE_UIACTIVITYWATERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1561D5A0)
#define MOLEMOLE_UIACTIVITYWATERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1561D630)
#define MOLEMOLE_UIACTIVITYWATERWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1561D450)
#define MOLEMOLE_UIACTIVITYWATERWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1561D4B0)
#define MOLEMOLE_UIACTIVITYWATERWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1561D6B0)
#define MOLEMOLE_UIACTIVITYWATERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1561DD80)
#define MOLEMOLE_UIACTIVITYWATERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1561DE60)
#define MOLEMOLE_UIACTIVITYWATERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1561DEF0)
#define MOLEMOLE_UIACTIVITYWATERWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1561DF80)
#define MOLEMOLE_UIACTIVITYWATERWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1561E010)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityWaterWidgetController_TypeDefinitionIndex = 46525;

	class UIActivityWaterWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_8374F755CC1451AB* _view; // 0x2B8
		::MoleMole::ActivityWaterContext* _context; // 0x2C0
		::MoleMole::UIActivityWaterProgressBarWidgetController* _progressBarWidget; // 0x2C8
		::System::Collections::Generic::List_1<::MoleMole::UIActivityWaterRewardWidgetController*>* _rewardWidgets; // 0x2D0
