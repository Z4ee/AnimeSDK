...
#define MOLEMOLE_MAINCITYSWITCHTIMEGAMEPADBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x12F959C0)
#define MOLEMOLE_MAINCITYSWITCHTIMEGAMEPADBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x12F959D0)
#define MOLEMOLE_MAINCITYSWITCHTIMEGAMEPADBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x12F959E0)

namespace MoleMole
{
	inline static constexpr unsigned int MainCitySwitchTimeGamepadBindingSettingEntry_TypeDefinitionIndex = 40371;
