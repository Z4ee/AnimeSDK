...
#define MOLEMOLE_UISUMMERPOPULARITYLEVELUPPOPWINDOWCONTEXT_GET_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x10EF07C0)
#define MOLEMOLE_UISUMMERPOPULARITYLEVELUPPOPWINDOWCONTEXT_SET_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x10EF07D0)
#define MOLEMOLE_UISUMMERPOPULARITYLEVELUPPOPWINDOWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x10EF07E0)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerPopularityLevelUpPopWindowContext_TypeDefinitionIndex = 58808;
