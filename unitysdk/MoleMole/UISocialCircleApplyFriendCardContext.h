...
#define MOLEMOLE_UISOCIALCIRCLEAPPLYFRIENDCARDCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x14802CD0)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleApplyFriendCardContext_TypeDefinitionIndex = 57591;
