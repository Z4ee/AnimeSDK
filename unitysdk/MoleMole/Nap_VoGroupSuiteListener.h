...
#define MOLEMOLE_NAP_VOGROUPSUITELISTENER_AWAKE_OFFSET UNITYSDK_OFFSET(0x11646E20)
#define MOLEMOLE_NAP_VOGROUPSUITELISTENER_GET_CURRENTSUITE_OFFSET UNITYSDK_OFFSET(0x11646E10)
#define MOLEMOLE_NAP_VOGROUPSUITELISTENER_METHOD_5_7E0D3A7A149A57B6_OFFSET UNITYSDK_OFFSET(0x11647130)
#define MOLEMOLE_NAP_VOGROUPSUITELISTENER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x11646F40)
#define MOLEMOLE_NAP_VOGROUPSUITELISTENER_ONGROUPSUITECHANGED_OFFSET UNITYSDK_OFFSET(0x11647030)
#define MOLEMOLE_NAP_VOGROUPSUITELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x116470E0)

namespace MoleMole
{
	inline static constexpr unsigned int Nap_VoGroupSuiteListener_TypeDefinitionIndex = 59641;
	...
	public:
		...
		::Foundation::ViewObject::Subsystem::GroupSuiteChangeListenEntry Field_5_6; // 0x30
