...
#define MOLEMOLE_COMMANDLINEANTIALIAS_METHOD_2_0D1560B7509BDB7B_OFFSET UNITYSDK_OFFSET(0x17284130)
#define MOLEMOLE_COMMANDLINEANTIALIAS_METHOD_2_78DB277A310DE432_OFFSET UNITYSDK_OFFSET(0x17284240)
#define MOLEMOLE_COMMANDLINEANTIALIAS__CTOR_OFFSET UNITYSDK_OFFSET(0x17284200)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineAntiAlias_TypeDefinitionIndex = 89125;
