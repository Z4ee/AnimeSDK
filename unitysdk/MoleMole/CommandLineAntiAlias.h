...
#define MOLEMOLE_COMMANDLINEANTIALIAS_METHOD_2_0D1560B7509BDB7B_OFFSET UNITYSDK_OFFSET(0x17D35770)
#define MOLEMOLE_COMMANDLINEANTIALIAS_METHOD_2_78DB277A310DE432_OFFSET UNITYSDK_OFFSET(0x17D35880)
#define MOLEMOLE_COMMANDLINEANTIALIAS__CTOR_OFFSET UNITYSDK_OFFSET(0x17D35840)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineAntiAlias_TypeDefinitionIndex = 75762;
