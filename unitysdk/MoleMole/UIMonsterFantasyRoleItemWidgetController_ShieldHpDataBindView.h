...
#define MOLEMOLE_UIMONSTERFANTASYROLEITEMWIDGETCONTROLLER_SHIELDHPDATABINDVIEW_GET_HPIMGMAT_OFFSET UNITYSDK_OFFSET(0x15309840)
#define MOLEMOLE_UIMONSTERFANTASYROLEITEMWIDGETCONTROLLER_SHIELDHPDATABINDVIEW_ONBUILDDATABINDING_OFFSET UNITYSDK_OFFSET(0x153099B0)
#define MOLEMOLE_UIMONSTERFANTASYROLEITEMWIDGETCONTROLLER_SHIELDHPDATABINDVIEW_ONINIT_OFFSET UNITYSDK_OFFSET(0x15309960)
#define MOLEMOLE_UIMONSTERFANTASYROLEITEMWIDGETCONTROLLER_SHIELDHPDATABINDVIEW_SET_HPIMGMAT_OFFSET UNITYSDK_OFFSET(0x15309850)
#define MOLEMOLE_UIMONSTERFANTASYROLEITEMWIDGETCONTROLLER_SHIELDHPDATABINDVIEW__CCTOR_OFFSET UNITYSDK_OFFSET(0x15309AD0)
#define MOLEMOLE_UIMONSTERFANTASYROLEITEMWIDGETCONTROLLER_SHIELDHPDATABINDVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x15309860)
#define MOLEMOLE_UIMONSTERFANTASYROLEITEMWIDGETCONTROLLER_SHIELDHPDATABINDVIEW__ONBUILDDATABINDING_B__6_0_OFFSET UNITYSDK_OFFSET(0x15309B10)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyRoleItemWidgetController_ShieldHpDataBindView_TypeDefinitionIndex = 57113;

	class UIMonsterFantasyRoleItemWidgetController_ShieldHpDataBindView : public ::Class_2_3BEB019E352B28D9_Class_2_D82C98D47A797E2D_3
	{
	public:
		static ::System::Int32* StaticGet_ShieldPercentShaderParamID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMonsterFantasyRoleItemWidgetController_ShieldHpDataBindView_TypeDefinitionIndex)->GetStaticField(0x10B50);
		}
