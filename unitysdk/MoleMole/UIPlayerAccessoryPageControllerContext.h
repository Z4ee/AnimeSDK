...
#define MOLEMOLE_UIPLAYERACCESSORYPAGECONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15DC2F30)

namespace MoleMole
{
	inline static constexpr unsigned int UIPlayerAccessoryPageControllerContext_TypeDefinitionIndex = 70091;
	...
	public:
		...
		::Enum_3_D54A5313F8CDCCC2 PageType; // 0x38
		::System::Int32 TabID; // 0x3C
		::Enum_3_ED790DAC948A65A9_9 InitSkinType; // 0x40
		::Enum_3_89453005EC225A84 SkinPreviewType; // 0x44
		::System::Int32 AccIndex; // 0x48
		::System::Int32 InitAvatarID; // 0x4C
		::System::Int32 InitSkinID; // 0x50
