...
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_CUSTOMSORTACTION_OFFSET UNITYSDK_OFFSET(0x184259B0)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_GETCOLLECTEDSHOWITEMNUM_OFFSET UNITYSDK_OFFSET(0x184258F0)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_GET_CURFOCUSED_OFFSET UNITYSDK_OFFSET(0x18423570)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_INITCARDLIST_OFFSET UNITYSDK_OFFSET(0x184242F0)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_INITSORT_OFFSET UNITYSDK_OFFSET(0x184237A0)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_MATCHFUNCCOLLECTED_OFFSET UNITYSDK_OFFSET(0x18425450)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_MATCHFUNC_OFFSET UNITYSDK_OFFSET(0x18425380)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x184252A0)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_ONSCROLLVIEWSELECTHANDLE_OFFSET UNITYSDK_OFFSET(0x18425D20)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18425200)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_ONSORTORFILTERCHANGED_OFFSET UNITYSDK_OFFSET(0x18425330)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_ONTOGGLEVALUE_OFFSET UNITYSDK_OFFSET(0x18425F90)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x184269F0)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18422BE0)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18423700)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_REFRESHITEMRARITY_OFFSET UNITYSDK_OFFSET(0x18425E30)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_REFRESHPROGRESSTITLETEXT_OFFSET UNITYSDK_OFFSET(0x18424D90)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_REFRESHSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x18424E50)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_REFRESHVIEWONFOCUSCHANGE_OFFSET UNITYSDK_OFFSET(0x18423080)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x184230D0)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_TRYCANCELSELECTONLAYOUTCHANGETOCONSOLE_OFFSET UNITYSDK_OFFSET(0x18425780)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_TRYSELECTFIRSTITEMEXCEPTCONSOLELAYOUT_OFFSET UNITYSDK_OFFSET(0x18425600)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18426A70)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18426C50)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18426CE0)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18426D80)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18426E10)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18426EA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCardCollectWidgetController_TypeDefinitionIndex = 66574;

	class UIHollowCardCollectWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_92* _view; // 0x2C0
