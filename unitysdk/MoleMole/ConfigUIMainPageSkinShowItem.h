...
#define MOLEMOLE_CONFIGUIMAINPAGESKINSHOWITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1922C5B0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIMainPageSkinShowItem_TypeDefinitionIndex = 84002;
