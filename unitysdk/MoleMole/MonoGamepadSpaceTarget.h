...
#define MOLEMOLE_MONOGAMEPADSPACETARGET_DOCOPYRESET_OFFSET UNITYSDK_OFFSET(0x17DD62C0)
#define MOLEMOLE_MONOGAMEPADSPACETARGET_GETNAVIGATEFORBID_OFFSET UNITYSDK_OFFSET(0x17DD6230)
#define MOLEMOLE_MONOGAMEPADSPACETARGET_GETNAVIGATEOBJ_OFFSET UNITYSDK_OFFSET(0x17DD61A0)
#define MOLEMOLE_MONOGAMEPADSPACETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x17DD6310)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGamepadSpaceTarget_TypeDefinitionIndex = 66935;
