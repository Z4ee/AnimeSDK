...
#define MOLEMOLE_MONONPCLOOKIKPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x16412F50)

namespace MoleMole
{
	inline static constexpr unsigned int MonoNpcLookIKParameter_TypeDefinitionIndex = 68018;
