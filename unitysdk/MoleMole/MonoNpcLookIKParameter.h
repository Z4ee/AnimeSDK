...
#define MOLEMOLE_MONONPCLOOKIKPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x18081AC0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoNpcLookIKParameter_TypeDefinitionIndex = 60577;
