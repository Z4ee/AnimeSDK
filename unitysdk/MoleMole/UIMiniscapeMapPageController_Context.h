...
#define MOLEMOLE_UIMINISCAPEMAPPAGECONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1452AA50)

namespace MoleMole
{
	inline static constexpr unsigned int UIMiniscapeMapPageController_Context_TypeDefinitionIndex = 61171;
