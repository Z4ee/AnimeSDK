...
#define MOLEMOLE_LANGUAGEVOICESETTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16CB1080)

namespace MoleMole
{
	inline static constexpr unsigned int LanguageVoiceSettingContext_TypeDefinitionIndex = 55664;
