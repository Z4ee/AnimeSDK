...
#define MOLEMOLE_UIRIDUSGOTBOORESULTPAGECONTROLLERCONTEXT_BUILD_OFFSET UNITYSDK_OFFSET(0x15C12A90)
#define MOLEMOLE_UIRIDUSGOTBOORESULTPAGECONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15C12970)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooResultPageControllerContext_TypeDefinitionIndex = 71707;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_998*>* Challenges; // 0x30
