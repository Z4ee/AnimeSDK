...
#define MOLEMOLE_SCENEQUALITYPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x136EBB00)
#define MOLEMOLE_SCENEQUALITYPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x136EBC40)
#define MOLEMOLE_SCENEQUALITYPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x136EBA20)
#define MOLEMOLE_SCENEQUALITYPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x136EBBC0)
#define MOLEMOLE_SCENEQUALITYPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x136EBA10)
#define MOLEMOLE_SCENEQUALITYPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x136EBD60)
#define MOLEMOLE_SCENEQUALITYPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x136EBDF0)
#define MOLEMOLE_SCENEQUALITYPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x136EBE80)
#define MOLEMOLE_SCENEQUALITYPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x136EBF10)

namespace MoleMole
{
	inline static constexpr unsigned int SceneQualityProfile_TypeDefinitionIndex = 45149;
