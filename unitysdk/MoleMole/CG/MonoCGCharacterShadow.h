...
#define MOLEMOLE_CG_MONOCGCHARACTERSHADOW__CTOR_OFFSET UNITYSDK_OFFSET(0xE94B4F0)

namespace MoleMole::CG
{
	inline static constexpr unsigned int MonoCGCharacterShadow_TypeDefinitionIndex = 57863;
