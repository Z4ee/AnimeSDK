...
#define MOLEMOLE_SHADERGENERATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1688FCD0)

namespace MoleMole
{
	inline static constexpr unsigned int ShaderGenerateConfig_TypeDefinitionIndex = 46758;
