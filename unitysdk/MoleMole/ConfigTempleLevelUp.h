...
#define MOLEMOLE_CONFIGTEMPLELEVELUP__CTOR_OFFSET UNITYSDK_OFFSET(0x170D4F40)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigTempleLevelUp_TypeDefinitionIndex = 86056;
