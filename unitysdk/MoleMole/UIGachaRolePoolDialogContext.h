...
#define MOLEMOLE_UIGACHAROLEPOOLDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x158049C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaRolePoolDialogContext_TypeDefinitionIndex = 56755;
