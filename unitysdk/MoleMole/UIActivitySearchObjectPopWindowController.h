...
#define MOLEMOLE_UIACTIVITYSEARCHOBJECTPOPWINDOWCONTROLLER_CLICKCANCEL_OFFSET UNITYSDK_OFFSET(0x1732BFB0)
#define MOLEMOLE_UIACTIVITYSEARCHOBJECTPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1732B840)
#define MOLEMOLE_UIACTIVITYSEARCHOBJECTPOPWINDOWCONTROLLER_INITUI_OFFSET UNITYSDK_OFFSET(0x1732BC60)
#define MOLEMOLE_UIACTIVITYSEARCHOBJECTPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1732BE40)
#define MOLEMOLE_UIACTIVITYSEARCHOBJECTPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1732BF40)
#define MOLEMOLE_UIACTIVITYSEARCHOBJECTPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1732B850)
#define MOLEMOLE_UIACTIVITYSEARCHOBJECTPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1732BB40)
#define MOLEMOLE_UIACTIVITYSEARCHOBJECTPOPWINDOWCONTROLLER_UICLOSE_OFFSET UNITYSDK_OFFSET(0x1732BED0)
#define MOLEMOLE_UIACTIVITYSEARCHOBJECTPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1732C000)
#define MOLEMOLE_UIACTIVITYSEARCHOBJECTPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1732C010)
#define MOLEMOLE_UIACTIVITYSEARCHOBJECTPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1732C0A0)
#define MOLEMOLE_UIACTIVITYSEARCHOBJECTPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1732C0B0)
#define MOLEMOLE_UIACTIVITYSEARCHOBJECTPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1732C0C0)
#define MOLEMOLE_UIACTIVITYSEARCHOBJECTPOPWINDOWCONTROLLER___BASE_UICLOSE_OFFSET UNITYSDK_OFFSET(0x1732C150)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivitySearchObjectPopWindowController_TypeDefinitionIndex = 53451;
