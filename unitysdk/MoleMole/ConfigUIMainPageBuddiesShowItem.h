...
#define MOLEMOLE_CONFIGUIMAINPAGEBUDDIESSHOWITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x110402F0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIMainPageBuddiesShowItem_TypeDefinitionIndex = 69813;
