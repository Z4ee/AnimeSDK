...
#define MOLEMOLE_CONFIGUIMAINPAGEBUDDIESSHOWITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x18F4E9B0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIMainPageBuddiesShowItem_TypeDefinitionIndex = 79084;
