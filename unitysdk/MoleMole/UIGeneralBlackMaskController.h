...
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x19FA8DE0)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x19FA9210)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19FA92A0)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19FA8DF0)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19FA8F50)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19FA9300)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19FA92F0)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x19FA9340)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19FA9400)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19FA9410)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19FA9420)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralBlackMaskController_TypeDefinitionIndex = 44872;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIGeneralBlackMaskController_TypeDefinitionIndex)->GetStaticField(0x51A90);
		}
		static ::System::String** StaticGet_FadeInAnimName()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIGeneralBlackMaskController_TypeDefinitionIndex)->GetStaticField(0x51A98);
		}
