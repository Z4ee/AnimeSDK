...
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x17F95AC0)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17F95EF0)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17F95F80)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17F95AD0)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17F95C30)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x17F95FE0)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17F95FD0)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17F96030)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17F960F0)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17F96100)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17F96110)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralBlackMaskController_TypeDefinitionIndex = 40479;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIGeneralBlackMaskController_TypeDefinitionIndex)->GetStaticField(0x4B190);
		}
		static ::System::String** StaticGet_FadeInAnimName()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIGeneralBlackMaskController_TypeDefinitionIndex)->GetStaticField(0x4B198);
		}
