...
#define MOLEMOLE_AUTOCENTERINGGRIDLAYOUTGROUP_GETCOLROW_OFFSET UNITYSDK_OFFSET(0x10CCD630)
#define MOLEMOLE_AUTOCENTERINGGRIDLAYOUTGROUP_METHOD_8_1AE07FDB9C7B9E43_OFFSET UNITYSDK_OFFSET(0x10CCD6D0)
#define MOLEMOLE_AUTOCENTERINGGRIDLAYOUTGROUP_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x10CCD680)
#define MOLEMOLE_AUTOCENTERINGGRIDLAYOUTGROUP_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x10CCDED0)
#define MOLEMOLE_AUTOCENTERINGGRIDLAYOUTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x10CCDF20)
#define MOLEMOLE_AUTOCENTERINGGRIDLAYOUTGROUP___BASE_GETCOLROW_OFFSET UNITYSDK_OFFSET(0x10CCDF50)
#define MOLEMOLE_AUTOCENTERINGGRIDLAYOUTGROUP___BASE_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x10CCDFE0)
#define MOLEMOLE_AUTOCENTERINGGRIDLAYOUTGROUP___BASE_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x10CCE070)

namespace MoleMole
{
	inline static constexpr unsigned int AutoCenteringGridLayoutGroup_TypeDefinitionIndex = 77505;
