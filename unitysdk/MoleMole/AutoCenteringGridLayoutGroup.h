...
#define MOLEMOLE_AUTOCENTERINGGRIDLAYOUTGROUP_GETCOLROW_OFFSET UNITYSDK_OFFSET(0x116C7E00)
#define MOLEMOLE_AUTOCENTERINGGRIDLAYOUTGROUP_METHOD_8_1AE07FDB9C7B9E43_OFFSET UNITYSDK_OFFSET(0x116C7EA0)
#define MOLEMOLE_AUTOCENTERINGGRIDLAYOUTGROUP_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x116C7E50)
#define MOLEMOLE_AUTOCENTERINGGRIDLAYOUTGROUP_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x116C8690)
#define MOLEMOLE_AUTOCENTERINGGRIDLAYOUTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x116C86E0)
#define MOLEMOLE_AUTOCENTERINGGRIDLAYOUTGROUP___BASE_GETCOLROW_OFFSET UNITYSDK_OFFSET(0x116C8710)
#define MOLEMOLE_AUTOCENTERINGGRIDLAYOUTGROUP___BASE_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x116C87A0)
#define MOLEMOLE_AUTOCENTERINGGRIDLAYOUTGROUP___BASE_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x116C87B0)

namespace MoleMole
{
	inline static constexpr unsigned int AutoCenteringGridLayoutGroup_TypeDefinitionIndex = 79520;

	class AutoCenteringGridLayoutGroup : public ::UnityEngine::UI::GridLayoutGroup
	{
	public:
		::System::Int32 Field_8_0; // 0x80
		::System::Int32 Field_8_7; // 0x84
