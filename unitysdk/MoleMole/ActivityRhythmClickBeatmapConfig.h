...
#define MOLEMOLE_ACTIVITYRHYTHMCLICKBEATMAPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x11002AB0)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityRhythmClickBeatmapConfig_TypeDefinitionIndex = 72792;
