...
#define MOLEMOLE_ACTIVITYRHYTHMCLICKBEATMAPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x13EBAC10)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityRhythmClickBeatmapConfig_TypeDefinitionIndex = 44725;
