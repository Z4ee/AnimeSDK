...
#define MOLEMOLE_UIPARTNERDATEREWARDROWWIDGETCONTROLLER_ADDITEMICONBTNSMALLWIDGET_OFFSET UNITYSDK_OFFSET(0x1820ADF0)
#define MOLEMOLE_UIPARTNERDATEREWARDROWWIDGETCONTROLLER_ONCLICKTAKEREWARD_OFFSET UNITYSDK_OFFSET(0x1820ABC0)
#define MOLEMOLE_UIPARTNERDATEREWARDROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18209D60)
#define MOLEMOLE_UIPARTNERDATEREWARDROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x18209E70)
#define MOLEMOLE_UIPARTNERDATEREWARDROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18209DF0)
#define MOLEMOLE_UIPARTNERDATEREWARDROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18209C20)
#define MOLEMOLE_UIPARTNERDATEREWARDROWWIDGETCONTROLLER_REFRESHSTATE_OFFSET UNITYSDK_OFFSET(0x1820A4D0)
#define MOLEMOLE_UIPARTNERDATEREWARDROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x18209F30)
#define MOLEMOLE_UIPARTNERDATEREWARDROWWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x1820A480)
#define MOLEMOLE_UIPARTNERDATEREWARDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1820AF10)
#define MOLEMOLE_UIPARTNERDATEREWARDROWWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0x1820AF20)
#define MOLEMOLE_UIPARTNERDATEREWARDROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1820AF30)
#define MOLEMOLE_UIPARTNERDATEREWARDROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1820AFC0)
#define MOLEMOLE_UIPARTNERDATEREWARDROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1820B060)
#define MOLEMOLE_UIPARTNERDATEREWARDROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1820B0F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPartnerDateRewardRowWidgetController_TypeDefinitionIndex = 39993;
	...
	public:
		...
		{
			return ((::MoleMole::UIItemIconBtnSmallWidgetController*(*)(::PVOID, ::Enum_3_7A4252233BCEB3A9, ::System::Func_1<::MoleMole::UIControlReference*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIPARTNERDATEREWARDROWWIDGETCONTROLLER_ADDITEMICONBTNSMALLWIDGET_OFFSET))(this, ctrl, arg);
		}
