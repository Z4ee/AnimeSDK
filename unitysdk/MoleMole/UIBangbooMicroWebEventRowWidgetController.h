...
#define MOLEMOLE_UIBANGBOOMICROWEBEVENTROWWIDGETCONTROLLER_ONCLICKGOTO_OFFSET UNITYSDK_OFFSET(0x15E63E30)
#define MOLEMOLE_UIBANGBOOMICROWEBEVENTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15E634C0)
#define MOLEMOLE_UIBANGBOOMICROWEBEVENTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15E63680)
#define MOLEMOLE_UIBANGBOOMICROWEBEVENTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15E635F0)
#define MOLEMOLE_UIBANGBOOMICROWEBEVENTROWWIDGETCONTROLLER_REFRESHPANEL_OFFSET UNITYSDK_OFFSET(0x15E63730)
#define MOLEMOLE_UIBANGBOOMICROWEBEVENTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15E64000)
#define MOLEMOLE_UIBANGBOOMICROWEBEVENTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15E64010)
#define MOLEMOLE_UIBANGBOOMICROWEBEVENTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15E640A0)
#define MOLEMOLE_UIBANGBOOMICROWEBEVENTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15E64140)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooMicroWebEventRowWidgetController_TypeDefinitionIndex = 45364;
