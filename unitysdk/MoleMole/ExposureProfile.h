...
#define MOLEMOLE_EXPOSUREPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x10D2CAD0)
#define MOLEMOLE_EXPOSUREPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x10D2CC10)
#define MOLEMOLE_EXPOSUREPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x10D2C9F0)
#define MOLEMOLE_EXPOSUREPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x10D2CB90)
#define MOLEMOLE_EXPOSUREPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x10D2C9E0)
#define MOLEMOLE_EXPOSUREPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x10D2CD30)
#define MOLEMOLE_EXPOSUREPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x10D2CDC0)
#define MOLEMOLE_EXPOSUREPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x10D2CE50)
#define MOLEMOLE_EXPOSUREPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x10D2CEE0)

namespace MoleMole
{
	inline static constexpr unsigned int ExposureProfile_TypeDefinitionIndex = 61186;
