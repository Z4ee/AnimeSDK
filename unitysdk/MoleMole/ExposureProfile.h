...
#define MOLEMOLE_EXPOSUREPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x1A991180)
#define MOLEMOLE_EXPOSUREPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x1A9912C0)
#define MOLEMOLE_EXPOSUREPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x1A9910A0)
#define MOLEMOLE_EXPOSUREPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1A991240)
#define MOLEMOLE_EXPOSUREPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x1A991090)
#define MOLEMOLE_EXPOSUREPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9913E0)
#define MOLEMOLE_EXPOSUREPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x1A991470)
#define MOLEMOLE_EXPOSUREPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x1A991500)
#define MOLEMOLE_EXPOSUREPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1A991590)

namespace MoleMole
{
	inline static constexpr unsigned int ExposureProfile_TypeDefinitionIndex = 74923;
