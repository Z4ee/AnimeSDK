...
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16799120)
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x167991B0)
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16798F50)
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x167990B0)
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER_REFRESHVIEW_1_OFFSET UNITYSDK_OFFSET(0x167992A0)
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x16799230)
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER_SETQUESTFIRSTREWARD_OFFSET UNITYSDK_OFFSET(0x167997D0)
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16799A40)
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0x16799B20)
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16799B40)
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16799BD0)
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16799C60)
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16799CF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralBottomRewardInfoWidgetController_TypeDefinitionIndex = 46426;
	...
	public:
		...
		::Class_2_7EFBB899B4E4B40A_1* _view; // 0x2C0
