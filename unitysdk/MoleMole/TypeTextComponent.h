...
namespace MoleMole { class TypeTextComponent_Class_3_50D343C44D28BEFB_8; }
...
#define MOLEMOLE_TYPETEXTCOMPONENT_AWAKE_OFFSET UNITYSDK_OFFSET(0x173AB5C0)
#define MOLEMOLE_TYPETEXTCOMPONENT_ISSKIPPABLE_OFFSET UNITYSDK_OFFSET(0x173AC110)
#define MOLEMOLE_TYPETEXTCOMPONENT_METHOD_5_2980C679BFB3D87F_OFFSET UNITYSDK_OFFSET(0x173AC380)
#define MOLEMOLE_TYPETEXTCOMPONENT_METHOD_5_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x173AB610)
#define MOLEMOLE_TYPETEXTCOMPONENT_METHOD_5_EB168421BB25ED79_OFFSET UNITYSDK_OFFSET(0x173ABA80)
#define MOLEMOLE_TYPETEXTCOMPONENT_SETONCOMPLETE_OFFSET UNITYSDK_OFFSET(0x173AC160)
#define MOLEMOLE_TYPETEXTCOMPONENT_SETREALTEXT_OFFSET UNITYSDK_OFFSET(0x173AB840)
#define MOLEMOLE_TYPETEXTCOMPONENT_SETTEXT_OFFSET UNITYSDK_OFFSET(0x173AB890)
#define MOLEMOLE_TYPETEXTCOMPONENT_SKIPTYPETEXT_OFFSET UNITYSDK_OFFSET(0x173ABEF0)
#define MOLEMOLE_TYPETEXTCOMPONENT_TYPETEXT_OFFSET UNITYSDK_OFFSET(0x173ABE60)
#define MOLEMOLE_TYPETEXTCOMPONENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x173AB7E0)
#define MOLEMOLE_TYPETEXTCOMPONENT__CCTOR_OFFSET UNITYSDK_OFFSET(0x173AC220)
#define MOLEMOLE_TYPETEXTCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x173AC1B0)

namespace MoleMole
{
	inline static constexpr unsigned int TypeTextComponent_TypeDefinitionIndex = 60670;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(TypeTextComponent_TypeDefinitionIndex)->GetStaticField(0x41280);
		}
		static ::Il2CppArray<::System::String*>** StaticGet_Field_5_6()
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(TypeTextComponent_TypeDefinitionIndex)->GetStaticField(0x41288);
		}
		...
		::MoleMole::TypeTextComponent_Class_3_50D343C44D28BEFB_8* Field_5_7; // 0x40
		...
		::System::Void SetOnComplete(::MoleMole::TypeTextComponent_Class_3_50D343C44D28BEFB_8* a1)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::TypeTextComponent_Class_3_50D343C44D28BEFB_8*))((::PBYTE)hIl2Cpp + MOLEMOLE_TYPETEXTCOMPONENT_SETONCOMPLETE_OFFSET))(this, a1);
		}
		...
		::System::String* Method_5_EB168421BB25ED79(::System::String* a1)
		{
			return ((::System::String*(*)(::PVOID, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_TYPETEXTCOMPONENT_METHOD_5_EB168421BB25ED79_OFFSET))(this, a1);
		}
