...
#define MOLEMOLE_ACTIVITYPIGRECOMMANDCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x12EDD320)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityPigRecommandContext_TypeDefinitionIndex = 70663;

	class ActivityPigRecommandContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::Class_1_EADE0AA2443F1473* ShopData; // 0x28
		::Class_1_E43D938AEBE01021* TabData; // 0x30
		::Class_1_EADE0AA2443F1473* LoginInfoData; // 0x38
