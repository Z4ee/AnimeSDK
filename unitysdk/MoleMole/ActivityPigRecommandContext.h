...
#define MOLEMOLE_ACTIVITYPIGRECOMMANDCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xF95AF90)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityPigRecommandContext_TypeDefinitionIndex = 60766;
