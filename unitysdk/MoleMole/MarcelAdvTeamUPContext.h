...
#define MOLEMOLE_MARCELADVTEAMUPCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x12BC9260)

namespace MoleMole
{
	inline static constexpr unsigned int MarcelAdvTeamUPContext_TypeDefinitionIndex = 59645;
