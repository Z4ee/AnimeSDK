...
#define MOLEMOLE_GETAVATARSKINPACKAGEBANNERSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x161F3580)
#define MOLEMOLE_GETAVATARSKINPACKAGEBANNERSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x161F35D0)
#define MOLEMOLE_GETAVATARSKINPACKAGEBANNERSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x161F3590)

namespace MoleMole
{
	inline static constexpr unsigned int GetAvatarSkinPackageBannerShow_TypeDefinitionIndex = 73874;
