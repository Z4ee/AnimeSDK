...
#define MOLEMOLE_GETAVATARSKINPACKAGEBANNERSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x144D9D00)
#define MOLEMOLE_GETAVATARSKINPACKAGEBANNERSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x144D9D50)
#define MOLEMOLE_GETAVATARSKINPACKAGEBANNERSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x144D9D10)

namespace MoleMole
{
	inline static constexpr unsigned int GetAvatarSkinPackageBannerShow_TypeDefinitionIndex = 44174;
