...
#define MOLEMOLE_UIROLESKINROWWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16690FB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleSkinRowWidgetController_Context_TypeDefinitionIndex = 83463;
