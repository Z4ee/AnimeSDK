...
#define MOLEMOLE_CONFIGUISTORECAMERA_GETUICAMERATELESCOPECONFIG_OFFSET UNITYSDK_OFFSET(0x183E6AD0)
#define MOLEMOLE_CONFIGUISTORECAMERA_GETUISTOREPAGECONFIG_OFFSET UNITYSDK_OFFSET(0x183E69F0)
#define MOLEMOLE_CONFIGUISTORECAMERA_GETUIVIRTUALCAMERACONFIG_OFFSET UNITYSDK_OFFSET(0x183E6910)
#define MOLEMOLE_CONFIGUISTORECAMERA_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x183E5FA0)
#define MOLEMOLE_CONFIGUISTORECAMERA_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x183E58A0)
#define MOLEMOLE_CONFIGUISTORECAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x183E6BB0)
#define MOLEMOLE_CONFIGUISTORECAMERA___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x183E6F50)
#define MOLEMOLE_CONFIGUISTORECAMERA___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x183E6F60)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIStoreCamera_TypeDefinitionIndex = 60001;
