...
#define MOLEMOLE_UIAVATARACTIVITYSELECTINFOAREA_FOLDWIDGETCONTROLLER_ONCLICK_OFFSET UNITYSDK_OFFSET(0x172B4160)
#define MOLEMOLE_UIAVATARACTIVITYSELECTINFOAREA_FOLDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x172B3CC0)
#define MOLEMOLE_UIAVATARACTIVITYSELECTINFOAREA_FOLDWIDGETCONTROLLER_ONTOGGLEVALUE_OFFSET UNITYSDK_OFFSET(0x172B4770)
#define MOLEMOLE_UIAVATARACTIVITYSELECTINFOAREA_FOLDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x172B3D50)
#define MOLEMOLE_UIAVATARACTIVITYSELECTINFOAREA_FOLDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x172B3B40)
#define MOLEMOLE_UIAVATARACTIVITYSELECTINFOAREA_FOLDWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x172B3BA0)
#define MOLEMOLE_UIAVATARACTIVITYSELECTINFOAREA_FOLDWIDGETCONTROLLER_PRASEBUFFDATA_ACTIVITYOVAMAINBATTLESELECTBUFF_OFFSET UNITYSDK_OFFSET(0x172B4E80)
#define MOLEMOLE_UIAVATARACTIVITYSELECTINFOAREA_FOLDWIDGETCONTROLLER_REGISTERONVALUECHANGE_OFFSET UNITYSDK_OFFSET(0x172B5100)
#define MOLEMOLE_UIAVATARACTIVITYSELECTINFOAREA_FOLDWIDGETCONTROLLER_SETMAXSELECTCOUNT_OFFSET UNITYSDK_OFFSET(0x172B5040)
#define MOLEMOLE_UIAVATARACTIVITYSELECTINFOAREA_FOLDWIDGETCONTROLLER_SETQUEST_1_OFFSET UNITYSDK_OFFSET(0x172B50A0)
#define MOLEMOLE_UIAVATARACTIVITYSELECTINFOAREA_FOLDWIDGETCONTROLLER_SETQUEST_OFFSET UNITYSDK_OFFSET(0x172B4E20)
#define MOLEMOLE_UIAVATARACTIVITYSELECTINFOAREA_FOLDWIDGETCONTROLLER_SHOWBUFF_OFFSET UNITYSDK_OFFSET(0x172B3ED0)
#define MOLEMOLE_UIAVATARACTIVITYSELECTINFOAREA_FOLDWIDGETCONTROLLER_UPDATESELECT_OFFSET UNITYSDK_OFFSET(0x172B4550)
#define MOLEMOLE_UIAVATARACTIVITYSELECTINFOAREA_FOLDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x172B5150)
#define MOLEMOLE_UIAVATARACTIVITYSELECTINFOAREA_FOLDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x172B52C0)
#define MOLEMOLE_UIAVATARACTIVITYSELECTINFOAREA_FOLDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x172B5350)
#define MOLEMOLE_UIAVATARACTIVITYSELECTINFOAREA_FOLDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x172B53E0)
#define MOLEMOLE_UIAVATARACTIVITYSELECTINFOAREA_FOLDWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x172B5470)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarActivitySelectInfoArea_FoldWidgetController_TypeDefinitionIndex = 84079;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_170*>* _selectInfoItemDatas; // 0x2D8
		...
		::System::Void SetQuest_1(::System::Int32 quest, ::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_170*>* ls)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_170*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIAVATARACTIVITYSELECTINFOAREA_FOLDWIDGETCONTROLLER_SETQUEST_1_OFFSET))(this, quest, ls);
		}
		...
		static ::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_170*>* PraseBuffData_ActivityOvaMainBattleSelectBuff(::System::Int32 questID)
		{
			return ((::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_170*>*(*)(::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIAVATARACTIVITYSELECTINFOAREA_FOLDWIDGETCONTROLLER_PRASEBUFFDATA_ACTIVITYOVAMAINBATTLESELECTBUFF_OFFSET))(questID);
		}
