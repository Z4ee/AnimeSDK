...
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER_GET_ISPOPANIMWAITPROGRESSDONE_OFFSET UNITYSDK_OFFSET(0x17625CA0)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER_GET_ISPOPEXPADDANIM_OFFSET UNITYSDK_OFFSET(0x17625C80)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17624720)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x176247B0)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17624640)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x176246A0)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER_PREPAREUI_1_OFFSET UNITYSDK_OFFSET(0x17624D20)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER_PREPAREUI_OFFSET UNITYSDK_OFFSET(0x17624BB0)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER_SAMPLEANIM_OFFSET UNITYSDK_OFFSET(0x17625BB0)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER_SET_ISPOPANIMWAITPROGRESSDONE_OFFSET UNITYSDK_OFFSET(0x17625CB0)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER_SET_ISPOPEXPADDANIM_OFFSET UNITYSDK_OFFSET(0x17625C90)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER_SKIPEXPPROGRESS_OFFSET UNITYSDK_OFFSET(0x17626030)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER_STARTEXPPROGRESS_OFFSET UNITYSDK_OFFSET(0x17625CC0)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x176260B0)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER__GETLEVELTARGETEXP_OFFSET UNITYSDK_OFFSET(0x17624940)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER__LOG_OFFSET UNITYSDK_OFFSET(0x17624B70)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER__PLAYADDEXPANI_OFFSET UNITYSDK_OFFSET(0x17625F20)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER__PLAYUPGRADELVTEXTANIM_OFFSET UNITYSDK_OFFSET(0x17625A60)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER__REFRESHINITTARGETEXP_OFFSET UNITYSDK_OFFSET(0x176253F0)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER__REFRESHPROGRESS_OFFSET UNITYSDK_OFFSET(0x176254E0)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER__UPGRADETOCURRLEVEL_OFFSET UNITYSDK_OFFSET(0x176258C0)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x176261A0)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17626230)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x176262C0)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17626350)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER___PLAYUPGRADELVTEXTANIM_B__20_0_OFFSET UNITYSDK_OFFSET(0x17626110)

namespace MoleMole
{
	inline static constexpr unsigned int UIExpProgressWidgetWidgetController_TypeDefinitionIndex = 68666;
	...
	public:
		...
		::Class_3_AE02BC8285203464_29* _prevLvInfo; // 0x2E0
		::Class_3_AE02BC8285203464_29* _curLvInfo; // 0x2E8
