...
#define MOLEMOLE_MIRRORREFLECTIONPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x1686BAB0)
#define MOLEMOLE_MIRRORREFLECTIONPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x1686BBF0)
#define MOLEMOLE_MIRRORREFLECTIONPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x1686B9D0)
#define MOLEMOLE_MIRRORREFLECTIONPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1686BB70)
#define MOLEMOLE_MIRRORREFLECTIONPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x1686B9C0)
#define MOLEMOLE_MIRRORREFLECTIONPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1686BD10)
#define MOLEMOLE_MIRRORREFLECTIONPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x1686BDA0)
#define MOLEMOLE_MIRRORREFLECTIONPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x1686BE30)
#define MOLEMOLE_MIRRORREFLECTIONPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1686BEC0)

namespace MoleMole
{
	inline static constexpr unsigned int MirrorReflectionProfile_TypeDefinitionIndex = 72264;
