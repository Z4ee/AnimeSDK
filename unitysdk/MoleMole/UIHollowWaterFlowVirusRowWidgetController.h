...
#define MOLEMOLE_UIHOLLOWWATERFLOWVIRUSROWWIDGETCONTROLLER_GET_VIRUSADDANIMCOOLDOWN_OFFSET UNITYSDK_OFFSET(0x167CCC10)
#define MOLEMOLE_UIHOLLOWWATERFLOWVIRUSROWWIDGETCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x167CCDA0)
#define MOLEMOLE_UIHOLLOWWATERFLOWVIRUSROWWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x167CD0E0)
#define MOLEMOLE_UIHOLLOWWATERFLOWVIRUSROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x167CD350)
#define MOLEMOLE_UIHOLLOWWATERFLOWVIRUSROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x167CD3E0)
#define MOLEMOLE_UIHOLLOWWATERFLOWVIRUSROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x167CD280)
#define MOLEMOLE_UIHOLLOWWATERFLOWVIRUSROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x167CD2E0)
#define MOLEMOLE_UIHOLLOWWATERFLOWVIRUSROWWIDGETCONTROLLER_SETNUM_OFFSET UNITYSDK_OFFSET(0x167CD060)
#define MOLEMOLE_UIHOLLOWWATERFLOWVIRUSROWWIDGETCONTROLLER_UPDATEADDANIM_OFFSET UNITYSDK_OFFSET(0x167CD130)
#define MOLEMOLE_UIHOLLOWWATERFLOWVIRUSROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x167CD460)
#define MOLEMOLE_UIHOLLOWWATERFLOWVIRUSROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x167CD4C0)
#define MOLEMOLE_UIHOLLOWWATERFLOWVIRUSROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x167CD550)
#define MOLEMOLE_UIHOLLOWWATERFLOWVIRUSROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x167CD5E0)
#define MOLEMOLE_UIHOLLOWWATERFLOWVIRUSROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x167CD670)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowWaterFlowVirusRowWidgetController_TypeDefinitionIndex = 72603;
