...
#define MOLEMOLE_UIHOLLOWCARDOPTIONSDIALOGV2POPWINDOWCONTROLLER__PLAYVIEWREFRESH_D__22_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x826DF0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSDIALOGV2POPWINDOWCONTROLLER__PLAYVIEWREFRESH_D__22_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x283610)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCardOptionsDialogV2PopWindowController__PlayViewRefresh_d__22_TypeDefinitionIndex = 79821;
