...
#define MOLEMOLE_UIHOLLOWCARDSUITDIALOGWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1690AD50)
#define MOLEMOLE_UIHOLLOWCARDSUITDIALOGWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1690ADE0)
#define MOLEMOLE_UIHOLLOWCARDSUITDIALOGWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1690AC80)
#define MOLEMOLE_UIHOLLOWCARDSUITDIALOGWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1690ACE0)
#define MOLEMOLE_UIHOLLOWCARDSUITDIALOGWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1690AE60)
#define MOLEMOLE_UIHOLLOWCARDSUITDIALOGWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1690AEC0)
#define MOLEMOLE_UIHOLLOWCARDSUITDIALOGWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1690AF50)
#define MOLEMOLE_UIHOLLOWCARDSUITDIALOGWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1690AFE0)
#define MOLEMOLE_UIHOLLOWCARDSUITDIALOGWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1690B070)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCardSuitDialogWidgetController_TypeDefinitionIndex = 84748;
