...
#define MOLEMOLE_UIHOLLOWCARDSUITDIALOGWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14F03390)
#define MOLEMOLE_UIHOLLOWCARDSUITDIALOGWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14F03420)
#define MOLEMOLE_UIHOLLOWCARDSUITDIALOGWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14F032C0)
#define MOLEMOLE_UIHOLLOWCARDSUITDIALOGWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14F03320)
#define MOLEMOLE_UIHOLLOWCARDSUITDIALOGWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14F034A0)
#define MOLEMOLE_UIHOLLOWCARDSUITDIALOGWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14F03500)
#define MOLEMOLE_UIHOLLOWCARDSUITDIALOGWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14F03590)
#define MOLEMOLE_UIHOLLOWCARDSUITDIALOGWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14F03620)
#define MOLEMOLE_UIHOLLOWCARDSUITDIALOGWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14F036B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCardSuitDialogWidgetController_TypeDefinitionIndex = 48448;

	class UIHollowCardSuitDialogWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_879190EF9CE803C9* _view; // 0x2B8
