...
#define MOLEMOLE_UIYOROZUYADIFFICULTYINFOWIDGETCONTROLLER_ABYSSHEATCONFIGTEMPLATEEXTANDNESTTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0xE48E420)

namespace MoleMole
{
	inline static constexpr unsigned int UIYorozuyaDifficultyInfoWidgetController_AbyssHeatConfigTemplateExtAndNestType_TypeDefinitionIndex = 38977;

	class UIYorozuyaDifficultyInfoWidgetController_AbyssHeatConfigTemplateExtAndNestType : public ::System::Object
	{
	public:
		::Class_2_208CC9941471731A_448* data; // 0x10
