...
#define MOLEMOLE_UIBANGKOVSTAFFTALENTPOINTWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17607200)
#define MOLEMOLE_UIBANGKOVSTAFFTALENTPOINTWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17607270)
#define MOLEMOLE_UIBANGKOVSTAFFTALENTPOINTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17607310)
#define MOLEMOLE_UIBANGKOVSTAFFTALENTPOINTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17607430)
#define MOLEMOLE_UIBANGKOVSTAFFTALENTPOINTWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17607490)
#define MOLEMOLE_UIBANGKOVSTAFFTALENTPOINTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x176074A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangkovStaffTalentPointWidgetController_TypeDefinitionIndex = 58793;
