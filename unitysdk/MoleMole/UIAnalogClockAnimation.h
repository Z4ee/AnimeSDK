...
#define MOLEMOLE_UIANALOGCLOCKANIMATION_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x12B4EBC0)
#define MOLEMOLE_UIANALOGCLOCKANIMATION_METHOD_5_C137A300E46D5C0F_OFFSET UNITYSDK_OFFSET(0x12B4ED90)
#define MOLEMOLE_UIANALOGCLOCKANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x12B4F050)

namespace MoleMole
{
	inline static constexpr unsigned int UIAnalogClockAnimation_TypeDefinitionIndex = 78964;
