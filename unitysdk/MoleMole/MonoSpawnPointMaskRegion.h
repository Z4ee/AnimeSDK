...
namespace MoleMole
{
	...
	public:
		...
		::System::Void Method_5_1073B8C441C31009(::System::Collections::Generic::IEnumerable_1<::MoleMole::MonoSpawnPoint*>* a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::IEnumerable_1<::MoleMole::MonoSpawnPoint*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOSPAWNPOINTMASKREGION_METHOD_5_1073B8C441C31009_OFFSET))(this, a1);
		}
	};
}
