...
#define MOLEMOLE_UIHANDBOOKAWAKENITEMREWARDCONTEXT_FROMQUESTID_OFFSET UNITYSDK_OFFSET(0x18ED1E00)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMREWARDCONTEXT_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0x18ED21E0)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMREWARDCONTEXT_GET_ITEMNUM_OFFSET UNITYSDK_OFFSET(0x18ED2340)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMREWARDCONTEXT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x18ED2090)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMREWARDCONTEXT_GET_REWARDPREVIEW_OFFSET UNITYSDK_OFFSET(0x18ED1F20)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMREWARDCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18ED1ED0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookAwakenItemRewardContext_TypeDefinitionIndex = 75367;
