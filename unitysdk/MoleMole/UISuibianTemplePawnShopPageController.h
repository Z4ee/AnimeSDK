...
#define MOLEMOLE_UISUIBIANTEMPLEPAWNSHOPPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x156BF9F0)
#define MOLEMOLE_UISUIBIANTEMPLEPAWNSHOPPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x156BFA00)
#define MOLEMOLE_UISUIBIANTEMPLEPAWNSHOPPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x156BFA70)
#define MOLEMOLE_UISUIBIANTEMPLEPAWNSHOPPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x156BFB30)
#define MOLEMOLE_UISUIBIANTEMPLEPAWNSHOPPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x156BFBC0)
#define MOLEMOLE_UISUIBIANTEMPLEPAWNSHOPPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x156BFC80)
#define MOLEMOLE_UISUIBIANTEMPLEPAWNSHOPPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x156BFC90)
#define MOLEMOLE_UISUIBIANTEMPLEPAWNSHOPPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x156BFD30)
#define MOLEMOLE_UISUIBIANTEMPLEPAWNSHOPPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x156BFD40)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTemplePawnShopPageController_TypeDefinitionIndex = 57017;
