...
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEWIDGETCONTROLLER___C__DISPLAYCLASS26_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19BFF470)
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEWIDGETCONTROLLER___C__DISPLAYCLASS26_0__ONGAMESETTLED_B__0_OFFSET UNITYSDK_OFFSET(0x19BFF480)
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEWIDGETCONTROLLER___C__DISPLAYCLASS26_0__ONGAMESETTLED_B__1_OFFSET UNITYSDK_OFFSET(0x19BFF4B0)

namespace MoleMole::MiniUIGame::BezierCurve
{
	inline static constexpr unsigned int UIBezierCurveGameWidgetController___c__DisplayClass26_0_TypeDefinitionIndex = 81131;
