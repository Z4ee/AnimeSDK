...
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEWIDGETCONTROLLER___C__DISPLAYCLASS26_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17E8BC40)
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEWIDGETCONTROLLER___C__DISPLAYCLASS26_0__ONGAMESETTLED_B__0_OFFSET UNITYSDK_OFFSET(0x17E8BC50)
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEWIDGETCONTROLLER___C__DISPLAYCLASS26_0__ONGAMESETTLED_B__1_OFFSET UNITYSDK_OFFSET(0x17E8BC80)

namespace MoleMole::MiniUIGame::BezierCurve
{
	inline static constexpr unsigned int UIBezierCurveGameWidgetController___c__DisplayClass26_0_TypeDefinitionIndex = 66668;
