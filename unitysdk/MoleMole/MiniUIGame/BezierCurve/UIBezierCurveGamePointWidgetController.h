...
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEPOINTWIDGETCONTROLLER_ADDCOLLIDER_OFFSET UNITYSDK_OFFSET(0x107FDE30)
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEPOINTWIDGETCONTROLLER_GETANCHOREDPOSITION_OFFSET UNITYSDK_OFFSET(0x107FDD50)
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEPOINTWIDGETCONTROLLER_GET_POINTTYPE_OFFSET UNITYSDK_OFFSET(0x107FDF90)
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEPOINTWIDGETCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x107FDB80)
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEPOINTWIDGETCONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0x107FDD10)
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEPOINTWIDGETCONTROLLER_SETANCHOREDPOSITION_OFFSET UNITYSDK_OFFSET(0x107FDDC0)
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEPOINTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x107FDFA0)

namespace MoleMole::MiniUIGame::BezierCurve
{
	inline static constexpr unsigned int UIBezierCurveGamePointWidgetController_TypeDefinitionIndex = 64930;
