...
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEPOINTWIDGETCONTROLLER_ADDCOLLIDER_OFFSET UNITYSDK_OFFSET(0x12F97CB0)
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEPOINTWIDGETCONTROLLER_GETANCHOREDPOSITION_OFFSET UNITYSDK_OFFSET(0x12F97BD0)
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEPOINTWIDGETCONTROLLER_GET_POINTTYPE_OFFSET UNITYSDK_OFFSET(0x12F97E10)
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEPOINTWIDGETCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x12F97A00)
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEPOINTWIDGETCONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0x12F97B90)
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEPOINTWIDGETCONTROLLER_SETANCHOREDPOSITION_OFFSET UNITYSDK_OFFSET(0x12F97C40)
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEPOINTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12F97E20)

namespace MoleMole::MiniUIGame::BezierCurve
{
	inline static constexpr unsigned int UIBezierCurveGamePointWidgetController_TypeDefinitionIndex = 56383;

	class UIBezierCurveGamePointWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::UnityEngine::RectTransform* _rect; // 0x2B8
		::MoleMole::MiniUIGame::BezierCurve::UIInLevelBezierCurveGameWidgetController* _inLevelWidget; // 0x2C0
