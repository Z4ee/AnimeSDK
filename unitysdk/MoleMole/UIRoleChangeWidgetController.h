...
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_CHECKAVATARCANSELECT_1_OFFSET UNITYSDK_OFFSET(0x17E38FB0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_CHECKAVATARCANSELECT_OFFSET UNITYSDK_OFFSET(0x17E38500)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_CREATROLELISTROW_OFFSET UNITYSDK_OFFSET(0x17E383D0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_DELAYCHANGEACTION_OFFSET UNITYSDK_OFFSET(0x17E3AB90)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_GET_SHOULDHANDLEINPUT_OFFSET UNITYSDK_OFFSET(0x17E38030)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x17E39390)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONAVATARSELECTHANDLE_OFFSET UNITYSDK_OFFSET(0x17E3A620)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x17E39C30)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17E3A440)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x17E39B10)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x17E38B40)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONNEXTBTN_OFFSET UNITYSDK_OFFSET(0x17E38770)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONPREVIOUSBTN_OFFSET UNITYSDK_OFFSET(0x17E38AB0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17E39230)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17E3ABE0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17E38040)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17E391B0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_REFRESHDATA_OFFSET UNITYSDK_OFFSET(0x17E3A5C0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_SETBLOCKINPUT_OFFSET UNITYSDK_OFFSET(0x17E3A330)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_SETCHANGEACTION_OFFSET UNITYSDK_OFFSET(0x17E3A4D0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_SETCHANGEBTNSTATE_OFFSET UNITYSDK_OFFSET(0x17E386E0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_SETFORBIDSELECTLOCKAVATAR_OFFSET UNITYSDK_OFFSET(0x17E38680)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_SETLEFTACTION_OFFSET UNITYSDK_OFFSET(0x17E3A520)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_SETNEXTAVATAR_OFFSET UNITYSDK_OFFSET(0x17E387F0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_SETRIGHTACTION_OFFSET UNITYSDK_OFFSET(0x17E3A570)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17E3AD30)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER__SETBLOCKINPUT_B__25_0_OFFSET UNITYSDK_OFFSET(0x17E3AE10)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17E3AEE0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x17E3AF70)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x17E3B000)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17E3B030)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17E3B0D0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17E3B160)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17E3B1F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleChangeWidgetController_TypeDefinitionIndex = 81674;
