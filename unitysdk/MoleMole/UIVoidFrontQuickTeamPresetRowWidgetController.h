...
#define MOLEMOLE_UIVOIDFRONTQUICKTEAMPRESETROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15145930)
#define MOLEMOLE_UIVOIDFRONTQUICKTEAMPRESETROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15145A60)
#define MOLEMOLE_UIVOIDFRONTQUICKTEAMPRESETROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15145B20)
#define MOLEMOLE_UIVOIDFRONTQUICKTEAMPRESETROWWIDGETCONTROLLER_ONSELECTROLEEVENT_OFFSET UNITYSDK_OFFSET(0x15145C30)
#define MOLEMOLE_UIVOIDFRONTQUICKTEAMPRESETROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x151459A0)
#define MOLEMOLE_UIVOIDFRONTQUICKTEAMPRESETROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15145D20)
#define MOLEMOLE_UIVOIDFRONTQUICKTEAMPRESETROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15145D30)
#define MOLEMOLE_UIVOIDFRONTQUICKTEAMPRESETROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15145DD0)
#define MOLEMOLE_UIVOIDFRONTQUICKTEAMPRESETROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15145E70)

namespace MoleMole
{
	inline static constexpr unsigned int UIVoidFrontQuickTeamPresetRowWidgetController_TypeDefinitionIndex = 71684;
