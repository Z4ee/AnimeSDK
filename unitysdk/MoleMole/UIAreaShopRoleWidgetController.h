...
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER_INITDATA_OFFSET UNITYSDK_OFFSET(0x15AABE40)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15AAC630)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15AAC6C0)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15AABBE0)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15AABDD0)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER_REFRESHHPRATIO_OFFSET UNITYSDK_OFFSET(0x15AAC1A0)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15AAC740)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15AAC7A0)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15AAC830)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15AAC8C0)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15AAC950)

namespace MoleMole
{
	inline static constexpr unsigned int UIAreaShopRoleWidgetController_TypeDefinitionIndex = 72164;

	class UIAreaShopRoleWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_D6BCF098B26738D7_2* _view; // 0x2B8
		::MoleMole::Battle::Entity* _cachedAvatarEntity; // 0x2C0
