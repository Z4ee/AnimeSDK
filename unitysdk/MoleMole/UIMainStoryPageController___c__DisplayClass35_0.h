...
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS35_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15570D20)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS35_0__ITEMSFADEOUT_B__1_OFFSET UNITYSDK_OFFSET(0x15570D30)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainStoryPageController___c__DisplayClass35_0_TypeDefinitionIndex = 56279;
