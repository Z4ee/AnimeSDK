...
#define MOLEMOLE_MONOUIIMAGEMATTEXTURECHANGE_APPLY_OFFSET UNITYSDK_OFFSET(0x173F8CB0)
#define MOLEMOLE_MONOUIIMAGEMATTEXTURECHANGE_GET_CHANGETAG_OFFSET UNITYSDK_OFFSET(0x173F8CA0)
#define MOLEMOLE_MONOUIIMAGEMATTEXTURECHANGE_GET_CHANGETYPE_OFFSET UNITYSDK_OFFSET(0x173F90D0)
#define MOLEMOLE_MONOUIIMAGEMATTEXTURECHANGE_METHOD_5_41654240C876123C_OFFSET UNITYSDK_OFFSET(0x173F8E60)
#define MOLEMOLE_MONOUIIMAGEMATTEXTURECHANGE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x173F9160)
#define MOLEMOLE_MONOUIIMAGEMATTEXTURECHANGE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x173F90E0)
#define MOLEMOLE_MONOUIIMAGEMATTEXTURECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x173F91E0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIImageMatTextureChange_TypeDefinitionIndex = 50741;
