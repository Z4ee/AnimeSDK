...
#define MOLEMOLE_MONOUIIMAGEMATTEXTURECHANGE_APPLY_OFFSET UNITYSDK_OFFSET(0x129D5850)
#define MOLEMOLE_MONOUIIMAGEMATTEXTURECHANGE_GET_CHANGETAG_OFFSET UNITYSDK_OFFSET(0x129D5840)
#define MOLEMOLE_MONOUIIMAGEMATTEXTURECHANGE_GET_CHANGETYPE_OFFSET UNITYSDK_OFFSET(0x129D5C70)
#define MOLEMOLE_MONOUIIMAGEMATTEXTURECHANGE_METHOD_5_41654240C876123C_OFFSET UNITYSDK_OFFSET(0x129D5A00)
#define MOLEMOLE_MONOUIIMAGEMATTEXTURECHANGE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x129D5D00)
#define MOLEMOLE_MONOUIIMAGEMATTEXTURECHANGE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x129D5C80)
#define MOLEMOLE_MONOUIIMAGEMATTEXTURECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x129D5D80)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIImageMatTextureChange_TypeDefinitionIndex = 88185;
