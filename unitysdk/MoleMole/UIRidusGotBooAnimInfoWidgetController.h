...
#define MOLEMOLE_UIRIDUSGOTBOOANIMINFOWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x12FFB1B0)
#define MOLEMOLE_UIRIDUSGOTBOOANIMINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12FFB160)
#define MOLEMOLE_UIRIDUSGOTBOOANIMINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12FFB270)
#define MOLEMOLE_UIRIDUSGOTBOOANIMINFOWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x12FFB280)
#define MOLEMOLE_UIRIDUSGOTBOOANIMINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12FFB290)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooAnimInfoWidgetController_TypeDefinitionIndex = 75610;

	class UIRidusGotBooAnimInfoWidgetController : public ::MoleMole::UIRidusGotBooSetIconInfoWidgetController
	{
	public:
		::Class_2_208CC9941471731A_1041* _config; // 0x318
