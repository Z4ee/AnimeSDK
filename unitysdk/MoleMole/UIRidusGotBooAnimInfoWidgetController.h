...
#define MOLEMOLE_UIRIDUSGOTBOOANIMINFOWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15F317D0)
#define MOLEMOLE_UIRIDUSGOTBOOANIMINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15F31780)
#define MOLEMOLE_UIRIDUSGOTBOOANIMINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15F31890)
#define MOLEMOLE_UIRIDUSGOTBOOANIMINFOWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15F318A0)
#define MOLEMOLE_UIRIDUSGOTBOOANIMINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15F318B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooAnimInfoWidgetController_TypeDefinitionIndex = 74080;

	class UIRidusGotBooAnimInfoWidgetController : public ::MoleMole::UIRidusGotBooSetIconInfoWidgetController
	{
	public:
		::Class_2_208CC9941471731A_827* _config; // 0x318
