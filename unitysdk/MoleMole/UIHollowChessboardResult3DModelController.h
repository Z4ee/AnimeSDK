...
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_ADDGROUPMEMBERBYPOSITION_OFFSET UNITYSDK_OFFSET(0x18EF35F0)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_ADDGROUPMEMBER_OFFSET UNITYSDK_OFFSET(0x18EF3670)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_BINDLIGHT_OFFSET UNITYSDK_OFFSET(0x18EF1090)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_BINK_OFFSET UNITYSDK_OFFSET(0x18EF2870)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_BUILDCHESSBOARD_OFFSET UNITYSDK_OFFSET(0x18EF1720)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_DOBLINKNUMBERV2_OFFSET UNITYSDK_OFFSET(0x18EF5230)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_DOBLINKNUMBER_OFFSET UNITYSDK_OFFSET(0x18EF46C0)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_DOBLINK_OFFSET UNITYSDK_OFFSET(0x18EF3A40)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_DOLIGHTLERP_OFFSET UNITYSDK_OFFSET(0x18EF12C0)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_GETBLINKMATRIXCONFIG_OFFSET UNITYSDK_OFFSET(0x18EF42D0)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_GETLASTTWODIGITS_OFFSET UNITYSDK_OFFSET(0x18EF5140)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_GETNUMBERREGION_OFFSET UNITYSDK_OFFSET(0x18EF51D0)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_GETRESULTPIECE_1_OFFSET UNITYSDK_OFFSET(0x18EF39E0)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_GETRESULTPIECE_OFFSET UNITYSDK_OFFSET(0x18EF38C0)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_GET_NUMBERRESULT_OFFSET UNITYSDK_OFFSET(0x18EF0F40)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_INITCAMERA_OFFSET UNITYSDK_OFFSET(0x18EF2940)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_INITCHESSPIECES_OFFSET UNITYSDK_OFFSET(0x18EF18A0)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_INITMODELCAMERA_OFFSET UNITYSDK_OFFSET(0x18EF29D0)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_ISINARRAY_OFFSET UNITYSDK_OFFSET(0x18EF3810)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x18EF16C0)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18EF0F60)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x18EF1150)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18EF11E0)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18EF0FF0)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18EF1100)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_REQFOCUSCONFIGGRID_OFFSET UNITYSDK_OFFSET(0x18EF2D70)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_REQINITCAMERAANIM_OFFSET UNITYSDK_OFFSET(0x18EF3590)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_REQRESULTCAMERA_OFFSET UNITYSDK_OFFSET(0x18EF2CB0)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_SETFAILBRIGHTNESS_OFFSET UNITYSDK_OFFSET(0x18EF43E0)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_SETLIGHTBYPERCENT_OFFSET UNITYSDK_OFFSET(0x18EF5850)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_SETLIGHTVAL_OFFSET UNITYSDK_OFFSET(0x18EF55B0)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_SETLIGHT_OFFSET UNITYSDK_OFFSET(0x18EF2520)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_SET_NUMBERRESULT_OFFSET UNITYSDK_OFFSET(0x18EF0F50)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x18EF1250)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER__BINK_B__16_0_OFFSET UNITYSDK_OFFSET(0x18EF5BB0)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18EF5B60)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18EF5A10)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER__SETLIGHT_B__40_0_OFFSET UNITYSDK_OFFSET(0x18EF5C30)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18EF5C40)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x18EF5CD0)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18EF5D90)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18EF5DA0)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18EF5DB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowChessboardResult3DModelController_TypeDefinitionIndex = 49220;
	...
	public:
		...
		{
			return (::UnityEngine::Quaternion*)Il2CppClass::FromTypeDefinitionIndex(UIHollowChessboardResult3DModelController_TypeDefinitionIndex)->GetStaticField(0xDCF0);
		}
		::System::Nullable_1<::System::Int32> _NumberResult_k__BackingField; // 0x360
		::Class_1_2DAF4D0B64681D6A* _hollowCameraGroup; // 0x368
