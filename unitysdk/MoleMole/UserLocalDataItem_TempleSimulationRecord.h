...
#define MOLEMOLE_USERLOCALDATAITEM_TEMPLESIMULATIONRECORD__CTOR_OFFSET UNITYSDK_OFFSET(0x174C1530)

namespace MoleMole
{
	inline static constexpr unsigned int UserLocalDataItem_TempleSimulationRecord_TypeDefinitionIndex = 70342;
