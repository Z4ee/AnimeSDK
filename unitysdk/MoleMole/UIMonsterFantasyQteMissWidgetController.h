...
#define MOLEMOLE_UIMONSTERFANTASYQTEMISSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x168E20E0)
#define MOLEMOLE_UIMONSTERFANTASYQTEMISSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x168E2170)
#define MOLEMOLE_UIMONSTERFANTASYQTEMISSWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x168E2070)
#define MOLEMOLE_UIMONSTERFANTASYQTEMISSWIDGETCONTROLLER_PLAYANIM_OFFSET UNITYSDK_OFFSET(0x168E21F0)
#define MOLEMOLE_UIMONSTERFANTASYQTEMISSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x168E2350)
#define MOLEMOLE_UIMONSTERFANTASYQTEMISSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x168E23B0)
#define MOLEMOLE_UIMONSTERFANTASYQTEMISSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x168E2440)
#define MOLEMOLE_UIMONSTERFANTASYQTEMISSWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x168E24D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyQteMissWidgetController_TypeDefinitionIndex = 90746;
