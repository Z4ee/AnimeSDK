...
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG_CLEAN_OFFSET UNITYSDK_OFFSET(0x1190D8D0)
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG_GETSHORTDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x118DFD40)
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG_GET_ANIMATORZONEGROUP_OFFSET UNITYSDK_OFFSET(0x1190DB50)
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG_GET_EVENTPATTERNCONFIGS_OFFSET UNITYSDK_OFFSET(0x1190DD90)
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG_GET_LINKEDANIMEVENTSOBJECT_OFFSET UNITYSDK_OFFSET(0x1190E4D0)
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG_GET_LINKEDANIMEVENTS_OFFSET UNITYSDK_OFFSET(0x1190E350)
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG_GET_STATELENGTHCONFIG_OFFSET UNITYSDK_OFFSET(0x1190D930)
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1190E0C0)
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0x1190E830)
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1190E650)
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1190E840)

namespace MoleMole
{
	inline static constexpr unsigned int SkillCharacterScriptConfig_TypeDefinitionIndex = 86315;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(SkillCharacterScriptConfig_TypeDefinitionIndex)->GetStaticField(0xE3E0);
		}
		static ::System::Boolean* StaticGet_S_False()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(SkillCharacterScriptConfig_TypeDefinitionIndex)->GetStaticField(0xE3E1);
		}
