...
#define MOLEMOLE_UIHOUSERHYTHMREWARDROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1468C900)
#define MOLEMOLE_UIHOUSERHYTHMREWARDROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1468C970)
#define MOLEMOLE_UIHOUSERHYTHMREWARDROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1468CA10)
#define MOLEMOLE_UIHOUSERHYTHMREWARDROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1468CAD0)
#define MOLEMOLE_UIHOUSERHYTHMREWARDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1468CB80)
#define MOLEMOLE_UIHOUSERHYTHMREWARDROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1468CB90)
#define MOLEMOLE_UIHOUSERHYTHMREWARDROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1468CC30)

namespace MoleMole
{
	inline static constexpr unsigned int UIHouseRhythmRewardRowWidgetController_TypeDefinitionIndex = 59952;
