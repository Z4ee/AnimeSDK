...
#define MOLEMOLE_UIHOUSERHYTHMREWARDROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x164D8220)
#define MOLEMOLE_UIHOUSERHYTHMREWARDROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x164D8290)
#define MOLEMOLE_UIHOUSERHYTHMREWARDROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x164D8330)
#define MOLEMOLE_UIHOUSERHYTHMREWARDROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x164D83F0)
#define MOLEMOLE_UIHOUSERHYTHMREWARDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x164D84A0)
#define MOLEMOLE_UIHOUSERHYTHMREWARDROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x164D84B0)
#define MOLEMOLE_UIHOUSERHYTHMREWARDROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x164D8550)

namespace MoleMole
{
	inline static constexpr unsigned int UIHouseRhythmRewardRowWidgetController_TypeDefinitionIndex = 53645;
