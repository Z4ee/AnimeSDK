...
#define MOLEMOLE_MATERIALMODIFIERTARGETTINGGROUP_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16053E30)
#define MOLEMOLE_MATERIALMODIFIERTARGETTINGGROUP_METHOD_1_1DA658F42F780D13_OFFSET UNITYSDK_OFFSET(0x160542A0)
#define MOLEMOLE_MATERIALMODIFIERTARGETTINGGROUP_METHOD_1_B2C0ADBFEA309440_OFFSET UNITYSDK_OFFSET(0x160540D0)
#define MOLEMOLE_MATERIALMODIFIERTARGETTINGGROUP_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x16054090)
#define MOLEMOLE_MATERIALMODIFIERTARGETTINGGROUP_METHOD_1_DD58D7555070DEA2_OFFSET UNITYSDK_OFFSET(0x160542F0)
#define MOLEMOLE_MATERIALMODIFIERTARGETTINGGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x16054010)

namespace MoleMole
{
	inline static constexpr unsigned int MaterialModifierTargettingGroup_TypeDefinitionIndex = 52563;
