...
#define MOLEMOLE_UIINTERKNOWCOURSEPANELWIDGETCONTROLLER_COURSEPANELCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x155F35A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnowCoursePanelWidgetController_CoursePanelContext_TypeDefinitionIndex = 49230;
	...
	public:
		...
		::System::Int32 focusTargetNode; // 0x30
		::System::Int32 showStartNodeIdx; // 0x34
		::System::Int32 showEndNodeIdx; // 0x38
