...
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__DELAYFADEOUTUIANDPOPRESULTPAGE_D__334_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x7BC1C0)
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__DELAYFADEOUTUIANDPOPRESULTPAGE_D__334_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x283610)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooPageController__DelayFadeoutUIAndPopResultPage_d__334_TypeDefinitionIndex = 40707;

	struct alignas(8) UIRidusGotBooPageController__DelayFadeoutUIAndPopResultPage_d__334
	{
		::Cysharp::Threading::Tasks::UniTask_Awaiter __u__1; // 0x10
		::System::Collections::Generic::List_1<::System::Int32>* finishedIDs; // 0x20
		...
		::MoleMole::UIRidusGotBooPageController___c__DisplayClass334_0* __8__1; // 0x40
