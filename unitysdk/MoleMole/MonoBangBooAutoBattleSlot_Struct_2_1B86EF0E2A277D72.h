...
#define MOLEMOLE_MONOBANGBOOAUTOBATTLESLOT_STRUCT_2_1B86EF0E2A277D72__CTOR_OFFSET UNITYSDK_OFFSET(0x346F70)

namespace MoleMole
{
	inline static constexpr unsigned int MonoBangBooAutoBattleSlot_Struct_2_1B86EF0E2A277D72_TypeDefinitionIndex = 56223;

	struct alignas(8) MonoBangBooAutoBattleSlot_Struct_2_1B86EF0E2A277D72
	{
		::UnityEngine::Transform* Field_2_1; // 0x10
		::System::Func_2<::MoleMole::MonoBangBooAutoBattleSlot_Enum_3_1468EE9C811FF285, ::System::Boolean>* Field_2_0; // 0x18
