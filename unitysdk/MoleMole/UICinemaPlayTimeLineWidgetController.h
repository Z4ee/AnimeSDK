...
#define MOLEMOLE_UICINEMAPLAYTIMELINEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1760FF20)
#define MOLEMOLE_UICINEMAPLAYTIMELINEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1760FFB0)
#define MOLEMOLE_UICINEMAPLAYTIMELINEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1760FE50)
#define MOLEMOLE_UICINEMAPLAYTIMELINEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1760FEB0)
#define MOLEMOLE_UICINEMAPLAYTIMELINEWIDGETCONTROLLER_SETHIGHLIGHTEFFECT_OFFSET UNITYSDK_OFFSET(0x17610030)
#define MOLEMOLE_UICINEMAPLAYTIMELINEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x176100F0)
#define MOLEMOLE_UICINEMAPLAYTIMELINEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17610150)
#define MOLEMOLE_UICINEMAPLAYTIMELINEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x176101E0)
#define MOLEMOLE_UICINEMAPLAYTIMELINEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17610270)
#define MOLEMOLE_UICINEMAPLAYTIMELINEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17610300)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaPlayTimeLineWidgetController_TypeDefinitionIndex = 58013;
