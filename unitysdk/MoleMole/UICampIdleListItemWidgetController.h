...
#define MOLEMOLE_UICAMPIDLELISTITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x192AF140)
#define MOLEMOLE_UICAMPIDLELISTITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x192AF250)
#define MOLEMOLE_UICAMPIDLELISTITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x192AF1D0)
#define MOLEMOLE_UICAMPIDLELISTITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x192AF0E0)
#define MOLEMOLE_UICAMPIDLELISTITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x192AF4F0)
#define MOLEMOLE_UICAMPIDLELISTITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x192AF500)
#define MOLEMOLE_UICAMPIDLELISTITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x192AF590)
#define MOLEMOLE_UICAMPIDLELISTITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x192AF630)
#define MOLEMOLE_UICAMPIDLELISTITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x192AF6C0)

namespace MoleMole
{
	inline static constexpr unsigned int UICampIdleListItemWidgetController_TypeDefinitionIndex = 45759;
