...
#define MOLEMOLE_UIFLOWERSHOPPREP_EMPTYPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x16DADE70)
#define MOLEMOLE_UIFLOWERSHOPPREP_EMPTYPAGECONTROLLER_ISQUESTINPROGRESS_OFFSET UNITYSDK_OFFSET(0x16DAF0B0)
#define MOLEMOLE_UIFLOWERSHOPPREP_EMPTYPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16DADE80)
#define MOLEMOLE_UIFLOWERSHOPPREP_EMPTYPAGECONTROLLER_ONOPENMAINCITYSTOREPAGE_OFFSET UNITYSDK_OFFSET(0x16DAE500)
#define MOLEMOLE_UIFLOWERSHOPPREP_EMPTYPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16DAE210)
#define MOLEMOLE_UIFLOWERSHOPPREP_EMPTYPAGECONTROLLER_ONSTOREEXIT_OFFSET UNITYSDK_OFFSET(0x16DAF2D0)
#define MOLEMOLE_UIFLOWERSHOPPREP_EMPTYPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16DAE490)
#define MOLEMOLE_UIFLOWERSHOPPREP_EMPTYPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16DADF10)
#define MOLEMOLE_UIFLOWERSHOPPREP_EMPTYPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16DAE000)
#define MOLEMOLE_UIFLOWERSHOPPREP_EMPTYPAGECONTROLLER_OPENMAINPAGE_OFFSET UNITYSDK_OFFSET(0x16DAF6D0)
#define MOLEMOLE_UIFLOWERSHOPPREP_EMPTYPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16DAF7A0)
#define MOLEMOLE_UIFLOWERSHOPPREP_EMPTYPAGECONTROLLER__ONSTOREEXIT_G__USENORMALEXITTRIGGER_10_0_OFFSET UNITYSDK_OFFSET(0x16DAF4B0)
#define MOLEMOLE_UIFLOWERSHOPPREP_EMPTYPAGECONTROLLER__ONUIINIT_B__5_0_OFFSET UNITYSDK_OFFSET(0x16DAF7B0)
#define MOLEMOLE_UIFLOWERSHOPPREP_EMPTYPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16DAF7C0)
#define MOLEMOLE_UIFLOWERSHOPPREP_EMPTYPAGECONTROLLER___BASE_ONOPENMAINCITYSTOREPAGE_OFFSET UNITYSDK_OFFSET(0x16DAF850)
#define MOLEMOLE_UIFLOWERSHOPPREP_EMPTYPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16DAF8F0)
#define MOLEMOLE_UIFLOWERSHOPPREP_EMPTYPAGECONTROLLER___BASE_ONSTOREEXIT_OFFSET UNITYSDK_OFFSET(0x16DAF990)
#define MOLEMOLE_UIFLOWERSHOPPREP_EMPTYPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16DAF9A0)
#define MOLEMOLE_UIFLOWERSHOPPREP_EMPTYPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16DAF9B0)
#define MOLEMOLE_UIFLOWERSHOPPREP_EMPTYPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16DAF9C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerShopPrep_EmptyPageController_TypeDefinitionIndex = 56631;
