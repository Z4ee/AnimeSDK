...
#define MOLEMOLE_GENERALHEADROWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x118C81E0)

namespace MoleMole
{
	inline static constexpr unsigned int GeneralHeadRowContext_TypeDefinitionIndex = 80692;
