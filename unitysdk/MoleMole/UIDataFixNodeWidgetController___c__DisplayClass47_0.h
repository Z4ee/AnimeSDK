...
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___C__DISPLAYCLASS47_0__CTOR_OFFSET UNITYSDK_OFFSET(0x157D87A0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___C__DISPLAYCLASS47_0__SETTERMCOLOR_B__6_OFFSET UNITYSDK_OFFSET(0x157DAC50)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___C__DISPLAYCLASS47_0__SETTERMCOLOR_B__7_OFFSET UNITYSDK_OFFSET(0x157DACA0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___C__DISPLAYCLASS47_0__SETTERMCOLOR_G__HASCOLORCHANGED_4_OFFSET UNITYSDK_OFFSET(0x157D9260)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___C__DISPLAYCLASS47_0__SETTERMCOLOR_G__SETCOLOR_2_OFFSET UNITYSDK_OFFSET(0x157D93B0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___C__DISPLAYCLASS47_0__SETTERMCOLOR_G__SETENDSTATE_5_OFFSET UNITYSDK_OFFSET(0x157DA1F0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___C__DISPLAYCLASS47_0__SETTERMCOLOR_G__SETNODECOLOR_1_OFFSET UNITYSDK_OFFSET(0x157D9550)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___C__DISPLAYCLASS47_0__SETTERMCOLOR_G__SETNULLCOLOR_0_OFFSET UNITYSDK_OFFSET(0x157D87B0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___C__DISPLAYCLASS47_0__SETTERMCOLOR_G__SETUNCONNECTCOLOR_3_OFFSET UNITYSDK_OFFSET(0x157DA050)

namespace MoleMole
{
	inline static constexpr unsigned int UIDataFixNodeWidgetController___c__DisplayClass47_0_TypeDefinitionIndex = 44490;
	...
	public:
		...
		::Enum_3_D0F2373931CC685D_1 flowDir; // 0x1C
