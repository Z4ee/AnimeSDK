...
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___C__DISPLAYCLASS47_0__CTOR_OFFSET UNITYSDK_OFFSET(0x166B99B0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___C__DISPLAYCLASS47_0__SETTERMCOLOR_B__6_OFFSET UNITYSDK_OFFSET(0x166BBE60)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___C__DISPLAYCLASS47_0__SETTERMCOLOR_B__7_OFFSET UNITYSDK_OFFSET(0x166BBEB0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___C__DISPLAYCLASS47_0__SETTERMCOLOR_G__HASCOLORCHANGED_4_OFFSET UNITYSDK_OFFSET(0x166BA470)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___C__DISPLAYCLASS47_0__SETTERMCOLOR_G__SETCOLOR_2_OFFSET UNITYSDK_OFFSET(0x166BA5C0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___C__DISPLAYCLASS47_0__SETTERMCOLOR_G__SETENDSTATE_5_OFFSET UNITYSDK_OFFSET(0x166BB400)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___C__DISPLAYCLASS47_0__SETTERMCOLOR_G__SETNODECOLOR_1_OFFSET UNITYSDK_OFFSET(0x166BA760)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___C__DISPLAYCLASS47_0__SETTERMCOLOR_G__SETNULLCOLOR_0_OFFSET UNITYSDK_OFFSET(0x166B99C0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___C__DISPLAYCLASS47_0__SETTERMCOLOR_G__SETUNCONNECTCOLOR_3_OFFSET UNITYSDK_OFFSET(0x166BB260)

namespace MoleMole
{
	inline static constexpr unsigned int UIDataFixNodeWidgetController___c__DisplayClass47_0_TypeDefinitionIndex = 75656;
	...
	public:
		...
		::System::Boolean needAnim; // 0x1C
		::Enum_3_D0F2373931CC685D_2 flowDir; // 0x20
