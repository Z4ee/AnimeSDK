...
#define MOLEMOLE_UIRABDEPOSITORYUPTIPSWIDGETCONTROLLER_FADEOUTRABBUDDYPOWERCHANGETIPSHANDLE_OFFSET UNITYSDK_OFFSET(0x17A1DC40)
#define MOLEMOLE_UIRABDEPOSITORYUPTIPSWIDGETCONTROLLER_GET_IGNOREFADING_OFFSET UNITYSDK_OFFSET(0x17A1CA70)
#define MOLEMOLE_UIRABDEPOSITORYUPTIPSWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17A1CA80)
#define MOLEMOLE_UIRABDEPOSITORYUPTIPSWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17A1CAF0)
#define MOLEMOLE_UIRABDEPOSITORYUPTIPSWIDGETCONTROLLER_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0x17A1D220)
#define MOLEMOLE_UIRABDEPOSITORYUPTIPSWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17A1CB90)
#define MOLEMOLE_UIRABDEPOSITORYUPTIPSWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17A1D1B0)
#define MOLEMOLE_UIRABDEPOSITORYUPTIPSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17A1DC90)
#define MOLEMOLE_UIRABDEPOSITORYUPTIPSWIDGETCONTROLLER__ONFADEPLAYFINISH_B__9_2_OFFSET UNITYSDK_OFFSET(0x17A1DCF0)
#define MOLEMOLE_UIRABDEPOSITORYUPTIPSWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17A1DD00)
#define MOLEMOLE_UIRABDEPOSITORYUPTIPSWIDGETCONTROLLER___BASE_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0x17A1DDA0)
#define MOLEMOLE_UIRABDEPOSITORYUPTIPSWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17A1DDB0)
#define MOLEMOLE_UIRABDEPOSITORYUPTIPSWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17A1DE50)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABDepositoryUpTipsWidgetController_TypeDefinitionIndex = 52806;
