...
#define MOLEMOLE_UIHOLLOWCLUEPICITEMWIDGETCONTROLLER_ONCLICKITEMPOPWINDOW_OFFSET UNITYSDK_OFFSET(0x19EB1D90)
#define MOLEMOLE_UIHOLLOWCLUEPICITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19EB2460)
#define MOLEMOLE_UIHOLLOWCLUEPICITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x19EB18A0)
#define MOLEMOLE_UIHOLLOWCLUEPICITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x19EB2570)
#define MOLEMOLE_UIHOLLOWCLUEPICITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19EB24F0)
#define MOLEMOLE_UIHOLLOWCLUEPICITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19EB1740)
#define MOLEMOLE_UIHOLLOWCLUEPICITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19EB1AC0)
#define MOLEMOLE_UIHOLLOWCLUEPICITEMWIDGETCONTROLLER_REFRESHREDPOINTBYDATA_OFFSET UNITYSDK_OFFSET(0x19EB1B80)
#define MOLEMOLE_UIHOLLOWCLUEPICITEMWIDGETCONTROLLER_REFRESHREDPOINT_OFFSET UNITYSDK_OFFSET(0x19EB1BD0)
#define MOLEMOLE_UIHOLLOWCLUEPICITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x19EB2090)
#define MOLEMOLE_UIHOLLOWCLUEPICITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19EB2670)
#define MOLEMOLE_UIHOLLOWCLUEPICITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19EB2680)
#define MOLEMOLE_UIHOLLOWCLUEPICITEMWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x19EB2710)
#define MOLEMOLE_UIHOLLOWCLUEPICITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x19EB27A0)
#define MOLEMOLE_UIHOLLOWCLUEPICITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19EB2840)
#define MOLEMOLE_UIHOLLOWCLUEPICITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19EB28D0)
#define MOLEMOLE_UIHOLLOWCLUEPICITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19EB2960)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCluePicItemWidgetController_TypeDefinitionIndex = 82811;

	class UIHollowCluePicItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_1C66F7E56EF1134C_1* _view; // 0x2F0
		::Class_2_6D99A03C58ED2B6E* m_cfg; // 0x2F8
