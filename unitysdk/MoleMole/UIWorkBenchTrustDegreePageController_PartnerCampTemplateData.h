...
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_PARTNERCAMPTEMPLATEDATA_GET_BADGESUBID_OFFSET UNITYSDK_OFFSET(0x14C4EF00)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_PARTNERCAMPTEMPLATEDATA_GET_BADGETYPE_OFFSET UNITYSDK_OFFSET(0x14C4EEF0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_PARTNERCAMPTEMPLATEDATA_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x14C4EEC0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_PARTNERCAMPTEMPLATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x14C4EFD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkBenchTrustDegreePageController_PartnerCampTemplateData_TypeDefinitionIndex = 39293;

	class UIWorkBenchTrustDegreePageController_PartnerCampTemplateData : public ::MoleMole::UIGeneralTabBtnWidgetController_Data_1<::Class_2_6D99A03C58ED2B6E_3*>
	{
	public:
		::System::Void _ctor()
		{
