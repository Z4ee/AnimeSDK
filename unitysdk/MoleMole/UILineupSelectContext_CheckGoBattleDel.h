...
#define MOLEMOLE_UILINEUPSELECTCONTEXT_CHECKGOBATTLEDEL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15C4A930)
#define MOLEMOLE_UILINEUPSELECTCONTEXT_CHECKGOBATTLEDEL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15C4A960)
#define MOLEMOLE_UILINEUPSELECTCONTEXT_CHECKGOBATTLEDEL_INVOKE_OFFSET UNITYSDK_OFFSET(0x15C4A3F0)
#define MOLEMOLE_UILINEUPSELECTCONTEXT_CHECKGOBATTLEDEL__CTOR_OFFSET UNITYSDK_OFFSET(0x15C4A3E0)

namespace MoleMole
{
	inline static constexpr unsigned int UILineupSelectContext_CheckGoBattleDel_TypeDefinitionIndex = 57526;
