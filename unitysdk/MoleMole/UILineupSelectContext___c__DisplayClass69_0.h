...
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS69_0__CTOR_OFFSET UNITYSDK_OFFSET(0x184BC920)
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS69_0__SETMINISCAPETASKCONTEXT_B__0_OFFSET UNITYSDK_OFFSET(0x184BC930)

namespace MoleMole
{
	inline static constexpr unsigned int UILineupSelectContext___c__DisplayClass69_0_TypeDefinitionIndex = 52594;
