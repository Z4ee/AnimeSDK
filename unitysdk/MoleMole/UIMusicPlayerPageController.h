...
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_BINDEVENT_OFFSET UNITYSDK_OFFSET(0x1575F2D0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_CHECKANDGENERATERANDOMLIST_OFFSET UNITYSDK_OFFSET(0x16643770)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_COMPUTESMOOTHENERGY_OFFSET UNITYSDK_OFFSET(0x16645020)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_CREATEGAUSSIANKERNEL_OFFSET UNITYSDK_OFFSET(0x166459E0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_DEALPAUSE_OFFSET UNITYSDK_OFFSET(0x16643EF0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_DEALRESUME_OFFSET UNITYSDK_OFFSET(0x16643890)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_DURATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x16643280)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_FADESPECTRUM_OFFSET UNITYSDK_OFFSET(0x16645640)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_GAUSSIANSMOOTH_OFFSET UNITYSDK_OFFSET(0x16645320)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_GET_CURMUSICDURATION_OFFSET UNITYSDK_OFFSET(0x1575F0D0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_GET_MUSICTIMEPERCENT_OFFSET UNITYSDK_OFFSET(0x1575F0F0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1575F0C0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_INITSPECTRUMS_OFFSET UNITYSDK_OFFSET(0x16644810)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONCLICK_OFFSET UNITYSDK_OFFSET(0x166442D0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1575F110)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONDRAGFINISHED_OFFSET UNITYSDK_OFFSET(0x15760390)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONENDEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x166431B0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONEVENTPLAYFAILED_OFFSET UNITYSDK_OFFSET(0x16643220)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x166441F0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1575F770)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONMAINBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x16641640)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONPOSTEVENTSUCCESS_OFFSET UNITYSDK_OFFSET(0x16643150)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONSLIDERPOINTERDOWNHANDLE_OFFSET UNITYSDK_OFFSET(0x157606E0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONSLIDERPOINTERUPHANDLE_OFFSET UNITYSDK_OFFSET(0x15760630)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15760790)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1575F1A0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1575FB60)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_PLAYINDEX_OFFSET UNITYSDK_OFFSET(0x16644320)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_PLAYNEXT_OFFSET UNITYSDK_OFFSET(0x16644500)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_PLAYPREV_OFFSET UNITYSDK_OFFSET(0x16644610)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_PLAYSONG_OFFSET UNITYSDK_OFFSET(0x16641760)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_REFRESHMODEDISPLAY_OFFSET UNITYSDK_OFFSET(0x166434F0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_SETDRAGGING_OFFSET UNITYSDK_OFFSET(0x1575FAD0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_SETMODE_OFFSET UNITYSDK_OFFSET(0x16643470)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_SETSPECTRUMPARAMS_OFFSET UNITYSDK_OFFSET(0x16642AF0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_SET_CURMUSICDURATION_OFFSET UNITYSDK_OFFSET(0x1575F0E0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_SHOWCURPLAYTIME_OFFSET UNITYSDK_OFFSET(0x15760A90)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_SHOWCURSPECTRUM_OFFSET UNITYSDK_OFFSET(0x15760C20)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_TOGGLELIKE_OFFSET UNITYSDK_OFFSET(0x16644710)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_TOGGLEPLAY_OFFSET UNITYSDK_OFFSET(0x16644180)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_TOGGLESPECTRUMNOISE_OFFSET UNITYSDK_OFFSET(0x16643C40)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_UPDATELIKEBTNSTATUS_OFFSET UNITYSDK_OFFSET(0x16642680)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_UPDATEPLAYDISPLAY_OFFSET UNITYSDK_OFFSET(0x166427E0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x157609C0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__BINDEVENT_B__54_0_OFFSET UNITYSDK_OFFSET(0x16645DA0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__BINDEVENT_B__54_1_OFFSET UNITYSDK_OFFSET(0x16645DB0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__BINDEVENT_B__54_2_OFFSET UNITYSDK_OFFSET(0x16645DC0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__BINDEVENT_B__54_3_OFFSET UNITYSDK_OFFSET(0x16645DD0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16645C10)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__FADESPECTRUM_B__84_0_OFFSET UNITYSDK_OFFSET(0x16645DE0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__ONUIOPEN_B__45_1_OFFSET UNITYSDK_OFFSET(0x16645CC0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__ONUIOPEN_B__45_2_OFFSET UNITYSDK_OFFSET(0x16645D70)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16645E20)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x16645EB0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x16645F40)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16645F70)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16645F80)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16645F90)

namespace MoleMole
{
	inline static constexpr unsigned int UIMusicPlayerPageController_TypeDefinitionIndex = 47386;
	...
	public:
		...
		::Class_2_79F6D62CE30E3F8E_63* _view; // 0x318
		...
		::Class_2_BF1F922B5C5C5180_Class_1_110CEE6864079A61_1* _spectrumData; // 0x368
		...
		::System::Void SetMode(::Enum_3_DB663931210BBC27_17 mode)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_DB663931210BBC27_17))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_SETMODE_OFFSET))(this, mode);
		}

		::System::Void RefreshModeDisplay(::Enum_3_DB663931210BBC27_17 mode, ::System::Boolean isOpen)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_DB663931210BBC27_17, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_REFRESHMODEDISPLAY_OFFSET))(this, mode, isOpen);
		}

		::System::Void CheckAndGenerateRandomList(::Enum_3_DB663931210BBC27_17 mode)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_DB663931210BBC27_17))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_CHECKANDGENERATERANDOMLIST_OFFSET))(this, mode);
		}
