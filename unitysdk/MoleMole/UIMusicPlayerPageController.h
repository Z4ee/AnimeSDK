...
class Class_2_BF1F922B5C5C5180_Class_1_110CEE6864079A61_4;
...
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_BINDEVENT_OFFSET UNITYSDK_OFFSET(0x14535D10)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_CHECKANDGENERATERANDOMLIST_OFFSET UNITYSDK_OFFSET(0x14536F30)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_COMPUTESMOOTHENERGY_OFFSET UNITYSDK_OFFSET(0x1453AE30)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_CREATEGAUSSIANKERNEL_OFFSET UNITYSDK_OFFSET(0x1453B800)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_DEALPAUSE_OFFSET UNITYSDK_OFFSET(0x145374B0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_DEALRESUME_OFFSET UNITYSDK_OFFSET(0x14537740)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_DURATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1453A820)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_FADESPECTRUM_OFFSET UNITYSDK_OFFSET(0x1453B450)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_GAUSSIANSMOOTH_OFFSET UNITYSDK_OFFSET(0x1453B130)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_GET_CURMUSICDURATION_OFFSET UNITYSDK_OFFSET(0x145352F0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_GET_MUSICTIMEPERCENT_OFFSET UNITYSDK_OFFSET(0x14535310)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x145352E0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_INITSPECTRUMS_OFFSET UNITYSDK_OFFSET(0x14535500)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONCLICK_OFFSET UNITYSDK_OFFSET(0x1453ABE0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14535330)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONDRAGFINISHED_OFFSET UNITYSDK_OFFSET(0x14537AF0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONENDEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1453A750)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONEVENTPLAYFAILED_OFFSET UNITYSDK_OFFSET(0x1453A7C0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x1453AB00)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x145361B0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONMAINBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x14538D60)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONPOSTEVENTSUCCESS_OFFSET UNITYSDK_OFFSET(0x1453A6F0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONSLIDERPOINTERDOWNHANDLE_OFFSET UNITYSDK_OFFSET(0x14537E40)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONSLIDERPOINTERUPHANDLE_OFFSET UNITYSDK_OFFSET(0x14537D90)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14537EF0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x145353C0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x145365A0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_PLAYINDEX_OFFSET UNITYSDK_OFFSET(0x145372D0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_PLAYNEXT_OFFSET UNITYSDK_OFFSET(0x14538380)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_PLAYPREV_OFFSET UNITYSDK_OFFSET(0x1453AC30)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_PLAYSONG_OFFSET UNITYSDK_OFFSET(0x14538E80)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_REFRESHMODEDISPLAY_OFFSET UNITYSDK_OFFSET(0x14537050)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_SETDRAGGING_OFFSET UNITYSDK_OFFSET(0x14536510)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_SETMODE_OFFSET UNITYSDK_OFFSET(0x1453AA10)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_SETSPECTRUMPARAMS_OFFSET UNITYSDK_OFFSET(0x1453A090)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_SET_CURMUSICDURATION_OFFSET UNITYSDK_OFFSET(0x14535300)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_SHOWCURPLAYTIME_OFFSET UNITYSDK_OFFSET(0x145381F0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_SHOWCURSPECTRUM_OFFSET UNITYSDK_OFFSET(0x14538490)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_TOGGLELIKE_OFFSET UNITYSDK_OFFSET(0x1453AD30)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_TOGGLEPLAY_OFFSET UNITYSDK_OFFSET(0x1453AA90)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_TOGGLESPECTRUMNOISE_OFFSET UNITYSDK_OFFSET(0x14538AB0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_UPDATELIKEBTNSTATUS_OFFSET UNITYSDK_OFFSET(0x14536DD0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_UPDATEPLAYDISPLAY_OFFSET UNITYSDK_OFFSET(0x14539D80)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x14538120)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__BINDEVENT_B__54_0_OFFSET UNITYSDK_OFFSET(0x1453BBC0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__BINDEVENT_B__54_1_OFFSET UNITYSDK_OFFSET(0x1453BBD0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__BINDEVENT_B__54_2_OFFSET UNITYSDK_OFFSET(0x1453BBE0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__BINDEVENT_B__54_3_OFFSET UNITYSDK_OFFSET(0x1453BBF0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1453BA30)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__FADESPECTRUM_B__84_0_OFFSET UNITYSDK_OFFSET(0x1453BC00)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__ONUIOPEN_B__45_1_OFFSET UNITYSDK_OFFSET(0x1453BAE0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__ONUIOPEN_B__45_2_OFFSET UNITYSDK_OFFSET(0x1453BB90)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1453BC40)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x1453BCD0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1453BD60)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1453BD90)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1453BDA0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1453BDB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMusicPlayerPageController_TypeDefinitionIndex = 74013;
	...
	public:
		...
		::Class_2_79F6D62CE30E3F8E_58* _view; // 0x310
		::System::Collections::Generic::List_1<::System::Int32>* curUnlockedIDList; // 0x318
		::System::Collections::Generic::List_1<::System::Int32>* curRamdomList; // 0x320
		::System::Int32 curPlayIndex; // 0x328
		::System::Int32 curRandomIndex; // 0x32C
		::System::Int32 curMusicId; // 0x330
		::System::Boolean isCurLike; // 0x334
		::System::Int32 curPlayGroupId; // 0x338
		::System::Boolean isBtnPlaying; // 0x33C
		::System::Boolean isRealPlaying; // 0x33D
		::System::Single _curMusicDuration; // 0x340
		::System::Single curMusicTimer; // 0x344
		::System::Single _lastShowtimer; // 0x348
		::Class_2_BF1F922B5C5C5180* _musicPlayerModel; // 0x350
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::List_1<::System::Single>*>* _initParams; // 0x358
		::Class_2_BF1F922B5C5C5180_Class_1_110CEE6864079A61_4* _spectrumData; // 0x360
		::UnityEngine::Matrix4x4 _matrix; // 0x368
		::System::Single _lerpSpeed; // 0x3A8
		::System::Collections::Generic::List_1<::DG::Tweening::Tween*>* _spectrumTweens; // 0x3B0
		::System::Boolean _isShowSpectrum; // 0x3B8
		::System::UInt32 _currentPendingId; // 0x3BC
		::System::UInt32 _currentPlayingId; // 0x3C0
		::UnityEngine::GameObject* _currentPlayingSoundEmitter; // 0x3C8
		::Foundation::Coroutine::CoroutineHandle _coroutineHandle; // 0x3D0
		::Foundation::Coroutine::CoroutineHandle _switchHandle; // 0x3D4
		::System::Boolean isLastFrameAxisInputting; // 0x3D8
		::System::Boolean isDragging; // 0x3D9
		::System::Boolean isDragStartPlaying; // 0x3DA
		::System::Int32 _lastClickIndex; // 0x3DC
		::System::Collections::Generic::List_1<::System::Single>* energyList; // 0x3E0
		::System::Collections::Generic::List_1<::System::Single>* smoothEnergy; // 0x3E8
		...
		::System::Void SetMode(::Enum_3_DB663931210BBC27_2 mode)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_DB663931210BBC27_2))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_SETMODE_OFFSET))(this, mode);
		}

		::System::Void RefreshModeDisplay(::Enum_3_DB663931210BBC27_2 mode, ::System::Boolean isOpen)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_DB663931210BBC27_2, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_REFRESHMODEDISPLAY_OFFSET))(this, mode, isOpen);
		}

		::System::Void CheckAndGenerateRandomList(::Enum_3_DB663931210BBC27_2 mode)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_DB663931210BBC27_2))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_CHECKANDGENERATERANDOMLIST_OFFSET))(this, mode);
		}
