...
#define MOLEMOLE_UIFILMGUIDEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x16782540)
#define MOLEMOLE_UIFILMGUIDEPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16782550)
#define MOLEMOLE_UIFILMGUIDEPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x167825C0)
#define MOLEMOLE_UIFILMGUIDEPAGECONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x16782DD0)
#define MOLEMOLE_UIFILMGUIDEPAGECONTROLLER_ONGETREWARDGUIDEDATARSP_OFFSET UNITYSDK_OFFSET(0x16782FA0)
#define MOLEMOLE_UIFILMGUIDEPAGECONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x16782AB0)
#define MOLEMOLE_UIFILMGUIDEPAGECONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x16782D00)
#define MOLEMOLE_UIFILMGUIDEPAGECONTROLLER_ONREWARDGUIDEDATACHANGED_OFFSET UNITYSDK_OFFSET(0x16782F00)
#define MOLEMOLE_UIFILMGUIDEPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16782970)
#define MOLEMOLE_UIFILMGUIDEPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x16782BF0)
#define MOLEMOLE_UIFILMGUIDEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16782660)
#define MOLEMOLE_UIFILMGUIDEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16782740)
#define MOLEMOLE_UIFILMGUIDEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16783040)
#define MOLEMOLE_UIFILMGUIDEPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x16783050)
#define MOLEMOLE_UIFILMGUIDEPAGECONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x167830F0)
#define MOLEMOLE_UIFILMGUIDEPAGECONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x167831A0)
#define MOLEMOLE_UIFILMGUIDEPAGECONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x16783230)
#define MOLEMOLE_UIFILMGUIDEPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x167832C0)
#define MOLEMOLE_UIFILMGUIDEPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x167832D0)
#define MOLEMOLE_UIFILMGUIDEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16783390)
#define MOLEMOLE_UIFILMGUIDEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x167833A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFilmGuidePageController_TypeDefinitionIndex = 56852;
