...
#define MOLEMOLE_TOOLKIT_RENDERERGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x11E07D80)

namespace MoleMole::ToolKit
{
	inline static constexpr unsigned int RendererGroup_TypeDefinitionIndex = 78209;
