...
#define MOLEMOLE_AFTERIMAGE_ACTIVATEAFTERIMAGE_OFFSET UNITYSDK_OFFSET(0x141D1240)
#define MOLEMOLE_AFTERIMAGE_AWAKE_OFFSET UNITYSDK_OFFSET(0x141CECE0)
#define MOLEMOLE_AFTERIMAGE_DEACTIVATEAFTERIMAGE_OFFSET UNITYSDK_OFFSET(0x141D1E50)
#define MOLEMOLE_AFTERIMAGE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x141CF5D0)
#define MOLEMOLE_AFTERIMAGE_GENERALTRANSDICT_OFFSET UNITYSDK_OFFSET(0x141CED30)
#define MOLEMOLE_AFTERIMAGE_GET_IMAGELIFETIME_OFFSET UNITYSDK_OFFSET(0x141CEC80)
#define MOLEMOLE_AFTERIMAGE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x141D0420)
#define MOLEMOLE_AFTERIMAGE_METHOD_5_0817012C9B9D8577_OFFSET UNITYSDK_OFFSET(0x141D1F50)
#define MOLEMOLE_AFTERIMAGE_METHOD_5_1D37DB4BA1163395_OFFSET UNITYSDK_OFFSET(0x141D2230)
#define MOLEMOLE_AFTERIMAGE_METHOD_5_32A907AC3D1A4D45_OFFSET UNITYSDK_OFFSET(0x141D05F0)
#define MOLEMOLE_AFTERIMAGE_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x141D0590)
#define MOLEMOLE_AFTERIMAGE_METHOD_5_96189EDEF38976A6_OFFSET UNITYSDK_OFFSET(0x141CF620)
#define MOLEMOLE_AFTERIMAGE_METHOD_5_CD28994AFE636FFF_OFFSET UNITYSDK_OFFSET(0x141D1490)
#define MOLEMOLE_AFTERIMAGE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x141CF570)
#define MOLEMOLE_AFTERIMAGE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x141CF520)
#define MOLEMOLE_AFTERIMAGE_SET_IMAGELIFETIME_OFFSET UNITYSDK_OFFSET(0x141CECD0)
#define MOLEMOLE_AFTERIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x141D1EA0)

namespace MoleMole
{
	inline static constexpr unsigned int AfterImage_TypeDefinitionIndex = 76096;
