...
#define MOLEMOLE_AFTERIMAGE_ACTIVATEAFTERIMAGE_OFFSET UNITYSDK_OFFSET(0x12797DE0)
#define MOLEMOLE_AFTERIMAGE_AWAKE_OFFSET UNITYSDK_OFFSET(0x12795870)
#define MOLEMOLE_AFTERIMAGE_DEACTIVATEAFTERIMAGE_OFFSET UNITYSDK_OFFSET(0x12798990)
#define MOLEMOLE_AFTERIMAGE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x12796150)
#define MOLEMOLE_AFTERIMAGE_GENERALTRANSDICT_OFFSET UNITYSDK_OFFSET(0x127958C0)
#define MOLEMOLE_AFTERIMAGE_GET_IMAGELIFETIME_OFFSET UNITYSDK_OFFSET(0x12795810)
#define MOLEMOLE_AFTERIMAGE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x12796FB0)
#define MOLEMOLE_AFTERIMAGE_METHOD_5_0817012C9B9D8577_OFFSET UNITYSDK_OFFSET(0x12798CF0)
#define MOLEMOLE_AFTERIMAGE_METHOD_5_1D37DB4BA1163395_OFFSET UNITYSDK_OFFSET(0x12798A90)
#define MOLEMOLE_AFTERIMAGE_METHOD_5_32A907AC3D1A4D45_OFFSET UNITYSDK_OFFSET(0x12797180)
#define MOLEMOLE_AFTERIMAGE_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x12797120)
#define MOLEMOLE_AFTERIMAGE_METHOD_5_96189EDEF38976A6_OFFSET UNITYSDK_OFFSET(0x127961A0)
#define MOLEMOLE_AFTERIMAGE_METHOD_5_CD28994AFE636FFF_OFFSET UNITYSDK_OFFSET(0x12798020)
#define MOLEMOLE_AFTERIMAGE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x127960F0)
#define MOLEMOLE_AFTERIMAGE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x127960A0)
#define MOLEMOLE_AFTERIMAGE_SET_IMAGELIFETIME_OFFSET UNITYSDK_OFFSET(0x12795860)
#define MOLEMOLE_AFTERIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x127989E0)

namespace MoleMole
{
	inline static constexpr unsigned int AfterImage_TypeDefinitionIndex = 83052;
	...
	public:
		...
		::Il2CppArray<::System::Single>* Field_5_23; // 0x80
		::System::Int32 Field_5_22; // 0x88
		::System::Int32 Field_5_21; // 0x8C
		::System::Int32 Field_5_20; // 0x90
		::Il2CppArray<::UnityEngine::Mesh*>* Field_5_27; // 0x98
		::Il2CppArray<::UnityEngine::Mesh*>* Field_5_26; // 0xA0
		::Il2CppArray<::Il2CppArray<::UnityEngine::Material*>*>* Field_5_25; // 0xA8
		::Il2CppArray<::UnityEngine::Matrix4x4>* Field_5_24; // 0xB0
		::Il2CppArray<::UnityEngine::Transform*>* Field_5_31; // 0xB8
		::Il2CppArray<::UnityEngine::Vector3>* Field_5_30; // 0xC0
		::System::Boolean Field_5_29; // 0xC8
		::UnityEngine::Color Field_5_28; // 0xCC
		::UnityEngine::MaterialPropertyBlock* Field_5_35; // 0xE0
		::Il2CppArray<::UnityEngine::Matrix4x4>* Field_5_34; // 0xE8
		::UnityEngine::Vector3 Field_5_33; // 0xF0
		::Il2CppArray<::UnityEngine::MeshFilter*>* Field_5_32; // 0x100
		::Il2CppArray<::UnityEngine::SkinnedMeshRenderer*>* Field_5_39; // 0x108
		::System::Boolean Field_5_38; // 0x110
		::System::Collections::Generic::Dictionary_2<::UnityEngine::Transform*, ::UnityEngine::Transform*>* Field_5_37; // 0x118
		::UnityEngine::Transform* Field_5_36; // 0x120
