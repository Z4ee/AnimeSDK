...
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER_DORESET_OFFSET UNITYSDK_OFFSET(0x19F92A50)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER_GET_RTIMG_OFFSET UNITYSDK_OFFSET(0x19F91B20)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19F928F0)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER_ONRESET_OFFSET UNITYSDK_OFFSET(0x19F92C70)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x19F92550)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19F92980)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19F91B50)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19F91DC0)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER_ONWIN_OFFSET UNITYSDK_OFFSET(0x19F92E60)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER_RESETVIEW_OFFSET UNITYSDK_OFFSET(0x19F92CF0)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19F930D0)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER__DORESET_B__14_0_OFFSET UNITYSDK_OFFSET(0x19F931A0)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER__ONUIINIT_B__9_0_OFFSET UNITYSDK_OFFSET(0x19F93130)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER__ONUIOPEN_B__10_0_OFFSET UNITYSDK_OFFSET(0x19F93160)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER__ONUIOPEN_B__10_1_OFFSET UNITYSDK_OFFSET(0x19F93180)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER__ONWIN_B__16_0_OFFSET UNITYSDK_OFFSET(0x19F931D0)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19F93240)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x19F932D0)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19F932E0)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19F93370)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19F93400)

namespace MoleMole
{
	inline static constexpr unsigned int UIDataFixOuterRenderWidgetController_TypeDefinitionIndex = 58413;
