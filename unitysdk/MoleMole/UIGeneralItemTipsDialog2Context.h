...
#define MOLEMOLE_UIGENERALITEMTIPSDIALOG2CONTEXT_GET_USECUSTOMITEMPACKAGETYPE_OFFSET UNITYSDK_OFFSET(0x155B3120)
#define MOLEMOLE_UIGENERALITEMTIPSDIALOG2CONTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x155B3190)
#define MOLEMOLE_UIGENERALITEMTIPSDIALOG2CONTEXT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x155B31C0)
#define MOLEMOLE_UIGENERALITEMTIPSDIALOG2CONTEXT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x155B31E0)
#define MOLEMOLE_UIGENERALITEMTIPSDIALOG2CONTEXT__CTOR_4_OFFSET UNITYSDK_OFFSET(0x155B3210)
#define MOLEMOLE_UIGENERALITEMTIPSDIALOG2CONTEXT__CTOR_5_OFFSET UNITYSDK_OFFSET(0x155B3230)
#define MOLEMOLE_UIGENERALITEMTIPSDIALOG2CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x155B3170)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralItemTipsDialog2Context_TypeDefinitionIndex = 72160;

	class UIGeneralItemTipsDialog2Context : public ::MoleMole::UIControllerContextBase
	{
	public:
		::Class_1_0D6706375CDAAE8C* itemdata; // 0x28
		::Class_0_16E4307DCC419505_27* photoItem; // 0x30
		::System::Collections::Generic::List_1<::System::Int32>* dungeonTagIds; // 0x38
		::Class_1_499EDFA3518A0E64* cafeItem; // 0x40
		::System::Action* equipStateCtrlChangeAction; // 0x48
		::System::Nullable_1<::System::Int32> overrideCount; // 0x50
		::System::Boolean checkSuibianProductState; // 0x58
		::System::Boolean disableJump; // 0x59
		::System::Nullable_1<::Share::EBattleRewardType> rewardType; // 0x5A
		::System::Int32 NeedCount; // 0x60
		::MoleMole::UIGeneralItemTipsDialog2Context_DialogType type; // 0x64
		::Enum_3_A734210DD9FF658C itemPackageType; // 0x68
		::System::Int32 spiceId; // 0x6C
		::System::Int32 ramenId; // 0x70
		...
		::System::Void _ctor_5(::Class_0_16E4307DCC419505_27* photoItem)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_27*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGENERALITEMTIPSDIALOG2CONTEXT__CTOR_5_OFFSET))(this, photoItem);
		}
