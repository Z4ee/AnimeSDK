...
#define MOLEMOLE_UIINLEVELCARDOPTIONSDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1691CC30)
#define MOLEMOLE_UIINLEVELCARDOPTIONSDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS9_0__INITINLEVELCARDOBJ_B__0_OFFSET UNITYSDK_OFFSET(0x1691CC40)
#define MOLEMOLE_UIINLEVELCARDOPTIONSDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS9_0__INITINLEVELCARDOBJ_B__1_OFFSET UNITYSDK_OFFSET(0x1691CDF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelCardOptionsDialogPopWindowController___c__DisplayClass9_0_TypeDefinitionIndex = 48277;
