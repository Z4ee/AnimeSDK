...
#define MOLEMOLE_UINEOGOLDENMECHAITEMWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x151F8320)
#define MOLEMOLE_UINEOGOLDENMECHAITEMWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x151F83F0)
#define MOLEMOLE_UINEOGOLDENMECHAITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x151F8680)
#define MOLEMOLE_UINEOGOLDENMECHAITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x151F84B0)
#define MOLEMOLE_UINEOGOLDENMECHAITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x151F8390)
#define MOLEMOLE_UINEOGOLDENMECHAITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x151F8770)
#define MOLEMOLE_UINEOGOLDENMECHAITEMWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x151F8780)
#define MOLEMOLE_UINEOGOLDENMECHAITEMWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x151F8820)
#define MOLEMOLE_UINEOGOLDENMECHAITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x151F88B0)
#define MOLEMOLE_UINEOGOLDENMECHAITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x151F8950)

namespace MoleMole
{
	inline static constexpr unsigned int UINeoGoldenMechaItemWidgetController_TypeDefinitionIndex = 56304;
