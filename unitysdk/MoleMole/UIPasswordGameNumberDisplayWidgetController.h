...
#define MOLEMOLE_UIPASSWORDGAMENUMBERDISPLAYWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1820B470)
#define MOLEMOLE_UIPASSWORDGAMENUMBERDISPLAYWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1820B500)
#define MOLEMOLE_UIPASSWORDGAMENUMBERDISPLAYWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1820B180)
#define MOLEMOLE_UIPASSWORDGAMENUMBERDISPLAYWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1820B1E0)
#define MOLEMOLE_UIPASSWORDGAMENUMBERDISPLAYWIDGETCONTROLLER_SETCONTEXT_OFFSET UNITYSDK_OFFSET(0x1820B290)
#define MOLEMOLE_UIPASSWORDGAMENUMBERDISPLAYWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1820B580)
#define MOLEMOLE_UIPASSWORDGAMENUMBERDISPLAYWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1820B5E0)
#define MOLEMOLE_UIPASSWORDGAMENUMBERDISPLAYWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1820B670)
#define MOLEMOLE_UIPASSWORDGAMENUMBERDISPLAYWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1820B700)
#define MOLEMOLE_UIPASSWORDGAMENUMBERDISPLAYWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1820B790)

namespace MoleMole
{
	inline static constexpr unsigned int UIPasswordGameNumberDisplayWidgetController_TypeDefinitionIndex = 53720;
