...
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_PARTNERCAMPTYPETEMPLATEDATA_GET_BADGESUBID_OFFSET UNITYSDK_OFFSET(0x10AEB5F0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_PARTNERCAMPTYPETEMPLATEDATA_GET_BADGETYPE_OFFSET UNITYSDK_OFFSET(0x10AEB5E0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_PARTNERCAMPTYPETEMPLATEDATA_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x10AEB550)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_PARTNERCAMPTYPETEMPLATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x10AEB6C0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_PARTNERCAMPTYPETEMPLATEDATA___BASE_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x10AEB750)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkBenchTrustDegreePageController_PartnerCampTypeTemplateData_TypeDefinitionIndex = 58039;
