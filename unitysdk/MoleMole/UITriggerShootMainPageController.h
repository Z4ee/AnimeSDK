...
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ADDREDAURAEFFECT_OFFSET UNITYSDK_OFFSET(0x19167F80)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_COUNTDOWNEND_OFFSET UNITYSDK_OFFSET(0x19167750)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_CREATEAVATARSKILLBTN_OFFSET UNITYSDK_OFFSET(0x191638E0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ENTERUISTORYMODE_OFFSET UNITYSDK_OFFSET(0x19167920)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_EXITUISTORYMODE_OFFSET UNITYSDK_OFFSET(0x191679C0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_GETBONUSTIME_OFFSET UNITYSDK_OFFSET(0x19167E30)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x19163300)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_GET_IMPORTANTPUSHMESSAGECTRL_OFFSET UNITYSDK_OFFSET(0x19163320)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_GET_MESSAGEMATCHPAGE_OFFSET UNITYSDK_OFFSET(0x19163310)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_GET_UICURSORHIDESTATE_OFFSET UNITYSDK_OFFSET(0x191632F0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x191632E0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ISBLENDINGTIMETOSCORE_OFFSET UNITYSDK_OFFSET(0x19166F70)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x19165710)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONAMMOCHANGE_OFFSET UNITYSDK_OFFSET(0x19166CB0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONBEFOREWORLDUPDATE_OFFSET UNITYSDK_OFFSET(0x19166230)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONCOMBOCHANGE_OFFSET UNITYSDK_OFFSET(0x19166FC0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19163330)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONEXITTPSMODE_OFFSET UNITYSDK_OFFSET(0x19167490)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONFREESHOOTTIME_OFFSET UNITYSDK_OFFSET(0x191669D0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x191644E0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONHITTARGET_OFFSET UNITYSDK_OFFSET(0x19166B80)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x19165BB0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x19166300)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONLOGICINLEVELCAMERAMOVE_OFFSET UNITYSDK_OFFSET(0x19165F00)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONMAGAZINESIZECHANGE_OFFSET UNITYSDK_OFFSET(0x19167400)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONPAUSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x19165C50)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONSCORECHANGE_OFFSET UNITYSDK_OFFSET(0x19166DC0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONSHOWSCOREPOPUP_OFFSET UNITYSDK_OFFSET(0x19166490)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x19163BC0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19165B30)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x191633C0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONWAVEEND_OFFSET UNITYSDK_OFFSET(0x19167CB0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONWAVESTART_OFFSET UNITYSDK_OFFSET(0x19167A60)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONZOOMIN_OFFSET UNITYSDK_OFFSET(0x191674E0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONZOOMOUT_OFFSET UNITYSDK_OFFSET(0x19167580)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_PREPAREGAMESTART_OFFSET UNITYSDK_OFFSET(0x191677A0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_SETRANK_OFFSET UNITYSDK_OFFSET(0x19164200)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x19165AA0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_SHOWMONSTERWAVEFAIRY_OFFSET UNITYSDK_OFFSET(0x19167B30)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x19167620)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_STARTTIMETOSCOREBLEND_OFFSET UNITYSDK_OFFSET(0x19167D10)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_TRIGGERLEVELGAMEREALSTART_OFFSET UNITYSDK_OFFSET(0x19164AD0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_UPDATETIMELEFTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x19165180)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_UPDATETIMETOSCOREBLEND_OFFSET UNITYSDK_OFFSET(0x19164B90)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x191645B0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_WAITCOROUTINE_OFFSET UNITYSDK_OFFSET(0x19167360)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19168120)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER__ONUIINIT_B__42_0_OFFSET UNITYSDK_OFFSET(0x19168200)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19168210)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x191682A0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x19168330)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x19168360)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x191683F0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19168400)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19168410)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x19168420)

namespace MoleMole
{
	inline static constexpr unsigned int UITriggerShootMainPageController_TypeDefinitionIndex = 66035;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_133* _view; // 0x318
