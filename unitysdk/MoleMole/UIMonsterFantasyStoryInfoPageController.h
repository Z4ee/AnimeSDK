...
#define MOLEMOLE_UIMONSTERFANTASYSTORYINFOPAGECONTROLLER_GET_IGNOREFADING_OFFSET UNITYSDK_OFFSET(0x1745F9A0)
#define MOLEMOLE_UIMONSTERFANTASYSTORYINFOPAGECONTROLLER_GET_ISENABLEFADEINPUTBLOCKING_OFFSET UNITYSDK_OFFSET(0x1745F990)
#define MOLEMOLE_UIMONSTERFANTASYSTORYINFOPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1745F910)
#define MOLEMOLE_UIMONSTERFANTASYSTORYINFOPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1745F920)
#define MOLEMOLE_UIMONSTERFANTASYSTORYINFOPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1745F9B0)
#define MOLEMOLE_UIMONSTERFANTASYSTORYINFOPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17460420)
#define MOLEMOLE_UIMONSTERFANTASYSTORYINFOPAGECONTROLLER_ONSTARTBTNCLICK_OFFSET UNITYSDK_OFFSET(0x174604E0)
#define MOLEMOLE_UIMONSTERFANTASYSTORYINFOPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17460480)
#define MOLEMOLE_UIMONSTERFANTASYSTORYINFOPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1745FA70)
#define MOLEMOLE_UIMONSTERFANTASYSTORYINFOPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1745FCA0)
#define MOLEMOLE_UIMONSTERFANTASYSTORYINFOPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17460780)
#define MOLEMOLE_UIMONSTERFANTASYSTORYINFOPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17460790)
#define MOLEMOLE_UIMONSTERFANTASYSTORYINFOPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17460830)
#define MOLEMOLE_UIMONSTERFANTASYSTORYINFOPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x17460840)
#define MOLEMOLE_UIMONSTERFANTASYSTORYINFOPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17460900)
#define MOLEMOLE_UIMONSTERFANTASYSTORYINFOPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17460910)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyStoryInfoPageController_TypeDefinitionIndex = 46620;
	...
	public:
		...
		::Class_2_C5DE6003F1E437A7* get__viewModel()
		{
			return ((::Class_2_C5DE6003F1E437A7*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMONSTERFANTASYSTORYINFOPAGECONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
