...
#define MOLEMOLE_UIHOLLOWACHIEVEMENTCARDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14B40ED0)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTCARDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14B40F60)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTCARDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14B40DC0)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTCARDWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x14B40FE0)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTCARDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14B41430)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTCARDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x14B41490)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTCARDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x14B41520)
#define MOLEMOLE_UIHOLLOWACHIEVEMENTCARDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14B415B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowAchievementCardWidgetController_TypeDefinitionIndex = 54724;

	class UIHollowAchievementCardWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_C39030A6227D9C3E* _view; // 0x2B8
		::System::Collections::Generic::List_1<::Class_1_0D6706375CDAAE8C*>* cardList; // 0x2C0
		::System::Boolean isInHollow; // 0x2C8
