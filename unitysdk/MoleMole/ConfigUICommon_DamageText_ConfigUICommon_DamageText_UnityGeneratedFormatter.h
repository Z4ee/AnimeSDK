...
#define MOLEMOLE_CONFIGUICOMMON_DAMAGETEXT_CONFIGUICOMMON_DAMAGETEXT_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x157D7A30)
#define MOLEMOLE_CONFIGUICOMMON_DAMAGETEXT_CONFIGUICOMMON_DAMAGETEXT_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x157D7A40)
#define MOLEMOLE_CONFIGUICOMMON_DAMAGETEXT_CONFIGUICOMMON_DAMAGETEXT_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x157D8240)
#define MOLEMOLE_CONFIGUICOMMON_DAMAGETEXT_CONFIGUICOMMON_DAMAGETEXT_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x157D8710)
#define MOLEMOLE_CONFIGUICOMMON_DAMAGETEXT_CONFIGUICOMMON_DAMAGETEXT_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x157D86D0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUICommon_DamageText_ConfigUICommon_DamageText_UnityGeneratedFormatter_TypeDefinitionIndex = 55544;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::MoleMole::Config::SpecialDamageTextType, ::System::Single>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigUICommon_DamageText_ConfigUICommon_DamageText_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3C3A0);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::MoleMole::Config::SpecialDamageTextType, ::System::String*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigUICommon_DamageText_ConfigUICommon_DamageText_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3C3A8);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::MoleMole::Config::DamageElementType, ::System::String*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigUICommon_DamageText_ConfigUICommon_DamageText_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3C3B0);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::MoleMole::Config::SpecialDamageTextType, ::Foundation::AssetPath>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigUICommon_DamageText_ConfigUICommon_DamageText_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3C3B8);
		}
