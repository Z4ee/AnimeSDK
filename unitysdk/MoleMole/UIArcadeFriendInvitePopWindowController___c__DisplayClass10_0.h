...
#define MOLEMOLE_UIARCADEFRIENDINVITEPOPWINDOWCONTROLLER___C__DISPLAYCLASS10_0__CTOR_OFFSET UNITYSDK_OFFSET(0x175997E0)
#define MOLEMOLE_UIARCADEFRIENDINVITEPOPWINDOWCONTROLLER___C__DISPLAYCLASS10_0__ONCIRCLETABCLICK_B__0_OFFSET UNITYSDK_OFFSET(0x175997F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeFriendInvitePopWindowController___c__DisplayClass10_0_TypeDefinitionIndex = 52885;
