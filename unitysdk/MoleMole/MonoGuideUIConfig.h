...
#define MOLEMOLE_MONOGUIDEUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1686FCD0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGuideUIConfig_TypeDefinitionIndex = 49435;
