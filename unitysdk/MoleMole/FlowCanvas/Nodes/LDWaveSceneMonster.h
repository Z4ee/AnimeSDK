...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_BEGIN_OFFSET UNITYSDK_OFFSET(0x1369C4D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_COLLECTMONSTERCREATEDATA_OFFSET UNITYSDK_OFFSET(0x1369C2C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x1369C670)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_GENERATECREATEDATA_OFFSET UNITYSDK_OFFSET(0x1369BB80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_GENERATEMONSTERCREATDATA_OFFSET UNITYSDK_OFFSET(0x1369C3D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x1369C570)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x1369C5D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_GETCURRENTMONSTERIDTYPE_OFFSET UNITYSDK_OFFSET(0x1369CCB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1369D050)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_ONRESET_OFFSET UNITYSDK_OFFSET(0x1369CD00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1369B800)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x1369C9E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1369D2E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER__REGISTERPORTS_B__8_0_OFFSET UNITYSDK_OFFSET(0x1369D2F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER__REGISTERPORTS_B__8_1_OFFSET UNITYSDK_OFFSET(0x1369D3B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER__REGISTERPORTS_B__8_2_OFFSET UNITYSDK_OFFSET(0x1369D4D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER__REGISTERPORTS_B__8_3_OFFSET UNITYSDK_OFFSET(0x1369D500)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER__REGISTERPORTS_B__8_4_OFFSET UNITYSDK_OFFSET(0x1369D510)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER__REGISTERPORTS_B__8_5_OFFSET UNITYSDK_OFFSET(0x1369D520)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_BEGIN_OFFSET UNITYSDK_OFFSET(0x1369D530)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x1369D560)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x1369D570)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x1369D580)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_GETCURRENTMONSTERIDTYPE_OFFSET UNITYSDK_OFFSET(0x1369D590)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1369D5A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1369D5B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1369D5C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x1369D5D0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveSceneMonster_TypeDefinitionIndex = 63162;
	...
	public:
		...
		::System::Collections::Generic::List_1<::MoleMole::Config::CampType>* monsterCampList; // 0x1B8
		::System::Collections::Generic::List_1<::MoleMole::FlowCanvas::Nodes::MonsterCreateData*>* monsterList; // 0x1C0
		::FlowCanvas::ValueInput_1<::System::Collections::Generic::List_1<::MoleMole::FlowCanvas::Nodes::SceneMonsterCreateData*>*>* createSceneMonsterInputList; // 0x1C8
		::System::String* lastGenerateDataStage; // 0x1D0
		::System::Boolean alreadyHasCreateData; // 0x1D8
		::System::Boolean preLoadGenerateMonsterData; // 0x1D9
