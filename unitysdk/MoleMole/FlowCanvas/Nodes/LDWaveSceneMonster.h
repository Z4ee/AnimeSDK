...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_BEGIN_OFFSET UNITYSDK_OFFSET(0x1232D6E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_COLLECTMONSTERCREATEDATA_OFFSET UNITYSDK_OFFSET(0x1232D4D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x1232D880)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_GENERATECREATEDATA_OFFSET UNITYSDK_OFFSET(0x1232CD80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_GENERATEMONSTERCREATDATA_OFFSET UNITYSDK_OFFSET(0x1232D5E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x1232D780)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x1232D7E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_GETCURRENTMONSTERIDTYPE_OFFSET UNITYSDK_OFFSET(0x1232DEC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1232E270)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_ONRESET_OFFSET UNITYSDK_OFFSET(0x1232DF10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1232CA00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x1232DBF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1232E510)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER__REGISTERPORTS_B__8_0_OFFSET UNITYSDK_OFFSET(0x1232E520)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER__REGISTERPORTS_B__8_1_OFFSET UNITYSDK_OFFSET(0x1232E5E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER__REGISTERPORTS_B__8_2_OFFSET UNITYSDK_OFFSET(0x1232E700)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER__REGISTERPORTS_B__8_3_OFFSET UNITYSDK_OFFSET(0x1232E730)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER__REGISTERPORTS_B__8_4_OFFSET UNITYSDK_OFFSET(0x1232E740)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER__REGISTERPORTS_B__8_5_OFFSET UNITYSDK_OFFSET(0x1232E750)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_BEGIN_OFFSET UNITYSDK_OFFSET(0x1232E760)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x1232E790)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x1232E7A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x1232E7B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_GETCURRENTMONSTERIDTYPE_OFFSET UNITYSDK_OFFSET(0x1232E7C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1232E7D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1232E7E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1232E7F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x1232E800)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveSceneMonster_TypeDefinitionIndex = 63199;
	...
	public:
		...
		::System::Collections::Generic::List_1<::MoleMole::Config::CampType>* monsterCampList; // 0x1C0
		::System::String* lastGenerateDataStage; // 0x1C8
