...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOMBATPAUSEGETISNEWBIEREQUIRED_INVOKE_OFFSET UNITYSDK_OFFSET(0x171017A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOMBATPAUSEGETISNEWBIEREQUIRED__CTOR_OFFSET UNITYSDK_OFFSET(0x171017E0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCombatPauseGetIsNewbieRequired_TypeDefinitionIndex = 81566;
