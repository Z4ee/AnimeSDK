...
#define MOLEMOLE_FLOWCANVAS_NODES_CUSTOMGETRANDOMMONSTERLABNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x14989460)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int CustomGetRandomMonsterLabNode_TypeDefinitionIndex = 52046;
