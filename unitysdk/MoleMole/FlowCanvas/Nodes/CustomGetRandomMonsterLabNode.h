...
#define MOLEMOLE_FLOWCANVAS_NODES_CUSTOMGETRANDOMMONSTERLABNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B52C7A0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int CustomGetRandomMonsterLabNode_TypeDefinitionIndex = 65004;
