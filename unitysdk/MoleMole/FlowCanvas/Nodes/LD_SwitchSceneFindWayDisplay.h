...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SWITCHSCENEFINDWAYDISPLAY_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x168522B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SWITCHSCENEFINDWAYDISPLAY_START_INTERACT_OFFSET UNITYSDK_OFFSET(0x168523E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SWITCHSCENEFINDWAYDISPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x168527B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SWITCHSCENEFINDWAYDISPLAY__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x168527F0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_SwitchSceneFindWayDisplay_TypeDefinitionIndex = 89636;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::System::Int32>* wayID; // 0xB0
		::FlowCanvas::ValueInput_1<::System::Boolean>* isOpen; // 0xB8
