...
#define MOLEMOLE_FLOWCANVAS_NODES_LDMPSETTLE__SETTLECOROUTINE_D__6_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x17E6FAE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMPSETTLE__SETTLECOROUTINE_D__6_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x17E6FCF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMPSETTLE__SETTLECOROUTINE_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x17E6FD50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMPSETTLE__SETTLECOROUTINE_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x17E6FD00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMPSETTLE__SETTLECOROUTINE_D__6_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17E6FAD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMPSETTLE__SETTLECOROUTINE_D__6__CTOR_OFFSET UNITYSDK_OFFSET(0x17E6FAC0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDMpSettle__SettleCoroutine_d__6_TypeDefinitionIndex = 60584;
