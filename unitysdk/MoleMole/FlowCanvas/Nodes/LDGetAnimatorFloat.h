...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETANIMATORFLOAT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1B19E1C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETANIMATORFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B19E2C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETANIMATORFLOAT__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x1B19E300)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetAnimatorFloat_TypeDefinitionIndex = 89518;
