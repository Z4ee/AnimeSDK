...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_HENSHINBUDDY_RECOVERENTITY_OFFSET UNITYSDK_OFFSET(0x1261AA40)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_HENSHINBUDDY_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1261A5A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_HENSHINBUDDY_START_INTERACT_OFFSET UNITYSDK_OFFSET(0x1261A710)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_HENSHINBUDDY__CTOR_OFFSET UNITYSDK_OFFSET(0x1261ABE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_HENSHINBUDDY__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x1261AC20)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_HENSHINBUDDY__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0x1261AC90)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_HenshinBuddy_TypeDefinitionIndex = 74961;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::System::Boolean>* hideOriBuddy; // 0xB8
