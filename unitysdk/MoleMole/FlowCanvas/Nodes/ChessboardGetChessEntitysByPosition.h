...
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDGETCHESSENTITYSBYPOSITION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1923DFD0)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDGETCHESSENTITYSBYPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1923E0F0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ChessboardGetChessEntitysByPosition_TypeDefinitionIndex = 85491;
