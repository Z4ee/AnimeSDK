...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESURFITEM__CREATEITEMCO_D__16_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x118BE150)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESURFITEM__CREATEITEMCO_D__16_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x118BE6C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESURFITEM__CREATEITEMCO_D__16_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x118BE720)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESURFITEM__CREATEITEMCO_D__16_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x118BE6D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESURFITEM__CREATEITEMCO_D__16_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x118BE140)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESURFITEM__CREATEITEMCO_D__16__CTOR_OFFSET UNITYSDK_OFFSET(0x118BE130)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveSurfItem__CreateItemCo_d__16_TypeDefinitionIndex = 75879;
