...
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDADDEXTRAUNIT_INVOKE_OFFSET UNITYSDK_OFFSET(0x182DC580)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDADDEXTRAUNIT_ISAPPENDTARGET_OFFSET UNITYSDK_OFFSET(0x182DCAC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDADDEXTRAUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x182DCBE0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDTurnBasedAddExtraUnit_TypeDefinitionIndex = 87506;
