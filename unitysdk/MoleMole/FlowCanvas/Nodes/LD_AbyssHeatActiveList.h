...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSHEATACTIVELIST_INVOKE_OFFSET UNITYSDK_OFFSET(0x10BB4E30)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSHEATACTIVELIST__CTOR_OFFSET UNITYSDK_OFFSET(0x10BB50B0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssHeatActiveList_TypeDefinitionIndex = 72627;
