...
#define MOLEMOLE_FLOWCANVAS_NODES_TRAPCREATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x168532B0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int TrapCreateData_TypeDefinitionIndex = 52104;
