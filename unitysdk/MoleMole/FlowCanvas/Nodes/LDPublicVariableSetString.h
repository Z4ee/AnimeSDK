...
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLESETSTRING_DOSET_OFFSET UNITYSDK_OFFSET(0x14996940)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLESETSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x14996B30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLESETSTRING___BASE_DOSET_OFFSET UNITYSDK_OFFSET(0x14996B80)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDPublicVariableSetString_TypeDefinitionIndex = 42039;
