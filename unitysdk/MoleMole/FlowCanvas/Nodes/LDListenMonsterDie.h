...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERDIE_ONMONSTERDIE_OFFSET UNITYSDK_OFFSET(0x1160D470)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERDIE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1160D1E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERDIE__CTOR_OFFSET UNITYSDK_OFFSET(0x1160DC00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERDIE__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0x1160DC40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERDIE__REGISTERPORTS_B__1_1_OFFSET UNITYSDK_OFFSET(0x1160DDA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERDIE__REGISTERPORTS_B__1_2_OFFSET UNITYSDK_OFFSET(0x1160DE90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERDIE___BASE_ONMONSTERDIE_OFFSET UNITYSDK_OFFSET(0x1160DEA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERDIE___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1160DEB0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDListenMonsterDie_TypeDefinitionIndex = 42202;
