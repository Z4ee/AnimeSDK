...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETALLLOCALAVATARNODE_GETLOCALAVATARLIST_OFFSET UNITYSDK_OFFSET(0x16B7C020)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETALLLOCALAVATARNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x16B7C270)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETALLLOCALAVATARNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x16B7C320)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetAllLocalAvatarNode_TypeDefinitionIndex = 52183;
