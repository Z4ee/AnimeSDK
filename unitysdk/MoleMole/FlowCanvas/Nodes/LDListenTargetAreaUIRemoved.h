...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED_BEGIN_OFFSET UNITYSDK_OFFSET(0x1A0467F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED_DESTROYTARGETAREAUI_OFFSET UNITYSDK_OFFSET(0x1A046BB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED_ONEVENT_OFFSET UNITYSDK_OFFSET(0x1A0474D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED_ONFCSTARTQUICKEXECMODE_OFFSET UNITYSDK_OFFSET(0x1A047660)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A047420)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A047480)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A0466E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED_REMOVELISTEN_OFFSET UNITYSDK_OFFSET(0x1A046DE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED_STARTLISTEN_OFFSET UNITYSDK_OFFSET(0x1A047100)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0477F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED__REGISTERPORTS_B__7_0_OFFSET UNITYSDK_OFFSET(0x1A047970)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A0479A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A0479B0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDListenTargetAreaUIRemoved_TypeDefinitionIndex = 48425;

	class LDListenTargetAreaUIRemoved : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::String*>* targetUIInput; // 0xA8
		::System::Collections::Generic::HashSet_1<::System::String*>* listenedTarget; // 0xB0
		::FlowCanvas::FlowOutput* conditionReachedOutput; // 0xB8
