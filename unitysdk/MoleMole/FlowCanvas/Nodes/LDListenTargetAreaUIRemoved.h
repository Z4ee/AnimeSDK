...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED_BEGIN_OFFSET UNITYSDK_OFFSET(0x130049F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED_DESTROYTARGETAREAUI_OFFSET UNITYSDK_OFFSET(0x13004DB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED_ONEVENT_OFFSET UNITYSDK_OFFSET(0x130056E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED_ONFCSTARTQUICKEXECMODE_OFFSET UNITYSDK_OFFSET(0x13005870)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x13005630)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x13005690)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x130048E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED_REMOVELISTEN_OFFSET UNITYSDK_OFFSET(0x13004FE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED_STARTLISTEN_OFFSET UNITYSDK_OFFSET(0x13005300)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED__CTOR_OFFSET UNITYSDK_OFFSET(0x13005A00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED__REGISTERPORTS_B__7_0_OFFSET UNITYSDK_OFFSET(0x13005B80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x13005BB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x13005BC0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDListenTargetAreaUIRemoved_TypeDefinitionIndex = 65215;

	class LDListenTargetAreaUIRemoved : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::FlowOutput* output; // 0xA8
		::FlowCanvas::ValueInput_1<::System::String*>* targetUIInput; // 0xB0
		::System::Collections::Generic::List_1<::System::String*>* quickRemoveTargetList; // 0xB8
		::System::Collections::Generic::HashSet_1<::System::String*>* listenedTarget; // 0xC0
