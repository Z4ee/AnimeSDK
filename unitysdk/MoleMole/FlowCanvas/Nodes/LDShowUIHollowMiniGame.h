...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_CACHEAUDIOSTATE_OFFSET UNITYSDK_OFFSET(0x13695C50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_CLOSEBIGTVMINIGAME_OFFSET UNITYSDK_OFFSET(0x13697390)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_ENTERBIGTV_OFFSET UNITYSDK_OFFSET(0x13696070)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_HANDLELEVELTIMER_OFFSET UNITYSDK_OFFSET(0x13696CB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_ONENTERSCENE_OFFSET UNITYSDK_OFFSET(0x13696E30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_ONHOLLOWCHANGECHESSBOARD_OFFSET UNITYSDK_OFFSET(0x13695DD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x13695540)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_RESTOREAUDIOSTATE_OFFSET UNITYSDK_OFFSET(0x13697660)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_SHOWBIGTVMINIGAME_OFFSET UNITYSDK_OFFSET(0x136968D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_SHOWHOLLOWMINIGAME_OFFSET UNITYSDK_OFFSET(0x136956D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_STARTPUSHBOX_OFFSET UNITYSDK_OFFSET(0x136960E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_STOPPUSHBOX_OFFSET UNITYSDK_OFFSET(0x13697480)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x13697830)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME__REGISTERPORTS_B__11_0_OFFSET UNITYSDK_OFFSET(0x13697870)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDShowUIHollowMiniGame_TypeDefinitionIndex = 59615;

	class LDShowUIHollowMiniGame : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::Int32>* _gameIDInput; // 0xA8
		::FlowCanvas::ValueInput_1<::System::Boolean>* _skipFadeOutOnFail; // 0xB0
		::FlowCanvas::ValueInput_1<::System::Boolean>* _pauseLevelTimer; // 0xB8
		::FlowCanvas::FlowOutput* _flowOutput; // 0xC0
		::MoleMole::UIHollowMiniGamePopWindowController* _miniGamePopWindow; // 0xC8
		::MoleMole::UIHollowPushBoxGame3DModelController* _pushBox3DCtrl; // 0xD0
		::FlowCanvas::FlowOutput* _flowOnFinish; // 0xD8
		::UnityEngine::RenderTexture* _miniGameRT; // 0xE0
		::System::String* _cachedAudioGameStateValue; // 0xE8
