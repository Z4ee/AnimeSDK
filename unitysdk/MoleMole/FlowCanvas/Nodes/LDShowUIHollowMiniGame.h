...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_CACHEAUDIOSTATE_OFFSET UNITYSDK_OFFSET(0x13ED1E40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_CLOSEBIGTVMINIGAME_OFFSET UNITYSDK_OFFSET(0x13ED19A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_ENTERBIGTV_OFFSET UNITYSDK_OFFSET(0x13ED06A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_HANDLELEVELTIMER_OFFSET UNITYSDK_OFFSET(0x13ED12D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_ONENTERSCENE_OFFSET UNITYSDK_OFFSET(0x13ED1450)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_ONHOLLOWCHANGECHESSBOARD_OFFSET UNITYSDK_OFFSET(0x1A39D7F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A39D0F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_RESTOREAUDIOSTATE_OFFSET UNITYSDK_OFFSET(0x13ED1C70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_SHOWBIGTVMINIGAME_OFFSET UNITYSDK_OFFSET(0x13ED0EF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_SHOWHOLLOWMINIGAME_OFFSET UNITYSDK_OFFSET(0x1A39D280)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_STARTPUSHBOX_OFFSET UNITYSDK_OFFSET(0x13ED0710)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_STOPPUSHBOX_OFFSET UNITYSDK_OFFSET(0x13ED1A90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x13ED1FC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME__REGISTERPORTS_B__11_0_OFFSET UNITYSDK_OFFSET(0x13ED2000)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDShowUIHollowMiniGame_TypeDefinitionIndex = 67220;
	...
	public:
		...
		::MoleMole::UIHollowPushBoxGame3DModelController* _pushBox3DCtrl; // 0xB0
		::System::String* _cachedAudioGameStateValue; // 0xB8
		::FlowCanvas::FlowOutput* _flowOutput; // 0xC0
		::FlowCanvas::ValueInput_1<::System::Int32>* _gameIDInput; // 0xC8
		::MoleMole::UIHollowMiniGamePopWindowController* _miniGamePopWindow; // 0xD0
		::FlowCanvas::ValueInput_1<::System::Boolean>* _skipFadeOutOnFail; // 0xD8
		::UnityEngine::RenderTexture* _miniGameRT; // 0xE0
		::FlowCanvas::FlowOutput* _flowOnFinish; // 0xE8
		::System::Boolean _levelTimerPausedByThis; // 0xF0
		::System::Boolean _isPlayerSucceeded; // 0xF1
