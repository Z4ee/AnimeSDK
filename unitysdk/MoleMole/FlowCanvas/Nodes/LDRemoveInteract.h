...
#define MOLEMOLE_FLOWCANVAS_NODES_LDREMOVEINTERACT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x17E70330)
#define MOLEMOLE_FLOWCANVAS_NODES_LDREMOVEINTERACT_STARTREMOVE_OFFSET UNITYSDK_OFFSET(0x17E70460)
#define MOLEMOLE_FLOWCANVAS_NODES_LDREMOVEINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x17E70B20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDREMOVEINTERACT__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x17E70B60)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDRemoveInteract_TypeDefinitionIndex = 71875;
