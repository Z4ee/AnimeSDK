...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_GETAREARANDOMNOWITHJUMP_INVOKE_OFFSET UNITYSDK_OFFSET(0x10BB6250)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_GETAREARANDOMNOWITHJUMP__CTOR_OFFSET UNITYSDK_OFFSET(0x10BB6600)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_GetAreaRandomNoWithJump_TypeDefinitionIndex = 40540;
