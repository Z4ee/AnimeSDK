...
#define MOLEMOLE_FLOWCANVAS_NODES_LDMECHBOOGETCURSCRIPTCONFIG_INVOKE_OFFSET UNITYSDK_OFFSET(0x170C76C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMECHBOOGETCURSCRIPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x170C7730)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDMechBooGetCurScriptConfig_TypeDefinitionIndex = 62064;
