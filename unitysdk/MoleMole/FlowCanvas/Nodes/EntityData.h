...
#define MOLEMOLE_FLOWCANVAS_NODES_ENTITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x12FFF8F0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int EntityData_TypeDefinitionIndex = 87065;
