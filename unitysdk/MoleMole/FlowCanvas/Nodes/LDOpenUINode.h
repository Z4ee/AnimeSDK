...
#define MOLEMOLE_FLOWCANVAS_NODES_LDOPENUINODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x136934D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDOPENUINODE__CTOR_OFFSET UNITYSDK_OFFSET(0x136935A0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDOpenUINode_TypeDefinitionIndex = 47488;
