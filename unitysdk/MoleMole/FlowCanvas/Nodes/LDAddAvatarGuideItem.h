...
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDAVATARGUIDEITEM_INVOKE_OFFSET UNITYSDK_OFFSET(0x19BD9DE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDAVATARGUIDEITEM_TRYADDAVATARGUIDEITEM_OFFSET UNITYSDK_OFFSET(0x19BD9E30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDAVATARGUIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x19BDA210)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDAddAvatarGuideItem_TypeDefinitionIndex = 77142;
