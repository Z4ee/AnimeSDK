...
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDAVATARGUIDEITEM_INVOKE_OFFSET UNITYSDK_OFFSET(0x16B79450)
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDAVATARGUIDEITEM_TRYADDAVATARGUIDEITEM_OFFSET UNITYSDK_OFFSET(0x16B794A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDAVATARGUIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x16B79880)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDAddAvatarGuideItem_TypeDefinitionIndex = 70087;
