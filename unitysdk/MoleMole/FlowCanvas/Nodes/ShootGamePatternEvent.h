...
#define MOLEMOLE_FLOWCANVAS_NODES_SHOOTGAMEPATTERNEVENT_ONRECEIVEEVENT_OFFSET UNITYSDK_OFFSET(0x1A061120)
#define MOLEMOLE_FLOWCANVAS_NODES_SHOOTGAMEPATTERNEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A060D80)
#define MOLEMOLE_FLOWCANVAS_NODES_SHOOTGAMEPATTERNEVENT_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1A060EE0)
#define MOLEMOLE_FLOWCANVAS_NODES_SHOOTGAMEPATTERNEVENT_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1A061000)
#define MOLEMOLE_FLOWCANVAS_NODES_SHOOTGAMEPATTERNEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0613F0)
#define MOLEMOLE_FLOWCANVAS_NODES_SHOOTGAMEPATTERNEVENT__REGISTERPORTS_B__6_0_OFFSET UNITYSDK_OFFSET(0x1A061440)
#define MOLEMOLE_FLOWCANVAS_NODES_SHOOTGAMEPATTERNEVENT__REGISTERPORTS_B__6_1_OFFSET UNITYSDK_OFFSET(0x1A061450)
#define MOLEMOLE_FLOWCANVAS_NODES_SHOOTGAMEPATTERNEVENT__REGISTERPORTS_B__6_2_OFFSET UNITYSDK_OFFSET(0x1A061460)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ShootGamePatternEvent_TypeDefinitionIndex = 84708;

	class ShootGamePatternEvent : public ::FlowCanvas::Nodes::RouterEventNode_1<::NodeCanvas::Framework::GraphOwner*>
	{
	public:
		::System::String* _beatmapName; // 0xC0
		::System::String* _output; // 0xC8
		::FlowCanvas::FlowOutput* _onReceived; // 0xD0
