...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYNODE_GETENTITY_OFFSET UNITYSDK_OFFSET(0x118B50D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x118B5240)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x118B5320)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYNODE__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x118B5360)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetEntityNode_TypeDefinitionIndex = 76132;
