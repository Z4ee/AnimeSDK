...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_CREATELEVELZEROSPECIALCAMERA_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A02EB10)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_CREATELEVELZEROSPECIALCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A02EC60)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_CREATELEVELZEROSPECIALCAMERA__REGISTERPORTS_B__9_0_OFFSET UNITYSDK_OFFSET(0x1A02ECC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_CREATELEVELZEROSPECIALCAMERA__REGISTERPORTS_B__9_1_OFFSET UNITYSDK_OFFSET(0x1A02ECD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_CREATELEVELZEROSPECIALCAMERA__REGISTERPORTS_G____CLOSECAMERA_9_2_OFFSET UNITYSDK_OFFSET(0x1A02F720)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_CreateLevelZeroSpecialCamera_TypeDefinitionIndex = 50149;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::System::Boolean>* isRT; // 0xB0
		::FlowCanvas::ValueInput_1<::System::String*>* spawnPoint; // 0xB8
		::FlowCanvas::ValueInput_1<::UnityEngine::Vector3>* extraOffset; // 0xC0
		::FlowCanvas::FlowOutput* _output; // 0xC8
		::UnityEngine::RenderTexture* createdTempRT; // 0xD0
		::System::Single rtDuration; // 0xD8
		::System::Boolean copyFromMainCamera; // 0xDC
		::System::Single screenScale; // 0xE0
