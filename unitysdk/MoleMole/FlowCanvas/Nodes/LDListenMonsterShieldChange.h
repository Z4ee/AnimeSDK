...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERSHIELDCHANGE_ADDLISTENHPABILITY_OFFSET UNITYSDK_OFFSET(0x170C68E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERSHIELDCHANGE_BINDEVENT_OFFSET UNITYSDK_OFFSET(0x170C6A40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERSHIELDCHANGE_ENTITYONREADY_OFFSET UNITYSDK_OFFSET(0x170C6830)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERSHIELDCHANGE_ONEVENT_OFFSET UNITYSDK_OFFSET(0x170C72B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERSHIELDCHANGE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x170C6E40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERSHIELDCHANGE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x170C6EA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERSHIELDCHANGE_ONPROPVALUECHANGE_OFFSET UNITYSDK_OFFSET(0x170C6EF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERSHIELDCHANGE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x170C6470)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERSHIELDCHANGE_START_OFFSET UNITYSDK_OFFSET(0x170C6610)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERSHIELDCHANGE_UNBINDEVENT_OFFSET UNITYSDK_OFFSET(0x170C6C40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERSHIELDCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x170C7610)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERSHIELDCHANGE__REGISTERPORTS_B__8_0_OFFSET UNITYSDK_OFFSET(0x170C7650)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERSHIELDCHANGE___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x170C76A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERSHIELDCHANGE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x170C76B0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDListenMonsterShieldChange_TypeDefinitionIndex = 51333;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::System::Single>* highToValuePercnetInput; // 0xB8
		::FlowCanvas::FlowOutput* onHighToValueOutPut; // 0xC0
		::FlowCanvas::ValueInput_1<::System::Single>* lowToValuePercentInput; // 0xC8
