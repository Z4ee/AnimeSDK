...
#define MOLEMOLE_FLOWCANVAS_NODES_LDMUTELOCK_INVOKE_OFFSET UNITYSDK_OFFSET(0x15114C10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMUTELOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x15115160)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDMuteLock_TypeDefinitionIndex = 71870;
