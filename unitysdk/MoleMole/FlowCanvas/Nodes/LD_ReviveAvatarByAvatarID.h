...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_REVIVEAVATARBYAVATARID_INVOKE_OFFSET UNITYSDK_OFFSET(0x161ED190)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_REVIVEAVATARBYAVATARID__CTOR_OFFSET UNITYSDK_OFFSET(0x161ED300)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_ReviveAvatarByAvatarID_TypeDefinitionIndex = 55442;
