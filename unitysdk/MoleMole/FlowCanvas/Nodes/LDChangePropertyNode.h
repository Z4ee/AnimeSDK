...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGEPROPERTYNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1173B1D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGEPROPERTYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1173B340)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDChangePropertyNode_TypeDefinitionIndex = 54642;
