...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_HASCHALLENGE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x16048410)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_HASCHALLENGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16048650)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_HASCHALLENGE__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x16048690)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_HasChallenge_TypeDefinitionIndex = 61653;
