...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_WAIT_GET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x16CABD70)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_WAIT_GET_TIMELEFT_OFFSET UNITYSDK_OFFSET(0x16CABD50)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_WAIT_INVOKE_OFFSET UNITYSDK_OFFSET(0x16CABD90)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_WAIT_ONREGISTEREXTRAPORTS_OFFSET UNITYSDK_OFFSET(0x16CABE20)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_WAIT_SET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x16CABD80)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_WAIT_SET_TIMELEFT_OFFSET UNITYSDK_OFFSET(0x16CABD60)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_WAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x16CABEB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_WAIT___BASE_ONREGISTEREXTRAPORTS_OFFSET UNITYSDK_OFFSET(0x16CABED0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_Wait_TypeDefinitionIndex = 48933;
