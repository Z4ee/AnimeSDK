...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTARGETENTITYFOUCSUINEW_ONENTITYREADY_OFFSET UNITYSDK_OFFSET(0x149E2440)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTARGETENTITYFOUCSUINEW_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x149E1DE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTARGETENTITYFOUCSUINEW_SENDENTITYSHOWTARGETUI_OFFSET UNITYSDK_OFFSET(0x149E21D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTARGETENTITYFOUCSUINEW_START_INVOKE_OFFSET UNITYSDK_OFFSET(0x149E1F70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTARGETENTITYFOUCSUINEW__CTOR_OFFSET UNITYSDK_OFFSET(0x149E24E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTARGETENTITYFOUCSUINEW__INITKEY_OFFSET UNITYSDK_OFFSET(0x149E1F30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTARGETENTITYFOUCSUINEW__REGISTERPORTS_B__7_0_OFFSET UNITYSDK_OFFSET(0x149E2560)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDShowTargetEntityFoucsUINew_TypeDefinitionIndex = 68097;
	...
	public:
		...
		::System::String* hpBarPointName; // 0xB8
		::FlowCanvas::ValueInput_1<::MoleMole::Battle::Entity*>* entityInput; // 0xC0
		::FlowCanvas::ValueInput_1<::System::Boolean>* hpBarInput; // 0xC8
		::FlowCanvas::Editor::FCValueDropList_1<::System::String*>* focusIconKey; // 0xD0
