...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ISAGENTOWNTALENTCARD_INVOKE_OFFSET UNITYSDK_OFFSET(0x1907F190)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ISAGENTOWNTALENTCARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1907F250)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_IsAgentOwnTalentCard_TypeDefinitionIndex = 73477;
