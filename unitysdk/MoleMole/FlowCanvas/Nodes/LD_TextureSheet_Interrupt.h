...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_TEXTURESHEET_INTERRUPT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x10BB90F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_TEXTURESHEET_INTERRUPT__CTOR_OFFSET UNITYSDK_OFFSET(0x10BB9220)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_TEXTURESHEET_INTERRUPT__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x10BB9260)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_TextureSheet_Interrupt_TypeDefinitionIndex = 56194;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::System::String*>* _textureSheetKey; // 0xC0
