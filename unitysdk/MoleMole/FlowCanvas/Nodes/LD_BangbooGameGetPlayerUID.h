...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_BANGBOOGAMEGETPLAYERUID_INVOKE_OFFSET UNITYSDK_OFFSET(0x170CC6D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_BANGBOOGAMEGETPLAYERUID__CTOR_OFFSET UNITYSDK_OFFSET(0x170CC710)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_BangbooGameGetPlayerUID_TypeDefinitionIndex = 40695;
