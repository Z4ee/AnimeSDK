...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_BANGBOOGAMEGETPLAYERUID_INVOKE_OFFSET UNITYSDK_OFFSET(0x19125DC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_BANGBOOGAMEGETPLAYERUID__CTOR_OFFSET UNITYSDK_OFFSET(0x19125E00)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_BangbooGameGetPlayerUID_TypeDefinitionIndex = 56816;
