...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERARMORCHANGE_ADDLISTENHPABILITY_OFFSET UNITYSDK_OFFSET(0x170C5690)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERARMORCHANGE_BINDEVENT_OFFSET UNITYSDK_OFFSET(0x170C57F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERARMORCHANGE_ENTITYONREADY_OFFSET UNITYSDK_OFFSET(0x170C55E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERARMORCHANGE_ONEVENT_OFFSET UNITYSDK_OFFSET(0x170C6060)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERARMORCHANGE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x170C5BF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERARMORCHANGE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x170C5C50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERARMORCHANGE_ONPROPVALUECHANGE_OFFSET UNITYSDK_OFFSET(0x170C5CA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERARMORCHANGE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x170C5220)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERARMORCHANGE_START_OFFSET UNITYSDK_OFFSET(0x170C53C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERARMORCHANGE_UNBINDEVENT_OFFSET UNITYSDK_OFFSET(0x170C59F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERARMORCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x170C63C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERARMORCHANGE__REGISTERPORTS_B__8_0_OFFSET UNITYSDK_OFFSET(0x170C6400)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERARMORCHANGE___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x170C6450)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERARMORCHANGE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x170C6460)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDListenMonsterArmorChange_TypeDefinitionIndex = 70606;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::System::Single>* highToValuePercnetInput; // 0xB0
		::FlowCanvas::FlowOutput* outPut; // 0xB8
		::FlowCanvas::FlowOutput* onLowToValueOutPut; // 0xC0
