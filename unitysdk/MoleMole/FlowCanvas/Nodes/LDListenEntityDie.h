...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENENTITYDIE_BINDEVENT_OFFSET UNITYSDK_OFFSET(0x161DC1C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENENTITYDIE_INTERRUPT_OFFSET UNITYSDK_OFFSET(0x161DC410)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENENTITYDIE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x161DC7E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENENTITYDIE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x161DC6E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENENTITYDIE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x161DC730)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENENTITYDIE_ONLATETICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x161DC780)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENENTITYDIE_ONMONSTERDIE_OFFSET UNITYSDK_OFFSET(0x161DC8E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENENTITYDIE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x161DBD80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENENTITYDIE_START_OFFSET UNITYSDK_OFFSET(0x161DBEF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENENTITYDIE_UNBINDEVENT_OFFSET UNITYSDK_OFFSET(0x161DC490)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENENTITYDIE__CTOR_OFFSET UNITYSDK_OFFSET(0x161DD070)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENENTITYDIE__REGISTERPORTS_B__7_0_OFFSET UNITYSDK_OFFSET(0x161DD0B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENENTITYDIE__REGISTERPORTS_B__7_1_OFFSET UNITYSDK_OFFSET(0x161DD0E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENENTITYDIE___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x161DD180)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENENTITYDIE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x161DD190)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDListenEntityDie_TypeDefinitionIndex = 72279;

	class LDListenEntityDie : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::FlowOutput* Reached; // 0xA8
		::FlowCanvas::ValueInput_1<::MoleMole::Battle::Entity*>* entityInput; // 0xB0
		::FlowCanvas::ValueInput_1<::MoleMole::FlowCanvas::Nodes::EntityDieCheckType>* inputDeathCheckType; // 0xB8
		::FlowCanvas::FlowOutput* output; // 0xC0
		::System::UInt32 listenEntityId; // 0xC8
		::System::Boolean nodeEnter; // 0xCC
		::System::Boolean bindEvent; // 0xCD
