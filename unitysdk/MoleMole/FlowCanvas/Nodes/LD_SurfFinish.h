...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SURFFINISH_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A030630)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SURFFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0306B0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_SurfFinish_TypeDefinitionIndex = 78023;
