...
#define MOLEMOLE_FLOWCANVAS_NODES_LDOPENLOADINGBUDDYNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x12992990)
#define MOLEMOLE_FLOWCANVAS_NODES_LDOPENLOADINGBUDDYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x12992A20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDOPENLOADINGBUDDYNODE__INVOKE_B__2_0_OFFSET UNITYSDK_OFFSET(0x12992A40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDOPENLOADINGBUDDYNODE__INVOKE_B__2_1_OFFSET UNITYSDK_OFFSET(0x12992A50)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDOpenLoadingBuddyNode_TypeDefinitionIndex = 62421;
