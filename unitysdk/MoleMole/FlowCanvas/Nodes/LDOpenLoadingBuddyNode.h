...
#define MOLEMOLE_FLOWCANVAS_NODES_LDOPENLOADINGBUDDYNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x11742570)
#define MOLEMOLE_FLOWCANVAS_NODES_LDOPENLOADINGBUDDYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x11742600)
#define MOLEMOLE_FLOWCANVAS_NODES_LDOPENLOADINGBUDDYNODE__INVOKE_B__2_0_OFFSET UNITYSDK_OFFSET(0x11742620)
#define MOLEMOLE_FLOWCANVAS_NODES_LDOPENLOADINGBUDDYNODE__INVOKE_B__2_1_OFFSET UNITYSDK_OFFSET(0x11742630)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDOpenLoadingBuddyNode_TypeDefinitionIndex = 63008;
