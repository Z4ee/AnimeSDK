...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_CHECKENTITYNEEDCHAT_INVOKE_OFFSET UNITYSDK_OFFSET(0x19BE5770)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_CHECKENTITYNEEDCHAT__CTOR_OFFSET UNITYSDK_OFFSET(0x19BE5820)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_CheckEntityNeedChat_TypeDefinitionIndex = 74943;
