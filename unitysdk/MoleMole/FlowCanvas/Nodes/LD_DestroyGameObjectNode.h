...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_DESTROYGAMEOBJECTNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x14282530)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_DESTROYGAMEOBJECTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x14282620)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_DESTROYGAMEOBJECTNODE__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x14282660)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_DestroyGameObjectNode_TypeDefinitionIndex = 38720;

	class LD_DestroyGameObjectNode : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::UnityEngine::GameObject*>* _inputObject; // 0xA8
