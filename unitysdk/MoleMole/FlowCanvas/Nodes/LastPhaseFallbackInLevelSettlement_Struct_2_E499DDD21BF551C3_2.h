...
#define MOLEMOLE_FLOWCANVAS_NODES_LASTPHASEFALLBACKINLEVELSETTLEMENT_STRUCT_2_E499DDD21BF551C3_2_COMPARE_OFFSET UNITYSDK_OFFSET(0x7B80C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LASTPHASEFALLBACKINLEVELSETTLEMENT_STRUCT_2_E499DDD21BF551C3_2_GET_MAXPITCH_OFFSET UNITYSDK_OFFSET(0x7307E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LASTPHASEFALLBACKINLEVELSETTLEMENT_STRUCT_2_E499DDD21BF551C3_2_GET_MINPITCH_OFFSET UNITYSDK_OFFSET(0x7307D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LASTPHASEFALLBACKINLEVELSETTLEMENT_STRUCT_2_E499DDD21BF551C3_2__CTOR_OFFSET UNITYSDK_OFFSET(0x730740)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LastPhaseFallbackInLevelSettlement_Struct_2_E499DDD21BF551C3_2_TypeDefinitionIndex = 52712;
