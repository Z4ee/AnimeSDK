...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEMONSTERSYNCNODE_CREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x17102150)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEMONSTERSYNCNODE_ONENTITYREADY_OFFSET UNITYSDK_OFFSET(0x17102FC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEMONSTERSYNCNODE_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x17101BC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEMONSTERSYNCNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x17101980)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEMONSTERSYNCNODE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x17101D90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEMONSTERSYNCNODE__CALLMONSTEROUTPUT_OFFSET UNITYSDK_OFFSET(0x17102F50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEMONSTERSYNCNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x171032B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEMONSTERSYNCNODE__REGISTERPORTS_B__11_0_OFFSET UNITYSDK_OFFSET(0x17103300)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEMONSTERSYNCNODE__REGISTERPORTS_B__11_1_OFFSET UNITYSDK_OFFSET(0x171033C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEMONSTERSYNCNODE___BASE_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x171033D0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCreateMonsterSyncNode_TypeDefinitionIndex = 83964;

	class LDCreateMonsterSyncNode : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::String*>* inputSpawnPoint; // 0xA8
		...
		::FlowCanvas::ValueInput_1<::System::Int32>* inputMonsterId; // 0xC8
		::FlowCanvas::ValueInput_1<::MoleMole::FlowCanvas::Nodes::MonsterIDType>* inputMonsterIDType; // 0xD0
		::FlowCanvas::ValueInput_1<::System::Int32>* overrideMonsterLevel; // 0xD8
		::FlowCanvas::FlowOutput* output; // 0xE0
		::FlowCanvas::ValueInput_1<::MoleMole::Config::CampType>* inputCamp; // 0xE8
