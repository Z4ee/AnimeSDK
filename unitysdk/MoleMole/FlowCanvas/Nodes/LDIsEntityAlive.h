...
#define MOLEMOLE_FLOWCANVAS_NODES_LDISENTITYALIVE_INVOKE_OFFSET UNITYSDK_OFFSET(0x16CA0990)
#define MOLEMOLE_FLOWCANVAS_NODES_LDISENTITYALIVE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x16CA0860)
#define MOLEMOLE_FLOWCANVAS_NODES_LDISENTITYALIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x16CA0CE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDISENTITYALIVE__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x16CA0D20)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDIsEntityAlive_TypeDefinitionIndex = 50031;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::MoleMole::Battle::Entity*>* inputValue; // 0xC8
