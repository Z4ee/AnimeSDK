...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETLEVELTIMERPAUSE_INVOKE_OFFSET UNITYSDK_OFFSET(0x16CAA310)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETLEVELTIMERPAUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x16CAA380)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_GetLevelTimerPause_TypeDefinitionIndex = 56889;
