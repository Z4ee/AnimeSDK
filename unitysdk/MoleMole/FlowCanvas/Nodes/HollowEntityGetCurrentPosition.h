...
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYGETCURRENTPOSITION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B830860)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYGETCURRENTPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B830B20)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int HollowEntityGetCurrentPosition_TypeDefinitionIndex = 82834;
