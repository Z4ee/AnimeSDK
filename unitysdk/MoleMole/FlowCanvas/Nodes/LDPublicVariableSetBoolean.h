...
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLESETBOOLEAN_DOSET_OFFSET UNITYSDK_OFFSET(0x1841A050)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLESETBOOLEAN__CTOR_OFFSET UNITYSDK_OFFSET(0x1841A220)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLESETBOOLEAN___BASE_DOSET_OFFSET UNITYSDK_OFFSET(0x1841A270)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDPublicVariableSetBoolean_TypeDefinitionIndex = 48392;
