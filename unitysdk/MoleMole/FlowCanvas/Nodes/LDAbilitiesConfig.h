...
#define MOLEMOLE_FLOWCANVAS_NODES_LDABILITIESCONFIG_INVOKE_OFFSET UNITYSDK_OFFSET(0x1382E610)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABILITIESCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1382E850)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDAbilitiesConfig_TypeDefinitionIndex = 86533;
