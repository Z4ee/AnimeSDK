...
#define MOLEMOLE_FLOWCANVAS_NODES_LDABILITIESCONFIG_INVOKE_OFFSET UNITYSDK_OFFSET(0x12BAD120)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABILITIESCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x12BAD350)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDAbilitiesConfig_TypeDefinitionIndex = 53004;
