...
#define MOLEMOLE_FLOWCANVAS_NODES_PATTERNMONSTERCREATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16853260)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int PatternMonsterCreate_TypeDefinitionIndex = 82420;
