...
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLEGET_FLOAT_DOGET_OFFSET UNITYSDK_OFFSET(0x182DA1B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLEGET_FLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x182DA220)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLEGET_FLOAT___BASE_DOGET_OFFSET UNITYSDK_OFFSET(0x182DA270)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDPublicVariableGet_Float_TypeDefinitionIndex = 85529;
