...
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLEGET_FLOAT_DOGET_OFFSET UNITYSDK_OFFSET(0x19B117E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLEGET_FLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x19B11850)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLEGET_FLOAT___BASE_DOGET_OFFSET UNITYSDK_OFFSET(0x19B118A0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDPublicVariableGet_Float_TypeDefinitionIndex = 52977;
