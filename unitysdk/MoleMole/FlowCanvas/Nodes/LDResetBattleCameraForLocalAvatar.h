...
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETBATTLECAMERAFORLOCALAVATAR_BACKCAMERA_OFFSET UNITYSDK_OFFSET(0x12BB77C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETBATTLECAMERAFORLOCALAVATAR_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x12BB7700)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETBATTLECAMERAFORLOCALAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x12BB7860)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDResetBattleCameraForLocalAvatar_TypeDefinitionIndex = 55827;
