...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ENDAREA___C__DISPLAYCLASS6_0____SENDEVENT_G____DELAYSENDACTION_1_D_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x16E50D70)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ENDAREA___C__DISPLAYCLASS6_0____SENDEVENT_G____DELAYSENDACTION_1_D_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16E51040)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ENDAREA___C__DISPLAYCLASS6_0____SENDEVENT_G____DELAYSENDACTION_1_D_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16E510A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ENDAREA___C__DISPLAYCLASS6_0____SENDEVENT_G____DELAYSENDACTION_1_D_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x16E51050)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ENDAREA___C__DISPLAYCLASS6_0____SENDEVENT_G____DELAYSENDACTION_1_D_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16E50D60)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ENDAREA___C__DISPLAYCLASS6_0____SENDEVENT_G____DELAYSENDACTION_1_D__CTOR_OFFSET UNITYSDK_OFFSET(0x16E50D50)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_EndArea___c__DisplayClass6_0____SendEvent_g____DelaySendAction_1_d_TypeDefinitionIndex = 76654;
	...
	public:
		...
		::MoleMole::UIInLevelMainPageController* _uimain_5__2; // 0x20
