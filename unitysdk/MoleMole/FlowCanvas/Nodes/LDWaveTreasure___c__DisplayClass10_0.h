...
{
	inline static constexpr unsigned int LDWaveTreasure___c__DisplayClass10_0_TypeDefinitionIndex = 74676;

	struct alignas(8) LDWaveTreasure___c__DisplayClass10_0
	{
		::MoleMole::FlowCanvas::Nodes::TreasureCreateData* treasureCreateData; // 0x10
