...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_CLOSEROTATORCONTROLUI_INVOKE_OFFSET UNITYSDK_OFFSET(0x19B164A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_CLOSEROTATORCONTROLUI__CTOR_OFFSET UNITYSDK_OFFSET(0x19B16600)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_CloseRotatorControlUI_TypeDefinitionIndex = 58608;
