...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATAR_GETAVATARINDEXBYAVATARID_GETAVATARINDEXBYAVATARID_OFFSET UNITYSDK_OFFSET(0x170CC300)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATAR_GETAVATARINDEXBYAVATARID_INVOKE_OFFSET UNITYSDK_OFFSET(0x170CC2B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATAR_GETAVATARINDEXBYAVATARID__CTOR_OFFSET UNITYSDK_OFFSET(0x170CC6B0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_Avatar_GetAvatarIndexByAvatarID_TypeDefinitionIndex = 46276;
