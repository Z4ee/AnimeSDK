...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATAR_GETAVATARINDEXBYAVATARID_GETAVATARINDEXBYAVATARID_OFFSET UNITYSDK_OFFSET(0x191259F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATAR_GETAVATARINDEXBYAVATARID_INVOKE_OFFSET UNITYSDK_OFFSET(0x191259A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATAR_GETAVATARINDEXBYAVATARID__CTOR_OFFSET UNITYSDK_OFFSET(0x19125DA0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_Avatar_GetAvatarIndexByAvatarID_TypeDefinitionIndex = 82334;
