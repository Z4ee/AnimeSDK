...
#define MOLEMOLE_FLOWCANVAS_NODES_LDPREINITBUDDYTOWERDEFENSESCENE_INITBUDDYTOWERDEFENSESCENE_OFFSET UNITYSDK_OFFSET(0x10BA7B90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPREINITBUDDYTOWERDEFENSESCENE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x10BA7AD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPREINITBUDDYTOWERDEFENSESCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x10BA8260)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPREINITBUDDYTOWERDEFENSESCENE__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0x10BA82A0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDPreInitBuddyTowerDefenseScene_TypeDefinitionIndex = 83001;
