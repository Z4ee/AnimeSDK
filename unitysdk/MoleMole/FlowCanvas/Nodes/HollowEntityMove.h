...
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYMOVE_INVOKEINNER_OFFSET UNITYSDK_OFFSET(0x160392C0)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYMOVE_INVOKES_OFFSET UNITYSDK_OFFSET(0x160394B0)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYMOVE_INVOKE_OFFSET UNITYSDK_OFFSET(0x16039240)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x16039520)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int HollowEntityMove_TypeDefinitionIndex = 65617;
