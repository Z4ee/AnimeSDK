...
#define MOLEMOLE_FLOWCANVAS_NODES_LDHADAL_ROOMLIMITTIME_INVOKE_OFFSET UNITYSDK_OFFSET(0x13001AB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDHADAL_ROOMLIMITTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x13001C30)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDHadal_RoomLimitTime_TypeDefinitionIndex = 78244;
