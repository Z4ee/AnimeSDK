...
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWGETPOSITIONBYDIR_INVOKE_OFFSET UNITYSDK_OFFSET(0x19DAD150)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWGETPOSITIONBYDIR__CTOR_OFFSET UNITYSDK_OFFSET(0x19DAD540)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int HollowGetPositionByDir_TypeDefinitionIndex = 88393;
