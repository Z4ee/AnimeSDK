...
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETRANDOMGENERATOR_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x129950F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETRANDOMGENERATOR_RESETRANDOM_OFFSET UNITYSDK_OFFSET(0x129951E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETRANDOMGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x12995550)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETRANDOMGENERATOR__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x129955A0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDResetRandomGenerator_TypeDefinitionIndex = 59069;
