...
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETRANDOMGENERATOR_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x15815CF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETRANDOMGENERATOR_RESETRANDOM_OFFSET UNITYSDK_OFFSET(0x15815DE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETRANDOMGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x15816150)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETRANDOMGENERATOR__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x158161A0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDResetRandomGenerator_TypeDefinitionIndex = 54244;
