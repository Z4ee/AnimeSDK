...
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLESETINT_DOSET_OFFSET UNITYSDK_OFFSET(0x10E0D560)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLESETINT__CTOR_OFFSET UNITYSDK_OFFSET(0x10E0D740)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLESETINT___BASE_DOSET_OFFSET UNITYSDK_OFFSET(0x10E0D790)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDPublicVariableSetInt_TypeDefinitionIndex = 46291;
