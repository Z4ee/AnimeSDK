...
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLESETINT_DOSET_OFFSET UNITYSDK_OFFSET(0x18B245A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLESETINT__CTOR_OFFSET UNITYSDK_OFFSET(0x18B24770)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLESETINT___BASE_DOSET_OFFSET UNITYSDK_OFFSET(0x18B247C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDPublicVariableSetInt_TypeDefinitionIndex = 58740;
