...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETLOCALAVATARNODE_GETLOCALAVATAR_OFFSET UNITYSDK_OFFSET(0x144BF650)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETLOCALAVATARNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x144BF8A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETLOCALAVATARNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x144BF950)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETLOCALAVATARNODE__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x144BF990)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetLocalAvatarNode_TypeDefinitionIndex = 51420;
