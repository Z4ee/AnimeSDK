...
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETANIMCONTROLLERNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x17809670)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETANIMCONTROLLERNODE_STOPTYPEENTITYTIMESLOW_OFFSET UNITYSDK_OFFSET(0x178099C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETANIMCONTROLLERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x17809C70)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDResetAnimControllerNode_TypeDefinitionIndex = 61956;
