...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEMONSTERNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19B0A080)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEMONSTERNODE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x19B0ABB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEMONSTERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B0AD80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEMONSTERNODE___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x19B0ADA0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCreateMonsterNode_TypeDefinitionIndex = 72265;
