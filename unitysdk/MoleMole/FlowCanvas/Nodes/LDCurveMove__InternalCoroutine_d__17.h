...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCURVEMOVE__INTERNALCOROUTINE_D__17_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x17E6B7A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCURVEMOVE__INTERNALCOROUTINE_D__17_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x17E6BBC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCURVEMOVE__INTERNALCOROUTINE_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x17E6BC20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCURVEMOVE__INTERNALCOROUTINE_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x17E6BBD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCURVEMOVE__INTERNALCOROUTINE_D__17_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17E6B790)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCURVEMOVE__INTERNALCOROUTINE_D__17__CTOR_OFFSET UNITYSDK_OFFSET(0x17E6B780)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCurveMove__InternalCoroutine_d__17_TypeDefinitionIndex = 79097;
	...
	public:
		...
		::MoleMole::FlowCanvas::Nodes::LDCurveMove___c__DisplayClass17_0* __8__1; // 0x40
		::MoleMole::FlowCanvas::Nodes::LDCurveMove* __4__this; // 0x48
