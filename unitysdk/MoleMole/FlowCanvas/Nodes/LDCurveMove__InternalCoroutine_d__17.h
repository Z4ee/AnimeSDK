...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCURVEMOVE__INTERNALCOROUTINE_D__17_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x16B7B730)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCURVEMOVE__INTERNALCOROUTINE_D__17_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16B7BB60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCURVEMOVE__INTERNALCOROUTINE_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16B7BBC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCURVEMOVE__INTERNALCOROUTINE_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x16B7BB70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCURVEMOVE__INTERNALCOROUTINE_D__17_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16B7B720)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCURVEMOVE__INTERNALCOROUTINE_D__17__CTOR_OFFSET UNITYSDK_OFFSET(0x16B7B710)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCurveMove__InternalCoroutine_d__17_TypeDefinitionIndex = 77056;

	class LDCurveMove__InternalCoroutine_d__17 : public ::System::Object
	{
	public:
		::FlowCanvas::Flow f; // 0x10
		::MoleMole::FlowCanvas::Nodes::LDCurveMove___c__DisplayClass17_0* __8__1; // 0x38
		::MoleMole::FlowCanvas::Nodes::LDCurveMove* __4__this; // 0x40
