...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ISINBATTLESTATUSNEW_INVOKE_OFFSET UNITYSDK_OFFSET(0x14285240)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ISINBATTLESTATUSNEW_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x14285110)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ISINBATTLESTATUSNEW__CTOR_OFFSET UNITYSDK_OFFSET(0x14285510)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ISINBATTLESTATUSNEW__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x14285550)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ISINBATTLESTATUSNEW__REGISTERPORTS_B__3_1_OFFSET UNITYSDK_OFFSET(0x14285560)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_IsInBattleStatusNew_TypeDefinitionIndex = 45436;
