...
#define MOLEMOLE_FLOWCANVAS_NODES_SWITCHFLOATCUSTOM_BETWEENPROCESS_OFFSET UNITYSDK_OFFSET(0x171181E0)
#define MOLEMOLE_FLOWCANVAS_NODES_SWITCHFLOATCUSTOM_EQUALPROCESS_OFFSET UNITYSDK_OFFSET(0x17117DA0)
#define MOLEMOLE_FLOWCANVAS_NODES_SWITCHFLOATCUSTOM_GREATEREQUALBREAKPROCESS_OFFSET UNITYSDK_OFFSET(0x17118550)
#define MOLEMOLE_FLOWCANVAS_NODES_SWITCHFLOATCUSTOM_GREATEREQUALPROCESS_OFFSET UNITYSDK_OFFSET(0x17117FC0)
#define MOLEMOLE_FLOWCANVAS_NODES_SWITCHFLOATCUSTOM_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x17117B10)
#define MOLEMOLE_FLOWCANVAS_NODES_SWITCHFLOATCUSTOM__CTOR_OFFSET UNITYSDK_OFFSET(0x17118760)
#define MOLEMOLE_FLOWCANVAS_NODES_SWITCHFLOATCUSTOM__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x17118800)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int SwitchFloatCustom_TypeDefinitionIndex = 59107;

	class SwitchFloatCustom : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::FlowOutput* defaultCase; // 0xA8
		::System::Collections::Generic::List_1<::System::Single>* floatCases; // 0xB0
		::Il2CppArray<::FlowCanvas::FlowOutput*>* cases; // 0xB8
		::FlowCanvas::ValueInput_1<::Enum_3_D7B028BA5CC069E1>* compareType; // 0xC0
		::FlowCanvas::ValueInput_1<::System::Single>* selector; // 0xC8
