...
#define MOLEMOLE_FLOWCANVAS_NODES_LDINTERACTSTOP_INVOKE_OFFSET UNITYSDK_OFFSET(0x16CA0570)
#define MOLEMOLE_FLOWCANVAS_NODES_LDINTERACTSTOP__CTOR_OFFSET UNITYSDK_OFFSET(0x16CA0680)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDInteractStop_TypeDefinitionIndex = 83997;
