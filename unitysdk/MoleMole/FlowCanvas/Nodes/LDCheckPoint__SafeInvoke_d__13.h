...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHECKPOINT__SAFEINVOKE_D__13_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1498C1E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHECKPOINT__SAFEINVOKE_D__13_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1498C4F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHECKPOINT__SAFEINVOKE_D__13_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1498C550)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHECKPOINT__SAFEINVOKE_D__13_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1498C500)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHECKPOINT__SAFEINVOKE_D__13_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1498C1D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHECKPOINT__SAFEINVOKE_D__13__CTOR_OFFSET UNITYSDK_OFFSET(0x1498C1C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCheckPoint__SafeInvoke_d__13_TypeDefinitionIndex = 78951;
