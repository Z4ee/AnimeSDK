...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHECKPOINT__SAFEINVOKE_D__13_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B52F4F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHECKPOINT__SAFEINVOKE_D__13_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B52F800)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHECKPOINT__SAFEINVOKE_D__13_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B52F860)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHECKPOINT__SAFEINVOKE_D__13_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B52F810)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHECKPOINT__SAFEINVOKE_D__13_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B52F4E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHECKPOINT__SAFEINVOKE_D__13__CTOR_OFFSET UNITYSDK_OFFSET(0x1B52F4D0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCheckPoint__SafeInvoke_d__13_TypeDefinitionIndex = 79997;

	class LDCheckPoint__SafeInvoke_d__13 : public ::System::Object
	{
	public:
		::MoleMole::FlowCanvas::Nodes::LDCheckPoint* __4__this; // 0x10
		::System::Object* __2__current; // 0x18
		::FlowCanvas::Flow flow; // 0x20
		::System::Boolean asFirstSection; // 0x48
