...
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTER_FULLCREATEDLIST_OFFSET UNITYSDK_OFFSET(0x14996C20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x14996B90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTER_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x14996FA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x14997130)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTER___BASE_FULLCREATEDLIST_OFFSET UNITYSDK_OFFSET(0x14997140)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTER___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x14997150)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTER___BASE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x14997160)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDRandomWaveMonster_TypeDefinitionIndex = 78808;
