...
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDGETENEMYMONSTERLIST_INVOKE_OFFSET UNITYSDK_OFFSET(0x17E74CA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDGETENEMYMONSTERLIST_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x17E747A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDGETENEMYMONSTERLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x17E74CE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDGETENEMYMONSTERLIST___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x17E74D40)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDTurnBasedGetEnemyMonsterList_TypeDefinitionIndex = 83197;
