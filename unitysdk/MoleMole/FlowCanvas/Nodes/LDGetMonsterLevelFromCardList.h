...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETMONSTERLEVELFROMCARDLIST_INVOKE_OFFSET UNITYSDK_OFFSET(0x17E6C3B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETMONSTERLEVELFROMCARDLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x17E6C970)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETMONSTERLEVELFROMCARDLIST__GETMONSTERLEVEL_OFFSET UNITYSDK_OFFSET(0x17E6C540)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetMonsterLevelFromCardList_TypeDefinitionIndex = 67052;
