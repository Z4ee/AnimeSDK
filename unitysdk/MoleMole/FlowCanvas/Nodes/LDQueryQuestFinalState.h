...
#define MOLEMOLE_FLOWCANVAS_NODES_LDQUERYQUESTFINALSTATE_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x13A85310)
#define MOLEMOLE_FLOWCANVAS_NODES_LDQUERYQUESTFINALSTATE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x13A851D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDQUERYQUESTFINALSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x13A855D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDQUERYQUESTFINALSTATE__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x13A85610)
#define MOLEMOLE_FLOWCANVAS_NODES_LDQUERYQUESTFINALSTATE__REGISTERPORTS_B__3_1_OFFSET UNITYSDK_OFFSET(0x13A85620)
#define MOLEMOLE_FLOWCANVAS_NODES_LDQUERYQUESTFINALSTATE__REGISTERPORTS_B__3_2_OFFSET UNITYSDK_OFFSET(0x13A85630)
#define MOLEMOLE_FLOWCANVAS_NODES_LDQUERYQUESTFINALSTATE___BASE_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x13A85640)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDQueryQuestFinalState_TypeDefinitionIndex = 66872;
