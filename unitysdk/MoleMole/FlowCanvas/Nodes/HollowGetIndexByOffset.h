...
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWGETINDEXBYOFFSET_INVOKE_OFFSET UNITYSDK_OFFSET(0x161D1C20)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWGETINDEXBYOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x161D1E00)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int HollowGetIndexByOffset_TypeDefinitionIndex = 39958;
