...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOOTGAME__WAITGAMEFINISHED_D__11_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1684B440)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOOTGAME__WAITGAMEFINISHED_D__11_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1684BA20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOOTGAME__WAITGAMEFINISHED_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1684BA80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOOTGAME__WAITGAMEFINISHED_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1684BA30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOOTGAME__WAITGAMEFINISHED_D__11_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1684B430)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOOTGAME__WAITGAMEFINISHED_D__11__CTOR_OFFSET UNITYSDK_OFFSET(0x1684B420)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDShootGame__WaitGameFinished_d__11_TypeDefinitionIndex = 75603;
