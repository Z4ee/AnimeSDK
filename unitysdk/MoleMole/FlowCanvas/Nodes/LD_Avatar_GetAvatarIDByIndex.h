...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATAR_GETAVATARIDBYINDEX_GETAVATARIDBYINDEX_OFFSET UNITYSDK_OFFSET(0x16E51560)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATAR_GETAVATARIDBYINDEX_INVOKE_OFFSET UNITYSDK_OFFSET(0x16E51510)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATAR_GETAVATARIDBYINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x16E517A0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_Avatar_GetAvatarIDByIndex_TypeDefinitionIndex = 76441;
