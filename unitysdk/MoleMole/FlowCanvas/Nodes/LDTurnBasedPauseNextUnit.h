...
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDPAUSENEXTUNIT_INVOKE_OFFSET UNITYSDK_OFFSET(0x11746230)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDPAUSENEXTUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x11746370)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDTurnBasedPauseNextUnit_TypeDefinitionIndex = 68695;
