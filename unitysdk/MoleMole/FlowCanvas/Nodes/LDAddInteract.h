...
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDINTERACT_GETINTERACTFLOATPARAM_OFFSET UNITYSDK_OFFSET(0x19B083A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDINTERACT_ONEVENT_OFFSET UNITYSDK_OFFSET(0x19B08460)
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDINTERACT_PREPAREDATA_OFFSET UNITYSDK_OFFSET(0x19B08120)
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDINTERACT_PREPAREINTERACTOBJECTS_OFFSET UNITYSDK_OFFSET(0x19B08160)
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDINTERACT_PROCESSINTERACTCNT_OFFSET UNITYSDK_OFFSET(0x19B093B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDINTERACT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19B07B70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDINTERACT_START_INTERACT_OFFSET UNITYSDK_OFFSET(0x19B08A50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDINTERACT__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B096A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x19B09620)
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDINTERACT__ONSUCCESS_OFFSET UNITYSDK_OFFSET(0x19B08770)
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDINTERACT__REGISTERPORTS_B__23_0_OFFSET UNITYSDK_OFFSET(0x19B096B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDINTERACT__REGISTERPORTS_B__23_1_OFFSET UNITYSDK_OFFSET(0x19B09720)
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDINTERACT__REGISTERPORTS_B__23_2_OFFSET UNITYSDK_OFFSET(0x19B097C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDINTERACT__START_INTERACT_B__29_0_OFFSET UNITYSDK_OFFSET(0x19B097D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDINTERACT__START_INTERACT_B__29_1_OFFSET UNITYSDK_OFFSET(0x19B09810)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDAddInteract_TypeDefinitionIndex = 41777;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LDAddInteract_TypeDefinitionIndex)->GetStaticField(0x12CD0);
		}
		// static const ::System::Int32 UPDATE_VALUE_MAGIC_NUMBER = 0x699; // 0x0
		::FlowCanvas::ValueInput_1<::System::String*>* interactTagName; // 0xA8
		::FlowCanvas::ValueInput_1<::System::String*>* interactGroupName; // 0xB0
		::System::String* usingKey; // 0xB8
		::System::String* inputInteractKey; // 0xC0
		::FlowCanvas::ValueInput_1<::System::Boolean>* isGlobalMonopoly; // 0xC8
		::FlowCanvas::ValueInput_1<::MoleMole::Battle::Entity*>* ownerEntity; // 0xD0
		::Class_1_BB5E87689475A1A2_Class_1_6A90028D873A938C* _interactParam; // 0xD8
		::MoleMole::Config::InteractEntry* entry; // 0xE0
		::FlowCanvas::ValueInput_1<::System::String*>* dynamicInputInteractKey; // 0xE8
		...
		::FlowCanvas::ValueInput_1<::System::Int32>* _overrideInteractionCnt; // 0x100
		...
		::FlowCanvas::FlowOutput* onInteract; // 0x118
		::System::String* _GroupName; // 0x120
		::System::Collections::Generic::Dictionary_2<::System::String*, ::FlowCanvas::FlowOutput*>* _interactMsgDict; // 0x128
		::System::Single _lastUpdateResource; // 0x130
		::System::Single _InteractStartTime; // 0x134
		::System::Int32 _GroupItemID; // 0x138
		::System::Boolean isBindEvent; // 0x13C
