...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE___C__DISPLAYCLASS27_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1924B990)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE___C__DISPLAYCLASS27_0__ONSTART_B__1_OFFSET UNITYSDK_OFFSET(0x1924BF30)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE___C__DISPLAYCLASS27_0__ONSTART_B__2_OFFSET UNITYSDK_OFFSET(0x1924BF90)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE___C__DISPLAYCLASS27_0__ONSTART_B__3_OFFSET UNITYSDK_OFFSET(0x1924BFF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE___C__DISPLAYCLASS27_0__ONSTART_B__4_OFFSET UNITYSDK_OFFSET(0x1924C050)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE___C__DISPLAYCLASS27_0__ONSTART_B__5_OFFSET UNITYSDK_OFFSET(0x1924C070)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE___C__DISPLAYCLASS27_0__ONSTART_B__6_OFFSET UNITYSDK_OFFSET(0x1924C2B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE___C__DISPLAYCLASS27_0__ONSTART_B__7_OFFSET UNITYSDK_OFFSET(0x1924C350)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE___C__DISPLAYCLASS27_0__ONSTART_G__STARTCHALLENGE_0_OFFSET UNITYSDK_OFFSET(0x1924B9A0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_StartLimitChallenge___c__DisplayClass27_0_TypeDefinitionIndex = 87725;

	class LD_StartLimitChallenge___c__DisplayClass27_0 : public ::System::Object
	{
	public:
		::FlowCanvas::Flow f; // 0x10
		::MoleMole::FlowCanvas::Nodes::LD_StartLimitChallenge* __4__this; // 0x38
