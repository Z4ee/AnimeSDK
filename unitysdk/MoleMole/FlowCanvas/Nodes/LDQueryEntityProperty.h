...
#define MOLEMOLE_FLOWCANVAS_NODES_LDQUERYENTITYPROPERTY_INVOKE_OFFSET UNITYSDK_OFFSET(0x11743DD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDQUERYENTITYPROPERTY_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x11743C30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDQUERYENTITYPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x11744160)
#define MOLEMOLE_FLOWCANVAS_NODES_LDQUERYENTITYPROPERTY__REGISTERPORTS_B__6_0_OFFSET UNITYSDK_OFFSET(0x117441A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDQUERYENTITYPROPERTY__REGISTERPORTS_B__6_1_OFFSET UNITYSDK_OFFSET(0x117441B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDQUERYENTITYPROPERTY__REGISTERPORTS_B__6_2_OFFSET UNITYSDK_OFFSET(0x117441C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDQueryEntityProperty_TypeDefinitionIndex = 55584;
	...
	public:
		...
		::System::Double _result; // 0xC0
		::System::Boolean _isValid; // 0xC8
