...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_TRIGGERSKILL_BEGIN_OFFSET UNITYSDK_OFFSET(0x16E54D20)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_TRIGGERSKILL_INTERNALTRIGGERSKILL_OFFSET UNITYSDK_OFFSET(0x16E54DC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_TRIGGERSKILL_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x16E54BD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_TRIGGERSKILL_UPDATESKILLINFO_OFFSET UNITYSDK_OFFSET(0x16E553C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_TRIGGERSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x16E55440)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_TRIGGERSKILL__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x16E55480)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_TriggerSkill_TypeDefinitionIndex = 80212;

	class LD_TriggerSkill : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::MoleMole::EntityHandle>* Entity; // 0xA8
		::FlowCanvas::ValueInput_1<::System::Boolean>* ForceTriggerSkill; // 0xB0
		::FlowCanvas::FlowOutput* Output; // 0xB8
		::FlowCanvas::ValueInput_1<::System::Int32>* SkillBtnIndex; // 0xC0
