...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVEDESTROYNODE_BEIGIN_OFFSET UNITYSDK_OFFSET(0x15117B90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVEDESTROYNODE_DEINITSCENEMOVEENTITY_OFFSET UNITYSDK_OFFSET(0x15117F40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVEDESTROYNODE_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x15117B50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVEDESTROYNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x15117A10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVEDESTROYNODE__BEIGIN_G__FINISH_7_0_OFFSET UNITYSDK_OFFSET(0x15117EF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVEDESTROYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x15118510)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVEDESTROYNODE__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x15118550)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVEDESTROYNODE__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0x15118580)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVEDESTROYNODE___BASE_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x15118590)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSceneMoveDestroyNode_TypeDefinitionIndex = 45881;
