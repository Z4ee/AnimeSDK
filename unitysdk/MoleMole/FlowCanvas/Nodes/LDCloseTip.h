...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCLOSETIP_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x13832670)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCLOSETIP__CTOR_OFFSET UNITYSDK_OFFSET(0x138327B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCLOSETIP__GETCREATEDTIPOBJECT_OFFSET UNITYSDK_OFFSET(0x13832760)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCLOSETIP__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x138327F0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCloseTip_TypeDefinitionIndex = 69189;
