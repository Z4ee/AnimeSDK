...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEMONSTERSYNCNODE___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x149D6D40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEMONSTERSYNCNODE___C__DISPLAYCLASS11_0__REGISTERPORTS_B__2_OFFSET UNITYSDK_OFFSET(0x149D6D50)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCreateMonsterSyncNode___c__DisplayClass11_0_TypeDefinitionIndex = 54714;
