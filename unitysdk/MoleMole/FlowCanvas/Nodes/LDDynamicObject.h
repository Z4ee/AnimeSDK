...
#define MOLEMOLE_FLOWCANVAS_NODES_LDDYNAMICOBJECT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A01FAF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDYNAMICOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A01FE90)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDDynamicObject_TypeDefinitionIndex = 79560;
