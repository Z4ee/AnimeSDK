...
#define MOLEMOLE_FLOWCANVAS_NODES_LDINITIALIZESHOOTINGSUBSYSTEM_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x178039D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDINITIALIZESHOOTINGSUBSYSTEM_START_OFFSET UNITYSDK_OFFSET(0x17803A90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDINITIALIZESHOOTINGSUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x17803C50)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDInitializeShootingSubsystem_TypeDefinitionIndex = 54401;
