...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVERESETPOSITIONNODE_BEIGIN_OFFSET UNITYSDK_OFFSET(0x149E0760)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVERESETPOSITIONNODE_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x149E0720)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVERESETPOSITIONNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x149E05E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVERESETPOSITIONNODE_RESETPOSITION_OFFSET UNITYSDK_OFFSET(0x149E0B00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVERESETPOSITIONNODE__BEIGIN_G__FINISH_7_0_OFFSET UNITYSDK_OFFSET(0x149E0AB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVERESETPOSITIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x149E1000)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVERESETPOSITIONNODE__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x149E1040)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVERESETPOSITIONNODE__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0x149E1070)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVERESETPOSITIONNODE___BASE_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x149E1080)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSceneMoveResetPositionNode_TypeDefinitionIndex = 89827;

	class LDSceneMoveResetPositionNode : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueOutput_1<::System::String*>* groupKeyOutput; // 0xA8
