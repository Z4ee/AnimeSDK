...
#define MOLEMOLE_FLOWCANVAS_NODES_LDOPENTRANSITIONLOADING_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x13837660)
#define MOLEMOLE_FLOWCANVAS_NODES_LDOPENTRANSITIONLOADING__CTOR_OFFSET UNITYSDK_OFFSET(0x138377C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDOPENTRANSITIONLOADING__ONSTARTCOMPLETE_OFFSET UNITYSDK_OFFSET(0x13837750)
#define MOLEMOLE_FLOWCANVAS_NODES_LDOPENTRANSITIONLOADING__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x13837800)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDOpenTransitionLoading_TypeDefinitionIndex = 82229;
