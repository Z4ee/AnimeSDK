...
#define MOLEMOLE_FLOWCANVAS_NODES_LDEXITFIXEDCAMERA_INVOKE_OFFSET UNITYSDK_OFFSET(0x1427B030)
#define MOLEMOLE_FLOWCANVAS_NODES_LDEXITFIXEDCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1427B170)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDExitFixedCamera_TypeDefinitionIndex = 76216;
