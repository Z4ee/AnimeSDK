...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSENDCHECKPOINT2SERVER_INVOKE_OFFSET UNITYSDK_OFFSET(0x154161A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSENDCHECKPOINT2SERVER__CTOR_OFFSET UNITYSDK_OFFSET(0x15416320)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSendCheckPoint2Server_TypeDefinitionIndex = 40999;
