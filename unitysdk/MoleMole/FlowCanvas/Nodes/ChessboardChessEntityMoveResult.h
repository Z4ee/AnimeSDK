...
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDCHESSENTITYMOVERESULT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x18B1B420)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDCHESSENTITYMOVERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x18B1B570)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDCHESSENTITYMOVERESULT__REGISTERPORTS_B__6_0_OFFSET UNITYSDK_OFFSET(0x18B1B5B0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ChessboardChessEntityMoveResult_TypeDefinitionIndex = 41416;
