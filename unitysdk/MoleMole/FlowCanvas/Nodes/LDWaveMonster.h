...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_ACTIVEPRELOADMONSTER_OFFSET UNITYSDK_OFFSET(0x10BAF7F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_ADDENTITYTOMAP_OFFSET UNITYSDK_OFFSET(0x10BAF870)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_BEGIN_OFFSET UNITYSDK_OFFSET(0x10BAEA30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_BREAK_OFFSET UNITYSDK_OFFSET(0x10BAF170)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_CHECKWARPMONSTERNAME_OFFSET UNITYSDK_OFFSET(0x10BB0300)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_COLLECTPRELOADASSETS_OFFSET UNITYSDK_OFFSET(0x10BAD510)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_CREATEMONSTER_1_OFFSET UNITYSDK_OFFSET(0x10BB0B10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_CREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x10BB25E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x10BAE0B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_DORESTART_OFFSET UNITYSDK_OFFSET(0x10BAF3F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_FIREFINISHEVENT_OFFSET UNITYSDK_OFFSET(0x10BAF4A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_FORCEBREAK_OFFSET UNITYSDK_OFFSET(0x10BAF220)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_GETCAMPTYPE_OFFSET UNITYSDK_OFFSET(0x10BB07E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x10BAE6E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x10BAE8C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_GETCURRENTMONSTERIDTYPE_OFFSET UNITYSDK_OFFSET(0x10BB3F80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_GETENTITYTYPE_OFFSET UNITYSDK_OFFSET(0x10BAD720)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_GET_MUTEAI_OFFSET UNITYSDK_OFFSET(0x10BAB600)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_GET_MUTEHUD_OFFSET UNITYSDK_OFFSET(0x10BAB6C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_INTERNALCOROUTINE_OFFSET UNITYSDK_OFFSET(0x10BAFDD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_ISPRELOADDONE_OFFSET UNITYSDK_OFFSET(0x10BAE690)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_ISSERVERCARE_OFFSET UNITYSDK_OFFSET(0x10BABD30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_ISSHOWELE_OFFSET UNITYSDK_OFFSET(0x10BABCE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_ISTRAPMONSTER_OFFSET UNITYSDK_OFFSET(0x10BB2550)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_MULTIPLAYERINTERNALCOROUTINE_OFFSET UNITYSDK_OFFSET(0x10BAFD20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_ONCREATE_OFFSET UNITYSDK_OFFSET(0x10BB4B10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_ONENTITYREADY_OFFSET UNITYSDK_OFFSET(0x10BB4090)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_ONHOSTCHANGED_OFFSET UNITYSDK_OFFSET(0x10BAED20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x10BB4870)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_ONRESET_OFFSET UNITYSDK_OFFSET(0x10BB4470)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_POSTENTITYREADY_OFFSET UNITYSDK_OFFSET(0x10BB3410)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_PRELOADMONSTERASSETS_OFFSET UNITYSDK_OFFSET(0x10BAD920)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x10BAB780)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_RESETDATA_OFFSET UNITYSDK_OFFSET(0x10BABBD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_RESTART_OFFSET UNITYSDK_OFFSET(0x10BAF6B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_RUNNINGRIGIDBODYORIGINALCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x10BABD70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_SETMONSTERENTITYACTIVE_OFFSET UNITYSDK_OFFSET(0x10BAC400)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_SINGLEINTERNALCOROUTINE_OFFSET UNITYSDK_OFFSET(0x10BAFC70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x10BB00A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_UPDATERUNNINGRIGIDBODYCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x10BABF60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER__CHECKCOULDCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x10BB3DF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER__CREATEMONSTER_G____CREATEMONSTER_76_0_OFFSET UNITYSDK_OFFSET(0x10BB27C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x10BB4B60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER__REGISTERPORTS_B__47_0_OFFSET UNITYSDK_OFFSET(0x10BB4C60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER__REGISTERPORTS_B__47_1_OFFSET UNITYSDK_OFFSET(0x10BB4CA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER__REGISTERPORTS_B__47_2_OFFSET UNITYSDK_OFFSET(0x10BB4D70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER__REGISTERPORTS_B__47_3_OFFSET UNITYSDK_OFFSET(0x10BB4DA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER__REGISTERPORTS_B__47_4_OFFSET UNITYSDK_OFFSET(0x10BB4DB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER__REGISTERPORTS_B__47_5_OFFSET UNITYSDK_OFFSET(0x10BB4DC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER___BASE_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x10BB4DD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER___BASE_ISPRELOADDONE_OFFSET UNITYSDK_OFFSET(0x10BB4DE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER___BASE_ISSERVERCARE_OFFSET UNITYSDK_OFFSET(0x10BB4DF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER___BASE_ONCREATE_OFFSET UNITYSDK_OFFSET(0x10BB4E00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER___BASE_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x10BB4E10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x10BB4E20)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveMonster_TypeDefinitionIndex = 58482;

	class LDWaveMonster : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::System::String* errorMsg; // 0xA8
		::FlowCanvas::FlowInput* breakInput; // 0xB0
		::FlowCanvas::ValueInput_1<::System::Boolean>* towardsPlayerInput; // 0xB8
		::UnityEngine::Coroutine* coroutine; // 0xC0
		::FlowCanvas::ValueInput_1<::System::Boolean>* muteAiInput; // 0xC8
		::FlowCanvas::ValueInput_1<::System::Boolean>* isServerSync; // 0xD0
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::String*>* createMonsterNameDic; // 0xD8
		::FlowCanvas::ValueInput_1<::System::String*>* currentSectionName; // 0xE0
		::System::Collections::Generic::List_1<::MoleMole::EntityHandle>* preloadEntityList; // 0xE8
		::FlowCanvas::ValueInput_1<::System::Boolean>* muteHudInput; // 0xF0
		::FlowCanvas::ValueInput_1<::System::Collections::Generic::List_1<::MoleMole::FlowCanvas::Nodes::MonsterCreateData*>*>* createInput; // 0xF8
		::FlowCanvas::ValueInput_1<::MoleMole::Battle::MonsterAlertInitParams>* monsterAlertInitParamsInput; // 0x100
		::FlowCanvas::ValueInput_1<::UnityEngine::RigidbodyConstraints>* RunningOverrideRbConstraints; // 0x108
		::FlowCanvas::ValueOutput_1<::System::Int32>* indexOutput; // 0x110
		::FlowCanvas::FlowOutput* finishOutput; // 0x118
		::FlowCanvas::ValueInput_1<::MoleMole::FlowCanvas::Nodes::MonsterIDType>* monsterIDInput; // 0x120
		::System::String* currMonsterName; // 0x128
		::System::String* createMonsterName; // 0x130
		::FlowCanvas::FlowInput* restartInput; // 0x138
		::FlowCanvas::ValueOutput_1<::System::Collections::Generic::List_1<::MoleMole::Battle::Entity*>*>* entityListOutput; // 0x140
		::System::Collections::Generic::List_1<::MoleMole::Battle::Entity*>* createList; // 0x148
		::FlowCanvas::FlowOutput* output; // 0x150
		::FlowCanvas::FlowOutput* doOutput; // 0x158
		::FlowCanvas::FlowInput* input; // 0x160
		::FlowCanvas::ValueOutput_1<::MoleMole::Battle::Entity*>* entityOutput; // 0x168
		::FlowCanvas::ValueInput_1<::System::Boolean>* overrideCamp; // 0x170
		::FlowCanvas::ValueInput_1<::MoleMole::Config::CampType>* campInput; // 0x178
		::MoleMole::Battle::Entity* createEntity; // 0x180
		::FlowCanvas::ValueInput_1<::MoleMole::FlowCanvas::Nodes::EntitySaveDataMap*>* saveMapInput; // 0x188
		::System::Single waitDuration; // 0x190
		::System::Int32 createIndex; // 0x194
		::System::Boolean waittingCreate; // 0x198
		::System::Boolean isMonsterCreateNode; // 0x199
		::System::Boolean needPreload; // 0x19A
		::System::Boolean highPreloadPriority; // 0x19B
		::System::Boolean inPreload; // 0x19C
		::System::Boolean isStart; // 0x19D
		::System::Single startTime; // 0x1A0
		::System::Boolean waittingRestart; // 0x1A4
		::System::Boolean waitBreak; // 0x1A5
		::System::Boolean isTrapCreateNode; // 0x1A6
		::System::Boolean isAddToSaveMap; // 0x1A7
		::System::Single waitDelta; // 0x1A8
