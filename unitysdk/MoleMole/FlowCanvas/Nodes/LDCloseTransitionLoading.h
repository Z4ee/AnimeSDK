...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCLOSETRANSITIONLOADING_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1160AAE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCLOSETRANSITIONLOADING__CTOR_OFFSET UNITYSDK_OFFSET(0x1160AC10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCLOSETRANSITIONLOADING__ONSTOPCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1160ABA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCLOSETRANSITIONLOADING__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0x1160AC50)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCloseTransitionLoading_TypeDefinitionIndex = 62128;
