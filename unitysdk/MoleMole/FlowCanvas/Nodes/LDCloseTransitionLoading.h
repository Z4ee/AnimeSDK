...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCLOSETRANSITIONLOADING_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1923FC20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCLOSETRANSITIONLOADING__CTOR_OFFSET UNITYSDK_OFFSET(0x1923FD50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCLOSETRANSITIONLOADING__ONSTOPCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1923FCE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCLOSETRANSITIONLOADING__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0x1923FD90)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCloseTransitionLoading_TypeDefinitionIndex = 87318;
