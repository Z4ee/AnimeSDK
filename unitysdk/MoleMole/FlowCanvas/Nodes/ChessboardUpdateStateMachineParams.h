...
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDUPDATESTATEMACHINEPARAMS_INVOKE_OFFSET UNITYSDK_OFFSET(0x118B10F0)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDUPDATESTATEMACHINEPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x118B11A0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ChessboardUpdateStateMachineParams_TypeDefinitionIndex = 62085;
