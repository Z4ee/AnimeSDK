...
#define MOLEMOLE_FLOWCANVAS_NODES_LDPLAYSHOOTINGSTARTTIPS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x136935C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPLAYSHOOTINGSTARTTIPS_START_OFFSET UNITYSDK_OFFSET(0x13693680)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPLAYSHOOTINGSTARTTIPS__CTOR_OFFSET UNITYSDK_OFFSET(0x13693850)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDPlayShootingStartTips_TypeDefinitionIndex = 65775;
