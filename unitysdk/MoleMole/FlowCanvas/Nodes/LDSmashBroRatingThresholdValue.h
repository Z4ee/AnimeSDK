...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSMASHBRORATINGTHRESHOLDVALUE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18B26C40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSMASHBRORATINGTHRESHOLDVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B26F40)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSmashBroRatingThresholdValue_TypeDefinitionIndex = 59024;
