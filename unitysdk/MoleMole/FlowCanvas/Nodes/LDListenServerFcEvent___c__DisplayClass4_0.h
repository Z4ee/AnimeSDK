...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENSERVERFCEVENT___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A3380)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENSERVERFCEVENT___C__DISPLAYCLASS4_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x1A9A3390)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENSERVERFCEVENT___C__DISPLAYCLASS4_0__REGISTERPORTS_B__1_OFFSET UNITYSDK_OFFSET(0x1A9A34C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDListenServerFcEvent___c__DisplayClass4_0_TypeDefinitionIndex = 88137;
