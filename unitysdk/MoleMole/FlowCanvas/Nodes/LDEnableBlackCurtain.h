...
#define MOLEMOLE_FLOWCANVAS_NODES_LDENABLEBLACKCURTAIN_INVOKE_OFFSET UNITYSDK_OFFSET(0x1603DE90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDENABLEBLACKCURTAIN_ONREGISTEREXTRAPORTS_OFFSET UNITYSDK_OFFSET(0x1603E160)
#define MOLEMOLE_FLOWCANVAS_NODES_LDENABLEBLACKCURTAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1603E1F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDENABLEBLACKCURTAIN___BASE_ONREGISTEREXTRAPORTS_OFFSET UNITYSDK_OFFSET(0x1603E210)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDEnableBlackCurtain_TypeDefinitionIndex = 71331;
