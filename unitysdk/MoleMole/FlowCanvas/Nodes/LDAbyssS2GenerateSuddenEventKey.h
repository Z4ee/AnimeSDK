...
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2GENERATESUDDENEVENTKEY_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x118B1670)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2GENERATESUDDENEVENTKEY_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x118B15C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2GENERATESUDDENEVENTKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x118B1870)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2GENERATESUDDENEVENTKEY__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0x118B18B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2GENERATESUDDENEVENTKEY___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x118B18C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDAbyssS2GenerateSuddenEventKey_TypeDefinitionIndex = 53534;
