...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_CREATEINTERACTIONBUILDDATABYROOMAREANO_INNERBUILD_OFFSET UNITYSDK_OFFSET(0x125C62C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_CREATEINTERACTIONBUILDDATABYROOMAREANO_INVOKE_OFFSET UNITYSDK_OFFSET(0x125C61D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_CREATEINTERACTIONBUILDDATABYROOMAREANO__CTOR_OFFSET UNITYSDK_OFFSET(0x125C6510)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_CreateInteractionBuildDataByRoomAreaNo_TypeDefinitionIndex = 65936;
