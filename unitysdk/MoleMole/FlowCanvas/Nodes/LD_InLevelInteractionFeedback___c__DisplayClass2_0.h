...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_INLEVELINTERACTIONFEEDBACK___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0x118C3330)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_INLEVELINTERACTIONFEEDBACK___C__DISPLAYCLASS2_0__REGISTERPORTS_B__2_OFFSET UNITYSDK_OFFSET(0x118C3340)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_INLEVELINTERACTIONFEEDBACK___C__DISPLAYCLASS2_0__REGISTERPORTS_B__3_OFFSET UNITYSDK_OFFSET(0x118C3390)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_InLevelInteractionFeedback___c__DisplayClass2_0_TypeDefinitionIndex = 85563;
