...
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTRUCTIONLEFTCHECKNODE_BINDEVENT_OFFSET UNITYSDK_OFFSET(0x161D4E60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTRUCTIONLEFTCHECKNODE_CHECKALIVECOUNT_OFFSET UNITYSDK_OFFSET(0x161D3380)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTRUCTIONLEFTCHECKNODE_COMPAREMONSTERCAMP_OFFSET UNITYSDK_OFFSET(0x161D5720)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTRUCTIONLEFTCHECKNODE_HANDLECOMPARE_OFFSET UNITYSDK_OFFSET(0x161D4BB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTRUCTIONLEFTCHECKNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x161D30C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTRUCTIONLEFTCHECKNODE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x161D5070)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTRUCTIONLEFTCHECKNODE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x161D4E10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTRUCTIONLEFTCHECKNODE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x161D5020)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTRUCTIONLEFTCHECKNODE_ONMONSTERDIE_OFFSET UNITYSDK_OFFSET(0x161D52B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTRUCTIONLEFTCHECKNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x161D2EF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTRUCTIONLEFTCHECKNODE_UNBINDEVENT_OFFSET UNITYSDK_OFFSET(0x161D4C60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTRUCTIONLEFTCHECKNODE_WAITTOCHECKALIVECOUNT_OFFSET UNITYSDK_OFFSET(0x161D5690)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTRUCTIONLEFTCHECKNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x161D5770)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTRUCTIONLEFTCHECKNODE__REGISTERPORTS_B__12_0_OFFSET UNITYSDK_OFFSET(0x161D58A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTRUCTIONLEFTCHECKNODE___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x161D5950)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTRUCTIONLEFTCHECKNODE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x161D5960)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDDestructionLeftCheckNode_TypeDefinitionIndex = 54155;

	class LDDestructionLeftCheckNode : public ::FlowCanvas::FlowNode
	{
	public:
		::FlowCanvas::ValueInput_1<::MoleMole::FlowCanvas::Nodes::NumberCompareType>* inputCompareFunc; // 0xA8
		::FlowCanvas::ValueInput_1<::MoleMole::FlowCanvas::Nodes::EntitySaveDataMap*>* inputEntityMap; // 0xB0
		::System::Collections::Generic::List_1<::System::String*>* removeList; // 0xB8
		::FlowCanvas::FlowOutput* raised; // 0xC0
		::FlowCanvas::ValueInput_1<::System::Boolean>* inputAllDestruction; // 0xC8
		::System::Collections::Generic::List_1<::MoleMole::Battle::Entity*>* monstList; // 0xD0
