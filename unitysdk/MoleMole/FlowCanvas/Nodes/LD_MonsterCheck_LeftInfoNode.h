...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE_BINDEVENT_OFFSET UNITYSDK_OFFSET(0x13A8DA10)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x13A8DBB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x13A8D7D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x13A8D640)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE_UNBINDEVENT_OFFSET UNITYSDK_OFFSET(0x13A8D820)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE__CTOR_OFFSET UNITYSDK_OFFSET(0x13A8DE40)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE__ONEVENTFROMANYONE_B__12_0_OFFSET UNITYSDK_OFFSET(0x13A8E150)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE__REGISTERPORTS_B__6_0_OFFSET UNITYSDK_OFFSET(0x13A8DE80)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE__REGISTERPORTS_B__6_1_OFFSET UNITYSDK_OFFSET(0x13A8E090)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE__START_OFFSET UNITYSDK_OFFSET(0x13A8D9C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x13A8E190)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_MonsterCheck_LeftInfoNode_TypeDefinitionIndex = 61348;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::System::Boolean>* _isAll; // 0xC0
		::FlowCanvas::ValueInput_1<::MoleMole::Config::MonsterStrengthType>* _monsterStrength; // 0xC8
		::FlowCanvas::FlowOutput* _OnChanged; // 0xD0
