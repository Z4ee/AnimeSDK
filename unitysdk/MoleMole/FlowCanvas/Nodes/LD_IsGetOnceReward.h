...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ISGETONCEREWARD_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x14284D40)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ISGETONCEREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x14284E30)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ISGETONCEREWARD__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x14284E70)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_IsGetOnceReward_TypeDefinitionIndex = 54400;
