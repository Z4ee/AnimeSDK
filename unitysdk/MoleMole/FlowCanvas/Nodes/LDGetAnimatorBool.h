...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETANIMATORBOOL_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1260A6E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETANIMATORBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1260A7E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETANIMATORBOOL__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x1260A820)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetAnimatorBool_TypeDefinitionIndex = 71965;

	class LDGetAnimatorBool : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueOutput_1<::System::Boolean>* Output; // 0xA8
