...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT_BINDEVENTLISTENER_OFFSET UNITYSDK_OFFSET(0x1A02DFF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x1A02E7E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A02DFA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A02E320)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT_ONPOSTGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A02E790)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT_ONSTAGECHANGED_OFFSET UNITYSDK_OFFSET(0x1A02E6A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT_PROCESSEVENT_OFFSET UNITYSDK_OFFSET(0x1A02E8A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A02DE40)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT_UNBINDEVENTLISTENER_OFFSET UNITYSDK_OFFSET(0x1A02E370)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A02E9A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x1A02E9E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0x1A02E9F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT__REGISTERPORTS_B__4_2_OFFSET UNITYSDK_OFFSET(0x1A02EA00)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A02EA10)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A02EA20)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT___BASE_ONPOSTGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A02EA30)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_OnEvent_TypeDefinitionIndex = 63758;

	class LD_AbyssS2_OnEvent : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::Struct_2_C3228BF2D48C5B85 _lastData; // 0xA8
		::FlowCanvas::ValueOutput_1<::MoleMole::AbyssS2_EventType>* _eventOut; // 0xB8
		::FlowCanvas::FlowOutput* _onEvent; // 0xC0
