...
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTRIGGERNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x10E08790)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTRIGGERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x10E08880)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTRIGGERNODE__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x10E088C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDDestroyTriggerNode_TypeDefinitionIndex = 44139;
