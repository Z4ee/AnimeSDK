...
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTRIGGERNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x118B4300)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTRIGGERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x118B43F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTRIGGERNODE__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x118B4430)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDDestroyTriggerNode_TypeDefinitionIndex = 87231;

	class LDDestroyTriggerNode : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::FlowOutput* _output; // 0xA8
		::FlowCanvas::ValueInput_1<::UnityEngine::GameObject*>* inputTrigger; // 0xB0
