...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPLAYERNODE_ISENTITYACTIVE_OFFSET UNITYSDK_OFFSET(0x149D7BE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPLAYERNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x149D7B30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPLAYERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x149D7ED0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPLAYERNODE__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x149D7FA0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetPlayerNode_TypeDefinitionIndex = 90540;
