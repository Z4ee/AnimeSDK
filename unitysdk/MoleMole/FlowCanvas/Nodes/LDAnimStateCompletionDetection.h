...
#define MOLEMOLE_FLOWCANVAS_NODES_LDANIMSTATECOMPLETIONDETECTION_ONANIMSTATEFRAMEREACHED_OFFSET UNITYSDK_OFFSET(0x13830E80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDANIMSTATECOMPLETIONDETECTION_ONENTITYLOST_OFFSET UNITYSDK_OFFSET(0x13830E30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDANIMSTATECOMPLETIONDETECTION_ONFINISH_OFFSET UNITYSDK_OFFSET(0x13831010)
#define MOLEMOLE_FLOWCANVAS_NODES_LDANIMSTATECOMPLETIONDETECTION_REGISTERLISTENER_OFFSET UNITYSDK_OFFSET(0x13830600)
#define MOLEMOLE_FLOWCANVAS_NODES_LDANIMSTATECOMPLETIONDETECTION_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1382FDA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDANIMSTATECOMPLETIONDETECTION_START_OFFSET UNITYSDK_OFFSET(0x1382FF80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDANIMSTATECOMPLETIONDETECTION_UNREGISTERLISTENER_OFFSET UNITYSDK_OFFSET(0x13830CC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDANIMSTATECOMPLETIONDETECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x13831180)
#define MOLEMOLE_FLOWCANVAS_NODES_LDANIMSTATECOMPLETIONDETECTION__REGISTERPORTS_B__11_0_OFFSET UNITYSDK_OFFSET(0x138311D0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDAnimStateCompletionDetection_TypeDefinitionIndex = 72762;

	class LDAnimStateCompletionDetection : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::MoleMole::FlowCanvas::Nodes::NumberCompareType>* animStateFrameCompareInput; // 0xA8
		::FlowCanvas::ValueInput_1<::MoleMole::AnimStateCheckType>* stateDetectionTypeInput; // 0xB0
		::FlowCanvas::ValueInput_1<::MoleMole::Battle::Entity*>* entityInput; // 0xB8
		::FlowCanvas::ValueInput_1<::System::String*>* animStateInput; // 0xC0
		::FlowCanvas::ValueInput_1<::System::Int32>* animStateFrameInput; // 0xC8
		...
		::FlowCanvas::ValueInput_1<::System::Boolean>* transitionOutTriggerInput; // 0xE8
