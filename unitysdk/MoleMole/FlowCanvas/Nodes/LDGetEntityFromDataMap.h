...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYFROMDATAMAP_GETENTITY_OFFSET UNITYSDK_OFFSET(0x16C9F5D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYFROMDATAMAP_LOGERROR_OFFSET UNITYSDK_OFFSET(0x16C9F4B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYFROMDATAMAP_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x16C9F360)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYFROMDATAMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x16C9F990)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYFROMDATAMAP__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x16C9F9D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYFROMDATAMAP__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0x16C9F9E0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetEntityFromDataMap_TypeDefinitionIndex = 58415;

	class LDGetEntityFromDataMap : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::String*>* nameInput; // 0xA8
		::FlowCanvas::ValueInput_1<::MoleMole::FlowCanvas::Nodes::EntitySaveDataMap*>* saveDataMapInput; // 0xB0
