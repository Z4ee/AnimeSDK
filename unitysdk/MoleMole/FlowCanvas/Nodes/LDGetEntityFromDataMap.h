...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYFROMDATAMAP_GETENTITY_OFFSET UNITYSDK_OFFSET(0x18A3AB40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYFROMDATAMAP_LOGERROR_OFFSET UNITYSDK_OFFSET(0x18A3AA20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYFROMDATAMAP_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x18A3A8D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYFROMDATAMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x18A3AF10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYFROMDATAMAP__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x18A3AF50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYFROMDATAMAP__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0x18A3AF60)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetEntityFromDataMap_TypeDefinitionIndex = 41266;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::System::String*>* nameInput; // 0xB0
