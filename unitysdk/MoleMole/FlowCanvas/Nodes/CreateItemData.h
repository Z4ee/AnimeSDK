...
#define MOLEMOLE_FLOWCANVAS_NODES_CREATEITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x118B12F0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int CreateItemData_TypeDefinitionIndex = 63526;
