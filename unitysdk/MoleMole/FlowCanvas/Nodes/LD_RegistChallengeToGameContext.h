...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_REGISTCHALLENGETOGAMECONTEXT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x18B2EBE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_REGISTCHALLENGETOGAMECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18B2ECF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_REGISTCHALLENGETOGAMECONTEXT__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x18B2ED30)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_RegistChallengeToGameContext_TypeDefinitionIndex = 68047;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::System::Int32>* ChallengeID; // 0xB8
