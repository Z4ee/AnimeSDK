...
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2WAVETREASURE_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x16039E40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2WAVETREASURE_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x16039F60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2WAVETREASURE_GETCURRENTMONSTERIDTYPE_OFFSET UNITYSDK_OFFSET(0x16039CF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2WAVETREASURE_ISSHOWELE_OFFSET UNITYSDK_OFFSET(0x16039D30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2WAVETREASURE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x16039C60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2WAVETREASURE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x1603A0B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2WAVETREASURE_TRYFETCHTREASUREID_OFFSET UNITYSDK_OFFSET(0x1603A410)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2WAVETREASURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1603A690)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2WAVETREASURE___BASE_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x1603A6A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2WAVETREASURE___BASE_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x1603A6B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2WAVETREASURE___BASE_GETCURRENTMONSTERIDTYPE_OFFSET UNITYSDK_OFFSET(0x1603A6C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2WAVETREASURE___BASE_ISSHOWELE_OFFSET UNITYSDK_OFFSET(0x1603A6D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2WAVETREASURE___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1603A760)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2WAVETREASURE___BASE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x1603A770)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDAbyssS2WaveTreasure_TypeDefinitionIndex = 57353;
