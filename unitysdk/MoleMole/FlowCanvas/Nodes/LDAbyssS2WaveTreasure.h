...
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2WAVETREASURE_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x1382EA50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2WAVETREASURE_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x1382EB70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2WAVETREASURE_GETCURRENTMONSTERIDTYPE_OFFSET UNITYSDK_OFFSET(0x1382E900)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2WAVETREASURE_ISSHOWELE_OFFSET UNITYSDK_OFFSET(0x1382E940)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2WAVETREASURE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1382E870)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2WAVETREASURE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x1382ECC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2WAVETREASURE_TRYFETCHTREASUREID_OFFSET UNITYSDK_OFFSET(0x1382F020)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2WAVETREASURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1382F2A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2WAVETREASURE___BASE_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x1382F2B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2WAVETREASURE___BASE_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x1382F2C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2WAVETREASURE___BASE_GETCURRENTMONSTERIDTYPE_OFFSET UNITYSDK_OFFSET(0x1382F2D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2WAVETREASURE___BASE_ISSHOWELE_OFFSET UNITYSDK_OFFSET(0x1382F2E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2WAVETREASURE___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1382F370)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2WAVETREASURE___BASE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x1382F380)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDAbyssS2WaveTreasure_TypeDefinitionIndex = 73180;
