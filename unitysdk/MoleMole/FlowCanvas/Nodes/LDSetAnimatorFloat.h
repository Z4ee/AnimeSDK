...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETANIMATORFLOAT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x144CA0B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETANIMATORFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x144CA1E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETANIMATORFLOAT__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x144CA220)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSetAnimatorFloat_TypeDefinitionIndex = 48898;

	class LDSetAnimatorFloat : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::Single>* Value; // 0xA8
