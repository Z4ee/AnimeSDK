...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETANIMATORFLOAT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x161E1740)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETANIMATORFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x161E1870)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETANIMATORFLOAT__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x161E18B0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSetAnimatorFloat_TypeDefinitionIndex = 57140;

	class LDSetAnimatorFloat : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::FlowOutput* output; // 0xA8
		::FlowCanvas::ValueInput_1<::System::Single>* Value; // 0xB0
