...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SHOWCOUNTDOWNUIBYKEY_BEGIN_OFFSET UNITYSDK_OFFSET(0x16B86EF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SHOWCOUNTDOWNUIBYKEY_CLOSE_OFFSET UNITYSDK_OFFSET(0x16B869A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SHOWCOUNTDOWNUIBYKEY_FAIL_OFFSET UNITYSDK_OFFSET(0x16B86830)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SHOWCOUNTDOWNUIBYKEY_GET_NAME_OFFSET UNITYSDK_OFFSET(0x16B86450)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SHOWCOUNTDOWNUIBYKEY_ONFINISH_OFFSET UNITYSDK_OFFSET(0x16B870D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SHOWCOUNTDOWNUIBYKEY_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x16B86460)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SHOWCOUNTDOWNUIBYKEY_SHOWCOUNTDOWNUI_OFFSET UNITYSDK_OFFSET(0x16B86A20)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SHOWCOUNTDOWNUIBYKEY_SUCCESS_OFFSET UNITYSDK_OFFSET(0x16B866C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SHOWCOUNTDOWNUIBYKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x16B87150)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SHOWCOUNTDOWNUIBYKEY__REGISTERPORTS_B__7_0_OFFSET UNITYSDK_OFFSET(0x16B87190)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SHOWCOUNTDOWNUIBYKEY__REGISTERPORTS_B__7_1_OFFSET UNITYSDK_OFFSET(0x16B871B0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_ShowCountDownUIByKey_TypeDefinitionIndex = 75038;
