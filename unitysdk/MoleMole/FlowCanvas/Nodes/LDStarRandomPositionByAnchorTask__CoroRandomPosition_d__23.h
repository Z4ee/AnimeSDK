...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTARRANDOMPOSITIONBYANCHORTASK__CORORANDOMPOSITION_D__23_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x79E540)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTARRANDOMPOSITIONBYANCHORTASK__CORORANDOMPOSITION_D__23_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2661E0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDStarRandomPositionByAnchorTask__CoroRandomPosition_d__23_TypeDefinitionIndex = 66915;
	...
	struct alignas(8) LDStarRandomPositionByAnchorTask__CoroRandomPosition_d__23
	{
		...
		::MoleMole::FlowCanvas::Nodes::LDStarRandomPositionByAnchorTask* __4__this; // 0x20
		::Cysharp::Threading::Tasks::CompilerServices::AsyncUniTaskMethodBuilder __t__builder; // 0x28
		::Class_1_08CADB6A2017E035* _task_5__2; // 0x38
