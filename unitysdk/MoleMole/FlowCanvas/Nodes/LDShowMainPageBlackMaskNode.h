...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWMAINPAGEBLACKMASKNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x14999810)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWMAINPAGEBLACKMASKNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x149998D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWMAINPAGEBLACKMASKNODE__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0x14999910)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDShowMainPageBlackMaskNode_TypeDefinitionIndex = 62346;
