...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHARACTERISMALE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x171010B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHARACTERISMALE__CTOR_OFFSET UNITYSDK_OFFSET(0x171011E0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCharacterIsMale_TypeDefinitionIndex = 84914;
