...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_INLEVELINTERACTIONFEEDBACK_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x16D46380)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_INLEVELINTERACTIONFEEDBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x16D46460)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_INLEVELINTERACTIONFEEDBACK__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x16D464A0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_InLevelInteractionFeedback_TypeDefinitionIndex = 75937;
