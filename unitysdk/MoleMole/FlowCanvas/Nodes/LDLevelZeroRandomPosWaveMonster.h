...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_BEGIN_OFFSET UNITYSDK_OFFSET(0x17104A80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x17106040)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_EXPENDCREATEDLIST_OFFSET UNITYSDK_OFFSET(0x17105500)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_FULLCREATEDLIST_OFFSET UNITYSDK_OFFSET(0x17104C40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x17105FE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x17105EE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_GETCURRENTMONSTERIDTYPE_OFFSET UNITYSDK_OFFSET(0x17104A30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_GETCURRENTTAG_OFFSET UNITYSDK_OFFSET(0x17106250)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_GETMONSTERTYPE_OFFSET UNITYSDK_OFFSET(0x17106300)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_PREPROCESSMONSTERCREATELIST_OFFSET UNITYSDK_OFFSET(0x17104E90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x17104560)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x17106410)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER__REGISTERPORTS_B__7_0_OFFSET UNITYSDK_OFFSET(0x171064F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER__REGISTERPORTS_B__7_1_OFFSET UNITYSDK_OFFSET(0x17106520)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER__REGISTERPORTS_B__7_2_OFFSET UNITYSDK_OFFSET(0x17106640)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER__REGISTERPORTS_B__7_3_OFFSET UNITYSDK_OFFSET(0x17106670)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER__REGISTERPORTS_B__7_4_OFFSET UNITYSDK_OFFSET(0x17106680)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER__REGISTERPORTS_B__7_5_OFFSET UNITYSDK_OFFSET(0x17106690)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER___BASE_BEGIN_OFFSET UNITYSDK_OFFSET(0x171066A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER___BASE_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x171066D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER___BASE_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x171066E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER___BASE_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x171066F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER___BASE_GETCURRENTMONSTERIDTYPE_OFFSET UNITYSDK_OFFSET(0x17106700)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x17106710)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDLevelZeroRandomPosWaveMonster_TypeDefinitionIndex = 41019;

	class LDLevelZeroRandomPosWaveMonster : public ::MoleMole::FlowCanvas::Nodes::LDWaveMonsterPosRandom
	{
	public:
		::FlowCanvas::ValueInput_1<::MoleMole::Project::Config::MonsterGroupTemplateExt_MonsterTypeEnum>* typeInput; // 0x1F0
		::System::Collections::Generic::List_1<::MoleMole::FlowCanvas::Nodes::MonsterCreateData*>* extendCreateData; // 0x1F8
		::System::Collections::Generic::List_1<::MoleMole::FlowCanvas::LevelZeroRandomPosMonsterCreateData*>* PostCreateData; // 0x200
		...
		::FlowCanvas::ValueInput_1<::System::Int32>* tagInput; // 0x210
