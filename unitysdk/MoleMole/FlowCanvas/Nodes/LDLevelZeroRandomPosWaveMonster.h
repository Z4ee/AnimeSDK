...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_BEGIN_OFFSET UNITYSDK_OFFSET(0x1498FA20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x14991000)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_EXPENDCREATEDLIST_OFFSET UNITYSDK_OFFSET(0x149904A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_FULLCREATEDLIST_OFFSET UNITYSDK_OFFSET(0x1498FBE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x14990FA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x14990EA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_GETCURRENTMONSTERIDTYPE_OFFSET UNITYSDK_OFFSET(0x1498F9D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_GETCURRENTTAG_OFFSET UNITYSDK_OFFSET(0x14991210)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_GETMONSTERTYPE_OFFSET UNITYSDK_OFFSET(0x149912C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_PREPROCESSMONSTERCREATELIST_OFFSET UNITYSDK_OFFSET(0x1498FE30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1498F500)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x149913D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER__REGISTERPORTS_B__7_0_OFFSET UNITYSDK_OFFSET(0x149914B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER__REGISTERPORTS_B__7_1_OFFSET UNITYSDK_OFFSET(0x149914E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER__REGISTERPORTS_B__7_2_OFFSET UNITYSDK_OFFSET(0x14991600)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER__REGISTERPORTS_B__7_3_OFFSET UNITYSDK_OFFSET(0x14991630)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER__REGISTERPORTS_B__7_4_OFFSET UNITYSDK_OFFSET(0x14991640)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER__REGISTERPORTS_B__7_5_OFFSET UNITYSDK_OFFSET(0x14991650)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER___BASE_BEGIN_OFFSET UNITYSDK_OFFSET(0x14991660)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER___BASE_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x14991690)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER___BASE_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x149916A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER___BASE_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x149916B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER___BASE_GETCURRENTMONSTERIDTYPE_OFFSET UNITYSDK_OFFSET(0x149916C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x149916D0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDLevelZeroRandomPosWaveMonster_TypeDefinitionIndex = 81907;

	class LDLevelZeroRandomPosWaveMonster : public ::MoleMole::FlowCanvas::Nodes::LDWaveMonsterPosRandom
	{
	public:
		::System::Collections::Generic::List_1<::MoleMole::FlowCanvas::Nodes::MonsterCreateData*>* extendCreateData; // 0x1F0
		::System::Collections::Generic::List_1<::MoleMole::FlowCanvas::LevelZeroRandomPosMonsterCreateData*>* PostCreateData; // 0x1F8
		::FlowCanvas::ValueInput_1<::System::Collections::Generic::List_1<::MoleMole::FlowCanvas::LevelZeroRandomPosMonsterCreateData*>*>* levelZeroCreateInput; // 0x200
		::FlowCanvas::ValueInput_1<::System::Int32>* tagInput; // 0x208
		::FlowCanvas::ValueInput_1<::MoleMole::Project::Config::MonsterGroupTemplateExt_MonsterTypeEnum>* typeInput; // 0x210
