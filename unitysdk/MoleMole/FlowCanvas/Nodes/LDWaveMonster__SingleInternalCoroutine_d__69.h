...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER__SINGLEINTERNALCOROUTINE_D__69_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A02A920)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER__SINGLEINTERNALCOROUTINE_D__69_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A02B6F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER__SINGLEINTERNALCOROUTINE_D__69_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A02B750)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER__SINGLEINTERNALCOROUTINE_D__69_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A02B700)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER__SINGLEINTERNALCOROUTINE_D__69_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A02A910)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER__SINGLEINTERNALCOROUTINE_D__69__CTOR_OFFSET UNITYSDK_OFFSET(0x1A02A900)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveMonster__SingleInternalCoroutine_d__69_TypeDefinitionIndex = 60400;
	...
	public:
		...
		::MoleMole::FlowCanvas::Nodes::MonsterCreateDataBase* _createData_5__4; // 0x40
		::MoleMole::FlowCanvas::Nodes::LDWaveMonster* __4__this; // 0x48
		::MoleMole::FlowCanvas::Nodes::LDWaveMonster___c__DisplayClass69_0* __8__1; // 0x50
		::System::Int32 _createListLen_5__2; // 0x58
		::System::Boolean _doWait_5__3; // 0x5C
