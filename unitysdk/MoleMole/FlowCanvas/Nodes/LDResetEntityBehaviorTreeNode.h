...
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETENTITYBEHAVIORTREENODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x11744910)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETENTITYBEHAVIORTREENODE_ISCOULDOUTCALL_OFFSET UNITYSDK_OFFSET(0x11744BD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETENTITYBEHAVIORTREENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x11744C20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETENTITYBEHAVIORTREENODE__INVOKE_B__0_0_OFFSET UNITYSDK_OFFSET(0x11744C40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETENTITYBEHAVIORTREENODE___BASE_ISCOULDOUTCALL_OFFSET UNITYSDK_OFFSET(0x11744CE0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDResetEntityBehaviorTreeNode_TypeDefinitionIndex = 82644;
