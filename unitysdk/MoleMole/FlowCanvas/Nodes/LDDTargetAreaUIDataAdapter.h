...
#define MOLEMOLE_FLOWCANVAS_NODES_LDDTARGETAREAUIDATAADAPTER_GETANCHORS_OFFSET UNITYSDK_OFFSET(0x8AF410)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDTARGETAREAUIDATAADAPTER_GETSTYLES_OFFSET UNITYSDK_OFFSET(0x8AF420)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDTARGETAREAUIDATAADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x8AF430)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDDTargetAreaUIDataAdapter_TypeDefinitionIndex = 58876;
