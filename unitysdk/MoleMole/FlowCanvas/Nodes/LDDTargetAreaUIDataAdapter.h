...
#define MOLEMOLE_FLOWCANVAS_NODES_LDDTARGETAREAUIDATAADAPTER_GETANCHORS_OFFSET UNITYSDK_OFFSET(0x74C9E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDTARGETAREAUIDATAADAPTER_GETSTYLES_OFFSET UNITYSDK_OFFSET(0x74C9F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDTARGETAREAUIDATAADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x74CA00)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDDTargetAreaUIDataAdapter_TypeDefinitionIndex = 52619;
