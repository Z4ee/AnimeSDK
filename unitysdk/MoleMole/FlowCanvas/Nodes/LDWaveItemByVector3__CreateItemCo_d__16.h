...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEITEMBYVECTOR3__CREATEITEMCO_D__16_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x192459D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEITEMBYVECTOR3__CREATEITEMCO_D__16_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19246120)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEITEMBYVECTOR3__CREATEITEMCO_D__16_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19246180)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEITEMBYVECTOR3__CREATEITEMCO_D__16_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19246130)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEITEMBYVECTOR3__CREATEITEMCO_D__16_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x192459C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEITEMBYVECTOR3__CREATEITEMCO_D__16__CTOR_OFFSET UNITYSDK_OFFSET(0x192459B0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveItemByVector3__CreateItemCo_d__16_TypeDefinitionIndex = 41294;

	class LDWaveItemByVector3__CreateItemCo_d__16 : public ::System::Object
	{
	public:
		::MoleMole::GameplayTag _tag_5__2; // 0x10
		::MoleMole::FlowCanvas::Nodes::LDWaveItemByVector3* __4__this; // 0x20
