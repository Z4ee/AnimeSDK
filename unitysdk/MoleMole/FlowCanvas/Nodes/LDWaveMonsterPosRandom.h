...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM_ACTIVEPRELOADMONSTER_OFFSET UNITYSDK_OFFSET(0x125C0410)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM_BEGIN_OFFSET UNITYSDK_OFFSET(0x125C0D20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x125C14D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x125BF730)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM_SEARCHANCHORBYPREFIX_OFFSET UNITYSDK_OFFSET(0x125C0250)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x125BFBF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0x125C1770)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM__REGISTERPORTS_B__8_0_OFFSET UNITYSDK_OFFSET(0x125C17D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM__REGISTERPORTS_B__8_1_OFFSET UNITYSDK_OFFSET(0x125C1810)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM__REGISTERPORTS_B__8_2_OFFSET UNITYSDK_OFFSET(0x125C1930)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM__REGISTERPORTS_B__8_3_OFFSET UNITYSDK_OFFSET(0x125C1960)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM__REGISTERPORTS_B__8_4_OFFSET UNITYSDK_OFFSET(0x125C1970)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM__REGISTERPORTS_B__8_5_OFFSET UNITYSDK_OFFSET(0x125C1980)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM___BASE_ACTIVEPRELOADMONSTER_OFFSET UNITYSDK_OFFSET(0x125C19D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM___BASE_BEGIN_OFFSET UNITYSDK_OFFSET(0x125C1990)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM___BASE_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x125C1A90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x125C1AA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM___BASE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x125C19C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveMonsterPosRandom_TypeDefinitionIndex = 81880;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::System::Single>* minimumRadiusInput; // 0x1C0
		::System::Collections::Generic::HashSet_1<::System::Int32>* alreadySearchedSet; // 0x1C8
		::FlowCanvas::ValueInput_1<::System::String*>* anchorPosPrefixInput; // 0x1D0
		::FlowCanvas::ValueInput_1<::MoleMole::Battle::Entity*>* inputPosEntity; // 0x1D8
		::Class_3_DFD5D1FDB9D2A4AC* inputModelComponent; // 0x1E0
