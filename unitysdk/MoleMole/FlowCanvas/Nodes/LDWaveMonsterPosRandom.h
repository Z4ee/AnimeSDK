...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM_ACTIVEPRELOADMONSTER_OFFSET UNITYSDK_OFFSET(0x13014130)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM_BEGIN_OFFSET UNITYSDK_OFFSET(0x13014A40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x130151E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x13013450)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM_SEARCHANCHORBYPREFIX_OFFSET UNITYSDK_OFFSET(0x13013F70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x13013910)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0x13015470)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM__REGISTERPORTS_B__8_0_OFFSET UNITYSDK_OFFSET(0x130154D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM__REGISTERPORTS_B__8_1_OFFSET UNITYSDK_OFFSET(0x13015510)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM__REGISTERPORTS_B__8_2_OFFSET UNITYSDK_OFFSET(0x13015630)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM__REGISTERPORTS_B__8_3_OFFSET UNITYSDK_OFFSET(0x13015660)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM__REGISTERPORTS_B__8_4_OFFSET UNITYSDK_OFFSET(0x13015670)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM__REGISTERPORTS_B__8_5_OFFSET UNITYSDK_OFFSET(0x13015680)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM___BASE_ACTIVEPRELOADMONSTER_OFFSET UNITYSDK_OFFSET(0x130156D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM___BASE_BEGIN_OFFSET UNITYSDK_OFFSET(0x13015690)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM___BASE_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x13015790)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x130157A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM___BASE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x130156C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveMonsterPosRandom_TypeDefinitionIndex = 41836;

	class LDWaveMonsterPosRandom : public ::MoleMole::FlowCanvas::Nodes::LDWaveMonster
	{
	public:
		::FlowCanvas::ValueInput_1<::System::Single>* minimumRadiusInput; // 0x1B0
		::System::Collections::Generic::HashSet_1<::System::Int32>* alreadySearchedSet; // 0x1B8
		::Class_3_DFD5D1FDB9D2A4AC* inputModelComponent; // 0x1C0
		::FlowCanvas::ValueInput_1<::MoleMole::Battle::Entity*>* inputPosEntity; // 0x1C8
		::FlowCanvas::ValueInput_1<::System::Single>* radiusInput; // 0x1D0
		::FlowCanvas::ValueInput_1<::System::Single>* angleRangeInput; // 0x1D8
		::FlowCanvas::ValueInput_1<::System::String*>* anchorPosPrefixInput; // 0x1E0
