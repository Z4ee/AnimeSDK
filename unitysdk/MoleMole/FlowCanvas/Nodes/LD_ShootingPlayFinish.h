...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SHOOTINGPLAYFINISH_ONREGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x16CAB580)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SHOOTINGPLAYFINISH_START_OFFSET UNITYSDK_OFFSET(0x16CAB650)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SHOOTINGPLAYFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x16CAB820)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_ShootingPlayFinish_TypeDefinitionIndex = 76198;
