...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ISDEVLEVEL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B1B1E60)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ISDEVLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1B1EC0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_IsDevLevel_TypeDefinitionIndex = 65480;
