...
#define MOLEMOLE_FLOWCANVAS_NODES_BANDTRAPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18205660)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int BandTrapData_TypeDefinitionIndex = 40057;
