...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTEAMAVATAR_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x16E4ED70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTEAMAVATAR_SHOWAVATAR_OFFSET UNITYSDK_OFFSET(0x16E4EE60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTEAMAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x16E4F1F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTEAMAVATAR__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x16E4F230)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDShowTeamAvatar_TypeDefinitionIndex = 81727;
