...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTEAMAVATAR_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1684C840)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTEAMAVATAR_SHOWAVATAR_OFFSET UNITYSDK_OFFSET(0x1684C930)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTEAMAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1684CCC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTEAMAVATAR__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x1684CD00)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDShowTeamAvatar_TypeDefinitionIndex = 66271;
