...
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDPIECEPARTICLEPLAYANIMATION_INVOKE_OFFSET UNITYSDK_OFFSET(0x18411680)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDPIECEPARTICLEPLAYANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x18411730)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ChessboardPieceParticlePlayAnimation_TypeDefinitionIndex = 54565;
