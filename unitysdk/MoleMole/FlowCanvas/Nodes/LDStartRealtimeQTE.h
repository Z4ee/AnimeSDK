...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTARTREALTIMEQTE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x17E740F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTARTREALTIMEQTE_STARTREALTIMEQTE_OFFSET UNITYSDK_OFFSET(0x17E74260)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTARTREALTIMEQTE__CTOR_OFFSET UNITYSDK_OFFSET(0x17E744F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTARTREALTIMEQTE__REGISTERPORTS_B__6_0_OFFSET UNITYSDK_OFFSET(0x17E74530)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDStartRealtimeQTE_TypeDefinitionIndex = 54656;
