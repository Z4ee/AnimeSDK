...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTARTREALTIMEQTE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x16B84090)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTARTREALTIMEQTE_STARTREALTIMEQTE_OFFSET UNITYSDK_OFFSET(0x16B84200)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTARTREALTIMEQTE__CTOR_OFFSET UNITYSDK_OFFSET(0x16B84490)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTARTREALTIMEQTE__REGISTERPORTS_B__6_0_OFFSET UNITYSDK_OFFSET(0x16B844D0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDStartRealtimeQTE_TypeDefinitionIndex = 45835;
