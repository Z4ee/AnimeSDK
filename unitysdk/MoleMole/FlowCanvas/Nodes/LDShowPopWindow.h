...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWPOPWINDOW_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x144CAC20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWPOPWINDOW_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x144CAAC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWPOPWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0x144CAE50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWPOPWINDOW__REGISTERPORTS_B__7_0_OFFSET UNITYSDK_OFFSET(0x144CAE90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWPOPWINDOW__REGISTERPORTS_B__7_1_OFFSET UNITYSDK_OFFSET(0x144CB470)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWPOPWINDOW__REGISTERPORTS_B__7_2_OFFSET UNITYSDK_OFFSET(0x144CB430)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWPOPWINDOW___BASE_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x144CB4B0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDShowPopWindow_TypeDefinitionIndex = 63483;
	...
	public:
		...
		::MoleMole::UITutorialDialog* preloadDialog; // 0xB8
		::FlowCanvas::FlowOutput* output; // 0xC0
		::FlowCanvas::ValueInput_1<::System::Int32>* showPage; // 0xC8
		::FlowCanvas::FlowOutput* onClosed; // 0xD0
		::FlowCanvas::ValueInput_1<::System::Int32>* popID; // 0xD8
