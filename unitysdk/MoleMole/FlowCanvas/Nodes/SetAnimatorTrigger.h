...
#define MOLEMOLE_FLOWCANVAS_NODES_SETANIMATORTRIGGER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x10BB9B10)
#define MOLEMOLE_FLOWCANVAS_NODES_SETANIMATORTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x10BB9C20)
#define MOLEMOLE_FLOWCANVAS_NODES_SETANIMATORTRIGGER__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x10BB9C60)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int SetAnimatorTrigger_TypeDefinitionIndex = 64703;
