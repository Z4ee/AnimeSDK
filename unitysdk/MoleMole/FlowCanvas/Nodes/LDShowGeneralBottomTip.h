...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWGENERALBOTTOMTIP_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1B83C060)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWGENERALBOTTOMTIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B83C180)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWGENERALBOTTOMTIP__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x1B83C1C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDShowGeneralBottomTip_TypeDefinitionIndex = 74838;
