...
#define MOLEMOLE_FLOWCANVAS_NODES_LDZEROGMENDNODE___C__DISPLAYCLASS0_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1907E710)
#define MOLEMOLE_FLOWCANVAS_NODES_LDZEROGMENDNODE___C__DISPLAYCLASS0_0__INVOKE_B__0_OFFSET UNITYSDK_OFFSET(0x1907E720)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDZeroGmEndNode___c__DisplayClass0_0_TypeDefinitionIndex = 80977;
