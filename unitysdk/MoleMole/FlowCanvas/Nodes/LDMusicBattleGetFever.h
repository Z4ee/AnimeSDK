...
#define MOLEMOLE_FLOWCANVAS_NODES_LDMUSICBATTLEGETFEVER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1710ABA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMUSICBATTLEGETFEVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1710AC30)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDMusicBattleGetFever_TypeDefinitionIndex = 44399;
