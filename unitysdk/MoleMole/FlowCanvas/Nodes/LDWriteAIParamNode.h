...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWRITEAIPARAMNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19246430)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWRITEAIPARAMNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19246690)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWriteAIParamNode_TypeDefinitionIndex = 89850;
