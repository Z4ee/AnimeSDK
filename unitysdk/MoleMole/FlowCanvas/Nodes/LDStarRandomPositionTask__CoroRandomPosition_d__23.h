...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTARRANDOMPOSITIONTASK__CORORANDOMPOSITION_D__23_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x7A3400)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTARRANDOMPOSITIONTASK__CORORANDOMPOSITION_D__23_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x283610)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDStarRandomPositionTask__CoroRandomPosition_d__23_TypeDefinitionIndex = 58392;

	struct alignas(8) LDStarRandomPositionTask__CoroRandomPosition_d__23
	{
		::MoleMole::FlowCanvas::Nodes::LDStarRandomPositionTask* __4__this; // 0x10
		::Class_1_A5F0BA8465FA1EC2* _task_5__2; // 0x18
