...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHERV2_POP_OFFSET UNITYSDK_OFFSET(0x16E54250)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHERV2_PUSH_OFFSET UNITYSDK_OFFSET(0x16E54000)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHERV2_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x16E53EB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHERV2__CTOR_OFFSET UNITYSDK_OFFSET(0x16E54520)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHERV2__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x16E54560)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHERV2__REGISTERPORTS_B__3_1_OFFSET UNITYSDK_OFFSET(0x16E54590)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_SetDynamicOverrideWeatherV2_TypeDefinitionIndex = 58350;

	class LD_SetDynamicOverrideWeatherV2 : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::FlowOutput* Output; // 0xA8
		::FlowCanvas::ValueInput_1<::System::Boolean>* immediateKey; // 0xB0
		::FlowCanvas::ValueInput_1<::System::String*>* weatherKey; // 0xB8
