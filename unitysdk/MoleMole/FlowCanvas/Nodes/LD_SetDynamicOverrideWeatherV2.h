...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHERV2_POP_OFFSET UNITYSDK_OFFSET(0x16851EF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHERV2_PUSH_OFFSET UNITYSDK_OFFSET(0x16851CB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHERV2_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x16851B60)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHERV2__CTOR_OFFSET UNITYSDK_OFFSET(0x168521B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHERV2__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x168521F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHERV2__REGISTERPORTS_B__3_1_OFFSET UNITYSDK_OFFSET(0x16852220)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_SetDynamicOverrideWeatherV2_TypeDefinitionIndex = 45327;
