...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERRANDOMTYPE__INTERNALCOROUTINE_D__41_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x125C51E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERRANDOMTYPE__INTERNALCOROUTINE_D__41_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x125C5F00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERRANDOMTYPE__INTERNALCOROUTINE_D__41_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x125C5F60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERRANDOMTYPE__INTERNALCOROUTINE_D__41_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x125C5F10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERRANDOMTYPE__INTERNALCOROUTINE_D__41_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x125C51D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERRANDOMTYPE__INTERNALCOROUTINE_D__41__CTOR_OFFSET UNITYSDK_OFFSET(0x125C3190)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveMonsterRandomType__InternalCoroutine_d__41_TypeDefinitionIndex = 66636;

	class LDWaveMonsterRandomType__InternalCoroutine_d__41 : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::MoleMole::FlowCanvas::Nodes::MonsterCreateData*>* _list_5__2; // 0x10
		::System::Object* __2__current; // 0x18
		::FlowCanvas::Flow f; // 0x20
		::MoleMole::FlowCanvas::Nodes::MonsterCreateData* _createData_5__3; // 0x48
		::MoleMole::FlowCanvas::Nodes::LDWaveMonsterRandomType* __4__this; // 0x50
		::MoleMole::FlowCanvas::Nodes::LDWaveMonsterRandomType___c__DisplayClass41_0* __8__1; // 0x58
