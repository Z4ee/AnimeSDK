...
#define MOLEMOLE_FLOWCANVAS_NODES_LDHADAL_ACTIVETIMER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x18B21A70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDHADAL_ACTIVETIMER__CTOR_OFFSET UNITYSDK_OFFSET(0x18B21B80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDHADAL_ACTIVETIMER__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x18B21BC0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDHadal_ActiveTimer_TypeDefinitionIndex = 63097;

	class LDHadal_ActiveTimer : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::String*>* _timerKey; // 0xA8
		::FlowCanvas::ValueInput_1<::System::Single>* _timerExpired; // 0xB0
