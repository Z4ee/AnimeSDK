...
#define MOLEMOLE_FLOWCANVAS_NODES_NAPCAMERASEQUENCEHANDLE_ISVALID_1_OFFSET UNITYSDK_OFFSET(0x7E7B90)
#define MOLEMOLE_FLOWCANVAS_NODES_NAPCAMERASEQUENCEHANDLE_ISVALID_OFFSET UNITYSDK_OFFSET(0x7E7B60)
#define MOLEMOLE_FLOWCANVAS_NODES_NAPCAMERASEQUENCEHANDLE_JUMPTOSECTION_OFFSET UNITYSDK_OFFSET(0x7E7BA0)
#define MOLEMOLE_FLOWCANVAS_NODES_NAPCAMERASEQUENCEHANDLE_STOP_OFFSET UNITYSDK_OFFSET(0x7E7BB0)
#define MOLEMOLE_FLOWCANVAS_NODES_NAPCAMERASEQUENCEHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x7E7B50)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int NapCameraSequenceHandle_TypeDefinitionIndex = 53171;
