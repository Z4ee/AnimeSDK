...
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDPIECEPLAYNAPEFFECT_INVOKE_OFFSET UNITYSDK_OFFSET(0x177FD720)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDPIECEPLAYNAPEFFECT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x177FD9D0)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDPIECEPLAYNAPEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x177FDB40)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDPIECEPLAYNAPEFFECT___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x177FDBF0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ChessboardPiecePlayNapEffect_TypeDefinitionIndex = 76931;
