...
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDPIECEPLAYNAPEFFECT_INVOKE_OFFSET UNITYSDK_OFFSET(0x182CE670)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDPIECEPLAYNAPEFFECT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x182CE920)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDPIECEPLAYNAPEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x182CEA90)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDPIECEPLAYNAPEFFECT___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x182CEB40)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ChessboardPiecePlayNapEffect_TypeDefinitionIndex = 86181;
