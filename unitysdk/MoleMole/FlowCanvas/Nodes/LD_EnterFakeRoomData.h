...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ENTERFAKEROOMDATA_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x171115A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ENTERFAKEROOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17111660)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ENTERFAKEROOMDATA__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0x171116A0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_EnterFakeRoomData_TypeDefinitionIndex = 71270;
