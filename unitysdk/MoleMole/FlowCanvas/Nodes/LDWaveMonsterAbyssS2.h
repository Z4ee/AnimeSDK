...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_ACTIVEPRELOADMONSTER_OFFSET UNITYSDK_OFFSET(0x1300F810)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_BEGIN_OFFSET UNITYSDK_OFFSET(0x13012DE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_BUILDCREATEVALUES_OFFSET UNITYSDK_OFFSET(0x1300EAD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x1300E6C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_GETCENTERANCHORNAME_OFFSET UNITYSDK_OFFSET(0x1300FE30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x13012A10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x1300FDA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_ISSPAWNPOINTINEXCLUDEREGION_OFFSET UNITYSDK_OFFSET(0x13011950)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1300E290)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_SEARCHACHORBYPREFIX_OFFSET UNITYSDK_OFFSET(0x13010C10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_SEARCHMONSTERSPAWNERPOINT_OFFSET UNITYSDK_OFFSET(0x13010440)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_SEARCHVALIDPOINTBYDISTANCEANDANGLE_OFFSET UNITYSDK_OFFSET(0x130124B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_STARTSPAWN_OFFSET UNITYSDK_OFFSET(0x13012A70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x13012E80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_WRAPANGLERANGE_OFFSET UNITYSDK_OFFSET(0x130123E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2__CTOR_OFFSET UNITYSDK_OFFSET(0x130130B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2__REGISTERPORTS_B__10_0_OFFSET UNITYSDK_OFFSET(0x130130D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2__REGISTERPORTS_B__10_1_OFFSET UNITYSDK_OFFSET(0x13013190)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2__REGISTERPORTS_B__10_2_OFFSET UNITYSDK_OFFSET(0x130132B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2__REGISTERPORTS_B__10_3_OFFSET UNITYSDK_OFFSET(0x130132E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2__REGISTERPORTS_B__10_4_OFFSET UNITYSDK_OFFSET(0x130132F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2__REGISTERPORTS_B__10_5_OFFSET UNITYSDK_OFFSET(0x13013300)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2___BASE_ACTIVEPRELOADMONSTER_OFFSET UNITYSDK_OFFSET(0x13013310)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2___BASE_BEGIN_OFFSET UNITYSDK_OFFSET(0x130133D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2___BASE_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x13013400)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2___BASE_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x13013410)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2___BASE_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x13013420)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x13013430)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2___BASE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x13013440)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveMonsterAbyssS2_TypeDefinitionIndex = 84667;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::System::Collections::Generic::List_1<::System::String*>*>* _excludeRegionList; // 0x1B8
		::System::Collections::Generic::List_1<::MoleMole::FlowCanvas::Nodes::AbyssS2PatternMonsterCreate*>* monsterCreateValues; // 0x1C0
		::FlowCanvas::ValueInput_1<::System::Int32>* monsterWaveRawIndex; // 0x1C8
		::FlowCanvas::ValueInput_1<::System::Single>* radiusInput; // 0x1D0
		::FlowCanvas::ValueInput_1<::System::Single>* spawnIntervalInput; // 0x1D8
		::FlowCanvas::ValueInput_1<::MoleMole::Battle::Entity*>* inputPosEntity; // 0x1E0
		::FlowCanvas::ValueInput_1<::System::String*>* anchorPosPrefixInput; // 0x1E8
