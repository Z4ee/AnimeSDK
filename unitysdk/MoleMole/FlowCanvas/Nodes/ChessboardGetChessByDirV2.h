...
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDGETCHESSBYDIRV2_INVOKE_OFFSET UNITYSDK_OFFSET(0x125AABB0)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDGETCHESSBYDIRV2__CTOR_OFFSET UNITYSDK_OFFSET(0x125AAF00)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ChessboardGetChessByDirV2_TypeDefinitionIndex = 42021;
