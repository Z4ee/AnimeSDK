...
#define MOLEMOLE_FLOWCANVAS_NODES_EXTERNALOPENDIRECTIONRESOLVER_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x10B9F370)
#define MOLEMOLE_FLOWCANVAS_NODES_EXTERNALOPENDIRECTIONRESOLVER_GETDATA_OFFSET UNITYSDK_OFFSET(0x10B9F510)
#define MOLEMOLE_FLOWCANVAS_NODES_EXTERNALOPENDIRECTIONRESOLVER_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x10B9F690)
#define MOLEMOLE_FLOWCANVAS_NODES_EXTERNALOPENDIRECTIONRESOLVER_METHOD_4_439B588EB4881570_OFFSET UNITYSDK_OFFSET(0x10B9F720)
#define MOLEMOLE_FLOWCANVAS_NODES_EXTERNALOPENDIRECTIONRESOLVER_METHOD_4_5A60CCF7370A1875_OFFSET UNITYSDK_OFFSET(0x10B9F7B0)
#define MOLEMOLE_FLOWCANVAS_NODES_EXTERNALOPENDIRECTIONRESOLVER_METHOD_4_BB75FB1EF4C67D87_OFFSET UNITYSDK_OFFSET(0x10B9F8A0)
#define MOLEMOLE_FLOWCANVAS_NODES_EXTERNALOPENDIRECTIONRESOLVER_SETPATH_OFFSET UNITYSDK_OFFSET(0x10B9F2D0)
#define MOLEMOLE_FLOWCANVAS_NODES_EXTERNALOPENDIRECTIONRESOLVER__CCTOR_OFFSET UNITYSDK_OFFSET(0x10B9F6C0)
#define MOLEMOLE_FLOWCANVAS_NODES_EXTERNALOPENDIRECTIONRESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x10B9F6A0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ExternalOpenDirectionResolver_TypeDefinitionIndex = 65457;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(ExternalOpenDirectionResolver_TypeDefinitionIndex)->GetStaticField(0xF450);
		}
