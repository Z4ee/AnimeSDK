...
#define MOLEMOLE_FLOWCANVAS_NODES_LDREMOVEBUBBLENODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x16D3EAF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDREMOVEBUBBLENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x16D3EBE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDREMOVEBUBBLENODE__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x16D3EC20)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDRemoveBubbleNode_TypeDefinitionIndex = 51154;
