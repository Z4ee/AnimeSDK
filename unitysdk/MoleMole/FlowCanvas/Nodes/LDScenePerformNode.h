...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEPERFORMNODE_MOLEMOLE_FLOWCANVAS_NODES_ISCENEPERFORMCOROUTINEPROVIDER_STARTCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1B838E00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEPERFORMNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1B8386E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEPERFORMNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B838DC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEPERFORMNODE__NEWINVOKE_OFFSET UNITYSDK_OFFSET(0x1B8389D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEPERFORMNODE__REGISTERPORTS_B__9_0_OFFSET UNITYSDK_OFFSET(0x1B838E50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEPERFORMNODE__WRAPCALLBACK_OFFSET UNITYSDK_OFFSET(0x1B8388C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEPERFORMNODE___WRAPCALLBACK_B__10_0_OFFSET UNITYSDK_OFFSET(0x1B838E80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEPERFORMNODE___WRAPCALLBACK_B__10_1_OFFSET UNITYSDK_OFFSET(0x1B838EC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEPERFORMNODE___WRAPCALLBACK_B__10_2_OFFSET UNITYSDK_OFFSET(0x1B838F00)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDScenePerformNode_TypeDefinitionIndex = 64554;

	class LDScenePerformNode : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::Boolean>* IsSkipBanner; // 0xA8
		::FlowCanvas::ValueInput_1<::MoleMole::LevelSectionGroupData*>* sectionInput; // 0xB0
		::FlowCanvas::ValueInput_1<::System::Boolean>* StartScenePerform; // 0xB8
		::FlowCanvas::ValueInput_1<::System::Collections::Generic::List_1<::MoleMole::Battle::Entity*>*>* entityInput; // 0xC0
		::FlowCanvas::FlowOutput* output; // 0xC8
		::FlowCanvas::FlowOutput* realPlayOutput; // 0xD0
		::FlowCanvas::FlowOutput* notPlayOutput; // 0xD8
		::FlowCanvas::ValueInput_1<::System::Boolean>* IsBannerOn; // 0xE0
		::Class_1_49266A9AAF1C928E_Class_1_02F8008115ABA9CB* _performRuntime; // 0xE8
		...
		::Class_1_49266A9AAF1C928E_Struct_2_52459899DB7358B9 _WrapCallback()
		{
			return ((::Class_1_49266A9AAF1C928E_Struct_2_52459899DB7358B9(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_FLOWCANVAS_NODES_LDSCENEPERFORMNODE__WRAPCALLBACK_OFFSET))(this);
		}
