...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETGLOBALVARIABLE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1499C9D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETGLOBALVARIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1499CC60)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_GetGlobalVariable_TypeDefinitionIndex = 80216;
