...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LEVELMONSTERPROPERTYMODIFYBYIDNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x16E51CF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LEVELMONSTERPROPERTYMODIFYBYIDNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x16E51E10)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LEVELMONSTERPROPERTYMODIFYBYIDNODE__REGISTERPORTS_B__2_1_OFFSET UNITYSDK_OFFSET(0x16E522D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LEVELMONSTERPROPERTYMODIFYBYIDNODE__REGISTERPORTS_B__2_2_OFFSET UNITYSDK_OFFSET(0x16E52320)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LEVELMONSTERPROPERTYMODIFYBYIDNODE__REGISTERPORTS_G___SETKEY_2_0_OFFSET UNITYSDK_OFFSET(0x16E51E50)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_LevelMonsterPropertyModifyByIDNode_TypeDefinitionIndex = 43315;
