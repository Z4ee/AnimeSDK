...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_GETNEXTSELECTIONS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1301A200)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_GETNEXTSELECTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1301A360)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_GetNextSelections_TypeDefinitionIndex = 73670;
