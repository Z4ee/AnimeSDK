...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATESTAGENODE_CREATESTAGE_OFFSET UNITYSDK_OFFSET(0x1427AEB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATESTAGENODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1427AC50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATESTAGENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1427AF50)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCreateStageNode_TypeDefinitionIndex = 64312;
