...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPASSEDPATROLPOINT_BINDEVENT_OFFSET UNITYSDK_OFFSET(0x1427BCA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPASSEDPATROLPOINT_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x1427C040)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPASSEDPATROLPOINT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1427BE40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPASSEDPATROLPOINT_ONNODETASKFINISH_OFFSET UNITYSDK_OFFSET(0x1427C330)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPASSEDPATROLPOINT_ONPASSWAYPOINT_OFFSET UNITYSDK_OFFSET(0x1427C290)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPASSEDPATROLPOINT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1427B840)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPASSEDPATROLPOINT_STARTLISTEN_OFFSET UNITYSDK_OFFSET(0x1427BA20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPASSEDPATROLPOINT_UNBINDEVENT_OFFSET UNITYSDK_OFFSET(0x1427BEA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPASSEDPATROLPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1427C390)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPASSEDPATROLPOINT__REGISTERPORTS_B__11_0_OFFSET UNITYSDK_OFFSET(0x1427C3F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPASSEDPATROLPOINT__REGISTERPORTS_B__11_1_OFFSET UNITYSDK_OFFSET(0x1427C400)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPASSEDPATROLPOINT___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1427C410)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetPassedPatrolPoint_TypeDefinitionIndex = 75039;
	...
	public:
		...
		::FlowCanvas::FlowOutput* wayPointArrivePort; // 0xE0
