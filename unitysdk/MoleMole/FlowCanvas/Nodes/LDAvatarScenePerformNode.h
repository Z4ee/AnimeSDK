...
#define MOLEMOLE_FLOWCANVAS_NODES_LDAVATARSCENEPERFORMNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1160A220)
#define MOLEMOLE_FLOWCANVAS_NODES_LDAVATARSCENEPERFORMNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1160A3F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDAVATARSCENEPERFORMNODE__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0x1160A430)
#define MOLEMOLE_FLOWCANVAS_NODES_LDAVATARSCENEPERFORMNODE___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1160A880)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDAvatarScenePerformNode_TypeDefinitionIndex = 86941;
