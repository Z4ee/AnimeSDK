...
#define MOLEMOLE_FLOWCANVAS_NODES_LDAVATARSCENEPERFORMNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1923F350)
#define MOLEMOLE_FLOWCANVAS_NODES_LDAVATARSCENEPERFORMNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1923F520)
#define MOLEMOLE_FLOWCANVAS_NODES_LDAVATARSCENEPERFORMNODE__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0x1923F560)
#define MOLEMOLE_FLOWCANVAS_NODES_LDAVATARSCENEPERFORMNODE___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1923F9C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDAvatarScenePerformNode_TypeDefinitionIndex = 60128;
