...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETRALLYQUESTCONDPROGRESS_INVOKE_OFFSET UNITYSDK_OFFSET(0x13EDC060)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETRALLYQUESTCONDPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x13EDC260)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_SetRallyQuestCondProgress_TypeDefinitionIndex = 83780;
