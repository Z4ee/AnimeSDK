...
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x16E40D20)
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER_GETDATA_OFFSET UNITYSDK_OFFSET(0x16E40EC0)
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x16E41020)
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER_METHOD_3_3621B53786EE26C8_OFFSET UNITYSDK_OFFSET(0x16E40F30)
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER_METHOD_3_439B588EB4881570_OFFSET UNITYSDK_OFFSET(0x16E410A0)
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER_METHOD_3_5A60CCF7370A1875_OFFSET UNITYSDK_OFFSET(0x16E41130)
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER_METHOD_3_83ED25F6A8C66D20_OFFSET UNITYSDK_OFFSET(0x16E41220)
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER_SETPATH_OFFSET UNITYSDK_OFFSET(0x16E40C80)
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x16E41040)
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x16E41030)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int AspectRatioProvider_TypeDefinitionIndex = 63022;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(AspectRatioProvider_TypeDefinitionIndex)->GetStaticField(0xC170);
		}
