...
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLEGET_INT_DOGET_OFFSET UNITYSDK_OFFSET(0x182DA280)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLEGET_INT__CTOR_OFFSET UNITYSDK_OFFSET(0x182DA2F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLEGET_INT___BASE_DOGET_OFFSET UNITYSDK_OFFSET(0x182DA340)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDPublicVariableGet_Int_TypeDefinitionIndex = 45644;
