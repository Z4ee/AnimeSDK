...
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLEGET_INT_DOGET_OFFSET UNITYSDK_OFFSET(0x19B118B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLEGET_INT__CTOR_OFFSET UNITYSDK_OFFSET(0x19B11920)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLEGET_INT___BASE_DOGET_OFFSET UNITYSDK_OFFSET(0x19B11970)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDPublicVariableGet_Int_TypeDefinitionIndex = 47932;
