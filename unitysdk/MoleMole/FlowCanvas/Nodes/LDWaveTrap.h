...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETRAP_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x12617380)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETRAP_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x12617560)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETRAP_GETRANDOMINDEXLIST_OFFSET UNITYSDK_OFFSET(0x12617DE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETRAP_ONCREATE_OFFSET UNITYSDK_OFFSET(0x12618260)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETRAP_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x12617000)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETRAP_SHOWBANDTRAPS_OFFSET UNITYSDK_OFFSET(0x12617F80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETRAP_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x126176C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETRAP__CTOR_OFFSET UNITYSDK_OFFSET(0x12618500)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETRAP__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0x12618510)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETRAP__REGISTERPORTS_B__1_1_OFFSET UNITYSDK_OFFSET(0x12618540)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETRAP__REGISTERPORTS_B__1_2_OFFSET UNITYSDK_OFFSET(0x12618660)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETRAP__REGISTERPORTS_B__1_3_OFFSET UNITYSDK_OFFSET(0x12618690)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETRAP__REGISTERPORTS_B__1_4_OFFSET UNITYSDK_OFFSET(0x126186A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETRAP__REGISTERPORTS_B__1_5_OFFSET UNITYSDK_OFFSET(0x126186B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETRAP___BASE_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x126186C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETRAP___BASE_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x126186D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETRAP___BASE_ONCREATE_OFFSET UNITYSDK_OFFSET(0x126186E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETRAP___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x12618770)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETRAP___BASE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x12618780)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveTrap_TypeDefinitionIndex = 65723;
