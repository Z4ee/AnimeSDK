...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETANIMATORINT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19BE28B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETANIMATORINT__CTOR_OFFSET UNITYSDK_OFFSET(0x19BE29E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETANIMATORINT__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x19BE2A20)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSetAnimatorInt_TypeDefinitionIndex = 61105;

	class LDSetAnimatorInt : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::Int32>* Value; // 0xA8
