...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETANIMATORINT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x16B81FF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETANIMATORINT__CTOR_OFFSET UNITYSDK_OFFSET(0x16B82120)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETANIMATORINT__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x16B82160)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSetAnimatorInt_TypeDefinitionIndex = 39854;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::System::Int32>* Value; // 0xC0
