...
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTARGETENTITYFOCUSUI_ONENTITYREADY_OFFSET UNITYSDK_OFFSET(0x118B41F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTARGETENTITYFOCUSUI_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x118B3A10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTARGETENTITYFOCUSUI_START_INVOKE_OFFSET UNITYSDK_OFFSET(0x118B3B20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTARGETENTITYFOCUSUI__CTOR_OFFSET UNITYSDK_OFFSET(0x118B4290)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTARGETENTITYFOCUSUI__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x118B42D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTARGETENTITYFOCUSUI___SENDENTITYDESTROYTARGETUI_OFFSET UNITYSDK_OFFSET(0x118B3D80)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDDestroyTargetEntityFocusUI_TypeDefinitionIndex = 44097;

	class LDDestroyTargetEntityFocusUI : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::FlowOutput* output; // 0xA8
		::FlowCanvas::ValueInput_1<::System::Boolean>* removeHpBarInput; // 0xB0
