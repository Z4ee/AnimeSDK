...
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTARGETENTITYFOCUSUI_ONENTITYREADY_OFFSET UNITYSDK_OFFSET(0x10E08680)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTARGETENTITYFOCUSUI_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x10E07DE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTARGETENTITYFOCUSUI_START_INVOKE_OFFSET UNITYSDK_OFFSET(0x10E07EF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTARGETENTITYFOCUSUI__CTOR_OFFSET UNITYSDK_OFFSET(0x10E08720)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTARGETENTITYFOCUSUI__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x10E08760)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTARGETENTITYFOCUSUI___SENDENTITYDESTROYTARGETUI_OFFSET UNITYSDK_OFFSET(0x10E081F0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDDestroyTargetEntityFocusUI_TypeDefinitionIndex = 58564;
