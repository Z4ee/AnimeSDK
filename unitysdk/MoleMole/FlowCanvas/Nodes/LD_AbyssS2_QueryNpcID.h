...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_QUERYNPCID_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1383A430)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_QUERYNPCID__CTOR_OFFSET UNITYSDK_OFFSET(0x1383A500)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_QUERYNPCID__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0x1383A540)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_QueryNpcID_TypeDefinitionIndex = 59512;
