...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_QUERYNPCID_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x12BB8EF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_QUERYNPCID__CTOR_OFFSET UNITYSDK_OFFSET(0x12BB8FC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_QUERYNPCID__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0x12BB9000)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_QueryNpcID_TypeDefinitionIndex = 76394;
