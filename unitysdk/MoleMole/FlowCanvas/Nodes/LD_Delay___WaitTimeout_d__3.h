...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_DELAY___WAITTIMEOUT_D__3_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1581F970)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_DELAY___WAITTIMEOUT_D__3_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1581FA40)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_DELAY___WAITTIMEOUT_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1581FAA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_DELAY___WAITTIMEOUT_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1581FA50)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_DELAY___WAITTIMEOUT_D__3_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1581F960)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_DELAY___WAITTIMEOUT_D__3__CTOR_OFFSET UNITYSDK_OFFSET(0x1581F950)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_Delay___WaitTimeout_d__3_TypeDefinitionIndex = 54944;
