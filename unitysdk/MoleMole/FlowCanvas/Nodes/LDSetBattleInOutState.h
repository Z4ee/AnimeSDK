...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETBATTLEINOUTSTATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x16E4D7D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETBATTLEINOUTSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16E4D980)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSetBattleInOutState_TypeDefinitionIndex = 50618;
