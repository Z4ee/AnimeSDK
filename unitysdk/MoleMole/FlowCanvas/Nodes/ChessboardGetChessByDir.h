...
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDGETCHESSBYDIR_INVOKE_OFFSET UNITYSDK_OFFSET(0x11737E50)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDGETCHESSBYDIR__CTOR_OFFSET UNITYSDK_OFFSET(0x117381C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ChessboardGetChessByDir_TypeDefinitionIndex = 66227;
