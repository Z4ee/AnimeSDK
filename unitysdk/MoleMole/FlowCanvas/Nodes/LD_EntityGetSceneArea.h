...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ENTITYGETSCENEAREA_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1174EAF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ENTITYGETSCENEAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x1174ECB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ENTITYGETSCENEAREA__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x1174ECF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ENTITYGETSCENEAREA__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0x1174F050)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ENTITYGETSCENEAREA__REGISTERPORTS_B__5_2_OFFSET UNITYSDK_OFFSET(0x1174F060)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ENTITYGETSCENEAREA__REGISTERPORTS_B__5_3_OFFSET UNITYSDK_OFFSET(0x1174F070)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_EntityGetSceneArea_TypeDefinitionIndex = 74233;
	...
	public:
		...
		::System::String* _lastAreaInfo; // 0xB8
