...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_BABELTOWER_GETCURFLOORINDEX_NEW_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A05C800)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_BABELTOWER_GETCURFLOORINDEX_NEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A05C920)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_BabelTower_GetCurFloorIndex_New_TypeDefinitionIndex = 76280;
