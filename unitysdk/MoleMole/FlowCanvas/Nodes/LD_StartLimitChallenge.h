...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE_ONFINISH_OFFSET UNITYSDK_OFFSET(0x15422CE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE_ONFORCESUCCESSFINISH_OFFSET UNITYSDK_OFFSET(0x15422DB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x15422E80)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE_ONRESUME_OFFSET UNITYSDK_OFFSET(0x15422F00)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE_ONSETSUBITEMPROGRESS_OFFSET UNITYSDK_OFFSET(0x15422F80)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE_ONSTART_OFFSET UNITYSDK_OFFSET(0x154226D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x15422220)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE__CTOR_OFFSET UNITYSDK_OFFSET(0x15423110)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE__REGISTERPORTS_B__25_0_OFFSET UNITYSDK_OFFSET(0x15423210)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE__REGISTERPORTS_B__25_1_OFFSET UNITYSDK_OFFSET(0x15423220)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE__REGISTERPORTS_B__25_2_OFFSET UNITYSDK_OFFSET(0x15423230)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE__REGISTERPORTS_B__25_3_OFFSET UNITYSDK_OFFSET(0x154232E0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_StartLimitChallenge_TypeDefinitionIndex = 52054;

	class LD_StartLimitChallenge : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::MoleMole::Battle::ChallengeSubTypeItem* _lastSuccessChallengeSubTypeItem; // 0xA8
		::Class_3_DB10471F01974BCE* challengeItem; // 0xB0
		::FlowCanvas::FlowOutput* FailOutput; // 0xB8
		::FlowCanvas::FlowOutput* UpdateOutput; // 0xC0
		::FlowCanvas::FlowInput* DoSetSubItemProgress; // 0xC8
		::FlowCanvas::ValueInput_1<::System::Boolean>* DisableTaimeScale; // 0xD0
		::FlowCanvas::ValueOutput_1<::System::Single>* TimeLeft; // 0xD8
		::FlowCanvas::ValueInput_1<::System::Boolean>* ReadFromServer; // 0xE0
		::FlowCanvas::FlowOutput* StartOutput; // 0xE8
		::FlowCanvas::FlowInput* DoFinish; // 0xF0
		::FlowCanvas::FlowOutput* SubSuccessOutput; // 0xF8
		::System::Collections::Generic::HashSet_1<::MoleMole::Battle::ChallengeSubTypeItem*>* _sucessSubTypeItems; // 0x100
		::FlowCanvas::FlowInput* Resume; // 0x108
		::FlowCanvas::FlowOutput* Out; // 0x110
		::FlowCanvas::ValueInput_1<::System::Int32>* ChallengeID; // 0x118
		::FlowCanvas::FlowInput* Start; // 0x120
		::FlowCanvas::ValueInput_1<::System::Boolean>* SubSuccessTriggerSelfSuccess; // 0x128
		::FlowCanvas::FlowInput* Pause; // 0x130
		::FlowCanvas::FlowInput* ForceSuccessFinish; // 0x138
		::FlowCanvas::FlowOutput* FinishOutput; // 0x140
		::FlowCanvas::ValueInput_1<::System::Single>* TotalTime; // 0x148
		::FlowCanvas::ValueInput_1<::System::Int32>* inputSubItemOffsetProgress; // 0x150
		::FlowCanvas::ValueInput_1<::System::Boolean>* IsUseItem; // 0x158
		::MoleMole::Battle::ChallengeSubTypeItem* _challengeSubTypeItem; // 0x160
		::FlowCanvas::ValueOutput_1<::System::Single>* NormalizedTime; // 0x168
