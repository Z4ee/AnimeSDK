...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETMONSTERLEVELFROMCARD_INVOKE_OFFSET UNITYSDK_OFFSET(0x13690760)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETMONSTERLEVELFROMCARD__CTOR_OFFSET UNITYSDK_OFFSET(0x13690AD0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetMonsterLevelFromCard_TypeDefinitionIndex = 51503;
