...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETMONSTERLEVELFROMCARD_INVOKE_OFFSET UNITYSDK_OFFSET(0x18416DC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETMONSTERLEVELFROMCARD__CTOR_OFFSET UNITYSDK_OFFSET(0x18417130)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetMonsterLevelFromCard_TypeDefinitionIndex = 62060;
