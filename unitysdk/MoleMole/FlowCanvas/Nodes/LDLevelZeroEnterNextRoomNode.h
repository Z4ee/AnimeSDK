...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROENTERNEXTROOMNODE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x13004640)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROENTERNEXTROOMNODE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x130042D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROENTERNEXTROOMNODE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x13004440)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROENTERNEXTROOMNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x13003D30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROENTERNEXTROOMNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x13004710)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROENTERNEXTROOMNODE__HANDLELEVELZEROROOMEND_OFFSET UNITYSDK_OFFSET(0x13003FD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROENTERNEXTROOMNODE__ONNEXTROOMLOADFINISHEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x13003EE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROENTERNEXTROOMNODE__REGISTERPORTS_B__11_0_OFFSET UNITYSDK_OFFSET(0x13004760)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROENTERNEXTROOMNODE__REGISTERPORTS_B__11_1_OFFSET UNITYSDK_OFFSET(0x130047C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROENTERNEXTROOMNODE___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x130048C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROENTERNEXTROOMNODE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x130048D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROENTERNEXTROOMNODE___HANDLELEVELZEROROOMEND_B__13_0_OFFSET UNITYSDK_OFFSET(0x13004840)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROENTERNEXTROOMNODE___ONNEXTROOMLOADFINISHEDCALLBACK_B__12_0_OFFSET UNITYSDK_OFFSET(0x13004800)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDLevelZeroEnterNextRoomNode_TypeDefinitionIndex = 44445;

	class LDLevelZeroEnterNextRoomNode : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::Boolean>* _isSuccess; // 0xA8
		::FlowCanvas::ValueInput_1<::System::Single>* _overrideDelayExitTime; // 0xB0
		::FlowCanvas::FlowInput* _transitIn; // 0xB8
