...
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDGETENEMYMONSTERLIST___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x13A8AC10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDGETENEMYMONSTERLIST___C__CTOR_OFFSET UNITYSDK_OFFSET(0x13A8AC50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDGETENEMYMONSTERLIST___C__ONGRAPHSTARTED_B__2_1_OFFSET UNITYSDK_OFFSET(0x13A8AC60)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDTurnBasedGetEnemyMonsterList___c_TypeDefinitionIndex = 45323;
	...
	public:
		...
		{
			return (::MoleMole::FlowCanvas::Nodes::LDTurnBasedGetEnemyMonsterList___c**)Il2CppClass::FromTypeDefinitionIndex(LDTurnBasedGetEnemyMonsterList___c_TypeDefinitionIndex)->GetStaticField(0x46CD0);
		}
		static ::System::Comparison_1<::MoleMole::Project::Config::EnemyWaveInformTemplateExt*>** StaticGet___9__2_1()
		{
			return (::System::Comparison_1<::MoleMole::Project::Config::EnemyWaveInformTemplateExt*>**)Il2CppClass::FromTypeDefinitionIndex(LDTurnBasedGetEnemyMonsterList___c_TypeDefinitionIndex)->GetStaticField(0x46CD8);
		}
