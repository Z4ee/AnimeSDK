...
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDGETENEMYMONSTERLIST___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x18A42FD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDGETENEMYMONSTERLIST___C__CTOR_OFFSET UNITYSDK_OFFSET(0x18A43010)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDGETENEMYMONSTERLIST___C__ONGRAPHSTARTED_B__2_1_OFFSET UNITYSDK_OFFSET(0x18A43020)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDTurnBasedGetEnemyMonsterList___c_TypeDefinitionIndex = 41697;
	...
	public:
		...
		{
			return (::MoleMole::FlowCanvas::Nodes::LDTurnBasedGetEnemyMonsterList___c**)Il2CppClass::FromTypeDefinitionIndex(LDTurnBasedGetEnemyMonsterList___c_TypeDefinitionIndex)->GetStaticField(0x40410);
		}
		static ::System::Comparison_1<::MoleMole::Project::Config::EnemyWaveInformTemplateExt*>** StaticGet___9__2_1()
		{
			return (::System::Comparison_1<::MoleMole::Project::Config::EnemyWaveInformTemplateExt*>**)Il2CppClass::FromTypeDefinitionIndex(LDTurnBasedGetEnemyMonsterList___c_TypeDefinitionIndex)->GetStaticField(0x40418);
		}
