...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_REMOVESCENETAG_INVOKE_OFFSET UNITYSDK_OFFSET(0x136A0A50)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_REMOVESCENETAG__CTOR_OFFSET UNITYSDK_OFFSET(0x136A0AE0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_RemoveSceneTag_TypeDefinitionIndex = 81719;
