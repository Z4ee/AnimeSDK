...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER__MULTIPLAYERINTERNALCOROUTINE_D__70_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x12997910)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER__MULTIPLAYERINTERNALCOROUTINE_D__70_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x12999740)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER__MULTIPLAYERINTERNALCOROUTINE_D__70_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x129997A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER__MULTIPLAYERINTERNALCOROUTINE_D__70_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x12999750)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER__MULTIPLAYERINTERNALCOROUTINE_D__70_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x12997900)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER__MULTIPLAYERINTERNALCOROUTINE_D__70__CTOR_OFFSET UNITYSDK_OFFSET(0x129978F0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveMonster__MultiplayerInternalCoroutine_d__70_TypeDefinitionIndex = 83844;
	...
	public:
		...
		::MoleMole::FlowCanvas::Nodes::LDWaveMonster___c__DisplayClass70_0* __8__1; // 0x18
		::MoleMole::FlowCanvas::Nodes::MonsterCreateDataBase* _createData_5__4; // 0x20
		::Class_3_69464E63CE567F68* _serverNotifyRecord_5__5; // 0x28
		::FlowCanvas::Flow f; // 0x30
		::System::Object* __2__current; // 0x58
		::System::Int32 _createListLen_5__2; // 0x60
		::System::Int32 __1__state; // 0x64
		::System::Boolean _isChangeToHostWhenWait_5__6; // 0x68
		::System::Boolean _doWait_5__3; // 0x69
