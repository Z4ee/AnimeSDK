...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE_BEGIN_OFFSET UNITYSDK_OFFSET(0x1A028E00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A028830)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1A0293D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE_FAIL_OFFSET UNITYSDK_OFFSET(0x1A0286C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A027FC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A0280B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A028110)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE_PAUSECOUNTDOWNUI_OFFSET UNITYSDK_OFFSET(0x1A029800)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE_PAUSE_OFFSET UNITYSDK_OFFSET(0x1A029A40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A028180)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE_RESTART_OFFSET UNITYSDK_OFFSET(0x1A029480)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE_RESUME_OFFSET UNITYSDK_OFFSET(0x1A029AD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE_SHOWCOUNTDOWNUI_OFFSET UNITYSDK_OFFSET(0x1A0288D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE_SUCCESS_OFFSET UNITYSDK_OFFSET(0x1A028550)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A029B50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE__REGISTERPORTS_B__18_0_OFFSET UNITYSDK_OFFSET(0x1A029B90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE__REGISTERPORTS_B__18_1_OFFSET UNITYSDK_OFFSET(0x1A029C20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE__REGISTERPORTS_B__18_2_OFFSET UNITYSDK_OFFSET(0x1A029CC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE__SETREMAIN_OFFSET UNITYSDK_OFFSET(0x1A029300)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE___BASE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A029D70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A029D80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A029D90)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDShowCountDownUINode_TypeDefinitionIndex = 70212;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::System::Single>* resetRemainTime; // 0xC8
		::UnityEngine::Coroutine* coroutine; // 0xD0
		::FlowCanvas::FlowOutput* update; // 0xD8
		::FlowCanvas::ValueInput_1<::System::Single>* totalDuration; // 0xE0
		::Class_1_8289F2785D9AA990* timer; // 0xE8
		::System::Boolean pauseState; // 0xF0
		::System::Single remainingNormalized; // 0xF4
		::System::Single remaining; // 0xF8
