...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_READMONSTERFROMCARDDATA_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19126FA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_READMONSTERFROMCARDDATA_START_F_OFFSET UNITYSDK_OFFSET(0x19127210)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_READMONSTERFROMCARDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x191277E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_READMONSTERFROMCARDDATA__REGISTERPORTS_B__12_0_OFFSET UNITYSDK_OFFSET(0x19127890)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_READMONSTERFROMCARDDATA__REGISTERPORTS_B__12_1_OFFSET UNITYSDK_OFFSET(0x191278C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_READMONSTERFROMCARDDATA__REGISTERPORTS_B__12_2_OFFSET UNITYSDK_OFFSET(0x191278D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_READMONSTERFROMCARDDATA__REGISTERPORTS_B__12_3_OFFSET UNITYSDK_OFFSET(0x191278E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_READMONSTERFROMCARDDATA__REGISTERPORTS_B__12_4_OFFSET UNITYSDK_OFFSET(0x191278F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_READMONSTERFROMCARDDATA__REGISTERPORTS_B__12_5_OFFSET UNITYSDK_OFFSET(0x19127900)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_ReadMonsterFromCardData_TypeDefinitionIndex = 81625;

	class LD_ReadMonsterFromCardData : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueOutput_1<::System::Int32>* changeToBadassBattleField; // 0xA8
		::System::String* targetBattleStageHandle; // 0xB0
		::FlowCanvas::ValueInput_1<::System::Int32>* cardIdNode; // 0xB8
		::FlowCanvas::ValueOutput_1<::System::String*>* targetBattleStage; // 0xC0
		::FlowCanvas::FlowOutput* output; // 0xC8
		::System::Collections::Generic::List_1<::MoleMole::FlowCanvas::Nodes::LD_ReadMonsterFromCardData_CardMonsterInfo>* waveMonsterHandle; // 0xD0
