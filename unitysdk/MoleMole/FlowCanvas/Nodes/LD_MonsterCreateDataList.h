...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCREATEDATALIST_GET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0x10D46E30)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCREATEDATALIST_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x10D46E50)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCREATEDATALIST_SET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0x10D46E40)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCREATEDATALIST__CTOR_OFFSET UNITYSDK_OFFSET(0x10D47050)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCREATEDATALIST__REGISTERPORTS_B__6_0_OFFSET UNITYSDK_OFFSET(0x10D47110)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCREATEDATALIST__REGISTERPORTS_B__6_1_OFFSET UNITYSDK_OFFSET(0x10D47150)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_MonsterCreateDataList_TypeDefinitionIndex = 58751;
