...
#define MOLEMOLE_FLOWCANVAS_NODES_LDACTIVEAREABLOCKWITHPARAM_INVOKE_OFFSET UNITYSDK_OFFSET(0x1603A8C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDACTIVEAREABLOCKWITHPARAM_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1603A780)
#define MOLEMOLE_FLOWCANVAS_NODES_LDACTIVEAREABLOCKWITHPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1603AE90)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDActiveAreaBlockWithParam_TypeDefinitionIndex = 76482;
