...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ADDSCENETAG_INVOKE_OFFSET UNITYSDK_OFFSET(0x17110DC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ADDSCENETAG__CTOR_OFFSET UNITYSDK_OFFSET(0x17110E50)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AddSceneTag_TypeDefinitionIndex = 65897;
