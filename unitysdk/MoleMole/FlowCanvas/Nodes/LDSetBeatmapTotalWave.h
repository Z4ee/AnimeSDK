...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETBEATMAPTOTALWAVE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x18B25990)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETBEATMAPTOTALWAVE_START_OFFSET UNITYSDK_OFFSET(0x18B25A80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETBEATMAPTOTALWAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B25D20)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSetBeatmapTotalWave_TypeDefinitionIndex = 49678;
