...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSCOREUIWITHRATING_GETONRESTARTPARAM_OFFSET UNITYSDK_OFFSET(0x15816D10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSCOREUIWITHRATING_GETONSTARTPARAM_OFFSET UNITYSDK_OFFSET(0x15816AF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSCOREUIWITHRATING_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x158169F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSCOREUIWITHRATING__CTOR_OFFSET UNITYSDK_OFFSET(0x15816F30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSCOREUIWITHRATING__GETONRESTARTPARAM_B__6_0_OFFSET UNITYSDK_OFFSET(0x158170A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSCOREUIWITHRATING__GETONRESTARTPARAM_B__6_1_OFFSET UNITYSDK_OFFSET(0x15817170)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSCOREUIWITHRATING__GETONSTARTPARAM_B__5_0_OFFSET UNITYSDK_OFFSET(0x15816F40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSCOREUIWITHRATING__GETONSTARTPARAM_B__5_1_OFFSET UNITYSDK_OFFSET(0x15817010)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSCOREUIWITHRATING___BASE_GETONRESTARTPARAM_OFFSET UNITYSDK_OFFSET(0x15817200)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSCOREUIWITHRATING___BASE_GETONSTARTPARAM_OFFSET UNITYSDK_OFFSET(0x15817210)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSCOREUIWITHRATING___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x15817220)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDShowScoreUIWithRating_TypeDefinitionIndex = 82311;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::MoleMole::Level::RatingType>* ratingType; // 0x118
