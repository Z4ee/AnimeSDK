...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_GETMERGEAREAIDBYORDERNO_INVOKE_OFFSET UNITYSDK_OFFSET(0x1780C930)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_GETMERGEAREAIDBYORDERNO__CTOR_OFFSET UNITYSDK_OFFSET(0x1780CBA0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_GetMergeAreaIDByOrderNo_TypeDefinitionIndex = 51496;
