...
#define MOLEMOLE_FLOWCANVAS_NODES_LDNAPCAMERASEQUENCEJUMPTOSECTION_DO_OFFSET UNITYSDK_OFFSET(0x1A9A37D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDNAPCAMERASEQUENCEJUMPTOSECTION_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A9A3630)
#define MOLEMOLE_FLOWCANVAS_NODES_LDNAPCAMERASEQUENCEJUMPTOSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A3AA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDNAPCAMERASEQUENCEJUMPTOSECTION__REGISTERPORTS_B__7_0_OFFSET UNITYSDK_OFFSET(0x1A9A3AE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDNAPCAMERASEQUENCEJUMPTOSECTION__REGISTERPORTS_B__7_1_OFFSET UNITYSDK_OFFSET(0x1A9A3E70)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDNapCameraSequenceJumpToSection_TypeDefinitionIndex = 45246;

	class LDNapCameraSequenceJumpToSection : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::FlowInput* _in; // 0xA8
		::FlowCanvas::ValueInput_1<::System::Boolean>* _toEnd; // 0xB0
		::FlowCanvas::ValueInput_1<::System::String*>* _section; // 0xB8
		::System::String* _errorMessage; // 0xC0
		::FlowCanvas::FlowOutput* _out; // 0xC8
		::FlowCanvas::FlowOutput* _onFailed; // 0xD0
