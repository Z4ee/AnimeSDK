...
#define MOLEMOLE_FLOWCANVAS_NODES_LDMPGETALLLOCALAVATARNODE_GETAVATAR1_OFFSET UNITYSDK_OFFSET(0x19B0F040)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMPGETALLLOCALAVATARNODE_GETAVATAR2_OFFSET UNITYSDK_OFFSET(0x19B0F2E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMPGETALLLOCALAVATARNODE_GETAVATAR3_OFFSET UNITYSDK_OFFSET(0x19B0F410)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMPGETALLLOCALAVATARNODE_GETAVATARBYPEERID_OFFSET UNITYSDK_OFFSET(0x19B0F210)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMPGETALLLOCALAVATARNODE_GETONLINEAVATARLIST_OFFSET UNITYSDK_OFFSET(0x19B0F540)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMPGETALLLOCALAVATARNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19B0EE90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMPGETALLLOCALAVATARNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B0F7E0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDMpGetAllLocalAvatarNode_TypeDefinitionIndex = 41632;
	...
	public:
		...
		::FlowCanvas::ValueOutput_1<::MoleMole::Battle::Entity*>* valueOutputAvatar2; // 0xB0
