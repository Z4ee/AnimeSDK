...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETTHEGUNSCORE_INVOKE_OFFSET UNITYSDK_OFFSET(0x170C3060)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETTHEGUNSCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x170C31C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetTheGunScore_TypeDefinitionIndex = 78656;
