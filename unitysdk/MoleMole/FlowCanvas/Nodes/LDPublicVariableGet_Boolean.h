...
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLEGET_BOOLEAN_DOGET_OFFSET UNITYSDK_OFFSET(0x13009720)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLEGET_BOOLEAN__CTOR_OFFSET UNITYSDK_OFFSET(0x13009790)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLEGET_BOOLEAN___BASE_DOGET_OFFSET UNITYSDK_OFFSET(0x130097E0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDPublicVariableGet_Boolean_TypeDefinitionIndex = 68675;
