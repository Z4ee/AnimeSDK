...
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLEGET_BOOLEAN_DOGET_OFFSET UNITYSDK_OFFSET(0x1A04B510)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLEGET_BOOLEAN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A04B580)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLEGET_BOOLEAN___BASE_DOGET_OFFSET UNITYSDK_OFFSET(0x1A04B5D0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDPublicVariableGet_Boolean_TypeDefinitionIndex = 50065;
