...
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTERWITHRANDOMPOS_FULLCREATEDLIST_OFFSET UNITYSDK_OFFSET(0x117442C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTERWITHRANDOMPOS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x11744210)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTERWITHRANDOMPOS_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x11744740)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTERWITHRANDOMPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x117448D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTERWITHRANDOMPOS___BASE_FULLCREATEDLIST_OFFSET UNITYSDK_OFFSET(0x117448E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTERWITHRANDOMPOS___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x117448F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTERWITHRANDOMPOS___BASE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x11744900)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDRandomWaveMonsterWithRandomPos_TypeDefinitionIndex = 55507;
