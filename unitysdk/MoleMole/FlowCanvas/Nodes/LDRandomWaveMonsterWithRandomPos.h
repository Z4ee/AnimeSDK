...
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTERWITHRANDOMPOS_FULLCREATEDLIST_OFFSET UNITYSDK_OFFSET(0x129946E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTERWITHRANDOMPOS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x12994630)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTERWITHRANDOMPOS_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x12994B40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTERWITHRANDOMPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x12994CD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTERWITHRANDOMPOS___BASE_FULLCREATEDLIST_OFFSET UNITYSDK_OFFSET(0x12994CE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTERWITHRANDOMPOS___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x12994CF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTERWITHRANDOMPOS___BASE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x12994D00)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDRandomWaveMonsterWithRandomPos_TypeDefinitionIndex = 70191;
