...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERHPCHANGENODE_ADDLISTENHPABILITY_OFFSET UNITYSDK_OFFSET(0x1A024A50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERHPCHANGENODE_BINDEVENT_OFFSET UNITYSDK_OFFSET(0x1A024BC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERHPCHANGENODE_ENTITYONREADY_OFFSET UNITYSDK_OFFSET(0x1A024930)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERHPCHANGENODE_ONEVENT_OFFSET UNITYSDK_OFFSET(0x1A025960)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERHPCHANGENODE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A024FD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERHPCHANGENODE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A025030)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERHPCHANGENODE_ONHOSTCHANGED_OFFSET UNITYSDK_OFFSET(0x1A0249E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERHPCHANGENODE_ONPROPVALUECHANGE_OFFSET UNITYSDK_OFFSET(0x1A0250A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERHPCHANGENODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A0240D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERHPCHANGENODE_START_OFFSET UNITYSDK_OFFSET(0x1A024270)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERHPCHANGENODE_UNBINDEVENT_OFFSET UNITYSDK_OFFSET(0x1A024DC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERHPCHANGENODE_WAITAUTHORITYNOTIFYCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1A0248B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERHPCHANGENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A025CC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERHPCHANGENODE__REGISTERPORTS_B__9_0_OFFSET UNITYSDK_OFFSET(0x1A025D00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERHPCHANGENODE___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A025D50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERHPCHANGENODE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A025D60)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDListenMonsterHpChangeNode_TypeDefinitionIndex = 79855;

	class LDListenMonsterHpChangeNode : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::FlowOutput* onHighToValueOutPut; // 0xA8
