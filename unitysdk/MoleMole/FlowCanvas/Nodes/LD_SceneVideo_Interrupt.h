...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SCENEVIDEO_INTERRUPT_INVOKE_OFFSET UNITYSDK_OFFSET(0x19B17A60)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SCENEVIDEO_INTERRUPT__CTOR_OFFSET UNITYSDK_OFFSET(0x19B17B80)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_SceneVideo_Interrupt_TypeDefinitionIndex = 40451;
