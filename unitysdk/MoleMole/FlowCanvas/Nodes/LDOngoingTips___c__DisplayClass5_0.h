...
#define MOLEMOLE_FLOWCANVAS_NODES_LDONGOINGTIPS___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19DB4C90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDONGOINGTIPS___C__DISPLAYCLASS5_0__WAITFORPLAYING_B__0_OFFSET UNITYSDK_OFFSET(0x19DB4CA0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDOngoingTips___c__DisplayClass5_0_TypeDefinitionIndex = 74326;
