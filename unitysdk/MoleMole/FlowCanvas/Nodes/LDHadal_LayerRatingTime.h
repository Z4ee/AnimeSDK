...
#define MOLEMOLE_FLOWCANVAS_NODES_LDHADAL_LAYERRATINGTIME_INVOKE_OFFSET UNITYSDK_OFFSET(0x19241960)
#define MOLEMOLE_FLOWCANVAS_NODES_LDHADAL_LAYERRATINGTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x19241AC0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDHadal_LayerRatingTime_TypeDefinitionIndex = 62716;
