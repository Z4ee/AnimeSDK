...
#define MOLEMOLE_FLOWCANVAS_NODES_ANCHORWITHSTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x346F70)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int AnchorWithStyle_TypeDefinitionIndex = 51431;
