...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEGROUPSCENEMONSTER_GENERATECREATEDATA_OFFSET UNITYSDK_OFFSET(0x12996AB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEGROUPSCENEMONSTER_ONCREATE_OFFSET UNITYSDK_OFFSET(0x12997300)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEGROUPSCENEMONSTER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x12996770)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEGROUPSCENEMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x129975A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEGROUPSCENEMONSTER__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0x129975B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEGROUPSCENEMONSTER__REGISTERPORTS_B__1_1_OFFSET UNITYSDK_OFFSET(0x129976C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEGROUPSCENEMONSTER__REGISTERPORTS_B__1_2_OFFSET UNITYSDK_OFFSET(0x129977E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEGROUPSCENEMONSTER__REGISTERPORTS_B__1_3_OFFSET UNITYSDK_OFFSET(0x12997810)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEGROUPSCENEMONSTER__REGISTERPORTS_B__1_4_OFFSET UNITYSDK_OFFSET(0x12997820)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEGROUPSCENEMONSTER__REGISTERPORTS_B__1_5_OFFSET UNITYSDK_OFFSET(0x12997830)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEGROUPSCENEMONSTER___BASE_GENERATECREATEDATA_OFFSET UNITYSDK_OFFSET(0x12997840)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEGROUPSCENEMONSTER___BASE_ONCREATE_OFFSET UNITYSDK_OFFSET(0x12997850)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEGROUPSCENEMONSTER___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x129978E0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveGroupSceneMonster_TypeDefinitionIndex = 84382;
