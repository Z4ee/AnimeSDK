...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEGROUPSCENEMONSTER_GENERATECREATEDATA_OFFSET UNITYSDK_OFFSET(0x117466D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEGROUPSCENEMONSTER_ONCREATE_OFFSET UNITYSDK_OFFSET(0x11746F10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEGROUPSCENEMONSTER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x11746390)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEGROUPSCENEMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x117471B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEGROUPSCENEMONSTER__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0x117471C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEGROUPSCENEMONSTER__REGISTERPORTS_B__1_1_OFFSET UNITYSDK_OFFSET(0x117472D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEGROUPSCENEMONSTER__REGISTERPORTS_B__1_2_OFFSET UNITYSDK_OFFSET(0x117473F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEGROUPSCENEMONSTER__REGISTERPORTS_B__1_3_OFFSET UNITYSDK_OFFSET(0x11747420)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEGROUPSCENEMONSTER__REGISTERPORTS_B__1_4_OFFSET UNITYSDK_OFFSET(0x11747430)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEGROUPSCENEMONSTER__REGISTERPORTS_B__1_5_OFFSET UNITYSDK_OFFSET(0x11747440)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEGROUPSCENEMONSTER___BASE_GENERATECREATEDATA_OFFSET UNITYSDK_OFFSET(0x11747450)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEGROUPSCENEMONSTER___BASE_ONCREATE_OFFSET UNITYSDK_OFFSET(0x11747460)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEGROUPSCENEMONSTER___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x117474F0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveGroupSceneMonster_TypeDefinitionIndex = 78639;
