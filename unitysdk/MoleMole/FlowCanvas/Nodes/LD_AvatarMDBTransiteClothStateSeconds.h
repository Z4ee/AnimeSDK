...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATARMDBTRANSITECLOTHSTATESECONDS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19DB7CF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATARMDBTRANSITECLOTHSTATESECONDS__CTOR_OFFSET UNITYSDK_OFFSET(0x19DB82C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATARMDBTRANSITECLOTHSTATESECONDS__PROCESS_OFFSET UNITYSDK_OFFSET(0x19DB7E40)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATARMDBTRANSITECLOTHSTATESECONDS__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x19DB8300)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AvatarMDBTransiteClothStateSeconds_TypeDefinitionIndex = 91296;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::System::Single>* transiteTime; // 0xB0
