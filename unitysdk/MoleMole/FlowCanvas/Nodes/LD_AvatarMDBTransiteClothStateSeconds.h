...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATARMDBTRANSITECLOTHSTATESECONDS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x170CB800)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATARMDBTRANSITECLOTHSTATESECONDS__CTOR_OFFSET UNITYSDK_OFFSET(0x170CBDD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATARMDBTRANSITECLOTHSTATESECONDS__PROCESS_OFFSET UNITYSDK_OFFSET(0x170CB950)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATARMDBTRANSITECLOTHSTATESECONDS__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x170CBE10)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AvatarMDBTransiteClothStateSeconds_TypeDefinitionIndex = 72892;

	class LD_AvatarMDBTransiteClothStateSeconds : public ::FlowCanvas::FlowNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::Int32>* clothIndex; // 0xA8
		::FlowCanvas::FlowOutput* _output; // 0xB0
		::FlowCanvas::ValueInput_1<::System::Single>* transiteTime; // 0xB8
		::FlowCanvas::ValueInput_1<::MoleMole::EntityHandle>* entityHandle; // 0xC0
