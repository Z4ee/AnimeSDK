...
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDGETPLAYERMONSTERLIST_INVOKE_OFFSET UNITYSDK_OFFSET(0x1541BB80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDGETPLAYERMONSTERLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1541BD50)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDTurnBasedGetPlayerMonsterList_TypeDefinitionIndex = 57291;
