...
#define MOLEMOLE_FLOWCANVAS_NODES_LDREPLACEGLOBALAI_PROCESS_OFFSET UNITYSDK_OFFSET(0x149E02F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDREPLACEGLOBALAI_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x149E0200)
#define MOLEMOLE_FLOWCANVAS_NODES_LDREPLACEGLOBALAI__CTOR_OFFSET UNITYSDK_OFFSET(0x149E0570)
#define MOLEMOLE_FLOWCANVAS_NODES_LDREPLACEGLOBALAI__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x149E05B0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDReplaceGlobalAI_TypeDefinitionIndex = 71729;
