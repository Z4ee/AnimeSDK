...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGEBEHAVIORTREENODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x12BB0D40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGEBEHAVIORTREENODE_ISCOULDOUTCALL_OFFSET UNITYSDK_OFFSET(0x12BB1020)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGEBEHAVIORTREENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x12BB1070)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGEBEHAVIORTREENODE__INVOKE_B__0_0_OFFSET UNITYSDK_OFFSET(0x12BB1090)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGEBEHAVIORTREENODE___BASE_ISCOULDOUTCALL_OFFSET UNITYSDK_OFFSET(0x12BB1130)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDChangeBehaviorTreeNode_TypeDefinitionIndex = 84521;
