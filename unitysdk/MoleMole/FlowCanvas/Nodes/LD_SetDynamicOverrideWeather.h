...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x11615BB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHER_REVERT_OFFSET UNITYSDK_OFFSET(0x11615F40)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHER_START_OFFSET UNITYSDK_OFFSET(0x11615D00)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHER__CTOR_OFFSET UNITYSDK_OFFSET(0x116161D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHER__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x11616210)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHER__REGISTERPORTS_B__3_1_OFFSET UNITYSDK_OFFSET(0x11616240)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_SetDynamicOverrideWeather_TypeDefinitionIndex = 48572;
