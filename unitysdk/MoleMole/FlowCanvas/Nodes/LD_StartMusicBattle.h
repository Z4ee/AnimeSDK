...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTMUSICBATTLE_PLAYTIMELINE_OFFSET UNITYSDK_OFFSET(0x12BBC370)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTMUSICBATTLE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x12BBC220)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTMUSICBATTLE_TRYCALLFINISH_OFFSET UNITYSDK_OFFSET(0x12BBC9E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTMUSICBATTLE_TRYPLAYMUSIC_OFFSET UNITYSDK_OFFSET(0x12BBC760)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTMUSICBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x12BBCB10)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_StartMusicBattle_TypeDefinitionIndex = 50966;
