...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSS_GETLOADEDABYSSHEATCOUNT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1581EBE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSS_GETLOADEDABYSSHEATCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1581EDA0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_Abyss_GetLoadedAbyssHeatCount_TypeDefinitionIndex = 75011;
