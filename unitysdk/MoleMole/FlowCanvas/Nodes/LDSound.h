...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSOUND_BEGIN_OFFSET UNITYSDK_OFFSET(0x144CBA60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSOUND_GETORCREATEAUDIOEMITTER_OFFSET UNITYSDK_OFFSET(0x144CBCC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSOUND_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x144CB900)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSOUND__CTOR_OFFSET UNITYSDK_OFFSET(0x144CCE80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSOUND__REGISTERPORTS_B__10_0_OFFSET UNITYSDK_OFFSET(0x144CCEC0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSound_TypeDefinitionIndex = 70752;

	class LDSound : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::System::String* sound; // 0xA8
		::FlowCanvas::ValueInput_1<::MoleMole::Battle::Entity*>* targetEntity; // 0xB0
		::FlowCanvas::FlowInput* input; // 0xB8
		::FlowCanvas::FlowOutput* output; // 0xC0
		::FlowCanvas::FlowOutput* finishOutput; // 0xC8
		::FlowCanvas::ValueInput_1<::System::String*>* targetAnchor; // 0xD0
		::FlowCanvas::ValueInput_1<::System::String*>* targetKey; // 0xD8
		::System::String* soundAction; // 0xE0
