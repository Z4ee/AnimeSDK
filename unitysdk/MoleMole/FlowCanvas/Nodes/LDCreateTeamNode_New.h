...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETEAMNODE_NEW_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x10D374E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETEAMNODE_NEW__CHECKREADY_OFFSET UNITYSDK_OFFSET(0x10D37650)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETEAMNODE_NEW__CTOR_OFFSET UNITYSDK_OFFSET(0x10D37800)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETEAMNODE_NEW__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x10D37840)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETEAMNODE_NEW__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0x10D37C00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETEAMNODE_NEW___CHECKREADY_G____CHECKREADYCOROTINE_6_0_OFFSET UNITYSDK_OFFSET(0x10D377B0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCreateTeamNode_New_TypeDefinitionIndex = 47695;

	class LDCreateTeamNode_New : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::FlowOutput* _onReady; // 0xA8
		::FlowCanvas::ValueInput_1<::System::String*>* bornPos; // 0xB0
		::FlowCanvas::FlowOutput* _output; // 0xB8
		::FlowCanvas::ValueInput_1<::MoleMole::TeamGroupDataItem*>* teamGroupDataItem; // 0xC0
