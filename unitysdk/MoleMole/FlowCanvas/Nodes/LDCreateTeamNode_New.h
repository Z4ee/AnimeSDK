...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETEAMNODE_NEW_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x16E43190)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETEAMNODE_NEW__CHECKREADY_OFFSET UNITYSDK_OFFSET(0x16E43300)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETEAMNODE_NEW__CTOR_OFFSET UNITYSDK_OFFSET(0x16E434B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETEAMNODE_NEW__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x16E434F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETEAMNODE_NEW__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0x16E438C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETEAMNODE_NEW___CHECKREADY_G____CHECKREADYCOROTINE_6_0_OFFSET UNITYSDK_OFFSET(0x16E43460)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCreateTeamNode_New_TypeDefinitionIndex = 38388;

	class LDCreateTeamNode_New : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::String*>* bornPos; // 0xA8
		::FlowCanvas::FlowOutput* _onReady; // 0xB0
