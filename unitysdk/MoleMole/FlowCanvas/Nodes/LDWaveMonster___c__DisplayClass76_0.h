...
{
	inline static constexpr unsigned int LDWaveMonster___c__DisplayClass76_0_TypeDefinitionIndex = 60403;

	struct alignas(8) LDWaveMonster___c__DisplayClass76_0
	{
		::Struct_2_820267F94C5D0AA4 config; // 0x10
		::MoleMole::FlowCanvas::Nodes::LDWaveMonster* __4__this; // 0x50
		::MoleMole::MonoSpawnPoint* spawnPoint; // 0x58
