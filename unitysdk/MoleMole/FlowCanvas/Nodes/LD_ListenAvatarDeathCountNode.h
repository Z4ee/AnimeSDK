...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENAVATARDEATHCOUNTNODE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x151271B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENAVATARDEATHCOUNTNODE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x15127200)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENAVATARDEATHCOUNTNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x15126C40)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENAVATARDEATHCOUNTNODE_UNBINDEVENT_OFFSET UNITYSDK_OFFSET(0x15127040)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENAVATARDEATHCOUNTNODE__BINDEVENT_OFFSET UNITYSDK_OFFSET(0x15126EE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENAVATARDEATHCOUNTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x15127250)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENAVATARDEATHCOUNTNODE__ONEVENT_OFFSET UNITYSDK_OFFSET(0x15126DE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENAVATARDEATHCOUNTNODE__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x15127290)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENAVATARDEATHCOUNTNODE___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x151272E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENAVATARDEATHCOUNTNODE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x151272F0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_ListenAvatarDeathCountNode_TypeDefinitionIndex = 42669;
