...
#define MOLEMOLE_FLOWCANVAS_NODES_PLAYSUMMERSHOOTINGOPENINGAUDIO_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x16B8A0B0)
#define MOLEMOLE_FLOWCANVAS_NODES_PLAYSUMMERSHOOTINGOPENINGAUDIO_START_OFFSET UNITYSDK_OFFSET(0x16B8A190)
#define MOLEMOLE_FLOWCANVAS_NODES_PLAYSUMMERSHOOTINGOPENINGAUDIO__CTOR_OFFSET UNITYSDK_OFFSET(0x16B8A370)
#define MOLEMOLE_FLOWCANVAS_NODES_PLAYSUMMERSHOOTINGOPENINGAUDIO__START_B__3_0_OFFSET UNITYSDK_OFFSET(0x16B8A3B0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int PlaySummerShootingOpeningAudio_TypeDefinitionIndex = 50394;
