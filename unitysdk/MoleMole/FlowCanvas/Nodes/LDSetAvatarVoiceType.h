...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETAVATARVOICETYPE_BEGIN_OFFSET UNITYSDK_OFFSET(0x10D41810)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETAVATARVOICETYPE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x10D41740)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETAVATARVOICETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x10D41AB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETAVATARVOICETYPE__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x10D41AF0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSetAvatarVoiceType_TypeDefinitionIndex = 79509;
