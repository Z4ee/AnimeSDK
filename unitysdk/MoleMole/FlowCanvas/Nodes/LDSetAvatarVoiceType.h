...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETAVATARVOICETYPE_BEGIN_OFFSET UNITYSDK_OFFSET(0x1684AE90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETAVATARVOICETYPE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1684ADC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETAVATARVOICETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1684B130)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETAVATARVOICETYPE__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x1684B170)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSetAvatarVoiceType_TypeDefinitionIndex = 86404;
