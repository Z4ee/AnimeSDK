...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSPAWNBUDDYNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x13A886B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSPAWNBUDDYNODE_TRYSETENTITYAICOMPONENTACTIVETAG_OFFSET UNITYSDK_OFFSET(0x13A88F20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSPAWNBUDDYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x13A89E30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSPAWNBUDDYNODE__ONBUDDYREADY_OFFSET UNITYSDK_OFFSET(0x13A88980)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSPAWNBUDDYNODE__REGISTERPORTS_B__14_0_OFFSET UNITYSDK_OFFSET(0x13A89EC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSPAWNBUDDYNODE__REGISTERPORTS_B__14_1_OFFSET UNITYSDK_OFFSET(0x13A89ED0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSPAWNBUDDYNODE__REGISTERPORTS_B__14_2_OFFSET UNITYSDK_OFFSET(0x13A8A7D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSPAWNBUDDYNODE__REGISTERPORTS_B__14_3_OFFSET UNITYSDK_OFFSET(0x13A8A650)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSPAWNBUDDYNODE__SETBUDDYPOS_DEPRECATED_OFFSET UNITYSDK_OFFSET(0x13A89070)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSPAWNBUDDYNODE__SETBUDDYPOS_NEW_OFFSET UNITYSDK_OFFSET(0x13A88A30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSPAWNBUDDYNODE__SETBUDDYPOS_OFFSET UNITYSDK_OFFSET(0x13A889C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSPAWNBUDDYNODE__SPAWNONANCHOR_OFFSET UNITYSDK_OFFSET(0x13A89410)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSPAWNBUDDYNODE__SYNMODELTRANSFORM_OFFSET UNITYSDK_OFFSET(0x13A88E70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSPAWNBUDDYNODE__TRYCALLOUTPUT_OFFSET UNITYSDK_OFFSET(0x13A88900)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSpawnBuddyNode_TypeDefinitionIndex = 57738;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::System::Single>* angleRangeInput; // 0xB8
		...
		::FlowCanvas::ValueInput_1<::System::Single>* minimumInput; // 0xD8
		...
		::System::Boolean lastChooseLeft; // 0x108
		::System::Boolean IsEnableAI; // 0x109
		::System::Boolean isOutputCalled; // 0x10A
