...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENLEVELSTATE_BEGIN_OFFSET UNITYSDK_OFFSET(0x1A9A1C10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENLEVELSTATE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A9A1D90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENLEVELSTATE_ONSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x1A9A1E40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENLEVELSTATE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A9A1910)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENLEVELSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A1EF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENLEVELSTATE__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x1A9A1F30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENLEVELSTATE__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0x1A9A1FE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENLEVELSTATE__REGISTERPORTS_B__5_2_OFFSET UNITYSDK_OFFSET(0x1A9A2090)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENLEVELSTATE__REGISTERPORTS_B__5_3_OFFSET UNITYSDK_OFFSET(0x1A9A2130)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENLEVELSTATE___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A9A21D0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDListenLevelState_TypeDefinitionIndex = 57807;

	class LDListenLevelState : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::FlowOutput* _onStateChangedOutput; // 0xA8
		::FlowCanvas::FlowOutput* _output; // 0xB0
		::Struct_2_A47ACAABA9AAFE92 stateValue; // 0xB8
		::FlowCanvas::FlowInput* beginFlowInput; // 0xD0
