...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENLEVELSTATE_BEGIN_OFFSET UNITYSDK_OFFSET(0x16E494F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENLEVELSTATE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x16E49670)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENLEVELSTATE_ONSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x16E49720)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENLEVELSTATE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x16E491E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENLEVELSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16E497D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENLEVELSTATE__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x16E49810)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENLEVELSTATE__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0x16E498C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENLEVELSTATE__REGISTERPORTS_B__5_2_OFFSET UNITYSDK_OFFSET(0x16E49970)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENLEVELSTATE__REGISTERPORTS_B__5_3_OFFSET UNITYSDK_OFFSET(0x16E49A10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENLEVELSTATE___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x16E49AB0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDListenLevelState_TypeDefinitionIndex = 64134;
	...
	public:
		...
		::FlowCanvas::FlowOutput* _onStateChangedOutput; // 0xD0
