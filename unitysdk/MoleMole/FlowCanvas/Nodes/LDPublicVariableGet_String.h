...
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLEGET_STRING_DOGET_OFFSET UNITYSDK_OFFSET(0x10BA9120)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLEGET_STRING__CTOR_OFFSET UNITYSDK_OFFSET(0x10BA9190)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLEGET_STRING___BASE_DOGET_OFFSET UNITYSDK_OFFSET(0x10BA91E0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDPublicVariableGet_String_TypeDefinitionIndex = 56382;
