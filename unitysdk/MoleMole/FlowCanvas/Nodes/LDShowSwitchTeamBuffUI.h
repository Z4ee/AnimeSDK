...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSWITCHTEAMBUFFUI_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x16D40870)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSWITCHTEAMBUFFUI_ONRESTART_OFFSET UNITYSDK_OFFSET(0x16D40920)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSWITCHTEAMBUFFUI_ONSTART_OFFSET UNITYSDK_OFFSET(0x16D40220)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSWITCHTEAMBUFFUI_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x16D40090)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSWITCHTEAMBUFFUI__CTOR_OFFSET UNITYSDK_OFFSET(0x16D40980)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSWITCHTEAMBUFFUI__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x16D409C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSWITCHTEAMBUFFUI__REGISTERPORTS_B__3_1_OFFSET UNITYSDK_OFFSET(0x16D40A10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSWITCHTEAMBUFFUI__REGISTERPORTS_B__3_2_OFFSET UNITYSDK_OFFSET(0x16D40A20)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDShowSwitchTeamBuffUI_TypeDefinitionIndex = 74658;

	class LDShowSwitchTeamBuffUI : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::String*>* BuffLevelName; // 0xA8
		::FlowCanvas::FlowOutput* output; // 0xB0
		::FlowCanvas::ValueInput_1<::System::String*>* BuffProgressName; // 0xB8
