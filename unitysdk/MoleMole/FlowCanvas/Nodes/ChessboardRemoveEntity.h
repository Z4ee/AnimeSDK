...
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDREMOVEENTITY_INVOKE_OFFSET UNITYSDK_OFFSET(0x19DAC1C0)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDREMOVEENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x19DAC230)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ChessboardRemoveEntity_TypeDefinitionIndex = 62331;
