...
#define MOLEMOLE_FLOWCANVAS_NODES_LDBUBBLENODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x12BAFCE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDBUBBLENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x12BAFF30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDBUBBLENODE__REGISTERPORTS_B__11_0_OFFSET UNITYSDK_OFFSET(0x12BAFF70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDBUBBLENODE__REGISTERPORTS_B__11_1_OFFSET UNITYSDK_OFFSET(0x12BB0730)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDBubbleNode_TypeDefinitionIndex = 80257;

	class LDBubbleNode : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::Int32>* performID; // 0xA8
		::FlowCanvas::ValueInput_1<::MoleMole::Battle::Entity*>* entity2; // 0xB0
		...
		::FlowCanvas::ValueInput_1<::System::Single>* NPCHUDChatBubbleInterruptDistance; // 0xD8
		::FlowCanvas::ValueInput_1<::System::String*>* speaker1; // 0xE0
		::FlowCanvas::ValueInput_1<::MoleMole::Battle::Entity*>* entity1; // 0xE8
		::FlowCanvas::ValueInput_1<::System::String*>* speaker2; // 0xF0
