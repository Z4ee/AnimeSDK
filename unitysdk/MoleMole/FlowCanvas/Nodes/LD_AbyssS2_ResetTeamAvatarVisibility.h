...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_RESETTEAMAVATARVISIBILITY_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x160459E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_RESETTEAMAVATARVISIBILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16045AA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_RESETTEAMAVATARVISIBILITY__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0x16045AE0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_ResetTeamAvatarVisibility_TypeDefinitionIndex = 42280;
