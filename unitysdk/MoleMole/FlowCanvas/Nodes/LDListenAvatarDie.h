...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARDIE_BINDEVENT_OFFSET UNITYSDK_OFFSET(0x161DB330)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARDIE_GETEVENTCOMPONENT_OFFSET UNITYSDK_OFFSET(0x161DB700)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARDIE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x161DB870)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARDIE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x161DB690)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARDIE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x161DAFB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARDIE_START_OFFSET UNITYSDK_OFFSET(0x161DB210)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARDIE_STOP_OFFSET UNITYSDK_OFFSET(0x161DB4B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARDIE_UNBINDEVENT_OFFSET UNITYSDK_OFFSET(0x161DB510)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARDIE__CTOR_OFFSET UNITYSDK_OFFSET(0x161DBC30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARDIE__REGISTERPORTS_B__11_0_OFFSET UNITYSDK_OFFSET(0x161DBC80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARDIE__REGISTERPORTS_B__11_1_OFFSET UNITYSDK_OFFSET(0x161DBCD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARDIE__REGISTERPORTS_B__11_2_OFFSET UNITYSDK_OFFSET(0x161DBD30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARDIE__REGISTERPORTS_B__11_3_OFFSET UNITYSDK_OFFSET(0x161DBD40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARDIE__REGISTERPORTS_B__11_4_OFFSET UNITYSDK_OFFSET(0x161DBD50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARDIE__REGISTERPORTS_B__11_5_OFFSET UNITYSDK_OFFSET(0x161DBD60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARDIE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x161DBD70)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDListenAvatarDie_TypeDefinitionIndex = 71632;
	...
	public:
		...
		::System::Int32 ResetCount; // 0xCC
		::System::Boolean OnlyInStage; // 0xD0
		::System::Boolean BoundEvent; // 0xD1
		::System::UInt32 EntityId; // 0xD4
		::System::Int32 Index; // 0xD8
