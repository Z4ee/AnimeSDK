...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MPBUDDYLEFTCHECKNODE_DOREGISTEREVENT_OFFSET UNITYSDK_OFFSET(0x1A05F310)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MPBUDDYLEFTCHECKNODE_GETALIVECOUNT_OFFSET UNITYSDK_OFFSET(0x1A05F6A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MPBUDDYLEFTCHECKNODE_GETDEADCOUNT_OFFSET UNITYSDK_OFFSET(0x1A05F700)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MPBUDDYLEFTCHECKNODE_GETTOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x1A05FA60)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MPBUDDYLEFTCHECKNODE_ONMARCELANYPLAYERFINISH_OFFSET UNITYSDK_OFFSET(0x1A05F5A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MPBUDDYLEFTCHECKNODE_ONMARCELUPDATETOTALNUMBER_OFFSET UNITYSDK_OFFSET(0x1A05F620)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MPBUDDYLEFTCHECKNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A05F190)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MPBUDDYLEFTCHECKNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A05FBE0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_MPBuddyLeftCheckNode_TypeDefinitionIndex = 43241;
	...
	public:
		...
		::FlowCanvas::ValueOutput_1<::System::Int32>* _totalCount; // 0xB8
		::FlowCanvas::ValueOutput_1<::System::Int32>* _deadCount; // 0xC0
		::System::Int32 savedTotalCount; // 0xC8
		::System::Boolean hasRegistered; // 0xCC
		::System::Boolean hasSavedTotalCount; // 0xCD
