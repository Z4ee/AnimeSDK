...
#define MOLEMOLE_FLOWCANVAS_NODES_LDEXITSHOOTGAMETPSMODE_PROCESS_OFFSET UNITYSDK_OFFSET(0x16B7BC90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDEXITSHOOTGAMETPSMODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x16B7BBD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDEXITSHOOTGAMETPSMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x16B7BDC0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDExitShootGameTPSMode_TypeDefinitionIndex = 68034;
