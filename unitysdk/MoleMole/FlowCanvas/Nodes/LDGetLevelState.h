...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETLEVELSTATE_BEGIN_OFFSET UNITYSDK_OFFSET(0x1911C3A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETLEVELSTATE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1911C0B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETLEVELSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1911C490)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETLEVELSTATE__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x1911C4D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETLEVELSTATE__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0x1911C580)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETLEVELSTATE__REGISTERPORTS_B__4_2_OFFSET UNITYSDK_OFFSET(0x1911C630)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETLEVELSTATE__REGISTERPORTS_B__4_3_OFFSET UNITYSDK_OFFSET(0x1911C6D0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetLevelState_TypeDefinitionIndex = 55116;
