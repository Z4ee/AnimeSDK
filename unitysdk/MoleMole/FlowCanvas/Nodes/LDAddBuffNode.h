...
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDBUFFNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x13A80C50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDBUFFNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x13A80F30)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDAddBuffNode_TypeDefinitionIndex = 54083;
