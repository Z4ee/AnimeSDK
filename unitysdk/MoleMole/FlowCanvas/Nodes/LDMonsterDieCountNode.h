...
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_BINDEVENT_OFFSET UNITYSDK_OFFSET(0x161DE220)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_CHECKDIECOUNT_OFFSET UNITYSDK_OFFSET(0x161DDDE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_CHECKFINISH_OFFSET UNITYSDK_OFFSET(0x161DFAF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_CHECKMONSTERDIETYPE_OFFSET UNITYSDK_OFFSET(0x161DF2D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_COMPAREMONSTERCAMP_OFFSET UNITYSDK_OFFSET(0x161DFD60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_FINDINMONSTERMAP_OFFSET UNITYSDK_OFFSET(0x161DF0C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x161DD840)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_ISMATCHMONSTER_OFFSET UNITYSDK_OFFSET(0x161DEEA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x161DE560)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x161DE1D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x161DE4B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_ONLATETICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x161DE500)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_ONMONSTERDIE_OFFSET UNITYSDK_OFFSET(0x161DE670)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x161DD2E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_STOP_OFFSET UNITYSDK_OFFSET(0x161DD530)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_UNBINDEVENT_OFFSET UNITYSDK_OFFSET(0x161DD5B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE__CALLREACHFLOW_OFFSET UNITYSDK_OFFSET(0x161DFCF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x161DFF70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE__REGISTERPORTS_B__14_0_OFFSET UNITYSDK_OFFSET(0x161DFFB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE__REGISTERPORTS_B__14_1_OFFSET UNITYSDK_OFFSET(0x161E0110)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x161E01C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x161E01D0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDMonsterDieCountNode_TypeDefinitionIndex = 57137;

	class LDMonsterDieCountNode : public ::FlowCanvas::FlowNode
	{
	public:
		::System::Collections::Generic::HashSet_1<::System::UInt32>* dieMonsterSet; // 0xA8
		...
		::FlowCanvas::ValueInput_1<::System::Int32>* triggerCountInput; // 0xC8
		...
		::FlowCanvas::ValueInput_1<::System::Int32>* inputNumber; // 0xE8
		::System::Int32 currentDieCount; // 0xF0
		::System::Int32 alreadyTriggerCount; // 0xF4
		::System::Boolean bindEvent; // 0xF8
		::System::Boolean goalReached; // 0xF9
		::System::Boolean nodeEnter; // 0xFA
