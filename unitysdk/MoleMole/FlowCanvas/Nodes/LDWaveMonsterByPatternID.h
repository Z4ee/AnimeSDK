...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_ACTIVEPRELOADMONSTER_OFFSET UNITYSDK_OFFSET(0x1299A9B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_BEGIN_OFFSET UNITYSDK_OFFSET(0x1299CEC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_BUILDCREATEVALUES_OFFSET UNITYSDK_OFFSET(0x1299A010)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x12999C00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x1299CAF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x1299AF20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x129997B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_SEARCHACHORBYPREFIX_OFFSET UNITYSDK_OFFSET(0x1299B750)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_SEARCHMONSTERSPAWNERPOINT_OFFSET UNITYSDK_OFFSET(0x1299AFB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_SEARCHVALIDPOINTBYDISTANCEANDANGLE_OFFSET UNITYSDK_OFFSET(0x1299C590)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_STARTSPAWN_OFFSET UNITYSDK_OFFSET(0x1299CB50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x1299CF60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_WRAPANGLERANGE_OFFSET UNITYSDK_OFFSET(0x1299C4C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__CTOR_OFFSET UNITYSDK_OFFSET(0x1299D150)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__REGISTERPORTS_B__10_0_OFFSET UNITYSDK_OFFSET(0x1299D160)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__REGISTERPORTS_B__10_1_OFFSET UNITYSDK_OFFSET(0x1299D220)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__REGISTERPORTS_B__10_2_OFFSET UNITYSDK_OFFSET(0x1299D340)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__REGISTERPORTS_B__10_3_OFFSET UNITYSDK_OFFSET(0x1299D370)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__REGISTERPORTS_B__10_4_OFFSET UNITYSDK_OFFSET(0x1299D380)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__REGISTERPORTS_B__10_5_OFFSET UNITYSDK_OFFSET(0x1299D390)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__REGISTERPORTS_B__10_6_OFFSET UNITYSDK_OFFSET(0x1299D3A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID___BASE_ACTIVEPRELOADMONSTER_OFFSET UNITYSDK_OFFSET(0x1299D3B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID___BASE_BEGIN_OFFSET UNITYSDK_OFFSET(0x1299D470)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID___BASE_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x1299D4A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID___BASE_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x1299D4B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID___BASE_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x1299D4C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1299D4D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID___BASE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x1299D4E0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveMonsterByPatternID_TypeDefinitionIndex = 51464;

	class LDWaveMonsterByPatternID : public ::MoleMole::FlowCanvas::Nodes::LDWaveMonster
	{
	public:
		::System::Collections::Generic::List_1<::MoleMole::FlowCanvas::Nodes::PatternMonsterCreate*>* monsterCreateValues; // 0x1B0
		::FlowCanvas::ValueInput_1<::System::Single>* spawnIntervalInput; // 0x1B8
		::FlowCanvas::ValueInput_1<::System::Single>* angleRangeInput; // 0x1C0
		::FlowCanvas::ValueInput_1<::System::String*>* anchorPosPrefixInput; // 0x1C8
		::FlowCanvas::ValueInput_1<::System::Int32>* patternId; // 0x1D0
		::FlowCanvas::ValueOutput_1<::System::Int32>* patternTypeOutput; // 0x1D8
		::FlowCanvas::ValueInput_1<::MoleMole::Battle::Entity*>* inputPosEntity; // 0x1E0
		::FlowCanvas::ValueInput_1<::System::Single>* radiusInput; // 0x1E8
		::System::Int32 monsterType; // 0x1F0
		::System::Int32 buildedPatternId; // 0x1F4
		...
		{
			return ((::MoleMole::MonoSpawnPoint*(*)(::PVOID, ::Class_3_C93CC3D2C2AC4067*, ::System::String*, ::UnityEngine::Vector2, ::UnityEngine::Vector2, ::System::Boolean&, ::System::Collections::Generic::HashSet_1<::System::Int32>*))((::PBYTE)hIl2Cpp + MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_SEARCHACHORBYPREFIX_OFFSET))(this, inputModelComponent, prefix, radius, angle, lastChooseLeft, excludePointSet);
		}
