...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_ACTIVEPRELOADMONSTER_OFFSET UNITYSDK_OFFSET(0x1581B700)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_BEGIN_OFFSET UNITYSDK_OFFSET(0x1581DBF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_BUILDCREATEVALUES_OFFSET UNITYSDK_OFFSET(0x1581AD60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x1581A950)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x1581D820)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x1581BC90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1581A500)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_SEARCHACHORBYPREFIX_OFFSET UNITYSDK_OFFSET(0x1581C4C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_SEARCHMONSTERSPAWNERPOINT_OFFSET UNITYSDK_OFFSET(0x1581BD20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_SEARCHVALIDPOINTBYDISTANCEANDANGLE_OFFSET UNITYSDK_OFFSET(0x1581D2C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_STARTSPAWN_OFFSET UNITYSDK_OFFSET(0x1581D880)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x1581DC90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_WRAPANGLERANGE_OFFSET UNITYSDK_OFFSET(0x1581D1F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__CTOR_OFFSET UNITYSDK_OFFSET(0x1581DE80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__REGISTERPORTS_B__10_0_OFFSET UNITYSDK_OFFSET(0x1581DE90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__REGISTERPORTS_B__10_1_OFFSET UNITYSDK_OFFSET(0x1581DF50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__REGISTERPORTS_B__10_2_OFFSET UNITYSDK_OFFSET(0x1581E070)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__REGISTERPORTS_B__10_3_OFFSET UNITYSDK_OFFSET(0x1581E0A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__REGISTERPORTS_B__10_4_OFFSET UNITYSDK_OFFSET(0x1581E0B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__REGISTERPORTS_B__10_5_OFFSET UNITYSDK_OFFSET(0x1581E0C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__REGISTERPORTS_B__10_6_OFFSET UNITYSDK_OFFSET(0x1581E0D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID___BASE_ACTIVEPRELOADMONSTER_OFFSET UNITYSDK_OFFSET(0x1581E0E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID___BASE_BEGIN_OFFSET UNITYSDK_OFFSET(0x1581E1A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID___BASE_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x1581E1D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID___BASE_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x1581E1E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID___BASE_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x1581E1F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1581E200)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID___BASE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x1581E210)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveMonsterByPatternID_TypeDefinitionIndex = 84112;

	class LDWaveMonsterByPatternID : public ::MoleMole::FlowCanvas::Nodes::LDWaveMonster
	{
	public:
		::FlowCanvas::ValueInput_1<::System::String*>* anchorPosPrefixInput; // 0x1B0
		::FlowCanvas::ValueInput_1<::MoleMole::Battle::Entity*>* inputPosEntity; // 0x1B8
		::FlowCanvas::ValueInput_1<::System::Single>* spawnIntervalInput; // 0x1C0
		::FlowCanvas::ValueInput_1<::System::Single>* radiusInput; // 0x1C8
		::FlowCanvas::ValueOutput_1<::System::Int32>* patternTypeOutput; // 0x1D0
		::System::Collections::Generic::List_1<::MoleMole::FlowCanvas::Nodes::PatternMonsterCreate*>* monsterCreateValues; // 0x1D8
		::FlowCanvas::ValueInput_1<::System::Single>* angleRangeInput; // 0x1E0
		::FlowCanvas::ValueInput_1<::System::Int32>* patternId; // 0x1E8
