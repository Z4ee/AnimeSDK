...
#define MOLEMOLE_FLOWCANVAS_NODES_OPENDIRECTIONSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x10D49F10)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int OpenDirectionSelector_TypeDefinitionIndex = 80395;
