...
#define MOLEMOLE_FLOWCANVAS_NODES_OPENDIRECTIONSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16E555B0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int OpenDirectionSelector_TypeDefinitionIndex = 62963;
