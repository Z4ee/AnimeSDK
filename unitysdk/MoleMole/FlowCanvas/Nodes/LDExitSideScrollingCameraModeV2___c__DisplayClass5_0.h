...
#define MOLEMOLE_FLOWCANVAS_NODES_LDEXITSIDESCROLLINGCAMERAMODEV2___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16C9F120)
#define MOLEMOLE_FLOWCANVAS_NODES_LDEXITSIDESCROLLINGCAMERAMODEV2___C__DISPLAYCLASS5_0__HANDLEFLOWINPUT_B__0_OFFSET UNITYSDK_OFFSET(0x16C9F130)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDExitSideScrollingCameraModeV2___c__DisplayClass5_0_TypeDefinitionIndex = 86774;
