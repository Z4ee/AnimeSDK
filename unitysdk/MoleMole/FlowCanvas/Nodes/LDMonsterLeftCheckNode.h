...
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_BINDEVENT_OFFSET UNITYSDK_OFFSET(0x149DDD10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_CHECKALIVECOUNT_OFFSET UNITYSDK_OFFSET(0x149DC190)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_COMPAREMONSTERCAMP_OFFSET UNITYSDK_OFFSET(0x149DE8D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_HANDLECOMPARE_OFFSET UNITYSDK_OFFSET(0x149DDAB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x149DBD10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_ISNORMALCOUNTINGTAG_OFFSET UNITYSDK_OFFSET(0x149DEC60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_ISSERVERCARE_OFFSET UNITYSDK_OFFSET(0x149DB310)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_LISTENENTITYTAGCHANGE_OFFSET UNITYSDK_OFFSET(0x149DE0F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x149DE590)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x149DE030)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x149DE080)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_ONHOSTCHANGED_OFFSET UNITYSDK_OFFSET(0x149DDBC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_ONLATETICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x149DE7E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_ONMONSTERSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x149DE1C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x149DB100)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_REMOTEWAITFLOWPROCESS_OFFSET UNITYSDK_OFFSET(0x149DDB40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_UNBINDEVENT_OFFSET UNITYSDK_OFFSET(0x149DBA10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_WAITTOCHECKALIVECOUNT_OFFSET UNITYSDK_OFFSET(0x149DE840)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE__CALLREACHED_OFFSET UNITYSDK_OFFSET(0x149DB350)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x149DEE90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE__REGISTERPORTS_B__15_0_OFFSET UNITYSDK_OFFSET(0x149DEFC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE___BASE_ISSERVERCARE_OFFSET UNITYSDK_OFFSET(0x149DF460)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x149DF470)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x149DF480)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDMonsterLeftCheckNode_TypeDefinitionIndex = 77507;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::MoleMole::FlowCanvas::Nodes::EntityDieCheckType>* deathCheckType; // 0xE8
		::FlowCanvas::ValueInput_1<::MoleMole::FlowCanvas::Nodes::NumberCompareType>* inputCompareFunc; // 0xF0
		::FlowCanvas::FlowOutput* Reached; // 0xF8
		::System::Boolean eventBind; // 0x100
		::System::Boolean goalReached; // 0x101
		::System::Boolean nodeEnter; // 0x102
		::System::Boolean notifyServer; // 0x103
		...
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::EntityHandle, ::Class_2_945F852A8B481F54_Enum_3_A5191D6218CE9E26, ::MoleMole::GameplayTag))((::PBYTE)hIl2Cpp + MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_LISTENENTITYTAGCHANGE_OFFSET))(this, entityHandle, changeType, tag);
		}
