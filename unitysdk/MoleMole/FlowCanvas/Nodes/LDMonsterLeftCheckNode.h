...
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_BINDEVENT_OFFSET UNITYSDK_OFFSET(0x126111B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_CHECKALIVECOUNT_OFFSET UNITYSDK_OFFSET(0x1260F3C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_COMPAREMONSTERCAMP_OFFSET UNITYSDK_OFFSET(0x12611DA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_HANDLECOMPARE_OFFSET UNITYSDK_OFFSET(0x12610F30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1260EF30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_ISNORMALCOUNTINGTAG_OFFSET UNITYSDK_OFFSET(0x12612130)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_ISSERVERCARE_OFFSET UNITYSDK_OFFSET(0x1260E510)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_LISTENENTITYTAGCHANGE_OFFSET UNITYSDK_OFFSET(0x126115A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x12611A60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x126114E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x12611530)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_ONHOSTCHANGED_OFFSET UNITYSDK_OFFSET(0x12611060)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_ONLATETICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x12611CB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_ONMONSTERSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x12611670)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1260E300)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_REMOTEWAITFLOWPROCESS_OFFSET UNITYSDK_OFFSET(0x12610FE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_UNBINDEVENT_OFFSET UNITYSDK_OFFSET(0x1260EC20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_WAITTOCHECKALIVECOUNT_OFFSET UNITYSDK_OFFSET(0x12611D10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE__CALLREACHED_OFFSET UNITYSDK_OFFSET(0x1260E550)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x12612360)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE__REGISTERPORTS_B__15_0_OFFSET UNITYSDK_OFFSET(0x12612490)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE___BASE_ISSERVERCARE_OFFSET UNITYSDK_OFFSET(0x12612930)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x12612940)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x12612950)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDMonsterLeftCheckNode_TypeDefinitionIndex = 51077;

	class LDMonsterLeftCheckNode : public ::FlowCanvas::FlowNode
	{
	public:
		::System::Collections::Generic::List_1<::MoleMole::Battle::Entity*>* monstList; // 0xA8
		::UnityEngine::Coroutine* coroutine; // 0xB0
		::FlowCanvas::FlowOutput* raised; // 0xB8
		::FlowCanvas::ValueInput_1<::MoleMole::FlowCanvas::Nodes::EntityDieCheckType>* deathCheckType; // 0xC0
		...
		::FlowCanvas::ValueInput_1<::System::Int32>* inputLeftCount; // 0xF0
		::FlowCanvas::ValueInput_1<::System::Boolean>* inputAllMonster; // 0xF8
		::System::Boolean eventBind; // 0x100
		::System::Boolean goalReached; // 0x101
		::System::Boolean notifyServer; // 0x102
		::System::Boolean nodeEnter; // 0x103
		...
		::System::Void ListenEntityTagChange(::MoleMole::EntityHandle entityHandle, ::Class_2_0CCE48347EBD6D5F_Enum_3_A5191D6218CE9E26 changeType, ::MoleMole::GameplayTag tag)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::EntityHandle, ::Class_2_0CCE48347EBD6D5F_Enum_3_A5191D6218CE9E26, ::MoleMole::GameplayTag))((::PBYTE)hIl2Cpp + MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_LISTENENTITYTAGCHANGE_OFFSET))(this, entityHandle, changeType, tag);
		}
