...
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDICONANIMV2_ICONANIMITEM_GETRENDERPRIORITY_OFFSET UNITYSDK_OFFSET(0x1B598C50)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDICONANIMV2_ICONANIMITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B598CE0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ChessboardIconAnimV2_IconAnimItem_TypeDefinitionIndex = 79985;
