...
#define MOLEMOLE_FLOWCANVAS_NODES_TREASURECREATEDATA_HIDEMONSTERID_OFFSET UNITYSDK_OFFSET(0x118C5910)
#define MOLEMOLE_FLOWCANVAS_NODES_TREASURECREATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x118C5950)
#define MOLEMOLE_FLOWCANVAS_NODES_TREASURECREATEDATA___BASE_HIDEMONSTERID_OFFSET UNITYSDK_OFFSET(0x118C59A0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int TreasureCreateData_TypeDefinitionIndex = 55937;
