...
#define MOLEMOLE_FLOWCANVAS_NODES_TREASURECREATEDATA_HIDEMONSTERID_OFFSET UNITYSDK_OFFSET(0x10E19910)
#define MOLEMOLE_FLOWCANVAS_NODES_TREASURECREATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x10E19950)
#define MOLEMOLE_FLOWCANVAS_NODES_TREASURECREATEDATA___BASE_HIDEMONSTERID_OFFSET UNITYSDK_OFFSET(0x10E199A0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int TreasureCreateData_TypeDefinitionIndex = 60709;
