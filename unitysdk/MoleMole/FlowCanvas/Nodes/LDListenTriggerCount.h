...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTRIGGERCOUNT_ATTACHEVENT_OFFSET UNITYSDK_OFFSET(0x125B2A50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTRIGGERCOUNT_CHECKMONSTERFUNCTIONTYPE_OFFSET UNITYSDK_OFFSET(0x125B35D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTRIGGERCOUNT_INVOKE_OFFSET UNITYSDK_OFFSET(0x125B25B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTRIGGERCOUNT_ISALLAVATARIN_OFFSET UNITYSDK_OFFSET(0x125B3840)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTRIGGERCOUNT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x125B2E20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTRIGGERCOUNT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x125B2E70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTRIGGERCOUNT_ONHOSTCHANGED_OFFSET UNITYSDK_OFFSET(0x125B4870)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTRIGGERCOUNT_ONPEERDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x125B4590)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTRIGGERCOUNT_ONTRIGGERENTITYENTER_OFFSET UNITYSDK_OFFSET(0x125B31D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTRIGGERCOUNT_ONTRIGGERENTITYEXIT_OFFSET UNITYSDK_OFFSET(0x125B4350)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTRIGGERCOUNT_ONTRIGGERENTITYSTAY_OFFSET UNITYSDK_OFFSET(0x125B4110)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTRIGGERCOUNT_PROCTRIGGERENTITYENTER_OFFSET UNITYSDK_OFFSET(0x125B3CC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTRIGGERCOUNT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x125B1E40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTRIGGERCOUNT_START_OFFSET UNITYSDK_OFFSET(0x125B22B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTRIGGERCOUNT_WAITAUTHORITYNOTIFYCOROUTINE_OFFSET UNITYSDK_OFFSET(0x125B2530)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTRIGGERCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x125B4A90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTRIGGERCOUNT__REGISTERPORTS_B__23_0_OFFSET UNITYSDK_OFFSET(0x125B4AD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTRIGGERCOUNT__REGISTERPORTS_B__23_1_OFFSET UNITYSDK_OFFSET(0x125B4AE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTRIGGERCOUNT__REGISTERPORTS_B__23_2_OFFSET UNITYSDK_OFFSET(0x125B4AF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTRIGGERCOUNT__REGISTERPORTS_B__23_3_OFFSET UNITYSDK_OFFSET(0x125B4B00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTRIGGERCOUNT__REGISTERPORTS_B__23_4_OFFSET UNITYSDK_OFFSET(0x125B4B10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTRIGGERCOUNT__REGISTERPORTS_B__23_5_OFFSET UNITYSDK_OFFSET(0x125B4B20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTRIGGERCOUNT___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x125B4EB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTRIGGERCOUNT___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x125B4EC0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDListenTriggerCount_TypeDefinitionIndex = 68409;

	class LDListenTriggerCount : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::FlowOutput* triggerEnter; // 0xA8
		::MoleMole::Battle::Entity* triggerEnterEntity; // 0xB0
		::FlowCanvas::ValueInput_1<::System::Boolean>* functionTypeEnableValueInput; // 0xB8
		::MoleMole::Battle::Entity* triggerExitEntity; // 0xC0
		::FlowCanvas::ValueInput_1<::System::Int32>* listenCountValueInput; // 0xC8
		...
		::FlowCanvas::ValueInput_1<::System::Boolean>* enableMonsterValueInput; // 0xE8
		...
		::MoleMole::LevelNodeEventTrigger* levelTrigger; // 0x118
		::FlowCanvas::ValueInput_1<::System::Boolean>* enableAvatarValueInput; // 0x120
		::FlowCanvas::ValueInput_1<::System::Boolean>* colliderEnableValueInput; // 0x128
		::FlowCanvas::FlowOutput* triggerExit; // 0x130
		::System::Boolean attachEvent; // 0x138
		::System::Boolean finished; // 0x139
