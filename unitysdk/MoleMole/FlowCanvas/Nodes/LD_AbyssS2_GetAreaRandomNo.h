...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_GETAREARANDOMNO_INVOKE_OFFSET UNITYSDK_OFFSET(0x19124970)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_GETAREARANDOMNO__CTOR_OFFSET UNITYSDK_OFFSET(0x19124C40)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_GetAreaRandomNo_TypeDefinitionIndex = 60729;
