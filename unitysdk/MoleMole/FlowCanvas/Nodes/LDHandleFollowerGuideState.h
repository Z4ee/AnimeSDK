...
#define MOLEMOLE_FLOWCANVAS_NODES_LDHANDLEFOLLOWERGUIDESTATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x13A82E10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDHANDLEFOLLOWERGUIDESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x13A82F60)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDHandleFollowerGuideState_TypeDefinitionIndex = 84132;
