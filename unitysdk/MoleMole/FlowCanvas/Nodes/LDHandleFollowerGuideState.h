...
#define MOLEMOLE_FLOWCANVAS_NODES_LDHANDLEFOLLOWERGUIDESTATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x16C9FC90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDHANDLEFOLLOWERGUIDESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16C9FDE0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDHandleFollowerGuideState_TypeDefinitionIndex = 53512;
