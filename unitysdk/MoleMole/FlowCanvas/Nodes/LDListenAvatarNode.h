...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_BINDEVENT_OFFSET UNITYSDK_OFFSET(0x17E6D460)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_CHECKFINISH_OFFSET UNITYSDK_OFFSET(0x17E6E9B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_CHECKHIGHTOLOW_OFFSET UNITYSDK_OFFSET(0x17E6F390)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_CHECKLOWTOHIGH_OFFSET UNITYSDK_OFFSET(0x17E6F1B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_CHECKSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x17E6E620)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_GETLOCALAVATARHPPERCENT_OFFSET UNITYSDK_OFFSET(0x17E6DE00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_GETTEAMHPPERCENT_OFFSET UNITYSDK_OFFSET(0x17E6E390)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_INITLOACLAVATARDATA_OFFSET UNITYSDK_OFFSET(0x17E6DBC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_INITTEAMDATA_OFFSET UNITYSDK_OFFSET(0x17E6DFF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x17E6EB90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x17E6D410)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x17E6D670)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_ONLOCALAVATARCHANGE_OFFSET UNITYSDK_OFFSET(0x17E6EC00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x17E6D1E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_START_OFFSET UNITYSDK_OFFSET(0x17E6D8E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_STOP_OFFSET UNITYSDK_OFFSET(0x17E6EB30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_UNBINDEVENT_OFFSET UNITYSDK_OFFSET(0x17E6D6C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_UPDATE_OFFSET UNITYSDK_OFFSET(0x17E6EF10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x17E6F570)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE__REGISTERPORTS_B__21_0_OFFSET UNITYSDK_OFFSET(0x17E6F5B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x17E6F5E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x17E6F5F0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDListenAvatarNode_TypeDefinitionIndex = 54446;

	class LDListenAvatarNode : public ::FlowCanvas::FlowNode
	{
	public:
		// static const ::System::Single tickSpan; // 0x0
		::FlowCanvas::FlowOutput* reachedHighToLowOutput; // 0xA8
		::Class_3_F97B015544BE936B* localAvatarData; // 0xB0
		::FlowCanvas::FlowOutput* flowOut; // 0xB8
		::FlowCanvas::ValueInput_1<::System::Single>* highToLowInput; // 0xC0
		::System::Collections::Generic::List_1<::Class_3_F97B015544BE936B*>* teamDataList; // 0xC8
		::FlowCanvas::ValueInput_1<::MoleMole::FlowCanvas::Nodes::LDListenAvatarNode_ListenAvatarTargetType>* listenTypeInput; // 0xD0
		::Class_3_F25C0BD4B2C92757* aliveStateComponent; // 0xD8
		::FlowCanvas::ValueInput_1<::System::Single>* lowToHighInput; // 0xE0
		::FlowCanvas::ValueInput_1<::System::Int32>* lowToHighTriggerCountInput; // 0xE8
		::FlowCanvas::ValueInput_1<::System::Int32>* highToLowTriggerCountInput; // 0xF0
		::FlowCanvas::FlowInput* flowIn; // 0xF8
		...
		::System::Single tickDelta; // 0x118
		::System::Int32 lowToHightTriggerCnt; // 0x11C
