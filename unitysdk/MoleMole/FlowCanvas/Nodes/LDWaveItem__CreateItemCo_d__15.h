...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEITEM__CREATEITEMCO_D__15_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x18B29100)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEITEM__CREATEITEMCO_D__15_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18B295D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEITEM__CREATEITEMCO_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18B29630)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEITEM__CREATEITEMCO_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x18B295E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEITEM__CREATEITEMCO_D__15_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18B290F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEITEM__CREATEITEMCO_D__15__CTOR_OFFSET UNITYSDK_OFFSET(0x18B290E0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveItem__CreateItemCo_d__15_TypeDefinitionIndex = 51426;
