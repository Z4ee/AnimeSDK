...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEITEM__CREATEITEMCO_D__15_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x10E12070)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEITEM__CREATEITEMCO_D__15_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x10E12540)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEITEM__CREATEITEMCO_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x10E125A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEITEM__CREATEITEMCO_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x10E12550)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEITEM__CREATEITEMCO_D__15_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10E12060)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEITEM__CREATEITEMCO_D__15__CTOR_OFFSET UNITYSDK_OFFSET(0x10E12050)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveItem__CreateItemCo_d__15_TypeDefinitionIndex = 42902;

	class LDWaveItem__CreateItemCo_d__15 : public ::System::Object
	{
	public:
		::MoleMole::FlowCanvas::Nodes::LDWaveItem* __4__this; // 0x10
		::MoleMole::FlowCanvas::Nodes::CreateItemData* _data_5__4; // 0x18
