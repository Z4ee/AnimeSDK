...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_BOSSRUSHENTITYID_INVOKE_OFFSET UNITYSDK_OFFSET(0x19125E20)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_BOSSRUSHENTITYID__CTOR_OFFSET UNITYSDK_OFFSET(0x19125EB0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_BossRushEntityID_TypeDefinitionIndex = 51487;
