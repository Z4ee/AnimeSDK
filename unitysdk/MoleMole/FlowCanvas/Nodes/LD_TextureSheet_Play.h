...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_TEXTURESHEET_PLAY_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x149A0080)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_TEXTURESHEET_PLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x149A0220)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_TEXTURESHEET_PLAY__REGISTERPORTS_B__7_0_OFFSET UNITYSDK_OFFSET(0x149A0260)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_TextureSheet_Play_TypeDefinitionIndex = 67640;

	class LD_TextureSheet_Play : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::Boolean>* _isForceUpdate; // 0xA8
