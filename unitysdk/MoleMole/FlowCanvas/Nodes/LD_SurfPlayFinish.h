...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SURFPLAYFINISH_ONREGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1174FB40)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SURFPLAYFINISH_START_OFFSET UNITYSDK_OFFSET(0x1174FC10)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SURFPLAYFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1174FDE0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_SurfPlayFinish_TypeDefinitionIndex = 45109;
