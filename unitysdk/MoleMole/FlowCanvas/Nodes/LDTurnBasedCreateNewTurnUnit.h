...
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDCREATENEWTURNUNIT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1541BA60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDCREATENEWTURNUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1541BB60)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDTurnBasedCreateNewTurnUnit_TypeDefinitionIndex = 55871;
