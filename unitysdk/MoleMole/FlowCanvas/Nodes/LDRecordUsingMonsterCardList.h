...
#define MOLEMOLE_FLOWCANVAS_NODES_LDRECORDUSINGMONSTERCARDLIST_INVOKE_OFFSET UNITYSDK_OFFSET(0x1160F0D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRECORDUSINGMONSTERCARDLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1160F340)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDRecordUsingMonsterCardList_TypeDefinitionIndex = 44013;
