...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENENTITYBEDAMAGECHANGE_ONEVENT_OFFSET UNITYSDK_OFFSET(0x1499EB60)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENENTITYBEDAMAGECHANGE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1499EAC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENENTITYBEDAMAGECHANGE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1499EB10)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENENTITYBEDAMAGECHANGE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1499E560)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENENTITYBEDAMAGECHANGE_UNBINDEVENT_OFFSET UNITYSDK_OFFSET(0x1499E920)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENENTITYBEDAMAGECHANGE__BINDEVENT_OFFSET UNITYSDK_OFFSET(0x1499E780)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENENTITYBEDAMAGECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1499F260)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENENTITYBEDAMAGECHANGE__REGISTERPORTS_B__11_0_OFFSET UNITYSDK_OFFSET(0x1499F2A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENENTITYBEDAMAGECHANGE__REGISTERPORTS_B__11_1_OFFSET UNITYSDK_OFFSET(0x1499F5E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENENTITYBEDAMAGECHANGE__START_OFFSET UNITYSDK_OFFSET(0x1499E730)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENENTITYBEDAMAGECHANGE___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1499F670)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENENTITYBEDAMAGECHANGE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1499F680)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_ListenEntityBeDamageChange_TypeDefinitionIndex = 55812;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::System::Single>* internalValueInput; // 0xB8
		::FlowCanvas::FlowOutput* internalValueOutPut; // 0xC0
		::FlowCanvas::ValueInput_1<::System::Single>* lowToValueInput; // 0xC8
		::FlowCanvas::FlowOutput* output; // 0xD0
		::FlowCanvas::FlowOutput* everyValueOutPut; // 0xD8
		::System::Single totalBeDamage; // 0xE0
		::System::Single internalBeDamage; // 0xE4
		::System::Boolean totalNotifyTag; // 0xE8
		::System::Boolean hasBindEvent; // 0xE9
