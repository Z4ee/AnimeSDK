...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_CURCHATID_INVOKE_OFFSET UNITYSDK_OFFSET(0x19DB76A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_CURCHATID__CTOR_OFFSET UNITYSDK_OFFSET(0x19DB7730)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_CurChatID_TypeDefinitionIndex = 53303;
