...
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWCREATEENTITYLIKEBOMBERMANBOMB___C__DISPLAYCLASS28_0__CTOR_OFFSET UNITYSDK_OFFSET(0x14279140)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWCREATEENTITYLIKEBOMBERMANBOMB___C__DISPLAYCLASS28_0__INTERNALCOROUTINE_B__0_OFFSET UNITYSDK_OFFSET(0x14279150)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWCREATEENTITYLIKEBOMBERMANBOMB___C__DISPLAYCLASS28_0__INTERNALCOROUTINE_G__CREATEENTITY_2_OFFSET UNITYSDK_OFFSET(0x142799C0)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWCREATEENTITYLIKEBOMBERMANBOMB___C__DISPLAYCLASS28_0__INTERNALCOROUTINE_G__CREATENEXTENTITY_1_OFFSET UNITYSDK_OFFSET(0x142791A0)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWCREATEENTITYLIKEBOMBERMANBOMB___C__DISPLAYCLASS28_0__INTERNALCOROUTINE_G__ISALLBLOCK_3_OFFSET UNITYSDK_OFFSET(0x14279BC0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int HollowCreateEntityLikeBombermanBomb___c__DisplayClass28_0_TypeDefinitionIndex = 53786;
	...
	public:
		...
		::Class_5_AF65C3A968E836D2* chessboard; // 0x40
