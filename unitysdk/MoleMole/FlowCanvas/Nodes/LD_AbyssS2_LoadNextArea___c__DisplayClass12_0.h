...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_LOADNEXTAREA___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1499BB40)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_LOADNEXTAREA___C__DISPLAYCLASS12_0___ABYSSLOADNEXT_ALLFINISHEDCALLBACK_B__1_OFFSET UNITYSDK_OFFSET(0x1499BBD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_LOADNEXTAREA___C__DISPLAYCLASS12_0___ABYSSLOADNEXT_ALLFINISHEDCALLBACK_G___NOTIFYAREAEND_0_OFFSET UNITYSDK_OFFSET(0x1499BB50)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_LoadNextArea___c__DisplayClass12_0_TypeDefinitionIndex = 48202;
