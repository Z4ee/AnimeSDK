...
#define MOLEMOLE_FLOWCANVAS_NODES_GAMEPLAYLOGICWINEVENT_ONRECEIVEEVENT_OFFSET UNITYSDK_OFFSET(0x1510E130)
#define MOLEMOLE_FLOWCANVAS_NODES_GAMEPLAYLOGICWINEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1510E0B0)
#define MOLEMOLE_FLOWCANVAS_NODES_GAMEPLAYLOGICWINEVENT_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1510DE70)
#define MOLEMOLE_FLOWCANVAS_NODES_GAMEPLAYLOGICWINEVENT_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1510DF90)
#define MOLEMOLE_FLOWCANVAS_NODES_GAMEPLAYLOGICWINEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1510E200)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int GamePlayLogicWinEvent_TypeDefinitionIndex = 54053;
