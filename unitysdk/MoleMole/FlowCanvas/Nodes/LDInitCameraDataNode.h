...
#define MOLEMOLE_FLOWCANVAS_NODES_LDINITCAMERADATANODE_INITCAMERACOMPONENT_OFFSET UNITYSDK_OFFSET(0x1A398CC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDINITCAMERADATANODE_INITCAMERADATA_OFFSET UNITYSDK_OFFSET(0x1A398BC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDINITCAMERADATANODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A398D00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDINITCAMERADATANODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A398D70)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDInitCameraDataNode_TypeDefinitionIndex = 74573;
