...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETTEAMENTITYNODE_GETTEAMENTITY_OFFSET UNITYSDK_OFFSET(0x1B832FB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETTEAMENTITYNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1B8330B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETTEAMENTITYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B833160)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETTEAMENTITYNODE__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x1B8331A0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetTeamEntityNode_TypeDefinitionIndex = 87747;
