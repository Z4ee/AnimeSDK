...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETTEAMENTITYNODE_GETTEAMENTITY_OFFSET UNITYSDK_OFFSET(0x18209030)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETTEAMENTITYNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x18209130)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETTEAMENTITYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x182091E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETTEAMENTITYNODE__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x18209220)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetTeamEntityNode_TypeDefinitionIndex = 42642;
