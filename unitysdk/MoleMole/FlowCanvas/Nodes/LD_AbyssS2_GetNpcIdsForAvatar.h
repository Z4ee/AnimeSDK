...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_GETNPCIDSFORAVATAR_INNERFINDNPCIDS_OFFSET UNITYSDK_OFFSET(0x12618D70)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_GETNPCIDSFORAVATAR_INVOKE_OFFSET UNITYSDK_OFFSET(0x12618AD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_GETNPCIDSFORAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x12618F60)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_GetNpcIdsForAvatar_TypeDefinitionIndex = 65810;
