...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_GETAREAFOCUSUISPECIALPARAM_BUILDPARAMFROMAREA_OFFSET UNITYSDK_OFFSET(0x15123C10)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_GETAREAFOCUSUISPECIALPARAM_GETAREAAFFIXICONPATHBYAREAID_OFFSET UNITYSDK_OFFSET(0x151245A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_GETAREAFOCUSUISPECIALPARAM_GETAREAICONPATHBYAREAID_OFFSET UNITYSDK_OFFSET(0x15124450)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_GETAREAFOCUSUISPECIALPARAM_INVOKE_OFFSET UNITYSDK_OFFSET(0x151237D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_GETAREAFOCUSUISPECIALPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x151246F0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_GetAreaFocusUISpecialParam_TypeDefinitionIndex = 59226;
