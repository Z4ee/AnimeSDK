...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT_BINDEVENT_OFFSET UNITYSDK_OFFSET(0x118B8020)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT_HANDLERWAYPOINTEVT_OFFSET UNITYSDK_OFFSET(0x118B8380)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT_INTERNALENTITYSTAYCOROUTINE_OFFSET UNITYSDK_OFFSET(0x118B8850)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT_ONENTITYENTERWAYPOINT_OFFSET UNITYSDK_OFFSET(0x118B84C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT_ONENTITYEXITWAYPOINT_OFFSET UNITYSDK_OFFSET(0x118B8680)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x118B81C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x118B7820)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x118B7860)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT_ONNODETASKFINISH_OFFSET UNITYSDK_OFFSET(0x118B8410)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x118B7620)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT_STARTLISTEN_OFFSET UNITYSDK_OFFSET(0x118B7A80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT_UNBINDEVENT_OFFSET UNITYSDK_OFFSET(0x118B78E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x118B88D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT__REGISTERPORTS_B__19_0_OFFSET UNITYSDK_OFFSET(0x118B8910)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x118B8940)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x118B8950)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDListenWayPointCount_TypeDefinitionIndex = 40344;
	...
	public:
		...
		::FlowCanvas::FlowOutput* wayPointOutPort; // 0xB8
		::FlowCanvas::ValueInput_1<::System::String*>* waypointInput; // 0xC0
		::FlowCanvas::ValueInput_1<::System::String*>* waypathNameInput; // 0xC8
		::FlowCanvas::FlowOutput* wayPointInPort; // 0xD0
		::UnityEngine::Coroutine* stayWaypointCo; // 0xD8
		::FlowCanvas::FlowInput* inputPort; // 0xE0
		::FlowCanvas::FlowOutput* outputPort; // 0xE8
		::FlowCanvas::ValueInput_1<::MoleMole::Battle::Entity*>* entityInput; // 0xF0
		::System::String* currWayPath; // 0xF8
		::System::String* currWayPoint; // 0x100
		::System::Single elapsedStart; // 0x108
		::System::Int32 currentListenCount; // 0x10C
		::System::Single timer; // 0x110
		::System::Boolean attachEventFinish; // 0x114
		::System::Boolean nodeStart; // 0x115
		::System::UInt32 listenEntityId; // 0x118
