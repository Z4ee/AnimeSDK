...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETCAMERASPHERICAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x125B6660)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETCAMERASPHERICAL__CTOR_OFFSET UNITYSDK_OFFSET(0x125B6700)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSetCameraSpherical_TypeDefinitionIndex = 62309;
