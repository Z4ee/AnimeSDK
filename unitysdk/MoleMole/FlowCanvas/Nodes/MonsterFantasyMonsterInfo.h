...
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYMONSTERINFO_FROMPROTO_OFFSET UNITYSDK_OFFSET(0x15127CD0)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYMONSTERINFO_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0x15127C60)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYMONSTERINFO_GET_ISNEW_OFFSET UNITYSDK_OFFSET(0x15127C80)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYMONSTERINFO_GET_UNLOCKSKILLLIST_OFFSET UNITYSDK_OFFSET(0x15127CA0)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYMONSTERINFO_SET_ENTITYID_OFFSET UNITYSDK_OFFSET(0x15127C70)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYMONSTERINFO_SET_ISNEW_OFFSET UNITYSDK_OFFSET(0x15127C90)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYMONSTERINFO_SET_UNLOCKSKILLLIST_OFFSET UNITYSDK_OFFSET(0x15127CB0)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYMONSTERINFO_TOPROTO_OFFSET UNITYSDK_OFFSET(0x15127E10)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYMONSTERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x15127CC0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int MonsterFantasyMonsterInfo_TypeDefinitionIndex = 78857;
