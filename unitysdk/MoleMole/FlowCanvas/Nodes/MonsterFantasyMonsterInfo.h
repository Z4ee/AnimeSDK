...
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYMONSTERINFO_FROMPROTO_OFFSET UNITYSDK_OFFSET(0x1B1B38A0)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYMONSTERINFO_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0x1B1B3830)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYMONSTERINFO_GET_ISNEW_OFFSET UNITYSDK_OFFSET(0x1B1B3850)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYMONSTERINFO_GET_UNLOCKSKILLLIST_OFFSET UNITYSDK_OFFSET(0x1B1B3870)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYMONSTERINFO_SET_ENTITYID_OFFSET UNITYSDK_OFFSET(0x1B1B3840)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYMONSTERINFO_SET_ISNEW_OFFSET UNITYSDK_OFFSET(0x1B1B3860)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYMONSTERINFO_SET_UNLOCKSKILLLIST_OFFSET UNITYSDK_OFFSET(0x1B1B3880)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYMONSTERINFO_TOPROTO_OFFSET UNITYSDK_OFFSET(0x1B1B39E0)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYMONSTERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1B3890)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int MonsterFantasyMonsterInfo_TypeDefinitionIndex = 89804;
