...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETLEVELZEROROOMINDEX_INVOKE_OFFSET UNITYSDK_OFFSET(0x12BBB970)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETLEVELZEROROOMINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x12BBBB40)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_GetLevelZeroRoomIndex_TypeDefinitionIndex = 50644;
