...
#define MOLEMOLE_FLOWCANVAS_NODES_LDTRIGGERABILITYATPOSITION_REALCALL_OFFSET UNITYSDK_OFFSET(0x149E2C20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTRIGGERABILITYATPOSITION_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x149E2E50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTRIGGERABILITYATPOSITION_START_OFFSET UNITYSDK_OFFSET(0x149E2FA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTRIGGERABILITYATPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x149E3370)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDTriggerAbilityAtPosition_TypeDefinitionIndex = 89432;

	class LDTriggerAbilityAtPosition : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::FlowOutput* _flowOutputOut; // 0xA8
		::UnityEngine::Coroutine* handle; // 0xB0
		...
		::FlowCanvas::ValueInput_1<::System::String*>* _inputAbilityName; // 0xD0
