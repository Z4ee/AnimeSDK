...
#define MOLEMOLE_FLOWCANVAS_NODES_LDTRIGGERABILITYATPOSITION_REALCALL_OFFSET UNITYSDK_OFFSET(0x16D418C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTRIGGERABILITYATPOSITION_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x16D41AF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTRIGGERABILITYATPOSITION_START_OFFSET UNITYSDK_OFFSET(0x16D41C40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTRIGGERABILITYATPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x16D42010)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDTriggerAbilityAtPosition_TypeDefinitionIndex = 75759;

	class LDTriggerAbilityAtPosition : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::UnityEngine::Vector3>* _inputRotation; // 0xA8
		::FlowCanvas::ValueInput_1<::UnityEngine::Vector3>* _inputPosition; // 0xB0
		::FlowCanvas::ValueInput_1<::System::String*>* _inputAbilityName; // 0xB8
