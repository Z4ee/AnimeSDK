...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_SHOWLAYERRESULT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x16D44670)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_SHOWLAYERRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x16D44750)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_SHOWLAYERRESULT__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x16D44790)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_SHOWLAYERRESULT__REGISTERPORTS_B__2_1_OFFSET UNITYSDK_OFFSET(0x16D44920)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_ShowLayerResult_TypeDefinitionIndex = 42233;
