...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED_ISMONSTER_OFFSET UNITYSDK_OFFSET(0x1A042400)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED_ONEVTKILLED_OFFSET UNITYSDK_OFFSET(0x1A042020)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A042780)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A042580)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A041F00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED__CTOR_OFFSET UNITYSDK_OFFSET(0x1A042830)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x1A0428D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0x1A0428E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A0428F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED___BASE_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A042900)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCoinBrushingListenMonsterBeKilled_TypeDefinitionIndex = 49804;
	...
	public:
		...
		::System::Collections::Generic::List_1<::MoleMole::GameplayTag>* _emptyTags; // 0xB0
		::MoleMole::Battle::Entity* _killedEntity; // 0xB8
		::FlowCanvas::FlowOutput* _onMonsterKilled; // 0xC0
		::System::Collections::Generic::List_1<::MoleMole::GameplayTag>* _killedEntityTags; // 0xC8
