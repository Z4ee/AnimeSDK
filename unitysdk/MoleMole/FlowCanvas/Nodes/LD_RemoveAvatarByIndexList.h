...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_REMOVEAVATARBYINDEXLIST_INVOKE_OFFSET UNITYSDK_OFFSET(0x18217E80)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_REMOVEAVATARBYINDEXLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x18217ED0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_RemoveAvatarByIndexList_TypeDefinitionIndex = 63502;
