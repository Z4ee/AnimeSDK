...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER_ACTIVEPRELOADMONSTER_OFFSET UNITYSDK_OFFSET(0x1A9A1180)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER_BEGIN_OFFSET UNITYSDK_OFFSET(0x1A99FDA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x1A9A0F80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER_EXPENDCREATEDLIST_OFFSET UNITYSDK_OFFSET(0x1A9A0040)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER_FULLCREATEDLIST_OFFSET UNITYSDK_OFFSET(0x1A9A0B30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x1A9A0F20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x1A9A0E20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER_GETCURRENTMONSTERIDTYPE_OFFSET UNITYSDK_OFFSET(0x1A99FD50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER_GETCURRENTTAG_OFFSET UNITYSDK_OFFSET(0x1A99FF90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER_GETMONSTERTYPE_OFFSET UNITYSDK_OFFSET(0x1A9A1680)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A99F910)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A1790)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER__REGISTERPORTS_B__6_0_OFFSET UNITYSDK_OFFSET(0x1A9A17A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER__REGISTERPORTS_B__6_1_OFFSET UNITYSDK_OFFSET(0x1A9A17B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER__REGISTERPORTS_B__6_2_OFFSET UNITYSDK_OFFSET(0x1A9A17C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER___BASE_ACTIVEPRELOADMONSTER_OFFSET UNITYSDK_OFFSET(0x1A9A17D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER___BASE_BEGIN_OFFSET UNITYSDK_OFFSET(0x1A9A1890)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER___BASE_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x1A9A18C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER___BASE_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x1A9A18D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER___BASE_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x1A9A18E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER___BASE_GETCURRENTMONSTERIDTYPE_OFFSET UNITYSDK_OFFSET(0x1A9A18F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A9A1900)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDLevelZeroWaveMonster_TypeDefinitionIndex = 44638;

	class LDLevelZeroWaveMonster : public ::MoleMole::FlowCanvas::Nodes::LDWaveMonster
	{
	public:
		::FlowCanvas::ValueInput_1<::System::Int32>* tagInput; // 0x1B0
		::FlowCanvas::ValueInput_1<::System::Collections::Generic::List_1<::MoleMole::FlowCanvas::LevelZeroMonsterCreateData*>*>* levelZeroCreateInput; // 0x1B8
		::System::Collections::Generic::List_1<::MoleMole::FlowCanvas::Nodes::MonsterCreateData*>* extendCreateData; // 0x1C0
