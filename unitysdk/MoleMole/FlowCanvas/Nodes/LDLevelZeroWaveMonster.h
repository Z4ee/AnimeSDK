...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER_ACTIVEPRELOADMONSTER_OFFSET UNITYSDK_OFFSET(0x16E48A40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER_BEGIN_OFFSET UNITYSDK_OFFSET(0x16E47640)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x16E48830)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER_EXPENDCREATEDLIST_OFFSET UNITYSDK_OFFSET(0x16E478E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER_FULLCREATEDLIST_OFFSET UNITYSDK_OFFSET(0x16E483E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x16E487D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x16E486D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER_GETCURRENTMONSTERIDTYPE_OFFSET UNITYSDK_OFFSET(0x16E475F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER_GETCURRENTTAG_OFFSET UNITYSDK_OFFSET(0x16E47830)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER_GETMONSTERTYPE_OFFSET UNITYSDK_OFFSET(0x16E48F50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x16E471C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x16E49060)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER__REGISTERPORTS_B__6_0_OFFSET UNITYSDK_OFFSET(0x16E49070)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER__REGISTERPORTS_B__6_1_OFFSET UNITYSDK_OFFSET(0x16E49080)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER__REGISTERPORTS_B__6_2_OFFSET UNITYSDK_OFFSET(0x16E49090)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER___BASE_ACTIVEPRELOADMONSTER_OFFSET UNITYSDK_OFFSET(0x16E490A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER___BASE_BEGIN_OFFSET UNITYSDK_OFFSET(0x16E49160)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER___BASE_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x16E49190)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER___BASE_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x16E491A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER___BASE_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x16E491B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER___BASE_GETCURRENTMONSTERIDTYPE_OFFSET UNITYSDK_OFFSET(0x16E491C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROWAVEMONSTER___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x16E491D0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDLevelZeroWaveMonster_TypeDefinitionIndex = 48807;

	class LDLevelZeroWaveMonster : public ::MoleMole::FlowCanvas::Nodes::LDWaveMonster
	{
	public:
		::FlowCanvas::ValueInput_1<::System::Collections::Generic::List_1<::MoleMole::FlowCanvas::LevelZeroMonsterCreateData*>*>* levelZeroCreateInput; // 0x1B0
		::FlowCanvas::ValueInput_1<::System::Int32>* tagInput; // 0x1B8
		::FlowCanvas::ValueInput_1<::MoleMole::Project::Config::MonsterGroupTemplateExt_MonsterTypeEnum>* typeInput; // 0x1C0
		::System::Collections::Generic::List_1<::MoleMole::FlowCanvas::Nodes::MonsterCreateData*>* extendCreateData; // 0x1C8
		::System::Boolean inited; // 0x1D0
		::MoleMole::FlowCanvas::Nodes::MonsterIDType _monsterIDType; // 0x1D4
