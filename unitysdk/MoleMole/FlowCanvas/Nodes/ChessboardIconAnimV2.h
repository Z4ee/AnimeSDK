...
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDICONANIMV2_CHECKRENDERSTATEENABLE_OFFSET UNITYSDK_OFFSET(0x18B1B940)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDICONANIMV2_GET_RENDERDATAHANDLELIST_OFFSET UNITYSDK_OFFSET(0x18B1B830)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDICONANIMV2_INVOKE_OFFSET UNITYSDK_OFFSET(0x18B1BC30)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDICONANIMV2__CTOR_OFFSET UNITYSDK_OFFSET(0x18B1C0A0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ChessboardIconAnimV2_TypeDefinitionIndex = 73879;
