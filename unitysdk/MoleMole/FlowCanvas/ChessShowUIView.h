...
#define MOLEMOLE_FLOWCANVAS_CHESSSHOWUIVIEW_INVOKE_OFFSET UNITYSDK_OFFSET(0x149D3BD0)
#define MOLEMOLE_FLOWCANVAS_CHESSSHOWUIVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x149D4040)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessShowUIView_TypeDefinitionIndex = 74088;
