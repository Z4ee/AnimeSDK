...
#define MOLEMOLE_FLOWCANVAS_HACKSHARDEDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x11605540)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int HackShardedInfo_TypeDefinitionIndex = 62196;
