...
#define MOLEMOLE_FLOWCANVAS_HACKSHARDEDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x14275300)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int HackShardedInfo_TypeDefinitionIndex = 79046;
