...
#define MOLEMOLE_FLOWCANVAS_CHESSHACKENTITYMOVENODE___C__DISPLAYCLASS15_0__CTOR_OFFSET UNITYSDK_OFFSET(0x118AAC70)
#define MOLEMOLE_FLOWCANVAS_CHESSHACKENTITYMOVENODE___C__DISPLAYCLASS15_0__SOLVECOLLISION_B__0_OFFSET UNITYSDK_OFFSET(0x118AAC80)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessHackEntityMoveNode___c__DisplayClass15_0_TypeDefinitionIndex = 82869;
