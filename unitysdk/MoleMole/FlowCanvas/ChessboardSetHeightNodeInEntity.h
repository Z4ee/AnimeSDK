...
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSETHEIGHTNODEINENTITY_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1B195D20)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSETHEIGHTNODEINENTITY_START_OFFSET UNITYSDK_OFFSET(0x1B195E30)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSETHEIGHTNODEINENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1964B0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSETHEIGHTNODEINENTITY__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x1B1964F0)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessboardSetHeightNodeInEntity_TypeDefinitionIndex = 53962;
