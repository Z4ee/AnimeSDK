...
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_GETTIME_OFFSET UNITYSDK_OFFSET(0x15404730)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_GET_CURRENTCHESSBOARD_OFFSET UNITYSDK_OFFSET(0x15403ED0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_GET_DELAY_OFFSET UNITYSDK_OFFSET(0x15403C70)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_GET_DISCRETEMODE_OFFSET UNITYSDK_OFFSET(0x15403DC0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x15403EC0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_GET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0x15403E40)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_GET_MAXX_OFFSET UNITYSDK_OFFSET(0x15403AF0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_GET_MAXY_OFFSET UNITYSDK_OFFSET(0x15403BF0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_GET_MINX_OFFSET UNITYSDK_OFFSET(0x15403A70)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_GET_MINY_OFFSET UNITYSDK_OFFSET(0x15403B70)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x154047D0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x15403FD0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_SETACTIVE_OFFSET UNITYSDK_OFFSET(0x15404D20)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_START_OFFSET UNITYSDK_OFFSET(0x15404C10)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_STOP_OFFSET UNITYSDK_OFFSET(0x15404AF0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_UPDATE_OFFSET UNITYSDK_OFFSET(0x154042C0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x15404D80)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE__REGISTERPORTS_B__40_0_OFFSET UNITYSDK_OFFSET(0x15404E20)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE__REGISTERPORTS_B__40_1_OFFSET UNITYSDK_OFFSET(0x15404E50)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE__REGISTERPORTS_B__40_2_OFFSET UNITYSDK_OFFSET(0x15404E60)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE__REGISTERPORTS_B__40_3_OFFSET UNITYSDK_OFFSET(0x15404E70)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int HackerGameWaveActionNode_TypeDefinitionIndex = 76969;
	...
	public:
		...
		::FlowCanvas::FlowOutput* _invokeColumn; // 0xE0
		::FlowCanvas::FlowOutput* _invokeCell; // 0xE8
		::FlowCanvas::ValueInput_1<::System::Boolean>* _discreteMode; // 0xF0
		::FlowCanvas::ValueOutput_1<::MoleMole::HollowChessboard::HollowCell>* _cellOutput; // 0xF8
		::FlowCanvas::ValueInput_1<::System::Boolean>* _isPaused; // 0x100
		::FlowCanvas::ValueInput_1<::System::Int32>* _minX; // 0x108
		::FlowCanvas::ValueOutput_1<::System::Int32>* _xOutput; // 0x110
		::FlowCanvas::ValueInput_1<::System::Collections::Generic::List_1<::System::Single>*>* _delay; // 0x118
		::FlowCanvas::ValueInput_1<::System::Int32>* _minY; // 0x120
		::FlowCanvas::ValueOutput_1<::System::Int32>* _yOutput; // 0x128
		::FlowCanvas::ValueInput_1<::System::Int32>* _maxX; // 0x130
		::FlowCanvas::FlowInput* _start; // 0x138
		::FlowCanvas::ValueInput_1<::System::Int32>* _maxY; // 0x140
		::System::Boolean _isActive; // 0x148
		::System::Single _timer; // 0x14C
		::System::Int32 _y; // 0x150
		::MoleMole::HollowChessboard::HollowCell _cell; // 0x154
		::System::Int32 _x; // 0x160
