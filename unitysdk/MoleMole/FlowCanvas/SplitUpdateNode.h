...
#define MOLEMOLE_FLOWCANVAS_SPLITUPDATENODE_ADVANCE_OFFSET UNITYSDK_OFFSET(0x15823280)
#define MOLEMOLE_FLOWCANVAS_SPLITUPDATENODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x15823070)
#define MOLEMOLE_FLOWCANVAS_SPLITUPDATENODE_START_OFFSET UNITYSDK_OFFSET(0x15823570)
#define MOLEMOLE_FLOWCANVAS_SPLITUPDATENODE_STOP_OFFSET UNITYSDK_OFFSET(0x158236A0)
#define MOLEMOLE_FLOWCANVAS_SPLITUPDATENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x158237D0)
#define MOLEMOLE_FLOWCANVAS_SPLITUPDATENODE__REGISTERPORTS_B__0_0_OFFSET UNITYSDK_OFFSET(0x15823810)
#define MOLEMOLE_FLOWCANVAS_SPLITUPDATENODE__REGISTERPORTS_B__0_1_OFFSET UNITYSDK_OFFSET(0x15823840)
#define MOLEMOLE_FLOWCANVAS_SPLITUPDATENODE__REGISTERPORTS_B__0_2_OFFSET UNITYSDK_OFFSET(0x15823870)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int SplitUpdateNode_TypeDefinitionIndex = 87167;

	class SplitUpdateNode : public ::FlowCanvas::FlowNode
	{
	public:
		::FlowCanvas::FlowOutput* _finish; // 0xA8
		::FlowCanvas::FlowInput* _advance; // 0xB0
		::FlowCanvas::FlowOutput* _update; // 0xB8
		::FlowCanvas::ValueInput_1<::System::Int32>* _delayedFrames; // 0xC0
		::FlowCanvas::ValueInput_1<::System::Int32>* _updateInterval; // 0xC8
		::FlowCanvas::FlowOutput* _delayedFinish; // 0xD0
		::FlowCanvas::FlowOutput* _startOutput; // 0xD8
		::FlowCanvas::FlowInput* _stop; // 0xE0
		::FlowCanvas::ValueInput_1<::System::Int32>* _feverEnergy; // 0xE8
