...
#define MOLEMOLE_FLOWCANVAS_HACKERCLOSESCANLINE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A040010)
#define MOLEMOLE_FLOWCANVAS_HACKERCLOSESCANLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A040A40)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int HackerCloseScanLine_TypeDefinitionIndex = 63268;
