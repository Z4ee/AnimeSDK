...
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECTBYTYPE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B597610)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECTBYTYPE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1B597B60)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECTBYTYPE_PROCESSSCREENEFFECT_OFFSET UNITYSDK_OFFSET(0x1B5976B0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECTBYTYPE_STOPEFFECT_OFFSET UNITYSDK_OFFSET(0x1B597A20)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECTBYTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B597D20)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECTBYTYPE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1B597DF0)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessboardPlayerScreenEffectByType_TypeDefinitionIndex = 53448;
