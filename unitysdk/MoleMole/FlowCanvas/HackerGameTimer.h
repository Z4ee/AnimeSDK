...
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER_PAUSE_OFFSET UNITYSDK_OFFSET(0x17E690B0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x17E68E00)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER_RESUME_OFFSET UNITYSDK_OFFSET(0x17E69040)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER_START_OFFSET UNITYSDK_OFFSET(0x17E69120)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER_UPDATE_OFFSET UNITYSDK_OFFSET(0x17E69190)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER__CTOR_OFFSET UNITYSDK_OFFSET(0x17E69240)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER__REGISTERPORTS_B__0_0_OFFSET UNITYSDK_OFFSET(0x17E69280)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER__REGISTERPORTS_B__0_1_OFFSET UNITYSDK_OFFSET(0x17E69320)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER__REGISTERPORTS_B__0_2_OFFSET UNITYSDK_OFFSET(0x17E693B0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER__REGISTERPORTS_B__0_3_OFFSET UNITYSDK_OFFSET(0x17E69440)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER__REGISTERPORTS_B__0_4_OFFSET UNITYSDK_OFFSET(0x17E69450)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER__REGISTERPORTS_B__0_5_OFFSET UNITYSDK_OFFSET(0x17E69470)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int HackerGameTimer_TypeDefinitionIndex = 62129;
	...
	public:
		...
		::FlowCanvas::ValueOutput_1<::System::Single>* _totalTimeOutput; // 0xD0
