...
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER_PAUSE_OFFSET UNITYSDK_OFFSET(0x16B79030)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x16B78D90)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER_RESUME_OFFSET UNITYSDK_OFFSET(0x16B78FC0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER_START_OFFSET UNITYSDK_OFFSET(0x16B790A0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER_UPDATE_OFFSET UNITYSDK_OFFSET(0x16B79110)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER__CTOR_OFFSET UNITYSDK_OFFSET(0x16B791C0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER__REGISTERPORTS_B__0_0_OFFSET UNITYSDK_OFFSET(0x16B79200)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER__REGISTERPORTS_B__0_1_OFFSET UNITYSDK_OFFSET(0x16B792A0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER__REGISTERPORTS_B__0_2_OFFSET UNITYSDK_OFFSET(0x16B79330)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER__REGISTERPORTS_B__0_3_OFFSET UNITYSDK_OFFSET(0x16B793C0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER__REGISTERPORTS_B__0_4_OFFSET UNITYSDK_OFFSET(0x16B793D0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER__REGISTERPORTS_B__0_5_OFFSET UNITYSDK_OFFSET(0x16B793F0)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int HackerGameTimer_TypeDefinitionIndex = 50761;

	class HackerGameTimer : public ::FlowCanvas::FlowNode
	{
	public:
		::FlowCanvas::ValueOutput_1<::System::Single>* _totalTimeOutput; // 0xA8
		::FlowCanvas::FlowInput* _resume; // 0xB0
		::FlowCanvas::ValueOutput_1<::System::Int32>* _totalTimeOutputInt32; // 0xB8
		::FlowCanvas::FlowInput* _start; // 0xC0
		::FlowCanvas::FlowOutput* _advance; // 0xC8
		::FlowCanvas::ValueOutput_1<::System::Single>* _deltaTimeFloat; // 0xD0
		::FlowCanvas::FlowInput* _pause; // 0xD8
		::System::Single _totalTime; // 0xE0
		::System::Single _deltaTime; // 0xE4
		::System::Boolean _isPaused; // 0xE8
