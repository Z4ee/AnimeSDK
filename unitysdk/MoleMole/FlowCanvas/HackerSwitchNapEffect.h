...
#define MOLEMOLE_FLOWCANVAS_HACKERSWITCHNAPEFFECT_CLEAR_OFFSET UNITYSDK_OFFSET(0x18411100)
#define MOLEMOLE_FLOWCANVAS_HACKERSWITCHNAPEFFECT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x184110B0)
#define MOLEMOLE_FLOWCANVAS_HACKERSWITCHNAPEFFECT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x18410F80)
#define MOLEMOLE_FLOWCANVAS_HACKERSWITCHNAPEFFECT_TRYSWITCH_OFFSET UNITYSDK_OFFSET(0x184111F0)
#define MOLEMOLE_FLOWCANVAS_HACKERSWITCHNAPEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x184114E0)
#define MOLEMOLE_FLOWCANVAS_HACKERSWITCHNAPEFFECT__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0x18411520)
#define MOLEMOLE_FLOWCANVAS_HACKERSWITCHNAPEFFECT__REGISTERPORTS_B__1_1_OFFSET UNITYSDK_OFFSET(0x18411570)
#define MOLEMOLE_FLOWCANVAS_HACKERSWITCHNAPEFFECT___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x18411580)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int HackerSwitchNapEffect_TypeDefinitionIndex = 75944;
