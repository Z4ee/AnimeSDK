...
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASER__EXECUTEDELAYEDLASER_D__30_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1510CAB0)
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASER__EXECUTEDELAYEDLASER_D__30_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1510CBD0)
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASER__EXECUTEDELAYEDLASER_D__30_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1510CC30)
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASER__EXECUTEDELAYEDLASER_D__30_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1510CBE0)
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASER__EXECUTEDELAYEDLASER_D__30_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1510CAA0)
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASER__EXECUTEDELAYEDLASER_D__30__CTOR_OFFSET UNITYSDK_OFFSET(0x1510B2B0)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int DelayedLaser__ExecuteDelayedLaser_d__30_TypeDefinitionIndex = 64455;
