...
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSETGLOBALRTPC_INVOKE_OFFSET UNITYSDK_OFFSET(0x16038210)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSETGLOBALRTPC_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x160383C0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSETGLOBALRTPC__CTOR_OFFSET UNITYSDK_OFFSET(0x160384E0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSETGLOBALRTPC___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x16038570)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessboardSetGlobalRTPC_TypeDefinitionIndex = 77278;
