...
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSETGLOBALRTPC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1382CE20)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSETGLOBALRTPC_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1382CFD0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSETGLOBALRTPC__CTOR_OFFSET UNITYSDK_OFFSET(0x1382D0F0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSETGLOBALRTPC___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1382D180)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessboardSetGlobalRTPC_TypeDefinitionIndex = 40814;
