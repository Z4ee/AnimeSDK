...
#define MOLEMOLE_FLOWCANVAS_CHESSFIXHOLLOWCELLLIST_INVOKE_OFFSET UNITYSDK_OFFSET(0x10DFEF50)
#define MOLEMOLE_FLOWCANVAS_CHESSFIXHOLLOWCELLLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x10DFF090)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessFixHollowCellList_TypeDefinitionIndex = 40000;
