...
#define MOLEMOLE_FLOWCANVAS_HACKEROVERRIDEQUESTCHALLENGE_HANDLEQUEST_OFFSET UNITYSDK_OFFSET(0x18205290)
#define MOLEMOLE_FLOWCANVAS_HACKEROVERRIDEQUESTCHALLENGE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18204D50)
#define MOLEMOLE_FLOWCANVAS_HACKEROVERRIDEQUESTCHALLENGE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x182054A0)
#define MOLEMOLE_FLOWCANVAS_HACKEROVERRIDEQUESTCHALLENGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18205630)
#define MOLEMOLE_FLOWCANVAS_HACKEROVERRIDEQUESTCHALLENGE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x18205650)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int HackerOverrideQuestChallenge_TypeDefinitionIndex = 39998;
