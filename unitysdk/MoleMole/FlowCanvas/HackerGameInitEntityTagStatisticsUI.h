...
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEINITENTITYTAGSTATISTICSUI_INVOKE_OFFSET UNITYSDK_OFFSET(0x17E68730)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEINITENTITYTAGSTATISTICSUI_REGISTERVIRUSINDEX_OFFSET UNITYSDK_OFFSET(0x17E689A0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEINITENTITYTAGSTATISTICSUI__CTOR_OFFSET UNITYSDK_OFFSET(0x17E68B40)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int HackerGameInitEntityTagStatisticsUI_TypeDefinitionIndex = 78552;
