...
#define MOLEMOLE_FLOWCANVAS_CHESSBOARD_VIRUSTIMEOUT_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x10D33770)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARD_VIRUSTIMEOUT__CCTOR_OFFSET UNITYSDK_OFFSET(0x10D33820)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARD_VIRUSTIMEOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x10D337D0)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessBoard_VirusTimeOut_TypeDefinitionIndex = 59239;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ChessBoard_VirusTimeOut_TypeDefinitionIndex)->GetStaticField(0x341C0);
		}
