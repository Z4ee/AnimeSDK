...
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEUPDATEAIMRECTBYCELL_INVOKE_OFFSET UNITYSDK_OFFSET(0x16D34160)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEUPDATEAIMRECTBYCELL_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x16D34270)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEUPDATEAIMRECTBYCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x16D342F0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEUPDATEAIMRECTBYCELL___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x16D34380)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int HackerGameUpdateAimRectByCell_TypeDefinitionIndex = 57871;
