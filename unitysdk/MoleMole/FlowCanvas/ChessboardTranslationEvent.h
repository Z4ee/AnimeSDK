...
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDTRANSLATIONEVENT_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x15402A90)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDTRANSLATIONEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x15402AF0)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessboardTranslationEvent_TypeDefinitionIndex = 42816;
