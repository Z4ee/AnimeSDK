...
#define MOLEMOLE_FLOWCANVAS_CHESSBOARD_VIRUSTODIE_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x15109470)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARD_VIRUSTODIE__CCTOR_OFFSET UNITYSDK_OFFSET(0x15109520)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARD_VIRUSTODIE__CTOR_OFFSET UNITYSDK_OFFSET(0x151094D0)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessBoard_VirusToDie_TypeDefinitionIndex = 41121;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ChessBoard_VirusToDie_TypeDefinitionIndex)->GetStaticField(0x40F00);
		}
