...
#define MOLEMOLE_FLOWCANVAS_CHESSBOARD_VIRUSTODIE_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x10B9AF40)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARD_VIRUSTODIE__CCTOR_OFFSET UNITYSDK_OFFSET(0x10B9AFF0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARD_VIRUSTODIE__CTOR_OFFSET UNITYSDK_OFFSET(0x10B9AFA0)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessBoard_VirusToDie_TypeDefinitionIndex = 55709;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ChessBoard_VirusToDie_TypeDefinitionIndex)->GetStaticField(0x3E940);
		}
