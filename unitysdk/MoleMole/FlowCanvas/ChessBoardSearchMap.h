...
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP_DOFILTER_OFFSET UNITYSDK_OFFSET(0x17E66C40)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP_DOSEARCH_OFFSET UNITYSDK_OFFSET(0x17E66A00)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP_FILTERDISTANCEINTERNAL_OFFSET UNITYSDK_OFFSET(0x17E67110)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP_FILTERINVALIDCHESSPIECE_OFFSET UNITYSDK_OFFSET(0x17E670C0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP_INDEXTOBOARDPOS_OFFSET UNITYSDK_OFFSET(0x17E67AB0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP_INVOKE_OFFSET UNITYSDK_OFFSET(0x17E668A0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP__CCTOR_OFFSET UNITYSDK_OFFSET(0x17E67BA0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x17E67B10)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP__DOSEARCH_G__SEARCHBYBOUND_6_1_OFFSET UNITYSDK_OFFSET(0x17E66FC0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP__DOSEARCH_G__SEARCHBYPOSITION_6_0_OFFSET UNITYSDK_OFFSET(0x17E66ED0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP__FILTERDISTANCEINTERNAL_G__CHECKCOLLISION_10_1_OFFSET UNITYSDK_OFFSET(0x17E676F0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP__FILTERDISTANCEINTERNAL_G__INDEXTOSAMPLEGRIDPOS_10_0_OFFSET UNITYSDK_OFFSET(0x17E676C0)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessBoardSearchMap_TypeDefinitionIndex = 85058;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(ChessBoardSearchMap_TypeDefinitionIndex)->GetStaticField(0x44CB0);
		}
