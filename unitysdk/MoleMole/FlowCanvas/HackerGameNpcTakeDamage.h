...
#define MOLEMOLE_FLOWCANVAS_HACKERGAMENPCTAKEDAMAGE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x170BE370)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMENPCTAKEDAMAGE_START_OFFSET UNITYSDK_OFFSET(0x170BE460)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMENPCTAKEDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x170BE640)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMENPCTAKEDAMAGE__REGISTERPORTS_B__0_0_OFFSET UNITYSDK_OFFSET(0x170BE680)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int HackerGameNpcTakeDamage_TypeDefinitionIndex = 50157;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::MoleMole::HackerGameDamageData>* damageData; // 0xB8
