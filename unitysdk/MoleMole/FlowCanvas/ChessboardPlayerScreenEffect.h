...
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECT_GETEFFECTCONFIG_OFFSET UNITYSDK_OFFSET(0x17E67FD0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECT_INVOKE_OFFSET UNITYSDK_OFFSET(0x17E67C50)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x17E682D0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECT_PROCESSSCREENEFFECT_OFFSET UNITYSDK_OFFSET(0x17E68070)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x17E68310)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECT___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x17E683A0)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessboardPlayerScreenEffect_TypeDefinitionIndex = 66702;
