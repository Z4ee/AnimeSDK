...
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECT_GETEFFECTCONFIG_OFFSET UNITYSDK_OFFSET(0x19BD88F0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECT_INVOKE_OFFSET UNITYSDK_OFFSET(0x19BD8470)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x19BD8BF0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECT_PROCESSSCREENEFFECT_OFFSET UNITYSDK_OFFSET(0x19BD8990)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19BD8C30)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECT___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x19BD8CC0)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessboardPlayerScreenEffect_TypeDefinitionIndex = 69691;
