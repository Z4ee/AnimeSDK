...
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSETFEVERWAVE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x149D41C0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSETFEVERWAVE_START_OFFSET UNITYSDK_OFFSET(0x149D4310)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSETFEVERWAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x149D4880)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSETFEVERWAVE__REGISTERPORTS_B__6_0_OFFSET UNITYSDK_OFFSET(0x149D48C0)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessboardSetFeverWave_TypeDefinitionIndex = 78216;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::System::Single>* targetValue; // 0xC0
