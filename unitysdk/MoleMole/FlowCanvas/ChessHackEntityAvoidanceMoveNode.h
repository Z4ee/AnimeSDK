...
#define MOLEMOLE_FLOWCANVAS_CHESSHACKENTITYAVOIDANCEMOVENODE_CHECKNEEDAVOIDANCE_OFFSET UNITYSDK_OFFSET(0x158071A0)
#define MOLEMOLE_FLOWCANVAS_CHESSHACKENTITYAVOIDANCEMOVENODE_HANDLEINAVOIDANCEMOVE_OFFSET UNITYSDK_OFFSET(0x158074C0)
#define MOLEMOLE_FLOWCANVAS_CHESSHACKENTITYAVOIDANCEMOVENODE_HANDLENORMALMOVE_OFFSET UNITYSDK_OFFSET(0x158076A0)
#define MOLEMOLE_FLOWCANVAS_CHESSHACKENTITYAVOIDANCEMOVENODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15807060)
#define MOLEMOLE_FLOWCANVAS_CHESSHACKENTITYAVOIDANCEMOVENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x15807930)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessHackEntityAvoidanceMoveNode_TypeDefinitionIndex = 68966;
