...
#define MOLEMOLE_FLOWCANVAS_SIMPLEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x18219800)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int SimpleItem_TypeDefinitionIndex = 72570;
