...
{
	inline static constexpr unsigned int ChessBoardChangePieceInfo_ServerInfo_TypeDefinitionIndex = 51743;
	...
	struct alignas(4) ChessBoardChangePieceInfo_ServerInfo
	{
		...
		::MoleMole::FlowCanvas::Optional_1<::Enum_3_4608E37A1B3D374A_4> GridType; // 0x34
