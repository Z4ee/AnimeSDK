...
#define MOLEMOLE_MONOTERRAINZONEVOXEL_VOXELDATA_GET_BASEMATTYPE_OFFSET UNITYSDK_OFFSET(0x13EA82A0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_VOXELDATA_GET_COVERMATTYPE_OFFSET UNITYSDK_OFFSET(0x13EA83C0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_VOXELDATA_METHOD_1_79830F666EE579C0_OFFSET UNITYSDK_OFFSET(0x13EA85F0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_VOXELDATA_METHOD_1_7DB49B5407C8FD68_OFFSET UNITYSDK_OFFSET(0x13EA8550)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_VOXELDATA_METHOD_1_85377D41FEE05B66_OFFSET UNITYSDK_OFFSET(0x13EA8730)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_VOXELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x13EA84F0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoTerrainZoneVoxel_VoxelData_TypeDefinitionIndex = 40075;
