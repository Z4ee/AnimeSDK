...
#define MOLEMOLE_MONOTERRAINZONEVOXEL_VOXELDATA_GET_BASEMATTYPE_OFFSET UNITYSDK_OFFSET(0x14A13970)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_VOXELDATA_GET_COVERMATTYPE_OFFSET UNITYSDK_OFFSET(0x14A13A90)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_VOXELDATA_METHOD_1_79830F666EE579C0_OFFSET UNITYSDK_OFFSET(0x14A13F30)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_VOXELDATA_METHOD_1_7DB49B5407C8FD68_OFFSET UNITYSDK_OFFSET(0x14A13E90)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_VOXELDATA_METHOD_1_85377D41FEE05B66_OFFSET UNITYSDK_OFFSET(0x14A13C20)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_VOXELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x14A13BC0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoTerrainZoneVoxel_VoxelData_TypeDefinitionIndex = 62030;
