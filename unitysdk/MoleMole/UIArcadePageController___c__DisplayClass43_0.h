...
#define MOLEMOLE_UIARCADEPAGECONTROLLER___C__DISPLAYCLASS43_0__CTOR_OFFSET UNITYSDK_OFFSET(0x164571B0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER___C__DISPLAYCLASS43_0__ENTERSPINNINGTABLEPHASEFROMENTRANCE_B__0_OFFSET UNITYSDK_OFFSET(0x16457270)
#define MOLEMOLE_UIARCADEPAGECONTROLLER___C__DISPLAYCLASS43_0__ENTERSPINNINGTABLEPHASEFROMENTRANCE_B__1_OFFSET UNITYSDK_OFFSET(0x164571C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadePageController___c__DisplayClass43_0_TypeDefinitionIndex = 75641;
