...
#define MOLEMOLE_LEVELPERFORM_DIRECTKILLSHAKESETTING_ASSIGN_OFFSET UNITYSDK_OFFSET(0x16D4F2C0)
#define MOLEMOLE_LEVELPERFORM_DIRECTKILLSHAKESETTING_GET_LOCATIONOFFSET_OFFSET UNITYSDK_OFFSET(0x16D4F220)
#define MOLEMOLE_LEVELPERFORM_DIRECTKILLSHAKESETTING_GET_ROTATIONOFFSET_OFFSET UNITYSDK_OFFSET(0x16D4F240)
#define MOLEMOLE_LEVELPERFORM_DIRECTKILLSHAKESETTING_HASVALIDDATA_OFFSET UNITYSDK_OFFSET(0x16D4F3A0)
#define MOLEMOLE_LEVELPERFORM_DIRECTKILLSHAKESETTING__CCTOR_OFFSET UNITYSDK_OFFSET(0x16D4F420)
#define MOLEMOLE_LEVELPERFORM_DIRECTKILLSHAKESETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x16D4F410)

namespace MoleMole::LevelPerform
{
	inline static constexpr unsigned int DirectKillShakeSetting_TypeDefinitionIndex = 44820;
	...
	public:
		...
		{
			return (::MoleMole::LevelPerform::DirectKillShakeSetting**)Il2CppClass::FromTypeDefinitionIndex(DirectKillShakeSetting_TypeDefinitionIndex)->GetStaticField(0x2E850);
		}
