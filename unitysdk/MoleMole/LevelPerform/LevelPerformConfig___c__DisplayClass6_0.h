...
#define MOLEMOLE_LEVELPERFORM_LEVELPERFORMCONFIG___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1582B400)
#define MOLEMOLE_LEVELPERFORM_LEVELPERFORMCONFIG___C__DISPLAYCLASS6_0__RELOADFROMFILEASYNC_B__0_OFFSET UNITYSDK_OFFSET(0x1582B410)

namespace MoleMole::LevelPerform
{
	inline static constexpr unsigned int LevelPerformConfig___c__DisplayClass6_0_TypeDefinitionIndex = 66242;
