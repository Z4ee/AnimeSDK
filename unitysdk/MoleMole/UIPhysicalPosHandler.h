...
#define MOLEMOLE_UIPHYSICALPOSHANDLER_APPLYLAYOUTRESULT_OFFSET UNITYSDK_OFFSET(0x14C722F0)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x14C6F340)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_CALCULATELAYOUT_OFFSET UNITYSDK_OFFSET(0x14C6F6B0)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_GETLAYOUTRESULT_1_OFFSET UNITYSDK_OFFSET(0x14C6FEA0)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_GETLAYOUTRESULT_OFFSET UNITYSDK_OFFSET(0x14C72720)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_GETPOSHANDLER_OFFSET UNITYSDK_OFFSET(0x14C6F090)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x14C6F580)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_1CCA9681CE0AE7A7_OFFSET UNITYSDK_OFFSET(0x14C72B60)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_3422201382CE593B_1_OFFSET UNITYSDK_OFFSET(0x14C6FDC0)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_3422201382CE593B_OFFSET UNITYSDK_OFFSET(0x14C6FCE0)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x14C72EB0)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_4B72F72501001F72_OFFSET UNITYSDK_OFFSET(0x14C72950)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_6426CAFBEED664F1_OFFSET UNITYSDK_OFFSET(0x14C6F880)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_7744894CEC41BF06_1_OFFSET UNITYSDK_OFFSET(0x14C73690)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0x14C6FAD0)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x14C73300)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x14C72F40)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_D3CDDBF95A81E584_1_OFFSET UNITYSDK_OFFSET(0x14C73160)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_D3CDDBF95A81E584_OFFSET UNITYSDK_OFFSET(0x14C72FB0)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_DBA008A0E0AB2ECC_OFFSET UNITYSDK_OFFSET(0x14C73310)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x14C73150)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_F4B69C1853FCB2B5_OFFSET UNITYSDK_OFFSET(0x14C727E0)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x14C6F4D0)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x14C6F410)
#define MOLEMOLE_UIPHYSICALPOSHANDLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x14C72C70)
#define MOLEMOLE_UIPHYSICALPOSHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14C72C10)
#define MOLEMOLE_UIPHYSICALPOSHANDLER___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x14C72D00)
#define MOLEMOLE_UIPHYSICALPOSHANDLER___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x14C72D90)
#define MOLEMOLE_UIPHYSICALPOSHANDLER___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x14C72E20)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhysicalPosHandler_TypeDefinitionIndex = 61589;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::MoleMole::UIPhysicalPosHandler*>**)Il2CppClass::FromTypeDefinitionIndex(UIPhysicalPosHandler_TypeDefinitionIndex)->GetStaticField(0x4B1F0);
		}
		static ::UnityEngine::Vector2* StaticGet_Field_6_13()
		{
			return (::UnityEngine::Vector2*)Il2CppClass::FromTypeDefinitionIndex(UIPhysicalPosHandler_TypeDefinitionIndex)->GetStaticField(0x11C70);
		}
		static ::System::Single* StaticGet_Field_6_14()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(UIPhysicalPosHandler_TypeDefinitionIndex)->GetStaticField(0x11C78);
		}
