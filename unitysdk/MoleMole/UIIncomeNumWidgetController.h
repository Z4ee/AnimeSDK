...
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER_BINDBUTTON_OFFSET UNITYSDK_OFFSET(0x181655D0)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER_BUILDDATABINDING_OFFSET UNITYSDK_OFFSET(0x18165B40)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER_BUILDVIEWMODELDATABINDING_OFFSET UNITYSDK_OFFSET(0x18165650)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER_CREATESUBWIDGET_OFFSET UNITYSDK_OFFSET(0x18165610)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x18165E60)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER_GET_NUM_OFFSET UNITYSDK_OFFSET(0x18166080)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x18165C70)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18165BE0)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x181659C0)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18165D30)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x181654A0)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER_PLAYNUMANIM_OFFSET UNITYSDK_OFFSET(0x181663F0)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER_PREPARENUMANIM_OFFSET UNITYSDK_OFFSET(0x18166760)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER_REFRESHNUMBER_OFFSET UNITYSDK_OFFSET(0x18165E20)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER_SET_EMPTY_OFFSET UNITYSDK_OFFSET(0x18165F50)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER_SET_NUM_OFFSET UNITYSDK_OFFSET(0x18166170)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER_SHOWSUBWIDGET_OFFSET UNITYSDK_OFFSET(0x18165B00)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x18165DB0)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER__BUILDVIEWMODELDATABINDING_B__17_0_OFFSET UNITYSDK_OFFSET(0x18166B20)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER__BUILDVIEWMODELDATABINDING_B__17_1_OFFSET UNITYSDK_OFFSET(0x18167160)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER__BUILDVIEWMODELDATABINDING_B__17_2_OFFSET UNITYSDK_OFFSET(0x18167400)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER__BUILDVIEWMODELDATABINDING_B__17_3_OFFSET UNITYSDK_OFFSET(0x18167640)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18166880)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER__PLAYNUMANIM_B__14_0_OFFSET UNITYSDK_OFFSET(0x181668E0)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER__PLAYNUMANIM_B__14_1_OFFSET UNITYSDK_OFFSET(0x18166A20)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x18167960)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x181679F0)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18167A80)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18167B20)
#define MOLEMOLE_UIINCOMENUMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18167BB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIIncomeNumWidgetController_TypeDefinitionIndex = 63991;
	...
	public:
		...
		::System::Boolean _numberDirty; // 0x2E8
