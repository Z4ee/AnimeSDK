...
#define MOLEMOLE_UIHANDBOOKHADALITEMWIDGETCONTROLLER___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1841AB70)
#define MOLEMOLE_UIHANDBOOKHADALITEMWIDGETCONTROLLER___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1841ABB0)
#define MOLEMOLE_UIHANDBOOKHADALITEMWIDGETCONTROLLER___C__REFRESHGAMEPADLIST_B__15_0_OFFSET UNITYSDK_OFFSET(0x1841ABC0)
#define MOLEMOLE_UIHANDBOOKHADALITEMWIDGETCONTROLLER___C__REFRESHGAMEPADLIST_B__15_1_OFFSET UNITYSDK_OFFSET(0x1841ABE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookHadalItemWidgetController___c_TypeDefinitionIndex = 49944;
	...
	public:
		...
		{
			return (::System::Func_2<::System::Collections::Generic::KeyValuePair_2<::UnityEngine::GameObject*, ::MoleMole::ScrollViewItemWidgetController*>, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(UIHandBookHadalItemWidgetController___c_TypeDefinitionIndex)->GetStaticField(0x4EB40);
		}
		static ::MoleMole::UIHandBookHadalItemWidgetController___c** StaticGet___9()
		{
			return (::MoleMole::UIHandBookHadalItemWidgetController___c**)Il2CppClass::FromTypeDefinitionIndex(UIHandBookHadalItemWidgetController___c_TypeDefinitionIndex)->GetStaticField(0x4EB48);
		}
		...
		{
			return (::System::Func_2<::System::Collections::Generic::KeyValuePair_2<::UnityEngine::GameObject*, ::MoleMole::ScrollViewItemWidgetController*>, ::UnityEngine::GameObject*>**)Il2CppClass::FromTypeDefinitionIndex(UIHandBookHadalItemWidgetController___c_TypeDefinitionIndex)->GetStaticField(0x4EB50);
		}
