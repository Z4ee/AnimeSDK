...
#define MOLEMOLE_UIBANGKOVBAGSUBPANELWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15AC40C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangkovBagSubPanelWidgetController_Context_TypeDefinitionIndex = 47413;

	class UIBangkovBagSubPanelWidgetController_Context : public ::MoleMole::UIControllerContextBase
	{
	public:
		::Class_0_16E4307DCC41950C_12<::System::Boolean>* IsInMultiSellMode; // 0x28
		::Class_0_16E4307DCC41950C_14<::MoleMole::UIBangkovBagPageController_LocalBangkovItemInfo>* SelectedItemList; // 0x30
		::Class_0_16E4307DCC41950C_12<::System::Int32>* SelectedItemSumValue; // 0x38
