...
#define MOLEMOLE_UIPRIVATEMESSAGEREPLYWIDGETCONTROLLER___C__DISPLAYCLASS24_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1988FC60)
#define MOLEMOLE_UIPRIVATEMESSAGEREPLYWIDGETCONTROLLER___C__DISPLAYCLASS24_0__UPDATEPERSONALMISSION_B__0_OFFSET UNITYSDK_OFFSET(0x1988FE40)
#define MOLEMOLE_UIPRIVATEMESSAGEREPLYWIDGETCONTROLLER___C__DISPLAYCLASS24_0__UPDATEPERSONALMISSION_B__1_OFFSET UNITYSDK_OFFSET(0x1988FC70)
#define MOLEMOLE_UIPRIVATEMESSAGEREPLYWIDGETCONTROLLER___C__DISPLAYCLASS24_0__UPDATEPERSONALMISSION_B__2_OFFSET UNITYSDK_OFFSET(0x1988FD20)
#define MOLEMOLE_UIPRIVATEMESSAGEREPLYWIDGETCONTROLLER___C__DISPLAYCLASS24_0__UPDATEPERSONALMISSION_B__3_OFFSET UNITYSDK_OFFSET(0x1988FED0)
#define MOLEMOLE_UIPRIVATEMESSAGEREPLYWIDGETCONTROLLER___C__DISPLAYCLASS24_0__UPDATEPERSONALMISSION_B__4_OFFSET UNITYSDK_OFFSET(0x19890130)
#define MOLEMOLE_UIPRIVATEMESSAGEREPLYWIDGETCONTROLLER___C__DISPLAYCLASS24_0__UPDATEPERSONALMISSION_B__5_OFFSET UNITYSDK_OFFSET(0x19890230)
#define MOLEMOLE_UIPRIVATEMESSAGEREPLYWIDGETCONTROLLER___C__DISPLAYCLASS24_0__UPDATEPERSONALMISSION_B__7_OFFSET UNITYSDK_OFFSET(0x19890390)

namespace MoleMole
{
	inline static constexpr unsigned int UIPrivateMessageReplyWidgetController___c__DisplayClass24_0_TypeDefinitionIndex = 56244;
	...
	public:
		...
		::Class_1_794BA983EDDBCFDE_Class_2_BD4CB46CB1BDBF16* singleMessage; // 0x40
		::System::Action* __9__4; // 0x48
