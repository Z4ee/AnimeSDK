...
#define MOLEMOLE_UIACTIVITYCAMERABOUNTYWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16320AE0)
#define MOLEMOLE_UIACTIVITYCAMERABOUNTYWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16320B70)
#define MOLEMOLE_UIACTIVITYCAMERABOUNTYWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16320990)
#define MOLEMOLE_UIACTIVITYCAMERABOUNTYWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16320A70)
#define MOLEMOLE_UIACTIVITYCAMERABOUNTYWIDGETCONTROLLER_SETBOUNTYSNAPSHOTDATA_OFFSET UNITYSDK_OFFSET(0x16320BF0)
#define MOLEMOLE_UIACTIVITYCAMERABOUNTYWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16321110)
#define MOLEMOLE_UIACTIVITYCAMERABOUNTYWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16321170)
#define MOLEMOLE_UIACTIVITYCAMERABOUNTYWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16321200)
#define MOLEMOLE_UIACTIVITYCAMERABOUNTYWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16321290)
#define MOLEMOLE_UIACTIVITYCAMERABOUNTYWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16321320)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityCameraBountyWidgetController_TypeDefinitionIndex = 40689;

	class UIActivityCameraBountyWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_1B5E8ECBDE012320* _view; // 0x2B8
		::MoleMole::UIPhotoTaskRowWidgetController* _singlePhotoTaskRow; // 0x2C0
