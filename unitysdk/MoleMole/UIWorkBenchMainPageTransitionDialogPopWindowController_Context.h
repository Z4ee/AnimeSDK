...
#define MOLEMOLE_UIWORKBENCHMAINPAGETRANSITIONDIALOGPOPWINDOWCONTROLLER_CONTEXT_GET_BGCOLOR_OFFSET UNITYSDK_OFFSET(0x1514AD50)
#define MOLEMOLE_UIWORKBENCHMAINPAGETRANSITIONDIALOGPOPWINDOWCONTROLLER_CONTEXT_GET_IMGANIMTIME_OFFSET UNITYSDK_OFFSET(0x1514AD70)
#define MOLEMOLE_UIWORKBENCHMAINPAGETRANSITIONDIALOGPOPWINDOWCONTROLLER_CONTEXT_SET_BGCOLOR_OFFSET UNITYSDK_OFFSET(0x1514AD60)
#define MOLEMOLE_UIWORKBENCHMAINPAGETRANSITIONDIALOGPOPWINDOWCONTROLLER_CONTEXT_SET_IMGANIMTIME_OFFSET UNITYSDK_OFFSET(0x1514AD80)
#define MOLEMOLE_UIWORKBENCHMAINPAGETRANSITIONDIALOGPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1514AD90)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkBenchMainPageTransitionDialogPopWindowController_Context_TypeDefinitionIndex = 88092;

	class UIWorkBenchMainPageTransitionDialogPopWindowController_Context : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::Single _imgAnimTime_k__BackingField; // 0x28
		::UnityEngine::Color _bgColor_k__BackingField; // 0x2C
