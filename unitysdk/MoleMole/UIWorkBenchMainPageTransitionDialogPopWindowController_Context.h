...
#define MOLEMOLE_UIWORKBENCHMAINPAGETRANSITIONDIALOGPOPWINDOWCONTROLLER_CONTEXT_GET_BGCOLOR_OFFSET UNITYSDK_OFFSET(0x11BE3900)
#define MOLEMOLE_UIWORKBENCHMAINPAGETRANSITIONDIALOGPOPWINDOWCONTROLLER_CONTEXT_GET_IMGANIMTIME_OFFSET UNITYSDK_OFFSET(0x11BE3920)
#define MOLEMOLE_UIWORKBENCHMAINPAGETRANSITIONDIALOGPOPWINDOWCONTROLLER_CONTEXT_SET_BGCOLOR_OFFSET UNITYSDK_OFFSET(0x11BE3910)
#define MOLEMOLE_UIWORKBENCHMAINPAGETRANSITIONDIALOGPOPWINDOWCONTROLLER_CONTEXT_SET_IMGANIMTIME_OFFSET UNITYSDK_OFFSET(0x11BE3930)
#define MOLEMOLE_UIWORKBENCHMAINPAGETRANSITIONDIALOGPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x11BE3940)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkBenchMainPageTransitionDialogPopWindowController_Context_TypeDefinitionIndex = 71666;
