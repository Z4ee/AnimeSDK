...
#define MOLEMOLE_UIHACKERDRONECHARGINGWIDGETCONTROLLER_CACHEFINISHPOINTS_OFFSET UNITYSDK_OFFSET(0x199CF950)
#define MOLEMOLE_UIHACKERDRONECHARGINGWIDGETCONTROLLER_GETCURRENTPROGRESS_OFFSET UNITYSDK_OFFSET(0x199D02B0)
#define MOLEMOLE_UIHACKERDRONECHARGINGWIDGETCONTROLLER_KILLINTROSEQUENCE_OFFSET UNITYSDK_OFFSET(0x199D1240)
#define MOLEMOLE_UIHACKERDRONECHARGINGWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x199D20C0)
#define MOLEMOLE_UIHACKERDRONECHARGINGWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x199D1100)
#define MOLEMOLE_UIHACKERDRONECHARGINGWIDGETCONTROLLER_ONFIGHTER_PROPERTYVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x199D18F0)
#define MOLEMOLE_UIHACKERDRONECHARGINGWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x199D1190)
#define MOLEMOLE_UIHACKERDRONECHARGINGWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x199CF480)
#define MOLEMOLE_UIHACKERDRONECHARGINGWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x199CF670)
#define MOLEMOLE_UIHACKERDRONECHARGINGWIDGETCONTROLLER_PLAYINTROSEQUENCE_OFFSET UNITYSDK_OFFSET(0x199D0C10)
#define MOLEMOLE_UIHACKERDRONECHARGINGWIDGETCONTROLLER_PLAYTRANSITIONTOCHARGING_OFFSET UNITYSDK_OFFSET(0x199D1A00)
#define MOLEMOLE_UIHACKERDRONECHARGINGWIDGETCONTROLLER_REFRESHPROGRESS_OFFSET UNITYSDK_OFFSET(0x199D04C0)
#define MOLEMOLE_UIHACKERDRONECHARGINGWIDGETCONTROLLER_REGISTERPROPERTYLISTENER_OFFSET UNITYSDK_OFFSET(0x199D00D0)
#define MOLEMOLE_UIHACKERDRONECHARGINGWIDGETCONTROLLER_RESETINTROSTATE_OFFSET UNITYSDK_OFFSET(0x199D1350)
#define MOLEMOLE_UIHACKERDRONECHARGINGWIDGETCONTROLLER_SETUPFOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x199CFC60)
#define MOLEMOLE_UIHACKERDRONECHARGINGWIDGETCONTROLLER_SETVISIBLE_OFFSET UNITYSDK_OFFSET(0x199D27D0)
#define MOLEMOLE_UIHACKERDRONECHARGINGWIDGETCONTROLLER_UNREGISTERPROPERTYLISTENER_OFFSET UNITYSDK_OFFSET(0x199D16B0)
#define MOLEMOLE_UIHACKERDRONECHARGINGWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x199D29E0)
#define MOLEMOLE_UIHACKERDRONECHARGINGWIDGETCONTROLLER__PLAYINTROSEQUENCE_B__33_0_OFFSET UNITYSDK_OFFSET(0x199D2A40)
#define MOLEMOLE_UIHACKERDRONECHARGINGWIDGETCONTROLLER__PLAYTRANSITIONTOCHARGING_B__34_0_OFFSET UNITYSDK_OFFSET(0x199D2A70)
#define MOLEMOLE_UIHACKERDRONECHARGINGWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x199D2AE0)
#define MOLEMOLE_UIHACKERDRONECHARGINGWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x199D2B70)
#define MOLEMOLE_UIHACKERDRONECHARGINGWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x199D2C00)
#define MOLEMOLE_UIHACKERDRONECHARGINGWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x199D2C90)

namespace MoleMole
{
	inline static constexpr unsigned int UIHackerDroneChargingWidgetController_TypeDefinitionIndex = 41674;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_11* _view; // 0x2C0
