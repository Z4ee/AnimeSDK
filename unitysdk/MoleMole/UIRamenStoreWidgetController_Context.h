...
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x14868C40)

namespace MoleMole
{
	inline static constexpr unsigned int UIRamenStoreWidgetController_Context_TypeDefinitionIndex = 46370;
