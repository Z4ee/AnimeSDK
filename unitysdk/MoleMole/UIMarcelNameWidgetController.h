...
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_BINDPLATFORMICONBTNLONGPRESS_OFFSET UNITYSDK_OFFSET(0x1714BE30)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_FIXPOSITION_OFFSET UNITYSDK_OFFSET(0x1714B8A0)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_HIDETEAMGOOD_OFFSET UNITYSDK_OFFSET(0x1714A110)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_INITIALIZEINFO_OFFSET UNITYSDK_OFFSET(0x1714A910)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1714BD20)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_ONTEAMMESSAGE_OFFSET UNITYSDK_OFFSET(0x1714B090)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1714BDB0)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1714A300)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_SETINFO_OFFSET UNITYSDK_OFFSET(0x1714AB00)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_SHOWNAME_OFFSET UNITYSDK_OFFSET(0x1714A090)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_UPDATEEMOJISCALE_OFFSET UNITYSDK_OFFSET(0x1714B590)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1714C0B0)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER__ONTEAMMESSAGE_G__HIDEEMOTIONICON_14_0_OFFSET UNITYSDK_OFFSET(0x1714C110)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1714C150)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1714C1E0)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1714C270)

namespace MoleMole
{
	inline static constexpr unsigned int UIMarcelNameWidgetController_TypeDefinitionIndex = 79090;

	class UIMarcelNameWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_94D5884806027679_5* _view; // 0x2C0
		::UnityEngine::RectTransform* _selfTransform; // 0x2C8
		::UnityEngine::RectTransform* _parentTransform; // 0x2D0
		::UnityEngine::Transform* _targetTransform; // 0x2D8
		::UnityEngine::Vector2 _lastPosition; // 0x2E0
		::MoleMole::UIMarcelNameWidgetController_Display _display; // 0x2E8
		::System::UInt32 _entityID; // 0x2EC
		::Class_1_BE6BF7909AD9D940* _info; // 0x2F0
		::Foundation::Coroutine::CoroutineHandle _emojiHandle; // 0x2F8
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_BINDPLATFORMICONBTNLONGPRESS_OFFSET))(this);
		}
