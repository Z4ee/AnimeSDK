...
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_BINDPLATFORMICONBTNLONGPRESS_OFFSET UNITYSDK_OFFSET(0x183B1720)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_FIXPOSITION_OFFSET UNITYSDK_OFFSET(0x183B1190)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_HIDETEAMGOOD_OFFSET UNITYSDK_OFFSET(0x183AFA10)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_INITIALIZEINFO_OFFSET UNITYSDK_OFFSET(0x183B0210)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x183B1610)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_ONTEAMMESSAGE_OFFSET UNITYSDK_OFFSET(0x183B0990)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x183B16A0)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x183AFC00)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_SETINFO_OFFSET UNITYSDK_OFFSET(0x183B0400)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_SHOWNAME_OFFSET UNITYSDK_OFFSET(0x183AF990)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_UPDATEEMOJISCALE_OFFSET UNITYSDK_OFFSET(0x183B0E90)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x183B19B0)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER__ONTEAMMESSAGE_G__HIDEEMOTIONICON_14_0_OFFSET UNITYSDK_OFFSET(0x183B1A10)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x183B1A50)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x183B1AE0)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x183B1B70)

namespace MoleMole
{
	inline static constexpr unsigned int UIMarcelNameWidgetController_TypeDefinitionIndex = 66791;
