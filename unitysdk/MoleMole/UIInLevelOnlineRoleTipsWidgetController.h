...
#define MOLEMOLE_UIINLEVELONLINEROLETIPSWIDGETCONTROLLER_CREATEITEMWIDGET_OFFSET UNITYSDK_OFFSET(0x1638EBE0)
#define MOLEMOLE_UIINLEVELONLINEROLETIPSWIDGETCONTROLLER_GET_ISDISAPPEAR_OFFSET UNITYSDK_OFFSET(0x1638E960)
#define MOLEMOLE_UIINLEVELONLINEROLETIPSWIDGETCONTROLLER_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0x1638E940)
#define MOLEMOLE_UIINLEVELONLINEROLETIPSWIDGETCONTROLLER_GET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x1638E980)
#define MOLEMOLE_UIINLEVELONLINEROLETIPSWIDGETCONTROLLER_GET_STATE_OFFSET UNITYSDK_OFFSET(0x1638E900)
#define MOLEMOLE_UIINLEVELONLINEROLETIPSWIDGETCONTROLLER_GET_TIMEUP_OFFSET UNITYSDK_OFFSET(0x1638E920)
#define MOLEMOLE_UIINLEVELONLINEROLETIPSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1638ED60)
#define MOLEMOLE_UIINLEVELONLINEROLETIPSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1638EDF0)
#define MOLEMOLE_UIINLEVELONLINEROLETIPSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1638E9A0)
#define MOLEMOLE_UIINLEVELONLINEROLETIPSWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1638EC80)
#define MOLEMOLE_UIINLEVELONLINEROLETIPSWIDGETCONTROLLER_PLAYFADEINANIM_OFFSET UNITYSDK_OFFSET(0x1638F400)
#define MOLEMOLE_UIINLEVELONLINEROLETIPSWIDGETCONTROLLER_PLAYFADEOUTANIM_OFFSET UNITYSDK_OFFSET(0x1638F690)
#define MOLEMOLE_UIINLEVELONLINEROLETIPSWIDGETCONTROLLER_PLAYWITHCALLBACK_OFFSET UNITYSDK_OFFSET(0x1638F1C0)
#define MOLEMOLE_UIINLEVELONLINEROLETIPSWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1638EE80)
#define MOLEMOLE_UIINLEVELONLINEROLETIPSWIDGETCONTROLLER_SET_ISDISAPPEAR_OFFSET UNITYSDK_OFFSET(0x1638E970)
#define MOLEMOLE_UIINLEVELONLINEROLETIPSWIDGETCONTROLLER_SET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0x1638E950)
#define MOLEMOLE_UIINLEVELONLINEROLETIPSWIDGETCONTROLLER_SET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x1638E990)
#define MOLEMOLE_UIINLEVELONLINEROLETIPSWIDGETCONTROLLER_SET_STATE_OFFSET UNITYSDK_OFFSET(0x1638E910)
#define MOLEMOLE_UIINLEVELONLINEROLETIPSWIDGETCONTROLLER_SKIPFADEOUTANIMTOHIDE_OFFSET UNITYSDK_OFFSET(0x1638F5B0)
#define MOLEMOLE_UIINLEVELONLINEROLETIPSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1638F8A0)
#define MOLEMOLE_UIINLEVELONLINEROLETIPSWIDGETCONTROLLER__PLAYFADEOUTANIM_B__36_0_OFFSET UNITYSDK_OFFSET(0x1638F900)
#define MOLEMOLE_UIINLEVELONLINEROLETIPSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1638F950)
#define MOLEMOLE_UIINLEVELONLINEROLETIPSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1638F9E0)
#define MOLEMOLE_UIINLEVELONLINEROLETIPSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1638FA70)
#define MOLEMOLE_UIINLEVELONLINEROLETIPSWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1638FB00)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelOnlineRoleTipsWidgetController_TypeDefinitionIndex = 42268;

	class UIInLevelOnlineRoleTipsWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::MoleMole::UIInLevelOnlineRoleTipsWidgetController_EState _State_k__BackingField; // 0x2B8
		...
		::System::Boolean _IsPlaying_k__BackingField; // 0x2E0
		::System::Boolean _IsDisappear_k__BackingField; // 0x2E1
		::Class_2_0471CF632A9E483C* _view; // 0x2E8
		::MoleMole::UIOnlinePlayerItemWidgetController* _itemWidget; // 0x2F0
		::System::String* _curAnimName; // 0x2F8
		::System::Boolean _NeedCache_k__BackingField; // 0x300
