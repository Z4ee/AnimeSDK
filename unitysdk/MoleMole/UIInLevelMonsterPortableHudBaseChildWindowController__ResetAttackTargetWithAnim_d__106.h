...
#define MOLEMOLE_UIINLEVELMONSTERPORTABLEHUDBASECHILDWINDOWCONTROLLER__RESETATTACKTARGETWITHANIM_D__106_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x84DA90)
#define MOLEMOLE_UIINLEVELMONSTERPORTABLEHUDBASECHILDWINDOWCONTROLLER__RESETATTACKTARGETWITHANIM_D__106_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x6CB1D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelMonsterPortableHudBaseChildWindowController__ResetAttackTargetWithAnim_d__106_TypeDefinitionIndex = 72801;
