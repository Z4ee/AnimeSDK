...
#define MOLEMOLE_UISETTINGRESOURCEMANAGEPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16760A40)

namespace MoleMole
{
	inline static constexpr unsigned int UISettingResourceManagePageContext_TypeDefinitionIndex = 55220;
