...
#define MOLEMOLE_CHECKAVATARENTERBATTLESTATE_GETCURRENTENTERBATTLESTATE_OFFSET UNITYSDK_OFFSET(0xDB8AFF0)
#define MOLEMOLE_CHECKAVATARENTERBATTLESTATE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xDB8AEC0)
#define MOLEMOLE_CHECKAVATARENTERBATTLESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xDB8B040)
#define MOLEMOLE_CHECKAVATARENTERBATTLESTATE___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xDB8B0D0)

namespace MoleMole
{
	inline static constexpr unsigned int CheckAvatarEnterBattleState_TypeDefinitionIndex = 50235;
