...
#define MOLEMOLE_COMMANDLINESHADINGQUALITY_METHOD_2_01E1005A437FAB49_OFFSET UNITYSDK_OFFSET(0x106B8E30)
#define MOLEMOLE_COMMANDLINESHADINGQUALITY_METHOD_2_9A4A515103E89443_OFFSET UNITYSDK_OFFSET(0x106B8F40)
#define MOLEMOLE_COMMANDLINESHADINGQUALITY__CTOR_OFFSET UNITYSDK_OFFSET(0x106B8F00)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineShadingQuality_TypeDefinitionIndex = 59143;
