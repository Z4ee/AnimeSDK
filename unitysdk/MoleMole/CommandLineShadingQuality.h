...
#define MOLEMOLE_COMMANDLINESHADINGQUALITY_METHOD_2_01E1005A437FAB49_OFFSET UNITYSDK_OFFSET(0x1A49A0E0)
#define MOLEMOLE_COMMANDLINESHADINGQUALITY_METHOD_2_9A4A515103E89443_OFFSET UNITYSDK_OFFSET(0x1A49A1F0)
#define MOLEMOLE_COMMANDLINESHADINGQUALITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A49A1B0)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineShadingQuality_TypeDefinitionIndex = 48271;
