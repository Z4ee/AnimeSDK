...
#define MOLEMOLE_DATASTRUCTURES_COMMON_OPTIONALINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1F9BDCA0)

namespace MoleMole::DataStructures::Common
{
	inline static constexpr unsigned int OptionalInt_TypeDefinitionIndex = 28796;
