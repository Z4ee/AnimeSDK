...
#define MOLEMOLE_DATASTRUCTURES_COMMON_OPTIONALCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5B2360)

namespace MoleMole::DataStructures::Common
{
	inline static constexpr unsigned int OptionalColor_TypeDefinitionIndex = 28186;
