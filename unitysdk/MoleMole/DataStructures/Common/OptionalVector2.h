...
#define MOLEMOLE_DATASTRUCTURES_COMMON_OPTIONALVECTOR2__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5B23F0)

namespace MoleMole::DataStructures::Common
{
	inline static constexpr unsigned int OptionalVector2_TypeDefinitionIndex = 28136;
