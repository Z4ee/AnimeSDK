...
#include "unitysdk/MoleMole/UIComposeItemPopWindowController___c__DisplayClass32_0.h"
...
class Class_1_2CB55B0619EAEE37;
...
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_CLEARITEMDATA_OFFSET UNITYSDK_OFFSET(0x1854E800)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_GETITEMDATA_OFFSET UNITYSDK_OFFSET(0x18548A00)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_GETRECYCLEMAXCOUNT_OFFSET UNITYSDK_OFFSET(0x1854D0F0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_GETSELECTITEMDATA_OFFSET UNITYSDK_OFFSET(0x1854E2B0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_GETVIEWLIST_OFFSET UNITYSDK_OFFSET(0x1854A6D0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_GETWIDGET_OFFSET UNITYSDK_OFFSET(0x1854D7B0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x18546D30)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_HANDLECONSUMESHOW_OFFSET UNITYSDK_OFFSET(0x18549F60)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_INITSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x18547310)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x18547530)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_ONCLICKCONFIRM_OFFSET UNITYSDK_OFFSET(0x1854DAA0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_ONCLICKCONSUMEICONBTN_OFFSET UNITYSDK_OFFSET(0x1854E3E0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_ONCLICKITEMINFOBTN_OFFSET UNITYSDK_OFFSET(0x1854E480)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x1854B910)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0x18549150)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18549050)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18548D10)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_ONSORTORFILTERCHANGED_OFFSET UNITYSDK_OFFSET(0x1854E9B0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x185490E0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18546D40)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18547990)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_REFRESHITEM_OFFSET UNITYSDK_OFFSET(0x1854E790)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_RESELECTITEM_OFFSET UNITYSDK_OFFSET(0x18549680)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_SELECTITEM_OFFSET UNITYSDK_OFFSET(0x18548C10)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_SENDDATA_OFFSET UNITYSDK_OFFSET(0x1854E530)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_SETCONFIRMBTNINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x1854D060)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_SETCOUNT_OFFSET UNITYSDK_OFFSET(0x1854CF20)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_SETCURTAB_OFFSET UNITYSDK_OFFSET(0x185491B0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_SETLIMITTEXT_OFFSET UNITYSDK_OFFSET(0x1854CF80)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_SHOWCOMPOSEITEM_OFFSET UNITYSDK_OFFSET(0x1854BA90)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_SHOWDECOMPOSEITEM_OFFSET UNITYSDK_OFFSET(0x1854C0D0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_SHOWEMPTYITEM_OFFSET UNITYSDK_OFFSET(0x1854CB90)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_SHOWPRICE_OFFSET UNITYSDK_OFFSET(0x1854D240)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_SHOWRECYCLEITEM_OFFSET UNITYSDK_OFFSET(0x1854C710)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_SHOWSUBITEMS_OFFSET UNITYSDK_OFFSET(0x1854D400)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_UPDATECOMPOSEITEMLIST_OFFSET UNITYSDK_OFFSET(0x1854AD90)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_UPDATECURRENCY_OFFSET UNITYSDK_OFFSET(0x1854CC20)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_UPDATEDECOMPOSEITEMLIST_OFFSET UNITYSDK_OFFSET(0x1854B130)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_UPDATEITEMLIST_OFFSET UNITYSDK_OFFSET(0x1854A150)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_UPDATERECYCLEITEMLIST_OFFSET UNITYSDK_OFFSET(0x1854B4D0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1854EA30)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER__INITSCROLLVIEW_B__26_0_OFFSET UNITYSDK_OFFSET(0x1854EBC0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER__SELECTITEM_G__DOSELECTITEM_32_0_OFFSET UNITYSDK_OFFSET(0x1854ABD0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1854EC80)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1854ED10)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1854ED20)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1854ED30)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1854ED40)

namespace MoleMole
{
	inline static constexpr unsigned int UIComposeItemPopWindowController_TypeDefinitionIndex = 41282;
	...
	public:
		...
		::Class_2_60638234271CCDB8_10* _view; // 0x320
		...
		::Class_1_2CB55B0619EAEE37* _itemInfoShow; // 0x338
		...
		::Class_2_9B614D02A0AA9182<::Class_1_0D6706375CDAAE8C*>* _sorter; // 0x388
		...
		::System::Void _SelectItem_g__DoSelectItem_32_0(::System::Int32 tmpIndex, ::MoleMole::UIComposeItemPopWindowController___c__DisplayClass32_0& a2)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::MoleMole::UIComposeItemPopWindowController___c__DisplayClass32_0&))((::PBYTE)hIl2Cpp + MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER__SELECTITEM_G__DOSELECTITEM_32_0_OFFSET))(this, tmpIndex, a2);
		}
