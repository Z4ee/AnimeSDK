...
#define MOLEMOLE_UITWEENSLOTWIDGETCONTROLLER_CANCELTWEEN_OFFSET UNITYSDK_OFFSET(0x152DDF80)
#define MOLEMOLE_UITWEENSLOTWIDGETCONTROLLER_GET_NEEDPLAYINSERT_OFFSET UNITYSDK_OFFSET(0x152DDBF0)
#define MOLEMOLE_UITWEENSLOTWIDGETCONTROLLER_GET_NEEDPLAYREMOVE_OFFSET UNITYSDK_OFFSET(0x152DDC50)
#define MOLEMOLE_UITWEENSLOTWIDGETCONTROLLER_ONSETROOTCONTROLLER_OFFSET UNITYSDK_OFFSET(0x152DDCB0)
#define MOLEMOLE_UITWEENSLOTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x152DE050)
#define MOLEMOLE_UITWEENSLOTWIDGETCONTROLLER_PLAYINSERT_OFFSET UNITYSDK_OFFSET(0x152DDEC0)
#define MOLEMOLE_UITWEENSLOTWIDGETCONTROLLER_PLAYREMOVE_OFFSET UNITYSDK_OFFSET(0x152DDF20)
#define MOLEMOLE_UITWEENSLOTWIDGETCONTROLLER_SETTWEENDURATION_OFFSET UNITYSDK_OFFSET(0x152DDFE0)
#define MOLEMOLE_UITWEENSLOTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x152DE0C0)
#define MOLEMOLE_UITWEENSLOTWIDGETCONTROLLER___BASE_ONSETROOTCONTROLLER_OFFSET UNITYSDK_OFFSET(0x152DE1B0)
#define MOLEMOLE_UITWEENSLOTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x152DE120)

namespace MoleMole
{
	inline static constexpr unsigned int UITweenSlotWidgetController_TypeDefinitionIndex = 49580;
