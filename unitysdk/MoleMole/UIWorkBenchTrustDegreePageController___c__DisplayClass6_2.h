...
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER___C__DISPLAYCLASS6_2__CTOR_OFFSET UNITYSDK_OFFSET(0x12C9BAD0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER___C__DISPLAYCLASS6_2__ONUIOPEN_B__4_OFFSET UNITYSDK_OFFSET(0x12C9BAE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkBenchTrustDegreePageController___c__DisplayClass6_2_TypeDefinitionIndex = 50974;
