...
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_CALAVATARLEFTEXP_OFFSET UNITYSDK_OFFSET(0x1520D090)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_CALCURITEMMAX_OFFSET UNITYSDK_OFFSET(0x1520EF10)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_CLEARMATERIAL_OFFSET UNITYSDK_OFFSET(0x1520CE60)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_GETALLSELECTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1520C450)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_GETHASSELECTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1520BF10)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_GETSELECTLEVELUPMATERIALEXCEPTI_OFFSET UNITYSDK_OFFSET(0x1520C080)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x1520AB00)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_ONAVATARLEVELUPRSP_OFFSET UNITYSDK_OFFSET(0x1520B710)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_ONAVATARLEVELUP_OFFSET UNITYSDK_OFFSET(0x1520C760)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_ONBEFOREWORLDUPDATE_OFFSET UNITYSDK_OFFSET(0x1520FB20)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_ONCLICKBTN1_OFFSET UNITYSDK_OFFSET(0x1520BA20)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_ONCLICKBTN2_OFFSET UNITYSDK_OFFSET(0x1520C310)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x1520F580)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x15210430)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_ONMATITEMCHANGED_OFFSET UNITYSDK_OFFSET(0x15210EF0)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1520B030)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1520F1A0)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1520B550)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_REFRESHLEVELUPINPUTKEY_OFFSET UNITYSDK_OFFSET(0x1520F6A0)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1520B2E0)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_SETCONSUME_OFFSET UNITYSDK_OFFSET(0x1520DCF0)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_SETPARENTVIEW_OFFSET UNITYSDK_OFFSET(0x1520A840)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_SETPROGRESS_OFFSET UNITYSDK_OFFSET(0x1520DC00)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_SHOWBACKITEMLISTDIALOG_OFFSET UNITYSDK_OFFSET(0x1520B870)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_TRIGGERGAMEPADADDBTN_OFFSET UNITYSDK_OFFSET(0x1520FBD0)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_TRIGGERGAMEPADREDUCEBTN_OFFSET UNITYSDK_OFFSET(0x15210000)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_UPDATEAVATAR_OFFSET UNITYSDK_OFFSET(0x1520D140)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_UPDATEBUDDY_OFFSET UNITYSDK_OFFSET(0x1520E6D0)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15211660)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER__ONAVATARLEVELUP_B__32_1_OFFSET UNITYSDK_OFFSET(0x15211A20)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER__ONAVATARLEVELUP_B__32_2_OFFSET UNITYSDK_OFFSET(0x15211A40)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER__ONAVATARLEVELUP_B__32_3_OFFSET UNITYSDK_OFFSET(0x15211B60)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER__ONUIOPEN_B__24_0_OFFSET UNITYSDK_OFFSET(0x152118E0)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x15211C20)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x15211CD0)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15211D00)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15211DA0)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15211E30)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleLevelupController_TypeDefinitionIndex = 46206;

	class UIRoleLevelupController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_11* _view; // 0x2B8
		::Class_2_1824EF69C8E376A3* _avatarData; // 0x2C0
		::Class_2_4DA7BFFCF976F7D7* _battleBuddyData; // 0x2C8
		::System::Collections::Generic::List_1<::MoleMole::UIItemIconBtnWidgetController*>* _expMatItems; // 0x2D0
		::Class_2_9D9172C07F82DDAE* _itemModel; // 0x2D8
		::Class_2_07A2E3D9266E9604* _roleDataProxy; // 0x2E0
		::Class_2_702D914FA95B6E36* _roleModel; // 0x2E8
		::MoleMole::UIRoleDevelopPopWindowController* _mainController; // 0x2F0
		::System::Collections::Generic::List_1<::Class_1_C5FDB00B12827EE9*>* _curPropertyItemViews; // 0x2F8
		::System::Boolean needNotifyParent; // 0x300
		::UnityEngine::Material* _percentMaterial; // 0x308
		::MoleMole::MonoGamepadCustomList* _monoGamepadCustomList; // 0x310
		::System::Int32 _gamepadAddSelectIndex; // 0x318
		::System::Int32 _gamepadReduceSelectIndex; // 0x31C
		::System::Boolean _isGamepadAddBtnPressed; // 0x320
		::System::Boolean _isGamepadReduceBtnPressed; // 0x321
		::System::Int32 curLeftExp; // 0x324
		::System::Collections::Generic::List_1<::Class_1_0D6706375CDAAE8C*>* backItemList; // 0x328
		::System::Int32 _nowLv; // 0x330
		::System::Int32 roleToMaxLvNeedExp; // 0x334
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Int32>* _popertyValueCache; // 0x338
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* hasMaterialDir; // 0x340
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* suggestMaterialDir; // 0x348
