...
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_CALAVATARLEFTEXP_OFFSET UNITYSDK_OFFSET(0x122858F0)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_CALCURITEMMAX_OFFSET UNITYSDK_OFFSET(0x12287790)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_CLEARMATERIAL_OFFSET UNITYSDK_OFFSET(0x122856C0)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_GETALLSELECTMATERIAL_OFFSET UNITYSDK_OFFSET(0x12284CB0)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_GETHASSELECTMATERIAL_OFFSET UNITYSDK_OFFSET(0x12284770)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_GETSELECTLEVELUPMATERIALEXCEPTI_OFFSET UNITYSDK_OFFSET(0x122848E0)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x12283340)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_ONAVATARLEVELUPRSP_OFFSET UNITYSDK_OFFSET(0x12283F70)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_ONAVATARLEVELUP_OFFSET UNITYSDK_OFFSET(0x12284FC0)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_ONBEFOREWORLDUPDATE_OFFSET UNITYSDK_OFFSET(0x122883A0)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_ONCLICKBTN1_OFFSET UNITYSDK_OFFSET(0x12284280)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_ONCLICKBTN2_OFFSET UNITYSDK_OFFSET(0x12284B70)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x12287E00)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x12288CB0)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_ONMATITEMCHANGED_OFFSET UNITYSDK_OFFSET(0x12289770)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x12283870)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12287A20)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12283DA0)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_REFRESHLEVELUPINPUTKEY_OFFSET UNITYSDK_OFFSET(0x12287F20)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x12283B30)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_SETCONSUME_OFFSET UNITYSDK_OFFSET(0x12286560)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_SETPARENTVIEW_OFFSET UNITYSDK_OFFSET(0x12283080)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_SETPROGRESS_OFFSET UNITYSDK_OFFSET(0x12286470)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_SHOWBACKITEMLISTDIALOG_OFFSET UNITYSDK_OFFSET(0x122840D0)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_TRIGGERGAMEPADADDBTN_OFFSET UNITYSDK_OFFSET(0x12288450)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_TRIGGERGAMEPADREDUCEBTN_OFFSET UNITYSDK_OFFSET(0x12288880)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_UPDATEAVATAR_OFFSET UNITYSDK_OFFSET(0x122859A0)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER_UPDATEBUDDY_OFFSET UNITYSDK_OFFSET(0x12286F40)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12289F30)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER__ONAVATARLEVELUP_B__32_1_OFFSET UNITYSDK_OFFSET(0x1228A2F0)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER__ONAVATARLEVELUP_B__32_2_OFFSET UNITYSDK_OFFSET(0x1228A310)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER__ONAVATARLEVELUP_B__32_3_OFFSET UNITYSDK_OFFSET(0x1228A430)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER__ONUIOPEN_B__24_0_OFFSET UNITYSDK_OFFSET(0x1228A1B0)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x1228A4F0)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1228A5A0)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1228A5D0)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1228A670)
#define MOLEMOLE_UIROLELEVELUPCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1228A700)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleLevelupController_TypeDefinitionIndex = 86811;

	class UIRoleLevelupController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_48* _view; // 0x2C0
		::Class_2_1824EF69C8E376A3* _avatarData; // 0x2C8
		::Class_2_6DA22669E4D1C4BF* _battleBuddyData; // 0x2D0
		::System::Collections::Generic::List_1<::MoleMole::UIItemIconBtnWidgetController*>* _expMatItems; // 0x2D8
		::Class_2_03F4D9B3111E6159* _itemModel; // 0x2E0
