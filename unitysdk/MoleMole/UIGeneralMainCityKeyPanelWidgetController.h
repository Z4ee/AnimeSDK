...
#define MOLEMOLE_UIGENERALMAINCITYKEYPANELWIDGETCONTROLLER_GET_CONSOLECAMERABTN_OFFSET UNITYSDK_OFFSET(0x15248440)
#define MOLEMOLE_UIGENERALMAINCITYKEYPANELWIDGETCONTROLLER_GET_CONSOLESTORYBTN_OFFSET UNITYSDK_OFFSET(0x15248480)
#define MOLEMOLE_UIGENERALMAINCITYKEYPANELWIDGETCONTROLLER_GET_PCSTORYBTN_OFFSET UNITYSDK_OFFSET(0x15248460)
#define MOLEMOLE_UIGENERALMAINCITYKEYPANELWIDGETCONTROLLER_GET_ROULETTEBTN_OFFSET UNITYSDK_OFFSET(0x152484A0)
#define MOLEMOLE_UIGENERALMAINCITYKEYPANELWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x152486B0)
#define MOLEMOLE_UIGENERALMAINCITYKEYPANELWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15248740)
#define MOLEMOLE_UIGENERALMAINCITYKEYPANELWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x152484C0)
#define MOLEMOLE_UIGENERALMAINCITYKEYPANELWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15248640)
#define MOLEMOLE_UIGENERALMAINCITYKEYPANELWIDGETCONTROLLER_SET_CONSOLECAMERABTN_OFFSET UNITYSDK_OFFSET(0x15248450)
#define MOLEMOLE_UIGENERALMAINCITYKEYPANELWIDGETCONTROLLER_SET_CONSOLESTORYBTN_OFFSET UNITYSDK_OFFSET(0x15248490)
#define MOLEMOLE_UIGENERALMAINCITYKEYPANELWIDGETCONTROLLER_SET_PCSTORYBTN_OFFSET UNITYSDK_OFFSET(0x15248470)
#define MOLEMOLE_UIGENERALMAINCITYKEYPANELWIDGETCONTROLLER_SET_ROULETTEBTN_OFFSET UNITYSDK_OFFSET(0x152484B0)
#define MOLEMOLE_UIGENERALMAINCITYKEYPANELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x152487C0)
#define MOLEMOLE_UIGENERALMAINCITYKEYPANELWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15248820)
#define MOLEMOLE_UIGENERALMAINCITYKEYPANELWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x152488B0)
#define MOLEMOLE_UIGENERALMAINCITYKEYPANELWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15248940)
#define MOLEMOLE_UIGENERALMAINCITYKEYPANELWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x152489D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralMainCityKeyPanelWidgetController_TypeDefinitionIndex = 78889;

	class UIGeneralMainCityKeyPanelWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_33C955BE8D3515AB* _view; // 0x2B8
		::MoleMole::UIConsoleCameraBtnWidgetController* _ConsoleCameraBtn_k__BackingField; // 0x2C0
		::MoleMole::UIGeneralConsoleBtnWidgetController* _PCStoryBtn_k__BackingField; // 0x2C8
		::MoleMole::UIGeneralConsoleBtnWidgetController* _ConsoleStoryBtn_k__BackingField; // 0x2D0
		::Class_2_B4378B46E0020E85* _RouletteBtn_k__BackingField; // 0x2D8
