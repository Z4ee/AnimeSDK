...
#define MOLEMOLE_HACKERGAMEBASEDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x149EDD20)

namespace MoleMole
{
	inline static constexpr unsigned int HackerGameBaseDamage_TypeDefinitionIndex = 52181;
