...
#define MOLEMOLE_UIACTIVITYVIDEODETAILPOPWINDOWCONTROLLER___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A625260)
#define MOLEMOLE_UIACTIVITYVIDEODETAILPOPWINDOWCONTROLLER___C__DISPLAYCLASS8_0__PLAYVIDEOFROMSTART_B__1_OFFSET UNITYSDK_OFFSET(0x1A6253C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityVideoDetailPopWindowController___c__DisplayClass8_0_TypeDefinitionIndex = 57037;

	class UIActivityVideoDetailPopWindowController___c__DisplayClass8_0 : public ::System::Object
	{
	public:
		::System::String* videoPath; // 0x10
		::MoleMole::UIActivityVideoDetailPopWindowController* __4__this; // 0x18
