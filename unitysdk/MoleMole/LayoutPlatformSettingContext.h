...
#define MOLEMOLE_LAYOUTPLATFORMSETTINGCONTEXT_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0x1908BF20)
#define MOLEMOLE_LAYOUTPLATFORMSETTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1908C4D0)
#define MOLEMOLE_LAYOUTPLATFORMSETTINGCONTEXT___BASE_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0x1908C4F0)

namespace MoleMole
{
	inline static constexpr unsigned int LayoutPlatformSettingContext_TypeDefinitionIndex = 75444;
