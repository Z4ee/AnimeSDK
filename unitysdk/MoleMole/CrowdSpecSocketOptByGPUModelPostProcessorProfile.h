...
#define MOLEMOLE_CROWDSPECSOCKETOPTBYGPUMODELPOSTPROCESSORPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x115F81A0)
#define MOLEMOLE_CROWDSPECSOCKETOPTBYGPUMODELPOSTPROCESSORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x115F8210)
#define MOLEMOLE_CROWDSPECSOCKETOPTBYGPUMODELPOSTPROCESSORPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x115F82A0)

namespace MoleMole
{
	inline static constexpr unsigned int CrowdSpecSocketOptByGPUModelPostProcessorProfile_TypeDefinitionIndex = 59747;
