...
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLER_APPLYITEMREF2BASECTRLER_OFFSET UNITYSDK_OFFSET(0x17D94FA0)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17D94EA0)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17D94F30)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17D94DF0)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17D94E50)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17D956A0)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17D95790)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17D95820)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17D95830)
#define MOLEMOLE_UIGACHASTAGEWEAPON3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17D958C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaStageWeapon3DModelController_TypeDefinitionIndex = 50847;

	class UIGachaStageWeapon3DModelController : public ::MoleMole::UIGachaStageWeapon3DModelControllerBase
	{
	public:
		::Class_2_60638234271CCDB8_56* _view; // 0x798
