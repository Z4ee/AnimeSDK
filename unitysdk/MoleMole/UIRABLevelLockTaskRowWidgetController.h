...
#define MOLEMOLE_UIRABLEVELLOCKTASKROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1845C990)
#define MOLEMOLE_UIRABLEVELLOCKTASKROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1845CA00)
#define MOLEMOLE_UIRABLEVELLOCKTASKROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1845CAA0)
#define MOLEMOLE_UIRABLEVELLOCKTASKROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1845CC60)
#define MOLEMOLE_UIRABLEVELLOCKTASKROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1845CCC0)
#define MOLEMOLE_UIRABLEVELLOCKTASKROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1845CD60)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABLevelLockTaskRowWidgetController_TypeDefinitionIndex = 70301;
