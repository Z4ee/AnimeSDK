...
#define MOLEMOLE_NAPHASRECEIVEDEVENT_ONBEHAVIORCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1264DAA0)
#define MOLEMOLE_NAPHASRECEIVEDEVENT_ONEND_OFFSET UNITYSDK_OFFSET(0x1264D170)
#define MOLEMOLE_NAPHASRECEIVEDEVENT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1264DDF0)
#define MOLEMOLE_NAPHASRECEIVEDEVENT_ONSTART_OFFSET UNITYSDK_OFFSET(0x1264CBE0)
#define MOLEMOLE_NAPHASRECEIVEDEVENT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1264D010)
#define MOLEMOLE_NAPHASRECEIVEDEVENT_RECEIVEDEVENT_1_OFFSET UNITYSDK_OFFSET(0x1264D530)
#define MOLEMOLE_NAPHASRECEIVEDEVENT_RECEIVEDEVENT_2_OFFSET UNITYSDK_OFFSET(0x1264D670)
#define MOLEMOLE_NAPHASRECEIVEDEVENT_RECEIVEDEVENT_3_OFFSET UNITYSDK_OFFSET(0x1264D840)
#define MOLEMOLE_NAPHASRECEIVEDEVENT_RECEIVEDEVENT_OFFSET UNITYSDK_OFFSET(0x1264D4D0)
#define MOLEMOLE_NAPHASRECEIVEDEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1264DE80)
#define MOLEMOLE_NAPHASRECEIVEDEVENT___BASE_ONBEHAVIORCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1264DF50)
#define MOLEMOLE_NAPHASRECEIVEDEVENT___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1264DFE0)
#define MOLEMOLE_NAPHASRECEIVEDEVENT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1264E070)
#define MOLEMOLE_NAPHASRECEIVEDEVENT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1264E100)
#define MOLEMOLE_NAPHASRECEIVEDEVENT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1264E190)

namespace MoleMole
{
	inline static constexpr unsigned int NapHasReceivedEvent_TypeDefinitionIndex = 83534;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedVariable* storedValue3; // 0x68
		::MoleMole::Battle::Entity* ownerEntity; // 0x70
		::BehaviorDesigner::Runtime::SharedFloat* KeepTime; // 0x78
		::BehaviorDesigner::Runtime::SharedString* eventName; // 0x80
		::System::Boolean eventReceived; // 0x88
		::System::Boolean registered; // 0x89
