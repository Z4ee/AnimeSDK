...
#define MOLEMOLE_MONOCANVASGROUPALPHAMODIFIERFORPARTICLESYSTEM_METHOD_5_8DC652D916C182B2_OFFSET UNITYSDK_OFFSET(0x1513B410)
#define MOLEMOLE_MONOCANVASGROUPALPHAMODIFIERFORPARTICLESYSTEM_METHOD_5_8E3C32E62F530E35_OFFSET UNITYSDK_OFFSET(0x1513C0E0)
#define MOLEMOLE_MONOCANVASGROUPALPHAMODIFIERFORPARTICLESYSTEM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1513B3C0)
#define MOLEMOLE_MONOCANVASGROUPALPHAMODIFIERFORPARTICLESYSTEM_RESET_OFFSET UNITYSDK_OFFSET(0x1513B110)
#define MOLEMOLE_MONOCANVASGROUPALPHAMODIFIERFORPARTICLESYSTEM_SETPARTICLESYSTEMALPHA_OFFSET UNITYSDK_OFFSET(0x1513B720)
#define MOLEMOLE_MONOCANVASGROUPALPHAMODIFIERFORPARTICLESYSTEM_UPDATE_OFFSET UNITYSDK_OFFSET(0x1513B6D0)
#define MOLEMOLE_MONOCANVASGROUPALPHAMODIFIERFORPARTICLESYSTEM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1513C0A0)
#define MOLEMOLE_MONOCANVASGROUPALPHAMODIFIERFORPARTICLESYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1513C040)

namespace MoleMole
{
	inline static constexpr unsigned int MonoCanvasGroupAlphaModifierForParticleSystem_TypeDefinitionIndex = 58212;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoCanvasGroupAlphaModifierForParticleSystem_TypeDefinitionIndex)->GetStaticField(0xF970);
		}
