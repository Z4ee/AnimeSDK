...
#define MOLEMOLE_UISURVEYPOINTSCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1379D870)

namespace MoleMole
{
	inline static constexpr unsigned int UISurveyPointsContext_TypeDefinitionIndex = 67237;
