...
#define MOLEMOLE_SHADINGQUALITYPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1809EF00)

namespace MoleMole
{
	inline static constexpr unsigned int ShadingQualityProfileContext_TypeDefinitionIndex = 47112;
