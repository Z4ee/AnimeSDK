...
#define MOLEMOLE_UIRANKROLECARDROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16A84410)
#define MOLEMOLE_UIRANKROLECARDROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x16A84520)
#define MOLEMOLE_UIRANKROLECARDROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16A845D0)
#define MOLEMOLE_UIRANKROLECARDROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16A844A0)
#define MOLEMOLE_UIRANKROLECARDROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16A841F0)
#define MOLEMOLE_UIRANKROLECARDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16A84D20)
#define MOLEMOLE_UIRANKROLECARDROWWIDGETCONTROLLER__ONUIINIT_B__3_0_OFFSET UNITYSDK_OFFSET(0x16A84D30)
#define MOLEMOLE_UIRANKROLECARDROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16A84E20)
#define MOLEMOLE_UIRANKROLECARDROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x16A84EB0)
#define MOLEMOLE_UIRANKROLECARDROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16A84F40)
#define MOLEMOLE_UIRANKROLECARDROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16A84FE0)
#define MOLEMOLE_UIRANKROLECARDROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16A85070)

namespace MoleMole
{
	inline static constexpr unsigned int UIRankRoleCardRowWidgetController_TypeDefinitionIndex = 89763;

	class UIRankRoleCardRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_242* _view; // 0x2F0
