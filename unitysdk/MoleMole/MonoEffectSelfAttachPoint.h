...
#define MOLEMOLE_MONOEFFECTSELFATTACHPOINT_SETATTACHPOINT_OFFSET UNITYSDK_OFFSET(0x17DD2540)
#define MOLEMOLE_MONOEFFECTSELFATTACHPOINT_TRYGETATTACHPOINT_OFFSET UNITYSDK_OFFSET(0x17DD2420)
#define MOLEMOLE_MONOEFFECTSELFATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x17DD2790)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectSelfAttachPoint_TypeDefinitionIndex = 84743;
