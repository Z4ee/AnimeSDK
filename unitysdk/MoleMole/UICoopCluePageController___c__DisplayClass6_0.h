...
#define MOLEMOLE_UICOOPCLUEPAGECONTROLLER___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16CA6A20)
#define MOLEMOLE_UICOOPCLUEPAGECONTROLLER___C__DISPLAYCLASS6_0__REGISTEREVENT_B__0_OFFSET UNITYSDK_OFFSET(0x16CA6A30)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopCluePageController___c__DisplayClass6_0_TypeDefinitionIndex = 47966;
