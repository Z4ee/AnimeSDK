...
#define MOLEMOLE_UIMINIUIGAME3DCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x174DFF00)

namespace MoleMole
{
	inline static constexpr unsigned int UIMiniUIGame3DContext_TypeDefinitionIndex = 60482;
