...
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS17_1__ADDREPLYTOBOTTOM_B__0_OFFSET UNITYSDK_OFFSET(0x14FFF720)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS17_1__ADDREPLYTOBOTTOM_B__1_OFFSET UNITYSDK_OFFSET(0x14FFF7B0)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS17_1__ADDREPLYTOBOTTOM_B__2_OFFSET UNITYSDK_OFFSET(0x14FFFBA0)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS17_1__CTOR_OFFSET UNITYSDK_OFFSET(0x14FFF710)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotPostDialogPopWindowController___c__DisplayClass17_1_TypeDefinitionIndex = 59039;
