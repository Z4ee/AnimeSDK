...
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS17_1__ADDREPLYTOBOTTOM_B__0_OFFSET UNITYSDK_OFFSET(0x184B6980)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS17_1__ADDREPLYTOBOTTOM_B__1_OFFSET UNITYSDK_OFFSET(0x184B6A10)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS17_1__ADDREPLYTOBOTTOM_B__2_OFFSET UNITYSDK_OFFSET(0x184B6E00)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS17_1__CTOR_OFFSET UNITYSDK_OFFSET(0x184B6970)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotPostDialogPopWindowController___c__DisplayClass17_1_TypeDefinitionIndex = 85434;
