...
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_CLOSEOVERHANDLE_OFFSET UNITYSDK_OFFSET(0x1B250180)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_GETDEFAULTSELECT_OFFSET UNITYSDK_OFFSET(0x1B24F2C0)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_GETHASDIFFICUTYUNLOCK_OFFSET UNITYSDK_OFFSET(0x1B24E9E0)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_GETTEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x1B24DDB0)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_GOTOPLAY_OFFSET UNITYSDK_OFFSET(0x1B250600)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_LOADBACKGROUND_OFFSET UNITYSDK_OFFSET(0x1B24E0A0)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_ONBACKCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x1B24F580)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_ONCLICKDIFFICUTYBTN_OFFSET UNITYSDK_OFFSET(0x1B24FAE0)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_ONCLICKNORMALBTN_OFFSET UNITYSDK_OFFSET(0x1B2500E0)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1B24ECB0)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_ONMAINCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x1B250230)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_ONQUESTROWSELECTHANDLE_OFFSET UNITYSDK_OFFSET(0x1B250560)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_ONTOGGLEHANDLE_OFFSET UNITYSDK_OFFSET(0x1B24FD50)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1B250860)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1B24D590)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1B24DE00)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_OPENHISTORYVIEW_OFFSET UNITYSDK_OFFSET(0x1B250300)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_RECORDTABCLICK_OFFSET UNITYSDK_OFFSET(0x1B24FB80)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_RECORDTABSHOW_OFFSET UNITYSDK_OFFSET(0x1B24ED40)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1B24E440)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_SETBACKGROUND_OFFSET UNITYSDK_OFFSET(0x1B24F020)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_SETISREAD_OFFSET UNITYSDK_OFFSET(0x1B24F630)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_SETQUESTROWLIST_OFFSET UNITYSDK_OFFSET(0x1B24F1D0)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_SETTOGGLEANISTATE_OFFSET UNITYSDK_OFFSET(0x1B24EF10)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER__CREATEDIFFICUTYROW_OFFSET UNITYSDK_OFFSET(0x1B24DD00)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER__CREATEROW_OFFSET UNITYSDK_OFFSET(0x1B24DC50)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2508E0)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1B250940)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1B2509D0)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1B250A60)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1B250AF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityGameplayWidgetController_TypeDefinitionIndex = 90139;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_446*>* _showQuestList; // 0x2D8
		::Class_2_208CC9941471731A_446* selectHollowEntranceCfg; // 0x2E0
