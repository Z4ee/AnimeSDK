...
#define MOLEMOLE_UIADAPTORPARAMS_UIADAPTORPARAMS_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x16453770)
#define MOLEMOLE_UIADAPTORPARAMS_UIADAPTORPARAMS_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x16453780)
#define MOLEMOLE_UIADAPTORPARAMS_UIADAPTORPARAMS_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x16453A20)
#define MOLEMOLE_UIADAPTORPARAMS_UIADAPTORPARAMS_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x16453C10)
#define MOLEMOLE_UIADAPTORPARAMS_UIADAPTORPARAMS_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x16453BD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAdaptorParams_UIAdaptorParams_UnityGeneratedFormatter_TypeDefinitionIndex = 47254;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::UIAdataporRectTransform*>**)Il2CppClass::FromTypeDefinitionIndex(UIAdaptorParams_UIAdaptorParams_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x437E0);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Boolean>** StaticGet_CachedSerializer1()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(UIAdaptorParams_UIAdaptorParams_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x437E8);
		}
