...
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1A6411A0)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER_ONCLICKCONSOLEBLACKLISTTAB_OFFSET UNITYSDK_OFFSET(0x1A642420)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER_ONCLICKINGAMEBLACKLISTTAB_OFFSET UNITYSDK_OFFSET(0x1A642470)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1A641A30)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER_ONRECEIVEBLACKLIST_OFFSET UNITYSDK_OFFSET(0x1A641B30)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER_ONREMOVEFROMBLACKLIST_OFFSET UNITYSDK_OFFSET(0x1A642070)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1A641AC0)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1A6411B0)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1A6419C0)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER_PLATFORM_ONRECEIVEBLACKLIST_OFFSET UNITYSDK_OFFSET(0x1A642190)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER_SHOWEMPTYCONTENT_OFFSET UNITYSDK_OFFSET(0x1A641DA0)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A642520)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER__ONUIINIT_B__4_0_OFFSET UNITYSDK_OFFSET(0x1A642590)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER__ONUIINIT_B__4_1_OFFSET UNITYSDK_OFFSET(0x1A6425F0)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER__ONUIINIT_B__4_2_OFFSET UNITYSDK_OFFSET(0x1A642650)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER__ONUIINIT_B__4_3_OFFSET UNITYSDK_OFFSET(0x1A642660)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1A6426B0)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1A642740)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1A642750)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1A642760)

namespace MoleMole
{
	inline static constexpr unsigned int UIBlackListPopWindowController_TypeDefinitionIndex = 60930;
