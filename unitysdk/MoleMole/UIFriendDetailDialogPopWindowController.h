...
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x16A8DBB0)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER_INITPLATFORM_OFFSET UNITYSDK_OFFSET(0x16A8E4D0)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16A8EA30)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x16A8DF70)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16A8E990)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER_ONSWITCHPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0x16A8DE00)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16A8DBC0)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16A8E010)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER_SHOWUIVIEW_OFFSET UNITYSDK_OFFSET(0x16A8EAC0)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER_SWITCHPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0x16A8DF00)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16A8EB50)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER__INITPLATFORM_B__12_0_OFFSET UNITYSDK_OFFSET(0x16A8EB60)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER__INITPLATFORM_B__12_1_OFFSET UNITYSDK_OFFSET(0x16A8EBC0)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16A8EC20)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x16A8ECB0)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x16A8ED40)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16A8ED50)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16A8ED60)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendDetailDialogPopWindowController_TypeDefinitionIndex = 75180;
