...
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER_COLLECTMIDDLETEXTS_OFFSET UNITYSDK_OFFSET(0x167A9A50)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER_GET_ISIGNOREINPUT_OFFSET UNITYSDK_OFFSET(0x167A9860)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER_GET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x167A9870)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x167A9850)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x167A9D10)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x167AABF0)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x167A9DA0)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x167A9890)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0x167AA880)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER_SET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x167A9880)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER_SHOWDIALOG_OFFSET UNITYSDK_OFFSET(0x167A9E10)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER_SHOWLEFTROOTITEM_OFFSET UNITYSDK_OFFSET(0x167AAAB0)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x167AAD00)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER__SHOWDIALOG_B__26_0_OFFSET UNITYSDK_OFFSET(0x167AAD90)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER__SHOWDIALOG_B__26_1_OFFSET UNITYSDK_OFFSET(0x167AAE20)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER__SHOWDIALOG_B__26_2_OFFSET UNITYSDK_OFFSET(0x167AAEB0)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER__SHOWDIALOG_B__26_3_OFFSET UNITYSDK_OFFSET(0x167AAF40)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x167AAFD0)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x167AB060)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x167AB070)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralSubtitle05EDPopWindowController_TypeDefinitionIndex = 58937;
	...
	public:
		...
		::System::Boolean _IsIgnoreInput_k__BackingField; // 0x310
		::Class_2_C282B8DEFC72AD58* _view; // 0x318
		::System::Boolean _NeedCache_k__BackingField; // 0x320
		::System::Collections::Generic::List_1<::UnityEngine::UI::Extension::UILocalizationText*>* leftTexts; // 0x328
		::Foundation::Coroutine::CoroutineHandle leftFadeOutHandle; // 0x330
		::Foundation::Coroutine::CoroutineHandle middleFadeOutHandle; // 0x334
		::Foundation::Coroutine::CoroutineHandle bottomFadeOutHandle; // 0x338
		::Foundation::Coroutine::CoroutineHandle upFadeOutHandle; // 0x33C
		::System::Boolean showBottom; // 0x340
		::System::Boolean showLeft; // 0x341
		::System::Boolean showMiddle; // 0x342
		::System::Boolean showTop; // 0x343
		::PopEffect* _topTextEffect; // 0x348
