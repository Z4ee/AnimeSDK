...
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER_COLLECTMIDDLETEXTS_OFFSET UNITYSDK_OFFSET(0x19EF0FC0)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER_GET_ISIGNOREINPUT_OFFSET UNITYSDK_OFFSET(0x19EF0DD0)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER_GET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x19EF0DE0)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x19EF0DC0)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19EF1280)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19EF2010)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19EF1310)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19EF0E00)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0x19EF1CA0)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER_SET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x19EF0DF0)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER_SHOWDIALOG_OFFSET UNITYSDK_OFFSET(0x19EF1380)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER_SHOWLEFTROOTITEM_OFFSET UNITYSDK_OFFSET(0x19EF1EE0)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19EF2120)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER__SHOWDIALOG_B__26_0_OFFSET UNITYSDK_OFFSET(0x19EF21B0)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER__SHOWDIALOG_B__26_1_OFFSET UNITYSDK_OFFSET(0x19EF2240)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER__SHOWDIALOG_B__26_2_OFFSET UNITYSDK_OFFSET(0x19EF22D0)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER__SHOWDIALOG_B__26_3_OFFSET UNITYSDK_OFFSET(0x19EF2360)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19EF23F0)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19EF2480)
#define MOLEMOLE_UIGENERALSUBTITLE05EDPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19EF2490)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralSubtitle05EDPopWindowController_TypeDefinitionIndex = 63487;
