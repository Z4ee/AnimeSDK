...
#define MOLEMOLE_MONOANIMATIONPLUGINBASE_METHOD_5_8652DE0774915A40_OFFSET UNITYSDK_OFFSET(0x10D62480)
#define MOLEMOLE_MONOANIMATIONPLUGINBASE_METHOD_5_A47A1AF85D5655BE_OFFSET UNITYSDK_OFFSET(0x10D622C0)
#define MOLEMOLE_MONOANIMATIONPLUGINBASE_METHOD_5_F6C10DB4374245F7_OFFSET UNITYSDK_OFFSET(0x10D622B0)
#define MOLEMOLE_MONOANIMATIONPLUGINBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x10D62260)

namespace MoleMole
{
	inline static constexpr unsigned int MonoAnimationPluginBase_TypeDefinitionIndex = 45667;
