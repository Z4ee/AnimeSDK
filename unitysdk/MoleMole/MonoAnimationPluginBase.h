...
#define MOLEMOLE_MONOANIMATIONPLUGINBASE_METHOD_5_8652DE0774915A40_OFFSET UNITYSDK_OFFSET(0x16E6DAE0)
#define MOLEMOLE_MONOANIMATIONPLUGINBASE_METHOD_5_A47A1AF85D5655BE_OFFSET UNITYSDK_OFFSET(0x16E6DB00)
#define MOLEMOLE_MONOANIMATIONPLUGINBASE_METHOD_5_F6C10DB4374245F7_OFFSET UNITYSDK_OFFSET(0x16E6DAF0)
#define MOLEMOLE_MONOANIMATIONPLUGINBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x16E6DA90)

namespace MoleMole
{
	inline static constexpr unsigned int MonoAnimationPluginBase_TypeDefinitionIndex = 42393;
