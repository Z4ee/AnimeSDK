...
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_GETADAPTASPECTOFFSET_OFFSET UNITYSDK_OFFSET(0x170E1B10)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_1D4018D4200358D0_1_OFFSET UNITYSDK_OFFSET(0x170E2E20)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_1D4018D4200358D0_2_OFFSET UNITYSDK_OFFSET(0x170E2EF0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_1D4018D4200358D0_3_OFFSET UNITYSDK_OFFSET(0x170E2F50)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x170E2DC0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_24902946B5E8137E_OFFSET UNITYSDK_OFFSET(0x170E2960)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_250144EB25DB3FF3_OFFSET UNITYSDK_OFFSET(0x170E25F0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_7E8E3AC25D35AA00_OFFSET UNITYSDK_OFFSET(0x170E2AD0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_A3FAE12D7B6ACD62_1_OFFSET UNITYSDK_OFFSET(0x170E3380)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0x170E32F0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_BEA3E455B88CC3AF_OFFSET UNITYSDK_OFFSET(0x170E1DD0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_C7C1E2C7C26CB01E_OFFSET UNITYSDK_OFFSET(0x170E2FB0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_D0CD9A971CA3B1CF_OFFSET UNITYSDK_OFFSET(0x170E2E80)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA__CCTOR_OFFSET UNITYSDK_OFFSET(0x170E2AC0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x170E2A70)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginAttachToCamera_TypeDefinitionIndex = 80253;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(MonoEffectPluginAttachToCamera_TypeDefinitionIndex)->GetStaticField(0x11B40);
		}
