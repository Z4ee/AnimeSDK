...
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_GETADAPTASPECTOFFSET_OFFSET UNITYSDK_OFFSET(0x19DD1FE0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_1D4018D4200358D0_1_OFFSET UNITYSDK_OFFSET(0x19DD3100)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_1D4018D4200358D0_2_OFFSET UNITYSDK_OFFSET(0x19DD3820)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_1D4018D4200358D0_3_OFFSET UNITYSDK_OFFSET(0x19DD30A0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x19DD2FB0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_24902946B5E8137E_OFFSET UNITYSDK_OFFSET(0x19DD2E40)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_250144EB25DB3FF3_OFFSET UNITYSDK_OFFSET(0x19DD2AD0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_7E8E3AC25D35AA00_OFFSET UNITYSDK_OFFSET(0x19DD31F0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_A3FAE12D7B6ACD62_1_OFFSET UNITYSDK_OFFSET(0x19DD3160)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0x19DD3010)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_BEA3E455B88CC3AF_OFFSET UNITYSDK_OFFSET(0x19DD22A0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_C7C1E2C7C26CB01E_OFFSET UNITYSDK_OFFSET(0x19DD34E0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_D0CD9A971CA3B1CF_OFFSET UNITYSDK_OFFSET(0x19DD3880)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA__CCTOR_OFFSET UNITYSDK_OFFSET(0x19DD2FA0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x19DD2F50)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginAttachToCamera_TypeDefinitionIndex = 56268;

	class MonoEffectPluginAttachToCamera : public ::MoleMole::MonoEffectPluginBase
	{
	public:
		static ::System::Single* StaticGet_Field_6_18()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(MonoEffectPluginAttachToCamera_TypeDefinitionIndex)->GetStaticField(0x11A20);
		}
