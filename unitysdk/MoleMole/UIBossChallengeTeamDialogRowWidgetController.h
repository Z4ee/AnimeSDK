...
#define MOLEMOLE_UIBOSSCHALLENGETEAMDIALOGROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A642800)
#define MOLEMOLE_UIBOSSCHALLENGETEAMDIALOGROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A642870)
#define MOLEMOLE_UIBOSSCHALLENGETEAMDIALOGROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1A642C30)
#define MOLEMOLE_UIBOSSCHALLENGETEAMDIALOGROWWIDGETCONTROLLER_SETBRIGHT_OFFSET UNITYSDK_OFFSET(0x1A642AB0)
#define MOLEMOLE_UIBOSSCHALLENGETEAMDIALOGROWWIDGETCONTROLLER_SETTEAMINFO_OFFSET UNITYSDK_OFFSET(0x1A642930)
#define MOLEMOLE_UIBOSSCHALLENGETEAMDIALOGROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A642CA0)
#define MOLEMOLE_UIBOSSCHALLENGETEAMDIALOGROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A642D00)
#define MOLEMOLE_UIBOSSCHALLENGETEAMDIALOGROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1A642DA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBossChallengeTeamDialogRowWidgetController_TypeDefinitionIndex = 80808;
	...
	public:
		...
		::System::Void SetTeamInfo(::Class_3_F118437738B4CCD5_2* teamInfo)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_F118437738B4CCD5_2*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBOSSCHALLENGETEAMDIALOGROWWIDGETCONTROLLER_SETTEAMINFO_OFFSET))(this, teamInfo);
		}
