...
#define MOLEMOLE_SKILLBUTTONCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x12B18540)
#define MOLEMOLE_SKILLBUTTONCONTROLLER_ONBUTTONDISABLED_OFFSET UNITYSDK_OFFSET(0x12B18CA0)
#define MOLEMOLE_SKILLBUTTONCONTROLLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0x12B189D0)
#define MOLEMOLE_SKILLBUTTONCONTROLLER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x12B18AA0)
#define MOLEMOLE_SKILLBUTTONCONTROLLER_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x12B18800)
#define MOLEMOLE_SKILLBUTTONCONTROLLER_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x12B188B0)
#define MOLEMOLE_SKILLBUTTONCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x12B18B50)
#define MOLEMOLE_SKILLBUTTONCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12B18D30)

namespace MoleMole
{
	inline static constexpr unsigned int SkillButtonController_TypeDefinitionIndex = 60742;
