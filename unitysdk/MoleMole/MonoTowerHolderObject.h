...
#define MOLEMOLE_MONOTOWERHOLDEROBJECT_GETALL_OFFSET UNITYSDK_OFFSET(0x16CDD2B0)
#define MOLEMOLE_MONOTOWERHOLDEROBJECT_HASTAG_OFFSET UNITYSDK_OFFSET(0x16CDD490)
#define MOLEMOLE_MONOTOWERHOLDEROBJECT_ISALLOWED_OFFSET UNITYSDK_OFFSET(0x16CDD3F0)
#define MOLEMOLE_MONOTOWERHOLDEROBJECT_METHOD_7_BB5BE9EEA0111E72_OFFSET UNITYSDK_OFFSET(0x16CDD6C0)
#define MOLEMOLE_MONOTOWERHOLDEROBJECT_POPTAG_OFFSET UNITYSDK_OFFSET(0x16CDD570)
#define MOLEMOLE_MONOTOWERHOLDEROBJECT_PUSHTAG_OFFSET UNITYSDK_OFFSET(0x16CDD4F0)
#define MOLEMOLE_MONOTOWERHOLDEROBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16CDD5D0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoTowerHolderObject_TypeDefinitionIndex = 56459;
