...
#define MOLEMOLE_UILEVELRESULTV2_PAGECONTROLLER___C__DISPLAYCLASS54_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17AE0C30)
#define MOLEMOLE_UILEVELRESULTV2_PAGECONTROLLER___C__DISPLAYCLASS54_0___BINDBTNCALLBACK_B__0_OFFSET UNITYSDK_OFFSET(0x17AE0C40)
#define MOLEMOLE_UILEVELRESULTV2_PAGECONTROLLER___C__DISPLAYCLASS54_0___BINDBTNCALLBACK_B__1_OFFSET UNITYSDK_OFFSET(0x17AE0E80)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultV2_PageController___c__DisplayClass54_0_TypeDefinitionIndex = 81821;
