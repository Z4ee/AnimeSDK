...
#define MOLEMOLE_UILEVELRESULTV2_PAGECONTROLLER___C__DISPLAYCLASS54_0__CTOR_OFFSET UNITYSDK_OFFSET(0x148CF870)
#define MOLEMOLE_UILEVELRESULTV2_PAGECONTROLLER___C__DISPLAYCLASS54_0___BINDBTNCALLBACK_B__0_OFFSET UNITYSDK_OFFSET(0x148CF880)
#define MOLEMOLE_UILEVELRESULTV2_PAGECONTROLLER___C__DISPLAYCLASS54_0___BINDBTNCALLBACK_B__1_OFFSET UNITYSDK_OFFSET(0x148CFAC0)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultV2_PageController___c__DisplayClass54_0_TypeDefinitionIndex = 58841;
	...
	public:
		...
		::Class_1_451601B8BB62C38C_Enum_3_3DCE6AAF7E47B319 btnTag; // 0x28
