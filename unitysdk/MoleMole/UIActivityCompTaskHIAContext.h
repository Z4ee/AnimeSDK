...
#define MOLEMOLE_UIACTIVITYCOMPTASKHIACONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15887980)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityCompTaskHIAContext_TypeDefinitionIndex = 63908;
