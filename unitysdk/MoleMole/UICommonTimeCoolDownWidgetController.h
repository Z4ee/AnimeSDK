...
#define MOLEMOLE_UICOMMONTIMECOOLDOWNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19DA3D50)
#define MOLEMOLE_UICOMMONTIMECOOLDOWNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19DA3DE0)
#define MOLEMOLE_UICOMMONTIMECOOLDOWNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19DA3C80)
#define MOLEMOLE_UICOMMONTIMECOOLDOWNWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19DA3CE0)
#define MOLEMOLE_UICOMMONTIMECOOLDOWNWIDGETCONTROLLER_SETTIME_OFFSET UNITYSDK_OFFSET(0x19DA3E60)
#define MOLEMOLE_UICOMMONTIMECOOLDOWNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19DA40B0)
#define MOLEMOLE_UICOMMONTIMECOOLDOWNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19DA4110)
#define MOLEMOLE_UICOMMONTIMECOOLDOWNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19DA41A0)
#define MOLEMOLE_UICOMMONTIMECOOLDOWNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19DA4230)
#define MOLEMOLE_UICOMMONTIMECOOLDOWNWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19DA42C0)

namespace MoleMole
{
	inline static constexpr unsigned int UICommonTimeCoolDownWidgetController_TypeDefinitionIndex = 50464;

	class UICommonTimeCoolDownWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_0096754AC2F6E253_20* _view; // 0x2C0
