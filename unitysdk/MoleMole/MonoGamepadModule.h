...
#define MOLEMOLE_MONOGAMEPADMODULE_AWAKE_OFFSET UNITYSDK_OFFSET(0x129B9C60)
#define MOLEMOLE_MONOGAMEPADMODULE_CANNAVIGATETO_OFFSET UNITYSDK_OFFSET(0x129BC4F0)
#define MOLEMOLE_MONOGAMEPADMODULE_CLEARCONTROLLER_OFFSET UNITYSDK_OFFSET(0x129BA760)
#define MOLEMOLE_MONOGAMEPADMODULE_CLEARFOCUSRECORDSTATE_OFFSET UNITYSDK_OFFSET(0x129BA960)
#define MOLEMOLE_MONOGAMEPADMODULE_CLEARMANAGEDOBJECTS_OFFSET UNITYSDK_OFFSET(0x129BD220)
#define MOLEMOLE_MONOGAMEPADMODULE_DOCOPYRESET_OFFSET UNITYSDK_OFFSET(0x129BD270)
#define MOLEMOLE_MONOGAMEPADMODULE_GET_CONTROLLER_OFFSET UNITYSDK_OFFSET(0x129B9A10)
#define MOLEMOLE_MONOGAMEPADMODULE_GET_FOCUSONENABLE_OFFSET UNITYSDK_OFFSET(0x129B9820)
#define MOLEMOLE_MONOGAMEPADMODULE_GET_FOCUSRECORDSTATE_OFFSET UNITYSDK_OFFSET(0x129B97B0)
#define MOLEMOLE_MONOGAMEPADMODULE_GET_FOCUSSTATE_OFFSET UNITYSDK_OFFSET(0x129B97C0)
#define MOLEMOLE_MONOGAMEPADMODULE_GET_FORCEIGNOREBENAVIGATED_OFFSET UNITYSDK_OFFSET(0x129B9A60)
#define MOLEMOLE_MONOGAMEPADMODULE_GET_HINTKEYS_OFFSET UNITYSDK_OFFSET(0x129B98B0)
#define MOLEMOLE_MONOGAMEPADMODULE_GET_INPUTHANDLEORDER_OFFSET UNITYSDK_OFFSET(0x129B9880)
#define MOLEMOLE_MONOGAMEPADMODULE_GET_ISCLEAR_OFFSET UNITYSDK_OFFSET(0x129B9A40)
#define MOLEMOLE_MONOGAMEPADMODULE_GET_ISCOLLECTED_OFFSET UNITYSDK_OFFSET(0x129B99F0)
#define MOLEMOLE_MONOGAMEPADMODULE_GET_ISFOCUSED_OFFSET UNITYSDK_OFFSET(0x129B97D0)
#define MOLEMOLE_MONOGAMEPADMODULE_GET_ISREGISTERED_OFFSET UNITYSDK_OFFSET(0x129B98C0)
#define MOLEMOLE_MONOGAMEPADMODULE_GET_MODULENAME_OFFSET UNITYSDK_OFFSET(0x129B9840)
#define MOLEMOLE_MONOGAMEPADMODULE_GET_PARENTMODULE_OFFSET UNITYSDK_OFFSET(0x129B9A20)
#define MOLEMOLE_MONOGAMEPADMODULE_GET_PRIORITYLEVEL_OFFSET UNITYSDK_OFFSET(0x129B9860)
#define MOLEMOLE_MONOGAMEPADMODULE_GET_PRIORITYSORTINDEX_OFFSET UNITYSDK_OFFSET(0x129B9890)
#define MOLEMOLE_MONOGAMEPADMODULE_HANDLEINPUTACTION_OFFSET UNITYSDK_OFFSET(0x129BC6E0)
#define MOLEMOLE_MONOGAMEPADMODULE_ISFUNCTIONENABLED_OFFSET UNITYSDK_OFFSET(0x129BC690)
#define MOLEMOLE_MONOGAMEPADMODULE_ISTEMPWORKABLE_OFFSET UNITYSDK_OFFSET(0x129B9C20)
#define MOLEMOLE_MONOGAMEPADMODULE_ISWORKABLE_OFFSET UNITYSDK_OFFSET(0x129B9A80)
#define MOLEMOLE_MONOGAMEPADMODULE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x129BA440)
#define MOLEMOLE_MONOGAMEPADMODULE_MANUALAWAKE_OFFSET UNITYSDK_OFFSET(0x129BA4F0)
#define MOLEMOLE_MONOGAMEPADMODULE_MANUALDISABLE_OFFSET UNITYSDK_OFFSET(0x129BA6B0)
#define MOLEMOLE_MONOGAMEPADMODULE_MANUALENABLE_OFFSET UNITYSDK_OFFSET(0x129BA5F0)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_0672F56933763C8F_OFFSET UNITYSDK_OFFSET(0x129BF3B0)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_079E6D0FB3AE13F6_OFFSET UNITYSDK_OFFSET(0x129BC830)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_0D5795AC159AF93B_OFFSET UNITYSDK_OFFSET(0x129BBA60)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_1B9CC121BDC8766D_1_OFFSET UNITYSDK_OFFSET(0x129BA370)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_1B9CC121BDC8766D_OFFSET UNITYSDK_OFFSET(0x129BB380)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x129BD390)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_2983CAA9D011AEC9_OFFSET UNITYSDK_OFFSET(0x129BBF80)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_2BEF6A28C6DA16FF_1_OFFSET UNITYSDK_OFFSET(0x129BDB40)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_2BEF6A28C6DA16FF_OFFSET UNITYSDK_OFFSET(0x129BD4B0)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_2EFF1445F2CEE386_OFFSET UNITYSDK_OFFSET(0x129BC2E0)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x129B9BE0)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_3D7E9840CF105C69_OFFSET UNITYSDK_OFFSET(0x129BB440)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x129BC210)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_49CE60633546B186_OFFSET UNITYSDK_OFFSET(0x129BE930)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_4F708DC8C166FF7F_OFFSET UNITYSDK_OFFSET(0x129BCAC0)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_6796390E2F1B97B3_OFFSET UNITYSDK_OFFSET(0x129BD460)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_9681042564541CD6_1_OFFSET UNITYSDK_OFFSET(0x129BAB90)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_9681042564541CD6_2_OFFSET UNITYSDK_OFFSET(0x129B9DD0)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x129B9D60)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_9FF06798F05BF979_OFFSET UNITYSDK_OFFSET(0x129BAD20)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_AA2B8A63BBDC1282_OFFSET UNITYSDK_OFFSET(0x129BB4B0)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_AD864436D3953AEC_OFFSET UNITYSDK_OFFSET(0x129BC880)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_B1936CE4DA97AA45_1_OFFSET UNITYSDK_OFFSET(0x129B9EE0)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x129BB310)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_BACD4B58CEA46E78_1_OFFSET UNITYSDK_OFFSET(0x129BE030)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_BACD4B58CEA46E78_2_OFFSET UNITYSDK_OFFSET(0x129BD970)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_BACD4B58CEA46E78_OFFSET UNITYSDK_OFFSET(0x129BEE00)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_BEA7E631729DFB7C_OFFSET UNITYSDK_OFFSET(0x129BF3C0)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x129BB250)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x129BB290)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0x129BB2D0)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x129BB210)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_D0DF0505F244B465_OFFSET UNITYSDK_OFFSET(0x129B9F60)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_E507C493A7842CF6_OFFSET UNITYSDK_OFFSET(0x129BF050)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_E57D0DA1E17C4DDA_1_OFFSET UNITYSDK_OFFSET(0x129BEC10)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_E57D0DA1E17C4DDA_2_OFFSET UNITYSDK_OFFSET(0x129BD7A0)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_E57D0DA1E17C4DDA_OFFSET UNITYSDK_OFFSET(0x129BDE40)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_ECA703745FE28665_OFFSET UNITYSDK_OFFSET(0x129BC280)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_F1D40B323FAD3DCE_OFFSET UNITYSDK_OFFSET(0x129BFD00)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_F4DD08A31BA3F883_OFFSET UNITYSDK_OFFSET(0x129BB500)
#define MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_FFD65E4FEAD3C019_OFFSET UNITYSDK_OFFSET(0x129BE200)
#define MOLEMOLE_MONOGAMEPADMODULE_MUTEFOCUSRECORD_OFFSET UNITYSDK_OFFSET(0x129BAC00)
#define MOLEMOLE_MONOGAMEPADMODULE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x129BA3F0)
#define MOLEMOLE_MONOGAMEPADMODULE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x129BA2D0)
#define MOLEMOLE_MONOGAMEPADMODULE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x129B9E40)
#define MOLEMOLE_MONOGAMEPADMODULE_PUBLICGETGAMEPADSELECTABLE_OFFSET UNITYSDK_OFFSET(0x129BD400)
#define MOLEMOLE_MONOGAMEPADMODULE_RECORDFOCUSSTATE_OFFSET UNITYSDK_OFFSET(0x129BAC80)
#define MOLEMOLE_MONOGAMEPADMODULE_RESOLVEMANAGEDOBJECTS_OFFSET UNITYSDK_OFFSET(0x129BB7A0)
#define MOLEMOLE_MONOGAMEPADMODULE_SETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x129BA4A0)
#define MOLEMOLE_MONOGAMEPADMODULE_SETFOCUSBYREGION_OFFSET UNITYSDK_OFFSET(0x129BB060)
#define MOLEMOLE_MONOGAMEPADMODULE_SETFOCUS_OFFSET UNITYSDK_OFFSET(0x129BA9B0)
#define MOLEMOLE_MONOGAMEPADMODULE_SETNAVIGATETARGET_OFFSET UNITYSDK_OFFSET(0x129BD080)
#define MOLEMOLE_MONOGAMEPADMODULE_SET_FOCUSONENABLE_OFFSET UNITYSDK_OFFSET(0x129B9830)
#define MOLEMOLE_MONOGAMEPADMODULE_SET_FORCEIGNOREBENAVIGATED_OFFSET UNITYSDK_OFFSET(0x129B9A70)
#define MOLEMOLE_MONOGAMEPADMODULE_SET_ISCLEAR_OFFSET UNITYSDK_OFFSET(0x129B9A50)
#define MOLEMOLE_MONOGAMEPADMODULE_SET_ISCOLLECTED_OFFSET UNITYSDK_OFFSET(0x129B9A00)
#define MOLEMOLE_MONOGAMEPADMODULE_SET_MODULENAME_OFFSET UNITYSDK_OFFSET(0x129B9850)
#define MOLEMOLE_MONOGAMEPADMODULE_SET_PARENTMODULE_OFFSET UNITYSDK_OFFSET(0x129B9A30)
#define MOLEMOLE_MONOGAMEPADMODULE_SET_PRIORITYLEVEL_OFFSET UNITYSDK_OFFSET(0x129B9870)
#define MOLEMOLE_MONOGAMEPADMODULE_SET_PRIORITYSORTINDEX_OFFSET UNITYSDK_OFFSET(0x129B98A0)
#define MOLEMOLE_MONOGAMEPADMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x129BEFD0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGamepadModule_TypeDefinitionIndex = 59765;
	...
	public:
		...
		::MoleMole::MonoGamepadModule_Enum_3_E1ECA05187CF4721 Field_5_0; // 0x20
		...
		::System::Int32 Field_5_16; // 0xB8
		::System::Action_1<::System::Boolean>* OnFocus; // 0xC0
		::System::Boolean Field_5_22; // 0xC8
		::MoleMole::UIBaseController* Field_5_21; // 0xD0
		::MoleMole::MonoGamepadModule* Field_5_20; // 0xD8
		::System::Boolean Field_5_27; // 0xE0
		::System::Boolean Field_5_26; // 0xE1
		::System::Boolean Field_5_25; // 0xE2
		::System::Boolean Field_5_24; // 0xE3
		::System::Boolean Field_5_31; // 0xE4
		::System::Boolean Field_5_30; // 0xE5
		...
		::System::Boolean Method_5_AD864436D3953AEC(::MoleMole::InputActionEvent a1)
		{
			return ((::System::Boolean(*)(::PVOID, ::MoleMole::InputActionEvent))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_AD864436D3953AEC_OFFSET))(this, a1);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_1D4018D4200358D0_OFFSET))(this);
		}
		...
		static ::System::Nullable_1<::System::Boolean> Method_5_E57D0DA1E17C4DDA(::MoleMole::MonoGamepadModule_Struct_2_858AFA8F6CDBEA34_1& a1)
		{
			return ((::System::Nullable_1<::System::Boolean>(*)(::MoleMole::MonoGamepadModule_Struct_2_858AFA8F6CDBEA34_1&))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_E57D0DA1E17C4DDA_OFFSET))(a1);
		}
		...
		static ::System::Nullable_1<::System::Boolean> Method_5_E57D0DA1E17C4DDA_1(::MoleMole::MonoGamepadModule_Struct_2_858AFA8F6CDBEA34& a1)
		{
			return ((::System::Nullable_1<::System::Boolean>(*)(::MoleMole::MonoGamepadModule_Struct_2_858AFA8F6CDBEA34&))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_E57D0DA1E17C4DDA_1_OFFSET))(a1);
		}
		...
		::System::Void Method_5_9FF06798F05BF979(::System::Boolean a1, ::System::Boolean a2, ::System::Boolean a3, ::System::Boolean a4)
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean, ::System::Boolean, ::System::Boolean, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_9FF06798F05BF979_OFFSET))(this, a1, a2, a3, a4);
		}
		...
		::System::Void Method_5_BEA7E631729DFB7C(::UnityEngine::Transform* a1, ::System::Boolean a2, ::System::Boolean a3)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Transform*, ::System::Boolean, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADMODULE_METHOD_5_BEA7E631729DFB7C_OFFSET))(this, a1, a2, a3);
		}
