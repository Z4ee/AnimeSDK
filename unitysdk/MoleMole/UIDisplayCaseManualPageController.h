...
#define MOLEMOLE_UIDISPLAYCASEMANUALPAGECONTROLLER_GET_CURPREVIEWID_OFFSET UNITYSDK_OFFSET(0x19DA8F30)
#define MOLEMOLE_UIDISPLAYCASEMANUALPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x19DA8F20)
#define MOLEMOLE_UIDISPLAYCASEMANUALPAGECONTROLLER_ONCLICKLEFT_OFFSET UNITYSDK_OFFSET(0x19DAC600)
#define MOLEMOLE_UIDISPLAYCASEMANUALPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19DA8F40)
#define MOLEMOLE_UIDISPLAYCASEMANUALPAGECONTROLLER_ONRTBUILT_OFFSET UNITYSDK_OFFSET(0x19DABCB0)
#define MOLEMOLE_UIDISPLAYCASEMANUALPAGECONTROLLER_ONTABCLICKED_OFFSET UNITYSDK_OFFSET(0x19DAA9C0)
#define MOLEMOLE_UIDISPLAYCASEMANUALPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19DAA920)
#define MOLEMOLE_UIDISPLAYCASEMANUALPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19DA8FD0)
#define MOLEMOLE_UIDISPLAYCASEMANUALPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19DA9530)
#define MOLEMOLE_UIDISPLAYCASEMANUALPAGECONTROLLER_PROCESSUIAVATAR_OFFSET UNITYSDK_OFFSET(0x19DAC650)
#define MOLEMOLE_UIDISPLAYCASEMANUALPAGECONTROLLER_REFRESHLEFT_OFFSET UNITYSDK_OFFSET(0x19DAB3B0)
#define MOLEMOLE_UIDISPLAYCASEMANUALPAGECONTROLLER_REFRESHTABS_OFFSET UNITYSDK_OFFSET(0x19DA9600)
#define MOLEMOLE_UIDISPLAYCASEMANUALPAGECONTROLLER_UICLOSE_OFFSET UNITYSDK_OFFSET(0x19DAA890)
#define MOLEMOLE_UIDISPLAYCASEMANUALPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19DAC6A0)
#define MOLEMOLE_UIDISPLAYCASEMANUALPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19DAC770)
#define MOLEMOLE_UIDISPLAYCASEMANUALPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19DAC800)
#define MOLEMOLE_UIDISPLAYCASEMANUALPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19DAC810)
#define MOLEMOLE_UIDISPLAYCASEMANUALPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19DAC820)
#define MOLEMOLE_UIDISPLAYCASEMANUALPAGECONTROLLER___BASE_UICLOSE_OFFSET UNITYSDK_OFFSET(0x19DAC8B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIDisplayCaseManualPageController_TypeDefinitionIndex = 61470;
	...
	public:
		...
		::System::Void OnRTBuilt(::Class_2_208CC9941471731A_440* cfg)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_440*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIDISPLAYCASEMANUALPAGECONTROLLER_ONRTBUILT_OFFSET))(this, cfg);
		}
