...
#define MOLEMOLE_UIMAPTEST2DICONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18331EC0)
#define MOLEMOLE_UIMAPTEST2DICONWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18331C90)
#define MOLEMOLE_UIMAPTEST2DICONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18331F50)
#define MOLEMOLE_UIMAPTEST2DICONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18331BC0)
#define MOLEMOLE_UIMAPTEST2DICONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18331C20)
#define MOLEMOLE_UIMAPTEST2DICONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18331FD0)
#define MOLEMOLE_UIMAPTEST2DICONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18332030)
#define MOLEMOLE_UIMAPTEST2DICONWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x183320C0)
#define MOLEMOLE_UIMAPTEST2DICONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x183321D0)
#define MOLEMOLE_UIMAPTEST2DICONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18332260)
#define MOLEMOLE_UIMAPTEST2DICONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x183322F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMapTest2DIconWidgetController_TypeDefinitionIndex = 82488;

	class UIMapTest2DIconWidgetController : public ::MoleMole::UITwoDMapElement_UIController
	{
	public:
		::Class_2_DE782794730406DC_5* _view; // 0x2C8
