...
#define MOLEMOLE_UIINLEVELJUFUFUPANELCHILDWINDOWCONTROLLER_COLLECTALLANIMATIONCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1825F920)
#define MOLEMOLE_UIINLEVELJUFUFUPANELCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1825E8F0)
#define MOLEMOLE_UIINLEVELJUFUFUPANELCHILDWINDOWCONTROLLER_HANDLEALLCUSTOMPROPERTIESONSHOW_OFFSET UNITYSDK_OFFSET(0x1825EA20)
#define MOLEMOLE_UIINLEVELJUFUFUPANELCHILDWINDOWCONTROLLER_HANDLECUSTOMPROPERTY_OFFSET UNITYSDK_OFFSET(0x1825EB20)
#define MOLEMOLE_UIINLEVELJUFUFUPANELCHILDWINDOWCONTROLLER_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x1825F5E0)
#define MOLEMOLE_UIINLEVELJUFUFUPANELCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1825E900)
#define MOLEMOLE_UIINLEVELJUFUFUPANELCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1825E990)
#define MOLEMOLE_UIINLEVELJUFUFUPANELCHILDWINDOWCONTROLLER_SETTHRESHOLDLINEPOSITION_OFFSET UNITYSDK_OFFSET(0x1825F7E0)
#define MOLEMOLE_UIINLEVELJUFUFUPANELCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1825F9E0)
#define MOLEMOLE_UIINLEVELJUFUFUPANELCHILDWINDOWCONTROLLER__HANDLECUSTOMPROPERTY_B__13_0_OFFSET UNITYSDK_OFFSET(0x1825F9F0)
#define MOLEMOLE_UIINLEVELJUFUFUPANELCHILDWINDOWCONTROLLER__HANDLECUSTOMPROPERTY_B__13_1_OFFSET UNITYSDK_OFFSET(0x1825FB00)
#define MOLEMOLE_UIINLEVELJUFUFUPANELCHILDWINDOWCONTROLLER___BASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x1825FC10)
#define MOLEMOLE_UIINLEVELJUFUFUPANELCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1825FCA0)
#define MOLEMOLE_UIINLEVELJUFUFUPANELCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1825FD30)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelJuFufuPanelChildWindowController_TypeDefinitionIndex = 52486;
	...
	public:
		...
		::Class_2_081DC89E6FC143C9* _view; // 0x350
