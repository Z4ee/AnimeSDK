...
#define MOLEMOLE_UIINLEVELJUFUFUPANELCHILDWINDOWCONTROLLER_COLLECTALLANIMATIONCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x19EBADC0)
#define MOLEMOLE_UIINLEVELJUFUFUPANELCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x19EB9D50)
#define MOLEMOLE_UIINLEVELJUFUFUPANELCHILDWINDOWCONTROLLER_HANDLEALLCUSTOMPROPERTIESONSHOW_OFFSET UNITYSDK_OFFSET(0x19EB9E80)
#define MOLEMOLE_UIINLEVELJUFUFUPANELCHILDWINDOWCONTROLLER_HANDLECUSTOMPROPERTY_OFFSET UNITYSDK_OFFSET(0x19EB9F80)
#define MOLEMOLE_UIINLEVELJUFUFUPANELCHILDWINDOWCONTROLLER_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x19EBAA80)
#define MOLEMOLE_UIINLEVELJUFUFUPANELCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19EB9D60)
#define MOLEMOLE_UIINLEVELJUFUFUPANELCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19EB9DF0)
#define MOLEMOLE_UIINLEVELJUFUFUPANELCHILDWINDOWCONTROLLER_SETTHRESHOLDLINEPOSITION_OFFSET UNITYSDK_OFFSET(0x19EBAC80)
#define MOLEMOLE_UIINLEVELJUFUFUPANELCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19EBAE80)
#define MOLEMOLE_UIINLEVELJUFUFUPANELCHILDWINDOWCONTROLLER__HANDLECUSTOMPROPERTY_B__13_0_OFFSET UNITYSDK_OFFSET(0x19EBAE90)
#define MOLEMOLE_UIINLEVELJUFUFUPANELCHILDWINDOWCONTROLLER__HANDLECUSTOMPROPERTY_B__13_1_OFFSET UNITYSDK_OFFSET(0x19EBAFA0)
#define MOLEMOLE_UIINLEVELJUFUFUPANELCHILDWINDOWCONTROLLER___BASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x19EBB0B0)
#define MOLEMOLE_UIINLEVELJUFUFUPANELCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19EBB140)
#define MOLEMOLE_UIINLEVELJUFUFUPANELCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19EBB1D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelJuFufuPanelChildWindowController_TypeDefinitionIndex = 90700;
