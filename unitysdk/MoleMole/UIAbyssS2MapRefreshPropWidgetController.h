...
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER_GET_ONCLICKACTION_OFFSET UNITYSDK_OFFSET(0x12BEED70)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x12BEE500)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER_ONCLICK_OFFSET UNITYSDK_OFFSET(0x12BEE7F0)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x12BEE570)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x12BEEB50)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x12BEE890)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12BEE630)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER_SETONCLICK_OFFSET UNITYSDK_OFFSET(0x12BEED20)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER_SET_ONCLICKACTION_OFFSET UNITYSDK_OFFSET(0x12BEED80)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12BEED90)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x12BEEDA0)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x12BEEE40)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x12BEEED0)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12BEEF70)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2MapRefreshPropWidgetController_TypeDefinitionIndex = 69587;
