...
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER_GET_ONCLICKACTION_OFFSET UNITYSDK_OFFSET(0x1386E9C0)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1386E130)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER_ONCLICK_OFFSET UNITYSDK_OFFSET(0x1386E430)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1386E1A0)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x1386E7A0)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1386E4D0)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1386E260)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER_SETONCLICK_OFFSET UNITYSDK_OFFSET(0x1386E970)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER_SET_ONCLICKACTION_OFFSET UNITYSDK_OFFSET(0x1386E9D0)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1386E9E0)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1386E9F0)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x1386EA90)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1386EB20)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1386EBC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2MapRefreshPropWidgetController_TypeDefinitionIndex = 68011;

	class UIAbyssS2MapRefreshPropWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::System::Int32 _cacheIndex; // 0x2F0
		::System::Action_2<::System::Boolean, ::System::Int32>* _OnClickAction_k__BackingField; // 0x2F8
