...
#define MOLEMOLE_UIBOSSBATTLEDATADIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x175B9920)

namespace MoleMole
{
	inline static constexpr unsigned int UIBossBattleDataDialogContext_TypeDefinitionIndex = 41507;
