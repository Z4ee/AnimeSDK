...
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATORV2_PROCESS_NORMALPARTFIXGEN_3_OFFSET UNITYSDK_OFFSET(0x11002780)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATORV2_PROCESS_NORMALPARTGEN_1_OFFSET UNITYSDK_OFFSET(0x10FFFC40)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATORV2_PROCESS_NORMALPARTREDUCEGEN_2_OFFSET UNITYSDK_OFFSET(0x11001C60)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATORV2_PROCESS_STARTPOINTS_0_OFFSET UNITYSDK_OFFSET(0x10FFFBD0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATORV2__CTOR_OFFSET UNITYSDK_OFFSET(0x10FFFBC0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATORV2___BASE_PROCESS_NORMALPARTFIXGEN_3_OFFSET UNITYSDK_OFFSET(0x110027F0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATORV2___BASE_PROCESS_NORMALPARTGEN_1_OFFSET UNITYSDK_OFFSET(0x11002820)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATORV2___BASE_PROCESS_NORMALPARTREDUCEGEN_2_OFFSET UNITYSDK_OFFSET(0x11002850)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATORV2___BASE_PROCESS_STARTPOINTS_0_OFFSET UNITYSDK_OFFSET(0x11002880)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_DefaultMapGeneratorV2_TypeDefinitionIndex = 82324;
