...
#define MOLEMOLE_MONOGAMEPADREGION_ADDMODULE_OFFSET UNITYSDK_OFFSET(0x170256B0)
#define MOLEMOLE_MONOGAMEPADREGION_CLEARMODULES_OFFSET UNITYSDK_OFFSET(0x17025AC0)
#define MOLEMOLE_MONOGAMEPADREGION_METHOD_6_0943098B945A3BE1_OFFSET UNITYSDK_OFFSET(0x17025150)
#define MOLEMOLE_MONOGAMEPADREGION_METHOD_6_3C37862761792B91_OFFSET UNITYSDK_OFFSET(0x17024F60)
#define MOLEMOLE_MONOGAMEPADREGION_METHOD_6_4F36FF0A94BB4979_OFFSET UNITYSDK_OFFSET(0x17025210)
#define MOLEMOLE_MONOGAMEPADREGION_METHOD_6_BA1A377B18A273A8_OFFSET UNITYSDK_OFFSET(0x170251C0)
#define MOLEMOLE_MONOGAMEPADREGION_METHOD_6_BBB2DE33CBFA5128_OFFSET UNITYSDK_OFFSET(0x17025640)
#define MOLEMOLE_MONOGAMEPADREGION_REFRESHMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x17025C00)
#define MOLEMOLE_MONOGAMEPADREGION_REMOVEMODULE_OFFSET UNITYSDK_OFFSET(0x17025960)
#define MOLEMOLE_MONOGAMEPADREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x17025C90)
#define MOLEMOLE_MONOGAMEPADREGION___BASE_LOGICEVENTTONAVDIR_OFFSET UNITYSDK_OFFSET(0x17025D10)
#define MOLEMOLE_MONOGAMEPADREGION___BASE_ONMODULEAWAKE_OFFSET UNITYSDK_OFFSET(0x17025DA0)
#define MOLEMOLE_MONOGAMEPADREGION___BASE_ONMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x17025E30)
#define MOLEMOLE_MONOGAMEPADREGION___BASE_ONMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x17025E40)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGamepadRegion_TypeDefinitionIndex = 45693;
