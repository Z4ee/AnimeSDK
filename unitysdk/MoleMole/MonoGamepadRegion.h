...
#define MOLEMOLE_MONOGAMEPADREGION_ADDMODULE_OFFSET UNITYSDK_OFFSET(0x144E7B10)
#define MOLEMOLE_MONOGAMEPADREGION_CLEARMODULES_OFFSET UNITYSDK_OFFSET(0x144E7F20)
#define MOLEMOLE_MONOGAMEPADREGION_METHOD_6_0943098B945A3BE1_OFFSET UNITYSDK_OFFSET(0x144E75A0)
#define MOLEMOLE_MONOGAMEPADREGION_METHOD_6_36B3126FAEF06CA3_OFFSET UNITYSDK_OFFSET(0x144E7610)
#define MOLEMOLE_MONOGAMEPADREGION_METHOD_6_3C37862761792B91_OFFSET UNITYSDK_OFFSET(0x144E73B0)
#define MOLEMOLE_MONOGAMEPADREGION_METHOD_6_BBB2DE33CBFA5128_OFFSET UNITYSDK_OFFSET(0x144E7AA0)
#define MOLEMOLE_MONOGAMEPADREGION_METHOD_6_E598AD81D411DEAB_OFFSET UNITYSDK_OFFSET(0x144E7660)
#define MOLEMOLE_MONOGAMEPADREGION_REFRESHMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x144E8060)
#define MOLEMOLE_MONOGAMEPADREGION_REMOVEMODULE_OFFSET UNITYSDK_OFFSET(0x144E7DC0)
#define MOLEMOLE_MONOGAMEPADREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x144E80F0)
#define MOLEMOLE_MONOGAMEPADREGION___BASE_LOGICEVENTTONAVDIR_OFFSET UNITYSDK_OFFSET(0x144E8170)
#define MOLEMOLE_MONOGAMEPADREGION___BASE_ONMODULEAWAKE_OFFSET UNITYSDK_OFFSET(0x144E8200)
#define MOLEMOLE_MONOGAMEPADREGION___BASE_ONMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x144E8290)
#define MOLEMOLE_MONOGAMEPADREGION___BASE_ONMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x144E82A0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGamepadRegion_TypeDefinitionIndex = 86402;
	...
	public:
		...
		::System::Void Method_6_36B3126FAEF06CA3()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADREGION_METHOD_6_36B3126FAEF06CA3_OFFSET))(this);
		}
		...
		::System::Void Method_6_E598AD81D411DEAB(::System::Boolean a1, ::System::Boolean a2)
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADREGION_METHOD_6_E598AD81D411DEAB_OFFSET))(this, a1, a2);
		}
	};
}
