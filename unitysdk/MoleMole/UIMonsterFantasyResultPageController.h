...
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_GETMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x14D8BC70)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x14D89960)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_OKBTNCALLBACK_OFFSET UNITYSDK_OFFSET(0x14D89A10)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_ONUIFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0x14D89FB0)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14D89B40)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14D8A2A0)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_QUITBTNCALLBACK_OFFSET UNITYSDK_OFFSET(0x14D89970)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_REFRESHCHAPTERTITLE_OFFSET UNITYSDK_OFFSET(0x14D8A570)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_REFRESHCHOICEBTN_OFFSET UNITYSDK_OFFSET(0x14D8B200)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_REFRESHLOSETIPS_OFFSET UNITYSDK_OFFSET(0x14D8C4F0)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_REFRESHMISSIONVIEW_OFFSET UNITYSDK_OFFSET(0x14D8A7E0)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_REFRESHREWARDVIEW_OFFSET UNITYSDK_OFFSET(0x14D8A8E0)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_REFRESHSAB_OFFSET UNITYSDK_OFFSET(0x14D8C130)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_REFRESHWINTIPS_OFFSET UNITYSDK_OFFSET(0x14D8CA70)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x14D89AB0)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14D8D390)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER__ONUIINIT_B__7_0_OFFSET UNITYSDK_OFFSET(0x14D8D580)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER__ONUIINIT_B__7_1_OFFSET UNITYSDK_OFFSET(0x14D8D640)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER__REFRESHSAB_B__11_1_OFFSET UNITYSDK_OFFSET(0x14D8D660)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER__REFRESHSAB_B__11_2_OFFSET UNITYSDK_OFFSET(0x14D8D930)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER___BASE_GETMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x14D8DCD0)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x14D8DD00)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x14D8DD10)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER___BASE_REFRESHMISSIONVIEW_OFFSET UNITYSDK_OFFSET(0x14D8DD20)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER___BASE_REFRESHREWARDVIEW_OFFSET UNITYSDK_OFFSET(0x14D8DD30)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x14D8DD40)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyResultPageController_TypeDefinitionIndex = 41561;

	class UIMonsterFantasyResultPageController : public ::MoleMole::UIHollowLayerResultPageV2PopWindowController
	{
	public:
		::MoleMole::MonsterFantasyResultContext* _context; // 0x390
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::Config::ConfigHollowAssetPath_HollowAssetPathKey>* RankDic; // 0x398
