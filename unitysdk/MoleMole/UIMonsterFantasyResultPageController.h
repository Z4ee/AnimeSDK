...
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_GETMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x179F62C0)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x179F3F90)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_OKBTNCALLBACK_OFFSET UNITYSDK_OFFSET(0x179F4040)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_ONUIFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0x179F45E0)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x179F4170)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x179F48C0)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_QUITBTNCALLBACK_OFFSET UNITYSDK_OFFSET(0x179F3FA0)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_REFRESHCHAPTERTITLE_OFFSET UNITYSDK_OFFSET(0x179F4B90)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_REFRESHCHOICEBTN_OFFSET UNITYSDK_OFFSET(0x179F5810)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_REFRESHLOSETIPS_OFFSET UNITYSDK_OFFSET(0x179F6BB0)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_REFRESHMISSIONVIEW_OFFSET UNITYSDK_OFFSET(0x179F4E00)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_REFRESHREWARDVIEW_OFFSET UNITYSDK_OFFSET(0x179F4F00)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_REFRESHSAB_OFFSET UNITYSDK_OFFSET(0x179F6770)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_REFRESHWINTIPS_OFFSET UNITYSDK_OFFSET(0x179F70D0)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x179F40E0)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x179F7A20)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER__ONUIINIT_B__7_0_OFFSET UNITYSDK_OFFSET(0x179F7C10)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER__ONUIINIT_B__7_1_OFFSET UNITYSDK_OFFSET(0x179F7CD0)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER__REFRESHSAB_B__11_1_OFFSET UNITYSDK_OFFSET(0x179F7CF0)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER__REFRESHSAB_B__11_2_OFFSET UNITYSDK_OFFSET(0x179F7FD0)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER___BASE_GETMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x179F8370)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x179F83A0)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x179F83B0)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER___BASE_REFRESHMISSIONVIEW_OFFSET UNITYSDK_OFFSET(0x179F83C0)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER___BASE_REFRESHREWARDVIEW_OFFSET UNITYSDK_OFFSET(0x179F83D0)
#define MOLEMOLE_UIMONSTERFANTASYRESULTPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x179F83E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyResultPageController_TypeDefinitionIndex = 79108;
