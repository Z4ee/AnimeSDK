...
#define MOLEMOLE_UINEOGOLDENMECHASKILLWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1529C710)
#define MOLEMOLE_UINEOGOLDENMECHASKILLWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1529C7E0)
#define MOLEMOLE_UINEOGOLDENMECHASKILLWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x1529C9D0)
#define MOLEMOLE_UINEOGOLDENMECHASKILLWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1529C8A0)
#define MOLEMOLE_UINEOGOLDENMECHASKILLWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1529C780)
#define MOLEMOLE_UINEOGOLDENMECHASKILLWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1529CAC0)
#define MOLEMOLE_UINEOGOLDENMECHASKILLWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1529CAD0)
#define MOLEMOLE_UINEOGOLDENMECHASKILLWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x1529CB70)
#define MOLEMOLE_UINEOGOLDENMECHASKILLWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1529CC00)
#define MOLEMOLE_UINEOGOLDENMECHASKILLWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1529CCA0)

namespace MoleMole
{
	inline static constexpr unsigned int UINeoGoldenMechaSkillWidgetController_TypeDefinitionIndex = 51968;
