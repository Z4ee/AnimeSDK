...
class Class_2_C7387D40D4120A48_3_Class_2_EBD92CE648041B43;
...
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_BINDVIEW_OFFSET UNITYSDK_OFFSET(0x173B84F0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_CANCELSELECT_OFFSET UNITYSDK_OFFSET(0x173B9890)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_DRAGSTANDBYSLOT_OFFSET UNITYSDK_OFFSET(0x173B9E80)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_GETPLAYERITEMMOVESCRIPT_OFFSET UNITYSDK_OFFSET(0x173B7070)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_GETSLIDERVALUE_OFFSET UNITYSDK_OFFSET(0x173BB910)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_GET_BACKBTN_OFFSET UNITYSDK_OFFSET(0x173B73D0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_GET_BOTTOM_OFFSET UNITYSDK_OFFSET(0x173B73B0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_GET_DRAGPIECE_OFFSET UNITYSDK_OFFSET(0x173B7390)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_GET_ISSHOWDAMAGE_OFFSET UNITYSDK_OFFSET(0x173BC7F0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_GET_LOCALGROUP_OFFSET UNITYSDK_OFFSET(0x173B7400)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_GET_RIGHTINFOROOT_OFFSET UNITYSDK_OFFSET(0x173BBA20)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_GET_SHOPWIDGET_OFFSET UNITYSDK_OFFSET(0x173B5F30)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_GET_SHOWSTARTBTN_OFFSET UNITYSDK_OFFSET(0x173B8130)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_HOVERONSTANDBYCTRL_OFFSET UNITYSDK_OFFSET(0x173BA0C0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_ISINSELLAREA_OFFSET UNITYSDK_OFFSET(0x173B9400)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x173BCF40)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_ONBANGBOOREACHLIMIT_OFFSET UNITYSDK_OFFSET(0x173BA450)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_ONCHILDGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x173BC1A0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x173B71B0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_ONLEVELBTNCLICK_OFFSET UNITYSDK_OFFSET(0x173BB2A0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_ONSERVERSORT_OFFSET UNITYSDK_OFFSET(0x173B6BF0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_ONSTAGECHANGE_OFFSET UNITYSDK_OFFSET(0x173BAA20)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_ONSTARTBTNCLICK_OFFSET UNITYSDK_OFFSET(0x173BA570)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x173B7260)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x173B5F40)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x173B68A0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_OPENCURPLAYERINFO_OFFSET UNITYSDK_OFFSET(0x173BC460)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_REFRESHRIGHTAREA_OFFSET UNITYSDK_OFFSET(0x173BBA50)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_REFRESHSTATPANEL_OFFSET UNITYSDK_OFFSET(0x173BC900)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_SAVEFINALBATTLERESULT_OFFSET UNITYSDK_OFFSET(0x173BACE0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_SETLEVELBTNINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x173B7EA0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_SETSELLPRICE_OFFSET UNITYSDK_OFFSET(0x173B95D0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_SETSLIDER_OFFSET UNITYSDK_OFFSET(0x173BB7C0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_SET_DRAGPIECE_OFFSET UNITYSDK_OFFSET(0x173B73A0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_TICKSTAT_OFFSET UNITYSDK_OFFSET(0x173BCB60)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_TOGGLEBOTTOM_OFFSET UNITYSDK_OFFSET(0x173B7430)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_TOGGLEPLAYERFOCUS_OFFSET UNITYSDK_OFFSET(0x173BC3F0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_TOGGLEPLAYERINFO_OFFSET UNITYSDK_OFFSET(0x173B9700)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_TOGGLESELLAREA_OFFSET UNITYSDK_OFFSET(0x173B9110)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_TOGGLESHOP_1_OFFSET UNITYSDK_OFFSET(0x173BB390)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_TOGGLESHOP_OFFSET UNITYSDK_OFFSET(0x173B9A00)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_TWEENSLIDER_OFFSET UNITYSDK_OFFSET(0x173BB5E0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x173BD390)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER__ONBANGBOOREACHLIMIT_B__52_0_OFFSET UNITYSDK_OFFSET(0x173BD820)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER__ONSTARTBTNCLICK_B__56_0_OFFSET UNITYSDK_OFFSET(0x173BD950)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER__ONUIOPEN_B__27_0_OFFSET UNITYSDK_OFFSET(0x173BD580)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER__OPENCURPLAYERINFO_B__69_0_OFFSET UNITYSDK_OFFSET(0x173BD970)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER__TOGGLESELLAREA_B__44_0_OFFSET UNITYSDK_OFFSET(0x173BD790)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER__TWEENSLIDER_B__60_0_OFFSET UNITYSDK_OFFSET(0x173BD960)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x173BD9F0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x173BDA80)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x173BDB10)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x173BDBA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIABStandbyPhaseWidgetController_TypeDefinitionIndex = 86075;
	...
	public:
		...
		::Class_2_C7387D40D4120A48_3_Class_2_EBD92CE648041B43* _lvlBtn; // 0x2F0
		...
		::Class_2_D4C8D2E76E094D02* _damageStatViewModel; // 0x378
		...
		::System::Void DragStandbySlot(::System::Boolean isDrag, ::Class_2_5AA8899FEE19F18E* slot)
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean, ::Class_2_5AA8899FEE19F18E*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_DRAGSTANDBYSLOT_OFFSET))(this, isDrag, slot);
		}
