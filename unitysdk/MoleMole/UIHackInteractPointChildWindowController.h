...
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_APPLYMONOINPUTKEYLOGICEVENT_OFFSET UNITYSDK_OFFSET(0x19FD5190)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_BINDDATA_OFFSET UNITYSDK_OFFSET(0x19FD0C10)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_CANCELROOTFADEBLOCK_OFFSET UNITYSDK_OFFSET(0x19FD3440)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_COLLECTMONOINPUTKEYS_OFFSET UNITYSDK_OFFSET(0x19FD01B0)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_ENSUREFOCUSDECORATIONREFS_OFFSET UNITYSDK_OFFSET(0x19FCF0F0)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_FINISHROOTFADE_OFFSET UNITYSDK_OFFSET(0x19FD35E0)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_GETHACKSCREENCENTERINPIXELS_OFFSET UNITYSDK_OFFSET(0x19FD3040)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_GETHACKSCREENCENTERVIEWPORT_OFFSET UNITYSDK_OFFSET(0x19FD4F20)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_GETINDICATESCREENPOSITION_OFFSET UNITYSDK_OFFSET(0x19FD30E0)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_GETINTERACTRANGEPARAM_OFFSET UNITYSDK_OFFSET(0x19FD4C10)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_GETPROGRESSVISIBLEFLAG_OFFSET UNITYSDK_OFFSET(0x19FD4890)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_GET_MAINCAMERA_OFFSET UNITYSDK_OFFSET(0x19FD2FD0)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_GET_UICAMERA_OFFSET UNITYSDK_OFFSET(0x19FD3250)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x19FCED30)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_ISCAMERASCANTARGET_OFFSET UNITYSDK_OFFSET(0x19FD3D40)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_ISFOCUSSTYLETARGET_OFFSET UNITYSDK_OFFSET(0x19FD3DA0)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_ISSPECIALHACK_OFFSET UNITYSDK_OFFSET(0x19FD3F80)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_ISTARGETPOINTINSIDESCREENRANGE_OFFSET UNITYSDK_OFFSET(0x19FD2FE0)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_ISTARGETPOINTVISIBLE_OFFSET UNITYSDK_OFFSET(0x19FD2F30)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_KILLROOTFADEANIMATION_OFFSET UNITYSDK_OFFSET(0x19FD0750)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x19FD33E0)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_ONCONTROLLABLEENDTRANS_OFFSET UNITYSDK_OFFSET(0x19FD0370)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_ONCONTROLLABLESTARTTRANS_OFFSET UNITYSDK_OFFSET(0x19FD0320)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19FD0420)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19FD03C0)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_ONHACKSYSTEMMODECHANGED_OFFSET UNITYSDK_OFFSET(0x19FD5130)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x19FD2C20)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_ONPREPAREHIDE_OFFSET UNITYSDK_OFFSET(0x19FD2190)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19FD04B0)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19FCED40)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19FD02B0)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x19FD2530)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x19FD2B00)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_REFRESHHINTVISUALSTATE_OFFSET UNITYSDK_OFFSET(0x19FD0D50)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_REFRESHLOCATIONTEXT_OFFSET UNITYSDK_OFFSET(0x19FD1BC0)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_REFRESHMONOINPUTKEYBYCURRENTMODE_OFFSET UNITYSDK_OFFSET(0x19FD20C0)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_RESETFOCUSDECORATIONSTATE_OFFSET UNITYSDK_OFFSET(0x19FCFFA0)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_RESETPROGRESSSTATE_OFFSET UNITYSDK_OFFSET(0x19FCFE30)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_RESETSCANINTERACTIVESTATE_OFFSET UNITYSDK_OFFSET(0x19FD0090)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_SETFOCUSDECORATIONVISIBLE_OFFSET UNITYSDK_OFFSET(0x19FD2200)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_SETPROGRESSVISIBLEFLAG_OFFSET UNITYSDK_OFFSET(0x19FD48F0)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_SETPROGRESSVISIBLE_OFFSET UNITYSDK_OFFSET(0x19FD3650)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_SETROOTCANVASVISIBLE_OFFSET UNITYSDK_OFFSET(0x19FD2C70)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_SETROOT_OFFSET UNITYSDK_OFFSET(0x19FD0120)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_SETSCANINTERACTIVEVISIBLE_OFFSET UNITYSDK_OFFSET(0x19FD23F0)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_SETSINGLEPROGRESSVISIBLE_OFFSET UNITYSDK_OFFSET(0x19FD42D0)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_SETTIPSVISIBLE_OFFSET UNITYSDK_OFFSET(0x19FCFAE0)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_SHOULDSHOWTIPS_OFFSET UNITYSDK_OFFSET(0x19FD3E50)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_STOPINTERACTAUDIO_OFFSET UNITYSDK_OFFSET(0x19FD0AA0)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_TRYCACHESUBSYSTEM_OFFSET UNITYSDK_OFFSET(0x19FD2B90)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_TRYPLAYPROGRESSANIMATION_OFFSET UNITYSDK_OFFSET(0x19FD4950)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_TRYPLAYROOTFADE_OFFSET UNITYSDK_OFFSET(0x19FD25A0)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_TRYPLAYTIPSANIMATION_OFFSET UNITYSDK_OFFSET(0x19FD4000)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_UPDATEDISPLAYSTATE_OFFSET UNITYSDK_OFFSET(0x19FD1370)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER_UPDATEINTERACTAUDIO_OFFSET UNITYSDK_OFFSET(0x19FD3770)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19FD53A0)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER__SETFOCUSDECORATIONVISIBLE_B__35_0_OFFSET UNITYSDK_OFFSET(0x19FD53E0)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER__SETSCANINTERACTIVEVISIBLE_B__38_0_OFFSET UNITYSDK_OFFSET(0x19FD5410)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER__SETTIPSVISIBLE_B__34_0_OFFSET UNITYSDK_OFFSET(0x19FD53B0)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19FD5440)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19FD54D0)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x19FD54E0)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER___BASE_ONPREPAREHIDE_OFFSET UNITYSDK_OFFSET(0x19FD5570)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19FD5580)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19FD5590)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19FD55A0)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER___BASE_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x19FD5630)
#define MOLEMOLE_UIHACKINTERACTPOINTCHILDWINDOWCONTROLLER___BASE_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x19FD5640)

namespace MoleMole
{
	inline static constexpr unsigned int UIHackInteractPointChildWindowController_TypeDefinitionIndex = 50747;
	...
	public:
		...
		::Class_2_79F6D62CE30E3F8E_91* _view; // 0x318
