...
#define MOLEMOLE_UIURBANMAPRIGHSHOPROWIMAGEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x157C6480)
#define MOLEMOLE_UIURBANMAPRIGHSHOPROWIMAGEWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x157C64F0)
#define MOLEMOLE_UIURBANMAPRIGHSHOPROWIMAGEWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x157C65B0)
#define MOLEMOLE_UIURBANMAPRIGHSHOPROWIMAGEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x157C6780)
#define MOLEMOLE_UIURBANMAPRIGHSHOPROWIMAGEWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x157C67E0)
#define MOLEMOLE_UIURBANMAPRIGHSHOPROWIMAGEWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x157C6880)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapRighShopRowImageWidgetController_TypeDefinitionIndex = 65143;
