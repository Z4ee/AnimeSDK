...
#define MOLEMOLE_UICOMMENTLEVELWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x193736C0)
#define MOLEMOLE_UICOMMENTLEVELWIDGETCONTROLLER_ONSCROLLVIEWSELECTHANDLE_OFFSET UNITYSDK_OFFSET(0x193737D0)
#define MOLEMOLE_UICOMMENTLEVELWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x19373390)
#define MOLEMOLE_UICOMMENTLEVELWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19373750)
#define MOLEMOLE_UICOMMENTLEVELWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19373130)
#define MOLEMOLE_UICOMMENTLEVELWIDGETCONTROLLER_SETPARENTPAGE_OFFSET UNITYSDK_OFFSET(0x193739C0)
#define MOLEMOLE_UICOMMENTLEVELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19373A10)
#define MOLEMOLE_UICOMMENTLEVELWIDGETCONTROLLER__ONSHOW_B__5_0_OFFSET UNITYSDK_OFFSET(0x19373AC0)
#define MOLEMOLE_UICOMMENTLEVELWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19373C00)
#define MOLEMOLE_UICOMMENTLEVELWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x19373C90)
#define MOLEMOLE_UICOMMENTLEVELWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19373D30)
#define MOLEMOLE_UICOMMENTLEVELWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19373DC0)

namespace MoleMole
{
	inline static constexpr unsigned int UICommentLevelWidgetController_TypeDefinitionIndex = 72110;

	class UICommentLevelWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_FBB8E5C056021DB6_7* _view; // 0x2C0
