...
#define MOLEMOLE_UILIVEHOUSEPAGECONTROLLER_ADDCONSOLEINPUTACTIONS_OFFSET UNITYSDK_OFFSET(0x15006CD0)
#define MOLEMOLE_UILIVEHOUSEPAGECONTROLLER_ADDMOBILEINPUTACTIONS_OFFSET UNITYSDK_OFFSET(0x15006A90)
#define MOLEMOLE_UILIVEHOUSEPAGECONTROLLER_ADDPCINPUTACTIONS_OFFSET UNITYSDK_OFFSET(0x15006B20)
#define MOLEMOLE_UILIVEHOUSEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15006750)
#define MOLEMOLE_UILIVEHOUSEPAGECONTROLLER_GET__GAMEPLAYMANGER_OFFSET UNITYSDK_OFFSET(0x150067D0)
#define MOLEMOLE_UILIVEHOUSEPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15006760)
#define MOLEMOLE_UILIVEHOUSEPAGECONTROLLER_ONAPPLICATIONFOCUS_OFFSET UNITYSDK_OFFSET(0x15008140)
#define MOLEMOLE_UILIVEHOUSEPAGECONTROLLER_ONAPPLICATIONPAUSE_OFFSET UNITYSDK_OFFSET(0x15008070)
#define MOLEMOLE_UILIVEHOUSEPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15006840)
#define MOLEMOLE_UILIVEHOUSEPAGECONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x15007B20)
#define MOLEMOLE_UILIVEHOUSEPAGECONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x150077F0)
#define MOLEMOLE_UILIVEHOUSEPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x15007BB0)
#define MOLEMOLE_UILIVEHOUSEPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15007780)
#define MOLEMOLE_UILIVEHOUSEPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x15007850)
#define MOLEMOLE_UILIVEHOUSEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x150068E0)
#define MOLEMOLE_UILIVEHOUSEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x150070F0)
#define MOLEMOLE_UILIVEHOUSEPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x15008190)
#define MOLEMOLE_UILIVEHOUSEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x150082E0)
#define MOLEMOLE_UILIVEHOUSEPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x150082F0)
#define MOLEMOLE_UILIVEHOUSEPAGECONTROLLER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x15008390)
#define MOLEMOLE_UILIVEHOUSEPAGECONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x150083A0)
#define MOLEMOLE_UILIVEHOUSEPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x15008430)
#define MOLEMOLE_UILIVEHOUSEPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15008460)
#define MOLEMOLE_UILIVEHOUSEPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x15008500)
#define MOLEMOLE_UILIVEHOUSEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15008510)
#define MOLEMOLE_UILIVEHOUSEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15008520)

namespace MoleMole
{
	inline static constexpr unsigned int UILiveHousePageController_TypeDefinitionIndex = 50729;

	class UILiveHousePageController : public ::MoleMole::UIMainCityStorePageController
	{
	public:
		::Class_2_941A638742843CB5* _model; // 0x320
		::MoleMole::UILiveHousePageController_Context* _context; // 0x328
