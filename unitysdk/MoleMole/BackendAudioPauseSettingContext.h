...
#define MOLEMOLE_BACKENDAUDIOPAUSESETTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xFAE2F60)

namespace MoleMole
{
	inline static constexpr unsigned int BackendAudioPauseSettingContext_TypeDefinitionIndex = 76357;
