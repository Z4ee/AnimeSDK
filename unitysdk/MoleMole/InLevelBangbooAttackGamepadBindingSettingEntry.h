...
#define MOLEMOLE_INLEVELBANGBOOATTACKGAMEPADBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x15134390)
#define MOLEMOLE_INLEVELBANGBOOATTACKGAMEPADBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x151343A0)
#define MOLEMOLE_INLEVELBANGBOOATTACKGAMEPADBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x151343B0)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelBangbooAttackGamepadBindingSettingEntry_TypeDefinitionIndex = 72413;
