...
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER_EXITPREPPAGE_OFFSET UNITYSDK_OFFSET(0x192B6460)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER_INITFIRSTSELECTLEVEL_OFFSET UNITYSDK_OFFSET(0x192B5750)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER_INITRIGHTREWARDROW_OFFSET UNITYSDK_OFFSET(0x192B4610)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER_ONCLICKROLEITEM_OFFSET UNITYSDK_OFFSET(0x192B5B80)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER_ONCLICKROLESELECT_OFFSET UNITYSDK_OFFSET(0x192B61C0)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x192B5ED0)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x192B5FE0)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x192B5F60)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x192B53D0)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x192B5440)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER_REFRESHDESC_OFFSET UNITYSDK_OFFSET(0x192B4D60)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER_REFRESHTARGETDATELEVEL_OFFSET UNITYSDK_OFFSET(0x192B4770)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER_RESETCLICKMASK_OFFSET UNITYSDK_OFFSET(0x192B65F0)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x192B6640)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x192B6710)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER___BASE_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x192B67A0)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x192B6890)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x192B6920)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x192B69B0)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaInviteRoleWidgetController_TypeDefinitionIndex = 60793;

	class UICinemaInviteRoleWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::System::Collections::Generic::List_1<::MoleMole::UICinemaRewardLevelRowWidgetController*>* levelRowList; // 0x2C0
		::Il2CppArray<::Enum_3_77ADBA378EFC2D41>* pointLevels; // 0x2C8
		::Class_2_FEC40CC23204DEDF* _view; // 0x2D0
		::MoleMole::UICinemaInvitePageController* parentPageController; // 0x2D8
		::System::Boolean clickRoleMask; // 0x2E0
