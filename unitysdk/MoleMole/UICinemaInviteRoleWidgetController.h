...
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER_EXITPREPPAGE_OFFSET UNITYSDK_OFFSET(0x17F63FD0)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER_INITFIRSTSELECTLEVEL_OFFSET UNITYSDK_OFFSET(0x17F632D0)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER_INITRIGHTREWARDROW_OFFSET UNITYSDK_OFFSET(0x17F621B0)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER_ONCLICKROLEITEM_OFFSET UNITYSDK_OFFSET(0x17F63700)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER_ONCLICKROLESELECT_OFFSET UNITYSDK_OFFSET(0x17F63D30)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17F63A50)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x17F63B60)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17F63AE0)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17F62F50)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17F62FC0)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER_REFRESHDESC_OFFSET UNITYSDK_OFFSET(0x17F628D0)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER_REFRESHTARGETDATELEVEL_OFFSET UNITYSDK_OFFSET(0x17F62310)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER_RESETCLICKMASK_OFFSET UNITYSDK_OFFSET(0x17F64160)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17F641B0)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17F64280)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER___BASE_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x17F64310)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17F64400)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17F64490)
#define MOLEMOLE_UICINEMAINVITEROLEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17F64520)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaInviteRoleWidgetController_TypeDefinitionIndex = 62937;
