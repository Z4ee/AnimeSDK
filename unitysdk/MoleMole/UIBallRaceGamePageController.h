...
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER_GET_UICURSORHIDESTATE_OFFSET UNITYSDK_OFFSET(0x16ED49B0)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x16ED4910)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16ED4920)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER_ONINITMINIWORLD_OFFSET UNITYSDK_OFFSET(0x16ED4CC0)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x16ED4AF0)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16ED4A80)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16ED49C0)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16ED4A10)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16ED4D10)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16ED4D20)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x16ED4DB0)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16ED4DE0)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16ED4DF0)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x16ED4E00)

namespace MoleMole
{
	inline static constexpr unsigned int UIBallRaceGamePageController_TypeDefinitionIndex = 79838;

	class UIBallRaceGamePageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_60638234271CCDB8_53* _view; // 0x318
