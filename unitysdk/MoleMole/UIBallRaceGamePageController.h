...
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER_GET_UICURSORHIDESTATE_OFFSET UNITYSDK_OFFSET(0x1563A9D0)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1563A930)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1563A940)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER_ONINITMINIWORLD_OFFSET UNITYSDK_OFFSET(0x1563ACE0)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1563AB10)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1563AAA0)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1563A9E0)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1563AA30)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1563AD30)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1563AD40)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1563ADD0)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1563AE00)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1563AE10)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1563AE20)

namespace MoleMole
{
	inline static constexpr unsigned int UIBallRaceGamePageController_TypeDefinitionIndex = 52896;

	class UIBallRaceGamePageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_60638234271CCDB8_83* _view; // 0x310
		...
		{
			return ((::Enum_3_92EDBC2AD8437DA6(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER_GET_UICURSORHIDESTATE_OFFSET))(this);
		}
