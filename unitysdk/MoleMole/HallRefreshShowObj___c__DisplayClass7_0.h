...
#define MOLEMOLE_HALLREFRESHSHOWOBJ___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0x11755E30)
#define MOLEMOLE_HALLREFRESHSHOWOBJ___C__DISPLAYCLASS7_0__ONPROCESS_B__6_OFFSET UNITYSDK_OFFSET(0x11756000)
#define MOLEMOLE_HALLREFRESHSHOWOBJ___C__DISPLAYCLASS7_0__ONPROCESS_G__ALLOCATELIST_4_OFFSET UNITYSDK_OFFSET(0x11756070)
#define MOLEMOLE_HALLREFRESHSHOWOBJ___C__DISPLAYCLASS7_0__ONPROCESS_G__CHANGETIME_2_OFFSET UNITYSDK_OFFSET(0x117584F0)
#define MOLEMOLE_HALLREFRESHSHOWOBJ___C__DISPLAYCLASS7_0__ONPROCESS_G__CHANGE_1_OFFSET UNITYSDK_OFFSET(0x11756110)
#define MOLEMOLE_HALLREFRESHSHOWOBJ___C__DISPLAYCLASS7_0__ONPROCESS_G__DEALLOCATELIST_5_OFFSET UNITYSDK_OFFSET(0x117586C0)
#define MOLEMOLE_HALLREFRESHSHOWOBJ___C__DISPLAYCLASS7_0__ONPROCESS_G__REGISTERAVATARSETPOSITION_0_OFFSET UNITYSDK_OFFSET(0x11755E40)

namespace MoleMole
{
	inline static constexpr unsigned int HallRefreshShowObj___c__DisplayClass7_0_TypeDefinitionIndex = 72029;

	class HallRefreshShowObj___c__DisplayClass7_0 : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::Class_3_06B506F3349584D7*>* hideList; // 0x10
		::System::Collections::Generic::List_1<::Class_3_06B506F3349584D7*>* delList; // 0x18
		::System::Collections::Generic::List_1<::Class_3_06B506F3349584D7*>* showList; // 0x20
		::Class_2_B7F42AAEE22538C5* hallScene; // 0x28
		::Class_2_371D7DE9D8405613* localHallScene; // 0x30
		::MoleMole::HallRefreshShowObj* __4__this; // 0x38
		::System::Collections::Generic::List_1<::Class_3_06B506F3349584D7*>* addList; // 0x40
		::System::Collections::Generic::List_1<::Class_3_06B506F3349584D7*>* interactList; // 0x48
