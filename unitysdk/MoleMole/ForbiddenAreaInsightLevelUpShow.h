...
#define MOLEMOLE_FORBIDDENAREAINSIGHTLEVELUPSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x149E90C0)
#define MOLEMOLE_FORBIDDENAREAINSIGHTLEVELUPSHOW_INITIGNOREPOPCTRL_OFFSET UNITYSDK_OFFSET(0x149E9150)
#define MOLEMOLE_FORBIDDENAREAINSIGHTLEVELUPSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x149E91A0)
#define MOLEMOLE_FORBIDDENAREAINSIGHTLEVELUPSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x149E90D0)

namespace MoleMole
{
	inline static constexpr unsigned int ForbiddenAreaInsightLevelUpShow_TypeDefinitionIndex = 61405;
