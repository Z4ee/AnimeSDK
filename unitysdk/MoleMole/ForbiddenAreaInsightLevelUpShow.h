...
#define MOLEMOLE_FORBIDDENAREAINSIGHTLEVELUPSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x16D47CA0)
#define MOLEMOLE_FORBIDDENAREAINSIGHTLEVELUPSHOW_INITIGNOREPOPCTRL_OFFSET UNITYSDK_OFFSET(0x16D47D30)
#define MOLEMOLE_FORBIDDENAREAINSIGHTLEVELUPSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x16D47D80)
#define MOLEMOLE_FORBIDDENAREAINSIGHTLEVELUPSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x16D47CB0)

namespace MoleMole
{
	inline static constexpr unsigned int ForbiddenAreaInsightLevelUpShow_TypeDefinitionIndex = 63523;

	class ForbiddenAreaInsightLevelUpShow : public ::MoleMole::DisplayMessageBase
	{
	public:
		::System::UInt32 LastInsight; // 0x28
		::System::UInt32 NewInsight; // 0x2C
