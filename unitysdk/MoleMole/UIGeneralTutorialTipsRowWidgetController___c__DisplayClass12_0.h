...
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER___C__DISPLAYCLASS12_0__CLOSEWIDGETWITHFADE_B__0_OFFSET UNITYSDK_OFFSET(0x18818DE0)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER___C__DISPLAYCLASS12_0__CLOSEWIDGETWITHFADE_B__1_OFFSET UNITYSDK_OFFSET(0x18819080)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER___C__DISPLAYCLASS12_0__CLOSEWIDGETWITHFADE_B__2_OFFSET UNITYSDK_OFFSET(0x18819090)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER___C__DISPLAYCLASS12_0__CLOSEWIDGETWITHFADE_B__3_OFFSET UNITYSDK_OFFSET(0x188190A0)
#define MOLEMOLE_UIGENERALTUTORIALTIPSROWWIDGETCONTROLLER___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18817A90)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralTutorialTipsRowWidgetController___c__DisplayClass12_0_TypeDefinitionIndex = 72009;

	class UIGeneralTutorialTipsRowWidgetController___c__DisplayClass12_0 : public ::System::Object
	{
	public:
		::DG::Tweening::TweenCallback* __9__3; // 0x10
