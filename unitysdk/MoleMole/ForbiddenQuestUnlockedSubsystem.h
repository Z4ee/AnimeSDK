...
#define MOLEMOLE_FORBIDDENQUESTUNLOCKEDSUBSYSTEM_GET_CURRENTTEMPLATE_OFFSET UNITYSDK_OFFSET(0x10BB9F50)
#define MOLEMOLE_FORBIDDENQUESTUNLOCKEDSUBSYSTEM_INITDATA_OFFSET UNITYSDK_OFFSET(0x10BBA0F0)
#define MOLEMOLE_FORBIDDENQUESTUNLOCKEDSUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x10BB9F70)
#define MOLEMOLE_FORBIDDENQUESTUNLOCKEDSUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x10BBA300)
#define MOLEMOLE_FORBIDDENQUESTUNLOCKEDSUBSYSTEM_ONQUESTADD_OFFSET UNITYSDK_OFFSET(0x10BBA480)
#define MOLEMOLE_FORBIDDENQUESTUNLOCKEDSUBSYSTEM_SET_CURRENTTEMPLATE_OFFSET UNITYSDK_OFFSET(0x10BB9F60)
#define MOLEMOLE_FORBIDDENQUESTUNLOCKEDSUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x10BBA640)
#define MOLEMOLE_FORBIDDENQUESTUNLOCKEDSUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x10BBA660)
#define MOLEMOLE_FORBIDDENQUESTUNLOCKEDSUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x10BBA6F0)

namespace MoleMole
{
	inline static constexpr unsigned int ForbiddenQuestUnlockedSubsystem_TypeDefinitionIndex = 80029;
