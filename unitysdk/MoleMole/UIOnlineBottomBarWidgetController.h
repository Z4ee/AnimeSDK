...
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_BUILDDATABINDING_OFFSET UNITYSDK_OFFSET(0x15DD3BD0)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x15DD3850)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15DD3740)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15DD37D0)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15DD3620)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15DD36D0)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_REFRESHAIDINGVIEW_OFFSET UNITYSDK_OFFSET(0x15DD40E0)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_REFRESHPROGRESS_OFFSET UNITYSDK_OFFSET(0x15DD4370)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_SETUPAVATARICON_OFFSET UNITYSDK_OFFSET(0x15DD3DE0)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_SETUPENTITY_OFFSET UNITYSDK_OFFSET(0x15DD3910)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER__BUILDDATABINDING_B__20_0_OFFSET UNITYSDK_OFFSET(0x15DD4720)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x15DD46C0)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15DD4600)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x15DD4B00)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15DD4B90)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15DD4C20)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15DD4CB0)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15DD4D40)

namespace MoleMole
{
	inline static constexpr unsigned int UIOnlineBottomBarWidgetController_TypeDefinitionIndex = 77332;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIOnlineBottomBarWidgetController_TypeDefinitionIndex)->GetStaticField(0xE710);
		}
		static ::System::Int32* StaticGet_EndColorShaderParamID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIOnlineBottomBarWidgetController_TypeDefinitionIndex)->GetStaticField(0xE714);
		}
		static ::System::Int32* StaticGet_StartColorShaderParamID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIOnlineBottomBarWidgetController_TypeDefinitionIndex)->GetStaticField(0xE718);
		}
		::Class_2_0DF21ECD13E1233B* _view; // 0x2B8
		...
		::UnityEngine::Color _beingRevivedStartColor; // 0x2E4
		::UnityEngine::Color _beingRevivedEndColor; // 0x2F4
		::UnityEngine::Color _beingRevivedPatternColor; // 0x304
		::System::Single ReviveWidth; // 0x314
