...
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_BUILDDATABINDING_OFFSET UNITYSDK_OFFSET(0x12FD5BC0)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x12FD5830)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12FD5720)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12FD57B0)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12FD5600)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12FD56B0)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_REFRESHAIDINGVIEW_OFFSET UNITYSDK_OFFSET(0x12FD6080)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_REFRESHPROGRESS_OFFSET UNITYSDK_OFFSET(0x12FD6320)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_SETUPAVATARICON_OFFSET UNITYSDK_OFFSET(0x12FD5DD0)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_SETUPENTITY_OFFSET UNITYSDK_OFFSET(0x12FD58F0)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER__BUILDDATABINDING_B__20_0_OFFSET UNITYSDK_OFFSET(0x12FD66C0)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x12FD6660)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12FD65A0)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x12FD6AA0)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12FD6B30)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12FD6BC0)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12FD6C50)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12FD6CE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIOnlineBottomBarWidgetController_TypeDefinitionIndex = 82109;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIOnlineBottomBarWidgetController_TypeDefinitionIndex)->GetStaticField(0x12970);
		}
		static ::System::Int32* StaticGet_StartColorShaderParamID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIOnlineBottomBarWidgetController_TypeDefinitionIndex)->GetStaticField(0x12974);
		}
		static ::System::Int32* StaticGet_EndColorShaderParamID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIOnlineBottomBarWidgetController_TypeDefinitionIndex)->GetStaticField(0x12978);
		}
