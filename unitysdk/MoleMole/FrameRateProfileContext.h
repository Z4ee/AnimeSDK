...
#define MOLEMOLE_FRAMERATEPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x149A3D40)

namespace MoleMole
{
	inline static constexpr unsigned int FrameRateProfileContext_TypeDefinitionIndex = 60307;
