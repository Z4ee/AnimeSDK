...
#define MOLEMOLE_UITOWERBANGBOOITEMWIDGETCONTROLLER_TOWERBANGBOOITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x10EF7430)

namespace MoleMole
{
	inline static constexpr unsigned int UITowerBangbooItemWidgetController_TowerBangbooItem_TypeDefinitionIndex = 77077;
