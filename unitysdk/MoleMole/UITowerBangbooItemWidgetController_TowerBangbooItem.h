...
#define MOLEMOLE_UITOWERBANGBOOITEMWIDGETCONTROLLER_TOWERBANGBOOITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x14DDA8D0)

namespace MoleMole
{
	inline static constexpr unsigned int UITowerBangbooItemWidgetController_TowerBangbooItem_TypeDefinitionIndex = 69582;
	...
	public:
		...
		::System::Int32 bangbooid; // 0x1C
		::System::Int32 towerDefenseBuddyID; // 0x20
