...
#define MOLEMOLE_UIRABSTAGEPREVIEWROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16904B80)
#define MOLEMOLE_UIRABSTAGEPREVIEWROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16904C90)
#define MOLEMOLE_UIRABSTAGEPREVIEWROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16904C10)
#define MOLEMOLE_UIRABSTAGEPREVIEWROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16904B20)
#define MOLEMOLE_UIRABSTAGEPREVIEWROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16904E80)
#define MOLEMOLE_UIRABSTAGEPREVIEWROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16904E90)
#define MOLEMOLE_UIRABSTAGEPREVIEWROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16904F20)
#define MOLEMOLE_UIRABSTAGEPREVIEWROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16904FC0)
#define MOLEMOLE_UIRABSTAGEPREVIEWROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16905050)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABStagePreviewRowWidgetController_TypeDefinitionIndex = 76950;
