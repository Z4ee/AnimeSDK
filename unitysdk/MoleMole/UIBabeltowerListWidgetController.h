...
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER_HIDEALL_OFFSET UNITYSDK_OFFSET(0x152E49B0)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER_ONBABELTOWERFLOORFINISHANIMATION_OFFSET UNITYSDK_OFFSET(0x152E40E0)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x152E3A40)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x152E55C0)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x152E3B50)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER_ONSHOWBABELTOWERUNLOCK_OFFSET UNITYSDK_OFFSET(0x152E3FD0)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x152E3AD0)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x152E37D0)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x152E3930)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x152E3C60)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER_SETCLICKFUNC_OFFSET UNITYSDK_OFFSET(0x152E56F0)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER_UPDATEFLOOR_OFFSET UNITYSDK_OFFSET(0x152E4CB0)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER_UPDATEOFFSET_OFFSET UNITYSDK_OFFSET(0x152E52E0)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x152E5740)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER__REFRESHNORMALVIEW_OFFSET UNITYSDK_OFFSET(0x152E43F0)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x152E5940)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x152E59D0)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x152E5A60)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x152E5B00)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x152E5B90)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x152E5C20)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerListWidgetController_TypeDefinitionIndex = 45972;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_99* _view; // 0x2E8
		::System::UInt32 currentFloor; // 0x2F0
		::System::Boolean isSpecial; // 0x2F4
		::Class_2_08E43914789BE5F3* model; // 0x2F8
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::String*>* rankPic; // 0x300
		::System::Action_3<::System::UInt32, ::System::UInt32, ::System::Int32>* onClick; // 0x308
		::System::Int32 floorID; // 0x310
		::System::Int32 towerID; // 0x314
		::System::Boolean isUnlimitSymbol; // 0x318
