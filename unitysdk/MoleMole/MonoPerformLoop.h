...
#define MOLEMOLE_MONOPERFORMLOOP_AWAKE_OFFSET UNITYSDK_OFFSET(0x11640250)
#define MOLEMOLE_MONOPERFORMLOOP_START_OFFSET UNITYSDK_OFFSET(0x116403C0)
#define MOLEMOLE_MONOPERFORMLOOP_UPDATE_OFFSET UNITYSDK_OFFSET(0x116402A0)
#define MOLEMOLE_MONOPERFORMLOOP__CTOR_OFFSET UNITYSDK_OFFSET(0x11640400)

namespace MoleMole
{
	inline static constexpr unsigned int MonoPerformLoop_TypeDefinitionIndex = 74633;
