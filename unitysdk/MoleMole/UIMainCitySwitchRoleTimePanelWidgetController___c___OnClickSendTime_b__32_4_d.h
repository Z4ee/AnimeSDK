...
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER___C___ONCLICKSENDTIME_B__32_4_D_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x82EE20)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER___C___ONCLICKSENDTIME_B__32_4_D_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x283610)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCitySwitchRoleTimePanelWidgetController___c___OnClickSendTime_b__32_4_d_TypeDefinitionIndex = 78547;
