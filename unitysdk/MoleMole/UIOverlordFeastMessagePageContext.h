...
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xEB79990)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastMessagePageContext_TypeDefinitionIndex = 51491;
