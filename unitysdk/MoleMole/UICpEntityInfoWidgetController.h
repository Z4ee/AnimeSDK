...
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1F7897E0)
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1F789870)
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1F7896F0)
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1F789760)
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER_UPDATEDATA_OFFSET UNITYSDK_OFFSET(0x1F789900)
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F789D90)
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1F789DF0)
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1F789E80)
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1F789F10)
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1F789FA0)

namespace MoleMole
{
	inline static constexpr unsigned int UICpEntityInfoWidgetController_TypeDefinitionIndex = 94850;
