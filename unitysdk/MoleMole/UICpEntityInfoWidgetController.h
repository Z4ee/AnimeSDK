...
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1AEC8680)
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1AEC8710)
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1AEC8590)
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1AEC8600)
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER_UPDATEDATA_OFFSET UNITYSDK_OFFSET(0x1AEC87A0)
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEC8C10)
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1AEC8C70)
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1AEC8D00)
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1AEC8D90)
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1AEC8E20)

namespace MoleMole
{
	inline static constexpr unsigned int UICpEntityInfoWidgetController_TypeDefinitionIndex = 85367;

	class UICpEntityInfoWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_C9DDE9730C6BE395_10* _view; // 0x2B8
