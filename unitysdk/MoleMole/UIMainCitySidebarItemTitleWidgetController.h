...
class Class_2_3CE902158D332CDC;
namespace MoleMole { class UIControlReference; }
namespace System { class Object; }

#define MOLEMOLE_UIMAINCITYSIDEBARITEMTITLEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15744D00)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMTITLEWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15744DD0)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMTITLEWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15744E90)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMTITLEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15744D70)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMTITLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15745040)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMTITLEWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15745050)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMTITLEWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x157450F0)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMTITLEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15745190)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCitySidebarItemTitleWidgetController_TypeDefinitionIndex = 73829;
	...
	public:
		...
		::Class_2_3CE902158D332CDC* get__viewModel()
		{
			return ((::Class_2_3CE902158D332CDC*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYSIDEBARITEMTITLEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
