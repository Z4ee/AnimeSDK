...
#define MOLEMOLE_UIMAINCITYSIDEBARITEMTITLEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17AEA0E0)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMTITLEWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17AEA1B0)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMTITLEWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17AEA270)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMTITLEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17AEA150)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMTITLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17AEA420)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMTITLEWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x17AEA430)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMTITLEWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17AEA4D0)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMTITLEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17AEA570)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCitySidebarItemTitleWidgetController_TypeDefinitionIndex = 46115;
