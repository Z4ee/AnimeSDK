...
#define MOLEMOLE_SERVERLISTINFO_GETSERVERHOST_OFFSET UNITYSDK_OFFSET(0x1585CCD0)
#define MOLEMOLE_SERVERLISTINFO_GETSERVERNAME_OFFSET UNITYSDK_OFFSET(0x1585CC50)
#define MOLEMOLE_SERVERLISTINFO_GETSERVERTITLE_OFFSET UNITYSDK_OFFSET(0x1585CC90)
#define MOLEMOLE_SERVERLISTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1585CE50)

namespace MoleMole
{
	inline static constexpr unsigned int ServerListInfo_TypeDefinitionIndex = 42388;
