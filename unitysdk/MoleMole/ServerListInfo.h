...
#define MOLEMOLE_SERVERLISTINFO_GETSERVERHOST_OFFSET UNITYSDK_OFFSET(0x1642CCA0)
#define MOLEMOLE_SERVERLISTINFO_GETSERVERNAME_OFFSET UNITYSDK_OFFSET(0x1642CC20)
#define MOLEMOLE_SERVERLISTINFO_GETSERVERTITLE_OFFSET UNITYSDK_OFFSET(0x1642CC60)
#define MOLEMOLE_SERVERLISTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1642CE20)

namespace MoleMole
{
	inline static constexpr unsigned int ServerListInfo_TypeDefinitionIndex = 44985;
