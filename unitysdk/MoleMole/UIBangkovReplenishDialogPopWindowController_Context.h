...
#define MOLEMOLE_UIBANGKOVREPLENISHDIALOGPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x158BD4E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangkovReplenishDialogPopWindowController_Context_TypeDefinitionIndex = 53345;
	...
	public:
		...
		::System::String* HintText2; // 0x50
		::System::Boolean ShowCancelBtn; // 0x58
		::System::Boolean ShowGroup2; // 0x59
		::System::Boolean ShowGroup1; // 0x5A
