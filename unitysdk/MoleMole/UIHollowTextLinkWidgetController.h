...
#define MOLEMOLE_UIHOLLOWTEXTLINKWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1961C8B0)
#define MOLEMOLE_UIHOLLOWTEXTLINKWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1961C940)
#define MOLEMOLE_UIHOLLOWTEXTLINKWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1961C5C0)
#define MOLEMOLE_UIHOLLOWTEXTLINKWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1961C620)
#define MOLEMOLE_UIHOLLOWTEXTLINKWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1961C9C0)
#define MOLEMOLE_UIHOLLOWTEXTLINKWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1961CAA0)
#define MOLEMOLE_UIHOLLOWTEXTLINKWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1961CB30)
#define MOLEMOLE_UIHOLLOWTEXTLINKWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1961CBC0)
#define MOLEMOLE_UIHOLLOWTEXTLINKWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1961CC50)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowTextLinkWidgetController_TypeDefinitionIndex = 61886;
