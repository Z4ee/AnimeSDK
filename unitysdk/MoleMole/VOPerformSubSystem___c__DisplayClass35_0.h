...
#define MOLEMOLE_VOPERFORMSUBSYSTEM___C__DISPLAYCLASS35_0__CTOR_OFFSET UNITYSDK_OFFSET(0x156F3C40)
#define MOLEMOLE_VOPERFORMSUBSYSTEM___C__DISPLAYCLASS35_0__UPDATETIPINFO_B__0_OFFSET UNITYSDK_OFFSET(0x156F3C50)

namespace MoleMole
{
	inline static constexpr unsigned int VOPerformSubSystem___c__DisplayClass35_0_TypeDefinitionIndex = 69488;
