...
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER___C__DISPLAYCLASS14_1__CTOR_OFFSET UNITYSDK_OFFSET(0x190F01E0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER___C__DISPLAYCLASS14_1__SHOWEFFECTATPOS_B__1_OFFSET UNITYSDK_OFFSET(0x190F01F0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER___C__DISPLAYCLASS14_1__SHOWEFFECTATPOS_B__2_OFFSET UNITYSDK_OFFSET(0x190F02F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowItemCollectWidgetController___c__DisplayClass14_1_TypeDefinitionIndex = 54641;
