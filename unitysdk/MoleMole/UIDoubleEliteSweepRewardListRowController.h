...
#define MOLEMOLE_UIDOUBLEELITESWEEPREWARDLISTROWCONTROLLER_CLEARREWARDS_OFFSET UNITYSDK_OFFSET(0x186A7980)
#define MOLEMOLE_UIDOUBLEELITESWEEPREWARDLISTROWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x186A6D60)
#define MOLEMOLE_UIDOUBLEELITESWEEPREWARDLISTROWCONTROLLER_ONGAMEPADMODULESELECTINDEXFROMINPUT_OFFSET UNITYSDK_OFFSET(0x186A7B00)
#define MOLEMOLE_UIDOUBLEELITESWEEPREWARDLISTROWCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x186A6E70)
#define MOLEMOLE_UIDOUBLEELITESWEEPREWARDLISTROWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x186A6DF0)
#define MOLEMOLE_UIDOUBLEELITESWEEPREWARDLISTROWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x186A6B20)
#define MOLEMOLE_UIDOUBLEELITESWEEPREWARDLISTROWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x186A7C20)
#define MOLEMOLE_UIDOUBLEELITESWEEPREWARDLISTROWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x186A7CB0)
#define MOLEMOLE_UIDOUBLEELITESWEEPREWARDLISTROWCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEXFROMINPUT_OFFSET UNITYSDK_OFFSET(0x186A7D40)
#define MOLEMOLE_UIDOUBLEELITESWEEPREWARDLISTROWCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x186A7DF0)
#define MOLEMOLE_UIDOUBLEELITESWEEPREWARDLISTROWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x186A7E90)
#define MOLEMOLE_UIDOUBLEELITESWEEPREWARDLISTROWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x186A7F20)

namespace MoleMole
{
	inline static constexpr unsigned int UIDoubleEliteSweepRewardListRowController_TypeDefinitionIndex = 64025;
