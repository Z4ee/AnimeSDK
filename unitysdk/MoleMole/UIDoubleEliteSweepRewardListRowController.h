...
#define MOLEMOLE_UIDOUBLEELITESWEEPREWARDLISTROWCONTROLLER_CLEARREWARDS_OFFSET UNITYSDK_OFFSET(0x17706740)
#define MOLEMOLE_UIDOUBLEELITESWEEPREWARDLISTROWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17705B40)
#define MOLEMOLE_UIDOUBLEELITESWEEPREWARDLISTROWCONTROLLER_ONGAMEPADMODULESELECTINDEXFROMINPUT_OFFSET UNITYSDK_OFFSET(0x177068C0)
#define MOLEMOLE_UIDOUBLEELITESWEEPREWARDLISTROWCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17705C50)
#define MOLEMOLE_UIDOUBLEELITESWEEPREWARDLISTROWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17705BD0)
#define MOLEMOLE_UIDOUBLEELITESWEEPREWARDLISTROWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17705900)
#define MOLEMOLE_UIDOUBLEELITESWEEPREWARDLISTROWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x177069E0)
#define MOLEMOLE_UIDOUBLEELITESWEEPREWARDLISTROWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17706A70)
#define MOLEMOLE_UIDOUBLEELITESWEEPREWARDLISTROWCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEXFROMINPUT_OFFSET UNITYSDK_OFFSET(0x17706B00)
#define MOLEMOLE_UIDOUBLEELITESWEEPREWARDLISTROWCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17706BB0)
#define MOLEMOLE_UIDOUBLEELITESWEEPREWARDLISTROWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17706C50)
#define MOLEMOLE_UIDOUBLEELITESWEEPREWARDLISTROWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17706CE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIDoubleEliteSweepRewardListRowController_TypeDefinitionIndex = 53466;
	...
	public:
		...
		::System::Boolean _bSetDefaultSelect; // 0x2F8
