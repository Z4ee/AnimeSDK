...
#define MOLEMOLE_HOLLOWCARDOPTIONITEMWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x19BF61B0)

namespace MoleMole
{
	inline static constexpr unsigned int HollowCardOptionItemWidgetContext_TypeDefinitionIndex = 70585;
