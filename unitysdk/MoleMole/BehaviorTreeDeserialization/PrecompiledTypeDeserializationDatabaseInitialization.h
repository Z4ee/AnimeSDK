...
#define MOLEMOLE_BEHAVIORTREEDESERIALIZATION_PRECOMPILEDTYPEDESERIALIZATIONDATABASEINITIALIZATION_METHOD_1_9E86D16B476C4CAF_OFFSET UNITYSDK_OFFSET(0x1B446A10)
#define MOLEMOLE_BEHAVIORTREEDESERIALIZATION_PRECOMPILEDTYPEDESERIALIZATIONDATABASEINITIALIZATION_METHOD_1_A33108F24FD72EA4_OFFSET UNITYSDK_OFFSET(0x1B446A30)
#define MOLEMOLE_BEHAVIORTREEDESERIALIZATION_PRECOMPILEDTYPEDESERIALIZATIONDATABASEINITIALIZATION_SETPRECOMPILEDTYPEDESERIALIZATIONDATABASEINITIALIZER_OFFSET UNITYSDK_OFFSET(0x1B4469B0)

namespace MoleMole::BehaviorTreeDeserialization
{
	inline static constexpr unsigned int PrecompiledTypeDeserializationDatabaseInitialization_TypeDefinitionIndex = 89897;
