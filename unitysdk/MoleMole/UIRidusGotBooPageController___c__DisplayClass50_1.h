...
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER___C__DISPLAYCLASS50_1__CTOR_OFFSET UNITYSDK_OFFSET(0x12E1AA30)
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER___C__DISPLAYCLASS50_1__UPDATEFEVERSCORE_B__1_OFFSET UNITYSDK_OFFSET(0x12E1AA40)
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER___C__DISPLAYCLASS50_1__UPDATEFEVERSCORE_B__2_OFFSET UNITYSDK_OFFSET(0x12E1AA70)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooPageController___c__DisplayClass50_1_TypeDefinitionIndex = 75558;
