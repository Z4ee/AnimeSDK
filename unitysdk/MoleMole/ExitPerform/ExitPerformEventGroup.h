...
#define MOLEMOLE_EXITPERFORM_EXITPERFORMEVENTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A018AF0)

namespace MoleMole::ExitPerform
{
	inline static constexpr unsigned int ExitPerformEventGroup_TypeDefinitionIndex = 44790;
