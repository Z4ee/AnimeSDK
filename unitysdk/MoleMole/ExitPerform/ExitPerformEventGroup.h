...
#define MOLEMOLE_EXITPERFORM_EXITPERFORMEVENTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x18200F90)

namespace MoleMole::ExitPerform
{
	inline static constexpr unsigned int ExitPerformEventGroup_TypeDefinitionIndex = 79781;
