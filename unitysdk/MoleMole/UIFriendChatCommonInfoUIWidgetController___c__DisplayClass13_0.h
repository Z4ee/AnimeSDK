...
#define MOLEMOLE_UIFRIENDCHATCOMMONINFOUIWIDGETCONTROLLER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x177DC160)
#define MOLEMOLE_UIFRIENDCHATCOMMONINFOUIWIDGETCONTROLLER___C__DISPLAYCLASS13_0__INITCIRCLEPLAYERINFOUIVIEW_B__0_OFFSET UNITYSDK_OFFSET(0x177DC170)
#define MOLEMOLE_UIFRIENDCHATCOMMONINFOUIWIDGETCONTROLLER___C__DISPLAYCLASS13_0__INITCIRCLEPLAYERINFOUIVIEW_B__1_OFFSET UNITYSDK_OFFSET(0x177DC900)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendChatCommonInfoUIWidgetController___c__DisplayClass13_0_TypeDefinitionIndex = 44598;
