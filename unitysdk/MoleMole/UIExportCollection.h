...
#define MOLEMOLE_UIEXPORTCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x170D0590)

namespace MoleMole
{
	inline static constexpr unsigned int UIExportCollection_TypeDefinitionIndex = 40775;
