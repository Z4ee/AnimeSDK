...
class Class_2_A24715A7AC86C445;
namespace MoleMole { class MonoGamepadModule; }
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }
namespace System::Collections::Generic { template <typename T> class List_1; }

#define MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x160D0E40)
#define MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x160D0EB0)
#define MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x160D1220)
#define MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x160D13B0)
#define MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x160D0FE0)
#define MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x160D0F70)
#define MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER_TRYOVERRIDESELECTONFOCUS_OFFSET UNITYSDK_OFFSET(0x160D1140)
#define MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x160D1580)
#define MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x160D1630)
#define MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER___BASE_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x160D16D0)
#define MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x160D17C0)
#define MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x160D1850)
#define MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x160D18F0)
#define MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER___BASE_TRYOVERRIDESELECTONFOCUS_OFFSET UNITYSDK_OFFSET(0x160D1980)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCitySidebarWidgetController_TypeDefinitionIndex = 59238;

	class UIMainCitySidebarWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::System::Collections::Generic::List_1<::Struct_2_C3D2448A87C70DB6>* _addedSkinDatas; // 0x2B8
		...
		::Class_2_A24715A7AC86C445* get__viewModel()
		{
			return ((::Class_2_A24715A7AC86C445*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
