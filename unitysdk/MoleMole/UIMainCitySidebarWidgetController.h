...
#define MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15D8B7C0)
#define MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15D8B830)
#define MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x15D8BBA0)
#define MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x15D8BD30)
#define MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15D8B960)
#define MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15D8B8F0)
#define MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER_TRYOVERRIDESELECTONFOCUS_OFFSET UNITYSDK_OFFSET(0x15D8BAC0)
#define MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15D8BF00)
#define MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15D8BFB0)
#define MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER___BASE_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x15D8C050)
#define MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x15D8C140)
#define MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15D8C1D0)
#define MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15D8C270)
#define MOLEMOLE_UIMAINCITYSIDEBARWIDGETCONTROLLER___BASE_TRYOVERRIDESELECTONFOCUS_OFFSET UNITYSDK_OFFSET(0x15D8C300)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCitySidebarWidgetController_TypeDefinitionIndex = 83051;
