...
#define MOLEMOLE_MAINCITYMAPKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x16053D60)
#define MOLEMOLE_MAINCITYMAPKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x16053D70)
#define MOLEMOLE_MAINCITYMAPKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x16053D80)

namespace MoleMole
{
	inline static constexpr unsigned int MainCityMapKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 61182;
