...
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO_FINISH_OFFSET UNITYSDK_OFFSET(0x191B1CA0)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x191B1D70)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO_INIT_OFFSET UNITYSDK_OFFSET(0x191B1670)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO_RESET_OFFSET UNITYSDK_OFFSET(0x191B1740)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO_SETALPHAUPDATE_OFFSET UNITYSDK_OFFSET(0x191B1930)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x191B1D80)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO_START_OFFSET UNITYSDK_OFFSET(0x191B1790)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO_STOP_OFFSET UNITYSDK_OFFSET(0x191B19D0)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO_UPDATE_OFFSET UNITYSDK_OFFSET(0x191B1A40)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x191B1660)

namespace MoleMole
{
	inline static constexpr unsigned int MultipleVideoPlayerManager_FadeRuntimeInfo_TypeDefinitionIndex = 70085;

	class MultipleVideoPlayerManager_FadeRuntimeInfo : public ::System::Object
	{
	public:
		::System::Func_1<::System::Double>* GetCurVideoTime; // 0x10
		::System::Collections::IEnumerator* _setAlphaUpdater; // 0x18
		::System::Action_2<::System::Boolean, ::System::Single>* SetAlpha; // 0x20
		::System::Boolean _isLoop; // 0x28
		::System::Boolean _playedFadeOut; // 0x29
		::System::Boolean _IsActive_k__BackingField; // 0x2A
		::System::Boolean _playedFadeIn; // 0x2B
		::System::Single _fadeInTime; // 0x2C
		::System::Single _fadeOutTime; // 0x30
		::System::Double _curFadeTime; // 0x38
