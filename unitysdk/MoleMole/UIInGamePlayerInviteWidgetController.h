...
#define MOLEMOLE_UIINGAMEPLAYERINVITEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18147300)
#define MOLEMOLE_UIINGAMEPLAYERINVITEWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18147370)
#define MOLEMOLE_UIINGAMEPLAYERINVITEWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18147430)
#define MOLEMOLE_UIINGAMEPLAYERINVITEWIDGETCONTROLLER_UPDATEINROOMPLAYERLIST_OFFSET UNITYSDK_OFFSET(0x18147670)
#define MOLEMOLE_UIINGAMEPLAYERINVITEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18147720)
#define MOLEMOLE_UIINGAMEPLAYERINVITEWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18147780)
#define MOLEMOLE_UIINGAMEPLAYERINVITEWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18147820)

namespace MoleMole
{
	inline static constexpr unsigned int UIInGamePlayerInviteWidgetController_TypeDefinitionIndex = 68456;
