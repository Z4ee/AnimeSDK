...
#define MOLEMOLE_MONOENTITYMODELMODIFIER_CONFIGMODIFIER_GET_CONTROLPOINT_HEIGHT_OFFSET UNITYSDK_OFFSET(0x15432B50)
#define MOLEMOLE_MONOENTITYMODELMODIFIER_CONFIGMODIFIER_GET_MODELHEIGHT_OFFSET UNITYSDK_OFFSET(0x15432BC0)
#define MOLEMOLE_MONOENTITYMODELMODIFIER_CONFIGMODIFIER_GET_MODELWIDTH_OFFSET UNITYSDK_OFFSET(0x15432BB0)
#define MOLEMOLE_MONOENTITYMODELMODIFIER_CONFIGMODIFIER_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0x15432AF0)
#define MOLEMOLE_MONOENTITYMODELMODIFIER_CONFIGMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x15432BD0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEntityModelModifier_ConfigModifier_TypeDefinitionIndex = 55089;
