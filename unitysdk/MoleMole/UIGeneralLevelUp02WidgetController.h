...
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER_ALLFINISH_OFFSET UNITYSDK_OFFSET(0x169CB860)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER_GET_ISIGNOREINPUT_OFFSET UNITYSDK_OFFSET(0x169C9AF0)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x169C9B00)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER_ONINTERRUPT_OFFSET UNITYSDK_OFFSET(0x169CA510)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x169CA3C0)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x169CA340)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x169C9B90)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER_PLAYSHOWANIM_OFFSET UNITYSDK_OFFSET(0x169C9CF0)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER_REFRESHLEVELTXTVIEW_OFFSET UNITYSDK_OFFSET(0x169CA5B0)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x169C9EF0)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER_STARTPLAYLEVELNUMANIM_OFFSET UNITYSDK_OFFSET(0x169CB460)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER_TRYPLAYCLOSEAFTERANIM_OFFSET UNITYSDK_OFFSET(0x169CB160)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x169CB6C0)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x169CB8C0)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER__ONINTERRUPT_B__9_0_OFFSET UNITYSDK_OFFSET(0x169CB920)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER__TRYPLAYCLOSEAFTERANIM_B__15_0_OFFSET UNITYSDK_OFFSET(0x169CB940)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER__TRYPLAYCLOSEAFTERANIM_B__15_1_OFFSET UNITYSDK_OFFSET(0x169CB9B0)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x169CB9D0)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x169CBA60)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x169CBA70)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x169CBB00)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralLevelUp02WidgetController_TypeDefinitionIndex = 64195;
