...
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER_ALLFINISH_OFFSET UNITYSDK_OFFSET(0x186C5CC0)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER_GET_ISIGNOREINPUT_OFFSET UNITYSDK_OFFSET(0x186C3F40)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x186C3F50)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER_ONINTERRUPT_OFFSET UNITYSDK_OFFSET(0x186C4960)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x186C4810)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x186C4790)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x186C3FE0)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER_PLAYSHOWANIM_OFFSET UNITYSDK_OFFSET(0x186C4140)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER_REFRESHLEVELTXTVIEW_OFFSET UNITYSDK_OFFSET(0x186C4A00)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x186C4340)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER_STARTPLAYLEVELNUMANIM_OFFSET UNITYSDK_OFFSET(0x186C58C0)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER_TRYPLAYCLOSEAFTERANIM_OFFSET UNITYSDK_OFFSET(0x186C55C0)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x186C5B20)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x186C5D20)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER__ONINTERRUPT_B__9_0_OFFSET UNITYSDK_OFFSET(0x186C5D80)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER__TRYPLAYCLOSEAFTERANIM_B__15_0_OFFSET UNITYSDK_OFFSET(0x186C5DA0)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER__TRYPLAYCLOSEAFTERANIM_B__15_1_OFFSET UNITYSDK_OFFSET(0x186C5E10)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x186C5E30)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x186C5EC0)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x186C5ED0)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x186C5F60)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralLevelUp02WidgetController_TypeDefinitionIndex = 75469;

	class UIGeneralLevelUp02WidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_665DC60C570878D1* _view; // 0x2C0
		::System::Action* finishHandle; // 0x2C8
		::MoleMole::UIGeneralLevelUp02WidgetController_Context* _context; // 0x2D0
		::System::Boolean _currentExpFinish; // 0x2D8
		::System::Boolean _ringFinish; // 0x2D9
		::System::Single _lastAnimTIme; // 0x2DC
		::System::Int32 _curLevel; // 0x2E0
