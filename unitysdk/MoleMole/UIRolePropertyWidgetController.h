...
#define MOLEMOLE_UIROLEPROPERTYWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15211F90)
#define MOLEMOLE_UIROLEPROPERTYWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15212020)
#define MOLEMOLE_UIROLEPROPERTYWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15211EC0)
#define MOLEMOLE_UIROLEPROPERTYWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15211F20)
#define MOLEMOLE_UIROLEPROPERTYWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x152120A0)
#define MOLEMOLE_UIROLEPROPERTYWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x152120E0)
#define MOLEMOLE_UIROLEPROPERTYWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15212140)
#define MOLEMOLE_UIROLEPROPERTYWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x152121D0)
#define MOLEMOLE_UIROLEPROPERTYWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15212260)
#define MOLEMOLE_UIROLEPROPERTYWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x152122F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRolePropertyWidgetController_TypeDefinitionIndex = 68110;

	class UIRolePropertyWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_60638234271CCDB8_139* _view; // 0x2B8
