...
#define MOLEMOLE_UISTRATEGYGUIDESKILLUPDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16AC48B0)
#define MOLEMOLE_UISTRATEGYGUIDESKILLUPDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS11_0__ONMAXLEVELRECOMMENDTOGGLECLICK_B__0_OFFSET UNITYSDK_OFFSET(0x16AC48C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIStrategyGuideSkillUpDialogPopWindowController___c__DisplayClass11_0_TypeDefinitionIndex = 71253;
