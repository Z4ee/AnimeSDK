...
class Class_2_058F5595A5605292;
...
#define MOLEMOLE_UIMAINCITYREVIVALREWARDWIDGETCONTROLLER_CLEARREWARDS_OFFSET UNITYSDK_OFFSET(0x160F8ED0)
#define MOLEMOLE_UIMAINCITYREVIVALREWARDWIDGETCONTROLLER_GET_CURRENTID_OFFSET UNITYSDK_OFFSET(0x160F8450)
#define MOLEMOLE_UIMAINCITYREVIVALREWARDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x160F8580)
#define MOLEMOLE_UIMAINCITYREVIVALREWARDWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x160F8E20)
#define MOLEMOLE_UIMAINCITYREVIVALREWARDWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x160F8690)
#define MOLEMOLE_UIMAINCITYREVIVALREWARDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x160F8610)
#define MOLEMOLE_UIMAINCITYREVIVALREWARDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x160F84B0)
#define MOLEMOLE_UIMAINCITYREVIVALREWARDWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x160F8510)
#define MOLEMOLE_UIMAINCITYREVIVALREWARDWIDGETCONTROLLER_SETCLICKCB_OFFSET UNITYSDK_OFFSET(0x160F8E80)
#define MOLEMOLE_UIMAINCITYREVIVALREWARDWIDGETCONTROLLER_SETDATA_OFFSET UNITYSDK_OFFSET(0x160F8860)
#define MOLEMOLE_UIMAINCITYREVIVALREWARDWIDGETCONTROLLER_SETREWARDS_OFFSET UNITYSDK_OFFSET(0x160F8B10)
#define MOLEMOLE_UIMAINCITYREVIVALREWARDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x160F9050)
#define MOLEMOLE_UIMAINCITYREVIVALREWARDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x160F90E0)
#define MOLEMOLE_UIMAINCITYREVIVALREWARDWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x160F9170)
#define MOLEMOLE_UIMAINCITYREVIVALREWARDWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x160F9200)
#define MOLEMOLE_UIMAINCITYREVIVALREWARDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x160F92A0)
#define MOLEMOLE_UIMAINCITYREVIVALREWARDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x160F9330)
#define MOLEMOLE_UIMAINCITYREVIVALREWARDWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x160F93C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityRevivalRewardWidgetController_TypeDefinitionIndex = 47615;
	...
	public:
		...
		::Class_2_058F5595A5605292* _view; // 0x2E8
		::Class_2_208CC9941471731A_749* _template; // 0x2F0
		::System::Collections::Generic::List_1<::MoleMole::UIItemIconBtnSmallWidgetController*>* _rewardIconList; // 0x2F8
		::System::Action_1<::MoleMole::UIMainCityRevivalRewardWidgetController*>* _clickCb; // 0x300
		...
		::System::Void SetData(::Class_2_208CC9941471731A_749* template_, ::System::Boolean rewarded)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_749*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYREVIVALREWARDWIDGETCONTROLLER_SETDATA_OFFSET))(this, template_, rewarded);
		}
