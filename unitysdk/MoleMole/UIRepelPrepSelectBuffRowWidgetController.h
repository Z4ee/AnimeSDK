...
#define MOLEMOLE_UIREPELPREPSELECTBUFFROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15101F60)
#define MOLEMOLE_UIREPELPREPSELECTBUFFROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15101FD0)
#define MOLEMOLE_UIREPELPREPSELECTBUFFROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x151022B0)
#define MOLEMOLE_UIREPELPREPSELECTBUFFROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15102090)
#define MOLEMOLE_UIREPELPREPSELECTBUFFROWWIDGETCONTROLLER_SETRECOMMEND_OFFSET UNITYSDK_OFFSET(0x15102200)
#define MOLEMOLE_UIREPELPREPSELECTBUFFROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x151023B0)
#define MOLEMOLE_UIREPELPREPSELECTBUFFROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x151023C0)
#define MOLEMOLE_UIREPELPREPSELECTBUFFROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x15102460)
#define MOLEMOLE_UIREPELPREPSELECTBUFFROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x151024F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRepelPrepSelectBuffRowWidgetController_TypeDefinitionIndex = 90748;
