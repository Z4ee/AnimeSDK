...
#define MOLEMOLE_UIFILMGUIDEITEMTAGLISTWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x157E6F20)
#define MOLEMOLE_UIFILMGUIDEITEMTAGLISTWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x157E6F90)
#define MOLEMOLE_UIFILMGUIDEITEMTAGLISTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x157E7030)
#define MOLEMOLE_UIFILMGUIDEITEMTAGLISTWIDGETCONTROLLER_REFRESHTAGICONLIST_OFFSET UNITYSDK_OFFSET(0x157E71E0)
#define MOLEMOLE_UIFILMGUIDEITEMTAGLISTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x157E7290)
#define MOLEMOLE_UIFILMGUIDEITEMTAGLISTWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x157E72F0)
#define MOLEMOLE_UIFILMGUIDEITEMTAGLISTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x157E7390)

namespace MoleMole
{
	inline static constexpr unsigned int UIFilmGuideItemTagListWidgetController_TypeDefinitionIndex = 81001;
