...
#define MOLEMOLE_UIFILMGUIDEITEMTAGLISTWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x166C86C0)
#define MOLEMOLE_UIFILMGUIDEITEMTAGLISTWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x166C8730)
#define MOLEMOLE_UIFILMGUIDEITEMTAGLISTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x166C87D0)
#define MOLEMOLE_UIFILMGUIDEITEMTAGLISTWIDGETCONTROLLER_REFRESHTAGICONLIST_OFFSET UNITYSDK_OFFSET(0x166C8980)
#define MOLEMOLE_UIFILMGUIDEITEMTAGLISTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x166C8A30)
#define MOLEMOLE_UIFILMGUIDEITEMTAGLISTWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x166C8A90)
#define MOLEMOLE_UIFILMGUIDEITEMTAGLISTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x166C8B30)

namespace MoleMole
{
	inline static constexpr unsigned int UIFilmGuideItemTagListWidgetController_TypeDefinitionIndex = 71110;
