...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUETEXTURE_CHECKUSELAZYLOADING_OFFSET UNITYSDK_OFFSET(0x7CAB90)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUETEXTURE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x7CAB80)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUETEXTURE_ONTEXPATHCHANGE_OFFSET UNITYSDK_OFFSET(0x7CAC30)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUETEXTURE_TRYLOADTEXTURE_OFFSET UNITYSDK_OFFSET(0x7CAC20)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUETEXTURE_WARMUP_OFFSET UNITYSDK_OFFSET(0x7CAC70)

namespace MoleMole
{
	inline static constexpr unsigned int MaterialPropertyModifierValueTexture_TypeDefinitionIndex = 55233;
