...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUETEXTURE_CHECKUSELAZYLOADING_OFFSET UNITYSDK_OFFSET(0x791540)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUETEXTURE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x791530)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUETEXTURE_ONTEXPATHCHANGE_OFFSET UNITYSDK_OFFSET(0x7915E0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUETEXTURE_TRYLOADTEXTURE_OFFSET UNITYSDK_OFFSET(0x7915D0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUETEXTURE_WARMUP_OFFSET UNITYSDK_OFFSET(0x791620)

namespace MoleMole
{
	inline static constexpr unsigned int MaterialPropertyModifierValueTexture_TypeDefinitionIndex = 57259;
