...
#define MOLEMOLE_LEVELSECTIONGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x12346FD0)

namespace MoleMole
{
	inline static constexpr unsigned int LevelSectionGroupData_TypeDefinitionIndex = 56301;
