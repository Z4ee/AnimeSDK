...
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTDISHTABBTNROWWIDGETCONTROLLER_DATA__CTOR_OFFSET UNITYSDK_OFFSET(0x173D2530)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityHotPotCollectDishTabBtnRowWidgetController_Data_TypeDefinitionIndex = 81305;

	class UIActivityHotPotCollectDishTabBtnRowWidgetController_Data : public ::System::Object
	{
	public:
		::System::Action* LockAction; // 0x10
		::System::String* Text; // 0x18
		::System::String* LockParam; // 0x20
		::System::Action_1<::System::Int32>* Action; // 0x28
		::System::Boolean ShowNew; // 0x30
		::System::Boolean IsUnlock; // 0x31
