...
#define MOLEMOLE_DYNAMICOVERRIDEWEATHERENTRY_ISVALID_OFFSET UNITYSDK_OFFSET(0x6B3E30)

namespace MoleMole
{
	inline static constexpr unsigned int DynamicOverrideWeatherEntry_TypeDefinitionIndex = 38900;
