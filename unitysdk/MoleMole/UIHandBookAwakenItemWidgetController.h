...
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLER_ONCLICKSHOWREWARD_OFFSET UNITYSDK_OFFSET(0x152584E0)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLER_ONCLICKTELEPORT_OFFSET UNITYSDK_OFFSET(0x152583F0)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15257EB0)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15257FC0)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15257F40)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15257990)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLER_REFRESHSTATE_OFFSET UNITYSDK_OFFSET(0x15257B60)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x152580C0)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15258660)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLER__ONCLICKTELEPORT_B__8_0_OFFSET UNITYSDK_OFFSET(0x15258670)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15258740)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x152587D0)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15258870)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15258900)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookAwakenItemWidgetController_TypeDefinitionIndex = 69620;

	class UIHandBookAwakenItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_144* _view; // 0x2E8
		::MoleMole::UIHandBookAwakenItemWidgetControllerContext* m_ctx; // 0x2F0
