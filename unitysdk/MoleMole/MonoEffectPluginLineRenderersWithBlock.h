...
#define MOLEMOLE_MONOEFFECTPLUGINLINERENDERERSWITHBLOCK_METHOD_6_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x1A044300)
#define MOLEMOLE_MONOEFFECTPLUGINLINERENDERERSWITHBLOCK_METHOD_6_56CE4AFC5339F746_OFFSET UNITYSDK_OFFSET(0x1A045090)
#define MOLEMOLE_MONOEFFECTPLUGINLINERENDERERSWITHBLOCK_METHOD_6_59436527057ADF55_OFFSET UNITYSDK_OFFSET(0x1A0450F0)
#define MOLEMOLE_MONOEFFECTPLUGINLINERENDERERSWITHBLOCK_METHOD_6_8B4B3FEAD1B0C4A6_OFFSET UNITYSDK_OFFSET(0x1A0444A0)
#define MOLEMOLE_MONOEFFECTPLUGINLINERENDERERSWITHBLOCK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A0443B0)
#define MOLEMOLE_MONOEFFECTPLUGINLINERENDERERSWITHBLOCK_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A044240)
#define MOLEMOLE_MONOEFFECTPLUGINLINERENDERERSWITHBLOCK_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A0443F0)
#define MOLEMOLE_MONOEFFECTPLUGINLINERENDERERSWITHBLOCK__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A045040)
#define MOLEMOLE_MONOEFFECTPLUGINLINERENDERERSWITHBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A044FE0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginLineRenderersWithBlock_TypeDefinitionIndex = 69305;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(MonoEffectPluginLineRenderersWithBlock_TypeDefinitionIndex)->GetStaticField(0x4BED0);
		}
