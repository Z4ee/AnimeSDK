...
#define MOLEMOLE_UICOLORTWEAKERTARGET_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x87EBD0)
#define MOLEMOLE_UICOLORTWEAKERTARGET_METHOD_2_5242C82824870B60_OFFSET UNITYSDK_OFFSET(0x183D0F40)
#define MOLEMOLE_UICOLORTWEAKERTARGET_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x87ECC0)
#define MOLEMOLE_UICOLORTWEAKERTARGET_METHOD_2_CFE4DF658F81C59C_OFFSET UNITYSDK_OFFSET(0x87EC40)

namespace MoleMole
{
	inline static constexpr unsigned int UIColorTweakerTarget_TypeDefinitionIndex = 82729;
