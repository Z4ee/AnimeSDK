...
#define MOLEMOLE_GRIDLAYOUTGROUPADAPTOR_GET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x12F8BBC0)
#define MOLEMOLE_GRIDLAYOUTGROUPADAPTOR_SET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x12F8BBE0)
#define MOLEMOLE_GRIDLAYOUTGROUPADAPTOR_UPDATEPARAMS_OFFSET UNITYSDK_OFFSET(0x12F8BCB0)
#define MOLEMOLE_GRIDLAYOUTGROUPADAPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x12F8BC40)

namespace MoleMole
{
	inline static constexpr unsigned int GridLayoutGroupAdaptor_TypeDefinitionIndex = 71323;
