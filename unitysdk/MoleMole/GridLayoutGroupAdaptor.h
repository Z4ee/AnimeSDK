...
#define MOLEMOLE_GRIDLAYOUTGROUPADAPTOR_GET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x107F23F0)
#define MOLEMOLE_GRIDLAYOUTGROUPADAPTOR_SET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x107F2410)
#define MOLEMOLE_GRIDLAYOUTGROUPADAPTOR_UPDATEPARAMS_OFFSET UNITYSDK_OFFSET(0x107F24E0)
#define MOLEMOLE_GRIDLAYOUTGROUPADAPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x107F2470)

namespace MoleMole
{
	inline static constexpr unsigned int GridLayoutGroupAdaptor_TypeDefinitionIndex = 50431;
