...
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ADDCOMPENTERBTN_OFFSET UNITYSDK_OFFSET(0x18A47930)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_CLEARCOMPONTNBTNS_OFFSET UNITYSDK_OFFSET(0x18A47170)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x18A46D40)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_INITANDPLAYVIDEO_OFFSET UNITYSDK_OFFSET(0x18A47E00)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONABILITYSELECTCHANGE_OFFSET UNITYSDK_OFFSET(0x18A49C60)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONACTIVITYCLOSE_OFFSET UNITYSDK_OFFSET(0x18A48F50)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONACTIVITYEND_OFFSET UNITYSDK_OFFSET(0x18A490B0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONCLICKBACK_OFFSET UNITYSDK_OFFSET(0x18A49CA0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONCLICKINFO_OFFSET UNITYSDK_OFFSET(0x18A49E20)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONCLICKMAINCITY_OFFSET UNITYSDK_OFFSET(0x18A49D00)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONCLICKOK_OFFSET UNITYSDK_OFFSET(0x18A4A0E0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18A46D50)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x18A48CC0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x18A48D80)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONSELECTQUEST_OFFSET UNITYSDK_OFFSET(0x18A49AC0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18A48C00)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x18A48590)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18A470D0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18A46DE0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18A47310)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_REFRESHGAMEPADBTN_OFFSET UNITYSDK_OFFSET(0x18A49850)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_REFRESHOKBTN_OFFSET UNITYSDK_OFFSET(0x18A496E0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_REFRESHREMAINTIMER_OFFSET UNITYSDK_OFFSET(0x18A47BC0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_SETTEAMTRIALSTATE_OFFSET UNITYSDK_OFFSET(0x18A48050)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_TRYCREATETEAMTRIALWIDGET_OFFSET UNITYSDK_OFFSET(0x18A49130)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18A4A350)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER__INITANDPLAYVIDEO_B__26_0_OFFSET UNITYSDK_OFFSET(0x18A4A360)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER__INITANDPLAYVIDEO_B__26_1_OFFSET UNITYSDK_OFFSET(0x18A4A3C0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER__SETTEAMTRIALSTATE_B__27_0_OFFSET UNITYSDK_OFFSET(0x18A4A400)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18A4A4A0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x18A4A530)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x18A4A5C0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18A4A5F0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x18A4A600)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18A4A6C0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18A4A6D0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18A4A6E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityTeamTrialPageController_TypeDefinitionIndex = 86862;
