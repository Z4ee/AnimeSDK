...
#define MOLEMOLE_MONOLEVELRESULTPAGECONFIG_ONENABLE_OFFSET UNITYSDK_OFFSET(0x10D6E090)
#define MOLEMOLE_MONOLEVELRESULTPAGECONFIG_START_OFFSET UNITYSDK_OFFSET(0x10D6E0D0)
#define MOLEMOLE_MONOLEVELRESULTPAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x10D6E300)
#define MOLEMOLE_MONOLEVELRESULTPAGECONFIG__START_G____NOTIFYEXP_9_0_OFFSET UNITYSDK_OFFSET(0x10D6E1B0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoLevelResultPageConfig_TypeDefinitionIndex = 60463;
