...
#define MOLEMOLE_MONOLEVELRESULTPAGECONFIG_ONENABLE_OFFSET UNITYSDK_OFFSET(0x15B9F6D0)
#define MOLEMOLE_MONOLEVELRESULTPAGECONFIG_START_OFFSET UNITYSDK_OFFSET(0x15B9F710)
#define MOLEMOLE_MONOLEVELRESULTPAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x15B9F940)
#define MOLEMOLE_MONOLEVELRESULTPAGECONFIG__START_G____NOTIFYEXP_9_0_OFFSET UNITYSDK_OFFSET(0x15B9F7F0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoLevelResultPageConfig_TypeDefinitionIndex = 80246;
