...
#define MOLEMOLE_UIARCADEMAINRANKCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16125A00)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeMainRankContext_TypeDefinitionIndex = 67180;
