...
#define MOLEMOLE_UIARCADEMAINRANKCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x19287630)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeMainRankContext_TypeDefinitionIndex = 91140;
