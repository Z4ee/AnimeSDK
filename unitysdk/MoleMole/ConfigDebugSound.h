...
#define MOLEMOLE_CONFIGDEBUGSOUND__CTOR_OFFSET UNITYSDK_OFFSET(0x1B56AA90)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigDebugSound_TypeDefinitionIndex = 69746;
