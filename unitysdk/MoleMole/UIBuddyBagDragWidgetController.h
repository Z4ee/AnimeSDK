...
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_CHANGETOCOMPONENTVIEW_OFFSET UNITYSDK_OFFSET(0x183CB890)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_COMPONENTSTATEDRAG_OFFSET UNITYSDK_OFFSET(0x183CC5C0)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ENABLEDRAG_OFFSET UNITYSDK_OFFSET(0x183CB4D0)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_GETTOUCHPOSITION_OFFSET UNITYSDK_OFFSET(0x183CBDD0)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ISCLICK_OFFSET UNITYSDK_OFFSET(0x183CBCA0)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ISMOVE_OFFSET UNITYSDK_OFFSET(0x183CBD20)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONBAGITEMSELECT_OFFSET UNITYSDK_OFFSET(0x183CCC10)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x183CBE50)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONCLEARITEMSELECT_OFFSET UNITYSDK_OFFSET(0x183CD170)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x183CB1C0)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONDRAGEND_OFFSET UNITYSDK_OFFSET(0x183CC800)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONDRAGING_OFFSET UNITYSDK_OFFSET(0x183CCBC0)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONDRAGSTART_OFFSET UNITYSDK_OFFSET(0x183CBB60)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x183CB250)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x183CA9A0)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x183CB080)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_REGISTERDRAG_OFFSET UNITYSDK_OFFSET(0x183CADB0)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_UPDATEDRAGUI_OFFSET UNITYSDK_OFFSET(0x183CB7D0)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x183CD1C0)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x183CD220)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x183CD2B0)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x183CD340)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x183CD3D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBuddyBagDragWidgetController_TypeDefinitionIndex = 59477;
