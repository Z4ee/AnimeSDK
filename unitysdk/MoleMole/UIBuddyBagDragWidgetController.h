...
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_CHANGETOCOMPONENTVIEW_OFFSET UNITYSDK_OFFSET(0x15ED5520)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_COMPONENTSTATEDRAG_OFFSET UNITYSDK_OFFSET(0x15ED6250)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ENABLEDRAG_OFFSET UNITYSDK_OFFSET(0x15ED5160)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_GETTOUCHPOSITION_OFFSET UNITYSDK_OFFSET(0x15ED5A60)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ISCLICK_OFFSET UNITYSDK_OFFSET(0x15ED5930)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ISMOVE_OFFSET UNITYSDK_OFFSET(0x15ED59B0)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONBAGITEMSELECT_OFFSET UNITYSDK_OFFSET(0x15ED68A0)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x15ED5AE0)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONCLEARITEMSELECT_OFFSET UNITYSDK_OFFSET(0x15ED6E00)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15ED4E50)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONDRAGEND_OFFSET UNITYSDK_OFFSET(0x15ED6490)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONDRAGING_OFFSET UNITYSDK_OFFSET(0x15ED6850)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONDRAGSTART_OFFSET UNITYSDK_OFFSET(0x15ED57F0)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15ED4EE0)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15ED4630)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15ED4D10)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_REGISTERDRAG_OFFSET UNITYSDK_OFFSET(0x15ED4A40)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_UPDATEDRAGUI_OFFSET UNITYSDK_OFFSET(0x15ED5460)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15ED6E50)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15ED6EB0)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15ED6F40)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15ED6FD0)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15ED7060)

namespace MoleMole
{
	inline static constexpr unsigned int UIBuddyBagDragWidgetController_TypeDefinitionIndex = 59146;

	class UIBuddyBagDragWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_1C00730466C60BCB_2* _view; // 0x2B8
		::MoleMole::UIBuddyBagDragWidgetController_DragState _dragState; // 0x2C0
		::UnityEngine::Transform* selectParent; // 0x2C8
		::UnityEngine::Transform* tvParent; // 0x2D0
		::MoleMole::UIItemIconBtnWidgetController* _item; // 0x2D8
		::MoleMole::MonoDragUIObject* _drag; // 0x2E0
		::System::Boolean isChanged; // 0x2E8
		::MoleMole::UIBuddyDIYComponentWidgetController* dragComponentWidget; // 0x2F0
		::Class_1_A59025D696FD25CD* _buddyDIYComponent; // 0x2F8
		::Struct_2_143B7A497B890286_1 DragCollider; // 0x300
