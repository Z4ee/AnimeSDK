...
#define MOLEMOLE_UIABYSSS2REWARDDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1892F470)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2RewardDialogContext_TypeDefinitionIndex = 87855;

	class UIAbyssS2RewardDialogContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::Action* CloseBtnCallBack; // 0x28
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_1165*>* missionTabs; // 0x30
