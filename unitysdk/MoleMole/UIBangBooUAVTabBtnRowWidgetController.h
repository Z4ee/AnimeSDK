...
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER_GETBADGE_OFFSET UNITYSDK_OFFSET(0x18A61B20)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER_GETTABBUTTON_OFFSET UNITYSDK_OFFSET(0x18A619D0)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18A61940)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18A61A30)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18A61870)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18A618D0)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER_SETTEXT_OFFSET UNITYSDK_OFFSET(0x18A61AB0)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18A61B80)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18A61BE0)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18A61C70)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18A61D00)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18A61D90)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangBooUAVTabBtnRowWidgetController_TypeDefinitionIndex = 58752;
