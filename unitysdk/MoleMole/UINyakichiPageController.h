...
class Class_2_60638234271CCDB8_167;
...
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1867BAE0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONCLICKDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1867F670)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONCLICKINFOBTN_OFFSET UNITYSDK_OFFSET(0x1867D110)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONCLICKSTATEBTN_OFFSET UNITYSDK_OFFSET(0x1867DA90)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1867BB90)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONDROPDOWNCHANGE_OFFSET UNITYSDK_OFFSET(0x18680240)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x1867FEF0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1867CF90)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x1867F480)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONQUESTCLICK_OFFSET UNITYSDK_OFFSET(0x1867E2E0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1867CDA0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONTABCLICK_OFFSET UNITYSDK_OFFSET(0x1867DD50)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONTAKEREWARD_OFFSET UNITYSDK_OFFSET(0x1867D330)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1867CD30)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1867BC20)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_PLAYPROGRESSANIM_OFFSET UNITYSDK_OFFSET(0x1867D8D0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_PLAYTAKEREWARDANI_OFFSET UNITYSDK_OFFSET(0x1867F280)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_SETCURRENTSTOREBYSTOREINDEX_OFFSET UNITYSDK_OFFSET(0x1867C660)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x1867BAF0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_SHOWPROGRESS_OFFSET UNITYSDK_OFFSET(0x1867F2D0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_UPDATEGOLDENSTATE_OFFSET UNITYSDK_OFFSET(0x1867DEC0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_UPDATEGROUPUI_OFFSET UNITYSDK_OFFSET(0x1867D7D0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_UPDATEQUESTUI_OFFSET UNITYSDK_OFFSET(0x1867E4B0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18680340)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x186802B0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER__ONUIINIT_B__6_0_OFFSET UNITYSDK_OFFSET(0x18680350)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x186803A0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER___BASE_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x18680430)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x18680520)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x18680550)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x186805E0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18680680)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18680690)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x186806A0)

namespace MoleMole
{
	inline static constexpr unsigned int UINyakichiPageController_TypeDefinitionIndex = 87112;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UINyakichiPageController_TypeDefinitionIndex)->GetStaticField(0x10890);
		}
		::Class_2_60638234271CCDB8_167* _view; // 0x328
