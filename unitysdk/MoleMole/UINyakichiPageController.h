...
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1300DAF0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONCLICKDROPDOWN_OFFSET UNITYSDK_OFFSET(0x130115C0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONCLICKINFOBTN_OFFSET UNITYSDK_OFFSET(0x1300F0D0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONCLICKSTATEBTN_OFFSET UNITYSDK_OFFSET(0x1300FA00)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1300DBA0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONDROPDOWNCHANGE_OFFSET UNITYSDK_OFFSET(0x13012130)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x13011DE0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1300EF50)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x130113D0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONQUESTCLICK_OFFSET UNITYSDK_OFFSET(0x13010240)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1300ED60)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONTABCLICK_OFFSET UNITYSDK_OFFSET(0x1300FCC0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONTAKEREWARD_OFFSET UNITYSDK_OFFSET(0x1300F2B0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1300ECF0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1300DC30)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_PLAYPROGRESSANIM_OFFSET UNITYSDK_OFFSET(0x1300F840)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_PLAYTAKEREWARDANI_OFFSET UNITYSDK_OFFSET(0x130111D0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_SETCURRENTSTOREBYSTOREINDEX_OFFSET UNITYSDK_OFFSET(0x1300E670)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x1300DB00)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_SHOWPROGRESS_OFFSET UNITYSDK_OFFSET(0x13011220)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_UPDATEGOLDENSTATE_OFFSET UNITYSDK_OFFSET(0x1300FE30)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_UPDATEGROUPUI_OFFSET UNITYSDK_OFFSET(0x1300F740)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_UPDATEQUESTUI_OFFSET UNITYSDK_OFFSET(0x13010410)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x13012230)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x130121A0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER__ONUIINIT_B__6_0_OFFSET UNITYSDK_OFFSET(0x13012240)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x13012290)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER___BASE_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x13012320)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x13012410)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x13012440)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x130124D0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x13012570)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x13012580)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x13012590)

namespace MoleMole
{
	inline static constexpr unsigned int UINyakichiPageController_TypeDefinitionIndex = 72905;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UINyakichiPageController_TypeDefinitionIndex)->GetStaticField(0xFA70);
		}
		::Class_2_60638234271CCDB8_82* _view; // 0x320
		::Class_1_48C59E92AE345A89* storeData; // 0x328
		::System::Int32 StoreIndex; // 0x330
		::Class_2_7C995C45BC10DBB8* _model; // 0x338
		::MoleMole::UIGeneralDynamicTipsPopWindowController* _dropDownTipsWidgetController; // 0x340
		::System::Int32 tabIndex; // 0x348
		::System::Int32 selectQuestID; // 0x34C
		::MoleMole::UIGeneralPopUpHintWidgetController* dropDownHint; // 0x350
		::System::String* ContentSwitchAni; // 0x358
		::System::String* CardBGSwitchAni; // 0x360
		::System::String* ProgressAddAni; // 0x368
		::System::String* ProgressSwitchAni; // 0x370
		::System::String* IconGoldenFadeIn; // 0x378
		::System::String* IconGoldenFadeOut; // 0x380
