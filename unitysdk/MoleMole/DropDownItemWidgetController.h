...
#define MOLEMOLE_DROPDOWNITEMWIDGETCONTROLLER_GETINDEX_OFFSET UNITYSDK_OFFSET(0x11040E70)
#define MOLEMOLE_DROPDOWNITEMWIDGETCONTROLLER_GETUITABBUTTON_OFFSET UNITYSDK_OFFSET(0x11040D50)
#define MOLEMOLE_DROPDOWNITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x11040D90)
#define MOLEMOLE_DROPDOWNITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11040EC0)
#define MOLEMOLE_DROPDOWNITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x11040F20)

namespace MoleMole
{
	inline static constexpr unsigned int DropDownItemWidgetController_TypeDefinitionIndex = 63450;

	class DropDownItemWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::System::Int32 _index; // 0x2B8
		::MoleMole::UIGeneralDropdownOptionContext* _dropdownContext; // 0x2C0
