...
#define MOLEMOLE_MONOBPANIMATIONS_BPMOTIONANIMEND_OFFSET UNITYSDK_OFFSET(0x1686CFC0)
#define MOLEMOLE_MONOBPANIMATIONS_BPMOTIONANIM_OFFSET UNITYSDK_OFFSET(0x1686CF30)
#define MOLEMOLE_MONOBPANIMATIONS_CALCULATEBPPOS_OFFSET UNITYSDK_OFFSET(0x1686CC00)
#define MOLEMOLE_MONOBPANIMATIONS_INITREWARDENTERANIM_OFFSET UNITYSDK_OFFSET(0x1686CA00)
#define MOLEMOLE_MONOBPANIMATIONS_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1686C7F0)
#define MOLEMOLE_MONOBPANIMATIONS_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1686CE20)
#define MOLEMOLE_MONOBPANIMATIONS_STARTREWARDENTERANIM_OFFSET UNITYSDK_OFFSET(0x1686C830)
#define MOLEMOLE_MONOBPANIMATIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1686D020)

namespace MoleMole
{
	inline static constexpr unsigned int MonoBPAnimations_TypeDefinitionIndex = 69790;
	...
	public:
		...
		::System::Double Field_5_6; // 0x30
		::System::Single Field_5_5; // 0x38
		::System::Boolean Field_5_4; // 0x3C
		::UnityEngine::Vector2 Field_5_11; // 0x40
		::System::Single Field_5_10; // 0x48
		::System::Single Field_5_9; // 0x4C
		::System::Single Field_5_8; // 0x50
		::System::Action* Field_5_15; // 0x58
		::Foundation::Coroutine::CoroutineHandle Field_5_14; // 0x60
