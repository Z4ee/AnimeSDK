...
#define MOLEMOLE_MONOBPANIMATIONS_BPMOTIONANIMEND_OFFSET UNITYSDK_OFFSET(0x16E6E490)
#define MOLEMOLE_MONOBPANIMATIONS_BPMOTIONANIM_OFFSET UNITYSDK_OFFSET(0x16E6E400)
#define MOLEMOLE_MONOBPANIMATIONS_CALCULATEBPPOS_OFFSET UNITYSDK_OFFSET(0x16E6E0D0)
#define MOLEMOLE_MONOBPANIMATIONS_INITREWARDENTERANIM_OFFSET UNITYSDK_OFFSET(0x16E6DED0)
#define MOLEMOLE_MONOBPANIMATIONS_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x16E6DCC0)
#define MOLEMOLE_MONOBPANIMATIONS_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16E6E2F0)
#define MOLEMOLE_MONOBPANIMATIONS_STARTREWARDENTERANIM_OFFSET UNITYSDK_OFFSET(0x16E6DD00)
#define MOLEMOLE_MONOBPANIMATIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x16E6E4F0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoBPAnimations_TypeDefinitionIndex = 38451;
