...
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_VIDEOPLAYERHELPERRUNTIMEINFO_ONFINISH_OFFSET UNITYSDK_OFFSET(0x17DDC9C0)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_VIDEOPLAYERHELPERRUNTIMEINFO_PLAY_OFFSET UNITYSDK_OFFSET(0x17DDC900)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_VIDEOPLAYERHELPERRUNTIMEINFO_STOP_OFFSET UNITYSDK_OFFSET(0x17DDC970)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_VIDEOPLAYERHELPERRUNTIMEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17DDC8E0)

namespace MoleMole
{
	inline static constexpr unsigned int MultipleVideoPlayerManager_VideoPlayerHelperRuntimeInfo_TypeDefinitionIndex = 67967;
