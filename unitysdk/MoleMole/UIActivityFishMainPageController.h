...
#define MOLEMOLE_UIACTIVITYFISHMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15A8FF90)
#define MOLEMOLE_UIACTIVITYFISHMAINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A8FFA0)
#define MOLEMOLE_UIACTIVITYFISHMAINPAGECONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x15A910E0)
#define MOLEMOLE_UIACTIVITYFISHMAINPAGECONTROLLER_ONITEMCHANGEDDELAY_OFFSET UNITYSDK_OFFSET(0x15A913D0)
#define MOLEMOLE_UIACTIVITYFISHMAINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A91340)
#define MOLEMOLE_UIACTIVITYFISHMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A90030)
#define MOLEMOLE_UIACTIVITYFISHMAINPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15A90580)
#define MOLEMOLE_UIACTIVITYFISHMAINPAGECONTROLLER_REFRESHAVATARREWARD_OFFSET UNITYSDK_OFFSET(0x15A93BD0)
#define MOLEMOLE_UIACTIVITYFISHMAINPAGECONTROLLER_REFRESHBIGREWARD_OFFSET UNITYSDK_OFFSET(0x15A92890)
#define MOLEMOLE_UIACTIVITYFISHMAINPAGECONTROLLER_REFRESHFINALREWARD_OFFSET UNITYSDK_OFFSET(0x15A928E0)
#define MOLEMOLE_UIACTIVITYFISHMAINPAGECONTROLLER_REFRESHNORMALREWARD_OFFSET UNITYSDK_OFFSET(0x15A91CC0)
#define MOLEMOLE_UIACTIVITYFISHMAINPAGECONTROLLER_REFRESHPROGRESS_OFFSET UNITYSDK_OFFSET(0x15A91A70)
#define MOLEMOLE_UIACTIVITYFISHMAINPAGECONTROLLER_REFRESHREWARD_OFFSET UNITYSDK_OFFSET(0x15A91810)
#define MOLEMOLE_UIACTIVITYFISHMAINPAGECONTROLLER_REFRESHTITLE_OFFSET UNITYSDK_OFFSET(0x15A91420)
#define MOLEMOLE_UIACTIVITYFISHMAINPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x15A90780)
#define MOLEMOLE_UIACTIVITYFISHMAINPAGECONTROLLER_REFRESHWEAPONREWARD_OFFSET UNITYSDK_OFFSET(0x15A934F0)
#define MOLEMOLE_UIACTIVITYFISHMAINPAGECONTROLLER_STARTCAROUSEL_OFFSET UNITYSDK_OFFSET(0x15A90AA0)
#define MOLEMOLE_UIACTIVITYFISHMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15A945C0)
#define MOLEMOLE_UIACTIVITYFISHMAINPAGECONTROLLER__ONUIINIT_B__10_0_OFFSET UNITYSDK_OFFSET(0x15A946D0)
#define MOLEMOLE_UIACTIVITYFISHMAINPAGECONTROLLER__REFRESHTITLE_B__17_0_OFFSET UNITYSDK_OFFSET(0x15A94750)
#define MOLEMOLE_UIACTIVITYFISHMAINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15A94760)
#define MOLEMOLE_UIACTIVITYFISHMAINPAGECONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x15A947F0)
#define MOLEMOLE_UIACTIVITYFISHMAINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15A94880)
#define MOLEMOLE_UIACTIVITYFISHMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15A94890)
#define MOLEMOLE_UIACTIVITYFISHMAINPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15A948A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityFishMainPageController_TypeDefinitionIndex = 39650;

	class UIActivityFishMainPageController : public ::MoleMole::UIWindowController
	{
	public:
		// static const ::System::Int32 COIN_ITEM_ID = 0x88; // 0x0
		::Class_2_7B15B3118FE590CD_5* _view; // 0x310
		::MoleMole::UIGeneralActivityTagWidgetController* _activityTag; // 0x318
		::Class_1_D375C91CCE5D3999* _mainActivity; // 0x320
		::MoleMole::UIActivityFishProgressBarWidgetController* _progressBarWidget; // 0x328
		::MoleMole::UIActivityFishMainPageController_Carousel* _weaponCarousel; // 0x330
		::MoleMole::UIActivityFishMainPageController_Carousel* _roleCarousel; // 0x338
