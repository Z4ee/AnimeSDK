...
#define MOLEMOLE_UIRABENEMYINFOINNERWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15BFB160)
#define MOLEMOLE_UIRABENEMYINFOINNERWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15BFB1D0)
#define MOLEMOLE_UIRABENEMYINFOINNERWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15BFB270)
#define MOLEMOLE_UIRABENEMYINFOINNERWIDGETCONTROLLER_SETCONTEXT_OFFSET UNITYSDK_OFFSET(0x15BFB320)
#define MOLEMOLE_UIRABENEMYINFOINNERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15BFB510)
#define MOLEMOLE_UIRABENEMYINFOINNERWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15BFB570)
#define MOLEMOLE_UIRABENEMYINFOINNERWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15BFB610)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABEnemyInfoInnerWidgetController_TypeDefinitionIndex = 60189;
