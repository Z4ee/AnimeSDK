...
#define MOLEMOLE_UIHOLLOWINFOPROGRESS02WIDGETCONTROLLER_GETREALMISSIONID_OFFSET UNITYSDK_OFFSET(0x177AA1C0)
#define MOLEMOLE_UIHOLLOWINFOPROGRESS02WIDGETCONTROLLER_GET_REWARDCONTENT_OFFSET UNITYSDK_OFFSET(0x177AD060)
#define MOLEMOLE_UIHOLLOWINFOPROGRESS02WIDGETCONTROLLER_INITHOTEFFECT_OFFSET UNITYSDK_OFFSET(0x177AC8D0)
#define MOLEMOLE_UIHOLLOWINFOPROGRESS02WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x177A9ED0)
#define MOLEMOLE_UIHOLLOWINFOPROGRESS02WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x177A9F60)
#define MOLEMOLE_UIHOLLOWINFOPROGRESS02WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x177A9CA0)
#define MOLEMOLE_UIHOLLOWINFOPROGRESS02WIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x177AA300)
#define MOLEMOLE_UIHOLLOWINFOPROGRESS02WIDGETCONTROLLER_SETMISSION_OFFSET UNITYSDK_OFFSET(0x177AD1C0)
#define MOLEMOLE_UIHOLLOWINFOPROGRESS02WIDGETCONTROLLER_UPDATEREWARDLIST_OFFSET UNITYSDK_OFFSET(0x177AB310)
#define MOLEMOLE_UIHOLLOWINFOPROGRESS02WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x177AD220)
#define MOLEMOLE_UIHOLLOWINFOPROGRESS02WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x177AD370)
#define MOLEMOLE_UIHOLLOWINFOPROGRESS02WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x177AD400)
#define MOLEMOLE_UIHOLLOWINFOPROGRESS02WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x177AD490)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowInfoProgress02WidgetController_TypeDefinitionIndex = 64497;
	...
	public:
		...
		::Class_2_0A55B5A82A61DAFA* hollowQuestTemplateExt; // 0x2F8
