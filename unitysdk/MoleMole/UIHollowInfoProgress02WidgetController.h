...
#define MOLEMOLE_UIHOLLOWINFOPROGRESS02WIDGETCONTROLLER_GETREALMISSIONID_OFFSET UNITYSDK_OFFSET(0x17320550)
#define MOLEMOLE_UIHOLLOWINFOPROGRESS02WIDGETCONTROLLER_GET_REWARDCONTENT_OFFSET UNITYSDK_OFFSET(0x17323450)
#define MOLEMOLE_UIHOLLOWINFOPROGRESS02WIDGETCONTROLLER_INITHOTEFFECT_OFFSET UNITYSDK_OFFSET(0x17322CA0)
#define MOLEMOLE_UIHOLLOWINFOPROGRESS02WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17320260)
#define MOLEMOLE_UIHOLLOWINFOPROGRESS02WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x173202F0)
#define MOLEMOLE_UIHOLLOWINFOPROGRESS02WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17320030)
#define MOLEMOLE_UIHOLLOWINFOPROGRESS02WIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x17320690)
#define MOLEMOLE_UIHOLLOWINFOPROGRESS02WIDGETCONTROLLER_SETMISSION_OFFSET UNITYSDK_OFFSET(0x173235B0)
#define MOLEMOLE_UIHOLLOWINFOPROGRESS02WIDGETCONTROLLER_UPDATEREWARDLIST_OFFSET UNITYSDK_OFFSET(0x173216B0)
#define MOLEMOLE_UIHOLLOWINFOPROGRESS02WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17323610)
#define MOLEMOLE_UIHOLLOWINFOPROGRESS02WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17323760)
#define MOLEMOLE_UIHOLLOWINFOPROGRESS02WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x173237F0)
#define MOLEMOLE_UIHOLLOWINFOPROGRESS02WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17323880)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowInfoProgress02WidgetController_TypeDefinitionIndex = 85657;
	...
	public:
		...
		::System::Collections::Generic::List_1<::UnityEngine::Transform*>* rewardTranList; // 0x2C0
		::HollowInfoProgressParam* _param; // 0x2C8
		::Class_2_7DC5AE118ED7708D* _view; // 0x2D0
		::Class_2_1A3197598F874EB7* _questModel; // 0x2D8
		::UnityEngine::Material* _fillMaterial; // 0x2E0
		::System::Int32 _missionID; // 0x2E8
		::System::Collections::Generic::List_1<::MoleMole::UIItemIconBtnWidgetController*>* _rewardsList; // 0x2F0
		::Class_2_0A55B5A82A61DAFA_2* hollowQuestTemplateExt; // 0x2F8
