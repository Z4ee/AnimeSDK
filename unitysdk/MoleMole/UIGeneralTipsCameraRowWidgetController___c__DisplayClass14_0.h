...
#define MOLEMOLE_UIGENERALTIPSCAMERAROWWIDGETCONTROLLER___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17BD5710)
#define MOLEMOLE_UIGENERALTIPSCAMERAROWWIDGETCONTROLLER___C__DISPLAYCLASS14_0__DOANIMATION_B__0_OFFSET UNITYSDK_OFFSET(0x17BD5720)
#define MOLEMOLE_UIGENERALTIPSCAMERAROWWIDGETCONTROLLER___C__DISPLAYCLASS14_0__DOANIMATION_B__1_OFFSET UNITYSDK_OFFSET(0x17BD5B70)
#define MOLEMOLE_UIGENERALTIPSCAMERAROWWIDGETCONTROLLER___C__DISPLAYCLASS14_0__DOANIMATION_B__2_OFFSET UNITYSDK_OFFSET(0x17BD5830)
#define MOLEMOLE_UIGENERALTIPSCAMERAROWWIDGETCONTROLLER___C__DISPLAYCLASS14_0__DOANIMATION_B__3_OFFSET UNITYSDK_OFFSET(0x17BD5AD0)
#define MOLEMOLE_UIGENERALTIPSCAMERAROWWIDGETCONTROLLER___C__DISPLAYCLASS14_0__DOANIMATION_B__4_OFFSET UNITYSDK_OFFSET(0x17BD5AE0)
#define MOLEMOLE_UIGENERALTIPSCAMERAROWWIDGETCONTROLLER___C__DISPLAYCLASS14_0__DOANIMATION_B__5_OFFSET UNITYSDK_OFFSET(0x17BD5AF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralTipsCameraRowWidgetController___c__DisplayClass14_0_TypeDefinitionIndex = 71152;
