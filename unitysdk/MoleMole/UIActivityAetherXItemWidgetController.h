...
#define MOLEMOLE_UIACTIVITYAETHERXITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12B38E90)
#define MOLEMOLE_UIACTIVITYAETHERXITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x12B39180)
#define MOLEMOLE_UIACTIVITYAETHERXITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12B38F20)
#define MOLEMOLE_UIACTIVITYAETHERXITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12B38CF0)
#define MOLEMOLE_UIACTIVITYAETHERXITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12B38E20)
#define MOLEMOLE_UIACTIVITYAETHERXITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x12B38FA0)
#define MOLEMOLE_UIACTIVITYAETHERXITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12B39500)
#define MOLEMOLE_UIACTIVITYAETHERXITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12B39560)
#define MOLEMOLE_UIACTIVITYAETHERXITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12B395F0)
#define MOLEMOLE_UIACTIVITYAETHERXITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12B39680)
#define MOLEMOLE_UIACTIVITYAETHERXITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x12B39710)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityAetherXItemWidgetController_TypeDefinitionIndex = 56752;

	class UIActivityAetherXItemWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_A933CF9454745DA7_1* _view; // 0x2B8
