...
#define MOLEMOLE_UIACTIVITYICONLIVEBTNWIDGETCONTROLLER___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x173D3170)
#define MOLEMOLE_UIACTIVITYICONLIVEBTNWIDGETCONTROLLER___C__DISPLAYCLASS8_0__REFRESHVIEW_B__0_OFFSET UNITYSDK_OFFSET(0x173D3180)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityIconLiveBtnWidgetController___c__DisplayClass8_0_TypeDefinitionIndex = 74682;
