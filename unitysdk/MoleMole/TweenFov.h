...
#define MOLEMOLE_TWEENFOV_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x17066D00)
#define MOLEMOLE_TWEENFOV_METHOD_7_DAD3126FCF30E9B2_OFFSET UNITYSDK_OFFSET(0x17066D90)
#define MOLEMOLE_TWEENFOV_METHOD_7_FE1A1A30B3CE9C46_OFFSET UNITYSDK_OFFSET(0x17066F80)
#define MOLEMOLE_TWEENFOV_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x17066D10)
#define MOLEMOLE_TWEENFOV__CTOR_OFFSET UNITYSDK_OFFSET(0x17067070)
#define MOLEMOLE_TWEENFOV___BASE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x17067090)

namespace MoleMole
{
	inline static constexpr unsigned int TweenFov_TypeDefinitionIndex = 81481;
