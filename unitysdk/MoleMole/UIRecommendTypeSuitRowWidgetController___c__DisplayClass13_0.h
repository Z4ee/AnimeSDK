...
#define MOLEMOLE_UIRECOMMENDTYPESUITROWWIDGETCONTROLLER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x169050E0)
#define MOLEMOLE_UIRECOMMENDTYPESUITROWWIDGETCONTROLLER___C__DISPLAYCLASS13_0__REFRESHVIEW_B__0_OFFSET UNITYSDK_OFFSET(0x169050F0)
#define MOLEMOLE_UIRECOMMENDTYPESUITROWWIDGETCONTROLLER___C__DISPLAYCLASS13_0__REFRESHVIEW_B__1_OFFSET UNITYSDK_OFFSET(0x16905120)
#define MOLEMOLE_UIRECOMMENDTYPESUITROWWIDGETCONTROLLER___C__DISPLAYCLASS13_0__REFRESHVIEW_G__GETSUITFILTERINDEX_3_OFFSET UNITYSDK_OFFSET(0x16905430)
#define MOLEMOLE_UIRECOMMENDTYPESUITROWWIDGETCONTROLLER___C__DISPLAYCLASS13_0__REFRESHVIEW_G__ISCANSELECT_4_OFFSET UNITYSDK_OFFSET(0x16905490)
#define MOLEMOLE_UIRECOMMENDTYPESUITROWWIDGETCONTROLLER___C__DISPLAYCLASS13_0__REFRESHVIEW_G__ONSUITROWCLICK_2_OFFSET UNITYSDK_OFFSET(0x16905180)

namespace MoleMole
{
	inline static constexpr unsigned int UIRecommendTypeSuitRowWidgetController___c__DisplayClass13_0_TypeDefinitionIndex = 75432;
