...
class Class_2_A6272C10C4E9B18E;
namespace MoleMole { class UIControlReference; }
namespace System { class Object; }

#define MOLEMOLE_UIBALLGAMECOLLECTMONSTERROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15223E80)
#define MOLEMOLE_UIBALLGAMECOLLECTMONSTERROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15223EF0)
#define MOLEMOLE_UIBALLGAMECOLLECTMONSTERROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x152242B0)
#define MOLEMOLE_UIBALLGAMECOLLECTMONSTERROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15224080)
#define MOLEMOLE_UIBALLGAMECOLLECTMONSTERROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15224350)
#define MOLEMOLE_UIBALLGAMECOLLECTMONSTERROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x15224360)
#define MOLEMOLE_UIBALLGAMECOLLECTMONSTERROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x15224400)
#define MOLEMOLE_UIBALLGAMECOLLECTMONSTERROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x15224490)

namespace MoleMole
{
	inline static constexpr unsigned int UIBallGameCollectMonsterRowWidgetController_TypeDefinitionIndex = 44709;
	...
	public:
		...
		::Class_2_A6272C10C4E9B18E* get__viewModel()
		{
			return ((::Class_2_A6272C10C4E9B18E*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBALLGAMECOLLECTMONSTERROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
