...
#define MOLEMOLE_UIABYSSS2BUILDDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B22F390)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2BuildDialogContext_TypeDefinitionIndex = 81053;
