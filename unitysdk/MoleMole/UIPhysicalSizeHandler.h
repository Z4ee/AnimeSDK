...
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_APPLYLAYOUTRESULT_OFFSET UNITYSDK_OFFSET(0x14D5BC70)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_CALCULATELAYOUT_OFFSET UNITYSDK_OFFSET(0x14D5A5A0)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_GETLAYOUTRESULT_OFFSET UNITYSDK_OFFSET(0x14D5AD60)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x14D5A480)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_METHOD_6_115AC51E73D999C8_OFFSET UNITYSDK_OFFSET(0x14D5A750)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_METHOD_6_1CCA9681CE0AE7A7_OFFSET UNITYSDK_OFFSET(0x14D5C1D0)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_METHOD_6_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x14D5C590)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_METHOD_6_4B72F72501001F72_OFFSET UNITYSDK_OFFSET(0x14D5C280)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_METHOD_6_7744894CEC41BF06_1_OFFSET UNITYSDK_OFFSET(0x14D5C680)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_METHOD_6_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0x14D5A990)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_METHOD_6_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x14D5C670)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x14D5C610)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_METHOD_6_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x14D5C880)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_METHOD_6_F4B69C1853FCB2B5_OFFSET UNITYSDK_OFFSET(0x14D5C060)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_METHOD_6_F7AB163354E6802C_OFFSET UNITYSDK_OFFSET(0x14D5AB90)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x14D5A430)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x14D5C4E0)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14D5C490)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x14D5C500)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhysicalSizeHandler_TypeDefinitionIndex = 50331;
	...
	public:
		...
		{
			return (::UnityEngine::Vector2*)Il2CppClass::FromTypeDefinitionIndex(UIPhysicalSizeHandler_TypeDefinitionIndex)->GetStaticField(0xDEF0);
		}
		static ::System::Single* StaticGet_Field_6_6()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(UIPhysicalSizeHandler_TypeDefinitionIndex)->GetStaticField(0xDEF8);
		}
