...
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER___C__DISPLAYCLASS25_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15551520)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER___C__DISPLAYCLASS25_0__SETMISSIONITEMSELECT_B__0_OFFSET UNITYSDK_OFFSET(0x15551530)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotNewsMissionRowV2WidgetController___c__DisplayClass25_0_TypeDefinitionIndex = 70231;
