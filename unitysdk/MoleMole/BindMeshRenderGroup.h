...
#define MOLEMOLE_BINDMESHRENDERGROUP_GETBINDMESHRENDERERS_OFFSET UNITYSDK_OFFSET(0x12B93600)
#define MOLEMOLE_BINDMESHRENDERGROUP_GETMATERIALSLISTBYRENDERS_OFFSET UNITYSDK_OFFSET(0x12B93640)
#define MOLEMOLE_BINDMESHRENDERGROUP_GETOVERRIDERDITHERKEY_OFFSET UNITYSDK_OFFSET(0x12B935C0)
#define MOLEMOLE_BINDMESHRENDERGROUP_METHOD_1_3306F24AC967FE79_OFFSET UNITYSDK_OFFSET(0x12B93A40)
#define MOLEMOLE_BINDMESHRENDERGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x12B93A30)

namespace MoleMole
{
	inline static constexpr unsigned int BindMeshRenderGroup_TypeDefinitionIndex = 39715;
