...
#define MOLEMOLE_ANIMATIONEVENTSOUNDACTION_AUTOCREATECUSTOMSOUNDEMITTER_OFFSET UNITYSDK_OFFSET(0xECE0FC0)
#define MOLEMOLE_ANIMATIONEVENTSOUNDACTION_GET_SOUNDACTIONSOURCEHINT_OFFSET UNITYSDK_OFFSET(0xECE1530)
#define MOLEMOLE_ANIMATIONEVENTSOUNDACTION_GET_SOUNDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xECE1330)
#define MOLEMOLE_ANIMATIONEVENTSOUNDACTION_SOUNDOTHER_OFFSET UNITYSDK_OFFSET(0xECE1670)
#define MOLEMOLE_ANIMATIONEVENTSOUNDACTION_SOUNDPLAY_OFFSET UNITYSDK_OFFSET(0xECE1590)
#define MOLEMOLE_ANIMATIONEVENTSOUNDACTION_SOUNDSTOP_OFFSET UNITYSDK_OFFSET(0xECE1600)
#define MOLEMOLE_ANIMATIONEVENTSOUNDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xECE1790)

namespace MoleMole
{
	inline static constexpr unsigned int AnimationEventSoundAction_TypeDefinitionIndex = 77951;
