...
#define MOLEMOLE_ANIMATIONEVENTSOUNDACTION_AUTOCREATECUSTOMSOUNDEMITTER_OFFSET UNITYSDK_OFFSET(0x10CCBB70)
#define MOLEMOLE_ANIMATIONEVENTSOUNDACTION_GET_SOUNDACTIONSOURCEHINT_OFFSET UNITYSDK_OFFSET(0x10CCC0E0)
#define MOLEMOLE_ANIMATIONEVENTSOUNDACTION_GET_SOUNDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x10CCBEE0)
#define MOLEMOLE_ANIMATIONEVENTSOUNDACTION_SOUNDOTHER_OFFSET UNITYSDK_OFFSET(0x10CCC220)
#define MOLEMOLE_ANIMATIONEVENTSOUNDACTION_SOUNDPLAY_OFFSET UNITYSDK_OFFSET(0x10CCC140)
#define MOLEMOLE_ANIMATIONEVENTSOUNDACTION_SOUNDSTOP_OFFSET UNITYSDK_OFFSET(0x10CCC1B0)
#define MOLEMOLE_ANIMATIONEVENTSOUNDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x10CCC330)

namespace MoleMole
{
	inline static constexpr unsigned int AnimationEventSoundAction_TypeDefinitionIndex = 69346;
