...
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER_CLICKLOCKSTATE_OFFSET UNITYSDK_OFFSET(0x18AF6AD0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER_GETCURCTX_OFFSET UNITYSDK_OFFSET(0x18AF5DA0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER_GETCURRENTZONEID_OFFSET UNITYSDK_OFFSET(0x18AF5A80)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER_MARKSELECT_OFFSET UNITYSDK_OFFSET(0x18AF65F0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18AF56F0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x18AF5E70)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18AF5780)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18AF5690)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18AF58C0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER_SETPARENTWINDOWFADEINDONEFUNC_OFFSET UNITYSDK_OFFSET(0x18AF6CD0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER_SETZONEITEMINFO_CLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x18AF6DA0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER__CHECKPLAY_OFFSET UNITYSDK_OFFSET(0x18AF6D20)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18AF6DF0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER__ONSCROLLITEMUPDATE_B__18_0_OFFSET UNITYSDK_OFFSET(0x18AF6E40)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER__REFRESHBESTRECORD_OFFSET UNITYSDK_OFFSET(0x18AF5DF0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER__REGNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x18AF64B0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER__SETCOMMON_OFFSET UNITYSDK_OFFSET(0x18AF5CB0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER__SETEMPTYSTATE_OFFSET UNITYSDK_OFFSET(0x18AF5AD0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER__SETLOCKSTATE_OFFSET UNITYSDK_OFFSET(0x18AF5BC0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER__TRYPLAYUNLOCKZONEANIM_OFFSET UNITYSDK_OFFSET(0x18AF6880)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18AF6FD0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x18AF7060)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18AF7100)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18AF7190)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18AF7220)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER___CHECKPLAY_B__25_0_OFFSET UNITYSDK_OFFSET(0x18AF6F60)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER___TRYPLAYUNLOCKZONEANIM_G____PLAYZONEUNLOCKANIM_21_0_OFFSET UNITYSDK_OFFSET(0x18AF6C00)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZoneItemInfoV2WidgetController_TypeDefinitionIndex = 75962;

	class UIHadalZoneItemInfoV2WidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_78* _view; // 0x2F0
		::MoleMole::UIHadalZone_Common_ZoneItemInfoData* _curItemData; // 0x2F8
		::System::Int32 _curZoneID; // 0x300
		::System::Int32 _curIndex; // 0x304
		::Class_2_468A4FBF2E9F527C* _hadalZoneModel; // 0x308
		::System::Func_1<::System::Boolean>* _isParentFadeInDoneFunc; // 0x310
		::System::String* UNLOCK_ZONE_ANIM_RED; // 0x318
		::System::String* UNLOCK_ZONE_ANIM_BLUE; // 0x320
		::System::Action_1<::MoleMole::UIHadalZoneItemInfoV2WidgetController*>* _clickCallback; // 0x328
