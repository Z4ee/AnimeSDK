...
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER_CLICKLOCKSTATE_OFFSET UNITYSDK_OFFSET(0x167B9BA0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER_GETCURCTX_OFFSET UNITYSDK_OFFSET(0x167B8EB0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER_GETCURRENTZONEID_OFFSET UNITYSDK_OFFSET(0x167B8B90)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER_MARKSELECT_OFFSET UNITYSDK_OFFSET(0x167B96D0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x167B8800)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x167B8F70)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x167B8890)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x167B87A0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x167B89D0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER_SETPARENTWINDOWFADEINDONEFUNC_OFFSET UNITYSDK_OFFSET(0x167B9DA0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER_SETZONEITEMINFO_CLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x167B9E70)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER__CHECKPLAY_OFFSET UNITYSDK_OFFSET(0x167B9DF0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x167B9EC0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER__ONSCROLLITEMUPDATE_B__18_0_OFFSET UNITYSDK_OFFSET(0x167B9F10)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER__REFRESHBESTRECORD_OFFSET UNITYSDK_OFFSET(0x167B8F00)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER__REGNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x167B95B0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER__SETCOMMON_OFFSET UNITYSDK_OFFSET(0x167B8DC0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER__SETEMPTYSTATE_OFFSET UNITYSDK_OFFSET(0x167B8BE0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER__SETLOCKSTATE_OFFSET UNITYSDK_OFFSET(0x167B8CD0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER__TRYPLAYUNLOCKZONEANIM_OFFSET UNITYSDK_OFFSET(0x167B9950)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x167BA0A0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x167BA130)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x167BA1D0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x167BA260)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x167BA2F0)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER___CHECKPLAY_B__25_0_OFFSET UNITYSDK_OFFSET(0x167BA030)
#define MOLEMOLE_UIHADALZONEITEMINFOV2WIDGETCONTROLLER___TRYPLAYUNLOCKZONEANIM_G____PLAYZONEUNLOCKANIM_21_0_OFFSET UNITYSDK_OFFSET(0x167B9CD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZoneItemInfoV2WidgetController_TypeDefinitionIndex = 48158;

	class UIHadalZoneItemInfoV2WidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_92* _view; // 0x2F0
