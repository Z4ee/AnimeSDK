...
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17D985C0)
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x17D98650)
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER_SAMPLEANIM_OFFSET UNITYSDK_OFFSET(0x17D99180)
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER_STARTEXPPROGRESS_OFFSET UNITYSDK_OFFSET(0x17D98EB0)
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17D99540)
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER__PLAYADDEXPANI_OFFSET UNITYSDK_OFFSET(0x17D99070)
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER__PLAYUPGRADELVTEXTANIM_OFFSET UNITYSDK_OFFSET(0x17D99250)
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER__REFRESHINITTARGETEXP_OFFSET UNITYSDK_OFFSET(0x17D98A00)
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER__REFRESHPROGRESS_OFFSET UNITYSDK_OFFSET(0x17D98AF0)
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER__UPGRADETOCURRLEVEL_OFFSET UNITYSDK_OFFSET(0x17D993A0)
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17D99630)
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER___PLAYUPGRADELVTEXTANIM_B__22_0_OFFSET UNITYSDK_OFFSET(0x17D995A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralExpProgressWidgetController_TypeDefinitionIndex = 67968;
