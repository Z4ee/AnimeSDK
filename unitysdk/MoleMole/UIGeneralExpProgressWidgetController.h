...
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15902740)
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x159027D0)
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER_SAMPLEANIM_OFFSET UNITYSDK_OFFSET(0x15903330)
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER_STARTEXPPROGRESS_OFFSET UNITYSDK_OFFSET(0x15903060)
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x159036F0)
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER__PLAYADDEXPANI_OFFSET UNITYSDK_OFFSET(0x15903220)
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER__PLAYUPGRADELVTEXTANIM_OFFSET UNITYSDK_OFFSET(0x15903400)
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER__REFRESHINITTARGETEXP_OFFSET UNITYSDK_OFFSET(0x15902B90)
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER__REFRESHPROGRESS_OFFSET UNITYSDK_OFFSET(0x15902C80)
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER__UPGRADETOCURRLEVEL_OFFSET UNITYSDK_OFFSET(0x15903550)
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x159037E0)
#define MOLEMOLE_UIGENERALEXPPROGRESSWIDGETCONTROLLER___PLAYUPGRADELVTEXTANIM_B__22_0_OFFSET UNITYSDK_OFFSET(0x15903750)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralExpProgressWidgetController_TypeDefinitionIndex = 74867;

	class UIGeneralExpProgressWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_D6646C12B5D25CB4* _view; // 0x2B8
		::Class_1_E398E2F4402CE967* _context; // 0x2C0
		::System::Int32 _startLv; // 0x2C8
		::System::Int32 _startExp; // 0x2CC
		::System::Int32 _toExp; // 0x2D0
		::System::Action* _onPlayFinished; // 0x2D8
		::Class_1_E398E2F4402CE967* data; // 0x2E0
		::System::Boolean _isStarted; // 0x2E8
		::System::Single _upgradePauseDuration; // 0x2EC
		::System::Boolean _isMaxLevel; // 0x2F0
		::System::Int32 totalProgressExpCount; // 0x2F4
		::System::Single startTime; // 0x2F8
		::System::Boolean _isUpLevel; // 0x2FC
		::System::Int32 oldLevel; // 0x300
		::System::Int32 newLevel; // 0x304
