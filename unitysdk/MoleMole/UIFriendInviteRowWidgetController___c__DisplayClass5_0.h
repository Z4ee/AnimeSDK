...
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17303950)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER___C__DISPLAYCLASS5_0__ONSCROLLITEMUPDATE_B__0_OFFSET UNITYSDK_OFFSET(0x17303960)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER___C__DISPLAYCLASS5_0__ONSCROLLITEMUPDATE_B__1_OFFSET UNITYSDK_OFFSET(0x17303D90)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER___C__DISPLAYCLASS5_0__ONSCROLLITEMUPDATE_B__2_OFFSET UNITYSDK_OFFSET(0x17303BB0)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER___C__DISPLAYCLASS5_0__ONSCROLLITEMUPDATE_B__3_OFFSET UNITYSDK_OFFSET(0x17303D20)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendInviteRowWidgetController___c__DisplayClass5_0_TypeDefinitionIndex = 51997;
	...
	public:
		...
		::MoleMole::UIFriendInviteRowWidgetController_Context* _data; // 0x20
