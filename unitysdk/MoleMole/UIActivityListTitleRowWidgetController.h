...
#define MOLEMOLE_UIACTIVITYLISTTITLEROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x16333EC0)
#define MOLEMOLE_UIACTIVITYLISTTITLEROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16333FD0)
#define MOLEMOLE_UIACTIVITYLISTTITLEROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16333F50)
#define MOLEMOLE_UIACTIVITYLISTTITLEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16333E60)
#define MOLEMOLE_UIACTIVITYLISTTITLEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x163344C0)
#define MOLEMOLE_UIACTIVITYLISTTITLEROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x163344D0)
#define MOLEMOLE_UIACTIVITYLISTTITLEROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x16334560)
#define MOLEMOLE_UIACTIVITYLISTTITLEROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x16334600)
#define MOLEMOLE_UIACTIVITYLISTTITLEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x16334690)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityListTitleRowWidgetController_TypeDefinitionIndex = 54845;

	class UIActivityListTitleRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_F914E35E759B2F13* _view; // 0x2E8
