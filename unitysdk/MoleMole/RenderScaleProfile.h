...
#define MOLEMOLE_RENDERSCALEPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x17DE0E40)
#define MOLEMOLE_RENDERSCALEPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x17DE0F80)
#define MOLEMOLE_RENDERSCALEPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x17DE0D60)
#define MOLEMOLE_RENDERSCALEPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x17DE0F00)
#define MOLEMOLE_RENDERSCALEPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x17DE0D50)
#define MOLEMOLE_RENDERSCALEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x17DE10A0)
#define MOLEMOLE_RENDERSCALEPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x17DE1130)
#define MOLEMOLE_RENDERSCALEPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x17DE11C0)
#define MOLEMOLE_RENDERSCALEPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x17DE1250)

namespace MoleMole
{
	inline static constexpr unsigned int RenderScaleProfile_TypeDefinitionIndex = 51384;
