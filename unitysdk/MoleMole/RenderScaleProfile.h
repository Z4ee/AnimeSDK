...
#define MOLEMOLE_RENDERSCALEPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x190A7B50)
#define MOLEMOLE_RENDERSCALEPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x190A7C90)
#define MOLEMOLE_RENDERSCALEPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x190A7A70)
#define MOLEMOLE_RENDERSCALEPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x190A7C10)
#define MOLEMOLE_RENDERSCALEPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x190A7A60)
#define MOLEMOLE_RENDERSCALEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x190A7DB0)
#define MOLEMOLE_RENDERSCALEPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x190A7E40)
#define MOLEMOLE_RENDERSCALEPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x190A7ED0)
#define MOLEMOLE_RENDERSCALEPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x190A7F60)

namespace MoleMole
{
	inline static constexpr unsigned int RenderScaleProfile_TypeDefinitionIndex = 82781;
