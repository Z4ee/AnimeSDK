...
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_SHOOTINGINFO_GET_CAPACITY_OFFSET UNITYSDK_OFFSET(0x2F1C00)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_SHOOTINGINFO_INIT_OFFSET UNITYSDK_OFFSET(0x7479E0)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_SHOOTINGINFO_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x747AA0)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_SHOOTINGINFO_ISFULL_OFFSET UNITYSDK_OFFSET(0x747AF0)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_SHOOTINGINFO_RELOAD_OFFSET UNITYSDK_OFFSET(0x747A50)

namespace MoleMole
{
	inline static constexpr unsigned int SummerEventDroneSubsystem_ShootingInfo_TypeDefinitionIndex = 62712;
