...
#define MOLEMOLE_UIINLEVELPAUSEDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16088130)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseDialogContext_TypeDefinitionIndex = 45895;

	class UIInLevelPauseDialogContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::Collections::Generic::List_1<::Class_1_1E0CF91A5D8A4275*>* TabBtnCtx; // 0x28
		::System::Action_1<::System::Collections::Generic::Dictionary_2<::MoleMole::InLevelPauseLevelTab, ::System::Collections::Generic::List_1<::MoleMole::ESystemSettingType>*>*>* SettingDictModifier; // 0x30
		::Class_1_59778CA46DD656B4* Btn2Ctx; // 0x38
		...
		::Class_1_59778CA46DD656B4* Btn1Ctx; // 0x58
