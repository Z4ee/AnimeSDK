...
#define MOLEMOLE_COMICCHAPTERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B79F290)

namespace MoleMole
{
	inline static constexpr unsigned int ComicChapterInfo_TypeDefinitionIndex = 30578;
	...
	public:
		...
		::UnityEngine::Sprite* defaultSprite; // 0x40
		...
		::System::String* pageTransitionSoundKey; // 0x58
		::System::Collections::Generic::List_1<::MoleMole::ComicClipBaseInfo*>* splitScreenZones; // 0x60
		::MoleMole::ComicImgSplitScreenGroup* imgGroup; // 0x68
		::System::Collections::Generic::List_1<::UnityEngine::Timeline::ImageTrack*>* imageTracks; // 0x70
		::System::String* pageBGMState; // 0x78
