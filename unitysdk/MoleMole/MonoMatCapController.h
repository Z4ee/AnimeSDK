...
#define MOLEMOLE_MONOMATCAPCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x14197470)
#define MOLEMOLE_MONOMATCAPCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x14197A50)
#define MOLEMOLE_MONOMATCAPCONTROLLER_METHOD_5_640E2FC48A07F427_OFFSET UNITYSDK_OFFSET(0x14197880)
#define MOLEMOLE_MONOMATCAPCONTROLLER_METHOD_5_D07BA88E28A45054_OFFSET UNITYSDK_OFFSET(0x141981F0)
#define MOLEMOLE_MONOMATCAPCONTROLLER_METHOD_5_FB4BE762B6186C23_OFFSET UNITYSDK_OFFSET(0x14198360)
#define MOLEMOLE_MONOMATCAPCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x14197A00)
#define MOLEMOLE_MONOMATCAPCONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0x14197600)
#define MOLEMOLE_MONOMATCAPCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14198390)

namespace MoleMole
{
	inline static constexpr unsigned int MonoMatCapController_TypeDefinitionIndex = 43935;
