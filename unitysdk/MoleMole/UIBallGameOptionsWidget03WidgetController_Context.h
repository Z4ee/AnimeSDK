...
#define MOLEMOLE_UIBALLGAMEOPTIONSWIDGET03WIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D78DD20)

namespace MoleMole
{
	inline static constexpr unsigned int UIBallGameOptionsWidget03WidgetController_Context_TypeDefinitionIndex = 89489;
