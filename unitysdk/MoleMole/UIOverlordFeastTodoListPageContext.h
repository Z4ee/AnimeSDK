...
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1746CC10)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastTodoListPageContext_TypeDefinitionIndex = 42865;
