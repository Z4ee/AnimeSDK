...
#define MOLEMOLE_MONOEFFECTSHAPE_EFFECTSHAPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18301830)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectShape_EffectShapeConfig_TypeDefinitionIndex = 65435;
