...
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_ADDDAYWIDGET_OFFSET UNITYSDK_OFFSET(0x175FD910)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_DATALISTSELECT_OFFSET UNITYSDK_OFFSET(0x175FE640)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_GETCANEQUIPCOUNT_OFFSET UNITYSDK_OFFSET(0x175FDC00)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_GETENTRYLIST_OFFSET UNITYSDK_OFFSET(0x175FBDC0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_GETINITSELECTOR_OFFSET UNITYSDK_OFFSET(0x175FBD30)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_GETLEVELTABCONTROLLER_OFFSET UNITYSDK_OFFSET(0x175FD580)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_GETREWARDLIST_OFFSET UNITYSDK_OFFSET(0x175FC240)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_GET_CURRENTQUEST_OFFSET UNITYSDK_OFFSET(0x175FB000)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_HIDERECORD_OFFSET UNITYSDK_OFFSET(0x175FD480)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_INITEQUIPLIST_OFFSET UNITYSDK_OFFSET(0x175FCB90)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_ISUNLOCKENTRY_OFFSET UNITYSDK_OFFSET(0x175FB590)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x175FB020)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_ONSTART_OFFSET UNITYSDK_OFFSET(0x175FB8B0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x175FD990)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x175FB120)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x175FD620)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_REFRESHDATADETAIL_OFFSET UNITYSDK_OFFSET(0x175FE2A0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0x175FC3C0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_REFRESHLEVELLIST_OFFSET UNITYSDK_OFFSET(0x175FEB40)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_REFRESHQUEST_OFFSET UNITYSDK_OFFSET(0x175FD0F0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_REFRESHTIME_OFFSET UNITYSDK_OFFSET(0x175FCDF0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_SET_CURRENTQUEST_OFFSET UNITYSDK_OFFSET(0x175FB010)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_SHOWTIPSASYNC_OFFSET UNITYSDK_OFFSET(0x175FD730)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_TRYSHOWLEVELCHANGEDTIPSASYNC_OFFSET UNITYSDK_OFFSET(0x175FD7D0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_TRYSHOWNEWEQUIPTIPSASYNC_OFFSET UNITYSDK_OFFSET(0x175FD870)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_TRYTRIGGERNEWBIEASYNC_OFFSET UNITYSDK_OFFSET(0x175FE000)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x175FFBE0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER__DATALISTSELECT_G__SETEQUIPID_33_0_OFFSET UNITYSDK_OFFSET(0x175FEAF0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER__INITEQUIPLIST_G__SETEQUIPDATA_30_0_OFFSET UNITYSDK_OFFSET(0x175FDD90)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER__REFRESHDATADETAIL_B__32_1_OFFSET UNITYSDK_OFFSET(0x175FFD50)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER__REFRESHDATADETAIL_G__SETEQUIP_32_0_OFFSET UNITYSDK_OFFSET(0x175FE370)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_ADDDAYWIDGET_OFFSET UNITYSDK_OFFSET(0x17600420)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_DATALISTSELECT_OFFSET UNITYSDK_OFFSET(0x176004F0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_GETENTRYLIST_OFFSET UNITYSDK_OFFSET(0x17600500)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_GETINITSELECTOR_OFFSET UNITYSDK_OFFSET(0x17600510)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_GETLEVELTABCONTROLLER_OFFSET UNITYSDK_OFFSET(0x176005E0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_GETREWARDLIST_OFFSET UNITYSDK_OFFSET(0x176006D0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_ISUNLOCKENTRY_OFFSET UNITYSDK_OFFSET(0x176006E0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x176006F0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x176007C0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x176007D0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x176007E0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x176007F0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_REFRESHDATADETAIL_OFFSET UNITYSDK_OFFSET(0x17600880)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0x17600890)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_REFRESHLEVELLIST_OFFSET UNITYSDK_OFFSET(0x176008A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangBooUAVLevelPageController_TypeDefinitionIndex = 61520;
	...
	public:
		...
		::Class_2_1CC0E2699D5FB1A6_3* _view; // 0x398
		::System::Collections::Generic::List_1<::Struct_2_A725E4562D03EA4E_2>* equipList; // 0x3A0
		...
		{
			return ((::Class_0_16E4307DCC419505_600*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_GETINITSELECTOR_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_7807B2B04302CD7B_18*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_REFRESHDETAIL_OFFSET))(this, data);
		}
		...
		::System::Void _InitEquipList_g__SetEquipData_30_0(::Struct_2_A725E4562D03EA4E_2& data, ::System::Int32 equipid, ::System::Boolean equiplock)
		{
			return ((::System::Void(*)(::PVOID, ::Struct_2_A725E4562D03EA4E_2&, ::System::Int32, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER__INITEQUIPLIST_G__SETEQUIPDATA_30_0_OFFSET))(this, data, equipid, equiplock);
		}

		::System::Void _RefreshDataDetail_g__SetEquip_32_0(::System::Int32 index, ::Struct_2_A725E4562D03EA4E_2 equipData)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::Struct_2_A725E4562D03EA4E_2))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER__REFRESHDATADETAIL_G__SETEQUIP_32_0_OFFSET))(this, index, equipData);
		}
		...
		::Class_0_16E4307DCC419505_600* __base_GetInitSelector()
		{
			return ((::Class_0_16E4307DCC419505_600*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_GETINITSELECTOR_OFFSET))(this);
		}
		...
		::System::Void __base_RefreshDetail(::Class_1_7807B2B04302CD7B_18* P0)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_7807B2B04302CD7B_18*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_REFRESHDETAIL_OFFSET))(this, P0);
		}
