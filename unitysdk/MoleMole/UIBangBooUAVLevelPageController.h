...
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_ADDDAYWIDGET_OFFSET UNITYSDK_OFFSET(0x18E3AE60)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_DATALISTSELECT_OFFSET UNITYSDK_OFFSET(0x18E3BB90)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_GETCANEQUIPCOUNT_OFFSET UNITYSDK_OFFSET(0x18E3B150)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_GETENTRYLIST_OFFSET UNITYSDK_OFFSET(0x18E39310)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_GETINITSELECTOR_OFFSET UNITYSDK_OFFSET(0x18E39280)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_GETLEVELTABCONTROLLER_OFFSET UNITYSDK_OFFSET(0x18E3AAE0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_GETREWARDLIST_OFFSET UNITYSDK_OFFSET(0x18E39790)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_GET_CURRENTQUEST_OFFSET UNITYSDK_OFFSET(0x18E38560)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_HIDERECORD_OFFSET UNITYSDK_OFFSET(0x18E3A9E0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_INITEQUIPLIST_OFFSET UNITYSDK_OFFSET(0x18E3A0E0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_ISUNLOCKENTRY_OFFSET UNITYSDK_OFFSET(0x18E38AE0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18E38580)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_ONSTART_OFFSET UNITYSDK_OFFSET(0x18E38E00)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18E3AEE0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18E38680)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18E3AB80)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_REFRESHDATADETAIL_OFFSET UNITYSDK_OFFSET(0x18E3B7F0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0x18E39910)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_REFRESHLEVELLIST_OFFSET UNITYSDK_OFFSET(0x18E3C090)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_REFRESHQUEST_OFFSET UNITYSDK_OFFSET(0x18E3A640)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_REFRESHTIME_OFFSET UNITYSDK_OFFSET(0x18E3A340)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_SET_CURRENTQUEST_OFFSET UNITYSDK_OFFSET(0x18E38570)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_SHOWTIPSASYNC_OFFSET UNITYSDK_OFFSET(0x18E3AC90)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_TRYSHOWLEVELCHANGEDTIPSASYNC_OFFSET UNITYSDK_OFFSET(0x18E3AD30)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_TRYSHOWNEWEQUIPTIPSASYNC_OFFSET UNITYSDK_OFFSET(0x18E3ADC0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_TRYTRIGGERNEWBIEASYNC_OFFSET UNITYSDK_OFFSET(0x18E3B560)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18E3D0E0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER__DATALISTSELECT_G__SETEQUIPID_33_0_OFFSET UNITYSDK_OFFSET(0x18E3C040)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER__INITEQUIPLIST_G__SETEQUIPDATA_30_0_OFFSET UNITYSDK_OFFSET(0x18E3B2E0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER__REFRESHDATADETAIL_B__32_1_OFFSET UNITYSDK_OFFSET(0x18E3D250)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER__REFRESHDATADETAIL_G__SETEQUIP_32_0_OFFSET UNITYSDK_OFFSET(0x18E3B8C0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_ADDDAYWIDGET_OFFSET UNITYSDK_OFFSET(0x18E3D920)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_DATALISTSELECT_OFFSET UNITYSDK_OFFSET(0x18E3D9F0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_GETENTRYLIST_OFFSET UNITYSDK_OFFSET(0x18E3DA00)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_GETINITSELECTOR_OFFSET UNITYSDK_OFFSET(0x18E3DA10)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_GETLEVELTABCONTROLLER_OFFSET UNITYSDK_OFFSET(0x18E3DAE0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_GETREWARDLIST_OFFSET UNITYSDK_OFFSET(0x18E3DBD0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_ISUNLOCKENTRY_OFFSET UNITYSDK_OFFSET(0x18E3DBE0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18E3DBF0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x18E3DCC0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18E3DCD0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18E3DCE0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18E3DCF0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_REFRESHDATADETAIL_OFFSET UNITYSDK_OFFSET(0x18E3DD80)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0x18E3DD90)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_REFRESHLEVELLIST_OFFSET UNITYSDK_OFFSET(0x18E3DDA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangBooUAVLevelPageController_TypeDefinitionIndex = 65625;
	...
	public:
		...
		::Class_2_1CC0E2699D5FB1A6_4* _view; // 0x398
		::System::Collections::Generic::List_1<::Struct_2_A725E4562D03EA4E>* equipList; // 0x3A0
		::System::Collections::Generic::List_1<::System::Int32>* EquipTmpList; // 0x3A8
		::System::Collections::Generic::List_1<::MoleMole::UIBangBooUAVInfoRowWidgetController*>* questInfos; // 0x3B0
		::Class_2_0F98EC09A480D0AE* dreamModel; // 0x3B8
		::System::Collections::Generic::List_1<::System::Int32>* lockTipsList; // 0x3C0
		...
		{
			return ((::Class_0_16E4307DCC419505_649*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_GETINITSELECTOR_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_7807B2B04302CD7B_11*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_REFRESHDETAIL_OFFSET))(this, data);
		}
		...
		::Class_0_16E4307DCC419505_649* __base_GetInitSelector()
		{
			return ((::Class_0_16E4307DCC419505_649*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_GETINITSELECTOR_OFFSET))(this);
		}
		...
		::System::Void __base_RefreshDetail(::Class_1_7807B2B04302CD7B_11* P0)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_7807B2B04302CD7B_11*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_REFRESHDETAIL_OFFSET))(this, P0);
		}
