...
#define MOLEMOLE_UIABINLEVELARCADETINFOWIDGETCONTROLLER_BINDVIEW_OFFSET UNITYSDK_OFFSET(0x19746890)
#define MOLEMOLE_UIABINLEVELARCADETINFOWIDGETCONTROLLER_INITPLATFORMSETTING_OFFSET UNITYSDK_OFFSET(0x19746160)
#define MOLEMOLE_UIABINLEVELARCADETINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19746780)
#define MOLEMOLE_UIABINLEVELARCADETINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19746810)
#define MOLEMOLE_UIABINLEVELARCADETINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19746050)
#define MOLEMOLE_UIABINLEVELARCADETINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19746650)
#define MOLEMOLE_UIABINLEVELARCADETINFOWIDGETCONTROLLER_SETPLATFORMBTNSHOWSTATE_OFFSET UNITYSDK_OFFSET(0x197466D0)
#define MOLEMOLE_UIABINLEVELARCADETINFOWIDGETCONTROLLER_SETROW_OFFSET UNITYSDK_OFFSET(0x19747020)
#define MOLEMOLE_UIABINLEVELARCADETINFOWIDGETCONTROLLER_SHOWREPORTDIALOG_OFFSET UNITYSDK_OFFSET(0x19746E00)
#define MOLEMOLE_UIABINLEVELARCADETINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x197471F0)
#define MOLEMOLE_UIABINLEVELARCADETINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x197472D0)
#define MOLEMOLE_UIABINLEVELARCADETINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19747360)
#define MOLEMOLE_UIABINLEVELARCADETINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x197473F0)
#define MOLEMOLE_UIABINLEVELARCADETINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19747480)

namespace MoleMole
{
	inline static constexpr unsigned int UIABInLevelArcadetInfoWidgetController_TypeDefinitionIndex = 84145;

	class UIABInLevelArcadetInfoWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_FF33B5ED14FB44B2_1* _view; // 0x2C0
