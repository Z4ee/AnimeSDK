...
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_CANADDNEWPLAN_OFFSET UNITYSDK_OFFSET(0x15262B90)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_CREATEITEMWIDGET_OFFSET UNITYSDK_OFFSET(0x152620B0)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_GETCURSELECTWIDGET_OFFSET UNITYSDK_OFFSET(0x15262990)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x15261DB0)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x15261780)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x15261980)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_ISCHECKED_OFFSET UNITYSDK_OFFSET(0x15261DC0)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_ONCONFIRM_OFFSET UNITYSDK_OFFSET(0x15261EC0)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15261CB0)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_ONITEMCLICKED_OFFSET UNITYSDK_OFFSET(0x152621E0)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15261D40)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15261790)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15261A30)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_REFRESHBTN_OFFSET UNITYSDK_OFFSET(0x15261E20)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x15261C20)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15262C00)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER__ONUIINIT_B__3_0_OFFSET UNITYSDK_OFFSET(0x15262C80)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x15262D40)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x15262DD0)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x15262DE0)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x15262DF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIDailyQuestSchedulePlanPopWindowController_TypeDefinitionIndex = 84179;
	...
	public:
		...
		::Class_2_208CC9941471731A_308* _poolConfig; // 0x338
