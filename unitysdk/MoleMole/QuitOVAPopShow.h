...
#define MOLEMOLE_QUITOVAPOPSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x11DED270)
#define MOLEMOLE_QUITOVAPOPSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x11DED2C0)
#define MOLEMOLE_QUITOVAPOPSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x11DED280)

namespace MoleMole
{
	inline static constexpr unsigned int QuitOVAPopShow_TypeDefinitionIndex = 51517;
