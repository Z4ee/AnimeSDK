...
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER__HIDESTANDBY_D__9_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x7A7440)
#define MOLEMOLE_UIQUESTIONSANSWERSCREENWIDGETCONTROLLER__HIDESTANDBY_D__9_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2661E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerScreenWidgetController__HideStandBy_d__9_TypeDefinitionIndex = 44832;
