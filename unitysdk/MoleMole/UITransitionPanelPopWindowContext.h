...
#define MOLEMOLE_UITRANSITIONPANELPOPWINDOWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x10EF7830)

namespace MoleMole
{
	inline static constexpr unsigned int UITransitionPanelPopWindowContext_TypeDefinitionIndex = 60464;
