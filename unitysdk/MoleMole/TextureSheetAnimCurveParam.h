...
#define MOLEMOLE_TEXTURESHEETANIMCURVEPARAM_EVALUATE_OFFSET UNITYSDK_OFFSET(0x10E52460)
#define MOLEMOLE_TEXTURESHEETANIMCURVEPARAM_GET_VALID_OFFSET UNITYSDK_OFFSET(0x10E52400)
#define MOLEMOLE_TEXTURESHEETANIMCURVEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x10E52550)

namespace MoleMole
{
	inline static constexpr unsigned int TextureSheetAnimCurveParam_TypeDefinitionIndex = 40090;
