...
#define MOLEMOLE_TEXTURESHEETANIMCURVEPARAM_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1190F410)
#define MOLEMOLE_TEXTURESHEETANIMCURVEPARAM_GET_VALID_OFFSET UNITYSDK_OFFSET(0x1190F3B0)
#define MOLEMOLE_TEXTURESHEETANIMCURVEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1190F500)

namespace MoleMole
{
	inline static constexpr unsigned int TextureSheetAnimCurveParam_TypeDefinitionIndex = 68900;
