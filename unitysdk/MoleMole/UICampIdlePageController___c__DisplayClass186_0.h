...
#define MOLEMOLE_UICAMPIDLEPAGECONTROLLER___C__DISPLAYCLASS186_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15B61CB0)
#define MOLEMOLE_UICAMPIDLEPAGECONTROLLER___C__DISPLAYCLASS186_0__REFRESHBATTLEREWARD_B__0_OFFSET UNITYSDK_OFFSET(0x15B61CC0)

namespace MoleMole
{
	inline static constexpr unsigned int UICampIdlePageController___c__DisplayClass186_0_TypeDefinitionIndex = 86928;
