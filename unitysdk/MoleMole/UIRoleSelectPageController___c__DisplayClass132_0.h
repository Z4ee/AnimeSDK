...
#define MOLEMOLE_UIROLESELECTPAGECONTROLLER___C__DISPLAYCLASS132_0__CTOR_OFFSET UNITYSDK_OFFSET(0x130268B0)
#define MOLEMOLE_UIROLESELECTPAGECONTROLLER___C__DISPLAYCLASS132_0__PROCESSUIAVATAR_B__0_OFFSET UNITYSDK_OFFSET(0x130268C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleSelectPageController___c__DisplayClass132_0_TypeDefinitionIndex = 39212;
	...
	public:
		...
		::Class_2_208CC9941471731A_100* avatarUIConfig; // 0x30
