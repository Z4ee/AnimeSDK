...
#define MOLEMOLE_UIFRIENDCHATMESSAGEWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x17F8D720)
#define MOLEMOLE_UIFRIENDCHATMESSAGEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17F8D500)
#define MOLEMOLE_UIFRIENDCHATMESSAGEWIDGETCONTROLLER_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0x17F8E6C0)
#define MOLEMOLE_UIFRIENDCHATMESSAGEWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17F8D620)
#define MOLEMOLE_UIFRIENDCHATMESSAGEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17F8D590)
#define MOLEMOLE_UIFRIENDCHATMESSAGEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17F8D030)
#define MOLEMOLE_UIFRIENDCHATMESSAGEWIDGETCONTROLLER_ONUPDATECHATMESSAGEROW_OFFSET UNITYSDK_OFFSET(0x17F8EAC0)
#define MOLEMOLE_UIFRIENDCHATMESSAGEWIDGETCONTROLLER_PROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x17F8D390)
#define MOLEMOLE_UIFRIENDCHATMESSAGEWIDGETCONTROLLER_RESETSPECIALUI_OFFSET UNITYSDK_OFFSET(0x17F8EA30)
#define MOLEMOLE_UIFRIENDCHATMESSAGEWIDGETCONTROLLER_RESETUIVIEW_OFFSET UNITYSDK_OFFSET(0x17F8E970)
#define MOLEMOLE_UIFRIENDCHATMESSAGEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17F8EB50)
#define MOLEMOLE_UIFRIENDCHATMESSAGEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17F8EB60)
#define MOLEMOLE_UIFRIENDCHATMESSAGEWIDGETCONTROLLER___BASE_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0x17F8EBF0)
#define MOLEMOLE_UIFRIENDCHATMESSAGEWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x17F8EC80)
#define MOLEMOLE_UIFRIENDCHATMESSAGEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17F8ED20)
#define MOLEMOLE_UIFRIENDCHATMESSAGEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17F8EDB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendChatMessageWidgetController_TypeDefinitionIndex = 51909;
	...
	public:
		...
		::Class_2_DF3786176D510571_1_Class_2_82300A0D1A49C358* _playerMsgView; // 0x2F8
		::Class_2_DF3786176D510571_1_Class_2_82300A0D1A49C358_1* _selfMsgView; // 0x300
