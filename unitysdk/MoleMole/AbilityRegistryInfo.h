...
#define MOLEMOLE_ABILITYREGISTRYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16C0A140)

namespace MoleMole
{
	inline static constexpr unsigned int AbilityRegistryInfo_TypeDefinitionIndex = 49246;
