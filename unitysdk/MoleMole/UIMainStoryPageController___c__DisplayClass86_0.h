...
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS86_0__CTOR_OFFSET UNITYSDK_OFFSET(0x189C6180)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS86_0__REFRESHPERSONALLEFTVIEW_B__0_OFFSET UNITYSDK_OFFSET(0x189C6190)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainStoryPageController___c__DisplayClass86_0_TypeDefinitionIndex = 84567;
