...
#define MOLEMOLE_UIRABDATASTATWIDGETCONTROLLER_GETSORTEDDATALIST_OFFSET UNITYSDK_OFFSET(0x17A1A350)
#define MOLEMOLE_UIRABDATASTATWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x17A1AC30)
#define MOLEMOLE_UIRABDATASTATWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17A1AB20)
#define MOLEMOLE_UIRABDATASTATWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x17A1AA80)
#define MOLEMOLE_UIRABDATASTATWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17A1A9D0)
#define MOLEMOLE_UIRABDATASTATWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17A1ABB0)
#define MOLEMOLE_UIRABDATASTATWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17A1A030)
#define MOLEMOLE_UIRABDATASTATWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17A1A120)
#define MOLEMOLE_UIRABDATASTATWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17A1ADA0)
#define MOLEMOLE_UIRABDATASTATWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0x17A1AE80)
#define MOLEMOLE_UIRABDATASTATWIDGETCONTROLLER__ONUIOPEN_B__2_0_OFFSET UNITYSDK_OFFSET(0x17A1AF00)
#define MOLEMOLE_UIRABDATASTATWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x17A1B020)
#define MOLEMOLE_UIRABDATASTATWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x17A1B0B0)
#define MOLEMOLE_UIRABDATASTATWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x17A1B140)
#define MOLEMOLE_UIRABDATASTATWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x17A1B1E0)
#define MOLEMOLE_UIRABDATASTATWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x17A1B270)
#define MOLEMOLE_UIRABDATASTATWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x17A1B300)

namespace MoleMole
{
	inline static constexpr unsigned int UIRABDataStatWidgetController_TypeDefinitionIndex = 61648;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_1_C31F776B3FE6F486_1*>* _dataCache; // 0x2D0
		...
		::System::Collections::Generic::List_1<::Class_1_C31F776B3FE6F486_1*>* GetSortedDataList()
		{
			return ((::System::Collections::Generic::List_1<::Class_1_C31F776B3FE6F486_1*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIRABDATASTATWIDGETCONTROLLER_GETSORTEDDATALIST_OFFSET))(this);
		}
