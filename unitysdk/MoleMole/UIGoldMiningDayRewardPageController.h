...
#define MOLEMOLE_UIGOLDMININGDAYREWARDPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x157AC8B0)
#define MOLEMOLE_UIGOLDMININGDAYREWARDPAGECONTROLLER_ONALLRECEIVEBTNCLICK_OFFSET UNITYSDK_OFFSET(0x157AD050)
#define MOLEMOLE_UIGOLDMININGDAYREWARDPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x157AC8C0)
#define MOLEMOLE_UIGOLDMININGDAYREWARDPAGECONTROLLER_ONGOLDMININGDAYSTATEREWARDGET_OFFSET UNITYSDK_OFFSET(0x157AD2E0)
#define MOLEMOLE_UIGOLDMININGDAYREWARDPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x157ACCB0)
#define MOLEMOLE_UIGOLDMININGDAYREWARDPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x157ACFE0)
#define MOLEMOLE_UIGOLDMININGDAYREWARDPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x157AC950)
#define MOLEMOLE_UIGOLDMININGDAYREWARDPAGECONTROLLER_UPDATEBTN_OFFSET UNITYSDK_OFFSET(0x157ACEB0)
#define MOLEMOLE_UIGOLDMININGDAYREWARDPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x157AD430)
#define MOLEMOLE_UIGOLDMININGDAYREWARDPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x157AD440)
#define MOLEMOLE_UIGOLDMININGDAYREWARDPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x157AD4D0)
#define MOLEMOLE_UIGOLDMININGDAYREWARDPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x157AD4E0)
#define MOLEMOLE_UIGOLDMININGDAYREWARDPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x157AD4F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGoldMiningDayRewardPageController_TypeDefinitionIndex = 69297;

	class UIGoldMiningDayRewardPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_D9B86F043E0024E5* _view; // 0x310
		::Class_1_C50659C1F7858B0C* data; // 0x318
		::System::Collections::Generic::List_1<::MoleMole::UIGoldMiningDayStateRewardEffectItemWidgetController*>* effectList; // 0x320
		::MoleMole::UIGeneralButtonController* effectGetBtn; // 0x328
