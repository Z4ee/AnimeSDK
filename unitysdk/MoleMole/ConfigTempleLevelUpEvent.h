...
#define MOLEMOLE_CONFIGTEMPLELEVELUPEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x161AEC00)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigTempleLevelUpEvent_TypeDefinitionIndex = 68082;
