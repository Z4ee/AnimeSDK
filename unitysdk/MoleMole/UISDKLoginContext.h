...
#define MOLEMOLE_UISDKLOGINCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x14DB20C0)

namespace MoleMole
{
	inline static constexpr unsigned int UISDKLoginContext_TypeDefinitionIndex = 65673;
