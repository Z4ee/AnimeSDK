...
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER___C__DISPLAYCLASS25_1__CTOR_OFFSET UNITYSDK_OFFSET(0x155E1360)
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER___C__DISPLAYCLASS25_1__INITSTATE_B__3_OFFSET UNITYSDK_OFFSET(0x155E1370)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowResultPageController___c__DisplayClass25_1_TypeDefinitionIndex = 80790;
	...
	public:
		...
		::MoleMole::UIHollowResultPageController___c__DisplayClass25_0* CS___8__locals1; // 0x18
