...
#define MOLEMOLE_MONOGHOSTEFFECT_STRUCT_2_F13019C0699F85E5__CTOR_OFFSET UNITYSDK_OFFSET(0x6B8C00)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGhostEffect_Struct_2_F13019C0699F85E5_TypeDefinitionIndex = 70635;
	...
	struct alignas(8) MonoGhostEffect_Struct_2_F13019C0699F85E5
	{
		...
		::System::Boolean Field_2_4; // 0x27
		::MoleMole::Config::ConfigGhostMove* Field_2_11; // 0x28
		::Class_1_EA1FEF8121ADE963* Field_2_10; // 0x30
