...
#define MOLEMOLE_UIABYSSARPEGGIOTALENTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12BE7CE0)
#define MOLEMOLE_UIABYSSARPEGGIOTALENTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x12BE7EE0)
#define MOLEMOLE_UIABYSSARPEGGIOTALENTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12BE7E60)
#define MOLEMOLE_UIABYSSARPEGGIOTALENTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12BE7C80)
#define MOLEMOLE_UIABYSSARPEGGIOTALENTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12BE8430)
#define MOLEMOLE_UIABYSSARPEGGIOTALENTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x12BE8440)
#define MOLEMOLE_UIABYSSARPEGGIOTALENTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x12BE84D0)
#define MOLEMOLE_UIABYSSARPEGGIOTALENTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x12BE8570)
#define MOLEMOLE_UIABYSSARPEGGIOTALENTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x12BE8600)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssArpeggioTalentRowWidgetController_TypeDefinitionIndex = 66365;

	class UIAbyssArpeggioTalentRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_BB7F5BC060EB063F* _view; // 0x2F0
