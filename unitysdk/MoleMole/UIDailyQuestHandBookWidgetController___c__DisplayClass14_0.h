...
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18D3EFB0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___C__DISPLAYCLASS14_0__TRYPLAYCANTAKEREWARDEFFECT_B__0_OFFSET UNITYSDK_OFFSET(0x18D40150)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___C__DISPLAYCLASS14_0__TRYPLAYCANTAKEREWARDEFFECT_G__DOPLAYPROGRESSANIM_2_OFFSET UNITYSDK_OFFSET(0x18D401E0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___C__DISPLAYCLASS14_0__TRYPLAYCANTAKEREWARDEFFECT_G__PLAYANIMATIONTOWARDSCURLEVEL_1_OFFSET UNITYSDK_OFFSET(0x18D3F100)

namespace MoleMole
{
	inline static constexpr unsigned int UIDailyQuestHandBookWidgetController___c__DisplayClass14_0_TypeDefinitionIndex = 43703;
