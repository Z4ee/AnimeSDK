...
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16EFD9F0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___C__DISPLAYCLASS14_0__TRYPLAYCANTAKEREWARDEFFECT_B__0_OFFSET UNITYSDK_OFFSET(0x16EFEB90)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___C__DISPLAYCLASS14_0__TRYPLAYCANTAKEREWARDEFFECT_G__DOPLAYPROGRESSANIM_2_OFFSET UNITYSDK_OFFSET(0x16EFEC20)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___C__DISPLAYCLASS14_0__TRYPLAYCANTAKEREWARDEFFECT_G__PLAYANIMATIONTOWARDSCURLEVEL_1_OFFSET UNITYSDK_OFFSET(0x16EFDB40)

namespace MoleMole
{
	inline static constexpr unsigned int UIDailyQuestHandBookWidgetController___c__DisplayClass14_0_TypeDefinitionIndex = 85075;
