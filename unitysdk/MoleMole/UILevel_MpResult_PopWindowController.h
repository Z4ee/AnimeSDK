...
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER_ACQUIRETITLETEXT_OFFSET UNITYSDK_OFFSET(0x1692B090)
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER_GETBUTTONCOMBINESTATE_OFFSET UNITYSDK_OFFSET(0x1692B150)
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER_GETPANELSTATE_OFFSET UNITYSDK_OFFSET(0x1692B1A0)
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER_ONPOPSHOWED_OFFSET UNITYSDK_OFFSET(0x1692B1F0)
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1692AFE0)
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1692B2F0)
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER__ONPOPSHOWED_B__7_0_OFFSET UNITYSDK_OFFSET(0x1692B320)
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER__ONPOPSHOWED_B__7_1_OFFSET UNITYSDK_OFFSET(0x1692B340)
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER__ONUIOPEN_B__3_0_OFFSET UNITYSDK_OFFSET(0x1692B300)
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1692B360)

namespace MoleMole
{
	inline static constexpr unsigned int UILevel_MpResult_PopWindowController_TypeDefinitionIndex = 68956;
	...
	public:
		...
		{
			return ((::Class_1_451601B8BB62C38C_3_Enum_3_3DCE6AAF7E47B319(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER_GETBUTTONCOMBINESTATE_OFFSET))(this);
		}

		::Class_1_451601B8BB62C38C_3_Enum_3_A188519F532ACB95 GetPanelState()
		{
			return ((::Class_1_451601B8BB62C38C_3_Enum_3_A188519F532ACB95(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER_GETPANELSTATE_OFFSET))(this);
		}
