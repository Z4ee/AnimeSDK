...
#define MOLEMOLE_UIACTIVITYTEAMTRIALCONDITIONROWWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15E4B560)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityTeamTrialConditionRowWidgetController_Context_TypeDefinitionIndex = 44499;
	...
	public:
		...
		::System::Int32 activityAbilityID; // 0x40
