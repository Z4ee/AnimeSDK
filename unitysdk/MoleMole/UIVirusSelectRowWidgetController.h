...
#define MOLEMOLE_UIVIRUSSELECTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19176060)
#define MOLEMOLE_UIVIRUSSELECTROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x19176C40)
#define MOLEMOLE_UIVIRUSSELECTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x19176170)
#define MOLEMOLE_UIVIRUSSELECTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x191760F0)
#define MOLEMOLE_UIVIRUSSELECTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19175EB0)
#define MOLEMOLE_UIVIRUSSELECTROWWIDGETCONTROLLER_REFRESHDATA_OFFSET UNITYSDK_OFFSET(0x19176820)
#define MOLEMOLE_UIVIRUSSELECTROWWIDGETCONTROLLER_REFRESHVIRUS_OFFSET UNITYSDK_OFFSET(0x19176290)
#define MOLEMOLE_UIVIRUSSELECTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19176CD0)
#define MOLEMOLE_UIVIRUSSELECTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19176CE0)
#define MOLEMOLE_UIVIRUSSELECTROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x19176D70)
#define MOLEMOLE_UIVIRUSSELECTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x19176E00)
#define MOLEMOLE_UIVIRUSSELECTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19176EA0)
#define MOLEMOLE_UIVIRUSSELECTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19176F30)

namespace MoleMole
{
	inline static constexpr unsigned int UIVirusSelectRowWidgetController_TypeDefinitionIndex = 69698;

	class UIVirusSelectRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_A8C94EA612F5CBF3_11* _view; // 0x2F0
