...
#define MOLEMOLE_OPENGETCOLLECTDIALOGMESSAGE_GET_ISTRIGGERINLOADING_OFFSET UNITYSDK_OFFSET(0x16CE0470)
#define MOLEMOLE_OPENGETCOLLECTDIALOGMESSAGE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x16CE0460)
#define MOLEMOLE_OPENGETCOLLECTDIALOGMESSAGE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x16CE04C0)
#define MOLEMOLE_OPENGETCOLLECTDIALOGMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16CE0480)

namespace MoleMole
{
	inline static constexpr unsigned int OpenGetCollectDialogMessage_TypeDefinitionIndex = 59317;
