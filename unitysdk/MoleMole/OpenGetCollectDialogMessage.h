...
#define MOLEMOLE_OPENGETCOLLECTDIALOGMESSAGE_GET_ISTRIGGERINLOADING_OFFSET UNITYSDK_OFFSET(0x13ACCF80)
#define MOLEMOLE_OPENGETCOLLECTDIALOGMESSAGE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x13ACCF70)
#define MOLEMOLE_OPENGETCOLLECTDIALOGMESSAGE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x13ACCFD0)
#define MOLEMOLE_OPENGETCOLLECTDIALOGMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x13ACCF90)

namespace MoleMole
{
	inline static constexpr unsigned int OpenGetCollectDialogMessage_TypeDefinitionIndex = 45326;
