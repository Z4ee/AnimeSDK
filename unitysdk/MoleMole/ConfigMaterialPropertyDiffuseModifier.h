...
#define MOLEMOLE_CONFIGMATERIALPROPERTYDIFFUSEMODIFIER_DOAFTERONENTER_OFFSET UNITYSDK_OFFSET(0x18AE0100)
#define MOLEMOLE_CONFIGMATERIALPROPERTYDIFFUSEMODIFIER_DOONENTER_OFFSET UNITYSDK_OFFSET(0x18AE0040)
#define MOLEMOLE_CONFIGMATERIALPROPERTYDIFFUSEMODIFIER_DOWARMUP_OFFSET UNITYSDK_OFFSET(0x18AE0E20)
#define MOLEMOLE_CONFIGMATERIALPROPERTYDIFFUSEMODIFIER_PREPAREONENTER_OFFSET UNITYSDK_OFFSET(0x18ADFEE0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYDIFFUSEMODIFIER_PREPAREONEXIT_OFFSET UNITYSDK_OFFSET(0x18AE01F0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYDIFFUSEMODIFIER_PROCESSENTER_OFFSET UNITYSDK_OFFSET(0x18AE0160)
#define MOLEMOLE_CONFIGMATERIALPROPERTYDIFFUSEMODIFIER_PROCESSEXIT_OFFSET UNITYSDK_OFFSET(0x18AE0230)
#define MOLEMOLE_CONFIGMATERIALPROPERTYDIFFUSEMODIFIER_PROCESSKEEP_OFFSET UNITYSDK_OFFSET(0x18AE06F0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYDIFFUSEMODIFIER_SYNCENABLES_OFFSET UNITYSDK_OFFSET(0x18AE04F0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYDIFFUSEMODIFIER_SYNCVALUES_OFFSET UNITYSDK_OFFSET(0x18AE0320)
#define MOLEMOLE_CONFIGMATERIALPROPERTYDIFFUSEMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x18AE0EB0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigMaterialPropertyDiffuseModifier_TypeDefinitionIndex = 48984;

	class ConfigMaterialPropertyDiffuseModifier : public ::MoleMole::ConfigMaterialPropertyModifier
	{
	public:
		::MoleMole::MaterialPropertyModifierValueFloat _AlbedoSmoothness; // 0x48
		::MoleMole::MaterialPropertyModifierValueColor _ShadowColor; // 0x50
		::MoleMole::MaterialPropertyModifierValueColor _ShallowColor; // 0x64
		::MoleMole::MaterialPropertyModifierValueBool _ShadowColorFadeByZ; // 0x78
