...
#define MOLEMOLE_ANIMATORBLENDGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x17022200)

namespace MoleMole
{
	inline static constexpr unsigned int AnimatorBlendGroup_TypeDefinitionIndex = 49882;

	class AnimatorBlendGroup : public ::System::Object
	{
	public:
		::System::String* BlendParam; // 0x10
