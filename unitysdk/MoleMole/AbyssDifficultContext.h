...
#define MOLEMOLE_ABYSSDIFFICULTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x12CFA620)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssDifficultContext_TypeDefinitionIndex = 58680;
