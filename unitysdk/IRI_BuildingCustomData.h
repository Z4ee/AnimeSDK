...
#define IRI_BUILDINGCUSTOMDATA_METHOD_6_A2846FC5EA0763C6_OFFSET UNITYSDK_OFFSET(0x111DAC70)
#define IRI_BUILDINGCUSTOMDATA_METHOD_6_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x111DABF0)
#define IRI_BUILDINGCUSTOMDATA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x111DABB0)
#define IRI_BUILDINGCUSTOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x111DAC90)

inline static constexpr unsigned int IRI_BuildingCustomData_TypeDefinitionIndex = 38080;
