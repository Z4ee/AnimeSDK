...
#define IRI_BUILDINGCUSTOMDATA_METHOD_6_A2846FC5EA0763C6_OFFSET UNITYSDK_OFFSET(0x1423C310)
#define IRI_BUILDINGCUSTOMDATA_METHOD_6_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x1423C290)
#define IRI_BUILDINGCUSTOMDATA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1423C250)
#define IRI_BUILDINGCUSTOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1423C330)

inline static constexpr unsigned int IRI_BuildingCustomData_TypeDefinitionIndex = 44506;
