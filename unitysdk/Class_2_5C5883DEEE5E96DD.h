...
#define CLASS_2_5C5883DEEE5E96DD_DISPOSE_OFFSET UNITYSDK_OFFSET(0x188BE570)
#define CLASS_2_5C5883DEEE5E96DD_METHOD_2_50DAA2D68A6C09FD_OFFSET UNITYSDK_OFFSET(0x188BF190)
#define CLASS_2_5C5883DEEE5E96DD_METHOD_2_7FF1F5DCD746CB3B_OFFSET UNITYSDK_OFFSET(0x188BEE80)
#define CLASS_2_5C5883DEEE5E96DD_METHOD_2_8C3DB70FFBBF01C7_OFFSET UNITYSDK_OFFSET(0x188BEC90)
#define CLASS_2_5C5883DEEE5E96DD_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x188BE710)
#define CLASS_2_5C5883DEEE5E96DD_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x188BF350)
#define CLASS_2_5C5883DEEE5E96DD_TICK_OFFSET UNITYSDK_OFFSET(0x188BF280)
#define CLASS_2_5C5883DEEE5E96DD__CTOR_OFFSET UNITYSDK_OFFSET(0x188BE560)
...
public:
	...
	::RPG::GameCore::AddSneakEffect* OFKGLJOAMLD; // 0x28
	::RPG::GameCore::CharacterVisibleComponent* MDDDGNIOKOF; // 0x30
	::Class_3_07C3C4D2990C49EE* MIDNKFFEBMG; // 0x38
