...
#define HIPPLENBUILDERRINGDETECTOR_GETCLOSESTPREDICTIONPOINT_OFFSET UNITYSDK_OFFSET(0x11E06B90)
#define HIPPLENBUILDERRINGDETECTOR_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x11E09200)
#define HIPPLENBUILDERRINGDETECTOR_ONTRIGGERSTAY_OFFSET UNITYSDK_OFFSET(0x11E095F0)
#define HIPPLENBUILDERRINGDETECTOR_PREDICTFUTUREPOSITIONS_OFFSET UNITYSDK_OFFSET(0x11E08FB0)
#define HIPPLENBUILDERRINGDETECTOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x11E08820)
#define HIPPLENBUILDERRINGDETECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x11E09850)

inline static constexpr unsigned int HipplenBuilderRingDetector_TypeDefinitionIndex = 43998;
