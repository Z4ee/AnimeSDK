...
#define HIPPLENBUILDERRINGDETECTOR_GETCLOSESTPREDICTIONPOINT_OFFSET UNITYSDK_OFFSET(0x18DD1350)
#define HIPPLENBUILDERRINGDETECTOR_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x18DD38D0)
#define HIPPLENBUILDERRINGDETECTOR_ONTRIGGERSTAY_OFFSET UNITYSDK_OFFSET(0x18DD3D30)
#define HIPPLENBUILDERRINGDETECTOR_PREDICTFUTUREPOSITIONS_OFFSET UNITYSDK_OFFSET(0x18DD3640)
#define HIPPLENBUILDERRINGDETECTOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x18DD2EF0)
#define HIPPLENBUILDERRINGDETECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18DD3F90)
