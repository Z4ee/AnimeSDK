...
#define HIPPLENBUILDERRINGDETECTOR_GETCLOSESTPREDICTIONPOINT_OFFSET UNITYSDK_OFFSET(0x17A66380)
#define HIPPLENBUILDERRINGDETECTOR_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x17A688E0)
#define HIPPLENBUILDERRINGDETECTOR_ONTRIGGERSTAY_OFFSET UNITYSDK_OFFSET(0x17A68D40)
#define HIPPLENBUILDERRINGDETECTOR_PREDICTFUTUREPOSITIONS_OFFSET UNITYSDK_OFFSET(0x17A68650)
#define HIPPLENBUILDERRINGDETECTOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x17A67F00)
#define HIPPLENBUILDERRINGDETECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17A68FA0)

inline static constexpr unsigned int HipplenBuilderRingDetector_TypeDefinitionIndex = 45416;
