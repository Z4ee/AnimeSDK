...
#define CLASS_2_781A24D57CD122C5_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x17C754D0)
#define CLASS_2_781A24D57CD122C5_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x17C757C0)
#define CLASS_2_781A24D57CD122C5_GET_PROGRESSCHANGEANIMENDPROMISE_OFFSET UNITYSDK_OFFSET(0x17C75230)
#define CLASS_2_781A24D57CD122C5_GET_SCEPTERDATA_OFFSET UNITYSDK_OFFSET(0x17C74F70)
#define CLASS_2_781A24D57CD122C5_METHOD_2_18D9238B9C310BFF_OFFSET UNITYSDK_OFFSET(0x17C750E0)
#define CLASS_2_781A24D57CD122C5_METHOD_2_307A59CF13188EC9_OFFSET UNITYSDK_OFFSET(0x17C74C30)
#define CLASS_2_781A24D57CD122C5_METHOD_2_57D5ED2C4C06D908_OFFSET UNITYSDK_OFFSET(0x17C749E0)
#define CLASS_2_781A24D57CD122C5_METHOD_2_6774EDC23D24BE2B_OFFSET UNITYSDK_OFFSET(0x17C748B0)
#define CLASS_2_781A24D57CD122C5_METHOD_2_7BBBC241D67B44B9_OFFSET UNITYSDK_OFFSET(0x17C74940)
#define CLASS_2_781A24D57CD122C5_METHOD_2_C436A2848092EB88_OFFSET UNITYSDK_OFFSET(0x17C74220)
#define CLASS_2_781A24D57CD122C5_METHOD_2_D2A08F3D951A0C1D_OFFSET UNITYSDK_OFFSET(0x17C74F90)
#define CLASS_2_781A24D57CD122C5_METHOD_2_DA4B4F9A7740A91B_OFFSET UNITYSDK_OFFSET(0x17C745B0)
#define CLASS_2_781A24D57CD122C5_METHOD_2_DAEB67F34AF80609_1_OFFSET UNITYSDK_OFFSET(0x17C752F0)
#define CLASS_2_781A24D57CD122C5_METHOD_2_DAEB67F34AF80609_OFFSET UNITYSDK_OFFSET(0x17C75080)
#define CLASS_2_781A24D57CD122C5_METHOD_2_E9A5CB8132825E13_OFFSET UNITYSDK_OFFSET(0x17C75250)
#define CLASS_2_781A24D57CD122C5_METHOD_2_F37CDBD6D46274D2_1_OFFSET UNITYSDK_OFFSET(0x17C75410)
#define CLASS_2_781A24D57CD122C5_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x17C75350)
#define CLASS_2_781A24D57CD122C5_METHOD_2_F927290E0B896A8F_OFFSET UNITYSDK_OFFSET(0x17C74350)
#define CLASS_2_781A24D57CD122C5_SET_PROGRESSCHANGEANIMENDPROMISE_OFFSET UNITYSDK_OFFSET(0x17C75240)
#define CLASS_2_781A24D57CD122C5_SET_SCEPTERDATA_OFFSET UNITYSDK_OFFSET(0x17C74F80)
#define CLASS_2_781A24D57CD122C5__CTOR_OFFSET UNITYSDK_OFFSET(0x17C75A70)
#define CLASS_2_781A24D57CD122C5__ONBIND_OFFSET UNITYSDK_OFFSET(0x17C73EF0)
#define CLASS_2_781A24D57CD122C5___PLAYSPCHANGEANIM_B__22_0_OFFSET UNITYSDK_OFFSET(0x17C75AA0)

inline static constexpr unsigned int Class_2_781A24D57CD122C5_TypeDefinitionIndex = 69040;
...
public:
	...
	::RPG::Client::RogueMagicScepterDataItem* _ScepterData_k__BackingField; // 0x78
	::UnityEngine::Animation* Field_2_4; // 0x80
	::UnityEngine::Transform* Field_2_5; // 0x88
	::RPG::Client::Promises::Promise* Field_2_6; // 0x90
	::UnityEngine::Coroutine* Field_2_7; // 0x98
	::RPG::Client::Promises::Promise* _ProgressChangeAnimEndPromise_k__BackingField; // 0xA0
	::RPG::Client::UIValueChangeAnimation* Field_2_9; // 0xA8
	::RPG::Client::UIValueChangeAnimation* Field_2_10; // 0xB0
	::RPG::Client::RPGAnimationEvent* Field_2_11; // 0xB8
	::UnityEngine::Transform* Field_2_12; // 0xC0
	::UnityEngine::UI::Image* Field_2_13; // 0xC8
	::UnityEngine::UI::Image* Field_2_14; // 0xD0
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_781A24D57CD122C5_METHOD_2_C436A2848092EB88_OFFSET))(this);
	}
