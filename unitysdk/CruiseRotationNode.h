...
#define CRUISEROTATIONNODE_GET_CURRENTPITCHANGLE_OFFSET UNITYSDK_OFFSET(0x16B4D640)
#define CRUISEROTATIONNODE_GET_CURRENTROLLANGLE_OFFSET UNITYSDK_OFFSET(0x16B4D630)
#define CRUISEROTATIONNODE_METHOD_1_031DC55E7B9F51C9_OFFSET UNITYSDK_OFFSET(0x16B4D240)
#define CRUISEROTATIONNODE_METHOD_1_0BC3FBBF9075A049_OFFSET UNITYSDK_OFFSET(0x16B4D650)
#define CRUISEROTATIONNODE_METHOD_1_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x16B4D140)
#define CRUISEROTATIONNODE_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x16B4D570)
#define CRUISEROTATIONNODE_METHOD_1_700D287A85A1E345_OFFSET UNITYSDK_OFFSET(0x16B4BDC0)
#define CRUISEROTATIONNODE_METHOD_1_B49D9DFCA7DAD6C6_OFFSET UNITYSDK_OFFSET(0x16B4CD30)
#define CRUISEROTATIONNODE_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x16B4D5E0)
#define CRUISEROTATIONNODE_METHOD_1_F10A0D072D26C4BF_OFFSET UNITYSDK_OFFSET(0x16B4D7A0)
#define CRUISEROTATIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x16B4D4B0)

inline static constexpr unsigned int CruiseRotationNode_TypeDefinitionIndex = 45542;
