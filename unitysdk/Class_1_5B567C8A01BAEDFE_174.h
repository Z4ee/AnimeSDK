...
#define CLASS_1_5B567C8A01BAEDFE_174_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19FD0E80)
#define CLASS_1_5B567C8A01BAEDFE_174_CLONE_OFFSET UNITYSDK_OFFSET(0x19FD0C90)
#define CLASS_1_5B567C8A01BAEDFE_174_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19FD0D90)
#define CLASS_1_5B567C8A01BAEDFE_174_EQUALS_OFFSET UNITYSDK_OFFSET(0x19FD0D00)
#define CLASS_1_5B567C8A01BAEDFE_174_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19FD0DE0)
#define CLASS_1_5B567C8A01BAEDFE_174_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19FD0ED0)
#define CLASS_1_5B567C8A01BAEDFE_174_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19FD0EA0)
#define CLASS_1_5B567C8A01BAEDFE_174_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19FD0BE0)
#define CLASS_1_5B567C8A01BAEDFE_174_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19FD0C40)
#define CLASS_1_5B567C8A01BAEDFE_174_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19FD0E10)
#define CLASS_1_5B567C8A01BAEDFE_174_WRITETO_OFFSET UNITYSDK_OFFSET(0x19FD0E70)
#define CLASS_1_5B567C8A01BAEDFE_174__CCTOR_OFFSET UNITYSDK_OFFSET(0x19FD0F20)
#define CLASS_1_5B567C8A01BAEDFE_174__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19FD0C60)
#define CLASS_1_5B567C8A01BAEDFE_174__CTOR_OFFSET UNITYSDK_OFFSET(0x19FD0C50)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_174_TypeDefinitionIndex = 28230;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_174*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_174_TypeDefinitionIndex)->GetStaticField(0x259A0);
	}
