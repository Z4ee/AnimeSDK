...
#define CLASS_2_F8A32961AECFF5C5_METHOD_2_201F56A9F246A225_OFFSET UNITYSDK_OFFSET(0x15567260)
#define CLASS_2_F8A32961AECFF5C5_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x155676C0)
#define CLASS_2_F8A32961AECFF5C5_METHOD_2_4C288C0C3DC7B4CA_OFFSET UNITYSDK_OFFSET(0x15567610)
#define CLASS_2_F8A32961AECFF5C5_ONCLEAR_OFFSET UNITYSDK_OFFSET(0x15567670)
#define CLASS_2_F8A32961AECFF5C5_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x15567310)
#define CLASS_2_F8A32961AECFF5C5__CTOR_OFFSET UNITYSDK_OFFSET(0x15567720)

inline static constexpr unsigned int Class_2_F8A32961AECFF5C5_TypeDefinitionIndex = 79528;
...
public:
	...
	::UnityEngine::RectTransform* GKNBCPMJHMN; // 0x30
