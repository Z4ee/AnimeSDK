...
#define MONONOTRELATEGAMELOGIC_MONOCUSTOMTEXTMESH_AWAKE_OFFSET UNITYSDK_OFFSET(0xE871520)
#define MONONOTRELATEGAMELOGIC_MONOCUSTOMTEXTMESH_REBUILD_OFFSET UNITYSDK_OFFSET(0xE871630)
#define MONONOTRELATEGAMELOGIC_MONOCUSTOMTEXTMESH__CTOR_OFFSET UNITYSDK_OFFSET(0xE8717B0)

namespace MonoNotRelateGameLogic
{
	inline static constexpr unsigned int MonoCustomTextMesh_TypeDefinitionIndex = 48494;
