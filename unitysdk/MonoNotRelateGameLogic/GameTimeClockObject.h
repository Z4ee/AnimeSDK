...
#define MONONOTRELATEGAMELOGIC_GAMETIMECLOCKOBJECT_GETUINT_OFFSET UNITYSDK_OFFSET(0x139E8190)
#define MONONOTRELATEGAMELOGIC_GAMETIMECLOCKOBJECT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x139E7FC0)
#define MONONOTRELATEGAMELOGIC_GAMETIMECLOCKOBJECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x139E7A90)
#define MONONOTRELATEGAMELOGIC_GAMETIMECLOCKOBJECT_ONMAINCITYTIMECHANGED_OFFSET UNITYSDK_OFFSET(0x139E8140)
#define MONONOTRELATEGAMELOGIC_GAMETIMECLOCKOBJECT_UPDATECLOCKTIME_OFFSET UNITYSDK_OFFSET(0x139E7DB0)
#define MONONOTRELATEGAMELOGIC_GAMETIMECLOCKOBJECT_UPDATEHANDROTATION_OFFSET UNITYSDK_OFFSET(0x139E8210)
#define MONONOTRELATEGAMELOGIC_GAMETIMECLOCKOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x139E85A0)

namespace MonoNotRelateGameLogic
{
	inline static constexpr unsigned int GameTimeClockObject_TypeDefinitionIndex = 63804;
