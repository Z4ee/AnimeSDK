...
#define MONONOTRELATEGAMELOGIC_GAMETIMECLOCKOBJECT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1345E570)
#define MONONOTRELATEGAMELOGIC_GAMETIMECLOCKOBJECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1345E0F0)
#define MONONOTRELATEGAMELOGIC_GAMETIMECLOCKOBJECT_ONMAINCITYTIMECHANGED_OFFSET UNITYSDK_OFFSET(0x1345E6F0)
#define MONONOTRELATEGAMELOGIC_GAMETIMECLOCKOBJECT_UPDATECLOCKTIME_OFFSET UNITYSDK_OFFSET(0x1345E410)
#define MONONOTRELATEGAMELOGIC_GAMETIMECLOCKOBJECT_UPDATEHANDROTATION_OFFSET UNITYSDK_OFFSET(0x1345E740)
#define MONONOTRELATEGAMELOGIC_GAMETIMECLOCKOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1345EAD0)

namespace MonoNotRelateGameLogic
{
	inline static constexpr unsigned int GameTimeClockObject_TypeDefinitionIndex = 82697;
