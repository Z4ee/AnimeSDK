...
#define CLASS_1_255F5FB2CE4ABA28___C__DISPLAYCLASS10_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1600EDC0)
#define CLASS_1_255F5FB2CE4ABA28___C__DISPLAYCLASS10_0__SHOWGAMESETTLE_B__0_OFFSET UNITYSDK_OFFSET(0x1600FCD0)

inline static constexpr unsigned int Class_1_255F5FB2CE4ABA28___c__DisplayClass10_0_TypeDefinitionIndex = 76331;

class Class_1_255F5FB2CE4ABA28___c__DisplayClass10_0 : public ::System::Object
{
public:
	::Class_1_D55DA8BFAC94B3A4_2* levelData; // 0x10
	::Class_1_5F4D64A4B97E38F9* messenger; // 0x18
	::RPG::Client::Promises::Promise* promise; // 0x20
	::Class_1_255F5FB2CE4ABA28* __4__this; // 0x28
