...
#define FIELDAOVOLUME_METHOD_5_1290EA767C459179_1_OFFSET UNITYSDK_OFFSET(0x1064D660)
#define FIELDAOVOLUME_METHOD_5_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x1064D0D0)
#define FIELDAOVOLUME_METHOD_5_7995D2033C97D105_OFFSET UNITYSDK_OFFSET(0x1064DB60)
#define FIELDAOVOLUME_METHOD_5_87318FF00D6BC7EB_OFFSET UNITYSDK_OFFSET(0x1064D240)
#define FIELDAOVOLUME_METHOD_5_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0x1064CFC0)
#define FIELDAOVOLUME_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1064DA80)
#define FIELDAOVOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1064D770)
#define FIELDAOVOLUME_START_OFFSET UNITYSDK_OFFSET(0x1064D1C0)
#define FIELDAOVOLUME_UPDATEMATRIX_OFFSET UNITYSDK_OFFSET(0x1064D850)
#define FIELDAOVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x1064DF80)

inline static constexpr unsigned int FieldAOVolume_TypeDefinitionIndex = 38370;
...
public:
	...
	{
		return (::UnityEngine::Material**)Il2CppClass::FromTypeDefinitionIndex(FieldAOVolume_TypeDefinitionIndex)->GetStaticField(0x23DF0);
	}
