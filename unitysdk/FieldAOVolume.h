...
#define FIELDAOVOLUME_METHOD_5_07FE6948AE52EE96_OFFSET UNITYSDK_OFFSET(0x156092A0)
#define FIELDAOVOLUME_METHOD_5_1290EA767C459179_1_OFFSET UNITYSDK_OFFSET(0x15608DA0)
#define FIELDAOVOLUME_METHOD_5_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x156087D0)
#define FIELDAOVOLUME_METHOD_5_8714CF4AE9195CA2_OFFSET UNITYSDK_OFFSET(0x15608940)
#define FIELDAOVOLUME_METHOD_5_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0x156086C0)
#define FIELDAOVOLUME_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x156091C0)
#define FIELDAOVOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0x15608EB0)
#define FIELDAOVOLUME_START_OFFSET UNITYSDK_OFFSET(0x156088C0)
#define FIELDAOVOLUME_UPDATEMATRIX_OFFSET UNITYSDK_OFFSET(0x15608F90)
#define FIELDAOVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x15609720)
...
public:
	...
	{
		return (::UnityEngine::Material**)Il2CppClass::FromTypeDefinitionIndex(FieldAOVolume_TypeDefinitionIndex)->GetStaticField(0x17BD0);
	}
