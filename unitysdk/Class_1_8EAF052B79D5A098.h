...
#define CLASS_1_8EAF052B79D5A098_METHOD_1_821D4346A7E0B2C4_OFFSET UNITYSDK_OFFSET(0x16D9AAC0)
#define CLASS_1_8EAF052B79D5A098_METHOD_1_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x16D9AA50)
#define CLASS_1_8EAF052B79D5A098_METHOD_1_9F25BB8F0AC58CBF_OFFSET UNITYSDK_OFFSET(0x16D9ACC0)
#define CLASS_1_8EAF052B79D5A098_METHOD_1_AA2D3E889C8A52CA_OFFSET UNITYSDK_OFFSET(0x16D9AA00)
#define CLASS_1_8EAF052B79D5A098_METHOD_1_ACE6B9BC84CA2B23_OFFSET UNITYSDK_OFFSET(0x16D9AAD0)
#define CLASS_1_8EAF052B79D5A098_METHOD_1_B40EAC74438AB608_OFFSET UNITYSDK_OFFSET(0x16D9AAE0)
#define CLASS_1_8EAF052B79D5A098_METHOD_1_BC62B9FB87FD6A48_OFFSET UNITYSDK_OFFSET(0x16D9AAB0)
#define CLASS_1_8EAF052B79D5A098__CTOR_OFFSET UNITYSDK_OFFSET(0x16D9ADD0)

inline static constexpr unsigned int Class_1_8EAF052B79D5A098_TypeDefinitionIndex = 54510;

class Class_1_8EAF052B79D5A098 : public ::System::Object
{
public:
	::RPG::GameCore::ILBattleAvatarSkillConfigRow* IBPBJBOKKMF; // 0x10
	::Il2CppArray<::RPG::GameCore::FixPoint>* BGEOOALFJOL; // 0x18
	::RPG::GameCore::RtSkillConfig* IGHAHBNLIJA; // 0x20
