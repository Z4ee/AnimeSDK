...
#define CLASS_1_E3144EBBA3CB68CA_CLASS_1_2C6DF30B62E4D0CA_EQUALS_OFFSET UNITYSDK_OFFSET(0xE8ADC90)
#define CLASS_1_E3144EBBA3CB68CA_CLASS_1_2C6DF30B62E4D0CA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xE8ADD80)
#define CLASS_1_E3144EBBA3CB68CA_CLASS_1_2C6DF30B62E4D0CA_TOSTRING_OFFSET UNITYSDK_OFFSET(0xE8ADEC0)
#define CLASS_1_E3144EBBA3CB68CA_CLASS_1_2C6DF30B62E4D0CA__CTOR_OFFSET UNITYSDK_OFFSET(0xE89F550)

inline static constexpr unsigned int Class_1_E3144EBBA3CB68CA_Class_1_2C6DF30B62E4D0CA_TypeDefinitionIndex = 49551;

class Class_1_E3144EBBA3CB68CA_Class_1_2C6DF30B62E4D0CA : public ::System::Object
{
public:
	::System::String* ACDAFHAFPHI; // 0x10
	::System::String* ELFIBPKLELI; // 0x18
	::System::Int32 JHBAAEHHPDE; // 0x20
	::System::Int32 KBKCIKHHFDL; // 0x24
	::RPG::CustomRP::CustomLightQualityFilter JFDEKLAJGNH; // 0x28
