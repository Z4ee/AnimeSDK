...
#define CUSTOMSKIN_OVERSEAVERIFYPHONENUMBER__COUNTDOWN_D__17_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x16530CC0)
#define CUSTOMSKIN_OVERSEAVERIFYPHONENUMBER__COUNTDOWN_D__17_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16530E50)
#define CUSTOMSKIN_OVERSEAVERIFYPHONENUMBER__COUNTDOWN_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16530EB0)
#define CUSTOMSKIN_OVERSEAVERIFYPHONENUMBER__COUNTDOWN_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x16530E60)
#define CUSTOMSKIN_OVERSEAVERIFYPHONENUMBER__COUNTDOWN_D__17_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16530CB0)
#define CUSTOMSKIN_OVERSEAVERIFYPHONENUMBER__COUNTDOWN_D__17__CTOR_OFFSET UNITYSDK_OFFSET(0x16530CA0)

inline static constexpr unsigned int CustomSkin_OverseaVerifyPhoneNumber__CountDown_d__17_TypeDefinitionIndex = 41639;
