...
#define CLASS_1_B590C31C505191E5_7_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1D010D20)
#define CLASS_1_B590C31C505191E5_7_CLONE_OFFSET UNITYSDK_OFFSET(0x1D0107D0)
#define CLASS_1_B590C31C505191E5_7_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1D010980)
#define CLASS_1_B590C31C505191E5_7_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D010850)
#define CLASS_1_B590C31C505191E5_7_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D010A80)
#define CLASS_1_B590C31C505191E5_7_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1D010E00)
#define CLASS_1_B590C31C505191E5_7_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1D010DB0)
#define CLASS_1_B590C31C505191E5_7_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1D010680)
#define CLASS_1_B590C31C505191E5_7_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1D010840)
#define CLASS_1_B590C31C505191E5_7_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1D010830)
#define CLASS_1_B590C31C505191E5_7_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1D010820)
#define CLASS_1_B590C31C505191E5_7_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1D0106E0)
#define CLASS_1_B590C31C505191E5_7_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D010B80)
#define CLASS_1_B590C31C505191E5_7_WRITETO_OFFSET UNITYSDK_OFFSET(0x1D010BE0)
#define CLASS_1_B590C31C505191E5_7__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D010FE0)
#define CLASS_1_B590C31C505191E5_7__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D010740)
#define CLASS_1_B590C31C505191E5_7__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0106F0)

inline static constexpr unsigned int Class_1_B590C31C505191E5_7_TypeDefinitionIndex = 28880;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_B590C31C505191E5_7*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B590C31C505191E5_7_TypeDefinitionIndex)->GetStaticField(0x4C7A0);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B590C31C505191E5_7_TypeDefinitionIndex)->GetStaticField(0x4C7A8);
	}
