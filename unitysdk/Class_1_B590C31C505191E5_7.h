...
#define CLASS_1_B590C31C505191E5_7_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A3819A0)
#define CLASS_1_B590C31C505191E5_7_CLONE_OFFSET UNITYSDK_OFFSET(0x1A381580)
#define CLASS_1_B590C31C505191E5_7_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A3816D0)
#define CLASS_1_B590C31C505191E5_7_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A381600)
#define CLASS_1_B590C31C505191E5_7_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A381770)
#define CLASS_1_B590C31C505191E5_7_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A381A80)
#define CLASS_1_B590C31C505191E5_7_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A381A30)
#define CLASS_1_B590C31C505191E5_7_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A381430)
#define CLASS_1_B590C31C505191E5_7_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1A3815F0)
#define CLASS_1_B590C31C505191E5_7_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1A3815E0)
#define CLASS_1_B590C31C505191E5_7_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1A3815D0)
#define CLASS_1_B590C31C505191E5_7_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A381490)
#define CLASS_1_B590C31C505191E5_7_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A381870)
#define CLASS_1_B590C31C505191E5_7_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A3818D0)
#define CLASS_1_B590C31C505191E5_7__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A381C50)
#define CLASS_1_B590C31C505191E5_7__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3814F0)
#define CLASS_1_B590C31C505191E5_7__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3814A0)

inline static constexpr unsigned int Class_1_B590C31C505191E5_7_TypeDefinitionIndex = 28446;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_B590C31C505191E5_7*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B590C31C505191E5_7_TypeDefinitionIndex)->GetStaticField(0x591E0);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B590C31C505191E5_7_TypeDefinitionIndex)->GetStaticField(0x591E8);
	}
	...
	static ::Google::Protobuf::MessageParser_1<::Class_1_B590C31C505191E5_7*>* Method_1_33819E510657F52F()
	{
		return ((::Google::Protobuf::MessageParser_1<::Class_1_B590C31C505191E5_7*>*(*)())((::PBYTE)hIl2Cpp + CLASS_1_B590C31C505191E5_7_METHOD_1_33819E510657F52F_OFFSET))();
	}
