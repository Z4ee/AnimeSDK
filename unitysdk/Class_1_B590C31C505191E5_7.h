...
#define CLASS_1_B590C31C505191E5_7_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E1C1190)
#define CLASS_1_B590C31C505191E5_7_CLONE_OFFSET UNITYSDK_OFFSET(0x1E1C0CC0)
#define CLASS_1_B590C31C505191E5_7_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E1C0E20)
#define CLASS_1_B590C31C505191E5_7_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E1C0D20)
#define CLASS_1_B590C31C505191E5_7_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E1C0F20)
#define CLASS_1_B590C31C505191E5_7_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E1C1250)
#define CLASS_1_B590C31C505191E5_7_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E1C1200)
#define CLASS_1_B590C31C505191E5_7_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1E1C0CF0)
#define CLASS_1_B590C31C505191E5_7_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E1C0BA0)
#define CLASS_1_B590C31C505191E5_7_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1E1C0D10)
#define CLASS_1_B590C31C505191E5_7_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1E1C0D00)
#define CLASS_1_B590C31C505191E5_7_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E1C0BD0)
#define CLASS_1_B590C31C505191E5_7_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E1C1020)
#define CLASS_1_B590C31C505191E5_7_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E1C1080)
#define CLASS_1_B590C31C505191E5_7__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E1C1410)
#define CLASS_1_B590C31C505191E5_7__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E1C0C30)
#define CLASS_1_B590C31C505191E5_7__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1C0BE0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_B590C31C505191E5_7*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B590C31C505191E5_7_TypeDefinitionIndex)->GetStaticField(0x2E1A0);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_IDLJKBKMMHG()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B590C31C505191E5_7_TypeDefinitionIndex)->GetStaticField(0x2E1A8);
	}
