...
#define SCENEOBJECTTRAFFICLIGHTCONFIG_CAR_TRAFFIC__CTOR_OFFSET UNITYSDK_OFFSET(0x1AADB370)

inline static constexpr unsigned int SceneObjectTrafficLightConfig_Car_Traffic_TypeDefinitionIndex = 49590;
