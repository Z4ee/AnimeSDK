...
#define CLASS_2_1D6506F91EF0330B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x169D2990)
#define CLASS_2_1D6506F91EF0330B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x169D29D0)
#define CLASS_2_1D6506F91EF0330B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x169D2BD0)
#define CLASS_2_1D6506F91EF0330B_TICK_OFFSET UNITYSDK_OFFSET(0x169D2C20)
#define CLASS_2_1D6506F91EF0330B__CTOR_OFFSET UNITYSDK_OFFSET(0x169D2980)

inline static constexpr unsigned int Class_2_1D6506F91EF0330B_TypeDefinitionIndex = 53060;

class Class_2_1D6506F91EF0330B : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SetTargetAnimSpeedScale* Field_2_0; // 0x18
