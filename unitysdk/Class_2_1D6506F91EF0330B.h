...
#define CLASS_2_1D6506F91EF0330B_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB9D1940)
#define CLASS_2_1D6506F91EF0330B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB9D1980)
#define CLASS_2_1D6506F91EF0330B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB9D1B80)
#define CLASS_2_1D6506F91EF0330B_TICK_OFFSET UNITYSDK_OFFSET(0xB9D1BD0)
#define CLASS_2_1D6506F91EF0330B__CTOR_OFFSET UNITYSDK_OFFSET(0xB9D1930)

inline static constexpr unsigned int Class_2_1D6506F91EF0330B_TypeDefinitionIndex = 51907;

class Class_2_1D6506F91EF0330B : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::SetTargetAnimSpeedScale* Field_2_1; // 0x20
