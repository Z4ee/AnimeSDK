...
#define CLASS_1_5B567C8A01BAEDFE_64_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A0A9720)
#define CLASS_1_5B567C8A01BAEDFE_64_CLONE_OFFSET UNITYSDK_OFFSET(0x1A0A9530)
#define CLASS_1_5B567C8A01BAEDFE_64_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A0A9630)
#define CLASS_1_5B567C8A01BAEDFE_64_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A0A95A0)
#define CLASS_1_5B567C8A01BAEDFE_64_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A0A9680)
#define CLASS_1_5B567C8A01BAEDFE_64_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A0A9770)
#define CLASS_1_5B567C8A01BAEDFE_64_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A0A9740)
#define CLASS_1_5B567C8A01BAEDFE_64_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A0A9480)
#define CLASS_1_5B567C8A01BAEDFE_64_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A0A94E0)
#define CLASS_1_5B567C8A01BAEDFE_64_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A0A96B0)
#define CLASS_1_5B567C8A01BAEDFE_64_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A0A9710)
#define CLASS_1_5B567C8A01BAEDFE_64__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0A97C0)
#define CLASS_1_5B567C8A01BAEDFE_64__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0A9500)
#define CLASS_1_5B567C8A01BAEDFE_64__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0A94F0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_64_TypeDefinitionIndex = 25504;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_64*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_64_TypeDefinitionIndex)->GetStaticField(0x379D0);
	}
