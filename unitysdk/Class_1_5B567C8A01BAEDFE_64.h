...
#define CLASS_1_5B567C8A01BAEDFE_64_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E3C4140)
#define CLASS_1_5B567C8A01BAEDFE_64_CLONE_OFFSET UNITYSDK_OFFSET(0x1E3C3DE0)
#define CLASS_1_5B567C8A01BAEDFE_64_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E3C3F40)
#define CLASS_1_5B567C8A01BAEDFE_64_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E3C3E50)
#define CLASS_1_5B567C8A01BAEDFE_64_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E3C40A0)
#define CLASS_1_5B567C8A01BAEDFE_64_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E3C4190)
#define CLASS_1_5B567C8A01BAEDFE_64_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E3C4160)
#define CLASS_1_5B567C8A01BAEDFE_64_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1E3C3D30)
#define CLASS_1_5B567C8A01BAEDFE_64_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E3C3D90)
#define CLASS_1_5B567C8A01BAEDFE_64_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E3C40D0)
#define CLASS_1_5B567C8A01BAEDFE_64_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E3C4130)
#define CLASS_1_5B567C8A01BAEDFE_64__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E3C41E0)
#define CLASS_1_5B567C8A01BAEDFE_64__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E3C3DB0)
#define CLASS_1_5B567C8A01BAEDFE_64__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3C3DA0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_64_TypeDefinitionIndex = 26697;

class Class_1_5B567C8A01BAEDFE_64 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_64*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_64*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_64_TypeDefinitionIndex)->GetStaticField(0x5F020);
	}
