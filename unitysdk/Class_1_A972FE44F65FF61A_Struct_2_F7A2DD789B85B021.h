...
#define CLASS_1_A972FE44F65FF61A_STRUCT_2_F7A2DD789B85B021_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x74E9B0)
#define CLASS_1_A972FE44F65FF61A_STRUCT_2_F7A2DD789B85B021_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2661E0)

inline static constexpr unsigned int Class_1_A972FE44F65FF61A_Struct_2_F7A2DD789B85B021_TypeDefinitionIndex = 48774;

struct alignas(8) Class_1_A972FE44F65FF61A_Struct_2_F7A2DD789B85B021
{
	::Cysharp::Threading::Tasks::CompilerServices::AsyncUniTaskMethodBuilder_1<::System::IO::Stream*> Field_2_1; // 0x10
	::Cysharp::Threading::Tasks::UniTask_Awaiter Field_2_5; // 0x28
	::Foundation::AssetPath Field_2_2; // 0x38
