...
#define CLASS_3_FE13809C8A1BBC77_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1528E940)
#define CLASS_3_FE13809C8A1BBC77_METHOD_3_147A527305B2FF1B_OFFSET UNITYSDK_OFFSET(0x1528E5F0)
#define CLASS_3_FE13809C8A1BBC77_METHOD_3_283228DCA08F69C7_OFFSET UNITYSDK_OFFSET(0x1528EDB0)
#define CLASS_3_FE13809C8A1BBC77_METHOD_3_8B848E52913DFCE9_OFFSET UNITYSDK_OFFSET(0x1528F100)
#define CLASS_3_FE13809C8A1BBC77_METHOD_3_972DBDE8A873D51A_OFFSET UNITYSDK_OFFSET(0x1528E980)
#define CLASS_3_FE13809C8A1BBC77_METHOD_3_CAEE376DC5422269_OFFSET UNITYSDK_OFFSET(0x1528E180)
#define CLASS_3_FE13809C8A1BBC77_METHOD_3_D299ECB45C12E72E_OFFSET UNITYSDK_OFFSET(0x1528EE50)
#define CLASS_3_FE13809C8A1BBC77_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1528D630)
#define CLASS_3_FE13809C8A1BBC77_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1528D9D0)
#define CLASS_3_FE13809C8A1BBC77_TICK_OFFSET UNITYSDK_OFFSET(0x1528DBB0)
#define CLASS_3_FE13809C8A1BBC77__CTOR_OFFSET UNITYSDK_OFFSET(0x1528D5B0)
...
{
public:
	::RPG::Client::LittleGame::NavigationRequest_1<::RPG::Client::LittleGame::ElfRestaurantGameEntity*>* BOOJINILAND; // 0x28
	::RPG::Client::LittleGame::ElfRestaurantGameEntity* PELIMKCPLCC; // 0x30
	::RPG::Client::ElfRestaurantGameInstance* MIJMIIENKAK; // 0x38
	::System::Single IJAJOGNGEIK; // 0x40
	::System::Single JIJJJDONLIP; // 0x44
	::System::Boolean BNDLCAADPPO; // 0x48
	::System::Single HBANLBGKNKP; // 0x4C
	::UnityEngine::Vector3 BEDPGAOCOHG; // 0x50
