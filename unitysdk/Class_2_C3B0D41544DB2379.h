...
#define CLASS_2_C3B0D41544DB2379_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11115BB0)
#define CLASS_2_C3B0D41544DB2379_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11115BF0)
#define CLASS_2_C3B0D41544DB2379_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11115CF0)
#define CLASS_2_C3B0D41544DB2379_TICK_OFFSET UNITYSDK_OFFSET(0x11115D40)
#define CLASS_2_C3B0D41544DB2379__CTOR_OFFSET UNITYSDK_OFFSET(0x11115BA0)

inline static constexpr unsigned int Class_2_C3B0D41544DB2379_TypeDefinitionIndex = 44137;

class Class_2_C3B0D41544DB2379 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::LockStepStatus* Field_2_0; // 0x20
