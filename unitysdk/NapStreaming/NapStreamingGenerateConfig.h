...
#define NAPSTREAMING_NAPSTREAMINGGENERATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xE0360D0)

namespace NapStreaming
{
	inline static constexpr unsigned int NapStreamingGenerateConfig_TypeDefinitionIndex = 72726;
