...
#define NAPSTREAMING_NAPSTREAMINGVIRTUALGRID__CTOR_OFFSET UNITYSDK_OFFSET(0x10D975F0)

namespace NapStreaming
{
	inline static constexpr unsigned int NapStreamingVirtualGrid_TypeDefinitionIndex = 78557;
