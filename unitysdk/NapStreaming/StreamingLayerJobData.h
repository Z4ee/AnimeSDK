...
#define NAPSTREAMING_STREAMINGLAYERJOBDATA_ISVALID_OFFSET UNITYSDK_OFFSET(0x68E490)
#define NAPSTREAMING_STREAMINGLAYERJOBDATA_UPDATEREALDISTANCE_OFFSET UNITYSDK_OFFSET(0x68E550)
#define NAPSTREAMING_STREAMINGLAYERJOBDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x68E500)
#define NAPSTREAMING_STREAMINGLAYERJOBDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x68E4E0)

namespace NapStreaming
{
	inline static constexpr unsigned int StreamingLayerJobData_TypeDefinitionIndex = 78671;
