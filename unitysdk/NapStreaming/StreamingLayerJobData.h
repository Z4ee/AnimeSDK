...
#define NAPSTREAMING_STREAMINGLAYERJOBDATA_ISVALID_OFFSET UNITYSDK_OFFSET(0x6DC180)
#define NAPSTREAMING_STREAMINGLAYERJOBDATA_UPDATEREALDISTANCE_OFFSET UNITYSDK_OFFSET(0x6DC240)
#define NAPSTREAMING_STREAMINGLAYERJOBDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x6DC1F0)
#define NAPSTREAMING_STREAMINGLAYERJOBDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x6DC1D0)

namespace NapStreaming
{
	inline static constexpr unsigned int StreamingLayerJobData_TypeDefinitionIndex = 51172;
