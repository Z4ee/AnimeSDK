...
#define NAPSTREAMING_NAPSTREAMINGDATA_STREAMINGLAYERDATA_GET_REALHLODLOADDISTANCE_OFFSET UNITYSDK_OFFSET(0xD4639B0)
#define NAPSTREAMING_NAPSTREAMINGDATA_STREAMINGLAYERDATA_GET_REALLOADDISTANCE_OFFSET UNITYSDK_OFFSET(0xD4639A0)
#define NAPSTREAMING_NAPSTREAMINGDATA_STREAMINGLAYERDATA_GET_REALUNLOADDISTANCE_OFFSET UNITYSDK_OFFSET(0xD4639C0)
#define NAPSTREAMING_NAPSTREAMINGDATA_STREAMINGLAYERDATA_UPDATEREALDISTANCE_OFFSET UNITYSDK_OFFSET(0xD4639D0)
#define NAPSTREAMING_NAPSTREAMINGDATA_STREAMINGLAYERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD463BA0)

namespace NapStreaming
{
	inline static constexpr unsigned int NapStreamingData_StreamingLayerData_TypeDefinitionIndex = 68166;
