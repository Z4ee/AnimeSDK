...
#define NAPSTREAMING_NAPSTREAMINGDATA_STREAMINGLAYERDATA_GET_REALHLODLOADDISTANCE_OFFSET UNITYSDK_OFFSET(0x1071ACA0)
#define NAPSTREAMING_NAPSTREAMINGDATA_STREAMINGLAYERDATA_GET_REALLOADDISTANCE_OFFSET UNITYSDK_OFFSET(0x1071AC90)
#define NAPSTREAMING_NAPSTREAMINGDATA_STREAMINGLAYERDATA_GET_REALUNLOADDISTANCE_OFFSET UNITYSDK_OFFSET(0x1071ACB0)
#define NAPSTREAMING_NAPSTREAMINGDATA_STREAMINGLAYERDATA_UPDATEREALDISTANCE_OFFSET UNITYSDK_OFFSET(0x1071ACC0)
#define NAPSTREAMING_NAPSTREAMINGDATA_STREAMINGLAYERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1071AE90)

namespace NapStreaming
{
	inline static constexpr unsigned int NapStreamingData_StreamingLayerData_TypeDefinitionIndex = 78660;
