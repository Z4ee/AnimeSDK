...
#define NAPSTREAMING_NAPSTREAMINGMANAGER_STREAMINGPOSPROVIDER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x11B33C00)
#define NAPSTREAMING_NAPSTREAMINGMANAGER_STREAMINGPOSPROVIDER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11B33C30)
#define NAPSTREAMING_NAPSTREAMINGMANAGER_STREAMINGPOSPROVIDER_INVOKE_OFFSET UNITYSDK_OFFSET(0x11B33870)
#define NAPSTREAMING_NAPSTREAMINGMANAGER_STREAMINGPOSPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x11B33860)

namespace NapStreaming
{
	inline static constexpr unsigned int NapStreamingManager_StreamingPosProvider_TypeDefinitionIndex = 42447;
