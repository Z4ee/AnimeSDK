...
#define NAPSTREAMING_NAPSTREAMINGASSETPATHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x954C930)

namespace NapStreaming
{
	inline static constexpr unsigned int NapStreamingAssetPathConfig_TypeDefinitionIndex = 65851;
