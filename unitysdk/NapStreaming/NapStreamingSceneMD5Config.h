...
#define NAPSTREAMING_NAPSTREAMINGSCENEMD5CONFIG_CHECKNEEDGENERATEQUICKLY_OFFSET UNITYSDK_OFFSET(0x13A09D60)
#define NAPSTREAMING_NAPSTREAMINGSCENEMD5CONFIG_CHECKNEEDGENERATE_OFFSET UNITYSDK_OFFSET(0x13A09D10)
#define NAPSTREAMING_NAPSTREAMINGSCENEMD5CONFIG_CLEARGENERATED_OFFSET UNITYSDK_OFFSET(0x13A09C30)
#define NAPSTREAMING_NAPSTREAMINGSCENEMD5CONFIG_FASTCHECKSCENECHANGED_OFFSET UNITYSDK_OFFSET(0x13A09670)
#define NAPSTREAMING_NAPSTREAMINGSCENEMD5CONFIG_GETMD5HASH_OFFSET UNITYSDK_OFFSET(0x13A09340)
#define NAPSTREAMING_NAPSTREAMINGSCENEMD5CONFIG_INITCONFIG_OFFSET UNITYSDK_OFFSET(0x13A097C0)
#define NAPSTREAMING_NAPSTREAMINGSCENEMD5CONFIG_ISGENERATED_OFFSET UNITYSDK_OFFSET(0x13A09B80)
#define NAPSTREAMING_NAPSTREAMINGSCENEMD5CONFIG_SAVECONFIG_OFFSET UNITYSDK_OFFSET(0x13A099F0)
#define NAPSTREAMING_NAPSTREAMINGSCENEMD5CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x13A09DB0)

namespace NapStreaming
{
	inline static constexpr unsigned int NapStreamingSceneMD5Config_TypeDefinitionIndex = 82050;
