...
#define NAPSTREAMING_STREAMINGGRIDJOBDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x7C0E20)

namespace NapStreaming
{
	inline static constexpr unsigned int StreamingGridJobData_TypeDefinitionIndex = 91410;
