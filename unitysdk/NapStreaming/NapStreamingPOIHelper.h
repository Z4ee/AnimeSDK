...
#define NAPSTREAMING_NAPSTREAMINGPOIHELPER_CONTAINSBOUNDS_OFFSET UNITYSDK_OFFSET(0x10CB58F0)
#define NAPSTREAMING_NAPSTREAMINGPOIHELPER_ISBOUNDSCONTAINED_OFFSET UNITYSDK_OFFSET(0x10CB5730)
#define NAPSTREAMING_NAPSTREAMINGPOIHELPER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x10CB5520)
#define NAPSTREAMING_NAPSTREAMINGPOIHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x10CB6130)

namespace NapStreaming
{
	inline static constexpr unsigned int NapStreamingPOIHelper_TypeDefinitionIndex = 55403;
