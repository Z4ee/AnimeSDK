...
#define NAPSTREAMING_NAPSTREAMINGPOIHELPER_CONTAINSBOUNDS_OFFSET UNITYSDK_OFFSET(0x12748BF0)
#define NAPSTREAMING_NAPSTREAMINGPOIHELPER_ISBOUNDSCONTAINED_OFFSET UNITYSDK_OFFSET(0x12748A30)
#define NAPSTREAMING_NAPSTREAMINGPOIHELPER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x12748820)
#define NAPSTREAMING_NAPSTREAMINGPOIHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x12749480)

namespace NapStreaming
{
	inline static constexpr unsigned int NapStreamingPOIHelper_TypeDefinitionIndex = 57738;
