...
#define NAPSTREAMING_NAPSTREAMINGBRGHELPER_BUILDFROMSERIALIZEDDATA_OFFSET UNITYSDK_OFFSET(0x117B1DF0)
#define NAPSTREAMING_NAPSTREAMINGBRGHELPER_BUILDSTATICCULLINGDATAFROMBATCHKEYS_OFFSET UNITYSDK_OFFSET(0x117B21E0)
#define NAPSTREAMING_NAPSTREAMINGBRGHELPER_DISPOSERESOURCES_OFFSET UNITYSDK_OFFSET(0x117B1BC0)
#define NAPSTREAMING_NAPSTREAMINGBRGHELPER_GETBUFFERHANDLE_OFFSET UNITYSDK_OFFSET(0x117B1A10)
#define NAPSTREAMING_NAPSTREAMINGBRGHELPER_ISSERIALIZEDDATAVALID_OFFSET UNITYSDK_OFFSET(0x117B29B0)
#define NAPSTREAMING_NAPSTREAMINGBRGHELPER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x117B1B70)
#define NAPSTREAMING_NAPSTREAMINGBRGHELPER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x117B1A60)
#define NAPSTREAMING_NAPSTREAMINGBRGHELPER_ONPERFORMCULLING_OFFSET UNITYSDK_OFFSET(0x117B3110)
#define NAPSTREAMING_NAPSTREAMINGBRGHELPER_REGISTERMATERIAL_OFFSET UNITYSDK_OFFSET(0x117B2F80)
#define NAPSTREAMING_NAPSTREAMINGBRGHELPER_REGISTERMESH_OFFSET UNITYSDK_OFFSET(0x117B2DF0)
#define NAPSTREAMING_NAPSTREAMINGBRGHELPER_RELEASERAWDATAINPLAYERAFTERINIT_OFFSET UNITYSDK_OFFSET(0x117B2950)
#define NAPSTREAMING_NAPSTREAMINGBRGHELPER_SETSERIALIZEDDATA_OFFSET UNITYSDK_OFFSET(0x117B2A30)
#define NAPSTREAMING_NAPSTREAMINGBRGHELPER_TRYBUILDIFNEEDED_OFFSET UNITYSDK_OFFSET(0x117B1AB0)
#define NAPSTREAMING_NAPSTREAMINGBRGHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x117B31D0)

namespace NapStreaming
{
	inline static constexpr unsigned int NapStreamingBRGHelper_TypeDefinitionIndex = 78932;
