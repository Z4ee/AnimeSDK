...
#define IRICLUSTERBUILDER_IRITEXTUREARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x111D4E80)

namespace IRIClusterBuilder
{
	inline static constexpr unsigned int IRITextureArray_TypeDefinitionIndex = 38629;
