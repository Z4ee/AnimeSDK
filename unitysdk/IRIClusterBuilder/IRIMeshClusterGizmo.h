...
#define IRICLUSTERBUILDER_IRIMESHCLUSTERGIZMO_METHOD_5_666191C5DC332092_OFFSET UNITYSDK_OFFSET(0x161B4730)
#define IRICLUSTERBUILDER_IRIMESHCLUSTERGIZMO_METHOD_5_B920F25FC9D3FA44_OFFSET UNITYSDK_OFFSET(0x161B4A50)
#define IRICLUSTERBUILDER_IRIMESHCLUSTERGIZMO_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x161B4070)
#define IRICLUSTERBUILDER_IRIMESHCLUSTERGIZMO__CTOR_OFFSET UNITYSDK_OFFSET(0x161B4D20)
