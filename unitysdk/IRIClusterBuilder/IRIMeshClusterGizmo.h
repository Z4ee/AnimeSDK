...
#define IRICLUSTERBUILDER_IRIMESHCLUSTERGIZMO_METHOD_5_666191C5DC332092_OFFSET UNITYSDK_OFFSET(0x14235F40)
#define IRICLUSTERBUILDER_IRIMESHCLUSTERGIZMO_METHOD_5_B920F25FC9D3FA44_OFFSET UNITYSDK_OFFSET(0x14236260)
#define IRICLUSTERBUILDER_IRIMESHCLUSTERGIZMO_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x14235880)
#define IRICLUSTERBUILDER_IRIMESHCLUSTERGIZMO__CTOR_OFFSET UNITYSDK_OFFSET(0x14236530)

namespace IRIClusterBuilder
{
	inline static constexpr unsigned int IRIMeshClusterGizmo_TypeDefinitionIndex = 45063;
