...
#define IRICLUSTERBUILDER_IRIMESHCLUSTERGIZMO_METHOD_5_666191C5DC332092_OFFSET UNITYSDK_OFFSET(0x111D47D0)
#define IRICLUSTERBUILDER_IRIMESHCLUSTERGIZMO_METHOD_5_B920F25FC9D3FA44_OFFSET UNITYSDK_OFFSET(0x111D4AF0)
#define IRICLUSTERBUILDER_IRIMESHCLUSTERGIZMO_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x111D4110)
#define IRICLUSTERBUILDER_IRIMESHCLUSTERGIZMO__CTOR_OFFSET UNITYSDK_OFFSET(0x111D4DC0)

namespace IRIClusterBuilder
{
	inline static constexpr unsigned int IRIMeshClusterGizmo_TypeDefinitionIndex = 38624;
