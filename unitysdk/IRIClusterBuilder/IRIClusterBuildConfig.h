...
#define IRICLUSTERBUILDER_IRICLUSTERBUILDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x12411620)

namespace IRIClusterBuilder
{
	inline static constexpr unsigned int IRIClusterBuildConfig_TypeDefinitionIndex = 44512;
