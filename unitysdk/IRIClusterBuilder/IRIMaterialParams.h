...
#define IRICLUSTERBUILDER_IRIMATERIALPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x174FF380)

namespace IRIClusterBuilder
{
	inline static constexpr unsigned int IRIMaterialParams_TypeDefinitionIndex = 45979;
