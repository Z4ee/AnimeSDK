...
#define IRICLUSTERBUILDER_IRI2VOLUMETEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x111D40C0)

namespace IRIClusterBuilder
{
	inline static constexpr unsigned int IRI2VolumeTemplate_TypeDefinitionIndex = 38619;
