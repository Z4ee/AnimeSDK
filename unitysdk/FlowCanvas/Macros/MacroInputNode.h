...
#define FLOWCANVAS_MACROS_MACROINPUTNODE_GET_ICONALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1D83A0F0)
#define FLOWCANVAS_MACROS_MACROINPUTNODE_GET_MACRO_OFFSET UNITYSDK_OFFSET(0x1D83A100)
#define FLOWCANVAS_MACROS_MACROINPUTNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D83A170)
#define FLOWCANVAS_MACROS_MACROINPUTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D83A710)

namespace FlowCanvas::Macros
{
	inline static constexpr unsigned int MacroInputNode_TypeDefinitionIndex = 29413;
