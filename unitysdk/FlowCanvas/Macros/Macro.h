...
#define FLOWCANVAS_MACROS_MACRO_ADDEXAMPLEPORTS_OFFSET UNITYSDK_OFFSET(0x1BC3F9F0)
#define FLOWCANVAS_MACROS_MACRO_ADDINPUTDEFINITION_OFFSET UNITYSDK_OFFSET(0x1BC3F760)
#define FLOWCANVAS_MACROS_MACRO_ADDOUTPUTDEFINITION_OFFSET UNITYSDK_OFFSET(0x1BC3F8A0)
#define FLOWCANVAS_MACROS_MACRO_CALLFLOWINPUT_OFFSET UNITYSDK_OFFSET(0x1BC3FBC0)
#define FLOWCANVAS_MACROS_MACRO_GET_ALLOWBLACKBOARDOVERRIDES_OFFSET UNITYSDK_OFFSET(0x1BC3F440)
#define FLOWCANVAS_MACROS_MACRO_GET_BINDMACRONODEWRAPPERID_OFFSET UNITYSDK_OFFSET(0x1BC3F450)
#define FLOWCANVAS_MACROS_MACRO_GET_ENTRY_OFFSET UNITYSDK_OFFSET(0x1BC3F470)
#define FLOWCANVAS_MACROS_MACRO_GET_EXIT_OFFSET UNITYSDK_OFFSET(0x1BC3F5C0)
#define FLOWCANVAS_MACROS_MACRO_ONDERIVEDDATADESERIALIZATION_OFFSET UNITYSDK_OFFSET(0x1BC3F3A0)
#define FLOWCANVAS_MACROS_MACRO_ONDERIVEDDATASERIALIZATION_OFFSET UNITYSDK_OFFSET(0x1BC3F340)
#define FLOWCANVAS_MACROS_MACRO_ONGRAPHVALIDATE_OFFSET UNITYSDK_OFFSET(0x1BC3F720)
#define FLOWCANVAS_MACROS_MACRO_SET_BINDMACRONODEWRAPPERID_OFFSET UNITYSDK_OFFSET(0x1BC3F460)
#define FLOWCANVAS_MACROS_MACRO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC3FDB0)

namespace FlowCanvas::Macros
{
	inline static constexpr unsigned int Macro_TypeDefinitionIndex = 29772;
