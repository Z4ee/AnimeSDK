...
#define FLOWCANVAS_MACROS_MACROINPUTNODE___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1D055A30)
#define FLOWCANVAS_MACROS_MACROINPUTNODE___C__DISPLAYCLASS4_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x1D055A40)

namespace FlowCanvas::Macros
{
	inline static constexpr unsigned int MacroInputNode___c__DisplayClass4_0_TypeDefinitionIndex = 30144;
