...
#define FLOWCANVAS_MACROS_MACROOUTPUTNODE_GET_ICONALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1D81C4D0)
#define FLOWCANVAS_MACROS_MACROOUTPUTNODE_GET_MACRO_OFFSET UNITYSDK_OFFSET(0x1D81C4E0)
#define FLOWCANVAS_MACROS_MACROOUTPUTNODE_ISSERVERCARE_OFFSET UNITYSDK_OFFSET(0x1D81CB60)
#define FLOWCANVAS_MACROS_MACROOUTPUTNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D81C550)
#define FLOWCANVAS_MACROS_MACROOUTPUTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D81CB70)

namespace FlowCanvas::Macros
{
	inline static constexpr unsigned int MacroOutputNode_TypeDefinitionIndex = 29488;
