...
#define FLOWCANVAS_MACROS_MACROOUTPUTNODE_GET_ICONALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1B456C00)
#define FLOWCANVAS_MACROS_MACROOUTPUTNODE_GET_MACRO_OFFSET UNITYSDK_OFFSET(0x1B456C10)
#define FLOWCANVAS_MACROS_MACROOUTPUTNODE_ISSERVERCARE_OFFSET UNITYSDK_OFFSET(0x1B457290)
#define FLOWCANVAS_MACROS_MACROOUTPUTNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1B456C80)
#define FLOWCANVAS_MACROS_MACROOUTPUTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4572A0)

namespace FlowCanvas::Macros
{
	inline static constexpr unsigned int MacroOutputNode_TypeDefinitionIndex = 27262;
