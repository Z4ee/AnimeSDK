...
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1D52F950)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_GET_MACRO_OFFSET UNITYSDK_OFFSET(0x1D52FB50)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1D52F7A0)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_MAKEINSTANCEWITHOUTGATHERPORTS_OFFSET UNITYSDK_OFFSET(0x1D52FFC0)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_MAKEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1D52FFA0)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_NODECANVAS_FRAMEWORK_IGRAPHASSIGNABLE_GET_CURRENTINSTANCE_OFFSET UNITYSDK_OFFSET(0x1D52FD80)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_NODECANVAS_FRAMEWORK_IGRAPHASSIGNABLE_GET_INSTANCES_OFFSET UNITYSDK_OFFSET(0x1D52FE60)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_NODECANVAS_FRAMEWORK_IGRAPHASSIGNABLE_GET_SUBGRAPHPARAMETER_OFFSET UNITYSDK_OFFSET(0x1D52FE50)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_NODECANVAS_FRAMEWORK_IGRAPHASSIGNABLE_GET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1D52FCF0)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_NODECANVAS_FRAMEWORK_IGRAPHASSIGNABLE_GET_VARIABLESMAP_OFFSET UNITYSDK_OFFSET(0x1D52FE30)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_NODECANVAS_FRAMEWORK_IGRAPHASSIGNABLE_SET_CURRENTINSTANCE_OFFSET UNITYSDK_OFFSET(0x1D52FD90)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_NODECANVAS_FRAMEWORK_IGRAPHASSIGNABLE_SET_INSTANCES_OFFSET UNITYSDK_OFFSET(0x1D52FF50)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_NODECANVAS_FRAMEWORK_IGRAPHASSIGNABLE_SET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1D52FD00)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_NODECANVAS_FRAMEWORK_IGRAPHASSIGNABLE_SET_VARIABLESMAP_OFFSET UNITYSDK_OFFSET(0x1D52FE40)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_NODECANVAS_FRAMEWORK_IUPDATABLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1D530250)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1D5303F0)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D530650)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_SET_MACRO_OFFSET UNITYSDK_OFFSET(0x1D52FB60)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_SET_TMACRO_OFFSET UNITYSDK_OFFSET(0x1D52FCE0)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D530F10)

namespace FlowCanvas::Macros
{
	inline static constexpr unsigned int MacroNodeWrapper_TypeDefinitionIndex = 29638;
