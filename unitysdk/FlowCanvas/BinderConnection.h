...
#define FLOWCANVAS_BINDERCONNECTION_BIND_OFFSET UNITYSDK_OFFSET(0x198450E0)
#define FLOWCANVAS_BINDERCONNECTION_CANBEBOUNDVERBOSED_INTERNAL_OFFSET UNITYSDK_OFFSET(0x19844340)
#define FLOWCANVAS_BINDERCONNECTION_CANBEBOUNDVERBOSED_OFFSET UNITYSDK_OFFSET(0x19842120)
#define FLOWCANVAS_BINDERCONNECTION_CANBEBOUND_OFFSET UNITYSDK_OFFSET(0x19844320)
#define FLOWCANVAS_BINDERCONNECTION_CREATE_OFFSET UNITYSDK_OFFSET(0x19841950)
#define FLOWCANVAS_BINDERCONNECTION_GATHERANDVALIDATESOURCEPORT_OFFSET UNITYSDK_OFFSET(0x19842680)
#define FLOWCANVAS_BINDERCONNECTION_GATHERANDVALIDATETARGETPORT_OFFSET UNITYSDK_OFFSET(0x19843510)
#define FLOWCANVAS_BINDERCONNECTION_GET_BINDINGTYPE_OFFSET UNITYSDK_OFFSET(0x19841840)
#define FLOWCANVAS_BINDERCONNECTION_GET_SOURCEPORTID_OFFSET UNITYSDK_OFFSET(0x19841500)
#define FLOWCANVAS_BINDERCONNECTION_GET_SOURCEPORT_OFFSET UNITYSDK_OFFSET(0x19841600)
#define FLOWCANVAS_BINDERCONNECTION_GET_TARGETPORTID_OFFSET UNITYSDK_OFFSET(0x198416A0)
#define FLOWCANVAS_BINDERCONNECTION_GET_TARGETPORT_OFFSET UNITYSDK_OFFSET(0x198417A0)
#define FLOWCANVAS_BINDERCONNECTION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19844B00)
#define FLOWCANVAS_BINDERCONNECTION_SETSOURCEPORT_OFFSET UNITYSDK_OFFSET(0x19842150)
#define FLOWCANVAS_BINDERCONNECTION_SETTARGETPORT_OFFSET UNITYSDK_OFFSET(0x19842FE0)
#define FLOWCANVAS_BINDERCONNECTION_SET_SOURCEPORTID_OFFSET UNITYSDK_OFFSET(0x19841690)
#define FLOWCANVAS_BINDERCONNECTION_SET_TARGETPORTID_OFFSET UNITYSDK_OFFSET(0x19841830)
#define FLOWCANVAS_BINDERCONNECTION_SET_TSETSOURCENODE_OFFSET UNITYSDK_OFFSET(0x198414E0)
#define FLOWCANVAS_BINDERCONNECTION_SET_TSETSOURCEPORTID_OFFSET UNITYSDK_OFFSET(0x198414C0)
#define FLOWCANVAS_BINDERCONNECTION_SET_TSETTARGETNODE_OFFSET UNITYSDK_OFFSET(0x198414F0)
#define FLOWCANVAS_BINDERCONNECTION_SET_TSETTARGETPORTID_OFFSET UNITYSDK_OFFSET(0x198414D0)
#define FLOWCANVAS_BINDERCONNECTION_UNBIND_OFFSET UNITYSDK_OFFSET(0x19845560)
#define FLOWCANVAS_BINDERCONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19842140)

namespace FlowCanvas
{
	inline static constexpr unsigned int BinderConnection_TypeDefinitionIndex = 27424;
