...
#define FLOWCANVAS_FLOWOUTPUT_ADD_POINTER_OFFSET UNITYSDK_OFFSET(0x1D346A30)
#define FLOWCANVAS_FLOWOUTPUT_APPEND_OFFSET UNITYSDK_OFFSET(0x1D346D80)
#define FLOWCANVAS_FLOWOUTPUT_BINDTO_OFFSET UNITYSDK_OFFSET(0x1D346D20)
#define FLOWCANVAS_FLOWOUTPUT_CALLANDNOTIFYSERVER_OFFSET UNITYSDK_OFFSET(0x1D346C00)
#define FLOWCANVAS_FLOWOUTPUT_CALL_OFFSET UNITYSDK_OFFSET(0x1D346C40)
#define FLOWCANVAS_FLOWOUTPUT_GET_CALLSEQ_OFFSET UNITYSDK_OFFSET(0x1D346BE0)
#define FLOWCANVAS_FLOWOUTPUT_GET_ISNOTSENDFLOWCALLTOSERVER_OFFSET UNITYSDK_OFFSET(0x1D346BC0)
#define FLOWCANVAS_FLOWOUTPUT_GET_ISSENDFLOWCALLTOSERVER_OFFSET UNITYSDK_OFFSET(0x1D346B80)
#define FLOWCANVAS_FLOWOUTPUT_GET_ISTARGETCHOICENODE_OFFSET UNITYSDK_OFFSET(0x1D346BA0)
#define FLOWCANVAS_FLOWOUTPUT_GET_ISTARGETNODESERVERCARE_OFFSET UNITYSDK_OFFSET(0x1D346B60)
#define FLOWCANVAS_FLOWOUTPUT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1D346B30)
#define FLOWCANVAS_FLOWOUTPUT_RECORDCALLINFO_OFFSET UNITYSDK_OFFSET(0x1D346D10)
#define FLOWCANVAS_FLOWOUTPUT_REMOVE_POINTER_OFFSET UNITYSDK_OFFSET(0x1D346AB0)
#define FLOWCANVAS_FLOWOUTPUT_SET_CALLSEQ_OFFSET UNITYSDK_OFFSET(0x1D346BF0)
#define FLOWCANVAS_FLOWOUTPUT_SET_ISNOTSENDFLOWCALLTOSERVER_OFFSET UNITYSDK_OFFSET(0x1D346BD0)
#define FLOWCANVAS_FLOWOUTPUT_SET_ISSENDFLOWCALLTOSERVER_OFFSET UNITYSDK_OFFSET(0x1D346B90)
#define FLOWCANVAS_FLOWOUTPUT_SET_ISTARGETCHOICENODE_OFFSET UNITYSDK_OFFSET(0x1D346BB0)
#define FLOWCANVAS_FLOWOUTPUT_SET_ISTARGETNODESERVERCARE_OFFSET UNITYSDK_OFFSET(0x1D346B70)
#define FLOWCANVAS_FLOWOUTPUT_UNBIND_OFFSET UNITYSDK_OFFSET(0x1D346E00)
#define FLOWCANVAS_FLOWOUTPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D346A20)

namespace FlowCanvas
{
	inline static constexpr unsigned int FlowOutput_TypeDefinitionIndex = 30884;
	...
	public:
		...
		{
			return (::System::Action_2<::FlowCanvas::FlowOutput*, ::FlowCanvas::FlowNode*>**)Il2CppClass::FromTypeDefinitionIndex(FlowOutput_TypeDefinitionIndex)->GetStaticField(0x24A80);
		}
		::FlowCanvas::FlowHandler* pointer; // 0x38
		::System::Boolean _IsSendFlowCallToServer_k__BackingField; // 0x40
		::System::Boolean _IsTargetNodeServerCare_k__BackingField; // 0x41
		::System::Boolean _IsTargetChoiceNode_k__BackingField; // 0x42
		::System::Boolean _IsNotSendFlowCallToServer_k__BackingField; // 0x43
