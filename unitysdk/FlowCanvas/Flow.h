...
#define FLOWCANVAS_FLOW_BEGINBREAKBLOCK_OFFSET UNITYSDK_OFFSET(0x6B3130)
#define FLOWCANVAS_FLOW_BREAK_OFFSET UNITYSDK_OFFSET(0x9F28F0)
#define FLOWCANVAS_FLOW_CALL_OFFSET UNITYSDK_OFFSET(0x9F2880)
#define FLOWCANVAS_FLOW_ENDBREAKBLOCK_OFFSET UNITYSDK_OFFSET(0x9F28E0)
#define FLOWCANVAS_FLOW_GET_NEW_OFFSET UNITYSDK_OFFSET(0x1D51A830)
#define FLOWCANVAS_FLOW_GET_TICKS_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define FLOWCANVAS_FLOW_RETURN_OFFSET UNITYSDK_OFFSET(0x9F28D0)
#define FLOWCANVAS_FLOW_SETRETURNDATA_OFFSET UNITYSDK_OFFSET(0x9F28C0)
#define FLOWCANVAS_FLOW_SET_TICKS_OFFSET UNITYSDK_OFFSET(0x2B66C0)

namespace FlowCanvas
{
	inline static constexpr unsigned int Flow_TypeDefinitionIndex = 30493;
