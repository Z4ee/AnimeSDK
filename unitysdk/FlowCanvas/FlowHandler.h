...
#define FLOWCANVAS_FLOWHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BCB3AE0)
#define FLOWCANVAS_FLOWHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BCB3B50)
#define FLOWCANVAS_FLOWHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BCB3610)
#define FLOWCANVAS_FLOWHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCB2210)

namespace FlowCanvas
{
	inline static constexpr unsigned int FlowHandler_TypeDefinitionIndex = 30371;
