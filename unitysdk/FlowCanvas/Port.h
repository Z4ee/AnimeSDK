...
#define FLOWCANVAS_PORT_CANACCEPTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1E7241A0)
#define FLOWCANVAS_PORT_FLAGINVALIDCAST_OFFSET UNITYSDK_OFFSET(0x1E724180)
#define FLOWCANVAS_PORT_FLAGMISSING_OFFSET UNITYSDK_OFFSET(0x1E724160)
#define FLOWCANVAS_PORT_FLAGVALID_OFFSET UNITYSDK_OFFSET(0x1E720750)
#define FLOWCANVAS_PORT_GETFIRSTINPUTCONNECTION_OFFSET UNITYSDK_OFFSET(0x1E7244B0)
#define FLOWCANVAS_PORT_GETFIRSTOUTPUTCONNECTION_OFFSET UNITYSDK_OFFSET(0x1E7245C0)
#define FLOWCANVAS_PORT_GETPORTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1E724280)
#define FLOWCANVAS_PORT_GET_BINDSTATUS_OFFSET UNITYSDK_OFFSET(0x1E724120)
#define FLOWCANVAS_PORT_GET_CONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1E724100)
#define FLOWCANVAS_PORT_GET_DISPLAYCONTENT_OFFSET UNITYSDK_OFFSET(0x1E724140)
#define FLOWCANVAS_PORT_GET_ID_OFFSET UNITYSDK_OFFSET(0x1E7240C0)
#define FLOWCANVAS_PORT_GET_ISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1E71BC10)
#define FLOWCANVAS_PORT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1E7240E0)
#define FLOWCANVAS_PORT_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x1E7240A0)
#define FLOWCANVAS_PORT_ISDELEGATE_OFFSET UNITYSDK_OFFSET(0x1E7249B0)
#define FLOWCANVAS_PORT_ISENUMERABLECOLLECTION_OFFSET UNITYSDK_OFFSET(0x1E724A60)
#define FLOWCANVAS_PORT_ISFLOWPORT_OFFSET UNITYSDK_OFFSET(0x1E7246D0)
#define FLOWCANVAS_PORT_ISINPUTPORT_OFFSET UNITYSDK_OFFSET(0x1E720630)
#define FLOWCANVAS_PORT_ISOUTPUTPORT_OFFSET UNITYSDK_OFFSET(0x1E7206C0)
#define FLOWCANVAS_PORT_ISUNITYOBJECT_OFFSET UNITYSDK_OFFSET(0x1E7247F0)
#define FLOWCANVAS_PORT_ISUNITYSCENEOBJECT_OFFSET UNITYSDK_OFFSET(0x1E7248A0)
#define FLOWCANVAS_PORT_ISVALUEPORT_OFFSET UNITYSDK_OFFSET(0x1E724760)
#define FLOWCANVAS_PORT_ISWILD_OFFSET UNITYSDK_OFFSET(0x1E724AD0)
#define FLOWCANVAS_PORT_SET_BINDSTATUS_OFFSET UNITYSDK_OFFSET(0x1E724130)
#define FLOWCANVAS_PORT_SET_CONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1E724110)
#define FLOWCANVAS_PORT_SET_DISPLAYCONTENT_OFFSET UNITYSDK_OFFSET(0x1E724150)
#define FLOWCANVAS_PORT_SET_ID_OFFSET UNITYSDK_OFFSET(0x1E7240D0)
#define FLOWCANVAS_PORT_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1E7240F0)
#define FLOWCANVAS_PORT_SET_PARENT_OFFSET UNITYSDK_OFFSET(0x1E7240B0)
#define FLOWCANVAS_PORT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E724B20)
#define FLOWCANVAS_PORT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E724090)
#define FLOWCANVAS_PORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E724080)
#define FLOWCANVAS_PORT__GETFIRSTINPUTCONNECTION_B__36_0_OFFSET UNITYSDK_OFFSET(0x1E724CC0)
#define FLOWCANVAS_PORT__GETFIRSTOUTPUTCONNECTION_B__37_0_OFFSET UNITYSDK_OFFSET(0x1E724D60)
#define FLOWCANVAS_PORT__GETPORTCONNECTIONS_B__35_0_OFFSET UNITYSDK_OFFSET(0x1E724B80)
#define FLOWCANVAS_PORT__GETPORTCONNECTIONS_B__35_1_OFFSET UNITYSDK_OFFSET(0x1E724C20)

namespace FlowCanvas
{
	inline static constexpr unsigned int Port_TypeDefinitionIndex = 30047;

	class Port : public ::System::Object
	{
	public:
		::UnityEngine::GUIContent* _displayContent_k__BackingField; // 0x10
		::FlowCanvas::FlowNode* _parent_k__BackingField; // 0x18
