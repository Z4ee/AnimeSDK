...
#define FLOWCANVAS_VALUEINPUT_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1B41A780)
#define FLOWCANVAS_VALUEINPUT_GET_SKIPSELFINSTANCEASSIGNMENT_OFFSET UNITYSDK_OFFSET(0x1B41AB20)
#define FLOWCANVAS_VALUEINPUT_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B41AAA0)
#define FLOWCANVAS_VALUEINPUT_SETDEFAULTANDSERIALIZEDVALUE_OFFSET UNITYSDK_OFFSET(0x1B41AAC0)
#define FLOWCANVAS_VALUEINPUT_SET_SKIPSELFINSTANCEASSIGNMENT_OFFSET UNITYSDK_OFFSET(0x1B41AB30)
#define FLOWCANVAS_VALUEINPUT_SKIPSELFINSTANCEASSIGNMENT_OFFSET UNITYSDK_OFFSET(0x1B41AB10)
#define FLOWCANVAS_VALUEINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B41A770)

namespace FlowCanvas
{
	inline static constexpr unsigned int ValueInput_TypeDefinitionIndex = 27569;
