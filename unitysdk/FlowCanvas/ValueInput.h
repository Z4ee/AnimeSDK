...
#define FLOWCANVAS_VALUEINPUT_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1D7BC050)
#define FLOWCANVAS_VALUEINPUT_GET_SKIPSELFINSTANCEASSIGNMENT_OFFSET UNITYSDK_OFFSET(0x1D7BC3F0)
#define FLOWCANVAS_VALUEINPUT_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D7BC370)
#define FLOWCANVAS_VALUEINPUT_SETDEFAULTANDSERIALIZEDVALUE_OFFSET UNITYSDK_OFFSET(0x1D7BC390)
#define FLOWCANVAS_VALUEINPUT_SET_SKIPSELFINSTANCEASSIGNMENT_OFFSET UNITYSDK_OFFSET(0x1D7BC400)
#define FLOWCANVAS_VALUEINPUT_SKIPSELFINSTANCEASSIGNMENT_OFFSET UNITYSDK_OFFSET(0x1D7BC3E0)
#define FLOWCANVAS_VALUEINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7BC040)

namespace FlowCanvas
{
	inline static constexpr unsigned int ValueInput_TypeDefinitionIndex = 29627;
