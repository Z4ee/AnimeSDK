...
#define FLOWCANVAS_FLOWRETURN_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B0E8F60)
#define FLOWCANVAS_FLOWRETURN_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B0E8F90)
#define FLOWCANVAS_FLOWRETURN_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B0E8A60)
#define FLOWCANVAS_FLOWRETURN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0E8A50)

namespace FlowCanvas
{
	inline static constexpr unsigned int FlowReturn_TypeDefinitionIndex = 26957;
