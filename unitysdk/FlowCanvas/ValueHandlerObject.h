...
#define FLOWCANVAS_VALUEHANDLEROBJECT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B0EE600)
#define FLOWCANVAS_VALUEHANDLEROBJECT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B0EE630)
#define FLOWCANVAS_VALUEHANDLEROBJECT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B0EE360)
#define FLOWCANVAS_VALUEHANDLEROBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0EA700)

namespace FlowCanvas
{
	inline static constexpr unsigned int ValueHandlerObject_TypeDefinitionIndex = 27503;
