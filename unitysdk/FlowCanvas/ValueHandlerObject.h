...
#define FLOWCANVAS_VALUEHANDLEROBJECT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E22C980)
#define FLOWCANVAS_VALUEHANDLEROBJECT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E22C9B0)
#define FLOWCANVAS_VALUEHANDLEROBJECT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E22C6F0)
#define FLOWCANVAS_VALUEHANDLEROBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E228AB0)

namespace FlowCanvas
{
	inline static constexpr unsigned int ValueHandlerObject_TypeDefinitionIndex = 31499;
