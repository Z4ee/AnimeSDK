...
#define FLOWCANVAS_FLOW_RETURNDATA_GET_RETURNCALL_OFFSET UNITYSDK_OFFSET(0x228FE0)
#define FLOWCANVAS_FLOW_RETURNDATA_GET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x28B580)
#define FLOWCANVAS_FLOW_RETURNDATA_SET_RETURNCALL_OFFSET UNITYSDK_OFFSET(0x2E5940)
#define FLOWCANVAS_FLOW_RETURNDATA_SET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x381830)
#define FLOWCANVAS_FLOW_RETURNDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x2FED90)

namespace FlowCanvas
{
	inline static constexpr unsigned int Flow_ReturnData_TypeDefinitionIndex = 26999;
