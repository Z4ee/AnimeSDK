...
#define FLOWCANVAS_NODES_STARTEVENT_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1D83C510)
#define FLOWCANVAS_NODES_STARTEVENT_ONSTARTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1D83C730)
#define FLOWCANVAS_NODES_STARTEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D83C800)
#define FLOWCANVAS_NODES_STARTEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D83C850)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int StartEvent_TypeDefinitionIndex = 29577;
