...
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE_BEGIN_OFFSET UNITYSDK_OFFSET(0x1E229F50)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE_BREAKALL_OFFSET UNITYSDK_OFFSET(0x1E229EB0)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE_GET_ALLOWROUTINEQUEUEING_OFFSET UNITYSDK_OFFSET(0x1E22A2F0)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1E229D60)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE_INTERNALCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1E22A0F0)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE_ONBREAK_OFFSET UNITYSDK_OFFSET(0x1E22A2E0)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1E229E30)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1E229E40)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE_ONREGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1E22A160)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E22A300)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE__INTERNALCOROUTINE_B__15_0_OFFSET UNITYSDK_OFFSET(0x1E22A310)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE__ONREGISTERPORTS_B__16_0_OFFSET UNITYSDK_OFFSET(0x1E22A320)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE__ONREGISTERPORTS_B__16_1_OFFSET UNITYSDK_OFFSET(0x1E22A330)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int LatentActionNodeBase_TypeDefinitionIndex = 31172;

	class LatentActionNodeBase : public ::FlowCanvas::Nodes::SimplexNode
	{
	public:
		::System::Collections::Generic::Queue_1<::FlowCanvas::Nodes::LatentActionNodeBase_RoutineData>* routineQueue; // 0x30
		::FlowCanvas::FlowOutput* onFinish; // 0x38
		::FlowCanvas::FlowOutput* onStart; // 0x40
		::UnityEngine::Coroutine* currentCoroutine; // 0x48
		::FlowCanvas::FlowOutput* onUpdate; // 0x50
