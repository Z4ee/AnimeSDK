...
#define FLOWCANVAS_NODES_SWITCHINT_GET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0x19848B90)
#define FLOWCANVAS_NODES_SWITCHINT_ISCHOICENODE_OFFSET UNITYSDK_OFFSET(0x19848D70)
#define FLOWCANVAS_NODES_SWITCHINT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19848BB0)
#define FLOWCANVAS_NODES_SWITCHINT_SET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0x19848BA0)
#define FLOWCANVAS_NODES_SWITCHINT__CTOR_OFFSET UNITYSDK_OFFSET(0x19848D80)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SwitchInt_TypeDefinitionIndex = 26968;
