...
#define FLOWCANVAS_NODES_UPDATEEVENT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1D83D560)
#define FLOWCANVAS_NODES_UPDATEEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D83D510)
#define FLOWCANVAS_NODES_UPDATEEVENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1D83D570)
#define FLOWCANVAS_NODES_UPDATEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D83D670)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int UpdateEvent_TypeDefinitionIndex = 29232;
