...
#define FLOWCANVAS_NODES_RANDOM_GET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0x1D83C270)
#define FLOWCANVAS_NODES_RANDOM_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D83C290)
#define FLOWCANVAS_NODES_RANDOM_SET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0x1D83C280)
#define FLOWCANVAS_NODES_RANDOM_STARTCOROUTINEWRAP_OFFSET UNITYSDK_OFFSET(0x1D83C470)
#define FLOWCANVAS_NODES_RANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D83C4B0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Random_TypeDefinitionIndex = 30168;
	...
	public:
		...
		{
			return (::System::Func_5<::FlowCanvas::Nodes::Random*, ::FlowCanvas::Flow, ::System::Collections::Generic::List_1<::FlowCanvas::FlowOutput*>*, ::System::Int32, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(Random_TypeDefinitionIndex)->GetStaticField(0x24070);
		}
