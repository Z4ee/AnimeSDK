...
#define FLOWCANVAS_NODES_EXTRACTRAYCASTHIT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BCB4410)
#define FLOWCANVAS_NODES_EXTRACTRAYCASTHIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCB46E0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ExtractRaycastHit_TypeDefinitionIndex = 30774;
