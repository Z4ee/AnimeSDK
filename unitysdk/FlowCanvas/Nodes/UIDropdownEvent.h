...
#define FLOWCANVAS_NODES_UIDROPDOWNEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1B41A280)
#define FLOWCANVAS_NODES_UIDROPDOWNEVENT_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1B41A190)
#define FLOWCANVAS_NODES_UIDROPDOWNEVENT_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1B41A470)
#define FLOWCANVAS_NODES_UIDROPDOWNEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1B41A390)
#define FLOWCANVAS_NODES_UIDROPDOWNEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B41A4C0)
#define FLOWCANVAS_NODES_UIDROPDOWNEVENT__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x1B41A510)
#define FLOWCANVAS_NODES_UIDROPDOWNEVENT__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0x1B41A570)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int UIDropdownEvent_TypeDefinitionIndex = 27474;
