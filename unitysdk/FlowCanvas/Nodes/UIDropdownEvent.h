...
#define FLOWCANVAS_NODES_UIDROPDOWNEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1D7BBB50)
#define FLOWCANVAS_NODES_UIDROPDOWNEVENT_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1D7BBA60)
#define FLOWCANVAS_NODES_UIDROPDOWNEVENT_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1D7BBD40)
#define FLOWCANVAS_NODES_UIDROPDOWNEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D7BBC60)
#define FLOWCANVAS_NODES_UIDROPDOWNEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7BBD90)
#define FLOWCANVAS_NODES_UIDROPDOWNEVENT__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x1D7BBDE0)
#define FLOWCANVAS_NODES_UIDROPDOWNEVENT__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0x1D7BBE40)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int UIDropdownEvent_TypeDefinitionIndex = 30316;
