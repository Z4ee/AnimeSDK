...
#define FLOWCANVAS_NODES_APPLICATIONPAUSEEVENT_APPLICATIONPAUSE_OFFSET UNITYSDK_OFFSET(0x1C61F8E0)
#define FLOWCANVAS_NODES_APPLICATIONPAUSEEVENT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1C61F740)
#define FLOWCANVAS_NODES_APPLICATIONPAUSEEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1C61F810)
#define FLOWCANVAS_NODES_APPLICATIONPAUSEEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1C61F930)
#define FLOWCANVAS_NODES_APPLICATIONPAUSEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C61F9C0)
#define FLOWCANVAS_NODES_APPLICATIONPAUSEEVENT__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x1C61FA00)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ApplicationPauseEvent_TypeDefinitionIndex = 30512;
