...
#define FLOWCANVAS_NODES_SWITCHPROBABILITY_ENTER_OFFSET UNITYSDK_OFFSET(0x1EA93DC0)
#define FLOWCANVAS_NODES_SWITCHPROBABILITY_GET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0x1EA93AF0)
#define FLOWCANVAS_NODES_SWITCHPROBABILITY_ISCHOICENODE_OFFSET UNITYSDK_OFFSET(0x1EA93DB0)
#define FLOWCANVAS_NODES_SWITCHPROBABILITY_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1EA93B10)
#define FLOWCANVAS_NODES_SWITCHPROBABILITY_SET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0x1EA93B00)
#define FLOWCANVAS_NODES_SWITCHPROBABILITY_STARTCOROUTINEWRAP_OFFSET UNITYSDK_OFFSET(0x1EA94090)
#define FLOWCANVAS_NODES_SWITCHPROBABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA940D0)
#define FLOWCANVAS_NODES_SWITCHPROBABILITY__REGISTERPORTS_B__10_0_OFFSET UNITYSDK_OFFSET(0x1EA94120)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SwitchProbability_TypeDefinitionIndex = 31192;
	...
	public:
		...
		{
			return (::System::Func_5<::FlowCanvas::Nodes::SwitchProbability*, ::FlowCanvas::Flow, ::System::Collections::Generic::List_1<::FlowCanvas::FlowOutput*>*, ::System::Int32, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(SwitchProbability_TypeDefinitionIndex)->GetStaticField(0x26360);
		}
