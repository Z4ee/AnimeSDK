...
#define FLOWCANVAS_NODES_WAITFORONEFRAME_GET_ALLOWROUTINEQUEUEING_OFFSET UNITYSDK_OFFSET(0x1B0AE6D0)
#define FLOWCANVAS_NODES_WAITFORONEFRAME_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B0AE6E0)
#define FLOWCANVAS_NODES_WAITFORONEFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0AE720)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int WaitForOneFrame_TypeDefinitionIndex = 26848;
