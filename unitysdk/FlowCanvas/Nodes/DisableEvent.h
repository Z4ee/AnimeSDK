...
#define FLOWCANVAS_NODES_DISABLEEVENT_ONPOSTGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1D056010)
#define FLOWCANVAS_NODES_DISABLEEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D056050)
#define FLOWCANVAS_NODES_DISABLEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0560A0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int DisableEvent_TypeDefinitionIndex = 31512;
