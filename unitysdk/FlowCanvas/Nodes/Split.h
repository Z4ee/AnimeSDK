...
#define FLOWCANVAS_NODES_SPLIT_GET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0x1D533200)
#define FLOWCANVAS_NODES_SPLIT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D533220)
#define FLOWCANVAS_NODES_SPLIT_SET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0x1D533210)
#define FLOWCANVAS_NODES_SPLIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5333C0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Split_TypeDefinitionIndex = 29273;
