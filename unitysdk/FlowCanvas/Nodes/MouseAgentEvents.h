...
#define FLOWCANVAS_NODES_MOUSEAGENTEVENTS_ONMOUSEDOWN_OFFSET UNITYSDK_OFFSET(0x1D057590)
#define FLOWCANVAS_NODES_MOUSEAGENTEVENTS_ONMOUSEDRAG_OFFSET UNITYSDK_OFFSET(0x1D0576B0)
#define FLOWCANVAS_NODES_MOUSEAGENTEVENTS_ONMOUSEENTER_OFFSET UNITYSDK_OFFSET(0x1D0571F0)
#define FLOWCANVAS_NODES_MOUSEAGENTEVENTS_ONMOUSEEXIT_OFFSET UNITYSDK_OFFSET(0x1D057500)
#define FLOWCANVAS_NODES_MOUSEAGENTEVENTS_ONMOUSEOVER_OFFSET UNITYSDK_OFFSET(0x1D057470)
#define FLOWCANVAS_NODES_MOUSEAGENTEVENTS_ONMOUSEUP_OFFSET UNITYSDK_OFFSET(0x1D057620)
#define FLOWCANVAS_NODES_MOUSEAGENTEVENTS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D0568C0)
#define FLOWCANVAS_NODES_MOUSEAGENTEVENTS_STOREHIT_OFFSET UNITYSDK_OFFSET(0x1D057280)
#define FLOWCANVAS_NODES_MOUSEAGENTEVENTS_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1D056A30)
#define FLOWCANVAS_NODES_MOUSEAGENTEVENTS_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1D056E10)
#define FLOWCANVAS_NODES_MOUSEAGENTEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D057740)
#define FLOWCANVAS_NODES_MOUSEAGENTEVENTS__REGISTERPORTS_B__8_0_OFFSET UNITYSDK_OFFSET(0x1D057790)
#define FLOWCANVAS_NODES_MOUSEAGENTEVENTS__REGISTERPORTS_B__8_1_OFFSET UNITYSDK_OFFSET(0x1D0577A0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int MouseAgentEvents_TypeDefinitionIndex = 29982;

	class MouseAgentEvents : public ::FlowCanvas::Nodes::RouterEventNode_1<::UnityEngine::Collider*>
	{
	public:
		::FlowCanvas::FlowOutput* onEnter; // 0xC0
		::FlowCanvas::FlowOutput* onDown; // 0xC8
		::FlowCanvas::FlowOutput* onUp; // 0xD0
