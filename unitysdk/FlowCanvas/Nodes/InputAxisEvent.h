...
#define FLOWCANVAS_NODES_INPUTAXISEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1B49B660)
#define FLOWCANVAS_NODES_INPUTAXISEVENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B49B740)
#define FLOWCANVAS_NODES_INPUTAXISEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B49B750)
#define FLOWCANVAS_NODES_INPUTAXISEVENT__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x1B49B790)
#define FLOWCANVAS_NODES_INPUTAXISEVENT__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0x1B49B7A0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int InputAxisEvent_TypeDefinitionIndex = 28104;
