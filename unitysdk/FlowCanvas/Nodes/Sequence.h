...
#define FLOWCANVAS_NODES_SEQUENCE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19848490)
#define FLOWCANVAS_NODES_SEQUENCE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x19848450)
#define FLOWCANVAS_NODES_SEQUENCE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x19848480)
#define FLOWCANVAS_NODES_SEQUENCE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19848530)
#define FLOWCANVAS_NODES_SEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x19848750)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Sequence_TypeDefinitionIndex = 26977;
