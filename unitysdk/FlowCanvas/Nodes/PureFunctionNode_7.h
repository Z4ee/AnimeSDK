...
{
	inline static constexpr unsigned int PureFunctionNode_7_TypeDefinitionIndex = 31178;

	template <typename TResult, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6>
	class PureFunctionNode_7 : public ::FlowCanvas::Nodes::PureFunctionNodeBase
	{
	public:
	};
}
