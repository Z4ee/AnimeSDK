...
#define FLOWCANVAS_NODES_TWEENSCALE__INVOKE_D__0_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B0EDD50)
#define FLOWCANVAS_NODES_TWEENSCALE__INVOKE_D__0_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B0EE060)
#define FLOWCANVAS_NODES_TWEENSCALE__INVOKE_D__0_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B0EE0C0)
#define FLOWCANVAS_NODES_TWEENSCALE__INVOKE_D__0_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B0EE070)
#define FLOWCANVAS_NODES_TWEENSCALE__INVOKE_D__0_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B0EDD40)
#define FLOWCANVAS_NODES_TWEENSCALE__INVOKE_D__0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0EDD30)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TweenScale__Invoke_d__0_TypeDefinitionIndex = 26612;
	...
	public:
		...
		::ParadoxNotion::Animation::EaseType interpolation; // 0x3C
