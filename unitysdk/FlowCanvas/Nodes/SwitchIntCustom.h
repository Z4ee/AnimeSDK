...
#define FLOWCANVAS_NODES_SWITCHINTCUSTOM_ISCHOICENODE_OFFSET UNITYSDK_OFFSET(0x1EB6DEC0)
#define FLOWCANVAS_NODES_SWITCHINTCUSTOM_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1EB6DC90)
#define FLOWCANVAS_NODES_SWITCHINTCUSTOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB6DED0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SwitchIntCustom_TypeDefinitionIndex = 31151;
