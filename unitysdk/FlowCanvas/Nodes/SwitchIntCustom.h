...
#define FLOWCANVAS_NODES_SWITCHINTCUSTOM_ISCHOICENODE_OFFSET UNITYSDK_OFFSET(0x1D7BB0C0)
#define FLOWCANVAS_NODES_SWITCHINTCUSTOM_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D7BAE90)
#define FLOWCANVAS_NODES_SWITCHINTCUSTOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7BB0D0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SwitchIntCustom_TypeDefinitionIndex = 29280;
