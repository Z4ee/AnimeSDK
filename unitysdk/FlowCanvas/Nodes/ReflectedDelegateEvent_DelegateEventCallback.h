...
#define FLOWCANVAS_NODES_REFLECTEDDELEGATEEVENT_DELEGATEEVENTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E537AE0)
#define FLOWCANVAS_NODES_REFLECTEDDELEGATEEVENT_DELEGATEEVENTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E537B10)
#define FLOWCANVAS_NODES_REFLECTEDDELEGATEEVENT_DELEGATEEVENTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E537520)
#define FLOWCANVAS_NODES_REFLECTEDDELEGATEEVENT_DELEGATEEVENTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E534DC0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ReflectedDelegateEvent_DelegateEventCallback_TypeDefinitionIndex = 30715;
