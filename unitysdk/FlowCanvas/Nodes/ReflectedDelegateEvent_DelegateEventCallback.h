...
#define FLOWCANVAS_NODES_REFLECTEDDELEGATEEVENT_DELEGATEEVENTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ADAF320)
#define FLOWCANVAS_NODES_REFLECTEDDELEGATEEVENT_DELEGATEEVENTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ADAF350)
#define FLOWCANVAS_NODES_REFLECTEDDELEGATEEVENT_DELEGATEEVENTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ADAED80)
#define FLOWCANVAS_NODES_REFLECTEDDELEGATEEVENT_DELEGATEEVENTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADAC630)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ReflectedDelegateEvent_DelegateEventCallback_TypeDefinitionIndex = 28139;
