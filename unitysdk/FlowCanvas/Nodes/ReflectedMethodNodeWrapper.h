...
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_GETNODEWILDDEFINITIONTYPE_OFFSET UNITYSDK_OFFSET(0x1DFCB200)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_GET_METHOD_OFFSET UNITYSDK_OFFSET(0x1DFCA7F0)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1DFCA850)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_GET_REFLECTEDMETHODNODE_OFFSET UNITYSDK_OFFSET(0x1DFCA7D0)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_GET_SERIALIZEDMETHODBASE_OFFSET UNITYSDK_OFFSET(0x1DFCA820)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_GET_TMETHOD_OFFSET UNITYSDK_OFFSET(0x1DFCA830)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_ONPORTCONNECTED_OFFSET UNITYSDK_OFFSET(0x1DFCB060)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1DFCB280)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_SETMETHODBASE_OFFSET UNITYSDK_OFFSET(0x1DFCAE30)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_SETMETHOD_OFFSET UNITYSDK_OFFSET(0x1DFCAE60)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_SET_REFLECTEDMETHODNODE_OFFSET UNITYSDK_OFFSET(0x1DFCA7E0)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_SET_TMETHOD_OFFSET UNITYSDK_OFFSET(0x1DFCA840)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DFCB330)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ReflectedMethodNodeWrapper_TypeDefinitionIndex = 31012;
