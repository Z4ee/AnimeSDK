...
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_GETNODEWILDDEFINITIONTYPE_OFFSET UNITYSDK_OFFSET(0x1A847070)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_GET_METHOD_OFFSET UNITYSDK_OFFSET(0x1A846650)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A8466B0)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_GET_REFLECTEDMETHODNODE_OFFSET UNITYSDK_OFFSET(0x1A846630)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_GET_SERIALIZEDMETHODBASE_OFFSET UNITYSDK_OFFSET(0x1A846680)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_GET_TMETHOD_OFFSET UNITYSDK_OFFSET(0x1A846690)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_ONPORTCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A846ED0)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A8470F0)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_SETMETHODBASE_OFFSET UNITYSDK_OFFSET(0x1A846C90)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_SETMETHOD_OFFSET UNITYSDK_OFFSET(0x1A846CD0)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_SET_REFLECTEDMETHODNODE_OFFSET UNITYSDK_OFFSET(0x1A846640)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_SET_TMETHOD_OFFSET UNITYSDK_OFFSET(0x1A8466A0)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8471B0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ReflectedMethodNodeWrapper_TypeDefinitionIndex = 28190;

	class ReflectedMethodNodeWrapper : public ::FlowCanvas::Nodes::ReflectedMethodBaseNodeWrapper
	{
	public:
		::ParadoxNotion::Serialization::SerializedMethodInfo* _method; // 0xB0
		::FlowCanvas::Nodes::BaseReflectedMethodNode* _reflectedMethodNode_k__BackingField; // 0xB8
