...
#define FLOWCANVAS_NODES_CSHARPEVENTCALLBACK___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A843840)
#define FLOWCANVAS_NODES_CSHARPEVENTCALLBACK___C__DISPLAYCLASS14_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x1A843AB0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CSharpEventCallback___c__DisplayClass14_0_TypeDefinitionIndex = 27912;
