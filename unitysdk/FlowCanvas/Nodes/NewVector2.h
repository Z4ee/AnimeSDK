...
#define FLOWCANVAS_NODES_NEWVECTOR2_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D6DD5B0)
#define FLOWCANVAS_NODES_NEWVECTOR2__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6DD5C0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int NewVector2_TypeDefinitionIndex = 30635;
