...
#define FLOWCANVAS_NODES_DOONCE___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B457450)
#define FLOWCANVAS_NODES_DOONCE___C__DISPLAYCLASS2_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x1B457460)
#define FLOWCANVAS_NODES_DOONCE___C__DISPLAYCLASS2_0__REGISTERPORTS_B__1_OFFSET UNITYSDK_OFFSET(0x1B4574C0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int DoOnce___c__DisplayClass2_0_TypeDefinitionIndex = 26891;
