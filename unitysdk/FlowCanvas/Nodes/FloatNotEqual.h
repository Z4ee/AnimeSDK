...
#define FLOWCANVAS_NODES_FLOATNOTEQUAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DB93060)
#define FLOWCANVAS_NODES_FLOATNOTEQUAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB93070)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int FloatNotEqual_TypeDefinitionIndex = 30535;
