...
#define FLOWCANVAS_NODES_FLOATEQUAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DFC9570)
#define FLOWCANVAS_NODES_FLOATEQUAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DFC9580)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int FloatEqual_TypeDefinitionIndex = 30817;
