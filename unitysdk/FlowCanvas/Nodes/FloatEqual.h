...
#define FLOWCANVAS_NODES_FLOATEQUAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A8453F0)
#define FLOWCANVAS_NODES_FLOATEQUAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A845400)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int FloatEqual_TypeDefinitionIndex = 27228;
