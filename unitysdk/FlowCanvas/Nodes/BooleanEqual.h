...
#define FLOWCANVAS_NODES_BOOLEANEQUAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EB6A880)
#define FLOWCANVAS_NODES_BOOLEANEQUAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB6A890)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int BooleanEqual_TypeDefinitionIndex = 30388;
