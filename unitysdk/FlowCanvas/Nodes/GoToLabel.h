...
#define FLOWCANVAS_NODES_GOTOLABEL_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1E6CB890)
#define FLOWCANVAS_NODES_GOTOLABEL_GET_PORT_OFFSET UNITYSDK_OFFSET(0x1E6CB870)
#define FLOWCANVAS_NODES_GOTOLABEL_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1E6CB920)
#define FLOWCANVAS_NODES_GOTOLABEL_SET_PORT_OFFSET UNITYSDK_OFFSET(0x1E6CB880)
#define FLOWCANVAS_NODES_GOTOLABEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6CB970)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int GoToLabel_TypeDefinitionIndex = 30969;
