...
#define FLOWCANVAS_NODES_SHARPEVENT_CREATE_OFFSET UNITYSDK_OFFSET(0x198487E0)
#define FLOWCANVAS_NODES_SHARPEVENT_GET_EVENTINFO_OFFSET UNITYSDK_OFFSET(0x198487C0)
#define FLOWCANVAS_NODES_SHARPEVENT_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x198487A0)
#define FLOWCANVAS_NODES_SHARPEVENT_SETINSTANCE_OFFSET UNITYSDK_OFFSET(0x198489F0)
#define FLOWCANVAS_NODES_SHARPEVENT_SET_EVENTINFO_OFFSET UNITYSDK_OFFSET(0x198487D0)
#define FLOWCANVAS_NODES_SHARPEVENT_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x198487B0)
#define FLOWCANVAS_NODES_SHARPEVENT_STARTLISTENING_OFFSET UNITYSDK_OFFSET(0x19848A00)
#define FLOWCANVAS_NODES_SHARPEVENT_STOPLISTENING_OFFSET UNITYSDK_OFFSET(0x19848AC0)
#define FLOWCANVAS_NODES_SHARPEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19848B80)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SharpEvent_TypeDefinitionIndex = 28216;
