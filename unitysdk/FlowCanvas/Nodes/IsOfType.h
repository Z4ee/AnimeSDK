...
#define FLOWCANVAS_NODES_ISOFTYPE_GET_OBJECT_OFFSET UNITYSDK_OFFSET(0x19846840)
#define FLOWCANVAS_NODES_ISOFTYPE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19846860)
#define FLOWCANVAS_NODES_ISOFTYPE_SET_OBJECT_OFFSET UNITYSDK_OFFSET(0x19846850)
#define FLOWCANVAS_NODES_ISOFTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x19846900)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int IsOfType_TypeDefinitionIndex = 27052;
