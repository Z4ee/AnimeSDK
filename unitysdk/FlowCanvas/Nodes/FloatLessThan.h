...
#define FLOWCANVAS_NODES_FLOATLESSTHAN_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EBB4940)
#define FLOWCANVAS_NODES_FLOATLESSTHAN__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBB4950)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int FloatLessThan_TypeDefinitionIndex = 31082;
