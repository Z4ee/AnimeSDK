...
#define FLOWCANVAS_NODES_WAITFORPHYSICSFRAME__INVOKE_D__2_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BC45110)
#define FLOWCANVAS_NODES_WAITFORPHYSICSFRAME__INVOKE_D__2_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BC45180)
#define FLOWCANVAS_NODES_WAITFORPHYSICSFRAME__INVOKE_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BC451E0)
#define FLOWCANVAS_NODES_WAITFORPHYSICSFRAME__INVOKE_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BC45190)
#define FLOWCANVAS_NODES_WAITFORPHYSICSFRAME__INVOKE_D__2_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BC45100)
#define FLOWCANVAS_NODES_WAITFORPHYSICSFRAME__INVOKE_D__2__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC450F0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int WaitForPhysicsFrame__Invoke_d__2_TypeDefinitionIndex = 29453;
