...
#define FLOWCANVAS_NODES_WAITFORPHYSICSFRAME__INVOKE_D__2_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1DB27B80)
#define FLOWCANVAS_NODES_WAITFORPHYSICSFRAME__INVOKE_D__2_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DB27BF0)
#define FLOWCANVAS_NODES_WAITFORPHYSICSFRAME__INVOKE_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DB27C50)
#define FLOWCANVAS_NODES_WAITFORPHYSICSFRAME__INVOKE_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1DB27C00)
#define FLOWCANVAS_NODES_WAITFORPHYSICSFRAME__INVOKE_D__2_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DB27B70)
#define FLOWCANVAS_NODES_WAITFORPHYSICSFRAME__INVOKE_D__2__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB27B60)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int WaitForPhysicsFrame__Invoke_d__2_TypeDefinitionIndex = 29861;
