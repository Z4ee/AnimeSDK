...
#define FLOWCANVAS_NODES_FLOATMODULO_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DB93030)
#define FLOWCANVAS_NODES_FLOATMODULO__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB93040)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int FloatModulo_TypeDefinitionIndex = 30840;
