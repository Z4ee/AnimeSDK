...
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS_ONTRIGGERENTER2D_OFFSET UNITYSDK_OFFSET(0x1BCB7270)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS_ONTRIGGEREXIT2D_OFFSET UNITYSDK_OFFSET(0x1BCB73B0)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS_ONTRIGGERSTAY2D_OFFSET UNITYSDK_OFFSET(0x1BCB7310)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1BCB6D10)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1BCB6E30)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1BCB7050)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCB7450)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x1BCB74A0)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0x1BCB74B0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Trigger2DEvents_TypeDefinitionIndex = 30616;
