...
#define FLOWCANVAS_NODES_WAIT__INVOKE_D__8_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1E6CD820)
#define FLOWCANVAS_NODES_WAIT__INVOKE_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E6CD8F0)
#define FLOWCANVAS_NODES_WAIT__INVOKE_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E6CD950)
#define FLOWCANVAS_NODES_WAIT__INVOKE_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1E6CD900)
#define FLOWCANVAS_NODES_WAIT__INVOKE_D__8_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E6CD810)
#define FLOWCANVAS_NODES_WAIT__INVOKE_D__8__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6CD800)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Wait__Invoke_d__8_TypeDefinitionIndex = 30445;
