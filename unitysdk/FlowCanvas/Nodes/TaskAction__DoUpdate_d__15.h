...
#define FLOWCANVAS_NODES_TASKACTION__DOUPDATE_D__15_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AF23180)
#define FLOWCANVAS_NODES_TASKACTION__DOUPDATE_D__15_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AF232C0)
#define FLOWCANVAS_NODES_TASKACTION__DOUPDATE_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AF23320)
#define FLOWCANVAS_NODES_TASKACTION__DOUPDATE_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AF232D0)
#define FLOWCANVAS_NODES_TASKACTION__DOUPDATE_D__15_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AF23170)
#define FLOWCANVAS_NODES_TASKACTION__DOUPDATE_D__15__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF23160)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TaskAction__DoUpdate_d__15_TypeDefinitionIndex = 28223;
