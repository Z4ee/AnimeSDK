...
#define FLOWCANVAS_NODES_EXTRACTVECTOR2_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AFC0470)
#define FLOWCANVAS_NODES_EXTRACTVECTOR2__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFC0480)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ExtractVector2_TypeDefinitionIndex = 27502;
