...
#define FLOWCANVAS_NODES_EXTRACTVECTOR2_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E7A5B20)
#define FLOWCANVAS_NODES_EXTRACTVECTOR2__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7A5B30)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ExtractVector2_TypeDefinitionIndex = 31327;
