...
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT___C__DISPLAYCLASS22_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1D387E50)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT___C__DISPLAYCLASS22_0__NODECANVAS_FRAMEWORK_IINVOKABLE_INVOKEASYNC_B__0_OFFSET UNITYSDK_OFFSET(0x1D387E60)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CustomFunctionEvent___c__DisplayClass22_0_TypeDefinitionIndex = 30209;
