...
#define FLOWCANVAS_NODES_TWEENQUATERNION__INVOKE_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1E537EB0)
#define FLOWCANVAS_NODES_TWEENQUATERNION__INVOKE_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E538030)
#define FLOWCANVAS_NODES_TWEENQUATERNION__INVOKE_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E538090)
#define FLOWCANVAS_NODES_TWEENQUATERNION__INVOKE_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1E538040)
#define FLOWCANVAS_NODES_TWEENQUATERNION__INVOKE_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E537EA0)
#define FLOWCANVAS_NODES_TWEENQUATERNION__INVOKE_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x1E537E90)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TweenQuaternion__Invoke_d__4_TypeDefinitionIndex = 29894;
	...
	public:
		...
		::UnityEngine::Quaternion from; // 0x20
