...
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT_CALLBACK_OFFSET UNITYSDK_OFFSET(0x1DFC91E0)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT_GET_DELEGATETYPE_OFFSET UNITYSDK_OFFSET(0x1DFC8C80)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1DFC8D20)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1DFC9230)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT_ONPORTCONNECTED_OFFSET UNITYSDK_OFFSET(0x1DFC9240)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1DFC8D30)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT_SET_DELEGATETYPE_OFFSET UNITYSDK_OFFSET(0x1DFC8CA0)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DFC93E0)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT__REGISTERPORTS_B__9_0_OFFSET UNITYSDK_OFFSET(0x1DFC9420)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int DelegateCallbackEvent_TypeDefinitionIndex = 30547;

	class DelegateCallbackEvent : public ::FlowCanvas::Nodes::EventNode
	{
	public:
		::ParadoxNotion::Serialization::SerializedTypeInfo* _type; // 0xA8
		::FlowCanvas::ValueOutput* delegatePort; // 0xB0
		::FlowCanvas::Nodes::ReflectedDelegateEvent* reflectedEvent; // 0xB8
		::FlowCanvas::FlowOutput* callbackPort; // 0xC0
