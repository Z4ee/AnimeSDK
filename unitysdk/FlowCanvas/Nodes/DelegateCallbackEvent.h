...
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT_CALLBACK_OFFSET UNITYSDK_OFFSET(0x1CC33B50)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT_GET_DELEGATETYPE_OFFSET UNITYSDK_OFFSET(0x1CC335F0)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1CC33690)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1CC33BA0)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT_ONPORTCONNECTED_OFFSET UNITYSDK_OFFSET(0x1CC33BB0)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1CC336A0)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT_SET_DELEGATETYPE_OFFSET UNITYSDK_OFFSET(0x1CC33610)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC33D50)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT__REGISTERPORTS_B__9_0_OFFSET UNITYSDK_OFFSET(0x1CC33D90)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int DelegateCallbackEvent_TypeDefinitionIndex = 29742;

	class DelegateCallbackEvent : public ::FlowCanvas::Nodes::EventNode
	{
	public:
		::Il2CppArray<::System::Object*>* args; // 0xA8
		::FlowCanvas::FlowOutput* callbackPort; // 0xB0
