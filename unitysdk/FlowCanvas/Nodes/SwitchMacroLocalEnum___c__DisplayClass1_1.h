...
#define FLOWCANVAS_NODES_SWITCHMACROLOCALENUM___C__DISPLAYCLASS1_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5337C0)
#define FLOWCANVAS_NODES_SWITCHMACROLOCALENUM___C__DISPLAYCLASS1_1__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x1D533880)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SwitchMacroLocalEnum___c__DisplayClass1_1_TypeDefinitionIndex = 30244;

	class SwitchMacroLocalEnum___c__DisplayClass1_1 : public ::System::Object
	{
	public:
		::FlowCanvas::FlowOutput* defaultCase; // 0x10
		::FlowCanvas::ValueInput_1<::FlowCanvas::Macros::CustomMacroEnumWrap*>* selector; // 0x18
