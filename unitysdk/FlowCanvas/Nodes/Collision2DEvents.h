...
#define FLOWCANVAS_NODES_COLLISION2DEVENTS_ONCOLLISIONENTER2D_OFFSET UNITYSDK_OFFSET(0x1E6CB220)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS_ONCOLLISIONEXIT2D_OFFSET UNITYSDK_OFFSET(0x1E6CB340)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS_ONCOLLISIONSTAY2D_OFFSET UNITYSDK_OFFSET(0x1E6CB2B0)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1E6CAC50)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1E6CAE00)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1E6CB010)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6CB3D0)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x1E6CB420)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0x1E6CB430)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS__REGISTERPORTS_B__5_2_OFFSET UNITYSDK_OFFSET(0x1E6CB450)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS__REGISTERPORTS_B__5_3_OFFSET UNITYSDK_OFFSET(0x1E6CB510)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Collision2DEvents_TypeDefinitionIndex = 29768;
	...
	public:
		...
		::UnityEngine::Collision2D* collision; // 0xE0
