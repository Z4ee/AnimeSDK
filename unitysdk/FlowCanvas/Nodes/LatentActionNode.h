...
#define FLOWCANVAS_NODES_LATENTACTIONNODE_ONREGISTERDERIVEDPORTS_OFFSET UNITYSDK_OFFSET(0x1B417220)
#define FLOWCANVAS_NODES_LATENTACTIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4172E0)
#define FLOWCANVAS_NODES_LATENTACTIONNODE__ONREGISTERDERIVEDPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0x1B4172F0)
#define FLOWCANVAS_NODES_LATENTACTIONNODE__ONREGISTERDERIVEDPORTS_B__1_1_OFFSET UNITYSDK_OFFSET(0x1B417340)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int LatentActionNode_TypeDefinitionIndex = 26739;
