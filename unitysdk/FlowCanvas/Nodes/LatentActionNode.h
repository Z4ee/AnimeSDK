...
#define FLOWCANVAS_NODES_LATENTACTIONNODE_ONREGISTERDERIVEDPORTS_OFFSET UNITYSDK_OFFSET(0x1D7B8AC0)
#define FLOWCANVAS_NODES_LATENTACTIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7B8B80)
#define FLOWCANVAS_NODES_LATENTACTIONNODE__ONREGISTERDERIVEDPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0x1D7B8B90)
#define FLOWCANVAS_NODES_LATENTACTIONNODE__ONREGISTERDERIVEDPORTS_B__1_1_OFFSET UNITYSDK_OFFSET(0x1D7B8BE0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int LatentActionNode_TypeDefinitionIndex = 30498;
