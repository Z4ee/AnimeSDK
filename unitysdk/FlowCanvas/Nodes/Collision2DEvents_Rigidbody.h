...
#define FLOWCANVAS_NODES_COLLISION2DEVENTS_RIGIDBODY_ONCOLLISIONENTER2D_OFFSET UNITYSDK_OFFSET(0x1D531A80)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS_RIGIDBODY_ONCOLLISIONEXIT2D_OFFSET UNITYSDK_OFFSET(0x1D531BA0)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS_RIGIDBODY_ONCOLLISIONSTAY2D_OFFSET UNITYSDK_OFFSET(0x1D531B10)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS_RIGIDBODY_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D531490)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS_RIGIDBODY_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1D531640)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS_RIGIDBODY_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1D531860)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS_RIGIDBODY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D531C30)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS_RIGIDBODY__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x1D531C80)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS_RIGIDBODY__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0x1D531C90)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS_RIGIDBODY__REGISTERPORTS_B__5_2_OFFSET UNITYSDK_OFFSET(0x1D531CB0)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS_RIGIDBODY__REGISTERPORTS_B__5_3_OFFSET UNITYSDK_OFFSET(0x1D531D70)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Collision2DEvents_Rigidbody_TypeDefinitionIndex = 29822;
	...
	public:
		...
		::UnityEngine::Rigidbody2D* receiver; // 0xC8
