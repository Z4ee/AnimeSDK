...
#define FLOWCANVAS_NODES_COLLISION2DEVENTS_RIGIDBODY_ONCOLLISIONENTER2D_OFFSET UNITYSDK_OFFSET(0x1E229620)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS_RIGIDBODY_ONCOLLISIONEXIT2D_OFFSET UNITYSDK_OFFSET(0x1E229740)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS_RIGIDBODY_ONCOLLISIONSTAY2D_OFFSET UNITYSDK_OFFSET(0x1E2296B0)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS_RIGIDBODY_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1E229050)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS_RIGIDBODY_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1E229200)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS_RIGIDBODY_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1E229410)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS_RIGIDBODY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E2297D0)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS_RIGIDBODY__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x1E229820)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS_RIGIDBODY__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0x1E229830)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS_RIGIDBODY__REGISTERPORTS_B__5_2_OFFSET UNITYSDK_OFFSET(0x1E229850)
#define FLOWCANVAS_NODES_COLLISION2DEVENTS_RIGIDBODY__REGISTERPORTS_B__5_3_OFFSET UNITYSDK_OFFSET(0x1E229910)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Collision2DEvents_Rigidbody_TypeDefinitionIndex = 30189;
