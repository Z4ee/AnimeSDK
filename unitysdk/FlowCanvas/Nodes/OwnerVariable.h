...
#define FLOWCANVAS_NODES_OWNERVARIABLE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1DFCA070)
#define FLOWCANVAS_NODES_OWNERVARIABLE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1DFCA0B0)
#define FLOWCANVAS_NODES_OWNERVARIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DFCA130)
#define FLOWCANVAS_NODES_OWNERVARIABLE__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x1DFCA170)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int OwnerVariable_TypeDefinitionIndex = 31461;
