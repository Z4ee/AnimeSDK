...
#define FLOWCANVAS_NODES_CSHARPEVENTCALLBACK_CALLBACK_OFFSET UNITYSDK_OFFSET(0x1DFC79B0)
#define FLOWCANVAS_NODES_CSHARPEVENTCALLBACK_GETNODEWILDDEFINITIONTYPE_OFFSET UNITYSDK_OFFSET(0x1DFC7A00)
#define FLOWCANVAS_NODES_CSHARPEVENTCALLBACK_GET_AUTOHANDLEREGISTRATION_OFFSET UNITYSDK_OFFSET(0x1DFC72D0)
#define FLOWCANVAS_NODES_CSHARPEVENTCALLBACK_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1DFC7230)
#define FLOWCANVAS_NODES_CSHARPEVENTCALLBACK_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1DFC72E0)
#define FLOWCANVAS_NODES_CSHARPEVENTCALLBACK_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1DFC72F0)
#define FLOWCANVAS_NODES_CSHARPEVENTCALLBACK_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1DFC7420)
#define FLOWCANVAS_NODES_CSHARPEVENTCALLBACK_ONPORTCONNECTED_OFFSET UNITYSDK_OFFSET(0x1DFC7A30)
#define FLOWCANVAS_NODES_CSHARPEVENTCALLBACK_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1DFC7530)
#define FLOWCANVAS_NODES_CSHARPEVENTCALLBACK_REGISTER_OFFSET UNITYSDK_OFFSET(0x1DFC7300)
#define FLOWCANVAS_NODES_CSHARPEVENTCALLBACK_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1DFC7250)
#define FLOWCANVAS_NODES_CSHARPEVENTCALLBACK_UNREGISTER_OFFSET UNITYSDK_OFFSET(0x1DFC7450)
#define FLOWCANVAS_NODES_CSHARPEVENTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DFC7BD0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CSharpEventCallback_TypeDefinitionIndex = 30749;

	class CSharpEventCallback : public ::FlowCanvas::Nodes::EventNode
	{
	public:
		::FlowCanvas::Nodes::ReflectedDelegateEvent* reflectedEvent; // 0xA8
		::FlowCanvas::FlowOutput* flowCallback; // 0xB0
		::FlowCanvas::ValueInput* eventInput; // 0xB8
		::Il2CppArray<::System::Object*>* argValues; // 0xC0
