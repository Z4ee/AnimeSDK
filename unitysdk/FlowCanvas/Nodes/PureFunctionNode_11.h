...
{
	inline static constexpr unsigned int PureFunctionNode_11_TypeDefinitionIndex = 30881;
	...
	class PureFunctionNode_11 : public ::FlowCanvas::Nodes::PureFunctionNodeBase
	{
	public:
	};
}
