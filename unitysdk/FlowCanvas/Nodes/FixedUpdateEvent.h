...
#define FLOWCANVAS_NODES_FIXEDUPDATEEVENT_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1B4ACA40)
#define FLOWCANVAS_NODES_FIXEDUPDATEEVENT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1B4AC8A0)
#define FLOWCANVAS_NODES_FIXEDUPDATEEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1B4AC970)
#define FLOWCANVAS_NODES_FIXEDUPDATEEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1B4AC850)
#define FLOWCANVAS_NODES_FIXEDUPDATEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4ACA80)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int FixedUpdateEvent_TypeDefinitionIndex = 27597;
