...
#define FLOWCANVAS_NODES_FIXEDUPDATEEVENT_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1D7FE190)
#define FLOWCANVAS_NODES_FIXEDUPDATEEVENT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1D7FDFF0)
#define FLOWCANVAS_NODES_FIXEDUPDATEEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1D7FE0C0)
#define FLOWCANVAS_NODES_FIXEDUPDATEEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D7FDFA0)
#define FLOWCANVAS_NODES_FIXEDUPDATEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7FE1D0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int FixedUpdateEvent_TypeDefinitionIndex = 30431;
