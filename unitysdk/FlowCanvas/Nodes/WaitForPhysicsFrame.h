...
#define FLOWCANVAS_NODES_WAITFORPHYSICSFRAME_GET_ALLOWROUTINEQUEUEING_OFFSET UNITYSDK_OFFSET(0x1E5387A0)
#define FLOWCANVAS_NODES_WAITFORPHYSICSFRAME_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E5387B0)
#define FLOWCANVAS_NODES_WAITFORPHYSICSFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5387F0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int WaitForPhysicsFrame_TypeDefinitionIndex = 29860;
