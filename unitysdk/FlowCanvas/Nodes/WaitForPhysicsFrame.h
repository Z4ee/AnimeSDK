...
#define FLOWCANVAS_NODES_WAITFORPHYSICSFRAME_GET_ALLOWROUTINEQUEUEING_OFFSET UNITYSDK_OFFSET(0x1D1DC910)
#define FLOWCANVAS_NODES_WAITFORPHYSICSFRAME_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D1DC920)
#define FLOWCANVAS_NODES_WAITFORPHYSICSFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1DC960)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int WaitForPhysicsFrame_TypeDefinitionIndex = 29452;
