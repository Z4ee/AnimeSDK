...
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_GET_EVENTINFO_OFFSET UNITYSDK_OFFSET(0x1E5341D0)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_GET_ISSTATICEVENT_OFFSET UNITYSDK_OFFSET(0x1E5341F0)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1E534260)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1E5345D0)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_ONEVENTRAISED_OFFSET UNITYSDK_OFFSET(0x1E535030)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1E534AD0)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1E534E60)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1E534630)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_SETEVENT_OFFSET UNITYSDK_OFFSET(0x1E5345E0)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E535080)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CSharpAutoCallbackEvent_TypeDefinitionIndex = 30660;
	...
	public:
		...
		::System::Object* instance; // 0xB8
		::FlowCanvas::FlowOutput* callback; // 0xC0
		::ParadoxNotion::Serialization::SerializedEventInfo* _event; // 0xC8
		::FlowCanvas::Nodes::ReflectedDelegateEvent* reflectedEvent; // 0xD0
