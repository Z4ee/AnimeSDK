...
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_GET_EVENTINFO_OFFSET UNITYSDK_OFFSET(0x1ADABA30)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_GET_ISSTATICEVENT_OFFSET UNITYSDK_OFFSET(0x1ADABA50)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1ADABAC0)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1ADABE30)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_ONEVENTRAISED_OFFSET UNITYSDK_OFFSET(0x1ADAC890)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1ADAC340)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1ADAC6C0)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1ADABE90)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_SETEVENT_OFFSET UNITYSDK_OFFSET(0x1ADABE40)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADAC8E0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CSharpAutoCallbackEvent_TypeDefinitionIndex = 28066;
	...
	public:
		...
		::FlowCanvas::Nodes::ReflectedDelegateEvent* reflectedEvent; // 0xB8
		::Il2CppArray<::System::Object*>* args; // 0xC0
		::FlowCanvas::FlowOutput* callback; // 0xC8
		::FlowCanvas::ValueInput* instancePort; // 0xD0
