...
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_UNITYEVENTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EB911C0)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_UNITYEVENTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EB911F0)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_UNITYEVENTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EB90CA0)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_UNITYEVENTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB90C80)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ReflectedUnityEvent_UnityEventCallback_TypeDefinitionIndex = 31296;
