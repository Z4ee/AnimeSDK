...
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_ADD__CALLBACK_OFFSET UNITYSDK_OFFSET(0x1D389050)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_CALLBACKMETHOD0_OFFSET UNITYSDK_OFFSET(0x1D389BE0)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_GET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1D389160)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1D389150)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_INITFOREVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1D389190)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_REMOVE__CALLBACK_OFFSET UNITYSDK_OFFSET(0x1D3890D0)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_STARTLISTENING_OFFSET UNITYSDK_OFFSET(0x1D389800)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_STOPLISTENING_OFFSET UNITYSDK_OFFSET(0x1D3899F0)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D389180)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D389170)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ReflectedUnityEvent_TypeDefinitionIndex = 30529;

	class ReflectedUnityEvent : public ::System::Object
	{
	public:
		::System::Type* _eventType; // 0x10
		::System::Reflection::MethodInfo* _removeListenerMethod; // 0x18
		::System::Reflection::MethodInfo* _callMethod; // 0x20
		::Il2CppArray<::System::Reflection::ParameterInfo*>* _parameters; // 0x28
		::System::Reflection::MethodInfo* _addListenerMethod; // 0x30
		::FlowCanvas::Nodes::ReflectedUnityEvent_UnityEventCallback* _callback; // 0x38
