...
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_ADD__CALLBACK_OFFSET UNITYSDK_OFFSET(0x1A8F6260)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_CALLBACKMETHOD0_OFFSET UNITYSDK_OFFSET(0x1A8F6DF0)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_GET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A8F6370)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1A8F6360)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_INITFOREVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A8F63A0)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_REMOVE__CALLBACK_OFFSET UNITYSDK_OFFSET(0x1A8F62E0)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_STARTLISTENING_OFFSET UNITYSDK_OFFSET(0x1A8F6A10)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_STOPLISTENING_OFFSET UNITYSDK_OFFSET(0x1A8F6C00)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A8F6390)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8F6380)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ReflectedUnityEvent_TypeDefinitionIndex = 27688;

	class ReflectedUnityEvent : public ::System::Object
	{
	public:
		::System::Reflection::MethodInfo* _callMethod; // 0x10
		::System::Reflection::MethodInfo* _addListenerMethod; // 0x18
		::System::Reflection::MethodInfo* _removeListenerMethod; // 0x20
		::System::Type* _eventType; // 0x28
		::FlowCanvas::Nodes::ReflectedUnityEvent_UnityEventCallback* _callback; // 0x30
		::Il2CppArray<::System::Reflection::ParameterInfo*>* _parameters; // 0x38
