...
#define FLOWCANVAS_NODES_INTEGERADD_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E722620)
#define FLOWCANVAS_NODES_INTEGERADD__CTOR_OFFSET UNITYSDK_OFFSET(0x1E722630)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int IntegerAdd_TypeDefinitionIndex = 30915;
