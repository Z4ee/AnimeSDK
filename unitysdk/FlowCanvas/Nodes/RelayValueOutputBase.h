...
#define FLOWCANVAS_NODES_RELAYVALUEOUTPUTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF8A450)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int RelayValueOutputBase_TypeDefinitionIndex = 29887;
