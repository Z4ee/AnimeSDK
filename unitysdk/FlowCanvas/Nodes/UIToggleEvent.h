...
#define FLOWCANVAS_NODES_UITOGGLEEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1D6DF540)
#define FLOWCANVAS_NODES_UITOGGLEEVENT_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1D6DF450)
#define FLOWCANVAS_NODES_UITOGGLEEVENT_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1D6DF730)
#define FLOWCANVAS_NODES_UITOGGLEEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D6DF650)
#define FLOWCANVAS_NODES_UITOGGLEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6DF780)
#define FLOWCANVAS_NODES_UITOGGLEEVENT__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x1D6DF7D0)
#define FLOWCANVAS_NODES_UITOGGLEEVENT__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0x1D6DF830)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int UIToggleEvent_TypeDefinitionIndex = 30183;
