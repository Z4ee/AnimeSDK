...
#define FLOWCANVAS_NODES_MERGEBOTH_GET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0x1D51DDA0)
#define FLOWCANVAS_NODES_MERGEBOTH_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D51DDC0)
#define FLOWCANVAS_NODES_MERGEBOTH_SET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0x1D51DDB0)
#define FLOWCANVAS_NODES_MERGEBOTH__CHECKOUT_OFFSET UNITYSDK_OFFSET(0x1D51DF20)
#define FLOWCANVAS_NODES_MERGEBOTH__CTOR_OFFSET UNITYSDK_OFFSET(0x1D51E130)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int MergeBoth_TypeDefinitionIndex = 29621;
