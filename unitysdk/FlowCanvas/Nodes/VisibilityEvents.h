...
#define FLOWCANVAS_NODES_VISIBILITYEVENTS_ONBECAMEINVISIBLE_OFFSET UNITYSDK_OFFSET(0x1D7FF700)
#define FLOWCANVAS_NODES_VISIBILITYEVENTS_ONBECAMEVISIBLE_OFFSET UNITYSDK_OFFSET(0x1D7FF670)
#define FLOWCANVAS_NODES_VISIBILITYEVENTS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D7FF2B0)
#define FLOWCANVAS_NODES_VISIBILITYEVENTS_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1D7FF370)
#define FLOWCANVAS_NODES_VISIBILITYEVENTS_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1D7FF4F0)
#define FLOWCANVAS_NODES_VISIBILITYEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7FF790)
#define FLOWCANVAS_NODES_VISIBILITYEVENTS__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x1D7FF7E0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int VisibilityEvents_TypeDefinitionIndex = 29564;

	class VisibilityEvents : public ::FlowCanvas::Nodes::RouterEventNode_1<::UnityEngine::Transform*>
	{
	public:
		::FlowCanvas::FlowOutput* onVisible; // 0xC0
		::UnityEngine::GameObject* receiver; // 0xC8
		::FlowCanvas::FlowOutput* onInvisible; // 0xD0
