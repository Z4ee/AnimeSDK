...
#define FLOWCANVAS_NODES_VARIABLECHANGEDEVENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A297890)
#define FLOWCANVAS_NODES_VARIABLECHANGEDEVENT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A2979A0)
#define FLOWCANVAS_NODES_VARIABLECHANGEDEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A297B40)
#define FLOWCANVAS_NODES_VARIABLECHANGEDEVENT_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1A297D20)
#define FLOWCANVAS_NODES_VARIABLECHANGEDEVENT_ONVARIABLEREFCHANGE_OFFSET UNITYSDK_OFFSET(0x1A297D70)
#define FLOWCANVAS_NODES_VARIABLECHANGEDEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A297C40)
#define FLOWCANVAS_NODES_VARIABLECHANGEDEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A297DE0)
#define FLOWCANVAS_NODES_VARIABLECHANGEDEVENT__REGISTERPORTS_B__7_0_OFFSET UNITYSDK_OFFSET(0x1A297E20)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int VariableChangedEvent_TypeDefinitionIndex = 26974;
