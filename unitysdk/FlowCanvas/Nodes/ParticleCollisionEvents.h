...
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS_ONPARTICLECOLLISION_OFFSET UNITYSDK_OFFSET(0x1A295890)
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A295420)
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1A2955D0)
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1A295730)
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A295AF0)
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x1A295B40)
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0x1A295B50)
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS__REGISTERPORTS_B__4_2_OFFSET UNITYSDK_OFFSET(0x1A295B60)
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS__REGISTERPORTS_B__4_3_OFFSET UNITYSDK_OFFSET(0x1A295BA0)
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS__REGISTERPORTS_B__4_4_OFFSET UNITYSDK_OFFSET(0x1A295C00)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ParticleCollisionEvents_TypeDefinitionIndex = 26887;
