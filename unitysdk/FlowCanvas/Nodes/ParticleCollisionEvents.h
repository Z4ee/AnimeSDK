...
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS_ONPARTICLECOLLISION_OFFSET UNITYSDK_OFFSET(0x1DB255B0)
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1DB25140)
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1DB252F0)
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1DB25450)
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB25810)
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x1DB25860)
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0x1DB25870)
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS__REGISTERPORTS_B__4_2_OFFSET UNITYSDK_OFFSET(0x1DB25880)
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS__REGISTERPORTS_B__4_3_OFFSET UNITYSDK_OFFSET(0x1DB258C0)
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS__REGISTERPORTS_B__4_4_OFFSET UNITYSDK_OFFSET(0x1DB25920)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ParticleCollisionEvents_TypeDefinitionIndex = 29865;
	...
	public:
		...
		::System::Collections::Generic::List_1<::UnityEngine::ParticleCollisionEvent>* collisionEvents; // 0xD8
