...
#define FLOWCANVAS_NODES_NEWVECTOR4_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EB6BAB0)
#define FLOWCANVAS_NODES_NEWVECTOR4__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB6BAE0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int NewVector4_TypeDefinitionIndex = 30155;
