...
#define FLOWCANVAS_NODES_NEWVECTOR4_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B417400)
#define FLOWCANVAS_NODES_NEWVECTOR4__CTOR_OFFSET UNITYSDK_OFFSET(0x1B417430)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int NewVector4_TypeDefinitionIndex = 27186;
