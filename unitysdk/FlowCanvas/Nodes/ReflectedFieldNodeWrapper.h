...
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_GETRUNTIMEICONTYPE_OFFSET UNITYSDK_OFFSET(0x1BCB5BF0)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_GET_FIELD_OFFSET UNITYSDK_OFFSET(0x1BCB5C20)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1BCB5CA0)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_GET_REFLECTEDFIELDNODE_OFFSET UNITYSDK_OFFSET(0x1BCB5C40)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_GET_TACCESSMODE_OFFSET UNITYSDK_OFFSET(0x1BCB5C80)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_GET_TFIELD_OFFSET UNITYSDK_OFFSET(0x1BCB5C60)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1BCB5BE0)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_IMIGRATABLE_FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_0__MIGRATE_OFFSET UNITYSDK_OFFSET(0x1BCB5B40)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1BCB62B0)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_SETFIELD_OFFSET UNITYSDK_OFFSET(0x1BCB60F0)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_SET_REFLECTEDFIELDNODE_OFFSET UNITYSDK_OFFSET(0x1BCB5C50)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_SET_TACCESSMODE_OFFSET UNITYSDK_OFFSET(0x1BCB5C90)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_SET_TFIELD_OFFSET UNITYSDK_OFFSET(0x1BCB5C70)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCB6300)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ReflectedFieldNodeWrapper_TypeDefinitionIndex = 30802;
