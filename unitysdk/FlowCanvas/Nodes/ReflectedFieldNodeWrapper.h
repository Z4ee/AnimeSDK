...
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_GETRUNTIMEICONTYPE_OFFSET UNITYSDK_OFFSET(0x1D057A70)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_GET_FIELD_OFFSET UNITYSDK_OFFSET(0x1D057AA0)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1D057B20)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_GET_REFLECTEDFIELDNODE_OFFSET UNITYSDK_OFFSET(0x1D057AC0)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_GET_TACCESSMODE_OFFSET UNITYSDK_OFFSET(0x1D057B00)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_GET_TFIELD_OFFSET UNITYSDK_OFFSET(0x1D057AE0)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1D057A60)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_IMIGRATABLE_FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_0__MIGRATE_OFFSET UNITYSDK_OFFSET(0x1D0579C0)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D058120)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_SETFIELD_OFFSET UNITYSDK_OFFSET(0x1D057F60)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_SET_REFLECTEDFIELDNODE_OFFSET UNITYSDK_OFFSET(0x1D057AD0)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_SET_TACCESSMODE_OFFSET UNITYSDK_OFFSET(0x1D057B10)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_SET_TFIELD_OFFSET UNITYSDK_OFFSET(0x1D057AF0)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D058170)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ReflectedFieldNodeWrapper_TypeDefinitionIndex = 30705;
