...
#define FLOWCANVAS_NODES_WAITUNTIL_GET_ALLOWROUTINEQUEUEING_OFFSET UNITYSDK_OFFSET(0x1DFCBC10)
#define FLOWCANVAS_NODES_WAITUNTIL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DFCBC20)
#define FLOWCANVAS_NODES_WAITUNTIL_ONREGISTEREXTRAPORTS_OFFSET UNITYSDK_OFFSET(0x1DFCBC70)
#define FLOWCANVAS_NODES_WAITUNTIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DFCBCD0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int WaitUntil_TypeDefinitionIndex = 30937;
