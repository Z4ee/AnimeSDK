...
#define FLOWCANVAS_NODES_WAITUNTIL_GET_ALLOWROUTINEQUEUEING_OFFSET UNITYSDK_OFFSET(0x1A847A80)
#define FLOWCANVAS_NODES_WAITUNTIL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A847A90)
#define FLOWCANVAS_NODES_WAITUNTIL_ONREGISTEREXTRAPORTS_OFFSET UNITYSDK_OFFSET(0x1A847AE0)
#define FLOWCANVAS_NODES_WAITUNTIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A847B40)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int WaitUntil_TypeDefinitionIndex = 27663;
