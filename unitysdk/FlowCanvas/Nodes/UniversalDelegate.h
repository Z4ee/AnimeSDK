...
#define FLOWCANVAS_NODES_UNIVERSALDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D51F820)
#define FLOWCANVAS_NODES_UNIVERSALDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D51F850)
#define FLOWCANVAS_NODES_UNIVERSALDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D51F320)
#define FLOWCANVAS_NODES_UNIVERSALDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D51F300)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int UniversalDelegate_TypeDefinitionIndex = 29521;
