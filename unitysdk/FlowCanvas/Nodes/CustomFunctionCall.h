...
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONCALL_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1A8442E0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONCALL_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A844240)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONCALL_GET_SOURCEFUNCTIONUID_OFFSET UNITYSDK_OFFSET(0x1A8440C0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONCALL_GET_SOURCEFUNCTION_OFFSET UNITYSDK_OFFSET(0x1A8440E0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONCALL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A8447E0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONCALL_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A8444D0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONCALL_SETFUNCTION_OFFSET UNITYSDK_OFFSET(0x1A8443C0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONCALL_SET_SOURCEFUNCTIONUID_OFFSET UNITYSDK_OFFSET(0x1A8440D0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONCALL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A844A20)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONCALL__GET_SOURCEFUNCTION_B__9_0_OFFSET UNITYSDK_OFFSET(0x1A844A60)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CustomFunctionCall_TypeDefinitionIndex = 27122;
	...
	public:
		...
		::System::String* _sourceOutputUID; // 0xC0
		::Il2CppArray<::FlowCanvas::ValueInput*>* portArgs; // 0xC8
