...
#define FLOWCANVAS_NODES_NEWRECT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EF8A020)
#define FLOWCANVAS_NODES_NEWRECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF8A050)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int NewRect_TypeDefinitionIndex = 30945;
