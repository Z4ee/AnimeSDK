...
#define FLOWCANVAS_NODES_FORLOOP_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1DB93090)
#define FLOWCANVAS_NODES_FORLOOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB93270)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ForLoop_TypeDefinitionIndex = 29922;
