...
#define FLOWCANVAS_NODES_MOUSEPICKEVENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1EA93140)
#define FLOWCANVAS_NODES_MOUSEPICKEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1EA93250)
#define FLOWCANVAS_NODES_MOUSEPICKEVENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1EA932E0)
#define FLOWCANVAS_NODES_MOUSEPICKEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA932F0)
#define FLOWCANVAS_NODES_MOUSEPICKEVENT__REGISTERPORTS_B__7_0_OFFSET UNITYSDK_OFFSET(0x1EA93380)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int MousePickEvent_TypeDefinitionIndex = 31467;
	...
	public:
		...
		::NodeCanvas::Framework::BBParameter_1<::FlowCanvas::Nodes::MousePickEvent_ButtonKeys>* buttonKey; // 0xB8
