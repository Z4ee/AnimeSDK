...
#define FLOWCANVAS_NODES_MOUSEPICKEVENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1D6DD340)
#define FLOWCANVAS_NODES_MOUSEPICKEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D6DD450)
#define FLOWCANVAS_NODES_MOUSEPICKEVENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1D6DD4E0)
#define FLOWCANVAS_NODES_MOUSEPICKEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6DD4F0)
#define FLOWCANVAS_NODES_MOUSEPICKEVENT__REGISTERPORTS_B__7_0_OFFSET UNITYSDK_OFFSET(0x1D6DD580)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int MousePickEvent_TypeDefinitionIndex = 29550;
