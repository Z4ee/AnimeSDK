...
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE__INTERNALCOROUTINE_D__15_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1E22A3B0)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE__INTERNALCOROUTINE_D__15_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E22A800)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE__INTERNALCOROUTINE_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E22A860)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE__INTERNALCOROUTINE_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1E22A810)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE__INTERNALCOROUTINE_D__15_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E22A3A0)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE__INTERNALCOROUTINE_D__15__CTOR_OFFSET UNITYSDK_OFFSET(0x1E22A150)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int LatentActionNodeBase__InternalCoroutine_d__15_TypeDefinitionIndex = 31174;

	class LatentActionNodeBase__InternalCoroutine_d__15 : public ::System::Object
	{
	public:
		::FlowCanvas::Flow _f_5__2; // 0x10
		::FlowCanvas::Nodes::LatentActionNodeBase_RoutineData data; // 0x38
		::FlowCanvas::Nodes::LatentActionNodeBase* __4__this; // 0x68
