...
#define FLOWCANVAS_NODES_WAITWHILE_GET_ALLOWROUTINEQUEUEING_OFFSET UNITYSDK_OFFSET(0x1B7E3FD0)
#define FLOWCANVAS_NODES_WAITWHILE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B7E3FE0)
#define FLOWCANVAS_NODES_WAITWHILE_ONREGISTEREXTRAPORTS_OFFSET UNITYSDK_OFFSET(0x1B7E4030)
#define FLOWCANVAS_NODES_WAITWHILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7E4090)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int WaitWhile_TypeDefinitionIndex = 26657;
