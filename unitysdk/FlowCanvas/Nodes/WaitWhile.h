...
#define FLOWCANVAS_NODES_WAITWHILE_GET_ALLOWROUTINEQUEUEING_OFFSET UNITYSDK_OFFSET(0x1DB95C00)
#define FLOWCANVAS_NODES_WAITWHILE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DB95C10)
#define FLOWCANVAS_NODES_WAITWHILE_ONREGISTEREXTRAPORTS_OFFSET UNITYSDK_OFFSET(0x1DB95C60)
#define FLOWCANVAS_NODES_WAITWHILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB95CC0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int WaitWhile_TypeDefinitionIndex = 30597;
