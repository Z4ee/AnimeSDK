...
namespace FlowCanvas::Nodes { template <typename T1, typename T2, typename T3, typename T4, typename T5> class ExtractorNode_5; }
...
namespace FlowCanvas::Nodes
{
	...
	{
	public:
		::FlowCanvas::Nodes::ExtractorNode_5<TInstance, T1, T2, T3, T4>* __4__this; // 0x0
