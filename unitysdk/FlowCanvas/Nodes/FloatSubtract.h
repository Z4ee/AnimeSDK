...
#define FLOWCANVAS_NODES_FLOATSUBTRACT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B49B350)
#define FLOWCANVAS_NODES_FLOATSUBTRACT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B49B360)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int FloatSubtract_TypeDefinitionIndex = 26944;
