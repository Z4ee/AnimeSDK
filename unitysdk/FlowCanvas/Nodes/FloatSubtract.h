...
#define FLOWCANVAS_NODES_FLOATSUBTRACT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EB7DE10)
#define FLOWCANVAS_NODES_FLOATSUBTRACT__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB7DE20)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int FloatSubtract_TypeDefinitionIndex = 30474;
