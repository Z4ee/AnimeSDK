...
#define FLOWCANVAS_NODES_FLOWNESTEDBT_ONAFTERUPDATECALL_OFFSET UNITYSDK_OFFSET(0x1D83B670)
#define FLOWCANVAS_NODES_FLOWNESTEDBT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D83B5E0)
#define FLOWCANVAS_NODES_FLOWNESTEDBT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D83B6A0)
#define FLOWCANVAS_NODES_FLOWNESTEDBT__REGISTERPORTS_B__0_0_OFFSET UNITYSDK_OFFSET(0x1D83B730)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int FlowNestedBT_TypeDefinitionIndex = 29355;
