...
#define FLOWCANVAS_NODES_FLOATADD_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D7B8A90)
#define FLOWCANVAS_NODES_FLOATADD__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7B8AA0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int FloatAdd_TypeDefinitionIndex = 30733;
