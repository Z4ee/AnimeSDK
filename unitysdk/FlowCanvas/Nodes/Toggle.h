...
#define FLOWCANVAS_NODES_TOGGLE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1EA94380)
#define FLOWCANVAS_NODES_TOGGLE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1EA943E0)
#define FLOWCANVAS_NODES_TOGGLE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1EA943F0)
#define FLOWCANVAS_NODES_TOGGLE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1EA94400)
#define FLOWCANVAS_NODES_TOGGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA94590)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Toggle_TypeDefinitionIndex = 30719;
