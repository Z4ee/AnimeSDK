...
#define FLOWCANVAS_NODES_TRIGGEREVENTS_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1B0EDA20)
#define FLOWCANVAS_NODES_TRIGGEREVENTS_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x1B0EDB60)
#define FLOWCANVAS_NODES_TRIGGEREVENTS_ONTRIGGERSTAY_OFFSET UNITYSDK_OFFSET(0x1B0EDAC0)
#define FLOWCANVAS_NODES_TRIGGEREVENTS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1B0ED4E0)
#define FLOWCANVAS_NODES_TRIGGEREVENTS_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1B0ED600)
#define FLOWCANVAS_NODES_TRIGGEREVENTS_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1B0ED810)
#define FLOWCANVAS_NODES_TRIGGEREVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0EDC00)
#define FLOWCANVAS_NODES_TRIGGEREVENTS__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x1B0EDC50)
#define FLOWCANVAS_NODES_TRIGGEREVENTS__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0x1B0EDC60)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TriggerEvents_TypeDefinitionIndex = 27771;
