...
#define FLOWCANVAS_NODES_TRIGGEREVENTS_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1D534260)
#define FLOWCANVAS_NODES_TRIGGEREVENTS_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x1D5343A0)
#define FLOWCANVAS_NODES_TRIGGEREVENTS_ONTRIGGERSTAY_OFFSET UNITYSDK_OFFSET(0x1D534300)
#define FLOWCANVAS_NODES_TRIGGEREVENTS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D533D00)
#define FLOWCANVAS_NODES_TRIGGEREVENTS_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1D533E20)
#define FLOWCANVAS_NODES_TRIGGEREVENTS_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1D534040)
#define FLOWCANVAS_NODES_TRIGGEREVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D534440)
#define FLOWCANVAS_NODES_TRIGGEREVENTS__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x1D534490)
#define FLOWCANVAS_NODES_TRIGGEREVENTS__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0x1D5344A0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TriggerEvents_TypeDefinitionIndex = 29193;
