...
{
	inline static constexpr unsigned int PureFunctionNode_9_TypeDefinitionIndex = 26979;
	...
	class PureFunctionNode_9 : public ::FlowCanvas::Nodes::PureFunctionNodeBase
	{
	public:
	};
}
