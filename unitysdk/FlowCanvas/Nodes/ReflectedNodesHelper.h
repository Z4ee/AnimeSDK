...
#define FLOWCANVAS_NODES_REFLECTEDNODESHELPER_GETDEFFROMINFO_OFFSET UNITYSDK_OFFSET(0x1A296880)
#define FLOWCANVAS_NODES_REFLECTEDNODESHELPER_GETGENERATEDKEY_OFFSET UNITYSDK_OFFSET(0x1A297300)
#define FLOWCANVAS_NODES_REFLECTEDNODESHELPER_GETGETTERDEFFROMINFO_OFFSET UNITYSDK_OFFSET(0x1A2966C0)
#define FLOWCANVAS_NODES_REFLECTEDNODESHELPER_INITPARAMS_1_OFFSET UNITYSDK_OFFSET(0x1A296D70)
#define FLOWCANVAS_NODES_REFLECTEDNODESHELPER_INITPARAMS_2_OFFSET UNITYSDK_OFFSET(0x1A293E30)
#define FLOWCANVAS_NODES_REFLECTEDNODESHELPER_INITPARAMS_3_OFFSET UNITYSDK_OFFSET(0x1A297000)
#define FLOWCANVAS_NODES_REFLECTEDNODESHELPER_INITPARAMS_4_OFFSET UNITYSDK_OFFSET(0x1A2971A0)
#define FLOWCANVAS_NODES_REFLECTEDNODESHELPER_INITPARAMS_OFFSET UNITYSDK_OFFSET(0x1A296B30)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ReflectedNodesHelper_TypeDefinitionIndex = 27930;
