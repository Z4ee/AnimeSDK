...
#define FLOWCANVAS_NODES_GOTOSTATEMENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1D51D760)
#define FLOWCANVAS_NODES_GOTOSTATEMENT_GET_TARGET_OFFSET UNITYSDK_OFFSET(0x1D51D700)
#define FLOWCANVAS_NODES_GOTOSTATEMENT_NODECANVAS_FRAMEWORK_IHAVENODEREFERENCE_GET_TARGETREFERENCE_OFFSET UNITYSDK_OFFSET(0x1D51D6F0)
#define FLOWCANVAS_NODES_GOTOSTATEMENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D51D940)
#define FLOWCANVAS_NODES_GOTOSTATEMENT_SETTARGET_OFFSET UNITYSDK_OFFSET(0x1D51D8A0)
#define FLOWCANVAS_NODES_GOTOSTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D51D9B0)
#define FLOWCANVAS_NODES_GOTOSTATEMENT__REGISTERPORTS_B__8_0_OFFSET UNITYSDK_OFFSET(0x1D51D9F0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int GoToStatement_TypeDefinitionIndex = 30795;
