...
#define FLOWCANVAS_NODES_GOTOSTATEMENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B0AC5F0)
#define FLOWCANVAS_NODES_GOTOSTATEMENT_GET_TARGET_OFFSET UNITYSDK_OFFSET(0x1B0AC590)
#define FLOWCANVAS_NODES_GOTOSTATEMENT_NODECANVAS_FRAMEWORK_IHAVENODEREFERENCE_GET_TARGETREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B0AC580)
#define FLOWCANVAS_NODES_GOTOSTATEMENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1B0AC7D0)
#define FLOWCANVAS_NODES_GOTOSTATEMENT_SETTARGET_OFFSET UNITYSDK_OFFSET(0x1B0AC730)
#define FLOWCANVAS_NODES_GOTOSTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0AC840)
#define FLOWCANVAS_NODES_GOTOSTATEMENT__REGISTERPORTS_B__8_0_OFFSET UNITYSDK_OFFSET(0x1B0AC880)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int GoToStatement_TypeDefinitionIndex = 27347;
