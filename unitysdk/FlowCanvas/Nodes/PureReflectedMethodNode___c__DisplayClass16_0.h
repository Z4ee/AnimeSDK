...
#define FLOWCANVAS_NODES_PUREREFLECTEDMETHODNODE___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B417A60)
#define FLOWCANVAS_NODES_PUREREFLECTEDMETHODNODE___C__DISPLAYCLASS16_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x1B417A70)
#define FLOWCANVAS_NODES_PUREREFLECTEDMETHODNODE___C__DISPLAYCLASS16_0__REGISTERPORTS_B__1_OFFSET UNITYSDK_OFFSET(0x1B417A90)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int PureReflectedMethodNode___c__DisplayClass16_0_TypeDefinitionIndex = 27962;
