...
#define FLOWCANVAS_NODES_SIGNALCALLBACK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1D7B9980)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_GET_SIGNALDEFINITION_OFFSET UNITYSDK_OFFSET(0x1D7B98C0)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1D7BA300)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1D7BA080)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_ONINVOKED_OFFSET UNITYSDK_OFFSET(0x1D7BA950)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1D7B9CF0)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D7BA580)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_SETTARGET_OFFSET UNITYSDK_OFFSET(0x1D7B9C10)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_SET_SIGNALDEFINITION_OFFSET UNITYSDK_OFFSET(0x1D7B9920)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1D7B9CD0)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1D7B9CE0)
#define FLOWCANVAS_NODES_SIGNALCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7BAD40)
#define FLOWCANVAS_NODES_SIGNALCALLBACK__REGISTERPORTS_B__16_0_OFFSET UNITYSDK_OFFSET(0x1D7BAD90)
#define FLOWCANVAS_NODES_SIGNALCALLBACK__REGISTERPORTS_B__16_1_OFFSET UNITYSDK_OFFSET(0x1D7BADA0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SignalCallback_TypeDefinitionIndex = 29116;
	...
	public:
		...
		::NodeCanvas::Framework::BBParameter_1<::NodeCanvas::Framework::SignalDefinition*>* _signalDefinition; // 0xD0
		::Il2CppArray<::System::Object*>* args; // 0xD8
		::UnityEngine::Transform* sender; // 0xE0
