...
#define FLOWCANVAS_NODES_LDCOOLDOWN__COUNTDOWN_D__15_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xF5D1990)
#define FLOWCANVAS_NODES_LDCOOLDOWN__COUNTDOWN_D__15_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xF5D1C60)
#define FLOWCANVAS_NODES_LDCOOLDOWN__COUNTDOWN_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xF5D1CC0)
#define FLOWCANVAS_NODES_LDCOOLDOWN__COUNTDOWN_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xF5D1C70)
#define FLOWCANVAS_NODES_LDCOOLDOWN__COUNTDOWN_D__15_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xF5D1980)
#define FLOWCANVAS_NODES_LDCOOLDOWN__COUNTDOWN_D__15__CTOR_OFFSET UNITYSDK_OFFSET(0xF5D1970)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCoolDown__CountDown_d__15_TypeDefinitionIndex = 55379;
