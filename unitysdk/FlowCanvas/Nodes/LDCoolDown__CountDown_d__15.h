...
#define FLOWCANVAS_NODES_LDCOOLDOWN__COUNTDOWN_D__15_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x11CE0E40)
#define FLOWCANVAS_NODES_LDCOOLDOWN__COUNTDOWN_D__15_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x11CE1110)
#define FLOWCANVAS_NODES_LDCOOLDOWN__COUNTDOWN_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x11CE1170)
#define FLOWCANVAS_NODES_LDCOOLDOWN__COUNTDOWN_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x11CE1120)
#define FLOWCANVAS_NODES_LDCOOLDOWN__COUNTDOWN_D__15_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11CE0E30)
#define FLOWCANVAS_NODES_LDCOOLDOWN__COUNTDOWN_D__15__CTOR_OFFSET UNITYSDK_OFFSET(0x11CE0E20)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCoolDown__CountDown_d__15_TypeDefinitionIndex = 54967;
	...
	public:
		...
		::FlowCanvas::Nodes::LDCoolDown* __4__this; // 0x40
