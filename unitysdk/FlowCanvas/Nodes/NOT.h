...
#define FLOWCANVAS_NODES_NOT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DFCA040)
#define FLOWCANVAS_NODES_NOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DFCA050)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int NOT_TypeDefinitionIndex = 31031;
