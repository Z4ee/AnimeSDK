...
#define FLOWCANVAS_NODES_EXTRACTRAYCASTHIT2D_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EB8F2A0)
#define FLOWCANVAS_NODES_EXTRACTRAYCASTHIT2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB8F590)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ExtractRaycastHit2D_TypeDefinitionIndex = 31081;
