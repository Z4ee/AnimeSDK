...
#define FLOWCANVAS_NODES_EXTRACTRAYCASTHIT2D_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B457600)
#define FLOWCANVAS_NODES_EXTRACTRAYCASTHIT2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4578F0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ExtractRaycastHit2D_TypeDefinitionIndex = 26897;
