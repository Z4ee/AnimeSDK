...
#define FLOWCANVAS_NODES_TWEENPOSITION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E537DE0)
#define FLOWCANVAS_NODES_TWEENPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E537E70)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TweenPosition_TypeDefinitionIndex = 30970;
