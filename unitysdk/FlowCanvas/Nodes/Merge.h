...
#define FLOWCANVAS_NODES_MERGE_GET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0x1EB8FCB0)
#define FLOWCANVAS_NODES_MERGE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1EB8FBF0)
#define FLOWCANVAS_NODES_MERGE_SET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0x1EB8FCC0)
#define FLOWCANVAS_NODES_MERGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB8FCD0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Merge_TypeDefinitionIndex = 30703;
