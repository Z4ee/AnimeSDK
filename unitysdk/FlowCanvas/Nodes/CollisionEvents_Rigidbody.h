...
#define FLOWCANVAS_NODES_COLLISIONEVENTS_RIGIDBODY_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0x1D7B8070)
#define FLOWCANVAS_NODES_COLLISIONEVENTS_RIGIDBODY_ONCOLLISIONEXIT_OFFSET UNITYSDK_OFFSET(0x1D7B8190)
#define FLOWCANVAS_NODES_COLLISIONEVENTS_RIGIDBODY_ONCOLLISIONSTAY_OFFSET UNITYSDK_OFFSET(0x1D7B8100)
#define FLOWCANVAS_NODES_COLLISIONEVENTS_RIGIDBODY_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D7B7A80)
#define FLOWCANVAS_NODES_COLLISIONEVENTS_RIGIDBODY_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1D7B7C30)
#define FLOWCANVAS_NODES_COLLISIONEVENTS_RIGIDBODY_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1D7B7E50)
#define FLOWCANVAS_NODES_COLLISIONEVENTS_RIGIDBODY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7B8220)
#define FLOWCANVAS_NODES_COLLISIONEVENTS_RIGIDBODY__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x1D7B8270)
#define FLOWCANVAS_NODES_COLLISIONEVENTS_RIGIDBODY__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0x1D7B8280)
#define FLOWCANVAS_NODES_COLLISIONEVENTS_RIGIDBODY__REGISTERPORTS_B__5_2_OFFSET UNITYSDK_OFFSET(0x1D7B82A0)
#define FLOWCANVAS_NODES_COLLISIONEVENTS_RIGIDBODY__REGISTERPORTS_B__5_3_OFFSET UNITYSDK_OFFSET(0x1D7B8350)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CollisionEvents_Rigidbody_TypeDefinitionIndex = 29954;

	class CollisionEvents_Rigidbody : public ::FlowCanvas::Nodes::RouterEventNode_1<::UnityEngine::Rigidbody*>
	{
	public:
		::UnityEngine::Collision* collision; // 0xC0
