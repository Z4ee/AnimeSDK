...
#define FLOWCANVAS_NODES_COLLISIONEVENTS_RIGIDBODY_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0x1EB6AE80)
#define FLOWCANVAS_NODES_COLLISIONEVENTS_RIGIDBODY_ONCOLLISIONEXIT_OFFSET UNITYSDK_OFFSET(0x1EB6AFA0)
#define FLOWCANVAS_NODES_COLLISIONEVENTS_RIGIDBODY_ONCOLLISIONSTAY_OFFSET UNITYSDK_OFFSET(0x1EB6AF10)
#define FLOWCANVAS_NODES_COLLISIONEVENTS_RIGIDBODY_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1EB6A8B0)
#define FLOWCANVAS_NODES_COLLISIONEVENTS_RIGIDBODY_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1EB6AA60)
#define FLOWCANVAS_NODES_COLLISIONEVENTS_RIGIDBODY_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1EB6AC70)
#define FLOWCANVAS_NODES_COLLISIONEVENTS_RIGIDBODY__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB6B030)
#define FLOWCANVAS_NODES_COLLISIONEVENTS_RIGIDBODY__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x1EB6B080)
#define FLOWCANVAS_NODES_COLLISIONEVENTS_RIGIDBODY__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0x1EB6B090)
#define FLOWCANVAS_NODES_COLLISIONEVENTS_RIGIDBODY__REGISTERPORTS_B__5_2_OFFSET UNITYSDK_OFFSET(0x1EB6B0B0)
#define FLOWCANVAS_NODES_COLLISIONEVENTS_RIGIDBODY__REGISTERPORTS_B__5_3_OFFSET UNITYSDK_OFFSET(0x1EB6B160)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CollisionEvents_Rigidbody_TypeDefinitionIndex = 31080;
	...
	public:
		...
		::UnityEngine::Rigidbody* receiver; // 0xD8
