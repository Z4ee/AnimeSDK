...
#define FLOWCANVAS_NODES_TWEENVECTOR3_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D6DF370)
#define FLOWCANVAS_NODES_TWEENVECTOR3_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D6DF3A0)
#define FLOWCANVAS_NODES_TWEENVECTOR3_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D6DF390)
#define FLOWCANVAS_NODES_TWEENVECTOR3__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6DF430)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TweenVector3_TypeDefinitionIndex = 30647;
