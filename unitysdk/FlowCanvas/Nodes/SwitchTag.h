...
#define FLOWCANVAS_NODES_SWITCHTAG_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D6DE350)
#define FLOWCANVAS_NODES_SWITCHTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6DE560)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SwitchTag_TypeDefinitionIndex = 29364;
