...
#define FLOWCANVAS_NODES_NEWCOLOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EB90C30)
#define FLOWCANVAS_NODES_NEWCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB90C60)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int NewColor_TypeDefinitionIndex = 30473;
