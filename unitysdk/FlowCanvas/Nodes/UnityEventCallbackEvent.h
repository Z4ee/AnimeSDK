...
#define FLOWCANVAS_NODES_UNITYEVENTCALLBACKEVENT_GETNODEWILDDEFINITIONTYPE_OFFSET UNITYSDK_OFFSET(0x1E723E70)
#define FLOWCANVAS_NODES_UNITYEVENTCALLBACKEVENT_GET_AUTOHANDLEREGISTRATION_OFFSET UNITYSDK_OFFSET(0x1E7237B0)
#define FLOWCANVAS_NODES_UNITYEVENTCALLBACKEVENT_GET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1E723710)
#define FLOWCANVAS_NODES_UNITYEVENTCALLBACKEVENT_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1E7237C0)
#define FLOWCANVAS_NODES_UNITYEVENTCALLBACKEVENT_ONEVENTRAISED_OFFSET UNITYSDK_OFFSET(0x1E723E20)
#define FLOWCANVAS_NODES_UNITYEVENTCALLBACKEVENT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1E7237D0)
#define FLOWCANVAS_NODES_UNITYEVENTCALLBACKEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1E723910)
#define FLOWCANVAS_NODES_UNITYEVENTCALLBACKEVENT_ONPORTCONNECTED_OFFSET UNITYSDK_OFFSET(0x1E723EA0)
#define FLOWCANVAS_NODES_UNITYEVENTCALLBACKEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1E723A10)
#define FLOWCANVAS_NODES_UNITYEVENTCALLBACKEVENT_REGISTER_OFFSET UNITYSDK_OFFSET(0x1E7237E0)
#define FLOWCANVAS_NODES_UNITYEVENTCALLBACKEVENT_SET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1E723730)
#define FLOWCANVAS_NODES_UNITYEVENTCALLBACKEVENT_UNREGISTER_OFFSET UNITYSDK_OFFSET(0x1E723920)
#define FLOWCANVAS_NODES_UNITYEVENTCALLBACKEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E724040)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int UnityEventCallbackEvent_TypeDefinitionIndex = 30372;

	class UnityEventCallbackEvent : public ::FlowCanvas::Nodes::EventNode
	{
	public:
		::ParadoxNotion::Serialization::SerializedTypeInfo* _type; // 0xA8
		::FlowCanvas::ValueInput* eventInput; // 0xB0
		::FlowCanvas::Nodes::ReflectedUnityEvent* reflectedEvent; // 0xB8
		::FlowCanvas::FlowOutput* flowCallback; // 0xC0
