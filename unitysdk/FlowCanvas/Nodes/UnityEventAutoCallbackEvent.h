...
#define FLOWCANVAS_NODES_UNITYEVENTAUTOCALLBACKEVENT_GET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1DB94D30)
#define FLOWCANVAS_NODES_UNITYEVENTAUTOCALLBACKEVENT_GET_FIELD_OFFSET UNITYSDK_OFFSET(0x1DB94DB0)
#define FLOWCANVAS_NODES_UNITYEVENTAUTOCALLBACKEVENT_GET_ISSTATIC_OFFSET UNITYSDK_OFFSET(0x1DB94D10)
#define FLOWCANVAS_NODES_UNITYEVENTAUTOCALLBACKEVENT_GET_MEMBER_OFFSET UNITYSDK_OFFSET(0x1DB94CF0)
#define FLOWCANVAS_NODES_UNITYEVENTAUTOCALLBACKEVENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1DB94E50)
#define FLOWCANVAS_NODES_UNITYEVENTAUTOCALLBACKEVENT_GET_PROP_OFFSET UNITYSDK_OFFSET(0x1DB94E00)
#define FLOWCANVAS_NODES_UNITYEVENTAUTOCALLBACKEVENT_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1DB95180)
#define FLOWCANVAS_NODES_UNITYEVENTAUTOCALLBACKEVENT_ONEVENTRAISED_OFFSET UNITYSDK_OFFSET(0x1DB95A20)
#define FLOWCANVAS_NODES_UNITYEVENTAUTOCALLBACKEVENT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1DB95610)
#define FLOWCANVAS_NODES_UNITYEVENTAUTOCALLBACKEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1DB95990)
#define FLOWCANVAS_NODES_UNITYEVENTAUTOCALLBACKEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1DB951F0)
#define FLOWCANVAS_NODES_UNITYEVENTAUTOCALLBACKEVENT_SETEVENT_OFFSET UNITYSDK_OFFSET(0x1DB95190)
#define FLOWCANVAS_NODES_UNITYEVENTAUTOCALLBACKEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB95A70)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int UnityEventAutoCallbackEvent_TypeDefinitionIndex = 30314;

	class UnityEventAutoCallbackEvent : public ::FlowCanvas::Nodes::EventNode
	{
	public:
		::UnityEngine::Events::UnityEventBase* unityEvent; // 0xA8
		::ParadoxNotion::Serialization::SerializedUnityEventInfo* _eventMember; // 0xB0
		::FlowCanvas::FlowOutput* callback; // 0xB8
