...
{
	inline static constexpr unsigned int PureFunctionNode_10_TypeDefinitionIndex = 31360;
	...
	class PureFunctionNode_10 : public ::FlowCanvas::Nodes::PureFunctionNodeBase
	{
	public:
	};
}
