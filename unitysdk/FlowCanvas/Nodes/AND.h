...
#define FLOWCANVAS_NODES_AND_INVOKE_OFFSET UNITYSDK_OFFSET(0x19845D60)
#define FLOWCANVAS_NODES_AND__CTOR_OFFSET UNITYSDK_OFFSET(0x19845D70)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int AND_TypeDefinitionIndex = 27081;
