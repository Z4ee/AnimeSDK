...
#define FLOWCANVAS_NODES_TWEENVECTOR3__INVOKE_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B0EE0F0)
#define FLOWCANVAS_NODES_TWEENVECTOR3__INVOKE_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B0EE290)
#define FLOWCANVAS_NODES_TWEENVECTOR3__INVOKE_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B0EE2F0)
#define FLOWCANVAS_NODES_TWEENVECTOR3__INVOKE_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B0EE2A0)
#define FLOWCANVAS_NODES_TWEENVECTOR3__INVOKE_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B0EE0E0)
#define FLOWCANVAS_NODES_TWEENVECTOR3__INVOKE_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0EE0D0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TweenVector3__Invoke_d__4_TypeDefinitionIndex = 28077;
	...
	public:
		...
		::UnityEngine::Vector3 to; // 0x24
		::ParadoxNotion::Animation::EaseType interpolation; // 0x30
		::UnityEngine::Vector3 from; // 0x34
