...
#define FLOWCANVAS_NODES_WAITWHILE__INVOKE_D__3_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1CC366A0)
#define FLOWCANVAS_NODES_WAITWHILE__INVOKE_D__3_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CC36750)
#define FLOWCANVAS_NODES_WAITWHILE__INVOKE_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CC367B0)
#define FLOWCANVAS_NODES_WAITWHILE__INVOKE_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1CC36760)
#define FLOWCANVAS_NODES_WAITWHILE__INVOKE_D__3_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CC36690)
#define FLOWCANVAS_NODES_WAITWHILE__INVOKE_D__3__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC36680)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int WaitWhile__Invoke_d__3_TypeDefinitionIndex = 30598;
