...
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_ADDPARAMETER_OFFSET UNITYSDK_OFFSET(0x1B49AC60)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_GATHERPORTSUPDATEREFS_OFFSET UNITYSDK_OFFSET(0x1B49AD70)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_GETRETURNVALUE_OFFSET UNITYSDK_OFFSET(0x1B49AC50)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B49A770)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1B49A600)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_GET_PARAMETERTYPES_OFFSET UNITYSDK_OFFSET(0x1B49A660)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_GET_RETURNS_OFFSET UNITYSDK_OFFSET(0x1B49A620)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_GET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x1B49A640)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_INVOKEASYNC_OFFSET UNITYSDK_OFFSET(0x1B49AB40)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B49A9D0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_NODECANVAS_FRAMEWORK_IINVOKABLE_GETINVOCATIONID_OFFSET UNITYSDK_OFFSET(0x1B49A910)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_NODECANVAS_FRAMEWORK_IINVOKABLE_INVOKEASYNC_OFFSET UNITYSDK_OFFSET(0x1B49AA80)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_NODECANVAS_FRAMEWORK_IINVOKABLE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B49A920)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1B49A7B0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1B49A7C0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_SET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1B49A610)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_SET_RETURNS_OFFSET UNITYSDK_OFFSET(0x1B49A630)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B49B130)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT__GATHERPORTSUPDATEREFS_B__27_0_OFFSET UNITYSDK_OFFSET(0x1B49B270)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT__INVOKE_B__23_0_OFFSET UNITYSDK_OFFSET(0x1B49B260)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CustomFunctionEvent_TypeDefinitionIndex = 26674;

	class CustomFunctionEvent : public ::FlowCanvas::Nodes::EventNode
	{
	public:
		::FlowCanvas::FlowOutput* onInvoke; // 0xA8
		::System::Collections::Generic::List_1<::ParadoxNotion::DynamicParameterDefinition*>* _parameters; // 0xB0
		::System::Object* returnValue; // 0xB8
		::Il2CppArray<::System::Object*>* args; // 0xC0
		::System::String* identifier; // 0xC8
		::ParadoxNotion::DynamicParameterDefinition* _returns; // 0xD0
