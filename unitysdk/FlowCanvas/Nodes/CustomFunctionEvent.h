...
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_ADDPARAMETER_OFFSET UNITYSDK_OFFSET(0x1D83AEC0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_GATHERPORTSUPDATEREFS_OFFSET UNITYSDK_OFFSET(0x1D83AFD0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_GETRETURNVALUE_OFFSET UNITYSDK_OFFSET(0x1D83AEB0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1D83A9C0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1D83A840)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_GET_PARAMETERTYPES_OFFSET UNITYSDK_OFFSET(0x1D83A8A0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_GET_RETURNS_OFFSET UNITYSDK_OFFSET(0x1D83A860)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_GET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x1D83A880)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_INVOKEASYNC_OFFSET UNITYSDK_OFFSET(0x1D83ADA0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D83AC30)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_NODECANVAS_FRAMEWORK_IINVOKABLE_GETINVOCATIONID_OFFSET UNITYSDK_OFFSET(0x1D83AB70)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_NODECANVAS_FRAMEWORK_IINVOKABLE_INVOKEASYNC_OFFSET UNITYSDK_OFFSET(0x1D83ACE0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_NODECANVAS_FRAMEWORK_IINVOKABLE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D83AB80)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1D83AA00)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D83AA20)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_SET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1D83A850)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_SET_RETURNS_OFFSET UNITYSDK_OFFSET(0x1D83A870)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D83B390)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT__GATHERPORTSUPDATEREFS_B__27_0_OFFSET UNITYSDK_OFFSET(0x1D83B4D0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT__INVOKE_B__23_0_OFFSET UNITYSDK_OFFSET(0x1D83B4C0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CustomFunctionEvent_TypeDefinitionIndex = 30207;
	...
	public:
		...
		::System::Collections::Generic::List_1<::ParadoxNotion::DynamicParameterDefinition*>* _parameters; // 0xB8
		::System::Object* returnValue; // 0xC0
		::ParadoxNotion::DynamicParameterDefinition* _returns; // 0xC8
