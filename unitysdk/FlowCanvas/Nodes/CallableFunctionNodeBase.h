...
#define FLOWCANVAS_NODES_CALLABLEFUNCTIONNODEBASE_CALLOUTPUTCALL_OFFSET UNITYSDK_OFFSET(0x1B3241B0)
#define FLOWCANVAS_NODES_CALLABLEFUNCTIONNODEBASE_ISCOULDOUTCALL_OFFSET UNITYSDK_OFFSET(0x1B3241A0)
#define FLOWCANVAS_NODES_CALLABLEFUNCTIONNODEBASE_ONCALLOUTPUTCALL_OFFSET UNITYSDK_OFFSET(0x1B324250)
#define FLOWCANVAS_NODES_CALLABLEFUNCTIONNODEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B324260)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CallableFunctionNodeBase_TypeDefinitionIndex = 27809;
