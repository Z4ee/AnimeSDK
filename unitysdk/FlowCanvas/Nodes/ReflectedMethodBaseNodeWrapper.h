...
#define FLOWCANVAS_NODES_REFLECTEDMETHODBASENODEWRAPPER_GETRUNTIMEICONTYPE_OFFSET UNITYSDK_OFFSET(0x1E6CCD80)
#define FLOWCANVAS_NODES_REFLECTEDMETHODBASENODEWRAPPER_GET_CALLABLE_OFFSET UNITYSDK_OFFSET(0x1E6CCEC0)
#define FLOWCANVAS_NODES_REFLECTEDMETHODBASENODEWRAPPER_GET_EXPOSEDPARAMSCOUNT_OFFSET UNITYSDK_OFFSET(0x1E6CCF30)
#define FLOWCANVAS_NODES_REFLECTEDMETHODBASENODEWRAPPER_GET_EXPOSEPARAMS_OFFSET UNITYSDK_OFFSET(0x1E6CCEF0)
#define FLOWCANVAS_NODES_REFLECTEDMETHODBASENODEWRAPPER_GET_METHOD_OFFSET UNITYSDK_OFFSET(0x1E6CCDD0)
#define FLOWCANVAS_NODES_REFLECTEDMETHODBASENODEWRAPPER_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1E6CCD70)
#define FLOWCANVAS_NODES_REFLECTEDMETHODBASENODEWRAPPER_SETDEFAULTPARAMETERVALUES_OFFSET UNITYSDK_OFFSET(0x1E6CCF70)
#define FLOWCANVAS_NODES_REFLECTEDMETHODBASENODEWRAPPER_SETDROPINSTANCEREFERENCE_OFFSET UNITYSDK_OFFSET(0x1E6CD110)
#define FLOWCANVAS_NODES_REFLECTEDMETHODBASENODEWRAPPER_SET_CALLABLE_OFFSET UNITYSDK_OFFSET(0x1E6CCED0)
#define FLOWCANVAS_NODES_REFLECTEDMETHODBASENODEWRAPPER_SET_EXPOSEDPARAMSCOUNT_OFFSET UNITYSDK_OFFSET(0x1E6CCF40)
#define FLOWCANVAS_NODES_REFLECTEDMETHODBASENODEWRAPPER_SET_EXPOSEPARAMS_OFFSET UNITYSDK_OFFSET(0x1E6CCF00)
#define FLOWCANVAS_NODES_REFLECTEDMETHODBASENODEWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6CD1F0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ReflectedMethodBaseNodeWrapper_TypeDefinitionIndex = 30246;

	class ReflectedMethodBaseNodeWrapper : public ::FlowCanvas::FlowNode
	{
	public:
		::System::Boolean _callable; // 0xA8
		::System::Boolean _exposeParams; // 0xA9
