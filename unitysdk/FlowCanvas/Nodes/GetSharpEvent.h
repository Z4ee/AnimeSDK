...
#define FLOWCANVAS_NODES_GETSHARPEVENT_GET_EVENTINFO_OFFSET UNITYSDK_OFFSET(0x1D388810)
#define FLOWCANVAS_NODES_GETSHARPEVENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1D388840)
#define FLOWCANVAS_NODES_GETSHARPEVENT_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1D388B00)
#define FLOWCANVAS_NODES_GETSHARPEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D388B70)
#define FLOWCANVAS_NODES_GETSHARPEVENT_SETEVENT_OFFSET UNITYSDK_OFFSET(0x1D388B10)
#define FLOWCANVAS_NODES_GETSHARPEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D388DC0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int GetSharpEvent_TypeDefinitionIndex = 30906;
