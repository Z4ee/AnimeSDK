...
#define FLOWCANVAS_NODES_GETSHARPEVENT_GET_EVENTINFO_OFFSET UNITYSDK_OFFSET(0x1A8F58C0)
#define FLOWCANVAS_NODES_GETSHARPEVENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A8F58F0)
#define FLOWCANVAS_NODES_GETSHARPEVENT_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1A8F5C70)
#define FLOWCANVAS_NODES_GETSHARPEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A8F5CE0)
#define FLOWCANVAS_NODES_GETSHARPEVENT_SETEVENT_OFFSET UNITYSDK_OFFSET(0x1A8F5C80)
#define FLOWCANVAS_NODES_GETSHARPEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8F5FD0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int GetSharpEvent_TypeDefinitionIndex = 27913;

	class GetSharpEvent : public ::FlowCanvas::FlowNode
	{
	public:
		::FlowCanvas::ValueInput* instancePort; // 0xA8
		::ParadoxNotion::Serialization::SerializedEventInfo* _event; // 0xB0
