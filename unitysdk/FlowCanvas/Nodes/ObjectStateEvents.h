...
#define FLOWCANVAS_NODES_OBJECTSTATEEVENTS_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1EA93A00)
#define FLOWCANVAS_NODES_OBJECTSTATEEVENTS_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1EA93970)
#define FLOWCANVAS_NODES_OBJECTSTATEEVENTS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1EA938E0)
#define FLOWCANVAS_NODES_OBJECTSTATEEVENTS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1EA933E0)
#define FLOWCANVAS_NODES_OBJECTSTATEEVENTS_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1EA934C0)
#define FLOWCANVAS_NODES_OBJECTSTATEEVENTS_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1EA936D0)
#define FLOWCANVAS_NODES_OBJECTSTATEEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA93A90)
#define FLOWCANVAS_NODES_OBJECTSTATEEVENTS__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x1EA93AE0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ObjectStateEvents_TypeDefinitionIndex = 31464;
