...
#define FLOWCANVAS_NODES_LDWHILENEXT___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1877E820)
#define FLOWCANVAS_NODES_LDWHILENEXT___C__DISPLAYCLASS7_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x1877E830)
#define FLOWCANVAS_NODES_LDWHILENEXT___C__DISPLAYCLASS7_0__REGISTERPORTS_B__1_OFFSET UNITYSDK_OFFSET(0x1877E9C0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWhileNext___c__DisplayClass7_0_TypeDefinitionIndex = 77402;
