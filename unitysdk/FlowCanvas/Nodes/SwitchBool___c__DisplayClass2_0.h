...
#define FLOWCANVAS_NODES_SWITCHBOOL___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1D389CF0)
#define FLOWCANVAS_NODES_SWITCHBOOL___C__DISPLAYCLASS2_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x1D389D00)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SwitchBool___c__DisplayClass2_0_TypeDefinitionIndex = 29811;
	...
	public:
		...
		::FlowCanvas::FlowOutput* caseTrue; // 0x28
