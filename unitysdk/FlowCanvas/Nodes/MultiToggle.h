...
#define FLOWCANVAS_NODES_MULTITOGGLE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1E22A8F0)
#define FLOWCANVAS_NODES_MULTITOGGLE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1E22A990)
#define FLOWCANVAS_NODES_MULTITOGGLE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1E22A9C0)
#define FLOWCANVAS_NODES_MULTITOGGLE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1E22A9D0)
#define FLOWCANVAS_NODES_MULTITOGGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E22AC30)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int MultiToggle_TypeDefinitionIndex = 30018;
