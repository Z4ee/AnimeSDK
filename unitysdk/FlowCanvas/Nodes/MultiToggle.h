...
#define FLOWCANVAS_NODES_MULTITOGGLE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B0EC520)
#define FLOWCANVAS_NODES_MULTITOGGLE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1B0EC5C0)
#define FLOWCANVAS_NODES_MULTITOGGLE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1B0EC5F0)
#define FLOWCANVAS_NODES_MULTITOGGLE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1B0EC600)
#define FLOWCANVAS_NODES_MULTITOGGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0EC850)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int MultiToggle_TypeDefinitionIndex = 27419;

	class MultiToggle : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::System::Int32 current; // 0xA8
