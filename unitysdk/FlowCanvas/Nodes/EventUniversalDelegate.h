...
#define FLOWCANVAS_NODES_EVENTUNIVERSALDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B4AC810)
#define FLOWCANVAS_NODES_EVENTUNIVERSALDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B4AC840)
#define FLOWCANVAS_NODES_EVENTUNIVERSALDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B4AC570)
#define FLOWCANVAS_NODES_EVENTUNIVERSALDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4AC560)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int EventUniversalDelegate_TypeDefinitionIndex = 27977;
