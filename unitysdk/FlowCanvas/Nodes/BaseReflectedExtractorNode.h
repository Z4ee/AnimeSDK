...
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_ADD_ONGETAOTEXTRACTORNODE_OFFSET UNITYSDK_OFFSET(0x1D7FD7B0)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_GETEXTRACTORNODE_OFFSET UNITYSDK_OFFSET(0x1D7FD910)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_GET_PARAMS_OFFSET UNITYSDK_OFFSET(0x1D7FDAD0)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_GET_TARGETTYPE_OFFSET UNITYSDK_OFFSET(0x1D7FDB80)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_INIT_OFFSET UNITYSDK_OFFSET(0x1D7FDA60)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_REMOVE_ONGETAOTEXTRACTORNODE_OFFSET UNITYSDK_OFFSET(0x1D7FD860)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_SET_PARAMS_OFFSET UNITYSDK_OFFSET(0x1D7FDB20)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_SET_TARGETTYPE_OFFSET UNITYSDK_OFFSET(0x1D7FDB90)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7FDBA0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int BaseReflectedExtractorNode_TypeDefinitionIndex = 29451;
	...
	public:
		...
		{
			return (::System::Func_4<::System::Type*, ::System::Boolean, ::Il2CppArray<::System::Reflection::MemberInfo*>*, ::FlowCanvas::Nodes::BaseReflectedExtractorNode*>**)Il2CppClass::FromTypeDefinitionIndex(BaseReflectedExtractorNode_TypeDefinitionIndex)->GetStaticField(0x23CC0);
		}
