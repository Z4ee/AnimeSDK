...
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_ADD_ONGETAOTEXTRACTORNODE_OFFSET UNITYSDK_OFFSET(0x1EBB3F30)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_GETEXTRACTORNODE_OFFSET UNITYSDK_OFFSET(0x1EBB4050)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_GET_PARAMS_OFFSET UNITYSDK_OFFSET(0x1EBB4210)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_GET_TARGETTYPE_OFFSET UNITYSDK_OFFSET(0x1EBB42C0)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_INIT_OFFSET UNITYSDK_OFFSET(0x1EBB41A0)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_REMOVE_ONGETAOTEXTRACTORNODE_OFFSET UNITYSDK_OFFSET(0x1EBB3FC0)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_SET_PARAMS_OFFSET UNITYSDK_OFFSET(0x1EBB4260)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_SET_TARGETTYPE_OFFSET UNITYSDK_OFFSET(0x1EBB42D0)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBB42E0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int BaseReflectedExtractorNode_TypeDefinitionIndex = 30900;
	...
	public:
		...
		{
			return (::System::Func_4<::System::Type*, ::System::Boolean, ::Il2CppArray<::System::Reflection::MemberInfo*>*, ::FlowCanvas::Nodes::BaseReflectedExtractorNode*>**)Il2CppClass::FromTypeDefinitionIndex(BaseReflectedExtractorNode_TypeDefinitionIndex)->GetStaticField(0x25500);
		}
		::FlowCanvas::Nodes::ParametresDef _Params_k__BackingField; // 0x10
		::System::Type* _TargetType_k__BackingField; // 0x88
