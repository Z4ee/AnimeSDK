...
#define FLOWCANVAS_NODES_COOLDOWN__COUNTDOWN_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1CC325F0)
#define FLOWCANVAS_NODES_COOLDOWN__COUNTDOWN_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CC328C0)
#define FLOWCANVAS_NODES_COOLDOWN__COUNTDOWN_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CC32920)
#define FLOWCANVAS_NODES_COOLDOWN__COUNTDOWN_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1CC328D0)
#define FLOWCANVAS_NODES_COOLDOWN__COUNTDOWN_D__14_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CC325E0)
#define FLOWCANVAS_NODES_COOLDOWN__COUNTDOWN_D__14__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC325D0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Cooldown__CountDown_d__14_TypeDefinitionIndex = 30035;
	...
	public:
		...
		::FlowCanvas::Nodes::Cooldown* __4__this; // 0x40
