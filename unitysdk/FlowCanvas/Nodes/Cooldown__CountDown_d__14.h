...
#define FLOWCANVAS_NODES_COOLDOWN__COUNTDOWN_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A843B20)
#define FLOWCANVAS_NODES_COOLDOWN__COUNTDOWN_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A843DF0)
#define FLOWCANVAS_NODES_COOLDOWN__COUNTDOWN_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A843E50)
#define FLOWCANVAS_NODES_COOLDOWN__COUNTDOWN_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A843E00)
#define FLOWCANVAS_NODES_COOLDOWN__COUNTDOWN_D__14_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A843B10)
#define FLOWCANVAS_NODES_COOLDOWN__COUNTDOWN_D__14__CTOR_OFFSET UNITYSDK_OFFSET(0x1A843B00)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Cooldown__CountDown_d__14_TypeDefinitionIndex = 26555;

	class Cooldown__CountDown_d__14 : public ::System::Object
	{
	public:
		::FlowCanvas::Flow f; // 0x10
		::FlowCanvas::Nodes::Cooldown* __4__this; // 0x38
