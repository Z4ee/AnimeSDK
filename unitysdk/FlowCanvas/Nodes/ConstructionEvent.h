...
#define FLOWCANVAS_NODES_CONSTRUCTIONEVENT_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1B49A510)
#define FLOWCANVAS_NODES_CONSTRUCTIONEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1B49A570)
#define FLOWCANVAS_NODES_CONSTRUCTIONEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B49A5C0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ConstructionEvent_TypeDefinitionIndex = 27521;
