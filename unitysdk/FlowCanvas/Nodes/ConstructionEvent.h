...
#define FLOWCANVAS_NODES_CONSTRUCTIONEVENT_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1EB7CFB0)
#define FLOWCANVAS_NODES_CONSTRUCTIONEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1EB7D010)
#define FLOWCANVAS_NODES_CONSTRUCTIONEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB7D060)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ConstructionEvent_TypeDefinitionIndex = 30774;
