...
#define FLOWCANVAS_NODES_FLOWNESTEDFSM_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D347D50)
#define FLOWCANVAS_NODES_FLOWNESTEDFSM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D347DE0)
#define FLOWCANVAS_NODES_FLOWNESTEDFSM__REGISTERPORTS_B__0_0_OFFSET UNITYSDK_OFFSET(0x1D347E70)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int FlowNestedFSM_TypeDefinitionIndex = 29927;
