...
#define FLOWCANVAS_NODES_TWEENQUATERNION_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D5344B0)
#define FLOWCANVAS_NODES_TWEENQUATERNION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D5344D0)
#define FLOWCANVAS_NODES_TWEENQUATERNION_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1D5344C0)
#define FLOWCANVAS_NODES_TWEENQUATERNION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D534550)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TweenQuaternion_TypeDefinitionIndex = 30251;
