...
#define FLOWCANVAS_NODES_TWEENQUATERNION_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1E22C010)
#define FLOWCANVAS_NODES_TWEENQUATERNION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E22C030)
#define FLOWCANVAS_NODES_TWEENQUATERNION_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1E22C020)
#define FLOWCANVAS_NODES_TWEENQUATERNION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E22C0B0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TweenQuaternion_TypeDefinitionIndex = 29893;
