...
#define FLOWCANVAS_NODES_TWEENROTATION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A2973F0)
#define FLOWCANVAS_NODES_TWEENROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A297480)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TweenRotation_TypeDefinitionIndex = 28211;
