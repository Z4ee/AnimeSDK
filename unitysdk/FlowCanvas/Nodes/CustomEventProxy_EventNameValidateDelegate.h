...
#define FLOWCANVAS_NODES_CUSTOMEVENTPROXY_EVENTNAMEVALIDATEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B417070)
#define FLOWCANVAS_NODES_CUSTOMEVENTPROXY_EVENTNAMEVALIDATEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B4170B0)
#define FLOWCANVAS_NODES_CUSTOMEVENTPROXY_EVENTNAMEVALIDATEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B416AD0)
#define FLOWCANVAS_NODES_CUSTOMEVENTPROXY_EVENTNAMEVALIDATEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B416AC0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CustomEventProxy_EventNameValidateDelegate_TypeDefinitionIndex = 28256;
