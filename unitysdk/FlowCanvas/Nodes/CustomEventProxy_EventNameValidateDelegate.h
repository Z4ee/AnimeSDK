...
#define FLOWCANVAS_NODES_CUSTOMEVENTPROXY_EVENTNAMEVALIDATEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EB6B720)
#define FLOWCANVAS_NODES_CUSTOMEVENTPROXY_EVENTNAMEVALIDATEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EB6B760)
#define FLOWCANVAS_NODES_CUSTOMEVENTPROXY_EVENTNAMEVALIDATEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EB6B190)
#define FLOWCANVAS_NODES_CUSTOMEVENTPROXY_EVENTNAMEVALIDATEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB6B170)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CustomEventProxy_EventNameValidateDelegate_TypeDefinitionIndex = 30050;
