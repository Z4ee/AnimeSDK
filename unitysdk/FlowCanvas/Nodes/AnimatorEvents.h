...
#define FLOWCANVAS_NODES_ANIMATOREVENTS_ONANIMATORIK_OFFSET UNITYSDK_OFFSET(0x1E5340D0)
#define FLOWCANVAS_NODES_ANIMATOREVENTS_ONANIMATORMOVE_OFFSET UNITYSDK_OFFSET(0x1E534050)
#define FLOWCANVAS_NODES_ANIMATOREVENTS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1E533C50)
#define FLOWCANVAS_NODES_ANIMATOREVENTS_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1E533D50)
#define FLOWCANVAS_NODES_ANIMATOREVENTS_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1E533ED0)
#define FLOWCANVAS_NODES_ANIMATOREVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E534160)
#define FLOWCANVAS_NODES_ANIMATOREVENTS__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x1E5341B0)
#define FLOWCANVAS_NODES_ANIMATOREVENTS__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0x1E5341C0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int AnimatorEvents_TypeDefinitionIndex = 31147;
	...
	public:
		...
		::UnityEngine::Animator* receiver; // 0xC8
