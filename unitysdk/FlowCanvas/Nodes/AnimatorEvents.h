...
#define FLOWCANVAS_NODES_ANIMATOREVENTS_ONANIMATORIK_OFFSET UNITYSDK_OFFSET(0x1D1D8240)
#define FLOWCANVAS_NODES_ANIMATOREVENTS_ONANIMATORMOVE_OFFSET UNITYSDK_OFFSET(0x1D1D81C0)
#define FLOWCANVAS_NODES_ANIMATOREVENTS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D1D7DC0)
#define FLOWCANVAS_NODES_ANIMATOREVENTS_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1D1D7EC0)
#define FLOWCANVAS_NODES_ANIMATOREVENTS_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1D1D8040)
#define FLOWCANVAS_NODES_ANIMATOREVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1D82D0)
#define FLOWCANVAS_NODES_ANIMATOREVENTS__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x1D1D8320)
#define FLOWCANVAS_NODES_ANIMATOREVENTS__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0x1D1D8330)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int AnimatorEvents_TypeDefinitionIndex = 30258;

	class AnimatorEvents : public ::FlowCanvas::Nodes::RouterEventNode_1<::UnityEngine::Animator*>
	{
	public:
		::FlowCanvas::FlowOutput* onAnimatorMove; // 0xC0
		::FlowCanvas::FlowOutput* onAnimatorIK; // 0xC8
		::UnityEngine::Animator* receiver; // 0xD0
