...
#define FLOWCANVAS_NODES_APPLICATIONQUITEVENT_APPLICATIONQUIT_OFFSET UNITYSDK_OFFSET(0x1B4ABFA0)
#define FLOWCANVAS_NODES_APPLICATIONQUITEVENT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1B4ABE00)
#define FLOWCANVAS_NODES_APPLICATIONQUITEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1B4ABED0)
#define FLOWCANVAS_NODES_APPLICATIONQUITEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1B4ABFE0)
#define FLOWCANVAS_NODES_APPLICATIONQUITEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4AC030)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ApplicationQuitEvent_TypeDefinitionIndex = 28068;
