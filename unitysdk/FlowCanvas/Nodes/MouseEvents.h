...
#define FLOWCANVAS_NODES_MOUSEEVENTS_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1EB7E830)
#define FLOWCANVAS_NODES_MOUSEEVENTS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1EB7E940)
#define FLOWCANVAS_NODES_MOUSEEVENTS_UPDATE_OFFSET UNITYSDK_OFFSET(0x1EB7E9D0)
#define FLOWCANVAS_NODES_MOUSEEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB7E9E0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int MouseEvents_TypeDefinitionIndex = 30086;
