...
#define FLOWCANVAS_NODES_UNITYEVENTAUTOCALLBACKEVENT___C__DISPLAYCLASS20_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB95600)
#define FLOWCANVAS_NODES_UNITYEVENTAUTOCALLBACKEVENT___C__DISPLAYCLASS20_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x1DB95AB0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int UnityEventAutoCallbackEvent___c__DisplayClass20_0_TypeDefinitionIndex = 30315;
