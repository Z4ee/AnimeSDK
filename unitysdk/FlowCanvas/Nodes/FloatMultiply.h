...
#define FLOWCANVAS_NODES_FLOATMULTIPLY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D83B580)
#define FLOWCANVAS_NODES_FLOATMULTIPLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D83B590)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int FloatMultiply_TypeDefinitionIndex = 30445;
