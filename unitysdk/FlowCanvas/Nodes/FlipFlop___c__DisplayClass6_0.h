...
#define FLOWCANVAS_NODES_FLIPFLOP___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA92F10)
#define FLOWCANVAS_NODES_FLIPFLOP___C__DISPLAYCLASS6_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x1EA92F20)
#define FLOWCANVAS_NODES_FLIPFLOP___C__DISPLAYCLASS6_0__REGISTERPORTS_B__1_OFFSET UNITYSDK_OFFSET(0x1EA92F90)
#define FLOWCANVAS_NODES_FLIPFLOP___C__DISPLAYCLASS6_0__REGISTERPORTS_B__2_OFFSET UNITYSDK_OFFSET(0x1EA92FB0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int FlipFlop___c__DisplayClass6_0_TypeDefinitionIndex = 30739;
	...
	public:
		...
		::FlowCanvas::FlowOutput* fFlip; // 0x20
