...
#define FLOWCANVAS_NODES_COROUTINESTATE___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7A5970)
#define FLOWCANVAS_NODES_COROUTINESTATE___C__DISPLAYCLASS3_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x1E7A5980)
#define FLOWCANVAS_NODES_COROUTINESTATE___C__DISPLAYCLASS3_0__REGISTERPORTS_B__1_OFFSET UNITYSDK_OFFSET(0x1E7A5A50)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CoroutineState___c__DisplayClass3_0_TypeDefinitionIndex = 31422;

	class CoroutineState___c__DisplayClass3_0 : public ::System::Object
	{
	public:
		::FlowCanvas::Nodes::CoroutineState* __4__this; // 0x10
		::FlowCanvas::FlowOutput* fStart; // 0x18
