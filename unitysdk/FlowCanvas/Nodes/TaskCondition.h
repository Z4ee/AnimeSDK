...
#define FLOWCANVAS_NODES_TASKCONDITION_GET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1CC36230)
#define FLOWCANVAS_NODES_TASKCONDITION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1CC361D0)
#define FLOWCANVAS_NODES_TASKCONDITION_NODECANVAS_FRAMEWORK_ITASKASSIGNABLE_GET_TASK_OFFSET UNITYSDK_OFFSET(0x1CC36250)
#define FLOWCANVAS_NODES_TASKCONDITION_NODECANVAS_FRAMEWORK_ITASKASSIGNABLE_SET_TASK_OFFSET UNITYSDK_OFFSET(0x1CC36260)
#define FLOWCANVAS_NODES_TASKCONDITION_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1CC362D0)
#define FLOWCANVAS_NODES_TASKCONDITION_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1CC36350)
#define FLOWCANVAS_NODES_TASKCONDITION_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1CC36390)
#define FLOWCANVAS_NODES_TASKCONDITION_SET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1CC36240)
#define FLOWCANVAS_NODES_TASKCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC36400)
#define FLOWCANVAS_NODES_TASKCONDITION__REGISTERPORTS_B__11_0_OFFSET UNITYSDK_OFFSET(0x1CC36440)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TaskCondition_TypeDefinitionIndex = 29251;
