...
#define FLOWCANVAS_NODES_TASKCONDITION_GET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1A847700)
#define FLOWCANVAS_NODES_TASKCONDITION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A8476A0)
#define FLOWCANVAS_NODES_TASKCONDITION_NODECANVAS_FRAMEWORK_ITASKASSIGNABLE_GET_TASK_OFFSET UNITYSDK_OFFSET(0x1A847720)
#define FLOWCANVAS_NODES_TASKCONDITION_NODECANVAS_FRAMEWORK_ITASKASSIGNABLE_SET_TASK_OFFSET UNITYSDK_OFFSET(0x1A847730)
#define FLOWCANVAS_NODES_TASKCONDITION_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A8477A0)
#define FLOWCANVAS_NODES_TASKCONDITION_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A847820)
#define FLOWCANVAS_NODES_TASKCONDITION_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A847860)
#define FLOWCANVAS_NODES_TASKCONDITION_SET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1A847710)
#define FLOWCANVAS_NODES_TASKCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8478D0)
#define FLOWCANVAS_NODES_TASKCONDITION__REGISTERPORTS_B__11_0_OFFSET UNITYSDK_OFFSET(0x1A847910)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TaskCondition_TypeDefinitionIndex = 27954;
