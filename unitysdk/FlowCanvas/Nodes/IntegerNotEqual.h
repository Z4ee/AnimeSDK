...
#define FLOWCANVAS_NODES_INTEGERNOTEQUAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A1F3D20)
#define FLOWCANVAS_NODES_INTEGERNOTEQUAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1F3D30)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int IntegerNotEqual_TypeDefinitionIndex = 26491;
