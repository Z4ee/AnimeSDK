...
#define FLOWCANVAS_NODES_PUREFUNCTIONNODEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C61FDB0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int PureFunctionNodeBase_TypeDefinitionIndex = 29539;
