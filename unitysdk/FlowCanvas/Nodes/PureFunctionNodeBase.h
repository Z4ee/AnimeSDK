...
#define FLOWCANVAS_NODES_PUREFUNCTIONNODEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1F3F80)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int PureFunctionNodeBase_TypeDefinitionIndex = 26629;
