...
#define FLOWCANVAS_NODES_TRIGGEREVENTS_TRANSFORM_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1D7BB6D0)
#define FLOWCANVAS_NODES_TRIGGEREVENTS_TRANSFORM_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x1D7BB810)
#define FLOWCANVAS_NODES_TRIGGEREVENTS_TRANSFORM_ONTRIGGERSTAY_OFFSET UNITYSDK_OFFSET(0x1D7BB770)
#define FLOWCANVAS_NODES_TRIGGEREVENTS_TRANSFORM_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D7BB170)
#define FLOWCANVAS_NODES_TRIGGEREVENTS_TRANSFORM_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1D7BB290)
#define FLOWCANVAS_NODES_TRIGGEREVENTS_TRANSFORM_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1D7BB4B0)
#define FLOWCANVAS_NODES_TRIGGEREVENTS_TRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7BB8B0)
#define FLOWCANVAS_NODES_TRIGGEREVENTS_TRANSFORM__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x1D7BB900)
#define FLOWCANVAS_NODES_TRIGGEREVENTS_TRANSFORM__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0x1D7BB910)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TriggerEvents_Transform_TypeDefinitionIndex = 30709;
