...
#define FLOWCANVAS_NODES_FLOATINVERT_INVOKE_OFFSET UNITYSDK_OFFSET(0x198467E0)
#define FLOWCANVAS_NODES_FLOATINVERT__CTOR_OFFSET UNITYSDK_OFFSET(0x198467F0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int FloatInvert_TypeDefinitionIndex = 27685;
