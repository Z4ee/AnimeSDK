...
#define FLOWCANVAS_NODES_LERPFLOAT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D388EC0)
#define FLOWCANVAS_NODES_LERPFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D389000)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int LerpFloat_TypeDefinitionIndex = 30861;
