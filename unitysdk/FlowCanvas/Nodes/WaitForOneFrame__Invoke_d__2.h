...
#define FLOWCANVAS_NODES_WAITFORONEFRAME__INVOKE_D__2_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1EB80000)
#define FLOWCANVAS_NODES_WAITFORONEFRAME__INVOKE_D__2_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1EB80030)
#define FLOWCANVAS_NODES_WAITFORONEFRAME__INVOKE_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1EB80090)
#define FLOWCANVAS_NODES_WAITFORONEFRAME__INVOKE_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1EB80040)
#define FLOWCANVAS_NODES_WAITFORONEFRAME__INVOKE_D__2_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EB7FFF0)
#define FLOWCANVAS_NODES_WAITFORONEFRAME__INVOKE_D__2__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB7FFE0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int WaitForOneFrame__Invoke_d__2_TypeDefinitionIndex = 29925;
