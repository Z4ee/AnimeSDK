...
#define FLOWCANVAS_NODES_WAITFORONEFRAME__INVOKE_D__2_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D83D790)
#define FLOWCANVAS_NODES_WAITFORONEFRAME__INVOKE_D__2_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D83D7C0)
#define FLOWCANVAS_NODES_WAITFORONEFRAME__INVOKE_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D83D820)
#define FLOWCANVAS_NODES_WAITFORONEFRAME__INVOKE_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1D83D7D0)
#define FLOWCANVAS_NODES_WAITFORONEFRAME__INVOKE_D__2_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D83D780)
#define FLOWCANVAS_NODES_WAITFORONEFRAME__INVOKE_D__2__CTOR_OFFSET UNITYSDK_OFFSET(0x1D83D770)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int WaitForOneFrame__Invoke_d__2_TypeDefinitionIndex = 29757;
