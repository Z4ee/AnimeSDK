...
#define FLOWCANVAS_NODES_COROUTINESTATE_DOREPEAT_OFFSET UNITYSDK_OFFSET(0x1ADAD440)
#define FLOWCANVAS_NODES_COROUTINESTATE_ISSERVERCARE_OFFSET UNITYSDK_OFFSET(0x1ADAD430)
#define FLOWCANVAS_NODES_COROUTINESTATE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1ADAD2C0)
#define FLOWCANVAS_NODES_COROUTINESTATE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1ADAD2F0)
#define FLOWCANVAS_NODES_COROUTINESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADAD4C0)
#define FLOWCANVAS_NODES_COROUTINESTATE__DOREPEAT_B__5_0_OFFSET UNITYSDK_OFFSET(0x1ADAD500)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CoroutineState_TypeDefinitionIndex = 26904;
