...
#define FLOWCANVAS_NODES_TRANSFORMEVENTS_ONTRANSFORMCHILDRENCHANGED_OFFSET UNITYSDK_OFFSET(0x1D6DED10)
#define FLOWCANVAS_NODES_TRANSFORMEVENTS_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0x1D6DEC50)
#define FLOWCANVAS_NODES_TRANSFORMEVENTS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1D6DE800)
#define FLOWCANVAS_NODES_TRANSFORMEVENTS_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1D6DE950)
#define FLOWCANVAS_NODES_TRANSFORMEVENTS_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1D6DEAD0)
#define FLOWCANVAS_NODES_TRANSFORMEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6DEDD0)
#define FLOWCANVAS_NODES_TRANSFORMEVENTS__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x1D6DEE20)
#define FLOWCANVAS_NODES_TRANSFORMEVENTS__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0x1D6DEE30)
#define FLOWCANVAS_NODES_TRANSFORMEVENTS__REGISTERPORTS_B__5_2_OFFSET UNITYSDK_OFFSET(0x1D6DEE40)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TransformEvents_TypeDefinitionIndex = 30760;
	...
	public:
		...
		::FlowCanvas::FlowOutput* onChildrenChanged; // 0xC8
		::UnityEngine::Transform* parent; // 0xD0
		::System::Collections::Generic::IEnumerable_1<::UnityEngine::Transform*>* children; // 0xD8
		::UnityEngine::Transform* receiver; // 0xE0
