...
#define FLOWCANVAS_NODES_WAITFORENDOFFRAME_GET_ALLOWROUTINEQUEUEING_OFFSET UNITYSDK_OFFSET(0x1EB7FF80)
#define FLOWCANVAS_NODES_WAITFORENDOFFRAME_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EB7FF90)
#define FLOWCANVAS_NODES_WAITFORENDOFFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB7FFD0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int WaitForEndOfFrame_TypeDefinitionIndex = 29788;
