...
#define FLOWCANVAS_NODES_WAITFORENDOFFRAME__INVOKE_D__2_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B7E3EF0)
#define FLOWCANVAS_NODES_WAITFORENDOFFRAME__INVOKE_D__2_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B7E3F60)
#define FLOWCANVAS_NODES_WAITFORENDOFFRAME__INVOKE_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B7E3FC0)
#define FLOWCANVAS_NODES_WAITFORENDOFFRAME__INVOKE_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B7E3F70)
#define FLOWCANVAS_NODES_WAITFORENDOFFRAME__INVOKE_D__2_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B7E3EE0)
#define FLOWCANVAS_NODES_WAITFORENDOFFRAME__INVOKE_D__2__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7E3ED0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int WaitForEndOfFrame__Invoke_d__2_TypeDefinitionIndex = 27455;
