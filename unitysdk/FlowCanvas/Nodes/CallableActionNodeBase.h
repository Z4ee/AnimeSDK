...
#define FLOWCANVAS_NODES_CALLABLEACTIONNODEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC40C10)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CallableActionNodeBase_TypeDefinitionIndex = 29563;
