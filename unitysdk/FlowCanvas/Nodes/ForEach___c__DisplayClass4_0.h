...
#define FLOWCANVAS_NODES_FOREACH___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A845450)
#define FLOWCANVAS_NODES_FOREACH___C__DISPLAYCLASS4_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x1A845460)
#define FLOWCANVAS_NODES_FOREACH___C__DISPLAYCLASS4_0__REGISTERPORTS_B__1_OFFSET UNITYSDK_OFFSET(0x1A845480)
#define FLOWCANVAS_NODES_FOREACH___C__DISPLAYCLASS4_0__REGISTERPORTS_B__2_OFFSET UNITYSDK_OFFSET(0x1A8454A0)
#define FLOWCANVAS_NODES_FOREACH___C__DISPLAYCLASS4_0__REGISTERPORTS_B__3_OFFSET UNITYSDK_OFFSET(0x1A8459E0)
#define FLOWCANVAS_NODES_FOREACH___C__DISPLAYCLASS4_0__REGISTERPORTS_B__4_OFFSET UNITYSDK_OFFSET(0x1A8459C0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ForEach___c__DisplayClass4_0_TypeDefinitionIndex = 27997;

	class ForEach___c__DisplayClass4_0 : public ::System::Object
	{
	public:
		::FlowCanvas::Nodes::ForEach* __4__this; // 0x10
