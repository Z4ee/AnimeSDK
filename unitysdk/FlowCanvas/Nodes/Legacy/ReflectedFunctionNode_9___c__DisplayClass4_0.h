...
namespace FlowCanvas::Nodes::Legacy { template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8, typename T9> class ReflectedFunctionNode_9; }

namespace FlowCanvas::Nodes::Legacy
{
	inline static constexpr unsigned int ReflectedFunctionNode_9___c__DisplayClass4_0_TypeDefinitionIndex = 29740;
	...
	class ReflectedFunctionNode_9___c__DisplayClass4_0 : public ::System::Object
	{
	public:
		::FlowCanvas::Nodes::Legacy::ReflectedFunctionNode_9<T1, T2, T3, T4, T5, T6, T7, T8, TResult>* __4__this; // 0x0
