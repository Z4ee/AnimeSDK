...
#define FLOWCANVAS_NODES_LEGACY_REFLECTEDMETHODNODE_CREATE_OFFSET UNITYSDK_OFFSET(0x1B4ACB00)
#define FLOWCANVAS_NODES_LEGACY_REFLECTEDMETHODNODE_GETNAME_OFFSET UNITYSDK_OFFSET(0x1B4AD320)
#define FLOWCANVAS_NODES_LEGACY_REFLECTEDMETHODNODE_TRYCREATEJIT_OFFSET UNITYSDK_OFFSET(0x1B4ACC80)
#define FLOWCANVAS_NODES_LEGACY_REFLECTEDMETHODNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4ACAF0)

namespace FlowCanvas::Nodes::Legacy
{
	inline static constexpr unsigned int ReflectedMethodNode_TypeDefinitionIndex = 27023;
