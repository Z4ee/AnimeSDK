...
{
	inline static constexpr unsigned int ReflectedActionNode_6_TypeDefinitionIndex = 26528;

	template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6>
	class ReflectedActionNode_6 : public ::FlowCanvas::Nodes::Legacy::ReflectedMethodNode
	{
	public:
