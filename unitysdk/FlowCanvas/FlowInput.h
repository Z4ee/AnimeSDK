...
#define FLOWCANVAS_FLOWINPUT_GET_POINTER_OFFSET UNITYSDK_OFFSET(0x1D52F050)
#define FLOWCANVAS_FLOWINPUT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1D52F070)
#define FLOWCANVAS_FLOWINPUT_RECORDCALLINFO_OFFSET UNITYSDK_OFFSET(0x1D52F0A0)
#define FLOWCANVAS_FLOWINPUT_SET_POINTER_OFFSET UNITYSDK_OFFSET(0x1D52F060)
#define FLOWCANVAS_FLOWINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D52EF10)

namespace FlowCanvas
{
	inline static constexpr unsigned int FlowInput_TypeDefinitionIndex = 29571;
	...
	public:
		...
		{
			return (::System::Action_2<::FlowCanvas::FlowInput*, ::FlowCanvas::FlowNode*>**)Il2CppClass::FromTypeDefinitionIndex(FlowInput_TypeDefinitionIndex)->GetStaticField(0x23850);
		}
