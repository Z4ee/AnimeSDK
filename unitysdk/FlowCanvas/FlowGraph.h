...
#define FLOWCANVAS_FLOWGRAPH_CALLFUNCTIONASYNC_OFFSET UNITYSDK_OFFSET(0x1E8B4EC0)
#define FLOWCANVAS_FLOWGRAPH_CALLFUNCTION_OFFSET UNITYSDK_OFFSET(0x1E8B4DF0)
#define FLOWCANVAS_FLOWGRAPH_GETAGENTCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1E8B5050)
#define FLOWCANVAS_FLOWGRAPH_GET_ALLOWBLACKBOARDOVERRIDES_OFFSET UNITYSDK_OFFSET(0x1E8B4DA0)
#define FLOWCANVAS_FLOWGRAPH_GET_BASENODETYPE_OFFSET UNITYSDK_OFFSET(0x1E8B4D70)
#define FLOWCANVAS_FLOWGRAPH_GET_CANACCEPTVARIABLEDROPS_OFFSET UNITYSDK_OFFSET(0x1E8B4DE0)
#define FLOWCANVAS_FLOWGRAPH_GET_ISTREE_OFFSET UNITYSDK_OFFSET(0x1E8B4DD0)
#define FLOWCANVAS_FLOWGRAPH_GET_REQUIRESAGENT_OFFSET UNITYSDK_OFFSET(0x1E8B4DB0)
#define FLOWCANVAS_FLOWGRAPH_GET_REQUIRESPRIMENODE_OFFSET UNITYSDK_OFFSET(0x1E8B4DC0)
#define FLOWCANVAS_FLOWGRAPH_INITIALIZEMACRO_OFFSET UNITYSDK_OFFSET(0x1E8B54B0)
#define FLOWCANVAS_FLOWGRAPH_INITSECONDPASS_OFFSET UNITYSDK_OFFSET(0x1E8B5AC0)
#define FLOWCANVAS_FLOWGRAPH_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1E8B6160)
#define FLOWCANVAS_FLOWGRAPH_ONGRAPHINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1E8B5760)
#define FLOWCANVAS_FLOWGRAPH_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1E8B5BA0)
#define FLOWCANVAS_FLOWGRAPH_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1E8B5F90)
#define FLOWCANVAS_FLOWGRAPH_ONGRAPHUPDATE_OFFSET UNITYSDK_OFFSET(0x1E8B5E40)
#define FLOWCANVAS_FLOWGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8B62C0)

namespace FlowCanvas
{
	inline static constexpr unsigned int FlowGraph_TypeDefinitionIndex = 31229;
