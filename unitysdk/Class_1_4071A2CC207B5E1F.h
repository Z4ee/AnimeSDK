...
#define CLASS_1_4071A2CC207B5E1F_METHOD_1_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x179FFC40)
#define CLASS_1_4071A2CC207B5E1F_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x179FFBA0)
#define CLASS_1_4071A2CC207B5E1F_METHOD_1_E2E1E267B00F9A3A_OFFSET UNITYSDK_OFFSET(0x179FFBF0)
#define CLASS_1_4071A2CC207B5E1F_METHOD_1_F982AFC8B115D594_OFFSET UNITYSDK_OFFSET(0x179FFA40)
#define CLASS_1_4071A2CC207B5E1F__CTOR_1_OFFSET UNITYSDK_OFFSET(0x179FFA30)
#define CLASS_1_4071A2CC207B5E1F__CTOR_OFFSET UNITYSDK_OFFSET(0x179FF9D0)

inline static constexpr unsigned int Class_1_4071A2CC207B5E1F_TypeDefinitionIndex = 56702;

class Class_1_4071A2CC207B5E1F : public ::System::Object
{
public:
	::System::String* GGINDEBOODJ; // 0x10
	::RPG::GameCore::TurnBasedAbilityConfig* MOINFBGHNFO; // 0x18
