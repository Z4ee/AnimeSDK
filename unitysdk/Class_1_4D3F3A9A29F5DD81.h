...
#define CLASS_1_4D3F3A9A29F5DD81_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x16451B10)
#define CLASS_1_4D3F3A9A29F5DD81_GET_ICON_OFFSET UNITYSDK_OFFSET(0x16451AF0)
#define CLASS_1_4D3F3A9A29F5DD81_GET_NAME_OFFSET UNITYSDK_OFFSET(0x16451AD0)
#define CLASS_1_4D3F3A9A29F5DD81_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x16451B20)
#define CLASS_1_4D3F3A9A29F5DD81_SET_ICON_OFFSET UNITYSDK_OFFSET(0x16451B00)
#define CLASS_1_4D3F3A9A29F5DD81_SET_NAME_OFFSET UNITYSDK_OFFSET(0x16451AE0)
#define CLASS_1_4D3F3A9A29F5DD81__CTOR_OFFSET UNITYSDK_OFFSET(0x16451B30)

inline static constexpr unsigned int Class_1_4D3F3A9A29F5DD81_TypeDefinitionIndex = 73331;

class Class_1_4D3F3A9A29F5DD81 : public ::System::Object
{
public:
	::R3::ReactiveProperty_1<::System::String*>* _Icon_k__BackingField; // 0x10
	::R3::ReactiveProperty_1<::System::String*>* _Name_k__BackingField; // 0x18
