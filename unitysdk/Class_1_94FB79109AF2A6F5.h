...
#define CLASS_1_94FB79109AF2A6F5__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0CD220)
...
{
public:
	::RPG::GameCore::PhotoGraphAimIdentifyType BDHPOJCKPIM; // 0x10
	::UnityEngine::Vector3 KKLDLLOJEFN; // 0x14
