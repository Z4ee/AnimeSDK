...
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ENTERGAME_OFFSET UNITYSDK_OFFSET(0x19F87720)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_FORGETPASSWORD_OFFSET UNITYSDK_OFFSET(0x19F87000)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_GENENTRYCALLBACK_OFFSET UNITYSDK_OFFSET(0x19F87450)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_INIT_OFFSET UNITYSDK_OFFSET(0x19F85960)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_INSTANCE_OFFSET UNITYSDK_OFFSET(0x19F84C80)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ISREGISTERVISIBLE_OFFSET UNITYSDK_OFFSET(0x19F86460)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0x19F87500)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ONCLICKBACK_OFFSET UNITYSDK_OFFSET(0x19F876A0)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x19F84EB0)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ONCONSOLECANCEL_OFFSET UNITYSDK_OFFSET(0x19F87A30)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ONOPENLOGIN_OFFSET UNITYSDK_OFFSET(0x19F85520)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ONREGISTERACCOUNT_OFFSET UNITYSDK_OFFSET(0x19F87120)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ONSHOW_OFFSET UNITYSDK_OFFSET(0x19F85310)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ONUILAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x19F87B80)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_REFRESHCONSOLERELATEUI_OFFSET UNITYSDK_OFFSET(0x19F86260)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_REGISTER_OFFSET UNITYSDK_OFFSET(0x19F87080)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_RESET_OFFSET UNITYSDK_OFFSET(0x19F84FD0)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_SETPLATFORM_OFFSET UNITYSDK_OFFSET(0x19F85FF0)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_SETTHIRDLOGIN_OFFSET UNITYSDK_OFFSET(0x19F86530)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_UPDATE_OFFSET UNITYSDK_OFFSET(0x19F86C70)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA__CCTOR_OFFSET UNITYSDK_OFFSET(0x19F87BD0)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA__CTOR_OFFSET UNITYSDK_OFFSET(0x19F84E20)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA__INIT_B__9_0_OFFSET UNITYSDK_OFFSET(0x19F87E30)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA__INIT_B__9_1_OFFSET UNITYSDK_OFFSET(0x19F87EA0)

inline static constexpr unsigned int CustomSkin_AccountLoginOversea_TypeDefinitionIndex = 62965;
...
public:
	...
	{
		return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(CustomSkin_AccountLoginOversea_TypeDefinitionIndex)->GetStaticField(0x45D40);
	}
	static ::CustomSkin_AccountLoginOversea** StaticGet__instance()
	{
		return (::CustomSkin_AccountLoginOversea**)Il2CppClass::FromTypeDefinitionIndex(CustomSkin_AccountLoginOversea_TypeDefinitionIndex)->GetStaticField(0x45D48);
	}
	static ::Il2CppArray<::Foundation::AssetPath>** StaticGet_thirdEntryIconList()
	{
		return (::Il2CppArray<::Foundation::AssetPath>**)Il2CppClass::FromTypeDefinitionIndex(CustomSkin_AccountLoginOversea_TypeDefinitionIndex)->GetStaticField(0x45D50);
	}
	::Class_2_79F6D62CE30E3F8E_29* _loginView; // 0x18
