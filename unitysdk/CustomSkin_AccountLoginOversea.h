...
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ENTERGAME_OFFSET UNITYSDK_OFFSET(0x1900A220)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_FORGETPASSWORD_OFFSET UNITYSDK_OFFSET(0x19009AF0)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_GENENTRYCALLBACK_OFFSET UNITYSDK_OFFSET(0x19009F50)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_INIT_OFFSET UNITYSDK_OFFSET(0x19008440)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_INSTANCE_OFFSET UNITYSDK_OFFSET(0x19007750)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ISREGISTERVISIBLE_OFFSET UNITYSDK_OFFSET(0x19008F40)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0x1900A000)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ONCLICKBACK_OFFSET UNITYSDK_OFFSET(0x1900A1A0)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x19007980)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ONCONSOLECANCEL_OFFSET UNITYSDK_OFFSET(0x1900A530)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ONOPENLOGIN_OFFSET UNITYSDK_OFFSET(0x19007FF0)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ONREGISTERACCOUNT_OFFSET UNITYSDK_OFFSET(0x19009C10)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ONSHOW_OFFSET UNITYSDK_OFFSET(0x19007DE0)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ONUILAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x1900A680)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_REFRESHCONSOLERELATEUI_OFFSET UNITYSDK_OFFSET(0x19008D40)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_REGISTER_OFFSET UNITYSDK_OFFSET(0x19009B70)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_RESET_OFFSET UNITYSDK_OFFSET(0x19007AA0)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_SETPLATFORM_OFFSET UNITYSDK_OFFSET(0x19008AD0)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_SETTHIRDLOGIN_OFFSET UNITYSDK_OFFSET(0x19009010)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_UPDATE_OFFSET UNITYSDK_OFFSET(0x19009750)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1900A6D0)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA__CTOR_OFFSET UNITYSDK_OFFSET(0x190078F0)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA__INIT_B__9_0_OFFSET UNITYSDK_OFFSET(0x1900A930)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA__INIT_B__9_1_OFFSET UNITYSDK_OFFSET(0x1900A9A0)

inline static constexpr unsigned int CustomSkin_AccountLoginOversea_TypeDefinitionIndex = 66160;
...
public:
	...
	{
		return (::CustomSkin_AccountLoginOversea**)Il2CppClass::FromTypeDefinitionIndex(CustomSkin_AccountLoginOversea_TypeDefinitionIndex)->GetStaticField(0x42260);
	}
	static ::Il2CppArray<::System::String*>** StaticGet_thirdEntryNameList()
	{
		return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(CustomSkin_AccountLoginOversea_TypeDefinitionIndex)->GetStaticField(0x42268);
	}
	static ::Il2CppArray<::Foundation::AssetPath>** StaticGet_thirdEntryIconList()
	{
		return (::Il2CppArray<::Foundation::AssetPath>**)Il2CppClass::FromTypeDefinitionIndex(CustomSkin_AccountLoginOversea_TypeDefinitionIndex)->GetStaticField(0x42270);
	}
