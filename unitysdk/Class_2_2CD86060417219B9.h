...
#define CLASS_2_2CD86060417219B9_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15B2FDD0)
#define CLASS_2_2CD86060417219B9_METHOD_2_A1781348F0A89177_OFFSET UNITYSDK_OFFSET(0x15B2FF60)
#define CLASS_2_2CD86060417219B9_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15B2FEB0)
#define CLASS_2_2CD86060417219B9_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15B301A0)
#define CLASS_2_2CD86060417219B9_TICK_OFFSET UNITYSDK_OFFSET(0x15B301F0)
#define CLASS_2_2CD86060417219B9__CTOR_OFFSET UNITYSDK_OFFSET(0x15B2FD50)

inline static constexpr unsigned int Class_2_2CD86060417219B9_TypeDefinitionIndex = 55362;

class Class_2_2CD86060417219B9 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::GameCore::LoopExecuteTaskList* OFKGLJOAMLD; // 0x20
	::Class_3_07C3C4D2990C49EE* NDOFCGDDHHD; // 0x28
	::System::Int32 DLANCNECDDA; // 0x30
	::System::Int32 CALNAPHILLA; // 0x34
