...
#define CLASS_2_B41331FB705B6530_ADD_ONCLAIMREWARDFINISHED_OFFSET UNITYSDK_OFFSET(0x10A38350)
#define CLASS_2_B41331FB705B6530_ADD_ONDRAWFINISHED_OFFSET UNITYSDK_OFFSET(0x10A38100)
#define CLASS_2_B41331FB705B6530_ADD_ONGETDATAFINISHED_OFFSET UNITYSDK_OFFSET(0x10A37EB0)
#define CLASS_2_B41331FB705B6530_METHOD_2_0865E94460F11643_OFFSET UNITYSDK_OFFSET(0x10A37DA0)
#define CLASS_2_B41331FB705B6530_METHOD_2_3EF33FD8BF224359_1_OFFSET UNITYSDK_OFFSET(0x10A381C0)
#define CLASS_2_B41331FB705B6530_METHOD_2_3EF33FD8BF224359_OFFSET UNITYSDK_OFFSET(0x10A37F70)
#define CLASS_2_B41331FB705B6530_REMOVE_ONCLAIMREWARDFINISHED_OFFSET UNITYSDK_OFFSET(0x10A383B0)
#define CLASS_2_B41331FB705B6530_REMOVE_ONDRAWFINISHED_OFFSET UNITYSDK_OFFSET(0x10A38160)
#define CLASS_2_B41331FB705B6530_REMOVE_ONGETDATAFINISHED_OFFSET UNITYSDK_OFFSET(0x10A37F10)
#define CLASS_2_B41331FB705B6530__CTOR_OFFSET UNITYSDK_OFFSET(0x10A37D90)
#define CLASS_2_B41331FB705B6530__REQUESTGETDATA_B__3_0_OFFSET UNITYSDK_OFFSET(0x10A38410)

inline static constexpr unsigned int Class_2_B41331FB705B6530_TypeDefinitionIndex = 49799;

class Class_2_B41331FB705B6530 : public ::Class_1_5E4ED920015DC82D
{
public:
	// static const ::System::UInt16 Field_2_1 = 0x265D; // 0x0
	// static const ::System::UInt16 Field_2_3 = 0x2662; // 0x0
	// static const ::System::UInt16 Field_2_5 = 0x2666; // 0x0
	::System::Action* OnGetDataFinished; // 0x20
	::System::Action_1<::System::Int32>* OnDrawFinished; // 0x28
	::Class_1_91EDF801EFB7E1C2* Field_2_0; // 0x30
	...
	::System::Void _RequestGetData_b__3_0(::Class_1_5FEFAED860528596_14* rsp)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_5FEFAED860528596_14*))((::PBYTE)hIl2Cpp + CLASS_2_B41331FB705B6530__REQUESTGETDATA_B__3_0_OFFSET))(this, rsp);
	}
};
