...
#define CLASS_1_A2B569C8E16CE41A___C__DISPLAYCLASS2_0__CREATEITEM_B__0_OFFSET UNITYSDK_OFFSET(0x15DDEAD0)
#define CLASS_1_A2B569C8E16CE41A___C__DISPLAYCLASS2_0__CREATEITEM_B__1_OFFSET UNITYSDK_OFFSET(0x15DDEC10)
#define CLASS_1_A2B569C8E16CE41A___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15DDE6D0)

inline static constexpr unsigned int Class_1_A2B569C8E16CE41A___c__DisplayClass2_0_TypeDefinitionIndex = 62670;
...
public:
	...
	::RPG::Client::SkillTreeGrowthGuideItem* item; // 0x18
	::RPG::GameCore::ICharacterSkillRowData* skillData; // 0x20
	::Class_1_A2B569C8E16CE41A* __4__this; // 0x28
