...
#define CLASS_1_A2B569C8E16CE41A___C__DISPLAYCLASS2_0__CREATEITEM_B__0_OFFSET UNITYSDK_OFFSET(0x112C0140)
#define CLASS_1_A2B569C8E16CE41A___C__DISPLAYCLASS2_0__CREATEITEM_B__1_OFFSET UNITYSDK_OFFSET(0x112C0230)
#define CLASS_1_A2B569C8E16CE41A___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0x112BFD40)

inline static constexpr unsigned int Class_1_A2B569C8E16CE41A___c__DisplayClass2_0_TypeDefinitionIndex = 61328;

class Class_1_A2B569C8E16CE41A___c__DisplayClass2_0 : public ::System::Object
{
public:
	::Class_1_A2B569C8E16CE41A* __4__this; // 0x10
	::RPG::GameCore::AvatarSkillTreeRow* skillTreeRow; // 0x18
	::RPG::Client::SkillTreeGrowthGuideItem* item; // 0x20
	::RPG::GameCore::ICharacterSkillRowData* skillData; // 0x28
