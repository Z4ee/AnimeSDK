...
#define CLASS_1_5B567C8A01BAEDFE_209_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1EBBE0E0)
#define CLASS_1_5B567C8A01BAEDFE_209_CLONE_OFFSET UNITYSDK_OFFSET(0x1EBBDDD0)
#define CLASS_1_5B567C8A01BAEDFE_209_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1EBBDEE0)
#define CLASS_1_5B567C8A01BAEDFE_209_EQUALS_OFFSET UNITYSDK_OFFSET(0x1EBBDE10)
#define CLASS_1_5B567C8A01BAEDFE_209_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1EBBE040)
#define CLASS_1_5B567C8A01BAEDFE_209_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1EBBE130)
#define CLASS_1_5B567C8A01BAEDFE_209_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1EBBE100)
#define CLASS_1_5B567C8A01BAEDFE_209_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1EBBDD50)
#define CLASS_1_5B567C8A01BAEDFE_209_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1EBBDD80)
#define CLASS_1_5B567C8A01BAEDFE_209_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1EBBE070)
#define CLASS_1_5B567C8A01BAEDFE_209_WRITETO_OFFSET UNITYSDK_OFFSET(0x1EBBE0D0)
#define CLASS_1_5B567C8A01BAEDFE_209__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EBBE180)
#define CLASS_1_5B567C8A01BAEDFE_209__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EBBDDA0)
#define CLASS_1_5B567C8A01BAEDFE_209__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBBDD90)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_209_TypeDefinitionIndex = 30317;

class Class_1_5B567C8A01BAEDFE_209 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_209*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_209*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_209_TypeDefinitionIndex)->GetStaticField(0xCCA0);
	}
