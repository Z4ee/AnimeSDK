...
#define CLASS_1_E84B715B4BB2E65F_GET_FINISH_OFFSET UNITYSDK_OFFSET(0x17E66770)
#define CLASS_1_E84B715B4BB2E65F_METHOD_1_63EDAB3EFF913F92_OFFSET UNITYSDK_OFFSET(0x17E663F0)
#define CLASS_1_E84B715B4BB2E65F_SET_FINISH_OFFSET UNITYSDK_OFFSET(0x17E66780)
#define CLASS_1_E84B715B4BB2E65F__CTOR_OFFSET UNITYSDK_OFFSET(0x17E66790)

inline static constexpr unsigned int Class_1_E84B715B4BB2E65F_TypeDefinitionIndex = 78055;
...
public:
	...
	::UnityEngine::AnimationCurve* LOHJNDDJAJE; // 0x28
	::UnityEngine::AnimationCurve* EDPIEOEAIMF; // 0x30
	::System::Single IEHPFADHJFD; // 0x38
	::System::UInt32 AMGLFFNJGFN; // 0x3C
	::System::Single PMHMEGEJDGP; // 0x40
	::System::Boolean EKOBCMPNOCP; // 0x44
