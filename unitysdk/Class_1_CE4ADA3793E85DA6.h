...
#define CLASS_1_CE4ADA3793E85DA6_METHOD_1_4CEBECA6D9DFE57C_OFFSET UNITYSDK_OFFSET(0xB5EC290)
#define CLASS_1_CE4ADA3793E85DA6__CCTOR_OFFSET UNITYSDK_OFFSET(0xB5ECF80)
#define CLASS_1_CE4ADA3793E85DA6__CTOR_OFFSET UNITYSDK_OFFSET(0xB5ECF70)
...
public:
	...
	{
		return (::System::Text::RegularExpressions::Regex**)Il2CppClass::FromTypeDefinitionIndex(Class_1_CE4ADA3793E85DA6_TypeDefinitionIndex)->GetStaticField(0x64770);
	}
	static ::System::Text::RegularExpressions::Regex** StaticGet_GLLBJLJJJIO()
	{
		return (::System::Text::RegularExpressions::Regex**)Il2CppClass::FromTypeDefinitionIndex(Class_1_CE4ADA3793E85DA6_TypeDefinitionIndex)->GetStaticField(0x64778);
	}
