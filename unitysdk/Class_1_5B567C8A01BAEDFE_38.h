...
#define CLASS_1_5B567C8A01BAEDFE_38_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1CCEBAD0)
#define CLASS_1_5B567C8A01BAEDFE_38_CLONE_OFFSET UNITYSDK_OFFSET(0x1CCEB7C0)
#define CLASS_1_5B567C8A01BAEDFE_38_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1CCEB8D0)
#define CLASS_1_5B567C8A01BAEDFE_38_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CCEB800)
#define CLASS_1_5B567C8A01BAEDFE_38_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CCEBA30)
#define CLASS_1_5B567C8A01BAEDFE_38_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1CCEBB20)
#define CLASS_1_5B567C8A01BAEDFE_38_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1CCEBAF0)
#define CLASS_1_5B567C8A01BAEDFE_38_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1CCEB740)
#define CLASS_1_5B567C8A01BAEDFE_38_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1CCEB770)
#define CLASS_1_5B567C8A01BAEDFE_38_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1CCEBA60)
#define CLASS_1_5B567C8A01BAEDFE_38_WRITETO_OFFSET UNITYSDK_OFFSET(0x1CCEBAC0)
#define CLASS_1_5B567C8A01BAEDFE_38__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CCEBB70)
#define CLASS_1_5B567C8A01BAEDFE_38__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CCEB790)
#define CLASS_1_5B567C8A01BAEDFE_38__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCEB780)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_38_TypeDefinitionIndex = 25653;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_38*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_38_TypeDefinitionIndex)->GetStaticField(0x1B080);
	}
