...
#define CLASS_2_64BFD0961B5D1E90_DISPOSE_OFFSET UNITYSDK_OFFSET(0x169AD0C0)
#define CLASS_2_64BFD0961B5D1E90_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x169AD100)
#define CLASS_2_64BFD0961B5D1E90_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x169AD530)
#define CLASS_2_64BFD0961B5D1E90_TICK_OFFSET UNITYSDK_OFFSET(0x169AD580)
#define CLASS_2_64BFD0961B5D1E90__CTOR_OFFSET UNITYSDK_OFFSET(0x169AD0B0)

inline static constexpr unsigned int Class_2_64BFD0961B5D1E90_TypeDefinitionIndex = 55798;

class Class_2_64BFD0961B5D1E90 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ReleaseEnvProfile* Field_2_0; // 0x18
