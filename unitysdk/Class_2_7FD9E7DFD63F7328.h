...
#define CLASS_2_7FD9E7DFD63F7328_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB5084E0)
#define CLASS_2_7FD9E7DFD63F7328_METHOD_2_B555E07014FDD9D7_OFFSET UNITYSDK_OFFSET(0xB508610)
#define CLASS_2_7FD9E7DFD63F7328_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB508190)
#define CLASS_2_7FD9E7DFD63F7328_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB508340)
#define CLASS_2_7FD9E7DFD63F7328_TICK_OFFSET UNITYSDK_OFFSET(0xB508880)
#define CLASS_2_7FD9E7DFD63F7328__CTOR_OFFSET UNITYSDK_OFFSET(0xB508100)
...
{
public:
	::RPG::GameCore::EntityInEraFlipperSpotAreaListener* IGHAHBNLIJA; // 0x18
	::RPG::GameCore::TaskContext* EEFMDEHLLFI; // 0x20
	::Class_3_07C3C4D2990C49EE* OFGBCFDDPBE; // 0x28
