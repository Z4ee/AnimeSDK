...
#define NAVMESHPREFABINSTANCE_ADDINSTANCE_OFFSET UNITYSDK_OFFSET(0xE585770)
#define NAVMESHPREFABINSTANCE_ADDTRACKING_OFFSET UNITYSDK_OFFSET(0xE585A10)
#define NAVMESHPREFABINSTANCE_GET_FOLLOWTRANSFORM_OFFSET UNITYSDK_OFFSET(0xE5855B0)
#define NAVMESHPREFABINSTANCE_GET_NAVMESHDATA_OFFSET UNITYSDK_OFFSET(0xE585590)
#define NAVMESHPREFABINSTANCE_GET_TRACKEDINSTANCES_OFFSET UNITYSDK_OFFSET(0xE5856A0)
#define NAVMESHPREFABINSTANCE_HASMOVED_OFFSET UNITYSDK_OFFSET(0xE585DC0)
#define NAVMESHPREFABINSTANCE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xE585BB0)
#define NAVMESHPREFABINSTANCE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xE585700)
#define NAVMESHPREFABINSTANCE_REMOVETRACKING_OFFSET UNITYSDK_OFFSET(0xE585C00)
#define NAVMESHPREFABINSTANCE_SETFOLLOWTRANSFORM_OFFSET UNITYSDK_OFFSET(0xE585630)
#define NAVMESHPREFABINSTANCE_SET_FOLLOWTRANSFORM_OFFSET UNITYSDK_OFFSET(0xE5855C0)
#define NAVMESHPREFABINSTANCE_SET_NAVMESHDATA_OFFSET UNITYSDK_OFFSET(0xE5855A0)
#define NAVMESHPREFABINSTANCE_UPDATEINSTANCE_OFFSET UNITYSDK_OFFSET(0xE585D70)
#define NAVMESHPREFABINSTANCE_UPDATETRACKEDINSTANCES_OFFSET UNITYSDK_OFFSET(0xE585F20)
#define NAVMESHPREFABINSTANCE__CCTOR_OFFSET UNITYSDK_OFFSET(0xE586140)
#define NAVMESHPREFABINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xE5860F0)

inline static constexpr unsigned int NavMeshPrefabInstance_TypeDefinitionIndex = 79895;
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::NavMeshPrefabInstance*>**)Il2CppClass::FromTypeDefinitionIndex(NavMeshPrefabInstance_TypeDefinitionIndex)->GetStaticField(0x377F0);
	}
