...
#define NAVMESHPREFABINSTANCE_ADDINSTANCE_OFFSET UNITYSDK_OFFSET(0xEC96040)
#define NAVMESHPREFABINSTANCE_ADDTRACKING_OFFSET UNITYSDK_OFFSET(0xEC962E0)
#define NAVMESHPREFABINSTANCE_GET_FOLLOWTRANSFORM_OFFSET UNITYSDK_OFFSET(0xEC95E80)
#define NAVMESHPREFABINSTANCE_GET_NAVMESHDATA_OFFSET UNITYSDK_OFFSET(0xEC95E60)
#define NAVMESHPREFABINSTANCE_GET_TRACKEDINSTANCES_OFFSET UNITYSDK_OFFSET(0xEC95F70)
#define NAVMESHPREFABINSTANCE_HASMOVED_OFFSET UNITYSDK_OFFSET(0xEC96690)
#define NAVMESHPREFABINSTANCE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xEC96480)
#define NAVMESHPREFABINSTANCE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xEC95FD0)
#define NAVMESHPREFABINSTANCE_REMOVETRACKING_OFFSET UNITYSDK_OFFSET(0xEC964D0)
#define NAVMESHPREFABINSTANCE_SETFOLLOWTRANSFORM_OFFSET UNITYSDK_OFFSET(0xEC95F00)
#define NAVMESHPREFABINSTANCE_SET_FOLLOWTRANSFORM_OFFSET UNITYSDK_OFFSET(0xEC95E90)
#define NAVMESHPREFABINSTANCE_SET_NAVMESHDATA_OFFSET UNITYSDK_OFFSET(0xEC95E70)
#define NAVMESHPREFABINSTANCE_UPDATEINSTANCE_OFFSET UNITYSDK_OFFSET(0xEC96640)
#define NAVMESHPREFABINSTANCE_UPDATETRACKEDINSTANCES_OFFSET UNITYSDK_OFFSET(0xEC967F0)
#define NAVMESHPREFABINSTANCE__CCTOR_OFFSET UNITYSDK_OFFSET(0xEC96A10)
#define NAVMESHPREFABINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xEC969C0)

inline static constexpr unsigned int NavMeshPrefabInstance_TypeDefinitionIndex = 55998;
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::NavMeshPrefabInstance*>**)Il2CppClass::FromTypeDefinitionIndex(NavMeshPrefabInstance_TypeDefinitionIndex)->GetStaticField(0x33070);
	}
