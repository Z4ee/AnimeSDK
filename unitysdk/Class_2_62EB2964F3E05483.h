...
#define CLASS_2_62EB2964F3E05483_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x15983EC0)
#define CLASS_2_62EB2964F3E05483_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x15984040)
#define CLASS_2_62EB2964F3E05483_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x15982FD0)
#define CLASS_2_62EB2964F3E05483_GET_TRANS_OFFSET UNITYSDK_OFFSET(0x15982FF0)
#define CLASS_2_62EB2964F3E05483_METHOD_2_00DEF5A164D9A9D5_OFFSET UNITYSDK_OFFSET(0x15983030)
#define CLASS_2_62EB2964F3E05483_METHOD_2_04B5EDB18FECE00C_OFFSET UNITYSDK_OFFSET(0x15983700)
#define CLASS_2_62EB2964F3E05483_METHOD_2_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x159831F0)
#define CLASS_2_62EB2964F3E05483_METHOD_2_73351D543AC31E3E_OFFSET UNITYSDK_OFFSET(0x159839E0)
#define CLASS_2_62EB2964F3E05483_METHOD_2_B877181B6123B7F6_OFFSET UNITYSDK_OFFSET(0x15983360)
#define CLASS_2_62EB2964F3E05483_METHOD_2_C450A961450309C9_1_OFFSET UNITYSDK_OFFSET(0x15983C30)
#define CLASS_2_62EB2964F3E05483_METHOD_2_C450A961450309C9_2_OFFSET UNITYSDK_OFFSET(0x15983D20)
#define CLASS_2_62EB2964F3E05483_METHOD_2_C450A961450309C9_OFFSET UNITYSDK_OFFSET(0x15983AA0)
#define CLASS_2_62EB2964F3E05483_METHOD_2_E530905EC9C5B4AD_OFFSET UNITYSDK_OFFSET(0x15983810)
#define CLASS_2_62EB2964F3E05483_METHOD_2_E5B2D19C36637166_OFFSET UNITYSDK_OFFSET(0x15983510)
#define CLASS_2_62EB2964F3E05483_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x15983E10)
#define CLASS_2_62EB2964F3E05483_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x15982FE0)
#define CLASS_2_62EB2964F3E05483__CTOR_OFFSET UNITYSDK_OFFSET(0x159841A0)
#define CLASS_2_62EB2964F3E05483__ONBIND_OFFSET UNITYSDK_OFFSET(0x15982E80)

inline static constexpr unsigned int Class_2_62EB2964F3E05483_TypeDefinitionIndex = 71344;

class Class_2_62EB2964F3E05483 : public ::Class_1_34917908B7833130
{
public:
	// static const ::System::String* DJCBDJMACFH; // 0x0
	::Il2CppArray<::System::String*>* NBPLHLICCNN; // 0x60
	::RPG::Client::LocalizedText* HCPKJEKHAPF; // 0x68
	::UnityEngine::UI::Image* KBJDOEDBFDC; // 0x70
	::UnityEngine::UI::Image* NMMAJIDOFHE; // 0x78
	::RPG::GameCore::LevelUIComponent* GEAHNEAGEBG; // 0x80
	::RPG::Client::LocalizedText* AFABAFFOLGO; // 0x88
	::UnityEngine::UI::Button* HNMPOPNPDDB; // 0x90
