...
#define STRUCT_2_E4C95F6C5D4D6E84_METHOD_2_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x259D70)
#define STRUCT_2_E4C95F6C5D4D6E84_METHOD_2_2E700FB2B007CDD3_OFFSET UNITYSDK_OFFSET(0x462A80)
#define STRUCT_2_E4C95F6C5D4D6E84_METHOD_2_326B5ADA84F231E8_OFFSET UNITYSDK_OFFSET(0x117AFBE0)
#define STRUCT_2_E4C95F6C5D4D6E84_METHOD_2_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x749480)
#define STRUCT_2_E4C95F6C5D4D6E84_METHOD_2_7D201B4343E63821_OFFSET UNITYSDK_OFFSET(0x324D50)
#define STRUCT_2_E4C95F6C5D4D6E84_METHOD_2_81D2FBB04F1B4526_OFFSET UNITYSDK_OFFSET(0x117AFA90)
#define STRUCT_2_E4C95F6C5D4D6E84_METHOD_2_9492CE5249143740_OFFSET UNITYSDK_OFFSET(0x117AF970)
#define STRUCT_2_E4C95F6C5D4D6E84_METHOD_2_B58BC6045ACAB0D9_OFFSET UNITYSDK_OFFSET(0x1178D4E0)
#define STRUCT_2_E4C95F6C5D4D6E84_METHOD_2_C8BA04CF72E4997A_OFFSET UNITYSDK_OFFSET(0x31CCF0)
#define STRUCT_2_E4C95F6C5D4D6E84_METHOD_2_F877676CDE5E42C2_OFFSET UNITYSDK_OFFSET(0x117AF860)
#define STRUCT_2_E4C95F6C5D4D6E84_TOSTRING_OFFSET UNITYSDK_OFFSET(0x749470)
#define STRUCT_2_E4C95F6C5D4D6E84__CTOR_1_OFFSET UNITYSDK_OFFSET(0x749450)
#define STRUCT_2_E4C95F6C5D4D6E84__CTOR_OFFSET UNITYSDK_OFFSET(0x5990B0)

inline static constexpr unsigned int Struct_2_E4C95F6C5D4D6E84_TypeDefinitionIndex = 44626;

struct alignas(8) Struct_2_E4C95F6C5D4D6E84
{
	::System::String* Field_2_1; // 0x10
	::System::Collections::Generic::IReadOnlyList_1<::System::String*>* Field_2_0; // 0x18
	...
	*/
	...
	static ::Struct_2_E4C95F6C5D4D6E84 Method_2_326B5ADA84F231E8(::Il2CppArray<::System::String*>* a1)
	{
		return ((::Struct_2_E4C95F6C5D4D6E84(*)(::Il2CppArray<::System::String*>*))((::PBYTE)hIl2Cpp + STRUCT_2_E4C95F6C5D4D6E84_METHOD_2_326B5ADA84F231E8_OFFSET))(a1);
	}

	static ::Struct_2_E4C95F6C5D4D6E84 Method_2_B58BC6045ACAB0D9(::System::String* a1)
	{
		return ((::Struct_2_E4C95F6C5D4D6E84(*)(::System::String*))((::PBYTE)hIl2Cpp + STRUCT_2_E4C95F6C5D4D6E84_METHOD_2_B58BC6045ACAB0D9_OFFSET))(a1);
	}
};
