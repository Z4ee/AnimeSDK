...
#define DYNAMICBONEV2_DAMPER_DAMP_1_OFFSET UNITYSDK_OFFSET(0x1E1B76C0)
#define DYNAMICBONEV2_DAMPER_DAMP_2_OFFSET UNITYSDK_OFFSET(0x1E1B6F80)
#define DYNAMICBONEV2_DAMPER_DAMP_OFFSET UNITYSDK_OFFSET(0x1E1B7650)
#define DYNAMICBONEV2_DAMPER_DECAYCONSTANT_OFFSET UNITYSDK_OFFSET(0x1E1B75F0)
#define DYNAMICBONEV2_DAMPER_DECAYEDREMAINDER_OFFSET UNITYSDK_OFFSET(0x1E1B7620)

inline static constexpr unsigned int DynamicBoneV2_Damper_TypeDefinitionIndex = 34637;
