...
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_CALCULATEAABB_OFFSET UNITYSDK_OFFSET(0x18B44640)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_CALCULATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x18B44DB0)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_CALCULATEINSIDEFAST_OFFSET UNITYSDK_OFFSET(0x18B45CF0)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_CALCULATEINSIDE_OFFSET UNITYSDK_OFFSET(0x18B46020)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_HIDENGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x18B46860)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_ISBAKE_OFFSET UNITYSDK_OFFSET(0x18B463D0)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_ISPOINTINRECT_OFFSET UNITYSDK_OFFSET(0x18B45A90)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_MERGEBOUNDS_OFFSET UNITYSDK_OFFSET(0x18B45670)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_SETGAMEOBJECTVISIBILITYANDENABLE_OFFSET UNITYSDK_OFFSET(0x18B46690)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_SETGAMEOBJECTVISIBILITY_OFFSET UNITYSDK_OFFSET(0x18B46490)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_SHOWGAMEOBJECTFIRST_OFFSET UNITYSDK_OFFSET(0x18B46640)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_SHOWGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x18B46440)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x18B468B0)

inline static constexpr unsigned int SceneMeshCulledManager_MyTrigger_TypeDefinitionIndex = 52120;
