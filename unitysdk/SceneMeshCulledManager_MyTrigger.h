...
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_CALCULATEAABB_OFFSET UNITYSDK_OFFSET(0x143B3F80)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_CALCULATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x143B46F0)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_CALCULATEINSIDEFAST_OFFSET UNITYSDK_OFFSET(0x143B5570)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_CALCULATEINSIDE_OFFSET UNITYSDK_OFFSET(0x143B58A0)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_HIDENGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x143B60E0)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_ISBAKE_OFFSET UNITYSDK_OFFSET(0x143B5C50)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_ISPOINTINRECT_OFFSET UNITYSDK_OFFSET(0x143B5300)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_MERGEBOUNDS_OFFSET UNITYSDK_OFFSET(0x143B4F70)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_SETGAMEOBJECTVISIBILITYANDENABLE_OFFSET UNITYSDK_OFFSET(0x143B5F10)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_SETGAMEOBJECTVISIBILITY_OFFSET UNITYSDK_OFFSET(0x143B5D10)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_SHOWGAMEOBJECTFIRST_OFFSET UNITYSDK_OFFSET(0x143B5EC0)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_SHOWGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x143B5CC0)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x143B6130)

inline static constexpr unsigned int SceneMeshCulledManager_MyTrigger_TypeDefinitionIndex = 72643;
