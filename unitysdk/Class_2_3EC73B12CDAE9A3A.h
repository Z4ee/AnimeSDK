...
#define CLASS_2_3EC73B12CDAE9A3A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x121EC890)
#define CLASS_2_3EC73B12CDAE9A3A_METHOD_2_8C3DB70FFBBF01C7_OFFSET UNITYSDK_OFFSET(0x121ECC10)
#define CLASS_2_3EC73B12CDAE9A3A_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x121ECD30)
#define CLASS_2_3EC73B12CDAE9A3A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x121ECA50)
#define CLASS_2_3EC73B12CDAE9A3A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x121ECB00)
#define CLASS_2_3EC73B12CDAE9A3A_TICK_OFFSET UNITYSDK_OFFSET(0x121EC9F0)
#define CLASS_2_3EC73B12CDAE9A3A__CTOR_OFFSET UNITYSDK_OFFSET(0x121EC800)
...
{
public:
	::RPG::GameCore::WaitPlayerSkillAbort* OFKGLJOAMLD; // 0x18
	::Class_3_07C3C4D2990C49EE* EMOELIFPFCC; // 0x20
