...
#define CLASS_1_271B4C12B45EBA1F_GET_PLAYERUID_OFFSET UNITYSDK_OFFSET(0x162724A0)
#define CLASS_1_271B4C12B45EBA1F_METHOD_1_169ACDDF88AD2AC3_OFFSET UNITYSDK_OFFSET(0x16271EA0)
#define CLASS_1_271B4C12B45EBA1F_METHOD_1_2B8A1C24CAC94DE4_OFFSET UNITYSDK_OFFSET(0x16271AC0)
#define CLASS_1_271B4C12B45EBA1F_METHOD_1_3C8B7F0E011E7389_OFFSET UNITYSDK_OFFSET(0x16261140)
#define CLASS_1_271B4C12B45EBA1F_METHOD_1_5A9AE913E7F75D0A_OFFSET UNITYSDK_OFFSET(0x162720B0)
#define CLASS_1_271B4C12B45EBA1F_METHOD_1_9D4E43A25FC97325_OFFSET UNITYSDK_OFFSET(0x162718A0)
#define CLASS_1_271B4C12B45EBA1F_METHOD_1_B7EA3BB9B88661C9_OFFSET UNITYSDK_OFFSET(0x16271DD0)
#define CLASS_1_271B4C12B45EBA1F_METHOD_1_B8FC1AADE1407217_OFFSET UNITYSDK_OFFSET(0x16272030)
#define CLASS_1_271B4C12B45EBA1F_METHOD_1_D4FC357ADBC9995A_OFFSET UNITYSDK_OFFSET(0x16271F70)
#define CLASS_1_271B4C12B45EBA1F_METHOD_1_E975629435F9C6D4_OFFSET UNITYSDK_OFFSET(0x16261220)
#define CLASS_1_271B4C12B45EBA1F_METHOD_1_EDBB6D17828767FC_OFFSET UNITYSDK_OFFSET(0x1625DE90)
#define CLASS_1_271B4C12B45EBA1F_METHOD_1_FCA14D652BC093E6_OFFSET UNITYSDK_OFFSET(0x16271CD0)
#define CLASS_1_271B4C12B45EBA1F_SET_PLAYERUID_OFFSET UNITYSDK_OFFSET(0x162724B0)
#define CLASS_1_271B4C12B45EBA1F__CTOR_OFFSET UNITYSDK_OFFSET(0x162715D0)

inline static constexpr unsigned int Class_1_271B4C12B45EBA1F_TypeDefinitionIndex = 36439;

class Class_1_271B4C12B45EBA1F : public ::System::Object
{
public:
	::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* COIAEELHCOJ; // 0x10
	::System::Collections::Generic::Dictionary_2<::RPG::Client::LittleGameShare::TeamTowersCore::TeamTowersStatType, ::System::Int32>* DPHIHLJEBKF; // 0x18
	::System::Collections::Generic::Dictionary_2<::System::ValueTuple_3<::System::UInt32, ::System::Int32, ::System::Int32>, ::System::Int32>* FGFFMLILPLP; // 0x20
	::System::Collections::Generic::Dictionary_2<::RPG::Client::LittleGameShare::TeamTowersCore::TeamTowersStatType, ::System::Object*>* EIKFHBIHLON; // 0x28
	::System::Collections::Generic::Dictionary_2<::System::ValueTuple_2<::System::Int32, ::System::Int32>, ::System::Int32>* MCMPOKENOJC; // 0x30
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::UInt32))((::PBYTE)hIl2Cpp + CLASS_1_271B4C12B45EBA1F_METHOD_1_2B8A1C24CAC94DE4_OFFSET))(this, a1);
	}
