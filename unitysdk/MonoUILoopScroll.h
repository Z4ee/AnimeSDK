...
#define MONOUILOOPSCROLL_ADDID_OFFSET UNITYSDK_OFFSET(0x1384B190)
#define MONOUILOOPSCROLL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1384AA40)
#define MONOUILOOPSCROLL_FINDNEARESTNOTEMPTYINDEX_OFFSET UNITYSDK_OFFSET(0x1384C540)
#define MONOUILOOPSCROLL_GETCURRENTPOSITION_OFFSET UNITYSDK_OFFSET(0x1384B1F0)
#define MONOUILOOPSCROLL_GETMOVESTEP_OFFSET UNITYSDK_OFFSET(0x1384BFA0)
#define MONOUILOOPSCROLL_INIT_OFFSET UNITYSDK_OFFSET(0x1384AB10)
#define MONOUILOOPSCROLL_MOVECENTERGAMEOBJECTID_OFFSET UNITYSDK_OFFSET(0x1384BF30)
#define MONOUILOOPSCROLL_MOVEID_OFFSET UNITYSDK_OFFSET(0x1384BEC0)
#define MONOUILOOPSCROLL_MOVESCROLL_OFFSET UNITYSDK_OFFSET(0x1384C900)
#define MONOUILOOPSCROLL_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x1384D040)
#define MONOUILOOPSCROLL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1384B930)
#define MONOUILOOPSCROLL_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1384CF80)
#define MONOUILOOPSCROLL_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x1384CFF0)
#define MONOUILOOPSCROLL_ROLETOGO_OFFSET UNITYSDK_OFFSET(0x1384BB90)
#define MONOUILOOPSCROLL_SCROLLTOINDEX_OFFSET UNITYSDK_OFFSET(0x1384C4C0)
#define MONOUILOOPSCROLL_SUBID_OFFSET UNITYSDK_OFFSET(0x1384BFF0)
#define MONOUILOOPSCROLL_UPDATESELECTANIM_OFFSET UNITYSDK_OFFSET(0x1384B260)
#define MONOUILOOPSCROLL_UPDATE_OFFSET UNITYSDK_OFFSET(0x1384C040)
#define MONOUILOOPSCROLL__CTOR_OFFSET UNITYSDK_OFFSET(0x1384D090)

inline static constexpr unsigned int MonoUILoopScroll_TypeDefinitionIndex = 68413;
