...
#define MONOUILOOPSCROLL_ADDID_OFFSET UNITYSDK_OFFSET(0x15B23340)
#define MONOUILOOPSCROLL_AWAKE_OFFSET UNITYSDK_OFFSET(0x15B22C10)
#define MONOUILOOPSCROLL_FINDNEARESTNOTEMPTYINDEX_OFFSET UNITYSDK_OFFSET(0x15B24740)
#define MONOUILOOPSCROLL_GETCURRENTPOSITION_OFFSET UNITYSDK_OFFSET(0x15B233A0)
#define MONOUILOOPSCROLL_GETMOVESTEP_OFFSET UNITYSDK_OFFSET(0x15B24190)
#define MONOUILOOPSCROLL_INIT_OFFSET UNITYSDK_OFFSET(0x15B22CE0)
#define MONOUILOOPSCROLL_MOVECENTERGAMEOBJECTID_OFFSET UNITYSDK_OFFSET(0x15B24120)
#define MONOUILOOPSCROLL_MOVEID_OFFSET UNITYSDK_OFFSET(0x15B240B0)
#define MONOUILOOPSCROLL_MOVESCROLL_OFFSET UNITYSDK_OFFSET(0x15B24AC0)
#define MONOUILOOPSCROLL_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x15B25200)
#define MONOUILOOPSCROLL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x15B23B10)
#define MONOUILOOPSCROLL_ONDRAG_OFFSET UNITYSDK_OFFSET(0x15B25140)
#define MONOUILOOPSCROLL_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x15B251B0)
#define MONOUILOOPSCROLL_ROLETOGO_OFFSET UNITYSDK_OFFSET(0x15B23D70)
#define MONOUILOOPSCROLL_SCROLLTOINDEX_OFFSET UNITYSDK_OFFSET(0x15B246C0)
#define MONOUILOOPSCROLL_SUBID_OFFSET UNITYSDK_OFFSET(0x15B241E0)
#define MONOUILOOPSCROLL_UPDATESELECTANIM_OFFSET UNITYSDK_OFFSET(0x15B23410)
#define MONOUILOOPSCROLL_UPDATE_OFFSET UNITYSDK_OFFSET(0x15B24230)
#define MONOUILOOPSCROLL__CTOR_OFFSET UNITYSDK_OFFSET(0x15B25250)

inline static constexpr unsigned int MonoUILoopScroll_TypeDefinitionIndex = 41020;
