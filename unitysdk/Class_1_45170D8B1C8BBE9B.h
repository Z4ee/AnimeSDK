...
#define CLASS_1_45170D8B1C8BBE9B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x191A0E00)
#define CLASS_1_45170D8B1C8BBE9B_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x191A01C0)
#define CLASS_1_45170D8B1C8BBE9B_METHOD_1_11B36F15BBFE78DA_OFFSET UNITYSDK_OFFSET(0x191A0BC0)
#define CLASS_1_45170D8B1C8BBE9B_METHOD_1_248D44EF32B72CFE_OFFSET UNITYSDK_OFFSET(0x191A0B20)
#define CLASS_1_45170D8B1C8BBE9B_METHOD_1_35565CD9C6FB6400_OFFSET UNITYSDK_OFFSET(0x191A17E0)
#define CLASS_1_45170D8B1C8BBE9B_METHOD_1_3F03CE06D6F0B151_OFFSET UNITYSDK_OFFSET(0x191A01E0)
#define CLASS_1_45170D8B1C8BBE9B_METHOD_1_43904F79FE24A79C_OFFSET UNITYSDK_OFFSET(0x191A08F0)
#define CLASS_1_45170D8B1C8BBE9B_METHOD_1_5E39267EAF306B10_OFFSET UNITYSDK_OFFSET(0x191A0620)
#define CLASS_1_45170D8B1C8BBE9B_METHOD_1_9DCF3550EA1947E7_OFFSET UNITYSDK_OFFSET(0x191A0810)
#define CLASS_1_45170D8B1C8BBE9B_METHOD_1_A5E077B8DDABB633_OFFSET UNITYSDK_OFFSET(0x191A1070)
#define CLASS_1_45170D8B1C8BBE9B_METHOD_1_E5E53384AAFBF184_OFFSET UNITYSDK_OFFSET(0x191A0D40)
#define CLASS_1_45170D8B1C8BBE9B_METHOD_1_EB6A0187C2E55A74_OFFSET UNITYSDK_OFFSET(0x191A0560)
#define CLASS_1_45170D8B1C8BBE9B_METHOD_1_EEB7AD9AD74B5FBF_OFFSET UNITYSDK_OFFSET(0x191A0470)
#define CLASS_1_45170D8B1C8BBE9B_METHOD_1_F0BD65B017F2AC0B_OFFSET UNITYSDK_OFFSET(0x191A0F40)
#define CLASS_1_45170D8B1C8BBE9B_SET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x191A01D0)
#define CLASS_1_45170D8B1C8BBE9B__CTOR_OFFSET UNITYSDK_OFFSET(0x191A19A0)

inline static constexpr unsigned int Class_1_45170D8B1C8BBE9B_TypeDefinitionIndex = 53823;

class Class_1_45170D8B1C8BBE9B : public ::System::Object
{
public:
	::Class_0_16E4307DCC419505_468* DAFMDPOGBCA; // 0x10
	...
	::System::Void Method_1_5E39267EAF306B10(::RPGTools::Timeline::CharacterStoryMoveSequenceData* a1, ::RPG::GameCore::GameEntity* a2, ::UnityEngine::Animator* a3)
	{
		return ((::System::Void(*)(::PVOID, ::RPGTools::Timeline::CharacterStoryMoveSequenceData*, ::RPG::GameCore::GameEntity*, ::UnityEngine::Animator*))((::PBYTE)hIl2Cpp + CLASS_1_45170D8B1C8BBE9B_METHOD_1_5E39267EAF306B10_OFFSET))(this, a1, a2, a3);
	}
	...
	{
		return ((::Class_1_526C2C5F58C0A6C2*(*)(::PVOID, ::RPG::GameCore::BodySize, ::RPG::GameCore::NPCBodySize))((::PBYTE)hIl2Cpp + CLASS_1_45170D8B1C8BBE9B_METHOD_1_9DCF3550EA1947E7_OFFSET))(this, a1, a2);
	}

	::Class_1_FEBC85A0903FC7D7* Method_1_248D44EF32B72CFE(::RPG::GameCore::BodySize a1, ::RPG::GameCore::NPCBodySize a2, ::RPGTools::Timeline::CharacterStoryMoveData_MoveMode a3)
	{
		return ((::Class_1_FEBC85A0903FC7D7*(*)(::PVOID, ::RPG::GameCore::BodySize, ::RPG::GameCore::NPCBodySize, ::RPGTools::Timeline::CharacterStoryMoveData_MoveMode))((::PBYTE)hIl2Cpp + CLASS_1_45170D8B1C8BBE9B_METHOD_1_248D44EF32B72CFE_OFFSET))(this, a1, a2, a3);
	}

	::Class_1_649B7D3FAC2110AE* Method_1_E5E53384AAFBF184(::RPG::GameCore::BodySize a1, ::RPG::GameCore::NPCBodySize a2)
	{
		return ((::Class_1_649B7D3FAC2110AE*(*)(::PVOID, ::RPG::GameCore::BodySize, ::RPG::GameCore::NPCBodySize))((::PBYTE)hIl2Cpp + CLASS_1_45170D8B1C8BBE9B_METHOD_1_E5E53384AAFBF184_OFFSET))(this, a1, a2);
	}
};
