...
#define CLASS_1_648C7B1B4B98AEC6_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x16ECE100)
#define CLASS_1_648C7B1B4B98AEC6_METHOD_1_16E792B668863BDD_OFFSET UNITYSDK_OFFSET(0x16ECE140)
#define CLASS_1_648C7B1B4B98AEC6_METHOD_1_809094DEBF13B21A_OFFSET UNITYSDK_OFFSET(0x16ECE300)
#define CLASS_1_648C7B1B4B98AEC6_METHOD_1_B71EC7803FF07770_OFFSET UNITYSDK_OFFSET(0x16ECE680)
#define CLASS_1_648C7B1B4B98AEC6_METHOD_1_D9B69CBFF2C3295F_OFFSET UNITYSDK_OFFSET(0x16ECE4D0)
#define CLASS_1_648C7B1B4B98AEC6_METHOD_1_E94FB3AC6CD51D5D_OFFSET UNITYSDK_OFFSET(0x16ECE5F0)
#define CLASS_1_648C7B1B4B98AEC6__CTOR_OFFSET UNITYSDK_OFFSET(0x16ECE1C0)

inline static constexpr unsigned int Class_1_648C7B1B4B98AEC6_TypeDefinitionIndex = 77559;

class Class_1_648C7B1B4B98AEC6 : public ::System::Object
{
public:
	::RPG::GameCore::LittleGameLevelConfig* OLNKMNBCDNA; // 0x10
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::GameCore::LittleGameEntityConfig*>* IPFDFOLOCKD; // 0x18
	::Class_1_532073A7C89441B0* BECABMLCIAJ; // 0x20
