...
#define CLASS_1_648C7B1B4B98AEC6_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x13802BC0)
#define CLASS_1_648C7B1B4B98AEC6_METHOD_1_16E792B668863BDD_OFFSET UNITYSDK_OFFSET(0x13802C00)
#define CLASS_1_648C7B1B4B98AEC6_METHOD_1_809094DEBF13B21A_OFFSET UNITYSDK_OFFSET(0x13802DC0)
#define CLASS_1_648C7B1B4B98AEC6_METHOD_1_B71EC7803FF07770_OFFSET UNITYSDK_OFFSET(0x13803140)
#define CLASS_1_648C7B1B4B98AEC6_METHOD_1_D9B69CBFF2C3295F_OFFSET UNITYSDK_OFFSET(0x13802F90)
#define CLASS_1_648C7B1B4B98AEC6_METHOD_1_E94FB3AC6CD51D5D_OFFSET UNITYSDK_OFFSET(0x138030B0)
#define CLASS_1_648C7B1B4B98AEC6__CTOR_OFFSET UNITYSDK_OFFSET(0x13802C80)

inline static constexpr unsigned int Class_1_648C7B1B4B98AEC6_TypeDefinitionIndex = 72550;

class Class_1_648C7B1B4B98AEC6 : public ::System::Object
{
public:
	::Class_1_532073A7C89441B0* Field_1_0; // 0x10
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::GameCore::LittleGameEntityConfig*>* Field_1_1; // 0x18
	::RPG::GameCore::LittleGameLevelConfig* Field_1_2; // 0x20
