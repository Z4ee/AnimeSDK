...
#define CLASS_1_9BA88018AC303C05_DISPOSE_OFFSET UNITYSDK_OFFSET(0x152000B0)
#define CLASS_1_9BA88018AC303C05_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x15200100)
#define CLASS_1_9BA88018AC303C05_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x151FF1D0)
#define CLASS_1_9BA88018AC303C05_METHOD_1_A536C0A3C82A1588_OFFSET UNITYSDK_OFFSET(0x151FF260)
#define CLASS_1_9BA88018AC303C05_METHOD_1_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0x151FF180)
#define CLASS_1_9BA88018AC303C05_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x15200110)
#define CLASS_1_9BA88018AC303C05__CTOR_OFFSET UNITYSDK_OFFSET(0x151FF130)
...
{
public:
	::Class_1_C891149273D7CFB5* NMDGJILDMLO; // 0x10
	::RPG::GameCore::GameEntity* CFKHNPGEAJA; // 0x18
	::RPG::GameCore::TransformComponent* NIDHDAOGNKO; // 0x20
	::Il2CppArray<::System::Single>* FKKOAHGDFID; // 0x28
	::Class_1_C58549E83E2A95B6* PBOBGOFNGMH; // 0x30
	::Il2CppArray<::System::Single>* NKFFPBJJBCE; // 0x38
	::UnityEngine::Vector3 OIMMGKNHKOA; // 0x40
	::UnityEngine::Vector3 GHHCEKAKAAO; // 0x4C
	::System::Single JMKACDADNGI; // 0x58
	::System::Single HBCJEGADKGF; // 0x5C
	::System::Boolean HDJOGGDMCIO; // 0x60
