...
#define CLASS_1_FD893FD36F6A3A6D_5_CALCULATEVALUE_OFFSET UNITYSDK_OFFSET(0x18BCD4B0)
#define CLASS_1_FD893FD36F6A3A6D_5_GET_BASIC_OFFSET UNITYSDK_OFFSET(0x18BCD490)
#define CLASS_1_FD893FD36F6A3A6D_5_SET_BASIC_OFFSET UNITYSDK_OFFSET(0x18BCD4A0)
#define CLASS_1_FD893FD36F6A3A6D_5__CTOR_OFFSET UNITYSDK_OFFSET(0x18BCD510)
