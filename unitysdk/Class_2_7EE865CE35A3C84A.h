...
#define CLASS_2_7EE865CE35A3C84A_METHOD_2_04A81FA1DB9D4E37_OFFSET UNITYSDK_OFFSET(0xAF416B0)
#define CLASS_2_7EE865CE35A3C84A_METHOD_2_DDC022DA675A07CD_OFFSET UNITYSDK_OFFSET(0xAF41250)
#define CLASS_2_7EE865CE35A3C84A__CTOR_OFFSET UNITYSDK_OFFSET(0xAF417E0)
#define CLASS_2_7EE865CE35A3C84A__ONBIND_OFFSET UNITYSDK_OFFSET(0xAF41030)
#define CLASS_2_7EE865CE35A3C84A___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0xAF41810)

inline static constexpr unsigned int Class_2_7EE865CE35A3C84A_TypeDefinitionIndex = 67207;
...
public:
	...
	::System::Void Method_2_DDC022DA675A07CD(::RPG::Client::FeixiaoSPPointState a1)
	{
		return ((::System::Void(*)(::PVOID, ::RPG::Client::FeixiaoSPPointState))((::PBYTE)hIl2Cpp + CLASS_2_7EE865CE35A3C84A_METHOD_2_DDC022DA675A07CD_OFFSET))(this, a1);
	}
