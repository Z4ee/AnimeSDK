...
#define CLASS_2_3142A3BECE366D47_METHOD_2_3422201382CE593B_OFFSET UNITYSDK_OFFSET(0x16CCE9F0)
#define CLASS_2_3142A3BECE366D47_METHOD_2_39A244BD953ADE9C_OFFSET UNITYSDK_OFFSET(0x16CCE670)
#define CLASS_2_3142A3BECE366D47_METHOD_2_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0x16CCE980)
#define CLASS_2_3142A3BECE366D47_METHOD_2_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x16CCE770)
#define CLASS_2_3142A3BECE366D47_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x16CCE660)
#define CLASS_2_3142A3BECE366D47_METHOD_2_FE327FD0760E1514_OFFSET UNITYSDK_OFFSET(0x16CCE850)
#define CLASS_2_3142A3BECE366D47__CTOR_OFFSET UNITYSDK_OFFSET(0x16CCEA70)

inline static constexpr unsigned int Class_2_3142A3BECE366D47_TypeDefinitionIndex = 60262;

class Class_2_3142A3BECE366D47 : public ::Class_1_2A73EE3831056054
{
public:
	::RPG::GameCore::PropComponent* PMIBEAIGLAO; // 0x20
	::RPG::GameCore::AdventureCharacterController* CPIIOIPAAKK; // 0x28
	::System::Single IJAJOGNGEIK; // 0x30
	::System::Single BPMNMDJIPLE; // 0x34
	::RPG::Client::AdventureEntityDieState DLNIGFGLPLJ; // 0x38
