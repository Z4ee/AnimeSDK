...
#define CLASS_1_64C3966266CD3F2B__CTOR_OFFSET UNITYSDK_OFFSET(0x167C39A0)

inline static constexpr unsigned int Class_1_64C3966266CD3F2B_TypeDefinitionIndex = 32733;

class Class_1_64C3966266CD3F2B : public ::System::Object
{
public:
	::RPG::GameCore::Match3::PieceTag Field_1_1; // 0x10
	::RPG::GameCore::Match3::GridTag Field_1_2; // 0x14
