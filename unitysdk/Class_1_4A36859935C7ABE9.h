...
#define CLASS_1_4A36859935C7ABE9_LATEEXECUTE_OFFSET UNITYSDK_OFFSET(0x1542A120)
#define CLASS_1_4A36859935C7ABE9_METHOD_1_281255C747FAABE8_OFFSET UNITYSDK_OFFSET(0x1542A260)
#define CLASS_1_4A36859935C7ABE9_METHOD_1_37271A3CB72783D5_OFFSET UNITYSDK_OFFSET(0x1542A8C0)
#define CLASS_1_4A36859935C7ABE9_METHOD_1_4518C672652FCAF9_OFFSET UNITYSDK_OFFSET(0x1542AB60)
#define CLASS_1_4A36859935C7ABE9_METHOD_1_4982AA42FF01B20D_OFFSET UNITYSDK_OFFSET(0x1542AD50)
#define CLASS_1_4A36859935C7ABE9_METHOD_1_AB70FF25B0F862BF_OFFSET UNITYSDK_OFFSET(0x1542AAE0)
#define CLASS_1_4A36859935C7ABE9_METHOD_1_B7F991DC594C3820_OFFSET UNITYSDK_OFFSET(0x1542AE90)
#define CLASS_1_4A36859935C7ABE9_TEARDOWN_OFFSET UNITYSDK_OFFSET(0x1542A810)
#define CLASS_1_4A36859935C7ABE9__CTOR_OFFSET UNITYSDK_OFFSET(0x15429F80)

inline static constexpr unsigned int Class_1_4A36859935C7ABE9_TypeDefinitionIndex = 76431;

class Class_1_4A36859935C7ABE9 : public ::System::Object
{
public:
	::Entitas::IGroup_1<::Class_2_B9E8C2EEAA5C96EC*>* ENJONGEODEM; // 0x10
	::Class_3_1E4F9B0ED3BF21DE* PDENFEFCAGN; // 0x18
	::Class_1_B4357A1C72BABC6B* FKINCGODJEP; // 0x20
	::Entitas::IGroup_1<::Class_2_B9E8C2EEAA5C96EC*>* IFKGIDBAFJJ; // 0x28
