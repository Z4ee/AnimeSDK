...
#define MONODOLLYCAMERACONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xBBC35A0)
#define MONODOLLYCAMERACONTROLLER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xBBC39D0)
#define MONODOLLYCAMERACONTROLLER_METHOD_5_D4D400F3063B9422_OFFSET UNITYSDK_OFFSET(0xBBC3870)
#define MONODOLLYCAMERACONTROLLER_SETCONTROLFOV_OFFSET UNITYSDK_OFFSET(0xBBC3B50)
#define MONODOLLYCAMERACONTROLLER_STARTDOLLYPOINTANIM_OFFSET UNITYSDK_OFFSET(0xBBC3A20)
#define MONODOLLYCAMERACONTROLLER_UPDATEBYTIMERATIO_OFFSET UNITYSDK_OFFSET(0xBBC3700)
#define MONODOLLYCAMERACONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xBBC3660)
#define MONODOLLYCAMERACONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBBC3C10)
