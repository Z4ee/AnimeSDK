...
#define MONODOLLYCAMERACONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x9338CE0)
#define MONODOLLYCAMERACONTROLLER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9338F90)
#define MONODOLLYCAMERACONTROLLER_SETCONTROLFOV_OFFSET UNITYSDK_OFFSET(0x93391D0)
#define MONODOLLYCAMERACONTROLLER_STARTDOLLYPOINTANIM_OFFSET UNITYSDK_OFFSET(0x9338FE0)
#define MONODOLLYCAMERACONTROLLER_UPDATEBYTIMERATIO_OFFSET UNITYSDK_OFFSET(0x9338E20)
#define MONODOLLYCAMERACONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x9338DA0)
#define MONODOLLYCAMERACONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9339290)

inline static constexpr unsigned int MonoDollyCameraController_TypeDefinitionIndex = 44053;
