...
#define CLASS_1_B628BD6117888CBA_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E364BD0)
#define CLASS_1_B628BD6117888CBA_CLONE_OFFSET UNITYSDK_OFFSET(0x1E364710)
#define CLASS_1_B628BD6117888CBA_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E3648B0)
#define CLASS_1_B628BD6117888CBA_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E364770)
#define CLASS_1_B628BD6117888CBA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E3649D0)
#define CLASS_1_B628BD6117888CBA_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E364D10)
#define CLASS_1_B628BD6117888CBA_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E364C70)
#define CLASS_1_B628BD6117888CBA_METHOD_1_4C96E9A31DDA1BDD_OFFSET UNITYSDK_OFFSET(0x1E364740)
#define CLASS_1_B628BD6117888CBA_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E364600)
#define CLASS_1_B628BD6117888CBA_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1E364760)
#define CLASS_1_B628BD6117888CBA_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1E364750)
#define CLASS_1_B628BD6117888CBA_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E364630)
#define CLASS_1_B628BD6117888CBA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E364A40)
#define CLASS_1_B628BD6117888CBA_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E364AA0)
#define CLASS_1_B628BD6117888CBA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E364ED0)
#define CLASS_1_B628BD6117888CBA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E364680)
#define CLASS_1_B628BD6117888CBA__CTOR_OFFSET UNITYSDK_OFFSET(0x1E364640)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_B628BD6117888CBA*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B628BD6117888CBA_TypeDefinitionIndex)->GetStaticField(0x58680);
	}
	static ::Google::Protobuf::FieldCodec_1<::Proto::PileItem*>** StaticGet_KMKECFIHFFA()
	{
		return (::Google::Protobuf::FieldCodec_1<::Proto::PileItem*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B628BD6117888CBA_TypeDefinitionIndex)->GetStaticField(0x58688);
	}
