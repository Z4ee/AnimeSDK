...
#define CLASS_1_3B5D702A260F9C39_METHOD_1_0868EF727040C390_OFFSET UNITYSDK_OFFSET(0x14008060)
#define CLASS_1_3B5D702A260F9C39_METHOD_1_0BE1846AC20D43BE_OFFSET UNITYSDK_OFFSET(0x14008200)
#define CLASS_1_3B5D702A260F9C39_METHOD_1_3E372E1A00FA0CCA_OFFSET UNITYSDK_OFFSET(0x14008D20)
#define CLASS_1_3B5D702A260F9C39_METHOD_1_DB52F3621E27A663_OFFSET UNITYSDK_OFFSET(0x140088D0)
#define CLASS_1_3B5D702A260F9C39_METHOD_1_F5237B6ABA881210_OFFSET UNITYSDK_OFFSET(0x14008410)
#define CLASS_1_3B5D702A260F9C39_METHOD_1_FDDC5A41F149A0CC_OFFSET UNITYSDK_OFFSET(0x14008C10)
#define CLASS_1_3B5D702A260F9C39__CCTOR_OFFSET UNITYSDK_OFFSET(0x14008020)

inline static constexpr unsigned int Class_1_3B5D702A260F9C39_TypeDefinitionIndex = 70721;
...
public:
	...
	{
		return (::MoleMole::Config::HollowCampTypeConfig**)Il2CppClass::FromTypeDefinitionIndex(Class_1_3B5D702A260F9C39_TypeDefinitionIndex)->GetStaticField(0x443F0);
	}
	static ::MoleMole::Config::HollowCampTypeConfig_CampTypeItem** StaticGet_Field_1_7()
	{
		return (::MoleMole::Config::HollowCampTypeConfig_CampTypeItem**)Il2CppClass::FromTypeDefinitionIndex(Class_1_3B5D702A260F9C39_TypeDefinitionIndex)->GetStaticField(0x443F8);
	}
	...
	static ::System::Collections::Generic::List_1<::MoleMole::HollowEntityConfig_CampType>* Method_1_F5237B6ABA881210(::MoleMole::HollowEntityConfig_CampType a1, ::MoleMole::HollowEntityConfig_TeamRelationship a2)
	{
		return ((::System::Collections::Generic::List_1<::MoleMole::HollowEntityConfig_CampType>*(*)(::MoleMole::HollowEntityConfig_CampType, ::MoleMole::HollowEntityConfig_TeamRelationship))((::PBYTE)hIl2Cpp + CLASS_1_3B5D702A260F9C39_METHOD_1_F5237B6ABA881210_OFFSET))(a1, a2);
	}
