...
#define CLASS_2_C6B8D430FBF9D128_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A7F6550)
#define CLASS_2_C6B8D430FBF9D128_METHOD_2_7B6EC255F45D034F_OFFSET UNITYSDK_OFFSET(0x1A7F6690)
#define CLASS_2_C6B8D430FBF9D128_METHOD_2_DB724851FEB3D97C_OFFSET UNITYSDK_OFFSET(0x1A7F6590)
#define CLASS_2_C6B8D430FBF9D128__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7F6760)

inline static constexpr unsigned int Class_2_C6B8D430FBF9D128_TypeDefinitionIndex = 57717;

class Class_2_C6B8D430FBF9D128 : public ::RPG::GameCore::GameComponentBase
{
public:
	::System::Action_1<::RPG::GameCore::GameEntity*>* FPCPEAPOOHG; // 0x18
