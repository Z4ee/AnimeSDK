...
#define CLASS_1_8D8733BA049AFFEB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x170B4330)
#define CLASS_1_8D8733BA049AFFEB_METHOD_1_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x170B4670)
#define CLASS_1_8D8733BA049AFFEB_METHOD_1_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x170B4880)
#define CLASS_1_8D8733BA049AFFEB_METHOD_1_257BFAD4C4600BB3_OFFSET UNITYSDK_OFFSET(0x170B49A0)
#define CLASS_1_8D8733BA049AFFEB_METHOD_1_44950E14D07C51F9_OFFSET UNITYSDK_OFFSET(0x170B4630)
#define CLASS_1_8D8733BA049AFFEB_METHOD_1_7DB49B5407C8FD68_OFFSET UNITYSDK_OFFSET(0x170B4380)
#define CLASS_1_8D8733BA049AFFEB_METHOD_1_DDA8A2337932DF10_OFFSET UNITYSDK_OFFSET(0x170B4760)
#define CLASS_1_8D8733BA049AFFEB_METHOD_1_DF9BC33850128E67_OFFSET UNITYSDK_OFFSET(0x170B4940)
#define CLASS_1_8D8733BA049AFFEB_TICK_OFFSET UNITYSDK_OFFSET(0x170B4460)
#define CLASS_1_8D8733BA049AFFEB__CTOR_OFFSET UNITYSDK_OFFSET(0x170B42E0)
...
{
public:
	::Class_3_07C3C4D2990C49EE* LPGMOLOFLOP; // 0x10
	::RPG::GameCore::WaitFrame* FLCFNDDCKOC; // 0x18
	::RPG::GameCore::ScrTrfActTaskList* IGHAHBNLIJA; // 0x20
