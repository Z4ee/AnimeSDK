...
#define CLASS_1_03DF5C4457066928_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A601A40)
#define CLASS_1_03DF5C4457066928__CTOR_OFFSET UNITYSDK_OFFSET(0x1A601AF0)
...
{
public:
	::Class_0_16E4307DCC419505_114* KPJGAIFEMOM; // 0x10
	::Struct_2_AE3A255CA9C42FA9 HLCIBNIDADC; // 0x18
