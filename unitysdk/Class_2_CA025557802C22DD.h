...
#define CLASS_2_CA025557802C22DD_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18BD82B0)
#define CLASS_2_CA025557802C22DD_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x18BD92B0)
#define CLASS_2_CA025557802C22DD_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18BD8350)
#define CLASS_2_CA025557802C22DD_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x18BD9300)
#define CLASS_2_CA025557802C22DD_TICK_OFFSET UNITYSDK_OFFSET(0x18BD82F0)
#define CLASS_2_CA025557802C22DD__CTOR_OFFSET UNITYSDK_OFFSET(0x18BD82A0)

inline static constexpr unsigned int Class_2_CA025557802C22DD_TypeDefinitionIndex = 56018;

class Class_2_CA025557802C22DD : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ShowEvolveBuildTreasureInBattle* Field_2_0; // 0x18
