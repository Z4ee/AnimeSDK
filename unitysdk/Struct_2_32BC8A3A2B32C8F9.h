...
#define STRUCT_2_32BC8A3A2B32C8F9_DISPOSE_OFFSET UNITYSDK_OFFSET(0x5DF550)
#define STRUCT_2_32BC8A3A2B32C8F9__CTOR_OFFSET UNITYSDK_OFFSET(0x5DF4D0)

inline static constexpr unsigned int Struct_2_32BC8A3A2B32C8F9_TypeDefinitionIndex = 80515;
