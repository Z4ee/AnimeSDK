...
#define STRUCT_2_32BC8A3A2B32C8F9_DISPOSE_OFFSET UNITYSDK_OFFSET(0x820270)
#define STRUCT_2_32BC8A3A2B32C8F9__CTOR_OFFSET UNITYSDK_OFFSET(0x8201F0)

inline static constexpr unsigned int Struct_2_32BC8A3A2B32C8F9_TypeDefinitionIndex = 55967;
