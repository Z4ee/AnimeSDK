...
#define CLASS_2_B5CD7CAF9AD255B9_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14263600)
#define CLASS_2_B5CD7CAF9AD255B9_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x14263850)
#define CLASS_2_B5CD7CAF9AD255B9_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x14263640)
#define CLASS_2_B5CD7CAF9AD255B9_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x142637A0)
#define CLASS_2_B5CD7CAF9AD255B9_TICK_OFFSET UNITYSDK_OFFSET(0x142637F0)
#define CLASS_2_B5CD7CAF9AD255B9__CTOR_OFFSET UNITYSDK_OFFSET(0x142635F0)

inline static constexpr unsigned int Class_2_B5CD7CAF9AD255B9_TypeDefinitionIndex = 49925;

class Class_2_B5CD7CAF9AD255B9 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TrainPartyShowEventFadeIn* Field_2_0; // 0x18
