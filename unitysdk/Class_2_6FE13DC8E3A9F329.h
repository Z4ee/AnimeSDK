...
#define CLASS_2_6FE13DC8E3A9F329_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x15BB4D50)
#define CLASS_2_6FE13DC8E3A9F329_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x15BB4F10)
#define CLASS_2_6FE13DC8E3A9F329_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x15BB3710)
#define CLASS_2_6FE13DC8E3A9F329_GET_TRANS_OFFSET UNITYSDK_OFFSET(0x15BB3730)
#define CLASS_2_6FE13DC8E3A9F329_METHOD_2_00DEF5A164D9A9D5_OFFSET UNITYSDK_OFFSET(0x15BB3960)
#define CLASS_2_6FE13DC8E3A9F329_METHOD_2_0D372435D9CAE4BC_OFFSET UNITYSDK_OFFSET(0x15BB41C0)
#define CLASS_2_6FE13DC8E3A9F329_METHOD_2_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0x15BB4960)
#define CLASS_2_6FE13DC8E3A9F329_METHOD_2_30866F9CCFB9057B_OFFSET UNITYSDK_OFFSET(0x15BB3B20)
#define CLASS_2_6FE13DC8E3A9F329_METHOD_2_5633C39E0F4C80C6_OFFSET UNITYSDK_OFFSET(0x15BB4470)
#define CLASS_2_6FE13DC8E3A9F329_METHOD_2_8C0F82AA8DA03496_OFFSET UNITYSDK_OFFSET(0x15BB4630)
#define CLASS_2_6FE13DC8E3A9F329_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x15BB3FB0)
#define CLASS_2_6FE13DC8E3A9F329_METHOD_2_974A70E8019154E7_OFFSET UNITYSDK_OFFSET(0x15BB4C40)
#define CLASS_2_6FE13DC8E3A9F329_METHOD_2_BA60B5B08BA71FA9_OFFSET UNITYSDK_OFFSET(0x15BB4860)
#define CLASS_2_6FE13DC8E3A9F329_METHOD_2_D10D72BF522CC48B_OFFSET UNITYSDK_OFFSET(0x15BB48E0)
#define CLASS_2_6FE13DC8E3A9F329_METHOD_2_F37CDBD6D46274D2_1_OFFSET UNITYSDK_OFFSET(0x15BB4AC0)
#define CLASS_2_6FE13DC8E3A9F329_METHOD_2_F37CDBD6D46274D2_2_OFFSET UNITYSDK_OFFSET(0x15BB4B80)
#define CLASS_2_6FE13DC8E3A9F329_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x15BB4A00)
#define CLASS_2_6FE13DC8E3A9F329_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x15BB3720)
#define CLASS_2_6FE13DC8E3A9F329__CTOR_OFFSET UNITYSDK_OFFSET(0x15BB50B0)
#define CLASS_2_6FE13DC8E3A9F329__ONBIND_OFFSET UNITYSDK_OFFSET(0x15BB3770)
#define CLASS_2_6FE13DC8E3A9F329__ONTICK_OFFSET UNITYSDK_OFFSET(0x15BB4070)

inline static constexpr unsigned int Class_2_6FE13DC8E3A9F329_TypeDefinitionIndex = 72034;

class Class_2_6FE13DC8E3A9F329 : public ::Class_1_34917908B7833130
{
public:
	// static const ::System::String* DJCBDJMACFH; // 0x0
	::RPG::Client::AnimatorButton* HDPAGPIHAJG; // 0x60
	::UnityEngine::CanvasGroup* GFJADDHHOII; // 0x68
	::System::Collections::Generic::Dictionary_2<::RPG::Client::TextID, ::System::Int32>* CPKPPAAJEOJ; // 0x70
	::UnityEngine::Animation* PMOJILOJEPE; // 0x78
	::UnityEngine::Transform* COGOPBJHLME; // 0x80
	::RPG::Client::AnimatorButton* NBBGLIHKLDH; // 0x88
	::UnityEngine::CanvasGroup* KNPDPINAFBG; // 0x90
	::UnityEngine::Transform* PEMIMCDDCNP; // 0x98
	::UnityEngine::UI::Text* LKICJKJDPAI; // 0xA0
