...
#define CLASS_1_C6871D0DAD2A840E_METHOD_1_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0x1783A650)
#define CLASS_1_C6871D0DAD2A840E_METHOD_1_30688639C05367DF_OFFSET UNITYSDK_OFFSET(0x1783A720)
#define CLASS_1_C6871D0DAD2A840E_METHOD_1_35AE813E1A9FD332_OFFSET UNITYSDK_OFFSET(0x1783AA80)
#define CLASS_1_C6871D0DAD2A840E_METHOD_1_3F1C4983871A7C3E_OFFSET UNITYSDK_OFFSET(0x1783A8D0)
#define CLASS_1_C6871D0DAD2A840E_METHOD_1_69B522BF0D581960_OFFSET UNITYSDK_OFFSET(0x1783A7C0)
#define CLASS_1_C6871D0DAD2A840E_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1783A9E0)
#define CLASS_1_C6871D0DAD2A840E_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1783A600)
#define CLASS_1_C6871D0DAD2A840E_METHOD_1_E246C7AF46F19BA3_OFFSET UNITYSDK_OFFSET(0x1783ABB0)
#define CLASS_1_C6871D0DAD2A840E_METHOD_1_F4ADC37B63F4E9EF_1_OFFSET UNITYSDK_OFFSET(0x1783A990)
#define CLASS_1_C6871D0DAD2A840E_METHOD_1_F4ADC37B63F4E9EF_OFFSET UNITYSDK_OFFSET(0x1783A6D0)
#define CLASS_1_C6871D0DAD2A840E__CTOR_OFFSET UNITYSDK_OFFSET(0x1783A5F0)

inline static constexpr unsigned int Class_1_C6871D0DAD2A840E_TypeDefinitionIndex = 63064;

class Class_1_C6871D0DAD2A840E : public ::System::Object
{
public:
	// static const ::System::String* BJDLCABFCLK; // 0x0
	// static const ::System::String* GLOCOOCFFNE; // 0x0
	::System::Int32 JDNFGGEJJPE; // 0x10
	::RPG::Client::CakeRaceBGMType AAJKPKGPOPJ; // 0x14
