...
#define CLASS_2_523C55AEA55804D8_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18836660)
#define CLASS_2_523C55AEA55804D8_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x18837D70)
#define CLASS_2_523C55AEA55804D8_METHOD_2_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x18839670)
#define CLASS_2_523C55AEA55804D8_METHOD_2_1FFE4260A7179061_OFFSET UNITYSDK_OFFSET(0x188397C0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_25C863F1B6DFA9F4_OFFSET UNITYSDK_OFFSET(0x18836750)
#define CLASS_2_523C55AEA55804D8_METHOD_2_2A2B4A2E0BDAAF15_OFFSET UNITYSDK_OFFSET(0x18837720)
#define CLASS_2_523C55AEA55804D8_METHOD_2_3CAC93BF77250DAD_OFFSET UNITYSDK_OFFSET(0x188397A0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_4538E9501054E688_OFFSET UNITYSDK_OFFSET(0x18837DF0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_4AB9012B5D01108B_OFFSET UNITYSDK_OFFSET(0x188394D0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_51BBA01F511E6107_OFFSET UNITYSDK_OFFSET(0x18837D10)
#define CLASS_2_523C55AEA55804D8_METHOD_2_57D80B372834C5D1_OFFSET UNITYSDK_OFFSET(0x188380E0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_595E641DF1B4387D_OFFSET UNITYSDK_OFFSET(0x188377B0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_5C00C2EE4FCF347E_OFFSET UNITYSDK_OFFSET(0x18839880)
#define CLASS_2_523C55AEA55804D8_METHOD_2_6516DD2B8C441001_OFFSET UNITYSDK_OFFSET(0x18837440)
#define CLASS_2_523C55AEA55804D8_METHOD_2_68A2CA32DC720C44_OFFSET UNITYSDK_OFFSET(0x18839580)
#define CLASS_2_523C55AEA55804D8_METHOD_2_7F4EBEC55EBE2D81_OFFSET UNITYSDK_OFFSET(0x18838A30)
#define CLASS_2_523C55AEA55804D8_METHOD_2_7F5959D5B740D04C_OFFSET UNITYSDK_OFFSET(0x18837690)
#define CLASS_2_523C55AEA55804D8_METHOD_2_7FCED9DBE84C0CF1_OFFSET UNITYSDK_OFFSET(0x18838310)
#define CLASS_2_523C55AEA55804D8_METHOD_2_8493EBF84986D042_OFFSET UNITYSDK_OFFSET(0x18837EF0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_A944F7B3B6322143_OFFSET UNITYSDK_OFFSET(0x18837900)
#define CLASS_2_523C55AEA55804D8_METHOD_2_B1445E8504415D4D_OFFSET UNITYSDK_OFFSET(0x188397B0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_BA0C5F78E9FFA006_OFFSET UNITYSDK_OFFSET(0x18838B30)
#define CLASS_2_523C55AEA55804D8_METHOD_2_C0A2DE8417347362_OFFSET UNITYSDK_OFFSET(0x18836E10)
#define CLASS_2_523C55AEA55804D8_METHOD_2_C114A1F8E08B6F92_OFFSET UNITYSDK_OFFSET(0x18839800)
#define CLASS_2_523C55AEA55804D8_METHOD_2_C74CF020AA42ED85_1_OFFSET UNITYSDK_OFFSET(0x18839890)
#define CLASS_2_523C55AEA55804D8_METHOD_2_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x188397F0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x188382C0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x18838270)
#define CLASS_2_523C55AEA55804D8_METHOD_2_CE18697B63E52504_OFFSET UNITYSDK_OFFSET(0x18839820)
#define CLASS_2_523C55AEA55804D8_METHOD_2_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x18838140)
#define CLASS_2_523C55AEA55804D8_METHOD_2_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x18836570)
#define CLASS_2_523C55AEA55804D8_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x18839810)
#define CLASS_2_523C55AEA55804D8_ONMODELROOTLOADED_OFFSET UNITYSDK_OFFSET(0x188371B0)
#define CLASS_2_523C55AEA55804D8_ONMODELROOTUNLOADED_OFFSET UNITYSDK_OFFSET(0x18837620)
#define CLASS_2_523C55AEA55804D8__CCTOR_OFFSET UNITYSDK_OFFSET(0x188398A0)
#define CLASS_2_523C55AEA55804D8__CTOR_OFFSET UNITYSDK_OFFSET(0x188364B0)
...
public:
	...
	{
		return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_523C55AEA55804D8_TypeDefinitionIndex)->GetStaticField(0x5B9B0);
	}
	static ::System::Boolean* StaticGet_KFHCFCMBDOJ()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_2_523C55AEA55804D8_TypeDefinitionIndex)->GetStaticField(0x12990);
	}
	// static const ::System::Single DKHMHBCIJGP; // 0x0
	::Class_1_51EED7CD291B614D* ICBMFGHKKLI; // 0x18
	::System::Action_2<::UnityEngine::Vector3, ::UnityEngine::Quaternion>* EHCFMGLAIFF; // 0x20
	::System::Action_1<::RPG::GameCore::GameEntity*>* KBNBHMMIOIP; // 0x28
	::System::Action* IBJMGFCCEFK; // 0x30
	::RPG::GameCore::TransformComponent* PLJPNMPJMJH; // 0x38
	::UnityEngine::Collider* LOPJEONAFBH; // 0x40
	::RPG::GameCore::GameEntity* ANGPGEHPJPD; // 0x48
	::Class_0_16E4307DCC419505_601* GMNBNHFCMMN; // 0x50
	::Class_3_2B2F6402EA3EAA0F* MDOBEIPOEON; // 0x58
	::System::Action* NLOIDDNMFOP; // 0x60
	::UnityEngine::Collider* HGNKFKIBFGM; // 0x68
	::Class_1_D70A30D666F20D90* DKIHLDAOIPN; // 0x70
	::System::Int32 IINLNILNJCD; // 0x78
	::System::Boolean KCCHNDJMOKE; // 0x7C
	::System::Boolean BFCDDGNPFPC; // 0x7D
	::System::Boolean HEODKNPDLKG; // 0x7E
	::UnityEngine::RaycastHit HNMGAGFMIFN; // 0x80
	::System::Int32 OLHKBFJJDNJ; // 0xB0
	::UnityEngine::Vector3 LPNNBBFOIAD; // 0xB4
	::System::Boolean PMMIMFDJJMC; // 0xC0
	::System::Boolean KFMPCPBPLHA; // 0xC1
	::System::Int32 AJGAFBFBDEC; // 0xC4
	::UnityEngine::Vector3 KBCKIAMJKIF; // 0xC8
