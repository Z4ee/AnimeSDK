...
#define CLASS_2_523C55AEA55804D8_DISPOSE_OFFSET UNITYSDK_OFFSET(0x112CDE40)
#define CLASS_2_523C55AEA55804D8_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x112CF340)
#define CLASS_2_523C55AEA55804D8_METHOD_2_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x112D0BD0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_1C6AD2DA62FB6EB1_OFFSET UNITYSDK_OFFSET(0x112CFF90)
#define CLASS_2_523C55AEA55804D8_METHOD_2_1EBA51A89D5A0DB5_OFFSET UNITYSDK_OFFSET(0x112CDF30)
#define CLASS_2_523C55AEA55804D8_METHOD_2_1FFE4260A7179061_OFFSET UNITYSDK_OFFSET(0x112D0D20)
#define CLASS_2_523C55AEA55804D8_METHOD_2_299EFA4949973FDA_OFFSET UNITYSDK_OFFSET(0x112CEED0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_2A2B4A2E0BDAAF15_OFFSET UNITYSDK_OFFSET(0x112CECF0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_3A9BDB056AF13046_OFFSET UNITYSDK_OFFSET(0x112CF3C0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_3CAC93BF77250DAD_OFFSET UNITYSDK_OFFSET(0x112D0D00)
#define CLASS_2_523C55AEA55804D8_METHOD_2_4AB9012B5D01108B_OFFSET UNITYSDK_OFFSET(0x112D0A30)
#define CLASS_2_523C55AEA55804D8_METHOD_2_57D80B372834C5D1_OFFSET UNITYSDK_OFFSET(0x112CF660)
#define CLASS_2_523C55AEA55804D8_METHOD_2_595E641DF1B4387D_OFFSET UNITYSDK_OFFSET(0x112CED80)
#define CLASS_2_523C55AEA55804D8_METHOD_2_6516DD2B8C441001_OFFSET UNITYSDK_OFFSET(0x112CEA20)
#define CLASS_2_523C55AEA55804D8_METHOD_2_68A2CA32DC720C44_OFFSET UNITYSDK_OFFSET(0x112D0AE0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_7F5959D5B740D04C_OFFSET UNITYSDK_OFFSET(0x112CEC60)
#define CLASS_2_523C55AEA55804D8_METHOD_2_7FCED9DBE84C0CF1_OFFSET UNITYSDK_OFFSET(0x112CF870)
#define CLASS_2_523C55AEA55804D8_METHOD_2_8AE6DBB1ED054191_OFFSET UNITYSDK_OFFSET(0x112D0090)
#define CLASS_2_523C55AEA55804D8_METHOD_2_B1445E8504415D4D_OFFSET UNITYSDK_OFFSET(0x112D0D10)
#define CLASS_2_523C55AEA55804D8_METHOD_2_BE4EBC8FF4054312_OFFSET UNITYSDK_OFFSET(0x112CF2E0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_C0A2DE8417347362_OFFSET UNITYSDK_OFFSET(0x112CE450)
#define CLASS_2_523C55AEA55804D8_METHOD_2_C114A1F8E08B6F92_OFFSET UNITYSDK_OFFSET(0x112D0D60)
#define CLASS_2_523C55AEA55804D8_METHOD_2_C74CF020AA42ED85_1_OFFSET UNITYSDK_OFFSET(0x112D0DE0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x112D0D50)
#define CLASS_2_523C55AEA55804D8_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x112CF830)
#define CLASS_2_523C55AEA55804D8_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x112CF7F0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_CAE55D2F30F9F997_OFFSET UNITYSDK_OFFSET(0x112CF4C0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_CE18697B63E52504_OFFSET UNITYSDK_OFFSET(0x112D0D80)
#define CLASS_2_523C55AEA55804D8_METHOD_2_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x112CF6C0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x112CDD50)
#define CLASS_2_523C55AEA55804D8_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x112D0D70)
#define CLASS_2_523C55AEA55804D8_ONMODELROOTLOADED_OFFSET UNITYSDK_OFFSET(0x112CE800)
#define CLASS_2_523C55AEA55804D8_ONMODELROOTUNLOADED_OFFSET UNITYSDK_OFFSET(0x112CEBF0)
#define CLASS_2_523C55AEA55804D8__CCTOR_OFFSET UNITYSDK_OFFSET(0x112D0DF0)
#define CLASS_2_523C55AEA55804D8__CTOR_OFFSET UNITYSDK_OFFSET(0x112CDC90)
#define CLASS_2_523C55AEA55804D8___IFIXBASEPROXY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x112D0E20)

inline static constexpr unsigned int Class_2_523C55AEA55804D8_TypeDefinitionIndex = 53306;
...
public:
	...
	{
		return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_523C55AEA55804D8_TypeDefinitionIndex)->GetStaticField(0x16AC0);
	}
	static ::System::Boolean* StaticGet_Field_2_1()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_2_523C55AEA55804D8_TypeDefinitionIndex)->GetStaticField(0x8090);
	}
	// static const ::System::Single Field_2_2; // 0x0
	::System::Action_1<::RPG::GameCore::GameEntity*>* Field_2_3; // 0x18
	::Class_1_D70A30D666F20D90* Field_2_4; // 0x20
	::System::Action_2<::UnityEngine::Vector3, ::UnityEngine::Quaternion>* Field_2_5; // 0x28
	::UnityEngine::Collider* Field_2_6; // 0x30
	::Class_1_51EED7CD291B614D* Field_2_7; // 0x38
	::UnityEngine::Collider* Field_2_8; // 0x40
	::System::Action* Field_2_9; // 0x48
	::Class_0_16E4307DCC419505_531* Field_2_10; // 0x50
	::Class_3_2B2F6402EA3EAA0F* Field_2_11; // 0x58
	...
	::System::Boolean Field_2_18; // 0x7E
	::System::Int32 Field_2_19; // 0x80
	::UnityEngine::Vector3 Field_2_20; // 0x84
	::UnityEngine::Vector3 Field_2_21; // 0x90
	::UnityEngine::RaycastHit Field_2_22; // 0x9C
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_523C55AEA55804D8_METHOD_2_1C6AD2DA62FB6EB1_OFFSET))(this);
	}

	::System::Boolean Method_2_8AE6DBB1ED054191(::UnityEngine::Transform* a1, ::UnityEngine::Collider* a2, ::UnityEngine::RaycastHit& a3)
	{
		return ((::System::Boolean(*)(::PVOID, ::UnityEngine::Transform*, ::UnityEngine::Collider*, ::UnityEngine::RaycastHit&))((::PBYTE)hIl2Cpp + CLASS_2_523C55AEA55804D8_METHOD_2_8AE6DBB1ED054191_OFFSET))(this, a1, a2, a3);
	}
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + CLASS_2_523C55AEA55804D8___IFIXBASEPROXY_LATEUPDATE_OFFSET))(this, a1);
	}
};
