...
#define CLASS_2_8F87CA454309770C_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x15972FD0)
#define CLASS_2_8F87CA454309770C_GET_TRANS_OFFSET UNITYSDK_OFFSET(0x15972FF0)
#define CLASS_2_8F87CA454309770C_METHOD_2_2C825E716CE9F2F9_OFFSET UNITYSDK_OFFSET(0x15974120)
#define CLASS_2_8F87CA454309770C_METHOD_2_41CF9B9431532A25_OFFSET UNITYSDK_OFFSET(0x15973F70)
#define CLASS_2_8F87CA454309770C_METHOD_2_60BAB51FAB46DBD1_OFFSET UNITYSDK_OFFSET(0x15974420)
#define CLASS_2_8F87CA454309770C_METHOD_2_66CC9828DB1F478F_OFFSET UNITYSDK_OFFSET(0x15973030)
#define CLASS_2_8F87CA454309770C_METHOD_2_6FECEF220D41E8B2_OFFSET UNITYSDK_OFFSET(0x15974540)
#define CLASS_2_8F87CA454309770C_METHOD_2_9AFCA18B112F248A_OFFSET UNITYSDK_OFFSET(0x15974590)
#define CLASS_2_8F87CA454309770C_METHOD_2_AAD21DE195D05736_OFFSET UNITYSDK_OFFSET(0x15974330)
#define CLASS_2_8F87CA454309770C_METHOD_2_D24C4A2B6F179260_OFFSET UNITYSDK_OFFSET(0x159743D0)
#define CLASS_2_8F87CA454309770C_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x159744B0)
#define CLASS_2_8F87CA454309770C_METHOD_2_F978A1D172468895_OFFSET UNITYSDK_OFFSET(0x15974170)
#define CLASS_2_8F87CA454309770C_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x15972FE0)
#define CLASS_2_8F87CA454309770C__CTOR_OFFSET UNITYSDK_OFFSET(0x15974620)
#define CLASS_2_8F87CA454309770C__ONBIND_OFFSET UNITYSDK_OFFSET(0x15972DD0)
#define CLASS_2_8F87CA454309770C___INITVARONCE_G___COMPAREDISPLAYDATA_15_0_OFFSET UNITYSDK_OFFSET(0x15974650)

inline static constexpr unsigned int Class_2_8F87CA454309770C_TypeDefinitionIndex = 72252;

class Class_2_8F87CA454309770C : public ::Class_1_34917908B7833130
{
public:
	// static const ::System::String* DJCBDJMACFH; // 0x0
	// static const ::System::Int32 PEJOGHOICIF = 0x3; // 0x0
	::System::Collections::Generic::List_1<::Class_2_8F87CA454309770C_Struct_2_86083371450A3659>* EBMKFBAAHHI; // 0x60
	::UnityEngine::Animation* PMOJILOJEPE; // 0x68
	::UnityEngine::Transform* DEAFAEDMLDD; // 0x70
	::UnityEngine::Transform* JGJJEGGBKKB; // 0x78
	::UnityEngine::Transform* EFCOIBEANAJ; // 0x80
	::UnityEngine::UI::Button* NIDPJAFEHNM; // 0x88
	::RPG::Client::NodeListViewPanel_1<::Class_2_9B97BC1FA2EDDEBE*>* ACBHEJCJGDA; // 0x90
	::RPG::GameCore::LevelUIComponent* GEAHNEAGEBG; // 0x98
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::RogueTitanType, ::System::Collections::Generic::List_1<::System::UInt32>*>* BBGOINLDJPN; // 0xA0
	::System::Collections::Generic::List_1<::Class_2_8F87CA454309770C_Struct_2_86083371450A3659>* AEDAGAGGKFL; // 0xA8
