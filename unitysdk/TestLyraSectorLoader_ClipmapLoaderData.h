...
#define TESTLYRASECTORLOADER_CLIPMAPLOADERDATA_CHECKDEBUGVARIABLES_OFFSET UNITYSDK_OFFSET(0x1CEEB0B0)
#define TESTLYRASECTORLOADER_CLIPMAPLOADERDATA_CHECKDEBUGVARIABLE_OFFSET UNITYSDK_OFFSET(0x1CEEB630)
#define TESTLYRASECTORLOADER_CLIPMAPLOADERDATA_GET_ENABLE_OFFSET UNITYSDK_OFFSET(0x1CEEB610)
#define TESTLYRASECTORLOADER_CLIPMAPLOADERDATA_REMOVEASSETS_OFFSET UNITYSDK_OFFSET(0x1CEEB2A0)
#define TESTLYRASECTORLOADER_CLIPMAPLOADERDATA_RESET_OFFSET UNITYSDK_OFFSET(0x1CEE8C30)
#define TESTLYRASECTORLOADER_CLIPMAPLOADERDATA_SET_ENABLE_OFFSET UNITYSDK_OFFSET(0x1CEEB620)
#define TESTLYRASECTORLOADER_CLIPMAPLOADERDATA_UPDATE_OFFSET UNITYSDK_OFFSET(0x1CEE8E10)
#define TESTLYRASECTORLOADER_CLIPMAPLOADERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEE8A70)

inline static constexpr unsigned int TestLyraSectorLoader_ClipmapLoaderData_TypeDefinitionIndex = 26871;

class TestLyraSectorLoader_ClipmapLoaderData : public ::System::Object
{
public:
	::System::Collections::Generic::Dictionary_2<::LyraSector::LyraSectorCoord, ::LyraSector::LyraPackedAsset*>* m_LoadedPackedAssets; // 0x10
	::System::Threading::Mutex* m_Mutex; // 0x18
	::System::String* m_SectorSceneVoxelAssetPathFormat; // 0x20
	::System::Collections::Generic::HashSet_1<::LyraSector::LyraSectorCoord>* m_LoadedCoords; // 0x28
	::System::String* m_SsectorDistanceFieldAssetPathFormat; // 0x30
	::System::Collections::Generic::List_1<::LyraSector::LyraSectorCoord>* m_UnloadCoords; // 0x38
	::TestLyraSectorLoader* m_LyraLoader; // 0x40
	::Il2CppArray<::LyraSector::LyraSectorCoord>* m_CachedLoadedCoordsArray; // 0x48
	::System::Boolean m_ForceFullUpdate; // 0x50
	::System::Boolean m_Enabled; // 0x51
	::System::Int32 m_ForceFullUpdateID; // 0x54
	::System::Boolean m_IsForDistanceField; // 0x58
	::System::Boolean m_EnableDebugView; // 0x59
	::System::Boolean m_CachedLoadedCoordsArrayDirty; // 0x5A
	::System::Int32 m_VisualizeModeID; // 0x5C
