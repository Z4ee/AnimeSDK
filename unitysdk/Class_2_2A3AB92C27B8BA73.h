...
#define CLASS_2_2A3AB92C27B8BA73_DISPOSE_OFFSET UNITYSDK_OFFSET(0x145120E0)
#define CLASS_2_2A3AB92C27B8BA73_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x14512120)
#define CLASS_2_2A3AB92C27B8BA73_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x145122C0)
#define CLASS_2_2A3AB92C27B8BA73_TICK_OFFSET UNITYSDK_OFFSET(0x14512310)
#define CLASS_2_2A3AB92C27B8BA73__CTOR_OFFSET UNITYSDK_OFFSET(0x145120D0)

inline static constexpr unsigned int Class_2_2A3AB92C27B8BA73_TypeDefinitionIndex = 54441;

class Class_2_2A3AB92C27B8BA73 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::OverrideWaveMonsterPerform* Field_2_1; // 0x20
