...
#define CLASS_2_2A3AB92C27B8BA73_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16D95E90)
#define CLASS_2_2A3AB92C27B8BA73_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16D95ED0)
#define CLASS_2_2A3AB92C27B8BA73_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x16D96070)
#define CLASS_2_2A3AB92C27B8BA73_TICK_OFFSET UNITYSDK_OFFSET(0x16D960C0)
#define CLASS_2_2A3AB92C27B8BA73__CTOR_OFFSET UNITYSDK_OFFSET(0x16D95E80)

inline static constexpr unsigned int Class_2_2A3AB92C27B8BA73_TypeDefinitionIndex = 58395;

class Class_2_2A3AB92C27B8BA73 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::OverrideWaveMonsterPerform* OFKGLJOAMLD; // 0x18
