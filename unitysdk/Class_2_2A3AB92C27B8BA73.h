...
#define CLASS_2_2A3AB92C27B8BA73_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16F2CF20)
#define CLASS_2_2A3AB92C27B8BA73_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16F2CF60)
#define CLASS_2_2A3AB92C27B8BA73_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x16F2D100)
#define CLASS_2_2A3AB92C27B8BA73_TICK_OFFSET UNITYSDK_OFFSET(0x16F2D150)
#define CLASS_2_2A3AB92C27B8BA73__CTOR_OFFSET UNITYSDK_OFFSET(0x16F2CF10)

inline static constexpr unsigned int Class_2_2A3AB92C27B8BA73_TypeDefinitionIndex = 55664;
