...
#define CLASS_1_4B9E24425867FD7E_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1CD7BB60)
#define CLASS_1_4B9E24425867FD7E_CLONE_OFFSET UNITYSDK_OFFSET(0x1CD7B500)
#define CLASS_1_4B9E24425867FD7E_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1CD7B640)
#define CLASS_1_4B9E24425867FD7E_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CD7B5E0)
#define CLASS_1_4B9E24425867FD7E_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CD7B7B0)
#define CLASS_1_4B9E24425867FD7E_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1CD7BD40)
#define CLASS_1_4B9E24425867FD7E_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1CD7BCB0)
#define CLASS_1_4B9E24425867FD7E_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1CD7B2E0)
#define CLASS_1_4B9E24425867FD7E_METHOD_1_3BDC77F20CA26C81_OFFSET UNITYSDK_OFFSET(0x1CD7B580)
#define CLASS_1_4B9E24425867FD7E_METHOD_1_8380E7BF9C2E481D_OFFSET UNITYSDK_OFFSET(0x1CD7B590)
#define CLASS_1_4B9E24425867FD7E_METHOD_1_AA645B8654F862A0_OFFSET UNITYSDK_OFFSET(0x1CD7B570)
#define CLASS_1_4B9E24425867FD7E_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1CD7B560)
#define CLASS_1_4B9E24425867FD7E_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1CD7B550)
#define CLASS_1_4B9E24425867FD7E_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1CD7B340)
#define CLASS_1_4B9E24425867FD7E_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1CD7B930)
#define CLASS_1_4B9E24425867FD7E_WRITETO_OFFSET UNITYSDK_OFFSET(0x1CD7B990)
#define CLASS_1_4B9E24425867FD7E__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CD7BFE0)
#define CLASS_1_4B9E24425867FD7E__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CD7B3E0)
#define CLASS_1_4B9E24425867FD7E__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD7B350)

inline static constexpr unsigned int Class_1_4B9E24425867FD7E_TypeDefinitionIndex = 24513;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_4B9E24425867FD7E*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4B9E24425867FD7E_TypeDefinitionIndex)->GetStaticField(0x2DC20);
	}
	static ::Google::Protobuf::Collections::MapField_2_Codec<::System::String*, ::Class_1_D17272E82AE804C2_20*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::Collections::MapField_2_Codec<::System::String*, ::Class_1_D17272E82AE804C2_20*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4B9E24425867FD7E_TypeDefinitionIndex)->GetStaticField(0x2DC28);
	}
	// static const ::System::Int32 Field_1_2 = 0x1; // 0x0
	// static const ::System::Int32 Field_1_3 = 0x2; // 0x0
	// static const ::System::Int32 Field_1_4 = 0x3; // 0x0
	::Google::Protobuf::ByteString* Field_1_5; // 0x10
	::Google::Protobuf::UnknownFieldSet* Field_1_6; // 0x18
	::Google::Protobuf::Collections::MapField_2<::System::String*, ::Class_1_D17272E82AE804C2_20*>* Field_1_7; // 0x20
