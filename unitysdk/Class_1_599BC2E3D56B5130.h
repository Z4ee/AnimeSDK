...
#define CLASS_1_599BC2E3D56B5130__CTOR_OFFSET UNITYSDK_OFFSET(0x1C638C50)
...
public:
	...
	::System::Boolean CKECINOEDKI; // 0x28
	::System::Boolean POHEIGDPBBO; // 0x29
	::System::Boolean HHOGEGIGHPM; // 0x2A
