...
#define AIRSHIPSUBWAYSCHEDULE_METHOD_3_4B967A5E70FF7EE4_OFFSET UNITYSDK_OFFSET(0x10BF8FC0)
#define AIRSHIPSUBWAYSCHEDULE_METHOD_3_7B423B7C669FCA6E_OFFSET UNITYSDK_OFFSET(0x10BF8AC0)
#define AIRSHIPSUBWAYSCHEDULE_METHOD_3_BA7BA85FBE4A1104_OFFSET UNITYSDK_OFFSET(0x10BF8F40)
#define AIRSHIPSUBWAYSCHEDULE_METHOD_3_D20FD81754C01453_OFFSET UNITYSDK_OFFSET(0x10BF90C0)
#define AIRSHIPSUBWAYSCHEDULE_METHOD_3_F34661EBA0A0A425_OFFSET UNITYSDK_OFFSET(0x10BF8D60)
#define AIRSHIPSUBWAYSCHEDULE__CTOR_OFFSET UNITYSDK_OFFSET(0x10BF9110)

inline static constexpr unsigned int AirShipSubwaySchedule_TypeDefinitionIndex = 38019;
