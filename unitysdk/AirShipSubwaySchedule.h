...
#define AIRSHIPSUBWAYSCHEDULE_METHOD_3_4B967A5E70FF7EE4_OFFSET UNITYSDK_OFFSET(0x13979C30)
#define AIRSHIPSUBWAYSCHEDULE_METHOD_3_5591F7FC72D87A0E_OFFSET UNITYSDK_OFFSET(0x13979D30)
#define AIRSHIPSUBWAYSCHEDULE_METHOD_3_7FF186C33A48A21A_OFFSET UNITYSDK_OFFSET(0x13979610)
#define AIRSHIPSUBWAYSCHEDULE_METHOD_3_858C6261DBD00141_OFFSET UNITYSDK_OFFSET(0x139799C0)
#define AIRSHIPSUBWAYSCHEDULE_METHOD_3_BA7BA85FBE4A1104_OFFSET UNITYSDK_OFFSET(0x13979BB0)
#define AIRSHIPSUBWAYSCHEDULE__CTOR_OFFSET UNITYSDK_OFFSET(0x13979D80)

inline static constexpr unsigned int AirShipSubwaySchedule_TypeDefinitionIndex = 44443;
