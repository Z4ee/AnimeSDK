...
#define AIRSHIPSUBWAYSCHEDULE_METHOD_3_4B967A5E70FF7EE4_OFFSET UNITYSDK_OFFSET(0x1596AA40)
#define AIRSHIPSUBWAYSCHEDULE_METHOD_3_5591F7FC72D87A0E_OFFSET UNITYSDK_OFFSET(0x1596AB40)
#define AIRSHIPSUBWAYSCHEDULE_METHOD_3_7FF186C33A48A21A_OFFSET UNITYSDK_OFFSET(0x1596A3C0)
#define AIRSHIPSUBWAYSCHEDULE_METHOD_3_858C6261DBD00141_OFFSET UNITYSDK_OFFSET(0x1596A7D0)
#define AIRSHIPSUBWAYSCHEDULE_METHOD_3_BA7BA85FBE4A1104_OFFSET UNITYSDK_OFFSET(0x1596A9C0)
#define AIRSHIPSUBWAYSCHEDULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1596AB90)
