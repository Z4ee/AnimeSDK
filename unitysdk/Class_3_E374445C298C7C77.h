...
#define CLASS_3_E374445C298C7C77_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1581DFD0)
#define CLASS_3_E374445C298C7C77_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1581E020)
#define CLASS_3_E374445C298C7C77_TICK_OFFSET UNITYSDK_OFFSET(0x1581E070)
#define CLASS_3_E374445C298C7C77__CTOR_OFFSET UNITYSDK_OFFSET(0x1581DFA0)
