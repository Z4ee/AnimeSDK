...
#define CLASS_3_592B6E2EB5A4002E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x178296B0)
#define CLASS_3_592B6E2EB5A4002E_METHOD_3_3D8F0F1C6E55B9B6_OFFSET UNITYSDK_OFFSET(0x17829B90)
#define CLASS_3_592B6E2EB5A4002E_METHOD_3_8F25DA58F977E86D_OFFSET UNITYSDK_OFFSET(0x178298E0)
#define CLASS_3_592B6E2EB5A4002E_METHOD_3_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x17829B00)
#define CLASS_3_592B6E2EB5A4002E_METHOD_3_E460F04F840ABD8A_OFFSET UNITYSDK_OFFSET(0x17829F50)
#define CLASS_3_592B6E2EB5A4002E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17829700)
#define CLASS_3_592B6E2EB5A4002E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17829BE0)
#define CLASS_3_592B6E2EB5A4002E_TICK_OFFSET UNITYSDK_OFFSET(0x17829C80)
#define CLASS_3_592B6E2EB5A4002E__CCTOR_OFFSET UNITYSDK_OFFSET(0x1782A020)
#define CLASS_3_592B6E2EB5A4002E__CTOR_OFFSET UNITYSDK_OFFSET(0x178295F0)
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_3_592B6E2EB5A4002E_TypeDefinitionIndex)->GetStaticField(0x13500);
	}
	::RPG::GameCore::AdventureAbilityComponent* PCDEEAAIFPK; // 0x28
	::Class_2_19E76B515E7B257C* IKGBNADHLNA; // 0x30
