...
#define VOLUMETRICCLOUDBLITPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A711D30)
#define VOLUMETRICCLOUDBLITPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1A712140)
#define VOLUMETRICCLOUDBLITPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x1A711C30)
#define VOLUMETRICCLOUDBLITPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A711B20)
#define VOLUMETRICCLOUDBLITPASS___BASE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1A712190)

inline static constexpr unsigned int VolumetricCloudBlitPass_TypeDefinitionIndex = 29614;
...
public:
	...
	::UnityEngine::Rendering::Universal::VolumetricCloudConfig* m_CloudConfig; // 0xB0
	::UnityEngine::Material* cloudSampleMat; // 0xB8
	::System::Boolean m_NeedVolumetricCloudBlit; // 0xC0
	::System::Boolean m_NeedVolumetricMistBlit; // 0xC1
