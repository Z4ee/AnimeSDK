...
#define CLASS_1_5B567C8A01BAEDFE_1_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19FC9EB0)
#define CLASS_1_5B567C8A01BAEDFE_1_CLONE_OFFSET UNITYSDK_OFFSET(0x19FC9CC0)
#define CLASS_1_5B567C8A01BAEDFE_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19FC9DC0)
#define CLASS_1_5B567C8A01BAEDFE_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x19FC9D30)
#define CLASS_1_5B567C8A01BAEDFE_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19FC9E10)
#define CLASS_1_5B567C8A01BAEDFE_1_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19FC9F00)
#define CLASS_1_5B567C8A01BAEDFE_1_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19FC9ED0)
#define CLASS_1_5B567C8A01BAEDFE_1_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19FC9C10)
#define CLASS_1_5B567C8A01BAEDFE_1_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19FC9C70)
#define CLASS_1_5B567C8A01BAEDFE_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19FC9E40)
#define CLASS_1_5B567C8A01BAEDFE_1_WRITETO_OFFSET UNITYSDK_OFFSET(0x19FC9EA0)
#define CLASS_1_5B567C8A01BAEDFE_1__CCTOR_OFFSET UNITYSDK_OFFSET(0x19FC9F50)
#define CLASS_1_5B567C8A01BAEDFE_1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19FC9C90)
#define CLASS_1_5B567C8A01BAEDFE_1__CTOR_OFFSET UNITYSDK_OFFSET(0x19FC9C80)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_1_TypeDefinitionIndex = 24265;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_1_TypeDefinitionIndex)->GetStaticField(0xFA80);
	}
