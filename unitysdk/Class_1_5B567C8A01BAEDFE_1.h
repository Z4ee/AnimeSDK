...
#define CLASS_1_5B567C8A01BAEDFE_1_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DF23C00)
#define CLASS_1_5B567C8A01BAEDFE_1_CLONE_OFFSET UNITYSDK_OFFSET(0x1DF238A0)
#define CLASS_1_5B567C8A01BAEDFE_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DF23A00)
#define CLASS_1_5B567C8A01BAEDFE_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DF23910)
#define CLASS_1_5B567C8A01BAEDFE_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DF23B60)
#define CLASS_1_5B567C8A01BAEDFE_1_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DF23C50)
#define CLASS_1_5B567C8A01BAEDFE_1_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DF23C20)
#define CLASS_1_5B567C8A01BAEDFE_1_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1DF237F0)
#define CLASS_1_5B567C8A01BAEDFE_1_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DF23850)
#define CLASS_1_5B567C8A01BAEDFE_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DF23B90)
#define CLASS_1_5B567C8A01BAEDFE_1_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DF23BF0)
#define CLASS_1_5B567C8A01BAEDFE_1__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DF23CA0)
#define CLASS_1_5B567C8A01BAEDFE_1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DF23870)
#define CLASS_1_5B567C8A01BAEDFE_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF23860)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_1_TypeDefinitionIndex = 25347;

class Class_1_5B567C8A01BAEDFE_1 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_1*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_1_TypeDefinitionIndex)->GetStaticField(0x41AA0);
	}
