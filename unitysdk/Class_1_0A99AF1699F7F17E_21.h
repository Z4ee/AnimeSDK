...
#define CLASS_1_0A99AF1699F7F17E_21_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E433F90)
#define CLASS_1_0A99AF1699F7F17E_21_CLONE_OFFSET UNITYSDK_OFFSET(0x1E433B70)
#define CLASS_1_0A99AF1699F7F17E_21_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E433CF0)
#define CLASS_1_0A99AF1699F7F17E_21_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E433BB0)
#define CLASS_1_0A99AF1699F7F17E_21_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E433E10)
#define CLASS_1_0A99AF1699F7F17E_21_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E4340D0)
#define CLASS_1_0A99AF1699F7F17E_21_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E434030)
#define CLASS_1_0A99AF1699F7F17E_21_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E433A60)
#define CLASS_1_0A99AF1699F7F17E_21_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x1E433BA0)
#define CLASS_1_0A99AF1699F7F17E_21_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E433A90)
#define CLASS_1_0A99AF1699F7F17E_21_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E433E80)
#define CLASS_1_0A99AF1699F7F17E_21_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E433EE0)
#define CLASS_1_0A99AF1699F7F17E_21__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E434290)
#define CLASS_1_0A99AF1699F7F17E_21__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E433AE0)
#define CLASS_1_0A99AF1699F7F17E_21__CTOR_OFFSET UNITYSDK_OFFSET(0x1E433AA0)

inline static constexpr unsigned int Class_1_0A99AF1699F7F17E_21_TypeDefinitionIndex = 30058;

class Class_1_0A99AF1699F7F17E_21 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_0A99AF1699F7F17E_21*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_0A99AF1699F7F17E_21*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0A99AF1699F7F17E_21_TypeDefinitionIndex)->GetStaticField(0x3DB30);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_BB2C29D4BF2DA1E4*>** StaticGet_JPGOOEBDHCN()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_BB2C29D4BF2DA1E4*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0A99AF1699F7F17E_21_TypeDefinitionIndex)->GetStaticField(0x3DB38);
	}
	// static const ::System::Int32 BIIMBGOFABJ = 0xF; // 0x0
