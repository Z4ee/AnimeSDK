...
#define CLASS_2_BE8370BD8350540C_GET_ABILITYID_OFFSET UNITYSDK_OFFSET(0x162A4BE0)
#define CLASS_2_BE8370BD8350540C_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x162A4BC0)
#define CLASS_2_BE8370BD8350540C_METHOD_2_1EA3754039AA10DF_OFFSET UNITYSDK_OFFSET(0x162A4590)
#define CLASS_2_BE8370BD8350540C_METHOD_2_30A2382C3FCC5386_OFFSET UNITYSDK_OFFSET(0x162A44F0)
#define CLASS_2_BE8370BD8350540C_METHOD_2_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0x162A48F0)
#define CLASS_2_BE8370BD8350540C_METHOD_2_735EE20B25F86BF4_OFFSET UNITYSDK_OFFSET(0x162A4390)
#define CLASS_2_BE8370BD8350540C_METHOD_2_A56385E6706FA723_OFFSET UNITYSDK_OFFSET(0x162A4230)
#define CLASS_2_BE8370BD8350540C_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x162A4550)
#define CLASS_2_BE8370BD8350540C_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x162A4210)
#define CLASS_2_BE8370BD8350540C_SET_ABILITYID_OFFSET UNITYSDK_OFFSET(0x162A4BF0)
#define CLASS_2_BE8370BD8350540C_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x162A4BD0)
#define CLASS_2_BE8370BD8350540C__CTOR_OFFSET UNITYSDK_OFFSET(0x162A3E40)

inline static constexpr unsigned int Class_2_BE8370BD8350540C_TypeDefinitionIndex = 77242;

class Class_2_BE8370BD8350540C : public ::Class_1_5332742A7B058447
{
public:
	::RPG::GameCore::ChenLingFesLevelAbilityConfig* _Config_k__BackingField; // 0x18
	::Class_3_07C3C4D2990C49EE* GEAKNAPJGFD; // 0x20
	::Class_3_07C3C4D2990C49EE* EELHJCEEBNC; // 0x28
	::Class_3_07C3C4D2990C49EE* EFMKPFCEKCL; // 0x30
	::Class_3_07C3C4D2990C49EE* LEOIENNPNLP; // 0x38
	::Class_2_5436AF4270279182* EENKEBPDHCN; // 0x40
	::System::Int32 _AbilityID_k__BackingField; // 0x48
	::System::Single MMOCIIJHFHL; // 0x4C
	::System::Single DAFAMCIPHDE; // 0x50
	::System::Single OFDKFNDPEAL; // 0x54
	::System::Single PJCPJFBOPEA; // 0x58
