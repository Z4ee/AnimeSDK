...
#define SPINE_RGBTIMELINE_APPLY_OFFSET UNITYSDK_OFFSET(0x183A9730)
#define SPINE_RGBTIMELINE_GET_FRAMEENTRIES_OFFSET UNITYSDK_OFFSET(0x183A9660)
#define SPINE_RGBTIMELINE_GET_SLOTINDEX_OFFSET UNITYSDK_OFFSET(0x183A9670)
#define SPINE_RGBTIMELINE_SETFRAME_OFFSET UNITYSDK_OFFSET(0x183A9680)
#define SPINE_RGBTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x183A9550)

namespace Spine
{
	inline static constexpr unsigned int RGBTimeline_TypeDefinitionIndex = 30656;
