...
#define SPINE_RGBTIMELINE_APPLY_OFFSET UNITYSDK_OFFSET(0x1C3CACB0)
#define SPINE_RGBTIMELINE_GET_FRAMEENTRIES_OFFSET UNITYSDK_OFFSET(0x1C3CABE0)
#define SPINE_RGBTIMELINE_GET_SLOTINDEX_OFFSET UNITYSDK_OFFSET(0x1C3CABF0)
#define SPINE_RGBTIMELINE_SETFRAME_OFFSET UNITYSDK_OFFSET(0x1C3CAC00)
#define SPINE_RGBTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3CAB00)

namespace Spine
{
	inline static constexpr unsigned int RGBTimeline_TypeDefinitionIndex = 31268;
