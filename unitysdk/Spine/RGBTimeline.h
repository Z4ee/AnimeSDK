...
#define SPINE_RGBTIMELINE_APPLY_OFFSET UNITYSDK_OFFSET(0x1FAECBF0)
#define SPINE_RGBTIMELINE_GET_FRAMEENTRIES_OFFSET UNITYSDK_OFFSET(0x1FAECB20)
#define SPINE_RGBTIMELINE_GET_SLOTINDEX_OFFSET UNITYSDK_OFFSET(0x1FAECB30)
#define SPINE_RGBTIMELINE_SETFRAME_OFFSET UNITYSDK_OFFSET(0x1FAECB40)
#define SPINE_RGBTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1FAECA40)

namespace Spine
{
	inline static constexpr unsigned int RGBTimeline_TypeDefinitionIndex = 33454;
