...
#define SPINE_RGBATIMELINE_APPLY_OFFSET UNITYSDK_OFFSET(0x183A8DA0)
#define SPINE_RGBATIMELINE_GET_FRAMEENTRIES_OFFSET UNITYSDK_OFFSET(0x183A8CB0)
#define SPINE_RGBATIMELINE_GET_SLOTINDEX_OFFSET UNITYSDK_OFFSET(0x183A8CC0)
#define SPINE_RGBATIMELINE_SETFRAME_OFFSET UNITYSDK_OFFSET(0x183A8CD0)
#define SPINE_RGBATIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x183A8B40)

namespace Spine
{
	inline static constexpr unsigned int RGBATimeline_TypeDefinitionIndex = 30655;
