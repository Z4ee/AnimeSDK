...
#define SPINE_ATTACHMENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19DD3860)
#define SPINE_ATTACHMENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19DD38E0)
#define SPINE_ATTACHMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19DD38C0)
#define SPINE_ATTACHMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19DD3870)

namespace Spine
{
	inline static constexpr unsigned int Attachment_TypeDefinitionIndex = 36412;
