...
#define SPINE_SKELETONLOADER_LINKEDMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1479F6D0)

namespace Spine
{
	inline static constexpr unsigned int SkeletonLoader_LinkedMesh_TypeDefinitionIndex = 37539;

	class SkeletonLoader_LinkedMesh : public ::System::Object
	{
	public:
		::Spine::MeshAttachment* mesh; // 0x10
		::System::String* parent; // 0x18
