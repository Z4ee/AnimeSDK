...
#define SPINE_SKELETONLOADER_LINKEDMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5FEC80)

namespace Spine
{
	inline static constexpr unsigned int SkeletonLoader_LinkedMesh_TypeDefinitionIndex = 38398;
