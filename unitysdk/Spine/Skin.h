...
#define SPINE_SKIN_ADDSKIN_OFFSET UNITYSDK_OFFSET(0x1AC98CE0)
#define SPINE_SKIN_ATTACHALL_OFFSET UNITYSDK_OFFSET(0x1AC67520)
#define SPINE_SKIN_CLEAR_OFFSET UNITYSDK_OFFSET(0x1AC997F0)
#define SPINE_SKIN_COPYSKIN_OFFSET UNITYSDK_OFFSET(0x1AC990E0)
#define SPINE_SKIN_GETATTACHMENTS_OFFSET UNITYSDK_OFFSET(0x1AC995D0)
#define SPINE_SKIN_GETATTACHMENT_OFFSET UNITYSDK_OFFSET(0x1AC67750)
#define SPINE_SKIN_GET_ATTACHMENTS_OFFSET UNITYSDK_OFFSET(0x1AC66650)
#define SPINE_SKIN_GET_BONES_OFFSET UNITYSDK_OFFSET(0x1AC98BA0)
#define SPINE_SKIN_GET_CONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1AC98BB0)
#define SPINE_SKIN_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1AC98B90)
#define SPINE_SKIN_REMOVEATTACHMENT_OFFSET UNITYSDK_OFFSET(0x1AC99570)
#define SPINE_SKIN_SETATTACHMENT_OFFSET UNITYSDK_OFFSET(0x1AC75800)
#define SPINE_SKIN_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AC998C0)
#define SPINE_SKIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC74810)

namespace Spine
{
	inline static constexpr unsigned int Skin_TypeDefinitionIndex = 36758;
