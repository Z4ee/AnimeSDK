...
#define SPINE_SKIN_ADDSKIN_OFFSET UNITYSDK_OFFSET(0x147C2360)
#define SPINE_SKIN_ATTACHALL_OFFSET UNITYSDK_OFFSET(0x1478DFF0)
#define SPINE_SKIN_CLEAR_OFFSET UNITYSDK_OFFSET(0x147C2DF0)
#define SPINE_SKIN_COPYSKIN_OFFSET UNITYSDK_OFFSET(0x147C26B0)
#define SPINE_SKIN_GETATTACHMENTS_OFFSET UNITYSDK_OFFSET(0x147C2BD0)
#define SPINE_SKIN_GETATTACHMENT_OFFSET UNITYSDK_OFFSET(0x1478E220)
#define SPINE_SKIN_GET_ATTACHMENTS_OFFSET UNITYSDK_OFFSET(0x1478D060)
#define SPINE_SKIN_GET_BONES_OFFSET UNITYSDK_OFFSET(0x147C2220)
#define SPINE_SKIN_GET_CONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x147C2230)
#define SPINE_SKIN_GET_NAME_OFFSET UNITYSDK_OFFSET(0x147C2210)
#define SPINE_SKIN_REMOVEATTACHMENT_OFFSET UNITYSDK_OFFSET(0x147C2B70)
#define SPINE_SKIN_SETATTACHMENT_OFFSET UNITYSDK_OFFSET(0x1479E9D0)
#define SPINE_SKIN_TOSTRING_OFFSET UNITYSDK_OFFSET(0x147C2EC0)
#define SPINE_SKIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1479D570)

namespace Spine
{
	inline static constexpr unsigned int Skin_TypeDefinitionIndex = 37540;
