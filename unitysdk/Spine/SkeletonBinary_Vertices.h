...
#define SPINE_SKELETONBINARY_VERTICES__CTOR_OFFSET UNITYSDK_OFFSET(0x19DFA3C0)

namespace Spine
{
	inline static constexpr unsigned int SkeletonBinary_Vertices_TypeDefinitionIndex = 36449;
