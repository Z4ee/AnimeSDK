...
#define SPINE_SKELETONBINARY_VERTICES__CTOR_OFFSET UNITYSDK_OFFSET(0x183BF810)

namespace Spine
{
	inline static constexpr unsigned int SkeletonBinary_Vertices_TypeDefinitionIndex = 30729;
