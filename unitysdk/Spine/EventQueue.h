...
#define SPINE_EVENTQUEUE_ADD_ANIMATIONSCHANGED_OFFSET UNITYSDK_OFFSET(0x1AC55960)
#define SPINE_EVENTQUEUE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1AC4CCA0)
#define SPINE_EVENTQUEUE_COMPLETE_OFFSET UNITYSDK_OFFSET(0x1AC4AD50)
#define SPINE_EVENTQUEUE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AC4C420)
#define SPINE_EVENTQUEUE_DRAIN_OFFSET UNITYSDK_OFFSET(0x1AC47E40)
#define SPINE_EVENTQUEUE_END_OFFSET UNITYSDK_OFFSET(0x1AC47B20)
#define SPINE_EVENTQUEUE_EVENT_OFFSET UNITYSDK_OFFSET(0x1AC4ACD0)
#define SPINE_EVENTQUEUE_INTERRUPT_OFFSET UNITYSDK_OFFSET(0x1AC4B300)
#define SPINE_EVENTQUEUE_REMOVE_ANIMATIONSCHANGED_OFFSET UNITYSDK_OFFSET(0x1AC559C0)
#define SPINE_EVENTQUEUE_START_OFFSET UNITYSDK_OFFSET(0x1AC4B380)
#define SPINE_EVENTQUEUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC471C0)

namespace Spine
{
	inline static constexpr unsigned int EventQueue_TypeDefinitionIndex = 36694;
