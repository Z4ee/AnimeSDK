...
#define SPINE_MATHUTILS_ATAN2_OFFSET UNITYSDK_OFFSET(0x1D954790)
#define SPINE_MATHUTILS_CLAMP_OFFSET UNITYSDK_OFFSET(0x1D9547B0)
#define SPINE_MATHUTILS_COSDEG_OFFSET UNITYSDK_OFFSET(0x1D954770)
#define SPINE_MATHUTILS_COS_OFFSET UNITYSDK_OFFSET(0x1D954730)
#define SPINE_MATHUTILS_RANDOMTRIANGLE_1_OFFSET UNITYSDK_OFFSET(0x1D954980)
#define SPINE_MATHUTILS_RANDOMTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1D9547D0)
#define SPINE_MATHUTILS_SINDEG_OFFSET UNITYSDK_OFFSET(0x1D954750)
#define SPINE_MATHUTILS_SIN_OFFSET UNITYSDK_OFFSET(0x1D954710)
#define SPINE_MATHUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D954AC0)

namespace Spine
{
	inline static constexpr unsigned int MathUtils_TypeDefinitionIndex = 32881;
	...
	public:
		...
		{
			return (::System::Random**)Il2CppClass::FromTypeDefinitionIndex(MathUtils_TypeDefinitionIndex)->GetStaticField(0x271F0);
		}
