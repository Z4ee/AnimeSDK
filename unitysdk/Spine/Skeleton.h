...
#define SPINE_SKELETON_FINDBONE_OFFSET UNITYSDK_OFFSET(0x1AC670F0)
#define SPINE_SKELETON_FINDIKCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1AC67B10)
#define SPINE_SKELETON_FINDPATHCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1AC67D50)
#define SPINE_SKELETON_FINDSLOT_OFFSET UNITYSDK_OFFSET(0x1AC67210)
#define SPINE_SKELETON_FINDTRANSFORMCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1AC67C30)
#define SPINE_SKELETON_GETATTACHMENT_1_OFFSET UNITYSDK_OFFSET(0x1AC49E50)
#define SPINE_SKELETON_GETATTACHMENT_OFFSET UNITYSDK_OFFSET(0x1AC677E0)
#define SPINE_SKELETON_GETBOUNDS_OFFSET UNITYSDK_OFFSET(0x1AC67E70)
#define SPINE_SKELETON_GET_A_OFFSET UNITYSDK_OFFSET(0x1AC63CB0)
#define SPINE_SKELETON_GET_BONES_OFFSET UNITYSDK_OFFSET(0x1AC639C0)
#define SPINE_SKELETON_GET_B_OFFSET UNITYSDK_OFFSET(0x1AC63C90)
#define SPINE_SKELETON_GET_DATA_OFFSET UNITYSDK_OFFSET(0x1AC639B0)
#define SPINE_SKELETON_GET_DRAWORDER_OFFSET UNITYSDK_OFFSET(0x1AC639F0)
#define SPINE_SKELETON_GET_FLIPX_OFFSET UNITYSDK_OFFSET(0x1AC63D40)
#define SPINE_SKELETON_GET_FLIPY_OFFSET UNITYSDK_OFFSET(0x1AC63D90)
#define SPINE_SKELETON_GET_G_OFFSET UNITYSDK_OFFSET(0x1AC63C70)
#define SPINE_SKELETON_GET_IKCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1AC63A00)
#define SPINE_SKELETON_GET_PATHCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1AC63A10)
#define SPINE_SKELETON_GET_ROOTBONE_OFFSET UNITYSDK_OFFSET(0x1AC63DE0)
#define SPINE_SKELETON_GET_R_OFFSET UNITYSDK_OFFSET(0x1AC63C50)
#define SPINE_SKELETON_GET_SCALEX_OFFSET UNITYSDK_OFFSET(0x1AC63D10)
#define SPINE_SKELETON_GET_SCALEY_OFFSET UNITYSDK_OFFSET(0x1AC52670)
#define SPINE_SKELETON_GET_SKIN_OFFSET UNITYSDK_OFFSET(0x1AC63A30)
#define SPINE_SKELETON_GET_SLOTS_OFFSET UNITYSDK_OFFSET(0x1AC639E0)
#define SPINE_SKELETON_GET_TRANSFORMCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1AC63A20)
#define SPINE_SKELETON_GET_UPDATECACHELIST_OFFSET UNITYSDK_OFFSET(0x1AC639D0)
#define SPINE_SKELETON_GET_X_OFFSET UNITYSDK_OFFSET(0x1AC63CD0)
#define SPINE_SKELETON_GET_Y_OFFSET UNITYSDK_OFFSET(0x1AC63CF0)
#define SPINE_SKELETON_SETATTACHMENT_OFFSET UNITYSDK_OFFSET(0x1AC67930)
#define SPINE_SKELETON_SETBONESTOSETUPPOSE_OFFSET UNITYSDK_OFFSET(0x1AC66CC0)
#define SPINE_SKELETON_SETSKIN_1_OFFSET UNITYSDK_OFFSET(0x1AC63A50)
#define SPINE_SKELETON_SETSKIN_OFFSET UNITYSDK_OFFSET(0x1AC67330)
#define SPINE_SKELETON_SETSLOTSTOSETUPPOSE_OFFSET UNITYSDK_OFFSET(0x1AC66F60)
#define SPINE_SKELETON_SETTOSETUPPOSE_OFFSET UNITYSDK_OFFSET(0x1AC66CA0)
#define SPINE_SKELETON_SET_A_OFFSET UNITYSDK_OFFSET(0x1AC63CC0)
#define SPINE_SKELETON_SET_B_OFFSET UNITYSDK_OFFSET(0x1AC63CA0)
#define SPINE_SKELETON_SET_FLIPX_OFFSET UNITYSDK_OFFSET(0x1AC63D50)
#define SPINE_SKELETON_SET_FLIPY_OFFSET UNITYSDK_OFFSET(0x1AC63DA0)
#define SPINE_SKELETON_SET_G_OFFSET UNITYSDK_OFFSET(0x1AC63C80)
#define SPINE_SKELETON_SET_R_OFFSET UNITYSDK_OFFSET(0x1AC63C60)
#define SPINE_SKELETON_SET_SCALEX_OFFSET UNITYSDK_OFFSET(0x1AC63D20)
#define SPINE_SKELETON_SET_SCALEY_OFFSET UNITYSDK_OFFSET(0x1AC63D30)
#define SPINE_SKELETON_SET_SKIN_OFFSET UNITYSDK_OFFSET(0x1AC63A40)
#define SPINE_SKELETON_SET_X_OFFSET UNITYSDK_OFFSET(0x1AC63CE0)
#define SPINE_SKELETON_SET_Y_OFFSET UNITYSDK_OFFSET(0x1AC63D00)
#define SPINE_SKELETON_SORTBONE_OFFSET UNITYSDK_OFFSET(0x1AC66030)
#define SPINE_SKELETON_SORTIKCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1AC658F0)
#define SPINE_SKELETON_SORTPATHCONSTRAINTATTACHMENT_1_OFFSET UNITYSDK_OFFSET(0x1AC664E0)
#define SPINE_SKELETON_SORTPATHCONSTRAINTATTACHMENT_OFFSET UNITYSDK_OFFSET(0x1AC66120)
#define SPINE_SKELETON_SORTPATHCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1AC65D80)
#define SPINE_SKELETON_SORTRESET_OFFSET UNITYSDK_OFFSET(0x1AC66090)
#define SPINE_SKELETON_SORTTRANSFORMCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1AC65B00)
#define SPINE_SKELETON_UPDATECACHE_OFFSET UNITYSDK_OFFSET(0x1AC64810)
#define SPINE_SKELETON_UPDATEWORLDTRANSFORM_1_OFFSET UNITYSDK_OFFSET(0x1AC668B0)
#define SPINE_SKELETON_UPDATEWORLDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AC666E0)
#define SPINE_SKELETON__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AC64BD0)
#define SPINE_SKELETON__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC63E30)

namespace Spine
{
	inline static constexpr unsigned int Skeleton_TypeDefinitionIndex = 36747;

	class Skeleton : public ::System::Object
	{
	public:
		::Spine::ExposedList_1<::Spine::IkConstraint*>* ikConstraints; // 0x10
		::Spine::Skin* skin; // 0x18
		::Spine::ExposedList_1<::Spine::Slot*>* slots; // 0x20
		::Spine::ExposedList_1<::Spine::Slot*>* drawOrder; // 0x28
		::Spine::ExposedList_1<::Spine::Bone*>* bones; // 0x30
		::Spine::ExposedList_1<::Spine::PathConstraint*>* pathConstraints; // 0x38
		::Spine::SkeletonData* data; // 0x40
		::Spine::ExposedList_1<::Spine::IUpdatable*>* updateCache; // 0x48
