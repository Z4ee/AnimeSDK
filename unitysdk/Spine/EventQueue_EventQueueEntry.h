...
#define SPINE_EVENTQUEUE_EVENTQUEUEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x607930)

namespace Spine
{
	inline static constexpr unsigned int EventQueue_EventQueueEntry_TypeDefinitionIndex = 32838;
