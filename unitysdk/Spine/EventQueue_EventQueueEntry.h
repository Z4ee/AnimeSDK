...
#define SPINE_EVENTQUEUE_EVENTQUEUEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x66EFE0)

namespace Spine
{
	inline static constexpr unsigned int EventQueue_EventQueueEntry_TypeDefinitionIndex = 33473;
