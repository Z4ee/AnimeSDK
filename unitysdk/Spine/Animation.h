...
#define SPINE_ANIMATION_APPLY_OFFSET UNITYSDK_OFFSET(0x1476C430)
#define SPINE_ANIMATION_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x1476C390)
#define SPINE_ANIMATION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1476C3B0)
#define SPINE_ANIMATION_GET_TIMELINES_OFFSET UNITYSDK_OFFSET(0x1476C370)
#define SPINE_ANIMATION_HASTIMELINE_OFFSET UNITYSDK_OFFSET(0x1476C3C0)
#define SPINE_ANIMATION_SETTIMELINES_OFFSET UNITYSDK_OFFSET(0x1476C020)
#define SPINE_ANIMATION_SET_DURATION_OFFSET UNITYSDK_OFFSET(0x1476C3A0)
#define SPINE_ANIMATION_SET_TIMELINES_OFFSET UNITYSDK_OFFSET(0x1476C380)
#define SPINE_ANIMATION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1476C650)
#define SPINE_ANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1476BFB0)

namespace Spine
{
	inline static constexpr unsigned int Animation_TypeDefinitionIndex = 37437;
	...
	public:
		...
		::System::Collections::Generic::HashSet_1<::System::String*>* timelineIds; // 0x20
