...
#define SPINE_PATHCONSTRAINTMIXTIMELINE_APPLY_OFFSET UNITYSDK_OFFSET(0x1F9734D0)
#define SPINE_PATHCONSTRAINTMIXTIMELINE_GET_FRAMEENTRIES_OFFSET UNITYSDK_OFFSET(0x1F973400)
#define SPINE_PATHCONSTRAINTMIXTIMELINE_GET_PATHCONSTRAINTINDEX_OFFSET UNITYSDK_OFFSET(0x1F973410)
#define SPINE_PATHCONSTRAINTMIXTIMELINE_SETFRAME_OFFSET UNITYSDK_OFFSET(0x1F973420)
#define SPINE_PATHCONSTRAINTMIXTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F973320)

namespace Spine
{
	inline static constexpr unsigned int PathConstraintMixTimeline_TypeDefinitionIndex = 33466;
