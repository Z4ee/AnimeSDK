...
#define SPINE_TEXTUREREGION_GET_ORIGINALHEIGHT_OFFSET UNITYSDK_OFFSET(0x19E1E600)
#define SPINE_TEXTUREREGION_GET_ORIGINALWIDTH_OFFSET UNITYSDK_OFFSET(0x19E1E5F0)
#define SPINE_TEXTUREREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x19E1E610)

namespace Spine
{
	inline static constexpr unsigned int TextureRegion_TypeDefinitionIndex = 36464;
