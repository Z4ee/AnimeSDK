...
#define SPINE_RGBA2TIMELINE_APPLY_OFFSET UNITYSDK_OFFSET(0x1D954E70)
#define SPINE_RGBA2TIMELINE_GET_FRAMEENTRIES_OFFSET UNITYSDK_OFFSET(0x1D954CE0)
#define SPINE_RGBA2TIMELINE_GET_SLOTINDEX_OFFSET UNITYSDK_OFFSET(0x1D954CF0)
#define SPINE_RGBA2TIMELINE_SETFRAME_OFFSET UNITYSDK_OFFSET(0x1D954D00)
#define SPINE_RGBA2TIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D954B40)

namespace Spine
{
	inline static constexpr unsigned int RGBA2Timeline_TypeDefinitionIndex = 32821;
