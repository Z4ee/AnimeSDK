...
#define SPINE_BONEDATA_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x1839AE30)
#define SPINE_BONEDATA_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1839AE60)
#define SPINE_BONEDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1839AE40)
#define SPINE_BONEDATA_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x1839AE50)
#define SPINE_BONEDATA_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1839AEC0)
#define SPINE_BONEDATA_GET_SCALEX_OFFSET UNITYSDK_OFFSET(0x1839AEE0)
#define SPINE_BONEDATA_GET_SCALEY_OFFSET UNITYSDK_OFFSET(0x1839AF00)
#define SPINE_BONEDATA_GET_SHEARX_OFFSET UNITYSDK_OFFSET(0x1839AF20)
#define SPINE_BONEDATA_GET_SHEARY_OFFSET UNITYSDK_OFFSET(0x1839AF40)
#define SPINE_BONEDATA_GET_SKINREQUIRED_OFFSET UNITYSDK_OFFSET(0x1839AF80)
#define SPINE_BONEDATA_GET_TRANSFORMMODE_OFFSET UNITYSDK_OFFSET(0x1839AF60)
#define SPINE_BONEDATA_GET_X_OFFSET UNITYSDK_OFFSET(0x1839AE80)
#define SPINE_BONEDATA_GET_Y_OFFSET UNITYSDK_OFFSET(0x1839AEA0)
#define SPINE_BONEDATA_SET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1839AE70)
#define SPINE_BONEDATA_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1839AED0)
#define SPINE_BONEDATA_SET_SCALEX_OFFSET UNITYSDK_OFFSET(0x1839AEF0)
#define SPINE_BONEDATA_SET_SCALEY_OFFSET UNITYSDK_OFFSET(0x1839AF10)
#define SPINE_BONEDATA_SET_SHEARX_OFFSET UNITYSDK_OFFSET(0x1839AF30)
#define SPINE_BONEDATA_SET_SHEARY_OFFSET UNITYSDK_OFFSET(0x1839AF50)
#define SPINE_BONEDATA_SET_SKINREQUIRED_OFFSET UNITYSDK_OFFSET(0x1839AF90)
#define SPINE_BONEDATA_SET_TRANSFORMMODE_OFFSET UNITYSDK_OFFSET(0x1839AF70)
#define SPINE_BONEDATA_SET_X_OFFSET UNITYSDK_OFFSET(0x1839AE90)
#define SPINE_BONEDATA_SET_Y_OFFSET UNITYSDK_OFFSET(0x1839AEB0)
#define SPINE_BONEDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1839B040)
#define SPINE_BONEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1839AFA0)

namespace Spine
{
	inline static constexpr unsigned int BoneData_TypeDefinitionIndex = 30707;
	...
	public:
		...
		::System::Single y; // 0x28
		::System::Int32 index; // 0x2C
		::System::Single shearY; // 0x30
