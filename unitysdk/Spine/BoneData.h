...
#define SPINE_BONEDATA_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x1E5D89B0)
#define SPINE_BONEDATA_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1E5D89E0)
#define SPINE_BONEDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1E5D89C0)
#define SPINE_BONEDATA_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x1E5D89D0)
#define SPINE_BONEDATA_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1E5D8A40)
#define SPINE_BONEDATA_GET_SCALEX_OFFSET UNITYSDK_OFFSET(0x1E5D8A60)
#define SPINE_BONEDATA_GET_SCALEY_OFFSET UNITYSDK_OFFSET(0x1E5D8A80)
#define SPINE_BONEDATA_GET_SHEARX_OFFSET UNITYSDK_OFFSET(0x1E5D8AA0)
#define SPINE_BONEDATA_GET_SHEARY_OFFSET UNITYSDK_OFFSET(0x1E5D8AC0)
#define SPINE_BONEDATA_GET_SKINREQUIRED_OFFSET UNITYSDK_OFFSET(0x1E5D8B00)
#define SPINE_BONEDATA_GET_TRANSFORMMODE_OFFSET UNITYSDK_OFFSET(0x1E5D8AE0)
#define SPINE_BONEDATA_GET_X_OFFSET UNITYSDK_OFFSET(0x1E5D8A00)
#define SPINE_BONEDATA_GET_Y_OFFSET UNITYSDK_OFFSET(0x1E5D8A20)
#define SPINE_BONEDATA_SET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1E5D89F0)
#define SPINE_BONEDATA_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1E5D8A50)
#define SPINE_BONEDATA_SET_SCALEX_OFFSET UNITYSDK_OFFSET(0x1E5D8A70)
#define SPINE_BONEDATA_SET_SCALEY_OFFSET UNITYSDK_OFFSET(0x1E5D8A90)
#define SPINE_BONEDATA_SET_SHEARX_OFFSET UNITYSDK_OFFSET(0x1E5D8AB0)
#define SPINE_BONEDATA_SET_SHEARY_OFFSET UNITYSDK_OFFSET(0x1E5D8AD0)
#define SPINE_BONEDATA_SET_SKINREQUIRED_OFFSET UNITYSDK_OFFSET(0x1E5D8B10)
#define SPINE_BONEDATA_SET_TRANSFORMMODE_OFFSET UNITYSDK_OFFSET(0x1E5D8AF0)
#define SPINE_BONEDATA_SET_X_OFFSET UNITYSDK_OFFSET(0x1E5D8A10)
#define SPINE_BONEDATA_SET_Y_OFFSET UNITYSDK_OFFSET(0x1E5D8A30)
#define SPINE_BONEDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E5D8BC0)
#define SPINE_BONEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5D8B20)
