...
#define SPINE_BONEDATA_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x14779340)
#define SPINE_BONEDATA_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x14779370)
#define SPINE_BONEDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x14779350)
#define SPINE_BONEDATA_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x14779360)
#define SPINE_BONEDATA_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x147793D0)
#define SPINE_BONEDATA_GET_SCALEX_OFFSET UNITYSDK_OFFSET(0x147793F0)
#define SPINE_BONEDATA_GET_SCALEY_OFFSET UNITYSDK_OFFSET(0x14779410)
#define SPINE_BONEDATA_GET_SHEARX_OFFSET UNITYSDK_OFFSET(0x14779430)
#define SPINE_BONEDATA_GET_SHEARY_OFFSET UNITYSDK_OFFSET(0x14779450)
#define SPINE_BONEDATA_GET_SKINREQUIRED_OFFSET UNITYSDK_OFFSET(0x14779490)
#define SPINE_BONEDATA_GET_TRANSFORMMODE_OFFSET UNITYSDK_OFFSET(0x14779470)
#define SPINE_BONEDATA_GET_X_OFFSET UNITYSDK_OFFSET(0x14779390)
#define SPINE_BONEDATA_GET_Y_OFFSET UNITYSDK_OFFSET(0x147793B0)
#define SPINE_BONEDATA_SET_LENGTH_OFFSET UNITYSDK_OFFSET(0x14779380)
#define SPINE_BONEDATA_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x147793E0)
#define SPINE_BONEDATA_SET_SCALEX_OFFSET UNITYSDK_OFFSET(0x14779400)
#define SPINE_BONEDATA_SET_SCALEY_OFFSET UNITYSDK_OFFSET(0x14779420)
#define SPINE_BONEDATA_SET_SHEARX_OFFSET UNITYSDK_OFFSET(0x14779440)
#define SPINE_BONEDATA_SET_SHEARY_OFFSET UNITYSDK_OFFSET(0x14779460)
#define SPINE_BONEDATA_SET_SKINREQUIRED_OFFSET UNITYSDK_OFFSET(0x147794A0)
#define SPINE_BONEDATA_SET_TRANSFORMMODE_OFFSET UNITYSDK_OFFSET(0x14779480)
#define SPINE_BONEDATA_SET_X_OFFSET UNITYSDK_OFFSET(0x147793A0)
#define SPINE_BONEDATA_SET_Y_OFFSET UNITYSDK_OFFSET(0x147793C0)
#define SPINE_BONEDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x14779550)
#define SPINE_BONEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x147794B0)
