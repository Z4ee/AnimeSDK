...
#define SPINE_BONE_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x1FADDCC0)
#define SPINE_BONE_GET_APPLIEDROTATION_OFFSET UNITYSDK_OFFSET(0x1FADDDB0)
#define SPINE_BONE_GET_ASCALEX_OFFSET UNITYSDK_OFFSET(0x1FADDE10)
#define SPINE_BONE_GET_ASCALEY_OFFSET UNITYSDK_OFFSET(0x1FADDE30)
#define SPINE_BONE_GET_ASHEARX_OFFSET UNITYSDK_OFFSET(0x1FADDE50)
#define SPINE_BONE_GET_ASHEARY_OFFSET UNITYSDK_OFFSET(0x1FADDE70)
#define SPINE_BONE_GET_AX_OFFSET UNITYSDK_OFFSET(0x1FADDDD0)
#define SPINE_BONE_GET_AY_OFFSET UNITYSDK_OFFSET(0x1FADDDF0)
#define SPINE_BONE_GET_A_OFFSET UNITYSDK_OFFSET(0x1FADDE90)
#define SPINE_BONE_GET_B_OFFSET UNITYSDK_OFFSET(0x1FADDEB0)
#define SPINE_BONE_GET_CHILDREN_OFFSET UNITYSDK_OFFSET(0x1FADDCB0)
#define SPINE_BONE_GET_C_OFFSET UNITYSDK_OFFSET(0x1FADDED0)
#define SPINE_BONE_GET_DATA_OFFSET UNITYSDK_OFFSET(0x1FADDC80)
#define SPINE_BONE_GET_D_OFFSET UNITYSDK_OFFSET(0x1FADDEF0)
#define SPINE_BONE_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x1FADDCA0)
#define SPINE_BONE_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1FADDD10)
#define SPINE_BONE_GET_SCALEX_OFFSET UNITYSDK_OFFSET(0x1FADDD30)
#define SPINE_BONE_GET_SCALEY_OFFSET UNITYSDK_OFFSET(0x1FADDD50)
#define SPINE_BONE_GET_SHEARX_OFFSET UNITYSDK_OFFSET(0x1FADDD70)
#define SPINE_BONE_GET_SHEARY_OFFSET UNITYSDK_OFFSET(0x1FADDD90)
#define SPINE_BONE_GET_SKELETON_OFFSET UNITYSDK_OFFSET(0x1FADDC90)
#define SPINE_BONE_GET_WORLDROTATIONX_OFFSET UNITYSDK_OFFSET(0x1FADDF50)
#define SPINE_BONE_GET_WORLDROTATIONY_OFFSET UNITYSDK_OFFSET(0x1FADDFD0)
#define SPINE_BONE_GET_WORLDSCALEX_OFFSET UNITYSDK_OFFSET(0x1FADE050)
#define SPINE_BONE_GET_WORLDSCALEY_OFFSET UNITYSDK_OFFSET(0x1FADE070)
#define SPINE_BONE_GET_WORLDTOLOCALROTATIONX_OFFSET UNITYSDK_OFFSET(0x1FADF230)
#define SPINE_BONE_GET_WORLDTOLOCALROTATIONY_OFFSET UNITYSDK_OFFSET(0x1FADF330)
#define SPINE_BONE_GET_WORLDX_OFFSET UNITYSDK_OFFSET(0x1FADDF10)
#define SPINE_BONE_GET_WORLDY_OFFSET UNITYSDK_OFFSET(0x1FADDF30)
#define SPINE_BONE_GET_X_OFFSET UNITYSDK_OFFSET(0x1FADDCD0)
#define SPINE_BONE_GET_Y_OFFSET UNITYSDK_OFFSET(0x1FADDCF0)
#define SPINE_BONE_LOCALTOWORLDROTATION_OFFSET UNITYSDK_OFFSET(0x1FADF520)
#define SPINE_BONE_LOCALTOWORLD_OFFSET UNITYSDK_OFFSET(0x1FADF1F0)
#define SPINE_BONE_ROTATEWORLD_OFFSET UNITYSDK_OFFSET(0x1FADF610)
#define SPINE_BONE_SETTOSETUPPOSE_OFFSET UNITYSDK_OFFSET(0x1FADE1C0)
#define SPINE_BONE_SET_APPLIEDROTATION_OFFSET UNITYSDK_OFFSET(0x1FADDDC0)
#define SPINE_BONE_SET_ASCALEX_OFFSET UNITYSDK_OFFSET(0x1FADDE20)
#define SPINE_BONE_SET_ASCALEY_OFFSET UNITYSDK_OFFSET(0x1FADDE40)
#define SPINE_BONE_SET_ASHEARX_OFFSET UNITYSDK_OFFSET(0x1FADDE60)
#define SPINE_BONE_SET_ASHEARY_OFFSET UNITYSDK_OFFSET(0x1FADDE80)
#define SPINE_BONE_SET_AX_OFFSET UNITYSDK_OFFSET(0x1FADDDE0)
#define SPINE_BONE_SET_AY_OFFSET UNITYSDK_OFFSET(0x1FADDE00)
#define SPINE_BONE_SET_A_OFFSET UNITYSDK_OFFSET(0x1FADDEA0)
#define SPINE_BONE_SET_B_OFFSET UNITYSDK_OFFSET(0x1FADDEC0)
#define SPINE_BONE_SET_C_OFFSET UNITYSDK_OFFSET(0x1FADDEE0)
#define SPINE_BONE_SET_D_OFFSET UNITYSDK_OFFSET(0x1FADDF00)
#define SPINE_BONE_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1FADDD20)
#define SPINE_BONE_SET_SCALEX_OFFSET UNITYSDK_OFFSET(0x1FADDD40)
#define SPINE_BONE_SET_SCALEY_OFFSET UNITYSDK_OFFSET(0x1FADDD60)
#define SPINE_BONE_SET_SHEARX_OFFSET UNITYSDK_OFFSET(0x1FADDD80)
#define SPINE_BONE_SET_SHEARY_OFFSET UNITYSDK_OFFSET(0x1FADDDA0)
#define SPINE_BONE_SET_WORLDX_OFFSET UNITYSDK_OFFSET(0x1FADDF20)
#define SPINE_BONE_SET_WORLDY_OFFSET UNITYSDK_OFFSET(0x1FADDF40)
#define SPINE_BONE_SET_X_OFFSET UNITYSDK_OFFSET(0x1FADDCE0)
#define SPINE_BONE_SET_Y_OFFSET UNITYSDK_OFFSET(0x1FADDD00)
#define SPINE_BONE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1FADF730)
#define SPINE_BONE_UPDATEAPPLIEDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1FADEDD0)
#define SPINE_BONE_UPDATEWORLDTRANSFORM_1_OFFSET UNITYSDK_OFFSET(0x1FADE3B0)
#define SPINE_BONE_UPDATEWORLDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1FADED70)
#define SPINE_BONE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1FADE350)
#define SPINE_BONE_WORLDTOLOCALROTATION_OFFSET UNITYSDK_OFFSET(0x1FADF430)
#define SPINE_BONE_WORLDTOLOCAL_OFFSET UNITYSDK_OFFSET(0x1FADF160)
#define SPINE_BONE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1FADE220)
#define SPINE_BONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1FADE090)

namespace Spine
{
	inline static constexpr unsigned int Bone_TypeDefinitionIndex = 33504;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Bone_TypeDefinitionIndex)->GetStaticField(0x8110);
		}
		::Spine::BoneData* data; // 0x10
		::Spine::ExposedList_1<::Spine::Bone*>* children; // 0x18
		::Spine::Bone* parent; // 0x20
		::Spine::Skeleton* skeleton; // 0x28
		::System::Single rotation; // 0x30
		::System::Single worldY; // 0x34
		::System::Single y; // 0x38
		::System::Single ascaleY; // 0x3C
		::System::Boolean active; // 0x40
		::System::Boolean sorted; // 0x41
		::System::Single ax; // 0x44
		::System::Single ashearY; // 0x48
		::System::Single ascaleX; // 0x4C
		::System::Single ay; // 0x50
		::System::Single scaleY; // 0x54
		::System::Single a; // 0x58
		::System::Single shearX; // 0x5C
		::System::Single x; // 0x60
		::System::Single c; // 0x64
		::System::Single scaleX; // 0x68
		::System::Single worldX; // 0x6C
		::System::Single shearY; // 0x70
		::System::Single arotation; // 0x74
