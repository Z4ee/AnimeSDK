...
#define SPINE_BONE_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x18399390)
#define SPINE_BONE_GET_APPLIEDROTATION_OFFSET UNITYSDK_OFFSET(0x18399480)
#define SPINE_BONE_GET_ASCALEX_OFFSET UNITYSDK_OFFSET(0x183994E0)
#define SPINE_BONE_GET_ASCALEY_OFFSET UNITYSDK_OFFSET(0x18399500)
#define SPINE_BONE_GET_ASHEARX_OFFSET UNITYSDK_OFFSET(0x18399520)
#define SPINE_BONE_GET_ASHEARY_OFFSET UNITYSDK_OFFSET(0x18399540)
#define SPINE_BONE_GET_AX_OFFSET UNITYSDK_OFFSET(0x183994A0)
#define SPINE_BONE_GET_AY_OFFSET UNITYSDK_OFFSET(0x183994C0)
#define SPINE_BONE_GET_A_OFFSET UNITYSDK_OFFSET(0x18399560)
#define SPINE_BONE_GET_B_OFFSET UNITYSDK_OFFSET(0x18399580)
#define SPINE_BONE_GET_CHILDREN_OFFSET UNITYSDK_OFFSET(0x18399380)
#define SPINE_BONE_GET_C_OFFSET UNITYSDK_OFFSET(0x183995A0)
#define SPINE_BONE_GET_DATA_OFFSET UNITYSDK_OFFSET(0x18399350)
#define SPINE_BONE_GET_D_OFFSET UNITYSDK_OFFSET(0x183995C0)
#define SPINE_BONE_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x18399370)
#define SPINE_BONE_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x183993E0)
#define SPINE_BONE_GET_SCALEX_OFFSET UNITYSDK_OFFSET(0x18399400)
#define SPINE_BONE_GET_SCALEY_OFFSET UNITYSDK_OFFSET(0x18399420)
#define SPINE_BONE_GET_SHEARX_OFFSET UNITYSDK_OFFSET(0x18399440)
#define SPINE_BONE_GET_SHEARY_OFFSET UNITYSDK_OFFSET(0x18399460)
#define SPINE_BONE_GET_SKELETON_OFFSET UNITYSDK_OFFSET(0x18399360)
#define SPINE_BONE_GET_WORLDROTATIONX_OFFSET UNITYSDK_OFFSET(0x18399620)
#define SPINE_BONE_GET_WORLDROTATIONY_OFFSET UNITYSDK_OFFSET(0x183996A0)
#define SPINE_BONE_GET_WORLDSCALEX_OFFSET UNITYSDK_OFFSET(0x18399700)
#define SPINE_BONE_GET_WORLDSCALEY_OFFSET UNITYSDK_OFFSET(0x18399730)
#define SPINE_BONE_GET_WORLDTOLOCALROTATIONX_OFFSET UNITYSDK_OFFSET(0x1839AA20)
#define SPINE_BONE_GET_WORLDTOLOCALROTATIONY_OFFSET UNITYSDK_OFFSET(0x1839AAE0)
#define SPINE_BONE_GET_WORLDX_OFFSET UNITYSDK_OFFSET(0x183995E0)
#define SPINE_BONE_GET_WORLDY_OFFSET UNITYSDK_OFFSET(0x18399600)
#define SPINE_BONE_GET_X_OFFSET UNITYSDK_OFFSET(0x183993A0)
#define SPINE_BONE_GET_Y_OFFSET UNITYSDK_OFFSET(0x183993C0)
#define SPINE_BONE_LOCALTOWORLDROTATION_OFFSET UNITYSDK_OFFSET(0x1839AC50)
#define SPINE_BONE_LOCALTOWORLD_OFFSET UNITYSDK_OFFSET(0x1839A9E0)
#define SPINE_BONE_ROTATEWORLD_OFFSET UNITYSDK_OFFSET(0x1839AD20)
#define SPINE_BONE_SETTOSETUPPOSE_OFFSET UNITYSDK_OFFSET(0x18399870)
#define SPINE_BONE_SET_APPLIEDROTATION_OFFSET UNITYSDK_OFFSET(0x18399490)
#define SPINE_BONE_SET_ASCALEX_OFFSET UNITYSDK_OFFSET(0x183994F0)
#define SPINE_BONE_SET_ASCALEY_OFFSET UNITYSDK_OFFSET(0x18399510)
#define SPINE_BONE_SET_ASHEARX_OFFSET UNITYSDK_OFFSET(0x18399530)
#define SPINE_BONE_SET_ASHEARY_OFFSET UNITYSDK_OFFSET(0x18399550)
#define SPINE_BONE_SET_AX_OFFSET UNITYSDK_OFFSET(0x183994B0)
#define SPINE_BONE_SET_AY_OFFSET UNITYSDK_OFFSET(0x183994D0)
#define SPINE_BONE_SET_A_OFFSET UNITYSDK_OFFSET(0x18399570)
#define SPINE_BONE_SET_B_OFFSET UNITYSDK_OFFSET(0x18399590)
#define SPINE_BONE_SET_C_OFFSET UNITYSDK_OFFSET(0x183995B0)
#define SPINE_BONE_SET_D_OFFSET UNITYSDK_OFFSET(0x183995D0)
#define SPINE_BONE_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x183993F0)
#define SPINE_BONE_SET_SCALEX_OFFSET UNITYSDK_OFFSET(0x18399410)
#define SPINE_BONE_SET_SCALEY_OFFSET UNITYSDK_OFFSET(0x18399430)
#define SPINE_BONE_SET_SHEARX_OFFSET UNITYSDK_OFFSET(0x18399450)
#define SPINE_BONE_SET_SHEARY_OFFSET UNITYSDK_OFFSET(0x18399470)
#define SPINE_BONE_SET_WORLDX_OFFSET UNITYSDK_OFFSET(0x183995F0)
#define SPINE_BONE_SET_WORLDY_OFFSET UNITYSDK_OFFSET(0x18399610)
#define SPINE_BONE_SET_X_OFFSET UNITYSDK_OFFSET(0x183993B0)
#define SPINE_BONE_SET_Y_OFFSET UNITYSDK_OFFSET(0x183993D0)
#define SPINE_BONE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1839AE10)
#define SPINE_BONE_UPDATEAPPLIEDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1839A570)
#define SPINE_BONE_UPDATEWORLDTRANSFORM_1_OFFSET UNITYSDK_OFFSET(0x18399A50)
#define SPINE_BONE_UPDATEWORLDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1839A470)
#define SPINE_BONE_UPDATE_OFFSET UNITYSDK_OFFSET(0x183999F0)
#define SPINE_BONE_WORLDTOLOCALROTATION_OFFSET UNITYSDK_OFFSET(0x1839ABA0)
#define SPINE_BONE_WORLDTOLOCAL_OFFSET UNITYSDK_OFFSET(0x1839A970)
#define SPINE_BONE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x183998D0)
#define SPINE_BONE__CTOR_OFFSET UNITYSDK_OFFSET(0x18399760)

namespace Spine
{
	inline static constexpr unsigned int Bone_TypeDefinitionIndex = 30706;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Bone_TypeDefinitionIndex)->GetStaticField(0xFBA0);
		}
		::Spine::ExposedList_1<::Spine::Bone*>* children; // 0x10
		::Spine::Bone* parent; // 0x18
		...
		::System::Single d; // 0x44
		::System::Single ashearY; // 0x48
		::System::Single ay; // 0x4C
		::System::Single worldY; // 0x50
		::System::Single arotation; // 0x54
		::System::Single c; // 0x58
		::System::Single ascaleX; // 0x5C
		::System::Boolean sorted; // 0x60
		::System::Boolean active; // 0x61
		::System::Single ax; // 0x64
		::System::Single scaleX; // 0x68
		::System::Single a; // 0x6C
		::System::Single shearX; // 0x70
		::System::Single worldX; // 0x74
		::System::Single x; // 0x78
		::System::Single y; // 0x7C
