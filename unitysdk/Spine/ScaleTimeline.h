...
#define SPINE_SCALETIMELINE_APPLY_OFFSET UNITYSDK_OFFSET(0x1C3BE110)
#define SPINE_SCALETIMELINE_GET_BONEINDEX_OFFSET UNITYSDK_OFFSET(0x1C3BE100)
#define SPINE_SCALETIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3BE010)

namespace Spine
{
	inline static constexpr unsigned int ScaleTimeline_TypeDefinitionIndex = 31261;
