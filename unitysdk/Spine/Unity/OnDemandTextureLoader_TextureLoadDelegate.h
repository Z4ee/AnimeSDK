...
#define SPINE_UNITY_ONDEMANDTEXTURELOADER_TEXTURELOADDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C172910)
#define SPINE_UNITY_ONDEMANDTEXTURELOADER_TEXTURELOADDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C1729A0)
#define SPINE_UNITY_ONDEMANDTEXTURELOADER_TEXTURELOADDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C172290)
#define SPINE_UNITY_ONDEMANDTEXTURELOADER_TEXTURELOADDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1728F0)

namespace Spine::Unity
{
	inline static constexpr unsigned int OnDemandTextureLoader_TextureLoadDelegate_TypeDefinitionIndex = 40090;
