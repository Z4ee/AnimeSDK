...
#define SPINE_UNITY_ONDEMANDTEXTURELOADER_TEXTURELOADDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18B479B0)
#define SPINE_UNITY_ONDEMANDTEXTURELOADER_TEXTURELOADDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18B47A40)
#define SPINE_UNITY_ONDEMANDTEXTURELOADER_TEXTURELOADDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18B472E0)
#define SPINE_UNITY_ONDEMANDTEXTURELOADER_TEXTURELOADDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B479A0)

namespace Spine::Unity
{
	inline static constexpr unsigned int OnDemandTextureLoader_TextureLoadDelegate_TypeDefinitionIndex = 37797;
