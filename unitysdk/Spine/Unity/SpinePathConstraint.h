...
#define SPINE_UNITY_SPINEPATHCONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C19EC10)

namespace Spine::Unity
{
	inline static constexpr unsigned int SpinePathConstraint_TypeDefinitionIndex = 40187;
