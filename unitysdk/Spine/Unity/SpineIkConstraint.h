...
#define SPINE_UNITY_SPINEIKCONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C19EBB0)

namespace Spine::Unity
{
	inline static constexpr unsigned int SpineIkConstraint_TypeDefinitionIndex = 40185;
