...
#define SPINE_UNITY_ISKELETONANIMATIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184006E0)
#define SPINE_UNITY_ISKELETONANIMATIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18400710)
#define SPINE_UNITY_ISKELETONANIMATIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18400190)
#define SPINE_UNITY_ISKELETONANIMATIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18400170)

namespace Spine::Unity
{
	inline static constexpr unsigned int ISkeletonAnimationDelegate_TypeDefinitionIndex = 34804;
