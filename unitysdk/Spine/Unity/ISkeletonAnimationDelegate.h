...
#define SPINE_UNITY_ISKELETONANIMATIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AD18D60)
#define SPINE_UNITY_ISKELETONANIMATIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AD18D90)
#define SPINE_UNITY_ISKELETONANIMATIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AD18860)
#define SPINE_UNITY_ISKELETONANIMATIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD18840)

namespace Spine::Unity
{
	inline static constexpr unsigned int ISkeletonAnimationDelegate_TypeDefinitionIndex = 39493;
