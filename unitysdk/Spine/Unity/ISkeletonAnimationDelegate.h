...
#define SPINE_UNITY_ISKELETONANIMATIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19E3B330)
#define SPINE_UNITY_ISKELETONANIMATIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19E3B360)
#define SPINE_UNITY_ISKELETONANIMATIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19E3ADE0)
#define SPINE_UNITY_ISKELETONANIMATIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E3ADC0)

namespace Spine::Unity
{
	inline static constexpr unsigned int ISkeletonAnimationDelegate_TypeDefinitionIndex = 40623;
