...
#define SPINE_UNITY_REGIONLESSATTACHMENTLOADER_GET_EMPTYREGION_OFFSET UNITYSDK_OFFSET(0x19E44E80)
#define SPINE_UNITY_REGIONLESSATTACHMENTLOADER_NEWBOUNDINGBOXATTACHMENT_OFFSET UNITYSDK_OFFSET(0x19E45110)
#define SPINE_UNITY_REGIONLESSATTACHMENTLOADER_NEWCLIPPINGATTACHMENT_OFFSET UNITYSDK_OFFSET(0x19E45260)
#define SPINE_UNITY_REGIONLESSATTACHMENTLOADER_NEWMESHATTACHMENT_OFFSET UNITYSDK_OFFSET(0x19E45060)
#define SPINE_UNITY_REGIONLESSATTACHMENTLOADER_NEWPATHATTACHMENT_OFFSET UNITYSDK_OFFSET(0x19E45170)
#define SPINE_UNITY_REGIONLESSATTACHMENTLOADER_NEWPOINTATTACHMENT_OFFSET UNITYSDK_OFFSET(0x19E451D0)
#define SPINE_UNITY_REGIONLESSATTACHMENTLOADER_NEWREGIONATTACHMENT_OFFSET UNITYSDK_OFFSET(0x19E44FA0)
#define SPINE_UNITY_REGIONLESSATTACHMENTLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E452B0)

namespace Spine::Unity
{
	inline static constexpr unsigned int RegionlessAttachmentLoader_TypeDefinitionIndex = 40556;
	...
	public:
		...
		{
			return (::Spine::AtlasRegion**)Il2CppClass::FromTypeDefinitionIndex(RegionlessAttachmentLoader_TypeDefinitionIndex)->GetStaticField(0x40F70);
		}
