...
#define SPINE_UNITY_SPINEMESH_NEWSKELETONMESH_OFFSET UNITYSDK_OFFSET(0x18B45D30)

namespace Spine::Unity
{
	inline static constexpr unsigned int SpineMesh_TypeDefinitionIndex = 37883;
