...
#define SPINE_UNITY_SPINEATTRIBUTEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E67B70)

namespace Spine::Unity
{
	inline static constexpr unsigned int SpineAttributeBase_TypeDefinitionIndex = 40645;
