...
#define SPINE_UNITY_SKELETONUTILITY_SKELETONUTILITYDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18B71730)
#define SPINE_UNITY_SKELETONUTILITY_SKELETONUTILITYDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18B71760)
#define SPINE_UNITY_SKELETONUTILITY_SKELETONUTILITYDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18B6F410)
#define SPINE_UNITY_SKELETONUTILITY_SKELETONUTILITYDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B71720)

namespace Spine::Unity
{
	inline static constexpr unsigned int SkeletonUtility_SkeletonUtilityDelegate_TypeDefinitionIndex = 37858;
