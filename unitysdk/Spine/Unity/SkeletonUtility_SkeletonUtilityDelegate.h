...
#define SPINE_UNITY_SKELETONUTILITY_SKELETONUTILITYDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C19C690)
#define SPINE_UNITY_SKELETONUTILITY_SKELETONUTILITYDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C19C6C0)
#define SPINE_UNITY_SKELETONUTILITY_SKELETONUTILITYDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C19A390)
#define SPINE_UNITY_SKELETONUTILITY_SKELETONUTILITYDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C19C670)

namespace Spine::Unity
{
	inline static constexpr unsigned int SkeletonUtility_SkeletonUtilityDelegate_TypeDefinitionIndex = 40151;
