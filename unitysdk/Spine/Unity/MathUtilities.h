...
#define SPINE_UNITY_MATHUTILITIES_INVERSELERP_1_OFFSET UNITYSDK_OFFSET(0x1E63F460)
#define SPINE_UNITY_MATHUTILITIES_INVERSELERP_2_OFFSET UNITYSDK_OFFSET(0x1E63F4B0)
#define SPINE_UNITY_MATHUTILITIES_INVERSELERP_3_OFFSET UNITYSDK_OFFSET(0x1E63F4F0)
#define SPINE_UNITY_MATHUTILITIES_INVERSELERP_OFFSET UNITYSDK_OFFSET(0x1E63F450)

namespace Spine::Unity
{
	inline static constexpr unsigned int MathUtilities_TypeDefinitionIndex = 43910;
