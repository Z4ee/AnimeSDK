...
#define SPINE_UNITY_NAPSKELETONGRAPHIC_AWAKE_OFFSET UNITYSDK_OFFSET(0x1C170EF0)
#define SPINE_UNITY_NAPSKELETONGRAPHIC_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x1C1710B0)
#define SPINE_UNITY_NAPSKELETONGRAPHIC_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C170FF0)
#define SPINE_UNITY_NAPSKELETONGRAPHIC__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1711E0)

namespace Spine::Unity
{
	inline static constexpr unsigned int NapSkeletonGraphic_TypeDefinitionIndex = 40111;
