...
#define SPINE_UNITY_NAPSKELETONGRAPHIC_AWAKE_OFFSET UNITYSDK_OFFSET(0x18B45F30)
#define SPINE_UNITY_NAPSKELETONGRAPHIC_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x18B460F0)
#define SPINE_UNITY_NAPSKELETONGRAPHIC_UPDATE_OFFSET UNITYSDK_OFFSET(0x18B46030)
#define SPINE_UNITY_NAPSKELETONGRAPHIC__CTOR_OFFSET UNITYSDK_OFFSET(0x18B46220)

namespace Spine::Unity
{
	inline static constexpr unsigned int NapSkeletonGraphic_TypeDefinitionIndex = 37818;
