...
#define SPINE_UNITY_SKELETONPARTSRENDERER_SKELETONPARTSRENDERERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19E5AA00)
#define SPINE_UNITY_SKELETONPARTSRENDERER_SKELETONPARTSRENDERERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19E5AA30)
#define SPINE_UNITY_SKELETONPARTSRENDERER_SKELETONPARTSRENDERERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19E5A130)
#define SPINE_UNITY_SKELETONPARTSRENDERER_SKELETONPARTSRENDERERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E5A9E0)

namespace Spine::Unity
{
	inline static constexpr unsigned int SkeletonPartsRenderer_SkeletonPartsRendererDelegate_TypeDefinitionIndex = 40598;
