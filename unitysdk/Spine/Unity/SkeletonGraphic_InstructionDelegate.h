...
#define SPINE_UNITY_SKELETONGRAPHIC_INSTRUCTIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18B567C0)
#define SPINE_UNITY_SKELETONGRAPHIC_INSTRUCTIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18B567F0)
#define SPINE_UNITY_SKELETONGRAPHIC_INSTRUCTIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18B52D20)
#define SPINE_UNITY_SKELETONGRAPHIC_INSTRUCTIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B567B0)

namespace Spine::Unity
{
	inline static constexpr unsigned int SkeletonGraphic_InstructionDelegate_TypeDefinitionIndex = 37831;
