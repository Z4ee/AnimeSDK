...
#define SPINE_UNITY_SKELETONUTILITYCONSTRAINT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AD4EDF0)
#define SPINE_UNITY_SKELETONUTILITYCONSTRAINT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AD4ECA0)
#define SPINE_UNITY_SKELETONUTILITYCONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD4EE50)

namespace Spine::Unity
{
	inline static constexpr unsigned int SkeletonUtilityConstraint_TypeDefinitionIndex = 39490;
