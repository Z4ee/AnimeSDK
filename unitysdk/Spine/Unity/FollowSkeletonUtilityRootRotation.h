...
#define SPINE_UNITY_FOLLOWSKELETONUTILITYROOTROTATION_COMPENSATEPOSITIONTOXROTATION_OFFSET UNITYSDK_OFFSET(0x1C1667D0)
#define SPINE_UNITY_FOLLOWSKELETONUTILITYROOTROTATION_COMPENSATEPOSITIONTOYROTATION_OFFSET UNITYSDK_OFFSET(0x1C166610)
#define SPINE_UNITY_FOLLOWSKELETONUTILITYROOTROTATION_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1C1662D0)
#define SPINE_UNITY_FOLLOWSKELETONUTILITYROOTROTATION_START_OFFSET UNITYSDK_OFFSET(0x1C1661C0)
#define SPINE_UNITY_FOLLOWSKELETONUTILITYROOTROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C166930)

namespace Spine::Unity
{
	inline static constexpr unsigned int FollowSkeletonUtilityRootRotation_TypeDefinitionIndex = 40149;
