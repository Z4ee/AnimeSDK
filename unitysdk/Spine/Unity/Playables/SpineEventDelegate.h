...
#define SPINE_UNITY_PLAYABLES_SPINEEVENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x183EF2D0)
#define SPINE_UNITY_PLAYABLES_SPINEEVENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x183EF300)
#define SPINE_UNITY_PLAYABLES_SPINEEVENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x183EED80)
#define SPINE_UNITY_PLAYABLES_SPINEEVENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x183EED60)

namespace Spine::Unity::Playables
{
	inline static constexpr unsigned int SpineEventDelegate_TypeDefinitionIndex = 35070;
