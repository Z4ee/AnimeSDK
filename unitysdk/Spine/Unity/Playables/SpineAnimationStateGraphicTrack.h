...
#define SPINE_UNITY_PLAYABLES_SPINEANIMATIONSTATEGRAPHICTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1ACA10B0)
#define SPINE_UNITY_PLAYABLES_SPINEANIMATIONSTATEGRAPHICTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACA1580)

namespace Spine::Unity::Playables
{
	inline static constexpr unsigned int SpineAnimationStateGraphicTrack_TypeDefinitionIndex = 41728;
