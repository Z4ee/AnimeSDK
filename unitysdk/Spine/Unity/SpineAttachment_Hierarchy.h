...
#define SPINE_UNITY_SPINEATTACHMENT_HIERARCHY__CTOR_OFFSET UNITYSDK_OFFSET(0x8120B0)

namespace Spine::Unity
{
	inline static constexpr unsigned int SpineAttachment_Hierarchy_TypeDefinitionIndex = 37897;
