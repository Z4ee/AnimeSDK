...
#define SPINE_UNITY_SKELETONMECANIM_MECANIMTRANSLATOR_CLIPINFOS__CTOR_OFFSET UNITYSDK_OFFSET(0x168C20F0)
...
namespace Spine::Unity
{
	...
	public:
		...
		::System::Int32 nextClipInfoCount; // 0x2C
		::System::Boolean isLastFrameOfInterruption; // 0x30
		::System::Boolean isInterruptionActive; // 0x31
		::System::Int32 interruptingClipInfoCount; // 0x34
		::System::Int32 clipInfoCount; // 0x38
		::UnityEngine::AnimatorStateInfo nextStateInfo; // 0x3C
		::UnityEngine::AnimatorStateInfo interruptingStateInfo; // 0x60
		::UnityEngine::AnimatorStateInfo stateInfo; // 0x84
