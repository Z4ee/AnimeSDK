...
#define SPINE_UNITY_SKELETONGRAPHIC_MESHASSIGNMENTDELEGATEMULTIPLE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C181720)
#define SPINE_UNITY_SKELETONGRAPHIC_MESHASSIGNMENTDELEGATEMULTIPLE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C1817C0)
#define SPINE_UNITY_SKELETONGRAPHIC_MESHASSIGNMENTDELEGATEMULTIPLE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C1812C0)
#define SPINE_UNITY_SKELETONGRAPHIC_MESHASSIGNMENTDELEGATEMULTIPLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C181700)

namespace Spine::Unity
{
	inline static constexpr unsigned int SkeletonGraphic_MeshAssignmentDelegateMultiple_TypeDefinitionIndex = 40122;
