...
#define SPINE_UNITY_SPINETRANSFORMCONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0x18B74D50)

namespace Spine::Unity
{
	inline static constexpr unsigned int SpineTransformConstraint_TypeDefinitionIndex = 37893;
