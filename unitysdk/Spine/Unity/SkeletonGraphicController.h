...
#define SPINE_UNITY_SKELETONGRAPHICCONTROLLER_ONANIMATIONCHECK_OFFSET UNITYSDK_OFFSET(0x1ACC8C80)
#define SPINE_UNITY_SKELETONGRAPHICCONTROLLER_ONSKINCHECK_OFFSET UNITYSDK_OFFSET(0x1ACC8E10)
#define SPINE_UNITY_SKELETONGRAPHICCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1ACC8EA0)
#define SPINE_UNITY_SKELETONGRAPHICCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACC8EC0)

namespace Spine::Unity
{
	inline static constexpr unsigned int SkeletonGraphicController_TypeDefinitionIndex = 41416;
