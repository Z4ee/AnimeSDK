...
#define SPINE_UNITY_SKELETONGRAPHICCONTROLLER_ONANIMATIONCHECK_OFFSET UNITYSDK_OFFSET(0x19E50DB0)
#define SPINE_UNITY_SKELETONGRAPHICCONTROLLER_ONSKINCHECK_OFFSET UNITYSDK_OFFSET(0x19E50F30)
#define SPINE_UNITY_SKELETONGRAPHICCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x19E50FB0)
#define SPINE_UNITY_SKELETONGRAPHICCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E50FD0)

namespace Spine::Unity
{
	inline static constexpr unsigned int SkeletonGraphicController_TypeDefinitionIndex = 40589;
