...
#define SPINE_UNITY_SKELETONGRAPHICCONTROLLER_ONANIMATIONCHECK_OFFSET UNITYSDK_OFFSET(0x18329360)
#define SPINE_UNITY_SKELETONGRAPHICCONTROLLER_ONSKINCHECK_OFFSET UNITYSDK_OFFSET(0x18329550)
#define SPINE_UNITY_SKELETONGRAPHICCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x183295E0)
#define SPINE_UNITY_SKELETONGRAPHICCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18329600)
