...
#define SPINE_UNITY_SPINEANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x168D2C10)

namespace Spine::Unity
{
	inline static constexpr unsigned int SpineAnimation_TypeDefinitionIndex = 42290;
