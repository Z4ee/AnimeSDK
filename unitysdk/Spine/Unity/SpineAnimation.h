...
#define SPINE_UNITY_SPINEANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACDE230)

namespace Spine::Unity
{
	inline static constexpr unsigned int SpineAnimation_TypeDefinitionIndex = 41475;
