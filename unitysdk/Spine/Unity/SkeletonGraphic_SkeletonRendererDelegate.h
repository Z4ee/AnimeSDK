...
#define SPINE_UNITY_SKELETONGRAPHIC_SKELETONRENDERERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C181840)
#define SPINE_UNITY_SKELETONGRAPHIC_SKELETONRENDERERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C181870)
#define SPINE_UNITY_SKELETONGRAPHIC_SKELETONRENDERERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C17C0A0)
#define SPINE_UNITY_SKELETONGRAPHIC_SKELETONRENDERERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C164180)

namespace Spine::Unity
{
	inline static constexpr unsigned int SkeletonGraphic_SkeletonRendererDelegate_TypeDefinitionIndex = 40123;
