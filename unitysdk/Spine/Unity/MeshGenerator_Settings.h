...
#define SPINE_UNITY_MESHGENERATOR_SETTINGS_GET_DEFAULT_OFFSET UNITYSDK_OFFSET(0x19E3BB00)

namespace Spine::Unity
{
	inline static constexpr unsigned int MeshGenerator_Settings_TypeDefinitionIndex = 40637;
