...
#define SPINE_UNITY_MESHGENERATOR_SETTINGS_GET_DEFAULT_OFFSET UNITYSDK_OFFSET(0x1AD19B60)

namespace Spine::Unity
{
	inline static constexpr unsigned int MeshGenerator_Settings_TypeDefinitionIndex = 39507;
