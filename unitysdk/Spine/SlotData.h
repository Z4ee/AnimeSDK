...
#define SPINE_SLOTDATA_GET_ATTACHMENTNAME_OFFSET UNITYSDK_OFFSET(0x1E0FD830)
#define SPINE_SLOTDATA_GET_A_OFFSET UNITYSDK_OFFSET(0x1E0FD790)
#define SPINE_SLOTDATA_GET_B2_OFFSET UNITYSDK_OFFSET(0x1E0FD7F0)
#define SPINE_SLOTDATA_GET_BLENDMODE_OFFSET UNITYSDK_OFFSET(0x1E0FD850)
#define SPINE_SLOTDATA_GET_BONEDATA_OFFSET UNITYSDK_OFFSET(0x1E0FD720)
#define SPINE_SLOTDATA_GET_B_OFFSET UNITYSDK_OFFSET(0x1E0FD770)
#define SPINE_SLOTDATA_GET_G2_OFFSET UNITYSDK_OFFSET(0x1E0FD7D0)
#define SPINE_SLOTDATA_GET_G_OFFSET UNITYSDK_OFFSET(0x1E0FD750)
#define SPINE_SLOTDATA_GET_HASSECONDCOLOR_OFFSET UNITYSDK_OFFSET(0x1E0FD810)
#define SPINE_SLOTDATA_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x1E0FD700)
#define SPINE_SLOTDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1E0FD710)
#define SPINE_SLOTDATA_GET_R2_OFFSET UNITYSDK_OFFSET(0x1E0FD7B0)
#define SPINE_SLOTDATA_GET_R_OFFSET UNITYSDK_OFFSET(0x1E0FD730)
#define SPINE_SLOTDATA_SET_ATTACHMENTNAME_OFFSET UNITYSDK_OFFSET(0x1E0FD840)
#define SPINE_SLOTDATA_SET_A_OFFSET UNITYSDK_OFFSET(0x1E0FD7A0)
#define SPINE_SLOTDATA_SET_B2_OFFSET UNITYSDK_OFFSET(0x1E0FD800)
#define SPINE_SLOTDATA_SET_BLENDMODE_OFFSET UNITYSDK_OFFSET(0x1E0FD860)
#define SPINE_SLOTDATA_SET_B_OFFSET UNITYSDK_OFFSET(0x1E0FD780)
#define SPINE_SLOTDATA_SET_G2_OFFSET UNITYSDK_OFFSET(0x1E0FD7E0)
#define SPINE_SLOTDATA_SET_G_OFFSET UNITYSDK_OFFSET(0x1E0FD760)
#define SPINE_SLOTDATA_SET_HASSECONDCOLOR_OFFSET UNITYSDK_OFFSET(0x1E0FD820)
#define SPINE_SLOTDATA_SET_R2_OFFSET UNITYSDK_OFFSET(0x1E0FD7C0)
#define SPINE_SLOTDATA_SET_R_OFFSET UNITYSDK_OFFSET(0x1E0FD740)
#define SPINE_SLOTDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E0FD980)
#define SPINE_SLOTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0FD870)

namespace Spine
{
	inline static constexpr unsigned int SlotData_TypeDefinitionIndex = 32906;
