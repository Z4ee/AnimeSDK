...
#define SPINE_POLYGON_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1E5E3870)
#define SPINE_POLYGON_GET_VERTICES_OFFSET UNITYSDK_OFFSET(0x1E5E3850)
#define SPINE_POLYGON_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x1E5E3880)
#define SPINE_POLYGON_SET_VERTICES_OFFSET UNITYSDK_OFFSET(0x1E5E3860)
#define SPINE_POLYGON__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5E3890)

namespace Spine
{
	inline static constexpr unsigned int Polygon_TypeDefinitionIndex = 38393;
