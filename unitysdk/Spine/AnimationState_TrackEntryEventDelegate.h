...
#define SPINE_ANIMATIONSTATE_TRACKENTRYEVENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x14773290)
#define SPINE_ANIMATIONSTATE_TRACKENTRYEVENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x147732D0)
#define SPINE_ANIMATIONSTATE_TRACKENTRYEVENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1476C730)
#define SPINE_ANIMATIONSTATE_TRACKENTRYEVENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x147731A0)

namespace Spine
{
	inline static constexpr unsigned int AnimationState_TrackEntryEventDelegate_TypeDefinitionIndex = 37474;
