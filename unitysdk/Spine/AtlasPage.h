...
#define SPINE_ATLASPAGE_CLONE_OFFSET UNITYSDK_OFFSET(0x14777100)
#define SPINE_ATLASPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x14775170)

namespace Spine
{
	inline static constexpr unsigned int AtlasPage_TypeDefinitionIndex = 37490;
