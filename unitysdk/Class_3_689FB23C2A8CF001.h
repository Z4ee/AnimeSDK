...
#define CLASS_3_689FB23C2A8CF001_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17EA4470)
#define CLASS_3_689FB23C2A8CF001_METHOD_3_79DFE051D7769B1A_OFFSET UNITYSDK_OFFSET(0x17EA5660)
#define CLASS_3_689FB23C2A8CF001_METHOD_3_98D7467AE0BEC3C1_OFFSET UNITYSDK_OFFSET(0x17EA5540)
#define CLASS_3_689FB23C2A8CF001_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17EA4840)
#define CLASS_3_689FB23C2A8CF001__CTOR_OFFSET UNITYSDK_OFFSET(0x17EA4010)
...
{
public:
	::Class_3_07C3C4D2990C49EE* IEEKLAMGHKI; // 0x28
	::System::Action_1<::RPG::GameCore::GameEntity*>* CLOMEGLHGOE; // 0x30
	::Class_3_07C3C4D2990C49EE* IOIINLJHFHH; // 0x38
	::System::Action_1<::RPG::GameCore::GameEntity*>* LLHCINBIBMJ; // 0x40
	::Class_3_07C3C4D2990C49EE* KBLLLKLEIOD; // 0x48
	::Class_3_07C3C4D2990C49EE* FGKOGMMBNFG; // 0x50
	::RPG::GameCore::AvatarChangeTemplate* JILGFHGMAAC; // 0x58
	::Class_3_07C3C4D2990C49EE* OMBIIGIJFIA; // 0x60
	::Class_3_07C3C4D2990C49EE* FEINADIKCAB; // 0x68
