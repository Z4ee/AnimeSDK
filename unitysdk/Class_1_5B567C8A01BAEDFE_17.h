...
#define CLASS_1_5B567C8A01BAEDFE_17_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E9E2B80)
#define CLASS_1_5B567C8A01BAEDFE_17_CLONE_OFFSET UNITYSDK_OFFSET(0x1E9E2870)
#define CLASS_1_5B567C8A01BAEDFE_17_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E9E2980)
#define CLASS_1_5B567C8A01BAEDFE_17_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E9E28B0)
#define CLASS_1_5B567C8A01BAEDFE_17_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E9E2AE0)
#define CLASS_1_5B567C8A01BAEDFE_17_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E9E2BD0)
#define CLASS_1_5B567C8A01BAEDFE_17_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E9E2BA0)
#define CLASS_1_5B567C8A01BAEDFE_17_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E9E27F0)
#define CLASS_1_5B567C8A01BAEDFE_17_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E9E2820)
#define CLASS_1_5B567C8A01BAEDFE_17_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E9E2B10)
#define CLASS_1_5B567C8A01BAEDFE_17_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E9E2B70)
#define CLASS_1_5B567C8A01BAEDFE_17__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E9E2C20)
#define CLASS_1_5B567C8A01BAEDFE_17__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E9E2840)
#define CLASS_1_5B567C8A01BAEDFE_17__CTOR_OFFSET UNITYSDK_OFFSET(0x1E9E2830)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_17_TypeDefinitionIndex = 25798;

class Class_1_5B567C8A01BAEDFE_17 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_17*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_17*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_17_TypeDefinitionIndex)->GetStaticField(0x27290);
	}
