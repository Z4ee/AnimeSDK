...
#define CLASS_1_5B567C8A01BAEDFE_17_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1CB0A9E0)
#define CLASS_1_5B567C8A01BAEDFE_17_CLONE_OFFSET UNITYSDK_OFFSET(0x1CB0A6D0)
#define CLASS_1_5B567C8A01BAEDFE_17_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1CB0A7E0)
#define CLASS_1_5B567C8A01BAEDFE_17_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CB0A710)
#define CLASS_1_5B567C8A01BAEDFE_17_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CB0A940)
#define CLASS_1_5B567C8A01BAEDFE_17_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1CB0AA30)
#define CLASS_1_5B567C8A01BAEDFE_17_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1CB0AA00)
#define CLASS_1_5B567C8A01BAEDFE_17_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1CB0A650)
#define CLASS_1_5B567C8A01BAEDFE_17_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1CB0A680)
#define CLASS_1_5B567C8A01BAEDFE_17_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1CB0A970)
#define CLASS_1_5B567C8A01BAEDFE_17_WRITETO_OFFSET UNITYSDK_OFFSET(0x1CB0A9D0)
#define CLASS_1_5B567C8A01BAEDFE_17__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CB0AA80)
#define CLASS_1_5B567C8A01BAEDFE_17__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CB0A6A0)
#define CLASS_1_5B567C8A01BAEDFE_17__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB0A690)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_17_TypeDefinitionIndex = 25209;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_17*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_17_TypeDefinitionIndex)->GetStaticField(0x40800);
	}
