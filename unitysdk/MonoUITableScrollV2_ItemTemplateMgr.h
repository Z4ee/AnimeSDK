...
#define MONOUITABLESCROLLV2_ITEMTEMPLATEMGR_CLEAR_OFFSET UNITYSDK_OFFSET(0x11347950)
#define MONOUITABLESCROLLV2_ITEMTEMPLATEMGR_CREATESCROLLVIEWITEM_OFFSET UNITYSDK_OFFSET(0x11347060)
#define MONOUITABLESCROLLV2_ITEMTEMPLATEMGR_FLUSHALLTEMPRECYCLEITEMTORECYCLE_OFFSET UNITYSDK_OFFSET(0x11347710)
#define MONOUITABLESCROLLV2_ITEMTEMPLATEMGR_GETTEMPLATEDATA_OFFSET UNITYSDK_OFFSET(0x113473D0)
#define MONOUITABLESCROLLV2_ITEMTEMPLATEMGR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x11346FC0)
#define MONOUITABLESCROLLV2_ITEMTEMPLATEMGR__CTOR_OFFSET UNITYSDK_OFFSET(0x11346F30)

inline static constexpr unsigned int MonoUITableScrollV2_ItemTemplateMgr_TypeDefinitionIndex = 54101;
...
public:
	...
	::System::Collections::Generic::Dictionary_2<::Struct_2_FC34C7AD15A42B48, ::MonoUITableScrollV2_TemplateData*>* _templateDataDic; // 0x20
	::System::Func_2<::System::Int32, ::MoleMole::ScrollViewItemWidgetController*>* _templateCreateFuncByIndex; // 0x28
