...
#define CLASS_2_4C3F9D9CF221EFEC_METHOD_2_1E13A8A5C0FF7D62_OFFSET UNITYSDK_OFFSET(0xB452370)
#define CLASS_2_4C3F9D9CF221EFEC_METHOD_2_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0xB453BB0)
#define CLASS_2_4C3F9D9CF221EFEC_METHOD_2_7AEA4B2B25797605_OFFSET UNITYSDK_OFFSET(0xB452240)
#define CLASS_2_4C3F9D9CF221EFEC_METHOD_2_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xB453570)
#define CLASS_2_4C3F9D9CF221EFEC_METHOD_2_BB171E9B663A64F3_OFFSET UNITYSDK_OFFSET(0xB450170)
#define CLASS_2_4C3F9D9CF221EFEC_METHOD_2_C26C5619A2449105_OFFSET UNITYSDK_OFFSET(0xB453CA0)
#define CLASS_2_4C3F9D9CF221EFEC_METHOD_2_C969C48EB0DAEC25_OFFSET UNITYSDK_OFFSET(0xB450260)
#define CLASS_2_4C3F9D9CF221EFEC_METHOD_2_CB7D3E84357B1D80_OFFSET UNITYSDK_OFFSET(0xB452C80)
#define CLASS_2_4C3F9D9CF221EFEC_METHOD_2_DF3C54A5ADEABAF1_OFFSET UNITYSDK_OFFSET(0xB452640)
#define CLASS_2_4C3F9D9CF221EFEC__CTOR_1_OFFSET UNITYSDK_OFFSET(0xB450000)
#define CLASS_2_4C3F9D9CF221EFEC__CTOR_OFFSET UNITYSDK_OFFSET(0xB44FFE0)
...
public:
	...
	::Cinemachine::CinemachineBlendDefinition_Style NEBFPFNNEDG; // 0x50
	::System::Single BHEOFLPGHEO; // 0x54
	::RPG::GameCore::VCameraState GCKCLKLHAOM; // 0x58
	::System::Int32 OAIPLAHOEEK; // 0x5C
	::System::Single POPIILBCAHE; // 0x60
	::System::Single CAAHOEEJNMN; // 0x64
