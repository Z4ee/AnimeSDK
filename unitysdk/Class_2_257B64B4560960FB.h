...
#define CLASS_2_257B64B4560960FB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x179BB8D0)
#define CLASS_2_257B64B4560960FB_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x179BB910)
#define CLASS_2_257B64B4560960FB_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x179BBC50)
#define CLASS_2_257B64B4560960FB_TICK_OFFSET UNITYSDK_OFFSET(0x179BBCA0)
#define CLASS_2_257B64B4560960FB__CTOR_OFFSET UNITYSDK_OFFSET(0x179BB8C0)
...
{
public:
	::RPG::GameCore::SyncCharLightAndCameraDir* OFKGLJOAMLD; // 0x18
