...
#define CLASS_2_257B64B4560960FB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x154A5100)
#define CLASS_2_257B64B4560960FB_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x154A5140)
#define CLASS_2_257B64B4560960FB_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x154A5480)
#define CLASS_2_257B64B4560960FB_TICK_OFFSET UNITYSDK_OFFSET(0x154A54D0)
#define CLASS_2_257B64B4560960FB__CTOR_OFFSET UNITYSDK_OFFSET(0x154A50F0)

inline static constexpr unsigned int Class_2_257B64B4560960FB_TypeDefinitionIndex = 58909;

class Class_2_257B64B4560960FB : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::GameCore::SyncCharLightAndCameraDir* OFKGLJOAMLD; // 0x20
