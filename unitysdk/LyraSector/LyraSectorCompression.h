...
#define LYRASECTOR_LYRASECTORCOMPRESSION_DECODEDISTANCEFIELDBLOCKS_1_OFFSET UNITYSDK_OFFSET(0x1CEDFBF0)
#define LYRASECTOR_LYRASECTORCOMPRESSION_DECODEDISTANCEFIELDBLOCKS_OFFSET UNITYSDK_OFFSET(0x1CEDFB00)
#define LYRASECTOR_LYRASECTORCOMPRESSION_DECOMPRESSMEMORY_OFFSET UNITYSDK_OFFSET(0x1CEDF840)
#define LYRASECTOR_LYRASECTORCOMPRESSION_DECOMPRESSSECTOR_OFFSET UNITYSDK_OFFSET(0x1CEDF900)
#define LYRASECTOR_LYRASECTORCOMPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEDFCD0)

namespace LyraSector
{
	inline static constexpr unsigned int LyraSectorCompression_TypeDefinitionIndex = 27856;
