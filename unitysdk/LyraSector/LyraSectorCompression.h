...
#define LYRASECTOR_LYRASECTORCOMPRESSION_DECODEDISTANCEFIELDBLOCKS_1_OFFSET UNITYSDK_OFFSET(0x1BDA5310)
#define LYRASECTOR_LYRASECTORCOMPRESSION_DECODEDISTANCEFIELDBLOCKS_OFFSET UNITYSDK_OFFSET(0x1BDA5220)
#define LYRASECTOR_LYRASECTORCOMPRESSION_DECOMPRESSMEMORY_OFFSET UNITYSDK_OFFSET(0x1BDA4F70)
#define LYRASECTOR_LYRASECTORCOMPRESSION_DECOMPRESSSECTOR_OFFSET UNITYSDK_OFFSET(0x1BDA5020)
#define LYRASECTOR_LYRASECTORCOMPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDA53F0)

namespace LyraSector
{
	inline static constexpr unsigned int LyraSectorCompression_TypeDefinitionIndex = 26418;
