...
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_DISPATCHWITHTHREADCOUNT_1_OFFSET UNITYSDK_OFFSET(0x9A5920)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_DISPATCHWITHTHREADCOUNT_OFFSET UNITYSDK_OFFSET(0x9A58A0)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_DISPATCH_1_OFFSET UNITYSDK_OFFSET(0x9A5810)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_DISPATCH_OFFSET UNITYSDK_OFFSET(0x9A5790)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9A5780)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_FILLFLOATS_OFFSET UNITYSDK_OFFSET(0x9A5F80)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_FILLINTS_1_OFFSET UNITYSDK_OFFSET(0x9A5FA0)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_FILLINTS_OFFSET UNITYSDK_OFFSET(0x9A5F90)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETBUFFER_OFFSET UNITYSDK_OFFSET(0x9A59E0)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETFLOATS_1_OFFSET UNITYSDK_OFFSET(0x9A5DC0)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETFLOATS_OFFSET UNITYSDK_OFFSET(0x9A5B70)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETFLOAT_OFFSET UNITYSDK_OFFSET(0x9A5AF0)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETINTS_1_OFFSET UNITYSDK_OFFSET(0x9A5CD0)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETINTS_2_OFFSET UNITYSDK_OFFSET(0x9A5EA0)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETINTS_OFFSET UNITYSDK_OFFSET(0x9A5BF0)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETINT_OFFSET UNITYSDK_OFFSET(0x9A5A70)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x9A5A60)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x9A5770)

namespace LyraSector
{
	inline static constexpr unsigned int LyraSectorUtils_DispatchHelper_TypeDefinitionIndex = 27504;
