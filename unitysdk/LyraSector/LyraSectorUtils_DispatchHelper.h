...
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_DISPATCHWITHTHREADCOUNT_1_OFFSET UNITYSDK_OFFSET(0x95DD00)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_DISPATCHWITHTHREADCOUNT_OFFSET UNITYSDK_OFFSET(0x95DC70)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_DISPATCH_1_OFFSET UNITYSDK_OFFSET(0x95DBE0)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_DISPATCH_OFFSET UNITYSDK_OFFSET(0x95DB60)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x95DB50)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_FILLFLOATS_OFFSET UNITYSDK_OFFSET(0x95E330)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_FILLINTS_1_OFFSET UNITYSDK_OFFSET(0x95E350)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_FILLINTS_OFFSET UNITYSDK_OFFSET(0x95E340)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETBUFFER_OFFSET UNITYSDK_OFFSET(0x95DDC0)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETFLOATS_1_OFFSET UNITYSDK_OFFSET(0x95E190)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETFLOATS_OFFSET UNITYSDK_OFFSET(0x95DF50)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETFLOAT_OFFSET UNITYSDK_OFFSET(0x95DED0)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETINTS_1_OFFSET UNITYSDK_OFFSET(0x95E0A0)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETINTS_2_OFFSET UNITYSDK_OFFSET(0x95E260)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETINTS_OFFSET UNITYSDK_OFFSET(0x95DFD0)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETINT_OFFSET UNITYSDK_OFFSET(0x95DE50)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x95DE40)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x95DB40)

namespace LyraSector
{
	inline static constexpr unsigned int LyraSectorUtils_DispatchHelper_TypeDefinitionIndex = 26884;
