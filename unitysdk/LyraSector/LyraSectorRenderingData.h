...
#define LYRASECTOR_LYRASECTORRENDERINGDATA_EMPTY_OFFSET UNITYSDK_OFFSET(0x1CB02620)
#define LYRASECTOR_LYRASECTORRENDERINGDATA_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1CB028C0)
#define LYRASECTOR_LYRASECTORRENDERINGDATA_INIT_OFFSET UNITYSDK_OFFSET(0x1CB02680)
#define LYRASECTOR_LYRASECTORRENDERINGDATA_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1CB025B0)
#define LYRASECTOR_LYRASECTORRENDERINGDATA_RELEASE_OFFSET UNITYSDK_OFFSET(0x1CB029C0)
#define LYRASECTOR_LYRASECTORRENDERINGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB02A40)

namespace LyraSector
{
	inline static constexpr unsigned int LyraSectorRenderingData_TypeDefinitionIndex = 26972;
