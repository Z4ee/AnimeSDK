...
#define LYRASECTOR_LYRASPARSETREEBAKINGDATA_CLEAR_OFFSET UNITYSDK_OFFSET(0x1CEE1AD0)
#define LYRASECTOR_LYRASPARSETREEBAKINGDATA_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1CEE1B30)
#define LYRASECTOR_LYRASPARSETREEBAKINGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEE1A70)

namespace LyraSector
{
	inline static constexpr unsigned int LyraSparseTreeBakingData_TypeDefinitionIndex = 27256;

	class LyraSparseTreeBakingData : public ::System::Object
	{
	public:
		::Il2CppArray<::System::Byte>* m_NodeArrayData; // 0x10
		::Il2CppArray<::System::Byte>* m_EntityBufferData; // 0x18
