...
#define LYRASECTOR_LYRAPACKEDASSETSECTORDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xF794020)

namespace LyraSector
{
	inline static constexpr unsigned int LyraPackedAssetSectorData_TypeDefinitionIndex = 27147;
