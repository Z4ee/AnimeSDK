...
#define LYRASECTOR_LYRAPACKEDASSETSECTORDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x11090DF0)

namespace LyraSector
{
	inline static constexpr unsigned int LyraPackedAssetSectorData_TypeDefinitionIndex = 27754;
