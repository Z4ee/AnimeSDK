...
namespace LyraSector { template <typename T1, typename T2> class CollectionsUtils_PriorityQueue_2_UnorderedItemsCollection; }
...
{
	inline static constexpr unsigned int CollectionsUtils_PriorityQueue_2_TypeDefinitionIndex = 29672;
	...
	public:
		...
		::LyraSector::CollectionsUtils_PriorityQueue_2_UnorderedItemsCollection<TElement, TPriority>* _unorderedItems; // 0x0
