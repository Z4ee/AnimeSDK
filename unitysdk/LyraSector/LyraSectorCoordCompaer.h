...
#define LYRASECTOR_LYRASECTORCOORDCOMPAER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B7E6200)
#define LYRASECTOR_LYRASECTORCOORDCOMPAER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B7E6280)
#define LYRASECTOR_LYRASECTORCOORDCOMPAER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7E6300)

namespace LyraSector
{
	inline static constexpr unsigned int LyraSectorCoordCompaer_TypeDefinitionIndex = 26805;
