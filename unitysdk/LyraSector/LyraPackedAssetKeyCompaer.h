...
#define LYRASECTOR_LYRAPACKEDASSETKEYCOMPAER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AB81050)
#define LYRASECTOR_LYRAPACKEDASSETKEYCOMPAER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AB810D0)
#define LYRASECTOR_LYRAPACKEDASSETKEYCOMPAER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB81130)

namespace LyraSector
{
	inline static constexpr unsigned int LyraPackedAssetKeyCompaer_TypeDefinitionIndex = 29687;
