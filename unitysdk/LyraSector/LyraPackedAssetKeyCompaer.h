...
#define LYRASECTOR_LYRAPACKEDASSETKEYCOMPAER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CEE18C0)
#define LYRASECTOR_LYRAPACKEDASSETKEYCOMPAER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CEE1940)
#define LYRASECTOR_LYRAPACKEDASSETKEYCOMPAER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEE19A0)

namespace LyraSector
{
	inline static constexpr unsigned int LyraPackedAssetKeyCompaer_TypeDefinitionIndex = 26284;
