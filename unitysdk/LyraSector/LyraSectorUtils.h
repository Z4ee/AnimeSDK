...
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHCOMPUTESHADERWITHTHREADCOUNT_OFFSET UNITYSDK_OFFSET(0x1967D320)
#define LYRASECTOR_LYRASECTORUTILS_RELEASECOMPUTEBUFFER_1_OFFSET UNITYSDK_OFFSET(0x1967D010)
#define LYRASECTOR_LYRASECTORUTILS_RELEASECOMPUTEBUFFER_OFFSET UNITYSDK_OFFSET(0x1967D120)
#define LYRASECTOR_LYRASECTORUTILS_RELEASERT_1_OFFSET UNITYSDK_OFFSET(0x1967D2D0)
#define LYRASECTOR_LYRASECTORUTILS_RELEASERT_OFFSET UNITYSDK_OFFSET(0x1967D170)
#define LYRASECTOR_LYRASECTORUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x1967D480)

namespace LyraSector
{
	inline static constexpr unsigned int LyraSectorUtils_TypeDefinitionIndex = 29682;
