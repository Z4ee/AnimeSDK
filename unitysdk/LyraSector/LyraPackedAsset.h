...
#define LYRASECTOR_LYRAPACKEDASSET_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1A680520)
#define LYRASECTOR_LYRAPACKEDASSET_GETCOORDTOLYRACOMPRESSEDASSETDATA_OFFSET UNITYSDK_OFFSET(0x1A6804C0)
#define LYRASECTOR_LYRAPACKEDASSET_GETLYRAPACKEDASSETSECTORDATAWITHOUTCHECK_OFFSET UNITYSDK_OFFSET(0x1A680600)
#define LYRASECTOR_LYRAPACKEDASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6803A0)

namespace LyraSector
{
	inline static constexpr unsigned int LyraPackedAsset_TypeDefinitionIndex = 29678;
