...
#define LYRASECTOR_LYRASECTORBINARYUTILS_READUINT_OFFSET UNITYSDK_OFFSET(0x1BBFF2C0)
#define LYRASECTOR_LYRASECTORBINARYUTILS_WRITEUINT_OFFSET UNITYSDK_OFFSET(0x1BBFF3A0)
#define LYRASECTOR_LYRASECTORBINARYUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBFF480)

namespace LyraSector
{
	inline static constexpr unsigned int LyraSectorBinaryUtils_TypeDefinitionIndex = 27015;
