...
#define LYRASECTOR_LYRASECTORBINARYUTILS_READUINT_OFFSET UNITYSDK_OFFSET(0x1C97B340)
#define LYRASECTOR_LYRASECTORBINARYUTILS_WRITEUINT_OFFSET UNITYSDK_OFFSET(0x1C97B430)
#define LYRASECTOR_LYRASECTORBINARYUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C97B510)

namespace LyraSector
{
	inline static constexpr unsigned int LyraSectorBinaryUtils_TypeDefinitionIndex = 27499;
