...
#define LYRASECTOR_LYRASPARSETREEBAKEDDATA_EMPTY_OFFSET UNITYSDK_OFFSET(0x1B066A30)
#define LYRASECTOR_LYRASPARSETREEBAKEDDATA_INITOFFSET_1_OFFSET UNITYSDK_OFFSET(0x1B066B70)
#define LYRASECTOR_LYRASPARSETREEBAKEDDATA_INITOFFSET_2_OFFSET UNITYSDK_OFFSET(0x1B066BD0)
#define LYRASECTOR_LYRASPARSETREEBAKEDDATA_INITOFFSET_OFFSET UNITYSDK_OFFSET(0x1B066B20)
#define LYRASECTOR_LYRASPARSETREEBAKEDDATA_SETBUFFERDATA_OFFSET UNITYSDK_OFFSET(0x1B066A80)
#define LYRASECTOR_LYRASPARSETREEBAKEDDATA_SETOFFSET_OFFSET UNITYSDK_OFFSET(0x1B066C40)
#define LYRASECTOR_LYRASPARSETREEBAKEDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B066CA0)

namespace LyraSector
{
	inline static constexpr unsigned int LyraSparseTreeBakedData_TypeDefinitionIndex = 27077;

	class LyraSparseTreeBakedData : public ::System::Object
	{
	public:
		::Il2CppArray<::System::Byte>* m_PackedData; // 0x10
		::System::Int32 m_EntityBufferSize; // 0x18
		::System::Int32 m_EmissionNodeArrayOffset; // 0x1C
		::System::Int32 m_NodeArrayStart; // 0x20
		::System::Int32 m_EntityBufferStart; // 0x24
