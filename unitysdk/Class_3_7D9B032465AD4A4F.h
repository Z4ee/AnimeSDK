...
#define CLASS_3_7D9B032465AD4A4F_METHOD_3_2BFFBF98C91CC35A_OFFSET UNITYSDK_OFFSET(0xF658F10)
#define CLASS_3_7D9B032465AD4A4F_METHOD_3_477285AA0EB5D09E_OFFSET UNITYSDK_OFFSET(0xF65CFA0)
#define CLASS_3_7D9B032465AD4A4F_METHOD_3_57DEEF0473E5D15B_OFFSET UNITYSDK_OFFSET(0xF65A050)
#define CLASS_3_7D9B032465AD4A4F_METHOD_3_BBA7EBF9B96E46D9_OFFSET UNITYSDK_OFFSET(0xF65E000)
#define CLASS_3_7D9B032465AD4A4F_METHOD_3_CD05B8ECB87653A3_OFFSET UNITYSDK_OFFSET(0xF65BFB0)
#define CLASS_3_7D9B032465AD4A4F_METHOD_3_EB6544F57081E06F_OFFSET UNITYSDK_OFFSET(0xF65AD70)
#define CLASS_3_7D9B032465AD4A4F_TOSTRING_OFFSET UNITYSDK_OFFSET(0x133F5600)
#define CLASS_3_7D9B032465AD4A4F__CTOR_OFFSET UNITYSDK_OFFSET(0xF658D50)

inline static constexpr unsigned int Class_3_7D9B032465AD4A4F_TypeDefinitionIndex = 80822;

class Class_3_7D9B032465AD4A4F : public ::Class_2_B0798E1629E01207<::UnityEngine::Rendering::Universal::Distortion*, ::MoleMole::Config::ConfigEntityDistortionEffect*>
{
public:
	::MoleMole::TwoValue_1<::System::Boolean>* Field_3_9; // 0xA8
	::MoleMole::TwoValue_1<::System::Int32>* Field_3_1; // 0xB0
	::MoleMole::TwoValue_1<::UnityEngine::NAPRenderPipeline0::DistortionQueueType>* Field_3_13; // 0xB8
	::MoleMole::TwoValue_1<::System::Single>* Field_3_7; // 0xC0
	::MoleMole::TwoValue_1<::System::Boolean>* Field_3_15; // 0xC8
	::MoleMole::TwoValue_1<::System::Single>* Field_3_11; // 0xD0
	::MoleMole::TwoValue_1<::UnityEngine::Vector3>* Field_3_5; // 0xD8
	::UnityEngine::NAPRenderPipeline0::DistortionQueueType Field_3_12; // 0xE0
	::UnityEngine::Vector3 Field_3_4; // 0xE4
	::System::Int32 Field_3_0; // 0xF0
	::System::Single Field_3_10; // 0xF4
	::System::Boolean Field_3_8; // 0xF8
	::System::Boolean Field_3_14; // 0xF9
	...
	::System::Void Method_3_BBA7EBF9B96E46D9(::UnityEngine::NAPRenderPipeline0::VolumeProfile_NativeSRP* a1, ::UnityEngine::Rendering::Universal::Distortion* a2, ::System::Boolean a3)
	{
		return ((::System::Void(*)(::PVOID, ::UnityEngine::NAPRenderPipeline0::VolumeProfile_NativeSRP*, ::UnityEngine::Rendering::Universal::Distortion*, ::System::Boolean))((::PBYTE)hIl2Cpp + CLASS_3_7D9B032465AD4A4F_METHOD_3_BBA7EBF9B96E46D9_OFFSET))(this, a1, a2, a3);
	}
