...
#define CLASS_2_2E49551FDF3C7C14_DISPOSE_OFFSET UNITYSDK_OFFSET(0x141E3050)
#define CLASS_2_2E49551FDF3C7C14_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x141E3090)
#define CLASS_2_2E49551FDF3C7C14_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x141E30F0)
#define CLASS_2_2E49551FDF3C7C14_TICK_OFFSET UNITYSDK_OFFSET(0x141E3140)
#define CLASS_2_2E49551FDF3C7C14__CTOR_OFFSET UNITYSDK_OFFSET(0x141E3040)

inline static constexpr unsigned int Class_2_2E49551FDF3C7C14_TypeDefinitionIndex = 54811;

class Class_2_2E49551FDF3C7C14 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::ShowMainPageHint* Field_2_1; // 0x20
