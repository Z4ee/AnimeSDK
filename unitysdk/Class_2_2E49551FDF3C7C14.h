...
#define CLASS_2_2E49551FDF3C7C14_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1615A8C0)
#define CLASS_2_2E49551FDF3C7C14_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1615A900)
#define CLASS_2_2E49551FDF3C7C14_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1615A960)
#define CLASS_2_2E49551FDF3C7C14_TICK_OFFSET UNITYSDK_OFFSET(0x1615A9B0)
#define CLASS_2_2E49551FDF3C7C14__CTOR_OFFSET UNITYSDK_OFFSET(0x1615A8B0)
