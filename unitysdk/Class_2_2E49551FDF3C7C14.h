...
#define CLASS_2_2E49551FDF3C7C14_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11814DD0)
#define CLASS_2_2E49551FDF3C7C14_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11814E10)
#define CLASS_2_2E49551FDF3C7C14_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11814E70)
#define CLASS_2_2E49551FDF3C7C14_TICK_OFFSET UNITYSDK_OFFSET(0x11814EC0)
#define CLASS_2_2E49551FDF3C7C14__CTOR_OFFSET UNITYSDK_OFFSET(0x11814DC0)

inline static constexpr unsigned int Class_2_2E49551FDF3C7C14_TypeDefinitionIndex = 47350;

class Class_2_2E49551FDF3C7C14 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::ShowMainPageHint* Field_2_0; // 0x20
