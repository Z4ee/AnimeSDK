...
#define STRUCT_2_B9E6DC87D4879FCD_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3B9D6C0)
#define STRUCT_2_B9E6DC87D4879FCD_EQUALS_OFFSET UNITYSDK_OFFSET(0x3B9D600)
#define STRUCT_2_B9E6DC87D4879FCD_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3B9D6D0)
#define STRUCT_2_B9E6DC87D4879FCD_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3B9D5F0)
#define STRUCT_2_B9E6DC87D4879FCD__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3B9D5E0)
#define STRUCT_2_B9E6DC87D4879FCD__CTOR_2_OFFSET UNITYSDK_OFFSET(0x2EFFD60)
#define STRUCT_2_B9E6DC87D4879FCD__CTOR_OFFSET UNITYSDK_OFFSET(0x3B9D5C0)

inline static constexpr unsigned int Struct_2_B9E6DC87D4879FCD_TypeDefinitionIndex = 42475;

struct alignas(8) Struct_2_B9E6DC87D4879FCD
{
	::System::Type* BBJDHCHNAKN; // 0x10
	::System::String* MBCACNKDMFG; // 0x18
	::System::Boolean AKCBGCGDPPB; // 0x20
