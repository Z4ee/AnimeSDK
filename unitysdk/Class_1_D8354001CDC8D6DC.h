...
#define CLASS_1_D8354001CDC8D6DC_GET_ASYNCLATENCYWINDOWSIZE_OFFSET UNITYSDK_OFFSET(0x183F2640)
#define CLASS_1_D8354001CDC8D6DC_GET_DEFAULTTOPN_OFFSET UNITYSDK_OFFSET(0x183F2660)
#define CLASS_1_D8354001CDC8D6DC_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x183F2620)
#define CLASS_1_D8354001CDC8D6DC_SET_ASYNCLATENCYWINDOWSIZE_OFFSET UNITYSDK_OFFSET(0x183F2650)
#define CLASS_1_D8354001CDC8D6DC_SET_DEFAULTTOPN_OFFSET UNITYSDK_OFFSET(0x183F2670)
#define CLASS_1_D8354001CDC8D6DC_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x183F2630)
#define CLASS_1_D8354001CDC8D6DC__CTOR_OFFSET UNITYSDK_OFFSET(0x183F2680)

inline static constexpr unsigned int Class_1_D8354001CDC8D6DC_TypeDefinitionIndex = 73885;
