...
#define CLASS_1_A1EDFD8801F68886_GET_ATTACHPOINTCONFIG_OFFSET UNITYSDK_OFFSET(0x18229680)
#define CLASS_1_A1EDFD8801F68886_GET_ATTACHPOINTS_OFFSET UNITYSDK_OFFSET(0x18229780)
#define CLASS_1_A1EDFD8801F68886_GET_CHILDRENIDS_OFFSET UNITYSDK_OFFSET(0x18229540)
#define CLASS_1_A1EDFD8801F68886_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x182297A0)
#define CLASS_1_A1EDFD8801F68886_GET_CUSTOMLOADCONFIG_OFFSET UNITYSDK_OFFSET(0x182296E0)
#define CLASS_1_A1EDFD8801F68886_GET_CUSTOMVISIBILITYCONFIG_OFFSET UNITYSDK_OFFSET(0x18229700)
#define CLASS_1_A1EDFD8801F68886_GET_ENTITYVARCONFIG_OFFSET UNITYSDK_OFFSET(0x18229720)
#define CLASS_1_A1EDFD8801F68886_GET_ICONCONFIG_OFFSET UNITYSDK_OFFSET(0x18229640)
#define CLASS_1_A1EDFD8801F68886_GET_ISLOADEDINNAV_OFFSET UNITYSDK_OFFSET(0x18229580)
#define CLASS_1_A1EDFD8801F68886_GET_ISLOADED_OFFSET UNITYSDK_OFFSET(0x18229560)
#define CLASS_1_A1EDFD8801F68886_GET_ISLOCKED_OFFSET UNITYSDK_OFFSET(0x182295C0)
#define CLASS_1_A1EDFD8801F68886_GET_ISSURFACE_OFFSET UNITYSDK_OFFSET(0x182294B0)
#define CLASS_1_A1EDFD8801F68886_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x182295A0)
#define CLASS_1_A1EDFD8801F68886_GET_LITTLEGAMETAGCONFIG_OFFSET UNITYSDK_OFFSET(0x18229740)
#define CLASS_1_A1EDFD8801F68886_GET_LOCALTRANSFORM_OFFSET UNITYSDK_OFFSET(0x182292B0)
#define CLASS_1_A1EDFD8801F68886_GET_MAPFACECONNECTCONFIG_OFFSET UNITYSDK_OFFSET(0x18229660)
#define CLASS_1_A1EDFD8801F68886_GET_PARENTID_OFFSET UNITYSDK_OFFSET(0x18229520)
#define CLASS_1_A1EDFD8801F68886_GET_PIPEPORTALCONFIG_OFFSET UNITYSDK_OFFSET(0x182296A0)
#define CLASS_1_A1EDFD8801F68886_GET_PORTALCONFIG_OFFSET UNITYSDK_OFFSET(0x182296C0)
#define CLASS_1_A1EDFD8801F68886_GET_SURFACECONFIG_OFFSET UNITYSDK_OFFSET(0x18229760)
#define CLASS_1_A1EDFD8801F68886_GET_SURFACEID_OFFSET UNITYSDK_OFFSET(0x18229490)
#define CLASS_1_A1EDFD8801F68886_GET_SURFACERELATIVETRANSFORM_OFFSET UNITYSDK_OFFSET(0x182293F0)
#define CLASS_1_A1EDFD8801F68886_GET_WORLDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x18229350)
#define CLASS_1_A1EDFD8801F68886_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x182295E0)
#define CLASS_1_A1EDFD8801F68886_METHOD_1_AA2D3E889C8A52CA_OFFSET UNITYSDK_OFFSET(0x182294D0)
#define CLASS_1_A1EDFD8801F68886_SET_ATTACHPOINTCONFIG_OFFSET UNITYSDK_OFFSET(0x18229690)
#define CLASS_1_A1EDFD8801F68886_SET_ATTACHPOINTS_OFFSET UNITYSDK_OFFSET(0x18229790)
#define CLASS_1_A1EDFD8801F68886_SET_CHILDRENIDS_OFFSET UNITYSDK_OFFSET(0x18229550)
#define CLASS_1_A1EDFD8801F68886_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x182297B0)
#define CLASS_1_A1EDFD8801F68886_SET_CUSTOMLOADCONFIG_OFFSET UNITYSDK_OFFSET(0x182296F0)
#define CLASS_1_A1EDFD8801F68886_SET_CUSTOMVISIBILITYCONFIG_OFFSET UNITYSDK_OFFSET(0x18229710)
#define CLASS_1_A1EDFD8801F68886_SET_ENTITYVARCONFIG_OFFSET UNITYSDK_OFFSET(0x18229730)
#define CLASS_1_A1EDFD8801F68886_SET_ICONCONFIG_OFFSET UNITYSDK_OFFSET(0x18229650)
#define CLASS_1_A1EDFD8801F68886_SET_ISLOADEDINNAV_OFFSET UNITYSDK_OFFSET(0x18229590)
#define CLASS_1_A1EDFD8801F68886_SET_ISLOADED_OFFSET UNITYSDK_OFFSET(0x18229570)
#define CLASS_1_A1EDFD8801F68886_SET_ISLOCKED_OFFSET UNITYSDK_OFFSET(0x182295D0)
#define CLASS_1_A1EDFD8801F68886_SET_ISSURFACE_OFFSET UNITYSDK_OFFSET(0x182294C0)
#define CLASS_1_A1EDFD8801F68886_SET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x182295B0)
#define CLASS_1_A1EDFD8801F68886_SET_LITTLEGAMETAGCONFIG_OFFSET UNITYSDK_OFFSET(0x18229750)
#define CLASS_1_A1EDFD8801F68886_SET_LOCALTRANSFORM_OFFSET UNITYSDK_OFFSET(0x18229300)
#define CLASS_1_A1EDFD8801F68886_SET_MAPFACECONNECTCONFIG_OFFSET UNITYSDK_OFFSET(0x18229670)
#define CLASS_1_A1EDFD8801F68886_SET_PARENTID_OFFSET UNITYSDK_OFFSET(0x18229530)
#define CLASS_1_A1EDFD8801F68886_SET_PIPEPORTALCONFIG_OFFSET UNITYSDK_OFFSET(0x182296B0)
#define CLASS_1_A1EDFD8801F68886_SET_PORTALCONFIG_OFFSET UNITYSDK_OFFSET(0x182296D0)
#define CLASS_1_A1EDFD8801F68886_SET_SURFACECONFIG_OFFSET UNITYSDK_OFFSET(0x18229770)
#define CLASS_1_A1EDFD8801F68886_SET_SURFACEID_OFFSET UNITYSDK_OFFSET(0x182294A0)
#define CLASS_1_A1EDFD8801F68886_SET_SURFACERELATIVETRANSFORM_OFFSET UNITYSDK_OFFSET(0x18229440)
#define CLASS_1_A1EDFD8801F68886_SET_WORLDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x182293A0)
#define CLASS_1_A1EDFD8801F68886__CTOR_OFFSET UNITYSDK_OFFSET(0x182297C0)
...
{
public:
	::RPG::GameCore::FiveDimNavMapSurfaceConnectConfig* _MapFaceConnectConfig_k__BackingField; // 0x10
	::RPG::GameCore::LittleGameTagConfig* _LittleGameTagConfig_k__BackingField; // 0x18
	::RPG::GameCore::LittleGameEntityConfig* _Config_k__BackingField; // 0x20
	::RPG::GameCore::FiveDimPortalConfig* _PortalConfig_k__BackingField; // 0x28
	::RPG::GameCore::FiveDimCustomVisibilityConfig* _CustomVisibilityConfig_k__BackingField; // 0x30
	::System::Collections::Generic::List_1<::System::UInt32>* _ChildrenIDs_k__BackingField; // 0x38
	::RPG::GameCore::FiveDimEntityVarConfig* _EntityVarConfig_k__BackingField; // 0x40
	::RPG::GameCore::FiveDimSurfaceConfig* _SurfaceConfig_k__BackingField; // 0x48
	::RPG::GameCore::LittleGameNavMapIconConfig* _IconConfig_k__BackingField; // 0x50
	::RPG::GameCore::FiveDimCustomLoadConfig* _CustomLoadConfig_k__BackingField; // 0x58
	::RPG::GameCore::LittleGameAttachPointConfig* _AttachPointConfig_k__BackingField; // 0x60
	::System::Collections::Generic::Dictionary_2<::System::String*, ::Struct_2_EAC1BB0F093534A5>* _AttachPoints_k__BackingField; // 0x68
	::RPG::GameCore::FiveDimPipePortalConfig* _PipePortalConfig_k__BackingField; // 0x70
	::Struct_2_EAC1BB0F093534A5 _WorldTransform_k__BackingField; // 0x78
	::Struct_2_EAC1BB0F093534A5 _SurfaceRelativeTransform_k__BackingField; // 0xE0
	::Struct_2_EAC1BB0F093534A5 _LocalTransform_k__BackingField; // 0x148
	::System::Boolean _IsLoadedInNav_k__BackingField; // 0x1B0
	::System::Boolean _IsLoaded_k__BackingField; // 0x1B1
	::System::Boolean _IsLocked_k__BackingField; // 0x1B2
	::System::UInt32 _SurfaceID_k__BackingField; // 0x1B4
	::System::UInt32 _ParentID_k__BackingField; // 0x1B8
	::System::Boolean _IsSurface_k__BackingField; // 0x1BC
	::System::Boolean _IsVisible_k__BackingField; // 0x1BD
