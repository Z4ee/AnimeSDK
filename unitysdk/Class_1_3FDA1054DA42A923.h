...
#define CLASS_1_3FDA1054DA42A923_GET_ISFADEIN_OFFSET UNITYSDK_OFFSET(0x160C1870)
#define CLASS_1_3FDA1054DA42A923_GET_ISWIN_OFFSET UNITYSDK_OFFSET(0x160C1890)
#define CLASS_1_3FDA1054DA42A923_GET_ONCOMPLETE_OFFSET UNITYSDK_OFFSET(0x160C18B0)
#define CLASS_1_3FDA1054DA42A923_SET_ISFADEIN_OFFSET UNITYSDK_OFFSET(0x160C1880)
#define CLASS_1_3FDA1054DA42A923_SET_ISWIN_OFFSET UNITYSDK_OFFSET(0x160C18A0)
#define CLASS_1_3FDA1054DA42A923_SET_ONCOMPLETE_OFFSET UNITYSDK_OFFSET(0x160C18C0)
#define CLASS_1_3FDA1054DA42A923__CTOR_OFFSET UNITYSDK_OFFSET(0x160C1860)

inline static constexpr unsigned int Class_1_3FDA1054DA42A923_TypeDefinitionIndex = 78546;
