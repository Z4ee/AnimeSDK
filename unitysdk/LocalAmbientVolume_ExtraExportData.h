...
#define LOCALAMBIENTVOLUME_EXTRAEXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x90BAFF0)

inline static constexpr unsigned int LocalAmbientVolume_ExtraExportData_TypeDefinitionIndex = 44214;
