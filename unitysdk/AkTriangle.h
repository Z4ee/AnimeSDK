...
#define AKTRIANGLE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1D2D4FD0)
#define AKTRIANGLE_CLONE_OFFSET UNITYSDK_OFFSET(0x1D2D5130)
#define AKTRIANGLE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1D2D4AD0)
#define AKTRIANGLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D2D48E0)
#define AKTRIANGLE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1D2D4A00)
#define AKTRIANGLE_GETCPTR_OFFSET UNITYSDK_OFFSET(0x1D2D4830)
#define AKTRIANGLE_GETSIZEOF_OFFSET UNITYSDK_OFFSET(0x1D2D5080)
#define AKTRIANGLE_GET_POINT0_OFFSET UNITYSDK_OFFSET(0x1D2CB770)
#define AKTRIANGLE_GET_POINT1_OFFSET UNITYSDK_OFFSET(0x1D2CB820)
#define AKTRIANGLE_GET_POINT2_OFFSET UNITYSDK_OFFSET(0x1D2CB8D0)
#define AKTRIANGLE_GET_SURFACE_OFFSET UNITYSDK_OFFSET(0x1D2D4F20)
#define AKTRIANGLE_SETCPTR_OFFSET UNITYSDK_OFFSET(0x1D2D4880)
#define AKTRIANGLE_SET_POINT0_OFFSET UNITYSDK_OFFSET(0x1D2CB470)
#define AKTRIANGLE_SET_POINT1_OFFSET UNITYSDK_OFFSET(0x1D2CB530)
#define AKTRIANGLE_SET_POINT2_OFFSET UNITYSDK_OFFSET(0x1D2CB5F0)
#define AKTRIANGLE_SET_SURFACE_OFFSET UNITYSDK_OFFSET(0x1D2CB6B0)
#define AKTRIANGLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D2D4CB0)
#define AKTRIANGLE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D2D4D30)
#define AKTRIANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2D4820)
