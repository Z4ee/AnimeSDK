...
#define AKTRIANGLE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A66B370)
#define AKTRIANGLE_CLONE_OFFSET UNITYSDK_OFFSET(0x1A66B4D0)
#define AKTRIANGLE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1A66AEB0)
#define AKTRIANGLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A66ADC0)
#define AKTRIANGLE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A66AE40)
#define AKTRIANGLE_GETCPTR_OFFSET UNITYSDK_OFFSET(0x1A66ACB0)
#define AKTRIANGLE_GETSIZEOF_OFFSET UNITYSDK_OFFSET(0x1A66B420)
#define AKTRIANGLE_GET_POINT0_OFFSET UNITYSDK_OFFSET(0x1A661BB0)
#define AKTRIANGLE_GET_POINT1_OFFSET UNITYSDK_OFFSET(0x1A661C60)
#define AKTRIANGLE_GET_POINT2_OFFSET UNITYSDK_OFFSET(0x1A661D10)
#define AKTRIANGLE_GET_SURFACE_OFFSET UNITYSDK_OFFSET(0x1A66B2C0)
#define AKTRIANGLE_SETCPTR_OFFSET UNITYSDK_OFFSET(0x1A66AD00)
#define AKTRIANGLE_SET_POINT0_OFFSET UNITYSDK_OFFSET(0x1A6618B0)
#define AKTRIANGLE_SET_POINT1_OFFSET UNITYSDK_OFFSET(0x1A661970)
#define AKTRIANGLE_SET_POINT2_OFFSET UNITYSDK_OFFSET(0x1A661A30)
#define AKTRIANGLE_SET_SURFACE_OFFSET UNITYSDK_OFFSET(0x1A661AF0)
#define AKTRIANGLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A66B050)
#define AKTRIANGLE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A66B0D0)
#define AKTRIANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A66ACA0)

inline static constexpr unsigned int AkTriangle_TypeDefinitionIndex = 40349;
