...
#define CARFLOWROADMAPPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0xACF8AF0)

inline static constexpr unsigned int CarFlowRoadMapPosition_TypeDefinitionIndex = 43883;
