...
#define CLASS_1_8E457B48C75D1A3E_EXECUTE_OFFSET UNITYSDK_OFFSET(0x15249260)
#define CLASS_1_8E457B48C75D1A3E_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x152479B0)
#define CLASS_1_8E457B48C75D1A3E_METHOD_1_256DE5D46644182A_OFFSET UNITYSDK_OFFSET(0x15247D10)
#define CLASS_1_8E457B48C75D1A3E_METHOD_1_4F90720896143030_OFFSET UNITYSDK_OFFSET(0x15248720)
#define CLASS_1_8E457B48C75D1A3E_TEARDOWN_OFFSET UNITYSDK_OFFSET(0x15248E70)
#define CLASS_1_8E457B48C75D1A3E__CTOR_OFFSET UNITYSDK_OFFSET(0x152478E0)

inline static constexpr unsigned int Class_1_8E457B48C75D1A3E_TypeDefinitionIndex = 76699;

class Class_1_8E457B48C75D1A3E : public ::System::Object
{
public:
	::Class_1_B4357A1C72BABC6B* FKINCGODJEP; // 0x10
	::Entitas::ICollector_1<::Class_2_B9E8C2EEAA5C96EC*>* NPNPNIAIMLO; // 0x18
