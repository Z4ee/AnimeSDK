...
#define BRIGHTSPOTSFLARERESOURCES_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C4C7440)
#define BRIGHTSPOTSFLARERESOURCES_ENSUREBUFFERS_OFFSET UNITYSDK_OFFSET(0x1C4C72E0)
#define BRIGHTSPOTSFLARERESOURCES_GET_DRAWARGSBUFFER_OFFSET UNITYSDK_OFFSET(0x1C4C7170)
#define BRIGHTSPOTSFLARERESOURCES_GET_FLAREMATERIAL_OFFSET UNITYSDK_OFFSET(0x1C4C7190)
#define BRIGHTSPOTSFLARERESOURCES_GET_HASFLARE_OFFSET UNITYSDK_OFFSET(0x1C4C71B0)
#define BRIGHTSPOTSFLARERESOURCES_INIT_OFFSET UNITYSDK_OFFSET(0x1C4C71D0)
#define BRIGHTSPOTSFLARERESOURCES_RESETDRAWARGS_OFFSET UNITYSDK_OFFSET(0x1C4C73A0)
#define BRIGHTSPOTSFLARERESOURCES_SETHASFLARE_OFFSET UNITYSDK_OFFSET(0x1C4C7290)
#define BRIGHTSPOTSFLARERESOURCES_SET_DRAWARGSBUFFER_OFFSET UNITYSDK_OFFSET(0x1C4C7180)
#define BRIGHTSPOTSFLARERESOURCES_SET_FLAREMATERIAL_OFFSET UNITYSDK_OFFSET(0x1C4C71A0)
#define BRIGHTSPOTSFLARERESOURCES_SET_HASFLARE_OFFSET UNITYSDK_OFFSET(0x1C4C71C0)
#define BRIGHTSPOTSFLARERESOURCES__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C4C74B0)
#define BRIGHTSPOTSFLARERESOURCES__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4C74A0)

inline static constexpr unsigned int BrightSpotsFlareResources_TypeDefinitionIndex = 27260;
...
public:
	...
	{
		return (::Il2CppArray<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(BrightSpotsFlareResources_TypeDefinitionIndex)->GetStaticField(0x23300);
	}
