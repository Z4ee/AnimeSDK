...
#define BRIGHTSPOTSFLARERESOURCES_DISPOSE_OFFSET UNITYSDK_OFFSET(0x190FDC60)
#define BRIGHTSPOTSFLARERESOURCES_ENSUREBUFFERS_OFFSET UNITYSDK_OFFSET(0x190FDB00)
#define BRIGHTSPOTSFLARERESOURCES_GET_DRAWARGSBUFFER_OFFSET UNITYSDK_OFFSET(0x190FD990)
#define BRIGHTSPOTSFLARERESOURCES_GET_FLAREMATERIAL_OFFSET UNITYSDK_OFFSET(0x190FD9B0)
#define BRIGHTSPOTSFLARERESOURCES_GET_HASFLARE_OFFSET UNITYSDK_OFFSET(0x190FD9D0)
#define BRIGHTSPOTSFLARERESOURCES_INIT_OFFSET UNITYSDK_OFFSET(0x190FD9F0)
#define BRIGHTSPOTSFLARERESOURCES_RESETDRAWARGS_OFFSET UNITYSDK_OFFSET(0x190FDBC0)
#define BRIGHTSPOTSFLARERESOURCES_SETHASFLARE_OFFSET UNITYSDK_OFFSET(0x190FDAB0)
#define BRIGHTSPOTSFLARERESOURCES_SET_DRAWARGSBUFFER_OFFSET UNITYSDK_OFFSET(0x190FD9A0)
#define BRIGHTSPOTSFLARERESOURCES_SET_FLAREMATERIAL_OFFSET UNITYSDK_OFFSET(0x190FD9C0)
#define BRIGHTSPOTSFLARERESOURCES_SET_HASFLARE_OFFSET UNITYSDK_OFFSET(0x190FD9E0)
#define BRIGHTSPOTSFLARERESOURCES__CCTOR_OFFSET UNITYSDK_OFFSET(0x190FDCD0)
#define BRIGHTSPOTSFLARERESOURCES__CTOR_OFFSET UNITYSDK_OFFSET(0x190FDCC0)

inline static constexpr unsigned int BrightSpotsFlareResources_TypeDefinitionIndex = 29604;
...
public:
	...
	{
		return (::Il2CppArray<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(BrightSpotsFlareResources_TypeDefinitionIndex)->GetStaticField(0x24350);
	}
	::UnityEngine::Material* _FlareMaterial_k__BackingField; // 0x10
	::UnityEngine::ComputeBuffer* _DrawArgsBuffer_k__BackingField; // 0x18
