...
#define CLASS_2_4734D0C87ABD9A97_DISPOSE_OFFSET UNITYSDK_OFFSET(0x113C4AD0)
#define CLASS_2_4734D0C87ABD9A97_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x113C5330)
#define CLASS_2_4734D0C87ABD9A97_METHOD_2_860EDB00E9DD5879_OFFSET UNITYSDK_OFFSET(0x113C4E20)
#define CLASS_2_4734D0C87ABD9A97_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x113C55E0)
#define CLASS_2_4734D0C87ABD9A97_ONSKIP_OFFSET UNITYSDK_OFFSET(0x113C5340)
#define CLASS_2_4734D0C87ABD9A97_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x113C4B70)
#define CLASS_2_4734D0C87ABD9A97_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x113C4B20)
#define CLASS_2_4734D0C87ABD9A97_TICK_OFFSET UNITYSDK_OFFSET(0x113C5200)
#define CLASS_2_4734D0C87ABD9A97__CTOR_OFFSET UNITYSDK_OFFSET(0x113C4AC0)

inline static constexpr unsigned int Class_2_4734D0C87ABD9A97_TypeDefinitionIndex = 42374;
...
public:
	...
	::RPG::GameCore::AdvEntityFaceToPoint* Field_2_1; // 0x28
