...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_ALLDUMMYMOVETOSTARTBY1_OFFSET UNITYSDK_OFFSET(0x116CC630)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_ALLOCATEDUMMY_1_OFFSET UNITYSDK_OFFSET(0x116CC800)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_ALLOCATEDUMMY_OFFSET UNITYSDK_OFFSET(0x116C9870)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_GETDATAINDEXBYITEMGO_OFFSET UNITYSDK_OFFSET(0x116CC3F0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_GETDUMMYTRANSBYDATAINDEX_OFFSET UNITYSDK_OFFSET(0x116CC4F0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_GET__DUMMYPOOL_OFFSET UNITYSDK_OFFSET(0x116C9020)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_GET__USINGDUMMYDIC_OFFSET UNITYSDK_OFFSET(0x116C99A0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_ONCLEARALLITEMDATAS_OFFSET UNITYSDK_OFFSET(0x116C8BF0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x116C8E10)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_RECYCLEALLDUMMY_OFFSET UNITYSDK_OFFSET(0x116C8C40)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_RECYCLEDUMMY_OFFSET UNITYSDK_OFFSET(0x116CC370)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_RECYCLETOOMUCHDUMMY_OFFSET UNITYSDK_OFFSET(0x116C7DA0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_REPLACEDUMMYTOREALGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x116C79B0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_TRYFINDFIRSTMATCHCANRECYCLESCROLLVIEWITEM_OFFSET UNITYSDK_OFFSET(0x116C90E0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_TRYFINDLASTMATCHCANRECYCLESCROLLVIEWITEM_OFFSET UNITYSDK_OFFSET(0x116C9A80)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_TRYRECYCLEDUMMY_OFFSET UNITYSDK_OFFSET(0x116CC270)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_TRYRECYCLESCROLLITEMFROMEND_OFFSET UNITYSDK_OFFSET(0x116C8330)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_TRYRECYCLESCROLLITEMFROMSTART_OFFSET UNITYSDK_OFFSET(0x116C7FA0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE__CTOR_OFFSET UNITYSDK_OFFSET(0x116C8BE0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE__RECYCLEDUMMY_OFFSET UNITYSDK_OFFSET(0x116CC180)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE__RECYCLETOOMUCHDUMMY_G__TRYRECYCLEFROMEND_6_1_OFFSET UNITYSDK_OFFSET(0x116CAF60)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE__RECYCLETOOMUCHDUMMY_G__TRYRECYCLEFROMSTART_6_0_OFFSET UNITYSDK_OFFSET(0x116CB7D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE__REPLACEDUMMYTOREALGAMEOBJECT_G__REPLACEALL_5_0_OFFSET UNITYSDK_OFFSET(0x116CA210)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE___BASE_ONCLEARALLITEMDATAS_OFFSET UNITYSDK_OFFSET(0x116CC950)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x116CC9E0)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginLazyRecycle_TypeDefinitionIndex = 69967;
