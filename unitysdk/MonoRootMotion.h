...
#define MONOROOTMOTION_CACHECOMPONENTS_OFFSET UNITYSDK_OFFSET(0x108ABF20)
#define MONOROOTMOTION_CANSKIPCURRENTANIMATORMOVE_OFFSET UNITYSDK_OFFSET(0x108AC630)
#define MONOROOTMOTION_GET_MUTEROOTMOTION_OFFSET UNITYSDK_OFFSET(0x108ABE40)
#define MONOROOTMOTION_ONANIMATORMOVE_OFFSET UNITYSDK_OFFSET(0x108AC220)
#define MONOROOTMOTION_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0x108AC8D0)
#define MONOROOTMOTION_ONCOLLISIONEXIT_OFFSET UNITYSDK_OFFSET(0x108AC990)
#define MONOROOTMOTION_SETOWNER_OFFSET UNITYSDK_OFFSET(0x108ABEC0)
#define MONOROOTMOTION_SET_MUTEROOTMOTION_OFFSET UNITYSDK_OFFSET(0x108ABE50)
#define MONOROOTMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x108ACA50)

inline static constexpr unsigned int MonoRootMotion_TypeDefinitionIndex = 59625;
