...
#define CLASS_3_DE6B43739A5F0EED_METHOD_3_1C1D8F032CA6010E_OFFSET UNITYSDK_OFFSET(0x17FEFD20)
#define CLASS_3_DE6B43739A5F0EED_METHOD_3_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x17FEFC80)
#define CLASS_3_DE6B43739A5F0EED_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x17FEFBF0)
#define CLASS_3_DE6B43739A5F0EED_METHOD_3_DA75C361EBED2E92_OFFSET UNITYSDK_OFFSET(0x17FEF3F0)
#define CLASS_3_DE6B43739A5F0EED_METHOD_3_E26C99C52BC1E654_OFFSET UNITYSDK_OFFSET(0x17FEF540)
#define CLASS_3_DE6B43739A5F0EED_METHOD_3_FE327FD0760E1514_OFFSET UNITYSDK_OFFSET(0x17FEFA80)
#define CLASS_3_DE6B43739A5F0EED__CTOR_OFFSET UNITYSDK_OFFSET(0x17FEFBE0)

inline static constexpr unsigned int Class_3_DE6B43739A5F0EED_TypeDefinitionIndex = 40860;

class Class_3_DE6B43739A5F0EED : public ::Class_2_A48F3719AA1CF200_3
{
public:
	::UnityEngine::AnimationCurve* Field_3_2; // 0x28
	::Plugins::TA::CGCustomGlobalAnimation* Field_3_4; // 0x30
	...
	{
		return ((::System::Void(*)(::PVOID, ::MoleMole::Config::ConfigUIBaseScriptableAnimationNode*, ::Class_1_43BD383C98B4C0C5_25*, ::MoleMole::Config::UISpecialNumGroup*, ::Class_1_C376DB68B1C74261*))((::PBYTE)hIl2Cpp + CLASS_3_DE6B43739A5F0EED_METHOD_3_DA75C361EBED2E92_OFFSET))(this, a1, a2, a3, a4);
	}
	...
	{
		return ((::System::Void(*)(::PVOID, ::MoleMole::Config::ConfigUIBaseScriptableAnimationNode*, ::Class_1_43BD383C98B4C0C5_25*, ::MoleMole::Config::UISpecialNumGroup*, ::Class_1_C376DB68B1C74261*))((::PBYTE)hIl2Cpp + CLASS_3_DE6B43739A5F0EED_METHOD_3_1C1D8F032CA6010E_OFFSET))(this, a1, a2, a3, a4);
	}
};
