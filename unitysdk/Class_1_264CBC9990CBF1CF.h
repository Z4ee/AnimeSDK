...
#define CLASS_1_264CBC9990CBF1CF_METHOD_1_08C578DC970E5EED_OFFSET UNITYSDK_OFFSET(0x162919B0)
#define CLASS_1_264CBC9990CBF1CF_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x16291960)
#define CLASS_1_264CBC9990CBF1CF_METHOD_1_4DA6D4A624E42CAB_OFFSET UNITYSDK_OFFSET(0x16291B20)
#define CLASS_1_264CBC9990CBF1CF_METHOD_1_6826D4DE9789BD2A_OFFSET UNITYSDK_OFFSET(0x16291A70)
#define CLASS_1_264CBC9990CBF1CF_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x16291900)
#define CLASS_1_264CBC9990CBF1CF_METHOD_1_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x16291E30)
#define CLASS_1_264CBC9990CBF1CF_METHOD_1_E84F19001ABFA9DF_OFFSET UNITYSDK_OFFSET(0x16291C10)
#define CLASS_1_264CBC9990CBF1CF__CTOR_OFFSET UNITYSDK_OFFSET(0x16291E70)

inline static constexpr unsigned int Class_1_264CBC9990CBF1CF_TypeDefinitionIndex = 59895;

class Class_1_264CBC9990CBF1CF : public ::System::Object
{
public:
	// static const ::System::String* KMDIKFJPOEO; // 0x0
	// static const ::System::Single PAGMNHCDHKO; // 0x0
	::System::String* FGMKCOANOOK; // 0x10
	::UnityEngine::GameObject* EAFMEEFNGMM; // 0x18
	::System::UInt32 EBGKKHCNKMO; // 0x20
	::System::UInt32 EKGKOBNEHCA; // 0x24
