...
#define CLASS_1_9142AEEC954ACD89_GET_BASECONFIG_OFFSET UNITYSDK_OFFSET(0x18BCEAB0)
#define CLASS_1_9142AEEC954ACD89_GET_BASEDAMAGEPCT_OFFSET UNITYSDK_OFFSET(0x18BCEB30)
#define CLASS_1_9142AEEC954ACD89_GET_BASEDAMAGE_OFFSET UNITYSDK_OFFSET(0x18BCEB10)
#define CLASS_1_9142AEEC954ACD89_GET_BASEHEALPCT_OFFSET UNITYSDK_OFFSET(0x18BCEAF0)
#define CLASS_1_9142AEEC954ACD89_GET_BASEHEAL_OFFSET UNITYSDK_OFFSET(0x18BCEAD0)
#define CLASS_1_9142AEEC954ACD89_GET_BASESHIELD_OFFSET UNITYSDK_OFFSET(0x18BCEB50)
#define CLASS_1_9142AEEC954ACD89_GET_ENTITY_OFFSET UNITYSDK_OFFSET(0x18BCEA80)
#define CLASS_1_9142AEEC954ACD89_GET_PRECALCTASKCONTEXT_OFFSET UNITYSDK_OFFSET(0x18BCEAA0)
#define CLASS_1_9142AEEC954ACD89_GET_SUBMODE_OFFSET UNITYSDK_OFFSET(0x18BCEA90)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_24DB0CE1595FE2D3_OFFSET UNITYSDK_OFFSET(0x18BCF870)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_28B4B80C29FB0F1B_OFFSET UNITYSDK_OFFSET(0x18BCEB70)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_2CE02CA00D75BA32_OFFSET UNITYSDK_OFFSET(0x18BCFD20)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_325888F29AD57E1B_OFFSET UNITYSDK_OFFSET(0x18BD0600)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_36CD3EA5F63BB6E2_OFFSET UNITYSDK_OFFSET(0x18BCF050)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_39F0DE2A1348DBFF_OFFSET UNITYSDK_OFFSET(0x18BCEDD0)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_4015FDE23F37E665_1_OFFSET UNITYSDK_OFFSET(0x18BD0B20)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_4015FDE23F37E665_OFFSET UNITYSDK_OFFSET(0x18BD08F0)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_474FC179B376E2F9_OFFSET UNITYSDK_OFFSET(0x18BCF4D0)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_534FA337054CA657_OFFSET UNITYSDK_OFFSET(0x18BD0710)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_9087AD74B4CB9BFD_OFFSET UNITYSDK_OFFSET(0x18BCF960)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_AB71CB6A7FDDA465_OFFSET UNITYSDK_OFFSET(0x18BD03D0)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_B2C13E0490FF5A9A_OFFSET UNITYSDK_OFFSET(0x18BCED30)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_C236E732AB1EC1E4_OFFSET UNITYSDK_OFFSET(0x18BCF6A0)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x18BD0390)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_CE922FA16F8C5A82_OFFSET UNITYSDK_OFFSET(0x18BD1040)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_DB6114EA5E195AD2_OFFSET UNITYSDK_OFFSET(0x18BCF1A0)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_F7268CF03A5BC199_OFFSET UNITYSDK_OFFSET(0x18BD0D40)
#define CLASS_1_9142AEEC954ACD89_SET_BASECONFIG_OFFSET UNITYSDK_OFFSET(0x18BCEAC0)
#define CLASS_1_9142AEEC954ACD89_SET_BASEDAMAGEPCT_OFFSET UNITYSDK_OFFSET(0x18BCEB40)
#define CLASS_1_9142AEEC954ACD89_SET_BASEDAMAGE_OFFSET UNITYSDK_OFFSET(0x18BCEB20)
#define CLASS_1_9142AEEC954ACD89_SET_BASEHEALPCT_OFFSET UNITYSDK_OFFSET(0x18BCEB00)
#define CLASS_1_9142AEEC954ACD89_SET_BASEHEAL_OFFSET UNITYSDK_OFFSET(0x18BCEAE0)
#define CLASS_1_9142AEEC954ACD89_SET_BASESHIELD_OFFSET UNITYSDK_OFFSET(0x18BCEB60)
#define CLASS_1_9142AEEC954ACD89__CTOR_OFFSET UNITYSDK_OFFSET(0x18BCE870)

inline static constexpr unsigned int Class_1_9142AEEC954ACD89_TypeDefinitionIndex = 56158;
...
public:
	...
	::Class_2_545F497870FB4A84* _BaseConfig_k__BackingField; // 0x20
	::RPG::GameCore::TaskContext* _PreCalcTaskContext_k__BackingField; // 0x28
	::Il2CppArray<::System::Collections::Generic::List_1<::Struct_2_BAFD362D8FC4BA51>*>* AMMPPENCFPF; // 0x30
	::RPG::GameCore::FixPoint COMBFMACFGO; // 0x38
	::RPG::GameCore::FixPoint BMMCEFDBHLP; // 0x40
	::RPG::GameCore::FixPoint _BaseDamage_k__BackingField; // 0x48
	::RPG::GameCore::FixPoint _BaseDamagePct_k__BackingField; // 0x50
	::RPG::GameCore::FixPoint IPLLLCOAPOM; // 0x58
	::RPG::GameCore::FixPoint DGPBNEAKFDM; // 0x60
	::System::Boolean PGCMAOFOLBP; // 0x68
	::System::Boolean FAIDOOKDHHD; // 0x69
	::RPG::GameCore::FixPoint MCCIKOBOIEM; // 0x70
	::RPG::GameCore::FixPoint _BaseHeal_k__BackingField; // 0x78
	::RPG::GameCore::FixPoint _BaseHealPct_k__BackingField; // 0x80
	::RPG::GameCore::FixPoint _BaseShield_k__BackingField; // 0x88
	::RPG::GameCore::FixPoint NDABMNBIIBI; // 0x90
