...
#define CLASS_1_9142AEEC954ACD89_GET_BASECONFIG_OFFSET UNITYSDK_OFFSET(0xBB14590)
#define CLASS_1_9142AEEC954ACD89_GET_BASEDAMAGEPCT_OFFSET UNITYSDK_OFFSET(0xBB14610)
#define CLASS_1_9142AEEC954ACD89_GET_BASEDAMAGE_OFFSET UNITYSDK_OFFSET(0xBB145F0)
#define CLASS_1_9142AEEC954ACD89_GET_BASEHEALPCT_OFFSET UNITYSDK_OFFSET(0xBB145D0)
#define CLASS_1_9142AEEC954ACD89_GET_BASEHEAL_OFFSET UNITYSDK_OFFSET(0xBB145B0)
#define CLASS_1_9142AEEC954ACD89_GET_BASESHIELD_OFFSET UNITYSDK_OFFSET(0xBB14630)
#define CLASS_1_9142AEEC954ACD89_GET_ENTITY_OFFSET UNITYSDK_OFFSET(0xBB14560)
#define CLASS_1_9142AEEC954ACD89_GET_PRECALCTASKCONTEXT_OFFSET UNITYSDK_OFFSET(0xBB14580)
#define CLASS_1_9142AEEC954ACD89_GET_SUBMODE_OFFSET UNITYSDK_OFFSET(0xBB14570)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_24DB0CE1595FE2D3_OFFSET UNITYSDK_OFFSET(0xBB15350)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_28B4B80C29FB0F1B_OFFSET UNITYSDK_OFFSET(0xBB14650)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_2CE02CA00D75BA32_OFFSET UNITYSDK_OFFSET(0xBB15800)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_325888F29AD57E1B_OFFSET UNITYSDK_OFFSET(0xBB160F0)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_36CD3EA5F63BB6E2_OFFSET UNITYSDK_OFFSET(0xBB14B30)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_39F0DE2A1348DBFF_OFFSET UNITYSDK_OFFSET(0xBB148B0)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_4015FDE23F37E665_1_OFFSET UNITYSDK_OFFSET(0xBB16620)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_4015FDE23F37E665_OFFSET UNITYSDK_OFFSET(0xBB163E0)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_474FC179B376E2F9_OFFSET UNITYSDK_OFFSET(0xBB14FB0)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_534FA337054CA657_OFFSET UNITYSDK_OFFSET(0xBB16200)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_9087AD74B4CB9BFD_OFFSET UNITYSDK_OFFSET(0xBB15440)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_AB71CB6A7FDDA465_OFFSET UNITYSDK_OFFSET(0xBB15EC0)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_B2C13E0490FF5A9A_OFFSET UNITYSDK_OFFSET(0xBB14810)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_C236E732AB1EC1E4_OFFSET UNITYSDK_OFFSET(0xBB15180)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xBB15E70)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_CE922FA16F8C5A82_OFFSET UNITYSDK_OFFSET(0xBB16B30)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_DB6114EA5E195AD2_OFFSET UNITYSDK_OFFSET(0xBB14C80)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_F7268CF03A5BC199_OFFSET UNITYSDK_OFFSET(0xBB16830)
#define CLASS_1_9142AEEC954ACD89_SET_BASECONFIG_OFFSET UNITYSDK_OFFSET(0xBB145A0)
#define CLASS_1_9142AEEC954ACD89_SET_BASEDAMAGEPCT_OFFSET UNITYSDK_OFFSET(0xBB14620)
#define CLASS_1_9142AEEC954ACD89_SET_BASEDAMAGE_OFFSET UNITYSDK_OFFSET(0xBB14600)
#define CLASS_1_9142AEEC954ACD89_SET_BASEHEALPCT_OFFSET UNITYSDK_OFFSET(0xBB145E0)
#define CLASS_1_9142AEEC954ACD89_SET_BASEHEAL_OFFSET UNITYSDK_OFFSET(0xBB145C0)
#define CLASS_1_9142AEEC954ACD89_SET_BASESHIELD_OFFSET UNITYSDK_OFFSET(0xBB14640)
#define CLASS_1_9142AEEC954ACD89__CTOR_OFFSET UNITYSDK_OFFSET(0xBB14350)
...
{
public:
	::RPG::GameCore::TaskContext* _PreCalcTaskContext_k__BackingField; // 0x10
	...
	::RPG::GameCore::FixPoint BMMCEFDBHLP; // 0x38
	::RPG::GameCore::FixPoint _BaseHeal_k__BackingField; // 0x40
	::RPG::GameCore::FixPoint _BaseDamagePct_k__BackingField; // 0x48
	::RPG::GameCore::FixPoint _BaseDamage_k__BackingField; // 0x50
	::RPG::GameCore::FixPoint MCCIKOBOIEM; // 0x58
	::RPG::GameCore::FixPoint DGPBNEAKFDM; // 0x60
	::RPG::GameCore::FixPoint NDABMNBIIBI; // 0x68
	::RPG::GameCore::FixPoint IPLLLCOAPOM; // 0x70
	::RPG::GameCore::FixPoint _BaseShield_k__BackingField; // 0x78
	::RPG::GameCore::FixPoint COMBFMACFGO; // 0x80
	::RPG::GameCore::FixPoint _BaseHealPct_k__BackingField; // 0x88
	::System::Boolean PGCMAOFOLBP; // 0x90
	::System::Boolean FAIDOOKDHHD; // 0x91
