...
#define ZZZUICURVEGRAPHIC_CURVESEGMENT_COMPUTECONTROLPOINTS_1_OFFSET UNITYSDK_OFFSET(0x1B169E50)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT_COMPUTECONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1B169DF0)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT_COMPUTECURVEINFO_OFFSET UNITYSDK_OFFSET(0x1B16A540)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT_GET_HASNEXTCURVE_OFFSET UNITYSDK_OFFSET(0x1B1699B0)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT_GET_HASPREVCURVE_OFFSET UNITYSDK_OFFSET(0x1B1699A0)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B169BD0)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B169CE0)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B169D30)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1B169D90)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1699C0)

inline static constexpr unsigned int ZzzUiCurveGraphic_CurveSegment_TypeDefinitionIndex = 62127;
