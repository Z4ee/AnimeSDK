...
#define ZZZUICURVEGRAPHIC_CURVESEGMENT_COMPUTECONTROLPOINTS_1_OFFSET UNITYSDK_OFFSET(0x1CB844A0)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT_COMPUTECONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1CB84440)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT_COMPUTECURVEINFO_OFFSET UNITYSDK_OFFSET(0x1CB84B90)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT_GET_HASNEXTCURVE_OFFSET UNITYSDK_OFFSET(0x1CB84000)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT_GET_HASPREVCURVE_OFFSET UNITYSDK_OFFSET(0x1CB83FF0)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CB84220)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1CB84330)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1CB84380)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1CB843E0)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB84010)

inline static constexpr unsigned int ZzzUiCurveGraphic_CurveSegment_TypeDefinitionIndex = 87466;
