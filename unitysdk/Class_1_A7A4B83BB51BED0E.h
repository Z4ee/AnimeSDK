...
#define CLASS_1_A7A4B83BB51BED0E_GET_FACESIZE_OFFSET UNITYSDK_OFFSET(0x10C999B0)
#define CLASS_1_A7A4B83BB51BED0E_GET_FOGS_OFFSET UNITYSDK_OFFSET(0x10C999D0)
#define CLASS_1_A7A4B83BB51BED0E_GET_SECTIONS_OFFSET UNITYSDK_OFFSET(0x10C99990)
#define CLASS_1_A7A4B83BB51BED0E_GET_SECTIONVERTICES_OFFSET UNITYSDK_OFFSET(0x10C99970)
#define CLASS_1_A7A4B83BB51BED0E_METHOD_1_FE8B82EDFBB3BD3F_OFFSET UNITYSDK_OFFSET(0x10C993D0)
#define CLASS_1_A7A4B83BB51BED0E_SET_FACESIZE_OFFSET UNITYSDK_OFFSET(0x10C999C0)
#define CLASS_1_A7A4B83BB51BED0E_SET_FOGS_OFFSET UNITYSDK_OFFSET(0x10C999E0)
#define CLASS_1_A7A4B83BB51BED0E_SET_SECTIONS_OFFSET UNITYSDK_OFFSET(0x10C999A0)
#define CLASS_1_A7A4B83BB51BED0E_SET_SECTIONVERTICES_OFFSET UNITYSDK_OFFSET(0x10C99980)
#define CLASS_1_A7A4B83BB51BED0E__CTOR_OFFSET UNITYSDK_OFFSET(0x10C99930)

inline static constexpr unsigned int Class_1_A7A4B83BB51BED0E_TypeDefinitionIndex = 61392;

class Class_1_A7A4B83BB51BED0E : public ::System::Object
{
public:
	::System::Collections::Generic::HashSet_1<::System::UInt32>* _Fogs_k__BackingField; // 0x10
	::Il2CppArray<::RPG::MVector2>* _SectionVertices_k__BackingField; // 0x18
	::System::Collections::Generic::List_1<::RPG::Client::NavMap::FiveDim::SectionConfig*>* _Sections_k__BackingField; // 0x20
