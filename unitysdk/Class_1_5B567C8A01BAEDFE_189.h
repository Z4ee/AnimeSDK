...
#define CLASS_1_5B567C8A01BAEDFE_189_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1ED0D990)
#define CLASS_1_5B567C8A01BAEDFE_189_CLONE_OFFSET UNITYSDK_OFFSET(0x1ED0D680)
#define CLASS_1_5B567C8A01BAEDFE_189_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1ED0D790)
#define CLASS_1_5B567C8A01BAEDFE_189_EQUALS_OFFSET UNITYSDK_OFFSET(0x1ED0D6C0)
#define CLASS_1_5B567C8A01BAEDFE_189_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1ED0D8F0)
#define CLASS_1_5B567C8A01BAEDFE_189_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1ED0D9E0)
#define CLASS_1_5B567C8A01BAEDFE_189_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1ED0D9B0)
#define CLASS_1_5B567C8A01BAEDFE_189_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1ED0D600)
#define CLASS_1_5B567C8A01BAEDFE_189_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1ED0D630)
#define CLASS_1_5B567C8A01BAEDFE_189_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1ED0D920)
#define CLASS_1_5B567C8A01BAEDFE_189_WRITETO_OFFSET UNITYSDK_OFFSET(0x1ED0D980)
#define CLASS_1_5B567C8A01BAEDFE_189__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ED0DA30)
#define CLASS_1_5B567C8A01BAEDFE_189__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ED0D650)
#define CLASS_1_5B567C8A01BAEDFE_189__CTOR_OFFSET UNITYSDK_OFFSET(0x1ED0D640)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_189_TypeDefinitionIndex = 29904;

class Class_1_5B567C8A01BAEDFE_189 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_189*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_189*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_189_TypeDefinitionIndex)->GetStaticField(0x42A10);
	}
