...
#define CLASS_1_5B567C8A01BAEDFE_189_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C7FED40)
#define CLASS_1_5B567C8A01BAEDFE_189_CLONE_OFFSET UNITYSDK_OFFSET(0x1C7FEA30)
#define CLASS_1_5B567C8A01BAEDFE_189_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C7FEB40)
#define CLASS_1_5B567C8A01BAEDFE_189_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C7FEA70)
#define CLASS_1_5B567C8A01BAEDFE_189_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C7FECA0)
#define CLASS_1_5B567C8A01BAEDFE_189_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C7FED90)
#define CLASS_1_5B567C8A01BAEDFE_189_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C7FED60)
#define CLASS_1_5B567C8A01BAEDFE_189_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C7FE9B0)
#define CLASS_1_5B567C8A01BAEDFE_189_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C7FE9E0)
#define CLASS_1_5B567C8A01BAEDFE_189_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C7FECD0)
#define CLASS_1_5B567C8A01BAEDFE_189_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C7FED30)
#define CLASS_1_5B567C8A01BAEDFE_189__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C7FEDE0)
#define CLASS_1_5B567C8A01BAEDFE_189__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C7FEA00)
#define CLASS_1_5B567C8A01BAEDFE_189__CTOR_OFFSET UNITYSDK_OFFSET(0x1C7FE9F0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_189_TypeDefinitionIndex = 29206;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_189*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_189_TypeDefinitionIndex)->GetStaticField(0x30170);
	}
