...
#define CLASS_1_512CC108C22F737B_CLEAR_OFFSET UNITYSDK_OFFSET(0xB774130)
#define CLASS_1_512CC108C22F737B__CTOR_OFFSET UNITYSDK_OFFSET(0xB7741A0)

inline static constexpr unsigned int Class_1_512CC108C22F737B_TypeDefinitionIndex = 53225;
