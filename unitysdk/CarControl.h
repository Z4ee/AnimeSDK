...
#define CARCONTROL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A863D70)
#define CARCONTROL_GENERATERANDOMPLATENUMBER_OFFSET UNITYSDK_OFFSET(0x1A865330)
#define CARCONTROL_GETTRANSFORMREF_OFFSET UNITYSDK_OFFSET(0x1A864D60)
#define CARCONTROL_INITCARLICENSE_OFFSET UNITYSDK_OFFSET(0x1A863CF0)
#define CARCONTROL_MANUALEND_OFFSET UNITYSDK_OFFSET(0x1A865650)
#define CARCONTROL_MANUALSTART_OFFSET UNITYSDK_OFFSET(0x1A863EC0)
#define CARCONTROL_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0x1A8657D0)
#define CARCONTROL_METHOD_5_1AD013B50B95594F_OFFSET UNITYSDK_OFFSET(0x1A8675C0)
#define CARCONTROL_METHOD_5_4C4796AC7F58C144_OFFSET UNITYSDK_OFFSET(0x1A8678C0)
#define CARCONTROL_METHOD_5_5CCB202047B26946_OFFSET UNITYSDK_OFFSET(0x1A864860)
#define CARCONTROL_METHOD_5_5CCDFA1325D1189C_OFFSET UNITYSDK_OFFSET(0x1A8677E0)
#define CARCONTROL_METHOD_5_5FAD56E9E208220A_OFFSET UNITYSDK_OFFSET(0x1A863E50)
#define CARCONTROL_METHOD_5_705AF43C01ED360A_OFFSET UNITYSDK_OFFSET(0x1A867640)
#define CARCONTROL_METHOD_5_72441113E013E70D_OFFSET UNITYSDK_OFFSET(0x1A866B90)
#define CARCONTROL_METHOD_5_8E7482C252877E8A_OFFSET UNITYSDK_OFFSET(0x1A867130)
#define CARCONTROL_METHOD_5_97AC5E0734B0603A_OFFSET UNITYSDK_OFFSET(0x1A864510)
#define CARCONTROL_METHOD_5_B6B60891A776E34D_OFFSET UNITYSDK_OFFSET(0x1A864E60)
#define CARCONTROL_METHOD_5_CEB0AC426B3FC6F6_OFFSET UNITYSDK_OFFSET(0x1A865BE0)
#define CARCONTROL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A863DE0)
#define CARCONTROL_SETCARSTATE_OFFSET UNITYSDK_OFFSET(0x1A867480)
#define CARCONTROL_SETIRICAR_OFFSET UNITYSDK_OFFSET(0x1A867AD0)
#define CARCONTROL_TRIGGERDANCE_OFFSET UNITYSDK_OFFSET(0x1A8644B0)
#define CARCONTROL_UPDATECARLICENSEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A863D30)
#define CARCONTROL_UPDATELIGHTS_OFFSET UNITYSDK_OFFSET(0x1A867B20)
#define CARCONTROL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A867F40)
#define CARCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A867EE0)
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::UnityEngine::Transform*>**)Il2CppClass::FromTypeDefinitionIndex(CarControl_TypeDefinitionIndex)->GetStaticField(0x66680);
	}
