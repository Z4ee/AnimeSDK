...
#define CARCONTROL_AWAKE_OFFSET UNITYSDK_OFFSET(0xA6D52A0)
#define CARCONTROL_GENERATERANDOMPLATENUMBER_OFFSET UNITYSDK_OFFSET(0xA6D6900)
#define CARCONTROL_GETTRANSFORMREF_OFFSET UNITYSDK_OFFSET(0xA6D62F0)
#define CARCONTROL_INITCARLICENSE_OFFSET UNITYSDK_OFFSET(0xA6D5220)
#define CARCONTROL_MANUALEND_OFFSET UNITYSDK_OFFSET(0xA6D6CC0)
#define CARCONTROL_MANUALSTART_OFFSET UNITYSDK_OFFSET(0xA6D53F0)
#define CARCONTROL_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0xA6D6E20)
#define CARCONTROL_METHOD_5_0D0A5518FDFDF0C4_OFFSET UNITYSDK_OFFSET(0xA6D63F0)
#define CARCONTROL_METHOD_5_1AD013B50B95594F_OFFSET UNITYSDK_OFFSET(0xA6D8E50)
#define CARCONTROL_METHOD_5_36F46336ADA62D13_OFFSET UNITYSDK_OFFSET(0xA6D5380)
#define CARCONTROL_METHOD_5_4C4796AC7F58C144_OFFSET UNITYSDK_OFFSET(0xA6D9150)
#define CARCONTROL_METHOD_5_5CCB202047B26946_OFFSET UNITYSDK_OFFSET(0xA6D5DE0)
#define CARCONTROL_METHOD_5_5CCDFA1325D1189C_OFFSET UNITYSDK_OFFSET(0xA6D9070)
#define CARCONTROL_METHOD_5_705AF43C01ED360A_OFFSET UNITYSDK_OFFSET(0xA6D8ED0)
#define CARCONTROL_METHOD_5_72441113E013E70D_OFFSET UNITYSDK_OFFSET(0xA6D83A0)
#define CARCONTROL_METHOD_5_8E7482C252877E8A_OFFSET UNITYSDK_OFFSET(0xA6D89B0)
#define CARCONTROL_METHOD_5_97AC5E0734B0603A_OFFSET UNITYSDK_OFFSET(0xA6D5A30)
#define CARCONTROL_METHOD_5_CEB0AC426B3FC6F6_OFFSET UNITYSDK_OFFSET(0xA6D7210)
#define CARCONTROL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA6D5310)
#define CARCONTROL_SETCARSTATE_OFFSET UNITYSDK_OFFSET(0xA6D8D10)
#define CARCONTROL_SETIRICAR_OFFSET UNITYSDK_OFFSET(0xA6D9360)
#define CARCONTROL_TRIGGERDANCE_OFFSET UNITYSDK_OFFSET(0xA6D59D0)
#define CARCONTROL_UPDATECARLICENSEPOSITION_OFFSET UNITYSDK_OFFSET(0xA6D5260)
#define CARCONTROL_UPDATELIGHTS_OFFSET UNITYSDK_OFFSET(0xA6D93B0)
#define CARCONTROL__CCTOR_OFFSET UNITYSDK_OFFSET(0xA6D97D0)
#define CARCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xA6D9770)

inline static constexpr unsigned int CarControl_TypeDefinitionIndex = 37995;

class CarControl : public ::UnityEngine::MonoBehaviour
{
public:
	static ::System::Collections::Generic::List_1<::UnityEngine::Transform*>** StaticGet_Field_5_55()
	{
		return (::System::Collections::Generic::List_1<::UnityEngine::Transform*>**)Il2CppClass::FromTypeDefinitionIndex(CarControl_TypeDefinitionIndex)->GetStaticField(0x48720);
	}
	...
	::System::Single Field_5_31; // 0xB8
	::System::Boolean Field_5_32; // 0xBC
	::System::Boolean Field_5_33; // 0xBD
	::System::Int32 Field_5_34; // 0xC0
	::UnityEngine::Vector3 Field_5_35; // 0xC4
	::UnityEngine::Quaternion Field_5_36; // 0xD0
	::UnityEngine::Vector3 Field_5_37; // 0xE0
	::UnityEngine::Quaternion Field_5_38; // 0xEC
	::Il2CppArray<::UnityEngine::Vector3>* Field_5_39; // 0x100
	::Il2CppArray<::UnityEngine::Vector3>* Field_5_40; // 0x108
	::System::Boolean Field_5_41; // 0x110
	::System::Single Field_5_42; // 0x114
	...
	::System::Int32 Field_5_48; // 0x134
	::System::Single Field_5_49; // 0x138
	::System::Single Field_5_50; // 0x13C
	::RPG::Client::DialogEmitterMonoPlugin* Field_5_51; // 0x140
	::System::Collections::Generic::List_1<::RPG::Client::DialogEmitterBehavior_DialogData*>* Field_5_52; // 0x148
	::Class_1_0AAA29E827EB555D_Class_1_4452B3A96D121692* Field_5_53; // 0x150
	::RootMotion::IKJob::IKThreadProxyContext* Field_5_54; // 0x158
