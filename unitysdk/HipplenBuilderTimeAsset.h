...
#define HIPPLENBUILDERTIMEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x17A6C0C0)

inline static constexpr unsigned int HipplenBuilderTimeAsset_TypeDefinitionIndex = 45445;
