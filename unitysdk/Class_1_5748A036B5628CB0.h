...
#define CLASS_1_5748A036B5628CB0_CLEAR_OFFSET UNITYSDK_OFFSET(0x1C5156F0)
#define CLASS_1_5748A036B5628CB0_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x1C515690)
#define CLASS_1_5748A036B5628CB0_METHOD_1_3D8C42F8CC3A01E9_OFFSET UNITYSDK_OFFSET(0x1C514D20)
#define CLASS_1_5748A036B5628CB0_METHOD_1_3F6435A17B157AFD_OFFSET UNITYSDK_OFFSET(0x1C514C00)
#define CLASS_1_5748A036B5628CB0_METHOD_1_5022DB1DC5AA8CB4_OFFSET UNITYSDK_OFFSET(0x1C5150E0)
#define CLASS_1_5748A036B5628CB0_METHOD_1_56DCDC75A2E42299_OFFSET UNITYSDK_OFFSET(0x1C515190)
#define CLASS_1_5748A036B5628CB0_METHOD_1_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0x1C515620)
#define CLASS_1_5748A036B5628CB0_METHOD_1_CC75865AF9CCA3AF_OFFSET UNITYSDK_OFFSET(0x1C5153B0)
#define CLASS_1_5748A036B5628CB0_METHOD_1_D605F1EFFC4B0D43_OFFSET UNITYSDK_OFFSET(0x1C514B30)
#define CLASS_1_5748A036B5628CB0_METHOD_1_DFF98536D8B4074F_OFFSET UNITYSDK_OFFSET(0x1C515550)
#define CLASS_1_5748A036B5628CB0_METHOD_1_E95714AB4DE1901F_OFFSET UNITYSDK_OFFSET(0x1C514F60)
#define CLASS_1_5748A036B5628CB0_METHOD_1_F74441856239DF08_OFFSET UNITYSDK_OFFSET(0x1C515420)
#define CLASS_1_5748A036B5628CB0_ONALLOC_OFFSET UNITYSDK_OFFSET(0x1C515BC0)
#define CLASS_1_5748A036B5628CB0_ONRECYCLE_OFFSET UNITYSDK_OFFSET(0x1C515C30)
#define CLASS_1_5748A036B5628CB0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C515C70)
...
{
public:
	::RPG::PoolDictionary_2<::RPG::Client::LittleGame::FiveDim::RendererMoveReason, ::Class_1_6DE8726ADEF173A7_6*>* BMGBOIBPGKL; // 0x10
	::RPG::PoolDictionary_2<::RPG::Client::LittleGame::FiveDim::RendererMoveReason, ::RPG::PoolDictionary_2<::Struct_2_EBD47A6A04BEEE4E, ::Class_1_FAE2544A4708BA7F_5*>*>* CAGGBOGCPHH; // 0x18
	::RPG::PoolList_1<::Class_1_0A24888DF04C995E_1*>* CEHBONLFIIO; // 0x20
	::UnityEngine::Quaternion HMLADPBJAMB; // 0x28
	::UnityEngine::Vector3 OHLPJGIECPF; // 0x38
	::UnityEngine::Quaternion FBGGLNLDMKE; // 0x44
