...
#define CLASS_1_93896D58DE250EBE_CLEAR_OFFSET UNITYSDK_OFFSET(0x155A4810)
#define CLASS_1_93896D58DE250EBE__CTOR_OFFSET UNITYSDK_OFFSET(0x155A4860)
...
{
public:
	::RPG::GameCore::FloatCurve* NPMMJCIGLJP; // 0x10
