...
#define CLASS_1_6C487F2BEA20B8D9_EXECUTE_OFFSET UNITYSDK_OFFSET(0x12370CC0)
#define CLASS_1_6C487F2BEA20B8D9_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x12370C80)
#define CLASS_1_6C487F2BEA20B8D9_METHOD_1_092A26D9B5D0973E_OFFSET UNITYSDK_OFFSET(0x123712F0)
#define CLASS_1_6C487F2BEA20B8D9_METHOD_1_297A485C4F88F7A8_OFFSET UNITYSDK_OFFSET(0x123727C0)
#define CLASS_1_6C487F2BEA20B8D9_METHOD_1_544F1D8EAA9B4FAE_OFFSET UNITYSDK_OFFSET(0x123715E0)
#define CLASS_1_6C487F2BEA20B8D9_METHOD_1_C9D3A1C812F5D64D_OFFSET UNITYSDK_OFFSET(0x12372C80)
#define CLASS_1_6C487F2BEA20B8D9_METHOD_1_F6894B5C37816912_OFFSET UNITYSDK_OFFSET(0x12372D80)
#define CLASS_1_6C487F2BEA20B8D9_METHOD_1_F859CE601F919CF3_OFFSET UNITYSDK_OFFSET(0x12370FE0)
#define CLASS_1_6C487F2BEA20B8D9__CTOR_OFFSET UNITYSDK_OFFSET(0x12370BF0)

inline static constexpr unsigned int Class_1_6C487F2BEA20B8D9_TypeDefinitionIndex = 71795;

class Class_1_6C487F2BEA20B8D9 : public ::System::Object
{
public:
	::RPG::Client::LittleGame::GraphNavigationService_1<::RPG::Client::LittleGame::ElfRestaurantGameEntity*>* Field_1_0; // 0x10
	...
	{
		return ((::System::Void(*)(::PVOID, ::RPG::Client::LittleGame::ElfRestaurantGameEntity*))((::PBYTE)hIl2Cpp + CLASS_1_6C487F2BEA20B8D9_METHOD_1_092A26D9B5D0973E_OFFSET))(this, a1);
	}
};
