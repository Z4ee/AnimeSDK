...
#define CLASS_1_6C487F2BEA20B8D9_EXECUTE_OFFSET UNITYSDK_OFFSET(0x18CBE7D0)
#define CLASS_1_6C487F2BEA20B8D9_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x18CBE790)
#define CLASS_1_6C487F2BEA20B8D9_METHOD_1_297A485C4F88F7A8_OFFSET UNITYSDK_OFFSET(0x18CC0330)
#define CLASS_1_6C487F2BEA20B8D9_METHOD_1_544F1D8EAA9B4FAE_OFFSET UNITYSDK_OFFSET(0x18CBF150)
#define CLASS_1_6C487F2BEA20B8D9_METHOD_1_A88E8E41DBE6B87B_OFFSET UNITYSDK_OFFSET(0x18CBEE00)
#define CLASS_1_6C487F2BEA20B8D9_METHOD_1_C9D3A1C812F5D64D_OFFSET UNITYSDK_OFFSET(0x18CC07F0)
#define CLASS_1_6C487F2BEA20B8D9_METHOD_1_F6894B5C37816912_OFFSET UNITYSDK_OFFSET(0x18CC08F0)
#define CLASS_1_6C487F2BEA20B8D9_METHOD_1_F859CE601F919CF3_OFFSET UNITYSDK_OFFSET(0x18CBEAF0)
#define CLASS_1_6C487F2BEA20B8D9__CTOR_OFFSET UNITYSDK_OFFSET(0x18CBE700)

inline static constexpr unsigned int Class_1_6C487F2BEA20B8D9_TypeDefinitionIndex = 76799;
...
public:
	...
	::RPG::Client::LittleGame::GraphNavigationService_1<::RPG::Client::LittleGame::ElfRestaurantGameEntity*>* IPPNPHCOCAF; // 0x20
