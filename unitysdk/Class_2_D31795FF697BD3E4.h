...
#define CLASS_2_D31795FF697BD3E4_GET_ACTIVEACTIONIDLIST_OFFSET UNITYSDK_OFFSET(0x18FB77A0)
#define CLASS_2_D31795FF697BD3E4_GET_ACTIVEPARTIDLIST_OFFSET UNITYSDK_OFFSET(0x18FB7780)
#define CLASS_2_D31795FF697BD3E4_GET_FINISHEDACTIONNUM_OFFSET UNITYSDK_OFFSET(0x18FB7760)
#define CLASS_2_D31795FF697BD3E4_METHOD_2_05679872695EE5DE_OFFSET UNITYSDK_OFFSET(0x18FB77C0)
#define CLASS_2_D31795FF697BD3E4_SET_ACTIVEACTIONIDLIST_OFFSET UNITYSDK_OFFSET(0x18FB77B0)
#define CLASS_2_D31795FF697BD3E4_SET_ACTIVEPARTIDLIST_OFFSET UNITYSDK_OFFSET(0x18FB7790)
#define CLASS_2_D31795FF697BD3E4_SET_FINISHEDACTIONNUM_OFFSET UNITYSDK_OFFSET(0x18FB7770)
#define CLASS_2_D31795FF697BD3E4__CTOR_OFFSET UNITYSDK_OFFSET(0x18FB78E0)

inline static constexpr unsigned int Class_2_D31795FF697BD3E4_TypeDefinitionIndex = 80339;

class Class_2_D31795FF697BD3E4 : public ::Class_1_5452947417BCF16A
{
public:
	::System::Collections::Generic::List_1<::System::UInt32>* _ActiveActionIDList_k__BackingField; // 0x20
	::System::Collections::Generic::List_1<::System::UInt32>* _ActivePartIDList_k__BackingField; // 0x28
