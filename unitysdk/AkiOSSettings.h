...
#define AKIOSSETTINGS_GETADVANCEDSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B6EB140)
#define AKIOSSETTINGS_GETCOMMSSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B6EB180)
#define AKIOSSETTINGS_GETUSERSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B6EB100)
#define AKIOSSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6EAF90)

inline static constexpr unsigned int AkiOSSettings_TypeDefinitionIndex = 42099;
