...
#define AKIOSSETTINGS_GETADVANCEDSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A672810)
#define AKIOSSETTINGS_GETCOMMSSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A672850)
#define AKIOSSETTINGS_GETUSERSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A6727D0)
#define AKIOSSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A672660)

inline static constexpr unsigned int AkiOSSettings_TypeDefinitionIndex = 40457;
