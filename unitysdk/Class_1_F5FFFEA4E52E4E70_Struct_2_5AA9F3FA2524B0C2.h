...
#define CLASS_1_F5FFFEA4E52E4E70_STRUCT_2_5AA9F3FA2524B0C2_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x808EC0)
#define CLASS_1_F5FFFEA4E52E4E70_STRUCT_2_5AA9F3FA2524B0C2_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

inline static constexpr unsigned int Class_1_F5FFFEA4E52E4E70_Struct_2_5AA9F3FA2524B0C2_TypeDefinitionIndex = 70891;

struct alignas(8) Class_1_F5FFFEA4E52E4E70_Struct_2_5AA9F3FA2524B0C2
{
	::Class_1_F5FFFEA4E52E4E70* Field_2_6; // 0x10
	::Cysharp::Threading::Tasks::CompilerServices::AsyncUniTaskMethodBuilder Field_2_7; // 0x18
	::Class_2_A944C35C433158AC* Field_2_5; // 0x28
	::UnityEngine::Transform* Field_2_4; // 0x30
	::System::Int32 Field_2_0; // 0x38
	::Cysharp::Threading::Tasks::YieldAwaitable_Awaiter Field_2_11; // 0x3C
