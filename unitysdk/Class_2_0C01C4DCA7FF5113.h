...
#define CLASS_2_0C01C4DCA7FF5113_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAECBA90)
#define CLASS_2_0C01C4DCA7FF5113_METHOD_2_722DE18E0CFA1CB5_OFFSET UNITYSDK_OFFSET(0xAECBDB0)
#define CLASS_2_0C01C4DCA7FF5113_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xAECBAD0)
#define CLASS_2_0C01C4DCA7FF5113_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xAECBFF0)
#define CLASS_2_0C01C4DCA7FF5113_TICK_OFFSET UNITYSDK_OFFSET(0xAECC040)
#define CLASS_2_0C01C4DCA7FF5113__CTOR_OFFSET UNITYSDK_OFFSET(0xAECBA80)

inline static constexpr unsigned int Class_2_0C01C4DCA7FF5113_TypeDefinitionIndex = 49906;

class Class_2_0C01C4DCA7FF5113 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::TraceCurrentHeartDialNPC* Field_2_1; // 0x20
