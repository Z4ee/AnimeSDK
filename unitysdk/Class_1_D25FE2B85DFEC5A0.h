...
#define CLASS_1_D25FE2B85DFEC5A0_METHOD_1_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x178C97E0)
#define CLASS_1_D25FE2B85DFEC5A0_METHOD_1_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x178C97D0)
#define CLASS_1_D25FE2B85DFEC5A0_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x178C97C0)
#define CLASS_1_D25FE2B85DFEC5A0__CTOR_OFFSET UNITYSDK_OFFSET(0x178C9780)

inline static constexpr unsigned int Class_1_D25FE2B85DFEC5A0_TypeDefinitionIndex = 47261;

class Class_1_D25FE2B85DFEC5A0 : public ::System::Object
{
public:
	::Class_2_208CC9941471731A_832* Field_1_0; // 0x10
