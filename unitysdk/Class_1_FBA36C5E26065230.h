...
#define CLASS_1_FBA36C5E26065230_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x17BFC950)
#define CLASS_1_FBA36C5E26065230_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x17BFC6F0)
#define CLASS_1_FBA36C5E26065230__CTOR_OFFSET UNITYSDK_OFFSET(0x17BDDD60)

inline static constexpr unsigned int Class_1_FBA36C5E26065230_TypeDefinitionIndex = 34589;
