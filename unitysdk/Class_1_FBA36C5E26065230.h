...
#define CLASS_1_FBA36C5E26065230_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1975E130)
#define CLASS_1_FBA36C5E26065230_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1975DE20)
#define CLASS_1_FBA36C5E26065230__CTOR_OFFSET UNITYSDK_OFFSET(0x1975E5C0)

inline static constexpr unsigned int Class_1_FBA36C5E26065230_TypeDefinitionIndex = 36515;
