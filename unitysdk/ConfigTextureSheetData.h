...
#define CONFIGTEXTURESHEETDATA_CHECKHOLLOWTEXTURELOOP_OFFSET UNITYSDK_OFFSET(0x128BF090)
#define CONFIGTEXTURESHEETDATA_CREATEANDRELOADTEXTURESHEETS_OFFSET UNITYSDK_OFFSET(0x128BE500)
#define CONFIGTEXTURESHEETDATA_GETBATTLETEXTURESHEETDATA_OFFSET UNITYSDK_OFFSET(0x128BECB0)
#define CONFIGTEXTURESHEETDATA_GETBLENDTEXTURESHEET_1_OFFSET UNITYSDK_OFFSET(0x128BE830)
#define CONFIGTEXTURESHEETDATA_GETBLENDTEXTURESHEET_OFFSET UNITYSDK_OFFSET(0x128BE690)
#define CONFIGTEXTURESHEETDATA_GETTEXTURESHEETASSETS_OFFSET UNITYSDK_OFFSET(0x128BEA40)
#define CONFIGTEXTURESHEETDATA_GETTEXTURESHEETBYALL_OFFSET UNITYSDK_OFFSET(0x128BF8A0)
#define CONFIGTEXTURESHEETDATA_GETTEXTURESHEETBYCOMBINELIBRARY_OFFSET UNITYSDK_OFFSET(0x128BE540)
#define CONFIGTEXTURESHEETDATA_GETTEXTURESHEETCONFIGPATH_OFFSET UNITYSDK_OFFSET(0x128BEC70)
#define CONFIGTEXTURESHEETDATA_GETTEXTURESHEETDATA_1_OFFSET UNITYSDK_OFFSET(0x128BF310)
#define CONFIGTEXTURESHEETDATA_GETTEXTURESHEETDATA_OFFSET UNITYSDK_OFFSET(0x128BF520)
#define CONFIGTEXTURESHEETDATA_GETTEXTURESHEETGROUPDATA_OFFSET UNITYSDK_OFFSET(0x128BEB50)
#define CONFIGTEXTURESHEETDATA_ISCONTAINTARGETTEXTURESHEET_OFFSET UNITYSDK_OFFSET(0x128BE400)
#define CONFIGTEXTURESHEETDATA_RELEASEALLTEXTURESHEETPLAYER_OFFSET UNITYSDK_OFFSET(0x128BFBD0)
#define CONFIGTEXTURESHEETDATA_RELOADFROMFILEASYNC_OFFSET UNITYSDK_OFFSET(0x128BC050)
#define CONFIGTEXTURESHEETDATA_RELOADFROMFILE_OFFSET UNITYSDK_OFFSET(0x128BC600)
#define CONFIGTEXTURESHEETDATA_RELOADTEXTURESHEETFROMFILE_OFFSET UNITYSDK_OFFSET(0x128BC140)
#define CONFIGTEXTURESHEETDATA_TRYRANDOMTEXTURESHEETKEY_OFFSET UNITYSDK_OFFSET(0x128BE880)
#define CONFIGTEXTURESHEETDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x128BFC10)

inline static constexpr unsigned int ConfigTextureSheetData_TypeDefinitionIndex = 72800;
...
public:
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::TextureSheetData*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigTextureSheetData_TypeDefinitionIndex)->GetStaticField(0x3E3E0);
	}
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::MoleMole::TextureSheetType, ::MoleMole::ConfigTextureSheet*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigTextureSheetData_TypeDefinitionIndex)->GetStaticField(0x3E3E8);
	}
	static ::MoleMole::ConfigTextureSheet** StaticGet_config()
	{
		return (::MoleMole::ConfigTextureSheet**)Il2CppClass::FromTypeDefinitionIndex(ConfigTextureSheetData_TypeDefinitionIndex)->GetStaticField(0x3E3F0);
	}
