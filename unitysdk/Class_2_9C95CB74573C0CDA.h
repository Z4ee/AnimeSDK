...
#define CLASS_2_9C95CB74573C0CDA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB4FC7C0)
#define CLASS_2_9C95CB74573C0CDA_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB4FC800)
#define CLASS_2_9C95CB74573C0CDA_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB4FCED0)
#define CLASS_2_9C95CB74573C0CDA_TICK_OFFSET UNITYSDK_OFFSET(0xB4FCF20)
#define CLASS_2_9C95CB74573C0CDA__CTOR_OFFSET UNITYSDK_OFFSET(0xB4FC7B0)
...
public:
	...
	::RPG::GameCore::StackBoostPointCallbackDecorate* OFKGLJOAMLD; // 0x20
