...
#define CLASS_2_9C95CB74573C0CDA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19C199F0)
#define CLASS_2_9C95CB74573C0CDA_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x19C19A30)
#define CLASS_2_9C95CB74573C0CDA_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x19C1A100)
#define CLASS_2_9C95CB74573C0CDA_TICK_OFFSET UNITYSDK_OFFSET(0x19C1A150)
#define CLASS_2_9C95CB74573C0CDA__CTOR_OFFSET UNITYSDK_OFFSET(0x19C199E0)

inline static constexpr unsigned int Class_2_9C95CB74573C0CDA_TypeDefinitionIndex = 55829;

class Class_2_9C95CB74573C0CDA : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::StackBoostPointCallbackDecorate* OFKGLJOAMLD; // 0x18
