...
#define CLASS_3_8960B8D5132C5605_METHOD_3_469ECD10EF199C13_OFFSET UNITYSDK_OFFSET(0x1D844010)
#define CLASS_3_8960B8D5132C5605_METHOD_3_9E3D0C5F7C38F16C_OFFSET UNITYSDK_OFFSET(0x1D843FC0)
#define CLASS_3_8960B8D5132C5605__CTOR_OFFSET UNITYSDK_OFFSET(0x1D844000)

inline static constexpr unsigned int Class_3_8960B8D5132C5605_TypeDefinitionIndex = 21691;

class Class_3_8960B8D5132C5605 : public ::RPG::GameCore::TaskConfig
{
public:
	::System::String* OENAMINOLLF; // 0x18
	::System::Boolean DIOGHCPEMMB; // 0x20
