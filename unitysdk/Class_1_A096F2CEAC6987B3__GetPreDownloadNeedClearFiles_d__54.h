...
#define CLASS_1_A096F2CEAC6987B3__GETPREDOWNLOADNEEDCLEARFILES_D__54_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x16AA1640)
#define CLASS_1_A096F2CEAC6987B3__GETPREDOWNLOADNEEDCLEARFILES_D__54_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_TUPLE_SYSTEM_STRING_SYSTEM_BOOLEAN___GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x16AA2060)
#define CLASS_1_A096F2CEAC6987B3__GETPREDOWNLOADNEEDCLEARFILES_D__54_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_TUPLE_SYSTEM_STRING_SYSTEM_BOOLEAN___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16AA1FF0)
#define CLASS_1_A096F2CEAC6987B3__GETPREDOWNLOADNEEDCLEARFILES_D__54_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x16AA20E0)
#define CLASS_1_A096F2CEAC6987B3__GETPREDOWNLOADNEEDCLEARFILES_D__54_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16AA2050)
#define CLASS_1_A096F2CEAC6987B3__GETPREDOWNLOADNEEDCLEARFILES_D__54_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x16AA2000)
#define CLASS_1_A096F2CEAC6987B3__GETPREDOWNLOADNEEDCLEARFILES_D__54_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16AA1500)
#define CLASS_1_A096F2CEAC6987B3__GETPREDOWNLOADNEEDCLEARFILES_D__54__CTOR_OFFSET UNITYSDK_OFFSET(0x16AA0700)
#define CLASS_1_A096F2CEAC6987B3__GETPREDOWNLOADNEEDCLEARFILES_D__54___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x16AA1540)

inline static constexpr unsigned int Class_1_A096F2CEAC6987B3__GetPreDownloadNeedClearFiles_d__54_TypeDefinitionIndex = 56808;

class Class_1_A096F2CEAC6987B3__GetPreDownloadNeedClearFiles_d__54 : public ::System::Object
{
public:
	::System::Collections::Generic::HashSet_1<::RPG::Client::ByteHash16>* _hpatchBlocks_5__2; // 0x10
	::Class_1_A096F2CEAC6987B3* __4__this; // 0x18
	::System::Collections::Generic::IEnumerator_1<::System::IO::FileInfo*>* __7__wrap2; // 0x20
