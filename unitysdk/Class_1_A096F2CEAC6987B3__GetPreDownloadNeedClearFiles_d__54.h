...
#define CLASS_1_A096F2CEAC6987B3__GETPREDOWNLOADNEEDCLEARFILES_D__54_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1896B3D0)
#define CLASS_1_A096F2CEAC6987B3__GETPREDOWNLOADNEEDCLEARFILES_D__54_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_TUPLE_SYSTEM_STRING_SYSTEM_BOOLEAN___GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1896BDE0)
#define CLASS_1_A096F2CEAC6987B3__GETPREDOWNLOADNEEDCLEARFILES_D__54_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_TUPLE_SYSTEM_STRING_SYSTEM_BOOLEAN___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1896BD70)
#define CLASS_1_A096F2CEAC6987B3__GETPREDOWNLOADNEEDCLEARFILES_D__54_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1896BE60)
#define CLASS_1_A096F2CEAC6987B3__GETPREDOWNLOADNEEDCLEARFILES_D__54_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1896BDD0)
#define CLASS_1_A096F2CEAC6987B3__GETPREDOWNLOADNEEDCLEARFILES_D__54_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1896BD80)
#define CLASS_1_A096F2CEAC6987B3__GETPREDOWNLOADNEEDCLEARFILES_D__54_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1896B290)
#define CLASS_1_A096F2CEAC6987B3__GETPREDOWNLOADNEEDCLEARFILES_D__54__CTOR_OFFSET UNITYSDK_OFFSET(0x1896A4E0)
#define CLASS_1_A096F2CEAC6987B3__GETPREDOWNLOADNEEDCLEARFILES_D__54___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1896B2D0)
