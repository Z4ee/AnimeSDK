...
#define CLASS_2_2CFA1DD7692E1A34_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1157B6C0)
#define CLASS_2_2CFA1DD7692E1A34_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1157B700)
#define CLASS_2_2CFA1DD7692E1A34_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1157B8A0)
#define CLASS_2_2CFA1DD7692E1A34_TICK_OFFSET UNITYSDK_OFFSET(0x1157B8F0)
#define CLASS_2_2CFA1DD7692E1A34__CTOR_OFFSET UNITYSDK_OFFSET(0x1157B6B0)

inline static constexpr unsigned int Class_2_2CFA1DD7692E1A34_TypeDefinitionIndex = 47432;

class Class_2_2CFA1DD7692E1A34 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SwitchUIMenuBGM* Field_2_0; // 0x18
