...
#define CLASS_2_3F2408C4C138A15C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8A6C870)
#define CLASS_2_3F2408C4C138A15C_METHOD_2_6898F77B75A69C20_OFFSET UNITYSDK_OFFSET(0x8A6CE20)
#define CLASS_2_3F2408C4C138A15C_METHOD_2_913947B6596EB50A_OFFSET UNITYSDK_OFFSET(0x8A6D3E0)
#define CLASS_2_3F2408C4C138A15C_METHOD_2_AB49D886CAE7CFE2_OFFSET UNITYSDK_OFFSET(0x8A6D1D0)
#define CLASS_2_3F2408C4C138A15C_METHOD_2_E892861EE594315C_OFFSET UNITYSDK_OFFSET(0x8A6CDA0)
#define CLASS_2_3F2408C4C138A15C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8A6C990)
#define CLASS_2_3F2408C4C138A15C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x8A6C8E0)
#define CLASS_2_3F2408C4C138A15C_TICK_OFFSET UNITYSDK_OFFSET(0x8A6C930)
#define CLASS_2_3F2408C4C138A15C__CTOR_OFFSET UNITYSDK_OFFSET(0x8A6C860)

inline static constexpr unsigned int Class_2_3F2408C4C138A15C_TypeDefinitionIndex = 42359;

class Class_2_3F2408C4C138A15C : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::Client::RuntimeGroupManager* Field_2_1; // 0x18
	::RPG::GameCore::TaskContext* Field_2_2; // 0x20
	::RPG::GameCore::AdvCreateEntityAsync* Field_2_3; // 0x28
