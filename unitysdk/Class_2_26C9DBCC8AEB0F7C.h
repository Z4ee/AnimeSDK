...
#define CLASS_2_26C9DBCC8AEB0F7C_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA9C0AE0)
#define CLASS_2_26C9DBCC8AEB0F7C_METHOD_2_61EC2AC0BD93363E_OFFSET UNITYSDK_OFFSET(0xA9C0D10)
#define CLASS_2_26C9DBCC8AEB0F7C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xA9C0B20)
#define CLASS_2_26C9DBCC8AEB0F7C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xA9C0C10)
#define CLASS_2_26C9DBCC8AEB0F7C_TICK_OFFSET UNITYSDK_OFFSET(0xA9C0CB0)
#define CLASS_2_26C9DBCC8AEB0F7C__CTOR_OFFSET UNITYSDK_OFFSET(0xA9C0AB0)

inline static constexpr unsigned int Class_2_26C9DBCC8AEB0F7C_TypeDefinitionIndex = 47547;
