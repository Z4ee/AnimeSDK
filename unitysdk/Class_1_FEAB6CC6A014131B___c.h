...
#define CLASS_1_FEAB6CC6A014131B___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x19EFC760)
#define CLASS_1_FEAB6CC6A014131B___C__CREATE_B__1_0_OFFSET UNITYSDK_OFFSET(0x19EFC7B0)
#define CLASS_1_FEAB6CC6A014131B___C__CTOR_OFFSET UNITYSDK_OFFSET(0x19EFC7A0)

inline static constexpr unsigned int Class_1_FEAB6CC6A014131B___c_TypeDefinitionIndex = 6563;
...
public:
	...
	{
		return (::System::Comparison_1<::Class_1_FEAB6CC6A014131B_Class_1_3B76E13757985C28*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_FEAB6CC6A014131B___c_TypeDefinitionIndex)->GetStaticField(0x48F0);
	}
	static ::Class_1_FEAB6CC6A014131B___c** StaticGet___9()
	{
		return (::Class_1_FEAB6CC6A014131B___c**)Il2CppClass::FromTypeDefinitionIndex(Class_1_FEAB6CC6A014131B___c_TypeDefinitionIndex)->GetStaticField(0x48F8);
	}
