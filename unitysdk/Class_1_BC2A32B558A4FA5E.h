...
#define CLASS_1_BC2A32B558A4FA5E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16F2C2A0)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_218124418542E081_OFFSET UNITYSDK_OFFSET(0x16F2C660)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_2BE3D7897F980828_OFFSET UNITYSDK_OFFSET(0x16F2BFD0)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_4AB9012B5D01108B_OFFSET UNITYSDK_OFFSET(0x16F2B240)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_7D5A58D439BD4FF2_OFFSET UNITYSDK_OFFSET(0x16F2B380)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_8F537CE539CF0103_OFFSET UNITYSDK_OFFSET(0x16F2B640)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_9CA5A80F6B5B9E01_OFFSET UNITYSDK_OFFSET(0x16F2CA70)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_A3EF4ED894EBFFC3_OFFSET UNITYSDK_OFFSET(0x16F2AE20)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_AF2CFBAAD2629B3B_OFFSET UNITYSDK_OFFSET(0x16F2B740)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0x16F2C4D0)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x16F2B340)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_ED0CD23D136F6F74_OFFSET UNITYSDK_OFFSET(0x16F2BC60)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x16F2CA80)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_F4BE962E72F8D312_OFFSET UNITYSDK_OFFSET(0x16F2A800)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_F9555880FBE027D5_OFFSET UNITYSDK_OFFSET(0x16F2C300)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_FD86C67947CE3065_OFFSET UNITYSDK_OFFSET(0x16F2ABC0)
#define CLASS_1_BC2A32B558A4FA5E__CTOR_OFFSET UNITYSDK_OFFSET(0x16F2A1B0)

inline static constexpr unsigned int Class_1_BC2A32B558A4FA5E_TypeDefinitionIndex = 57798;

class Class_1_BC2A32B558A4FA5E : public ::System::Object
{
public:
	::RPG::Client::PartialFlipDeviceComponent* Field_1_0; // 0x10
	::RPG::Client::ConeSphereTrigger* Field_1_1; // 0x18
	::System::Collections::Generic::HashSet_1<::RPG::GameCore::GameEntity*>* Field_1_2; // 0x20
	::System::Action_1<::RPG::Client::PartialFlipDeviceComponent*>* Field_1_3; // 0x28
	::RPG::Client::EraFlipperCommonConfig* Field_1_4; // 0x30
	::RPG::Client::ConeSphereTrigger* Field_1_5; // 0x38
	::UnityEngine::Transform* Field_1_6; // 0x40
	::UnityEngine::GameObject* Field_1_7; // 0x48
	::RPG::Client::RangeLimitCollider* Field_1_8; // 0x50
	::UnityEngine::GameObject* Field_1_9; // 0x58
	::Struct_2_984AA94FB23486F9_1 Field_1_10; // 0x60
	::UnityEngine::Vector3 Field_1_11; // 0x74
	::Struct_2_984AA94FB23486F9_1 Field_1_12; // 0x80
	::System::Single Field_1_13; // 0x94
	::System::Boolean Field_1_14; // 0x98
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_BC2A32B558A4FA5E_METHOD_1_8F537CE539CF0103_OFFSET))(this);
	}

	::System::Void Method_1_AF2CFBAAD2629B3B(::System::Single a1)
	{
		return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + CLASS_1_BC2A32B558A4FA5E_METHOD_1_AF2CFBAAD2629B3B_OFFSET))(this, a1);
	}

	::Struct_2_984AA94FB23486F9_1 Method_1_F4BE962E72F8D312()
	{
		return ((::Struct_2_984AA94FB23486F9_1(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_BC2A32B558A4FA5E_METHOD_1_F4BE962E72F8D312_OFFSET))(this);
	}
