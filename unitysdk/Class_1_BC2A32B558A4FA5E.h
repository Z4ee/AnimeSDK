...
#define CLASS_1_BC2A32B558A4FA5E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16D95220)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_218124418542E081_OFFSET UNITYSDK_OFFSET(0x16D955E0)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_2BE3D7897F980828_OFFSET UNITYSDK_OFFSET(0x16D94F60)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_4AB9012B5D01108B_OFFSET UNITYSDK_OFFSET(0x16D93F40)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_6D8954457E2B7EA7_OFFSET UNITYSDK_OFFSET(0x16D93450)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_7A8604A90B40E6A9_OFFSET UNITYSDK_OFFSET(0x16D94630)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_7D5A58D439BD4FF2_OFFSET UNITYSDK_OFFSET(0x16D94070)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_98CD66A7F3C102A5_OFFSET UNITYSDK_OFFSET(0x16D944A0)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_9CA5A80F6B5B9E01_OFFSET UNITYSDK_OFFSET(0x16D959E0)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_A3EF4ED894EBFFC3_OFFSET UNITYSDK_OFFSET(0x16D93B20)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0x16D95450)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x16D94030)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_ED0CD23D136F6F74_OFFSET UNITYSDK_OFFSET(0x16D94BF0)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x16D959F0)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_F9555880FBE027D5_OFFSET UNITYSDK_OFFSET(0x16D95280)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_FD86C67947CE3065_OFFSET UNITYSDK_OFFSET(0x16D938C0)
#define CLASS_1_BC2A32B558A4FA5E__CTOR_OFFSET UNITYSDK_OFFSET(0x16D92D60)

inline static constexpr unsigned int Class_1_BC2A32B558A4FA5E_TypeDefinitionIndex = 60618;

class Class_1_BC2A32B558A4FA5E : public ::System::Object
{
public:
	::System::Action_1<::RPG::Client::PartialFlipDeviceComponent*>* MECKBKLEHAN; // 0x10
	::UnityEngine::GameObject* FGCHCPFPNBP; // 0x18
	::RPG::Client::EraFlipperCommonConfig* LMAPPLJEBEH; // 0x20
	::RPG::Client::ConeSphereTrigger* NIMOCLGFFLE; // 0x28
	::UnityEngine::GameObject* BPEEKJFKHNI; // 0x30
	::RPG::Client::PartialFlipDeviceComponent* HDDOOONCFPA; // 0x38
	::RPG::Client::ConeSphereTrigger* LANKKDMNGHG; // 0x40
	::System::Collections::Generic::HashSet_1<::RPG::GameCore::GameEntity*>* NICPGBKGLPL; // 0x48
	::RPG::Client::RangeLimitCollider* DIJHGLNHBEN; // 0x50
	::UnityEngine::Transform* MEMMLNBHMHA; // 0x58
	::UnityEngine::Vector3 DFCODJGJOEH; // 0x60
	::System::Boolean EHIHJNJJANI; // 0x6C
	::Struct_2_984AA94FB23486F9_1 MBKKMBPHCNI; // 0x70
	::System::Single KJOHCNFLHFH; // 0x84
	::Struct_2_984AA94FB23486F9_1 KLLFHAKLADI; // 0x88
