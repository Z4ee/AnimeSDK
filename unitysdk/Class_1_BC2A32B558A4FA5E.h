...
#define CLASS_1_BC2A32B558A4FA5E_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB586980)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_218124418542E081_OFFSET UNITYSDK_OFFSET(0xB586D40)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_2BE3D7897F980828_OFFSET UNITYSDK_OFFSET(0xB5866C0)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_4AB9012B5D01108B_OFFSET UNITYSDK_OFFSET(0xB5856B0)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_6D8954457E2B7EA7_OFFSET UNITYSDK_OFFSET(0xB584BC0)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_7A8604A90B40E6A9_OFFSET UNITYSDK_OFFSET(0xB585D90)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_7D5A58D439BD4FF2_OFFSET UNITYSDK_OFFSET(0xB5857E0)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_98CD66A7F3C102A5_OFFSET UNITYSDK_OFFSET(0xB585C00)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_9CA5A80F6B5B9E01_OFFSET UNITYSDK_OFFSET(0xB587150)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_A3EF4ED894EBFFC3_OFFSET UNITYSDK_OFFSET(0xB585290)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0xB586BB0)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB5857A0)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_ED0CD23D136F6F74_OFFSET UNITYSDK_OFFSET(0xB586350)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xB587160)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_F9555880FBE027D5_OFFSET UNITYSDK_OFFSET(0xB5869E0)
#define CLASS_1_BC2A32B558A4FA5E_METHOD_1_FD86C67947CE3065_OFFSET UNITYSDK_OFFSET(0xB585030)
#define CLASS_1_BC2A32B558A4FA5E__CTOR_OFFSET UNITYSDK_OFFSET(0xB5844C0)
...
public:
	...
	::RPG::Client::ConeSphereTrigger* NIMOCLGFFLE; // 0x18
	::UnityEngine::Transform* MEMMLNBHMHA; // 0x20
	::UnityEngine::GameObject* BPEEKJFKHNI; // 0x28
	::RPG::Client::RangeLimitCollider* DIJHGLNHBEN; // 0x30
	::System::Collections::Generic::HashSet_1<::RPG::GameCore::GameEntity*>* NICPGBKGLPL; // 0x38
	::RPG::Client::ConeSphereTrigger* LANKKDMNGHG; // 0x40
	::RPG::Client::EraFlipperCommonConfig* LMAPPLJEBEH; // 0x48
	::RPG::Client::PartialFlipDeviceComponent* HDDOOONCFPA; // 0x50
	::UnityEngine::GameObject* FGCHCPFPNBP; // 0x58
	::Struct_2_984AA94FB23486F9_1 MBKKMBPHCNI; // 0x60
	::System::Boolean EHIHJNJJANI; // 0x74
	::UnityEngine::Vector3 DFCODJGJOEH; // 0x78
