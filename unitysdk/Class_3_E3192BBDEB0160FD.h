...
#define CLASS_3_E3192BBDEB0160FD_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1220AA30)
#define CLASS_3_E3192BBDEB0160FD_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1220AA70)
#define CLASS_3_E3192BBDEB0160FD__CTOR_OFFSET UNITYSDK_OFFSET(0x1220AA00)

inline static constexpr unsigned int Class_3_E3192BBDEB0160FD_TypeDefinitionIndex = 55509;
