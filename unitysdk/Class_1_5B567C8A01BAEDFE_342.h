...
#define CLASS_1_5B567C8A01BAEDFE_342_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1CC2ABD0)
#define CLASS_1_5B567C8A01BAEDFE_342_CLONE_OFFSET UNITYSDK_OFFSET(0x1CC2A870)
#define CLASS_1_5B567C8A01BAEDFE_342_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1CC2A9D0)
#define CLASS_1_5B567C8A01BAEDFE_342_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CC2A8E0)
#define CLASS_1_5B567C8A01BAEDFE_342_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CC2AB30)
#define CLASS_1_5B567C8A01BAEDFE_342_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1CC2AC20)
#define CLASS_1_5B567C8A01BAEDFE_342_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1CC2ABF0)
#define CLASS_1_5B567C8A01BAEDFE_342_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1CC2A7C0)
#define CLASS_1_5B567C8A01BAEDFE_342_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1CC2A820)
#define CLASS_1_5B567C8A01BAEDFE_342_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1CC2AB60)
#define CLASS_1_5B567C8A01BAEDFE_342_WRITETO_OFFSET UNITYSDK_OFFSET(0x1CC2ABC0)
#define CLASS_1_5B567C8A01BAEDFE_342__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CC2AC70)
#define CLASS_1_5B567C8A01BAEDFE_342__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CC2A840)
#define CLASS_1_5B567C8A01BAEDFE_342__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC2A830)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_342_TypeDefinitionIndex = 32996;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_342*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_342_TypeDefinitionIndex)->GetStaticField(0x28E50);
	}
