...
#define CLASS_1_5B567C8A01BAEDFE_342_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A4B0470)
#define CLASS_1_5B567C8A01BAEDFE_342_CLONE_OFFSET UNITYSDK_OFFSET(0x1A4B0280)
#define CLASS_1_5B567C8A01BAEDFE_342_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A4B0380)
#define CLASS_1_5B567C8A01BAEDFE_342_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A4B02F0)
#define CLASS_1_5B567C8A01BAEDFE_342_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A4B03D0)
#define CLASS_1_5B567C8A01BAEDFE_342_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A4B04C0)
#define CLASS_1_5B567C8A01BAEDFE_342_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A4B0490)
#define CLASS_1_5B567C8A01BAEDFE_342_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A4B01D0)
#define CLASS_1_5B567C8A01BAEDFE_342_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A4B0230)
#define CLASS_1_5B567C8A01BAEDFE_342_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A4B0400)
#define CLASS_1_5B567C8A01BAEDFE_342_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A4B0460)
#define CLASS_1_5B567C8A01BAEDFE_342__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A4B0510)
#define CLASS_1_5B567C8A01BAEDFE_342__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A4B0250)
#define CLASS_1_5B567C8A01BAEDFE_342__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4B0240)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_342_TypeDefinitionIndex = 31981;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_342*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_342_TypeDefinitionIndex)->GetStaticField(0x5130);
	}
