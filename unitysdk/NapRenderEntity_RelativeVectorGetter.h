...
#define NAPRENDERENTITY_RELATIVEVECTORGETTER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C428070)
#define NAPRENDERENTITY_RELATIVEVECTORGETTER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C428100)
#define NAPRENDERENTITY_RELATIVEVECTORGETTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C427CF0)
#define NAPRENDERENTITY_RELATIVEVECTORGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C427CD0)

inline static constexpr unsigned int NapRenderEntity_RelativeVectorGetter_TypeDefinitionIndex = 27265;
