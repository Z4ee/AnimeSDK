...
#define NAPRENDERENTITY_RELATIVEVECTORGETTER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A2E4A10)
#define NAPRENDERENTITY_RELATIVEVECTORGETTER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A2E4AA0)
#define NAPRENDERENTITY_RELATIVEVECTORGETTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A2E4690)
#define NAPRENDERENTITY_RELATIVEVECTORGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2E4680)

inline static constexpr unsigned int NapRenderEntity_RelativeVectorGetter_TypeDefinitionIndex = 29579;
