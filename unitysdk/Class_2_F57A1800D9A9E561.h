...
#define CLASS_2_F57A1800D9A9E561_DISPOSE_OFFSET UNITYSDK_OFFSET(0x178A0BD0)
#define CLASS_2_F57A1800D9A9E561_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x178A0C10)
#define CLASS_2_F57A1800D9A9E561_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x178A0DE0)
#define CLASS_2_F57A1800D9A9E561_TICK_OFFSET UNITYSDK_OFFSET(0x178A0E30)
#define CLASS_2_F57A1800D9A9E561__CTOR_OFFSET UNITYSDK_OFFSET(0x178A0BC0)
...
{
public:
	::RPG::GameCore::SetTriggeredFormationAssetAutoCenter* OFKGLJOAMLD; // 0x18
