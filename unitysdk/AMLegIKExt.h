...
#define AMLEGIKEXT_APPLYPLAYERMOTION_OFFSET UNITYSDK_OFFSET(0x123B6B60)
#define AMLEGIKEXT_CALCFOOTBINDVECTORS_OFFSET UNITYSDK_OFFSET(0x123B63F0)
#define AMLEGIKEXT_CALCULATEFOOTTARGET_OFFSET UNITYSDK_OFFSET(0x123BD880)
#define AMLEGIKEXT_CALCULATEIKHIPDELTA_OFFSET UNITYSDK_OFFSET(0x123B7820)
#define AMLEGIKEXT_CALCULATEPELVISTARGET_OFFSET UNITYSDK_OFFSET(0x123BE4F0)
#define AMLEGIKEXT_CALCULATEPREDICTFOOTTARGET_OFFSET UNITYSDK_OFFSET(0x123B8190)
#define AMLEGIKEXT_CROSSCHECK_OFFSET UNITYSDK_OFFSET(0x123B9A30)
#define AMLEGIKEXT_DEBUGFOCUSEDFOOT_OFFSET UNITYSDK_OFFSET(0x123B6B10)
#define AMLEGIKEXT_DOCALCULATETARGET_OFFSET UNITYSDK_OFFSET(0x123BC930)
#define AMLEGIKEXT_FINALIZEFOOTIK_OFFSET UNITYSDK_OFFSET(0x123BDFC0)
#define AMLEGIKEXT_GETDELTAFROMRIGIDBODYTOTRANSFORM_OFFSET UNITYSDK_OFFSET(0x123BB1A0)
#define AMLEGIKEXT_GETFOOTSHAPE_OFFSET UNITYSDK_OFFSET(0x123BB4A0)
#define AMLEGIKEXT_GETRAYCASTHIT_OFFSET UNITYSDK_OFFSET(0x123BAFF0)
#define AMLEGIKEXT_GETSTATEDEPENDPARAMS_OFFSET UNITYSDK_OFFSET(0x123B4AB0)
#define AMLEGIKEXT_GET_CURRENTFOOTANIMPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x123B4630)
#define AMLEGIKEXT_GET_CURRENTFOOTANIMPOSLOCAL_OFFSET UNITYSDK_OFFSET(0x123B4610)
#define AMLEGIKEXT_GET_CURRENTFOOTANIMROTGLOBAL_OFFSET UNITYSDK_OFFSET(0x123B4690)
#define AMLEGIKEXT_GET_CURRENTFOOTANIMROTLOCAL_OFFSET UNITYSDK_OFFSET(0x123B4670)
#define AMLEGIKEXT_GET_CURRENTFOOTLOCKEDPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x123B4650)
#define AMLEGIKEXT_GET_CURRENTPELVISANIMPOSLOCAL_OFFSET UNITYSDK_OFFSET(0x123B45B0)
#define AMLEGIKEXT_GET_CURRENTPELVISANIMROTLOCAL_OFFSET UNITYSDK_OFFSET(0x123B45F0)
#define AMLEGIKEXT_GET_CURRENTTOEPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x123B46B0)
#define AMLEGIKEXT_GET_ENABLEANIMDEBUG_OFFSET UNITYSDK_OFFSET(0x123B4CE0)
#define AMLEGIKEXT_GET_ENABLEDEBUGONOFFGROUNDHEIGHT_OFFSET UNITYSDK_OFFSET(0x123B4D00)
#define AMLEGIKEXT_GET_ENABLEFINALHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x123B4C80)
#define AMLEGIKEXT_GET_ENABLEFOOTMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0x123B4C20)
#define AMLEGIKEXT_GET_ENABLELOCKFOOTDEBUG_OFFSET UNITYSDK_OFFSET(0x123B4C00)
#define AMLEGIKEXT_GET_ENABLELOCKFOOTREAL_OFFSET UNITYSDK_OFFSET(0x123B4920)
#define AMLEGIKEXT_GET_ENABLEORDINARYHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x123B4C40)
#define AMLEGIKEXT_GET_ENABLEPELVISDEBUG_OFFSET UNITYSDK_OFFSET(0x123B4BE0)
#define AMLEGIKEXT_GET_ENABLEPIKDRAWDEBUG_OFFSET UNITYSDK_OFFSET(0x123B4D20)
#define AMLEGIKEXT_GET_ENABLEPIKHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x123B4C60)
#define AMLEGIKEXT_GET_ENABLEPREDICTIVEMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0x123B4D40)
#define AMLEGIKEXT_GET_ENABLERAYCASTDEBUG_OFFSET UNITYSDK_OFFSET(0x123B4CC0)
#define AMLEGIKEXT_GET_ENABLETARGETDEBUG_OFFSET UNITYSDK_OFFSET(0x123B4CA0)
#define AMLEGIKEXT_GET_FOOTINDEXTOWATCH_OFFSET UNITYSDK_OFFSET(0x123B4D80)
#define AMLEGIKEXT_GET_GIZMOSLASTTIME_OFFSET UNITYSDK_OFFSET(0x123B4D60)
#define AMLEGIKEXT_GET_HIPDELTA_OFFSET UNITYSDK_OFFSET(0x123B4570)
#define AMLEGIKEXT_GET_HIPHITCOLLIDER_OFFSET UNITYSDK_OFFSET(0x123BD870)
#define AMLEGIKEXT_GET_HIPHITPOINT_OFFSET UNITYSDK_OFFSET(0x123BD840)
#define AMLEGIKEXT_GET_IKWEIGHT_OFFSET UNITYSDK_OFFSET(0x123B4550)
#define AMLEGIKEXT_GET_LASTANIMPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x123B4790)
#define AMLEGIKEXT_GET_LASTFOOTONGROUNDWEIGHT_OFFSET UNITYSDK_OFFSET(0x123B47F0)
#define AMLEGIKEXT_GET_LASTHITNORMALGLOBAL_OFFSET UNITYSDK_OFFSET(0x123B4770)
#define AMLEGIKEXT_GET_LASTHITPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x123B4750)
#define AMLEGIKEXT_GET_LASTORDINARYHITPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x123B4710)
#define AMLEGIKEXT_GET_LASTPIKHITPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x123B4730)
#define AMLEGIKEXT_GET_LASTTARGETPELVISPOSLOCAL_OFFSET UNITYSDK_OFFSET(0x123B46D0)
#define AMLEGIKEXT_GET_LASTTARGETPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x123B47B0)
#define AMLEGIKEXT_GET_LASTTARGETROTGLOBAL_OFFSET UNITYSDK_OFFSET(0x123B47D0)
#define AMLEGIKEXT_HIPHEIGHTLIFTINGDELTABYMINDIST_OFFSET UNITYSDK_OFFSET(0x123BA910)
#define AMLEGIKEXT_INITIALIZEFOOTLOCKSTATE_OFFSET UNITYSDK_OFFSET(0x123B68F0)
#define AMLEGIKEXT_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x123B4DA0)
#define AMLEGIKEXT_ISFOOTMOVING_OFFSET UNITYSDK_OFFSET(0x123BAB10)
#define AMLEGIKEXT_ISINPIKSTATE_OFFSET UNITYSDK_OFFSET(0x123B9670)
#define AMLEGIKEXT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x123BFA70)
#define AMLEGIKEXT_LOCKFOOT_OFFSET UNITYSDK_OFFSET(0x123B9C10)
#define AMLEGIKEXT_ONANIMATORIKEXEC_OFFSET UNITYSDK_OFFSET(0x123BF400)
#define AMLEGIKEXT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x123BED50)
#define AMLEGIKEXT_ONFOOTPLANT_OFFSET UNITYSDK_OFFSET(0x123BEA10)
#define AMLEGIKEXT_ORDINARYIKHITGROUND_OFFSET UNITYSDK_OFFSET(0x123BB530)
#define AMLEGIKEXT_PREDICTDRAWDEBUG_OFFSET UNITYSDK_OFFSET(0x123B95F0)
#define AMLEGIKEXT_PREDICTFOOT_OFFSET UNITYSDK_OFFSET(0x123B8A60)
#define AMLEGIKEXT_PREDICTIKHITGROUND_OFFSET UNITYSDK_OFFSET(0x123BB8F0)
#define AMLEGIKEXT_PREPARE_OFFSET UNITYSDK_OFFSET(0x123B6D50)
#define AMLEGIKEXT_PREPROCESSANIMPOS_OFFSET UNITYSDK_OFFSET(0x123BA4B0)
#define AMLEGIKEXT_PREPROCESSPREDICTIONIK_OFFSET UNITYSDK_OFFSET(0x123B9930)
#define AMLEGIKEXT_RESETSTATEDEPENDPARAMS_OFFSET UNITYSDK_OFFSET(0x123B4B70)
#define AMLEGIKEXT_SETFOOTCONTROLPARAM_OFFSET UNITYSDK_OFFSET(0x123BDD90)
#define AMLEGIKEXT_SETSTATEDEPENDPARAMS_OFFSET UNITYSDK_OFFSET(0x123B4980)
#define AMLEGIKEXT_SET_CURRENTFOOTANIMPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x123B4640)
#define AMLEGIKEXT_SET_CURRENTFOOTANIMPOSLOCAL_OFFSET UNITYSDK_OFFSET(0x123B4620)
#define AMLEGIKEXT_SET_CURRENTFOOTANIMROTGLOBAL_OFFSET UNITYSDK_OFFSET(0x123B46A0)
#define AMLEGIKEXT_SET_CURRENTFOOTANIMROTLOCAL_OFFSET UNITYSDK_OFFSET(0x123B4680)
#define AMLEGIKEXT_SET_CURRENTFOOTLOCKEDPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x123B4660)
#define AMLEGIKEXT_SET_CURRENTPELVISANIMPOSLOCAL_OFFSET UNITYSDK_OFFSET(0x123B45D0)
#define AMLEGIKEXT_SET_CURRENTPELVISANIMROTLOCAL_OFFSET UNITYSDK_OFFSET(0x123B4600)
#define AMLEGIKEXT_SET_CURRENTTOEPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x123B46C0)
#define AMLEGIKEXT_SET_DISABLEDAMPING_OFFSET UNITYSDK_OFFSET(0x123B4810)
#define AMLEGIKEXT_SET_ENABLEANIMDEBUG_OFFSET UNITYSDK_OFFSET(0x123B4CF0)
#define AMLEGIKEXT_SET_ENABLEDEBUGONOFFGROUNDHEIGHT_OFFSET UNITYSDK_OFFSET(0x123B4D10)
#define AMLEGIKEXT_SET_ENABLEFINALHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x123B4C90)
#define AMLEGIKEXT_SET_ENABLEFOOTMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0x123B4C30)
#define AMLEGIKEXT_SET_ENABLELOCKFOOTDEBUG_OFFSET UNITYSDK_OFFSET(0x123B4C10)
#define AMLEGIKEXT_SET_ENABLEORDINARYHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x123B4C50)
#define AMLEGIKEXT_SET_ENABLEPELVISDEBUG_OFFSET UNITYSDK_OFFSET(0x123B4BF0)
#define AMLEGIKEXT_SET_ENABLEPIKDRAWDEBUG_OFFSET UNITYSDK_OFFSET(0x123B4D30)
#define AMLEGIKEXT_SET_ENABLEPIKHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x123B4C70)
#define AMLEGIKEXT_SET_ENABLEPREDICTIVEMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0x123B4D50)
#define AMLEGIKEXT_SET_ENABLERAYCASTDEBUG_OFFSET UNITYSDK_OFFSET(0x123B4CD0)
#define AMLEGIKEXT_SET_ENABLETARGETDEBUG_OFFSET UNITYSDK_OFFSET(0x123B4CB0)
#define AMLEGIKEXT_SET_FOOTINDEXTOWATCH_OFFSET UNITYSDK_OFFSET(0x123B4D90)
#define AMLEGIKEXT_SET_GIZMOSLASTTIME_OFFSET UNITYSDK_OFFSET(0x123B4D70)
#define AMLEGIKEXT_SET_HIPDELTA_OFFSET UNITYSDK_OFFSET(0x123B4590)
#define AMLEGIKEXT_SET_HIPHITCOLLIDER_OFFSET UNITYSDK_OFFSET(0x123BD860)
#define AMLEGIKEXT_SET_HIPHITPOINT_OFFSET UNITYSDK_OFFSET(0x123BD820)
#define AMLEGIKEXT_SET_IKWEIGHT_OFFSET UNITYSDK_OFFSET(0x123B4560)
#define AMLEGIKEXT_SET_ISONMOVINGPLATFORM_OFFSET UNITYSDK_OFFSET(0x123B4820)
#define AMLEGIKEXT_SET_LASTANIMPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x123B47A0)
#define AMLEGIKEXT_SET_LASTFOOTONGROUNDWEIGHT_OFFSET UNITYSDK_OFFSET(0x123B4800)
#define AMLEGIKEXT_SET_LASTHITNORMALGLOBAL_OFFSET UNITYSDK_OFFSET(0x123B4780)
#define AMLEGIKEXT_SET_LASTHITPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x123B4760)
#define AMLEGIKEXT_SET_LASTORDINARYHITPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x123B4720)
#define AMLEGIKEXT_SET_LASTPIKHITPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x123B4740)
#define AMLEGIKEXT_SET_LASTTARGETPELVISPOSLOCAL_OFFSET UNITYSDK_OFFSET(0x123B46F0)
#define AMLEGIKEXT_SET_LASTTARGETPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x123B47C0)
#define AMLEGIKEXT_SET_LASTTARGETROTGLOBAL_OFFSET UNITYSDK_OFFSET(0x123B47E0)
#define AMLEGIKEXT_START_OFFSET UNITYSDK_OFFSET(0x123BEB80)
#define AMLEGIKEXT_UPDATE_OFFSET UNITYSDK_OFFSET(0x123BEF20)
#define AMLEGIKEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x123BFAD0)

inline static constexpr unsigned int AMLegIKExt_TypeDefinitionIndex = 89688;
