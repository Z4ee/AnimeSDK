...
#define AMLEGIKEXT_APPLYPLAYERMOTION_OFFSET UNITYSDK_OFFSET(0x11AA5820)
#define AMLEGIKEXT_CALCFOOTBINDVECTORS_OFFSET UNITYSDK_OFFSET(0x11AA5090)
#define AMLEGIKEXT_CALCULATEFOOTTARGET_OFFSET UNITYSDK_OFFSET(0x11AAC6F0)
#define AMLEGIKEXT_CALCULATEIKHIPDELTA_OFFSET UNITYSDK_OFFSET(0x11AA65A0)
#define AMLEGIKEXT_CALCULATEPELVISTARGET_OFFSET UNITYSDK_OFFSET(0x11AAD380)
#define AMLEGIKEXT_CALCULATEPREDICTFOOTTARGET_OFFSET UNITYSDK_OFFSET(0x11AA6F10)
#define AMLEGIKEXT_CROSSCHECK_OFFSET UNITYSDK_OFFSET(0x11AA87E0)
#define AMLEGIKEXT_DEBUGFOCUSEDFOOT_OFFSET UNITYSDK_OFFSET(0x11AA57D0)
#define AMLEGIKEXT_DOCALCULATETARGET_OFFSET UNITYSDK_OFFSET(0x11AAB7D0)
#define AMLEGIKEXT_FINALIZEFOOTIK_OFFSET UNITYSDK_OFFSET(0x11AACE50)
#define AMLEGIKEXT_GETDELTAFROMRIGIDBODYTOTRANSFORM_OFFSET UNITYSDK_OFFSET(0x11AAA000)
#define AMLEGIKEXT_GETFOOTSHAPE_OFFSET UNITYSDK_OFFSET(0x11AAA300)
#define AMLEGIKEXT_GETRAYCASTHIT_OFFSET UNITYSDK_OFFSET(0x11AA9E50)
#define AMLEGIKEXT_GETSTATEDEPENDPARAMS_OFFSET UNITYSDK_OFFSET(0x11AA3760)
#define AMLEGIKEXT_GET_CURRENTFOOTANIMPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x11AA32C0)
#define AMLEGIKEXT_GET_CURRENTFOOTANIMPOSLOCAL_OFFSET UNITYSDK_OFFSET(0x11AA32A0)
#define AMLEGIKEXT_GET_CURRENTFOOTANIMROTGLOBAL_OFFSET UNITYSDK_OFFSET(0x11AA3320)
#define AMLEGIKEXT_GET_CURRENTFOOTANIMROTLOCAL_OFFSET UNITYSDK_OFFSET(0x11AA3300)
#define AMLEGIKEXT_GET_CURRENTFOOTLOCKEDPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x11AA32E0)
#define AMLEGIKEXT_GET_CURRENTPELVISANIMPOSLOCAL_OFFSET UNITYSDK_OFFSET(0x11AA3240)
#define AMLEGIKEXT_GET_CURRENTPELVISANIMROTLOCAL_OFFSET UNITYSDK_OFFSET(0x11AA3280)
#define AMLEGIKEXT_GET_CURRENTTOEPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x11AA3340)
#define AMLEGIKEXT_GET_ENABLEANIMDEBUG_OFFSET UNITYSDK_OFFSET(0x11AA3980)
#define AMLEGIKEXT_GET_ENABLEDEBUGONOFFGROUNDHEIGHT_OFFSET UNITYSDK_OFFSET(0x11AA39A0)
#define AMLEGIKEXT_GET_ENABLEFINALHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x11AA3920)
#define AMLEGIKEXT_GET_ENABLEFOOTMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0x11AA38C0)
#define AMLEGIKEXT_GET_ENABLELOCKFOOTDEBUG_OFFSET UNITYSDK_OFFSET(0x11AA38A0)
#define AMLEGIKEXT_GET_ENABLELOCKFOOTREAL_OFFSET UNITYSDK_OFFSET(0x11AA35D0)
#define AMLEGIKEXT_GET_ENABLEORDINARYHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x11AA38E0)
#define AMLEGIKEXT_GET_ENABLEPELVISDEBUG_OFFSET UNITYSDK_OFFSET(0x11AA3880)
#define AMLEGIKEXT_GET_ENABLEPIKDRAWDEBUG_OFFSET UNITYSDK_OFFSET(0x11AA39C0)
#define AMLEGIKEXT_GET_ENABLEPIKHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x11AA3900)
#define AMLEGIKEXT_GET_ENABLEPREDICTIVEMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0x11AA39E0)
#define AMLEGIKEXT_GET_ENABLERAYCASTDEBUG_OFFSET UNITYSDK_OFFSET(0x11AA3960)
#define AMLEGIKEXT_GET_ENABLETARGETDEBUG_OFFSET UNITYSDK_OFFSET(0x11AA3940)
#define AMLEGIKEXT_GET_FOOTINDEXTOWATCH_OFFSET UNITYSDK_OFFSET(0x11AA3A20)
#define AMLEGIKEXT_GET_GIZMOSLASTTIME_OFFSET UNITYSDK_OFFSET(0x11AA3A00)
#define AMLEGIKEXT_GET_HIPDELTA_OFFSET UNITYSDK_OFFSET(0x11AA3200)
#define AMLEGIKEXT_GET_HIPHITCOLLIDER_OFFSET UNITYSDK_OFFSET(0x11AAC6E0)
#define AMLEGIKEXT_GET_HIPHITPOINT_OFFSET UNITYSDK_OFFSET(0x11AAC6B0)
#define AMLEGIKEXT_GET_IKWEIGHT_OFFSET UNITYSDK_OFFSET(0x11AA31E0)
#define AMLEGIKEXT_GET_LASTANIMPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x11AA3420)
#define AMLEGIKEXT_GET_LASTFOOTONGROUNDWEIGHT_OFFSET UNITYSDK_OFFSET(0x11AA3480)
#define AMLEGIKEXT_GET_LASTHITNORMALGLOBAL_OFFSET UNITYSDK_OFFSET(0x11AA3400)
#define AMLEGIKEXT_GET_LASTHITPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x11AA33E0)
#define AMLEGIKEXT_GET_LASTORDINARYHITPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x11AA33A0)
#define AMLEGIKEXT_GET_LASTPIKHITPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x11AA33C0)
#define AMLEGIKEXT_GET_LASTTARGETPELVISPOSLOCAL_OFFSET UNITYSDK_OFFSET(0x11AA3360)
#define AMLEGIKEXT_GET_LASTTARGETPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x11AA3440)
#define AMLEGIKEXT_GET_LASTTARGETROTGLOBAL_OFFSET UNITYSDK_OFFSET(0x11AA3460)
#define AMLEGIKEXT_HIPHEIGHTLIFTINGDELTABYMINDIST_OFFSET UNITYSDK_OFFSET(0x11AA96F0)
#define AMLEGIKEXT_INITIALIZEFOOTLOCKSTATE_OFFSET UNITYSDK_OFFSET(0x11AA55D0)
#define AMLEGIKEXT_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x11AA3A40)
#define AMLEGIKEXT_ISFOOTMOVING_OFFSET UNITYSDK_OFFSET(0x11AA9950)
#define AMLEGIKEXT_ISINPIKSTATE_OFFSET UNITYSDK_OFFSET(0x11AA8420)
#define AMLEGIKEXT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x11AAE920)
#define AMLEGIKEXT_LOCKFOOT_OFFSET UNITYSDK_OFFSET(0x11AA89C0)
#define AMLEGIKEXT_ONANIMATORIKEXEC_OFFSET UNITYSDK_OFFSET(0x11AAE2C0)
#define AMLEGIKEXT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x11AADC00)
#define AMLEGIKEXT_ONFOOTPLANT_OFFSET UNITYSDK_OFFSET(0x11AAD8C0)
#define AMLEGIKEXT_ORDINARYIKHITGROUND_OFFSET UNITYSDK_OFFSET(0x11AAA390)
#define AMLEGIKEXT_PREDICTDRAWDEBUG_OFFSET UNITYSDK_OFFSET(0x11AA83A0)
#define AMLEGIKEXT_PREDICTFOOT_OFFSET UNITYSDK_OFFSET(0x11AA7810)
#define AMLEGIKEXT_PREDICTIKHITGROUND_OFFSET UNITYSDK_OFFSET(0x11AAA750)
#define AMLEGIKEXT_PREPARE_OFFSET UNITYSDK_OFFSET(0x11AA5A10)
#define AMLEGIKEXT_PREPROCESSANIMPOS_OFFSET UNITYSDK_OFFSET(0x11AA9290)
#define AMLEGIKEXT_PREPROCESSPREDICTIONIK_OFFSET UNITYSDK_OFFSET(0x11AA86E0)
#define AMLEGIKEXT_RESETSTATEDEPENDPARAMS_OFFSET UNITYSDK_OFFSET(0x11AA3810)
#define AMLEGIKEXT_SETFOOTCONTROLPARAM_OFFSET UNITYSDK_OFFSET(0x11AACC20)
#define AMLEGIKEXT_SETSTATEDEPENDPARAMS_OFFSET UNITYSDK_OFFSET(0x11AA3630)
#define AMLEGIKEXT_SET_CURRENTFOOTANIMPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x11AA32D0)
#define AMLEGIKEXT_SET_CURRENTFOOTANIMPOSLOCAL_OFFSET UNITYSDK_OFFSET(0x11AA32B0)
#define AMLEGIKEXT_SET_CURRENTFOOTANIMROTGLOBAL_OFFSET UNITYSDK_OFFSET(0x11AA3330)
#define AMLEGIKEXT_SET_CURRENTFOOTANIMROTLOCAL_OFFSET UNITYSDK_OFFSET(0x11AA3310)
#define AMLEGIKEXT_SET_CURRENTFOOTLOCKEDPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x11AA32F0)
#define AMLEGIKEXT_SET_CURRENTPELVISANIMPOSLOCAL_OFFSET UNITYSDK_OFFSET(0x11AA3260)
#define AMLEGIKEXT_SET_CURRENTPELVISANIMROTLOCAL_OFFSET UNITYSDK_OFFSET(0x11AA3290)
#define AMLEGIKEXT_SET_CURRENTTOEPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x11AA3350)
#define AMLEGIKEXT_SET_DISABLEDAMPING_OFFSET UNITYSDK_OFFSET(0x11AA34A0)
#define AMLEGIKEXT_SET_ENABLEANIMDEBUG_OFFSET UNITYSDK_OFFSET(0x11AA3990)
#define AMLEGIKEXT_SET_ENABLEDEBUGONOFFGROUNDHEIGHT_OFFSET UNITYSDK_OFFSET(0x11AA39B0)
#define AMLEGIKEXT_SET_ENABLEFINALHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x11AA3930)
#define AMLEGIKEXT_SET_ENABLEFOOTMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0x11AA38D0)
#define AMLEGIKEXT_SET_ENABLELOCKFOOTDEBUG_OFFSET UNITYSDK_OFFSET(0x11AA38B0)
#define AMLEGIKEXT_SET_ENABLEORDINARYHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x11AA38F0)
#define AMLEGIKEXT_SET_ENABLEPELVISDEBUG_OFFSET UNITYSDK_OFFSET(0x11AA3890)
#define AMLEGIKEXT_SET_ENABLEPIKDRAWDEBUG_OFFSET UNITYSDK_OFFSET(0x11AA39D0)
#define AMLEGIKEXT_SET_ENABLEPIKHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x11AA3910)
#define AMLEGIKEXT_SET_ENABLEPREDICTIVEMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0x11AA39F0)
#define AMLEGIKEXT_SET_ENABLERAYCASTDEBUG_OFFSET UNITYSDK_OFFSET(0x11AA3970)
#define AMLEGIKEXT_SET_ENABLETARGETDEBUG_OFFSET UNITYSDK_OFFSET(0x11AA3950)
#define AMLEGIKEXT_SET_FOOTINDEXTOWATCH_OFFSET UNITYSDK_OFFSET(0x11AA3A30)
#define AMLEGIKEXT_SET_GIZMOSLASTTIME_OFFSET UNITYSDK_OFFSET(0x11AA3A10)
#define AMLEGIKEXT_SET_HIPDELTA_OFFSET UNITYSDK_OFFSET(0x11AA3220)
#define AMLEGIKEXT_SET_HIPHITCOLLIDER_OFFSET UNITYSDK_OFFSET(0x11AAC6D0)
#define AMLEGIKEXT_SET_HIPHITPOINT_OFFSET UNITYSDK_OFFSET(0x11AAC690)
#define AMLEGIKEXT_SET_IKWEIGHT_OFFSET UNITYSDK_OFFSET(0x11AA31F0)
#define AMLEGIKEXT_SET_ISONMOVINGPLATFORM_OFFSET UNITYSDK_OFFSET(0x11AA34B0)
#define AMLEGIKEXT_SET_LASTANIMPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x11AA3430)
#define AMLEGIKEXT_SET_LASTFOOTONGROUNDWEIGHT_OFFSET UNITYSDK_OFFSET(0x11AA3490)
#define AMLEGIKEXT_SET_LASTHITNORMALGLOBAL_OFFSET UNITYSDK_OFFSET(0x11AA3410)
#define AMLEGIKEXT_SET_LASTHITPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x11AA33F0)
#define AMLEGIKEXT_SET_LASTORDINARYHITPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x11AA33B0)
#define AMLEGIKEXT_SET_LASTPIKHITPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x11AA33D0)
#define AMLEGIKEXT_SET_LASTTARGETPELVISPOSLOCAL_OFFSET UNITYSDK_OFFSET(0x11AA3380)
#define AMLEGIKEXT_SET_LASTTARGETPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x11AA3450)
#define AMLEGIKEXT_SET_LASTTARGETROTGLOBAL_OFFSET UNITYSDK_OFFSET(0x11AA3470)
#define AMLEGIKEXT_START_OFFSET UNITYSDK_OFFSET(0x11AADA30)
#define AMLEGIKEXT_UPDATE_OFFSET UNITYSDK_OFFSET(0x11AADDD0)
#define AMLEGIKEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x11AAE980)

inline static constexpr unsigned int AMLegIKExt_TypeDefinitionIndex = 52192;
