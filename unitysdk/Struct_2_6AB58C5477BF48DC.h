...
#define STRUCT_2_6AB58C5477BF48DC__CTOR_1_OFFSET UNITYSDK_OFFSET(0x7499C0)
#define STRUCT_2_6AB58C5477BF48DC__CTOR_OFFSET UNITYSDK_OFFSET(0x749920)

inline static constexpr unsigned int Struct_2_6AB58C5477BF48DC_TypeDefinitionIndex = 72298;

struct alignas(8) Struct_2_6AB58C5477BF48DC
{
	::System::String* Field_2_3; // 0x10
	::Enum_3_3A280D225275881D Field_2_2; // 0x18
