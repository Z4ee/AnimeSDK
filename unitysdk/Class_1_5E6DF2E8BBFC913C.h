...
#define CLASS_1_5E6DF2E8BBFC913C_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19924000)
#define CLASS_1_5E6DF2E8BBFC913C_CLONE_OFFSET UNITYSDK_OFFSET(0x19923B80)
#define CLASS_1_5E6DF2E8BBFC913C_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19923D20)
#define CLASS_1_5E6DF2E8BBFC913C_EQUALS_OFFSET UNITYSDK_OFFSET(0x19923C00)
#define CLASS_1_5E6DF2E8BBFC913C_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19923DD0)
#define CLASS_1_5E6DF2E8BBFC913C_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x199241B0)
#define CLASS_1_5E6DF2E8BBFC913C_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19924110)
#define CLASS_1_5E6DF2E8BBFC913C_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x19923BD0)
#define CLASS_1_5E6DF2E8BBFC913C_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19923A40)
#define CLASS_1_5E6DF2E8BBFC913C_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x19923BE0)
#define CLASS_1_5E6DF2E8BBFC913C_METHOD_1_F9594A5160DEEC20_OFFSET UNITYSDK_OFFSET(0x19923BF0)
#define CLASS_1_5E6DF2E8BBFC913C_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19923AA0)
#define CLASS_1_5E6DF2E8BBFC913C_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19923EC0)
#define CLASS_1_5E6DF2E8BBFC913C_WRITETO_OFFSET UNITYSDK_OFFSET(0x19923F20)
#define CLASS_1_5E6DF2E8BBFC913C__CCTOR_OFFSET UNITYSDK_OFFSET(0x19924290)
#define CLASS_1_5E6DF2E8BBFC913C__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19923AF0)
#define CLASS_1_5E6DF2E8BBFC913C__CTOR_OFFSET UNITYSDK_OFFSET(0x19923AB0)

inline static constexpr unsigned int Class_1_5E6DF2E8BBFC913C_TypeDefinitionIndex = 24984;
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Proto::ItemCost*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5E6DF2E8BBFC913C_TypeDefinitionIndex)->GetStaticField(0x5B6D0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_5E6DF2E8BBFC913C*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5E6DF2E8BBFC913C*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5E6DF2E8BBFC913C_TypeDefinitionIndex)->GetStaticField(0x5B6D8);
	}
	// static const ::System::Int32 Field_1_2 = 0xF; // 0x0
	// static const ::System::Int32 Field_1_4 = 0x1; // 0x0
	::Google::Protobuf::Collections::RepeatedField_1<::Proto::ItemCost*>* Field_1_6; // 0x10
