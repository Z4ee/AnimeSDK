...
#define MICROSOFT_WIN32_SESSIONENDINGEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C2DAFE0)
#define MICROSOFT_WIN32_SESSIONENDINGEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C2DB020)
#define MICROSOFT_WIN32_SESSIONENDINGEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C2DAFA0)
#define MICROSOFT_WIN32_SESSIONENDINGEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2DAF60)

namespace Microsoft::Win32
{
	inline static constexpr unsigned int SessionEndingEventHandler_TypeDefinitionIndex = 4300;
