...
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_CLOSE_OFFSET UNITYSDK_OFFSET(0x1BB4B750)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_COMBINENAME_OFFSET UNITYSDK_OFFSET(0x1BB4B620)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_FLUSH_OFFSET UNITYSDK_OFFSET(0x1BB4B650)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_GENERATEEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1BB4B090)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_GETBINARYVALUE_OFFSET UNITYSDK_OFFSET(0x1BB4B210)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_GETHANDLE_OFFSET UNITYSDK_OFFSET(0x1BB4A8A0)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_GETSUBKEYNAMES_OFFSET UNITYSDK_OFFSET(0x1BB4B8F0)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1BB4A940)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_ISHANDLEVALID_OFFSET UNITYSDK_OFFSET(0x1BB4A920)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_OPENSUBKEY_OFFSET UNITYSDK_OFFSET(0x1BB4B460)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_REGCLOSEKEY_OFFSET UNITYSDK_OFFSET(0x1BB49C60)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_REGENUMKEYEX_OFFSET UNITYSDK_OFFSET(0x1BB49E10)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_REGFLUSHKEY_OFFSET UNITYSDK_OFFSET(0x1BB49CE0)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_REGOPENKEYEX_OFFSET UNITYSDK_OFFSET(0x1BB49D60)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_REGQUERYINFOKEY_OFFSET UNITYSDK_OFFSET(0x1BB4A570)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_REGQUERYVALUEEX_1_OFFSET UNITYSDK_OFFSET(0x1BB4A190)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_REGQUERYVALUEEX_2_OFFSET UNITYSDK_OFFSET(0x1BB4A3D0)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_REGQUERYVALUEEX_3_OFFSET UNITYSDK_OFFSET(0x1BB4A4A0)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_REGQUERYVALUEEX_OFFSET UNITYSDK_OFFSET(0x1BB4A0C0)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_SUBKEYCOUNT_OFFSET UNITYSDK_OFFSET(0x1BB4B2F0)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BB4BB90)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB47930)
