...
#define MICROSOFT_WIN32_TIMERELAPSEDEVENTARGS_GET_TIMERID_OFFSET UNITYSDK_OFFSET(0x1E7DACF0)
#define MICROSOFT_WIN32_TIMERELAPSEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7DACB0)
