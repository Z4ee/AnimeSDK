...
#define MICROSOFT_WIN32_EXPANDSTRING_EXPAND_OFFSET UNITYSDK_OFFSET(0x1AC3FC50)
#define MICROSOFT_WIN32_EXPANDSTRING_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AC3FC40)
#define MICROSOFT_WIN32_EXPANDSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC3FC30)
