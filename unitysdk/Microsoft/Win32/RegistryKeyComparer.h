...
#define MICROSOFT_WIN32_REGISTRYKEYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D17FB80)
#define MICROSOFT_WIN32_REGISTRYKEYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D17FC90)
#define MICROSOFT_WIN32_REGISTRYKEYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D17FD70)

namespace Microsoft::Win32
{
	inline static constexpr unsigned int RegistryKeyComparer_TypeDefinitionIndex = 96;
