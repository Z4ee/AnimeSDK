...
#define MICROSOFT_WIN32_USERPREFERENCECHANGEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C6F1670)
#define MICROSOFT_WIN32_USERPREFERENCECHANGEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C6F16B0)
#define MICROSOFT_WIN32_USERPREFERENCECHANGEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C6F1630)
#define MICROSOFT_WIN32_USERPREFERENCECHANGEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6F15F0)

namespace Microsoft::Win32
{
	inline static constexpr unsigned int UserPreferenceChangedEventHandler_TypeDefinitionIndex = 4307;
