...
#define MICROSOFT_WIN32_NATIVEMETHODS_CLOSEPROCESS_OFFSET UNITYSDK_OFFSET(0x1B1B08E0)
#define MICROSOFT_WIN32_NATIVEMETHODS_DUPLICATEHANDLE_1_OFFSET UNITYSDK_OFFSET(0x1B1B01F0)
#define MICROSOFT_WIN32_NATIVEMETHODS_DUPLICATEHANDLE_OFFSET UNITYSDK_OFFSET(0x1B1B0050)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETCURRENTPROCESSID_OFFSET UNITYSDK_OFFSET(0x1B1B0770)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETCURRENTPROCESS_OFFSET UNITYSDK_OFFSET(0x1B1B0300)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETEXITCODEPROCESS_1_OFFSET UNITYSDK_OFFSET(0x1B1B0330)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETEXITCODEPROCESS_OFFSET UNITYSDK_OFFSET(0x1B1B0310)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETPRIORITYCLASS_1_OFFSET UNITYSDK_OFFSET(0x1B1B0790)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETPRIORITYCLASS_OFFSET UNITYSDK_OFFSET(0x1B1B0780)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETPROCESSTIMES_1_OFFSET UNITYSDK_OFFSET(0x1B1B06D0)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETPROCESSTIMES_OFFSET UNITYSDK_OFFSET(0x1B1B06C0)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETPROCESSWORKINGSETSIZE_1_OFFSET UNITYSDK_OFFSET(0x1B1B0570)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETPROCESSWORKINGSETSIZE_OFFSET UNITYSDK_OFFSET(0x1B1B0560)
#define MICROSOFT_WIN32_NATIVEMETHODS_SETPRIORITYCLASS_1_OFFSET UNITYSDK_OFFSET(0x1B1B0840)
#define MICROSOFT_WIN32_NATIVEMETHODS_SETPRIORITYCLASS_OFFSET UNITYSDK_OFFSET(0x1B1B0830)
#define MICROSOFT_WIN32_NATIVEMETHODS_SETPROCESSWORKINGSETSIZE_1_OFFSET UNITYSDK_OFFSET(0x1B1B0620)
#define MICROSOFT_WIN32_NATIVEMETHODS_SETPROCESSWORKINGSETSIZE_OFFSET UNITYSDK_OFFSET(0x1B1B0610)
#define MICROSOFT_WIN32_NATIVEMETHODS_TERMINATEPROCESS_1_OFFSET UNITYSDK_OFFSET(0x1B1B0410)
#define MICROSOFT_WIN32_NATIVEMETHODS_TERMINATEPROCESS_OFFSET UNITYSDK_OFFSET(0x1B1B0400)
#define MICROSOFT_WIN32_NATIVEMETHODS_WAITFORINPUTIDLE_1_OFFSET UNITYSDK_OFFSET(0x1B1B04C0)
#define MICROSOFT_WIN32_NATIVEMETHODS_WAITFORINPUTIDLE_OFFSET UNITYSDK_OFFSET(0x1B1B04B0)
