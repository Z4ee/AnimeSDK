...
#define MICROSOFT_WIN32_NATIVEMETHODS_CLOSEPROCESS_OFFSET UNITYSDK_OFFSET(0x18FA2850)
#define MICROSOFT_WIN32_NATIVEMETHODS_DUPLICATEHANDLE_1_OFFSET UNITYSDK_OFFSET(0x18FA2160)
#define MICROSOFT_WIN32_NATIVEMETHODS_DUPLICATEHANDLE_OFFSET UNITYSDK_OFFSET(0x18FA1FC0)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETCURRENTPROCESSID_OFFSET UNITYSDK_OFFSET(0x18FA26E0)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETCURRENTPROCESS_OFFSET UNITYSDK_OFFSET(0x18FA2270)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETEXITCODEPROCESS_1_OFFSET UNITYSDK_OFFSET(0x18FA22A0)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETEXITCODEPROCESS_OFFSET UNITYSDK_OFFSET(0x18FA2280)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETPRIORITYCLASS_1_OFFSET UNITYSDK_OFFSET(0x18FA2700)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETPRIORITYCLASS_OFFSET UNITYSDK_OFFSET(0x18FA26F0)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETPROCESSTIMES_1_OFFSET UNITYSDK_OFFSET(0x18FA2640)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETPROCESSTIMES_OFFSET UNITYSDK_OFFSET(0x18FA2630)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETPROCESSWORKINGSETSIZE_1_OFFSET UNITYSDK_OFFSET(0x18FA24E0)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETPROCESSWORKINGSETSIZE_OFFSET UNITYSDK_OFFSET(0x18FA24D0)
#define MICROSOFT_WIN32_NATIVEMETHODS_SETPRIORITYCLASS_1_OFFSET UNITYSDK_OFFSET(0x18FA27B0)
#define MICROSOFT_WIN32_NATIVEMETHODS_SETPRIORITYCLASS_OFFSET UNITYSDK_OFFSET(0x18FA27A0)
#define MICROSOFT_WIN32_NATIVEMETHODS_SETPROCESSWORKINGSETSIZE_1_OFFSET UNITYSDK_OFFSET(0x18FA2590)
#define MICROSOFT_WIN32_NATIVEMETHODS_SETPROCESSWORKINGSETSIZE_OFFSET UNITYSDK_OFFSET(0x18FA2580)
#define MICROSOFT_WIN32_NATIVEMETHODS_TERMINATEPROCESS_1_OFFSET UNITYSDK_OFFSET(0x18FA2380)
#define MICROSOFT_WIN32_NATIVEMETHODS_TERMINATEPROCESS_OFFSET UNITYSDK_OFFSET(0x18FA2370)
#define MICROSOFT_WIN32_NATIVEMETHODS_WAITFORINPUTIDLE_1_OFFSET UNITYSDK_OFFSET(0x18FA2430)
#define MICROSOFT_WIN32_NATIVEMETHODS_WAITFORINPUTIDLE_OFFSET UNITYSDK_OFFSET(0x18FA2420)

namespace Microsoft::Win32
{
	inline static constexpr unsigned int NativeMethods_TypeDefinitionIndex = 2653;
	...
	public:
		...
		// static const ::System::Int32 Field_1_14 = 0x100000; // 0x0
