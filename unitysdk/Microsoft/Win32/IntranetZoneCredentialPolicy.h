...
#define MICROSOFT_WIN32_INTRANETZONECREDENTIALPOLICY_SHOULDSENDCREDENTIAL_OFFSET UNITYSDK_OFFSET(0x1DD0AC30)
#define MICROSOFT_WIN32_INTRANETZONECREDENTIALPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD0ABF0)
