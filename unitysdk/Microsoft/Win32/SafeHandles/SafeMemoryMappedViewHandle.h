...
#define MICROSOFT_WIN32_SAFEHANDLES_SAFEMEMORYMAPPEDVIEWHANDLE_FLUSH_OFFSET UNITYSDK_OFFSET(0x19A26740)
#define MICROSOFT_WIN32_SAFEHANDLES_SAFEMEMORYMAPPEDVIEWHANDLE_RELEASEHANDLE_OFFSET UNITYSDK_OFFSET(0x19A26760)
#define MICROSOFT_WIN32_SAFEHANDLES_SAFEMEMORYMAPPEDVIEWHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19A266D0)

namespace Microsoft::Win32::SafeHandles
{
	inline static constexpr unsigned int SafeMemoryMappedViewHandle_TypeDefinitionIndex = 3096;
