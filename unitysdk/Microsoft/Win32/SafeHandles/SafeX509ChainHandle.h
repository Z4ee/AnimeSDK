...
#define MICROSOFT_WIN32_SAFEHANDLES_SAFEX509CHAINHANDLE_RELEASEHANDLE_OFFSET UNITYSDK_OFFSET(0x1A236DA0)
#define MICROSOFT_WIN32_SAFEHANDLES_SAFEX509CHAINHANDLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A236DF0)
#define MICROSOFT_WIN32_SAFEHANDLES_SAFEX509CHAINHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A236D40)

namespace Microsoft::Win32::SafeHandles
{
	inline static constexpr unsigned int SafeX509ChainHandle_TypeDefinitionIndex = 2655;
