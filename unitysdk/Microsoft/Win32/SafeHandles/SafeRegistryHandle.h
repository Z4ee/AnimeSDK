...
#define MICROSOFT_WIN32_SAFEHANDLES_SAFEREGISTRYHANDLE_RELEASEHANDLE_OFFSET UNITYSDK_OFFSET(0x16DDD710)
#define MICROSOFT_WIN32_SAFEHANDLES_SAFEREGISTRYHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16DDCAB0)
