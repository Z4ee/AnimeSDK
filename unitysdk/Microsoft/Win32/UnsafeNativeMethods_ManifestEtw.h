...
#define MICROSOFT_WIN32_UNSAFENATIVEMETHODS_MANIFESTETW_ENUMERATETRACEGUIDSEX_OFFSET UNITYSDK_OFFSET(0x161629A0)
#define MICROSOFT_WIN32_UNSAFENATIVEMETHODS_MANIFESTETW_EVENTACTIVITYIDCONTROL_OFFSET UNITYSDK_OFFSET(0x16162870)
#define MICROSOFT_WIN32_UNSAFENATIVEMETHODS_MANIFESTETW_EVENTREGISTER_OFFSET UNITYSDK_OFFSET(0x16162530)
#define MICROSOFT_WIN32_UNSAFENATIVEMETHODS_MANIFESTETW_EVENTSETINFORMATION_OFFSET UNITYSDK_OFFSET(0x16162900)
#define MICROSOFT_WIN32_UNSAFENATIVEMETHODS_MANIFESTETW_EVENTUNREGISTER_OFFSET UNITYSDK_OFFSET(0x161625D0)
#define MICROSOFT_WIN32_UNSAFENATIVEMETHODS_MANIFESTETW_EVENTWRITETRANSFERWRAPPER_OFFSET UNITYSDK_OFFSET(0x16162650)
#define MICROSOFT_WIN32_UNSAFENATIVEMETHODS_MANIFESTETW_EVENTWRITETRANSFER_OFFSET UNITYSDK_OFFSET(0x161627B0)
