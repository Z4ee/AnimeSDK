...
#define MICROSOFT_WIN32_UNSAFENATIVEMETHODS_MANIFESTETW_ENUMERATETRACEGUIDSEX_OFFSET UNITYSDK_OFFSET(0x155CD060)
#define MICROSOFT_WIN32_UNSAFENATIVEMETHODS_MANIFESTETW_EVENTACTIVITYIDCONTROL_OFFSET UNITYSDK_OFFSET(0x155CCF30)
#define MICROSOFT_WIN32_UNSAFENATIVEMETHODS_MANIFESTETW_EVENTREGISTER_OFFSET UNITYSDK_OFFSET(0x155CCBF0)
#define MICROSOFT_WIN32_UNSAFENATIVEMETHODS_MANIFESTETW_EVENTSETINFORMATION_OFFSET UNITYSDK_OFFSET(0x155CCFC0)
#define MICROSOFT_WIN32_UNSAFENATIVEMETHODS_MANIFESTETW_EVENTUNREGISTER_OFFSET UNITYSDK_OFFSET(0x155CCC90)
#define MICROSOFT_WIN32_UNSAFENATIVEMETHODS_MANIFESTETW_EVENTWRITETRANSFERWRAPPER_OFFSET UNITYSDK_OFFSET(0x155CCD10)
#define MICROSOFT_WIN32_UNSAFENATIVEMETHODS_MANIFESTETW_EVENTWRITETRANSFER_OFFSET UNITYSDK_OFFSET(0x155CCE70)
