...
#define MICROSOFT_WIN32_WIN32NATIVE_GETCURRENTPROCESSID_OFFSET UNITYSDK_OFFSET(0x16163100)
#define MICROSOFT_WIN32_WIN32NATIVE_GETMESSAGE_OFFSET UNITYSDK_OFFSET(0x16163020)
#define MICROSOFT_WIN32_WIN32NATIVE_MAKEHRFROMERRORCODE_OFFSET UNITYSDK_OFFSET(0x161630F0)
