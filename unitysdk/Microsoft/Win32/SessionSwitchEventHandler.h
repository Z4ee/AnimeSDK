...
#define MICROSOFT_WIN32_SESSIONSWITCHEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A7D1670)
#define MICROSOFT_WIN32_SESSIONSWITCHEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A7D16B0)
#define MICROSOFT_WIN32_SESSIONSWITCHEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A7D1630)
#define MICROSOFT_WIN32_SESSIONSWITCHEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7D15F0)

namespace Microsoft::Win32
{
	inline static constexpr unsigned int SessionSwitchEventHandler_TypeDefinitionIndex = 4304;
