...
#define MICROSOFT_WIN32_TIMERELAPSEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19BA6630)
#define MICROSOFT_WIN32_TIMERELAPSEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19BA6670)
#define MICROSOFT_WIN32_TIMERELAPSEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19BA65F0)
#define MICROSOFT_WIN32_TIMERELAPSEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19BA65B0)

namespace Microsoft::Win32
{
	inline static constexpr unsigned int TimerElapsedEventHandler_TypeDefinitionIndex = 4306;
