...
#define MICROSOFT_WIN32_USERPREFERENCECHANGINGEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x191FB8B0)
#define MICROSOFT_WIN32_USERPREFERENCECHANGINGEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x191FB8F0)
#define MICROSOFT_WIN32_USERPREFERENCECHANGINGEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x191FB870)
#define MICROSOFT_WIN32_USERPREFERENCECHANGINGEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x191FB830)

namespace Microsoft::Win32
{
	inline static constexpr unsigned int UserPreferenceChangingEventHandler_TypeDefinitionIndex = 4311;
