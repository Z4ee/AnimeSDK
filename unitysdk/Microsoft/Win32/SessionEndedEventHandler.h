...
#define MICROSOFT_WIN32_SESSIONENDEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A7D1570)
#define MICROSOFT_WIN32_SESSIONENDEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A7D15B0)
#define MICROSOFT_WIN32_SESSIONENDEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A7D1530)
#define MICROSOFT_WIN32_SESSIONENDEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7D14F0)

namespace Microsoft::Win32
{
	inline static constexpr unsigned int SessionEndedEventHandler_TypeDefinitionIndex = 4299;
