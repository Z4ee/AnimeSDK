...
#define MICROSOFT_CSHARP_CSHARPCODEPROVIDER_CREATECOMPILER_OFFSET UNITYSDK_OFFSET(0x1CBEC600)
#define MICROSOFT_CSHARP_CSHARPCODEPROVIDER_CREATEGENERATOR_OFFSET UNITYSDK_OFFSET(0x1CBEC640)
#define MICROSOFT_CSHARP_CSHARPCODEPROVIDER_GENERATECODEFROMMEMBER_OFFSET UNITYSDK_OFFSET(0x1CBEC680)
#define MICROSOFT_CSHARP_CSHARPCODEPROVIDER_GETCONVERTER_OFFSET UNITYSDK_OFFSET(0x1CBEC6C0)
#define MICROSOFT_CSHARP_CSHARPCODEPROVIDER_GET_FILEEXTENSION_OFFSET UNITYSDK_OFFSET(0x1CBEC5C0)
#define MICROSOFT_CSHARP_CSHARPCODEPROVIDER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CBEC580)
#define MICROSOFT_CSHARP_CSHARPCODEPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBEC540)
