...
#define MICROSOFT_CSHARP_CSHARPCODEPROVIDER_CREATECOMPILER_OFFSET UNITYSDK_OFFSET(0x1B738180)
#define MICROSOFT_CSHARP_CSHARPCODEPROVIDER_CREATEGENERATOR_OFFSET UNITYSDK_OFFSET(0x1B7381C0)
#define MICROSOFT_CSHARP_CSHARPCODEPROVIDER_GENERATECODEFROMMEMBER_OFFSET UNITYSDK_OFFSET(0x1B738200)
#define MICROSOFT_CSHARP_CSHARPCODEPROVIDER_GETCONVERTER_OFFSET UNITYSDK_OFFSET(0x1B738240)
#define MICROSOFT_CSHARP_CSHARPCODEPROVIDER_GET_FILEEXTENSION_OFFSET UNITYSDK_OFFSET(0x1B738140)
#define MICROSOFT_CSHARP_CSHARPCODEPROVIDER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B738100)
#define MICROSOFT_CSHARP_CSHARPCODEPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7380C0)

namespace Microsoft::CSharp
{
	inline static constexpr unsigned int CSharpCodeProvider_TypeDefinitionIndex = 4313;
