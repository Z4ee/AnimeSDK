...
#define CLASS_1_57A077DBC3E5B8EF_METHOD_1_870444CFA4CA9AF1_OFFSET UNITYSDK_OFFSET(0x17BC02F0)
#define CLASS_1_57A077DBC3E5B8EF_METHOD_1_AC0195DC691C588E_OFFSET UNITYSDK_OFFSET(0x17BC0800)
#define CLASS_1_57A077DBC3E5B8EF_METHOD_1_DFF3374D26AD1858_OFFSET UNITYSDK_OFFSET(0x17BC0290)
#define CLASS_1_57A077DBC3E5B8EF__CTOR_OFFSET UNITYSDK_OFFSET(0x17BC01C0)

inline static constexpr unsigned int Class_1_57A077DBC3E5B8EF_TypeDefinitionIndex = 79877;

class Class_1_57A077DBC3E5B8EF : public ::System::Object
{
public:
	::Class_1_2C0D14CC520BF272* NABLOINKCCC; // 0x10
	::RPG::Client::FateRin::Logging::ILogger* JKCNFDEAMDJ; // 0x18
	::Class_0_16E4307DCC419505_1381* ILMLNDPKFNO; // 0x20
	::Il2CppArray<::RPG::GameCore::FixPoint>* ACFBFHAOFFI; // 0x28
	::Class_1_384B00F01F0CAFA9* LGFABLFAJBI; // 0x30
