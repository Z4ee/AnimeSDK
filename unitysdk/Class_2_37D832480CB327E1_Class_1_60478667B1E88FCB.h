...
#define CLASS_2_37D832480CB327E1_CLASS_1_60478667B1E88FCB__CTOR_OFFSET UNITYSDK_OFFSET(0x12E93FC0)
...
public:
	...
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* MLNPMBIDPIF; // 0x18
	::System::String* BAHLDFMIJFG; // 0x20
	::UnityEngine::Vector3 LBJPPLGGBNN; // 0x28
	::UnityEngine::Quaternion POHDKIIOAJB; // 0x34
	::System::Boolean OHLOEABKKME; // 0x44
	::System::Boolean GMFPEGFIKAE; // 0x45
