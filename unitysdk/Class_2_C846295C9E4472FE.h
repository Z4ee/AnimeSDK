...
#define CLASS_2_C846295C9E4472FE_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x11BEE9B0)
#define CLASS_2_C846295C9E4472FE_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x11BEEC90)
#define CLASS_2_C846295C9E4472FE_METHOD_2_00D9C214C63942A7_OFFSET UNITYSDK_OFFSET(0x11BEC5B0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0x11BE9EE0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_1A7F9F3B13A09C96_OFFSET UNITYSDK_OFFSET(0x11BE9D40)
#define CLASS_2_C846295C9E4472FE_METHOD_2_1DF1FA98B6A6B5EE_OFFSET UNITYSDK_OFFSET(0x11BEA5C0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_229E068D4C618706_OFFSET UNITYSDK_OFFSET(0x11BED1F0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_39845204DD04FC33_OFFSET UNITYSDK_OFFSET(0x11BEA320)
#define CLASS_2_C846295C9E4472FE_METHOD_2_3CE8A1831DA14AB7_OFFSET UNITYSDK_OFFSET(0x11BEA1E0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_3F620310DEF68809_OFFSET UNITYSDK_OFFSET(0x11BED9D0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_45E1B5C827BB0063_OFFSET UNITYSDK_OFFSET(0x11BE9E90)
#define CLASS_2_C846295C9E4472FE_METHOD_2_48DCE3E9EBCCF56D_OFFSET UNITYSDK_OFFSET(0x11BEDC60)
#define CLASS_2_C846295C9E4472FE_METHOD_2_4927ACC1FFCD0949_OFFSET UNITYSDK_OFFSET(0x11BEB060)
#define CLASS_2_C846295C9E4472FE_METHOD_2_494DEE1E2F1B0134_OFFSET UNITYSDK_OFFSET(0x11BEAD90)
#define CLASS_2_C846295C9E4472FE_METHOD_2_4EF39E24235C05BA_OFFSET UNITYSDK_OFFSET(0x11BEA400)
#define CLASS_2_C846295C9E4472FE_METHOD_2_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0x11BEF0A0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x11BEEFD0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_5B176AC622BC2444_OFFSET UNITYSDK_OFFSET(0x11BEAF90)
#define CLASS_2_C846295C9E4472FE_METHOD_2_5E6C171886C48967_OFFSET UNITYSDK_OFFSET(0x11BEE2B0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_64B7F5DF4C560641_OFFSET UNITYSDK_OFFSET(0x11BEB0D0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_679BB2AF51138481_OFFSET UNITYSDK_OFFSET(0x11BEA170)
#define CLASS_2_C846295C9E4472FE_METHOD_2_6BEB244CD2E6EADC_OFFSET UNITYSDK_OFFSET(0x11BEE040)
#define CLASS_2_C846295C9E4472FE_METHOD_2_8C3DB70FFBBF01C7_OFFSET UNITYSDK_OFFSET(0x11BEE5B0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_8C40D8A084322E50_OFFSET UNITYSDK_OFFSET(0x11BEA750)
#define CLASS_2_C846295C9E4472FE_METHOD_2_95D5F1592312589E_1_OFFSET UNITYSDK_OFFSET(0x11BEACF0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_95D5F1592312589E_OFFSET UNITYSDK_OFFSET(0x11BEA7B0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x11BEB5E0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_9805F2901C5A7FC1_OFFSET UNITYSDK_OFFSET(0x11BED0F0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0x11BEE7E0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_A27D06F9481FAFDB_2_OFFSET UNITYSDK_OFFSET(0x11BEE950)
#define CLASS_2_C846295C9E4472FE_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0x11BEE660)
#define CLASS_2_C846295C9E4472FE_METHOD_2_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0x11BEE530)
#define CLASS_2_C846295C9E4472FE_METHOD_2_A80EDC4C30C0B325_OFFSET UNITYSDK_OFFSET(0x11BEA840)
#define CLASS_2_C846295C9E4472FE_METHOD_2_A88B36294D55B85C_OFFSET UNITYSDK_OFFSET(0x11BE9560)
#define CLASS_2_C846295C9E4472FE_METHOD_2_AA957E371B77E633_OFFSET UNITYSDK_OFFSET(0x11BE98D0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_B81305259F90066A_OFFSET UNITYSDK_OFFSET(0x11BEB840)
#define CLASS_2_C846295C9E4472FE_METHOD_2_BC9D09BED49A4927_OFFSET UNITYSDK_OFFSET(0x11BED6E0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_C1C0CB2C8B6124DE_OFFSET UNITYSDK_OFFSET(0x11BEE840)
#define CLASS_2_C846295C9E4472FE_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x11BE9D00)
#define CLASS_2_C846295C9E4472FE_METHOD_2_D5E5EC1B4538DDD1_OFFSET UNITYSDK_OFFSET(0x11BEF100)
#define CLASS_2_C846295C9E4472FE_METHOD_2_E28394F67B2A3D25_OFFSET UNITYSDK_OFFSET(0x11BEBD30)
#define CLASS_2_C846295C9E4472FE_METHOD_2_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0x11BEA620)
#define CLASS_2_C846295C9E4472FE_METHOD_2_EEAEEB43B404284D_OFFSET UNITYSDK_OFFSET(0x11BEE450)
#define CLASS_2_C846295C9E4472FE_METHOD_2_EF791A79C773DCBB_OFFSET UNITYSDK_OFFSET(0x11BEB710)
#define CLASS_2_C846295C9E4472FE_METHOD_2_F343645A04DC6AEF_OFFSET UNITYSDK_OFFSET(0x11BEC600)
#define CLASS_2_C846295C9E4472FE_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x11BEE710)
#define CLASS_2_C846295C9E4472FE_METHOD_2_F6B522B422985D1A_OFFSET UNITYSDK_OFFSET(0x11BEB680)
#define CLASS_2_C846295C9E4472FE_METHOD_2_F7460366379D5568_OFFSET UNITYSDK_OFFSET(0x11BEC2F0)
#define CLASS_2_C846295C9E4472FE_METHOD_2_F7BA13C72A6B3F58_OFFSET UNITYSDK_OFFSET(0x11BE9AE0)
#define CLASS_2_C846295C9E4472FE__CTOR_OFFSET UNITYSDK_OFFSET(0x11BEEF40)
#define CLASS_2_C846295C9E4472FE__ONBIND_OFFSET UNITYSDK_OFFSET(0x11BE9500)
#define CLASS_2_C846295C9E4472FE__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x11BE9E30)
#define CLASS_2_C846295C9E4472FE__ONTICK_OFFSET UNITYSDK_OFFSET(0x11BE9870)
#define CLASS_2_C846295C9E4472FE___IFIXBASEPROXY_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x11BEF1D0)
#define CLASS_2_C846295C9E4472FE___IFIXBASEPROXY_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x11BEF230)
#define CLASS_2_C846295C9E4472FE___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x11BEEF70)
#define CLASS_2_C846295C9E4472FE___IFIXBASEPROXY__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x11BEF170)
#define CLASS_2_C846295C9E4472FE___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0x11BEF030)

inline static constexpr unsigned int Class_2_C846295C9E4472FE_TypeDefinitionIndex = 66362;

class Class_2_C846295C9E4472FE : public ::Class_1_CA217ABF4E3B4F3F
{
public:
	::RPG::Client::ScreenEventHandler* Field_2_0; // 0x60
	::RPG::GameCore::BattleInstance* Field_2_1; // 0x68
	::Class_1_48FB41EE27FB816A* Field_2_3; // 0x70
	::RPG::GameCore::LevelUIComponent* Field_2_2; // 0x78
	::System::String* Field_2_20; // 0x80
	::RPG::GameCore::EntityManager* Field_2_4; // 0x88
	::RPG::GameCore::TeamDataComponent* Field_2_5; // 0x90
	::RPG::Client::TextID Field_2_10; // 0x98
	::System::Single Field_2_9; // 0xA8
	::System::Single Field_2_21; // 0xAC
	::RPG::GameCore::GameModeState Field_2_6; // 0xB0
	::System::Single Field_2_11; // 0xB4
	::System::Boolean Field_2_22; // 0xB8
	::System::Boolean Field_2_13; // 0xB9
	::System::Single Field_2_19; // 0xBC
	::UnityEngine::Vector2 Field_2_16; // 0xC0
