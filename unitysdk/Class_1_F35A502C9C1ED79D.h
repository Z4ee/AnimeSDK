...
#define CLASS_1_F35A502C9C1ED79D_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x195B6E50)
#define CLASS_1_F35A502C9C1ED79D_CLONE_OFFSET UNITYSDK_OFFSET(0x195B68D0)
#define CLASS_1_F35A502C9C1ED79D_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x195B6AB0)
#define CLASS_1_F35A502C9C1ED79D_EQUALS_OFFSET UNITYSDK_OFFSET(0x195B69B0)
#define CLASS_1_F35A502C9C1ED79D_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x195B6B70)
#define CLASS_1_F35A502C9C1ED79D_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x195B70C0)
#define CLASS_1_F35A502C9C1ED79D_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x195B7050)
#define CLASS_1_F35A502C9C1ED79D_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x195B6990)
#define CLASS_1_F35A502C9C1ED79D_METHOD_1_3163C288F3AE2966_OFFSET UNITYSDK_OFFSET(0x195B6930)
#define CLASS_1_F35A502C9C1ED79D_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x195B6770)
#define CLASS_1_F35A502C9C1ED79D_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x195B6980)
#define CLASS_1_F35A502C9C1ED79D_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x195B69A0)
#define CLASS_1_F35A502C9C1ED79D_METHOD_1_C74E50CBD41F0264_1_OFFSET UNITYSDK_OFFSET(0x195B6970)
#define CLASS_1_F35A502C9C1ED79D_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x195B6950)
#define CLASS_1_F35A502C9C1ED79D_METHOD_1_CE81D059476B1F49_OFFSET UNITYSDK_OFFSET(0x195B6920)
#define CLASS_1_F35A502C9C1ED79D_METHOD_1_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x195B6960)
#define CLASS_1_F35A502C9C1ED79D_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x195B6940)
#define CLASS_1_F35A502C9C1ED79D_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x195B67D0)
#define CLASS_1_F35A502C9C1ED79D_TOSTRING_OFFSET UNITYSDK_OFFSET(0x195B6CA0)
#define CLASS_1_F35A502C9C1ED79D_WRITETO_OFFSET UNITYSDK_OFFSET(0x195B6D00)
#define CLASS_1_F35A502C9C1ED79D__CCTOR_OFFSET UNITYSDK_OFFSET(0x195B71E0)
#define CLASS_1_F35A502C9C1ED79D__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195B6830)
#define CLASS_1_F35A502C9C1ED79D__CTOR_OFFSET UNITYSDK_OFFSET(0x195B67E0)

inline static constexpr unsigned int Class_1_F35A502C9C1ED79D_TypeDefinitionIndex = 28882;
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F35A502C9C1ED79D_TypeDefinitionIndex)->GetStaticField(0x521A0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_F35A502C9C1ED79D*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_F35A502C9C1ED79D*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F35A502C9C1ED79D_TypeDefinitionIndex)->GetStaticField(0x521A8);
	}
