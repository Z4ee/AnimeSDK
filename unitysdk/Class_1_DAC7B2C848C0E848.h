...
#define CLASS_1_DAC7B2C848C0E848_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x1F6E03B0)
#define CLASS_1_DAC7B2C848C0E848_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1F6E0340)
#define CLASS_1_DAC7B2C848C0E848__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F6E02C0)
#define CLASS_1_DAC7B2C848C0E848__CTOR_OFFSET UNITYSDK_OFFSET(0x1F6E0240)

inline static constexpr unsigned int Class_1_DAC7B2C848C0E848_TypeDefinitionIndex = 29396;
