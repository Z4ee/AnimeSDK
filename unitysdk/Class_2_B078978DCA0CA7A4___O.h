...
public:
	...
	{
		return (::System::Comparison_1<::RPG::GameCore::GameEntity*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_B078978DCA0CA7A4___O_TypeDefinitionIndex)->GetStaticField(0x5D440);
	}
};
