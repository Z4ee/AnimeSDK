...
#define EXPRESSIONTESTCASE_ABILITYEXPRESSIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x2FED90)

inline static constexpr unsigned int ExpressionTestCase_AbilityExpressionInfo_TypeDefinitionIndex = 61622;
