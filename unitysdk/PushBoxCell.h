...
#define PUSHBOXCELL_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x7D80B0)
#define PUSHBOXCELL_EQUALS_OFFSET UNITYSDK_OFFSET(0x7D8050)
#define PUSHBOXCELL_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x17921E80)
#define PUSHBOXCELL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x68DAB0)
#define PUSHBOXCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x293FB0)
#define PUSHBOXCELL___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x7D80C0)

inline static constexpr unsigned int PushBoxCell_TypeDefinitionIndex = 56088;
