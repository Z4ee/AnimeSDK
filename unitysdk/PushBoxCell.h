...
#define PUSHBOXCELL_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x885090)
#define PUSHBOXCELL_EQUALS_OFFSET UNITYSDK_OFFSET(0x885030)
#define PUSHBOXCELL_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x18B44340)
#define PUSHBOXCELL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x825680)
#define PUSHBOXCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x312BA0)
#define PUSHBOXCELL___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x8850A0)

inline static constexpr unsigned int PushBoxCell_TypeDefinitionIndex = 70329;
