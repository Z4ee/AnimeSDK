...
#define CLASS_1_F3C7B0727419C065_METHOD_1_2ABED86F73FF5BC5_OFFSET UNITYSDK_OFFSET(0x14131BF0)
#define CLASS_1_F3C7B0727419C065_METHOD_1_BE3C6A087FF493A4_OFFSET UNITYSDK_OFFSET(0x14131B00)
#define CLASS_1_F3C7B0727419C065__CTOR_OFFSET UNITYSDK_OFFSET(0x14131C70)

inline static constexpr unsigned int Class_1_F3C7B0727419C065_TypeDefinitionIndex = 59146;
