...
#define CLASS_1_671780733A8844ED_GET_IDLELIVEPROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x17BD1730)
#define CLASS_1_671780733A8844ED_METHOD_1_1187FD85F8BDC1D1_OFFSET UNITYSDK_OFFSET(0x17BD29F0)
#define CLASS_1_671780733A8844ED_METHOD_1_59CF809F3C3FAAF4_OFFSET UNITYSDK_OFFSET(0x17BD2F30)
#define CLASS_1_671780733A8844ED_METHOD_1_A939D99766724EBC_OFFSET UNITYSDK_OFFSET(0x17BD16D0)
#define CLASS_1_671780733A8844ED_METHOD_1_D3A860C94F2DA104_OFFSET UNITYSDK_OFFSET(0x17BD1FC0)
#define CLASS_1_671780733A8844ED_METHOD_1_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x17BD1690)
#define CLASS_1_671780733A8844ED_METHOD_1_DD1F80BD94ED96B3_OFFSET UNITYSDK_OFFSET(0x17BD1750)
#define CLASS_1_671780733A8844ED_SET_IDLELIVEPROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x17BD1740)
#define CLASS_1_671780733A8844ED__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17BD1C70)
#define CLASS_1_671780733A8844ED__CTOR_OFFSET UNITYSDK_OFFSET(0x17BD1870)

inline static constexpr unsigned int Class_1_671780733A8844ED_TypeDefinitionIndex = 75029;

class Class_1_671780733A8844ED : public ::System::Object
{
public:
	::RPG::Client::ActivityIdleLive::IdleLiveDecimal NHKBABFADEK; // 0x10
	::System::Collections::Generic::List_1<::RPG::Client::ActivityIdleLive::IdleLiveDecimal>* ILOBNLFGNBM; // 0x28
	::System::String* FADILKPGCEM; // 0x30
	::RPG::Client::ActivityIdleLive::IdleLiveDecimal BECGKKEKNGI; // 0x38
	::RPG::Client::ActivityIdleLive::IdleLiveDecimal BCGEKLGHMFI; // 0x50
	::RPG::Client::ActivityIdleLive::IdleLiveDecimal MLCCAFBJIJD; // 0x68
	::RPG::Client::TextID FKFFDCCCGFE; // 0x80
	::System::Boolean GFLDACJFAAO; // 0x90
	::RPG::GameCore::IdleLiveAvatarPropertyType _IdleLivePropertyType_k__BackingField; // 0x94
	::RPG::GameCore::FixPoint IFFGPNJIIJI; // 0x98
