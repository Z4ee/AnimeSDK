...
#define CLASS_3_DB4C93C03AA9B0A7_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xA4E9B60)
#define CLASS_3_DB4C93C03AA9B0A7__CTOR_OFFSET UNITYSDK_OFFSET(0xA4E9B30)

inline static constexpr unsigned int Class_3_DB4C93C03AA9B0A7_TypeDefinitionIndex = 51605;
