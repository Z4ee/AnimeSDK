...
#define CLASS_1_23C1B7E6B450FFB8_8_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x195ADFF0)
#define CLASS_1_23C1B7E6B450FFB8_8_CLONE_OFFSET UNITYSDK_OFFSET(0x195ADAC0)
#define CLASS_1_23C1B7E6B450FFB8_8_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x195ADC00)
#define CLASS_1_23C1B7E6B450FFB8_8_EQUALS_OFFSET UNITYSDK_OFFSET(0x195ADBA0)
#define CLASS_1_23C1B7E6B450FFB8_8_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x195ADD70)
#define CLASS_1_23C1B7E6B450FFB8_8_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x195AE120)
#define CLASS_1_23C1B7E6B450FFB8_8_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x195AE0B0)
#define CLASS_1_23C1B7E6B450FFB8_8_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x195ADB40)
#define CLASS_1_23C1B7E6B450FFB8_8_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x195ADA00)
#define CLASS_1_23C1B7E6B450FFB8_8_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x195ADB50)
#define CLASS_1_23C1B7E6B450FFB8_8_METHOD_1_8633AE51B23EBDFD_1_OFFSET UNITYSDK_OFFSET(0x195ADB90)
#define CLASS_1_23C1B7E6B450FFB8_8_METHOD_1_8633AE51B23EBDFD_OFFSET UNITYSDK_OFFSET(0x195ADB70)
#define CLASS_1_23C1B7E6B450FFB8_8_METHOD_1_C229FF62B898C0B2_1_OFFSET UNITYSDK_OFFSET(0x195ADB80)
#define CLASS_1_23C1B7E6B450FFB8_8_METHOD_1_C229FF62B898C0B2_OFFSET UNITYSDK_OFFSET(0x195ADB60)
#define CLASS_1_23C1B7E6B450FFB8_8_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x195ADA60)
#define CLASS_1_23C1B7E6B450FFB8_8_TOSTRING_OFFSET UNITYSDK_OFFSET(0x195ADEC0)
#define CLASS_1_23C1B7E6B450FFB8_8_WRITETO_OFFSET UNITYSDK_OFFSET(0x195ADF20)
#define CLASS_1_23C1B7E6B450FFB8_8__CCTOR_OFFSET UNITYSDK_OFFSET(0x195AE1B0)
#define CLASS_1_23C1B7E6B450FFB8_8__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195ADA80)
#define CLASS_1_23C1B7E6B450FFB8_8__CTOR_OFFSET UNITYSDK_OFFSET(0x195ADA70)

inline static constexpr unsigned int Class_1_23C1B7E6B450FFB8_8_TypeDefinitionIndex = 27868;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_23C1B7E6B450FFB8_8*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_23C1B7E6B450FFB8_8_TypeDefinitionIndex)->GetStaticField(0x7D10);
	}
	...
	{
		return ((::System::Double(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_23C1B7E6B450FFB8_8_METHOD_1_C229FF62B898C0B2_1_OFFSET))(this);
	}

	::System::Void Method_1_8633AE51B23EBDFD_1(::System::Double a1)
	{
		return ((::System::Void(*)(::PVOID, ::System::Double))((::PBYTE)hIl2Cpp + CLASS_1_23C1B7E6B450FFB8_8_METHOD_1_8633AE51B23EBDFD_1_OFFSET))(this, a1);
	}
