...
#define CLASS_1_FFB8A2463BCB64C3_METHOD_1_27C97DD54FC313CD_OFFSET UNITYSDK_OFFSET(0xE2E5270)
#define CLASS_1_FFB8A2463BCB64C3_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xE2E4F20)
#define CLASS_1_FFB8A2463BCB64C3_METHOD_1_40FC6B4714090E98_OFFSET UNITYSDK_OFFSET(0xE2E5390)
#define CLASS_1_FFB8A2463BCB64C3_METHOD_1_4307B2A4B4A12C1A_1_OFFSET UNITYSDK_OFFSET(0xE2E5800)
#define CLASS_1_FFB8A2463BCB64C3_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xE2E5750)
#define CLASS_1_FFB8A2463BCB64C3_METHOD_1_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0xE2E4F70)
#define CLASS_1_FFB8A2463BCB64C3_METHOD_1_B5B5A333663EF42F_OFFSET UNITYSDK_OFFSET(0xE2E50B0)
#define CLASS_1_FFB8A2463BCB64C3__CTOR_OFFSET UNITYSDK_OFFSET(0xE2E58B0)
...
{
public:
	::System::Collections::Generic::List_1<::Class_1_76D576E4C3921565*>* JHLBFPBGGIN; // 0x10
	::RPG::GameCore::ConfigTrainDispatcher* EJJEEJENLDA; // 0x18
	::System::Collections::Generic::Dictionary_2<::System::String*, ::Class_1_76D576E4C3921565*>* PGMOEJGBLLG; // 0x20
