...
#define CLASS_3_601484553AD71CED_METHOD_3_2166CB70112347ED_OFFSET UNITYSDK_OFFSET(0x1840C4C0)
#define CLASS_3_601484553AD71CED_METHOD_3_7F22A781A9156478_OFFSET UNITYSDK_OFFSET(0x1840C540)
#define CLASS_3_601484553AD71CED__CTOR_OFFSET UNITYSDK_OFFSET(0x1840C510)

inline static constexpr unsigned int Class_3_601484553AD71CED_TypeDefinitionIndex = 23182;

class Class_3_601484553AD71CED : public ::RPG::GameCore::TaskConfig
{
public:
	::RPG::GameCore::DynamicFloat* Field_3_2; // 0x18
	::RPG::GameCore::RtDefenceGlobalPropertyType Field_3_0; // 0x20
