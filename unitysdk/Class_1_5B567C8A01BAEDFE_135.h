...
#define CLASS_1_5B567C8A01BAEDFE_135_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1D0A5C90)
#define CLASS_1_5B567C8A01BAEDFE_135_CLONE_OFFSET UNITYSDK_OFFSET(0x1D0A5980)
#define CLASS_1_5B567C8A01BAEDFE_135_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1D0A5A90)
#define CLASS_1_5B567C8A01BAEDFE_135_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D0A59C0)
#define CLASS_1_5B567C8A01BAEDFE_135_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D0A5BF0)
#define CLASS_1_5B567C8A01BAEDFE_135_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1D0A5CE0)
#define CLASS_1_5B567C8A01BAEDFE_135_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1D0A5CB0)
#define CLASS_1_5B567C8A01BAEDFE_135_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1D0A5900)
#define CLASS_1_5B567C8A01BAEDFE_135_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1D0A5930)
#define CLASS_1_5B567C8A01BAEDFE_135_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D0A5C20)
#define CLASS_1_5B567C8A01BAEDFE_135_WRITETO_OFFSET UNITYSDK_OFFSET(0x1D0A5C80)
#define CLASS_1_5B567C8A01BAEDFE_135__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D0A5D30)
#define CLASS_1_5B567C8A01BAEDFE_135__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D0A5950)
#define CLASS_1_5B567C8A01BAEDFE_135__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0A5940)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_135_TypeDefinitionIndex = 27793;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_135*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_135_TypeDefinitionIndex)->GetStaticField(0x3F2D0);
	}
