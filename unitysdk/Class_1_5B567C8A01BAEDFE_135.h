...
#define CLASS_1_5B567C8A01BAEDFE_135_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A5FECC0)
#define CLASS_1_5B567C8A01BAEDFE_135_CLONE_OFFSET UNITYSDK_OFFSET(0x1A5FEB30)
#define CLASS_1_5B567C8A01BAEDFE_135_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A5FEBD0)
#define CLASS_1_5B567C8A01BAEDFE_135_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A5FEB70)
#define CLASS_1_5B567C8A01BAEDFE_135_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A5FEC20)
#define CLASS_1_5B567C8A01BAEDFE_135_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A5FED10)
#define CLASS_1_5B567C8A01BAEDFE_135_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A5FECE0)
#define CLASS_1_5B567C8A01BAEDFE_135_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A5FEAB0)
#define CLASS_1_5B567C8A01BAEDFE_135_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A5FEAE0)
#define CLASS_1_5B567C8A01BAEDFE_135_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A5FEC50)
#define CLASS_1_5B567C8A01BAEDFE_135_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A5FECB0)
#define CLASS_1_5B567C8A01BAEDFE_135__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A5FED60)
#define CLASS_1_5B567C8A01BAEDFE_135__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5FEB00)
#define CLASS_1_5B567C8A01BAEDFE_135__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5FEAF0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_135_TypeDefinitionIndex = 27271;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_135*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_135_TypeDefinitionIndex)->GetStaticField(0x23000);
	}
