...
#define STRUCT_2_E5666136A508B56A__CCTOR_OFFSET UNITYSDK_OFFSET(0x133E42F0)

inline static constexpr unsigned int Struct_2_E5666136A508B56A_TypeDefinitionIndex = 73833;

struct alignas(8) Struct_2_E5666136A508B56A
{
	static ::System::String** StaticGet_Field_2_4()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Struct_2_E5666136A508B56A_TypeDefinitionIndex)->GetStaticField(0x40DC0);
	}
	::System::String* Field_2_3; // 0x10
	::System::String* Field_2_2; // 0x18
	::System::Boolean Field_2_1; // 0x20
	::System::Int32 Field_2_0; // 0x24
	::MoleMole::Config::ConfigPosRot* Field_2_7; // 0x28
