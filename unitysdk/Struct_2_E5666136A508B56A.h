...
#define STRUCT_2_E5666136A508B56A__CCTOR_OFFSET UNITYSDK_OFFSET(0x1335AE70)

inline static constexpr unsigned int Struct_2_E5666136A508B56A_TypeDefinitionIndex = 61579;

struct alignas(8) Struct_2_E5666136A508B56A
{
	static ::System::String** StaticGet_Field_2_7()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Struct_2_E5666136A508B56A_TypeDefinitionIndex)->GetStaticField(0x409E0);
	}
