...
#define STAGEHARMONYCOLORDEMODULATOR_METHOD_3_ABDB3ADBC66AC39E_OFFSET UNITYSDK_OFFSET(0xABDB4F0)
#define STAGEHARMONYCOLORDEMODULATOR_METHOD_3_F4B1CC0F7E08D926_OFFSET UNITYSDK_OFFSET(0xABDB590)
#define STAGEHARMONYCOLORDEMODULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xABDB5E0)

inline static constexpr unsigned int StageHarmonyColorDemodulator_TypeDefinitionIndex = 38386;
