...
#define STAGEHARMONYCOLORDEMODULATOR_METHOD_3_ABDB3ADBC66AC39E_OFFSET UNITYSDK_OFFSET(0x14EC7D70)
#define STAGEHARMONYCOLORDEMODULATOR_METHOD_3_F4B1CC0F7E08D926_OFFSET UNITYSDK_OFFSET(0x14EC7E10)
#define STAGEHARMONYCOLORDEMODULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x14EC7E60)

inline static constexpr unsigned int StageHarmonyColorDemodulator_TypeDefinitionIndex = 45733;
