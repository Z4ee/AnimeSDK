...
#define STAGEHARMONYCOLORDEMODULATOR_METHOD_3_ABDB3ADBC66AC39E_OFFSET UNITYSDK_OFFSET(0xE937C70)
#define STAGEHARMONYCOLORDEMODULATOR_METHOD_3_F4B1CC0F7E08D926_OFFSET UNITYSDK_OFFSET(0xE937D10)
#define STAGEHARMONYCOLORDEMODULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xE937D60)
