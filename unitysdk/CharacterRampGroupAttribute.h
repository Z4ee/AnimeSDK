...
#define CHARACTERRAMPGROUPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2EB7D0)

inline static constexpr unsigned int CharacterRampGroupAttribute_TypeDefinitionIndex = 27255;
