...
#define CLASS_1_E6C27BAF7E68B7B7_METHOD_1_002015B66398AA99_OFFSET UNITYSDK_OFFSET(0x179C10D0)
#define CLASS_1_E6C27BAF7E68B7B7_METHOD_1_1EED54C5EC4AF1D0_OFFSET UNITYSDK_OFFSET(0x179C0880)
#define CLASS_1_E6C27BAF7E68B7B7_METHOD_1_351509A1D07D4E11_OFFSET UNITYSDK_OFFSET(0x179C15E0)
#define CLASS_1_E6C27BAF7E68B7B7_METHOD_1_3521612C2671AF9D_OFFSET UNITYSDK_OFFSET(0x179C0BD0)
#define CLASS_1_E6C27BAF7E68B7B7_METHOD_1_3C70DB49DA52A2EA_OFFSET UNITYSDK_OFFSET(0x179C1A40)
#define CLASS_1_E6C27BAF7E68B7B7_METHOD_1_81ABC11F4E05E2C0_OFFSET UNITYSDK_OFFSET(0x179C0D00)
#define CLASS_1_E6C27BAF7E68B7B7__CCTOR_OFFSET UNITYSDK_OFFSET(0x179C1FB0)

inline static constexpr unsigned int Class_1_E6C27BAF7E68B7B7_TypeDefinitionIndex = 54968;

class Class_1_E6C27BAF7E68B7B7 : public ::System::Object
{
public:
	static ::Il2CppArray<::UnityEngine::Collider*>** StaticGet_LOBGBIGJEEM()
	{
		return (::Il2CppArray<::UnityEngine::Collider*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E6C27BAF7E68B7B7_TypeDefinitionIndex)->GetStaticField(0x66CF0);
	}
