...
#define CLASS_1_3E9A0EFA0AAE76DD_GET_BELONGID_OFFSET UNITYSDK_OFFSET(0x18463DA0)
#define CLASS_1_3E9A0EFA0AAE76DD_GET_CASTERID_OFFSET UNITYSDK_OFFSET(0x18463DC0)
#define CLASS_1_3E9A0EFA0AAE76DD_GET_ISENABLE_OFFSET UNITYSDK_OFFSET(0x18463D60)
#define CLASS_1_3E9A0EFA0AAE76DD_GET_ISWHITELISTENABLE_OFFSET UNITYSDK_OFFSET(0x18463D80)
#define CLASS_1_3E9A0EFA0AAE76DD_GET_MODIFIERNAME_OFFSET UNITYSDK_OFFSET(0x18463D40)
#define CLASS_1_3E9A0EFA0AAE76DD_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x18463E20)
#define CLASS_1_3E9A0EFA0AAE76DD_GET_SPECIALMARKPARAMLIST_OFFSET UNITYSDK_OFFSET(0x18463E60)
#define CLASS_1_3E9A0EFA0AAE76DD_GET_UIEFFECTPATH_OFFSET UNITYSDK_OFFSET(0x18463DE0)
#define CLASS_1_3E9A0EFA0AAE76DD_GET_UIINDEX_OFFSET UNITYSDK_OFFSET(0x18463E40)
#define CLASS_1_3E9A0EFA0AAE76DD_GET_UIMINIEFFECTPATH_OFFSET UNITYSDK_OFFSET(0x18463E00)
#define CLASS_1_3E9A0EFA0AAE76DD_SET_BELONGID_OFFSET UNITYSDK_OFFSET(0x18463DB0)
#define CLASS_1_3E9A0EFA0AAE76DD_SET_CASTERID_OFFSET UNITYSDK_OFFSET(0x18463DD0)
#define CLASS_1_3E9A0EFA0AAE76DD_SET_ISENABLE_OFFSET UNITYSDK_OFFSET(0x18463D70)
#define CLASS_1_3E9A0EFA0AAE76DD_SET_ISWHITELISTENABLE_OFFSET UNITYSDK_OFFSET(0x18463D90)
#define CLASS_1_3E9A0EFA0AAE76DD_SET_MODIFIERNAME_OFFSET UNITYSDK_OFFSET(0x18463D50)
#define CLASS_1_3E9A0EFA0AAE76DD_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x18463E30)
#define CLASS_1_3E9A0EFA0AAE76DD_SET_SPECIALMARKPARAMLIST_OFFSET UNITYSDK_OFFSET(0x18463E70)
#define CLASS_1_3E9A0EFA0AAE76DD_SET_UIEFFECTPATH_OFFSET UNITYSDK_OFFSET(0x18463DF0)
#define CLASS_1_3E9A0EFA0AAE76DD_SET_UIINDEX_OFFSET UNITYSDK_OFFSET(0x18463E50)
#define CLASS_1_3E9A0EFA0AAE76DD_SET_UIMINIEFFECTPATH_OFFSET UNITYSDK_OFFSET(0x18463E10)
#define CLASS_1_3E9A0EFA0AAE76DD__CTOR_OFFSET UNITYSDK_OFFSET(0x18463E80)

inline static constexpr unsigned int Class_1_3E9A0EFA0AAE76DD_TypeDefinitionIndex = 76053;
...
public:
	...
	::System::Boolean _IsWhiteListEnable_k__BackingField; // 0x34
	::System::Boolean _IsEnable_k__BackingField; // 0x35
	::System::UInt32 _CasterID_k__BackingField; // 0x38
	::System::Int32 _UIIndex_k__BackingField; // 0x3C
