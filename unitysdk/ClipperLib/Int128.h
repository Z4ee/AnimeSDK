...
#define CLIPPERLIB_INT128_EQUALS_OFFSET UNITYSDK_OFFSET(0x924500)
#define CLIPPERLIB_INT128_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x924560)
#define CLIPPERLIB_INT128_INT128MUL_OFFSET UNITYSDK_OFFSET(0x1AB6C430)
#define CLIPPERLIB_INT128_ISNEGATIVE_OFFSET UNITYSDK_OFFSET(0x578080)
#define CLIPPERLIB_INT128_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1AB709E0)
#define CLIPPERLIB_INT128_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AB6C4C0)
#define CLIPPERLIB_INT128_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1AB70A90)
#define CLIPPERLIB_INT128_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1AB709A0)
#define CLIPPERLIB_INT128_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1AB70890)
#define CLIPPERLIB_INT128_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1AB709C0)
#define CLIPPERLIB_INT128_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1AB70A20)
#define CLIPPERLIB_INT128_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1AB70A60)
#define CLIPPERLIB_INT128__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9244F0)
#define CLIPPERLIB_INT128__CTOR_2_OFFSET UNITYSDK_OFFSET(0x2E1100)
#define CLIPPERLIB_INT128__CTOR_OFFSET UNITYSDK_OFFSET(0x9244E0)

namespace ClipperLib
{
	inline static constexpr unsigned int Int128_TypeDefinitionIndex = 31219;
