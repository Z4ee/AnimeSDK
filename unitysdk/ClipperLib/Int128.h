...
#define CLIPPERLIB_INT128_EQUALS_OFFSET UNITYSDK_OFFSET(0x9CA580)
#define CLIPPERLIB_INT128_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9CA5E0)
#define CLIPPERLIB_INT128_INT128MUL_OFFSET UNITYSDK_OFFSET(0x1CFF73B0)
#define CLIPPERLIB_INT128_ISNEGATIVE_OFFSET UNITYSDK_OFFSET(0x5C90F0)
#define CLIPPERLIB_INT128_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1CFFBA00)
#define CLIPPERLIB_INT128_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1CFF7440)
#define CLIPPERLIB_INT128_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1CFFBAB0)
#define CLIPPERLIB_INT128_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1CFFB9C0)
#define CLIPPERLIB_INT128_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1CFFB8B0)
#define CLIPPERLIB_INT128_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1CFFB9E0)
#define CLIPPERLIB_INT128_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1CFFBA40)
#define CLIPPERLIB_INT128_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1CFFBA80)
#define CLIPPERLIB_INT128__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9CA570)
#define CLIPPERLIB_INT128__CTOR_2_OFFSET UNITYSDK_OFFSET(0x2AD810)
#define CLIPPERLIB_INT128__CTOR_OFFSET UNITYSDK_OFFSET(0x9CA560)

namespace ClipperLib
{
	inline static constexpr unsigned int Int128_TypeDefinitionIndex = 32770;
