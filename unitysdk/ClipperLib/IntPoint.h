...
#define CLIPPERLIB_INTPOINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x9CA620)
#define CLIPPERLIB_INTPOINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9CA680)
#define CLIPPERLIB_INTPOINT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1CFEE680)
#define CLIPPERLIB_INTPOINT_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1CFEEC10)
#define CLIPPERLIB_INTPOINT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9CA600)
#define CLIPPERLIB_INTPOINT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x2AD810)
#define CLIPPERLIB_INTPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x2BDE80)

namespace ClipperLib
{
	inline static constexpr unsigned int IntPoint_TypeDefinitionIndex = 32771;
