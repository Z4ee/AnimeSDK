...
#define CLIPPERLIB_INTPOINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x9245A0)
#define CLIPPERLIB_INTPOINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x924600)
#define CLIPPERLIB_INTPOINT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AB637B0)
#define CLIPPERLIB_INTPOINT_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1AB63D40)
#define CLIPPERLIB_INTPOINT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x924580)
#define CLIPPERLIB_INTPOINT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x2E1100)
#define CLIPPERLIB_INTPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x2FED90)

namespace ClipperLib
{
	inline static constexpr unsigned int IntPoint_TypeDefinitionIndex = 31220;
