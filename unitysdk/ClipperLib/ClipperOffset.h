...
#define CLIPPERLIB_CLIPPEROFFSET_ADDPATHS_OFFSET UNITYSDK_OFFSET(0x1AB6D9E0)
#define CLIPPERLIB_CLIPPEROFFSET_ADDPATH_OFFSET UNITYSDK_OFFSET(0x1AB6D530)
#define CLIPPERLIB_CLIPPEROFFSET_CLEAR_OFFSET UNITYSDK_OFFSET(0x1AB6D4B0)
#define CLIPPERLIB_CLIPPEROFFSET_DOMITER_OFFSET UNITYSDK_OFFSET(0x1AB706E0)
#define CLIPPERLIB_CLIPPEROFFSET_DOOFFSET_OFFSET UNITYSDK_OFFSET(0x1AB6DFA0)
#define CLIPPERLIB_CLIPPEROFFSET_DOROUND_OFFSET UNITYSDK_OFFSET(0x1AB6FAE0)
#define CLIPPERLIB_CLIPPEROFFSET_DOSQUARE_OFFSET UNITYSDK_OFFSET(0x1AB6F810)
#define CLIPPERLIB_CLIPPEROFFSET_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0x1AB700F0)
#define CLIPPERLIB_CLIPPEROFFSET_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1AB6FDE0)
#define CLIPPERLIB_CLIPPEROFFSET_FIXORIENTATIONS_OFFSET UNITYSDK_OFFSET(0x1AB6DAF0)
#define CLIPPERLIB_CLIPPEROFFSET_GETUNITNORMAL_OFFSET UNITYSDK_OFFSET(0x1AB6DEE0)
#define CLIPPERLIB_CLIPPEROFFSET_GET_ARCTOLERANCE_OFFSET UNITYSDK_OFFSET(0x1AB6D310)
#define CLIPPERLIB_CLIPPEROFFSET_GET_MITERLIMIT_OFFSET UNITYSDK_OFFSET(0x1AB6D330)
#define CLIPPERLIB_CLIPPEROFFSET_OFFSETPOINT_OFFSET UNITYSDK_OFFSET(0x1AB6F3E0)
#define CLIPPERLIB_CLIPPEROFFSET_ROUND_OFFSET UNITYSDK_OFFSET(0x1AB6D510)
#define CLIPPERLIB_CLIPPEROFFSET_SET_ARCTOLERANCE_OFFSET UNITYSDK_OFFSET(0x1AB6D320)
#define CLIPPERLIB_CLIPPEROFFSET_SET_MITERLIMIT_OFFSET UNITYSDK_OFFSET(0x1AB6D340)
#define CLIPPERLIB_CLIPPEROFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB6D350)

namespace ClipperLib
{
	inline static constexpr unsigned int ClipperOffset_TypeDefinitionIndex = 31241;
	...
	public:
		...
		::ClipperLib::PolyNode* m_polyNodes; // 0x20
		::System::Collections::Generic::List_1<::ClipperLib::IntPoint>* m_destPoly; // 0x28
		::System::Collections::Generic::List_1<::ClipperLib::DoublePoint>* m_normals; // 0x30
		::System::Double m_StepsPerRad; // 0x38
		::System::Double m_miterLim; // 0x40
		::ClipperLib::IntPoint m_lowest; // 0x48
		::System::Double _ArcTolerance_k__BackingField; // 0x58
		::System::Double _MiterLimit_k__BackingField; // 0x60
		::System::Double m_sinA; // 0x68
		::System::Double m_sin; // 0x70
		::System::Double m_delta; // 0x78
		::System::Double m_cos; // 0x80
