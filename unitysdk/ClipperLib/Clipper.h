...
#define CLIPPERLIB_CLIPPER_ADDEDGETOSEL_OFFSET UNITYSDK_OFFSET(0x1CFED510)
#define CLIPPERLIB_CLIPPER_ADDGHOSTJOIN_OFFSET UNITYSDK_OFFSET(0x1CFEC970)
#define CLIPPERLIB_CLIPPER_ADDJOIN_OFFSET UNITYSDK_OFFSET(0x1CFEC8D0)
#define CLIPPERLIB_CLIPPER_ADDLOCALMAXPOLY_OFFSET UNITYSDK_OFFSET(0x1CFEE0B0)
#define CLIPPERLIB_CLIPPER_ADDLOCALMINPOLY_OFFSET UNITYSDK_OFFSET(0x1CFED240)
#define CLIPPERLIB_CLIPPER_ADDOUTPT_OFFSET UNITYSDK_OFFSET(0x1CFECFA0)
#define CLIPPERLIB_CLIPPER_ADDPOLYNODETOPATHS_OFFSET UNITYSDK_OFFSET(0x1CFF6C80)
#define CLIPPERLIB_CLIPPER_APPENDPOLYGON_OFFSET UNITYSDK_OFFSET(0x1CFEE150)
#define CLIPPERLIB_CLIPPER_AREA_1_OFFSET UNITYSDK_OFFSET(0x1CFEB850)
#define CLIPPERLIB_CLIPPER_AREA_2_OFFSET UNITYSDK_OFFSET(0x1CFEEAB0)
#define CLIPPERLIB_CLIPPER_AREA_OFFSET UNITYSDK_OFFSET(0x1CFF1660)
#define CLIPPERLIB_CLIPPER_BUILDINTERSECTLIST_OFFSET UNITYSDK_OFFSET(0x1CFF0470)
#define CLIPPERLIB_CLIPPER_BUILDRESULT2_OFFSET UNITYSDK_OFFSET(0x1CFE9FB0)
#define CLIPPERLIB_CLIPPER_BUILDRESULT_OFFSET UNITYSDK_OFFSET(0x1CFE9BC0)
#define CLIPPERLIB_CLIPPER_CLEANPOLYGONS_OFFSET UNITYSDK_OFFSET(0x1CFF5290)
#define CLIPPERLIB_CLIPPER_CLEANPOLYGON_OFFSET UNITYSDK_OFFSET(0x1CFF4D40)
#define CLIPPERLIB_CLIPPER_CLOSEDPATHSFROMPOLYTREE_OFFSET UNITYSDK_OFFSET(0x1CFF6F70)
#define CLIPPERLIB_CLIPPER_COPYAELTOSEL_OFFSET UNITYSDK_OFFSET(0x1CFEDF50)
#define CLIPPERLIB_CLIPPER_DELETEFROMSEL_OFFSET UNITYSDK_OFFSET(0x1CFEEE20)
#define CLIPPERLIB_CLIPPER_DISPOSEALLPOLYPTS_OFFSET UNITYSDK_OFFSET(0x1CFE9F40)
#define CLIPPERLIB_CLIPPER_DISTANCEFROMLINESQRD_OFFSET UNITYSDK_OFFSET(0x1CFF4A50)
#define CLIPPERLIB_CLIPPER_DISTANCESQRD_OFFSET UNITYSDK_OFFSET(0x1CFF49F0)
#define CLIPPERLIB_CLIPPER_DOMAXIMA_OFFSET UNITYSDK_OFFSET(0x1CFF0F90)
#define CLIPPERLIB_CLIPPER_DOSIMPLEPOLYGONS_OFFSET UNITYSDK_OFFSET(0x1CFEC200)
#define CLIPPERLIB_CLIPPER_DUPOUTPT_OFFSET UNITYSDK_OFFSET(0x1CFF1B50)
#define CLIPPERLIB_CLIPPER_E2INSERTSBEFOREE1_OFFSET UNITYSDK_OFFSET(0x1CFEDD70)
#define CLIPPERLIB_CLIPPER_EDGESADJACENT_OFFSET UNITYSDK_OFFSET(0x1CFF0F00)
#define CLIPPERLIB_CLIPPER_EXCLUDEOP_OFFSET UNITYSDK_OFFSET(0x1CFF4CF0)
#define CLIPPERLIB_CLIPPER_EXECUTEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1CFE9560)
#define CLIPPERLIB_CLIPPER_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0x1CFE9350)
#define CLIPPERLIB_CLIPPER_EXECUTE_2_OFFSET UNITYSDK_OFFSET(0x1CFE9150)
#define CLIPPERLIB_CLIPPER_EXECUTE_3_OFFSET UNITYSDK_OFFSET(0x1CFE9370)
#define CLIPPERLIB_CLIPPER_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1CFE9130)
#define CLIPPERLIB_CLIPPER_FIRSTISBOTTOMPT_OFFSET UNITYSDK_OFFSET(0x1CFEE7A0)
#define CLIPPERLIB_CLIPPER_FIXHOLELINKAGE_OFFSET UNITYSDK_OFFSET(0x1CFEA5A0)
#define CLIPPERLIB_CLIPPER_FIXUPFIRSTLEFTS1_OFFSET UNITYSDK_OFFSET(0x1CFF3030)
#define CLIPPERLIB_CLIPPER_FIXUPFIRSTLEFTS2_OFFSET UNITYSDK_OFFSET(0x1CFF33B0)
#define CLIPPERLIB_CLIPPER_FIXUPFIRSTLEFTS3_OFFSET UNITYSDK_OFFSET(0x1CFF38D0)
#define CLIPPERLIB_CLIPPER_FIXUPINTERSECTIONORDER_OFFSET UNITYSDK_OFFSET(0x1CFF07B0)
#define CLIPPERLIB_CLIPPER_FIXUPOUTPOLYGON_OFFSET UNITYSDK_OFFSET(0x1CFEBFC0)
#define CLIPPERLIB_CLIPPER_FIXUPOUTPOLYLINE_OFFSET UNITYSDK_OFFSET(0x1CFEBF20)
#define CLIPPERLIB_CLIPPER_GETBOTTOMPT_OFFSET UNITYSDK_OFFSET(0x1CFEEB20)
#define CLIPPERLIB_CLIPPER_GETDX_OFFSET UNITYSDK_OFFSET(0x1CFEE770)
#define CLIPPERLIB_CLIPPER_GETHORZDIRECTION_OFFSET UNITYSDK_OFFSET(0x1CFEFD40)
#define CLIPPERLIB_CLIPPER_GETLASTOUTPT_OFFSET UNITYSDK_OFFSET(0x1CFEE6A0)
#define CLIPPERLIB_CLIPPER_GETLOWERMOSTREC_OFFSET UNITYSDK_OFFSET(0x1CFEEC30)
#define CLIPPERLIB_CLIPPER_GETMAXIMAPAIREX_OFFSET UNITYSDK_OFFSET(0x1CFF03C0)
#define CLIPPERLIB_CLIPPER_GETMAXIMAPAIR_OFFSET UNITYSDK_OFFSET(0x1CFEFDA0)
#define CLIPPERLIB_CLIPPER_GETNEXTINAEL_OFFSET UNITYSDK_OFFSET(0x1CFEFE20)
#define CLIPPERLIB_CLIPPER_GETOUTREC_OFFSET UNITYSDK_OFFSET(0x1CFEED20)
#define CLIPPERLIB_CLIPPER_GETOVERLAP_OFFSET UNITYSDK_OFFSET(0x1CFF1C20)
#define CLIPPERLIB_CLIPPER_GET_REVERSESOLUTION_OFFSET UNITYSDK_OFFSET(0x1CFE90F0)
#define CLIPPERLIB_CLIPPER_GET_STRICTLYSIMPLE_OFFSET UNITYSDK_OFFSET(0x1CFE9110)
#define CLIPPERLIB_CLIPPER_HORZSEGMENTSOVERLAP_OFFSET UNITYSDK_OFFSET(0x1CFED570)
#define CLIPPERLIB_CLIPPER_INSERTEDGEINTOAEL_OFFSET UNITYSDK_OFFSET(0x1CFECA00)
#define CLIPPERLIB_CLIPPER_INSERTLOCALMINIMAINTOAEL_OFFSET UNITYSDK_OFFSET(0x1CFEA6B0)
#define CLIPPERLIB_CLIPPER_INSERTMAXIMA_OFFSET UNITYSDK_OFFSET(0x1CFE9000)
#define CLIPPERLIB_CLIPPER_INTERSECTEDGES_OFFSET UNITYSDK_OFFSET(0x1CFED760)
#define CLIPPERLIB_CLIPPER_INTERSECTNODESORT_OFFSET UNITYSDK_OFFSET(0x1CFF0F40)
#define CLIPPERLIB_CLIPPER_INTERSECTPOINT_OFFSET UNITYSDK_OFFSET(0x1CFF0B20)
#define CLIPPERLIB_CLIPPER_ISCONTRIBUTING_OFFSET UNITYSDK_OFFSET(0x1CFECE80)
#define CLIPPERLIB_CLIPPER_ISEVENODDALTFILLTYPE_OFFSET UNITYSDK_OFFSET(0x1CFEDEE0)
#define CLIPPERLIB_CLIPPER_ISEVENODDFILLTYPE_OFFSET UNITYSDK_OFFSET(0x1CFEDEB0)
#define CLIPPERLIB_CLIPPER_ISINTERMEDIATE_OFFSET UNITYSDK_OFFSET(0x1CFF0380)
#define CLIPPERLIB_CLIPPER_ISMAXIMA_OFFSET UNITYSDK_OFFSET(0x1CFF0350)
#define CLIPPERLIB_CLIPPER_ISMINIMA_OFFSET UNITYSDK_OFFSET(0x1CFF0310)
#define CLIPPERLIB_CLIPPER_JOINCOMMONEDGES_OFFSET UNITYSDK_OFFSET(0x1CFEB910)
#define CLIPPERLIB_CLIPPER_JOINHORZ_OFFSET UNITYSDK_OFFSET(0x1CFF1CB0)
#define CLIPPERLIB_CLIPPER_JOINPOINTS_OFFSET UNITYSDK_OFFSET(0x1CFF2600)
#define CLIPPERLIB_CLIPPER_MINKOWSKIDIFF_OFFSET UNITYSDK_OFFSET(0x1CFF69A0)
#define CLIPPERLIB_CLIPPER_MINKOWSKISUM_1_OFFSET UNITYSDK_OFFSET(0x1CFF6610)
#define CLIPPERLIB_CLIPPER_MINKOWSKISUM_OFFSET UNITYSDK_OFFSET(0x1CFF63A0)
#define CLIPPERLIB_CLIPPER_MINKOWSKI_OFFSET UNITYSDK_OFFSET(0x1CFF5370)
#define CLIPPERLIB_CLIPPER_OPENPATHSFROMPOLYTREE_OFFSET UNITYSDK_OFFSET(0x1CFF6E10)
#define CLIPPERLIB_CLIPPER_ORIENTATION_OFFSET UNITYSDK_OFFSET(0x1CFF15B0)
#define CLIPPERLIB_CLIPPER_OUTREC1RIGHTOFOUTREC2_OFFSET UNITYSDK_OFFSET(0x1CFEECE0)
#define CLIPPERLIB_CLIPPER_PARSEFIRSTLEFT_OFFSET UNITYSDK_OFFSET(0x1CFF3380)
#define CLIPPERLIB_CLIPPER_POINTCOUNT_OFFSET UNITYSDK_OFFSET(0x1CFF1710)
#define CLIPPERLIB_CLIPPER_POINTINPOLYGON_1_OFFSET UNITYSDK_OFFSET(0x1CFF2E90)
#define CLIPPERLIB_CLIPPER_POINTINPOLYGON_OFFSET UNITYSDK_OFFSET(0x1CFF2D00)
#define CLIPPERLIB_CLIPPER_POINTSARECLOSE_OFFSET UNITYSDK_OFFSET(0x1CFF4C90)
#define CLIPPERLIB_CLIPPER_POLY2CONTAINSPOLY1_OFFSET UNITYSDK_OFFSET(0x1CFF2FD0)
#define CLIPPERLIB_CLIPPER_POLYTREETOPATHS_OFFSET UNITYSDK_OFFSET(0x1CFF6AB0)
#define CLIPPERLIB_CLIPPER_POPEDGEFROMSEL_OFFSET UNITYSDK_OFFSET(0x1CFEDF10)
#define CLIPPERLIB_CLIPPER_PROCESSEDGESATTOPOFSCANBEAM_OFFSET UNITYSDK_OFFSET(0x1CFEAFE0)
#define CLIPPERLIB_CLIPPER_PROCESSHORIZONTALS_OFFSET UNITYSDK_OFFSET(0x1CFEAE50)
#define CLIPPERLIB_CLIPPER_PROCESSHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1CFEEE80)
#define CLIPPERLIB_CLIPPER_PROCESSINTERSECTIONS_OFFSET UNITYSDK_OFFSET(0x1CFEAEB0)
#define CLIPPERLIB_CLIPPER_PROCESSINTERSECTLIST_OFFSET UNITYSDK_OFFSET(0x1CFF0A40)
#define CLIPPERLIB_CLIPPER_REVERSEPATHS_OFFSET UNITYSDK_OFFSET(0x1CFF1480)
#define CLIPPERLIB_CLIPPER_REVERSEPOLYPTLINKS_OFFSET UNITYSDK_OFFSET(0x1CFEB8D0)
#define CLIPPERLIB_CLIPPER_ROUND_OFFSET UNITYSDK_OFFSET(0x1CFF0F70)
#define CLIPPERLIB_CLIPPER_SETHOLESTATE_OFFSET UNITYSDK_OFFSET(0x1CFEE580)
#define CLIPPERLIB_CLIPPER_SETWINDINGCOUNT_OFFSET UNITYSDK_OFFSET(0x1CFECC80)
#define CLIPPERLIB_CLIPPER_SET_REVERSESOLUTION_OFFSET UNITYSDK_OFFSET(0x1CFE9100)
#define CLIPPERLIB_CLIPPER_SET_STRICTLYSIMPLE_OFFSET UNITYSDK_OFFSET(0x1CFE9120)
#define CLIPPERLIB_CLIPPER_SIMPLIFYPOLYGONS_OFFSET UNITYSDK_OFFSET(0x1CFF47E0)
#define CLIPPERLIB_CLIPPER_SIMPLIFYPOLYGON_OFFSET UNITYSDK_OFFSET(0x1CFF3A70)
#define CLIPPERLIB_CLIPPER_SLOPESNEARCOLLINEAR_OFFSET UNITYSDK_OFFSET(0x1CFF4AC0)
#define CLIPPERLIB_CLIPPER_SWAPPOINTS_OFFSET UNITYSDK_OFFSET(0x1CFEE740)
#define CLIPPERLIB_CLIPPER_SWAPPOLYINDEXES_OFFSET UNITYSDK_OFFSET(0x1CFEEDF0)
#define CLIPPERLIB_CLIPPER_SWAPPOSITIONSINSEL_OFFSET UNITYSDK_OFFSET(0x1CFEDF80)
#define CLIPPERLIB_CLIPPER_SWAPSIDES_OFFSET UNITYSDK_OFFSET(0x1CFEEDB0)
#define CLIPPERLIB_CLIPPER_TOPX_OFFSET UNITYSDK_OFFSET(0x1CFEDE50)
#define CLIPPERLIB_CLIPPER_TRANSLATEPATH_OFFSET UNITYSDK_OFFSET(0x1CFF64C0)
#define CLIPPERLIB_CLIPPER_UPDATEOUTPTIDXS_OFFSET UNITYSDK_OFFSET(0x1CFF3A30)
#define CLIPPERLIB_CLIPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFE8CF0)

namespace ClipperLib
{
	inline static constexpr unsigned int Clipper_TypeDefinitionIndex = 32790;
	...
	public:
		...
		::System::Collections::Generic::List_1<::ClipperLib::IntersectNode*>* m_IntersectList; // 0x48
		::ClipperLib::Maxima* m_Maxima; // 0x50
		::System::Collections::Generic::List_1<::ClipperLib::Join*>* m_Joins; // 0x58
		::System::Collections::Generic::List_1<::ClipperLib::Join*>* m_GhostJoins; // 0x60
		::System::Collections::Generic::IComparer_1<::ClipperLib::IntersectNode*>* m_IntersectNodeComparer; // 0x68
		::ClipperLib::TEdge* m_SortedEdges; // 0x70
		::ClipperLib::ClipType m_ClipType; // 0x78
		::ClipperLib::PolyFillType m_ClipFillType; // 0x7C
		::ClipperLib::PolyFillType m_SubjFillType; // 0x80
		::System::Boolean m_UsingPolyTree; // 0x84
		::System::Boolean _ReverseSolution_k__BackingField; // 0x85
		::System::Boolean m_ExecuteLocked; // 0x86
		::System::Boolean _StrictlySimple_k__BackingField; // 0x87
