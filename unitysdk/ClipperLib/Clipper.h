...
#define CLIPPERLIB_CLIPPER_ADDEDGETOSEL_OFFSET UNITYSDK_OFFSET(0x1E3C99B0)
#define CLIPPERLIB_CLIPPER_ADDGHOSTJOIN_OFFSET UNITYSDK_OFFSET(0x1E3C8DD0)
#define CLIPPERLIB_CLIPPER_ADDJOIN_OFFSET UNITYSDK_OFFSET(0x1E3C8D30)
#define CLIPPERLIB_CLIPPER_ADDLOCALMAXPOLY_OFFSET UNITYSDK_OFFSET(0x1E3CA570)
#define CLIPPERLIB_CLIPPER_ADDLOCALMINPOLY_OFFSET UNITYSDK_OFFSET(0x1E3C96F0)
#define CLIPPERLIB_CLIPPER_ADDOUTPT_OFFSET UNITYSDK_OFFSET(0x1E3C9430)
#define CLIPPERLIB_CLIPPER_ADDPOLYNODETOPATHS_OFFSET UNITYSDK_OFFSET(0x1E3D3030)
#define CLIPPERLIB_CLIPPER_APPENDPOLYGON_OFFSET UNITYSDK_OFFSET(0x1E3CA620)
#define CLIPPERLIB_CLIPPER_AREA_1_OFFSET UNITYSDK_OFFSET(0x1E3C7D00)
#define CLIPPERLIB_CLIPPER_AREA_2_OFFSET UNITYSDK_OFFSET(0x1E3CAF90)
#define CLIPPERLIB_CLIPPER_AREA_OFFSET UNITYSDK_OFFSET(0x1E3CDA90)
#define CLIPPERLIB_CLIPPER_BUILDINTERSECTLIST_OFFSET UNITYSDK_OFFSET(0x1E3CC8C0)
#define CLIPPERLIB_CLIPPER_BUILDRESULT2_OFFSET UNITYSDK_OFFSET(0x1E3C64B0)
#define CLIPPERLIB_CLIPPER_BUILDRESULT_OFFSET UNITYSDK_OFFSET(0x1E3C60B0)
#define CLIPPERLIB_CLIPPER_CLEANPOLYGONS_OFFSET UNITYSDK_OFFSET(0x1E3D15D0)
#define CLIPPERLIB_CLIPPER_CLEANPOLYGON_OFFSET UNITYSDK_OFFSET(0x1E3D1070)
#define CLIPPERLIB_CLIPPER_CLOSEDPATHSFROMPOLYTREE_OFFSET UNITYSDK_OFFSET(0x1E3D3320)
#define CLIPPERLIB_CLIPPER_COPYAELTOSEL_OFFSET UNITYSDK_OFFSET(0x1E3CA410)
#define CLIPPERLIB_CLIPPER_DELETEFROMSEL_OFFSET UNITYSDK_OFFSET(0x1E3CB300)
#define CLIPPERLIB_CLIPPER_DISPOSEALLPOLYPTS_OFFSET UNITYSDK_OFFSET(0x1E3C6440)
#define CLIPPERLIB_CLIPPER_DISTANCEFROMLINESQRD_OFFSET UNITYSDK_OFFSET(0x1E3D0D80)
#define CLIPPERLIB_CLIPPER_DISTANCESQRD_OFFSET UNITYSDK_OFFSET(0x1E3D0D20)
#define CLIPPERLIB_CLIPPER_DOMAXIMA_OFFSET UNITYSDK_OFFSET(0x1E3CD390)
#define CLIPPERLIB_CLIPPER_DOSIMPLEPOLYGONS_OFFSET UNITYSDK_OFFSET(0x1E3C8690)
#define CLIPPERLIB_CLIPPER_DUPOUTPT_OFFSET UNITYSDK_OFFSET(0x1E3CDF80)
#define CLIPPERLIB_CLIPPER_E2INSERTSBEFOREE1_OFFSET UNITYSDK_OFFSET(0x1E3CA250)
#define CLIPPERLIB_CLIPPER_EDGESADJACENT_OFFSET UNITYSDK_OFFSET(0x1E3CD300)
#define CLIPPERLIB_CLIPPER_EXCLUDEOP_OFFSET UNITYSDK_OFFSET(0x1E3D1020)
#define CLIPPERLIB_CLIPPER_EXECUTEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1E3C5A30)
#define CLIPPERLIB_CLIPPER_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0x1E3C5840)
#define CLIPPERLIB_CLIPPER_EXECUTE_2_OFFSET UNITYSDK_OFFSET(0x1E3C5640)
#define CLIPPERLIB_CLIPPER_EXECUTE_3_OFFSET UNITYSDK_OFFSET(0x1E3C5860)
#define CLIPPERLIB_CLIPPER_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1E3C5620)
#define CLIPPERLIB_CLIPPER_FIRSTISBOTTOMPT_OFFSET UNITYSDK_OFFSET(0x1E3CAC90)
#define CLIPPERLIB_CLIPPER_FIXHOLELINKAGE_OFFSET UNITYSDK_OFFSET(0x1E3C6A80)
#define CLIPPERLIB_CLIPPER_FIXUPFIRSTLEFTS1_OFFSET UNITYSDK_OFFSET(0x1E3CF3B0)
#define CLIPPERLIB_CLIPPER_FIXUPFIRSTLEFTS2_OFFSET UNITYSDK_OFFSET(0x1E3CF700)
#define CLIPPERLIB_CLIPPER_FIXUPFIRSTLEFTS3_OFFSET UNITYSDK_OFFSET(0x1E3CFBF0)
#define CLIPPERLIB_CLIPPER_FIXUPINTERSECTIONORDER_OFFSET UNITYSDK_OFFSET(0x1E3CCBF0)
#define CLIPPERLIB_CLIPPER_FIXUPOUTPOLYGON_OFFSET UNITYSDK_OFFSET(0x1E3C8450)
#define CLIPPERLIB_CLIPPER_FIXUPOUTPOLYLINE_OFFSET UNITYSDK_OFFSET(0x1E3C83B0)
#define CLIPPERLIB_CLIPPER_GETBOTTOMPT_OFFSET UNITYSDK_OFFSET(0x1E3CB000)
#define CLIPPERLIB_CLIPPER_GETDX_OFFSET UNITYSDK_OFFSET(0x1E3CAC60)
#define CLIPPERLIB_CLIPPER_GETHORZDIRECTION_OFFSET UNITYSDK_OFFSET(0x1E3CC1B0)
#define CLIPPERLIB_CLIPPER_GETLASTOUTPT_OFFSET UNITYSDK_OFFSET(0x1E3CAB90)
#define CLIPPERLIB_CLIPPER_GETLOWERMOSTREC_OFFSET UNITYSDK_OFFSET(0x1E3CB110)
#define CLIPPERLIB_CLIPPER_GETMAXIMAPAIREX_OFFSET UNITYSDK_OFFSET(0x1E3CC820)
#define CLIPPERLIB_CLIPPER_GETMAXIMAPAIR_OFFSET UNITYSDK_OFFSET(0x1E3CC200)
#define CLIPPERLIB_CLIPPER_GETNEXTINAEL_OFFSET UNITYSDK_OFFSET(0x1E3CC270)
#define CLIPPERLIB_CLIPPER_GETOUTREC_OFFSET UNITYSDK_OFFSET(0x1E3CB200)
#define CLIPPERLIB_CLIPPER_GETOVERLAP_OFFSET UNITYSDK_OFFSET(0x1E3CE050)
#define CLIPPERLIB_CLIPPER_GET_REVERSESOLUTION_OFFSET UNITYSDK_OFFSET(0x1E3C55E0)
#define CLIPPERLIB_CLIPPER_GET_STRICTLYSIMPLE_OFFSET UNITYSDK_OFFSET(0x1E3C5600)
#define CLIPPERLIB_CLIPPER_HORZSEGMENTSOVERLAP_OFFSET UNITYSDK_OFFSET(0x1E3C9A00)
#define CLIPPERLIB_CLIPPER_INSERTEDGEINTOAEL_OFFSET UNITYSDK_OFFSET(0x1E3C8E60)
#define CLIPPERLIB_CLIPPER_INSERTLOCALMINIMAINTOAEL_OFFSET UNITYSDK_OFFSET(0x1E3C6BA0)
#define CLIPPERLIB_CLIPPER_INSERTMAXIMA_OFFSET UNITYSDK_OFFSET(0x1E3C54F0)
#define CLIPPERLIB_CLIPPER_INTERSECTEDGES_OFFSET UNITYSDK_OFFSET(0x1E3C9C00)
#define CLIPPERLIB_CLIPPER_INTERSECTNODESORT_OFFSET UNITYSDK_OFFSET(0x1E3CD340)
#define CLIPPERLIB_CLIPPER_INTERSECTPOINT_OFFSET UNITYSDK_OFFSET(0x1E3CCF60)
#define CLIPPERLIB_CLIPPER_ISCONTRIBUTING_OFFSET UNITYSDK_OFFSET(0x1E3C9300)
#define CLIPPERLIB_CLIPPER_ISEVENODDALTFILLTYPE_OFFSET UNITYSDK_OFFSET(0x1E3CA3B0)
#define CLIPPERLIB_CLIPPER_ISEVENODDFILLTYPE_OFFSET UNITYSDK_OFFSET(0x1E3CA380)
#define CLIPPERLIB_CLIPPER_ISINTERMEDIATE_OFFSET UNITYSDK_OFFSET(0x1E3CC7E0)
#define CLIPPERLIB_CLIPPER_ISMAXIMA_OFFSET UNITYSDK_OFFSET(0x1E3CC7C0)
#define CLIPPERLIB_CLIPPER_ISMINIMA_OFFSET UNITYSDK_OFFSET(0x1E3CC780)
#define CLIPPERLIB_CLIPPER_JOINCOMMONEDGES_OFFSET UNITYSDK_OFFSET(0x1E3C7DC0)
#define CLIPPERLIB_CLIPPER_JOINHORZ_OFFSET UNITYSDK_OFFSET(0x1E3CE0E0)
#define CLIPPERLIB_CLIPPER_JOINPOINTS_OFFSET UNITYSDK_OFFSET(0x1E3CE9E0)
#define CLIPPERLIB_CLIPPER_MINKOWSKIDIFF_OFFSET UNITYSDK_OFFSET(0x1E3D2D50)
#define CLIPPERLIB_CLIPPER_MINKOWSKISUM_1_OFFSET UNITYSDK_OFFSET(0x1E3D29C0)
#define CLIPPERLIB_CLIPPER_MINKOWSKISUM_OFFSET UNITYSDK_OFFSET(0x1E3D2750)
#define CLIPPERLIB_CLIPPER_MINKOWSKI_OFFSET UNITYSDK_OFFSET(0x1E3D16B0)
#define CLIPPERLIB_CLIPPER_OPENPATHSFROMPOLYTREE_OFFSET UNITYSDK_OFFSET(0x1E3D31C0)
#define CLIPPERLIB_CLIPPER_ORIENTATION_OFFSET UNITYSDK_OFFSET(0x1E3CD9E0)
#define CLIPPERLIB_CLIPPER_OUTREC1RIGHTOFOUTREC2_OFFSET UNITYSDK_OFFSET(0x1E3CB1C0)
#define CLIPPERLIB_CLIPPER_PARSEFIRSTLEFT_OFFSET UNITYSDK_OFFSET(0x1E3CF6D0)
#define CLIPPERLIB_CLIPPER_POINTCOUNT_OFFSET UNITYSDK_OFFSET(0x1E3CDB40)
#define CLIPPERLIB_CLIPPER_POINTINPOLYGON_1_OFFSET UNITYSDK_OFFSET(0x1E3CF210)
#define CLIPPERLIB_CLIPPER_POINTINPOLYGON_OFFSET UNITYSDK_OFFSET(0x1E3CF090)
#define CLIPPERLIB_CLIPPER_POINTSARECLOSE_OFFSET UNITYSDK_OFFSET(0x1E3D0FC0)
#define CLIPPERLIB_CLIPPER_POLY2CONTAINSPOLY1_OFFSET UNITYSDK_OFFSET(0x1E3CF350)
#define CLIPPERLIB_CLIPPER_POLYTREETOPATHS_OFFSET UNITYSDK_OFFSET(0x1E3D2E60)
#define CLIPPERLIB_CLIPPER_POPEDGEFROMSEL_OFFSET UNITYSDK_OFFSET(0x1E3CA3E0)
#define CLIPPERLIB_CLIPPER_PROCESSEDGESATTOPOFSCANBEAM_OFFSET UNITYSDK_OFFSET(0x1E3C7480)
#define CLIPPERLIB_CLIPPER_PROCESSHORIZONTALS_OFFSET UNITYSDK_OFFSET(0x1E3C72F0)
#define CLIPPERLIB_CLIPPER_PROCESSHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1E3CB360)
#define CLIPPERLIB_CLIPPER_PROCESSINTERSECTIONS_OFFSET UNITYSDK_OFFSET(0x1E3C7350)
#define CLIPPERLIB_CLIPPER_PROCESSINTERSECTLIST_OFFSET UNITYSDK_OFFSET(0x1E3CCE70)
#define CLIPPERLIB_CLIPPER_REVERSEPATHS_OFFSET UNITYSDK_OFFSET(0x1E3CD8B0)
#define CLIPPERLIB_CLIPPER_REVERSEPOLYPTLINKS_OFFSET UNITYSDK_OFFSET(0x1E3C7D80)
#define CLIPPERLIB_CLIPPER_ROUND_OFFSET UNITYSDK_OFFSET(0x1E3CD370)
#define CLIPPERLIB_CLIPPER_SETHOLESTATE_OFFSET UNITYSDK_OFFSET(0x1E3CAA60)
#define CLIPPERLIB_CLIPPER_SETWINDINGCOUNT_OFFSET UNITYSDK_OFFSET(0x1E3C90C0)
#define CLIPPERLIB_CLIPPER_SET_REVERSESOLUTION_OFFSET UNITYSDK_OFFSET(0x1E3C55F0)
#define CLIPPERLIB_CLIPPER_SET_STRICTLYSIMPLE_OFFSET UNITYSDK_OFFSET(0x1E3C5610)
#define CLIPPERLIB_CLIPPER_SIMPLIFYPOLYGONS_OFFSET UNITYSDK_OFFSET(0x1E3D0B10)
#define CLIPPERLIB_CLIPPER_SIMPLIFYPOLYGON_OFFSET UNITYSDK_OFFSET(0x1E3CFD90)
#define CLIPPERLIB_CLIPPER_SLOPESNEARCOLLINEAR_OFFSET UNITYSDK_OFFSET(0x1E3D0DF0)
#define CLIPPERLIB_CLIPPER_SWAPPOINTS_OFFSET UNITYSDK_OFFSET(0x1E3CAC30)
#define CLIPPERLIB_CLIPPER_SWAPPOLYINDEXES_OFFSET UNITYSDK_OFFSET(0x1E3CB2C0)
#define CLIPPERLIB_CLIPPER_SWAPPOSITIONSINSEL_OFFSET UNITYSDK_OFFSET(0x1E3CA440)
#define CLIPPERLIB_CLIPPER_SWAPSIDES_OFFSET UNITYSDK_OFFSET(0x1E3CB290)
#define CLIPPERLIB_CLIPPER_TOPX_OFFSET UNITYSDK_OFFSET(0x1E3CA320)
#define CLIPPERLIB_CLIPPER_TRANSLATEPATH_OFFSET UNITYSDK_OFFSET(0x1E3D2870)
#define CLIPPERLIB_CLIPPER_UPDATEOUTPTIDXS_OFFSET UNITYSDK_OFFSET(0x1E3CFD50)
#define CLIPPERLIB_CLIPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3C51E0)

namespace ClipperLib
{
	inline static constexpr unsigned int Clipper_TypeDefinitionIndex = 33425;
	...
	public:
		...
		::System::Collections::Generic::IComparer_1<::ClipperLib::IntersectNode*>* m_IntersectNodeComparer; // 0x48
		::System::Collections::Generic::List_1<::ClipperLib::Join*>* m_GhostJoins; // 0x50
		::ClipperLib::TEdge* m_SortedEdges; // 0x58
		::System::Collections::Generic::List_1<::ClipperLib::Join*>* m_Joins; // 0x60
		::ClipperLib::Maxima* m_Maxima; // 0x68
		::System::Collections::Generic::List_1<::ClipperLib::IntersectNode*>* m_IntersectList; // 0x70
		::ClipperLib::ClipType m_ClipType; // 0x78
		::System::Boolean m_ExecuteLocked; // 0x7C
		::System::Boolean _ReverseSolution_k__BackingField; // 0x7D
		::System::Boolean _StrictlySimple_k__BackingField; // 0x7E
		::System::Boolean m_UsingPolyTree; // 0x7F
