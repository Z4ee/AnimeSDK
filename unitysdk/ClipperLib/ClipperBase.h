...
#define CLIPPERLIB_CLIPPERBASE_ADDPATHS_OFFSET UNITYSDK_OFFSET(0x1AB699C0)
#define CLIPPERLIB_CLIPPERBASE_ADDPATH_OFFSET UNITYSDK_OFFSET(0x1AB68C00)
#define CLIPPERLIB_CLIPPERBASE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1AB6C5F0)
#define CLIPPERLIB_CLIPPERBASE_CREATEOUTREC_OFFSET UNITYSDK_OFFSET(0x1AB635E0)
#define CLIPPERLIB_CLIPPERBASE_DELETEFROMAEL_OFFSET UNITYSDK_OFFSET(0x1AB64F30)
#define CLIPPERLIB_CLIPPERBASE_DISPOSELOCALMINIMALIST_OFFSET UNITYSDK_OFFSET(0x1AB6C770)
#define CLIPPERLIB_CLIPPERBASE_DISPOSEOUTREC_OFFSET UNITYSDK_OFFSET(0x1AB61880)
#define CLIPPERLIB_CLIPPERBASE_FINDNEXTLOCMIN_OFFSET UNITYSDK_OFFSET(0x1AB6C9D0)
#define CLIPPERLIB_CLIPPERBASE_GETBOUNDS_OFFSET UNITYSDK_OFFSET(0x1AB6D110)
#define CLIPPERLIB_CLIPPERBASE_GET_PRESERVECOLLINEAR_OFFSET UNITYSDK_OFFSET(0x1AB6C170)
#define CLIPPERLIB_CLIPPERBASE_INITEDGE2_OFFSET UNITYSDK_OFFSET(0x1AB6C8C0)
#define CLIPPERLIB_CLIPPERBASE_INITEDGE_OFFSET UNITYSDK_OFFSET(0x1AB6C880)
#define CLIPPERLIB_CLIPPERBASE_INSERTLOCALMINIMA_OFFSET UNITYSDK_OFFSET(0x1AB6D030)
#define CLIPPERLIB_CLIPPERBASE_INSERTSCANBEAM_OFFSET UNITYSDK_OFFSET(0x1AB621F0)
#define CLIPPERLIB_CLIPPERBASE_ISHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1AB62590)
#define CLIPPERLIB_CLIPPERBASE_LOCALMINIMAPENDING_OFFSET UNITYSDK_OFFSET(0x1AB60890)
#define CLIPPERLIB_CLIPPERBASE_NEAR_ZERO_OFFSET UNITYSDK_OFFSET(0x1AB6C140)
#define CLIPPERLIB_CLIPPERBASE_POINTISVERTEX_OFFSET UNITYSDK_OFFSET(0x1AB6C190)
#define CLIPPERLIB_CLIPPERBASE_POINTONLINESEGMENT_OFFSET UNITYSDK_OFFSET(0x1AB6C1D0)
#define CLIPPERLIB_CLIPPERBASE_POINTONPOLYGON_OFFSET UNITYSDK_OFFSET(0x1AB6C550)
#define CLIPPERLIB_CLIPPERBASE_POPLOCALMINIMA_OFFSET UNITYSDK_OFFSET(0x1AB62E50)
#define CLIPPERLIB_CLIPPERBASE_POPSCANBEAM_OFFSET UNITYSDK_OFFSET(0x1AB5F6F0)
#define CLIPPERLIB_CLIPPERBASE_PROCESSBOUND_OFFSET UNITYSDK_OFFSET(0x1AB6CAF0)
#define CLIPPERLIB_CLIPPERBASE_PT2ISBETWEENPT1ANDPT3_OFFSET UNITYSDK_OFFSET(0x1AB66B90)
#define CLIPPERLIB_CLIPPERBASE_RANGETEST_OFFSET UNITYSDK_OFFSET(0x1AB6C790)
#define CLIPPERLIB_CLIPPERBASE_REMOVEEDGE_OFFSET UNITYSDK_OFFSET(0x1AB6D0C0)
#define CLIPPERLIB_CLIPPERBASE_RESET_OFFSET UNITYSDK_OFFSET(0x1AB5F670)
#define CLIPPERLIB_CLIPPERBASE_REVERSEHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1AB6D080)
#define CLIPPERLIB_CLIPPERBASE_SETDX_OFFSET UNITYSDK_OFFSET(0x1AB6C970)
#define CLIPPERLIB_CLIPPERBASE_SET_PRESERVECOLLINEAR_OFFSET UNITYSDK_OFFSET(0x1AB6C180)
#define CLIPPERLIB_CLIPPERBASE_SLOPESEQUAL_1_OFFSET UNITYSDK_OFFSET(0x1AB669D0)
#define CLIPPERLIB_CLIPPERBASE_SLOPESEQUAL_2_OFFSET UNITYSDK_OFFSET(0x1AB62640)
#define CLIPPERLIB_CLIPPERBASE_SLOPESEQUAL_OFFSET UNITYSDK_OFFSET(0x1AB65210)
#define CLIPPERLIB_CLIPPERBASE_SWAPPOSITIONSINAEL_OFFSET UNITYSDK_OFFSET(0x1AB64F90)
#define CLIPPERLIB_CLIPPERBASE_SWAP_OFFSET UNITYSDK_OFFSET(0x1AB63890)
#define CLIPPERLIB_CLIPPERBASE_UPDATEEDGEINTOAEL_OFFSET UNITYSDK_OFFSET(0x1AB650A0)
#define CLIPPERLIB_CLIPPERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB5DFF0)

namespace ClipperLib
{
	inline static constexpr unsigned int ClipperBase_TypeDefinitionIndex = 31238;
	...
	public:
		...
		::ClipperLib::LocalMinima* m_MinimaList; // 0x20
		::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::ClipperLib::TEdge*>*>* m_edges; // 0x28
