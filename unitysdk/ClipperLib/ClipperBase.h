...
#define CLIPPERLIB_CLIPPERBASE_ADDPATHS_OFFSET UNITYSDK_OFFSET(0x1CFF4940)
#define CLIPPERLIB_CLIPPERBASE_ADDPATH_OFFSET UNITYSDK_OFFSET(0x1CFF3B60)
#define CLIPPERLIB_CLIPPERBASE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1CFF7570)
#define CLIPPERLIB_CLIPPERBASE_CREATEOUTREC_OFFSET UNITYSDK_OFFSET(0x1CFEE4C0)
#define CLIPPERLIB_CLIPPERBASE_DELETEFROMAEL_OFFSET UNITYSDK_OFFSET(0x1CFEFE60)
#define CLIPPERLIB_CLIPPERBASE_DISPOSELOCALMINIMALIST_OFFSET UNITYSDK_OFFSET(0x1CFF76F0)
#define CLIPPERLIB_CLIPPERBASE_DISPOSEOUTREC_OFFSET UNITYSDK_OFFSET(0x1CFEC840)
#define CLIPPERLIB_CLIPPERBASE_FINDNEXTLOCMIN_OFFSET UNITYSDK_OFFSET(0x1CFF7950)
#define CLIPPERLIB_CLIPPERBASE_GETBOUNDS_OFFSET UNITYSDK_OFFSET(0x1CFF8130)
#define CLIPPERLIB_CLIPPERBASE_GET_PRESERVECOLLINEAR_OFFSET UNITYSDK_OFFSET(0x1CFF70F0)
#define CLIPPERLIB_CLIPPERBASE_INITEDGE2_OFFSET UNITYSDK_OFFSET(0x1CFF7830)
#define CLIPPERLIB_CLIPPERBASE_INITEDGE_OFFSET UNITYSDK_OFFSET(0x1CFF7800)
#define CLIPPERLIB_CLIPPERBASE_INSERTLOCALMINIMA_OFFSET UNITYSDK_OFFSET(0x1CFF8050)
#define CLIPPERLIB_CLIPPERBASE_INSERTSCANBEAM_OFFSET UNITYSDK_OFFSET(0x1CFED170)
#define CLIPPERLIB_CLIPPERBASE_ISHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1CFED4F0)
#define CLIPPERLIB_CLIPPERBASE_LOCALMINIMAPENDING_OFFSET UNITYSDK_OFFSET(0x1CFEB840)
#define CLIPPERLIB_CLIPPERBASE_NEAR_ZERO_OFFSET UNITYSDK_OFFSET(0x1CFF70C0)
#define CLIPPERLIB_CLIPPERBASE_POINTISVERTEX_OFFSET UNITYSDK_OFFSET(0x1CFF7110)
#define CLIPPERLIB_CLIPPERBASE_POINTONLINESEGMENT_OFFSET UNITYSDK_OFFSET(0x1CFF7150)
#define CLIPPERLIB_CLIPPERBASE_POINTONPOLYGON_OFFSET UNITYSDK_OFFSET(0x1CFF74D0)
#define CLIPPERLIB_CLIPPERBASE_POPLOCALMINIMA_OFFSET UNITYSDK_OFFSET(0x1CFEDD40)
#define CLIPPERLIB_CLIPPERBASE_POPSCANBEAM_OFFSET UNITYSDK_OFFSET(0x1CFEA680)
#define CLIPPERLIB_CLIPPERBASE_PROCESSBOUND_OFFSET UNITYSDK_OFFSET(0x1CFF7A90)
#define CLIPPERLIB_CLIPPERBASE_PT2ISBETWEENPT1ANDPT3_OFFSET UNITYSDK_OFFSET(0x1CFF1AF0)
#define CLIPPERLIB_CLIPPERBASE_RANGETEST_OFFSET UNITYSDK_OFFSET(0x1CFF7710)
#define CLIPPERLIB_CLIPPERBASE_REMOVEEDGE_OFFSET UNITYSDK_OFFSET(0x1CFF80E0)
#define CLIPPERLIB_CLIPPERBASE_RESET_OFFSET UNITYSDK_OFFSET(0x1CFEA600)
#define CLIPPERLIB_CLIPPERBASE_REVERSEHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1CFF80A0)
#define CLIPPERLIB_CLIPPERBASE_SETDX_OFFSET UNITYSDK_OFFSET(0x1CFF78F0)
#define CLIPPERLIB_CLIPPERBASE_SET_PRESERVECOLLINEAR_OFFSET UNITYSDK_OFFSET(0x1CFF7100)
#define CLIPPERLIB_CLIPPERBASE_SLOPESEQUAL_1_OFFSET UNITYSDK_OFFSET(0x1CFF1930)
#define CLIPPERLIB_CLIPPERBASE_SLOPESEQUAL_2_OFFSET UNITYSDK_OFFSET(0x1CFED5A0)
#define CLIPPERLIB_CLIPPERBASE_SLOPESEQUAL_OFFSET UNITYSDK_OFFSET(0x1CFF0140)
#define CLIPPERLIB_CLIPPERBASE_SWAPPOSITIONSINAEL_OFFSET UNITYSDK_OFFSET(0x1CFEFEC0)
#define CLIPPERLIB_CLIPPERBASE_SWAP_OFFSET UNITYSDK_OFFSET(0x1CFEE760)
#define CLIPPERLIB_CLIPPERBASE_UPDATEEDGEINTOAEL_OFFSET UNITYSDK_OFFSET(0x1CFEFFD0)
#define CLIPPERLIB_CLIPPERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFE8F60)

namespace ClipperLib
{
	inline static constexpr unsigned int ClipperBase_TypeDefinitionIndex = 32789;
	...
	public:
		...
		::ClipperLib::Scanbeam* m_Scanbeam; // 0x10
		::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::ClipperLib::TEdge*>*>* m_edges; // 0x18
		::ClipperLib::TEdge* m_ActiveEdges; // 0x20
		::System::Collections::Generic::List_1<::ClipperLib::OutRec*>* m_PolyOuts; // 0x28
		::ClipperLib::LocalMinima* m_MinimaList; // 0x30
		::ClipperLib::LocalMinima* m_CurrentLM; // 0x38
		::System::Boolean _PreserveCollinear_k__BackingField; // 0x40
		::System::Boolean m_UseFullRange; // 0x41
		::System::Boolean m_HasOpenPaths; // 0x42
