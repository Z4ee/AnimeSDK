...
#define CLIPPERLIB_POLYNODE_ADDCHILD_OFFSET UNITYSDK_OFFSET(0x1AB66960)
#define CLIPPERLIB_POLYNODE_GETNEXTSIBLINGUP_OFFSET UNITYSDK_OFFSET(0x1AB70DC0)
#define CLIPPERLIB_POLYNODE_GETNEXT_OFFSET UNITYSDK_OFFSET(0x1AB70CB0)
#define CLIPPERLIB_POLYNODE_GET_CHILDCOUNT_OFFSET UNITYSDK_OFFSET(0x1AB6BFD0)
#define CLIPPERLIB_POLYNODE_GET_CHILDS_OFFSET UNITYSDK_OFFSET(0x1AB70E80)
#define CLIPPERLIB_POLYNODE_GET_CONTOUR_OFFSET UNITYSDK_OFFSET(0x1AB70CA0)
#define CLIPPERLIB_POLYNODE_GET_ISHOLE_OFFSET UNITYSDK_OFFSET(0x1AB70EA0)
#define CLIPPERLIB_POLYNODE_GET_ISOPEN_OFFSET UNITYSDK_OFFSET(0x1AB70ED0)
#define CLIPPERLIB_POLYNODE_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x1AB70E90)
#define CLIPPERLIB_POLYNODE_ISHOLENODE_OFFSET UNITYSDK_OFFSET(0x1AB70C70)
#define CLIPPERLIB_POLYNODE_SET_ISOPEN_OFFSET UNITYSDK_OFFSET(0x1AB70EE0)
#define CLIPPERLIB_POLYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB668B0)

namespace ClipperLib
{
	inline static constexpr unsigned int PolyNode_TypeDefinitionIndex = 31218;

	class PolyNode : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::ClipperLib::PolyNode*>* m_Childs; // 0x10
		::System::Collections::Generic::List_1<::ClipperLib::IntPoint>* m_polygon; // 0x18
		::ClipperLib::PolyNode* m_Parent; // 0x20
		::ClipperLib::EndType m_endtype; // 0x28
		::ClipperLib::JoinType m_jointype; // 0x2C
