...
#define CLIPPERLIB_POLYNODE_ADDCHILD_OFFSET UNITYSDK_OFFSET(0x1CFF18C0)
#define CLIPPERLIB_POLYNODE_GETNEXTSIBLINGUP_OFFSET UNITYSDK_OFFSET(0x1CFFBDE0)
#define CLIPPERLIB_POLYNODE_GETNEXT_OFFSET UNITYSDK_OFFSET(0x1CFFBCD0)
#define CLIPPERLIB_POLYNODE_GET_CHILDCOUNT_OFFSET UNITYSDK_OFFSET(0x1CFF6F50)
#define CLIPPERLIB_POLYNODE_GET_CHILDS_OFFSET UNITYSDK_OFFSET(0x1CFFBEA0)
#define CLIPPERLIB_POLYNODE_GET_CONTOUR_OFFSET UNITYSDK_OFFSET(0x1CFFBCC0)
#define CLIPPERLIB_POLYNODE_GET_ISHOLE_OFFSET UNITYSDK_OFFSET(0x1CFFBEC0)
#define CLIPPERLIB_POLYNODE_GET_ISOPEN_OFFSET UNITYSDK_OFFSET(0x1CFFBEF0)
#define CLIPPERLIB_POLYNODE_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x1CFFBEB0)
#define CLIPPERLIB_POLYNODE_ISHOLENODE_OFFSET UNITYSDK_OFFSET(0x1CFFBC90)
#define CLIPPERLIB_POLYNODE_SET_ISOPEN_OFFSET UNITYSDK_OFFSET(0x1CFFBF00)
#define CLIPPERLIB_POLYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFF1810)

namespace ClipperLib
{
	inline static constexpr unsigned int PolyNode_TypeDefinitionIndex = 32769;
	...
	public:
		...
		::ClipperLib::JoinType m_jointype; // 0x28
		::System::Int32 m_Index; // 0x2C
		::System::Boolean _IsOpen_k__BackingField; // 0x30
		::ClipperLib::EndType m_endtype; // 0x34
