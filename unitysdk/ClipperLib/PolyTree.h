...
#define CLIPPERLIB_POLYTREE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1AB667E0)
#define CLIPPERLIB_POLYTREE_GETFIRST_OFFSET UNITYSDK_OFFSET(0x1AB70EF0)
#define CLIPPERLIB_POLYTREE_GET_TOTAL_OFFSET UNITYSDK_OFFSET(0x1AB6BC80)
#define CLIPPERLIB_POLYTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB70F50)

namespace ClipperLib
{
	inline static constexpr unsigned int PolyTree_TypeDefinitionIndex = 31217;
