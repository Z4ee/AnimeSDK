...
#define CLASS_2_CFEDE77CE6B2789D_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x18967040)
#define CLASS_2_CFEDE77CE6B2789D_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x18967250)
#define CLASS_2_CFEDE77CE6B2789D_METHOD_2_19CCC07C980409E4_1_OFFSET UNITYSDK_OFFSET(0x18966E20)
#define CLASS_2_CFEDE77CE6B2789D_METHOD_2_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x18966DB0)
#define CLASS_2_CFEDE77CE6B2789D_METHOD_2_455E250D679F9642_OFFSET UNITYSDK_OFFSET(0x18966D60)
#define CLASS_2_CFEDE77CE6B2789D_METHOD_2_C58BA76DADC5F97D_OFFSET UNITYSDK_OFFSET(0x18966EB0)
#define CLASS_2_CFEDE77CE6B2789D_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x18966F80)
#define CLASS_2_CFEDE77CE6B2789D__CTOR_OFFSET UNITYSDK_OFFSET(0x18967420)
#define CLASS_2_CFEDE77CE6B2789D__ONBIND_OFFSET UNITYSDK_OFFSET(0x18966C90)

inline static constexpr unsigned int Class_2_CFEDE77CE6B2789D_TypeDefinitionIndex = 71594;
...
public:
	...
	::Class_2_DC286ED3B0B23D49* MBKDJAJJCCG; // 0x60
	::UnityEngine::Animation* EACCDAKEHLG; // 0x68
	::UnityEngine::Animation* JPHOOFFIAAH; // 0x70
	::Class_2_A80FFA2F42BC210A* JDLNLMEECOI; // 0x78
	::Class_2_C41EA7620AD7D128* KMMINGNJJPK; // 0x80
