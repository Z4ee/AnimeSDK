...
#define TIRETRACKSPRINTER_BEZIERPOINT_OFFSET UNITYSDK_OFFSET(0x1C3EBEA0)
#define TIRETRACKSPRINTER_CREATEWHEELMESHROOT_OFFSET UNITYSDK_OFFSET(0x1C3EAFD0)
#define TIRETRACKSPRINTER_DESTORYWHEEL_OFFSET UNITYSDK_OFFSET(0x1C3EAD30)
#define TIRETRACKSPRINTER_GENERATEWHEELMESH_OFFSET UNITYSDK_OFFSET(0x1C3EC020)
#define TIRETRACKSPRINTER_INITWHEELDATA_OFFSET UNITYSDK_OFFSET(0x1C3E9ED0)
#define TIRETRACKSPRINTER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1C3EA190)
#define TIRETRACKSPRINTER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C3E9E80)
#define TIRETRACKSPRINTER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1C3EA2E0)
#define TIRETRACKSPRINTER_REMOVEWHEELDATA_OFFSET UNITYSDK_OFFSET(0x1C3EA1E0)
#define TIRETRACKSPRINTER_RESETWHEELDATAARRAY_OFFSET UNITYSDK_OFFSET(0x1C3EAC30)
#define TIRETRACKSPRINTER_TICKWHEELPRINT_OFFSET UNITYSDK_OFFSET(0x1C3EA390)
#define TIRETRACKSPRINTER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C3EA330)
#define TIRETRACKSPRINTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3ECFB0)

inline static constexpr unsigned int TireTracksPrinter_TypeDefinitionIndex = 42063;
