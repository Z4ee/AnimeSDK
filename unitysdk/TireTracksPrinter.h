...
#define TIRETRACKSPRINTER_BEZIERPOINT_OFFSET UNITYSDK_OFFSET(0x1A0E83B0)
#define TIRETRACKSPRINTER_CREATEWHEELMESHROOT_OFFSET UNITYSDK_OFFSET(0x1A0E74E0)
#define TIRETRACKSPRINTER_DESTORYWHEEL_OFFSET UNITYSDK_OFFSET(0x1A0E7240)
#define TIRETRACKSPRINTER_GENERATEWHEELMESH_OFFSET UNITYSDK_OFFSET(0x1A0E8530)
#define TIRETRACKSPRINTER_INITWHEELDATA_OFFSET UNITYSDK_OFFSET(0x1A0E6390)
#define TIRETRACKSPRINTER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A0E6650)
#define TIRETRACKSPRINTER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A0E6340)
#define TIRETRACKSPRINTER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A0E67A0)
#define TIRETRACKSPRINTER_REMOVEWHEELDATA_OFFSET UNITYSDK_OFFSET(0x1A0E66A0)
#define TIRETRACKSPRINTER_RESETWHEELDATAARRAY_OFFSET UNITYSDK_OFFSET(0x1A0E7130)
#define TIRETRACKSPRINTER_TICKWHEELPRINT_OFFSET UNITYSDK_OFFSET(0x1A0E6850)
#define TIRETRACKSPRINTER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A0E67F0)
#define TIRETRACKSPRINTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0E9490)

inline static constexpr unsigned int TireTracksPrinter_TypeDefinitionIndex = 40633;
