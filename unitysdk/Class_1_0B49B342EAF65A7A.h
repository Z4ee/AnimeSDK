...
#define CLASS_1_0B49B342EAF65A7A_METHOD_1_BA928C31B09C0D39_OFFSET UNITYSDK_OFFSET(0x16C514C0)
#define CLASS_1_0B49B342EAF65A7A__CTOR_OFFSET UNITYSDK_OFFSET(0x16C51980)

inline static constexpr unsigned int Class_1_0B49B342EAF65A7A_TypeDefinitionIndex = 10768;
...
public:
	...
	::RPG::GameCore::FateTraitTag Field_1_6; // 0x3C
	::RPG::Client::TextID Field_1_3; // 0x40
	::RPG::GameCore::FateTraitMode Field_1_7; // 0x50
