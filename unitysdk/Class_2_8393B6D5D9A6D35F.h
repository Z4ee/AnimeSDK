...
#define CLASS_2_8393B6D5D9A6D35F_METHOD_2_03BFDB1C3240A55A_OFFSET UNITYSDK_OFFSET(0xC145300)
#define CLASS_2_8393B6D5D9A6D35F_METHOD_2_52DCD0869ABE0AD5_OFFSET UNITYSDK_OFFSET(0xC145230)
#define CLASS_2_8393B6D5D9A6D35F_METHOD_2_E69AA2E64A20143D_OFFSET UNITYSDK_OFFSET(0xC145410)
#define CLASS_2_8393B6D5D9A6D35F__CTOR_OFFSET UNITYSDK_OFFSET(0xC145710)

inline static constexpr unsigned int Class_2_8393B6D5D9A6D35F_TypeDefinitionIndex = 77525;

class Class_2_8393B6D5D9A6D35F : public ::Class_1_1FB256EC3633CF9E
{
public:
	::Class_1_3ED45B5689DB5816* MPHCGNLJLBJ; // 0x28
	::System::UInt32 MMEFHCADAHG; // 0x30
	::System::UInt32 MEDDOCEGILC; // 0x34
	::UnityEngine::Vector3 LLCKDLOMGEO; // 0x38
