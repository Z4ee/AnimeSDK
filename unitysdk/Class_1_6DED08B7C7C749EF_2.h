...
#define CLASS_1_6DED08B7C7C749EF_2_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A5EA0D0)
#define CLASS_1_6DED08B7C7C749EF_2_CLONE_OFFSET UNITYSDK_OFFSET(0x1A5E9AE0)
#define CLASS_1_6DED08B7C7C749EF_2_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A5E9CD0)
#define CLASS_1_6DED08B7C7C749EF_2_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A5E9BE0)
#define CLASS_1_6DED08B7C7C749EF_2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A5E9DA0)
#define CLASS_1_6DED08B7C7C749EF_2_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A5EA3D0)
#define CLASS_1_6DED08B7C7C749EF_2_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A5EA360)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1A5E9B60)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1A5E9B40)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x1A5E9B90)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x1A5E9B80)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A5E9970)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1A5E9B30)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1A5E9B70)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1A5E9B50)
#define CLASS_1_6DED08B7C7C749EF_2_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A5E99D0)
#define CLASS_1_6DED08B7C7C749EF_2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A5E9F20)
#define CLASS_1_6DED08B7C7C749EF_2_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A5E9F80)
#define CLASS_1_6DED08B7C7C749EF_2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A5EA510)
#define CLASS_1_6DED08B7C7C749EF_2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5E9A40)
#define CLASS_1_6DED08B7C7C749EF_2__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5E99E0)

inline static constexpr unsigned int Class_1_6DED08B7C7C749EF_2_TypeDefinitionIndex = 24330;
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6DED08B7C7C749EF_2_TypeDefinitionIndex)->GetStaticField(0x1AB10);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_6DED08B7C7C749EF_2*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_6DED08B7C7C749EF_2*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6DED08B7C7C749EF_2_TypeDefinitionIndex)->GetStaticField(0x1AB18);
	}
