...
#define CLASS_1_6DED08B7C7C749EF_2_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DEDE360)
#define CLASS_1_6DED08B7C7C749EF_2_CLONE_OFFSET UNITYSDK_OFFSET(0x1DEDDCA0)
#define CLASS_1_6DED08B7C7C749EF_2_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DEDDE60)
#define CLASS_1_6DED08B7C7C749EF_2_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DEDDDA0)
#define CLASS_1_6DED08B7C7C749EF_2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DEDDFA0)
#define CLASS_1_6DED08B7C7C749EF_2_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DEDE5B0)
#define CLASS_1_6DED08B7C7C749EF_2_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DEDE540)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1DEDDD20)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1DEDDD00)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x1DEDDD50)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x1DEDDD40)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1DEDDB20)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1DEDDCF0)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1DEDDD30)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1DEDDD10)
#define CLASS_1_6DED08B7C7C749EF_2_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DEDDB80)
#define CLASS_1_6DED08B7C7C749EF_2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DEDE120)
#define CLASS_1_6DED08B7C7C749EF_2_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DEDE180)
#define CLASS_1_6DED08B7C7C749EF_2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DEDE6F0)
#define CLASS_1_6DED08B7C7C749EF_2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DEDDBF0)
#define CLASS_1_6DED08B7C7C749EF_2__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEDDB90)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_6DED08B7C7C749EF_2*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6DED08B7C7C749EF_2_TypeDefinitionIndex)->GetStaticField(0x37BF0);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_PPJIIDKOOMM()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6DED08B7C7C749EF_2_TypeDefinitionIndex)->GetStaticField(0x37BF8);
	}
	...
	::System::String* JOBGEDKHMED; // 0x18
