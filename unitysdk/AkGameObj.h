...
#define AKGAMEOBJ_ADDLISTENER_OFFSET UNITYSDK_OFFSET(0x1A5CC6B0)
#define AKGAMEOBJ_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A5EAAF0)
#define AKGAMEOBJ_CHECKSTATICSTATUS_OFFSET UNITYSDK_OFFSET(0x1A5EBA10)
#define AKGAMEOBJ_GETFORWARD_OFFSET UNITYSDK_OFFSET(0x1A5EC9A0)
#define AKGAMEOBJ_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x1A5EC6B0)
#define AKGAMEOBJ_GETUPWARD_OFFSET UNITYSDK_OFFSET(0x1A5ECB60)
#define AKGAMEOBJ_GET_ISAUTOSTOP_OFFSET UNITYSDK_OFFSET(0x1A5EA660)
#define AKGAMEOBJ_GET_ISUSINGDEFAULTLISTENERS_OFFSET UNITYSDK_OFFSET(0x1A5E5460)
#define AKGAMEOBJ_GET_LISTENERLIST_OFFSET UNITYSDK_OFFSET(0x1A5E5480)
#define AKGAMEOBJ_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A5EBC20)
#define AKGAMEOBJ_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A5EBA50)
#define AKGAMEOBJ_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1A5ECD20)
#define AKGAMEOBJ_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x1A5ECD90)
#define AKGAMEOBJ_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A5EB900)
#define AKGAMEOBJ_REGISTER_OFFSET UNITYSDK_OFFSET(0x1A5CC2F0)
#define AKGAMEOBJ_REMOVELISTENER_OFFSET UNITYSDK_OFFSET(0x1A5CC710)
#define AKGAMEOBJ_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x1A5EA9A0)
#define AKGAMEOBJ_SET_ISAUTOSTOP_OFFSET UNITYSDK_OFFSET(0x1A5EA670)
#define AKGAMEOBJ_TICK_OFFSET UNITYSDK_OFFSET(0x1A5EBF60)
#define AKGAMEOBJ__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5ED220)

inline static constexpr unsigned int AkGameObj_TypeDefinitionIndex = 40484;
