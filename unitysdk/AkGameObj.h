...
#define AKGAMEOBJ_ADDLISTENER_OFFSET UNITYSDK_OFFSET(0x1D580340)
#define AKGAMEOBJ_AWAKE_OFFSET UNITYSDK_OFFSET(0x1D59E470)
#define AKGAMEOBJ_CHECKSTATICSTATUS_OFFSET UNITYSDK_OFFSET(0x1D59F260)
#define AKGAMEOBJ_GETFORWARD_OFFSET UNITYSDK_OFFSET(0x1D5A02D0)
#define AKGAMEOBJ_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x1D59FFE0)
#define AKGAMEOBJ_GETUPWARD_OFFSET UNITYSDK_OFFSET(0x1D5A0490)
#define AKGAMEOBJ_GET_ISAUTOSTOP_OFFSET UNITYSDK_OFFSET(0x1D59DEA0)
#define AKGAMEOBJ_GET_ISUSINGDEFAULTLISTENERS_OFFSET UNITYSDK_OFFSET(0x1D599240)
#define AKGAMEOBJ_GET_LISTENERLIST_OFFSET UNITYSDK_OFFSET(0x1D599260)
#define AKGAMEOBJ_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1D59F4C0)
#define AKGAMEOBJ_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D59F2A0)
#define AKGAMEOBJ_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1D5A0650)
#define AKGAMEOBJ_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x1D5A06C0)
#define AKGAMEOBJ_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1D59F150)
#define AKGAMEOBJ_REGISTER_OFFSET UNITYSDK_OFFSET(0x1D57FF20)
#define AKGAMEOBJ_REMOVELISTENER_OFFSET UNITYSDK_OFFSET(0x1D5803A0)
#define AKGAMEOBJ_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x1D59E1E0)
#define AKGAMEOBJ_SET_ISAUTOSTOP_OFFSET UNITYSDK_OFFSET(0x1D59DEB0)
#define AKGAMEOBJ_TICK_OFFSET UNITYSDK_OFFSET(0x1D59F890)
#define AKGAMEOBJ__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5A0B40)

inline static constexpr unsigned int AkGameObj_TypeDefinitionIndex = 43737;
