...
#define AKGAMEOBJ_ADDLISTENER_OFFSET UNITYSDK_OFFSET(0x1ECB43F0)
#define AKGAMEOBJ_AWAKE_OFFSET UNITYSDK_OFFSET(0x1ECB4F20)
#define AKGAMEOBJ_CHECKSTATICSTATUS_OFFSET UNITYSDK_OFFSET(0x1ECB5320)
#define AKGAMEOBJ_GETFORWARD_OFFSET UNITYSDK_OFFSET(0x1ECB5B90)
#define AKGAMEOBJ_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x1ECB58E0)
#define AKGAMEOBJ_GETUPWARD_OFFSET UNITYSDK_OFFSET(0x1ECB5CF0)
#define AKGAMEOBJ_GET_ISUSINGDEFAULTLISTENERS_OFFSET UNITYSDK_OFFSET(0x1ECB43B0)
#define AKGAMEOBJ_GET_LISTENERLIST_OFFSET UNITYSDK_OFFSET(0x1ECB43D0)
#define AKGAMEOBJ_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1ECB5330)
#define AKGAMEOBJ_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1ECB42C0)
#define AKGAMEOBJ_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1ECB4200)
#define AKGAMEOBJ_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x1ECB4360)
#define AKGAMEOBJ_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1ECB43A0)
#define AKGAMEOBJ_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0x1ECB4350)
#define AKGAMEOBJ_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x1ECB42A0)
#define AKGAMEOBJ_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1ECB5E50)
#define AKGAMEOBJ_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x1ECB5E70)
#define AKGAMEOBJ_REGISTER_OFFSET UNITYSDK_OFFSET(0x1ECB4690)
#define AKGAMEOBJ_REMOVELISTENER_OFFSET UNITYSDK_OFFSET(0x1ECB4540)
#define AKGAMEOBJ_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x1ECB4A30)
#define AKGAMEOBJ_UPDATE_OFFSET UNITYSDK_OFFSET(0x1ECB5840)
#define AKGAMEOBJ__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ECB6050)
#define AKGAMEOBJ__CTOR_OFFSET UNITYSDK_OFFSET(0x1ECB5E90)

inline static constexpr unsigned int AkGameObj_TypeDefinitionIndex = 33787;
...
public:
	...
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(AkGameObj_TypeDefinitionIndex)->GetStaticField(0x81C0);
	}
