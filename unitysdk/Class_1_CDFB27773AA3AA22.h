...
#define CLASS_1_CDFB27773AA3AA22_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x142B4400)
#define CLASS_1_CDFB27773AA3AA22_GET_MAINAFFIXSCORE_OFFSET UNITYSDK_OFFSET(0x142B4420)
#define CLASS_1_CDFB27773AA3AA22_GET_RARITYCOEFFICIENT_OFFSET UNITYSDK_OFFSET(0x142B4460)
#define CLASS_1_CDFB27773AA3AA22_GET_SUBAFFIXSCORE_OFFSET UNITYSDK_OFFSET(0x142B4440)
#define CLASS_1_CDFB27773AA3AA22_METHOD_1_6136C199368283F5_OFFSET UNITYSDK_OFFSET(0x142B44D0)
#define CLASS_1_CDFB27773AA3AA22_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x142B4480)
#define CLASS_1_CDFB27773AA3AA22_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x142B4410)
#define CLASS_1_CDFB27773AA3AA22_SET_MAINAFFIXSCORE_OFFSET UNITYSDK_OFFSET(0x142B4430)
#define CLASS_1_CDFB27773AA3AA22_SET_RARITYCOEFFICIENT_OFFSET UNITYSDK_OFFSET(0x142B4470)
#define CLASS_1_CDFB27773AA3AA22_SET_SUBAFFIXSCORE_OFFSET UNITYSDK_OFFSET(0x142B4450)
#define CLASS_1_CDFB27773AA3AA22__CTOR_OFFSET UNITYSDK_OFFSET(0x142B4850)

inline static constexpr unsigned int Class_1_CDFB27773AA3AA22_TypeDefinitionIndex = 69511;

class Class_1_CDFB27773AA3AA22 : public ::System::Object
{
public:
	::System::Single _RarityCoefficient_k__BackingField; // 0x10
	::System::Single _MainAffixScore_k__BackingField; // 0x14
	::System::Single _SubAffixScore_k__BackingField; // 0x18
	::RPG::Client::RelicSmartSuit::RelicScoreCalculatorConfig _Config_k__BackingField; // 0x1C
