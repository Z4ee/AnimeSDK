...
#define CLASS_1_CDFB27773AA3AA22_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x146F0BF0)
#define CLASS_1_CDFB27773AA3AA22_GET_MAINAFFIXSCORE_OFFSET UNITYSDK_OFFSET(0x146F0C10)
#define CLASS_1_CDFB27773AA3AA22_GET_RARITYCOEFFICIENT_OFFSET UNITYSDK_OFFSET(0x146F0C50)
#define CLASS_1_CDFB27773AA3AA22_GET_SUBAFFIXSCORE_OFFSET UNITYSDK_OFFSET(0x146F0C30)
#define CLASS_1_CDFB27773AA3AA22_METHOD_1_6136C199368283F5_OFFSET UNITYSDK_OFFSET(0x146F0CC0)
#define CLASS_1_CDFB27773AA3AA22_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x146F0C70)
#define CLASS_1_CDFB27773AA3AA22_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x146F0C00)
#define CLASS_1_CDFB27773AA3AA22_SET_MAINAFFIXSCORE_OFFSET UNITYSDK_OFFSET(0x146F0C20)
#define CLASS_1_CDFB27773AA3AA22_SET_RARITYCOEFFICIENT_OFFSET UNITYSDK_OFFSET(0x146F0C60)
#define CLASS_1_CDFB27773AA3AA22_SET_SUBAFFIXSCORE_OFFSET UNITYSDK_OFFSET(0x146F0C40)
#define CLASS_1_CDFB27773AA3AA22__CTOR_OFFSET UNITYSDK_OFFSET(0x146F1040)

inline static constexpr unsigned int Class_1_CDFB27773AA3AA22_TypeDefinitionIndex = 71034;

class Class_1_CDFB27773AA3AA22 : public ::System::Object
{
public:
	::RPG::Client::RelicSmartSuit::RelicScoreCalculatorConfig _Config_k__BackingField; // 0x10
	::System::Single _MainAffixScore_k__BackingField; // 0x14
	::System::Single _RarityCoefficient_k__BackingField; // 0x18
	::System::Single _SubAffixScore_k__BackingField; // 0x1C
