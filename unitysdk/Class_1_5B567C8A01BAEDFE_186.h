...
#define CLASS_1_5B567C8A01BAEDFE_186_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1946AFD0)
#define CLASS_1_5B567C8A01BAEDFE_186_CLONE_OFFSET UNITYSDK_OFFSET(0x1946AE40)
#define CLASS_1_5B567C8A01BAEDFE_186_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1946AEE0)
#define CLASS_1_5B567C8A01BAEDFE_186_EQUALS_OFFSET UNITYSDK_OFFSET(0x1946AE80)
#define CLASS_1_5B567C8A01BAEDFE_186_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1946AF30)
#define CLASS_1_5B567C8A01BAEDFE_186_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1946B020)
#define CLASS_1_5B567C8A01BAEDFE_186_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1946AFF0)
#define CLASS_1_5B567C8A01BAEDFE_186_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1946ADC0)
#define CLASS_1_5B567C8A01BAEDFE_186_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1946ADF0)
#define CLASS_1_5B567C8A01BAEDFE_186_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1946AF60)
#define CLASS_1_5B567C8A01BAEDFE_186_WRITETO_OFFSET UNITYSDK_OFFSET(0x1946AFC0)
#define CLASS_1_5B567C8A01BAEDFE_186__CCTOR_OFFSET UNITYSDK_OFFSET(0x1946B070)
#define CLASS_1_5B567C8A01BAEDFE_186__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1946AE10)
#define CLASS_1_5B567C8A01BAEDFE_186__CTOR_OFFSET UNITYSDK_OFFSET(0x1946AE00)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_186_TypeDefinitionIndex = 28693;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_186*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_186_TypeDefinitionIndex)->GetStaticField(0x4A140);
	}
