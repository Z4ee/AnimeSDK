...
#define CLASS_1_5B567C8A01BAEDFE_186_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A74BB10)
#define CLASS_1_5B567C8A01BAEDFE_186_CLONE_OFFSET UNITYSDK_OFFSET(0x1A74B980)
#define CLASS_1_5B567C8A01BAEDFE_186_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A74BA20)
#define CLASS_1_5B567C8A01BAEDFE_186_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A74B9C0)
#define CLASS_1_5B567C8A01BAEDFE_186_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A74BA70)
#define CLASS_1_5B567C8A01BAEDFE_186_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A74BB60)
#define CLASS_1_5B567C8A01BAEDFE_186_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A74BB30)
#define CLASS_1_5B567C8A01BAEDFE_186_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A74B900)
#define CLASS_1_5B567C8A01BAEDFE_186_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A74B930)
#define CLASS_1_5B567C8A01BAEDFE_186_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A74BAA0)
#define CLASS_1_5B567C8A01BAEDFE_186_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A74BB00)
#define CLASS_1_5B567C8A01BAEDFE_186__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A74BBB0)
#define CLASS_1_5B567C8A01BAEDFE_186__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A74B950)
#define CLASS_1_5B567C8A01BAEDFE_186__CTOR_OFFSET UNITYSDK_OFFSET(0x1A74B940)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_186_TypeDefinitionIndex = 28566;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_186*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_186_TypeDefinitionIndex)->GetStaticField(0x426B0);
	}
