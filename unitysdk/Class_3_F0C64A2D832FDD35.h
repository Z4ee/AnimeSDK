...
#define CLASS_3_F0C64A2D832FDD35_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8C47D90)
#define CLASS_3_F0C64A2D832FDD35__CTOR_OFFSET UNITYSDK_OFFSET(0x8C47D60)

inline static constexpr unsigned int Class_3_F0C64A2D832FDD35_TypeDefinitionIndex = 44496;
