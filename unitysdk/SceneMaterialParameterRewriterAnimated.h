...
#define SCENEMATERIALPARAMETERREWRITERANIMATED_APPLY_OFFSET UNITYSDK_OFFSET(0x1AECAB60)
#define SCENEMATERIALPARAMETERREWRITERANIMATED_CLEARCONTENT_OFFSET UNITYSDK_OFFSET(0x1AECBA30)
#define SCENEMATERIALPARAMETERREWRITERANIMATED_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AECB9E0)
#define SCENEMATERIALPARAMETERREWRITERANIMATED_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AECAB10)
#define SCENEMATERIALPARAMETERREWRITERANIMATED_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AECBBA0)
#define SCENEMATERIALPARAMETERREWRITERANIMATED__CTOR_OFFSET UNITYSDK_OFFSET(0x1AECBC00)

inline static constexpr unsigned int SceneMaterialParameterRewriterAnimated_TypeDefinitionIndex = 26419;
