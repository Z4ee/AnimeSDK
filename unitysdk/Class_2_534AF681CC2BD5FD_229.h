...
inline static constexpr unsigned int Class_2_534AF681CC2BD5FD_229_TypeDefinitionIndex = 60385;

template <typename T, typename TCollection>
class Class_2_534AF681CC2BD5FD_229 : public ::Class_1_B1B2E75C037702A7<T, TCollection>
{
public:
};
