...
#define CLASS_2_DD09D799E578CFFF_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AF424D0)
#define CLASS_2_DD09D799E578CFFF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1AF42510)
#define CLASS_2_DD09D799E578CFFF_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1AF42860)
#define CLASS_2_DD09D799E578CFFF_TICK_OFFSET UNITYSDK_OFFSET(0x1AF428B0)
#define CLASS_2_DD09D799E578CFFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF424C0)

inline static constexpr unsigned int Class_2_DD09D799E578CFFF_TypeDefinitionIndex = 56638;

class Class_2_DD09D799E578CFFF : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ShowEntityFloatMessage* OFKGLJOAMLD; // 0x18
