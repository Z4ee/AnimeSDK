...
#define CLASS_1_F34834ADCD6ED4D0__CTOR_OFFSET UNITYSDK_OFFSET(0x18857020)
...
public:
	...
	::RPG::Client::UILayer OCKDGDBMPOM; // 0x20
	::RPG::Client::UIController_TransitionStyle HHPLFNBGLEK; // 0x24
	::System::Boolean BCOKPOLAFCG; // 0x28
	::System::Boolean OAHAEALJFAB; // 0x29
