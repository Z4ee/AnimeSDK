...
#define CLASS_2_B5DB04A6D2546EAC_METHOD_2_921C3C3E09D59CD4_OFFSET UNITYSDK_OFFSET(0x1626A700)
#define CLASS_2_B5DB04A6D2546EAC__CTOR_OFFSET UNITYSDK_OFFSET(0x1626A6F0)
...
{
public:
	::RPG::GameCore::DiceCombatTaskConfig_InsertAbility* IGHAHBNLIJA; // 0x18
