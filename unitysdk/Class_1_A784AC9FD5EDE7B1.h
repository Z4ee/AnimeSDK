...
#define CLASS_1_A784AC9FD5EDE7B1_METHOD_1_0E3C9CE42200F670_OFFSET UNITYSDK_OFFSET(0x1B4FE6E0)
#define CLASS_1_A784AC9FD5EDE7B1__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4FEAC0)
...
{
public:
	::System::String* KKJHBCAHFAO; // 0x10
	::System::String* FBKAMIHGLFK; // 0x18
	::System::String* BDACPPLKLGL; // 0x20
	::Il2CppArray<::System::UInt32>* GFLGOBHOKHI; // 0x28
	...
	::System::UInt32 DBIHGLJEGPO; // 0x5C
	::System::UInt32 HAEDMJHMJHC; // 0x60
