...
#define MONOUIDAMAGETMPEFFECT__ANIMATETEXT_D__62_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xF3AE7A0)
#define MONOUIDAMAGETMPEFFECT__ANIMATETEXT_D__62_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xF3AE840)
#define MONOUIDAMAGETMPEFFECT__ANIMATETEXT_D__62_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xF3AE8A0)
#define MONOUIDAMAGETMPEFFECT__ANIMATETEXT_D__62_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xF3AE850)
#define MONOUIDAMAGETMPEFFECT__ANIMATETEXT_D__62_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xF3AE790)
#define MONOUIDAMAGETMPEFFECT__ANIMATETEXT_D__62__CTOR_OFFSET UNITYSDK_OFFSET(0xF3AE780)

inline static constexpr unsigned int MonoUIDamageTMPEffect__AnimateText_d__62_TypeDefinitionIndex = 78929;
