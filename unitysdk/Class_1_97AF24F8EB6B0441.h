...
#define CLASS_1_97AF24F8EB6B0441__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1827B0)
...
{
public:
	::RPG::GameCore::LittleGameEntityType Field_1_0; // 0x10
	::RPG::GameCore::LittleGameSmartObjectSlotGroup Field_1_1; // 0x14
	::UnityEngine::Vector3 Field_1_2; // 0x18
	::UnityEngine::Vector3 Field_1_3; // 0x24
	::RPG::Client::LittleGame::SmartObjectState Field_1_4; // 0x30
