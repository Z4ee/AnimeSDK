...
#define TA_LOCALLIGHTTEST_START_OFFSET UNITYSDK_OFFSET(0x104F35D0)
#define TA_LOCALLIGHTTEST_UPDATE_OFFSET UNITYSDK_OFFSET(0x104F3620)
#define TA_LOCALLIGHTTEST__CTOR_OFFSET UNITYSDK_OFFSET(0x104F37A0)
