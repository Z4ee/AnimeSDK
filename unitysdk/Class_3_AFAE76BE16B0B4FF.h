...
#define CLASS_3_AFAE76BE16B0B4FF_METHOD_3_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0x18C946B0)
#define CLASS_3_AFAE76BE16B0B4FF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18C93E90)
#define CLASS_3_AFAE76BE16B0B4FF__CTOR_OFFSET UNITYSDK_OFFSET(0x18C93E60)

inline static constexpr unsigned int Class_3_AFAE76BE16B0B4FF_TypeDefinitionIndex = 56547;
