...
#define CLASS_2_E24C129C8F986B0F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15B1F960)
#define CLASS_2_E24C129C8F986B0F_METHOD_2_4389275F4099DE36_OFFSET UNITYSDK_OFFSET(0x15B201A0)
#define CLASS_2_E24C129C8F986B0F_METHOD_2_83F3488F646038A3_OFFSET UNITYSDK_OFFSET(0x15B20350)
#define CLASS_2_E24C129C8F986B0F_METHOD_2_D4405B1C2CBD9D8F_OFFSET UNITYSDK_OFFSET(0x15B20920)
#define CLASS_2_E24C129C8F986B0F_METHOD_2_EEB04BF960D675D2_OFFSET UNITYSDK_OFFSET(0x15B20120)
#define CLASS_2_E24C129C8F986B0F_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15B1F9A0)
#define CLASS_2_E24C129C8F986B0F_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15B208D0)
#define CLASS_2_E24C129C8F986B0F_TICK_OFFSET UNITYSDK_OFFSET(0x15B206C0)
#define CLASS_2_E24C129C8F986B0F__CTOR_OFFSET UNITYSDK_OFFSET(0x15B1F850)
#define CLASS_2_E24C129C8F986B0F__ONTASKBEGIN_B__3_0_OFFSET UNITYSDK_OFFSET(0x15B20A00)
...
public:
	...
	::Class_1_5F51D4049EA87B7B* FMNNOJKECOE; // 0x20
	::RPG::GameCore::TriggerModifierEnterBattle* OFKGLJOAMLD; // 0x28
	::System::Collections::Generic::List_1<::RPG::GameCore::TurnBasedModifierInstance*>* PGFACPLOACF; // 0x30
	::System::Int32 BBPBJFBGDBJ; // 0x38
	::System::Boolean NEKAHLIFDDI; // 0x3C
	::System::Boolean HFAFMLHAJBJ; // 0x3D
