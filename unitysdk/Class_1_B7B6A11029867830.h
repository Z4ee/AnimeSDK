...
#define CLASS_1_B7B6A11029867830_METHOD_1_417A218C63D0B3DA_OFFSET UNITYSDK_OFFSET(0x1CD3BD50)
#define CLASS_1_B7B6A11029867830__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD3C000)
...
public:
	...
	::RPG::GameCore::FixPoint NFNILIEFKHJ; // 0x20
