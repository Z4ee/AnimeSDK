...
#define CLASS_1_4C451B39EB3F4200_METHOD_1_E9A2160FD348DB23_OFFSET UNITYSDK_OFFSET(0x1D0685C0)
#define CLASS_1_4C451B39EB3F4200__CTOR_OFFSET UNITYSDK_OFFSET(0x1D068800)

inline static constexpr unsigned int Class_1_4C451B39EB3F4200_TypeDefinitionIndex = 11303;

class Class_1_4C451B39EB3F4200 : public ::System::Object
{
public:
	::System::UInt32 IBLFDGEHJBK; // 0x10
	::System::UInt32 PHFMCACHFIJ; // 0x14
	::RPG::Client::TextID OENAMINOLLF; // 0x18
	::System::UInt32 LCBCODGENJD; // 0x28
	::System::UInt32 FIGEGOBFPIF; // 0x2C
