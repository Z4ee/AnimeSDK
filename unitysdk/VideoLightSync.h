...
#define VIDEOLIGHTSYNC_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1E7847C0)
#define VIDEOLIGHTSYNC_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1E784410)
#define VIDEOLIGHTSYNC_TURNOFFLIGHT_OFFSET UNITYSDK_OFFSET(0x1E784840)
#define VIDEOLIGHTSYNC_UPDATEVIDEOFRAME_OFFSET UNITYSDK_OFFSET(0x1E784C70)
#define VIDEOLIGHTSYNC_UPDATEVIDEONAME_OFFSET UNITYSDK_OFFSET(0x1E784AC0)
#define VIDEOLIGHTSYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1E784D40)

inline static constexpr unsigned int VideoLightSync_TypeDefinitionIndex = 84110;
