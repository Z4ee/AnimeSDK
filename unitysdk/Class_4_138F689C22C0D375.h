...
#define CLASS_4_138F689C22C0D375_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1145B250)
#define CLASS_4_138F689C22C0D375__CTOR_OFFSET UNITYSDK_OFFSET(0x1145B220)
#define CLASS_4_138F689C22C0D375___IFIXBASEPROXY_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1145B2F0)

inline static constexpr unsigned int Class_4_138F689C22C0D375_TypeDefinitionIndex = 44649;
