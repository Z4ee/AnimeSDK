...
#define CUSTOMSKIN_OVERSEANEWDEVICEPHONEVERIFY__COUNTDOWN_D__16_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x130FBFF0)
#define CUSTOMSKIN_OVERSEANEWDEVICEPHONEVERIFY__COUNTDOWN_D__16_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x130FC240)
#define CUSTOMSKIN_OVERSEANEWDEVICEPHONEVERIFY__COUNTDOWN_D__16_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x130FC2A0)
#define CUSTOMSKIN_OVERSEANEWDEVICEPHONEVERIFY__COUNTDOWN_D__16_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x130FC250)
#define CUSTOMSKIN_OVERSEANEWDEVICEPHONEVERIFY__COUNTDOWN_D__16_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x130FBFE0)
#define CUSTOMSKIN_OVERSEANEWDEVICEPHONEVERIFY__COUNTDOWN_D__16__CTOR_OFFSET UNITYSDK_OFFSET(0x130FBFD0)

inline static constexpr unsigned int CustomSkin_OverseaNewDevicePhoneVerify__CountDown_d__16_TypeDefinitionIndex = 43626;
