...
#define CUSTOMSKIN_OVERSEANEWDEVICEPHONEVERIFY__COUNTDOWN_D__16_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x131A2A90)
#define CUSTOMSKIN_OVERSEANEWDEVICEPHONEVERIFY__COUNTDOWN_D__16_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x131A2CE0)
#define CUSTOMSKIN_OVERSEANEWDEVICEPHONEVERIFY__COUNTDOWN_D__16_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x131A2D40)
#define CUSTOMSKIN_OVERSEANEWDEVICEPHONEVERIFY__COUNTDOWN_D__16_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x131A2CF0)
#define CUSTOMSKIN_OVERSEANEWDEVICEPHONEVERIFY__COUNTDOWN_D__16_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x131A2A80)
#define CUSTOMSKIN_OVERSEANEWDEVICEPHONEVERIFY__COUNTDOWN_D__16__CTOR_OFFSET UNITYSDK_OFFSET(0x131A2A70)

inline static constexpr unsigned int CustomSkin_OverseaNewDevicePhoneVerify__CountDown_d__16_TypeDefinitionIndex = 67289;
