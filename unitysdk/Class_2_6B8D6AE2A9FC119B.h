...
#define CLASS_2_6B8D6AE2A9FC119B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18C938C0)
#define CLASS_2_6B8D6AE2A9FC119B_METHOD_2_2EB64D7F3388406F_OFFSET UNITYSDK_OFFSET(0x18C94FC0)
#define CLASS_2_6B8D6AE2A9FC119B_METHOD_2_84B92802FDAFF6C8_1_OFFSET UNITYSDK_OFFSET(0x18C95A60)
#define CLASS_2_6B8D6AE2A9FC119B_METHOD_2_84B92802FDAFF6C8_OFFSET UNITYSDK_OFFSET(0x18C95870)
#define CLASS_2_6B8D6AE2A9FC119B_METHOD_2_9029BA80CA63A4CA_OFFSET UNITYSDK_OFFSET(0x18C94680)
#define CLASS_2_6B8D6AE2A9FC119B_METHOD_2_AFDC576A9606B859_OFFSET UNITYSDK_OFFSET(0x18C93B70)
#define CLASS_2_6B8D6AE2A9FC119B_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x18C95C50)
#define CLASS_2_6B8D6AE2A9FC119B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18C93EE0)
#define CLASS_2_6B8D6AE2A9FC119B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x18C95670)
#define CLASS_2_6B8D6AE2A9FC119B_TICK_OFFSET UNITYSDK_OFFSET(0x18C956C0)
#define CLASS_2_6B8D6AE2A9FC119B__CTOR_OFFSET UNITYSDK_OFFSET(0x18C936D0)

inline static constexpr unsigned int Class_2_6B8D6AE2A9FC119B_TypeDefinitionIndex = 55481;

class Class_2_6B8D6AE2A9FC119B : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::CreateSharedSummonUnit* Field_2_0; // 0x18
