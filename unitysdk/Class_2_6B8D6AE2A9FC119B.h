...
#define CLASS_2_6B8D6AE2A9FC119B_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD7FCE90)
#define CLASS_2_6B8D6AE2A9FC119B_METHOD_2_2EB64D7F3388406F_OFFSET UNITYSDK_OFFSET(0xD7FE580)
#define CLASS_2_6B8D6AE2A9FC119B_METHOD_2_84B92802FDAFF6C8_1_OFFSET UNITYSDK_OFFSET(0xD7FF010)
#define CLASS_2_6B8D6AE2A9FC119B_METHOD_2_84B92802FDAFF6C8_OFFSET UNITYSDK_OFFSET(0xD7FEE20)
#define CLASS_2_6B8D6AE2A9FC119B_METHOD_2_9029BA80CA63A4CA_OFFSET UNITYSDK_OFFSET(0xD7FDC50)
#define CLASS_2_6B8D6AE2A9FC119B_METHOD_2_AFDC576A9606B859_OFFSET UNITYSDK_OFFSET(0xD7FD140)
#define CLASS_2_6B8D6AE2A9FC119B_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD7FF200)
#define CLASS_2_6B8D6AE2A9FC119B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xD7FD4B0)
#define CLASS_2_6B8D6AE2A9FC119B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xD7FEC20)
#define CLASS_2_6B8D6AE2A9FC119B_TICK_OFFSET UNITYSDK_OFFSET(0xD7FEC70)
#define CLASS_2_6B8D6AE2A9FC119B__CTOR_OFFSET UNITYSDK_OFFSET(0xD7FCCA0)
...
public:
	...
	::Class_1_DB9575801298F699* EPGIOAEIACN; // 0x30
	::Class_3_07C3C4D2990C49EE* FJJCPJNINDE; // 0x38
	::Class_3_07C3C4D2990C49EE* HBCDNGJDPCE; // 0x40
	::RPG::GameCore::CreateSharedSummonUnit* OFKGLJOAMLD; // 0x48
