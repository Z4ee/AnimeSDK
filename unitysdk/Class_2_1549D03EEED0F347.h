...
#define CLASS_2_1549D03EEED0F347_DISPOSE_OFFSET UNITYSDK_OFFSET(0x169C2340)
#define CLASS_2_1549D03EEED0F347_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x169C2770)
#define CLASS_2_1549D03EEED0F347_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x169C27C0)
#define CLASS_2_1549D03EEED0F347_TICK_OFFSET UNITYSDK_OFFSET(0x169C24C0)
#define CLASS_2_1549D03EEED0F347__CTOR_OFFSET UNITYSDK_OFFSET(0x169C2150)
...
public:
	...
	::RPG::Client::Prop::BlockPuzzleBase* Field_2_6; // 0x48
	::RPG::GameCore::CommonBoardPuzzleInBoard* Field_2_7; // 0x50
