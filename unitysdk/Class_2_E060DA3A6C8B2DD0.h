...
#define CLASS_2_E060DA3A6C8B2DD0_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB6E0370)
#define CLASS_2_E060DA3A6C8B2DD0_METHOD_2_1290EA767C459179_1_OFFSET UNITYSDK_OFFSET(0xB6E1000)
#define CLASS_2_E060DA3A6C8B2DD0_METHOD_2_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xB6E1130)
#define CLASS_2_E060DA3A6C8B2DD0_METHOD_2_1DF59E6F9D4E273B_OFFSET UNITYSDK_OFFSET(0xB6E0E60)
#define CLASS_2_E060DA3A6C8B2DD0_METHOD_2_41CF9B9431532A25_OFFSET UNITYSDK_OFFSET(0xB6E1210)
#define CLASS_2_E060DA3A6C8B2DD0_METHOD_2_5176DC743E478510_OFFSET UNITYSDK_OFFSET(0xB6E0BA0)
#define CLASS_2_E060DA3A6C8B2DD0_METHOD_2_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0xB6E10E0)
#define CLASS_2_E060DA3A6C8B2DD0_METHOD_2_D7D514A57F13FD3D_OFFSET UNITYSDK_OFFSET(0xB6E09F0)
#define CLASS_2_E060DA3A6C8B2DD0_METHOD_2_DAE67D4DC8B67113_OFFSET UNITYSDK_OFFSET(0xB6E0E10)
#define CLASS_2_E060DA3A6C8B2DD0_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB6E05D0)
#define CLASS_2_E060DA3A6C8B2DD0_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB6E0320)
#define CLASS_2_E060DA3A6C8B2DD0_TICK_OFFSET UNITYSDK_OFFSET(0xB6E02C0)
#define CLASS_2_E060DA3A6C8B2DD0__CTOR_OFFSET UNITYSDK_OFFSET(0xB6E0170)
...
public:
	...
	::Class_3_07C3C4D2990C49EE* JFAMPANPALF; // 0x30
	::RPG::GameCore::PropComponent* BCCLENOIOBD; // 0x38
	::RPG::GameCore::RogueGambleFuncShowUI* JKJPFJALGKO; // 0x40
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x48
	::Class_3_07C3C4D2990C49EE* AFPMOJKPEIC; // 0x50
