...
#define CLASS_1_E1497142ADDE0A20_DISPOSE_OFFSET UNITYSDK_OFFSET(0x178C6900)
#define CLASS_1_E1497142ADDE0A20_METHOD_1_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x178C6BB0)
#define CLASS_1_E1497142ADDE0A20_METHOD_1_365B3CE7026B1EB7_OFFSET UNITYSDK_OFFSET(0x178C6B70)
#define CLASS_1_E1497142ADDE0A20_METHOD_1_475D7AF7572E6782_OFFSET UNITYSDK_OFFSET(0x178C6950)
#define CLASS_1_E1497142ADDE0A20_METHOD_1_76C0FF663C72E0E7_OFFSET UNITYSDK_OFFSET(0x178C6CB0)
#define CLASS_1_E1497142ADDE0A20_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x178C6A90)
#define CLASS_1_E1497142ADDE0A20_METHOD_1_BADDA70ED68283AE_OFFSET UNITYSDK_OFFSET(0x178C6F10)
#define CLASS_1_E1497142ADDE0A20_METHOD_1_C450A961450309C9_OFFSET UNITYSDK_OFFSET(0x178C6C10)
#define CLASS_1_E1497142ADDE0A20_TICK_OFFSET UNITYSDK_OFFSET(0x178C6B00)
#define CLASS_1_E1497142ADDE0A20__CTOR_OFFSET UNITYSDK_OFFSET(0x178C68C0)

inline static constexpr unsigned int Class_1_E1497142ADDE0A20_TypeDefinitionIndex = 56034;
...
public:
	...
	::RPG::GameCore::AdventureSkillCharacterComponent* KBDBKHPNJHC; // 0x20
	::RPG::GameCore::GameEntity* ICHEDAEHEBG; // 0x28
	::System::UInt32 GDMJNMFOKIO; // 0x30
	::RPG::GameCore::AdventureAnimStateType ECLBEOPGDOG; // 0x34
	...
	::System::Void Method_1_76C0FF663C72E0E7(::RPG::GameCore::AdventureAnimStateType a1)
	{
		return ((::System::Void(*)(::PVOID, ::RPG::GameCore::AdventureAnimStateType))((::PBYTE)hIl2Cpp + CLASS_1_E1497142ADDE0A20_METHOD_1_76C0FF663C72E0E7_OFFSET))(this, a1);
	}
