...
#define CLASS_2_D2E857D318656CEC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11854010)
#define CLASS_2_D2E857D318656CEC_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11854050)
#define CLASS_2_D2E857D318656CEC_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x118546F0)
#define CLASS_2_D2E857D318656CEC_TICK_OFFSET UNITYSDK_OFFSET(0x11854740)
#define CLASS_2_D2E857D318656CEC__CTOR_OFFSET UNITYSDK_OFFSET(0x11854000)

inline static constexpr unsigned int Class_2_D2E857D318656CEC_TypeDefinitionIndex = 50940;

class Class_2_D2E857D318656CEC : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::PPFilterStackEffect* Field_2_0; // 0x18
