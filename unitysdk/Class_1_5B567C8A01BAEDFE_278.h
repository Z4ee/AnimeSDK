...
#define CLASS_1_5B567C8A01BAEDFE_278_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A02C7E0)
#define CLASS_1_5B567C8A01BAEDFE_278_CLONE_OFFSET UNITYSDK_OFFSET(0x1A02C650)
#define CLASS_1_5B567C8A01BAEDFE_278_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A02C6F0)
#define CLASS_1_5B567C8A01BAEDFE_278_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A02C690)
#define CLASS_1_5B567C8A01BAEDFE_278_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A02C740)
#define CLASS_1_5B567C8A01BAEDFE_278_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A02C830)
#define CLASS_1_5B567C8A01BAEDFE_278_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A02C800)
#define CLASS_1_5B567C8A01BAEDFE_278_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A02C5D0)
#define CLASS_1_5B567C8A01BAEDFE_278_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A02C600)
#define CLASS_1_5B567C8A01BAEDFE_278_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A02C770)
#define CLASS_1_5B567C8A01BAEDFE_278_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A02C7D0)
#define CLASS_1_5B567C8A01BAEDFE_278__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A02C880)
#define CLASS_1_5B567C8A01BAEDFE_278__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A02C620)
#define CLASS_1_5B567C8A01BAEDFE_278__CTOR_OFFSET UNITYSDK_OFFSET(0x1A02C610)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_278_TypeDefinitionIndex = 30710;

class Class_1_5B567C8A01BAEDFE_278 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_278*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_278*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_278_TypeDefinitionIndex)->GetStaticField(0x2C400);
	}
