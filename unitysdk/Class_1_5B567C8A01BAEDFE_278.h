...
#define CLASS_1_5B567C8A01BAEDFE_278_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19960A00)
#define CLASS_1_5B567C8A01BAEDFE_278_CLONE_OFFSET UNITYSDK_OFFSET(0x19960870)
#define CLASS_1_5B567C8A01BAEDFE_278_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19960910)
#define CLASS_1_5B567C8A01BAEDFE_278_EQUALS_OFFSET UNITYSDK_OFFSET(0x199608B0)
#define CLASS_1_5B567C8A01BAEDFE_278_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19960960)
#define CLASS_1_5B567C8A01BAEDFE_278_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19960A50)
#define CLASS_1_5B567C8A01BAEDFE_278_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19960A20)
#define CLASS_1_5B567C8A01BAEDFE_278_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x199607F0)
#define CLASS_1_5B567C8A01BAEDFE_278_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19960820)
#define CLASS_1_5B567C8A01BAEDFE_278_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19960990)
#define CLASS_1_5B567C8A01BAEDFE_278_WRITETO_OFFSET UNITYSDK_OFFSET(0x199609F0)
#define CLASS_1_5B567C8A01BAEDFE_278__CCTOR_OFFSET UNITYSDK_OFFSET(0x19960AA0)
#define CLASS_1_5B567C8A01BAEDFE_278__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19960840)
#define CLASS_1_5B567C8A01BAEDFE_278__CTOR_OFFSET UNITYSDK_OFFSET(0x19960830)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_278_TypeDefinitionIndex = 30868;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_278*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_278_TypeDefinitionIndex)->GetStaticField(0x61000);
	}
