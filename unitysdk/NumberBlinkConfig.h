...
#define NUMBERBLINKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x179E86D0)

inline static constexpr unsigned int NumberBlinkConfig_TypeDefinitionIndex = 80359;
...
public:
	...
	::NumberBlinkInfos* LeftInfos; // 0x20
