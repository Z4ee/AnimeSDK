...
#define CLASS_2_E05BF61024E5B194_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11E74C60)
#define CLASS_2_E05BF61024E5B194_GET_POSAPDATIONTARGET_OFFSET UNITYSDK_OFFSET(0x11E76340)
#define CLASS_2_E05BF61024E5B194_METHOD_2_1504B1D7C52AC88D_OFFSET UNITYSDK_OFFSET(0x11E75D40)
#define CLASS_2_E05BF61024E5B194_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x11E752F0)
#define CLASS_2_E05BF61024E5B194_METHOD_2_329D75B50DCBA9D5_OFFSET UNITYSDK_OFFSET(0x11E75EF0)
#define CLASS_2_E05BF61024E5B194_METHOD_2_3D78D2E0F9F95F07_OFFSET UNITYSDK_OFFSET(0x11E76290)
#define CLASS_2_E05BF61024E5B194_METHOD_2_79F82AA229668E10_OFFSET UNITYSDK_OFFSET(0x11E75370)
#define CLASS_2_E05BF61024E5B194_METHOD_2_921C3C3E09D59CD4_OFFSET UNITYSDK_OFFSET(0x11E74DE0)
#define CLASS_2_E05BF61024E5B194_METHOD_2_96A53A17AC5D0E93_OFFSET UNITYSDK_OFFSET(0x11E752A0)
#define CLASS_2_E05BF61024E5B194_METHOD_2_AE0258B108DEC531_OFFSET UNITYSDK_OFFSET(0x11E762B0)
#define CLASS_2_E05BF61024E5B194_METHOD_2_B40F084418F05DE4_OFFSET UNITYSDK_OFFSET(0x11E75540)
#define CLASS_2_E05BF61024E5B194_METHOD_2_F0A3E2362C37FB0E_OFFSET UNITYSDK_OFFSET(0x11E74B50)
#define CLASS_2_E05BF61024E5B194_METHOD_2_FA92B3E07A6BA5A6_OFFSET UNITYSDK_OFFSET(0x11E762C0)
#define CLASS_2_E05BF61024E5B194_SET_POSAPDATIONTARGET_OFFSET UNITYSDK_OFFSET(0x11E76350)
#define CLASS_2_E05BF61024E5B194_TICK_OFFSET UNITYSDK_OFFSET(0x11E74CB0)
#define CLASS_2_E05BF61024E5B194__CTOR_OFFSET UNITYSDK_OFFSET(0x11E76360)
...
public:
	...
	{
		return (::Il2CppArray<::UnityEngine::Collider*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_E05BF61024E5B194_TypeDefinitionIndex)->GetStaticField(0x3ACB0);
	}
	::System::Action_1<::Class_2_E05BF61024E5B194*>* GAHEPJKKNMJ; // 0x18
	::System::Action_1<::Class_2_E05BF61024E5B194*>* KMHBOBANHJI; // 0x20
	::RPG::GameCore::CharacterVisibleComponent* JAOPNEJFELA; // 0x28
	::RPG::GameCore::AdventurePositionCheckConfig* IGHAHBNLIJA; // 0x30
	::RPG::GameCore::GameEntity* _PosApdationTarget_k__BackingField; // 0x38
	::RPG::GameCore::TransformComponent* PLJPNMPJMJH; // 0x40
	::RPG::GameCore::CharacterAdventureSomatoType KBLEAJNBLEL; // 0x48
	::System::Int32 CPANBNANIMM; // 0x4C
	::Struct_2_5C05B865B0E3235A_1 ANOCHAPDGFN; // 0x50
	::System::Single LPCKOIGHKLK; // 0x6C
	::UnityEngine::Vector3 AGNNCPBIICH; // 0x70
