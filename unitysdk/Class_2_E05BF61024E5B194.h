...
#define CLASS_2_E05BF61024E5B194_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17686E30)
#define CLASS_2_E05BF61024E5B194_GET_POSAPDATIONTARGET_OFFSET UNITYSDK_OFFSET(0x17688510)
#define CLASS_2_E05BF61024E5B194_METHOD_2_1504B1D7C52AC88D_OFFSET UNITYSDK_OFFSET(0x17687F10)
#define CLASS_2_E05BF61024E5B194_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x176874C0)
#define CLASS_2_E05BF61024E5B194_METHOD_2_329D75B50DCBA9D5_OFFSET UNITYSDK_OFFSET(0x176880C0)
#define CLASS_2_E05BF61024E5B194_METHOD_2_3D78D2E0F9F95F07_OFFSET UNITYSDK_OFFSET(0x17688460)
#define CLASS_2_E05BF61024E5B194_METHOD_2_79F82AA229668E10_OFFSET UNITYSDK_OFFSET(0x17687540)
#define CLASS_2_E05BF61024E5B194_METHOD_2_921C3C3E09D59CD4_OFFSET UNITYSDK_OFFSET(0x17686FB0)
#define CLASS_2_E05BF61024E5B194_METHOD_2_96A53A17AC5D0E93_OFFSET UNITYSDK_OFFSET(0x17687470)
#define CLASS_2_E05BF61024E5B194_METHOD_2_AE0258B108DEC531_OFFSET UNITYSDK_OFFSET(0x17688480)
#define CLASS_2_E05BF61024E5B194_METHOD_2_B40F084418F05DE4_OFFSET UNITYSDK_OFFSET(0x17687710)
#define CLASS_2_E05BF61024E5B194_METHOD_2_F0A3E2362C37FB0E_OFFSET UNITYSDK_OFFSET(0x17686D20)
#define CLASS_2_E05BF61024E5B194_METHOD_2_FA92B3E07A6BA5A6_OFFSET UNITYSDK_OFFSET(0x17688490)
#define CLASS_2_E05BF61024E5B194_SET_POSAPDATIONTARGET_OFFSET UNITYSDK_OFFSET(0x17688520)
#define CLASS_2_E05BF61024E5B194_TICK_OFFSET UNITYSDK_OFFSET(0x17686E80)
#define CLASS_2_E05BF61024E5B194__CTOR_OFFSET UNITYSDK_OFFSET(0x17688530)

inline static constexpr unsigned int Class_2_E05BF61024E5B194_TypeDefinitionIndex = 54798;
...
public:
	...
	{
		return (::Il2CppArray<::UnityEngine::Collider*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_E05BF61024E5B194_TypeDefinitionIndex)->GetStaticField(0x6BF90);
	}
	::RPG::GameCore::GameEntity* _PosApdationTarget_k__BackingField; // 0x18
	::RPG::GameCore::TransformComponent* Field_2_2; // 0x20
	::RPG::GameCore::CharacterVisibleComponent* Field_2_3; // 0x28
	::RPG::GameCore::AdventurePositionCheckConfig* Field_2_4; // 0x30
	::System::Action_1<::Class_2_E05BF61024E5B194*>* Field_2_5; // 0x38
	::System::Action_1<::Class_2_E05BF61024E5B194*>* Field_2_6; // 0x40
	::System::Single Field_2_7; // 0x48
	::RPG::GameCore::CharacterAdventureSomatoType Field_2_8; // 0x4C
	::Struct_2_5C05B865B0E3235A_1 Field_2_9; // 0x50
