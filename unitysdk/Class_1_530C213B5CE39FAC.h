...
#define CLASS_1_530C213B5CE39FAC_GET_MIRACLE_OFFSET UNITYSDK_OFFSET(0x12AF31C0)
#define CLASS_1_530C213B5CE39FAC_GET_SOURCE_OFFSET UNITYSDK_OFFSET(0x12AF31D0)
#define CLASS_1_530C213B5CE39FAC_TOSTRING_OFFSET UNITYSDK_OFFSET(0x12AF3060)
#define CLASS_1_530C213B5CE39FAC_TRIGGERACTION_OFFSET UNITYSDK_OFFSET(0x12AF3100)
#define CLASS_1_530C213B5CE39FAC__CTOR_OFFSET UNITYSDK_OFFSET(0x12AF3050)
#define CLASS_1_530C213B5CE39FAC___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x12AF31E0)

inline static constexpr unsigned int Class_1_530C213B5CE39FAC_TypeDefinitionIndex = 61724;
