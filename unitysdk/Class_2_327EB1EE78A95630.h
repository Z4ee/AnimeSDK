...
#define CLASS_2_327EB1EE78A95630_DISPOSE_OFFSET UNITYSDK_OFFSET(0xE2C26E0)
#define CLASS_2_327EB1EE78A95630_METHOD_2_047D34745A4B98A3_OFFSET UNITYSDK_OFFSET(0xE2C40E0)
#define CLASS_2_327EB1EE78A95630_METHOD_2_05A2973E25A926AB_OFFSET UNITYSDK_OFFSET(0xE2C2E40)
#define CLASS_2_327EB1EE78A95630_METHOD_2_0B7E3489D2C0938B_OFFSET UNITYSDK_OFFSET(0xE2C3D10)
#define CLASS_2_327EB1EE78A95630_METHOD_2_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xE2C3950)
#define CLASS_2_327EB1EE78A95630_METHOD_2_2917BB48A903B3F0_OFFSET UNITYSDK_OFFSET(0xE2C2EB0)
#define CLASS_2_327EB1EE78A95630_METHOD_2_30A2382C3FCC5386_OFFSET UNITYSDK_OFFSET(0xE2C28D0)
#define CLASS_2_327EB1EE78A95630_METHOD_2_3422201382CE593B_1_OFFSET UNITYSDK_OFFSET(0xE2C4720)
#define CLASS_2_327EB1EE78A95630_METHOD_2_3422201382CE593B_OFFSET UNITYSDK_OFFSET(0xE2C4680)
#define CLASS_2_327EB1EE78A95630_METHOD_2_39590AB2089F9F4D_OFFSET UNITYSDK_OFFSET(0xE2C3300)
#define CLASS_2_327EB1EE78A95630_METHOD_2_40082CAD46FBE80F_OFFSET UNITYSDK_OFFSET(0xE2C47C0)
#define CLASS_2_327EB1EE78A95630_METHOD_2_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0xE2C33B0)
#define CLASS_2_327EB1EE78A95630_METHOD_2_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0xE2C37E0)
#define CLASS_2_327EB1EE78A95630_METHOD_2_5FBAD89A54D9F070_OFFSET UNITYSDK_OFFSET(0xE2C27E0)
#define CLASS_2_327EB1EE78A95630_METHOD_2_79C171A8034611D5_OFFSET UNITYSDK_OFFSET(0xE2C3A20)
#define CLASS_2_327EB1EE78A95630_METHOD_2_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xE2C3670)
#define CLASS_2_327EB1EE78A95630_METHOD_2_9CA35E5BF1A50E77_OFFSET UNITYSDK_OFFSET(0xE2C3A90)
#define CLASS_2_327EB1EE78A95630_METHOD_2_A9F6594EA869CA9D_OFFSET UNITYSDK_OFFSET(0xE2C3BB0)
#define CLASS_2_327EB1EE78A95630_METHOD_2_B1EB734337965E73_OFFSET UNITYSDK_OFFSET(0xE2C2670)
#define CLASS_2_327EB1EE78A95630_METHOD_2_BC0FA8C838B766A1_OFFSET UNITYSDK_OFFSET(0xE2C2D50)
#define CLASS_2_327EB1EE78A95630_METHOD_2_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0xE2C2BA0)
#define CLASS_2_327EB1EE78A95630__CCTOR_OFFSET UNITYSDK_OFFSET(0xE2C48B0)
#define CLASS_2_327EB1EE78A95630__CTOR_OFFSET UNITYSDK_OFFSET(0xE2C48A0)

inline static constexpr unsigned int Class_2_327EB1EE78A95630_TypeDefinitionIndex = 69873;

class Class_2_327EB1EE78A95630 : public ::RPG::Client::BehaviorBase
{
public:
	static ::UnityEngine::Vector2* StaticGet_GDLJCEMLNMN()
	{
		return (::UnityEngine::Vector2*)Il2CppClass::FromTypeDefinitionIndex(Class_2_327EB1EE78A95630_TypeDefinitionIndex)->GetStaticField(0x15580);
	}
	::UnityEngine::RectTransform* OIGGFCOBKCG; // 0x18
	::UnityEngine::MeshRenderer* BPDNHCHACII; // 0x20
	::UnityEngine::Camera* DMBMOHJLNEN; // 0x28
	::UnityEngine::Vector3 JJCCINGEOKI; // 0x30
	::UnityEngine::Vector3 KINACPIEDJH; // 0x3C
	::UnityEngine::Vector3 OANHPPNGGAF; // 0x48
	::System::Boolean PIPLLENMLIM; // 0x54
	::System::Boolean GLFDHPDMJJP; // 0x55
