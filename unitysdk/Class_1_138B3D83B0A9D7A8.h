...
#define CLASS_1_138B3D83B0A9D7A8_DELTATIMEWITHIGNOREINDEX_OFFSET UNITYSDK_OFFSET(0x1786AAF0)
#define CLASS_1_138B3D83B0A9D7A8_DELTATIME_OFFSET UNITYSDK_OFFSET(0x1786AA40)
#define CLASS_1_138B3D83B0A9D7A8_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1786AF60)
#define CLASS_1_138B3D83B0A9D7A8_FIXEDDELTATIME_OFFSET UNITYSDK_OFFSET(0x1786A930)
#define CLASS_1_138B3D83B0A9D7A8_METHOD_1_230FE7F4B4EA88A5_OFFSET UNITYSDK_OFFSET(0x1786AB70)
#define CLASS_1_138B3D83B0A9D7A8_TIMESCALE_OFFSET UNITYSDK_OFFSET(0x1786A9E0)
#define CLASS_1_138B3D83B0A9D7A8__CTOR_OFFSET UNITYSDK_OFFSET(0x1786A920)

inline static constexpr unsigned int Class_1_138B3D83B0A9D7A8_TypeDefinitionIndex = 72930;
