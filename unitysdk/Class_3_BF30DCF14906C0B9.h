...
#define CLASS_3_BF30DCF14906C0B9_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA7FD8B0)
#define CLASS_3_BF30DCF14906C0B9_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA7FD930)
#define CLASS_3_BF30DCF14906C0B9_INVOKE_OFFSET UNITYSDK_OFFSET(0xA7FD8A0)
#define CLASS_3_BF30DCF14906C0B9__CTOR_OFFSET UNITYSDK_OFFSET(0xA7FD830)

inline static constexpr unsigned int Class_3_BF30DCF14906C0B9_TypeDefinitionIndex = 68581;
