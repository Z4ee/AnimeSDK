...
#define CLASS_3_BF30DCF14906C0B9_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16B29FD0)
#define CLASS_3_BF30DCF14906C0B9_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16B2A050)
#define CLASS_3_BF30DCF14906C0B9_INVOKE_OFFSET UNITYSDK_OFFSET(0x16B29FC0)
#define CLASS_3_BF30DCF14906C0B9__CTOR_OFFSET UNITYSDK_OFFSET(0x16B29F50)

inline static constexpr unsigned int Class_3_BF30DCF14906C0B9_TypeDefinitionIndex = 73377;
