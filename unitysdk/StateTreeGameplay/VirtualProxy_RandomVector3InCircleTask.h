...
#define STATETREEGAMEPLAY_VIRTUALPROXY_RANDOMVECTOR3INCIRCLETASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x1CC190F0)
#define STATETREEGAMEPLAY_VIRTUALPROXY_RANDOMVECTOR3INCIRCLETASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x1CC19090)
#define STATETREEGAMEPLAY_VIRTUALPROXY_RANDOMVECTOR3INCIRCLETASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC19160)

namespace StateTreeGameplay
{
	inline static constexpr unsigned int VirtualProxy_RandomVector3InCircleTask_TypeDefinitionIndex = 41296;
