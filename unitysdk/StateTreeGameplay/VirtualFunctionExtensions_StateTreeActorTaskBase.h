...
#define STATETREEGAMEPLAY_VIRTUALFUNCTIONEXTENSIONS_STATETREEACTORTASKBASE_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x1AEAB300)
#define STATETREEGAMEPLAY_VIRTUALFUNCTIONEXTENSIONS_STATETREEACTORTASKBASE_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x1AEAB390)
#define STATETREEGAMEPLAY_VIRTUALFUNCTIONEXTENSIONS_STATETREEACTORTASKBASE_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0x1AEAB450)
#define STATETREEGAMEPLAY_VIRTUALFUNCTIONEXTENSIONS_STATETREEACTORTASKBASE_TICK_OFFSET UNITYSDK_OFFSET(0x1AEAB510)
#define STATETREEGAMEPLAY_VIRTUALFUNCTIONEXTENSIONS_STATETREEACTORTASKBASE_TRIGGERTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x1AEAB5A0)

namespace StateTreeGameplay
{
	inline static constexpr unsigned int VirtualFunctionExtensions_StateTreeActorTaskBase_TypeDefinitionIndex = 65666;
