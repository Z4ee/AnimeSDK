...
#define STATETREEGAMEPLAY_VIRTUALPROXY_PLAYANIMATIONTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x1BF4FC90)
#define STATETREEGAMEPLAY_VIRTUALPROXY_PLAYANIMATIONTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x1BF4FC30)
#define STATETREEGAMEPLAY_VIRTUALPROXY_PLAYANIMATIONTASK_TICK_OFFSET UNITYSDK_OFFSET(0x1BF4FD00)
#define STATETREEGAMEPLAY_VIRTUALPROXY_PLAYANIMATIONTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF4FD80)

namespace StateTreeGameplay
{
	inline static constexpr unsigned int VirtualProxy_PlayAnimationTask_TypeDefinitionIndex = 76014;
