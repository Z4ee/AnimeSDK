...
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x591C80)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x732F40)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_CREATE_OFFSET UNITYSDK_OFFSET(0x1AEAA1A0)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x8B90F0)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x1AEA95B0)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x1AEA9510)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4109D0)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x410AF0)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x410A60)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x3E3DA0)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x591890)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x4108C0)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x410830)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x591800)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x591770)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x4107A0)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x8B8AC0)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x8B9110)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x591920)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x8B8AB0)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x591C80)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x732F40)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_RESET_OFFSET UNITYSDK_OFFSET(0x591CC0)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x8B8F20)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x8B9020)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x8B8FA0)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x8B8EA0)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x8B8DA0)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x8B8C20)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x8B8BA0)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x8B8D20)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x8B8CA0)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x8B8B20)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x8B8E20)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x8B8A30)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_TICK_OFFSET UNITYSDK_OFFSET(0x1AEA9760)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK_UNREALTYPES_ISTRUCT_STATETREEGAMEPLAY_MOVETOPOSITIONTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x8B9170)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AEAA610)

namespace StateTreeGameplay
{
	inline static constexpr unsigned int MoveToPositionTask_TypeDefinitionIndex = 49973;

	struct alignas(4) MoveToPositionTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(MoveToPositionTask_TypeDefinitionIndex)->GetStaticField(0x3D410);
		}
