...
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x7E39D0)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_CREATE_OFFSET UNITYSDK_OFFSET(0x1EC67FA0)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0xA68AB0)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x1EC67770)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x1EC677C0)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4635B0)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x425400)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x463640)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x41E4D0)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x463410)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x463260)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x4631D0)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x463380)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x4632F0)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x42ABB0)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0xA686B0)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xA68AD0)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x4634A0)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x325570)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0xA686A0)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x7E39D0)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_RESET_OFFSET UNITYSDK_OFFSET(0x463850)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0xA68990)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0xA68A30)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0xA689E0)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_SET_NAME_OFFSET UNITYSDK_OFFSET(0xA68940)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0xA688A0)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0xA687B0)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0xA68760)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0xA68850)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0xA68800)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0xA68710)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0xA688F0)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0xA68650)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0x1EC67810)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_TICK_OFFSET UNITYSDK_OFFSET(0x1EC67870)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_TRIGGERTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x1EC678D0)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE_UNREALTYPES_ISTRUCT_STATETREEGAMEPLAY_STATETREECOMMONTASKBASE__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA68B30)
#define STATETREEGAMEPLAY_STATETREECOMMONTASKBASE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EC683D0)

namespace StateTreeGameplay
{
	inline static constexpr unsigned int StateTreeCommonTaskBase_TypeDefinitionIndex = 43975;

	struct alignas(4) StateTreeCommonTaskBase
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeCommonTaskBase_TypeDefinitionIndex)->GetStaticField(0x49830);
		}
