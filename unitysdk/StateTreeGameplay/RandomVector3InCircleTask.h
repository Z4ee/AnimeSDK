...
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x7E39D0)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_CREATE_OFFSET UNITYSDK_OFFSET(0x1BC40CA0)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x8D8660)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x1BC402E0)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x1BC40240)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4635B0)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x425400)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x463640)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x41E4D0)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x463410)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x463260)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x4631D0)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x463380)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x4632F0)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x42ABB0)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x8D8030)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x8D8680)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x4634A0)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x325570)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x8D8020)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x463810)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x7E39D0)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_RESET_OFFSET UNITYSDK_OFFSET(0x463850)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x8D8490)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x8D8590)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x8D8510)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x8D8410)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x8D8310)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x8D8190)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x8D8110)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x8D8290)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x8D8210)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x8D8090)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x8D8390)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x8D7FA0)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK_UNREALTYPES_ISTRUCT_STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x8D86E0)
#define STATETREEGAMEPLAY_RANDOMVECTOR3INCIRCLETASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BC41110)

namespace StateTreeGameplay
{
	inline static constexpr unsigned int RandomVector3InCircleTask_TypeDefinitionIndex = 84775;

	struct alignas(4) RandomVector3InCircleTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(RandomVector3InCircleTask_TypeDefinitionIndex)->GetStaticField(0x437E0);
		}
