...
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASKINSTANCEDATA_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x879F00)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASKINSTANCEDATA_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x879EE0)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASKINSTANCEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1AEAA730)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASKINSTANCEDATA_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x8B9260)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASKINSTANCEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASKINSTANCEDATA_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x8B9200)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASKINSTANCEDATA_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x8B9340)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASKINSTANCEDATA_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x879F00)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASKINSTANCEDATA_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x879EE0)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASKINSTANCEDATA_RESET_OFFSET UNITYSDK_OFFSET(0x8B92D0)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASKINSTANCEDATA_UNREALTYPES_ISTRUCT_STATETREEGAMEPLAY_MOVETOPOSITIONTASKINSTANCEDATA__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x8B93A0)
#define STATETREEGAMEPLAY_MOVETOPOSITIONTASKINSTANCEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AEAA970)

namespace StateTreeGameplay
{
	inline static constexpr unsigned int MoveToPositionTaskInstanceData_TypeDefinitionIndex = 41504;

	struct alignas(4) MoveToPositionTaskInstanceData
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(MoveToPositionTaskInstanceData_TypeDefinitionIndex)->GetStaticField(0x3D420);
		}
