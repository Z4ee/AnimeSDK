...
#define STATETREEGAMEPLAY_VIRTUALPROXY_RANDOMVECTOR3INSPHERETASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x1BB28EF0)
#define STATETREEGAMEPLAY_VIRTUALPROXY_RANDOMVECTOR3INSPHERETASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x1BB28E90)
#define STATETREEGAMEPLAY_VIRTUALPROXY_RANDOMVECTOR3INSPHERETASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB28F60)

namespace StateTreeGameplay
{
	inline static constexpr unsigned int VirtualProxy_RandomVector3InSphereTask_TypeDefinitionIndex = 45790;
