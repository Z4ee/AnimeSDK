...
#define STATETREEGAMEPLAY_ACTORSCHEMACONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1CB727C0)
#define STATETREEGAMEPLAY_ACTORSCHEMACONVERTER_ENSURERUNTIMEINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1CB72980)
#define STATETREEGAMEPLAY_ACTORSCHEMACONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1CB723A0)
#define STATETREEGAMEPLAY_ACTORSCHEMACONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1CB72120)
#define STATETREEGAMEPLAY_ACTORSCHEMACONVERTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CB72830)
#define STATETREEGAMEPLAY_ACTORSCHEMACONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB72970)

namespace StateTreeGameplay
{
	inline static constexpr unsigned int ActorSchemaConverter_TypeDefinitionIndex = 87277;
