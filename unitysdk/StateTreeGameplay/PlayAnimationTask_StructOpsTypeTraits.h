...
#define STATETREEGAMEPLAY_PLAYANIMATIONTASK_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0x1BF4F8D0)
#define STATETREEGAMEPLAY_PLAYANIMATIONTASK_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF4F8E0)

namespace StateTreeGameplay
{
	inline static constexpr unsigned int PlayAnimationTask_StructOpsTypeTraits_TypeDefinitionIndex = 70925;
