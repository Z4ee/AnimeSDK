...
#define STATETREEGAMEPLAY_RANDOMVECTOR3TASKINSTANCEDATA_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9AE860)
#define STATETREEGAMEPLAY_RANDOMVECTOR3TASKINSTANCEDATA_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9AE830)
#define STATETREEGAMEPLAY_RANDOMVECTOR3TASKINSTANCEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1CC18960)
#define STATETREEGAMEPLAY_RANDOMVECTOR3TASKINSTANCEDATA_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9AE820)
#define STATETREEGAMEPLAY_RANDOMVECTOR3TASKINSTANCEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define STATETREEGAMEPLAY_RANDOMVECTOR3TASKINSTANCEDATA_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x9AE7C0)
#define STATETREEGAMEPLAY_RANDOMVECTOR3TASKINSTANCEDATA_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9AE8A0)
#define STATETREEGAMEPLAY_RANDOMVECTOR3TASKINSTANCEDATA_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9AE860)
#define STATETREEGAMEPLAY_RANDOMVECTOR3TASKINSTANCEDATA_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9AE830)
#define STATETREEGAMEPLAY_RANDOMVECTOR3TASKINSTANCEDATA_RESET_OFFSET UNITYSDK_OFFSET(0x9AE890)
#define STATETREEGAMEPLAY_RANDOMVECTOR3TASKINSTANCEDATA_UNREALTYPES_ISTRUCT_STATETREEGAMEPLAY_RANDOMVECTOR3TASKINSTANCEDATA__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9AE900)
#define STATETREEGAMEPLAY_RANDOMVECTOR3TASKINSTANCEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CC18B30)

namespace StateTreeGameplay
{
	inline static constexpr unsigned int RandomVector3TaskInstanceData_TypeDefinitionIndex = 80147;

	struct alignas(4) RandomVector3TaskInstanceData
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(RandomVector3TaskInstanceData_TypeDefinitionIndex)->GetStaticField(0x38800);
		}
