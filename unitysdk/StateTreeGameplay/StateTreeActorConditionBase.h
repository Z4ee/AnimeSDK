...
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x410C50)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x695C90)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_CREATE_OFFSET UNITYSDK_OFFSET(0x1B5A8300)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x912D00)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x4109D0)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_GET_DELTAINDENT_OFFSET UNITYSDK_OFFSET(0x410830)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_GET_EVALUATIONMODE_OFFSET UNITYSDK_OFFSET(0x4108C0)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x410AF0)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x410A60)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x3E3DA0)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_GET_OPERAND_OFFSET UNITYSDK_OFFSET(0x4107A0)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x912A40)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x912D20)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x912A30)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x410C50)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x695C90)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_RESET_OFFSET UNITYSDK_OFFSET(0x410C90)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x912BE0)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_SET_DELTAINDENT_OFFSET UNITYSDK_OFFSET(0x912AF0)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_SET_EVALUATIONMODE_OFFSET UNITYSDK_OFFSET(0x912B40)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x912C80)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x912C30)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x912B90)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_SET_OPERAND_OFFSET UNITYSDK_OFFSET(0x912AA0)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x9129E0)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0x1B5A7DB0)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE_UNREALTYPES_ISTRUCT_STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x912D80)
#define STATETREEGAMEPLAY_STATETREEACTORCONDITIONBASE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B5A8730)

namespace StateTreeGameplay
{
	inline static constexpr unsigned int StateTreeActorConditionBase_TypeDefinitionIndex = 57195;

	struct alignas(4) StateTreeActorConditionBase
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeActorConditionBase_TypeDefinitionIndex)->GetStaticField(0x4D050);
		}
