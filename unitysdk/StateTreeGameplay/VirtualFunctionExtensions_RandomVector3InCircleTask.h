...
#define STATETREEGAMEPLAY_VIRTUALFUNCTIONEXTENSIONS_RANDOMVECTOR3INCIRCLETASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x1F1CAFB0)
#define STATETREEGAMEPLAY_VIRTUALFUNCTIONEXTENSIONS_RANDOMVECTOR3INCIRCLETASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x1F1CAF30)

namespace StateTreeGameplay
{
	inline static constexpr unsigned int VirtualFunctionExtensions_RandomVector3InCircleTask_TypeDefinitionIndex = 73366;
