...
#define STATETREEGAMEPLAY_DELAYSECONDSTASKINSTANCEDATA_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x591FD0)
#define STATETREEGAMEPLAY_DELAYSECONDSTASKINSTANCEDATA_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define STATETREEGAMEPLAY_DELAYSECONDSTASKINSTANCEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x19E37400)
#define STATETREEGAMEPLAY_DELAYSECONDSTASKINSTANCEDATA_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x86F1C0)
#define STATETREEGAMEPLAY_DELAYSECONDSTASKINSTANCEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define STATETREEGAMEPLAY_DELAYSECONDSTASKINSTANCEDATA_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x86F160)
#define STATETREEGAMEPLAY_DELAYSECONDSTASKINSTANCEDATA_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x86F1E0)
#define STATETREEGAMEPLAY_DELAYSECONDSTASKINSTANCEDATA_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x591FD0)
#define STATETREEGAMEPLAY_DELAYSECONDSTASKINSTANCEDATA_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define STATETREEGAMEPLAY_DELAYSECONDSTASKINSTANCEDATA_RESET_OFFSET UNITYSDK_OFFSET(0x86F1D0)
#define STATETREEGAMEPLAY_DELAYSECONDSTASKINSTANCEDATA_UNREALTYPES_ISTRUCT_STATETREEGAMEPLAY_DELAYSECONDSTASKINSTANCEDATA__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x86F240)
#define STATETREEGAMEPLAY_DELAYSECONDSTASKINSTANCEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x19E37530)

namespace StateTreeGameplay
{
	inline static constexpr unsigned int DelaySecondsTaskInstanceData_TypeDefinitionIndex = 46173;

	struct alignas(4) DelaySecondsTaskInstanceData
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(DelaySecondsTaskInstanceData_TypeDefinitionIndex)->GetStaticField(0x3AE80);
		}
