...
#define STATETREEGAMEPLAY_VIRTUALFUNCTIONEXTENSIONS_STATETREECOMMONTASKBASE_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x1A515B80)
#define STATETREEGAMEPLAY_VIRTUALFUNCTIONEXTENSIONS_STATETREECOMMONTASKBASE_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x1A515C10)
#define STATETREEGAMEPLAY_VIRTUALFUNCTIONEXTENSIONS_STATETREECOMMONTASKBASE_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0x1A515CD0)
#define STATETREEGAMEPLAY_VIRTUALFUNCTIONEXTENSIONS_STATETREECOMMONTASKBASE_TICK_OFFSET UNITYSDK_OFFSET(0x1A515D90)
#define STATETREEGAMEPLAY_VIRTUALFUNCTIONEXTENSIONS_STATETREECOMMONTASKBASE_TRIGGERTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x1A515E20)

namespace StateTreeGameplay
{
	inline static constexpr unsigned int VirtualFunctionExtensions_StateTreeCommonTaskBase_TypeDefinitionIndex = 57158;
