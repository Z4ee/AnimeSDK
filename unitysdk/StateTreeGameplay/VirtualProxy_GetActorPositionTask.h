...
#define STATETREEGAMEPLAY_VIRTUALPROXY_GETACTORPOSITIONTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x11EB18D0)
#define STATETREEGAMEPLAY_VIRTUALPROXY_GETACTORPOSITIONTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x11EB1870)
#define STATETREEGAMEPLAY_VIRTUALPROXY_GETACTORPOSITIONTASK_TICK_OFFSET UNITYSDK_OFFSET(0x11EB1940)
#define STATETREEGAMEPLAY_VIRTUALPROXY_GETACTORPOSITIONTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x11EB19C0)

namespace StateTreeGameplay
{
	inline static constexpr unsigned int VirtualProxy_GetActorPositionTask_TypeDefinitionIndex = 47932;
