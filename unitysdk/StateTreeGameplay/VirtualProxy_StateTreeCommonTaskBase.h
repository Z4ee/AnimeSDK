...
#define STATETREEGAMEPLAY_VIRTUALPROXY_STATETREECOMMONTASKBASE_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x1D33E560)
#define STATETREEGAMEPLAY_VIRTUALPROXY_STATETREECOMMONTASKBASE_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x1D33E600)
#define STATETREEGAMEPLAY_VIRTUALPROXY_STATETREECOMMONTASKBASE_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0x1D33E6A0)
#define STATETREEGAMEPLAY_VIRTUALPROXY_STATETREECOMMONTASKBASE_TICK_OFFSET UNITYSDK_OFFSET(0x1D33E740)
#define STATETREEGAMEPLAY_VIRTUALPROXY_STATETREECOMMONTASKBASE_TRIGGERTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x1D33E7F0)
#define STATETREEGAMEPLAY_VIRTUALPROXY_STATETREECOMMONTASKBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D33E890)

namespace StateTreeGameplay
{
	inline static constexpr unsigned int VirtualProxy_StateTreeCommonTaskBase_TypeDefinitionIndex = 59368;
