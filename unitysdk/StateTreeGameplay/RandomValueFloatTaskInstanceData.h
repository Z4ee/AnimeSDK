...
#define STATETREEGAMEPLAY_RANDOMVALUEFLOATTASKINSTANCEDATA_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x591FD0)
#define STATETREEGAMEPLAY_RANDOMVALUEFLOATTASKINSTANCEDATA_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define STATETREEGAMEPLAY_RANDOMVALUEFLOATTASKINSTANCEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1BF4F950)
#define STATETREEGAMEPLAY_RANDOMVALUEFLOATTASKINSTANCEDATA_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x332AB0)
#define STATETREEGAMEPLAY_RANDOMVALUEFLOATTASKINSTANCEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define STATETREEGAMEPLAY_RANDOMVALUEFLOATTASKINSTANCEDATA_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x9491D0)
#define STATETREEGAMEPLAY_RANDOMVALUEFLOATTASKINSTANCEDATA_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x949230)
#define STATETREEGAMEPLAY_RANDOMVALUEFLOATTASKINSTANCEDATA_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x591FD0)
#define STATETREEGAMEPLAY_RANDOMVALUEFLOATTASKINSTANCEDATA_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define STATETREEGAMEPLAY_RANDOMVALUEFLOATTASKINSTANCEDATA_RESET_OFFSET UNITYSDK_OFFSET(0x3E1930)
#define STATETREEGAMEPLAY_RANDOMVALUEFLOATTASKINSTANCEDATA_UNREALTYPES_ISTRUCT_STATETREEGAMEPLAY_RANDOMVALUEFLOATTASKINSTANCEDATA__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x949290)
#define STATETREEGAMEPLAY_RANDOMVALUEFLOATTASKINSTANCEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BF4FA80)

namespace StateTreeGameplay
{
	inline static constexpr unsigned int RandomValueFloatTaskInstanceData_TypeDefinitionIndex = 81373;

	struct alignas(4) RandomValueFloatTaskInstanceData
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(RandomValueFloatTaskInstanceData_TypeDefinitionIndex)->GetStaticField(0x47230);
		}
