...
#define STATETREEGAMEPLAY_GETACTORPOSITIONTASKINSTANCEDATA_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x90B890)
#define STATETREEGAMEPLAY_GETACTORPOSITIONTASKINSTANCEDATA_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x90B870)
#define STATETREEGAMEPLAY_GETACTORPOSITIONTASKINSTANCEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1C3E8C50)
#define STATETREEGAMEPLAY_GETACTORPOSITIONTASKINSTANCEDATA_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x90B800)
#define STATETREEGAMEPLAY_GETACTORPOSITIONTASKINSTANCEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define STATETREEGAMEPLAY_GETACTORPOSITIONTASKINSTANCEDATA_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x90B7A0)
#define STATETREEGAMEPLAY_GETACTORPOSITIONTASKINSTANCEDATA_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x90B920)
#define STATETREEGAMEPLAY_GETACTORPOSITIONTASKINSTANCEDATA_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x90B890)
#define STATETREEGAMEPLAY_GETACTORPOSITIONTASKINSTANCEDATA_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x90B870)
#define STATETREEGAMEPLAY_GETACTORPOSITIONTASKINSTANCEDATA_RESET_OFFSET UNITYSDK_OFFSET(0x90B8B0)
#define STATETREEGAMEPLAY_GETACTORPOSITIONTASKINSTANCEDATA_UNREALTYPES_ISTRUCT_STATETREEGAMEPLAY_GETACTORPOSITIONTASKINSTANCEDATA__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x90B980)
#define STATETREEGAMEPLAY_GETACTORPOSITIONTASKINSTANCEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C3E8E90)

namespace StateTreeGameplay
{
	inline static constexpr unsigned int GetActorPositionTaskInstanceData_TypeDefinitionIndex = 61494;

	struct alignas(4) GetActorPositionTaskInstanceData
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(GetActorPositionTaskInstanceData_TypeDefinitionIndex)->GetStaticField(0x51D40);
		}
