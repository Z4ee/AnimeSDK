...
#define STATETREEGAMEPLAY_VIRTUALPROXY_SENDGRAPHEVENTTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x1C6AAAD0)
#define STATETREEGAMEPLAY_VIRTUALPROXY_SENDGRAPHEVENTTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x1C6AAA70)
#define STATETREEGAMEPLAY_VIRTUALPROXY_SENDGRAPHEVENTTASK_TICK_OFFSET UNITYSDK_OFFSET(0x1C6AAB40)
#define STATETREEGAMEPLAY_VIRTUALPROXY_SENDGRAPHEVENTTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6AABF0)

namespace StateTreeGameplay
{
	inline static constexpr unsigned int VirtualProxy_SendGraphEventTask_TypeDefinitionIndex = 67605;
