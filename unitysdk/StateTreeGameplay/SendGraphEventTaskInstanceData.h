...
#define STATETREEGAMEPLAY_SENDGRAPHEVENTTASKINSTANCEDATA_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9A0090)
#define STATETREEGAMEPLAY_SENDGRAPHEVENTTASKINSTANCEDATA_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9A0070)
#define STATETREEGAMEPLAY_SENDGRAPHEVENTTASKINSTANCEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1CB75940)
#define STATETREEGAMEPLAY_SENDGRAPHEVENTTASKINSTANCEDATA_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9A0000)
#define STATETREEGAMEPLAY_SENDGRAPHEVENTTASKINSTANCEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define STATETREEGAMEPLAY_SENDGRAPHEVENTTASKINSTANCEDATA_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x99FFA0)
#define STATETREEGAMEPLAY_SENDGRAPHEVENTTASKINSTANCEDATA_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9A0110)
#define STATETREEGAMEPLAY_SENDGRAPHEVENTTASKINSTANCEDATA_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9A0090)
#define STATETREEGAMEPLAY_SENDGRAPHEVENTTASKINSTANCEDATA_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9A0070)
#define STATETREEGAMEPLAY_SENDGRAPHEVENTTASKINSTANCEDATA_RESET_OFFSET UNITYSDK_OFFSET(0x9A00A0)
#define STATETREEGAMEPLAY_SENDGRAPHEVENTTASKINSTANCEDATA_UNREALTYPES_ISTRUCT_STATETREEGAMEPLAY_SENDGRAPHEVENTTASKINSTANCEDATA__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9A0170)
#define STATETREEGAMEPLAY_SENDGRAPHEVENTTASKINSTANCEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CB75B50)

namespace StateTreeGameplay
{
	inline static constexpr unsigned int SendGraphEventTaskInstanceData_TypeDefinitionIndex = 48055;

	struct alignas(4) SendGraphEventTaskInstanceData
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(SendGraphEventTaskInstanceData_TypeDefinitionIndex)->GetStaticField(0x4C430);
		}
