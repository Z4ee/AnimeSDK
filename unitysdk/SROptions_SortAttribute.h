...
#define SROPTIONS_SORTATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFEB230)

inline static constexpr unsigned int SROptions_SortAttribute_TypeDefinitionIndex = 44787;
