...
#define CLASS_1_3DD471F282DD1D78_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E4F6B60)
#define CLASS_1_3DD471F282DD1D78_CLONE_OFFSET UNITYSDK_OFFSET(0x1E4F67D0)
#define CLASS_1_3DD471F282DD1D78_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E4F6950)
#define CLASS_1_3DD471F282DD1D78_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E4F6860)
#define CLASS_1_3DD471F282DD1D78_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E4F6A40)
#define CLASS_1_3DD471F282DD1D78_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E4F6C20)
#define CLASS_1_3DD471F282DD1D78_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E4F6BD0)
#define CLASS_1_3DD471F282DD1D78_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E4F66F0)
#define CLASS_1_3DD471F282DD1D78_METHOD_1_AA415D46E3167651_OFFSET UNITYSDK_OFFSET(0x1E4F6850)
#define CLASS_1_3DD471F282DD1D78_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E4F6720)
#define CLASS_1_3DD471F282DD1D78_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E4F6A80)
#define CLASS_1_3DD471F282DD1D78_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E4F6AE0)
#define CLASS_1_3DD471F282DD1D78__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E4F6DB0)
#define CLASS_1_3DD471F282DD1D78__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E4F6760)
#define CLASS_1_3DD471F282DD1D78__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4F6730)

inline static constexpr unsigned int Class_1_3DD471F282DD1D78_TypeDefinitionIndex = 32382;

class Class_1_3DD471F282DD1D78 : public ::System::Object
{
public:
	static ::Google::Protobuf::Collections::MapField_2_Codec<::System::UInt32, ::System::Boolean>** StaticGet_HEGMHPIKOOA()
	{
		return (::Google::Protobuf::Collections::MapField_2_Codec<::System::UInt32, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_3DD471F282DD1D78_TypeDefinitionIndex)->GetStaticField(0x208B0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_3DD471F282DD1D78*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_3DD471F282DD1D78*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_3DD471F282DD1D78_TypeDefinitionIndex)->GetStaticField(0x208B8);
	}
	// static const ::System::Int32 KKIOOJPEPJP = 0xB; // 0x0
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x10
	::Google::Protobuf::Collections::MapField_2<::System::UInt32, ::System::Boolean>* BPKJDEGKECP; // 0x18
