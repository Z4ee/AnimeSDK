...
#define CLASS_2_B9EF300C0A792A54_METHOD_2_C6998EF7892A3ACC_OFFSET UNITYSDK_OFFSET(0x1521F560)
#define CLASS_2_B9EF300C0A792A54_METHOD_2_F0D9B6AAFF504D87_OFFSET UNITYSDK_OFFSET(0x1521EDC0)
#define CLASS_2_B9EF300C0A792A54_METHOD_2_F7DA1F2BF31C250A_OFFSET UNITYSDK_OFFSET(0x1521FC10)
#define CLASS_2_B9EF300C0A792A54__CTOR_OFFSET UNITYSDK_OFFSET(0x1521ED90)

inline static constexpr unsigned int Class_2_B9EF300C0A792A54_TypeDefinitionIndex = 62216;

class Class_2_B9EF300C0A792A54 : public ::Class_1_ED6312566761D69A
{
public:
	::Class_0_16E4307DCC419505_804* Field_2_0; // 0x20
	::RPG::Client::GridFightRole* Field_2_1; // 0x28

	::System::Void _ctor(::RPG::Client::GridFightRole* a1, ::Class_0_16E4307DCC419505_804* a2)
	{
		return ((::System::Void(*)(::PVOID, ::RPG::Client::GridFightRole*, ::Class_0_16E4307DCC419505_804*))((::PBYTE)hIl2Cpp + CLASS_2_B9EF300C0A792A54__CTOR_OFFSET))(this, a1, a2);
	}
