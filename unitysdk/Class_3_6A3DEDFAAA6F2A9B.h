...
#define CLASS_3_6A3DEDFAAA6F2A9B_METHOD_3_447B86A977F32098_OFFSET UNITYSDK_OFFSET(0x15C774C0)
#define CLASS_3_6A3DEDFAAA6F2A9B_METHOD_3_7C2676DAE3F039F9_OFFSET UNITYSDK_OFFSET(0x15C77880)
#define CLASS_3_6A3DEDFAAA6F2A9B_METHOD_3_BE8A1D0F6D838666_OFFSET UNITYSDK_OFFSET(0x15C77FE0)
#define CLASS_3_6A3DEDFAAA6F2A9B_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x15C77F60)
#define CLASS_3_6A3DEDFAAA6F2A9B__CTOR_OFFSET UNITYSDK_OFFSET(0x15C77FC0)

inline static constexpr unsigned int Class_3_6A3DEDFAAA6F2A9B_TypeDefinitionIndex = 51155;
