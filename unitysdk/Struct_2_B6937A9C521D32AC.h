...
#define STRUCT_2_B6937A9C521D32AC_METHOD_2_1F8314262457963A_OFFSET UNITYSDK_OFFSET(0x8209F0)
#define STRUCT_2_B6937A9C521D32AC_METHOD_2_5489F9CD0AA85DE6_OFFSET UNITYSDK_OFFSET(0x820970)
#define STRUCT_2_B6937A9C521D32AC_METHOD_2_5A219A4F5451E01D_OFFSET UNITYSDK_OFFSET(0x8209E0)
#define STRUCT_2_B6937A9C521D32AC_METHOD_2_77E6E3DA1F0E9CCC_1_OFFSET UNITYSDK_OFFSET(0x820A30)
#define STRUCT_2_B6937A9C521D32AC_METHOD_2_77E6E3DA1F0E9CCC_2_OFFSET UNITYSDK_OFFSET(0x820A50)
#define STRUCT_2_B6937A9C521D32AC_METHOD_2_77E6E3DA1F0E9CCC_OFFSET UNITYSDK_OFFSET(0x820A10)
#define STRUCT_2_B6937A9C521D32AC_METHOD_2_C3B21C74C45D6F86_OFFSET UNITYSDK_OFFSET(0x8209A0)
#define STRUCT_2_B6937A9C521D32AC_PROCESSANIMATION_OFFSET UNITYSDK_OFFSET(0x8208F0)
#define STRUCT_2_B6937A9C521D32AC_PROCESSROOTMOTION_OFFSET UNITYSDK_OFFSET(0x820930)
#define STRUCT_2_B6937A9C521D32AC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1689F640)
#define STRUCT_2_B6937A9C521D32AC__CTOR_OFFSET UNITYSDK_OFFSET(0x820830)

inline static constexpr unsigned int Struct_2_B6937A9C521D32AC_TypeDefinitionIndex = 67454;

struct alignas(8) Struct_2_B6937A9C521D32AC
{
	static ::Struct_2_B6937A9C521D32AC* StaticGet_Field_2_11()
	{
		return (::Struct_2_B6937A9C521D32AC*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_B6937A9C521D32AC_TypeDefinitionIndex)->GetStaticField(0xFEC0);
	}
