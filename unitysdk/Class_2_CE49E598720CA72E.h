...
#define CLASS_2_CE49E598720CA72E_METHOD_2_37B10ADE5E9E91EF_OFFSET UNITYSDK_OFFSET(0x15B4A1A0)
#define CLASS_2_CE49E598720CA72E_METHOD_2_52510872F1FAAB30_OFFSET UNITYSDK_OFFSET(0x15B47C40)
#define CLASS_2_CE49E598720CA72E_METHOD_2_6BC7335E83B35013_OFFSET UNITYSDK_OFFSET(0x15B47160)
#define CLASS_2_CE49E598720CA72E_METHOD_2_7A097E7EF929F289_OFFSET UNITYSDK_OFFSET(0x15B49A70)
#define CLASS_2_CE49E598720CA72E_METHOD_2_7CB38613B004D178_OFFSET UNITYSDK_OFFSET(0x15B49BC0)
#define CLASS_2_CE49E598720CA72E_METHOD_2_81EAE04AE64DEBC7_OFFSET UNITYSDK_OFFSET(0x15B47350)
#define CLASS_2_CE49E598720CA72E_METHOD_2_823D2321780524FA_OFFSET UNITYSDK_OFFSET(0x15B49CD0)
#define CLASS_2_CE49E598720CA72E_METHOD_2_A88B36294D55B85C_OFFSET UNITYSDK_OFFSET(0x15B471D0)
#define CLASS_2_CE49E598720CA72E_METHOD_2_B8AE0D2E790CBF66_OFFSET UNITYSDK_OFFSET(0x15B4A060)
#define CLASS_2_CE49E598720CA72E_METHOD_2_C50B93169B85DAEA_OFFSET UNITYSDK_OFFSET(0x15B49B70)
#define CLASS_2_CE49E598720CA72E_METHOD_2_C864ACA97B30C73D_OFFSET UNITYSDK_OFFSET(0x15B47DD0)
#define CLASS_2_CE49E598720CA72E_METHOD_2_D0ACB47B641DF879_OFFSET UNITYSDK_OFFSET(0x15B484D0)
#define CLASS_2_CE49E598720CA72E_METHOD_2_D0EDFA57F5E97657_OFFSET UNITYSDK_OFFSET(0x15B493F0)
#define CLASS_2_CE49E598720CA72E_METHOD_2_D12268C88ECA46C9_OFFSET UNITYSDK_OFFSET(0x15B47BA0)
#define CLASS_2_CE49E598720CA72E_METHOD_2_D339EFAB24ED44B0_OFFSET UNITYSDK_OFFSET(0x15B482F0)
#define CLASS_2_CE49E598720CA72E_METHOD_2_E0C2C06EB965A1D6_OFFSET UNITYSDK_OFFSET(0x15B46F20)
#define CLASS_2_CE49E598720CA72E_METHOD_2_E53F85027BE01D72_OFFSET UNITYSDK_OFFSET(0x15B497E0)
#define CLASS_2_CE49E598720CA72E_METHOD_2_E6EB3DAD63B8AE72_OFFSET UNITYSDK_OFFSET(0x15B47990)
#define CLASS_2_CE49E598720CA72E_METHOD_2_E92A0511BEF15ED2_OFFSET UNITYSDK_OFFSET(0x15B48040)
#define CLASS_2_CE49E598720CA72E__CTOR_OFFSET UNITYSDK_OFFSET(0x15B4A2F0)
...
{
public:
	::RPG::GameCore::EventManager* EBOCGAJBGPG; // 0x18
	::System::String* BIDGMFEGNGM; // 0x20
	::UnityEngine::BoxCollider* GDJEPIMALFI; // 0x28
	::RPG::GameCore::PropComponent* CLGHBANCIDF; // 0x30
	::System::String* FDHGBLNNFCJ; // 0x38
	::UnityEngine::Animator* IKHNGKOLIEC; // 0x40
	::RPG::GameCore::GameEntity* JOIPPIKNILC; // 0x48
	::RPG::GameCore::GameEntity* MFOAFKNAIOD; // 0x50
	::UnityEngine::SphereCollider* LGJKAAIMJLD; // 0x58
	::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* JHBIGOHDKKG; // 0x60
	::System::Boolean POHEELFNCOM; // 0x68
	::System::Single PMCOJONMBNO; // 0x6C
