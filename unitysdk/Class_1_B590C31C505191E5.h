...
#define CLASS_1_B590C31C505191E5_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A316410)
#define CLASS_1_B590C31C505191E5_CLONE_OFFSET UNITYSDK_OFFSET(0x1A316060)
#define CLASS_1_B590C31C505191E5_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A316170)
#define CLASS_1_B590C31C505191E5_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A3160C0)
#define CLASS_1_B590C31C505191E5_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A316210)
#define CLASS_1_B590C31C505191E5_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A3164D0)
#define CLASS_1_B590C31C505191E5_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A316480)
#define CLASS_1_B590C31C505191E5_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1A3160B0)
#define CLASS_1_B590C31C505191E5_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A315F40)
#define CLASS_1_B590C31C505191E5_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1A3160A0)
#define CLASS_1_B590C31C505191E5_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1A316090)
#define CLASS_1_B590C31C505191E5_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A315F70)
#define CLASS_1_B590C31C505191E5_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A316310)
#define CLASS_1_B590C31C505191E5_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A316370)
#define CLASS_1_B590C31C505191E5__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A316690)
#define CLASS_1_B590C31C505191E5__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A315FD0)
#define CLASS_1_B590C31C505191E5__CTOR_OFFSET UNITYSDK_OFFSET(0x1A315F80)

inline static constexpr unsigned int Class_1_B590C31C505191E5_TypeDefinitionIndex = 24827;
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B590C31C505191E5_TypeDefinitionIndex)->GetStaticField(0x539A0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_B590C31C505191E5*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_B590C31C505191E5*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B590C31C505191E5_TypeDefinitionIndex)->GetStaticField(0x539A8);
	}
