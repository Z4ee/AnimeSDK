...
#define CLASS_1_B590C31C505191E5_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E6C6F70)
#define CLASS_1_B590C31C505191E5_CLONE_OFFSET UNITYSDK_OFFSET(0x1E6C6AB0)
#define CLASS_1_B590C31C505191E5_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E6C6C10)
#define CLASS_1_B590C31C505191E5_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E6C6B10)
#define CLASS_1_B590C31C505191E5_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E6C6D10)
#define CLASS_1_B590C31C505191E5_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E6C7030)
#define CLASS_1_B590C31C505191E5_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E6C6FE0)
#define CLASS_1_B590C31C505191E5_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1E6C6B00)
#define CLASS_1_B590C31C505191E5_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E6C6990)
#define CLASS_1_B590C31C505191E5_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1E6C6AF0)
#define CLASS_1_B590C31C505191E5_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1E6C6AE0)
#define CLASS_1_B590C31C505191E5_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E6C69C0)
#define CLASS_1_B590C31C505191E5_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E6C6E10)
#define CLASS_1_B590C31C505191E5_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E6C6E70)
#define CLASS_1_B590C31C505191E5__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E6C71F0)
#define CLASS_1_B590C31C505191E5__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E6C6A20)
#define CLASS_1_B590C31C505191E5__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6C69D0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_B590C31C505191E5*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B590C31C505191E5_TypeDefinitionIndex)->GetStaticField(0x51030);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_DIFNGFODAED()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B590C31C505191E5_TypeDefinitionIndex)->GetStaticField(0x51038);
	}
