...
#define CLASS_1_B590C31C505191E5_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19808750)
#define CLASS_1_B590C31C505191E5_CLONE_OFFSET UNITYSDK_OFFSET(0x198083A0)
#define CLASS_1_B590C31C505191E5_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x198084B0)
#define CLASS_1_B590C31C505191E5_EQUALS_OFFSET UNITYSDK_OFFSET(0x19808400)
#define CLASS_1_B590C31C505191E5_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19808550)
#define CLASS_1_B590C31C505191E5_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19808810)
#define CLASS_1_B590C31C505191E5_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x198087C0)
#define CLASS_1_B590C31C505191E5_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x198083D0)
#define CLASS_1_B590C31C505191E5_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19808280)
#define CLASS_1_B590C31C505191E5_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x198083F0)
#define CLASS_1_B590C31C505191E5_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x198083E0)
#define CLASS_1_B590C31C505191E5_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x198082B0)
#define CLASS_1_B590C31C505191E5_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19808650)
#define CLASS_1_B590C31C505191E5_WRITETO_OFFSET UNITYSDK_OFFSET(0x198086B0)
#define CLASS_1_B590C31C505191E5__CCTOR_OFFSET UNITYSDK_OFFSET(0x19808940)
#define CLASS_1_B590C31C505191E5__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19808310)
#define CLASS_1_B590C31C505191E5__CTOR_OFFSET UNITYSDK_OFFSET(0x198082C0)

inline static constexpr unsigned int Class_1_B590C31C505191E5_TypeDefinitionIndex = 24966;

class Class_1_B590C31C505191E5 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_B590C31C505191E5*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_B590C31C505191E5*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B590C31C505191E5_TypeDefinitionIndex)->GetStaticField(0x65700);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_3()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B590C31C505191E5_TypeDefinitionIndex)->GetStaticField(0x65708);
	}
