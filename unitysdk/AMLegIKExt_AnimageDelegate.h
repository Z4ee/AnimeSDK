...
#define AMLEGIKEXT_ANIMAGEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18086320)
#define AMLEGIKEXT_ANIMAGEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18086350)
#define AMLEGIKEXT_ANIMAGEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18086080)
#define AMLEGIKEXT_ANIMAGEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18086060)

inline static constexpr unsigned int AMLegIKExt_AnimageDelegate_TypeDefinitionIndex = 52194;
