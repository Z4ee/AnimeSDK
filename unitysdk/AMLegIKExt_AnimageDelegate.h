...
#define AMLEGIKEXT_ANIMAGEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x14B739B0)
#define AMLEGIKEXT_ANIMAGEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x14B739E0)
#define AMLEGIKEXT_ANIMAGEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x14B73720)
#define AMLEGIKEXT_ANIMAGEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x14B73700)

inline static constexpr unsigned int AMLegIKExt_AnimageDelegate_TypeDefinitionIndex = 89690;
