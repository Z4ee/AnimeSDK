...
#define CLASS_1_EB813CC1D00A138D_2_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DD55EA0)
#define CLASS_1_EB813CC1D00A138D_2_CLONE_OFFSET UNITYSDK_OFFSET(0x1DD55810)
#define CLASS_1_EB813CC1D00A138D_2_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DD55AC0)
#define CLASS_1_EB813CC1D00A138D_2_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DD55890)
#define CLASS_1_EB813CC1D00A138D_2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DD55C90)
#define CLASS_1_EB813CC1D00A138D_2_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DD56080)
#define CLASS_1_EB813CC1D00A138D_2_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DD55F90)
#define CLASS_1_EB813CC1D00A138D_2_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x1DD55860)
#define CLASS_1_EB813CC1D00A138D_2_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1DD55630)
#define CLASS_1_EB813CC1D00A138D_2_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x1DD55880)
#define CLASS_1_EB813CC1D00A138D_2_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1DD55870)
#define CLASS_1_EB813CC1D00A138D_2_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DD55690)
#define CLASS_1_EB813CC1D00A138D_2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DD55D20)
#define CLASS_1_EB813CC1D00A138D_2_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DD55D80)
#define CLASS_1_EB813CC1D00A138D_2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DD56270)
#define CLASS_1_EB813CC1D00A138D_2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DD556F0)
#define CLASS_1_EB813CC1D00A138D_2__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD556A0)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_31B87651CEDF5B41*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_EB813CC1D00A138D_2_TypeDefinitionIndex)->GetStaticField(0x116C0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_EB813CC1D00A138D_2*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_EB813CC1D00A138D_2*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_EB813CC1D00A138D_2_TypeDefinitionIndex)->GetStaticField(0x116C8);
	}
	// static const ::System::Int32 GOGDMMLLHHB = 0x5; // 0x0
	// static const ::System::Int32 PLPFFMKHFHI = 0x1; // 0x0
	::Class_1_8844A4E6AE686D5C_5* JAKEAPOAJPI; // 0x10
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x18
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_31B87651CEDF5B41*>* DLMPOFHPNKH; // 0x20
