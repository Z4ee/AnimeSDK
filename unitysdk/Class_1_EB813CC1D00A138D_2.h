...
#define CLASS_1_EB813CC1D00A138D_2_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C896A20)
#define CLASS_1_EB813CC1D00A138D_2_CLONE_OFFSET UNITYSDK_OFFSET(0x1C8963A0)
#define CLASS_1_EB813CC1D00A138D_2_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C896650)
#define CLASS_1_EB813CC1D00A138D_2_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C896420)
#define CLASS_1_EB813CC1D00A138D_2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C896820)
#define CLASS_1_EB813CC1D00A138D_2_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C896C00)
#define CLASS_1_EB813CC1D00A138D_2_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C896B00)
#define CLASS_1_EB813CC1D00A138D_2_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x1C896400)
#define CLASS_1_EB813CC1D00A138D_2_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C8961D0)
#define CLASS_1_EB813CC1D00A138D_2_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x1C8963F0)
#define CLASS_1_EB813CC1D00A138D_2_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1C896410)
#define CLASS_1_EB813CC1D00A138D_2_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C896230)
#define CLASS_1_EB813CC1D00A138D_2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C8968A0)
#define CLASS_1_EB813CC1D00A138D_2_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C896900)
#define CLASS_1_EB813CC1D00A138D_2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C896DF0)
#define CLASS_1_EB813CC1D00A138D_2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C896290)
#define CLASS_1_EB813CC1D00A138D_2__CTOR_OFFSET UNITYSDK_OFFSET(0x1C896240)

inline static constexpr unsigned int Class_1_EB813CC1D00A138D_2_TypeDefinitionIndex = 27995;

class Class_1_EB813CC1D00A138D_2 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_EB813CC1D00A138D_2*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_EB813CC1D00A138D_2*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_EB813CC1D00A138D_2_TypeDefinitionIndex)->GetStaticField(0x65EC0);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_31B87651CEDF5B41*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_31B87651CEDF5B41*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_EB813CC1D00A138D_2_TypeDefinitionIndex)->GetStaticField(0x65EC8);
	}
	// static const ::System::Int32 Field_1_2 = 0x3; // 0x0
	// static const ::System::Int32 Field_1_3 = 0x6; // 0x0
	::Google::Protobuf::UnknownFieldSet* Field_1_4; // 0x10
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_31B87651CEDF5B41*>* Field_1_5; // 0x18
	::Class_1_8844A4E6AE686D5C_5* Field_1_6; // 0x20
