...
#define CLASS_1_33B3767CFAB8BF13_CLEAR_OFFSET UNITYSDK_OFFSET(0x1428BF40)
#define CLASS_1_33B3767CFAB8BF13_GET_ABILITY_OFFSET UNITYSDK_OFFSET(0x1428CB20)
#define CLASS_1_33B3767CFAB8BF13_GET_CONDITIONCONFIG_OFFSET UNITYSDK_OFFSET(0x1428CB40)
#define CLASS_1_33B3767CFAB8BF13_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1428CBA0)
#define CLASS_1_33B3767CFAB8BF13_GET_CURRENTCDTIME_OFFSET UNITYSDK_OFFSET(0x1428CBC0)
#define CLASS_1_33B3767CFAB8BF13_GET_ISCASTBEFORE_OFFSET UNITYSDK_OFFSET(0x1428CC00)
#define CLASS_1_33B3767CFAB8BF13_GET_ISRELEASEDONLYONCE_OFFSET UNITYSDK_OFFSET(0x1428CBE0)
#define CLASS_1_33B3767CFAB8BF13_GET_SKILLUID_OFFSET UNITYSDK_OFFSET(0x1428CB60)
#define CLASS_1_33B3767CFAB8BF13_METHOD_1_1D4018D4200358D0_1_OFFSET UNITYSDK_OFFSET(0x1428C540)
#define CLASS_1_33B3767CFAB8BF13_METHOD_1_1D4018D4200358D0_2_OFFSET UNITYSDK_OFFSET(0x1428C410)
#define CLASS_1_33B3767CFAB8BF13_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x1428C250)
#define CLASS_1_33B3767CFAB8BF13_METHOD_1_42C5BADE1C9EFC80_OFFSET UNITYSDK_OFFSET(0x1428C2B0)
#define CLASS_1_33B3767CFAB8BF13_METHOD_1_717BB26CA29468F0_OFFSET UNITYSDK_OFFSET(0x1428C470)
#define CLASS_1_33B3767CFAB8BF13_METHOD_1_7269FF885AF7BCF1_OFFSET UNITYSDK_OFFSET(0x1428C050)
#define CLASS_1_33B3767CFAB8BF13_METHOD_1_7EAA8879197594BA_OFFSET UNITYSDK_OFFSET(0x1428C5A0)
#define CLASS_1_33B3767CFAB8BF13_METHOD_1_8C90C775EAE86885_OFFSET UNITYSDK_OFFSET(0x1428CA00)
#define CLASS_1_33B3767CFAB8BF13_METHOD_1_D978819B0A4871A0_OFFSET UNITYSDK_OFFSET(0x1428CB80)
#define CLASS_1_33B3767CFAB8BF13_METHOD_1_DF2186C51E25C1BB_OFFSET UNITYSDK_OFFSET(0x1428C8B0)
#define CLASS_1_33B3767CFAB8BF13_SET_ABILITY_OFFSET UNITYSDK_OFFSET(0x1428CB30)
#define CLASS_1_33B3767CFAB8BF13_SET_CONDITIONCONFIG_OFFSET UNITYSDK_OFFSET(0x1428CB50)
#define CLASS_1_33B3767CFAB8BF13_SET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1428CBB0)
#define CLASS_1_33B3767CFAB8BF13_SET_CURRENTCDTIME_OFFSET UNITYSDK_OFFSET(0x1428CBD0)
#define CLASS_1_33B3767CFAB8BF13_SET_ISCASTBEFORE_OFFSET UNITYSDK_OFFSET(0x1428CC10)
#define CLASS_1_33B3767CFAB8BF13_SET_ISRELEASEDONLYONCE_OFFSET UNITYSDK_OFFSET(0x1428CBF0)
#define CLASS_1_33B3767CFAB8BF13_SET_SKILLUID_OFFSET UNITYSDK_OFFSET(0x1428CB70)
#define CLASS_1_33B3767CFAB8BF13__CTOR_OFFSET UNITYSDK_OFFSET(0x1428BF30)

inline static constexpr unsigned int Class_1_33B3767CFAB8BF13_TypeDefinitionIndex = 73911;

class Class_1_33B3767CFAB8BF13 : public ::System::Object
{
public:
	::Class_1_DA581C745E06616F* Field_1_0; // 0x10
	::Class_1_021CB433CF10B390* Field_1_1; // 0x18
	::Class_1_B8FF829EFDD29B81* _Context_k__BackingField; // 0x20
	::RPG::GameCore::BaseChenLingBattleAbilityConditionChecker* _ConditionConfig_k__BackingField; // 0x28
	::Class_1_B8836451EE3130C0* _Ability_k__BackingField; // 0x30
