...
#define CLASS_2_7D410B11D876F24C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x185EF440)
#define CLASS_2_7D410B11D876F24C_METHOD_2_33E04F40C443C2C0_OFFSET UNITYSDK_OFFSET(0x185EFC10)
#define CLASS_2_7D410B11D876F24C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x185EFA70)
#define CLASS_2_7D410B11D876F24C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x185EF710)
#define CLASS_2_7D410B11D876F24C_TICK_OFFSET UNITYSDK_OFFSET(0x185EF8C0)
#define CLASS_2_7D410B11D876F24C__CTOR_OFFSET UNITYSDK_OFFSET(0x185EF350)
...
{
public:
	::Class_3_07C3C4D2990C49EE* GLNNENJGEJC; // 0x18
	::RPG::GameCore::SceneGachaListener* OFKGLJOAMLD; // 0x20
	::Class_3_07C3C4D2990C49EE* GAOBOFDMIDO; // 0x28
