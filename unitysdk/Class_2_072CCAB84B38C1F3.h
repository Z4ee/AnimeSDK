...
#define CLASS_2_072CCAB84B38C1F3_METHOD_2_0AFAD1EC9AEDCF98_OFFSET UNITYSDK_OFFSET(0x176C60A0)
#define CLASS_2_072CCAB84B38C1F3_METHOD_2_15CAD4B37A120966_OFFSET UNITYSDK_OFFSET(0x176C61E0)
#define CLASS_2_072CCAB84B38C1F3_METHOD_2_75F5788C80666805_OFFSET UNITYSDK_OFFSET(0x176C6110)
#define CLASS_2_072CCAB84B38C1F3_METHOD_2_CA94ABA214A2046A_OFFSET UNITYSDK_OFFSET(0x176C63B0)
#define CLASS_2_072CCAB84B38C1F3_METHOD_2_FC2661F064DB6E0D_OFFSET UNITYSDK_OFFSET(0x176C6320)
#define CLASS_2_072CCAB84B38C1F3__COMPAREIMPL_OFFSET UNITYSDK_OFFSET(0x176C6160)
#define CLASS_2_072CCAB84B38C1F3__CTOR_OFFSET UNITYSDK_OFFSET(0x176C6600)

inline static constexpr unsigned int Class_2_072CCAB84B38C1F3_TypeDefinitionIndex = 62880;

class Class_2_072CCAB84B38C1F3 : public ::RPG::Client::AvatarComparerBase
{
public:
	::System::Collections::Generic::List_1<::RPG::AvatarSystem::IAvatar*>* BDBOMBOKHGM; // 0x18
	::System::Comparison_1<::RPG::AvatarSystem::IAvatar*>* AHFBNFMCJLI; // 0x20
