...
#define CLASS_1_5B567C8A01BAEDFE_150_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E8A76D0)
#define CLASS_1_5B567C8A01BAEDFE_150_CLONE_OFFSET UNITYSDK_OFFSET(0x1E8A7370)
#define CLASS_1_5B567C8A01BAEDFE_150_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E8A74D0)
#define CLASS_1_5B567C8A01BAEDFE_150_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E8A73E0)
#define CLASS_1_5B567C8A01BAEDFE_150_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E8A7630)
#define CLASS_1_5B567C8A01BAEDFE_150_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E8A7720)
#define CLASS_1_5B567C8A01BAEDFE_150_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E8A76F0)
#define CLASS_1_5B567C8A01BAEDFE_150_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1E8A72C0)
#define CLASS_1_5B567C8A01BAEDFE_150_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E8A7320)
#define CLASS_1_5B567C8A01BAEDFE_150_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E8A7660)
#define CLASS_1_5B567C8A01BAEDFE_150_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E8A76C0)
#define CLASS_1_5B567C8A01BAEDFE_150__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E8A7770)
#define CLASS_1_5B567C8A01BAEDFE_150__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E8A7340)
#define CLASS_1_5B567C8A01BAEDFE_150__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8A7330)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_150_TypeDefinitionIndex = 28957;

class Class_1_5B567C8A01BAEDFE_150 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_150*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_150*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_150_TypeDefinitionIndex)->GetStaticField(0x43A30);
	}
