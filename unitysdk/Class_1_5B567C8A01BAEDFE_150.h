...
#define CLASS_1_5B567C8A01BAEDFE_150_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19401B20)
#define CLASS_1_5B567C8A01BAEDFE_150_CLONE_OFFSET UNITYSDK_OFFSET(0x19401930)
#define CLASS_1_5B567C8A01BAEDFE_150_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19401A30)
#define CLASS_1_5B567C8A01BAEDFE_150_EQUALS_OFFSET UNITYSDK_OFFSET(0x194019A0)
#define CLASS_1_5B567C8A01BAEDFE_150_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19401A80)
#define CLASS_1_5B567C8A01BAEDFE_150_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19401B70)
#define CLASS_1_5B567C8A01BAEDFE_150_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19401B40)
#define CLASS_1_5B567C8A01BAEDFE_150_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19401880)
#define CLASS_1_5B567C8A01BAEDFE_150_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x194018E0)
#define CLASS_1_5B567C8A01BAEDFE_150_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19401AB0)
#define CLASS_1_5B567C8A01BAEDFE_150_WRITETO_OFFSET UNITYSDK_OFFSET(0x19401B10)
#define CLASS_1_5B567C8A01BAEDFE_150__CCTOR_OFFSET UNITYSDK_OFFSET(0x19401BC0)
#define CLASS_1_5B567C8A01BAEDFE_150__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19401900)
#define CLASS_1_5B567C8A01BAEDFE_150__CTOR_OFFSET UNITYSDK_OFFSET(0x194018F0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_150_TypeDefinitionIndex = 27788;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_150*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_150_TypeDefinitionIndex)->GetStaticField(0x42750);
	}
