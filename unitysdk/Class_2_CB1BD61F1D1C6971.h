...
#define CLASS_2_CB1BD61F1D1C6971_DISPOSE_OFFSET UNITYSDK_OFFSET(0x156F0C20)
#define CLASS_2_CB1BD61F1D1C6971_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x156F0F50)
#define CLASS_2_CB1BD61F1D1C6971_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x156F0C70)
#define CLASS_2_CB1BD61F1D1C6971_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x156F0EA0)
#define CLASS_2_CB1BD61F1D1C6971_TICK_OFFSET UNITYSDK_OFFSET(0x156F0EF0)
#define CLASS_2_CB1BD61F1D1C6971__CTOR_OFFSET UNITYSDK_OFFSET(0x156F0C10)

inline static constexpr unsigned int Class_2_CB1BD61F1D1C6971_TypeDefinitionIndex = 53000;

class Class_2_CB1BD61F1D1C6971 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::GameCore::DebateInitialize* OFKGLJOAMLD; // 0x20
