...
#define CLASS_2_DC41472B72D28028_METHOD_2_01509228E3A9577B_OFFSET UNITYSDK_OFFSET(0x1914A280)
#define CLASS_2_DC41472B72D28028_METHOD_2_33531301A55BB22F_OFFSET UNITYSDK_OFFSET(0x1914A420)
#define CLASS_2_DC41472B72D28028_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1914A130)
#define CLASS_2_DC41472B72D28028_METHOD_2_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0x1914A6E0)
#define CLASS_2_DC41472B72D28028_METHOD_2_AC7CD4175E0A3EF8_OFFSET UNITYSDK_OFFSET(0x19149F00)
#define CLASS_2_DC41472B72D28028_METHOD_2_BCCEF225A11BDA90_OFFSET UNITYSDK_OFFSET(0x19149DC0)
#define CLASS_2_DC41472B72D28028_METHOD_2_BF9C25E762BD53B3_OFFSET UNITYSDK_OFFSET(0x19149E40)
#define CLASS_2_DC41472B72D28028_METHOD_2_FCEF005F844F513C_OFFSET UNITYSDK_OFFSET(0x1914A580)
#define CLASS_2_DC41472B72D28028__CTOR_OFFSET UNITYSDK_OFFSET(0x1914A740)
#define CLASS_2_DC41472B72D28028__ONBIND_OFFSET UNITYSDK_OFFSET(0x19149CA0)
#define CLASS_2_DC41472B72D28028__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x1914A1A0)

inline static constexpr unsigned int Class_2_DC41472B72D28028_TypeDefinitionIndex = 72288;

class Class_2_DC41472B72D28028 : public ::Class_1_34917908B7833130
{
public:
	::RPG::Client::AnimatorButton* HPMCPFLHFPO; // 0x60
	::RPG::Client::MonoInControlButton* FDBAPJJPMMG; // 0x68
	::RPG::Client::LocalizedText* DMCFNALLLMO; // 0x70
	::RPG::Client::MonoInControlButton* HPODAOJOJMN; // 0x78
	::UnityEngine::Coroutine* FCDGNGBHHJD; // 0x80
	::RPG::Client::AnimatorButton* CHBLDOPEEBE; // 0x88
	::RPG::GameCore::AvatarDemoConfigRow* IBPBJBOKKMF; // 0x90
