...
#define CLASS_2_CDA79B2C607C695E_METHOD_2_2340068C22DFE332_OFFSET UNITYSDK_OFFSET(0x18A9C670)
#define CLASS_2_CDA79B2C607C695E_METHOD_2_CC8BA8306EA10C06_OFFSET UNITYSDK_OFFSET(0x18A9C600)
#define CLASS_2_CDA79B2C607C695E_METHOD_2_E855A974FE0C8866_OFFSET UNITYSDK_OFFSET(0x18A9C930)
#define CLASS_2_CDA79B2C607C695E_METHOD_2_F0D9B6AAFF504D87_OFFSET UNITYSDK_OFFSET(0x18A9C860)
#define CLASS_2_CDA79B2C607C695E__CTOR_OFFSET UNITYSDK_OFFSET(0x18A9CA10)
#define CLASS_2_CDA79B2C607C695E__ONBIND_OFFSET UNITYSDK_OFFSET(0x18A9C4C0)

inline static constexpr unsigned int Class_2_CDA79B2C607C695E_TypeDefinitionIndex = 72192;
...
public:
	...
	::RPG::Client::GridFightRole* IAHCEGHHCKB; // 0x80
	::UnityEngine::UI::Image* GOBAHDNAOLK; // 0x88
