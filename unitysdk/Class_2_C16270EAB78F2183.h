...
#define CLASS_2_C16270EAB78F2183_METHOD_2_1092C5537716905B_OFFSET UNITYSDK_OFFSET(0xB51FF80)
#define CLASS_2_C16270EAB78F2183_METHOD_2_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xB51FE60)
#define CLASS_2_C16270EAB78F2183_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0xB51FDF0)
#define CLASS_2_C16270EAB78F2183_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB51FB90)
#define CLASS_2_C16270EAB78F2183_METHOD_2_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0xB51FCA0)
#define CLASS_2_C16270EAB78F2183_METHOD_2_D951EE47D243444C_OFFSET UNITYSDK_OFFSET(0xB51FA30)
#define CLASS_2_C16270EAB78F2183_VIEWPREFABPATH_OFFSET UNITYSDK_OFFSET(0xB51F770)
#define CLASS_2_C16270EAB78F2183__CTOR_OFFSET UNITYSDK_OFFSET(0xB51F9C0)
#define CLASS_2_C16270EAB78F2183__CUSTOMBINDVIEW_OFFSET UNITYSDK_OFFSET(0xB51F7E0)
#define CLASS_2_C16270EAB78F2183__ONTICK_OFFSET UNITYSDK_OFFSET(0xB51FC40)
#define CLASS_2_C16270EAB78F2183__SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xB51FA90)
#define CLASS_2_C16270EAB78F2183__UNBINDVIEW_OFFSET UNITYSDK_OFFSET(0xB51FBF0)

inline static constexpr unsigned int Class_2_C16270EAB78F2183_TypeDefinitionIndex = 72239;

class Class_2_C16270EAB78F2183 : public ::RPG::Client::UIController
{
public:
	::Class_1_1C30CE192ABE4C54* CGGGPPBMFID; // 0x188
	::RPG::Client::CustomButton* EBKBADIICEA; // 0x190
	::RPG::Client::MonoTieMuQTE* MKIEHCGKMIA; // 0x198
	::UnityEngine::UI::Slider* EBLLEMNBNBO; // 0x1A0
	::RPG::GameCore::StringHash DIJHOMCLPEG; // 0x1A8
	::System::Single EBOBPBINAAO; // 0x1AC
	::System::Single EKEGNJACGEA; // 0x1B0
