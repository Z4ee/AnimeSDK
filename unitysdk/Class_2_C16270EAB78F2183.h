...
#define CLASS_2_C16270EAB78F2183_METHOD_2_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x8AAD9F0)
#define CLASS_2_C16270EAB78F2183_METHOD_2_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0x8AAD980)
#define CLASS_2_C16270EAB78F2183_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x8AAD6C0)
#define CLASS_2_C16270EAB78F2183_METHOD_2_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0x8AAD7D0)
#define CLASS_2_C16270EAB78F2183_METHOD_2_D1305BC17A89C222_OFFSET UNITYSDK_OFFSET(0x8AADA90)
#define CLASS_2_C16270EAB78F2183_METHOD_2_D951EE47D243444C_OFFSET UNITYSDK_OFFSET(0x8AAD5E0)
#define CLASS_2_C16270EAB78F2183_VIEWPREFABPATH_OFFSET UNITYSDK_OFFSET(0x8AAD360)
#define CLASS_2_C16270EAB78F2183__CTOR_OFFSET UNITYSDK_OFFSET(0x8AAD5A0)
#define CLASS_2_C16270EAB78F2183__CUSTOMBINDVIEW_OFFSET UNITYSDK_OFFSET(0x8AAD3D0)
#define CLASS_2_C16270EAB78F2183__ONTICK_OFFSET UNITYSDK_OFFSET(0x8AAD770)
#define CLASS_2_C16270EAB78F2183__SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x8AAD640)
#define CLASS_2_C16270EAB78F2183__UNBINDVIEW_OFFSET UNITYSDK_OFFSET(0x8AAD720)
#define CLASS_2_C16270EAB78F2183___IFIXBASEPROXY_VIEWPREFABPATH_OFFSET UNITYSDK_OFFSET(0x8AADB70)
#define CLASS_2_C16270EAB78F2183___IFIXBASEPROXY__CUSTOMBINDVIEW_OFFSET UNITYSDK_OFFSET(0x8AADC00)
#define CLASS_2_C16270EAB78F2183___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0x8AADD20)
#define CLASS_2_C16270EAB78F2183___IFIXBASEPROXY__SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x8AADC60)
#define CLASS_2_C16270EAB78F2183___IFIXBASEPROXY__UNBINDVIEW_OFFSET UNITYSDK_OFFSET(0x8AADCC0)

inline static constexpr unsigned int Class_2_C16270EAB78F2183_TypeDefinitionIndex = 59224;

class Class_2_C16270EAB78F2183 : public ::RPG::Client::UIController
{
public:
	::RPG::Client::MonoTieMuQTE* Field_2_0; // 0x180
	::UnityEngine::UI::Slider* Field_2_2; // 0x188
	::RPG::Client::CustomButton* Field_2_1; // 0x190
	::Class_1_2CAAA2FDF9170110* Field_2_3; // 0x198
	::System::Boolean Field_2_8; // 0x1A0
	::System::Single Field_2_7; // 0x1A4
	::System::Single Field_2_5; // 0x1A8
	::RPG::GameCore::StringHash Field_2_4; // 0x1AC
	::System::Single Field_2_6; // 0x1B0
