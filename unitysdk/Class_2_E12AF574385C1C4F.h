...
#define CLASS_2_E12AF574385C1C4F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17B5F5F0)
#define CLASS_2_E12AF574385C1C4F_METHOD_2_11D0275BC8CDB628_1_OFFSET UNITYSDK_OFFSET(0x17B60020)
#define CLASS_2_E12AF574385C1C4F_METHOD_2_11D0275BC8CDB628_OFFSET UNITYSDK_OFFSET(0x17B5FF10)
#define CLASS_2_E12AF574385C1C4F_METHOD_2_17DF797C7BADB9F1_OFFSET UNITYSDK_OFFSET(0x17B5FFC0)
#define CLASS_2_E12AF574385C1C4F_METHOD_2_4997AEC4BF5EB145_OFFSET UNITYSDK_OFFSET(0x17B5FF20)
#define CLASS_2_E12AF574385C1C4F_METHOD_2_619F2A2FD9E836DC_OFFSET UNITYSDK_OFFSET(0x17B5FE30)
#define CLASS_2_E12AF574385C1C4F_METHOD_2_6C58E77C33E0B131_OFFSET UNITYSDK_OFFSET(0x17B5FAF0)
#define CLASS_2_E12AF574385C1C4F_METHOD_2_7443AD94E7275ABA_OFFSET UNITYSDK_OFFSET(0x17B5F9F0)
#define CLASS_2_E12AF574385C1C4F_METHOD_2_84CA29AC5D026444_OFFSET UNITYSDK_OFFSET(0x17B5FEC0)
#define CLASS_2_E12AF574385C1C4F_METHOD_2_8720C122730219B8_OFFSET UNITYSDK_OFFSET(0x17B5F8B0)
#define CLASS_2_E12AF574385C1C4F_METHOD_2_950F65CE5A552DCD_1_OFFSET UNITYSDK_OFFSET(0x17B5FAE0)
#define CLASS_2_E12AF574385C1C4F_METHOD_2_950F65CE5A552DCD_OFFSET UNITYSDK_OFFSET(0x17B5F9E0)
#define CLASS_2_E12AF574385C1C4F_METHOD_2_BB04B329C8919768_OFFSET UNITYSDK_OFFSET(0x17B5FB30)
#define CLASS_2_E12AF574385C1C4F_METHOD_2_F37B9D40CAB505DE_OFFSET UNITYSDK_OFFSET(0x17B5FCC0)
#define CLASS_2_E12AF574385C1C4F_METHOD_2_F9AAF7C025455ADA_OFFSET UNITYSDK_OFFSET(0x17B60030)
#define CLASS_2_E12AF574385C1C4F_ONCREATE_OFFSET UNITYSDK_OFFSET(0x17B5F720)
#define CLASS_2_E12AF574385C1C4F_UPDATE_OFFSET UNITYSDK_OFFSET(0x17B5F830)
#define CLASS_2_E12AF574385C1C4F__CTOR_OFFSET UNITYSDK_OFFSET(0x17B5F890)

inline static constexpr unsigned int Class_2_E12AF574385C1C4F_TypeDefinitionIndex = 78333;

class Class_2_E12AF574385C1C4F : public ::Foundation::SingletonDisposable_1<::Class_2_E12AF574385C1C4F*>
{
public:
	::System::Collections::Generic::List_1<::MoleMole::ScreenPlayer*>* Field_2_0; // 0x10
	::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::ConfigVideoAudioMapping_VideoAudioEntry*>* Field_2_4; // 0x18
	::System::Collections::Generic::List_1<::MoleMole::ScreenPlayer*>* Field_2_1; // 0x20
	::MoleMole::ConfigVideoAudioMapping* Field_2_3; // 0x28
