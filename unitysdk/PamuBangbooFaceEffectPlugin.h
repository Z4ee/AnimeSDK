...
#define PAMUBANGBOOFACEEFFECTPLUGIN_APPLYOFFSETSCALETOBONE_OFFSET UNITYSDK_OFFSET(0x11EA9230)
#define PAMUBANGBOOFACEEFFECTPLUGIN_CACHEBONELOCALBASESIFNEEDED_OFFSET UNITYSDK_OFFSET(0x11EA72E0)
#define PAMUBANGBOOFACEEFFECTPLUGIN_CENTERLOCALOFFSETTOPARENTLOCAL_OFFSET UNITYSDK_OFFSET(0x11EA8E30)
#define PAMUBANGBOOFACEEFFECTPLUGIN_GETEFFECTCAMERA_OFFSET UNITYSDK_OFFSET(0x11EA86F0)
#define PAMUBANGBOOFACEEFFECTPLUGIN_GETSYMMETRYAXISOFFSET_OFFSET UNITYSDK_OFFSET(0x11EA9080)
#define PAMUBANGBOOFACEEFFECTPLUGIN_GETWORLDAXISDIRECTION_OFFSET UNITYSDK_OFFSET(0x11EA8B10)
#define PAMUBANGBOOFACEEFFECTPLUGIN_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x11EA76D0)
#define PAMUBANGBOOFACEEFFECTPLUGIN_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x11EA8680)
#define PAMUBANGBOOFACEEFFECTPLUGIN_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x11EA85C0)
#define PAMUBANGBOOFACEEFFECTPLUGIN_ONENABLE_OFFSET UNITYSDK_OFFSET(0x11EA7290)
#define PAMUBANGBOOFACEEFFECTPLUGIN_RESETBONEANDFLAG_OFFSET UNITYSDK_OFFSET(0x11EA8630)
#define PAMUBANGBOOFACEEFFECTPLUGIN_RESETOFFSETSCALETOBONE_OFFSET UNITYSDK_OFFSET(0x11EA9370)
#define PAMUBANGBOOFACEEFFECTPLUGIN_UPDATELEFTRIGHTFACEBONESBYCAMERAAXES_OFFSET UNITYSDK_OFFSET(0x11EA7720)
#define PAMUBANGBOOFACEEFFECTPLUGIN_UPDATESTENCILVALUE_OFFSET UNITYSDK_OFFSET(0x11EA8070)
#define PAMUBANGBOOFACEEFFECTPLUGIN__CCTOR_OFFSET UNITYSDK_OFFSET(0x11EA9940)
#define PAMUBANGBOOFACEEFFECTPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x11EA97D0)

inline static constexpr unsigned int PamuBangbooFaceEffectPlugin_TypeDefinitionIndex = 42072;
...
public:
	...
	{
		return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(PamuBangbooFaceEffectPlugin_TypeDefinitionIndex)->GetStaticField(0x4DB90);
	}
