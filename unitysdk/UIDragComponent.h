...
#define UIDRAGCOMPONENT_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A0EBE40)
#define UIDRAGCOMPONENT_FORBIDRIGHTMOUSEINPUT_OFFSET UNITYSDK_OFFSET(0x1A0ED410)
#define UIDRAGCOMPONENT_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x1A0ECA70)
#define UIDRAGCOMPONENT_REGISTERCALLBACK_1_OFFSET UNITYSDK_OFFSET(0x1A0ED170)
#define UIDRAGCOMPONENT_REGISTERCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A0ECD30)
#define UIDRAGCOMPONENT_RESET_OFFSET UNITYSDK_OFFSET(0x1A0ED460)
#define UIDRAGCOMPONENT_UNITYENGINE_EVENTSYSTEMS_IBEGINDRAGHANDLER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x1A0EBF10)
#define UIDRAGCOMPONENT_UNITYENGINE_EVENTSYSTEMS_IDRAGHANDLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1A0EC1F0)
#define UIDRAGCOMPONENT_UNITYENGINE_EVENTSYSTEMS_IENDDRAGHANDLER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x1A0EC4D0)
#define UIDRAGCOMPONENT_UNITYENGINE_EVENTSYSTEMS_IPOINTERDOWNHANDLER_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x1A0EC7B0)
#define UIDRAGCOMPONENT_UNREGISTERCALLBACK_1_OFFSET UNITYSDK_OFFSET(0x1A0ED2C0)
#define UIDRAGCOMPONENT_UNREGISTERCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A0ECF50)
#define UIDRAGCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0ED4C0)

inline static constexpr unsigned int UIDragComponent_TypeDefinitionIndex = 40242;
