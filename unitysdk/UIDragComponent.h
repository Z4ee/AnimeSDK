...
#define UIDRAGCOMPONENT_AWAKE_OFFSET UNITYSDK_OFFSET(0x1C3EFA20)
#define UIDRAGCOMPONENT_FORBIDRIGHTMOUSEINPUT_OFFSET UNITYSDK_OFFSET(0x1C3F0FF0)
#define UIDRAGCOMPONENT_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x1C3F0650)
#define UIDRAGCOMPONENT_REGISTERCALLBACK_1_OFFSET UNITYSDK_OFFSET(0x1C3F0D50)
#define UIDRAGCOMPONENT_REGISTERCALLBACK_OFFSET UNITYSDK_OFFSET(0x1C3F0910)
#define UIDRAGCOMPONENT_RESET_OFFSET UNITYSDK_OFFSET(0x1C3F1040)
#define UIDRAGCOMPONENT_UNITYENGINE_EVENTSYSTEMS_IBEGINDRAGHANDLER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x1C3EFAF0)
#define UIDRAGCOMPONENT_UNITYENGINE_EVENTSYSTEMS_IDRAGHANDLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1C3EFDD0)
#define UIDRAGCOMPONENT_UNITYENGINE_EVENTSYSTEMS_IENDDRAGHANDLER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x1C3F00B0)
#define UIDRAGCOMPONENT_UNITYENGINE_EVENTSYSTEMS_IPOINTERDOWNHANDLER_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x1C3F0390)
#define UIDRAGCOMPONENT_UNREGISTERCALLBACK_1_OFFSET UNITYSDK_OFFSET(0x1C3F0EA0)
#define UIDRAGCOMPONENT_UNREGISTERCALLBACK_OFFSET UNITYSDK_OFFSET(0x1C3F0B30)
#define UIDRAGCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3F10A0)

inline static constexpr unsigned int UIDragComponent_TypeDefinitionIndex = 82272;
