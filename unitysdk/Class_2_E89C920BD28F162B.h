...
#define CLASS_2_E89C920BD28F162B_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD7E5DF0)
#define CLASS_2_E89C920BD28F162B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xD7E5CD0)
#define CLASS_2_E89C920BD28F162B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xD7E5DA0)
#define CLASS_2_E89C920BD28F162B_TICK_OFFSET UNITYSDK_OFFSET(0xD7E5E30)
#define CLASS_2_E89C920BD28F162B__CTOR_OFFSET UNITYSDK_OFFSET(0xD7E5CC0)

inline static constexpr unsigned int Class_2_E89C920BD28F162B_TypeDefinitionIndex = 54415;

class Class_2_E89C920BD28F162B : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::MonopolyDestroyWorld* Field_2_0; // 0x18
