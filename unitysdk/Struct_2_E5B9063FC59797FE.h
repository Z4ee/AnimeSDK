...
#define STRUCT_2_E5B9063FC59797FE__CCTOR_OFFSET UNITYSDK_OFFSET(0x10FCAF30)

inline static constexpr unsigned int Struct_2_E5B9063FC59797FE_TypeDefinitionIndex = 70224;

struct alignas(8) Struct_2_E5B9063FC59797FE
{
	static ::System::String** StaticGet_Field_2_5()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Struct_2_E5B9063FC59797FE_TypeDefinitionIndex)->GetStaticField(0x39610);
	}
