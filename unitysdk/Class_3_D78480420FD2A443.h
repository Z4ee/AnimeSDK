...
#define CLASS_3_D78480420FD2A443_DISPOSE_OFFSET UNITYSDK_OFFSET(0x89EE180)
#define CLASS_3_D78480420FD2A443_METHOD_3_A2AC2E0FF37103AB_OFFSET UNITYSDK_OFFSET(0x89EE6A0)
#define CLASS_3_D78480420FD2A443_METHOD_3_AF29D9D849AE3973_OFFSET UNITYSDK_OFFSET(0x89EE3F0)
#define CLASS_3_D78480420FD2A443_METHOD_3_BED35D89A6A10D7A_OFFSET UNITYSDK_OFFSET(0x89EE7E0)
#define CLASS_3_D78480420FD2A443_TICK_OFFSET UNITYSDK_OFFSET(0x89EE1D0)
#define CLASS_3_D78480420FD2A443__CTOR_OFFSET UNITYSDK_OFFSET(0x89EDF70)
#define CLASS_3_D78480420FD2A443__PREPAREDATA_OFFSET UNITYSDK_OFFSET(0x89EE390)
#define CLASS_3_D78480420FD2A443__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x89EE4F0)
#define CLASS_3_D78480420FD2A443__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x89EE5D0)
#define CLASS_3_D78480420FD2A443___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x89EEA20)
#define CLASS_3_D78480420FD2A443___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x89EEA70)
#define CLASS_3_D78480420FD2A443___IFIXBASEPROXY__PREPAREDATA_OFFSET UNITYSDK_OFFSET(0x89EEA80)
#define CLASS_3_D78480420FD2A443___IFIXBASEPROXY__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x89EEAE0)
#define CLASS_3_D78480420FD2A443___IFIXBASEPROXY__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x89EEAF0)

inline static constexpr unsigned int Class_3_D78480420FD2A443_TypeDefinitionIndex = 47522;

class Class_3_D78480420FD2A443 : public ::RPG::GameCore::AdvWaitingTaskBase_1<::RPG::GameCore::WaitAnimStateChangeV2*>
{
public:
	::Class_2_705B862E649BF345* Field_3_2; // 0x68
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + CLASS_3_D78480420FD2A443___IFIXBASEPROXY_TICK_OFFSET))(this, P0);
	}
