...
#define CLASS_1_FD2182C93CE4D927_METHOD_1_5C07AC6B562A2160_OFFSET UNITYSDK_OFFSET(0xD1B50E0)
#define CLASS_1_FD2182C93CE4D927_METHOD_1_6778013C4BE543AA_OFFSET UNITYSDK_OFFSET(0xD1B54A0)
#define CLASS_1_FD2182C93CE4D927_METHOD_1_794372DBC0F29516_OFFSET UNITYSDK_OFFSET(0xD1B5940)
#define CLASS_1_FD2182C93CE4D927_METHOD_1_7F121A408DC1AB93_OFFSET UNITYSDK_OFFSET(0xD1B4460)
#define CLASS_1_FD2182C93CE4D927_METHOD_1_8C6E66D260CC37AD_OFFSET UNITYSDK_OFFSET(0xD1B5F10)
#define CLASS_1_FD2182C93CE4D927_METHOD_1_9A0F2E1BF8D3FADB_OFFSET UNITYSDK_OFFSET(0xD1B5BF0)
#define CLASS_1_FD2182C93CE4D927_METHOD_1_B9196C576870EF00_OFFSET UNITYSDK_OFFSET(0xD1B63B0)
#define CLASS_1_FD2182C93CE4D927_METHOD_1_B9F28A541C75B6BB_OFFSET UNITYSDK_OFFSET(0xD1B48E0)
#define CLASS_1_FD2182C93CE4D927_METHOD_1_E4C54787AF0B49EF_OFFSET UNITYSDK_OFFSET(0xD1B43D0)
#define CLASS_1_FD2182C93CE4D927_METHOD_1_FDCEA86BDA7EFC5E_OFFSET UNITYSDK_OFFSET(0xD1B6170)
#define CLASS_1_FD2182C93CE4D927_METHOD_1_FFDAD09A37C2FF6E_OFFSET UNITYSDK_OFFSET(0xD1B6040)
#define CLASS_1_FD2182C93CE4D927__CCTOR_OFFSET UNITYSDK_OFFSET(0xD1B6560)
#define CLASS_1_FD2182C93CE4D927__CTOR_OFFSET UNITYSDK_OFFSET(0xD1B3FE0)

inline static constexpr unsigned int Class_1_FD2182C93CE4D927_TypeDefinitionIndex = 50680;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_FD2182C93CE4D927_TypeDefinitionIndex)->GetStaticField(0x12590);
	}
	static ::System::Int32* StaticGet_Field_1_2()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_FD2182C93CE4D927_TypeDefinitionIndex)->GetStaticField(0x12594);
	}
	static ::System::Int32* StaticGet_Field_1_3()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_FD2182C93CE4D927_TypeDefinitionIndex)->GetStaticField(0x12598);
	}
	::Class_0_16E4307DCC419505_559* Field_1_0; // 0x10
	::System::Single Field_1_1; // 0x18

	::System::Void _ctor(::Class_0_16E4307DCC419505_559* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_559*))((::PBYTE)hIl2Cpp + CLASS_1_FD2182C93CE4D927__CTOR_OFFSET))(this, a1);
	}
