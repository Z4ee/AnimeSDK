...
#define STRUCT_2_25F7E31FCD8D52C3_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7AEE10)
#define STRUCT_2_25F7E31FCD8D52C3_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x41FC30)
#define STRUCT_2_25F7E31FCD8D52C3_METHOD_2_3105EAD418A897C1_OFFSET UNITYSDK_OFFSET(0x7AEF50)
#define STRUCT_2_25F7E31FCD8D52C3_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x7AEE50)
#define STRUCT_2_25F7E31FCD8D52C3_RESET_OFFSET UNITYSDK_OFFSET(0x7AEE60)
#define STRUCT_2_25F7E31FCD8D52C3_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x7AEEC0)
#define STRUCT_2_25F7E31FCD8D52C3__CTOR_OFFSET UNITYSDK_OFFSET(0x7AEDE0)

inline static constexpr unsigned int Struct_2_25F7E31FCD8D52C3_TypeDefinitionIndex = 40975;

struct alignas(4) Struct_2_25F7E31FCD8D52C3
{
	::Enum_3_688F44EEB4FF6017 Field_2_2; // 0x10
	::MoleMole::HollowChessboard::ChessboardView::LineInfo Field_2_1; // 0x14
	::UnityEngine::Vector3Int Field_2_0; // 0x2C
