...
#define STRUCT_2_C2A8EAAA55542082__CTOR_OFFSET UNITYSDK_OFFSET(0x342140)

inline static constexpr unsigned int Struct_2_C2A8EAAA55542082_TypeDefinitionIndex = 90454;

struct alignas(1) Struct_2_C2A8EAAA55542082
{
	::System::Boolean Field_2_1; // 0x10
	::Enum_3_B009262C81039D6C Field_2_0; // 0x11
