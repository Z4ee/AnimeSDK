...
#define CLASS_3_E374445C298C7C77_5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1585DF60)
#define CLASS_3_E374445C298C7C77_5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1585DFF0)
#define CLASS_3_E374445C298C7C77_5__CTOR_OFFSET UNITYSDK_OFFSET(0x1585DF30)

inline static constexpr unsigned int Class_3_E374445C298C7C77_5_TypeDefinitionIndex = 51180;
