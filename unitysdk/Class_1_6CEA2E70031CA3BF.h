...
#define CLASS_1_6CEA2E70031CA3BF__CTOR_OFFSET UNITYSDK_OFFSET(0x1527D070)
...
{
public:
	::System::UInt32 LJMHECKCBKH; // 0x10
	::RPG::Client::VoiceType KJMPDIHMBGO; // 0x14
	::System::UInt32 CDAMNNDDJAN; // 0x18
