...
#define CLASS_1_D4E2A0605A71F3AC_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC13EDC0)
#define CLASS_1_D4E2A0605A71F3AC_METHOD_1_025E4B1A2211CF52_OFFSET UNITYSDK_OFFSET(0xC13F7C0)
#define CLASS_1_D4E2A0605A71F3AC_METHOD_1_122508E459F25D87_OFFSET UNITYSDK_OFFSET(0xC140200)
#define CLASS_1_D4E2A0605A71F3AC_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xC13FCD0)
#define CLASS_1_D4E2A0605A71F3AC_METHOD_1_637DBA7901C3991A_OFFSET UNITYSDK_OFFSET(0xC13EFD0)
#define CLASS_1_D4E2A0605A71F3AC_METHOD_1_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0xC13EE10)
#define CLASS_1_D4E2A0605A71F3AC_METHOD_1_9C22BF803F744161_OFFSET UNITYSDK_OFFSET(0xC13F340)
#define CLASS_1_D4E2A0605A71F3AC_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0xC1401A0)
#define CLASS_1_D4E2A0605A71F3AC_METHOD_1_D67046CBB357BF79_OFFSET UNITYSDK_OFFSET(0xC140A40)
#define CLASS_1_D4E2A0605A71F3AC_METHOD_1_E548C3CF0994CD38_OFFSET UNITYSDK_OFFSET(0xC13FD40)
#define CLASS_1_D4E2A0605A71F3AC_METHOD_1_E681B6D41E5607D0_1_OFFSET UNITYSDK_OFFSET(0xC140990)
#define CLASS_1_D4E2A0605A71F3AC_METHOD_1_E681B6D41E5607D0_OFFSET UNITYSDK_OFFSET(0xC1408E0)
#define CLASS_1_D4E2A0605A71F3AC_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xC140190)
#define CLASS_1_D4E2A0605A71F3AC__CCTOR_OFFSET UNITYSDK_OFFSET(0xC140C70)
#define CLASS_1_D4E2A0605A71F3AC__CTOR_OFFSET UNITYSDK_OFFSET(0xC13EDB0)

inline static constexpr unsigned int Class_1_D4E2A0605A71F3AC_TypeDefinitionIndex = 73690;
...
public:
	...
	{
		return (::RPG::Client::RPGProfilerMarker**)Il2CppClass::FromTypeDefinitionIndex(Class_1_D4E2A0605A71F3AC_TypeDefinitionIndex)->GetStaticField(0x5ECF0);
	}
	...
	::Class_1_1342B57709FD7AC5* KDFPNFHHNGA; // 0x18
	::UnityEngine::GameObject* FEGGKFOOFLI; // 0x20
	::Class_2_250DE1D032671F25* BHHAMGJHDON; // 0x28
	::Class_0_16E4307DCC419505_1182* FCMGMJJCHCI; // 0x30
	::Class_1_1342B57709FD7AC5* HLIGDBAEAEG; // 0x38
	::Class_0_16E4307DCC419505_1182* EIHPDMPGPFB; // 0x40
	::System::Single DPFLANOOHBE; // 0x48
	::System::Single IEHPFADHJFD; // 0x4C
	::System::Boolean CMHPBKHKFMG; // 0x50
	::Class_1_D4E2A0605A71F3AC_FadingDoneActionType LNJBHEFKJCH; // 0x54
