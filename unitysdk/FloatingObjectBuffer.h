...
#define FLOATINGOBJECTBUFFER_GET_SIMPARTICLECOUNT_OFFSET UNITYSDK_OFFSET(0x13830160)
#define FLOATINGOBJECTBUFFER_METHOD_1_33FF6C2A9A5A7FC3_OFFSET UNITYSDK_OFFSET(0x138309C0)
#define FLOATINGOBJECTBUFFER_METHOD_1_920CE21000EB4B8F_OFFSET UNITYSDK_OFFSET(0x13830880)
#define FLOATINGOBJECTBUFFER_METHOD_1_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x13831170)
#define FLOATINGOBJECTBUFFER_METHOD_1_9B4F9A6EF59CF365_1_OFFSET UNITYSDK_OFFSET(0x138310F0)
#define FLOATINGOBJECTBUFFER_METHOD_1_9B4F9A6EF59CF365_OFFSET UNITYSDK_OFFSET(0x13831070)
#define FLOATINGOBJECTBUFFER_METHOD_1_AE231BEA38F773A1_OFFSET UNITYSDK_OFFSET(0x138301B0)
#define FLOATINGOBJECTBUFFER_METHOD_1_C440F43DE8FB4205_1_OFFSET UNITYSDK_OFFSET(0x13830930)
#define FLOATINGOBJECTBUFFER_METHOD_1_C440F43DE8FB4205_OFFSET UNITYSDK_OFFSET(0x138308E0)
#define FLOATINGOBJECTBUFFER_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x13830FE0)
#define FLOATINGOBJECTBUFFER_METHOD_1_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x13831020)
#define FLOATINGOBJECTBUFFER_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x13830980)
#define FLOATINGOBJECTBUFFER_METHOD_1_CCF7A015FEFCDABD_OFFSET UNITYSDK_OFFSET(0x13830E30)
#define FLOATINGOBJECTBUFFER_METHOD_1_E824431C22EF9361_OFFSET UNITYSDK_OFFSET(0x138306A0)
#define FLOATINGOBJECTBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x138311C0)

inline static constexpr unsigned int FloatingObjectBuffer_TypeDefinitionIndex = 44786;
