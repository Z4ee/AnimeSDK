...
#define FLOATINGOBJECTBUFFER_GET_SIMPARTICLECOUNT_OFFSET UNITYSDK_OFFSET(0x19120260)
#define FLOATINGOBJECTBUFFER_METHOD_1_33FF6C2A9A5A7FC3_OFFSET UNITYSDK_OFFSET(0x19120AC0)
#define FLOATINGOBJECTBUFFER_METHOD_1_920CE21000EB4B8F_OFFSET UNITYSDK_OFFSET(0x19120980)
#define FLOATINGOBJECTBUFFER_METHOD_1_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x19121270)
#define FLOATINGOBJECTBUFFER_METHOD_1_9B4F9A6EF59CF365_1_OFFSET UNITYSDK_OFFSET(0x191211F0)
#define FLOATINGOBJECTBUFFER_METHOD_1_9B4F9A6EF59CF365_OFFSET UNITYSDK_OFFSET(0x19121170)
#define FLOATINGOBJECTBUFFER_METHOD_1_AE231BEA38F773A1_OFFSET UNITYSDK_OFFSET(0x191202B0)
#define FLOATINGOBJECTBUFFER_METHOD_1_C440F43DE8FB4205_1_OFFSET UNITYSDK_OFFSET(0x19120A30)
#define FLOATINGOBJECTBUFFER_METHOD_1_C440F43DE8FB4205_OFFSET UNITYSDK_OFFSET(0x191209E0)
#define FLOATINGOBJECTBUFFER_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x191210E0)
#define FLOATINGOBJECTBUFFER_METHOD_1_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x19121120)
#define FLOATINGOBJECTBUFFER_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x19120A80)
#define FLOATINGOBJECTBUFFER_METHOD_1_CCF7A015FEFCDABD_OFFSET UNITYSDK_OFFSET(0x19120F30)
#define FLOATINGOBJECTBUFFER_METHOD_1_E824431C22EF9361_OFFSET UNITYSDK_OFFSET(0x191207A0)
#define FLOATINGOBJECTBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x191212C0)
