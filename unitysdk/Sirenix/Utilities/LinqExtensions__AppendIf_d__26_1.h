...
{
	inline static constexpr unsigned int LinqExtensions__AppendIf_d__26_1_TypeDefinitionIndex = 6467;

	template <typename T>
	class LinqExtensions__AppendIf_d__26_1 : public ::System::Object
	{
	public:
