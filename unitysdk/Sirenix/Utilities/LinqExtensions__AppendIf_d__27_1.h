...
{
	inline static constexpr unsigned int LinqExtensions__AppendIf_d__27_1_TypeDefinitionIndex = 6472;

	template <typename T>
	class LinqExtensions__AppendIf_d__27_1 : public ::System::Object
	{
	public:
