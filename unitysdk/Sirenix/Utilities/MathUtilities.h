...
#define SIRENIX_UTILITIES_MATHUTILITIES_ABS_OFFSET UNITYSDK_OFFSET(0x1BAD6A90)
#define SIRENIX_UTILITIES_MATHUTILITIES_BOUNCEEASEINFASTOUT_OFFSET UNITYSDK_OFFSET(0x1BAD66F0)
#define SIRENIX_UTILITIES_MATHUTILITIES_BOUNCE_OFFSET UNITYSDK_OFFSET(0x1BAD68C0)
#define SIRENIX_UTILITIES_MATHUTILITIES_CLAMPWRAPANGLE_OFFSET UNITYSDK_OFFSET(0x1BAD7AF0)
#define SIRENIX_UTILITIES_MATHUTILITIES_CLAMP_1_OFFSET UNITYSDK_OFFSET(0x1BAD6D30)
#define SIRENIX_UTILITIES_MATHUTILITIES_CLAMP_OFFSET UNITYSDK_OFFSET(0x1BAD6CB0)
#define SIRENIX_UTILITIES_MATHUTILITIES_COMPUTEBYTEARRAYHASH_OFFSET UNITYSDK_OFFSET(0x1BAD6D90)
#define SIRENIX_UTILITIES_MATHUTILITIES_DISCARDLEASTSIGNIFICANTDECIMAL_OFFSET UNITYSDK_OFFSET(0x1BAD7960)
#define SIRENIX_UTILITIES_MATHUTILITIES_EASEINELASTIC_OFFSET UNITYSDK_OFFSET(0x1BAD68F0)
#define SIRENIX_UTILITIES_MATHUTILITIES_EASEINOUT_OFFSET UNITYSDK_OFFSET(0x1BAD6C50)
#define SIRENIX_UTILITIES_MATHUTILITIES_EASEOUTELASTIC_OFFSET UNITYSDK_OFFSET(0x1BAD6B10)
#define SIRENIX_UTILITIES_MATHUTILITIES_FRACT_1_OFFSET UNITYSDK_OFFSET(0x1BAD65B0)
#define SIRENIX_UTILITIES_MATHUTILITIES_FRACT_2_OFFSET UNITYSDK_OFFSET(0x1BAD6630)
#define SIRENIX_UTILITIES_MATHUTILITIES_FRACT_OFFSET UNITYSDK_OFFSET(0x1BAD6570)
#define SIRENIX_UTILITIES_MATHUTILITIES_GETNUMBEROFDECIMALSFORMINIMUMDIFFERENCE_OFFSET UNITYSDK_OFFSET(0x1BAD7AB0)
#define SIRENIX_UTILITIES_MATHUTILITIES_HERMITE01_OFFSET UNITYSDK_OFFSET(0x1BAD6730)
#define SIRENIX_UTILITIES_MATHUTILITIES_HERMITE_OFFSET UNITYSDK_OFFSET(0x1BAD6430)
#define SIRENIX_UTILITIES_MATHUTILITIES_INFINITELINEINTERSECT_OFFSET UNITYSDK_OFFSET(0x1BAD7330)
#define SIRENIX_UTILITIES_MATHUTILITIES_INTERPOLATEPOINTS_OFFSET UNITYSDK_OFFSET(0x1BAD6E80)
#define SIRENIX_UTILITIES_MATHUTILITIES_LERPUNCLAMPED_1_OFFSET UNITYSDK_OFFSET(0x1BAD6880)
#define SIRENIX_UTILITIES_MATHUTILITIES_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x1BAD6840)
#define SIRENIX_UTILITIES_MATHUTILITIES_LINEARSTEP_OFFSET UNITYSDK_OFFSET(0x1BAD7730)
#define SIRENIX_UTILITIES_MATHUTILITIES_LINEDISTTOPLANE_OFFSET UNITYSDK_OFFSET(0x1BAD7470)
#define SIRENIX_UTILITIES_MATHUTILITIES_LINEINTERSECTSLINE_OFFSET UNITYSDK_OFFSET(0x1BAD71A0)
#define SIRENIX_UTILITIES_MATHUTILITIES_POINTDISTANCETOLINE_OFFSET UNITYSDK_OFFSET(0x1BAD63C0)
#define SIRENIX_UTILITIES_MATHUTILITIES_POW_OFFSET UNITYSDK_OFFSET(0x1BAD6A20)
#define SIRENIX_UTILITIES_MATHUTILITIES_RAYDISTTOPLANE_OFFSET UNITYSDK_OFFSET(0x1BAD7500)
#define SIRENIX_UTILITIES_MATHUTILITIES_ROTATEPOINT_1_OFFSET UNITYSDK_OFFSET(0x1BAD7610)
#define SIRENIX_UTILITIES_MATHUTILITIES_ROTATEPOINT_OFFSET UNITYSDK_OFFSET(0x1BAD7570)
#define SIRENIX_UTILITIES_MATHUTILITIES_ROUNDBASEDONMINIMUMDIFFERENCE_OFFSET UNITYSDK_OFFSET(0x1BAD78C0)
#define SIRENIX_UTILITIES_MATHUTILITIES_SIGN_OFFSET UNITYSDK_OFFSET(0x1BAD6AC0)
#define SIRENIX_UTILITIES_MATHUTILITIES_SMOOTHSTEP_OFFSET UNITYSDK_OFFSET(0x1BAD76F0)
#define SIRENIX_UTILITIES_MATHUTILITIES_STACKHERMITE01_OFFSET UNITYSDK_OFFSET(0x1BAD6770)
#define SIRENIX_UTILITIES_MATHUTILITIES_STACKHERMITE_OFFSET UNITYSDK_OFFSET(0x1BAD6470)
#define SIRENIX_UTILITIES_MATHUTILITIES_WRAP_1_OFFSET UNITYSDK_OFFSET(0x1BAD77F0)
#define SIRENIX_UTILITIES_MATHUTILITIES_WRAP_2_OFFSET UNITYSDK_OFFSET(0x1BAD7870)
#define SIRENIX_UTILITIES_MATHUTILITIES_WRAP_OFFSET UNITYSDK_OFFSET(0x1BAD7760)

namespace Sirenix::Utilities
{
	inline static constexpr unsigned int MathUtilities_TypeDefinitionIndex = 6453;
