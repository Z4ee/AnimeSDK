...
#define SIRENIX_UTILITIES_MATHUTILITIES_ABS_OFFSET UNITYSDK_OFFSET(0x1F25E9C0)
#define SIRENIX_UTILITIES_MATHUTILITIES_BOUNCEEASEINFASTOUT_OFFSET UNITYSDK_OFFSET(0x1F25E660)
#define SIRENIX_UTILITIES_MATHUTILITIES_BOUNCE_OFFSET UNITYSDK_OFFSET(0x1F25E7E0)
#define SIRENIX_UTILITIES_MATHUTILITIES_CLAMPWRAPANGLE_OFFSET UNITYSDK_OFFSET(0x1F25F9E0)
#define SIRENIX_UTILITIES_MATHUTILITIES_CLAMP_1_OFFSET UNITYSDK_OFFSET(0x1F25EC80)
#define SIRENIX_UTILITIES_MATHUTILITIES_CLAMP_OFFSET UNITYSDK_OFFSET(0x1F25EC00)
#define SIRENIX_UTILITIES_MATHUTILITIES_COMPUTEBYTEARRAYHASH_OFFSET UNITYSDK_OFFSET(0x1F25ECE0)
#define SIRENIX_UTILITIES_MATHUTILITIES_DISCARDLEASTSIGNIFICANTDECIMAL_OFFSET UNITYSDK_OFFSET(0x1F25F850)
#define SIRENIX_UTILITIES_MATHUTILITIES_EASEINELASTIC_OFFSET UNITYSDK_OFFSET(0x1F25E810)
#define SIRENIX_UTILITIES_MATHUTILITIES_EASEINOUT_OFFSET UNITYSDK_OFFSET(0x1F25EB90)
#define SIRENIX_UTILITIES_MATHUTILITIES_EASEOUTELASTIC_OFFSET UNITYSDK_OFFSET(0x1F25EA40)
#define SIRENIX_UTILITIES_MATHUTILITIES_FRACT_1_OFFSET UNITYSDK_OFFSET(0x1F25E520)
#define SIRENIX_UTILITIES_MATHUTILITIES_FRACT_2_OFFSET UNITYSDK_OFFSET(0x1F25E5A0)
#define SIRENIX_UTILITIES_MATHUTILITIES_FRACT_OFFSET UNITYSDK_OFFSET(0x1F25E4E0)
#define SIRENIX_UTILITIES_MATHUTILITIES_GETNUMBEROFDECIMALSFORMINIMUMDIFFERENCE_OFFSET UNITYSDK_OFFSET(0x1F25F9A0)
#define SIRENIX_UTILITIES_MATHUTILITIES_HERMITE01_OFFSET UNITYSDK_OFFSET(0x1F25E6A0)
#define SIRENIX_UTILITIES_MATHUTILITIES_HERMITE_OFFSET UNITYSDK_OFFSET(0x1F25E420)
#define SIRENIX_UTILITIES_MATHUTILITIES_INFINITELINEINTERSECT_OFFSET UNITYSDK_OFFSET(0x1F25F240)
#define SIRENIX_UTILITIES_MATHUTILITIES_INTERPOLATEPOINTS_OFFSET UNITYSDK_OFFSET(0x1F25EDE0)
#define SIRENIX_UTILITIES_MATHUTILITIES_LERPUNCLAMPED_1_OFFSET UNITYSDK_OFFSET(0x1F25E7A0)
#define SIRENIX_UTILITIES_MATHUTILITIES_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x1F25E760)
#define SIRENIX_UTILITIES_MATHUTILITIES_LINEARSTEP_OFFSET UNITYSDK_OFFSET(0x1F25F620)
#define SIRENIX_UTILITIES_MATHUTILITIES_LINEDISTTOPLANE_OFFSET UNITYSDK_OFFSET(0x1F25F380)
#define SIRENIX_UTILITIES_MATHUTILITIES_LINEINTERSECTSLINE_OFFSET UNITYSDK_OFFSET(0x1F25F0C0)
#define SIRENIX_UTILITIES_MATHUTILITIES_POINTDISTANCETOLINE_OFFSET UNITYSDK_OFFSET(0x1F25E3E0)
#define SIRENIX_UTILITIES_MATHUTILITIES_POW_OFFSET UNITYSDK_OFFSET(0x1F25E950)
#define SIRENIX_UTILITIES_MATHUTILITIES_RAYDISTTOPLANE_OFFSET UNITYSDK_OFFSET(0x1F25F3F0)
#define SIRENIX_UTILITIES_MATHUTILITIES_ROTATEPOINT_1_OFFSET UNITYSDK_OFFSET(0x1F25F500)
#define SIRENIX_UTILITIES_MATHUTILITIES_ROTATEPOINT_OFFSET UNITYSDK_OFFSET(0x1F25F460)
#define SIRENIX_UTILITIES_MATHUTILITIES_ROUNDBASEDONMINIMUMDIFFERENCE_OFFSET UNITYSDK_OFFSET(0x1F25F7B0)
#define SIRENIX_UTILITIES_MATHUTILITIES_SIGN_OFFSET UNITYSDK_OFFSET(0x1F25E9F0)
#define SIRENIX_UTILITIES_MATHUTILITIES_SMOOTHSTEP_OFFSET UNITYSDK_OFFSET(0x1F25F5E0)
#define SIRENIX_UTILITIES_MATHUTILITIES_STACKHERMITE01_OFFSET UNITYSDK_OFFSET(0x1F25E6F0)
#define SIRENIX_UTILITIES_MATHUTILITIES_STACKHERMITE_OFFSET UNITYSDK_OFFSET(0x1F25E460)
#define SIRENIX_UTILITIES_MATHUTILITIES_WRAP_1_OFFSET UNITYSDK_OFFSET(0x1F25F6E0)
#define SIRENIX_UTILITIES_MATHUTILITIES_WRAP_2_OFFSET UNITYSDK_OFFSET(0x1F25F760)
#define SIRENIX_UTILITIES_MATHUTILITIES_WRAP_OFFSET UNITYSDK_OFFSET(0x1F25F650)

namespace Sirenix::Utilities
{
	inline static constexpr unsigned int MathUtilities_TypeDefinitionIndex = 6502;
