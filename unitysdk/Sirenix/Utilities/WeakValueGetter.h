...
#define SIRENIX_UTILITIES_WEAKVALUEGETTER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F2668A0)
#define SIRENIX_UTILITIES_WEAKVALUEGETTER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F2668D0)
#define SIRENIX_UTILITIES_WEAKVALUEGETTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F2665B0)
#define SIRENIX_UTILITIES_WEAKVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F266590)

namespace Sirenix::Utilities
{
	inline static constexpr unsigned int WeakValueGetter_TypeDefinitionIndex = 6483;
