...
#define SIRENIX_UTILITIES_COLOREXTENSIONS_LERP_OFFSET UNITYSDK_OFFSET(0x1F25AB90)
#define SIRENIX_UTILITIES_COLOREXTENSIONS_MOVETOWARDS_OFFSET UNITYSDK_OFFSET(0x1F25AC60)
#define SIRENIX_UTILITIES_COLOREXTENSIONS_NORMALIZERGB_OFFSET UNITYSDK_OFFSET(0x1F25B620)
#define SIRENIX_UTILITIES_COLOREXTENSIONS_POW_OFFSET UNITYSDK_OFFSET(0x1F25B5B0)
#define SIRENIX_UTILITIES_COLOREXTENSIONS_TOCSHARPCOLOR_OFFSET UNITYSDK_OFFSET(0x1F25B260)
#define SIRENIX_UTILITIES_COLOREXTENSIONS_TRIMFLOAT_OFFSET UNITYSDK_OFFSET(0x1F25B440)
#define SIRENIX_UTILITIES_COLOREXTENSIONS_TRYPARSESTRING_OFFSET UNITYSDK_OFFSET(0x1F25ADB0)
#define SIRENIX_UTILITIES_COLOREXTENSIONS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F25B690)

namespace Sirenix::Utilities
{
	inline static constexpr unsigned int ColorExtensions_TypeDefinitionIndex = 6440;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(ColorExtensions_TypeDefinitionIndex)->GetStaticField(0x59F0);
		}
