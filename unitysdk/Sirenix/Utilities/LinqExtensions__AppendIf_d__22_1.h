...
{
	inline static constexpr unsigned int LinqExtensions__AppendIf_d__22_1_TypeDefinitionIndex = 6463;

	template <typename T>
	class LinqExtensions__AppendIf_d__22_1 : public ::System::Object
	{
	public:
