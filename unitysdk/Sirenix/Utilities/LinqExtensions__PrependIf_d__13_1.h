...
{
	inline static constexpr unsigned int LinqExtensions__PrependIf_d__13_1_TypeDefinitionIndex = 6458;

	template <typename T>
	class LinqExtensions__PrependIf_d__13_1 : public ::System::Object
	{
	public:
