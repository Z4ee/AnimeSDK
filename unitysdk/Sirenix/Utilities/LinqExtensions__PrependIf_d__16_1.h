...
{
	inline static constexpr unsigned int LinqExtensions__PrependIf_d__16_1_TypeDefinitionIndex = 6457;

	template <typename T>
	class LinqExtensions__PrependIf_d__16_1 : public ::System::Object
	{
	public:
