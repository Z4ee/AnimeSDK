...
#define SIRENIX_UTILITIES_STRINGEXTENSIONS_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1F25D0A0)
#define SIRENIX_UTILITIES_STRINGEXTENSIONS_ISNULLORWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1F264420)
#define SIRENIX_UTILITIES_STRINGEXTENSIONS_SPLITPASCALCASE_OFFSET UNITYSDK_OFFSET(0x1F264060)
#define SIRENIX_UTILITIES_STRINGEXTENSIONS_TOTITLECASE_OFFSET UNITYSDK_OFFSET(0x1F263EA0)

namespace Sirenix::Utilities
{
	inline static constexpr unsigned int StringExtensions_TypeDefinitionIndex = 6479;
