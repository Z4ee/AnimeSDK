...
#define SIRENIX_UTILITIES_ODINDEFINESYMBOLS__CTOR_OFFSET UNITYSDK_OFFSET(0x1F260610)

namespace Sirenix::Utilities
{
	inline static constexpr unsigned int OdinDefineSymbols_TypeDefinitionIndex = 6507;
