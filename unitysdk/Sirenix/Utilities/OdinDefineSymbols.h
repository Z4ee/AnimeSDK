...
#define SIRENIX_UTILITIES_ODINDEFINESYMBOLS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE52950)

namespace Sirenix::Utilities
{
	inline static constexpr unsigned int OdinDefineSymbols_TypeDefinitionIndex = 6503;
