...
#define SIRENIX_UTILITIES_UNSAFE_UNSAFEUTILITIES_MEMORYCOPY_OFFSET UNITYSDK_OFFSET(0x1DE585E0)
#define SIRENIX_UTILITIES_UNSAFE_UNSAFEUTILITIES_STRINGFROMBYTES_OFFSET UNITYSDK_OFFSET(0x1DE57BB0)
#define SIRENIX_UTILITIES_UNSAFE_UNSAFEUTILITIES_STRINGTOBYTES_OFFSET UNITYSDK_OFFSET(0x1DE580C0)

namespace Sirenix::Utilities::Unsafe
{
	inline static constexpr unsigned int UnsafeUtilities_TypeDefinitionIndex = 6515;
