...
#define SIRENIX_UTILITIES_UNSAFE_UNSAFEUTILITIES_MEMORYCOPY_OFFSET UNITYSDK_OFFSET(0x1F2661D0)
#define SIRENIX_UTILITIES_UNSAFE_UNSAFEUTILITIES_STRINGFROMBYTES_OFFSET UNITYSDK_OFFSET(0x1F2657F0)
#define SIRENIX_UTILITIES_UNSAFE_UNSAFEUTILITIES_STRINGTOBYTES_OFFSET UNITYSDK_OFFSET(0x1F265CB0)

namespace Sirenix::Utilities::Unsafe
{
	inline static constexpr unsigned int UnsafeUtilities_TypeDefinitionIndex = 6519;
