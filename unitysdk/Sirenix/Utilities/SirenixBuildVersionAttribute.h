...
#define SIRENIX_UTILITIES_SIRENIXBUILDVERSIONATTRIBUTE_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1DE56130)
#define SIRENIX_UTILITIES_SIRENIXBUILDVERSIONATTRIBUTE_SET_VERSION_OFFSET UNITYSDK_OFFSET(0x1DE56140)
#define SIRENIX_UTILITIES_SIRENIXBUILDVERSIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE56150)

namespace Sirenix::Utilities
{
	inline static constexpr unsigned int SirenixBuildVersionAttribute_TypeDefinitionIndex = 6510;
