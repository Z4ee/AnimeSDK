...
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE_GET_ASSETPATHWITHASSETSPREFIX_OFFSET UNITYSDK_OFFSET(0x1BAD4DE0)
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE_GET_ASSETPATHWITHOUTASSETSPREFIX_OFFSET UNITYSDK_OFFSET(0x1BAD4E60)
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE_GET_ASSETPATH_OFFSET UNITYSDK_OFFSET(0x1BAD4C60)
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE_GET_FULLPATH_OFFSET UNITYSDK_OFFSET(0x1BAD4C10)
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE_GET_ISINRESOURCESFOLDER_OFFSET UNITYSDK_OFFSET(0x1BAD5000)
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE_GET_RESOURCESPATH_OFFSET UNITYSDK_OFFSET(0x1BAD4EF0)
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE_GET_USEASSET_OFFSET UNITYSDK_OFFSET(0x1BAD5070)
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE_SET_USEASSET_OFFSET UNITYSDK_OFFSET(0x1BAD5080)
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BAD5100)
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAD50C0)

namespace Sirenix::Utilities
{
	inline static constexpr unsigned int GlobalConfigAttribute_TypeDefinitionIndex = 6445;
