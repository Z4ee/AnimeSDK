...
{
	inline static constexpr unsigned int LinqExtensions__AppendWith_d__19_1_TypeDefinitionIndex = 6464;

	template <typename T>
	class LinqExtensions__AppendWith_d__19_1 : public ::System::Object
	{
	public:
