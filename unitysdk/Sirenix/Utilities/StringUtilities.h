...
#define SIRENIX_UTILITIES_STRINGUTILITIES_FASTENDSWITH_OFFSET UNITYSDK_OFFSET(0x1F264950)
#define SIRENIX_UTILITIES_STRINGUTILITIES_NICIFYBYTESIZE_OFFSET UNITYSDK_OFFSET(0x1F264570)
#define SIRENIX_UTILITIES_STRINGUTILITIES_NUMBERAWARESTRINGCOMPARE_OFFSET UNITYSDK_OFFSET(0x1F264A60)

namespace Sirenix::Utilities
{
	inline static constexpr unsigned int StringUtilities_TypeDefinitionIndex = 6517;
