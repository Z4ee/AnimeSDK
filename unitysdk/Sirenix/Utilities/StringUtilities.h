...
#define SIRENIX_UTILITIES_STRINGUTILITIES_FASTENDSWITH_OFFSET UNITYSDK_OFFSET(0x1DE56D00)
#define SIRENIX_UTILITIES_STRINGUTILITIES_NICIFYBYTESIZE_OFFSET UNITYSDK_OFFSET(0x1DE56930)
#define SIRENIX_UTILITIES_STRINGUTILITIES_NUMBERAWARESTRINGCOMPARE_OFFSET UNITYSDK_OFFSET(0x1DE56E10)

namespace Sirenix::Utilities
{
	inline static constexpr unsigned int StringUtilities_TypeDefinitionIndex = 6513;
