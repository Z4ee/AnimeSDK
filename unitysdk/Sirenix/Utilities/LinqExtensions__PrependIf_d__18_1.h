...
{
	inline static constexpr unsigned int LinqExtensions__PrependIf_d__18_1_TypeDefinitionIndex = 6459;

	template <typename T>
	class LinqExtensions__PrependIf_d__18_1 : public ::System::Object
	{
	public:
