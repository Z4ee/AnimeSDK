...
#define SIRENIX_UTILITIES_SIRENIXASSETPATHS_TOPATHSAFESTRING_OFFSET UNITYSDK_OFFSET(0x1DE55F70)
#define SIRENIX_UTILITIES_SIRENIXASSETPATHS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DE55E80)

namespace Sirenix::Utilities
{
	inline static constexpr unsigned int SirenixAssetPaths_TypeDefinitionIndex = 6507;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(SirenixAssetPaths_TypeDefinitionIndex)->GetStaticField(0x5A30);
		}
		static ::System::String** StaticGet_SirenixAssembliesPath()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(SirenixAssetPaths_TypeDefinitionIndex)->GetStaticField(0x5A38);
		}
