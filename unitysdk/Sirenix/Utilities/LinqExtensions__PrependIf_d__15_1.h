...
{
	inline static constexpr unsigned int LinqExtensions__PrependIf_d__15_1_TypeDefinitionIndex = 6456;

	template <typename T>
	class LinqExtensions__PrependIf_d__15_1 : public ::System::Object
	{
	public:
