...
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_GET_BUILDSERIALIZATIONFORMAT_OFFSET UNITYSDK_OFFSET(0x1FC68A30)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_GET_EDITORSERIALIZATIONFORMAT_OFFSET UNITYSDK_OFFSET(0x1FC68A10)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_GET_ERRORHANDLINGPOLICY_OFFSET UNITYSDK_OFFSET(0x1FC68A70)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_GET_LOGGER_OFFSET UNITYSDK_OFFSET(0x1FC689B0)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_GET_LOGGINGPOLICY_OFFSET UNITYSDK_OFFSET(0x1FC68A50)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_ONINSPECTORGUI_OFFSET UNITYSDK_OFFSET(0x1FC68A90)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_SET_BUILDSERIALIZATIONFORMAT_OFFSET UNITYSDK_OFFSET(0x1FC68A40)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_SET_EDITORSERIALIZATIONFORMAT_OFFSET UNITYSDK_OFFSET(0x1FC68A20)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_SET_ERRORHANDLINGPOLICY_OFFSET UNITYSDK_OFFSET(0x1FC68A80)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_SET_LOGGINGPOLICY_OFFSET UNITYSDK_OFFSET(0x1FC68A60)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FC68F50)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC68EE0)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int GlobalSerializationConfig_TypeDefinitionIndex = 6545;
	...
	public:
		...
		{
			return (::Il2CppArray<::Sirenix::Serialization::DataFormat>**)Il2CppClass::FromTypeDefinitionIndex(GlobalSerializationConfig_TypeDefinitionIndex)->GetStaticField(0x5AB0);
		}
