...
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_GET_BUILDSERIALIZATIONFORMAT_OFFSET UNITYSDK_OFFSET(0x1E889B50)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_GET_EDITORSERIALIZATIONFORMAT_OFFSET UNITYSDK_OFFSET(0x1E889B30)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_GET_ERRORHANDLINGPOLICY_OFFSET UNITYSDK_OFFSET(0x1E889B90)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_GET_LOGGER_OFFSET UNITYSDK_OFFSET(0x1E889AD0)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_GET_LOGGINGPOLICY_OFFSET UNITYSDK_OFFSET(0x1E889B70)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_ONINSPECTORGUI_OFFSET UNITYSDK_OFFSET(0x1E889BB0)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_SET_BUILDSERIALIZATIONFORMAT_OFFSET UNITYSDK_OFFSET(0x1E889B60)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_SET_EDITORSERIALIZATIONFORMAT_OFFSET UNITYSDK_OFFSET(0x1E889B40)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_SET_ERRORHANDLINGPOLICY_OFFSET UNITYSDK_OFFSET(0x1E889BA0)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_SET_LOGGINGPOLICY_OFFSET UNITYSDK_OFFSET(0x1E889B80)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E88A070)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E88A000)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int GlobalSerializationConfig_TypeDefinitionIndex = 6541;
	...
	public:
		...
		{
			return (::Il2CppArray<::Sirenix::Serialization::DataFormat>**)Il2CppClass::FromTypeDefinitionIndex(GlobalSerializationConfig_TypeDefinitionIndex)->GetStaticField(0x5AA0);
		}
