...
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_CONSUMECURRENTENTRY_OFFSET UNITYSDK_OFFSET(0x1D551AB0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D5516B0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_ENTERARRAY_OFFSET UNITYSDK_OFFSET(0x1D551840)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_ENTERNODE_OFFSET UNITYSDK_OFFSET(0x1D551AE0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_EXITARRAY_OFFSET UNITYSDK_OFFSET(0x1D552160)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_EXITNODE_OFFSET UNITYSDK_OFFSET(0x1D552350)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_GETDATADUMP_OFFSET UNITYSDK_OFFSET(0x1D554F90)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_GET_INDEXISVALID_OFFSET UNITYSDK_OFFSET(0x1D551510)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_GET_NODES_OFFSET UNITYSDK_OFFSET(0x1D551530)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_GET_STREAM_OFFSET UNITYSDK_OFFSET(0x1D551610)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_PEEKENTRY_1_OFFSET UNITYSDK_OFFSET(0x1D551A90)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_PEEKENTRY_OFFSET UNITYSDK_OFFSET(0x1D5516F0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_PREPARENEWSERIALIZATIONSESSION_OFFSET UNITYSDK_OFFSET(0x1D5516C0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1D5525C0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READBYTE_OFFSET UNITYSDK_OFFSET(0x1D5526E0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READCHAR_OFFSET UNITYSDK_OFFSET(0x1D552B20)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READDECIMAL_OFFSET UNITYSDK_OFFSET(0x1D552E50)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READDOUBLE_OFFSET UNITYSDK_OFFSET(0x1D553180)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READEXTERNALREFERENCE_1_OFFSET UNITYSDK_OFFSET(0x1D553870)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READEXTERNALREFERENCE_2_OFFSET UNITYSDK_OFFSET(0x1D5538E0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READEXTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1D5534A0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READGUID_OFFSET UNITYSDK_OFFSET(0x1D553C00)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READINT16_OFFSET UNITYSDK_OFFSET(0x1D553FD0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READINT32_OFFSET UNITYSDK_OFFSET(0x1D554410)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READINT64_OFFSET UNITYSDK_OFFSET(0x1D5540F0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READINTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1D554530)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READNULL_OFFSET UNITYSDK_OFFSET(0x1D554850)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READSBYTE_OFFSET UNITYSDK_OFFSET(0x1D5548A0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READSINGLE_OFFSET UNITYSDK_OFFSET(0x1D5549C0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READSTRING_OFFSET UNITYSDK_OFFSET(0x1D554CE0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READTONEXTENTRY_OFFSET UNITYSDK_OFFSET(0x1D555210)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READUINT16_OFFSET UNITYSDK_OFFSET(0x1D554D50)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READUINT32_OFFSET UNITYSDK_OFFSET(0x1D554E70)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READUINT64_OFFSET UNITYSDK_OFFSET(0x1D552800)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_SET_NODES_OFFSET UNITYSDK_OFFSET(0x1D5515A0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_SET_STREAM_OFFSET UNITYSDK_OFFSET(0x1D551660)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D550BF0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER___CTOR_B__6_0_OFFSET UNITYSDK_OFFSET(0x1D555250)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER___CTOR_B__6_10_OFFSET UNITYSDK_OFFSET(0x1D5553D0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER___CTOR_B__6_11_OFFSET UNITYSDK_OFFSET(0x1D5553F0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER___CTOR_B__6_12_OFFSET UNITYSDK_OFFSET(0x1D555420)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER___CTOR_B__6_13_OFFSET UNITYSDK_OFFSET(0x1D555450)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER___CTOR_B__6_1_OFFSET UNITYSDK_OFFSET(0x1D555270)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER___CTOR_B__6_2_OFFSET UNITYSDK_OFFSET(0x1D555290)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER___CTOR_B__6_3_OFFSET UNITYSDK_OFFSET(0x1D5552B0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER___CTOR_B__6_4_OFFSET UNITYSDK_OFFSET(0x1D5552D0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER___CTOR_B__6_5_OFFSET UNITYSDK_OFFSET(0x1D555300)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER___CTOR_B__6_6_OFFSET UNITYSDK_OFFSET(0x1D555320)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER___CTOR_B__6_7_OFFSET UNITYSDK_OFFSET(0x1D555340)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER___CTOR_B__6_8_OFFSET UNITYSDK_OFFSET(0x1D555360)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER___CTOR_B__6_9_OFFSET UNITYSDK_OFFSET(0x1D555390)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int SerializationNodeDataReader_TypeDefinitionIndex = 7429;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::Delegate*>* primitiveTypeReaders; // 0x40
		::System::String* peekedEntryData; // 0x48
		::System::String* peekedEntryName; // 0x50
		::System::Nullable_1<::Sirenix::Serialization::EntryType> peekedEntryType; // 0x58
		::System::Int32 currentIndex; // 0x5C
