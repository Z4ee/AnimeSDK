...
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_CONSUMECURRENTENTRY_OFFSET UNITYSDK_OFFSET(0x1E8EC3B0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E8EBFC0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_ENTERARRAY_OFFSET UNITYSDK_OFFSET(0x1E8EC140)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_ENTERNODE_OFFSET UNITYSDK_OFFSET(0x1E8EC3E0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_EXITARRAY_OFFSET UNITYSDK_OFFSET(0x1E8ECA50)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_EXITNODE_OFFSET UNITYSDK_OFFSET(0x1E8ECC40)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_GETDATADUMP_OFFSET UNITYSDK_OFFSET(0x1E8EF870)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_GET_INDEXISVALID_OFFSET UNITYSDK_OFFSET(0x1E8EBE20)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_GET_NODES_OFFSET UNITYSDK_OFFSET(0x1E8EBE40)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_GET_STREAM_OFFSET UNITYSDK_OFFSET(0x1E8EBF20)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_PEEKENTRY_1_OFFSET UNITYSDK_OFFSET(0x1E8EC390)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_PEEKENTRY_OFFSET UNITYSDK_OFFSET(0x1E8EC000)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_PREPARENEWSERIALIZATIONSESSION_OFFSET UNITYSDK_OFFSET(0x1E8EBFD0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1E8ECEB0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READBYTE_OFFSET UNITYSDK_OFFSET(0x1E8ECFD0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READCHAR_OFFSET UNITYSDK_OFFSET(0x1E8ED410)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READDECIMAL_OFFSET UNITYSDK_OFFSET(0x1E8ED740)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READDOUBLE_OFFSET UNITYSDK_OFFSET(0x1E8EDA70)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READEXTERNALREFERENCE_1_OFFSET UNITYSDK_OFFSET(0x1E8EE160)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READEXTERNALREFERENCE_2_OFFSET UNITYSDK_OFFSET(0x1E8EE1D0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READEXTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1E8EDD90)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READGUID_OFFSET UNITYSDK_OFFSET(0x1E8EE4F0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READINT16_OFFSET UNITYSDK_OFFSET(0x1E8EE8C0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READINT32_OFFSET UNITYSDK_OFFSET(0x1E8EED00)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READINT64_OFFSET UNITYSDK_OFFSET(0x1E8EE9E0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READINTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1E8EEE20)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READNULL_OFFSET UNITYSDK_OFFSET(0x1E8EF140)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READSBYTE_OFFSET UNITYSDK_OFFSET(0x1E8EF190)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READSINGLE_OFFSET UNITYSDK_OFFSET(0x1E8EF2B0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READSTRING_OFFSET UNITYSDK_OFFSET(0x1E8EF5C0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READTONEXTENTRY_OFFSET UNITYSDK_OFFSET(0x1E8EFAF0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READUINT16_OFFSET UNITYSDK_OFFSET(0x1E8EF630)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READUINT32_OFFSET UNITYSDK_OFFSET(0x1E8EF750)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_READUINT64_OFFSET UNITYSDK_OFFSET(0x1E8ED0F0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_SET_NODES_OFFSET UNITYSDK_OFFSET(0x1E8EBEB0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER_SET_STREAM_OFFSET UNITYSDK_OFFSET(0x1E8EBF70)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8EB500)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER___CTOR_B__6_0_OFFSET UNITYSDK_OFFSET(0x1E8EFB30)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER___CTOR_B__6_10_OFFSET UNITYSDK_OFFSET(0x1E8EFCB0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER___CTOR_B__6_11_OFFSET UNITYSDK_OFFSET(0x1E8EFCD0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER___CTOR_B__6_12_OFFSET UNITYSDK_OFFSET(0x1E8EFD00)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER___CTOR_B__6_13_OFFSET UNITYSDK_OFFSET(0x1E8EFD30)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER___CTOR_B__6_1_OFFSET UNITYSDK_OFFSET(0x1E8EFB50)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER___CTOR_B__6_2_OFFSET UNITYSDK_OFFSET(0x1E8EFB70)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER___CTOR_B__6_3_OFFSET UNITYSDK_OFFSET(0x1E8EFB90)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER___CTOR_B__6_4_OFFSET UNITYSDK_OFFSET(0x1E8EFBB0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER___CTOR_B__6_5_OFFSET UNITYSDK_OFFSET(0x1E8EFBE0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER___CTOR_B__6_6_OFFSET UNITYSDK_OFFSET(0x1E8EFC00)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER___CTOR_B__6_7_OFFSET UNITYSDK_OFFSET(0x1E8EFC20)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER___CTOR_B__6_8_OFFSET UNITYSDK_OFFSET(0x1E8EFC40)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAREADER___CTOR_B__6_9_OFFSET UNITYSDK_OFFSET(0x1E8EFC70)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int SerializationNodeDataReader_TypeDefinitionIndex = 7433;

	class SerializationNodeDataReader : public ::Sirenix::Serialization::BaseDataReader
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::Delegate*>* primitiveTypeReaders; // 0x38
		::System::Collections::Generic::List_1<::Sirenix::Serialization::SerializationNode>* nodes; // 0x40
		::System::String* peekedEntryName; // 0x48
		::System::String* peekedEntryData; // 0x50
