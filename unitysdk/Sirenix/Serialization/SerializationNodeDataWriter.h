...
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_BEGINARRAYNODE_OFFSET UNITYSDK_OFFSET(0x1DC1B650)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_BEGINREFERENCENODE_OFFSET UNITYSDK_OFFSET(0x1DC1B730)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_BEGINSTRUCTNODE_OFFSET UNITYSDK_OFFSET(0x1DC1BB10)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DC1BEC0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_ENDARRAYNODE_OFFSET UNITYSDK_OFFSET(0x1DC1BED0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_ENDNODE_OFFSET UNITYSDK_OFFSET(0x1DC1BF80)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_FLUSHTOSTREAM_OFFSET UNITYSDK_OFFSET(0x1DC1D470)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_GETDATADUMP_OFFSET UNITYSDK_OFFSET(0x1DC1D480)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_GET_NODES_OFFSET UNITYSDK_OFFSET(0x1DC1A7F0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_GET_STREAM_OFFSET UNITYSDK_OFFSET(0x1DC1B5B0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_PREPARENEWSERIALIZATIONSESSION_OFFSET UNITYSDK_OFFSET(0x1DC1C050)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_SET_NODES_OFFSET UNITYSDK_OFFSET(0x1DC1A860)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_SET_STREAM_OFFSET UNITYSDK_OFFSET(0x1DC1B600)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1DC1C080)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1DC1C170)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITECHAR_OFFSET UNITYSDK_OFFSET(0x1DC1C280)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEDECIMAL_OFFSET UNITYSDK_OFFSET(0x1DC1C3B0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEDOUBLE_OFFSET UNITYSDK_OFFSET(0x1DC1C5E0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEEXTERNALREFERENCE_1_OFFSET UNITYSDK_OFFSET(0x1DC1C7F0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEEXTERNALREFERENCE_2_OFFSET UNITYSDK_OFFSET(0x1DC1C8A0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEEXTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1DC1C6F0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEGUID_OFFSET UNITYSDK_OFFSET(0x1DC1C9B0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEINT16_OFFSET UNITYSDK_OFFSET(0x1DC1CAB0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEINT32_OFFSET UNITYSDK_OFFSET(0x1DC1CBB0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEINT64_OFFSET UNITYSDK_OFFSET(0x1DC1CCC0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEINTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1DC1CDD0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITENULL_OFFSET UNITYSDK_OFFSET(0x1DC1CEE0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITESBYTE_OFFSET UNITYSDK_OFFSET(0x1DC1CF90)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITESINGLE_OFFSET UNITYSDK_OFFSET(0x1DC1C4D0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITESTRING_OFFSET UNITYSDK_OFFSET(0x1DC1D090)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEUINT16_OFFSET UNITYSDK_OFFSET(0x1DC1D140)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEUINT32_OFFSET UNITYSDK_OFFSET(0x1DC1D250)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEUINT64_OFFSET UNITYSDK_OFFSET(0x1DC1D360)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC1A8D0)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int SerializationNodeDataWriter_TypeDefinitionIndex = 7431;
