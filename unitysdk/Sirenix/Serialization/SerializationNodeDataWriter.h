...
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_BEGINARRAYNODE_OFFSET UNITYSDK_OFFSET(0x1F043C80)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_BEGINREFERENCENODE_OFFSET UNITYSDK_OFFSET(0x1F043D60)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_BEGINSTRUCTNODE_OFFSET UNITYSDK_OFFSET(0x1F044140)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1F0444F0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_ENDARRAYNODE_OFFSET UNITYSDK_OFFSET(0x1F044500)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_ENDNODE_OFFSET UNITYSDK_OFFSET(0x1F0445B0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_FLUSHTOSTREAM_OFFSET UNITYSDK_OFFSET(0x1F045A90)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_GETDATADUMP_OFFSET UNITYSDK_OFFSET(0x1F045AA0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_GET_NODES_OFFSET UNITYSDK_OFFSET(0x1F042E40)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_GET_STREAM_OFFSET UNITYSDK_OFFSET(0x1F043BE0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_PREPARENEWSERIALIZATIONSESSION_OFFSET UNITYSDK_OFFSET(0x1F044680)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_SET_NODES_OFFSET UNITYSDK_OFFSET(0x1F042EB0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_SET_STREAM_OFFSET UNITYSDK_OFFSET(0x1F043C30)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1F0446B0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1F0447A0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITECHAR_OFFSET UNITYSDK_OFFSET(0x1F0448B0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEDECIMAL_OFFSET UNITYSDK_OFFSET(0x1F0449E0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEDOUBLE_OFFSET UNITYSDK_OFFSET(0x1F044C00)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEEXTERNALREFERENCE_1_OFFSET UNITYSDK_OFFSET(0x1F044E10)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEEXTERNALREFERENCE_2_OFFSET UNITYSDK_OFFSET(0x1F044EC0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEEXTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1F044D10)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEGUID_OFFSET UNITYSDK_OFFSET(0x1F044FD0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEINT16_OFFSET UNITYSDK_OFFSET(0x1F0450D0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEINT32_OFFSET UNITYSDK_OFFSET(0x1F0451D0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEINT64_OFFSET UNITYSDK_OFFSET(0x1F0452E0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEINTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1F0453F0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITENULL_OFFSET UNITYSDK_OFFSET(0x1F045500)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITESBYTE_OFFSET UNITYSDK_OFFSET(0x1F0455B0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITESINGLE_OFFSET UNITYSDK_OFFSET(0x1F044AF0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITESTRING_OFFSET UNITYSDK_OFFSET(0x1F0456B0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEUINT16_OFFSET UNITYSDK_OFFSET(0x1F045760)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEUINT32_OFFSET UNITYSDK_OFFSET(0x1F045870)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEUINT64_OFFSET UNITYSDK_OFFSET(0x1F045980)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F042F20)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int SerializationNodeDataWriter_TypeDefinitionIndex = 7435;
