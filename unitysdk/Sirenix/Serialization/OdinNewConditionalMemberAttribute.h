...
#define SIRENIX_SERIALIZATION_ODINNEWCONDITIONALMEMBERATTRIBUTE_GET_FULLCONDITIONSTATEMENT_OFFSET UNITYSDK_OFFSET(0x1FC15040)
#define SIRENIX_SERIALIZATION_ODINNEWCONDITIONALMEMBERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC15050)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int OdinNewConditionalMemberAttribute_TypeDefinitionIndex = 7599;
