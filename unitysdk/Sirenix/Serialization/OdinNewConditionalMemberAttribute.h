...
#define SIRENIX_SERIALIZATION_ODINNEWCONDITIONALMEMBERATTRIBUTE_GET_FULLCONDITIONSTATEMENT_OFFSET UNITYSDK_OFFSET(0x1E834BE0)
#define SIRENIX_SERIALIZATION_ODINNEWCONDITIONALMEMBERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E834BF0)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int OdinNewConditionalMemberAttribute_TypeDefinitionIndex = 7595;
