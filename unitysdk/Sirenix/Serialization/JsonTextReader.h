...
#define SIRENIX_SERIALIZATION_JSONTEXTREADER_CONSUMECHAR_OFFSET UNITYSDK_OFFSET(0x1F8C85A0)
#define SIRENIX_SERIALIZATION_JSONTEXTREADER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1F8C7010)
#define SIRENIX_SERIALIZATION_JSONTEXTREADER_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1F8C6EA0)
#define SIRENIX_SERIALIZATION_JSONTEXTREADER_GUESSPRIMITIVETYPE_OFFSET UNITYSDK_OFFSET(0x1F8C9030)
#define SIRENIX_SERIALIZATION_JSONTEXTREADER_ISHEX_OFFSET UNITYSDK_OFFSET(0x1F8C8660)
#define SIRENIX_SERIALIZATION_JSONTEXTREADER_PARSEENTRYFROMBUFFER_OFFSET UNITYSDK_OFFSET(0x1F8C8970)
#define SIRENIX_SERIALIZATION_JSONTEXTREADER_PARSEHEXCHAR_OFFSET UNITYSDK_OFFSET(0x1F8C8680)
#define SIRENIX_SERIALIZATION_JSONTEXTREADER_PARSESINGLECHAR_OFFSET UNITYSDK_OFFSET(0x1F8C9210)
#define SIRENIX_SERIALIZATION_JSONTEXTREADER_PEEKCHAR_OFFSET UNITYSDK_OFFSET(0x1F8C8470)
#define SIRENIX_SERIALIZATION_JSONTEXTREADER_READCHARINTOBUFFER_OFFSET UNITYSDK_OFFSET(0x1F8C87F0)
#define SIRENIX_SERIALIZATION_JSONTEXTREADER_READTONEXTENTRY_OFFSET UNITYSDK_OFFSET(0x1F8C7020)
#define SIRENIX_SERIALIZATION_JSONTEXTREADER_RESET_OFFSET UNITYSDK_OFFSET(0x1F8C6FE0)
#define SIRENIX_SERIALIZATION_JSONTEXTREADER_SET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1F8C6EB0)
#define SIRENIX_SERIALIZATION_JSONTEXTREADER_SKIPCHAR_OFFSET UNITYSDK_OFFSET(0x1F8C8540)
#define SIRENIX_SERIALIZATION_JSONTEXTREADER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F8C9250)
#define SIRENIX_SERIALIZATION_JSONTEXTREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F8C6EC0)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int JsonTextReader_TypeDefinitionIndex = 7431;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Char, ::System::Nullable_1<::Sirenix::Serialization::EntryType>>**)Il2CppClass::FromTypeDefinitionIndex(JsonTextReader_TypeDefinitionIndex)->GetStaticField(0x63D0);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::Char, ::System::Char>** StaticGet_UnescapeDictionary()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Char, ::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(JsonTextReader_TypeDefinitionIndex)->GetStaticField(0x63D8);
		}
		::Il2CppArray<::System::Char>* buffer; // 0x10
		::System::IO::StreamReader* reader; // 0x18
		::System::Collections::Generic::Queue_1<::System::Char>* emergencyPlayback; // 0x20
