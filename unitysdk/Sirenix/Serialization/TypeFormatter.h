...
#define SIRENIX_SERIALIZATION_TYPEFORMATTER_GETUNINITIALIZEDOBJECT_OFFSET UNITYSDK_OFFSET(0x1E837F70)
#define SIRENIX_SERIALIZATION_TYPEFORMATTER_READ_OFFSET UNITYSDK_OFFSET(0x1E837830)
#define SIRENIX_SERIALIZATION_TYPEFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x1E837C30)
#define SIRENIX_SERIALIZATION_TYPEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E837F80)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int TypeFormatter_TypeDefinitionIndex = 7489;
