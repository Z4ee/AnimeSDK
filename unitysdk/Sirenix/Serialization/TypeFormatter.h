...
#define SIRENIX_SERIALIZATION_TYPEFORMATTER_GETUNINITIALIZEDOBJECT_OFFSET UNITYSDK_OFFSET(0x1C507700)
#define SIRENIX_SERIALIZATION_TYPEFORMATTER_READ_OFFSET UNITYSDK_OFFSET(0x1C506FC0)
#define SIRENIX_SERIALIZATION_TYPEFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x1C5073C0)
#define SIRENIX_SERIALIZATION_TYPEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C507710)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int TypeFormatter_TypeDefinitionIndex = 7357;
