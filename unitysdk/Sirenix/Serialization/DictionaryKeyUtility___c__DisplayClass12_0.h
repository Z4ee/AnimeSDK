...
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7F7490)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY___C__DISPLAYCLASS12_0___CCTOR_B__2_OFFSET UNITYSDK_OFFSET(0x1E7F74A0)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int DictionaryKeyUtility___c__DisplayClass12_0_TypeDefinitionIndex = 7563;
