...
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4C6A00)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY___C__DISPLAYCLASS12_0___CCTOR_B__2_OFFSET UNITYSDK_OFFSET(0x1C4C6A10)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int DictionaryKeyUtility___c__DisplayClass12_0_TypeDefinitionIndex = 7431;
