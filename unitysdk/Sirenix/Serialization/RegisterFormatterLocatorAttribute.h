...
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERLOCATORATTRIBUTE_GET_FORMATTERLOCATORTYPE_OFFSET UNITYSDK_OFFSET(0x1FC15070)
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERLOCATORATTRIBUTE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1FC15090)
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERLOCATORATTRIBUTE_SET_FORMATTERLOCATORTYPE_OFFSET UNITYSDK_OFFSET(0x1FC15080)
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERLOCATORATTRIBUTE_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1FC150A0)
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERLOCATORATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC150B0)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int RegisterFormatterLocatorAttribute_TypeDefinitionIndex = 7531;
