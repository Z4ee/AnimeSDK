...
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1FC14C50)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_TYPE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1FC14F60)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_TYPE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1FC14EF0)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1FC14FD0)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1FC14F50)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1FC14F00)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1FC14C10)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC14BF0)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1FC14C30)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1FC14C40)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int DictionaryKeyUtility__GetPersistentPathKeyTypes_d__14_TypeDefinitionIndex = 7569;

	class DictionaryKeyUtility__GetPersistentPathKeyTypes_d__14 : public ::System::Object
	{
	public:
		::System::Type* __2__current; // 0x10
		::System::Collections::Generic::HashSet_1_Enumerator<::System::Type*> __7__wrap1; // 0x18
