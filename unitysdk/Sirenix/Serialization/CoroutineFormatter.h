...
#define SIRENIX_SERIALIZATION_COROUTINEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C1436C0)
#define SIRENIX_SERIALIZATION_COROUTINEFORMATTER_GET_SERIALIZEDTYPE_OFFSET UNITYSDK_OFFSET(0x1C143680)
#define SIRENIX_SERIALIZATION_COROUTINEFORMATTER_SERIALIZE_1_OFFSET UNITYSDK_OFFSET(0x1C1436E0)
#define SIRENIX_SERIALIZATION_COROUTINEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C1436D0)
#define SIRENIX_SERIALIZATION_COROUTINEFORMATTER_SIRENIX_SERIALIZATION_IFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C1436B0)
#define SIRENIX_SERIALIZATION_COROUTINEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1436F0)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int CoroutineFormatter_TypeDefinitionIndex = 7446;
