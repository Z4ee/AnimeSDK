...
#define SIRENIX_SERIALIZATION_VECTOR2FORMATTER_READ_OFFSET UNITYSDK_OFFSET(0x1C502920)
#define SIRENIX_SERIALIZATION_VECTOR2FORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x1C502A10)
#define SIRENIX_SERIALIZATION_VECTOR2FORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C502B70)
#define SIRENIX_SERIALIZATION_VECTOR2FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C502B10)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int Vector2Formatter_TypeDefinitionIndex = 7458;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(Vector2Formatter_TypeDefinitionIndex)->GetStaticField(0x6560);
		}
