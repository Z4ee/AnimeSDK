...
#define SIRENIX_SERIALIZATION_KEYFRAMEFORMATTER_READFIELDACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F042B10)
#define SIRENIX_SERIALIZATION_KEYFRAMEFORMATTER_READFIELDACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F042B90)
#define SIRENIX_SERIALIZATION_KEYFRAMEFORMATTER_READFIELDACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F0427F0)
#define SIRENIX_SERIALIZATION_KEYFRAMEFORMATTER_READFIELDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1F0427D0)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int KeyframeFormatter_ReadFieldAction_TypeDefinitionIndex = 7587;
