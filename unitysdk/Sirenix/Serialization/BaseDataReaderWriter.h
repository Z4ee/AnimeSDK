...
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_CLEARNODES_OFFSET UNITYSDK_OFFSET(0x1C1433E0)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_EXPANDNAMEBUFFER_OFFSET UNITYSDK_OFFSET(0x1C142F50)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_EXPANDNODES_OFFSET UNITYSDK_OFFSET(0x1C143080)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_GET_BINDER_OFFSET UNITYSDK_OFFSET(0x1C1426B0)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_GET_CURRENTNODE_OFFSET UNITYSDK_OFFSET(0x1C142D50)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_GET_ISINARRAYNODE_OFFSET UNITYSDK_OFFSET(0x1C142CF0)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_GET_NODEDEPTH_OFFSET UNITYSDK_OFFSET(0x1C142D40)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_POPARRAY_OFFSET UNITYSDK_OFFSET(0x1C1432F0)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_POPNODE_OFFSET UNITYSDK_OFFSET(0x1C143240)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_PUSHARRAY_OFFSET UNITYSDK_OFFSET(0x1C1430B0)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_PUSHNODE_OFFSET UNITYSDK_OFFSET(0x1C142E00)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_SET_BINDER_OFFSET UNITYSDK_OFFSET(0x1C142AD0)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C143410)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int BaseDataReaderWriter_TypeDefinitionIndex = 7282;

	class BaseDataReaderWriter : public ::System::Object
	{
	public:
		::Il2CppArray<::System::Byte>* nodeNameBuffer; // 0x10
		::Il2CppArray<::Sirenix::Serialization::NodeInfo>* nodes; // 0x18
