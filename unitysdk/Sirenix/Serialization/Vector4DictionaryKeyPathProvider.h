...
#define SIRENIX_SERIALIZATION_VECTOR4DICTIONARYKEYPATHPROVIDER_COMPARE_OFFSET UNITYSDK_OFFSET(0x1DC2C290)
#define SIRENIX_SERIALIZATION_VECTOR4DICTIONARYKEYPATHPROVIDER_GETKEYFROMPATHSTRING_OFFSET UNITYSDK_OFFSET(0x1DC2C3E0)
#define SIRENIX_SERIALIZATION_VECTOR4DICTIONARYKEYPATHPROVIDER_GETPATHSTRINGFROMKEY_OFFSET UNITYSDK_OFFSET(0x1DC2C5D0)
#define SIRENIX_SERIALIZATION_VECTOR4DICTIONARYKEYPATHPROVIDER_GET_PROVIDERID_OFFSET UNITYSDK_OFFSET(0x1DC2C250)
#define SIRENIX_SERIALIZATION_VECTOR4DICTIONARYKEYPATHPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC2C840)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int Vector4DictionaryKeyPathProvider_TypeDefinitionIndex = 7571;
