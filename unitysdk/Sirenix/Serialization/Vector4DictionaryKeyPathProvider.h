...
#define SIRENIX_SERIALIZATION_VECTOR4DICTIONARYKEYPATHPROVIDER_COMPARE_OFFSET UNITYSDK_OFFSET(0x1F0547A0)
#define SIRENIX_SERIALIZATION_VECTOR4DICTIONARYKEYPATHPROVIDER_GETKEYFROMPATHSTRING_OFFSET UNITYSDK_OFFSET(0x1F0548F0)
#define SIRENIX_SERIALIZATION_VECTOR4DICTIONARYKEYPATHPROVIDER_GETPATHSTRINGFROMKEY_OFFSET UNITYSDK_OFFSET(0x1F054AD0)
#define SIRENIX_SERIALIZATION_VECTOR4DICTIONARYKEYPATHPROVIDER_GET_PROVIDERID_OFFSET UNITYSDK_OFFSET(0x1F054760)
#define SIRENIX_SERIALIZATION_VECTOR4DICTIONARYKEYPATHPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F054D40)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int Vector4DictionaryKeyPathProvider_TypeDefinitionIndex = 7575;
