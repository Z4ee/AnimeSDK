...
#define SIRENIX_SERIALIZATION_BASEDATAREADER_ENTERNODE_OFFSET UNITYSDK_OFFSET(0x1E836080)
#define SIRENIX_SERIALIZATION_BASEDATAREADER_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1E835FD0)
#define SIRENIX_SERIALIZATION_BASEDATAREADER_GET_CURRENTNODEDEPTH_OFFSET UNITYSDK_OFFSET(0x1E835E60)
#define SIRENIX_SERIALIZATION_BASEDATAREADER_GET_CURRENTNODEID_OFFSET UNITYSDK_OFFSET(0x1E835DC0)
#define SIRENIX_SERIALIZATION_BASEDATAREADER_GET_CURRENTNODENAME_OFFSET UNITYSDK_OFFSET(0x1E835E70)
#define SIRENIX_SERIALIZATION_BASEDATAREADER_GET_STREAM_OFFSET UNITYSDK_OFFSET(0x1E835F10)
#define SIRENIX_SERIALIZATION_BASEDATAREADER_PREPARENEWSERIALIZATIONSESSION_OFFSET UNITYSDK_OFFSET(0x1E836C50)
#define SIRENIX_SERIALIZATION_BASEDATAREADER_SET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1E836070)
#define SIRENIX_SERIALIZATION_BASEDATAREADER_SET_STREAM_OFFSET UNITYSDK_OFFSET(0x1E835F20)
#define SIRENIX_SERIALIZATION_BASEDATAREADER_SKIPENTRY_OFFSET UNITYSDK_OFFSET(0x1E8360B0)
#define SIRENIX_SERIALIZATION_BASEDATAREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E835D30)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int BaseDataReader_TypeDefinitionIndex = 7412;
