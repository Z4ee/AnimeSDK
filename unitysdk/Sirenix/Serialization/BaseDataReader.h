...
#define SIRENIX_SERIALIZATION_BASEDATAREADER_ENTERNODE_OFFSET UNITYSDK_OFFSET(0x1FC18570)
#define SIRENIX_SERIALIZATION_BASEDATAREADER_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1FC184C0)
#define SIRENIX_SERIALIZATION_BASEDATAREADER_GET_CURRENTNODEDEPTH_OFFSET UNITYSDK_OFFSET(0x1FC18350)
#define SIRENIX_SERIALIZATION_BASEDATAREADER_GET_CURRENTNODEID_OFFSET UNITYSDK_OFFSET(0x1FC182B0)
#define SIRENIX_SERIALIZATION_BASEDATAREADER_GET_CURRENTNODENAME_OFFSET UNITYSDK_OFFSET(0x1FC18360)
#define SIRENIX_SERIALIZATION_BASEDATAREADER_GET_STREAM_OFFSET UNITYSDK_OFFSET(0x1FC18400)
#define SIRENIX_SERIALIZATION_BASEDATAREADER_PREPARENEWSERIALIZATIONSESSION_OFFSET UNITYSDK_OFFSET(0x1FC19150)
#define SIRENIX_SERIALIZATION_BASEDATAREADER_SET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1FC18560)
#define SIRENIX_SERIALIZATION_BASEDATAREADER_SET_STREAM_OFFSET UNITYSDK_OFFSET(0x1FC18410)
#define SIRENIX_SERIALIZATION_BASEDATAREADER_SKIPENTRY_OFFSET UNITYSDK_OFFSET(0x1FC185A0)
#define SIRENIX_SERIALIZATION_BASEDATAREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC18220)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int BaseDataReader_TypeDefinitionIndex = 7416;
