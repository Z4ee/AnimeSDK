...
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERATTRIBUTE_GET_FORMATTERTYPE_OFFSET UNITYSDK_OFFSET(0x1E518120)
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERATTRIBUTE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1E518140)
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERATTRIBUTE_SET_FORMATTERTYPE_OFFSET UNITYSDK_OFFSET(0x1E518130)
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERATTRIBUTE_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1E518150)
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E518160)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int RegisterFormatterAttribute_TypeDefinitionIndex = 7526;
