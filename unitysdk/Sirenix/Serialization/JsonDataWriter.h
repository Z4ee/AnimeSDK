...
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_BEGINARRAYNODE_OFFSET UNITYSDK_OFFSET(0x1F454280)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_BEGINREFERENCENODE_OFFSET UNITYSDK_OFFSET(0x1F4532A0)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_BEGINSTRUCTNODE_OFFSET UNITYSDK_OFFSET(0x1F453DB0)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_BUFFER_WRITESTRING_WITHESCAPE_OFFSET UNITYSDK_OFFSET(0x1F454BE0)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_CREATEBYTETOHEXLOOKUP_OFFSET UNITYSDK_OFFSET(0x1F455CD0)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1F455680)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_ENDARRAYNODE_OFFSET UNITYSDK_OFFSET(0x1F4543C0)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_ENDNODE_OFFSET UNITYSDK_OFFSET(0x1F453E50)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_ENSUREBUFFERSPACE_OFFSET UNITYSDK_OFFSET(0x1F454190)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_FLUSHTOSTREAM_OFFSET UNITYSDK_OFFSET(0x1F453230)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_GETDATADUMP_OFFSET UNITYSDK_OFFSET(0x1F455720)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_MARKJUSTSTARTED_OFFSET UNITYSDK_OFFSET(0x1F453220)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_PREPARENEWSERIALIZATIONSESSION_OFFSET UNITYSDK_OFFSET(0x1F455690)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_STARTNEWLINE_OFFSET UNITYSDK_OFFSET(0x1F453ED0)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1F454420)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1F454490)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITECHAR_OFFSET UNITYSDK_OFFSET(0x1F454570)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEDECIMAL_OFFSET UNITYSDK_OFFSET(0x1F4548A0)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEDOUBLE_OFFSET UNITYSDK_OFFSET(0x1F454920)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEENTRY_1_OFFSET UNITYSDK_OFFSET(0x1F455970)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEENTRY_OFFSET UNITYSDK_OFFSET(0x1F4533B0)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEEXTERNALREFERENCE_1_OFFSET UNITYSDK_OFFSET(0x1F455510)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEEXTERNALREFERENCE_2_OFFSET UNITYSDK_OFFSET(0x1F455580)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEEXTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1F455490)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEGUID_OFFSET UNITYSDK_OFFSET(0x1F4553C0)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEINT16_OFFSET UNITYSDK_OFFSET(0x1F454AE0)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEINT32_OFFSET UNITYSDK_OFFSET(0x1F453690)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEINT64_OFFSET UNITYSDK_OFFSET(0x1F454350)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEINTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1F4549E0)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITENULL_OFFSET UNITYSDK_OFFSET(0x1F4549A0)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITESBYTE_OFFSET UNITYSDK_OFFSET(0x1F454A60)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITESINGLE_OFFSET UNITYSDK_OFFSET(0x1F454B60)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITESTRING_OFFSET UNITYSDK_OFFSET(0x1F454610)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITETYPEENTRY_OFFSET UNITYSDK_OFFSET(0x1F453700)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEUINT16_OFFSET UNITYSDK_OFFSET(0x1F455610)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEUINT32_OFFSET UNITYSDK_OFFSET(0x1F455420)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEUINT64_OFFSET UNITYSDK_OFFSET(0x1F454500)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F455E70)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F4524B0)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F4524A0)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int JsonDataWriter_TypeDefinitionIndex = 7430;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(JsonDataWriter_TypeDefinitionIndex)->GetStaticField(0x65F0);
		}
		static ::Il2CppArray<::System::UInt32>** StaticGet_ByteToHexCharLookup()
		{
			return (::Il2CppArray<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(JsonDataWriter_TypeDefinitionIndex)->GetStaticField(0x65F8);
		}
		::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::Delegate*>* primitiveTypeWriters; // 0x38
		::Il2CppArray<::System::Byte>* buffer; // 0x40
		::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::Int32>* seenTypes; // 0x48
		::System::Boolean EnableTypeOptimization; // 0x50
		::System::Boolean FormatAsReadable; // 0x51
		::System::Boolean justStarted; // 0x52
		::System::Boolean forceNoSeparatorNextLine; // 0x53
