...
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_CREATECOPY_OFFSET UNITYSDK_OFFSET(0x1BCF79B0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_CREATEREADER_OFFSET UNITYSDK_OFFSET(0x1BCF53D0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_CREATEWRITER_OFFSET UNITYSDK_OFFSET(0x1BCF5280)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_DESERIALIZEVALUEWEAK_1_OFFSET UNITYSDK_OFFSET(0x1BCF6AD0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_DESERIALIZEVALUEWEAK_2_OFFSET UNITYSDK_OFFSET(0x1BCF6D80)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_DESERIALIZEVALUEWEAK_3_OFFSET UNITYSDK_OFFSET(0x1BCF7200)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_DESERIALIZEVALUEWEAK_4_OFFSET UNITYSDK_OFFSET(0x1BCF7530)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_DESERIALIZEVALUEWEAK_5_OFFSET UNITYSDK_OFFSET(0x1BCF7770)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_DESERIALIZEVALUEWEAK_OFFSET UNITYSDK_OFFSET(0x1BCF6A30)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_GETCACHEDREADER_OFFSET UNITYSDK_OFFSET(0x1BCF57A0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_GETCACHEDWRITER_OFFSET UNITYSDK_OFFSET(0x1BCF5520)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_SERIALIZEVALUEWEAK_1_OFFSET UNITYSDK_OFFSET(0x1BCF5AE0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_SERIALIZEVALUEWEAK_2_OFFSET UNITYSDK_OFFSET(0x1BCF5E10)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_SERIALIZEVALUEWEAK_3_OFFSET UNITYSDK_OFFSET(0x1BCF60B0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_SERIALIZEVALUEWEAK_4_OFFSET UNITYSDK_OFFSET(0x1BCF6380)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_SERIALIZEVALUEWEAK_5_OFFSET UNITYSDK_OFFSET(0x1BCF66D0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_SERIALIZEVALUEWEAK_OFFSET UNITYSDK_OFFSET(0x1BCF59A0)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int SerializationUtility_TypeDefinitionIndex = 7403;
