...
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_CREATECOPY_OFFSET UNITYSDK_OFFSET(0x1F458630)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_CREATEREADER_OFFSET UNITYSDK_OFFSET(0x1F456030)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_CREATEWRITER_OFFSET UNITYSDK_OFFSET(0x1F455EE0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_DESERIALIZEVALUEWEAK_1_OFFSET UNITYSDK_OFFSET(0x1F457760)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_DESERIALIZEVALUEWEAK_2_OFFSET UNITYSDK_OFFSET(0x1F457A10)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_DESERIALIZEVALUEWEAK_3_OFFSET UNITYSDK_OFFSET(0x1F457E80)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_DESERIALIZEVALUEWEAK_4_OFFSET UNITYSDK_OFFSET(0x1F4581B0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_DESERIALIZEVALUEWEAK_5_OFFSET UNITYSDK_OFFSET(0x1F4583F0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_DESERIALIZEVALUEWEAK_OFFSET UNITYSDK_OFFSET(0x1F4576C0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_GETCACHEDREADER_OFFSET UNITYSDK_OFFSET(0x1F456400)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_GETCACHEDWRITER_OFFSET UNITYSDK_OFFSET(0x1F456180)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_SERIALIZEVALUEWEAK_1_OFFSET UNITYSDK_OFFSET(0x1F456750)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_SERIALIZEVALUEWEAK_2_OFFSET UNITYSDK_OFFSET(0x1F456A90)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_SERIALIZEVALUEWEAK_3_OFFSET UNITYSDK_OFFSET(0x1F456D30)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_SERIALIZEVALUEWEAK_4_OFFSET UNITYSDK_OFFSET(0x1F457000)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_SERIALIZEVALUEWEAK_5_OFFSET UNITYSDK_OFFSET(0x1F457360)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_SERIALIZEVALUEWEAK_OFFSET UNITYSDK_OFFSET(0x1F456600)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int SerializationUtility_TypeDefinitionIndex = 7539;
