...
#define SIRENIX_SERIALIZATION_RECTFORMATTER_READ_OFFSET UNITYSDK_OFFSET(0x1C506C10)
#define SIRENIX_SERIALIZATION_RECTFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x1C506D80)
#define SIRENIX_SERIALIZATION_RECTFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C506F60)
#define SIRENIX_SERIALIZATION_RECTFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C506F00)
