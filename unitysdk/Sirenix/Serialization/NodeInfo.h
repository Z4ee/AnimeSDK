...
#define SIRENIX_SERIALIZATION_NODEINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0xA75210)
#define SIRENIX_SERIALIZATION_NODEINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA75220)
#define SIRENIX_SERIALIZATION_NODEINFO_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1E68F760)
#define SIRENIX_SERIALIZATION_NODEINFO_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1E68F810)
#define SIRENIX_SERIALIZATION_NODEINFO__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E68FBD0)
#define SIRENIX_SERIALIZATION_NODEINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0xA75190)
#define SIRENIX_SERIALIZATION_NODEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA75170)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int NodeInfo_TypeDefinitionIndex = 7516;

	struct alignas(8) NodeInfo
	{
		static ::Sirenix::Serialization::NodeInfo* StaticGet_Empty()
		{
			return (::Sirenix::Serialization::NodeInfo*)Il2CppClass::FromTypeDefinitionIndex(NodeInfo_TypeDefinitionIndex)->GetStaticField(0x6190);
		}
