...
#define SIRENIX_SERIALIZATION_NODEINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x9D3950)
#define SIRENIX_SERIALIZATION_NODEINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9D3960)
#define SIRENIX_SERIALIZATION_NODEINFO_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1C34CDA0)
#define SIRENIX_SERIALIZATION_NODEINFO_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1C34CE50)
#define SIRENIX_SERIALIZATION_NODEINFO__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C34D210)
#define SIRENIX_SERIALIZATION_NODEINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9D38D0)
#define SIRENIX_SERIALIZATION_NODEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x9D38B0)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int NodeInfo_TypeDefinitionIndex = 7384;

	struct alignas(8) NodeInfo
	{
		static ::Sirenix::Serialization::NodeInfo* StaticGet_Empty()
		{
			return (::Sirenix::Serialization::NodeInfo*)Il2CppClass::FromTypeDefinitionIndex(NodeInfo_TypeDefinitionIndex)->GetStaticField(0x60A0);
		}
