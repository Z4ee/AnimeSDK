...
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GETEXTERNALOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1EFDFAB0)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GETEXTERNALOBJECT_2_OFFSET UNITYSDK_OFFSET(0x1EFDFDF0)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GETEXTERNALOBJECT_OFFSET UNITYSDK_OFFSET(0x1EFDF960)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GETINTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1EFDF900)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GET_BINDER_OFFSET UNITYSDK_OFFSET(0x1EFDC930)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1EFD5830)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GET_FORMATTERCONVERTER_OFFSET UNITYSDK_OFFSET(0x1EFDF840)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GET_GUIDREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1EFDF7F0)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GET_INDEXREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1EFDF810)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GET_STREAMINGCONTEXT_OFFSET UNITYSDK_OFFSET(0x1EFDF830)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GET_STRINGREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1EFDF7D0)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_REGISTERINTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1EFDF860)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_RESET_OFFSET UNITYSDK_OFFSET(0x1EFDF750)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_SET_BINDER_OFFSET UNITYSDK_OFFSET(0x1EFDF7C0)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1EFDF850)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_SET_GUIDREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1EFDF800)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_SET_INDEXREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1EFDF820)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_SET_STRINGREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1EFDF7E0)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_SIRENIX_SERIALIZATION_UTILITIES_ICACHENOTIFICATIONRECEIVER_ONCLAIMED_OFFSET UNITYSDK_OFFSET(0x1EFE0150)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_SIRENIX_SERIALIZATION_UTILITIES_ICACHENOTIFICATIONRECEIVER_ONFREED_OFFSET UNITYSDK_OFFSET(0x1EFE00E0)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EFDF6D0)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1EFDF730)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1EFDF560)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFDF510)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int DeserializationContext_TypeDefinitionIndex = 7506;
	...
	public:
		...
		::System::Collections::Generic::List_1<::System::Object*>* internalIdReferenceMap; // 0x28
		...
		::System::Runtime::Serialization::StreamingContext streamingContext; // 0x40
