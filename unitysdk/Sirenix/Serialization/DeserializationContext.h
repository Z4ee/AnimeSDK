...
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GETEXTERNALOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1DBF7110)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GETEXTERNALOBJECT_2_OFFSET UNITYSDK_OFFSET(0x1DBF7440)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GETEXTERNALOBJECT_OFFSET UNITYSDK_OFFSET(0x1DBF6FB0)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GETINTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1DBF6F50)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GET_BINDER_OFFSET UNITYSDK_OFFSET(0x1DBF3EF0)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1DBECD30)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GET_FORMATTERCONVERTER_OFFSET UNITYSDK_OFFSET(0x1DBF6E90)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GET_GUIDREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1DBF6E40)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GET_INDEXREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1DBF6E60)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GET_STREAMINGCONTEXT_OFFSET UNITYSDK_OFFSET(0x1DBF6E80)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GET_STRINGREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1DBF6E20)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_REGISTERINTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1DBF6EB0)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_RESET_OFFSET UNITYSDK_OFFSET(0x1DBF6DA0)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_SET_BINDER_OFFSET UNITYSDK_OFFSET(0x1DBF6E10)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1DBF6EA0)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_SET_GUIDREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1DBF6E50)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_SET_INDEXREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1DBF6E70)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_SET_STRINGREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1DBF6E30)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_SIRENIX_SERIALIZATION_UTILITIES_ICACHENOTIFICATIONRECEIVER_ONCLAIMED_OFFSET UNITYSDK_OFFSET(0x1DBF77B0)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_SIRENIX_SERIALIZATION_UTILITIES_ICACHENOTIFICATIONRECEIVER_ONFREED_OFFSET UNITYSDK_OFFSET(0x1DBF7740)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DBF6D20)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1DBF6D80)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1DBF6BB0)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DBF6B60)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int DeserializationContext_TypeDefinitionIndex = 7502;

	class DeserializationContext : public ::System::Object
	{
	public:
		::Sirenix::Serialization::IExternalGuidReferenceResolver* _GuidReferenceResolver_k__BackingField; // 0x10
		::Sirenix::Serialization::IExternalStringReferenceResolver* _StringReferenceResolver_k__BackingField; // 0x18
		::System::Runtime::Serialization::IFormatterConverter* formatterConverter; // 0x20
		::Sirenix::Serialization::TwoWaySerializationBinder* binder; // 0x28
		::System::Collections::Generic::List_1<::System::Object*>* internalIdReferenceMap; // 0x30
		::System::Runtime::Serialization::StreamingContext streamingContext; // 0x38
		::Sirenix::Serialization::IExternalIndexReferenceResolver* _IndexReferenceResolver_k__BackingField; // 0x48
