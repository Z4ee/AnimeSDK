...
#define SIRENIX_SERIALIZATION_DEFAULTSERIALIZATIONBINDER___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C47C3A0)
#define SIRENIX_SERIALIZATION_DEFAULTSERIALIZATIONBINDER___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1C47C3E0)
#define SIRENIX_SERIALIZATION_DEFAULTSERIALIZATIONBINDER___C___CCTOR_B__12_0_OFFSET UNITYSDK_OFFSET(0x1C47C3F0)
