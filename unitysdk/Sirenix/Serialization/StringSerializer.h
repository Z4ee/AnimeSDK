...
#define SIRENIX_SERIALIZATION_STRINGSERIALIZER_READVALUE_OFFSET UNITYSDK_OFFSET(0x1C34DA80)
#define SIRENIX_SERIALIZATION_STRINGSERIALIZER_WRITEVALUE_OFFSET UNITYSDK_OFFSET(0x1C34E330)
#define SIRENIX_SERIALIZATION_STRINGSERIALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C34E4C0)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int StringSerializer_TypeDefinitionIndex = 7421;
