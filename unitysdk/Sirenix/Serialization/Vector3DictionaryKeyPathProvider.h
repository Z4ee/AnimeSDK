...
#define SIRENIX_SERIALIZATION_VECTOR3DICTIONARYKEYPATHPROVIDER_COMPARE_OFFSET UNITYSDK_OFFSET(0x1FC15D20)
#define SIRENIX_SERIALIZATION_VECTOR3DICTIONARYKEYPATHPROVIDER_GETKEYFROMPATHSTRING_OFFSET UNITYSDK_OFFSET(0x1FC15E10)
#define SIRENIX_SERIALIZATION_VECTOR3DICTIONARYKEYPATHPROVIDER_GETPATHSTRINGFROMKEY_OFFSET UNITYSDK_OFFSET(0x1FC15F70)
#define SIRENIX_SERIALIZATION_VECTOR3DICTIONARYKEYPATHPROVIDER_GET_PROVIDERID_OFFSET UNITYSDK_OFFSET(0x1FC15CE0)
#define SIRENIX_SERIALIZATION_VECTOR3DICTIONARYKEYPATHPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC16170)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int Vector3DictionaryKeyPathProvider_TypeDefinitionIndex = 7574;
