...
#define SIRENIX_SERIALIZATION_VECTOR3DICTIONARYKEYPATHPROVIDER_COMPARE_OFFSET UNITYSDK_OFFSET(0x1C502C10)
#define SIRENIX_SERIALIZATION_VECTOR3DICTIONARYKEYPATHPROVIDER_GETKEYFROMPATHSTRING_OFFSET UNITYSDK_OFFSET(0x1C502D00)
#define SIRENIX_SERIALIZATION_VECTOR3DICTIONARYKEYPATHPROVIDER_GETPATHSTRINGFROMKEY_OFFSET UNITYSDK_OFFSET(0x1C502E60)
#define SIRENIX_SERIALIZATION_VECTOR3DICTIONARYKEYPATHPROVIDER_GET_PROVIDERID_OFFSET UNITYSDK_OFFSET(0x1C502BD0)
#define SIRENIX_SERIALIZATION_VECTOR3DICTIONARYKEYPATHPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C503060)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int Vector3DictionaryKeyPathProvider_TypeDefinitionIndex = 7438;
