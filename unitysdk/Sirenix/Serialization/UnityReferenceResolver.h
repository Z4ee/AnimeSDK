...
#define SIRENIX_SERIALIZATION_UNITYREFERENCERESOLVER_CANREFERENCE_OFFSET UNITYSDK_OFFSET(0x1F8CA120)
#define SIRENIX_SERIALIZATION_UNITYREFERENCERESOLVER_GETREFERENCEDUNITYOBJECTS_OFFSET UNITYSDK_OFFSET(0x1F8CB610)
#define SIRENIX_SERIALIZATION_UNITYREFERENCERESOLVER_RESET_OFFSET UNITYSDK_OFFSET(0x1F8CB690)
#define SIRENIX_SERIALIZATION_UNITYREFERENCERESOLVER_SETREFERENCEDUNITYOBJECTS_OFFSET UNITYSDK_OFFSET(0x1F8CB3F0)
#define SIRENIX_SERIALIZATION_UNITYREFERENCERESOLVER_SIRENIX_SERIALIZATION_UTILITIES_ICACHENOTIFICATIONRECEIVER_ONCLAIMED_OFFSET UNITYSDK_OFFSET(0x1F8CB790)
#define SIRENIX_SERIALIZATION_UNITYREFERENCERESOLVER_SIRENIX_SERIALIZATION_UTILITIES_ICACHENOTIFICATIONRECEIVER_ONFREED_OFFSET UNITYSDK_OFFSET(0x1F8CB710)
#define SIRENIX_SERIALIZATION_UNITYREFERENCERESOLVER_TRYRESOLVEREFERENCE_OFFSET UNITYSDK_OFFSET(0x1F8CB620)
#define SIRENIX_SERIALIZATION_UNITYREFERENCERESOLVER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F8CB350)
#define SIRENIX_SERIALIZATION_UNITYREFERENCERESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F8CB270)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int UnityReferenceResolver_TypeDefinitionIndex = 7612;
