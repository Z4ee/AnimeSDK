...
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_APPLYDICTIONARYMODIFICATIONS_OFFSET UNITYSDK_OFFSET(0x1E8E46C0)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_APPLYLISTLENGTH_OFFSET UNITYSDK_OFFSET(0x1E8E34D0)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_APPLYVALUE_OFFSET UNITYSDK_OFFSET(0x1E8E3390)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_APPLY_OFFSET UNITYSDK_OFFSET(0x1E8E32B0)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_GETINSTANCEFROMPATH_OFFSET UNITYSDK_OFFSET(0x1E8E4D70)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_GETINSTANCEOFSTEP_OFFSET UNITYSDK_OFFSET(0x1E8E55D0)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_REPLACEALLREFERENCESINGRAPH_OFFSET UNITYSDK_OFFSET(0x1E8E4F20)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_SETINSTANCETOPATH_1_OFFSET UNITYSDK_OFFSET(0x1E8E6710)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_SETINSTANCETOPATH_OFFSET UNITYSDK_OFFSET(0x1E8E4E70)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_TRYSETINSTANCEOFSTEP_OFFSET UNITYSDK_OFFSET(0x1E8E6820)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8E7E20)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int PrefabModification_TypeDefinitionIndex = 7522;

	class PrefabModification : public ::System::Object
	{
	public:
		::Il2CppArray<::System::Object*>* DictionaryKeysAdded; // 0x10
		::System::Object* ModifiedValue; // 0x18
		::Il2CppArray<::System::Object*>* DictionaryKeysRemoved; // 0x20
		::System::Collections::Generic::List_1<::System::String*>* ReferencePaths; // 0x28
