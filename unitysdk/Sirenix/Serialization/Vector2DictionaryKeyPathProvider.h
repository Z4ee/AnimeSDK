...
#define SIRENIX_SERIALIZATION_VECTOR2DICTIONARYKEYPATHPROVIDER_COMPARE_OFFSET UNITYSDK_OFFSET(0x1E519200)
#define SIRENIX_SERIALIZATION_VECTOR2DICTIONARYKEYPATHPROVIDER_GETKEYFROMPATHSTRING_OFFSET UNITYSDK_OFFSET(0x1E519290)
#define SIRENIX_SERIALIZATION_VECTOR2DICTIONARYKEYPATHPROVIDER_GETPATHSTRINGFROMKEY_OFFSET UNITYSDK_OFFSET(0x1E519370)
#define SIRENIX_SERIALIZATION_VECTOR2DICTIONARYKEYPATHPROVIDER_GET_PROVIDERID_OFFSET UNITYSDK_OFFSET(0x1E5191C0)
#define SIRENIX_SERIALIZATION_VECTOR2DICTIONARYKEYPATHPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E519510)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int Vector2DictionaryKeyPathProvider_TypeDefinitionIndex = 7569;
