...
#define SIRENIX_SERIALIZATION_VECTOR2DICTIONARYKEYPATHPROVIDER_COMPARE_OFFSET UNITYSDK_OFFSET(0x1F91DD40)
#define SIRENIX_SERIALIZATION_VECTOR2DICTIONARYKEYPATHPROVIDER_GETKEYFROMPATHSTRING_OFFSET UNITYSDK_OFFSET(0x1F91DDD0)
#define SIRENIX_SERIALIZATION_VECTOR2DICTIONARYKEYPATHPROVIDER_GETPATHSTRINGFROMKEY_OFFSET UNITYSDK_OFFSET(0x1F91DEB0)
#define SIRENIX_SERIALIZATION_VECTOR2DICTIONARYKEYPATHPROVIDER_GET_PROVIDERID_OFFSET UNITYSDK_OFFSET(0x1F91DD00)
#define SIRENIX_SERIALIZATION_VECTOR2DICTIONARYKEYPATHPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F91E050)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int Vector2DictionaryKeyPathProvider_TypeDefinitionIndex = 7573;
