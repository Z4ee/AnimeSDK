...
#define SIRENIX_SERIALIZATION_KEYFRAMEFORMATTER___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C145F70)
#define SIRENIX_SERIALIZATION_KEYFRAMEFORMATTER___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1C145FB0)
#define SIRENIX_SERIALIZATION_KEYFRAMEFORMATTER___C___CCTOR_B__6_0_OFFSET UNITYSDK_OFFSET(0x1C145FC0)
#define SIRENIX_SERIALIZATION_KEYFRAMEFORMATTER___C___CCTOR_B__6_1_OFFSET UNITYSDK_OFFSET(0x1C146060)
#define SIRENIX_SERIALIZATION_KEYFRAMEFORMATTER___C___CCTOR_B__6_2_OFFSET UNITYSDK_OFFSET(0x1C146100)
#define SIRENIX_SERIALIZATION_KEYFRAMEFORMATTER___C___CCTOR_B__6_3_OFFSET UNITYSDK_OFFSET(0x1C1461A0)
#define SIRENIX_SERIALIZATION_KEYFRAMEFORMATTER___C___CCTOR_B__6_4_OFFSET UNITYSDK_OFFSET(0x1C146240)
#define SIRENIX_SERIALIZATION_KEYFRAMEFORMATTER___C___CCTOR_B__6_5_OFFSET UNITYSDK_OFFSET(0x1C1462E0)
#define SIRENIX_SERIALIZATION_KEYFRAMEFORMATTER___C___CCTOR_B__6_6_OFFSET UNITYSDK_OFFSET(0x1C146380)
#define SIRENIX_SERIALIZATION_KEYFRAMEFORMATTER___C___CCTOR_B__6_7_OFFSET UNITYSDK_OFFSET(0x1C146420)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int KeyframeFormatter___c_TypeDefinitionIndex = 7453;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::KeyframeFormatter___c**)Il2CppClass::FromTypeDefinitionIndex(KeyframeFormatter___c_TypeDefinitionIndex)->GetStaticField(0x6080);
		}
