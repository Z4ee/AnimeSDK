...
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C47C530)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1C47C570)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY___C___CCTOR_B__12_0_OFFSET UNITYSDK_OFFSET(0x1C47C580)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY___C___CCTOR_B__12_1_OFFSET UNITYSDK_OFFSET(0x1C47C700)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int DictionaryKeyUtility___c_TypeDefinitionIndex = 7432;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::DictionaryKeyUtility___c**)Il2CppClass::FromTypeDefinitionIndex(DictionaryKeyUtility___c_TypeDefinitionIndex)->GetStaticField(0x6260);
		}
