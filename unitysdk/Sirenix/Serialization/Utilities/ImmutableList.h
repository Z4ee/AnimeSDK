...
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1DC2B9A0)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_COPYTO_1_OFFSET UNITYSDK_OFFSET(0x1DC2BB70)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_COPYTO_OFFSET UNITYSDK_OFFSET(0x1DC2BA90)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1DC2BC50)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1DC2B3A0)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_GET_ISFIXEDSIZE_OFFSET UNITYSDK_OFFSET(0x1DC2B480)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1DC2B490)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1DC2B4A0)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1DC2B8C0)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1DC2B580)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1DC2BF20)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_GENERIC_ICOLLECTION_SYSTEM_OBJECT__ADD_OFFSET UNITYSDK_OFFSET(0x1DC2C0B0)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_GENERIC_ICOLLECTION_SYSTEM_OBJECT__CLEAR_OFFSET UNITYSDK_OFFSET(0x1DC2C100)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_GENERIC_ICOLLECTION_SYSTEM_OBJECT__REMOVE_OFFSET UNITYSDK_OFFSET(0x1DC2C150)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_OBJECT__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1DC2BD40)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_GENERIC_ILIST_SYSTEM_OBJECT__GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1DC2B790)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_GENERIC_ILIST_SYSTEM_OBJECT__INSERT_OFFSET UNITYSDK_OFFSET(0x1DC2C060)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_GENERIC_ILIST_SYSTEM_OBJECT__REMOVEAT_OFFSET UNITYSDK_OFFSET(0x1DC2C010)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_GENERIC_ILIST_SYSTEM_OBJECT__SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1DC2B870)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1DC2BD30)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_ILIST_ADD_OFFSET UNITYSDK_OFFSET(0x1DC2BD90)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_ILIST_CLEAR_OFFSET UNITYSDK_OFFSET(0x1DC2BDE0)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_ILIST_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1DC2B660)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_ILIST_INSERT_OFFSET UNITYSDK_OFFSET(0x1DC2BE30)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_ILIST_REMOVEAT_OFFSET UNITYSDK_OFFSET(0x1DC2BED0)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_ILIST_REMOVE_OFFSET UNITYSDK_OFFSET(0x1DC2BE80)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_ILIST_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1DC2B740)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC2B330)

namespace Sirenix::Serialization::Utilities
{
	inline static constexpr unsigned int ImmutableList_TypeDefinitionIndex = 7653;
