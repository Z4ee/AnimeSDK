...
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1F053EB0)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_COPYTO_1_OFFSET UNITYSDK_OFFSET(0x1F054080)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_COPYTO_OFFSET UNITYSDK_OFFSET(0x1F053FA0)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1F054160)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1F0538B0)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_GET_ISFIXEDSIZE_OFFSET UNITYSDK_OFFSET(0x1F053990)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1F0539A0)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1F0539B0)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1F053DD0)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1F053A90)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1F054430)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_GENERIC_ICOLLECTION_SYSTEM_OBJECT__ADD_OFFSET UNITYSDK_OFFSET(0x1F0545C0)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_GENERIC_ICOLLECTION_SYSTEM_OBJECT__CLEAR_OFFSET UNITYSDK_OFFSET(0x1F054610)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_GENERIC_ICOLLECTION_SYSTEM_OBJECT__REMOVE_OFFSET UNITYSDK_OFFSET(0x1F054660)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_OBJECT__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1F054250)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_GENERIC_ILIST_SYSTEM_OBJECT__GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1F053CA0)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_GENERIC_ILIST_SYSTEM_OBJECT__INSERT_OFFSET UNITYSDK_OFFSET(0x1F054570)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_GENERIC_ILIST_SYSTEM_OBJECT__REMOVEAT_OFFSET UNITYSDK_OFFSET(0x1F054520)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_GENERIC_ILIST_SYSTEM_OBJECT__SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1F053D80)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1F054240)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_ILIST_ADD_OFFSET UNITYSDK_OFFSET(0x1F0542A0)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_ILIST_CLEAR_OFFSET UNITYSDK_OFFSET(0x1F0542F0)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_ILIST_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1F053B70)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_ILIST_INSERT_OFFSET UNITYSDK_OFFSET(0x1F054340)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_ILIST_REMOVEAT_OFFSET UNITYSDK_OFFSET(0x1F0543E0)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_ILIST_REMOVE_OFFSET UNITYSDK_OFFSET(0x1F054390)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST_SYSTEM_COLLECTIONS_ILIST_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1F053C50)
#define SIRENIX_SERIALIZATION_UTILITIES_IMMUTABLELIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1F053840)

namespace Sirenix::Serialization::Utilities
{
	inline static constexpr unsigned int ImmutableList_TypeDefinitionIndex = 7657;
