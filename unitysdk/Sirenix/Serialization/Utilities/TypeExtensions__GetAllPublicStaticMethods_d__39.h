...
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLPUBLICSTATICMETHODS_D__39_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1DBF7AF0)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLPUBLICSTATICMETHODS_D__39_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_REFLECTION_METHODINFO__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1DBF7E30)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLPUBLICSTATICMETHODS_D__39_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_REFLECTION_METHODINFO__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DBF7DC0)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLPUBLICSTATICMETHODS_D__39_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1DBF7EB0)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLPUBLICSTATICMETHODS_D__39_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DBF7E20)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLPUBLICSTATICMETHODS_D__39_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1DBF7DD0)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLPUBLICSTATICMETHODS_D__39_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DBF7AE0)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLPUBLICSTATICMETHODS_D__39__CTOR_OFFSET UNITYSDK_OFFSET(0x1DBF7AC0)

namespace Sirenix::Serialization::Utilities
{
	inline static constexpr unsigned int TypeExtensions__GetAllPublicStaticMethods_d__39_TypeDefinitionIndex = 7626;
