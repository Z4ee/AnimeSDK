...
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GETCUSTOMATTRIBUTES_1_OFFSET UNITYSDK_OFFSET(0x1C3F7240)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GETCUSTOMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1C3F7210)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1C3F72A0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_ALIASEDFIELD_OFFSET UNITYSDK_OFFSET(0x1C3F70A0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1C3F71E0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_DECLARINGTYPE_OFFSET UNITYSDK_OFFSET(0x1C3F7120)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_FIELDHANDLE_OFFSET UNITYSDK_OFFSET(0x1C3F71B0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_FIELDTYPE_OFFSET UNITYSDK_OFFSET(0x1C3F7180)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_METADATATOKEN_OFFSET UNITYSDK_OFFSET(0x1C3F70E0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_MODULE_OFFSET UNITYSDK_OFFSET(0x1C3F70B0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1C3F7110)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_REFLECTEDTYPE_OFFSET UNITYSDK_OFFSET(0x1C3F7150)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_ISDEFINED_OFFSET UNITYSDK_OFFSET(0x1C3F7270)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1C3F72D0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C3F7050)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3F6FE0)

namespace Sirenix::Serialization::Utilities
{
	inline static constexpr unsigned int MemberAliasFieldInfo_TypeDefinitionIndex = 7525;
	...
	public:
		...
		::System::Reflection::FieldInfo* aliasedField; // 0x18
