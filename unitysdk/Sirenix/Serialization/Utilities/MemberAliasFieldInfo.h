...
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GETCUSTOMATTRIBUTES_1_OFFSET UNITYSDK_OFFSET(0x1E738CE0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GETCUSTOMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1E738CB0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1E738D40)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_ALIASEDFIELD_OFFSET UNITYSDK_OFFSET(0x1E738B40)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1E738C80)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_DECLARINGTYPE_OFFSET UNITYSDK_OFFSET(0x1E738BC0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_FIELDHANDLE_OFFSET UNITYSDK_OFFSET(0x1E738C50)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_FIELDTYPE_OFFSET UNITYSDK_OFFSET(0x1E738C20)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_METADATATOKEN_OFFSET UNITYSDK_OFFSET(0x1E738B80)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_MODULE_OFFSET UNITYSDK_OFFSET(0x1E738B50)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1E738BB0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_REFLECTEDTYPE_OFFSET UNITYSDK_OFFSET(0x1E738BF0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_ISDEFINED_OFFSET UNITYSDK_OFFSET(0x1E738D10)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1E738D70)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E738AF0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1E738A80)

namespace Sirenix::Serialization::Utilities
{
	inline static constexpr unsigned int MemberAliasFieldInfo_TypeDefinitionIndex = 7657;
