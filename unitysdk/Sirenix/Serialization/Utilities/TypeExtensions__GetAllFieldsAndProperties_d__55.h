...
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLFIELDSANDPROPERTIES_D__55_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1E738DE0)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLFIELDSANDPROPERTIES_D__55_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_REFLECTION_MEMBERINFO__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1E739020)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLFIELDSANDPROPERTIES_D__55_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_REFLECTION_MEMBERINFO__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E738FB0)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLFIELDSANDPROPERTIES_D__55_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1E7390A0)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLFIELDSANDPROPERTIES_D__55_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E739010)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLFIELDSANDPROPERTIES_D__55_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1E738FC0)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLFIELDSANDPROPERTIES_D__55_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E738DD0)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLFIELDSANDPROPERTIES_D__55__CTOR_OFFSET UNITYSDK_OFFSET(0x1E738DB0)

namespace Sirenix::Serialization::Utilities
{
	inline static constexpr unsigned int TypeExtensions__GetAllFieldsAndProperties_d__55_TypeDefinitionIndex = 7627;

	class TypeExtensions__GetAllFieldsAndProperties_d__55 : public ::System::Object
	{
	public:
		::System::Reflection::MemberInfo* __2__current; // 0x10
		::System::Type* __3__type; // 0x18
		::System::Type* _currentType_5__2; // 0x20
		::Il2CppArray<::System::Reflection::MemberInfo*>* __7__wrap3; // 0x28
		::System::Type* type; // 0x30
		::System::Int32 __1__state; // 0x38
		::System::Reflection::BindingFlags _flags_5__3; // 0x3C
