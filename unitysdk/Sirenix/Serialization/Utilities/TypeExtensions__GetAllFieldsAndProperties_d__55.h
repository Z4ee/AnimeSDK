...
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLFIELDSANDPROPERTIES_D__55_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1FB1B1C0)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLFIELDSANDPROPERTIES_D__55_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_REFLECTION_MEMBERINFO__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1FB1B400)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLFIELDSANDPROPERTIES_D__55_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_REFLECTION_MEMBERINFO__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1FB1B390)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLFIELDSANDPROPERTIES_D__55_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1FB1B480)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLFIELDSANDPROPERTIES_D__55_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1FB1B3F0)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLFIELDSANDPROPERTIES_D__55_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1FB1B3A0)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLFIELDSANDPROPERTIES_D__55_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1FB1B1B0)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLFIELDSANDPROPERTIES_D__55__CTOR_OFFSET UNITYSDK_OFFSET(0x1FB1B190)

namespace Sirenix::Serialization::Utilities
{
	inline static constexpr unsigned int TypeExtensions__GetAllFieldsAndProperties_d__55_TypeDefinitionIndex = 7631;
	...
	public:
		...
		::System::Reflection::BindingFlags _flags_5__3; // 0x44
