...
#define SIRENIX_SERIALIZATION_UTILITIES_PROPERTYINFOEXTENSIONS_DEALIASPROPERTY_OFFSET UNITYSDK_OFFSET(0x1E835510)
#define SIRENIX_SERIALIZATION_UTILITIES_PROPERTYINFOEXTENSIONS_ISALIASPROPERTY_OFFSET UNITYSDK_OFFSET(0x1E8354C0)
#define SIRENIX_SERIALIZATION_UTILITIES_PROPERTYINFOEXTENSIONS_ISAUTOPROPERTY_OFFSET UNITYSDK_OFFSET(0x1E835250)

namespace Sirenix::Serialization::Utilities
{
	inline static constexpr unsigned int PropertyInfoExtensions_TypeDefinitionIndex = 7622;
