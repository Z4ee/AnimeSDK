...
#define SIRENIX_SERIALIZATION_UTILITIES_UNSAFE_UNSAFEUTILITIES_MEMORYCOPY_1_OFFSET UNITYSDK_OFFSET(0x1C517CD0)
#define SIRENIX_SERIALIZATION_UTILITIES_UNSAFE_UNSAFEUTILITIES_MEMORYCOPY_OFFSET UNITYSDK_OFFSET(0x1C517C10)
#define SIRENIX_SERIALIZATION_UTILITIES_UNSAFE_UNSAFEUTILITIES_STRINGFROMBYTES_OFFSET UNITYSDK_OFFSET(0x1C517130)
#define SIRENIX_SERIALIZATION_UTILITIES_UNSAFE_UNSAFEUTILITIES_STRINGTOBYTES_OFFSET UNITYSDK_OFFSET(0x1C5176F0)

namespace Sirenix::Serialization::Utilities::Unsafe
{
	inline static constexpr unsigned int UnsafeUtilities_TypeDefinitionIndex = 7530;
