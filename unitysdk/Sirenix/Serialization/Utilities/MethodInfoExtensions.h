...
#define SIRENIX_SERIALIZATION_UTILITIES_METHODINFOEXTENSIONS_DEALIASMETHOD_OFFSET UNITYSDK_OFFSET(0x1C47E070)
#define SIRENIX_SERIALIZATION_UTILITIES_METHODINFOEXTENSIONS_GETFULLNAME_1_OFFSET UNITYSDK_OFFSET(0x1C47DB50)
#define SIRENIX_SERIALIZATION_UTILITIES_METHODINFOEXTENSIONS_GETFULLNAME_OFFSET UNITYSDK_OFFSET(0x1C47DB90)
#define SIRENIX_SERIALIZATION_UTILITIES_METHODINFOEXTENSIONS_GETPARAMSNAMES_OFFSET UNITYSDK_OFFSET(0x1C47DD70)
#define SIRENIX_SERIALIZATION_UTILITIES_METHODINFOEXTENSIONS_ISALIASMETHOD_OFFSET UNITYSDK_OFFSET(0x1C47E020)
#define SIRENIX_SERIALIZATION_UTILITIES_METHODINFOEXTENSIONS_ISEXTENSIONMETHOD_OFFSET UNITYSDK_OFFSET(0x1C47DCB0)

namespace Sirenix::Serialization::Utilities
{
	inline static constexpr unsigned int MethodInfoExtensions_TypeDefinitionIndex = 7487;
