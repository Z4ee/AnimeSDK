...
#define SIRENIX_SERIALIZATION_UTILITIES_METHODINFOEXTENSIONS_DEALIASMETHOD_OFFSET UNITYSDK_OFFSET(0x1E7BC030)
#define SIRENIX_SERIALIZATION_UTILITIES_METHODINFOEXTENSIONS_GETFULLNAME_1_OFFSET UNITYSDK_OFFSET(0x1E7BBB10)
#define SIRENIX_SERIALIZATION_UTILITIES_METHODINFOEXTENSIONS_GETFULLNAME_OFFSET UNITYSDK_OFFSET(0x1E7BBB50)
#define SIRENIX_SERIALIZATION_UTILITIES_METHODINFOEXTENSIONS_GETPARAMSNAMES_OFFSET UNITYSDK_OFFSET(0x1E7BBD30)
#define SIRENIX_SERIALIZATION_UTILITIES_METHODINFOEXTENSIONS_ISALIASMETHOD_OFFSET UNITYSDK_OFFSET(0x1E7BBFE0)
#define SIRENIX_SERIALIZATION_UTILITIES_METHODINFOEXTENSIONS_ISEXTENSIONMETHOD_OFFSET UNITYSDK_OFFSET(0x1E7BBC70)

namespace Sirenix::Serialization::Utilities
{
	inline static constexpr unsigned int MethodInfoExtensions_TypeDefinitionIndex = 7619;
