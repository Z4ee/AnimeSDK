...
#define SIRENIX_SERIALIZATION_UTILITIES_WEAKVALUEGETTER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DC2C1A0)
#define SIRENIX_SERIALIZATION_UTILITIES_WEAKVALUEGETTER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DC2C1D0)
#define SIRENIX_SERIALIZATION_UTILITIES_WEAKVALUEGETTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DC22BA0)
#define SIRENIX_SERIALIZATION_UTILITIES_WEAKVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC2AA90)

namespace Sirenix::Serialization::Utilities
{
	inline static constexpr unsigned int WeakValueGetter_TypeDefinitionIndex = 7632;
