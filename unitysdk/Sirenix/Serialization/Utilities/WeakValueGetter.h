...
#define SIRENIX_SERIALIZATION_UTILITIES_WEAKVALUEGETTER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F0546B0)
#define SIRENIX_SERIALIZATION_UTILITIES_WEAKVALUEGETTER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F0546E0)
#define SIRENIX_SERIALIZATION_UTILITIES_WEAKVALUEGETTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F04B1C0)
#define SIRENIX_SERIALIZATION_UTILITIES_WEAKVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F052FA0)

namespace Sirenix::Serialization::Utilities
{
	inline static constexpr unsigned int WeakValueGetter_TypeDefinitionIndex = 7636;
