...
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASPROPERTYINFO_GETACCESSORS_OFFSET UNITYSDK_OFFSET(0x1FB99200)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASPROPERTYINFO_GETCUSTOMATTRIBUTES_1_OFFSET UNITYSDK_OFFSET(0x1FB991A0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASPROPERTYINFO_GETCUSTOMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1FB99170)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASPROPERTYINFO_GETGETMETHOD_OFFSET UNITYSDK_OFFSET(0x1FB99230)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASPROPERTYINFO_GETINDEXPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1FB99260)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASPROPERTYINFO_GETSETMETHOD_OFFSET UNITYSDK_OFFSET(0x1FB99290)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASPROPERTYINFO_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1FB992C0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASPROPERTYINFO_GET_ALIASEDPROPERTY_OFFSET UNITYSDK_OFFSET(0x1FB98FD0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASPROPERTYINFO_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1FB990E0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASPROPERTYINFO_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1FB99110)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASPROPERTYINFO_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1FB99140)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASPROPERTYINFO_GET_DECLARINGTYPE_OFFSET UNITYSDK_OFFSET(0x1FB99050)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASPROPERTYINFO_GET_METADATATOKEN_OFFSET UNITYSDK_OFFSET(0x1FB99010)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASPROPERTYINFO_GET_MODULE_OFFSET UNITYSDK_OFFSET(0x1FB98FE0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASPROPERTYINFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1FB99040)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASPROPERTYINFO_GET_PROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x1FB990B0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASPROPERTYINFO_GET_REFLECTEDTYPE_OFFSET UNITYSDK_OFFSET(0x1FB99080)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASPROPERTYINFO_ISDEFINED_OFFSET UNITYSDK_OFFSET(0x1FB991D0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASPROPERTYINFO_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1FB99300)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASPROPERTYINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1FB98F80)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASPROPERTYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1FB98F10)

namespace Sirenix::Serialization::Utilities
{
	inline static constexpr unsigned int MemberAliasPropertyInfo_TypeDefinitionIndex = 7663;
