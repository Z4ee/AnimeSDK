...
#define SIRENIX_SERIALIZATION_UTILITIES_WEAKVALUESETTER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DC2C1F0)
#define SIRENIX_SERIALIZATION_UTILITIES_WEAKVALUESETTER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DC2C230)
#define SIRENIX_SERIALIZATION_UTILITIES_WEAKVALUESETTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DC288A0)
#define SIRENIX_SERIALIZATION_UTILITIES_WEAKVALUESETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC2AAB0)

namespace Sirenix::Serialization::Utilities
{
	inline static constexpr unsigned int WeakValueSetter_TypeDefinitionIndex = 7633;
