...
#define SIRENIX_SERIALIZATION_UTILITIES_WEAKVALUESETTER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F054700)
#define SIRENIX_SERIALIZATION_UTILITIES_WEAKVALUESETTER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F054740)
#define SIRENIX_SERIALIZATION_UTILITIES_WEAKVALUESETTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F050DD0)
#define SIRENIX_SERIALIZATION_UTILITIES_WEAKVALUESETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F052FC0)

namespace Sirenix::Serialization::Utilities
{
	inline static constexpr unsigned int WeakValueSetter_TypeDefinitionIndex = 7637;
