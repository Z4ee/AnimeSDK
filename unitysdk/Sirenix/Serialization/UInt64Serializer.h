...
#define SIRENIX_SERIALIZATION_UINT64SERIALIZER_READVALUE_OFFSET UNITYSDK_OFFSET(0x1BCF8770)
#define SIRENIX_SERIALIZATION_UINT64SERIALIZER_WRITEVALUE_OFFSET UNITYSDK_OFFSET(0x1BCF8D60)
#define SIRENIX_SERIALIZATION_UINT64SERIALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCF8E40)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int UInt64Serializer_TypeDefinitionIndex = 7424;
