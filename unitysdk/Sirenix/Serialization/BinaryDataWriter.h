...
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_BEGINARRAYNODE_OFFSET UNITYSDK_OFFSET(0x1B644770)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_BEGINREFERENCENODE_OFFSET UNITYSDK_OFFSET(0x1B6449E0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_BEGINSTRUCTNODE_OFFSET UNITYSDK_OFFSET(0x1B645540)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B645620)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_ENDARRAYNODE_OFFSET UNITYSDK_OFFSET(0x1B645700)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_ENDNODE_OFFSET UNITYSDK_OFFSET(0x1B645760)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_ENSUREBUFFERSPACE_OFFSET UNITYSDK_OFFSET(0x1B64DC10)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_FLUSHTOSTREAM_OFFSET UNITYSDK_OFFSET(0x1B645690)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_GETDATADUMP_OFFSET UNITYSDK_OFFSET(0x1B64CC30)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_PREPARENEWSERIALIZATIONSESSION_OFFSET UNITYSDK_OFFSET(0x1B64CBA0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_TRYENSUREBUFFERSPACE_OFFSET UNITYSDK_OFFSET(0x1B64DD10)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_UNSAFE_WRITETOBUFFER_16_DECIMAL_OFFSET UNITYSDK_OFFSET(0x1B64D950)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_UNSAFE_WRITETOBUFFER_16_GUID_OFFSET UNITYSDK_OFFSET(0x1B64DAB0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_UNSAFE_WRITETOBUFFER_2_CHAR_OFFSET UNITYSDK_OFFSET(0x1B64D340)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_UNSAFE_WRITETOBUFFER_2_INT16_OFFSET UNITYSDK_OFFSET(0x1B64D3A0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_UNSAFE_WRITETOBUFFER_2_UINT16_OFFSET UNITYSDK_OFFSET(0x1B64D400)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_UNSAFE_WRITETOBUFFER_4_FLOAT32_OFFSET UNITYSDK_OFFSET(0x1B64D540)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_UNSAFE_WRITETOBUFFER_4_INT32_OFFSET UNITYSDK_OFFSET(0x1B64D460)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_UNSAFE_WRITETOBUFFER_4_UINT32_OFFSET UNITYSDK_OFFSET(0x1B64D4D0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_UNSAFE_WRITETOBUFFER_8_FLOAT64_OFFSET UNITYSDK_OFFSET(0x1B64D840)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_UNSAFE_WRITETOBUFFER_8_INT64_OFFSET UNITYSDK_OFFSET(0x1B64D640)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_UNSAFE_WRITETOBUFFER_8_UINT64_OFFSET UNITYSDK_OFFSET(0x1B64D740)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1B64B600)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1B64B720)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITECHAR_OFFSET UNITYSDK_OFFSET(0x1B64B840)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEDECIMAL_OFFSET UNITYSDK_OFFSET(0x1B64B9B0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEDOUBLE_OFFSET UNITYSDK_OFFSET(0x1B64BA80)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEEXTERNALREFERENCE_1_OFFSET UNITYSDK_OFFSET(0x1B64BCF0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEEXTERNALREFERENCE_2_OFFSET UNITYSDK_OFFSET(0x1B64BE80)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEEXTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B64BC20)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEGUID_OFFSET UNITYSDK_OFFSET(0x1B64BB50)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEINT16_OFFSET UNITYSDK_OFFSET(0x1B64C500)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEINT32_OFFSET UNITYSDK_OFFSET(0x1B64BF70)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEINT64_OFFSET UNITYSDK_OFFSET(0x1B64C100)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEINTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B64C250)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITENULL_OFFSET UNITYSDK_OFFSET(0x1B64C1C0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEPRIMITIVEARRAY_BOOL_OFFSET UNITYSDK_OFFSET(0x1B645F30)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEPRIMITIVEARRAY_BYTE_OFFSET UNITYSDK_OFFSET(0x1B6457E0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEPRIMITIVEARRAY_CHAR_OFFSET UNITYSDK_OFFSET(0x1B646470)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEPRIMITIVEARRAY_DECIMAL_OFFSET UNITYSDK_OFFSET(0x1B649650)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEPRIMITIVEARRAY_DOUBLE_OFFSET UNITYSDK_OFFSET(0x1B64A620)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEPRIMITIVEARRAY_FLOAT_OFFSET UNITYSDK_OFFSET(0x1B649E80)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEPRIMITIVEARRAY_GUID_OFFSET UNITYSDK_OFFSET(0x1B64ADD0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEPRIMITIVEARRAY_INT_OFFSET UNITYSDK_OFFSET(0x1B6472B0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEPRIMITIVEARRAY_LONG_OFFSET UNITYSDK_OFFSET(0x1B6479C0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEPRIMITIVEARRAY_SBYTE_OFFSET UNITYSDK_OFFSET(0x1B6459F0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEPRIMITIVEARRAY_SHORT_OFFSET UNITYSDK_OFFSET(0x1B646B90)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEPRIMITIVEARRAY_UINT_OFFSET UNITYSDK_OFFSET(0x1B648790)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEPRIMITIVEARRAY_ULONG_OFFSET UNITYSDK_OFFSET(0x1B648EA0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEPRIMITIVEARRAY_USHORT_OFFSET UNITYSDK_OFFSET(0x1B648070)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITESBYTE_OFFSET UNITYSDK_OFFSET(0x1B64C3E0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITESINGLE_OFFSET UNITYSDK_OFFSET(0x1B64C670)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITESTRINGFAST_OFFSET UNITYSDK_OFFSET(0x1B644B50)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITESTRING_OFFSET UNITYSDK_OFFSET(0x1B64C740)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITETYPE_OFFSET UNITYSDK_OFFSET(0x1B64CE10)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEUINT16_OFFSET UNITYSDK_OFFSET(0x1B64CA30)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEUINT32_OFFSET UNITYSDK_OFFSET(0x1B64C7E0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEUINT64_OFFSET UNITYSDK_OFFSET(0x1B64C970)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B64DDA0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B644630)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B644520)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int BinaryDataWriter_TypeDefinitionIndex = 7287;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(BinaryDataWriter_TypeDefinitionIndex)->GetStaticField(0x6430);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::Delegate*>** StaticGet_PrimitiveGetBytesMethods()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::Delegate*>**)Il2CppClass::FromTypeDefinitionIndex(BinaryDataWriter_TypeDefinitionIndex)->GetStaticField(0x6438);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::Action_2<::Sirenix::Serialization::BinaryDataWriter*, ::System::Object*>*>**)Il2CppClass::FromTypeDefinitionIndex(BinaryDataWriter_TypeDefinitionIndex)->GetStaticField(0x6440);
		}
		::Il2CppArray<::System::Byte>* small_buffer; // 0x38
