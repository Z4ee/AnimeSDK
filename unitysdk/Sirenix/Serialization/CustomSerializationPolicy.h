...
#define SIRENIX_SERIALIZATION_CUSTOMSERIALIZATIONPOLICY_GET_ALLOWNONSERIALIZABLETYPES_OFFSET UNITYSDK_OFFSET(0x1B0FDDF0)
#define SIRENIX_SERIALIZATION_CUSTOMSERIALIZATIONPOLICY_GET_ID_OFFSET UNITYSDK_OFFSET(0x1B0FDDE0)
#define SIRENIX_SERIALIZATION_CUSTOMSERIALIZATIONPOLICY_SHOULDSERIALIZEMEMBER_OFFSET UNITYSDK_OFFSET(0x1B0FDE00)
#define SIRENIX_SERIALIZATION_CUSTOMSERIALIZATIONPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0FDD30)
