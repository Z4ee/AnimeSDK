...
#define SIRENIX_ODININSPECTOR_HIDEIFGROUPATTRIBUTE_COMBINEVALUESWITH_OFFSET UNITYSDK_OFFSET(0x1F7704D0)
#define SIRENIX_ODININSPECTOR_HIDEIFGROUPATTRIBUTE_GET_ANIMATE_OFFSET UNITYSDK_OFFSET(0x1F7702F0)
#define SIRENIX_ODININSPECTOR_HIDEIFGROUPATTRIBUTE_GET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1F770330)
#define SIRENIX_ODININSPECTOR_HIDEIFGROUPATTRIBUTE_GET_MEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1F770310)
#define SIRENIX_ODININSPECTOR_HIDEIFGROUPATTRIBUTE_SET_ANIMATE_OFFSET UNITYSDK_OFFSET(0x1F770300)
#define SIRENIX_ODININSPECTOR_HIDEIFGROUPATTRIBUTE_SET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1F770360)
#define SIRENIX_ODININSPECTOR_HIDEIFGROUPATTRIBUTE_SET_MEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1F770350)
#define SIRENIX_ODININSPECTOR_HIDEIFGROUPATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F770450)
#define SIRENIX_ODININSPECTOR_HIDEIFGROUPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F770370)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int HideIfGroupAttribute_TypeDefinitionIndex = 7306;
