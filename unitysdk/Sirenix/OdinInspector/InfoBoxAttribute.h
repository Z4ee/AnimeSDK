...
#define SIRENIX_ODININSPECTOR_INFOBOXATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F7708B0)
#define SIRENIX_ODININSPECTOR_INFOBOXATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F7708A0)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int InfoBoxAttribute_TypeDefinitionIndex = 7323;
