...
#define SIRENIX_ODININSPECTOR_VALUEDROPDOWNITEM_SIRENIX_ODININSPECTOR_IVALUEDROPDOWNITEM_GETSELECTEDTEXT_OFFSET UNITYSDK_OFFSET(0x466520)
#define SIRENIX_ODININSPECTOR_VALUEDROPDOWNITEM_SIRENIX_ODININSPECTOR_IVALUEDROPDOWNITEM_GETTEXT_OFFSET UNITYSDK_OFFSET(0x228FE0)
#define SIRENIX_ODININSPECTOR_VALUEDROPDOWNITEM_SIRENIX_ODININSPECTOR_IVALUEDROPDOWNITEM_GETVALUE_OFFSET UNITYSDK_OFFSET(0x381840)
#define SIRENIX_ODININSPECTOR_VALUEDROPDOWNITEM_TOSTRING_OFFSET UNITYSDK_OFFSET(0x466540)
#define SIRENIX_ODININSPECTOR_VALUEDROPDOWNITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x4626C0)
