...
#define SIRENIX_ODININSPECTOR_CUSTOMVALUEDRAWERATTRIBUTE_GET_METHODNAME_OFFSET UNITYSDK_OFFSET(0x1C01F6A0)
#define SIRENIX_ODININSPECTOR_CUSTOMVALUEDRAWERATTRIBUTE_SET_METHODNAME_OFFSET UNITYSDK_OFFSET(0x1C01F6B0)
#define SIRENIX_ODININSPECTOR_CUSTOMVALUEDRAWERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C01F6C0)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int CustomValueDrawerAttribute_TypeDefinitionIndex = 7140;
