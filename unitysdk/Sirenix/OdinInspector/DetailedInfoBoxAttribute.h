...
#define SIRENIX_ODININSPECTOR_DETAILEDINFOBOXATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F76FD90)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int DetailedInfoBoxAttribute_TypeDefinitionIndex = 7277;
