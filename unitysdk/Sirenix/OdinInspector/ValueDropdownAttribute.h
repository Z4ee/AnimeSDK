...
#define SIRENIX_ODININSPECTOR_VALUEDROPDOWNATTRIBUTE_GET_MEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1F772D10)
#define SIRENIX_ODININSPECTOR_VALUEDROPDOWNATTRIBUTE_SET_MEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1F772D20)
#define SIRENIX_ODININSPECTOR_VALUEDROPDOWNATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F772D30)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int ValueDropdownAttribute_TypeDefinitionIndex = 7383;
	...
	public:
		...
		::System::Int32 DropdownHeight; // 0x20
		::System::Int32 NumberOfItemsBeforeEnablingSearch; // 0x24
		::System::Boolean ExpandAllMenuItems; // 0x28
		::System::Boolean AppendNextDrawer; // 0x29
		::System::Boolean DoubleClickToConfirm; // 0x2A
		::System::Boolean ExcludeExistingValuesInList; // 0x2B
		::System::Int32 DropdownWidth; // 0x2C
		::System::Boolean HideChildProperties; // 0x30
		::System::Boolean SortDropdownItems; // 0x31
		::System::Boolean DisableGUIInAppendedDrawer; // 0x32
		::System::Boolean FlattenTreeView; // 0x33
		::System::Boolean IsUniqueList; // 0x34
