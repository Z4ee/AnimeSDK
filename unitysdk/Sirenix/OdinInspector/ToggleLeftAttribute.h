...
#define SIRENIX_ODININSPECTOR_TOGGLELEFTATTRIBUTE_GET_EXPANDCLICKABLEAREA_OFFSET UNITYSDK_OFFSET(0x1C022250)
#define SIRENIX_ODININSPECTOR_TOGGLELEFTATTRIBUTE_SET_EXPANDCLICKABLEAREA_OFFSET UNITYSDK_OFFSET(0x1C022260)
#define SIRENIX_ODININSPECTOR_TOGGLELEFTATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C022270)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int ToggleLeftAttribute_TypeDefinitionIndex = 7242;
