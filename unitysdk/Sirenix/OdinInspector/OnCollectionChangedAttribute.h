...
#define SIRENIX_ODININSPECTOR_ONCOLLECTIONCHANGEDATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F770E40)
#define SIRENIX_ODININSPECTOR_ONCOLLECTIONCHANGEDATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1F770E50)
#define SIRENIX_ODININSPECTOR_ONCOLLECTIONCHANGEDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F770E30)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int OnCollectionChangedAttribute_TypeDefinitionIndex = 7335;
