...
#define SIRENIX_ODININSPECTOR_ONCOLLECTIONCHANGEDATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E329AB0)
#define SIRENIX_ODININSPECTOR_ONCOLLECTIONCHANGEDATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E329AC0)
#define SIRENIX_ODININSPECTOR_ONCOLLECTIONCHANGEDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E329AA0)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int OnCollectionChangedAttribute_TypeDefinitionIndex = 7331;
