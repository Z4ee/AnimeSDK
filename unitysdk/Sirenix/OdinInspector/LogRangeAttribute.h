...
#define SIRENIX_ODININSPECTOR_LOGRANGEATTRIBUTE_GET_MAXMEMBER_OFFSET UNITYSDK_OFFSET(0x1F770C70)
#define SIRENIX_ODININSPECTOR_LOGRANGEATTRIBUTE_GET_MINMEMBER_OFFSET UNITYSDK_OFFSET(0x1F770C50)
#define SIRENIX_ODININSPECTOR_LOGRANGEATTRIBUTE_SET_MAXMEMBER_OFFSET UNITYSDK_OFFSET(0x1F770C80)
#define SIRENIX_ODININSPECTOR_LOGRANGEATTRIBUTE_SET_MINMEMBER_OFFSET UNITYSDK_OFFSET(0x1F770C60)
#define SIRENIX_ODININSPECTOR_LOGRANGEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F770CC0)
#define SIRENIX_ODININSPECTOR_LOGRANGEATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1F770CD0)
#define SIRENIX_ODININSPECTOR_LOGRANGEATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1F770CE0)
#define SIRENIX_ODININSPECTOR_LOGRANGEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F770C90)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int LogRangeAttribute_TypeDefinitionIndex = 7330;
