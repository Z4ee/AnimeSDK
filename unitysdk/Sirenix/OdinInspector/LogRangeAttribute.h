...
#define SIRENIX_ODININSPECTOR_LOGRANGEATTRIBUTE_GET_MAXMEMBER_OFFSET UNITYSDK_OFFSET(0x1C0205E0)
#define SIRENIX_ODININSPECTOR_LOGRANGEATTRIBUTE_GET_MINMEMBER_OFFSET UNITYSDK_OFFSET(0x1C0205C0)
#define SIRENIX_ODININSPECTOR_LOGRANGEATTRIBUTE_SET_MAXMEMBER_OFFSET UNITYSDK_OFFSET(0x1C0205F0)
#define SIRENIX_ODININSPECTOR_LOGRANGEATTRIBUTE_SET_MINMEMBER_OFFSET UNITYSDK_OFFSET(0x1C0205D0)
#define SIRENIX_ODININSPECTOR_LOGRANGEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C020630)
#define SIRENIX_ODININSPECTOR_LOGRANGEATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C020640)
#define SIRENIX_ODININSPECTOR_LOGRANGEATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C020650)
#define SIRENIX_ODININSPECTOR_LOGRANGEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C020600)
