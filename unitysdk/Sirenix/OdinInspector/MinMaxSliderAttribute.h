...
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE_GET_MAXMEMBER_OFFSET UNITYSDK_OFFSET(0x1C0206A0)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE_GET_MINMAXMEMBER_OFFSET UNITYSDK_OFFSET(0x1C0206C0)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE_GET_MINMEMBER_OFFSET UNITYSDK_OFFSET(0x1C020680)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE_SET_MAXMEMBER_OFFSET UNITYSDK_OFFSET(0x1C0206B0)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE_SET_MINMAXMEMBER_OFFSET UNITYSDK_OFFSET(0x1C0206D0)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE_SET_MINMEMBER_OFFSET UNITYSDK_OFFSET(0x1C020690)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C0206F0)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C020700)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C020710)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1C020720)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0206E0)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int MinMaxSliderAttribute_TypeDefinitionIndex = 7197;

	class MinMaxSliderAttribute : public ::System::Attribute
	{
	public:
		::System::String* MinMaxValueGetter; // 0x10
		::System::String* MinValueGetter; // 0x18
		::System::String* MaxValueGetter; // 0x20
		::System::Single MaxValue; // 0x28
		::System::Single MinValue; // 0x2C
		::System::Boolean ShowFields; // 0x30
