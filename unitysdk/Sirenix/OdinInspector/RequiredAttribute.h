...
#define SIRENIX_ODININSPECTOR_REQUIREDATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F7714B0)
#define SIRENIX_ODININSPECTOR_REQUIREDATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1F7714C0)
#define SIRENIX_ODININSPECTOR_REQUIREDATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1F7714D0)
#define SIRENIX_ODININSPECTOR_REQUIREDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F7714A0)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int RequiredAttribute_TypeDefinitionIndex = 7351;
