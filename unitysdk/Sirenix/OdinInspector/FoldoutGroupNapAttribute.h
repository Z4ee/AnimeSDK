...
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPNAPATTRIBUTE_GET_HASDEFINEDEXPANDED_OFFSET UNITYSDK_OFFSET(0x1B626630)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPNAPATTRIBUTE_SET_HASDEFINEDEXPANDED_OFFSET UNITYSDK_OFFSET(0x1B626640)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPNAPATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B626620)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPNAPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B626610)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int FoldoutGroupNapAttribute_TypeDefinitionIndex = 7816;
