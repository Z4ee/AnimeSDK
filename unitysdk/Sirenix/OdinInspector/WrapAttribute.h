...
#define SIRENIX_ODININSPECTOR_WRAPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F772F80)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int WrapAttribute_TypeDefinitionIndex = 7389;
