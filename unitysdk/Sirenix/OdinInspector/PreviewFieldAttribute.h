...
#define SIRENIX_ODININSPECTOR_PREVIEWFIELDATTRIBUTE_GET_ALIGNMENTHASVALUE_OFFSET UNITYSDK_OFFSET(0x1F770F40)
#define SIRENIX_ODININSPECTOR_PREVIEWFIELDATTRIBUTE_GET_ALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1F770F20)
#define SIRENIX_ODININSPECTOR_PREVIEWFIELDATTRIBUTE_SET_ALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1F770F30)
#define SIRENIX_ODININSPECTOR_PREVIEWFIELDATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F770F60)
#define SIRENIX_ODININSPECTOR_PREVIEWFIELDATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1F770F70)
#define SIRENIX_ODININSPECTOR_PREVIEWFIELDATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1F770F80)
#define SIRENIX_ODININSPECTOR_PREVIEWFIELDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F770F50)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int PreviewFieldAttribute_TypeDefinitionIndex = 7342;

	class PreviewFieldAttribute : public ::System::Attribute
	{
	public:
		::Sirenix::OdinInspector::ObjectFieldAlignment alignment; // 0x10
		::System::Single Height; // 0x14
		::System::Boolean alignmentHasValue; // 0x18
