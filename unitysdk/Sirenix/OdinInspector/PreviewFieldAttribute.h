...
#define SIRENIX_ODININSPECTOR_PREVIEWFIELDATTRIBUTE_GET_ALIGNMENTHASVALUE_OFFSET UNITYSDK_OFFSET(0x1C0208C0)
#define SIRENIX_ODININSPECTOR_PREVIEWFIELDATTRIBUTE_GET_ALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1C0208A0)
#define SIRENIX_ODININSPECTOR_PREVIEWFIELDATTRIBUTE_SET_ALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1C0208B0)
#define SIRENIX_ODININSPECTOR_PREVIEWFIELDATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C0208E0)
#define SIRENIX_ODININSPECTOR_PREVIEWFIELDATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C0208F0)
#define SIRENIX_ODININSPECTOR_PREVIEWFIELDATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C020900)
#define SIRENIX_ODININSPECTOR_PREVIEWFIELDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0208D0)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int PreviewFieldAttribute_TypeDefinitionIndex = 7207;

	class PreviewFieldAttribute : public ::System::Attribute
	{
	public:
		::System::Single Height; // 0x10
		::System::Boolean alignmentHasValue; // 0x14
