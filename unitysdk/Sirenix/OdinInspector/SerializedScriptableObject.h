...
#define SIRENIX_ODININSPECTOR_SERIALIZEDSCRIPTABLEOBJECT_BRIDGEONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E8DE1B0)
#define SIRENIX_ODININSPECTOR_SERIALIZEDSCRIPTABLEOBJECT_BRIDGEONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E8DE140)
#define SIRENIX_ODININSPECTOR_SERIALIZEDSCRIPTABLEOBJECT_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E8DE240)
#define SIRENIX_ODININSPECTOR_SERIALIZEDSCRIPTABLEOBJECT_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E8DE250)
#define SIRENIX_ODININSPECTOR_SERIALIZEDSCRIPTABLEOBJECT_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E8DE120)
#define SIRENIX_ODININSPECTOR_SERIALIZEDSCRIPTABLEOBJECT_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E8DE130)
#define SIRENIX_ODININSPECTOR_SERIALIZEDSCRIPTABLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8DE260)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int SerializedScriptableObject_TypeDefinitionIndex = 7413;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(SerializedScriptableObject_TypeDefinitionIndex)->GetStaticField(0x32F0);
		}
