...
#define SIRENIX_ODININSPECTOR_SERIALIZEDSCRIPTABLEOBJECT_BRIDGEONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0FD190)
#define SIRENIX_ODININSPECTOR_SERIALIZEDSCRIPTABLEOBJECT_BRIDGEONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0FD120)
#define SIRENIX_ODININSPECTOR_SERIALIZEDSCRIPTABLEOBJECT_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0FD220)
#define SIRENIX_ODININSPECTOR_SERIALIZEDSCRIPTABLEOBJECT_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0FD230)
#define SIRENIX_ODININSPECTOR_SERIALIZEDSCRIPTABLEOBJECT_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0FD100)
#define SIRENIX_ODININSPECTOR_SERIALIZEDSCRIPTABLEOBJECT_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0FD110)
#define SIRENIX_ODININSPECTOR_SERIALIZEDSCRIPTABLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0FD240)
...
namespace Sirenix::OdinInspector
{
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(SerializedScriptableObject_TypeDefinitionIndex)->GetStaticField(0x3250);
		}
