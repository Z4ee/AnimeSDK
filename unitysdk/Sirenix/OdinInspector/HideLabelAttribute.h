...
#define SIRENIX_ODININSPECTOR_HIDELABELATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C01FF40)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int HideLabelAttribute_TypeDefinitionIndex = 7181;
