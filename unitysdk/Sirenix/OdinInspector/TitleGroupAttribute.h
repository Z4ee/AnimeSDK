...
#define SIRENIX_ODININSPECTOR_TITLEGROUPATTRIBUTE_COMBINEVALUESWITH_OFFSET UNITYSDK_OFFSET(0x1F772570)
#define SIRENIX_ODININSPECTOR_TITLEGROUPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F7724C0)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int TitleGroupAttribute_TypeDefinitionIndex = 7374;
