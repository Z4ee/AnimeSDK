...
#define SIRENIX_ODININSPECTOR_TOGGLEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C021FF0)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int ToggleAttribute_TypeDefinitionIndex = 7240;
