...
#define SIRENIX_ODININSPECTOR_EXPANDCOLLAPSENAPATTRIBUTE_GET_HASEXPANDVALUE_OFFSET UNITYSDK_OFFSET(0x1E198D20)
#define SIRENIX_ODININSPECTOR_EXPANDCOLLAPSENAPATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E198D40)
#define SIRENIX_ODININSPECTOR_EXPANDCOLLAPSENAPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E198D30)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int ExpandCollapseNapAttribute_TypeDefinitionIndex = 8178;

	class ExpandCollapseNapAttribute : public ::System::Attribute
	{
	public:
		::System::String* ExpandIf; // 0x10
		::System::String* OnCollapsed; // 0x18
		::System::String* OnExpanded; // 0x20
