...
#define SIRENIX_ODININSPECTOR_ONVALUECHANGEDATTRIBUTE_GET_METHODNAME_OFFSET UNITYSDK_OFFSET(0x1F770EF0)
#define SIRENIX_ODININSPECTOR_ONVALUECHANGEDATTRIBUTE_SET_METHODNAME_OFFSET UNITYSDK_OFFSET(0x1F770F00)
#define SIRENIX_ODININSPECTOR_ONVALUECHANGEDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F770F10)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int OnValueChangedAttribute_TypeDefinitionIndex = 7341;
