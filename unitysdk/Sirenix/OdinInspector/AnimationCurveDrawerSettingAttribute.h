...
#define SIRENIX_ODININSPECTOR_ANIMATIONCURVEDRAWERSETTINGATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E1F2580)
#define SIRENIX_ODININSPECTOR_ANIMATIONCURVEDRAWERSETTINGATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1F2530)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int AnimationCurveDrawerSettingAttribute_TypeDefinitionIndex = 7818;

	class AnimationCurveDrawerSettingAttribute : public ::System::Attribute
	{
	public:
		::System::String* TimeAxisMaxValGetter; // 0x10
		::System::String* ValueAxisMaxValGetter; // 0x18
		::System::String* TimeAxisMinValGetter; // 0x20
		::System::String* ValueAxisMinValGetter; // 0x28
		::System::Single ValueAxisMinVal; // 0x30
		::System::Single TimeAxisMaxVal; // 0x34
		::System::Single TimeAxisMinVal; // 0x38
