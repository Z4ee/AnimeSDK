...
#define SIRENIX_ODININSPECTOR_FILEPATHATTRIBUTE_GET_READONLY_OFFSET UNITYSDK_OFFSET(0x1F76FFC0)
#define SIRENIX_ODININSPECTOR_FILEPATHATTRIBUTE_SET_READONLY_OFFSET UNITYSDK_OFFSET(0x1F76FFD0)
#define SIRENIX_ODININSPECTOR_FILEPATHATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F76FFE0)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int FilePathAttribute_TypeDefinitionIndex = 7300;

	class FilePathAttribute : public ::System::Attribute
	{
	public:
		::System::String* Extensions; // 0x10
		::System::String* ParentFolder; // 0x18
		::System::Boolean RequireExistingPath; // 0x20
		::System::Boolean AbsolutePath; // 0x21
		::System::Boolean _ReadOnly_k__BackingField; // 0x22
		::System::Boolean RequireValidPath; // 0x23
