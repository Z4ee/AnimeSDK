...
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_COMBINEVALUESWITH_OFFSET UNITYSDK_OFFSET(0x1F7701D0)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_GET_DEFAULTEXPANDGETTER_OFFSET UNITYSDK_OFFSET(0x1F770040)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_GET_EXPANDED_OFFSET UNITYSDK_OFFSET(0x1F770000)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_GET_HASDEFINEDEXPANDED_OFFSET UNITYSDK_OFFSET(0x1F770020)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_GET_ONEXPANDCHANGED_OFFSET UNITYSDK_OFFSET(0x1F770050)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_SET_EXPANDED_OFFSET UNITYSDK_OFFSET(0x1F770010)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_SET_HASDEFINEDEXPANDED_OFFSET UNITYSDK_OFFSET(0x1F770030)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_SET_ONEXPANDCHANGED_OFFSET UNITYSDK_OFFSET(0x1F770060)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F7700E0)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1F770150)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F770070)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int FoldoutGroupAttribute_TypeDefinitionIndex = 7302;

	class FoldoutGroupAttribute : public ::Sirenix::OdinInspector::PropertyGroupAttribute
	{
	public:
		::System::String* _OnExpandChanged_k__BackingField; // 0x30
		::System::String* _DefaultExpandGetter_k__BackingField; // 0x38
