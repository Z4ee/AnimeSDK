...
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_COMBINEVALUESWITH_OFFSET UNITYSDK_OFFSET(0x1C01FB20)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_GET_DEFAULTEXPANDGETTER_OFFSET UNITYSDK_OFFSET(0x1C01F990)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_GET_EXPANDED_OFFSET UNITYSDK_OFFSET(0x1C01F950)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_GET_HASDEFINEDEXPANDED_OFFSET UNITYSDK_OFFSET(0x1C01F970)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_GET_ONEXPANDCHANGED_OFFSET UNITYSDK_OFFSET(0x1C01F9A0)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_SET_EXPANDED_OFFSET UNITYSDK_OFFSET(0x1C01F960)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_SET_HASDEFINEDEXPANDED_OFFSET UNITYSDK_OFFSET(0x1C01F980)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_SET_ONEXPANDCHANGED_OFFSET UNITYSDK_OFFSET(0x1C01F9B0)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C01FA30)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C01FAA0)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C01F9C0)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int FoldoutGroupAttribute_TypeDefinitionIndex = 7167;
