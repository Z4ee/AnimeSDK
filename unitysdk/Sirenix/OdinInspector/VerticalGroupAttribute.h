...
#define SIRENIX_ODININSPECTOR_VERTICALGROUPATTRIBUTE_COMBINEVALUESWITH_OFFSET UNITYSDK_OFFSET(0x1F772EF0)
#define SIRENIX_ODININSPECTOR_VERTICALGROUPATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F772E50)
#define SIRENIX_ODININSPECTOR_VERTICALGROUPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F772DE0)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int VerticalGroupAttribute_TypeDefinitionIndex = 7388;
