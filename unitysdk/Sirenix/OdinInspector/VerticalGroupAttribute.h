...
#define SIRENIX_ODININSPECTOR_VERTICALGROUPATTRIBUTE_COMBINEVALUESWITH_OFFSET UNITYSDK_OFFSET(0x1E32BB90)
#define SIRENIX_ODININSPECTOR_VERTICALGROUPATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E32BAF0)
#define SIRENIX_ODININSPECTOR_VERTICALGROUPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E32BA80)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int VerticalGroupAttribute_TypeDefinitionIndex = 7384;
