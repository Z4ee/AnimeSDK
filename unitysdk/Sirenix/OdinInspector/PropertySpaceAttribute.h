...
#define SIRENIX_ODININSPECTOR_PROPERTYSPACEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E32A0F0)
#define SIRENIX_ODININSPECTOR_PROPERTYSPACEATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E32A100)
#define SIRENIX_ODININSPECTOR_PROPERTYSPACEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E32A0E0)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int PropertySpaceAttribute_TypeDefinitionIndex = 7344;
