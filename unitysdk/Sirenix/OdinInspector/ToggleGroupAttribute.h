...
#define SIRENIX_ODININSPECTOR_TOGGLEGROUPATTRIBUTE_COMBINEVALUESWITH_OFFSET UNITYSDK_OFFSET(0x1C0221B0)
#define SIRENIX_ODININSPECTOR_TOGGLEGROUPATTRIBUTE_GET_TITLESTRINGMEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1C022190)
#define SIRENIX_ODININSPECTOR_TOGGLEGROUPATTRIBUTE_GET_TOGGLEMEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1C022180)
#define SIRENIX_ODININSPECTOR_TOGGLEGROUPATTRIBUTE_SET_TITLESTRINGMEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1C0221A0)
#define SIRENIX_ODININSPECTOR_TOGGLEGROUPATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C022080)
#define SIRENIX_ODININSPECTOR_TOGGLEGROUPATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C022100)
#define SIRENIX_ODININSPECTOR_TOGGLEGROUPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C022000)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int ToggleGroupAttribute_TypeDefinitionIndex = 7241;
