...
#define SIRENIX_ODININSPECTOR_TOGGLEGROUPATTRIBUTE_COMBINEVALUESWITH_OFFSET UNITYSDK_OFFSET(0x1E32B4C0)
#define SIRENIX_ODININSPECTOR_TOGGLEGROUPATTRIBUTE_GET_TITLESTRINGMEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1E32B4A0)
#define SIRENIX_ODININSPECTOR_TOGGLEGROUPATTRIBUTE_GET_TOGGLEMEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1E32B490)
#define SIRENIX_ODININSPECTOR_TOGGLEGROUPATTRIBUTE_SET_TITLESTRINGMEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1E32B4B0)
#define SIRENIX_ODININSPECTOR_TOGGLEGROUPATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E32B390)
#define SIRENIX_ODININSPECTOR_TOGGLEGROUPATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E32B410)
#define SIRENIX_ODININSPECTOR_TOGGLEGROUPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E32B310)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int ToggleGroupAttribute_TypeDefinitionIndex = 7372;
