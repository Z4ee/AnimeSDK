...
#define SIRENIX_ODININSPECTOR_FOLDERPATHATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F76FFF0)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int FolderPathAttribute_TypeDefinitionIndex = 7301;
	...
	public:
		...
		::System::Boolean UseBackslashes; // 0x19
