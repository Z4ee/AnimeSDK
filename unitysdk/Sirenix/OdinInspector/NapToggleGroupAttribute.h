...
#define SIRENIX_ODININSPECTOR_NAPTOGGLEGROUPATTRIBUTE_COMBINEVALUESWITH_OFFSET UNITYSDK_OFFSET(0x1F4C3020)
#define SIRENIX_ODININSPECTOR_NAPTOGGLEGROUPATTRIBUTE_GET_TITLESTRINGMEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1F4C3000)
#define SIRENIX_ODININSPECTOR_NAPTOGGLEGROUPATTRIBUTE_GET_TOGGLEMEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1F4C2FF0)
#define SIRENIX_ODININSPECTOR_NAPTOGGLEGROUPATTRIBUTE_SET_TITLESTRINGMEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1F4C3010)
#define SIRENIX_ODININSPECTOR_NAPTOGGLEGROUPATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F4C2EF0)
#define SIRENIX_ODININSPECTOR_NAPTOGGLEGROUPATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1F4C2F70)
#define SIRENIX_ODININSPECTOR_NAPTOGGLEGROUPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F4C2E70)
#define SIRENIX_ODININSPECTOR_NAPTOGGLEGROUPATTRIBUTE___BASE_COMBINEVALUESWITH_OFFSET UNITYSDK_OFFSET(0x1F4C3100)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int NapToggleGroupAttribute_TypeDefinitionIndex = 8299;

	class NapToggleGroupAttribute : public ::Sirenix::OdinInspector::PropertyGroupAttribute
	{
	public:
		::System::String* ToggleGroupTitle; // 0x30
		::System::String* LineHeightGetter; // 0x38
		::System::String* _TitleStringMemberName_k__BackingField; // 0x40
		::System::String* LineBackgroundColorGetter; // 0x48
