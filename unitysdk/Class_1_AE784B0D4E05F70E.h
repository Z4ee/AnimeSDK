...
#define CLASS_1_AE784B0D4E05F70E_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1ED04C90)
#define CLASS_1_AE784B0D4E05F70E_CLONE_OFFSET UNITYSDK_OFFSET(0x1ED04860)
#define CLASS_1_AE784B0D4E05F70E_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1ED04A20)
#define CLASS_1_AE784B0D4E05F70E_EQUALS_OFFSET UNITYSDK_OFFSET(0x1ED04910)
#define CLASS_1_AE784B0D4E05F70E_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1ED04AF0)
#define CLASS_1_AE784B0D4E05F70E_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1ED04E90)
#define CLASS_1_AE784B0D4E05F70E_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1ED04E50)
#define CLASS_1_AE784B0D4E05F70E_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1ED047B0)
#define CLASS_1_AE784B0D4E05F70E_METHOD_1_4C4B9DFE092840D4_1_OFFSET UNITYSDK_OFFSET(0x1ED04900)
#define CLASS_1_AE784B0D4E05F70E_METHOD_1_4C4B9DFE092840D4_OFFSET UNITYSDK_OFFSET(0x1ED048E0)
#define CLASS_1_AE784B0D4E05F70E_METHOD_1_7ADD5F1F5E247E3B_1_OFFSET UNITYSDK_OFFSET(0x1ED048F0)
#define CLASS_1_AE784B0D4E05F70E_METHOD_1_7ADD5F1F5E247E3B_OFFSET UNITYSDK_OFFSET(0x1ED048D0)
#define CLASS_1_AE784B0D4E05F70E_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1ED04810)
#define CLASS_1_AE784B0D4E05F70E_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1ED04B50)
#define CLASS_1_AE784B0D4E05F70E_WRITETO_OFFSET UNITYSDK_OFFSET(0x1ED04BB0)
#define CLASS_1_AE784B0D4E05F70E__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ED05010)
#define CLASS_1_AE784B0D4E05F70E__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ED04830)
#define CLASS_1_AE784B0D4E05F70E__CTOR_OFFSET UNITYSDK_OFFSET(0x1ED04820)

inline static constexpr unsigned int Class_1_AE784B0D4E05F70E_TypeDefinitionIndex = 28733;

class Class_1_AE784B0D4E05F70E : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_AE784B0D4E05F70E*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_AE784B0D4E05F70E*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_AE784B0D4E05F70E_TypeDefinitionIndex)->GetStaticField(0x417A0);
	}
	// static const ::System::Int32 MHLMDKGPFAK = 0x4; // 0x0
	// static const ::System::Int32 ICGAGDOBKAM = 0x6; // 0x0
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x10
	::System::Int64 DPNKODHICIJ; // 0x18
	::System::Int64 BIMKNFGLKPG; // 0x20
