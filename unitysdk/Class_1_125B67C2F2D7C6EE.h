...
#define CLASS_1_125B67C2F2D7C6EE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8C38B60)
#define CLASS_1_125B67C2F2D7C6EE_METHOD_1_51561B6306F77F3A_OFFSET UNITYSDK_OFFSET(0x8C38DE0)
#define CLASS_1_125B67C2F2D7C6EE_METHOD_1_9DEEA62E1DF23E4E_OFFSET UNITYSDK_OFFSET(0x8C38C00)
#define CLASS_1_125B67C2F2D7C6EE_METHOD_1_A6D9E413B271AA3B_OFFSET UNITYSDK_OFFSET(0x8C38FC0)
#define CLASS_1_125B67C2F2D7C6EE_METHOD_1_B6F0C2C831C5F31A_OFFSET UNITYSDK_OFFSET(0x8C38A80)
#define CLASS_1_125B67C2F2D7C6EE_METHOD_1_F4ADC37B63F4E9EF_OFFSET UNITYSDK_OFFSET(0x8C38E50)
#define CLASS_1_125B67C2F2D7C6EE__CTOR_OFFSET UNITYSDK_OFFSET(0x8C39520)

inline static constexpr unsigned int Class_1_125B67C2F2D7C6EE_TypeDefinitionIndex = 63958;

class Class_1_125B67C2F2D7C6EE : public ::System::Object
{
public:
	::Class_1_7F77701ED75B8609* Field_1_2; // 0x10
	::RPG::GameCore::TransformComponent* Field_1_1; // 0x18
	::Class_3_CD04D3296DF4C842_4* Field_1_4; // 0x20
	::RPG::GameCore::AdventureCharacterController* Field_1_0; // 0x28
