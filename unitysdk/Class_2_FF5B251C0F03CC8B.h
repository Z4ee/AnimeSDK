...
#define CLASS_2_FF5B251C0F03CC8B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9C5DF80)
#define CLASS_2_FF5B251C0F03CC8B_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x9C5E180)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x9C5F3C0)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_262D2B4BC22B01ED_OFFSET UNITYSDK_OFFSET(0x9C60640)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_27EC2C099D14356D_OFFSET UNITYSDK_OFFSET(0x9C609F0)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_32D4A70A38448E14_OFFSET UNITYSDK_OFFSET(0x9C5EB00)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_3B258437A86233AC_OFFSET UNITYSDK_OFFSET(0x9C5DE30)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_5C0C256643E989F8_OFFSET UNITYSDK_OFFSET(0x9C5DB90)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_61EC2AC0BD93363E_OFFSET UNITYSDK_OFFSET(0x9C5FC40)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_67D41ACFEF39E84E_OFFSET UNITYSDK_OFFSET(0x9C5FF80)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_716BA667B58090A4_OFFSET UNITYSDK_OFFSET(0x9C5FD00)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_7BFF16CC471B6C59_OFFSET UNITYSDK_OFFSET(0x9C60760)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_7E1BADD1D133FA1C_OFFSET UNITYSDK_OFFSET(0x9C5DFD0)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_9186B8EB46BDAB54_OFFSET UNITYSDK_OFFSET(0x9C5F7B0)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x9C5DC10)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_AD4C034BC86ADE53_OFFSET UNITYSDK_OFFSET(0x9C60310)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_B7E6ED31D1624EEC_OFFSET UNITYSDK_OFFSET(0x9C5E960)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_D34432C0B65E6441_OFFSET UNITYSDK_OFFSET(0x9C5EC30)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_D5387FAF23786253_OFFSET UNITYSDK_OFFSET(0x9C5F450)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_DCC0CC5DBC127BF8_OFFSET UNITYSDK_OFFSET(0x9C5E8B0)
#define CLASS_2_FF5B251C0F03CC8B_METHOD_2_EB522918F22FFA3B_OFFSET UNITYSDK_OFFSET(0x9C5DD60)
#define CLASS_2_FF5B251C0F03CC8B_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x9C5EC90)
#define CLASS_2_FF5B251C0F03CC8B_ONSKIP_OFFSET UNITYSDK_OFFSET(0x9C5E190)
#define CLASS_2_FF5B251C0F03CC8B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x9C5EF70)
#define CLASS_2_FF5B251C0F03CC8B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x9C5E120)
#define CLASS_2_FF5B251C0F03CC8B_SETNEXTTASK_OFFSET UNITYSDK_OFFSET(0x9C5EF20)
#define CLASS_2_FF5B251C0F03CC8B_TICK_OFFSET UNITYSDK_OFFSET(0x9C5EE90)
#define CLASS_2_FF5B251C0F03CC8B__CTOR_OFFSET UNITYSDK_OFFSET(0x9C5DAE0)
#define CLASS_2_FF5B251C0F03CC8B__ONTASKBEGIN_B__11_0_OFFSET UNITYSDK_OFFSET(0x9C60B50)
#define CLASS_2_FF5B251C0F03CC8B___ONSCREENTRANSFERTEXTEND_B__15_0_OFFSET UNITYSDK_OFFSET(0x9C60D50)
#define CLASS_2_FF5B251C0F03CC8B___PROMISEKEEPTIMEOUT_B__19_0_OFFSET UNITYSDK_OFFSET(0x9C60DB0)

inline static constexpr unsigned int Class_2_FF5B251C0F03CC8B_TypeDefinitionIndex = 47005;

class Class_2_FF5B251C0F03CC8B : public ::Class_1_5F51D4049EA87B7B
{
public:
	// static const ::System::String* Field_2_3; // 0x0
	::RPG::Client::Promises::Promise* Field_2_7; // 0x18
	::Class_1_23F67DD15593C8D6* Field_2_5; // 0x20
	::RPG::Client::Promises::Promise* Field_2_10; // 0x28
	::RPG::GameCore::PlayFullScreenTransfer* Field_2_0; // 0x30
	::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_380*>* Field_2_12; // 0x38
	::Class_1_5F51D4049EA87B7B* Field_2_1; // 0x40
	::System::Exception* Field_2_4; // 0x48
	::RPG::Client::Promises::Promise* Field_2_8; // 0x50
	::RPG::GameCore::TaskContext* Field_2_2; // 0x58
	::RPG::Client::Promises::Promise* Field_2_9; // 0x60
	::RPG::Client::Promises::Promise* Field_2_6; // 0x68
	::System::Int32 Field_2_18; // 0x70
	::RPG::GameCore::ScreenTransferActionState Field_2_13; // 0x74
	::System::UInt32 Field_2_17; // 0x78
	::System::Boolean Field_2_14; // 0x7C
	::System::Boolean Field_2_16; // 0x7D
	::System::Boolean Field_2_15; // 0x7E
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Object*))((::PBYTE)hIl2Cpp + CLASS_2_FF5B251C0F03CC8B_METHOD_2_716BA667B58090A4_OFFSET))(this, a1);
	}
	...
	::Class_0_16E4307DCC419505_380* Method_2_7BFF16CC471B6C59(::RPG::GameCore::ScreenTransferBaseAction* a1)
	{
		return ((::Class_0_16E4307DCC419505_380*(*)(::PVOID, ::RPG::GameCore::ScreenTransferBaseAction*))((::PBYTE)hIl2Cpp + CLASS_2_FF5B251C0F03CC8B_METHOD_2_7BFF16CC471B6C59_OFFSET))(this, a1);
	}
