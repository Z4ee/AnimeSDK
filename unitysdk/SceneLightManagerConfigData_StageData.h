...
#define SCENELIGHTMANAGERCONFIGDATA_STAGEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xABBC5D0)

inline static constexpr unsigned int SceneLightManagerConfigData_StageData_TypeDefinitionIndex = 38252;
