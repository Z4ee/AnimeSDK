...
#define SCENELIGHTMANAGERCONFIGDATA_STAGEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB931BC0)

inline static constexpr unsigned int SceneLightManagerConfigData_StageData_TypeDefinitionIndex = 44136;
