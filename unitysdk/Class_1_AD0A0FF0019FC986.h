...
#define CLASS_1_AD0A0FF0019FC986_APPLY_OFFSET UNITYSDK_OFFSET(0x15B9F4A0)
#define CLASS_1_AD0A0FF0019FC986_INIT_OFFSET UNITYSDK_OFFSET(0x15B9F3A0)
#define CLASS_1_AD0A0FF0019FC986_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x15B9E2C0)
#define CLASS_1_AD0A0FF0019FC986_METHOD_1_2FAA87026AC4C0F4_OFFSET UNITYSDK_OFFSET(0x15B9E9B0)
#define CLASS_1_AD0A0FF0019FC986_METHOD_1_40942C03FFEE6EF0_OFFSET UNITYSDK_OFFSET(0x15B9E710)
#define CLASS_1_AD0A0FF0019FC986_METHOD_1_44815C74DF99C8B0_OFFSET UNITYSDK_OFFSET(0x15B9EA60)
#define CLASS_1_AD0A0FF0019FC986_METHOD_1_492A229C2726426C_OFFSET UNITYSDK_OFFSET(0x15B9E450)
#define CLASS_1_AD0A0FF0019FC986_METHOD_1_56AD1EF09CA27CB0_OFFSET UNITYSDK_OFFSET(0x15B9E510)
#define CLASS_1_AD0A0FF0019FC986_METHOD_1_7733D915A2A1AE09_OFFSET UNITYSDK_OFFSET(0x15B9E2D0)
#define CLASS_1_AD0A0FF0019FC986_METHOD_1_7A3939C20075D81C_OFFSET UNITYSDK_OFFSET(0x15B9E800)
#define CLASS_1_AD0A0FF0019FC986_METHOD_1_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0x15B9F220)
#define CLASS_1_AD0A0FF0019FC986_METHOD_1_C97F1DF1BCE94A44_OFFSET UNITYSDK_OFFSET(0x15B9F020)
#define CLASS_1_AD0A0FF0019FC986_METHOD_1_E09679FCD3B3BFA5_1_OFFSET UNITYSDK_OFFSET(0x15B9F150)
#define CLASS_1_AD0A0FF0019FC986_METHOD_1_E09679FCD3B3BFA5_OFFSET UNITYSDK_OFFSET(0x15B9F080)
#define CLASS_1_AD0A0FF0019FC986_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x15B9E2B0)
#define CLASS_1_AD0A0FF0019FC986_ONENVOBJENABLE_OFFSET UNITYSDK_OFFSET(0x15B9F3F0)
#define CLASS_1_AD0A0FF0019FC986_ONFADINGBEGIN_OFFSET UNITYSDK_OFFSET(0x15B9F4F0)
#define CLASS_1_AD0A0FF0019FC986_ONFADINGEND_OFFSET UNITYSDK_OFFSET(0x15B9F5A0)
#define CLASS_1_AD0A0FF0019FC986_ONFADING_OFFSET UNITYSDK_OFFSET(0x15B9F540)
#define CLASS_1_AD0A0FF0019FC986_RELEASE_OFFSET UNITYSDK_OFFSET(0x15B9F2E0)
#define CLASS_1_AD0A0FF0019FC986_TICK_OFFSET UNITYSDK_OFFSET(0x15B9F440)
#define CLASS_1_AD0A0FF0019FC986__CCTOR_OFFSET UNITYSDK_OFFSET(0x15B9F5F0)
#define CLASS_1_AD0A0FF0019FC986__CTOR_OFFSET UNITYSDK_OFFSET(0x15B9E430)
...
public:
	...
	{
		return (::System::Text::RegularExpressions::Regex**)Il2CppClass::FromTypeDefinitionIndex(Class_1_AD0A0FF0019FC986_TypeDefinitionIndex)->GetStaticField(0x64E30);
	}
	::System::String* GCPJMGNCMEE; // 0x10
	::Class_1_65F0290E6742FF82* LEFHPGFJJCD; // 0x18
	::System::Int32 JHBAAEHHPDE; // 0x20
	::System::Boolean CMAKJFGCOAH; // 0x24
	::System::Boolean ECLOLHLBILM; // 0x25
	::System::Boolean OJIMILLNLNJ; // 0x26
