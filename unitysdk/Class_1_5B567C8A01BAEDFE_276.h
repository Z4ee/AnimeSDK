...
#define CLASS_1_5B567C8A01BAEDFE_276_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1AA9C210)
#define CLASS_1_5B567C8A01BAEDFE_276_CLONE_OFFSET UNITYSDK_OFFSET(0x1AA9C080)
#define CLASS_1_5B567C8A01BAEDFE_276_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1AA9C120)
#define CLASS_1_5B567C8A01BAEDFE_276_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AA9C0C0)
#define CLASS_1_5B567C8A01BAEDFE_276_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AA9C170)
#define CLASS_1_5B567C8A01BAEDFE_276_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1AA9C260)
#define CLASS_1_5B567C8A01BAEDFE_276_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1AA9C230)
#define CLASS_1_5B567C8A01BAEDFE_276_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1AA9C000)
#define CLASS_1_5B567C8A01BAEDFE_276_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1AA9C030)
#define CLASS_1_5B567C8A01BAEDFE_276_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AA9C1A0)
#define CLASS_1_5B567C8A01BAEDFE_276_WRITETO_OFFSET UNITYSDK_OFFSET(0x1AA9C200)
#define CLASS_1_5B567C8A01BAEDFE_276__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AA9C2B0)
#define CLASS_1_5B567C8A01BAEDFE_276__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AA9C050)
#define CLASS_1_5B567C8A01BAEDFE_276__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA9C040)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_276_TypeDefinitionIndex = 30602;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_276*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_276_TypeDefinitionIndex)->GetStaticField(0xC230);
	}
