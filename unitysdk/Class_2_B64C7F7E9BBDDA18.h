...
#define CLASS_2_B64C7F7E9BBDDA18_DISPOSE_OFFSET UNITYSDK_OFFSET(0x923FDA0)
#define CLASS_2_B64C7F7E9BBDDA18_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x923FDE0)
#define CLASS_2_B64C7F7E9BBDDA18_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x923FF50)
#define CLASS_2_B64C7F7E9BBDDA18_TICK_OFFSET UNITYSDK_OFFSET(0x923FFA0)
#define CLASS_2_B64C7F7E9BBDDA18__CTOR_OFFSET UNITYSDK_OFFSET(0x923FD90)
