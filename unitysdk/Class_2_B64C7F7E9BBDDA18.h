...
#define CLASS_2_B64C7F7E9BBDDA18_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1380F5D0)
#define CLASS_2_B64C7F7E9BBDDA18_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1380F610)
#define CLASS_2_B64C7F7E9BBDDA18_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1380F810)
#define CLASS_2_B64C7F7E9BBDDA18_TICK_OFFSET UNITYSDK_OFFSET(0x1380F860)
#define CLASS_2_B64C7F7E9BBDDA18__CTOR_OFFSET UNITYSDK_OFFSET(0x1380F5C0)

inline static constexpr unsigned int Class_2_B64C7F7E9BBDDA18_TypeDefinitionIndex = 52116;

class Class_2_B64C7F7E9BBDDA18 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::VCameraNoiseChange* Field_2_0; // 0x18
