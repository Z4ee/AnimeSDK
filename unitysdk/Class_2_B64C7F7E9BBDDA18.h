...
#define CLASS_2_B64C7F7E9BBDDA18_DISPOSE_OFFSET UNITYSDK_OFFSET(0x155EDA30)
#define CLASS_2_B64C7F7E9BBDDA18_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x155EDA70)
#define CLASS_2_B64C7F7E9BBDDA18_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x155EDD50)
#define CLASS_2_B64C7F7E9BBDDA18_TICK_OFFSET UNITYSDK_OFFSET(0x155EDDA0)
#define CLASS_2_B64C7F7E9BBDDA18__CTOR_OFFSET UNITYSDK_OFFSET(0x155EDA20)
