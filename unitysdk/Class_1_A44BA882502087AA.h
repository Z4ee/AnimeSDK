...
#define CLASS_1_A44BA882502087AA_GET_FACESIZE_OFFSET UNITYSDK_OFFSET(0x177C9400)
#define CLASS_1_A44BA882502087AA_GET_FOGS_OFFSET UNITYSDK_OFFSET(0x177C9420)
#define CLASS_1_A44BA882502087AA_GET_SECTIONS_OFFSET UNITYSDK_OFFSET(0x177C93E0)
#define CLASS_1_A44BA882502087AA_GET_SECTIONVERTICES_OFFSET UNITYSDK_OFFSET(0x177C93C0)
#define CLASS_1_A44BA882502087AA_METHOD_1_8A5692253C0897D8_OFFSET UNITYSDK_OFFSET(0x177C8E80)
#define CLASS_1_A44BA882502087AA_SET_FACESIZE_OFFSET UNITYSDK_OFFSET(0x177C9410)
#define CLASS_1_A44BA882502087AA_SET_FOGS_OFFSET UNITYSDK_OFFSET(0x177C9430)
#define CLASS_1_A44BA882502087AA_SET_SECTIONS_OFFSET UNITYSDK_OFFSET(0x177C93F0)
#define CLASS_1_A44BA882502087AA_SET_SECTIONVERTICES_OFFSET UNITYSDK_OFFSET(0x177C93D0)
#define CLASS_1_A44BA882502087AA__CTOR_OFFSET UNITYSDK_OFFSET(0x177C9380)

inline static constexpr unsigned int Class_1_A44BA882502087AA_TypeDefinitionIndex = 74539;

class Class_1_A44BA882502087AA : public ::System::Object
{
public:
	::Il2CppArray<::RPG::MVector2>* _SectionVertices_k__BackingField; // 0x10
