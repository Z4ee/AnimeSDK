...
#define CLASS_1_8B83CE81FFD7409A__CTOR_OFFSET UNITYSDK_OFFSET(0x938CBF0)

inline static constexpr unsigned int Class_1_8B83CE81FFD7409A_TypeDefinitionIndex = 67488;
...
public:
	...
	::RPG::GameCore::SkillType Field_1_0; // 0x28
