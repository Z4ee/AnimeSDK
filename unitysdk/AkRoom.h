...
#define AKROOM_EXIT_OFFSET UNITYSDK_OFFSET(0x18BD1700)
#define AKROOM_GETAKROOMID_OFFSET UNITYSDK_OFFSET(0x18BD13D0)
#define AKROOM_GETID_OFFSET UNITYSDK_OFFSET(0x18BD14E0)
#define AKROOM_GET_ROOMCOUNT_OFFSET UNITYSDK_OFFSET(0x18BD15B0)
#define AKROOM_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x18BD39A0)
#define AKROOM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18BD2F00)
#define AKROOM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18BD17C0)
#define AKROOM_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x18BD35A0)
#define AKROOM_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x18BD36B0)
#define AKROOM_POSTROOMTONE_OFFSET UNITYSDK_OFFSET(0x18BD37C0)
#define AKROOM_SET_ROOMCOUNT_OFFSET UNITYSDK_OFFSET(0x18BD15C0)
#define AKROOM_TRYENTER_OFFSET UNITYSDK_OFFSET(0x18BD15D0)
#define AKROOM__CTOR_OFFSET UNITYSDK_OFFSET(0x18BD39F0)
#define AKROOM___IFIXBASEPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18BD3B00)

inline static constexpr unsigned int AkRoom_TypeDefinitionIndex = 34679;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AkRoom_TypeDefinitionIndex)->GetStaticField(0xFC50);
	}
	static ::System::UInt64* StaticGet_INVALID_ROOM_ID()
	{
		return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(AkRoom_TypeDefinitionIndex)->GetStaticField(0xFC58);
	}
