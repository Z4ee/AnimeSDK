...
#define AKROOM_EXIT_OFFSET UNITYSDK_OFFSET(0x1C128EA0)
#define AKROOM_GETAKROOMID_OFFSET UNITYSDK_OFFSET(0x1C128930)
#define AKROOM_GETID_OFFSET UNITYSDK_OFFSET(0x1C128A80)
#define AKROOM_GET_ROOMCOUNT_OFFSET UNITYSDK_OFFSET(0x1C128C20)
#define AKROOM_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x1C12A090)
#define AKROOM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1C1299C0)
#define AKROOM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C129010)
#define AKROOM_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1C129E30)
#define AKROOM_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x1C129E90)
#define AKROOM_POSTROOMTONE_OFFSET UNITYSDK_OFFSET(0x1C129EF0)
#define AKROOM_SET_ROOMCOUNT_OFFSET UNITYSDK_OFFSET(0x1C128C80)
#define AKROOM_TRYENTER_OFFSET UNITYSDK_OFFSET(0x1C128CE0)
#define AKROOM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C12A1B0)
#define AKROOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C12A0A0)

inline static constexpr unsigned int AkRoom_TypeDefinitionIndex = 31614;
...
public:
	...
	{
		return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(AkRoom_TypeDefinitionIndex)->GetStaticField(0x7C60);
	}
	static ::System::Int32* StaticGet__RoomCount_k__BackingField()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AkRoom_TypeDefinitionIndex)->GetStaticField(0x7C68);
	}
