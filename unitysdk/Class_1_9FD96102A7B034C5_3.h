...
#define CLASS_1_9FD96102A7B034C5_3_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1CC40400)
#define CLASS_1_9FD96102A7B034C5_3_CLONE_OFFSET UNITYSDK_OFFSET(0x1CC3FF60)
#define CLASS_1_9FD96102A7B034C5_3_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1CC40110)
#define CLASS_1_9FD96102A7B034C5_3_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CC3FFC0)
#define CLASS_1_9FD96102A7B034C5_3_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CC40230)
#define CLASS_1_9FD96102A7B034C5_3_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1CC405D0)
#define CLASS_1_9FD96102A7B034C5_3_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1CC40530)
#define CLASS_1_9FD96102A7B034C5_3_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1CC3FFA0)
#define CLASS_1_9FD96102A7B034C5_3_METHOD_1_4C96E9A31DDA1BDD_OFFSET UNITYSDK_OFFSET(0x1CC3FF90)
#define CLASS_1_9FD96102A7B034C5_3_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1CC3FE50)
#define CLASS_1_9FD96102A7B034C5_3_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1CC3FFB0)
#define CLASS_1_9FD96102A7B034C5_3_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1CC3FE80)
#define CLASS_1_9FD96102A7B034C5_3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1CC402A0)
#define CLASS_1_9FD96102A7B034C5_3_WRITETO_OFFSET UNITYSDK_OFFSET(0x1CC40300)
#define CLASS_1_9FD96102A7B034C5_3__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CC40790)
#define CLASS_1_9FD96102A7B034C5_3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CC3FED0)
#define CLASS_1_9FD96102A7B034C5_3__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC3FE90)

inline static constexpr unsigned int Class_1_9FD96102A7B034C5_3_TypeDefinitionIndex = 28912;

class Class_1_9FD96102A7B034C5_3 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_9FD96102A7B034C5_3*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_9FD96102A7B034C5_3*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9FD96102A7B034C5_3_TypeDefinitionIndex)->GetStaticField(0x56080);
	}
	static ::Google::Protobuf::FieldCodec_1<::Proto::PileItem*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::FieldCodec_1<::Proto::PileItem*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9FD96102A7B034C5_3_TypeDefinitionIndex)->GetStaticField(0x56088);
	}
