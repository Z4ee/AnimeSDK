...
#define CLASS_1_9FD96102A7B034C5_3_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E181DC0)
#define CLASS_1_9FD96102A7B034C5_3_CLONE_OFFSET UNITYSDK_OFFSET(0x1E181910)
#define CLASS_1_9FD96102A7B034C5_3_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E181AC0)
#define CLASS_1_9FD96102A7B034C5_3_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E181970)
#define CLASS_1_9FD96102A7B034C5_3_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E181BE0)
#define CLASS_1_9FD96102A7B034C5_3_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E181F90)
#define CLASS_1_9FD96102A7B034C5_3_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E181EF0)
#define CLASS_1_9FD96102A7B034C5_3_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1E181950)
#define CLASS_1_9FD96102A7B034C5_3_METHOD_1_4C96E9A31DDA1BDD_OFFSET UNITYSDK_OFFSET(0x1E181940)
#define CLASS_1_9FD96102A7B034C5_3_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E181800)
#define CLASS_1_9FD96102A7B034C5_3_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1E181960)
#define CLASS_1_9FD96102A7B034C5_3_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E181830)
#define CLASS_1_9FD96102A7B034C5_3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E181C50)
#define CLASS_1_9FD96102A7B034C5_3_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E181CB0)
#define CLASS_1_9FD96102A7B034C5_3__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E182150)
#define CLASS_1_9FD96102A7B034C5_3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E181880)
#define CLASS_1_9FD96102A7B034C5_3__CTOR_OFFSET UNITYSDK_OFFSET(0x1E181840)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_9FD96102A7B034C5_3*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9FD96102A7B034C5_3_TypeDefinitionIndex)->GetStaticField(0x255D0);
	}
	static ::Google::Protobuf::FieldCodec_1<::Proto::PileItem*>** StaticGet_EDEMPAMDAFD()
	{
		return (::Google::Protobuf::FieldCodec_1<::Proto::PileItem*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9FD96102A7B034C5_3_TypeDefinitionIndex)->GetStaticField(0x255D8);
	}
