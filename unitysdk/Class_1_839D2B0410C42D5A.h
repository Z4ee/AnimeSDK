...
#define CLASS_1_839D2B0410C42D5A_EXECUTE_OFFSET UNITYSDK_OFFSET(0x14C5B1D0)
#define CLASS_1_839D2B0410C42D5A_GET_EXECUTEFRAME_OFFSET UNITYSDK_OFFSET(0x14C5B190)
#define CLASS_1_839D2B0410C42D5A_GET_SOURCE_OFFSET UNITYSDK_OFFSET(0x14C5B1B0)
#define CLASS_1_839D2B0410C42D5A_SET_EXECUTEFRAME_OFFSET UNITYSDK_OFFSET(0x14C5B1A0)
#define CLASS_1_839D2B0410C42D5A_SET_SOURCE_OFFSET UNITYSDK_OFFSET(0x14C5B1C0)
#define CLASS_1_839D2B0410C42D5A__CTOR_OFFSET UNITYSDK_OFFSET(0x14C5B260)

inline static constexpr unsigned int Class_1_839D2B0410C42D5A_TypeDefinitionIndex = 54475;
