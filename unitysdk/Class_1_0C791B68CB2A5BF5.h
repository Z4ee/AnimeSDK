...
#define CLASS_1_0C791B68CB2A5BF5_METHOD_1_2FB9DA1F70998790_OFFSET UNITYSDK_OFFSET(0x16469E80)
#define CLASS_1_0C791B68CB2A5BF5_METHOD_1_5558FFC4A45750C6_OFFSET UNITYSDK_OFFSET(0x1646A290)
#define CLASS_1_0C791B68CB2A5BF5_METHOD_1_DF2A78D8DB25ED05_OFFSET UNITYSDK_OFFSET(0x1646A2F0)
#define CLASS_1_0C791B68CB2A5BF5__CTOR_OFFSET UNITYSDK_OFFSET(0x16469D80)

inline static constexpr unsigned int Class_1_0C791B68CB2A5BF5_TypeDefinitionIndex = 85291;

class Class_1_0C791B68CB2A5BF5 : public ::System::Object
{
public:
	::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::Sprite*>* Field_1_0; // 0x10
	::System::Collections::Generic::Dictionary_2<::System::String*, ::Foundation::AssetRequestHandle>* Field_1_1; // 0x18
