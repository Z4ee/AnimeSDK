...
#define CLASS_1_52DD9E5E2B969CDC_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A807180)
#define CLASS_1_52DD9E5E2B969CDC_GET_AUDIENCEMOODMAPCONFIGPATH_OFFSET UNITYSDK_OFFSET(0x1A807000)
#define CLASS_1_52DD9E5E2B969CDC_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1A807040)
#define CLASS_1_52DD9E5E2B969CDC_GET_CROWDVARIANTPATH_OFFSET UNITYSDK_OFFSET(0x1A806FE0)
#define CLASS_1_52DD9E5E2B969CDC_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1A807060)
#define CLASS_1_52DD9E5E2B969CDC_GET_PREFAB_OFFSET UNITYSDK_OFFSET(0x1A807020)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_083EFC24EE1811E3_OFFSET UNITYSDK_OFFSET(0x1A806200)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_092CD57850778EFC_OFFSET UNITYSDK_OFFSET(0x1A807EF0)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_0D3455A2B8A3E6D4_OFFSET UNITYSDK_OFFSET(0x1A806940)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_0D372435D9CAE4BC_OFFSET UNITYSDK_OFFSET(0x1A806740)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_13263CB5FCEC31EC_OFFSET UNITYSDK_OFFSET(0x1A807810)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_17773E5AAC0D5C9C_OFFSET UNITYSDK_OFFSET(0x1A806F70)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_1E13A8A5C0FF7D62_OFFSET UNITYSDK_OFFSET(0x1A8072A0)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x1A8078C0)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_279FA27EC5CC6ADB_OFFSET UNITYSDK_OFFSET(0x1A807080)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_2F46EF9FA91E7517_OFFSET UNITYSDK_OFFSET(0x1A8079D0)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_570C5557A774C69E_OFFSET UNITYSDK_OFFSET(0x1A807740)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_6130BC24956B5935_OFFSET UNITYSDK_OFFSET(0x1A8076F0)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_6A264EE8243CFA05_OFFSET UNITYSDK_OFFSET(0x1A8063A0)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_83F4F6CFBC2434C6_OFFSET UNITYSDK_OFFSET(0x1A807250)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_8D595942D57F40CD_OFFSET UNITYSDK_OFFSET(0x1A806EF0)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_954D0A030E5BF9D8_OFFSET UNITYSDK_OFFSET(0x1A806A70)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_9968CD0165DD7DC7_OFFSET UNITYSDK_OFFSET(0x1A807AC0)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_AF2CFBAAD2629B3B_OFFSET UNITYSDK_OFFSET(0x1A807920)
#define CLASS_1_52DD9E5E2B969CDC_SET_AUDIENCEMOODMAPCONFIGPATH_OFFSET UNITYSDK_OFFSET(0x1A807010)
#define CLASS_1_52DD9E5E2B969CDC_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1A807050)
#define CLASS_1_52DD9E5E2B969CDC_SET_CROWDVARIANTPATH_OFFSET UNITYSDK_OFFSET(0x1A806FF0)
#define CLASS_1_52DD9E5E2B969CDC_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1A807070)
#define CLASS_1_52DD9E5E2B969CDC_SET_PREFAB_OFFSET UNITYSDK_OFFSET(0x1A807030)
#define CLASS_1_52DD9E5E2B969CDC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A807F70)
#define CLASS_1_52DD9E5E2B969CDC__CTOR_OFFSET UNITYSDK_OFFSET(0x1A807F60)
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_52DD9E5E2B969CDC_TypeDefinitionIndex)->GetStaticField(0xBA10);
	}
	// static const ::System::Single DKJBBBDEOAF; // 0x0
	::System::String* _CrowdVariantPath_k__BackingField; // 0x10
	::UnityEngine::CapsuleCollider* CEEGJCAJAHB; // 0x18
	::System::String* _AudienceMoodMapConfigPath_k__BackingField; // 0x20
	::System::String* ACHIACDNCNN; // 0x28
	::RPG::Client::AudienceMoodMapConfig* _Config_k__BackingField; // 0x30
	...
	::System::Collections::Generic::List_1<::Class_1_E85115A4C331A9DA*>* IEOABMPAGAA; // 0x48
	::RPG::Client::AudienceGroupInstance* EOBLJJBOBIN; // 0x50
	::Class_1_6B7F9A1269220FA8* BNCDHNIIJPJ; // 0x58
	::System::String* OENAMINOLLF; // 0x60
	::UnityEngine::Quaternion NMELCPIOKNO; // 0x68
	::RPG::Client::AudienceStanceConfig_EPositionPoseType EDCEJMPENKI; // 0x78
	::UnityEngine::Vector3 BBFOLEOPPPL; // 0x7C
	::System::Single EOKMFCIBCDI; // 0x88
	::RPG::GameCore::NPCBodySize FNCMBFHKKCK; // 0x8C
	::System::Boolean PMOCMKPOBGF; // 0x90
	::Class_1_52DD9E5E2B969CDC_EPose LGHNGJCFGGC; // 0x94
