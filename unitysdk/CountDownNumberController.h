...
#define COUNTDOWNNUMBERCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1BC4B690)
#define COUNTDOWNNUMBERCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1BC4B530)
#define COUNTDOWNNUMBERCONTROLLER_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x1BC4B890)
#define COUNTDOWNNUMBERCONTROLLER_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1BC4B8F0)
#define COUNTDOWNNUMBERCONTROLLER_ONPRERENDER_OFFSET UNITYSDK_OFFSET(0x1BC4CEA0)
#define COUNTDOWNNUMBERCONTROLLER_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0x1BC4B810)
#define COUNTDOWNNUMBERCONTROLLER_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x1BC4B5F0)
#define COUNTDOWNNUMBERCONTROLLER_SETRENDERSTATE_OFFSET UNITYSDK_OFFSET(0x1BC4B9A0)
#define COUNTDOWNNUMBERCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC4CEF0)

inline static constexpr unsigned int CountDownNumberController_TypeDefinitionIndex = 27851;
