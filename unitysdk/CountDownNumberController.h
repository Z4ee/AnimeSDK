...
#define COUNTDOWNNUMBERCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AF497E0)
#define COUNTDOWNNUMBERCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AF49680)
#define COUNTDOWNNUMBERCONTROLLER_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x1AF499E0)
#define COUNTDOWNNUMBERCONTROLLER_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1AF49A40)
#define COUNTDOWNNUMBERCONTROLLER_ONPRERENDER_OFFSET UNITYSDK_OFFSET(0x1AF4AF60)
#define COUNTDOWNNUMBERCONTROLLER_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0x1AF49960)
#define COUNTDOWNNUMBERCONTROLLER_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x1AF49740)
#define COUNTDOWNNUMBERCONTROLLER_SETRENDERSTATE_OFFSET UNITYSDK_OFFSET(0x1AF49AF0)
#define COUNTDOWNNUMBERCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF4AFB0)

inline static constexpr unsigned int CountDownNumberController_TypeDefinitionIndex = 26896;
