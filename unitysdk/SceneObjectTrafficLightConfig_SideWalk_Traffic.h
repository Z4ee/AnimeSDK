...
#define SCENEOBJECTTRAFFICLIGHTCONFIG_SIDEWALK_TRAFFIC__CTOR_OFFSET UNITYSDK_OFFSET(0x12AA60B0)

inline static constexpr unsigned int SceneObjectTrafficLightConfig_SideWalk_Traffic_TypeDefinitionIndex = 69041;
