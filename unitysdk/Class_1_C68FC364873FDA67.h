...
#define CLASS_1_C68FC364873FDA67_METHOD_1_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x1A8CEE70)
#define CLASS_1_C68FC364873FDA67_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x1A8CEEA0)
#define CLASS_1_C68FC364873FDA67_METHOD_1_43E0506067472339_OFFSET UNITYSDK_OFFSET(0x1A8CC640)
#define CLASS_1_C68FC364873FDA67_METHOD_1_479759059E440327_OFFSET UNITYSDK_OFFSET(0x1A8CE140)
#define CLASS_1_C68FC364873FDA67_METHOD_1_53FE75B00F3A21BF_OFFSET UNITYSDK_OFFSET(0x1A8CBDD0)
#define CLASS_1_C68FC364873FDA67_METHOD_1_700971FD483F8D08_OFFSET UNITYSDK_OFFSET(0x1A8CEE90)
#define CLASS_1_C68FC364873FDA67_METHOD_1_70ABAF7F0B6E54DF_OFFSET UNITYSDK_OFFSET(0x1A8CEEB0)
#define CLASS_1_C68FC364873FDA67_METHOD_1_75F06AA2B167CAB6_OFFSET UNITYSDK_OFFSET(0x1A8CEDB0)
#define CLASS_1_C68FC364873FDA67_METHOD_1_7B6EC255F45D034F_OFFSET UNITYSDK_OFFSET(0x1A8CC560)
#define CLASS_1_C68FC364873FDA67_METHOD_1_87228966056CB632_1_OFFSET UNITYSDK_OFFSET(0x1A8CD7C0)
#define CLASS_1_C68FC364873FDA67_METHOD_1_87228966056CB632_2_OFFSET UNITYSDK_OFFSET(0x1A8CEB10)
#define CLASS_1_C68FC364873FDA67_METHOD_1_87228966056CB632_OFFSET UNITYSDK_OFFSET(0x1A8CDA60)
#define CLASS_1_C68FC364873FDA67_METHOD_1_AA2C0B4005734BA0_OFFSET UNITYSDK_OFFSET(0x1A8CC490)
#define CLASS_1_C68FC364873FDA67_METHOD_1_B58984781C172663_OFFSET UNITYSDK_OFFSET(0x1A8CD610)
#define CLASS_1_C68FC364873FDA67_METHOD_1_EAD10B3E55E2C4C5_OFFSET UNITYSDK_OFFSET(0x1A8CDD00)
#define CLASS_1_C68FC364873FDA67_METHOD_1_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x1A8CEE80)
#define CLASS_1_C68FC364873FDA67_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1A8CC480)
#define CLASS_1_C68FC364873FDA67_METHOD_1_F44C933722F13965_OFFSET UNITYSDK_OFFSET(0x1A8CC890)
#define CLASS_1_C68FC364873FDA67_METHOD_1_F77BBFBC56288301_OFFSET UNITYSDK_OFFSET(0x1A8CC390)
#define CLASS_1_C68FC364873FDA67_METHOD_1_F978A1D172468895_OFFSET UNITYSDK_OFFSET(0x1A8CC0E0)
#define CLASS_1_C68FC364873FDA67_METHOD_1_FA2B1D07C223AE82_OFFSET UNITYSDK_OFFSET(0x1A8CBE70)
#define CLASS_1_C68FC364873FDA67_METHOD_1_FD7491A53D5F5FC6_OFFSET UNITYSDK_OFFSET(0x1A8CE1D0)
#define CLASS_1_C68FC364873FDA67_METHOD_1_FF8F8C575E487469_OFFSET UNITYSDK_OFFSET(0x1A8CB0E0)
#define CLASS_1_C68FC364873FDA67__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8CEEC0)
...
{
public:
	::Class_1_5F51D4049EA87B7B* DJHOAONPLLH; // 0x10
	::Class_3_07C3C4D2990C49EE* ENAIBJGFMFI; // 0x18
	::System::String* GIDAEFPOGHI; // 0x20
	::Class_1_29B23DDF98AF43AC* GALAHGAJODG; // 0x28
	::Class_3_07C3C4D2990C49EE* GMEDBNAABDC; // 0x30
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x38
	::RPG::GameCore::ColliderTriggerComponent* EJEEIAAFHNN; // 0x40
	::Class_2_AB846E7B21D5AD33* LFFDPMJPHEG; // 0x48
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* NBCPCIFHEHG; // 0x50
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* AKHPJHLBMCM; // 0x58
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* NCIHENHPKCH; // 0x60
	::RPG::GameCore::SummonUnitGlobalConfig* FAFFFDIKBBI; // 0x68
	::RPG::GameCore::UnitCustomTriggerConfig* IGHAHBNLIJA; // 0x70
	::System::Boolean BDKBIJFDANJ; // 0x78
	::System::Boolean AGMMNOOOFAD; // 0x79
	::System::Single MDNPNOEMHIC; // 0x7C
	::System::Boolean HOBLOANFANB; // 0x80
	::System::Boolean OLABICPNDFJ; // 0x81
	::System::Boolean HKKLHMHNNHG; // 0x82
	::System::Boolean OKCCLDANMCE; // 0x83
	::Class_1_C68FC364873FDA67_TriggerDisableReason KPIJLMIIJKF; // 0x84
	::System::Single COAELIHGAHH; // 0x88
	::System::Single FJPOKCBJDAL; // 0x8C
