...
#define CLASS_3_BB620C4A1DC7FE3E_METHOD_3_387C40D074FB1980_OFFSET UNITYSDK_OFFSET(0x1C96AE70)
#define CLASS_3_BB620C4A1DC7FE3E_METHOD_3_8C07A6A51F854693_OFFSET UNITYSDK_OFFSET(0x1C96AF10)
#define CLASS_3_BB620C4A1DC7FE3E__CTOR_OFFSET UNITYSDK_OFFSET(0x1C96AED0)

inline static constexpr unsigned int Class_3_BB620C4A1DC7FE3E_TypeDefinitionIndex = 22359;

class Class_3_BB620C4A1DC7FE3E : public ::RPG::GameCore::TaskConfig
{
public:
	::RPG::GameCore::DynamicFloat* KBAPBCNJHDB; // 0x18
