...
#define SINGLEFLOATCURVEBUNDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABD5B90)

inline static constexpr unsigned int SingleFloatCurveBundle_TypeDefinitionIndex = 40520;
