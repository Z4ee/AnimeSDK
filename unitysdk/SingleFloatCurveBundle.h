...
#define SINGLEFLOATCURVEBUNDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19D57C20)

inline static constexpr unsigned int SingleFloatCurveBundle_TypeDefinitionIndex = 39697;
