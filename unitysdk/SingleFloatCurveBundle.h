...
#define SINGLEFLOATCURVEBUNDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18302FE0)

inline static constexpr unsigned int SingleFloatCurveBundle_TypeDefinitionIndex = 33896;
