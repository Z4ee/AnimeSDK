...
#define CUSTOMSKIN_SAFEPHONE__COUNTDOWN_D__20_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x194977D0)
#define CUSTOMSKIN_SAFEPHONE__COUNTDOWN_D__20_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19497930)
#define CUSTOMSKIN_SAFEPHONE__COUNTDOWN_D__20_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19497990)
#define CUSTOMSKIN_SAFEPHONE__COUNTDOWN_D__20_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19497940)
#define CUSTOMSKIN_SAFEPHONE__COUNTDOWN_D__20_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x194977C0)
#define CUSTOMSKIN_SAFEPHONE__COUNTDOWN_D__20__CTOR_OFFSET UNITYSDK_OFFSET(0x194977B0)

inline static constexpr unsigned int CustomSkin_SafePhone__CountDown_d__20_TypeDefinitionIndex = 77502;
