...
#define FRAMEENDREFRESHMANAGER_CALLKEY_COMPUTEHASH_OFFSET UNITYSDK_OFFSET(0x11CE2A40)
#define FRAMEENDREFRESHMANAGER_CALLKEY_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x761D00)
#define FRAMEENDREFRESHMANAGER_CALLKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x761CC0)
#define FRAMEENDREFRESHMANAGER_CALLKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x761E00)
#define FRAMEENDREFRESHMANAGER_CALLKEY_GETUNITYID_OFFSET UNITYSDK_OFFSET(0x11CE2740)
#define FRAMEENDREFRESHMANAGER_CALLKEY_MAKEARGKEYS_OFFSET UNITYSDK_OFFSET(0x11CE28C0)
#define FRAMEENDREFRESHMANAGER_CALLKEY_OWNERSEQUAL_OFFSET UNITYSDK_OFFSET(0x11CE2D50)
#define FRAMEENDREFRESHMANAGER_CALLKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x761C60)
#define FRAMEENDREFRESHMANAGER_CALLKEY___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x761E50)
#define FRAMEENDREFRESHMANAGER_CALLKEY___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x761ED0)

inline static constexpr unsigned int FrameEndRefreshManager_CallKey_TypeDefinitionIndex = 60366;
