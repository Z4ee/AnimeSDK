...
#define AKSWITCH_GET_GROUPGUID_OFFSET UNITYSDK_OFFSET(0x1FBD9EF0)
#define AKSWITCH_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1FBD9CE0)
#define AKSWITCH_GET_VALUEGUID_OFFSET UNITYSDK_OFFSET(0x1FBD9CF0)
#define AKSWITCH_GET_VALUEID_OFFSET UNITYSDK_OFFSET(0x1FBD9C90)
#define AKSWITCH_GET_WWISETYPE_OFFSET UNITYSDK_OFFSET(0x1FBD9B20)
#define AKSWITCH_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x1FBD9B30)
#define AKSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBDA0F0)

inline static constexpr unsigned int AkSwitch_TypeDefinitionIndex = 33815;
