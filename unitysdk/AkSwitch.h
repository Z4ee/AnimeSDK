...
#define AKSWITCH_GET_GROUPGUID_OFFSET UNITYSDK_OFFSET(0x1B6DB970)
#define AKSWITCH_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1B6DB810)
#define AKSWITCH_GET_VALUEGUID_OFFSET UNITYSDK_OFFSET(0x1B6DB890)
#define AKSWITCH_GET_VALUEID_OFFSET UNITYSDK_OFFSET(0x1B6DB7B0)
#define AKSWITCH_GET_WWISETYPE_OFFSET UNITYSDK_OFFSET(0x1B6DB6F0)
#define AKSWITCH_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x1B6DB730)
#define AKSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6DBA50)

inline static constexpr unsigned int AkSwitch_TypeDefinitionIndex = 42154;
