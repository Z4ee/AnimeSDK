...
#define AKSWITCH_GET_GROUPGUID_OFFSET UNITYSDK_OFFSET(0x1C4CC910)
#define AKSWITCH_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1C4CC6F0)
#define AKSWITCH_GET_VALUEGUID_OFFSET UNITYSDK_OFFSET(0x1C4CC710)
#define AKSWITCH_GET_VALUEID_OFFSET UNITYSDK_OFFSET(0x1C4CC6A0)
#define AKSWITCH_GET_WWISETYPE_OFFSET UNITYSDK_OFFSET(0x1C4CC530)
#define AKSWITCH_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x1C4CC540)
#define AKSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4CCB10)

inline static constexpr unsigned int AkSwitch_TypeDefinitionIndex = 31628;
