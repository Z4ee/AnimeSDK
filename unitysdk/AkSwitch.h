...
#define AKSWITCH_GET_GROUPGUID_OFFSET UNITYSDK_OFFSET(0x1D2CCEA0)
#define AKSWITCH_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1D2CCD40)
#define AKSWITCH_GET_VALUEGUID_OFFSET UNITYSDK_OFFSET(0x1D2CCDC0)
#define AKSWITCH_GET_VALUEID_OFFSET UNITYSDK_OFFSET(0x1D2CCCE0)
#define AKSWITCH_GET_WWISETYPE_OFFSET UNITYSDK_OFFSET(0x1D2CCC20)
#define AKSWITCH_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x1D2CCC60)
#define AKSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2CCF80)

inline static constexpr unsigned int AkSwitch_TypeDefinitionIndex = 43765;
