...
#define AKSWITCH_GET_GROUPGUID_OFFSET UNITYSDK_OFFSET(0x18C27D40)
#define AKSWITCH_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x18C27C00)
#define AKSWITCH_GET_VALUEGUID_OFFSET UNITYSDK_OFFSET(0x18C27C60)
#define AKSWITCH_GET_VALUEID_OFFSET UNITYSDK_OFFSET(0x18C27B80)
#define AKSWITCH_GET_WWISETYPE_OFFSET UNITYSDK_OFFSET(0x18C27AC0)
#define AKSWITCH_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x18C27B00)
#define AKSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x18C27EA0)

inline static constexpr unsigned int AkSwitch_TypeDefinitionIndex = 34693;
