...
#define AKSWITCH_GET_GROUPGUID_OFFSET UNITYSDK_OFFSET(0x1E7FD3C0)
#define AKSWITCH_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1E7FD1A0)
#define AKSWITCH_GET_VALUEGUID_OFFSET UNITYSDK_OFFSET(0x1E7FD1C0)
#define AKSWITCH_GET_VALUEID_OFFSET UNITYSDK_OFFSET(0x1E7FD150)
#define AKSWITCH_GET_WWISETYPE_OFFSET UNITYSDK_OFFSET(0x1E7FCFE0)
#define AKSWITCH_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x1E7FCFF0)
#define AKSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7FD5C0)

inline static constexpr unsigned int AkSwitch_TypeDefinitionIndex = 33179;
