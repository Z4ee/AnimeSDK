...
#define AKSWITCH_GET_GROUPGUID_OFFSET UNITYSDK_OFFSET(0x1EF47570)
#define AKSWITCH_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1EF47410)
#define AKSWITCH_GET_VALUEGUID_OFFSET UNITYSDK_OFFSET(0x1EF47490)
#define AKSWITCH_GET_VALUEID_OFFSET UNITYSDK_OFFSET(0x1EF473B0)
#define AKSWITCH_GET_WWISETYPE_OFFSET UNITYSDK_OFFSET(0x1EF472F0)
#define AKSWITCH_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x1EF47330)
#define AKSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF47650)
