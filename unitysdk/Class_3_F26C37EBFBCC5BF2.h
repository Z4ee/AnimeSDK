...
#define CLASS_3_F26C37EBFBCC5BF2_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAC4F9F0)
#define CLASS_3_F26C37EBFBCC5BF2_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0xAC50150)
#define CLASS_3_F26C37EBFBCC5BF2_METHOD_3_E239382DD8D3653B_OFFSET UNITYSDK_OFFSET(0xAC4FE20)
#define CLASS_3_F26C37EBFBCC5BF2_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0xAC500F0)
#define CLASS_3_F26C37EBFBCC5BF2_ONSKIP_OFFSET UNITYSDK_OFFSET(0xAC500A0)
#define CLASS_3_F26C37EBFBCC5BF2_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xAC4FA30)
#define CLASS_3_F26C37EBFBCC5BF2__CTOR_OFFSET UNITYSDK_OFFSET(0xAC4F9C0)
#define CLASS_3_F26C37EBFBCC5BF2___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAC50160)

inline static constexpr unsigned int Class_3_F26C37EBFBCC5BF2_TypeDefinitionIndex = 47022;
