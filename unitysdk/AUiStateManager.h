...
#define AUISTATEMANAGER_CHECKINDEX_OFFSET UNITYSDK_OFFSET(0x10BF65E0)
#define AUISTATEMANAGER_FRESHSTATE_OFFSET UNITYSDK_OFFSET(0x10BF6D30)
#define AUISTATEMANAGER_GETALLTAG_OFFSET UNITYSDK_OFFSET(0x10BF64C0)
#define AUISTATEMANAGER_METHOD_5_4820FAF758595035_OFFSET UNITYSDK_OFFSET(0x10BF6860)
#define AUISTATEMANAGER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x10BF6470)
#define AUISTATEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x10BF6F00)

inline static constexpr unsigned int AUiStateManager_TypeDefinitionIndex = 38436;
