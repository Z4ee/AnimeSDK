...
#define CLASS_1_034C19731D8994B1_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1D046C80)
...
{
public:
	::Struct_2_0A051985BE5779B7 GPMGIHIJDFN; // 0x10
	::RPG::GameCore::FiveDimAvatarConfig* JIHEDFDCCAD; // 0x40
