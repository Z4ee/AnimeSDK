...
#define CLASS_3_B7AF035C09C238DF_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x188D7A70)
#define CLASS_3_B7AF035C09C238DF_ONSKIP_OFFSET UNITYSDK_OFFSET(0x188D7A80)
#define CLASS_3_B7AF035C09C238DF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x188D79A0)
#define CLASS_3_B7AF035C09C238DF__CTOR_OFFSET UNITYSDK_OFFSET(0x188D7970)

inline static constexpr unsigned int Class_3_B7AF035C09C238DF_TypeDefinitionIndex = 49985;
