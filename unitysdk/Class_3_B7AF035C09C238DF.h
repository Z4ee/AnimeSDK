...
#define CLASS_3_B7AF035C09C238DF_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x8864640)
#define CLASS_3_B7AF035C09C238DF_ONSKIP_OFFSET UNITYSDK_OFFSET(0x8864650)
#define CLASS_3_B7AF035C09C238DF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8864570)
#define CLASS_3_B7AF035C09C238DF__CTOR_OFFSET UNITYSDK_OFFSET(0x8864540)

inline static constexpr unsigned int Class_3_B7AF035C09C238DF_TypeDefinitionIndex = 42386;
