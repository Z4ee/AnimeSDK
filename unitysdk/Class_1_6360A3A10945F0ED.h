...
#define CLASS_1_6360A3A10945F0ED_GET_CASTQUEUES_OFFSET UNITYSDK_OFFSET(0xC02D8B0)
#define CLASS_1_6360A3A10945F0ED_GET_FRAMEABILITYUSECOUNT_OFFSET UNITYSDK_OFFSET(0xC02D8C0)
#define CLASS_1_6360A3A10945F0ED_GET_NEXTCASTTIME_OFFSET UNITYSDK_OFFSET(0xC02D8A0)
#define CLASS_1_6360A3A10945F0ED_METHOD_1_01774206ABF53A0E_OFFSET UNITYSDK_OFFSET(0xC02C990)
#define CLASS_1_6360A3A10945F0ED_METHOD_1_08E6D1A4DC44556A_OFFSET UNITYSDK_OFFSET(0xC02C270)
#define CLASS_1_6360A3A10945F0ED_METHOD_1_20E060AF2A40CA51_OFFSET UNITYSDK_OFFSET(0xC02C420)
#define CLASS_1_6360A3A10945F0ED_METHOD_1_281255C747FAABE8_OFFSET UNITYSDK_OFFSET(0xC02C0E0)
#define CLASS_1_6360A3A10945F0ED_METHOD_1_489E0B827662C211_OFFSET UNITYSDK_OFFSET(0xC02D390)
#define CLASS_1_6360A3A10945F0ED_METHOD_1_4B47E0E437013140_OFFSET UNITYSDK_OFFSET(0xC02D250)
#define CLASS_1_6360A3A10945F0ED_METHOD_1_63882E0318B95793_OFFSET UNITYSDK_OFFSET(0xC02B830)
#define CLASS_1_6360A3A10945F0ED_METHOD_1_933713A4305E9272_OFFSET UNITYSDK_OFFSET(0xC02C4D0)
#define CLASS_1_6360A3A10945F0ED_METHOD_1_9AF9D9529B0BC153_OFFSET UNITYSDK_OFFSET(0xC02C6D0)
#define CLASS_1_6360A3A10945F0ED_METHOD_1_D3BBF140D24D382E_OFFSET UNITYSDK_OFFSET(0xC02D080)
#define CLASS_1_6360A3A10945F0ED_METHOD_1_DADC23986433A9E4_OFFSET UNITYSDK_OFFSET(0xC02CC30)
#define CLASS_1_6360A3A10945F0ED_METHOD_1_FA0119DD445A672F_OFFSET UNITYSDK_OFFSET(0xC02B6C0)
#define CLASS_1_6360A3A10945F0ED__CTOR_OFFSET UNITYSDK_OFFSET(0xC02B490)

inline static constexpr unsigned int Class_1_6360A3A10945F0ED_TypeDefinitionIndex = 76829;

class Class_1_6360A3A10945F0ED : public ::System::Object
{
public:
	::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::Queue_1<::Class_1_12E54BDA00FBCA01*>*>* _CastQueues_k__BackingField; // 0x10
	::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* _FrameAbilityUseCount_k__BackingField; // 0x18
	::Class_1_3B1EA953A4067E26_2* FKINCGODJEP; // 0x20
	::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Single>* _NextCastTime_k__BackingField; // 0x28
	::Class_1_D15D83CB948FC3A0* JDILNDANFCO; // 0x30
	::System::Int32 AHFGLFMJELJ; // 0x38
	::System::Single KEENOCIHFDF; // 0x3C
	::System::Int32 OCDPPDPDGME; // 0x40
