...
#define CLASS_1_0A99AF1699F7F17E_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1EC18A90)
#define CLASS_1_0A99AF1699F7F17E_CLONE_OFFSET UNITYSDK_OFFSET(0x1EC186A0)
#define CLASS_1_0A99AF1699F7F17E_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1EC18820)
#define CLASS_1_0A99AF1699F7F17E_EQUALS_OFFSET UNITYSDK_OFFSET(0x1EC186E0)
#define CLASS_1_0A99AF1699F7F17E_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1EC18940)
#define CLASS_1_0A99AF1699F7F17E_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1EC18BA0)
#define CLASS_1_0A99AF1699F7F17E_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1EC18B00)
#define CLASS_1_0A99AF1699F7F17E_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1EC18590)
#define CLASS_1_0A99AF1699F7F17E_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x1EC186D0)
#define CLASS_1_0A99AF1699F7F17E_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1EC185C0)
#define CLASS_1_0A99AF1699F7F17E_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1EC189B0)
#define CLASS_1_0A99AF1699F7F17E_WRITETO_OFFSET UNITYSDK_OFFSET(0x1EC18A10)
#define CLASS_1_0A99AF1699F7F17E__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EC18D40)
#define CLASS_1_0A99AF1699F7F17E__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EC18610)
#define CLASS_1_0A99AF1699F7F17E__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC185D0)

inline static constexpr unsigned int Class_1_0A99AF1699F7F17E_TypeDefinitionIndex = 25086;

class Class_1_0A99AF1699F7F17E : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_0A99AF1699F7F17E*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_0A99AF1699F7F17E*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0A99AF1699F7F17E_TypeDefinitionIndex)->GetStaticField(0x13850);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_D17272E82AE804C2_19*>** StaticGet_MNCHCOFMDMM()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_D17272E82AE804C2_19*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0A99AF1699F7F17E_TypeDefinitionIndex)->GetStaticField(0x13858);
	}
	// static const ::System::Int32 AIICFPIDLIB = 0x1; // 0x0
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x10
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_D17272E82AE804C2_19*>* NKAGCEJIBEN; // 0x18
