...
#define CLASS_1_0A99AF1699F7F17E_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DAEF940)
#define CLASS_1_0A99AF1699F7F17E_CLONE_OFFSET UNITYSDK_OFFSET(0x1DAEF550)
#define CLASS_1_0A99AF1699F7F17E_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DAEF6D0)
#define CLASS_1_0A99AF1699F7F17E_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DAEF590)
#define CLASS_1_0A99AF1699F7F17E_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DAEF7F0)
#define CLASS_1_0A99AF1699F7F17E_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DAEFA50)
#define CLASS_1_0A99AF1699F7F17E_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DAEF9B0)
#define CLASS_1_0A99AF1699F7F17E_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1DAEF440)
#define CLASS_1_0A99AF1699F7F17E_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x1DAEF580)
#define CLASS_1_0A99AF1699F7F17E_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DAEF470)
#define CLASS_1_0A99AF1699F7F17E_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DAEF860)
#define CLASS_1_0A99AF1699F7F17E_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DAEF8C0)
#define CLASS_1_0A99AF1699F7F17E__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DAEFBF0)
#define CLASS_1_0A99AF1699F7F17E__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DAEF4C0)
#define CLASS_1_0A99AF1699F7F17E__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAEF480)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_D17272E82AE804C2_19*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0A99AF1699F7F17E_TypeDefinitionIndex)->GetStaticField(0x13790);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_0A99AF1699F7F17E*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_0A99AF1699F7F17E*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0A99AF1699F7F17E_TypeDefinitionIndex)->GetStaticField(0x13798);
	}
	// static const ::System::Int32 AIICFPIDLIB = 0x1; // 0x0
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_D17272E82AE804C2_19*>* NKAGCEJIBEN; // 0x10
