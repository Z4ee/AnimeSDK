...
#define CLASS_1_AEF3B473274E6579_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E370460)
#define CLASS_1_AEF3B473274E6579_CLONE_OFFSET UNITYSDK_OFFSET(0x1E36FF30)
#define CLASS_1_AEF3B473274E6579_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E36FFE0)
#define CLASS_1_AEF3B473274E6579_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E36FFB0)
#define CLASS_1_AEF3B473274E6579_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E3701C0)
#define CLASS_1_AEF3B473274E6579_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E370670)
#define CLASS_1_AEF3B473274E6579_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E370560)
#define CLASS_1_AEF3B473274E6579_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x1E36FF60)
#define CLASS_1_AEF3B473274E6579_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E36FDC0)
#define CLASS_1_AEF3B473274E6579_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x1E36FF80)
#define CLASS_1_AEF3B473274E6579_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1E36FF70)
#define CLASS_1_AEF3B473274E6579_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1E36FFA0)
#define CLASS_1_AEF3B473274E6579_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1E36FF90)
#define CLASS_1_AEF3B473274E6579_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E36FDF0)
#define CLASS_1_AEF3B473274E6579_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E370260)
#define CLASS_1_AEF3B473274E6579_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E3702C0)
#define CLASS_1_AEF3B473274E6579__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E3708C0)
#define CLASS_1_AEF3B473274E6579__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E36FE40)
#define CLASS_1_AEF3B473274E6579__CTOR_OFFSET UNITYSDK_OFFSET(0x1E36FE00)

inline static constexpr unsigned int Class_1_AEF3B473274E6579_TypeDefinitionIndex = 25035;

class Class_1_AEF3B473274E6579 : public ::System::Object
{
public:
	static ::Google::Protobuf::FieldCodec_1<::Class_1_D17272E82AE804C2_14*>** StaticGet_FLKLPNILEFA()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_D17272E82AE804C2_14*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_AEF3B473274E6579_TypeDefinitionIndex)->GetStaticField(0x59650);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_AEF3B473274E6579*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_AEF3B473274E6579*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_AEF3B473274E6579_TypeDefinitionIndex)->GetStaticField(0x59658);
	}
	// static const ::System::Int32 FJFADMPEDGH = 0x1; // 0x0
	// static const ::System::Int32 ILEPHLBOHPG = 0x2; // 0x0
	// static const ::System::Int32 DJPCFBHOMJB = 0x3; // 0x0
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x10
	::Class_1_21C7581DFE99F091_1* IPDJEFAFDNA; // 0x18
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_D17272E82AE804C2_14*>* KODDFEIHCDN; // 0x20
	::System::Boolean JADCILGHJKN; // 0x28
