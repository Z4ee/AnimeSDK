...
#define CLASS_2_0D1F2962370675BA_METHOD_2_10AEFFE6314C3D88_OFFSET UNITYSDK_OFFSET(0x17AFE260)
#define CLASS_2_0D1F2962370675BA_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x17AFE5F0)
#define CLASS_2_0D1F2962370675BA_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x17AFE520)
#define CLASS_2_0D1F2962370675BA_ONCLEAR_OFFSET UNITYSDK_OFFSET(0x17AFE560)
#define CLASS_2_0D1F2962370675BA_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x17AFE380)
#define CLASS_2_0D1F2962370675BA__CTOR_OFFSET UNITYSDK_OFFSET(0x17AFE650)

inline static constexpr unsigned int Class_2_0D1F2962370675BA_TypeDefinitionIndex = 79526;

class Class_2_0D1F2962370675BA : public ::Class_1_3713064DEE761936
{
public:
	::RPG::Client::FateRin::View::Battle::FateRinEffectController* CPIIOIPAAKK; // 0x20
	::System::Object* CFKHNPGEAJA; // 0x28
	::System::Boolean BEMMCKLJICI; // 0x30
	::UnityEngine::Vector3 IEBJLLHDMAG; // 0x34
	::UnityEngine::Vector3 IMFHNDBKHLI; // 0x40
	::UnityEngine::Vector3 IPBOCIPNDMG; // 0x4C
