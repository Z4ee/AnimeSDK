...
#define CLASS_2_BBFD0E52E2E016C9_DISPOSE_OFFSET UNITYSDK_OFFSET(0xDE45FE0)
#define CLASS_2_BBFD0E52E2E016C9_METHOD_2_05DBE83F8B5D6163_OFFSET UNITYSDK_OFFSET(0xDE463C0)
#define CLASS_2_BBFD0E52E2E016C9_METHOD_2_0A68C812815B75DA_OFFSET UNITYSDK_OFFSET(0xDE496F0)
#define CLASS_2_BBFD0E52E2E016C9_METHOD_2_3A599F23178B2776_OFFSET UNITYSDK_OFFSET(0xDE48970)
#define CLASS_2_BBFD0E52E2E016C9_METHOD_2_4B95663C16A02708_OFFSET UNITYSDK_OFFSET(0xDE48E90)
#define CLASS_2_BBFD0E52E2E016C9_METHOD_2_501509B4B58077AF_OFFSET UNITYSDK_OFFSET(0xDE49940)
#define CLASS_2_BBFD0E52E2E016C9_METHOD_2_56D8C8BA32305461_OFFSET UNITYSDK_OFFSET(0xDE49570)
#define CLASS_2_BBFD0E52E2E016C9_METHOD_2_5E72916301E347E2_OFFSET UNITYSDK_OFFSET(0xDE49050)
#define CLASS_2_BBFD0E52E2E016C9_METHOD_2_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0xDE49660)
#define CLASS_2_BBFD0E52E2E016C9_METHOD_2_A3EF4ED894EBFFC3_OFFSET UNITYSDK_OFFSET(0xDE48870)
#define CLASS_2_BBFD0E52E2E016C9_METHOD_2_ABFE6A357B89C69A_1_OFFSET UNITYSDK_OFFSET(0xDE49120)
#define CLASS_2_BBFD0E52E2E016C9_METHOD_2_ABFE6A357B89C69A_OFFSET UNITYSDK_OFFSET(0xDE49230)
#define CLASS_2_BBFD0E52E2E016C9_METHOD_2_D0BD1377F2594D33_1_OFFSET UNITYSDK_OFFSET(0xDE461A0)
#define CLASS_2_BBFD0E52E2E016C9_METHOD_2_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0xDE460E0)
#define CLASS_2_BBFD0E52E2E016C9_METHOD_2_E52129E82CD2D7F8_OFFSET UNITYSDK_OFFSET(0xDE494B0)
#define CLASS_2_BBFD0E52E2E016C9_METHOD_2_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0xDE49340)
#define CLASS_2_BBFD0E52E2E016C9_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xDE46260)
#define CLASS_2_BBFD0E52E2E016C9_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xDE48290)
#define CLASS_2_BBFD0E52E2E016C9_TICK_OFFSET UNITYSDK_OFFSET(0xDE48370)
#define CLASS_2_BBFD0E52E2E016C9__CCTOR_OFFSET UNITYSDK_OFFSET(0xDE49F10)
#define CLASS_2_BBFD0E52E2E016C9__CTOR_OFFSET UNITYSDK_OFFSET(0xDE45D00)

inline static constexpr unsigned int Class_2_BBFD0E52E2E016C9_TypeDefinitionIndex = 49039;
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_2_BBFD0E52E2E016C9_TypeDefinitionIndex)->GetStaticField(0x142F0);
	}
	static ::System::Int32* StaticGet_Field_2_1()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_2_BBFD0E52E2E016C9_TypeDefinitionIndex)->GetStaticField(0x142F4);
	}
	::UnityEngine::Coroutine* Field_2_2; // 0x18
	::RPG::GameCore::AdvNPCRunAwayPlayer* Field_2_3; // 0x20
	::Class_2_A0580152EB393340* Field_2_4; // 0x28
	::RPG::GameCore::AdventureCharacterController* Field_2_5; // 0x30
	::RPG::GameCore::NPCComponent* Field_2_6; // 0x38
	::Class_1_F3391C70DC37088D* Field_2_7; // 0x40
	::Class_1_F3391C70DC37088D* Field_2_8; // 0x48
	::Class_1_F3391C70DC37088D* Field_2_9; // 0x50
	::RPG::GameCore::CharacterVisibleComponent* Field_2_10; // 0x58
	::RPG::GameCore::TaskContext* Field_2_11; // 0x60
	::RPG::GameCore::TransformComponent* Field_2_12; // 0x68
	::System::Boolean Field_2_13; // 0x70
	::System::Single Field_2_14; // 0x74
	::System::Nullable_1<::UnityEngine::Vector3> Field_2_15; // 0x78
	::UnityEngine::Vector3 Field_2_16; // 0x88
	::UnityEngine::Vector3 Field_2_17; // 0x94
	::UnityEngine::Vector3 Field_2_18; // 0xA0
	::RPG::GameCore::AdvNPCRunAwayPlayerStatus Field_2_19; // 0xAC
