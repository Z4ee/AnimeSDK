...
#define CLASS_3_CA807220C14CD3E3_1_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1591BBF0)
#define CLASS_3_CA807220C14CD3E3_1_ENTER_OFFSET UNITYSDK_OFFSET(0x1591BC30)
#define CLASS_3_CA807220C14CD3E3_1_GETGAMEPHASETYPE_OFFSET UNITYSDK_OFFSET(0x1591C1B0)
#define CLASS_3_CA807220C14CD3E3_1_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1591C100)
#define CLASS_3_CA807220C14CD3E3_1_LEAVE_OFFSET UNITYSDK_OFFSET(0x1591C160)
#define CLASS_3_CA807220C14CD3E3_1_METHOD_3_E53DFBBB5F1609C2_OFFSET UNITYSDK_OFFSET(0x1591BF70)
#define CLASS_3_CA807220C14CD3E3_1_TICK_OFFSET UNITYSDK_OFFSET(0x1591C200)
#define CLASS_3_CA807220C14CD3E3_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1591BB60)
#define CLASS_3_CA807220C14CD3E3_1__ENTER_B__2_0_OFFSET UNITYSDK_OFFSET(0x1591C260)
