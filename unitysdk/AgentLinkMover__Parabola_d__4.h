...
#define AGENTLINKMOVER__PARABOLA_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x18170F80)
#define AGENTLINKMOVER__PARABOLA_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x181711F0)
#define AGENTLINKMOVER__PARABOLA_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18171250)
#define AGENTLINKMOVER__PARABOLA_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x18171200)
#define AGENTLINKMOVER__PARABOLA_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18170F70)
#define AGENTLINKMOVER__PARABOLA_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x18170F60)

inline static constexpr unsigned int AgentLinkMover__Parabola_d__4_TypeDefinitionIndex = 79925;
...
public:
	...
	::System::Single _normalizedTime_5__4; // 0x20
	::UnityEngine::Vector3 _endPos_5__3; // 0x24
