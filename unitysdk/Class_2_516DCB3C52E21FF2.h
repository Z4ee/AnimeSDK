...
#define CLASS_2_516DCB3C52E21FF2_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11164A40)
#define CLASS_2_516DCB3C52E21FF2_METHOD_2_2483ADBE483CF401_OFFSET UNITYSDK_OFFSET(0x11166900)
#define CLASS_2_516DCB3C52E21FF2_METHOD_2_5328D6743BA51A4A_OFFSET UNITYSDK_OFFSET(0x11166130)
#define CLASS_2_516DCB3C52E21FF2_METHOD_2_84F804B2B956D18D_OFFSET UNITYSDK_OFFSET(0x11165430)
#define CLASS_2_516DCB3C52E21FF2_METHOD_2_891D2360CB4AAF39_OFFSET UNITYSDK_OFFSET(0x111653A0)
#define CLASS_2_516DCB3C52E21FF2_METHOD_2_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x11166080)
#define CLASS_2_516DCB3C52E21FF2_METHOD_2_9727757D1D6D3326_OFFSET UNITYSDK_OFFSET(0x111656D0)
#define CLASS_2_516DCB3C52E21FF2_METHOD_2_9F8864631434A8C7_1_OFFSET UNITYSDK_OFFSET(0x11165FC0)
#define CLASS_2_516DCB3C52E21FF2_METHOD_2_9F8864631434A8C7_OFFSET UNITYSDK_OFFSET(0x11165630)
#define CLASS_2_516DCB3C52E21FF2_METHOD_2_AA08720895458700_OFFSET UNITYSDK_OFFSET(0x11166020)
#define CLASS_2_516DCB3C52E21FF2_METHOD_2_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x11165290)
#define CLASS_2_516DCB3C52E21FF2_METHOD_2_FABC9D43ED6552D8_OFFSET UNITYSDK_OFFSET(0x11166A50)
#define CLASS_2_516DCB3C52E21FF2_ONCREATE_OFFSET UNITYSDK_OFFSET(0x111643D0)
#define CLASS_2_516DCB3C52E21FF2__CCTOR_OFFSET UNITYSDK_OFFSET(0x11165280)
#define CLASS_2_516DCB3C52E21FF2__CTOR_OFFSET UNITYSDK_OFFSET(0x111650C0)

inline static constexpr unsigned int Class_2_516DCB3C52E21FF2_TypeDefinitionIndex = 63240;
...
public:
	...
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_2_516DCB3C52E21FF2_TypeDefinitionIndex)->GetStaticField(0xA510);
	}
	::System::Collections::Generic::Dictionary_2<::System::ValueTuple_2<::UnityEngine::Vector3, ::UnityEngine::Vector3>, ::System::ValueTuple_2<::UnityEngine::Vector2, ::UnityEngine::Vector2>>* Field_2_4; // 0x10
	::System::Collections::Generic::Dictionary_2<::Enum_3_E8AA3BFDDEBD45EA, ::Class_1_B5F58059A372D660*>* Field_2_7; // 0x18
	::Class_1_B5F58059A372D660* Field_2_6; // 0x20
	::System::Runtime::CompilerServices::ConditionalWeakTable_2<::UnityEngine::RectTransform*, ::Il2CppArray<::UnityEngine::Vector3>*>* Field_2_11; // 0x28
	...
	::System::Collections::Generic::List_1<::Struct_2_FA093D24932D214F>* Method_2_5328D6743BA51A4A(::System::Collections::Generic::IEnumerable_1<::MoleMole::UICloudController_UIRTCItem*>* a1, ::System::Boolean a2)
	{
		return ((::System::Collections::Generic::List_1<::Struct_2_FA093D24932D214F>*(*)(::PVOID, ::System::Collections::Generic::IEnumerable_1<::MoleMole::UICloudController_UIRTCItem*>*, ::System::Boolean))((::PBYTE)hIl2Cpp + CLASS_2_516DCB3C52E21FF2_METHOD_2_5328D6743BA51A4A_OFFSET))(this, a1, a2);
	}
