...
#define CLASS_2_1A0820588D0058BE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x97A6AF0)
#define CLASS_2_1A0820588D0058BE_METHOD_2_1283EC0876EAAACF_OFFSET UNITYSDK_OFFSET(0x97A6B80)
#define CLASS_2_1A0820588D0058BE_METHOD_2_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x97A7480)
#define CLASS_2_1A0820588D0058BE_METHOD_2_98511BB23D2E3748_OFFSET UNITYSDK_OFFSET(0x97A75A0)
#define CLASS_2_1A0820588D0058BE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x97A6B30)
#define CLASS_2_1A0820588D0058BE_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x97A7360)
#define CLASS_2_1A0820588D0058BE_TICK_OFFSET UNITYSDK_OFFSET(0x97A73B0)
#define CLASS_2_1A0820588D0058BE__CTOR_OFFSET UNITYSDK_OFFSET(0x97A6AE0)
#define CLASS_2_1A0820588D0058BE___SHOWGUIDEDETAILDIALOG_B__5_0_OFFSET UNITYSDK_OFFSET(0x97A75F0)

inline static constexpr unsigned int Class_2_1A0820588D0058BE_TypeDefinitionIndex = 54072;

class Class_2_1A0820588D0058BE : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::Client::LuaUIController* Field_2_2; // 0x18
	::RPG::GameCore::ShowGuideDetailDialog* Field_2_0; // 0x20
