...
#define CLASS_1_6A1F92A73CE83B57__CTOR_OFFSET UNITYSDK_OFFSET(0xB966890)
...
public:
	...
	::RPG::GameCore::AdventureAnimStateType PGFKKJLJJDN; // 0x18
	::RPG::GameCore::AdventureAnimStateType LABNOBJEDBD; // 0x1C
