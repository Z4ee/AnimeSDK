...
#define IL2CPPCLASS_FROMTYPEDEFINITIONINDEX_OFFSET UNITYSDK_OFFSET(0x241A90)
#define IL2CPPCLASS_NAME_OFFSET UNITYSDK_OFFSET(0x30)
#define IL2CPPCLASS_GETNAMESPACE_OFFSET UNITYSDK_OFFSET(0x236990)
#define IL2CPPCLASS_GETPARENT_OFFSET UNITYSDK_OFFSET(0x9DC060)
#define STATICFIELDSPOOL_OFFSET UNITYSDK_OFFSET(0x4B373D8)
