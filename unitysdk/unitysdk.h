...
#define IL2CPPCLASS_FROMTYPEDEFINITIONINDEX_OFFSET UNITYSDK_OFFSET(0x3C76420)
#define IL2CPPCLASS_NAME_OFFSET UNITYSDK_OFFSET(0x20)
#define IL2CPPCLASS_GETNAMESPACE_OFFSET UNITYSDK_OFFSET(0x3C0B0B0)
#define IL2CPPCLASS_GETPARENT_OFFSET UNITYSDK_OFFSET(0x3C0B0F0)
#define STATICFIELDSPOOL_OFFSET UNITYSDK_OFFSET(0x95CFD58)
