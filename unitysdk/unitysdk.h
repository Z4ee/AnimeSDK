...
#define IL2CPPCLASS_FROMTYPEDEFINITIONINDEX_OFFSET UNITYSDK_OFFSET(0x23A26A0)
#define IL2CPPCLASS_NAME_OFFSET UNITYSDK_OFFSET(0x78)
#define IL2CPPCLASS_GETNAMESPACE_OFFSET UNITYSDK_OFFSET(0x2330520)
#define IL2CPPCLASS_GETPARENT_OFFSET UNITYSDK_OFFSET(0x2330560)
#define STATICFIELDSPOOL_OFFSET UNITYSDK_OFFSET(0x73A61B0)
