...
#define IL2CPPCLASS_FROMTYPEDEFINITIONINDEX_OFFSET UNITYSDK_OFFSET(0x393BA30)
#define IL2CPPCLASS_NAME_OFFSET UNITYSDK_OFFSET(0x80)
#define IL2CPPCLASS_GETNAMESPACE_OFFSET UNITYSDK_OFFSET(0x38D2600)
#define IL2CPPCLASS_GETPARENT_OFFSET UNITYSDK_OFFSET(0x38D2640)
#define STATICFIELDSPOOL_OFFSET UNITYSDK_OFFSET(0x8729D58)
