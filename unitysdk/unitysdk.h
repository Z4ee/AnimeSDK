...
#define IL2CPPCLASS_FROMTYPEDEFINITIONINDEX_OFFSET UNITYSDK_OFFSET(0x63CA00)
#define IL2CPPCLASS_NAME_OFFSET UNITYSDK_OFFSET(0x20)
#define IL2CPPCLASS_GETNAMESPACE_OFFSET UNITYSDK_OFFSET(0x630DC0)
#define IL2CPPCLASS_GETPARENT_OFFSET UNITYSDK_OFFSET(0x3B06E70)
#define STATICFIELDSPOOL_OFFSET UNITYSDK_OFFSET(0x964F4E0)
