...
#define IL2CPPCLASS_FROMTYPEDEFINITIONINDEX_OFFSET UNITYSDK_OFFSET(0x272A00)
#define IL2CPPCLASS_NAME_OFFSET UNITYSDK_OFFSET(0x50)
#define IL2CPPCLASS_GETNAMESPACE_OFFSET UNITYSDK_OFFSET(0x267640)
#define IL2CPPCLASS_GETPARENT_OFFSET UNITYSDK_OFFSET(0xACDB20)
#define STATICFIELDSPOOL_OFFSET UNITYSDK_OFFSET(0x5360730)
