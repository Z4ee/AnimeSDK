...
#define IL2CPPCLASS_FROMTYPEDEFINITIONINDEX_OFFSET UNITYSDK_OFFSET(0x21D05A0)
#define IL2CPPCLASS_NAME_OFFSET UNITYSDK_OFFSET(0x78)
#define IL2CPPCLASS_GETNAMESPACE_OFFSET UNITYSDK_OFFSET(0x215E720)
#define IL2CPPCLASS_GETPARENT_OFFSET UNITYSDK_OFFSET(0x215E760)
#define STATICFIELDSPOOL_OFFSET UNITYSDK_OFFSET(0x6CECAB0)
