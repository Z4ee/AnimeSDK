...
#define IL2CPPCLASS_FROMTYPEDEFINITIONINDEX_OFFSET UNITYSDK_OFFSET(0x25ED70)
#define IL2CPPCLASS_NAME_OFFSET UNITYSDK_OFFSET(0x58)
#define IL2CPPCLASS_GETNAMESPACE_OFFSET UNITYSDK_OFFSET(0x253D00)
#define IL2CPPCLASS_GETPARENT_OFFSET UNITYSDK_OFFSET(0xA7D640)
#define STATICFIELDSPOOL_OFFSET UNITYSDK_OFFSET(0x504C068)
