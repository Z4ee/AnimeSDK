...
#define CLASS_1_6403DECDBFD56254_METHOD_1_13A4856CD0BBDB3F_OFFSET UNITYSDK_OFFSET(0x1CF87E20)
#define CLASS_1_6403DECDBFD56254__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF88030)
...
public:
	...
	::RPG::Client::TextID PEPOHJHNFHF; // 0x18
	::System::UInt32 PHFMCACHFIJ; // 0x28
	::RPG::GameCore::ActivityDiceCombatV2BattleTalkType LLBDOPKHHEB; // 0x2C
