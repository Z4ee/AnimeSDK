...
#define STRUCT_2_01A1C5D2E69C14A4_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x821750)
#define STRUCT_2_01A1C5D2E69C14A4_EQUALS_OFFSET UNITYSDK_OFFSET(0x8216A0)
#define STRUCT_2_01A1C5D2E69C14A4_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x821760)
#define STRUCT_2_01A1C5D2E69C14A4_METHOD_2_1293CB739F1151A1_OFFSET UNITYSDK_OFFSET(0x8218A0)
#define STRUCT_2_01A1C5D2E69C14A4_METHOD_2_6D0360BD23602584_OFFSET UNITYSDK_OFFSET(0x821770)
#define STRUCT_2_01A1C5D2E69C14A4_METHOD_2_718A29F5005F6A5D_1_OFFSET UNITYSDK_OFFSET(0x156C1080)
#define STRUCT_2_01A1C5D2E69C14A4_METHOD_2_718A29F5005F6A5D_OFFSET UNITYSDK_OFFSET(0x156C0D10)
#define STRUCT_2_01A1C5D2E69C14A4_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x821830)
#define STRUCT_2_01A1C5D2E69C14A4_METHOD_2_D0EE81B3FDA3E65D_OFFSET UNITYSDK_OFFSET(0x8217E0)
#define STRUCT_2_01A1C5D2E69C14A4_METHOD_2_EDC1F4BA713AAFCE_OFFSET UNITYSDK_OFFSET(0x156C0C40)
#define STRUCT_2_01A1C5D2E69C14A4__CCTOR_OFFSET UNITYSDK_OFFSET(0x156C0BA0)
#define STRUCT_2_01A1C5D2E69C14A4__CTOR_OFFSET UNITYSDK_OFFSET(0x821680)

inline static constexpr unsigned int Struct_2_01A1C5D2E69C14A4_TypeDefinitionIndex = 54913;

struct alignas(8) Struct_2_01A1C5D2E69C14A4
{
	static ::Struct_2_01A1C5D2E69C14A4* StaticGet_Field_2_3()
	{
		return (::Struct_2_01A1C5D2E69C14A4*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_01A1C5D2E69C14A4_TypeDefinitionIndex)->GetStaticField(0x2E490);
	}
	::Struct_2_3A004622942516C0 Field_2_2; // 0x10
	::FluffyUnderware::Curvy::CurvySpline* Field_2_1; // 0x20
	::System::Boolean Field_2_0; // 0x28

	::System::Void _ctor(::FluffyUnderware::Curvy::CurvySpline* a1, ::Enum_3_527B06155233FF65 a2)
	{
		return ((::System::Void(*)(::PVOID, ::FluffyUnderware::Curvy::CurvySpline*, ::Enum_3_527B06155233FF65))((::PBYTE)hIl2Cpp + STRUCT_2_01A1C5D2E69C14A4__CTOR_OFFSET))(this, a1, a2);
	}
