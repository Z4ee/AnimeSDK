...
#define CLASS_1_5B567C8A01BAEDFE_21_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A1CE630)
#define CLASS_1_5B567C8A01BAEDFE_21_CLONE_OFFSET UNITYSDK_OFFSET(0x1A1CE440)
#define CLASS_1_5B567C8A01BAEDFE_21_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A1CE540)
#define CLASS_1_5B567C8A01BAEDFE_21_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A1CE4B0)
#define CLASS_1_5B567C8A01BAEDFE_21_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A1CE590)
#define CLASS_1_5B567C8A01BAEDFE_21_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A1CE680)
#define CLASS_1_5B567C8A01BAEDFE_21_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A1CE650)
#define CLASS_1_5B567C8A01BAEDFE_21_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A1CE390)
#define CLASS_1_5B567C8A01BAEDFE_21_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A1CE3F0)
#define CLASS_1_5B567C8A01BAEDFE_21_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A1CE5C0)
#define CLASS_1_5B567C8A01BAEDFE_21_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A1CE620)
#define CLASS_1_5B567C8A01BAEDFE_21__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1CE6D0)
#define CLASS_1_5B567C8A01BAEDFE_21__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1CE410)
#define CLASS_1_5B567C8A01BAEDFE_21__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1CE400)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_21_TypeDefinitionIndex = 24803;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_21*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_21_TypeDefinitionIndex)->GetStaticField(0x35CE0);
	}
