...
{
	inline static constexpr unsigned int ObservableQueue_1_View_1_TypeDefinitionIndex = 28232;

	template <typename T, typename TView>
	class ObservableQueue_1_View_1 : public ::System::Object
	{
	public:
		::ObservableCollections::ObservableQueue_1<T>* source; // 0x0
		::System::Func_2<T, TView>* selector; // 0x0
		::System::Boolean reverse; // 0x0
		::System::Collections::Generic::Queue_1<::System::ValueTuple_2<T, TView>>* queue; // 0x0
