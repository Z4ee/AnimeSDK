...
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS_GET_COLLECTION_OFFSET UNITYSDK_OFFSET(0x1E5B2B80)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS_GET_INVOKER_OFFSET UNITYSDK_OFFSET(0x1E5B2BE0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS_GET_ISINVOKECOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1E5B2BA0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS_GET_ISINVOKEPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1E5B2BC0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E5B2C00)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS_SET_COLLECTION_OFFSET UNITYSDK_OFFSET(0x1E5B2B90)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS_SET_INVOKER_OFFSET UNITYSDK_OFFSET(0x1E5B2BF0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS_SET_ISINVOKECOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1E5B2BB0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS_SET_ISINVOKEPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1E5B2BD0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_10_OFFSET UNITYSDK_OFFSET(0x1E5B2D20)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E5B2C90)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E5B2CA0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1E5B2CB0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1E5B2CC0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1E5B2CD0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1E5B2CE0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_7_OFFSET UNITYSDK_OFFSET(0x1E5B2CF0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_8_OFFSET UNITYSDK_OFFSET(0x1E5B2D00)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_9_OFFSET UNITYSDK_OFFSET(0x1E5B2D10)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5B2C80)

namespace ObservableCollections
{
	inline static constexpr unsigned int CollectionEventDispatcherEventArgs_TypeDefinitionIndex = 28011;
	...
	public:
		...
		::System::Boolean _IsInvokeCollectionChanged_k__BackingField; // 0x40
		::System::Boolean _IsInvokePropertyChanged_k__BackingField; // 0x41
