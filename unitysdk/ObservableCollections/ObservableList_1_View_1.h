...
{
	inline static constexpr unsigned int ObservableList_1_View_1_TypeDefinitionIndex = 25797;

	template <typename T, typename TView>
	class ObservableList_1_View_1 : public ::System::Object
	{
	public:
		::ObservableCollections::ObservableList_1<T>* source; // 0x0
		::System::Func_2<T, TView>* selector; // 0x0
		::System::Boolean reverse; // 0x0
		::System::Collections::Generic::List_1<::System::ValueTuple_2<T, TView>>* list; // 0x0
