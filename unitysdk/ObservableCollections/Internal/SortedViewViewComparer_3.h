...
{
	inline static constexpr unsigned int SortedViewViewComparer_3_TypeDefinitionIndex = 25697;

	template <typename T, typename TKey, typename TView>
	class SortedViewViewComparer_3 : public ::System::Object
	{
	public:
		::ObservableCollections::IObservableCollection_1<T>* source; // 0x0
		::System::Func_2<T, TView>* transform; // 0x0
		::System::Func_2<T, TKey>* identitySelector; // 0x0
		::System::Collections::Generic::Dictionary_2<TKey, TView>* viewMap; // 0x0
		::System::Collections::Generic::SortedList_2<::System::ValueTuple_2<TView, TKey>, ::System::ValueTuple_2<T, TView>>* list; // 0x0
