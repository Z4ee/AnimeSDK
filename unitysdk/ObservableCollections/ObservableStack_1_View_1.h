...
namespace ObservableCollections { template <typename T> class ObservableStack_1; }
...
{
	inline static constexpr unsigned int ObservableStack_1_View_1_TypeDefinitionIndex = 28157;

	template <typename T, typename TView>
	class ObservableStack_1_View_1 : public ::System::Object
	{
	public:
		::ObservableCollections::ObservableStack_1<T>* source; // 0x0
		::System::Func_2<T, TView>* selector; // 0x0
		::System::Boolean reverse; // 0x0
		::System::Collections::Generic::Stack_1<::System::ValueTuple_2<T, TView>>* stack; // 0x0
