...
#define CLASS_1_DDDB57AA67C3A9EA_GET_DELAYCHANGEDATA_OFFSET UNITYSDK_OFFSET(0x156EC2C0)
#define CLASS_1_DDDB57AA67C3A9EA_GET_PENDINGINSERTABILITYPRIORITY_OFFSET UNITYSDK_OFFSET(0x156EC1E0)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_107247B6331E64C6_OFFSET UNITYSDK_OFFSET(0x156EC180)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x156EC420)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x156EC200)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_38CF1CC114148ECD_OFFSET UNITYSDK_OFFSET(0x156EC520)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x156EC3D0)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_483ECA2AADCA9775_OFFSET UNITYSDK_OFFSET(0x156EC2E0)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_4E2BCE3C8705DF5E_OFFSET UNITYSDK_OFFSET(0x156EC770)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_7F99DD204643D534_OFFSET UNITYSDK_OFFSET(0x156ECD90)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x156EC260)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_95780ED94B90ED36_1_OFFSET UNITYSDK_OFFSET(0x156ECB90)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x156EC800)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_97F6923D7612A0EB_OFFSET UNITYSDK_OFFSET(0x156EC870)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_984AC483B8A24BF2_OFFSET UNITYSDK_OFFSET(0x156ECD40)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_ADF4AD3331B4D7AD_OFFSET UNITYSDK_OFFSET(0x156ECCF0)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_BFC42181680DB9D3_OFFSET UNITYSDK_OFFSET(0x156ECC00)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x156EC380)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_E7498AF04E8E685D_OFFSET UNITYSDK_OFFSET(0x156EC5E0)
#define CLASS_1_DDDB57AA67C3A9EA_SET_DELAYCHANGEDATA_OFFSET UNITYSDK_OFFSET(0x156EC2D0)
#define CLASS_1_DDDB57AA67C3A9EA_SET_PENDINGINSERTABILITYPRIORITY_OFFSET UNITYSDK_OFFSET(0x156EC1F0)
#define CLASS_1_DDDB57AA67C3A9EA__CCTOR_OFFSET UNITYSDK_OFFSET(0x156ECEB0)
#define CLASS_1_DDDB57AA67C3A9EA__CTOR_OFFSET UNITYSDK_OFFSET(0x156EC670)

inline static constexpr unsigned int Class_1_DDDB57AA67C3A9EA_TypeDefinitionIndex = 71188;
...
public:
	...
	{
		return (::RPG::GameCore::StringHash*)Il2CppClass::FromTypeDefinitionIndex(Class_1_DDDB57AA67C3A9EA_TypeDefinitionIndex)->GetStaticField(0xBE40);
	}
	static ::RPG::GameCore::StringHash* StaticGet_CPHFKNEPFMM()
	{
		return (::RPG::GameCore::StringHash*)Il2CppClass::FromTypeDefinitionIndex(Class_1_DDDB57AA67C3A9EA_TypeDefinitionIndex)->GetStaticField(0xBE44);
	}
	static ::System::UInt32* StaticGet_BPGAHELKDDC()
	{
		return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_DDDB57AA67C3A9EA_TypeDefinitionIndex)->GetStaticField(0xBE48);
	}
	// static const ::System::String* PLCIENDOJFJ; // 0x0
	::RPG::GameCore::GameEntity* GGKGFABFGFE; // 0x10
	::RPG::GameCore::ActionBarUIConfig* JBKNKBCCNPA; // 0x18
	::Class_1_6CE70F4211D79CD5_9* _DelayChangeData_k__BackingField; // 0x20
	::Class_1_DDDB57AA67C3A9EA* OFCLNGHDFEG; // 0x28
	::Class_1_152140BAFD2DB102* JHLCIJPFLGG; // 0x30
	::RPG::Client::ActionItemType LINLNNHIBAK; // 0x38
	::RPG::Client::ActionItemStatus FFEPLIHOFLA; // 0x3C
	::System::Int32 GGEIJACCPCK; // 0x40
	::RPG::Client::ActionBarItemAction MOEAIFDPOPI; // 0x44
	::Struct_2_157CBCDCB45BE900 HCMHENAMLCD; // 0x48
	::System::Boolean EJOCCPGEIPI; // 0xD8
	::System::Boolean DFHHKFNDECI; // 0xD9
	::System::Int32 APJPPDLHEBO; // 0xDC
	::System::UInt32 LCHLDHNIILN; // 0xE0
	::System::Int32 _PendingInsertAbilityPriority_k__BackingField; // 0xE4
