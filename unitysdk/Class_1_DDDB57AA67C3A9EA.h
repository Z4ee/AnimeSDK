...
#define CLASS_1_DDDB57AA67C3A9EA_GET_DELAYCHANGEDATA_OFFSET UNITYSDK_OFFSET(0x138B6F30)
#define CLASS_1_DDDB57AA67C3A9EA_GET_PENDINGINSERTABILITYPRIORITY_OFFSET UNITYSDK_OFFSET(0x138B6E50)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_115AC51E73D999C8_OFFSET UNITYSDK_OFFSET(0x138B6DC0)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_1D4018D4200358D0_1_OFFSET UNITYSDK_OFFSET(0x138B7050)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x138B6E70)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_483ECA2AADCA9775_OFFSET UNITYSDK_OFFSET(0x138B6F50)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_4E2BCE3C8705DF5E_OFFSET UNITYSDK_OFFSET(0x138B7340)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_7F99DD204643D534_OFFSET UNITYSDK_OFFSET(0x138B7900)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x138B6ED0)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_95780ED94B90ED36_1_OFFSET UNITYSDK_OFFSET(0x138B7700)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x138B73D0)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_97F6923D7612A0EB_OFFSET UNITYSDK_OFFSET(0x138B7440)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_984AC483B8A24BF2_OFFSET UNITYSDK_OFFSET(0x138B78B0)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_AC9A0FDB80EBAAB2_OFFSET UNITYSDK_OFFSET(0x138B7120)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_ADF4AD3331B4D7AD_OFFSET UNITYSDK_OFFSET(0x138B7860)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_BFC42181680DB9D3_OFFSET UNITYSDK_OFFSET(0x138B7770)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x138B6FF0)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_E7498AF04E8E685D_OFFSET UNITYSDK_OFFSET(0x138B71B0)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x138B7040)
#define CLASS_1_DDDB57AA67C3A9EA_SET_DELAYCHANGEDATA_OFFSET UNITYSDK_OFFSET(0x138B6F40)
#define CLASS_1_DDDB57AA67C3A9EA_SET_PENDINGINSERTABILITYPRIORITY_OFFSET UNITYSDK_OFFSET(0x138B6E60)
#define CLASS_1_DDDB57AA67C3A9EA__CCTOR_OFFSET UNITYSDK_OFFSET(0x138B7A20)
#define CLASS_1_DDDB57AA67C3A9EA__CTOR_OFFSET UNITYSDK_OFFSET(0x138B7240)

inline static constexpr unsigned int Class_1_DDDB57AA67C3A9EA_TypeDefinitionIndex = 66578;
...
public:
	...
	{
		return (::RPG::GameCore::StringHash*)Il2CppClass::FromTypeDefinitionIndex(Class_1_DDDB57AA67C3A9EA_TypeDefinitionIndex)->GetStaticField(0x135E0);
	}
	static ::RPG::GameCore::StringHash* StaticGet_Field_1_1()
	{
		return (::RPG::GameCore::StringHash*)Il2CppClass::FromTypeDefinitionIndex(Class_1_DDDB57AA67C3A9EA_TypeDefinitionIndex)->GetStaticField(0x135E4);
	}
	static ::System::UInt32* StaticGet_Field_1_2()
	{
		return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_DDDB57AA67C3A9EA_TypeDefinitionIndex)->GetStaticField(0x135E8);
	}
	// static const ::System::String* Field_1_3; // 0x0
	::Class_1_152140BAFD2DB102* Field_1_4; // 0x10
	::RPG::GameCore::GameEntity* Field_1_5; // 0x18
	::Class_1_DDDB57AA67C3A9EA* Field_1_6; // 0x20
	::Class_1_6CE70F4211D79CD5_9* _DelayChangeData_k__BackingField; // 0x28
	::RPG::GameCore::ActionBarUIConfig* Field_1_8; // 0x30
	::RPG::Client::ActionItemType Field_1_9; // 0x38
	::System::Int32 Field_1_10; // 0x3C
	::Struct_2_157CBCDCB45BE900 Field_1_11; // 0x40
	::RPG::Client::ActionItemStatus Field_1_12; // 0xD0
	::System::UInt32 Field_1_13; // 0xD4
	...
	::RPG::GameCore::FixPoint Method_1_AC9A0FDB80EBAAB2()
	{
		return ((::RPG::GameCore::FixPoint(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_DDDB57AA67C3A9EA_METHOD_1_AC9A0FDB80EBAAB2_OFFSET))(this);
	}
