...
#define LAYERSTATECOUNT_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x118E5B90)
#define LAYERSTATECOUNT_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x118E5DD0)
#define LAYERSTATECOUNT_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x118E5C80)
#define LAYERSTATECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x118E5E90)
#define LAYERSTATECOUNT___IFIXBASEPROXY_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x118E5EA0)
#define LAYERSTATECOUNT___IFIXBASEPROXY_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x118E5EC0)
#define LAYERSTATECOUNT___IFIXBASEPROXY_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x118E5EB0)

inline static constexpr unsigned int LayerStateCount_TypeDefinitionIndex = 38181;
