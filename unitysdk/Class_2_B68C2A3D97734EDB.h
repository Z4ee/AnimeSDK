...
#define CLASS_2_B68C2A3D97734EDB_METHOD_2_B235E757922104A8_OFFSET UNITYSDK_OFFSET(0x1AA575C0)
#define CLASS_2_B68C2A3D97734EDB_METHOD_2_C7BF9C1E6A78DCAB_OFFSET UNITYSDK_OFFSET(0x1AA57360)
#define CLASS_2_B68C2A3D97734EDB_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1AA57790)
#define CLASS_2_B68C2A3D97734EDB_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0x1AA57920)
#define CLASS_2_B68C2A3D97734EDB_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1AA57870)
#define CLASS_2_B68C2A3D97734EDB_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1AA56F60)
#define CLASS_2_B68C2A3D97734EDB__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA579D0)
...
public:
	...
	::UnityEngine::AnimationClip* EHAGPHLMPEJ; // 0x10
	::UnityEngine::Camera* IEMGKEFBPCG; // 0x18
	::UnityEngine::Camera* DMBMOHJLNEN; // 0x20
	::UnityEngine::GameObject* KNGMBOLJFPN; // 0x28
	::System::Double NPINECOCALC; // 0x30
	::System::Single ELCCJDOLGNG; // 0x38
	::System::Boolean NINHNNILLLF; // 0x3C
	::System::Boolean DNFOKAPGFHA; // 0x3D
	::UnityEngine::Vector3 BBFOLEOPPPL; // 0x40
	::System::Single GJDEGANOCCO; // 0x4C
