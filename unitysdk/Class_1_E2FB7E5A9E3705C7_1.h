...
#define CLASS_1_E2FB7E5A9E3705C7_1_GET_AVATARICONPATH_OFFSET UNITYSDK_OFFSET(0x15490AE0)
#define CLASS_1_E2FB7E5A9E3705C7_1_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0x15490AC0)
#define CLASS_1_E2FB7E5A9E3705C7_1_GET_BOARDAVATARICONPATH_OFFSET UNITYSDK_OFFSET(0x15490B00)
#define CLASS_1_E2FB7E5A9E3705C7_1_GET_COMMONTALK_OFFSET UNITYSDK_OFFSET(0x15490B40)
#define CLASS_1_E2FB7E5A9E3705C7_1_GET_STARTTALK_OFFSET UNITYSDK_OFFSET(0x15490B60)
#define CLASS_1_E2FB7E5A9E3705C7_1_GET_VICTORYTALK_OFFSET UNITYSDK_OFFSET(0x15490B20)
#define CLASS_1_E2FB7E5A9E3705C7_1_SET_AVATARICONPATH_OFFSET UNITYSDK_OFFSET(0x15490AF0)
#define CLASS_1_E2FB7E5A9E3705C7_1_SET_AVATARID_OFFSET UNITYSDK_OFFSET(0x15490AD0)
#define CLASS_1_E2FB7E5A9E3705C7_1_SET_BOARDAVATARICONPATH_OFFSET UNITYSDK_OFFSET(0x15490B10)
#define CLASS_1_E2FB7E5A9E3705C7_1_SET_COMMONTALK_OFFSET UNITYSDK_OFFSET(0x15490B50)
#define CLASS_1_E2FB7E5A9E3705C7_1_SET_STARTTALK_OFFSET UNITYSDK_OFFSET(0x15490B70)
#define CLASS_1_E2FB7E5A9E3705C7_1_SET_VICTORYTALK_OFFSET UNITYSDK_OFFSET(0x15490B30)
#define CLASS_1_E2FB7E5A9E3705C7_1__CTOR_OFFSET UNITYSDK_OFFSET(0x15490B80)
...
public:
	...
	::RPG::Client::TextID _CommonTalk_k__BackingField; // 0x20
	::System::UInt32 _AvatarID_k__BackingField; // 0x30
	::RPG::Client::TextID _VictoryTalk_k__BackingField; // 0x38
	::RPG::Client::TextID _StartTalk_k__BackingField; // 0x48
