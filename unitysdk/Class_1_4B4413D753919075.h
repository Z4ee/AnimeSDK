...
#define CLASS_1_4B4413D753919075_METHOD_1_009AE7772C206756_OFFSET UNITYSDK_OFFSET(0x17DB8D60)
#define CLASS_1_4B4413D753919075_METHOD_1_1F6182100767BE0D_OFFSET UNITYSDK_OFFSET(0x17DB9950)
#define CLASS_1_4B4413D753919075_METHOD_1_21378A7EB1BCB13B_OFFSET UNITYSDK_OFFSET(0x17DB8E10)
#define CLASS_1_4B4413D753919075_METHOD_1_341ADB940EA251D7_OFFSET UNITYSDK_OFFSET(0x17DB86C0)
#define CLASS_1_4B4413D753919075_METHOD_1_568AE7A1499723FD_OFFSET UNITYSDK_OFFSET(0x17DB9CB0)
#define CLASS_1_4B4413D753919075_METHOD_1_5AE155640BE85A22_OFFSET UNITYSDK_OFFSET(0x17DB9FD0)
#define CLASS_1_4B4413D753919075_METHOD_1_6B13A04D4995E40F_OFFSET UNITYSDK_OFFSET(0x17DB89C0)
#define CLASS_1_4B4413D753919075_METHOD_1_73BBF288E84F41B7_OFFSET UNITYSDK_OFFSET(0x17DB85A0)
#define CLASS_1_4B4413D753919075_METHOD_1_814B2B0F621DA493_OFFSET UNITYSDK_OFFSET(0x17DB9820)
#define CLASS_1_4B4413D753919075_METHOD_1_B67408574BF18406_OFFSET UNITYSDK_OFFSET(0x17DB9E10)
#define CLASS_1_4B4413D753919075_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x17DB9DC0)
#define CLASS_1_4B4413D753919075_METHOD_1_CF3C24A8060C2F99_OFFSET UNITYSDK_OFFSET(0x17DB8C20)
#define CLASS_1_4B4413D753919075_METHOD_1_DFEC27F1F6CA5A80_OFFSET UNITYSDK_OFFSET(0x17DB90A0)
#define CLASS_1_4B4413D753919075_METHOD_1_E9A575D18A0748D9_OFFSET UNITYSDK_OFFSET(0x17DB9D70)
#define CLASS_1_4B4413D753919075_METHOD_1_FDC75E773C3424A0_OFFSET UNITYSDK_OFFSET(0x17DB88B0)
#define CLASS_1_4B4413D753919075__CCTOR_OFFSET UNITYSDK_OFFSET(0x17DBA0C0)
#define CLASS_1_4B4413D753919075__CTOR_OFFSET UNITYSDK_OFFSET(0x17DB8430)

inline static constexpr unsigned int Class_1_4B4413D753919075_TypeDefinitionIndex = 73730;
...
public:
	...
	{
		return (::RPG::Client::RPGProfilerMarker**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4B4413D753919075_TypeDefinitionIndex)->GetStaticField(0xB620);
	}
	static ::System::Int32* StaticGet_BHCOGGFLBCP()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_4B4413D753919075_TypeDefinitionIndex)->GetStaticField(0x2750);
	}
	// static const ::System::Int32 MHBACHLLFFA = 0xF; // 0x0
	// static const ::System::Int32 GKJFFHAABLK = 0x1; // 0x0
	::System::Collections::Generic::List_1<::Class_1_8A6989C352B0F0F0*>* GMBIOLIAPDD; // 0x10
	::System::Collections::Generic::LinkedList_1<::Class_1_8A6989C352B0F0F0*>* BAFPJNKHFFB; // 0x18
	::Class_1_303D5A33D1401D59* KDLDKNBOFBN; // 0x20
	::System::Collections::Generic::List_1<::System::Collections::Generic::LinkedListNode_1<::Class_1_8A6989C352B0F0F0*>*>* MKFLEJIFBLL; // 0x28
	::Class_2_4346854BFC7E4C60* CBLNBBGKEFM; // 0x30
	::RPG::Client::LinkedNodeInstancePool_1<::Class_1_8A6989C352B0F0F0*>* LBHDLGPCFFF; // 0x38
	::System::Collections::Generic::Dictionary_2<::RPG::Client::OpenWorld::StreamingItemData*, ::System::Collections::Generic::LinkedListNode_1<::Class_1_8A6989C352B0F0F0*>*>* KIBMLJBELJB; // 0x40
	::Class_1_7EC3ECF7D604F64D* OOFIFJJMNJM; // 0x48
