...
#define STRUCT_2_1A84C744BF703CC0_COMPARETO_OFFSET UNITYSDK_OFFSET(0x7C3420)
#define STRUCT_2_1A84C744BF703CC0_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x7C3520)
#define STRUCT_2_1A84C744BF703CC0_EQUALS_OFFSET UNITYSDK_OFFSET(0x7C34B0)
#define STRUCT_2_1A84C744BF703CC0_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7C3530)
#define STRUCT_2_1A84C744BF703CC0_METHOD_2_51BB781957D7506D_OFFSET UNITYSDK_OFFSET(0x12ED46C0)
#define STRUCT_2_1A84C744BF703CC0_METHOD_2_6D0360BD23602584_OFFSET UNITYSDK_OFFSET(0x7C35F0)
#define STRUCT_2_1A84C744BF703CC0_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x7C3590)
#define STRUCT_2_1A84C744BF703CC0_METHOD_2_F3A11A82F954C854_OFFSET UNITYSDK_OFFSET(0x12ED47E0)
#define STRUCT_2_1A84C744BF703CC0__CCTOR_OFFSET UNITYSDK_OFFSET(0x12ED46B0)

inline static constexpr unsigned int Struct_2_1A84C744BF703CC0_TypeDefinitionIndex = 75302;

struct alignas(8) Struct_2_1A84C744BF703CC0
{
	static ::Struct_2_1A84C744BF703CC0* StaticGet_Field_2_2()
	{
		return (::Struct_2_1A84C744BF703CC0*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_1A84C744BF703CC0_TypeDefinitionIndex)->GetStaticField(0x10560);
	}
