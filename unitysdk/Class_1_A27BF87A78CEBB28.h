...
#define CLASS_1_A27BF87A78CEBB28__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1987A690)
#define CLASS_1_A27BF87A78CEBB28__CTOR_OFFSET UNITYSDK_OFFSET(0x1987A670)
...
public:
	...
	::Class_1_2A2B2DC1DA1205FE* BJOANNFMNEO; // 0x18
	::UnityEngine::Vector3 KKLDLLOJEFN; // 0x20
	::RPG::Client::AimEntityInfoType HGIABLHMGPB; // 0x2C
	::RPG::GameCore::PhotoGraphAimIdentifyType BDHPOJCKPIM; // 0x30
