...
#define CLASS_1_8AE7A2C15AA5D5A0_METHOD_1_2B5077F1F7E1182E_OFFSET UNITYSDK_OFFSET(0xF98AE60)
#define CLASS_1_8AE7A2C15AA5D5A0_METHOD_1_8DA2C45C7019FA48_OFFSET UNITYSDK_OFFSET(0xF98AFD0)
#define CLASS_1_8AE7A2C15AA5D5A0_METHOD_1_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0xF98B0F0)
#define CLASS_1_8AE7A2C15AA5D5A0_METHOD_1_E06ECA39EB16C571_OFFSET UNITYSDK_OFFSET(0xF98B130)
#define CLASS_1_8AE7A2C15AA5D5A0_METHOD_1_E21AC6EE08DC160A_OFFSET UNITYSDK_OFFSET(0xF98ACC0)
#define CLASS_1_8AE7A2C15AA5D5A0__CTOR_OFFSET UNITYSDK_OFFSET(0xF98ACB0)

inline static constexpr unsigned int Class_1_8AE7A2C15AA5D5A0_TypeDefinitionIndex = 59516;
...
public:
	...
	{
		return (::Class_2_07A2E3D9266E9604**)Il2CppClass::FromTypeDefinitionIndex(Class_1_8AE7A2C15AA5D5A0_TypeDefinitionIndex)->GetStaticField(0x48AA0);
	}
