...
#define AKBANKMANAGER_DOUNLOADBANKS_OFFSET UNITYSDK_OFFSET(0x1B41B270)
#define AKBANKMANAGER_ISBANKLOADED_OFFSET UNITYSDK_OFFSET(0x1B41C2B0)
#define AKBANKMANAGER_LOADBANKASYNC_OFFSET UNITYSDK_OFFSET(0x1B40DB40)
#define AKBANKMANAGER_LOADBANK_OFFSET UNITYSDK_OFFSET(0x1B40D710)
#define AKBANKMANAGER_LOADINITBANK_OFFSET UNITYSDK_OFFSET(0x1B41BAB0)
#define AKBANKMANAGER_RELOADALLBANKS_OFFSET UNITYSDK_OFFSET(0x1B41B530)
#define AKBANKMANAGER_RESET_OFFSET UNITYSDK_OFFSET(0x1B41B420)
#define AKBANKMANAGER_UNLOADBANK_OFFSET UNITYSDK_OFFSET(0x1B40DF30)
#define AKBANKMANAGER_UNLOADINITBANK_OFFSET UNITYSDK_OFFSET(0x1B41B960)
#define AKBANKMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B41C490)

inline static constexpr unsigned int AkBankManager_TypeDefinitionIndex = 41198;
...
public:
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::System::String*, ::AkBankManager_BankHandle*>**)Il2CppClass::FromTypeDefinitionIndex(AkBankManager_TypeDefinitionIndex)->GetStaticField(0x5C6C0);
	}
	static ::System::Collections::Generic::List_1<::AkBankManager_BankHandle*>** StaticGet_BanksToUnload()
	{
		return (::System::Collections::Generic::List_1<::AkBankManager_BankHandle*>**)Il2CppClass::FromTypeDefinitionIndex(AkBankManager_TypeDefinitionIndex)->GetStaticField(0x5C6C8);
	}
