...
#define CLASS_2_9257E9613AEDAD2B_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA702930)
#define CLASS_2_9257E9613AEDAD2B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xA702970)
#define CLASS_2_9257E9613AEDAD2B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xA702B20)
#define CLASS_2_9257E9613AEDAD2B_TICK_OFFSET UNITYSDK_OFFSET(0xA702B70)
#define CLASS_2_9257E9613AEDAD2B__CTOR_OFFSET UNITYSDK_OFFSET(0xA702920)

inline static constexpr unsigned int Class_2_9257E9613AEDAD2B_TypeDefinitionIndex = 47204;

class Class_2_9257E9613AEDAD2B : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SetAsRogueDialogue* Field_2_0; // 0x18
