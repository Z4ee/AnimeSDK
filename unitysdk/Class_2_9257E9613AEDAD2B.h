...
#define CLASS_2_9257E9613AEDAD2B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16B044B0)
#define CLASS_2_9257E9613AEDAD2B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16B044F0)
#define CLASS_2_9257E9613AEDAD2B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x16B046A0)
#define CLASS_2_9257E9613AEDAD2B_TICK_OFFSET UNITYSDK_OFFSET(0x16B046F0)
#define CLASS_2_9257E9613AEDAD2B__CTOR_OFFSET UNITYSDK_OFFSET(0x16B044A0)

inline static constexpr unsigned int Class_2_9257E9613AEDAD2B_TypeDefinitionIndex = 58658;

class Class_2_9257E9613AEDAD2B : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SetAsRogueDialogue* OFKGLJOAMLD; // 0x18
