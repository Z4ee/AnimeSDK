...
#define CLASS_1_975345FDA78BFE56__CTOR_OFFSET UNITYSDK_OFFSET(0x19D48F50)
...
{
public:
	::RPG::GameCore::DiceCombatIgnoreDefendPointType PCBNGAJDNGD; // 0x10
	::System::Int32 CIIBJHAMJCK; // 0x14
