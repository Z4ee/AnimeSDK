...
#define SROPTIONS_INCREMENTATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x8E52760)

inline static constexpr unsigned int SROptions_IncrementAttribute_TypeDefinitionIndex = 40924;
