...
#define CLASS_2_F0036DA2B4B7E9C1_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAEF7940)
#define CLASS_2_F0036DA2B4B7E9C1_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xAEF7AD0)
#define CLASS_2_F0036DA2B4B7E9C1_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xAEF7B50)
#define CLASS_2_F0036DA2B4B7E9C1_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xAEF79C0)
#define CLASS_2_F0036DA2B4B7E9C1_TICK_OFFSET UNITYSDK_OFFSET(0xAEF7A10)
#define CLASS_2_F0036DA2B4B7E9C1__CTOR_OFFSET UNITYSDK_OFFSET(0xAEF7930)

inline static constexpr unsigned int Class_2_F0036DA2B4B7E9C1_TypeDefinitionIndex = 49537;
