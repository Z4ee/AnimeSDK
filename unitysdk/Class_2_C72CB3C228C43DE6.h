...
#define CLASS_2_C72CB3C228C43DE6_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x179C7F30)
#define CLASS_2_C72CB3C228C43DE6_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x179C8050)
#define CLASS_2_C72CB3C228C43DE6_METHOD_2_1F130271093617A5_OFFSET UNITYSDK_OFFSET(0x179C7910)
#define CLASS_2_C72CB3C228C43DE6_METHOD_2_4E6F72124EC1C84B_OFFSET UNITYSDK_OFFSET(0x179C7D00)
#define CLASS_2_C72CB3C228C43DE6_METHOD_2_8F3F5DB4D7DE476B_OFFSET UNITYSDK_OFFSET(0x179C7D80)
#define CLASS_2_C72CB3C228C43DE6_METHOD_2_99D60EF23C904C6D_OFFSET UNITYSDK_OFFSET(0x179C77D0)
#define CLASS_2_C72CB3C228C43DE6_METHOD_2_E693A0026D178D8E_OFFSET UNITYSDK_OFFSET(0x179C7C20)
#define CLASS_2_C72CB3C228C43DE6_METHOD_2_F37CDBD6D46274D2_1_OFFSET UNITYSDK_OFFSET(0x179C7EA0)
#define CLASS_2_C72CB3C228C43DE6_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x179C7E10)
#define CLASS_2_C72CB3C228C43DE6__CTOR_OFFSET UNITYSDK_OFFSET(0x179C8140)
#define CLASS_2_C72CB3C228C43DE6__ONBIND_OFFSET UNITYSDK_OFFSET(0x179C76B0)

inline static constexpr unsigned int Class_2_C72CB3C228C43DE6_TypeDefinitionIndex = 71762;
...
public:
	...
	::UnityEngine::Transform* FKCDFLJLPCA; // 0x68
	::RPG::Client::DiscreteBar* DEILOFCIGJF; // 0x70
	::UnityEngine::Transform* KGMDBKMPJIL; // 0x78
