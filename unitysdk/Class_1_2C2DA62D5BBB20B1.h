...
#define CLASS_1_2C2DA62D5BBB20B1_CLEAR_OFFSET UNITYSDK_OFFSET(0xC30F580)
#define CLASS_1_2C2DA62D5BBB20B1_COMPARETO_OFFSET UNITYSDK_OFFSET(0xC30F7A0)
#define CLASS_1_2C2DA62D5BBB20B1_METHOD_1_42D74E8C949A6883_OFFSET UNITYSDK_OFFSET(0xC30F880)
#define CLASS_1_2C2DA62D5BBB20B1_METHOD_1_4D606E0EBD8E195C_OFFSET UNITYSDK_OFFSET(0xC30F610)
#define CLASS_1_2C2DA62D5BBB20B1_METHOD_1_A27D39E06AC34DD9_OFFSET UNITYSDK_OFFSET(0xC30EDF0)
#define CLASS_1_2C2DA62D5BBB20B1_METHOD_1_D8BF40F27BE9947D_OFFSET UNITYSDK_OFFSET(0xC30ED10)
#define CLASS_1_2C2DA62D5BBB20B1_METHOD_1_E0BE53945D089B15_OFFSET UNITYSDK_OFFSET(0xC30F2B0)
#define CLASS_1_2C2DA62D5BBB20B1_METHOD_1_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0xC30EDD0)
#define CLASS_1_2C2DA62D5BBB20B1_METHOD_1_F0088C88851A7DFB_2_OFFSET UNITYSDK_OFFSET(0xC30EDE0)
#define CLASS_1_2C2DA62D5BBB20B1_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xC30EDC0)
#define CLASS_1_2C2DA62D5BBB20B1_TOSTRING_OFFSET UNITYSDK_OFFSET(0xC30EF00)
#define CLASS_1_2C2DA62D5BBB20B1__CTOR_OFFSET UNITYSDK_OFFSET(0xC30F900)
...
public:
	...
	::System::String* AGNDDHOLJNL; // 0x10
	::System::String* KNJEFFPKCFD; // 0x18
	::System::Action* DPANHIICMLD; // 0x20
	::Collections::Pooled::PooledList_1<::Class_1_F860364065044F08*>* NPENGFBHFJN; // 0x28
	::System::UInt32 AJCPOOCBNNH; // 0x30
	::Class_1_2C2DA62D5BBB20B1_PreloadType KGJAPOONHOD; // 0x34
	::RPG::GameCore::PreloadGroupType HBEDCNGOIMI; // 0x38
	::Class_1_2C2DA62D5BBB20B1_PreloadType IJCGJAGCGMO; // 0x3C
	::Class_1_2C2DA62D5BBB20B1_PreloadItemState MEPFOEEGBEA; // 0x40
	::RPG::Client::PreloadItemFlag FNPGDNFLMPC; // 0x44
	::System::Single MNAKIEOGPDK; // 0x48
