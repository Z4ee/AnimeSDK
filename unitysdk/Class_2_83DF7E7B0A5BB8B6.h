...
#define CLASS_2_83DF7E7B0A5BB8B6_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCED69A0)
#define CLASS_2_83DF7E7B0A5BB8B6_METHOD_2_4DA6D4A624E42CAB_OFFSET UNITYSDK_OFFSET(0xCED6B00)
#define CLASS_2_83DF7E7B0A5BB8B6_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xCED6A40)
#define CLASS_2_83DF7E7B0A5BB8B6_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xCED69F0)
#define CLASS_2_83DF7E7B0A5BB8B6_TICK_OFFSET UNITYSDK_OFFSET(0xCED6B80)
#define CLASS_2_83DF7E7B0A5BB8B6__CTOR_OFFSET UNITYSDK_OFFSET(0xCED6990)

inline static constexpr unsigned int Class_2_83DF7E7B0A5BB8B6_TypeDefinitionIndex = 52131;
