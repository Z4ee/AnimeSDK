...
#define CLASS_2_DFC3EFB2BCCFA5C4_DISPOSE_OFFSET UNITYSDK_OFFSET(0x117A3190)
#define CLASS_2_DFC3EFB2BCCFA5C4_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x117A3040)
#define CLASS_2_DFC3EFB2BCCFA5C4_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x117A3140)
#define CLASS_2_DFC3EFB2BCCFA5C4_TICK_OFFSET UNITYSDK_OFFSET(0x117A31F0)
#define CLASS_2_DFC3EFB2BCCFA5C4__CTOR_OFFSET UNITYSDK_OFFSET(0x117A3030)

inline static constexpr unsigned int Class_2_DFC3EFB2BCCFA5C4_TypeDefinitionIndex = 47063;
