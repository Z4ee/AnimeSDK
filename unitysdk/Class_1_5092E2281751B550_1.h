...
#define CLASS_1_5092E2281751B550_1_GET_ACHIEVEMENTIDLIST_OFFSET UNITYSDK_OFFSET(0x15A6A8C0)
#define CLASS_1_5092E2281751B550_1_GET_ALLYOUTPUTNUM_OFFSET UNITYSDK_OFFSET(0x15A6A900)
#define CLASS_1_5092E2281751B550_1_GET_ALLYPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0x15A6AA60)
#define CLASS_1_5092E2281751B550_1_GET_BREAKRECORD_OFFSET UNITYSDK_OFFSET(0x15A6A920)
#define CLASS_1_5092E2281751B550_1_GET_BREAKWAVECOUNTRECORD_OFFSET UNITYSDK_OFFSET(0x15A6A940)
#define CLASS_1_5092E2281751B550_1_GET_BRICKCOUNT_OFFSET UNITYSDK_OFFSET(0x15A6AAC0)
#define CLASS_1_5092E2281751B550_1_GET_CASTSKILLINFOLIST_OFFSET UNITYSDK_OFFSET(0x15A6A880)
#define CLASS_1_5092E2281751B550_1_GET_DEADCOUNT_OFFSET UNITYSDK_OFFSET(0x15A6A840)
#define CLASS_1_5092E2281751B550_1_GET_EXPOBTAINED_OFFSET UNITYSDK_OFFSET(0x15A6A9C0)
#define CLASS_1_5092E2281751B550_1_GET_FIRSTPASS_OFFSET UNITYSDK_OFFSET(0x15A6AA00)
#define CLASS_1_5092E2281751B550_1_GET_HEIGHTLINECOUNT_OFFSET UNITYSDK_OFFSET(0x15A6A860)
#define CLASS_1_5092E2281751B550_1_GET_ISPVPMODE_OFFSET UNITYSDK_OFFSET(0x15A6AA80)
#define CLASS_1_5092E2281751B550_1_GET_LEVELGAMEMODE_OFFSET UNITYSDK_OFFSET(0x15A6AAA0)
#define CLASS_1_5092E2281751B550_1_GET_PLAYEROUTPUTNUM_OFFSET UNITYSDK_OFFSET(0x15A6A8E0)
#define CLASS_1_5092E2281751B550_1_GET_PLAYERPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0x15A6AA40)
#define CLASS_1_5092E2281751B550_1_GET_PREVEXTRAEXP_OFFSET UNITYSDK_OFFSET(0x15A6A980)
#define CLASS_1_5092E2281751B550_1_GET_PREVLEVELTOTALEXP_OFFSET UNITYSDK_OFFSET(0x15A6A9A0)
#define CLASS_1_5092E2281751B550_1_GET_PREVLEVEL_OFFSET UNITYSDK_OFFSET(0x15A6A960)
#define CLASS_1_5092E2281751B550_1_GET_SETTLEEXPINFOLIST_OFFSET UNITYSDK_OFFSET(0x15A6AA20)
#define CLASS_1_5092E2281751B550_1_GET_SILVERWOLFEXTRAEXP_OFFSET UNITYSDK_OFFSET(0x15A6A9E0)
#define CLASS_1_5092E2281751B550_1_GET_STAGEID_OFFSET UNITYSDK_OFFSET(0x15A6A820)
#define CLASS_1_5092E2281751B550_1_GET_STARIDLIST_OFFSET UNITYSDK_OFFSET(0x15A6A8A0)
#define CLASS_1_5092E2281751B550_1_GET_SUCCESS_OFFSET UNITYSDK_OFFSET(0x15A6A800)
#define CLASS_1_5092E2281751B550_1_GET_WAVECOUNT_OFFSET UNITYSDK_OFFSET(0x15A6AAE0)
#define CLASS_1_5092E2281751B550_1_METHOD_1_13BD520B095657CC_OFFSET UNITYSDK_OFFSET(0x15A6A2B0)
#define CLASS_1_5092E2281751B550_1_METHOD_1_1D4018D4200358D0_1_OFFSET UNITYSDK_OFFSET(0x15A6AB60)
#define CLASS_1_5092E2281751B550_1_METHOD_1_1D4018D4200358D0_2_OFFSET UNITYSDK_OFFSET(0x15A6ABC0)
#define CLASS_1_5092E2281751B550_1_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x15A6AB00)
#define CLASS_1_5092E2281751B550_1_METHOD_1_842446766C7EDE9B_OFFSET UNITYSDK_OFFSET(0x15A6A250)
#define CLASS_1_5092E2281751B550_1_SET_ACHIEVEMENTIDLIST_OFFSET UNITYSDK_OFFSET(0x15A6A8D0)
#define CLASS_1_5092E2281751B550_1_SET_ALLYOUTPUTNUM_OFFSET UNITYSDK_OFFSET(0x15A6A910)
#define CLASS_1_5092E2281751B550_1_SET_ALLYPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0x15A6AA70)
#define CLASS_1_5092E2281751B550_1_SET_BREAKRECORD_OFFSET UNITYSDK_OFFSET(0x15A6A930)
#define CLASS_1_5092E2281751B550_1_SET_BREAKWAVECOUNTRECORD_OFFSET UNITYSDK_OFFSET(0x15A6A950)
#define CLASS_1_5092E2281751B550_1_SET_BRICKCOUNT_OFFSET UNITYSDK_OFFSET(0x15A6AAD0)
#define CLASS_1_5092E2281751B550_1_SET_CASTSKILLINFOLIST_OFFSET UNITYSDK_OFFSET(0x15A6A890)
#define CLASS_1_5092E2281751B550_1_SET_DEADCOUNT_OFFSET UNITYSDK_OFFSET(0x15A6A850)
#define CLASS_1_5092E2281751B550_1_SET_EXPOBTAINED_OFFSET UNITYSDK_OFFSET(0x15A6A9D0)
#define CLASS_1_5092E2281751B550_1_SET_FIRSTPASS_OFFSET UNITYSDK_OFFSET(0x15A6AA10)
#define CLASS_1_5092E2281751B550_1_SET_HEIGHTLINECOUNT_OFFSET UNITYSDK_OFFSET(0x15A6A870)
#define CLASS_1_5092E2281751B550_1_SET_ISPVPMODE_OFFSET UNITYSDK_OFFSET(0x15A6AA90)
#define CLASS_1_5092E2281751B550_1_SET_LEVELGAMEMODE_OFFSET UNITYSDK_OFFSET(0x15A6AAB0)
#define CLASS_1_5092E2281751B550_1_SET_PLAYEROUTPUTNUM_OFFSET UNITYSDK_OFFSET(0x15A6A8F0)
#define CLASS_1_5092E2281751B550_1_SET_PLAYERPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0x15A6AA50)
#define CLASS_1_5092E2281751B550_1_SET_PREVEXTRAEXP_OFFSET UNITYSDK_OFFSET(0x15A6A990)
#define CLASS_1_5092E2281751B550_1_SET_PREVLEVELTOTALEXP_OFFSET UNITYSDK_OFFSET(0x15A6A9B0)
#define CLASS_1_5092E2281751B550_1_SET_PREVLEVEL_OFFSET UNITYSDK_OFFSET(0x15A6A970)
#define CLASS_1_5092E2281751B550_1_SET_SETTLEEXPINFOLIST_OFFSET UNITYSDK_OFFSET(0x15A6AA30)
#define CLASS_1_5092E2281751B550_1_SET_SILVERWOLFEXTRAEXP_OFFSET UNITYSDK_OFFSET(0x15A6A9F0)
#define CLASS_1_5092E2281751B550_1_SET_STAGEID_OFFSET UNITYSDK_OFFSET(0x15A6A830)
#define CLASS_1_5092E2281751B550_1_SET_STARIDLIST_OFFSET UNITYSDK_OFFSET(0x15A6A8B0)
#define CLASS_1_5092E2281751B550_1_SET_SUCCESS_OFFSET UNITYSDK_OFFSET(0x15A6A810)
#define CLASS_1_5092E2281751B550_1_SET_WAVECOUNT_OFFSET UNITYSDK_OFFSET(0x15A6AAF0)
#define CLASS_1_5092E2281751B550_1__CTOR_OFFSET UNITYSDK_OFFSET(0x15A6AC20)

inline static constexpr unsigned int Class_1_5092E2281751B550_1_TypeDefinitionIndex = 78568;

class Class_1_5092E2281751B550_1 : public ::System::Object
{
public:
	::RPG::Client::PlayerPlatformInfo* _AllyPlatformInfo_k__BackingField; // 0x10
	::System::Collections::Generic::List_1<::Class_1_D17272E82AE804C2_51*>* _CastSkillInfoList_k__BackingField; // 0x18
	::System::Collections::Generic::List_1<::Class_1_8831ADA1771A2099*>* _SettleExpInfoList_k__BackingField; // 0x20
	::System::Collections::Generic::List_1<::System::UInt32>* _StarIDList_k__BackingField; // 0x28
	::RPG::Client::PlayerPlatformInfo* _PlayerPlatformInfo_k__BackingField; // 0x30
	::System::Collections::Generic::List_1<::System::UInt32>* _AchievementIDList_k__BackingField; // 0x38
	::System::Boolean _BreakRecord_k__BackingField; // 0x40
	::System::Boolean _BreakWaveCountRecord_k__BackingField; // 0x41
	::System::Boolean _FirstPass_k__BackingField; // 0x42
	::System::Boolean _IsPvpMode_k__BackingField; // 0x43
	::System::UInt32 _DeadCount_k__BackingField; // 0x44
	::System::UInt32 _AllyOutputNum_k__BackingField; // 0x48
	::System::UInt32 _ExpObtained_k__BackingField; // 0x4C
	::System::UInt32 _SilverWolfExtraExp_k__BackingField; // 0x50
	::System::UInt32 _PrevExtraExp_k__BackingField; // 0x54
	::System::UInt32 _WaveCount_k__BackingField; // 0x58
	::System::UInt32 _PrevLevel_k__BackingField; // 0x5C
	::System::UInt32 _PrevLevelTotalExp_k__BackingField; // 0x60
	::System::UInt32 _StageID_k__BackingField; // 0x64
	::System::UInt32 _HeightLineCount_k__BackingField; // 0x68
	::System::UInt32 _BrickCount_k__BackingField; // 0x6C
	::System::UInt32 _PlayerOutputNum_k__BackingField; // 0x70
	::System::Boolean _Success_k__BackingField; // 0x74
	::RPG::GameCore::TeamTowersLevelGameMode _LevelGameMode_k__BackingField; // 0x75
	...
	::RPG::Client::Promises::IPromise_1<::Class_1_5092E2281751B550_1*>* Method_1_13BD520B095657CC(::Class_1_48AADA497C3F117F_3* a1)
	{
		return ((::RPG::Client::Promises::IPromise_1<::Class_1_5092E2281751B550_1*>*(*)(::PVOID, ::Class_1_48AADA497C3F117F_3*))((::PBYTE)hIl2Cpp + CLASS_1_5092E2281751B550_1_METHOD_1_13BD520B095657CC_OFFSET))(this, a1);
	}
