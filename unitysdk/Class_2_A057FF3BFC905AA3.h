...
#define CLASS_2_A057FF3BFC905AA3_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAC21510)
#define CLASS_2_A057FF3BFC905AA3_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xAC21550)
#define CLASS_2_A057FF3BFC905AA3_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xAC21820)
#define CLASS_2_A057FF3BFC905AA3_TICK_OFFSET UNITYSDK_OFFSET(0xAC21870)
#define CLASS_2_A057FF3BFC905AA3__CTOR_OFFSET UNITYSDK_OFFSET(0xAC21500)

inline static constexpr unsigned int Class_2_A057FF3BFC905AA3_TypeDefinitionIndex = 51497;

class Class_2_A057FF3BFC905AA3 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::LensDistortionCurveEffect* Field_2_1; // 0x20
