...
#define CLASS_2_A057FF3BFC905AA3_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10044C80)
#define CLASS_2_A057FF3BFC905AA3_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10044CC0)
#define CLASS_2_A057FF3BFC905AA3_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10044F60)
#define CLASS_2_A057FF3BFC905AA3_TICK_OFFSET UNITYSDK_OFFSET(0x10044FB0)
#define CLASS_2_A057FF3BFC905AA3__CTOR_OFFSET UNITYSDK_OFFSET(0x10044C70)

inline static constexpr unsigned int Class_2_A057FF3BFC905AA3_TypeDefinitionIndex = 50828;

class Class_2_A057FF3BFC905AA3 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::LensDistortionCurveEffect* Field_2_0; // 0x20
