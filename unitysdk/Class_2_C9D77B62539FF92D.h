...
#define CLASS_2_C9D77B62539FF92D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17F31D10)
#define CLASS_2_C9D77B62539FF92D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17F31D50)
#define CLASS_2_C9D77B62539FF92D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17F31F50)
#define CLASS_2_C9D77B62539FF92D_TICK_OFFSET UNITYSDK_OFFSET(0x17F31FA0)
#define CLASS_2_C9D77B62539FF92D__CTOR_OFFSET UNITYSDK_OFFSET(0x17F31D00)

inline static constexpr unsigned int Class_2_C9D77B62539FF92D_TypeDefinitionIndex = 55814;

class Class_2_C9D77B62539FF92D : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SkillPerformFinish* OFKGLJOAMLD; // 0x18
