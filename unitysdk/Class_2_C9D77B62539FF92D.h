...
#define CLASS_2_C9D77B62539FF92D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x129C8BC0)
#define CLASS_2_C9D77B62539FF92D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x129C8C00)
#define CLASS_2_C9D77B62539FF92D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x129C8D90)
#define CLASS_2_C9D77B62539FF92D_TICK_OFFSET UNITYSDK_OFFSET(0x129C8DE0)
#define CLASS_2_C9D77B62539FF92D__CTOR_OFFSET UNITYSDK_OFFSET(0x129C8BB0)

inline static constexpr unsigned int Class_2_C9D77B62539FF92D_TypeDefinitionIndex = 51285;
