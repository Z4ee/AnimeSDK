...
#define STRUCT_2_D1DB1EFC46D2DA3E_STRUCT_2_2D7A9B58CD9E378D_EXECUTE_OFFSET UNITYSDK_OFFSET(0x73DF00)
#define STRUCT_2_D1DB1EFC46D2DA3E_STRUCT_2_2D7A9B58CD9E378D__CTOR_OFFSET UNITYSDK_OFFSET(0x73DEA0)

inline static constexpr unsigned int Struct_2_D1DB1EFC46D2DA3E_Struct_2_2D7A9B58CD9E378D_TypeDefinitionIndex = 52903;

struct alignas(8) Struct_2_D1DB1EFC46D2DA3E_Struct_2_2D7A9B58CD9E378D
{
	::Struct_2_D1DB1EFC46D2DA3E Field_2_0; // 0x10
	::Foundation::Geometry::Circle2D Field_2_1; // 0xB0
	::Unity::Collections::NativeArray_1<::System::Single> Field_2_2; // 0xC0
