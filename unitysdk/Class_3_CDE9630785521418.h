...
#define CLASS_3_CDE9630785521418_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x123C47D0)
#define CLASS_3_CDE9630785521418_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x123C4820)
#define CLASS_3_CDE9630785521418_TICK_OFFSET UNITYSDK_OFFSET(0x123C4870)
#define CLASS_3_CDE9630785521418__CTOR_OFFSET UNITYSDK_OFFSET(0x123C47A0)
#define CLASS_3_CDE9630785521418___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x123C48F0)

inline static constexpr unsigned int Class_3_CDE9630785521418_TypeDefinitionIndex = 48239;
