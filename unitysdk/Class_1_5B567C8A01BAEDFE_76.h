...
#define CLASS_1_5B567C8A01BAEDFE_76_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1982C520)
#define CLASS_1_5B567C8A01BAEDFE_76_CLONE_OFFSET UNITYSDK_OFFSET(0x1982C390)
#define CLASS_1_5B567C8A01BAEDFE_76_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1982C430)
#define CLASS_1_5B567C8A01BAEDFE_76_EQUALS_OFFSET UNITYSDK_OFFSET(0x1982C3D0)
#define CLASS_1_5B567C8A01BAEDFE_76_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1982C480)
#define CLASS_1_5B567C8A01BAEDFE_76_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1982C570)
#define CLASS_1_5B567C8A01BAEDFE_76_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1982C540)
#define CLASS_1_5B567C8A01BAEDFE_76_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1982C310)
#define CLASS_1_5B567C8A01BAEDFE_76_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1982C340)
#define CLASS_1_5B567C8A01BAEDFE_76_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1982C4B0)
#define CLASS_1_5B567C8A01BAEDFE_76_WRITETO_OFFSET UNITYSDK_OFFSET(0x1982C510)
#define CLASS_1_5B567C8A01BAEDFE_76__CCTOR_OFFSET UNITYSDK_OFFSET(0x1982C5C0)
#define CLASS_1_5B567C8A01BAEDFE_76__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1982C360)
#define CLASS_1_5B567C8A01BAEDFE_76__CTOR_OFFSET UNITYSDK_OFFSET(0x1982C350)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_76_TypeDefinitionIndex = 25913;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_76*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_76_TypeDefinitionIndex)->GetStaticField(0x67030);
	}
