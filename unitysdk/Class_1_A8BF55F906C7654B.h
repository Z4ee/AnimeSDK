...
#define CLASS_1_A8BF55F906C7654B_METHOD_1_0E801852F4B4F2C3_OFFSET UNITYSDK_OFFSET(0x163BFF10)
#define CLASS_1_A8BF55F906C7654B_METHOD_1_1082279FA65C761E_OFFSET UNITYSDK_OFFSET(0x163BF800)
#define CLASS_1_A8BF55F906C7654B_METHOD_1_1AD3CAF2B0982C3F_OFFSET UNITYSDK_OFFSET(0x163C0CF0)
#define CLASS_1_A8BF55F906C7654B_METHOD_1_E2B2E1DEE99874B5_OFFSET UNITYSDK_OFFSET(0x163BFB40)
#define CLASS_1_A8BF55F906C7654B_METHOD_1_E69AA2E64A20143D_OFFSET UNITYSDK_OFFSET(0x163C05E0)
#define CLASS_1_A8BF55F906C7654B__CTOR_OFFSET UNITYSDK_OFFSET(0x163C10D0)
...
{
public:
	::RPG::Client::RPGProfilerMarker* FALLNHJEKLL; // 0x10
	::System::String* BOIJNHAFIDH; // 0x18
	::RPG::Client::RPGProfilerMarker* AABOMBAEELI; // 0x20
	::RPG::Client::RPGProfilerMarker* MHNHCBNCFPD; // 0x28
	::RPG::Client::RPGProfilerMarker* NBCPAOCIHEL; // 0x30
	::RPG::Client::RPGProfilerMarker* PBPAADBDKIO; // 0x38
	::HoudiniEngineUnity::JSONObject* EOCNNGBKFAN; // 0x40
	::RPG::Client::RPGProfilerMarker* DPBGHAPJHKC; // 0x48
