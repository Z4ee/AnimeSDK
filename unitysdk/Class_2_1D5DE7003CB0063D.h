...
#define CLASS_2_1D5DE7003CB0063D_GET_ISRUNNING_OFFSET UNITYSDK_OFFSET(0x18752210)
#define CLASS_2_1D5DE7003CB0063D_METHOD_2_102A1038C38883F3_OFFSET UNITYSDK_OFFSET(0x187522C0)
#define CLASS_2_1D5DE7003CB0063D_METHOD_2_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0x18752310)
#define CLASS_2_1D5DE7003CB0063D_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x18752560)
#define CLASS_2_1D5DE7003CB0063D__CTOR_OFFSET UNITYSDK_OFFSET(0x18752270)

inline static constexpr unsigned int Class_2_1D5DE7003CB0063D_TypeDefinitionIndex = 80906;

class Class_2_1D5DE7003CB0063D : public ::Class_1_FAF146B3D74C3C3F
{
public:
	::System::String* IIHFKAGKEMC; // 0x20
	::Class_1_049B9A4D827304A8* BGKEEIDDGOB; // 0x28
