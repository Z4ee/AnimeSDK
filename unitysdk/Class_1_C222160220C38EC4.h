...
#define CLASS_1_C222160220C38EC4_GET_ASSISTSCORE_OFFSET UNITYSDK_OFFSET(0x181B00E0)
#define CLASS_1_C222160220C38EC4_GET_AVATARLIST_OFFSET UNITYSDK_OFFSET(0x181B00C0)
#define CLASS_1_C222160220C38EC4_GET_BATTLEREPLAYKEY_OFFSET UNITYSDK_OFFSET(0x181B00A0)
#define CLASS_1_C222160220C38EC4_GET_DAMAGEHP_OFFSET UNITYSDK_OFFSET(0x181B0040)
#define CLASS_1_C222160220C38EC4_GET_DAMAGESCORE_OFFSET UNITYSDK_OFFSET(0x181B0100)
#define CLASS_1_C222160220C38EC4_GET_FINALHITSCORE_OFFSET UNITYSDK_OFFSET(0x181B0120)
#define CLASS_1_C222160220C38EC4_GET_ISFINALHIT_OFFSET UNITYSDK_OFFSET(0x181B0060)
#define CLASS_1_C222160220C38EC4_GET_OVERKILLDAMAGEHP_OFFSET UNITYSDK_OFFSET(0x181B0080)
#define CLASS_1_C222160220C38EC4_GET_UID_OFFSET UNITYSDK_OFFSET(0x181B0020)
#define CLASS_1_C222160220C38EC4_METHOD_1_A85A5A4F484E8E77_OFFSET UNITYSDK_OFFSET(0x181AFF30)
#define CLASS_1_C222160220C38EC4_METHOD_1_C37EE151D005EDA7_OFFSET UNITYSDK_OFFSET(0x181AF9C0)
#define CLASS_1_C222160220C38EC4_SET_ASSISTSCORE_OFFSET UNITYSDK_OFFSET(0x181B00F0)
#define CLASS_1_C222160220C38EC4_SET_AVATARLIST_OFFSET UNITYSDK_OFFSET(0x181B00D0)
#define CLASS_1_C222160220C38EC4_SET_BATTLEREPLAYKEY_OFFSET UNITYSDK_OFFSET(0x181B00B0)
#define CLASS_1_C222160220C38EC4_SET_DAMAGEHP_OFFSET UNITYSDK_OFFSET(0x181B0050)
#define CLASS_1_C222160220C38EC4_SET_DAMAGESCORE_OFFSET UNITYSDK_OFFSET(0x181B0110)
#define CLASS_1_C222160220C38EC4_SET_FINALHITSCORE_OFFSET UNITYSDK_OFFSET(0x181B0130)
#define CLASS_1_C222160220C38EC4_SET_ISFINALHIT_OFFSET UNITYSDK_OFFSET(0x181B0070)
#define CLASS_1_C222160220C38EC4_SET_OVERKILLDAMAGEHP_OFFSET UNITYSDK_OFFSET(0x181B0090)
#define CLASS_1_C222160220C38EC4_SET_UID_OFFSET UNITYSDK_OFFSET(0x181B0030)
#define CLASS_1_C222160220C38EC4__CTOR_OFFSET UNITYSDK_OFFSET(0x181B0010)

inline static constexpr unsigned int Class_1_C222160220C38EC4_TypeDefinitionIndex = 63774;
...
public:
	...
	::System::UInt32 _DamageScore_k__BackingField; // 0x2C
	::System::Boolean _IsFinalHit_k__BackingField; // 0x30
	::System::UInt32 _OverKillDamageHp_k__BackingField; // 0x34
