...
#define BINARYDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDBYTESTOSHAREDVARIABLE_1_OFFSET UNITYSDK_OFFSET(0x1BA329B0)
#define BINARYDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDBYTESTOSHAREDVARIABLE_OFFSET UNITYSDK_OFFSET(0x1BA30C50)
#define BINARYDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDLOADFIELDS_OFFSET UNITYSDK_OFFSET(0x1BA33820)
#define BINARYDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDLOADTASK_OFFSET UNITYSDK_OFFSET(0x1BA30E80)
#define BINARYDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDLOAD_1_OFFSET UNITYSDK_OFFSET(0x1BA31CC0)
#define BINARYDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDLOAD_OFFSET UNITYSDK_OFFSET(0x1BA2F420)
#define BINARYDESERIALIZATION_PRECOMPILEDDESERIALIZATION_TRYGETFIELDINDEX_OFFSET UNITYSDK_OFFSET(0x1BA32760)

inline static constexpr unsigned int BinaryDeserialization_PrecompiledDeserialization_TypeDefinitionIndex = 31657;
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::BehaviorDesigner::Runtime::TaskFieldAssigner>**)Il2CppClass::FromTypeDefinitionIndex(BinaryDeserialization_PrecompiledDeserialization_TypeDefinitionIndex)->GetStaticField(0x25A30);
	}
