...
#define STRUCT_2_9143926C2C91FB11_EQUALS_OFFSET UNITYSDK_OFFSET(0x3977060)
#define STRUCT_2_9143926C2C91FB11_GET_BADGETYPE_OFFSET UNITYSDK_OFFSET(0x676EB0)
#define STRUCT_2_9143926C2C91FB11_GET_CHALLENGETYPE_OFFSET UNITYSDK_OFFSET(0x167710)
#define STRUCT_2_9143926C2C91FB11_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x7A7C20)
#define STRUCT_2_9143926C2C91FB11_SET_BADGETYPE_OFFSET UNITYSDK_OFFSET(0x38C2BD0)
#define STRUCT_2_9143926C2C91FB11_SET_CHALLENGETYPE_OFFSET UNITYSDK_OFFSET(0x167520)
#define STRUCT_2_9143926C2C91FB11_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0xA4B350)

inline static constexpr unsigned int Struct_2_9143926C2C91FB11_TypeDefinitionIndex = 71369;
