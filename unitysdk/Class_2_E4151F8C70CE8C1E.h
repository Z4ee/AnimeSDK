...
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_0772661406F51ADB_OFFSET UNITYSDK_OFFSET(0x17AB10C0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_186AA054E8326968_OFFSET UNITYSDK_OFFSET(0x17AB0CA0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_2934FD95900E25B5_OFFSET UNITYSDK_OFFSET(0x17AB5C90)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_2AA27BA1D6C33879_OFFSET UNITYSDK_OFFSET(0x17AAB0D0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_3008EB101AD8057B_OFFSET UNITYSDK_OFFSET(0x17AB5200)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_30D1209326FA87FC_1_OFFSET UNITYSDK_OFFSET(0x17AABDC0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x17AB0610)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_353E31384A248EED_OFFSET UNITYSDK_OFFSET(0x17AB69F0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_3C0F7658751C32B0_OFFSET UNITYSDK_OFFSET(0x17AB3830)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_3DA91C9B57824EE6_OFFSET UNITYSDK_OFFSET(0x17AB1590)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_3E23A2EE3F65066B_OFFSET UNITYSDK_OFFSET(0x17AB0B20)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_3E4CBBD89B4FBE55_OFFSET UNITYSDK_OFFSET(0x17AB0180)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_44E1C4BA1123578B_OFFSET UNITYSDK_OFFSET(0x17AB4E20)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_47B46C40CF547193_OFFSET UNITYSDK_OFFSET(0x17AB38D0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_47F2555F83B8DAE1_OFFSET UNITYSDK_OFFSET(0x17AAAEC0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_49F692C01A20E7F1_OFFSET UNITYSDK_OFFSET(0x17AB1390)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_5A124CAF1E48B74F_OFFSET UNITYSDK_OFFSET(0x17AAC360)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_5E9906D613ECF25F_OFFSET UNITYSDK_OFFSET(0x17AB2400)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_602B796CAD5DBEDB_OFFSET UNITYSDK_OFFSET(0x17AB1D70)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_6092608CF92684DE_OFFSET UNITYSDK_OFFSET(0x17AB0AD0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_67D41ACFEF39E84E_OFFSET UNITYSDK_OFFSET(0x17AABA50)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_6A21186282395464_OFFSET UNITYSDK_OFFSET(0x17AB47B0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_6E6682ED9FD6F719_OFFSET UNITYSDK_OFFSET(0x17AAB430)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_7AB000B2DA3DF7D1_OFFSET UNITYSDK_OFFSET(0x17AB53A0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_7D7AA2DF949AC657_OFFSET UNITYSDK_OFFSET(0x17AB3A00)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_7D968026C2023C80_OFFSET UNITYSDK_OFFSET(0x17AABE70)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_83DA3EC57FF907F4_OFFSET UNITYSDK_OFFSET(0x17AB3ED0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_851CC87DBC0902F9_OFFSET UNITYSDK_OFFSET(0x17AB3540)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_8C3DB70FFBBF01C7_OFFSET UNITYSDK_OFFSET(0x17AB5F40)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_8F6A1B72899F4EA4_OFFSET UNITYSDK_OFFSET(0x17AAAFE0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_9076BB310BB6989E_OFFSET UNITYSDK_OFFSET(0x17AAC490)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_907E24F785836BA0_OFFSET UNITYSDK_OFFSET(0x17AB0770)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_9982841760D041C2_OFFSET UNITYSDK_OFFSET(0x17AB6730)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_AC93B0A6D917A386_OFFSET UNITYSDK_OFFSET(0x17AB55E0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_B0091B0E1DC92674_OFFSET UNITYSDK_OFFSET(0x17AB5750)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_B1EB734337965E73_OFFSET UNITYSDK_OFFSET(0x17AAB540)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_BC4D22544163BF30_OFFSET UNITYSDK_OFFSET(0x17AB3B20)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_C373CE9EE91987A2_OFFSET UNITYSDK_OFFSET(0x17AAADC0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_CB74603E77CF9AD9_OFFSET UNITYSDK_OFFSET(0x17AB27A0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_D5C60D4BCF120194_OFFSET UNITYSDK_OFFSET(0x17AB54D0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_D8ACD155C8BD8238_OFFSET UNITYSDK_OFFSET(0x17AB5850)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_D94D446371432B5F_OFFSET UNITYSDK_OFFSET(0x17AB5ED0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_DDFCBBB54CA12CE0_OFFSET UNITYSDK_OFFSET(0x17AB3060)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_DFBFA538F7174FFF_OFFSET UNITYSDK_OFFSET(0x17AB3F60)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_E305ECB63019269B_OFFSET UNITYSDK_OFFSET(0x17AB5FE0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_E46BE7AABD43A71A_OFFSET UNITYSDK_OFFSET(0x17AB4FF0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_ECF5752EC6D68585_OFFSET UNITYSDK_OFFSET(0x17AB6690)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_EEED34E9AAC26D51_OFFSET UNITYSDK_OFFSET(0x17AAB5B0)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_F2C85D8580AEDBDE_OFFSET UNITYSDK_OFFSET(0x17AAC050)
#define CLASS_2_E4151F8C70CE8C1E_METHOD_2_F63FE1AA9633F811_OFFSET UNITYSDK_OFFSET(0x17AAC680)
#define CLASS_2_E4151F8C70CE8C1E__CTOR_OFFSET UNITYSDK_OFFSET(0x17AB6A40)
...
public:
	...
	::UnityEngine::Transform* AHHCHFFGONL; // 0x28
	::UnityEngine::Rigidbody* LHDDEIIFHLI; // 0x30
	::UnityEngine::Transform* GLCKFPKNEIM; // 0x38
	::RPG::GameCore::TransformComponent* NJINMJCLJNE; // 0x40
	::RPG::GameCore::GameEntity* ANFAHNJGAGG; // 0x48
	::RPG::Client::NotifyHandler* OIJOCINPFLJ; // 0x50
	::Il2CppArray<::RPG::Client::Effect_AfterImageNew*>* LOAACBNJABB; // 0x58
	::UnityEngine::Transform* DMBMOHJLNEN; // 0x60
	::System::Collections::Generic::HashSet_1<::System::Int32>* CPHHELOGCCL; // 0x68
	::System::Collections::Generic::HashSet_1<::System::Int32>* JEJFNGENNPI; // 0x70
	::RPG::Client::AttachPointMapping* FEFIGDAEGGI; // 0x78
	::RPG::Client::NotifyHandler* AFIPMMNJIJC; // 0x80
	::RPG::GameCore::CharacterModelComponent* MCEKMAPNCKL; // 0x88
	::UnityEngine::Vector3 AMHNNDHJNKD; // 0x90
	::System::Single IIFMKPHMONJ; // 0x9C
	::System::Single CBIIFEGEPIP; // 0xA0
	::UnityEngine::Vector3 MMCEMCHNAGD; // 0xA4
	::RPG::Client::ModelFlipOption AEKBJMKAMPL; // 0xB0
	::System::Boolean LFOHPMLLAME; // 0xB4
	::System::Boolean HJMADNNHBHC; // 0xB5
	::System::Boolean DPEJDIOGODF; // 0xB6
	::System::Boolean GPDGGNNBHJE; // 0xB7
	::UnityEngine::Vector3 MEKFHKIIPAN; // 0xB8
	::System::Single HLPBJKOOKOF; // 0xC4
	::RPG::Client::PositionFollowOption KMMPIAAPGKI; // 0xC8
	::UnityEngine::Vector3 NMEBMMDAJKF; // 0xCC
	::UnityEngine::Vector3 MKJBIBGMPPI; // 0xD8
	::UnityEngine::Vector3 CAPGLCKLIBK; // 0xE4
	::UnityEngine::Vector3 NLABAOCHHCK; // 0xF0
	::UnityEngine::Quaternion HEMFBLEPEFB; // 0xFC
	::System::Single CFCDBPNJPHN; // 0x10C
	::System::Single HPFGIPBAHCB; // 0x110
	::RPG::Client::ScaleFollowOption LABCJMACDDI; // 0x114
	::System::Int32 ONJLDCPDKFD; // 0x118
	::UnityEngine::Vector3 CPEBEIGNAAK; // 0x11C
	::RPG::Client::RotationFollowOption HEPOCPPCOLI; // 0x128
