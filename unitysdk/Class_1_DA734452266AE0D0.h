...
#define CLASS_1_DA734452266AE0D0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4A3E90)
...
{
public:
	::RPG::Client::LittleGame::PixAir::PixAirGameState MEPFOEEGBEA; // 0x10
	::System::Boolean KBEJHKAFIIF; // 0x14
