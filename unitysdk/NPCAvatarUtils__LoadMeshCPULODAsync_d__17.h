...
#define NPCAVATARUTILS__LOADMESHCPULODASYNC_D__17_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x5B0C70)
#define NPCAVATARUTILS__LOADMESHCPULODASYNC_D__17_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x283610)

inline static constexpr unsigned int NPCAvatarUtils__LoadMeshCPULODAsync_d__17_TypeDefinitionIndex = 52701;

struct alignas(8) NPCAvatarUtils__LoadMeshCPULODAsync_d__17
{
	::NPCAvatarMeshAssetsSO* assetSo; // 0x10
	::NPCCrowd::Avatar::NPCAvatarGOReference* goInfo; // 0x18
