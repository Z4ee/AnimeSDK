...
#define CLASS_1_5B567C8A01BAEDFE_260_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1958CBC0)
#define CLASS_1_5B567C8A01BAEDFE_260_CLONE_OFFSET UNITYSDK_OFFSET(0x1958CA30)
#define CLASS_1_5B567C8A01BAEDFE_260_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1958CAD0)
#define CLASS_1_5B567C8A01BAEDFE_260_EQUALS_OFFSET UNITYSDK_OFFSET(0x1958CA70)
#define CLASS_1_5B567C8A01BAEDFE_260_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1958CB20)
#define CLASS_1_5B567C8A01BAEDFE_260_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1958CC10)
#define CLASS_1_5B567C8A01BAEDFE_260_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1958CBE0)
#define CLASS_1_5B567C8A01BAEDFE_260_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1958C9B0)
#define CLASS_1_5B567C8A01BAEDFE_260_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1958C9E0)
#define CLASS_1_5B567C8A01BAEDFE_260_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1958CB50)
#define CLASS_1_5B567C8A01BAEDFE_260_WRITETO_OFFSET UNITYSDK_OFFSET(0x1958CBB0)
#define CLASS_1_5B567C8A01BAEDFE_260__CCTOR_OFFSET UNITYSDK_OFFSET(0x1958CC60)
#define CLASS_1_5B567C8A01BAEDFE_260__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1958CA00)
#define CLASS_1_5B567C8A01BAEDFE_260__CTOR_OFFSET UNITYSDK_OFFSET(0x1958C9F0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_260_TypeDefinitionIndex = 30406;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_260*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_260_TypeDefinitionIndex)->GetStaticField(0x4E5E0);
	}
