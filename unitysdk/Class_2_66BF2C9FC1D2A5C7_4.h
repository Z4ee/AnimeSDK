...
#define CLASS_2_66BF2C9FC1D2A5C7_4_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1C36B9D0)
#define CLASS_2_66BF2C9FC1D2A5C7_4_FILTER_OFFSET UNITYSDK_OFFSET(0x1C36B8D0)
#define CLASS_2_66BF2C9FC1D2A5C7_4_GETTRIGGER_OFFSET UNITYSDK_OFFSET(0x1C36B7B0)
#define CLASS_2_66BF2C9FC1D2A5C7_4__CTOR_OFFSET UNITYSDK_OFFSET(0x1C36B730)

inline static constexpr unsigned int Class_2_66BF2C9FC1D2A5C7_4_TypeDefinitionIndex = 40752;

class Class_2_66BF2C9FC1D2A5C7_4 : public ::Entitas::ReactiveSystem_1<::Class_2_4706D3AD6019CD01*>
{
public:
	::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_217*>* BGKHCJPFFLN; // 0x28
