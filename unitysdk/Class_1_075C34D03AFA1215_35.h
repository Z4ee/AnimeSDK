...
#define CLASS_1_075C34D03AFA1215_35_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x195FA000)
#define CLASS_1_075C34D03AFA1215_35_CLONE_OFFSET UNITYSDK_OFFSET(0x195F9C30)
#define CLASS_1_075C34D03AFA1215_35_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x195F9D50)
#define CLASS_1_075C34D03AFA1215_35_EQUALS_OFFSET UNITYSDK_OFFSET(0x195F9C90)
#define CLASS_1_075C34D03AFA1215_35_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x195F9DE0)
#define CLASS_1_075C34D03AFA1215_35_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x195FA0F0)
#define CLASS_1_075C34D03AFA1215_35_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x195FA0A0)
#define CLASS_1_075C34D03AFA1215_35_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x195F9AE0)
#define CLASS_1_075C34D03AFA1215_35_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x195F9C80)
#define CLASS_1_075C34D03AFA1215_35_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x195F9B40)
#define CLASS_1_075C34D03AFA1215_35_TOSTRING_OFFSET UNITYSDK_OFFSET(0x195F9EF0)
#define CLASS_1_075C34D03AFA1215_35_WRITETO_OFFSET UNITYSDK_OFFSET(0x195F9F50)
#define CLASS_1_075C34D03AFA1215_35__CCTOR_OFFSET UNITYSDK_OFFSET(0x195FA1C0)
#define CLASS_1_075C34D03AFA1215_35__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195F9BA0)
#define CLASS_1_075C34D03AFA1215_35__CTOR_OFFSET UNITYSDK_OFFSET(0x195F9B50)

inline static constexpr unsigned int Class_1_075C34D03AFA1215_35_TypeDefinitionIndex = 27596;

class Class_1_075C34D03AFA1215_35 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_075C34D03AFA1215_35*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_075C34D03AFA1215_35*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_075C34D03AFA1215_35_TypeDefinitionIndex)->GetStaticField(0x5A8D0);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_3()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_075C34D03AFA1215_35_TypeDefinitionIndex)->GetStaticField(0x5A8D8);
	}
