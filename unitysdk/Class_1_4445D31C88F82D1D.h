...
#define CLASS_1_4445D31C88F82D1D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18E339C0)
#define CLASS_1_4445D31C88F82D1D_METHOD_1_2C56AE4A42D6E217_OFFSET UNITYSDK_OFFSET(0x18E334E0)
#define CLASS_1_4445D31C88F82D1D_METHOD_1_39E669857F41F800_OFFSET UNITYSDK_OFFSET(0x18E323C0)
#define CLASS_1_4445D31C88F82D1D_METHOD_1_6B4A3A1B5816B81E_OFFSET UNITYSDK_OFFSET(0x18E31C40)
#define CLASS_1_4445D31C88F82D1D_METHOD_1_909FC79222B4A1EB_OFFSET UNITYSDK_OFFSET(0x18E327B0)
#define CLASS_1_4445D31C88F82D1D_METHOD_1_90A07D9BC1B409B9_OFFSET UNITYSDK_OFFSET(0x18E32F80)
#define CLASS_1_4445D31C88F82D1D_METHOD_1_ADA85C40A3382050_OFFSET UNITYSDK_OFFSET(0x18E32DC0)
#define CLASS_1_4445D31C88F82D1D_METHOD_1_CCB1C92E6A241E7C_OFFSET UNITYSDK_OFFSET(0x18E32B70)
#define CLASS_1_4445D31C88F82D1D_METHOD_1_CEE2550285AA5985_OFFSET UNITYSDK_OFFSET(0x18E33A50)
#define CLASS_1_4445D31C88F82D1D_METHOD_1_DF7CEFC0E6C5FD0D_1_OFFSET UNITYSDK_OFFSET(0x18E33C30)
#define CLASS_1_4445D31C88F82D1D_METHOD_1_DF7CEFC0E6C5FD0D_OFFSET UNITYSDK_OFFSET(0x18E33B70)
#define CLASS_1_4445D31C88F82D1D_TICK_OFFSET UNITYSDK_OFFSET(0x18E31D60)
#define CLASS_1_4445D31C88F82D1D__CTOR_OFFSET UNITYSDK_OFFSET(0x18E31BB0)
...
public:
	...
	::RPG::Client::GamePlayLockTargetFunc* EGCPOEIJPPC; // 0x10
	::RPG::Client::InputDataController* JHGFHAFJLPC; // 0x18
	::RPG::Client::AdventurePhase* DEIEJIOELMO; // 0x20
	::System::Boolean HJAAPIOGKIO; // 0x28
	::System::Boolean FPGNCCFKIHA; // 0x29
	::System::Boolean HMOBGJKPHLE; // 0x2A
	::UnityEngine::Vector2 LICNPONDOHP; // 0x2C
	::System::UInt32 EGOEPDIGMBH; // 0x34
	::System::UInt32 CJLNNGNNKFL; // 0x38
