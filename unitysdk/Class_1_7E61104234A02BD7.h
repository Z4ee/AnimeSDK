...
#define CLASS_1_7E61104234A02BD7__CTOR_OFFSET UNITYSDK_OFFSET(0x1574CD80)
...
{
public:
	::Class_3_07C3C4D2990C49EE* CMFJBFKOFDC; // 0x10
	::RPG::GameCore::TaskContext* BKIFMPHBIAK; // 0x18
	::Class_3_07C3C4D2990C49EE* MGEBFBDCNHM; // 0x20
	::RPG::GameCore::BattleQTEBaseConfig* COKHBDEGLIA; // 0x28
	::Class_3_07C3C4D2990C49EE* JGNEPMDIHEC; // 0x30
