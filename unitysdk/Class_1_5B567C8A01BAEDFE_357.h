...
#define CLASS_1_5B567C8A01BAEDFE_357_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E2ECA40)
#define CLASS_1_5B567C8A01BAEDFE_357_CLONE_OFFSET UNITYSDK_OFFSET(0x1E2EC730)
#define CLASS_1_5B567C8A01BAEDFE_357_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E2EC840)
#define CLASS_1_5B567C8A01BAEDFE_357_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E2EC770)
#define CLASS_1_5B567C8A01BAEDFE_357_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E2EC9A0)
#define CLASS_1_5B567C8A01BAEDFE_357_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E2ECA90)
#define CLASS_1_5B567C8A01BAEDFE_357_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E2ECA60)
#define CLASS_1_5B567C8A01BAEDFE_357_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E2EC6B0)
#define CLASS_1_5B567C8A01BAEDFE_357_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E2EC6E0)
#define CLASS_1_5B567C8A01BAEDFE_357_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E2EC9D0)
#define CLASS_1_5B567C8A01BAEDFE_357_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E2ECA30)
#define CLASS_1_5B567C8A01BAEDFE_357__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E2ECAE0)
#define CLASS_1_5B567C8A01BAEDFE_357__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E2EC700)
#define CLASS_1_5B567C8A01BAEDFE_357__CTOR_OFFSET UNITYSDK_OFFSET(0x1E2EC6F0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_357_TypeDefinitionIndex = 33913;

class Class_1_5B567C8A01BAEDFE_357 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_357*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_357*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_357_TypeDefinitionIndex)->GetStaticField(0x30890);
	}
