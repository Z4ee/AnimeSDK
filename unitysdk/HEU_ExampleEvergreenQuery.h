...
#define HEU_EXAMPLEEVERGREENQUERY_CHANGEPARMSANDCOOK_OFFSET UNITYSDK_OFFSET(0x1B3B89C0)
#define HEU_EXAMPLEEVERGREENQUERY_COOKASSET_OFFSET UNITYSDK_OFFSET(0x1B3B89A0)
#define HEU_EXAMPLEEVERGREENQUERY_QUERYATTRIBUTEBYSTORAGETYPE_OFFSET UNITYSDK_OFFSET(0x1B3BB0D0)
#define HEU_EXAMPLEEVERGREENQUERY_QUERYATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1B3B93C0)
#define HEU_EXAMPLEEVERGREENQUERY_QUERYGEOPARTS_OFFSET UNITYSDK_OFFSET(0x1B3BA1B0)
#define HEU_EXAMPLEEVERGREENQUERY_QUERYHOUDINIASSET_OFFSET UNITYSDK_OFFSET(0x1B3B87B0)
#define HEU_EXAMPLEEVERGREENQUERY_QUERYOBJECTS_OFFSET UNITYSDK_OFFSET(0x1B3B8E60)
#define HEU_EXAMPLEEVERGREENQUERY_QUERYPARTATTRIBUTEBYOWNER_OFFSET UNITYSDK_OFFSET(0x1B3BA950)
#define HEU_EXAMPLEEVERGREENQUERY_STARTQUERY_OFFSET UNITYSDK_OFFSET(0x1B3B8120)
#define HEU_EXAMPLEEVERGREENQUERY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3BB720)
