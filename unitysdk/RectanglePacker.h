...
#define RECTANGLEPACKER_ALLOCATERECTANGLE_OFFSET UNITYSDK_OFFSET(0x19104370)
#define RECTANGLEPACKER_ALLOCATESIZE_OFFSET UNITYSDK_OFFSET(0x19104730)
#define RECTANGLEPACKER_FILTERSELFSUBAREAS_OFFSET UNITYSDK_OFFSET(0x19105660)
#define RECTANGLEPACKER_FREERECTANGLE_OFFSET UNITYSDK_OFFSET(0x191042E0)
#define RECTANGLEPACKER_FREESIZE_OFFSET UNITYSDK_OFFSET(0x19104490)
#define RECTANGLEPACKER_GENERATEDIVIDEDAREAS_OFFSET UNITYSDK_OFFSET(0x19105900)
#define RECTANGLEPACKER_GENERATENEWFREEAREAS_OFFSET UNITYSDK_OFFSET(0x19104FA0)
#define RECTANGLEPACKER_GETFREEAREAINDEX_OFFSET UNITYSDK_OFFSET(0x19104DF0)
#define RECTANGLEPACKER_GETRECTANGLEID_OFFSET UNITYSDK_OFFSET(0x191045C0)
#define RECTANGLEPACKER_GETRECTANGLE_OFFSET UNITYSDK_OFFSET(0x19104510)
#define RECTANGLEPACKER_GET_FAILEDRECTINDICES_OFFSET UNITYSDK_OFFSET(0x19103CC0)
#define RECTANGLEPACKER_GET_PACKEDHEIGHT_OFFSET UNITYSDK_OFFSET(0x19103CA0)
#define RECTANGLEPACKER_GET_PACKEDWIDTH_OFFSET UNITYSDK_OFFSET(0x19103C90)
#define RECTANGLEPACKER_GET_PADDING_OFFSET UNITYSDK_OFFSET(0x19103CB0)
#define RECTANGLEPACKER_GET_RECTANGLECOUNT_OFFSET UNITYSDK_OFFSET(0x19103C70)
#define RECTANGLEPACKER_INSERTRECTANGLE_OFFSET UNITYSDK_OFFSET(0x19104630)
#define RECTANGLEPACKER_PACKRECTANGLES_OFFSET UNITYSDK_OFFSET(0x191047D0)
#define RECTANGLEPACKER_RESET_OFFSET UNITYSDK_OFFSET(0x19103E80)
#define RECTANGLEPACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x19103CD0)

inline static constexpr unsigned int RectanglePacker_TypeDefinitionIndex = 29632;
...
public:
	...
	::System::Collections::Generic::List_1<::IntegerRectangle>* mRectangleStack; // 0x20
	::System::Collections::Generic::List_1<::System::Int32>* mFailedRectIndices; // 0x28
	::System::Collections::Generic::List_1<::IntegerRectangle>* mInsertedRectangles; // 0x30
	...
	::System::Int32 mHeight; // 0x48
	::System::Int32 mPadding; // 0x4C
