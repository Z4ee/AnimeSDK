...
#define RECTANGLEPACKER_ALLOCATERECTANGLE_OFFSET UNITYSDK_OFFSET(0x1B070170)
#define RECTANGLEPACKER_ALLOCATESIZE_OFFSET UNITYSDK_OFFSET(0x1B070530)
#define RECTANGLEPACKER_FILTERSELFSUBAREAS_OFFSET UNITYSDK_OFFSET(0x1B071460)
#define RECTANGLEPACKER_FREERECTANGLE_OFFSET UNITYSDK_OFFSET(0x1B0700E0)
#define RECTANGLEPACKER_FREESIZE_OFFSET UNITYSDK_OFFSET(0x1B070290)
#define RECTANGLEPACKER_GENERATEDIVIDEDAREAS_OFFSET UNITYSDK_OFFSET(0x1B071700)
#define RECTANGLEPACKER_GENERATENEWFREEAREAS_OFFSET UNITYSDK_OFFSET(0x1B070DA0)
#define RECTANGLEPACKER_GETFREEAREAINDEX_OFFSET UNITYSDK_OFFSET(0x1B070BF0)
#define RECTANGLEPACKER_GETRECTANGLEID_OFFSET UNITYSDK_OFFSET(0x1B0703C0)
#define RECTANGLEPACKER_GETRECTANGLE_OFFSET UNITYSDK_OFFSET(0x1B070310)
#define RECTANGLEPACKER_GET_FAILEDRECTINDICES_OFFSET UNITYSDK_OFFSET(0x1B06FAB0)
#define RECTANGLEPACKER_GET_PACKEDHEIGHT_OFFSET UNITYSDK_OFFSET(0x1B06FA90)
#define RECTANGLEPACKER_GET_PACKEDWIDTH_OFFSET UNITYSDK_OFFSET(0x1B06FA80)
#define RECTANGLEPACKER_GET_PADDING_OFFSET UNITYSDK_OFFSET(0x1B06FAA0)
#define RECTANGLEPACKER_GET_RECTANGLECOUNT_OFFSET UNITYSDK_OFFSET(0x1B06FA60)
#define RECTANGLEPACKER_INSERTRECTANGLE_OFFSET UNITYSDK_OFFSET(0x1B070430)
#define RECTANGLEPACKER_PACKRECTANGLES_OFFSET UNITYSDK_OFFSET(0x1B0705D0)
#define RECTANGLEPACKER_RESET_OFFSET UNITYSDK_OFFSET(0x1B06FC70)
#define RECTANGLEPACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B06FAC0)

inline static constexpr unsigned int RectanglePacker_TypeDefinitionIndex = 26330;

class RectanglePacker : public ::System::Object
{
public:
	::System::Collections::Generic::Queue_1<::RectanglePacker_SortableSize>* mInsertList; // 0x10
	::System::Collections::Generic::List_1<::RectanglePacker_SortableSize>* mSortableSizeStack; // 0x18
	::System::Collections::Generic::List_1<::IntegerRectangle>* mFreeAreas; // 0x20
	::System::Collections::Generic::List_1<::IntegerRectangle>* mInsertedRectangles; // 0x28
	::System::Collections::Generic::List_1<::System::Int32>* mFailedRectIndices; // 0x30
	::System::Collections::Generic::List_1<::IntegerRectangle>* mNewFreeAreas; // 0x38
	::System::Collections::Generic::List_1<::IntegerRectangle>* mRectangleStack; // 0x40
	::System::Int32 mPadding; // 0x48
	::System::Int32 mPackedHeight; // 0x4C
	::System::Int32 mWidth; // 0x50
	::IntegerRectangle mOutsideRectangle; // 0x54
	::System::Int32 mPackedWidth; // 0x74
	::System::Int32 mHeight; // 0x78
