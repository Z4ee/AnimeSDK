...
#define SCENEOBJECTAREACHECKDOENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D33CD60)

inline static constexpr unsigned int SceneObjectAreaCheckDoEnable_TypeDefinitionIndex = 54509;
