...
#define CLASS_1_C2963602F383E66F__CTOR_OFFSET UNITYSDK_OFFSET(0x1C38B000)
...
public:
	...
	::UnityEngine::Vector3 KONBAMDOGDH; // 0x50
	::UnityEngine::Vector3 HFOMPEEAPCG; // 0x5C
	::UnityEngine::Vector3 OIHGPMFDIEA; // 0x68
	::UnityEngine::Vector3 CLMKNFILOLB; // 0x74
	::RPG::Client::LittleGame::ETimelineControlGameLevelRotation NMELCPIOKNO; // 0x80
	::UnityEngine::Vector3 IJPLNPNAMBJ; // 0x84
