...
#define CLASS_1_5B567C8A01BAEDFE_295_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A8C5AF0)
#define CLASS_1_5B567C8A01BAEDFE_295_CLONE_OFFSET UNITYSDK_OFFSET(0x1A8C5900)
#define CLASS_1_5B567C8A01BAEDFE_295_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A8C5A00)
#define CLASS_1_5B567C8A01BAEDFE_295_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A8C5970)
#define CLASS_1_5B567C8A01BAEDFE_295_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A8C5A50)
#define CLASS_1_5B567C8A01BAEDFE_295_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A8C5B40)
#define CLASS_1_5B567C8A01BAEDFE_295_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A8C5B10)
#define CLASS_1_5B567C8A01BAEDFE_295_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A8C5850)
#define CLASS_1_5B567C8A01BAEDFE_295_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A8C58B0)
#define CLASS_1_5B567C8A01BAEDFE_295_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A8C5A80)
#define CLASS_1_5B567C8A01BAEDFE_295_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A8C5AE0)
#define CLASS_1_5B567C8A01BAEDFE_295__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A8C5B90)
#define CLASS_1_5B567C8A01BAEDFE_295__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A8C58D0)
#define CLASS_1_5B567C8A01BAEDFE_295__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8C58C0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_295_TypeDefinitionIndex = 31017;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_295*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_295_TypeDefinitionIndex)->GetStaticField(0x5B9E0);
	}
