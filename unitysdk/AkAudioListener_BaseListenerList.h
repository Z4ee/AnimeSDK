...
#define AKAUDIOLISTENER_BASELISTENERLIST_ADD_OFFSET UNITYSDK_OFFSET(0x1EEAEAD0)
#define AKAUDIOLISTENER_BASELISTENERLIST_GETLISTENERIDS_OFFSET UNITYSDK_OFFSET(0x1EEAF160)
#define AKAUDIOLISTENER_BASELISTENERLIST_GET_LISTENERLIST_OFFSET UNITYSDK_OFFSET(0x1EEAEAC0)
#define AKAUDIOLISTENER_BASELISTENERLIST_REMOVE_OFFSET UNITYSDK_OFFSET(0x1EEAEF10)
#define AKAUDIOLISTENER_BASELISTENERLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEAF210)
