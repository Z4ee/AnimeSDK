...
#define AKTRIGGERHANDLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1C0C2F80)
#define AKTRIGGERHANDLER_DODESTROY_OFFSET UNITYSDK_OFFSET(0x1C0C3600)
#define AKTRIGGERHANDLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1C0C35F0)
#define AKTRIGGERHANDLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C0C3BD0)
#define AKTRIGGERHANDLER_REGISTERTRIGGERS_OFFSET UNITYSDK_OFFSET(0x1C0C3040)
#define AKTRIGGERHANDLER_START_OFFSET UNITYSDK_OFFSET(0x1C0C35A0)
#define AKTRIGGERHANDLER_UNREGISTERTRIGGERS_OFFSET UNITYSDK_OFFSET(0x1C0C36C0)
#define AKTRIGGERHANDLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C0C3CE0)
#define AKTRIGGERHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0C3C20)

inline static constexpr unsigned int AkTriggerHandler_TypeDefinitionIndex = 33189;
...
public:
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(AkTriggerHandler_TypeDefinitionIndex)->GetStaticField(0x273D0);
	}
