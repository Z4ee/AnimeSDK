...
#define ENTITAS_VISUALDEBUGGING_UNITY_DEBUGSYSTEMSBEHAVIOUR_GET_SYSTEMS_OFFSET UNITYSDK_OFFSET(0x1D1D2370)
#define ENTITAS_VISUALDEBUGGING_UNITY_DEBUGSYSTEMSBEHAVIOUR_INIT_OFFSET UNITYSDK_OFFSET(0x1D1D2380)
#define ENTITAS_VISUALDEBUGGING_UNITY_DEBUGSYSTEMSBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1D2390)

namespace Entitas::VisualDebugging::Unity
{
	inline static constexpr unsigned int DebugSystemsBehaviour_TypeDefinitionIndex = 9724;
