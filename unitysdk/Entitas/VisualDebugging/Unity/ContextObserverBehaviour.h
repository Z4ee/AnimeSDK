...
#define ENTITAS_VISUALDEBUGGING_UNITY_CONTEXTOBSERVERBEHAVIOUR_GET_CONTEXTOBSERVER_OFFSET UNITYSDK_OFFSET(0x12C57FE0)
#define ENTITAS_VISUALDEBUGGING_UNITY_CONTEXTOBSERVERBEHAVIOUR_INIT_OFFSET UNITYSDK_OFFSET(0x12C576F0)
#define ENTITAS_VISUALDEBUGGING_UNITY_CONTEXTOBSERVERBEHAVIOUR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x12C580C0)
#define ENTITAS_VISUALDEBUGGING_UNITY_CONTEXTOBSERVERBEHAVIOUR_UPDATE_OFFSET UNITYSDK_OFFSET(0x12C57FF0)
#define ENTITAS_VISUALDEBUGGING_UNITY_CONTEXTOBSERVERBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x12C580F0)

namespace Entitas::VisualDebugging::Unity
{
	inline static constexpr unsigned int ContextObserverBehaviour_TypeDefinitionIndex = 9879;
