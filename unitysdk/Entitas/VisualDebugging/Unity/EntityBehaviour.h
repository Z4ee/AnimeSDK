...
#define ENTITAS_VISUALDEBUGGING_UNITY_ENTITYBEHAVIOUR_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x11A8B530)
#define ENTITAS_VISUALDEBUGGING_UNITY_ENTITYBEHAVIOUR_GET_ENTITY_OFFSET UNITYSDK_OFFSET(0x11A8B540)
#define ENTITAS_VISUALDEBUGGING_UNITY_ENTITYBEHAVIOUR_INIT_OFFSET UNITYSDK_OFFSET(0x11A8B550)
#define ENTITAS_VISUALDEBUGGING_UNITY_ENTITYBEHAVIOUR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x11A8B8B0)
#define ENTITAS_VISUALDEBUGGING_UNITY_ENTITYBEHAVIOUR_ONENTITYRELEASED_OFFSET UNITYSDK_OFFSET(0x11A8B690)
#define ENTITAS_VISUALDEBUGGING_UNITY_ENTITYBEHAVIOUR_UPDATE_OFFSET UNITYSDK_OFFSET(0x11A8B810)
#define ENTITAS_VISUALDEBUGGING_UNITY_ENTITYBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x11A8B980)

namespace Entitas::VisualDebugging::Unity
{
	inline static constexpr unsigned int EntityBehaviour_TypeDefinitionIndex = 9754;
