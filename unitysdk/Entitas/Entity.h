...
#define ENTITAS_ENTITY_ADDCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1D1CA430)
#define ENTITAS_ENTITY_ADD_ONCOMPONENTADDED_OFFSET UNITYSDK_OFFSET(0x1D1C9CD0)
#define ENTITAS_ENTITY_ADD_ONCOMPONENTREMOVED_OFFSET UNITYSDK_OFFSET(0x1D1C9D90)
#define ENTITAS_ENTITY_ADD_ONCOMPONENTREPLACED_OFFSET UNITYSDK_OFFSET(0x1D1C9E50)
#define ENTITAS_ENTITY_ADD_ONDESTROYENTITY_OFFSET UNITYSDK_OFFSET(0x1D1C9FD0)
#define ENTITAS_ENTITY_ADD_ONENTITYRELEASED_OFFSET UNITYSDK_OFFSET(0x1D1C9F10)
#define ENTITAS_ENTITY_CREATECOMPONENT_1_OFFSET UNITYSDK_OFFSET(0x1D1CB6F0)
#define ENTITAS_ENTITY_CREATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1D1CB610)
#define ENTITAS_ENTITY_CREATEDEFAULTCONTEXTINFO_OFFSET UNITYSDK_OFFSET(0x1D1CA2C0)
#define ENTITAS_ENTITY_DESTROY_OFFSET UNITYSDK_OFFSET(0x1D1CBB90)
#define ENTITAS_ENTITY_GETCOMPONENTINDICES_OFFSET UNITYSDK_OFFSET(0x1D1CB370)
#define ENTITAS_ENTITY_GETCOMPONENTPOOL_OFFSET UNITYSDK_OFFSET(0x1D1CB010)
#define ENTITAS_ENTITY_GETCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1D1CB240)
#define ENTITAS_ENTITY_GETCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1D1CB100)
#define ENTITAS_ENTITY_GET_AERC_OFFSET UNITYSDK_OFFSET(0x1D1CA100)
#define ENTITAS_ENTITY_GET_COMPONENTPOOLS_OFFSET UNITYSDK_OFFSET(0x1D1CA0E0)
#define ENTITAS_ENTITY_GET_CONTEXTINFO_OFFSET UNITYSDK_OFFSET(0x1D1CA0F0)
#define ENTITAS_ENTITY_GET_CREATIONINDEX_OFFSET UNITYSDK_OFFSET(0x1D1CA0C0)
#define ENTITAS_ENTITY_GET_ISENABLED_OFFSET UNITYSDK_OFFSET(0x1D1CA0D0)
#define ENTITAS_ENTITY_GET_RETAINCOUNT_OFFSET UNITYSDK_OFFSET(0x1D1CB770)
#define ENTITAS_ENTITY_GET_TOTALCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1D1CA0B0)
#define ENTITAS_ENTITY_HASANYCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1D1CB530)
#define ENTITAS_ENTITY_HASCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1D1CB4C0)
#define ENTITAS_ENTITY_HASCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1D1CA7C0)
#define ENTITAS_ENTITY_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1D1CA190)
#define ENTITAS_ENTITY_INTERNALDESTROY_OFFSET UNITYSDK_OFFSET(0x1D1CBC20)
#define ENTITAS_ENTITY_REACTIVATE_OFFSET UNITYSDK_OFFSET(0x1D1CA2B0)
#define ENTITAS_ENTITY_RELEASE_OFFSET UNITYSDK_OFFSET(0x1D1CB970)
#define ENTITAS_ENTITY_REMOVEALLCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1D1CB5A0)
#define ENTITAS_ENTITY_REMOVEALLONENTITYRELEASEDHANDLERS_OFFSET UNITYSDK_OFFSET(0x1D1CBCC0)
#define ENTITAS_ENTITY_REMOVECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1D1CA8F0)
#define ENTITAS_ENTITY_REMOVE_ONCOMPONENTADDED_OFFSET UNITYSDK_OFFSET(0x1D1C9D30)
#define ENTITAS_ENTITY_REMOVE_ONCOMPONENTREMOVED_OFFSET UNITYSDK_OFFSET(0x1D1C9DF0)
#define ENTITAS_ENTITY_REMOVE_ONCOMPONENTREPLACED_OFFSET UNITYSDK_OFFSET(0x1D1C9EB0)
#define ENTITAS_ENTITY_REMOVE_ONDESTROYENTITY_OFFSET UNITYSDK_OFFSET(0x1D1CA040)
#define ENTITAS_ENTITY_REMOVE_ONENTITYRELEASED_OFFSET UNITYSDK_OFFSET(0x1D1C9F70)
#define ENTITAS_ENTITY_REPLACECOMPONENT_1_OFFSET UNITYSDK_OFFSET(0x1D1CAC20)
#define ENTITAS_ENTITY_REPLACECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1D1CAE80)
#define ENTITAS_ENTITY_RETAIN_OFFSET UNITYSDK_OFFSET(0x1D1CB870)
#define ENTITAS_ENTITY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D1CBCD0)
#define ENTITAS_ENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1CA110)
...
namespace Entitas
{
	...
	{
	public:
		::System::Text::StringBuilder* _toStringBuilder; // 0x10
		::Entitas::EntityComponentReplaced* OnComponentReplaced; // 0x18
		::Entitas::ContextInfo* _contextInfo; // 0x20
		::System::String* _toStringCache; // 0x28
		::Il2CppArray<::System::Int32>* _componentIndicesCache; // 0x30
		...
		::Entitas::IAERC* _aerc; // 0x48
		::Il2CppArray<::System::Collections::Generic::Stack_1<::Entitas::IComponent*>*>* _componentPools; // 0x50
		::Entitas::EntityComponentChanged* OnComponentAdded; // 0x58
		::Il2CppArray<::Entitas::IComponent*>* _components; // 0x60
		::System::Collections::Generic::List_1<::System::Int32>* _indexBuffer; // 0x68
		::Entitas::EntityComponentChanged* OnComponentRemoved; // 0x70
		::Entitas::EntityEvent* OnEntityReleased; // 0x78
		::Entitas::EntityEvent* OnDestroyEntity; // 0x80
