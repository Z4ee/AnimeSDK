...
#define ENTITAS_ENTITY_ADDCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1EECA800)
#define ENTITAS_ENTITY_ADD_ONCOMPONENTADDED_OFFSET UNITYSDK_OFFSET(0x1EECA0C0)
#define ENTITAS_ENTITY_ADD_ONCOMPONENTREMOVED_OFFSET UNITYSDK_OFFSET(0x1EECA180)
#define ENTITAS_ENTITY_ADD_ONCOMPONENTREPLACED_OFFSET UNITYSDK_OFFSET(0x1EECA240)
#define ENTITAS_ENTITY_ADD_ONDESTROYENTITY_OFFSET UNITYSDK_OFFSET(0x1EECA3C0)
#define ENTITAS_ENTITY_ADD_ONENTITYRELEASED_OFFSET UNITYSDK_OFFSET(0x1EECA300)
#define ENTITAS_ENTITY_CREATECOMPONENT_1_OFFSET UNITYSDK_OFFSET(0x1EECBB20)
#define ENTITAS_ENTITY_CREATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1EECBA40)
#define ENTITAS_ENTITY_CREATEDEFAULTCONTEXTINFO_OFFSET UNITYSDK_OFFSET(0x1EECA690)
#define ENTITAS_ENTITY_DESTROY_OFFSET UNITYSDK_OFFSET(0x1EECBFC0)
#define ENTITAS_ENTITY_GETCOMPONENTINDICES_OFFSET UNITYSDK_OFFSET(0x1EECB7A0)
#define ENTITAS_ENTITY_GETCOMPONENTPOOL_OFFSET UNITYSDK_OFFSET(0x1EECB400)
#define ENTITAS_ENTITY_GETCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1EECB630)
#define ENTITAS_ENTITY_GETCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1EECB4F0)
#define ENTITAS_ENTITY_GET_AERC_OFFSET UNITYSDK_OFFSET(0x1EECA4D0)
#define ENTITAS_ENTITY_GET_COMPONENTPOOLS_OFFSET UNITYSDK_OFFSET(0x1EECA4B0)
#define ENTITAS_ENTITY_GET_CONTEXTINFO_OFFSET UNITYSDK_OFFSET(0x1EECA4C0)
#define ENTITAS_ENTITY_GET_CREATIONINDEX_OFFSET UNITYSDK_OFFSET(0x1EECA490)
#define ENTITAS_ENTITY_GET_ISENABLED_OFFSET UNITYSDK_OFFSET(0x1EECA4A0)
#define ENTITAS_ENTITY_GET_RETAINCOUNT_OFFSET UNITYSDK_OFFSET(0x1EECBBA0)
#define ENTITAS_ENTITY_GET_TOTALCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1EECA480)
#define ENTITAS_ENTITY_HASANYCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1EECB960)
#define ENTITAS_ENTITY_HASCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1EECB8F0)
#define ENTITAS_ENTITY_HASCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1EECABA0)
#define ENTITAS_ENTITY_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1EECA560)
#define ENTITAS_ENTITY_INTERNALDESTROY_OFFSET UNITYSDK_OFFSET(0x1EECC050)
#define ENTITAS_ENTITY_REACTIVATE_OFFSET UNITYSDK_OFFSET(0x1EECA680)
#define ENTITAS_ENTITY_RELEASE_OFFSET UNITYSDK_OFFSET(0x1EECBDA0)
#define ENTITAS_ENTITY_REMOVEALLCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1EECB9D0)
#define ENTITAS_ENTITY_REMOVEALLONENTITYRELEASEDHANDLERS_OFFSET UNITYSDK_OFFSET(0x1EECC0E0)
#define ENTITAS_ENTITY_REMOVECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1EECACD0)
#define ENTITAS_ENTITY_REMOVE_ONCOMPONENTADDED_OFFSET UNITYSDK_OFFSET(0x1EECA120)
#define ENTITAS_ENTITY_REMOVE_ONCOMPONENTREMOVED_OFFSET UNITYSDK_OFFSET(0x1EECA1E0)
#define ENTITAS_ENTITY_REMOVE_ONCOMPONENTREPLACED_OFFSET UNITYSDK_OFFSET(0x1EECA2A0)
#define ENTITAS_ENTITY_REMOVE_ONDESTROYENTITY_OFFSET UNITYSDK_OFFSET(0x1EECA420)
#define ENTITAS_ENTITY_REMOVE_ONENTITYRELEASED_OFFSET UNITYSDK_OFFSET(0x1EECA360)
#define ENTITAS_ENTITY_REPLACECOMPONENT_1_OFFSET UNITYSDK_OFFSET(0x1EECB000)
#define ENTITAS_ENTITY_REPLACECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1EECB270)
#define ENTITAS_ENTITY_RETAIN_OFFSET UNITYSDK_OFFSET(0x1EECBCA0)
#define ENTITAS_ENTITY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1EECC0F0)
#define ENTITAS_ENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1EECA4E0)
...
namespace Entitas
{
	...
	{
	public:
		::Entitas::IAERC* _aerc; // 0x10
		::Il2CppArray<::System::Int32>* _componentIndicesCache; // 0x18
		::Entitas::EntityComponentChanged* OnComponentRemoved; // 0x20
		::Entitas::EntityEvent* OnEntityReleased; // 0x28
		::Il2CppArray<::System::Collections::Generic::Stack_1<::Entitas::IComponent*>*>* _componentPools; // 0x30
		::Entitas::EntityComponentReplaced* OnComponentReplaced; // 0x38
		::Entitas::EntityComponentChanged* OnComponentAdded; // 0x40
		::System::Collections::Generic::List_1<::System::Int32>* _indexBuffer; // 0x48
		::System::String* _toStringCache; // 0x50
		::Il2CppArray<::Entitas::IComponent*>* _components; // 0x58
		::Entitas::EntityEvent* OnDestroyEntity; // 0x60
		::Il2CppArray<::Entitas::IComponent*>* _componentsCache; // 0x68
		::Entitas::ContextInfo* _contextInfo; // 0x70
		::System::Text::StringBuilder* _toStringBuilder; // 0x78
		::System::Collections::Generic::List_1<::Entitas::IComponent*>* _componentBuffer; // 0x80
		::System::Int32 _creationIndex; // 0x88
		::System::Int32 _totalComponents; // 0x8C
		::System::Boolean _isEnabled; // 0x90
