...
#define ENTITAS_CONTEXTENTITYCHANGED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D1C8400)
#define ENTITAS_CONTEXTENTITYCHANGED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D1C8440)
#define ENTITAS_CONTEXTENTITYCHANGED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D1C83F0)
#define ENTITAS_CONTEXTENTITYCHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1C8300)

namespace Entitas
{
	inline static constexpr unsigned int ContextEntityChanged_TypeDefinitionIndex = 9659;
