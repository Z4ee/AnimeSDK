...
#define ENTITAS_ENTITYINDEXEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x12C55920)

namespace Entitas
{
	inline static constexpr unsigned int EntityIndexException_TypeDefinitionIndex = 9842;
