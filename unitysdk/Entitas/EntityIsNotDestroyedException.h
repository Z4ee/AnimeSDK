...
#define ENTITAS_ENTITYISNOTDESTROYEDEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1EECCAA0)

namespace Entitas
{
	inline static constexpr unsigned int EntityIsNotDestroyedException_TypeDefinitionIndex = 9937;
