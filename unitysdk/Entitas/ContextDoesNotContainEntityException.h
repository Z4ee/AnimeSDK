...
#define ENTITAS_CONTEXTDOESNOTCONTAINENTITYEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEC8630)

namespace Entitas
{
	inline static constexpr unsigned int ContextDoesNotContainEntityException_TypeDefinitionIndex = 9931;
