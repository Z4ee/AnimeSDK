...
#define ENTITAS_COLLECTOREXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEC8530)

namespace Entitas
{
	inline static constexpr unsigned int CollectorException_TypeDefinitionIndex = 9923;
