...
#define ENTITAS_CODEGENERATION_ATTRIBUTES_EVENTATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEC8250)
...
namespace Entitas::CodeGeneration::Attributes
{
	...
	{
	public:
		::Entitas::CodeGeneration::Attributes::EventType eventType; // 0x10
		::System::Int32 priority; // 0x14
		::Entitas::CodeGeneration::Attributes::EventTarget eventTarget; // 0x18
