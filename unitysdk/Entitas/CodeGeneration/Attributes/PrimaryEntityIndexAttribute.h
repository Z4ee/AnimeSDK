...
#define ENTITAS_CODEGENERATION_ATTRIBUTES_PRIMARYENTITYINDEXATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1C7EA0)

namespace Entitas::CodeGeneration::Attributes
{
	inline static constexpr unsigned int PrimaryEntityIndexAttribute_TypeDefinitionIndex = 9744;
