...
#define ENTITAS_ENTITYDOESNOTHAVECOMPONENTEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x147010F0)

namespace Entitas
{
	inline static constexpr unsigned int EntityDoesNotHaveComponentException_TypeDefinitionIndex = 9656;
