...
#define ENTITAS_SINGLEENTITYEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x146FEA10)

namespace Entitas
{
	inline static constexpr unsigned int SingleEntityException_TypeDefinitionIndex = 9673;
