...
#define ENTITAS_ENTITYALREADYHASCOMPONENTEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x11A842B0)

namespace Entitas
{
	inline static constexpr unsigned int EntityAlreadyHasComponentException_TypeDefinitionIndex = 9695;
