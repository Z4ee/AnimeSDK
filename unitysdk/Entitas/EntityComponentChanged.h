...
#define ENTITAS_ENTITYCOMPONENTCHANGED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x147024A0)
#define ENTITAS_ENTITYCOMPONENTCHANGED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x14702510)
#define ENTITAS_ENTITYCOMPONENTCHANGED_INVOKE_OFFSET UNITYSDK_OFFSET(0x14700E60)
#define ENTITAS_ENTITYCOMPONENTCHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0x147023B0)

namespace Entitas
{
	inline static constexpr unsigned int EntityComponentChanged_TypeDefinitionIndex = 9661;
