...
#define ENTITAS_ENTITYCOMPONENTCHANGED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D1CC030)
#define ENTITAS_ENTITYCOMPONENTCHANGED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D1CC0A0)
#define ENTITAS_ENTITYCOMPONENTCHANGED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D1CA8D0)
#define ENTITAS_ENTITYCOMPONENTCHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1CBF40)

namespace Entitas
{
	inline static constexpr unsigned int EntityComponentChanged_TypeDefinitionIndex = 9675;
