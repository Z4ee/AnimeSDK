...
#define PARKOURCAMERACONTROLLER_MANUALEND_OFFSET UNITYSDK_OFFSET(0x8EB9E40)
#define PARKOURCAMERACONTROLLER_MANUALSTART_OFFSET UNITYSDK_OFFSET(0x8EB9BA0)
#define PARKOURCAMERACONTROLLER_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0x8EB9E90)
#define PARKOURCAMERACONTROLLER_METHOD_5_6226389E87D2F955_OFFSET UNITYSDK_OFFSET(0x8EB9F40)
#define PARKOURCAMERACONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8EBA320)

inline static constexpr unsigned int ParkourCameraController_TypeDefinitionIndex = 38177;
