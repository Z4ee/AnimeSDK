...
#define CLASS_1_5B567C8A01BAEDFE_358_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E4BAB00)
#define CLASS_1_5B567C8A01BAEDFE_358_CLONE_OFFSET UNITYSDK_OFFSET(0x1E4BA7F0)
#define CLASS_1_5B567C8A01BAEDFE_358_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E4BA900)
#define CLASS_1_5B567C8A01BAEDFE_358_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E4BA830)
#define CLASS_1_5B567C8A01BAEDFE_358_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E4BAA60)
#define CLASS_1_5B567C8A01BAEDFE_358_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E4BAB50)
#define CLASS_1_5B567C8A01BAEDFE_358_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E4BAB20)
#define CLASS_1_5B567C8A01BAEDFE_358_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E4BA770)
#define CLASS_1_5B567C8A01BAEDFE_358_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E4BA7A0)
#define CLASS_1_5B567C8A01BAEDFE_358_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E4BAA90)
#define CLASS_1_5B567C8A01BAEDFE_358_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E4BAAF0)
#define CLASS_1_5B567C8A01BAEDFE_358__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E4BABA0)
#define CLASS_1_5B567C8A01BAEDFE_358__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E4BA7C0)
#define CLASS_1_5B567C8A01BAEDFE_358__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4BA7B0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_358_TypeDefinitionIndex = 33943;

class Class_1_5B567C8A01BAEDFE_358 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_358*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_358*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_358_TypeDefinitionIndex)->GetStaticField(0x193C0);
	}
