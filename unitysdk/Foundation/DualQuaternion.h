...
#define FOUNDATION_DUALQUATERNION_CONJUGATE_OFFSET UNITYSDK_OFFSET(0x1F9DB450)
#define FOUNDATION_DUALQUATERNION_DIAGNOSTICCHECK_ALL_OFFSET UNITYSDK_OFFSET(0xABF500)
#define FOUNDATION_DUALQUATERNION_DIAGNOSTICCHECK_NORMALIZED_OFFSET UNITYSDK_OFFSET(0xABF500)
#define FOUNDATION_DUALQUATERNION_DIAGNOSTICCHECK_ROTATION_OFFSET UNITYSDK_OFFSET(0x296F30)
#define FOUNDATION_DUALQUATERNION_DIAGNOSTICCHECK_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x296F30)
#define FOUNDATION_DUALQUATERNION_GET_DUAL_OFFSET UNITYSDK_OFFSET(0x41E4B0)
#define FOUNDATION_DUALQUATERNION_GET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0xABE7F0)
#define FOUNDATION_DUALQUATERNION_GET_REAL_OFFSET UNITYSDK_OFFSET(0x31EA80)
#define FOUNDATION_DUALQUATERNION_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x31EA80)
#define FOUNDATION_DUALQUATERNION_GET_TRANSLATION_OFFSET UNITYSDK_OFFSET(0xABE6C0)
#define FOUNDATION_DUALQUATERNION_INVERSETRANSFORMPOSITION_OFFSET UNITYSDK_OFFSET(0xABED70)
#define FOUNDATION_DUALQUATERNION_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x1F9DB400)
#define FOUNDATION_DUALQUATERNION_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1F9DB350)
#define FOUNDATION_DUALQUATERNION_NEGATE_OFFSET UNITYSDK_OFFSET(0x1F9DB430)
#define FOUNDATION_DUALQUATERNION_NEW_OFFSET UNITYSDK_OFFSET(0x1F9DB1B0)
#define FOUNDATION_DUALQUATERNION_PLUS_OFFSET UNITYSDK_OFFSET(0x1F9DB310)
#define FOUNDATION_DUALQUATERNION_SCALE_OFFSET UNITYSDK_OFFSET(0x1F9DB330)
#define FOUNDATION_DUALQUATERNION_TRANSFORMPOSITION_OFFSET UNITYSDK_OFFSET(0xABE930)
#define FOUNDATION_DUALQUATERNION_TRANSFORMVECTOR_OFFSET UNITYSDK_OFFSET(0xABF1D0)
#define FOUNDATION_DUALQUATERNION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F9DB820)

namespace Foundation
{
	inline static constexpr unsigned int DualQuaternion_TypeDefinitionIndex = 8808;

	struct alignas(4) DualQuaternion
	{
		static ::Foundation::DualQuaternion* StaticGet_Identity()
		{
			return (::Foundation::DualQuaternion*)Il2CppClass::FromTypeDefinitionIndex(DualQuaternion_TypeDefinitionIndex)->GetStaticField(0x3D10);
		}
