...
#define FOUNDATION_MULTIVERSIONDIFFCONFIG___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B76D300)
#define FOUNDATION_MULTIVERSIONDIFFCONFIG___C__DISPLAYCLASS5_0__GETALLOTHERVERSIONPATHS_B__0_OFFSET UNITYSDK_OFFSET(0x1B76D310)

namespace Foundation
{
	inline static constexpr unsigned int MultiVersionDiffConfig___c__DisplayClass5_0_TypeDefinitionIndex = 7971;
