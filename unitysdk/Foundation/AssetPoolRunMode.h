...
#define FOUNDATION_ASSETPOOLRUNMODE_ADDINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x1E1A0270)
#define FOUNDATION_ASSETPOOLRUNMODE_ADDINSTANCE_OFFSET UNITYSDK_OFFSET(0x1E1A0150)
#define FOUNDATION_ASSETPOOLRUNMODE_APPLICATIONONLOWMEMORY_OFFSET UNITYSDK_OFFSET(0x1E19FE60)
#define FOUNDATION_ASSETPOOLRUNMODE_CLEARALLPOOLINSTANCES_OFFSET UNITYSDK_OFFSET(0x1E19FEB0)
#define FOUNDATION_ASSETPOOLRUNMODE_CLEARASYNCREQUESTS_OFFSET UNITYSDK_OFFSET(0x1E1A3460)
#define FOUNDATION_ASSETPOOLRUNMODE_CLEARINSTANCES_1_OFFSET UNITYSDK_OFFSET(0x1E1A28F0)
#define FOUNDATION_ASSETPOOLRUNMODE_CLEARINSTANCES_OFFSET UNITYSDK_OFFSET(0x1E1A2840)
#define FOUNDATION_ASSETPOOLRUNMODE_GETASSET_1_OFFSET UNITYSDK_OFFSET(0x1E1A0650)
#define FOUNDATION_ASSETPOOLRUNMODE_GETASSET_OFFSET UNITYSDK_OFFSET(0x1E1A0590)
#define FOUNDATION_ASSETPOOLRUNMODE_GETINSTANCEASYNC_1_OFFSET UNITYSDK_OFFSET(0x1E1A15F0)
#define FOUNDATION_ASSETPOOLRUNMODE_GETINSTANCEASYNC_OFFSET UNITYSDK_OFFSET(0x1E1A1500)
#define FOUNDATION_ASSETPOOLRUNMODE_GETINSTANCEPOOLSNAPSHOTDIFF_OFFSET UNITYSDK_OFFSET(0x1E19F780)
#define FOUNDATION_ASSETPOOLRUNMODE_GETINSTANCEPOOLSNAPSHOT_OFFSET UNITYSDK_OFFSET(0x1E19F070)
#define FOUNDATION_ASSETPOOLRUNMODE_GETINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x1E1A0D00)
#define FOUNDATION_ASSETPOOLRUNMODE_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1E1A0C30)
#define FOUNDATION_ASSETPOOLRUNMODE_GETPRELOADINSTANCEIFNOTEXIST_OFFSET UNITYSDK_OFFSET(0x1E1A23B0)
#define FOUNDATION_ASSETPOOLRUNMODE_GETPRELOADINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x1E1A1E90)
#define FOUNDATION_ASSETPOOLRUNMODE_GETPRELOADINSTANCE_OFFSET UNITYSDK_OFFSET(0x1E1A1CE0)
#define FOUNDATION_ASSETPOOLRUNMODE_GET_ROOTTF_OFFSET UNITYSDK_OFFSET(0x1E19F050)
#define FOUNDATION_ASSETPOOLRUNMODE_ISASSETLOADEDINPOOL_OFFSET UNITYSDK_OFFSET(0x1E1A2300)
#define FOUNDATION_ASSETPOOLRUNMODE_LOGINSTANCEPOOLDETAIL_OFFSET UNITYSDK_OFFSET(0x1E19F390)
#define FOUNDATION_ASSETPOOLRUNMODE_RELEASE_OFFSET UNITYSDK_OFFSET(0x1E1A2A60)
#define FOUNDATION_ASSETPOOLRUNMODE_SETREQUESTHANDLECACHED_OFFSET UNITYSDK_OFFSET(0x1E1A35F0)
#define FOUNDATION_ASSETPOOLRUNMODE_SETUSINGINSTANCEPOOL_OFFSET UNITYSDK_OFFSET(0x1E1A2A10)
#define FOUNDATION_ASSETPOOLRUNMODE_SET_ROOTTF_OFFSET UNITYSDK_OFFSET(0x1E19F060)
#define FOUNDATION_ASSETPOOLRUNMODE_UNLOAD_1_OFFSET UNITYSDK_OFFSET(0x1E1A3180)
#define FOUNDATION_ASSETPOOLRUNMODE_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1E1A30D0)
#define FOUNDATION_ASSETPOOLRUNMODE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E1A3690)
#define FOUNDATION_ASSETPOOLRUNMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E19FBE0)

namespace Foundation
{
	inline static constexpr unsigned int AssetPoolRunMode_TypeDefinitionIndex = 7856;
	...
	public:
		...
		{
			return (::System::Action_1<::Foundation::AssetPath>**)Il2CppClass::FromTypeDefinitionIndex(AssetPoolRunMode_TypeDefinitionIndex)->GetStaticField(0x7320);
		}
		static ::System::Single* StaticGet_DISPOSE_CHECK_TIME()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(AssetPoolRunMode_TypeDefinitionIndex)->GetStaticField(0x3A40);
		}
		static ::System::Int32* StaticGet_DEFAULT_TIME_OUT()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AssetPoolRunMode_TypeDefinitionIndex)->GetStaticField(0x3A44);
		}
		static ::System::Boolean* StaticGet_allowUIInPool()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(AssetPoolRunMode_TypeDefinitionIndex)->GetStaticField(0x3A48);
		}
		// static const ::System::Int32 DEFAULT_CAPCITY = 0x64; // 0x0
		// static const ::System::Int32 EMPTY_DEFAULT_CAPCITY = 0x1E; // 0x0
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::Foundation::TemporarayTracker*>* strTempPool; // 0x10
		...
		::System::Collections::Generic::HashSet_1<::Foundation::AssetPath>* requestCachedStatus; // 0x30
