...
#define FOUNDATION_SERIALIZEX_SERIALIZETOBASE64_OFFSET UNITYSDK_OFFSET(0x1B61A490)
#define FOUNDATION_SERIALIZEX_SERIALIZETOBYTES_OFFSET UNITYSDK_OFFSET(0x1B61A180)
#define FOUNDATION_SERIALIZEX_SERIALIZETOUTF8STRING_OFFSET UNITYSDK_OFFSET(0x1B61A360)
#define FOUNDATION_SERIALIZEX_TOBINARY_OFFSET UNITYSDK_OFFSET(0x1B619DA0)
#define FOUNDATION_SERIALIZEX_TOJSON_OFFSET UNITYSDK_OFFSET(0x1B619D50)

namespace Foundation
{
	inline static constexpr unsigned int SerializeX_TypeDefinitionIndex = 7836;
