...
#define FOUNDATION_MULTIVERSIONERRORREF__CTOR_OFFSET UNITYSDK_OFFSET(0x1E752500)

namespace Foundation
{
	inline static constexpr unsigned int MultiVersionErrorRef_TypeDefinitionIndex = 7994;
