...
#define FOUNDATION_TIMESLICEDLOADER_ADDLOADERTASK_OFFSET UNITYSDK_OFFSET(0x1AA126E0)
#define FOUNDATION_TIMESLICEDLOADER_GET_ISDONE_OFFSET UNITYSDK_OFFSET(0x1AA124C0)
#define FOUNDATION_TIMESLICEDLOADER_GET_LOADERTYPE_OFFSET UNITYSDK_OFFSET(0x1AA124B0)
#define FOUNDATION_TIMESLICEDLOADER_GET_ONFINISHED_OFFSET UNITYSDK_OFFSET(0x1AA124F0)
#define FOUNDATION_TIMESLICEDLOADER_GET_ONPROGRESS_OFFSET UNITYSDK_OFFSET(0x1AA124D0)
#define FOUNDATION_TIMESLICEDLOADER_GET_TIMESLICECOND_OFFSET UNITYSDK_OFFSET(0x1AA12510)
#define FOUNDATION_TIMESLICEDLOADER_ONTASKEND_OFFSET UNITYSDK_OFFSET(0x1AA12950)
#define FOUNDATION_TIMESLICEDLOADER_ONTASKLOADED_OFFSET UNITYSDK_OFFSET(0x1AA12870)
#define FOUNDATION_TIMESLICEDLOADER_SET_ONFINISHED_OFFSET UNITYSDK_OFFSET(0x1AA12500)
#define FOUNDATION_TIMESLICEDLOADER_SET_ONPROGRESS_OFFSET UNITYSDK_OFFSET(0x1AA124E0)
#define FOUNDATION_TIMESLICEDLOADER_SET_TIMESLICECOND_OFFSET UNITYSDK_OFFSET(0x1AA12520)
#define FOUNDATION_TIMESLICEDLOADER_START_OFFSET UNITYSDK_OFFSET(0x1AA129F0)
#define FOUNDATION_TIMESLICEDLOADER_TERMINATE_OFFSET UNITYSDK_OFFSET(0x1AA12A30)
#define FOUNDATION_TIMESLICEDLOADER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AA12B40)
#define FOUNDATION_TIMESLICEDLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA12530)

namespace Foundation
{
	inline static constexpr unsigned int TimeSlicedLoader_TypeDefinitionIndex = 7735;

	class TimeSlicedLoader : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::System::Exception*>* errorList; // 0x10
		::System::Collections::Generic::HashSet_1<::Foundation::TimeSlicedLoaderNode*>* pendingTasks; // 0x18
		::System::Action_2<::System::Int32, ::System::Collections::Generic::List_1<::System::Exception*>*>* _OnFinished_k__BackingField; // 0x20
		::System::Collections::Generic::Queue_1<::Foundation::TimeSlicedLoaderNode*>* callbackTasks; // 0x28
		::System::Diagnostics::Stopwatch* stopwatch; // 0x30
		::System::Action_2<::System::Int32, ::System::Int32>* _OnProgress_k__BackingField; // 0x38
		::System::Int64 _TimeSliceCond_k__BackingField; // 0x40
		::System::Int32 completeCount; // 0x48
		::System::Int32 totalCount; // 0x4C
