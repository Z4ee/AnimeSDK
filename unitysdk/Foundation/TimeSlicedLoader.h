...
#define FOUNDATION_TIMESLICEDLOADER_ADDLOADERTASK_OFFSET UNITYSDK_OFFSET(0x1E197350)
#define FOUNDATION_TIMESLICEDLOADER_GET_ISDONE_OFFSET UNITYSDK_OFFSET(0x1E197130)
#define FOUNDATION_TIMESLICEDLOADER_GET_LOADERTYPE_OFFSET UNITYSDK_OFFSET(0x1E197120)
#define FOUNDATION_TIMESLICEDLOADER_GET_ONFINISHED_OFFSET UNITYSDK_OFFSET(0x1E197160)
#define FOUNDATION_TIMESLICEDLOADER_GET_ONPROGRESS_OFFSET UNITYSDK_OFFSET(0x1E197140)
#define FOUNDATION_TIMESLICEDLOADER_GET_TIMESLICECOND_OFFSET UNITYSDK_OFFSET(0x1E197180)
#define FOUNDATION_TIMESLICEDLOADER_ONTASKEND_OFFSET UNITYSDK_OFFSET(0x1E1975C0)
#define FOUNDATION_TIMESLICEDLOADER_ONTASKLOADED_OFFSET UNITYSDK_OFFSET(0x1E1974E0)
#define FOUNDATION_TIMESLICEDLOADER_SET_ONFINISHED_OFFSET UNITYSDK_OFFSET(0x1E197170)
#define FOUNDATION_TIMESLICEDLOADER_SET_ONPROGRESS_OFFSET UNITYSDK_OFFSET(0x1E197150)
#define FOUNDATION_TIMESLICEDLOADER_SET_TIMESLICECOND_OFFSET UNITYSDK_OFFSET(0x1E197190)
#define FOUNDATION_TIMESLICEDLOADER_START_OFFSET UNITYSDK_OFFSET(0x1E197660)
#define FOUNDATION_TIMESLICEDLOADER_TERMINATE_OFFSET UNITYSDK_OFFSET(0x1E1976A0)
#define FOUNDATION_TIMESLICEDLOADER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E1977B0)
#define FOUNDATION_TIMESLICEDLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1971A0)

namespace Foundation
{
	inline static constexpr unsigned int TimeSlicedLoader_TypeDefinitionIndex = 8217;
	...
	public:
		...
		::System::Action_2<::System::Int32, ::System::Int32>* _OnProgress_k__BackingField; // 0x20
		::System::Collections::Generic::List_1<::System::Exception*>* errorList; // 0x28
		::System::Collections::Generic::Queue_1<::Foundation::TimeSlicedLoaderNode*>* callbackTasks; // 0x30
		::System::Action_2<::System::Int32, ::System::Collections::Generic::List_1<::System::Exception*>*>* _OnFinished_k__BackingField; // 0x38
		::System::Int32 totalCount; // 0x40
		::System::Int32 completeCount; // 0x44
