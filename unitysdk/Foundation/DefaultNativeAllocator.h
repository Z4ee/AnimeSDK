...
#define FOUNDATION_DEFAULTNATIVEALLOCATOR_EQUALS_OFFSET UNITYSDK_OFFSET(0x661410)
#define FOUNDATION_DEFAULTNATIVEALLOCATOR_FREE_OFFSET UNITYSDK_OFFSET(0x924760)
#define FOUNDATION_DEFAULTNATIVEALLOCATOR_GET_ISCREATED_OFFSET UNITYSDK_OFFSET(0x726120)
#define FOUNDATION_DEFAULTNATIVEALLOCATOR_MALLOC_OFFSET UNITYSDK_OFFSET(0x924780)
#define FOUNDATION_DEFAULTNATIVEALLOCATOR_RESOLVE_OFFSET UNITYSDK_OFFSET(0x9247A0)
#define FOUNDATION_DEFAULTNATIVEALLOCATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x2E85F0)

namespace Foundation
{
	inline static constexpr unsigned int DefaultNativeAllocator_TypeDefinitionIndex = 8856;
