...
#define FOUNDATION_IENUMERATORLOADER__LOADLOOPER_D__42_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BEDD710)
#define FOUNDATION_IENUMERATORLOADER__LOADLOOPER_D__42_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BEDDA40)
#define FOUNDATION_IENUMERATORLOADER__LOADLOOPER_D__42_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BEDDAA0)
#define FOUNDATION_IENUMERATORLOADER__LOADLOOPER_D__42_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BEDDA50)
#define FOUNDATION_IENUMERATORLOADER__LOADLOOPER_D__42_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BEDD700)
#define FOUNDATION_IENUMERATORLOADER__LOADLOOPER_D__42__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEDD6F0)

namespace Foundation
{
	inline static constexpr unsigned int IEnumeratorLoader__LoadLooper_d__42_TypeDefinitionIndex = 8165;
