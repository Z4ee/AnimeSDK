...
#define FOUNDATION_IENUMERATORLOADER__LOADLOOPER_D__42_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1F62D930)
#define FOUNDATION_IENUMERATORLOADER__LOADLOOPER_D__42_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1F62DC60)
#define FOUNDATION_IENUMERATORLOADER__LOADLOOPER_D__42_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1F62DCC0)
#define FOUNDATION_IENUMERATORLOADER__LOADLOOPER_D__42_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1F62DC70)
#define FOUNDATION_IENUMERATORLOADER__LOADLOOPER_D__42_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1F62D920)
#define FOUNDATION_IENUMERATORLOADER__LOADLOOPER_D__42__CTOR_OFFSET UNITYSDK_OFFSET(0x1F62D910)

namespace Foundation
{
	inline static constexpr unsigned int IEnumeratorLoader__LoadLooper_d__42_TypeDefinitionIndex = 8166;
