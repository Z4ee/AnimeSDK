...
#define FOUNDATION_TICKSERVICE_FOUNDATION_IGAMESERVICE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1DDA4B00)
#define FOUNDATION_TICKSERVICE_FOUNDATION_IGAMESERVICE_ONREADYTODESTROY_OFFSET UNITYSDK_OFFSET(0x1DDA4AF0)
#define FOUNDATION_TICKSERVICE_FOUNDATION_ITICKSERVICE_FOUNDATION_ETICKINGGROUP__ADDTICKFUNCTION_OFFSET UNITYSDK_OFFSET(0x1DDA46C0)
#define FOUNDATION_TICKSERVICE_FOUNDATION_ITICKSERVICE_FOUNDATION_ETICKINGGROUP__ENDSUBFRAME_OFFSET UNITYSDK_OFFSET(0x1DDA4580)
#define FOUNDATION_TICKSERVICE_FOUNDATION_ITICKSERVICE_FOUNDATION_ETICKINGGROUP__HASTICKFUNCTION_OFFSET UNITYSDK_OFFSET(0x1DDA45D0)
#define FOUNDATION_TICKSERVICE_FOUNDATION_ITICKSERVICE_FOUNDATION_ETICKINGGROUP__MARKDEPENDENCYGRAPHDIRTY_OFFSET UNITYSDK_OFFSET(0x1DDA4A10)
#define FOUNDATION_TICKSERVICE_FOUNDATION_ITICKSERVICE_FOUNDATION_ETICKINGGROUP__REMOVETICKFUNCTION_OFFSET UNITYSDK_OFFSET(0x1DDA4930)
#define FOUNDATION_TICKSERVICE_FOUNDATION_ITICKSERVICE_FOUNDATION_ETICKINGGROUP__RUNTTICKGROUP_OFFSET UNITYSDK_OFFSET(0x1DDA4530)
#define FOUNDATION_TICKSERVICE_FOUNDATION_ITICKSERVICE_FOUNDATION_ETICKINGGROUP__STARTFRAME_OFFSET UNITYSDK_OFFSET(0x1DDA4490)
#define FOUNDATION_TICKSERVICE_FOUNDATION_ITICKSERVICE_FOUNDATION_ETICKINGGROUP__STARTNEXTSUBFRAME_OFFSET UNITYSDK_OFFSET(0x1DDA44E0)
#define FOUNDATION_TICKSERVICE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1DDA41C0)
#define FOUNDATION_TICKSERVICE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1DDA3E40)
#define FOUNDATION_TICKSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDA4B10)

namespace Foundation
{
	inline static constexpr unsigned int TickService_TypeDefinitionIndex = 8624;
