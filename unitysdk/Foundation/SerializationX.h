...
#define FOUNDATION_SERIALIZATIONX_GUIDFROMSERIALSTRING_OFFSET UNITYSDK_OFFSET(0x1D972D50)
#define FOUNDATION_SERIALIZATIONX_GUIDNULLABLEFROMSERIALSTRING_OFFSET UNITYSDK_OFFSET(0x1D972C80)
#define FOUNDATION_SERIALIZATIONX_READBBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x1D972EA0)
#define FOUNDATION_SERIALIZATIONX_READDATETIMEASLOCALTIME_OFFSET UNITYSDK_OFFSET(0x1D973420)
#define FOUNDATION_SERIALIZATIONX_READDATETIMEASUTC_OFFSET UNITYSDK_OFFSET(0x1D973350)
#define FOUNDATION_SERIALIZATIONX_READGUIDNULLABLE_OFFSET UNITYSDK_OFFSET(0x1D973080)
#define FOUNDATION_SERIALIZATIONX_READGUID_OFFSET UNITYSDK_OFFSET(0x1D973100)
#define FOUNDATION_SERIALIZATIONX_READVECTOR2_OFFSET UNITYSDK_OFFSET(0x1D973840)
#define FOUNDATION_SERIALIZATIONX_READVECTOR3_OFFSET UNITYSDK_OFFSET(0x1D973780)
#define FOUNDATION_SERIALIZATIONX_TOSTRINGSERIAL_1_OFFSET UNITYSDK_OFFSET(0x1D972AD0)
#define FOUNDATION_SERIALIZATIONX_TOSTRINGSERIAL_2_OFFSET UNITYSDK_OFFSET(0x1D972C20)
#define FOUNDATION_SERIALIZATIONX_TOSTRINGSERIAL_OFFSET UNITYSDK_OFFSET(0x1D972A60)
#define FOUNDATION_SERIALIZATIONX_WRITEBOOL_OFFSET UNITYSDK_OFFSET(0x1D9738D0)
#define FOUNDATION_SERIALIZATIONX_WRITEBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x1D972E00)
#define FOUNDATION_SERIALIZATIONX_WRITEDATETIME_OFFSET UNITYSDK_OFFSET(0x1D9732D0)
#define FOUNDATION_SERIALIZATIONX_WRITEFLOAT_OFFSET UNITYSDK_OFFSET(0x1D9735E0)
#define FOUNDATION_SERIALIZATIONX_WRITEGUID_1_OFFSET UNITYSDK_OFFSET(0x1D972FB0)
#define FOUNDATION_SERIALIZATIONX_WRITEGUID_OFFSET UNITYSDK_OFFSET(0x1D972F20)
#define FOUNDATION_SERIALIZATIONX_WRITEINT_OFFSET UNITYSDK_OFFSET(0x1D973500)
#define FOUNDATION_SERIALIZATIONX_WRITELONG_OFFSET UNITYSDK_OFFSET(0x1D973570)
#define FOUNDATION_SERIALIZATIONX_WRITESERIALIZEDSTRING_OFFSET UNITYSDK_OFFSET(0x1D973210)
#define FOUNDATION_SERIALIZATIONX_WRITEVECTOR2_OFFSET UNITYSDK_OFFSET(0x1D9736F0)
#define FOUNDATION_SERIALIZATIONX_WRITEVECTOR3_OFFSET UNITYSDK_OFFSET(0x1D973650)

namespace Foundation
{
	inline static constexpr unsigned int SerializationX_TypeDefinitionIndex = 8180;
