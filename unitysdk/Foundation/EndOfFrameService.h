...
#define FOUNDATION_ENDOFFRAMESERVICE_DOENDOFFRAMEWORK_OFFSET UNITYSDK_OFFSET(0x1F9BF300)
#define FOUNDATION_ENDOFFRAMESERVICE_FOUNDATION_IGAMESERVICE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1F9BF8F0)
#define FOUNDATION_ENDOFFRAMESERVICE_FOUNDATION_IGAMESERVICE_ONREADYTODESTROY_OFFSET UNITYSDK_OFFSET(0x1F9BF8E0)
#define FOUNDATION_ENDOFFRAMESERVICE_INVOKECALLONCECALLBACK_OFFSET UNITYSDK_OFFSET(0x1F9BF2D0)
#define FOUNDATION_ENDOFFRAMESERVICE_INVOKESELFDETERMINEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1F9BF1D0)
#define FOUNDATION_ENDOFFRAMESERVICE_REGISTER_OFFSET UNITYSDK_OFFSET(0x1F9BF700)
#define FOUNDATION_ENDOFFRAMESERVICE_START_OFFSET UNITYSDK_OFFSET(0x1F9BF180)
#define FOUNDATION_ENDOFFRAMESERVICE_UNREGISTER_OFFSET UNITYSDK_OFFSET(0x1F9BF7F0)
#define FOUNDATION_ENDOFFRAMESERVICE_VALIDATEINVARIANT_OFFSET UNITYSDK_OFFSET(0x1F9BF2F0)
#define FOUNDATION_ENDOFFRAMESERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F9BEF30)

namespace Foundation
{
	inline static constexpr unsigned int EndOfFrameService_TypeDefinitionIndex = 8678;

	class EndOfFrameService : public ::System::Object
	{
	public:
		::Il2CppArray<::System::Action*>* _callOnceCallbacks; // 0x10
		::Il2CppArray<::System::Collections::Generic::List_1<::System::Func_1<::System::Boolean>*>*>* _selfDeterminedCallbacks; // 0x18
		::UnityEngine::WaitForEndOfFrame* _endOfFrame; // 0x20
		::Il2CppArray<::System::Action*>* _callbacks; // 0x28
