...
#define FOUNDATION_NAPSTRINGINTERNCACHEBACKENDSIMPLE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1D2E7340)
#define FOUNDATION_NAPSTRINGINTERNCACHEBACKENDSIMPLE_GETINTERNEDSTRING_OFFSET UNITYSDK_OFFSET(0x1D2E7530)
#define FOUNDATION_NAPSTRINGINTERNCACHEBACKENDSIMPLE_GET_CACHEDSTRINGCOUNT_OFFSET UNITYSDK_OFFSET(0x1D2E7250)
#define FOUNDATION_NAPSTRINGINTERNCACHEBACKENDSIMPLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2E77E0)

namespace Foundation
{
	inline static constexpr unsigned int NapStringInternCacheBackendSimple_TypeDefinitionIndex = 8130;
