...
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IREADERLOCK_ACQUIREREADERLOCK_1_OFFSET UNITYSDK_OFFSET(0x1F467E30)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IREADERLOCK_ACQUIREREADERLOCK_OFFSET UNITYSDK_OFFSET(0x1F467DF0)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IREADERLOCK_ISREADERLOCKHELD_OFFSET UNITYSDK_OFFSET(0x1F467EA0)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IREADERLOCK_RELEASEREADERLOCK_OFFSET UNITYSDK_OFFSET(0x1F467E80)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IWRITERLOCK_ACQUIREWRITERLOCK_1_OFFSET UNITYSDK_OFFSET(0x1F467F80)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IWRITERLOCK_ACQUIREWRITERLOCK_OFFSET UNITYSDK_OFFSET(0x1F467F40)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IWRITERLOCK_ISWRITERLOCKHELD_OFFSET UNITYSDK_OFFSET(0x1F467FF0)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IWRITERLOCK_RELEASEWRITERLOCK_OFFSET UNITYSDK_OFFSET(0x1F467FD0)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM__CTOR_OFFSET UNITYSDK_OFFSET(0x1F467D50)

namespace Foundation
{
	inline static constexpr unsigned int SystemReaderWriterLockSlim_TypeDefinitionIndex = 8804;
