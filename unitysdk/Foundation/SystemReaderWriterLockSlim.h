...
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IREADERLOCK_ACQUIREREADERLOCK_1_OFFSET UNITYSDK_OFFSET(0x1BCA1890)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IREADERLOCK_ACQUIREREADERLOCK_OFFSET UNITYSDK_OFFSET(0x1BCA1850)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IREADERLOCK_ISREADERLOCKHELD_OFFSET UNITYSDK_OFFSET(0x1BCA1900)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IREADERLOCK_RELEASEREADERLOCK_OFFSET UNITYSDK_OFFSET(0x1BCA18E0)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IWRITERLOCK_ACQUIREWRITERLOCK_1_OFFSET UNITYSDK_OFFSET(0x1BCA19E0)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IWRITERLOCK_ACQUIREWRITERLOCK_OFFSET UNITYSDK_OFFSET(0x1BCA19A0)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IWRITERLOCK_ISWRITERLOCKHELD_OFFSET UNITYSDK_OFFSET(0x1BCA1A50)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IWRITERLOCK_RELEASEWRITERLOCK_OFFSET UNITYSDK_OFFSET(0x1BCA1A30)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCA17B0)

namespace Foundation
{
	inline static constexpr unsigned int SystemReaderWriterLockSlim_TypeDefinitionIndex = 9138;
