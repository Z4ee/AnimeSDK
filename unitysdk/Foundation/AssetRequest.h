...
#define FOUNDATION_ASSETREQUEST_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x1E1A3F10)
#define FOUNDATION_ASSETREQUEST_GETINSTANCEASYNC_OFFSET UNITYSDK_OFFSET(0x1E1A4320)
#define FOUNDATION_ASSETREQUEST_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1E1A3F60)
#define FOUNDATION_ASSETREQUEST_INIT_OFFSET UNITYSDK_OFFSET(0x1E1A36B0)
#define FOUNDATION_ASSETREQUEST_LOADIMMEDIATE_OFFSET UNITYSDK_OFFSET(0x1E1A3BD0)
#define FOUNDATION_ASSETREQUEST_LOAD_OFFSET UNITYSDK_OFFSET(0x1E1A3710)
#define FOUNDATION_ASSETREQUEST_RECYCLE_OFFSET UNITYSDK_OFFSET(0x1E1A3E80)
#define FOUNDATION_ASSETREQUEST_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1E1A3C10)
#define FOUNDATION_ASSETREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1A4400)
#define FOUNDATION_ASSETREQUEST___BASE_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x1E1A4410)
#define FOUNDATION_ASSETREQUEST___BASE_GETINSTANCEASYNC_OFFSET UNITYSDK_OFFSET(0x1E1A44F0)
#define FOUNDATION_ASSETREQUEST___BASE_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1E1A4420)
#define FOUNDATION_ASSETREQUEST___BASE_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1E1A4530)

namespace Foundation
{
	inline static constexpr unsigned int AssetRequest_TypeDefinitionIndex = 7869;
