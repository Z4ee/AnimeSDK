...
#define FOUNDATION_DATASTRUCTURES_MARVIN32_COMPUTEHASH_1_OFFSET UNITYSDK_OFFSET(0x1B85A780)
#define FOUNDATION_DATASTRUCTURES_MARVIN32_COMPUTEHASH_2_OFFSET UNITYSDK_OFFSET(0x1B85A6E0)
#define FOUNDATION_DATASTRUCTURES_MARVIN32_COMPUTEHASH_OFFSET UNITYSDK_OFFSET(0x1B85A4D0)
#define FOUNDATION_DATASTRUCTURES_MARVIN32_MARVIN32_MIX_OFFSET UNITYSDK_OFFSET(0x1B85A110)
#define FOUNDATION_DATASTRUCTURES_MARVIN32_ROTL32_OFFSET UNITYSDK_OFFSET(0x1B859F40)
#define FOUNDATION_DATASTRUCTURES_MARVIN32_U8TO32_LE_OFFSET UNITYSDK_OFFSET(0x1B85A100)

namespace Foundation::DataStructures
{
	inline static constexpr unsigned int Marvin32_TypeDefinitionIndex = 8369;
