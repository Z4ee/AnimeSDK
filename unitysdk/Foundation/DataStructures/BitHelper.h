...
#define FOUNDATION_DATASTRUCTURES_BITHELPER_ISMARKED_OFFSET UNITYSDK_OFFSET(0x1D95E100)
#define FOUNDATION_DATASTRUCTURES_BITHELPER_MARKBIT_OFFSET UNITYSDK_OFFSET(0x1D95E040)
#define FOUNDATION_DATASTRUCTURES_BITHELPER_TOINTARRAYLENGTH_OFFSET UNITYSDK_OFFSET(0x1D95E1B0)
#define FOUNDATION_DATASTRUCTURES_BITHELPER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D95E030)
#define FOUNDATION_DATASTRUCTURES_BITHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D95E020)

namespace Foundation::DataStructures
{
	inline static constexpr unsigned int BitHelper_TypeDefinitionIndex = 8470;
	...
	public:
		...
		::System::Int32* m_arrayPtr; // 0x18
		::System::Boolean useStackAlloc; // 0x20
