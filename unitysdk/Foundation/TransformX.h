...
#define FOUNDATION_TRANSFORMX_ADJUSTLOCALX_OFFSET UNITYSDK_OFFSET(0x19DB1740)
#define FOUNDATION_TRANSFORMX_ADJUSTLOCALY_OFFSET UNITYSDK_OFFSET(0x19DB17E0)
#define FOUNDATION_TRANSFORMX_ADJUSTLOCALZ_OFFSET UNITYSDK_OFFSET(0x19DB1890)
#define FOUNDATION_TRANSFORMX_COPYFROM_OFFSET UNITYSDK_OFFSET(0x19DB1D80)
#define FOUNDATION_TRANSFORMX_FLIP_OFFSET UNITYSDK_OFFSET(0x19DB1930)
#define FOUNDATION_TRANSFORMX_GETINCHILDREN_OFFSET UNITYSDK_OFFSET(0x19DB1EB0)
#define FOUNDATION_TRANSFORMX_GETPOSITIONX_OFFSET UNITYSDK_OFFSET(0x19DB1220)
#define FOUNDATION_TRANSFORMX_GETPOSITIONY_OFFSET UNITYSDK_OFFSET(0x19DB1290)
#define FOUNDATION_TRANSFORMX_GETPOSITIONZ_OFFSET UNITYSDK_OFFSET(0x19DB1300)
#define FOUNDATION_TRANSFORMX_RESET_OFFSET UNITYSDK_OFFSET(0x19DB1CD0)
#define FOUNDATION_TRANSFORMX_SETLOCALPOSITION_1_OFFSET UNITYSDK_OFFSET(0x19DB19F0)
#define FOUNDATION_TRANSFORMX_SETLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0x19DB1370)
#define FOUNDATION_TRANSFORMX_SETLOCALSCALE_OFFSET UNITYSDK_OFFSET(0x19DB1BD0)
#define FOUNDATION_TRANSFORMX_SETLOCALX_OFFSET UNITYSDK_OFFSET(0x19DB1550)
#define FOUNDATION_TRANSFORMX_SETLOCALY_OFFSET UNITYSDK_OFFSET(0x19DB15F0)
#define FOUNDATION_TRANSFORMX_SETLOCALZ_OFFSET UNITYSDK_OFFSET(0x19DB16A0)
#define FOUNDATION_TRANSFORMX_SETPOSITIONX_1_OFFSET UNITYSDK_OFFSET(0x19DB0DF0)
#define FOUNDATION_TRANSFORMX_SETPOSITIONX_OFFSET UNITYSDK_OFFSET(0x19DB0CC0)
#define FOUNDATION_TRANSFORMX_SETPOSITIONY_1_OFFSET UNITYSDK_OFFSET(0x19DB0FC0)
#define FOUNDATION_TRANSFORMX_SETPOSITIONY_OFFSET UNITYSDK_OFFSET(0x19DB0E80)
#define FOUNDATION_TRANSFORMX_SETPOSITIONZ_1_OFFSET UNITYSDK_OFFSET(0x19DB1190)
#define FOUNDATION_TRANSFORMX_SETPOSITIONZ_OFFSET UNITYSDK_OFFSET(0x19DB1060)
#define FOUNDATION_TRANSFORMX_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x19DB1AE0)

namespace Foundation
{
	inline static constexpr unsigned int TransformX_TypeDefinitionIndex = 7721;
