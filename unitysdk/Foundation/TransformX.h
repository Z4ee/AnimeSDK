...
#define FOUNDATION_TRANSFORMX_ADJUSTLOCALX_OFFSET UNITYSDK_OFFSET(0x1D5A0150)
#define FOUNDATION_TRANSFORMX_ADJUSTLOCALY_OFFSET UNITYSDK_OFFSET(0x1D5A01F0)
#define FOUNDATION_TRANSFORMX_ADJUSTLOCALZ_OFFSET UNITYSDK_OFFSET(0x1D5A02A0)
#define FOUNDATION_TRANSFORMX_COPYFROM_OFFSET UNITYSDK_OFFSET(0x1D5A0790)
#define FOUNDATION_TRANSFORMX_FLIP_OFFSET UNITYSDK_OFFSET(0x1D5A0340)
#define FOUNDATION_TRANSFORMX_GETINCHILDREN_OFFSET UNITYSDK_OFFSET(0x1D5A08C0)
#define FOUNDATION_TRANSFORMX_GETPOSITIONX_OFFSET UNITYSDK_OFFSET(0x1D59FC30)
#define FOUNDATION_TRANSFORMX_GETPOSITIONY_OFFSET UNITYSDK_OFFSET(0x1D59FCA0)
#define FOUNDATION_TRANSFORMX_GETPOSITIONZ_OFFSET UNITYSDK_OFFSET(0x1D59FD10)
#define FOUNDATION_TRANSFORMX_RESET_OFFSET UNITYSDK_OFFSET(0x1D5A06E0)
#define FOUNDATION_TRANSFORMX_SETLOCALPOSITION_1_OFFSET UNITYSDK_OFFSET(0x1D5A0400)
#define FOUNDATION_TRANSFORMX_SETLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0x1D59FD80)
#define FOUNDATION_TRANSFORMX_SETLOCALSCALE_OFFSET UNITYSDK_OFFSET(0x1D5A05E0)
#define FOUNDATION_TRANSFORMX_SETLOCALX_OFFSET UNITYSDK_OFFSET(0x1D59FF60)
#define FOUNDATION_TRANSFORMX_SETLOCALY_OFFSET UNITYSDK_OFFSET(0x1D5A0000)
#define FOUNDATION_TRANSFORMX_SETLOCALZ_OFFSET UNITYSDK_OFFSET(0x1D5A00B0)
#define FOUNDATION_TRANSFORMX_SETPOSITIONX_1_OFFSET UNITYSDK_OFFSET(0x1D59F800)
#define FOUNDATION_TRANSFORMX_SETPOSITIONX_OFFSET UNITYSDK_OFFSET(0x1D59F6D0)
#define FOUNDATION_TRANSFORMX_SETPOSITIONY_1_OFFSET UNITYSDK_OFFSET(0x1D59F9D0)
#define FOUNDATION_TRANSFORMX_SETPOSITIONY_OFFSET UNITYSDK_OFFSET(0x1D59F890)
#define FOUNDATION_TRANSFORMX_SETPOSITIONZ_1_OFFSET UNITYSDK_OFFSET(0x1D59FBA0)
#define FOUNDATION_TRANSFORMX_SETPOSITIONZ_OFFSET UNITYSDK_OFFSET(0x1D59FA70)
#define FOUNDATION_TRANSFORMX_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x1D5A04F0)

namespace Foundation
{
	inline static constexpr unsigned int TransformX_TypeDefinitionIndex = 7981;
