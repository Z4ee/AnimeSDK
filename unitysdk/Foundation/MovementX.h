...
#define FOUNDATION_MOVEMENTX_MOVEBYFORCEPUSHING_WITHPHYSICS_OFFSET UNITYSDK_OFFSET(0x1C5D6690)
#define FOUNDATION_MOVEMENTX_MOVEBYVELOCITY_WITHPHYSICS_OFFSET UNITYSDK_OFFSET(0x1C5D6730)
#define FOUNDATION_MOVEMENTX_MOVETOWARDSINTERPOLATE_NOPHYSICS_1_OFFSET UNITYSDK_OFFSET(0x1C5D6370)
#define FOUNDATION_MOVEMENTX_MOVETOWARDSINTERPOLATE_NOPHYSICS_2_OFFSET UNITYSDK_OFFSET(0x1C5D6410)
#define FOUNDATION_MOVEMENTX_MOVETOWARDSINTERPOLATE_NOPHYSICS_3_OFFSET UNITYSDK_OFFSET(0x1C5D6260)
#define FOUNDATION_MOVEMENTX_MOVETOWARDSINTERPOLATE_NOPHYSICS_OFFSET UNITYSDK_OFFSET(0x1C5D6180)
#define FOUNDATION_MOVEMENTX_MOVETOWARDS_NOPHYSICS_1_OFFSET UNITYSDK_OFFSET(0x1C5D5F80)
#define FOUNDATION_MOVEMENTX_MOVETOWARDS_NOPHYSICS_2_OFFSET UNITYSDK_OFFSET(0x1C5D6090)
#define FOUNDATION_MOVEMENTX_MOVETOWARDS_NOPHYSICS_3_OFFSET UNITYSDK_OFFSET(0x1C5D5EF0)
#define FOUNDATION_MOVEMENTX_MOVETOWARDS_NOPHYSICS_OFFSET UNITYSDK_OFFSET(0x1C5D5DB0)
#define FOUNDATION_MOVEMENTX_MOVETOWARDS_WITHPHYSICS_OFFSET UNITYSDK_OFFSET(0x1C5D67D0)
#define FOUNDATION_MOVEMENTX_TELEPORTFORWARD_NOPHYSICS_1_OFFSET UNITYSDK_OFFSET(0x1C5D6530)
#define FOUNDATION_MOVEMENTX_TELEPORTFORWARD_NOPHYSICS_OFFSET UNITYSDK_OFFSET(0x1C5D64C0)

namespace Foundation
{
	inline static constexpr unsigned int MovementX_TypeDefinitionIndex = 8075;
