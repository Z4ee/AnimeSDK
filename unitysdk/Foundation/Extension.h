...
#define FOUNDATION_EXTENSION_ADD_OFFSET UNITYSDK_OFFSET(0x1BFF90B0)
#define FOUNDATION_EXTENSION_CLAMP_OFFSET UNITYSDK_OFFSET(0x1BFF5560)
#define FOUNDATION_EXTENSION_CONTAINNAN_OFFSET UNITYSDK_OFFSET(0x1BFF95C0)
#define FOUNDATION_EXTENSION_CROSS_OFFSET UNITYSDK_OFFSET(0x1BFF92E0)
#define FOUNDATION_EXTENSION_DELTA_OFFSET UNITYSDK_OFFSET(0x1BFF8D50)
#define FOUNDATION_EXTENSION_DIAGNOSTICCHECKNAN_ALL_OFFSET UNITYSDK_OFFSET(0x1BFF5B60)
#define FOUNDATION_EXTENSION_DIAGNOSTICCHECKNAN_ROTATION_OFFSET UNITYSDK_OFFSET(0x1BFF5B40)
#define FOUNDATION_EXTENSION_DIAGNOSTICCHECKNAN_SCALE_OFFSET UNITYSDK_OFFSET(0x1BFF5B50)
#define FOUNDATION_EXTENSION_DIAGNOSTICCHECKNAN_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x1BFF5B30)
#define FOUNDATION_EXTENSION_FROMTOROTATION_OFFSET UNITYSDK_OFFSET(0x1BFF8D80)
#define FOUNDATION_EXTENSION_GENERATECACHE_OFFSET UNITYSDK_OFFSET(0x1BFF54A0)
#define FOUNDATION_EXTENSION_GETFORWARDVECTOR_OFFSET UNITYSDK_OFFSET(0x1BFF80D0)
#define FOUNDATION_EXTENSION_GETINTERVALCOUNT_OFFSET UNITYSDK_OFFSET(0x1BFF54F0)
#define FOUNDATION_EXTENSION_GETINVERSED_OFFSET UNITYSDK_OFFSET(0x1BFF8900)
#define FOUNDATION_EXTENSION_GETRELATIVETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1BFF7430)
#define FOUNDATION_EXTENSION_GETRIGHTVECTOR_OFFSET UNITYSDK_OFFSET(0x1BFF8200)
#define FOUNDATION_EXTENSION_GETSAFESCALERECIPROCAL_OFFSET UNITYSDK_OFFSET(0x1BFF8070)
#define FOUNDATION_EXTENSION_GETUPVECTOR_OFFSET UNITYSDK_OFFSET(0x1BFF8330)
#define FOUNDATION_EXTENSION_IDENTITYNAPTRANSFORMDATA_OFFSET UNITYSDK_OFFSET(0x1BFF5820)
#define FOUNDATION_EXTENSION_INVERSETRANSFORMPOSITION_OFFSET UNITYSDK_OFFSET(0x1BFF6C00)
#define FOUNDATION_EXTENSION_ISCOMPONENTSEQUAL_OFFSET UNITYSDK_OFFSET(0x1BFF9600)
#define FOUNDATION_EXTENSION_ISNEARLYEQUAL_1_OFFSET UNITYSDK_OFFSET(0x1BFF9220)
#define FOUNDATION_EXTENSION_ISNEARLYEQUAL_2_OFFSET UNITYSDK_OFFSET(0x1BFF9320)
#define FOUNDATION_EXTENSION_ISNEARLYEQUAL_3_OFFSET UNITYSDK_OFFSET(0x1BFF94F0)
#define FOUNDATION_EXTENSION_ISNEARLYEQUAL_OFFSET UNITYSDK_OFFSET(0x1BFF5540)
#define FOUNDATION_EXTENSION_ISNEARLYRELATIVEEQUAL_OFFSET UNITYSDK_OFFSET(0x1BFF9240)
#define FOUNDATION_EXTENSION_ISNEARLYZERO_1_OFFSET UNITYSDK_OFFSET(0x1BFF8940)
#define FOUNDATION_EXTENSION_ISNEARLYZERO_2_OFFSET UNITYSDK_OFFSET(0x1BFF9270)
#define FOUNDATION_EXTENSION_ISNEARLYZERO_3_OFFSET UNITYSDK_OFFSET(0x1BFF92B0)
#define FOUNDATION_EXTENSION_ISNEARLYZERO_4_OFFSET UNITYSDK_OFFSET(0x1BFF9540)
#define FOUNDATION_EXTENSION_ISNEARLYZERO_OFFSET UNITYSDK_OFFSET(0x1BFF5530)
#define FOUNDATION_EXTENSION_ISNORMALIZED_1_OFFSET UNITYSDK_OFFSET(0x1BFF9580)
#define FOUNDATION_EXTENSION_ISNORMALIZED_OFFSET UNITYSDK_OFFSET(0x1BFF88C0)
#define FOUNDATION_EXTENSION_MEMBERWISEMULTIPLY_OFFSET UNITYSDK_OFFSET(0x1BFF9640)
#define FOUNDATION_EXTENSION_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1BFF6E80)
#define FOUNDATION_EXTENSION_NEWNAPTRANSFORMDATA_1_OFFSET UNITYSDK_OFFSET(0x1BFF5930)
#define FOUNDATION_EXTENSION_NEWNAPTRANSFORMDATA_OFFSET UNITYSDK_OFFSET(0x1BFF58B0)
#define FOUNDATION_EXTENSION_POW_OFFSET UNITYSDK_OFFSET(0x1BFF5E20)
#define FOUNDATION_EXTENSION_ROTATE_OFFSET UNITYSDK_OFFSET(0x1BFF8F40)
#define FOUNDATION_EXTENSION_SETAXIS_OFFSET UNITYSDK_OFFSET(0x1BFF5590)
#define FOUNDATION_EXTENSION_SETBLENDIN_OFFSET UNITYSDK_OFFSET(0x1BFF9680)
#define FOUNDATION_EXTENSION_SETBLENDOUT_OFFSET UNITYSDK_OFFSET(0x1BFF9730)
#define FOUNDATION_EXTENSION_SETIDENTITY_OFFSET UNITYSDK_OFFSET(0x1BFF6E40)
#define FOUNDATION_EXTENSION_SETPRIORITY_OFFSET UNITYSDK_OFFSET(0x1BFF97E0)
#define FOUNDATION_EXTENSION_SETTIME_OFFSET UNITYSDK_OFFSET(0x1BFF9670)
#define FOUNDATION_EXTENSION_SETTORELATIVETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1BFF7A30)
#define FOUNDATION_EXTENSION_SIGN_OFFSET UNITYSDK_OFFSET(0x1BFF9280)
#define FOUNDATION_EXTENSION_TOFLOAT_OFFSET UNITYSDK_OFFSET(0x1BFF5580)
#define FOUNDATION_EXTENSION_TOINVERSEMATRIXWITHSCALE_OFFSET UNITYSDK_OFFSET(0x1BFF5CA0)
#define FOUNDATION_EXTENSION_TOMATRIXWITHSCALE_OFFSET UNITYSDK_OFFSET(0x1BFF5B70)
#define FOUNDATION_EXTENSION_TOORIENTEDEULER_OFFSET UNITYSDK_OFFSET(0x1BFF9420)
#define FOUNDATION_EXTENSION_TOORIENTEDQUATERNION_OFFSET UNITYSDK_OFFSET(0x1BFF9360)
#define FOUNDATION_EXTENSION_TOPITCHYAWROLL_OFFSET UNITYSDK_OFFSET(0x1BFF8970)
#define FOUNDATION_EXTENSION_TOSWINGTWIST_OFFSET UNITYSDK_OFFSET(0x1BFF8460)
#define FOUNDATION_EXTENSION_TOTRANSLATIONROTATIONSCALE_OFFSET UNITYSDK_OFFSET(0x1BFF5690)
#define FOUNDATION_EXTENSION_TOTWISTSWING_OFFSET UNITYSDK_OFFSET(0x1BFF8690)
#define FOUNDATION_EXTENSION_TRANSFORMPOSITIONNOSCALE_OFFSET UNITYSDK_OFFSET(0x1BFF6AA0)
#define FOUNDATION_EXTENSION_TRANSFORMPOSITION_OFFSET UNITYSDK_OFFSET(0x1BFF6950)

namespace Foundation
{
	inline static constexpr unsigned int Extension_TypeDefinitionIndex = 9110;
