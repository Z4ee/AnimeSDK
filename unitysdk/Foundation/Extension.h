...
#define FOUNDATION_EXTENSION_ADD_OFFSET UNITYSDK_OFFSET(0x1E6B7870)
#define FOUNDATION_EXTENSION_CLAMP_OFFSET UNITYSDK_OFFSET(0x1E6B3D20)
#define FOUNDATION_EXTENSION_CONTAINNAN_OFFSET UNITYSDK_OFFSET(0x1E6B7D80)
#define FOUNDATION_EXTENSION_CROSS_OFFSET UNITYSDK_OFFSET(0x1E6B7AA0)
#define FOUNDATION_EXTENSION_DELTA_OFFSET UNITYSDK_OFFSET(0x1E6B7510)
#define FOUNDATION_EXTENSION_DIAGNOSTICCHECKNAN_ALL_OFFSET UNITYSDK_OFFSET(0x1E6B4320)
#define FOUNDATION_EXTENSION_DIAGNOSTICCHECKNAN_ROTATION_OFFSET UNITYSDK_OFFSET(0x1E6B4300)
#define FOUNDATION_EXTENSION_DIAGNOSTICCHECKNAN_SCALE_OFFSET UNITYSDK_OFFSET(0x1E6B4310)
#define FOUNDATION_EXTENSION_DIAGNOSTICCHECKNAN_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x1E6B42F0)
#define FOUNDATION_EXTENSION_FROMTOROTATION_OFFSET UNITYSDK_OFFSET(0x1E6B7540)
#define FOUNDATION_EXTENSION_GENERATECACHE_OFFSET UNITYSDK_OFFSET(0x1E6B3C60)
#define FOUNDATION_EXTENSION_GETFORWARDVECTOR_OFFSET UNITYSDK_OFFSET(0x1E6B6890)
#define FOUNDATION_EXTENSION_GETINTERVALCOUNT_OFFSET UNITYSDK_OFFSET(0x1E6B3CB0)
#define FOUNDATION_EXTENSION_GETINVERSED_OFFSET UNITYSDK_OFFSET(0x1E6B70C0)
#define FOUNDATION_EXTENSION_GETRELATIVETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1E6B5BF0)
#define FOUNDATION_EXTENSION_GETRIGHTVECTOR_OFFSET UNITYSDK_OFFSET(0x1E6B69C0)
#define FOUNDATION_EXTENSION_GETSAFESCALERECIPROCAL_OFFSET UNITYSDK_OFFSET(0x1E6B6830)
#define FOUNDATION_EXTENSION_GETUPVECTOR_OFFSET UNITYSDK_OFFSET(0x1E6B6AF0)
#define FOUNDATION_EXTENSION_IDENTITYNAPTRANSFORMDATA_OFFSET UNITYSDK_OFFSET(0x1E6B3FE0)
#define FOUNDATION_EXTENSION_INVERSETRANSFORMPOSITION_OFFSET UNITYSDK_OFFSET(0x1E6B53C0)
#define FOUNDATION_EXTENSION_ISCOMPONENTSEQUAL_OFFSET UNITYSDK_OFFSET(0x1E6B7DC0)
#define FOUNDATION_EXTENSION_ISNEARLYEQUAL_1_OFFSET UNITYSDK_OFFSET(0x1E6B79E0)
#define FOUNDATION_EXTENSION_ISNEARLYEQUAL_2_OFFSET UNITYSDK_OFFSET(0x1E6B7AE0)
#define FOUNDATION_EXTENSION_ISNEARLYEQUAL_3_OFFSET UNITYSDK_OFFSET(0x1E6B7CB0)
#define FOUNDATION_EXTENSION_ISNEARLYEQUAL_OFFSET UNITYSDK_OFFSET(0x1E6B3D00)
#define FOUNDATION_EXTENSION_ISNEARLYRELATIVEEQUAL_OFFSET UNITYSDK_OFFSET(0x1E6B7A00)
#define FOUNDATION_EXTENSION_ISNEARLYZERO_1_OFFSET UNITYSDK_OFFSET(0x1E6B7100)
#define FOUNDATION_EXTENSION_ISNEARLYZERO_2_OFFSET UNITYSDK_OFFSET(0x1E6B7A30)
#define FOUNDATION_EXTENSION_ISNEARLYZERO_3_OFFSET UNITYSDK_OFFSET(0x1E6B7A70)
#define FOUNDATION_EXTENSION_ISNEARLYZERO_4_OFFSET UNITYSDK_OFFSET(0x1E6B7D00)
#define FOUNDATION_EXTENSION_ISNEARLYZERO_OFFSET UNITYSDK_OFFSET(0x1E6B3CF0)
#define FOUNDATION_EXTENSION_ISNORMALIZED_1_OFFSET UNITYSDK_OFFSET(0x1E6B7D40)
#define FOUNDATION_EXTENSION_ISNORMALIZED_OFFSET UNITYSDK_OFFSET(0x1E6B7080)
#define FOUNDATION_EXTENSION_MEMBERWISEMULTIPLY_OFFSET UNITYSDK_OFFSET(0x1E6B7E00)
#define FOUNDATION_EXTENSION_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1E6B5640)
#define FOUNDATION_EXTENSION_NEWNAPTRANSFORMDATA_1_OFFSET UNITYSDK_OFFSET(0x1E6B40F0)
#define FOUNDATION_EXTENSION_NEWNAPTRANSFORMDATA_OFFSET UNITYSDK_OFFSET(0x1E6B4070)
#define FOUNDATION_EXTENSION_POW_OFFSET UNITYSDK_OFFSET(0x1E6B45E0)
#define FOUNDATION_EXTENSION_ROTATE_OFFSET UNITYSDK_OFFSET(0x1E6B7700)
#define FOUNDATION_EXTENSION_SETAXIS_OFFSET UNITYSDK_OFFSET(0x1E6B3D50)
#define FOUNDATION_EXTENSION_SETBLENDIN_OFFSET UNITYSDK_OFFSET(0x1E6B7E40)
#define FOUNDATION_EXTENSION_SETBLENDOUT_OFFSET UNITYSDK_OFFSET(0x1E6B7EF0)
#define FOUNDATION_EXTENSION_SETIDENTITY_OFFSET UNITYSDK_OFFSET(0x1E6B5600)
#define FOUNDATION_EXTENSION_SETPRIORITY_OFFSET UNITYSDK_OFFSET(0x1E6B7FA0)
#define FOUNDATION_EXTENSION_SETTIME_OFFSET UNITYSDK_OFFSET(0x1E6B7E30)
#define FOUNDATION_EXTENSION_SETTORELATIVETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1E6B61F0)
#define FOUNDATION_EXTENSION_SIGN_OFFSET UNITYSDK_OFFSET(0x1E6B7A40)
#define FOUNDATION_EXTENSION_TOFLOAT_OFFSET UNITYSDK_OFFSET(0x1E6B3D40)
#define FOUNDATION_EXTENSION_TOINVERSEMATRIXWITHSCALE_OFFSET UNITYSDK_OFFSET(0x1E6B4460)
#define FOUNDATION_EXTENSION_TOMATRIXWITHSCALE_OFFSET UNITYSDK_OFFSET(0x1E6B4330)
#define FOUNDATION_EXTENSION_TOORIENTEDEULER_OFFSET UNITYSDK_OFFSET(0x1E6B7BE0)
#define FOUNDATION_EXTENSION_TOORIENTEDQUATERNION_OFFSET UNITYSDK_OFFSET(0x1E6B7B20)
#define FOUNDATION_EXTENSION_TOPITCHYAWROLL_OFFSET UNITYSDK_OFFSET(0x1E6B7130)
#define FOUNDATION_EXTENSION_TOSWINGTWIST_OFFSET UNITYSDK_OFFSET(0x1E6B6C20)
#define FOUNDATION_EXTENSION_TOTRANSLATIONROTATIONSCALE_OFFSET UNITYSDK_OFFSET(0x1E6B3E50)
#define FOUNDATION_EXTENSION_TOTWISTSWING_OFFSET UNITYSDK_OFFSET(0x1E6B6E50)
#define FOUNDATION_EXTENSION_TRANSFORMPOSITIONNOSCALE_OFFSET UNITYSDK_OFFSET(0x1E6B5260)
#define FOUNDATION_EXTENSION_TRANSFORMPOSITION_OFFSET UNITYSDK_OFFSET(0x1E6B5110)

namespace Foundation
{
	inline static constexpr unsigned int Extension_TypeDefinitionIndex = 8786;
