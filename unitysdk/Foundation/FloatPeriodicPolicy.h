...
#define FOUNDATION_FLOATPERIODICPOLICY_FOUNDATION_IPERIODICPOLICY_SYSTEM_SINGLE__INVOKE_OFFSET UNITYSDK_OFFSET(0x1E355CB0)
#define FOUNDATION_FLOATPERIODICPOLICY_FOUNDATION_IPERIODICPOLICY_SYSTEM_SINGLE__ISVALIDPERIOD_OFFSET UNITYSDK_OFFSET(0x1E355E30)
#define FOUNDATION_FLOATPERIODICPOLICY_FOUNDATION_IPLUSFUNC_SYSTEM_SINGLE__PLUS_OFFSET UNITYSDK_OFFSET(0x1E355E40)
#define FOUNDATION_FLOATPERIODICPOLICY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E355E50)
#define FOUNDATION_FLOATPERIODICPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E355CA0)

namespace Foundation
{
	inline static constexpr unsigned int FloatPeriodicPolicy_TypeDefinitionIndex = 8674;
	...
	public:
		...
		{
			return (::Foundation::FloatPeriodicPolicy**)Il2CppClass::FromTypeDefinitionIndex(FloatPeriodicPolicy_TypeDefinitionIndex)->GetStaticField(0x7590);
		}
