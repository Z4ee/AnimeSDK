...
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERCONSTANT_GETPARTICULARSOLUTIONTYPE_OFFSET UNITYSDK_OFFSET(0x1C0A3340)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERCONSTANT_RESOLVE_OFFSET UNITYSDK_OFFSET(0x9C14C0)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERCONSTANT__CTOR_OFFSET UNITYSDK_OFFSET(0x9C14B0)

namespace Foundation::Equation::OrdinaryDifferential
{
	inline static constexpr unsigned int SecondOrderConstant_TypeDefinitionIndex = 8924;
