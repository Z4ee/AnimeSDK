...
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERCONSTANT_GETPARTICULARSOLUTIONTYPE_OFFSET UNITYSDK_OFFSET(0x1FBFD4E0)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERCONSTANT_RESOLVE_OFFSET UNITYSDK_OFFSET(0xACFAE0)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERCONSTANT__CTOR_OFFSET UNITYSDK_OFFSET(0xACFAD0)

namespace Foundation::Equation::OrdinaryDifferential
{
	inline static constexpr unsigned int SecondOrderConstant_TypeDefinitionIndex = 8564;
