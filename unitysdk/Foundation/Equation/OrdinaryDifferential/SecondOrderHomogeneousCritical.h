...
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUSCRITICAL_GET_A_OFFSET UNITYSDK_OFFSET(0xACFDF0)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUSCRITICAL_RESOLVE_OFFSET UNITYSDK_OFFSET(0xACFE20)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUSCRITICAL__CTOR_OFFSET UNITYSDK_OFFSET(0xACFE00)

namespace Foundation::Equation::OrdinaryDifferential
{
	inline static constexpr unsigned int SecondOrderHomogeneousCritical_TypeDefinitionIndex = 8793;
