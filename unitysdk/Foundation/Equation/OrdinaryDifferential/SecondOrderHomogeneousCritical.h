...
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUSCRITICAL_GET_A_OFFSET UNITYSDK_OFFSET(0x9C17D0)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUSCRITICAL_RESOLVE_OFFSET UNITYSDK_OFFSET(0x9C1800)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUSCRITICAL__CTOR_OFFSET UNITYSDK_OFFSET(0x9C17E0)

namespace Foundation::Equation::OrdinaryDifferential
{
	inline static constexpr unsigned int SecondOrderHomogeneousCritical_TypeDefinitionIndex = 8870;
