...
#define FOUNDATION_IENUMERATORLOADERNODE_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x1BFE6DF0)
#define FOUNDATION_IENUMERATORLOADERNODE_DEPENDENCYSTATUSCHANGE_OFFSET UNITYSDK_OFFSET(0x1BFE6FD0)
#define FOUNDATION_IENUMERATORLOADERNODE_EXECUTEMOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BFE71D0)
#define FOUNDATION_IENUMERATORLOADERNODE_GET_EXCEPTION_OFFSET UNITYSDK_OFFSET(0x1BFE69D0)
#define FOUNDATION_IENUMERATORLOADERNODE_GET_FLAG_OFFSET UNITYSDK_OFFSET(0x1BFE6990)
#define FOUNDATION_IENUMERATORLOADERNODE_GET_ISCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1BFE6980)
#define FOUNDATION_IENUMERATORLOADERNODE_GET_PENDINGCOUNT_OFFSET UNITYSDK_OFFSET(0x1BFE69B0)
#define FOUNDATION_IENUMERATORLOADERNODE_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x1BFE6960)
#define FOUNDATION_IENUMERATORLOADERNODE_INTERNALSTATUSCHANGE_OFFSET UNITYSDK_OFFSET(0x1BFE6F40)
#define FOUNDATION_IENUMERATORLOADERNODE_SETDATA_OFFSET UNITYSDK_OFFSET(0x1BFE6A00)
#define FOUNDATION_IENUMERATORLOADERNODE_SET_EXCEPTION_OFFSET UNITYSDK_OFFSET(0x1BFE69E0)
#define FOUNDATION_IENUMERATORLOADERNODE_SET_FLAG_OFFSET UNITYSDK_OFFSET(0x1BFE69A0)
#define FOUNDATION_IENUMERATORLOADERNODE_SET_PENDINGCOUNT_OFFSET UNITYSDK_OFFSET(0x1BFE69C0)
#define FOUNDATION_IENUMERATORLOADERNODE_SET_STATUS_OFFSET UNITYSDK_OFFSET(0x1BFE6970)
#define FOUNDATION_IENUMERATORLOADERNODE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BFE6DE0)
#define FOUNDATION_IENUMERATORLOADERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFE69F0)
#define FOUNDATION_IENUMERATORLOADERNODE__SETDATA_B__25_2_OFFSET UNITYSDK_OFFSET(0x1BFE7560)

namespace Foundation
{
	inline static constexpr unsigned int IEnumeratorLoaderNode_TypeDefinitionIndex = 7944;

	class IEnumeratorLoaderNode : public ::System::Object
	{
	public:
		::System::Collections::IEnumerator* iEnumeratorFunc; // 0x10
		::System::Exception* _Exception_k__BackingField; // 0x18
		::System::Action_1<::Foundation::IEnumeratorLoaderNode*>* OnLoaderNodeStatusChange; // 0x20
		::System::Predicate_1<::Foundation::IEnumeratorLoaderNode*>* MoveNextCond; // 0x28
		::System::Collections::Generic::HashSet_1<::Foundation::IEnumeratorLoaderNode*>* dependencies; // 0x30
		::System::String* _Flag_k__BackingField; // 0x38
		::System::Action* WrapperFunc; // 0x40
