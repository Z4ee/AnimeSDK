...
#define FOUNDATION_IENUMERATORLOADERNODE_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x19DABA20)
#define FOUNDATION_IENUMERATORLOADERNODE_DEPENDENCYSTATUSCHANGE_OFFSET UNITYSDK_OFFSET(0x19DABC00)
#define FOUNDATION_IENUMERATORLOADERNODE_EXECUTEMOVENEXT_OFFSET UNITYSDK_OFFSET(0x19DABDF0)
#define FOUNDATION_IENUMERATORLOADERNODE_GET_EXCEPTION_OFFSET UNITYSDK_OFFSET(0x19DAB600)
#define FOUNDATION_IENUMERATORLOADERNODE_GET_FLAG_OFFSET UNITYSDK_OFFSET(0x19DAB5C0)
#define FOUNDATION_IENUMERATORLOADERNODE_GET_ISCOMPLETED_OFFSET UNITYSDK_OFFSET(0x19DAB5B0)
#define FOUNDATION_IENUMERATORLOADERNODE_GET_PENDINGCOUNT_OFFSET UNITYSDK_OFFSET(0x19DAB5E0)
#define FOUNDATION_IENUMERATORLOADERNODE_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x19DAB590)
#define FOUNDATION_IENUMERATORLOADERNODE_INTERNALSTATUSCHANGE_OFFSET UNITYSDK_OFFSET(0x19DABB70)
#define FOUNDATION_IENUMERATORLOADERNODE_SETDATA_OFFSET UNITYSDK_OFFSET(0x19DAB630)
#define FOUNDATION_IENUMERATORLOADERNODE_SET_EXCEPTION_OFFSET UNITYSDK_OFFSET(0x19DAB610)
#define FOUNDATION_IENUMERATORLOADERNODE_SET_FLAG_OFFSET UNITYSDK_OFFSET(0x19DAB5D0)
#define FOUNDATION_IENUMERATORLOADERNODE_SET_PENDINGCOUNT_OFFSET UNITYSDK_OFFSET(0x19DAB5F0)
#define FOUNDATION_IENUMERATORLOADERNODE_SET_STATUS_OFFSET UNITYSDK_OFFSET(0x19DAB5A0)
#define FOUNDATION_IENUMERATORLOADERNODE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19DABA10)
#define FOUNDATION_IENUMERATORLOADERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19DAB620)
#define FOUNDATION_IENUMERATORLOADERNODE__SETDATA_B__25_2_OFFSET UNITYSDK_OFFSET(0x19DAC180)

namespace Foundation
{
	inline static constexpr unsigned int IEnumeratorLoaderNode_TypeDefinitionIndex = 7891;

	class IEnumeratorLoaderNode : public ::System::Object
	{
	public:
		::System::Exception* _Exception_k__BackingField; // 0x10
		::System::String* _Flag_k__BackingField; // 0x18
		::System::Action* WrapperFunc; // 0x20
		::System::Collections::IEnumerator* iEnumeratorFunc; // 0x28
		::System::Action_1<::Foundation::IEnumeratorLoaderNode*>* OnLoaderNodeStatusChange; // 0x30
		::System::Predicate_1<::Foundation::IEnumeratorLoaderNode*>* MoveNextCond; // 0x38
		::System::Collections::Generic::HashSet_1<::Foundation::IEnumeratorLoaderNode*>* dependencies; // 0x40
