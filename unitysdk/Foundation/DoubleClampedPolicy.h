...
#define FOUNDATION_DOUBLECLAMPEDPOLICY_FOUNDATION_ICLAMPFUNC_SYSTEM_DOUBLE__CLAMP_OFFSET UNITYSDK_OFFSET(0x1B37AE70)
#define FOUNDATION_DOUBLECLAMPEDPOLICY_FOUNDATION_IMAXFUNC_SYSTEM_DOUBLE__MAX_OFFSET UNITYSDK_OFFSET(0x1B37AEE0)
#define FOUNDATION_DOUBLECLAMPEDPOLICY_FOUNDATION_IMINFUNC_SYSTEM_DOUBLE__MIN_OFFSET UNITYSDK_OFFSET(0x1B37AE90)
#define FOUNDATION_DOUBLECLAMPEDPOLICY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B37AF30)
#define FOUNDATION_DOUBLECLAMPEDPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B37AE60)

namespace Foundation
{
	inline static constexpr unsigned int DoubleClampedPolicy_TypeDefinitionIndex = 8836;
	...
	public:
		...
		{
			return (::Foundation::DoubleClampedPolicy**)Il2CppClass::FromTypeDefinitionIndex(DoubleClampedPolicy_TypeDefinitionIndex)->GetStaticField(0x7CE0);
		}
