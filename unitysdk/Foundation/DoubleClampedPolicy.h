...
#define FOUNDATION_DOUBLECLAMPEDPOLICY_FOUNDATION_ICLAMPFUNC_SYSTEM_DOUBLE__CLAMP_OFFSET UNITYSDK_OFFSET(0x1DC992F0)
#define FOUNDATION_DOUBLECLAMPEDPOLICY_FOUNDATION_IMAXFUNC_SYSTEM_DOUBLE__MAX_OFFSET UNITYSDK_OFFSET(0x1DC99360)
#define FOUNDATION_DOUBLECLAMPEDPOLICY_FOUNDATION_IMINFUNC_SYSTEM_DOUBLE__MIN_OFFSET UNITYSDK_OFFSET(0x1DC99310)
#define FOUNDATION_DOUBLECLAMPEDPOLICY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DC993B0)
#define FOUNDATION_DOUBLECLAMPEDPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC992E0)

namespace Foundation
{
	inline static constexpr unsigned int DoubleClampedPolicy_TypeDefinitionIndex = 8509;
	...
	public:
		...
		{
			return (::Foundation::DoubleClampedPolicy**)Il2CppClass::FromTypeDefinitionIndex(DoubleClampedPolicy_TypeDefinitionIndex)->GetStaticField(0x74C0);
		}
