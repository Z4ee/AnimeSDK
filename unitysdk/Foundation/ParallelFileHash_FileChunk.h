...
#define FOUNDATION_PARALLELFILEHASH_FILECHUNK__CTOR_OFFSET UNITYSDK_OFFSET(0x891F20)

namespace Foundation
{
	inline static constexpr unsigned int ParallelFileHash_FileChunk_TypeDefinitionIndex = 87354;
