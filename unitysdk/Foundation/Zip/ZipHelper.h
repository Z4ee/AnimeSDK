...
#define FOUNDATION_ZIP_ZIPHELPER_UNZIP_1_OFFSET UNITYSDK_OFFSET(0x1E1A88C0)
#define FOUNDATION_ZIP_ZIPHELPER_UNZIP_OFFSET UNITYSDK_OFFSET(0x1E1A8270)
#define FOUNDATION_ZIP_ZIPHELPER_ZIPDIRECTORY_1_OFFSET UNITYSDK_OFFSET(0x1E1A7710)
#define FOUNDATION_ZIP_ZIPHELPER_ZIPDIRECTORY_2_OFFSET UNITYSDK_OFFSET(0x1E1A7970)
#define FOUNDATION_ZIP_ZIPHELPER_ZIPDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1E1A6F60)
#define FOUNDATION_ZIP_ZIPHELPER_ZIPFILE_1_OFFSET UNITYSDK_OFFSET(0x1E1A7F80)
#define FOUNDATION_ZIP_ZIPHELPER_ZIPFILE_OFFSET UNITYSDK_OFFSET(0x1E1A7A00)
#define FOUNDATION_ZIP_ZIPHELPER_ZIP_1_OFFSET UNITYSDK_OFFSET(0x1E1A81E0)
#define FOUNDATION_ZIP_ZIPHELPER_ZIP_OFFSET UNITYSDK_OFFSET(0x1E1A8010)
#define FOUNDATION_ZIP_ZIPHELPER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E1A8960)
#define FOUNDATION_ZIP_ZIPHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1A8950)

namespace Foundation::Zip
{
	inline static constexpr unsigned int ZipHelper_TypeDefinitionIndex = 7835;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ZipHelper_TypeDefinitionIndex)->GetStaticField(0x7470);
		}
