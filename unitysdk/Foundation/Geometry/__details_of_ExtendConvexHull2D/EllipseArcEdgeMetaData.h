...
#define FOUNDATION_GEOMETRY___DETAILS_OF_EXTENDCONVEXHULL2D_ELLIPSEARCEDGEMETADATA_GENERATE_1_OFFSET UNITYSDK_OFFSET(0x9C74F0)
#define FOUNDATION_GEOMETRY___DETAILS_OF_EXTENDCONVEXHULL2D_ELLIPSEARCEDGEMETADATA_GENERATE_OFFSET UNITYSDK_OFFSET(0x9C7270)
#define FOUNDATION_GEOMETRY___DETAILS_OF_EXTENDCONVEXHULL2D_ELLIPSEARCEDGEMETADATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3405B0)
#define FOUNDATION_GEOMETRY___DETAILS_OF_EXTENDCONVEXHULL2D_ELLIPSEARCEDGEMETADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x3405B0)

namespace Foundation::Geometry::__details_of_ExtendConvexHull2D
{
	inline static constexpr unsigned int EllipseArcEdgeMetaData_TypeDefinitionIndex = 8915;
