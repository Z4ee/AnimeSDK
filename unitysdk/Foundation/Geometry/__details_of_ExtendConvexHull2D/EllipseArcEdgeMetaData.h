...
#define FOUNDATION_GEOMETRY___DETAILS_OF_EXTENDCONVEXHULL2D_ELLIPSEARCEDGEMETADATA_GENERATE_1_OFFSET UNITYSDK_OFFSET(0xABFA00)
#define FOUNDATION_GEOMETRY___DETAILS_OF_EXTENDCONVEXHULL2D_ELLIPSEARCEDGEMETADATA_GENERATE_OFFSET UNITYSDK_OFFSET(0xABF7B0)
#define FOUNDATION_GEOMETRY___DETAILS_OF_EXTENDCONVEXHULL2D_ELLIPSEARCEDGEMETADATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3D65A0)
#define FOUNDATION_GEOMETRY___DETAILS_OF_EXTENDCONVEXHULL2D_ELLIPSEARCEDGEMETADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x3D65A0)

namespace Foundation::Geometry::__details_of_ExtendConvexHull2D
{
	inline static constexpr unsigned int EllipseArcEdgeMetaData_TypeDefinitionIndex = 8773;
