...
#define FOUNDATION_GEOMETRY_ELLIPSE2D_GETPARAM_OFFSET UNITYSDK_OFFSET(0x99FBA0)
#define FOUNDATION_GEOMETRY_ELLIPSE2D_GETPOINTX_OFFSET UNITYSDK_OFFSET(0x99F990)
#define FOUNDATION_GEOMETRY_ELLIPSE2D_GETPOINTY_OFFSET UNITYSDK_OFFSET(0x99FA60)
#define FOUNDATION_GEOMETRY_ELLIPSE2D_GETPOINT_1_OFFSET UNITYSDK_OFFSET(0x99FB20)
#define FOUNDATION_GEOMETRY_ELLIPSE2D_GETPOINT_OFFSET UNITYSDK_OFFSET(0x99F8E0)
#define FOUNDATION_GEOMETRY_ELLIPSE2D__CTOR_OFFSET UNITYSDK_OFFSET(0x99F7E0)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int Ellipse2D_TypeDefinitionIndex = 9182;
