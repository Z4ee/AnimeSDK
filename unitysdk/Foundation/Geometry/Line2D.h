...
#define FOUNDATION_GEOMETRY_LINE2D_CREATE_OFFSET UNITYSDK_OFFSET(0x1BE2C180)
#define FOUNDATION_GEOMETRY_LINE2D_GET_ISDEGENERATE_OFFSET UNITYSDK_OFFSET(0x9B5550)
#define FOUNDATION_GEOMETRY_LINE2D_ON_OFFSET UNITYSDK_OFFSET(0x9B5590)
#define FOUNDATION_GEOMETRY_LINE2D__CTOR_OFFSET UNITYSDK_OFFSET(0x2FED90)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int Line2D_TypeDefinitionIndex = 9059;
