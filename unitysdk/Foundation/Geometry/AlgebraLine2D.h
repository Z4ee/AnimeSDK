...
#define FOUNDATION_GEOMETRY_ALGEBRALINE2D_GET_C_OFFSET UNITYSDK_OFFSET(0x41A770)
#define FOUNDATION_GEOMETRY_ALGEBRALINE2D_GET_ISDEGENERATE_OFFSET UNITYSDK_OFFSET(0xA532C0)
#define FOUNDATION_GEOMETRY_ALGEBRALINE2D_GET_X_OFFSET UNITYSDK_OFFSET(0x45A800)
#define FOUNDATION_GEOMETRY_ALGEBRALINE2D_GET_Y_OFFSET UNITYSDK_OFFSET(0x40CF10)
#define FOUNDATION_GEOMETRY_ALGEBRALINE2D_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1E058F30)
#define FOUNDATION_GEOMETRY_ALGEBRALINE2D_VALUEOF_1_OFFSET UNITYSDK_OFFSET(0xA53330)
#define FOUNDATION_GEOMETRY_ALGEBRALINE2D_VALUEOF_OFFSET UNITYSDK_OFFSET(0xA53300)
#define FOUNDATION_GEOMETRY_ALGEBRALINE2D__CTOR_OFFSET UNITYSDK_OFFSET(0x9C4460)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int AlgebraLine2D_TypeDefinitionIndex = 8619;
