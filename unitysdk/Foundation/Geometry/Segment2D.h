...
#define FOUNDATION_GEOMETRY_SEGMENT2D_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x8EA150)
#define FOUNDATION_GEOMETRY_SEGMENT2D_GET_ISDEGENERATE_OFFSET UNITYSDK_OFFSET(0x8EA0D0)
#define FOUNDATION_GEOMETRY_SEGMENT2D_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x8EA190)
#define FOUNDATION_GEOMETRY_SEGMENT2D_GET_VECTOR_OFFSET UNITYSDK_OFFSET(0x8EA120)
#define FOUNDATION_GEOMETRY_SEGMENT2D_ONLEFT_OFFSET UNITYSDK_OFFSET(0x8EA000)
#define FOUNDATION_GEOMETRY_SEGMENT2D__CTOR_OFFSET UNITYSDK_OFFSET(0x2FED90)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int Segment2D_TypeDefinitionIndex = 9069;
