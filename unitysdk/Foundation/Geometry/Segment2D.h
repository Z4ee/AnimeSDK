...
#define FOUNDATION_GEOMETRY_SEGMENT2D_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x9D9F30)
#define FOUNDATION_GEOMETRY_SEGMENT2D_GET_ISDEGENERATE_OFFSET UNITYSDK_OFFSET(0x9D9EB0)
#define FOUNDATION_GEOMETRY_SEGMENT2D_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x9D9F70)
#define FOUNDATION_GEOMETRY_SEGMENT2D_GET_VECTOR_OFFSET UNITYSDK_OFFSET(0x9D9F00)
#define FOUNDATION_GEOMETRY_SEGMENT2D_ONLEFT_OFFSET UNITYSDK_OFFSET(0x9D9DF0)
#define FOUNDATION_GEOMETRY_SEGMENT2D__CTOR_OFFSET UNITYSDK_OFFSET(0x346F70)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int Segment2D_TypeDefinitionIndex = 8483;
