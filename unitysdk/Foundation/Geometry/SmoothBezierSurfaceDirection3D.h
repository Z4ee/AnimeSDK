...
#define FOUNDATION_GEOMETRY_SMOOTHBEZIERSURFACEDIRECTION3D_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1A5C6BB0)
#define FOUNDATION_GEOMETRY_SMOOTHBEZIERSURFACEDIRECTION3D_GET_POLICY_OFFSET UNITYSDK_OFFSET(0x1A5C6B50)
#define FOUNDATION_GEOMETRY_SMOOTHBEZIERSURFACEDIRECTION3D__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5C6E50)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int SmoothBezierSurfaceDirection3D_TypeDefinitionIndex = 8849;
