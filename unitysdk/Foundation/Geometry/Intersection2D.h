...
#define FOUNDATION_GEOMETRY_INTERSECTION2D_LINEINTERSECTION_1_OFFSET UNITYSDK_OFFSET(0x1B793C70)
#define FOUNDATION_GEOMETRY_INTERSECTION2D_LINEINTERSECTION_2_OFFSET UNITYSDK_OFFSET(0x1B7952F0)
#define FOUNDATION_GEOMETRY_INTERSECTION2D_LINEINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1B793A40)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int Intersection2D_TypeDefinitionIndex = 8966;
