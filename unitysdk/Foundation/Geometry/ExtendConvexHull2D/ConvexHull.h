...
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CREATEPROJECTIONCONVEXHULL_1_OFFSET UNITYSDK_OFFSET(0x1C993440)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CREATEPROJECTIONCONVEXHULL_2_OFFSET UNITYSDK_OFFSET(0x1C993A50)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CREATEPROJECTIONCONVEXHULL_OFFSET UNITYSDK_OFFSET(0x1C993220)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CROSSCULLOUTAREA_OFFSET UNITYSDK_OFFSET(0x1C98E4E0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CULLNOINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1C98E8C0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CULLONEINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1C98CC90)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CULLPOINT_OFFSET UNITYSDK_OFFSET(0x1C98DE00)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CULLTWOINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1C98D4E0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CULL_OFFSET UNITYSDK_OFFSET(0x98C240)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_ENTERCULLOUTAREA_OFFSET UNITYSDK_OFFSET(0x1C98DE60)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_EXITCULLOUTAREA_OFFSET UNITYSDK_OFFSET(0x1C98E250)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GENERATECONVEXHULLFROMCONVEXLINES_OFFSET UNITYSDK_OFFSET(0x1C9921F0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GENERATECUSTOMEQUATIONXINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1C98F3E0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GENERATECUSTOMEQUATIONYINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1C98F280)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GETCONVEXLINES_OFFSET UNITYSDK_OFFSET(0x1C98FC30)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GETEDGE_OFFSET UNITYSDK_OFFSET(0x98C2C0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GETLINEFROMCUSTOMEQUATION_OFFSET UNITYSDK_OFFSET(0x1C98F560)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GETSPHEREPROJECTIONELLIPSE_OFFSET UNITYSDK_OFFSET(0x1C98EBF0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_AREA_OFFSET UNITYSDK_OFFSET(0x98BF30)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_EDGECOUNT_OFFSET UNITYSDK_OFFSET(0x2B7CC0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x98BF10)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x98BED0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_MAXX_OFFSET UNITYSDK_OFFSET(0x98C020)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_MAXY_OFFSET UNITYSDK_OFFSET(0x98C160)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_MINX_OFFSET UNITYSDK_OFFSET(0x98BF40)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_NULL_OFFSET UNITYSDK_OFFSET(0x1C98A1C0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_PUSHEDGE_OFFSET UNITYSDK_OFFSET(0x1C98E650)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x98C2E0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL__CTOR_OFFSET UNITYSDK_OFFSET(0x416FB0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL__GENERATECONVEXHULLFROMCONVEXLINES_G__LINEINTERSECTION_44_0_OFFSET UNITYSDK_OFFSET(0x1C992F00)

namespace Foundation::Geometry::ExtendConvexHull2D
{
	inline static constexpr unsigned int ConvexHull_TypeDefinitionIndex = 8762;
