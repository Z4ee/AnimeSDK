...
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CREATEPROJECTIONCONVEXHULL_1_OFFSET UNITYSDK_OFFSET(0x1A5C5D40)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CREATEPROJECTIONCONVEXHULL_2_OFFSET UNITYSDK_OFFSET(0x1A5C6350)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CREATEPROJECTIONCONVEXHULL_OFFSET UNITYSDK_OFFSET(0x1A5C5B20)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CROSSCULLOUTAREA_OFFSET UNITYSDK_OFFSET(0x1A5C0F60)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CULLNOINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1A5C1340)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CULLONEINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1A5BF710)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CULLPOINT_OFFSET UNITYSDK_OFFSET(0x1A5C0880)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CULLTWOINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1A5BFF60)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CULL_OFFSET UNITYSDK_OFFSET(0x8E9F10)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_ENTERCULLOUTAREA_OFFSET UNITYSDK_OFFSET(0x1A5C08E0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_EXITCULLOUTAREA_OFFSET UNITYSDK_OFFSET(0x1A5C0CD0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GENERATECONVEXHULLFROMCONVEXLINES_OFFSET UNITYSDK_OFFSET(0x1A5C4AF0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GENERATECUSTOMEQUATIONXINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1A5C1E30)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GENERATECUSTOMEQUATIONYINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1A5C1D00)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GETCONVEXLINES_OFFSET UNITYSDK_OFFSET(0x1A5C2650)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GETEDGE_OFFSET UNITYSDK_OFFSET(0x8E9F90)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GETLINEFROMCUSTOMEQUATION_OFFSET UNITYSDK_OFFSET(0x1A5C1F80)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GETSPHEREPROJECTIONELLIPSE_OFFSET UNITYSDK_OFFSET(0x1A5C1670)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_AREA_OFFSET UNITYSDK_OFFSET(0x8E9C00)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_EDGECOUNT_OFFSET UNITYSDK_OFFSET(0x2E8B50)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x8E9BE0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x8E9BA0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_MAXX_OFFSET UNITYSDK_OFFSET(0x8E9CF0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_MAXY_OFFSET UNITYSDK_OFFSET(0x8E9E30)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_MINX_OFFSET UNITYSDK_OFFSET(0x8E9C10)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_NULL_OFFSET UNITYSDK_OFFSET(0x1A5BCC40)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_PUSHEDGE_OFFSET UNITYSDK_OFFSET(0x1A5C10D0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8E9FB0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL__CTOR_OFFSET UNITYSDK_OFFSET(0x43EB10)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL__GENERATECONVEXHULLFROMCONVEXLINES_G__LINEINTERSECTION_44_0_OFFSET UNITYSDK_OFFSET(0x1A5C5800)

namespace Foundation::Geometry::ExtendConvexHull2D
{
	inline static constexpr unsigned int ConvexHull_TypeDefinitionIndex = 8935;
