...
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGE_GETPOINT_OFFSET UNITYSDK_OFFSET(0xA57280)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGE_GET_ARCAREA_OFFSET UNITYSDK_OFFSET(0xA57080)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGE_GET_END_OFFSET UNITYSDK_OFFSET(0xA571D0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGE_GET_MAXX_OFFSET UNITYSDK_OFFSET(0xA57260)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGE_GET_MAXY_OFFSET UNITYSDK_OFFSET(0xA57270)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGE_GET_MINX_OFFSET UNITYSDK_OFFSET(0xA57250)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGE_GET_START_OFFSET UNITYSDK_OFFSET(0xA57150)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGE_NEW_1_OFFSET UNITYSDK_OFFSET(0x1E148440)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGE_NEW_2_OFFSET UNITYSDK_OFFSET(0x1E148530)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGE_NEW_OFFSET UNITYSDK_OFFSET(0x1E148230)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGE__CTOR_1_OFFSET UNITYSDK_OFFSET(0xA572F0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGE__CTOR_OFFSET UNITYSDK_OFFSET(0xA57290)

namespace Foundation::Geometry::ExtendConvexHull2D
{
	inline static constexpr unsigned int Edge_TypeDefinitionIndex = 8713;

	struct alignas(8) Edge
	{
		static ::Foundation::Geometry::ExtendConvexHull2D::Edge* StaticGet_Null()
		{
			return (::Foundation::Geometry::ExtendConvexHull2D::Edge*)Il2CppClass::FromTypeDefinitionIndex(Edge_TypeDefinitionIndex)->GetStaticField(0x3D50);
		}
