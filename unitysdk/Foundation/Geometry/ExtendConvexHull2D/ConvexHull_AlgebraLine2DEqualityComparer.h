...
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_ALGEBRALINE2DEQUALITYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0xAD0880)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_ALGEBRALINE2DEQUALITYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x324A50)

namespace Foundation::Geometry::ExtendConvexHull2D
{
	inline static constexpr unsigned int ConvexHull_AlgebraLine2DEqualityComparer_TypeDefinitionIndex = 8857;
