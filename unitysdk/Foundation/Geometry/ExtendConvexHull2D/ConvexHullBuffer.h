...
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULLBUFFER_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x325D00)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULLBUFFER_SET_1_OFFSET UNITYSDK_OFFSET(0xAA58B0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULLBUFFER_SET_2_OFFSET UNITYSDK_OFFSET(0xAA5940)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULLBUFFER_SET_OFFSET UNITYSDK_OFFSET(0xAA57F0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULLBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x44DAC0)

namespace Foundation::Geometry::ExtendConvexHull2D
{
	inline static constexpr unsigned int ConvexHullBuffer_TypeDefinitionIndex = 8621;
