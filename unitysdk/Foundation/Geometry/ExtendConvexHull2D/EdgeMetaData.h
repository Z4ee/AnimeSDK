...
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGEMETADATA_GENERATE_1_OFFSET UNITYSDK_OFFSET(0xA54480)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGEMETADATA_GENERATE_OFFSET UNITYSDK_OFFSET(0xA54460)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGEMETADATA_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1E05ABD0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGEMETADATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0xA543F0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGEMETADATA__CTOR_2_OFFSET UNITYSDK_OFFSET(0xA54410)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGEMETADATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA542E0)

namespace Foundation::Geometry::ExtendConvexHull2D
{
	inline static constexpr unsigned int EdgeMetaData_TypeDefinitionIndex = 8446;
