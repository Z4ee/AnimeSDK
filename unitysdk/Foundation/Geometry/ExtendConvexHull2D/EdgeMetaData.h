...
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGEMETADATA_GENERATE_1_OFFSET UNITYSDK_OFFSET(0x9B0D20)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGEMETADATA_GENERATE_OFFSET UNITYSDK_OFFSET(0x9B0D00)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGEMETADATA_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1BCA1630)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGEMETADATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9B0C90)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGEMETADATA__CTOR_2_OFFSET UNITYSDK_OFFSET(0x9B0CB0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGEMETADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9B0B80)

namespace Foundation::Geometry::ExtendConvexHull2D
{
	inline static constexpr unsigned int EdgeMetaData_TypeDefinitionIndex = 8994;
