...
#define FOUNDATION_GEOMETRY_SMALLESTBOUNDING2D_CREATECIRCLE_OFFSET UNITYSDK_OFFSET(0x1CFFDA70)
#define FOUNDATION_GEOMETRY_SMALLESTBOUNDING2D_MINIMUMENCLOSINGCIRCLEHELPER_OFFSET UNITYSDK_OFFSET(0x1CFFD200)
#define FOUNDATION_GEOMETRY_SMALLESTBOUNDING2D_MINIMUMENCLOSINGCIRCLE_OFFSET UNITYSDK_OFFSET(0x1CFFD020)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int SmallestBounding2D_TypeDefinitionIndex = 8472;
