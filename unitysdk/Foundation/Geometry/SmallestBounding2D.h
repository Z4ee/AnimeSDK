...
#define FOUNDATION_GEOMETRY_SMALLESTBOUNDING2D_CREATECIRCLE_OFFSET UNITYSDK_OFFSET(0x1AB72A70)
#define FOUNDATION_GEOMETRY_SMALLESTBOUNDING2D_MINIMUMENCLOSINGCIRCLEHELPER_OFFSET UNITYSDK_OFFSET(0x1AB72200)
#define FOUNDATION_GEOMETRY_SMALLESTBOUNDING2D_MINIMUMENCLOSINGCIRCLE_OFFSET UNITYSDK_OFFSET(0x1AB72020)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int SmallestBounding2D_TypeDefinitionIndex = 9060;
