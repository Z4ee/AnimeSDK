...
#define FOUNDATION_GEOMETRY_CONVEXHULL2D_FINDMINPOINTINDEX_OFFSET UNITYSDK_OFFSET(0x1E0590B0)
#define FOUNDATION_GEOMETRY_CONVEXHULL2D_GENERATECONVEXHULLGRAHAM_OFFSET UNITYSDK_OFFSET(0x1E059250)
#define FOUNDATION_GEOMETRY_CONVEXHULL2D_SWAP_OFFSET UNITYSDK_OFFSET(0x1E0591E0)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int ConvexHull2D_TypeDefinitionIndex = 8583;
