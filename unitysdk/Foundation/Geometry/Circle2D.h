...
#define FOUNDATION_GEOMETRY_CIRCLE2D_CONTAINS_OFFSET UNITYSDK_OFFSET(0x9C4020)
#define FOUNDATION_GEOMETRY_CIRCLE2D_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1C1734F0)
#define FOUNDATION_GEOMETRY_CIRCLE2D_CREATE_2_OFFSET UNITYSDK_OFFSET(0x1C173590)
#define FOUNDATION_GEOMETRY_CIRCLE2D_CREATE_OFFSET UNITYSDK_OFFSET(0x1C1734E0)
#define FOUNDATION_GEOMETRY_CIRCLE2D_GET_ISDEGENERATE_OFFSET UNITYSDK_OFFSET(0x9C3FF0)
#define FOUNDATION_GEOMETRY_CIRCLE2D__CTOR_OFFSET UNITYSDK_OFFSET(0x2FEEC0)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int Circle2D_TypeDefinitionIndex = 9089;
