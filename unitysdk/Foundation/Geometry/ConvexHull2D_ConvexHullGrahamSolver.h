...
#define FOUNDATION_GEOMETRY_CONVEXHULL2D_CONVEXHULLGRAHAMSOLVER_FINDMINPOINTANDPLACEITATFIRST_OFFSET UNITYSDK_OFFSET(0xAA5100)
#define FOUNDATION_GEOMETRY_CONVEXHULL2D_CONVEXHULLGRAHAMSOLVER_SCANPOINTSANDBUILDCONVEXHULL_OFFSET UNITYSDK_OFFSET(0xAA52F0)
#define FOUNDATION_GEOMETRY_CONVEXHULL2D_CONVEXHULLGRAHAMSOLVER_SOLVE_OFFSET UNITYSDK_OFFSET(0xAA4A70)
#define FOUNDATION_GEOMETRY_CONVEXHULL2D_CONVEXHULLGRAHAMSOLVER_SORTPOINTSBYPOLARANDDISTANCE_OFFSET UNITYSDK_OFFSET(0xAA51F0)
#define FOUNDATION_GEOMETRY_CONVEXHULL2D_CONVEXHULLGRAHAMSOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x3222E0)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int ConvexHull2D_ConvexHullGrahamSolver_TypeDefinitionIndex = 8647;
