...
#define FOUNDATION_GEOMETRY_ELLIPSEARC2D_GET_AREA_OFFSET UNITYSDK_OFFSET(0x9DA190)
#define FOUNDATION_GEOMETRY_ELLIPSEARC2D_GET_ENDTHETA_OFFSET UNITYSDK_OFFSET(0x9DA180)
#define FOUNDATION_GEOMETRY_ELLIPSEARC2D__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9D9E70)
#define FOUNDATION_GEOMETRY_ELLIPSEARC2D__CTOR_2_OFFSET UNITYSDK_OFFSET(0x9D9F40)
#define FOUNDATION_GEOMETRY_ELLIPSEARC2D__CTOR_3_OFFSET UNITYSDK_OFFSET(0x9D9F80)
#define FOUNDATION_GEOMETRY_ELLIPSEARC2D__CTOR_OFFSET UNITYSDK_OFFSET(0x9D9DE0)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int EllipseArc2D_TypeDefinitionIndex = 9179;
