...
#define FOUNDATION_GEOMETRY_ELLIPSEARC2D_GET_AREA_OFFSET UNITYSDK_OFFSET(0xA7B510)
#define FOUNDATION_GEOMETRY_ELLIPSEARC2D_GET_ENDTHETA_OFFSET UNITYSDK_OFFSET(0xA7B500)
#define FOUNDATION_GEOMETRY_ELLIPSEARC2D__CTOR_1_OFFSET UNITYSDK_OFFSET(0xA7B1F0)
#define FOUNDATION_GEOMETRY_ELLIPSEARC2D__CTOR_2_OFFSET UNITYSDK_OFFSET(0xA7B2C0)
#define FOUNDATION_GEOMETRY_ELLIPSEARC2D__CTOR_3_OFFSET UNITYSDK_OFFSET(0xA7B300)
#define FOUNDATION_GEOMETRY_ELLIPSEARC2D__CTOR_OFFSET UNITYSDK_OFFSET(0xA7B160)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int EllipseArc2D_TypeDefinitionIndex = 8671;
