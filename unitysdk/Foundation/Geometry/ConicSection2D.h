...
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GENERATEQUADRATICEQUATIONX_OFFSET UNITYSDK_OFFSET(0x8E5EB0)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GENERATEQUADRATICEQUATIONY_OFFSET UNITYSDK_OFFSET(0x8E5F50)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GETNORMAL_OFFSET UNITYSDK_OFFSET(0x8E5E30)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GETSCALE_OFFSET UNITYSDK_OFFSET(0x1A5BC9B0)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GETTANGENTLINEXINTERSECTION_OFFSET UNITYSDK_OFFSET(0x8E73F0)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GETTANGENTLINEYINTERSECTION_OFFSET UNITYSDK_OFFSET(0x8E7050)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GETTANGENTPOINT_OFFSET UNITYSDK_OFFSET(0x8E7790)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GETTYPE_OFFSET UNITYSDK_OFFSET(0x1A5BCAC0)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GET_ELLIPSE_OFFSET UNITYSDK_OFFSET(0x8E6CB0)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GET_ISELLIPSE_OFFSET UNITYSDK_OFFSET(0x8E5E20)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_INTERSECTIONSOFLINE_OFFSET UNITYSDK_OFFSET(0x8E5FE0)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_NEW_1_OFFSET UNITYSDK_OFFSET(0x1A5BC850)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_NEW_OFFSET UNITYSDK_OFFSET(0x1A5BC570)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_SOLVE_OFFSET UNITYSDK_OFFSET(0x1A5B8400)
#define FOUNDATION_GEOMETRY_CONICSECTION2D__CTOR_OFFSET UNITYSDK_OFFSET(0x8E9B70)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int ConicSection2D_TypeDefinitionIndex = 9124;
