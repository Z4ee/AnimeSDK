...
#define FOUNDATION_GEOMETRY_SMOOTHBEZIERSURFACE3D_GET_POLICY_OFFSET UNITYSDK_OFFSET(0x1E6B8AC0)
#define FOUNDATION_GEOMETRY_SMOOTHBEZIERSURFACE3D__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6B8B20)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int SmoothBezierSurface3D_TypeDefinitionIndex = 8747;
