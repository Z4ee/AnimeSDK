...
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST_ADDPOOLINSTANCE_OFFSET UNITYSDK_OFFSET(0x1BFDD4E0)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x1BFDC1B0)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST_CLEARASYNCREQUESTS_OFFSET UNITYSDK_OFFSET(0x1BFDD8E0)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST_CLEARPOOLINSTANCES_OFFSET UNITYSDK_OFFSET(0x1BFDD730)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST_GETINSTANCEASYNC_1_OFFSET UNITYSDK_OFFSET(0x1BFDD120)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST_GETINSTANCEASYNC_OFFSET UNITYSDK_OFFSET(0x1BFDCE10)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1BFDCB10)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST_GETPOOLINSTANCESCOUNT_OFFSET UNITYSDK_OFFSET(0x1BFDC160)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST_ISBUNDLELOADED_OFFSET UNITYSDK_OFFSET(0x1BFDB6F0)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST_LOADIMMEDIATE_OFFSET UNITYSDK_OFFSET(0x1BFDC2D0)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST_LOADSYNC_OFFSET UNITYSDK_OFFSET(0x1BFDB430)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST_LOAD_OFFSET UNITYSDK_OFFSET(0x1BFDADE0)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST_RECYCLE_OFFSET UNITYSDK_OFFSET(0x1BFDC0C0)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST_TRYGETPOOLEDOBJECT_OFFSET UNITYSDK_OFFSET(0x1BFDD330)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST_UNLOADINTERNAL_OFFSET UNITYSDK_OFFSET(0x1BFDB990)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1BFDBEC0)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST_WAITFORINSTANCEASYNC_OFFSET UNITYSDK_OFFSET(0x1BFDCD80)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST_WAITFORTEMPLATEASYNC_OFFSET UNITYSDK_OFFSET(0x1BFDB3B0)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST_WAITFORUNLOADASYNC_OFFSET UNITYSDK_OFFSET(0x1BFDB910)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BFDDC00)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFDD980)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST___BASE_ADDPOOLINSTANCE_OFFSET UNITYSDK_OFFSET(0x1BFDDC10)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST___BASE_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x1BFDDCA0)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST___BASE_CLEARPOOLINSTANCES_OFFSET UNITYSDK_OFFSET(0x1BFDDCB0)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST___BASE_GETINSTANCEASYNC_OFFSET UNITYSDK_OFFSET(0x1BFDDD70)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST___BASE_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1BFDDD40)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST___BASE_GETPOOLINSTANCESCOUNT_OFFSET UNITYSDK_OFFSET(0x1BFDDDB0)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST___BASE_LOADIMMEDIATE_OFFSET UNITYSDK_OFFSET(0x1BFDDE50)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST___BASE_LOAD_OFFSET UNITYSDK_OFFSET(0x1BFDDE40)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST___BASE_RECYCLE_OFFSET UNITYSDK_OFFSET(0x1BFDDE90)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST___BASE_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1BFDDEA0)

namespace Foundation
{
	inline static constexpr unsigned int BundleObjectInstanceRequest_TypeDefinitionIndex = 8173;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(BundleObjectInstanceRequest_TypeDefinitionIndex)->GetStaticField(0x38E0);
		}
		::System::Collections::Generic::Stack_1<::UnityEngine::GameObject*>* pooledObjects; // 0x90
		...
		::UnityEngine::AssetBundleInstanceRequest* templateRequest; // 0xB0
		::UnityEngine::AssetBundleCreateRequest* _bundleRequest; // 0xB8
		::System::Collections::Generic::List_1<::UnityEngine::AssetBundleInstanceRequest*>* instanceAsyncRequests2; // 0xC0
