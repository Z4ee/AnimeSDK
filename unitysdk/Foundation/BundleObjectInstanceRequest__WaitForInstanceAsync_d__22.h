...
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST__WAITFORINSTANCEASYNC_D__22_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B83F860)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST__WAITFORINSTANCEASYNC_D__22_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B83F9E0)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST__WAITFORINSTANCEASYNC_D__22_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B83FA40)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST__WAITFORINSTANCEASYNC_D__22_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B83F9F0)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST__WAITFORINSTANCEASYNC_D__22_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B83F850)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST__WAITFORINSTANCEASYNC_D__22__CTOR_OFFSET UNITYSDK_OFFSET(0x1B83F840)

namespace Foundation
{
	inline static constexpr unsigned int BundleObjectInstanceRequest__WaitForInstanceAsync_d__22_TypeDefinitionIndex = 7935;
	...
	public:
		...
		::Foundation::BundleObjectInstanceRequest* __4__this; // 0x18
