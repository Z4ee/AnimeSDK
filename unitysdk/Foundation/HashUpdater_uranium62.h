...
#define FOUNDATION_HASHUPDATER_URANIUM62_DIGEST_OFFSET UNITYSDK_OFFSET(0x1022EB50)
#define FOUNDATION_HASHUPDATER_URANIUM62_RESET_OFFSET UNITYSDK_OFFSET(0x1022ECE0)
#define FOUNDATION_HASHUPDATER_URANIUM62_UPDATE_OFFSET UNITYSDK_OFFSET(0x1022EAD0)
#define FOUNDATION_HASHUPDATER_URANIUM62__CTOR_OFFSET UNITYSDK_OFFSET(0x1022EA80)

namespace Foundation
{
	inline static constexpr unsigned int HashUpdater_uranium62_TypeDefinitionIndex = 43289;
