...
#define FOUNDATION_HASHUPDATER_URANIUM62_DIGEST_OFFSET UNITYSDK_OFFSET(0x113ED4F0)
#define FOUNDATION_HASHUPDATER_URANIUM62_RESET_OFFSET UNITYSDK_OFFSET(0x113ED690)
#define FOUNDATION_HASHUPDATER_URANIUM62_UPDATE_OFFSET UNITYSDK_OFFSET(0x113ED470)
#define FOUNDATION_HASHUPDATER_URANIUM62__CTOR_OFFSET UNITYSDK_OFFSET(0x113ED420)

namespace Foundation
{
	inline static constexpr unsigned int HashUpdater_uranium62_TypeDefinitionIndex = 66851;
