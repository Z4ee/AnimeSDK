...
#define FOUNDATION_ASSETREQUESTCOMPLETEDELWITHUSERDATA_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E1EAF30)
#define FOUNDATION_ASSETREQUESTCOMPLETEDELWITHUSERDATA_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E1EAFC0)
#define FOUNDATION_ASSETREQUESTCOMPLETEDELWITHUSERDATA_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E1EA700)
#define FOUNDATION_ASSETREQUESTCOMPLETEDELWITHUSERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1EA6E0)

namespace Foundation
{
	inline static constexpr unsigned int AssetRequestCompleteDelWithUserData_TypeDefinitionIndex = 7961;
