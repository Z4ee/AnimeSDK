...
#define FOUNDATION_DOWNLOADVERIFIER_COPYFILEIFEXIST_OFFSET UNITYSDK_OFFSET(0x1E1EC8E0)
#define FOUNDATION_DOWNLOADVERIFIER_DELETEFILEIFEXIST_OFFSET UNITYSDK_OFFSET(0x1E1EC6A0)
#define FOUNDATION_DOWNLOADVERIFIER_GETTEMPFILEPATH_OFFSET UNITYSDK_OFFSET(0x1E1EC230)
#define FOUNDATION_DOWNLOADVERIFIER_MOVEFILEIFEXIST_OFFSET UNITYSDK_OFFSET(0x1E1EC7D0)
#define FOUNDATION_DOWNLOADVERIFIER_RENAMETEMPFILE_OFFSET UNITYSDK_OFFSET(0x1E1EC460)
#define FOUNDATION_DOWNLOADVERIFIER_VERIFYANDRENAMETEMPFILE_OFFSET UNITYSDK_OFFSET(0x1E1EC1B0)
#define FOUNDATION_DOWNLOADVERIFIER_VERIFYFILE_OFFSET UNITYSDK_OFFSET(0x1E1EC310)
#define FOUNDATION_DOWNLOADVERIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1EC9F0)

namespace Foundation
{
	inline static constexpr unsigned int DownloadVerifier_TypeDefinitionIndex = 8100;
