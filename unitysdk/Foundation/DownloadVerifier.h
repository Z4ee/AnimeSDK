...
#define FOUNDATION_DOWNLOADVERIFIER_COPYFILEIFEXIST_OFFSET UNITYSDK_OFFSET(0x1C00E430)
#define FOUNDATION_DOWNLOADVERIFIER_DELETEFILEIFEXIST_OFFSET UNITYSDK_OFFSET(0x1C00E1F0)
#define FOUNDATION_DOWNLOADVERIFIER_GETTEMPFILEPATH_OFFSET UNITYSDK_OFFSET(0x1C00DD80)
#define FOUNDATION_DOWNLOADVERIFIER_MOVEFILEIFEXIST_OFFSET UNITYSDK_OFFSET(0x1C00E320)
#define FOUNDATION_DOWNLOADVERIFIER_RENAMETEMPFILE_OFFSET UNITYSDK_OFFSET(0x1C00DFB0)
#define FOUNDATION_DOWNLOADVERIFIER_VERIFYANDRENAMETEMPFILE_OFFSET UNITYSDK_OFFSET(0x1C00DD00)
#define FOUNDATION_DOWNLOADVERIFIER_VERIFYFILE_OFFSET UNITYSDK_OFFSET(0x1C00DE60)
#define FOUNDATION_DOWNLOADVERIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C00E540)

namespace Foundation
{
	inline static constexpr unsigned int DownloadVerifier_TypeDefinitionIndex = 7927;
