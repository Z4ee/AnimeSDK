...
#define FOUNDATION_NATIVETEMPMEMORYBUILDER1_BUILD_OFFSET UNITYSDK_OFFSET(0x98C5D0)
#define FOUNDATION_NATIVETEMPMEMORYBUILDER1_REQUESTINTERNAL_OFFSET UNITYSDK_OFFSET(0x98C770)
#define FOUNDATION_NATIVETEMPMEMORYBUILDER1__CTOR_OFFSET UNITYSDK_OFFSET(0x98C570)

namespace Foundation
{
	inline static constexpr unsigned int NativeTempMemoryBuilder1_TypeDefinitionIndex = 8465;
