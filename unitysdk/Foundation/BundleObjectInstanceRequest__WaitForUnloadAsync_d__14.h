...
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST__WAITFORUNLOADASYNC_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19FFBA50)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST__WAITFORUNLOADASYNC_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19FFBAF0)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST__WAITFORUNLOADASYNC_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19FFBB50)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST__WAITFORUNLOADASYNC_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19FFBB00)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST__WAITFORUNLOADASYNC_D__14_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19FFBA40)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST__WAITFORUNLOADASYNC_D__14__CTOR_OFFSET UNITYSDK_OFFSET(0x19FFBA30)

namespace Foundation
{
	inline static constexpr unsigned int BundleObjectInstanceRequest__WaitForUnloadAsync_d__14_TypeDefinitionIndex = 8279;
