...
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST__WAITFORUNLOADASYNC_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D95DA20)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST__WAITFORUNLOADASYNC_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D95DAC0)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST__WAITFORUNLOADASYNC_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D95DB20)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST__WAITFORUNLOADASYNC_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1D95DAD0)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST__WAITFORUNLOADASYNC_D__14_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D95DA10)
#define FOUNDATION_BUNDLEOBJECTINSTANCEREQUEST__WAITFORUNLOADASYNC_D__14__CTOR_OFFSET UNITYSDK_OFFSET(0x1D95DA00)

namespace Foundation
{
	inline static constexpr unsigned int BundleObjectInstanceRequest__WaitForUnloadAsync_d__14_TypeDefinitionIndex = 7937;
