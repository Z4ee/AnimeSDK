...
#define FOUNDATION_VERSION_ASSETGROUP_ASSETSUBGROUP_GET_BLACKLISTMODE_OFFSET UNITYSDK_OFFSET(0x13275360)
#define FOUNDATION_VERSION_ASSETGROUP_ASSETSUBGROUP_GET_SUBGROUPMODE_OFFSET UNITYSDK_OFFSET(0x13275350)
#define FOUNDATION_VERSION_ASSETGROUP_ASSETSUBGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x13275370)

namespace Foundation::Version
{
	inline static constexpr unsigned int AssetGroup_AssetSubGroup_TypeDefinitionIndex = 54689;
