...
#define FOUNDATION_VERSION_ASSETGROUP_ASSETSUBGROUP_GET_BLACKLISTMODE_OFFSET UNITYSDK_OFFSET(0x1503AFA0)
#define FOUNDATION_VERSION_ASSETGROUP_ASSETSUBGROUP_GET_SUBGROUPMODE_OFFSET UNITYSDK_OFFSET(0x1503AF90)
#define FOUNDATION_VERSION_ASSETGROUP_ASSETSUBGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1503AFB0)

namespace Foundation::Version
{
	inline static constexpr unsigned int AssetGroup_AssetSubGroup_TypeDefinitionIndex = 47838;
