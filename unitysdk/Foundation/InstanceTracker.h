...
#define FOUNDATION_INSTANCETRACKER_ADDREQUEST_OFFSET UNITYSDK_OFFSET(0x1A114ED0)
#define FOUNDATION_INSTANCETRACKER_CANFORCEDROP_OFFSET UNITYSDK_OFFSET(0x1A113E10)
#define FOUNDATION_INSTANCETRACKER_CHECKALIVE_OFFSET UNITYSDK_OFFSET(0x1A113930)
#define FOUNDATION_INSTANCETRACKER_CLEARINSTANCES_OFFSET UNITYSDK_OFFSET(0x1A114C80)
#define FOUNDATION_INSTANCETRACKER_COMPOSEINSTANCETRACKER_OFFSET UNITYSDK_OFFSET(0x1A113620)
#define FOUNDATION_INSTANCETRACKER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A115440)
#define FOUNDATION_INSTANCETRACKER_DROP_OFFSET UNITYSDK_OFFSET(0x1A113C80)
#define FOUNDATION_INSTANCETRACKER_FORCEDROP_OFFSET UNITYSDK_OFFSET(0x1A114020)
#define FOUNDATION_INSTANCETRACKER_GETMISSINFOSTRING_OFFSET UNITYSDK_OFFSET(0x1A1140C0)
#define FOUNDATION_INSTANCETRACKER_GET_CAPCITY_OFFSET UNITYSDK_OFFSET(0x1A113590)
#define FOUNDATION_INSTANCETRACKER_GET_DISPOSETICK_OFFSET UNITYSDK_OFFSET(0x1A113560)
#define FOUNDATION_INSTANCETRACKER_GET_MAXREFCOUNT_OFFSET UNITYSDK_OFFSET(0x1A1135F0)
#define FOUNDATION_INSTANCETRACKER_GET_MISSCOUNT_OFFSET UNITYSDK_OFFSET(0x1A113610)
#define FOUNDATION_INSTANCETRACKER_GET_PATH_OFFSET UNITYSDK_OFFSET(0x1A1135E0)
#define FOUNDATION_INSTANCETRACKER_GET_POOLCOUNT_OFFSET UNITYSDK_OFFSET(0x1A113530)
#define FOUNDATION_INSTANCETRACKER_GET_REQUEST_OFFSET UNITYSDK_OFFSET(0x1A1135B0)
#define FOUNDATION_INSTANCETRACKER_GET_TIMEOUTTICK_OFFSET UNITYSDK_OFFSET(0x1A113550)
#define FOUNDATION_INSTANCETRACKER_GET_TIMEOUT_OFFSET UNITYSDK_OFFSET(0x1A113570)
#define FOUNDATION_INSTANCETRACKER_GET_TOTALTAKECOUNT_OFFSET UNITYSDK_OFFSET(0x1A113600)
#define FOUNDATION_INSTANCETRACKER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1A1150E0)
#define FOUNDATION_INSTANCETRACKER_RESETMISSCOUNTER_OFFSET UNITYSDK_OFFSET(0x1A1153F0)
#define FOUNDATION_INSTANCETRACKER_SETPERMANENTLY_OFFSET UNITYSDK_OFFSET(0x1A114BD0)
#define FOUNDATION_INSTANCETRACKER_SET_CAPCITY_OFFSET UNITYSDK_OFFSET(0x1A1135A0)
#define FOUNDATION_INSTANCETRACKER_SET_REQUEST_OFFSET UNITYSDK_OFFSET(0x1A1135D0)
#define FOUNDATION_INSTANCETRACKER_SET_TIMEOUT_OFFSET UNITYSDK_OFFSET(0x1A113580)
#define FOUNDATION_INSTANCETRACKER_TAKEOUT_OFFSET UNITYSDK_OFFSET(0x1A1141E0)
#define FOUNDATION_INSTANCETRACKER_TRACK_OFFSET UNITYSDK_OFFSET(0x1A114940)
#define FOUNDATION_INSTANCETRACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A115720)

namespace Foundation
{
	inline static constexpr unsigned int InstanceTracker_TypeDefinitionIndex = 8270;
	...
	public:
		...
		::Foundation::AssetPoolRunMode* pool; // 0x20
		...
		::System::Int32 _Timeout_k__BackingField; // 0x58
		::System::Int32 _takeCount; // 0x5C
		::System::Int32 _maxRefCount; // 0x60
		::System::Single timeoutTick; // 0x64
		::System::Single disposeTick; // 0x68
		::System::Boolean forceDrop; // 0x6C
		::System::Boolean dontTickAlive; // 0x6D
		::System::Int32 _missCount; // 0x70
