...
#define FOUNDATION_BLOCK_RUNTIME_BLOCKINFO_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0xA157A0)
#define FOUNDATION_BLOCK_RUNTIME_BLOCKINFO_GETASSETBUNDLENAME_OFFSET UNITYSDK_OFFSET(0xA156F0)
#define FOUNDATION_BLOCK_RUNTIME_BLOCKINFO_SERIALIZE_OFFSET UNITYSDK_OFFSET(0xA15710)
#define FOUNDATION_BLOCK_RUNTIME_BLOCKINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA15700)
#define FOUNDATION_BLOCK_RUNTIME_BLOCKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x607930)
#define FOUNDATION_BLOCK_RUNTIME_BLOCKINFO___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA15830)

namespace Foundation::Block::Runtime
{
	inline static constexpr unsigned int BlockInfo_TypeDefinitionIndex = 8120;
