...
#define FOUNDATION_BLOCK_RUNTIME_BLOCKINFO_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x96BB10)
#define FOUNDATION_BLOCK_RUNTIME_BLOCKINFO_GETASSETBUNDLENAME_OFFSET UNITYSDK_OFFSET(0x96BA60)
#define FOUNDATION_BLOCK_RUNTIME_BLOCKINFO_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x96BA80)
#define FOUNDATION_BLOCK_RUNTIME_BLOCKINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x96BA70)
#define FOUNDATION_BLOCK_RUNTIME_BLOCKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x3E9BB0)
#define FOUNDATION_BLOCK_RUNTIME_BLOCKINFO___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x96BBA0)

namespace Foundation::Block::Runtime
{
	inline static constexpr unsigned int BlockInfo_TypeDefinitionIndex = 7936;
