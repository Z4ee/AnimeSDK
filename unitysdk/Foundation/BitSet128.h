...
#define FOUNDATION_BITSET128_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9C13F0)
#define FOUNDATION_BITSET128_EQUALS_OFFSET UNITYSDK_OFFSET(0x9C1380)
#define FOUNDATION_BITSET128_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x9C1490)
#define FOUNDATION_BITSET128_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x6854A0)
#define FOUNDATION_BITSET128_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x588B50)
#define FOUNDATION_BITSET128_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x685BB0)
#define FOUNDATION_BITSET128_NUMBITSET_OFFSET UNITYSDK_OFFSET(0x685BF0)
#define FOUNDATION_BITSET128_OP_BITWISEAND_OFFSET UNITYSDK_OFFSET(0x1C0A2DF0)
#define FOUNDATION_BITSET128_OP_BITWISEOR_OFFSET UNITYSDK_OFFSET(0x1C0A2DD0)
#define FOUNDATION_BITSET128_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1C0A2E10)
#define FOUNDATION_BITSET128_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1C0A2E30)
#define FOUNDATION_BITSET128_OP_ONESCOMPLEMENT_OFFSET UNITYSDK_OFFSET(0x1C0A2DB0)
#define FOUNDATION_BITSET128_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x9C1280)
#define FOUNDATION_BITSET128__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C0A3090)
#define FOUNDATION_BITSET128__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9C12E0)
#define FOUNDATION_BITSET128__CTOR_OFFSET UNITYSDK_OFFSET(0x2FED90)

namespace Foundation
{
	inline static constexpr unsigned int BitSet128_TypeDefinitionIndex = 9198;

	struct alignas(8) BitSet128
	{
		static ::Foundation::BitSet128* StaticGet_Full()
		{
			return (::Foundation::BitSet128*)Il2CppClass::FromTypeDefinitionIndex(BitSet128_TypeDefinitionIndex)->GetStaticField(0x3E20);
		}
		static ::Foundation::BitSet128* StaticGet_Empty()
		{
			return (::Foundation::BitSet128*)Il2CppClass::FromTypeDefinitionIndex(BitSet128_TypeDefinitionIndex)->GetStaticField(0x3E30);
		}
