...
#define FOUNDATION_EXCLUSIVERESOURCEMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C1B37C0)
#define FOUNDATION_EXCLUSIVERESOURCEMANAGER_INITIALIZETICKER_OFFSET UNITYSDK_OFFSET(0x1C1B3810)
#define FOUNDATION_EXCLUSIVERESOURCEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1B3880)

namespace Foundation
{
	inline static constexpr unsigned int ExclusiveResourceManager_TypeDefinitionIndex = 9032;
