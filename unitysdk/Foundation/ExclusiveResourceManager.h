...
#define FOUNDATION_EXCLUSIVERESOURCEMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E5D86B0)
#define FOUNDATION_EXCLUSIVERESOURCEMANAGER_INITIALIZETICKER_OFFSET UNITYSDK_OFFSET(0x1E5D8700)
#define FOUNDATION_EXCLUSIVERESOURCEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5D8770)

namespace Foundation
{
	inline static constexpr unsigned int ExclusiveResourceManager_TypeDefinitionIndex = 8405;
