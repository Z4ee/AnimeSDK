...
#define FOUNDATION_TIMESLICEDLOADERNODE_AWAITLOAD_OFFSET UNITYSDK_OFFSET(0x1B471BF0)
#define FOUNDATION_TIMESLICEDLOADERNODE_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x1B4720E0)
#define FOUNDATION_TIMESLICEDLOADERNODE_CALLLOADED_OFFSET UNITYSDK_OFFSET(0x1B471F60)
#define FOUNDATION_TIMESLICEDLOADERNODE_ONASSETCOMPLETECALLBACK_OFFSET UNITYSDK_OFFSET(0x1B472060)
#define FOUNDATION_TIMESLICEDLOADERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B471920)

namespace Foundation
{
	inline static constexpr unsigned int TimeSlicedLoaderNode_TypeDefinitionIndex = 8075;
