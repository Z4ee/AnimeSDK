...
#define FOUNDATION_ENDOFFRAMESERVICE__START_D__7_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BFF5380)
#define FOUNDATION_ENDOFFRAMESERVICE__START_D__7_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BFF5430)
#define FOUNDATION_ENDOFFRAMESERVICE__START_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BFF5490)
#define FOUNDATION_ENDOFFRAMESERVICE__START_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BFF5440)
#define FOUNDATION_ENDOFFRAMESERVICE__START_D__7_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BFF5370)
#define FOUNDATION_ENDOFFRAMESERVICE__START_D__7__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFF5360)

namespace Foundation
{
	inline static constexpr unsigned int EndOfFrameService__Start_d__7_TypeDefinitionIndex = 9144;
