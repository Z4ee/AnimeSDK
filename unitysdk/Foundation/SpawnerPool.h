...
#define FOUNDATION_SPAWNERPOOL_CLEARPOOL_OFFSET UNITYSDK_OFFSET(0x1C1AC160)
#define FOUNDATION_SPAWNERPOOL_DESPAWNALL_OFFSET UNITYSDK_OFFSET(0x1C1AC0A0)
#define FOUNDATION_SPAWNERPOOL_DESPAWNLIST_OFFSET UNITYSDK_OFFSET(0x1C1ABF20)
#define FOUNDATION_SPAWNERPOOL_DESPAWN_OFFSET UNITYSDK_OFFSET(0x1C1ABD60)
#define FOUNDATION_SPAWNERPOOL_GETACTIVESPAWNS_OFFSET UNITYSDK_OFFSET(0x1C1AC1F0)
#define FOUNDATION_SPAWNERPOOL_PRESPAWN_OFFSET UNITYSDK_OFFSET(0x1C1ABB10)
#define FOUNDATION_SPAWNERPOOL_SPAWN_1_OFFSET UNITYSDK_OFFSET(0x1C1AB7F0)
#define FOUNDATION_SPAWNERPOOL_SPAWN_OFFSET UNITYSDK_OFFSET(0x1C1AB750)
#define FOUNDATION_SPAWNERPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1AB660)

namespace Foundation
{
	inline static constexpr unsigned int SpawnerPool_TypeDefinitionIndex = 7995;
