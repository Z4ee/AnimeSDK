...
#define FOUNDATION_DOWNLOADHANDLER_ABORT_OFFSET UNITYSDK_OFFSET(0x1BAE57F0)
#define FOUNDATION_DOWNLOADHANDLER_CLOSETEMPFILE_OFFSET UNITYSDK_OFFSET(0x1BAE5880)
#define FOUNDATION_DOWNLOADHANDLER_COMBINETEMPFILES_OFFSET UNITYSDK_OFFSET(0x1BAE6080)
#define FOUNDATION_DOWNLOADHANDLER_COMPLETECONTENT_OFFSET UNITYSDK_OFFSET(0x1BAE5B80)
#define FOUNDATION_DOWNLOADHANDLER_DELETEFILEIFEXIST_OFFSET UNITYSDK_OFFSET(0x1BAE6410)
#define FOUNDATION_DOWNLOADHANDLER_GETFILECRC_OFFSET UNITYSDK_OFFSET(0x1BAE5F10)
#define FOUNDATION_DOWNLOADHANDLER_GETFILEMD5_OFFSET UNITYSDK_OFFSET(0x1BAE64E0)
#define FOUNDATION_DOWNLOADHANDLER_INIT_OFFSET UNITYSDK_OFFSET(0x1BAE5720)
#define FOUNDATION_DOWNLOADHANDLER_ISINASSETREQUEST_OFFSET UNITYSDK_OFFSET(0x1BAE62A0)
#define FOUNDATION_DOWNLOADHANDLER_MOVEFILEIFEXIST_OFFSET UNITYSDK_OFFSET(0x1BAE62F0)
#define FOUNDATION_DOWNLOADHANDLER_RECEIVEDATA_OFFSET UNITYSDK_OFFSET(0x1BAE58F0)
#define FOUNDATION_DOWNLOADHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAE56F0)
#define FOUNDATION_DOWNLOADHANDLER___BASE_COMPLETECONTENT_OFFSET UNITYSDK_OFFSET(0x1BAE6770)
#define FOUNDATION_DOWNLOADHANDLER___BASE_RECEIVEDATA_OFFSET UNITYSDK_OFFSET(0x1BAE6780)

namespace Foundation
{
	inline static constexpr unsigned int DownloadHandler_TypeDefinitionIndex = 8257;

	class DownloadHandler : public ::UnityEngine::Networking::DownloadHandlerScript
	{
	public:
		::Foundation::Download* _downloadInfo; // 0x18
		::System::IO::FileStream* _tempFileStream; // 0x20
		::System::String* _tempFilePath; // 0x28
