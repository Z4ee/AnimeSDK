...
#define FOUNDATION_AGGREGATECOMPONENTASSIGNABLEINTERFACE_GET_OFFSET UNITYSDK_OFFSET(0x9662B0)
#define FOUNDATION_AGGREGATECOMPONENTASSIGNABLEINTERFACE_ISASSIGNABLE_OFFSET UNITYSDK_OFFSET(0x966360)
#define FOUNDATION_AGGREGATECOMPONENTASSIGNABLEINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x9662A0)

namespace Foundation
{
	inline static constexpr unsigned int AggregateComponentAssignableInterface_TypeDefinitionIndex = 8956;
