...
#define FOUNDATION_AGGREGATECOMPONENTASSIGNABLEINTERFACE_GET_OFFSET UNITYSDK_OFFSET(0xA3A990)
#define FOUNDATION_AGGREGATECOMPONENTASSIGNABLEINTERFACE_ISASSIGNABLE_OFFSET UNITYSDK_OFFSET(0xA3AA40)
#define FOUNDATION_AGGREGATECOMPONENTASSIGNABLEINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0xA3A980)

namespace Foundation
{
	inline static constexpr unsigned int AggregateComponentAssignableInterface_TypeDefinitionIndex = 8630;
