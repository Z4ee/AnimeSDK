...
#define FOUNDATION_BITSET64_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x99F720)
#define FOUNDATION_BITSET64_EQUALS_OFFSET UNITYSDK_OFFSET(0x99F6B0)
#define FOUNDATION_BITSET64_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x815700)
#define FOUNDATION_BITSET64_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x396A90)
#define FOUNDATION_BITSET64_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x99F540)
#define FOUNDATION_BITSET64_OP_BITWISEAND_OFFSET UNITYSDK_OFFSET(0x1BA60E90)
#define FOUNDATION_BITSET64_OP_BITWISEOR_OFFSET UNITYSDK_OFFSET(0x1BA60E80)
#define FOUNDATION_BITSET64_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1BA60EA0)
#define FOUNDATION_BITSET64_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x99F550)
#define FOUNDATION_BITSET64__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BA60FC0)
#define FOUNDATION_BITSET64__CTOR_1_OFFSET UNITYSDK_OFFSET(0x99F570)
#define FOUNDATION_BITSET64__CTOR_OFFSET UNITYSDK_OFFSET(0x2E5940)

namespace Foundation
{
	inline static constexpr unsigned int BitSet64_TypeDefinitionIndex = 8826;

	struct alignas(8) BitSet64
	{
		static ::Foundation::BitSet64* StaticGet_Full()
		{
			return (::Foundation::BitSet64*)Il2CppClass::FromTypeDefinitionIndex(BitSet64_TypeDefinitionIndex)->GetStaticField(0x3CE0);
		}
		static ::Foundation::BitSet64* StaticGet_Empty()
		{
			return (::Foundation::BitSet64*)Il2CppClass::FromTypeDefinitionIndex(BitSet64_TypeDefinitionIndex)->GetStaticField(0x3CE8);
		}
