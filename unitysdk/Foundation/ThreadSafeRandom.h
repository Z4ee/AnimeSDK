...
#define FOUNDATION_THREADSAFERANDOM_GET_OFFSET UNITYSDK_OFFSET(0xA574F0)
#define FOUNDATION_THREADSAFERANDOM_RANGE_OFFSET UNITYSDK_OFFSET(0xA57440)
#define FOUNDATION_THREADSAFERANDOM_SETSEED_OFFSET UNITYSDK_OFFSET(0xA57410)
#define FOUNDATION_THREADSAFERANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0xA57410)

namespace Foundation
{
	inline static constexpr unsigned int ThreadSafeRandom_TypeDefinitionIndex = 8806;
