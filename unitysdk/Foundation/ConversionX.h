...
#define FOUNDATION_CONVERSIONX_FROMBASE64_OFFSET UNITYSDK_OFFSET(0x1B8453C0)
#define FOUNDATION_CONVERSIONX_TOBASE64_OFFSET UNITYSDK_OFFSET(0x1B845130)
#define FOUNDATION_CONVERSIONX_TOBOOLNULL_OFFSET UNITYSDK_OFFSET(0x1B843D40)
#define FOUNDATION_CONVERSIONX_TOBOOL_OFFSET UNITYSDK_OFFSET(0x1B843B20)
#define FOUNDATION_CONVERSIONX_TOCHAR_OFFSET UNITYSDK_OFFSET(0x1B8422C0)
#define FOUNDATION_CONVERSIONX_TODATETIMENULL_OFFSET UNITYSDK_OFFSET(0x1B844260)
#define FOUNDATION_CONVERSIONX_TODATETIME_OFFSET UNITYSDK_OFFSET(0x1B844000)
#define FOUNDATION_CONVERSIONX_TODECIMALNULLABLE_OFFSET UNITYSDK_OFFSET(0x1B844AE0)
#define FOUNDATION_CONVERSIONX_TODECIMALNULL_OFFSET UNITYSDK_OFFSET(0x1B843330)
#define FOUNDATION_CONVERSIONX_TODECIMAL_1_OFFSET UNITYSDK_OFFSET(0x1B842DF0)
#define FOUNDATION_CONVERSIONX_TODECIMAL_OFFSET UNITYSDK_OFFSET(0x1B842010)
#define FOUNDATION_CONVERSIONX_TODOUBLENULLABLE_OFFSET UNITYSDK_OFFSET(0x1B844820)
#define FOUNDATION_CONVERSIONX_TODOUBLE_1_OFFSET UNITYSDK_OFFSET(0x1B844F90)
#define FOUNDATION_CONVERSIONX_TODOUBLE_OFFSET UNITYSDK_OFFSET(0x1B843120)
#define FOUNDATION_CONVERSIONX_TOFLOATNULL_OFFSET UNITYSDK_OFFSET(0x1B843880)
#define FOUNDATION_CONVERSIONX_TOFLOAT_1_OFFSET UNITYSDK_OFFSET(0x1B843670)
#define FOUNDATION_CONVERSIONX_TOFLOAT_OFFSET UNITYSDK_OFFSET(0x1B841E80)
#define FOUNDATION_CONVERSIONX_TOGUID_OFFSET UNITYSDK_OFFSET(0x1B844510)
#define FOUNDATION_CONVERSIONX_TOINTNULLABLE_OFFSET UNITYSDK_OFFSET(0x1B844BE0)
#define FOUNDATION_CONVERSIONX_TOINTNULL_OFFSET UNITYSDK_OFFSET(0x1B8426A0)
#define FOUNDATION_CONVERSIONX_TOINT_1_OFFSET UNITYSDK_OFFSET(0x1B844C70)
#define FOUNDATION_CONVERSIONX_TOINT_OFFSET UNITYSDK_OFFSET(0x1B8424B0)
#define FOUNDATION_CONVERSIONX_TOLONGNULL_OFFSET UNITYSDK_OFFSET(0x1B842B30)
#define FOUNDATION_CONVERSIONX_TOLONG_1_OFFSET UNITYSDK_OFFSET(0x1B844E00)
#define FOUNDATION_CONVERSIONX_TOLONG_OFFSET UNITYSDK_OFFSET(0x1B842940)

namespace Foundation
{
	inline static constexpr unsigned int ConversionX_TypeDefinitionIndex = 8473;
