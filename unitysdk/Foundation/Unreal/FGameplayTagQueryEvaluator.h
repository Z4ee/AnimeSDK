...
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEVALUATOR_CREATE_OFFSET UNITYSDK_OFFSET(0x1C173AA0)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEVALUATOR_EVALALLEXPRMATCH_OFFSET UNITYSDK_OFFSET(0x9C4140)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEVALUATOR_EVALALLTAGSMATCH_OFFSET UNITYSDK_OFFSET(0x9C4110)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEVALUATOR_EVALANYEXPRMATCH_OFFSET UNITYSDK_OFFSET(0x9C4130)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEVALUATOR_EVALANYTAGSMATCH_OFFSET UNITYSDK_OFFSET(0x9C4100)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEVALUATOR_EVALEXPR_OFFSET UNITYSDK_OFFSET(0x9C4160)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEVALUATOR_EVALNOEXPRMATCH_OFFSET UNITYSDK_OFFSET(0x9C4150)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEVALUATOR_EVALNOTAGSMATCH_OFFSET UNITYSDK_OFFSET(0x9C4120)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEVALUATOR_EVAL_OFFSET UNITYSDK_OFFSET(0x9C40F0)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEVALUATOR_GETQUERY_OFFSET UNITYSDK_OFFSET(0x9C4240)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEVALUATOR_GETTOKEN_OFFSET UNITYSDK_OFFSET(0x9C4170)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int FGameplayTagQueryEvaluator_TypeDefinitionIndex = 9209;
