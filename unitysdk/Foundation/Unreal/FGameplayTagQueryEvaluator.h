...
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEVALUATOR_CREATE_OFFSET UNITYSDK_OFFSET(0x13663F10)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEVALUATOR_EVALALLEXPRMATCH_OFFSET UNITYSDK_OFFSET(0x7B7140)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEVALUATOR_EVALALLTAGSMATCH_OFFSET UNITYSDK_OFFSET(0x7B7110)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEVALUATOR_EVALANYEXPRMATCH_OFFSET UNITYSDK_OFFSET(0x7B7130)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEVALUATOR_EVALANYTAGSMATCH_OFFSET UNITYSDK_OFFSET(0x7B7100)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEVALUATOR_EVALEXPR_OFFSET UNITYSDK_OFFSET(0x7B7160)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEVALUATOR_EVALNOEXPRMATCH_OFFSET UNITYSDK_OFFSET(0x7B7150)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEVALUATOR_EVALNOTAGSMATCH_OFFSET UNITYSDK_OFFSET(0x7B7120)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEVALUATOR_EVAL_OFFSET UNITYSDK_OFFSET(0x7B70F0)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEVALUATOR_GETQUERY_OFFSET UNITYSDK_OFFSET(0x7B7240)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEVALUATOR_GETTOKEN_OFFSET UNITYSDK_OFFSET(0x7B7170)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int FGameplayTagQueryEvaluator_TypeDefinitionIndex = 17448;
