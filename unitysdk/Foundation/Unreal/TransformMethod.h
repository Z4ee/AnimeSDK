...
#define FOUNDATION_UNREAL_TRANSFORMMETHOD_GETRELATIVETRANSFORM_1_OFFSET UNITYSDK_OFFSET(0x1F762830)
#define FOUNDATION_UNREAL_TRANSFORMMETHOD_GETRELATIVETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1F7621C0)
#define FOUNDATION_UNREAL_TRANSFORMMETHOD_GETSAFESCALERECIPROCAL_1_OFFSET UNITYSDK_OFFSET(0x1F762D10)
#define FOUNDATION_UNREAL_TRANSFORMMETHOD_GETSAFESCALERECIPROCAL_2_OFFSET UNITYSDK_OFFSET(0x1F762D70)
#define FOUNDATION_UNREAL_TRANSFORMMETHOD_GETSAFESCALERECIPROCAL_OFFSET UNITYSDK_OFFSET(0x1F761FF0)
#define FOUNDATION_UNREAL_TRANSFORMMETHOD_INVERSETRANSFORMPOINTDIRECT_OFFSET UNITYSDK_OFFSET(0x1F762050)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int TransformMethod_TypeDefinitionIndex = 8537;
