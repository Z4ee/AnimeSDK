...
#define FOUNDATION_UNREAL_SERIALIZABLEGAMEPLAYTAGQUERY_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x136668E0)
#define FOUNDATION_UNREAL_SERIALIZABLEGAMEPLAYTAGQUERY_GET_VALUEREF_OFFSET UNITYSDK_OFFSET(0x13666730)
#define FOUNDATION_UNREAL_SERIALIZABLEGAMEPLAYTAGQUERY_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x13666A90)
#define FOUNDATION_UNREAL_SERIALIZABLEGAMEPLAYTAGQUERY_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x13666BD0)
#define FOUNDATION_UNREAL_SERIALIZABLEGAMEPLAYTAGQUERY_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x13666BC0)
#define FOUNDATION_UNREAL_SERIALIZABLEGAMEPLAYTAGQUERY__CTOR_OFFSET UNITYSDK_OFFSET(0x13666BE0)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int SerializableGameplayTagQuery_TypeDefinitionIndex = 11427;
