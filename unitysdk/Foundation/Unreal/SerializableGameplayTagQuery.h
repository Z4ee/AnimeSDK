...
#define FOUNDATION_UNREAL_SERIALIZABLEGAMEPLAYTAGQUERY_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C176EA0)
#define FOUNDATION_UNREAL_SERIALIZABLEGAMEPLAYTAGQUERY_GET_VALUEREF_OFFSET UNITYSDK_OFFSET(0x1C176CF0)
#define FOUNDATION_UNREAL_SERIALIZABLEGAMEPLAYTAGQUERY_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C177050)
#define FOUNDATION_UNREAL_SERIALIZABLEGAMEPLAYTAGQUERY_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C177190)
#define FOUNDATION_UNREAL_SERIALIZABLEGAMEPLAYTAGQUERY_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C177180)
#define FOUNDATION_UNREAL_SERIALIZABLEGAMEPLAYTAGQUERY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1771A0)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int SerializableGameplayTagQuery_TypeDefinitionIndex = 8778;
