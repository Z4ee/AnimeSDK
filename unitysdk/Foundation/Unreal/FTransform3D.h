...
#define FOUNDATION_UNREAL_FTRANSFORM3D_DIAGNOSTICCHECKNAN_ROTATION_OFFSET UNITYSDK_OFFSET(0x283610)
#define FOUNDATION_UNREAL_FTRANSFORM3D_DIAGNOSTICCHECKNAN_SCALE_OFFSET UNITYSDK_OFFSET(0x283610)
#define FOUNDATION_UNREAL_FTRANSFORM3D_DIAGNOSTICCHECKNAN_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x283610)
#define FOUNDATION_UNREAL_FTRANSFORM3D_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x417280)
#define FOUNDATION_UNREAL_FTRANSFORM3D_GET_SCALE3D_OFFSET UNITYSDK_OFFSET(0x92A7D0)
#define FOUNDATION_UNREAL_FTRANSFORM3D_GET_TRANSLATIONOFFSET_OFFSET UNITYSDK_OFFSET(0x1E8074D0)
#define FOUNDATION_UNREAL_FTRANSFORM3D_GET_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x388220)
#define FOUNDATION_UNREAL_FTRANSFORM3D_OP_EXPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1E807650)
#define FOUNDATION_UNREAL_FTRANSFORM3D_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1E8075D0)
#define FOUNDATION_UNREAL_FTRANSFORM3D_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x92A7C0)
#define FOUNDATION_UNREAL_FTRANSFORM3D_SET_SCALE3D_OFFSET UNITYSDK_OFFSET(0x92A7F0)
#define FOUNDATION_UNREAL_FTRANSFORM3D_SET_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x387FA0)
#define FOUNDATION_UNREAL_FTRANSFORM3D__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E8076E0)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int FTransform3D_TypeDefinitionIndex = 8660;

	struct alignas(4) FTransform3D
	{
		static ::Foundation::Unreal::FTransform3D* StaticGet_Identity()
		{
			return (::Foundation::Unreal::FTransform3D*)Il2CppClass::FromTypeDefinitionIndex(FTransform3D_TypeDefinitionIndex)->GetStaticField(0x3C60);
		}
