...
#define FOUNDATION_UNREAL_FTRANSFORM3D_DIAGNOSTICCHECKNAN_ROTATION_OFFSET UNITYSDK_OFFSET(0x296F30)
#define FOUNDATION_UNREAL_FTRANSFORM3D_DIAGNOSTICCHECKNAN_SCALE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define FOUNDATION_UNREAL_FTRANSFORM3D_DIAGNOSTICCHECKNAN_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x296F30)
#define FOUNDATION_UNREAL_FTRANSFORM3D_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x4963E0)
#define FOUNDATION_UNREAL_FTRANSFORM3D_GET_SCALE3D_OFFSET UNITYSDK_OFFSET(0x97A360)
#define FOUNDATION_UNREAL_FTRANSFORM3D_GET_TRANSLATIONOFFSET_OFFSET UNITYSDK_OFFSET(0x1FBE36B0)
#define FOUNDATION_UNREAL_FTRANSFORM3D_GET_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x34AF10)
#define FOUNDATION_UNREAL_FTRANSFORM3D_OP_EXPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1FBE3830)
#define FOUNDATION_UNREAL_FTRANSFORM3D_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1FBE37B0)
#define FOUNDATION_UNREAL_FTRANSFORM3D_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x97A350)
#define FOUNDATION_UNREAL_FTRANSFORM3D_SET_SCALE3D_OFFSET UNITYSDK_OFFSET(0x97A380)
#define FOUNDATION_UNREAL_FTRANSFORM3D_SET_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x34AC00)
#define FOUNDATION_UNREAL_FTRANSFORM3D__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FBE38C0)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int FTransform3D_TypeDefinitionIndex = 8603;

	struct alignas(4) FTransform3D
	{
		static ::Foundation::Unreal::FTransform3D* StaticGet_Identity()
		{
			return (::Foundation::Unreal::FTransform3D*)Il2CppClass::FromTypeDefinitionIndex(FTransform3D_TypeDefinitionIndex)->GetStaticField(0x3C80);
		}
