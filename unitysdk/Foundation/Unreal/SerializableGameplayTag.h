...
#define FOUNDATION_UNREAL_SERIALIZABLEGAMEPLAYTAG_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x16FCB350)
#define FOUNDATION_UNREAL_SERIALIZABLEGAMEPLAYTAG_GET_VALUEREF_OFFSET UNITYSDK_OFFSET(0x16FCB0E0)
#define FOUNDATION_UNREAL_SERIALIZABLEGAMEPLAYTAG_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x16FCB5C0)
#define FOUNDATION_UNREAL_SERIALIZABLEGAMEPLAYTAG_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x16FCB5B0)
#define FOUNDATION_UNREAL_SERIALIZABLEGAMEPLAYTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FCB5D0)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int SerializableGameplayTag_TypeDefinitionIndex = 9538;
