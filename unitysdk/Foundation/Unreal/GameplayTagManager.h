...
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_ADDTAG_OFFSET UNITYSDK_OFFSET(0x1BA65E90)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_CHECKVALIDGAMEPLAYTAGSIMPLESTRINGVIEW_OFFSET UNITYSDK_OFFSET(0x1BA65790)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_CONSTRUCTGAMEPLAYTAGTREE_OFFSET UNITYSDK_OFFSET(0x1BA64EE0)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_CREATEIFNULL_OFFSET UNITYSDK_OFFSET(0x1BA65950)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_FINDORADDCHILD_OFFSET UNITYSDK_OFFSET(0x1BA65C30)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_GETNODETREE_OFFSET UNITYSDK_OFFSET(0x1BA64E60)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_GETSINGLETAGCONTAINER_1_OFFSET UNITYSDK_OFFSET(0x1BA64D00)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_GETSINGLETAGCONTAINER_OFFSET UNITYSDK_OFFSET(0x1BA64B90)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_GET_OFFSET UNITYSDK_OFFSET(0x1BA64150)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1BA64220)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_PARSEINTOARRAY_OFFSET UNITYSDK_OFFSET(0x1BA659D0)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_REQUESTGAMEPLAYTAG_OFFSET UNITYSDK_OFFSET(0x1BA64B00)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BA641B0)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA64A40)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int GameplayTagManager_TypeDefinitionIndex = 8813;
	...
	public:
		...
		{
			return (::Foundation::AssetPath*)Il2CppClass::FromTypeDefinitionIndex(GameplayTagManager_TypeDefinitionIndex)->GetStaticField(0x7D40);
		}
		static ::Foundation::Unreal::GameplayTagManager** StaticGet__instance()
		{
			return (::Foundation::Unreal::GameplayTagManager**)Il2CppClass::FromTypeDefinitionIndex(GameplayTagManager_TypeDefinitionIndex)->GetStaticField(0x7D50);
		}
