...
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_ADDTAG_OFFSET UNITYSDK_OFFSET(0x181AA090)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_CHECKVALIDGAMEPLAYTAGSIMPLESTRINGVIEW_OFFSET UNITYSDK_OFFSET(0x181A9980)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_CONSTRUCTGAMEPLAYTAGTREE_OFFSET UNITYSDK_OFFSET(0x181A90D0)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_CREATEIFNULL_OFFSET UNITYSDK_OFFSET(0x181A9B60)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_FINDORADDCHILD_OFFSET UNITYSDK_OFFSET(0x181A9E50)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_GETNODETREE_OFFSET UNITYSDK_OFFSET(0x181A9050)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_GETSINGLETAGCONTAINER_1_OFFSET UNITYSDK_OFFSET(0x181A8D20)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_GETSINGLETAGCONTAINER_OFFSET UNITYSDK_OFFSET(0x181A8BC0)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_GET_OFFSET UNITYSDK_OFFSET(0x181A82C0)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x181A8390)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_PARSEINTOARRAY_OFFSET UNITYSDK_OFFSET(0x181A9BE0)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_REQUESTGAMEPLAYTAGPARENTS_OFFSET UNITYSDK_OFFSET(0x181A8E80)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_REQUESTGAMEPLAYTAG_OFFSET UNITYSDK_OFFSET(0x181A8B30)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x181A8320)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x181A8A70)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int GameplayTagManager_TypeDefinitionIndex = 14227;
	...
	public:
		...
		{
			return (::Foundation::Unreal::GameplayTagManager**)Il2CppClass::FromTypeDefinitionIndex(GameplayTagManager_TypeDefinitionIndex)->GetStaticField(0x7660);
		}
		static ::Foundation::AssetPath* StaticGet_SettingPath()
		{
			return (::Foundation::AssetPath*)Il2CppClass::FromTypeDefinitionIndex(GameplayTagManager_TypeDefinitionIndex)->GetStaticField(0x7668);
		}
