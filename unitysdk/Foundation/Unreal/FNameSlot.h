...
#define FOUNDATION_UNREAL_FNAMESLOT_GET_ENTRYID_OFFSET UNITYSDK_OFFSET(0xA6DB50)
#define FOUNDATION_UNREAL_FNAMESLOT_GET_ISUSED_OFFSET UNITYSDK_OFFSET(0x677870)
#define FOUNDATION_UNREAL_FNAMESLOT_GET_PROBEHASH_OFFSET UNITYSDK_OFFSET(0xA6DBB0)
#define FOUNDATION_UNREAL_FNAMESLOT__CTOR_OFFSET UNITYSDK_OFFSET(0xA6DB40)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int FNameSlot_TypeDefinitionIndex = 8805;
