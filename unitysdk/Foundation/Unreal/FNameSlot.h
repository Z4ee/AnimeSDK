...
#define FOUNDATION_UNREAL_FNAMESLOT_GET_ENTRYID_OFFSET UNITYSDK_OFFSET(0x9C5250)
#define FOUNDATION_UNREAL_FNAMESLOT_GET_ISUSED_OFFSET UNITYSDK_OFFSET(0x5B28F0)
#define FOUNDATION_UNREAL_FNAMESLOT_GET_PROBEHASH_OFFSET UNITYSDK_OFFSET(0x9C52B0)
#define FOUNDATION_UNREAL_FNAMESLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x9C5240)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int FNameSlot_TypeDefinitionIndex = 9006;
