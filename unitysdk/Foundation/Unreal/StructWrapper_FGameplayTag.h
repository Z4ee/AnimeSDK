...
#define FOUNDATION_UNREAL_STRUCTWRAPPER_FGAMEPLAYTAG_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x296F30)
#define FOUNDATION_UNREAL_STRUCTWRAPPER_FGAMEPLAYTAG_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x3CADC0)
#define FOUNDATION_UNREAL_STRUCTWRAPPER_FGAMEPLAYTAG_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x3CADC0)
#define FOUNDATION_UNREAL_STRUCTWRAPPER_FGAMEPLAYTAG_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define FOUNDATION_UNREAL_STRUCTWRAPPER_FGAMEPLAYTAG_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0xA13ED0)
#define FOUNDATION_UNREAL_STRUCTWRAPPER_FGAMEPLAYTAG_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xA13F30)
#define FOUNDATION_UNREAL_STRUCTWRAPPER_FGAMEPLAYTAG_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x3CADC0)
#define FOUNDATION_UNREAL_STRUCTWRAPPER_FGAMEPLAYTAG_UNREALTYPES_ISTRUCT_FOUNDATION_UNREAL_FGAMEPLAYTAG__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x296F30)
#define FOUNDATION_UNREAL_STRUCTWRAPPER_FGAMEPLAYTAG__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E381EB0)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int StructWrapper_FGameplayTag_TypeDefinitionIndex = 28268;

	struct alignas(1) StructWrapper_FGameplayTag
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StructWrapper_FGameplayTag_TypeDefinitionIndex)->GetStaticField(0x23ED0);
		}
