...
#define FOUNDATION_UNREAL_FNAMEENTRYALLOCATOR_ALLOCATEBLOCK_OFFSET UNITYSDK_OFFSET(0x1C176390)
#define FOUNDATION_UNREAL_FNAMEENTRYALLOCATOR_ALLOCATENAMEENTRY_OFFSET UNITYSDK_OFFSET(0x9C4380)
#define FOUNDATION_UNREAL_FNAMEENTRYALLOCATOR_CREATE_OFFSET UNITYSDK_OFFSET(0x1C176830)
#define FOUNDATION_UNREAL_FNAMEENTRYALLOCATOR_FREEBLOCK_OFFSET UNITYSDK_OFFSET(0x1C176460)
#define FOUNDATION_UNREAL_FNAMEENTRYALLOCATOR_ISDISPOSED_OFFSET UNITYSDK_OFFSET(0x58CD50)
#define FOUNDATION_UNREAL_FNAMEENTRYALLOCATOR_NEWBLOCK_OFFSET UNITYSDK_OFFSET(0x9C4370)
#define FOUNDATION_UNREAL_FNAMEENTRYALLOCATOR_RESOLVE_OFFSET UNITYSDK_OFFSET(0x9C4390)
#define FOUNDATION_UNREAL_FNAMEENTRYALLOCATOR_TOALIGNEDLENGTH_OFFSET UNITYSDK_OFFSET(0x1C176400)
#define FOUNDATION_UNREAL_FNAMEENTRYALLOCATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C1762C0)
#define FOUNDATION_UNREAL_FNAMEENTRYALLOCATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x9C42B0)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int FNameEntryAllocator_TypeDefinitionIndex = 9074;

	struct alignas(8) FNameEntryAllocator
	{
		static ::System::Int32* StaticGet_DataOffset()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(FNameEntryAllocator_TypeDefinitionIndex)->GetStaticField(0x3D40);
		}
		static ::System::Int32* StaticGet_Stride()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(FNameEntryAllocator_TypeDefinitionIndex)->GetStaticField(0x3D44);
		}
		static ::System::Int32* StaticGet_BlockByteSize()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(FNameEntryAllocator_TypeDefinitionIndex)->GetStaticField(0x3D48);
		}
