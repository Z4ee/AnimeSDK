...
#define FOUNDATION_UNREAL_GAMEPLAYTAGCOLLECTION__COLLECT_D__3_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19D695B0)
#define FOUNDATION_UNREAL_GAMEPLAYTAGCOLLECTION__COLLECT_D__3_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_STRING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A067560)
#define FOUNDATION_UNREAL_GAMEPLAYTAGCOLLECTION__COLLECT_D__3_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_STRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A0674F0)
#define FOUNDATION_UNREAL_GAMEPLAYTAGCOLLECTION__COLLECT_D__3_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A0675E0)
#define FOUNDATION_UNREAL_GAMEPLAYTAGCOLLECTION__COLLECT_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A067550)
#define FOUNDATION_UNREAL_GAMEPLAYTAGCOLLECTION__COLLECT_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A067500)
#define FOUNDATION_UNREAL_GAMEPLAYTAGCOLLECTION__COLLECT_D__3_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19D69590)
#define FOUNDATION_UNREAL_GAMEPLAYTAGCOLLECTION__COLLECT_D__3__CTOR_OFFSET UNITYSDK_OFFSET(0x19D69570)
#define FOUNDATION_UNREAL_GAMEPLAYTAGCOLLECTION__COLLECT_D__3___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1A0674D0)
#define FOUNDATION_UNREAL_GAMEPLAYTAGCOLLECTION__COLLECT_D__3___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1A0674E0)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int GameplayTagCollection__Collect_d__3_TypeDefinitionIndex = 10071;

	class GameplayTagCollection__Collect_d__3 : public ::System::Object
	{
	public:
		::Foundation::Unreal::GameplayTagCollection* __4__this; // 0x10
		...
		::System::String* __2__current; // 0x38
