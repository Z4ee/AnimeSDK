...
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEXPRESSIONEXTENSION_ADDEXPR_OFFSET UNITYSDK_OFFSET(0x18F6B8E0)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEXPRESSIONEXTENSION_ADDTAG_OFFSET UNITYSDK_OFFSET(0x18F6B880)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEXPRESSIONEXTENSION_ALLEXPRMATCH_OFFSET UNITYSDK_OFFSET(0x18F6B3E0)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEXPRESSIONEXTENSION_ALLTAGSMATCH_OFFSET UNITYSDK_OFFSET(0x18F6B3B0)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEXPRESSIONEXTENSION_ANYEXPRMATCH_OFFSET UNITYSDK_OFFSET(0x18F6B3D0)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEXPRESSIONEXTENSION_ANYTAGSMATCH_OFFSET UNITYSDK_OFFSET(0x18F6B3A0)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEXPRESSIONEXTENSION_EMITIMPL_OFFSET UNITYSDK_OFFSET(0x18F6BB60)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEXPRESSIONEXTENSION_EMIT_OFFSET UNITYSDK_OFFSET(0x18F6BB00)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEXPRESSIONEXTENSION_GETTOKENCOUNT_OFFSET UNITYSDK_OFFSET(0x18F6BA60)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEXPRESSIONEXTENSION_NOEXPRMATCH_OFFSET UNITYSDK_OFFSET(0x18F6B3F0)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEXPRESSIONEXTENSION_NOTAGSMATCH_OFFSET UNITYSDK_OFFSET(0x18F6B3C0)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEXPRESSIONEXTENSION_RESERVEQUERYEXPRESSION_OFFSET UNITYSDK_OFFSET(0x18F6B650)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEXPRESSIONEXTENSION_RESERVETAGSET_OFFSET UNITYSDK_OFFSET(0x18F6B420)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEXPRESSIONEXTENSION_USEEXPRSET_OFFSET UNITYSDK_OFFSET(0x18F6B410)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGQUERYEXPRESSIONEXTENSION_USETAGSET_OFFSET UNITYSDK_OFFSET(0x18F6B400)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int FGameplayTagQueryExpressionExtension_TypeDefinitionIndex = 12764;
