...
#define FOUNDATION_UNREAL_STRUCTWRAPPER_FGAMEPLAYTAG_STRUCTOPSTYPETRAITS_GET_CANZEROCREATE_OFFSET UNITYSDK_OFFSET(0x1D1ABAC0)
#define FOUNDATION_UNREAL_STRUCTWRAPPER_FGAMEPLAYTAG_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0x1D1ABAB0)
#define FOUNDATION_UNREAL_STRUCTWRAPPER_FGAMEPLAYTAG_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1ABA90)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int StructWrapper_FGameplayTag_StructOpsTypeTraits_TypeDefinitionIndex = 27667;
