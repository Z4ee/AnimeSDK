...
#define FOUNDATION_FBEHAVIORSWITCHSTATUS_CONTAINS_OFFSET UNITYSDK_OFFSET(0xAB76F0)
#define FOUNDATION_FBEHAVIORSWITCHSTATUS_GET_HASBLENDEDINSWITCH_OFFSET UNITYSDK_OFFSET(0xAB7690)
#define FOUNDATION_FBEHAVIORSWITCHSTATUS_GET_HASBLENDEDOUTSWITCH_OFFSET UNITYSDK_OFFSET(0xAB76D0)
#define FOUNDATION_FBEHAVIORSWITCHSTATUS_GET_HASBLENDINSWITCH_OFFSET UNITYSDK_OFFSET(0xAB7670)
#define FOUNDATION_FBEHAVIORSWITCHSTATUS_GET_HASBLENDOUTSWITCH_OFFSET UNITYSDK_OFFSET(0xAB76B0)
#define FOUNDATION_FBEHAVIORSWITCHSTATUS_GET_HASSTATESWITCH_OFFSET UNITYSDK_OFFSET(0xAB7660)
#define FOUNDATION_FBEHAVIORSWITCHSTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x312BA0)

namespace Foundation
{
	inline static constexpr unsigned int FBehaviorSwitchStatus_TypeDefinitionIndex = 8597;
