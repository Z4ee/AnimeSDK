...
#define FOUNDATION_DOUBLEPERIODICPOLICY_FOUNDATION_IPERIODICPOLICY_SYSTEM_DOUBLE__INVOKE_OFFSET UNITYSDK_OFFSET(0x1FBFD290)
#define FOUNDATION_DOUBLEPERIODICPOLICY_FOUNDATION_IPERIODICPOLICY_SYSTEM_DOUBLE__ISVALIDPERIOD_OFFSET UNITYSDK_OFFSET(0x1FBFD3E0)
#define FOUNDATION_DOUBLEPERIODICPOLICY_FOUNDATION_IPLUSFUNC_SYSTEM_DOUBLE__PLUS_OFFSET UNITYSDK_OFFSET(0x1FBFD3F0)
#define FOUNDATION_DOUBLEPERIODICPOLICY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FBFD400)
#define FOUNDATION_DOUBLEPERIODICPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBFD280)

namespace Foundation
{
	inline static constexpr unsigned int DoublePeriodicPolicy_TypeDefinitionIndex = 8485;
	...
	public:
		...
		{
			return (::Foundation::DoublePeriodicPolicy**)Il2CppClass::FromTypeDefinitionIndex(DoublePeriodicPolicy_TypeDefinitionIndex)->GetStaticField(0x75A0);
		}
