...
#define FOUNDATION_DOUBLEPERIODICPOLICY_FOUNDATION_IPERIODICPOLICY_SYSTEM_DOUBLE__INVOKE_OFFSET UNITYSDK_OFFSET(0x1E822780)
#define FOUNDATION_DOUBLEPERIODICPOLICY_FOUNDATION_IPERIODICPOLICY_SYSTEM_DOUBLE__ISVALIDPERIOD_OFFSET UNITYSDK_OFFSET(0x1E8228F0)
#define FOUNDATION_DOUBLEPERIODICPOLICY_FOUNDATION_IPLUSFUNC_SYSTEM_DOUBLE__PLUS_OFFSET UNITYSDK_OFFSET(0x1E822900)
#define FOUNDATION_DOUBLEPERIODICPOLICY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E822910)
#define FOUNDATION_DOUBLEPERIODICPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E822770)

namespace Foundation
{
	inline static constexpr unsigned int DoublePeriodicPolicy_TypeDefinitionIndex = 8718;
	...
	public:
		...
		{
			return (::Foundation::DoublePeriodicPolicy**)Il2CppClass::FromTypeDefinitionIndex(DoublePeriodicPolicy_TypeDefinitionIndex)->GetStaticField(0x7560);
		}
