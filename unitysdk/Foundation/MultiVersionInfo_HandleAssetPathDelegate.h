...
#define FOUNDATION_MULTIVERSIONINFO_HANDLEASSETPATHDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B76D960)
#define FOUNDATION_MULTIVERSIONINFO_HANDLEASSETPATHDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B76D9E0)
#define FOUNDATION_MULTIVERSIONINFO_HANDLEASSETPATHDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B76D400)
#define FOUNDATION_MULTIVERSIONINFO_HANDLEASSETPATHDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B76D3F0)

namespace Foundation
{
	inline static constexpr unsigned int MultiVersionInfo_HandleAssetPathDelegate_TypeDefinitionIndex = 7762;
