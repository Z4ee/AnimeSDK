...
#define FOUNDATION_MULTIVERSIONDIFFCONFIG_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1F696D40)
#define FOUNDATION_MULTIVERSIONDIFFCONFIG_GETALLOTHERVERSIONPATHS_OFFSET UNITYSDK_OFFSET(0x1F6971E0)
#define FOUNDATION_MULTIVERSIONDIFFCONFIG_GETASSETPATHS_OFFSET UNITYSDK_OFFSET(0x1F696E10)
#define FOUNDATION_MULTIVERSIONDIFFCONFIG_UPDATEHASH_OFFSET UNITYSDK_OFFSET(0x1F697090)
#define FOUNDATION_MULTIVERSIONDIFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1F697460)

namespace Foundation
{
	inline static constexpr unsigned int MultiVersionDiffConfig_TypeDefinitionIndex = 7941;
