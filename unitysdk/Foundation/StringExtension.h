...
#define FOUNDATION_STRINGEXTENSION_INT64VALUE_OFFSET UNITYSDK_OFFSET(0x1CC95870)
#define FOUNDATION_STRINGEXTENSION_INTVALUE_OFFSET UNITYSDK_OFFSET(0x1CC95790)
#define FOUNDATION_STRINGEXTENSION_UINTVALUE_OFFSET UNITYSDK_OFFSET(0x1CC95800)

namespace Foundation
{
	inline static constexpr unsigned int StringExtension_TypeDefinitionIndex = 8189;
