...
#define FOUNDATION_DOWNLOADUTIL_CHANGEFILEREADONLYACCESS_OFFSET UNITYSDK_OFFSET(0x1DE35ED0)
#define FOUNDATION_DOWNLOADUTIL_CHANGEREADONLYANDDELETEIFEXIST_OFFSET UNITYSDK_OFFSET(0x1DE35DA0)
#define FOUNDATION_DOWNLOADUTIL_CHECKCLEARRESINPERSISTDIR_OFFSET UNITYSDK_OFFSET(0x1DE35190)
#define FOUNDATION_DOWNLOADUTIL_CHECKUNSAVEDNEWRES_1_OFFSET UNITYSDK_OFFSET(0x1DE354F0)
#define FOUNDATION_DOWNLOADUTIL_CHECKUNSAVEDNEWRES_OFFSET UNITYSDK_OFFSET(0x1DE35240)
#define FOUNDATION_DOWNLOADUTIL_CHECKUNZIPPEDNEWRES_OFFSET UNITYSDK_OFFSET(0x1DE359E0)
#define FOUNDATION_DOWNLOADUTIL_CLEARDOWNLOADTEMPFILE_OFFSET UNITYSDK_OFFSET(0x1DE35200)
#define FOUNDATION_DOWNLOADUTIL_GETDISPLAYSIZEB_OFFSET UNITYSDK_OFFSET(0x1DE350E0)
#define FOUNDATION_DOWNLOADUTIL_GETDISPLAYSIZEKB_OFFSET UNITYSDK_OFFSET(0x1DE35020)
#define FOUNDATION_DOWNLOADUTIL_GETDISPLAYSIZEMB_OFFSET UNITYSDK_OFFSET(0x1DE34F60)
#define FOUNDATION_DOWNLOADUTIL_GETDISPLAYSIZE_OFFSET UNITYSDK_OFFSET(0x1DE34EF0)
#define FOUNDATION_DOWNLOADUTIL_GETDISPLAYSPEED_OFFSET UNITYSDK_OFFSET(0x1DE34DC0)

namespace Foundation
{
	inline static constexpr unsigned int DownloadUtil_TypeDefinitionIndex = 7732;
