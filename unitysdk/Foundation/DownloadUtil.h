...
#define FOUNDATION_DOWNLOADUTIL_CHANGEFILEREADONLYACCESS_OFFSET UNITYSDK_OFFSET(0x1F01B320)
#define FOUNDATION_DOWNLOADUTIL_CHANGEREADONLYANDDELETEIFEXIST_OFFSET UNITYSDK_OFFSET(0x1F01B1F0)
#define FOUNDATION_DOWNLOADUTIL_CHECKCLEARRESINPERSISTDIR_OFFSET UNITYSDK_OFFSET(0x1F01A5E0)
#define FOUNDATION_DOWNLOADUTIL_CHECKUNSAVEDNEWRES_1_OFFSET UNITYSDK_OFFSET(0x1F01A940)
#define FOUNDATION_DOWNLOADUTIL_CHECKUNSAVEDNEWRES_OFFSET UNITYSDK_OFFSET(0x1F01A690)
#define FOUNDATION_DOWNLOADUTIL_CHECKUNZIPPEDNEWRES_OFFSET UNITYSDK_OFFSET(0x1F01AE30)
#define FOUNDATION_DOWNLOADUTIL_CLEARDOWNLOADTEMPFILE_OFFSET UNITYSDK_OFFSET(0x1F01A650)
#define FOUNDATION_DOWNLOADUTIL_GETDISPLAYSIZEB_OFFSET UNITYSDK_OFFSET(0x1F01A530)
#define FOUNDATION_DOWNLOADUTIL_GETDISPLAYSIZEKB_OFFSET UNITYSDK_OFFSET(0x1F01A470)
#define FOUNDATION_DOWNLOADUTIL_GETDISPLAYSIZEMB_OFFSET UNITYSDK_OFFSET(0x1F01A3B0)
#define FOUNDATION_DOWNLOADUTIL_GETDISPLAYSIZE_OFFSET UNITYSDK_OFFSET(0x1F01A340)
#define FOUNDATION_DOWNLOADUTIL_GETDISPLAYSPEED_OFFSET UNITYSDK_OFFSET(0x1F01A210)

namespace Foundation
{
	inline static constexpr unsigned int DownloadUtil_TypeDefinitionIndex = 7966;
