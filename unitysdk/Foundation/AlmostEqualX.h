...
#define FOUNDATION_ALMOSTEQUALX_ALMOSTEQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B714870)
#define FOUNDATION_ALMOSTEQUALX_ALMOSTEQUALS_2_OFFSET UNITYSDK_OFFSET(0x1B714900)
#define FOUNDATION_ALMOSTEQUALX_ALMOSTEQUALS_3_OFFSET UNITYSDK_OFFSET(0x1B7149D0)
#define FOUNDATION_ALMOSTEQUALX_ALMOSTEQUALS_4_OFFSET UNITYSDK_OFFSET(0x1B714A60)
#define FOUNDATION_ALMOSTEQUALX_ALMOSTEQUALS_OFFSET UNITYSDK_OFFSET(0x1B7147B0)

namespace Foundation
{
	inline static constexpr unsigned int AlmostEqualX_TypeDefinitionIndex = 8246;
