...
#define FOUNDATION_ALMOSTEQUALX_ALMOSTEQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DA2FCA0)
#define FOUNDATION_ALMOSTEQUALX_ALMOSTEQUALS_2_OFFSET UNITYSDK_OFFSET(0x1DA2FD30)
#define FOUNDATION_ALMOSTEQUALX_ALMOSTEQUALS_3_OFFSET UNITYSDK_OFFSET(0x1DA2FE00)
#define FOUNDATION_ALMOSTEQUALX_ALMOSTEQUALS_4_OFFSET UNITYSDK_OFFSET(0x1DA2FE90)
#define FOUNDATION_ALMOSTEQUALX_ALMOSTEQUALS_OFFSET UNITYSDK_OFFSET(0x1DA2FBE0)

namespace Foundation
{
	inline static constexpr unsigned int AlmostEqualX_TypeDefinitionIndex = 8042;
