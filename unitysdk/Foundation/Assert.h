...
#define FOUNDATION_ASSERT_ASSERTATLEAST_OFFSET UNITYSDK_OFFSET(0x1F7806A0)
#define FOUNDATION_ASSERT_ASSERTATMOST_OFFSET UNITYSDK_OFFSET(0x1F780860)
#define FOUNDATION_ASSERT_ASSERTEQUALS_OFFSET UNITYSDK_OFFSET(0x1F780B10)
#define FOUNDATION_ASSERT_ASSERTINRANGE_1_OFFSET UNITYSDK_OFFSET(0x1F780400)
#define FOUNDATION_ASSERT_ASSERTINRANGE_OFFSET UNITYSDK_OFFSET(0x1F780190)
#define FOUNDATION_ASSERT_ASSERTNOTNULL_1_OFFSET UNITYSDK_OFFSET(0x1F780A60)
#define FOUNDATION_ASSERT_ASSERTNOTNULL_OFFSET UNITYSDK_OFFSET(0x1F780A20)
#define FOUNDATION_ASSERT_ASSERTSTRINGNOTNULL_OFFSET UNITYSDK_OFFSET(0x1F7800F0)
#define FOUNDATION_ASSERT_ASSERTTRUE_1_OFFSET UNITYSDK_OFFSET(0x1F780080)
#define FOUNDATION_ASSERT_ASSERTTRUE_OFFSET UNITYSDK_OFFSET(0x1F780000)
#define FOUNDATION_ASSERT_FAIL_1_OFFSET UNITYSDK_OFFSET(0x1F77FFA0)
#define FOUNDATION_ASSERT_FAIL_OFFSET UNITYSDK_OFFSET(0x1F77FE80)

namespace Foundation
{
	inline static constexpr unsigned int Assert_TypeDefinitionIndex = 8341;
