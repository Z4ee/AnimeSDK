...
#define FOUNDATION_CONFIGINFOGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1F661490)

namespace Foundation
{
	inline static constexpr unsigned int ConfigInfoGroup_TypeDefinitionIndex = 8059;
