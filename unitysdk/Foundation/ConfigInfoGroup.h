...
#define FOUNDATION_CONFIGINFOGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBF0F50)

namespace Foundation
{
	inline static constexpr unsigned int ConfigInfoGroup_TypeDefinitionIndex = 7955;
