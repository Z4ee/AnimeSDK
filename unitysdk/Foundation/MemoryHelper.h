...
#define FOUNDATION_MEMORYHELPER_GETFILESIZE_OFFSET UNITYSDK_OFFSET(0x1DDAB3C0)
#define FOUNDATION_MEMORYHELPER_GETMEMORYGB_1_OFFSET UNITYSDK_OFFSET(0x1DDABA10)
#define FOUNDATION_MEMORYHELPER_GETMEMORYGB_2_OFFSET UNITYSDK_OFFSET(0x1DDABAC0)
#define FOUNDATION_MEMORYHELPER_GETMEMORYGB_3_OFFSET UNITYSDK_OFFSET(0x1DDABB70)
#define FOUNDATION_MEMORYHELPER_GETMEMORYGB_OFFSET UNITYSDK_OFFSET(0x1DDAB960)
#define FOUNDATION_MEMORYHELPER_GETMEMORYMB_1_OFFSET UNITYSDK_OFFSET(0x1DDAB730)
#define FOUNDATION_MEMORYHELPER_GETMEMORYMB_2_OFFSET UNITYSDK_OFFSET(0x1DDAB7E0)
#define FOUNDATION_MEMORYHELPER_GETMEMORYMB_3_OFFSET UNITYSDK_OFFSET(0x1DDAB890)
#define FOUNDATION_MEMORYHELPER_GETMEMORYMB_OFFSET UNITYSDK_OFFSET(0x1DDAB680)
#define FOUNDATION_MEMORYHELPER_GETMEMSIZE_OFFSET UNITYSDK_OFFSET(0x1DDAB460)

namespace Foundation
{
	inline static constexpr unsigned int MemoryHelper_TypeDefinitionIndex = 8108;
