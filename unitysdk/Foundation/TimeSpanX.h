...
#define FOUNDATION_TIMESPANX_GETFORTNIGHTS_OFFSET UNITYSDK_OFFSET(0x1BD3D0E0)
#define FOUNDATION_TIMESPANX_GETWEEKS_OFFSET UNITYSDK_OFFSET(0x1BD3D060)
#define FOUNDATION_TIMESPANX_MINUTESTOTIMESPAN_OFFSET UNITYSDK_OFFSET(0x1BD3D1E0)
#define FOUNDATION_TIMESPANX_SECONDSTOTIMESPAN_OFFSET UNITYSDK_OFFSET(0x1BD3D190)

namespace Foundation
{
	inline static constexpr unsigned int TimeSpanX_TypeDefinitionIndex = 8161;
