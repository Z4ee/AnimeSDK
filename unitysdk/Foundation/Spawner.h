...
#define FOUNDATION_SPAWNER_DESPAWN_OFFSET UNITYSDK_OFFSET(0x1DDACAC0)
#define FOUNDATION_SPAWNER_PRESPAWN_OFFSET UNITYSDK_OFFSET(0x1DDACDE0)
#define FOUNDATION_SPAWNER_SPAWN_1_OFFSET UNITYSDK_OFFSET(0x1DDAC710)
#define FOUNDATION_SPAWNER_SPAWN_OFFSET UNITYSDK_OFFSET(0x1DDAC060)
#define FOUNDATION_SPAWNER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DDAD130)
#define FOUNDATION_SPAWNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDAD0D0)

namespace Foundation
{
	inline static constexpr unsigned int Spawner_TypeDefinitionIndex = 8133;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::Foundation::SpawnerPool*>**)Il2CppClass::FromTypeDefinitionIndex(Spawner_TypeDefinitionIndex)->GetStaticField(0x6A30);
		}
