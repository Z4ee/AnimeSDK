...
#define FOUNDATION_CONTAINER_DEFAULTNATIVEVECTORELEMENTALLOCATOR_CALCULATECAPACITYFORRESERVE_OFFSET UNITYSDK_OFFSET(0x924670)
#define FOUNDATION_CONTAINER_DEFAULTNATIVEVECTORELEMENTALLOCATOR_FREE_OFFSET UNITYSDK_OFFSET(0x924760)
#define FOUNDATION_CONTAINER_DEFAULTNATIVEVECTORELEMENTALLOCATOR_GET_ISCREATED_OFFSET UNITYSDK_OFFSET(0x726120)
#define FOUNDATION_CONTAINER_DEFAULTNATIVEVECTORELEMENTALLOCATOR_MALLOC_OFFSET UNITYSDK_OFFSET(0x924780)
#define FOUNDATION_CONTAINER_DEFAULTNATIVEVECTORELEMENTALLOCATOR_RESOLVE_OFFSET UNITYSDK_OFFSET(0x9247A0)
#define FOUNDATION_CONTAINER_DEFAULTNATIVEVECTORELEMENTALLOCATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x2E85F0)

namespace Foundation::Container
{
	inline static constexpr unsigned int DefaultNativeVectorElementAllocator_TypeDefinitionIndex = 8954;
