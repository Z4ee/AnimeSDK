...
#define FOUNDATION_CONTAINER_DEFAULTNATIVEVECTORELEMENTALLOCATOR_CALCULATECAPACITYFORRESERVE_OFFSET UNITYSDK_OFFSET(0x9CA6F0)
#define FOUNDATION_CONTAINER_DEFAULTNATIVEVECTORELEMENTALLOCATOR_FREE_OFFSET UNITYSDK_OFFSET(0x9CA7E0)
#define FOUNDATION_CONTAINER_DEFAULTNATIVEVECTORELEMENTALLOCATOR_GET_ISCREATED_OFFSET UNITYSDK_OFFSET(0x7A4180)
#define FOUNDATION_CONTAINER_DEFAULTNATIVEVECTORELEMENTALLOCATOR_MALLOC_OFFSET UNITYSDK_OFFSET(0x9CA800)
#define FOUNDATION_CONTAINER_DEFAULTNATIVEVECTORELEMENTALLOCATOR_RESOLVE_OFFSET UNITYSDK_OFFSET(0x9CA820)
#define FOUNDATION_CONTAINER_DEFAULTNATIVEVECTORELEMENTALLOCATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x2B66C0)

namespace Foundation::Container
{
	inline static constexpr unsigned int DefaultNativeVectorElementAllocator_TypeDefinitionIndex = 8418;
