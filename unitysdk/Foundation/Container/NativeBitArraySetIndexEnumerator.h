...
#define FOUNDATION_CONTAINER_NATIVEBITARRAYSETINDEXENUMERATOR_FINDSETBITINDEX_OFFSET UNITYSDK_OFFSET(0x1F9DA2D0)
#define FOUNDATION_CONTAINER_NATIVEBITARRAYSETINDEXENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xABE530)
#define FOUNDATION_CONTAINER_NATIVEBITARRAYSETINDEXENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xABE5A0)
#define FOUNDATION_CONTAINER_NATIVEBITARRAYSETINDEXENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xABE510)

namespace Foundation::Container
{
	inline static constexpr unsigned int NativeBitArraySetIndexEnumerator_TypeDefinitionIndex = 8607;
