...
#define FOUNDATION_CONTAINER_NATIVEBITARRAYSETINDEXENUMERATOR_FINDSETBITINDEX_OFFSET UNITYSDK_OFFSET(0x1C212420)
#define FOUNDATION_CONTAINER_NATIVEBITARRAYSETINDEXENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x9C6020)
#define FOUNDATION_CONTAINER_NATIVEBITARRAYSETINDEXENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x9C6090)
#define FOUNDATION_CONTAINER_NATIVEBITARRAYSETINDEXENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x9C6000)

namespace Foundation::Container
{
	inline static constexpr unsigned int NativeBitArraySetIndexEnumerator_TypeDefinitionIndex = 9128;
