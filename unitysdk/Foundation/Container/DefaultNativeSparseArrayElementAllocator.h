...
#define FOUNDATION_CONTAINER_DEFAULTNATIVESPARSEARRAYELEMENTALLOCATOR_CALCULATECAPACITYFORRESERVE_OFFSET UNITYSDK_OFFSET(0x9BCDF0)
#define FOUNDATION_CONTAINER_DEFAULTNATIVESPARSEARRAYELEMENTALLOCATOR_FREE_OFFSET UNITYSDK_OFFSET(0x924760)
#define FOUNDATION_CONTAINER_DEFAULTNATIVESPARSEARRAYELEMENTALLOCATOR_GET_ISCREATED_OFFSET UNITYSDK_OFFSET(0x726120)
#define FOUNDATION_CONTAINER_DEFAULTNATIVESPARSEARRAYELEMENTALLOCATOR_MALLOC_OFFSET UNITYSDK_OFFSET(0x924780)
#define FOUNDATION_CONTAINER_DEFAULTNATIVESPARSEARRAYELEMENTALLOCATOR_RESOLVE_OFFSET UNITYSDK_OFFSET(0x9247A0)
#define FOUNDATION_CONTAINER_DEFAULTNATIVESPARSEARRAYELEMENTALLOCATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x2E85F0)

namespace Foundation::Container
{
	inline static constexpr unsigned int DefaultNativeSparseArrayElementAllocator_TypeDefinitionIndex = 8878;
