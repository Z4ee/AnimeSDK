...
#define FOUNDATION_CONTAINER_DEFAULTNATIVESPARSEARRAYELEMENTALLOCATOR_CALCULATECAPACITYFORRESERVE_OFFSET UNITYSDK_OFFSET(0xA60D80)
#define FOUNDATION_CONTAINER_DEFAULTNATIVESPARSEARRAYELEMENTALLOCATOR_FREE_OFFSET UNITYSDK_OFFSET(0x9CA7E0)
#define FOUNDATION_CONTAINER_DEFAULTNATIVESPARSEARRAYELEMENTALLOCATOR_GET_ISCREATED_OFFSET UNITYSDK_OFFSET(0x7A4180)
#define FOUNDATION_CONTAINER_DEFAULTNATIVESPARSEARRAYELEMENTALLOCATOR_MALLOC_OFFSET UNITYSDK_OFFSET(0x9CA800)
#define FOUNDATION_CONTAINER_DEFAULTNATIVESPARSEARRAYELEMENTALLOCATOR_RESOLVE_OFFSET UNITYSDK_OFFSET(0x9CA820)
#define FOUNDATION_CONTAINER_DEFAULTNATIVESPARSEARRAYELEMENTALLOCATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x2B66C0)

namespace Foundation::Container
{
	inline static constexpr unsigned int DefaultNativeSparseArrayElementAllocator_TypeDefinitionIndex = 8752;
