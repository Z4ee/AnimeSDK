...
#define FOUNDATION_MYLOGGER___C__DISPLAYCLASS21_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B85DBF0)
#define FOUNDATION_MYLOGGER___C__DISPLAYCLASS21_0__DODRAWARROW_B__0_OFFSET UNITYSDK_OFFSET(0x1B85DC00)

namespace Foundation
{
	inline static constexpr unsigned int MyLogger___c__DisplayClass21_0_TypeDefinitionIndex = 8380;
