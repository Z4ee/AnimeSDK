...
#define FOUNDATION_OBJECTSERVICE_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x1D0015D0)
#define FOUNDATION_OBJECTSERVICE_COLLECTCHILDRENRELEASEOBJECTRECURSIVE_OFFSET UNITYSDK_OFFSET(0x1D0067F0)
#define FOUNDATION_OBJECTSERVICE_COLLECTRELEASEOBJECT_OFFSET UNITYSDK_OFFSET(0x1D007C00)
#define FOUNDATION_OBJECTSERVICE_DORELEASEOBJECT_OFFSET UNITYSDK_OFFSET(0x1D006560)
#define FOUNDATION_OBJECTSERVICE_DOREMOVEFROMPARENT_1_OFFSET UNITYSDK_OFFSET(0x1D0060C0)
#define FOUNDATION_OBJECTSERVICE_DOREMOVEFROMPARENT_OFFSET UNITYSDK_OFFSET(0x1D005730)
#define FOUNDATION_OBJECTSERVICE_DOREMOVE_OFFSET UNITYSDK_OFFSET(0x1D006A90)
#define FOUNDATION_OBJECTSERVICE_DOSETPARENT_OFFSET UNITYSDK_OFFSET(0x1D006370)
#define FOUNDATION_OBJECTSERVICE_ENSUREOBJECTSINDEX_OFFSET UNITYSDK_OFFSET(0x1D0064D0)
#define FOUNDATION_OBJECTSERVICE_FOUNDATION_IGAMESERVICE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1D00AEF0)
#define FOUNDATION_OBJECTSERVICE_FOUNDATION_IGAMESERVICE_ONREADYTODESTROY_OFFSET UNITYSDK_OFFSET(0x1D00AE70)
#define FOUNDATION_OBJECTSERVICE_GETROOT_OFFSET UNITYSDK_OFFSET(0x1D009030)
#define FOUNDATION_OBJECTSERVICE_INITRELEASEBUFFER_OFFSET UNITYSDK_OFFSET(0x1D007B90)
#define FOUNDATION_OBJECTSERVICE_ISALIVE_1_OFFSET UNITYSDK_OFFSET(0x1D008970)
#define FOUNDATION_OBJECTSERVICE_ISALIVE_2_OFFSET UNITYSDK_OFFSET(0x1D008EA0)
#define FOUNDATION_OBJECTSERVICE_ISALIVE_OFFSET UNITYSDK_OFFSET(0x1D002900)
#define FOUNDATION_OBJECTSERVICE_ISALLOCATED_OFFSET UNITYSDK_OFFSET(0x1D009B70)
#define FOUNDATION_OBJECTSERVICE_ISMATCHANDALIVE_1_OFFSET UNITYSDK_OFFSET(0x1D0093E0)
#define FOUNDATION_OBJECTSERVICE_ISMATCHANDALIVE_OFFSET UNITYSDK_OFFSET(0x1D0091B0)
#define FOUNDATION_OBJECTSERVICE_ISMATCHANDALLOCATED_OFFSET UNITYSDK_OFFSET(0x1D0098B0)
#define FOUNDATION_OBJECTSERVICE_ISMATCH_OFFSET UNITYSDK_OFFSET(0x1D009B90)
#define FOUNDATION_OBJECTSERVICE_MARKFORREMOVAL_OFFSET UNITYSDK_OFFSET(0x1D002EA0)
#define FOUNDATION_OBJECTSERVICE_NEWITEM_OFFSET UNITYSDK_OFFSET(0x1D006550)
#define FOUNDATION_OBJECTSERVICE_ONCREATE_OFFSET UNITYSDK_OFFSET(0x1D001530)
#define FOUNDATION_OBJECTSERVICE_RELEASE_OFFSET UNITYSDK_OFFSET(0x1D009BA0)
#define FOUNDATION_OBJECTSERVICE_REMOVE_OFFSET UNITYSDK_OFFSET(0x1D003C50)
#define FOUNDATION_OBJECTSERVICE_RESET_OFFSET UNITYSDK_OFFSET(0x1D0021D0)
#define FOUNDATION_OBJECTSERVICE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D00B1C0)
#define FOUNDATION_OBJECTSERVICE__COLLECTRELEASEOBJECT_G__COLLECTANDMOVENEXT_32_0_OFFSET UNITYSDK_OFFSET(0x1D008810)
#define FOUNDATION_OBJECTSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D001340)

namespace Foundation
{
	inline static constexpr unsigned int ObjectService_TypeDefinitionIndex = 8541;
	...
	public:
		...
		{
			return (::Foundation::Container::DefaultNativeSparseArrayElementAllocator*)Il2CppClass::FromTypeDefinitionIndex(ObjectService_TypeDefinitionIndex)->GetStaticField(0x3AE0);
		}
		::System::Collections::Generic::List_1<::System::Int32>* _objectsToRelease; // 0x10
		::System::Collections::Generic::List_1<::Foundation::IObject*>* _objects; // 0x18
		::Foundation::Container::NativeSparseArrayData_3<::Foundation::Container::EmptyUserData, ::Foundation::ObjectService_ObjectItem, ::Foundation::Native::RawPointer> _objectItems; // 0x20
		::Foundation::ObjectService_ObjectItem _aliveRoot; // 0x30
		::Foundation::ObjectService_ObjectItem _removalRoot; // 0x44
		::System::Int32 _idGenerator; // 0x58
