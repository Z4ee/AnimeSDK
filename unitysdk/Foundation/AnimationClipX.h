...
#define FOUNDATION_ANIMATIONCLIPX_DRAWSAMPLEANIMATION_OFFSET UNITYSDK_OFFSET(0x1B714B00)

namespace Foundation
{
	inline static constexpr unsigned int AnimationClipX_TypeDefinitionIndex = 7977;
