...
#define FOUNDATION_ANIMATIONCLIPX_DRAWSAMPLEANIMATION_OFFSET UNITYSDK_OFFSET(0x1EF793C0)

namespace Foundation
{
	inline static constexpr unsigned int AnimationClipX_TypeDefinitionIndex = 8311;
