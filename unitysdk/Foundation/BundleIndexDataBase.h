...
#define FOUNDATION_BUNDLEINDEXDATABASE_ASSETTOBUNDLESINSERTORUPDATE_OFFSET UNITYSDK_OFFSET(0x1DCB5320)
#define FOUNDATION_BUNDLEINDEXDATABASE_ASSETTOBUNDLESREMOVEBYKEY_OFFSET UNITYSDK_OFFSET(0x1DCB53A0)
#define FOUNDATION_BUNDLEINDEXDATABASE_ASSETTOBUNDLESTRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1DCB5430)
#define FOUNDATION_BUNDLEINDEXDATABASE_BUNDLECHILDRENSADD_OFFSET UNITYSDK_OFFSET(0x1DCB5730)
#define FOUNDATION_BUNDLEINDEXDATABASE_BUNDLEINFOSINSERTORUPDATE_OFFSET UNITYSDK_OFFSET(0x1DCB5240)
#define FOUNDATION_BUNDLEINDEXDATABASE_BUNDLEINFOSTRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1DCB52B0)
#define FOUNDATION_BUNDLEINDEXDATABASE_BUNDLETOCHILDRENINSERTORUPDATE_OFFSET UNITYSDK_OFFSET(0x1DCB54B0)
#define FOUNDATION_BUNDLEINDEXDATABASE_BUNDLETOCHILDRENTRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1DCB5520)
#define FOUNDATION_BUNDLEINDEXDATABASE_CLEARALLBLOCKLOCATIONCACHE_OFFSET UNITYSDK_OFFSET(0x1DCB4DC0)
#define FOUNDATION_BUNDLEINDEXDATABASE_CLEARALLWITHOUTBUNDLES_OFFSET UNITYSDK_OFFSET(0x1DCB51A0)
#define FOUNDATION_BUNDLEINDEXDATABASE_CLEARALL_OFFSET UNITYSDK_OFFSET(0x1DCB50F0)
#define FOUNDATION_BUNDLEINDEXDATABASE_CLEARBLOCKLOCATIONCACHE_OFFSET UNITYSDK_OFFSET(0x1DCB4E00)
#define FOUNDATION_BUNDLEINDEXDATABASE_GETALLASSETHASHES_OFFSET UNITYSDK_OFFSET(0x1DCB57C0)
#define FOUNDATION_BUNDLEINDEXDATABASE_GETBUNDLECHILDRENSCOUNT_OFFSET UNITYSDK_OFFSET(0x1DCB56E0)
#define FOUNDATION_BUNDLEINDEXDATABASE_GETCHILDREN_OFFSET UNITYSDK_OFFSET(0x1DCB5590)
#define FOUNDATION_BUNDLEINDEXDATABASE_INITASSETS_OFFSET UNITYSDK_OFFSET(0x1DCB5010)
#define FOUNDATION_BUNDLEINDEXDATABASE_INITBUNDLEINDEXASSET_OFFSET UNITYSDK_OFFSET(0x1DCB4D70)
#define FOUNDATION_BUNDLEINDEXDATABASE_INITBUNDLES_OFFSET UNITYSDK_OFFSET(0x1DCB4E50)
#define FOUNDATION_BUNDLEINDEXDATABASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCB5830)

namespace Foundation
{
	inline static constexpr unsigned int BundleIndexDataBase_TypeDefinitionIndex = 8149;
