...
#define FOUNDATION_MULTIVERSIONINFO_CHECKASSETPATHDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F697C20)
#define FOUNDATION_MULTIVERSIONINFO_CHECKASSETPATHDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F697CA0)
#define FOUNDATION_MULTIVERSIONINFO_CHECKASSETPATHDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F6976A0)
#define FOUNDATION_MULTIVERSIONINFO_CHECKASSETPATHDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F697680)

namespace Foundation
{
	inline static constexpr unsigned int MultiVersionInfo_CheckAssetPathDelegate_TypeDefinitionIndex = 8244;
