...
#define FOUNDATION_MULTIVERSIONINFO_CHECKASSETPATHDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C00F640)
#define FOUNDATION_MULTIVERSIONINFO_CHECKASSETPATHDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C00F6C0)
#define FOUNDATION_MULTIVERSIONINFO_CHECKASSETPATHDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C00F0E0)
#define FOUNDATION_MULTIVERSIONINFO_CHECKASSETPATHDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C00F0D0)

namespace Foundation
{
	inline static constexpr unsigned int MultiVersionInfo_CheckAssetPathDelegate_TypeDefinitionIndex = 7761;
