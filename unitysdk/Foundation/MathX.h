...
#define FOUNDATION_MATHX_ACCEL_OFFSET UNITYSDK_OFFSET(0x1B85D3A0)
#define FOUNDATION_MATHX_CALPARALOBAPOSITION_OFFSET UNITYSDK_OFFSET(0x1B85D7C0)
#define FOUNDATION_MATHX_CLAMPINDEGREE_OFFSET UNITYSDK_OFFSET(0x1B85D720)
#define FOUNDATION_MATHX_COSEULAR_OFFSET UNITYSDK_OFFSET(0x1B85D0C0)
#define FOUNDATION_MATHX_LERP_OFFSET UNITYSDK_OFFSET(0x1B85D150)
#define FOUNDATION_MATHX_SINEULAR_OFFSET UNITYSDK_OFFSET(0x1B85CE60)
#define FOUNDATION_MATHX_SPEEDTO_OFFSET UNITYSDK_OFFSET(0x1B85D430)
#define FOUNDATION_MATHX_TOPI_OFFSET UNITYSDK_OFFSET(0x1B85D060)

namespace Foundation
{
	inline static constexpr unsigned int MathX_TypeDefinitionIndex = 8309;
