...
#define FOUNDATION_TIMERCLOCKROOT_ADDLISTENERSPEEDCHANGEDBEFORE_OFFSET UNITYSDK_OFFSET(0x1F4BF610)
#define FOUNDATION_TIMERCLOCKROOT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1F4BF730)
#define FOUNDATION_TIMERCLOCKROOT_GETDELTATIME_OFFSET UNITYSDK_OFFSET(0x1F4BF530)
#define FOUNDATION_TIMERCLOCKROOT_GETENGINETIME_OFFSET UNITYSDK_OFFSET(0x1F4BF590)
#define FOUNDATION_TIMERCLOCKROOT_GET_E_ONCHANGED_OFFSET UNITYSDK_OFFSET(0x1F4BF710)
#define FOUNDATION_TIMERCLOCKROOT_GET_PARENTTIMERCLOCK_OFFSET UNITYSDK_OFFSET(0x1F4BF600)
#define FOUNDATION_TIMERCLOCKROOT_GET_SPEED_OFFSET UNITYSDK_OFFSET(0x1F4BF5F0)
#define FOUNDATION_TIMERCLOCKROOT_REMOVELISTENERSPEEDCHANGEDBEFORE_OFFSET UNITYSDK_OFFSET(0x1F4BF660)
#define FOUNDATION_TIMERCLOCKROOT_SETPARENTCLOCK_OFFSET UNITYSDK_OFFSET(0x1F4BF4E0)
#define FOUNDATION_TIMERCLOCKROOT_SETSPEED_OFFSET UNITYSDK_OFFSET(0x1F4BF6B0)
#define FOUNDATION_TIMERCLOCKROOT_SET_E_ONCHANGED_OFFSET UNITYSDK_OFFSET(0x1F4BF720)
#define FOUNDATION_TIMERCLOCKROOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1F4BF770)

namespace Foundation
{
	inline static constexpr unsigned int TimerClockRoot_TypeDefinitionIndex = 8002;
