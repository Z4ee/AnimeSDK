...
#define FOUNDATION_IENUMERATORLOADERYIELD_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1DCC2ED0)
#define FOUNDATION_IENUMERATORLOADERYIELD_GET_KEEPWAITING_OFFSET UNITYSDK_OFFSET(0x1DCC2F70)
#define FOUNDATION_IENUMERATORLOADERYIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCC2F60)

namespace Foundation
{
	inline static constexpr unsigned int IEnumeratorLoaderYield_TypeDefinitionIndex = 8329;
	...
	public:
		...
		{
			return (::Foundation::IEnumeratorLoaderYield**)Il2CppClass::FromTypeDefinitionIndex(IEnumeratorLoaderYield_TypeDefinitionIndex)->GetStaticField(0x7350);
		}
