...
{
	inline static constexpr unsigned int TwoDimensionalTable_3___c__DisplayClass6_0_TypeDefinitionIndex = 7751;

	template <typename TX, typename TY, typename V>
	class TwoDimensionalTable_3___c__DisplayClass6_0 : public ::System::Object
	{
	public:
		TX x; // 0x0
		TY y; // 0x0
