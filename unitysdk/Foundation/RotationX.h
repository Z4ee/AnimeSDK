...
#define FOUNDATION_ROTATIONX_GETCAMERAROTATIONTOTARGET_OFFSET UNITYSDK_OFFSET(0x19DAEF00)
#define FOUNDATION_ROTATIONX_LOOKAT_1_OFFSET UNITYSDK_OFFSET(0x19DAE0E0)
#define FOUNDATION_ROTATIONX_LOOKAT_2_OFFSET UNITYSDK_OFFSET(0x19DAE150)
#define FOUNDATION_ROTATIONX_LOOKAT_OFFSET UNITYSDK_OFFSET(0x19DAE040)
#define FOUNDATION_ROTATIONX_ROTATEAROUNDAXIS_X_1_OFFSET UNITYSDK_OFFSET(0x19DADD10)
#define FOUNDATION_ROTATIONX_ROTATEAROUNDAXIS_X_OFFSET UNITYSDK_OFFSET(0x19DADC50)
#define FOUNDATION_ROTATIONX_ROTATEAROUNDAXIS_Y_1_OFFSET UNITYSDK_OFFSET(0x19DADE60)
#define FOUNDATION_ROTATIONX_ROTATEAROUNDAXIS_Y_OFFSET UNITYSDK_OFFSET(0x19DADDA0)
#define FOUNDATION_ROTATIONX_ROTATEAROUNDAXIS_Z_1_OFFSET UNITYSDK_OFFSET(0x19DADFB0)
#define FOUNDATION_ROTATIONX_ROTATEAROUNDAXIS_Z_OFFSET UNITYSDK_OFFSET(0x19DADEF0)
#define FOUNDATION_ROTATIONX_ROTATE_DEGREESPERSECOND_1_OFFSET UNITYSDK_OFFSET(0x19DADAA0)
#define FOUNDATION_ROTATIONX_ROTATE_DEGREESPERSECOND_OFFSET UNITYSDK_OFFSET(0x19DADA00)
#define FOUNDATION_ROTATIONX_SLERPWITHREFERENCEUP_OFFSET UNITYSDK_OFFSET(0x19DAE200)

namespace Foundation
{
	inline static constexpr unsigned int RotationX_TypeDefinitionIndex = 8256;
