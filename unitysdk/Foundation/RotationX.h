...
#define FOUNDATION_ROTATIONX_GETCAMERAROTATIONTOTARGET_OFFSET UNITYSDK_OFFSET(0x1BFEA2E0)
#define FOUNDATION_ROTATIONX_LOOKAT_1_OFFSET UNITYSDK_OFFSET(0x1BFE94C0)
#define FOUNDATION_ROTATIONX_LOOKAT_2_OFFSET UNITYSDK_OFFSET(0x1BFE9530)
#define FOUNDATION_ROTATIONX_LOOKAT_OFFSET UNITYSDK_OFFSET(0x1BFE9420)
#define FOUNDATION_ROTATIONX_ROTATEAROUNDAXIS_X_1_OFFSET UNITYSDK_OFFSET(0x1BFE90F0)
#define FOUNDATION_ROTATIONX_ROTATEAROUNDAXIS_X_OFFSET UNITYSDK_OFFSET(0x1BFE9030)
#define FOUNDATION_ROTATIONX_ROTATEAROUNDAXIS_Y_1_OFFSET UNITYSDK_OFFSET(0x1BFE9240)
#define FOUNDATION_ROTATIONX_ROTATEAROUNDAXIS_Y_OFFSET UNITYSDK_OFFSET(0x1BFE9180)
#define FOUNDATION_ROTATIONX_ROTATEAROUNDAXIS_Z_1_OFFSET UNITYSDK_OFFSET(0x1BFE9390)
#define FOUNDATION_ROTATIONX_ROTATEAROUNDAXIS_Z_OFFSET UNITYSDK_OFFSET(0x1BFE92D0)
#define FOUNDATION_ROTATIONX_ROTATE_DEGREESPERSECOND_1_OFFSET UNITYSDK_OFFSET(0x1BFE8E80)
#define FOUNDATION_ROTATIONX_ROTATE_DEGREESPERSECOND_OFFSET UNITYSDK_OFFSET(0x1BFE8DE0)
#define FOUNDATION_ROTATIONX_SLERPWITHREFERENCEUP_OFFSET UNITYSDK_OFFSET(0x1BFE95E0)

namespace Foundation
{
	inline static constexpr unsigned int RotationX_TypeDefinitionIndex = 8282;
