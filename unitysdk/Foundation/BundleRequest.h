...
#define FOUNDATION_BUNDLEREQUEST_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x1B718010)
#define FOUNDATION_BUNDLEREQUEST_GET_ASSETBUNDLE_OFFSET UNITYSDK_OFFSET(0x1B717890)
#define FOUNDATION_BUNDLEREQUEST_GET_BUNDLEFILEPATH_OFFSET UNITYSDK_OFFSET(0x1B717930)
#define FOUNDATION_BUNDLEREQUEST_GET_BUNDLEID_OFFSET UNITYSDK_OFFSET(0x1B717910)
#define FOUNDATION_BUNDLEREQUEST_LOAD_OFFSET UNITYSDK_OFFSET(0x1B717950)
#define FOUNDATION_BUNDLEREQUEST_RECYCLE_OFFSET UNITYSDK_OFFSET(0x1B717F80)
#define FOUNDATION_BUNDLEREQUEST_SET_ASSETBUNDLE_OFFSET UNITYSDK_OFFSET(0x1B717900)
#define FOUNDATION_BUNDLEREQUEST_SET_BUNDLEFILEPATH_OFFSET UNITYSDK_OFFSET(0x1B717940)
#define FOUNDATION_BUNDLEREQUEST_SET_BUNDLEID_OFFSET UNITYSDK_OFFSET(0x1B717920)
#define FOUNDATION_BUNDLEREQUEST_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1B717CC0)
#define FOUNDATION_BUNDLEREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B718170)
#define FOUNDATION_BUNDLEREQUEST___BASE_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x1B718190)
#define FOUNDATION_BUNDLEREQUEST___BASE_LOAD_OFFSET UNITYSDK_OFFSET(0x1B718230)
#define FOUNDATION_BUNDLEREQUEST___BASE_RECYCLE_OFFSET UNITYSDK_OFFSET(0x1B718240)
#define FOUNDATION_BUNDLEREQUEST___BASE_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1B718220)

namespace Foundation
{
	inline static constexpr unsigned int BundleRequest_TypeDefinitionIndex = 8021;
