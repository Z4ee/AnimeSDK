...
#define FOUNDATION_BUNDLEREQUEST_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x1EF7C670)
#define FOUNDATION_BUNDLEREQUEST_GET_ASSETBUNDLE_OFFSET UNITYSDK_OFFSET(0x1EF7BEF0)
#define FOUNDATION_BUNDLEREQUEST_GET_BUNDLEFILEPATH_OFFSET UNITYSDK_OFFSET(0x1EF7BF90)
#define FOUNDATION_BUNDLEREQUEST_GET_BUNDLEID_OFFSET UNITYSDK_OFFSET(0x1EF7BF70)
#define FOUNDATION_BUNDLEREQUEST_LOAD_OFFSET UNITYSDK_OFFSET(0x1EF7BFB0)
#define FOUNDATION_BUNDLEREQUEST_RECYCLE_OFFSET UNITYSDK_OFFSET(0x1EF7C5E0)
#define FOUNDATION_BUNDLEREQUEST_SET_ASSETBUNDLE_OFFSET UNITYSDK_OFFSET(0x1EF7BF60)
#define FOUNDATION_BUNDLEREQUEST_SET_BUNDLEFILEPATH_OFFSET UNITYSDK_OFFSET(0x1EF7BFA0)
#define FOUNDATION_BUNDLEREQUEST_SET_BUNDLEID_OFFSET UNITYSDK_OFFSET(0x1EF7BF80)
#define FOUNDATION_BUNDLEREQUEST_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1EF7C320)
#define FOUNDATION_BUNDLEREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF7C7D0)
#define FOUNDATION_BUNDLEREQUEST___BASE_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x1EF7C7F0)
#define FOUNDATION_BUNDLEREQUEST___BASE_LOAD_OFFSET UNITYSDK_OFFSET(0x1EF7C890)
#define FOUNDATION_BUNDLEREQUEST___BASE_RECYCLE_OFFSET UNITYSDK_OFFSET(0x1EF7C8A0)
#define FOUNDATION_BUNDLEREQUEST___BASE_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1EF7C880)

namespace Foundation
{
	inline static constexpr unsigned int BundleRequest_TypeDefinitionIndex = 7811;

	class BundleRequest : public ::Foundation::AssetRequest
	{
	public:
		::Foundation::AssetPath RefAssetUrl; // 0x70
		::System::String* _BundleFilePath_k__BackingField; // 0x80
