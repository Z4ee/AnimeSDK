...
#define FOUNDATION_COLORX_COLORTOHEX_OFFSET UNITYSDK_OFFSET(0x1F695300)
#define FOUNDATION_COLORX_HEXTOCOLOR_OFFSET UNITYSDK_OFFSET(0x1F695680)
#define FOUNDATION_COLORX_LERP_OFFSET UNITYSDK_OFFSET(0x1F6958F0)
#define FOUNDATION_COLORX_TOVECTOR3_OFFSET UNITYSDK_OFFSET(0x1F6959B0)

namespace Foundation
{
	inline static constexpr unsigned int ColorX_TypeDefinitionIndex = 8181;
