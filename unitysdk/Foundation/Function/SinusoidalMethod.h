...
#define FOUNDATION_FUNCTION_SINUSOIDALMETHOD_GET_OFFSET UNITYSDK_OFFSET(0x1E3B6E90)
#define FOUNDATION_FUNCTION_SINUSOIDALMETHOD_MAXVALUE_OFFSET UNITYSDK_OFFSET(0x1E3B6EC0)
#define FOUNDATION_FUNCTION_SINUSOIDALMETHOD_MINVALUE_OFFSET UNITYSDK_OFFSET(0x1E3B6EB0)
#define FOUNDATION_FUNCTION_SINUSOIDALMETHOD_RANGE_OFFSET UNITYSDK_OFFSET(0x1E3B6ED0)
#define FOUNDATION_FUNCTION_SINUSOIDALMETHOD_RESOLVEGREATER_OFFSET UNITYSDK_OFFSET(0x1E3B6E30)
#define FOUNDATION_FUNCTION_SINUSOIDALMETHOD_RESOLVE_OFFSET UNITYSDK_OFFSET(0x1E3B6E70)

namespace Foundation::Function
{
	inline static constexpr unsigned int SinusoidalMethod_TypeDefinitionIndex = 8788;
