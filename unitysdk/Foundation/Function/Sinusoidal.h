...
#define FOUNDATION_FUNCTION_SINUSOIDAL_EVALUATE_1_OFFSET UNITYSDK_OFFSET(0x924910)
#define FOUNDATION_FUNCTION_SINUSOIDAL_EVALUATE_OFFSET UNITYSDK_OFFSET(0x9248C0)
#define FOUNDATION_FUNCTION_SINUSOIDAL_GET_COSCOEFFICIENT_OFFSET UNITYSDK_OFFSET(0x312A10)
#define FOUNDATION_FUNCTION_SINUSOIDAL_GET_MAXVALUE_OFFSET UNITYSDK_OFFSET(0x73D0E0)
#define FOUNDATION_FUNCTION_SINUSOIDAL_GET_MINVALUE_OFFSET UNITYSDK_OFFSET(0x924830)
#define FOUNDATION_FUNCTION_SINUSOIDAL_GET_SINCOEFFICIENT_OFFSET UNITYSDK_OFFSET(0x3B0F30)
#define FOUNDATION_FUNCTION_SINUSOIDAL_NEW_OFFSET UNITYSDK_OFFSET(0x1AB71370)
#define FOUNDATION_FUNCTION_SINUSOIDAL_RANGE_OFFSET UNITYSDK_OFFSET(0x924960)
#define FOUNDATION_FUNCTION_SINUSOIDAL_RESOLVEGREATER_OFFSET UNITYSDK_OFFSET(0x924940)
#define FOUNDATION_FUNCTION_SINUSOIDAL__CTOR_OFFSET UNITYSDK_OFFSET(0x924840)
#define FOUNDATION_FUNCTION_SINUSOIDAL__RANGE_G__UPDATEVALUE_21_0_OFFSET UNITYSDK_OFFSET(0x1AB71D90)

namespace Foundation::Function
{
	inline static constexpr unsigned int Sinusoidal_TypeDefinitionIndex = 9016;
