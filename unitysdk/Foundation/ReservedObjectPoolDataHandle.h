...
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x7453B0)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x7452C0)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE_GETDATAINSTANCE_OFFSET UNITYSDK_OFFSET(0x745290)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x745430)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE_ISVALID_OFFSET UNITYSDK_OFFSET(0x745230)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1171FDE0)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1171FEA0)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE_PUSHSELF_OFFSET UNITYSDK_OFFSET(0x7452A0)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE_RELEASESELF_OFFSET UNITYSDK_OFFSET(0x7452B0)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x745210)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x745490)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x745500)

namespace Foundation
{
	inline static constexpr unsigned int ReservedObjectPoolDataHandle_TypeDefinitionIndex = 82603;
