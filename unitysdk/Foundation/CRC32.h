...
#define FOUNDATION_CRC32_CALCULATEHASH_OFFSET UNITYSDK_OFFSET(0x1BEDBE20)
#define FOUNDATION_CRC32_COMPUTE_1_OFFSET UNITYSDK_OFFSET(0x1BEDC1E0)
#define FOUNDATION_CRC32_COMPUTE_2_OFFSET UNITYSDK_OFFSET(0x1BEDC290)
#define FOUNDATION_CRC32_COMPUTE_OFFSET UNITYSDK_OFFSET(0x1BEDC190)
#define FOUNDATION_CRC32_GET_HASHSIZE_OFFSET UNITYSDK_OFFSET(0x1BEDBD50)
#define FOUNDATION_CRC32_HASHCORE_OFFSET UNITYSDK_OFFSET(0x1BEDBDB0)
#define FOUNDATION_CRC32_HASHFINAL_OFFSET UNITYSDK_OFFSET(0x1BEDC030)
#define FOUNDATION_CRC32_INITIALIZETABLE_OFFSET UNITYSDK_OFFSET(0x1BEDBAA0)
#define FOUNDATION_CRC32_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1BEDBD60)
#define FOUNDATION_CRC32_UINT32TOBIGENDIANBYTES_OFFSET UNITYSDK_OFFSET(0x1BEDC100)
#define FOUNDATION_CRC32__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BEDBA10)
#define FOUNDATION_CRC32__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEDB990)

namespace Foundation
{
	inline static constexpr unsigned int CRC32_TypeDefinitionIndex = 8231;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(CRC32_TypeDefinitionIndex)->GetStaticField(0x6D50);
		}
		...
		::System::UInt32 _seed; // 0x30
		::System::UInt32 _hash; // 0x34
