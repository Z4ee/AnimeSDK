...
#define FOUNDATION_CRC32_CALCULATEHASH_OFFSET UNITYSDK_OFFSET(0x1DF0EA60)
#define FOUNDATION_CRC32_COMPUTE_1_OFFSET UNITYSDK_OFFSET(0x1DF0EE20)
#define FOUNDATION_CRC32_COMPUTE_2_OFFSET UNITYSDK_OFFSET(0x1DF0EED0)
#define FOUNDATION_CRC32_COMPUTE_OFFSET UNITYSDK_OFFSET(0x1DF0EDD0)
#define FOUNDATION_CRC32_GET_HASHSIZE_OFFSET UNITYSDK_OFFSET(0x1DF0E990)
#define FOUNDATION_CRC32_HASHCORE_OFFSET UNITYSDK_OFFSET(0x1DF0E9F0)
#define FOUNDATION_CRC32_HASHFINAL_OFFSET UNITYSDK_OFFSET(0x1DF0EC70)
#define FOUNDATION_CRC32_INITIALIZETABLE_OFFSET UNITYSDK_OFFSET(0x1DF0E6E0)
#define FOUNDATION_CRC32_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1DF0E9A0)
#define FOUNDATION_CRC32_UINT32TOBIGENDIANBYTES_OFFSET UNITYSDK_OFFSET(0x1DF0ED40)
#define FOUNDATION_CRC32__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DF0E650)
#define FOUNDATION_CRC32__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF0E5D0)

namespace Foundation
{
	inline static constexpr unsigned int CRC32_TypeDefinitionIndex = 8380;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(CRC32_TypeDefinitionIndex)->GetStaticField(0x6F00);
		}
