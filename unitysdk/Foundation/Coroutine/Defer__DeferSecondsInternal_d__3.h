...
#define FOUNDATION_COROUTINE_DEFER__DEFERSECONDSINTERNAL_D__3_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1DA338A0)
#define FOUNDATION_COROUTINE_DEFER__DEFERSECONDSINTERNAL_D__3_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DA33950)
#define FOUNDATION_COROUTINE_DEFER__DEFERSECONDSINTERNAL_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DA339B0)
#define FOUNDATION_COROUTINE_DEFER__DEFERSECONDSINTERNAL_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1DA33960)
#define FOUNDATION_COROUTINE_DEFER__DEFERSECONDSINTERNAL_D__3_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DA33890)
#define FOUNDATION_COROUTINE_DEFER__DEFERSECONDSINTERNAL_D__3__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA33880)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int Defer__DeferSecondsInternal_d__3_TypeDefinitionIndex = 8112;
