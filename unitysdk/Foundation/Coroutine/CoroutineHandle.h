...
#define FOUNDATION_COROUTINE_COROUTINEHANDLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9A71C0)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x9A7170)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9A71D0)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x9A72B0)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE_GET_KEY_OFFSET UNITYSDK_OFFSET(0x9A7100)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE_KILLCOROUTINE_OFFSET UNITYSDK_OFFSET(0x9A7220)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1BAE44A0)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1BAE44F0)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE_TOCOUTINEID_OFFSET UNITYSDK_OFFSET(0x9A7120)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BAE4580)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x2E85F0)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x9A7110)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x9A72C0)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9A7320)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int CoroutineHandle_TypeDefinitionIndex = 7766;

	struct alignas(4) CoroutineHandle
	{
		static ::Il2CppArray<::System::Int32>** StaticGet_NextIndex()
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(CoroutineHandle_TypeDefinitionIndex)->GetStaticField(0x6880);
		}
		static ::Foundation::Coroutine::CoroutineHandle* StaticGet_Empty()
		{
			return (::Foundation::Coroutine::CoroutineHandle*)Il2CppClass::FromTypeDefinitionIndex(CoroutineHandle_TypeDefinitionIndex)->GetStaticField(0x35C0);
		}
