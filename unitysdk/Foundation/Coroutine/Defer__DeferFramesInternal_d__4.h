...
#define FOUNDATION_COROUTINE_DEFER__DEFERFRAMESINTERNAL_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1ED8CDA0)
#define FOUNDATION_COROUTINE_DEFER__DEFERFRAMESINTERNAL_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1ED8CE50)
#define FOUNDATION_COROUTINE_DEFER__DEFERFRAMESINTERNAL_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1ED8CEB0)
#define FOUNDATION_COROUTINE_DEFER__DEFERFRAMESINTERNAL_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1ED8CE60)
#define FOUNDATION_COROUTINE_DEFER__DEFERFRAMESINTERNAL_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1ED8CD90)
#define FOUNDATION_COROUTINE_DEFER__DEFERFRAMESINTERNAL_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x1ED8CD80)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int Defer__DeferFramesInternal_d__4_TypeDefinitionIndex = 7909;
