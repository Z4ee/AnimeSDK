...
#define FOUNDATION_COROUTINE_DEFER__DEFERFRAMESINTERNAL_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D8829A0)
#define FOUNDATION_COROUTINE_DEFER__DEFERFRAMESINTERNAL_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D882A50)
#define FOUNDATION_COROUTINE_DEFER__DEFERFRAMESINTERNAL_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D882AB0)
#define FOUNDATION_COROUTINE_DEFER__DEFERFRAMESINTERNAL_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1D882A60)
#define FOUNDATION_COROUTINE_DEFER__DEFERFRAMESINTERNAL_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D882990)
#define FOUNDATION_COROUTINE_DEFER__DEFERFRAMESINTERNAL_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x1D882980)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int Defer__DeferFramesInternal_d__4_TypeDefinitionIndex = 8111;
