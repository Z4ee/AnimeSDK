...
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___DELAYEDCALL_D__138_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1F661540)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___DELAYEDCALL_D__138_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1F661720)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___DELAYEDCALL_D__138_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1F661780)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___DELAYEDCALL_D__138_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1F661730)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___DELAYEDCALL_D__138_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1F661530)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___DELAYEDCALL_D__138__CTOR_OFFSET UNITYSDK_OFFSET(0x1F661520)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int CoroutineManager___DelayedCall_d__138_TypeDefinitionIndex = 8056;

	class CoroutineManager___DelayedCall_d__138 : public ::System::Object
	{
	public:
		::System::Action* action; // 0x10
		::UnityEngine::GameObject* cancelWith; // 0x18
