...
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___CALLCONTINUOUSLYUNTIL_D__159_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D591520)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___CALLCONTINUOUSLYUNTIL_D__159_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D591620)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___CALLCONTINUOUSLYUNTIL_D__159_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D591680)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___CALLCONTINUOUSLYUNTIL_D__159_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1D591630)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___CALLCONTINUOUSLYUNTIL_D__159_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D591510)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___CALLCONTINUOUSLYUNTIL_D__159__CTOR_OFFSET UNITYSDK_OFFSET(0x1D591500)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int CoroutineManager___CallContinuouslyUntil_d__159_TypeDefinitionIndex = 8053;
