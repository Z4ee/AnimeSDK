...
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_ADDTAG_OFFSET UNITYSDK_OFFSET(0x1A105B10)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_ADD_ONPREEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A0FE280)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A0FE740)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLCONTINUOUSLYONINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x1A110FE0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLCONTINUOUSLYONINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A110A80)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLCONTINUOUSLY_1_OFFSET UNITYSDK_OFFSET(0x1A110C10)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLCONTINUOUSLY_OFFSET UNITYSDK_OFFSET(0x1A110900)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLDELAYEDONINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x1A10EFC0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLDELAYEDONINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A10E040)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLDELAYED_1_OFFSET UNITYSDK_OFFSET(0x1A10E3F0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLDELAYED_2_OFFSET UNITYSDK_OFFSET(0x1A10E780)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLDELAYED_3_OFFSET UNITYSDK_OFFSET(0x1A10EC20)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLDELAYED_OFFSET UNITYSDK_OFFSET(0x1A10DC10)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLPERIODICALLYONINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x1A1104D0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLPERIODICALLYONINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A10FCB0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLPERIODICALLYUNTIL_OFFSET UNITYSDK_OFFSET(0x1A111650)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLPERIODICALLY_1_OFFSET UNITYSDK_OFFSET(0x1A1100C0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLPERIODICALLY_OFFSET UNITYSDK_OFFSET(0x1A10F800)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CLOSEWAITINGPROCESS_OFFSET UNITYSDK_OFFSET(0x1A1021D0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_COINDEXEXTRACT_OFFSET UNITYSDK_OFFSET(0x1A106CF0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_COINDEXISNULL_OFFSET UNITYSDK_OFFSET(0x1A1020A0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_COINDEXPEEK_OFFSET UNITYSDK_OFFSET(0x1A10B010)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_COINDEXREPLACE_OFFSET UNITYSDK_OFFSET(0x1A10B5C0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CREATENEWHANDLE_OFFSET UNITYSDK_OFFSET(0x1A10BCE0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_DESTROYIMMEDIATE_1_OFFSET UNITYSDK_OFFSET(0x1A1122D0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_DESTROYIMMEDIATE_OFFSET UNITYSDK_OFFSET(0x1A112290)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_DESTROYOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1A112230)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_DESTROYOBJECT_OFFSET UNITYSDK_OFFSET(0x1A1121F0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_DESTROY_1_OFFSET UNITYSDK_OFFSET(0x1A112030)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_DESTROY_OFFSET UNITYSDK_OFFSET(0x1A111FF0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_FINDOBJECTOFTYPE_OFFSET UNITYSDK_OFFSET(0x1A112480)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_FINDOBJECTSOFTYPE_OFFSET UNITYSDK_OFFSET(0x1A1124C0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1A101140)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A1068C0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_GETSEGMENTTIME_OFFSET UNITYSDK_OFFSET(0x1A10A2C0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_GET_DELTATIME_OFFSET UNITYSDK_OFFSET(0x1A0FE210)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1A0FDC50)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_GET_LOCALTIME_OFFSET UNITYSDK_OFFSET(0x1A0FDBE0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_GET_MAINTHREAD_OFFSET UNITYSDK_OFFSET(0x1A0FE440)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_HANDLEISINWAITINGLIST_OFFSET UNITYSDK_OFFSET(0x1A10CE80)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_KILLCOROUTINESONINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x1A1069F0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_KILLCOROUTINESONINSTANCE_2_OFFSET UNITYSDK_OFFSET(0x1A107000)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_KILLCOROUTINESONINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A106020)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_KILLCOROUTINES_1_OFFSET UNITYSDK_OFFSET(0x1A1065E0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_KILLCOROUTINES_2_OFFSET UNITYSDK_OFFSET(0x1A106E20)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_KILLCOROUTINES_OFFSET UNITYSDK_OFFSET(0x1A105D10)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A1018F0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_LOCKCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1A10D5F0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_NULLIFY_1_OFFSET UNITYSDK_OFFSET(0x1A107400)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_NULLIFY_OFFSET UNITYSDK_OFFSET(0x1A10AA40)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A0FEDB0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PAUSECOROUTINESONINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x1A107B10)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PAUSECOROUTINESONINSTANCE_2_OFFSET UNITYSDK_OFFSET(0x1A108D90)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PAUSECOROUTINESONINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A107710)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PAUSECOROUTINES_1_OFFSET UNITYSDK_OFFSET(0x1A1079C0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PAUSECOROUTINES_2_OFFSET UNITYSDK_OFFSET(0x1A108BB0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PAUSECOROUTINES_OFFSET UNITYSDK_OFFSET(0x1A107540)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PRINT_OFFSET UNITYSDK_OFFSET(0x1A112500)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_REMOVETAG_OFFSET UNITYSDK_OFFSET(0x1A1023C0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_REMOVEUNUSED_OFFSET UNITYSDK_OFFSET(0x1A0FFF10)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_REMOVE_ONPREEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A0FE360)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RESETTIMECOUNTONINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A106580)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RESUMECOROUTINESONINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x1A1098A0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RESUMECOROUTINESONINSTANCE_2_OFFSET UNITYSDK_OFFSET(0x1A109CD0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RESUMECOROUTINESONINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A109110)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RESUMECOROUTINES_1_OFFSET UNITYSDK_OFFSET(0x1A109750)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RESUMECOROUTINES_2_OFFSET UNITYSDK_OFFSET(0x1A109AF0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RESUMECOROUTINES_OFFSET UNITYSDK_OFFSET(0x1A108F40)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A102880)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINEONINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x1A105090)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINEONINSTANCE_2_OFFSET UNITYSDK_OFFSET(0x1A105310)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINEONINSTANCE_3_OFFSET UNITYSDK_OFFSET(0x1A1055B0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINEONINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A105000)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINE_1_OFFSET UNITYSDK_OFFSET(0x1A1043E0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINE_2_OFFSET UNITYSDK_OFFSET(0x1A104700)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINE_3_OFFSET UNITYSDK_OFFSET(0x1A1049E0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINE_4_OFFSET UNITYSDK_OFFSET(0x1A104CE0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1A1025B0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_SETPAUSE_OFFSET UNITYSDK_OFFSET(0x1A107BD0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1A0FE6E0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_SET_MAINTHREAD_OFFSET UNITYSDK_OFFSET(0x1A0FE4A0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_STARTCOROUTINE_1_OFFSET UNITYSDK_OFFSET(0x1A111D70)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_STARTCOROUTINE_AUTO_OFFSET UNITYSDK_OFFSET(0x1A111DC0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_STARTCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1A111D20)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_STOPALLCOROUTINES_OFFSET UNITYSDK_OFFSET(0x1A111FB0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_STOPCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1A111E10)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_UNLOCKCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1A10DA20)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_UPDATETIMEVALUES_OFFSET UNITYSDK_OFFSET(0x1A0FFD90)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A0FEF10)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_WAITFORSECONDSONINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A10BF50)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_WAITFORSECONDS_OFFSET UNITYSDK_OFFSET(0x1A10BA00)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_WAITUNTILDONEWRAPPER_OFFSET UNITYSDK_OFFSET(0x1A10C840)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_WAITUNTILDONE_1_OFFSET UNITYSDK_OFFSET(0x1A10C1D0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_WAITUNTILDONE_2_OFFSET UNITYSDK_OFFSET(0x1A10CFA0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_WAITUNTILDONE_3_OFFSET UNITYSDK_OFFSET(0x1A10D2A0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_WAITUNTILDONE_4_OFFSET UNITYSDK_OFFSET(0x1A10D440)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_WAITUNTILDONE_OFFSET UNITYSDK_OFFSET(0x1A10BFC0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__CALLCONTINUOUSLYUNTIL_OFFSET UNITYSDK_OFFSET(0x1A111A00)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__CALLCONTINUOUSLY_OFFSET UNITYSDK_OFFSET(0x1A10FBE0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A112920)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A112540)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__DELAYEDCALL_1_OFFSET UNITYSDK_OFFSET(0x1A10EB80)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__DELAYEDCALL_OFFSET UNITYSDK_OFFSET(0x1A10DF90)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__INJECTDELAY_OFFSET UNITYSDK_OFFSET(0x1A10B310)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__STARTWHENDONE_1_OFFSET UNITYSDK_OFFSET(0x1A10D210)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__STARTWHENDONE_2_OFFSET UNITYSDK_OFFSET(0x1A10D3B0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__STARTWHENDONE_3_OFFSET UNITYSDK_OFFSET(0x1A10D560)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__STARTWHENDONE_OFFSET UNITYSDK_OFFSET(0x1A10C7B0)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int CoroutineManager_TypeDefinitionIndex = 8004;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Byte, ::Foundation::Coroutine::CoroutineManager*>**)Il2CppClass::FromTypeDefinitionIndex(CoroutineManager_TypeDefinitionIndex)->GetStaticField(0x6870);
		}
		static ::System::Action** StaticGet_OnPreExecute()
		{
			return (::System::Action**)Il2CppClass::FromTypeDefinitionIndex(CoroutineManager_TypeDefinitionIndex)->GetStaticField(0x6878);
		}
		static ::Foundation::Coroutine::CoroutineManager** StaticGet__instance()
		{
			return (::Foundation::Coroutine::CoroutineManager**)Il2CppClass::FromTypeDefinitionIndex(CoroutineManager_TypeDefinitionIndex)->GetStaticField(0x6880);
		}
		...
		{
			return (::System::Func_3<::System::Collections::Generic::IEnumerator_1<::System::Single>*, ::Foundation::Coroutine::CoroutineHandle, ::System::Collections::Generic::IEnumerator_1<::System::Single>*>**)Il2CppClass::FromTypeDefinitionIndex(CoroutineManager_TypeDefinitionIndex)->GetStaticField(0x6888);
		}
		static ::System::Action** StaticGet_OnPostExecute()
		{
			return (::System::Action**)Il2CppClass::FromTypeDefinitionIndex(CoroutineManager_TypeDefinitionIndex)->GetStaticField(0x6890);
		}
		static ::System::Threading::Thread** StaticGet__MainThread_k__BackingField()
		{
			return (::System::Threading::Thread**)Il2CppClass::FromTypeDefinitionIndex(CoroutineManager_TypeDefinitionIndex)->GetStaticField(0x6898);
		}
		static ::Foundation::Coroutine::CoroutineHandle* StaticGet__tmpHandle()
		{
			return (::Foundation::Coroutine::CoroutineHandle*)Il2CppClass::FromTypeDefinitionIndex(CoroutineManager_TypeDefinitionIndex)->GetStaticField(0x35F0);
		}
		static ::System::Single* StaticGet_WaitForOneFrame()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(CoroutineManager_TypeDefinitionIndex)->GetStaticField(0x35F4);
		}
		static ::System::Boolean* StaticGet__tmpBool()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(CoroutineManager_TypeDefinitionIndex)->GetStaticField(0x35F8);
		}
