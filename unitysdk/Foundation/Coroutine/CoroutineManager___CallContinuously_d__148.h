...
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___CALLCONTINUOUSLY_D__148_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BFDDED0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___CALLCONTINUOUSLY_D__148_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BFDDFE0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___CALLCONTINUOUSLY_D__148_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BFDE040)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___CALLCONTINUOUSLY_D__148_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BFDDFF0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___CALLCONTINUOUSLY_D__148_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BFDDEC0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___CALLCONTINUOUSLY_D__148__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFDDEB0)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int CoroutineManager___CallContinuously_d__148_TypeDefinitionIndex = 8010;
	...
	public:
		...
		::System::Double _startTime_5__2; // 0x28
		::System::Single timeframe; // 0x30
