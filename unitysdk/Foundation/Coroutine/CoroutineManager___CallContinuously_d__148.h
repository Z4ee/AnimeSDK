...
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___CALLCONTINUOUSLY_D__148_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D591340)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___CALLCONTINUOUSLY_D__148_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D591450)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___CALLCONTINUOUSLY_D__148_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D5914B0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___CALLCONTINUOUSLY_D__148_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1D591460)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___CALLCONTINUOUSLY_D__148_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D591330)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___CALLCONTINUOUSLY_D__148__CTOR_OFFSET UNITYSDK_OFFSET(0x1D591320)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int CoroutineManager___CallContinuously_d__148_TypeDefinitionIndex = 8044;
	...
	public:
		...
		::System::Single period; // 0x28
		::System::Single timeframe; // 0x2C
