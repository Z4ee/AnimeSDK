...
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__129_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1DDA9B20)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__129_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DDA9C80)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__129_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DDA9CE0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__129_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1DDA9C90)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__129_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DDA9B10)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__129__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDA9B00)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int CoroutineManager___StartWhenDone_d__129_TypeDefinitionIndex = 8015;
	...
	public:
		...
		::Foundation::Coroutine::CoroutineManager___c__DisplayClass129_0* __8__1; // 0x18
