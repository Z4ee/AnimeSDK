...
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__129_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BAE5030)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__129_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BAE5190)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__129_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BAE51F0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__129_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BAE51A0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__129_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BAE5020)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__129__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAE5010)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int CoroutineManager___StartWhenDone_d__129_TypeDefinitionIndex = 7853;
	...
	public:
		...
		::UnityEngine::CustomYieldInstruction* operation; // 0x18
		::Foundation::Coroutine::CoroutineManager___c__DisplayClass129_0* __8__1; // 0x20
