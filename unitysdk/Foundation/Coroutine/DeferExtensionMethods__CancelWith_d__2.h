...
#define FOUNDATION_COROUTINE_DEFEREXTENSIONMETHODS__CANCELWITH_D__2_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1F017A20)
#define FOUNDATION_COROUTINE_DEFEREXTENSIONMETHODS__CANCELWITH_D__2_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1F017EF0)
#define FOUNDATION_COROUTINE_DEFEREXTENSIONMETHODS__CANCELWITH_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1F017F50)
#define FOUNDATION_COROUTINE_DEFEREXTENSIONMETHODS__CANCELWITH_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1F017F00)
#define FOUNDATION_COROUTINE_DEFEREXTENSIONMETHODS__CANCELWITH_D__2_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1F017A10)
#define FOUNDATION_COROUTINE_DEFEREXTENSIONMETHODS__CANCELWITH_D__2__CTOR_OFFSET UNITYSDK_OFFSET(0x1F017A00)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int DeferExtensionMethods__CancelWith_d__2_TypeDefinitionIndex = 8123;

	class DeferExtensionMethods__CancelWith_d__2 : public ::System::Object
	{
	public:
		::UnityEngine::GameObject* gameObject1; // 0x10
		::UnityEngine::GameObject* gameObject2; // 0x18
		::UnityEngine::GameObject* gameObject3; // 0x20
		::System::Collections::Generic::IEnumerator_1<::System::Single>* coroutine; // 0x28
