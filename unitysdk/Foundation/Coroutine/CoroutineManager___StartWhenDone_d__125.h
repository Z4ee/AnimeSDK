...
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__125_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1F0A3960)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__125_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1F0A3AC0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__125_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1F0A3B20)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__125_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1F0A3AD0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__125_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1F0A3950)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__125__CTOR_OFFSET UNITYSDK_OFFSET(0x1F0A3940)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int CoroutineManager___StartWhenDone_d__125_TypeDefinitionIndex = 8052;
	...
	public:
		...
		::Foundation::Coroutine::CoroutineManager___c__DisplayClass125_0* __8__1; // 0x18
