...
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__127_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BAE4E20)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__127_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BAE4F60)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__127_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BAE4FC0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__127_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BAE4F70)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__127_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BAE4E10)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__127__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAE4E00)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int CoroutineManager___StartWhenDone_d__127_TypeDefinitionIndex = 7850;
	...
	public:
		...
		::Foundation::Coroutine::CoroutineManager___c__DisplayClass127_0* __8__1; // 0x18
		::UnityEngine::AsyncOperation* operation; // 0x20
