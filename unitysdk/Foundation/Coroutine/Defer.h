...
#define FOUNDATION_COROUTINE_DEFER_DEFERFRAMESINTERNAL_OFFSET UNITYSDK_OFFSET(0x1E1A5060)
#define FOUNDATION_COROUTINE_DEFER_DEFERSECONDSINTERNAL_OFFSET UNITYSDK_OFFSET(0x1E1A5210)
#define FOUNDATION_COROUTINE_DEFER_FRAMES_OFFSET UNITYSDK_OFFSET(0x1E1A4F40)
#define FOUNDATION_COROUTINE_DEFER_RUNCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1E1A52A0)
#define FOUNDATION_COROUTINE_DEFER_SECONDS_OFFSET UNITYSDK_OFFSET(0x1E1A50E0)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int Defer_TypeDefinitionIndex = 8110;
