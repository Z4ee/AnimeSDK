...
#define FOUNDATION_COROUTINE_DEFER_DEFERFRAMESINTERNAL_OFFSET UNITYSDK_OFFSET(0x1BE56790)
#define FOUNDATION_COROUTINE_DEFER_DEFERSECONDSINTERNAL_OFFSET UNITYSDK_OFFSET(0x1BE56940)
#define FOUNDATION_COROUTINE_DEFER_FRAMES_OFFSET UNITYSDK_OFFSET(0x1BE56670)
#define FOUNDATION_COROUTINE_DEFER_RUNCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1BE569D0)
#define FOUNDATION_COROUTINE_DEFER_SECONDS_OFFSET UNITYSDK_OFFSET(0x1BE56810)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int Defer_TypeDefinitionIndex = 8000;
