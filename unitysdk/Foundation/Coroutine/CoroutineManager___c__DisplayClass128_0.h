...
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___C__DISPLAYCLASS128_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1A7700)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___C__DISPLAYCLASS128_0__WAITUNTILDONE_B__0_OFFSET UNITYSDK_OFFSET(0x1C1A7710)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int CoroutineManager___c__DisplayClass128_0_TypeDefinitionIndex = 7858;
