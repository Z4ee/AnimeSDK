...
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PROCESSINDEX_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9B6460)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PROCESSINDEX_EQUALS_OFFSET UNITYSDK_OFFSET(0x9B6400)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PROCESSINDEX_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9B6470)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PROCESSINDEX_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1CC8DA80)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PROCESSINDEX_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1CC8DAD0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PROCESSINDEX___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x9B64D0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PROCESSINDEX___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9B6530)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int CoroutineManager_ProcessIndex_TypeDefinitionIndex = 8006;
