...
#define FOUNDATION_COROUTINE_DEFEREXTENSIONMETHODS_CANCELWITH_1_OFFSET UNITYSDK_OFFSET(0x1F0178D0)
#define FOUNDATION_COROUTINE_DEFEREXTENSIONMETHODS_CANCELWITH_2_OFFSET UNITYSDK_OFFSET(0x1F017960)
#define FOUNDATION_COROUTINE_DEFEREXTENSIONMETHODS_CANCELWITH_OFFSET UNITYSDK_OFFSET(0x1F017840)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int DeferExtensionMethods_TypeDefinitionIndex = 8122;
