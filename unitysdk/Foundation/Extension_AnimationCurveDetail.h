...
#define FOUNDATION_EXTENSION_ANIMATIONCURVEDETAIL_CREATEINTERVAL_OFFSET UNITYSDK_OFFSET(0x1BFF97F0)

namespace Foundation
{
	inline static constexpr unsigned int Extension_AnimationCurveDetail_TypeDefinitionIndex = 9111;
