...
#define FOUNDATION_GAMEOBJECTX_ACTIVATEANDPARENT_OFFSET UNITYSDK_OFFSET(0x1B71A8F0)
#define FOUNDATION_GAMEOBJECTX_ADDCOMPONENTSAFELY_OFFSET UNITYSDK_OFFSET(0x1B71C350)
#define FOUNDATION_GAMEOBJECTX_CLONE_OFFSET UNITYSDK_OFFSET(0x1B71BD10)
#define FOUNDATION_GAMEOBJECTX_GETCHILDBYABSPATH_OFFSET UNITYSDK_OFFSET(0x1B719EF0)
#define FOUNDATION_GAMEOBJECTX_GETCHILDBYRELATEDPATHLIST_OFFSET UNITYSDK_OFFSET(0x1B7199B0)
#define FOUNDATION_GAMEOBJECTX_GETCHILDBYRELATEDPATH_OFFSET UNITYSDK_OFFSET(0x1B719320)
#define FOUNDATION_GAMEOBJECTX_GETCOLLISIONMASK_OFFSET UNITYSDK_OFFSET(0x1B71B770)
#define FOUNDATION_GAMEOBJECTX_GETRELATEDREALPATHANDINDEX_OFFSET UNITYSDK_OFFSET(0x1B719820)
#define FOUNDATION_GAMEOBJECTX_HASCHARACTERCONTROLLER_OFFSET UNITYSDK_OFFSET(0x1B71AD70)
#define FOUNDATION_GAMEOBJECTX_HASRIGIDBODY_OFFSET UNITYSDK_OFFSET(0x1B71ABA0)
#define FOUNDATION_GAMEOBJECTX_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1B71A780)
#define FOUNDATION_GAMEOBJECTX_ISNULLORINACTIVE_OFFSET UNITYSDK_OFFSET(0x1B71A610)
#define FOUNDATION_GAMEOBJECTX_NEWGAMEOBJECTASCHILD_OFFSET UNITYSDK_OFFSET(0x1B71B840)
#define FOUNDATION_GAMEOBJECTX_REMOVEALLCHILDOBJECT_OFFSET UNITYSDK_OFFSET(0x1B71C0D0)
#define FOUNDATION_GAMEOBJECTX_RESETTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B71BB00)
#define FOUNDATION_GAMEOBJECTX_SETACTIVERECURSIVELYEXT_OFFSET UNITYSDK_OFFSET(0x1B71BFC0)
#define FOUNDATION_GAMEOBJECTX_SETACTIVESAFELY_OFFSET UNITYSDK_OFFSET(0x1B71BE40)
#define FOUNDATION_GAMEOBJECTX_SETCOLLISIONRECURSIVELY_OFFSET UNITYSDK_OFFSET(0x1B71B2B0)
#define FOUNDATION_GAMEOBJECTX_SETLAYERRECURSIVELY_OFFSET UNITYSDK_OFFSET(0x1B71AF40)
#define FOUNDATION_GAMEOBJECTX_TOSTRINGPARENTHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1B718660)
#define FOUNDATION_GAMEOBJECTX_TOSTRINGRELATEDPATH_OFFSET UNITYSDK_OFFSET(0x1B718A10)

namespace Foundation
{
	inline static constexpr unsigned int GameObjectX_TypeDefinitionIndex = 8244;
