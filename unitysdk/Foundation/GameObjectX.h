...
#define FOUNDATION_GAMEOBJECTX_ACTIVATEANDPARENT_OFFSET UNITYSDK_OFFSET(0x1DA35D10)
#define FOUNDATION_GAMEOBJECTX_ADDCOMPONENTSAFELY_OFFSET UNITYSDK_OFFSET(0x1DA37770)
#define FOUNDATION_GAMEOBJECTX_CLONE_OFFSET UNITYSDK_OFFSET(0x1DA37130)
#define FOUNDATION_GAMEOBJECTX_GETCHILDBYABSPATH_OFFSET UNITYSDK_OFFSET(0x1DA35310)
#define FOUNDATION_GAMEOBJECTX_GETCHILDBYRELATEDPATHLIST_OFFSET UNITYSDK_OFFSET(0x1DA34DD0)
#define FOUNDATION_GAMEOBJECTX_GETCHILDBYRELATEDPATH_OFFSET UNITYSDK_OFFSET(0x1DA34740)
#define FOUNDATION_GAMEOBJECTX_GETCOLLISIONMASK_OFFSET UNITYSDK_OFFSET(0x1DA36B90)
#define FOUNDATION_GAMEOBJECTX_GETRELATEDREALPATHANDINDEX_OFFSET UNITYSDK_OFFSET(0x1DA34C40)
#define FOUNDATION_GAMEOBJECTX_HASCHARACTERCONTROLLER_OFFSET UNITYSDK_OFFSET(0x1DA36190)
#define FOUNDATION_GAMEOBJECTX_HASRIGIDBODY_OFFSET UNITYSDK_OFFSET(0x1DA35FC0)
#define FOUNDATION_GAMEOBJECTX_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1DA35BA0)
#define FOUNDATION_GAMEOBJECTX_ISNULLORINACTIVE_OFFSET UNITYSDK_OFFSET(0x1DA35A30)
#define FOUNDATION_GAMEOBJECTX_NEWGAMEOBJECTASCHILD_OFFSET UNITYSDK_OFFSET(0x1DA36C60)
#define FOUNDATION_GAMEOBJECTX_REMOVEALLCHILDOBJECT_OFFSET UNITYSDK_OFFSET(0x1DA374F0)
#define FOUNDATION_GAMEOBJECTX_RESETTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1DA36F20)
#define FOUNDATION_GAMEOBJECTX_SETACTIVERECURSIVELYEXT_OFFSET UNITYSDK_OFFSET(0x1DA373E0)
#define FOUNDATION_GAMEOBJECTX_SETACTIVESAFELY_OFFSET UNITYSDK_OFFSET(0x1DA37260)
#define FOUNDATION_GAMEOBJECTX_SETCOLLISIONRECURSIVELY_OFFSET UNITYSDK_OFFSET(0x1DA366D0)
#define FOUNDATION_GAMEOBJECTX_SETLAYERRECURSIVELY_OFFSET UNITYSDK_OFFSET(0x1DA36360)
#define FOUNDATION_GAMEOBJECTX_TOSTRINGPARENTHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1DA33A80)
#define FOUNDATION_GAMEOBJECTX_TOSTRINGRELATEDPATH_OFFSET UNITYSDK_OFFSET(0x1DA33E30)

namespace Foundation
{
	inline static constexpr unsigned int GameObjectX_TypeDefinitionIndex = 7843;
