...
#define FOUNDATION_ASSETTRACKER_CHECKALIVE_OFFSET UNITYSDK_OFFSET(0x1EF37B30)
#define FOUNDATION_ASSETTRACKER_COMPOSEASSETTACKER_OFFSET UNITYSDK_OFFSET(0x1EF37AD0)
#define FOUNDATION_ASSETTRACKER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EF37EA0)
#define FOUNDATION_ASSETTRACKER_GET_TIMEOUT_OFFSET UNITYSDK_OFFSET(0x1EF37AB0)
#define FOUNDATION_ASSETTRACKER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1EF37E50)
#define FOUNDATION_ASSETTRACKER_SET_TIMEOUT_OFFSET UNITYSDK_OFFSET(0x1EF37AC0)
#define FOUNDATION_ASSETTRACKER_TAKEOUT_OFFSET UNITYSDK_OFFSET(0x1EF37C70)
#define FOUNDATION_ASSETTRACKER_TRACK_OFFSET UNITYSDK_OFFSET(0x1EF37D90)
#define FOUNDATION_ASSETTRACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF37F80)

namespace Foundation
{
	inline static constexpr unsigned int AssetTracker_TypeDefinitionIndex = 7856;

	class AssetTracker : public ::System::Object
	{
	public:
		::UnityEngine::Object* strongRef; // 0x10
		::System::WeakReference* weakRef; // 0x18
