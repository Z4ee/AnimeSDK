...
#define FOUNDATION_ASSETTRACKER_CHECKALIVE_OFFSET UNITYSDK_OFFSET(0x1DCB1A00)
#define FOUNDATION_ASSETTRACKER_COMPOSEASSETTACKER_OFFSET UNITYSDK_OFFSET(0x1DCB19A0)
#define FOUNDATION_ASSETTRACKER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DCB1D70)
#define FOUNDATION_ASSETTRACKER_GET_TIMEOUT_OFFSET UNITYSDK_OFFSET(0x1DCB1980)
#define FOUNDATION_ASSETTRACKER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1DCB1D20)
#define FOUNDATION_ASSETTRACKER_SET_TIMEOUT_OFFSET UNITYSDK_OFFSET(0x1DCB1990)
#define FOUNDATION_ASSETTRACKER_TAKEOUT_OFFSET UNITYSDK_OFFSET(0x1DCB1B40)
#define FOUNDATION_ASSETTRACKER_TRACK_OFFSET UNITYSDK_OFFSET(0x1DCB1C60)
#define FOUNDATION_ASSETTRACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCB1E50)

namespace Foundation
{
	inline static constexpr unsigned int AssetTracker_TypeDefinitionIndex = 8299;
