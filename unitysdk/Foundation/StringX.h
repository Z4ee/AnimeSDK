...
#define FOUNDATION_STRINGX_ADDWWWFILEPREFIX_OFFSET UNITYSDK_OFFSET(0x1F0A77C0)
#define FOUNDATION_STRINGX_APPENDCOMMA_OFFSET UNITYSDK_OFFSET(0x1F0A8B90)
#define FOUNDATION_STRINGX_APPENDHTMLBR_OFFSET UNITYSDK_OFFSET(0x1F0A8CF0)
#define FOUNDATION_STRINGX_APPENDHYPHEN_OFFSET UNITYSDK_OFFSET(0x1F0A8E50)
#define FOUNDATION_STRINGX_APPENDNEWLINE_OFFSET UNITYSDK_OFFSET(0x1F0A8C40)
#define FOUNDATION_STRINGX_APPENDSEP_1_OFFSET UNITYSDK_OFFSET(0x1F0A8F00)
#define FOUNDATION_STRINGX_APPENDSEP_OFFSET UNITYSDK_OFFSET(0x1F0A8B40)
#define FOUNDATION_STRINGX_APPENDSPACE_OFFSET UNITYSDK_OFFSET(0x1F0A8DA0)
#define FOUNDATION_STRINGX_APPENDWITHCOMMA_OFFSET UNITYSDK_OFFSET(0x1F0A9100)
#define FOUNDATION_STRINGX_APPENDWITHHTMLBR_OFFSET UNITYSDK_OFFSET(0x1F0A9200)
#define FOUNDATION_STRINGX_APPENDWITHHYPHEN_OFFSET UNITYSDK_OFFSET(0x1F0A9280)
#define FOUNDATION_STRINGX_APPENDWITHNEWLINE_OFFSET UNITYSDK_OFFSET(0x1F0A9180)
#define FOUNDATION_STRINGX_APPENDWITHSEP_1_OFFSET UNITYSDK_OFFSET(0x1F0A9090)
#define FOUNDATION_STRINGX_APPENDWITHSEP_OFFSET UNITYSDK_OFFSET(0x1F0A9000)
#define FOUNDATION_STRINGX_APPENDWITHSPACE_OFFSET UNITYSDK_OFFSET(0x1F0A9300)
#define FOUNDATION_STRINGX_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1F0A98E0)
#define FOUNDATION_STRINGX_FORMATTED_OFFSET UNITYSDK_OFFSET(0x1F0A7CD0)
#define FOUNDATION_STRINGX_F_OFFSET UNITYSDK_OFFSET(0x1F0A4130)
#define FOUNDATION_STRINGX_GETWORDCOUNT_OFFSET UNITYSDK_OFFSET(0x1F0A86D0)
#define FOUNDATION_STRINGX_INVERTCASE_OFFSET UNITYSDK_OFFSET(0x1F0A80C0)
#define FOUNDATION_STRINGX_ISDATE_OFFSET UNITYSDK_OFFSET(0x1F0A7830)
#define FOUNDATION_STRINGX_ISINT_OFFSET UNITYSDK_OFFSET(0x1F0A78D0)
#define FOUNDATION_STRINGX_ISNOTNULLOREMPTY_OFFSET UNITYSDK_OFFSET(0x1F0A7C80)
#define FOUNDATION_STRINGX_ISNULLOREMPTYAFTERTRIMMED_OFFSET UNITYSDK_OFFSET(0x1F0A8290)
#define FOUNDATION_STRINGX_ISNULLOREMPTY_OFFSET UNITYSDK_OFFSET(0x1F0A7C30)
#define FOUNDATION_STRINGX_ISPALINDROME_OFFSET UNITYSDK_OFFSET(0x1F0A87F0)
#define FOUNDATION_STRINGX_ISVALIDEMAIL_OFFSET UNITYSDK_OFFSET(0x1F0A8A10)
#define FOUNDATION_STRINGX_ISVALIDIPADDRESS_OFFSET UNITYSDK_OFFSET(0x1F0A8AB0)
#define FOUNDATION_STRINGX_MATCH_OFFSET UNITYSDK_OFFSET(0x1F0A7EA0)
#define FOUNDATION_STRINGX_PADRIGHTEX_OFFSET UNITYSDK_OFFSET(0x1F0A9790)
#define FOUNDATION_STRINGX_REMOVECHAR_OFFSET UNITYSDK_OFFSET(0x1F0A85A0)
#define FOUNDATION_STRINGX_REMOVESPACES_OFFSET UNITYSDK_OFFSET(0x1F0A7F30)
#define FOUNDATION_STRINGX_REPLACERNWITHBR_OFFSET UNITYSDK_OFFSET(0x1F0A7FC0)
#define FOUNDATION_STRINGX_REVERSE_OFFSET UNITYSDK_OFFSET(0x1F0A7AD0)
#define FOUNDATION_STRINGX_SKIP_OFFSET UNITYSDK_OFFSET(0x1F0A7A60)
#define FOUNDATION_STRINGX_STRIPHTML_OFFSET UNITYSDK_OFFSET(0x1F0A7D20)
#define FOUNDATION_STRINGX_SUBSETSTRING_OFFSET UNITYSDK_OFFSET(0x1F0A94E0)
#define FOUNDATION_STRINGX_SUBSTRINGFROMXTOY_OFFSET UNITYSDK_OFFSET(0x1F0A84D0)
#define FOUNDATION_STRINGX_TAKE_OFFSET UNITYSDK_OFFSET(0x1F0A7980)
#define FOUNDATION_STRINGX_TOCHARLIST_OFFSET UNITYSDK_OFFSET(0x1F0A8360)
#define FOUNDATION_STRINGX_TODOUBLE_OFFSET UNITYSDK_OFFSET(0x1F0A7720)
#define FOUNDATION_STRINGX_TOEMPTYSTRING_OFFSET UNITYSDK_OFFSET(0x1F0A8060)
#define FOUNDATION_STRINGX_TOFLOAT_OFFSET UNITYSDK_OFFSET(0x1F0A7770)
#define FOUNDATION_STRINGX_TOTITLECASE_OFFSET UNITYSDK_OFFSET(0x1F0A9380)
#define FOUNDATION_STRINGX_TRUNCATE_OFFSET UNITYSDK_OFFSET(0x1F0A76B0)

namespace Foundation
{
	inline static constexpr unsigned int StringX_TypeDefinitionIndex = 8221;
