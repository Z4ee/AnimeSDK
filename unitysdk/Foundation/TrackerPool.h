...
#define FOUNDATION_TRACKERPOOL_ASSETTRACKERCREATER_OFFSET UNITYSDK_OFFSET(0x1B71F050)
#define FOUNDATION_TRACKERPOOL_GETASSETTRAKER_OFFSET UNITYSDK_OFFSET(0x1B71EC00)
#define FOUNDATION_TRACKERPOOL_GETINSTANCETRACKER_OFFSET UNITYSDK_OFFSET(0x1B71ED50)
#define FOUNDATION_TRACKERPOOL_GETTEMPORARAYTRACKER_OFFSET UNITYSDK_OFFSET(0x1B71EF00)
#define FOUNDATION_TRACKERPOOL_INSTANCETRACKERCREATER_OFFSET UNITYSDK_OFFSET(0x1B71F0C0)
#define FOUNDATION_TRACKERPOOL_RELEASEASSETTRACKER_OFFSET UNITYSDK_OFFSET(0x1B71ECC0)
#define FOUNDATION_TRACKERPOOL_RELEASEINSTANCETRACKER_OFFSET UNITYSDK_OFFSET(0x1B71EE70)
#define FOUNDATION_TRACKERPOOL_RELEASETEMPORARAYTRACKER_OFFSET UNITYSDK_OFFSET(0x1B71EFC0)
#define FOUNDATION_TRACKERPOOL_TEMPORARAYTRACKERCREATER_OFFSET UNITYSDK_OFFSET(0x1B71F170)
#define FOUNDATION_TRACKERPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B71F220)

namespace Foundation
{
	inline static constexpr unsigned int TrackerPool_TypeDefinitionIndex = 8269;

	class TrackerPool : public ::System::Object
	{
	public:
		::Foundation::ObjectPool_1<::Foundation::TemporarayTracker*>* tempTrackerPool; // 0x10
		::Foundation::ObjectPool_1<::Foundation::AssetTracker*>* assetTrackerPool; // 0x18
		::Foundation::ObjectPool_1<::Foundation::InstanceTracker*>* instanceTrackerPool; // 0x20
