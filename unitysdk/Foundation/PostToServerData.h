...
#define FOUNDATION_POSTTOSERVERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1F62E550)

namespace Foundation
{
	inline static constexpr unsigned int PostToServerData_TypeDefinitionIndex = 8310;

	class PostToServerData : public ::System::Object
	{
	public:
		::Foundation::VersionFileInfo* versions; // 0x10
		::System::String* P4ChangeList; // 0x18
		::System::String* GameResUrl; // 0x20
		...
		::System::String* res_revision; // 0x40
		::System::String* data_revision; // 0x48
