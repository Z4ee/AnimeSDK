...
{
	inline static constexpr unsigned int TwoDimensionalTable_3___c__DisplayClass5_0_TypeDefinitionIndex = 8325;

	template <typename TX, typename TY, typename V>
	class TwoDimensionalTable_3___c__DisplayClass5_0 : public ::System::Object
	{
	public:
		TX x; // 0x0
		TY y; // 0x0
