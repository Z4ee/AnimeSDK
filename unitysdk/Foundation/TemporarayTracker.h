...
#define FOUNDATION_TEMPORARAYTRACKER_CHECKALIVE_OFFSET UNITYSDK_OFFSET(0x1DCC3900)
#define FOUNDATION_TEMPORARAYTRACKER_COMPOSETEMPORARAYTRACKER_OFFSET UNITYSDK_OFFSET(0x1DCC38A0)
#define FOUNDATION_TEMPORARAYTRACKER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DCC3D00)
#define FOUNDATION_TEMPORARAYTRACKER_GET_CAPCITY_OFFSET UNITYSDK_OFFSET(0x1DCC3880)
#define FOUNDATION_TEMPORARAYTRACKER_GET_TIMEOUT_OFFSET UNITYSDK_OFFSET(0x1DCC3860)
#define FOUNDATION_TEMPORARAYTRACKER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1DCC3A80)
#define FOUNDATION_TEMPORARAYTRACKER_SET_CAPCITY_OFFSET UNITYSDK_OFFSET(0x1DCC3890)
#define FOUNDATION_TEMPORARAYTRACKER_SET_TIMEOUT_OFFSET UNITYSDK_OFFSET(0x1DCC3870)
#define FOUNDATION_TEMPORARAYTRACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCC3DA0)

namespace Foundation
{
	inline static constexpr unsigned int TemporarayTracker_TypeDefinitionIndex = 7941;

	class TemporarayTracker : public ::System::Object
	{
	public:
		::System::Collections::Generic::LinkedList_1<::UnityEngine::Object*>* objectsPool; // 0x10
		::System::Single disposeTick; // 0x18
		::System::Int32 _Timeout_k__BackingField; // 0x1C
		::System::Int32 _Capcity_k__BackingField; // 0x20
