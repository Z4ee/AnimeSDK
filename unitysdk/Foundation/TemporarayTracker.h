...
#define FOUNDATION_TEMPORARAYTRACKER_CHECKALIVE_OFFSET UNITYSDK_OFFSET(0x1EF49770)
#define FOUNDATION_TEMPORARAYTRACKER_COMPOSETEMPORARAYTRACKER_OFFSET UNITYSDK_OFFSET(0x1EF49710)
#define FOUNDATION_TEMPORARAYTRACKER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EF49B70)
#define FOUNDATION_TEMPORARAYTRACKER_GET_CAPCITY_OFFSET UNITYSDK_OFFSET(0x1EF496F0)
#define FOUNDATION_TEMPORARAYTRACKER_GET_TIMEOUT_OFFSET UNITYSDK_OFFSET(0x1EF496D0)
#define FOUNDATION_TEMPORARAYTRACKER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1EF498E0)
#define FOUNDATION_TEMPORARAYTRACKER_SET_CAPCITY_OFFSET UNITYSDK_OFFSET(0x1EF49700)
#define FOUNDATION_TEMPORARAYTRACKER_SET_TIMEOUT_OFFSET UNITYSDK_OFFSET(0x1EF496E0)
#define FOUNDATION_TEMPORARAYTRACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF49C10)

namespace Foundation
{
	inline static constexpr unsigned int TemporarayTracker_TypeDefinitionIndex = 8316;

	class TemporarayTracker : public ::System::Object
	{
	public:
		::System::Collections::Generic::LinkedList_1<::UnityEngine::Object*>* objectsPool; // 0x10
		::System::Single timeoutTick; // 0x18
		::System::Int32 _Capcity_k__BackingField; // 0x1C
		::System::Single disposeTick; // 0x20
