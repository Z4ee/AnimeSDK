...
#define FOUNDATION_FLOATCLAMPEDPOLICY_FOUNDATION_ICLAMPFUNC_SYSTEM_SINGLE__CLAMP_OFFSET UNITYSDK_OFFSET(0x1B3805A0)
#define FOUNDATION_FLOATCLAMPEDPOLICY_FOUNDATION_IMAXFUNC_SYSTEM_SINGLE__MAX_OFFSET UNITYSDK_OFFSET(0x1B3805D0)
#define FOUNDATION_FLOATCLAMPEDPOLICY_FOUNDATION_IMINFUNC_SYSTEM_SINGLE__MIN_OFFSET UNITYSDK_OFFSET(0x1B3805C0)
#define FOUNDATION_FLOATCLAMPEDPOLICY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B3805E0)
#define FOUNDATION_FLOATCLAMPEDPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B380590)

namespace Foundation
{
	inline static constexpr unsigned int FloatClampedPolicy_TypeDefinitionIndex = 8816;
	...
	public:
		...
		{
			return (::Foundation::FloatClampedPolicy**)Il2CppClass::FromTypeDefinitionIndex(FloatClampedPolicy_TypeDefinitionIndex)->GetStaticField(0x7D00);
		}
