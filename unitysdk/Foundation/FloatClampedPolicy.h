...
#define FOUNDATION_FLOATCLAMPEDPOLICY_FOUNDATION_ICLAMPFUNC_SYSTEM_SINGLE__CLAMP_OFFSET UNITYSDK_OFFSET(0x1DC9EA50)
#define FOUNDATION_FLOATCLAMPEDPOLICY_FOUNDATION_IMAXFUNC_SYSTEM_SINGLE__MAX_OFFSET UNITYSDK_OFFSET(0x1DC9EA80)
#define FOUNDATION_FLOATCLAMPEDPOLICY_FOUNDATION_IMINFUNC_SYSTEM_SINGLE__MIN_OFFSET UNITYSDK_OFFSET(0x1DC9EA70)
#define FOUNDATION_FLOATCLAMPEDPOLICY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DC9EA90)
#define FOUNDATION_FLOATCLAMPEDPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC9EA40)

namespace Foundation
{
	inline static constexpr unsigned int FloatClampedPolicy_TypeDefinitionIndex = 8651;
	...
	public:
		...
		{
			return (::Foundation::FloatClampedPolicy**)Il2CppClass::FromTypeDefinitionIndex(FloatClampedPolicy_TypeDefinitionIndex)->GetStaticField(0x74E0);
		}
