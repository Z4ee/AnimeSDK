...
#define FOUNDATION_DYNAMICRESOURCELOADER_ADDRESPATHCOMMONPREFIX_OFFSET UNITYSDK_OFFSET(0x1C5CA680)
#define FOUNDATION_DYNAMICRESOURCELOADER_ADDSCENEPATHCOMMONPREFIX_OFFSET UNITYSDK_OFFSET(0x1C5CA170)
#define FOUNDATION_DYNAMICRESOURCELOADER_CONTAINSASSET_1_OFFSET UNITYSDK_OFFSET(0x1C5CB1E0)
#define FOUNDATION_DYNAMICRESOURCELOADER_CONTAINSASSET_OFFSET UNITYSDK_OFFSET(0x1C5CB120)
#define FOUNDATION_DYNAMICRESOURCELOADER_DESTROYOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1C5C9D70)
#define FOUNDATION_DYNAMICRESOURCELOADER_DESTROYOBJECT_OFFSET UNITYSDK_OFFSET(0x1C5C9CD0)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADASSETASYNC_1_OFFSET UNITYSDK_OFFSET(0x1C5CAB60)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADASSETASYNC_OFFSET UNITYSDK_OFFSET(0x1C5CA9C0)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADASSET_OFFSET UNITYSDK_OFFSET(0x1C5CACD0)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADINSTANCEASSET_1_OFFSET UNITYSDK_OFFSET(0x1C5CAE90)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADINSTANCEASSET_OFFSET UNITYSDK_OFFSET(0x1C5CADE0)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADOBJECTINSTANCECACHESYNC_1_OFFSET UNITYSDK_OFFSET(0x1C5CA910)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADOBJECTINSTANCECACHESYNC_OFFSET UNITYSDK_OFFSET(0x1C5CA850)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADOBJECTINSTANCECACHE_1_OFFSET UNITYSDK_OFFSET(0x1C5CA7A0)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADOBJECTINSTANCECACHE_OFFSET UNITYSDK_OFFSET(0x1C5CA5C0)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADSCENEASYNC_1_OFFSET UNITYSDK_OFFSET(0x1C5CA220)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADSCENEASYNC_OFFSET UNITYSDK_OFFSET(0x1C5CA0B0)
#define FOUNDATION_DYNAMICRESOURCELOADER_REMOVEUNUSEDASSETS_OFFSET UNITYSDK_OFFSET(0x1C5CB0A0)
#define FOUNDATION_DYNAMICRESOURCELOADER_SETSCENEPATHPERSISTENT_OFFSET UNITYSDK_OFFSET(0x1C5C9F50)
#define FOUNDATION_DYNAMICRESOURCELOADER_UNLOADALLAUTO_OFFSET UNITYSDK_OFFSET(0x1C5CB280)
#define FOUNDATION_DYNAMICRESOURCELOADER_UNLOADALLSCENESINADDITIVESCENE_OFFSET UNITYSDK_OFFSET(0x1C5CA540)
#define FOUNDATION_DYNAMICRESOURCELOADER_UNLOADALLSCENES_OFFSET UNITYSDK_OFFSET(0x1C5CA4C0)
#define FOUNDATION_DYNAMICRESOURCELOADER_UNLOADASSET_OFFSET UNITYSDK_OFFSET(0x1C5CB5A0)
#define FOUNDATION_DYNAMICRESOURCELOADER_UNLOADSCENE_OFFSET UNITYSDK_OFFSET(0x1C5CA3C0)
#define FOUNDATION_DYNAMICRESOURCELOADER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C5CB690)
#define FOUNDATION_DYNAMICRESOURCELOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5CB680)

namespace Foundation
{
	inline static constexpr unsigned int DynamicResourceLoader_TypeDefinitionIndex = 7758;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::Foundation::AssetRequestHandle>**)Il2CppClass::FromTypeDefinitionIndex(DynamicResourceLoader_TypeDefinitionIndex)->GetStaticField(0x6E00);
		}
		static ::System::Collections::Generic::HashSet_1<::System::String*>** StaticGet_persistentSceneDict()
		{
			return (::System::Collections::Generic::HashSet_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(DynamicResourceLoader_TypeDefinitionIndex)->GetStaticField(0x6E08);
		}
		static ::System::Collections::Generic::List_1<::Foundation::AssetRequestHandle>** StaticGet_HookAutoHandles()
		{
			return (::System::Collections::Generic::List_1<::Foundation::AssetRequestHandle>**)Il2CppClass::FromTypeDefinitionIndex(DynamicResourceLoader_TypeDefinitionIndex)->GetStaticField(0x6E10);
		}
