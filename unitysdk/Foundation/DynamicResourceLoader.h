...
#define FOUNDATION_DYNAMICRESOURCELOADER_ADDRESPATHCOMMONPREFIX_OFFSET UNITYSDK_OFFSET(0x1A004010)
#define FOUNDATION_DYNAMICRESOURCELOADER_ADDSCENEPATHCOMMONPREFIX_OFFSET UNITYSDK_OFFSET(0x1A003B00)
#define FOUNDATION_DYNAMICRESOURCELOADER_CONTAINSASSET_1_OFFSET UNITYSDK_OFFSET(0x1A004B70)
#define FOUNDATION_DYNAMICRESOURCELOADER_CONTAINSASSET_OFFSET UNITYSDK_OFFSET(0x1A004AB0)
#define FOUNDATION_DYNAMICRESOURCELOADER_DESTROYOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1A003700)
#define FOUNDATION_DYNAMICRESOURCELOADER_DESTROYOBJECT_OFFSET UNITYSDK_OFFSET(0x1A003660)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADASSETASYNC_1_OFFSET UNITYSDK_OFFSET(0x1A0044F0)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADASSETASYNC_OFFSET UNITYSDK_OFFSET(0x1A004350)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADASSET_OFFSET UNITYSDK_OFFSET(0x1A004660)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADINSTANCEASSET_1_OFFSET UNITYSDK_OFFSET(0x1A004820)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADINSTANCEASSET_OFFSET UNITYSDK_OFFSET(0x1A004770)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADOBJECTINSTANCECACHESYNC_1_OFFSET UNITYSDK_OFFSET(0x1A0042A0)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADOBJECTINSTANCECACHESYNC_OFFSET UNITYSDK_OFFSET(0x1A0041E0)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADOBJECTINSTANCECACHE_1_OFFSET UNITYSDK_OFFSET(0x1A004130)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADOBJECTINSTANCECACHE_OFFSET UNITYSDK_OFFSET(0x1A003F50)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADSCENEASYNC_1_OFFSET UNITYSDK_OFFSET(0x1A003BB0)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADSCENEASYNC_OFFSET UNITYSDK_OFFSET(0x1A003A40)
#define FOUNDATION_DYNAMICRESOURCELOADER_REMOVEUNUSEDASSETS_OFFSET UNITYSDK_OFFSET(0x1A004A30)
#define FOUNDATION_DYNAMICRESOURCELOADER_SETSCENEPATHPERSISTENT_OFFSET UNITYSDK_OFFSET(0x1A0038E0)
#define FOUNDATION_DYNAMICRESOURCELOADER_UNLOADALLAUTO_OFFSET UNITYSDK_OFFSET(0x1A004C10)
#define FOUNDATION_DYNAMICRESOURCELOADER_UNLOADALLSCENESINADDITIVESCENE_OFFSET UNITYSDK_OFFSET(0x1A003ED0)
#define FOUNDATION_DYNAMICRESOURCELOADER_UNLOADALLSCENES_OFFSET UNITYSDK_OFFSET(0x1A003E50)
#define FOUNDATION_DYNAMICRESOURCELOADER_UNLOADASSET_OFFSET UNITYSDK_OFFSET(0x1A004F30)
#define FOUNDATION_DYNAMICRESOURCELOADER_UNLOADSCENE_OFFSET UNITYSDK_OFFSET(0x1A003D50)
#define FOUNDATION_DYNAMICRESOURCELOADER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A005020)
#define FOUNDATION_DYNAMICRESOURCELOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A005010)

namespace Foundation
{
	inline static constexpr unsigned int DynamicResourceLoader_TypeDefinitionIndex = 8091;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::Foundation::AssetRequestHandle>**)Il2CppClass::FromTypeDefinitionIndex(DynamicResourceLoader_TypeDefinitionIndex)->GetStaticField(0x6CB0);
		}
		static ::System::Collections::Generic::HashSet_1<::System::String*>** StaticGet_persistentSceneDict()
		{
			return (::System::Collections::Generic::HashSet_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(DynamicResourceLoader_TypeDefinitionIndex)->GetStaticField(0x6CB8);
		}
		static ::System::Collections::Generic::List_1<::Foundation::AssetRequestHandle>** StaticGet_AutoHandles()
		{
			return (::System::Collections::Generic::List_1<::Foundation::AssetRequestHandle>**)Il2CppClass::FromTypeDefinitionIndex(DynamicResourceLoader_TypeDefinitionIndex)->GetStaticField(0x6CC0);
		}
