...
#define FOUNDATION_STATEMACHINE_PARAMETER_EQUALS_OFFSET UNITYSDK_OFFSET(0x661410)
#define FOUNDATION_STATEMACHINE_PARAMETER_GET_BOOLVALUE_OFFSET UNITYSDK_OFFSET(0x3E5650)
#define FOUNDATION_STATEMACHINE_PARAMETER_GET_ISTRIGGERED_OFFSET UNITYSDK_OFFSET(0x3E5650)
#define FOUNDATION_STATEMACHINE_PARAMETER_NEWBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1C173800)
#define FOUNDATION_STATEMACHINE_PARAMETER_NEWFLOAT_OFFSET UNITYSDK_OFFSET(0x1C1737E0)
#define FOUNDATION_STATEMACHINE_PARAMETER_NEWINTEGER_OFFSET UNITYSDK_OFFSET(0x1C1737F0)
#define FOUNDATION_STATEMACHINE_PARAMETER_NEWTRIGGER_OFFSET UNITYSDK_OFFSET(0x1C173810)
#define FOUNDATION_STATEMACHINE_PARAMETER_RESETTRIGGER_OFFSET UNITYSDK_OFFSET(0x9C4070)
#define FOUNDATION_STATEMACHINE_PARAMETER_SET_BOOLVALUE_OFFSET UNITYSDK_OFFSET(0x2E7740)
#define FOUNDATION_STATEMACHINE_PARAMETER_TRIGGER_OFFSET UNITYSDK_OFFSET(0x9C4060)

namespace Foundation::StateMachine
{
	inline static constexpr unsigned int Parameter_TypeDefinitionIndex = 8830;
