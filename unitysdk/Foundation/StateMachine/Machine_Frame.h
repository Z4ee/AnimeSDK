...
#define FOUNDATION_STATEMACHINE_MACHINE_FRAME_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0xA81E90)
#define FOUNDATION_STATEMACHINE_MACHINE_FRAME_GET_TRANSITIONCOUNT_OFFSET UNITYSDK_OFFSET(0xA7B5E0)
#define FOUNDATION_STATEMACHINE_MACHINE_FRAME_GET_TRANSITIONINDEX_OFFSET UNITYSDK_OFFSET(0xA7B5D0)
#define FOUNDATION_STATEMACHINE_MACHINE_FRAME_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xA81EC0)
#define FOUNDATION_STATEMACHINE_MACHINE_FRAME_SET_TRANSITIONCOUNT_OFFSET UNITYSDK_OFFSET(0xA81F30)
#define FOUNDATION_STATEMACHINE_MACHINE_FRAME_SET_TRANSITIONINDEX_OFFSET UNITYSDK_OFFSET(0xA81F10)
#define FOUNDATION_STATEMACHINE_MACHINE_FRAME__CTOR_1_OFFSET UNITYSDK_OFFSET(0xA81EF0)
#define FOUNDATION_STATEMACHINE_MACHINE_FRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x35ACA0)

namespace Foundation::StateMachine
{
	inline static constexpr unsigned int Machine_Frame_TypeDefinitionIndex = 8489;
