...
#define FOUNDATION_STATEMACHINE_MACHINE_DFS_OFFSET UNITYSDK_OFFSET(0xA6DB00)
#define FOUNDATION_STATEMACHINE_MACHINE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA57400)
#define FOUNDATION_STATEMACHINE_MACHINE_EQUALS_OFFSET UNITYSDK_OFFSET(0xA6D990)
#define FOUNDATION_STATEMACHINE_MACHINE_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0xA6D960)
#define FOUNDATION_STATEMACHINE_MACHINE_GET_LAYERCOUNT_OFFSET UNITYSDK_OFFSET(0xA6D7D0)
#define FOUNDATION_STATEMACHINE_MACHINE_GET_PARAMCOUNT_OFFSET UNITYSDK_OFFSET(0xA6D7B0)
#define FOUNDATION_STATEMACHINE_MACHINE_GET_STATECOUNT_OFFSET UNITYSDK_OFFSET(0xA6D7C0)
#define FOUNDATION_STATEMACHINE_MACHINE_PROCESS_OFFSET UNITYSDK_OFFSET(0xA6D9D0)
#define FOUNDATION_STATEMACHINE_MACHINE_RESETTRIGGER_OFFSET UNITYSDK_OFFSET(0xA6D7F0)
#define FOUNDATION_STATEMACHINE_MACHINE_STEPNEXTSTATE_OFFSET UNITYSDK_OFFSET(0xA6DA10)
#define FOUNDATION_STATEMACHINE_MACHINE_UPDATECONDITIONS_OFFSET UNITYSDK_OFFSET(0xA6DA50)
#define FOUNDATION_STATEMACHINE_MACHINE_UPDATELAYER_OFFSET UNITYSDK_OFFSET(0xA6DAA0)
#define FOUNDATION_STATEMACHINE_MACHINE__CTOR_OFFSET UNITYSDK_OFFSET(0xA6D7E0)

namespace Foundation::StateMachine
{
	inline static constexpr unsigned int Machine_TypeDefinitionIndex = 8488;
