...
#define FOUNDATION_STATEMACHINE_MACHINE_DFS_OFFSET UNITYSDK_OFFSET(0xABE430)
#define FOUNDATION_STATEMACHINE_MACHINE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAA8980)
#define FOUNDATION_STATEMACHINE_MACHINE_EQUALS_OFFSET UNITYSDK_OFFSET(0xABE2C0)
#define FOUNDATION_STATEMACHINE_MACHINE_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0xABE290)
#define FOUNDATION_STATEMACHINE_MACHINE_GET_LAYERCOUNT_OFFSET UNITYSDK_OFFSET(0xABE100)
#define FOUNDATION_STATEMACHINE_MACHINE_GET_PARAMCOUNT_OFFSET UNITYSDK_OFFSET(0xABE0E0)
#define FOUNDATION_STATEMACHINE_MACHINE_GET_STATECOUNT_OFFSET UNITYSDK_OFFSET(0xABE0F0)
#define FOUNDATION_STATEMACHINE_MACHINE_PROCESS_OFFSET UNITYSDK_OFFSET(0xABE300)
#define FOUNDATION_STATEMACHINE_MACHINE_RESETTRIGGER_OFFSET UNITYSDK_OFFSET(0xABE120)
#define FOUNDATION_STATEMACHINE_MACHINE_STEPNEXTSTATE_OFFSET UNITYSDK_OFFSET(0xABE340)
#define FOUNDATION_STATEMACHINE_MACHINE_UPDATECONDITIONS_OFFSET UNITYSDK_OFFSET(0xABE380)
#define FOUNDATION_STATEMACHINE_MACHINE_UPDATELAYER_OFFSET UNITYSDK_OFFSET(0xABE3D0)
#define FOUNDATION_STATEMACHINE_MACHINE__CTOR_OFFSET UNITYSDK_OFFSET(0xABE110)

namespace Foundation::StateMachine
{
	inline static constexpr unsigned int Machine_TypeDefinitionIndex = 8782;
