...
#define FOUNDATION_STATEMACHINE_PARAMETERID_EQUALS_OFFSET UNITYSDK_OFFSET(0x9BD870)
#define FOUNDATION_STATEMACHINE_PARAMETERID_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x2E7930)
#define FOUNDATION_STATEMACHINE_PARAMETERID_GET_ISFLOAT_OFFSET UNITYSDK_OFFSET(0x9BD850)
#define FOUNDATION_STATEMACHINE_PARAMETERID_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x9BD840)
#define FOUNDATION_STATEMACHINE_PARAMETERID_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x99FEF0)
#define FOUNDATION_STATEMACHINE_PARAMETERID_ISVALIDFLOAT_OFFSET UNITYSDK_OFFSET(0x9BD960)
#define FOUNDATION_STATEMACHINE_PARAMETERID_ISVALID_OFFSET UNITYSDK_OFFSET(0x9BD950)
#define FOUNDATION_STATEMACHINE_PARAMETERID_NEWBOOL_OFFSET UNITYSDK_OFFSET(0x1BFE5E90)
#define FOUNDATION_STATEMACHINE_PARAMETERID_NEWFLOAT_OFFSET UNITYSDK_OFFSET(0x1BFE5E70)
#define FOUNDATION_STATEMACHINE_PARAMETERID_NEWINT_OFFSET UNITYSDK_OFFSET(0x1BFE5E80)
#define FOUNDATION_STATEMACHINE_PARAMETERID_NEWTRIGGER_OFFSET UNITYSDK_OFFSET(0x1BFE5EA0)
#define FOUNDATION_STATEMACHINE_PARAMETERID_SETBOOL_OFFSET UNITYSDK_OFFSET(0x9BD880)
#define FOUNDATION_STATEMACHINE_PARAMETERID_SETFLOAT_1_OFFSET UNITYSDK_OFFSET(0x9BD900)
#define FOUNDATION_STATEMACHINE_PARAMETERID_SETFLOAT_OFFSET UNITYSDK_OFFSET(0x9BD8A0)
#define FOUNDATION_STATEMACHINE_PARAMETERID_SETINT_OFFSET UNITYSDK_OFFSET(0x9BD8C0)
#define FOUNDATION_STATEMACHINE_PARAMETERID_TRIGGER_OFFSET UNITYSDK_OFFSET(0x9BD8E0)
#define FOUNDATION_STATEMACHINE_PARAMETERID__CTOR_OFFSET UNITYSDK_OFFSET(0x9BD820)

namespace Foundation::StateMachine
{
	inline static constexpr unsigned int ParameterId_TypeDefinitionIndex = 9046;

	struct alignas(2) ParameterId
	{
		static ::Foundation::StateMachine::ParameterId* StaticGet_Null()
		{
			return (::Foundation::StateMachine::ParameterId*)Il2CppClass::FromTypeDefinitionIndex(ParameterId_TypeDefinitionIndex)->GetStaticField(0xB680);
		}
