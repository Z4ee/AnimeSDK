...
#define FOUNDATION_STATEMACHINE_CONDITION_CHECKBOOL_OFFSET UNITYSDK_OFFSET(0x1BA62900)
#define FOUNDATION_STATEMACHINE_CONDITION_CHECKFLOAT_OFFSET UNITYSDK_OFFSET(0x1BA62830)
#define FOUNDATION_STATEMACHINE_CONDITION_CHECKINT_OFFSET UNITYSDK_OFFSET(0x1BA62890)
#define FOUNDATION_STATEMACHINE_CONDITION_CHECKTRIGGER_OFFSET UNITYSDK_OFFSET(0x1BA62920)
#define FOUNDATION_STATEMACHINE_CONDITION_CHECK_1_OFFSET UNITYSDK_OFFSET(0x1BA62930)
#define FOUNDATION_STATEMACHINE_CONDITION_CHECK_OFFSET UNITYSDK_OFFSET(0x99FF30)
#define FOUNDATION_STATEMACHINE_CONDITION_EQUALS_OFFSET UNITYSDK_OFFSET(0x99FF10)
#define FOUNDATION_STATEMACHINE_CONDITION_GET_PARAMINDEX_OFFSET UNITYSDK_OFFSET(0x2E7930)
#define FOUNDATION_STATEMACHINE_CONDITION_GET_PARAMTYPE_OFFSET UNITYSDK_OFFSET(0x99FEF0)
#define FOUNDATION_STATEMACHINE_CONDITION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x99FF00)

namespace Foundation::StateMachine
{
	inline static constexpr unsigned int Condition_TypeDefinitionIndex = 9031;
