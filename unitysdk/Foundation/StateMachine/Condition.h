...
#define FOUNDATION_STATEMACHINE_CONDITION_CHECKBOOL_OFFSET UNITYSDK_OFFSET(0x1E148AD0)
#define FOUNDATION_STATEMACHINE_CONDITION_CHECKFLOAT_OFFSET UNITYSDK_OFFSET(0x1E148A00)
#define FOUNDATION_STATEMACHINE_CONDITION_CHECKINT_OFFSET UNITYSDK_OFFSET(0x1E148A60)
#define FOUNDATION_STATEMACHINE_CONDITION_CHECKTRIGGER_OFFSET UNITYSDK_OFFSET(0x1E148AF0)
#define FOUNDATION_STATEMACHINE_CONDITION_CHECK_1_OFFSET UNITYSDK_OFFSET(0x1E148B00)
#define FOUNDATION_STATEMACHINE_CONDITION_CHECK_OFFSET UNITYSDK_OFFSET(0xA573A0)
#define FOUNDATION_STATEMACHINE_CONDITION_EQUALS_OFFSET UNITYSDK_OFFSET(0xA57380)
#define FOUNDATION_STATEMACHINE_CONDITION_GET_PARAMINDEX_OFFSET UNITYSDK_OFFSET(0x2ACBE0)
#define FOUNDATION_STATEMACHINE_CONDITION_GET_PARAMTYPE_OFFSET UNITYSDK_OFFSET(0xA57360)
#define FOUNDATION_STATEMACHINE_CONDITION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xA57370)

namespace Foundation::StateMachine
{
	inline static constexpr unsigned int Condition_TypeDefinitionIndex = 8757;
