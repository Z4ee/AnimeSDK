...
#define FOUNDATION_IPADDRESSUTIL_PARSEIPADDRESSANDPORT_OFFSET UNITYSDK_OFFSET(0x1A00F1E0)

namespace Foundation
{
	inline static constexpr unsigned int IpAddressUtil_TypeDefinitionIndex = 8057;
