...
#define FOUNDATION_AGGREGATEOBJECTCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC327F0)

namespace Foundation
{
	inline static constexpr unsigned int AggregateObjectCache_TypeDefinitionIndex = 8762;

	class AggregateObjectCache : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::Foundation::AggregateObjectCache_InterfaceData>* Interfaces; // 0x10
		::Il2CppArray<::System::Collections::Generic::List_1<::System::Int32>*>* EventDispatcher; // 0x18
