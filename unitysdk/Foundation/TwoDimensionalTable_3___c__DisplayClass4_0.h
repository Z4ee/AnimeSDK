...
{
	inline static constexpr unsigned int TwoDimensionalTable_3___c__DisplayClass4_0_TypeDefinitionIndex = 8328;

	template <typename TX, typename TY, typename V>
	class TwoDimensionalTable_3___c__DisplayClass4_0 : public ::System::Object
	{
	public:
		TX x; // 0x0
		TY y; // 0x0
