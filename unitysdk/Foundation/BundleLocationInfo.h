...
#define FOUNDATION_BUNDLELOCATIONINFO_FINDBLOCKLOCATIONCACHE_OFFSET UNITYSDK_OFFSET(0x1C5C1250)
#define FOUNDATION_BUNDLELOCATIONINFO_FINDBLOCKLOCATIONINDEX_OFFSET UNITYSDK_OFFSET(0x1C5C13E0)
#define FOUNDATION_BUNDLELOCATIONINFO_GETFILEEXT_OFFSET UNITYSDK_OFFSET(0x96ECD0)
#define FOUNDATION_BUNDLELOCATIONINFO_GETFOLDERPATH_OFFSET UNITYSDK_OFFSET(0x96EBD0)
#define FOUNDATION_BUNDLELOCATIONINFO_GETRELATIVEPATH_OFFSET UNITYSDK_OFFSET(0x96EC40)
#define FOUNDATION_BUNDLELOCATIONINFO_GETROOTFOLDER_OFFSET UNITYSDK_OFFSET(0x96EBE0)
#define FOUNDATION_BUNDLELOCATIONINFO_GET_NONE_OFFSET UNITYSDK_OFFSET(0x1C5C0D50)
#define FOUNDATION_BUNDLELOCATIONINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x96ED50)
#define FOUNDATION_BUNDLELOCATIONINFO__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C5C1800)
#define FOUNDATION_BUNDLELOCATIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x96EBC0)
#define FOUNDATION_BUNDLELOCATIONINFO___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x96ED60)

namespace Foundation
{
	inline static constexpr unsigned int BundleLocationInfo_TypeDefinitionIndex = 7975;
	...
	struct alignas(4) BundleLocationInfo
	{
		...
		{
			return (::Il2CppArray<::System::ValueTuple_2<::Foundation::BundleLocation, ::Foundation::BundleType>>**)Il2CppClass::FromTypeDefinitionIndex(BundleLocationInfo_TypeDefinitionIndex)->GetStaticField(0x6DF0);
		}
