...
#define FOUNDATION_BUNDLELOCATIONINFO_FINDBLOCKLOCATIONCACHE_OFFSET UNITYSDK_OFFSET(0x1D95CBB0)
#define FOUNDATION_BUNDLELOCATIONINFO_FINDBLOCKLOCATIONINDEX_OFFSET UNITYSDK_OFFSET(0x1D95CD40)
#define FOUNDATION_BUNDLELOCATIONINFO_GETFILEEXT_OFFSET UNITYSDK_OFFSET(0x9B97E0)
#define FOUNDATION_BUNDLELOCATIONINFO_GETFOLDERPATH_OFFSET UNITYSDK_OFFSET(0x9B96E0)
#define FOUNDATION_BUNDLELOCATIONINFO_GETRELATIVEPATH_OFFSET UNITYSDK_OFFSET(0x9B9750)
#define FOUNDATION_BUNDLELOCATIONINFO_GETROOTFOLDER_OFFSET UNITYSDK_OFFSET(0x9B96F0)
#define FOUNDATION_BUNDLELOCATIONINFO_GET_NONE_OFFSET UNITYSDK_OFFSET(0x1D95C6B0)
#define FOUNDATION_BUNDLELOCATIONINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9B9860)
#define FOUNDATION_BUNDLELOCATIONINFO__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D95D160)
#define FOUNDATION_BUNDLELOCATIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x447F70)
#define FOUNDATION_BUNDLELOCATIONINFO___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9B9870)

namespace Foundation
{
	inline static constexpr unsigned int BundleLocationInfo_TypeDefinitionIndex = 8007;
	...
	struct alignas(4) BundleLocationInfo
	{
		...
		{
			return (::Il2CppArray<::System::ValueTuple_2<::Foundation::BundleLocation, ::Foundation::BundleType>>**)Il2CppClass::FromTypeDefinitionIndex(BundleLocationInfo_TypeDefinitionIndex)->GetStaticField(0x6D60);
		}
