...
#define FOUNDATION_CITYHASH_UINT128__CTOR_OFFSET UNITYSDK_OFFSET(0x346F70)

namespace Foundation
{
	inline static constexpr unsigned int CityHash_Uint128_TypeDefinitionIndex = 8862;
