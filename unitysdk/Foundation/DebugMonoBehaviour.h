...
#define FOUNDATION_DEBUGMONOBEHAVIOUR_DRAW_OFFSET UNITYSDK_OFFSET(0x1CC8E4A0)
#define FOUNDATION_DEBUGMONOBEHAVIOUR_GET__CURACTIONS_OFFSET UNITYSDK_OFFSET(0x1CC8E170)
#define FOUNDATION_DEBUGMONOBEHAVIOUR_INIT_OFFSET UNITYSDK_OFFSET(0x1CC8E1C0)
#define FOUNDATION_DEBUGMONOBEHAVIOUR_ONRENDEROBJECT_OFFSET UNITYSDK_OFFSET(0x1CC8E2D0)
#define FOUNDATION_DEBUGMONOBEHAVIOUR_PUSHCMD_OFFSET UNITYSDK_OFFSET(0x1CC8E200)
#define FOUNDATION_DEBUGMONOBEHAVIOUR_SWITCHLIST_OFFSET UNITYSDK_OFFSET(0x1CC8E370)
#define FOUNDATION_DEBUGMONOBEHAVIOUR_UPDATE_OFFSET UNITYSDK_OFFSET(0x1CC8E310)
#define FOUNDATION_DEBUGMONOBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC8E640)
#define FOUNDATION_DEBUGMONOBEHAVIOUR___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x1CC8E750)

namespace Foundation
{
	inline static constexpr unsigned int DebugMonoBehaviour_TypeDefinitionIndex = 8272;
