...
#define FOUNDATION_DUALQUATERNION_POLICY_FOUNDATION_IMAGNITUDEFUNC_UNITYENGINE_QUATERNION__MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x8E5D00)
#define FOUNDATION_DUALQUATERNION_POLICY_FOUNDATION_INEGATEFUNC_UNITYENGINE_QUATERNION__NEGATE_OFFSET UNITYSDK_OFFSET(0x8E5DB0)
#define FOUNDATION_DUALQUATERNION_POLICY_FOUNDATION_IPLUSFUNC_UNITYENGINE_QUATERNION__PLUS_OFFSET UNITYSDK_OFFSET(0x8E5C00)
#define FOUNDATION_DUALQUATERNION_POLICY_FOUNDATION_ISCALEFUNC_UNITYENGINE_QUATERNION__SCALE_OFFSET UNITYSDK_OFFSET(0x8E5C80)

namespace Foundation
{
	inline static constexpr unsigned int DualQuaternion_Policy_TypeDefinitionIndex = 8940;
