...
#define FOUNDATION_UTILITY_ENCODEBYTETOSTRINGASCII_OFFSET UNITYSDK_OFFSET(0x1F021E00)
#define FOUNDATION_UTILITY_ENCODESTRINGTOBYTEASCII_OFFSET UNITYSDK_OFFSET(0x1F021D50)
#define FOUNDATION_UTILITY_GETSTACKTRACE_OFFSET UNITYSDK_OFFSET(0x1F021BE0)
#define FOUNDATION_UTILITY_ISNAPQUICKSTARTGAMEMODE_OFFSET UNITYSDK_OFFSET(0x1F021BA0)

namespace Foundation
{
	inline static constexpr unsigned int Utility_TypeDefinitionIndex = 7869;
