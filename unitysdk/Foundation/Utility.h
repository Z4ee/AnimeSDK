...
#define FOUNDATION_UTILITY_ENCODEBYTETOSTRINGASCII_OFFSET UNITYSDK_OFFSET(0x1BD3D490)
#define FOUNDATION_UTILITY_ENCODESTRINGTOBYTEASCII_OFFSET UNITYSDK_OFFSET(0x1BD3D3E0)
#define FOUNDATION_UTILITY_GETSTACKTRACE_OFFSET UNITYSDK_OFFSET(0x1BD3D270)
#define FOUNDATION_UTILITY_ISNAPQUICKSTARTGAMEMODE_OFFSET UNITYSDK_OFFSET(0x1BD3D230)

namespace Foundation
{
	inline static constexpr unsigned int Utility_TypeDefinitionIndex = 8074;
