...
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_TEMPECSCOMPONENTCONTAINER_ADD_OFFSET UNITYSDK_OFFSET(0x1877F1F0)
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_TEMPECSCOMPONENTCONTAINER_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1877F130)
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_TEMPECSCOMPONENTCONTAINER_RESET_OFFSET UNITYSDK_OFFSET(0x1877F0C0)
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_TEMPECSCOMPONENTCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1877F2C0)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int EntityBuildContext_TempEcsComponentContainer_TypeDefinitionIndex = 55297;
