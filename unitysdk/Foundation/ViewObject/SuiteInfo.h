...
#define FOUNDATION_VIEWOBJECT_SUITEINFO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8018C0)
#define FOUNDATION_VIEWOBJECT_SUITEINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x801860)
#define FOUNDATION_VIEWOBJECT_SUITEINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8018D0)
#define FOUNDATION_VIEWOBJECT_SUITEINFO_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x1586CEE0)
#define FOUNDATION_VIEWOBJECT_SUITEINFO_GET_ISV1_OFFSET UNITYSDK_OFFSET(0x5882A0)
#define FOUNDATION_VIEWOBJECT_SUITEINFO_GET_ISV2_OFFSET UNITYSDK_OFFSET(0x5882B0)
#define FOUNDATION_VIEWOBJECT_SUITEINFO_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x801810)
#define FOUNDATION_VIEWOBJECT_SUITEINFO_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1586D0D0)
#define FOUNDATION_VIEWOBJECT_SUITEINFO_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1586D150)
#define FOUNDATION_VIEWOBJECT_SUITEINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x801920)
#define FOUNDATION_VIEWOBJECT_SUITEINFO___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x801930)
#define FOUNDATION_VIEWOBJECT_SUITEINFO___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x801990)
#define FOUNDATION_VIEWOBJECT_SUITEINFO___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8019F0)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int SuiteInfo_TypeDefinitionIndex = 49676;
