...
#define FOUNDATION_VIEWOBJECT_STRUCTURES_FSPLINESESSIONARGS_GET_VIEWOBJECTHANDLE_OFFSET UNITYSDK_OFFSET(0x3E4320)
#define FOUNDATION_VIEWOBJECT_STRUCTURES_FSPLINESESSIONARGS_SET_ENTITYHANDLE_OFFSET UNITYSDK_OFFSET(0x79F2D0)
#define FOUNDATION_VIEWOBJECT_STRUCTURES_FSPLINESESSIONARGS_SET_VIEWOBJECTHANDLE_OFFSET UNITYSDK_OFFSET(0x79F200)
#define FOUNDATION_VIEWOBJECT_STRUCTURES_FSPLINESESSIONARGS_WITHENTITYHANDLE_OFFSET UNITYSDK_OFFSET(0x79F320)
#define FOUNDATION_VIEWOBJECT_STRUCTURES_FSPLINESESSIONARGS_WITHVIEWOBJECTHANDLE_OFFSET UNITYSDK_OFFSET(0x79F2F0)

namespace Foundation::ViewObject::Structures
{
	inline static constexpr unsigned int FSplineSessionArgs_TypeDefinitionIndex = 49413;
