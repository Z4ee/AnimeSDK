...
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTLOADINGTASK_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x3C9DA0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTLOADINGTASK_SET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x3C9DB0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTLOADINGTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x351C10)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int ViewObjectLoadingTask_TypeDefinitionIndex = 64226;
