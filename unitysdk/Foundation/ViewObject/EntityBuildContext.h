...
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_CREATE_OFFSET UNITYSDK_OFFSET(0x1541A7F0)
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_DEBUGLOGVOENTITYCREATE_OFFSET UNITYSDK_OFFSET(0x1541A1A0)
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x81C570)
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_DUMPTOCOMPONENTLIST_OFFSET UNITYSDK_OFFSET(0x81C560)
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_GENERATECOMPONENTBYTRAIT_OFFSET UNITYSDK_OFFSET(0x81C4F0)
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_GENERATECOMPONENTBYVIEWOBJECTCONFIG_OFFSET UNITYSDK_OFFSET(0x81C500)
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_GENERATEENTITYHANDLE_OFFSET UNITYSDK_OFFSET(0x81C4D0)
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_GETNPCIDBYENTITY_OFFSET UNITYSDK_OFFSET(0x1541A1F0)
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_GET_OUTER_OFFSET UNITYSDK_OFFSET(0x81C4B0)
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_SETTYPE_OFFSET UNITYSDK_OFFSET(0x81C510)
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_SET_OUTER_OFFSET UNITYSDK_OFFSET(0x81C4C0)
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_VALIDATE_OFFSET UNITYSDK_OFFSET(0x81C580)
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1541ABD0)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int EntityBuildContext_TypeDefinitionIndex = 46981;

	struct alignas(8) EntityBuildContext
	{
		static ::System::Boolean* StaticGet_Debug_LogVoEntityCreate()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(EntityBuildContext_TypeDefinitionIndex)->GetStaticField(0x13650);
		}
		...
		*/
		...
		::System::Void GenerateComponentByViewObjectConfig(::Class_1_B85817849BC6CF88* configViewObject)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_B85817849BC6CF88*))((::PBYTE)hIl2Cpp + FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_GENERATECOMPONENTBYVIEWOBJECTCONFIG_OFFSET))(this, configViewObject);
		}
