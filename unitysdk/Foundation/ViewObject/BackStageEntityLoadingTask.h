...
#define FOUNDATION_VIEWOBJECT_BACKSTAGEENTITYLOADINGTASK_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x381840)
#define FOUNDATION_VIEWOBJECT_BACKSTAGEENTITYLOADINGTASK_SET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x381850)
#define FOUNDATION_VIEWOBJECT_BACKSTAGEENTITYLOADINGTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x2FE550)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int BackStageEntityLoadingTask_TypeDefinitionIndex = 50451;
