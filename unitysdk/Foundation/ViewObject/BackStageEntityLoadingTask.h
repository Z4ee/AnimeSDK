...
#define FOUNDATION_VIEWOBJECT_BACKSTAGEENTITYLOADINGTASK_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x3E3F20)
#define FOUNDATION_VIEWOBJECT_BACKSTAGEENTITYLOADINGTASK_SET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x446DB0)
#define FOUNDATION_VIEWOBJECT_BACKSTAGEENTITYLOADINGTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x3E3F10)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int BackStageEntityLoadingTask_TypeDefinitionIndex = 55022;
