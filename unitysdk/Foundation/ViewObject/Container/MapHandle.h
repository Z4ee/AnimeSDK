...
#define FOUNDATION_VIEWOBJECT_CONTAINER_MAPHANDLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x870820)
#define FOUNDATION_VIEWOBJECT_CONTAINER_MAPHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x8707D0)
#define FOUNDATION_VIEWOBJECT_CONTAINER_MAPHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x870830)
#define FOUNDATION_VIEWOBJECT_CONTAINER_MAPHANDLE_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x178A3E20)
#define FOUNDATION_VIEWOBJECT_CONTAINER_MAPHANDLE_ISVALID_OFFSET UNITYSDK_OFFSET(0x870780)
#define FOUNDATION_VIEWOBJECT_CONTAINER_MAPHANDLE___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x870880)
#define FOUNDATION_VIEWOBJECT_CONTAINER_MAPHANDLE___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8708E0)

namespace Foundation::ViewObject::Container
{
	inline static constexpr unsigned int MapHandle_TypeDefinitionIndex = 48605;
