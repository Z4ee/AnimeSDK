...
#define FOUNDATION_VIEWOBJECT_CONTAINER_MAPHANDLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x7FA920)
#define FOUNDATION_VIEWOBJECT_CONTAINER_MAPHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x7FA8D0)
#define FOUNDATION_VIEWOBJECT_CONTAINER_MAPHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7FA930)
#define FOUNDATION_VIEWOBJECT_CONTAINER_MAPHANDLE_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x154B66A0)
#define FOUNDATION_VIEWOBJECT_CONTAINER_MAPHANDLE_ISVALID_OFFSET UNITYSDK_OFFSET(0x7FA880)
#define FOUNDATION_VIEWOBJECT_CONTAINER_MAPHANDLE___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x7FA980)
#define FOUNDATION_VIEWOBJECT_CONTAINER_MAPHANDLE___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7FA9E0)

namespace Foundation::ViewObject::Container
{
	inline static constexpr unsigned int MapHandle_TypeDefinitionIndex = 44418;
