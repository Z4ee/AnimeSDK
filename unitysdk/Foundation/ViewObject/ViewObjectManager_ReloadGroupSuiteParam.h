...
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_RELOADGROUPSUITEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x13638710)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int ViewObjectManager_ReloadGroupSuiteParam_TypeDefinitionIndex = 66396;

	class ViewObjectManager_ReloadGroupSuiteParam : public ::Foundation::ViewObject::ViewObjectManager_ReloadParamBase
	{
	public:
		::System::UInt32 SuiteIndex; // 0x30
