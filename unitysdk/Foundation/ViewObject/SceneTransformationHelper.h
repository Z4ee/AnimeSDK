...
#define FOUNDATION_VIEWOBJECT_SCENETRANSFORMATIONHELPER_ADDSCENETRANSFORMATIONGROUP_OFFSET UNITYSDK_OFFSET(0x1503BE30)
#define FOUNDATION_VIEWOBJECT_SCENETRANSFORMATIONHELPER_REMOVESCENETRANSFORMATIONGROUP_OFFSET UNITYSDK_OFFSET(0x1503C0B0)
#define FOUNDATION_VIEWOBJECT_SCENETRANSFORMATIONHELPER_TRYGETSCENETRANSFORMATIONGROUPINFO_OFFSET UNITYSDK_OFFSET(0x1503C2A0)
#define FOUNDATION_VIEWOBJECT_SCENETRANSFORMATIONHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1503C3C0)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int SceneTransformationHelper_TypeDefinitionIndex = 53547;
