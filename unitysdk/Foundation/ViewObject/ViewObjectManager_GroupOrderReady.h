...
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY_CAREGROUPORDERVO_OFFSET UNITYSDK_OFFSET(0x803B90)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY_FINISH_OFFSET UNITYSDK_OFFSET(0x803B80)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY_GET_ISALLREADY_OFFSET UNITYSDK_OFFSET(0x803B50)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY_MARKVOREADY_OFFSET UNITYSDK_OFFSET(0x803C20)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY_SET_ISALLREADY_OFFSET UNITYSDK_OFFSET(0x803B60)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY_SHOOTCACHEVO_OFFSET UNITYSDK_OFFSET(0x803BB0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY_SKIPVO_OFFSET UNITYSDK_OFFSET(0x803C40)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY_UPDATECHECKALLREADY_OFFSET UNITYSDK_OFFSET(0x803BC0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY__CHECKALLREADY_OFFSET UNITYSDK_OFFSET(0x803C10)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY__CTOR_OFFSET UNITYSDK_OFFSET(0x803B70)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int ViewObjectManager_GroupOrderReady_TypeDefinitionIndex = 73616;
