...
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_RELOADGROUPPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x12E6D820)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int ViewObjectManager_ReloadGroupParam_TypeDefinitionIndex = 73602;
