...
#define FOUNDATION_VIEWOBJECT_GROUPVARIABLEHELPER__PUSHSINGLE_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x84D8D0)
#define FOUNDATION_VIEWOBJECT_GROUPVARIABLEHELPER__PUSHSINGLE_D__14_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x283610)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int GroupVariableHelper__PushSingle_d__14_TypeDefinitionIndex = 80465;
	...
	struct alignas(8) GroupVariableHelper__PushSingle_d__14
	{
		...
		::Cysharp::Threading::Tasks::UniTask_1_Awaiter<::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_0_16E4307DCC419505_33*>*> __u__1; // 0x48
