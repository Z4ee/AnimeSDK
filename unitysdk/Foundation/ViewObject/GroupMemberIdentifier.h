...
#define FOUNDATION_VIEWOBJECT_GROUPMEMBERIDENTIFIER_EQUALS_OFFSET UNITYSDK_OFFSET(0x8773A0)
#define FOUNDATION_VIEWOBJECT_GROUPMEMBERIDENTIFIER_GET_COMBINEMEMBERID_OFFSET UNITYSDK_OFFSET(0x8772E0)
#define FOUNDATION_VIEWOBJECT_GROUPMEMBERIDENTIFIER_GET_ISGROUP_OFFSET UNITYSDK_OFFSET(0x877380)
#define FOUNDATION_VIEWOBJECT_GROUPMEMBERIDENTIFIER_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x669870)
#define FOUNDATION_VIEWOBJECT_GROUPMEMBERIDENTIFIER_NEW_1_OFFSET UNITYSDK_OFFSET(0x17F29CF0)
#define FOUNDATION_VIEWOBJECT_GROUPMEMBERIDENTIFIER_NEW_2_OFFSET UNITYSDK_OFFSET(0x17F29D40)
#define FOUNDATION_VIEWOBJECT_GROUPMEMBERIDENTIFIER_NEW_OFFSET UNITYSDK_OFFSET(0x17F29CA0)
#define FOUNDATION_VIEWOBJECT_GROUPMEMBERIDENTIFIER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x877400)
#define FOUNDATION_VIEWOBJECT_GROUPMEMBERIDENTIFIER__CCTOR_OFFSET UNITYSDK_OFFSET(0x17F2A050)
#define FOUNDATION_VIEWOBJECT_GROUPMEMBERIDENTIFIER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x877390)
#define FOUNDATION_VIEWOBJECT_GROUPMEMBERIDENTIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x312BA0)
#define FOUNDATION_VIEWOBJECT_GROUPMEMBERIDENTIFIER___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x877410)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int GroupMemberIdentifier_TypeDefinitionIndex = 91401;

	struct alignas(4) GroupMemberIdentifier
	{
		static ::Il2CppArray<::System::Char>** StaticGet_seperator()
		{
			return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(GroupMemberIdentifier_TypeDefinitionIndex)->GetStaticField(0x38E30);
		}
