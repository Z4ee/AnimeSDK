...
#define FOUNDATION_VIEWOBJECT_SUBSYSTEM_GROUPSUITECHANGELISTENENTRY_CREATE_OFFSET UNITYSDK_OFFSET(0x148D8490)
#define FOUNDATION_VIEWOBJECT_SUBSYSTEM_GROUPSUITECHANGELISTENENTRY_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x803120)
#define FOUNDATION_VIEWOBJECT_SUBSYSTEM_GROUPSUITECHANGELISTENENTRY_EQUALS_OFFSET UNITYSDK_OFFSET(0x8030A0)
#define FOUNDATION_VIEWOBJECT_SUBSYSTEM_GROUPSUITECHANGELISTENENTRY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x803130)
#define FOUNDATION_VIEWOBJECT_SUBSYSTEM_GROUPSUITECHANGELISTENENTRY___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x8031B0)
#define FOUNDATION_VIEWOBJECT_SUBSYSTEM_GROUPSUITECHANGELISTENENTRY___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x803220)

namespace Foundation::ViewObject::Subsystem
{
	inline static constexpr unsigned int GroupSuiteChangeListenEntry_TypeDefinitionIndex = 45045;
