...
#define FOUNDATION_VIEWOBJECT_SUBSYSTEM_GROUPSUITEHELPER_ADDLISTENER_OFFSET UNITYSDK_OFFSET(0x11EB0ED0)
#define FOUNDATION_VIEWOBJECT_SUBSYSTEM_GROUPSUITEHELPER_CLEAR_OFFSET UNITYSDK_OFFSET(0x11EB0D90)
#define FOUNDATION_VIEWOBJECT_SUBSYSTEM_GROUPSUITEHELPER_GET_INS_OFFSET UNITYSDK_OFFSET(0x11EB0C90)
#define FOUNDATION_VIEWOBJECT_SUBSYSTEM_GROUPSUITEHELPER_NOTIFYSUITECHANGE_OFFSET UNITYSDK_OFFSET(0x11EB0FC0)
#define FOUNDATION_VIEWOBJECT_SUBSYSTEM_GROUPSUITEHELPER_REMOVELISTENER_OFFSET UNITYSDK_OFFSET(0x11EB0F40)
#define FOUNDATION_VIEWOBJECT_SUBSYSTEM_GROUPSUITEHELPER_TRYGETCURRENTSUITE_OFFSET UNITYSDK_OFFSET(0x11EB1570)
#define FOUNDATION_VIEWOBJECT_SUBSYSTEM_GROUPSUITEHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x11EB1620)

namespace Foundation::ViewObject::Subsystem
{
	inline static constexpr unsigned int GroupSuiteHelper_TypeDefinitionIndex = 80335;
	...
	public:
		...
		::Class_1_4BBF2D747CC2DDFA<::System::UInt32, ::Foundation::ViewObject::Subsystem::GroupSuiteChangeListenEntry>* _listeners; // 0x18
