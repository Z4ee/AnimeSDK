...
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTHANDLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x702EA0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x702DF0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x702EB0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTHANDLE_GET_EMPTYHANDLE_OFFSET UNITYSDK_OFFSET(0x10F1FEE0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTHANDLE_GET_ID_OFFSET UNITYSDK_OFFSET(0x702DA0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTHANDLE_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTHANDLE_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x702DB0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTHANDLE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x10F20250)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTHANDLE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x10F20340)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTHANDLE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x702D90)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x2AD810)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTHANDLE___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x702F20)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTHANDLE___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x702F90)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTHANDLE___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x702FF0)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int ViewObjectHandle_TypeDefinitionIndex = 48138;
