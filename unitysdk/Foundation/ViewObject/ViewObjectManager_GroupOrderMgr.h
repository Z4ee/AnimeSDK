...
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERMGR_CAREGROUPORDERVO_OFFSET UNITYSDK_OFFSET(0x7FAB80)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERMGR_GETCURRENTGROUPORDERREADYMAP_OFFSET UNITYSDK_OFFSET(0x7FAA90)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERMGR_GETFUNCTIONOPENFLAG_OFFSET UNITYSDK_OFFSET(0x7FABC0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERMGR_GET_CURFLAG_OFFSET UNITYSDK_OFFSET(0x32EC50)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERMGR_GROUPORDERWAIT_SETREADYVIEWOBJECT_OFFSET UNITYSDK_OFFSET(0x7FABA0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERMGR_MARKREADYGROUPID_OFFSET UNITYSDK_OFFSET(0x7FAAE0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERMGR_POSITIVECHECKGROUPREADY_OFFSET UNITYSDK_OFFSET(0x7FABD0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERMGR__CTOR_OFFSET UNITYSDK_OFFSET(0x7FAA80)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERMGR__SHOOTONEGROUP_OFFSET UNITYSDK_OFFSET(0x7FAB40)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int ViewObjectManager_GroupOrderMgr_TypeDefinitionIndex = 73613;
