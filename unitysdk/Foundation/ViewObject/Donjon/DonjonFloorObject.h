...
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECT_CLEARALLCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x15953F00)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECT_GET_DUNGEONID_OFFSET UNITYSDK_OFFSET(0x15953DA0)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECT_GET_ENABLE_OFFSET UNITYSDK_OFFSET(0x159545B0)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECT_GET_FLOORID_OFFSET UNITYSDK_OFFSET(0x15953DC0)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECT_GET_FLOORNAME_OFFSET UNITYSDK_OFFSET(0x15953DE0)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECT_GET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0x15953D80)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECT_INIT_OFFSET UNITYSDK_OFFSET(0x15953E00)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECT_INTERNALATTACHCOMPONENT_OFFSET UNITYSDK_OFFSET(0x15954280)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECT_INTERNALDETACHCOMPONENT_OFFSET UNITYSDK_OFFSET(0x15954390)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECT_INTERNALRECYCLECOMPONENT_OFFSET UNITYSDK_OFFSET(0x159544A0)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECT_NOTIFYCOMPONENTUPDATEENABLE_OFFSET UNITYSDK_OFFSET(0x15954680)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECT_RECYCLE_OFFSET UNITYSDK_OFFSET(0x15953E90)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECT_SET_DUNGEONID_OFFSET UNITYSDK_OFFSET(0x15953DB0)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECT_SET_ENABLE_OFFSET UNITYSDK_OFFSET(0x159545C0)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECT_SET_FLOORID_OFFSET UNITYSDK_OFFSET(0x15953DD0)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECT_SET_FLOORNAME_OFFSET UNITYSDK_OFFSET(0x15953DF0)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECT_SET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0x15953D90)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x15954700)

namespace Foundation::ViewObject::Donjon
{
	inline static constexpr unsigned int DonjonFloorObject_TypeDefinitionIndex = 48414;
	...
	public:
		...
		::System::Int32 _DungeonID_k__BackingField; // 0x2C
