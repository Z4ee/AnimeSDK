...
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORMUSTDATACOMPONENT_GET_BORNTELEPORTID_OFFSET UNITYSDK_OFFSET(0x132753C0)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORMUSTDATACOMPONENT_GET_FLOORID_OFFSET UNITYSDK_OFFSET(0x13275380)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORMUSTDATACOMPONENT_GET_FLOORNAME_OFFSET UNITYSDK_OFFSET(0x132753A0)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORMUSTDATACOMPONENT_INITDATA_OFFSET UNITYSDK_OFFSET(0x13275420)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORMUSTDATACOMPONENT_ONCREATE_OFFSET UNITYSDK_OFFSET(0x132753E0)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORMUSTDATACOMPONENT_ONRECYCLE_OFFSET UNITYSDK_OFFSET(0x13275480)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORMUSTDATACOMPONENT_SET_BORNTELEPORTID_OFFSET UNITYSDK_OFFSET(0x132753D0)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORMUSTDATACOMPONENT_SET_FLOORID_OFFSET UNITYSDK_OFFSET(0x13275390)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORMUSTDATACOMPONENT_SET_FLOORNAME_OFFSET UNITYSDK_OFFSET(0x132753B0)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORMUSTDATACOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x132754E0)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORMUSTDATACOMPONENT___BASE_ONCREATE_OFFSET UNITYSDK_OFFSET(0x13275500)

namespace Foundation::ViewObject::Donjon
{
	inline static constexpr unsigned int FloorMustDataComponent_TypeDefinitionIndex = 50540;
	...
	public:
		...
		::System::Int32 _bornTeleportID_k__BackingField; // 0x2C
