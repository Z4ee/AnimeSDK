...
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORMUSTDATACOMPONENT_GET_BORNTELEPORTID_OFFSET UNITYSDK_OFFSET(0x1503B000)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORMUSTDATACOMPONENT_GET_FLOORID_OFFSET UNITYSDK_OFFSET(0x1503AFC0)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORMUSTDATACOMPONENT_GET_FLOORNAME_OFFSET UNITYSDK_OFFSET(0x1503AFE0)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORMUSTDATACOMPONENT_INITDATA_OFFSET UNITYSDK_OFFSET(0x1503B060)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORMUSTDATACOMPONENT_ONCREATE_OFFSET UNITYSDK_OFFSET(0x1503B020)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORMUSTDATACOMPONENT_ONRECYCLE_OFFSET UNITYSDK_OFFSET(0x1503B0C0)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORMUSTDATACOMPONENT_SET_BORNTELEPORTID_OFFSET UNITYSDK_OFFSET(0x1503B010)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORMUSTDATACOMPONENT_SET_FLOORID_OFFSET UNITYSDK_OFFSET(0x1503AFD0)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORMUSTDATACOMPONENT_SET_FLOORNAME_OFFSET UNITYSDK_OFFSET(0x1503AFF0)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORMUSTDATACOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1503B120)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORMUSTDATACOMPONENT___BASE_ONCREATE_OFFSET UNITYSDK_OFFSET(0x1503B140)

namespace Foundation::ViewObject::Donjon
{
	inline static constexpr unsigned int FloorMustDataComponent_TypeDefinitionIndex = 58184;
