...
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOORMANAGER_CREATEDEFAULTFLOOROBJECT_OFFSET UNITYSDK_OFFSET(0x11EAF7E0)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOORMANAGER_CREATEFLOOROBJECT_OFFSET UNITYSDK_OFFSET(0x11EAF360)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOORMANAGER_CREATE_OFFSET UNITYSDK_OFFSET(0x11EAEC20)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOORMANAGER_DESTROYINSTANCE_OFFSET UNITYSDK_OFFSET(0x11EAEEE0)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOORMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11EAEF40)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOORMANAGER_GETDONJONFLOOROBJECT_OFFSET UNITYSDK_OFFSET(0x11EAF200)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOORMANAGER_GET_INS_OFFSET UNITYSDK_OFFSET(0x11EAEC10)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOORMANAGER_ONCREATE_OFFSET UNITYSDK_OFFSET(0x11EAEE10)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOORMANAGER_ONPOSTLEVELREADY_OFFSET UNITYSDK_OFFSET(0x11EAFFA0)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOORMANAGER_ONPOSTPREPAREENTERSCENE_OFFSET UNITYSDK_OFFSET(0x11EAFD60)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOORMANAGER_ONPREPAREENTERSCENE_OFFSET UNITYSDK_OFFSET(0x11EAFB20)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOORMANAGER_RECREATE_OFFSET UNITYSDK_OFFSET(0x11EAEE50)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOORMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x11EAF1A0)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOORMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x11EAED80)

namespace Foundation::ViewObject::Donjon
{
	inline static constexpr unsigned int DonjonFloorManager_TypeDefinitionIndex = 69031;
	...
	public:
		...
		{
			return (::Foundation::ViewObject::Donjon::DonjonFloorManager**)Il2CppClass::FromTypeDefinitionIndex(DonjonFloorManager_TypeDefinitionIndex)->GetStaticField(0x34250);
		}
