...
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORSTREAMINGLAYERLOADCOMPONENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x15954A80)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORSTREAMINGLAYERLOADCOMPONENT_ONRECYCLE_OFFSET UNITYSDK_OFFSET(0x15955170)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORSTREAMINGLAYERLOADCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x159551C0)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORSTREAMINGLAYERLOADCOMPONENT___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x159551E0)

namespace Foundation::ViewObject::Donjon
{
	inline static constexpr unsigned int FloorStreamingLayerLoadComponent_TypeDefinitionIndex = 83371;
