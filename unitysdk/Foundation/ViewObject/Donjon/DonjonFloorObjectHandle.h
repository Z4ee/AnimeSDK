...
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECTHANDLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x6EE8F0)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECTHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x6EE870)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECTHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x6EE900)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECTHANDLE_GET_DUNGEONID_OFFSET UNITYSDK_OFFSET(0x6EE7F0)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECTHANDLE_GET_EMPTYHANDLE_OFFSET UNITYSDK_OFFSET(0x1058FCB0)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECTHANDLE_GET_FLOORID_OFFSET UNITYSDK_OFFSET(0x6EE800)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECTHANDLE_GET_OFFSET UNITYSDK_OFFSET(0x6EE810)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECTHANDLE_ISVALID_OFFSET UNITYSDK_OFFSET(0x6EE7E0)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECTHANDLE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x10590870)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECTHANDLE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x10590930)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECTHANDLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x6EE7C0)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECTHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x6EE780)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECTHANDLE___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x6EE950)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECTHANDLE___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x6EE9C0)

namespace Foundation::ViewObject::Donjon
{
	inline static constexpr unsigned int DonjonFloorObjectHandle_TypeDefinitionIndex = 76926;
