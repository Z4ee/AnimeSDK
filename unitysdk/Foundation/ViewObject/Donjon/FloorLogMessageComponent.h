...
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORLOGMESSAGECOMPONENT_GET_MESSAGE_OFFSET UNITYSDK_OFFSET(0x11583A50)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORLOGMESSAGECOMPONENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x11583A70)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORLOGMESSAGECOMPONENT_ONRECYCLE_OFFSET UNITYSDK_OFFSET(0x11583AB0)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORLOGMESSAGECOMPONENT_SET_MESSAGE_OFFSET UNITYSDK_OFFSET(0x11583A60)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORLOGMESSAGECOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x11583B00)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORLOGMESSAGECOMPONENT___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x11583B20)

namespace Foundation::ViewObject::Donjon
{
	inline static constexpr unsigned int FloorLogMessageComponent_TypeDefinitionIndex = 61640;
