...
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORLOGMESSAGECOMPONENT_GET_MESSAGE_OFFSET UNITYSDK_OFFSET(0x148D6E00)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORLOGMESSAGECOMPONENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x148D6E20)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORLOGMESSAGECOMPONENT_ONRECYCLE_OFFSET UNITYSDK_OFFSET(0x148D6E60)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORLOGMESSAGECOMPONENT_SET_MESSAGE_OFFSET UNITYSDK_OFFSET(0x148D6E10)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORLOGMESSAGECOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x148D6EB0)
#define FOUNDATION_VIEWOBJECT_DONJON_FLOORLOGMESSAGECOMPONENT___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x148D6ED0)

namespace Foundation::ViewObject::Donjon
{
	inline static constexpr unsigned int FloorLogMessageComponent_TypeDefinitionIndex = 90988;
