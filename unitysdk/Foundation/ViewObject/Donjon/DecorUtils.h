...
#define FOUNDATION_VIEWOBJECT_DONJON_DECORUTILS_FOREACHDECOR_1_OFFSET UNITYSDK_OFFSET(0x1143A3C0)
#define FOUNDATION_VIEWOBJECT_DONJON_DECORUTILS_FOREACHDECOR_OFFSET UNITYSDK_OFFSET(0x1143A0D0)

namespace Foundation::ViewObject::Donjon
{
	inline static constexpr unsigned int DecorUtils_TypeDefinitionIndex = 41445;
