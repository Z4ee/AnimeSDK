...
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECTBUILDCONTEXT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14798930)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECTBUILDCONTEXT_GENERATECOMPONENTBYCONFIG_1_OFFSET UNITYSDK_OFFSET(0x14798A90)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECTBUILDCONTEXT_GENERATECOMPONENTBYCONFIG_2_OFFSET UNITYSDK_OFFSET(0x14798AF0)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECTBUILDCONTEXT_GENERATECOMPONENTBYCONFIG_OFFSET UNITYSDK_OFFSET(0x14798A30)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECTBUILDCONTEXT_GENERATEDONJONFLOOROBJECT_OFFSET UNITYSDK_OFFSET(0x14798B50)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECTBUILDCONTEXT_TRACKDECORTYPE_OFFSET UNITYSDK_OFFSET(0x147989E0)
#define FOUNDATION_VIEWOBJECT_DONJON_DONJONFLOOROBJECTBUILDCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x14798E20)

namespace Foundation::ViewObject::Donjon
{
	inline static constexpr unsigned int DonjonFloorObjectBuildContext_TypeDefinitionIndex = 76014;
	...
	public:
		...
		::System::Int32 DungeonID; // 0x18
		::System::Int32 FloorID; // 0x1C
