...
#define FOUNDATION_DOWNLOADDIFFPATCHER_DIFFFILECOLLECTRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x11EA8C70)

namespace Foundation
{
	inline static constexpr unsigned int DownloadDiffPatcher_DiffFileCollectResult_TypeDefinitionIndex = 52900;
	...
	public:
		...
		::System::String* diffFilePath; // 0x20
		::Struct_2_DAA84C1CDD754F37 verifyFilePickInfo; // 0x28
		::Foundation::ExceptionInfo* exception; // 0x70
