...
#define FOUNDATION_BYTESWRITER_WRITEBYTES_1_OFFSET UNITYSDK_OFFSET(0x1F780DC0)
#define FOUNDATION_BYTESWRITER_WRITEBYTES_2_OFFSET UNITYSDK_OFFSET(0x1F780EB0)
#define FOUNDATION_BYTESWRITER_WRITEBYTES_3_OFFSET UNITYSDK_OFFSET(0x1F780FA0)
#define FOUNDATION_BYTESWRITER_WRITEBYTES_4_OFFSET UNITYSDK_OFFSET(0x1F781090)
#define FOUNDATION_BYTESWRITER_WRITEBYTES_5_OFFSET UNITYSDK_OFFSET(0x1F781180)
#define FOUNDATION_BYTESWRITER_WRITEBYTES_OFFSET UNITYSDK_OFFSET(0x1F780CD0)
#define FOUNDATION_BYTESWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F781270)

namespace Foundation
{
	inline static constexpr unsigned int BytesWriter_TypeDefinitionIndex = 8302;
