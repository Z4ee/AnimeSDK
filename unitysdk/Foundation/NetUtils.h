...
#define FOUNDATION_NETUTILS_CRC32WITHSEED_1_OFFSET UNITYSDK_OFFSET(0x17FF8E20)
#define FOUNDATION_NETUTILS_CRC32WITHSEED_2_OFFSET UNITYSDK_OFFSET(0x17FF8ED0)
#define FOUNDATION_NETUTILS_CRC32WITHSEED_OFFSET UNITYSDK_OFFSET(0x17FF8C10)
#define FOUNDATION_NETUTILS_CRC32_1_OFFSET UNITYSDK_OFFSET(0x17FF8730)
#define FOUNDATION_NETUTILS_CRC32_2_OFFSET UNITYSDK_OFFSET(0x17FF8940)
#define FOUNDATION_NETUTILS_CRC32_3_OFFSET UNITYSDK_OFFSET(0x17FF86E0)
#define FOUNDATION_NETUTILS_CRC32_OFFSET UNITYSDK_OFFSET(0x17FF84F0)
#define FOUNDATION_NETUTILS_FINALURL_OFFSET UNITYSDK_OFFSET(0x17FF9970)
#define FOUNDATION_NETUTILS_GETBYTES_1_OFFSET UNITYSDK_OFFSET(0x17FF7800)
#define FOUNDATION_NETUTILS_GETBYTES_2_OFFSET UNITYSDK_OFFSET(0x17FF7880)
#define FOUNDATION_NETUTILS_GETBYTES_3_OFFSET UNITYSDK_OFFSET(0x17FF7900)
#define FOUNDATION_NETUTILS_GETBYTES_4_OFFSET UNITYSDK_OFFSET(0x17FF7980)
#define FOUNDATION_NETUTILS_GETBYTES_5_OFFSET UNITYSDK_OFFSET(0x17FF7BA0)
#define FOUNDATION_NETUTILS_GETBYTES_OFFSET UNITYSDK_OFFSET(0x17FF75F0)
#define FOUNDATION_NETUTILS_GETIPADDRESS_1_OFFSET UNITYSDK_OFFSET(0x17FF9140)
#define FOUNDATION_NETUTILS_GETIPADDRESS_OFFSET UNITYSDK_OFFSET(0x17FF9100)
#define FOUNDATION_NETUTILS_GETIPV6ADRESS_OFFSET UNITYSDK_OFFSET(0x17FF96E0)
#define FOUNDATION_NETUTILS_GETIPV6_OFFSET UNITYSDK_OFFSET(0x17FF9600)
#define FOUNDATION_NETUTILS_GET_ISIPV6_OFFSET UNITYSDK_OFFSET(0x17FF8F60)
#define FOUNDATION_NETUTILS_HOSTTONETWORKORDER_1_OFFSET UNITYSDK_OFFSET(0x17FF70E0)
#define FOUNDATION_NETUTILS_HOSTTONETWORKORDER_2_OFFSET UNITYSDK_OFFSET(0x17FF72A0)
#define FOUNDATION_NETUTILS_HOSTTONETWORKORDER_OFFSET UNITYSDK_OFFSET(0x17FF6F30)
#define FOUNDATION_NETUTILS_ISIPADRESS_OFFSET UNITYSDK_OFFSET(0x17FF9640)
#define FOUNDATION_NETUTILS_ISIPV6_OFFSET UNITYSDK_OFFSET(0x17FF8F80)
#define FOUNDATION_NETUTILS_NETWORKTOHOSTORDER_1_OFFSET UNITYSDK_OFFSET(0x17FF74F0)
#define FOUNDATION_NETUTILS_NETWORKTOHOSTORDER_2_OFFSET UNITYSDK_OFFSET(0x17FF7560)
#define FOUNDATION_NETUTILS_NETWORKTOHOSTORDER_OFFSET UNITYSDK_OFFSET(0x17FF7490)
#define FOUNDATION_NETUTILS_SET_ISIPV6_OFFSET UNITYSDK_OFFSET(0x17FF8F70)
#define FOUNDATION_NETUTILS_SIZEOF_1_OFFSET UNITYSDK_OFFSET(0x17FF7E00)
#define FOUNDATION_NETUTILS_SIZEOF_2_OFFSET UNITYSDK_OFFSET(0x17FF7E40)
#define FOUNDATION_NETUTILS_SIZEOF_3_OFFSET UNITYSDK_OFFSET(0x17FF7E80)
#define FOUNDATION_NETUTILS_SIZEOF_4_OFFSET UNITYSDK_OFFSET(0x17FF7EC0)
#define FOUNDATION_NETUTILS_SIZEOF_5_OFFSET UNITYSDK_OFFSET(0x17FF7F00)
#define FOUNDATION_NETUTILS_SIZEOF_6_OFFSET UNITYSDK_OFFSET(0x17FF7F40)
#define FOUNDATION_NETUTILS_SIZEOF_7_OFFSET UNITYSDK_OFFSET(0x17FF80F0)
#define FOUNDATION_NETUTILS_SIZEOF_OFFSET UNITYSDK_OFFSET(0x17FF7DC0)
#define FOUNDATION_NETUTILS_WRITEBYTESREVERSE_OFFSET UNITYSDK_OFFSET(0x17FF82A0)

namespace Foundation
{
	inline static constexpr unsigned int NetUtils_TypeDefinitionIndex = 8003;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(NetUtils_TypeDefinitionIndex)->GetStaticField(0x39F0);
		}
