...
#define FOUNDATION_PARALLELFILEVERIFIER_FILEINFOCHECKRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x114D44B0)

namespace Foundation
{
	inline static constexpr unsigned int ParallelFileVerifier_FileInfoCheckResult_TypeDefinitionIndex = 48095;
	...
	public:
		...
		::Foundation::ParallelFileVerifier_FileResult* PersistNew; // 0x20
		::Struct_2_DAA84C1CDD754F37 filePickInfo; // 0x28
		::Foundation::ExceptionInfo* errorInfo; // 0x70
		::Foundation::ParallelFileVerifier_FileResult* Persist; // 0x78
		::System::String* displayMsg; // 0x80
