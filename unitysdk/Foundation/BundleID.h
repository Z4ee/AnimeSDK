...
#define FOUNDATION_BUNDLEID_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9B9540)
#define FOUNDATION_BUNDLEID_EQUALS_OFFSET UNITYSDK_OFFSET(0x9B9460)
#define FOUNDATION_BUNDLEID_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9B9410)
#define FOUNDATION_BUNDLEID_ISVALID_OFFSET UNITYSDK_OFFSET(0x9B93C0)
#define FOUNDATION_BUNDLEID_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9B9590)
#define FOUNDATION_BUNDLEID__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D95C540)
#define FOUNDATION_BUNDLEID__CTOR_OFFSET UNITYSDK_OFFSET(0x324D50)
#define FOUNDATION_BUNDLEID___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x9B95A0)
#define FOUNDATION_BUNDLEID___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9B9600)
#define FOUNDATION_BUNDLEID___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9B9660)

namespace Foundation
{
	inline static constexpr unsigned int BundleID_TypeDefinitionIndex = 8032;

	struct alignas(8) BundleID
	{
		static ::Il2CppArray<::Foundation::BundleID>** StaticGet_EmptyArray()
		{
			return (::Il2CppArray<::Foundation::BundleID>**)Il2CppClass::FromTypeDefinitionIndex(BundleID_TypeDefinitionIndex)->GetStaticField(0x6D50);
		}
		static ::Foundation::BundleID* StaticGet_None()
		{
			return (::Foundation::BundleID*)Il2CppClass::FromTypeDefinitionIndex(BundleID_TypeDefinitionIndex)->GetStaticField(0x3700);
		}
