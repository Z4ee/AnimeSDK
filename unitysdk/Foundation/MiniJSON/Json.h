...
#define FOUNDATION_MINIJSON_JSON_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C1A7810)
#define FOUNDATION_MINIJSON_JSON_EATWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1C1A96C0)
#define FOUNDATION_MINIJSON_JSON_GETLASTERRORINDEX_OFFSET UNITYSDK_OFFSET(0x1C1A8170)
#define FOUNDATION_MINIJSON_JSON_GETLASTERRORSNIPPET_OFFSET UNITYSDK_OFFSET(0x1C1A81F0)
#define FOUNDATION_MINIJSON_JSON_GETLASTINDEXOFNUMBER_OFFSET UNITYSDK_OFFSET(0x1C1A9790)
#define FOUNDATION_MINIJSON_JSON_LASTDECODESUCCESSFUL_OFFSET UNITYSDK_OFFSET(0x1C1A80F0)
#define FOUNDATION_MINIJSON_JSON_LOOKAHEAD_OFFSET UNITYSDK_OFFSET(0x1C1A8A90)
#define FOUNDATION_MINIJSON_JSON_NEXTTOKEN_OFFSET UNITYSDK_OFFSET(0x1C1A8680)
#define FOUNDATION_MINIJSON_JSON_PARSEARRAY_OFFSET UNITYSDK_OFFSET(0x1C1A92D0)
#define FOUNDATION_MINIJSON_JSON_PARSENUMBER_OFFSET UNITYSDK_OFFSET(0x1C1A94C0)
#define FOUNDATION_MINIJSON_JSON_PARSEOBJECT_OFFSET UNITYSDK_OFFSET(0x1C1A83B0)
#define FOUNDATION_MINIJSON_JSON_PARSESTRING_OFFSET UNITYSDK_OFFSET(0x1C1A8B20)
#define FOUNDATION_MINIJSON_JSON_PARSEVALUE_OFFSET UNITYSDK_OFFSET(0x1C1A79D0)
#define FOUNDATION_MINIJSON_JSON_PRINTPRETTYTAB_OFFSET UNITYSDK_OFFSET(0x1C1AA670)
#define FOUNDATION_MINIJSON_JSON_SERIALIZEARRAY_OFFSET UNITYSDK_OFFSET(0x1C1AAC50)
#define FOUNDATION_MINIJSON_JSON_SERIALIZENUMBER_1_OFFSET UNITYSDK_OFFSET(0x1C1AB200)
#define FOUNDATION_MINIJSON_JSON_SERIALIZENUMBER_OFFSET UNITYSDK_OFFSET(0x1C1AB270)
#define FOUNDATION_MINIJSON_JSON_SERIALIZEOBJECT_OFFSET UNITYSDK_OFFSET(0x1C1A9870)
#define FOUNDATION_MINIJSON_JSON_SERIALIZESTRING_OFFSET UNITYSDK_OFFSET(0x1C1AA880)
#define FOUNDATION_MINIJSON_JSON_SERIALIZEVALUE_OFFSET UNITYSDK_OFFSET(0x1C1A7D60)
#define FOUNDATION_MINIJSON_JSON_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C1A7C40)
#define FOUNDATION_MINIJSON_JSON__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C1AB2F0)

namespace Foundation::MiniJSON
{
	inline static constexpr unsigned int Json_TypeDefinitionIndex = 8254;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Json_TypeDefinitionIndex)->GetStaticField(0x73E0);
		}
		static ::System::Int32* StaticGet_lastErrorIndex()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Json_TypeDefinitionIndex)->GetStaticField(0x39E0);
		}
		static ::System::Int32* StaticGet_tabCounter()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Json_TypeDefinitionIndex)->GetStaticField(0x39E4);
		}
		static ::System::Int32* StaticGet_tabSize()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Json_TypeDefinitionIndex)->GetStaticField(0x39E8);
		}
		static ::System::Boolean* StaticGet_PrettyPrint()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Json_TypeDefinitionIndex)->GetStaticField(0x39EC);
		}
