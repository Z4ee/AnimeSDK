...
#define FOUNDATION_MINIJSON_JSON_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1F7815F0)
#define FOUNDATION_MINIJSON_JSON_EATWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1F783230)
#define FOUNDATION_MINIJSON_JSON_GETLASTERRORINDEX_OFFSET UNITYSDK_OFFSET(0x1F781F20)
#define FOUNDATION_MINIJSON_JSON_GETLASTERRORSNIPPET_OFFSET UNITYSDK_OFFSET(0x1F781FA0)
#define FOUNDATION_MINIJSON_JSON_GETLASTINDEXOFNUMBER_OFFSET UNITYSDK_OFFSET(0x1F783300)
#define FOUNDATION_MINIJSON_JSON_LASTDECODESUCCESSFUL_OFFSET UNITYSDK_OFFSET(0x1F781EA0)
#define FOUNDATION_MINIJSON_JSON_LOOKAHEAD_OFFSET UNITYSDK_OFFSET(0x1F782730)
#define FOUNDATION_MINIJSON_JSON_NEXTTOKEN_OFFSET UNITYSDK_OFFSET(0x1F782420)
#define FOUNDATION_MINIJSON_JSON_PARSEARRAY_OFFSET UNITYSDK_OFFSET(0x1F782E40)
#define FOUNDATION_MINIJSON_JSON_PARSENUMBER_OFFSET UNITYSDK_OFFSET(0x1F783030)
#define FOUNDATION_MINIJSON_JSON_PARSEOBJECT_OFFSET UNITYSDK_OFFSET(0x1F782160)
#define FOUNDATION_MINIJSON_JSON_PARSESTRING_OFFSET UNITYSDK_OFFSET(0x1F7827C0)
#define FOUNDATION_MINIJSON_JSON_PARSEVALUE_OFFSET UNITYSDK_OFFSET(0x1F7817B0)
#define FOUNDATION_MINIJSON_JSON_PRINTPRETTYTAB_OFFSET UNITYSDK_OFFSET(0x1F784210)
#define FOUNDATION_MINIJSON_JSON_SERIALIZEARRAY_OFFSET UNITYSDK_OFFSET(0x1F784770)
#define FOUNDATION_MINIJSON_JSON_SERIALIZENUMBER_1_OFFSET UNITYSDK_OFFSET(0x1F784D30)
#define FOUNDATION_MINIJSON_JSON_SERIALIZENUMBER_OFFSET UNITYSDK_OFFSET(0x1F784DA0)
#define FOUNDATION_MINIJSON_JSON_SERIALIZEOBJECT_OFFSET UNITYSDK_OFFSET(0x1F7833E0)
#define FOUNDATION_MINIJSON_JSON_SERIALIZESTRING_OFFSET UNITYSDK_OFFSET(0x1F784400)
#define FOUNDATION_MINIJSON_JSON_SERIALIZEVALUE_OFFSET UNITYSDK_OFFSET(0x1F781B10)
#define FOUNDATION_MINIJSON_JSON_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1F7819F0)
#define FOUNDATION_MINIJSON_JSON__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F784E20)

namespace Foundation::MiniJSON
{
	inline static constexpr unsigned int Json_TypeDefinitionIndex = 8319;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Json_TypeDefinitionIndex)->GetStaticField(0x72B0);
		}
		static ::System::Boolean* StaticGet_PrettyPrint()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Json_TypeDefinitionIndex)->GetStaticField(0x3880);
		}
		static ::System::Int32* StaticGet_tabSize()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Json_TypeDefinitionIndex)->GetStaticField(0x3884);
		}
		static ::System::Int32* StaticGet_tabCounter()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Json_TypeDefinitionIndex)->GetStaticField(0x3888);
		}
		static ::System::Int32* StaticGet_lastErrorIndex()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Json_TypeDefinitionIndex)->GetStaticField(0x388C);
		}
