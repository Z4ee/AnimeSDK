...
#define FOUNDATION_ULONGSERIALIZABLE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1F698AB0)
#define FOUNDATION_ULONGSERIALIZABLE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1F698B50)
#define FOUNDATION_ULONGSERIALIZABLE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1F698BB0)
#define FOUNDATION_ULONGSERIALIZABLE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1F698AC0)
#define FOUNDATION_ULONGSERIALIZABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F698C10)

namespace Foundation
{
	inline static constexpr unsigned int UlongSerializable_TypeDefinitionIndex = 8193;
