...
#define FOUNDATION_ASSETREQUESTHANDLE_ADDCOMPLETECALLBACKWITHUSERDATA_OFFSET UNITYSDK_OFFSET(0x8AA830)
#define FOUNDATION_ASSETREQUESTHANDLE_ADDCOMPLETECALLBACK_OFFSET UNITYSDK_OFFSET(0x8AA7B0)
#define FOUNDATION_ASSETREQUESTHANDLE_ADDDESTROYCALLBACK_OFFSET UNITYSDK_OFFSET(0x8AA9B0)
#define FOUNDATION_ASSETREQUESTHANDLE_ADDPOOLINSTANCE_OFFSET UNITYSDK_OFFSET(0x8AAFC0)
#define FOUNDATION_ASSETREQUESTHANDLE_ADDREFERENCE_OFFSET UNITYSDK_OFFSET(0x8AB2D0)
#define FOUNDATION_ASSETREQUESTHANDLE_CLEARINSTANCES_OFFSET UNITYSDK_OFFSET(0x8AAEE0)
#define FOUNDATION_ASSETREQUESTHANDLE_CLEARPOOLINSTANCES_OFFSET UNITYSDK_OFFSET(0x8AB040)
#define FOUNDATION_ASSETREQUESTHANDLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8AA570)
#define FOUNDATION_ASSETREQUESTHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x8AA490)
#define FOUNDATION_ASSETREQUESTHANDLE_ERROR_OFFSET UNITYSDK_OFFSET(0x8AAB20)
#define FOUNDATION_ASSETREQUESTHANDLE_GENERATE_OFFSET UNITYSDK_OFFSET(0x19D9CB70)
#define FOUNDATION_ASSETREQUESTHANDLE_GETASSETINSTANCEREQUEST_OFFSET UNITYSDK_OFFSET(0x8AA7A0)
#define FOUNDATION_ASSETREQUESTHANDLE_GETASSETREQUEST_OFFSET UNITYSDK_OFFSET(0x8AA790)
#define FOUNDATION_ASSETREQUESTHANDLE_GETASSET_OFFSET UNITYSDK_OFFSET(0x8AAB80)
#define FOUNDATION_ASSETREQUESTHANDLE_GETCHECKERLOADSTACK_OFFSET UNITYSDK_OFFSET(0x8AB290)
#define FOUNDATION_ASSETREQUESTHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8AA440)
#define FOUNDATION_ASSETREQUESTHANDLE_GETINSTANCEASYNC_OFFSET UNITYSDK_OFFSET(0x8AAE00)
#define FOUNDATION_ASSETREQUESTHANDLE_GETINSTANCESCOUNT_OFFSET UNITYSDK_OFFSET(0x8AAF50)
#define FOUNDATION_ASSETREQUESTHANDLE_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x8AAD20)
#define FOUNDATION_ASSETREQUESTHANDLE_GETPOOLINSTANCESCOUNT_OFFSET UNITYSDK_OFFSET(0x8AB0B0)
#define FOUNDATION_ASSETREQUESTHANDLE_GETSTATUS_OFFSET UNITYSDK_OFFSET(0x8AAC50)
#define FOUNDATION_ASSETREQUESTHANDLE_ISDONE_OFFSET UNITYSDK_OFFSET(0x8AABE0)
#define FOUNDATION_ASSETREQUESTHANDLE_ISUNUSED_OFFSET UNITYSDK_OFFSET(0x8AB210)
#define FOUNDATION_ASSETREQUESTHANDLE_ISVALID_OFFSET UNITYSDK_OFFSET(0x8AA660)
#define FOUNDATION_ASSETREQUESTHANDLE_LOADIMMEDIATE_OFFSET UNITYSDK_OFFSET(0x8AACB0)
#define FOUNDATION_ASSETREQUESTHANDLE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x19D9CE30)
#define FOUNDATION_ASSETREQUESTHANDLE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x19D9D1F0)
#define FOUNDATION_ASSETREQUESTHANDLE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x19D9CEA0)
#define FOUNDATION_ASSETREQUESTHANDLE_RELEASECALLBACKNOTUNLOAD_OFFSET UNITYSDK_OFFSET(0x8AA680)
#define FOUNDATION_ASSETREQUESTHANDLE_REMOVECOMPLETECALLBACK_1_OFFSET UNITYSDK_OFFSET(0x8AA940)
#define FOUNDATION_ASSETREQUESTHANDLE_REMOVECOMPLETECALLBACK_OFFSET UNITYSDK_OFFSET(0x8AA8C0)
#define FOUNDATION_ASSETREQUESTHANDLE_REMOVEDESTROYCALLBACK_1_OFFSET UNITYSDK_OFFSET(0x8AAAB0)
#define FOUNDATION_ASSETREQUESTHANDLE_REMOVEDESTROYCALLBACK_OFFSET UNITYSDK_OFFSET(0x8AAA30)
#define FOUNDATION_ASSETREQUESTHANDLE_SCENENAME_OFFSET UNITYSDK_OFFSET(0x8AB280)
#define FOUNDATION_ASSETREQUESTHANDLE_SETUNLOADSCENECOMPLETED_OFFSET UNITYSDK_OFFSET(0x8AB120)
#define FOUNDATION_ASSETREQUESTHANDLE_SUBREFERENCE_OFFSET UNITYSDK_OFFSET(0x8AB2F0)
#define FOUNDATION_ASSETREQUESTHANDLE_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x8AA600)
#define FOUNDATION_ASSETREQUESTHANDLE_SYSTEM_COLLECTIONS_IENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x8AA610)
#define FOUNDATION_ASSETREQUESTHANDLE_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x8AA620)
#define FOUNDATION_ASSETREQUESTHANDLE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8AA5F0)
#define FOUNDATION_ASSETREQUESTHANDLE_TRYGETASSETREQUEST_OFFSET UNITYSDK_OFFSET(0x8AA720)
#define FOUNDATION_ASSETREQUESTHANDLE_UNLOAD_OFFSET UNITYSDK_OFFSET(0x8AA670)
#define FOUNDATION_ASSETREQUESTHANDLE_URL_OFFSET UNITYSDK_OFFSET(0x8AB130)
#define FOUNDATION_ASSETREQUESTHANDLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x19D9E740)
#define FOUNDATION_ASSETREQUESTHANDLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8AB2A0)
#define FOUNDATION_ASSETREQUESTHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x8AA410)
#define FOUNDATION_ASSETREQUESTHANDLE___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x8AB300)
#define FOUNDATION_ASSETREQUESTHANDLE___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8AB370)
#define FOUNDATION_ASSETREQUESTHANDLE___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8AB3E0)

namespace Foundation
{
	inline static constexpr unsigned int AssetRequestHandle_TypeDefinitionIndex = 8044;

	struct alignas(8) AssetRequestHandle
	{
		static ::Foundation::AssetRequestHandle* StaticGet_None()
		{
			return (::Foundation::AssetRequestHandle*)Il2CppClass::FromTypeDefinitionIndex(AssetRequestHandle_TypeDefinitionIndex)->GetStaticField(0x67A0);
		}
		static ::System::UInt32* StaticGet_gHandle()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(AssetRequestHandle_TypeDefinitionIndex)->GetStaticField(0x3530);
		}
