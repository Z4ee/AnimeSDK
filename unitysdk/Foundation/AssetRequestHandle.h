...
#define FOUNDATION_ASSETREQUESTHANDLE_ADDCOMPLETECALLBACKWITHUSERDATA_OFFSET UNITYSDK_OFFSET(0x9A17D0)
#define FOUNDATION_ASSETREQUESTHANDLE_ADDCOMPLETECALLBACK_OFFSET UNITYSDK_OFFSET(0x9A1750)
#define FOUNDATION_ASSETREQUESTHANDLE_ADDDESTROYCALLBACK_OFFSET UNITYSDK_OFFSET(0x9A1950)
#define FOUNDATION_ASSETREQUESTHANDLE_ADDPOOLINSTANCE_OFFSET UNITYSDK_OFFSET(0x9A1F60)
#define FOUNDATION_ASSETREQUESTHANDLE_ADDREFERENCE_OFFSET UNITYSDK_OFFSET(0x9A2270)
#define FOUNDATION_ASSETREQUESTHANDLE_CLEARINSTANCES_OFFSET UNITYSDK_OFFSET(0x9A1E80)
#define FOUNDATION_ASSETREQUESTHANDLE_CLEARPOOLINSTANCES_OFFSET UNITYSDK_OFFSET(0x9A1FE0)
#define FOUNDATION_ASSETREQUESTHANDLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9A1510)
#define FOUNDATION_ASSETREQUESTHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x9A1430)
#define FOUNDATION_ASSETREQUESTHANDLE_ERROR_OFFSET UNITYSDK_OFFSET(0x9A1AC0)
#define FOUNDATION_ASSETREQUESTHANDLE_GENERATE_OFFSET UNITYSDK_OFFSET(0x1D58B2A0)
#define FOUNDATION_ASSETREQUESTHANDLE_GETASSETINSTANCEREQUEST_OFFSET UNITYSDK_OFFSET(0x9A1740)
#define FOUNDATION_ASSETREQUESTHANDLE_GETASSETREQUEST_OFFSET UNITYSDK_OFFSET(0x9A1730)
#define FOUNDATION_ASSETREQUESTHANDLE_GETASSET_OFFSET UNITYSDK_OFFSET(0x9A1B20)
#define FOUNDATION_ASSETREQUESTHANDLE_GETCHECKERLOADSTACK_OFFSET UNITYSDK_OFFSET(0x9A2230)
#define FOUNDATION_ASSETREQUESTHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9A13E0)
#define FOUNDATION_ASSETREQUESTHANDLE_GETINSTANCEASYNC_OFFSET UNITYSDK_OFFSET(0x9A1DA0)
#define FOUNDATION_ASSETREQUESTHANDLE_GETINSTANCESCOUNT_OFFSET UNITYSDK_OFFSET(0x9A1EF0)
#define FOUNDATION_ASSETREQUESTHANDLE_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x9A1CC0)
#define FOUNDATION_ASSETREQUESTHANDLE_GETPOOLINSTANCESCOUNT_OFFSET UNITYSDK_OFFSET(0x9A2050)
#define FOUNDATION_ASSETREQUESTHANDLE_GETSTATUS_OFFSET UNITYSDK_OFFSET(0x9A1BF0)
#define FOUNDATION_ASSETREQUESTHANDLE_ISDONE_OFFSET UNITYSDK_OFFSET(0x9A1B80)
#define FOUNDATION_ASSETREQUESTHANDLE_ISUNUSED_OFFSET UNITYSDK_OFFSET(0x9A21B0)
#define FOUNDATION_ASSETREQUESTHANDLE_ISVALID_OFFSET UNITYSDK_OFFSET(0x9A1600)
#define FOUNDATION_ASSETREQUESTHANDLE_LOADIMMEDIATE_OFFSET UNITYSDK_OFFSET(0x9A1C50)
#define FOUNDATION_ASSETREQUESTHANDLE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1D58B550)
#define FOUNDATION_ASSETREQUESTHANDLE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1D58B910)
#define FOUNDATION_ASSETREQUESTHANDLE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1D58B5C0)
#define FOUNDATION_ASSETREQUESTHANDLE_RELEASECALLBACKNOTUNLOAD_OFFSET UNITYSDK_OFFSET(0x9A1620)
#define FOUNDATION_ASSETREQUESTHANDLE_REMOVECOMPLETECALLBACK_1_OFFSET UNITYSDK_OFFSET(0x9A18E0)
#define FOUNDATION_ASSETREQUESTHANDLE_REMOVECOMPLETECALLBACK_OFFSET UNITYSDK_OFFSET(0x9A1860)
#define FOUNDATION_ASSETREQUESTHANDLE_REMOVEDESTROYCALLBACK_1_OFFSET UNITYSDK_OFFSET(0x9A1A50)
#define FOUNDATION_ASSETREQUESTHANDLE_REMOVEDESTROYCALLBACK_OFFSET UNITYSDK_OFFSET(0x9A19D0)
#define FOUNDATION_ASSETREQUESTHANDLE_SCENENAME_OFFSET UNITYSDK_OFFSET(0x9A2220)
#define FOUNDATION_ASSETREQUESTHANDLE_SETUNLOADSCENECOMPLETED_OFFSET UNITYSDK_OFFSET(0x9A20C0)
#define FOUNDATION_ASSETREQUESTHANDLE_SUBREFERENCE_OFFSET UNITYSDK_OFFSET(0x9A2290)
#define FOUNDATION_ASSETREQUESTHANDLE_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x9A15A0)
#define FOUNDATION_ASSETREQUESTHANDLE_SYSTEM_COLLECTIONS_IENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x9A15B0)
#define FOUNDATION_ASSETREQUESTHANDLE_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x9A15C0)
#define FOUNDATION_ASSETREQUESTHANDLE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9A1590)
#define FOUNDATION_ASSETREQUESTHANDLE_TRYGETASSETREQUEST_OFFSET UNITYSDK_OFFSET(0x9A16C0)
#define FOUNDATION_ASSETREQUESTHANDLE_UNLOAD_OFFSET UNITYSDK_OFFSET(0x9A1610)
#define FOUNDATION_ASSETREQUESTHANDLE_URL_OFFSET UNITYSDK_OFFSET(0x9A20D0)
#define FOUNDATION_ASSETREQUESTHANDLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D58CE60)
#define FOUNDATION_ASSETREQUESTHANDLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9A2240)
#define FOUNDATION_ASSETREQUESTHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x9A13B0)
#define FOUNDATION_ASSETREQUESTHANDLE___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x9A22A0)
#define FOUNDATION_ASSETREQUESTHANDLE___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9A2310)
#define FOUNDATION_ASSETREQUESTHANDLE___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9A2380)

namespace Foundation
{
	inline static constexpr unsigned int AssetRequestHandle_TypeDefinitionIndex = 8080;

	struct alignas(8) AssetRequestHandle
	{
		static ::Foundation::AssetRequestHandle* StaticGet_None()
		{
			return (::Foundation::AssetRequestHandle*)Il2CppClass::FromTypeDefinitionIndex(AssetRequestHandle_TypeDefinitionIndex)->GetStaticField(0x6810);
		}
		static ::System::UInt32* StaticGet_gHandle()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(AssetRequestHandle_TypeDefinitionIndex)->GetStaticField(0x3560);
		}
