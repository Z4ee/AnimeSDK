...
#define FOUNDATION_ASSETPOOLEDITORMODE_ADDINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x1BFD7260)
#define FOUNDATION_ASSETPOOLEDITORMODE_ADDINSTANCE_OFFSET UNITYSDK_OFFSET(0x1BFD71D0)
#define FOUNDATION_ASSETPOOLEDITORMODE_APPLICATIONONLOWMEMORY_OFFSET UNITYSDK_OFFSET(0x1BFD7190)
#define FOUNDATION_ASSETPOOLEDITORMODE_GETINSTANCEASYNC_1_OFFSET UNITYSDK_OFFSET(0x1BFD7510)
#define FOUNDATION_ASSETPOOLEDITORMODE_GETINSTANCEASYNC_OFFSET UNITYSDK_OFFSET(0x1BFD73F0)
#define FOUNDATION_ASSETPOOLEDITORMODE_GETINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x1BFD7760)
#define FOUNDATION_ASSETPOOLEDITORMODE_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1BFD7670)
#define FOUNDATION_ASSETPOOLEDITORMODE_INITINSTANTIATEDPREVIEWRECURSIVE_OFFSET UNITYSDK_OFFSET(0x1BFD79A0)
#define FOUNDATION_ASSETPOOLEDITORMODE_INTERNALDESTROY_OFFSET UNITYSDK_OFFSET(0x1BFD7360)
#define FOUNDATION_ASSETPOOLEDITORMODE_RELEASE_OFFSET UNITYSDK_OFFSET(0x1BFD7960)
#define FOUNDATION_ASSETPOOLEDITORMODE_UNLOAD_1_OFFSET UNITYSDK_OFFSET(0x1BFD7D90)
#define FOUNDATION_ASSETPOOLEDITORMODE_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1BFD7D40)
#define FOUNDATION_ASSETPOOLEDITORMODE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BFD7DE0)
#define FOUNDATION_ASSETPOOLEDITORMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFD7180)

namespace Foundation
{
	inline static constexpr unsigned int AssetPoolEditorMode_TypeDefinitionIndex = 8106;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AssetPoolEditorMode_TypeDefinitionIndex)->GetStaticField(0x38D0);
		}
