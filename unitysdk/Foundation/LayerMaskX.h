...
#define FOUNDATION_LAYERMASKX_ADDTOMASK_OFFSET UNITYSDK_OFFSET(0x1F01B900)
#define FOUNDATION_LAYERMASKX_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1F01B660)
#define FOUNDATION_LAYERMASKX_CREATE_OFFSET UNITYSDK_OFFSET(0x1F01B570)
#define FOUNDATION_LAYERMASKX_INVERSE_OFFSET UNITYSDK_OFFSET(0x1F01B8C0)
#define FOUNDATION_LAYERMASKX_ISINLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1F01BCD0)
#define FOUNDATION_LAYERMASKX_LAYERNUMBERSTOMASK_OFFSET UNITYSDK_OFFSET(0x1F01B7A0)
#define FOUNDATION_LAYERMASKX_MASKTONAMES_OFFSET UNITYSDK_OFFSET(0x1F01B9A0)
#define FOUNDATION_LAYERMASKX_MASKTOSTRING_1_OFFSET UNITYSDK_OFFSET(0x1F01BC20)
#define FOUNDATION_LAYERMASKX_MASKTOSTRING_OFFSET UNITYSDK_OFFSET(0x1F01BB10)
#define FOUNDATION_LAYERMASKX_NAMESTOMASK_OFFSET UNITYSDK_OFFSET(0x1F01B5C0)
#define FOUNDATION_LAYERMASKX_REMOVEFROMMASK_OFFSET UNITYSDK_OFFSET(0x1F01B950)

namespace Foundation
{
	inline static constexpr unsigned int LayerMaskX_TypeDefinitionIndex = 8349;
