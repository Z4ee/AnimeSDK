...
#define FOUNDATION_DOWNLOADDIFFPATCHER_DIFFRESULT_GET_COLLECTRESULT_OFFSET UNITYSDK_OFFSET(0x12A39A30)
#define FOUNDATION_DOWNLOADDIFFPATCHER_DIFFRESULT_GET_EXCEPTIONINFO_OFFSET UNITYSDK_OFFSET(0x12A39A90)
#define FOUNDATION_DOWNLOADDIFFPATCHER_DIFFRESULT_GET_MOVERESULT_OFFSET UNITYSDK_OFFSET(0x12A39A50)
#define FOUNDATION_DOWNLOADDIFFPATCHER_DIFFRESULT_GET_PATCHRESULT_OFFSET UNITYSDK_OFFSET(0x12A39A70)
#define FOUNDATION_DOWNLOADDIFFPATCHER_DIFFRESULT_SET_COLLECTRESULT_OFFSET UNITYSDK_OFFSET(0x12A39A40)
#define FOUNDATION_DOWNLOADDIFFPATCHER_DIFFRESULT_SET_MOVERESULT_OFFSET UNITYSDK_OFFSET(0x12A39A60)
#define FOUNDATION_DOWNLOADDIFFPATCHER_DIFFRESULT_SET_PATCHRESULT_OFFSET UNITYSDK_OFFSET(0x12A39A80)
#define FOUNDATION_DOWNLOADDIFFPATCHER_DIFFRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x12A39B10)

namespace Foundation
{
	inline static constexpr unsigned int DownloadDiffPatcher_DiffResult_TypeDefinitionIndex = 80181;

	class DownloadDiffPatcher_DiffResult : public ::System::Object
	{
	public:
		::Foundation::DownloadDiffPatcher_DiffFileMoveResult* _MoveResult_k__BackingField; // 0x10
		::Foundation::DownloadDiffPatcher_DiffFilePatchResult* _PatchResult_k__BackingField; // 0x18
