...
#define CLASS_1_78C2963AC589BAA9__CTOR_OFFSET UNITYSDK_OFFSET(0x1DBF2D60)
...
{
public:
	::RPG::GameCore::MarbleShapeType EDONJJDPDCD; // 0x10
	::System::Single IDKONBFPBLH; // 0x14
	::RPG::GameCore::MarbleItemType LINLNNHIBAK; // 0x18
