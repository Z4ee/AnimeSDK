...
#define CLASS_2_E5A99CD0EA723FEC_METHOD_2_0E5AEC953C77273E_OFFSET UNITYSDK_OFFSET(0x14C45860)
#define CLASS_2_E5A99CD0EA723FEC_METHOD_2_5262BC49EFD121F6_OFFSET UNITYSDK_OFFSET(0x14C45420)
#define CLASS_2_E5A99CD0EA723FEC_METHOD_2_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x14C45090)
#define CLASS_2_E5A99CD0EA723FEC_METHOD_2_A7F8207BBA14FDCD_OFFSET UNITYSDK_OFFSET(0x14C45190)
#define CLASS_2_E5A99CD0EA723FEC_METHOD_2_B4A91A4ACDF9D75F_OFFSET UNITYSDK_OFFSET(0x14C45110)
#define CLASS_2_E5A99CD0EA723FEC__CCTOR_OFFSET UNITYSDK_OFFSET(0x14C45B20)
#define CLASS_2_E5A99CD0EA723FEC__CTOR_OFFSET UNITYSDK_OFFSET(0x14C45100)
...
public:
	...
	{
		return (::Class_2_E5A99CD0EA723FEC**)Il2CppClass::FromTypeDefinitionIndex(Class_2_E5A99CD0EA723FEC_TypeDefinitionIndex)->GetStaticField(0x40210);
	}
	::Class_1_2670985A37556FEA* KBIPBKEGLCC; // 0x10
	::System::Collections::Generic::IDictionary_2<::System::String*, ::RPG::GameCore::FixPoint>* CCLGKDICBNH; // 0x18
