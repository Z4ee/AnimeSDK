...
#define PLUGINMSGRECEIVER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1BE65970)
#define PLUGINMSGRECEIVER_SENDPLUGINMSG_OFFSET UNITYSDK_OFFSET(0x1BE65A30)
#define PLUGINMSGRECEIVER_START_OFFSET UNITYSDK_OFFSET(0x1BE658B0)
#define PLUGINMSGRECEIVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE65B90)
