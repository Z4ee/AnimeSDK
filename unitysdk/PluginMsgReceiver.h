...
#define PLUGINMSGRECEIVER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x164240F0)
#define PLUGINMSGRECEIVER_SENDPLUGINMSG_OFFSET UNITYSDK_OFFSET(0x164241B0)
#define PLUGINMSGRECEIVER_START_OFFSET UNITYSDK_OFFSET(0x16424030)
#define PLUGINMSGRECEIVER__CTOR_OFFSET UNITYSDK_OFFSET(0x16424310)

inline static constexpr unsigned int PluginMsgReceiver_TypeDefinitionIndex = 31924;
