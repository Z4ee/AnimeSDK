...
#define COUNTDOWNNUMBERMATERIALANIMCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1907C8B0)
#define COUNTDOWNNUMBERMATERIALANIMCONTROLLER_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x1907D050)
#define COUNTDOWNNUMBERMATERIALANIMCONTROLLER_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x1907C970)
#define COUNTDOWNNUMBERMATERIALANIMCONTROLLER_UPDATEMATERIALPROPS_OFFSET UNITYSDK_OFFSET(0x1907D220)
#define COUNTDOWNNUMBERMATERIALANIMCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1907D0B0)
#define COUNTDOWNNUMBERMATERIALANIMCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1907D6F0)

inline static constexpr unsigned int CountDownNumberMaterialAnimController_TypeDefinitionIndex = 29499;
