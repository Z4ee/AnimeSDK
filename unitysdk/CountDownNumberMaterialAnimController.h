...
#define COUNTDOWNNUMBERMATERIALANIMCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C3FB420)
#define COUNTDOWNNUMBERMATERIALANIMCONTROLLER_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x1C3FBBC0)
#define COUNTDOWNNUMBERMATERIALANIMCONTROLLER_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x1C3FB4E0)
#define COUNTDOWNNUMBERMATERIALANIMCONTROLLER_UPDATEMATERIALPROPS_OFFSET UNITYSDK_OFFSET(0x1C3FBD90)
#define COUNTDOWNNUMBERMATERIALANIMCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C3FBC20)
#define COUNTDOWNNUMBERMATERIALANIMCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3FC260)

inline static constexpr unsigned int CountDownNumberMaterialAnimController_TypeDefinitionIndex = 27292;
