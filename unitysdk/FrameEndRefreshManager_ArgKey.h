...
#define FRAMEENDREFRESHMANAGER_ARGKEY_ARRAYSEQUAL_OFFSET UNITYSDK_OFFSET(0x178A5F70)
#define FRAMEENDREFRESHMANAGER_ARGKEY_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x870C20)
#define FRAMEENDREFRESHMANAGER_ARGKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x870BF0)
#define FRAMEENDREFRESHMANAGER_ARGKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x870D10)
#define FRAMEENDREFRESHMANAGER_ARGKEY_HASHARRAY_OFFSET UNITYSDK_OFFSET(0x178A59C0)
#define FRAMEENDREFRESHMANAGER_ARGKEY_TRYGETSAFEHASH_OFFSET UNITYSDK_OFFSET(0x178A5C90)
#define FRAMEENDREFRESHMANAGER_ARGKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x870BE0)
#define FRAMEENDREFRESHMANAGER_ARGKEY___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x870D60)
#define FRAMEENDREFRESHMANAGER_ARGKEY___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x870DD0)

inline static constexpr unsigned int FrameEndRefreshManager_ArgKey_TypeDefinitionIndex = 77544;
