...
#define CLASS_2_11AD7A2D72029F1E_METHOD_2_047C27B43598EEF2_OFFSET UNITYSDK_OFFSET(0x134CC570)
#define CLASS_2_11AD7A2D72029F1E_METHOD_2_2776E8AE918CB345_OFFSET UNITYSDK_OFFSET(0x134C6AF0)
#define CLASS_2_11AD7A2D72029F1E_METHOD_2_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x134CC6B0)
#define CLASS_2_11AD7A2D72029F1E_METHOD_2_40E490E2772D5D75_OFFSET UNITYSDK_OFFSET(0x134C7840)
#define CLASS_2_11AD7A2D72029F1E_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x134C78A0)
#define CLASS_2_11AD7A2D72029F1E_METHOD_2_6EDFB5C97C6E7C6A_OFFSET UNITYSDK_OFFSET(0x134CC340)
#define CLASS_2_11AD7A2D72029F1E_METHOD_2_7B9D6F143086B23A_OFFSET UNITYSDK_OFFSET(0x134C6E20)
#define CLASS_2_11AD7A2D72029F1E_METHOD_2_AAFE8DC44E675A0C_OFFSET UNITYSDK_OFFSET(0x134CC7C0)
#define CLASS_2_11AD7A2D72029F1E_METHOD_2_B73CDCBF771B2B3A_OFFSET UNITYSDK_OFFSET(0x134CC920)
#define CLASS_2_11AD7A2D72029F1E_METHOD_2_C4C552549A8C0DBA_OFFSET UNITYSDK_OFFSET(0x134CC4F0)
#define CLASS_2_11AD7A2D72029F1E_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x134CC4A0)
#define CLASS_2_11AD7A2D72029F1E__CCTOR_OFFSET UNITYSDK_OFFSET(0x134CC990)
#define CLASS_2_11AD7A2D72029F1E__CTOR_OFFSET UNITYSDK_OFFSET(0x134C6A20)

inline static constexpr unsigned int Class_2_11AD7A2D72029F1E_TypeDefinitionIndex = 52545;
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_2_11AD7A2D72029F1E_TypeDefinitionIndex)->GetStaticField(0x90A0);
	}
	::RPG::GameCore::ModifyAdventureCharacterRunSpeedRatio* JFEJENBHBCO; // 0x38
	::UnityEngine::Vector3 BEDPGAOCOHG; // 0x40
	::System::Single OLPMGDANOGE; // 0x4C
	::System::Single DGKFELJKIEM; // 0x50
	::System::Single POJMPKLGMEP; // 0x54
	::System::Single CMPJEDPEALD; // 0x58
	::System::Single BKIGKLKOHPM; // 0x5C
	::System::Single MNCCILIKMPB; // 0x60
	::System::Single JOKFKNIBJJH; // 0x64
	::System::Single FHOCFFBHDGI; // 0x68
	::System::Single BLJLGBAJLAJ; // 0x6C
	::System::Single DIGGHFOKNCL; // 0x70
	::RPG::GameCore::CharacterMotionFlag JMMIBGDIDDG; // 0x74
