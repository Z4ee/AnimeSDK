...
#define CODABLE_JSONNUMBER_EQUALS_OFFSET UNITYSDK_OFFSET(0x8B88BD0)
#define CODABLE_JSONNUMBER_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x8B88A20)
#define CODABLE_JSONNUMBER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8B88D80)
#define CODABLE_JSONNUMBER_GET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x8B88AC0)
#define CODABLE_JSONNUMBER_GET_ISNUMBER_OFFSET UNITYSDK_OFFSET(0x8B88A10)
#define CODABLE_JSONNUMBER_GET_TAG_OFFSET UNITYSDK_OFFSET(0x8B88A00)
#define CODABLE_JSONNUMBER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x8B88A40)
#define CODABLE_JSONNUMBER_ISNUMERIC_OFFSET UNITYSDK_OFFSET(0x8B88B50)
#define CODABLE_JSONNUMBER_SET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x8B88AD0)
#define CODABLE_JSONNUMBER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x8B88A70)
#define CODABLE_JSONNUMBER_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x8B88B30)
#define CODABLE_JSONNUMBER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8B88AE0)
#define CODABLE_JSONNUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x8B84F00)

namespace Codable
{
	inline static constexpr unsigned int JSONNumber_TypeDefinitionIndex = 42684;
