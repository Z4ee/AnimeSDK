...
#define CODABLE_JSONNUMBER_EQUALS_OFFSET UNITYSDK_OFFSET(0xB10BBC0)
#define CODABLE_JSONNUMBER_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xB10BA10)
#define CODABLE_JSONNUMBER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xB10BD10)
#define CODABLE_JSONNUMBER_GET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0xB10BAB0)
#define CODABLE_JSONNUMBER_GET_ISNUMBER_OFFSET UNITYSDK_OFFSET(0xB10BA00)
#define CODABLE_JSONNUMBER_GET_TAG_OFFSET UNITYSDK_OFFSET(0xB10B9F0)
#define CODABLE_JSONNUMBER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xB10BA30)
#define CODABLE_JSONNUMBER_ISNUMERIC_OFFSET UNITYSDK_OFFSET(0xB10BB40)
#define CODABLE_JSONNUMBER_SET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0xB10BAC0)
#define CODABLE_JSONNUMBER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xB10BA60)
#define CODABLE_JSONNUMBER_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0xB10BB20)
#define CODABLE_JSONNUMBER__CTOR_1_OFFSET UNITYSDK_OFFSET(0xB10BAD0)
#define CODABLE_JSONNUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0xB1070E0)
