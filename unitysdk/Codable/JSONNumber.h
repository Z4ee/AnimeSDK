...
#define CODABLE_JSONNUMBER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BD9F870)
#define CODABLE_JSONNUMBER_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BD9F6C0)
#define CODABLE_JSONNUMBER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BD9F9C0)
#define CODABLE_JSONNUMBER_GET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x1BD9F760)
#define CODABLE_JSONNUMBER_GET_ISNUMBER_OFFSET UNITYSDK_OFFSET(0x1BD9F6B0)
#define CODABLE_JSONNUMBER_GET_TAG_OFFSET UNITYSDK_OFFSET(0x1BD9F6A0)
#define CODABLE_JSONNUMBER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1BD9F6E0)
#define CODABLE_JSONNUMBER_ISNUMERIC_OFFSET UNITYSDK_OFFSET(0x1BD9F7F0)
#define CODABLE_JSONNUMBER_SET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x1BD9F770)
#define CODABLE_JSONNUMBER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1BD9F710)
#define CODABLE_JSONNUMBER_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x1BD9F7D0)
#define CODABLE_JSONNUMBER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BD9F780)
#define CODABLE_JSONNUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD9ADB0)

namespace Codable
{
	inline static constexpr unsigned int JSONNumber_TypeDefinitionIndex = 44348;
