...
#define CODABLE_JSONNODE__GET_CHILDREN_D__39_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x835F4C0)
#define CODABLE_JSONNODE__GET_CHILDREN_D__39_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_CODABLE_JSONNODE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x835F550)
#define CODABLE_JSONNODE__GET_CHILDREN_D__39_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_CODABLE_JSONNODE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x835F4E0)
#define CODABLE_JSONNODE__GET_CHILDREN_D__39_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x835F5C0)
#define CODABLE_JSONNODE__GET_CHILDREN_D__39_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x835F540)
#define CODABLE_JSONNODE__GET_CHILDREN_D__39_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x835F4F0)
#define CODABLE_JSONNODE__GET_CHILDREN_D__39_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x835F4B0)
#define CODABLE_JSONNODE__GET_CHILDREN_D__39__CTOR_OFFSET UNITYSDK_OFFSET(0x835D6E0)

namespace Codable
{
	inline static constexpr unsigned int JSONNode__get_Children_d__39_TypeDefinitionIndex = 36850;
