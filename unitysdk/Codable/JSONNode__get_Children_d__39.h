...
#define CODABLE_JSONNODE__GET_CHILDREN_D__39_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1C4B4270)
#define CODABLE_JSONNODE__GET_CHILDREN_D__39_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_CODABLE_JSONNODE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1C4B4300)
#define CODABLE_JSONNODE__GET_CHILDREN_D__39_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_CODABLE_JSONNODE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C4B4290)
#define CODABLE_JSONNODE__GET_CHILDREN_D__39_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1C4B4370)
#define CODABLE_JSONNODE__GET_CHILDREN_D__39_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C4B42F0)
#define CODABLE_JSONNODE__GET_CHILDREN_D__39_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1C4B42A0)
#define CODABLE_JSONNODE__GET_CHILDREN_D__39_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C4B4260)
#define CODABLE_JSONNODE__GET_CHILDREN_D__39__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4B1EB0)

namespace Codable
{
	inline static constexpr unsigned int JSONNode__get_Children_d__39_TypeDefinitionIndex = 36458;
