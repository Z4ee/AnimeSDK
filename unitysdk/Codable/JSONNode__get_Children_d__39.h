...
#define CODABLE_JSONNODE__GET_CHILDREN_D__39_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A1CB700)
#define CODABLE_JSONNODE__GET_CHILDREN_D__39_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_CODABLE_JSONNODE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A1CB790)
#define CODABLE_JSONNODE__GET_CHILDREN_D__39_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_CODABLE_JSONNODE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A1CB720)
#define CODABLE_JSONNODE__GET_CHILDREN_D__39_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A1CB800)
#define CODABLE_JSONNODE__GET_CHILDREN_D__39_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A1CB780)
#define CODABLE_JSONNODE__GET_CHILDREN_D__39_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A1CB730)
#define CODABLE_JSONNODE__GET_CHILDREN_D__39_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A1CB6F0)
#define CODABLE_JSONNODE__GET_CHILDREN_D__39__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1C9340)

namespace Codable
{
	inline static constexpr unsigned int JSONNode__get_Children_d__39_TypeDefinitionIndex = 34895;
