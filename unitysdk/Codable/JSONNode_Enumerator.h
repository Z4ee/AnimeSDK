...
#define CODABLE_JSONNODE_ENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x99BF90)
#define CODABLE_JSONNODE_ENUMERATOR_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x669870)
#define CODABLE_JSONNODE_ENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x9844A0)
#define CODABLE_JSONNODE_ENUMERATOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8D9220)
#define CODABLE_JSONNODE_ENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x8D91D0)

namespace Codable
{
	inline static constexpr unsigned int JSONNode_Enumerator_TypeDefinitionIndex = 37112;
