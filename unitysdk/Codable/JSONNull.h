...
#define CODABLE_JSONNULL_CREATEORGET_OFFSET UNITYSDK_OFFSET(0x1C531170)
#define CODABLE_JSONNULL_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C5312C0)
#define CODABLE_JSONNULL_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1C531230)
#define CODABLE_JSONNULL_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C531330)
#define CODABLE_JSONNULL_GET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x1C5312A0)
#define CODABLE_JSONNULL_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x1C531220)
#define CODABLE_JSONNULL_GET_TAG_OFFSET UNITYSDK_OFFSET(0x1C531210)
#define CODABLE_JSONNULL_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1C531250)
#define CODABLE_JSONNULL_SET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x1C5312B0)
#define CODABLE_JSONNULL_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1C531290)
#define CODABLE_JSONNULL_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x1C531340)
#define CODABLE_JSONNULL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C531390)
#define CODABLE_JSONNULL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C531200)

namespace Codable
{
	inline static constexpr unsigned int JSONNull_TypeDefinitionIndex = 36468;
	...
	public:
		...
		{
			return (::Codable::JSONNull**)Il2CppClass::FromTypeDefinitionIndex(JSONNull_TypeDefinitionIndex)->GetStaticField(0x28120);
		}
		static ::System::Boolean* StaticGet_reuseSameInstance()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(JSONNull_TypeDefinitionIndex)->GetStaticField(0x8770);
		}
