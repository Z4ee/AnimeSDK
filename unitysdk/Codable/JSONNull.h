...
#define CODABLE_JSONNULL_CREATEORGET_OFFSET UNITYSDK_OFFSET(0x835B5B0)
#define CODABLE_JSONNULL_EQUALS_OFFSET UNITYSDK_OFFSET(0x8360900)
#define CODABLE_JSONNULL_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x83608A0)
#define CODABLE_JSONNULL_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8360970)
#define CODABLE_JSONNULL_GET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x83608E0)
#define CODABLE_JSONNULL_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x8360890)
#define CODABLE_JSONNULL_GET_TAG_OFFSET UNITYSDK_OFFSET(0x8360880)
#define CODABLE_JSONNULL_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x83608C0)
#define CODABLE_JSONNULL_SET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x83608F0)
#define CODABLE_JSONNULL_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x83608D0)
#define CODABLE_JSONNULL_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x8360980)
#define CODABLE_JSONNULL__CCTOR_OFFSET UNITYSDK_OFFSET(0x83609B0)
#define CODABLE_JSONNULL__CTOR_OFFSET UNITYSDK_OFFSET(0x8360870)

namespace Codable
{
	inline static constexpr unsigned int JSONNull_TypeDefinitionIndex = 36860;
	...
	public:
		...
		{
			return (::Codable::JSONNull**)Il2CppClass::FromTypeDefinitionIndex(JSONNull_TypeDefinitionIndex)->GetStaticField(0x35E40);
		}
		static ::System::Boolean* StaticGet_reuseSameInstance()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(JSONNull_TypeDefinitionIndex)->GetStaticField(0x10CD0);
		}
