...
#define CODABLE_JSONBOOL_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BD9A330)
#define CODABLE_JSONBOOL_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BD9A1E0)
#define CODABLE_JSONBOOL_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BD9A350)
#define CODABLE_JSONBOOL_GET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x1BD9A270)
#define CODABLE_JSONBOOL_GET_ISBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1BD9A1D0)
#define CODABLE_JSONBOOL_GET_TAG_OFFSET UNITYSDK_OFFSET(0x1BD9A1C0)
#define CODABLE_JSONBOOL_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1BD9A200)
#define CODABLE_JSONBOOL_SET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x1BD9A280)
#define CODABLE_JSONBOOL_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1BD9A220)
#define CODABLE_JSONBOOL_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x1BD9A2F0)
#define CODABLE_JSONBOOL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BD9A2A0)
#define CODABLE_JSONBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD9A290)

namespace Codable
{
	inline static constexpr unsigned int JSONBool_TypeDefinitionIndex = 44349;
