...
#define CODABLE_JSONSTRING_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DB5DFF0)
#define CODABLE_JSONSTRING_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1DB5DE80)
#define CODABLE_JSONSTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DB5E0F0)
#define CODABLE_JSONSTRING_GET_ISSTRING_OFFSET UNITYSDK_OFFSET(0x1DB5DE70)
#define CODABLE_JSONSTRING_GET_TAG_OFFSET UNITYSDK_OFFSET(0x1DB5DE60)
#define CODABLE_JSONSTRING_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1DB5DEA0)
#define CODABLE_JSONSTRING_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1DB5DEB0)
#define CODABLE_JSONSTRING_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x1DB5DEC0)
#define CODABLE_JSONSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB58C60)

namespace Codable
{
	inline static constexpr unsigned int JSONString_TypeDefinitionIndex = 46529;
