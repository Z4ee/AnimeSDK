...
#define CODABLE_JSONSTRING_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A863090)
#define CODABLE_JSONSTRING_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A862F60)
#define CODABLE_JSONSTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A863190)
#define CODABLE_JSONSTRING_GET_ISSTRING_OFFSET UNITYSDK_OFFSET(0x1A862F50)
#define CODABLE_JSONSTRING_GET_TAG_OFFSET UNITYSDK_OFFSET(0x1A862F40)
#define CODABLE_JSONSTRING_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A862F80)
#define CODABLE_JSONSTRING_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A862F90)
#define CODABLE_JSONSTRING_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x1A862FB0)
#define CODABLE_JSONSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A862FA0)

namespace Codable
{
	inline static constexpr unsigned int JSONString_TypeDefinitionIndex = 34902;
