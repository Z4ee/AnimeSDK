...
#define CODABLE_JSONSTRING_EQUALS_OFFSET UNITYSDK_OFFSET(0x8B89E80)
#define CODABLE_JSONSTRING_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x8B89DF0)
#define CODABLE_JSONSTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8B8A010)
#define CODABLE_JSONSTRING_GET_ISSTRING_OFFSET UNITYSDK_OFFSET(0x8B89DE0)
#define CODABLE_JSONSTRING_GET_TAG_OFFSET UNITYSDK_OFFSET(0x8B89DD0)
#define CODABLE_JSONSTRING_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x8B89E10)
#define CODABLE_JSONSTRING_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x8B89E20)
#define CODABLE_JSONSTRING_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x8B89E30)
#define CODABLE_JSONSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x8B85DC0)
