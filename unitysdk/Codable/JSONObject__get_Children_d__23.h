...
#define CODABLE_JSONOBJECT__GET_CHILDREN_D__23_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BDA0E10)
#define CODABLE_JSONOBJECT__GET_CHILDREN_D__23_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_CODABLE_JSONNODE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BDA0FF0)
#define CODABLE_JSONOBJECT__GET_CHILDREN_D__23_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_CODABLE_JSONNODE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BDA0F80)
#define CODABLE_JSONOBJECT__GET_CHILDREN_D__23_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BDA1070)
#define CODABLE_JSONOBJECT__GET_CHILDREN_D__23_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BDA0FE0)
#define CODABLE_JSONOBJECT__GET_CHILDREN_D__23_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BDA0F90)
#define CODABLE_JSONOBJECT__GET_CHILDREN_D__23_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BDA0DF0)
#define CODABLE_JSONOBJECT__GET_CHILDREN_D__23__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDA03C0)
#define CODABLE_JSONOBJECT__GET_CHILDREN_D__23___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1BDA0E00)

namespace Codable
{
	inline static constexpr unsigned int JSONObject__get_Children_d__23_TypeDefinitionIndex = 44346;
