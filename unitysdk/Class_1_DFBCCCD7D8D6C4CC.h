...
#define CLASS_1_DFBCCCD7D8D6C4CC_GET_ENABLEIPV6_OFFSET UNITYSDK_OFFSET(0x1D7AE100)
#define CLASS_1_DFBCCCD7D8D6C4CC_GET_MAXLONGUNSTABLETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1D7AE1C0)
#define CLASS_1_DFBCCCD7D8D6C4CC_GET_MINLONGUNSTABLETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1D7AE1E0)
#define CLASS_1_DFBCCCD7D8D6C4CC_GET_PACKETLOSSRATETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1D7AE1A0)
#define CLASS_1_DFBCCCD7D8D6C4CC_GET_PINGTIMEOUTMILISECONDS_OFFSET UNITYSDK_OFFSET(0x1D7AE140)
#define CLASS_1_DFBCCCD7D8D6C4CC_GET_PREFERIPV6RTTTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1D7AE160)
#define CLASS_1_DFBCCCD7D8D6C4CC_GET_RECVTIMEOUTMILISECONDS_OFFSET UNITYSDK_OFFSET(0x1D7AE120)
#define CLASS_1_DFBCCCD7D8D6C4CC_GET_RTTUNSTABLETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1D7AE180)
#define CLASS_1_DFBCCCD7D8D6C4CC_SET_ENABLEIPV6_OFFSET UNITYSDK_OFFSET(0x1D7AE110)
#define CLASS_1_DFBCCCD7D8D6C4CC_SET_MAXLONGUNSTABLETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1D7AE1D0)
#define CLASS_1_DFBCCCD7D8D6C4CC_SET_MINLONGUNSTABLETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1D7AE1F0)
#define CLASS_1_DFBCCCD7D8D6C4CC_SET_PACKETLOSSRATETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1D7AE1B0)
#define CLASS_1_DFBCCCD7D8D6C4CC_SET_PINGTIMEOUTMILISECONDS_OFFSET UNITYSDK_OFFSET(0x1D7AE150)
#define CLASS_1_DFBCCCD7D8D6C4CC_SET_PREFERIPV6RTTTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1D7AE170)
#define CLASS_1_DFBCCCD7D8D6C4CC_SET_RECVTIMEOUTMILISECONDS_OFFSET UNITYSDK_OFFSET(0x1D7AE130)
#define CLASS_1_DFBCCCD7D8D6C4CC_SET_RTTUNSTABLETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1D7AE190)
#define CLASS_1_DFBCCCD7D8D6C4CC__CTOR_OFFSET UNITYSDK_OFFSET(0x1D79ECA0)
...
{
public:
	::System::Int32 _RecvTimeoutMiliSeconds_k__BackingField; // 0x10
	::System::UInt32 _PingTimeoutMiliSeconds_k__BackingField; // 0x14
	::System::Single _PacketLossRateThreshold_k__BackingField; // 0x18
	::System::Single _MaxLongUnstableThreshold_k__BackingField; // 0x1C
	::System::UInt32 _RttUnstableThreshold_k__BackingField; // 0x20
	::System::Boolean _EnableIpv6_k__BackingField; // 0x24
	::System::UInt32 _PreferIPv6RttThreshold_k__BackingField; // 0x28
