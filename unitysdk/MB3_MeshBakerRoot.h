...
#define MB3_MESHBAKERROOT_DOCOMBINEDVALIDATE_OFFSET UNITYSDK_OFFSET(0x1F2A8FA0)
#define MB3_MESHBAKERROOT_GETOBJECTSTOCOMBINE_OFFSET UNITYSDK_OFFSET(0x1F2A8F80)
#define MB3_MESHBAKERROOT_PURGENULLSFROMOBJECTSTOCOMBINE_OFFSET UNITYSDK_OFFSET(0x1F2A8F90)
#define MB3_MESHBAKERROOT_VALIDATETEXTUREBAKERGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1F2A9510)
#define MB3_MESHBAKERROOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1F2AA540)

inline static constexpr unsigned int MB3_MeshBakerRoot_TypeDefinitionIndex = 94477;
