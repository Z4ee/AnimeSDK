...
#define MB3_MESHBAKERROOT_DOCOMBINEDVALIDATE_OFFSET UNITYSDK_OFFSET(0x1DE8C180)
#define MB3_MESHBAKERROOT_GETOBJECTSTOCOMBINE_OFFSET UNITYSDK_OFFSET(0x1DE8C160)
#define MB3_MESHBAKERROOT_PURGENULLSFROMOBJECTSTOCOMBINE_OFFSET UNITYSDK_OFFSET(0x1DE8C170)
#define MB3_MESHBAKERROOT_VALIDATETEXTUREBAKERGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1DE8C6E0)
#define MB3_MESHBAKERROOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE8D710)

inline static constexpr unsigned int MB3_MeshBakerRoot_TypeDefinitionIndex = 90544;
