...
#define STRUCT_2_E0116B533C3182F9_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x7C4450)
#define STRUCT_2_E0116B533C3182F9_EQUALS_OFFSET UNITYSDK_OFFSET(0x7C4350)
#define STRUCT_2_E0116B533C3182F9_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7C4460)
#define STRUCT_2_E0116B533C3182F9_METHOD_2_6D0360BD23602584_OFFSET UNITYSDK_OFFSET(0x7C44D0)
#define STRUCT_2_E0116B533C3182F9_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x7C4550)

inline static constexpr unsigned int Struct_2_E0116B533C3182F9_TypeDefinitionIndex = 41894;

struct alignas(8) Struct_2_E0116B533C3182F9
{
	::MoleMole::EntityHandle Field_2_1; // 0x10
	::Foundation::AssetRequestHandle Field_2_0; // 0x20
	::Enum_3_94C3508574381C0F Field_2_7; // 0x40
