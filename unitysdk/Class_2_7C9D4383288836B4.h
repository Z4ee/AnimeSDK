...
#define CLASS_2_7C9D4383288836B4_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13AB6760)
#define CLASS_2_7C9D4383288836B4_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x13AB67A0)
#define CLASS_2_7C9D4383288836B4_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x13AB6840)
#define CLASS_2_7C9D4383288836B4_TICK_OFFSET UNITYSDK_OFFSET(0x13AB6890)
#define CLASS_2_7C9D4383288836B4__CTOR_OFFSET UNITYSDK_OFFSET(0x13AB6750)

inline static constexpr unsigned int Class_2_7C9D4383288836B4_TypeDefinitionIndex = 52702;
...
public:
	...
	::RPG::GameCore::ShowBattleUI* Field_2_2; // 0x20
