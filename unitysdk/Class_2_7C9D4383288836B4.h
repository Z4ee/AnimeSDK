...
#define CLASS_2_7C9D4383288836B4_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1197EED0)
#define CLASS_2_7C9D4383288836B4_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1197EF10)
#define CLASS_2_7C9D4383288836B4_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1197EFB0)
#define CLASS_2_7C9D4383288836B4_TICK_OFFSET UNITYSDK_OFFSET(0x1197F000)
#define CLASS_2_7C9D4383288836B4__CTOR_OFFSET UNITYSDK_OFFSET(0x1197EEC0)

inline static constexpr unsigned int Class_2_7C9D4383288836B4_TypeDefinitionIndex = 52028;
...
public:
	...
	::RPG::GameCore::ShowBattleUI* Field_2_0; // 0x20
