...
#define CLASS_2_1C5A1FFE688EDC9C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x124624B0)
#define CLASS_2_1C5A1FFE688EDC9C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x124624F0)
#define CLASS_2_1C5A1FFE688EDC9C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x124625F0)
#define CLASS_2_1C5A1FFE688EDC9C_TICK_OFFSET UNITYSDK_OFFSET(0x12462640)
#define CLASS_2_1C5A1FFE688EDC9C__CTOR_OFFSET UNITYSDK_OFFSET(0x124624A0)

inline static constexpr unsigned int Class_2_1C5A1FFE688EDC9C_TypeDefinitionIndex = 48606;

class Class_2_1C5A1FFE688EDC9C : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ChangeChallengeBuff* Field_2_0; // 0x18
