...
#define CLASS_2_1C5A1FFE688EDC9C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1444DFD0)
#define CLASS_2_1C5A1FFE688EDC9C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1444E010)
#define CLASS_2_1C5A1FFE688EDC9C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1444E0C0)
#define CLASS_2_1C5A1FFE688EDC9C_TICK_OFFSET UNITYSDK_OFFSET(0x1444E110)
#define CLASS_2_1C5A1FFE688EDC9C__CTOR_OFFSET UNITYSDK_OFFSET(0x1444DFC0)

inline static constexpr unsigned int Class_2_1C5A1FFE688EDC9C_TypeDefinitionIndex = 49233;
