...
#define CLASS_1_5B567C8A01BAEDFE_226_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19C45FD0)
#define CLASS_1_5B567C8A01BAEDFE_226_CLONE_OFFSET UNITYSDK_OFFSET(0x19C45E40)
#define CLASS_1_5B567C8A01BAEDFE_226_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19C45EE0)
#define CLASS_1_5B567C8A01BAEDFE_226_EQUALS_OFFSET UNITYSDK_OFFSET(0x19C45E80)
#define CLASS_1_5B567C8A01BAEDFE_226_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19C45F30)
#define CLASS_1_5B567C8A01BAEDFE_226_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19C46020)
#define CLASS_1_5B567C8A01BAEDFE_226_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19C45FF0)
#define CLASS_1_5B567C8A01BAEDFE_226_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19C45DC0)
#define CLASS_1_5B567C8A01BAEDFE_226_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19C45DF0)
#define CLASS_1_5B567C8A01BAEDFE_226_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19C45F60)
#define CLASS_1_5B567C8A01BAEDFE_226_WRITETO_OFFSET UNITYSDK_OFFSET(0x19C45FC0)
#define CLASS_1_5B567C8A01BAEDFE_226__CCTOR_OFFSET UNITYSDK_OFFSET(0x19C46070)
#define CLASS_1_5B567C8A01BAEDFE_226__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19C45E10)
#define CLASS_1_5B567C8A01BAEDFE_226__CTOR_OFFSET UNITYSDK_OFFSET(0x19C45E00)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_226_TypeDefinitionIndex = 29630;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_226*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_226_TypeDefinitionIndex)->GetStaticField(0x5C760);
	}
