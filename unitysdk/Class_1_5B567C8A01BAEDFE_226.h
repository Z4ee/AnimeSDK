...
#define CLASS_1_5B567C8A01BAEDFE_226_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A2ACC10)
#define CLASS_1_5B567C8A01BAEDFE_226_CLONE_OFFSET UNITYSDK_OFFSET(0x1A2ACA20)
#define CLASS_1_5B567C8A01BAEDFE_226_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A2ACB20)
#define CLASS_1_5B567C8A01BAEDFE_226_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A2ACA90)
#define CLASS_1_5B567C8A01BAEDFE_226_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A2ACB70)
#define CLASS_1_5B567C8A01BAEDFE_226_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A2ACC60)
#define CLASS_1_5B567C8A01BAEDFE_226_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A2ACC30)
#define CLASS_1_5B567C8A01BAEDFE_226_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A2AC970)
#define CLASS_1_5B567C8A01BAEDFE_226_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A2AC9D0)
#define CLASS_1_5B567C8A01BAEDFE_226_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A2ACBA0)
#define CLASS_1_5B567C8A01BAEDFE_226_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A2ACC00)
#define CLASS_1_5B567C8A01BAEDFE_226__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2ACCB0)
#define CLASS_1_5B567C8A01BAEDFE_226__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A2AC9F0)
#define CLASS_1_5B567C8A01BAEDFE_226__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2AC9E0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_226_TypeDefinitionIndex = 29402;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_226*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_226_TypeDefinitionIndex)->GetStaticField(0x4AA20);
	}
