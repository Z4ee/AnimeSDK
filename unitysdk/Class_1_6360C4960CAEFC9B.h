...
#define CLASS_1_6360C4960CAEFC9B__CTOR_OFFSET UNITYSDK_OFFSET(0x15D0E830)

inline static constexpr unsigned int Class_1_6360C4960CAEFC9B_TypeDefinitionIndex = 80536;

class Class_1_6360C4960CAEFC9B : public ::System::Object
{
public:
	::Struct_2_90CF7B92576C9A88 Field_1_0; // 0x10
	::MoleMole::HollowChessboard::ChessboardView::LineInfo Field_1_7; // 0x3C
