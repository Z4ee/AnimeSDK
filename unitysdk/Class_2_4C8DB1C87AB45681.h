...
#define CLASS_2_4C8DB1C87AB45681_METHOD_2_283DA224BE06DA9F_OFFSET UNITYSDK_OFFSET(0x19707420)
#define CLASS_2_4C8DB1C87AB45681__CTOR_OFFSET UNITYSDK_OFFSET(0x19707410)
...
{
public:
	::RPG::GameCore::DiceCombatTaskConfig_TriggerIceEffect* IGHAHBNLIJA; // 0x18
