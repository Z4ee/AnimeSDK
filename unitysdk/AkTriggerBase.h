...
#define AKTRIGGERBASE_GETALLDERIVEDTYPES_OFFSET UNITYSDK_OFFSET(0x1EF4FC40)
#define AKTRIGGERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF50440)

inline static constexpr unsigned int AkTriggerBase_TypeDefinitionIndex = 43767;
