...
#define MB3_MESHBAKER_ADDDELETEGAMEOBJECTSBYID_OFFSET UNITYSDK_OFFSET(0x1EE3A700)
#define MB3_MESHBAKER_ADDDELETEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1EE3A5D0)
#define MB3_MESHBAKER_APPLYSHOWHIDE_OFFSET UNITYSDK_OFFSET(0x1EE3A5A0)
#define MB3_MESHBAKER_BUILDSCENEMESHOBJECT_OFFSET UNITYSDK_OFFSET(0x1EE3A550)
#define MB3_MESHBAKER_GET_MESHCOMBINER_OFFSET UNITYSDK_OFFSET(0x1EE3A540)
#define MB3_MESHBAKER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1EE3A830)
#define MB3_MESHBAKER_PRINTTIMINGS_OFFSET UNITYSDK_OFFSET(0x1EE398D0)
#define MB3_MESHBAKER_SHOWHIDE_OFFSET UNITYSDK_OFFSET(0x1EE3A580)
#define MB3_MESHBAKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE3A850)

inline static constexpr unsigned int MB3_MeshBaker_TypeDefinitionIndex = 94472;
