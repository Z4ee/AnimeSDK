...
#define MB3_MESHBAKER_ADDDELETEGAMEOBJECTSBYID_OFFSET UNITYSDK_OFFSET(0x1DA6F950)
#define MB3_MESHBAKER_ADDDELETEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1DA6F820)
#define MB3_MESHBAKER_APPLYSHOWHIDE_OFFSET UNITYSDK_OFFSET(0x1DA6F7F0)
#define MB3_MESHBAKER_BUILDSCENEMESHOBJECT_OFFSET UNITYSDK_OFFSET(0x1DA6F7A0)
#define MB3_MESHBAKER_GET_MESHCOMBINER_OFFSET UNITYSDK_OFFSET(0x1DA6F790)
#define MB3_MESHBAKER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1DA6FA80)
#define MB3_MESHBAKER_PRINTTIMINGS_OFFSET UNITYSDK_OFFSET(0x1DA6EAC0)
#define MB3_MESHBAKER_SHOWHIDE_OFFSET UNITYSDK_OFFSET(0x1DA6F7D0)
#define MB3_MESHBAKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA6FAA0)

inline static constexpr unsigned int MB3_MeshBaker_TypeDefinitionIndex = 90539;
