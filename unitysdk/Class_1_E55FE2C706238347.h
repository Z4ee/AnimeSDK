...
#define CLASS_1_E55FE2C706238347__CTOR_OFFSET UNITYSDK_OFFSET(0x14DDDF10)

inline static constexpr unsigned int Class_1_E55FE2C706238347_TypeDefinitionIndex = 82991;

class Class_1_E55FE2C706238347 : public ::System::Object
{
public:
	::ProtoScript::HollowSystemType Field_1_0; // 0x10
	::ProtoScript::HollowSystemUIState Field_1_1; // 0x14
