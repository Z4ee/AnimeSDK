...
#define CLASS_1_2AE7FBE19C7FFFCD_GET_BRICKCONTROLMODE_OFFSET UNITYSDK_OFFSET(0x17F64520)
#define CLASS_1_2AE7FBE19C7FFFCD_GET_BRICKDIRECTIONMODE_OFFSET UNITYSDK_OFFSET(0x17F64540)
#define CLASS_1_2AE7FBE19C7FFFCD_GET_KEYBOARDUSEWROTATE_OFFSET UNITYSDK_OFFSET(0x17F64580)
#define CLASS_1_2AE7FBE19C7FFFCD_GET_MOBILEUSEBTNROTATE_OFFSET UNITYSDK_OFFSET(0x17F64560)
#define CLASS_1_2AE7FBE19C7FFFCD_SET_BRICKCONTROLMODE_OFFSET UNITYSDK_OFFSET(0x17F64530)
#define CLASS_1_2AE7FBE19C7FFFCD_SET_BRICKDIRECTIONMODE_OFFSET UNITYSDK_OFFSET(0x17F64550)
#define CLASS_1_2AE7FBE19C7FFFCD_SET_KEYBOARDUSEWROTATE_OFFSET UNITYSDK_OFFSET(0x17F64590)
#define CLASS_1_2AE7FBE19C7FFFCD_SET_MOBILEUSEBTNROTATE_OFFSET UNITYSDK_OFFSET(0x17F64570)
#define CLASS_1_2AE7FBE19C7FFFCD__CTOR_OFFSET UNITYSDK_OFFSET(0x17F645A0)

inline static constexpr unsigned int Class_1_2AE7FBE19C7FFFCD_TypeDefinitionIndex = 78553;

class Class_1_2AE7FBE19C7FFFCD : public ::System::Object
{
public:
	::System::Boolean _KeyBoardUseWRotate_k__BackingField; // 0x10
	::System::Boolean _MobileUseBtnRotate_k__BackingField; // 0x11
	::RPG::Client::TeamTowers::BrickControlType _BrickControlMode_k__BackingField; // 0x14
	::RPG::Client::TeamTowers::BrickDirectionType _BrickDirectionMode_k__BackingField; // 0x18
