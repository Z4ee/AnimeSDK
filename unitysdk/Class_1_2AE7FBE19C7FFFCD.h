...
#define CLASS_1_2AE7FBE19C7FFFCD_GET_BRICKCONTROLMODE_OFFSET UNITYSDK_OFFSET(0x165BCF70)
#define CLASS_1_2AE7FBE19C7FFFCD_GET_BRICKDIRECTIONMODE_OFFSET UNITYSDK_OFFSET(0x165BCF90)
#define CLASS_1_2AE7FBE19C7FFFCD_GET_KEYBOARDUSEWROTATE_OFFSET UNITYSDK_OFFSET(0x165BCFD0)
#define CLASS_1_2AE7FBE19C7FFFCD_GET_MOBILEUSEBTNROTATE_OFFSET UNITYSDK_OFFSET(0x165BCFB0)
#define CLASS_1_2AE7FBE19C7FFFCD_SET_BRICKCONTROLMODE_OFFSET UNITYSDK_OFFSET(0x165BCF80)
#define CLASS_1_2AE7FBE19C7FFFCD_SET_BRICKDIRECTIONMODE_OFFSET UNITYSDK_OFFSET(0x165BCFA0)
#define CLASS_1_2AE7FBE19C7FFFCD_SET_KEYBOARDUSEWROTATE_OFFSET UNITYSDK_OFFSET(0x165BCFE0)
#define CLASS_1_2AE7FBE19C7FFFCD_SET_MOBILEUSEBTNROTATE_OFFSET UNITYSDK_OFFSET(0x165BCFC0)
#define CLASS_1_2AE7FBE19C7FFFCD__CTOR_OFFSET UNITYSDK_OFFSET(0x165BCFF0)

inline static constexpr unsigned int Class_1_2AE7FBE19C7FFFCD_TypeDefinitionIndex = 75055;

class Class_1_2AE7FBE19C7FFFCD : public ::System::Object
{
public:
	::System::Boolean _MobileUseBtnRotate_k__BackingField; // 0x10
	::System::Boolean _KeyBoardUseWRotate_k__BackingField; // 0x11
	::RPG::Client::TeamTowers::BrickDirectionType _BrickDirectionMode_k__BackingField; // 0x14
	::RPG::Client::TeamTowers::BrickControlType _BrickControlMode_k__BackingField; // 0x18
