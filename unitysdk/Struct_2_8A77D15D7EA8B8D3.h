...
#define STRUCT_2_8A77D15D7EA8B8D3_EQUALS_OFFSET UNITYSDK_OFFSET(0x7CC9D0)
#define STRUCT_2_8A77D15D7EA8B8D3_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7CCAB0)
#define STRUCT_2_8A77D15D7EA8B8D3_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x7CCB00)
#define STRUCT_2_8A77D15D7EA8B8D3_METHOD_2_3DFFEA8885EDBFF0_OFFSET UNITYSDK_OFFSET(0x7CCC10)
#define STRUCT_2_8A77D15D7EA8B8D3_METHOD_2_6D0360BD23602584_OFFSET UNITYSDK_OFFSET(0x7CCBB0)
#define STRUCT_2_8A77D15D7EA8B8D3_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x7CCB50)
#define STRUCT_2_8A77D15D7EA8B8D3_METHOD_2_CD79A54011A64F0E_OFFSET UNITYSDK_OFFSET(0x133D3470)
#define STRUCT_2_8A77D15D7EA8B8D3__CCTOR_OFFSET UNITYSDK_OFFSET(0x133D3460)
#define STRUCT_2_8A77D15D7EA8B8D3__CTOR_OFFSET UNITYSDK_OFFSET(0x312BA0)

inline static constexpr unsigned int Struct_2_8A77D15D7EA8B8D3_TypeDefinitionIndex = 59665;

struct alignas(4) Struct_2_8A77D15D7EA8B8D3
{
	static ::Struct_2_8A77D15D7EA8B8D3* StaticGet_Field_2_6()
	{
		return (::Struct_2_8A77D15D7EA8B8D3*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_8A77D15D7EA8B8D3_TypeDefinitionIndex)->GetStaticField(0x10A40);
	}
