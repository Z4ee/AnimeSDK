...
#define CLASS_2_849DACF0B6D839B1_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A456070)
#define CLASS_2_849DACF0B6D839B1_GET_CONTAINERINFO_OFFSET UNITYSDK_OFFSET(0x1A456640)
#define CLASS_2_849DACF0B6D839B1_GET_LEVELCONFIGPATH_OFFSET UNITYSDK_OFFSET(0x1A456620)
#define CLASS_2_849DACF0B6D839B1_GET_LEVELCONFIG_OFFSET UNITYSDK_OFFSET(0x1A456660)
#define CLASS_2_849DACF0B6D839B1_GET_LEVELVARBINDING_OFFSET UNITYSDK_OFFSET(0x1A4566A0)
#define CLASS_2_849DACF0B6D839B1_GET_LITTLEGAMEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A456680)
#define CLASS_2_849DACF0B6D839B1_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4564E0)
#define CLASS_2_849DACF0B6D839B1_METHOD_2_354036A4D50F194A_OFFSET UNITYSDK_OFFSET(0x1A455C00)
#define CLASS_2_849DACF0B6D839B1_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1A456220)
#define CLASS_2_849DACF0B6D839B1_METHOD_2_5176DC743E478510_OFFSET UNITYSDK_OFFSET(0x1A455D80)
#define CLASS_2_849DACF0B6D839B1_METHOD_2_7FBAA229ED524F8E_OFFSET UNITYSDK_OFFSET(0x1A455FE0)
#define CLASS_2_849DACF0B6D839B1_METHOD_2_D14D1C669EDC2D6B_OFFSET UNITYSDK_OFFSET(0x1A456140)
#define CLASS_2_849DACF0B6D839B1_METHOD_2_D7F8E51377682B4C_OFFSET UNITYSDK_OFFSET(0x1A456550)
#define CLASS_2_849DACF0B6D839B1_METHOD_2_F85D0650F8957CC8_OFFSET UNITYSDK_OFFSET(0x1A455B70)
#define CLASS_2_849DACF0B6D839B1_ONWILLBEDESTROY_OFFSET UNITYSDK_OFFSET(0x1A4560C0)
#define CLASS_2_849DACF0B6D839B1_SET_CONTAINERINFO_OFFSET UNITYSDK_OFFSET(0x1A456650)
#define CLASS_2_849DACF0B6D839B1_SET_LEVELCONFIGPATH_OFFSET UNITYSDK_OFFSET(0x1A456630)
#define CLASS_2_849DACF0B6D839B1_SET_LEVELCONFIG_OFFSET UNITYSDK_OFFSET(0x1A456670)
#define CLASS_2_849DACF0B6D839B1_SET_LEVELVARBINDING_OFFSET UNITYSDK_OFFSET(0x1A4566B0)
#define CLASS_2_849DACF0B6D839B1_SET_LITTLEGAMEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A456690)
#define CLASS_2_849DACF0B6D839B1_TICK_OFFSET UNITYSDK_OFFSET(0x1A456280)
#define CLASS_2_849DACF0B6D839B1__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4566C0)
...
{
public:
	::RPG::GameCore::LevelLittleGameInfo* _ContainerInfo_k__BackingField; // 0x18
	::Class_1_E0103A0EA6CD0F4C* _LittleGameInstance_k__BackingField; // 0x20
	::System::String* _LevelConfigPath_k__BackingField; // 0x28
	::RPG::GameCore::LittleGameLevelConfig* _LevelConfig_k__BackingField; // 0x30
