...
#define CLASS_2_B3566F804A22C208_16_LOCK_OFFSET UNITYSDK_OFFSET(0x1064B710)
#define CLASS_2_B3566F804A22C208_16_UNLOCK_OFFSET UNITYSDK_OFFSET(0x1064B7C0)
#define CLASS_2_B3566F804A22C208_16__CTOR_OFFSET UNITYSDK_OFFSET(0x1064B700)
#define CLASS_2_B3566F804A22C208_16___IFIXBASEPROXY_LOCK_OFFSET UNITYSDK_OFFSET(0x1064B870)
#define CLASS_2_B3566F804A22C208_16___IFIXBASEPROXY_UNLOCK_OFFSET UNITYSDK_OFFSET(0x1064B8E0)

inline static constexpr unsigned int Class_2_B3566F804A22C208_16_TypeDefinitionIndex = 61497;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_295*>*))((::PBYTE)hIl2Cpp + CLASS_2_B3566F804A22C208_16__CTOR_OFFSET))(this, a1);
	}
