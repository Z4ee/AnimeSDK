...
#define CLASS_1_BAF6F107F0961F34_CLEAR_OFFSET UNITYSDK_OFFSET(0x1C7697C0)
#define CLASS_1_BAF6F107F0961F34_GET_CONTEXTS_OFFSET UNITYSDK_OFFSET(0x1C76A110)
#define CLASS_1_BAF6F107F0961F34_GET_CURRENTSTATE_OFFSET UNITYSDK_OFFSET(0x1C76A130)
#define CLASS_1_BAF6F107F0961F34_GET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0x1C76A0D0)
#define CLASS_1_BAF6F107F0961F34_GET_PREVSTATE_OFFSET UNITYSDK_OFFSET(0x1C76A150)
#define CLASS_1_BAF6F107F0961F34_GET_SERVICES_OFFSET UNITYSDK_OFFSET(0x1C76A0F0)
#define CLASS_1_BAF6F107F0961F34_GET__CURRENTSTATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1C76A170)
#define CLASS_1_BAF6F107F0961F34_METHOD_1_2685B6183E614529_1_OFFSET UNITYSDK_OFFSET(0x1C76A030)
#define CLASS_1_BAF6F107F0961F34_METHOD_1_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x1C769FD0)
#define CLASS_1_BAF6F107F0961F34_METHOD_1_3A6D2E46EDDEDB52_OFFSET UNITYSDK_OFFSET(0x1C769C00)
#define CLASS_1_BAF6F107F0961F34_METHOD_1_C76FBF5BDDCD86A3_OFFSET UNITYSDK_OFFSET(0x1C769A80)
#define CLASS_1_BAF6F107F0961F34_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1C76A090)
#define CLASS_1_BAF6F107F0961F34_METHOD_1_EBDE4257DCCF7437_OFFSET UNITYSDK_OFFSET(0x1C769570)
#define CLASS_1_BAF6F107F0961F34_SET_CONTEXTS_OFFSET UNITYSDK_OFFSET(0x1C76A120)
#define CLASS_1_BAF6F107F0961F34_SET_CURRENTSTATE_OFFSET UNITYSDK_OFFSET(0x1C76A140)
#define CLASS_1_BAF6F107F0961F34_SET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0x1C76A0E0)
#define CLASS_1_BAF6F107F0961F34_SET_PREVSTATE_OFFSET UNITYSDK_OFFSET(0x1C76A160)
#define CLASS_1_BAF6F107F0961F34_SET_SERVICES_OFFSET UNITYSDK_OFFSET(0x1C76A100)
#define CLASS_1_BAF6F107F0961F34_SET__CURRENTSTATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1C76A180)
#define CLASS_1_BAF6F107F0961F34__CTOR_OFFSET UNITYSDK_OFFSET(0x1C76A190)

inline static constexpr unsigned int Class_1_BAF6F107F0961F34_TypeDefinitionIndex = 42019;

class Class_1_BAF6F107F0961F34 : public ::System::Object
{
public:
	::Entitas::IContexts* _Contexts_k__BackingField; // 0x10
	::System::Collections::Generic::Dictionary_2<::RPG::Client::LittleGame::Move::MoveState, ::Class_1_C35CD375605BD7E2*>* PFNCFHNGHAG; // 0x18
	::Class_1_47EE63CB5C4DC8FC_5* _Services_k__BackingField; // 0x20
	::Class_1_C35CD375605BD7E2* __CurrentStateInstance_k__BackingField; // 0x28
	::Entitas::IEntity* _OwnerEntity_k__BackingField; // 0x30
