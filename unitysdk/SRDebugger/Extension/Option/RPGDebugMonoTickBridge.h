...
#define SRDEBUGGER_EXTENSION_OPTION_RPGDEBUGMONOTICKBRIDGE_SET_LIFETIME_OFFSET UNITYSDK_OFFSET(0xD076380)
#define SRDEBUGGER_EXTENSION_OPTION_RPGDEBUGMONOTICKBRIDGE_UPDATE_OFFSET UNITYSDK_OFFSET(0xD076390)
#define SRDEBUGGER_EXTENSION_OPTION_RPGDEBUGMONOTICKBRIDGE__CTOR_OFFSET UNITYSDK_OFFSET(0xD076410)

namespace SRDebugger::Extension::Option
{
	inline static constexpr unsigned int RPGDebugMonoTickBridge_TypeDefinitionIndex = 45027;
