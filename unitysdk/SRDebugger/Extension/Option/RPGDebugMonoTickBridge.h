...
#define SRDEBUGGER_EXTENSION_OPTION_RPGDEBUGMONOTICKBRIDGE_SET_LIFETIME_OFFSET UNITYSDK_OFFSET(0xB9319E0)
#define SRDEBUGGER_EXTENSION_OPTION_RPGDEBUGMONOTICKBRIDGE_UPDATE_OFFSET UNITYSDK_OFFSET(0xB9319F0)
#define SRDEBUGGER_EXTENSION_OPTION_RPGDEBUGMONOTICKBRIDGE__CTOR_OFFSET UNITYSDK_OFFSET(0xB931A60)

namespace SRDebugger::Extension::Option
{
	inline static constexpr unsigned int RPGDebugMonoTickBridge_TypeDefinitionIndex = 44481;
