...
#define SRDEBUGGER_ACTIONCOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A1EE720)
#define SRDEBUGGER_ACTIONCOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A1EE770)
#define SRDEBUGGER_ACTIONCOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A1EE710)
#define SRDEBUGGER_ACTIONCOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1EE6A0)

namespace SRDebugger
{
	inline static constexpr unsigned int ActionCompleteCallback_TypeDefinitionIndex = 36414;
