...
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1E6743F0)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_ENDFRAME_OFFSET UNITYSDK_OFFSET(0x1E674850)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_GET_AVERAGEFRAMETIME_OFFSET UNITYSDK_OFFSET(0x1E6743A0)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_GET_FRAMEBUFFER_OFFSET UNITYSDK_OFFSET(0x1E6743E0)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_GET_LASTFRAMETIME_OFFSET UNITYSDK_OFFSET(0x1E6743C0)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_ONCAMERAPOSTRENDER_OFFSET UNITYSDK_OFFSET(0x1E674A40)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_ONCAMERAPRERENDER_OFFSET UNITYSDK_OFFSET(0x1E6749F0)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1E6749B0)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_PUSHFRAME_OFFSET UNITYSDK_OFFSET(0x1E674960)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_SET_AVERAGEFRAMETIME_OFFSET UNITYSDK_OFFSET(0x1E6743B0)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_SET_LASTFRAMETIME_OFFSET UNITYSDK_OFFSET(0x1E6743D0)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E674650)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1E674A80)
