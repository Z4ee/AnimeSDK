...
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_AWAKE_OFFSET UNITYSDK_OFFSET(0x18435D10)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_ENDFRAME_OFFSET UNITYSDK_OFFSET(0x18436130)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_GET_AVERAGEFRAMETIME_OFFSET UNITYSDK_OFFSET(0x18435CC0)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_GET_FRAMEBUFFER_OFFSET UNITYSDK_OFFSET(0x18435D00)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_GET_LASTFRAMETIME_OFFSET UNITYSDK_OFFSET(0x18435CE0)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_ONCAMERAPOSTRENDER_OFFSET UNITYSDK_OFFSET(0x18436320)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_ONCAMERAPRERENDER_OFFSET UNITYSDK_OFFSET(0x184362D0)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x18436290)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_PUSHFRAME_OFFSET UNITYSDK_OFFSET(0x18436240)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_SET_AVERAGEFRAMETIME_OFFSET UNITYSDK_OFFSET(0x18435CD0)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_SET_LASTFRAMETIME_OFFSET UNITYSDK_OFFSET(0x18435CF0)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_UPDATE_OFFSET UNITYSDK_OFFSET(0x18435F80)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x18436360)

namespace SRDebugger::Profiler
{
	inline static constexpr unsigned int ProfilerServiceImpl_TypeDefinitionIndex = 29739;
