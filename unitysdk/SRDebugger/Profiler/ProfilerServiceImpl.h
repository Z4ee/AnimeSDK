...
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A1F4430)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_ENDFRAME_OFFSET UNITYSDK_OFFSET(0x1A1F4890)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_GET_AVERAGEFRAMETIME_OFFSET UNITYSDK_OFFSET(0x1A1F43E0)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_GET_FRAMEBUFFER_OFFSET UNITYSDK_OFFSET(0x1A1F4420)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_GET_LASTFRAMETIME_OFFSET UNITYSDK_OFFSET(0x1A1F4400)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_ONCAMERAPOSTRENDER_OFFSET UNITYSDK_OFFSET(0x1A1F4A80)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_ONCAMERAPRERENDER_OFFSET UNITYSDK_OFFSET(0x1A1F4A30)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A1F49F0)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_PUSHFRAME_OFFSET UNITYSDK_OFFSET(0x1A1F49A0)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_SET_AVERAGEFRAMETIME_OFFSET UNITYSDK_OFFSET(0x1A1F43F0)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_SET_LASTFRAMETIME_OFFSET UNITYSDK_OFFSET(0x1A1F4410)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A1F4690)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1F4AC0)

namespace SRDebugger::Profiler
{
	inline static constexpr unsigned int ProfilerServiceImpl_TypeDefinitionIndex = 36541;
