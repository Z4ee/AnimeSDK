...
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE__ENDOFFRAMECOROUTINE_D__20_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19E71780)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE__ENDOFFRAMECOROUTINE_D__20_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19E71810)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE__ENDOFFRAMECOROUTINE_D__20_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19E71870)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE__ENDOFFRAMECOROUTINE_D__20_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19E71820)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE__ENDOFFRAMECOROUTINE_D__20_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19E71770)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE__ENDOFFRAMECOROUTINE_D__20__CTOR_OFFSET UNITYSDK_OFFSET(0x19E71620)

namespace SRDebugger::Profiler
{
	inline static constexpr unsigned int SRPProfilerService__EndOfFrameCoroutine_d__20_TypeDefinitionIndex = 35461;
