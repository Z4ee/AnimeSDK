...
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1ACE7680)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_ENDFRAME_OFFSET UNITYSDK_OFFSET(0x1ACE7AC0)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_ENDOFFRAMECOROUTINE_OFFSET UNITYSDK_OFFSET(0x1ACE78A0)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_GET_AVERAGEFRAMETIME_OFFSET UNITYSDK_OFFSET(0x1ACE7630)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_GET_FRAMEBUFFER_OFFSET UNITYSDK_OFFSET(0x1ACE7670)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_GET_LASTFRAMETIME_OFFSET UNITYSDK_OFFSET(0x1ACE7650)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1ACE7C30)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_PUSHFRAME_OFFSET UNITYSDK_OFFSET(0x1ACE7BE0)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_RENDERPIPELINEONBEGINFRAMERENDERING_OFFSET UNITYSDK_OFFSET(0x1ACE7C70)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_SET_AVERAGEFRAMETIME_OFFSET UNITYSDK_OFFSET(0x1ACE7640)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_SET_LASTFRAMETIME_OFFSET UNITYSDK_OFFSET(0x1ACE7660)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1ACE78D0)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACE7CB0)

namespace SRDebugger::Profiler
{
	inline static constexpr unsigned int SRPProfilerService_TypeDefinitionIndex = 35760;
