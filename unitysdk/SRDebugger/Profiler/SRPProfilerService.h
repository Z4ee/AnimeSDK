...
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1BD9E930)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_ENDFRAME_OFFSET UNITYSDK_OFFSET(0x1BD9ED70)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_ENDOFFRAMECOROUTINE_OFFSET UNITYSDK_OFFSET(0x1BD9EB50)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_GET_AVERAGEFRAMETIME_OFFSET UNITYSDK_OFFSET(0x1BD9E8E0)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_GET_FRAMEBUFFER_OFFSET UNITYSDK_OFFSET(0x1BD9E920)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_GET_LASTFRAMETIME_OFFSET UNITYSDK_OFFSET(0x1BD9E900)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1BD9EEE0)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_PUSHFRAME_OFFSET UNITYSDK_OFFSET(0x1BD9EE90)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_RENDERPIPELINEONBEGINFRAMERENDERING_OFFSET UNITYSDK_OFFSET(0x1BD9EF20)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_SET_AVERAGEFRAMETIME_OFFSET UNITYSDK_OFFSET(0x1BD9E8F0)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_SET_LASTFRAMETIME_OFFSET UNITYSDK_OFFSET(0x1BD9E910)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1BD9EB80)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD9EF60)
