...
#define SRDEBUGGER_INTERNAL_SRDEBUGGERUTIL_ADDLEGACYINPUTSYSTEM_OFFSET UNITYSDK_OFFSET(0x1E672CE0)
#define SRDEBUGGER_INTERNAL_SRDEBUGGERUTIL_CONFIGURECANVAS_OFFSET UNITYSDK_OFFSET(0x1E673700)
#define SRDEBUGGER_INTERNAL_SRDEBUGGERUTIL_CREATEDEFAULTEVENTSYSTEM_OFFSET UNITYSDK_OFFSET(0x1E672C50)
#define SRDEBUGGER_INTERNAL_SRDEBUGGERUTIL_ENSUREEVENTSYSTEMEXISTS_OFFSET UNITYSDK_OFFSET(0x1E672A80)
#define SRDEBUGGER_INTERNAL_SRDEBUGGERUTIL_GETMETHODOPTIONDEFINITION_OFFSET UNITYSDK_OFFSET(0x1E673BD0)
#define SRDEBUGGER_INTERNAL_SRDEBUGGERUTIL_GETNUMBERSTRING_OFFSET UNITYSDK_OFFSET(0x1E6736D0)
#define SRDEBUGGER_INTERNAL_SRDEBUGGERUTIL_GETPROPERTYOPTIONDEFINITION_OFFSET UNITYSDK_OFFSET(0x1E673880)
#define SRDEBUGGER_INTERNAL_SRDEBUGGERUTIL_GET_ISMOBILEPLATFORM_OFFSET UNITYSDK_OFFSET(0x1E672A30)
#define SRDEBUGGER_INTERNAL_SRDEBUGGERUTIL_SCANFOROPTIONS_OFFSET UNITYSDK_OFFSET(0x1E672D30)
#define SRDEBUGGER_INTERNAL_SRDEBUGGERUTIL__GENERATEOPTIONDEFINITIONINITPARAM_OFFSET UNITYSDK_OFFSET(0x1E673940)
