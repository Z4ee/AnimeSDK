...
#define SRDEBUGGER_INTERNAL_SRDEBUGSTRINGS__CCTOR_OFFSET UNITYSDK_OFFSET(0x18434300)
#define SRDEBUGGER_INTERNAL_SRDEBUGSTRINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x18434270)

namespace SRDebugger::Internal
{
	inline static constexpr unsigned int SRDebugStrings_TypeDefinitionIndex = 29753;
	...
	public:
		...
		{
			return (::SRDebugger::Internal::SRDebugStrings**)Il2CppClass::FromTypeDefinitionIndex(SRDebugStrings_TypeDefinitionIndex)->GetStaticField(0x321C0);
		}
		::System::String* ProfilerCameraListenerHelp; // 0x10
		::System::String* Console_NoStackTrace; // 0x18
		::System::String* Profiler_EnableProfilerInfo; // 0x20
