...
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI_BUILDJSONREQUEST_OFFSET UNITYSDK_OFFSET(0x1A1EF060)
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI_CREATECONSOLEDUMP_OFFSET UNITYSDK_OFFSET(0x1A1EF3C0)
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI_GET_ERRORMESSAGE_OFFSET UNITYSDK_OFFSET(0x1A1EEE90)
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI_GET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1A1EEE50)
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI_GET_PROGRESS_OFFSET UNITYSDK_OFFSET(0x1A1EEEB0)
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI_GET_WASSUCCESSFUL_OFFSET UNITYSDK_OFFSET(0x1A1EEE70)
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI_SETCOMPLETIONSTATE_OFFSET UNITYSDK_OFFSET(0x1A1EEF80)
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI_SET_ERRORMESSAGE_OFFSET UNITYSDK_OFFSET(0x1A1EEEA0)
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI_SET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1A1EEE60)
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI_SET_WASSUCCESSFUL_OFFSET UNITYSDK_OFFSET(0x1A1EEE80)
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI_SUBMIT_OFFSET UNITYSDK_OFFSET(0x1A1EEF20)
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1EEE40)

namespace SRDebugger::Internal
{
	inline static constexpr unsigned int BugReportApi_TypeDefinitionIndex = 36546;
	...
	public:
		...
		::System::String* _apiKey; // 0x20
		::SRDebugger::Services::BugReport* _bugReport; // 0x28
		::System::Boolean _isBusy; // 0x30
		::System::Boolean _WasSuccessful_k__BackingField; // 0x31
		::System::Boolean _IsComplete_k__BackingField; // 0x32
