...
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI__SUBMIT_D__19_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A1EFC80)
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI__SUBMIT_D__19_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A1F0D80)
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI__SUBMIT_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A1F0DE0)
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI__SUBMIT_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A1F0D90)
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI__SUBMIT_D__19_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A1EFC70)
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI__SUBMIT_D__19__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1EEF70)

namespace SRDebugger::Internal
{
	inline static constexpr unsigned int BugReportApi__Submit_d__19_TypeDefinitionIndex = 36547;
