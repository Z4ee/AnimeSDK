...
#define SRDEBUGGER_SERVICES_BUGREPORTPROGRESSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184391B0)
#define SRDEBUGGER_SERVICES_BUGREPORTPROGRESSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18439200)
#define SRDEBUGGER_SERVICES_BUGREPORTPROGRESSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18438E50)
#define SRDEBUGGER_SERVICES_BUGREPORTPROGRESSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18438E30)

namespace SRDebugger::Services
{
	inline static constexpr unsigned int BugReportProgressCallback_TypeDefinitionIndex = 29698;
