...
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_PINENTRYSERVICEIMPL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1BDA9F60)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_PINENTRYSERVICEIMPL_GET_ISSHOWINGKEYPAD_OFFSET UNITYSDK_OFFSET(0x1BDA9220)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_PINENTRYSERVICEIMPL_LOAD_OFFSET UNITYSDK_OFFSET(0x1BDA99D0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_PINENTRYSERVICEIMPL_PINCONTROLONCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1BDAA0F0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_PINENTRYSERVICEIMPL_SHOWPINENTRY_1_OFFSET UNITYSDK_OFFSET(0x1BDA9F40)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_PINENTRYSERVICEIMPL_SHOWPINENTRY_OFFSET UNITYSDK_OFFSET(0x1BDA9230)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_PINENTRYSERVICEIMPL_VERIFYPIN_OFFSET UNITYSDK_OFFSET(0x1BDA9510)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_PINENTRYSERVICEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDAA260)

namespace SRDebugger::Services::Implementation
{
	inline static constexpr unsigned int PinEntryServiceImpl_TypeDefinitionIndex = 37391;
