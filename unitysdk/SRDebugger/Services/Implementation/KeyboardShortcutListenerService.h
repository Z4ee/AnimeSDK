...
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_KEYBOARDSHORTCUTLISTENERSERVICE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1E67C6B0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_KEYBOARDSHORTCUTLISTENERSERVICE_EXECUTESHORTCUT_OFFSET UNITYSDK_OFFSET(0x1E67CB00)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_KEYBOARDSHORTCUTLISTENERSERVICE_TOGGLETAB_OFFSET UNITYSDK_OFFSET(0x1E67C7F0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_KEYBOARDSHORTCUTLISTENERSERVICE_UPDATELEGACYINPUTSYSTEM_OFFSET UNITYSDK_OFFSET(0x1E67D790)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_KEYBOARDSHORTCUTLISTENERSERVICE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E67D780)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_KEYBOARDSHORTCUTLISTENERSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E67DBB0)
