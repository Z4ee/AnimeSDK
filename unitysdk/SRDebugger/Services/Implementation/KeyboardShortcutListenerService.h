...
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_KEYBOARDSHORTCUTLISTENERSERVICE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A1FC5E0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_KEYBOARDSHORTCUTLISTENERSERVICE_EXECUTESHORTCUT_OFFSET UNITYSDK_OFFSET(0x1A1FCA30)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_KEYBOARDSHORTCUTLISTENERSERVICE_TOGGLETAB_OFFSET UNITYSDK_OFFSET(0x1A1FC720)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_KEYBOARDSHORTCUTLISTENERSERVICE_UPDATELEGACYINPUTSYSTEM_OFFSET UNITYSDK_OFFSET(0x1A1FD6C0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_KEYBOARDSHORTCUTLISTENERSERVICE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A1FD6B0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_KEYBOARDSHORTCUTLISTENERSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1FDAE0)

namespace SRDebugger::Services::Implementation
{
	inline static constexpr unsigned int KeyboardShortcutListenerService_TypeDefinitionIndex = 36528;
