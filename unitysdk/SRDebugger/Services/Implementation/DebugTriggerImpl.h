...
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGTRIGGERIMPL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1BDA50B0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGTRIGGERIMPL_CREATETRIGGER_OFFSET UNITYSDK_OFFSET(0x1BDA4650)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGTRIGGERIMPL_GET_ISENABLED_OFFSET UNITYSDK_OFFSET(0x1BDA4570)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGTRIGGERIMPL_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1BDA4F30)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGTRIGGERIMPL_ONACTIVESCENECHANGED_OFFSET UNITYSDK_OFFSET(0x1BDA5490)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGTRIGGERIMPL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1BDA5260)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGTRIGGERIMPL_ONERROR_OFFSET UNITYSDK_OFFSET(0x1BDA51A0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGTRIGGERIMPL_ONTRIGGERBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1BDA54A0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGTRIGGERIMPL_SETTRIGGERPOSITION_OFFSET UNITYSDK_OFFSET(0x1BDA5010)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGTRIGGERIMPL_SET_ISENABLED_OFFSET UNITYSDK_OFFSET(0x1BDA45D0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGTRIGGERIMPL_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1BDA4F40)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGTRIGGERIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDA5700)
