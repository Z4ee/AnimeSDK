...
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTAPISERVICE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A1F8660)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTAPISERVICE_ONCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1A1F8740)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTAPISERVICE_ONPROGRESS_OFFSET UNITYSDK_OFFSET(0x1A1F8720)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTAPISERVICE_SENDBUGREPORT_OFFSET UNITYSDK_OFFSET(0x1A1F84B0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTAPISERVICE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A1F87B0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTAPISERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1F89B0)

namespace SRDebugger::Services::Implementation
{
	inline static constexpr unsigned int BugReportApiService_TypeDefinitionIndex = 36520;
