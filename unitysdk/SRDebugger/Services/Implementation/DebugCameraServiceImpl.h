...
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGCAMERASERVICEIMPL_GET_CAMERA_OFFSET UNITYSDK_OFFSET(0x1E679D30)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGCAMERASERVICEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1E679B10)
