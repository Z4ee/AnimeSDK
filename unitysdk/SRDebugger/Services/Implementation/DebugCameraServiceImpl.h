...
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGCAMERASERVICEIMPL_GET_CAMERA_OFFSET UNITYSDK_OFFSET(0x1843B470)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGCAMERASERVICEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1843B1C0)

namespace SRDebugger::Services::Implementation
{
	inline static constexpr unsigned int DebugCameraServiceImpl_TypeDefinitionIndex = 29721;
