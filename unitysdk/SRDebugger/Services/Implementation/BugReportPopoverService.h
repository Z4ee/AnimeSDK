...
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A1F97D0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_CANCELPRESSED_OFFSET UNITYSDK_OFFSET(0x1A1F95D0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_GET_ISSHOWINGPOPOVER_OFFSET UNITYSDK_OFFSET(0x1A1F89D0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_LOAD_OFFSET UNITYSDK_OFFSET(0x1A1F8BA0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_ONCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1A1F9450)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_OPENCO_OFFSET UNITYSDK_OFFSET(0x1A1F93D0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_SCREENSHOTCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1A1F96F0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_SHOWBUGREPORTER_OFFSET UNITYSDK_OFFSET(0x1A1F89E0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_SUBMITCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1A1F9440)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_TAKINGSCREENSHOT_OFFSET UNITYSDK_OFFSET(0x1A1F9610)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1F9890)

namespace SRDebugger::Services::Implementation
{
	inline static constexpr unsigned int BugReportPopoverService_TypeDefinitionIndex = 36521;
