...
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1843AEB0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_CANCELPRESSED_OFFSET UNITYSDK_OFFSET(0x1843ACB0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_GET_ISSHOWINGPOPOVER_OFFSET UNITYSDK_OFFSET(0x1843A2B0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_LOAD_OFFSET UNITYSDK_OFFSET(0x1843A470)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_ONCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1843AB40)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_OPENCO_OFFSET UNITYSDK_OFFSET(0x1843AAC0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_SCREENSHOTCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1843ADD0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_SHOWBUGREPORTER_OFFSET UNITYSDK_OFFSET(0x1843A2C0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_SUBMITCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1843AB30)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_TAKINGSCREENSHOT_OFFSET UNITYSDK_OFFSET(0x1843ACF0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1843AF70)

namespace SRDebugger::Services::Implementation
{
	inline static constexpr unsigned int BugReportPopoverService_TypeDefinitionIndex = 29719;
