...
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_ADD_VISIBILITYCHANGED_OFFSET UNITYSDK_OFFSET(0x1E679D40)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E67A570)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_GET_ACTIVETAB_OFFSET UNITYSDK_OFFSET(0x1E67A3C0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_GET_ISINCONTROLMODE_OFFSET UNITYSDK_OFFSET(0x1E67A740)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_GET_ISLOADED_OFFSET UNITYSDK_OFFSET(0x1E679E10)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x1E679E30)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_GET_ROOTOBJECT_OFFSET UNITYSDK_OFFSET(0x1E679E00)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_LOAD_OFFSET UNITYSDK_OFFSET(0x1E679FB0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_MOVESCROLLCONTENT_OFFSET UNITYSDK_OFFSET(0x1E67A5B0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_OPENTAB_OFFSET UNITYSDK_OFFSET(0x1E67A400)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_OPTIONCONTROL_OFFSET UNITYSDK_OFFSET(0x1E67A6B0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_REMOVE_VISIBILITYCHANGED_OFFSET UNITYSDK_OFFSET(0x1E679DA0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_SELECTNEXTTAB_OFFSET UNITYSDK_OFFSET(0x1E67A650)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_SELECTPRETAB_OFFSET UNITYSDK_OFFSET(0x1E67A680)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_SET_ISINCONTROLMODE_OFFSET UNITYSDK_OFFSET(0x1E67A750)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_SET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x1E679E50)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_SRDEBUGGER_SERVICES_IDEBUGPANELSERVICE_ISTABSHOW_OFFSET UNITYSDK_OFFSET(0x1E67A700)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1E67A4C0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1E67A760)
