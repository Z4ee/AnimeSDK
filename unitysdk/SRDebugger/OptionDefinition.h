...
#define SRDEBUGGER_OPTIONDEFINITION_CREATE_OFFSET UNITYSDK_OFFSET(0x1A1F42D0)
#define SRDEBUGGER_OPTIONDEFINITION_FROMMETHOD_1_OFFSET UNITYSDK_OFFSET(0x1A1F42E0)
#define SRDEBUGGER_OPTIONDEFINITION_FROMMETHOD_OFFSET UNITYSDK_OFFSET(0x1A1F41B0)
#define SRDEBUGGER_OPTIONDEFINITION_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0x1A1F40C0)
#define SRDEBUGGER_OPTIONDEFINITION_GET_ISMETHOD_OFFSET UNITYSDK_OFFSET(0x1A1F4120)
#define SRDEBUGGER_OPTIONDEFINITION_GET_ISPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A1F4130)
#define SRDEBUGGER_OPTIONDEFINITION_GET_METHOD_OFFSET UNITYSDK_OFFSET(0x1A1F4140)
#define SRDEBUGGER_OPTIONDEFINITION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A1F40A0)
#define SRDEBUGGER_OPTIONDEFINITION_GET_PROPERTY_OFFSET UNITYSDK_OFFSET(0x1A1F4160)
#define SRDEBUGGER_OPTIONDEFINITION_GET_SORTPRIORITY_OFFSET UNITYSDK_OFFSET(0x1A1F40E0)
#define SRDEBUGGER_OPTIONDEFINITION_GET_TARGETTAB_OFFSET UNITYSDK_OFFSET(0x1A1F4100)
#define SRDEBUGGER_OPTIONDEFINITION_SET_CATEGORY_OFFSET UNITYSDK_OFFSET(0x1A1F40D0)
#define SRDEBUGGER_OPTIONDEFINITION_SET_METHOD_OFFSET UNITYSDK_OFFSET(0x1A1F4150)
#define SRDEBUGGER_OPTIONDEFINITION_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1A1F40B0)
#define SRDEBUGGER_OPTIONDEFINITION_SET_PROPERTY_OFFSET UNITYSDK_OFFSET(0x1A1F4170)
#define SRDEBUGGER_OPTIONDEFINITION_SET_SORTPRIORITY_OFFSET UNITYSDK_OFFSET(0x1A1F40F0)
#define SRDEBUGGER_OPTIONDEFINITION_SET_TARGETTAB_OFFSET UNITYSDK_OFFSET(0x1A1F4110)
#define SRDEBUGGER_OPTIONDEFINITION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1F3DC0)
#define SRDEBUGGER_OPTIONDEFINITION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A1F3BE0)
#define SRDEBUGGER_OPTIONDEFINITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1F4180)

namespace SRDebugger
{
	inline static constexpr unsigned int OptionDefinition_TypeDefinitionIndex = 36403;

	class OptionDefinition : public ::System::Object
	{
	public:
		::System::String* _TargetTab_k__BackingField; // 0x10
		::SRF::Helpers::MethodReference* _Method_k__BackingField; // 0x18
		::System::String* _Category_k__BackingField; // 0x20
		::System::String* _Name_k__BackingField; // 0x28
		::SRF::Helpers::PropertyReference* _Property_k__BackingField; // 0x30
