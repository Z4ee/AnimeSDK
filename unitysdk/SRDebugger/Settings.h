...
#define SRDEBUGGER_SETTINGS_ADD_PROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1ACFCE20)
#define SRDEBUGGER_SETTINGS_CLEARCACHE_OFFSET UNITYSDK_OFFSET(0x1ACFD4A0)
#define SRDEBUGGER_SETTINGS_GETDEFAULTKEYBOARDSHORTCUTS_OFFSET UNITYSDK_OFFSET(0x1ACFCA70)
#define SRDEBUGGER_SETTINGS_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1ACFD630)
#define SRDEBUGGER_SETTINGS_GETORCREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1ACFCA40)
#define SRDEBUGGER_SETTINGS_GET_APIKEY_OFFSET UNITYSDK_OFFSET(0x1ACFD270)
#define SRDEBUGGER_SETTINGS_GET_AUTOMATICALLYSHOWCURSOR_OFFSET UNITYSDK_OFFSET(0x1ACFD340)
#define SRDEBUGGER_SETTINGS_GET_COLLAPSEDUPLICATELOGENTRIES_OFFSET UNITYSDK_OFFSET(0x1ACFD250)
#define SRDEBUGGER_SETTINGS_GET_CONSOLEALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1ACFD2E0)
#define SRDEBUGGER_SETTINGS_GET_DEBUGCAMERADEPTH_OFFSET UNITYSDK_OFFSET(0x1ACFD240)
#define SRDEBUGGER_SETTINGS_GET_DEBUGLAYER_OFFSET UNITYSDK_OFFSET(0x1ACFD230)
#define SRDEBUGGER_SETTINGS_GET_DEFAULTTAB_OFFSET UNITYSDK_OFFSET(0x1ACFCF40)
#define SRDEBUGGER_SETTINGS_GET_DISABLEDTABS_OFFSET UNITYSDK_OFFSET(0x1ACFD2A0)
#define SRDEBUGGER_SETTINGS_GET_ENABLEBACKGROUNDTRANSPARENCY_OFFSET UNITYSDK_OFFSET(0x1ACFCFB0)
#define SRDEBUGGER_SETTINGS_GET_ENABLEBUGREPORTER_OFFSET UNITYSDK_OFFSET(0x1ACFD280)
#define SRDEBUGGER_SETTINGS_GET_ENABLEBUGREPORTSCREENSHOT_OFFSET UNITYSDK_OFFSET(0x1ACFD290)
#define SRDEBUGGER_SETTINGS_GET_ENABLEEVENTSYSTEMGENERATION_OFFSET UNITYSDK_OFFSET(0x1ACFD320)
#define SRDEBUGGER_SETTINGS_GET_ENABLEKEYBOARDSHORTCUTS_OFFSET UNITYSDK_OFFSET(0x1ACFCF80)
#define SRDEBUGGER_SETTINGS_GET_ENABLETRIGGER_OFFSET UNITYSDK_OFFSET(0x1ACFCF50)
#define SRDEBUGGER_SETTINGS_GET_ENTRYCODE_OFFSET UNITYSDK_OFFSET(0x1ACF57F0)
#define SRDEBUGGER_SETTINGS_GET_ERRORNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x1ACFCF70)
#define SRDEBUGGER_SETTINGS_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1ACE5BE0)
#define SRDEBUGGER_SETTINGS_GET_ISENABLED_OFFSET UNITYSDK_OFFSET(0x1ACFCF20)
#define SRDEBUGGER_SETTINGS_GET_KEYBOARDESCAPECLOSE_OFFSET UNITYSDK_OFFSET(0x1ACFCFA0)
#define SRDEBUGGER_SETTINGS_GET_KEYBOARDSHORTCUTS_OFFSET UNITYSDK_OFFSET(0x1ACFCF90)
#define SRDEBUGGER_SETTINGS_GET_MAXIMUMCONSOLEENTRIES_OFFSET UNITYSDK_OFFSET(0x1ACFD300)
#define SRDEBUGGER_SETTINGS_GET_OPTIONSALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1ACFD2D0)
#define SRDEBUGGER_SETTINGS_GET_PROFILERALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1ACFD2C0)
#define SRDEBUGGER_SETTINGS_GET_REQUIRECODE_OFFSET UNITYSDK_OFFSET(0x1ACFCFC0)
#define SRDEBUGGER_SETTINGS_GET_REQUIREENTRYCODEEVERYTIME_OFFSET UNITYSDK_OFFSET(0x1ACFCFD0)
#define SRDEBUGGER_SETTINGS_GET_RICHTEXTINCONSOLE_OFFSET UNITYSDK_OFFSET(0x1ACFD260)
#define SRDEBUGGER_SETTINGS_GET_TRIGGERBEHAVIOUR_OFFSET UNITYSDK_OFFSET(0x1ACFCF60)
#define SRDEBUGGER_SETTINGS_GET_TRIGGERPOSITION_OFFSET UNITYSDK_OFFSET(0x1ACFD2B0)
#define SRDEBUGGER_SETTINGS_GET_UIINPUTMODE_OFFSET UNITYSDK_OFFSET(0x1ACFCF30)
#define SRDEBUGGER_SETTINGS_GET_UISCALE_OFFSET UNITYSDK_OFFSET(0x1ACFD350)
#define SRDEBUGGER_SETTINGS_GET_UNLOADONCLOSE_OFFSET UNITYSDK_OFFSET(0x1ACFD490)
#define SRDEBUGGER_SETTINGS_GET_USEDEBUGCAMERA_OFFSET UNITYSDK_OFFSET(0x1ACFD220)
#define SRDEBUGGER_SETTINGS_ONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1ACFD420)
#define SRDEBUGGER_SETTINGS_REMOVE_PROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1ACFCEA0)
#define SRDEBUGGER_SETTINGS_SET_CONSOLEALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1ACFD2F0)
#define SRDEBUGGER_SETTINGS_SET_ENABLEEVENTSYSTEMGENERATION_OFFSET UNITYSDK_OFFSET(0x1ACFD330)
#define SRDEBUGGER_SETTINGS_SET_ENTRYCODE_OFFSET UNITYSDK_OFFSET(0x1ACFCFE0)
#define SRDEBUGGER_SETTINGS_SET_MAXIMUMCONSOLEENTRIES_OFFSET UNITYSDK_OFFSET(0x1ACFD310)
#define SRDEBUGGER_SETTINGS_SET_UISCALE_OFFSET UNITYSDK_OFFSET(0x1ACFD360)
#define SRDEBUGGER_SETTINGS_UPGRADEKEYBOARDSHORTCUTS_OFFSET UNITYSDK_OFFSET(0x1ACFCBA0)
#define SRDEBUGGER_SETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACFD870)

namespace SRDebugger
{
	inline static constexpr unsigned int Settings_TypeDefinitionIndex = 35639;
	...
	public:
		...
		{
			return (::SRDebugger::Settings**)Il2CppClass::FromTypeDefinitionIndex(Settings_TypeDefinitionIndex)->GetStaticField(0x63C20);
		}
