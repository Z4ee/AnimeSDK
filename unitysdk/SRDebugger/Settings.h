...
#define SRDEBUGGER_SETTINGS_ADD_PROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x19E868E0)
#define SRDEBUGGER_SETTINGS_CLEARCACHE_OFFSET UNITYSDK_OFFSET(0x19E86EF0)
#define SRDEBUGGER_SETTINGS_GETDEFAULTKEYBOARDSHORTCUTS_OFFSET UNITYSDK_OFFSET(0x19E864F0)
#define SRDEBUGGER_SETTINGS_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x19E87080)
#define SRDEBUGGER_SETTINGS_GETORCREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x19E864C0)
#define SRDEBUGGER_SETTINGS_GET_APIKEY_OFFSET UNITYSDK_OFFSET(0x19E86CC0)
#define SRDEBUGGER_SETTINGS_GET_AUTOMATICALLYSHOWCURSOR_OFFSET UNITYSDK_OFFSET(0x19E86D90)
#define SRDEBUGGER_SETTINGS_GET_COLLAPSEDUPLICATELOGENTRIES_OFFSET UNITYSDK_OFFSET(0x19E86CA0)
#define SRDEBUGGER_SETTINGS_GET_CONSOLEALIGNMENT_OFFSET UNITYSDK_OFFSET(0x19E86D30)
#define SRDEBUGGER_SETTINGS_GET_DEBUGCAMERADEPTH_OFFSET UNITYSDK_OFFSET(0x19E86C90)
#define SRDEBUGGER_SETTINGS_GET_DEBUGLAYER_OFFSET UNITYSDK_OFFSET(0x19E86C80)
#define SRDEBUGGER_SETTINGS_GET_DEFAULTTAB_OFFSET UNITYSDK_OFFSET(0x19E869C0)
#define SRDEBUGGER_SETTINGS_GET_DISABLEDTABS_OFFSET UNITYSDK_OFFSET(0x19E86CF0)
#define SRDEBUGGER_SETTINGS_GET_ENABLEBACKGROUNDTRANSPARENCY_OFFSET UNITYSDK_OFFSET(0x19E86A30)
#define SRDEBUGGER_SETTINGS_GET_ENABLEBUGREPORTER_OFFSET UNITYSDK_OFFSET(0x19E86CD0)
#define SRDEBUGGER_SETTINGS_GET_ENABLEBUGREPORTSCREENSHOT_OFFSET UNITYSDK_OFFSET(0x19E86CE0)
#define SRDEBUGGER_SETTINGS_GET_ENABLEEVENTSYSTEMGENERATION_OFFSET UNITYSDK_OFFSET(0x19E86D70)
#define SRDEBUGGER_SETTINGS_GET_ENABLEKEYBOARDSHORTCUTS_OFFSET UNITYSDK_OFFSET(0x19E86A00)
#define SRDEBUGGER_SETTINGS_GET_ENABLETRIGGER_OFFSET UNITYSDK_OFFSET(0x19E869D0)
#define SRDEBUGGER_SETTINGS_GET_ENTRYCODE_OFFSET UNITYSDK_OFFSET(0x19E7F0C0)
#define SRDEBUGGER_SETTINGS_GET_ERRORNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x19E869F0)
#define SRDEBUGGER_SETTINGS_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x19E6F2C0)
#define SRDEBUGGER_SETTINGS_GET_ISENABLED_OFFSET UNITYSDK_OFFSET(0x19E869A0)
#define SRDEBUGGER_SETTINGS_GET_KEYBOARDESCAPECLOSE_OFFSET UNITYSDK_OFFSET(0x19E86A20)
#define SRDEBUGGER_SETTINGS_GET_KEYBOARDSHORTCUTS_OFFSET UNITYSDK_OFFSET(0x19E86A10)
#define SRDEBUGGER_SETTINGS_GET_MAXIMUMCONSOLEENTRIES_OFFSET UNITYSDK_OFFSET(0x19E86D50)
#define SRDEBUGGER_SETTINGS_GET_OPTIONSALIGNMENT_OFFSET UNITYSDK_OFFSET(0x19E86D20)
#define SRDEBUGGER_SETTINGS_GET_PROFILERALIGNMENT_OFFSET UNITYSDK_OFFSET(0x19E86D10)
#define SRDEBUGGER_SETTINGS_GET_REQUIRECODE_OFFSET UNITYSDK_OFFSET(0x19E86A40)
#define SRDEBUGGER_SETTINGS_GET_REQUIREENTRYCODEEVERYTIME_OFFSET UNITYSDK_OFFSET(0x19E86A50)
#define SRDEBUGGER_SETTINGS_GET_RICHTEXTINCONSOLE_OFFSET UNITYSDK_OFFSET(0x19E86CB0)
#define SRDEBUGGER_SETTINGS_GET_TRIGGERBEHAVIOUR_OFFSET UNITYSDK_OFFSET(0x19E869E0)
#define SRDEBUGGER_SETTINGS_GET_TRIGGERPOSITION_OFFSET UNITYSDK_OFFSET(0x19E86D00)
#define SRDEBUGGER_SETTINGS_GET_UIINPUTMODE_OFFSET UNITYSDK_OFFSET(0x19E869B0)
#define SRDEBUGGER_SETTINGS_GET_UISCALE_OFFSET UNITYSDK_OFFSET(0x19E86DA0)
#define SRDEBUGGER_SETTINGS_GET_UNLOADONCLOSE_OFFSET UNITYSDK_OFFSET(0x19E86EE0)
#define SRDEBUGGER_SETTINGS_GET_USEDEBUGCAMERA_OFFSET UNITYSDK_OFFSET(0x19E86C70)
#define SRDEBUGGER_SETTINGS_ONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x19E86E70)
#define SRDEBUGGER_SETTINGS_REMOVE_PROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x19E86940)
#define SRDEBUGGER_SETTINGS_SET_CONSOLEALIGNMENT_OFFSET UNITYSDK_OFFSET(0x19E86D40)
#define SRDEBUGGER_SETTINGS_SET_ENABLEEVENTSYSTEMGENERATION_OFFSET UNITYSDK_OFFSET(0x19E86D80)
#define SRDEBUGGER_SETTINGS_SET_ENTRYCODE_OFFSET UNITYSDK_OFFSET(0x19E86A60)
#define SRDEBUGGER_SETTINGS_SET_MAXIMUMCONSOLEENTRIES_OFFSET UNITYSDK_OFFSET(0x19E86D60)
#define SRDEBUGGER_SETTINGS_SET_UISCALE_OFFSET UNITYSDK_OFFSET(0x19E86DB0)
#define SRDEBUGGER_SETTINGS_UPGRADEKEYBOARDSHORTCUTS_OFFSET UNITYSDK_OFFSET(0x19E86660)
#define SRDEBUGGER_SETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x19E87210)

namespace SRDebugger
{
	inline static constexpr unsigned int Settings_TypeDefinitionIndex = 35339;
	...
	public:
		...
		{
			return (::SRDebugger::Settings**)Il2CppClass::FromTypeDefinitionIndex(Settings_TypeDefinitionIndex)->GetStaticField(0x68BD0);
		}
