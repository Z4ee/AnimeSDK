...
#define SRDEBUGGER_SETTINGS_ADD_PROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1E68B5A0)
#define SRDEBUGGER_SETTINGS_CLEARCACHE_OFFSET UNITYSDK_OFFSET(0x1E68BC40)
#define SRDEBUGGER_SETTINGS_GETDEFAULTKEYBOARDSHORTCUTS_OFFSET UNITYSDK_OFFSET(0x1E68B1F0)
#define SRDEBUGGER_SETTINGS_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1E68BE30)
#define SRDEBUGGER_SETTINGS_GETORCREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1E68B120)
#define SRDEBUGGER_SETTINGS_GET_APIKEY_OFFSET UNITYSDK_OFFSET(0x1E68BA10)
#define SRDEBUGGER_SETTINGS_GET_AUTOMATICALLYSHOWCURSOR_OFFSET UNITYSDK_OFFSET(0x1E68BAE0)
#define SRDEBUGGER_SETTINGS_GET_COLLAPSEDUPLICATELOGENTRIES_OFFSET UNITYSDK_OFFSET(0x1E68B9F0)
#define SRDEBUGGER_SETTINGS_GET_CONSOLEALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1E68BA80)
#define SRDEBUGGER_SETTINGS_GET_DEBUGCAMERADEPTH_OFFSET UNITYSDK_OFFSET(0x1E68B9E0)
#define SRDEBUGGER_SETTINGS_GET_DEBUGLAYER_OFFSET UNITYSDK_OFFSET(0x1E68B9D0)
#define SRDEBUGGER_SETTINGS_GET_DEFAULTTAB_OFFSET UNITYSDK_OFFSET(0x1E68B680)
#define SRDEBUGGER_SETTINGS_GET_DISABLEDTABS_OFFSET UNITYSDK_OFFSET(0x1E68BA40)
#define SRDEBUGGER_SETTINGS_GET_ENABLEBACKGROUNDTRANSPARENCY_OFFSET UNITYSDK_OFFSET(0x1E68B6F0)
#define SRDEBUGGER_SETTINGS_GET_ENABLEBUGREPORTER_OFFSET UNITYSDK_OFFSET(0x1E68BA20)
#define SRDEBUGGER_SETTINGS_GET_ENABLEBUGREPORTSCREENSHOT_OFFSET UNITYSDK_OFFSET(0x1E68BA30)
#define SRDEBUGGER_SETTINGS_GET_ENABLEEVENTSYSTEMGENERATION_OFFSET UNITYSDK_OFFSET(0x1E68BAC0)
#define SRDEBUGGER_SETTINGS_GET_ENABLEKEYBOARDSHORTCUTS_OFFSET UNITYSDK_OFFSET(0x1E68B6C0)
#define SRDEBUGGER_SETTINGS_GET_ENABLETRIGGER_OFFSET UNITYSDK_OFFSET(0x1E68B690)
#define SRDEBUGGER_SETTINGS_GET_ENTRYCODE_OFFSET UNITYSDK_OFFSET(0x1E683490)
#define SRDEBUGGER_SETTINGS_GET_ERRORNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x1E68B6B0)
#define SRDEBUGGER_SETTINGS_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1E672C10)
#define SRDEBUGGER_SETTINGS_GET_ISENABLED_OFFSET UNITYSDK_OFFSET(0x1E68B660)
#define SRDEBUGGER_SETTINGS_GET_KEYBOARDESCAPECLOSE_OFFSET UNITYSDK_OFFSET(0x1E68B6E0)
#define SRDEBUGGER_SETTINGS_GET_KEYBOARDSHORTCUTS_OFFSET UNITYSDK_OFFSET(0x1E68B6D0)
#define SRDEBUGGER_SETTINGS_GET_MAXIMUMCONSOLEENTRIES_OFFSET UNITYSDK_OFFSET(0x1E68BAA0)
#define SRDEBUGGER_SETTINGS_GET_OPTIONSALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1E68BA70)
#define SRDEBUGGER_SETTINGS_GET_PROFILERALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1E68BA60)
#define SRDEBUGGER_SETTINGS_GET_REQUIRECODE_OFFSET UNITYSDK_OFFSET(0x1E68B700)
#define SRDEBUGGER_SETTINGS_GET_REQUIREENTRYCODEEVERYTIME_OFFSET UNITYSDK_OFFSET(0x1E68B710)
#define SRDEBUGGER_SETTINGS_GET_RICHTEXTINCONSOLE_OFFSET UNITYSDK_OFFSET(0x1E68BA00)
#define SRDEBUGGER_SETTINGS_GET_TRIGGERBEHAVIOUR_OFFSET UNITYSDK_OFFSET(0x1E68B6A0)
#define SRDEBUGGER_SETTINGS_GET_TRIGGERPOSITION_OFFSET UNITYSDK_OFFSET(0x1E68BA50)
#define SRDEBUGGER_SETTINGS_GET_UIINPUTMODE_OFFSET UNITYSDK_OFFSET(0x1E68B670)
#define SRDEBUGGER_SETTINGS_GET_UISCALE_OFFSET UNITYSDK_OFFSET(0x1E68BAF0)
#define SRDEBUGGER_SETTINGS_GET_UNLOADONCLOSE_OFFSET UNITYSDK_OFFSET(0x1E68BC30)
#define SRDEBUGGER_SETTINGS_GET_USEDEBUGCAMERA_OFFSET UNITYSDK_OFFSET(0x1E68B9C0)
#define SRDEBUGGER_SETTINGS_ONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1E68BBC0)
#define SRDEBUGGER_SETTINGS_REMOVE_PROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1E68B600)
#define SRDEBUGGER_SETTINGS_SET_CONSOLEALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1E68BA90)
#define SRDEBUGGER_SETTINGS_SET_ENABLEEVENTSYSTEMGENERATION_OFFSET UNITYSDK_OFFSET(0x1E68BAD0)
#define SRDEBUGGER_SETTINGS_SET_ENTRYCODE_OFFSET UNITYSDK_OFFSET(0x1E68B720)
#define SRDEBUGGER_SETTINGS_SET_MAXIMUMCONSOLEENTRIES_OFFSET UNITYSDK_OFFSET(0x1E68BAB0)
#define SRDEBUGGER_SETTINGS_SET_UISCALE_OFFSET UNITYSDK_OFFSET(0x1E68BB00)
#define SRDEBUGGER_SETTINGS_UPGRADEKEYBOARDSHORTCUTS_OFFSET UNITYSDK_OFFSET(0x1E68B320)
#define SRDEBUGGER_SETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E68BEE0)
...
namespace SRDebugger
{
	...
	public:
		...
		{
			return (::SRDebugger::Settings**)Il2CppClass::FromTypeDefinitionIndex(Settings_TypeDefinitionIndex)->GetStaticField(0x47820);
		}
