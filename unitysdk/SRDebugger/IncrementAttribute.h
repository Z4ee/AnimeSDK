...
#define SRDEBUGGER_INCREMENTATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1EEBD0)

namespace SRDebugger
{
	inline static constexpr unsigned int IncrementAttribute_TypeDefinitionIndex = 36408;
