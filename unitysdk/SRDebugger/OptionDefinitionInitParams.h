...
#define SRDEBUGGER_OPTIONDEFINITIONINITPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x19E6FF40)

namespace SRDebugger
{
	inline static constexpr unsigned int OptionDefinitionInitParams_TypeDefinitionIndex = 35320;
