...
#define SRDEBUGGER_OPTIONDEFINITIONINITPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x18435240)

namespace SRDebugger
{
	inline static constexpr unsigned int OptionDefinitionInitParams_TypeDefinitionIndex = 29600;

	class OptionDefinitionInitParams : public ::System::Object
	{
	public:
		::System::String* Category; // 0x10
		::System::String* TargetTab; // 0x18
