...
#define SRDEBUGGER_CUSTOMOPTIONSATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1EE7E0)

namespace SRDebugger
{
	inline static constexpr unsigned int CustomOptionsAttribute_TypeDefinitionIndex = 36412;
