...
#define SRDEBUGGER_DROPSELECTATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACE2210)

namespace SRDebugger
{
	inline static constexpr unsigned int DropSelectAttribute_TypeDefinitionIndex = 35623;
