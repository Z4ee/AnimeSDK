...
#define SRDEBUGGER_DEBUGGERSPEED_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x12424BE0)
#define SRDEBUGGER_DEBUGGERSPEED_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x12424960)
#define SRDEBUGGER_DEBUGGERSPEED_UPDATE_OFFSET UNITYSDK_OFFSET(0x124246E0)
#define SRDEBUGGER_DEBUGGERSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x12424E60)

namespace SRDebugger
{
	inline static constexpr unsigned int DebuggerSpeed_TypeDefinitionIndex = 95383;
