...
#define SRDEBUGGER_DEBUGGERSPEED_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x103435C0)
#define SRDEBUGGER_DEBUGGERSPEED_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x10343340)
#define SRDEBUGGER_DEBUGGERSPEED_UPDATE_OFFSET UNITYSDK_OFFSET(0x103430C0)
#define SRDEBUGGER_DEBUGGERSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x10343840)

namespace SRDebugger
{
	inline static constexpr unsigned int DebuggerSpeed_TypeDefinitionIndex = 85949;
