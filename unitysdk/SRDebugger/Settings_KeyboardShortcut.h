...
#define SRDEBUGGER_SETTINGS_KEYBOARDSHORTCUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACFCB90)

namespace SRDebugger
{
	inline static constexpr unsigned int Settings_KeyboardShortcut_TypeDefinitionIndex = 35644;
