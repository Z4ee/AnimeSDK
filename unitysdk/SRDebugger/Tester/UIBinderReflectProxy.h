...
#define SRDEBUGGER_TESTER_UIBINDERREFLECTPROXY_FINDOPENDIALOGMETHOD_OFFSET UNITYSDK_OFFSET(0x10343C40)
#define SRDEBUGGER_TESTER_UIBINDERREFLECTPROXY_FINDOPENPAGEMETHOD_OFFSET UNITYSDK_OFFSET(0x10343A50)
#define SRDEBUGGER_TESTER_UIBINDERREFLECTPROXY_INVOKEOPENDIALOGMETHOD_OFFSET UNITYSDK_OFFSET(0x103441B0)
#define SRDEBUGGER_TESTER_UIBINDERREFLECTPROXY_INVOKEOPENMETHOD_INNER_OFFSET UNITYSDK_OFFSET(0x10343EA0)
#define SRDEBUGGER_TESTER_UIBINDERREFLECTPROXY_INVOKEOPENPAGEMETHOD_OFFSET UNITYSDK_OFFSET(0x10343E30)
#define SRDEBUGGER_TESTER_UIBINDERREFLECTPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x10344220)

namespace SRDebugger::Tester
{
	inline static constexpr unsigned int UIBinderReflectProxy_TypeDefinitionIndex = 85962;
