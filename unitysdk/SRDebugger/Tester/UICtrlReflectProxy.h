...
#define SRDEBUGGER_TESTER_UICTRLREFLECTPROXY_FINDOPENDIALOGMETHOD_OFFSET UNITYSDK_OFFSET(0x103448F0)
#define SRDEBUGGER_TESTER_UICTRLREFLECTPROXY_FINDOPENPAGEMETHOD_OFFSET UNITYSDK_OFFSET(0x10344700)
#define SRDEBUGGER_TESTER_UICTRLREFLECTPROXY_INVOKEOPENDIALOGMETHOD_OFFSET UNITYSDK_OFFSET(0x10344E60)
#define SRDEBUGGER_TESTER_UICTRLREFLECTPROXY_INVOKEOPENMETHOD_INNER_OFFSET UNITYSDK_OFFSET(0x10344B50)
#define SRDEBUGGER_TESTER_UICTRLREFLECTPROXY_INVOKEOPENPAGEMETHOD_OFFSET UNITYSDK_OFFSET(0x10344AE0)
#define SRDEBUGGER_TESTER_UICTRLREFLECTPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x10344ED0)

namespace SRDebugger::Tester
{
	inline static constexpr unsigned int UICtrlReflectProxy_TypeDefinitionIndex = 85910;
