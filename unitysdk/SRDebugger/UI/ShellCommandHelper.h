...
#define SRDEBUGGER_UI_SHELLCOMMANDHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0xD076470)

namespace SRDebugger::UI
{
	inline static constexpr unsigned int ShellCommandHelper_TypeDefinitionIndex = 45025;
