...
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1E69FCB0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_CONSOLELOGSELECTEDITEMCHANGED_OFFSET UNITYSDK_OFFSET(0x1E69F7C0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_CONSOLEONUPDATED_OFFSET UNITYSDK_OFFSET(0x1E69FCA0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_COPYTOCLIPBOARD_OFFSET UNITYSDK_OFFSET(0x1E69FAF0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_FADECOPYBUTTON_OFFSET UNITYSDK_OFFSET(0x1E69FC40)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_FILTERTOGGLEVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1E69F090)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_FILTERVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1E69F170)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_LOGGINGDISABLECLOSEANDIGNOREPRESSED_OFFSET UNITYSDK_OFFSET(0x1E69FD50)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_LOGGINGDISABLEREENABLEPRESSED_OFFSET UNITYSDK_OFFSET(0x1E69FD80)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_LOGHANDLERHASBEENOVERRIDENOKAYBUTTONPRESS_OFFSET UNITYSDK_OFFSET(0x1E69FD20)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1E69F500)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1E69F700)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1E69F6F0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_PANELONVISIBILITYCHANGED_OFFSET UNITYSDK_OFFSET(0x1E69F230)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_PINTOGGLEVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1E69F3E0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_POPULATESTACKTRACEAREA_OFFSET UNITYSDK_OFFSET(0x1E69E6F0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x1E69EA40)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_SETCOPYTOCLIPBOARDBUTTONSTATE_OFFSET UNITYSDK_OFFSET(0x1E69F820)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x1E69E0E0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_STOPANIMATIONS_OFFSET UNITYSDK_OFFSET(0x1E69F320)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E69F810)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E69FF20)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER__START_B__26_0_OFFSET UNITYSDK_OFFSET(0x1E69FF30)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER__START_B__26_1_OFFSET UNITYSDK_OFFSET(0x1E69FF40)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER__START_B__26_2_OFFSET UNITYSDK_OFFSET(0x1E69FF50)
...
namespace SRDebugger::UI::Tabs
{
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ConsoleTabController_TypeDefinitionIndex)->GetStaticField(0x10D50);
		}
		static ::System::Boolean* StaticGet__hasWarnedAboutLoggingDisabled()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ConsoleTabController_TypeDefinitionIndex)->GetStaticField(0x10D51);
		}
