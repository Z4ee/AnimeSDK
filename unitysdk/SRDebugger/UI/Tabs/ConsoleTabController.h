...
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A21F6B0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_CONSOLELOGSELECTEDITEMCHANGED_OFFSET UNITYSDK_OFFSET(0x1A21F1F0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_CONSOLEONUPDATED_OFFSET UNITYSDK_OFFSET(0x1A21F6A0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_COPYTOCLIPBOARD_OFFSET UNITYSDK_OFFSET(0x1A21F4F0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_FADECOPYBUTTON_OFFSET UNITYSDK_OFFSET(0x1A21F640)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_FILTERTOGGLEVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1A21EB80)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_FILTERVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1A21EC60)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_LOGGINGDISABLECLOSEANDIGNOREPRESSED_OFFSET UNITYSDK_OFFSET(0x1A21F750)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_LOGGINGDISABLEREENABLEPRESSED_OFFSET UNITYSDK_OFFSET(0x1A21F780)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_LOGHANDLERHASBEENOVERRIDENOKAYBUTTONPRESS_OFFSET UNITYSDK_OFFSET(0x1A21F720)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A21EF90)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A21F160)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A21F150)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_PANELONVISIBILITYCHANGED_OFFSET UNITYSDK_OFFSET(0x1A21ED20)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_PINTOGGLEVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1A21EE70)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_POPULATESTACKTRACEAREA_OFFSET UNITYSDK_OFFSET(0x1A21E1E0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x1A21E530)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_SETCOPYTOCLIPBOARDBUTTONSTATE_OFFSET UNITYSDK_OFFSET(0x1A21F250)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x1A21DBD0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_STOPANIMATIONS_OFFSET UNITYSDK_OFFSET(0x1A21EDE0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A21F240)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A21F920)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER__START_B__26_0_OFFSET UNITYSDK_OFFSET(0x1A21F930)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER__START_B__26_1_OFFSET UNITYSDK_OFFSET(0x1A21F940)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER__START_B__26_2_OFFSET UNITYSDK_OFFSET(0x1A21F950)

namespace SRDebugger::UI::Tabs
{
	inline static constexpr unsigned int ConsoleTabController_TypeDefinitionIndex = 36434;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ConsoleTabController_TypeDefinitionIndex)->GetStaticField(0x12F50);
		}
		static ::System::Boolean* StaticGet__hasWarnedAboutLogHandler()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ConsoleTabController_TypeDefinitionIndex)->GetStaticField(0x12F51);
		}
