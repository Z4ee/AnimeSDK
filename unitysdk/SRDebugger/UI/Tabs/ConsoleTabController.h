...
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1AD0F410)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_CONSOLELOGSELECTEDITEMCHANGED_OFFSET UNITYSDK_OFFSET(0x1AD0EF20)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_CONSOLEONUPDATED_OFFSET UNITYSDK_OFFSET(0x1AD0F400)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_COPYTOCLIPBOARD_OFFSET UNITYSDK_OFFSET(0x1AD0F250)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_FADECOPYBUTTON_OFFSET UNITYSDK_OFFSET(0x1AD0F3A0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_FILTERTOGGLEVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1AD0E7F0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_FILTERVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1AD0E8D0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_LOGGINGDISABLECLOSEANDIGNOREPRESSED_OFFSET UNITYSDK_OFFSET(0x1AD0F4B0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_LOGGINGDISABLEREENABLEPRESSED_OFFSET UNITYSDK_OFFSET(0x1AD0F4E0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_LOGHANDLERHASBEENOVERRIDENOKAYBUTTONPRESS_OFFSET UNITYSDK_OFFSET(0x1AD0F480)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AD0EC60)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AD0EE60)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AD0EE50)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_PANELONVISIBILITYCHANGED_OFFSET UNITYSDK_OFFSET(0x1AD0E990)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_PINTOGGLEVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1AD0EB40)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_POPULATESTACKTRACEAREA_OFFSET UNITYSDK_OFFSET(0x1AD0E050)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x1AD0E2F0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_SETCOPYTOCLIPBOARDBUTTONSTATE_OFFSET UNITYSDK_OFFSET(0x1AD0EF80)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x1AD0D9D0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_STOPANIMATIONS_OFFSET UNITYSDK_OFFSET(0x1AD0EA80)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AD0EF70)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD0F680)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER__START_B__26_0_OFFSET UNITYSDK_OFFSET(0x1AD0F690)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER__START_B__26_1_OFFSET UNITYSDK_OFFSET(0x1AD0F6A0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER__START_B__26_2_OFFSET UNITYSDK_OFFSET(0x1AD0F6B0)

namespace SRDebugger::UI::Tabs
{
	inline static constexpr unsigned int ConsoleTabController_TypeDefinitionIndex = 35652;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ConsoleTabController_TypeDefinitionIndex)->GetStaticField(0x139F0);
		}
		static ::System::Boolean* StaticGet__hasWarnedAboutLogHandler()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ConsoleTabController_TypeDefinitionIndex)->GetStaticField(0x139F1);
		}
