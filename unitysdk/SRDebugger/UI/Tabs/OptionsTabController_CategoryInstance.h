...
#define SRDEBUGGER_UI_TABS_OPTIONSTABCONTROLLER_CATEGORYINSTANCE_GET_CATEGORYGROUP_OFFSET UNITYSDK_OFFSET(0x1E6A8000)
#define SRDEBUGGER_UI_TABS_OPTIONSTABCONTROLLER_CATEGORYINSTANCE_SET_CATEGORYGROUP_OFFSET UNITYSDK_OFFSET(0x1E6A8010)
#define SRDEBUGGER_UI_TABS_OPTIONSTABCONTROLLER_CATEGORYINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6A6680)
