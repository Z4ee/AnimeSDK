...
#define SRDEBUGGER_UI_TABS_OPTIONSTABCONTROLLER_CATEGORYINSTANCE_GET_CATEGORYGROUP_OFFSET UNITYSDK_OFFSET(0x1D2C3CD0)
#define SRDEBUGGER_UI_TABS_OPTIONSTABCONTROLLER_CATEGORYINSTANCE_SET_CATEGORYGROUP_OFFSET UNITYSDK_OFFSET(0x1D2C3CE0)
#define SRDEBUGGER_UI_TABS_OPTIONSTABCONTROLLER_CATEGORYINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2C2350)

namespace SRDebugger::UI::Tabs
{
	inline static constexpr unsigned int OptionsTabController_CategoryInstance_TypeDefinitionIndex = 36439;

	class OptionsTabController_CategoryInstance : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::SRDebugger::UI::Controls::OptionsControlBase*>* Options; // 0x10
		::SRDebugger::UI::Other::CategoryGroup* _CategoryGroup_k__BackingField; // 0x18
