...
#define SRDEBUGGER_UI_TABS_PROFILERTABCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18466700)
#define SRDEBUGGER_UI_TABS_PROFILERTABCONTROLLER_PINTOGGLEVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x18466680)
#define SRDEBUGGER_UI_TABS_PROFILERTABCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x18466550)
#define SRDEBUGGER_UI_TABS_PROFILERTABCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x184663A0)
#define SRDEBUGGER_UI_TABS_PROFILERTABCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x18466710)
#define SRDEBUGGER_UI_TABS_PROFILERTABCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18466850)

namespace SRDebugger::UI::Tabs
{
	inline static constexpr unsigned int ProfilerTabController_TypeDefinitionIndex = 29641;
