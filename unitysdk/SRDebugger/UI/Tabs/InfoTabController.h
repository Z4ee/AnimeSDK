...
#define SRDEBUGGER_UI_TABS_INFOTABCONTROLLER_ACTIVATEREFRESHEVERYFRAME_OFFSET UNITYSDK_OFFSET(0x1E6A0990)
#define SRDEBUGGER_UI_TABS_INFOTABCONTROLLER_CREATEBLOCK_OFFSET UNITYSDK_OFFSET(0x1E6A09C0)
#define SRDEBUGGER_UI_TABS_INFOTABCONTROLLER_FILLINFOBLOCK_OFFSET UNITYSDK_OFFSET(0x1E6A0B20)
#define SRDEBUGGER_UI_TABS_INFOTABCONTROLLER_INTERNALREFRESH_OFFSET UNITYSDK_OFFSET(0x1E6A0190)
#define SRDEBUGGER_UI_TABS_INFOTABCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1E6A0150)
#define SRDEBUGGER_UI_TABS_INFOTABCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x1E6A0950)
#define SRDEBUGGER_UI_TABS_INFOTABCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E6A0980)
#define SRDEBUGGER_UI_TABS_INFOTABCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6A1D60)
#define SRDEBUGGER_UI_TABS_INFOTABCONTROLLER__GETLENGTH_OFFSET UNITYSDK_OFFSET(0x1E6A1B10)

namespace SRDebugger::UI::Tabs
{
	inline static constexpr unsigned int InfoTabController_TypeDefinitionIndex = 37296;
