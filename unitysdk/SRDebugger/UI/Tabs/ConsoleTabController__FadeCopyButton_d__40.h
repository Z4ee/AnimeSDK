...
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER__FADECOPYBUTTON_D__40_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AD0F6D0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER__FADECOPYBUTTON_D__40_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AD0F840)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER__FADECOPYBUTTON_D__40_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AD0F8A0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER__FADECOPYBUTTON_D__40_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AD0F850)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER__FADECOPYBUTTON_D__40_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AD0F6C0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER__FADECOPYBUTTON_D__40__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD0F3F0)

namespace SRDebugger::UI::Tabs
{
	inline static constexpr unsigned int ConsoleTabController__FadeCopyButton_d__40_TypeDefinitionIndex = 35654;
