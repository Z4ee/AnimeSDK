...
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER__FADECOPYBUTTON_D__40_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BDC9D80)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER__FADECOPYBUTTON_D__40_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BDC9EF0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER__FADECOPYBUTTON_D__40_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BDC9F50)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER__FADECOPYBUTTON_D__40_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BDC9F00)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER__FADECOPYBUTTON_D__40_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BDC9D70)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER__FADECOPYBUTTON_D__40__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDC9AA0)

namespace SRDebugger::UI::Tabs
{
	inline static constexpr unsigned int ConsoleTabController__FadeCopyButton_d__40_TypeDefinitionIndex = 37295;
	...
	public:
		...
		::System::Single _endTime_5__3; // 0x20
