...
#define SRDEBUGGER_UI_CONTROLS_PROFILERMEMORYBLOCK__CLEANUP_D__8_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A2161C0)
#define SRDEBUGGER_UI_CONTROLS_PROFILERMEMORYBLOCK__CLEANUP_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A2162F0)
#define SRDEBUGGER_UI_CONTROLS_PROFILERMEMORYBLOCK__CLEANUP_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A216350)
#define SRDEBUGGER_UI_CONTROLS_PROFILERMEMORYBLOCK__CLEANUP_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A216300)
#define SRDEBUGGER_UI_CONTROLS_PROFILERMEMORYBLOCK__CLEANUP_D__8_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A2161B0)
#define SRDEBUGGER_UI_CONTROLS_PROFILERMEMORYBLOCK__CLEANUP_D__8__CTOR_OFFSET UNITYSDK_OFFSET(0x1A216190)

namespace SRDebugger::UI::Controls
{
	inline static constexpr unsigned int ProfilerMemoryBlock__CleanUp_d__8_TypeDefinitionIndex = 36479;
