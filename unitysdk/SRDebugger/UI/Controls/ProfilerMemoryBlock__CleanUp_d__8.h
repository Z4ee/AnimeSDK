...
#define SRDEBUGGER_UI_CONTROLS_PROFILERMEMORYBLOCK__CLEANUP_D__8_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AD06980)
#define SRDEBUGGER_UI_CONTROLS_PROFILERMEMORYBLOCK__CLEANUP_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AD06AB0)
#define SRDEBUGGER_UI_CONTROLS_PROFILERMEMORYBLOCK__CLEANUP_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AD06B10)
#define SRDEBUGGER_UI_CONTROLS_PROFILERMEMORYBLOCK__CLEANUP_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AD06AC0)
#define SRDEBUGGER_UI_CONTROLS_PROFILERMEMORYBLOCK__CLEANUP_D__8_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AD06970)
#define SRDEBUGGER_UI_CONTROLS_PROFILERMEMORYBLOCK__CLEANUP_D__8__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD06950)

namespace SRDebugger::UI::Controls
{
	inline static constexpr unsigned int ProfilerMemoryBlock__CleanUp_d__8_TypeDefinitionIndex = 35697;
