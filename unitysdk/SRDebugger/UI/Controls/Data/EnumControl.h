...
#define SRDEBUGGER_UI_CONTROLS_DATA_ENUMCONTROL_CANBIND_OFFSET UNITYSDK_OFFSET(0x1844E400)
#define SRDEBUGGER_UI_CONTROLS_DATA_ENUMCONTROL_GETENUMNAME_OFFSET UNITYSDK_OFFSET(0x1844E340)
#define SRDEBUGGER_UI_CONTROLS_DATA_ENUMCONTROL_GOTONEXT_OFFSET UNITYSDK_OFFSET(0x1844E630)
#define SRDEBUGGER_UI_CONTROLS_DATA_ENUMCONTROL_GOTOPREVIOUS_OFFSET UNITYSDK_OFFSET(0x1844E850)
#define SRDEBUGGER_UI_CONTROLS_DATA_ENUMCONTROL_ONBIND_OFFSET UNITYSDK_OFFSET(0x1844DF20)
#define SRDEBUGGER_UI_CONTROLS_DATA_ENUMCONTROL_ONVALUEUPDATED_OFFSET UNITYSDK_OFFSET(0x1844E2A0)
#define SRDEBUGGER_UI_CONTROLS_DATA_ENUMCONTROL_OPTIONCONTROL_OFFSET UNITYSDK_OFFSET(0x1844EA70)
#define SRDEBUGGER_UI_CONTROLS_DATA_ENUMCONTROL_SETINDEX_OFFSET UNITYSDK_OFFSET(0x1844E430)
#define SRDEBUGGER_UI_CONTROLS_DATA_ENUMCONTROL_START_OFFSET UNITYSDK_OFFSET(0x1844DF00)
#define SRDEBUGGER_UI_CONTROLS_DATA_ENUMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1844EA90)

namespace SRDebugger::UI::Controls::Data
{
	inline static constexpr unsigned int EnumControl_TypeDefinitionIndex = 29689;
