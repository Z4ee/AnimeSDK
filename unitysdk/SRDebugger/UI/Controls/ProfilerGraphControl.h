...
#define SRDEBUGGER_UI_CONTROLS_PROFILERGRAPHCONTROL_ADDRECT_OFFSET UNITYSDK_OFFSET(0x1BDBF580)
#define SRDEBUGGER_UI_CONTROLS_PROFILERGRAPHCONTROL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1BDBDA20)
#define SRDEBUGGER_UI_CONTROLS_PROFILERGRAPHCONTROL_CALCULATEMAXFRAMETIME_OFFSET UNITYSDK_OFFSET(0x1BDBE4F0)
#define SRDEBUGGER_UI_CONTROLS_PROFILERGRAPHCONTROL_CALCULATEVISIBLEDATAPOINTCOUNT_OFFSET UNITYSDK_OFFSET(0x1BDBE6D0)
#define SRDEBUGGER_UI_CONTROLS_PROFILERGRAPHCONTROL_DRAWAXIS_OFFSET UNITYSDK_OFFSET(0x1BDBF180)
#define SRDEBUGGER_UI_CONTROLS_PROFILERGRAPHCONTROL_DRAWDATAPOINT_OFFSET UNITYSDK_OFFSET(0x1BDBEB00)
#define SRDEBUGGER_UI_CONTROLS_PROFILERGRAPHCONTROL_GETAXISLABEL_OFFSET UNITYSDK_OFFSET(0x1BDBEFF0)
#define SRDEBUGGER_UI_CONTROLS_PROFILERGRAPHCONTROL_GETFRAMEBUFFERCURRENTSIZE_OFFSET UNITYSDK_OFFSET(0x1BDBE860)
#define SRDEBUGGER_UI_CONTROLS_PROFILERGRAPHCONTROL_GETFRAMEBUFFERMAXSIZE_OFFSET UNITYSDK_OFFSET(0x1BDBFB50)
#define SRDEBUGGER_UI_CONTROLS_PROFILERGRAPHCONTROL_GETFRAME_OFFSET UNITYSDK_OFFSET(0x1BDBE9A0)
#define SRDEBUGGER_UI_CONTROLS_PROFILERGRAPHCONTROL_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x1BDBDAD0)
#define SRDEBUGGER_UI_CONTROLS_PROFILERGRAPHCONTROL_START_OFFSET UNITYSDK_OFFSET(0x1BDBDA60)
#define SRDEBUGGER_UI_CONTROLS_PROFILERGRAPHCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0x1BDBDA70)
#define SRDEBUGGER_UI_CONTROLS_PROFILERGRAPHCONTROL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BDBFE30)
#define SRDEBUGGER_UI_CONTROLS_PROFILERGRAPHCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDBFCA0)

namespace SRDebugger::UI::Controls
{
	inline static constexpr unsigned int ProfilerGraphControl_TypeDefinitionIndex = 37345;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(ProfilerGraphControl_TypeDefinitionIndex)->GetStaticField(0x41000);
		}
