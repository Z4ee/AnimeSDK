...
#define SRDEBUGGER_UI_CONTROLS_SRTABBUTTON_GET_CACHERECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A217440)
#define SRDEBUGGER_UI_CONTROLS_SRTABBUTTON_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1A2173F0)
#define SRDEBUGGER_UI_CONTROLS_SRTABBUTTON_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1A217410)
#define SRDEBUGGER_UI_CONTROLS_SRTABBUTTON__CTOR_OFFSET UNITYSDK_OFFSET(0x1A217510)

namespace SRDebugger::UI::Controls
{
	inline static constexpr unsigned int SRTabButton_TypeDefinitionIndex = 36488;
