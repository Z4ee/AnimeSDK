...
#define SRDEBUGGER_UI_CONTROLS_TABLESIZE_SYSTEM_ICOMPARABLE_SRDEBUGGER_UI_CONTROLS_TABLESIZE__COMPARETO_OFFSET UNITYSDK_OFFSET(0x19E91E20)
#define SRDEBUGGER_UI_CONTROLS_TABLESIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E91E50)

namespace SRDebugger::UI::Controls
{
	inline static constexpr unsigned int TableSize_TypeDefinitionIndex = 35399;
