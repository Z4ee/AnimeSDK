...
#define SRDEBUGGER_UI_CONTROLS_TABLESIZE_SYSTEM_ICOMPARABLE_SRDEBUGGER_UI_CONTROLS_TABLESIZE__COMPARETO_OFFSET UNITYSDK_OFFSET(0x1E6979C0)
#define SRDEBUGGER_UI_CONTROLS_TABLESIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6979F0)

namespace SRDebugger::UI::Controls
{
	inline static constexpr unsigned int TableSize_TypeDefinitionIndex = 37340;
