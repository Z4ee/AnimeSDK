...
#define SRDEBUGGER_UI_CONTROLS_INFOBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD02F10)

namespace SRDebugger::UI::Controls
{
	inline static constexpr unsigned int InfoBlock_TypeDefinitionIndex = 35691;
