...
#define SRDEBUGGER_UI_CONTROLS_PROFILERMONOBLOCK_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AD06B20)
#define SRDEBUGGER_UI_CONTROLS_PROFILERMONOBLOCK_TRIGGERCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1AD06F10)
#define SRDEBUGGER_UI_CONTROLS_PROFILERMONOBLOCK_TRIGGERREFRESH_OFFSET UNITYSDK_OFFSET(0x1AD06B90)
#define SRDEBUGGER_UI_CONTROLS_PROFILERMONOBLOCK_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AD06E50)
#define SRDEBUGGER_UI_CONTROLS_PROFILERMONOBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD06F80)

namespace SRDebugger::UI::Controls
{
	inline static constexpr unsigned int ProfilerMonoBlock_TypeDefinitionIndex = 35698;
