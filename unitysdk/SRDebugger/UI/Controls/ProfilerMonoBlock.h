...
#define SRDEBUGGER_UI_CONTROLS_PROFILERMONOBLOCK_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A216360)
#define SRDEBUGGER_UI_CONTROLS_PROFILERMONOBLOCK_TRIGGERCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1A216870)
#define SRDEBUGGER_UI_CONTROLS_PROFILERMONOBLOCK_TRIGGERREFRESH_OFFSET UNITYSDK_OFFSET(0x1A2163D0)
#define SRDEBUGGER_UI_CONTROLS_PROFILERMONOBLOCK_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A2167B0)
#define SRDEBUGGER_UI_CONTROLS_PROFILERMONOBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2168E0)

namespace SRDebugger::UI::Controls
{
	inline static constexpr unsigned int ProfilerMonoBlock_TypeDefinitionIndex = 36480;
