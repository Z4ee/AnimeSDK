...
#define SRDEBUGGER_UI_CONTROLS_PROFILERMONOBLOCK_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19E90A20)
#define SRDEBUGGER_UI_CONTROLS_PROFILERMONOBLOCK_TRIGGERCOLLECTION_OFFSET UNITYSDK_OFFSET(0x19E90E90)
#define SRDEBUGGER_UI_CONTROLS_PROFILERMONOBLOCK_TRIGGERREFRESH_OFFSET UNITYSDK_OFFSET(0x19E90A90)
#define SRDEBUGGER_UI_CONTROLS_PROFILERMONOBLOCK_UPDATE_OFFSET UNITYSDK_OFFSET(0x19E90DD0)
#define SRDEBUGGER_UI_CONTROLS_PROFILERMONOBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x19E90F00)

namespace SRDebugger::UI::Controls
{
	inline static constexpr unsigned int ProfilerMonoBlock_TypeDefinitionIndex = 35398;
