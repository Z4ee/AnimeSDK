...
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_ADD_COMPLETE_OFFSET UNITYSDK_OFFSET(0x1A2001C0)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A2126A0)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_CANCELBUTTONPRESSED_OFFSET UNITYSDK_OFFSET(0x1A212DD0)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A200000)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_HANDLECHARACTER_OFFSET UNITYSDK_OFFSET(0x1A212B20)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_HIDE_OFFSET UNITYSDK_OFFSET(0x1A200170)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_ONCANCEL_OFFSET UNITYSDK_OFFSET(0x1A212D90)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_ONCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1A212D10)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A2129D0)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A2129C0)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_PLAYINVALIDCODEANIMATION_OFFSET UNITYSDK_OFFSET(0x1A200380)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_PUSHNUMBER_OFFSET UNITYSDK_OFFSET(0x1A212B90)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_REFRESHSTATE_OFFSET UNITYSDK_OFFSET(0x1A212850)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_REMOVE_COMPLETE_OFFSET UNITYSDK_OFFSET(0x1A212620)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_SHOW_OFFSET UNITYSDK_OFFSET(0x1A200030)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A2129E0)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A212E30)

namespace SRDebugger::UI::Controls
{
	inline static constexpr unsigned int PinEntryControl_TypeDefinitionIndex = 36476;
