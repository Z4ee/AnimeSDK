...
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_ADD_COMPLETE_OFFSET UNITYSDK_OFFSET(0x1ACF2480)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1AD03370)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_CANCELBUTTONPRESSED_OFFSET UNITYSDK_OFFSET(0x1AD03A20)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_CLEAR_OFFSET UNITYSDK_OFFSET(0x1ACF22C0)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_HANDLECHARACTER_OFFSET UNITYSDK_OFFSET(0x1AD03770)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_HIDE_OFFSET UNITYSDK_OFFSET(0x1ACF2430)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_ONCANCEL_OFFSET UNITYSDK_OFFSET(0x1AD039E0)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_ONCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1AD03960)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AD03620)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AD03610)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_PLAYINVALIDCODEANIMATION_OFFSET UNITYSDK_OFFSET(0x1ACF2640)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_PUSHNUMBER_OFFSET UNITYSDK_OFFSET(0x1AD037E0)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_REFRESHSTATE_OFFSET UNITYSDK_OFFSET(0x1AD03520)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_REMOVE_COMPLETE_OFFSET UNITYSDK_OFFSET(0x1AD032F0)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_SHOW_OFFSET UNITYSDK_OFFSET(0x1ACF22F0)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AD03630)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD03A80)

namespace SRDebugger::UI::Controls
{
	inline static constexpr unsigned int PinEntryControl_TypeDefinitionIndex = 35694;
