...
#define SRDEBUGGER_UI_CONTROLS_DATABOUNDCONTROL_BINDCONTROL_OFFSET UNITYSDK_OFFSET(0x1E691F40)
#define SRDEBUGGER_UI_CONTROLS_DATABOUNDCONTROL_BIND_OFFSET UNITYSDK_OFFSET(0x1E672160)
#define SRDEBUGGER_UI_CONTROLS_DATABOUNDCONTROL_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1E691F10)
#define SRDEBUGGER_UI_CONTROLS_DATABOUNDCONTROL_GET_PROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1E691F20)
#define SRDEBUGGER_UI_CONTROLS_DATABOUNDCONTROL_GET_PROPERTY_OFFSET UNITYSDK_OFFSET(0x1E691F00)
#define SRDEBUGGER_UI_CONTROLS_DATABOUNDCONTROL_ONBIND_OFFSET UNITYSDK_OFFSET(0x1E68DC60)
#define SRDEBUGGER_UI_CONTROLS_DATABOUNDCONTROL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1E6922B0)
#define SRDEBUGGER_UI_CONTROLS_DATABOUNDCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1E692130)
#define SRDEBUGGER_UI_CONTROLS_DATABOUNDCONTROL_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1E692120)
#define SRDEBUGGER_UI_CONTROLS_DATABOUNDCONTROL_REFRESH_OFFSET UNITYSDK_OFFSET(0x1E68E620)
#define SRDEBUGGER_UI_CONTROLS_DATABOUNDCONTROL_SET_PROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1E691F30)
#define SRDEBUGGER_UI_CONTROLS_DATABOUNDCONTROL_START_OFFSET UNITYSDK_OFFSET(0x1E68D910)
#define SRDEBUGGER_UI_CONTROLS_DATABOUNDCONTROL_UPDATEVALUE_OFFSET UNITYSDK_OFFSET(0x1E68D960)
#define SRDEBUGGER_UI_CONTROLS_DATABOUNDCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1E68DD50)
