...
#define SRDEBUGGER_UI_CONTROLS_DATABOUNDCONTROL_BINDCONTROL_OFFSET UNITYSDK_OFFSET(0x184517C0)
#define SRDEBUGGER_UI_CONTROLS_DATABOUNDCONTROL_BIND_OFFSET UNITYSDK_OFFSET(0x18433D60)
#define SRDEBUGGER_UI_CONTROLS_DATABOUNDCONTROL_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x18451790)
#define SRDEBUGGER_UI_CONTROLS_DATABOUNDCONTROL_GET_PROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x184517A0)
#define SRDEBUGGER_UI_CONTROLS_DATABOUNDCONTROL_GET_PROPERTY_OFFSET UNITYSDK_OFFSET(0x18451780)
#define SRDEBUGGER_UI_CONTROLS_DATABOUNDCONTROL_ONBIND_OFFSET UNITYSDK_OFFSET(0x1844DE00)
#define SRDEBUGGER_UI_CONTROLS_DATABOUNDCONTROL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18451B50)
#define SRDEBUGGER_UI_CONTROLS_DATABOUNDCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x184519F0)
#define SRDEBUGGER_UI_CONTROLS_DATABOUNDCONTROL_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x184519E0)
#define SRDEBUGGER_UI_CONTROLS_DATABOUNDCONTROL_REFRESH_OFFSET UNITYSDK_OFFSET(0x1844E470)
#define SRDEBUGGER_UI_CONTROLS_DATABOUNDCONTROL_SET_PROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x184517B0)
#define SRDEBUGGER_UI_CONTROLS_DATABOUNDCONTROL_START_OFFSET UNITYSDK_OFFSET(0x1844DB90)
#define SRDEBUGGER_UI_CONTROLS_DATABOUNDCONTROL_UPDATEVALUE_OFFSET UNITYSDK_OFFSET(0x1844DBE0)
#define SRDEBUGGER_UI_CONTROLS_DATABOUNDCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1844DEF0)

namespace SRDebugger::UI::Controls
{
	inline static constexpr unsigned int DataBoundControl_TypeDefinitionIndex = 29669;
