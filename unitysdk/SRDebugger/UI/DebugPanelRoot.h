...
#define SRDEBUGGER_UI_DEBUGPANELROOT_CLOSEANDDESTROY_OFFSET UNITYSDK_OFFSET(0x19E91FE0)
#define SRDEBUGGER_UI_DEBUGPANELROOT_CLOSE_OFFSET UNITYSDK_OFFSET(0x19E91E60)
#define SRDEBUGGER_UI_DEBUGPANELROOT__CTOR_OFFSET UNITYSDK_OFFSET(0x19E92060)

namespace SRDebugger::UI
{
	inline static constexpr unsigned int DebugPanelRoot_TypeDefinitionIndex = 35349;
