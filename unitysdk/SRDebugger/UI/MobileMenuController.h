...
#define SRDEBUGGER_UI_MOBILEMENUCONTROLLER_CLOSEBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x1A218800)
#define SRDEBUGGER_UI_MOBILEMENUCONTROLLER_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A218840)
#define SRDEBUGGER_UI_MOBILEMENUCONTROLLER_CREATECLOSEBUTTON_OFFSET UNITYSDK_OFFSET(0x1A217E20)
#define SRDEBUGGER_UI_MOBILEMENUCONTROLLER_GET_MAXMENUWIDTH_OFFSET UNITYSDK_OFFSET(0x1A217750)
#define SRDEBUGGER_UI_MOBILEMENUCONTROLLER_GET_PEEKAMOUNT_OFFSET UNITYSDK_OFFSET(0x1A217740)
#define SRDEBUGGER_UI_MOBILEMENUCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A218430)
#define SRDEBUGGER_UI_MOBILEMENUCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A217760)
#define SRDEBUGGER_UI_MOBILEMENUCONTROLLER_OPEN_OFFSET UNITYSDK_OFFSET(0x1A218B80)
#define SRDEBUGGER_UI_MOBILEMENUCONTROLLER_SETRECTSIZE_OFFSET UNITYSDK_OFFSET(0x1A218730)
#define SRDEBUGGER_UI_MOBILEMENUCONTROLLER_TABCONTROLLERONACTIVETABCHANGED_OFFSET UNITYSDK_OFFSET(0x1A218B40)
#define SRDEBUGGER_UI_MOBILEMENUCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A218880)
#define SRDEBUGGER_UI_MOBILEMENUCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A218BF0)

namespace SRDebugger::UI
{
	inline static constexpr unsigned int MobileMenuController_TypeDefinitionIndex = 36432;
