...
#define SRDEBUGGER_UI_MOBILEMENUCONTROLLER_CLOSEBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x1BDC2AB0)
#define SRDEBUGGER_UI_MOBILEMENUCONTROLLER_CLOSE_OFFSET UNITYSDK_OFFSET(0x1BDC2AF0)
#define SRDEBUGGER_UI_MOBILEMENUCONTROLLER_CREATECLOSEBUTTON_OFFSET UNITYSDK_OFFSET(0x1BDC20D0)
#define SRDEBUGGER_UI_MOBILEMENUCONTROLLER_GET_MAXMENUWIDTH_OFFSET UNITYSDK_OFFSET(0x1BDC1A00)
#define SRDEBUGGER_UI_MOBILEMENUCONTROLLER_GET_PEEKAMOUNT_OFFSET UNITYSDK_OFFSET(0x1BDC19F0)
#define SRDEBUGGER_UI_MOBILEMENUCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1BDC26E0)
#define SRDEBUGGER_UI_MOBILEMENUCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1BDC1A10)
#define SRDEBUGGER_UI_MOBILEMENUCONTROLLER_OPEN_OFFSET UNITYSDK_OFFSET(0x1BDC2E30)
#define SRDEBUGGER_UI_MOBILEMENUCONTROLLER_SETRECTSIZE_OFFSET UNITYSDK_OFFSET(0x1BDC29E0)
#define SRDEBUGGER_UI_MOBILEMENUCONTROLLER_TABCONTROLLERONACTIVETABCHANGED_OFFSET UNITYSDK_OFFSET(0x1BDC2DF0)
#define SRDEBUGGER_UI_MOBILEMENUCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1BDC2B30)
#define SRDEBUGGER_UI_MOBILEMENUCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDC2EA0)
