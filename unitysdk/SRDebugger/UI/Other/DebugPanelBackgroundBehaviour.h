...
#define SRDEBUGGER_UI_OTHER_DEBUGPANELBACKGROUNDBEHAVIOUR_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A21A6F0)
#define SRDEBUGGER_UI_OTHER_DEBUGPANELBACKGROUNDBEHAVIOUR_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A21A7A0)
#define SRDEBUGGER_UI_OTHER_DEBUGPANELBACKGROUNDBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A21A880)

namespace SRDebugger::UI::Other
{
	inline static constexpr unsigned int DebugPanelBackgroundBehaviour_TypeDefinitionIndex = 36450;
