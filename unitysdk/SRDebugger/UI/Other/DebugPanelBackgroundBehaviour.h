...
#define SRDEBUGGER_UI_OTHER_DEBUGPANELBACKGROUNDBEHAVIOUR_AWAKE_OFFSET UNITYSDK_OFFSET(0x1BDC49D0)
#define SRDEBUGGER_UI_OTHER_DEBUGPANELBACKGROUNDBEHAVIOUR_UPDATE_OFFSET UNITYSDK_OFFSET(0x1BDC4A80)
#define SRDEBUGGER_UI_OTHER_DEBUGPANELBACKGROUNDBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDC4B60)
