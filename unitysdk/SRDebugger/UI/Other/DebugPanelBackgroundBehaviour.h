...
#define SRDEBUGGER_UI_OTHER_DEBUGPANELBACKGROUNDBEHAVIOUR_AWAKE_OFFSET UNITYSDK_OFFSET(0x1AD0A840)
#define SRDEBUGGER_UI_OTHER_DEBUGPANELBACKGROUNDBEHAVIOUR_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AD0A8F0)
#define SRDEBUGGER_UI_OTHER_DEBUGPANELBACKGROUNDBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD0AA30)

namespace SRDebugger::UI::Other
{
	inline static constexpr unsigned int DebugPanelBackgroundBehaviour_TypeDefinitionIndex = 35668;
