...
#define SRDEBUGGER_UI_OTHER_BUGREPORTPOPOVERROOT__CTOR_OFFSET UNITYSDK_OFFSET(0x19E933B0)

namespace SRDebugger::UI::Other
{
	inline static constexpr unsigned int BugReportPopoverRoot_TypeDefinitionIndex = 35362;
