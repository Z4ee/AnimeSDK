...
#define SRDEBUGGER_UI_OTHER_PINNEDUIROOT__CTOR_OFFSET UNITYSDK_OFFSET(0x19E96020)

namespace SRDebugger::UI::Other
{
	inline static constexpr unsigned int PinnedUIRoot_TypeDefinitionIndex = 35375;
