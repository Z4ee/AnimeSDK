...
#define SRDEBUGGER_UI_OTHER_CONFIGURECANVASFROMSETTINGS_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A219F40)
#define SRDEBUGGER_UI_OTHER_CONFIGURECANVASFROMSETTINGS_SETTINGSONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1A21A010)
#define SRDEBUGGER_UI_OTHER_CONFIGURECANVASFROMSETTINGS_START_OFFSET UNITYSDK_OFFSET(0x1A219CB0)
#define SRDEBUGGER_UI_OTHER_CONFIGURECANVASFROMSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A21A070)

namespace SRDebugger::UI::Other
{
	inline static constexpr unsigned int ConfigureCanvasFromSettings_TypeDefinitionIndex = 36448;
