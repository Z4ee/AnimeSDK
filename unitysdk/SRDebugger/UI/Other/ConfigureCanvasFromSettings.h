...
#define SRDEBUGGER_UI_OTHER_CONFIGURECANVASFROMSETTINGS_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1BDC4220)
#define SRDEBUGGER_UI_OTHER_CONFIGURECANVASFROMSETTINGS_SETTINGSONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1BDC42F0)
#define SRDEBUGGER_UI_OTHER_CONFIGURECANVASFROMSETTINGS_START_OFFSET UNITYSDK_OFFSET(0x1BDC3F90)
#define SRDEBUGGER_UI_OTHER_CONFIGURECANVASFROMSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDC4350)
