...
#define SRDEBUGGER_UI_OTHER_FLOATOVERELEMENT_COPY_OFFSET UNITYSDK_OFFSET(0x1BDC56B0)
#define SRDEBUGGER_UI_OTHER_FLOATOVERELEMENT_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1BDC5D70)
#define SRDEBUGGER_UI_OTHER_FLOATOVERELEMENT_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x1BDC5D80)
#define SRDEBUGGER_UI_OTHER_FLOATOVERELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDC5D90)

namespace SRDebugger::UI::Other
{
	inline static constexpr unsigned int FloatOverElement_TypeDefinitionIndex = 37312;
