...
#define SRDEBUGGER_UI_OTHER_SCROLLSETTINGSBEHAVIOUR_AWAKE_OFFSET UNITYSDK_OFFSET(0x1BDC7700)
#define SRDEBUGGER_UI_OTHER_SCROLLSETTINGSBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDC77C0)
