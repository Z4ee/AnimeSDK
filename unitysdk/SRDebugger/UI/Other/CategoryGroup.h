...
#define SRDEBUGGER_UI_OTHER_CATEGORYGROUP_GET_ISSELECTED_OFFSET UNITYSDK_OFFSET(0x1A219AC0)
#define SRDEBUGGER_UI_OTHER_CATEGORYGROUP_GET_SELECTIONMODEENABLED_OFFSET UNITYSDK_OFFSET(0x1A219BD0)
#define SRDEBUGGER_UI_OTHER_CATEGORYGROUP_SET_ISSELECTED_OFFSET UNITYSDK_OFFSET(0x1A219AE0)
#define SRDEBUGGER_UI_OTHER_CATEGORYGROUP_SET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x1A219C50)
#define SRDEBUGGER_UI_OTHER_CATEGORYGROUP_SET_SELECTIONMODEENABLED_OFFSET UNITYSDK_OFFSET(0x1A219BE0)
#define SRDEBUGGER_UI_OTHER_CATEGORYGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A219C80)

namespace SRDebugger::UI::Other
{
	inline static constexpr unsigned int CategoryGroup_TypeDefinitionIndex = 36447;
