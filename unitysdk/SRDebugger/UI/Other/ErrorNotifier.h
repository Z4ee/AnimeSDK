...
#define SRDEBUGGER_UI_OTHER_ERRORNOTIFIER_AWAKE_OFFSET UNITYSDK_OFFSET(0x19E95610)
#define SRDEBUGGER_UI_OTHER_ERRORNOTIFIER_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x19E95600)
#define SRDEBUGGER_UI_OTHER_ERRORNOTIFIER_SHOWERRORWARNING_OFFSET UNITYSDK_OFFSET(0x19E776D0)
#define SRDEBUGGER_UI_OTHER_ERRORNOTIFIER_UPDATE_OFFSET UNITYSDK_OFFSET(0x19E95650)
#define SRDEBUGGER_UI_OTHER_ERRORNOTIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E956D0)

namespace SRDebugger::UI::Other
{
	inline static constexpr unsigned int ErrorNotifier_TypeDefinitionIndex = 35370;
