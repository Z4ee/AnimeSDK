...
#define SRDEBUGGER_UI_OTHER_ERRORNOTIFIER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1AD0B370)
#define SRDEBUGGER_UI_OTHER_ERRORNOTIFIER_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x1AD0B360)
#define SRDEBUGGER_UI_OTHER_ERRORNOTIFIER_SHOWERRORWARNING_OFFSET UNITYSDK_OFFSET(0x1ACEDAD0)
#define SRDEBUGGER_UI_OTHER_ERRORNOTIFIER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AD0B3B0)
#define SRDEBUGGER_UI_OTHER_ERRORNOTIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD0B430)

namespace SRDebugger::UI::Other
{
	inline static constexpr unsigned int ErrorNotifier_TypeDefinitionIndex = 35670;
