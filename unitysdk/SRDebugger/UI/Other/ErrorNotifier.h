...
#define SRDEBUGGER_UI_OTHER_ERRORNOTIFIER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1E69B7D0)
#define SRDEBUGGER_UI_OTHER_ERRORNOTIFIER_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x1E69B7C0)
#define SRDEBUGGER_UI_OTHER_ERRORNOTIFIER_SHOWERRORWARNING_OFFSET UNITYSDK_OFFSET(0x1E67B3D0)
#define SRDEBUGGER_UI_OTHER_ERRORNOTIFIER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E69B810)
#define SRDEBUGGER_UI_OTHER_ERRORNOTIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E69B890)
