...
#define SRDEBUGGER_UI_OTHER_HANDLEMANAGER_SETACTIVE_OFFSET UNITYSDK_OFFSET(0x1E69BFA0)
#define SRDEBUGGER_UI_OTHER_HANDLEMANAGER_SETALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1E682030)
#define SRDEBUGGER_UI_OTHER_HANDLEMANAGER_START_OFFSET UNITYSDK_OFFSET(0x1E69BF90)
#define SRDEBUGGER_UI_OTHER_HANDLEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E69BFC0)
