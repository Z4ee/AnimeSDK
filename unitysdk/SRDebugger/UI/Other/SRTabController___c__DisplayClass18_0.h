...
#define SRDEBUGGER_UI_OTHER_SRTABCONTROLLER___C__DISPLAYCLASS18_0__ADDTAB_B__0_OFFSET UNITYSDK_OFFSET(0x1845C350)
#define SRDEBUGGER_UI_OTHER_SRTABCONTROLLER___C__DISPLAYCLASS18_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1845C000)

namespace SRDebugger::UI::Other
{
	inline static constexpr unsigned int SRTabController___c__DisplayClass18_0_TypeDefinitionIndex = 29660;
