...
#define SRDEBUGGER_UI_OTHER_BUGREPORTSHEETCONTROLLER__SUBMITCO_D__18_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1E699B70)
#define SRDEBUGGER_UI_OTHER_BUGREPORTSHEETCONTROLLER__SUBMITCO_D__18_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E699F20)
#define SRDEBUGGER_UI_OTHER_BUGREPORTSHEETCONTROLLER__SUBMITCO_D__18_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E699F80)
#define SRDEBUGGER_UI_OTHER_BUGREPORTSHEETCONTROLLER__SUBMITCO_D__18_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1E699F30)
#define SRDEBUGGER_UI_OTHER_BUGREPORTSHEETCONTROLLER__SUBMITCO_D__18_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E699B60)
#define SRDEBUGGER_UI_OTHER_BUGREPORTSHEETCONTROLLER__SUBMITCO_D__18__CTOR_OFFSET UNITYSDK_OFFSET(0x1E699740)

namespace SRDebugger::UI::Other
{
	inline static constexpr unsigned int BugReportSheetController__SubmitCo_d__18_TypeDefinitionIndex = 37305;
