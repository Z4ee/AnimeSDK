...
#define SRDEBUGGER_UI_CUSTOMDEBUGREADONLYCONTROL_CANBIND_OFFSET UNITYSDK_OFFSET(0xABBC4B0)
#define SRDEBUGGER_UI_CUSTOMDEBUGREADONLYCONTROL_ONBIND_OFFSET UNITYSDK_OFFSET(0xABBC490)
#define SRDEBUGGER_UI_CUSTOMDEBUGREADONLYCONTROL_ONVALUEUPDATED_OFFSET UNITYSDK_OFFSET(0xABBC4A0)
#define SRDEBUGGER_UI_CUSTOMDEBUGREADONLYCONTROL_START_OFFSET UNITYSDK_OFFSET(0xABBC480)
#define SRDEBUGGER_UI_CUSTOMDEBUGREADONLYCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xABBC4C0)

namespace SRDebugger::UI
{
	inline static constexpr unsigned int CustomDebugReadOnlyControl_TypeDefinitionIndex = 38586;
