...
#define SRDEBUGGER_UI_CUSTOMDEBUGREADONLYCONTROL_CANBIND_OFFSET UNITYSDK_OFFSET(0x19F66E90)
#define SRDEBUGGER_UI_CUSTOMDEBUGREADONLYCONTROL_ONBIND_OFFSET UNITYSDK_OFFSET(0x19F66E70)
#define SRDEBUGGER_UI_CUSTOMDEBUGREADONLYCONTROL_ONVALUEUPDATED_OFFSET UNITYSDK_OFFSET(0x19F66E80)
#define SRDEBUGGER_UI_CUSTOMDEBUGREADONLYCONTROL_START_OFFSET UNITYSDK_OFFSET(0x19F66E60)
#define SRDEBUGGER_UI_CUSTOMDEBUGREADONLYCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x19F66EA0)

namespace SRDebugger::UI
{
	inline static constexpr unsigned int CustomDebugReadOnlyControl_TypeDefinitionIndex = 45942;
