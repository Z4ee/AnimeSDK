...
#define SRDEBUGGER_BINDCONTROLACTIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1EE7D0)

namespace SRDebugger
{
	inline static constexpr unsigned int BindControlActionAttribute_TypeDefinitionIndex = 36410;
