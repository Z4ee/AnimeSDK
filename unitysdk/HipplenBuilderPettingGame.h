...
#define HIPPLENBUILDERPETTINGGAME_METHOD_5_6478E93E26BFB642_OFFSET UNITYSDK_OFFSET(0x10C24FA0)
#define HIPPLENBUILDERPETTINGGAME_METHOD_5_C5B3CC9884471A9E_OFFSET UNITYSDK_OFFSET(0x10C25660)
#define HIPPLENBUILDERPETTINGGAME_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x10C25AF0)
#define HIPPLENBUILDERPETTINGGAME_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x10C25B50)
#define HIPPLENBUILDERPETTINGGAME_START_OFFSET UNITYSDK_OFFSET(0x10C24560)
#define HIPPLENBUILDERPETTINGGAME_UPDATE_OFFSET UNITYSDK_OFFSET(0x10C246A0)
#define HIPPLENBUILDERPETTINGGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x10C25FC0)

inline static constexpr unsigned int HipplenBuilderPettingGame_TypeDefinitionIndex = 38113;
