...
#define HIPPLENBUILDERPETTINGGAME_METHOD_5_145F41071532775D_OFFSET UNITYSDK_OFFSET(0x15ADA230)
#define HIPPLENBUILDERPETTINGGAME_METHOD_5_C5B3CC9884471A9E_OFFSET UNITYSDK_OFFSET(0x15ADA890)
#define HIPPLENBUILDERPETTINGGAME_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x15ADAD20)
#define HIPPLENBUILDERPETTINGGAME_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x15ADAD80)
#define HIPPLENBUILDERPETTINGGAME_START_OFFSET UNITYSDK_OFFSET(0x15AD9800)
#define HIPPLENBUILDERPETTINGGAME_UPDATE_OFFSET UNITYSDK_OFFSET(0x15AD9940)
#define HIPPLENBUILDERPETTINGGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x15ADB1A0)
