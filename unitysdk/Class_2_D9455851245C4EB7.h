...
#define CLASS_2_D9455851245C4EB7_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17F2E530)
#define CLASS_2_D9455851245C4EB7_METHOD_2_AA0EFBB13088BA5E_OFFSET UNITYSDK_OFFSET(0x17F2F390)
#define CLASS_2_D9455851245C4EB7_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17F2E580)
#define CLASS_2_D9455851245C4EB7_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17F2F680)
#define CLASS_2_D9455851245C4EB7_TICK_OFFSET UNITYSDK_OFFSET(0x17F2F6D0)
#define CLASS_2_D9455851245C4EB7__CTOR_OFFSET UNITYSDK_OFFSET(0x17F2E490)
...
{
public:
	::Class_3_07C3C4D2990C49EE* KLCAHFOFIHC; // 0x18
	::RPG::GameCore::GameEntity* OJAHLJGABMJ; // 0x20
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x28
	::RPG::GameCore::CreateBattleCharacter* OFKGLJOAMLD; // 0x30
