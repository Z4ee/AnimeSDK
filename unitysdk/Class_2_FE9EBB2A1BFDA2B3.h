...
#define CLASS_2_FE9EBB2A1BFDA2B3_DISPOSE_OFFSET UNITYSDK_OFFSET(0x118CF110)
#define CLASS_2_FE9EBB2A1BFDA2B3_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x118CF150)
#define CLASS_2_FE9EBB2A1BFDA2B3_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x118CF210)
#define CLASS_2_FE9EBB2A1BFDA2B3_TICK_OFFSET UNITYSDK_OFFSET(0x118CF260)
#define CLASS_2_FE9EBB2A1BFDA2B3__CTOR_OFFSET UNITYSDK_OFFSET(0x118CF100)

inline static constexpr unsigned int Class_2_FE9EBB2A1BFDA2B3_TypeDefinitionIndex = 44592;

class Class_2_FE9EBB2A1BFDA2B3 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::StretchGlobalTimeSlowByKey* Field_2_0; // 0x18
