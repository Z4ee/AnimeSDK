...
#define CLASS_2_FE9EBB2A1BFDA2B3_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15925BB0)
#define CLASS_2_FE9EBB2A1BFDA2B3_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15925BF0)
#define CLASS_2_FE9EBB2A1BFDA2B3_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15925D10)
#define CLASS_2_FE9EBB2A1BFDA2B3_TICK_OFFSET UNITYSDK_OFFSET(0x15925D60)
#define CLASS_2_FE9EBB2A1BFDA2B3__CTOR_OFFSET UNITYSDK_OFFSET(0x15925BA0)
...
{
public:
	::RPG::GameCore::StretchGlobalTimeSlowByKey* OFKGLJOAMLD; // 0x18
