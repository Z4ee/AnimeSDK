...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_CALSELECTALIGNTARGETPOSITIONV2_OFFSET UNITYSDK_OFFSET(0xFAFBD50)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_CALSELECTALIGNTARGETPOSITION_OFFSET UNITYSDK_OFFSET(0xFAF9850)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_CHECKSCROLLDATAINDEX_OFFSET UNITYSDK_OFFSET(0xFAF5BD0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_DEBUGLOG_OFFSET UNITYSDK_OFFSET(0xFAF6660)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GETREALALIGNDATAINDEXV2_OFFSET UNITYSDK_OFFSET(0xFAF7730)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GETREALALIGNRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xFAF8980)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET_CANNOTMOVERUNTIME_OFFSET UNITYSDK_OFFSET(0xFAF44F0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET_DATACOUNT_OFFSET UNITYSDK_OFFSET(0xFAF4420)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET_DYNAMICITEMSIZE_OFFSET UNITYSDK_OFFSET(0xFAF4490)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET_DYNAMICVIEWRECTSIZE_OFFSET UNITYSDK_OFFSET(0xFAF44B0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET_ISDRAGGINGSCROLLBAR_OFFSET UNITYSDK_OFFSET(0xFAF4540)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET_ISDRAGGING_OFFSET UNITYSDK_OFFSET(0xFAF4510)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET_ITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xFAF4650)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET_LOGIC_OFFSET UNITYSDK_OFFSET(0xFAF44D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET_LOOPSCROLL_OFFSET UNITYSDK_OFFSET(0xFAF4450)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET_MANUALMODE_OFFSET UNITYSDK_OFFSET(0xFAF4630)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET_M_DATAS_OFFSET UNITYSDK_OFFSET(0xFAF4610)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET_M_INITED_OFFSET UNITYSDK_OFFSET(0xFAF45F0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET_SIMPLEMODE_OFFSET UNITYSDK_OFFSET(0xFAF4470)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET_STARTAXISEQUALSCROLLAXIS_OFFSET UNITYSDK_OFFSET(0xFAF46B0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET__CURRENTSELECTALIGNTARGETDATAINDEX_OFFSET UNITYSDK_OFFSET(0xFAF4320)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET__CURRENTSELECTALIGNTARGETRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xFAF43A0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET__DATAINDEX_OFFSET UNITYSDK_OFFSET(0xFAF46E0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET__FEATURESTATE_OFFSET UNITYSDK_OFFSET(0xFAF4570)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET__SCROLLDATAINDEX_OFFSET UNITYSDK_OFFSET(0xFAFDD70)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET__SCROLLFROMDATAINDEX_OFFSET UNITYSDK_OFFSET(0xFAFDDB0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET__SCROLLTRANSFORM_OFFSET UNITYSDK_OFFSET(0xFAFDD90)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_ISMOVETOEND_1_OFFSET UNITYSDK_OFFSET(0xFAF7480)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_ISMOVETOEND_OFFSET UNITYSDK_OFFSET(0xFAF9E20)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_JUDGEALIGNDATAINDEX_OFFSET UNITYSDK_OFFSET(0xFAF7860)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_ONAFTERREFRESHGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xFAF4FE0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_ONCLEARALLITEMDATAS_OFFSET UNITYSDK_OFFSET(0xFAF42C0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_ONINITDATA_OFFSET UNITYSDK_OFFSET(0xFAF4280)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_ONSELECTITEMWHENNOTINIT_OFFSET UNITYSDK_OFFSET(0xFAF5B70)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SCROLLDELTA_OFFSET UNITYSDK_OFFSET(0xFAF4BE0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SCROLLTOSHOWTARGETWITHOUTANIM_OFFSET UNITYSDK_OFFSET(0xFAF60D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SCROLLTOSHOWTARGET_1_OFFSET UNITYSDK_OFFSET(0xFAF62F0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SCROLLTOSHOWTARGET_OFFSET UNITYSDK_OFFSET(0xFAF6020)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SCROLLTOTARGETINNERWITHOUTALIGNDATAINDEXOFFSET_1_OFFSET UNITYSDK_OFFSET(0xFAF9310)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SCROLLTOTARGETINNERWITHOUTALIGNDATAINDEXOFFSET_OFFSET UNITYSDK_OFFSET(0xFAF8FF0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SCROLLTOTARGETINNER_1_OFFSET UNITYSDK_OFFSET(0xFAF8620)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SCROLLTOTARGETINNER_2_OFFSET UNITYSDK_OFFSET(0xFAF7F80)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SCROLLTOTARGETINNER_OFFSET UNITYSDK_OFFSET(0xFAF6BF0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SCROLLTOTARGET_OFFSET UNITYSDK_OFFSET(0xFAF4700)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SET__CURRENTSELECTALIGNTARGETDATAINDEX_OFFSET UNITYSDK_OFFSET(0xFAF4340)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SET__CURRENTSELECTALIGNTARGETRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xFAF43C0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SET__FEATURESTATE_OFFSET UNITYSDK_OFFSET(0xFAF4590)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SET__SCROLLDATAINDEX_OFFSET UNITYSDK_OFFSET(0xFAFDD80)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SET__SCROLLFROMDATAINDEX_OFFSET UNITYSDK_OFFSET(0xFAFDDC0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SET__SCROLLTRANSFORM_OFFSET UNITYSDK_OFFSET(0xFAFDDA0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__CALSELECTALIGNTARGETPOSITIONV2_G__CALALIGNTARGETPOSITION_CENTER_63_0_OFFSET UNITYSDK_OFFSET(0xFAFC580)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__CALSELECTALIGNTARGETPOSITIONV2_G__CALALIGNTARGETPOSITION_CUSTOMRANGE_63_4_OFFSET UNITYSDK_OFFSET(0xFAFC830)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__CALSELECTALIGNTARGETPOSITIONV2_G__CALALIGNTARGETPOSITION_VISIBLE_63_3_OFFSET UNITYSDK_OFFSET(0xFAFBEC0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__CALSELECTALIGNTARGETPOSITIONV2_G__CALGRIDALIGNTARGETPOSITION_END_63_2_OFFSET UNITYSDK_OFFSET(0xFAFDB20)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__CALSELECTALIGNTARGETPOSITIONV2_G__CALGRIDALIGNTARGETPOSITION_START_63_1_OFFSET UNITYSDK_OFFSET(0xFAFD8D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__CALSELECTALIGNTARGETPOSITION_G__CALALIGNTARGETPOSITION_CENTER_62_0_OFFSET UNITYSDK_OFFSET(0xFAFA570)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__CALSELECTALIGNTARGETPOSITION_G__CALALIGNTARGETPOSITION_CUSTOMRANGE_62_4_OFFSET UNITYSDK_OFFSET(0xFAFA820)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__CALSELECTALIGNTARGETPOSITION_G__CALALIGNTARGETPOSITION_VISIBLE_62_3_OFFSET UNITYSDK_OFFSET(0xFAF9EB0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__CALSELECTALIGNTARGETPOSITION_G__CALGRIDALIGNTARGETPOSITION_END_62_2_OFFSET UNITYSDK_OFFSET(0xFAFBB00)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__CALSELECTALIGNTARGETPOSITION_G__CALGRIDALIGNTARGETPOSITION_START_62_1_OFFSET UNITYSDK_OFFSET(0xFAFB8B0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__CHECKSCROLLDATAINDEX_G__GETSCROLLDIRECTION_47_0_OFFSET UNITYSDK_OFFSET(0xFAF6000)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0xFAF4270)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__GETREALALIGNDATAINDEXV2_G__GETNEXTINDEX_58_1_OFFSET UNITYSDK_OFFSET(0xFAF9CA0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__GETREALALIGNDATAINDEXV2_G__GETPREVINDEX_58_0_OFFSET UNITYSDK_OFFSET(0xFAF9C20)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__GETREALALIGNRECTTRANSFORM_G__ISMOVETOENDV2_57_0_OFFSET UNITYSDK_OFFSET(0xFAF99B0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__GETREALALIGNRECTTRANSFORM_G__SELECTACTIVEGAMEOBJECTBYOFFSET_57_3_OFFSET UNITYSDK_OFFSET(0xFAF9B20)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__GETREALALIGNRECTTRANSFORM_G__SELECTACTIVEGAMEOBJECTINNER_57_2_OFFSET UNITYSDK_OFFSET(0xFAFDEC0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__GETREALALIGNRECTTRANSFORM_G__SELECTACTIVEGAMEOBJECT_57_1_OFFSET UNITYSDK_OFFSET(0xFAFDDF0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__JUDGEALIGNDATAINDEX_G__GETALIGNDATAINDEX_59_0_OFFSET UNITYSDK_OFFSET(0xFAF9D20)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__JUDGEALIGNDATAINDEX_G__GETALIGNDATAINDEX_59_2_OFFSET UNITYSDK_OFFSET(0xFAF9E70)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__JUDGEALIGNDATAINDEX_G__GETSCROLLDISTANCE_59_1_OFFSET UNITYSDK_OFFSET(0xFAFDF70)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__SCROLLTOSHOWTARGETWITHOUTANIM_G__GETSCROLLDIRECTION_49_0_OFFSET UNITYSDK_OFFSET(0xFAF62D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__SCROLLTOTARGETINNER_G__GETDISTANCETOVISIBLE_52_1_OFFSET UNITYSDK_OFFSET(0xFAFDDD0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__SCROLLTOTARGETINNER_G__GETNEARESTDATAINDEX_52_0_OFFSET UNITYSDK_OFFSET(0xFAF7EE0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__SCROLLTOTARGET_G__INNER_43_0_OFFSET UNITYSDK_OFFSET(0xFAF49D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET___BASE_ONCLEARALLITEMDATAS_OFFSET UNITYSDK_OFFSET(0xFAFE010)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET___BASE_ONINITDATA_OFFSET UNITYSDK_OFFSET(0xFAFE0A0)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginScrollToTarget_TypeDefinitionIndex = 69934;
...
public:
	...
	::System::Nullable_1<::System::Boolean> _consoleScrollToEnd; // 0x2C
	::System::Boolean _tempParamFor1_0; // 0x2E
