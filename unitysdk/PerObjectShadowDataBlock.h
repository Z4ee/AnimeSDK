...
#define PEROBJECTSHADOWDATABLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x95D0B0)

inline static constexpr unsigned int PerObjectShadowDataBlock_TypeDefinitionIndex = 27332;
