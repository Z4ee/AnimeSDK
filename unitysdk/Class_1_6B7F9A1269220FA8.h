...
#define CLASS_1_6B7F9A1269220FA8_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17BAB860)
#define CLASS_1_6B7F9A1269220FA8_METHOD_1_37AACA8481A4B501_OFFSET UNITYSDK_OFFSET(0x17BAB4C0)
#define CLASS_1_6B7F9A1269220FA8_METHOD_1_5B2CAD1A0582F9BB_OFFSET UNITYSDK_OFFSET(0x17BAB8B0)
#define CLASS_1_6B7F9A1269220FA8_METHOD_1_FD1A8012013ED9C5_OFFSET UNITYSDK_OFFSET(0x17BAB6C0)
#define CLASS_1_6B7F9A1269220FA8__CTOR_OFFSET UNITYSDK_OFFSET(0x17BAB430)
...
{
public:
	::Class_1_52DD9E5E2B969CDC* EDLCJHNBKDN; // 0x10
	::RPG::Client::AudiencePrefabSpecialTag_Blink* EIALGCHCOCN; // 0x18
	::RPG::GameCore::CharacterAtlasFaceSet* IBOHAFFKOJN; // 0x20
	::System::Collections::Generic::List_1<::System::Int32>* OIKPPAFNOEJ; // 0x28
	::System::Single MLHIGPBLBPN; // 0x30
	::System::Single CLLHFCJIAHB; // 0x34
