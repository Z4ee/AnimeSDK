...
#define CLASS_1_6B7F9A1269220FA8_DISPOSE_OFFSET UNITYSDK_OFFSET(0x12ACE530)
#define CLASS_1_6B7F9A1269220FA8_METHOD_1_2779D76E9C9FA4B9_OFFSET UNITYSDK_OFFSET(0x12ACE0E0)
#define CLASS_1_6B7F9A1269220FA8_METHOD_1_5B2CAD1A0582F9BB_OFFSET UNITYSDK_OFFSET(0x12ACE580)
#define CLASS_1_6B7F9A1269220FA8_METHOD_1_EDBC885B6838D667_OFFSET UNITYSDK_OFFSET(0x12ACE2C0)
#define CLASS_1_6B7F9A1269220FA8__CTOR_OFFSET UNITYSDK_OFFSET(0x12ACE050)

inline static constexpr unsigned int Class_1_6B7F9A1269220FA8_TypeDefinitionIndex = 63741;

class Class_1_6B7F9A1269220FA8 : public ::System::Object
{
public:
	::RPG::Client::AudiencePrefabSpecialTag_Blink* Field_1_1; // 0x10
	::System::Collections::Generic::List_1<::System::Int32>* Field_1_3; // 0x18
	::RPG::GameCore::CharacterAtlasFaceSet* Field_1_2; // 0x20
	::Class_1_52DD9E5E2B969CDC* Field_1_0; // 0x28
