...
#define CLASS_2_478930A9575FB58A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15479740)
#define CLASS_2_478930A9575FB58A_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x15479720)
#define CLASS_2_478930A9575FB58A_METHOD_2_84C3BE9BB646C7FD_OFFSET UNITYSDK_OFFSET(0x1547A490)
#define CLASS_2_478930A9575FB58A_METHOD_2_94B986AB6A27D0D2_OFFSET UNITYSDK_OFFSET(0x1547A2F0)
#define CLASS_2_478930A9575FB58A_METHOD_2_CEBFF096B4C9D46B_OFFSET UNITYSDK_OFFSET(0x1547ADD0)
#define CLASS_2_478930A9575FB58A_METHOD_2_D109CE569415FA03_OFFSET UNITYSDK_OFFSET(0x1547BAF0)
#define CLASS_2_478930A9575FB58A_METHOD_2_E99F5B5982E9B552_OFFSET UNITYSDK_OFFSET(0x1547B560)
#define CLASS_2_478930A9575FB58A_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x1547BA90)
#define CLASS_2_478930A9575FB58A_ONSKIP_OFFSET UNITYSDK_OFFSET(0x1547B760)
#define CLASS_2_478930A9575FB58A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15479780)
#define CLASS_2_478930A9575FB58A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1547B440)
#define CLASS_2_478930A9575FB58A_TICK_OFFSET UNITYSDK_OFFSET(0x1547B490)
#define CLASS_2_478930A9575FB58A__CTOR_OFFSET UNITYSDK_OFFSET(0x15479730)
...
{
public:
	::System::String* CENMHIGCEDG; // 0x18
	::System::String* MLHHKCCAOJK; // 0x20
	::Cinemachine::CinemachineBrain* NDFNHOJDLPK; // 0x28
	::RPG::GameCore::ActiveVirtualCamera_PerformanceTransition* OFKGLJOAMLD; // 0x30
	::System::String* ALGOGGCGNEJ; // 0x38
