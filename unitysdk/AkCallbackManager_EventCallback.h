...
#define AKCALLBACKMANAGER_EVENTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F7EB160)
#define AKCALLBACKMANAGER_EVENTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F7EB1F0)
#define AKCALLBACKMANAGER_EVENTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F7EABB0)
#define AKCALLBACKMANAGER_EVENTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1F7EAB90)

inline static constexpr unsigned int AkCallbackManager_EventCallback_TypeDefinitionIndex = 33684;
