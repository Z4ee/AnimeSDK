...
#define AKCALLBACKMANAGER_EVENTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D58BB90)
#define AKCALLBACKMANAGER_EVENTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D58BC00)
#define AKCALLBACKMANAGER_EVENTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D58AD80)
#define AKCALLBACKMANAGER_EVENTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D58BAA0)
