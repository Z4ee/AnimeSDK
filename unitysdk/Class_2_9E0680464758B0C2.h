...
#define CLASS_2_9E0680464758B0C2_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA64B100)
#define CLASS_2_9E0680464758B0C2_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xA64B140)
#define CLASS_2_9E0680464758B0C2_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xA64B2B0)
#define CLASS_2_9E0680464758B0C2_TICK_OFFSET UNITYSDK_OFFSET(0xA64B300)
#define CLASS_2_9E0680464758B0C2__CTOR_OFFSET UNITYSDK_OFFSET(0xA64B0F0)

inline static constexpr unsigned int Class_2_9E0680464758B0C2_TypeDefinitionIndex = 51939;
...
public:
	...
	::RPG::GameCore::ShowBattleFeverTimeScreenFire* Field_2_2; // 0x20
