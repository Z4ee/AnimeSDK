...
#define CLASS_2_08CB3ADF4FC783D2_DISPOSE_OFFSET UNITYSDK_OFFSET(0x134B7E80)
#define CLASS_2_08CB3ADF4FC783D2_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x134B7F10)
#define CLASS_2_08CB3ADF4FC783D2_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x134B7EC0)
#define CLASS_2_08CB3ADF4FC783D2_TICK_OFFSET UNITYSDK_OFFSET(0x134B7F60)
#define CLASS_2_08CB3ADF4FC783D2__CTOR_OFFSET UNITYSDK_OFFSET(0x134B7E70)

inline static constexpr unsigned int Class_2_08CB3ADF4FC783D2_TypeDefinitionIndex = 55344;

class Class_2_08CB3ADF4FC783D2 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::LoadBattleArea* OFKGLJOAMLD; // 0x18
