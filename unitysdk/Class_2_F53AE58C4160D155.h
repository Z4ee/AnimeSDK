...
#define CLASS_2_F53AE58C4160D155_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBAE63D0)
#define CLASS_2_F53AE58C4160D155_METHOD_2_6BD012F436E1844D_OFFSET UNITYSDK_OFFSET(0xBAE6930)
#define CLASS_2_F53AE58C4160D155_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xBAE62A0)
#define CLASS_2_F53AE58C4160D155_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xBAE6380)
#define CLASS_2_F53AE58C4160D155_TICK_OFFSET UNITYSDK_OFFSET(0xBAE6F90)
#define CLASS_2_F53AE58C4160D155__CTOR_OFFSET UNITYSDK_OFFSET(0xBAE5F10)
...
{
public:
	::Class_3_07C3C4D2990C49EE* KIJAPLDDHNL; // 0x18
	::RPG::GameCore::TaskContext* EEFMDEHLLFI; // 0x20
	::Class_3_07C3C4D2990C49EE* BAONKBDCBDN; // 0x28
	::RPG::GameCore::OpticalIllusionPuzzleEventListener* IGHAHBNLIJA; // 0x30
	::Class_3_07C3C4D2990C49EE* NJBHAENKEEF; // 0x38
	::Class_3_07C3C4D2990C49EE* NDPIPPKNDMA; // 0x40
	::Class_3_07C3C4D2990C49EE* JAKNDHHOCJE; // 0x48
	::Class_3_07C3C4D2990C49EE* CIFOILLJFNF; // 0x50
	::Class_3_07C3C4D2990C49EE* PAOJOBEPBIO; // 0x58
	::Class_3_07C3C4D2990C49EE* LGNCIBMAIEA; // 0x60
