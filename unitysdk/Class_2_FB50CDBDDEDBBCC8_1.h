...
#define CLASS_2_FB50CDBDDEDBBCC8_1_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x1000BA60)
#define CLASS_2_FB50CDBDDEDBBCC8_1_METHOD_2_7C2C2820B36B9508_OFFSET UNITYSDK_OFFSET(0x1000B980)
#define CLASS_2_FB50CDBDDEDBBCC8_1_METHOD_2_9E16668DCD80C475_OFFSET UNITYSDK_OFFSET(0x1000B8C0)
#define CLASS_2_FB50CDBDDEDBBCC8_1_METHOD_2_BA3A3B0992257D00_OFFSET UNITYSDK_OFFSET(0x1000B8B0)
#define CLASS_2_FB50CDBDDEDBBCC8_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1000B8A0)

inline static constexpr unsigned int Class_2_FB50CDBDDEDBBCC8_1_TypeDefinitionIndex = 69108;

class Class_2_FB50CDBDDEDBBCC8_1 : public ::Class_1_D019640AABA5E1A8
{
public:
	::Class_1_21C7581DFE99F091_101* Field_2_0; // 0x28

	::System::Void _ctor(::Class_1_21C7581DFE99F091_101* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_21C7581DFE99F091_101*))((::PBYTE)hIl2Cpp + CLASS_2_FB50CDBDDEDBBCC8_1__CTOR_OFFSET))(this, a1);
	}
