...
#define NAP_NAPECS_ECSCOMPONENTMETAINFO_CREATECOMPONENTLIST_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B2EEE40)
#define NAP_NAPECS_ECSCOMPONENTMETAINFO_CREATECOMPONENTLIST_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B2EEE70)
#define NAP_NAPECS_ECSCOMPONENTMETAINFO_CREATECOMPONENTLIST_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B2EEBA0)
#define NAP_NAPECS_ECSCOMPONENTMETAINFO_CREATECOMPONENTLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2EEB80)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsComponentMetaInfo_CreateComponentList_TypeDefinitionIndex = 37338;
