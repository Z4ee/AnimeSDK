...
#define NAP_NAPECS_ECSWORLDTIMELINE_SYNCEVENT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x192ECD10)
#define NAP_NAPECS_ECSWORLDTIMELINE_SYNCEVENT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x192ECDC0)
#define NAP_NAPECS_ECSWORLDTIMELINE_SYNCEVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x192EC870)
#define NAP_NAPECS_ECSWORLDTIMELINE_SYNCEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x192ECD00)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsWorldTimeline_SyncEvent_TypeDefinitionIndex = 35724;
