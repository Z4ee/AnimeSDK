...
#define NAP_NAPECS_ECSWORLDTIMELINE_SYNCEVENT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B30BBE0)
#define NAP_NAPECS_ECSWORLDTIMELINE_SYNCEVENT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B30BC90)
#define NAP_NAPECS_ECSWORLDTIMELINE_SYNCEVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B30B730)
#define NAP_NAPECS_ECSWORLDTIMELINE_SYNCEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B30BBC0)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsWorldTimeline_SyncEvent_TypeDefinitionIndex = 37267;
