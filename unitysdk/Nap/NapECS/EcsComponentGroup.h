...
#define NAP_NAPECS_ECSCOMPONENTGROUP_ADD_OFFSET UNITYSDK_OFFSET(0x1C83BF50)
#define NAP_NAPECS_ECSCOMPONENTGROUP_DESTROY_OFFSET UNITYSDK_OFFSET(0x1C83D1F0)
#define NAP_NAPECS_ECSCOMPONENTGROUP_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C83D2D0)
#define NAP_NAPECS_ECSCOMPONENTGROUP_REMOVE_1_OFFSET UNITYSDK_OFFSET(0x1C83D180)
#define NAP_NAPECS_ECSCOMPONENTGROUP_REMOVE_OFFSET UNITYSDK_OFFSET(0x1C83D120)
#define NAP_NAPECS_ECSCOMPONENTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1C83D060)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsComponentGroup_TypeDefinitionIndex = 37922;
