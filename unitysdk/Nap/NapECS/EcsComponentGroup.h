...
#define NAP_NAPECS_ECSCOMPONENTGROUP_ADD_OFFSET UNITYSDK_OFFSET(0x192CE950)
#define NAP_NAPECS_ECSCOMPONENTGROUP_DESTROY_OFFSET UNITYSDK_OFFSET(0x192CFC10)
#define NAP_NAPECS_ECSCOMPONENTGROUP_DISPOSE_OFFSET UNITYSDK_OFFSET(0x192CFCF0)
#define NAP_NAPECS_ECSCOMPONENTGROUP_REMOVE_1_OFFSET UNITYSDK_OFFSET(0x192CFBA0)
#define NAP_NAPECS_ECSCOMPONENTGROUP_REMOVE_OFFSET UNITYSDK_OFFSET(0x192CFB40)
#define NAP_NAPECS_ECSCOMPONENTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x192CFA80)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsComponentGroup_TypeDefinitionIndex = 35727;
