...
#define NAP_NAPECS_ECSSYSTEMMETA_DUMMYECSCLASS__CTOR_OFFSET UNITYSDK_OFFSET(0x192E3A80)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsSystemMeta_DummyEcsClass_TypeDefinitionIndex = 35748;
