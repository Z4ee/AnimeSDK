...
#define NAP_NAPECS_SYNCTIMECONTEXT_GET_DELTATIME_OFFSET UNITYSDK_OFFSET(0x3B3000)
#define NAP_NAPECS_SYNCTIMECONTEXT_GET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x2E1000)
#define NAP_NAPECS_SYNCTIMECONTEXT_GET_UNSCALEDDELTATIME_OFFSET UNITYSDK_OFFSET(0x6E8AA0)
#define NAP_NAPECS_SYNCTIMECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x86BE90)

namespace Nap::NapECS
{
	inline static constexpr unsigned int SyncTimeContext_TypeDefinitionIndex = 35750;
