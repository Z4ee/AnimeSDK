...
#define NAP_NAPECS_ECSCOMPONENTMETAINFO_CREATEDATACOMPONENTLIST_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B2EF140)
#define NAP_NAPECS_ECSCOMPONENTMETAINFO_CREATEDATACOMPONENTLIST_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B2EF170)
#define NAP_NAPECS_ECSCOMPONENTMETAINFO_CREATEDATACOMPONENTLIST_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B2EEEA0)
#define NAP_NAPECS_ECSCOMPONENTMETAINFO_CREATEDATACOMPONENTLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2EEE80)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsComponentMetaInfo_CreateDataComponentList_TypeDefinitionIndex = 37339;
