...
#define NAP_NAPECS_ECSWORLD_ADDCOMPONENTSTOENTITY_1_OFFSET UNITYSDK_OFFSET(0x1C854630)
#define NAP_NAPECS_ECSWORLD_ADDCOMPONENTSTOENTITY_OFFSET UNITYSDK_OFFSET(0x1C8543D0)
#define NAP_NAPECS_ECSWORLD_ADDCOMPONENTTOENTITY_OFFSET UNITYSDK_OFFSET(0x1C855880)
#define NAP_NAPECS_ECSWORLD_ADDFILTER_OFFSET UNITYSDK_OFFSET(0x1C843150)
#define NAP_NAPECS_ECSWORLD_ADDSYSTEM_OFFSET UNITYSDK_OFFSET(0x1C852410)
#define NAP_NAPECS_ECSWORLD_AFTERANIMATORFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1C853D50)
#define NAP_NAPECS_ECSWORLD_BEFOREFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1C8537C0)
#define NAP_NAPECS_ECSWORLD_CREATESYSTEMS_OFFSET UNITYSDK_OFFSET(0x1C852220)
#define NAP_NAPECS_ECSWORLD_DESTROYENTITY_OFFSET UNITYSDK_OFFSET(0x1C856500)
#define NAP_NAPECS_ECSWORLD_DIAGNOSECHECKFILTERCONSISTENCY_OFFSET UNITYSDK_OFFSET(0x1C856220)
#define NAP_NAPECS_ECSWORLD_ENDOFFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1C853DF0)
#define NAP_NAPECS_ECSWORLD_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1C853770)
#define NAP_NAPECS_ECSWORLD_GETARCHETYPEVERSION_OFFSET UNITYSDK_OFFSET(0x1C856BB0)
#define NAP_NAPECS_ECSWORLD_GETCOMPONENTMASK_OFFSET UNITYSDK_OFFSET(0x1C856C50)
#define NAP_NAPECS_ECSWORLD_GET_TIMECENTER_OFFSET UNITYSDK_OFFSET(0x1C851950)
#define NAP_NAPECS_ECSWORLD_INNERFIXEDSTEPTIMECENTER_OFFSET UNITYSDK_OFFSET(0x1C853820)
#define NAP_NAPECS_ECSWORLD_INNERSTEPTIMECENTER_OFFSET UNITYSDK_OFFSET(0x1C852750)
#define NAP_NAPECS_ECSWORLD_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1C852820)
#define NAP_NAPECS_ECSWORLD_LINKFILTERARCHETYPE_OFFSET UNITYSDK_OFFSET(0x1C83AA10)
#define NAP_NAPECS_ECSWORLD_MODIFYENTITYCOMPONENTSINTERNAL_1_OFFSET UNITYSDK_OFFSET(0x1C8549D0)
#define NAP_NAPECS_ECSWORLD_MODIFYENTITYCOMPONENTSINTERNAL_OFFSET UNITYSDK_OFFSET(0x1C854570)
#define NAP_NAPECS_ECSWORLD_ONADDCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1C856450)
#define NAP_NAPECS_ECSWORLD_ONANIMIKPOSTUPDATE_OFFSET UNITYSDK_OFFSET(0x1C853E40)
#define NAP_NAPECS_ECSWORLD_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1C853F30)
#define NAP_NAPECS_ECSWORLD_ONPOSTPARTICLESYSTEMUPDATE_OFFSET UNITYSDK_OFFSET(0x1C853EE0)
#define NAP_NAPECS_ECSWORLD_ONPOSTSIMULATIONUPDATE_OFFSET UNITYSDK_OFFSET(0x1C853E90)
#define NAP_NAPECS_ECSWORLD_POSTLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1C852890)
#define NAP_NAPECS_ECSWORLD_REMOVECOMPONENTFROMENTITY_OFFSET UNITYSDK_OFFSET(0x1C855E90)
#define NAP_NAPECS_ECSWORLD_REMOVECOMPONENTSFROMENTITY_OFFSET UNITYSDK_OFFSET(0x1C855AC0)
#define NAP_NAPECS_ECSWORLD_REMOVEFILTER_OFFSET UNITYSDK_OFFSET(0x1C854370)
#define NAP_NAPECS_ECSWORLD_SET_TIMECENTER_OFFSET UNITYSDK_OFFSET(0x1C851960)
#define NAP_NAPECS_ECSWORLD_STARTTIMECENTER_OFFSET UNITYSDK_OFFSET(0x1C852520)
#define NAP_NAPECS_ECSWORLD_START_OFFSET UNITYSDK_OFFSET(0x1C852480)
#define NAP_NAPECS_ECSWORLD_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C8526E0)
#define NAP_NAPECS_ECSWORLD_WAITFORFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1C853DA0)
#define NAP_NAPECS_ECSWORLD__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C851980)
#define NAP_NAPECS_ECSWORLD__CTOR_OFFSET UNITYSDK_OFFSET(0x1C851970)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsWorld_TypeDefinitionIndex = 37970;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(EcsWorld_TypeDefinitionIndex)->GetStaticField(0x8A60);
		}
		static ::System::Boolean* StaticGet_EnableDiagnose()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(EcsWorld_TypeDefinitionIndex)->GetStaticField(0x8A61);
		}
		::Nap::NapECS::EcsArchetypeGroup* archetypeGroup; // 0x10
		::Nap::NapECS::EcsFilterGroup* filterGroup; // 0x18
		::Nap::NapECS::EcsWorldTimeCenter* _TimeCenter_k__BackingField; // 0x20
		::Nap::NapECS::EcsComponentGroup* componentGroup; // 0x28
		::Nap::NapECS::EcsEntityGroup* entityGroup; // 0x30
		::Nap::NapECS::EcsSystemGroup* systemGroup; // 0x38
		::Nap::NapECS::EcsWorld_EntityComponentMaskMap* _componentMaskMap; // 0x40
		::System::Int32 worldId; // 0x48
		::System::Int32 worldTypeID; // 0x4C
		::System::Boolean enableForEachAccelerate; // 0x50
