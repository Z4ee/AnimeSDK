...
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_COMPONENTMASKPREDICATEPASSFILTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x86BCD0)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_COMPONENTMASKPREDICATEPASSFILTER_NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_ICOMPONENTMASKPREDICATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x86BD80)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsWorld_EntityComponentMaskMap_ComponentMaskPredicatePassFilter_TypeDefinitionIndex = 35689;
