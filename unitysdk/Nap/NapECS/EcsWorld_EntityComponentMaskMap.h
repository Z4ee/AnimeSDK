...
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_ADDCOMPONENTMASK_OFFSET UNITYSDK_OFFSET(0x1B30A140)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_APPLYDELTA_OFFSET UNITYSDK_OFFSET(0x1B309C50)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_GETCOMPONENTMASK_OFFSET UNITYSDK_OFFSET(0x1B307D80)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_GETVERSION_OFFSET UNITYSDK_OFFSET(0x1B308FB0)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_HANDLEDIRTYENTITIES_OFFSET UNITYSDK_OFFSET(0x1B303940)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_HANDLEENTITYADD_OFFSET UNITYSDK_OFFSET(0x1B309990)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_HANDLEENTITYREMOVE_OFFSET UNITYSDK_OFFSET(0x1B309AF0)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_ONENTITYADDED_OFFSET UNITYSDK_OFFSET(0x1B308050)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_ONENTITYCHANGED_OFFSET UNITYSDK_OFFSET(0x1B308120)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_ONENTITYDESTROY_OFFSET UNITYSDK_OFFSET(0x1B309000)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_ONENTITYLAYOUTCHANGED_OFFSET UNITYSDK_OFFSET(0x1B309220)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_REMOVECOMPONENTMASK_OFFSET UNITYSDK_OFFSET(0x1B30A330)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_SETMERGE_OFFSET UNITYSDK_OFFSET(0x1B3089D0)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_SETREMOVE_OFFSET UNITYSDK_OFFSET(0x1B3085E0)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B302D40)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsWorld_EntityComponentMaskMap_TypeDefinitionIndex = 37373;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::Nap::NapECS::ComponentMask, ::System::Int32>* _maskToEntityCount; // 0x18
		::System::Collections::Generic::List_1<::Nap::NapECS::ComponentMask>* _addBuffer; // 0x20
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::ValueTuple_2<::System::Nullable_1<::Nap::NapECS::ComponentMask>, ::System::Nullable_1<::Nap::NapECS::ComponentMask>>>* _cachedDirtyEntities; // 0x28
		::System::Collections::Generic::Dictionary_2<::Nap::NapECS::ComponentMask, ::System::Int32>* _deltaBuffer; // 0x30
		::System::Collections::Generic::List_1<::Nap::NapECS::ComponentMask>* _removeBuffer; // 0x38
