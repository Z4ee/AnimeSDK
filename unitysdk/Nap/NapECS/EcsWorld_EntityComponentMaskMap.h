...
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_ADDCOMPONENTMASK_OFFSET UNITYSDK_OFFSET(0x192EB230)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_APPLYDELTA_OFFSET UNITYSDK_OFFSET(0x192EAD40)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_GETCOMPONENTMASK_OFFSET UNITYSDK_OFFSET(0x192E8E70)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_GETVERSION_OFFSET UNITYSDK_OFFSET(0x192EA0A0)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_HANDLEDIRTYENTITIES_OFFSET UNITYSDK_OFFSET(0x192E4B80)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_HANDLEENTITYADD_OFFSET UNITYSDK_OFFSET(0x192EAA80)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_HANDLEENTITYREMOVE_OFFSET UNITYSDK_OFFSET(0x192EABE0)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_ONENTITYADDED_OFFSET UNITYSDK_OFFSET(0x192E9140)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_ONENTITYCHANGED_OFFSET UNITYSDK_OFFSET(0x192E9210)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_ONENTITYDESTROY_OFFSET UNITYSDK_OFFSET(0x192EA0F0)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_ONENTITYLAYOUTCHANGED_OFFSET UNITYSDK_OFFSET(0x192EA310)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_REMOVECOMPONENTMASK_OFFSET UNITYSDK_OFFSET(0x192EB420)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_SETMERGE_OFFSET UNITYSDK_OFFSET(0x192E9AC0)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_SETREMOVE_OFFSET UNITYSDK_OFFSET(0x192E96D0)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x192E3F80)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsWorld_EntityComponentMaskMap_TypeDefinitionIndex = 35686;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Nap::NapECS::ComponentMask>* _maskSortedList; // 0x18
		...
		::System::Collections::Generic::Dictionary_2<::Nap::NapECS::ComponentMask, ::System::Int32>* _maskToEntityCount; // 0x38
