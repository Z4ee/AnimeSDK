...
#define NAP_NAPECS_UNSCALEDECSWORLDTIMELINE_CREATE_OFFSET UNITYSDK_OFFSET(0x1C859900)
#define NAP_NAPECS_UNSCALEDECSWORLDTIMELINE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C859AC0)
#define NAP_NAPECS_UNSCALEDECSWORLDTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C85B240)

namespace Nap::NapECS
{
	inline static constexpr unsigned int UnscaledEcsWorldTimeline_TypeDefinitionIndex = 38035;
