...
#define CLASS_1_9CD95AD0A2E83C8D_GET_FIGUREICONPATH_OFFSET UNITYSDK_OFFSET(0x16993080)
#define CLASS_1_9CD95AD0A2E83C8D_GET_GENDER_OFFSET UNITYSDK_OFFSET(0x16992FA0)
#define CLASS_1_9CD95AD0A2E83C8D_GET_HASITEMDISPLAY_OFFSET UNITYSDK_OFFSET(0x16992FC0)
#define CLASS_1_9CD95AD0A2E83C8D_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x16993060)
#define CLASS_1_9CD95AD0A2E83C8D_GET_ITEMBGDESC_OFFSET UNITYSDK_OFFSET(0x16993040)
#define CLASS_1_9CD95AD0A2E83C8D_GET_ITEMCURRENCYICONPATH_OFFSET UNITYSDK_OFFSET(0x169930A0)
#define CLASS_1_9CD95AD0A2E83C8D_GET_ITEMDESC_OFFSET UNITYSDK_OFFSET(0x16993020)
#define CLASS_1_9CD95AD0A2E83C8D_GET_ITEMNAME_OFFSET UNITYSDK_OFFSET(0x16993000)
#define CLASS_1_9CD95AD0A2E83C8D_GET_JSONPATH_OFFSET UNITYSDK_OFFSET(0x169930C0)
#define CLASS_1_9CD95AD0A2E83C8D_GET_RARITY_OFFSET UNITYSDK_OFFSET(0x16992FE0)
#define CLASS_1_9CD95AD0A2E83C8D_SET_FIGUREICONPATH_OFFSET UNITYSDK_OFFSET(0x16993090)
#define CLASS_1_9CD95AD0A2E83C8D_SET_GENDER_OFFSET UNITYSDK_OFFSET(0x16992FB0)
#define CLASS_1_9CD95AD0A2E83C8D_SET_HASITEMDISPLAY_OFFSET UNITYSDK_OFFSET(0x16992FD0)
#define CLASS_1_9CD95AD0A2E83C8D_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x16993070)
#define CLASS_1_9CD95AD0A2E83C8D_SET_ITEMBGDESC_OFFSET UNITYSDK_OFFSET(0x16993050)
#define CLASS_1_9CD95AD0A2E83C8D_SET_ITEMCURRENCYICONPATH_OFFSET UNITYSDK_OFFSET(0x169930B0)
#define CLASS_1_9CD95AD0A2E83C8D_SET_ITEMDESC_OFFSET UNITYSDK_OFFSET(0x16993030)
#define CLASS_1_9CD95AD0A2E83C8D_SET_ITEMNAME_OFFSET UNITYSDK_OFFSET(0x16993010)
#define CLASS_1_9CD95AD0A2E83C8D_SET_JSONPATH_OFFSET UNITYSDK_OFFSET(0x169930D0)
#define CLASS_1_9CD95AD0A2E83C8D_SET_RARITY_OFFSET UNITYSDK_OFFSET(0x16992FF0)
#define CLASS_1_9CD95AD0A2E83C8D__CTOR_OFFSET UNITYSDK_OFFSET(0x169930E0)

inline static constexpr unsigned int Class_1_9CD95AD0A2E83C8D_TypeDefinitionIndex = 59741;

class Class_1_9CD95AD0A2E83C8D : public ::System::Object
{
public:
	::System::String* _IconPath_k__BackingField; // 0x10
	::System::String* _FigureIconPath_k__BackingField; // 0x18
	...
	::RPG::GameCore::TargetGenderType _Gender_k__BackingField; // 0x58
	::System::Boolean _HasItemDisplay_k__BackingField; // 0x5C
