...
#define CLASS_2_F25425D92068F467_DISPOSE_OFFSET UNITYSDK_OFFSET(0x887FD70)
#define CLASS_2_F25425D92068F467_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x887F3F0)
#define CLASS_2_F25425D92068F467_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x887FD20)
#define CLASS_2_F25425D92068F467_TICK_OFFSET UNITYSDK_OFFSET(0x887FDD0)
#define CLASS_2_F25425D92068F467__CTOR_OFFSET UNITYSDK_OFFSET(0x887F3E0)

inline static constexpr unsigned int Class_2_F25425D92068F467_TypeDefinitionIndex = 47064;

class Class_2_F25425D92068F467 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::GameEntity* Field_2_5; // 0x18
	::RPG::Client::Prop::FastDeliverPuzzleEntityData* Field_2_6; // 0x20
	::RPG::GameCore::PropFastDeliverSwitchTarget* Field_2_1; // 0x28
