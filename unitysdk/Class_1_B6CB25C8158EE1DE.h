...
#include "unitysdk/Class_1_B6CB25C8158EE1DE_Enum_3_C780BFBFED223F30_6.h"
...
#define CLASS_1_B6CB25C8158EE1DE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x12CF81B0)
#define CLASS_1_B6CB25C8158EE1DE_METHOD_1_21360BB0E7184F8B_1_OFFSET UNITYSDK_OFFSET(0x12CF9B00)
#define CLASS_1_B6CB25C8158EE1DE_METHOD_1_21360BB0E7184F8B_OFFSET UNITYSDK_OFFSET(0x12CF99C0)
#define CLASS_1_B6CB25C8158EE1DE_METHOD_1_2FA8AE0519AC7829_OFFSET UNITYSDK_OFFSET(0x12CF8140)
#define CLASS_1_B6CB25C8158EE1DE_METHOD_1_35F826730F7FB9BD_OFFSET UNITYSDK_OFFSET(0x12CF9780)
#define CLASS_1_B6CB25C8158EE1DE_METHOD_1_392267C4D8AC544E_1_OFFSET UNITYSDK_OFFSET(0x12CF8FC0)
#define CLASS_1_B6CB25C8158EE1DE_METHOD_1_392267C4D8AC544E_OFFSET UNITYSDK_OFFSET(0x12CF9120)
#define CLASS_1_B6CB25C8158EE1DE_METHOD_1_49BC8120B2321B5D_OFFSET UNITYSDK_OFFSET(0x12CF8C90)
#define CLASS_1_B6CB25C8158EE1DE_METHOD_1_601EDD6847FBEEDA_OFFSET UNITYSDK_OFFSET(0x12CF93A0)
#define CLASS_1_B6CB25C8158EE1DE_METHOD_1_80313B77C31AD02B_OFFSET UNITYSDK_OFFSET(0x12CF8470)
#define CLASS_1_B6CB25C8158EE1DE_METHOD_1_A6174AB0C8C219A1_OFFSET UNITYSDK_OFFSET(0x12CF9440)
#define CLASS_1_B6CB25C8158EE1DE_METHOD_1_A61A196E6AD5766D_OFFSET UNITYSDK_OFFSET(0x12CF8270)
#define CLASS_1_B6CB25C8158EE1DE_METHOD_1_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0x12CF9280)
#define CLASS_1_B6CB25C8158EE1DE_METHOD_1_B13A873C7C334E65_OFFSET UNITYSDK_OFFSET(0x12CF8E60)
#define CLASS_1_B6CB25C8158EE1DE_METHOD_1_D26D36BF546FB283_OFFSET UNITYSDK_OFFSET(0x12CF9C40)
#define CLASS_1_B6CB25C8158EE1DE_METHOD_1_DB7233D1CBD72694_OFFSET UNITYSDK_OFFSET(0x12CF9F00)
#define CLASS_1_B6CB25C8158EE1DE_METHOD_1_F4DD08A31BA3F883_OFFSET UNITYSDK_OFFSET(0x12CF7E30)
#define CLASS_1_B6CB25C8158EE1DE__CTOR_OFFSET UNITYSDK_OFFSET(0x12CF7CE0)

inline static constexpr unsigned int Class_1_B6CB25C8158EE1DE_TypeDefinitionIndex = 76338;

class Class_1_B6CB25C8158EE1DE : public ::System::Object
{
public:
	// static const ::Enum_3_24F60EA0D4DCCDF0 Field_1_0; // 0x0
	// static const ::PipelineCamera::WorldBasicCameraDataDeltaFlag Field_1_7; // 0x0
	::PipelineCamera::CameraVariableSubModule_1<::PipelineCamera::WorldBasicCameraData>* Field_1_5; // 0x10
	::System::Collections::Generic::Dictionary_2<::Cinemachine::CinemachineVirtualCameraBase*, ::System::Int32>* Field_1_10; // 0x18
	::System::Collections::Generic::List_1<::Cinemachine::CinemachineVirtualCameraBase*>* Field_1_11; // 0x20
	::MoleMole::Utils::TaskBasedEventCollection_1<::Class_1_B6CB25C8158EE1DE_Enum_3_C780BFBFED223F30_6>* Field_1_6; // 0x28
	::MoleMole::TimelineDataExtra* Field_1_4; // 0x30
	::System::Nullable_1<::PipelineCamera::WorldBasicCameraData> Field_1_15; // 0x38
	...
	::PipelineCamera::WorldBasicCameraData Method_1_A6174AB0C8C219A1(::PipelineCamera::CameraVariableFetchContext_1<::PipelineCamera::WorldBasicCameraData> a1)
	{
		return ((::PipelineCamera::WorldBasicCameraData(*)(::PVOID, ::PipelineCamera::CameraVariableFetchContext_1<::PipelineCamera::WorldBasicCameraData>))((::PBYTE)hIl2Cpp + CLASS_1_B6CB25C8158EE1DE_METHOD_1_A6174AB0C8C219A1_OFFSET))(this, a1);
	}
