...
#define CLASS_3_9DF0A5E12CE253EF_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC0F7A10)
#define CLASS_3_9DF0A5E12CE253EF_METHOD_3_6D71CC7A9DF62322_OFFSET UNITYSDK_OFFSET(0xC0F89F0)
#define CLASS_3_9DF0A5E12CE253EF_METHOD_3_7223CD34BEFCBF48_OFFSET UNITYSDK_OFFSET(0xC0F85F0)
#define CLASS_3_9DF0A5E12CE253EF_METHOD_3_736EFAF4152D13AF_OFFSET UNITYSDK_OFFSET(0xC0F8560)
#define CLASS_3_9DF0A5E12CE253EF_METHOD_3_C2CB27D3BB7D9DBC_OFFSET UNITYSDK_OFFSET(0xC0F8780)
#define CLASS_3_9DF0A5E12CE253EF_METHOD_3_D26AC14EBBDB9AAF_OFFSET UNITYSDK_OFFSET(0xC0F81D0)
#define CLASS_3_9DF0A5E12CE253EF_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0xC0F8B30)
#define CLASS_3_9DF0A5E12CE253EF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xC0F7B50)
#define CLASS_3_9DF0A5E12CE253EF_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xC0F88D0)
#define CLASS_3_9DF0A5E12CE253EF_TICK_OFFSET UNITYSDK_OFFSET(0xC0F82B0)
#define CLASS_3_9DF0A5E12CE253EF__CTOR_OFFSET UNITYSDK_OFFSET(0xC0F78B0)
...
{
public:
	::RPG::GameCore::AdvSetAIMoveTo* OFKGLJOAMLD; // 0x30
	::Class_3_07C3C4D2990C49EE* KANMJJLKMMI; // 0x38
	::Class_2_21055A9FA74B791E* IPFNHFDJKKL; // 0x40
	::Class_2_A0580152EB393340* GEPFAIOOOGB; // 0x48
	::RPG::GameCore::ModifyAdventureCharacterRunSpeedRatio* JFEJENBHBCO; // 0x50
	::System::Boolean FNEJMBKLEIP; // 0x58
	::UnityEngine::Vector3 BEDPGAOCOHG; // 0x5C
	::UnityEngine::Quaternion MGFPKGIOKEN; // 0x68
