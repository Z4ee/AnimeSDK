...
#define WWISESTATEREFERENCE_GET_GROUPOBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B4D61C0)
#define WWISESTATEREFERENCE_GET_GROUPWWISEOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x1B4D6240)
#define WWISESTATEREFERENCE_GET_WWISEOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x1B4D61B0)
#define WWISESTATEREFERENCE_SET_GROUPOBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B4D61D0)
#define WWISESTATEREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D6250)

inline static constexpr unsigned int WwiseStateReference_TypeDefinitionIndex = 41272;
