...
#define CLASS_2_1D142474FF64049F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x106AECD0)
#define CLASS_2_1D142474FF64049F_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x106AED10)
#define CLASS_2_1D142474FF64049F_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x106AEF50)
#define CLASS_2_1D142474FF64049F_TICK_OFFSET UNITYSDK_OFFSET(0x106AEFA0)
#define CLASS_2_1D142474FF64049F__CTOR_OFFSET UNITYSDK_OFFSET(0x106AECC0)

inline static constexpr unsigned int Class_2_1D142474FF64049F_TypeDefinitionIndex = 46645;

class Class_2_1D142474FF64049F : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::AddGlobalDynamicOffset* Field_2_0; // 0x20
