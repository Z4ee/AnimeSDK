...
#define CLASS_2_1D142474FF64049F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1780EA70)
#define CLASS_2_1D142474FF64049F_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1780EAB0)
#define CLASS_2_1D142474FF64049F_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1780EFC0)
#define CLASS_2_1D142474FF64049F_TICK_OFFSET UNITYSDK_OFFSET(0x1780F010)
#define CLASS_2_1D142474FF64049F__CTOR_OFFSET UNITYSDK_OFFSET(0x1780EA60)

inline static constexpr unsigned int Class_2_1D142474FF64049F_TypeDefinitionIndex = 58013;

class Class_2_1D142474FF64049F : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::AddGlobalDynamicOffset* OFKGLJOAMLD; // 0x18
