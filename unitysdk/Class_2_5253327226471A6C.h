...
#define CLASS_2_5253327226471A6C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1613E410)
#define CLASS_2_5253327226471A6C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1613E450)
#define CLASS_2_5253327226471A6C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1613E5B0)
#define CLASS_2_5253327226471A6C_TICK_OFFSET UNITYSDK_OFFSET(0x1613E3B0)
#define CLASS_2_5253327226471A6C__CTOR_OFFSET UNITYSDK_OFFSET(0x1613E3A0)

inline static constexpr unsigned int Class_2_5253327226471A6C_TypeDefinitionIndex = 52753;

class Class_2_5253327226471A6C : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::AdvPuzzleCollectItem* OFKGLJOAMLD; // 0x18
