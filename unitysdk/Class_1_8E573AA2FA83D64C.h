...
#define CLASS_1_8E573AA2FA83D64C_METHOD_1_503CD42A0C349327_OFFSET UNITYSDK_OFFSET(0x1A8D0B30)
#define CLASS_1_8E573AA2FA83D64C_METHOD_1_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0x1A8D0C30)
#define CLASS_1_8E573AA2FA83D64C_METHOD_1_C42C96E5F42EBF58_OFFSET UNITYSDK_OFFSET(0x1A8D0B80)
#define CLASS_1_8E573AA2FA83D64C__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8D0C20)

inline static constexpr unsigned int Class_1_8E573AA2FA83D64C_TypeDefinitionIndex = 68215;

class Class_1_8E573AA2FA83D64C : public ::System::Object
{
public:
	::InControl::PlayerAction* CAFNPBJBOEG; // 0x10
