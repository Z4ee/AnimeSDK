...
#define CLASS_1_5B567C8A01BAEDFE_241_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x192B85E0)
#define CLASS_1_5B567C8A01BAEDFE_241_CLONE_OFFSET UNITYSDK_OFFSET(0x192B8450)
#define CLASS_1_5B567C8A01BAEDFE_241_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x192B84F0)
#define CLASS_1_5B567C8A01BAEDFE_241_EQUALS_OFFSET UNITYSDK_OFFSET(0x192B8490)
#define CLASS_1_5B567C8A01BAEDFE_241_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x192B8540)
#define CLASS_1_5B567C8A01BAEDFE_241_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x192B8630)
#define CLASS_1_5B567C8A01BAEDFE_241_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x192B8600)
#define CLASS_1_5B567C8A01BAEDFE_241_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x192B83D0)
#define CLASS_1_5B567C8A01BAEDFE_241_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x192B8400)
#define CLASS_1_5B567C8A01BAEDFE_241_TOSTRING_OFFSET UNITYSDK_OFFSET(0x192B8570)
#define CLASS_1_5B567C8A01BAEDFE_241_WRITETO_OFFSET UNITYSDK_OFFSET(0x192B85D0)
#define CLASS_1_5B567C8A01BAEDFE_241__CCTOR_OFFSET UNITYSDK_OFFSET(0x192B8680)
#define CLASS_1_5B567C8A01BAEDFE_241__CTOR_1_OFFSET UNITYSDK_OFFSET(0x192B8420)
#define CLASS_1_5B567C8A01BAEDFE_241__CTOR_OFFSET UNITYSDK_OFFSET(0x192B8410)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_241_TypeDefinitionIndex = 30036;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_241*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_241_TypeDefinitionIndex)->GetStaticField(0x55DC0);
	}
