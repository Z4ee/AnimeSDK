...
#define CLASS_1_714A2A6E232161AB__ASYNCGETLATENCY_D__1_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x16B72C40)
#define CLASS_1_714A2A6E232161AB__ASYNCGETLATENCY_D__1_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16B72F40)
#define CLASS_1_714A2A6E232161AB__ASYNCGETLATENCY_D__1_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16B72FA0)
#define CLASS_1_714A2A6E232161AB__ASYNCGETLATENCY_D__1_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x16B72F50)
#define CLASS_1_714A2A6E232161AB__ASYNCGETLATENCY_D__1_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16B72C30)
#define CLASS_1_714A2A6E232161AB__ASYNCGETLATENCY_D__1__CTOR_OFFSET UNITYSDK_OFFSET(0x16B72C20)

inline static constexpr unsigned int Class_1_714A2A6E232161AB__AsyncGetLatency_d__1_TypeDefinitionIndex = 66236;
