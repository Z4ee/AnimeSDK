...
#define CLASS_2_562D060B25B6A626_DISPOSE_OFFSET UNITYSDK_OFFSET(0x165B3580)
#define CLASS_2_562D060B25B6A626_METHOD_2_4AD3C45D81B35B70_OFFSET UNITYSDK_OFFSET(0x165B3E80)
#define CLASS_2_562D060B25B6A626_METHOD_2_CD0979951400C3FD_OFFSET UNITYSDK_OFFSET(0x165B3E20)
#define CLASS_2_562D060B25B6A626_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x165B35C0)
#define CLASS_2_562D060B25B6A626_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x165B3EE0)
#define CLASS_2_562D060B25B6A626_TICK_OFFSET UNITYSDK_OFFSET(0x165B3F30)
#define CLASS_2_562D060B25B6A626__CTOR_OFFSET UNITYSDK_OFFSET(0x165B3570)

inline static constexpr unsigned int Class_2_562D060B25B6A626_TypeDefinitionIndex = 55703;

class Class_2_562D060B25B6A626 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SetGridFightBEEnergyBarState* OFKGLJOAMLD; // 0x18
