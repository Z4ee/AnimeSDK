...
#define CLASS_2_562D060B25B6A626_DISPOSE_OFFSET UNITYSDK_OFFSET(0x124F65B0)
#define CLASS_2_562D060B25B6A626_METHOD_2_4AD3C45D81B35B70_OFFSET UNITYSDK_OFFSET(0x124F6DB0)
#define CLASS_2_562D060B25B6A626_METHOD_2_CD0979951400C3FD_OFFSET UNITYSDK_OFFSET(0x124F6D50)
#define CLASS_2_562D060B25B6A626_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x124F65F0)
#define CLASS_2_562D060B25B6A626_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x124F6E10)
#define CLASS_2_562D060B25B6A626_TICK_OFFSET UNITYSDK_OFFSET(0x124F6E60)
#define CLASS_2_562D060B25B6A626__CTOR_OFFSET UNITYSDK_OFFSET(0x124F65A0)

inline static constexpr unsigned int Class_2_562D060B25B6A626_TypeDefinitionIndex = 51179;

class Class_2_562D060B25B6A626 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::SetGridFightBEEnergyBarState* Field_2_0; // 0x20
