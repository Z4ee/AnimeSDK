...
#define CLASS_1_5B567C8A01BAEDFE_300_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A809840)
#define CLASS_1_5B567C8A01BAEDFE_300_CLONE_OFFSET UNITYSDK_OFFSET(0x1A8096B0)
#define CLASS_1_5B567C8A01BAEDFE_300_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A809750)
#define CLASS_1_5B567C8A01BAEDFE_300_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A8096F0)
#define CLASS_1_5B567C8A01BAEDFE_300_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A8097A0)
#define CLASS_1_5B567C8A01BAEDFE_300_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A809890)
#define CLASS_1_5B567C8A01BAEDFE_300_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A809860)
#define CLASS_1_5B567C8A01BAEDFE_300_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A809630)
#define CLASS_1_5B567C8A01BAEDFE_300_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A809660)
#define CLASS_1_5B567C8A01BAEDFE_300_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A8097D0)
#define CLASS_1_5B567C8A01BAEDFE_300_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A809830)
#define CLASS_1_5B567C8A01BAEDFE_300__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A8098E0)
#define CLASS_1_5B567C8A01BAEDFE_300__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A809680)
#define CLASS_1_5B567C8A01BAEDFE_300__CTOR_OFFSET UNITYSDK_OFFSET(0x1A809670)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_300_TypeDefinitionIndex = 31051;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_300*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_300_TypeDefinitionIndex)->GetStaticField(0x19690);
	}
