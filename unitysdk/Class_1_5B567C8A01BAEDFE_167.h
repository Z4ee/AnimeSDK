...
#define CLASS_1_5B567C8A01BAEDFE_167_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C9CC000)
#define CLASS_1_5B567C8A01BAEDFE_167_CLONE_OFFSET UNITYSDK_OFFSET(0x1C9CBCA0)
#define CLASS_1_5B567C8A01BAEDFE_167_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C9CBE00)
#define CLASS_1_5B567C8A01BAEDFE_167_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C9CBD10)
#define CLASS_1_5B567C8A01BAEDFE_167_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C9CBF60)
#define CLASS_1_5B567C8A01BAEDFE_167_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C9CC050)
#define CLASS_1_5B567C8A01BAEDFE_167_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C9CC020)
#define CLASS_1_5B567C8A01BAEDFE_167_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C9CBBF0)
#define CLASS_1_5B567C8A01BAEDFE_167_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C9CBC50)
#define CLASS_1_5B567C8A01BAEDFE_167_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C9CBF90)
#define CLASS_1_5B567C8A01BAEDFE_167_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C9CBFF0)
#define CLASS_1_5B567C8A01BAEDFE_167__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C9CC0A0)
#define CLASS_1_5B567C8A01BAEDFE_167__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C9CBC70)
#define CLASS_1_5B567C8A01BAEDFE_167__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9CBC60)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_167_TypeDefinitionIndex = 28629;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_167*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_167_TypeDefinitionIndex)->GetStaticField(0x3440);
	}
