...
#define AUISTATETAGACTIVE_GET_STATETAGLIST_OFFSET UNITYSDK_OFFSET(0x13977B40)
#define AUISTATETAGACTIVE_ISFALSE_OFFSET UNITYSDK_OFFSET(0x13977A60)
#define AUISTATETAGACTIVE_ISTRUE_OFFSET UNITYSDK_OFFSET(0x13977AD0)
#define AUISTATETAGACTIVE_SET_STATETAGLIST_OFFSET UNITYSDK_OFFSET(0x13977B50)
#define AUISTATETAGACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x13977B60)

inline static constexpr unsigned int AUiStateTagActive_TypeDefinitionIndex = 44867;
