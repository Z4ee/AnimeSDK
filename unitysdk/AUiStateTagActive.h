...
#define AUISTATETAGACTIVE_GET_STATETAGLIST_OFFSET UNITYSDK_OFFSET(0x10BF70A0)
#define AUISTATETAGACTIVE_ISFALSE_OFFSET UNITYSDK_OFFSET(0x10BF6FC0)
#define AUISTATETAGACTIVE_ISTRUE_OFFSET UNITYSDK_OFFSET(0x10BF7030)
#define AUISTATETAGACTIVE_SET_STATETAGLIST_OFFSET UNITYSDK_OFFSET(0x10BF70B0)
#define AUISTATETAGACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x10BF70C0)

inline static constexpr unsigned int AUiStateTagActive_TypeDefinitionIndex = 38437;
