...
#define AUISTATETAGACTIVE_GET_STATETAGLIST_OFFSET UNITYSDK_OFFSET(0x158D1480)
#define AUISTATETAGACTIVE_ISFALSE_OFFSET UNITYSDK_OFFSET(0x158D13A0)
#define AUISTATETAGACTIVE_ISTRUE_OFFSET UNITYSDK_OFFSET(0x158D1410)
#define AUISTATETAGACTIVE_SET_STATETAGLIST_OFFSET UNITYSDK_OFFSET(0x158D14C0)
#define AUISTATETAGACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x158D1510)

inline static constexpr unsigned int AUiStateTagActive_TypeDefinitionIndex = 45784;
