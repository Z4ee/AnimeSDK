...
#define AUISTATETAGACTIVE_GET_STATETAGLIST_OFFSET UNITYSDK_OFFSET(0x159685B0)
#define AUISTATETAGACTIVE_ISFALSE_OFFSET UNITYSDK_OFFSET(0x159684D0)
#define AUISTATETAGACTIVE_ISTRUE_OFFSET UNITYSDK_OFFSET(0x15968540)
#define AUISTATETAGACTIVE_SET_STATETAGLIST_OFFSET UNITYSDK_OFFSET(0x159685F0)
#define AUISTATETAGACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x15968640)

inline static constexpr unsigned int AUiStateTagActive_TypeDefinitionIndex = 48036;
