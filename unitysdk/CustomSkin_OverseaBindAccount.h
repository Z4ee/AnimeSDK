...
#define CUSTOMSKIN_OVERSEABINDACCOUNT_CLICKBACK_OFFSET UNITYSDK_OFFSET(0x139E4150)
#define CUSTOMSKIN_OVERSEABINDACCOUNT_CLICKCLOSE_OFFSET UNITYSDK_OFFSET(0x139E41D0)
#define CUSTOMSKIN_OVERSEABINDACCOUNT_CLICKFORGOT_OFFSET UNITYSDK_OFFSET(0x139E4250)
#define CUSTOMSKIN_OVERSEABINDACCOUNT_INSTANCE_OFFSET UNITYSDK_OFFSET(0x139E3120)
#define CUSTOMSKIN_OVERSEABINDACCOUNT_ONBINDCLICKED_OFFSET UNITYSDK_OFFSET(0x139E42F0)
#define CUSTOMSKIN_OVERSEABINDACCOUNT_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x139E32E0)
#define CUSTOMSKIN_OVERSEABINDACCOUNT_ONCONSOLECANCEL_OFFSET UNITYSDK_OFFSET(0x139E4A30)
#define CUSTOMSKIN_OVERSEABINDACCOUNT_ONFORGETPASSWORDCALLBACK_OFFSET UNITYSDK_OFFSET(0x139E4680)
#define CUSTOMSKIN_OVERSEABINDACCOUNT_ONSHOW_OFFSET UNITYSDK_OFFSET(0x139E3340)
#define CUSTOMSKIN_OVERSEABINDACCOUNT_REGISTTEXTACTION_OFFSET UNITYSDK_OFFSET(0x139E4080)
#define CUSTOMSKIN_OVERSEABINDACCOUNT_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x139E3CF0)
#define CUSTOMSKIN_OVERSEABINDACCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x139E3250)
#define CUSTOMSKIN_OVERSEABINDACCOUNT__REGISTTEXTACTION_B__7_0_OFFSET UNITYSDK_OFFSET(0x139E4BC0)
#define CUSTOMSKIN_OVERSEABINDACCOUNT__REGISTTEXTACTION_B__7_1_OFFSET UNITYSDK_OFFSET(0x139E4C40)

inline static constexpr unsigned int CustomSkin_OverseaBindAccount_TypeDefinitionIndex = 66133;
...
public:
	...
	{
		return (::CustomSkin_OverseaBindAccount**)Il2CppClass::FromTypeDefinitionIndex(CustomSkin_OverseaBindAccount_TypeDefinitionIndex)->GetStaticField(0x306E0);
	}
