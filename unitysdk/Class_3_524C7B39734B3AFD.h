...
#define CLASS_3_524C7B39734B3AFD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xE669480)
#define CLASS_3_524C7B39734B3AFD_METHOD_3_2576376AC7F6B15D_OFFSET UNITYSDK_OFFSET(0xE66A380)
#define CLASS_3_524C7B39734B3AFD_METHOD_3_DB915699370309DA_OFFSET UNITYSDK_OFFSET(0xE66A640)
#define CLASS_3_524C7B39734B3AFD_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xE6694D0)
#define CLASS_3_524C7B39734B3AFD__CTOR_OFFSET UNITYSDK_OFFSET(0xE669320)
#define CLASS_3_524C7B39734B3AFD___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xE66A9B0)

inline static constexpr unsigned int Class_3_524C7B39734B3AFD_TypeDefinitionIndex = 51396;

class Class_3_524C7B39734B3AFD : public ::RPG::GameCore::ImmediateTaskBase_1<::RPG::GameCore::TriggerModifierCustomEvent*>
{
public:
	::RPG::GameCore::GameEntity* Field_3_8; // 0x28
	::RPG::GameCore::ModifierCustomEventConfig* Field_3_6; // 0x30
	::RPG::GameCore::GameEntity* Field_3_7; // 0x38
	::Class_1_5F51D4049EA87B7B* Field_3_0; // 0x40
	::RPG::PoolList_1<::RPG::GameCore::TurnBasedModifierInstance*>* Field_3_5; // 0x48
	::System::Int32 Field_3_2; // 0x50
	::RPG::GameCore::StringHash Field_3_1; // 0x54
	::RPG::GameCore::ModifierCustomEventSortType Field_3_3; // 0x58
	...
	::System::Void Method_3_DB915699370309DA(::Class_0_16E4307DCC419505_382* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_382*))((::PBYTE)hIl2Cpp + CLASS_3_524C7B39734B3AFD_METHOD_3_DB915699370309DA_OFFSET))(this, a1);
	}
