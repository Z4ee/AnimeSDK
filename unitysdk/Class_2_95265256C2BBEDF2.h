...
#define CLASS_2_95265256C2BBEDF2__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF8CEF0)
...
{
public:
	::System::String* KEOAHDOPBMH; // 0x10
	::System::String* AFNAAAJILIL; // 0x18
	::System::String* FMBNGMNEIFB; // 0x20
	::System::String* DPPJMFBGFJN; // 0x28
	::System::String* FCKKFGEKLJA; // 0x30
	::System::Object* NBMKFMINNGO; // 0x38
	::System::String* CHFPPBOOEFK; // 0x40
	::System::Boolean OEAKMFHPMPN; // 0x48
	::System::Boolean IPLKGEDHJHM; // 0x49
	::System::Boolean LONIOGBIKFK; // 0x4A
