...
#define HIPPLENBUILDERFIRSTPERSONCAMCONTROLLER_METHOD_5_60E1F7F58CCF739F_OFFSET UNITYSDK_OFFSET(0x18DC7060)
#define HIPPLENBUILDERFIRSTPERSONCAMCONTROLLER_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x18DC7410)
#define HIPPLENBUILDERFIRSTPERSONCAMCONTROLLER_SETCAMERALOCK_OFFSET UNITYSDK_OFFSET(0x18DC74D0)
#define HIPPLENBUILDERFIRSTPERSONCAMCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x18DC6FB0)
#define HIPPLENBUILDERFIRSTPERSONCAMCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x18DC7000)
#define HIPPLENBUILDERFIRSTPERSONCAMCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18DC7530)
