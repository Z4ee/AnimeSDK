...
#define HIPPLENBUILDERFIRSTPERSONCAMCONTROLLER_METHOD_5_60E1F7F58CCF739F_OFFSET UNITYSDK_OFFSET(0x11DFD710)
#define HIPPLENBUILDERFIRSTPERSONCAMCONTROLLER_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x11DFDAC0)
#define HIPPLENBUILDERFIRSTPERSONCAMCONTROLLER_SETCAMERALOCK_OFFSET UNITYSDK_OFFSET(0x11DFDB80)
#define HIPPLENBUILDERFIRSTPERSONCAMCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x11DFD660)
#define HIPPLENBUILDERFIRSTPERSONCAMCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x11DFD6B0)
#define HIPPLENBUILDERFIRSTPERSONCAMCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11DFDBE0)

inline static constexpr unsigned int HipplenBuilderFirstPersonCamController_TypeDefinitionIndex = 43992;
