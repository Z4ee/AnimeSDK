...
#define CLASS_2_D8368AFD8DDC1986_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16E97850)
#define CLASS_2_D8368AFD8DDC1986_METHOD_2_5690A272C6403EDD_OFFSET UNITYSDK_OFFSET(0x16E984D0)
#define CLASS_2_D8368AFD8DDC1986_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16E97890)
#define CLASS_2_D8368AFD8DDC1986_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x16E985D0)
#define CLASS_2_D8368AFD8DDC1986_TICK_OFFSET UNITYSDK_OFFSET(0x16E98620)
#define CLASS_2_D8368AFD8DDC1986__CTOR_OFFSET UNITYSDK_OFFSET(0x16E97840)

inline static constexpr unsigned int Class_2_D8368AFD8DDC1986_TypeDefinitionIndex = 52680;

class Class_2_D8368AFD8DDC1986 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::ModifierAttachEffect* Field_2_1; // 0x20
