...
#define CLASS_2_A232231D6F6E2050_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1794D890)
#define CLASS_2_A232231D6F6E2050_METHOD_2_2ADBA02EC0F7C432_1_OFFSET UNITYSDK_OFFSET(0x17DFBB60)
#define CLASS_2_A232231D6F6E2050_METHOD_2_2ADBA02EC0F7C432_OFFSET UNITYSDK_OFFSET(0x17DFB760)
#define CLASS_2_A232231D6F6E2050_METHOD_2_7B12090AF6D76E60_1_OFFSET UNITYSDK_OFFSET(0x17DFB930)
#define CLASS_2_A232231D6F6E2050_METHOD_2_7B12090AF6D76E60_OFFSET UNITYSDK_OFFSET(0x17DFB450)
#define CLASS_2_A232231D6F6E2050_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1794DC60)
#define CLASS_2_A232231D6F6E2050_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17DFB2A0)
#define CLASS_2_A232231D6F6E2050_TICK_OFFSET UNITYSDK_OFFSET(0x17DFB3F0)
#define CLASS_2_A232231D6F6E2050__CTOR_OFFSET UNITYSDK_OFFSET(0x1794D6A0)
...
{
public:
	::Class_3_07C3C4D2990C49EE* FFKBFPKEPEN; // 0x18
	::Class_3_07C3C4D2990C49EE* NMPLHCJKEOI; // 0x20
	::Class_3_07C3C4D2990C49EE* MMEPKHGPPHJ; // 0x28
	::RPG::GameCore::WaitFiveDimPlayerEnterOrExit* OFKGLJOAMLD; // 0x30
	::Class_3_07C3C4D2990C49EE* IJAFDDPLOIH; // 0x38
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x40
	::System::UInt32 PHENAPCKMIJ; // 0x48
	::System::UInt32 GJFHPJDIECP; // 0x4C
	::System::UInt32 AJNLLPDCAII; // 0x50
