...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_COMBINEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1C6173C0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_COPYPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1C6182E0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_ISSEPARATOR_OFFSET UNITYSDK_OFFSET(0x1C619080)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_ISWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1C619060)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_PARSEINLINE_OFFSET UNITYSDK_OFFSET(0x1C615AB0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_PARSEPARENVALUE_OFFSET UNITYSDK_OFFSET(0x1C618C10)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_PARSEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1C617F50)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_PARSEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1C6184E0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_PARSESELECTOR_OFFSET UNITYSDK_OFFSET(0x1C617560)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_PARSE_OFFSET UNITYSDK_OFFSET(0x1C60E390)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_PEEKTOKEN_OFFSET UNITYSDK_OFFSET(0x1C618280)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_POPTOKEN_OFFSET UNITYSDK_OFFSET(0x1C6181D0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_TOKENIZE_OFFSET UNITYSDK_OFFSET(0x1C616E50)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SVGStyleSheetUtils_TypeDefinitionIndex = 31150;
