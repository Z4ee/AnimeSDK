...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGDOCUMENT_LINEARGRADIENTEXDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6080C0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SVGDocument_LinearGradientExData_TypeDefinitionIndex = 31126;
	...
	public:
		...
		::System::String* X1; // 0x40
		::System::String* Y1; // 0x48
