...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SCENENODES_D__68_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A1C77E0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SCENENODES_D__68_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A1C7CE0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SCENENODES_D__68_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A1C7C70)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SCENENODES_D__68_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A1C7D60)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SCENENODES_D__68_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A1C7CD0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SCENENODES_D__68_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A1C7C80)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SCENENODES_D__68_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A1C7580)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SCENENODES_D__68__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1C68A0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SCENENODES_D__68___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1A1C77D0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SCENENODES_D__68___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1A1C76F0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int VectorUtils__SceneNodes_d__68_TypeDefinitionIndex = 28499;
	...
	public:
		...
		::ToolBuddy::ThirdParty::VectorGraphics::SceneNode* __3__root; // 0x18
		::ToolBuddy::ThirdParty::VectorGraphics::SceneNode* __2__current; // 0x20
		::ToolBuddy::ThirdParty::VectorGraphics::SceneNode* root; // 0x28
		::System::Collections::Generic::List_1_Enumerator<::ToolBuddy::ThirdParty::VectorGraphics::SceneNode*> __7__wrap1; // 0x30
