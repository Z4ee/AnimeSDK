...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1A1A5660)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_GETLAYERFORSCENNODE_OFFSET UNITYSDK_OFFSET(0x1A1B8AF0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_LOOKUPPROPERTYINSHEET_OFFSET UNITYSDK_OFFSET(0x1A1BFD70)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_LOOKUPPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A1BFB80)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_LOOKUPSTYLEORATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A1BFA50)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_PEEKLAYER_OFFSET UNITYSDK_OFFSET(0x1A1B9BD0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_POPLAYER_OFFSET UNITYSDK_OFFSET(0x1A1B9210)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_POPNODE_OFFSET UNITYSDK_OFFSET(0x1A1AB800)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_PUSHLAYER_OFFSET UNITYSDK_OFFSET(0x1A1B8BA0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_PUSHNODE_OFFSET UNITYSDK_OFFSET(0x1A1AAF70)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_SAVELAYERFORSCENENODE_OFFSET UNITYSDK_OFFSET(0x1A1AB470)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_SETGLOBALSTYLESHEET_OFFSET UNITYSDK_OFFSET(0x1A1B87C0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_SORTEDCLASSES_OFFSET UNITYSDK_OFFSET(0x1A1BF2B0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A9960)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SVGStyleResolver_TypeDefinitionIndex = 28481;

	class SVGStyleResolver : public ::System::Object
	{
	public:
		::System::Collections::Generic::Dictionary_2<::ToolBuddy::ThirdParty::VectorGraphics::SceneNode*, ::ToolBuddy::ThirdParty::VectorGraphics::SVGStyleResolver_StyleLayer*>* nodeLayers; // 0x10
