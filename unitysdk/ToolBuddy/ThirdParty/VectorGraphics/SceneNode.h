...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE_GET_CHILDREN_OFFSET UNITYSDK_OFFSET(0x1A1C2C10)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE_GET_CLIPPER_OFFSET UNITYSDK_OFFSET(0x1A1C2C80)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE_GET_SHAPES_OFFSET UNITYSDK_OFFSET(0x1A1C2C30)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A1C2C50)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE_SET_CHILDREN_OFFSET UNITYSDK_OFFSET(0x1A1C2C20)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE_SET_CLIPPER_OFFSET UNITYSDK_OFFSET(0x1A1C2C90)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE_SET_SHAPES_OFFSET UNITYSDK_OFFSET(0x1A1C2C40)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE_SET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A1C2C70)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1AAEC0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SceneNode_TypeDefinitionIndex = 28519;

	class SceneNode : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::ToolBuddy::ThirdParty::VectorGraphics::SceneNode*>* _Children_k__BackingField; // 0x10
