...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE_GET_CHILDREN_OFFSET UNITYSDK_OFFSET(0x1DAA1D90)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE_GET_CLIPPER_OFFSET UNITYSDK_OFFSET(0x1DAA1E00)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE_GET_SHAPES_OFFSET UNITYSDK_OFFSET(0x1DAA1DB0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1DAA1DD0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE_SET_CHILDREN_OFFSET UNITYSDK_OFFSET(0x1DAA1DA0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE_SET_CLIPPER_OFFSET UNITYSDK_OFFSET(0x1DAA1E10)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE_SET_SHAPES_OFFSET UNITYSDK_OFFSET(0x1DAA1DC0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE_SET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1DAA1DF0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA8A240)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SceneNode_TypeDefinitionIndex = 31793;

	class SceneNode : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::ToolBuddy::ThirdParty::VectorGraphics::Shape*>* _Shapes_k__BackingField; // 0x10
		::System::Collections::Generic::List_1<::ToolBuddy::ThirdParty::VectorGraphics::SceneNode*>* _Children_k__BackingField; // 0x18
		::ToolBuddy::ThirdParty::VectorGraphics::SceneNode* _Clipper_k__BackingField; // 0x20
