...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGDOCUMENT_RADIALGRADIENTEXDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1B4620)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SVGDocument_RadialGradientExData_TypeDefinitionIndex = 28472;

	class SVGDocument_RadialGradientExData : public ::ToolBuddy::ThirdParty::VectorGraphics::SVGDocument_GradientExData
	{
	public:
		::System::String* Fy; // 0x30
		::System::String* Cx; // 0x38
		::System::String* Cy; // 0x40
		::System::String* Fx; // 0x48
