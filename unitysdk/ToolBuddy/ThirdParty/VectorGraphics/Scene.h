...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENE_GET_ROOT_OFFSET UNITYSDK_OFFSET(0x1DAA1D70)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENE_SET_ROOT_OFFSET UNITYSDK_OFFSET(0x1DAA1D80)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA9E3E0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int Scene_TypeDefinitionIndex = 31794;
