...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENE_GET_ROOT_OFFSET UNITYSDK_OFFSET(0x1A1C2BF0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENE_SET_ROOT_OFFSET UNITYSDK_OFFSET(0x1A1C2C00)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1BF1D0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int Scene_TypeDefinitionIndex = 28520;
