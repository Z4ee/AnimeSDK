...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_CLEANIRI_OFFSET UNITYSDK_OFFSET(0x1DA85E30)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_CONCLUDEPATH_OFFSET UNITYSDK_OFFSET(0x1DA86140)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_NEXTBOOL_OFFSET UNITYSDK_OFFSET(0x1DA86D30)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_NEXTFLOAT_OFFSET UNITYSDK_OFFSET(0x1DA86530)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_NEXTPATHCOMMAND_OFFSET UNITYSDK_OFFSET(0x1DA85EE0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_NEXTSTRINGCOMMAND_OFFSET UNITYSDK_OFFSET(0x1DA871C0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_NEXTVECTOR2_OFFSET UNITYSDK_OFFSET(0x1DA860F0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSECOLOR_OFFSET UNITYSDK_OFFSET(0x1DA85510)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSEFILL_1_OFFSET UNITYSDK_OFFSET(0x1DA84790)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSEFILL_OFFSET UNITYSDK_OFFSET(0x1DA84760)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSEFLOAT_OFFSET UNITYSDK_OFFSET(0x1DA84B50)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSEPATH_OFFSET UNITYSDK_OFFSET(0x1DA82160)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSERELATIVEREF_OFFSET UNITYSDK_OFFSET(0x1DA85D00)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSESTROKEANDOPACITY_OFFSET UNITYSDK_OFFSET(0x1DA851A0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSETRANSFORM_1_OFFSET UNITYSDK_OFFSET(0x1DA83A00)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1DA839A0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSEURLREF_OFFSET UNITYSDK_OFFSET(0x1DA85C80)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PEEKSYMBOL_OFFSET UNITYSDK_OFFSET(0x1DA87760)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_SKIPSYMBOL_OFFSET UNITYSDK_OFFSET(0x1DA874A0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_SKIPWHITESPACES_OFFSET UNITYSDK_OFFSET(0x1DA87930)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DA83BB0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1DA84BB0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA822B0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SVGAttribParser_TypeDefinitionIndex = 31760;
	...
	public:
		...
		{
			return (::ToolBuddy::ThirdParty::VectorGraphics::NamedWebColorDictionary**)Il2CppClass::FromTypeDefinitionIndex(SVGAttribParser_TypeDefinitionIndex)->GetStaticField(0x26FA0);
		}
		::System::String* attribString; // 0x10
		::ToolBuddy::ThirdParty::VectorGraphics::IFill* fill; // 0x18
		::System::String* attribName; // 0x20
		::System::Collections::Generic::List_1<::ToolBuddy::ThirdParty::VectorGraphics::BezierContour>* contours; // 0x28
		::System::Collections::Generic::LinkedList_1<::ToolBuddy::ThirdParty::VectorGraphics::BezierSegment>* currentContour; // 0x30
		::System::Char pathCommand; // 0x38
		::UnityEngine::Vector2 penPos; // 0x3C
		::ToolBuddy::ThirdParty::VectorGraphics::Matrix2D transform; // 0x44
