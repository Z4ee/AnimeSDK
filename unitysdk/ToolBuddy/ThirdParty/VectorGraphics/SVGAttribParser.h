...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_CLEANIRI_OFFSET UNITYSDK_OFFSET(0x1A1A6A60)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_CONCLUDEPATH_OFFSET UNITYSDK_OFFSET(0x1A1A6D70)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_NEXTBOOL_OFFSET UNITYSDK_OFFSET(0x1A1A7960)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_NEXTFLOAT_OFFSET UNITYSDK_OFFSET(0x1A1A7160)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_NEXTPATHCOMMAND_OFFSET UNITYSDK_OFFSET(0x1A1A6B10)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_NEXTSTRINGCOMMAND_OFFSET UNITYSDK_OFFSET(0x1A1A7E00)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_NEXTVECTOR2_OFFSET UNITYSDK_OFFSET(0x1A1A6D20)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSECOLOR_OFFSET UNITYSDK_OFFSET(0x1A1A6150)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSEFILL_1_OFFSET UNITYSDK_OFFSET(0x1A1A53C0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSEFILL_OFFSET UNITYSDK_OFFSET(0x1A1A5390)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSEFLOAT_OFFSET UNITYSDK_OFFSET(0x1A1A5780)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSEPATH_OFFSET UNITYSDK_OFFSET(0x1A1A2CA0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSERELATIVEREF_OFFSET UNITYSDK_OFFSET(0x1A1A6930)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSESTROKEANDOPACITY_OFFSET UNITYSDK_OFFSET(0x1A1A5DE0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSETRANSFORM_1_OFFSET UNITYSDK_OFFSET(0x1A1A4630)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A1A45D0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSEURLREF_OFFSET UNITYSDK_OFFSET(0x1A1A68B0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PEEKSYMBOL_OFFSET UNITYSDK_OFFSET(0x1A1A83A0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_SKIPSYMBOL_OFFSET UNITYSDK_OFFSET(0x1A1A80E0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_SKIPWHITESPACES_OFFSET UNITYSDK_OFFSET(0x1A1A8570)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1A47E0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A1A57E0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A2DF0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SVGAttribParser_TypeDefinitionIndex = 28486;
	...
	public:
		...
		{
			return (::ToolBuddy::ThirdParty::VectorGraphics::NamedWebColorDictionary**)Il2CppClass::FromTypeDefinitionIndex(SVGAttribParser_TypeDefinitionIndex)->GetStaticField(0x21A90);
		}
		::System::String* attribString; // 0x10
		::System::String* attribName; // 0x18
		::System::Collections::Generic::List_1<::ToolBuddy::ThirdParty::VectorGraphics::BezierContour>* contours; // 0x20
		::ToolBuddy::ThirdParty::VectorGraphics::IFill* fill; // 0x28
		...
		::ToolBuddy::ThirdParty::VectorGraphics::Matrix2D transform; // 0x3C
		::System::Int32 stringPos; // 0x54
		::UnityEngine::Vector2 penPos; // 0x58
