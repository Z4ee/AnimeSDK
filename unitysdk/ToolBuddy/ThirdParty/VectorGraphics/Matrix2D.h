...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_EQUALS_OFFSET UNITYSDK_OFFSET(0x8BA100)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_GETCOLUMN_OFFSET UNITYSDK_OFFSET(0x8BA260)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8BA040)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_GET_IDENTITY_OFFSET UNITYSDK_OFFSET(0x1A19F100)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x8B9EB0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x8B9D20)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x1A19F090)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_INVERSE_OFFSET UNITYSDK_OFFSET(0x8BA300)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_MULTIPLYPOINT_OFFSET UNITYSDK_OFFSET(0x8BA270)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_MULTIPLYVECTOR_OFFSET UNITYSDK_OFFSET(0x8BA2C0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1A19EB30)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1A19EAD0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_ROTATELH_OFFSET UNITYSDK_OFFSET(0x1A19F030)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_SCALE_OFFSET UNITYSDK_OFFSET(0x1A19EFF0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_SET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x8B9F70)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x8B9DE0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8BA320)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_TRANSLATE_OFFSET UNITYSDK_OFFSET(0x1A19F010)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A19F5C0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D__CTOR_OFFSET UNITYSDK_OFFSET(0x8B9CF0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int Matrix2D_TypeDefinitionIndex = 28452;

	struct alignas(4) Matrix2D
	{
		static ::ToolBuddy::ThirdParty::VectorGraphics::Matrix2D* StaticGet_zeroMatrix()
		{
			return (::ToolBuddy::ThirdParty::VectorGraphics::Matrix2D*)Il2CppClass::FromTypeDefinitionIndex(Matrix2D_TypeDefinitionIndex)->GetStaticField(0x4AB0);
		}
		static ::ToolBuddy::ThirdParty::VectorGraphics::Matrix2D* StaticGet_identityMatrix()
		{
			return (::ToolBuddy::ThirdParty::VectorGraphics::Matrix2D*)Il2CppClass::FromTypeDefinitionIndex(Matrix2D_TypeDefinitionIndex)->GetStaticField(0x4AC8);
		}
