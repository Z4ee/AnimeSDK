...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_EQUALS_OFFSET UNITYSDK_OFFSET(0x9BC6D0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_GETCOLUMN_OFFSET UNITYSDK_OFFSET(0x9BC830)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9BC5E0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_GET_IDENTITY_OFFSET UNITYSDK_OFFSET(0x1DA7E660)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x9BC490)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x9BC340)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x1DA7E5F0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_INVERSE_OFFSET UNITYSDK_OFFSET(0x9BC8D0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_MULTIPLYPOINT_OFFSET UNITYSDK_OFFSET(0x9BC840)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_MULTIPLYVECTOR_OFFSET UNITYSDK_OFFSET(0x9BC890)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1DA7E090)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1DA7E030)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_ROTATELH_OFFSET UNITYSDK_OFFSET(0x1DA7E590)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_SCALE_OFFSET UNITYSDK_OFFSET(0x1DA7E550)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_SET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x9BC530)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x9BC3E0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9BC8F0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_TRANSLATE_OFFSET UNITYSDK_OFFSET(0x1DA7E570)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DA7EB20)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D__CTOR_OFFSET UNITYSDK_OFFSET(0x9BC310)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int Matrix2D_TypeDefinitionIndex = 31726;

	struct alignas(4) Matrix2D
	{
		static ::ToolBuddy::ThirdParty::VectorGraphics::Matrix2D* StaticGet_zeroMatrix()
		{
			return (::ToolBuddy::ThirdParty::VectorGraphics::Matrix2D*)Il2CppClass::FromTypeDefinitionIndex(Matrix2D_TypeDefinitionIndex)->GetStaticField(0x7B60);
		}
		static ::ToolBuddy::ThirdParty::VectorGraphics::Matrix2D* StaticGet_identityMatrix()
		{
			return (::ToolBuddy::ThirdParty::VectorGraphics::Matrix2D*)Il2CppClass::FromTypeDefinitionIndex(Matrix2D_TypeDefinitionIndex)->GetStaticField(0x7B78);
		}
