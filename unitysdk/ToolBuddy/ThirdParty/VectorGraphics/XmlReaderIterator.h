...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_XMLREADERITERATOR_GOTONEXTCHILD_OFFSET UNITYSDK_OFFSET(0x1A1AB8A0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_XMLREADERITERATOR_GOTOROOT_OFFSET UNITYSDK_OFFSET(0x1A1A9CE0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_XMLREADERITERATOR_READTEXTWITHINELEMENT_OFFSET UNITYSDK_OFFSET(0x1A1B7DB0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_XMLREADERITERATOR_SKIPCURRENTCHILDTREE_OFFSET UNITYSDK_OFFSET(0x1A1AAE10)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_XMLREADERITERATOR_VISITCURRENT_OFFSET UNITYSDK_OFFSET(0x1A1AAD90)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_XMLREADERITERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A9B10)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int XmlReaderIterator_TypeDefinitionIndex = 28456;
