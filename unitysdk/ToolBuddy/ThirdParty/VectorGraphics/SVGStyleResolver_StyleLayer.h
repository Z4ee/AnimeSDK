...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_STYLELAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6157F0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SVGStyleResolver_StyleLayer_TypeDefinitionIndex = 31138;
	...
	public:
		...
		::ToolBuddy::ThirdParty::VectorGraphics::SVGStyleSheet* styleSheet; // 0x30
