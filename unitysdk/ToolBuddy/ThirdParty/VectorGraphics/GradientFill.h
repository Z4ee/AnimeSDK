...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_GET_ADDRESSING_OFFSET UNITYSDK_OFFSET(0x1C5F4AA0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_GET_MODE_OFFSET UNITYSDK_OFFSET(0x1C5F4A60)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_GET_OPACITY_OFFSET UNITYSDK_OFFSET(0x1C5F4A80)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_GET_RADIALFOCUS_OFFSET UNITYSDK_OFFSET(0x1C5F4AC0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_GET_STOPS_OFFSET UNITYSDK_OFFSET(0x1C5F4A40)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1C5F4A20)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_SET_ADDRESSING_OFFSET UNITYSDK_OFFSET(0x1C5F4AB0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_SET_MODE_OFFSET UNITYSDK_OFFSET(0x1C5F4A70)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_SET_OPACITY_OFFSET UNITYSDK_OFFSET(0x1C5F4A90)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_SET_RADIALFOCUS_OFFSET UNITYSDK_OFFSET(0x1C5F4AD0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_SET_STOPS_OFFSET UNITYSDK_OFFSET(0x1C5F4A50)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1C5F4A30)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5F4AE0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int GradientFill_TypeDefinitionIndex = 31168;
	...
	public:
		...
		::UnityEngine::Vector2 _RadialFocus_k__BackingField; // 0x28
