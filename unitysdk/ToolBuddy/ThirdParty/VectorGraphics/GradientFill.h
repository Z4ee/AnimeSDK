...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_GET_ADDRESSING_OFFSET UNITYSDK_OFFSET(0x1DA7D9D0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_GET_MODE_OFFSET UNITYSDK_OFFSET(0x1DA7D990)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_GET_OPACITY_OFFSET UNITYSDK_OFFSET(0x1DA7D9B0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_GET_RADIALFOCUS_OFFSET UNITYSDK_OFFSET(0x1DA7D9F0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_GET_STOPS_OFFSET UNITYSDK_OFFSET(0x1DA7D970)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1DA7D950)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_SET_ADDRESSING_OFFSET UNITYSDK_OFFSET(0x1DA7D9E0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_SET_MODE_OFFSET UNITYSDK_OFFSET(0x1DA7D9A0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_SET_OPACITY_OFFSET UNITYSDK_OFFSET(0x1DA7D9C0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_SET_RADIALFOCUS_OFFSET UNITYSDK_OFFSET(0x1DA7DA00)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_SET_STOPS_OFFSET UNITYSDK_OFFSET(0x1DA7D980)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1DA7D960)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA7DA10)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int GradientFill_TypeDefinitionIndex = 31787;
	...
	public:
		...
		::ToolBuddy::ThirdParty::VectorGraphics::GradientFillType _Type_k__BackingField; // 0x18
		::ToolBuddy::ThirdParty::VectorGraphics::FillMode _Mode_k__BackingField; // 0x1C
		::System::Single m_Opacity; // 0x20
		::UnityEngine::Vector2 _RadialFocus_k__BackingField; // 0x24
		::ToolBuddy::ThirdParty::VectorGraphics::AddressMode _Addressing_k__BackingField; // 0x2C
