...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTSTOP_GET_COLOR_OFFSET UNITYSDK_OFFSET(0x2E1000)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTSTOP_GET_STOPPERCENTAGE_OFFSET UNITYSDK_OFFSET(0x3B3000)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTSTOP_SET_COLOR_OFFSET UNITYSDK_OFFSET(0x2E1100)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTSTOP_SET_STOPPERCENTAGE_OFFSET UNITYSDK_OFFSET(0x5A1FC0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int GradientStop_TypeDefinitionIndex = 28507;
