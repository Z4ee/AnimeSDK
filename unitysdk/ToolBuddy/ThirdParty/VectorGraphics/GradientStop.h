...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTSTOP_GET_COLOR_OFFSET UNITYSDK_OFFSET(0x2ADAB0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTSTOP_GET_STOPPERCENTAGE_OFFSET UNITYSDK_OFFSET(0x3EA130)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTSTOP_SET_COLOR_OFFSET UNITYSDK_OFFSET(0x2AD810)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTSTOP_SET_STOPPERCENTAGE_OFFSET UNITYSDK_OFFSET(0x66AD60)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int GradientStop_TypeDefinitionIndex = 31162;
