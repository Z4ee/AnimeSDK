...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_XMLREADERITERATOR_NODE_GETATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1DA9E520)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_XMLREADERITERATOR_NODE_GETEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1DA838D0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_XMLREADERITERATOR_NODE_GETUNSUPPORTEDATTRIBVALEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1DA90B90)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_XMLREADERITERATOR_NODE_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0x1DAA8170)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_XMLREADERITERATOR_NODE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1DA82280)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_XMLREADERITERATOR_NODE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1DAA8160)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_XMLREADERITERATOR_NODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAA8110)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int XmlReaderIterator_Node_TypeDefinitionIndex = 31731;
