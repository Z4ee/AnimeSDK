...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_XMLREADERITERATOR_NODE_GETATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1A1BF320)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_XMLREADERITERATOR_NODE_GETEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1A1A4500)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_XMLREADERITERATOR_NODE_GETUNSUPPORTEDATTRIBVALEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1A1B1910)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_XMLREADERITERATOR_NODE_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0x1A1C9130)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_XMLREADERITERATOR_NODE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A1A2DC0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_XMLREADERITERATOR_NODE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A1C9120)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_XMLREADERITERATOR_NODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1C90D0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int XmlReaderIterator_Node_TypeDefinitionIndex = 28457;
