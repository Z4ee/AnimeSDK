...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_ARCSEGMENTFORQUADRANT_OFFSET UNITYSDK_OFFSET(0x1DAA4870)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BEZIERCOEFFICIENTS_OFFSET UNITYSDK_OFFSET(0x1DAA59A0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BEZIERSEGMENTSTOPATH_OFFSET UNITYSDK_OFFSET(0x1DAA3D50)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BEZIERSEGMENTTOPATH_OFFSET UNITYSDK_OFFSET(0x1DA90230)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BOUNDS_1_OFFSET UNITYSDK_OFFSET(0x1DA9CE90)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BOUNDS_2_OFFSET UNITYSDK_OFFSET(0x1DAA40D0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BOUNDS_OFFSET UNITYSDK_OFFSET(0x1DA9CA10)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BUILDELLIPSEPATH_OFFSET UNITYSDK_OFFSET(0x1DA86DA0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BUILDRECTANGLECONTOUR_OFFSET UNITYSDK_OFFSET(0x1DAA3200)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_COMPUTEELLIPSEPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1DAA2090)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_CUBICROOTS_OFFSET UNITYSDK_OFFSET(0x1DAA5B50)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_ENSURERADIIARELARGEENOUGH_OFFSET UNITYSDK_OFFSET(0x1DAA31B0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_EVAL_OFFSET UNITYSDK_OFFSET(0x1DAA5500)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_FINDBEZIERLINEINTERSECTIONS_OFFSET UNITYSDK_OFFSET(0x1DAA49C0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_FLIPSEGMENT_OFFSET UNITYSDK_OFFSET(0x1DAA5420)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_ISEMPTYSEGMENT_OFFSET UNITYSDK_OFFSET(0x1DA86C10)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKEARCQUARTER_OFFSET UNITYSDK_OFFSET(0x1DAA46B0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKEARC_OFFSET UNITYSDK_OFFSET(0x1DAA2620)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKECIRCLESHAPE_OFFSET UNITYSDK_OFFSET(0x1DA8BD10)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKEELLIPSESHAPE_OFFSET UNITYSDK_OFFSET(0x1DA8CC40)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKELINE_OFFSET UNITYSDK_OFFSET(0x1DA864D0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKEPATHLINE_OFFSET UNITYSDK_OFFSET(0x1DAA3C60)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKERECTANGLESHAPE_1_OFFSET UNITYSDK_OFFSET(0x1DA953A0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKERECTANGLESHAPE_OFFSET UNITYSDK_OFFSET(0x1DA8E9C0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_QUADRANTATANGLE_OFFSET UNITYSDK_OFFSET(0x1DAA4800)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_SCENENODEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1DA99630)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_SCENENODES_OFFSET UNITYSDK_OFFSET(0x1DA97E60)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_SEGMENTSINPATH_OFFSET UNITYSDK_OFFSET(0x1DA87160)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_SOLVEQUADRATIC_OFFSET UNITYSDK_OFFSET(0x1DAA5440)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_SPLITSEGMENT_OFFSET UNITYSDK_OFFSET(0x1DAA4F70)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_TRANSFORMBEZIERPATH_1_OFFSET UNITYSDK_OFFSET(0x1DAA5670)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_TRANSFORMBEZIERPATH_OFFSET UNITYSDK_OFFSET(0x1DAA2E90)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_TRANSFORMSEGMENT_OFFSET UNITYSDK_OFFSET(0x1DAA5280)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_WORLDTRANSFORMEDSCENENODES_1_OFFSET UNITYSDK_OFFSET(0x1DA9ACC0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_WORLDTRANSFORMEDSCENENODES_OFFSET UNITYSDK_OFFSET(0x1DAA58D0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DAA64B0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int VectorUtils_TypeDefinitionIndex = 31770;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(VectorUtils_TypeDefinitionIndex)->GetStaticField(0x7B90);
		}
