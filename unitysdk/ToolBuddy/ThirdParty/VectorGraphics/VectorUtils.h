...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_ARCSEGMENTFORQUADRANT_OFFSET UNITYSDK_OFFSET(0x1C61BCB0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BEZIERCOEFFICIENTS_OFFSET UNITYSDK_OFFSET(0x1C61CE50)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BEZIERSEGMENTSTOPATH_OFFSET UNITYSDK_OFFSET(0x1C61B180)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BEZIERSEGMENTTOPATH_OFFSET UNITYSDK_OFFSET(0x1C607520)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BOUNDS_1_OFFSET UNITYSDK_OFFSET(0x1C614140)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BOUNDS_2_OFFSET UNITYSDK_OFFSET(0x1C61B4F0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BOUNDS_OFFSET UNITYSDK_OFFSET(0x1C613CE0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BUILDELLIPSEPATH_OFFSET UNITYSDK_OFFSET(0x1C5FDF60)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BUILDRECTANGLECONTOUR_OFFSET UNITYSDK_OFFSET(0x1C61A5A0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_COMPUTEELLIPSEPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1C6193D0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_CUBICROOTS_OFFSET UNITYSDK_OFFSET(0x1C61D000)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_ENSURERADIIARELARGEENOUGH_OFFSET UNITYSDK_OFFSET(0x1C61A530)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_EVAL_OFFSET UNITYSDK_OFFSET(0x1C61C9A0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_FINDBEZIERLINEINTERSECTIONS_OFFSET UNITYSDK_OFFSET(0x1C61BE10)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_FLIPSEGMENT_OFFSET UNITYSDK_OFFSET(0x1C61C8C0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_ISEMPTYSEGMENT_OFFSET UNITYSDK_OFFSET(0x1C5FDDD0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKEARCQUARTER_OFFSET UNITYSDK_OFFSET(0x1C61BAF0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKEARC_OFFSET UNITYSDK_OFFSET(0x1C619990)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKECIRCLESHAPE_OFFSET UNITYSDK_OFFSET(0x1C602F50)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKEELLIPSESHAPE_OFFSET UNITYSDK_OFFSET(0x1C603E80)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKELINE_OFFSET UNITYSDK_OFFSET(0x1C5FD690)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKEPATHLINE_OFFSET UNITYSDK_OFFSET(0x1C61B090)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKERECTANGLESHAPE_1_OFFSET UNITYSDK_OFFSET(0x1C60C640)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKERECTANGLESHAPE_OFFSET UNITYSDK_OFFSET(0x1C605C70)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_QUADRANTATANGLE_OFFSET UNITYSDK_OFFSET(0x1C61BC40)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_SCENENODEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1C610810)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_SCENENODES_OFFSET UNITYSDK_OFFSET(0x1C60F0F0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_SEGMENTSINPATH_OFFSET UNITYSDK_OFFSET(0x1C5FE330)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_SOLVEQUADRATIC_OFFSET UNITYSDK_OFFSET(0x1C61C8E0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_SPLITSEGMENT_OFFSET UNITYSDK_OFFSET(0x1C61C3C0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_TRANSFORMBEZIERPATH_1_OFFSET UNITYSDK_OFFSET(0x1C61CB20)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_TRANSFORMBEZIERPATH_OFFSET UNITYSDK_OFFSET(0x1C61A1E0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_TRANSFORMSEGMENT_OFFSET UNITYSDK_OFFSET(0x1C61C6D0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_WORLDTRANSFORMEDSCENENODES_1_OFFSET UNITYSDK_OFFSET(0x1C611FB0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_WORLDTRANSFORMEDSCENENODES_OFFSET UNITYSDK_OFFSET(0x1C61CD80)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C61D950)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int VectorUtils_TypeDefinitionIndex = 31151;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(VectorUtils_TypeDefinitionIndex)->GetStaticField(0x7BA0);
		}
