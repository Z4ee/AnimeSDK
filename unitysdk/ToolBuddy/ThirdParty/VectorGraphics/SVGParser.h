...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGPARSER_IMPORTSVG_1_OFFSET UNITYSDK_OFFSET(0x1C614C70)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGPARSER_IMPORTSVG_OFFSET UNITYSDK_OFFSET(0x1C614C10)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGPARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6156E0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SVGParser_TypeDefinitionIndex = 31109;
