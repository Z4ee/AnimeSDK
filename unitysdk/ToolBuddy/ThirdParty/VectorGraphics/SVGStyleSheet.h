...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEET_CLEAR_OFFSET UNITYSDK_OFFSET(0x1C616D50)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEET_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1C615E10)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEET_GET_SELECTORS_OFFSET UNITYSDK_OFFSET(0x1C615D10)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEET_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1C615B80)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEET__CTOR_OFFSET UNITYSDK_OFFSET(0x1C615A30)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SVGStyleSheet_TypeDefinitionIndex = 31146;
