...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_TEXTUREFILL_GET_ADDRESSING_OFFSET UNITYSDK_OFFSET(0x1DAA2070)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_TEXTUREFILL_GET_MODE_OFFSET UNITYSDK_OFFSET(0x1DAA2030)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_TEXTUREFILL_GET_OPACITY_OFFSET UNITYSDK_OFFSET(0x1DAA2050)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_TEXTUREFILL_GET_TEXTURE_OFFSET UNITYSDK_OFFSET(0x1DAA2010)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_TEXTUREFILL_SET_ADDRESSING_OFFSET UNITYSDK_OFFSET(0x1DAA2080)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_TEXTUREFILL_SET_MODE_OFFSET UNITYSDK_OFFSET(0x1DAA2040)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_TEXTUREFILL_SET_OPACITY_OFFSET UNITYSDK_OFFSET(0x1DAA2060)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_TEXTUREFILL_SET_TEXTURE_OFFSET UNITYSDK_OFFSET(0x1DAA2020)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_TEXTUREFILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA8DC50)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int TextureFill_TypeDefinitionIndex = 31788;
	...
	public:
		...
		::ToolBuddy::ThirdParty::VectorGraphics::AddressMode _Addressing_k__BackingField; // 0x20
