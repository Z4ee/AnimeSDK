...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SOLIDFILL_GET_COLOR_OFFSET UNITYSDK_OFFSET(0x1A1C2D60)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SOLIDFILL_GET_MODE_OFFSET UNITYSDK_OFFSET(0x1A1C2DA0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SOLIDFILL_GET_OPACITY_OFFSET UNITYSDK_OFFSET(0x1A1C2D80)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SOLIDFILL_SET_COLOR_OFFSET UNITYSDK_OFFSET(0x1A1C2D70)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SOLIDFILL_SET_MODE_OFFSET UNITYSDK_OFFSET(0x1A1C2DB0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SOLIDFILL_SET_OPACITY_OFFSET UNITYSDK_OFFSET(0x1A1C2D90)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SOLIDFILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A84E0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SolidFill_TypeDefinitionIndex = 28512;

	class SolidFill : public ::System::Object
	{
	public:
		::ToolBuddy::ThirdParty::VectorGraphics::FillMode _Mode_k__BackingField; // 0x10
		::UnityEngine::Color _Color_k__BackingField; // 0x14
		::System::Single m_Opacity; // 0x24
