...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SOLIDFILL_GET_COLOR_OFFSET UNITYSDK_OFFSET(0x1C619220)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SOLIDFILL_GET_MODE_OFFSET UNITYSDK_OFFSET(0x1C619260)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SOLIDFILL_GET_OPACITY_OFFSET UNITYSDK_OFFSET(0x1C619240)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SOLIDFILL_SET_COLOR_OFFSET UNITYSDK_OFFSET(0x1C619230)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SOLIDFILL_SET_MODE_OFFSET UNITYSDK_OFFSET(0x1C619270)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SOLIDFILL_SET_OPACITY_OFFSET UNITYSDK_OFFSET(0x1C619250)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SOLIDFILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5FEA70)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SolidFill_TypeDefinitionIndex = 31167;
