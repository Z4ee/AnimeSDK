...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__WORLDTRANSFORMEDSCENENODES_D__70_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1C61EBA0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__WORLDTRANSFORMEDSCENENODES_D__70_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_SCENENODEWORLDTRANSFORM__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1C61F410)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__WORLDTRANSFORMEDSCENENODES_D__70_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_SCENENODEWORLDTRANSFORM__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C61F340)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__WORLDTRANSFORMEDSCENENODES_D__70_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1C61F4D0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__WORLDTRANSFORMEDSCENENODES_D__70_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C61F3B0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__WORLDTRANSFORMEDSCENENODES_D__70_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1C61F360)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__WORLDTRANSFORMEDSCENENODES_D__70_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C61E940)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__WORLDTRANSFORMEDSCENENODES_D__70__CTOR_OFFSET UNITYSDK_OFFSET(0x1C61CE10)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__WORLDTRANSFORMEDSCENENODES_D__70___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1C61EB90)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__WORLDTRANSFORMEDSCENENODES_D__70___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1C61EAB0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int VectorUtils__WorldTransformedSceneNodes_d__70_TypeDefinitionIndex = 31155;

	class VectorUtils__WorldTransformedSceneNodes_d__70 : public ::System::Object
	{
	public:
		::ToolBuddy::ThirdParty::VectorGraphics::VectorUtils_SceneNodeWorldTransform __2__current; // 0x10
		::System::Collections::Generic::Dictionary_2<::ToolBuddy::ThirdParty::VectorGraphics::SceneNode*, ::System::Single>* nodeOpacities; // 0x40
		::System::Collections::Generic::IEnumerator_1<::ToolBuddy::ThirdParty::VectorGraphics::VectorUtils_SceneNodeWorldTransform>* __7__wrap3; // 0x48
		::ToolBuddy::ThirdParty::VectorGraphics::VectorUtils_SceneNodeWorldTransform __3__parent; // 0x50
		::ToolBuddy::ThirdParty::VectorGraphics::SceneNode* child; // 0x80
		::System::Collections::Generic::List_1_Enumerator<::ToolBuddy::ThirdParty::VectorGraphics::SceneNode*> __7__wrap2; // 0x88
		::ToolBuddy::ThirdParty::VectorGraphics::VectorUtils_SceneNodeWorldTransform _childWorldTransform_5__2; // 0xA0
		::System::Collections::Generic::Dictionary_2<::ToolBuddy::ThirdParty::VectorGraphics::SceneNode*, ::System::Single>* __3__nodeOpacities; // 0xD0
		::ToolBuddy::ThirdParty::VectorGraphics::VectorUtils_SceneNodeWorldTransform parent; // 0xD8
