...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_BEZIERCONTOUR_GET_CLOSED_OFFSET UNITYSDK_OFFSET(0x3E5670)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_BEZIERCONTOUR_GET_SEGMENTS_OFFSET UNITYSDK_OFFSET(0x246290)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_BEZIERCONTOUR_SET_CLOSED_OFFSET UNITYSDK_OFFSET(0x5C9410)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_BEZIERCONTOUR_SET_SEGMENTS_OFFSET UNITYSDK_OFFSET(0x2B6D10)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int BezierContour_TypeDefinitionIndex = 31165;
