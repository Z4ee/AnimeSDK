...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_BEZIERCONTOUR_GET_CLOSED_OFFSET UNITYSDK_OFFSET(0x41FD70)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_BEZIERCONTOUR_GET_SEGMENTS_OFFSET UNITYSDK_OFFSET(0x259D70)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_BEZIERCONTOUR_SET_CLOSED_OFFSET UNITYSDK_OFFSET(0x622AD0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_BEZIERCONTOUR_SET_SEGMENTS_OFFSET UNITYSDK_OFFSET(0x324D50)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int BezierContour_TypeDefinitionIndex = 31784;
