...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SEGMENTSINPATH_D__75_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1DAA6E20)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SEGMENTSINPATH_D__75_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_BEZIERSEGMENT__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1DAA73B0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SEGMENTSINPATH_D__75_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_BEZIERSEGMENT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DAA72F0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SEGMENTSINPATH_D__75_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1DAA7430)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SEGMENTSINPATH_D__75_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DAA7360)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SEGMENTSINPATH_D__75_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1DAA7310)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SEGMENTSINPATH_D__75_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DAA6E10)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SEGMENTSINPATH_D__75__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAA5980)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int VectorUtils__SegmentsInPath_d__75_TypeDefinitionIndex = 31775;
	...
	public:
		...
		::System::Boolean __3__closed; // 0x2C
		::System::Boolean closed; // 0x2D
		::ToolBuddy::ThirdParty::VectorGraphics::BezierPathSegment _s2_5__3; // 0x30
		::ToolBuddy::ThirdParty::VectorGraphics::BezierSegment __2__current; // 0x48
