...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER__SORTEDCLASSES_D__12_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1DA9F2E0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER__SORTEDCLASSES_D__12_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_STRING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1DA9F930)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER__SORTEDCLASSES_D__12_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_STRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DA9F8C0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER__SORTEDCLASSES_D__12_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1DA9F9B0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER__SORTEDCLASSES_D__12_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DA9F920)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER__SORTEDCLASSES_D__12_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1DA9F8D0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER__SORTEDCLASSES_D__12_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DA9F0E0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER__SORTEDCLASSES_D__12__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA9F050)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER__SORTEDCLASSES_D__12___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1DA9F1F0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER__SORTEDCLASSES_D__12___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1DA9F200)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SVGStyleResolver__SortedClasses_d__12_TypeDefinitionIndex = 31759;
	...
	public:
		...
		::System::Collections::Generic::List_1_Enumerator<::System::String*> __7__wrap1; // 0x20
		::System::Collections::Generic::List_1<::System::String*>* __3__classes; // 0x38
		::System::String* __2__current; // 0x40
		::ToolBuddy::ThirdParty::VectorGraphics::SVGStyleResolver* __4__this; // 0x48
