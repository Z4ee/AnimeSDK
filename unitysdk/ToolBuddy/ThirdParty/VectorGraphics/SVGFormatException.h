...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGFORMATEXCEPTION_COMPOSEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1C6146E0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGFORMATEXCEPTION_GET_STACKERROR_OFFSET UNITYSDK_OFFSET(0x1C6009B0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGFORMATEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C6002F0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGFORMATEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C614B80)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGFORMATEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C614660)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SVGFormatException_TypeDefinitionIndex = 31113;
