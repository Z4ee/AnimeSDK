...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGFORMATEXCEPTION_COMPOSEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1A1BE200)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGFORMATEXCEPTION_GET_STACKERROR_OFFSET UNITYSDK_OFFSET(0x1A1AA400)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGFORMATEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1A9D40)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGFORMATEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A1BE6A0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGFORMATEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1BE180)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SVGFormatException_TypeDefinitionIndex = 28458;
