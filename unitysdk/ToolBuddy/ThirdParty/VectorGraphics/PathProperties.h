...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_PATHPROPERTIES_GET_CORNERS_OFFSET UNITYSDK_OFFSET(0x2B7CC0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_PATHPROPERTIES_GET_HEAD_OFFSET UNITYSDK_OFFSET(0x2C19D0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_PATHPROPERTIES_GET_STROKE_OFFSET UNITYSDK_OFFSET(0x246290)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_PATHPROPERTIES_GET_TAIL_OFFSET UNITYSDK_OFFSET(0x2C3430)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_PATHPROPERTIES_SET_CORNERS_OFFSET UNITYSDK_OFFSET(0x48E3B0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_PATHPROPERTIES_SET_HEAD_OFFSET UNITYSDK_OFFSET(0x52CCD0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_PATHPROPERTIES_SET_STROKE_OFFSET UNITYSDK_OFFSET(0x2B6D10)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_PATHPROPERTIES_SET_TAIL_OFFSET UNITYSDK_OFFSET(0x52CD90)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int PathProperties_TypeDefinitionIndex = 31172;
