...
#define CLASS_1_F1E790FCE2711921__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4FA410)
...
{
public:
	::System::Collections::Generic::List_1<::RPG::Client::LittleGame::TimelineControlGameCharacterMovementPath*>* DIKJBMHBCNK; // 0x10
	...
	::RPG::Client::LittleGame::TimelineControlGameCharacterMovementConfig EABKOHGCHFP; // 0x34
	::RPG::Client::LittleGame::ETimelineControlGameCharacterMoveDirection FFHIEMCJDJJ; // 0x38
