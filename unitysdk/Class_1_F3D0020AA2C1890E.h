...
#define CLASS_1_F3D0020AA2C1890E_METHOD_1_1352708442940A46_OFFSET UNITYSDK_OFFSET(0x1855BFE0)
#define CLASS_1_F3D0020AA2C1890E_METHOD_1_52C117739DCB195E_OFFSET UNITYSDK_OFFSET(0x18559840)
#define CLASS_1_F3D0020AA2C1890E_METHOD_1_5C07AC6B562A2160_OFFSET UNITYSDK_OFFSET(0x1855A9C0)
#define CLASS_1_F3D0020AA2C1890E_METHOD_1_6778013C4BE543AA_OFFSET UNITYSDK_OFFSET(0x1855AF00)
#define CLASS_1_F3D0020AA2C1890E_METHOD_1_9788B03F21707475_OFFSET UNITYSDK_OFFSET(0x1855C270)
#define CLASS_1_F3D0020AA2C1890E_METHOD_1_9A0F2E1BF8D3FADB_OFFSET UNITYSDK_OFFSET(0x1855BB20)
#define CLASS_1_F3D0020AA2C1890E_METHOD_1_B7FB649DB8FD268A_OFFSET UNITYSDK_OFFSET(0x1855C3A0)
#define CLASS_1_F3D0020AA2C1890E_METHOD_1_B9196C576870EF00_OFFSET UNITYSDK_OFFSET(0x1855C7A0)
#define CLASS_1_F3D0020AA2C1890E_METHOD_1_B9F28A541C75B6BB_OFFSET UNITYSDK_OFFSET(0x18559E40)
#define CLASS_1_F3D0020AA2C1890E_METHOD_1_DC497FA458BA0CAA_OFFSET UNITYSDK_OFFSET(0x1855B6E0)
#define CLASS_1_F3D0020AA2C1890E_METHOD_1_E4C54787AF0B49EF_OFFSET UNITYSDK_OFFSET(0x185597B0)
#define CLASS_1_F3D0020AA2C1890E__CCTOR_OFFSET UNITYSDK_OFFSET(0x1855C9B0)
#define CLASS_1_F3D0020AA2C1890E__CTOR_OFFSET UNITYSDK_OFFSET(0x185591D0)

inline static constexpr unsigned int Class_1_F3D0020AA2C1890E_TypeDefinitionIndex = 62456;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_F3D0020AA2C1890E_TypeDefinitionIndex)->GetStaticField(0x12B10);
	}
	static ::System::Int32* StaticGet_HBEFIMAAJHD()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_F3D0020AA2C1890E_TypeDefinitionIndex)->GetStaticField(0x12B14);
	}
	static ::System::Int32* StaticGet_DOGCPKEDCPD()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_F3D0020AA2C1890E_TypeDefinitionIndex)->GetStaticField(0x12B18);
	}
	::Class_0_16E4307DCC419505_745* IFPBIHEFOBN; // 0x10
	::System::Single ALDHNEADDBL; // 0x18

	::System::Void _ctor(::Class_0_16E4307DCC419505_745* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_745*))((::PBYTE)hIl2Cpp + CLASS_1_F3D0020AA2C1890E__CTOR_OFFSET))(this, a1);
	}
