...
#define CLASS_1_F3D0020AA2C1890E_METHOD_1_1352708442940A46_OFFSET UNITYSDK_OFFSET(0x162A7E00)
#define CLASS_1_F3D0020AA2C1890E_METHOD_1_52C117739DCB195E_OFFSET UNITYSDK_OFFSET(0x162A5660)
#define CLASS_1_F3D0020AA2C1890E_METHOD_1_5C07AC6B562A2160_OFFSET UNITYSDK_OFFSET(0x162A67E0)
#define CLASS_1_F3D0020AA2C1890E_METHOD_1_6778013C4BE543AA_OFFSET UNITYSDK_OFFSET(0x162A6D20)
#define CLASS_1_F3D0020AA2C1890E_METHOD_1_9788B03F21707475_OFFSET UNITYSDK_OFFSET(0x162A8090)
#define CLASS_1_F3D0020AA2C1890E_METHOD_1_9A0F2E1BF8D3FADB_OFFSET UNITYSDK_OFFSET(0x162A7940)
#define CLASS_1_F3D0020AA2C1890E_METHOD_1_B7FB649DB8FD268A_OFFSET UNITYSDK_OFFSET(0x162A81C0)
#define CLASS_1_F3D0020AA2C1890E_METHOD_1_B9196C576870EF00_OFFSET UNITYSDK_OFFSET(0x162A85C0)
#define CLASS_1_F3D0020AA2C1890E_METHOD_1_B9F28A541C75B6BB_OFFSET UNITYSDK_OFFSET(0x162A5C60)
#define CLASS_1_F3D0020AA2C1890E_METHOD_1_DC497FA458BA0CAA_OFFSET UNITYSDK_OFFSET(0x162A7500)
#define CLASS_1_F3D0020AA2C1890E_METHOD_1_E4C54787AF0B49EF_OFFSET UNITYSDK_OFFSET(0x162A55D0)
#define CLASS_1_F3D0020AA2C1890E__CCTOR_OFFSET UNITYSDK_OFFSET(0x162A87D0)
#define CLASS_1_F3D0020AA2C1890E__CTOR_OFFSET UNITYSDK_OFFSET(0x162A4FF0)
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_F3D0020AA2C1890E_TypeDefinitionIndex)->GetStaticField(0x12B40);
	}
	static ::System::Int32* StaticGet_HBEFIMAAJHD()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_F3D0020AA2C1890E_TypeDefinitionIndex)->GetStaticField(0x12B44);
	}
	static ::System::Int32* StaticGet_DOGCPKEDCPD()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_F3D0020AA2C1890E_TypeDefinitionIndex)->GetStaticField(0x12B48);
	}
