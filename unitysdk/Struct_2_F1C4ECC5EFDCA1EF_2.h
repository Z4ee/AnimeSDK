...
#define STRUCT_2_F1C4ECC5EFDCA1EF_2_DECONSTRUCT_OFFSET UNITYSDK_OFFSET(0x841F0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_2_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x841C0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_2_EQUALS_OFFSET UNITYSDK_OFFSET(0x84180)
#define STRUCT_2_F1C4ECC5EFDCA1EF_2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x84170)
#define STRUCT_2_F1C4ECC5EFDCA1EF_2_GET_ID_OFFSET UNITYSDK_OFFSET(0xDAB0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_2_GET_PROTOTYPEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x5AB0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_2_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xB931350)
#define STRUCT_2_F1C4ECC5EFDCA1EF_2_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xB931310)
#define STRUCT_2_F1C4ECC5EFDCA1EF_2_PRINTMEMBERS_OFFSET UNITYSDK_OFFSET(0x84150)
#define STRUCT_2_F1C4ECC5EFDCA1EF_2_SET_ID_OFFSET UNITYSDK_OFFSET(0xDAC0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_2_SET_PROTOTYPEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0xC610)
#define STRUCT_2_F1C4ECC5EFDCA1EF_2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x84140)
#define STRUCT_2_F1C4ECC5EFDCA1EF_2__CTOR_OFFSET UNITYSDK_OFFSET(0x84130)
