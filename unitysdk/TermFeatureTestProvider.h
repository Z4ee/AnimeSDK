...
#define TERMFEATURETESTPROVIDER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1F1CBA50)
#define TERMFEATURETESTPROVIDER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1F1CBD80)
#define TERMFEATURETESTPROVIDER_REBUILDLOOKUP_OFFSET UNITYSDK_OFFSET(0x1F1CBB30)
#define TERMFEATURETESTPROVIDER_TRYGETTERM_OFFSET UNITYSDK_OFFSET(0x1F1CBEF0)
#define TERMFEATURETESTPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F1CBFE0)

inline static constexpr unsigned int TermFeatureTestProvider_TypeDefinitionIndex = 68249;
