...
#define TERMFEATURETESTPROVIDER_AWAKE_OFFSET UNITYSDK_OFFSET(0x17885980)
#define TERMFEATURETESTPROVIDER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17885CA0)
#define TERMFEATURETESTPROVIDER_REBUILDLOOKUP_OFFSET UNITYSDK_OFFSET(0x17885A60)
#define TERMFEATURETESTPROVIDER_TRYGETTERM_OFFSET UNITYSDK_OFFSET(0x17885E10)
#define TERMFEATURETESTPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x17885EF0)

inline static constexpr unsigned int TermFeatureTestProvider_TypeDefinitionIndex = 40578;
