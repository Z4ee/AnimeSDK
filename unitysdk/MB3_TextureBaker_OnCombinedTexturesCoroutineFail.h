...
#define MB3_TEXTUREBAKER_ONCOMBINEDTEXTURESCOROUTINEFAIL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F560E80)
#define MB3_TEXTUREBAKER_ONCOMBINEDTEXTURESCOROUTINEFAIL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F560EB0)
#define MB3_TEXTUREBAKER_ONCOMBINEDTEXTURESCOROUTINEFAIL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F560B60)
#define MB3_TEXTUREBAKER_ONCOMBINEDTEXTURESCOROUTINEFAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1F560E60)

inline static constexpr unsigned int MB3_TextureBaker_OnCombinedTexturesCoroutineFail_TypeDefinitionIndex = 94484;
