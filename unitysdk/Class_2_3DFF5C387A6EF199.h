...
#define CLASS_2_3DFF5C387A6EF199_GET_PERCENTINCREASE_OFFSET UNITYSDK_OFFSET(0x161FA080)
#define CLASS_2_3DFF5C387A6EF199_ISEFFECTIVEONAVATAR_OFFSET UNITYSDK_OFFSET(0x161FA110)
#define CLASS_2_3DFF5C387A6EF199_ISTRIGGERED_OFFSET UNITYSDK_OFFSET(0x161FA160)
#define CLASS_2_3DFF5C387A6EF199__CTOR_OFFSET UNITYSDK_OFFSET(0x161FA1A0)
#define CLASS_2_3DFF5C387A6EF199__ONINITPARAM_OFFSET UNITYSDK_OFFSET(0x161FA0C0)

inline static constexpr unsigned int Class_2_3DFF5C387A6EF199_TypeDefinitionIndex = 66573;

class Class_2_3DFF5C387A6EF199 : public ::RPG::Client::BasePlanetFesBuff
{
public:
	::Il2CppArray<::System::UInt32>* BGDDKFHKAKM; // 0x30
