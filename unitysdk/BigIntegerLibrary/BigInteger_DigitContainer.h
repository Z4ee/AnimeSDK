...
#define BIGINTEGERLIBRARY_BIGINTEGER_DIGITCONTAINER_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1BE607B0)
#define BIGINTEGERLIBRARY_BIGINTEGER_DIGITCONTAINER_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1BE60420)
#define BIGINTEGERLIBRARY_BIGINTEGER_DIGITCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE603E0)

namespace BigIntegerLibrary
{
	inline static constexpr unsigned int BigInteger_DigitContainer_TypeDefinitionIndex = 19477;
