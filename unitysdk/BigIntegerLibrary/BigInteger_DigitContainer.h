...
#define BIGINTEGERLIBRARY_BIGINTEGER_DIGITCONTAINER_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x18CF3640)
#define BIGINTEGERLIBRARY_BIGINTEGER_DIGITCONTAINER_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x18CF32E0)
#define BIGINTEGERLIBRARY_BIGINTEGER_DIGITCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x18CF32A0)

namespace BigIntegerLibrary
{
	inline static constexpr unsigned int BigInteger_DigitContainer_TypeDefinitionIndex = 6057;
