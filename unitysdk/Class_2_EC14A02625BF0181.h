...
#define CLASS_2_EC14A02625BF0181_METHOD_2_C54EC196AF37CD63_OFFSET UNITYSDK_OFFSET(0x1D7133E0)
#define CLASS_2_EC14A02625BF0181__CTOR_OFFSET UNITYSDK_OFFSET(0x1D713620)
...
{
public:
	::RPG::GameCore::DynamicFloat* COKBFAHFMPB; // 0x10
	::RPG::GameCore::DynamicFloat* PHPNFMOOFBK; // 0x18
	::RPG::GameCore::DynamicFloat* GOICKEFFKNP; // 0x20
