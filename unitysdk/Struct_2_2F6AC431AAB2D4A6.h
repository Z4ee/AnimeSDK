...
#define STRUCT_2_2F6AC431AAB2D4A6_EQUALS_OFFSET UNITYSDK_OFFSET(0xE0100)
#define STRUCT_2_2F6AC431AAB2D4A6_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xE0160)
#define STRUCT_2_2F6AC431AAB2D4A6___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xE01C0)

inline static constexpr unsigned int Struct_2_2F6AC431AAB2D4A6_TypeDefinitionIndex = 52238;
