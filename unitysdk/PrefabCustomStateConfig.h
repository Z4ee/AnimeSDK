...
#define PREFABCUSTOMSTATECONFIG_AWAKE_OFFSET UNITYSDK_OFFSET(0x17467C70)
#define PREFABCUSTOMSTATECONFIG_GETGAMEOBJECTSTATEBIT_OFFSET UNITYSDK_OFFSET(0x17467CF0)
#define PREFABCUSTOMSTATECONFIG_GET_CUSTOMOBJCOLOR_OFFSET UNITYSDK_OFFSET(0x17468500)
#define PREFABCUSTOMSTATECONFIG_GET_TERRAINRATEPEROBJ_OFFSET UNITYSDK_OFFSET(0x174686F0)
#define PREFABCUSTOMSTATECONFIG_INITCOMPONENT_OFFSET UNITYSDK_OFFSET(0x17467F00)
#define PREFABCUSTOMSTATECONFIG_METHOD_5_F0D9B6AAFF504D87_OFFSET UNITYSDK_OFFSET(0x17467F50)
#define PREFABCUSTOMSTATECONFIG_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x17468140)
#define PREFABCUSTOMSTATECONFIG_PERSISTENTDATA_OFFSET UNITYSDK_OFFSET(0x174680F0)
#define PREFABCUSTOMSTATECONFIG_SET_CUSTOMOBJCOLOR_OFFSET UNITYSDK_OFFSET(0x17468510)
#define PREFABCUSTOMSTATECONFIG_SET_TERRAINRATEPEROBJ_OFFSET UNITYSDK_OFFSET(0x17468700)
#define PREFABCUSTOMSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17468770)

inline static constexpr unsigned int PrefabCustomStateConfig_TypeDefinitionIndex = 45544;
