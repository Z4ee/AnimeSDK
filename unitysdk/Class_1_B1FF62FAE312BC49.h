...
#define CLASS_1_B1FF62FAE312BC49_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x18183A80)
#define CLASS_1_B1FF62FAE312BC49_CLONE_OFFSET UNITYSDK_OFFSET(0x18183380)
#define CLASS_1_B1FF62FAE312BC49_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x18183490)
#define CLASS_1_B1FF62FAE312BC49_EQUALS_OFFSET UNITYSDK_OFFSET(0x18183460)
#define CLASS_1_B1FF62FAE312BC49_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x181835D0)
#define CLASS_1_B1FF62FAE312BC49_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x18183EC0)
#define CLASS_1_B1FF62FAE312BC49_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x18183D40)
#define CLASS_1_B1FF62FAE312BC49_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x181833E0)
#define CLASS_1_B1FF62FAE312BC49_METHOD_1_02A3D10A9D535169_2_OFFSET UNITYSDK_OFFSET(0x18183440)
#define CLASS_1_B1FF62FAE312BC49_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x181833B0)
#define CLASS_1_B1FF62FAE312BC49_METHOD_1_6E1EC2DF63D7020F_1_OFFSET UNITYSDK_OFFSET(0x18183400)
#define CLASS_1_B1FF62FAE312BC49_METHOD_1_6E1EC2DF63D7020F_2_OFFSET UNITYSDK_OFFSET(0x18183410)
#define CLASS_1_B1FF62FAE312BC49_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x181833D0)
#define CLASS_1_B1FF62FAE312BC49_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x181833F0)
#define CLASS_1_B1FF62FAE312BC49_METHOD_1_7786DC814C2FC3BE_2_OFFSET UNITYSDK_OFFSET(0x18183450)
#define CLASS_1_B1FF62FAE312BC49_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x181833C0)
#define CLASS_1_B1FF62FAE312BC49_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x18183430)
#define CLASS_1_B1FF62FAE312BC49_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x18183420)
#define CLASS_1_B1FF62FAE312BC49_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x181831B0)
#define CLASS_1_B1FF62FAE312BC49_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18183840)
#define CLASS_1_B1FF62FAE312BC49_WRITETO_OFFSET UNITYSDK_OFFSET(0x181838A0)
#define CLASS_1_B1FF62FAE312BC49__CCTOR_OFFSET UNITYSDK_OFFSET(0x18184080)
#define CLASS_1_B1FF62FAE312BC49__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18183240)
#define CLASS_1_B1FF62FAE312BC49__CTOR_OFFSET UNITYSDK_OFFSET(0x181831C0)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_36E3880E987172D7*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B1FF62FAE312BC49_TypeDefinitionIndex)->GetStaticField(0xC590);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_FA34F6BE161ACBE6_1*>** StaticGet_Field_1_12()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_FA34F6BE161ACBE6_1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B1FF62FAE312BC49_TypeDefinitionIndex)->GetStaticField(0xC598);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_9592B34F41301777*>** StaticGet_Field_1_4()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_9592B34F41301777*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B1FF62FAE312BC49_TypeDefinitionIndex)->GetStaticField(0xC5A0);
	}
	...
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_FA34F6BE161ACBE6_1*>* Field_1_13; // 0x10
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_36E3880E987172D7*>* Field_1_10; // 0x18
	::Google::Protobuf::UnknownFieldSet* Field_1_0; // 0x20
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_9592B34F41301777*>* Field_1_5; // 0x28
