...
#define CLASS_1_C7618451F544DC60_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A8315D0)
#define CLASS_1_C7618451F544DC60_METHOD_1_3C7A858EC86F05BF_OFFSET UNITYSDK_OFFSET(0x1A831950)
#define CLASS_1_C7618451F544DC60_METHOD_1_6A7CEF06F8896271_OFFSET UNITYSDK_OFFSET(0x1A8328D0)
#define CLASS_1_C7618451F544DC60_METHOD_1_7F4785C9A769CFCC_OFFSET UNITYSDK_OFFSET(0x1A832810)
#define CLASS_1_C7618451F544DC60_METHOD_1_A3B219A44BBB402C_OFFSET UNITYSDK_OFFSET(0x1A831D60)
#define CLASS_1_C7618451F544DC60_METHOD_1_BD658202BB4C4431_OFFSET UNITYSDK_OFFSET(0x1A831C90)
#define CLASS_1_C7618451F544DC60_METHOD_1_C1D3BDE2A17F5C9D_OFFSET UNITYSDK_OFFSET(0x1A831A80)
#define CLASS_1_C7618451F544DC60_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1A8327B0)
#define CLASS_1_C7618451F544DC60_METHOD_1_E52129E82CD2D7F8_OFFSET UNITYSDK_OFFSET(0x1A8316A0)
#define CLASS_1_C7618451F544DC60_METHOD_1_EF78D1C8F5F25917_OFFSET UNITYSDK_OFFSET(0x1A831BE0)
#define CLASS_1_C7618451F544DC60_METHOD_1_FA0119DD445A672F_OFFSET UNITYSDK_OFFSET(0x1A831E80)
#define CLASS_1_C7618451F544DC60_METHOD_1_FDE09C8D62639E3E_OFFSET UNITYSDK_OFFSET(0x1A831CF0)
#define CLASS_1_C7618451F544DC60_ONCANCELSPAWN_OFFSET UNITYSDK_OFFSET(0x1A8322E0)
#define CLASS_1_C7618451F544DC60_ONSPAWNASYNC_OFFSET UNITYSDK_OFFSET(0x1A832320)
#define CLASS_1_C7618451F544DC60_USELIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1A832980)
#define CLASS_1_C7618451F544DC60__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8329C0)
...
public:
	...
	::System::String* ODHMHECLFCO; // 0x20
	::System::String* BEGBPEHAEDM; // 0x28
	::System::Collections::Generic::List_1<::UnityEngine::Material*>* POLGHOLICMA; // 0x30
	::RPG::GameCore::ResidentPossessionInfo* IGHAHBNLIJA; // 0x38
	::Class_1_1342B57709FD7AC5* OIDAGBPPNBJ; // 0x40
	::UnityEngine::GameObject* AFGEEDIJOJF; // 0x48
	::RPG::Client::CharacterShaderPropertyTransition* EPOBIDJNGOL; // 0x50
	::System::String* KHHGBMCHGPL; // 0x58
	::RPG::GameCore::GameEntity* CFKHNPGEAJA; // 0x60
	::UnityEngine::Transform* OEPDOMNEOHO; // 0x68
	::System::Boolean GGCFLAOOJNN; // 0x70
	::System::Single CKIDJOPJMBP; // 0x74
	::UnityEngine::Quaternion KCBAMAPIPFI; // 0x78
	::UnityEngine::Vector3 FPILBEAAACE; // 0x88
