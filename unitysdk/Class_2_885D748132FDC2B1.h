...
#define CLASS_2_885D748132FDC2B1_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16C88650)
#define CLASS_2_885D748132FDC2B1_METHOD_2_7352BE9A0DF686CA_OFFSET UNITYSDK_OFFSET(0x16C88AB0)
#define CLASS_2_885D748132FDC2B1_METHOD_2_A9AE62EC8237EA52_OFFSET UNITYSDK_OFFSET(0x16C88970)
#define CLASS_2_885D748132FDC2B1_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16C88690)
#define CLASS_2_885D748132FDC2B1_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x16C88A00)
#define CLASS_2_885D748132FDC2B1_TICK_OFFSET UNITYSDK_OFFSET(0x16C88A50)
#define CLASS_2_885D748132FDC2B1__CTOR_OFFSET UNITYSDK_OFFSET(0x16C88640)

inline static constexpr unsigned int Class_2_885D748132FDC2B1_TypeDefinitionIndex = 56033;

class Class_2_885D748132FDC2B1 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::ShowGuideTextFollow3D* Field_2_1; // 0x20
