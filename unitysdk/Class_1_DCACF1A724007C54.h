...
#define CLASS_1_DCACF1A724007C54_CLEAR_OFFSET UNITYSDK_OFFSET(0x1646C2E0)
#define CLASS_1_DCACF1A724007C54_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1646C1F0)
#define CLASS_1_DCACF1A724007C54_ONCANCELSPAWN_OFFSET UNITYSDK_OFFSET(0x1646C260)
#define CLASS_1_DCACF1A724007C54_ONSPAWNASYNC_OFFSET UNITYSDK_OFFSET(0x1646C200)
#define CLASS_1_DCACF1A724007C54_USELIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1646C2A0)
#define CLASS_1_DCACF1A724007C54__CTOR_OFFSET UNITYSDK_OFFSET(0x1646C330)

inline static constexpr unsigned int Class_1_DCACF1A724007C54_TypeDefinitionIndex = 65696;
