...
#define CLASS_1_DCACF1A724007C54_CLEAR_OFFSET UNITYSDK_OFFSET(0xAF40FD0)
#define CLASS_1_DCACF1A724007C54_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xAF40EE0)
#define CLASS_1_DCACF1A724007C54_ONCANCELSPAWN_OFFSET UNITYSDK_OFFSET(0xAF40F50)
#define CLASS_1_DCACF1A724007C54_ONSPAWNASYNC_OFFSET UNITYSDK_OFFSET(0xAF40EF0)
#define CLASS_1_DCACF1A724007C54_USELIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0xAF40F90)
#define CLASS_1_DCACF1A724007C54__CTOR_OFFSET UNITYSDK_OFFSET(0xAF41020)

inline static constexpr unsigned int Class_1_DCACF1A724007C54_TypeDefinitionIndex = 64325;
