...
#define CLASS_1_0301444171B4FB72__CTOR_OFFSET UNITYSDK_OFFSET(0x16119A40)
...
{
public:
	::Il2CppArray<::RPG::GameCore::TaskConfig*>* NEMENNBHAFK; // 0x10
	::Il2CppArray<::RPG::GameCore::TaskConfig*>* AONJGMLJNLC; // 0x18
