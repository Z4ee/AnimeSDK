...
#define CLASS_2_1DB6C02CA182EEBA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x199F3360)
#define CLASS_2_1DB6C02CA182EEBA_GET_CURRENTABILITYTARGETGROUPLEADER_OFFSET UNITYSDK_OFFSET(0x199F3590)
#define CLASS_2_1DB6C02CA182EEBA_GET_PARALLELDELAYTIME_OFFSET UNITYSDK_OFFSET(0x199F3570)
#define CLASS_2_1DB6C02CA182EEBA_GET_PARALLELLOCALTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x199F3550)
#define CLASS_2_1DB6C02CA182EEBA_GET_PARALLELROOT_OFFSET UNITYSDK_OFFSET(0x199F34C0)
#define CLASS_2_1DB6C02CA182EEBA_GET_PARENTPARALLELTASKLIST_OFFSET UNITYSDK_OFFSET(0x199F34A0)
#define CLASS_2_1DB6C02CA182EEBA_GET_TARGETTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x199F34E0)
#define CLASS_2_1DB6C02CA182EEBA_METHOD_2_30A2382C3FCC5386_OFFSET UNITYSDK_OFFSET(0x199F33E0)
#define CLASS_2_1DB6C02CA182EEBA_METHOD_2_6AEE51845DFA6D71_OFFSET UNITYSDK_OFFSET(0x199F3500)
#define CLASS_2_1DB6C02CA182EEBA_METHOD_2_775B6D644F07B554_OFFSET UNITYSDK_OFFSET(0x199F35B0)
#define CLASS_2_1DB6C02CA182EEBA_METHOD_2_C50B93169B85DAEA_OFFSET UNITYSDK_OFFSET(0x199F3450)
#define CLASS_2_1DB6C02CA182EEBA_SET_CURRENTABILITYTARGETGROUPLEADER_OFFSET UNITYSDK_OFFSET(0x199F35A0)
#define CLASS_2_1DB6C02CA182EEBA_SET_PARALLELDELAYTIME_OFFSET UNITYSDK_OFFSET(0x199F3580)
#define CLASS_2_1DB6C02CA182EEBA_SET_PARALLELLOCALTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x199F3560)
#define CLASS_2_1DB6C02CA182EEBA_SET_PARALLELROOT_OFFSET UNITYSDK_OFFSET(0x199F34D0)
#define CLASS_2_1DB6C02CA182EEBA_SET_PARENTPARALLELTASKLIST_OFFSET UNITYSDK_OFFSET(0x199F34B0)
#define CLASS_2_1DB6C02CA182EEBA_SET_TARGETTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x199F34F0)
#define CLASS_2_1DB6C02CA182EEBA__CTOR_OFFSET UNITYSDK_OFFSET(0x199F3270)
...
{
public:
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* HBKFLPIHGLL; // 0x90
	::RPG::GameCore::TurnBasedAbilityConfig* EABKOHGCHFP; // 0x98
	::Class_0_16E4307DCC419505_564* _ParentParallelTaskList_k__BackingField; // 0xA0
	::RPG::GameCore::GameEntity* _CurrentAbilityTargetGroupLeader_k__BackingField; // 0xA8
	::Class_1_07A210D994F284D8_6* _ParallelRoot_k__BackingField; // 0xB0
	::Class_3_07C3C4D2990C49EE* GEIKINNJCBD; // 0xB8
	::RPG::GameCore::FixPoint _TargetTimeStamp_k__BackingField; // 0xC0
	::RPG::GameCore::FixPoint _ParallelLocalTimeStamp_k__BackingField; // 0xC8
