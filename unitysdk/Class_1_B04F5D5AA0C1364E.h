...
#define CLASS_1_B04F5D5AA0C1364E_GET_ENABLEINFINITETACTICSREFRESH_OFFSET UNITYSDK_OFFSET(0x17BA7B30)
#define CLASS_1_B04F5D5AA0C1364E_GET_IGNORECOLORDICECONDITIONCHECK_OFFSET UNITYSDK_OFFSET(0x17BA7B10)
#define CLASS_1_B04F5D5AA0C1364E_SET_ENABLEINFINITETACTICSREFRESH_OFFSET UNITYSDK_OFFSET(0x17BA7B40)
#define CLASS_1_B04F5D5AA0C1364E_SET_IGNORECOLORDICECONDITIONCHECK_OFFSET UNITYSDK_OFFSET(0x17BA7B20)
#define CLASS_1_B04F5D5AA0C1364E__CTOR_OFFSET UNITYSDK_OFFSET(0x17B7AAA0)

inline static constexpr unsigned int Class_1_B04F5D5AA0C1364E_TypeDefinitionIndex = 34928;
