...
#define CLASS_1_B04F5D5AA0C1364E_GET_ENABLEINFINITETACTICSREFRESH_OFFSET UNITYSDK_OFFSET(0x1976AAA0)
#define CLASS_1_B04F5D5AA0C1364E_GET_IGNORECOLORDICECONDITIONCHECK_OFFSET UNITYSDK_OFFSET(0x1976AA80)
#define CLASS_1_B04F5D5AA0C1364E_SET_ENABLEINFINITETACTICSREFRESH_OFFSET UNITYSDK_OFFSET(0x1976AAB0)
#define CLASS_1_B04F5D5AA0C1364E_SET_IGNORECOLORDICECONDITIONCHECK_OFFSET UNITYSDK_OFFSET(0x1976AA90)
#define CLASS_1_B04F5D5AA0C1364E__CTOR_OFFSET UNITYSDK_OFFSET(0x1973DA90)
