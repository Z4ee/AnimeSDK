...
#define CLASS_2_E045D949642577E9_DISPOSE_OFFSET UNITYSDK_OFFSET(0x973C230)
#define CLASS_2_E045D949642577E9_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x973C270)
#define CLASS_2_E045D949642577E9_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x973C300)
#define CLASS_2_E045D949642577E9_TICK_OFFSET UNITYSDK_OFFSET(0x973C350)
#define CLASS_2_E045D949642577E9__CTOR_OFFSET UNITYSDK_OFFSET(0x973C220)

inline static constexpr unsigned int Class_2_E045D949642577E9_TypeDefinitionIndex = 53720;

class Class_2_E045D949642577E9 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::PauseGameModeToState* Field_2_0; // 0x18
