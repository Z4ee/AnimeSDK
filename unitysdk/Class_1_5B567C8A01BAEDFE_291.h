...
#define CLASS_1_5B567C8A01BAEDFE_291_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19FD6530)
#define CLASS_1_5B567C8A01BAEDFE_291_CLONE_OFFSET UNITYSDK_OFFSET(0x19FD63A0)
#define CLASS_1_5B567C8A01BAEDFE_291_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19FD6440)
#define CLASS_1_5B567C8A01BAEDFE_291_EQUALS_OFFSET UNITYSDK_OFFSET(0x19FD63E0)
#define CLASS_1_5B567C8A01BAEDFE_291_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19FD6490)
#define CLASS_1_5B567C8A01BAEDFE_291_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19FD6580)
#define CLASS_1_5B567C8A01BAEDFE_291_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19FD6550)
#define CLASS_1_5B567C8A01BAEDFE_291_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19FD6320)
#define CLASS_1_5B567C8A01BAEDFE_291_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19FD6350)
#define CLASS_1_5B567C8A01BAEDFE_291_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19FD64C0)
#define CLASS_1_5B567C8A01BAEDFE_291_WRITETO_OFFSET UNITYSDK_OFFSET(0x19FD6520)
#define CLASS_1_5B567C8A01BAEDFE_291__CCTOR_OFFSET UNITYSDK_OFFSET(0x19FD65D0)
#define CLASS_1_5B567C8A01BAEDFE_291__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19FD6370)
#define CLASS_1_5B567C8A01BAEDFE_291__CTOR_OFFSET UNITYSDK_OFFSET(0x19FD6360)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_291_TypeDefinitionIndex = 30977;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_291*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_291_TypeDefinitionIndex)->GetStaticField(0x25F90);
	}
