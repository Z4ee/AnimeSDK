...
#define CLASS_1_E5AFA09D8E02FD08_GET_STARTREASON_OFFSET UNITYSDK_OFFSET(0x15838630)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_057D664B08376234_OFFSET UNITYSDK_OFFSET(0x1583D360)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_08390806370BA43F_OFFSET UNITYSDK_OFFSET(0x1583E6E0)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_0C88AB06D46E777A_OFFSET UNITYSDK_OFFSET(0x1583B070)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_102A1038C38883F3_OFFSET UNITYSDK_OFFSET(0x15838C30)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_107FD70DCCEDAA2A_OFFSET UNITYSDK_OFFSET(0x1583AA60)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_183775EBED825945_OFFSET UNITYSDK_OFFSET(0x15838FA0)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_1C5E85EAB424AB24_OFFSET UNITYSDK_OFFSET(0x15838980)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x15839470)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_352C8D2911FBE3AB_OFFSET UNITYSDK_OFFSET(0x1583B410)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x15839520)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_539150C224ACEEBF_OFFSET UNITYSDK_OFFSET(0x15839130)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_5D6CD31BA2372F92_OFFSET UNITYSDK_OFFSET(0x15839270)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_6699C48D2240A7A2_OFFSET UNITYSDK_OFFSET(0x15839BD0)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_6BF485E2474856B0_OFFSET UNITYSDK_OFFSET(0x1583AEF0)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_7D21D8548943D577_OFFSET UNITYSDK_OFFSET(0x1583B910)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_8080E22F79F246F0_OFFSET UNITYSDK_OFFSET(0x158396F0)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_8279976FE67B5972_OFFSET UNITYSDK_OFFSET(0x1583A980)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_8542E37E74FDE1B5_OFFSET UNITYSDK_OFFSET(0x15838110)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_866242D8F6C828B4_OFFSET UNITYSDK_OFFSET(0x15838160)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_87CB8E735FBF02D2_OFFSET UNITYSDK_OFFSET(0x1583B870)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_923A37F9BA4FBD06_OFFSET UNITYSDK_OFFSET(0x15838650)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_A1ADC999CFACEB89_OFFSET UNITYSDK_OFFSET(0x158392D0)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_A871253BFD471C99_OFFSET UNITYSDK_OFFSET(0x15839580)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_AC31F425E7B1C1BA_OFFSET UNITYSDK_OFFSET(0x1583B2B0)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_B44A4F89D9CB9736_OFFSET UNITYSDK_OFFSET(0x15839DD0)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_BB8AD55CC76A6352_OFFSET UNITYSDK_OFFSET(0x1583CB00)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_C1A87A47FD383D5E_OFFSET UNITYSDK_OFFSET(0x15838D40)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_C923407A53F704A1_OFFSET UNITYSDK_OFFSET(0x15839B40)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_DEAC86EB2AD5D389_OFFSET UNITYSDK_OFFSET(0x1583B720)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_E5B2D19C36637166_OFFSET UNITYSDK_OFFSET(0x1583B260)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x15838C10)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_F0088C88851A7DFB_2_OFFSET UNITYSDK_OFFSET(0x15838C20)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x15838C00)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_F94BF46E59DB6B56_OFFSET UNITYSDK_OFFSET(0x1583BAA0)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_FA58824BA12F6F62_1_OFFSET UNITYSDK_OFFSET(0x15838BB0)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_FA58824BA12F6F62_OFFSET UNITYSDK_OFFSET(0x15838B60)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_FE72BF2F281C4FA8_OFFSET UNITYSDK_OFFSET(0x1583BA30)
#define CLASS_1_E5AFA09D8E02FD08_METHOD_1_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x158393C0)
#define CLASS_1_E5AFA09D8E02FD08_SET_STARTREASON_OFFSET UNITYSDK_OFFSET(0x15838640)
#define CLASS_1_E5AFA09D8E02FD08__CCTOR_OFFSET UNITYSDK_OFFSET(0x1583FD80)
#define CLASS_1_E5AFA09D8E02FD08__CTOR_OFFSET UNITYSDK_OFFSET(0x1583B380)
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E5AFA09D8E02FD08_TypeDefinitionIndex)->GetStaticField(0x63BA0);
	}
	static ::System::String** StaticGet_LIIAFGOKDHA()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E5AFA09D8E02FD08_TypeDefinitionIndex)->GetStaticField(0x63BA8);
	}
	static ::System::String** StaticGet_OCMLGADHCIB()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E5AFA09D8E02FD08_TypeDefinitionIndex)->GetStaticField(0x63BB0);
	}
	static ::System::String** StaticGet_DJMKFFDOEFN()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E5AFA09D8E02FD08_TypeDefinitionIndex)->GetStaticField(0x63BB8);
	}
	static ::System::Boolean* StaticGet_GBBJIEBFPNI()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_1_E5AFA09D8E02FD08_TypeDefinitionIndex)->GetStaticField(0x147E0);
	}
	::Class_1_3DF80F278B6BDF72* NLACHFOEKDJ; // 0x10
	::Il2CppArray<::System::String*>* FPDCLGJAHEI; // 0x18
	::WarmupSVC* FCGOEOAINJP; // 0x20
	::System::Collections::Generic::List_1<::System::String*>* IHLINCHNNHC; // 0x28
	::Il2CppArray<::UnityEngine::Rendering::VertexAttributeDescriptor>* DCFHEBILJLK; // 0x30
	::System::Collections::Generic::List_1<::UnityEngine::Shader*>* JOANNGLOFPM; // 0x38
	::System::Int32 ADNDFBCPABH; // 0x40
	::System::Boolean KKCFCJFAAKA; // 0x44
	::System::Int32 AKJDODFEAMG; // 0x48
	::System::Boolean ODCLJGLPFNN; // 0x4C
	::System::Boolean KCALMLKOMFC; // 0x4D
	::System::Boolean KLLLAHLPMNB; // 0x4E
	::System::Boolean DFNKJIJNJEM; // 0x4F
