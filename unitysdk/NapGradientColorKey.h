...
#define NAPGRADIENTCOLORKEY_COMPARETO_OFFSET UNITYSDK_OFFSET(0x5CC8E0)
#define NAPGRADIENTCOLORKEY_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0xD957B50)
#define NAPGRADIENTCOLORKEY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x5CC8C0)
#define NAPGRADIENTCOLORKEY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x5CC8C0)
#define NAPGRADIENTCOLORKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x3A5230)

inline static constexpr unsigned int NapGradientColorKey_TypeDefinitionIndex = 51749;
