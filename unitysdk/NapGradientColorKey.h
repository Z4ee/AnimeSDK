...
#define NAPGRADIENTCOLORKEY_COMPARETO_OFFSET UNITYSDK_OFFSET(0x875110)
#define NAPGRADIENTCOLORKEY_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x17CC9930)
#define NAPGRADIENTCOLORKEY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8750F0)
#define NAPGRADIENTCOLORKEY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x8750F0)
#define NAPGRADIENTCOLORKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x37F040)

inline static constexpr unsigned int NapGradientColorKey_TypeDefinitionIndex = 42476;
