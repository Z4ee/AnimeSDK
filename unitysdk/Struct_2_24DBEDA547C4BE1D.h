...
inline static constexpr unsigned int Struct_2_24DBEDA547C4BE1D_TypeDefinitionIndex = 73011;

struct alignas(8) Struct_2_24DBEDA547C4BE1D
{
	::MoleMole::MonoEffectContrllerModule::MonoEffectPluginController_Class_1_E5308BE9EEBA8B55* Field_2_3; // 0x10
