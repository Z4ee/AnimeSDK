...
#define ENVIRONMENTCONFIGV2_DEEPCLONE_OFFSET UNITYSDK_OFFSET(0x19274B90)
#define ENVIRONMENTCONFIGV2_READFROMVOLUME_OFFSET UNITYSDK_OFFSET(0x19274AE0)
#define ENVIRONMENTCONFIGV2_WRITETOVOLUME_OFFSET UNITYSDK_OFFSET(0x19274DD0)
#define ENVIRONMENTCONFIGV2__CTOR_OFFSET UNITYSDK_OFFSET(0x19274A70)

inline static constexpr unsigned int EnvironmentConfigV2_TypeDefinitionIndex = 29459;
