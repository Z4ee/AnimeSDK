...
#define ENVIRONMENTCONFIGV2_DEEPCLONE_OFFSET UNITYSDK_OFFSET(0x1C59FD60)
#define ENVIRONMENTCONFIGV2_READFROMVOLUME_OFFSET UNITYSDK_OFFSET(0x1C59FCB0)
#define ENVIRONMENTCONFIGV2_WRITETOVOLUME_OFFSET UNITYSDK_OFFSET(0x1C59FFA0)
#define ENVIRONMENTCONFIGV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1C59FC40)

inline static constexpr unsigned int EnvironmentConfigV2_TypeDefinitionIndex = 27927;
