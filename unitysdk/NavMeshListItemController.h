...
#define NAVMESHLISTITEMCONTROLLER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x11D995F0)
#define NAVMESHLISTITEMCONTROLLER_ONNAMECHANGED_OFFSET UNITYSDK_OFFSET(0x11D99D10)
#define NAVMESHLISTITEMCONTROLLER_ONNAVMESHDATADROPPED_OFFSET UNITYSDK_OFFSET(0x11D99E80)
#define NAVMESHLISTITEMCONTROLLER_ONREMOVECLICKED_OFFSET UNITYSDK_OFFSET(0x11D99E30)
#define NAVMESHLISTITEMCONTROLLER_ONTOGGLECHANGED_OFFSET UNITYSDK_OFFSET(0x11D99DA0)
#define NAVMESHLISTITEMCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11D9A030)

inline static constexpr unsigned int NavMeshListItemController_TypeDefinitionIndex = 72063;
