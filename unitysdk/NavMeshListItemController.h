...
#define NAVMESHLISTITEMCONTROLLER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x113743C0)
#define NAVMESHLISTITEMCONTROLLER_ONNAMECHANGED_OFFSET UNITYSDK_OFFSET(0x11374AF0)
#define NAVMESHLISTITEMCONTROLLER_ONNAVMESHDATADROPPED_OFFSET UNITYSDK_OFFSET(0x11374C60)
#define NAVMESHLISTITEMCONTROLLER_ONREMOVECLICKED_OFFSET UNITYSDK_OFFSET(0x11374C10)
#define NAVMESHLISTITEMCONTROLLER_ONTOGGLECHANGED_OFFSET UNITYSDK_OFFSET(0x11374B80)
#define NAVMESHLISTITEMCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11374E10)

inline static constexpr unsigned int NavMeshListItemController_TypeDefinitionIndex = 82142;
