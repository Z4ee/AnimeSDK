...
#define HIPPLENBUILDERSTATUS___C__BUFFTIMEPASS_B__8_0_OFFSET UNITYSDK_OFFSET(0x15ADD4C0)
#define HIPPLENBUILDERSTATUS___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x15ADD470)
#define HIPPLENBUILDERSTATUS___C__CTOR_OFFSET UNITYSDK_OFFSET(0x15ADD4B0)
...
public:
	...
	{
		return (::HipplenBuilderStatus___c**)Il2CppClass::FromTypeDefinitionIndex(HipplenBuilderStatus___c_TypeDefinitionIndex)->GetStaticField(0x60D00);
	}
	static ::System::Predicate_1<::HipplenBuilderStatus_Class_1_FF08BBE63201ECB5*>** StaticGet___9__8_0()
	{
		return (::System::Predicate_1<::HipplenBuilderStatus_Class_1_FF08BBE63201ECB5*>**)Il2CppClass::FromTypeDefinitionIndex(HipplenBuilderStatus___c_TypeDefinitionIndex)->GetStaticField(0x60D08);
	}
