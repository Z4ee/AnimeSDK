...
#define CLASS_3_AA449FD9DEDB7919_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xC7D3C30)
#define CLASS_3_AA449FD9DEDB7919_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xC7D3C60)
#define CLASS_3_AA449FD9DEDB7919_INVOKE_OFFSET UNITYSDK_OFFSET(0xC7D3C20)
#define CLASS_3_AA449FD9DEDB7919__CTOR_OFFSET UNITYSDK_OFFSET(0xC7D3B30)

inline static constexpr unsigned int Class_3_AA449FD9DEDB7919_TypeDefinitionIndex = 73975;
