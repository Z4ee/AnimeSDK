...
#define CLASS_2_D17EECB7F4215805_METHOD_2_0A0F16311F960C37_OFFSET UNITYSDK_OFFSET(0x1520A9C0)
#define CLASS_2_D17EECB7F4215805_METHOD_2_0CC4BC19C602BCD0_1_OFFSET UNITYSDK_OFFSET(0x1520AF90)
#define CLASS_2_D17EECB7F4215805_METHOD_2_0CC4BC19C602BCD0_OFFSET UNITYSDK_OFFSET(0x1520AF40)
#define CLASS_2_D17EECB7F4215805_METHOD_2_3422201382CE593B_OFFSET UNITYSDK_OFFSET(0x1520A700)
#define CLASS_2_D17EECB7F4215805_METHOD_2_5D0BCFABEB41AF6A_OFFSET UNITYSDK_OFFSET(0x15209D50)
#define CLASS_2_D17EECB7F4215805_METHOD_2_6BD820E2AD04F003_OFFSET UNITYSDK_OFFSET(0x15209750)
#define CLASS_2_D17EECB7F4215805_METHOD_2_A3C36642AA77866E_OFFSET UNITYSDK_OFFSET(0x15209A20)
#define CLASS_2_D17EECB7F4215805_METHOD_2_BABE6D163A0ED793_OFFSET UNITYSDK_OFFSET(0x1520A7E0)
#define CLASS_2_D17EECB7F4215805_METHOD_2_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0x1520AD70)
#define CLASS_2_D17EECB7F4215805__CTOR_OFFSET UNITYSDK_OFFSET(0x152096D0)

inline static constexpr unsigned int Class_2_D17EECB7F4215805_TypeDefinitionIndex = 60301;

class Class_2_D17EECB7F4215805 : public ::Class_1_422F2D395BEF4FA5
{
public:
	::System::UInt32 KDNDHMNNDAH; // 0xD8
	::System::Single FANEHJNKNOK; // 0xDC
	::System::UInt32 CNJJGGAJFJE; // 0xE0
	::System::UInt32 GNNPKPBFAPB; // 0xE4
	::System::UInt32 GNJFPJGIEOH; // 0xE8
	::System::Single BACBMLFMCPB; // 0xEC
	::System::Single GCGGPMBHDHA; // 0xF0
	::System::Single BJPICNDLGGD; // 0xF4
	::System::Int32 KBDPMBDJIOF; // 0xF8
