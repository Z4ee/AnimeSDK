...
#define CLASS_2_FE2B603B9E4C6CF2_2_GET_BP_OFFSET UNITYSDK_OFFSET(0x17DBCD20)
#define CLASS_2_FE2B603B9E4C6CF2_2_GET_DAMAGECOUNTER_OFFSET UNITYSDK_OFFSET(0x17DBCD00)
#define CLASS_2_FE2B603B9E4C6CF2_2_METHOD_2_7991C72AB7DF1C9E_OFFSET UNITYSDK_OFFSET(0x17DBCB90)
#define CLASS_2_FE2B603B9E4C6CF2_2_SET_BP_OFFSET UNITYSDK_OFFSET(0x17DBCD30)
#define CLASS_2_FE2B603B9E4C6CF2_2_SET_DAMAGECOUNTER_OFFSET UNITYSDK_OFFSET(0x17DBCD10)
#define CLASS_2_FE2B603B9E4C6CF2_2__CTOR_OFFSET UNITYSDK_OFFSET(0x17DBCC60)

inline static constexpr unsigned int Class_2_FE2B603B9E4C6CF2_2_TypeDefinitionIndex = 56368;

class Class_2_FE2B603B9E4C6CF2_2 : public ::Class_1_7AAAC9B25C84E6E4
{
public:
	::System::Int32 _BP_k__BackingField; // 0x10
