...
#define CLASS_3_5927E3FC05B75928_METHOD_3_E024E0080A08A9C9_OFFSET UNITYSDK_OFFSET(0x1D1E21F0)
#define CLASS_3_5927E3FC05B75928_METHOD_3_FF096862EF90B096_OFFSET UNITYSDK_OFFSET(0x1D1E2150)
#define CLASS_3_5927E3FC05B75928__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1E21B0)
...
{
public:
	::RPG::GameCore::TargetEvaluator* IDFDJPPLHFE; // 0x18
	::RPG::GameCore::TargetEvaluator* EDLFMHHFEBO; // 0x20
	::RPG::GameCore::TargetEvaluator* HILNFHCPEAD; // 0x28
	::RPG::GameCore::TargetEvaluator* ABAPJDNAJBN; // 0x30
	::RPG::GameCore::DynamicString* FHLJGDGMMHK; // 0x38
	::RPG::GameCore::DynamicFloat* IDKONBFPBLH; // 0x40
