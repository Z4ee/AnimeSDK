...
#define CLASS_1_828B93627FACA5C2_1_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17CAFED0)
#define CLASS_1_828B93627FACA5C2_1_CLONE_OFFSET UNITYSDK_OFFSET(0x17CAF9F0)
#define CLASS_1_828B93627FACA5C2_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17CAFAB0)
#define CLASS_1_828B93627FACA5C2_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x17CAFA80)
#define CLASS_1_828B93627FACA5C2_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17CAFB70)
#define CLASS_1_828B93627FACA5C2_1_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17CB0080)
#define CLASS_1_828B93627FACA5C2_1_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17CB0010)
#define CLASS_1_828B93627FACA5C2_1_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x17CAFA50)
#define CLASS_1_828B93627FACA5C2_1_METHOD_1_554199E0076172C5_1_OFFSET UNITYSDK_OFFSET(0x17CAFA70)
#define CLASS_1_828B93627FACA5C2_1_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x17CAFA40)
#define CLASS_1_828B93627FACA5C2_1_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x17CAFA60)
#define CLASS_1_828B93627FACA5C2_1_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x17CAFA30)
#define CLASS_1_828B93627FACA5C2_1_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x17CAFA20)
#define CLASS_1_828B93627FACA5C2_1_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17CAF860)
#define CLASS_1_828B93627FACA5C2_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17CAFD50)
#define CLASS_1_828B93627FACA5C2_1_WRITETO_OFFSET UNITYSDK_OFFSET(0x17CAFDB0)
#define CLASS_1_828B93627FACA5C2_1__CCTOR_OFFSET UNITYSDK_OFFSET(0x17CB01B0)
#define CLASS_1_828B93627FACA5C2_1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17CAF900)
#define CLASS_1_828B93627FACA5C2_1__CTOR_OFFSET UNITYSDK_OFFSET(0x17CAF870)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_828B93627FACA5C2_1_TypeDefinitionIndex)->GetStaticField(0x6720);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_4()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_828B93627FACA5C2_1_TypeDefinitionIndex)->GetStaticField(0x6728);
	}
