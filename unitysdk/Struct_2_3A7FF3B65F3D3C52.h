...
#define STRUCT_2_3A7FF3B65F3D3C52_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x92CE60)
#define STRUCT_2_3A7FF3B65F3D3C52_EQUALS_OFFSET UNITYSDK_OFFSET(0x92CE10)
#define STRUCT_2_3A7FF3B65F3D3C52_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x92CE70)
#define STRUCT_2_3A7FF3B65F3D3C52_METHOD_2_6D0360BD23602584_OFFSET UNITYSDK_OFFSET(0x92CF20)
#define STRUCT_2_3A7FF3B65F3D3C52_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x92CEC0)
#define STRUCT_2_3A7FF3B65F3D3C52__CTOR_OFFSET UNITYSDK_OFFSET(0x2ACBF0)

inline static constexpr unsigned int Struct_2_3A7FF3B65F3D3C52_TypeDefinitionIndex = 88550;
