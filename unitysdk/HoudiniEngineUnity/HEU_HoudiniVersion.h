...
#define HOUDINIENGINEUNITY_HEU_HOUDINIVERSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B42A2F0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_HoudiniVersion_TypeDefinitionIndex = 39228;
