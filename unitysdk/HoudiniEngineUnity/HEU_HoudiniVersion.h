...
#define HOUDINIENGINEUNITY_HEU_HOUDINIVERSION__CTOR_OFFSET UNITYSDK_OFFSET(0x845C570)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_HoudiniVersion_TypeDefinitionIndex = 37740;
