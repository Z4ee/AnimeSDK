...
#define HOUDINIENGINEUNITY_TEST_COLLIDER_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x1B4ADF80)
#define HOUDINIENGINEUNITY_TEST_COLLIDER_ISNULL_OFFSET UNITYSDK_OFFSET(0x1B4ADF60)
#define HOUDINIENGINEUNITY_TEST_COLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4ADF50)
