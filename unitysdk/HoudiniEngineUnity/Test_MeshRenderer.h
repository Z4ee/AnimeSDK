...
#define HOUDINIENGINEUNITY_TEST_MESHRENDERER_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x17F82A70)
#define HOUDINIENGINEUNITY_TEST_MESHRENDERER_ISNULL_OFFSET UNITYSDK_OFFSET(0x17F82A50)
#define HOUDINIENGINEUNITY_TEST_MESHRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x17F82A40)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_MeshRenderer_TypeDefinitionIndex = 37773;
