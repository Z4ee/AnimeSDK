...
#define HOUDINIENGINEUNITY_HEU_INPUTHDAINFO_COPYTO_OFFSET UNITYSDK_OFFSET(0x17F06DF0)
#define HOUDINIENGINEUNITY_HEU_INPUTHDAINFO_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x17F06E20)
#define HOUDINIENGINEUNITY_HEU_INPUTHDAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17F06F90)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_InputHDAInfo_TypeDefinitionIndex = 37444;
