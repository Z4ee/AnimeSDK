...
#define HOUDINIENGINEUNITY_HEU_INPUTHDAINFO_COPYTO_OFFSET UNITYSDK_OFFSET(0x1086B2A0)
#define HOUDINIENGINEUNITY_HEU_INPUTHDAINFO_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x1086B2D0)
#define HOUDINIENGINEUNITY_HEU_INPUTHDAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1086B440)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_InputHDAInfo_TypeDefinitionIndex = 38252;
