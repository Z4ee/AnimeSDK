...
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_HEU_LOADDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8CC5F40)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_ThreadedTaskLoadGeo_HEU_LoadData_TypeDefinitionIndex = 43675;

	class HEU_ThreadedTaskLoadGeo_HEU_LoadData : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_ThreadedTaskLoadGeo_HEU_LoadObject*>* _loadedObjects; // 0x10
		...
		::HoudiniEngineUnity::HEU_SessionBase* _session; // 0x28
