...
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_HEU_LOADDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x849DB90)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_ThreadedTaskLoadGeo_HEU_LoadData_TypeDefinitionIndex = 37798;
