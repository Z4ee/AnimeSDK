...
#define HOUDINIENGINEUNITY_TEST_LODGROUP_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x17F80BF0)
#define HOUDINIENGINEUNITY_TEST_LODGROUP_ISNULL_OFFSET UNITYSDK_OFFSET(0x17F80BD0)
#define HOUDINIENGINEUNITY_TEST_LODGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x17F80BC0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_LODGroup_TypeDefinitionIndex = 37746;
