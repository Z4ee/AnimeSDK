...
#define HOUDINIENGINEUNITY_TEST_LODGROUP_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x1D20CED0)
#define HOUDINIENGINEUNITY_TEST_LODGROUP_ISNULL_OFFSET UNITYSDK_OFFSET(0x1D20CEB0)
#define HOUDINIENGINEUNITY_TEST_LODGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D20CEA0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_LODGroup_TypeDefinitionIndex = 38554;
