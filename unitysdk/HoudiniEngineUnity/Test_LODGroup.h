...
#define HOUDINIENGINEUNITY_TEST_LODGROUP_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x1EEED070)
#define HOUDINIENGINEUNITY_TEST_LODGROUP_ISNULL_OFFSET UNITYSDK_OFFSET(0x1EEED050)
#define HOUDINIENGINEUNITY_TEST_LODGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEED040)
