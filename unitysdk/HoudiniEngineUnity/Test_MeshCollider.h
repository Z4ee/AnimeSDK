...
#define HOUDINIENGINEUNITY_TEST_MESHCOLLIDER_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x17F82050)
#define HOUDINIENGINEUNITY_TEST_MESHCOLLIDER_ISNULL_OFFSET UNITYSDK_OFFSET(0x17F82030)
#define HOUDINIENGINEUNITY_TEST_MESHCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x17F82020)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_MeshCollider_TypeDefinitionIndex = 37767;
