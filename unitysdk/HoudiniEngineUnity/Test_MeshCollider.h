...
#define HOUDINIENGINEUNITY_TEST_MESHCOLLIDER_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x1EEEE4D0)
#define HOUDINIENGINEUNITY_TEST_MESHCOLLIDER_ISNULL_OFFSET UNITYSDK_OFFSET(0x1EEEE4B0)
#define HOUDINIENGINEUNITY_TEST_MESHCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEEE4A0)
