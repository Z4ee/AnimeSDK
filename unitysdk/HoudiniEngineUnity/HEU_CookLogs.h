...
#define HOUDINIENGINEUNITY_HEU_COOKLOGS_APPENDCOOKLOG_OFFSET UNITYSDK_OFFSET(0x167CED40)
#define HOUDINIENGINEUNITY_HEU_COOKLOGS_CLEARCOOKLOG_OFFSET UNITYSDK_OFFSET(0x167CF240)
#define HOUDINIENGINEUNITY_HEU_COOKLOGS_DELETECOOKINGFILE_OFFSET UNITYSDK_OFFSET(0x167CF370)
#define HOUDINIENGINEUNITY_HEU_COOKLOGS_GETCOOKLOGFILEPATH_OFFSET UNITYSDK_OFFSET(0x167CF2C0)
#define HOUDINIENGINEUNITY_HEU_COOKLOGS_GETCOOKLOGSTRING_OFFSET UNITYSDK_OFFSET(0x167CED20)
#define HOUDINIENGINEUNITY_HEU_COOKLOGS_GETFILESIZEOFLOGFILE_OFFSET UNITYSDK_OFFSET(0x167CF5F0)
#define HOUDINIENGINEUNITY_HEU_COOKLOGS_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x167CEB90)
#define HOUDINIENGINEUNITY_HEU_COOKLOGS_WRITETOLOGFILE_OFFSET UNITYSDK_OFFSET(0x167CEF70)
#define HOUDINIENGINEUNITY_HEU_COOKLOGS__CTOR_OFFSET UNITYSDK_OFFSET(0x167CEC90)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_CookLogs_TypeDefinitionIndex = 39323;
	...
	public:
		...
		{
			return (::HoudiniEngineUnity::HEU_CookLogs**)Il2CppClass::FromTypeDefinitionIndex(HEU_CookLogs_TypeDefinitionIndex)->GetStaticField(0x47E30);
		}
		...
		::System::Int32 _currentCookLogCount; // 0x20
		::System::Boolean _uniqueStrOnly; // 0x24
