...
#define HOUDINIENGINEUNITY_HEU_COOKLOGS_APPENDCOOKLOG_OFFSET UNITYSDK_OFFSET(0x17EB4FA0)
#define HOUDINIENGINEUNITY_HEU_COOKLOGS_CLEARCOOKLOG_OFFSET UNITYSDK_OFFSET(0x17EB5530)
#define HOUDINIENGINEUNITY_HEU_COOKLOGS_DELETECOOKINGFILE_OFFSET UNITYSDK_OFFSET(0x17EB5660)
#define HOUDINIENGINEUNITY_HEU_COOKLOGS_GETCOOKLOGFILEPATH_OFFSET UNITYSDK_OFFSET(0x17EB55B0)
#define HOUDINIENGINEUNITY_HEU_COOKLOGS_GETCOOKLOGSTRING_OFFSET UNITYSDK_OFFSET(0x17EB4F80)
#define HOUDINIENGINEUNITY_HEU_COOKLOGS_GETFILESIZEOFLOGFILE_OFFSET UNITYSDK_OFFSET(0x17EB58D0)
#define HOUDINIENGINEUNITY_HEU_COOKLOGS_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x17EB4E00)
#define HOUDINIENGINEUNITY_HEU_COOKLOGS_WRITETOLOGFILE_OFFSET UNITYSDK_OFFSET(0x17EB51D0)
#define HOUDINIENGINEUNITY_HEU_COOKLOGS__CTOR_OFFSET UNITYSDK_OFFSET(0x17EB4EF0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_CookLogs_TypeDefinitionIndex = 37656;
	...
	public:
		...
		{
			return (::HoudiniEngineUnity::HEU_CookLogs**)Il2CppClass::FromTypeDefinitionIndex(HEU_CookLogs_TypeDefinitionIndex)->GetStaticField(0xA130);
		}
		// static const ::System::Int32 MAX_COOK_LOG_COUNT = 0x2329; // 0x0
		// static const ::System::Int64 MaxLogSize = 0x2FAF080; // 0x0
		::System::String* _lastLogStr; // 0x10
