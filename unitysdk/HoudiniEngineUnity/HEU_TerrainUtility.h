...
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_APPENDCONVERTEDHEIGHTFIELDTOALPHAMAP_OFFSET UNITYSDK_OFFSET(0x1B1569A0)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_APPLYDETAILLAYERS_OFFSET UNITYSDK_OFFSET(0x1B159C20)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_APPLYSCATTERTREES_OFFSET UNITYSDK_OFFSET(0x1B158D40)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_CONVERTHEIGHTFIELDTOALPHAMAP_OFFSET UNITYSDK_OFFSET(0x1B1567C0)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_CONVERTHEIGHTMAPHOUDINITOUNITY_OFFSET UNITYSDK_OFFSET(0x1B155DB0)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_GENERATETERRAINFROMVOLUME_OFFSET UNITYSDK_OFFSET(0x1B1541D0)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_GETATTRIBUTETILE_OFFSET UNITYSDK_OFFSET(0x1B15A7E0)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_GETDEFAULTTERRAINMATERIALPATH_OFFSET UNITYSDK_OFFSET(0x1B155F30)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_GETDEFAULTTERRAINSHADERNAME_OFFSET UNITYSDK_OFFSET(0x1B155EB0)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_GETDETAILMAPFROMPART_OFFSET UNITYSDK_OFFSET(0x1B1562C0)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_GETHEIGHTFIELDLAYERTYPE_OFFSET UNITYSDK_OFFSET(0x1B15A580)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_GETHEIGHTMAPFROMPART_OFFSET UNITYSDK_OFFSET(0x1B155FB0)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_GETHEIGHTRANGEFROMHEIGHTFIELD_OFFSET UNITYSDK_OFFSET(0x1B156260)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_GETNORMALIZEDHEIGHTMAPFROMPARTWITHMINMAX_OFFSET UNITYSDK_OFFSET(0x1B1552C0)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_GETTERRAINDATAEXPORTPATHFROMHEIGHTFIELDATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1B15A730)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_GETTERRAINLAYERINDEXBYNAME_OFFSET UNITYSDK_OFFSET(0x1B15A180)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_GETTERRAINLAYERINDEX_OFFSET UNITYSDK_OFFSET(0x1B15A2B0)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_GETTREEPROTOTYPEINFOSFROMPART_OFFSET UNITYSDK_OFFSET(0x1B156EC0)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_GETVOLUMEPOSITIONOFFSET_OFFSET UNITYSDK_OFFSET(0x1B156CA0)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_POPULATEDETAILPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B159560)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_POPULATEDETAILPROTOTYPE_OFFSET UNITYSDK_OFFSET(0x1B1591C0)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_POPULATESCATTERTREES_OFFSET UNITYSDK_OFFSET(0x1B1571C0)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_RESAMPLEDATA_OFFSET UNITYSDK_OFFSET(0x1B155AE0)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_SETTERRAINMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B155010)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_VOLUMELAYERHASATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1B15A350)
