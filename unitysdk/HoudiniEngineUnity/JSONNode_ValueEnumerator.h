...
#define HOUDINIENGINEUNITY_JSONNODE_VALUEENUMERATOR_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1360)
#define HOUDINIENGINEUNITY_JSONNODE_VALUEENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x13B0)
#define HOUDINIENGINEUNITY_JSONNODE_VALUEENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x2D4C180)
...
{
	inline static constexpr unsigned int JSONNode_ValueEnumerator_TypeDefinitionIndex = 37707;
