...
#define HOUDINIENGINEUNITY_JSONNODE_VALUEENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x274E0)
...
{
	inline static constexpr unsigned int JSONNode_ValueEnumerator_TypeDefinitionIndex = 37843;
