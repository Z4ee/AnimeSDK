...
#define HOUDINIENGINEUNITY_HEU_RELOADEVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8CB3920)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_ReloadEventData_TypeDefinitionIndex = 43468;
