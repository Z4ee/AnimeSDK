...
#define HOUDINIENGINEUNITY_HEU_RELOADEVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17F51D10)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_ReloadEventData_TypeDefinitionIndex = 37393;
