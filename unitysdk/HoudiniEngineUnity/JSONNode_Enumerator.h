...
#define HOUDINIENGINEUNITY_JSONNODE_ENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x3A33950)
#define HOUDINIENGINEUNITY_JSONNODE_ENUMERATOR_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0xC2F770)
#define HOUDINIENGINEUNITY_JSONNODE_ENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3AF7A90)
#define HOUDINIENGINEUNITY_JSONNODE_ENUMERATOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x397B570)
#define HOUDINIENGINEUNITY_JSONNODE_ENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x397B520)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int JSONNode_Enumerator_TypeDefinitionIndex = 38513;
