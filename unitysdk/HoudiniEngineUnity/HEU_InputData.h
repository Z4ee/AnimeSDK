...
#define HOUDINIENGINEUNITY_HEU_INPUTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x845C590)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_InputData_TypeDefinitionIndex = 37822;
