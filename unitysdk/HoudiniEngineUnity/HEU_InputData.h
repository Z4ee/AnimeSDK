...
#define HOUDINIENGINEUNITY_HEU_INPUTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8C846D0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_InputData_TypeDefinitionIndex = 43699;
