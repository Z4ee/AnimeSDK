...
#define HOUDINIENGINEUNITY_HEU_VERTEXENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x17F6DE30)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_VertexEntry_TypeDefinitionIndex = 37676;
