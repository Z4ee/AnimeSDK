...
#define HOUDINIENGINEUNITY_HEU_GEOGROUP_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1B3F5980)
#define HOUDINIENGINEUNITY_HEU_GEOGROUP_SETUPNORMALINDICES_OFFSET UNITYSDK_OFFSET(0x1B3F21F0)
#define HOUDINIENGINEUNITY_HEU_GEOGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3F2160)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_GeoGroup_TypeDefinitionIndex = 39342;
