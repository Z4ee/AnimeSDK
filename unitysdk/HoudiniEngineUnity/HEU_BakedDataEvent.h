...
#define HOUDINIENGINEUNITY_HEU_BAKEDDATAEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x15013DD0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_BakedDataEvent_TypeDefinitionIndex = 38207;
