...
#define HOUDINIENGINEUNITY_HEU_BAKEDDATAEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3CCEC0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_BakedDataEvent_TypeDefinitionIndex = 39066;
