...
#define HOUDINIENGINEUNITY_TEST_TERRAINDATA_EXTENSIONS_TOTESTOBJECT_1_OFFSET UNITYSDK_OFFSET(0x17F84310)
#define HOUDINIENGINEUNITY_TEST_TERRAINDATA_EXTENSIONS_TOTESTOBJECT_2_OFFSET UNITYSDK_OFFSET(0x17F84430)
#define HOUDINIENGINEUNITY_TEST_TERRAINDATA_EXTENSIONS_TOTESTOBJECT_OFFSET UNITYSDK_OFFSET(0x17F838E0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_TerrainData_Extensions_TypeDefinitionIndex = 37797;
