...
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_HEU_LOADOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x197D7DA0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_ThreadedTaskLoadGeo_HEU_LoadObject_TypeDefinitionIndex = 38461;
	...
	public:
		...
		::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_LoadBufferMesh*>* _meshBuffers; // 0x18
