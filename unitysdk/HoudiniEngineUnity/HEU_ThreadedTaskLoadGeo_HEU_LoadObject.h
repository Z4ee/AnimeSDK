...
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_HEU_LOADOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x8CC6E10)
...
namespace HoudiniEngineUnity
{
	...
	{
	public:
		::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_LoadBufferInstancer*>* _instancerBuffers; // 0x10
