...
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_HEU_LOADOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4917E0)
...
namespace HoudiniEngineUnity
{
	...
	{
	public:
		::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_LoadBufferVolume*>* _terrainBuffers; // 0x10
		::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_LoadBufferInstancer*>* _instancerBuffers; // 0x18
		::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_LoadBufferMesh*>* _meshBuffers; // 0x20
		::System::Int32 _objectNodeID; // 0x28
		::System::Int32 _displayNodeID; // 0x2C
