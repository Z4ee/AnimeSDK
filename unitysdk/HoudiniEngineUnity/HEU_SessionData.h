...
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GETORCREATESESSIONSYNC_OFFSET UNITYSDK_OFFSET(0x1B1486F0)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GETSESSIONSYNC_OFFSET UNITYSDK_OFFSET(0x1B148920)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_ISDEFAULTSESSION_OFFSET UNITYSDK_OFFSET(0x1B148BA0)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1B1489E0)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_ISSESSIONSYNC_OFFSET UNITYSDK_OFFSET(0x1B147270)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_ISVALIDSESSIONID_OFFSET UNITYSDK_OFFSET(0x1B148A00)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_PIPENAME_OFFSET UNITYSDK_OFFSET(0x1B148A10)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_PORT_OFFSET UNITYSDK_OFFSET(0x1B148A30)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_PROCESSID_OFFSET UNITYSDK_OFFSET(0x1B1489A0)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_SESSIONCLASSTYPE_OFFSET UNITYSDK_OFFSET(0x1B148AB0)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_SESSIONID_OFFSET UNITYSDK_OFFSET(0x1B148940)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_SESSIONTYPE_OFFSET UNITYSDK_OFFSET(0x1B1489C0)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_SHAREDMEMORYBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x1B148A90)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_SHAREDMEMORYBUFFERTYPE_OFFSET UNITYSDK_OFFSET(0x1B148A70)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_SHAREDMEMORYNAME_OFFSET UNITYSDK_OFFSET(0x1B148A50)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_THISCONNECTIONMODE_OFFSET UNITYSDK_OFFSET(0x1B148BC0)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_THISSESSIONMODE_OFFSET UNITYSDK_OFFSET(0x1B148BE0)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_SETSESSIONSYNC_OFFSET UNITYSDK_OFFSET(0x1B148930)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_SET_ISDEFAULTSESSION_OFFSET UNITYSDK_OFFSET(0x1B148BB0)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_SET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1B1489F0)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_SET_PIPENAME_OFFSET UNITYSDK_OFFSET(0x1B148A20)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_SET_PORT_OFFSET UNITYSDK_OFFSET(0x1B148A40)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_SET_PROCESSID_OFFSET UNITYSDK_OFFSET(0x1B1489B0)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_SET_SESSIONCLASSTYPE_OFFSET UNITYSDK_OFFSET(0x1B148B00)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_SET_SESSIONID_OFFSET UNITYSDK_OFFSET(0x1B147A30)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_SET_SESSIONTYPE_OFFSET UNITYSDK_OFFSET(0x1B1489D0)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_SET_SHAREDMEMORYBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x1B148AA0)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_SET_SHAREDMEMORYBUFFERTYPE_OFFSET UNITYSDK_OFFSET(0x1B148A80)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_SET_SHAREDMEMORYNAME_OFFSET UNITYSDK_OFFSET(0x1B148A60)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_SET_THISCONNECTIONMODE_OFFSET UNITYSDK_OFFSET(0x1B148BD0)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_SET_THISSESSIONMODE_OFFSET UNITYSDK_OFFSET(0x1B148BF0)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B148C10)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B148C00)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_SessionData_TypeDefinitionIndex = 39288;
	...
	public:
		...
		{
			return (::System::Int64*)Il2CppClass::FromTypeDefinitionIndex(HEU_SessionData_TypeDefinitionIndex)->GetStaticField(0x10610);
		}
