...
#define HOUDINIENGINEUNITY_TEST_ANIMATIONCURVE_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x1EEE9A80)
#define HOUDINIENGINEUNITY_TEST_ANIMATIONCURVE_ISNULL_OFFSET UNITYSDK_OFFSET(0x1EEE9A70)
#define HOUDINIENGINEUNITY_TEST_ANIMATIONCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEE9A60)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_AnimationCurve_TypeDefinitionIndex = 39451;
