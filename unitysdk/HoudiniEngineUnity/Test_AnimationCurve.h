...
#define HOUDINIENGINEUNITY_TEST_ANIMATIONCURVE_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x1D2098F0)
#define HOUDINIENGINEUNITY_TEST_ANIMATIONCURVE_ISNULL_OFFSET UNITYSDK_OFFSET(0x1D2098E0)
#define HOUDINIENGINEUNITY_TEST_ANIMATIONCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2098D0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_AnimationCurve_TypeDefinitionIndex = 38592;
