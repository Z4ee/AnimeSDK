...
#define HOUDINIENGINEUNITY_HEU_TOPNODEDATA_ANYWORKITEMSFAILED_OFFSET UNITYSDK_OFFSET(0x8CBE370)
#define HOUDINIENGINEUNITY_HEU_TOPNODEDATA_ANYWORKITEMSPENDING_OFFSET UNITYSDK_OFFSET(0x8CBE3A0)
#define HOUDINIENGINEUNITY_HEU_TOPNODEDATA_AREALLWORKITEMSCOMPLETE_OFFSET UNITYSDK_OFFSET(0x8CBE300)
#define HOUDINIENGINEUNITY_HEU_TOPNODEDATA_RESET_OFFSET UNITYSDK_OFFSET(0x8CBE2C0)
#define HOUDINIENGINEUNITY_HEU_TOPNODEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8CBE400)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_TOPNodeData_TypeDefinitionIndex = 43627;
