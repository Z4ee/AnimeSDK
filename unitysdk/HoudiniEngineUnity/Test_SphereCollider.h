...
#define HOUDINIENGINEUNITY_TEST_SPHERECOLLIDER_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x17F83260)
#define HOUDINIENGINEUNITY_TEST_SPHERECOLLIDER_ISNULL_OFFSET UNITYSDK_OFFSET(0x17F83240)
#define HOUDINIENGINEUNITY_TEST_SPHERECOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x17F83230)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_SphereCollider_TypeDefinitionIndex = 37761;
