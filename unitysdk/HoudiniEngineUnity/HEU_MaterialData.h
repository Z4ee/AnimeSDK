...
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA_GETMATERIALALPHA_OFFSET UNITYSDK_OFFSET(0x17F1F790)
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA_GETSUPPORTEDFILEFORMAT_OFFSET UNITYSDK_OFFSET(0x17F1FB00)
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA_GETTEXTUREFILENAMEFROMMATERIALPARAM_OFFSET UNITYSDK_OFFSET(0x17F1EB80)
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA_GET_MATERIALKEY_OFFSET UNITYSDK_OFFSET(0x17F1E180)
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA_GET_MATERIALSOURCE_OFFSET UNITYSDK_OFFSET(0x17F1E160)
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA_GET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x17F1E150)
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x17F1FCF0)
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA_ISEXISTINGMATERIAL_OFFSET UNITYSDK_OFFSET(0x17F1FA90)
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA_ISTRANSPARENTMATERIAL_OFFSET UNITYSDK_OFFSET(0x17F1E1A0)
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA_MATERIALSOURCE_WRAPPERTOINTERNAL_1_OFFSET UNITYSDK_OFFSET(0x17F1E170)
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA_MATERIALSOURCE_WRAPPERTOINTERNAL_OFFSET UNITYSDK_OFFSET(0x17F1FFA0)
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA_SET_MATERIALKEY_OFFSET UNITYSDK_OFFSET(0x17F1E190)
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA_UPDATEMATERIALFROMHOUDINI_OFFSET UNITYSDK_OFFSET(0x17EFE5F0)
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA_USELEGACYSHADERS_OFFSET UNITYSDK_OFFSET(0x17F1E340)
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17F1FFB0)
