...
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER_GET_BOOLVALUES_OFFSET UNITYSDK_OFFSET(0x1B456150)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER_GET_COLORRAMPVALUES_OFFSET UNITYSDK_OFFSET(0x1B4561F0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER_GET_FLOATRAMPVALUES_OFFSET UNITYSDK_OFFSET(0x1B4561D0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER_GET_FLOATVALUES_OFFSET UNITYSDK_OFFSET(0x1B456190)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER_GET_INTVALUES_OFFSET UNITYSDK_OFFSET(0x1B456170)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER_GET_STRINGVALUES_OFFSET UNITYSDK_OFFSET(0x1B4561B0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER_SET_BOOLVALUES_OFFSET UNITYSDK_OFFSET(0x1B456160)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER_SET_COLORRAMPVALUES_OFFSET UNITYSDK_OFFSET(0x1B456200)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER_SET_FLOATRAMPVALUES_OFFSET UNITYSDK_OFFSET(0x1B4561E0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER_SET_FLOATVALUES_OFFSET UNITYSDK_OFFSET(0x1B4561A0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER_SET_INTVALUES_OFFSET UNITYSDK_OFFSET(0x1B456180)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER_SET_STRINGVALUES_OFFSET UNITYSDK_OFFSET(0x1B4561C0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B456220)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B456230)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B456240)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1B456250)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1B456260)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1B456270)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B456210)
...
namespace HoudiniEngineUnity
{
	...
	public:
		...
		::Il2CppArray<::HoudiniEngineUnity::HEU_ColorRampPointWrapper*>* _colorRampValues; // 0x18
		::Il2CppArray<::System::Single>* _floatValues; // 0x20
