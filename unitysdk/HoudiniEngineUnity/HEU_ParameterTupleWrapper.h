...
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER_GET_BOOLVALUES_OFFSET UNITYSDK_OFFSET(0x17F2F190)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER_GET_COLORRAMPVALUES_OFFSET UNITYSDK_OFFSET(0x17F2F230)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER_GET_FLOATRAMPVALUES_OFFSET UNITYSDK_OFFSET(0x17F2F210)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER_GET_FLOATVALUES_OFFSET UNITYSDK_OFFSET(0x17F2F1D0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER_GET_INTVALUES_OFFSET UNITYSDK_OFFSET(0x17F2F1B0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER_GET_STRINGVALUES_OFFSET UNITYSDK_OFFSET(0x17F2F1F0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER_SET_BOOLVALUES_OFFSET UNITYSDK_OFFSET(0x17F2F1A0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER_SET_COLORRAMPVALUES_OFFSET UNITYSDK_OFFSET(0x17F2F240)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER_SET_FLOATRAMPVALUES_OFFSET UNITYSDK_OFFSET(0x17F2F220)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER_SET_FLOATVALUES_OFFSET UNITYSDK_OFFSET(0x17F2F1E0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER_SET_INTVALUES_OFFSET UNITYSDK_OFFSET(0x17F2F1C0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER_SET_STRINGVALUES_OFFSET UNITYSDK_OFFSET(0x17F2F200)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17F2F260)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x17F2F270)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x17F2F280)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER__CTOR_4_OFFSET UNITYSDK_OFFSET(0x17F2F290)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER__CTOR_5_OFFSET UNITYSDK_OFFSET(0x17F2F2A0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER__CTOR_6_OFFSET UNITYSDK_OFFSET(0x17F2F2B0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERTUPLEWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x17F2F250)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_ParameterTupleWrapper_TypeDefinitionIndex = 37610;

	class HEU_ParameterTupleWrapper : public ::System::Object
	{
	public:
		::Il2CppArray<::HoudiniEngineUnity::HEU_ColorRampPointWrapper*>* _colorRampValues; // 0x10
