...
#define HOUDINIENGINEUNITY_TEST_TERRAINDATA_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x17F83950)
#define HOUDINIENGINEUNITY_TEST_TERRAINDATA_ISNULL_OFFSET UNITYSDK_OFFSET(0x17F83930)
#define HOUDINIENGINEUNITY_TEST_TERRAINDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17F83920)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_TerrainData_TypeDefinitionIndex = 37796;
