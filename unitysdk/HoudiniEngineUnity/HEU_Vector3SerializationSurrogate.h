...
#define HOUDINIENGINEUNITY_HEU_VECTOR3SERIALIZATIONSURROGATE_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZATIONSURROGATE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1B4984C0)
#define HOUDINIENGINEUNITY_HEU_VECTOR3SERIALIZATIONSURROGATE_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZATIONSURROGATE_SETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1B498680)
#define HOUDINIENGINEUNITY_HEU_VECTOR3SERIALIZATIONSURROGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B498930)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_Vector3SerializationSurrogate_TypeDefinitionIndex = 39076;
