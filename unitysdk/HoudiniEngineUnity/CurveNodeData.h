...
#define HOUDINIENGINEUNITY_CURVENODEDATA_GETROTATION_OFFSET UNITYSDK_OFFSET(0x17EA3240)
#define HOUDINIENGINEUNITY_CURVENODEDATA_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x17EA32A0)
#define HOUDINIENGINEUNITY_CURVENODEDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17EA2EF0)
#define HOUDINIENGINEUNITY_CURVENODEDATA__CTOR_2_OFFSET UNITYSDK_OFFSET(0x17EA2F40)
#define HOUDINIENGINEUNITY_CURVENODEDATA__CTOR_3_OFFSET UNITYSDK_OFFSET(0x17EA3070)
#define HOUDINIENGINEUNITY_CURVENODEDATA__CTOR_4_OFFSET UNITYSDK_OFFSET(0x17EA31B0)
#define HOUDINIENGINEUNITY_CURVENODEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17EA2EB0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int CurveNodeData_TypeDefinitionIndex = 37413;
