...
#define HOUDINIENGINEUNITY_HEU_ASSETEVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8407220)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_AssetEventData_TypeDefinitionIndex = 37590;
