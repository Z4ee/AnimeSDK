...
#define HOUDINIENGINEUNITY_TEST_BOXCOLLIDER_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x1D209DB0)
#define HOUDINIENGINEUNITY_TEST_BOXCOLLIDER_ISNULL_OFFSET UNITYSDK_OFFSET(0x1D209D90)
#define HOUDINIENGINEUNITY_TEST_BOXCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D209D80)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_BoxCollider_TypeDefinitionIndex = 38566;
