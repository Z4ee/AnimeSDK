...
#define HOUDINIENGINEUNITY_HEU_HOUDINIASSETROOT_CLEARHOUDINIENGINEREFERENCES_OFFSET UNITYSDK_OFFSET(0x1086AE20)
#define HOUDINIENGINEUNITY_HEU_HOUDINIASSETROOT_DESTROYROOTCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1086AE70)
#define HOUDINIENGINEUNITY_HEU_HOUDINIASSETROOT_GET_BAKETARGETS_OFFSET UNITYSDK_OFFSET(0x1086ACF0)
#define HOUDINIENGINEUNITY_HEU_HOUDINIASSETROOT_GET_HOUDINIASSET_OFFSET UNITYSDK_OFFSET(0x1086ACE0)
#define HOUDINIENGINEUNITY_HEU_HOUDINIASSETROOT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1086AD00)
#define HOUDINIENGINEUNITY_HEU_HOUDINIASSETROOT_REMOVEHOUDINIENGINEASSETDATA_OFFSET UNITYSDK_OFFSET(0x1086AD30)
#define HOUDINIENGINEUNITY_HEU_HOUDINIASSETROOT_RESET_OFFSET UNITYSDK_OFFSET(0x1086AEB0)
#define HOUDINIENGINEUNITY_HEU_HOUDINIASSETROOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1086AF20)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_HoudiniAssetRoot_TypeDefinitionIndex = 38245;
