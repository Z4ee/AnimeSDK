...
#define HOUDINIENGINEUNITY_HEU_HOUDINIASSETROOT_CLEARHOUDINIENGINEREFERENCES_OFFSET UNITYSDK_OFFSET(0x1B42A090)
#define HOUDINIENGINEUNITY_HEU_HOUDINIASSETROOT_DESTROYROOTCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B42A0E0)
#define HOUDINIENGINEUNITY_HEU_HOUDINIASSETROOT_GET_BAKETARGETS_OFFSET UNITYSDK_OFFSET(0x1B429F60)
#define HOUDINIENGINEUNITY_HEU_HOUDINIASSETROOT_GET_HOUDINIASSET_OFFSET UNITYSDK_OFFSET(0x1B429F50)
#define HOUDINIENGINEUNITY_HEU_HOUDINIASSETROOT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B429F70)
#define HOUDINIENGINEUNITY_HEU_HOUDINIASSETROOT_REMOVEHOUDINIENGINEASSETDATA_OFFSET UNITYSDK_OFFSET(0x1B429FA0)
#define HOUDINIENGINEUNITY_HEU_HOUDINIASSETROOT_RESET_OFFSET UNITYSDK_OFFSET(0x1B42A120)
#define HOUDINIENGINEUNITY_HEU_HOUDINIASSETROOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B42A190)
