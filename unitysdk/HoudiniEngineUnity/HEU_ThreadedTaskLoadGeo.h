...
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_APPENDLOG_OFFSET UNITYSDK_OFFSET(0x1B15E170)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_BUILDBUFFERIDSMAP_OFFSET UNITYSDK_OFFSET(0x1B161B30)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1B162DA0)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_COOKNODE_OFFSET UNITYSDK_OFFSET(0x1B15E2E0)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_CREATEFILENODE_OFFSET UNITYSDK_OFFSET(0x1B162480)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_CREATELOGSTRING_OFFSET UNITYSDK_OFFSET(0x1B162DB0)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_DOASSETLOAD_OFFSET UNITYSDK_OFFSET(0x1B1627A0)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_DOFILELOAD_OFFSET UNITYSDK_OFFSET(0x1B162150)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_DOWORK_OFFSET UNITYSDK_OFFSET(0x1B15DB20)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_GENERATEINSTANCERBUFFERS_OFFSET UNITYSDK_OFFSET(0x1B161780)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_GENERATEMESHBUFFERS_OFFSET UNITYSDK_OFFSET(0x1B15F5F0)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_GENERATEPARTSINSTANCERBUFFER_OFFSET UNITYSDK_OFFSET(0x1B163990)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_GENERATEPOINTATTRIBUTEINSTANCERBUFFER_OFFSET UNITYSDK_OFFSET(0x1B164000)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_GENERATETERRAINBUFFERS_OFFSET UNITYSDK_OFFSET(0x1B15FA80)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_GETCOOKNODEID_OFFSET UNITYSDK_OFFSET(0x1B163040)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_GETDISPLAYNODEID_OFFSET UNITYSDK_OFFSET(0x1B162570)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_GETLOADBUFFERVOLUMEFROMTILEINDEX_OFFSET UNITYSDK_OFFSET(0x1B1638B0)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_GETVALIDASSETCACHEFOLDERPATH_OFFSET UNITYSDK_OFFSET(0x1B15DA30)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_LOADFLOATFROMATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1B1630E0)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_LOADLAYERCOLORFROMATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1B163330)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_LOADLAYERVECTOR2FROMATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1B163640)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_LOADNODEBUFFER_OFFSET UNITYSDK_OFFSET(0x1B15E960)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_LOADOBJECTBUFFERS_OFFSET UNITYSDK_OFFSET(0x1B15E5E0)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_LOADSTRINGFROMATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1B163060)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_ONCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1B162CE0)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_ONSTOPPED_OFFSET UNITYSDK_OFFSET(0x1B162D80)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_QUERYPARTS_OFFSET UNITYSDK_OFFSET(0x1B15EE60)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_SETFILEPARM_OFFSET UNITYSDK_OFFSET(0x1B162630)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_SETLOADCALLBACK_OFFSET UNITYSDK_OFFSET(0x1B15DB10)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_SETLOG_OFFSET UNITYSDK_OFFSET(0x1B162EF0)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_SETUPLOADASSET_OFFSET UNITYSDK_OFFSET(0x1B15DAE0)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_SETUPLOADFILE_OFFSET UNITYSDK_OFFSET(0x1B15DAB0)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_SETUPLOADNODE_OFFSET UNITYSDK_OFFSET(0x1B15DA80)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_SETUPLOAD_OFFSET UNITYSDK_OFFSET(0x1B15D8D0)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_SLEEP_OFFSET UNITYSDK_OFFSET(0x1B15E5D0)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1649F0)
...
namespace HoudiniEngineUnity
{
	...
	{
	public:
		::HoudiniEngineUnity::HEU_ThreadedTaskLoadGeo_HEU_LoadCallback* _loadCallback; // 0x30
