...
#define HOUDINIENGINEUNITY_HEU_ATTRIBUTESSTORE_SETATTRIBUTEVALUEFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15013D20)
#define HOUDINIENGINEUNITY_HEU_ATTRIBUTESSTORE_SETATTRIBUTEVALUEFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15013DC0)
#define HOUDINIENGINEUNITY_HEU_ATTRIBUTESSTORE_SETATTRIBUTEVALUEFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x15011CF0)
#define HOUDINIENGINEUNITY_HEU_ATTRIBUTESSTORE_SETATTRIBUTEVALUEFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x15013CA0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_AttributesStore_SetAttributeValueFunc_TypeDefinitionIndex = 38270;
