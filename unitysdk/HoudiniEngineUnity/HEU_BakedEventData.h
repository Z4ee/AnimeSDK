...
#define HOUDINIENGINEUNITY_HEU_BAKEDEVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x15013DE0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_BakedEventData_TypeDefinitionIndex = 38203;
