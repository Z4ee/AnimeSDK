...
#define HOUDINIENGINEUNITY_HEU_INPUTPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x8459430)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_InputPreset_TypeDefinitionIndex = 37603;
