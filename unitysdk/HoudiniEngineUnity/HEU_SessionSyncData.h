...
#define HOUDINIENGINEUNITY_HEU_SESSIONSYNCDATA_GET_SYNCSTATUS_OFFSET UNITYSDK_OFFSET(0x197C7A20)
#define HOUDINIENGINEUNITY_HEU_SESSIONSYNCDATA_SET_SYNCSTATUS_OFFSET UNITYSDK_OFFSET(0x197C7A30)
#define HOUDINIENGINEUNITY_HEU_SESSIONSYNCDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x197C1FF0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_SessionSyncData_TypeDefinitionIndex = 38434;
