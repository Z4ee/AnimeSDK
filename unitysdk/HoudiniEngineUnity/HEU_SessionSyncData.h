...
#define HOUDINIENGINEUNITY_HEU_SESSIONSYNCDATA_GET_SYNCSTATUS_OFFSET UNITYSDK_OFFSET(0x8491A60)
#define HOUDINIENGINEUNITY_HEU_SESSIONSYNCDATA_SET_SYNCSTATUS_OFFSET UNITYSDK_OFFSET(0x8491A70)
#define HOUDINIENGINEUNITY_HEU_SESSIONSYNCDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x848CEF0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_SessionSyncData_TypeDefinitionIndex = 37774;
