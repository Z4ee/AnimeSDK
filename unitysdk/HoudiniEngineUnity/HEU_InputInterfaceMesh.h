...
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_CREATEINPUTNODEFORCOLLIDER_OFFSET UNITYSDK_OFFSET(0x10875250)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_CREATEINPUTNODEWITHDATAUPLOAD_OFFSET UNITYSDK_OFFSET(0x1086B860)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_CREATESINGLEMESHDATA_OFFSET UNITYSDK_OFFSET(0x108758C0)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_GENERATEMESHDATASFROMGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1086BE30)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_GETCOLLIDERGROUPBASENAME_OFFSET UNITYSDK_OFFSET(0x10875180)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_GETMESHFROMOBJECT_OFFSET UNITYSDK_OFFSET(0x10875DB0)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_GETUVSFROMMESH_OFFSET UNITYSDK_OFFSET(0x10871200)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1086B850)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_ISTHISINPUTOBJECTSUPPORTED_OFFSET UNITYSDK_OFFSET(0x108710F0)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_UPLOADBOXCOLLIDERDATA_OFFSET UNITYSDK_OFFSET(0x10872310)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_UPLOADCAPSULECOLLIDERDATA_OFFSET UNITYSDK_OFFSET(0x10873300)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_UPLOADCOLLIDERDATA_OFFSET UNITYSDK_OFFSET(0x108705C0)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_UPLOADDATA_OFFSET UNITYSDK_OFFSET(0x1086C2C0)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_UPLOADMESHCOLLIDERDATA_OFFSET UNITYSDK_OFFSET(0x108748F0)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_UPLOADSPHERECOLLIDERDATA_OFFSET UNITYSDK_OFFSET(0x10872B10)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1086B840)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_InputInterfaceMesh_TypeDefinitionIndex = 38489;
