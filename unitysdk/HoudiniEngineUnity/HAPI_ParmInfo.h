...
#define HOUDINIENGINEUNITY_HAPI_PARMINFO_ISFLOAT_OFFSET UNITYSDK_OFFSET(0x38DF410)
#define HOUDINIENGINEUNITY_HAPI_PARMINFO_ISINT_OFFSET UNITYSDK_OFFSET(0x38DF3F0)
#define HOUDINIENGINEUNITY_HAPI_PARMINFO_ISNODE_OFFSET UNITYSDK_OFFSET(0x38DF460)
#define HOUDINIENGINEUNITY_HAPI_PARMINFO_ISNONVALUE_OFFSET UNITYSDK_OFFSET(0x38DF470)
#define HOUDINIENGINEUNITY_HAPI_PARMINFO_ISPATH_OFFSET UNITYSDK_OFFSET(0x38DF440)
#define HOUDINIENGINEUNITY_HAPI_PARMINFO_ISSTRING_OFFSET UNITYSDK_OFFSET(0x38DF420)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HAPI_ParmInfo_TypeDefinitionIndex = 38343;
