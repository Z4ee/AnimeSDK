...
#define HOUDINIENGINEUNITY_HAPI_PARMINFO_ISFLOAT_OFFSET UNITYSDK_OFFSET(0x26510)
#define HOUDINIENGINEUNITY_HAPI_PARMINFO_ISINT_OFFSET UNITYSDK_OFFSET(0x264F0)
#define HOUDINIENGINEUNITY_HAPI_PARMINFO_ISNODE_OFFSET UNITYSDK_OFFSET(0x26560)
#define HOUDINIENGINEUNITY_HAPI_PARMINFO_ISNONVALUE_OFFSET UNITYSDK_OFFSET(0x26570)
#define HOUDINIENGINEUNITY_HAPI_PARMINFO_ISPATH_OFFSET UNITYSDK_OFFSET(0x26540)
#define HOUDINIENGINEUNITY_HAPI_PARMINFO_ISSTRING_OFFSET UNITYSDK_OFFSET(0x26520)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HAPI_ParmInfo_TypeDefinitionIndex = 43592;
