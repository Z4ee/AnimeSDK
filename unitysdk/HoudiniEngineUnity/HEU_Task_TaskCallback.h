...
#define HOUDINIENGINEUNITY_HEU_TASK_TASKCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x197CCF50)
#define HOUDINIENGINEUNITY_HEU_TASK_TASKCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x197CCF80)
#define HOUDINIENGINEUNITY_HEU_TASK_TASKCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x197CCF40)
#define HOUDINIENGINEUNITY_HEU_TASK_TASKCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x197CCE50)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_Task_TaskCallback_TypeDefinitionIndex = 38446;
