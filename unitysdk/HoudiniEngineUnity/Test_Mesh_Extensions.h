...
#define HOUDINIENGINEUNITY_TEST_MESH_EXTENSIONS_TOTESTOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1D20F1F0)
#define HOUDINIENGINEUNITY_TEST_MESH_EXTENSIONS_TOTESTOBJECT_2_OFFSET UNITYSDK_OFFSET(0x1D20F310)
#define HOUDINIENGINEUNITY_TEST_MESH_EXTENSIONS_TOTESTOBJECT_OFFSET UNITYSDK_OFFSET(0x1D20E480)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_Mesh_Extensions_TypeDefinitionIndex = 38579;
