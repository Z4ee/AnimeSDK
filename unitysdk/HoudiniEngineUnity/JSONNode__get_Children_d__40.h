...
#define HOUDINIENGINEUNITY_JSONNODE__GET_CHILDREN_D__40_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x8CD75A0)
#define HOUDINIENGINEUNITY_JSONNODE__GET_CHILDREN_D__40_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_HOUDINIENGINEUNITY_JSONNODE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x8CD7630)
#define HOUDINIENGINEUNITY_JSONNODE__GET_CHILDREN_D__40_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_HOUDINIENGINEUNITY_JSONNODE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x8CD75C0)
#define HOUDINIENGINEUNITY_JSONNODE__GET_CHILDREN_D__40_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x8CD76A0)
#define HOUDINIENGINEUNITY_JSONNODE__GET_CHILDREN_D__40_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x8CD7620)
#define HOUDINIENGINEUNITY_JSONNODE__GET_CHILDREN_D__40_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x8CD75D0)
#define HOUDINIENGINEUNITY_JSONNODE__GET_CHILDREN_D__40_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8CD7590)
#define HOUDINIENGINEUNITY_JSONNODE__GET_CHILDREN_D__40__CTOR_OFFSET UNITYSDK_OFFSET(0x8CD3D00)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int JSONNode__get_Children_d__40_TypeDefinitionIndex = 43723;
