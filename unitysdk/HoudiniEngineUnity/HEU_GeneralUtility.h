...
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_APPLYTRANSFORMTO_OFFSET UNITYSDK_OFFSET(0x1B3E2090)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_ASSIGNUNITYLAYER_OFFSET UNITYSDK_OFFSET(0x1B3D3E60)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_ASSIGNUNITYTAG_OFFSET UNITYSDK_OFFSET(0x1B3D3A50)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_ATTACHSCRIPTWITHINVOKEFUNCTION_OFFSET UNITYSDK_OFFSET(0x1B3E5DD0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_BILERPF_OFFSET UNITYSDK_OFFSET(0x1B3E81E0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_CHECKATTRIBUTEEXISTS_OFFSET UNITYSDK_OFFSET(0x1B3E1720)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_COLORTOSTRING_OFFSET UNITYSDK_OFFSET(0x1B3E41C0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_COMPOSENCHILDREN_OFFSET UNITYSDK_OFFSET(0x1B3D9480)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_COPYCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1B3E7600)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_COPYFLAGS_OFFSET UNITYSDK_OFFSET(0x1B3D3410)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_COPYHAPITRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B3E7BD0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_COPYLOCALTRANSFORMVALUES_OFFSET UNITYSDK_OFFSET(0x1B3E2490)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_COPYWORLDTRANSFORMVALUES_OFFSET UNITYSDK_OFFSET(0x1B3E1FA0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_CREATENEWGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B3C0360)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_CREATEOUTPUTATTRIBUTEHELPER_OFFSET UNITYSDK_OFFSET(0x1B3E1F30)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_CREATEOUTPUTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1B3E1920)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYAUTOGENERATEDCHILDREN_OFFSET UNITYSDK_OFFSET(0x1B3E8860)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYBAKEDGAMEOBJECTSWITHENDNAME_OFFSET UNITYSDK_OFFSET(0x1B3E3600)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYBAKEDGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1B3E35F0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYCHILDWITHNAME_OFFSET UNITYSDK_OFFSET(0x1B3E8750)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYGENERATEDCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1B3E3350)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYGENERATEDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B3E3F90)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYGENERATEDMESHCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1B3E33F0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYGENERATEDMESHMATERIALSLODGROUPS_OFFSET UNITYSDK_OFFSET(0x1B3E37B0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYIMMEDIATE_OFFSET UNITYSDK_OFFSET(0x1B3D3060)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYLODGROUP_OFFSET UNITYSDK_OFFSET(0x1B3E39F0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYMESHCOLLIDER_OFFSET UNITYSDK_OFFSET(0x1B3E40F0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYTERRAINCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1B3E3460)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DOESUNITYTAGEXIST_OFFSET UNITYSDK_OFFSET(0x1B3E45F0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_FINDORGENERATEHANDLES_OFFSET UNITYSDK_OFFSET(0x1B3E6140)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_FRACTIONALF_OFFSET UNITYSDK_OFFSET(0x1B3E8260)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETATTRIBUTECOLORSINGLE_OFFSET UNITYSDK_OFFSET(0x1B3E5AD0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETATTRIBUTEDATAASSTRING_OFFSET UNITYSDK_OFFSET(0x1B3E11E0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETATTRIBUTEFLOATSINGLE_OFFSET UNITYSDK_OFFSET(0x1B3E55A0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETATTRIBUTEINFO_OFFSET UNITYSDK_OFFSET(0x1B3BAFD0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETATTRIBUTEINTSINGLE_OFFSET UNITYSDK_OFFSET(0x1B3E5840)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETATTRIBUTESTRINGDATAHELPER_OFFSET UNITYSDK_OFFSET(0x1B3E0D90)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETATTRIBUTESTRINGDATA_OFFSET UNITYSDK_OFFSET(0x1B3BB4E0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETATTRIBUTESTRINGVALUESINGLESTRICT_OFFSET UNITYSDK_OFFSET(0x1B3E5030)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETATTRIBUTESTRINGVALUESINGLE_OFFSET UNITYSDK_OFFSET(0x1B3E4C20)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETCHILDGAMEOBJECTSWITHNAMEPATTERN_OFFSET UNITYSDK_OFFSET(0x1B3E2A50)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETCHILDGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1B3E2580)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETGAMEOBJECTBYNAMEINPROJECTONLY_OFFSET UNITYSDK_OFFSET(0x1B3E3170)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETGAMEOBJECTBYNAMEINSCENE_OFFSET UNITYSDK_OFFSET(0x1B3E32D0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETGAMEOBJECTBYNAME_OFFSET UNITYSDK_OFFSET(0x1B3E3010)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETHDABYGAMEOBJECTNAMEINSCENE_OFFSET UNITYSDK_OFFSET(0x1B3E3310)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETINSTANCECHILDOBJECTS_OFFSET UNITYSDK_OFFSET(0x1B3E2F90)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETLODTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1B3E3BC0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETMATERIALATTRIBUTEVALUEFROMPART_OFFSET UNITYSDK_OFFSET(0x1B3E7D50)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETNONINSTANCECHILDOBJECTS_OFFSET UNITYSDK_OFFSET(0x1B3E2FD0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETPREFABFROMPATH_OFFSET UNITYSDK_OFFSET(0x1B3E8510)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETRAWOPERATORNAME_OFFSET UNITYSDK_OFFSET(0x1B3E84A0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETSYSTEMTYPEBYNAME_OFFSET UNITYSDK_OFFSET(0x1B3E48F0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETUNITYSCRIPTATTRIBUTEVALUE_OFFSET UNITYSDK_OFFSET(0x1B3E4930)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_HASATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1B3D7E10)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_HASVALIDINSTANCEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1B3E1800)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_ISGAMEOBJECTINPROJECT_OFFSET UNITYSDK_OFFSET(0x1B3E3290)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_ISINCAMERAVIEW_OFFSET UNITYSDK_OFFSET(0x1B3E60B0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_ISMOUSEOVERRECT_OFFSET UNITYSDK_OFFSET(0x1B3E4880)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_ISMOUSEWITHINSCENEVIEW_OFFSET UNITYSDK_OFFSET(0x1B3E4800)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_LOADTEXTUREFROMFILE_OFFSET UNITYSDK_OFFSET(0x1B3E7610)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_LONGESTCOMMONPREFIX_OFFSET UNITYSDK_OFFSET(0x1B3E8290)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_MAKESTATICIFHASATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1B3D4230)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_MAKETEXTURE_OFFSET UNITYSDK_OFFSET(0x1B3E78A0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_RENAMEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B3D33F0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_REPLACECOLLIDERMESHFROMMESHCOLLIDER_OFFSET UNITYSDK_OFFSET(0x1B3E8040)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_REPLACECOLLIDERMESHFROMMESHFILTER_OFFSET UNITYSDK_OFFSET(0x1B3D31B0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_REPLACEFIRSTOCCURRENCE_OFFSET UNITYSDK_OFFSET(0x1B3E7AB0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_SETGAMEOBJECTCHILDRENCOLLIDERSTATE_OFFSET UNITYSDK_OFFSET(0x1B3D39B0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_SETGAMEOBJECTCHILDRENRENDERVISIBILITY_OFFSET UNITYSDK_OFFSET(0x1B3D3840)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_SETGAMEOBJECTCOLLIDERSTATE_OFFSET UNITYSDK_OFFSET(0x1B3D38E0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_SETGAMEOBJECTRENDERVISIBLITY_OFFSET UNITYSDK_OFFSET(0x1B3D37A0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_SETLAYER_OFFSET UNITYSDK_OFFSET(0x1B3E4600)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_SETLODTRANSFORMVALUES_OFFSET UNITYSDK_OFFSET(0x1B3E3DC0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_SETPARENTWITHCLEANTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B3E7B40)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_SETTAG_OFFSET UNITYSDK_OFFSET(0x1B3E4700)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_STRINGTOCOLOR_OFFSET UNITYSDK_OFFSET(0x1B3E44C0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_UPDATEGENERATEDATTRIBUTESTORE_OFFSET UNITYSDK_OFFSET(0x1B3D1040)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3E8A80)
