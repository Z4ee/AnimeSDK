...
#define HOUDINIENGINEUNITY_HEU_OUTPUTATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x8C990F0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_OutputAttribute_TypeDefinitionIndex = 43530;
