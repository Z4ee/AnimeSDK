...
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_HEU_LOADCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x197DDDB0)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_HEU_LOADCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x197DDE40)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_HEU_LOADCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x197D7790)
#define HOUDINIENGINEUNITY_HEU_THREADEDTASKLOADGEO_HEU_LOADCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x197DDCC0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_ThreadedTaskLoadGeo_HEU_LoadCallback_TypeDefinitionIndex = 38463;
