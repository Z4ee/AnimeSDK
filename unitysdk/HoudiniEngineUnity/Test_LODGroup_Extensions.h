...
#define HOUDINIENGINEUNITY_TEST_LODGROUP_EXTENSIONS_TOTESTOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1D20D190)
#define HOUDINIENGINEUNITY_TEST_LODGROUP_EXTENSIONS_TOTESTOBJECT_2_OFFSET UNITYSDK_OFFSET(0x1D20D2B0)
#define HOUDINIENGINEUNITY_TEST_LODGROUP_EXTENSIONS_TOTESTOBJECT_OFFSET UNITYSDK_OFFSET(0x1D20D150)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_LODGroup_Extensions_TypeDefinitionIndex = 38555;
