...
#define HOUDINIENGINEUNITY_TEST_LODGROUP_EXTENSIONS_TOTESTOBJECT_1_OFFSET UNITYSDK_OFFSET(0x17F80EB0)
#define HOUDINIENGINEUNITY_TEST_LODGROUP_EXTENSIONS_TOTESTOBJECT_2_OFFSET UNITYSDK_OFFSET(0x17F80FD0)
#define HOUDINIENGINEUNITY_TEST_LODGROUP_EXTENSIONS_TOTESTOBJECT_OFFSET UNITYSDK_OFFSET(0x17F80E70)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_LODGroup_Extensions_TypeDefinitionIndex = 37747;
