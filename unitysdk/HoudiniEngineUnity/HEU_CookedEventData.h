...
#define HOUDINIENGINEUNITY_HEU_COOKEDEVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17EB5AF0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_CookedEventData_TypeDefinitionIndex = 37394;
