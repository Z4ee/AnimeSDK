...
#define HOUDINIENGINEUNITY_TEST_TERRAIN_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x1D20FA40)
#define HOUDINIENGINEUNITY_TEST_TERRAIN_ISNULL_OFFSET UNITYSDK_OFFSET(0x1D20FA20)
#define HOUDINIENGINEUNITY_TEST_TERRAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1D20FA10)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_Terrain_TypeDefinitionIndex = 38607;
