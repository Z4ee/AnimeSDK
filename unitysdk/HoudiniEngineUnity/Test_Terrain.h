...
#define HOUDINIENGINEUNITY_TEST_TERRAIN_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x17F83760)
#define HOUDINIENGINEUNITY_TEST_TERRAIN_ISNULL_OFFSET UNITYSDK_OFFSET(0x17F83740)
#define HOUDINIENGINEUNITY_TEST_TERRAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x17F83730)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_Terrain_TypeDefinitionIndex = 37799;
