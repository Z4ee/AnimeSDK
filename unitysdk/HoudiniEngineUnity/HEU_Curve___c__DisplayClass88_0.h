...
#define HOUDINIENGINEUNITY_HEU_CURVE___C__DISPLAYCLASS88_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17EBC300)
#define HOUDINIENGINEUNITY_HEU_CURVE___C__DISPLAYCLASS88_0__UPDATECURVEINPUTFORCUSTOMATTRIBUTES_B__0_OFFSET UNITYSDK_OFFSET(0x17EBE340)
#define HOUDINIENGINEUNITY_HEU_CURVE___C__DISPLAYCLASS88_0__UPDATECURVEINPUTFORCUSTOMATTRIBUTES_B__1_OFFSET UNITYSDK_OFFSET(0x17EBE500)
#define HOUDINIENGINEUNITY_HEU_CURVE___C__DISPLAYCLASS88_0__UPDATECURVEINPUTFORCUSTOMATTRIBUTES_B__2_OFFSET UNITYSDK_OFFSET(0x17EBE850)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_Curve___c__DisplayClass88_0_TypeDefinitionIndex = 37422;
	...
	public:
		...
		::System::Collections::Generic::List_1<::UnityEngine::Vector3>* positions; // 0x18
