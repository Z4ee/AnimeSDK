...
#define HOUDINIENGINEUNITY_HEU_ASSETPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x8407230)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_AssetPreset_TypeDefinitionIndex = 37602;
