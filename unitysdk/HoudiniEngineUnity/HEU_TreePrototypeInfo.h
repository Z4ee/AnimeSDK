...
#define HOUDINIENGINEUNITY_HEU_TREEPROTOTYPEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x8499920)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_TreePrototypeInfo_TypeDefinitionIndex = 37867;
