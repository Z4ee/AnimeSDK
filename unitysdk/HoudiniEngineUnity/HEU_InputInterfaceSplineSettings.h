...
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACESPLINESETTINGS_GET_SAMPLINGRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1B435040)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACESPLINESETTINGS_SET_SAMPLINGRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1B435050)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACESPLINESETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B435060)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_InputInterfaceSplineSettings_TypeDefinitionIndex = 39353;
