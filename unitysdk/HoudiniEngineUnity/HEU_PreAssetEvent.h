...
#define HOUDINIENGINEUNITY_HEU_PREASSETEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x848B630)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_PreAssetEvent_TypeDefinitionIndex = 37601;
