...
#define HOUDINIENGINEUNITY_HEU_PREASSETEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x8CB3880)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_PreAssetEvent_TypeDefinitionIndex = 43478;
