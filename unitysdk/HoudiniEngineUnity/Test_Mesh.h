...
#define HOUDINIENGINEUNITY_TEST_MESH_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x1D20DAE0)
#define HOUDINIENGINEUNITY_TEST_MESH_ISNULL_OFFSET UNITYSDK_OFFSET(0x1D20DAC0)
#define HOUDINIENGINEUNITY_TEST_MESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1D20DAB0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_Mesh_TypeDefinitionIndex = 38578;
