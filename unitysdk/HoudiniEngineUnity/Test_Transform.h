...
#define HOUDINIENGINEUNITY_TEST_TRANSFORM_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x1D211A50)
#define HOUDINIENGINEUNITY_TEST_TRANSFORM_ISNULL_OFFSET UNITYSDK_OFFSET(0x1D211A30)
#define HOUDINIENGINEUNITY_TEST_TRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D211A20)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_Transform_TypeDefinitionIndex = 38557;
