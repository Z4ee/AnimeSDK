...
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_APPLYLOCALTRANSFROMFROMHOUDINITOUNITYFORINSTANCE_OFFSET UNITYSDK_OFFSET(0x167CDA40)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_APPLYLOCALTRANSFROMFROMHOUDINITOUNITY_OFFSET UNITYSDK_OFFSET(0x167CAEF0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_APPLYMATRIXTOLOCALTRANSFORM_OFFSET UNITYSDK_OFFSET(0x167DC900)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_APPLYWORLDTRANSFROMFROMHOUDINITOUNITY_OFFSET UNITYSDK_OFFSET(0x167F8E50)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONTAINSSOPNODES_OFFSET UNITYSDK_OFFSET(0x167FA840)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTPOSITIONUNITYTOHOUDINI_1_OFFSET UNITYSDK_OFFSET(0x167D6C20)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTPOSITIONUNITYTOHOUDINI_2_OFFSET UNITYSDK_OFFSET(0x167D85A0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTPOSITIONUNITYTOHOUDINI_3_OFFSET UNITYSDK_OFFSET(0x167FCC10)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTPOSITIONUNITYTOHOUDINI_4_OFFSET UNITYSDK_OFFSET(0x167D2EC0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTPOSITIONUNITYTOHOUDINI_OFFSET UNITYSDK_OFFSET(0x167FCC00)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTROTATIONUNITYTOHOUDINI_1_OFFSET UNITYSDK_OFFSET(0x167D6C50)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTROTATIONUNITYTOHOUDINI_2_OFFSET UNITYSDK_OFFSET(0x167FCD40)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTROTATIONUNITYTOHOUDINI_3_OFFSET UNITYSDK_OFFSET(0x167FCE70)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTROTATIONUNITYTOHOUDINI_OFFSET UNITYSDK_OFFSET(0x167FCC30)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTSCALEUNITYTOHOUDINI_1_OFFSET UNITYSDK_OFFSET(0x167D6DC0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTSCALEUNITYTOHOUDINI_2_OFFSET UNITYSDK_OFFSET(0x167FCF90)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTSCALEUNITYTOHOUDINI_3_OFFSET UNITYSDK_OFFSET(0x167FCFB0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTSCALEUNITYTOHOUDINI_OFFSET UNITYSDK_OFFSET(0x167FCF80)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_COOKNODEINHOUDINIWITHOPTIONS_OFFSET UNITYSDK_OFFSET(0x167D70D0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_COOKNODEINHOUDINI_OFFSET UNITYSDK_OFFSET(0x167B7330)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CREATEANDCOOKASSETNODE_OFFSET UNITYSDK_OFFSET(0x167F6F00)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CREATEANDCOOKCURVEASSET_OFFSET UNITYSDK_OFFSET(0x167F7A80)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CREATEANDCOOKINPUTASSET_OFFSET UNITYSDK_OFFSET(0x167F7DD0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CREATENEWASSET_1_OFFSET UNITYSDK_OFFSET(0x167F81C0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CREATENEWASSET_OFFSET UNITYSDK_OFFSET(0x167F8190)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CREATENEWCURVEASSET_OFFSET UNITYSDK_OFFSET(0x167F86E0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CREATENEWINPUTASSET_OFFSET UNITYSDK_OFFSET(0x167F8710)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_DESTROYCHILDREN_OFFSET UNITYSDK_OFFSET(0x167F8750)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_DESTROYGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x167D26F0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_DOESGEOPARTHAVEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x167FA680)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_DOESMAPPEDPATHEXIST_OFFSET UNITYSDK_OFFSET(0x167F66C0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_FINDHOUDINIASSETFILEINPATHWITHEXT_OFFSET UNITYSDK_OFFSET(0x167F6840)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GATHERALLASSETGEOINFOS_OFFSET UNITYSDK_OFFSET(0x167FAC00)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GATHERALLASSETOUTPUTS_OFFSET UNITYSDK_OFFSET(0x167FB520)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GATHERALLOBJECTGEOINFOS_OFFSET UNITYSDK_OFFSET(0x167FC170)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETASSETINSCENE_OFFSET UNITYSDK_OFFSET(0x167F8D30)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETDEFAULTCOOKOPTIONS_OFFSET UNITYSDK_OFFSET(0x167D7090)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETENVIRONMENTPATH_OFFSET UNITYSDK_OFFSET(0x167F6390)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETHAPITRANSFORMFROMMATRIX_OFFSET UNITYSDK_OFFSET(0x167F96C0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETHAPITRANSFORMQUATFROMMATRIX_OFFSET UNITYSDK_OFFSET(0x167F9C60)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETHAPITRANSFORM_OFFSET UNITYSDK_OFFSET(0x167F9A90)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETHOUDINIENGINEINSTALLATIONINFO_OFFSET UNITYSDK_OFFSET(0x167F6380)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETMATRIX4X4_OFFSET UNITYSDK_OFFSET(0x167FA090)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETMATRIXFROMHAPITRANSFORM_OFFSET UNITYSDK_OFFSET(0x167F93A0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETOBJECTINFOS_OFFSET UNITYSDK_OFFSET(0x167B3F40)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETOUTPUTINDEX_OFFSET UNITYSDK_OFFSET(0x167FAB10)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETPARENTNODEID_OFFSET UNITYSDK_OFFSET(0x167FA770)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x167F9100)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETQUATERNION_OFFSET UNITYSDK_OFFSET(0x167F9120)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETREALPATHFROMHFSPATH_OFFSET UNITYSDK_OFFSET(0x167F6490)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETSCALE_OFFSET UNITYSDK_OFFSET(0x167F92B0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_INSTANTIATEHDA_OFFSET UNITYSDK_OFFSET(0x167B2940)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISEQUALTOL_OFFSET UNITYSDK_OFFSET(0x167FA340)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISHOUDINIASSETFILE_OFFSET UNITYSDK_OFFSET(0x167F6760)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISNODEVALIDINHOUDINI_OFFSET UNITYSDK_OFFSET(0x167B71E0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISOBJNODEFULLYVISIBLE_OFFSET UNITYSDK_OFFSET(0x167FA910)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISSAMETRANSFORM_OFFSET UNITYSDK_OFFSET(0x167FA1A0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISSESSIONSYNCEQUAL_OFFSET UNITYSDK_OFFSET(0x167FA660)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISSUPPORTEDPOLYGONTYPE_OFFSET UNITYSDK_OFFSET(0x167C31F0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISTRANSFORMEQUAL_OFFSET UNITYSDK_OFFSET(0x167FA360)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISVIEWPORTEQUAL_OFFSET UNITYSDK_OFFSET(0x167FA560)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_LOADGEOWITHNEWGEOSYNC_OFFSET UNITYSDK_OFFSET(0x167F8740)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_LOADHDAFILE_OFFSET UNITYSDK_OFFSET(0x167F6BD0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_LOCATEVALIDFILEPATH_1_OFFSET UNITYSDK_OFFSET(0x167F6BC0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_LOCATEVALIDFILEPATH_OFFSET UNITYSDK_OFFSET(0x167F6B80)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_LOGERROR_OFFSET UNITYSDK_OFFSET(0x167F6B70)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_LOGWARNING_OFFSET UNITYSDK_OFFSET(0x167F6B60)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_LOG_OFFSET UNITYSDK_OFFSET(0x167F6AE0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_PROCESSHOUDINICOOKSTATUS_OFFSET UNITYSDK_OFFSET(0x167F72F0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_SETANIMATIONCURVETANGENTMODES_OFFSET UNITYSDK_OFFSET(0x167FA760)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_SETMATRIXPOSITION_OFFSET UNITYSDK_OFFSET(0x167F9660)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_TOHAPIVARIABLENAME_OFFSET UNITYSDK_OFFSET(0x167FC9C0)
