...
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_APPLYLOCALTRANSFROMFROMHOUDINITOUNITYFORINSTANCE_OFFSET UNITYSDK_OFFSET(0x1501A360)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_APPLYLOCALTRANSFROMFROMHOUDINITOUNITY_OFFSET UNITYSDK_OFFSET(0x15017820)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_APPLYMATRIXTOLOCALTRANSFORM_OFFSET UNITYSDK_OFFSET(0x15029140)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_APPLYWORLDTRANSFROMFROMHOUDINITOUNITY_OFFSET UNITYSDK_OFFSET(0x150452C0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONTAINSSOPNODES_OFFSET UNITYSDK_OFFSET(0x15046E60)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTPOSITIONUNITYTOHOUDINI_1_OFFSET UNITYSDK_OFFSET(0x150234D0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTPOSITIONUNITYTOHOUDINI_2_OFFSET UNITYSDK_OFFSET(0x15024E40)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTPOSITIONUNITYTOHOUDINI_3_OFFSET UNITYSDK_OFFSET(0x15049230)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTPOSITIONUNITYTOHOUDINI_4_OFFSET UNITYSDK_OFFSET(0x1501F770)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTPOSITIONUNITYTOHOUDINI_OFFSET UNITYSDK_OFFSET(0x15049220)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTROTATIONUNITYTOHOUDINI_1_OFFSET UNITYSDK_OFFSET(0x15023500)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTROTATIONUNITYTOHOUDINI_2_OFFSET UNITYSDK_OFFSET(0x15049360)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTROTATIONUNITYTOHOUDINI_3_OFFSET UNITYSDK_OFFSET(0x15049490)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTROTATIONUNITYTOHOUDINI_OFFSET UNITYSDK_OFFSET(0x15049250)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTSCALEUNITYTOHOUDINI_1_OFFSET UNITYSDK_OFFSET(0x15023670)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTSCALEUNITYTOHOUDINI_2_OFFSET UNITYSDK_OFFSET(0x150495B0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTSCALEUNITYTOHOUDINI_3_OFFSET UNITYSDK_OFFSET(0x150495D0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTSCALEUNITYTOHOUDINI_OFFSET UNITYSDK_OFFSET(0x150495A0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_COOKNODEINHOUDINIWITHOPTIONS_OFFSET UNITYSDK_OFFSET(0x15023970)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_COOKNODEINHOUDINI_OFFSET UNITYSDK_OFFSET(0x15003D40)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CREATEANDCOOKASSETNODE_OFFSET UNITYSDK_OFFSET(0x15043370)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CREATEANDCOOKCURVEASSET_OFFSET UNITYSDK_OFFSET(0x15043EF0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CREATEANDCOOKINPUTASSET_OFFSET UNITYSDK_OFFSET(0x15044240)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CREATENEWASSET_1_OFFSET UNITYSDK_OFFSET(0x15044630)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CREATENEWASSET_OFFSET UNITYSDK_OFFSET(0x15044600)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CREATENEWCURVEASSET_OFFSET UNITYSDK_OFFSET(0x15044B50)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CREATENEWINPUTASSET_OFFSET UNITYSDK_OFFSET(0x15044B80)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_DESTROYCHILDREN_OFFSET UNITYSDK_OFFSET(0x15044BC0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_DESTROYGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1501EFA0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_DOESGEOPARTHAVEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x15046CA0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_DOESMAPPEDPATHEXIST_OFFSET UNITYSDK_OFFSET(0x15042B30)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_FINDHOUDINIASSETFILEINPATHWITHEXT_OFFSET UNITYSDK_OFFSET(0x15042CB0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GATHERALLASSETGEOINFOS_OFFSET UNITYSDK_OFFSET(0x15047220)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GATHERALLASSETOUTPUTS_OFFSET UNITYSDK_OFFSET(0x15047B40)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GATHERALLOBJECTGEOINFOS_OFFSET UNITYSDK_OFFSET(0x15048790)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETASSETINSCENE_OFFSET UNITYSDK_OFFSET(0x150451A0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETDEFAULTCOOKOPTIONS_OFFSET UNITYSDK_OFFSET(0x15023930)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETENVIRONMENTPATH_OFFSET UNITYSDK_OFFSET(0x15042800)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETHAPITRANSFORMFROMMATRIX_OFFSET UNITYSDK_OFFSET(0x15045C00)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETHAPITRANSFORMQUATFROMMATRIX_OFFSET UNITYSDK_OFFSET(0x15046210)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETHAPITRANSFORM_OFFSET UNITYSDK_OFFSET(0x15046020)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETHOUDINIENGINEINSTALLATIONINFO_OFFSET UNITYSDK_OFFSET(0x150427F0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETMATRIX4X4_OFFSET UNITYSDK_OFFSET(0x150466B0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETMATRIXFROMHAPITRANSFORM_OFFSET UNITYSDK_OFFSET(0x150458E0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETOBJECTINFOS_OFFSET UNITYSDK_OFFSET(0x15000920)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETOUTPUTINDEX_OFFSET UNITYSDK_OFFSET(0x15047130)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETPARENTNODEID_OFFSET UNITYSDK_OFFSET(0x15046D90)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x15045570)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETQUATERNION_OFFSET UNITYSDK_OFFSET(0x150455C0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETREALPATHFROMHFSPATH_OFFSET UNITYSDK_OFFSET(0x15042900)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETSCALE_OFFSET UNITYSDK_OFFSET(0x150457F0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_INSTANTIATEHDA_OFFSET UNITYSDK_OFFSET(0x14FFF320)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISEQUALTOL_OFFSET UNITYSDK_OFFSET(0x15046960)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISHOUDINIASSETFILE_OFFSET UNITYSDK_OFFSET(0x15042BD0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISNODEVALIDINHOUDINI_OFFSET UNITYSDK_OFFSET(0x15003BF0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISOBJNODEFULLYVISIBLE_OFFSET UNITYSDK_OFFSET(0x15046F30)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISSAMETRANSFORM_OFFSET UNITYSDK_OFFSET(0x150467C0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISSESSIONSYNCEQUAL_OFFSET UNITYSDK_OFFSET(0x15046C80)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISSUPPORTEDPOLYGONTYPE_OFFSET UNITYSDK_OFFSET(0x1500FB20)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISTRANSFORMEQUAL_OFFSET UNITYSDK_OFFSET(0x15046980)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISVIEWPORTEQUAL_OFFSET UNITYSDK_OFFSET(0x15046B80)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_LOADGEOWITHNEWGEOSYNC_OFFSET UNITYSDK_OFFSET(0x15044BB0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_LOADHDAFILE_OFFSET UNITYSDK_OFFSET(0x15043040)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_LOCATEVALIDFILEPATH_1_OFFSET UNITYSDK_OFFSET(0x15043030)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_LOCATEVALIDFILEPATH_OFFSET UNITYSDK_OFFSET(0x15042FF0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_LOGERROR_OFFSET UNITYSDK_OFFSET(0x15042FE0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_LOGWARNING_OFFSET UNITYSDK_OFFSET(0x15042FD0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_LOG_OFFSET UNITYSDK_OFFSET(0x15042F50)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_PROCESSHOUDINICOOKSTATUS_OFFSET UNITYSDK_OFFSET(0x15043760)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_SETANIMATIONCURVETANGENTMODES_OFFSET UNITYSDK_OFFSET(0x15046D80)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_SETMATRIXPOSITION_OFFSET UNITYSDK_OFFSET(0x15045BA0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_TOHAPIVARIABLENAME_OFFSET UNITYSDK_OFFSET(0x15048FE0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_HAPIUtility_TypeDefinitionIndex = 38278;
