...
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_APPLYLOCALTRANSFROMFROMHOUDINITOUNITYFORINSTANCE_OFFSET UNITYSDK_OFFSET(0x17EB3B20)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_APPLYLOCALTRANSFROMFROMHOUDINITOUNITY_OFFSET UNITYSDK_OFFSET(0x17EB1150)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_APPLYMATRIXTOLOCALTRANSFORM_OFFSET UNITYSDK_OFFSET(0x17EC15C0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_APPLYWORLDTRANSFROMFROMHOUDINITOUNITY_OFFSET UNITYSDK_OFFSET(0x17EDCCE0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONTAINSSOPNODES_OFFSET UNITYSDK_OFFSET(0x17EDE5E0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTPOSITIONUNITYTOHOUDINI_1_OFFSET UNITYSDK_OFFSET(0x17EBC140)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTPOSITIONUNITYTOHOUDINI_2_OFFSET UNITYSDK_OFFSET(0x17EBD7F0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTPOSITIONUNITYTOHOUDINI_3_OFFSET UNITYSDK_OFFSET(0x17EE0330)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTPOSITIONUNITYTOHOUDINI_4_OFFSET UNITYSDK_OFFSET(0x17EB8C00)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTPOSITIONUNITYTOHOUDINI_OFFSET UNITYSDK_OFFSET(0x17EE0320)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTROTATIONUNITYTOHOUDINI_1_OFFSET UNITYSDK_OFFSET(0x17EBC170)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTROTATIONUNITYTOHOUDINI_2_OFFSET UNITYSDK_OFFSET(0x17EE0460)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTROTATIONUNITYTOHOUDINI_3_OFFSET UNITYSDK_OFFSET(0x17EE0590)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTROTATIONUNITYTOHOUDINI_OFFSET UNITYSDK_OFFSET(0x17EE0350)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTSCALEUNITYTOHOUDINI_1_OFFSET UNITYSDK_OFFSET(0x17EBC2E0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTSCALEUNITYTOHOUDINI_2_OFFSET UNITYSDK_OFFSET(0x17EE06B0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTSCALEUNITYTOHOUDINI_3_OFFSET UNITYSDK_OFFSET(0x17EE06D0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTSCALEUNITYTOHOUDINI_OFFSET UNITYSDK_OFFSET(0x17EE06A0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_COOKNODEINHOUDINIWITHOPTIONS_OFFSET UNITYSDK_OFFSET(0x17EBC5E0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_COOKNODEINHOUDINI_OFFSET UNITYSDK_OFFSET(0x17E9E9B0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CREATEANDCOOKASSETNODE_OFFSET UNITYSDK_OFFSET(0x17EDB690)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CREATEANDCOOKCURVEASSET_OFFSET UNITYSDK_OFFSET(0x17EDBE50)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CREATEANDCOOKINPUTASSET_OFFSET UNITYSDK_OFFSET(0x17EDBFF0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CREATENEWASSET_1_OFFSET UNITYSDK_OFFSET(0x17EDC1D0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CREATENEWASSET_OFFSET UNITYSDK_OFFSET(0x17EDC1A0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CREATENEWCURVEASSET_OFFSET UNITYSDK_OFFSET(0x17EDC690)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CREATENEWINPUTASSET_OFFSET UNITYSDK_OFFSET(0x17EDC6C0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_DESTROYCHILDREN_OFFSET UNITYSDK_OFFSET(0x17EDC700)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_DESTROYGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x17EB85F0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_DOESGEOPARTHAVEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x17EDE510)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_DOESMAPPEDPATHEXIST_OFFSET UNITYSDK_OFFSET(0x17EDAE90)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_FINDHOUDINIASSETFILEINPATHWITHEXT_OFFSET UNITYSDK_OFFSET(0x17EDB010)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GATHERALLASSETGEOINFOS_OFFSET UNITYSDK_OFFSET(0x17EDE880)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GATHERALLASSETOUTPUTS_OFFSET UNITYSDK_OFFSET(0x17EDEFB0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GATHERALLOBJECTGEOINFOS_OFFSET UNITYSDK_OFFSET(0x17EDF9A0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETASSETINSCENE_OFFSET UNITYSDK_OFFSET(0x17EDCBC0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETDEFAULTCOOKOPTIONS_OFFSET UNITYSDK_OFFSET(0x17EBC5A0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETENVIRONMENTPATH_OFFSET UNITYSDK_OFFSET(0x17EDAB60)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETHAPITRANSFORMFROMMATRIX_OFFSET UNITYSDK_OFFSET(0x17EDD550)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETHAPITRANSFORMQUATFROMMATRIX_OFFSET UNITYSDK_OFFSET(0x17EDDAF0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETHAPITRANSFORM_OFFSET UNITYSDK_OFFSET(0x17EDD920)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETHOUDINIENGINEINSTALLATIONINFO_OFFSET UNITYSDK_OFFSET(0x17EDAB50)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETMATRIX4X4_OFFSET UNITYSDK_OFFSET(0x17EDDF20)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETMATRIXFROMHAPITRANSFORM_OFFSET UNITYSDK_OFFSET(0x17EDD230)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETOBJECTINFOS_OFFSET UNITYSDK_OFFSET(0x17E9BFF0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETOUTPUTINDEX_OFFSET UNITYSDK_OFFSET(0x17EDE7F0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETPARENTNODEID_OFFSET UNITYSDK_OFFSET(0x17EDE570)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x17EDCF90)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETQUATERNION_OFFSET UNITYSDK_OFFSET(0x17EDCFB0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETREALPATHFROMHFSPATH_OFFSET UNITYSDK_OFFSET(0x17EDAC60)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETSCALE_OFFSET UNITYSDK_OFFSET(0x17EDD140)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_INSTANTIATEHDA_OFFSET UNITYSDK_OFFSET(0x17E9ACE0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISEQUALTOL_OFFSET UNITYSDK_OFFSET(0x17EDE1D0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISHOUDINIASSETFILE_OFFSET UNITYSDK_OFFSET(0x17EDAF30)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISNODEVALIDINHOUDINI_OFFSET UNITYSDK_OFFSET(0x17E9E920)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISOBJNODEFULLYVISIBLE_OFFSET UNITYSDK_OFFSET(0x17EDE640)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISSAMETRANSFORM_OFFSET UNITYSDK_OFFSET(0x17EDE030)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISSESSIONSYNCEQUAL_OFFSET UNITYSDK_OFFSET(0x17EDE4F0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISSUPPORTEDPOLYGONTYPE_OFFSET UNITYSDK_OFFSET(0x17EA9D30)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISTRANSFORMEQUAL_OFFSET UNITYSDK_OFFSET(0x17EDE1F0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISVIEWPORTEQUAL_OFFSET UNITYSDK_OFFSET(0x17EDE3F0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_LOADGEOWITHNEWGEOSYNC_OFFSET UNITYSDK_OFFSET(0x17EDC6F0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_LOADHDAFILE_OFFSET UNITYSDK_OFFSET(0x17EDB3A0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_LOCATEVALIDFILEPATH_1_OFFSET UNITYSDK_OFFSET(0x17EDB390)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_LOCATEVALIDFILEPATH_OFFSET UNITYSDK_OFFSET(0x17EDB350)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_LOGERROR_OFFSET UNITYSDK_OFFSET(0x17EDB340)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_LOGWARNING_OFFSET UNITYSDK_OFFSET(0x17EDB330)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_LOG_OFFSET UNITYSDK_OFFSET(0x17EDB2B0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_PROCESSHOUDINICOOKSTATUS_OFFSET UNITYSDK_OFFSET(0x17EDB870)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_SETANIMATIONCURVETANGENTMODES_OFFSET UNITYSDK_OFFSET(0x17EDE560)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_SETMATRIXPOSITION_OFFSET UNITYSDK_OFFSET(0x17EDD4F0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_TOHAPIVARIABLENAME_OFFSET UNITYSDK_OFFSET(0x17EE00E0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_HAPIUtility_TypeDefinitionIndex = 37470;
