...
#define HOUDINIENGINEUNITY_HEU_VECTOR2SERIALIZATIONSURROGATE_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZATIONSURROGATE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1B498150)
#define HOUDINIENGINEUNITY_HEU_VECTOR2SERIALIZATIONSURROGATE_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZATIONSURROGATE_SETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1B4982B0)
#define HOUDINIENGINEUNITY_HEU_VECTOR2SERIALIZATIONSURROGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4984B0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_Vector2SerializationSurrogate_TypeDefinitionIndex = 39077;
