...
#define HOUDINIENGINEUNITY_HEU_BASESYNC_ADDGENERATEDOUTPUTFILEPATH_OFFSET UNITYSDK_OFFSET(0x167CAE10)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_APPLYATTRIBUTEMODIFIERSONGAMEOBJECTOUTPUT_OFFSET UNITYSDK_OFFSET(0x167CB120)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_AWAKE_OFFSET UNITYSDK_OFFSET(0x167C74E0)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_BAKE_OFFSET UNITYSDK_OFFSET(0x167C7FB0)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_CLEARLOG_OFFSET UNITYSDK_OFFSET(0x167C7BD0)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_CREATENEWINSTANCEFROMOBJECT_OFFSET UNITYSDK_OFFSET(0x167CD2C0)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_DELETESESSIONDATA_OFFSET UNITYSDK_OFFSET(0x167BEFA0)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_DESTROYGENERATEDDATA_OFFSET UNITYSDK_OFFSET(0x167BF710)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_DESTROYOUTPUTS_OFFSET UNITYSDK_OFFSET(0x167C7640)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_ERROR_OFFSET UNITYSDK_OFFSET(0x167C7CF0)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_GENERATEALLINSTANCERS_OFFSET UNITYSDK_OFFSET(0x167CAB50)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_GENERATEGEOMETRY_OFFSET UNITYSDK_OFFSET(0x167C8A10)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_GENERATEINSTANCER_OFFSET UNITYSDK_OFFSET(0x167CBC70)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_GENERATEINSTANCESFROMASSETPATHS_OFFSET UNITYSDK_OFFSET(0x167CC850)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_GENERATEINSTANCESFROMNODEIDS_OFFSET UNITYSDK_OFFSET(0x167CC070)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_GENERATEMESH_OFFSET UNITYSDK_OFFSET(0x167C8B30)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_GENERATEOBJECTS_OFFSET UNITYSDK_OFFSET(0x167C8930)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_GENERATETERRAIN_OFFSET UNITYSDK_OFFSET(0x167C9300)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_GETHOUDINISESSION_OFFSET UNITYSDK_OFFSET(0x167C7860)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_GETOUTPUTCACHEDIRECTORY_OFFSET UNITYSDK_OFFSET(0x167CADB0)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_GETPARENTNODEID_OFFSET UNITYSDK_OFFSET(0x167C7570)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_GET_ONSYNCED_OFFSET UNITYSDK_OFFSET(0x167CEB30)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x167BF290)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_ISLOADED_OFFSET UNITYSDK_OFFSET(0x167C7D10)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_LOG_OFFSET UNITYSDK_OFFSET(0x167C7AC0)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x167C74F0)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_ONLOADCOMPLETE_OFFSET UNITYSDK_OFFSET(0x167BF480)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_ONSTOPPED_OFFSET UNITYSDK_OFFSET(0x167CABF0)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_RESET_OFFSET UNITYSDK_OFFSET(0x167C8730)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_RESYNC_OFFSET UNITYSDK_OFFSET(0x167C7EB0)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_SETOUTPUTCACHEDIRECTORY_OFFSET UNITYSDK_OFFSET(0x167CEB10)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_SETOUTPUTVISIBLITY_OFFSET UNITYSDK_OFFSET(0x167CB170)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_SETUPLOADTASK_OFFSET UNITYSDK_OFFSET(0x167C7D30)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_SET_ONSYNCED_OFFSET UNITYSDK_OFFSET(0x167CEB40)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_STARTSYNC_OFFSET UNITYSDK_OFFSET(0x167BF720)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_STOPSYNC_OFFSET UNITYSDK_OFFSET(0x167C7D40)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_SYNCUPDATE_OFFSET UNITYSDK_OFFSET(0x167CEB20)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_UNLOAD_OFFSET UNITYSDK_OFFSET(0x167C8480)
#define HOUDINIENGINEUNITY_HEU_BASESYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x167BFB60)
