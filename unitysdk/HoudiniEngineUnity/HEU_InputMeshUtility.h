...
#define HOUDINIENGINEUNITY_HEU_INPUTMESHUTILITY_SETMESHDETAILATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1087B640)
#define HOUDINIENGINEUNITY_HEU_INPUTMESHUTILITY_SETMESHPOINTATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x10879CA0)
#define HOUDINIENGINEUNITY_HEU_INPUTMESHUTILITY_SETMESHPOINTATTRIBUTE_2_OFFSET UNITYSDK_OFFSET(0x1087ADB0)
#define HOUDINIENGINEUNITY_HEU_INPUTMESHUTILITY_SETMESHPOINTATTRIBUTE_3_OFFSET UNITYSDK_OFFSET(0x1087B2E0)
#define HOUDINIENGINEUNITY_HEU_INPUTMESHUTILITY_SETMESHPOINTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x10871250)
#define HOUDINIENGINEUNITY_HEU_INPUTMESHUTILITY_SETMESHVERTEXATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x10871840)
#define HOUDINIENGINEUNITY_HEU_INPUTMESHUTILITY_SETMESHVERTEXFLOATATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x10871EA0)
#define HOUDINIENGINEUNITY_HEU_INPUTMESHUTILITY_UPLOADMESHINTOHOUDININODE_OFFSET UNITYSDK_OFFSET(0x1087A050)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_InputMeshUtility_TypeDefinitionIndex = 38497;
