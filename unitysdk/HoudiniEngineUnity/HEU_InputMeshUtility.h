...
#define HOUDINIENGINEUNITY_HEU_INPUTMESHUTILITY_SETMESHDETAILATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x17F158A0)
#define HOUDINIENGINEUNITY_HEU_INPUTMESHUTILITY_SETMESHPOINTATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x17F14200)
#define HOUDINIENGINEUNITY_HEU_INPUTMESHUTILITY_SETMESHPOINTATTRIBUTE_2_OFFSET UNITYSDK_OFFSET(0x17F150E0)
#define HOUDINIENGINEUNITY_HEU_INPUTMESHUTILITY_SETMESHPOINTATTRIBUTE_3_OFFSET UNITYSDK_OFFSET(0x17F15590)
#define HOUDINIENGINEUNITY_HEU_INPUTMESHUTILITY_SETMESHPOINTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x17F0CC80)
#define HOUDINIENGINEUNITY_HEU_INPUTMESHUTILITY_SETMESHVERTEXATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x17F0D130)
#define HOUDINIENGINEUNITY_HEU_INPUTMESHUTILITY_SETMESHVERTEXFLOATATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x17F0D630)
#define HOUDINIENGINEUNITY_HEU_INPUTMESHUTILITY_UPLOADMESHINTOHOUDININODE_OFFSET UNITYSDK_OFFSET(0x17F14550)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_InputMeshUtility_TypeDefinitionIndex = 37689;
