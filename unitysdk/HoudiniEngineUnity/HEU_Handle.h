...
#define HOUDINIENGINEUNITY_HEU_HANDLE_CLEANUP_OFFSET UNITYSDK_OFFSET(0x15049DD0)
#define HOUDINIENGINEUNITY_HEU_HANDLE_GENERATETRANSFORM_OFFSET UNITYSDK_OFFSET(0x150497A0)
#define HOUDINIENGINEUNITY_HEU_HANDLE_GETROTATEBINDING_OFFSET UNITYSDK_OFFSET(0x15049700)
#define HOUDINIENGINEUNITY_HEU_HANDLE_GETSCALEBINDING_OFFSET UNITYSDK_OFFSET(0x15049710)
#define HOUDINIENGINEUNITY_HEU_HANDLE_GETTRANSLATEBINDING_OFFSET UNITYSDK_OFFSET(0x150496F0)
#define HOUDINIENGINEUNITY_HEU_HANDLE_GETUPDATEDPOSITION_OFFSET UNITYSDK_OFFSET(0x15049E00)
#define HOUDINIENGINEUNITY_HEU_HANDLE_GETUPDATEDROTATION_OFFSET UNITYSDK_OFFSET(0x1504A0D0)
#define HOUDINIENGINEUNITY_HEU_HANDLE_GET_CONVERTEDTRANSFORMEULER_OFFSET UNITYSDK_OFFSET(0x15049630)
#define HOUDINIENGINEUNITY_HEU_HANDLE_GET_HANDLENAME_OFFSET UNITYSDK_OFFSET(0x150495F0)
#define HOUDINIENGINEUNITY_HEU_HANDLE_GET_HANDLEPOSITION_OFFSET UNITYSDK_OFFSET(0x15049720)
#define HOUDINIENGINEUNITY_HEU_HANDLE_GET_HANDLEROTATION_OFFSET UNITYSDK_OFFSET(0x15049740)
#define HOUDINIENGINEUNITY_HEU_HANDLE_GET_HANDLESCALE_OFFSET UNITYSDK_OFFSET(0x15049750)
#define HOUDINIENGINEUNITY_HEU_HANDLE_GET_HANDLETYPE_OFFSET UNITYSDK_OFFSET(0x15049600)
#define HOUDINIENGINEUNITY_HEU_HANDLE_GET_RSTORDER_OFFSET UNITYSDK_OFFSET(0x15049610)
#define HOUDINIENGINEUNITY_HEU_HANDLE_GET_XYZORDER_OFFSET UNITYSDK_OFFSET(0x15049620)
#define HOUDINIENGINEUNITY_HEU_HANDLE_HASROTATEHANDLE_OFFSET UNITYSDK_OFFSET(0x15049670)
#define HOUDINIENGINEUNITY_HEU_HANDLE_HASSCALEHANDLE_OFFSET UNITYSDK_OFFSET(0x15049680)
#define HOUDINIENGINEUNITY_HEU_HANDLE_HASTRANSLATEHANDLE_OFFSET UNITYSDK_OFFSET(0x15049660)
#define HOUDINIENGINEUNITY_HEU_HANDLE_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x1504A490)
#define HOUDINIENGINEUNITY_HEU_HANDLE_ISROTATEHANDLEDISABLED_OFFSET UNITYSDK_OFFSET(0x150496B0)
#define HOUDINIENGINEUNITY_HEU_HANDLE_ISSCALEHANDLEDISABLED_OFFSET UNITYSDK_OFFSET(0x150496D0)
#define HOUDINIENGINEUNITY_HEU_HANDLE_ISSPECIALRSTORDER_OFFSET UNITYSDK_OFFSET(0x15049DE0)
#define HOUDINIENGINEUNITY_HEU_HANDLE_ISTRANSLATEHANDLEDISABLED_OFFSET UNITYSDK_OFFSET(0x15049690)
#define HOUDINIENGINEUNITY_HEU_HANDLE_SETUPHANDLE_OFFSET UNITYSDK_OFFSET(0x1502D530)
#define HOUDINIENGINEUNITY_HEU_HANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1504A990)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_Handle_TypeDefinitionIndex = 38370;
