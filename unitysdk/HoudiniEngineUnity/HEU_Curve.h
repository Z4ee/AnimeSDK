...
#define HOUDINIENGINEUNITY_HEU_CURVE_ADDCURVEPOINTTOEND_1_OFFSET UNITYSDK_OFFSET(0x1501C880)
#define HOUDINIENGINEUNITY_HEU_CURVE_ADDCURVEPOINTTOEND_OFFSET UNITYSDK_OFFSET(0x1501C770)
#define HOUDINIENGINEUNITY_HEU_CURVE_CLEARCURVENODEDATA_OFFSET UNITYSDK_OFFSET(0x1501C9C0)
#define HOUDINIENGINEUNITY_HEU_CURVE_CREATESETUPCURVE_OFFSET UNITYSDK_OFFSET(0x1501DB30)
#define HOUDINIENGINEUNITY_HEU_CURVE_DESTROYALLDATA_OFFSET UNITYSDK_OFFSET(0x1501EDC0)
#define HOUDINIENGINEUNITY_HEU_CURVE_DOWNLOADASDEFAULTPRESETDATA_OFFSET UNITYSDK_OFFSET(0x15025420)
#define HOUDINIENGINEUNITY_HEU_CURVE_DOWNLOADPRESETDATA_OFFSET UNITYSDK_OFFSET(0x15024CD0)
#define HOUDINIENGINEUNITY_HEU_CURVE_DUPLICATECURVENODEDATA_OFFSET UNITYSDK_OFFSET(0x1501D8E0)
#define HOUDINIENGINEUNITY_HEU_CURVE_GENERATEMESHFORSINGLEOBJECT_OFFSET UNITYSDK_OFFSET(0x150206A0)
#define HOUDINIENGINEUNITY_HEU_CURVE_GENERATEMESH_OFFSET UNITYSDK_OFFSET(0x1501FC00)
#define HOUDINIENGINEUNITY_HEU_CURVE_GETALLPOINTS_OFFSET UNITYSDK_OFFSET(0x1501C4B0)
#define HOUDINIENGINEUNITY_HEU_CURVE_GETALLPOINTTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1501C4A0)
#define HOUDINIENGINEUNITY_HEU_CURVE_GETCURVECOUNTINDEXFROMPOSITIONINDEX_OFFSET UNITYSDK_OFFSET(0x15024E60)
#define HOUDINIENGINEUNITY_HEU_CURVE_GETCURVECOUNTS_OFFSET UNITYSDK_OFFSET(0x1501F790)
#define HOUDINIENGINEUNITY_HEU_CURVE_GETCURVEDATATYPE_OFFSET UNITYSDK_OFFSET(0x1501E360)
#define HOUDINIENGINEUNITY_HEU_CURVE_GETCURVEPOINT_OFFSET UNITYSDK_OFFSET(0x1501C420)
#define HOUDINIENGINEUNITY_HEU_CURVE_GETINVERTEDTRANSFORMEDDIRECTION_OFFSET UNITYSDK_OFFSET(0x15025220)
#define HOUDINIENGINEUNITY_HEU_CURVE_GETINVERTEDTRANSFORMEDPOSITION_OFFSET UNITYSDK_OFFSET(0x150251A0)
#define HOUDINIENGINEUNITY_HEU_CURVE_GETNUMPOINTS_OFFSET UNITYSDK_OFFSET(0x1501C620)
#define HOUDINIENGINEUNITY_HEU_CURVE_GETORDERFORCURVETYPE_OFFSET UNITYSDK_OFFSET(0x15008CD0)
#define HOUDINIENGINEUNITY_HEU_CURVE_GETPOINTSSTRING_1_OFFSET UNITYSDK_OFFSET(0x150236A0)
#define HOUDINIENGINEUNITY_HEU_CURVE_GETPOINTSSTRING_OFFSET UNITYSDK_OFFSET(0x15024F00)
#define HOUDINIENGINEUNITY_HEU_CURVE_GETSESSION_OFFSET UNITYSDK_OFFSET(0x1501C1C0)
#define HOUDINIENGINEUNITY_HEU_CURVE_GETTRANSFORMEDPOINTS_OFFSET UNITYSDK_OFFSET(0x1501D700)
#define HOUDINIENGINEUNITY_HEU_CURVE_GETTRANSFORMEDPOINT_OFFSET UNITYSDK_OFFSET(0x1501D550)
#define HOUDINIENGINEUNITY_HEU_CURVE_GETTRANSFORMEDPOSITION_OFFSET UNITYSDK_OFFSET(0x1501D680)
#define HOUDINIENGINEUNITY_HEU_CURVE_GETVERTICES_OFFSET UNITYSDK_OFFSET(0x150252A0)
#define HOUDINIENGINEUNITY_HEU_CURVE_GET_CURVEDATATYPE_OFFSET UNITYSDK_OFFSET(0x1501C1B0)
#define HOUDINIENGINEUNITY_HEU_CURVE_GET_CURVENAME_OFFSET UNITYSDK_OFFSET(0x1501C140)
#define HOUDINIENGINEUNITY_HEU_CURVE_GET_CURVENODEDATA_OFFSET UNITYSDK_OFFSET(0x1501C120)
#define HOUDINIENGINEUNITY_HEU_CURVE_GET_EDITSTATE_OFFSET UNITYSDK_OFFSET(0x1501C190)
#define HOUDINIENGINEUNITY_HEU_CURVE_GET_GEOID_OFFSET UNITYSDK_OFFSET(0x1501C100)
#define HOUDINIENGINEUNITY_HEU_CURVE_GET_INPUTCURVEINFO_OFFSET UNITYSDK_OFFSET(0x1501C170)
#define HOUDINIENGINEUNITY_HEU_CURVE_GET_ISINPUTCURVE_OFFSET UNITYSDK_OFFSET(0x1501C150)
#define HOUDINIENGINEUNITY_HEU_CURVE_GET_ISPARTCURVE_OFFSET UNITYSDK_OFFSET(0x1501C160)
#define HOUDINIENGINEUNITY_HEU_CURVE_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1501C130)
#define HOUDINIENGINEUNITY_HEU_CURVE_GET_PARENTASSET_OFFSET UNITYSDK_OFFSET(0x1501C1A0)
#define HOUDINIENGINEUNITY_HEU_CURVE_GET_PARTID_OFFSET UNITYSDK_OFFSET(0x1501C110)
#define HOUDINIENGINEUNITY_HEU_CURVE_GET_TARGETGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1501C0E0)
#define HOUDINIENGINEUNITY_HEU_CURVE_INSERTCURVEPOINT_1_OFFSET UNITYSDK_OFFSET(0x1501C710)
#define HOUDINIENGINEUNITY_HEU_CURVE_INSERTCURVEPOINT_OFFSET UNITYSDK_OFFSET(0x1501C640)
#define HOUDINIENGINEUNITY_HEU_CURVE_ISEDITABLE_OFFSET UNITYSDK_OFFSET(0x1501C250)
#define HOUDINIENGINEUNITY_HEU_CURVE_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x15025580)
#define HOUDINIENGINEUNITY_HEU_CURVE_ISGEOCURVE_OFFSET UNITYSDK_OFFSET(0x1501C260)
#define HOUDINIENGINEUNITY_HEU_CURVE_ISMESHCURVE_OFFSET UNITYSDK_OFFSET(0x1501FB40)
#define HOUDINIENGINEUNITY_HEU_CURVE_ONPRESYNCPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1501F200)
#define HOUDINIENGINEUNITY_HEU_CURVE_PROJECTTOCOLLIDERSINTERNAL_OFFSET UNITYSDK_OFFSET(0x1501CA80)
#define HOUDINIENGINEUNITY_HEU_CURVE_PROJECTTOCOLLIDERS_OFFSET UNITYSDK_OFFSET(0x1501CA30)
#define HOUDINIENGINEUNITY_HEU_CURVE_REBUILD_OFFSET UNITYSDK_OFFSET(0x1501C240)
#define HOUDINIENGINEUNITY_HEU_CURVE_RECOOK_OFFSET UNITYSDK_OFFSET(0x1501C230)
#define HOUDINIENGINEUNITY_HEU_CURVE_REMOVECURVEPOINT_OFFSET UNITYSDK_OFFSET(0x1501C920)
#define HOUDINIENGINEUNITY_HEU_CURVE_RESETCURVEPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1501F230)
#define HOUDINIENGINEUNITY_HEU_CURVE_SETCURVEGEOMETRYVISIBILITYINTERNAL_OFFSET UNITYSDK_OFFSET(0x1501D4B0)
#define HOUDINIENGINEUNITY_HEU_CURVE_SETCURVEGEOMETRYVISIBILITY_OFFSET UNITYSDK_OFFSET(0x1501D400)
#define HOUDINIENGINEUNITY_HEU_CURVE_SETCURVENAME_OFFSET UNITYSDK_OFFSET(0x1501C270)
#define HOUDINIENGINEUNITY_HEU_CURVE_SETCURVENODEDATA_OFFSET UNITYSDK_OFFSET(0x1501C410)
#define HOUDINIENGINEUNITY_HEU_CURVE_SETCURVEPARAMETERPRESET_OFFSET UNITYSDK_OFFSET(0x1501F330)
#define HOUDINIENGINEUNITY_HEU_CURVE_SETCURVEPOINT_1_OFFSET UNITYSDK_OFFSET(0x1501C2F0)
#define HOUDINIENGINEUNITY_HEU_CURVE_SETCURVEPOINT_OFFSET UNITYSDK_OFFSET(0x1501C290)
#define HOUDINIENGINEUNITY_HEU_CURVE_SETEDITSTATE_OFFSET UNITYSDK_OFFSET(0x15025190)
#define HOUDINIENGINEUNITY_HEU_CURVE_SETUPLOADPARAMETERPRESET_OFFSET UNITYSDK_OFFSET(0x1501C180)
#define HOUDINIENGINEUNITY_HEU_CURVE_SET_TARGETGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1501C0F0)
#define HOUDINIENGINEUNITY_HEU_CURVE_SHOULDKEEPNODE_OFFSET UNITYSDK_OFFSET(0x1501ED80)
#define HOUDINIENGINEUNITY_HEU_CURVE_SYNCFROMPARAMETERS_OFFSET UNITYSDK_OFFSET(0x15023A70)
#define HOUDINIENGINEUNITY_HEU_CURVE_UPDATECACHEDCURVEINFO_OFFSET UNITYSDK_OFFSET(0x1501E540)
#define HOUDINIENGINEUNITY_HEU_CURVE_UPDATECURVEINPUTFORCURVEPARTS_OFFSET UNITYSDK_OFFSET(0x15022990)
#define HOUDINIENGINEUNITY_HEU_CURVE_UPDATECURVEINPUTFORCUSTOMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x15020C20)
#define HOUDINIENGINEUNITY_HEU_CURVE_UPDATECURVE_OFFSET UNITYSDK_OFFSET(0x1501F420)
#define HOUDINIENGINEUNITY_HEU_CURVE_UPDATEPOINTS_OFFSET UNITYSDK_OFFSET(0x15023E20)
#define HOUDINIENGINEUNITY_HEU_CURVE_UPLOADPARAMETERPRESET_OFFSET UNITYSDK_OFFSET(0x1501EFE0)
#define HOUDINIENGINEUNITY_HEU_CURVE_UPLOADPRESETDATA_OFFSET UNITYSDK_OFFSET(0x150252B0)
#define HOUDINIENGINEUNITY_HEU_CURVE_USEPREVIOUSCURVEDATA_OFFSET UNITYSDK_OFFSET(0x1501E9E0)
#define HOUDINIENGINEUNITY_HEU_CURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x15025880)
