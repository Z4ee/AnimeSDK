...
#define HOUDINIENGINEUNITY_TEST_TREEINSTANCE_EXTENSIONS_TOTESTOBJECT_1_OFFSET UNITYSDK_OFFSET(0x17F841F0)
#define HOUDINIENGINEUNITY_TEST_TREEINSTANCE_EXTENSIONS_TOTESTOBJECT_2_OFFSET UNITYSDK_OFFSET(0x17F85F30)
#define HOUDINIENGINEUNITY_TEST_TREEINSTANCE_EXTENSIONS_TOTESTOBJECT_OFFSET UNITYSDK_OFFSET(0x17F85EC0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_TreeInstance_Extensions_TypeDefinitionIndex = 37794;
