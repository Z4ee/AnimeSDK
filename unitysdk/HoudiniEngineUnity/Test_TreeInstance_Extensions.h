...
#define HOUDINIENGINEUNITY_TEST_TREEINSTANCE_EXTENSIONS_TOTESTOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1D2104D0)
#define HOUDINIENGINEUNITY_TEST_TREEINSTANCE_EXTENSIONS_TOTESTOBJECT_2_OFFSET UNITYSDK_OFFSET(0x1D212210)
#define HOUDINIENGINEUNITY_TEST_TREEINSTANCE_EXTENSIONS_TOTESTOBJECT_OFFSET UNITYSDK_OFFSET(0x1D2121A0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_TreeInstance_Extensions_TypeDefinitionIndex = 38602;
