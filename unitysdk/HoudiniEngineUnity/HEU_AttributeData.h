...
#define HOUDINIENGINEUNITY_HEU_ATTRIBUTEDATA_COPYVALUESTO_OFFSET UNITYSDK_OFFSET(0x1500D2A0)
#define HOUDINIENGINEUNITY_HEU_ATTRIBUTEDATA_ISCOLORATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1500D230)
#define HOUDINIENGINEUNITY_HEU_ATTRIBUTEDATA_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x1500D390)
#define HOUDINIENGINEUNITY_HEU_ATTRIBUTEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1500D6D0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_AttributeData_TypeDefinitionIndex = 38266;
