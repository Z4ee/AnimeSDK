...
#define HOUDINIENGINEUNITY_HEU_LOADBUFFERMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B443C20)
...
namespace HoudiniEngineUnity
{
	...
	public:
		...
		::System::Boolean _bGenerateUVs; // 0x38
		::System::Boolean _bPartInstanced; // 0x39
		::System::Boolean _bGenerateTangents; // 0x3A
