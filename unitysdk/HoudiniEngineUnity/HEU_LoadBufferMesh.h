...
#define HOUDINIENGINEUNITY_HEU_LOADBUFFERMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x8C91D30)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_LoadBufferMesh_TypeDefinitionIndex = 43668;
