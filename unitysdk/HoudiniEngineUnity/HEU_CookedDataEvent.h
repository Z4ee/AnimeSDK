...
#define HOUDINIENGINEUNITY_HEU_COOKEDDATAEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x8C40840)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_CookedDataEvent_TypeDefinitionIndex = 43475;
