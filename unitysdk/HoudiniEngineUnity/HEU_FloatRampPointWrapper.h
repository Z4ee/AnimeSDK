...
#define HOUDINIENGINEUNITY_HEU_FLOATRAMPPOINTWRAPPER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x17EC03C0)
#define HOUDINIENGINEUNITY_HEU_FLOATRAMPPOINTWRAPPER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x17EC03D0)
#define HOUDINIENGINEUNITY_HEU_FLOATRAMPPOINTWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x17EC03E0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_FloatRampPointWrapper_TypeDefinitionIndex = 37608;
