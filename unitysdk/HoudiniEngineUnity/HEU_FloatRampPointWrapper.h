...
#define HOUDINIENGINEUNITY_HEU_FLOATRAMPPOINTWRAPPER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x15027C80)
#define HOUDINIENGINEUNITY_HEU_FLOATRAMPPOINTWRAPPER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x15027C90)
#define HOUDINIENGINEUNITY_HEU_FLOATRAMPPOINTWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x15027CA0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_FloatRampPointWrapper_TypeDefinitionIndex = 38416;
