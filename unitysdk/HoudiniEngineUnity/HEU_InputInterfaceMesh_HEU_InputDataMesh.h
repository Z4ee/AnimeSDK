...
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_HEU_INPUTDATAMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x8C8A8F0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_InputInterfaceMesh_HEU_InputDataMesh_TypeDefinitionIndex = 43703;
	...
	public:
		...
		::System::Int32 _numSubMeshes; // 0x48
		::System::Int32 _numVertices; // 0x4C
