...
#define HOUDINIENGINEUNITY_HEU_TOPNETWORKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17F5CA00)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_TOPNetworkData_TypeDefinitionIndex = 37574;
