...
#define HOUDINIENGINEUNITY_HEU_TOPNETWORKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B486410)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_TOPNetworkData_TypeDefinitionIndex = 39241;
