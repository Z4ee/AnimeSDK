...
#define HOUDINIENGINEUNITY_JSONNODE__GET_DEEPCHILDREN_D__42_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x17F7A470)
#define HOUDINIENGINEUNITY_JSONNODE__GET_DEEPCHILDREN_D__42_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_HOUDINIENGINEUNITY_JSONNODE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x17F7AAE0)
#define HOUDINIENGINEUNITY_JSONNODE__GET_DEEPCHILDREN_D__42_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_HOUDINIENGINEUNITY_JSONNODE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x17F7AA70)
#define HOUDINIENGINEUNITY_JSONNODE__GET_DEEPCHILDREN_D__42_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x17F7AB60)
#define HOUDINIENGINEUNITY_JSONNODE__GET_DEEPCHILDREN_D__42_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x17F7AAD0)
#define HOUDINIENGINEUNITY_JSONNODE__GET_DEEPCHILDREN_D__42_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x17F7AA80)
#define HOUDINIENGINEUNITY_JSONNODE__GET_DEEPCHILDREN_D__42_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17F7A170)
#define HOUDINIENGINEUNITY_JSONNODE__GET_DEEPCHILDREN_D__42__CTOR_OFFSET UNITYSDK_OFFSET(0x17F76310)
#define HOUDINIENGINEUNITY_JSONNODE__GET_DEEPCHILDREN_D__42___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x17F7A3D0)
#define HOUDINIENGINEUNITY_JSONNODE__GET_DEEPCHILDREN_D__42___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x17F7A330)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int JSONNode__get_DeepChildren_d__42_TypeDefinitionIndex = 37711;

	class JSONNode__get_DeepChildren_d__42 : public ::System::Object
	{
	public:
		::HoudiniEngineUnity::JSONNode* __2__current; // 0x10
		::HoudiniEngineUnity::JSONNode* __4__this; // 0x18
