...
#define HOUDINIENGINEUNITY_HAPI_ATTRIBUTEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x38DF160)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HAPI_AttributeInfo_TypeDefinitionIndex = 38350;
