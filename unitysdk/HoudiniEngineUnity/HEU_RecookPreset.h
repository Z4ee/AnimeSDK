...
#define HOUDINIENGINEUNITY_HEU_RECOOKPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B479C50)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_RecookPreset_TypeDefinitionIndex = 39074;
