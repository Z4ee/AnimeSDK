...
#define HOUDINIENGINEUNITY_HEU_RECOOKPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x197C0550)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_RecookPreset_TypeDefinitionIndex = 38215;
