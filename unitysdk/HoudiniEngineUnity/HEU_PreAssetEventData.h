...
#define HOUDINIENGINEUNITY_HEU_PREASSETEVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x848B640)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_PreAssetEventData_TypeDefinitionIndex = 37594;
