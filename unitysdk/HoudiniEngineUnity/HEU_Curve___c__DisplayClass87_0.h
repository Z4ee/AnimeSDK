...
#define HOUDINIENGINEUNITY_HEU_CURVE___C__DISPLAYCLASS87_0__CTOR_OFFSET UNITYSDK_OFFSET(0x150234C0)
#define HOUDINIENGINEUNITY_HEU_CURVE___C__DISPLAYCLASS87_0__UPDATECURVEINPUTFORCURVEPARTS_B__0_OFFSET UNITYSDK_OFFSET(0x15025980)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_Curve___c__DisplayClass87_0_TypeDefinitionIndex = 38229;
	...
	public:
		...
		::System::Collections::Generic::List_1<::System::Int32>* curveCountIndices; // 0x18
		::System::Collections::Generic::List_1<::UnityEngine::Vector3>* positions; // 0x20
		::System::Collections::Generic::List_1<::UnityEngine::Quaternion>* rotations; // 0x28
		::System::Boolean hasRotations; // 0x30
		::System::Boolean hasScales; // 0x31
