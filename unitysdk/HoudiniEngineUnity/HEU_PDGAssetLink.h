...
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_AWAKE_OFFSET UNITYSDK_OFFSET(0x10891B20)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_CANCELCOOK_OFFSET UNITYSDK_OFFSET(0x108914F0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_CLEARALLTOPDATA_OFFSET UNITYSDK_OFFSET(0x10890240)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_CLEARTOPNETWORKWORKITEMRESULTS_OFFSET UNITYSDK_OFFSET(0x10890F40)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_CLEARTOPNODEWORKITEMRESULTS_OFFSET UNITYSDK_OFFSET(0x10890C80)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_CLEARWORKITEMRESULTBYID_OFFSET UNITYSDK_OFFSET(0x108932F0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_CLEARWORKITEMRESULT_OFFSET UNITYSDK_OFFSET(0x10893460)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_COOKOUTPUT_OFFSET UNITYSDK_OFFSET(0x10891030)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_COOKTOPNODE_OFFSET UNITYSDK_OFFSET(0x10890DD0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_DESTROYWORKITEMRESULTDATA_OFFSET UNITYSDK_OFFSET(0x108930A0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_DIRTYALL_OFFSET UNITYSDK_OFFSET(0x10890E70)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_DIRTYTOPNODE_OFFSET UNITYSDK_OFFSET(0x10890B60)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETHAPISESSION_OFFSET UNITYSDK_OFFSET(0x10891250)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETLOADROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x10894070)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETNONHIDDENTOPNODES_OFFSET UNITYSDK_OFFSET(0x108907C0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETSELECTEDTOPNETWORK_OFFSET UNITYSDK_OFFSET(0x10890A20)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETSELECTEDTOPNODE_OFFSET UNITYSDK_OFFSET(0x10890AD0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETTOPNETWORKBYNAME_OFFSET UNITYSDK_OFFSET(0x108918A0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETTOPNETWORK_OFFSET UNITYSDK_OFFSET(0x10890A80)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETTOPNODEBYNAME_OFFSET UNITYSDK_OFFSET(0x108919E0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETTOPNODESTATUS_OFFSET UNITYSDK_OFFSET(0x10891800)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETTOPNODE_OFFSET UNITYSDK_OFFSET(0x108916B0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETWORKRESULTBYID_OFFSET UNITYSDK_OFFSET(0x10893370)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_ASSETGO_OFFSET UNITYSDK_OFFSET(0x1088FEA0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_ASSETID_OFFSET UNITYSDK_OFFSET(0x1088FEC0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_ASSETLINKSTATEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1088FF50)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_ASSETNAME_OFFSET UNITYSDK_OFFSET(0x1088FEB0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_ASSETPATH_OFFSET UNITYSDK_OFFSET(0x1088FE90)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_AUTOCOOK_OFFSET UNITYSDK_OFFSET(0x1088FDC0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_COOKEDDATAEVENT_OFFSET UNITYSDK_OFFSET(0x1088FF40)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_LOADROOTGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1088FF20)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_OUTPUTCACHEPATHROOT_OFFSET UNITYSDK_OFFSET(0x1088FF30)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_PARENTASSET_OFFSET UNITYSDK_OFFSET(0x1088FE80)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_PDGLINKSTATE_OFFSET UNITYSDK_OFFSET(0x1088FF00)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_SELECTEDTOPNETWORK_OFFSET UNITYSDK_OFFSET(0x1088FEF0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_TOPNETWORKNAMES_OFFSET UNITYSDK_OFFSET(0x1088FEE0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_TOPNETWORKS_OFFSET UNITYSDK_OFFSET(0x1088FED0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_TOPNODEFILTER_OFFSET UNITYSDK_OFFSET(0x1088FE40)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_TOPOUTPUTFILTER_OFFSET UNITYSDK_OFFSET(0x1088FE60)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_USEHENGINEDATA_OFFSET UNITYSDK_OFFSET(0x1088FDE0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_USETOPNODEFILTER_OFFSET UNITYSDK_OFFSET(0x1088FE00)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_USETOPOUTPUTFILTER_OFFSET UNITYSDK_OFFSET(0x1088FE20)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_HANDLEINITIALLOAD_OFFSET UNITYSDK_OFFSET(0x10891B30)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_LINKSTATE_INTERNALTOWRAPPER_OFFSET UNITYSDK_OFFSET(0x1088FF10)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_LINKSTATE_WRAPPERTOINTERNAL_OFFSET UNITYSDK_OFFSET(0x10894A50)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_LOADRESULTS_OFFSET UNITYSDK_OFFSET(0x10893510)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_NOTIFYASSETCOOKED_1_OFFSET UNITYSDK_OFFSET(0x10891C20)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_NOTIFYASSETCOOKED_2_OFFSET UNITYSDK_OFFSET(0x10891C50)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_NOTIFYASSETCOOKED_OFFSET UNITYSDK_OFFSET(0x10891BF0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x10891B50)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x10891B40)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x10891B60)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_ONSYNCCOMPLETE_OFFSET UNITYSDK_OFFSET(0x108949F0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_ONTOPNODEFILTERCHANGED_OFFSET UNITYSDK_OFFSET(0x10894300)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_ONTOPOUTPUTFILTERCHANGED_OFFSET UNITYSDK_OFFSET(0x108946B0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_PARSEHENGINEDATA_OFFSET UNITYSDK_OFFSET(0x10892750)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_PAUSECOOK_OFFSET UNITYSDK_OFFSET(0x10891330)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_POPULATEFROMHDA_OFFSET UNITYSDK_OFFSET(0x108904E0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_POPULATETOPNETWORKS_OFFSET UNITYSDK_OFFSET(0x10891C80)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_POPULATETOPNODES_OFFSET UNITYSDK_OFFSET(0x108929E0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_REFRESH_OFFSET UNITYSDK_OFFSET(0x1088FF70)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_REPAINTUI_OFFSET UNITYSDK_OFFSET(0x108904C0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_RESETTOPNETWORKWORKITEMTALLY_OFFSET UNITYSDK_OFFSET(0x10891270)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_RESET_OFFSET UNITYSDK_OFFSET(0x1088FF60)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SELECTTOPNETWORK_OFFSET UNITYSDK_OFFSET(0x108909B0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SELECTTOPNODE_OFFSET UNITYSDK_OFFSET(0x108909E0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SETUPTOPNETWORKNAMES_OFFSET UNITYSDK_OFFSET(0x10892FD0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SETUP_OFFSET UNITYSDK_OFFSET(0x1084CBB0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SET_AUTOCOOK_OFFSET UNITYSDK_OFFSET(0x1088FDD0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SET_TOPNODEFILTER_OFFSET UNITYSDK_OFFSET(0x1088FE50)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SET_TOPOUTPUTFILTER_OFFSET UNITYSDK_OFFSET(0x1088FE70)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SET_USEHENGINEDATA_OFFSET UNITYSDK_OFFSET(0x1088FDF0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SET_USETOPNODEFILTER_OFFSET UNITYSDK_OFFSET(0x1088FE10)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SET_USETOPOUTPUTFILTER_OFFSET UNITYSDK_OFFSET(0x1088FE30)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_UPDATETOPNODERESULTSVISIBILITY_OFFSET UNITYSDK_OFFSET(0x108934D0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_UPDATEWORKITEMTALLY_OFFSET UNITYSDK_OFFSET(0x10894180)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x10894A60)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_PDGAssetLink_TypeDefinitionIndex = 38376;
