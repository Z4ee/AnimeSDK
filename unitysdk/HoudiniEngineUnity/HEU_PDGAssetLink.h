...
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B4510D0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_CANCELCOOK_OFFSET UNITYSDK_OFFSET(0x1B450A20)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_CLEARALLTOPDATA_OFFSET UNITYSDK_OFFSET(0x1B44F7A0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_CLEARTOPNETWORKWORKITEMRESULTS_OFFSET UNITYSDK_OFFSET(0x1B450470)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_CLEARTOPNODEWORKITEMRESULTS_OFFSET UNITYSDK_OFFSET(0x1B4501B0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_CLEARWORKITEMRESULTBYID_OFFSET UNITYSDK_OFFSET(0x1B4528F0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_CLEARWORKITEMRESULT_OFFSET UNITYSDK_OFFSET(0x1B452A60)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_COOKOUTPUT_OFFSET UNITYSDK_OFFSET(0x1B450560)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_COOKTOPNODE_OFFSET UNITYSDK_OFFSET(0x1B450300)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_DESTROYWORKITEMRESULTDATA_OFFSET UNITYSDK_OFFSET(0x1B4526A0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_DIRTYALL_OFFSET UNITYSDK_OFFSET(0x1B4503A0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_DIRTYTOPNODE_OFFSET UNITYSDK_OFFSET(0x1B450090)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETHAPISESSION_OFFSET UNITYSDK_OFFSET(0x1B450780)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETLOADROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B453670)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETNONHIDDENTOPNODES_OFFSET UNITYSDK_OFFSET(0x1B44FCF0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETSELECTEDTOPNETWORK_OFFSET UNITYSDK_OFFSET(0x1B44FF50)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETSELECTEDTOPNODE_OFFSET UNITYSDK_OFFSET(0x1B450000)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETTOPNETWORKBYNAME_OFFSET UNITYSDK_OFFSET(0x1B450DD0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETTOPNETWORK_OFFSET UNITYSDK_OFFSET(0x1B44FFB0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETTOPNODEBYNAME_OFFSET UNITYSDK_OFFSET(0x1B450F50)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETTOPNODESTATUS_OFFSET UNITYSDK_OFFSET(0x1B450D30)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETTOPNODE_OFFSET UNITYSDK_OFFSET(0x1B450BE0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETWORKRESULTBYID_OFFSET UNITYSDK_OFFSET(0x1B452970)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_ASSETGO_OFFSET UNITYSDK_OFFSET(0x1B44F400)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_ASSETID_OFFSET UNITYSDK_OFFSET(0x1B44F420)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_ASSETLINKSTATEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B44F4B0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_ASSETNAME_OFFSET UNITYSDK_OFFSET(0x1B44F410)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_ASSETPATH_OFFSET UNITYSDK_OFFSET(0x1B44F3F0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_AUTOCOOK_OFFSET UNITYSDK_OFFSET(0x1B44F320)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_COOKEDDATAEVENT_OFFSET UNITYSDK_OFFSET(0x1B44F4A0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_LOADROOTGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B44F480)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_OUTPUTCACHEPATHROOT_OFFSET UNITYSDK_OFFSET(0x1B44F490)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_PARENTASSET_OFFSET UNITYSDK_OFFSET(0x1B44F3E0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_PDGLINKSTATE_OFFSET UNITYSDK_OFFSET(0x1B44F460)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_SELECTEDTOPNETWORK_OFFSET UNITYSDK_OFFSET(0x1B44F450)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_TOPNETWORKNAMES_OFFSET UNITYSDK_OFFSET(0x1B44F440)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_TOPNETWORKS_OFFSET UNITYSDK_OFFSET(0x1B44F430)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_TOPNODEFILTER_OFFSET UNITYSDK_OFFSET(0x1B44F3A0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_TOPOUTPUTFILTER_OFFSET UNITYSDK_OFFSET(0x1B44F3C0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_USEHENGINEDATA_OFFSET UNITYSDK_OFFSET(0x1B44F340)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_USETOPNODEFILTER_OFFSET UNITYSDK_OFFSET(0x1B44F360)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_USETOPOUTPUTFILTER_OFFSET UNITYSDK_OFFSET(0x1B44F380)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_HANDLEINITIALLOAD_OFFSET UNITYSDK_OFFSET(0x1B4510E0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_LINKSTATE_INTERNALTOWRAPPER_OFFSET UNITYSDK_OFFSET(0x1B44F470)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_LINKSTATE_WRAPPERTOINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B454050)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_LOADRESULTS_OFFSET UNITYSDK_OFFSET(0x1B452B10)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_NOTIFYASSETCOOKED_1_OFFSET UNITYSDK_OFFSET(0x1B4511D0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_NOTIFYASSETCOOKED_2_OFFSET UNITYSDK_OFFSET(0x1B451200)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_NOTIFYASSETCOOKED_OFFSET UNITYSDK_OFFSET(0x1B4511A0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B451100)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B4510F0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B451110)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_ONSYNCCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1B453FF0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_ONTOPNODEFILTERCHANGED_OFFSET UNITYSDK_OFFSET(0x1B453900)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_ONTOPOUTPUTFILTERCHANGED_OFFSET UNITYSDK_OFFSET(0x1B453CB0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_PARSEHENGINEDATA_OFFSET UNITYSDK_OFFSET(0x1B451D00)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_PAUSECOOK_OFFSET UNITYSDK_OFFSET(0x1B450860)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_POPULATEFROMHDA_OFFSET UNITYSDK_OFFSET(0x1B44FA40)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_POPULATETOPNETWORKS_OFFSET UNITYSDK_OFFSET(0x1B451230)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_POPULATETOPNODES_OFFSET UNITYSDK_OFFSET(0x1B451FE0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_REFRESH_OFFSET UNITYSDK_OFFSET(0x1B44F4D0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_REPAINTUI_OFFSET UNITYSDK_OFFSET(0x1B44FA20)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_RESETTOPNETWORKWORKITEMTALLY_OFFSET UNITYSDK_OFFSET(0x1B4507A0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_RESET_OFFSET UNITYSDK_OFFSET(0x1B44F4C0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SELECTTOPNETWORK_OFFSET UNITYSDK_OFFSET(0x1B44FEE0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SELECTTOPNODE_OFFSET UNITYSDK_OFFSET(0x1B44FF10)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SETUPTOPNETWORKNAMES_OFFSET UNITYSDK_OFFSET(0x1B4525D0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SETUP_OFFSET UNITYSDK_OFFSET(0x1B40BE60)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SET_AUTOCOOK_OFFSET UNITYSDK_OFFSET(0x1B44F330)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SET_TOPNODEFILTER_OFFSET UNITYSDK_OFFSET(0x1B44F3B0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SET_TOPOUTPUTFILTER_OFFSET UNITYSDK_OFFSET(0x1B44F3D0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SET_USEHENGINEDATA_OFFSET UNITYSDK_OFFSET(0x1B44F350)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SET_USETOPNODEFILTER_OFFSET UNITYSDK_OFFSET(0x1B44F370)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SET_USETOPOUTPUTFILTER_OFFSET UNITYSDK_OFFSET(0x1B44F390)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_UPDATETOPNODERESULTSVISIBILITY_OFFSET UNITYSDK_OFFSET(0x1B452AD0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_UPDATEWORKITEMTALLY_OFFSET UNITYSDK_OFFSET(0x1B453780)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B454060)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_PDGAssetLink_TypeDefinitionIndex = 39235;
