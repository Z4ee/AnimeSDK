...
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_AWAKE_OFFSET UNITYSDK_OFFSET(0x11A74390)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_CANCELCOOK_OFFSET UNITYSDK_OFFSET(0x11A73CE0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_CLEARALLTOPDATA_OFFSET UNITYSDK_OFFSET(0x11A72A60)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_CLEARTOPNETWORKWORKITEMRESULTS_OFFSET UNITYSDK_OFFSET(0x11A73730)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_CLEARTOPNODEWORKITEMRESULTS_OFFSET UNITYSDK_OFFSET(0x11A73470)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_CLEARWORKITEMRESULTBYID_OFFSET UNITYSDK_OFFSET(0x11A75BB0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_CLEARWORKITEMRESULT_OFFSET UNITYSDK_OFFSET(0x11A75D20)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_COOKOUTPUT_OFFSET UNITYSDK_OFFSET(0x11A73820)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_COOKTOPNODE_OFFSET UNITYSDK_OFFSET(0x11A735C0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_DESTROYWORKITEMRESULTDATA_OFFSET UNITYSDK_OFFSET(0x11A75960)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_DIRTYALL_OFFSET UNITYSDK_OFFSET(0x11A73660)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_DIRTYTOPNODE_OFFSET UNITYSDK_OFFSET(0x11A73350)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETHAPISESSION_OFFSET UNITYSDK_OFFSET(0x11A73A40)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETLOADROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x11A76930)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETNONHIDDENTOPNODES_OFFSET UNITYSDK_OFFSET(0x11A72FB0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETSELECTEDTOPNETWORK_OFFSET UNITYSDK_OFFSET(0x11A73210)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETSELECTEDTOPNODE_OFFSET UNITYSDK_OFFSET(0x11A732C0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETTOPNETWORKBYNAME_OFFSET UNITYSDK_OFFSET(0x11A74090)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETTOPNETWORK_OFFSET UNITYSDK_OFFSET(0x11A73270)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETTOPNODEBYNAME_OFFSET UNITYSDK_OFFSET(0x11A74210)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETTOPNODESTATUS_OFFSET UNITYSDK_OFFSET(0x11A73FF0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETTOPNODE_OFFSET UNITYSDK_OFFSET(0x11A73EA0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETWORKRESULTBYID_OFFSET UNITYSDK_OFFSET(0x11A75C30)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_ASSETGO_OFFSET UNITYSDK_OFFSET(0x11A726C0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_ASSETID_OFFSET UNITYSDK_OFFSET(0x11A726E0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_ASSETLINKSTATEINTERNAL_OFFSET UNITYSDK_OFFSET(0x11A72770)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_ASSETNAME_OFFSET UNITYSDK_OFFSET(0x11A726D0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_ASSETPATH_OFFSET UNITYSDK_OFFSET(0x11A726B0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_AUTOCOOK_OFFSET UNITYSDK_OFFSET(0x11A725E0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_COOKEDDATAEVENT_OFFSET UNITYSDK_OFFSET(0x11A72760)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_LOADROOTGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x11A72740)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_OUTPUTCACHEPATHROOT_OFFSET UNITYSDK_OFFSET(0x11A72750)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_PARENTASSET_OFFSET UNITYSDK_OFFSET(0x11A726A0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_PDGLINKSTATE_OFFSET UNITYSDK_OFFSET(0x11A72720)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_SELECTEDTOPNETWORK_OFFSET UNITYSDK_OFFSET(0x11A72710)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_TOPNETWORKNAMES_OFFSET UNITYSDK_OFFSET(0x11A72700)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_TOPNETWORKS_OFFSET UNITYSDK_OFFSET(0x11A726F0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_TOPNODEFILTER_OFFSET UNITYSDK_OFFSET(0x11A72660)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_TOPOUTPUTFILTER_OFFSET UNITYSDK_OFFSET(0x11A72680)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_USEHENGINEDATA_OFFSET UNITYSDK_OFFSET(0x11A72600)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_USETOPNODEFILTER_OFFSET UNITYSDK_OFFSET(0x11A72620)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_USETOPOUTPUTFILTER_OFFSET UNITYSDK_OFFSET(0x11A72640)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_HANDLEINITIALLOAD_OFFSET UNITYSDK_OFFSET(0x11A743A0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_LINKSTATE_INTERNALTOWRAPPER_OFFSET UNITYSDK_OFFSET(0x11A72730)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_LINKSTATE_WRAPPERTOINTERNAL_OFFSET UNITYSDK_OFFSET(0x11A77310)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_LOADRESULTS_OFFSET UNITYSDK_OFFSET(0x11A75DD0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_NOTIFYASSETCOOKED_1_OFFSET UNITYSDK_OFFSET(0x11A74490)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_NOTIFYASSETCOOKED_2_OFFSET UNITYSDK_OFFSET(0x11A744C0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_NOTIFYASSETCOOKED_OFFSET UNITYSDK_OFFSET(0x11A74460)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x11A743C0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x11A743B0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x11A743D0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_ONSYNCCOMPLETE_OFFSET UNITYSDK_OFFSET(0x11A772B0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_ONTOPNODEFILTERCHANGED_OFFSET UNITYSDK_OFFSET(0x11A76BC0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_ONTOPOUTPUTFILTERCHANGED_OFFSET UNITYSDK_OFFSET(0x11A76F70)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_PARSEHENGINEDATA_OFFSET UNITYSDK_OFFSET(0x11A74FC0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_PAUSECOOK_OFFSET UNITYSDK_OFFSET(0x11A73B20)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_POPULATEFROMHDA_OFFSET UNITYSDK_OFFSET(0x11A72D00)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_POPULATETOPNETWORKS_OFFSET UNITYSDK_OFFSET(0x11A744F0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_POPULATETOPNODES_OFFSET UNITYSDK_OFFSET(0x11A752A0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_REFRESH_OFFSET UNITYSDK_OFFSET(0x11A72790)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_REPAINTUI_OFFSET UNITYSDK_OFFSET(0x11A72CE0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_RESETTOPNETWORKWORKITEMTALLY_OFFSET UNITYSDK_OFFSET(0x11A73A60)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_RESET_OFFSET UNITYSDK_OFFSET(0x11A72780)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SELECTTOPNETWORK_OFFSET UNITYSDK_OFFSET(0x11A731A0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SELECTTOPNODE_OFFSET UNITYSDK_OFFSET(0x11A731D0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SETUPTOPNETWORKNAMES_OFFSET UNITYSDK_OFFSET(0x11A75890)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SETUP_OFFSET UNITYSDK_OFFSET(0x11A2F110)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SET_AUTOCOOK_OFFSET UNITYSDK_OFFSET(0x11A725F0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SET_TOPNODEFILTER_OFFSET UNITYSDK_OFFSET(0x11A72670)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SET_TOPOUTPUTFILTER_OFFSET UNITYSDK_OFFSET(0x11A72690)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SET_USEHENGINEDATA_OFFSET UNITYSDK_OFFSET(0x11A72610)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SET_USETOPNODEFILTER_OFFSET UNITYSDK_OFFSET(0x11A72630)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SET_USETOPOUTPUTFILTER_OFFSET UNITYSDK_OFFSET(0x11A72650)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_UPDATETOPNODERESULTSVISIBILITY_OFFSET UNITYSDK_OFFSET(0x11A75D90)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_UPDATEWORKITEMTALLY_OFFSET UNITYSDK_OFFSET(0x11A76A40)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x11A77320)
