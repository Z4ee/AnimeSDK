...
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_COPYMATERIAL_OFFSET UNITYSDK_OFFSET(0x8C94280)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_CREATEHOUDINIMATERIALDATA_OFFSET UNITYSDK_OFFSET(0x8C94B50)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_CREATEMATERIALINCACHE_OFFSET UNITYSDK_OFFSET(0x8C947C0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_CREATENEWHOUDINISTANDARDMATERIAL_OFFSET UNITYSDK_OFFSET(0x8C92F80)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_CREATEUNITYSUBSTANCEMATERIALDATA_OFFSET UNITYSDK_OFFSET(0x8C944E0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_DELETEASSETMATERIAL_OFFSET UNITYSDK_OFFSET(0x8C7CFA0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_DESTROYNONASSETMATERIAL_OFFSET UNITYSDK_OFFSET(0x8C93070)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_DOESMATERIALEXISTINASSETCACHE_OFFSET UNITYSDK_OFFSET(0x8C93040)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_ENABLEGPUINSTANCING_OFFSET UNITYSDK_OFFSET(0x8C94240)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_EXTRACTHOUDINIIMAGETOTEXTUREFILE_OFFSET UNITYSDK_OFFSET(0x8C93630)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_EXTRACTHOUDINIIMAGETOTEXTUREPNGJPEG_OFFSET UNITYSDK_OFFSET(0x8C93470)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_EXTRACTHOUDINIIMAGETOTEXTURERAW_OFFSET UNITYSDK_OFFSET(0x8C930B0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_FINDPLUGINSHADER_OFFSET UNITYSDK_OFFSET(0x8C91FB0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_FINDSHADER_OFFSET UNITYSDK_OFFSET(0x8C92D20)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_GENERATEDEFAULTMATERIALNAME_OFFSET UNITYSDK_OFFSET(0x8C949B0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_GETDEFAULTSTANDARDMATERIAL_OFFSET UNITYSDK_OFFSET(0x8C942B0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_GETMATERIALDATAFROMCACHE_OFFSET UNITYSDK_OFFSET(0x8C94A50)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_GETMATERIALDATAMAPFROMCACHE_OFFSET UNITYSDK_OFFSET(0x8C94C10)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_GETNEWMATERIALWITHSHADER_OFFSET UNITYSDK_OFFSET(0x8C92DD0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_GETORCREATEDEFAULTMATERIALINCACHE_OFFSET UNITYSDK_OFFSET(0x8C94860)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_GETUNITYSUBSTANCEMATERIALKEY_OFFSET UNITYSDK_OFFSET(0x8C94020)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_LOADSUBSTANCEMATERIALWITHINDEX_OFFSET UNITYSDK_OFFSET(0x8C93CF0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_LOADSUBSTANCEMATERIALWITHNAME_OFFSET UNITYSDK_OFFSET(0x8C939F0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_LOADTEXTURE_OFFSET UNITYSDK_OFFSET(0x8C94320)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_LOADUNITYMATERIAL_OFFSET UNITYSDK_OFFSET(0x8C93830)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_MATERIALHASGPUINSTANCINGENABLED_OFFSET UNITYSDK_OFFSET(0x8C94260)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_MATERIALNAMETOKEY_OFFSET UNITYSDK_OFFSET(0x8C941B0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_RENDERANDEXTRACTIMAGETOTEXTURE_OFFSET UNITYSDK_OFFSET(0x8C92510)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_WHITETEXTURE_OFFSET UNITYSDK_OFFSET(0x8C944D0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_WRITEMATERIALTOASSETCACHE_OFFSET UNITYSDK_OFFSET(0x8C92FA0)
...
namespace HoudiniEngineUnity
{
	...
	public:
		...
		{
			return (::UnityEngine::Material**)Il2CppClass::FromTypeDefinitionIndex(HEU_MaterialFactory_TypeDefinitionIndex)->GetStaticField(0x40860);
		}
