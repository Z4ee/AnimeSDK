...
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_COPYMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B448420)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_CREATEHOUDINIMATERIALDATA_OFFSET UNITYSDK_OFFSET(0x1B448FC0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_CREATEMATERIALINCACHE_1_OFFSET UNITYSDK_OFFSET(0x1B448BE0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_CREATEMATERIALINCACHE_OFFSET UNITYSDK_OFFSET(0x1B448CD0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_CREATENEWHOUDINISTANDARDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B4465E0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_CREATEUNITYSUBSTANCEMATERIALDATA_OFFSET UNITYSDK_OFFSET(0x1B4485D0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_DELETEASSETMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B422FF0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_DESTROYNONASSETMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B4466D0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_DOESMATERIALEXISTINASSETCACHE_OFFSET UNITYSDK_OFFSET(0x1B446690)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_ENABLEGPUINSTANCING_OFFSET UNITYSDK_OFFSET(0x1B4483E0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_EXTRACTHOUDINIIMAGETOTEXTUREFILE_OFFSET UNITYSDK_OFFSET(0x1B447100)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_EXTRACTHOUDINIIMAGETOTEXTUREPNGJPEG_OFFSET UNITYSDK_OFFSET(0x1B446E40)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_EXTRACTHOUDINIIMAGETOTEXTURERAW_OFFSET UNITYSDK_OFFSET(0x1B446760)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_FINDPLUGINSHADER_OFFSET UNITYSDK_OFFSET(0x1B444470)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_FINDSHADER_OFFSET UNITYSDK_OFFSET(0x1B446260)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_GENERATEDEFAULTMATERIALNAME_OFFSET UNITYSDK_OFFSET(0x1B448E50)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_GETDEFAULTSTANDARDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B448450)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_GETMATERIALDATAFROMCACHE_OFFSET UNITYSDK_OFFSET(0x1B448EF0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_GETMATERIALDATAMAPFROMCACHE_OFFSET UNITYSDK_OFFSET(0x1B449080)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_GETNEWMATERIALWITHSHADER_OFFSET UNITYSDK_OFFSET(0x1B4463C0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_GETORCREATEDEFAULTMATERIALINCACHE_OFFSET UNITYSDK_OFFSET(0x1B448D00)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_GETUNITYSUBSTANCEMATERIALKEY_OFFSET UNITYSDK_OFFSET(0x1B4481C0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_LOADSUBSTANCEMATERIALWITHINDEX_OFFSET UNITYSDK_OFFSET(0x1B447BF0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_LOADSUBSTANCEMATERIALWITHNAME_OFFSET UNITYSDK_OFFSET(0x1B447650)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_LOADTEXTURE_OFFSET UNITYSDK_OFFSET(0x1B4484C0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_LOADUNITYMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B447430)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_MATERIALHASGPUINSTANCINGENABLED_OFFSET UNITYSDK_OFFSET(0x1B448400)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_MATERIALNAMETOKEY_OFFSET UNITYSDK_OFFSET(0x1B448350)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_RENDERANDEXTRACTIMAGETOTEXTURE_OFFSET UNITYSDK_OFFSET(0x1B4450C0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_WHITETEXTURE_OFFSET UNITYSDK_OFFSET(0x1B4485C0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_WRITEMATERIALTOASSETCACHE_OFFSET UNITYSDK_OFFSET(0x1B446600)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B449420)
...
namespace HoudiniEngineUnity
{
	...
	public:
		...
		{
			return (::UnityEngine::Material**)Il2CppClass::FromTypeDefinitionIndex(HEU_MaterialFactory_TypeDefinitionIndex)->GetStaticField(0x604E0);
		}
