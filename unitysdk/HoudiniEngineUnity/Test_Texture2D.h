...
#define HOUDINIENGINEUNITY_TEST_TEXTURE2D_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x1EEF16D0)
#define HOUDINIENGINEUNITY_TEST_TEXTURE2D_ISNULL_OFFSET UNITYSDK_OFFSET(0x1EEF16B0)
#define HOUDINIENGINEUNITY_TEST_TEXTURE2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEF16A0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_Texture2D_TypeDefinitionIndex = 39457;
