...
#define HOUDINIENGINEUNITY_TEST_TEXTURE2D_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x17F85250)
#define HOUDINIENGINEUNITY_TEST_TEXTURE2D_ISNULL_OFFSET UNITYSDK_OFFSET(0x17F85230)
#define HOUDINIENGINEUNITY_TEST_TEXTURE2D__CTOR_OFFSET UNITYSDK_OFFSET(0x17F85220)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_Texture2D_TypeDefinitionIndex = 37790;
