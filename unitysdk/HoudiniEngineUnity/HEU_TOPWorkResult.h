...
#define HOUDINIENGINEUNITY_HEU_TOPWORKRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1537C0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_TOPWorkResult_TypeDefinitionIndex = 39244;
