...
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK___C__DISPLAYCLASS107_0__CTOR_OFFSET UNITYSDK_OFFSET(0x11A76910)
...
namespace HoudiniEngineUnity
{
	...
	{
	public:
		::HoudiniEngineUnity::HEU_TOPNodeData* topNode; // 0x10
		::HoudiniEngineUnity::HEU_PDGAssetLink* __4__this; // 0x18
		::System::Action_2<::HoudiniEngineUnity::HEU_TOPNodeData*, ::HoudiniEngineUnity::HEU_SyncedEventData*>* OnSynced; // 0x20
