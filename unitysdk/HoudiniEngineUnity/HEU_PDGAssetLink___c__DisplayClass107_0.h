...
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK___C__DISPLAYCLASS107_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17F2C710)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_PDGAssetLink___c__DisplayClass107_0_TypeDefinitionIndex = 37571;
