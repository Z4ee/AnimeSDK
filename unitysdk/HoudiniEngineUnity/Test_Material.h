...
#define HOUDINIENGINEUNITY_TEST_MATERIAL_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x1B4B0CD0)
#define HOUDINIENGINEUNITY_TEST_MATERIAL_ISNULL_OFFSET UNITYSDK_OFFSET(0x1B4B0CB0)
#define HOUDINIENGINEUNITY_TEST_MATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4B0CA0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_Material_TypeDefinitionIndex = 39419;
