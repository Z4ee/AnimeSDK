...
#define HOUDINIENGINEUNITY_HEU_COLORRAMPPOINTWRAPPER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B3D4580)
#define HOUDINIENGINEUNITY_HEU_COLORRAMPPOINTWRAPPER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B3D4590)
#define HOUDINIENGINEUNITY_HEU_COLORRAMPPOINTWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3D45A0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_ColorRampPointWrapper_TypeDefinitionIndex = 39276;
