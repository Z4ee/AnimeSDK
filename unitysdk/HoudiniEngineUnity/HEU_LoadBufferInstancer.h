...
#define HOUDINIENGINEUNITY_HEU_LOADBUFFERINSTANCER__CTOR_OFFSET UNITYSDK_OFFSET(0x108849B0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_LoadBufferInstancer_TypeDefinitionIndex = 38455;
	...
	public:
		...
		::Il2CppArray<::System::String*>* _instancePrefixes; // 0x30
		::Il2CppArray<::System::String*>* _assetPaths; // 0x38
		::Il2CppArray<::System::String*>* _collisionAssetPaths; // 0x40
