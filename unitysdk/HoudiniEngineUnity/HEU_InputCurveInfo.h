...
#define HOUDINIENGINEUNITY_HEU_INPUTCURVEINFO_CREATEFROMHAPI_INPUTCURVEINFO_OFFSET UNITYSDK_OFFSET(0x17F06BF0)
#define HOUDINIENGINEUNITY_HEU_INPUTCURVEINFO_GETBREAKPOINTPARAMETERIZATIONNAMES_OFFSET UNITYSDK_OFFSET(0x17F06D60)
#define HOUDINIENGINEUNITY_HEU_INPUTCURVEINFO_GETCURVETYPENAMES_OFFSET UNITYSDK_OFFSET(0x17F06C70)
#define HOUDINIENGINEUNITY_HEU_INPUTCURVEINFO_GETINPUTMETHODNAMES_OFFSET UNITYSDK_OFFSET(0x17F06CF0)
#define HOUDINIENGINEUNITY_HEU_INPUTCURVEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17F06C60)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_InputCurveInfo_TypeDefinitionIndex = 37414;
