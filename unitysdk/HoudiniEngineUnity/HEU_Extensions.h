...
#define HOUDINIENGINEUNITY_HEU_EXTENSIONS_APPROXIMATELYEQUALS_1_OFFSET UNITYSDK_OFFSET(0x167DAF80)
#define HOUDINIENGINEUNITY_HEU_EXTENSIONS_APPROXIMATELYEQUALS_OFFSET UNITYSDK_OFFSET(0x167DAF30)
#define HOUDINIENGINEUNITY_HEU_EXTENSIONS_ASBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x167DAFA0)
#define HOUDINIENGINEUNITY_HEU_EXTENSIONS_ASSTRING_OFFSET UNITYSDK_OFFSET(0x167DB050)
#define HOUDINIENGINEUNITY_HEU_EXTENSIONS_DECOMPOSETOPOSITION_OFFSET UNITYSDK_OFFSET(0x167DB180)
#define HOUDINIENGINEUNITY_HEU_EXTENSIONS_DECOMPOSETOROTATION_OFFSET UNITYSDK_OFFSET(0x167DB1A0)
#define HOUDINIENGINEUNITY_HEU_EXTENSIONS_DECOMPOSETOSCALE_OFFSET UNITYSDK_OFFSET(0x167DB210)
#define HOUDINIENGINEUNITY_HEU_EXTENSIONS_SWAPXANDY_OFFSET UNITYSDK_OFFSET(0x167DB110)
#define HOUDINIENGINEUNITY_HEU_EXTENSIONS_SWAPXANDZ_OFFSET UNITYSDK_OFFSET(0x167DB130)
#define HOUDINIENGINEUNITY_HEU_EXTENSIONS_SWAPYANDZ_OFFSET UNITYSDK_OFFSET(0x167DB160)
