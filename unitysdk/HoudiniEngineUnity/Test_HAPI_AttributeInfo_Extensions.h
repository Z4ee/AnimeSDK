...
#define HOUDINIENGINEUNITY_TEST_HAPI_ATTRIBUTEINFO_EXTENSIONS_TOTESTOBJECT_OFFSET UNITYSDK_OFFSET(0x17F7F970)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_HAPI_AttributeInfo_Extensions_TypeDefinitionIndex = 37741;
