...
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESHSETTINGS_GET_EXPORTCOLLIDERS_OFFSET UNITYSDK_OFFSET(0x11A582C0)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESHSETTINGS_SET_EXPORTCOLLIDERS_OFFSET UNITYSDK_OFFSET(0x11A582D0)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESHSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x11A582E0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_InputInterfaceMeshSettings_TypeDefinitionIndex = 39347;
