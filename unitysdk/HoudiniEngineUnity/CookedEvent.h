...
#define HOUDINIENGINEUNITY_COOKEDEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x84042A0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int CookedEvent_TypeDefinitionIndex = 37597;
