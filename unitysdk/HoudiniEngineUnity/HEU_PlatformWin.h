...
#define HOUDINIENGINEUNITY_HEU_PLATFORMWIN_GETAPPLICATIONPATH_OFFSET UNITYSDK_OFFSET(0x197B5F70)
#define HOUDINIENGINEUNITY_HEU_PLATFORMWIN_GETREGISTRYKEYVALUE_OFFSET UNITYSDK_OFFSET(0x197B5BA0)
#define HOUDINIENGINEUNITY_HEU_PLATFORMWIN_GETREGISTRYKEYVALUE_X64_OFFSET UNITYSDK_OFFSET(0x197B5F00)
#define HOUDINIENGINEUNITY_HEU_PLATFORMWIN_GETREGISTRYKEYVALUE_X86_OFFSET UNITYSDK_OFFSET(0x197B5E90)
#define HOUDINIENGINEUNITY_HEU_PLATFORMWIN_REGCLOSEKEY_OFFSET UNITYSDK_OFFSET(0x197B5B20)
#define HOUDINIENGINEUNITY_HEU_PLATFORMWIN_REGOPENKEYEX_OFFSET UNITYSDK_OFFSET(0x197B5960)
#define HOUDINIENGINEUNITY_HEU_PLATFORMWIN_REGQUERYVALUEEX_OFFSET UNITYSDK_OFFSET(0x197B5A20)
#define HOUDINIENGINEUNITY_HEU_PLATFORMWIN__CCTOR_OFFSET UNITYSDK_OFFSET(0x197B6310)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_PlatformWin_TypeDefinitionIndex = 38281;
	...
	public:
		...
		{
			return (::System::UIntPtr*)Il2CppClass::FromTypeDefinitionIndex(HEU_PlatformWin_TypeDefinitionIndex)->GetStaticField(0x60B0);
		}
		static ::System::UIntPtr* StaticGet_HKEY_CURRENT_USER()
		{
			return (::System::UIntPtr*)Il2CppClass::FromTypeDefinitionIndex(HEU_PlatformWin_TypeDefinitionIndex)->GetStaticField(0x60B8);
		}
