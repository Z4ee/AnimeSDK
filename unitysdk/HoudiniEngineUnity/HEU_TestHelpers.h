...
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS_ASSERTTRUELOGEQUIVALENT_1_OFFSET UNITYSDK_OFFSET(0x1B48E920)
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS_ASSERTTRUELOGEQUIVALENT_2_OFFSET UNITYSDK_OFFSET(0x1B48EB50)
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS_ASSERTTRUELOGEQUIVALENT_OFFSET UNITYSDK_OFFSET(0x1B48DA00)
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS_PRINTTESTLOGANDSETRESULT_OFFSET UNITYSDK_OFFSET(0x1B48E7D0)
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS_SHOULDBETESTED_1_OFFSET UNITYSDK_OFFSET(0x1B48EA80)
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS_SHOULDBETESTED_OFFSET UNITYSDK_OFFSET(0x1B48DAB0)
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS_TESTOUTPUTOBJECTEQUIVALENCE_OFFSET UNITYSDK_OFFSET(0x1B48DC30)
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B48EDC0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_TestHelpers_TypeDefinitionIndex = 39394;
