...
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS_ASSERTTRUELOGEQUIVALENT_1_OFFSET UNITYSDK_OFFSET(0x197D5040)
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS_ASSERTTRUELOGEQUIVALENT_2_OFFSET UNITYSDK_OFFSET(0x197D5250)
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS_ASSERTTRUELOGEQUIVALENT_OFFSET UNITYSDK_OFFSET(0x197D4120)
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS_PRINTTESTLOGANDSETRESULT_OFFSET UNITYSDK_OFFSET(0x197D4EF0)
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS_SHOULDBETESTED_1_OFFSET UNITYSDK_OFFSET(0x197D5180)
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS_SHOULDBETESTED_OFFSET UNITYSDK_OFFSET(0x197D41D0)
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS_TESTOUTPUTOBJECTEQUIVALENCE_OFFSET UNITYSDK_OFFSET(0x197D4350)
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS__CTOR_OFFSET UNITYSDK_OFFSET(0x197D5490)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_TestHelpers_TypeDefinitionIndex = 38535;
