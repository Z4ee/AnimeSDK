...
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS_ASSERTTRUELOGEQUIVALENT_1_OFFSET UNITYSDK_OFFSET(0x1B15BA90)
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS_ASSERTTRUELOGEQUIVALENT_2_OFFSET UNITYSDK_OFFSET(0x1B15BCC0)
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS_ASSERTTRUELOGEQUIVALENT_OFFSET UNITYSDK_OFFSET(0x1B15AB70)
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS_PRINTTESTLOGANDSETRESULT_OFFSET UNITYSDK_OFFSET(0x1B15B940)
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS_SHOULDBETESTED_1_OFFSET UNITYSDK_OFFSET(0x1B15BBF0)
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS_SHOULDBETESTED_OFFSET UNITYSDK_OFFSET(0x1B15AC20)
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS_TESTOUTPUTOBJECTEQUIVALENCE_OFFSET UNITYSDK_OFFSET(0x1B15ADA0)
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B15BF30)
