...
#define HOUDINIENGINEUNITY_TEST_CAPSULECOLLIDER_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x1D20A360)
#define HOUDINIENGINEUNITY_TEST_CAPSULECOLLIDER_ISNULL_OFFSET UNITYSDK_OFFSET(0x1D20A340)
#define HOUDINIENGINEUNITY_TEST_CAPSULECOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D20A330)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_CapsuleCollider_TypeDefinitionIndex = 38572;
