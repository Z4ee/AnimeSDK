...
#define HOUDINIENGINEUNITY_TEST_CAPSULECOLLIDER_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x1EEEA4F0)
#define HOUDINIENGINEUNITY_TEST_CAPSULECOLLIDER_ISNULL_OFFSET UNITYSDK_OFFSET(0x1EEEA4D0)
#define HOUDINIENGINEUNITY_TEST_CAPSULECOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEEA4C0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_CapsuleCollider_TypeDefinitionIndex = 39431;
