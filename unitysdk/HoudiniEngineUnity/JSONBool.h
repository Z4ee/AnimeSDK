...
#define HOUDINIENGINEUNITY_JSONBOOL_EQUALS_OFFSET UNITYSDK_OFFSET(0x8CD2A20)
#define HOUDINIENGINEUNITY_JSONBOOL_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x8CD28D0)
#define HOUDINIENGINEUNITY_JSONBOOL_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8CD2A40)
#define HOUDINIENGINEUNITY_JSONBOOL_GET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x8CD2960)
#define HOUDINIENGINEUNITY_JSONBOOL_GET_ISBOOLEAN_OFFSET UNITYSDK_OFFSET(0x8CD28C0)
#define HOUDINIENGINEUNITY_JSONBOOL_GET_TAG_OFFSET UNITYSDK_OFFSET(0x8CD28B0)
#define HOUDINIENGINEUNITY_JSONBOOL_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x8CD28F0)
#define HOUDINIENGINEUNITY_JSONBOOL_SET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x8CD2970)
#define HOUDINIENGINEUNITY_JSONBOOL_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x8CD2910)
#define HOUDINIENGINEUNITY_JSONBOOL_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x8CD29E0)
#define HOUDINIENGINEUNITY_JSONBOOL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8CD2990)
#define HOUDINIENGINEUNITY_JSONBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x8CD2980)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int JSONBool_TypeDefinitionIndex = 43732;
