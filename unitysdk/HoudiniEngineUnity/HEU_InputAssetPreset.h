...
#define HOUDINIENGINEUNITY_HEU_INPUTASSETPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x845C580)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_InputAssetPreset_TypeDefinitionIndex = 37605;
