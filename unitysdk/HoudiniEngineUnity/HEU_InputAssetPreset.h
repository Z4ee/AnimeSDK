...
#define HOUDINIENGINEUNITY_HEU_INPUTASSETPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x8C846C0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_InputAssetPreset_TypeDefinitionIndex = 43482;
