...
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_ADDINPUTENTRYATENDHDA_OFFSET UNITYSDK_OFFSET(0x1087F090)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_ADDINPUTENTRYATENDMESH_OFFSET UNITYSDK_OFFSET(0x1087EFD0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_ADDINPUTENTRYATEND_OFFSET UNITYSDK_OFFSET(0x1087D450)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_AREANYINPUTHDASCONNECTED_OFFSET UNITYSDK_OFFSET(0x1087E8A0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_CHANGEINPUTTYPE_1_OFFSET UNITYSDK_OFFSET(0x1087D990)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_CHANGEINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x1087D8D0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_CLEARCONNECTEDINPUTHDAS_OFFSET UNITYSDK_OFFSET(0x1087F550)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_CLEARUICACHE_OFFSET UNITYSDK_OFFSET(0x1087EB80)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_CONNECTTOMERGEOBJECT_OFFSET UNITYSDK_OFFSET(0x108809B0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_COPYINPUTVALUESTO_OFFSET UNITYSDK_OFFSET(0x10868BD0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_CREATEINPUTHDAINFO_OFFSET UNITYSDK_OFFSET(0x1087CD70)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_CREATEINPUTOBJECTINFO_OFFSET UNITYSDK_OFFSET(0x1087CC50)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_CREATESETUPINPUT_OFFSET UNITYSDK_OFFSET(0x1085D4E0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_DESTROYALLDATA_OFFSET UNITYSDK_OFFSET(0x1085A420)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_DISCONNECTANDDESTROYINPUTS_OFFSET UNITYSDK_OFFSET(0x1087EB90)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_DISCONNECTCONNECTEDMERGENODE_OFFSET UNITYSDK_OFFSET(0x1087F0B0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_FINDADDTOINPUTHDA_OFFSET UNITYSDK_OFFSET(0x10882BA0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GETCONNECTEDINPUTCOUNT_OFFSET UNITYSDK_OFFSET(0x1087E9A0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GETCONNECTEDNODEID_OFFSET UNITYSDK_OFFSET(0x1087E9F0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GETINPUTENTRYGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1087C3B0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GETINPUTENTRYGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1087BD40)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GETINTERNALOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x1087BD20)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GETSESSION_OFFSET UNITYSDK_OFFSET(0x1087BC50)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_INPUTASSETINFOS_OFFSET UNITYSDK_OFFSET(0x1087BC00)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_INPUTNAME_OFFSET UNITYSDK_OFFSET(0x1087BB90)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_INPUTNODEID_OFFSET UNITYSDK_OFFSET(0x1087BB80)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_INPUTOBJECTS_OFFSET UNITYSDK_OFFSET(0x1087BBF0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_INPUTTYPE_OFFSET UNITYSDK_OFFSET(0x1087BBE0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_KEEPWORLDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1087BA70)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_LABELNAME_OFFSET UNITYSDK_OFFSET(0x1087BBA0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_MESHSETTINGS_OFFSET UNITYSDK_OFFSET(0x1087BBC0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1087BAB0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_OBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x1087BAE0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_PACKGEOMETRYBEFOREMERGING_OFFSET UNITYSDK_OFFSET(0x1087BA90)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_PARAMNAME_OFFSET UNITYSDK_OFFSET(0x1087BBB0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_PARENTASSET_OFFSET UNITYSDK_OFFSET(0x1087BA60)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_PENDINGOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x1087BB20)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_REQUIRESCOOK_OFFSET UNITYSDK_OFFSET(0x1087BC10)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_REQUIRESUPLOAD_OFFSET UNITYSDK_OFFSET(0x1087BC30)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_SPLINESETTINGS_OFFSET UNITYSDK_OFFSET(0x1087BBD0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_HANDLESELECTEDOBJECTSFORINPUTHDAS_OFFSET UNITYSDK_OFFSET(0x10883160)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_HANDLESELECTEDOBJECTSFORINPUTOBJECTS_OFFSET UNITYSDK_OFFSET(0x10882EB0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_HASINPUTNODETRANSFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x10859CD0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_INPUTNODETYPE_INTERNALTOWRAPPER_1_OFFSET UNITYSDK_OFFSET(0x10883740)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_INPUTNODETYPE_INTERNALTOWRAPPER_OFFSET UNITYSDK_OFFSET(0x1087BAD0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_INPUTOBJECTTYPE_INTERNALTOWRAPPER_OFFSET UNITYSDK_OFFSET(0x1087BB00)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_INPUTOBJECTTYPE_WRAPPERTOINTERNAL_OFFSET UNITYSDK_OFFSET(0x1087BB60)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_INSERTINPUTENTRY_OFFSET UNITYSDK_OFFSET(0x1087CDC0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_INTERNALADDINPUTHDAATEND_OFFSET UNITYSDK_OFFSET(0x1087D750)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_INTERNALADDINPUTOBJECTATEND_OFFSET UNITYSDK_OFFSET(0x1087D6A0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_ISASSETINPUT_OFFSET UNITYSDK_OFFSET(0x1084A310)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x108832E0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_LOADPRESET_1_OFFSET UNITYSDK_OFFSET(0x10866000)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_LOADPRESET_OFFSET UNITYSDK_OFFSET(0x1087EAA0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_NOTIFYPARENTREMOVEDINPUT_OFFSET UNITYSDK_OFFSET(0x10882E30)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_NUMINPUTENTRIES_OFFSET UNITYSDK_OFFSET(0x1087BCD0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_POPULATEINPUTPRESET_OFFSET UNITYSDK_OFFSET(0x1084C2D0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_RECONNECTTOUPSTREAMASSET_OFFSET UNITYSDK_OFFSET(0x10861C70)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_RECOOK_OFFSET UNITYSDK_OFFSET(0x1087BCC0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_REMOVEALLINPUTENTRIES_OFFSET UNITYSDK_OFFSET(0x1087E070)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_REMOVEINPUTENTRY_OFFSET UNITYSDK_OFFSET(0x1087D9C0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_RESETCONNECTIONFORFORCEUPDATE_OFFSET UNITYSDK_OFFSET(0x1085D6B0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_RESETINPUTNODE_1_OFFSET UNITYSDK_OFFSET(0x1084B270)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_RESETINPUTNODE_OFFSET UNITYSDK_OFFSET(0x1087D840)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_RESETINPUTOBJECTTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1087EEB0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_SETINPUTENTRYOBJECTTRANSFORMROTATEOFFSET_OFFSET UNITYSDK_OFFSET(0x1087E4C0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_SETINPUTENTRYOBJECTTRANSFORMSCALEOFFSET_OFFSET UNITYSDK_OFFSET(0x1087E6B0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_SETINPUTENTRYOBJECTTRANSFORMTRANSLATEOFFSET_OFFSET UNITYSDK_OFFSET(0x1087E2E0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_SETINPUTENTRYOBJECTUSETRANSFORMOFFSET_OFFSET UNITYSDK_OFFSET(0x1087E100)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_SETINPUTENTRY_OFFSET UNITYSDK_OFFSET(0x1087C590)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_SETINPUTNODEID_OFFSET UNITYSDK_OFFSET(0x1087EB70)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_SET_KEEPWORLDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1087BA80)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_SET_PACKGEOMETRYBEFOREMERGING_OFFSET UNITYSDK_OFFSET(0x1087BAA0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_SET_PENDINGOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x1087BB40)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_SET_REQUIRESCOOK_OFFSET UNITYSDK_OFFSET(0x1087BC20)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_SET_REQUIRESUPLOAD_OFFSET UNITYSDK_OFFSET(0x1087BC40)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_UPDATEONASSETRECREATION_OFFSET UNITYSDK_OFFSET(0x10861A60)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_UPLOADHDAINPUT_OFFSET UNITYSDK_OFFSET(0x1087F7D0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_UPLOADINPUTOBJECTTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x10882250)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_UPLOADINPUT_OFFSET UNITYSDK_OFFSET(0x1085D6F0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_UPLOADOBJECTMERGEPACKGEOMETRY_OFFSET UNITYSDK_OFFSET(0x10881140)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_UPLOADOBJECTMERGETRANSFORMTYPE_OFFSET UNITYSDK_OFFSET(0x10880EF0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_UPLOADUNITYINPUT_OFFSET UNITYSDK_OFFSET(0x1087FB20)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x10883750)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_InputNode_TypeDefinitionIndex = 38246;
