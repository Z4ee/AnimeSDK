...
#define HOUDINIENGINEUNITY_TEST_TERRAINLAYER_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x1D210940)
#define HOUDINIENGINEUNITY_TEST_TERRAINLAYER_ISNULL_OFFSET UNITYSDK_OFFSET(0x1D210920)
#define HOUDINIENGINEUNITY_TEST_TERRAINLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D210910)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_TerrainLayer_TypeDefinitionIndex = 38595;
