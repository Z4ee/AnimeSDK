...
#define HOUDINIENGINEUNITY_TEST_TERRAINLAYER_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x17F84660)
#define HOUDINIENGINEUNITY_TEST_TERRAINLAYER_ISNULL_OFFSET UNITYSDK_OFFSET(0x17F84640)
#define HOUDINIENGINEUNITY_TEST_TERRAINLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x17F84630)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_TerrainLayer_TypeDefinitionIndex = 37787;
