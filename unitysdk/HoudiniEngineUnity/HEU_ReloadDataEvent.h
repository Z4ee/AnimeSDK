...
#define HOUDINIENGINEUNITY_HEU_RELOADDATAEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x8CB3910)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_ReloadDataEvent_TypeDefinitionIndex = 43473;
