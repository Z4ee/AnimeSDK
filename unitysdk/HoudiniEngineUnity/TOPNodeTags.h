...
#define HOUDINIENGINEUNITY_TOPNODETAGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEE9A50)
...
namespace HoudiniEngineUnity
{
	...
	public:
		...
		::System::Boolean _autoloadHEngineData; // 0x11
		::System::Boolean _showHEngineData; // 0x12
		::System::Boolean _show; // 0x13
