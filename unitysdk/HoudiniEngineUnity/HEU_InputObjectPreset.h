...
#define HOUDINIENGINEUNITY_HEU_INPUTOBJECTPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x17F189F0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_InputObjectPreset_TypeDefinitionIndex = 37403;
