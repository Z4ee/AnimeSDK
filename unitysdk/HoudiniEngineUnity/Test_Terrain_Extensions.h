...
#define HOUDINIENGINEUNITY_TEST_TERRAIN_EXTENSIONS_TOTESTOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1B4B48F0)
#define HOUDINIENGINEUNITY_TEST_TERRAIN_EXTENSIONS_TOTESTOBJECT_2_OFFSET UNITYSDK_OFFSET(0x1B4B4A10)
#define HOUDINIENGINEUNITY_TEST_TERRAIN_EXTENSIONS_TOTESTOBJECT_OFFSET UNITYSDK_OFFSET(0x1B4B48B0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_Terrain_Extensions_TypeDefinitionIndex = 39467;
