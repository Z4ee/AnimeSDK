...
#define HOUDINIENGINEUNITY_TEST_TERRAIN_EXTENSIONS_TOTESTOBJECT_1_OFFSET UNITYSDK_OFFSET(0x17F84F00)
#define HOUDINIENGINEUNITY_TEST_TERRAIN_EXTENSIONS_TOTESTOBJECT_2_OFFSET UNITYSDK_OFFSET(0x17F85020)
#define HOUDINIENGINEUNITY_TEST_TERRAIN_EXTENSIONS_TOTESTOBJECT_OFFSET UNITYSDK_OFFSET(0x17F84EC0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_Terrain_Extensions_TypeDefinitionIndex = 37800;
