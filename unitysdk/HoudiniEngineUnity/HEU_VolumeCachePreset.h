...
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHEPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x197E31E0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_VolumeCachePreset_TypeDefinitionIndex = 38214;
