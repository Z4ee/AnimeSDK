...
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHEPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B169F40)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_VolumeCachePreset_TypeDefinitionIndex = 39073;
