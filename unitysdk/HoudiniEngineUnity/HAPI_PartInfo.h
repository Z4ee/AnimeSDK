...
#define HOUDINIENGINEUNITY_HAPI_PARTINFO_GETELEMENTCOUNTBYATTRIBUTEOWNER_OFFSET UNITYSDK_OFFSET(0x3A96680)
#define HOUDINIENGINEUNITY_HAPI_PARTINFO_GETELEMENTCOUNTBYGROUPTYPE_OFFSET UNITYSDK_OFFSET(0x3A966C0)
#define HOUDINIENGINEUNITY_HAPI_PARTINFO_GET_DETAILATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x3A968F0)
#define HOUDINIENGINEUNITY_HAPI_PARTINFO_GET_POINTATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x3A96710)
#define HOUDINIENGINEUNITY_HAPI_PARTINFO_GET_PRIMITIVEATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x3A967B0)
#define HOUDINIENGINEUNITY_HAPI_PARTINFO_GET_VERTEXATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x3A96850)
#define HOUDINIENGINEUNITY_HAPI_PARTINFO_INIT_OFFSET UNITYSDK_OFFSET(0x3A966E0)
#define HOUDINIENGINEUNITY_HAPI_PARTINFO_SET_DETAILATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x3A96940)
#define HOUDINIENGINEUNITY_HAPI_PARTINFO_SET_POINTATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x3A96760)
#define HOUDINIENGINEUNITY_HAPI_PARTINFO_SET_PRIMITIVEATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x3A96800)
#define HOUDINIENGINEUNITY_HAPI_PARTINFO_SET_VERTEXATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x3A968A0)
