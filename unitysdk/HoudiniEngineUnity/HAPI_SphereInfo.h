...
#define HOUDINIENGINEUNITY_HAPI_SPHEREINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x38DFDD0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HAPI_SphereInfo_TypeDefinitionIndex = 38361;
