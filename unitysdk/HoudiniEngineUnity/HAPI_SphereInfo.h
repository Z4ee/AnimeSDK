...
#define HOUDINIENGINEUNITY_HAPI_SPHEREINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x2D4B310)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HAPI_SphereInfo_TypeDefinitionIndex = 37553;
