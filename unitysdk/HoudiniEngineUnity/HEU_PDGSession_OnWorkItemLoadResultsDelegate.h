...
#define HOUDINIENGINEUNITY_HEU_PDGSESSION_ONWORKITEMLOADRESULTSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x10895800)
#define HOUDINIENGINEUNITY_HEU_PDGSESSION_ONWORKITEMLOADRESULTSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x10895830)
#define HOUDINIENGINEUNITY_HEU_PDGSESSION_ONWORKITEMLOADRESULTSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x108957F0)
#define HOUDINIENGINEUNITY_HEU_PDGSESSION_ONWORKITEMLOADRESULTSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x10895700)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_PDGSession_OnWorkItemLoadResultsDelegate_TypeDefinitionIndex = 38388;
