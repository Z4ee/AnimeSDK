...
#define HOUDINIENGINEUNITY_HEU_HOUDINIENGINEERROR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1086B070)
#define HOUDINIENGINEUNITY_HEU_HOUDINIENGINEERROR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1086AFE0)
#define HOUDINIENGINEUNITY_HEU_HOUDINIENGINEERROR__CTOR_OFFSET UNITYSDK_OFFSET(0x1086AF60)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_HoudiniEngineError_TypeDefinitionIndex = 38279;
