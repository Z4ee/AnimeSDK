...
#define HOUDINIENGINEUNITY_HAPI_TRANSFORMEULER__CTOR_OFFSET UNITYSDK_OFFSET(0x27020)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HAPI_TransformEuler_TypeDefinitionIndex = 37708;
