...
#define HOUDINIENGINEUNITY_TEST_GRADIENT_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x17F7F0E0)
#define HOUDINIENGINEUNITY_TEST_GRADIENT_ISNULL_OFFSET UNITYSDK_OFFSET(0x17F7F0D0)
#define HOUDINIENGINEUNITY_TEST_GRADIENT__CTOR_OFFSET UNITYSDK_OFFSET(0x17F7F0C0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_Gradient_TypeDefinitionIndex = 37781;
