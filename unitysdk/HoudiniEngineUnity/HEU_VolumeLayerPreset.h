...
#define HOUDINIENGINEUNITY_HEU_VOLUMELAYERPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x8CD0B00)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_VolumeLayerPreset_TypeDefinitionIndex = 43483;
