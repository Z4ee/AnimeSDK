...
#define HOUDINIENGINEUNITY_HEU_VOLUMELAYERPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x84A86B0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_VolumeLayerPreset_TypeDefinitionIndex = 37606;
