...
#define HOUDINIENGINEUNITY_TEST_HAPI_NODEINFO_EXTENSIONS_TOTESTOBJECT_OFFSET UNITYSDK_OFFSET(0x17F7FF80)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int Test_HAPI_NodeInfo_Extensions_TypeDefinitionIndex = 37733;
