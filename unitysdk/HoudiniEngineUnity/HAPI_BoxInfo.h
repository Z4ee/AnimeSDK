...
#define HOUDINIENGINEUNITY_HAPI_BOXINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x38DF2F0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HAPI_BoxInfo_TypeDefinitionIndex = 38360;
