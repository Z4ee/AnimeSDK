...
#define HOUDINIENGINEUNITY_HAPI_BOXINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x3A96410)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HAPI_BoxInfo_TypeDefinitionIndex = 39219;
