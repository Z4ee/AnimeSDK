...
#define HOUDINIENGINEUNITY_HEU_PARTDATA_APPENDBAKEDCLONENAME_OFFSET UNITYSDK_OFFSET(0x8C7B720)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_APPLYHAPITRANSFORM_OFFSET UNITYSDK_OFFSET(0x8CA22A0)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_BAKEPARTTOGAMEOBJECT_1_OFFSET UNITYSDK_OFFSET(0x8C7B5C0)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_BAKEPARTTOGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x8CA7C10)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_BAKEPARTTONEWGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x8C79FC0)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_CALCULATECOLLIDERSTATE_OFFSET UNITYSDK_OFFSET(0x8CA4A40)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_CALCULATEVISIBILITY_OFFSET UNITYSDK_OFFSET(0x8CA49E0)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_CLEARGENERATEDDATA_OFFSET UNITYSDK_OFFSET(0x8CA2A60)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_CLEARGENERATEDMESHOUTPUT_OFFSET UNITYSDK_OFFSET(0x8CA2A80)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_CLEARGENERATEDVOLUMEOUTPUT_OFFSET UNITYSDK_OFFSET(0x8CA2B70)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_CLEARINSTANCES_OFFSET UNITYSDK_OFFSET(0x8C96C40)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_CLEARINVALIDOBJECTINSTANCEINFOS_OFFSET UNITYSDK_OFFSET(0x8C96D30)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_CLEAROBJECTINSTANCEINFOS_OFFSET UNITYSDK_OFFSET(0x8CA2050)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_COPYCHILDGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x8CA7690)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_COPYGAMEOBJECTCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x8CA4D90)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_CREATENEWINSTANCEFROMOBJECT_OFFSET UNITYSDK_OFFSET(0x8CA3A00)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_CREATEOBJECTINSTANCEINFO_OFFSET UNITYSDK_OFFSET(0x8CA4510)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_DESTROYALLDATA_OFFSET UNITYSDK_OFFSET(0x8CA1F30)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_DESTROYATTRIBUTESSTORE_OFFSET UNITYSDK_OFFSET(0x8CA2110)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_DESTROYPARTS_OFFSET UNITYSDK_OFFSET(0x8CA8BE0)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_DESTROYPART_OFFSET UNITYSDK_OFFSET(0x8C96790)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_GENERATEATTRIBUTESSTORE_OFFSET UNITYSDK_OFFSET(0x8CA4610)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_GENERATEINSTANCESFROMOBJECTIDS_OFFSET UNITYSDK_OFFSET(0x8C96FB0)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_GENERATEINSTANCESFROMOBJECTID_OFFSET UNITYSDK_OFFSET(0x8C98AA0)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_GENERATEINSTANCESFROMOBJECT_OFFSET UNITYSDK_OFFSET(0x8CA3F40)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_GENERATEINSTANCESFROMUNITYASSETPATHATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x8C97870)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_GENERATEMESH_OFFSET UNITYSDK_OFFSET(0x8C96330)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_GENERATEPARTINSTANCES_OFFSET UNITYSDK_OFFSET(0x8CA2BB0)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_GETCLONABLEOBJECTS_OFFSET UNITYSDK_OFFSET(0x8CA2820)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_GETCLONABLEPARTS_OFFSET UNITYSDK_OFFSET(0x8CA2880)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_GETCURVE_OFFSET UNITYSDK_OFFSET(0x8CA4660)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_GETDEBUGINFO_OFFSET UNITYSDK_OFFSET(0x8CA23E0)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_GETHDAPARTWITHGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x8CA29E0)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_GETOBJECTINSTANCEINFOS_OFFSET UNITYSDK_OFFSET(0x8CA89A0)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_GETOBJECTINSTANCEINFOWITHOBJECTID_OFFSET UNITYSDK_OFFSET(0x8CA3970)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_GETOBJECTINSTANCEINFOWITHOBJECTPATH_OFFSET UNITYSDK_OFFSET(0x8CA43C0)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_GETOUTPUTGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x8CA2910)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_GETOUTPUT_OFFSET UNITYSDK_OFFSET(0x8CA2970)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_GETPARTPOINTCOUNT_OFFSET UNITYSDK_OFFSET(0x8CA1A10)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_GETVOLUMELAYERNAME_OFFSET UNITYSDK_OFFSET(0x8CA1F20)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_GET_GENERATEDOUTPUT_OFFSET UNITYSDK_OFFSET(0x8CA1AA0)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_GET_MESHVERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x8CA1A90)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_GET_OBJECTINSTANCESBEENGENERATED_OFFSET UNITYSDK_OFFSET(0x8CA1A30)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_GET_OUTPUTGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x8C7B6F0)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_GET_PARENTASSET_OFFSET UNITYSDK_OFFSET(0x8CA1990)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_GET_PARENTGEONODE_OFFSET UNITYSDK_OFFSET(0x8CA1980)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_GET_PARTID_OFFSET UNITYSDK_OFFSET(0x8CA1960)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_GET_PARTNAME_OFFSET UNITYSDK_OFFSET(0x8CA1970)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_HAVEINSTANCESBEENGENERATED_OFFSET UNITYSDK_OFFSET(0x8CA1A80)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x8CA1BA0)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_ISATTRIBINSTANCER_OFFSET UNITYSDK_OFFSET(0x8CA19D0)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_ISINSTANCERANYTYPE_OFFSET UNITYSDK_OFFSET(0x8CA19E0)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_ISOBJECTINSTANCER_OFFSET UNITYSDK_OFFSET(0x8CA1A20)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_ISPARTCURVE_OFFSET UNITYSDK_OFFSET(0x8CA1A50)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_ISPARTEDITABLE_OFFSET UNITYSDK_OFFSET(0x8CA1A70)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_ISPARTINSTANCED_OFFSET UNITYSDK_OFFSET(0x8CA1A00)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_ISPARTINSTANCER_OFFSET UNITYSDK_OFFSET(0x8CA19C0)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_ISPARTMESH_OFFSET UNITYSDK_OFFSET(0x8CA1A60)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_ISPARTVOLUME_OFFSET UNITYSDK_OFFSET(0x8C96C30)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_ISUSINGMATERIAL_OFFSET UNITYSDK_OFFSET(0x8CA27F0)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_POPULATEOBJECTINSTANCEINFOS_OFFSET UNITYSDK_OFFSET(0x8C99010)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_PROCESSCURVEPART_OFFSET UNITYSDK_OFFSET(0x8CA8650)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_SETCOLLIDERSTATE_OFFSET UNITYSDK_OFFSET(0x8CA4A00)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_SETGAMEOBJECTNAME_OFFSET UNITYSDK_OFFSET(0x8CA1DA0)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_SETGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x8CA1EE0)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_SETOBJECTINSTANCEINFOS_OFFSET UNITYSDK_OFFSET(0x8CA8890)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_SETOBJECTINSTANCER_OFFSET UNITYSDK_OFFSET(0x8CA2A50)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_SETTERRAINDATA_OFFSET UNITYSDK_OFFSET(0x8CA89C0)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_SETTERRAINOFFSETPOSITION_OFFSET UNITYSDK_OFFSET(0x8CA89B0)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_SETUPATTRIBUTEGEOMETRY_OFFSET UNITYSDK_OFFSET(0x8C968E0)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_SETVISIBLITY_OFFSET UNITYSDK_OFFSET(0x8CA4680)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_SETVOLUMELAYERNAME_OFFSET UNITYSDK_OFFSET(0x8CA1F10)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_SET_OBJECTINSTANCESBEENGENERATED_OFFSET UNITYSDK_OFFSET(0x8CA1A40)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_SYNCATTRIBUTESSTORE_OFFSET UNITYSDK_OFFSET(0x8CA8780)
#define HOUDINIENGINEUNITY_HEU_PARTDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8CA8B80)
#define HOUDINIENGINEUNITY_HEU_PARTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8CA1AB0)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_PartData_TypeDefinitionIndex = 43518;
