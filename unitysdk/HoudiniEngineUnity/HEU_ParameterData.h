...
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_GET_CHILDINDEX_OFFSET UNITYSDK_OFFSET(0x17F2DE90)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_GET_FLOATMAX_OFFSET UNITYSDK_OFFSET(0x17F2E240)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_GET_FLOATMIN_OFFSET UNITYSDK_OFFSET(0x17F2E230)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_GET_FLOATUIMAX_OFFSET UNITYSDK_OFFSET(0x17F2E260)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_GET_FLOATUIMIN_OFFSET UNITYSDK_OFFSET(0x17F2E250)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_GET_INTMAX_OFFSET UNITYSDK_OFFSET(0x17F2DFF0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_GET_INTMIN_OFFSET UNITYSDK_OFFSET(0x17F2DF30)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_GET_INTUIMAX_OFFSET UNITYSDK_OFFSET(0x17F2E170)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_GET_INTUIMIN_OFFSET UNITYSDK_OFFSET(0x17F2E0B0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_GET_PARENTID_OFFSET UNITYSDK_OFFSET(0x17F2DE80)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_GET_PARMID_OFFSET UNITYSDK_OFFSET(0x17F1B620)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_GET_PARMSIZE_OFFSET UNITYSDK_OFFSET(0x17F2DEA0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_HASMAX_OFFSET UNITYSDK_OFFSET(0x17F2DF00)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_HASMIN_OFFSET UNITYSDK_OFFSET(0x17F2DEF0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_HASUIMAX_OFFSET UNITYSDK_OFFSET(0x17F2DF20)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_HASUIMIN_OFFSET UNITYSDK_OFFSET(0x17F2DF10)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISASSETPATH_OFFSET UNITYSDK_OFFSET(0x17F2E380)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISBUTTON_OFFSET UNITYSDK_OFFSET(0x17F2E300)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISCOLORRAMP_OFFSET UNITYSDK_OFFSET(0x17F2E2C0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISCOLOR_OFFSET UNITYSDK_OFFSET(0x17F2E2E0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISCONTAINER_OFFSET UNITYSDK_OFFSET(0x17F2E270)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x17F2E390)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISFLOATRAMP_OFFSET UNITYSDK_OFFSET(0x17F2E2B0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISFLOAT_OFFSET UNITYSDK_OFFSET(0x17F2DEC0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISFOLDER_OFFSET UNITYSDK_OFFSET(0x17F2E2F0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISINT_OFFSET UNITYSDK_OFFSET(0x17F2DEB0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISMULTIPARAM_OFFSET UNITYSDK_OFFSET(0x17F2E290)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISPATHFILE_OFFSET UNITYSDK_OFFSET(0x17F2DEE0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISRAMP_OFFSET UNITYSDK_OFFSET(0x17F2E2A0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISSTRING_OFFSET UNITYSDK_OFFSET(0x17F2DED0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISTOGGLE_OFFSET UNITYSDK_OFFSET(0x17F2E2D0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_TOVECTOR3_OFFSET UNITYSDK_OFFSET(0x17F2E310)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17F2EC20)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_ParameterData_TypeDefinitionIndex = 37583;
