...
#define HOUDINIENGINEUNITY_HEU_LOADBUFFERBASE_INITIALIZEBUFFER_OFFSET UNITYSDK_OFFSET(0x17F1DB40)
#define HOUDINIENGINEUNITY_HEU_LOADBUFFERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x17F1DB60)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_LoadBufferBase_TypeDefinitionIndex = 37643;
