...
#define HOUDINIENGINEUNITY_HEU_WORKITEMTALLY_ANYWORKITEMSFAILED_OFFSET UNITYSDK_OFFSET(0x17F5CB40)
#define HOUDINIENGINEUNITY_HEU_WORKITEMTALLY_ANYWORKITEMSPENDING_OFFSET UNITYSDK_OFFSET(0x17F5CB90)
#define HOUDINIENGINEUNITY_HEU_WORKITEMTALLY_AREALLWORKITEMSCOMPLETE_OFFSET UNITYSDK_OFFSET(0x17F5CAF0)
#define HOUDINIENGINEUNITY_HEU_WORKITEMTALLY_PROGRESSRATIO_OFFSET UNITYSDK_OFFSET(0x17F729C0)
#define HOUDINIENGINEUNITY_HEU_WORKITEMTALLY_ZEROALL_OFFSET UNITYSDK_OFFSET(0x17F5CAA0)
#define HOUDINIENGINEUNITY_HEU_WORKITEMTALLY__CTOR_OFFSET UNITYSDK_OFFSET(0x17F5CC30)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_WorkItemTally_TypeDefinitionIndex = 37578;
