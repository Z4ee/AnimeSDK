...
#define HOUDINIENGINEUNITY_HEU_WORKITEMTALLY_ANYWORKITEMSFAILED_OFFSET UNITYSDK_OFFSET(0x8CBE390)
#define HOUDINIENGINEUNITY_HEU_WORKITEMTALLY_ANYWORKITEMSPENDING_OFFSET UNITYSDK_OFFSET(0x8CBE3E0)
#define HOUDINIENGINEUNITY_HEU_WORKITEMTALLY_AREALLWORKITEMSCOMPLETE_OFFSET UNITYSDK_OFFSET(0x8CBE340)
#define HOUDINIENGINEUNITY_HEU_WORKITEMTALLY_PROGRESSRATIO_OFFSET UNITYSDK_OFFSET(0x8CD0E30)
#define HOUDINIENGINEUNITY_HEU_WORKITEMTALLY_ZEROALL_OFFSET UNITYSDK_OFFSET(0x8CBE2F0)
#define HOUDINIENGINEUNITY_HEU_WORKITEMTALLY__CTOR_OFFSET UNITYSDK_OFFSET(0x8CBE480)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_WorkItemTally_TypeDefinitionIndex = 43630;
