...
#define HOUDINIENGINEUNITY_HEU_WORKITEMTALLY_ANYWORKITEMSFAILED_OFFSET UNITYSDK_OFFSET(0x1B486550)
#define HOUDINIENGINEUNITY_HEU_WORKITEMTALLY_ANYWORKITEMSPENDING_OFFSET UNITYSDK_OFFSET(0x1B4865A0)
#define HOUDINIENGINEUNITY_HEU_WORKITEMTALLY_AREALLWORKITEMSCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1B486500)
#define HOUDINIENGINEUNITY_HEU_WORKITEMTALLY_PROGRESSRATIO_OFFSET UNITYSDK_OFFSET(0x1B49D450)
#define HOUDINIENGINEUNITY_HEU_WORKITEMTALLY_ZEROALL_OFFSET UNITYSDK_OFFSET(0x1B4864B0)
#define HOUDINIENGINEUNITY_HEU_WORKITEMTALLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B486640)

namespace HoudiniEngineUnity
{
	inline static constexpr unsigned int HEU_WorkItemTally_TypeDefinitionIndex = 39245;
