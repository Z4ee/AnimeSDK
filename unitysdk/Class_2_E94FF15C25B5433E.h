...
#define CLASS_2_E94FF15C25B5433E_METHOD_2_0589B5E7626E6766_OFFSET UNITYSDK_OFFSET(0xE511320)
#define CLASS_2_E94FF15C25B5433E_METHOD_2_0D76AE00F4F0B723_OFFSET UNITYSDK_OFFSET(0xE511120)
#define CLASS_2_E94FF15C25B5433E_METHOD_2_30F611F71DB721B8_OFFSET UNITYSDK_OFFSET(0xE510D20)
#define CLASS_2_E94FF15C25B5433E_METHOD_2_A0646B40A733EA40_OFFSET UNITYSDK_OFFSET(0xE511020)
#define CLASS_2_E94FF15C25B5433E_METHOD_2_DE8FDF9C87F3AA65_OFFSET UNITYSDK_OFFSET(0xE511280)
#define CLASS_2_E94FF15C25B5433E_METHOD_2_FB6392A8F30862C7_OFFSET UNITYSDK_OFFSET(0xE511400)
#define CLASS_2_E94FF15C25B5433E__CTOR_OFFSET UNITYSDK_OFFSET(0xE511270)

inline static constexpr unsigned int Class_2_E94FF15C25B5433E_TypeDefinitionIndex = 60678;

class Class_2_E94FF15C25B5433E : public ::MoleMole::Config::AnimatorEvent
{
public:
	::System::String* Field_2_1; // 0x50
	::MoleMole::Config::EnterBattleState Field_2_2; // 0x58
