...
#define CLASS_2_1A6FC25EF3C932F2_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16C963A0)
#define CLASS_2_1A6FC25EF3C932F2_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16C963E0)
#define CLASS_2_1A6FC25EF3C932F2_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x16C96560)
#define CLASS_2_1A6FC25EF3C932F2_TICK_OFFSET UNITYSDK_OFFSET(0x16C965B0)
#define CLASS_2_1A6FC25EF3C932F2__CTOR_OFFSET UNITYSDK_OFFSET(0x16C96390)

inline static constexpr unsigned int Class_2_1A6FC25EF3C932F2_TypeDefinitionIndex = 50150;

class Class_2_1A6FC25EF3C932F2 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::BlockWheelItem* Field_2_1; // 0x20
