...
#define CLASS_1_3659AE0E8250857A_GET_GEN_OFFSET UNITYSDK_OFFSET(0x18160C50)
#define CLASS_1_3659AE0E8250857A_GET_SEED_OFFSET UNITYSDK_OFFSET(0x18160C70)
#define CLASS_1_3659AE0E8250857A_METHOD_1_5800B8C2CE59928F_OFFSET UNITYSDK_OFFSET(0x18160BB0)
#define CLASS_1_3659AE0E8250857A_SET_GEN_OFFSET UNITYSDK_OFFSET(0x18160C60)
#define CLASS_1_3659AE0E8250857A_SET_SEED_OFFSET UNITYSDK_OFFSET(0x18160C80)
#define CLASS_1_3659AE0E8250857A__CTOR_OFFSET UNITYSDK_OFFSET(0x18160C90)

inline static constexpr unsigned int Class_1_3659AE0E8250857A_TypeDefinitionIndex = 35456;
