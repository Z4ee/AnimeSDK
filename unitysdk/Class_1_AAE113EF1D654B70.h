...
#include "unitysdk/Class_1_AAE113EF1D654B70_Enum_3_C780BFBFED223F30_2.h"
...
#define CLASS_1_AAE113EF1D654B70_METHOD_1_2FA8AE0519AC7829_OFFSET UNITYSDK_OFFSET(0x15CDC600)
#define CLASS_1_AAE113EF1D654B70_METHOD_1_60DC879ACE99CF48_OFFSET UNITYSDK_OFFSET(0x15CDCF20)
#define CLASS_1_AAE113EF1D654B70_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x15CDCE30)
#define CLASS_1_AAE113EF1D654B70_METHOD_1_999A32A2294435FF_OFFSET UNITYSDK_OFFSET(0x15CDC320)
#define CLASS_1_AAE113EF1D654B70_METHOD_1_9B49AC9CA4A66690_OFFSET UNITYSDK_OFFSET(0x15CDCA80)
#define CLASS_1_AAE113EF1D654B70_METHOD_1_DFEAB96CD1BCA51D_OFFSET UNITYSDK_OFFSET(0x15CDC6C0)
#define CLASS_1_AAE113EF1D654B70_METHOD_1_EF3D19C357AD772F_OFFSET UNITYSDK_OFFSET(0x15CDCE90)
#define CLASS_1_AAE113EF1D654B70_METHOD_1_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0x15CDC670)
#define CLASS_1_AAE113EF1D654B70__CCTOR_OFFSET UNITYSDK_OFFSET(0x15CDC870)
#define CLASS_1_AAE113EF1D654B70__CTOR_1_OFFSET UNITYSDK_OFFSET(0x15CDC170)
#define CLASS_1_AAE113EF1D654B70__CTOR_OFFSET UNITYSDK_OFFSET(0x15CDC100)

inline static constexpr unsigned int Class_1_AAE113EF1D654B70_TypeDefinitionIndex = 50017;
...
public:
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::MoleMole::InLevelCustomCameraSequenceType, ::System::Func_2<::Class_1_AAE113EF1D654B70*, ::Class_1_AAE113EF1D654B70_Class_1_18BFEAD82BA3C5E8_1*>*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_AAE113EF1D654B70_TypeDefinitionIndex)->GetStaticField(0x36400);
	}
	::System::Collections::Generic::List_1<::Class_1_AAE113EF1D654B70_Enum_3_C780BFBFED223F30_2>* Field_1_7; // 0x10
	::Class_1_AAE113EF1D654B70_Class_1_18BFEAD82BA3C5E8_1* Field_1_2; // 0x18
	::MoleMole::Utils::TaskBasedEventCollection_1<::Class_1_AAE113EF1D654B70_Enum_3_C780BFBFED223F30_2>* Field_1_8; // 0x20
	::PipelineCamera::SubModule::CameraSequenceCollectionPlayer_1<::PipelineCamera::WorldBasicCameraData>* Field_1_5; // 0x28
	::MoleMole::InLevelCustomPerformerRunnerEnvironment Field_1_1; // 0x30
	::MoleMole::LevelPerform::LevelPerformConfig_InLevelCameraSequenceConfig Field_1_3; // 0x38
