...
#define STAGEHARMONYLIGHTGROUPLINKSLOT_METHOD_2_7DB49B5407C8FD68_OFFSET UNITYSDK_OFFSET(0xABDD4F0)
#define STAGEHARMONYLIGHTGROUPLINKSLOT_METHOD_2_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0xABDD5B0)
#define STAGEHARMONYLIGHTGROUPLINKSLOT_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xABDD6E0)
#define STAGEHARMONYLIGHTGROUPLINKSLOT_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xABDD6A0)
#define STAGEHARMONYLIGHTGROUPLINKSLOT_METHOD_2_F5909B5FD6F94F42_OFFSET UNITYSDK_OFFSET(0xABDD720)
#define STAGEHARMONYLIGHTGROUPLINKSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0xABDDB00)

inline static constexpr unsigned int StageHarmonyLightGroupLinkSlot_TypeDefinitionIndex = 38405;
