...
#define CLASS_1_9F040B65AE1452C4_METHOD_1_47FCE72550F759BF_OFFSET UNITYSDK_OFFSET(0x188F33C0)
#define CLASS_1_9F040B65AE1452C4__CTOR_OFFSET UNITYSDK_OFFSET(0x188F3460)
...
public:
	...
	{
		return (::Class_1_9F040B65AE1452C4**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9F040B65AE1452C4_TypeDefinitionIndex)->GetStaticField(0x666B0);
	}
	::UnityEngine::GUIStyle* JPAGHLAGBKH; // 0x10
	::System::String* EABJNFEEIML; // 0x18
	::UnityEngine::GUIStyle* EKBHGEBNHHL; // 0x20
	::UnityEngine::GUIStyle* KFOOOGCIFAE; // 0x28
	::UnityEngine::GUIContent* CMLIGBGANML; // 0x30
	::System::String* OAKGNPDJPBE; // 0x38
