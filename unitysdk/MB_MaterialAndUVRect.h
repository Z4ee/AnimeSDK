...
#define MB_MATERIALANDUVRECT_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C466D40)
#define MB_MATERIALANDUVRECT_GETENCAPSULATINGRECT_OFFSET UNITYSDK_OFFSET(0x1C466E70)
#define MB_MATERIALANDUVRECT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C466C20)
#define MB_MATERIALANDUVRECT_GETMATERIALTILINGRECT_OFFSET UNITYSDK_OFFSET(0x1C466E90)
#define MB_MATERIALANDUVRECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C466BC0)

inline static constexpr unsigned int MB_MaterialAndUVRect_TypeDefinitionIndex = 84954;
