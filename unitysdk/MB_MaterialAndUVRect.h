...
#define MB_MATERIALANDUVRECT_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E7A4B60)
#define MB_MATERIALANDUVRECT_GETENCAPSULATINGRECT_OFFSET UNITYSDK_OFFSET(0x1E7A4C90)
#define MB_MATERIALANDUVRECT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E7A4A40)
#define MB_MATERIALANDUVRECT_GETMATERIALTILINGRECT_OFFSET UNITYSDK_OFFSET(0x1E7A4CB0)
#define MB_MATERIALANDUVRECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7A49E0)

inline static constexpr unsigned int MB_MaterialAndUVRect_TypeDefinitionIndex = 90528;
