...
#define RENDERITEMPOLYMERCONFIG_GET_ADDANIMATIONIRI_OFFSET UNITYSDK_OFFSET(0xABBB910)
#define RENDERITEMPOLYMERCONFIG_GET_ADDSYNCPOSITIONCHILDPATH_OFFSET UNITYSDK_OFFSET(0xABBC250)
#define RENDERITEMPOLYMERCONFIG_GET_ADDSYNCPOSITIONROOTPATH_OFFSET UNITYSDK_OFFSET(0xABBB070)
#define RENDERITEMPOLYMERCONFIG_METHOD_5_B44E223C58DE8E13_OFFSET UNITYSDK_OFFSET(0xABBBA50)
#define RENDERITEMPOLYMERCONFIG_METHOD_5_F4DD08A31BA3F883_OFFSET UNITYSDK_OFFSET(0xABBB5D0)
#define RENDERITEMPOLYMERCONFIG_METHOD_5_FBE22211014B40D9_OFFSET UNITYSDK_OFFSET(0xABBB0E0)
#define RENDERITEMPOLYMERCONFIG_SET_ADDANIMATIONIRI_OFFSET UNITYSDK_OFFSET(0xABBB920)
#define RENDERITEMPOLYMERCONFIG_SET_ADDSYNCPOSITIONCHILDPATH_OFFSET UNITYSDK_OFFSET(0xABBC260)
#define RENDERITEMPOLYMERCONFIG_SET_ADDSYNCPOSITIONROOTPATH_OFFSET UNITYSDK_OFFSET(0xABBB080)
#define RENDERITEMPOLYMERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xABBC3D0)

inline static constexpr unsigned int RenderItemPolymerConfig_TypeDefinitionIndex = 38236;
