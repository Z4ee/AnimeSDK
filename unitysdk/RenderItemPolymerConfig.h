...
#define RENDERITEMPOLYMERCONFIG_GET_ADDANIMATIONIRI_OFFSET UNITYSDK_OFFSET(0xD075300)
#define RENDERITEMPOLYMERCONFIG_GET_ADDSYNCPOSITIONCHILDPATH_OFFSET UNITYSDK_OFFSET(0xD076120)
#define RENDERITEMPOLYMERCONFIG_GET_ADDSYNCPOSITIONROOTPATH_OFFSET UNITYSDK_OFFSET(0xD074990)
#define RENDERITEMPOLYMERCONFIG_METHOD_5_0869E1192F8E01DF_OFFSET UNITYSDK_OFFSET(0xD074FC0)
#define RENDERITEMPOLYMERCONFIG_METHOD_5_560ABD6EDDE4D0DB_OFFSET UNITYSDK_OFFSET(0xD074A00)
#define RENDERITEMPOLYMERCONFIG_METHOD_5_65BECD5F98452910_OFFSET UNITYSDK_OFFSET(0xD075510)
#define RENDERITEMPOLYMERCONFIG_SET_ADDANIMATIONIRI_OFFSET UNITYSDK_OFFSET(0xD075310)
#define RENDERITEMPOLYMERCONFIG_SET_ADDSYNCPOSITIONCHILDPATH_OFFSET UNITYSDK_OFFSET(0xD076130)
#define RENDERITEMPOLYMERCONFIG_SET_ADDSYNCPOSITIONROOTPATH_OFFSET UNITYSDK_OFFSET(0xD0749A0)
#define RENDERITEMPOLYMERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xD076360)

inline static constexpr unsigned int RenderItemPolymerConfig_TypeDefinitionIndex = 44666;
