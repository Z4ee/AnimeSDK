...
#define RENDERITEMPOLYMERCONFIG_GET_ADDANIMATIONIRI_OFFSET UNITYSDK_OFFSET(0x19F65DC0)
#define RENDERITEMPOLYMERCONFIG_GET_ADDSYNCPOSITIONCHILDPATH_OFFSET UNITYSDK_OFFSET(0x19F66B60)
#define RENDERITEMPOLYMERCONFIG_GET_ADDSYNCPOSITIONROOTPATH_OFFSET UNITYSDK_OFFSET(0x19F65330)
#define RENDERITEMPOLYMERCONFIG_METHOD_5_0869E1192F8E01DF_OFFSET UNITYSDK_OFFSET(0x19F65A80)
#define RENDERITEMPOLYMERCONFIG_METHOD_5_560ABD6EDDE4D0DB_OFFSET UNITYSDK_OFFSET(0x19F653A0)
#define RENDERITEMPOLYMERCONFIG_METHOD_5_65BECD5F98452910_OFFSET UNITYSDK_OFFSET(0x19F65F50)
#define RENDERITEMPOLYMERCONFIG_SET_ADDANIMATIONIRI_OFFSET UNITYSDK_OFFSET(0x19F65DD0)
#define RENDERITEMPOLYMERCONFIG_SET_ADDSYNCPOSITIONCHILDPATH_OFFSET UNITYSDK_OFFSET(0x19F66B70)
#define RENDERITEMPOLYMERCONFIG_SET_ADDSYNCPOSITIONROOTPATH_OFFSET UNITYSDK_OFFSET(0x19F65340)
#define RENDERITEMPOLYMERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19F66DA0)

inline static constexpr unsigned int RenderItemPolymerConfig_TypeDefinitionIndex = 45546;
