...
#define RENDERITEMPOLYMERCONFIG_GET_ADDANIMATIONIRI_OFFSET UNITYSDK_OFFSET(0xE908200)
#define RENDERITEMPOLYMERCONFIG_GET_ADDSYNCPOSITIONCHILDPATH_OFFSET UNITYSDK_OFFSET(0xE908FA0)
#define RENDERITEMPOLYMERCONFIG_GET_ADDSYNCPOSITIONROOTPATH_OFFSET UNITYSDK_OFFSET(0xE907730)
#define RENDERITEMPOLYMERCONFIG_METHOD_5_0869E1192F8E01DF_OFFSET UNITYSDK_OFFSET(0xE907E90)
#define RENDERITEMPOLYMERCONFIG_METHOD_5_560ABD6EDDE4D0DB_OFFSET UNITYSDK_OFFSET(0xE9077A0)
#define RENDERITEMPOLYMERCONFIG_METHOD_5_65BECD5F98452910_OFFSET UNITYSDK_OFFSET(0xE908390)
#define RENDERITEMPOLYMERCONFIG_SET_ADDANIMATIONIRI_OFFSET UNITYSDK_OFFSET(0xE908210)
#define RENDERITEMPOLYMERCONFIG_SET_ADDSYNCPOSITIONCHILDPATH_OFFSET UNITYSDK_OFFSET(0xE908FB0)
#define RENDERITEMPOLYMERCONFIG_SET_ADDSYNCPOSITIONROOTPATH_OFFSET UNITYSDK_OFFSET(0xE907740)
#define RENDERITEMPOLYMERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xE9091E0)
