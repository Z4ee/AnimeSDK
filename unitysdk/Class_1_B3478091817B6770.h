...
#define CLASS_1_B3478091817B6770__CTOR_OFFSET UNITYSDK_OFFSET(0xB70A880)
...
public:
	...
	::RPG::GameCore::GridFightTraitEffectChargeType MJPHFBALDBM; // 0x18
	::RPG::GameCore::GridFightTraitEffectChangeHintType HMOAIJEANAP; // 0x1C
