...
#define CLASS_3_6485C8A7E38B4E35_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xCB3F620)
#define CLASS_3_6485C8A7E38B4E35__CTOR_OFFSET UNITYSDK_OFFSET(0xCB3F5F0)

inline static constexpr unsigned int Class_3_6485C8A7E38B4E35_TypeDefinitionIndex = 46901;
