...
#define ADVANCEDNAVMESHAREACALCULATOR_ADDNEWNAVMESHDATA_OFFSET UNITYSDK_OFFSET(0x171EFA40)
#define ADVANCEDNAVMESHAREACALCULATOR_CALCULATECURRENTNAVMESHAREA_OFFSET UNITYSDK_OFFSET(0x171EF700)
#define ADVANCEDNAVMESHAREACALCULATOR_CALCULATETOTALAREA_OFFSET UNITYSDK_OFFSET(0x171EF0D0)
#define ADVANCEDNAVMESHAREACALCULATOR_CLEARALLDATA_OFFSET UNITYSDK_OFFSET(0x171EFDF0)
#define ADVANCEDNAVMESHAREACALCULATOR_GETNAVMESHDATAINFOLDER_OFFSET UNITYSDK_OFFSET(0x171EFED0)
#define ADVANCEDNAVMESHAREACALCULATOR_GET_TOTALAREA_OFFSET UNITYSDK_OFFSET(0x171EEEE0)
#define ADVANCEDNAVMESHAREACALCULATOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x171EEF00)
#define ADVANCEDNAVMESHAREACALCULATOR_REMOVENAVMESHDATA_OFFSET UNITYSDK_OFFSET(0x171EFB50)
#define ADVANCEDNAVMESHAREACALCULATOR_SET_TOTALAREA_OFFSET UNITYSDK_OFFSET(0x171EEEF0)
#define ADVANCEDNAVMESHAREACALCULATOR_TOGGLENAVMESHDATA_OFFSET UNITYSDK_OFFSET(0x171EFC00)
#define ADVANCEDNAVMESHAREACALCULATOR_UNLOADALLNAVMESHDATA_OFFSET UNITYSDK_OFFSET(0x171EEF50)
#define ADVANCEDNAVMESHAREACALCULATOR_UPDATENAVMESHDATAASSET_OFFSET UNITYSDK_OFFSET(0x171EFD50)
#define ADVANCEDNAVMESHAREACALCULATOR_UPDATENAVMESHDATANAME_OFFSET UNITYSDK_OFFSET(0x171EFCA0)
#define ADVANCEDNAVMESHAREACALCULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x171EFF80)

inline static constexpr unsigned int AdvancedNavMeshAreaCalculator_TypeDefinitionIndex = 49421;
