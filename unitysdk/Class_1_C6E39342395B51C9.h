...
#define CLASS_1_C6E39342395B51C9_DISPOSE_OFFSET UNITYSDK_OFFSET(0x176F2C30)
#define CLASS_1_C6E39342395B51C9_GET_SUBMODETYPE_OFFSET UNITYSDK_OFFSET(0x176F2D10)
#define CLASS_1_C6E39342395B51C9_GET_UPPERGROUPMAP_OFFSET UNITYSDK_OFFSET(0x176F2CF0)
#define CLASS_1_C6E39342395B51C9_METHOD_1_8E6B1A705324E469_OFFSET UNITYSDK_OFFSET(0x176F2C80)
#define CLASS_1_C6E39342395B51C9_SET_SUBMODETYPE_OFFSET UNITYSDK_OFFSET(0x176F2D20)
#define CLASS_1_C6E39342395B51C9_SET_UPPERGROUPMAP_OFFSET UNITYSDK_OFFSET(0x176F2D00)
#define CLASS_1_C6E39342395B51C9__CTOR_OFFSET UNITYSDK_OFFSET(0x176F2B80)

inline static constexpr unsigned int Class_1_C6E39342395B51C9_TypeDefinitionIndex = 56218;
