...
#define CLASS_2_FFBC8C99F6B84D8F_METHOD_2_E4EE4D98EE55C81B_OFFSET UNITYSDK_OFFSET(0x192408B0)
#define CLASS_2_FFBC8C99F6B84D8F__CTOR_OFFSET UNITYSDK_OFFSET(0x19240A00)

inline static constexpr unsigned int Class_2_FFBC8C99F6B84D8F_TypeDefinitionIndex = 19002;

class Class_2_FFBC8C99F6B84D8F : public ::RPG::GameCore::JsonConfig
{
public:
	::RPG::GameCore::STDetectMoneyType Field_2_0; // 0x10
