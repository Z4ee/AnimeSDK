...
#define AKMEMBANKLOADER__LOADFILE_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BD66BD0)
#define AKMEMBANKLOADER__LOADFILE_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BD67040)
#define AKMEMBANKLOADER__LOADFILE_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BD670A0)
#define AKMEMBANKLOADER__LOADFILE_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BD67050)
#define AKMEMBANKLOADER__LOADFILE_D__14_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BD66BC0)
#define AKMEMBANKLOADER__LOADFILE_D__14__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD66960)

inline static constexpr unsigned int AkMemBankLoader__LoadFile_d__14_TypeDefinitionIndex = 42134;
