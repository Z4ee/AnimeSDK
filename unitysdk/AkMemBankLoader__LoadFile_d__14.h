...
#define AKMEMBANKLOADER__LOADFILE_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x18BC0A90)
#define AKMEMBANKLOADER__LOADFILE_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18BC0E20)
#define AKMEMBANKLOADER__LOADFILE_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18BC0E80)
#define AKMEMBANKLOADER__LOADFILE_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x18BC0E30)
#define AKMEMBANKLOADER__LOADFILE_D__14_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18BC0A80)
#define AKMEMBANKLOADER__LOADFILE_D__14__CTOR_OFFSET UNITYSDK_OFFSET(0x18BC0820)

inline static constexpr unsigned int AkMemBankLoader__LoadFile_d__14_TypeDefinitionIndex = 34673;
