...
#define CLASS_3_460B59E6EC8A4DB8_METHOD_3_514ABAC4020261C0_OFFSET UNITYSDK_OFFSET(0x1CCA6A70)
#define CLASS_3_460B59E6EC8A4DB8_METHOD_3_A18832F1E35D7A11_OFFSET UNITYSDK_OFFSET(0x1CCA6990)
#define CLASS_3_460B59E6EC8A4DB8__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCA6A10)
...
public:
	...
	::System::String* KOOOKCNNPFE; // 0x20
	::Il2CppArray<::System::String*>* PKKDIAENBEK; // 0x28
	::RPG::GameCore::TargetEvaluator* HILNFHCPEAD; // 0x30
	::System::String* OLOIFNNLKJP; // 0x38
	::RPG::GameCore::DynamicFloat* OFBPKCNCGFG; // 0x40
	::RPG::GameCore::DynamicFloat* HOCMHABKLGJ; // 0x48
	::RPG::GameCore::MonsterEnergyBarCustomColor* OCHLDEHBDOL; // 0x50
	::Il2CppArray<::RPG::GameCore::UITextNode*>* KDIAKCHPLMN; // 0x58
	::System::String* ECLCEDOLOBG; // 0x60
	::RPG::GameCore::DynamicFloat* JADMAPDKLKL; // 0x68
	::System::String* FCAHMLGMDMN; // 0x70
	::RPG::GameCore::MonsterEnergyBarType OPFMFGGBAKC; // 0x78
	::System::Int32 EIADCADKKDN; // 0x7C
	::System::Int32 EOIHOACNHDH; // 0x80
	::System::Int32 IMPAJLCMHFP; // 0x84
	::RPG::GameCore::MonsterEnergyBarNumColor IBNBFBBNBBH; // 0x88
	::RPG::GameCore::BoolEx BGCEFKAHBDE; // 0x8C
	::RPG::GameCore::BoolEx IOBJFEJFLJP; // 0x90
	::RPG::GameCore::EnergyBarState MEPFOEEGBEA; // 0x94
