...
#define NAPLODCONTROLLERGROUP_COOKDISTANCE_OFFSET UNITYSDK_OFFSET(0xFDFA870)
#define NAPLODCONTROLLERGROUP_GET_SIZE_OFFSET UNITYSDK_OFFSET(0xFDF9BF0)
#define NAPLODCONTROLLERGROUP_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xFDF9D90)
#define NAPLODCONTROLLERGROUP_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xFDF97E0)
#define NAPLODCONTROLLERGROUP_ONENABLE_OFFSET UNITYSDK_OFFSET(0xFDF9490)
#define NAPLODCONTROLLERGROUP_ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0xFDFAA50)
#define NAPLODCONTROLLERGROUP_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0xFDF9B30)
#define NAPLODCONTROLLERGROUP_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0xFDF9B90)
#define NAPLODCONTROLLERGROUP_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0xFDF98A0)
#define NAPLODCONTROLLERGROUP_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0xFDF9550)
#define NAPLODCONTROLLERGROUP_SETLODOFFSET_OFFSET UNITYSDK_OFFSET(0xFDFB050)
#define NAPLODCONTROLLERGROUP_START_OFFSET UNITYSDK_OFFSET(0xFDFAA00)
#define NAPLODCONTROLLERGROUP__CCTOR_OFFSET UNITYSDK_OFFSET(0xFDFB2F0)
#define NAPLODCONTROLLERGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xFDFB240)

inline static constexpr unsigned int NapLodControllerGroup_TypeDefinitionIndex = 64737;
...
public:
	...
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(NapLodControllerGroup_TypeDefinitionIndex)->GetStaticField(0xEF30);
	}
