...
#define CLASS_1_9D5468144EC4C1CF_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19B152E0)
#define CLASS_1_9D5468144EC4C1CF_CLONE_OFFSET UNITYSDK_OFFSET(0x19B14EC0)
#define CLASS_1_9D5468144EC4C1CF_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19B15030)
#define CLASS_1_9D5468144EC4C1CF_EQUALS_OFFSET UNITYSDK_OFFSET(0x19B14F20)
#define CLASS_1_9D5468144EC4C1CF_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19B150E0)
#define CLASS_1_9D5468144EC4C1CF_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19B15420)
#define CLASS_1_9D5468144EC4C1CF_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19B15380)
#define CLASS_1_9D5468144EC4C1CF_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19B14D50)
#define CLASS_1_9D5468144EC4C1CF_METHOD_1_96F1CABDCC6E782E_OFFSET UNITYSDK_OFFSET(0x19B14F10)
#define CLASS_1_9D5468144EC4C1CF_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19B14DB0)
#define CLASS_1_9D5468144EC4C1CF_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19B151D0)
#define CLASS_1_9D5468144EC4C1CF_WRITETO_OFFSET UNITYSDK_OFFSET(0x19B15230)
#define CLASS_1_9D5468144EC4C1CF__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B15500)
#define CLASS_1_9D5468144EC4C1CF__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B14E10)
#define CLASS_1_9D5468144EC4C1CF__CTOR_OFFSET UNITYSDK_OFFSET(0x19B14DC0)

inline static constexpr unsigned int Class_1_9D5468144EC4C1CF_TypeDefinitionIndex = 30457;

class Class_1_9D5468144EC4C1CF : public ::System::Object
{
public:
	static ::Google::Protobuf::FieldCodec_1<::Proto::BigDataAvatarRelicRecommend*>** StaticGet_Field_1_3()
	{
		return (::Google::Protobuf::FieldCodec_1<::Proto::BigDataAvatarRelicRecommend*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9D5468144EC4C1CF_TypeDefinitionIndex)->GetStaticField(0x5FD60);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_9D5468144EC4C1CF*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_9D5468144EC4C1CF*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9D5468144EC4C1CF_TypeDefinitionIndex)->GetStaticField(0x5FD68);
	}
	// static const ::System::Int32 Field_1_2 = 0xC; // 0x0
	::Google::Protobuf::Collections::RepeatedField_1<::Proto::BigDataAvatarRelicRecommend*>* Field_1_4; // 0x10
