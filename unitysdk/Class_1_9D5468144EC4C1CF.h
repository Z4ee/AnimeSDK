...
#define CLASS_1_9D5468144EC4C1CF_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1AB2E4E0)
#define CLASS_1_9D5468144EC4C1CF_CLONE_OFFSET UNITYSDK_OFFSET(0x1AB2E0D0)
#define CLASS_1_9D5468144EC4C1CF_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1AB2E240)
#define CLASS_1_9D5468144EC4C1CF_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AB2E130)
#define CLASS_1_9D5468144EC4C1CF_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AB2E2F0)
#define CLASS_1_9D5468144EC4C1CF_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1AB2E620)
#define CLASS_1_9D5468144EC4C1CF_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1AB2E580)
#define CLASS_1_9D5468144EC4C1CF_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1AB2DF60)
#define CLASS_1_9D5468144EC4C1CF_METHOD_1_96F1CABDCC6E782E_OFFSET UNITYSDK_OFFSET(0x1AB2E120)
#define CLASS_1_9D5468144EC4C1CF_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1AB2DFC0)
#define CLASS_1_9D5468144EC4C1CF_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AB2E3D0)
#define CLASS_1_9D5468144EC4C1CF_WRITETO_OFFSET UNITYSDK_OFFSET(0x1AB2E430)
#define CLASS_1_9D5468144EC4C1CF__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AB2E7E0)
#define CLASS_1_9D5468144EC4C1CF__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB2E020)
#define CLASS_1_9D5468144EC4C1CF__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB2DFD0)

inline static constexpr unsigned int Class_1_9D5468144EC4C1CF_TypeDefinitionIndex = 30564;
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Proto::BigDataAvatarRelicRecommend*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9D5468144EC4C1CF_TypeDefinitionIndex)->GetStaticField(0x17B10);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_9D5468144EC4C1CF*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_9D5468144EC4C1CF*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9D5468144EC4C1CF_TypeDefinitionIndex)->GetStaticField(0x17B18);
	}
	// static const ::System::Int32 Field_1_2 = 0xD; // 0x0
	::Google::Protobuf::UnknownFieldSet* Field_1_3; // 0x10
	::Google::Protobuf::Collections::RepeatedField_1<::Proto::BigDataAvatarRelicRecommend*>* Field_1_4; // 0x18
