...
#define CLASS_2_7F0BF9B3687806BC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1592DD80)
#define CLASS_2_7F0BF9B3687806BC_METHOD_2_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0x1592E010)
#define CLASS_2_7F0BF9B3687806BC_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1592DEA0)
#define CLASS_2_7F0BF9B3687806BC_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1592DF60)
#define CLASS_2_7F0BF9B3687806BC_TICK_OFFSET UNITYSDK_OFFSET(0x1592DE40)
#define CLASS_2_7F0BF9B3687806BC__CTOR_OFFSET UNITYSDK_OFFSET(0x1592DD70)

inline static constexpr unsigned int Class_2_7F0BF9B3687806BC_TypeDefinitionIndex = 58605;

class Class_2_7F0BF9B3687806BC : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::GameCore::RogueDLC1Dot3DiceRotate* OFKGLJOAMLD; // 0x20
