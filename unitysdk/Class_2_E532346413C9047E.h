...
#define CLASS_2_E532346413C9047E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x117A11D0)
#define CLASS_2_E532346413C9047E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x117A0F50)
#define CLASS_2_E532346413C9047E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x117A1140)
#define CLASS_2_E532346413C9047E_TICK_OFFSET UNITYSDK_OFFSET(0x117A0FA0)
#define CLASS_2_E532346413C9047E__CTOR_OFFSET UNITYSDK_OFFSET(0x117A0F40)

inline static constexpr unsigned int Class_2_E532346413C9047E_TypeDefinitionIndex = 54243;

class Class_2_E532346413C9047E : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::UIMonopolyWaitMainPage* Field_2_0; // 0x18
