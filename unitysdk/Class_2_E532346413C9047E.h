...
#define CLASS_2_E532346413C9047E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x160B1020)
#define CLASS_2_E532346413C9047E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x160B0CF0)
#define CLASS_2_E532346413C9047E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x160B0F90)
#define CLASS_2_E532346413C9047E_TICK_OFFSET UNITYSDK_OFFSET(0x160B0D40)
#define CLASS_2_E532346413C9047E__CTOR_OFFSET UNITYSDK_OFFSET(0x160B0CE0)

inline static constexpr unsigned int Class_2_E532346413C9047E_TypeDefinitionIndex = 56202;

class Class_2_E532346413C9047E : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::UIMonopolyWaitMainPage* Field_2_1; // 0x20
