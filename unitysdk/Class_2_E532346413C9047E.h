...
#define CLASS_2_E532346413C9047E_DISPOSE_OFFSET UNITYSDK_OFFSET(0xE456AF0)
#define CLASS_2_E532346413C9047E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xE456830)
#define CLASS_2_E532346413C9047E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xE456A60)
#define CLASS_2_E532346413C9047E_TICK_OFFSET UNITYSDK_OFFSET(0xE456880)
#define CLASS_2_E532346413C9047E__CTOR_OFFSET UNITYSDK_OFFSET(0xE456820)

inline static constexpr unsigned int Class_2_E532346413C9047E_TypeDefinitionIndex = 54969;
