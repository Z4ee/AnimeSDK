...
#define CLASS_2_78CEF5203DD4B7B4_METHOD_2_0B7AE2333E75CC14_OFFSET UNITYSDK_OFFSET(0x134C72E0)
#define CLASS_2_78CEF5203DD4B7B4_METHOD_2_84516C3E776F194F_OFFSET UNITYSDK_OFFSET(0x134C7450)
#define CLASS_2_78CEF5203DD4B7B4__CTOR_OFFSET UNITYSDK_OFFSET(0x134C74E0)
#define CLASS_2_78CEF5203DD4B7B4__ONBIND_OFFSET UNITYSDK_OFFSET(0x134C7100)
#define CLASS_2_78CEF5203DD4B7B4___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x134C7510)

inline static constexpr unsigned int Class_2_78CEF5203DD4B7B4_TypeDefinitionIndex = 67170;
