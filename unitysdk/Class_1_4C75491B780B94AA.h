...
#define CLASS_1_4C75491B780B94AA_GET_ISPVP1V1NETWORKDATAREADY_OFFSET UNITYSDK_OFFSET(0x15A046C0)
#define CLASS_1_4C75491B780B94AA_GET_ISPVPNETWORKDATAREADY_OFFSET UNITYSDK_OFFSET(0x15A046A0)
#define CLASS_1_4C75491B780B94AA_GET_ISPVPROYALENETWORKDATAREADY_OFFSET UNITYSDK_OFFSET(0x15A046E0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_012CEDC0727C8D27_OFFSET UNITYSDK_OFFSET(0x15A04440)
#define CLASS_1_4C75491B780B94AA_METHOD_1_0BDAEE707043B6C9_OFFSET UNITYSDK_OFFSET(0x159FF100)
#define CLASS_1_4C75491B780B94AA_METHOD_1_0C88AB06D46E777A_OFFSET UNITYSDK_OFFSET(0x15A022B0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_10054BB010E03EDD_OFFSET UNITYSDK_OFFSET(0x159FE6A0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_102BA849186931FD_OFFSET UNITYSDK_OFFSET(0x159FDE50)
#define CLASS_1_4C75491B780B94AA_METHOD_1_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x15A035A0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_1808E1CF7A125519_1_OFFSET UNITYSDK_OFFSET(0x159FF930)
#define CLASS_1_4C75491B780B94AA_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x159FF370)
#define CLASS_1_4C75491B780B94AA_METHOD_1_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x15A017D0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_1CDA0051FD244886_OFFSET UNITYSDK_OFFSET(0x15A01DA0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_2045BA2947DBDBCE_OFFSET UNITYSDK_OFFSET(0x159FDB40)
#define CLASS_1_4C75491B780B94AA_METHOD_1_344DB1721ADD2658_1_OFFSET UNITYSDK_OFFSET(0x15A00770)
#define CLASS_1_4C75491B780B94AA_METHOD_1_344DB1721ADD2658_2_OFFSET UNITYSDK_OFFSET(0x15A010B0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_344DB1721ADD2658_OFFSET UNITYSDK_OFFSET(0x159FFAD0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_3C0149AD0F766343_OFFSET UNITYSDK_OFFSET(0x159FEA60)
#define CLASS_1_4C75491B780B94AA_METHOD_1_40A10C74E0EFD4AD_OFFSET UNITYSDK_OFFSET(0x159FF840)
#define CLASS_1_4C75491B780B94AA_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x15A03260)
#define CLASS_1_4C75491B780B94AA_METHOD_1_51BBA01F511E6107_OFFSET UNITYSDK_OFFSET(0x15A01A90)
#define CLASS_1_4C75491B780B94AA_METHOD_1_749948B663FCCCEF_1_OFFSET UNITYSDK_OFFSET(0x159FECE0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_749948B663FCCCEF_2_OFFSET UNITYSDK_OFFSET(0x159FEEF0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_749948B663FCCCEF_OFFSET UNITYSDK_OFFSET(0x159FEAD0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_78A816EDF045E4C8_OFFSET UNITYSDK_OFFSET(0x15A004F0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_7F4EBEC55EBE2D81_OFFSET UNITYSDK_OFFSET(0x15A03810)
#define CLASS_1_4C75491B780B94AA_METHOD_1_7FBA19736CF767B2_OFFSET UNITYSDK_OFFSET(0x159FE9E0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_80520F976E9CE8B4_OFFSET UNITYSDK_OFFSET(0x159FDD30)
#define CLASS_1_4C75491B780B94AA_METHOD_1_8BB948EFB8DB02D1_OFFSET UNITYSDK_OFFSET(0x159FF1C0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_8CA05BCD86E125DF_OFFSET UNITYSDK_OFFSET(0x15A036C0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_8CA88D55ECEFAD59_OFFSET UNITYSDK_OFFSET(0x159FE280)
#define CLASS_1_4C75491B780B94AA_METHOD_1_8CBF5028E5DA8254_1_OFFSET UNITYSDK_OFFSET(0x15A03C80)
#define CLASS_1_4C75491B780B94AA_METHOD_1_8CBF5028E5DA8254_OFFSET UNITYSDK_OFFSET(0x15A03970)
#define CLASS_1_4C75491B780B94AA_METHOD_1_915FBC3734874058_OFFSET UNITYSDK_OFFSET(0x15A00290)
#define CLASS_1_4C75491B780B94AA_METHOD_1_9681042564541CD6_1_OFFSET UNITYSDK_OFFSET(0x15A02210)
#define CLASS_1_4C75491B780B94AA_METHOD_1_9681042564541CD6_2_OFFSET UNITYSDK_OFFSET(0x15A034F0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x159FDF20)
#define CLASS_1_4C75491B780B94AA_METHOD_1_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0x15A03410)
#define CLASS_1_4C75491B780B94AA_METHOD_1_A51891BFB0ABDB68_OFFSET UNITYSDK_OFFSET(0x15A03F90)
#define CLASS_1_4C75491B780B94AA_METHOD_1_B235E757922104A8_OFFSET UNITYSDK_OFFSET(0x159FFA00)
#define CLASS_1_4C75491B780B94AA_METHOD_1_B6BB704B01BCC35B_OFFSET UNITYSDK_OFFSET(0x159FDEA0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_BDE3028FCE2D9EC3_OFFSET UNITYSDK_OFFSET(0x159FF5A0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_C07F2657F47AFF02_OFFSET UNITYSDK_OFFSET(0x159FF9A0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_C8E2469222842786_OFFSET UNITYSDK_OFFSET(0x159FE860)
#define CLASS_1_4C75491B780B94AA_METHOD_1_CB145AC06225B366_OFFSET UNITYSDK_OFFSET(0x15A038B0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_CBDC22058B67F0FE_OFFSET UNITYSDK_OFFSET(0x159FD7C0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x159FDA50)
#define CLASS_1_4C75491B780B94AA_METHOD_1_D308836DB54415C3_OFFSET UNITYSDK_OFFSET(0x15A002A0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_D588C897704F5375_OFFSET UNITYSDK_OFFSET(0x15A04230)
#define CLASS_1_4C75491B780B94AA_METHOD_1_DE1C1F4DF5D06882_1_OFFSET UNITYSDK_OFFSET(0x15A00F30)
#define CLASS_1_4C75491B780B94AA_METHOD_1_DE1C1F4DF5D06882_2_OFFSET UNITYSDK_OFFSET(0x15A015D0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_DE1C1F4DF5D06882_OFFSET UNITYSDK_OFFSET(0x15A005F0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_DFF98536D8B4074F_OFFSET UNITYSDK_OFFSET(0x159FF280)
#define CLASS_1_4C75491B780B94AA_METHOD_1_E11A60CCAF1D8111_1_OFFSET UNITYSDK_OFFSET(0x159FF4C0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_E11A60CCAF1D8111_2_OFFSET UNITYSDK_OFFSET(0x159FF680)
#define CLASS_1_4C75491B780B94AA_METHOD_1_E11A60CCAF1D8111_3_OFFSET UNITYSDK_OFFSET(0x159FF760)
#define CLASS_1_4C75491B780B94AA_METHOD_1_E11A60CCAF1D8111_OFFSET UNITYSDK_OFFSET(0x159FF3E0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_E21AC6EE08DC160A_OFFSET UNITYSDK_OFFSET(0x15A01840)
#define CLASS_1_4C75491B780B94AA_METHOD_1_E41B6A823556FEEA_OFFSET UNITYSDK_OFFSET(0x15A02180)
#define CLASS_1_4C75491B780B94AA_METHOD_1_EC5C1AC08DA276C7_OFFSET UNITYSDK_OFFSET(0x15A03000)
#define CLASS_1_4C75491B780B94AA_METHOD_1_EC83FF7769033850_OFFSET UNITYSDK_OFFSET(0x15A01750)
#define CLASS_1_4C75491B780B94AA_METHOD_1_FE09F91DC8303B4D_OFFSET UNITYSDK_OFFSET(0x159FE970)
#define CLASS_1_4C75491B780B94AA_SET_ISPVP1V1NETWORKDATAREADY_OFFSET UNITYSDK_OFFSET(0x15A046D0)
#define CLASS_1_4C75491B780B94AA_SET_ISPVPNETWORKDATAREADY_OFFSET UNITYSDK_OFFSET(0x15A046B0)
#define CLASS_1_4C75491B780B94AA_SET_ISPVPROYALENETWORKDATAREADY_OFFSET UNITYSDK_OFFSET(0x15A046F0)
#define CLASS_1_4C75491B780B94AA__CTOR_OFFSET UNITYSDK_OFFSET(0x15A04700)

inline static constexpr unsigned int Class_1_4C75491B780B94AA_TypeDefinitionIndex = 76081;

class Class_1_4C75491B780B94AA : public ::System::Object
{
public:
	// static const ::System::UInt32 PMEHFMCKBKJ = 0x7; // 0x0
	// static const ::System::UInt32 PPKPAIPGGJB = 0x7; // 0x0
	::Class_3_83FD4418E6E9E045* MOAHPOKJFMH; // 0x10
	::System::Collections::Generic::List_1<::RPG::GameCore::Match3::BombCreateConfig*>* DIAGMGFBMNB; // 0x18
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::GameCore::Match3::PieceConfig*>* AEMBMHAIFMB; // 0x20
	::System::Collections::Generic::List_1<::RPG::Client::MatchThreeGameProp*>* NDOAIECPLBE; // 0x28
	::RPG::GameCore::Match3::Match3BirdSkillConfig* LJHHGLJAJFC; // 0x30
	::System::Collections::Generic::List_1<::RPG::Client::MatchThreeGameProp*>* NMHLIAHHGGM; // 0x38
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::GameCore::Match3::PieceConfig*>* DAMCNHHCGPB; // 0x40
	::System::Collections::Generic::List_1<::RPG::GameCore::Match3::PieceConfig*>* GPLJOCJABDG; // 0x48
	::RPG::Client::MatchThreeBoard* PCDGPKPNIOE; // 0x50
	::System::Action_1<::RPG::Client::LittleGame::Match3::Match3GameState>* EFKLHOJHCEG; // 0x58
	::System::Action* LKGCGEDKPDP; // 0x60
	::RPG::GameCore::Match3::Match3BirdSkillConfig* CINFFNNKCHF; // 0x68
	::RPG::Client::LittleGame::MatchThreeTimelineBattleField* NJGEMGKDBCM; // 0x70
	::System::String* JLFLLPEIKGF; // 0x78
	::Class_1_D33B7D6901AE39E9* FKINCGODJEP; // 0x80
	::System::Action* MJBDDBBGBLJ; // 0x88
	::RPG::GameCore::GameEntity* LIDKFDENKAP; // 0x90
	::Class_3_1A9D32B2B1D681B8* PDENFEFCAGN; // 0x98
	::System::UInt32 CCNEOCIJAJA; // 0xA0
	::RPG::Client::LittleGame::Match3::MatchThreeGameMode GICHGNGMBGD; // 0xA4
	::System::UInt32 NIGHDMEGFNF; // 0xA8
	::System::UInt32 BMLFMMNOJJM; // 0xAC
	::System::UInt32 JCGAHCNJFJP; // 0xB0
	::System::Boolean _IsPvpNetworkDataReady_k__BackingField; // 0xB4
	::System::Boolean _IsPvpRoyaleNetworkDataReady_k__BackingField; // 0xB5
	::System::Boolean _IsPvp1v1NetworkDataReady_k__BackingField; // 0xB6
	::System::Boolean EMHAACACFOM; // 0xB7
	::System::UInt32 CNDNIFAFBGK; // 0xB8
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_4C75491B780B94AA_METHOD_1_749948B663FCCCEF_OFFSET))(this);
	}

	::System::Void Method_1_749948B663FCCCEF_1()
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_4C75491B780B94AA_METHOD_1_749948B663FCCCEF_1_OFFSET))(this);
	}

	::System::Void Method_1_749948B663FCCCEF_2()
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_4C75491B780B94AA_METHOD_1_749948B663FCCCEF_2_OFFSET))(this);
	}
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_4C75491B780B94AA_METHOD_1_B235E757922104A8_OFFSET))(this);
	}
