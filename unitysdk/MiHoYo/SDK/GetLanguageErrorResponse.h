...
#define MIHOYO_SDK_GETLANGUAGEERRORRESPONSE__CTOR_OFFSET UNITYSDK_OFFSET(0x15EE03F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int GetLanguageErrorResponse_TypeDefinitionIndex = 7067;
