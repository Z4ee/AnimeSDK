...
#define MIHOYO_SDK_GETLANGUAGEERRORRESPONSE__CTOR_OFFSET UNITYSDK_OFFSET(0x175264D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int GetLanguageErrorResponse_TypeDefinitionIndex = 7110;
