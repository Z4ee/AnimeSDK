...
#define MIHOYO_SDK_PSDELEGATE_GETUSERIDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x199AA560)
#define MIHOYO_SDK_PSDELEGATE_GETUSERIDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x199AA590)
#define MIHOYO_SDK_PSDELEGATE_GETUSERIDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x199AA2C0)
#define MIHOYO_SDK_PSDELEGATE_GETUSERIDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x199AA2B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_GetUserIdDelegate_TypeDefinitionIndex = 18598;
