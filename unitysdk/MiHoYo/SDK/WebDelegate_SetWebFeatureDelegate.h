...
#define MIHOYO_SDK_WEBDELEGATE_SETWEBFEATUREDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B7D8300)
#define MIHOYO_SDK_WEBDELEGATE_SETWEBFEATUREDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B7D8380)
#define MIHOYO_SDK_WEBDELEGATE_SETWEBFEATUREDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B7D82F0)
#define MIHOYO_SDK_WEBDELEGATE_SETWEBFEATUREDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7D8200)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetWebFeatureDelegate_TypeDefinitionIndex = 7810;
