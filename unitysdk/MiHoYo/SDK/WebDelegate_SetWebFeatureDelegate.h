...
#define MIHOYO_SDK_WEBDELEGATE_SETWEBFEATUREDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A18BBC0)
#define MIHOYO_SDK_WEBDELEGATE_SETWEBFEATUREDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A18BC40)
#define MIHOYO_SDK_WEBDELEGATE_SETWEBFEATUREDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A18B0C0)
#define MIHOYO_SDK_WEBDELEGATE_SETWEBFEATUREDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A18BBB0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetWebFeatureDelegate_TypeDefinitionIndex = 18722;
