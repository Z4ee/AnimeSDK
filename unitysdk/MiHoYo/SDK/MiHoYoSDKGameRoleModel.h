...
#define MIHOYO_SDK_MIHOYOSDKGAMEROLEMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xA19A7C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKGameRoleModel_TypeDefinitionIndex = 43758;
