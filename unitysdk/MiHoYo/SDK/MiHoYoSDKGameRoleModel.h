...
#define MIHOYO_SDK_MIHOYOSDKGAMEROLEMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC6C4C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKGameRoleModel_TypeDefinitionIndex = 36733;
