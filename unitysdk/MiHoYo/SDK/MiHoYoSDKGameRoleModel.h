...
#define MIHOYO_SDK_MIHOYOSDKGAMEROLEMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9E8260)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKGameRoleModel_TypeDefinitionIndex = 35169;
