...
#define MIHOYO_SDK_BILIBILIDELEGATE_LOGINCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19C946D0)
#define MIHOYO_SDK_BILIBILIDELEGATE_LOGINCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19C94750)
#define MIHOYO_SDK_BILIBILIDELEGATE_LOGINCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C94170)
#define MIHOYO_SDK_BILIBILIDELEGATE_LOGINCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19C94160)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int BiliBiliDelegate_LoginCallback_TypeDefinitionIndex = 18474;
