...
#define MIHOYO_SDK_STATICICON__DELAYEDACTION_D__19_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x15FFC070)
#define MIHOYO_SDK_STATICICON__DELAYEDACTION_D__19_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15FFC0E0)
#define MIHOYO_SDK_STATICICON__DELAYEDACTION_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15FFC140)
#define MIHOYO_SDK_STATICICON__DELAYEDACTION_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x15FFC0F0)
#define MIHOYO_SDK_STATICICON__DELAYEDACTION_D__19_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15FFC060)
#define MIHOYO_SDK_STATICICON__DELAYEDACTION_D__19__CTOR_OFFSET UNITYSDK_OFFSET(0x15FFBA80)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int StaticIcon__DelayedAction_d__19_TypeDefinitionIndex = 7010;
	...
	public:
		...
		::System::Action_1<::UnityEngine::EventSystems::PointerEventData*>* action; // 0x28
