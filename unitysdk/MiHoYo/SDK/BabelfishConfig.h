...
#define MIHOYO_SDK_BABELFISHCONFIG_GET_MAXBATCHSIZE_OFFSET UNITYSDK_OFFSET(0x16A84310)
#define MIHOYO_SDK_BABELFISHCONFIG_GET_MAXTOKENSPERITEM_OFFSET UNITYSDK_OFFSET(0x16A84330)
#define MIHOYO_SDK_BABELFISHCONFIG_GET_PROVIDER_OFFSET UNITYSDK_OFFSET(0x16A842D0)
#define MIHOYO_SDK_BABELFISHCONFIG_GET_SUPPORTEDLANGUAGES_OFFSET UNITYSDK_OFFSET(0x16A842F0)
#define MIHOYO_SDK_BABELFISHCONFIG_SET_MAXBATCHSIZE_OFFSET UNITYSDK_OFFSET(0x16A84320)
#define MIHOYO_SDK_BABELFISHCONFIG_SET_MAXTOKENSPERITEM_OFFSET UNITYSDK_OFFSET(0x16A84340)
#define MIHOYO_SDK_BABELFISHCONFIG_SET_PROVIDER_OFFSET UNITYSDK_OFFSET(0x16A842E0)
#define MIHOYO_SDK_BABELFISHCONFIG_SET_SUPPORTEDLANGUAGES_OFFSET UNITYSDK_OFFSET(0x16A84300)
#define MIHOYO_SDK_BABELFISHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16A83D80)
...
namespace MiHoYo::SDK
{
	...
	public:
		...
		::System::Int32 _MaxBatchSize_k__BackingField; // 0x20
		::System::Int32 _MaxTokensPerItem_k__BackingField; // 0x24
