...
#define MIHOYO_SDK_H5LOGGENERALREPORT___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC692B0)
#define MIHOYO_SDK_H5LOGGENERALREPORT___C__DISPLAYCLASS4_0__LOGREPORTASYNC_B__0_OFFSET UNITYSDK_OFFSET(0x1CC692C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int H5logGeneralReport___c__DisplayClass4_0_TypeDefinitionIndex = 36862;

	class H5logGeneralReport___c__DisplayClass4_0 : public ::System::Object
	{
	public:
		::MiHoYo::SDK::H5logGeneralReport* __4__this; // 0x10
