...
#define MIHOYO_SDK_NETUTIL___C__DISPLAYCLASS19_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19C7EFD0)
#define MIHOYO_SDK_NETUTIL___C__DISPLAYCLASS19_0__HTTPGETBINARY_B__0_OFFSET UNITYSDK_OFFSET(0x19C7EFE0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int NetUtil___c__DisplayClass19_0_TypeDefinitionIndex = 19060;
