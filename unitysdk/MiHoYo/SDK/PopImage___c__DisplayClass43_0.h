...
#define MIHOYO_SDK_POPIMAGE___C__DISPLAYCLASS43_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C90DE10)
#define MIHOYO_SDK_POPIMAGE___C__DISPLAYCLASS43_0__SHOW_B__0_OFFSET UNITYSDK_OFFSET(0x1C90DE20)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PopImage___c__DisplayClass43_0_TypeDefinitionIndex = 20368;
