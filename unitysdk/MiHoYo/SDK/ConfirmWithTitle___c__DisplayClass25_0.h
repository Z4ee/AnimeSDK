...
#define MIHOYO_SDK_CONFIRMWITHTITLE___C__DISPLAYCLASS25_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A169530)
#define MIHOYO_SDK_CONFIRMWITHTITLE___C__DISPLAYCLASS25_0__SHOW_B__0_OFFSET UNITYSDK_OFFSET(0x1A169540)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConfirmWithTitle___c__DisplayClass25_0_TypeDefinitionIndex = 18869;

	class ConfirmWithTitle___c__DisplayClass25_0 : public ::System::Object
	{
	public:
		::System::Action* cancelCallback; // 0x10
