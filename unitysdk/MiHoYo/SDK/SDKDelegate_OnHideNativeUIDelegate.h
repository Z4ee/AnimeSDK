...
#define MIHOYO_SDK_SDKDELEGATE_ONHIDENATIVEUIDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17120100)
#define MIHOYO_SDK_SDKDELEGATE_ONHIDENATIVEUIDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17120140)
#define MIHOYO_SDK_SDKDELEGATE_ONHIDENATIVEUIDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x171200F0)
#define MIHOYO_SDK_SDKDELEGATE_ONHIDENATIVEUIDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17120070)
