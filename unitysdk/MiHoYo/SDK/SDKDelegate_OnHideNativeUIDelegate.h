...
#define MIHOYO_SDK_SDKDELEGATE_ONHIDENATIVEUIDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BAC9590)
#define MIHOYO_SDK_SDKDELEGATE_ONHIDENATIVEUIDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BAC95D0)
#define MIHOYO_SDK_SDKDELEGATE_ONHIDENATIVEUIDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BAC9580)
#define MIHOYO_SDK_SDKDELEGATE_ONHIDENATIVEUIDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAC9500)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_OnHideNativeUIDelegate_TypeDefinitionIndex = 7761;
