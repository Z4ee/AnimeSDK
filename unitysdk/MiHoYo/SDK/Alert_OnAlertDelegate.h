...
#define MIHOYO_SDK_ALERT_ONALERTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BC6B470)
#define MIHOYO_SDK_ALERT_ONALERTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BC6B4E0)
#define MIHOYO_SDK_ALERT_ONALERTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BC6B180)
#define MIHOYO_SDK_ALERT_ONALERTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC6B160)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int Alert_OnAlertDelegate_TypeDefinitionIndex = 20003;
