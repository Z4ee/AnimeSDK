...
#define MIHOYO_SDK_ALERT_ONALERTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x173D7F70)
#define MIHOYO_SDK_ALERT_ONALERTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x173D7FE0)
#define MIHOYO_SDK_ALERT_ONALERTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x173D78F0)
#define MIHOYO_SDK_ALERT_ONALERTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x173D7F50)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int Alert_OnAlertDelegate_TypeDefinitionIndex = 7278;
