...
#define MIHOYO_SDK_MIHOYOSDKCONFIGURLMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x85095A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKConfigUrlModel_TypeDefinitionIndex = 37116;
