...
#define MIHOYO_SDK_MIHOYOSDKCONFIGURLMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x8D3D790)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKConfigUrlModel_TypeDefinitionIndex = 42961;
