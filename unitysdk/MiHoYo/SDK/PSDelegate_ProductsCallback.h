...
#define MIHOYO_SDK_PSDELEGATE_PRODUCTSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15F9A240)
#define MIHOYO_SDK_PSDELEGATE_PRODUCTSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15F9A2A0)
#define MIHOYO_SDK_PSDELEGATE_PRODUCTSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x15F99EF0)
#define MIHOYO_SDK_PSDELEGATE_PRODUCTSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x15F99ED0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_ProductsCallback_TypeDefinitionIndex = 6737;
