...
#define MIHOYO_SDK_WEBDELEGATE_SETGAMEVOLUMEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15C268B0)
#define MIHOYO_SDK_WEBDELEGATE_SETGAMEVOLUMEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15C26940)
#define MIHOYO_SDK_WEBDELEGATE_SETGAMEVOLUMEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15C26890)
#define MIHOYO_SDK_WEBDELEGATE_SETGAMEVOLUMEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15C26820)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetGameVolumeDelegate_TypeDefinitionIndex = 7804;
