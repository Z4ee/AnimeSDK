...
#define MIHOYO_SDK_PSDELEGATE_GAMEINTENTDESTORYDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x175FA050)
#define MIHOYO_SDK_PSDELEGATE_GAMEINTENTDESTORYDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x175FA080)
#define MIHOYO_SDK_PSDELEGATE_GAMEINTENTDESTORYDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x175D8F70)
#define MIHOYO_SDK_PSDELEGATE_GAMEINTENTDESTORYDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x175FA030)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_GameIntentDestoryDelegate_TypeDefinitionIndex = 6806;
