...
#define MIHOYO_SDK_CONSOLEDELEGATE_IMEDIALOGCLOSECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AA45010)
#define MIHOYO_SDK_CONSOLEDELEGATE_IMEDIALOGCLOSECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AA45040)
#define MIHOYO_SDK_CONSOLEDELEGATE_IMEDIALOGCLOSECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AA45000)
#define MIHOYO_SDK_CONSOLEDELEGATE_IMEDIALOGCLOSECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA44F90)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_ImeDialogCloseCallback_TypeDefinitionIndex = 7607;
