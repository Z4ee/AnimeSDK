...
#define MIHOYO_SDK_THREADDISPATCHER_MAINTHREADDISPATCHER_DISPATCHTOMAINTHREAD_OFFSET UNITYSDK_OFFSET(0x1BAD83F0)
#define MIHOYO_SDK_THREADDISPATCHER_MAINTHREADDISPATCHER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1BAD8820)
#define MIHOYO_SDK_THREADDISPATCHER_MAINTHREADDISPATCHER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1BAD8600)
#define MIHOYO_SDK_THREADDISPATCHER_MAINTHREADDISPATCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAD85A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ThreadDispatcher_MainThreadDispatcher_TypeDefinitionIndex = 7988;
