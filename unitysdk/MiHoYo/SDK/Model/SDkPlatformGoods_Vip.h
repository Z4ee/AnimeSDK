...
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIP_GET_VALID_UNTIL_OFFSET UNITYSDK_OFFSET(0x12A11680)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIP_SET_VALID_UNTIL_OFFSET UNITYSDK_OFFSET(0x12A11690)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIP_TOSTRING_OFFSET UNITYSDK_OFFSET(0x12A116A0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIP__CTOR_OFFSET UNITYSDK_OFFSET(0x12A11710)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIP___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x12A11720)

namespace MiHoYo::SDK::Model
{
	inline static constexpr unsigned int SDkPlatformGoods_Vip_TypeDefinitionIndex = 79200;
