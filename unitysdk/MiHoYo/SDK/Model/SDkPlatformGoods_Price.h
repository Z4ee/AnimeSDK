...
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_GET_AMOUNT_DECIMAL_OFFSET UNITYSDK_OFFSET(0x122CF680)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_GET_AMOUNT_DISPLAY_OFFSET UNITYSDK_OFFSET(0x122CF6A0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_GET_AMOUNT_OFFSET UNITYSDK_OFFSET(0x122CF660)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_GET_CURRENCY_OFFSET UNITYSDK_OFFSET(0x122CF6C0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_GET_CURRENCY_SYMBOL_OFFSET UNITYSDK_OFFSET(0x122CF6E0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_GET_ORIGINAL_AMOUNT_DISPLAY_OFFSET UNITYSDK_OFFSET(0x122CF720)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_GET_TIER_OFFSET UNITYSDK_OFFSET(0x122CF700)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_SET_AMOUNT_DECIMAL_OFFSET UNITYSDK_OFFSET(0x122CF690)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_SET_AMOUNT_DISPLAY_OFFSET UNITYSDK_OFFSET(0x122CF6B0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_SET_AMOUNT_OFFSET UNITYSDK_OFFSET(0x122CF670)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_SET_CURRENCY_OFFSET UNITYSDK_OFFSET(0x122CF6D0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_SET_CURRENCY_SYMBOL_OFFSET UNITYSDK_OFFSET(0x122CF6F0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_SET_ORIGINAL_AMOUNT_DISPLAY_OFFSET UNITYSDK_OFFSET(0x122CF730)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_SET_TIER_OFFSET UNITYSDK_OFFSET(0x122CF710)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x122CF740)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE__CTOR_OFFSET UNITYSDK_OFFSET(0x122CFBE0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x122CFBF0)

namespace MiHoYo::SDK::Model
{
	inline static constexpr unsigned int SDkPlatformGoods_Price_TypeDefinitionIndex = 49487;
