...
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_GET_AMOUNT_DECIMAL_OFFSET UNITYSDK_OFFSET(0x14DF9080)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_GET_AMOUNT_DISPLAY_OFFSET UNITYSDK_OFFSET(0x14DF90A0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_GET_AMOUNT_OFFSET UNITYSDK_OFFSET(0x14DF9060)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_GET_CURRENCY_OFFSET UNITYSDK_OFFSET(0x14DF90C0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_GET_CURRENCY_SYMBOL_OFFSET UNITYSDK_OFFSET(0x14DF90E0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_GET_ORIGINAL_AMOUNT_DISPLAY_OFFSET UNITYSDK_OFFSET(0x14DF9120)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_GET_TIER_OFFSET UNITYSDK_OFFSET(0x14DF9100)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_SET_AMOUNT_DECIMAL_OFFSET UNITYSDK_OFFSET(0x14DF9090)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_SET_AMOUNT_DISPLAY_OFFSET UNITYSDK_OFFSET(0x14DF90B0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_SET_AMOUNT_OFFSET UNITYSDK_OFFSET(0x14DF9070)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_SET_CURRENCY_OFFSET UNITYSDK_OFFSET(0x14DF90D0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_SET_CURRENCY_SYMBOL_OFFSET UNITYSDK_OFFSET(0x14DF90F0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_SET_ORIGINAL_AMOUNT_DISPLAY_OFFSET UNITYSDK_OFFSET(0x14DF9130)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_SET_TIER_OFFSET UNITYSDK_OFFSET(0x14DF9110)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x14DF9140)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE__CTOR_OFFSET UNITYSDK_OFFSET(0x14DF95E0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_PRICE___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x14DF95F0)

namespace MiHoYo::SDK::Model
{
	inline static constexpr unsigned int SDkPlatformGoods_Price_TypeDefinitionIndex = 65161;
