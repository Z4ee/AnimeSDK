...
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIRTUALCURRENCY_GET_BONUS_ONCE_ELIGIBLE_OFFSET UNITYSDK_OFFSET(0x122CFC70)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIRTUALCURRENCY_GET_COUNT_BONUS_OFFSET UNITYSDK_OFFSET(0x122CFC50)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIRTUALCURRENCY_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x122CFC30)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIRTUALCURRENCY_SET_BONUS_ONCE_ELIGIBLE_OFFSET UNITYSDK_OFFSET(0x122CFC80)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIRTUALCURRENCY_SET_COUNT_BONUS_OFFSET UNITYSDK_OFFSET(0x122CFC60)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIRTUALCURRENCY_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x122CFC40)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIRTUALCURRENCY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x122CFC90)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIRTUALCURRENCY__CTOR_OFFSET UNITYSDK_OFFSET(0x122CFD90)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIRTUALCURRENCY___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x122CFDA0)

namespace MiHoYo::SDK::Model
{
	inline static constexpr unsigned int SDkPlatformGoods_VirtualCurrency_TypeDefinitionIndex = 49483;
