...
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x11441350)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_GET_CYCLE_COUNT_OFFSET UNITYSDK_OFFSET(0x114413D0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_GET_PURCHASED_COUNT_OFFSET UNITYSDK_OFFSET(0x114413B0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_GET_RESET_MODE_OFFSET UNITYSDK_OFFSET(0x11441390)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_GET_RESET_UNTIL_OFFSET UNITYSDK_OFFSET(0x11441370)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x11441360)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_SET_CYCLE_COUNT_OFFSET UNITYSDK_OFFSET(0x114413E0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_SET_PURCHASED_COUNT_OFFSET UNITYSDK_OFFSET(0x114413C0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_SET_RESET_MODE_OFFSET UNITYSDK_OFFSET(0x114413A0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_SET_RESET_UNTIL_OFFSET UNITYSDK_OFFSET(0x11441380)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x114413F0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x114417E0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x114417F0)

namespace MiHoYo::SDK::Model
{
	inline static constexpr unsigned int SDkPlatformGoods_Consumable_TypeDefinitionIndex = 79203;
