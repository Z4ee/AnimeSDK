...
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CREATEFROMJSON_OFFSET UNITYSDK_OFFSET(0xFE88310)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_BP_OFFSET UNITYSDK_OFFSET(0xFE87EA0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_BUYTIMES_OFFSET UNITYSDK_OFFSET(0xFE88210)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_CONSUMABLE_OFFSET UNITYSDK_OFFSET(0xFE87EE0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_FIRSTPRESENTITEMID_OFFSET UNITYSDK_OFFSET(0xFE88090)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_FIRSTPRESENTITEMNUM_OFFSET UNITYSDK_OFFSET(0xFE880A0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_GOODS_DESC_OFFSET UNITYSDK_OFFSET(0xFE87D60)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_GOODS_ID_OFFSET UNITYSDK_OFFSET(0xFE87D20)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_GOODS_NAME_OFFSET UNITYSDK_OFFSET(0xFE87D80)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_GOODS_TYPE_OFFSET UNITYSDK_OFFSET(0xFE87D40)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_ISFIRSTCHARGE_OFFSET UNITYSDK_OFFSET(0xFE880F0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0xFE87F20)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_ITEMNUM_OFFSET UNITYSDK_OFFSET(0xFE87F30)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_ITEM_ID_OFFSET UNITYSDK_OFFSET(0xFE87E40)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_LAUNCH_END_TIME_OFFSET UNITYSDK_OFFSET(0xFE87DC0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_LAUNCH_START_TIME_OFFSET UNITYSDK_OFFSET(0xFE87DA0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_LEVEL_MIN_OFFSET UNITYSDK_OFFSET(0xFE87E60)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_MAXBUYTIMES_OFFSET UNITYSDK_OFFSET(0xFE881C0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_NEXTREFRESHTIME_OFFSET UNITYSDK_OFFSET(0xFE882B0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_OFFICIALGOODSID_OFFSET UNITYSDK_OFFSET(0xFE88150)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_OFFICIAL_GOODS_ID_OFFSET UNITYSDK_OFFSET(0xFE87D00)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_PRESENTITEMID_OFFSET UNITYSDK_OFFSET(0xFE88020)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_PRESENTITEMNUM_OFFSET UNITYSDK_OFFSET(0xFE88030)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_PRICE_OFFSET UNITYSDK_OFFSET(0xFE87F00)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_PURCHASE_ELIGIBLE_OFFSET UNITYSDK_OFFSET(0xFE87DE0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_PURCHASE_INELIGIBLE_CODE_OFFSET UNITYSDK_OFFSET(0xFE87E00)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_PURCHASE_INELIGIBLE_REASON_OFFSET UNITYSDK_OFFSET(0xFE87E20)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_REFRESHTYPE_OFFSET UNITYSDK_OFFSET(0xFE88260)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_THIRDPARTYPRODUCTID_OFFSET UNITYSDK_OFFSET(0xFE881B0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_VIP_OFFSET UNITYSDK_OFFSET(0xFE87EC0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_VIRTUAL_CURRENCY_OFFSET UNITYSDK_OFFSET(0xFE87E80)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_BP_OFFSET UNITYSDK_OFFSET(0xFE87EB0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_CONSUMABLE_OFFSET UNITYSDK_OFFSET(0xFE87EF0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_GOODS_DESC_OFFSET UNITYSDK_OFFSET(0xFE87D70)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_GOODS_ID_OFFSET UNITYSDK_OFFSET(0xFE87D30)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_GOODS_NAME_OFFSET UNITYSDK_OFFSET(0xFE87D90)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_GOODS_TYPE_OFFSET UNITYSDK_OFFSET(0xFE87D50)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_ITEM_ID_OFFSET UNITYSDK_OFFSET(0xFE87E50)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_LAUNCH_END_TIME_OFFSET UNITYSDK_OFFSET(0xFE87DD0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_LAUNCH_START_TIME_OFFSET UNITYSDK_OFFSET(0xFE87DB0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_LEVEL_MIN_OFFSET UNITYSDK_OFFSET(0xFE87E70)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_OFFICIAL_GOODS_ID_OFFSET UNITYSDK_OFFSET(0xFE87D10)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_PRICE_OFFSET UNITYSDK_OFFSET(0xFE87F10)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_PURCHASE_ELIGIBLE_OFFSET UNITYSDK_OFFSET(0xFE87DF0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_PURCHASE_INELIGIBLE_CODE_OFFSET UNITYSDK_OFFSET(0xFE87E10)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_PURCHASE_INELIGIBLE_REASON_OFFSET UNITYSDK_OFFSET(0xFE87E30)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_VIP_OFFSET UNITYSDK_OFFSET(0xFE87ED0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_VIRTUAL_CURRENCY_OFFSET UNITYSDK_OFFSET(0xFE87E90)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_TOSTRING_OFFSET UNITYSDK_OFFSET(0xFE88490)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS__CTOR_OFFSET UNITYSDK_OFFSET(0xFE892B0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0xFE892C0)

namespace MiHoYo::SDK::Model
{
	inline static constexpr unsigned int SDkPlatformGoods_TypeDefinitionIndex = 49482;
