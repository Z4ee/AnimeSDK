...
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CREATEFROMJSON_OFFSET UNITYSDK_OFFSET(0x12B85C40)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_BP_OFFSET UNITYSDK_OFFSET(0x12B857D0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_BUYTIMES_OFFSET UNITYSDK_OFFSET(0x12B85B40)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_CONSUMABLE_OFFSET UNITYSDK_OFFSET(0x12B85810)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_FIRSTPRESENTITEMID_OFFSET UNITYSDK_OFFSET(0x12B859C0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_FIRSTPRESENTITEMNUM_OFFSET UNITYSDK_OFFSET(0x12B859D0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_GOODS_DESC_OFFSET UNITYSDK_OFFSET(0x12B85690)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_GOODS_ID_OFFSET UNITYSDK_OFFSET(0x12B85650)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_GOODS_NAME_OFFSET UNITYSDK_OFFSET(0x12B856B0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_GOODS_TYPE_OFFSET UNITYSDK_OFFSET(0x12B85670)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_ISFIRSTCHARGE_OFFSET UNITYSDK_OFFSET(0x12B85A20)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0x12B85850)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_ITEMNUM_OFFSET UNITYSDK_OFFSET(0x12B85860)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_ITEM_ID_OFFSET UNITYSDK_OFFSET(0x12B85770)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_LAUNCH_END_TIME_OFFSET UNITYSDK_OFFSET(0x12B856F0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_LAUNCH_START_TIME_OFFSET UNITYSDK_OFFSET(0x12B856D0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_LEVEL_MIN_OFFSET UNITYSDK_OFFSET(0x12B85790)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_MAXBUYTIMES_OFFSET UNITYSDK_OFFSET(0x12B85AF0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_NEXTREFRESHTIME_OFFSET UNITYSDK_OFFSET(0x12B85BE0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_OFFICIALGOODSID_OFFSET UNITYSDK_OFFSET(0x12B85A80)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_OFFICIAL_GOODS_ID_OFFSET UNITYSDK_OFFSET(0x12B85630)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_PRESENTITEMID_OFFSET UNITYSDK_OFFSET(0x12B85950)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_PRESENTITEMNUM_OFFSET UNITYSDK_OFFSET(0x12B85960)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_PRICE_OFFSET UNITYSDK_OFFSET(0x12B85830)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_PURCHASE_ELIGIBLE_OFFSET UNITYSDK_OFFSET(0x12B85710)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_PURCHASE_INELIGIBLE_CODE_OFFSET UNITYSDK_OFFSET(0x12B85730)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_PURCHASE_INELIGIBLE_REASON_OFFSET UNITYSDK_OFFSET(0x12B85750)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_REFRESHTYPE_OFFSET UNITYSDK_OFFSET(0x12B85B90)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_THIRDPARTYPRODUCTID_OFFSET UNITYSDK_OFFSET(0x12B85AE0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_VIP_OFFSET UNITYSDK_OFFSET(0x12B857F0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_VIRTUAL_CURRENCY_OFFSET UNITYSDK_OFFSET(0x12B857B0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_BP_OFFSET UNITYSDK_OFFSET(0x12B857E0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_CONSUMABLE_OFFSET UNITYSDK_OFFSET(0x12B85820)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_GOODS_DESC_OFFSET UNITYSDK_OFFSET(0x12B856A0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_GOODS_ID_OFFSET UNITYSDK_OFFSET(0x12B85660)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_GOODS_NAME_OFFSET UNITYSDK_OFFSET(0x12B856C0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_GOODS_TYPE_OFFSET UNITYSDK_OFFSET(0x12B85680)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_ITEM_ID_OFFSET UNITYSDK_OFFSET(0x12B85780)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_LAUNCH_END_TIME_OFFSET UNITYSDK_OFFSET(0x12B85700)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_LAUNCH_START_TIME_OFFSET UNITYSDK_OFFSET(0x12B856E0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_LEVEL_MIN_OFFSET UNITYSDK_OFFSET(0x12B857A0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_OFFICIAL_GOODS_ID_OFFSET UNITYSDK_OFFSET(0x12B85640)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_PRICE_OFFSET UNITYSDK_OFFSET(0x12B85840)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_PURCHASE_ELIGIBLE_OFFSET UNITYSDK_OFFSET(0x12B85720)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_PURCHASE_INELIGIBLE_CODE_OFFSET UNITYSDK_OFFSET(0x12B85740)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_PURCHASE_INELIGIBLE_REASON_OFFSET UNITYSDK_OFFSET(0x12B85760)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_VIP_OFFSET UNITYSDK_OFFSET(0x12B85800)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_VIRTUAL_CURRENCY_OFFSET UNITYSDK_OFFSET(0x12B857C0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x12B85DC0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS__CTOR_OFFSET UNITYSDK_OFFSET(0x12B86BE0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x12B86BF0)

namespace MiHoYo::SDK::Model
{
	inline static constexpr unsigned int SDkPlatformGoods_TypeDefinitionIndex = 65157;
