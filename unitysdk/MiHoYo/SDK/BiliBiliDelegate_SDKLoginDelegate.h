...
#define MIHOYO_SDK_BILIBILIDELEGATE_SDKLOGINDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BF5E400)
#define MIHOYO_SDK_BILIBILIDELEGATE_SDKLOGINDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BF5E430)
#define MIHOYO_SDK_BILIBILIDELEGATE_SDKLOGINDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BF5DEC0)
#define MIHOYO_SDK_BILIBILIDELEGATE_SDKLOGINDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF5DEA0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int BiliBiliDelegate_SDKLoginDelegate_TypeDefinitionIndex = 19362;
