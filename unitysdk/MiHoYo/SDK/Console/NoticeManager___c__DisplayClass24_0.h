...
#define MIHOYO_SDK_CONSOLE_NOTICEMANAGER___C__DISPLAYCLASS24_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7AB110)
#define MIHOYO_SDK_CONSOLE_NOTICEMANAGER___C__DISPLAYCLASS24_0__REQUESTCROSSLOGIN_B__0_OFFSET UNITYSDK_OFFSET(0x1B7AB320)
#define MIHOYO_SDK_CONSOLE_NOTICEMANAGER___C__DISPLAYCLASS24_0__REQUESTCROSSLOGIN_B__1_OFFSET UNITYSDK_OFFSET(0x1B7AB3D0)
#define MIHOYO_SDK_CONSOLE_NOTICEMANAGER___C__DISPLAYCLASS24_0__REQUESTCROSSLOGIN_B__2_OFFSET UNITYSDK_OFFSET(0x1B7AB3B0)

namespace MiHoYo::SDK::Console
{
	inline static constexpr unsigned int NoticeManager___c__DisplayClass24_0_TypeDefinitionIndex = 8922;
