...
#define MIHOYO_SDK_CONSOLE_CONSOLEUSERAGREEMENTDIALOG__CHECKSCROLLBARVISIBILITY_D__34_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19C69AA0)
#define MIHOYO_SDK_CONSOLE_CONSOLEUSERAGREEMENTDIALOG__CHECKSCROLLBARVISIBILITY_D__34_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19C69F30)
#define MIHOYO_SDK_CONSOLE_CONSOLEUSERAGREEMENTDIALOG__CHECKSCROLLBARVISIBILITY_D__34_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19C69F90)
#define MIHOYO_SDK_CONSOLE_CONSOLEUSERAGREEMENTDIALOG__CHECKSCROLLBARVISIBILITY_D__34_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19C69F40)
#define MIHOYO_SDK_CONSOLE_CONSOLEUSERAGREEMENTDIALOG__CHECKSCROLLBARVISIBILITY_D__34_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19C69A90)
#define MIHOYO_SDK_CONSOLE_CONSOLEUSERAGREEMENTDIALOG__CHECKSCROLLBARVISIBILITY_D__34__CTOR_OFFSET UNITYSDK_OFFSET(0x19C69A80)

namespace MiHoYo::SDK::Console
{
	inline static constexpr unsigned int ConsoleUserAgreementDialog__CheckScrollBarVisibility_d__34_TypeDefinitionIndex = 19596;
