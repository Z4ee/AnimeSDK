...
#define MIHOYO_SDK_CONSOLE_CONSOLEACCOUNTINFODIALOG___C__DISPLAYCLASS27_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15E30C70)
#define MIHOYO_SDK_CONSOLE_CONSOLEACCOUNTINFODIALOG___C__DISPLAYCLASS27_0__SHOW_B__0_OFFSET UNITYSDK_OFFSET(0x15E32DC0)
#define MIHOYO_SDK_CONSOLE_CONSOLEACCOUNTINFODIALOG___C__DISPLAYCLASS27_0__SHOW_B__1_OFFSET UNITYSDK_OFFSET(0x15E32F30)
#define MIHOYO_SDK_CONSOLE_CONSOLEACCOUNTINFODIALOG___C__DISPLAYCLASS27_0__SHOW_B__2_OFFSET UNITYSDK_OFFSET(0x15E32F80)

namespace MiHoYo::SDK::Console
{
	inline static constexpr unsigned int ConsoleAccountInfoDialog___c__DisplayClass27_0_TypeDefinitionIndex = 7615;
	...
	public:
		...
		::System::Collections::Generic::List_1<::MiHoYo::SDK::Console::UserGameServerInfo*>* userGameInfoList; // 0x28
