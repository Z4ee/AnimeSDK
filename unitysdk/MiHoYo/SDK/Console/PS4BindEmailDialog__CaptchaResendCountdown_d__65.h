...
#define MIHOYO_SDK_CONSOLE_PS4BINDEMAILDIALOG__CAPTCHARESENDCOUNTDOWN_D__65_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A176CA0)
#define MIHOYO_SDK_CONSOLE_PS4BINDEMAILDIALOG__CAPTCHARESENDCOUNTDOWN_D__65_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A176DC0)
#define MIHOYO_SDK_CONSOLE_PS4BINDEMAILDIALOG__CAPTCHARESENDCOUNTDOWN_D__65_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A176E20)
#define MIHOYO_SDK_CONSOLE_PS4BINDEMAILDIALOG__CAPTCHARESENDCOUNTDOWN_D__65_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A176DD0)
#define MIHOYO_SDK_CONSOLE_PS4BINDEMAILDIALOG__CAPTCHARESENDCOUNTDOWN_D__65_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A176C90)
#define MIHOYO_SDK_CONSOLE_PS4BINDEMAILDIALOG__CAPTCHARESENDCOUNTDOWN_D__65__CTOR_OFFSET UNITYSDK_OFFSET(0x1A176350)

namespace MiHoYo::SDK::Console
{
	inline static constexpr unsigned int PS4BindEmailDialog__CaptchaResendCountdown_d__65_TypeDefinitionIndex = 19603;
