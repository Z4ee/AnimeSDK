...
#define MIHOYO_SDK_CONSOLE_PS4BINDEMAILDIALOG__CAPTCHARESENDCOUNTDOWN_D__65_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x17476BE0)
#define MIHOYO_SDK_CONSOLE_PS4BINDEMAILDIALOG__CAPTCHARESENDCOUNTDOWN_D__65_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x17476CE0)
#define MIHOYO_SDK_CONSOLE_PS4BINDEMAILDIALOG__CAPTCHARESENDCOUNTDOWN_D__65_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x17476D40)
#define MIHOYO_SDK_CONSOLE_PS4BINDEMAILDIALOG__CAPTCHARESENDCOUNTDOWN_D__65_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x17476CF0)
#define MIHOYO_SDK_CONSOLE_PS4BINDEMAILDIALOG__CAPTCHARESENDCOUNTDOWN_D__65_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17476BD0)
#define MIHOYO_SDK_CONSOLE_PS4BINDEMAILDIALOG__CAPTCHARESENDCOUNTDOWN_D__65__CTOR_OFFSET UNITYSDK_OFFSET(0x17476410)

namespace MiHoYo::SDK::Console
{
	inline static constexpr unsigned int PS4BindEmailDialog__CaptchaResendCountdown_d__65_TypeDefinitionIndex = 7776;
