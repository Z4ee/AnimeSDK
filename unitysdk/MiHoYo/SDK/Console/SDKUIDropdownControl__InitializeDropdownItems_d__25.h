...
#define MIHOYO_SDK_CONSOLE_SDKUIDROPDOWNCONTROL__INITIALIZEDROPDOWNITEMS_D__25_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x174F8EC0)
#define MIHOYO_SDK_CONSOLE_SDKUIDROPDOWNCONTROL__INITIALIZEDROPDOWNITEMS_D__25_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x174F9130)
#define MIHOYO_SDK_CONSOLE_SDKUIDROPDOWNCONTROL__INITIALIZEDROPDOWNITEMS_D__25_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x174F9190)
#define MIHOYO_SDK_CONSOLE_SDKUIDROPDOWNCONTROL__INITIALIZEDROPDOWNITEMS_D__25_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x174F9140)
#define MIHOYO_SDK_CONSOLE_SDKUIDROPDOWNCONTROL__INITIALIZEDROPDOWNITEMS_D__25_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x174F8EB0)
#define MIHOYO_SDK_CONSOLE_SDKUIDROPDOWNCONTROL__INITIALIZEDROPDOWNITEMS_D__25__CTOR_OFFSET UNITYSDK_OFFSET(0x174F8BE0)

namespace MiHoYo::SDK::Console
{
	inline static constexpr unsigned int SDKUIDropdownControl__InitializeDropdownItems_d__25_TypeDefinitionIndex = 7713;
