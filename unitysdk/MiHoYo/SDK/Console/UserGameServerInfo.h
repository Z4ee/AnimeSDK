...
#define MIHOYO_SDK_CONSOLE_USERGAMESERVERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9CBD40)

namespace MiHoYo::SDK::Console
{
	inline static constexpr unsigned int UserGameServerInfo_TypeDefinitionIndex = 20742;
