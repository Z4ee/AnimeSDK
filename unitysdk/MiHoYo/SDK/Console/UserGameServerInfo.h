...
#define MIHOYO_SDK_CONSOLE_USERGAMESERVERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA42CD0)

namespace MiHoYo::SDK::Console
{
	inline static constexpr unsigned int UserGameServerInfo_TypeDefinitionIndex = 8669;
