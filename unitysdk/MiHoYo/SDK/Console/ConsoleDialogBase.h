...
#define MIHOYO_SDK_CONSOLE_CONSOLEDIALOGBASE_ADJUSTBUTTONSIZEONXCLOUD_OFFSET UNITYSDK_OFFSET(0x17433990)
#define MIHOYO_SDK_CONSOLE_CONSOLEDIALOGBASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1742A9D0)
#define MIHOYO_SDK_CONSOLE_CONSOLEDIALOGBASE_CANCELBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x17433C80)
#define MIHOYO_SDK_CONSOLE_CONSOLEDIALOGBASE_CONFIRMBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x17433D50)
#define MIHOYO_SDK_CONSOLE_CONSOLEDIALOGBASE_GET_CANCELBUTTONTEXT_OFFSET UNITYSDK_OFFSET(0x174337B0)
#define MIHOYO_SDK_CONSOLE_CONSOLEDIALOGBASE_GET_CONFIRMBUTTONTEXT_OFFSET UNITYSDK_OFFSET(0x174336D0)
#define MIHOYO_SDK_CONSOLE_CONSOLEDIALOGBASE_HIGHLIGHTEDCHANGED_OFFSET UNITYSDK_OFFSET(0x17433E20)
#define MIHOYO_SDK_CONSOLE_CONSOLEDIALOGBASE_ISFOCUS_OFFSET UNITYSDK_OFFSET(0x17433E40)
#define MIHOYO_SDK_CONSOLE_CONSOLEDIALOGBASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1742B570)
#define MIHOYO_SDK_CONSOLE_CONSOLEDIALOGBASE_REVERTPS4BUTTONIMAGES_OFFSET UNITYSDK_OFFSET(0x17433890)
#define MIHOYO_SDK_CONSOLE_CONSOLEDIALOGBASE_SETHIGHLIGHTEDOBJECT_OFFSET UNITYSDK_OFFSET(0x17426DE0)
#define MIHOYO_SDK_CONSOLE_CONSOLEDIALOGBASE_SET_CANCELBUTTONTEXT_OFFSET UNITYSDK_OFFSET(0x1742AF90)
#define MIHOYO_SDK_CONSOLE_CONSOLEDIALOGBASE_SET_CONFIRMBUTTONTEXT_OFFSET UNITYSDK_OFFSET(0x1742AEB0)
#define MIHOYO_SDK_CONSOLE_CONSOLEDIALOGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1742DCB0)

namespace MiHoYo::SDK::Console
{
	inline static constexpr unsigned int ConsoleDialogBase_TypeDefinitionIndex = 7761;
