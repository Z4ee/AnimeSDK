...
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEVERIFICATIONDIALOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B5B53D0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEVERIFICATIONDIALOG_GET_INTERACTABLE_OFFSET UNITYSDK_OFFSET(0x1B5B53B0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEVERIFICATIONDIALOG_GET_ONCLOSED_OFFSET UNITYSDK_OFFSET(0x1B5B5390)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEVERIFICATIONDIALOG_GET_ONNEXTBUTTONPRESSED_OFFSET UNITYSDK_OFFSET(0x1B5B5370)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEVERIFICATIONDIALOG_HIDEDIALOG_OFFSET UNITYSDK_OFFSET(0x1B5B7BB0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEVERIFICATIONDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x1B5B7CE0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEVERIFICATIONDIALOG_MONTHSINYEARARRAY_OFFSET UNITYSDK_OFFSET(0x1B5B6C30)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEVERIFICATIONDIALOG_NEXTBUTTONPRESSED_OFFSET UNITYSDK_OFFSET(0x1B5B7B40)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEVERIFICATIONDIALOG_ONCLOSEDPRESSED_OFFSET UNITYSDK_OFFSET(0x1B5B7EA0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEVERIFICATIONDIALOG_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B5B6DF0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEVERIFICATIONDIALOG_ONMONTHDROPDOWNVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1B5B6E40)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEVERIFICATIONDIALOG_ONSETHIGHLIGHTEDOBJECT_OFFSET UNITYSDK_OFFSET(0x1B5B7780)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEVERIFICATIONDIALOG_ONYEARDROPDOWNVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1B5B7610)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEVERIFICATIONDIALOG_SETDROPDOWNYEAR_OFFSET UNITYSDK_OFFSET(0x1B5B6FB0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEVERIFICATIONDIALOG_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x1B5B7FC0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEVERIFICATIONDIALOG_SET_INTERACTABLE_OFFSET UNITYSDK_OFFSET(0x1B5B53C0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEVERIFICATIONDIALOG_SET_ONCLOSED_OFFSET UNITYSDK_OFFSET(0x1B5B53A0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEVERIFICATIONDIALOG_SET_ONNEXTBUTTONPRESSED_OFFSET UNITYSDK_OFFSET(0x1B5B5380)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEVERIFICATIONDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x1B5B7D70)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEVERIFICATIONDIALOG_UPDATENAVIGATION_OFFSET UNITYSDK_OFFSET(0x1B5B6CE0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEVERIFICATIONDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5B8030)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEVERIFICATIONDIALOG__ONCLOSEDPRESSED_G__ONCLOSEPRESSEDROUTINE_45_0_OFFSET UNITYSDK_OFFSET(0x1B5B7F70)

namespace MiHoYo::SDK::Console::UI::OS
{
	inline static constexpr unsigned int ConsoleAgeGateVerificationDialog_TypeDefinitionIndex = 20792;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Console::UI::OS::ConsoleAgeGateVerificationDialog**)Il2CppClass::FromTypeDefinitionIndex(ConsoleAgeGateVerificationDialog_TypeDefinitionIndex)->GetStaticField(0xA130);
		}
