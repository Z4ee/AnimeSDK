...
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTSENTDIALOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x175043C0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTSENTDIALOG_CLOSEPRESSED_OFFSET UNITYSDK_OFFSET(0x17505FE0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTSENTDIALOG_COUNTDOWNCOROUTINE_OFFSET UNITYSDK_OFFSET(0x17505E90)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTSENTDIALOG_GET_COOLDOWNTIME_OFFSET UNITYSDK_OFFSET(0x17504380)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTSENTDIALOG_GET_INTERACTABLE_OFFSET UNITYSDK_OFFSET(0x175043A0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTSENTDIALOG_GET_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x17504360)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTSENTDIALOG_GET_ONRESENDEMAIL_OFFSET UNITYSDK_OFFSET(0x17504340)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTSENTDIALOG_HIDEDIALOG_OFFSET UNITYSDK_OFFSET(0x17505C80)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTSENTDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x17505D90)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTSENTDIALOG_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17505220)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTSENTDIALOG_RESENDEMAILPRESSED_OFFSET UNITYSDK_OFFSET(0x175051F0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTSENTDIALOG_SETDATETIMEZONETEXT_OFFSET UNITYSDK_OFFSET(0x17505300)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTSENTDIALOG_SETEMAIL_OFFSET UNITYSDK_OFFSET(0x175053A0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTSENTDIALOG_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x17506090)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTSENTDIALOG_SETMULTILANGUAGETEXT_OFFSET UNITYSDK_OFFSET(0x175053E0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTSENTDIALOG_SET_COOLDOWNTIME_OFFSET UNITYSDK_OFFSET(0x17504390)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTSENTDIALOG_SET_INTERACTABLE_OFFSET UNITYSDK_OFFSET(0x175043B0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTSENTDIALOG_SET_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x17504370)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTSENTDIALOG_SET_ONRESENDEMAIL_OFFSET UNITYSDK_OFFSET(0x17504350)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTSENTDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x17505EE0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTSENTDIALOG_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x17505E20)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTSENTDIALOG_UPDATE_OFFSET UNITYSDK_OFFSET(0x17504F40)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTSENTDIALOG__CLOSEPRESSED_G__ONCLOSEPRESSEDROUTINE_47_0_OFFSET UNITYSDK_OFFSET(0x17506040)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTSENTDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x175060B0)

namespace MiHoYo::SDK::Console::UI::OS
{
	inline static constexpr unsigned int ConsoleAgeGateParentalConsentSentDialog_TypeDefinitionIndex = 7800;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Console::UI::OS::ConsoleAgeGateParentalConsentSentDialog**)Il2CppClass::FromTypeDefinitionIndex(ConsoleAgeGateParentalConsentSentDialog_TypeDefinitionIndex)->GetStaticField(0x17820);
		}
