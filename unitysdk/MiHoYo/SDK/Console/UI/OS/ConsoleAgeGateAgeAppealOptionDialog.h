...
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEAGEAPPEALOPTIONDIALOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B92C440)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEAGEAPPEALOPTIONDIALOG_CORRECTAGEBUTTONPRESSED_OFFSET UNITYSDK_OFFSET(0x1B92D670)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEAGEAPPEALOPTIONDIALOG_GET_INTERACTABLE_OFFSET UNITYSDK_OFFSET(0x1B92C420)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEAGEAPPEALOPTIONDIALOG_GET_ONCLOSED_OFFSET UNITYSDK_OFFSET(0x1B92C3C0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEAGEAPPEALOPTIONDIALOG_GET_ONCORRECTAGEBUTTONPRESSED_OFFSET UNITYSDK_OFFSET(0x1B92C400)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEAGEAPPEALOPTIONDIALOG_GET_ONSENDEMAILBUTTONPRESSED_OFFSET UNITYSDK_OFFSET(0x1B92C3E0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEAGEAPPEALOPTIONDIALOG_HIDEDIALOG_OFFSET UNITYSDK_OFFSET(0x1B92D3A0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEAGEAPPEALOPTIONDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x1B92D4B0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEAGEAPPEALOPTIONDIALOG_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x1B92D730)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEAGEAPPEALOPTIONDIALOG_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B92D340)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEAGEAPPEALOPTIONDIALOG_SENDEMAILPRESSED_OFFSET UNITYSDK_OFFSET(0x1B92D640)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEAGEAPPEALOPTIONDIALOG_SETDAYS_OFFSET UNITYSDK_OFFSET(0x1B92D010)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEAGEAPPEALOPTIONDIALOG_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x1B92D720)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEAGEAPPEALOPTIONDIALOG_SET_INTERACTABLE_OFFSET UNITYSDK_OFFSET(0x1B92C430)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEAGEAPPEALOPTIONDIALOG_SET_ONCLOSED_OFFSET UNITYSDK_OFFSET(0x1B92C3D0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEAGEAPPEALOPTIONDIALOG_SET_ONCORRECTAGEBUTTONPRESSED_OFFSET UNITYSDK_OFFSET(0x1B92C410)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEAGEAPPEALOPTIONDIALOG_SET_ONSENDEMAILBUTTONPRESSED_OFFSET UNITYSDK_OFFSET(0x1B92C3F0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEAGEAPPEALOPTIONDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x1B92D540)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEAGEAPPEALOPTIONDIALOG__CORRECTAGEBUTTONPRESSED_G__ONCLOSEPRESSEDROUTINE_37_0_OFFSET UNITYSDK_OFFSET(0x1B92D6D0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEAGEAPPEALOPTIONDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B92D7E0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEAGEAPPEALOPTIONDIALOG__ONCLOSE_G__ONCLOSEPRESSEDROUTINE_39_0_OFFSET UNITYSDK_OFFSET(0x1B92D790)
...
namespace MiHoYo::SDK::Console::UI::OS
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Console::UI::OS::ConsoleAgeGateAgeAppealOptionDialog**)Il2CppClass::FromTypeDefinitionIndex(ConsoleAgeGateAgeAppealOptionDialog_TypeDefinitionIndex)->GetStaticField(0xFF30);
		}
