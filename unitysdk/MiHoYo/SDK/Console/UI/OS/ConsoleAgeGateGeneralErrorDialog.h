...
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEGENERALERRORDIALOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A3FA750)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEGENERALERRORDIALOG_GET_INTERACTABLE_OFFSET UNITYSDK_OFFSET(0x1A3FA730)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEGENERALERRORDIALOG_GET_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x1A3FA6F0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEGENERALERRORDIALOG_GET_ONCONFIRM_OFFSET UNITYSDK_OFFSET(0x1A3FA710)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEGENERALERRORDIALOG_HIDEDIALOG_OFFSET UNITYSDK_OFFSET(0x1A3FB2B0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEGENERALERRORDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x1A3FB220)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEGENERALERRORDIALOG_ONCLOSEDIALOG_OFFSET UNITYSDK_OFFSET(0x1A3FB350)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEGENERALERRORDIALOG_ONCONFIRMDIALOG_OFFSET UNITYSDK_OFFSET(0x1A3FB470)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEGENERALERRORDIALOG_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A3FABF0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEGENERALERRORDIALOG_SETDIALOGMESSAGE_OFFSET UNITYSDK_OFFSET(0x1A3FAC30)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEGENERALERRORDIALOG_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x1A3FB4D0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEGENERALERRORDIALOG_SET_INTERACTABLE_OFFSET UNITYSDK_OFFSET(0x1A3FA740)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEGENERALERRORDIALOG_SET_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x1A3FA700)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEGENERALERRORDIALOG_SET_ONCONFIRM_OFFSET UNITYSDK_OFFSET(0x1A3FA720)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEGENERALERRORDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x1A3FB110)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEGENERALERRORDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3FB4E0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEGENERALERRORDIALOG__ONCLOSEDIALOG_G__ONCLOSEPRESSEDROUTINE_31_0_OFFSET UNITYSDK_OFFSET(0x1A3FB420)

namespace MiHoYo::SDK::Console::UI::OS
{
	inline static constexpr unsigned int ConsoleAgeGateGeneralErrorDialog_TypeDefinitionIndex = 19607;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Console::UI::OS::ConsoleAgeGateGeneralErrorDialog**)Il2CppClass::FromTypeDefinitionIndex(ConsoleAgeGateGeneralErrorDialog_TypeDefinitionIndex)->GetStaticField(0xAAB0);
		}
