...
#define MIHOYO_SDK_CONSOLE_OS_LOGINMANAGER___C__DISPLAYCLASS20_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD39160)
#define MIHOYO_SDK_CONSOLE_OS_LOGINMANAGER___C__DISPLAYCLASS20_0__OPENUSERCENTER_G__ACTIONRESPONSE_1_OFFSET UNITYSDK_OFFSET(0x1DD392A0)
#define MIHOYO_SDK_CONSOLE_OS_LOGINMANAGER___C__DISPLAYCLASS20_0__OPENUSERCENTER_G__OPENWEB_0_OFFSET UNITYSDK_OFFSET(0x1DD39170)

namespace MiHoYo::SDK::Console::OS
{
	inline static constexpr unsigned int LoginManager___c__DisplayClass20_0_TypeDefinitionIndex = 21170;
