...
#define MIHOYO_SDK_CONSOLE_OS_BINDMANAGER_BINDEMAIL_OFFSET UNITYSDK_OFFSET(0x1B6BE1F0)
#define MIHOYO_SDK_CONSOLE_OS_BINDMANAGER_GETCAPTCHACODE_OFFSET UNITYSDK_OFFSET(0x1B6BE380)
#define MIHOYO_SDK_CONSOLE_OS_BINDMANAGER_GETUSERGAMESERVERLIST_OFFSET UNITYSDK_OFFSET(0x1B6BE580)
#define MIHOYO_SDK_CONSOLE_OS_BINDMANAGER_GET_RSAKEY_OFFSET UNITYSDK_OFFSET(0x1B6BDAA0)
#define MIHOYO_SDK_CONSOLE_OS_BINDMANAGER_QUERYWEBBINDINGRESULT_OFFSET UNITYSDK_OFFSET(0x1B6BDED0)
#define MIHOYO_SDK_CONSOLE_OS_BINDMANAGER_REPORTBINDFAIL_OFFSET UNITYSDK_OFFSET(0x1B6BDB50)
#define MIHOYO_SDK_CONSOLE_OS_BINDMANAGER_REQUESTACTIONTICKET_OFFSET UNITYSDK_OFFSET(0x1B6BDE10)
#define MIHOYO_SDK_CONSOLE_OS_BINDMANAGER_REQUESTBINDTHIRDPARTY_OFFSET UNITYSDK_OFFSET(0x1B6BF040)
#define MIHOYO_SDK_CONSOLE_OS_BINDMANAGER_REQUESTGETACTIONTICKETINFO_OFFSET UNITYSDK_OFFSET(0x1B6BDF40)
#define MIHOYO_SDK_CONSOLE_OS_BINDMANAGER_REQUESTGETSERVERBYREGIONCODE_OFFSET UNITYSDK_OFFSET(0x1B6BF6E0)
#define MIHOYO_SDK_CONSOLE_OS_BINDMANAGER_REQUESTLOGINBYACTIONTICKET_OFFSET UNITYSDK_OFFSET(0x1B6BEBE0)
#define MIHOYO_SDK_CONSOLE_OS_BINDMANAGER_REQUESTREACTIVATEACCOUNT_OFFSET UNITYSDK_OFFSET(0x1B6BEDE0)
#define MIHOYO_SDK_CONSOLE_OS_BINDMANAGER_REQUESTUSERSERVERLIST_OFFSET UNITYSDK_OFFSET(0x1B6BF310)
#define MIHOYO_SDK_CONSOLE_OS_BINDMANAGER_REQUESTVERIFYCAPTCHA_OFFSET UNITYSDK_OFFSET(0x1B6BE890)
#define MIHOYO_SDK_CONSOLE_OS_BINDMANAGER_SHOWACCOUNTINFODIALOG_OFFSET UNITYSDK_OFFSET(0x1B6BE740)
#define MIHOYO_SDK_CONSOLE_OS_BINDMANAGER_UPDATEQRCODE_OFFSET UNITYSDK_OFFSET(0x1B6BDCF0)
#define MIHOYO_SDK_CONSOLE_OS_BINDMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6BFA00)
#define MIHOYO_SDK_CONSOLE_OS_BINDMANAGER__QUERYWEBBINDINGRESULT_B__22_0_OFFSET UNITYSDK_OFFSET(0x1B6BFEB0)
#define MIHOYO_SDK_CONSOLE_OS_BINDMANAGER__SHOWACCOUNTINFODIALOG_B__26_0_OFFSET UNITYSDK_OFFSET(0x1B6C0590)
#define MIHOYO_SDK_CONSOLE_OS_BINDMANAGER__SHOWACCOUNTINFODIALOG_B__26_1_OFFSET UNITYSDK_OFFSET(0x1B6C06C0)
#define MIHOYO_SDK_CONSOLE_OS_BINDMANAGER__UPDATEQRCODE_B__21_0_OFFSET UNITYSDK_OFFSET(0x1B6BFB00)

namespace MiHoYo::SDK::Console::OS
{
	inline static constexpr unsigned int BindManager_TypeDefinitionIndex = 20809;
	...
	public:
		...
		::System::String* ConsoleAccountName; // 0x48
