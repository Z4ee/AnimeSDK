...
#define MIHOYO_SDK_CONSOLE_OS_AGEGATEMANAGER___C__DISPLAYCLASS30_2__CTOR_OFFSET UNITYSDK_OFFSET(0x17454B00)
#define MIHOYO_SDK_CONSOLE_OS_AGEGATEMANAGER___C__DISPLAYCLASS30_2__PROCESSAGEGATETICKET_B__5_OFFSET UNITYSDK_OFFSET(0x17454DB0)

namespace MiHoYo::SDK::Console::OS
{
	inline static constexpr unsigned int AgeGateManager___c__DisplayClass30_2_TypeDefinitionIndex = 7816;
