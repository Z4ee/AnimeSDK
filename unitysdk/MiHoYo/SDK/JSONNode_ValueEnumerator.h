...
#define MIHOYO_SDK_JSONNODE_VALUEENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x20CAE60)
...
{
	inline static constexpr unsigned int JSONNode_ValueEnumerator_TypeDefinitionIndex = 7123;
