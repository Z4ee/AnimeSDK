...
#define MIHOYO_SDK_JSONNODE_VALUEENUMERATOR_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x381F70)
#define MIHOYO_SDK_JSONNODE_VALUEENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x937E80)
#define MIHOYO_SDK_JSONNODE_VALUEENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x881870)
#define MIHOYO_SDK_JSONNODE_VALUEENUMERATOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x937E00)
#define MIHOYO_SDK_JSONNODE_VALUEENUMERATOR__CTOR_2_OFFSET UNITYSDK_OFFSET(0x381AA0)
#define MIHOYO_SDK_JSONNODE_VALUEENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x937DC0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int JSONNode_ValueEnumerator_TypeDefinitionIndex = 19889;
