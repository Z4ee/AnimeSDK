...
#define MIHOYO_SDK_NETWORKRESPONSEMODELEX_TOJSONOBJECT_OFFSET UNITYSDK_OFFSET(0x1993C310)
#define MIHOYO_SDK_NETWORKRESPONSEMODELEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1993C5E0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int NetworkResponseModelEx_TypeDefinitionIndex = 19043;
