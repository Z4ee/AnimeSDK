...
#define MIHOYO_SDK_NETWORKRESPONSEMODELEX_TOJSONOBJECT_OFFSET UNITYSDK_OFFSET(0x15F48560)
#define MIHOYO_SDK_NETWORKRESPONSEMODELEX__CTOR_OFFSET UNITYSDK_OFFSET(0x15F43B30)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int NetworkResponseModelEx_TypeDefinitionIndex = 7174;
