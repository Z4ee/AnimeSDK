...
#define MIHOYO_SDK_WEGAMEDELEGATE_SETNOTIFYWINDOWENABLEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x176914C0)
#define MIHOYO_SDK_WEGAMEDELEGATE_SETNOTIFYWINDOWENABLEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17691510)
#define MIHOYO_SDK_WEGAMEDELEGATE_SETNOTIFYWINDOWENABLEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x17691150)
#define MIHOYO_SDK_WEGAMEDELEGATE_SETNOTIFYWINDOWENABLEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17691130)
