...
#define MIHOYO_SDK_SDKREPORTMODEL_LOGINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEB6F80)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKReportModel_LogInfo_TypeDefinitionIndex = 20049;
