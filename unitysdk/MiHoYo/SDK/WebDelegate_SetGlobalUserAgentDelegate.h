...
#define MIHOYO_SDK_WEBDELEGATE_SETGLOBALUSERAGENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BCA1DB0)
#define MIHOYO_SDK_WEBDELEGATE_SETGLOBALUSERAGENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BCA1DE0)
#define MIHOYO_SDK_WEBDELEGATE_SETGLOBALUSERAGENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BCA18B0)
#define MIHOYO_SDK_WEBDELEGATE_SETGLOBALUSERAGENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCA1890)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetGlobalUserAgentDelegate_TypeDefinitionIndex = 19600;
