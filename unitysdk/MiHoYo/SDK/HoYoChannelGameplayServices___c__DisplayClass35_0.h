...
#define MIHOYO_SDK_HOYOCHANNELGAMEPLAYSERVICES___C__DISPLAYCLASS35_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBDFB60)
#define MIHOYO_SDK_HOYOCHANNELGAMEPLAYSERVICES___C__DISPLAYCLASS35_0__ONRECENTPLAYERSCALLBACK_B__0_OFFSET UNITYSDK_OFFSET(0x1CBDFB70)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoChannelGameplayServices___c__DisplayClass35_0_TypeDefinitionIndex = 36900;
