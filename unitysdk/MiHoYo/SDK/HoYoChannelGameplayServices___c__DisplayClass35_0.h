...
#define MIHOYO_SDK_HOYOCHANNELGAMEPLAYSERVICES___C__DISPLAYCLASS35_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF821E0)
#define MIHOYO_SDK_HOYOCHANNELGAMEPLAYSERVICES___C__DISPLAYCLASS35_0__ONRECENTPLAYERSCALLBACK_B__0_OFFSET UNITYSDK_OFFSET(0x1DF821F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoChannelGameplayServices___c__DisplayClass35_0_TypeDefinitionIndex = 37561;

	class HoYoChannelGameplayServices___c__DisplayClass35_0 : public ::System::Object
	{
	public:
		::System::String* jsonResponse; // 0x10
		::System::Action_1<::MiHoYo::SDK::PC::OS::HoYoChannelRecentPlayersResult*>* callback; // 0x18
