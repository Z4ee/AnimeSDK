...
#define MIHOYO_SDK_CONFIRMWITHJOYPAD___C__DISPLAYCLASS39_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1740A650)
#define MIHOYO_SDK_CONFIRMWITHJOYPAD___C__DISPLAYCLASS39_0__SHOW_B__0_OFFSET UNITYSDK_OFFSET(0x1740B870)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConfirmWithJoypad___c__DisplayClass39_0_TypeDefinitionIndex = 7042;
