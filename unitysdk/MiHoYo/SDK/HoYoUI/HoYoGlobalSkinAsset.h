...
#define MIHOYO_SDK_HOYOUI_HOYOGLOBALSKINASSET_GETCOLORORDEFAULT_OFFSET UNITYSDK_OFFSET(0xB205D30)
#define MIHOYO_SDK_HOYOUI_HOYOGLOBALSKINASSET_GETIMAGESTRETCHMODE_OFFSET UNITYSDK_OFFSET(0xB205DF0)
#define MIHOYO_SDK_HOYOUI_HOYOGLOBALSKINASSET_PARSESKINCONFIGURATION_OFFSET UNITYSDK_OFFSET(0xB2060F0)
#define MIHOYO_SDK_HOYOUI_HOYOGLOBALSKINASSET__CTOR_OFFSET UNITYSDK_OFFSET(0xB206090)
