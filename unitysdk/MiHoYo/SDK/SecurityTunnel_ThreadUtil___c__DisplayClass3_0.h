...
#define MIHOYO_SDK_SECURITYTUNNEL_THREADUTIL___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8594930)
#define MIHOYO_SDK_SECURITYTUNNEL_THREADUTIL___C__DISPLAYCLASS3_0__ENQUEUE_B__0_OFFSET UNITYSDK_OFFSET(0x8595300)
#define MIHOYO_SDK_SECURITYTUNNEL_THREADUTIL___C__DISPLAYCLASS3_0__ENQUEUE_B__1_OFFSET UNITYSDK_OFFSET(0x8595310)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_ThreadUtil___c__DisplayClass3_0_TypeDefinitionIndex = 37177;
