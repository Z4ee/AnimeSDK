...
#define MIHOYO_SDK_CONSOLEDELEGATE_JOINSESSIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AA45280)
#define MIHOYO_SDK_CONSOLEDELEGATE_JOINSESSIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AA452C0)
#define MIHOYO_SDK_CONSOLEDELEGATE_JOINSESSIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AA45270)
#define MIHOYO_SDK_CONSOLEDELEGATE_JOINSESSIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA451F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_JoinSessionDelegate_TypeDefinitionIndex = 7589;
