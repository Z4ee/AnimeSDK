...
#define MIHOYO_SDK_CONSOLEDELEGATE_JOINSESSIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18308DD0)
#define MIHOYO_SDK_CONSOLEDELEGATE_JOINSESSIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18308E10)
#define MIHOYO_SDK_CONSOLEDELEGATE_JOINSESSIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18308DC0)
#define MIHOYO_SDK_CONSOLEDELEGATE_JOINSESSIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18308D40)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_JoinSessionDelegate_TypeDefinitionIndex = 7583;
