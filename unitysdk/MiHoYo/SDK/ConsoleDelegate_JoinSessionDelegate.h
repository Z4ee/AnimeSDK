...
#define MIHOYO_SDK_CONSOLEDELEGATE_JOINSESSIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B93EB50)
#define MIHOYO_SDK_CONSOLEDELEGATE_JOINSESSIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B93EB90)
#define MIHOYO_SDK_CONSOLEDELEGATE_JOINSESSIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B93EB40)
#define MIHOYO_SDK_CONSOLEDELEGATE_JOINSESSIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B93EAC0)
