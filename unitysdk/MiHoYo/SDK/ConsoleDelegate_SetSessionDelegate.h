...
#define MIHOYO_SDK_CONSOLEDELEGATE_SETSESSIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18309F40)
#define MIHOYO_SDK_CONSOLEDELEGATE_SETSESSIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18309F80)
#define MIHOYO_SDK_CONSOLEDELEGATE_SETSESSIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18309F30)
#define MIHOYO_SDK_CONSOLEDELEGATE_SETSESSIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18309EB0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_SetSessionDelegate_TypeDefinitionIndex = 7580;
