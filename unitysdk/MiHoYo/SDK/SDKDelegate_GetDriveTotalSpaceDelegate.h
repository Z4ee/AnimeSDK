...
#define MIHOYO_SDK_SDKDELEGATE_GETDRIVETOTALSPACEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBCFAD0)
#define MIHOYO_SDK_SDKDELEGATE_GETDRIVETOTALSPACEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBCFB00)
#define MIHOYO_SDK_SDKDELEGATE_GETDRIVETOTALSPACEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBCF590)
#define MIHOYO_SDK_SDKDELEGATE_GETDRIVETOTALSPACEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBCF570)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_GetDriveTotalSpaceDelegate_TypeDefinitionIndex = 19551;
