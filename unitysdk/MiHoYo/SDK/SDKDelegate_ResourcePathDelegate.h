...
#define MIHOYO_SDK_SDKDELEGATE_RESOURCEPATHDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x171202B0)
#define MIHOYO_SDK_SDKDELEGATE_RESOURCEPATHDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x171202E0)
#define MIHOYO_SDK_SDKDELEGATE_RESOURCEPATHDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x171202A0)
#define MIHOYO_SDK_SDKDELEGATE_RESOURCEPATHDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17120230)
