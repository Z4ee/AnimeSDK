...
#define MIHOYO_SDK_SDKDELEGATE_RESOURCEPATHDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18420F30)
#define MIHOYO_SDK_SDKDELEGATE_RESOURCEPATHDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18420F60)
#define MIHOYO_SDK_SDKDELEGATE_RESOURCEPATHDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18420F20)
#define MIHOYO_SDK_SDKDELEGATE_RESOURCEPATHDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18420EB0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_ResourcePathDelegate_TypeDefinitionIndex = 7729;
