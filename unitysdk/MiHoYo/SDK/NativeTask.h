...
#define MIHOYO_SDK_NATIVETASK_DOLOGGER_OFFSET UNITYSDK_OFFSET(0x1A638280)
#define MIHOYO_SDK_NATIVETASK_ISNATIVETASKSWITCHENABLE_OFFSET UNITYSDK_OFFSET(0x1A638300)
#define MIHOYO_SDK_NATIVETASK_KIBANAREPORTEASY_OFFSET UNITYSDK_OFFSET(0x1A638790)
#define MIHOYO_SDK_NATIVETASK_NATIVEINVOKERETURN_OFFSET UNITYSDK_OFFSET(0x1A638820)
#define MIHOYO_SDK_NATIVETASK_NATIVEINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6383A0)
#define MIHOYO_SDK_NATIVETASK_ONSYNCDATATONATIVE_OFFSET UNITYSDK_OFFSET(0x1A638390)
#define MIHOYO_SDK_NATIVETASK_SYNCDATATONATIVE_OFFSET UNITYSDK_OFFSET(0x1A638310)
#define MIHOYO_SDK_NATIVETASK_USINGNATIVETASK_OFFSET UNITYSDK_OFFSET(0x1A637F70)
#define MIHOYO_SDK_NATIVETASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A638B50)
