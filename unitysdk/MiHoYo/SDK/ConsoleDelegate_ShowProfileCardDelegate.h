...
#define MIHOYO_SDK_CONSOLEDELEGATE_SHOWPROFILECARDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C5FB2D0)
#define MIHOYO_SDK_CONSOLEDELEGATE_SHOWPROFILECARDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C5FB310)
#define MIHOYO_SDK_CONSOLEDELEGATE_SHOWPROFILECARDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C5FB2C0)
#define MIHOYO_SDK_CONSOLEDELEGATE_SHOWPROFILECARDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5FB240)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_ShowProfileCardDelegate_TypeDefinitionIndex = 7625;
