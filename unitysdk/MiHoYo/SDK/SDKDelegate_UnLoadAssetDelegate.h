...
#define MIHOYO_SDK_SDKDELEGATE_UNLOADASSETDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15FEE4C0)
#define MIHOYO_SDK_SDKDELEGATE_UNLOADASSETDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15FEE4F0)
#define MIHOYO_SDK_SDKDELEGATE_UNLOADASSETDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15FE4110)
#define MIHOYO_SDK_SDKDELEGATE_UNLOADASSETDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15FEE4A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_UnLoadAssetDelegate_TypeDefinitionIndex = 6788;
