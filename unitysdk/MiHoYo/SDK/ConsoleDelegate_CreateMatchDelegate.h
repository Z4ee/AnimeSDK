...
#define MIHOYO_SDK_CONSOLEDELEGATE_CREATEMATCHDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D4A46C0)
#define MIHOYO_SDK_CONSOLEDELEGATE_CREATEMATCHDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D4A4700)
#define MIHOYO_SDK_CONSOLEDELEGATE_CREATEMATCHDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D4A4130)
#define MIHOYO_SDK_CONSOLEDELEGATE_CREATEMATCHDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4A4110)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_CreateMatchDelegate_TypeDefinitionIndex = 19757;
