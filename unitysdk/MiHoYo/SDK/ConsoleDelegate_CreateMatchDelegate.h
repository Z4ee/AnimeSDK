...
#define MIHOYO_SDK_CONSOLEDELEGATE_CREATEMATCHDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15EC9840)
#define MIHOYO_SDK_CONSOLEDELEGATE_CREATEMATCHDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15EC9880)
#define MIHOYO_SDK_CONSOLEDELEGATE_CREATEMATCHDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15EC92C0)
#define MIHOYO_SDK_CONSOLEDELEGATE_CREATEMATCHDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15EC92A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_CreateMatchDelegate_TypeDefinitionIndex = 6670;
