...
#define MIHOYO_SDK_CONSOLEDELEGATE_CREATEMATCHDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A06BAB0)
#define MIHOYO_SDK_CONSOLEDELEGATE_CREATEMATCHDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A06BAF0)
#define MIHOYO_SDK_CONSOLEDELEGATE_CREATEMATCHDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A06B530)
#define MIHOYO_SDK_CONSOLEDELEGATE_CREATEMATCHDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A06B520)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_CreateMatchDelegate_TypeDefinitionIndex = 18526;
