...
#define MIHOYO_SDK_UGCINTERFACE__POST_D__47_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B73CC70)
#define MIHOYO_SDK_UGCINTERFACE__POST_D__47_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B73CD30)
#define MIHOYO_SDK_UGCINTERFACE__POST_D__47_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B73CD90)
#define MIHOYO_SDK_UGCINTERFACE__POST_D__47_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B73CD40)
#define MIHOYO_SDK_UGCINTERFACE__POST_D__47_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B73CC60)
#define MIHOYO_SDK_UGCINTERFACE__POST_D__47__CTOR_OFFSET UNITYSDK_OFFSET(0x1B739EE0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int UGCInterface__Post_d__47_TypeDefinitionIndex = 44722;
	...
	public:
		...
		::System::Action_2<::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>*, ::System::String*>* completeCallback; // 0x38
