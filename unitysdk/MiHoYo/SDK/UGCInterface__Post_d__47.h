...
#define MIHOYO_SDK_UGCINTERFACE__POST_D__47_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x85A50D0)
#define MIHOYO_SDK_UGCINTERFACE__POST_D__47_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x85A5190)
#define MIHOYO_SDK_UGCINTERFACE__POST_D__47_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x85A51F0)
#define MIHOYO_SDK_UGCINTERFACE__POST_D__47_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x85A51A0)
#define MIHOYO_SDK_UGCINTERFACE__POST_D__47_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x85A50C0)
#define MIHOYO_SDK_UGCINTERFACE__POST_D__47__CTOR_OFFSET UNITYSDK_OFFSET(0x85A2360)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int UGCInterface__Post_d__47_TypeDefinitionIndex = 37212;
