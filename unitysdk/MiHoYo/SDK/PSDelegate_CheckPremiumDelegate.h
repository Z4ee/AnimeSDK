...
#define MIHOYO_SDK_PSDELEGATE_CHECKPREMIUMDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CE10290)
#define MIHOYO_SDK_PSDELEGATE_CHECKPREMIUMDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CE102C0)
#define MIHOYO_SDK_PSDELEGATE_CHECKPREMIUMDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CE10000)
#define MIHOYO_SDK_PSDELEGATE_CHECKPREMIUMDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE0FFE0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_CheckPremiumDelegate_TypeDefinitionIndex = 19873;
