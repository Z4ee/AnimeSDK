...
#define MIHOYO_SDK_EOSDELEGATE_PAYDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DD3D550)
#define MIHOYO_SDK_EOSDELEGATE_PAYDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DD3D590)
#define MIHOYO_SDK_EOSDELEGATE_PAYDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DD3CF90)
#define MIHOYO_SDK_EOSDELEGATE_PAYDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD3CF70)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int EOSDelegate_PayDelegate_TypeDefinitionIndex = 19826;
