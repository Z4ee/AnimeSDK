...
#define MIHOYO_SDK_EOSDELEGATE_PAYDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x175249F0)
#define MIHOYO_SDK_EOSDELEGATE_PAYDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17524A30)
#define MIHOYO_SDK_EOSDELEGATE_PAYDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x175243B0)
#define MIHOYO_SDK_EOSDELEGATE_PAYDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17524390)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int EOSDelegate_PayDelegate_TypeDefinitionIndex = 6762;
