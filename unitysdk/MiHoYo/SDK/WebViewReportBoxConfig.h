...
#define MIHOYO_SDK_WEBVIEWREPORTBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x15C27E30)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebViewReportBoxConfig_TypeDefinitionIndex = 7874;
