...
#define MIHOYO_SDK_WEBVIEWREPORTBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16044020)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebViewReportBoxConfig_TypeDefinitionIndex = 6920;
