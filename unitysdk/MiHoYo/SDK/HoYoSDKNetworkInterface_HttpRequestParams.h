...
#define MIHOYO_SDK_HOYOSDKNETWORKINTERFACE_HTTPREQUESTPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0xB2017A0)
...
namespace MiHoYo::SDK
{
	...
	public:
		...
		::System::String* m_strOptions; // 0x28
		::System::String* m_strMethodName; // 0x30
