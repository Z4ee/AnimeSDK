...
#define MIHOYO_SDK_HOYOSDKNETWORKINTERFACE_HTTPREQUESTPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD91C60)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoSDKNetworkInterface_HttpRequestParams_TypeDefinitionIndex = 34931;
	...
	public:
		...
		::System::String* m_strIpAddr; // 0x20
