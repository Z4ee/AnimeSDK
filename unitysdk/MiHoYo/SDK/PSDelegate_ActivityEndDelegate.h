...
#define MIHOYO_SDK_PSDELEGATE_ACTIVITYENDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BA74150)
#define MIHOYO_SDK_PSDELEGATE_ACTIVITYENDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BA74180)
#define MIHOYO_SDK_PSDELEGATE_ACTIVITYENDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BA74140)
#define MIHOYO_SDK_PSDELEGATE_ACTIVITYENDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA740D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_ActivityEndDelegate_TypeDefinitionIndex = 7709;
