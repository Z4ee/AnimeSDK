...
#define MIHOYO_SDK_PSDELEGATE_ACTIVITYENDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A518C40)
#define MIHOYO_SDK_PSDELEGATE_ACTIVITYENDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A518C70)
#define MIHOYO_SDK_PSDELEGATE_ACTIVITYENDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A518700)
#define MIHOYO_SDK_PSDELEGATE_ACTIVITYENDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5186F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_ActivityEndDelegate_TypeDefinitionIndex = 18622;
