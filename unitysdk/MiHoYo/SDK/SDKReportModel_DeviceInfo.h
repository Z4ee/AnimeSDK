...
#define MIHOYO_SDK_SDKREPORTMODEL_DEVICEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9B0BF0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKReportModel_DeviceInfo_TypeDefinitionIndex = 7892;
