...
#define MIHOYO_SDK_SDKREPORTMODEL_DEVICEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17651410)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKReportModel_DeviceInfo_TypeDefinitionIndex = 6980;
