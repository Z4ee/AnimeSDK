...
#define MIHOYO_SDK_SDKREPORTMODEL_DEVICEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x15FF3880)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKReportModel_DeviceInfo_TypeDefinitionIndex = 6934;
