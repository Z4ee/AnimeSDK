...
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONWEBVIEWPAGEERROR_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xB257870)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONWEBVIEWPAGEERROR_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xB2578F0)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONWEBVIEWPAGEERROR_INVOKE_OFFSET UNITYSDK_OFFSET(0xB2567B0)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONWEBVIEWPAGEERROR__CTOR_OFFSET UNITYSDK_OFFSET(0xB257780)
