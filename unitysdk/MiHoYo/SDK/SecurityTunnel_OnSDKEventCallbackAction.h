...
#define MIHOYO_SDK_SECURITYTUNNEL_ONSDKEVENTCALLBACKACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BFCB8C0)
#define MIHOYO_SDK_SECURITYTUNNEL_ONSDKEVENTCALLBACKACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BFCB960)
#define MIHOYO_SDK_SECURITYTUNNEL_ONSDKEVENTCALLBACKACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BFCB540)
#define MIHOYO_SDK_SECURITYTUNNEL_ONSDKEVENTCALLBACKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFCB520)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_OnSDKEventCallbackAction_TypeDefinitionIndex = 36783;
