...
#define MIHOYO_SDK_HOYOCHANNELSYSTEMFUNCTIONS___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCC03B0)
#define MIHOYO_SDK_HOYOCHANNELSYSTEMFUNCTIONS___C__DISPLAYCLASS5_0__ONSHOWTEXTENTRYCALLBACK_B__0_OFFSET UNITYSDK_OFFSET(0x1DCC03C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoChannelSystemFunctions___c__DisplayClass5_0_TypeDefinitionIndex = 37603;
