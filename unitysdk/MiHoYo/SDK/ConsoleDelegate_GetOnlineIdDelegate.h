...
#define MIHOYO_SDK_CONSOLEDELEGATE_GETONLINEIDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15ECD550)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETONLINEIDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15ECD580)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETONLINEIDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15ECD2A0)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETONLINEIDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15ECD280)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_GetOnlineIdDelegate_TypeDefinitionIndex = 6634;
