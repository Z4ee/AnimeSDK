...
#define MIHOYO_SDK_PROTOCOLMANAGER___C__DISPLAYCLASS36_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3C78D0)
#define MIHOYO_SDK_PROTOCOLMANAGER___C__DISPLAYCLASS36_0__SHOWPROTOCOLPLUGINUI_B__0_OFFSET UNITYSDK_OFFSET(0x1D3C78E0)
#define MIHOYO_SDK_PROTOCOLMANAGER___C__DISPLAYCLASS36_0__SHOWPROTOCOLPLUGINUI_B__1_OFFSET UNITYSDK_OFFSET(0x1D3C7900)
#define MIHOYO_SDK_PROTOCOLMANAGER___C__DISPLAYCLASS36_0__SHOWPROTOCOLPLUGINUI_B__2_OFFSET UNITYSDK_OFFSET(0x1D3C7920)
#define MIHOYO_SDK_PROTOCOLMANAGER___C__DISPLAYCLASS36_0__SHOWPROTOCOLPLUGINUI_B__3_OFFSET UNITYSDK_OFFSET(0x1D3C7940)
#define MIHOYO_SDK_PROTOCOLMANAGER___C__DISPLAYCLASS36_0__SHOWPROTOCOLPLUGINUI_B__4_OFFSET UNITYSDK_OFFSET(0x1D3C7960)
#define MIHOYO_SDK_PROTOCOLMANAGER___C__DISPLAYCLASS36_0__SHOWPROTOCOLPLUGINUI_B__5_OFFSET UNITYSDK_OFFSET(0x1D3C7B00)
#define MIHOYO_SDK_PROTOCOLMANAGER___C__DISPLAYCLASS36_0__SHOWPROTOCOLPLUGINUI_B__6_OFFSET UNITYSDK_OFFSET(0x1D3C7AC0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ProtocolManager___c__DisplayClass36_0_TypeDefinitionIndex = 20157;
