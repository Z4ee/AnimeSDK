...
#define MIHOYO_SDK_H5LOGGENERALREPORT_MODULETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1B3D60)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int H5logGeneralReport_ModuleType_TypeDefinitionIndex = 37521;
