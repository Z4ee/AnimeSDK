...
#define MIHOYO_SDK_HTTPDNSBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9614B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HttpDnsBoxConfig_TypeDefinitionIndex = 19680;
