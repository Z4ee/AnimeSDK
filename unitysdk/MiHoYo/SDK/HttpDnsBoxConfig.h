...
#define MIHOYO_SDK_HTTPDNSBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD406D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HttpDnsBoxConfig_TypeDefinitionIndex = 20028;
