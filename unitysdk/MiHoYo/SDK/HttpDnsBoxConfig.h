...
#define MIHOYO_SDK_HTTPDNSBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x15F13840)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HttpDnsBoxConfig_TypeDefinitionIndex = 6917;
