...
#define MIHOYO_SDK_PSDELEGATE_PS5FRIENDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19FE8710)
#define MIHOYO_SDK_PSDELEGATE_PS5FRIENDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19FE8740)
#define MIHOYO_SDK_PSDELEGATE_PS5FRIENDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19FE6F00)
#define MIHOYO_SDK_PSDELEGATE_PS5FRIENDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19FE8700)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_PS5FriendDelegate_TypeDefinitionIndex = 18618;
