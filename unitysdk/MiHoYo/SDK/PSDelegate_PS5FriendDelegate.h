...
#define MIHOYO_SDK_PSDELEGATE_PS5FRIENDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15F995E0)
#define MIHOYO_SDK_PSDELEGATE_PS5FRIENDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15F99610)
#define MIHOYO_SDK_PSDELEGATE_PS5FRIENDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15F99340)
#define MIHOYO_SDK_PSDELEGATE_PS5FRIENDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15F99320)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_PS5FriendDelegate_TypeDefinitionIndex = 6754;
