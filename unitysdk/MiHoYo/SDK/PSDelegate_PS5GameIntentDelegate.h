...
#define MIHOYO_SDK_PSDELEGATE_PS5GAMEINTENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15F99E90)
#define MIHOYO_SDK_PSDELEGATE_PS5GAMEINTENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15F99EC0)
#define MIHOYO_SDK_PSDELEGATE_PS5GAMEINTENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15F99BF0)
#define MIHOYO_SDK_PSDELEGATE_PS5GAMEINTENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15F99BD0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_PS5GameIntentDelegate_TypeDefinitionIndex = 6766;
