...
#define MIHOYO_SDK_PSDELEGATE_PS5GAMEINTENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x175FB1B0)
#define MIHOYO_SDK_PSDELEGATE_PS5GAMEINTENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x175FB1E0)
#define MIHOYO_SDK_PSDELEGATE_PS5GAMEINTENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x175D9880)
#define MIHOYO_SDK_PSDELEGATE_PS5GAMEINTENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x175FB190)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_PS5GameIntentDelegate_TypeDefinitionIndex = 6808;
