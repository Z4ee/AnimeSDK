...
#define MIHOYO_SDK_PSDELEGATE_PS5GAMEINTENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CF482E0)
#define MIHOYO_SDK_PSDELEGATE_PS5GAMEINTENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CF48310)
#define MIHOYO_SDK_PSDELEGATE_PS5GAMEINTENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CF28C40)
#define MIHOYO_SDK_PSDELEGATE_PS5GAMEINTENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF482C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_PS5GameIntentDelegate_TypeDefinitionIndex = 19872;
