...
#define MIHOYO_SDK_HOYOCHANNELINTERFACE___C__DISPLAYCLASS57_1__CLEANUPTIMEDOUTCALLBACKS_B__1_OFFSET UNITYSDK_OFFSET(0x1A49C600)
#define MIHOYO_SDK_HOYOCHANNELINTERFACE___C__DISPLAYCLASS57_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1A49C5F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoChannelInterface___c__DisplayClass57_1_TypeDefinitionIndex = 35340;
