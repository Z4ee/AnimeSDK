...
#define MIHOYO_SDK_PSDELEGATE_HIDEPSSTOREICONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19E7B450)
#define MIHOYO_SDK_PSDELEGATE_HIDEPSSTOREICONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19E7B480)
#define MIHOYO_SDK_PSDELEGATE_HIDEPSSTOREICONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19E7B440)
#define MIHOYO_SDK_PSDELEGATE_HIDEPSSTOREICONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E7B3D0)
