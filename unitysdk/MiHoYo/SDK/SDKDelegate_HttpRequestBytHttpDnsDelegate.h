...
#define MIHOYO_SDK_SDKDELEGATE_HTTPREQUESTBYTHTTPDNSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x197EB210)
#define MIHOYO_SDK_SDKDELEGATE_HTTPREQUESTBYTHTTPDNSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x197EB350)
#define MIHOYO_SDK_SDKDELEGATE_HTTPREQUESTBYTHTTPDNSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x197EA7E0)
#define MIHOYO_SDK_SDKDELEGATE_HTTPREQUESTBYTHTTPDNSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x197EA7D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_HttpRequestBytHttpDnsDelegate_TypeDefinitionIndex = 18667;
