...
#define MIHOYO_SDK_CONSOLEDELEGATE_UPDATEMATCHSTATUSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19995FC0)
#define MIHOYO_SDK_CONSOLEDELEGATE_UPDATEMATCHSTATUSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19996000)
#define MIHOYO_SDK_CONSOLEDELEGATE_UPDATEMATCHSTATUSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19995A40)
#define MIHOYO_SDK_CONSOLEDELEGATE_UPDATEMATCHSTATUSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19995A30)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_UpdateMatchStatusDelegate_TypeDefinitionIndex = 18529;
