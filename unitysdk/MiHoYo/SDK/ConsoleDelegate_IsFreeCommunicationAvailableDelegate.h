...
#define MIHOYO_SDK_CONSOLEDELEGATE_ISFREECOMMUNICATIONAVAILABLEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C0D5ED0)
#define MIHOYO_SDK_CONSOLEDELEGATE_ISFREECOMMUNICATIONAVAILABLEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C0D5F00)
#define MIHOYO_SDK_CONSOLEDELEGATE_ISFREECOMMUNICATIONAVAILABLEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C0D5C30)
#define MIHOYO_SDK_CONSOLEDELEGATE_ISFREECOMMUNICATIONAVAILABLEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0D5C10)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_IsFreeCommunicationAvailableDelegate_TypeDefinitionIndex = 19444;
