...
#define MIHOYO_SDK_BOXMODEL_CHECKDIVISORENABLE_OFFSET UNITYSDK_OFFSET(0x15DEED80)
#define MIHOYO_SDK_BOXMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x15DEB020)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int BoxModel_TypeDefinitionIndex = 6928;
