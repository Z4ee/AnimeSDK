...
#define MIHOYO_SDK_WEBDELEGATE_SHOWDEVTOOLSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x176A7B00)
#define MIHOYO_SDK_WEBDELEGATE_SHOWDEVTOOLSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x176A7B60)
#define MIHOYO_SDK_WEBDELEGATE_SHOWDEVTOOLSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1769AC90)
#define MIHOYO_SDK_WEBDELEGATE_SHOWDEVTOOLSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176A7AE0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_ShowDevToolsDelegate_TypeDefinitionIndex = 6885;
