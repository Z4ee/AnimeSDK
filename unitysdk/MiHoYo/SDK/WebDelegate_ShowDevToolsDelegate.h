...
#define MIHOYO_SDK_WEBDELEGATE_SHOWDEVTOOLSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C0EBEE0)
#define MIHOYO_SDK_WEBDELEGATE_SHOWDEVTOOLSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C0EBF60)
#define MIHOYO_SDK_WEBDELEGATE_SHOWDEVTOOLSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C0EB8F0)
#define MIHOYO_SDK_WEBDELEGATE_SHOWDEVTOOLSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0EB8D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_ShowDevToolsDelegate_TypeDefinitionIndex = 19602;
