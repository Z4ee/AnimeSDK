...
#define MIHOYO_SDK_WEBDELEGATE_SHOWDEVTOOLSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D4BC060)
#define MIHOYO_SDK_WEBDELEGATE_SHOWDEVTOOLSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D4BC0E0)
#define MIHOYO_SDK_WEBDELEGATE_SHOWDEVTOOLSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D4BBA50)
#define MIHOYO_SDK_WEBDELEGATE_SHOWDEVTOOLSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4BBA30)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_ShowDevToolsDelegate_TypeDefinitionIndex = 19950;
