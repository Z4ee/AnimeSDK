...
#define MIHOYO_SDK_SECURITYTUNNEL_RESPONSECALLBACKACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8DCA550)
#define MIHOYO_SDK_SECURITYTUNNEL_RESPONSECALLBACKACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8DCA5B0)
#define MIHOYO_SDK_SECURITYTUNNEL_RESPONSECALLBACKACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x8DBF640)
#define MIHOYO_SDK_SECURITYTUNNEL_RESPONSECALLBACKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x8DB8140)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_ResponseCallbackAction_TypeDefinitionIndex = 43004;
