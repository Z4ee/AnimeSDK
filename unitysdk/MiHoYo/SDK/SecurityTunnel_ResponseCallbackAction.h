...
#define MIHOYO_SDK_SECURITYTUNNEL_RESPONSECALLBACKACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ABC1180)
#define MIHOYO_SDK_SECURITYTUNNEL_RESPONSECALLBACKACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ABC11E0)
#define MIHOYO_SDK_SECURITYTUNNEL_RESPONSECALLBACKACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ABB7360)
#define MIHOYO_SDK_SECURITYTUNNEL_RESPONSECALLBACKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABC1110)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_ResponseCallbackAction_TypeDefinitionIndex = 44669;
