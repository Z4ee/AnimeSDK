...
#define MIHOYO_SDK_CLOUDSAVEIMAGEMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x173EDC90)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int CloudSaveImageModel_TypeDefinitionIndex = 7108;
