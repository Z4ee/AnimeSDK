...
#define MIHOYO_SDK_SDKDELEGATE_ISEDITORDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18420470)
#define MIHOYO_SDK_SDKDELEGATE_ISEDITORDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x184204A0)
#define MIHOYO_SDK_SDKDELEGATE_ISEDITORDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1841D7D0)
#define MIHOYO_SDK_SDKDELEGATE_ISEDITORDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18420400)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_IsEditorDelegate_TypeDefinitionIndex = 7728;
