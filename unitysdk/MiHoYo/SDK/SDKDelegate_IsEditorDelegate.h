...
#define MIHOYO_SDK_SDKDELEGATE_ISEDITORDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15FE9F20)
#define MIHOYO_SDK_SDKDELEGATE_ISEDITORDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15FE9F50)
#define MIHOYO_SDK_SDKDELEGATE_ISEDITORDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15FE1A20)
#define MIHOYO_SDK_SDKDELEGATE_ISEDITORDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15FE9F00)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_IsEditorDelegate_TypeDefinitionIndex = 6783;
