...
#define MIHOYO_SDK_SECURITYTUNNEL_PACKETHEADER_GETBYTES_OFFSET UNITYSDK_OFFSET(0x3A07760)
#define MIHOYO_SDK_SECURITYTUNNEL_PACKETHEADER_GET_FIXEDLENGTH_OFFSET UNITYSDK_OFFSET(0x1ABC0F90)
#define MIHOYO_SDK_SECURITYTUNNEL_PACKETHEADER_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x3A07620)
#define MIHOYO_SDK_SECURITYTUNNEL_PACKETHEADER_GET_WANTSGENERATEDID_OFFSET UNITYSDK_OFFSET(0x3A07640)
#define MIHOYO_SDK_SECURITYTUNNEL_PACKETHEADER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3A07770)
#define MIHOYO_SDK_SECURITYTUNNEL_PACKETHEADER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3A076C0)
#define MIHOYO_SDK_SECURITYTUNNEL_PACKETHEADER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x3A076E0)
#define MIHOYO_SDK_SECURITYTUNNEL_PACKETHEADER__CTOR_OFFSET UNITYSDK_OFFSET(0x3A076B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_PacketHeader_TypeDefinitionIndex = 44658;
