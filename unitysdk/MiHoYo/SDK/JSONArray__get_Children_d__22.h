...
#define MIHOYO_SDK_JSONARRAY__GET_CHILDREN_D__22_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1CFD0390)
#define MIHOYO_SDK_JSONARRAY__GET_CHILDREN_D__22_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_MIHOYO_SDK_JSONNODE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1CFD05A0)
#define MIHOYO_SDK_JSONARRAY__GET_CHILDREN_D__22_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_MIHOYO_SDK_JSONNODE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CFD0530)
#define MIHOYO_SDK_JSONARRAY__GET_CHILDREN_D__22_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1CFD0780)
#define MIHOYO_SDK_JSONARRAY__GET_CHILDREN_D__22_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CFD0590)
#define MIHOYO_SDK_JSONARRAY__GET_CHILDREN_D__22_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1CFD0540)
#define MIHOYO_SDK_JSONARRAY__GET_CHILDREN_D__22_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CFD0360)
#define MIHOYO_SDK_JSONARRAY__GET_CHILDREN_D__22__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFD0290)
#define MIHOYO_SDK_JSONARRAY__GET_CHILDREN_D__22___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1CFD0380)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int JSONArray__get_Children_d__22_TypeDefinitionIndex = 20243;
	...
	public:
		...
		::System::Collections::Generic::List_1_Enumerator<::MiHoYo::SDK::JSONNode*> __s__1; // 0x20
