...
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOGETCHUNKINFODELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AA45910)
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOGETCHUNKINFODELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AA45940)
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOGETCHUNKINFODELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AA45900)
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOGETCHUNKINFODELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA45890)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_PlayGoGetChunkInfoDelegate_TypeDefinitionIndex = 7623;
