...
#define MIHOYO_SDK_TIPSBAR___C__DISPLAYCLASS10_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1883A0)
#define MIHOYO_SDK_TIPSBAR___C__DISPLAYCLASS10_0__SHOW_B__0_OFFSET UNITYSDK_OFFSET(0x1A1883B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int TipsBar___c__DisplayClass10_0_TypeDefinitionIndex = 19096;
