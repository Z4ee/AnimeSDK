...
#define MIHOYO_SDK_HOYOCHANNELSYSTEMFUNCTIONS___C__DISPLAYCLASS17_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1D282A40)
#define MIHOYO_SDK_HOYOCHANNELSYSTEMFUNCTIONS___C__DISPLAYCLASS17_0__ONSHOWMESSAGEDIALOGCALLBACK_B__0_OFFSET UNITYSDK_OFFSET(0x1D282A50)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoChannelSystemFunctions___c__DisplayClass17_0_TypeDefinitionIndex = 36944;
