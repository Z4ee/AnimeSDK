...
#define MIHOYO_SDK_PROTOCOLMANAGER___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A359190)
#define MIHOYO_SDK_PROTOCOLMANAGER___C__DISPLAYCLASS14_0__SHOWLAUNCHERPROTOCOLFALLBACK_B__0_OFFSET UNITYSDK_OFFSET(0x1A3591A0)
#define MIHOYO_SDK_PROTOCOLMANAGER___C__DISPLAYCLASS14_0__SHOWLAUNCHERPROTOCOLFALLBACK_B__1_OFFSET UNITYSDK_OFFSET(0x1A3591D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ProtocolManager___c__DisplayClass14_0_TypeDefinitionIndex = 18912;
