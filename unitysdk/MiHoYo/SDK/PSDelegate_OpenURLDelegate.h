...
#define MIHOYO_SDK_PSDELEGATE_OPENURLDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CF481F0)
#define MIHOYO_SDK_PSDELEGATE_OPENURLDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CF48230)
#define MIHOYO_SDK_PSDELEGATE_OPENURLDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CF47C60)
#define MIHOYO_SDK_PSDELEGATE_OPENURLDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF47C40)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_OpenURLDelegate_TypeDefinitionIndex = 19835;
