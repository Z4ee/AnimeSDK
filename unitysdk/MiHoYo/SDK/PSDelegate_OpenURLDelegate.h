...
#define MIHOYO_SDK_PSDELEGATE_OPENURLDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x175FB000)
#define MIHOYO_SDK_PSDELEGATE_OPENURLDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x175FB040)
#define MIHOYO_SDK_PSDELEGATE_OPENURLDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x175C70D0)
#define MIHOYO_SDK_PSDELEGATE_OPENURLDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x175FAFE0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_OpenURLDelegate_TypeDefinitionIndex = 6771;
