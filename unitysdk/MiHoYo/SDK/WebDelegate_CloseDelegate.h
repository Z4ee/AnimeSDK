...
#define MIHOYO_SDK_WEBDELEGATE_CLOSEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x160404A0)
#define MIHOYO_SDK_WEBDELEGATE_CLOSEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x160404D0)
#define MIHOYO_SDK_WEBDELEGATE_CLOSEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x160327D0)
#define MIHOYO_SDK_WEBDELEGATE_CLOSEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16040480)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_CloseDelegate_TypeDefinitionIndex = 6829;
