...
#define MIHOYO_SDK_WEBDELEGATE_CLOSEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x176A4DA0)
#define MIHOYO_SDK_WEBDELEGATE_CLOSEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x176A4DD0)
#define MIHOYO_SDK_WEBDELEGATE_CLOSEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x176970A0)
#define MIHOYO_SDK_WEBDELEGATE_CLOSEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176A4D80)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_CloseDelegate_TypeDefinitionIndex = 6871;
