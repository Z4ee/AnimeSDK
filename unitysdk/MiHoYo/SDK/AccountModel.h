...
#define MIHOYO_SDK_ACCOUNTMODEL_GETTOKEN_OFFSET UNITYSDK_OFFSET(0x173D4820)
#define MIHOYO_SDK_ACCOUNTMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x173D38D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AccountModel_TypeDefinitionIndex = 6908;
