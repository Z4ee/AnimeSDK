...
#define MIHOYO_SDK_ACCOUNTMODEL_GETTOKEN_OFFSET UNITYSDK_OFFSET(0x1CDEC3E0)
#define MIHOYO_SDK_ACCOUNTMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDEC3F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AccountModel_TypeDefinitionIndex = 19973;
