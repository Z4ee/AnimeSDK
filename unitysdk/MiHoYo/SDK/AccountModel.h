...
#define MIHOYO_SDK_ACCOUNTMODEL_GETTOKEN_OFFSET UNITYSDK_OFFSET(0x15DD7060)
#define MIHOYO_SDK_ACCOUNTMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x15DD6120)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AccountModel_TypeDefinitionIndex = 6866;
