...
#define MIHOYO_SDK_CONSOLEDELEGATE_GETUSERCOLLECTIONSIDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AA4C310)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETUSERCOLLECTIONSIDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AA4C390)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETUSERCOLLECTIONSIDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AA4BFD0)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETUSERCOLLECTIONSIDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA4BFC0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_GetUserCollectionsIdCallback_TypeDefinitionIndex = 18546;
