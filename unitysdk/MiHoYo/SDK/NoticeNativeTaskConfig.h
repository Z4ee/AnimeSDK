...
#define MIHOYO_SDK_NOTICENATIVETASKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17591AC0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int NoticeNativeTaskConfig_TypeDefinitionIndex = 6972;
