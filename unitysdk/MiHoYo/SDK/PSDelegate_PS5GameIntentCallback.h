...
#define MIHOYO_SDK_PSDELEGATE_PS5GAMEINTENTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15F99B90)
#define MIHOYO_SDK_PSDELEGATE_PS5GAMEINTENTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15F99BC0)
#define MIHOYO_SDK_PSDELEGATE_PS5GAMEINTENTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x15F99640)
#define MIHOYO_SDK_PSDELEGATE_PS5GAMEINTENTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x15F99620)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_PS5GameIntentCallback_TypeDefinitionIndex = 6765;
