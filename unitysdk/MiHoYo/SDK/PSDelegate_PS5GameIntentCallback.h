...
#define MIHOYO_SDK_PSDELEGATE_PS5GAMEINTENTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19E7BD40)
#define MIHOYO_SDK_PSDELEGATE_PS5GAMEINTENTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19E7BD70)
#define MIHOYO_SDK_PSDELEGATE_PS5GAMEINTENTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19E7BD30)
#define MIHOYO_SDK_PSDELEGATE_PS5GAMEINTENTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19E7BCC0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_PS5GameIntentCallback_TypeDefinitionIndex = 7716;
