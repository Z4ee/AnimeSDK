...
#define MIHOYO_SDK_STEAMDELEGATE_GETTICKETDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1712D560)
#define MIHOYO_SDK_STEAMDELEGATE_GETTICKETDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1712D590)
#define MIHOYO_SDK_STEAMDELEGATE_GETTICKETDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1712D550)
#define MIHOYO_SDK_STEAMDELEGATE_GETTICKETDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1712D4E0)
