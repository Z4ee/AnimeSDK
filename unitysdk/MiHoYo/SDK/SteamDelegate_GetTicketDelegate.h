...
#define MIHOYO_SDK_STEAMDELEGATE_GETTICKETDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B9B9710)
#define MIHOYO_SDK_STEAMDELEGATE_GETTICKETDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B9B9740)
#define MIHOYO_SDK_STEAMDELEGATE_GETTICKETDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B9B9700)
#define MIHOYO_SDK_STEAMDELEGATE_GETTICKETDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9B9690)
