...
#define MIHOYO_SDK_STEAMDELEGATE_GETTICKETDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1842DFE0)
#define MIHOYO_SDK_STEAMDELEGATE_GETTICKETDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1842E010)
#define MIHOYO_SDK_STEAMDELEGATE_GETTICKETDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1842DFD0)
#define MIHOYO_SDK_STEAMDELEGATE_GETTICKETDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1842DF60)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SteamDelegate_GetTicketDelegate_TypeDefinitionIndex = 7638;
