...
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDKNOTIFICATION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DCB52E0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDKNOTIFICATION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DCB5310)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDKNOTIFICATION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DCB4DC0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDKNOTIFICATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCB4DA0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AccountPlatNative_HoYoSDKNotification_TypeDefinitionIndex = 37135;
