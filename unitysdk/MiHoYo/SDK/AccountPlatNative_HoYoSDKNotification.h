...
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDKNOTIFICATION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A4F69C0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDKNOTIFICATION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A4F69F0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDKNOTIFICATION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A4F64C0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDKNOTIFICATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4F64B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AccountPlatNative_HoYoSDKNotification_TypeDefinitionIndex = 34913;
