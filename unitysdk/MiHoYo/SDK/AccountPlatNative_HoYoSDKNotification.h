...
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDKNOTIFICATION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C82C160)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDKNOTIFICATION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C82C190)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDKNOTIFICATION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C82BC60)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDKNOTIFICATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C82BC40)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AccountPlatNative_HoYoSDKNotification_TypeDefinitionIndex = 36476;
