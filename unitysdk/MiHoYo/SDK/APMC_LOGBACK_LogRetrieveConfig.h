...
namespace MiHoYo::SDK { class APMC_LOGBACK_LogAttachmentFileMapping; }
...
#define MIHOYO_SDK_APMC_LOGBACK_LOGRETRIEVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16A77210)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int APMC_LOGBACK_LogRetrieveConfig_TypeDefinitionIndex = 46962;
	...
	public:
		...
		::MiHoYo::SDK::APMC_LOGBACK_LogAttachmentFileMapping* attachment_file_mapping; // 0x30
		::System::IntPtr opaque; // 0x38

		::System::Void _ctor()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MIHOYO_SDK_APMC_LOGBACK_LOGRETRIEVECONFIG__CTOR_OFFSET))(this);
		}
	};
}
