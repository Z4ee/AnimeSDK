...
#define MIHOYO_SDK_H5LOGFILTERCONFIG_ISREPORTENABLE_OFFSET UNITYSDK_OFFSET(0x1830F710)
#define MIHOYO_SDK_H5LOGFILTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1830EE60)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int H5logFilterConfig_TypeDefinitionIndex = 7862;
