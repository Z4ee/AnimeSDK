...
#define MIHOYO_SDK_WEB_ONWEBVIEWPAGEERROR_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18DDFF80)
#define MIHOYO_SDK_WEB_ONWEBVIEWPAGEERROR_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18DE0020)
#define MIHOYO_SDK_WEB_ONWEBVIEWPAGEERROR_INVOKE_OFFSET UNITYSDK_OFFSET(0x18DDF8D0)
#define MIHOYO_SDK_WEB_ONWEBVIEWPAGEERROR__CTOR_OFFSET UNITYSDK_OFFSET(0x18DDF8C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int Web_OnWebViewPageError_TypeDefinitionIndex = 19081;
