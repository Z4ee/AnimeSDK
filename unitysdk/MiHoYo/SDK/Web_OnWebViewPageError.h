...
#define MIHOYO_SDK_WEB_ONWEBVIEWPAGEERROR_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x160400F0)
#define MIHOYO_SDK_WEB_ONWEBVIEWPAGEERROR_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16040170)
#define MIHOYO_SDK_WEB_ONWEBVIEWPAGEERROR_INVOKE_OFFSET UNITYSDK_OFFSET(0x160394D0)
#define MIHOYO_SDK_WEB_ONWEBVIEWPAGEERROR__CTOR_OFFSET UNITYSDK_OFFSET(0x160400D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int Web_OnWebViewPageError_TypeDefinitionIndex = 7211;
