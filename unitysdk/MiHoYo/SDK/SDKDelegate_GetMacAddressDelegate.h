...
#define MIHOYO_SDK_SDKDELEGATE_GETMACADDRESSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B9AA810)
#define MIHOYO_SDK_SDKDELEGATE_GETMACADDRESSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B9AA840)
#define MIHOYO_SDK_SDKDELEGATE_GETMACADDRESSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B9AA800)
#define MIHOYO_SDK_SDKDELEGATE_GETMACADDRESSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9AA790)
