...
#define MIHOYO_SDK_WEBDELEGATE_CALLJSPUBLISHFUNCTIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AA5BE20)
#define MIHOYO_SDK_WEBDELEGATE_CALLJSPUBLISHFUNCTIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AA5BED0)
#define MIHOYO_SDK_WEBDELEGATE_CALLJSPUBLISHFUNCTIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AA5B780)
#define MIHOYO_SDK_WEBDELEGATE_CALLJSPUBLISHFUNCTIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA5B770)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_CallJSPublishFunctionDelegate_TypeDefinitionIndex = 18713;
