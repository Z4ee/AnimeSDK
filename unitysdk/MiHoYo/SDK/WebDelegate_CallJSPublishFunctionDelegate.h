...
#define MIHOYO_SDK_WEBDELEGATE_CALLJSPUBLISHFUNCTIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BB13FA0)
#define MIHOYO_SDK_WEBDELEGATE_CALLJSPUBLISHFUNCTIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BB14010)
#define MIHOYO_SDK_WEBDELEGATE_CALLJSPUBLISHFUNCTIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BB12B60)
#define MIHOYO_SDK_WEBDELEGATE_CALLJSPUBLISHFUNCTIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB13EB0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_CallJSPublishFunctionDelegate_TypeDefinitionIndex = 7801;
