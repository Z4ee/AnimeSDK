...
#define MIHOYO_SDK_MIHOYOCLOUD_MIHOYOSDKDLL___C__DISPLAYCLASS27_0__CTOR_OFFSET UNITYSDK_OFFSET(0x199142B0)
#define MIHOYO_SDK_MIHOYOCLOUD_MIHOYOSDKDLL___C__DISPLAYCLASS27_0__INVOKERETURN_B__0_OFFSET UNITYSDK_OFFSET(0x199169A0)

namespace MiHoYo::SDK::MiHoYoCloud
{
	inline static constexpr unsigned int MiHoYoSDKDll___c__DisplayClass27_0_TypeDefinitionIndex = 8798;
