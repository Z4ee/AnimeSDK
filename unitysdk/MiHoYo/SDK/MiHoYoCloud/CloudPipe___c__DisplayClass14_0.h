...
#define MIHOYO_SDK_MIHOYOCLOUD_CLOUDPIPE___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9972C0)
#define MIHOYO_SDK_MIHOYOCLOUD_CLOUDPIPE___C__DISPLAYCLASS14_0__ONGETRESPONSE_B__0_OFFSET UNITYSDK_OFFSET(0x1A9972D0)
#define MIHOYO_SDK_MIHOYOCLOUD_CLOUDPIPE___C__DISPLAYCLASS14_0__ONGETRESPONSE_B__1_OFFSET UNITYSDK_OFFSET(0x1A997360)
#define MIHOYO_SDK_MIHOYOCLOUD_CLOUDPIPE___C__DISPLAYCLASS14_0__ONGETRESPONSE_B__2_OFFSET UNITYSDK_OFFSET(0x1A9973A0)
#define MIHOYO_SDK_MIHOYOCLOUD_CLOUDPIPE___C__DISPLAYCLASS14_0__ONGETRESPONSE_B__3_OFFSET UNITYSDK_OFFSET(0x1A9973E0)

namespace MiHoYo::SDK::MiHoYoCloud
{
	inline static constexpr unsigned int CloudPipe___c__DisplayClass14_0_TypeDefinitionIndex = 20884;
