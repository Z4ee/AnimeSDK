...
#define MIHOYO_SDK_WEBDELEGATE_SETBACKBUTTONACTIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D4BB460)
#define MIHOYO_SDK_WEBDELEGATE_SETBACKBUTTONACTIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D4BB4A0)
#define MIHOYO_SDK_WEBDELEGATE_SETBACKBUTTONACTIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D4BAED0)
#define MIHOYO_SDK_WEBDELEGATE_SETBACKBUTTONACTIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4BAEB0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetBackButtonActionDelegate_TypeDefinitionIndex = 19942;
