...
#define MIHOYO_SDK_WEBDELEGATE_SETBACKBUTTONACTIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A080E70)
#define MIHOYO_SDK_WEBDELEGATE_SETBACKBUTTONACTIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A080EB0)
#define MIHOYO_SDK_WEBDELEGATE_SETBACKBUTTONACTIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A0808F0)
#define MIHOYO_SDK_WEBDELEGATE_SETBACKBUTTONACTIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0808E0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetBackButtonActionDelegate_TypeDefinitionIndex = 18699;
