...
#define MIHOYO_SDK_WATERMARKDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1768F420)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WatermarkDefine_TypeDefinitionIndex = 6649;
