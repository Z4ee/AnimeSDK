...
#define MIHOYO_SDK_WATERMARKDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C8CBA0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WatermarkDefine_TypeDefinitionIndex = 18471;
