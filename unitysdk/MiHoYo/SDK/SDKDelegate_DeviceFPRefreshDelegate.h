...
#define MIHOYO_SDK_SDKDELEGATE_DEVICEFPREFRESHDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B9AA110)
#define MIHOYO_SDK_SDKDELEGATE_DEVICEFPREFRESHDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B9AA140)
#define MIHOYO_SDK_SDKDELEGATE_DEVICEFPREFRESHDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B9AA100)
#define MIHOYO_SDK_SDKDELEGATE_DEVICEFPREFRESHDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9AA090)
