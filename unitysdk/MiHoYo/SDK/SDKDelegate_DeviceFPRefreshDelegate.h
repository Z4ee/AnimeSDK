...
#define MIHOYO_SDK_SDKDELEGATE_DEVICEFPREFRESHDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1711E850)
#define MIHOYO_SDK_SDKDELEGATE_DEVICEFPREFRESHDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1711E880)
#define MIHOYO_SDK_SDKDELEGATE_DEVICEFPREFRESHDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1711E840)
#define MIHOYO_SDK_SDKDELEGATE_DEVICEFPREFRESHDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1711E7D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_DeviceFPRefreshDelegate_TypeDefinitionIndex = 7727;
