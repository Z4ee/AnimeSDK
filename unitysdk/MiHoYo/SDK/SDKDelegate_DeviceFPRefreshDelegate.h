...
#define MIHOYO_SDK_SDKDELEGATE_DEVICEFPREFRESHDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D3C80F0)
#define MIHOYO_SDK_SDKDELEGATE_DEVICEFPREFRESHDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D3C8120)
#define MIHOYO_SDK_SDKDELEGATE_DEVICEFPREFRESHDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D3C7BD0)
#define MIHOYO_SDK_SDKDELEGATE_DEVICEFPREFRESHDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3C7BB0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_DeviceFPRefreshDelegate_TypeDefinitionIndex = 19882;
