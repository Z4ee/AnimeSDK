...
#define MIHOYO_SDK_CONSOLEDELEGATE_REGISTERFRIENDINVITATIONNOTIFYDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C569B50)
#define MIHOYO_SDK_CONSOLEDELEGATE_REGISTERFRIENDINVITATIONNOTIFYDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C569B80)
#define MIHOYO_SDK_CONSOLEDELEGATE_REGISTERFRIENDINVITATIONNOTIFYDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C569650)
#define MIHOYO_SDK_CONSOLEDELEGATE_REGISTERFRIENDINVITATIONNOTIFYDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C569630)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_RegisterFriendInvitationNotifyDelegate_TypeDefinitionIndex = 19441;
