...
#define MIHOYO_SDK_THIRDPARTYINFOMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1765DC30)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ThirdPartyInfoModel_TypeDefinitionIndex = 6909;
