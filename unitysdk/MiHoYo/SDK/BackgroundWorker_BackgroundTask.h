...
#define MIHOYO_SDK_BACKGROUNDWORKER_BACKGROUNDTASK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C82DA90)
#define MIHOYO_SDK_BACKGROUNDWORKER_BACKGROUNDTASK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C82DAC0)
#define MIHOYO_SDK_BACKGROUNDWORKER_BACKGROUNDTASK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C82D590)
#define MIHOYO_SDK_BACKGROUNDWORKER_BACKGROUNDTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C82D570)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int BackgroundWorker_BackgroundTask_TypeDefinitionIndex = 36667;
