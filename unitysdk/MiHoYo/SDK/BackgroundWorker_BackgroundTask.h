...
#define MIHOYO_SDK_BACKGROUNDWORKER_BACKGROUNDTASK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x84BFEF0)
#define MIHOYO_SDK_BACKGROUNDWORKER_BACKGROUNDTASK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x84BFF20)
#define MIHOYO_SDK_BACKGROUNDWORKER_BACKGROUNDTASK_INVOKE_OFFSET UNITYSDK_OFFSET(0x84BF9A0)
#define MIHOYO_SDK_BACKGROUNDWORKER_BACKGROUNDTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x84BF980)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int BackgroundWorker_BackgroundTask_TypeDefinitionIndex = 37042;
