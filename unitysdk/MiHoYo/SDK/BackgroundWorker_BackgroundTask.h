...
#define MIHOYO_SDK_BACKGROUNDWORKER_BACKGROUNDTASK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15368D10)
#define MIHOYO_SDK_BACKGROUNDWORKER_BACKGROUNDTASK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15368D40)
#define MIHOYO_SDK_BACKGROUNDWORKER_BACKGROUNDTASK_INVOKE_OFFSET UNITYSDK_OFFSET(0x15368D00)
#define MIHOYO_SDK_BACKGROUNDWORKER_BACKGROUNDTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x15368C10)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int BackgroundWorker_BackgroundTask_TypeDefinitionIndex = 44552;
