...
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_CLASS_3_BBFFA3EDA51FCB23_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8D3B790)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_CLASS_3_BBFFA3EDA51FCB23_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8D3B800)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_CLASS_3_BBFFA3EDA51FCB23_INVOKE_OFFSET UNITYSDK_OFFSET(0x8D3B420)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_CLASS_3_BBFFA3EDA51FCB23__CTOR_OFFSET UNITYSDK_OFFSET(0x8D3B3B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKBiliBiliInterface_Class_3_BBFFA3EDA51FCB23_TypeDefinitionIndex = 42907;
