...
#define MIHOYO_SDK_TOOLTIP___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16002AF0)
#define MIHOYO_SDK_TOOLTIP___C__DISPLAYCLASS12_0__SHOW_B__0_OFFSET UNITYSDK_OFFSET(0x16002B50)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int Tooltip___c__DisplayClass12_0_TypeDefinitionIndex = 7012;
