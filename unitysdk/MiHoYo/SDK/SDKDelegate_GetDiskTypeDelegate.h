...
#define MIHOYO_SDK_SDKDELEGATE_GETDISKTYPEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19FEBA20)
#define MIHOYO_SDK_SDKDELEGATE_GETDISKTYPEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19FEBA50)
#define MIHOYO_SDK_SDKDELEGATE_GETDISKTYPEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19FEB4E0)
#define MIHOYO_SDK_SDKDELEGATE_GETDISKTYPEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19FEB4D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_GetDiskTypeDelegate_TypeDefinitionIndex = 18670;
