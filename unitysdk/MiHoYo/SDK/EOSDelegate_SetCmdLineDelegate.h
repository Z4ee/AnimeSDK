...
#define MIHOYO_SDK_EOSDELEGATE_SETCMDLINEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15EDF4D0)
#define MIHOYO_SDK_EOSDELEGATE_SETCMDLINEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15EDF500)
#define MIHOYO_SDK_EOSDELEGATE_SETCMDLINEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15EDEF70)
#define MIHOYO_SDK_EOSDELEGATE_SETCMDLINEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15EDEF50)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int EOSDelegate_SetCmdLineDelegate_TypeDefinitionIndex = 6722;
