...
#define MIHOYO_SDK_EOSDELEGATE_SETCMDLINEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AE73920)
#define MIHOYO_SDK_EOSDELEGATE_SETCMDLINEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AE73950)
#define MIHOYO_SDK_EOSDELEGATE_SETCMDLINEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AE73910)
#define MIHOYO_SDK_EOSDELEGATE_SETCMDLINEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE73820)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int EOSDelegate_SetCmdLineDelegate_TypeDefinitionIndex = 7673;
