...
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOFINALIZEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18DB8ED0)
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOFINALIZEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18DB8F00)
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOFINALIZEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18DB8C30)
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOFINALIZEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18DB8C20)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_PlayGoFinalizeDelegate_TypeDefinitionIndex = 18535;
