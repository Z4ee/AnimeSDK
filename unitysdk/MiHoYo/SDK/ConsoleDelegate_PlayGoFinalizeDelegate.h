...
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOFINALIZEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BDCA310)
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOFINALIZEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BDCA340)
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOFINALIZEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BDCA080)
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOFINALIZEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDCA060)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_PlayGoFinalizeDelegate_TypeDefinitionIndex = 19766;
