...
#define MIHOYO_SDK_TELEMETRYINTERFACE___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABC2AC0)
#define MIHOYO_SDK_TELEMETRYINTERFACE___C__DISPLAYCLASS6_0__DESTORY_B__0_OFFSET UNITYSDK_OFFSET(0x1ABC4470)
#define MIHOYO_SDK_TELEMETRYINTERFACE___C__DISPLAYCLASS6_0__DESTORY_B__1_OFFSET UNITYSDK_OFFSET(0x1ABC4630)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int TelemetryInterface___c__DisplayClass6_0_TypeDefinitionIndex = 44808;
