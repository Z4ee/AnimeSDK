...
#define MIHOYO_SDK_WEB_ONWEBVIEWPOPUPBROWSERCREATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x176A4B10)
#define MIHOYO_SDK_WEB_ONWEBVIEWPOPUPBROWSERCREATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x176A4B50)
#define MIHOYO_SDK_WEB_ONWEBVIEWPOPUPBROWSERCREATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1769E480)
#define MIHOYO_SDK_WEB_ONWEBVIEWPOPUPBROWSERCREATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176A4AF0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int Web_OnWebViewPopupBrowserCreate_TypeDefinitionIndex = 7260;
