...
#define MIHOYO_SDK_WEB_ONWEBVIEWPOPUPBROWSERCREATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CD1C730)
#define MIHOYO_SDK_WEB_ONWEBVIEWPOPUPBROWSERCREATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CD1C770)
#define MIHOYO_SDK_WEB_ONWEBVIEWPOPUPBROWSERCREATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CD1B520)
#define MIHOYO_SDK_WEB_ONWEBVIEWPOPUPBROWSERCREATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD1C710)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int Web_OnWebViewPopupBrowserCreate_TypeDefinitionIndex = 20333;
