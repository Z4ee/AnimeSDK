...
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGEFINISH_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19B61000)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGEFINISH_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19B61030)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGEFINISH_INVOKE_OFFSET UNITYSDK_OFFSET(0x19B60B00)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGEFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x19B60AF0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_OnWebViewPageFinish_TypeDefinitionIndex = 18684;
