...
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGEFINISH_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x160411D0)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGEFINISH_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16041200)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGEFINISH_INVOKE_OFFSET UNITYSDK_OFFSET(0x1602DD60)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGEFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x160411B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_OnWebViewPageFinish_TypeDefinitionIndex = 6820;
