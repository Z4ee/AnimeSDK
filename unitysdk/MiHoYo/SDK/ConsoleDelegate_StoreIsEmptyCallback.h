...
#define MIHOYO_SDK_CONSOLEDELEGATE_STOREISEMPTYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CF31590)
#define MIHOYO_SDK_CONSOLEDELEGATE_STOREISEMPTYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CF31620)
#define MIHOYO_SDK_CONSOLEDELEGATE_STOREISEMPTYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CF31280)
#define MIHOYO_SDK_CONSOLEDELEGATE_STOREISEMPTYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF31260)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_StoreIsEmptyCallback_TypeDefinitionIndex = 19716;
