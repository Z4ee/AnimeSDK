...
#define MIHOYO_SDK_CONSOLEDELEGATE_SHOWSESSIONINVITEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19C77D70)
#define MIHOYO_SDK_CONSOLEDELEGATE_SHOWSESSIONINVITEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19C77DA0)
#define MIHOYO_SDK_CONSOLEDELEGATE_SHOWSESSIONINVITEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C72210)
#define MIHOYO_SDK_CONSOLEDELEGATE_SHOWSESSIONINVITEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C77D60)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_ShowSessionInviteDelegate_TypeDefinitionIndex = 18503;
