...
#define MIHOYO_SDK_CONSOLEDELEGATE_SHOWSESSIONINVITEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15ED6800)
#define MIHOYO_SDK_CONSOLEDELEGATE_SHOWSESSIONINVITEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15ED6830)
#define MIHOYO_SDK_CONSOLEDELEGATE_SHOWSESSIONINVITEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15ED62A0)
#define MIHOYO_SDK_CONSOLEDELEGATE_SHOWSESSIONINVITEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15ED6280)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_ShowSessionInviteDelegate_TypeDefinitionIndex = 6647;
