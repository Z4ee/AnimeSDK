...
#define MIHOYO_SDK_SDKDELEGATE_ONGYROEVENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CE19C70)
#define MIHOYO_SDK_SDKDELEGATE_ONGYROEVENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CE19CF0)
#define MIHOYO_SDK_SDKDELEGATE_ONGYROEVENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CE19960)
#define MIHOYO_SDK_SDKDELEGATE_ONGYROEVENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE19940)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_OnGyroEventDelegate_TypeDefinitionIndex = 19905;
