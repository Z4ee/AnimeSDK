...
#define MIHOYO_SDK_GOOGLEPLAYABTESTCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C38F4C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int GooglePlayAbTestConfigs_TypeDefinitionIndex = 19664;
