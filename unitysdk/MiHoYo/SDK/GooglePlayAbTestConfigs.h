...
#define MIHOYO_SDK_GOOGLEPLAYABTESTCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7674E0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int GooglePlayAbTestConfigs_TypeDefinitionIndex = 20012;
