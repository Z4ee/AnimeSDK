...
#define MIHOYO_SDK_GOOGLEPLAYABTESTCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x17526520)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int GooglePlayAbTestConfigs_TypeDefinitionIndex = 6946;
