...
#define MIHOYO_SDK_HOYOCHANNELINTERFACE___C__DISPLAYCLASS48_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1DBE1C60)
#define MIHOYO_SDK_HOYOCHANNELINTERFACE___C__DISPLAYCLASS48_0__ONPRODUCTSCALLBACK_B__0_OFFSET UNITYSDK_OFFSET(0x1DBE1C70)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoChannelInterface___c__DisplayClass48_0_TypeDefinitionIndex = 37574;
