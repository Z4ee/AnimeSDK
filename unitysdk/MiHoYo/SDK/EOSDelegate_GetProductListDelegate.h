...
#define MIHOYO_SDK_EOSDELEGATE_GETPRODUCTLISTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1830D790)
#define MIHOYO_SDK_EOSDELEGATE_GETPRODUCTLISTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1830D7D0)
#define MIHOYO_SDK_EOSDELEGATE_GETPRODUCTLISTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1830D770)
#define MIHOYO_SDK_EOSDELEGATE_GETPRODUCTLISTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1830D680)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int EOSDelegate_GetProductListDelegate_TypeDefinitionIndex = 7662;
