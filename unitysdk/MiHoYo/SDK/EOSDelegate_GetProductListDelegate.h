...
#define MIHOYO_SDK_EOSDELEGATE_GETPRODUCTLISTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C0D8AC0)
#define MIHOYO_SDK_EOSDELEGATE_GETPRODUCTLISTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C0D8B00)
#define MIHOYO_SDK_EOSDELEGATE_GETPRODUCTLISTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C0D84A0)
#define MIHOYO_SDK_EOSDELEGATE_GETPRODUCTLISTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0D8480)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int EOSDelegate_GetProductListDelegate_TypeDefinitionIndex = 19476;
