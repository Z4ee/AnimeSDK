...
#define MIHOYO_SDK_LOGINRECORDBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCFF6F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int LoginRecordBoxConfig_TypeDefinitionIndex = 20034;
