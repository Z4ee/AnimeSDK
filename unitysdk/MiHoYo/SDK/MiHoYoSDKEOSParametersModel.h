...
#define MIHOYO_SDK_MIHOYOSDKEOSPARAMETERSMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD1E3D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKEOSParametersModel_TypeDefinitionIndex = 44625;
