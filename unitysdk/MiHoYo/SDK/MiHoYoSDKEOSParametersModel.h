...
#define MIHOYO_SDK_MIHOYOSDKEOSPARAMETERSMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D285D90)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKEOSParametersModel_TypeDefinitionIndex = 36738;
