...
#define MIHOYO_SDK_WEBDELEGATE_HIDEBGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x176A5570)
#define MIHOYO_SDK_WEBDELEGATE_HIDEBGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x176A55D0)
#define MIHOYO_SDK_WEBDELEGATE_HIDEBGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1769EFD0)
#define MIHOYO_SDK_WEBDELEGATE_HIDEBGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176A5550)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_HideBGDelegate_TypeDefinitionIndex = 6889;
