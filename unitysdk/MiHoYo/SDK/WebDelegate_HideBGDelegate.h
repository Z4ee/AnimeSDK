...
#define MIHOYO_SDK_WEBDELEGATE_HIDEBGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CE211A0)
#define MIHOYO_SDK_WEBDELEGATE_HIDEBGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CE21220)
#define MIHOYO_SDK_WEBDELEGATE_HIDEBGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CE20B90)
#define MIHOYO_SDK_WEBDELEGATE_HIDEBGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE20B70)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_HideBGDelegate_TypeDefinitionIndex = 19954;
