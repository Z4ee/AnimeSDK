...
#define MIHOYO_SDK_WEBDELEGATE_HIDEBGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18464230)
#define MIHOYO_SDK_WEBDELEGATE_HIDEBGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18464290)
#define MIHOYO_SDK_WEBDELEGATE_HIDEBGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18462600)
#define MIHOYO_SDK_WEBDELEGATE_HIDEBGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18464140)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_HideBGDelegate_TypeDefinitionIndex = 7792;
