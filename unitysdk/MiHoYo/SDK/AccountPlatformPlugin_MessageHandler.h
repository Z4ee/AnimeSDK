...
#define MIHOYO_SDK_ACCOUNTPLATFORMPLUGIN_MESSAGEHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C920670)
#define MIHOYO_SDK_ACCOUNTPLATFORMPLUGIN_MESSAGEHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C9206A0)
#define MIHOYO_SDK_ACCOUNTPLATFORMPLUGIN_MESSAGEHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C920150)
#define MIHOYO_SDK_ACCOUNTPLATFORMPLUGIN_MESSAGEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C920130)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AccountPlatformPlugin_MessageHandler_TypeDefinitionIndex = 20080;
