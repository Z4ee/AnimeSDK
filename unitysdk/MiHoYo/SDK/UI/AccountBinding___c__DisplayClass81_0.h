...
#define MIHOYO_SDK_UI_ACCOUNTBINDING___C__DISPLAYCLASS81_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19CAF100)
#define MIHOYO_SDK_UI_ACCOUNTBINDING___C__DISPLAYCLASS81_0__SHOW_B__0_OFFSET UNITYSDK_OFFSET(0x19CAF110)

namespace MiHoYo::SDK::UI
{
	inline static constexpr unsigned int AccountBinding___c__DisplayClass81_0_TypeDefinitionIndex = 19226;
