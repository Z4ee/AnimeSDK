...
#define MIHOYO_SDK_UI_CHANNELPROTOCOLDIALOG_ACCEPT_OFFSET UNITYSDK_OFFSET(0x1BDFCC00)
#define MIHOYO_SDK_UI_CHANNELPROTOCOLDIALOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x1BDFB450)
#define MIHOYO_SDK_UI_CHANNELPROTOCOLDIALOG_CANCEL_OFFSET UNITYSDK_OFFSET(0x1BDFCBE0)
#define MIHOYO_SDK_UI_CHANNELPROTOCOLDIALOG_CLOSE_OFFSET UNITYSDK_OFFSET(0x1BDFCB60)
#define MIHOYO_SDK_UI_CHANNELPROTOCOLDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x1BDFCD00)
#define MIHOYO_SDK_UI_CHANNELPROTOCOLDIALOG_ONAGREEMENTCHECKBOXTOGGLECLICKED_OFFSET UNITYSDK_OFFSET(0x1BDFCBC0)
#define MIHOYO_SDK_UI_CHANNELPROTOCOLDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x1BDFCC20)
#define MIHOYO_SDK_UI_CHANNELPROTOCOLDIALOG_VIEWPRIVACYPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1BDFCBA0)
#define MIHOYO_SDK_UI_CHANNELPROTOCOLDIALOG_VIEWUSERAGREEMENT_OFFSET UNITYSDK_OFFSET(0x1BDFCB80)
#define MIHOYO_SDK_UI_CHANNELPROTOCOLDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDFCD70)

namespace MiHoYo::SDK::UI
{
	inline static constexpr unsigned int ChannelProtocolDialog_TypeDefinitionIndex = 20502;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::UI::ChannelProtocolDialog**)Il2CppClass::FromTypeDefinitionIndex(ChannelProtocolDialog_TypeDefinitionIndex)->GetStaticField(0x9630);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean))((::PBYTE)hIl2Cpp + MIHOYO_SDK_UI_CHANNELPROTOCOLDIALOG_ONAGREEMENTCHECKBOXTOGGLECLICKED_OFFSET))(this, isOn);
		}
		...
		static ::System::Void Show(::MiHoYo::SDK::UI::OS::ChannelProtocolDisplayType protocolDisplayType)
		{
			return ((::System::Void(*)(::MiHoYo::SDK::UI::OS::ChannelProtocolDisplayType))((::PBYTE)hIl2Cpp + MIHOYO_SDK_UI_CHANNELPROTOCOLDIALOG_SHOW_OFFSET))(protocolDisplayType);
		}
