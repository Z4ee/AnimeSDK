...
#define MIHOYO_SDK_UI_CHANNELPROTOCOLDIALOG_ACCEPT_OFFSET UNITYSDK_OFFSET(0x1A9C62E0)
#define MIHOYO_SDK_UI_CHANNELPROTOCOLDIALOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A9C4B30)
#define MIHOYO_SDK_UI_CHANNELPROTOCOLDIALOG_CANCEL_OFFSET UNITYSDK_OFFSET(0x1A9C62C0)
#define MIHOYO_SDK_UI_CHANNELPROTOCOLDIALOG_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A9C6240)
#define MIHOYO_SDK_UI_CHANNELPROTOCOLDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x1A9C63E0)
#define MIHOYO_SDK_UI_CHANNELPROTOCOLDIALOG_ONAGREEMENTCHECKBOXTOGGLECLICKED_OFFSET UNITYSDK_OFFSET(0x1A9C62A0)
#define MIHOYO_SDK_UI_CHANNELPROTOCOLDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x1A9C6300)
#define MIHOYO_SDK_UI_CHANNELPROTOCOLDIALOG_VIEWPRIVACYPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1A9C6280)
#define MIHOYO_SDK_UI_CHANNELPROTOCOLDIALOG_VIEWUSERAGREEMENT_OFFSET UNITYSDK_OFFSET(0x1A9C6260)
#define MIHOYO_SDK_UI_CHANNELPROTOCOLDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9C6450)

namespace MiHoYo::SDK::UI
{
	inline static constexpr unsigned int ChannelProtocolDialog_TypeDefinitionIndex = 20154;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::UI::ChannelProtocolDialog**)Il2CppClass::FromTypeDefinitionIndex(ChannelProtocolDialog_TypeDefinitionIndex)->GetStaticField(0x95F0);
		}
