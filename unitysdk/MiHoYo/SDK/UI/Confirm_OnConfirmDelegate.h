...
#define MIHOYO_SDK_UI_CONFIRM_ONCONFIRMDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19C8C730)
#define MIHOYO_SDK_UI_CONFIRM_ONCONFIRMDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19C8C7A0)
#define MIHOYO_SDK_UI_CONFIRM_ONCONFIRMDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C8C440)
#define MIHOYO_SDK_UI_CONFIRM_ONCONFIRMDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C8C430)

namespace MiHoYo::SDK::UI
{
	inline static constexpr unsigned int Confirm_OnConfirmDelegate_TypeDefinitionIndex = 19251;
