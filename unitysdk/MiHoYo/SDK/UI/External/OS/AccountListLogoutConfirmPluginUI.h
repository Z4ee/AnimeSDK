...
#define MIHOYO_SDK_UI_EXTERNAL_OS_ACCOUNTLISTLOGOUTCONFIRMPLUGINUI_GET_ONACCOUNTLISTLOGOUTCANCEL_OFFSET UNITYSDK_OFFSET(0x1766E400)
#define MIHOYO_SDK_UI_EXTERNAL_OS_ACCOUNTLISTLOGOUTCONFIRMPLUGINUI_GET_ONACCOUNTLISTLOGOUTCONFIRM_OFFSET UNITYSDK_OFFSET(0x1766E3E0)
#define MIHOYO_SDK_UI_EXTERNAL_OS_ACCOUNTLISTLOGOUTCONFIRMPLUGINUI_HIDE_OFFSET UNITYSDK_OFFSET(0x1766E420)
#define MIHOYO_SDK_UI_EXTERNAL_OS_ACCOUNTLISTLOGOUTCONFIRMPLUGINUI_SET_ONACCOUNTLISTLOGOUTCANCEL_OFFSET UNITYSDK_OFFSET(0x1766E410)
#define MIHOYO_SDK_UI_EXTERNAL_OS_ACCOUNTLISTLOGOUTCONFIRMPLUGINUI_SET_ONACCOUNTLISTLOGOUTCONFIRM_OFFSET UNITYSDK_OFFSET(0x1766E3F0)
#define MIHOYO_SDK_UI_EXTERNAL_OS_ACCOUNTLISTLOGOUTCONFIRMPLUGINUI_SHOW_OFFSET UNITYSDK_OFFSET(0x1766E520)
#define MIHOYO_SDK_UI_EXTERNAL_OS_ACCOUNTLISTLOGOUTCONFIRMPLUGINUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1766E780)
#define MIHOYO_SDK_UI_EXTERNAL_OS_ACCOUNTLISTLOGOUTCONFIRMPLUGINUI__SHOW_B__9_0_OFFSET UNITYSDK_OFFSET(0x1766E790)
#define MIHOYO_SDK_UI_EXTERNAL_OS_ACCOUNTLISTLOGOUTCONFIRMPLUGINUI__SHOW_B__9_1_OFFSET UNITYSDK_OFFSET(0x1766E7C0)

namespace MiHoYo::SDK::UI::External::OS
{
	inline static constexpr unsigned int AccountListLogoutConfirmPluginUI_TypeDefinitionIndex = 7434;
