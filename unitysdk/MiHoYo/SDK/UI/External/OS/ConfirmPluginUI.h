...
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI_GET_ONCANCELBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1CE1A680)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI_GET_ONCONFIRMBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1CE1A6A0)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI_HIDEPLUGINUI_OFFSET UNITYSDK_OFFSET(0x1CE1AA90)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI_HIDE_OFFSET UNITYSDK_OFFSET(0x1CE1AB40)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI_SET_ONCANCELBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1CE1A690)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI_SET_ONCONFIRMBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1CE1A6B0)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI_SHOWPLUGINUI_OFFSET UNITYSDK_OFFSET(0x1CE1A6C0)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI_SHOW_OFFSET UNITYSDK_OFFSET(0x1CE1AB30)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE1AB50)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI__SHOWPLUGINUI_B__8_0_OFFSET UNITYSDK_OFFSET(0x1CE1AB60)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI__SHOWPLUGINUI_B__8_1_OFFSET UNITYSDK_OFFSET(0x1CE1AB80)

namespace MiHoYo::SDK::UI::External::OS
{
	inline static constexpr unsigned int ConfirmPluginUI_TypeDefinitionIndex = 20517;
