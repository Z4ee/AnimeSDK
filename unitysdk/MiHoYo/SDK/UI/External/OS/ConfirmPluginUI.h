...
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI_GET_ONCANCELBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1600D0C0)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI_GET_ONCONFIRMBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1600D0E0)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI_HIDEPLUGINUI_OFFSET UNITYSDK_OFFSET(0x1600D4A0)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI_HIDE_OFFSET UNITYSDK_OFFSET(0x1600D550)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI_SET_ONCANCELBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1600D0D0)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI_SET_ONCONFIRMBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1600D0F0)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI_SHOWPLUGINUI_OFFSET UNITYSDK_OFFSET(0x1600D100)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI_SHOW_OFFSET UNITYSDK_OFFSET(0x1600D540)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1600D560)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI__SHOWPLUGINUI_B__8_0_OFFSET UNITYSDK_OFFSET(0x1600D570)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI__SHOWPLUGINUI_B__8_1_OFFSET UNITYSDK_OFFSET(0x1600D590)

namespace MiHoYo::SDK::UI::External::OS
{
	inline static constexpr unsigned int ConfirmPluginUI_TypeDefinitionIndex = 7360;
