...
#define MIHOYO_SDK_UI_EXTERNAL_OS_ALERTPLUGINUI_GET_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1BF7F9C0)
#define MIHOYO_SDK_UI_EXTERNAL_OS_ALERTPLUGINUI_GET_ONCONFIRMBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1BF7F9E0)
#define MIHOYO_SDK_UI_EXTERNAL_OS_ALERTPLUGINUI_HIDEPLUGINUI_OFFSET UNITYSDK_OFFSET(0x1BF7FDC0)
#define MIHOYO_SDK_UI_EXTERNAL_OS_ALERTPLUGINUI_HIDE_OFFSET UNITYSDK_OFFSET(0x1BF7FED0)
#define MIHOYO_SDK_UI_EXTERNAL_OS_ALERTPLUGINUI_SET_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1BF7F9D0)
#define MIHOYO_SDK_UI_EXTERNAL_OS_ALERTPLUGINUI_SET_ONCONFIRMBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1BF7F9F0)
#define MIHOYO_SDK_UI_EXTERNAL_OS_ALERTPLUGINUI_SHOWPLUGINUI_OFFSET UNITYSDK_OFFSET(0x1BF7FA00)
#define MIHOYO_SDK_UI_EXTERNAL_OS_ALERTPLUGINUI_SHOW_OFFSET UNITYSDK_OFFSET(0x1BF7FEC0)
#define MIHOYO_SDK_UI_EXTERNAL_OS_ALERTPLUGINUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF7FEE0)
#define MIHOYO_SDK_UI_EXTERNAL_OS_ALERTPLUGINUI__SHOWPLUGINUI_B__8_0_OFFSET UNITYSDK_OFFSET(0x1BF7FEF0)
#define MIHOYO_SDK_UI_EXTERNAL_OS_ALERTPLUGINUI__SHOWPLUGINUI_B__8_1_OFFSET UNITYSDK_OFFSET(0x1BF7FF00)

namespace MiHoYo::SDK::UI::External::OS
{
	inline static constexpr unsigned int AlertPluginUI_TypeDefinitionIndex = 20168;
