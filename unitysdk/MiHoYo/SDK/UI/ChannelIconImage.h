...
#define MIHOYO_SDK_UI_CHANNELICONIMAGE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1BAE77C0)
#define MIHOYO_SDK_UI_CHANNELICONIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAE7970)
