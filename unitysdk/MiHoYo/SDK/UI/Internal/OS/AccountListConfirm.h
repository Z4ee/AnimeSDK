...
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTCONFIRM_AWAKE_OFFSET UNITYSDK_OFFSET(0x16012FC0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTCONFIRM_CANCEL_OFFSET UNITYSDK_OFFSET(0x16013EE0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTCONFIRM_CONFIRM_OFFSET UNITYSDK_OFFSET(0x16013EA0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTCONFIRM_HIDE_OFFSET UNITYSDK_OFFSET(0x16013F00)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTCONFIRM_SHOW_OFFSET UNITYSDK_OFFSET(0x16013D70)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTCONFIRM_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x16013B60)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTCONFIRM__CTOR_OFFSET UNITYSDK_OFFSET(0x16013F70)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int AccountListConfirm_TypeDefinitionIndex = 7385;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::UI::Internal::OS::AccountListConfirm**)Il2CppClass::FromTypeDefinitionIndex(AccountListConfirm_TypeDefinitionIndex)->GetStaticField(0x191F0);
		}
