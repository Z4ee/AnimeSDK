...
#define MIHOYO_SDK_UI_INTERNAL_OS_TIPSBAR_GET_ONHIDECOMPLETED_OFFSET UNITYSDK_OFFSET(0x1B538AB0)
#define MIHOYO_SDK_UI_INTERNAL_OS_TIPSBAR_SET_ONHIDECOMPLETED_OFFSET UNITYSDK_OFFSET(0x1B538AC0)
#define MIHOYO_SDK_UI_INTERNAL_OS_TIPSBAR_SHOW_OFFSET UNITYSDK_OFFSET(0x1B538AD0)
#define MIHOYO_SDK_UI_INTERNAL_OS_TIPSBAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B538AE0)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int Tipsbar_TypeDefinitionIndex = 20206;
