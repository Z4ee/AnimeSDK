...
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_GETACCOUNTINPUT_OFFSET UNITYSDK_OFFSET(0x1B6BCA90)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_GET_ONAPPLELOGINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1B6BC9B0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_GET_ONBACKBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1B6BCA50)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_GET_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1B6BCA30)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_GET_ONFACEBOOKLOGINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1B6BC9D0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_GET_ONFORGOTPASSWORDBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1B6BC990)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_GET_ONGOOGLELOGINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1B6BC9F0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_GET_ONGUESTLOGINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1B6BCA70)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_GET_ONLOGINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1B6BC950)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_GET_ONREGISTERBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1B6BC970)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_GET_ONTWITTERLOGINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1B6BCA10)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x1B6BCD20)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x1B6BCD90)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_SET_ONAPPLELOGINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1B6BC9C0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_SET_ONBACKBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1B6BCA60)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_SET_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1B6BCA40)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_SET_ONFACEBOOKLOGINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1B6BC9E0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_SET_ONFORGOTPASSWORDBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1B6BC9A0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_SET_ONGOOGLELOGINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1B6BCA00)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_SET_ONGUESTLOGINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1B6BCA80)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_SET_ONLOGINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1B6BC960)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_SET_ONREGISTERBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1B6BC980)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_SET_ONTWITTERLOGINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1B6BCA20)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x1B6BCB50)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_UPDATEACCOUNTINPUT_OFFSET UNITYSDK_OFFSET(0x1B6BCAD0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_UPDATEPASSWORD_OFFSET UNITYSDK_OFFSET(0x1B6BCB10)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6BCDB0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG__SHOW_B__43_0_OFFSET UNITYSDK_OFFSET(0x1B6BCDC0)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int LoginByAccountDialog_TypeDefinitionIndex = 8365;
	...
	public:
		...
		::System::Action* _OnRegisterBtnClicked_k__BackingField; // 0x50
		::System::Action* _OnBackBtnClicked_k__BackingField; // 0x58
