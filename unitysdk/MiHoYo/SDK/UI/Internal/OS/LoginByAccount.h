...
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_ACCOUNTINPUTCLEARBTNCLICK_OFFSET UNITYSDK_OFFSET(0x1CD69020)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_AWAKE_OFFSET UNITYSDK_OFFSET(0x1CD65460)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_CLICKAPPLEBUTTON_OFFSET UNITYSDK_OFFSET(0x1CD68DC0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_CLICKCLOSEBUTTON_OFFSET UNITYSDK_OFFSET(0x1CD68FC0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_CLICKFACEBOOKBUTTON_OFFSET UNITYSDK_OFFSET(0x1CD68EC0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_CLICKFORGETPASSWORDBUTTON_OFFSET UNITYSDK_OFFSET(0x1CD69000)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_CLICKGOOGLEBUTTON_OFFSET UNITYSDK_OFFSET(0x1CD68E40)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_CLICKLOGINBUTTON_OFFSET UNITYSDK_OFFSET(0x1CD685C0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_CLICKREGISTERBUTTON_OFFSET UNITYSDK_OFFSET(0x1CD68FE0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_CLICKTWITTERBUTTON_OFFSET UNITYSDK_OFFSET(0x1CD68F40)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_DISABLEREGISTER_OFFSET UNITYSDK_OFFSET(0x1CD68310)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_GUESTLOGIN_OFFSET UNITYSDK_OFFSET(0x1CD68D40)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_HIDEPASSWORDDETAILBTNCLICK_OFFSET UNITYSDK_OFFSET(0x1CD69190)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_HIDE_OFFSET UNITYSDK_OFFSET(0x1CD68550)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_ONACCOUNTINPUTVALUECHANGE_OFFSET UNITYSDK_OFFSET(0x1CD69230)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_ONBACKBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x1CD68D10)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1CD694B0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_ONPASSWORDINPUTVALUECHANGE_OFFSET UNITYSDK_OFFSET(0x1CD692B0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_PASSWORDINPUTCLEARBTNCLICK_OFFSET UNITYSDK_OFFSET(0x1CD69050)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_SHOWPASSWORDDETAILBTNCLICK_OFFSET UNITYSDK_OFFSET(0x1CD690F0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_SHOW_OFFSET UNITYSDK_OFFSET(0x1CD683F0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_START_OFFSET UNITYSDK_OFFSET(0x1CD68B70)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_UPDATEBACKBTN_OFFSET UNITYSDK_OFFSET(0x1CD68BA0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_UPDATEBOTTOMCONTENT_OFFSET UNITYSDK_OFFSET(0x1CD671D0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x1CD67E90)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD694D0)
...
namespace MiHoYo::SDK::UI::Internal::OS
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::UI::Internal::OS::LoginByAccount**)Il2CppClass::FromTypeDefinitionIndex(LoginByAccount_TypeDefinitionIndex)->GetStaticField(0x26050);
		}
