...
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDETAILSDIALOG_GET_ONBACK_OFFSET UNITYSDK_OFFSET(0x1A9C6460)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDETAILSDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x1A9C6500)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDETAILSDIALOG_SET_ONBACK_OFFSET UNITYSDK_OFFSET(0x1A9C6470)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDETAILSDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x1A9C6480)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDETAILSDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9C6590)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDETAILSDIALOG__SHOW_B__4_0_OFFSET UNITYSDK_OFFSET(0x1A9C65A0)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int AgeGateParentalConsentDetailsDialog_TypeDefinitionIndex = 20179;
