...
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDETAILSDIALOG_GET_ONBACK_OFFSET UNITYSDK_OFFSET(0x1BDFCD80)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDETAILSDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x1BDFCE20)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDETAILSDIALOG_SET_ONBACK_OFFSET UNITYSDK_OFFSET(0x1BDFCD90)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDETAILSDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x1BDFCDA0)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDETAILSDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDFCEB0)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDETAILSDIALOG__SHOW_B__4_0_OFFSET UNITYSDK_OFFSET(0x1BDFCEC0)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int AgeGateParentalConsentDetailsDialog_TypeDefinitionIndex = 20527;
