...
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTLOGOUTCONFIRMDIALOG_GET_ONACCOUNTLISTLOGOUTCANCEL_OFFSET UNITYSDK_OFFSET(0x1BF7FF30)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTLOGOUTCONFIRMDIALOG_GET_ONACCOUNTLISTLOGOUTCONFIRM_OFFSET UNITYSDK_OFFSET(0x1BF7FF10)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTLOGOUTCONFIRMDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x1BF80010)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTLOGOUTCONFIRMDIALOG_SET_ONACCOUNTLISTLOGOUTCANCEL_OFFSET UNITYSDK_OFFSET(0x1BF7FF40)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTLOGOUTCONFIRMDIALOG_SET_ONACCOUNTLISTLOGOUTCONFIRM_OFFSET UNITYSDK_OFFSET(0x1BF7FF20)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTLOGOUTCONFIRMDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x1BF7FF50)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTLOGOUTCONFIRMDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF80080)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTLOGOUTCONFIRMDIALOG__SHOW_B__8_0_OFFSET UNITYSDK_OFFSET(0x1BF80090)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTLOGOUTCONFIRMDIALOG__SHOW_B__8_1_OFFSET UNITYSDK_OFFSET(0x1BF800F0)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int AccountListLogoutConfirmDialog_TypeDefinitionIndex = 20189;
