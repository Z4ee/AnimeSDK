...
#define MIHOYO_SDK_UI_INTERNAL_OS_ALERTDIALOG_GET_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x16014C20)
#define MIHOYO_SDK_UI_INTERNAL_OS_ALERTDIALOG_GET_ONCONFIRMBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x16014C40)
#define MIHOYO_SDK_UI_INTERNAL_OS_ALERTDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x16014D00)
#define MIHOYO_SDK_UI_INTERNAL_OS_ALERTDIALOG_SET_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x16014C30)
#define MIHOYO_SDK_UI_INTERNAL_OS_ALERTDIALOG_SET_ONCONFIRMBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x16014C50)
#define MIHOYO_SDK_UI_INTERNAL_OS_ALERTDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x16014C60)
#define MIHOYO_SDK_UI_INTERNAL_OS_ALERTDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x16014D60)
#define MIHOYO_SDK_UI_INTERNAL_OS_ALERTDIALOG__SHOW_B__8_0_OFFSET UNITYSDK_OFFSET(0x16014D70)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int AlertDialog_TypeDefinitionIndex = 7391;
