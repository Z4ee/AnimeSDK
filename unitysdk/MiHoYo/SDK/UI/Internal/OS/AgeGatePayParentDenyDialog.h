...
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPAYPARENTDENYDIALOG_GET_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1844BAB0)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPAYPARENTDENYDIALOG_GET_ONSENDBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1844BA90)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPAYPARENTDENYDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x1844BBF0)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPAYPARENTDENYDIALOG_SET_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1844BAC0)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPAYPARENTDENYDIALOG_SET_ONSENDBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1844BAA0)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPAYPARENTDENYDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x1844BAF0)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPAYPARENTDENYDIALOG_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1844BAD0)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPAYPARENTDENYDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1844BC80)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPAYPARENTDENYDIALOG__SHOW_B__9_0_OFFSET UNITYSDK_OFFSET(0x1844BC90)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPAYPARENTDENYDIALOG__SHOW_B__9_1_OFFSET UNITYSDK_OFFSET(0x1844BCB0)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int AgeGatePayParentDenyDialog_TypeDefinitionIndex = 8341;
