...
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPAYPARENTDENYDIALOG_GET_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1767A260)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPAYPARENTDENYDIALOG_GET_ONSENDBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1767A240)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPAYPARENTDENYDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x1767A3C0)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPAYPARENTDENYDIALOG_SET_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1767A270)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPAYPARENTDENYDIALOG_SET_ONSENDBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1767A250)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPAYPARENTDENYDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x1767A2F0)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPAYPARENTDENYDIALOG_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1767A280)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPAYPARENTDENYDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1767A450)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPAYPARENTDENYDIALOG__SHOW_B__9_0_OFFSET UNITYSDK_OFFSET(0x1767A460)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPAYPARENTDENYDIALOG__SHOW_B__9_1_OFFSET UNITYSDK_OFFSET(0x1767A470)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int AgeGatePayParentDenyDialog_TypeDefinitionIndex = 7438;
