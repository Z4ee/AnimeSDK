...
#define MIHOYO_SDK_UI_INTERNAL_OS_CHANNELPROTOCOLDIALOG_GET_ONACCEPTBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x1BA96F30)
#define MIHOYO_SDK_UI_INTERNAL_OS_CHANNELPROTOCOLDIALOG_GET_ONCANCELBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x1BA96F10)
#define MIHOYO_SDK_UI_INTERNAL_OS_CHANNELPROTOCOLDIALOG_GET_ONCLOSEBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x1BA96EB0)
#define MIHOYO_SDK_UI_INTERNAL_OS_CHANNELPROTOCOLDIALOG_GET_ONVIEWPRIVACYPROTOCOLBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x1BA96EF0)
#define MIHOYO_SDK_UI_INTERNAL_OS_CHANNELPROTOCOLDIALOG_GET_ONVIEWUSERAGREEMENTBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x1BA96ED0)
#define MIHOYO_SDK_UI_INTERNAL_OS_CHANNELPROTOCOLDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x1BA96F50)
#define MIHOYO_SDK_UI_INTERNAL_OS_CHANNELPROTOCOLDIALOG_SET_ONACCEPTBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x1BA96F40)
#define MIHOYO_SDK_UI_INTERNAL_OS_CHANNELPROTOCOLDIALOG_SET_ONCANCELBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x1BA96F20)
#define MIHOYO_SDK_UI_INTERNAL_OS_CHANNELPROTOCOLDIALOG_SET_ONCLOSEBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x1BA96EC0)
#define MIHOYO_SDK_UI_INTERNAL_OS_CHANNELPROTOCOLDIALOG_SET_ONVIEWPRIVACYPROTOCOLBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x1BA96F00)
#define MIHOYO_SDK_UI_INTERNAL_OS_CHANNELPROTOCOLDIALOG_SET_ONVIEWUSERAGREEMENTBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x1BA96EE0)
#define MIHOYO_SDK_UI_INTERNAL_OS_CHANNELPROTOCOLDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x1BA96FC0)
#define MIHOYO_SDK_UI_INTERNAL_OS_CHANNELPROTOCOLDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA97070)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int ChannelProtocolDialog_TypeDefinitionIndex = 20185;
	...
	public:
		...
		::System::Action* _OnViewPrivacyProtocolButtonClicked_k__BackingField; // 0x20
		::System::Action* _OnAcceptButtonClicked_k__BackingField; // 0x28
		::System::Action* _OnViewUserAgreementButtonClicked_k__BackingField; // 0x30
