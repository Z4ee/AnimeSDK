...
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTH_AWAKE_OFFSET UNITYSDK_OFFSET(0x1844C2D0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTH_BACK_OFFSET UNITYSDK_OFFSET(0x1844D720)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTH_CHANGEAUTHSTATUS_OFFSET UNITYSDK_OFFSET(0x1844D490)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTH_CLICKBACKBUTTON_OFFSET UNITYSDK_OFFSET(0x1844D4C0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTH_CONTINUEAUTH_OFFSET UNITYSDK_OFFSET(0x1844D980)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTH_FINISHAUTH_OFFSET UNITYSDK_OFFSET(0x1844D860)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTH_HIDE_OFFSET UNITYSDK_OFFSET(0x1844D420)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTH_MEETPROBLEM_OFFSET UNITYSDK_OFFSET(0x1844D670)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTH_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1844DA10)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTH_REAUTH_OFFSET UNITYSDK_OFFSET(0x1844D8F0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTH_SETAUTHSTATUS_OFFSET UNITYSDK_OFFSET(0x1844CFC0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTH_SHOW_OFFSET UNITYSDK_OFFSET(0x1844D250)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTH_SUBMIT_OFFSET UNITYSDK_OFFSET(0x1844D7D0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTH_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x1844CBB0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTH__CLICKBACKBUTTON_B__33_0_OFFSET UNITYSDK_OFFSET(0x1844DA70)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTH__CTOR_OFFSET UNITYSDK_OFFSET(0x1844DA30)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int GooglePCOAuth_TypeDefinitionIndex = 8355;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::UI::Internal::OS::GooglePCOAuth**)Il2CppClass::FromTypeDefinitionIndex(GooglePCOAuth_TypeDefinitionIndex)->GetStaticField(0x23F30);
		}
