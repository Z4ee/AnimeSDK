...
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHDIALOG_GET_ONCANCELBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x17682910)
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHDIALOG_GET_ONRETRYBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x17682930)
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x17682950)
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHDIALOG_SET_ONCANCELBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x17682920)
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHDIALOG_SET_ONRETRYBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x17682940)
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x17682A30)
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHDIALOG_UPDATESTATE_OFFSET UNITYSDK_OFFSET(0x17682BB0)
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x17683A10)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int ThirdPartyOAuthDialog_TypeDefinitionIndex = 7462;
