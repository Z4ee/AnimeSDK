...
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B9EAE80)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_CHECKACCOUNTLISTDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1B9EE640)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_CLOSE_OFFSET UNITYSDK_OFFSET(0x1B9EE7B0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_DELETEACCOUNT_OFFSET UNITYSDK_OFFSET(0x1B9EE2A0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_HIDE_OFFSET UNITYSDK_OFFSET(0x1B9EE120)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_LOADACCOUNTINFODATA_OFFSET UNITYSDK_OFFSET(0x1B9EBFA0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_LOGINOTHERACCOUNT_OFFSET UNITYSDK_OFFSET(0x1B9EE830)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_ONACCOUNTSELECTED_OFFSET UNITYSDK_OFFSET(0x1B9ED850)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_ONCOLLAPSELIST_OFFSET UNITYSDK_OFFSET(0x1B9ED760)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_ONCONFIRMBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x1B9EE7D0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_ONDELETEBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x1B9EE190)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B9EE850)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_ONNOTICEEXPANDDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1B9ED690)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_SHOW_OFFSET UNITYSDK_OFFSET(0x1B9ECBE0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_START_OFFSET UNITYSDK_OFFSET(0x1B9EBC70)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_UPDATEDISPLAYEDACCOUNTLIST_OFFSET UNITYSDK_OFFSET(0x1B9ED5A0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_UPDATEDROPDOWNTITLE_OFFSET UNITYSDK_OFFSET(0x1B9ECD70)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x1B9EBE10)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9EE870)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST__ONDELETEBUTTONCLICKED_B__50_0_OFFSET UNITYSDK_OFFSET(0x1B9EE880)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int AccountList_TypeDefinitionIndex = 20195;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::UI::Internal::OS::AccountList**)Il2CppClass::FromTypeDefinitionIndex(AccountList_TypeDefinitionIndex)->GetStaticField(0xAAC0);
		}
