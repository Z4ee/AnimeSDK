...
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_AWAKE_OFFSET UNITYSDK_OFFSET(0x1994BAF0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_CHECKACCOUNTLISTDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1994F2B0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_CLOSE_OFFSET UNITYSDK_OFFSET(0x1994F420)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_DELETEACCOUNT_OFFSET UNITYSDK_OFFSET(0x1994EF10)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_HIDE_OFFSET UNITYSDK_OFFSET(0x1994ED90)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_LOADACCOUNTINFODATA_OFFSET UNITYSDK_OFFSET(0x1994CC10)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_LOGINOTHERACCOUNT_OFFSET UNITYSDK_OFFSET(0x1994F4A0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_ONACCOUNTSELECTED_OFFSET UNITYSDK_OFFSET(0x1994E4C0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_ONCOLLAPSELIST_OFFSET UNITYSDK_OFFSET(0x1994E3D0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_ONCONFIRMBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x1994F440)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_ONDELETEBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x1994EE00)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1994F4C0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_ONNOTICEEXPANDDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1994E300)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_SHOW_OFFSET UNITYSDK_OFFSET(0x1994D850)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_START_OFFSET UNITYSDK_OFFSET(0x1994C8E0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_UPDATEDISPLAYEDACCOUNTLIST_OFFSET UNITYSDK_OFFSET(0x1994E210)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_UPDATEDROPDOWNTITLE_OFFSET UNITYSDK_OFFSET(0x1994D9E0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x1994CA80)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1994F4E0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST__ONDELETEBUTTONCLICKED_B__50_0_OFFSET UNITYSDK_OFFSET(0x1994F4F0)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int AccountList_TypeDefinitionIndex = 19281;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::UI::Internal::OS::AccountList**)Il2CppClass::FromTypeDefinitionIndex(AccountList_TypeDefinitionIndex)->GetStaticField(0xA7A0);
		}
