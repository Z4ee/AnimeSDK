...
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_AWAKE_OFFSET UNITYSDK_OFFSET(0x18446880)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_CHECKACCOUNTLISTDROPDOWN_OFFSET UNITYSDK_OFFSET(0x18449A20)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_CLOSE_OFFSET UNITYSDK_OFFSET(0x18449C00)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_DELETEACCOUNT_OFFSET UNITYSDK_OFFSET(0x18449620)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_HIDE_OFFSET UNITYSDK_OFFSET(0x18449470)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_LOADACCOUNTINFODATA_OFFSET UNITYSDK_OFFSET(0x18447770)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_LOGINOTHERACCOUNT_OFFSET UNITYSDK_OFFSET(0x18449C50)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_ONACCOUNTSELECTED_OFFSET UNITYSDK_OFFSET(0x18448CB0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_ONCOLLAPSELIST_OFFSET UNITYSDK_OFFSET(0x18448BC0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_ONCONFIRMBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x18449C20)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_ONDELETEBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x184494E0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18449C70)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_ONNOTICEEXPANDDROPDOWN_OFFSET UNITYSDK_OFFSET(0x18448AF0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_SHOW_OFFSET UNITYSDK_OFFSET(0x184480B0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_START_OFFSET UNITYSDK_OFFSET(0x18447430)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_UPDATEDISPLAYEDACCOUNTLIST_OFFSET UNITYSDK_OFFSET(0x184489A0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_UPDATEDROPDOWNTITLE_OFFSET UNITYSDK_OFFSET(0x18448280)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x18447610)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x18449C90)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST__ONDELETEBUTTONCLICKED_B__50_0_OFFSET UNITYSDK_OFFSET(0x18449CD0)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int AccountList_TypeDefinitionIndex = 8357;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::UI::Internal::OS::AccountList**)Il2CppClass::FromTypeDefinitionIndex(AccountList_TypeDefinitionIndex)->GetStaticField(0x23D20);
		}
