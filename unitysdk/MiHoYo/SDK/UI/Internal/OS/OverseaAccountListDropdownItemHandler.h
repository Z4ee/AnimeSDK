...
#define MIHOYO_SDK_UI_INTERNAL_OS_OVERSEAACCOUNTLISTDROPDOWNITEMHANDLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1601B340)
#define MIHOYO_SDK_UI_INTERNAL_OS_OVERSEAACCOUNTLISTDROPDOWNITEMHANDLER_GETKEY_OFFSET UNITYSDK_OFFSET(0x1601CF00)
#define MIHOYO_SDK_UI_INTERNAL_OS_OVERSEAACCOUNTLISTDROPDOWNITEMHANDLER_ONDELETEACCOUNT_OFFSET UNITYSDK_OFFSET(0x1601CF30)
#define MIHOYO_SDK_UI_INTERNAL_OS_OVERSEAACCOUNTLISTDROPDOWNITEMHANDLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1601CE70)
#define MIHOYO_SDK_UI_INTERNAL_OS_OVERSEAACCOUNTLISTDROPDOWNITEMHANDLER_PARSEACCOUNTINFO_OFFSET UNITYSDK_OFFSET(0x1601C010)
#define MIHOYO_SDK_UI_INTERNAL_OS_OVERSEAACCOUNTLISTDROPDOWNITEMHANDLER_START_OFFSET UNITYSDK_OFFSET(0x1601C000)
#define MIHOYO_SDK_UI_INTERNAL_OS_OVERSEAACCOUNTLISTDROPDOWNITEMHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1601CFB0)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int OverseaAccountListDropdownItemHandler_TypeDefinitionIndex = 7379;
