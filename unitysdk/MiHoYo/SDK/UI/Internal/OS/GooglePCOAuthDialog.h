...
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_GET_ONAUTHBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1767C360)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_GET_ONBACKBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1767C400)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_GET_ONCHECKBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1767C3A0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_GET_ONMEETPROBLEMBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1767C3E0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_GET_ONREAUTHBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1767C3C0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_GET_ONSUBMITBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1767C380)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x1767C5E0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_ONMEETPROBLEM_OFFSET UNITYSDK_OFFSET(0x1767C650)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SETSTATE_OFFSET UNITYSDK_OFFSET(0x1767C420)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SET_ONAUTHBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1767C370)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SET_ONBACKBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1767C410)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SET_ONCHECKBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1767C3B0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SET_ONMEETPROBLEMBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1767C3F0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SET_ONREAUTHBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1767C3D0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SET_ONSUBMITBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1767C390)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x1767C4E0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1767C7D0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG__SHOW_B__25_0_OFFSET UNITYSDK_OFFSET(0x1767C7E0)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int GooglePCOAuthDialog_TypeDefinitionIndex = 7449;

	class GooglePCOAuthDialog : public ::System::Object
	{
	public:
		::System::Action* _OnMeetProblemButtonClick_k__BackingField; // 0x10
		::System::Action* _OnAuthButtonClick_k__BackingField; // 0x18
