...
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_GET_ONAUTHBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1D1DCB90)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_GET_ONBACKBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1D1DCC30)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_GET_ONCHECKBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1D1DCBD0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_GET_ONMEETPROBLEMBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1D1DCC10)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_GET_ONREAUTHBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1D1DCBF0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_GET_ONSUBMITBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1D1DCBB0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x1D1DCD90)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_ONMEETPROBLEM_OFFSET UNITYSDK_OFFSET(0x1D1DCE00)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SETSTATE_OFFSET UNITYSDK_OFFSET(0x1D1DCC50)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SET_ONAUTHBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1D1DCBA0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SET_ONBACKBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1D1DCC40)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SET_ONCHECKBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1D1DCBE0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SET_ONMEETPROBLEMBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1D1DCC20)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SET_ONREAUTHBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1D1DCC00)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SET_ONSUBMITBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1D1DCBC0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x1D1DCC90)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1DCF80)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG__SHOW_B__25_0_OFFSET UNITYSDK_OFFSET(0x1D1DCF90)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int GooglePCOAuthDialog_TypeDefinitionIndex = 20538;
	...
	public:
		...
		::System::Action* _OnBackButtonClick_k__BackingField; // 0x38
