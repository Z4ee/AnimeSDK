...
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_GET_ONAUTHBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1BE6B4F0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_GET_ONBACKBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1BE6B590)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_GET_ONCHECKBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1BE6B530)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_GET_ONMEETPROBLEMBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1BE6B570)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_GET_ONREAUTHBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1BE6B550)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_GET_ONSUBMITBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1BE6B510)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x1BE6B710)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_ONMEETPROBLEM_OFFSET UNITYSDK_OFFSET(0x1BE6B780)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SETSTATE_OFFSET UNITYSDK_OFFSET(0x1BE6B5B0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SET_ONAUTHBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1BE6B500)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SET_ONBACKBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1BE6B5A0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SET_ONCHECKBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1BE6B540)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SET_ONMEETPROBLEMBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1BE6B580)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SET_ONREAUTHBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1BE6B560)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SET_ONSUBMITBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x1BE6B520)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x1BE6B610)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE6B900)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG__SHOW_B__25_0_OFFSET UNITYSDK_OFFSET(0x1BE6B910)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int GooglePCOAuthDialog_TypeDefinitionIndex = 20190;

	class GooglePCOAuthDialog : public ::System::Object
	{
	public:
		::System::Action* _OnBackButtonClick_k__BackingField; // 0x10
		::System::Action* _OnSubmitButtonClick_k__BackingField; // 0x18
		::System::Action* _OnMeetProblemButtonClick_k__BackingField; // 0x20
		::System::Action* _OnReAuthButtonClick_k__BackingField; // 0x28
		::System::Action* _OnCheckButtonClick_k__BackingField; // 0x30
