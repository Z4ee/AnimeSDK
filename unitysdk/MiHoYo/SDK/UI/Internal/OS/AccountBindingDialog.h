...
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_CLEARCAPTCHACODE_OFFSET UNITYSDK_OFFSET(0x17675200)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_CLEARINPUTACCOUNT_OFFSET UNITYSDK_OFFSET(0x176751B0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_GET_ONBACKBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x17674D40)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_GET_ONBINDBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x17674DE0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_GET_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x17674D60)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_GET_ONGETCAPTCHABTNCLICKED_OFFSET UNITYSDK_OFFSET(0x17674D80)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_GET_ONQRREFRESHBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x17674E00)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_GET_ONSHOWPRIVACYPROTOCOLCLICKED_OFFSET UNITYSDK_OFFSET(0x17674DC0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_GET_ONSHOWUSERAGREEMENTCLICKED_OFFSET UNITYSDK_OFFSET(0x17674DA0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x17675370)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_INVALIDATEQRCODE_OFFSET UNITYSDK_OFFSET(0x17674E80)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_LOADINGQRCODE_OFFSET UNITYSDK_OFFSET(0x17674EE0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_SETQRIMAGE_OFFSET UNITYSDK_OFFSET(0x17674E20)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_SET_ONBACKBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x17674D50)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_SET_ONBINDBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x17674DF0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_SET_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x17674D70)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_SET_ONGETCAPTCHABTNCLICKED_OFFSET UNITYSDK_OFFSET(0x17674D90)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_SET_ONQRREFRESHBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x17674E10)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_SET_ONSHOWPRIVACYPROTOCOLCLICKED_OFFSET UNITYSDK_OFFSET(0x17674DD0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_SET_ONSHOWUSERAGREEMENTCLICKED_OFFSET UNITYSDK_OFFSET(0x17674DB0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x17675250)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_STARTBINDRESULTQUERYCOROUTINE_OFFSET UNITYSDK_OFFSET(0x17674FD0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_STARTCAPTCHACOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x176750F0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_STOPBINDRESULTQUERYCOROUTINE_OFFSET UNITYSDK_OFFSET(0x17675090)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_STOPCAPTCHACOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x17675150)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x176753E0)
