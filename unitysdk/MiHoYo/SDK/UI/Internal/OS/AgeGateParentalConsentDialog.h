...
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG_GET_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1B5CDD30)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG_GET_ONENDEDIT_OFFSET UNITYSDK_OFFSET(0x1B5CDD50)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG_GET_ONNEXTBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x1B5CDCF0)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG_GET_ONSHOWPARENTALCONTROLPROCESSBUTTONPRESSED_OFFSET UNITYSDK_OFFSET(0x1B5CDD10)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x1B5C03C0)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG_SET_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1B5CDD40)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG_SET_ONENDEDIT_OFFSET UNITYSDK_OFFSET(0x1B5CDD60)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG_SET_ONNEXTBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x1B5CDD00)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG_SET_ONSHOWPARENTALCONTROLPROCESSBUTTONPRESSED_OFFSET UNITYSDK_OFFSET(0x1B5CDD20)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x1B5CDD70)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5CDEC0)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG__SHOW_B__16_0_OFFSET UNITYSDK_OFFSET(0x1B5CDED0)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG__SHOW_B__16_1_OFFSET UNITYSDK_OFFSET(0x1B5CDF30)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG__SHOW_B__16_2_OFFSET UNITYSDK_OFFSET(0x1B5CDF40)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG__SHOW_B__16_3_OFFSET UNITYSDK_OFFSET(0x1B5CDF50)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int AgeGateParentalConsentDialog_TypeDefinitionIndex = 20180;
