...
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG_GET_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x17679FC0)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG_GET_ONENDEDIT_OFFSET UNITYSDK_OFFSET(0x17679FE0)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG_GET_ONNEXTBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x17679F80)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG_GET_ONSHOWPARENTALCONTROLPROCESSBUTTONPRESSED_OFFSET UNITYSDK_OFFSET(0x17679FA0)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x1767A150)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG_SET_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x17679FD0)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG_SET_ONENDEDIT_OFFSET UNITYSDK_OFFSET(0x17679FF0)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG_SET_ONNEXTBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x17679F90)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG_SET_ONSHOWPARENTALCONTROLPROCESSBUTTONPRESSED_OFFSET UNITYSDK_OFFSET(0x17679FB0)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x1767A000)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1767A1E0)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG__SHOW_B__16_0_OFFSET UNITYSDK_OFFSET(0x1767A1F0)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG__SHOW_B__16_1_OFFSET UNITYSDK_OFFSET(0x1767A210)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG__SHOW_B__16_2_OFFSET UNITYSDK_OFFSET(0x1767A220)
#define MIHOYO_SDK_UI_INTERNAL_OS_AGEGATEPARENTALCONSENTDIALOG__SHOW_B__16_3_OFFSET UNITYSDK_OFFSET(0x1767A230)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int AgeGateParentalConsentDialog_TypeDefinitionIndex = 7440;
