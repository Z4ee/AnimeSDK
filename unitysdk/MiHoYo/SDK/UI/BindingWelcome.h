...
#define MIHOYO_SDK_UI_BINDINGWELCOME_AWAKE_OFFSET UNITYSDK_OFFSET(0x1766B7D0)
#define MIHOYO_SDK_UI_BINDINGWELCOME_BINDEXISTINGACCOUNT_OFFSET UNITYSDK_OFFSET(0x1766C5D0)
#define MIHOYO_SDK_UI_BINDINGWELCOME_CANCELCREATENEWACCOUNT_OFFSET UNITYSDK_OFFSET(0x1766C640)
#define MIHOYO_SDK_UI_BINDINGWELCOME_CLOSE_OFFSET UNITYSDK_OFFSET(0x1766C650)
#define MIHOYO_SDK_UI_BINDINGWELCOME_CONFIRMCREATEANDBINDNEWACCOUNT_OFFSET UNITYSDK_OFFSET(0x1766C5F0)
#define MIHOYO_SDK_UI_BINDINGWELCOME_CREATEANDBINDNEWACCOUNT_OFFSET UNITYSDK_OFFSET(0x1766C630)
#define MIHOYO_SDK_UI_BINDINGWELCOME_HIDE_OFFSET UNITYSDK_OFFSET(0x1766C7A0)
#define MIHOYO_SDK_UI_BINDINGWELCOME_ONBINDBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1766C5A0)
#define MIHOYO_SDK_UI_BINDINGWELCOME_ONSKIPORCANCELBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1766C610)
#define MIHOYO_SDK_UI_BINDINGWELCOME_SHOWBINDMODESELECTION_OFFSET UNITYSDK_OFFSET(0x1766C210)
#define MIHOYO_SDK_UI_BINDINGWELCOME_SHOWNEWACCOUNTPROMPT_OFFSET UNITYSDK_OFFSET(0x1766C380)
#define MIHOYO_SDK_UI_BINDINGWELCOME_SHOW_OFFSET UNITYSDK_OFFSET(0x1766C670)
#define MIHOYO_SDK_UI_BINDINGWELCOME__CTOR_OFFSET UNITYSDK_OFFSET(0x1766C810)

namespace MiHoYo::SDK::UI
{
	inline static constexpr unsigned int BindingWelcome_TypeDefinitionIndex = 7413;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::UI::BindingWelcome**)Il2CppClass::FromTypeDefinitionIndex(BindingWelcome_TypeDefinitionIndex)->GetStaticField(0x24A30);
		}
