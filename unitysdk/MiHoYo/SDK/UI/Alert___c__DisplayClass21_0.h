...
#define MIHOYO_SDK_UI_ALERT___C__DISPLAYCLASS21_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA1CD20)
#define MIHOYO_SDK_UI_ALERT___C__DISPLAYCLASS21_0__SHOW_B__0_OFFSET UNITYSDK_OFFSET(0x1DA1CD30)

namespace MiHoYo::SDK::UI
{
	inline static constexpr unsigned int Alert___c__DisplayClass21_0_TypeDefinitionIndex = 20509;

	class Alert___c__DisplayClass21_0 : public ::System::Object
	{
	public:
		::System::String* button; // 0x10
		::MiHoYo::SDK::UI::Alert_OnAlertDelegate* callback; // 0x18
