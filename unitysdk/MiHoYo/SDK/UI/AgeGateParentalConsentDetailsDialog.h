...
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDETAILSDIALOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x18437400)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDETAILSDIALOG_GET_ONBACK_OFFSET UNITYSDK_OFFSET(0x184373E0)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDETAILSDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x18438100)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDETAILSDIALOG_ONBACKBTNCLICK_OFFSET UNITYSDK_OFFSET(0x18438190)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDETAILSDIALOG_SET_ONBACK_OFFSET UNITYSDK_OFFSET(0x184373F0)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDETAILSDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x18437FA0)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDETAILSDIALOG_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x18437D40)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDETAILSDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x184381B0)

namespace MiHoYo::SDK::UI
{
	inline static constexpr unsigned int AgeGateParentalConsentDetailsDialog_TypeDefinitionIndex = 8304;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::UI::AgeGateParentalConsentDetailsDialog**)Il2CppClass::FromTypeDefinitionIndex(AgeGateParentalConsentDetailsDialog_TypeDefinitionIndex)->GetStaticField(0x235F0);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Action*))((::PBYTE)hIl2Cpp + MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDETAILSDIALOG_SET_ONBACK_OFFSET))(this, a1);
		}
