...
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDETAILSDIALOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x1CEB95C0)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDETAILSDIALOG_GET_ONBACK_OFFSET UNITYSDK_OFFSET(0x1CEB95A0)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDETAILSDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x1CEBA470)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDETAILSDIALOG_ONBACKBTNCLICK_OFFSET UNITYSDK_OFFSET(0x1CEBA500)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDETAILSDIALOG_SET_ONBACK_OFFSET UNITYSDK_OFFSET(0x1CEB95B0)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDETAILSDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x1CEBA340)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDETAILSDIALOG_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x1CEBA0A0)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDETAILSDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEBA520)

namespace MiHoYo::SDK::UI
{
	inline static constexpr unsigned int AgeGateParentalConsentDetailsDialog_TypeDefinitionIndex = 20486;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::UI::AgeGateParentalConsentDetailsDialog**)Il2CppClass::FromTypeDefinitionIndex(AgeGateParentalConsentDetailsDialog_TypeDefinitionIndex)->GetStaticField(0x9620);
		}
