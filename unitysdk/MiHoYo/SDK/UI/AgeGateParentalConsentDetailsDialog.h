...
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDETAILSDIALOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x19CAF180)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDETAILSDIALOG_GET_ONBACK_OFFSET UNITYSDK_OFFSET(0x19CAF160)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDETAILSDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x19CB0030)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDETAILSDIALOG_ONBACKBTNCLICK_OFFSET UNITYSDK_OFFSET(0x19CB00C0)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDETAILSDIALOG_SET_ONBACK_OFFSET UNITYSDK_OFFSET(0x19CAF170)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDETAILSDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x19CAFF00)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDETAILSDIALOG_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x19CAFC60)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDETAILSDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x19CB00E0)

namespace MiHoYo::SDK::UI
{
	inline static constexpr unsigned int AgeGateParentalConsentDetailsDialog_TypeDefinitionIndex = 19228;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::UI::AgeGateParentalConsentDetailsDialog**)Il2CppClass::FromTypeDefinitionIndex(AgeGateParentalConsentDetailsDialog_TypeDefinitionIndex)->GetStaticField(0x9380);
		}
