...
#define MIHOYO_SDK_KCPCLIENT_ONCONNECTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8D29A20)
#define MIHOYO_SDK_KCPCLIENT_ONCONNECTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8D29A80)
#define MIHOYO_SDK_KCPCLIENT_ONCONNECTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x8D294C0)
#define MIHOYO_SDK_KCPCLIENT_ONCONNECTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x8D294A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int KCPClient_OnConnectDelegate_TypeDefinitionIndex = 42733;
