...
#define MIHOYO_SDK_KCPCLIENT_ONCONNECTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A8175B0)
#define MIHOYO_SDK_KCPCLIENT_ONCONNECTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A817630)
#define MIHOYO_SDK_KCPCLIENT_ONCONNECTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A817050)
#define MIHOYO_SDK_KCPCLIENT_ONCONNECTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A817040)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int KCPClient_OnConnectDelegate_TypeDefinitionIndex = 34950;
