...
#define MIHOYO_SDK_EOSDELEGATE_LOGINDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D4A9280)
#define MIHOYO_SDK_EOSDELEGATE_LOGINDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D4A92B0)
#define MIHOYO_SDK_EOSDELEGATE_LOGINDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D4A8D60)
#define MIHOYO_SDK_EOSDELEGATE_LOGINDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4A8D40)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int EOSDelegate_LoginDelegate_TypeDefinitionIndex = 19825;
