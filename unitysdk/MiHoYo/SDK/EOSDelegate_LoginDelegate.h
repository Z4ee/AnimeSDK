...
#define MIHOYO_SDK_EOSDELEGATE_LOGINDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15EDE270)
#define MIHOYO_SDK_EOSDELEGATE_LOGINDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15EDE2A0)
#define MIHOYO_SDK_EOSDELEGATE_LOGINDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15EDDD20)
#define MIHOYO_SDK_EOSDELEGATE_LOGINDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15EDDD00)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int EOSDelegate_LoginDelegate_TypeDefinitionIndex = 6719;
