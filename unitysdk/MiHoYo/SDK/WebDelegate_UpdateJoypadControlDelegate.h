...
#define MIHOYO_SDK_WEBDELEGATE_UPDATEJOYPADCONTROLDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B7D8B80)
#define MIHOYO_SDK_WEBDELEGATE_UPDATEJOYPADCONTROLDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B7D8BB0)
#define MIHOYO_SDK_WEBDELEGATE_UPDATEJOYPADCONTROLDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B7D8B70)
#define MIHOYO_SDK_WEBDELEGATE_UPDATEJOYPADCONTROLDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7D8B00)
