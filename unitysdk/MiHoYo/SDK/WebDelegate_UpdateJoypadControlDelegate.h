...
#define MIHOYO_SDK_WEBDELEGATE_UPDATEJOYPADCONTROLDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B5D0640)
#define MIHOYO_SDK_WEBDELEGATE_UPDATEJOYPADCONTROLDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B5D0670)
#define MIHOYO_SDK_WEBDELEGATE_UPDATEJOYPADCONTROLDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B5D03A0)
#define MIHOYO_SDK_WEBDELEGATE_UPDATEJOYPADCONTROLDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5D0380)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_UpdateJoypadControlDelegate_TypeDefinitionIndex = 19614;
