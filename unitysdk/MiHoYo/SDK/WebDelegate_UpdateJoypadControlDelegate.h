...
#define MIHOYO_SDK_WEBDELEGATE_UPDATEJOYPADCONTROLDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C941510)
#define MIHOYO_SDK_WEBDELEGATE_UPDATEJOYPADCONTROLDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C941540)
#define MIHOYO_SDK_WEBDELEGATE_UPDATEJOYPADCONTROLDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C941280)
#define MIHOYO_SDK_WEBDELEGATE_UPDATEJOYPADCONTROLDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C941260)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_UpdateJoypadControlDelegate_TypeDefinitionIndex = 19962;
