...
#define MIHOYO_SDK_CONSOLEDELEGATE_ONFRIENDINVITATIONNOTIFYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CF31060)
#define MIHOYO_SDK_CONSOLEDELEGATE_ONFRIENDINVITATIONNOTIFYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CF310E0)
#define MIHOYO_SDK_CONSOLEDELEGATE_ONFRIENDINVITATIONNOTIFYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CF30D50)
#define MIHOYO_SDK_CONSOLEDELEGATE_ONFRIENDINVITATIONNOTIFYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF30D30)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_OnFriendInvitationNotifyCallback_TypeDefinitionIndex = 19787;
