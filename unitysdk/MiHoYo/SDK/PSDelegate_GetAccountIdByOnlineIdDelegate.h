...
#define MIHOYO_SDK_PSDELEGATE_GETACCOUNTIDBYONLINEIDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15F94F20)
#define MIHOYO_SDK_PSDELEGATE_GETACCOUNTIDBYONLINEIDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15F94F60)
#define MIHOYO_SDK_PSDELEGATE_GETACCOUNTIDBYONLINEIDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15F949A0)
#define MIHOYO_SDK_PSDELEGATE_GETACCOUNTIDBYONLINEIDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15F94980)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_GetAccountIdByOnlineIdDelegate_TypeDefinitionIndex = 6751;
