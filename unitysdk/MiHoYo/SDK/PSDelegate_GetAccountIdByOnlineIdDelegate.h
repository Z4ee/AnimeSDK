...
#define MIHOYO_SDK_PSDELEGATE_GETACCOUNTIDBYONLINEIDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19CA4010)
#define MIHOYO_SDK_PSDELEGATE_GETACCOUNTIDBYONLINEIDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19CA4050)
#define MIHOYO_SDK_PSDELEGATE_GETACCOUNTIDBYONLINEIDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19CA3A90)
#define MIHOYO_SDK_PSDELEGATE_GETACCOUNTIDBYONLINEIDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CA3A80)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_GetAccountIdByOnlineIdDelegate_TypeDefinitionIndex = 18615;
