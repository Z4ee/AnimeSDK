...
#define MIHOYO_SDK_CLOUD_CLOUDPIPE___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x173EF990)
#define MIHOYO_SDK_CLOUD_CLOUDPIPE___C__DISPLAYCLASS11_0__ONGETRESPONSE_B__0_OFFSET UNITYSDK_OFFSET(0x173EFEB0)
#define MIHOYO_SDK_CLOUD_CLOUDPIPE___C__DISPLAYCLASS11_0__ONGETRESPONSE_B__1_OFFSET UNITYSDK_OFFSET(0x173EFF10)
#define MIHOYO_SDK_CLOUD_CLOUDPIPE___C__DISPLAYCLASS11_0__ONGETRESPONSE_B__2_OFFSET UNITYSDK_OFFSET(0x173EFF50)
#define MIHOYO_SDK_CLOUD_CLOUDPIPE___C__DISPLAYCLASS11_0__ONGETRESPONSE_B__3_OFFSET UNITYSDK_OFFSET(0x173EFF90)

namespace MiHoYo::SDK::Cloud
{
	inline static constexpr unsigned int CloudPipe___c__DisplayClass11_0_TypeDefinitionIndex = 7645;
