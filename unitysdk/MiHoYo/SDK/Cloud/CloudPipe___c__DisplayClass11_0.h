...
#define MIHOYO_SDK_CLOUD_CLOUDPIPE___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1AB470)
#define MIHOYO_SDK_CLOUD_CLOUDPIPE___C__DISPLAYCLASS11_0__ONGETRESPONSE_B__0_OFFSET UNITYSDK_OFFSET(0x1A1AB950)
#define MIHOYO_SDK_CLOUD_CLOUDPIPE___C__DISPLAYCLASS11_0__ONGETRESPONSE_B__1_OFFSET UNITYSDK_OFFSET(0x1A1AB9B0)
#define MIHOYO_SDK_CLOUD_CLOUDPIPE___C__DISPLAYCLASS11_0__ONGETRESPONSE_B__2_OFFSET UNITYSDK_OFFSET(0x1A1ABA00)
#define MIHOYO_SDK_CLOUD_CLOUDPIPE___C__DISPLAYCLASS11_0__ONGETRESPONSE_B__3_OFFSET UNITYSDK_OFFSET(0x1A1ABA50)

namespace MiHoYo::SDK::Cloud
{
	inline static constexpr unsigned int CloudPipe___c__DisplayClass11_0_TypeDefinitionIndex = 8827;
