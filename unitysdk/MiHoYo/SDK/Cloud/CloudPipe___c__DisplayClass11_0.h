...
#define MIHOYO_SDK_CLOUD_CLOUDPIPE___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18873C30)
#define MIHOYO_SDK_CLOUD_CLOUDPIPE___C__DISPLAYCLASS11_0__ONGETRESPONSE_B__0_OFFSET UNITYSDK_OFFSET(0x18874110)
#define MIHOYO_SDK_CLOUD_CLOUDPIPE___C__DISPLAYCLASS11_0__ONGETRESPONSE_B__1_OFFSET UNITYSDK_OFFSET(0x18874170)
#define MIHOYO_SDK_CLOUD_CLOUDPIPE___C__DISPLAYCLASS11_0__ONGETRESPONSE_B__2_OFFSET UNITYSDK_OFFSET(0x188741C0)
#define MIHOYO_SDK_CLOUD_CLOUDPIPE___C__DISPLAYCLASS11_0__ONGETRESPONSE_B__3_OFFSET UNITYSDK_OFFSET(0x18874210)

namespace MiHoYo::SDK::Cloud
{
	inline static constexpr unsigned int CloudPipe___c__DisplayClass11_0_TypeDefinitionIndex = 8560;
