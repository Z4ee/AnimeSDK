...
#define MIHOYO_SDK_CLOUD_CLOUDPIPE_PIPESENDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5607A0)

namespace MiHoYo::SDK::Cloud
{
	inline static constexpr unsigned int CloudPipe_PipeSendData_TypeDefinitionIndex = 20629;
