...
#define MIHOYO_SDK_CONSOLEIMEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0D7D80)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleImeInfo_TypeDefinitionIndex = 19632;
	...
	public:
		...
		::UnityEngine::UI::InputField_ContentType imeType; // 0x34
