...
#define MIHOYO_SDK_KIBANANETWORKMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD407B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int KibanaNetworkModel_TypeDefinitionIndex = 19993;
