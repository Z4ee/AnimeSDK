...
#define MIHOYO_SDK_KIBANANETWORKMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1820BEB0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int KibanaNetworkModel_TypeDefinitionIndex = 7837;
