...
#define MIHOYO_SDK_KIBANANETWORKMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x17566660)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int KibanaNetworkModel_TypeDefinitionIndex = 6928;
