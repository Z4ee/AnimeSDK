...
#define MIHOYO_SDK_MIHOYOSDKACCOUNTINFOMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCC0EC0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKAccountInfoModel_TypeDefinitionIndex = 37381;
