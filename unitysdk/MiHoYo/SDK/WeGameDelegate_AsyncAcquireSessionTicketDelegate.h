...
#define MIHOYO_SDK_WEGAMEDELEGATE_ASYNCACQUIRESESSIONTICKETDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1602B620)
#define MIHOYO_SDK_WEGAMEDELEGATE_ASYNCACQUIRESESSIONTICKETDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1602B650)
#define MIHOYO_SDK_WEGAMEDELEGATE_ASYNCACQUIRESESSIONTICKETDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1602B0D0)
#define MIHOYO_SDK_WEGAMEDELEGATE_ASYNCACQUIRESESSIONTICKETDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1602B0B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WeGameDelegate_AsyncAcquireSessionTicketDelegate_TypeDefinitionIndex = 6710;
