...
#define MIHOYO_SDK_KCPCLIENT_ONERRORDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D1A6690)
#define MIHOYO_SDK_KCPCLIENT_ONERRORDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D1A6710)
#define MIHOYO_SDK_KCPCLIENT_ONERRORDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D1A58A0)
#define MIHOYO_SDK_KCPCLIENT_ONERRORDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1A6670)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int KCPClient_OnErrorDelegate_TypeDefinitionIndex = 36516;
