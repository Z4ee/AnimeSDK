...
#define MIHOYO_SDK_SDKDELEGATE_GETDEVICEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15FE60A0)
#define MIHOYO_SDK_SDKDELEGATE_GETDEVICEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15FE60D0)
#define MIHOYO_SDK_SDKDELEGATE_GETDEVICEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15FE5DF0)
#define MIHOYO_SDK_SDKDELEGATE_GETDEVICEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15FE5DD0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_GetDeviceDelegate_TypeDefinitionIndex = 6774;
