...
#define MIHOYO_SDK_CONSOLEDELEGATE_TRYGETCXTOKENDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BC79630)
#define MIHOYO_SDK_CONSOLEDELEGATE_TRYGETCXTOKENDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BC79700)
#define MIHOYO_SDK_CONSOLEDELEGATE_TRYGETCXTOKENDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BC78E40)
#define MIHOYO_SDK_CONSOLEDELEGATE_TRYGETCXTOKENDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC78E20)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_TryGetCXTokenDelegate_TypeDefinitionIndex = 19428;
