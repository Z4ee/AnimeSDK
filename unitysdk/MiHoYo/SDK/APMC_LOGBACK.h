...
#define MIHOYO_SDK_APMC_LOGBACK_ASTROLABE_LOGPLUGINSETUPLOADSEPERATECONFIG_OFFSET UNITYSDK_OFFSET(0x1A9E3420)
#define MIHOYO_SDK_APMC_LOGBACK_ASTROLABE_NATIVE_DISABLECALLBACK_OFFSET UNITYSDK_OFFSET(0x1A9E33A0)
#define MIHOYO_SDK_APMC_LOGBACK_ASTROLABE_NATIVE_FLUSH_OFFSET UNITYSDK_OFFSET(0x1A9E39C0)
#define MIHOYO_SDK_APMC_LOGBACK_ASTROLABE_NATIVE_UPLOAD_OFFSET UNITYSDK_OFFSET(0x1A9E3BA0)
#define MIHOYO_SDK_APMC_LOGBACK_ASTROLABE_NATIVE_WRITE_OFFSET UNITYSDK_OFFSET(0x1A9E3700)
#define MIHOYO_SDK_APMC_LOGBACK_CONFIG_OFFSET UNITYSDK_OFFSET(0x1A9E2E20)
#define MIHOYO_SDK_APMC_LOGBACK_FLUSH_OFFSET UNITYSDK_OFFSET(0x1A9E3890)
#define MIHOYO_SDK_APMC_LOGBACK_UPLOAD_OFFSET UNITYSDK_OFFSET(0x1A9E3A40)
#define MIHOYO_SDK_APMC_LOGBACK_WRITE_OFFSET UNITYSDK_OFFSET(0x1A9E34A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int APMC_LOGBACK_TypeDefinitionIndex = 35318;
