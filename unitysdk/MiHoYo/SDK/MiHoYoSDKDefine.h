...
#define MIHOYO_SDK_MIHOYOSDKDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x8D3DC70)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKDefine_TypeDefinitionIndex = 42941;
