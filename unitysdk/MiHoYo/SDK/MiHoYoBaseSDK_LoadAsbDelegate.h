...
#define MIHOYO_SDK_MIHOYOBASESDK_LOADASBDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A81A690)
#define MIHOYO_SDK_MIHOYOBASESDK_LOADASBDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A81A6C0)
#define MIHOYO_SDK_MIHOYOBASESDK_LOADASBDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A81A150)
#define MIHOYO_SDK_MIHOYOBASESDK_LOADASBDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A81A140)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoBaseSDK_LoadAsbDelegate_TypeDefinitionIndex = 35076;
