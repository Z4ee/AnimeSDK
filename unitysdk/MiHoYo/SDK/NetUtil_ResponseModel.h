...
#define MIHOYO_SDK_NETUTIL_RESPONSEMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDCE630)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int NetUtil_ResponseModel_TypeDefinitionIndex = 20294;
