...
#define MIHOYO_SDK_PSDELEGATE_DESTROYTROPHYCONTEXTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A518FB0)
#define MIHOYO_SDK_PSDELEGATE_DESTROYTROPHYCONTEXTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A519020)
#define MIHOYO_SDK_PSDELEGATE_DESTROYTROPHYCONTEXTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A518CB0)
#define MIHOYO_SDK_PSDELEGATE_DESTROYTROPHYCONTEXTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A518CA0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_DestroyTrophyContextDelegate_TypeDefinitionIndex = 18612;
