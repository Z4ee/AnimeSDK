...
#define MIHOYO_SDK_PSDELEGATE_CHECKPSSTOREISEMPTYDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15F934A0)
#define MIHOYO_SDK_PSDELEGATE_CHECKPSSTOREISEMPTYDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15F934D0)
#define MIHOYO_SDK_PSDELEGATE_CHECKPSSTOREISEMPTYDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15F92F50)
#define MIHOYO_SDK_PSDELEGATE_CHECKPSSTOREISEMPTYDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15F92F30)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_CheckPsStoreIsEmptyDelegate_TypeDefinitionIndex = 6736;
