...
#define MIHOYO_SDK_SDKDELEGATE_GETRAMREMAINDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15FE81D0)
#define MIHOYO_SDK_SDKDELEGATE_GETRAMREMAINDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15FE8200)
#define MIHOYO_SDK_SDKDELEGATE_GETRAMREMAINDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15FE7F20)
#define MIHOYO_SDK_SDKDELEGATE_GETRAMREMAINDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15FE7F00)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_GetRamRemainDelegate_TypeDefinitionIndex = 6794;
