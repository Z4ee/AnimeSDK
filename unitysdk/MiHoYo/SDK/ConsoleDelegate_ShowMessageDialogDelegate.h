...
#define MIHOYO_SDK_CONSOLEDELEGATE_SHOWMESSAGEDIALOGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C5FB1F0)
#define MIHOYO_SDK_CONSOLEDELEGATE_SHOWMESSAGEDIALOGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C5FB230)
#define MIHOYO_SDK_CONSOLEDELEGATE_SHOWMESSAGEDIALOGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C5FB1E0)
#define MIHOYO_SDK_CONSOLEDELEGATE_SHOWMESSAGEDIALOGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5FB160)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_ShowMessageDialogDelegate_TypeDefinitionIndex = 7588;
