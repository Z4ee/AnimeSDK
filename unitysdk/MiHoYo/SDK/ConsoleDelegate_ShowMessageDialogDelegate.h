...
#define MIHOYO_SDK_CONSOLEDELEGATE_SHOWMESSAGEDIALOGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AA465D0)
#define MIHOYO_SDK_CONSOLEDELEGATE_SHOWMESSAGEDIALOGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AA46610)
#define MIHOYO_SDK_CONSOLEDELEGATE_SHOWMESSAGEDIALOGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AA465C0)
#define MIHOYO_SDK_CONSOLEDELEGATE_SHOWMESSAGEDIALOGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA46540)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_ShowMessageDialogDelegate_TypeDefinitionIndex = 7599;
