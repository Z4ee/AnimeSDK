...
#define MIHOYO_SDK_NOTICECOOKIEVALUEMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x15F486F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int NoticeCookieValueModel_TypeDefinitionIndex = 6573;
