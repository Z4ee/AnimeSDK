...
#define MIHOYO_SDK_NOTICECOOKIEVALUEMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A648CD0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int NoticeCookieValueModel_TypeDefinitionIndex = 7502;
