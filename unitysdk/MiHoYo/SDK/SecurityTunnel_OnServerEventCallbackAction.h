...
#define MIHOYO_SDK_SECURITYTUNNEL_ONSERVEREVENTCALLBACKACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA215030)
#define MIHOYO_SDK_SECURITYTUNNEL_ONSERVEREVENTCALLBACKACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA2150B0)
#define MIHOYO_SDK_SECURITYTUNNEL_ONSERVEREVENTCALLBACKACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0xA20C6B0)
#define MIHOYO_SDK_SECURITYTUNNEL_ONSERVEREVENTCALLBACKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xA214FC0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_OnServerEventCallbackAction_TypeDefinitionIndex = 43809;
