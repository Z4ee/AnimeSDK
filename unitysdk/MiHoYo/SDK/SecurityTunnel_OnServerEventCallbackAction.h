...
#define MIHOYO_SDK_SECURITYTUNNEL_ONSERVEREVENTCALLBACKACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ABC01B0)
#define MIHOYO_SDK_SECURITYTUNNEL_ONSERVEREVENTCALLBACKACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ABC0230)
#define MIHOYO_SDK_SECURITYTUNNEL_ONSERVEREVENTCALLBACKACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ABB6F40)
#define MIHOYO_SDK_SECURITYTUNNEL_ONSERVEREVENTCALLBACKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABC0140)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_OnServerEventCallbackAction_TypeDefinitionIndex = 44671;
