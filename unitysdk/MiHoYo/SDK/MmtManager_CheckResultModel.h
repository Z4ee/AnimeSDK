...
#define MIHOYO_SDK_MMTMANAGER_CHECKRESULTMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x15F38170)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MmtManager_CheckResultModel_TypeDefinitionIndex = 7029;
