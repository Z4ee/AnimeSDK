...
#define MIHOYO_SDK_TRANSLATESERVICE_ADDMESSAGE_OFFSET UNITYSDK_OFFSET(0x1CD41260)
#define MIHOYO_SDK_TRANSLATESERVICE_CALLBACKTRANSLATERESULT_OFFSET UNITYSDK_OFFSET(0x1CD43D50)
#define MIHOYO_SDK_TRANSLATESERVICE_CHECKINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1CD43050)
#define MIHOYO_SDK_TRANSLATESERVICE_CLEARCONTEXT_OFFSET UNITYSDK_OFFSET(0x1CD42A60)
#define MIHOYO_SDK_TRANSLATESERVICE_GETCONFIGURL_OFFSET UNITYSDK_OFFSET(0x1CD42DF0)
#define MIHOYO_SDK_TRANSLATESERVICE_GETGAMEBIZ_OFFSET UNITYSDK_OFFSET(0x1CD42CF0)
#define MIHOYO_SDK_TRANSLATESERVICE_GETREGION_OFFSET UNITYSDK_OFFSET(0x1CD42D70)
#define MIHOYO_SDK_TRANSLATESERVICE_GETTRANSLATEURL_OFFSET UNITYSDK_OFFSET(0x1CD42F20)
#define MIHOYO_SDK_TRANSLATESERVICE_INIT_OFFSET UNITYSDK_OFFSET(0x1CD40150)
#define MIHOYO_SDK_TRANSLATESERVICE_PARSECHATMESSAGE_OFFSET UNITYSDK_OFFSET(0x1CD430B0)
#define MIHOYO_SDK_TRANSLATESERVICE_SETCONTEXT_OFFSET UNITYSDK_OFFSET(0x1CD40BD0)
#define MIHOYO_SDK_TRANSLATESERVICE_TRANSLATE_OFFSET UNITYSDK_OFFSET(0x1CD422D0)
#define MIHOYO_SDK_TRANSLATESERVICE_VALIDATEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1CD43C80)
#define MIHOYO_SDK_TRANSLATESERVICE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CD448A0)
#define MIHOYO_SDK_TRANSLATESERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD44860)
...
namespace MiHoYo::SDK
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::TranslateService**)Il2CppClass::FromTypeDefinitionIndex(TranslateService_TypeDefinitionIndex)->GetStaticField(0x5DF20);
		}
