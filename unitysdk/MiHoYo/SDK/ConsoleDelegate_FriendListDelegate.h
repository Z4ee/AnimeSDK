...
#define MIHOYO_SDK_CONSOLEDELEGATE_FRIENDLISTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AA43E60)
#define MIHOYO_SDK_CONSOLEDELEGATE_FRIENDLISTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AA43E90)
#define MIHOYO_SDK_CONSOLEDELEGATE_FRIENDLISTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AA43E50)
#define MIHOYO_SDK_CONSOLEDELEGATE_FRIENDLISTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA43DE0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_FriendListDelegate_TypeDefinitionIndex = 7581;
