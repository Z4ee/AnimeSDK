...
#define MIHOYO_SDK_CONSOLEDELEGATE_FRIENDLISTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C5F83A0)
#define MIHOYO_SDK_CONSOLEDELEGATE_FRIENDLISTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C5F83D0)
#define MIHOYO_SDK_CONSOLEDELEGATE_FRIENDLISTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C5F8390)
#define MIHOYO_SDK_CONSOLEDELEGATE_FRIENDLISTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5F8320)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_FriendListDelegate_TypeDefinitionIndex = 7569;
