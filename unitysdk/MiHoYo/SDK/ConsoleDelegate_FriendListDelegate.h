...
#define MIHOYO_SDK_CONSOLEDELEGATE_FRIENDLISTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B93D4A0)
#define MIHOYO_SDK_CONSOLEDELEGATE_FRIENDLISTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B93D4D0)
#define MIHOYO_SDK_CONSOLEDELEGATE_FRIENDLISTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B93D490)
#define MIHOYO_SDK_CONSOLEDELEGATE_FRIENDLISTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B93D420)
