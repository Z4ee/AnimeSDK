...
#define MIHOYO_SDK_REQUESTMANAGER___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15FD7AA0)
#define MIHOYO_SDK_REQUESTMANAGER___C__DISPLAYCLASS5_0__GETMAILVERIFYCODE_B__0_OFFSET UNITYSDK_OFFSET(0x15FE1500)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int RequestManager___c__DisplayClass5_0_TypeDefinitionIndex = 7056;
