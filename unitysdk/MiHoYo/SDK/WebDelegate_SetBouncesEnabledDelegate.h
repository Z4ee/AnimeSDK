...
#define MIHOYO_SDK_WEBDELEGATE_SETBOUNCESENABLEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CE21DE0)
#define MIHOYO_SDK_WEBDELEGATE_SETBOUNCESENABLEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CE21E60)
#define MIHOYO_SDK_WEBDELEGATE_SETBOUNCESENABLEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CE217D0)
#define MIHOYO_SDK_WEBDELEGATE_SETBOUNCESENABLEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE217B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetBouncesEnabledDelegate_TypeDefinitionIndex = 19938;
