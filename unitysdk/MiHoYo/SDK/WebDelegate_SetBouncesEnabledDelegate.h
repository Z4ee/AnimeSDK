...
#define MIHOYO_SDK_WEBDELEGATE_SETBOUNCESENABLEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18465BE0)
#define MIHOYO_SDK_WEBDELEGATE_SETBOUNCESENABLEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18465C40)
#define MIHOYO_SDK_WEBDELEGATE_SETBOUNCESENABLEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18461FD0)
#define MIHOYO_SDK_WEBDELEGATE_SETBOUNCESENABLEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18465AF0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetBouncesEnabledDelegate_TypeDefinitionIndex = 7776;
