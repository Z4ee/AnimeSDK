...
#define MIHOYO_SDK_INPUTSYSTEMDELEGATE_DELEGATESETIMECOMPOSITIONMODE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B97F230)
#define MIHOYO_SDK_INPUTSYSTEMDELEGATE_DELEGATESETIMECOMPOSITIONMODE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B97F2A0)
#define MIHOYO_SDK_INPUTSYSTEMDELEGATE_DELEGATESETIMECOMPOSITIONMODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B97EF30)
#define MIHOYO_SDK_INPUTSYSTEMDELEGATE_DELEGATESETIMECOMPOSITIONMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B97F1C0)
