...
#define MIHOYO_SDK_MIHOYOSDKCLIENTCONFIGMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1A6C60)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKClientConfigModel_TypeDefinitionIndex = 36722;
