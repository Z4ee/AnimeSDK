...
#define MIHOYO_SDK_MIHOYOSDKCLIENTCONFIGMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD93AF0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKClientConfigModel_TypeDefinitionIndex = 35158;
