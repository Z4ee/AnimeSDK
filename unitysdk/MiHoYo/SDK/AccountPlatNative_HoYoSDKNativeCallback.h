...
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDKNATIVECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15366C30)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDKNATIVECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15366C90)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDKNATIVECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x15366C20)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDKNATIVECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x15366BB0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AccountPlatNative_HoYoSDKNativeCallback_TypeDefinitionIndex = 44356;
