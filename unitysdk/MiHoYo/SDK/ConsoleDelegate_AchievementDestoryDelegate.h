...
#define MIHOYO_SDK_CONSOLEDELEGATE_ACHIEVEMENTDESTORYDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AA43450)
#define MIHOYO_SDK_CONSOLEDELEGATE_ACHIEVEMENTDESTORYDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AA43480)
#define MIHOYO_SDK_CONSOLEDELEGATE_ACHIEVEMENTDESTORYDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AA43440)
#define MIHOYO_SDK_CONSOLEDELEGATE_ACHIEVEMENTDESTORYDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA433D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_AchievementDestoryDelegate_TypeDefinitionIndex = 7596;
