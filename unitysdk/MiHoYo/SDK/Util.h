...
#define MIHOYO_SDK_UTIL_ADDTIME_OFFSET UNITYSDK_OFFSET(0x17674C20)
#define MIHOYO_SDK_UTIL_GENERATESEQUENCEARRAY_1_OFFSET UNITYSDK_OFFSET(0x17689150)
#define MIHOYO_SDK_UTIL_GENERATESEQUENCEARRAY_OFFSET UNITYSDK_OFFSET(0x176890E0)
#define MIHOYO_SDK_UTIL_GETCURRENTTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x17671770)
#define MIHOYO_SDK_UTIL_GETDATETIME_OFFSET UNITYSDK_OFFSET(0x176718D0)
#define MIHOYO_SDK_UTIL_ISHOYODOMAIN_OFFSET UNITYSDK_OFFSET(0x17688E80)
#define MIHOYO_SDK_UTIL_ISVALIDEMAIL_OFFSET UNITYSDK_OFFSET(0x176685A0)
#define MIHOYO_SDK_UTIL_MASKEMAIL_OFFSET UNITYSDK_OFFSET(0x17689230)
#define MIHOYO_SDK_UTIL_YMDTOUTCTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x17689040)
#define MIHOYO_SDK_UTIL__CTOR_OFFSET UNITYSDK_OFFSET(0x17689490)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int Util_TypeDefinitionIndex = 7237;
