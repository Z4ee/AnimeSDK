...
#define MIHOYO_SDK_HOYOSDKHTTPDNSSERVICE_HTTPDNSRESOLVEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x8D17410)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoSDKHttpDnsService_HttpDnsResolveObject_TypeDefinitionIndex = 42700;
