...
#define MIHOYO_SDK_BILIBILIDELEGATE_SDKSTARTHEARTBEATDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19991910)
#define MIHOYO_SDK_BILIBILIDELEGATE_SDKSTARTHEARTBEATDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19991940)
#define MIHOYO_SDK_BILIBILIDELEGATE_SDKSTARTHEARTBEATDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x199913D0)
#define MIHOYO_SDK_BILIBILIDELEGATE_SDKSTARTHEARTBEATDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x199913C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int BiliBiliDelegate_SDKStartHeartbeatDelegate_TypeDefinitionIndex = 18481;
