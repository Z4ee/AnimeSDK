...
#define MIHOYO_SDK_BILIBILIDELEGATE_SDKSTARTHEARTBEATDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BF5E9C0)
#define MIHOYO_SDK_BILIBILIDELEGATE_SDKSTARTHEARTBEATDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BF5E9F0)
#define MIHOYO_SDK_BILIBILIDELEGATE_SDKSTARTHEARTBEATDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BF5E480)
#define MIHOYO_SDK_BILIBILIDELEGATE_SDKSTARTHEARTBEATDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF5E460)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int BiliBiliDelegate_SDKStartHeartbeatDelegate_TypeDefinitionIndex = 19364;
