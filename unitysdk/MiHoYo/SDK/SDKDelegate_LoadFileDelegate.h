...
#define MIHOYO_SDK_SDKDELEGATE_LOADFILEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CF4B750)
#define MIHOYO_SDK_SDKDELEGATE_LOADFILEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CF4B780)
#define MIHOYO_SDK_SDKDELEGATE_LOADFILEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CF4B230)
#define MIHOYO_SDK_SDKDELEGATE_LOADFILEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF4B210)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_LoadFileDelegate_TypeDefinitionIndex = 19892;
