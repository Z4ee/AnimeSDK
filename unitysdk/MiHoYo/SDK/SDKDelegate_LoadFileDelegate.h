...
#define MIHOYO_SDK_SDKDELEGATE_LOADFILEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x176482E0)
#define MIHOYO_SDK_SDKDELEGATE_LOADFILEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17648310)
#define MIHOYO_SDK_SDKDELEGATE_LOADFILEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1763F9E0)
#define MIHOYO_SDK_SDKDELEGATE_LOADFILEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176482C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_LoadFileDelegate_TypeDefinitionIndex = 6828;
