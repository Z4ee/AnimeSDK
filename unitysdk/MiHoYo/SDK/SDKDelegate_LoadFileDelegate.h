...
#define MIHOYO_SDK_SDKDELEGATE_LOADFILEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15FEA5F0)
#define MIHOYO_SDK_SDKDELEGATE_LOADFILEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15FEA620)
#define MIHOYO_SDK_SDKDELEGATE_LOADFILEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15FE1CF0)
#define MIHOYO_SDK_SDKDELEGATE_LOADFILEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15FEA5D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_LoadFileDelegate_TypeDefinitionIndex = 6786;
