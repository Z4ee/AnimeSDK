...
#define MIHOYO_SDK_CONSOLEDELEGATE_REGISTERRECEIVEINVITEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B93FA20)
#define MIHOYO_SDK_CONSOLEDELEGATE_REGISTERRECEIVEINVITEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B93FA50)
#define MIHOYO_SDK_CONSOLEDELEGATE_REGISTERRECEIVEINVITEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B93FA10)
#define MIHOYO_SDK_CONSOLEDELEGATE_REGISTERRECEIVEINVITEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B93F9A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_RegisterReceiveInviteDelegate_TypeDefinitionIndex = 7582;
