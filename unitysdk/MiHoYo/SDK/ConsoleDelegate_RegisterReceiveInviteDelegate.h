...
#define MIHOYO_SDK_CONSOLEDELEGATE_REGISTERRECEIVEINVITEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19930730)
#define MIHOYO_SDK_CONSOLEDELEGATE_REGISTERRECEIVEINVITEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19930760)
#define MIHOYO_SDK_CONSOLEDELEGATE_REGISTERRECEIVEINVITEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19930230)
#define MIHOYO_SDK_CONSOLEDELEGATE_REGISTERRECEIVEINVITEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19930220)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_RegisterReceiveInviteDelegate_TypeDefinitionIndex = 18507;
