...
#define MIHOYO_SDK_CONSOLEDELEGATE_REGISTERRECEIVEINVITEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B9CD130)
#define MIHOYO_SDK_CONSOLEDELEGATE_REGISTERRECEIVEINVITEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B9CD160)
#define MIHOYO_SDK_CONSOLEDELEGATE_REGISTERRECEIVEINVITEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B9CCC30)
#define MIHOYO_SDK_CONSOLEDELEGATE_REGISTERRECEIVEINVITEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9CCC10)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_RegisterReceiveInviteDelegate_TypeDefinitionIndex = 19390;
