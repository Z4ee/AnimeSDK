...
#define MIHOYO_SDK_CONSOLEDELEGATE_REGISTERRECEIVEINVITEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15ED31C0)
#define MIHOYO_SDK_CONSOLEDELEGATE_REGISTERRECEIVEINVITEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15ED31F0)
#define MIHOYO_SDK_CONSOLEDELEGATE_REGISTERRECEIVEINVITEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15ED2C70)
#define MIHOYO_SDK_CONSOLEDELEGATE_REGISTERRECEIVEINVITEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15ED2C50)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_RegisterReceiveInviteDelegate_TypeDefinitionIndex = 6651;
