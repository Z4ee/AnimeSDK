...
#define MIHOYO_SDK_NOTIFICATIONDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x18379E60)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int NotificationDefine_TypeDefinitionIndex = 7538;
