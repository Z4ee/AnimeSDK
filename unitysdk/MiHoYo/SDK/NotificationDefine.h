...
#define MIHOYO_SDK_NOTIFICATIONDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x15F48710)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int NotificationDefine_TypeDefinitionIndex = 6601;
