...
#define MIHOYO_SDK_NOTIFICATIONDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A648CF0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int NotificationDefine_TypeDefinitionIndex = 7532;
