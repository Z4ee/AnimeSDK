...
#define MIHOYO_SDK_KCPCLIENT_ONLOGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AD04140)
#define MIHOYO_SDK_KCPCLIENT_ONLOGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AD041A0)
#define MIHOYO_SDK_KCPCLIENT_ONLOGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AD03930)
#define MIHOYO_SDK_KCPCLIENT_ONLOGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD040D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int KCPClient_OnLogDelegate_TypeDefinitionIndex = 44401;
