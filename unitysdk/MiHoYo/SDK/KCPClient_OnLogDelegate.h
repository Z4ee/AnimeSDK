...
#define MIHOYO_SDK_KCPCLIENT_ONLOGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C700C70)
#define MIHOYO_SDK_KCPCLIENT_ONLOGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C700CD0)
#define MIHOYO_SDK_KCPCLIENT_ONLOGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C700490)
#define MIHOYO_SDK_KCPCLIENT_ONLOGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C700C00)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int KCPClient_OnLogDelegate_TypeDefinitionIndex = 46583;
