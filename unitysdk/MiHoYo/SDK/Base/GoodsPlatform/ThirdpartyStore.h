...
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE_EXCHANGECLOUDGAMESTOREITEMINFO_OFFSET UNITYSDK_OFFSET(0x18869D00)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE_EXCHANGECXSTOREITEMINFO_OFFSET UNITYSDK_OFFSET(0x18869C80)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE_EXCHANGEEPICSTOREITEMINFO_OFFSET UNITYSDK_OFFSET(0x18869CC0)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE_EXCHANGESONYSTOREITEMINFO_OFFSET UNITYSDK_OFFSET(0x18869AB0)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE_EXCHANGESTOREITEMINFO_OFFSET UNITYSDK_OFFSET(0x18866B40)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE_GETGOODSIDLIST_OFFSET UNITYSDK_OFFSET(0x1886A710)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE_GETGOODSWITHNODISCOUNTIDS_OFFSET UNITYSDK_OFFSET(0x18869D50)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE_GETTHIRDPARTYSTORENAME_OFFSET UNITYSDK_OFFSET(0x18864A70)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1886AA20)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE__CTOR_OFFSET UNITYSDK_OFFSET(0x1886AA10)

namespace MiHoYo::SDK::Base::GoodsPlatform
{
	inline static constexpr unsigned int ThirdpartyStore_TypeDefinitionIndex = 8522;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ThirdpartyStore_TypeDefinitionIndex)->GetStaticField(0xEB40);
		}
