...
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE_EXCHANGECLOUDGAMESTOREITEMINFO_OFFSET UNITYSDK_OFFSET(0x1B73A0C0)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE_EXCHANGECXSTOREITEMINFO_OFFSET UNITYSDK_OFFSET(0x1B73A040)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE_EXCHANGEEPICSTOREITEMINFO_OFFSET UNITYSDK_OFFSET(0x1B73A080)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE_EXCHANGESONYSTOREITEMINFO_OFFSET UNITYSDK_OFFSET(0x1B739E70)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE_EXCHANGESTOREITEMINFO_OFFSET UNITYSDK_OFFSET(0x1B736E70)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE_GETGOODSIDLIST_OFFSET UNITYSDK_OFFSET(0x1B73AAD0)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE_GETGOODSWITHNODISCOUNTIDS_OFFSET UNITYSDK_OFFSET(0x1B73A110)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE_GETTHIRDPARTYSTORENAME_OFFSET UNITYSDK_OFFSET(0x1B734D90)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B73ADE0)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B73ADD0)
...
namespace MiHoYo::SDK::Base::GoodsPlatform
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ThirdpartyStore_TypeDefinitionIndex)->GetStaticField(0x49A0);
		}
