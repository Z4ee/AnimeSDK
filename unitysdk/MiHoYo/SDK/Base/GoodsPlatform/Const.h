...
#define MIHOYO_SDK_BASE_GOODSPLATFORM_CONST__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9221A0)

namespace MiHoYo::SDK::Base::GoodsPlatform
{
	inline static constexpr unsigned int Const_TypeDefinitionIndex = 20933;
