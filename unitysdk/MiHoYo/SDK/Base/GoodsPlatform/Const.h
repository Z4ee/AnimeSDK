...
#define MIHOYO_SDK_BASE_GOODSPLATFORM_CONST__CTOR_OFFSET UNITYSDK_OFFSET(0x19449D60)

namespace MiHoYo::SDK::Base::GoodsPlatform
{
	inline static constexpr unsigned int Const_TypeDefinitionIndex = 19425;
