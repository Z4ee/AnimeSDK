...
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE___C__DISPLAYCLASS16_2__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A4440)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE___C__DISPLAYCLASS16_2__EXCHANGESONYSTOREITEMINFO_B__2_OFFSET UNITYSDK_OFFSET(0x1A1A4580)
