...
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE___C__DISPLAYCLASS16_2__CTOR_OFFSET UNITYSDK_OFFSET(0x1886C950)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE___C__DISPLAYCLASS16_2__EXCHANGESONYSTOREITEMINFO_B__2_OFFSET UNITYSDK_OFFSET(0x1886CA90)

namespace MiHoYo::SDK::Base::GoodsPlatform
{
	inline static constexpr unsigned int ThirdpartyStore___c__DisplayClass16_2_TypeDefinitionIndex = 8525;
