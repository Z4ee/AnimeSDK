...
#define MIHOYO_SDK_BASE_GOODSPLATFORM_CDNDATASOURCE_FILTERGOODSLIST_OFFSET UNITYSDK_OFFSET(0x1B5B0C60)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_CDNDATASOURCE_REQUESTALLSONYPRODUCTID_OFFSET UNITYSDK_OFFSET(0x1B5B0A70)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_CDNDATASOURCE_REQUESTGOODSLIST_OFFSET UNITYSDK_OFFSET(0x1B5B0140)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_CDNDATASOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5B12F0)

namespace MiHoYo::SDK::Base::GoodsPlatform
{
	inline static constexpr unsigned int CDNDataSource_TypeDefinitionIndex = 20582;
