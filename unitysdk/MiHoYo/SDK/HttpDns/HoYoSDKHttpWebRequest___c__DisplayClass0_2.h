...
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBREQUEST___C__DISPLAYCLASS0_2__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD91DE0)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBREQUEST___C__DISPLAYCLASS0_2__GETRESPONSE_B__1_OFFSET UNITYSDK_OFFSET(0x1AD91DF0)

namespace MiHoYo::SDK::HttpDns
{
	inline static constexpr unsigned int HoYoSDKHttpWebRequest___c__DisplayClass0_2_TypeDefinitionIndex = 35475;

	class HoYoSDKHttpWebRequest___c__DisplayClass0_2 : public ::System::Object
	{
	public:
		::MiHoYo::SDK::HttpDns::HoYoSDKHttpWebRequest___c__DisplayClass0_1* CS___8__locals2; // 0x10
		::MiHoYo::SDK::HoYoSDKNetworkInterface_CustomHttpRequestHandler* handler; // 0x18
