...
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_CASEINSENSITIVECOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x84EF9C0)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_CASEINSENSITIVECOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x84EF9E0)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_CASEINSENSITIVECOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x84EFA90)

namespace MiHoYo::SDK::HttpDns
{
	inline static constexpr unsigned int HoYoSDKHttpWebResponse_CaseInsensitiveComparer_TypeDefinitionIndex = 37380;
