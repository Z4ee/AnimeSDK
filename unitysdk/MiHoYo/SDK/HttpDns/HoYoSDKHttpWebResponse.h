...
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_CLOSE_OFFSET UNITYSDK_OFFSET(0x1ACFDAC0)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1ACFDAD0)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_DOHTTPREQUEST_OFFSET UNITYSDK_OFFSET(0x1ACFD020)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_DOLOGGER_OFFSET UNITYSDK_OFFSET(0x1ACFDC20)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_GETRESPONSEHEADER_OFFSET UNITYSDK_OFFSET(0x1ACFDCF0)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_GETRESPONSESTREAM_OFFSET UNITYSDK_OFFSET(0x1ACFD9E0)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_GET_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1ACFE000)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_GET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1ACFE020)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_GET_ERRORCODE_OFFSET UNITYSDK_OFFSET(0x1ACFE080)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_GET_ERRORMSG_OFFSET UNITYSDK_OFFSET(0x1ACFE0A0)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_GET_SESSIONID_OFFSET UNITYSDK_OFFSET(0x1ACFE060)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_GET_STATUSCODE_OFFSET UNITYSDK_OFFSET(0x1ACFE040)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_NATIVEPTRTOBYTES_OFFSET UNITYSDK_OFFSET(0x1ACFDF90)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_SET_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1ACFE010)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_SET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1ACFE030)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_SET_ERRORCODE_OFFSET UNITYSDK_OFFSET(0x1ACFE090)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_SET_ERRORMSG_OFFSET UNITYSDK_OFFSET(0x1ACFE0B0)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_SET_SESSIONID_OFFSET UNITYSDK_OFFSET(0x1ACFE070)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_SET_STATUSCODE_OFFSET UNITYSDK_OFFSET(0x1ACFE050)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACFC740)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE__DOHTTPREQUEST_B__4_0_OFFSET UNITYSDK_OFFSET(0x1ACFE0C0)

namespace MiHoYo::SDK::HttpDns
{
	inline static constexpr unsigned int HoYoSDKHttpWebResponse_TypeDefinitionIndex = 44921;
	...
	public:
		...
		::System::IO::Stream* m_responseStream; // 0x18
		...
		::System::Net::HttpStatusCode _StatusCode_k__BackingField; // 0x38
