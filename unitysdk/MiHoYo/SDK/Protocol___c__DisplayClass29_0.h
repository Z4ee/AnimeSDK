...
#define MIHOYO_SDK_PROTOCOL___C__DISPLAYCLASS29_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15FBE7A0)
#define MIHOYO_SDK_PROTOCOL___C__DISPLAYCLASS29_0__SHOW_B__0_OFFSET UNITYSDK_OFFSET(0x15FBFBA0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int Protocol___c__DisplayClass29_0_TypeDefinitionIndex = 7244;
