...
#define MIHOYO_SDK_WEBDELEGATE_SHOWDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C914D70)
#define MIHOYO_SDK_WEBDELEGATE_SHOWDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C914DA0)
#define MIHOYO_SDK_WEBDELEGATE_SHOWDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C914850)
#define MIHOYO_SDK_WEBDELEGATE_SHOWDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C914830)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_ShowDelegate_TypeDefinitionIndex = 19934;
