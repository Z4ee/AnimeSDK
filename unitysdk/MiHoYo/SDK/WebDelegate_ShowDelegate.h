...
#define MIHOYO_SDK_WEBDELEGATE_SHOWDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15C27560)
#define MIHOYO_SDK_WEBDELEGATE_SHOWDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15C27590)
#define MIHOYO_SDK_WEBDELEGATE_SHOWDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15C22430)
#define MIHOYO_SDK_WEBDELEGATE_SHOWDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15C27470)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_ShowDelegate_TypeDefinitionIndex = 7778;
