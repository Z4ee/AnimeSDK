...
#define MIHOYO_SDK_CONSOLEDELEGATE_AUTHCODECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CCFD600)
#define MIHOYO_SDK_CONSOLEDELEGATE_AUTHCODECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CCFD6A0)
#define MIHOYO_SDK_CONSOLEDELEGATE_AUTHCODECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CCFD2D0)
#define MIHOYO_SDK_CONSOLEDELEGATE_AUTHCODECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCFD2B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_AuthCodeCallback_TypeDefinitionIndex = 19745;
