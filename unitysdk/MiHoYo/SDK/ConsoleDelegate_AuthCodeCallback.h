...
#define MIHOYO_SDK_CONSOLEDELEGATE_AUTHCODECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A17A090)
#define MIHOYO_SDK_CONSOLEDELEGATE_AUTHCODECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A17A130)
#define MIHOYO_SDK_CONSOLEDELEGATE_AUTHCODECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A179D10)
#define MIHOYO_SDK_CONSOLEDELEGATE_AUTHCODECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A179D00)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_AuthCodeCallback_TypeDefinitionIndex = 18514;
