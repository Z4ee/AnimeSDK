...
#define MIHOYO_SDK_CONSOLEDELEGATE_AUTHCODECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BA7CBB0)
#define MIHOYO_SDK_CONSOLEDELEGATE_AUTHCODECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BA7CC50)
#define MIHOYO_SDK_CONSOLEDELEGATE_AUTHCODECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BA7C830)
#define MIHOYO_SDK_CONSOLEDELEGATE_AUTHCODECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA7C810)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_AuthCodeCallback_TypeDefinitionIndex = 19398;
