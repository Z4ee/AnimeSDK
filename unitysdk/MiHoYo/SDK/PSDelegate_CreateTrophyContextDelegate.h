...
#define MIHOYO_SDK_PSDELEGATE_CREATETROPHYCONTEXTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19B5AAC0)
#define MIHOYO_SDK_PSDELEGATE_CREATETROPHYCONTEXTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19B5AB30)
#define MIHOYO_SDK_PSDELEGATE_CREATETROPHYCONTEXTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19B5A780)
#define MIHOYO_SDK_PSDELEGATE_CREATETROPHYCONTEXTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B5A770)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_CreateTrophyContextDelegate_TypeDefinitionIndex = 18611;
