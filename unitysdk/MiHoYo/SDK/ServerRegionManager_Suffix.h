...
#define MIHOYO_SDK_SERVERREGIONMANAGER_SUFFIX__CTOR_OFFSET UNITYSDK_OFFSET(0x1712C800)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ServerRegionManager_Suffix_TypeDefinitionIndex = 7918;
