...
{
	inline static constexpr unsigned int MHYSDKC_Cloud_TypeDefinitionIndex = 43572;
	...
	public:
		...
		// static const ::System::String* KEY_MAX_TEXT_LENGTH; // 0x0
		// static const ::System::String* KEY_TEXT; // 0x0
		// static const ::System::String* KEY_PLACEHOLDER; // 0x0
	};
}
