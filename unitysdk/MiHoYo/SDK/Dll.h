...
#define MIHOYO_SDK_DLL_ADD_DLLDESTROYHANDLER_OFFSET UNITYSDK_OFFSET(0x15EDBB00)
#define MIHOYO_SDK_DLL_ADD_ONESC_OFFSET UNITYSDK_OFFSET(0x15EDBA40)
#define MIHOYO_SDK_DLL_ADD_ONRETURN_OFFSET UNITYSDK_OFFSET(0x15EDB980)
#define MIHOYO_SDK_DLL_ADD_ONTAB_OFFSET UNITYSDK_OFFSET(0x15EDB8C0)
#define MIHOYO_SDK_DLL_INSTANCE_OFFSET UNITYSDK_OFFSET(0x15EAE090)
#define MIHOYO_SDK_DLL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x15EDC020)
#define MIHOYO_SDK_DLL_REMOVE_DLLDESTROYHANDLER_OFFSET UNITYSDK_OFFSET(0x15EDBB60)
#define MIHOYO_SDK_DLL_REMOVE_ONESC_OFFSET UNITYSDK_OFFSET(0x15EDBAA0)
#define MIHOYO_SDK_DLL_REMOVE_ONRETURN_OFFSET UNITYSDK_OFFSET(0x15EDB9E0)
#define MIHOYO_SDK_DLL_REMOVE_ONTAB_OFFSET UNITYSDK_OFFSET(0x15EDB920)
#define MIHOYO_SDK_DLL_UPDATE_OFFSET UNITYSDK_OFFSET(0x15EDBBC0)
#define MIHOYO_SDK_DLL__CTOR_OFFSET UNITYSDK_OFFSET(0x15EDC030)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int Dll_TypeDefinitionIndex = 6939;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Dll**)Il2CppClass::FromTypeDefinitionIndex(Dll_TypeDefinitionIndex)->GetStaticField(0x13500);
		}
