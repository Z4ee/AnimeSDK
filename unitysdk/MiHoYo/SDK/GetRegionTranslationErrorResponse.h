...
#define MIHOYO_SDK_GETREGIONTRANSLATIONERRORRESPONSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF64760)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int GetRegionTranslationErrorResponse_TypeDefinitionIndex = 19717;
