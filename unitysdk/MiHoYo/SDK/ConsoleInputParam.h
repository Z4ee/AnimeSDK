...
#define MIHOYO_SDK_CONSOLEINPUTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBA090)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleInputParam_TypeDefinitionIndex = 19683;
