...
#define MIHOYO_SDK_WEBDELEGATE_PRELOADDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16041290)
#define MIHOYO_SDK_WEBDELEGATE_PRELOADDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16041300)
#define MIHOYO_SDK_WEBDELEGATE_PRELOADDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x16030810)
#define MIHOYO_SDK_WEBDELEGATE_PRELOADDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16041270)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_PreLoadDelegate_TypeDefinitionIndex = 6816;
