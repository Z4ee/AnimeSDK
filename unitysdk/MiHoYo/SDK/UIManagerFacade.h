...
#define MIHOYO_SDK_UIMANAGERFACADE_DESTROYALLUI_OFFSET UNITYSDK_OFFSET(0x1D773D70)
#define MIHOYO_SDK_UIMANAGERFACADE_ENABLEUITRACKING_OFFSET UNITYSDK_OFFSET(0x1D773D50)
#define MIHOYO_SDK_UIMANAGERFACADE_GET_INSATANCE_OFFSET UNITYSDK_OFFSET(0x1D773A90)
#define MIHOYO_SDK_UIMANAGERFACADE_ISENABLEUITRACKING_OFFSET UNITYSDK_OFFSET(0x1D773D60)
#define MIHOYO_SDK_UIMANAGERFACADE_POPUIMANAGER_OFFSET UNITYSDK_OFFSET(0x1D7741E0)
#define MIHOYO_SDK_UIMANAGERFACADE_PUSHUIMANAGER_OFFSET UNITYSDK_OFFSET(0x1D7740D0)
#define MIHOYO_SDK_UIMANAGERFACADE_SET_INSATANCE_OFFSET UNITYSDK_OFFSET(0x1D773CF0)
#define MIHOYO_SDK_UIMANAGERFACADE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D7742D0)
#define MIHOYO_SDK_UIMANAGERFACADE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D773C20)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int UIManagerFacade_TypeDefinitionIndex = 20373;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::UIManagerFacade**)Il2CppClass::FromTypeDefinitionIndex(UIManagerFacade_TypeDefinitionIndex)->GetStaticField(0xAFE0);
		}
