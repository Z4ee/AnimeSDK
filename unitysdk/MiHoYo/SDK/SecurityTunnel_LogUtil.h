...
#define MIHOYO_SDK_SECURITYTUNNEL_LOGUTIL_FORMATBYTES_OFFSET UNITYSDK_OFFSET(0x19FBAE60)
#define MIHOYO_SDK_SECURITYTUNNEL_LOGUTIL__CTOR_OFFSET UNITYSDK_OFFSET(0x19FBAFE0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_LogUtil_TypeDefinitionIndex = 35230;
