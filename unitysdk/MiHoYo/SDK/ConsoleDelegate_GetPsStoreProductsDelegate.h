...
#define MIHOYO_SDK_CONSOLEDELEGATE_GETPSSTOREPRODUCTSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15ECE120)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETPSSTOREPRODUCTSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15ECE160)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETPSSTOREPRODUCTSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15ECDBA0)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETPSSTOREPRODUCTSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15ECDB80)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_GetPsStoreProductsDelegate_TypeDefinitionIndex = 6661;
