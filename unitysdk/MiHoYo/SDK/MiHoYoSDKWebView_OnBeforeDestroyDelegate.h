...
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONBEFOREDESTROYDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA1C4130)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONBEFOREDESTROYDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA1C4160)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONBEFOREDESTROYDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xA1C3BF0)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONBEFOREDESTROYDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xA1C4040)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKWebView_OnBeforeDestroyDelegate_TypeDefinitionIndex = 43966;
