...
#define MIHOYO_SDK_PS_USERGAMESERVERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x15F8FD50)

namespace MiHoYo::SDK::PS
{
	inline static constexpr unsigned int UserGameServerInfo_TypeDefinitionIndex = 7550;
