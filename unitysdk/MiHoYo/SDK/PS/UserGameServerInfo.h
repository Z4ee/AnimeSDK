...
#define MIHOYO_SDK_PS_USERGAMESERVERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1945D510)

namespace MiHoYo::SDK::PS
{
	inline static constexpr unsigned int UserGameServerInfo_TypeDefinitionIndex = 8606;
