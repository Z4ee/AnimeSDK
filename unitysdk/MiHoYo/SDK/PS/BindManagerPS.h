...
#define MIHOYO_SDK_PS_BINDMANAGERPS_CANCELBINDING_OFFSET UNITYSDK_OFFSET(0x1C576C00)
#define MIHOYO_SDK_PS_BINDMANAGERPS_ENVCHANGED_OFFSET UNITYSDK_OFFSET(0x1C576940)
#define MIHOYO_SDK_PS_BINDMANAGERPS_EXTRACTFIRSTNONPSTHIRDPARTYNAME_OFFSET UNITYSDK_OFFSET(0x1C5774D0)
#define MIHOYO_SDK_PS_BINDMANAGERPS_EXTRACTSNOYACCOUNTNAME_OFFSET UNITYSDK_OFFSET(0x1C577840)
#define MIHOYO_SDK_PS_BINDMANAGERPS_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1C576770)
#define MIHOYO_SDK_PS_BINDMANAGERPS_LOGREPORT_OFFSET UNITYSDK_OFFSET(0x1C577120)
#define MIHOYO_SDK_PS_BINDMANAGERPS_SHOWBINDINGDIALOG_OFFSET UNITYSDK_OFFSET(0x1C5769E0)
#define MIHOYO_SDK_PS_BINDMANAGERPS_SHOWBINDSUCCESSDIALOG_OFFSET UNITYSDK_OFFSET(0x1C576F90)
#define MIHOYO_SDK_PS_BINDMANAGERPS_SHOWREACTIVATEDIALOG_OFFSET UNITYSDK_OFFSET(0x1C577390)
#define MIHOYO_SDK_PS_BINDMANAGERPS_STARTACCOUNTBINDING_OFFSET UNITYSDK_OFFSET(0x1C5769D0)
#define MIHOYO_SDK_PS_BINDMANAGERPS_STARTWEBBINDINGRESULTQUERYLOOP_OFFSET UNITYSDK_OFFSET(0x1C576DE0)
#define MIHOYO_SDK_PS_BINDMANAGERPS_STOPWEBBINDINGRESULTQUERYLOOP_OFFSET UNITYSDK_OFFSET(0x1C576D30)
#define MIHOYO_SDK_PS_BINDMANAGERPS_UPDATEACCESSTOKEN_OFFSET UNITYSDK_OFFSET(0x1C577B50)
#define MIHOYO_SDK_PS_BINDMANAGERPS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C577C60)
#define MIHOYO_SDK_PS_BINDMANAGERPS__SHOWBINDINGDIALOG_B__18_0_OFFSET UNITYSDK_OFFSET(0x1C577C70)
#define MIHOYO_SDK_PS_BINDMANAGERPS__SHOWBINDINGDIALOG_B__18_1_OFFSET UNITYSDK_OFFSET(0x1C577D30)
#define MIHOYO_SDK_PS_BINDMANAGERPS__SHOWBINDINGDIALOG_B__18_2_OFFSET UNITYSDK_OFFSET(0x1C577DE0)
#define MIHOYO_SDK_PS_BINDMANAGERPS__SHOWBINDINGDIALOG_B__18_3_OFFSET UNITYSDK_OFFSET(0x1C577EA0)
#define MIHOYO_SDK_PS_BINDMANAGERPS__SHOWBINDSUCCESSDIALOG_B__19_0_OFFSET UNITYSDK_OFFSET(0x1C577F40)
#define MIHOYO_SDK_PS_BINDMANAGERPS__SHOWREACTIVATEDIALOG_B__20_0_OFFSET UNITYSDK_OFFSET(0x1C578080)
#define MIHOYO_SDK_PS_BINDMANAGERPS__SHOWREACTIVATEDIALOG_B__20_1_OFFSET UNITYSDK_OFFSET(0x1C578130)

namespace MiHoYo::SDK::PS
{
	inline static constexpr unsigned int BindManagerPS_TypeDefinitionIndex = 20639;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PS::BindManagerPS**)Il2CppClass::FromTypeDefinitionIndex(BindManagerPS_TypeDefinitionIndex)->GetStaticField(0xB580);
		}
