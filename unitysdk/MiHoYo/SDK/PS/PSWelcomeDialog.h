...
#define MIHOYO_SDK_PS_PSWELCOMEDIALOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A1816B0)
#define MIHOYO_SDK_PS_PSWELCOMEDIALOG_BINDEXISTINGACCOUNT_OFFSET UNITYSDK_OFFSET(0x1A182720)
#define MIHOYO_SDK_PS_PSWELCOMEDIALOG_CANCELDIALOG_OFFSET UNITYSDK_OFFSET(0x1A182750)
#define MIHOYO_SDK_PS_PSWELCOMEDIALOG_CONFIRMDIALOG_OFFSET UNITYSDK_OFFSET(0x1A182770)
#define MIHOYO_SDK_PS_PSWELCOMEDIALOG_CREATEANDBINDNEWACCOUNT_OFFSET UNITYSDK_OFFSET(0x1A182740)
#define MIHOYO_SDK_PS_PSWELCOMEDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x1A181640)
#define MIHOYO_SDK_PS_PSWELCOMEDIALOG_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A182350)
#define MIHOYO_SDK_PS_PSWELCOMEDIALOG_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A182320)
#define MIHOYO_SDK_PS_PSWELCOMEDIALOG_SHOWBINDMODESELECTION_OFFSET UNITYSDK_OFFSET(0x1A182080)
#define MIHOYO_SDK_PS_PSWELCOMEDIALOG_SHOWNEWACCOUNTPROMPT_OFFSET UNITYSDK_OFFSET(0x1A182370)
#define MIHOYO_SDK_PS_PSWELCOMEDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x1A181510)
#define MIHOYO_SDK_PS_PSWELCOMEDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A182790)

namespace MiHoYo::SDK::PS
{
	inline static constexpr unsigned int PSWelcomeDialog_TypeDefinitionIndex = 19527;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PS::PSWelcomeDialog**)Il2CppClass::FromTypeDefinitionIndex(PSWelcomeDialog_TypeDefinitionIndex)->GetStaticField(0xA270);
		}
