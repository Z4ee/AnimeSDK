...
#define MIHOYO_SDK_PS_SDKUICONTROLLER_GETACTIVEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1CAD61A0)
#define MIHOYO_SDK_PS_SDKUICONTROLLER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1CAD56D0)
#define MIHOYO_SDK_PS_SDKUICONTROLLER_HIGHLIGHTNEXTGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1CAD59F0)
#define MIHOYO_SDK_PS_SDKUICONTROLLER_SEARCHNEXTHIGHLIGHTGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1CAD6370)
#define MIHOYO_SDK_PS_SDKUICONTROLLER_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1CAD56E0)
#define MIHOYO_SDK_PS_SDKUICONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x1CAD56F0)
#define MIHOYO_SDK_PS_SDKUICONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1CAD5700)
#define MIHOYO_SDK_PS_SDKUICONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAD7060)

namespace MiHoYo::SDK::PS
{
	inline static constexpr unsigned int SDKUIController_TypeDefinitionIndex = 21017;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PS::SDKUIController**)Il2CppClass::FromTypeDefinitionIndex(SDKUIController_TypeDefinitionIndex)->GetStaticField(0xA830);
		}
