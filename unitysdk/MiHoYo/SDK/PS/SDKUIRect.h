...
#define MIHOYO_SDK_PS_SDKUIRECT_CONTAINS_OFFSET UNITYSDK_OFFSET(0x9528C0)
#define MIHOYO_SDK_PS_SDKUIRECT_GET_BOTTOM_OFFSET UNITYSDK_OFFSET(0x952820)
#define MIHOYO_SDK_PS_SDKUIRECT_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x952870)
#define MIHOYO_SDK_PS_SDKUIRECT_GET_LEFT_OFFSET UNITYSDK_OFFSET(0x45B300)
#define MIHOYO_SDK_PS_SDKUIRECT_GET_MIDX_OFFSET UNITYSDK_OFFSET(0x952830)
#define MIHOYO_SDK_PS_SDKUIRECT_GET_MIDY_OFFSET UNITYSDK_OFFSET(0x952850)
#define MIHOYO_SDK_PS_SDKUIRECT_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x785550)
#define MIHOYO_SDK_PS_SDKUIRECT_GET_TOP_OFFSET UNITYSDK_OFFSET(0x40C5C0)
#define MIHOYO_SDK_PS_SDKUIRECT_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x1C396A60)
#define MIHOYO_SDK_PS_SDKUIRECT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x95DA00)
#define MIHOYO_SDK_PS_SDKUIRECT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x95D9F0)
#define MIHOYO_SDK_PS_SDKUIRECT__CTOR_OFFSET UNITYSDK_OFFSET(0x776510)

namespace MiHoYo::SDK::PS
{
	inline static constexpr unsigned int SDKUIRect_TypeDefinitionIndex = 20675;
