...
#define MIHOYO_SDK_PS_SDKUIRECT_CONTAINS_OFFSET UNITYSDK_OFFSET(0x3829600)
#define MIHOYO_SDK_PS_SDKUIRECT_GET_BOTTOM_OFFSET UNITYSDK_OFFSET(0x3829560)
#define MIHOYO_SDK_PS_SDKUIRECT_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x38295B0)
#define MIHOYO_SDK_PS_SDKUIRECT_GET_LEFT_OFFSET UNITYSDK_OFFSET(0xD4D0)
#define MIHOYO_SDK_PS_SDKUIRECT_GET_MIDX_OFFSET UNITYSDK_OFFSET(0x3829570)
#define MIHOYO_SDK_PS_SDKUIRECT_GET_MIDY_OFFSET UNITYSDK_OFFSET(0x3829590)
#define MIHOYO_SDK_PS_SDKUIRECT_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x3829550)
#define MIHOYO_SDK_PS_SDKUIRECT_GET_TOP_OFFSET UNITYSDK_OFFSET(0xD4F0)
#define MIHOYO_SDK_PS_SDKUIRECT_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x183CF1C0)
#define MIHOYO_SDK_PS_SDKUIRECT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x382B1E0)
#define MIHOYO_SDK_PS_SDKUIRECT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x382B1D0)
#define MIHOYO_SDK_PS_SDKUIRECT__CTOR_OFFSET UNITYSDK_OFFSET(0x259B0)

namespace MiHoYo::SDK::PS
{
	inline static constexpr unsigned int SDKUIRect_TypeDefinitionIndex = 8590;
