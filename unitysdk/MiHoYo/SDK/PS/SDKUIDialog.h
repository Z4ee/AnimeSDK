...
#define MIHOYO_SDK_PS_SDKUIDIALOG_FIREBUTTON_OFFSET UNITYSDK_OFFSET(0x1CD14790)
#define MIHOYO_SDK_PS_SDKUIDIALOG_FIREINPUTFIELD_OFFSET UNITYSDK_OFFSET(0x1CD14960)
#define MIHOYO_SDK_PS_SDKUIDIALOG_FIRESLIDER_OFFSET UNITYSDK_OFFSET(0x1CD14D20)
#define MIHOYO_SDK_PS_SDKUIDIALOG_FIRETOGGLE_OFFSET UNITYSDK_OFFSET(0x1CD14B20)
#define MIHOYO_SDK_PS_SDKUIDIALOG_FIRE_OFFSET UNITYSDK_OFFSET(0x1CD144A0)
#define MIHOYO_SDK_PS_SDKUIDIALOG_GET_HIGHLIGHTEDOBJECT_OFFSET UNITYSDK_OFFSET(0x1CD12D10)
#define MIHOYO_SDK_PS_SDKUIDIALOG_GET_ISFOCUSED_OFFSET UNITYSDK_OFFSET(0x1CD13F30)
#define MIHOYO_SDK_PS_SDKUIDIALOG_ONIMEDIALOGCLOSECALLBACK_OFFSET UNITYSDK_OFFSET(0x1CD15100)
#define MIHOYO_SDK_PS_SDKUIDIALOG_ONIMEDIALOGCOMPLETECALLBACK_OFFSET UNITYSDK_OFFSET(0x1CD153A0)
#define MIHOYO_SDK_PS_SDKUIDIALOG_OPENIME_OFFSET UNITYSDK_OFFSET(0x1CD14ED0)
#define MIHOYO_SDK_PS_SDKUIDIALOG_SETHIGHLIGHTOBJECT_OFFSET UNITYSDK_OFFSET(0x1CD12D30)
#define MIHOYO_SDK_PS_SDKUIDIALOG_SET_HIGHLIGHTEDOBJECT_OFFSET UNITYSDK_OFFSET(0x1CD12D20)
#define MIHOYO_SDK_PS_SDKUIDIALOG_SET_ISFOCUSED_OFFSET UNITYSDK_OFFSET(0x1CD13F40)
#define MIHOYO_SDK_PS_SDKUIDIALOG_UPDATEINPUTFIELD_OFFSET UNITYSDK_OFFSET(0x1CD140C0)
#define MIHOYO_SDK_PS_SDKUIDIALOG_UPDATESLIDER_OFFSET UNITYSDK_OFFSET(0x1CD14230)
#define MIHOYO_SDK_PS_SDKUIDIALOG_UPDATE_OFFSET UNITYSDK_OFFSET(0x1CD13F50)
#define MIHOYO_SDK_PS_SDKUIDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD15780)

namespace MiHoYo::SDK::PS
{
	inline static constexpr unsigned int SDKUIDialog_TypeDefinitionIndex = 21021;
