...
#define MIHOYO_SDK_PS_PSACCOUNTINFODIALOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x1AA556D0)
#define MIHOYO_SDK_PS_PSACCOUNTINFODIALOG_CANCELDIALOG_OFFSET UNITYSDK_OFFSET(0x1AA57A50)
#define MIHOYO_SDK_PS_PSACCOUNTINFODIALOG_CONFIRMDIALOG_OFFSET UNITYSDK_OFFSET(0x1AA57A30)
#define MIHOYO_SDK_PS_PSACCOUNTINFODIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x1AA55510)
#define MIHOYO_SDK_PS_PSACCOUNTINFODIALOG_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AA57A10)
#define MIHOYO_SDK_PS_PSACCOUNTINFODIALOG_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x1AA55580)
#define MIHOYO_SDK_PS_PSACCOUNTINFODIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x1AA55410)
#define MIHOYO_SDK_PS_PSACCOUNTINFODIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA57A70)

namespace MiHoYo::SDK::PS
{
	inline static constexpr unsigned int PSAccountInfoDialog_TypeDefinitionIndex = 19519;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PS::PSAccountInfoDialog**)Il2CppClass::FromTypeDefinitionIndex(PSAccountInfoDialog_TypeDefinitionIndex)->GetStaticField(0x9030);
		}
