...
#define MIHOYO_SDK_PS_PSBINDINGSUCCESSDIALOG__AUTOCLOSECOUNTDOWN_D__17_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x199A7F90)
#define MIHOYO_SDK_PS_PSBINDINGSUCCESSDIALOG__AUTOCLOSECOUNTDOWN_D__17_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x199A8120)
#define MIHOYO_SDK_PS_PSBINDINGSUCCESSDIALOG__AUTOCLOSECOUNTDOWN_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x199A8180)
#define MIHOYO_SDK_PS_PSBINDINGSUCCESSDIALOG__AUTOCLOSECOUNTDOWN_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x199A8130)
#define MIHOYO_SDK_PS_PSBINDINGSUCCESSDIALOG__AUTOCLOSECOUNTDOWN_D__17_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x199A7F80)
#define MIHOYO_SDK_PS_PSBINDINGSUCCESSDIALOG__AUTOCLOSECOUNTDOWN_D__17__CTOR_OFFSET UNITYSDK_OFFSET(0x199A7F70)

namespace MiHoYo::SDK::PS
{
	inline static constexpr unsigned int PSBindingSuccessDialog__AutoCloseCountdown_d__17_TypeDefinitionIndex = 19526;
