...
#define MIHOYO_SDK_PS_PSBINDINGSUCCESSDIALOG__AUTOCLOSECOUNTDOWN_D__17_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BF78280)
#define MIHOYO_SDK_PS_PSBINDINGSUCCESSDIALOG__AUTOCLOSECOUNTDOWN_D__17_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BF78410)
#define MIHOYO_SDK_PS_PSBINDINGSUCCESSDIALOG__AUTOCLOSECOUNTDOWN_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BF78470)
#define MIHOYO_SDK_PS_PSBINDINGSUCCESSDIALOG__AUTOCLOSECOUNTDOWN_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BF78420)
#define MIHOYO_SDK_PS_PSBINDINGSUCCESSDIALOG__AUTOCLOSECOUNTDOWN_D__17_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BF78270)
#define MIHOYO_SDK_PS_PSBINDINGSUCCESSDIALOG__AUTOCLOSECOUNTDOWN_D__17__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF78260)

namespace MiHoYo::SDK::PS
{
	inline static constexpr unsigned int PSBindingSuccessDialog__AutoCloseCountdown_d__17_TypeDefinitionIndex = 20687;
