...
#define MIHOYO_SDK_PS_BINDINGMANAGERPSOS___C__DISPLAYCLASS24_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1942A110)
#define MIHOYO_SDK_PS_BINDINGMANAGERPSOS___C__DISPLAYCLASS24_0__PERFORMBINDINGFLOW_B__0_OFFSET UNITYSDK_OFFSET(0x1942D440)
#define MIHOYO_SDK_PS_BINDINGMANAGERPSOS___C__DISPLAYCLASS24_0__PERFORMBINDINGFLOW_B__1_OFFSET UNITYSDK_OFFSET(0x1942DAE0)

namespace MiHoYo::SDK::PS
{
	inline static constexpr unsigned int BindingManagerPSOS___c__DisplayClass24_0_TypeDefinitionIndex = 8573;
