...
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B5C59E0)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_CANCELDIALOG_OFFSET UNITYSDK_OFFSET(0x1B5C9EE0)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_CAPTCHACODEVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1B5C92B0)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_CAPTCHARESENDCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1B5C5990)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_CLEARCAPTCHACODE_OFFSET UNITYSDK_OFFSET(0x1B5C2E30)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x1B5C3FD0)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_INVALIDATEQRCODE_OFFSET UNITYSDK_OFFSET(0x1B5C5380)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_LOADINGQRCODE_OFFSET UNITYSDK_OFFSET(0x1B5C4FA0)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_MAILINPUTVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1B5C9210)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_ONAGREEMENTTOGGLECLICKED_OFFSET UNITYSDK_OFFSET(0x1B5C9BA0)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_ONBINDBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1B5C9D40)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_ONCAPTCHARESENDCOUNTDOWNEND_OFFSET UNITYSDK_OFFSET(0x1B5C9530)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B5C9160)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_ONGETCAPTCHACODE_OFFSET UNITYSDK_OFFSET(0x1B5C8EA0)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_ONHIGHLIGHTEDOBJECTCHANGED_OFFSET UNITYSDK_OFFSET(0x1B5C9780)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_ONREFRESHQRIMAGE_OFFSET UNITYSDK_OFFSET(0x1B5C90D0)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_PHONEINPUTVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1B5C9180)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_SETBOTTOMBUTTONSENABLE_OFFSET UNITYSDK_OFFSET(0x1B5C4DC0)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x1B5C2A50)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_SETQRIMAGE_OFFSET UNITYSDK_OFFSET(0x1B5C5140)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_SETSENDCAPTCHABUTTONENABLE_OFFSET UNITYSDK_OFFSET(0x1B5C5560)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x1B5C4C90)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_STARTCAPTCHACOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1B5C2550)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_START_OFFSET UNITYSDK_OFFSET(0x1B5C89F0)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_UPDATECAPTCHARESENDCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1B5C9420)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B5C8BE0)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C9F20)

namespace MiHoYo::SDK::PS
{
	inline static constexpr unsigned int PSAccountBindingDialog_TypeDefinitionIndex = 20676;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PS::PSAccountBindingDialog**)Il2CppClass::FromTypeDefinitionIndex(PSAccountBindingDialog_TypeDefinitionIndex)->GetStaticField(0x9420);
		}
