...
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x1945ABA0)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_CANCELDIALOG_OFFSET UNITYSDK_OFFSET(0x1945F090)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_CAPTCHACODEVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1945E460)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_CAPTCHARESENDCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1945AB50)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_CLEARCAPTCHACODE_OFFSET UNITYSDK_OFFSET(0x19457FF0)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x19459190)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_INVALIDATEQRCODE_OFFSET UNITYSDK_OFFSET(0x1945A540)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_LOADINGQRCODE_OFFSET UNITYSDK_OFFSET(0x1945A160)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_MAILINPUTVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1945E3C0)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_ONAGREEMENTTOGGLECLICKED_OFFSET UNITYSDK_OFFSET(0x1945ED50)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_ONBINDBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x1945EEF0)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_ONCAPTCHARESENDCOUNTDOWNEND_OFFSET UNITYSDK_OFFSET(0x1945E6E0)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1945E310)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_ONGETCAPTCHACODE_OFFSET UNITYSDK_OFFSET(0x1945E050)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_ONHIGHLIGHTEDOBJECTCHANGED_OFFSET UNITYSDK_OFFSET(0x1945E930)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_ONREFRESHQRIMAGE_OFFSET UNITYSDK_OFFSET(0x1945E280)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_PHONEINPUTVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1945E330)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_SETBOTTOMBUTTONSENABLE_OFFSET UNITYSDK_OFFSET(0x19459F80)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x19457C10)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_SETQRIMAGE_OFFSET UNITYSDK_OFFSET(0x1945A300)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_SETSENDCAPTCHABUTTONENABLE_OFFSET UNITYSDK_OFFSET(0x1945A720)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x19459E50)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_STARTCAPTCHACOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x19457710)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_START_OFFSET UNITYSDK_OFFSET(0x1945DBB0)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_UPDATECAPTCHARESENDCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1945E5D0)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG_UPDATE_OFFSET UNITYSDK_OFFSET(0x1945DD90)
#define MIHOYO_SDK_PS_PSACCOUNTBINDINGDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1945F0D0)

namespace MiHoYo::SDK::PS
{
	inline static constexpr unsigned int PSAccountBindingDialog_TypeDefinitionIndex = 19515;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PS::PSAccountBindingDialog**)Il2CppClass::FromTypeDefinitionIndex(PSAccountBindingDialog_TypeDefinitionIndex)->GetStaticField(0x91C0);
		}
