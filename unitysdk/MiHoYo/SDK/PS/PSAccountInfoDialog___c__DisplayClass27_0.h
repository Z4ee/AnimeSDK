...
#define MIHOYO_SDK_PS_PSACCOUNTINFODIALOG___C__DISPLAYCLASS27_0__CTOR_OFFSET UNITYSDK_OFFSET(0x183BE9C0)
#define MIHOYO_SDK_PS_PSACCOUNTINFODIALOG___C__DISPLAYCLASS27_0__SHOW_B__0_OFFSET UNITYSDK_OFFSET(0x183C0A30)
#define MIHOYO_SDK_PS_PSACCOUNTINFODIALOG___C__DISPLAYCLASS27_0__SHOW_B__1_OFFSET UNITYSDK_OFFSET(0x183C0BD0)
#define MIHOYO_SDK_PS_PSACCOUNTINFODIALOG___C__DISPLAYCLASS27_0__SHOW_B__2_OFFSET UNITYSDK_OFFSET(0x183C0C20)

namespace MiHoYo::SDK::PS
{
	inline static constexpr unsigned int PSAccountInfoDialog___c__DisplayClass27_0_TypeDefinitionIndex = 8596;
	...
	public:
		...
		::System::Collections::Generic::List_1<::MiHoYo::SDK::PS::UserGameServerInfo*>* userGameInfoList; // 0x20
