...
#define MIHOYO_SDK_ALERTWITHTITLE___C__DISPLAYCLASS19_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0C4910)
#define MIHOYO_SDK_ALERTWITHTITLE___C__DISPLAYCLASS19_0__SHOW_B__0_OFFSET UNITYSDK_OFFSET(0x1C0C4920)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AlertWithTitle___c__DisplayClass19_0_TypeDefinitionIndex = 19758;
	...
	public:
		...
		::System::String* contentText; // 0x28
