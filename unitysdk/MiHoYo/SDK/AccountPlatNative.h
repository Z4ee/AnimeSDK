...
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_ACCOUNTPLATINVOKERETURN_OFFSET UNITYSDK_OFFSET(0x84B7B70)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_ACCOUNTPLATINVOKE_OFFSET UNITYSDK_OFFSET(0x84B76C0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_ACTIONEXISTS_OFFSET UNITYSDK_OFFSET(0x84B7F40)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_CACHEACTIONINDEX_OFFSET UNITYSDK_OFFSET(0x84B7E50)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_CONFIGSYNCWITHNATIVE_OFFSET UNITYSDK_OFFSET(0x84B7450)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_ENABLENATIVEHANDLE_OFFSET UNITYSDK_OFFSET(0x84B6030)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDKINTERNALCALLBACK_OFFSET UNITYSDK_OFFSET(0x84B54A0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDKINTERNALNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x84B58D0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDKINTERNALPLUGINUICALLBACK_OFFSET UNITYSDK_OFFSET(0x84B55B0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDK_CONFIGSYNC_OFFSET UNITYSDK_OFFSET(0x84B7600)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDK_INITGLOBALENV_OFFSET UNITYSDK_OFFSET(0x84B86A0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDK_INVOKERETURN_OFFSET UNITYSDK_OFFSET(0x84B8470)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDK_INVOKE_OFFSET UNITYSDK_OFFSET(0x84B85D0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDK_REGISTERNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x84B6200)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDK_REGISTERPLUGINUI_OFFSET UNITYSDK_OFFSET(0x84B87D0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDK_RELEASERESULT_OFFSET UNITYSDK_OFFSET(0x84B8530)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDK_STOP_OFFSET UNITYSDK_OFFSET(0x84B6420)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_INITNATIVEENV_OFFSET UNITYSDK_OFFSET(0x84B5B30)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_INSTANCE_OFFSET UNITYSDK_OFFSET(0x84B5DB0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_INVOKERETURN_OFFSET UNITYSDK_OFFSET(0x84B7BC0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_INVOKE_OFFSET UNITYSDK_OFFSET(0x84B77D0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_NEEDHALFDELEGATE_OFFSET UNITYSDK_OFFSET(0x84B83B0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_ONGETINVOKERESPONSE_OFFSET UNITYSDK_OFFSET(0x84B8860)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_ONGETNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x84B8950)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_PREHANDLEACTIONS_OFFSET UNITYSDK_OFFSET(0x84B8A50)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_REGISTERINTERNALNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x84B7E40)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_REGISTERNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x84B6060)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_REGISTERPLUGINUI_OFFSET UNITYSDK_OFFSET(0x84B64A0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_REMOVEACTIONINDEX_OFFSET UNITYSDK_OFFSET(0x84B7EE0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_RUNONMAINTHREAD_OFFSET UNITYSDK_OFFSET(0x84B5FF0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_STOP_OFFSET UNITYSDK_OFFSET(0x84B6290)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE__CCTOR_OFFSET UNITYSDK_OFFSET(0x84B8EB0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x84B59D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AccountPlatNative_TypeDefinitionIndex = 36863;
	...
	public:
		...
		{
			return (::System::Collections::Generic::HashSet_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(AccountPlatNative_TypeDefinitionIndex)->GetStaticField(0x88B0);
		}
		static ::MiHoYo::SDK::AccountPlatNative** StaticGet_sm_instance()
		{
			return (::MiHoYo::SDK::AccountPlatNative**)Il2CppClass::FromTypeDefinitionIndex(AccountPlatNative_TypeDefinitionIndex)->GetStaticField(0x88B8);
		}
		static ::System::Boolean* StaticGet_sm_bEnableNativeHandle()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(AccountPlatNative_TypeDefinitionIndex)->GetStaticField(0x4640);
		}
		static ::System::Boolean* StaticGet_sm_bIsOpenAccountPlat()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(AccountPlatNative_TypeDefinitionIndex)->GetStaticField(0x4641);
		}
		...
		::MiHoYo::SDK::AccountPlatformPlugin_Notification* m_internalNotification; // 0x20
		::System::Action_1<::System::String*>* m_notification; // 0x28
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::HashSet_1<::System::Int32>*>* m_mapUIName2ActionIndexSet; // 0x30
