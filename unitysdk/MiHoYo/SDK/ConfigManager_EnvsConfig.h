...
#define MIHOYO_SDK_CONFIGMANAGER_ENVSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1888C920)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConfigManager_EnvsConfig_TypeDefinitionIndex = 8153;
