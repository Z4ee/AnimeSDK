...
#define MIHOYO_SDK_WEBDELEGATE_CLEARBGIMGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CD7E650)
#define MIHOYO_SDK_WEBDELEGATE_CLEARBGIMGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CD7E680)
#define MIHOYO_SDK_WEBDELEGATE_CLEARBGIMGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CD7D040)
#define MIHOYO_SDK_WEBDELEGATE_CLEARBGIMGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD7E560)
