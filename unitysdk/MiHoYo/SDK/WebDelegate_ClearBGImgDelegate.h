...
#define MIHOYO_SDK_WEBDELEGATE_CLEARBGIMGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BB14110)
#define MIHOYO_SDK_WEBDELEGATE_CLEARBGIMGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BB14140)
#define MIHOYO_SDK_WEBDELEGATE_CLEARBGIMGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BB12B00)
#define MIHOYO_SDK_WEBDELEGATE_CLEARBGIMGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB14020)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_ClearBGImgDelegate_TypeDefinitionIndex = 7802;
