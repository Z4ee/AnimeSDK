...
#define MIHOYO_SDK_PROTOCOLMANAGER___C__DISPLAYCLASS72_0__CHECKSHOWLAUNCHPROTOCOLCOMPLIANCE_B__0_OFFSET UNITYSDK_OFFSET(0x15FCD250)
#define MIHOYO_SDK_PROTOCOLMANAGER___C__DISPLAYCLASS72_0__CHECKSHOWLAUNCHPROTOCOLCOMPLIANCE_B__1_OFFSET UNITYSDK_OFFSET(0x15FCD280)
#define MIHOYO_SDK_PROTOCOLMANAGER___C__DISPLAYCLASS72_0__CHECKSHOWLAUNCHPROTOCOLCOMPLIANCE_B__2_OFFSET UNITYSDK_OFFSET(0x15FCD2A0)
#define MIHOYO_SDK_PROTOCOLMANAGER___C__DISPLAYCLASS72_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15FCABE0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ProtocolManager___c__DisplayClass72_0_TypeDefinitionIndex = 7052;
