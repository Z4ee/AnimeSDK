...
#define MIHOYO_SDK_WEBDELEGATE_SHOWGEETESTV4WEBDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18467200)
#define MIHOYO_SDK_WEBDELEGATE_SHOWGEETESTV4WEBDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18467270)
#define MIHOYO_SDK_WEBDELEGATE_SHOWGEETESTV4WEBDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x184671E0)
#define MIHOYO_SDK_WEBDELEGATE_SHOWGEETESTV4WEBDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x184670F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_ShowGeetestV4WebDelegate_TypeDefinitionIndex = 7808;
