...
#define MIHOYO_SDK_WEBDELEGATE_SHOWGEETESTV4WEBDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BDFEC20)
#define MIHOYO_SDK_WEBDELEGATE_SHOWGEETESTV4WEBDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BDFECB0)
#define MIHOYO_SDK_WEBDELEGATE_SHOWGEETESTV4WEBDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BDFE660)
#define MIHOYO_SDK_WEBDELEGATE_SHOWGEETESTV4WEBDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDFE640)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_ShowGeetestV4WebDelegate_TypeDefinitionIndex = 19970;
