...
#define MIHOYO_SDK_COMMON_STRINGUTILS___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B74F610)
#define MIHOYO_SDK_COMMON_STRINGUTILS___C__DISPLAYCLASS2_0__SAFEFORMATNOTCSHARPSTANDARDSTRING_B__0_OFFSET UNITYSDK_OFFSET(0x1B74F910)

namespace MiHoYo::SDK::Common
{
	inline static constexpr unsigned int StringUtils___c__DisplayClass2_0_TypeDefinitionIndex = 8767;
