...
#define MIHOYO_SDK_PRESSEDMASKBUTTON_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x170F8E10)
#define MIHOYO_SDK_PRESSEDMASKBUTTON_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x170F8EF0)
#define MIHOYO_SDK_PRESSEDMASKBUTTON_START_OFFSET UNITYSDK_OFFSET(0x170F89E0)
#define MIHOYO_SDK_PRESSEDMASKBUTTON__CTOR_OFFSET UNITYSDK_OFFSET(0x170F8FD0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PressedMaskButton_TypeDefinitionIndex = 7966;
