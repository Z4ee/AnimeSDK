...
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOSETLANGUAGEMASKDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B93F7B0)
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOSETLANGUAGEMASKDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B93F7E0)
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOSETLANGUAGEMASKDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B93F7A0)
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOSETLANGUAGEMASKDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B93F730)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_PlayGoSetLanguageMaskDelegate_TypeDefinitionIndex = 7617;
