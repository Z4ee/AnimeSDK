...
#define MIHOYO_SDK_JSONBOOL_EQUALS_OFFSET UNITYSDK_OFFSET(0x18205470)
#define MIHOYO_SDK_JSONBOOL_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x182052D0)
#define MIHOYO_SDK_JSONBOOL_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x18205490)
#define MIHOYO_SDK_JSONBOOL_GET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x18205360)
#define MIHOYO_SDK_JSONBOOL_GET_ISBOOLEAN_OFFSET UNITYSDK_OFFSET(0x182052C0)
#define MIHOYO_SDK_JSONBOOL_GET_TAG_OFFSET UNITYSDK_OFFSET(0x182052B0)
#define MIHOYO_SDK_JSONBOOL_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x182052F0)
#define MIHOYO_SDK_JSONBOOL_SET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x18205370)
#define MIHOYO_SDK_JSONBOOL_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x18205310)
#define MIHOYO_SDK_JSONBOOL_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x18205430)
#define MIHOYO_SDK_JSONBOOL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x182053B0)
#define MIHOYO_SDK_JSONBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x18205380)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int JSONBool_TypeDefinitionIndex = 8091;
