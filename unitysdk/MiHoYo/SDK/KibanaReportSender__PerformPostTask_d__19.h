...
#define MIHOYO_SDK_KIBANAREPORTSENDER__PERFORMPOSTTASK_D__19_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1942F7A0)
#define MIHOYO_SDK_KIBANAREPORTSENDER__PERFORMPOSTTASK_D__19_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x194308C0)
#define MIHOYO_SDK_KIBANAREPORTSENDER__PERFORMPOSTTASK_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19430920)
#define MIHOYO_SDK_KIBANAREPORTSENDER__PERFORMPOSTTASK_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x194308D0)
#define MIHOYO_SDK_KIBANAREPORTSENDER__PERFORMPOSTTASK_D__19_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1942F790)
#define MIHOYO_SDK_KIBANAREPORTSENDER__PERFORMPOSTTASK_D__19__CTOR_OFFSET UNITYSDK_OFFSET(0x1942F780)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int KibanaReportSender__PerformPostTask_d__19_TypeDefinitionIndex = 35354;
	...
	public:
		...
		::UnityEngine::Networking::UnityWebRequest* _unityWebRequest_5__2; // 0x28
