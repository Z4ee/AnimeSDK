...
#define MIHOYO_SDK_CONSOLEDELEGATE_GETACTIVITIESDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B6C6770)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETACTIVITIESDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B6C67B0)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETACTIVITIESDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B6C61F0)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETACTIVITIESDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C61D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_GetActivitiesDelegate_TypeDefinitionIndex = 19389;
