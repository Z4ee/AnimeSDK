...
#define MIHOYO_SDK_HOYOCHANNELSDK_LOGHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1942EBF0)
#define MIHOYO_SDK_HOYOCHANNELSDK_LOGHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1942EC70)
#define MIHOYO_SDK_HOYOCHANNELSDK_LOGHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1942E8A0)
#define MIHOYO_SDK_HOYOCHANNELSDK_LOGHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1942E890)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoChannelSDK_LogHandler_TypeDefinitionIndex = 35347;
