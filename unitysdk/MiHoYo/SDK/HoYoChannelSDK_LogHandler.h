...
#define MIHOYO_SDK_HOYOCHANNELSDK_LOGHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xB1F43C0)
#define MIHOYO_SDK_HOYOCHANNELSDK_LOGHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xB1F4440)
#define MIHOYO_SDK_HOYOCHANNELSDK_LOGHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0xB1F43B0)
#define MIHOYO_SDK_HOYOCHANNELSDK_LOGHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB1F4340)
