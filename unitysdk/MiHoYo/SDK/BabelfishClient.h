...
#define MIHOYO_SDK_BABELFISHCLIENT_GETCONFIG_OFFSET UNITYSDK_OFFSET(0xB1B1840)
#define MIHOYO_SDK_BABELFISHCLIENT_SETCONFIGURL_OFFSET UNITYSDK_OFFSET(0xB1B1820)
#define MIHOYO_SDK_BABELFISHCLIENT_SETTRANSLATEURL_OFFSET UNITYSDK_OFFSET(0xB1B1830)
#define MIHOYO_SDK_BABELFISHCLIENT_TRANSLATE_OFFSET UNITYSDK_OFFSET(0xB1B1B00)
#define MIHOYO_SDK_BABELFISHCLIENT__CTOR_OFFSET UNITYSDK_OFFSET(0xB1B2030)
