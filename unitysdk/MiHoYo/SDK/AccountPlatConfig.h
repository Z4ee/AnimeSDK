...
#define MIHOYO_SDK_ACCOUNTPLATCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x15DD7090)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AccountPlatConfig_TypeDefinitionIndex = 6902;
