...
#define MIHOYO_SDK_ACCOUNTPLATCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1885B2F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AccountPlatConfig_TypeDefinitionIndex = 7856;
