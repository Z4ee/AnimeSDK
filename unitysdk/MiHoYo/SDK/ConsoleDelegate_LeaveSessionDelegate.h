...
#define MIHOYO_SDK_CONSOLEDELEGATE_LEAVESESSIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CACD3C0)
#define MIHOYO_SDK_CONSOLEDELEGATE_LEAVESESSIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CACD3F0)
#define MIHOYO_SDK_CONSOLEDELEGATE_LEAVESESSIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CACCEA0)
#define MIHOYO_SDK_CONSOLEDELEGATE_LEAVESESSIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CACCE80)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_LeaveSessionDelegate_TypeDefinitionIndex = 19731;
