...
#define MIHOYO_SDK_SDKDELEGATE_GETDEVICEFPDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x197EA790)
#define MIHOYO_SDK_SDKDELEGATE_GETDEVICEFPDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x197EA7C0)
#define MIHOYO_SDK_SDKDELEGATE_GETDEVICEFPDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x197EA4F0)
#define MIHOYO_SDK_SDKDELEGATE_GETDEVICEFPDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x197EA4E0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_GetDeviceFPDelegate_TypeDefinitionIndex = 18639;
