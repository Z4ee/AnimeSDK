...
#define MIHOYO_SDK_SDKDELEGATE_GETDEVICEFPDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C7D6CD0)
#define MIHOYO_SDK_SDKDELEGATE_GETDEVICEFPDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C7D6D00)
#define MIHOYO_SDK_SDKDELEGATE_GETDEVICEFPDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C7D6A40)
#define MIHOYO_SDK_SDKDELEGATE_GETDEVICEFPDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C7D6A20)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_GetDeviceFPDelegate_TypeDefinitionIndex = 19881;
