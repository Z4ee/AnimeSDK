...
#define MIHOYO_SDK_MMTMANAGER_CREATEMMT_OFFSET UNITYSDK_OFFSET(0x19919A60)
#define MIHOYO_SDK_MMTMANAGER_GETMMTHEADER_OFFSET UNITYSDK_OFFSET(0x19919450)
#define MIHOYO_SDK_MMTMANAGER_GETMMTRESULT_OFFSET UNITYSDK_OFFSET(0x19918E60)
#define MIHOYO_SDK_MMTMANAGER_ONGETUNIWEBVIEWMESSAGE_OFFSET UNITYSDK_OFFSET(0x19918EF0)
#define MIHOYO_SDK_MMTMANAGER_ONMMTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1991A000)
#define MIHOYO_SDK_MMTMANAGER_ONPAGECLOSE_OFFSET UNITYSDK_OFFSET(0x19919130)
#define MIHOYO_SDK_MMTMANAGER_ONPAGEERROR_OFFSET UNITYSDK_OFFSET(0x199191C0)
#define MIHOYO_SDK_MMTMANAGER_REQUESTCHECK_OFFSET UNITYSDK_OFFSET(0x19919B70)
#define MIHOYO_SDK_MMTMANAGER_SHOWMMTWEB_OFFSET UNITYSDK_OFFSET(0x19918AD0)
#define MIHOYO_SDK_MMTMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1991A280)
#define MIHOYO_SDK_MMTMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1991A270)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MmtManager_TypeDefinitionIndex = 7987;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::MmtManager**)Il2CppClass::FromTypeDefinitionIndex(MmtManager_TypeDefinitionIndex)->GetStaticField(0x1DAA0);
		}
