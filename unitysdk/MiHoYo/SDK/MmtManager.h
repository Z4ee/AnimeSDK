...
#define MIHOYO_SDK_MMTMANAGER_CREATEMMT_OFFSET UNITYSDK_OFFSET(0x197E6A10)
#define MIHOYO_SDK_MMTMANAGER_GETMMTHEADER_OFFSET UNITYSDK_OFFSET(0x197E6320)
#define MIHOYO_SDK_MMTMANAGER_GETMMTRESULT_OFFSET UNITYSDK_OFFSET(0x197E5E00)
#define MIHOYO_SDK_MMTMANAGER_ONGETUNIWEBVIEWMESSAGE_OFFSET UNITYSDK_OFFSET(0x197E5E70)
#define MIHOYO_SDK_MMTMANAGER_ONMMTCALLBACK_OFFSET UNITYSDK_OFFSET(0x197E71B0)
#define MIHOYO_SDK_MMTMANAGER_ONPAGECLOSE_OFFSET UNITYSDK_OFFSET(0x197E6010)
#define MIHOYO_SDK_MMTMANAGER_ONPAGEERROR_OFFSET UNITYSDK_OFFSET(0x197E60B0)
#define MIHOYO_SDK_MMTMANAGER_REQUESTCHECK_OFFSET UNITYSDK_OFFSET(0x197E6B00)
#define MIHOYO_SDK_MMTMANAGER_SHOWMMTWEB_OFFSET UNITYSDK_OFFSET(0x197E5AA0)
#define MIHOYO_SDK_MMTMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x197E7220)
#define MIHOYO_SDK_MMTMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x197E7210)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MmtManager_TypeDefinitionIndex = 18900;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::MmtManager**)Il2CppClass::FromTypeDefinitionIndex(MmtManager_TypeDefinitionIndex)->GetStaticField(0x9B40);
		}
