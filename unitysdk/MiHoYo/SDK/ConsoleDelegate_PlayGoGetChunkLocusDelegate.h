...
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOGETCHUNKLOCUSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17517590)
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOGETCHUNKLOCUSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x175175C0)
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOGETCHUNKLOCUSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x17517030)
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOGETCHUNKLOCUSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17517010)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_PlayGoGetChunkLocusDelegate_TypeDefinitionIndex = 6715;
