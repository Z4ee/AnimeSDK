...
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOGETCHUNKLOCUSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AA459D0)
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOGETCHUNKLOCUSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AA45A00)
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOGETCHUNKLOCUSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AA459C0)
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOGETCHUNKLOCUSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA45950)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_PlayGoGetChunkLocusDelegate_TypeDefinitionIndex = 7624;
