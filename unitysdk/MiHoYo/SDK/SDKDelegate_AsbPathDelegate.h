...
#define MIHOYO_SDK_SDKDELEGATE_ASBPATHDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1711E6B0)
#define MIHOYO_SDK_SDKDELEGATE_ASBPATHDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1711E6E0)
#define MIHOYO_SDK_SDKDELEGATE_ASBPATHDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1711E6A0)
#define MIHOYO_SDK_SDKDELEGATE_ASBPATHDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1711E630)
