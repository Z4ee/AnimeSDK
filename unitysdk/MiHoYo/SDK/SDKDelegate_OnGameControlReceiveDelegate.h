...
#define MIHOYO_SDK_SDKDELEGATE_ONGAMECONTROLRECEIVEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CEB6C50)
#define MIHOYO_SDK_SDKDELEGATE_ONGAMECONTROLRECEIVEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CEB6C80)
#define MIHOYO_SDK_SDKDELEGATE_ONGAMECONTROLRECEIVEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CEB6730)
#define MIHOYO_SDK_SDKDELEGATE_ONGAMECONTROLRECEIVEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEB6710)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_OnGameControlReceiveDelegate_TypeDefinitionIndex = 19908;
