...
namespace MiHoYo::SDK
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::HoYoSDKNetworkNative_HoYoNetworkProgressCallback**)Il2CppClass::FromTypeDefinitionIndex(HoYoSDKNetworkNative___O_TypeDefinitionIndex)->GetStaticField(0x52A90);
		}
		static ::MiHoYo::SDK::HoYoSDKNetworkNative_HoYoNetworkHeaderCallback** StaticGet__1___HoYoNetworkHeaderInternalCallback()
		{
			return (::MiHoYo::SDK::HoYoSDKNetworkNative_HoYoNetworkHeaderCallback**)Il2CppClass::FromTypeDefinitionIndex(HoYoSDKNetworkNative___O_TypeDefinitionIndex)->GetStaticField(0x52A98);
		}
		static ::MiHoYo::SDK::HoYoSDKNetworkNative_HoYoNetworkWriteCallback** StaticGet__0___HoYoNetworkWriteInternalCallback()
		{
			return (::MiHoYo::SDK::HoYoSDKNetworkNative_HoYoNetworkWriteCallback**)Il2CppClass::FromTypeDefinitionIndex(HoYoSDKNetworkNative___O_TypeDefinitionIndex)->GetStaticField(0x52AA0);
		}
	};
}
