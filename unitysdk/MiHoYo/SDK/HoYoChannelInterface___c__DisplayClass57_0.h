...
#define MIHOYO_SDK_HOYOCHANNELINTERFACE___C__DISPLAYCLASS57_0__CLEANUPTIMEDOUTCALLBACKS_B__0_OFFSET UNITYSDK_OFFSET(0x1ADF4FF0)
#define MIHOYO_SDK_HOYOCHANNELINTERFACE___C__DISPLAYCLASS57_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADF4FE0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoChannelInterface___c__DisplayClass57_0_TypeDefinitionIndex = 35339;
