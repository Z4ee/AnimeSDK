...
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGVERBOSEACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A1F1F50)
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGVERBOSEACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A1F1F80)
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGVERBOSEACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A1F1A50)
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGVERBOSEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1F1A40)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_OnLogVerboseAction_TypeDefinitionIndex = 35225;
