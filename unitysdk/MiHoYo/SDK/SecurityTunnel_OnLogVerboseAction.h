...
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGVERBOSEACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8591570)
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGVERBOSEACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x85915A0)
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGVERBOSEACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x858FEE0)
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGVERBOSEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x8591550)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_OnLogVerboseAction_TypeDefinitionIndex = 37166;
