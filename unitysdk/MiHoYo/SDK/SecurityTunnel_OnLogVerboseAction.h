...
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGVERBOSEACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8DC92A0)
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGVERBOSEACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8DC92D0)
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGVERBOSEACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x8DC7C10)
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGVERBOSEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x8DC9280)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_OnLogVerboseAction_TypeDefinitionIndex = 43011;
