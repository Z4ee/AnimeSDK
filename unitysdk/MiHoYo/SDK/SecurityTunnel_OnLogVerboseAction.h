...
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGVERBOSEACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D849AE0)
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGVERBOSEACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D849B10)
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGVERBOSEACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D8495C0)
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGVERBOSEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8495A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_OnLogVerboseAction_TypeDefinitionIndex = 37450;
