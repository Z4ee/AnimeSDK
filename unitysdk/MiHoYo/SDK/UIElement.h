...
#define MIHOYO_SDK_UIELEMENT_GETUIMANAGER_OFFSET UNITYSDK_OFFSET(0x16020F10)
#define MIHOYO_SDK_UIELEMENT_GET_MANAGER_OFFSET UNITYSDK_OFFSET(0x16020EF0)
#define MIHOYO_SDK_UIELEMENT_GET_PREFABNAME_OFFSET UNITYSDK_OFFSET(0x16020ED0)
#define MIHOYO_SDK_UIELEMENT_ISINGLOBALUISTACKTOP_OFFSET UNITYSDK_OFFSET(0x16021450)
#define MIHOYO_SDK_UIELEMENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16021490)
#define MIHOYO_SDK_UIELEMENT_SET_MANAGER_OFFSET UNITYSDK_OFFSET(0x16020F00)
#define MIHOYO_SDK_UIELEMENT_SET_PREFABNAME_OFFSET UNITYSDK_OFFSET(0x16020EE0)
#define MIHOYO_SDK_UIELEMENT_TABACTIVE_OFFSET UNITYSDK_OFFSET(0x16019790)
#define MIHOYO_SDK_UIELEMENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x16020F20)
#define MIHOYO_SDK_UIELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1601ACC0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int UIElement_TypeDefinitionIndex = 7219;
