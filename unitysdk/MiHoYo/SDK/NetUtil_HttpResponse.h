...
#define MIHOYO_SDK_NETUTIL_HTTPRESPONSE__CTOR_OFFSET UNITYSDK_OFFSET(0x19922630)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int NetUtil_HttpResponse_TypeDefinitionIndex = 8137;
