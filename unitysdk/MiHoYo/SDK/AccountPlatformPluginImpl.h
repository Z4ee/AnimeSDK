...
#define MIHOYO_SDK_ACCOUNTPLATFORMPLUGINIMPL_CONFIGSYNCWITHNATIVE_OFFSET UNITYSDK_OFFSET(0x1A2CB7B0)
#define MIHOYO_SDK_ACCOUNTPLATFORMPLUGINIMPL_ENABLENATIVEHANDLE_OFFSET UNITYSDK_OFFSET(0x1A2CB920)
#define MIHOYO_SDK_ACCOUNTPLATFORMPLUGINIMPL_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1A2CB5F0)
#define MIHOYO_SDK_ACCOUNTPLATFORMPLUGINIMPL_INVOKERETURN_OFFSET UNITYSDK_OFFSET(0x1A2CB8A0)
#define MIHOYO_SDK_ACCOUNTPLATFORMPLUGINIMPL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A2CB720)
#define MIHOYO_SDK_ACCOUNTPLATFORMPLUGINIMPL_REGISTERNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x1A2CB830)
#define MIHOYO_SDK_ACCOUNTPLATFORMPLUGINIMPL_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1A2CB710)
#define MIHOYO_SDK_ACCOUNTPLATFORMPLUGINIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2CB6B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AccountPlatformPluginImpl_TypeDefinitionIndex = 34907;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::AccountPlatformPluginImpl**)Il2CppClass::FromTypeDefinitionIndex(AccountPlatformPluginImpl_TypeDefinitionIndex)->GetStaticField(0x26640);
		}
