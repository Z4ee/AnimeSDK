...
#define MIHOYO_SDK_PSDELEGATE_COMMERCECHECKOUTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19E7A850)
#define MIHOYO_SDK_PSDELEGATE_COMMERCECHECKOUTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19E7A8E0)
#define MIHOYO_SDK_PSDELEGATE_COMMERCECHECKOUTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19E7A840)
#define MIHOYO_SDK_PSDELEGATE_COMMERCECHECKOUTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19E7A7D0)
