...
#define MIHOYO_SDK_NETUTIL__DOWNLOADDATAASBYTEARRAY_D__8_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1836D9E0)
#define MIHOYO_SDK_NETUTIL__DOWNLOADDATAASBYTEARRAY_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1836DDC0)
#define MIHOYO_SDK_NETUTIL__DOWNLOADDATAASBYTEARRAY_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1836DE20)
#define MIHOYO_SDK_NETUTIL__DOWNLOADDATAASBYTEARRAY_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1836DDD0)
#define MIHOYO_SDK_NETUTIL__DOWNLOADDATAASBYTEARRAY_D__8_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1836D9D0)
#define MIHOYO_SDK_NETUTIL__DOWNLOADDATAASBYTEARRAY_D__8__CTOR_OFFSET UNITYSDK_OFFSET(0x1836ACA0)
...
namespace MiHoYo::SDK
{
	...
	public:
		...
		::UnityEngine::Networking::UnityWebRequest* _request_5__1; // 0x28
