...
#define MIHOYO_SDK_NETUTIL__DOWNLOADDATAASBYTEARRAY_D__8_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1C963020)
#define MIHOYO_SDK_NETUTIL__DOWNLOADDATAASBYTEARRAY_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C963410)
#define MIHOYO_SDK_NETUTIL__DOWNLOADDATAASBYTEARRAY_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C963470)
#define MIHOYO_SDK_NETUTIL__DOWNLOADDATAASBYTEARRAY_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1C963420)
#define MIHOYO_SDK_NETUTIL__DOWNLOADDATAASBYTEARRAY_D__8_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C963010)
#define MIHOYO_SDK_NETUTIL__DOWNLOADDATAASBYTEARRAY_D__8__CTOR_OFFSET UNITYSDK_OFFSET(0x1C963000)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int NetUtil__DownloadDataAsByteArray_d__8_TypeDefinitionIndex = 19948;
	...
	public:
		...
		::MiHoYo::SDK::NetUtil_ResponseModel* _result_5__2; // 0x38
		::System::Exception* _e_5__3; // 0x40
