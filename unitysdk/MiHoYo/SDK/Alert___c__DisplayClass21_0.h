...
#define MIHOYO_SDK_ALERT___C__DISPLAYCLASS21_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15DD9CA0)
#define MIHOYO_SDK_ALERT___C__DISPLAYCLASS21_0__SHOW_B__0_OFFSET UNITYSDK_OFFSET(0x15DDA760)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int Alert___c__DisplayClass21_0_TypeDefinitionIndex = 7238;
