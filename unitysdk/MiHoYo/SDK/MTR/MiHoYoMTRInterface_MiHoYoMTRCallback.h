...
#define MIHOYO_SDK_MTR_MIHOYOMTRINTERFACE_MIHOYOMTRCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B62E270)
#define MIHOYO_SDK_MTR_MIHOYOMTRINTERFACE_MIHOYOMTRCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B62E2F0)
#define MIHOYO_SDK_MTR_MIHOYOMTRINTERFACE_MIHOYOMTRCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B62DF30)
#define MIHOYO_SDK_MTR_MIHOYOMTRINTERFACE_MIHOYOMTRCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B62DF10)

namespace MiHoYo::SDK::MTR
{
	inline static constexpr unsigned int MiHoYoMTRInterface_MiHoYoMTRCallback_TypeDefinitionIndex = 37045;
