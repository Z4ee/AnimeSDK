...
#define MIHOYO_SDK_MTR_MIHOYOMTRINTERFACE_MIHOYOMTRCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x198C0070)
#define MIHOYO_SDK_MTR_MIHOYOMTRINTERFACE_MIHOYOMTRCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x198C00F0)
#define MIHOYO_SDK_MTR_MIHOYOMTRINTERFACE_MIHOYOMTRCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x198BFD30)
#define MIHOYO_SDK_MTR_MIHOYOMTRINTERFACE_MIHOYOMTRCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x198BFD20)

namespace MiHoYo::SDK::MTR
{
	inline static constexpr unsigned int MiHoYoMTRInterface_MiHoYoMTRCallback_TypeDefinitionIndex = 35446;
