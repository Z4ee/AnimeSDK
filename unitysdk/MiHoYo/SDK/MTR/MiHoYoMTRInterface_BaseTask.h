...
#define MIHOYO_SDK_MTR_MIHOYOMTRINTERFACE_BASETASK__CTOR_OFFSET UNITYSDK_OFFSET(0x8500520)

namespace MiHoYo::SDK::MTR
{
	inline static constexpr unsigned int MiHoYoMTRInterface_BaseTask_TypeDefinitionIndex = 37363;
