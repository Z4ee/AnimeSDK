...
#define MIHOYO_SDK_MTR_MIHOYOMTRINTERFACE_MIHOYOURLUSAGECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8501630)
#define MIHOYO_SDK_MTR_MIHOYOMTRINTERFACE_MIHOYOURLUSAGECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8501690)
#define MIHOYO_SDK_MTR_MIHOYOMTRINTERFACE_MIHOYOURLUSAGECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x85011A0)
#define MIHOYO_SDK_MTR_MIHOYOMTRINTERFACE_MIHOYOURLUSAGECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x8501610)

namespace MiHoYo::SDK::MTR
{
	inline static constexpr unsigned int MiHoYoMTRInterface_MiHoYoUrlUsageCallback_TypeDefinitionIndex = 37360;
