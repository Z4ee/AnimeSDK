...
#define MIHOYO_SDK_MTR_MIHOYOMTRINTERFACE_MIHOYORESOLVERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x85015A0)
#define MIHOYO_SDK_MTR_MIHOYOMTRINTERFACE_MIHOYORESOLVERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8501600)
#define MIHOYO_SDK_MTR_MIHOYOMTRINTERFACE_MIHOYORESOLVERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x8500AC0)
#define MIHOYO_SDK_MTR_MIHOYOMTRINTERFACE_MIHOYORESOLVERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x8501580)

namespace MiHoYo::SDK::MTR
{
	inline static constexpr unsigned int MiHoYoMTRInterface_MiHoYoResolverCallback_TypeDefinitionIndex = 37361;
