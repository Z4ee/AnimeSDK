...
#define MIHOYO_SDK_MTR_MIHOYOMTRINTERFACE_MIHOYORESOLVERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C4D64A0)
#define MIHOYO_SDK_MTR_MIHOYOMTRINTERFACE_MIHOYORESOLVERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C4D6520)
#define MIHOYO_SDK_MTR_MIHOYOMTRINTERFACE_MIHOYORESOLVERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C4D6100)
#define MIHOYO_SDK_MTR_MIHOYOMTRINTERFACE_MIHOYORESOLVERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4D6480)

namespace MiHoYo::SDK::MTR
{
	inline static constexpr unsigned int MiHoYoMTRInterface_MiHoYoResolverCallback_TypeDefinitionIndex = 37047;
