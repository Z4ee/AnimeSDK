...
#define MIHOYO_SDK_MTR_MIHOYOMTRINTERFACE_MIHOYORESOLVERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A1ECA70)
#define MIHOYO_SDK_MTR_MIHOYOMTRINTERFACE_MIHOYORESOLVERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A1ECAF0)
#define MIHOYO_SDK_MTR_MIHOYOMTRINTERFACE_MIHOYORESOLVERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A1EC6E0)
#define MIHOYO_SDK_MTR_MIHOYOMTRINTERFACE_MIHOYORESOLVERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1ECA60)

namespace MiHoYo::SDK::MTR
{
	inline static constexpr unsigned int MiHoYoMTRInterface_MiHoYoResolverCallback_TypeDefinitionIndex = 35448;
