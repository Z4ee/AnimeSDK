...
#define MIHOYO_SDK_MTR_MIHOYOMTRINTERFACE_MTRTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x84FE710)

namespace MiHoYo::SDK::MTR
{
	inline static constexpr unsigned int MiHoYoMTRInterface_MTRTask_TypeDefinitionIndex = 37364;
