...
#define MIHOYO_SDK_NETUTIL_DOWNLOADDATAASBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x1991CA40)
#define MIHOYO_SDK_NETUTIL_GENERATERANDOMDELAYTIMEMS_OFFSET UNITYSDK_OFFSET(0x1991E4D0)
#define MIHOYO_SDK_NETUTIL_HTTPGETBINARY_OFFSET UNITYSDK_OFFSET(0x1991E230)
#define MIHOYO_SDK_NETUTIL_HTTPGET_1_OFFSET UNITYSDK_OFFSET(0x1991CE80)
#define MIHOYO_SDK_NETUTIL_HTTPGET_OFFSET UNITYSDK_OFFSET(0x1991CAB0)
#define MIHOYO_SDK_NETUTIL_HTTPPOSTFORM_1_OFFSET UNITYSDK_OFFSET(0x1991DDE0)
#define MIHOYO_SDK_NETUTIL_HTTPPOSTFORM_OFFSET UNITYSDK_OFFSET(0x1991D9D0)
#define MIHOYO_SDK_NETUTIL_HTTPPOSTJSON_1_OFFSET UNITYSDK_OFFSET(0x1991D630)
#define MIHOYO_SDK_NETUTIL_HTTPPOSTJSON_OFFSET UNITYSDK_OFFSET(0x1991D200)
#define MIHOYO_SDK_NETUTIL_PERFORMHTTPREQUESTFORBINARYRESPONSE_OFFSET UNITYSDK_OFFSET(0x1991E430)
#define MIHOYO_SDK_NETUTIL_PERFORMHTTPREQUESTINTERNAL_OFFSET UNITYSDK_OFFSET(0x1991E140)
#define MIHOYO_SDK_NETUTIL_PERFORMHTTPREQUEST_1_OFFSET UNITYSDK_OFFSET(0x1991D0A0)
#define MIHOYO_SDK_NETUTIL_PERFORMHTTPREQUEST_OFFSET UNITYSDK_OFFSET(0x1991CD60)
#define MIHOYO_SDK_NETUTIL_REGISTERINTERCEPTOR_OFFSET UNITYSDK_OFFSET(0x1991C890)
#define MIHOYO_SDK_NETUTIL_TRYHTTPREQUESTBYHTTPDNS_OFFSET UNITYSDK_OFFSET(0x1991E4F0)
#define MIHOYO_SDK_NETUTIL_UNREGISTERINTERCEPTOR_OFFSET UNITYSDK_OFFSET(0x1991C9B0)
#define MIHOYO_SDK_NETUTIL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1991EAC0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int NetUtil_TypeDefinitionIndex = 8134;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::MiHoYo::SDK::INetworkInterceptor*>**)Il2CppClass::FromTypeDefinitionIndex(NetUtil_TypeDefinitionIndex)->GetStaticField(0x21BA0);
		}
