...
#define MIHOYO_SDK_NETUTIL_DOWNLOADDATAASBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x1A638E20)
#define MIHOYO_SDK_NETUTIL_GENERATERANDOMDELAYTIMEMS_OFFSET UNITYSDK_OFFSET(0x1A63A890)
#define MIHOYO_SDK_NETUTIL_HTTPGETBINARY_OFFSET UNITYSDK_OFFSET(0x1A63A5E0)
#define MIHOYO_SDK_NETUTIL_HTTPGET_1_OFFSET UNITYSDK_OFFSET(0x1A639240)
#define MIHOYO_SDK_NETUTIL_HTTPGET_OFFSET UNITYSDK_OFFSET(0x1A638E70)
#define MIHOYO_SDK_NETUTIL_HTTPPOSTFORM_1_OFFSET UNITYSDK_OFFSET(0x1A63A1A0)
#define MIHOYO_SDK_NETUTIL_HTTPPOSTFORM_OFFSET UNITYSDK_OFFSET(0x1A639D90)
#define MIHOYO_SDK_NETUTIL_HTTPPOSTJSON_1_OFFSET UNITYSDK_OFFSET(0x1A6399F0)
#define MIHOYO_SDK_NETUTIL_HTTPPOSTJSON_OFFSET UNITYSDK_OFFSET(0x1A6395C0)
#define MIHOYO_SDK_NETUTIL_PERFORMHTTPREQUESTFORBINARYRESPONSE_OFFSET UNITYSDK_OFFSET(0x1A63A7F0)
#define MIHOYO_SDK_NETUTIL_PERFORMHTTPREQUESTINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A63A500)
#define MIHOYO_SDK_NETUTIL_PERFORMHTTPREQUEST_1_OFFSET UNITYSDK_OFFSET(0x1A639460)
#define MIHOYO_SDK_NETUTIL_PERFORMHTTPREQUEST_OFFSET UNITYSDK_OFFSET(0x1A639120)
#define MIHOYO_SDK_NETUTIL_REGISTERINTERCEPTOR_OFFSET UNITYSDK_OFFSET(0x1A638C70)
#define MIHOYO_SDK_NETUTIL_TRYHTTPREQUESTBYHTTPDNS_OFFSET UNITYSDK_OFFSET(0x1A63A8B0)
#define MIHOYO_SDK_NETUTIL_UNREGISTERINTERCEPTOR_OFFSET UNITYSDK_OFFSET(0x1A638D90)
#define MIHOYO_SDK_NETUTIL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A63AE80)
...
namespace MiHoYo::SDK
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::MiHoYo::SDK::INetworkInterceptor*>**)Il2CppClass::FromTypeDefinitionIndex(NetUtil_TypeDefinitionIndex)->GetStaticField(0x17540);
		}
