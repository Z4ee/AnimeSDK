...
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_BINDEMAIL_OFFSET UNITYSDK_OFFSET(0x182E2210)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_BINDEXISTINGACCOUNT_OFFSET UNITYSDK_OFFSET(0x182E08C0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_CREATEANDBINDNEWACCOUNT_OFFSET UNITYSDK_OFFSET(0x182E0F90)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_GENERATEACCESSTOKEN_OFFSET UNITYSDK_OFFSET(0x182E0780)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_GETACCOUNTPRIVACYPROTOCOLURL_OFFSET UNITYSDK_OFFSET(0x182E33C0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_GETACCOUNTUSERAGREEMENTURL_OFFSET UNITYSDK_OFFSET(0x182E3140)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_GETBINDINGWEBURL_OFFSET UNITYSDK_OFFSET(0x182E1230)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_GETCAPTCHACODE_OFFSET UNITYSDK_OFFSET(0x182E18D0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_GETCHANNELNICKNAME_OFFSET UNITYSDK_OFFSET(0x182E2F00)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_GETREPORTTYPE_OFFSET UNITYSDK_OFFSET(0x182E3F50)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x182DFAC0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_GET_RSAKEY_OFFSET UNITYSDK_OFFSET(0x182DFEA0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_LOGINAFTERSUCCESSFULBINDING_OFFSET UNITYSDK_OFFSET(0x182E0FB0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_LOGINBYEMAILCAPTCHA_OFFSET UNITYSDK_OFFSET(0x182E1C80)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_LOGREPORT_OFFSET UNITYSDK_OFFSET(0x182E0230)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_ONCLOSEDIALOG_OFFSET UNITYSDK_OFFSET(0x182E2E70)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_PERFORMBINDINGFLOW_OFFSET UNITYSDK_OFFSET(0x182E1BE0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_QUERYWEBBINDINGRESULT_OFFSET UNITYSDK_OFFSET(0x182E1340)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_REACTIVATEACCOUNT_OFFSET UNITYSDK_OFFSET(0x182E2410)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_REMOVESPACES_OFFSET UNITYSDK_OFFSET(0x182E1BA0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_REQUESTBINDTHIRDPARTY_OFFSET UNITYSDK_OFFSET(0x182E3B80)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_REQUESTCREATEACTIONTICKET_OFFSET UNITYSDK_OFFSET(0x182E1250)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_REQUESTGETACTIONTICKETINFO_OFFSET UNITYSDK_OFFSET(0x182E13E0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_REQUESTLOGINBYACTIONTICKET_OFFSET UNITYSDK_OFFSET(0x182E3460)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_REQUESTREACTIVATEACCOUNT_OFFSET UNITYSDK_OFFSET(0x182E37B0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_REQUESTVERIFYCAPTCHA_OFFSET UNITYSDK_OFFSET(0x182E1E10)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_RISKCHECK_OFFSET UNITYSDK_OFFSET(0x182E2890)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_SHOWACCOUNTPRIVACYPROTOCOL_OFFSET UNITYSDK_OFFSET(0x182E31D0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_SHOWACCOUNTUSERAGREEMENT_OFFSET UNITYSDK_OFFSET(0x182E2F50)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_SHOWBINDSUCCESSDIALOG_OFFSET UNITYSDK_OFFSET(0x182E1040)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_SHOWWELCOMEDIALOG_OFFSET UNITYSDK_OFFSET(0x182E04C0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_STARTACCOUNTBINDING_OFFSET UNITYSDK_OFFSET(0x182E0190)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_STARTWEBBINDINGRESULTQUERYLOOP_OFFSET UNITYSDK_OFFSET(0x182E1780)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_STOPWEBBINDINGRESULTQUERYLOOP_OFFSET UNITYSDK_OFFSET(0x182E1890)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_UPDATEQRCODE_OFFSET UNITYSDK_OFFSET(0x182E0D90)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__BINDEXISTINGACCOUNT_B__34_0_OFFSET UNITYSDK_OFFSET(0x182E4230)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__BINDEXISTINGACCOUNT_B__34_1_OFFSET UNITYSDK_OFFSET(0x182E4360)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__BINDEXISTINGACCOUNT_B__34_2_OFFSET UNITYSDK_OFFSET(0x182E4450)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__BINDEXISTINGACCOUNT_B__34_3_OFFSET UNITYSDK_OFFSET(0x182E44D0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__BINDEXISTINGACCOUNT_B__34_4_OFFSET UNITYSDK_OFFSET(0x182E4550)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x182DFF50)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__PERFORMBINDINGFLOW_B__44_0_OFFSET UNITYSDK_OFFSET(0x182E4F30)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__QUERYWEBBINDINGRESULT_B__40_0_OFFSET UNITYSDK_OFFSET(0x182E48A0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__SHOWBINDSUCCESSDIALOG_B__37_0_OFFSET UNITYSDK_OFFSET(0x182E4640)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__SHOWBINDSUCCESSDIALOG_B__37_1_OFFSET UNITYSDK_OFFSET(0x182E4770)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__SHOWWELCOMEDIALOG_B__33_0_OFFSET UNITYSDK_OFFSET(0x182E3F60)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__SHOWWELCOMEDIALOG_B__33_1_OFFSET UNITYSDK_OFFSET(0x182E4090)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__SHOWWELCOMEDIALOG_B__33_2_OFFSET UNITYSDK_OFFSET(0x182E41A0)

namespace MiHoYo::SDK::Windows::OS
{
	inline static constexpr unsigned int BindManager_TypeDefinitionIndex = 8291;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Windows::OS::BindManager**)Il2CppClass::FromTypeDefinitionIndex(BindManager_TypeDefinitionIndex)->GetStaticField(0x920);
		}
		...
		::System::String* _userEmail; // 0x10
		::System::String* _sToken; // 0x18
		::MiHoYo::SDK::UI::OS::IWinAccountBindingDialog* _accountBindingDialog; // 0x20
		::System::Action_1<::System::Boolean>* _processCompletedCallback; // 0x28
		::MiHoYo::SDK::UI::OS::IWinBindingSuccessDialog* _bindingSuccessDialog; // 0x30
		::System::String* _webTicket; // 0x38
		::MiHoYo::SDK::JSONObject* _captchaVerifyCombination; // 0x40
		::MiHoYo::SDK::UI::OS::IWinBindingWelcomeDialog* _bindingWelcomeDialog; // 0x48
		::System::String* _accessToken; // 0x50
		::System::Action* _processCancelledCallback; // 0x58
		::System::String* _userId; // 0x60
		::UnityEngine::Coroutine* _webBindingResultQueryCoroutine; // 0x68
		::System::String* _loginTicket; // 0x70
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>* _commonHeaders; // 0x78
		::System::String* H5LOG_REPORT_MODULE; // 0x80
