...
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER___C__DISPLAYCLASS55_0__CTOR_OFFSET UNITYSDK_OFFSET(0x199CF570)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER___C__DISPLAYCLASS55_0__REQUESTCREATEACTIONTICKET_B__0_OFFSET UNITYSDK_OFFSET(0x199D1910)

namespace MiHoYo::SDK::Windows::OS
{
	inline static constexpr unsigned int BindManager___c__DisplayClass55_0_TypeDefinitionIndex = 19223;
