...
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGERSTEAM_GETBINDINGWEBURL_OFFSET UNITYSDK_OFFSET(0x174EA030)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGERSTEAM_GETREPORTTYPE_OFFSET UNITYSDK_OFFSET(0x174EA4A0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGERSTEAM__CTOR_OFFSET UNITYSDK_OFFSET(0x174E20D0)

namespace MiHoYo::SDK::Windows::OS
{
	inline static constexpr unsigned int BindManagerSteam_TypeDefinitionIndex = 7397;
