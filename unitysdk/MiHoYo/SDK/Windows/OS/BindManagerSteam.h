...
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGERSTEAM_GETBINDINGWEBURL_OFFSET UNITYSDK_OFFSET(0x1D111B00)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGERSTEAM_GETREPORTTYPE_OFFSET UNITYSDK_OFFSET(0x1D111EB0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGERSTEAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D109500)

namespace MiHoYo::SDK::Windows::OS
{
	inline static constexpr unsigned int BindManagerSteam_TypeDefinitionIndex = 8312;
