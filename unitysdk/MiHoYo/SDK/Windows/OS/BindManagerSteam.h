...
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGERSTEAM_GETBINDINGWEBURL_OFFSET UNITYSDK_OFFSET(0x182E7E20)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGERSTEAM_GETREPORTTYPE_OFFSET UNITYSDK_OFFSET(0x182E81D0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGERSTEAM__CTOR_OFFSET UNITYSDK_OFFSET(0x182DFE50)

namespace MiHoYo::SDK::Windows::OS
{
	inline static constexpr unsigned int BindManagerSteam_TypeDefinitionIndex = 8300;
