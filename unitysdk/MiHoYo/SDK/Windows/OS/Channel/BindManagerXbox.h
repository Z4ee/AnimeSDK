...
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERXBOX_CHECKSHOWPREBINDINGPROTOCOLDIALOG_OFFSET UNITYSDK_OFFSET(0x1B915430)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERXBOX_GENERATEACCESSTOKEN_OFFSET UNITYSDK_OFFSET(0x1B9154B0)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERXBOX_GETBINDINGWEBURL_OFFSET UNITYSDK_OFFSET(0x1B915610)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERXBOX_GETREPORTTYPE_OFFSET UNITYSDK_OFFSET(0x1B9159C0)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERXBOX_ISBINDINGACCOUNTSWITCHON_OFFSET UNITYSDK_OFFSET(0x1B915440)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERXBOX_SAVEPREBINDINGPROTOCOLAGREERECORD_OFFSET UNITYSDK_OFFSET(0x1B9154A0)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERXBOX__CTOR_OFFSET UNITYSDK_OFFSET(0x1B90CA30)
