...
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERXBOX_CHECKSHOWPREBINDINGPROTOCOLDIALOG_OFFSET UNITYSDK_OFFSET(0x1C0FB000)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERXBOX_GENERATEACCESSTOKEN_OFFSET UNITYSDK_OFFSET(0x1C0FB0B0)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERXBOX_GETBINDINGWEBURL_OFFSET UNITYSDK_OFFSET(0x1C0FB1A0)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERXBOX_GETREPORTTYPE_OFFSET UNITYSDK_OFFSET(0x1C0FB650)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERXBOX_ISBINDINGACCOUNTSWITCHON_OFFSET UNITYSDK_OFFSET(0x1C0FB010)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERXBOX_SAVEPREBINDINGPROTOCOLAGREERECORD_OFFSET UNITYSDK_OFFSET(0x1C0FB0A0)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERXBOX__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0FAFA0)

namespace MiHoYo::SDK::Windows::OS::Channel
{
	inline static constexpr unsigned int BindManagerXbox_TypeDefinitionIndex = 20131;
