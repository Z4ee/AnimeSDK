...
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERXBOX_CHECKSHOWPREBINDINGPROTOCOLDIALOG_OFFSET UNITYSDK_OFFSET(0x1D4CB1A0)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERXBOX_GENERATEACCESSTOKEN_OFFSET UNITYSDK_OFFSET(0x1D4CB250)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERXBOX_GETBINDINGWEBURL_OFFSET UNITYSDK_OFFSET(0x1D4CB340)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERXBOX_GETREPORTTYPE_OFFSET UNITYSDK_OFFSET(0x1D4CB7F0)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERXBOX_ISBINDINGACCOUNTSWITCHON_OFFSET UNITYSDK_OFFSET(0x1D4CB1B0)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERXBOX_SAVEPREBINDINGPROTOCOLAGREERECORD_OFFSET UNITYSDK_OFFSET(0x1D4CB240)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERXBOX__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4CB150)

namespace MiHoYo::SDK::Windows::OS::Channel
{
	inline static constexpr unsigned int BindManagerXbox_TypeDefinitionIndex = 20479;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Action_1<::System::String*>*, ::System::Boolean))((::PBYTE)hIl2Cpp + MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERXBOX_GENERATEACCESSTOKEN_OFFSET))(this, callback, refreshToken);
		}
