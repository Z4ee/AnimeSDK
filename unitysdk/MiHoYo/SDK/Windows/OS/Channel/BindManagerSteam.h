...
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERSTEAM_CHECKSHOWPREBINDINGPROTOCOLDIALOG_OFFSET UNITYSDK_OFFSET(0x1C3BCB10)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERSTEAM_GETBINDINGWEBURL_OFFSET UNITYSDK_OFFSET(0x1C3BCB20)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERSTEAM_GETREPORTTYPE_OFFSET UNITYSDK_OFFSET(0x1C3BCFD0)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERSTEAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3BCAC0)

namespace MiHoYo::SDK::Windows::OS::Channel
{
	inline static constexpr unsigned int BindManagerSteam_TypeDefinitionIndex = 20130;
