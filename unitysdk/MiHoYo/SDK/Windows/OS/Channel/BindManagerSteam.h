...
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERSTEAM_CHECKSHOWPREBINDINGPROTOCOLDIALOG_OFFSET UNITYSDK_OFFSET(0x1D794CE0)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERSTEAM_GETBINDINGWEBURL_OFFSET UNITYSDK_OFFSET(0x1D794CF0)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERSTEAM_GETREPORTTYPE_OFFSET UNITYSDK_OFFSET(0x1D7951A0)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERSTEAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D794C90)

namespace MiHoYo::SDK::Windows::OS::Channel
{
	inline static constexpr unsigned int BindManagerSteam_TypeDefinitionIndex = 20478;
