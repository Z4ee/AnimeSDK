...
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERXBOX___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4CB330)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGERXBOX___C__DISPLAYCLASS5_0__GENERATEACCESSTOKEN_B__0_OFFSET UNITYSDK_OFFSET(0x1D4CB800)

namespace MiHoYo::SDK::Windows::OS::Channel
{
	inline static constexpr unsigned int BindManagerXbox___c__DisplayClass5_0_TypeDefinitionIndex = 20480;
