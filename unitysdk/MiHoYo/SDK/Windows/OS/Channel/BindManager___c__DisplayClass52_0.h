...
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGER___C__DISPLAYCLASS52_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF53970)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGER___C__DISPLAYCLASS52_0__SHOWPREBINDINGPROTOCOLDIALOG_B__0_OFFSET UNITYSDK_OFFSET(0x1CF53980)

namespace MiHoYo::SDK::Windows::OS::Channel
{
	inline static constexpr unsigned int BindManager___c__DisplayClass52_0_TypeDefinitionIndex = 20476;
