...
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGER___C__DISPLAYCLASS45_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD2EE40)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGER___C__DISPLAYCLASS45_0__LOGINBYEMAILCAPTCHA_B__0_OFFSET UNITYSDK_OFFSET(0x1CD2EE50)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGER___C__DISPLAYCLASS45_0__LOGINBYEMAILCAPTCHA_B__1_OFFSET UNITYSDK_OFFSET(0x1CD2F780)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_BINDMANAGER___C__DISPLAYCLASS45_0__LOGINBYEMAILCAPTCHA_B__2_OFFSET UNITYSDK_OFFSET(0x1CD2F720)

namespace MiHoYo::SDK::Windows::OS::Channel
{
	inline static constexpr unsigned int BindManager___c__DisplayClass45_0_TypeDefinitionIndex = 20472;

	class BindManager___c__DisplayClass45_0 : public ::System::Object
	{
	public:
		::System::Action* completeCallback; // 0x10
		::System::Action_1<::MiHoYo::SDK::NetworkResponseModelEx*>* onLogin; // 0x18
		::MiHoYo::SDK::Windows::OS::Channel::BindManager* __4__this; // 0x20
