...
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_PROTOCOLMANAGER_GETACCOUNTPRIVACYPROTOCOLURL_OFFSET UNITYSDK_OFFSET(0x1B9167B0)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_PROTOCOLMANAGER_GETACCOUNTUSERAGREEMENTURL_OFFSET UNITYSDK_OFFSET(0x1B916520)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_PROTOCOLMANAGER_IFSHOWPRECOMBOLOGINPROTOCOLDIALOGFORUPDATE_OFFSET UNITYSDK_OFFSET(0x1B915B90)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_PROTOCOLMANAGER_IFSHOWPRECOMBOLOGINPROTOCOLFORFIRSTLOCALACCEPT_OFFSET UNITYSDK_OFFSET(0x1B915A00)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_PROTOCOLMANAGER_SAVEPRECOMBOLOGINPROTOCOLAGREERECORD_OFFSET UNITYSDK_OFFSET(0x1B915D20)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_PROTOCOLMANAGER_SHOWACCOUNTPRIVACYPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1B9165B0)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_PROTOCOLMANAGER_SHOWACCOUNTUSERAGREEMENT_OFFSET UNITYSDK_OFFSET(0x1B916320)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_PROTOCOLMANAGER_SHOWPRECOMBOLOGINPROTOCOLDIALOG_OFFSET UNITYSDK_OFFSET(0x1B915E10)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_PROTOCOLMANAGER_SHOWPRIVACYPROTOCOLINGAME_OFFSET UNITYSDK_OFFSET(0x1B9162D0)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_PROTOCOLMANAGER_SHOWUSERAGREEMENTINGAME_OFFSET UNITYSDK_OFFSET(0x1B916280)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_PROTOCOLMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B916840)
