...
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_PROTOCOLMANAGER_GETACCOUNTPRIVACYPROTOCOLURL_OFFSET UNITYSDK_OFFSET(0x1CEDA850)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_PROTOCOLMANAGER_GETACCOUNTUSERAGREEMENTURL_OFFSET UNITYSDK_OFFSET(0x1CEDA630)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_PROTOCOLMANAGER_IFSHOWPRECOMBOLOGINPROTOCOLDIALOGFORUPDATE_OFFSET UNITYSDK_OFFSET(0x1CED9DD0)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_PROTOCOLMANAGER_IFSHOWPRECOMBOLOGINPROTOCOLFORFIRSTLOCALACCEPT_OFFSET UNITYSDK_OFFSET(0x1CED9C80)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_PROTOCOLMANAGER_SAVEPRECOMBOLOGINPROTOCOLAGREERECORD_OFFSET UNITYSDK_OFFSET(0x1CED9F20)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_PROTOCOLMANAGER_SHOWACCOUNTPRIVACYPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1CEDA6C0)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_PROTOCOLMANAGER_SHOWACCOUNTUSERAGREEMENT_OFFSET UNITYSDK_OFFSET(0x1CEDA4A0)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_PROTOCOLMANAGER_SHOWPRECOMBOLOGINPROTOCOLDIALOG_OFFSET UNITYSDK_OFFSET(0x1CEDA050)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_PROTOCOLMANAGER_SHOWPRIVACYPROTOCOLINGAME_OFFSET UNITYSDK_OFFSET(0x1CEDA420)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_PROTOCOLMANAGER_SHOWUSERAGREEMENTINGAME_OFFSET UNITYSDK_OFFSET(0x1CEDA3A0)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_PROTOCOLMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEDA8E0)

namespace MiHoYo::SDK::Windows::OS::Channel
{
	inline static constexpr unsigned int ProtocolManager_TypeDefinitionIndex = 20481;
