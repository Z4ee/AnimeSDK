...
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_PROTOCOLMANAGER___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFEF7D0)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_PROTOCOLMANAGER___C__DISPLAYCLASS5_0__SHOWPRECOMBOLOGINPROTOCOLDIALOG_B__0_OFFSET UNITYSDK_OFFSET(0x1CFEF7E0)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_PROTOCOLMANAGER___C__DISPLAYCLASS5_0__SHOWPRECOMBOLOGINPROTOCOLDIALOG_B__1_OFFSET UNITYSDK_OFFSET(0x1CFEF930)
#define MIHOYO_SDK_WINDOWS_OS_CHANNEL_PROTOCOLMANAGER___C__DISPLAYCLASS5_0__SHOWPRECOMBOLOGINPROTOCOLDIALOG_B__2_OFFSET UNITYSDK_OFFSET(0x1CFEFA80)

namespace MiHoYo::SDK::Windows::OS::Channel
{
	inline static constexpr unsigned int ProtocolManager___c__DisplayClass5_0_TypeDefinitionIndex = 20482;

	class ProtocolManager___c__DisplayClass5_0 : public ::System::Object
	{
	public:
		::System::Action* onProtocolRefused; // 0x10
		::MiHoYo::SDK::UI::OS::IWinChannelProtocolDialog* dialog; // 0x18
		::System::Action* onProtocolAccepted; // 0x20
