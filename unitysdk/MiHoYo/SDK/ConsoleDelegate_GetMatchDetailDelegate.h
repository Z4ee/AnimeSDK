...
#define MIHOYO_SDK_CONSOLEDELEGATE_GETMATCHDETAILDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AA446B0)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETMATCHDETAILDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AA446F0)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETMATCHDETAILDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AA446A0)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETMATCHDETAILDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA44620)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_GetMatchDetailDelegate_TypeDefinitionIndex = 7614;
