...
#define MIHOYO_SDK_SDKREPORT_ANALYZERRESULTFORMATTER_ANALYZERRESULTTOJSON_OFFSET UNITYSDK_OFFSET(0xB296790)
#define MIHOYO_SDK_SDKREPORT_ANALYZERRESULTFORMATTER_BUILDJSON_1_OFFSET UNITYSDK_OFFSET(0xB2965C0)
#define MIHOYO_SDK_SDKREPORT_ANALYZERRESULTFORMATTER_BUILDJSON_OFFSET UNITYSDK_OFFSET(0xB2962B0)
#define MIHOYO_SDK_SDKREPORT_ANALYZERRESULTFORMATTER_CREATEEMPTYNOTE_OFFSET UNITYSDK_OFFSET(0xB296580)
#define MIHOYO_SDK_SDKREPORT_ANALYZERRESULTFORMATTER_FILLHEADERS_OFFSET UNITYSDK_OFFSET(0xB2970B0)
#define MIHOYO_SDK_SDKREPORT_ANALYZERRESULTFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xB2975E0)
