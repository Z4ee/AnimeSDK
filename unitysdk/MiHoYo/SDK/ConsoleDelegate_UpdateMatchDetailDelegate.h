...
#define MIHOYO_SDK_CONSOLEDELEGATE_UPDATEMATCHDETAILDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15ED86F0)
#define MIHOYO_SDK_CONSOLEDELEGATE_UPDATEMATCHDETAILDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15ED8730)
#define MIHOYO_SDK_CONSOLEDELEGATE_UPDATEMATCHDETAILDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15ED8170)
#define MIHOYO_SDK_CONSOLEDELEGATE_UPDATEMATCHDETAILDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15ED8150)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_UpdateMatchDetailDelegate_TypeDefinitionIndex = 6672;
