...
#define MIHOYO_SDK_HOYOSDKNETWORKINTERFACE___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0x84E5330)
#define MIHOYO_SDK_HOYOSDKNETWORKINTERFACE___C__DISPLAYCLASS12_0__HTTPDNSHTTPREQUESTWITHCUSTOMHANDLER_B__0_OFFSET UNITYSDK_OFFSET(0x84E54C0)
#define MIHOYO_SDK_HOYOSDKNETWORKINTERFACE___C__DISPLAYCLASS12_0__HTTPDNSHTTPREQUESTWITHCUSTOMHANDLER_B__1_OFFSET UNITYSDK_OFFSET(0x84E5920)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoSDKNetworkInterface___c__DisplayClass12_0_TypeDefinitionIndex = 36889;

	class HoYoSDKNetworkInterface___c__DisplayClass12_0 : public ::System::Object
	{
	public:
		::System::String* strMethod; // 0x10
		::System::String* strUrl; // 0x18
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>* dicHeaders; // 0x20
		::System::Action* timeoutExternalCallback; // 0x28
		::System::String* strExtraOptions; // 0x30
		::MiHoYo::SDK::HoYoSDKNetworkInterface* __4__this; // 0x38
