...
#define MIHOYO_SDK_SDKDELEGATE_WEBEVENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBD0970)
#define MIHOYO_SDK_SDKDELEGATE_WEBEVENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBD09B0)
#define MIHOYO_SDK_SDKDELEGATE_WEBEVENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBD03F0)
#define MIHOYO_SDK_SDKDELEGATE_WEBEVENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBD03D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_WebEventDelegate_TypeDefinitionIndex = 19541;
