...
#define MIHOYO_SDK_SDKDELEGATE_WEBEVENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18421460)
#define MIHOYO_SDK_SDKDELEGATE_WEBEVENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x184214A0)
#define MIHOYO_SDK_SDKDELEGATE_WEBEVENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18421450)
#define MIHOYO_SDK_SDKDELEGATE_WEBEVENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x184213D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_WebEventDelegate_TypeDefinitionIndex = 7727;
