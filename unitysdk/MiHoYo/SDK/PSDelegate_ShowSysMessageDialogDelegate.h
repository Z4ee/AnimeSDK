...
#define MIHOYO_SDK_PSDELEGATE_SHOWSYSMESSAGEDIALOGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A519B70)
#define MIHOYO_SDK_PSDELEGATE_SHOWSYSMESSAGEDIALOGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A519BB0)
#define MIHOYO_SDK_PSDELEGATE_SHOWSYSMESSAGEDIALOGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A5195F0)
#define MIHOYO_SDK_PSDELEGATE_SHOWSYSMESSAGEDIALOGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5195E0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_ShowSysMessageDialogDelegate_TypeDefinitionIndex = 18614;
