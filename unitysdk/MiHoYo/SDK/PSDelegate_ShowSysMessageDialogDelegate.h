...
#define MIHOYO_SDK_PSDELEGATE_SHOWSYSMESSAGEDIALOGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BE5E9F0)
#define MIHOYO_SDK_PSDELEGATE_SHOWSYSMESSAGEDIALOGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BE5EA30)
#define MIHOYO_SDK_PSDELEGATE_SHOWSYSMESSAGEDIALOGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BE5E470)
#define MIHOYO_SDK_PSDELEGATE_SHOWSYSMESSAGEDIALOGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE5E450)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_ShowSysMessageDialogDelegate_TypeDefinitionIndex = 19509;
