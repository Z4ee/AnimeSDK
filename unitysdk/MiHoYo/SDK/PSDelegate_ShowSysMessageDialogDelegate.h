...
#define MIHOYO_SDK_PSDELEGATE_SHOWSYSMESSAGEDIALOGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x175FB790)
#define MIHOYO_SDK_PSDELEGATE_SHOWSYSMESSAGEDIALOGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x175FB7D0)
#define MIHOYO_SDK_PSDELEGATE_SHOWSYSMESSAGEDIALOGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x175D4070)
#define MIHOYO_SDK_PSDELEGATE_SHOWSYSMESSAGEDIALOGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x175FB770)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_ShowSysMessageDialogDelegate_TypeDefinitionIndex = 6792;
