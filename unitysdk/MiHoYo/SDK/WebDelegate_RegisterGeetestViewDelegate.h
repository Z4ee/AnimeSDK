...
#define MIHOYO_SDK_WEBDELEGATE_REGISTERGEETESTVIEWDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16041BB0)
#define MIHOYO_SDK_WEBDELEGATE_REGISTERGEETESTVIEWDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16041BE0)
#define MIHOYO_SDK_WEBDELEGATE_REGISTERGEETESTVIEWDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x16041660)
#define MIHOYO_SDK_WEBDELEGATE_REGISTERGEETESTVIEWDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16041640)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_RegisterGeetestViewDelegate_TypeDefinitionIndex = 6845;
