...
#define MIHOYO_SDK_CONFIGMANAGER___C__DISPLAYCLASS95_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C388B80)
#define MIHOYO_SDK_CONFIGMANAGER___C__DISPLAYCLASS95_0__REQUESTMDKCONFIG_B__0_OFFSET UNITYSDK_OFFSET(0x1C388B90)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConfigManager___c__DisplayClass95_0_TypeDefinitionIndex = 19974;
