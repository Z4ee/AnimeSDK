...
#define MIHOYO_SDK_THIRDLOGINCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x16000550)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ThirdLoginConfigs_TypeDefinitionIndex = 6907;
