...
#define MIHOYO_SDK_THIRDLOGINCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1712E2F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ThirdLoginConfigs_TypeDefinitionIndex = 7861;
