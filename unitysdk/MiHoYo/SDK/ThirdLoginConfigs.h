...
#define MIHOYO_SDK_THIRDLOGINCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9BA690)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ThirdLoginConfigs_TypeDefinitionIndex = 7864;
