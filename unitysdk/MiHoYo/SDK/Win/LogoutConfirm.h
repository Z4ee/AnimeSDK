...
#define MIHOYO_SDK_WIN_LOGOUTCONFIRM_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A5397D0)
#define MIHOYO_SDK_WIN_LOGOUTCONFIRM_CLICKCANCELBUTTON_OFFSET UNITYSDK_OFFSET(0x1A53A9F0)
#define MIHOYO_SDK_WIN_LOGOUTCONFIRM_CLICKLOGOUTBUTTON_OFFSET UNITYSDK_OFFSET(0x1A53AA10)
#define MIHOYO_SDK_WIN_LOGOUTCONFIRM_HIDE_OFFSET UNITYSDK_OFFSET(0x1A53ABB0)
#define MIHOYO_SDK_WIN_LOGOUTCONFIRM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A53AC20)
#define MIHOYO_SDK_WIN_LOGOUTCONFIRM_SHOW_OFFSET UNITYSDK_OFFSET(0x1A53AA80)
#define MIHOYO_SDK_WIN_LOGOUTCONFIRM_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x1A539FF0)
#define MIHOYO_SDK_WIN_LOGOUTCONFIRM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A53AC40)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int LogoutConfirm_TypeDefinitionIndex = 19881;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::LogoutConfirm**)Il2CppClass::FromTypeDefinitionIndex(LogoutConfirm_TypeDefinitionIndex)->GetStaticField(0x9650);
		}
