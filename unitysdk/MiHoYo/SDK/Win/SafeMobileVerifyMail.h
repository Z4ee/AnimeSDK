...
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_AWAKE_OFFSET UNITYSDK_OFFSET(0x174C1470)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_BIND_OFFSET UNITYSDK_OFFSET(0x174C1FD0)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_CLOSE_OFFSET UNITYSDK_OFFSET(0x174C1EB0)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x174C1F50)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_HIDE_OFFSET UNITYSDK_OFFSET(0x174C1E40)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x174C21C0)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x174C2160)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x174C1FB0)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_SHOW_OFFSET UNITYSDK_OFFSET(0x174C1D50)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x174C1ED0)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x174C1C60)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_VALUECHANGEPHONEINPUT_OFFSET UNITYSDK_OFFSET(0x174C1FC0)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x174C2200)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int SafeMobileVerifyMail_TypeDefinitionIndex = 8240;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::SafeMobileVerifyMail**)Il2CppClass::FromTypeDefinitionIndex(SafeMobileVerifyMail_TypeDefinitionIndex)->GetStaticField(0x33210);
		}
