...
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_AWAKE_OFFSET UNITYSDK_OFFSET(0x15E8A040)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_BIND_OFFSET UNITYSDK_OFFSET(0x15E8ABA0)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_CLOSE_OFFSET UNITYSDK_OFFSET(0x15E8AA80)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x15E8AB20)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_HIDE_OFFSET UNITYSDK_OFFSET(0x15E8AA10)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x15E8AD90)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x15E8AD30)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x15E8AB80)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_SHOW_OFFSET UNITYSDK_OFFSET(0x15E8A920)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x15E8AAA0)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x15E8A830)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_VALUECHANGEPHONEINPUT_OFFSET UNITYSDK_OFFSET(0x15E8AB90)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x15E8ADD0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int SafeMobileVerifyMail_TypeDefinitionIndex = 8094;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::SafeMobileVerifyMail**)Il2CppClass::FromTypeDefinitionIndex(SafeMobileVerifyMail_TypeDefinitionIndex)->GetStaticField(0x175F0);
		}
		...
		{
			return ((::System::Void(*)(::MiHoYo::SDK::AccountModel*))((::PBYTE)hIl2Cpp + MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_SHOW_OFFSET))(model);
		}
		...
		{
			return ((::System::Collections::IEnumerator*(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_COUNTDOWN_OFFSET))(this, time);
		}
