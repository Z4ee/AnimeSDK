...
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B8EB8E0)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_BIND_OFFSET UNITYSDK_OFFSET(0x1B8EC610)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_CLOSE_OFFSET UNITYSDK_OFFSET(0x1B8EC4F0)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1B8EC590)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_HIDE_OFFSET UNITYSDK_OFFSET(0x1B8EC480)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B8EC810)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x1B8EC7B0)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1B8EC5F0)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_SHOW_OFFSET UNITYSDK_OFFSET(0x1B8EC380)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1B8EC510)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x1B8EC200)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL_VALUECHANGEPHONEINPUT_OFFSET UNITYSDK_OFFSET(0x1B8EC600)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8EC830)
...
namespace MiHoYo::SDK::Win
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::SafeMobileVerifyMail**)Il2CppClass::FromTypeDefinitionIndex(SafeMobileVerifyMail_TypeDefinitionIndex)->GetStaticField(0x38B30);
		}
