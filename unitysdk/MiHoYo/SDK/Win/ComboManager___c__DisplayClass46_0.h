...
#define MIHOYO_SDK_WIN_COMBOMANAGER___C__DISPLAYCLASS46_0__BEFOREVERIFY_B__0_OFFSET UNITYSDK_OFFSET(0x16094C40)
#define MIHOYO_SDK_WIN_COMBOMANAGER___C__DISPLAYCLASS46_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16087920)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int ComboManager___c__DisplayClass46_0_TypeDefinitionIndex = 8036;
