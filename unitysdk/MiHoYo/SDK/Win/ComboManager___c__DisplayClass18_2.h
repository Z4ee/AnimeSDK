...
#define MIHOYO_SDK_WIN_COMBOMANAGER___C__DISPLAYCLASS18_2__CTOR_OFFSET UNITYSDK_OFFSET(0x199C59B0)
#define MIHOYO_SDK_WIN_COMBOMANAGER___C__DISPLAYCLASS18_2__LOGIN_B__7_OFFSET UNITYSDK_OFFSET(0x199C5AF0)
#define MIHOYO_SDK_WIN_COMBOMANAGER___C__DISPLAYCLASS18_2__LOGIN_B__8_OFFSET UNITYSDK_OFFSET(0x199C59C0)
#define MIHOYO_SDK_WIN_COMBOMANAGER___C__DISPLAYCLASS18_2__LOGIN_B__9_OFFSET UNITYSDK_OFFSET(0x199C5A20)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int ComboManager___c__DisplayClass18_2_TypeDefinitionIndex = 19998;
