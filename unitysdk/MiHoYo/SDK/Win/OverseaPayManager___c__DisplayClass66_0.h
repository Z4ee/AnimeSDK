...
#define MIHOYO_SDK_WIN_OVERSEAPAYMANAGER___C__DISPLAYCLASS66_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5FDB40)
#define MIHOYO_SDK_WIN_OVERSEAPAYMANAGER___C__DISPLAYCLASS66_0__REQUESTADYENCREATEORDER_B__0_OFFSET UNITYSDK_OFFSET(0x1B5FDB50)
#define MIHOYO_SDK_WIN_OVERSEAPAYMANAGER___C__DISPLAYCLASS66_0__REQUESTADYENCREATEORDER_G__CANCELCALLBACK_1_OFFSET UNITYSDK_OFFSET(0x1B5FF5F0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int OverseaPayManager___c__DisplayClass66_0_TypeDefinitionIndex = 21093;
