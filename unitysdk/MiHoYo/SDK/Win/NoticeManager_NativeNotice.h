...
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x160FA0A0)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_ISNATIVETASKSWITCHENABLE_OFFSET UNITYSDK_OFFSET(0x16101EF0)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_ONSYNCDATATONATIVE_OFFSET UNITYSDK_OFFSET(0x16101760)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x16101720)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_SYNCCOMBOLOGINDATATONATIVE_OFFSET UNITYSDK_OFFSET(0x16101D50)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_SYNCCURENVCONFIGTONATIVE_OFFSET UNITYSDK_OFFSET(0x16101830)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_SYNCGAMEROLETONATIVE_OFFSET UNITYSDK_OFFSET(0x161018A0)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_SYNCNOTICELANGTONATIVE_OFFSET UNITYSDK_OFFSET(0x161018F0)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_SYNCNOTICEURLTONATIVE_OFFSET UNITYSDK_OFFSET(0x16101B00)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_TRYCHECKPOPNOTICE_OFFSET UNITYSDK_OFFSET(0x160FA150)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_TRYMANUALLYCLOSE_OFFSET UNITYSDK_OFFSET(0x160FC030)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_TRYONSETSERVERID_OFFSET UNITYSDK_OFFSET(0x160FF4A0)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_TRYREQUESTREDPOINTTEXT_OFFSET UNITYSDK_OFFSET(0x160FAF90)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_TRYSHOWNOTICE_OFFSET UNITYSDK_OFFSET(0x160FBEE0)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_TRYSHOWPOPNOTICE_OFFSET UNITYSDK_OFFSET(0x160FBF30)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE__CCTOR_OFFSET UNITYSDK_OFFSET(0x16101FB0)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE__CTOR_OFFSET UNITYSDK_OFFSET(0x161014B0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int NoticeManager_NativeNotice_TypeDefinitionIndex = 8004;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::NoticeManager_NativeNotice**)Il2CppClass::FromTypeDefinitionIndex(NoticeManager_NativeNotice_TypeDefinitionIndex)->GetStaticField(0x15A80);
		}
