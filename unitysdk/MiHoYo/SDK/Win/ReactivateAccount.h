...
#define MIHOYO_SDK_WIN_REACTIVATEACCOUNT_AWAKE_OFFSET UNITYSDK_OFFSET(0x171735D0)
#define MIHOYO_SDK_WIN_REACTIVATEACCOUNT_CLOSE_OFFSET UNITYSDK_OFFSET(0x17173EE0)
#define MIHOYO_SDK_WIN_REACTIVATEACCOUNT_HIDE_OFFSET UNITYSDK_OFFSET(0x17173E70)
#define MIHOYO_SDK_WIN_REACTIVATEACCOUNT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17173F20)
#define MIHOYO_SDK_WIN_REACTIVATEACCOUNT_SHOW_OFFSET UNITYSDK_OFFSET(0x17173470)
#define MIHOYO_SDK_WIN_REACTIVATEACCOUNT_SUBMIT_OFFSET UNITYSDK_OFFSET(0x17173F00)
#define MIHOYO_SDK_WIN_REACTIVATEACCOUNT_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x17173B20)
#define MIHOYO_SDK_WIN_REACTIVATEACCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x17173F40)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int ReactivateAccount_TypeDefinitionIndex = 9209;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::ReactivateAccount**)Il2CppClass::FromTypeDefinitionIndex(ReactivateAccount_TypeDefinitionIndex)->GetStaticField(0x1AE80);
		}
