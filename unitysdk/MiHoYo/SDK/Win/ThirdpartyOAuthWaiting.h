...
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING_AWAKE_OFFSET UNITYSDK_OFFSET(0x18DFC070)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING_HIDE_OFFSET UNITYSDK_OFFSET(0x18DFD100)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18DFD000)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING_SHOWFAILEDSTAGE_OFFSET UNITYSDK_OFFSET(0x18DFD4E0)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING_SHOWTIMEOUTSTAGE_OFFSET UNITYSDK_OFFSET(0x18DFD170)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING_SHOWWAITINGSTAGE_OFFSET UNITYSDK_OFFSET(0x18DFCB40)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING_SHOW_OFFSET UNITYSDK_OFFSET(0x18DFD020)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING__CTOR_OFFSET UNITYSDK_OFFSET(0x18DFD850)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING__SHOWFAILEDSTAGE_B__29_0_OFFSET UNITYSDK_OFFSET(0x18DFD8E0)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING__SHOWFAILEDSTAGE_B__29_1_OFFSET UNITYSDK_OFFSET(0x18DFD900)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING__SHOWTIMEOUTSTAGE_B__28_0_OFFSET UNITYSDK_OFFSET(0x18DFD8A0)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING__SHOWTIMEOUTSTAGE_B__28_1_OFFSET UNITYSDK_OFFSET(0x18DFD8C0)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING__SHOWWAITINGSTAGE_B__27_0_OFFSET UNITYSDK_OFFSET(0x18DFD860)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING__SHOWWAITINGSTAGE_B__27_1_OFFSET UNITYSDK_OFFSET(0x18DFD880)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int ThirdpartyOAuthWaiting_TypeDefinitionIndex = 19892;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::ThirdpartyOAuthWaiting**)Il2CppClass::FromTypeDefinitionIndex(ThirdpartyOAuthWaiting_TypeDefinitionIndex)->GetStaticField(0x9DD0);
		}
		static ::MiHoYo::SDK::Win::OAuthType* StaticGet_AuthType()
		{
			return (::MiHoYo::SDK::Win::OAuthType*)Il2CppClass::FromTypeDefinitionIndex(ThirdpartyOAuthWaiting_TypeDefinitionIndex)->GetStaticField(0x44A0);
		}
