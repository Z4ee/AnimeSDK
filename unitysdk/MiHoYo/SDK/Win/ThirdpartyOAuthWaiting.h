...
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A9E8A70)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING_HIDE_OFFSET UNITYSDK_OFFSET(0x1A9E9B00)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A9E9A00)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING_SHOWFAILEDSTAGE_OFFSET UNITYSDK_OFFSET(0x1A9E9EE0)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING_SHOWTIMEOUTSTAGE_OFFSET UNITYSDK_OFFSET(0x1A9E9B70)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING_SHOWWAITINGSTAGE_OFFSET UNITYSDK_OFFSET(0x1A9E9540)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING_SHOW_OFFSET UNITYSDK_OFFSET(0x1A9E9A20)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9EA250)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING__SHOWFAILEDSTAGE_B__29_0_OFFSET UNITYSDK_OFFSET(0x1A9EA2E0)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING__SHOWFAILEDSTAGE_B__29_1_OFFSET UNITYSDK_OFFSET(0x1A9EA300)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING__SHOWTIMEOUTSTAGE_B__28_0_OFFSET UNITYSDK_OFFSET(0x1A9EA2A0)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING__SHOWTIMEOUTSTAGE_B__28_1_OFFSET UNITYSDK_OFFSET(0x1A9EA2C0)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING__SHOWWAITINGSTAGE_B__27_0_OFFSET UNITYSDK_OFFSET(0x1A9EA260)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING__SHOWWAITINGSTAGE_B__27_1_OFFSET UNITYSDK_OFFSET(0x1A9EA280)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int ThirdpartyOAuthWaiting_TypeDefinitionIndex = 21055;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::ThirdpartyOAuthWaiting**)Il2CppClass::FromTypeDefinitionIndex(ThirdpartyOAuthWaiting_TypeDefinitionIndex)->GetStaticField(0xA090);
		}
		static ::MiHoYo::SDK::Win::OAuthType* StaticGet_AuthType()
		{
			return (::MiHoYo::SDK::Win::OAuthType*)Il2CppClass::FromTypeDefinitionIndex(ThirdpartyOAuthWaiting_TypeDefinitionIndex)->GetStaticField(0x45B0);
		}
