...
#define MIHOYO_SDK_WIN_TAPTAPMANAGER_GETACCESSTOKEN_OFFSET UNITYSDK_OFFSET(0x15E98480)
#define MIHOYO_SDK_WIN_TAPTAPMANAGER_GETSHOWNAME_OFFSET UNITYSDK_OFFSET(0x15E984F0)
#define MIHOYO_SDK_WIN_TAPTAPMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0x15E982D0)
#define MIHOYO_SDK_WIN_TAPTAPMANAGER_LOGIN_OFFSET UNITYSDK_OFFSET(0x15E98390)
#define MIHOYO_SDK_WIN_TAPTAPMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x15E98530)
#define MIHOYO_SDK_WIN_TAPTAPMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x15E98520)
#define MIHOYO_SDK_WIN_TAPTAPMANAGER__LOGIN_B__4_0_OFFSET UNITYSDK_OFFSET(0x15E98560)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int TapTapManager_TypeDefinitionIndex = 7978;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::TapTapManager**)Il2CppClass::FromTypeDefinitionIndex(TapTapManager_TypeDefinitionIndex)->GetStaticField(0x13610);
		}
