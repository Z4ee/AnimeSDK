...
#define MIHOYO_SDK_WIN_COMBOMANAGER___C__DISPLAYCLASS36_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCA6510)
#define MIHOYO_SDK_WIN_COMBOMANAGER___C__DISPLAYCLASS36_0__LOGOUTWITHOUTCONFIRM_B__0_OFFSET UNITYSDK_OFFSET(0x1BCA6520)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int ComboManager___c__DisplayClass36_0_TypeDefinitionIndex = 21174;
