...
#define MIHOYO_SDK_WIN_BILIBILIGAMEINFOMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6EBB30)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int BiliBiliGameInfoModel_TypeDefinitionIndex = 21075;
