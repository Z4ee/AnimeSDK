...
#define MIHOYO_SDK_WIN_BILIBILIGAMEINFOMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x15C307E0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int BiliBiliGameInfoModel_TypeDefinitionIndex = 9000;
