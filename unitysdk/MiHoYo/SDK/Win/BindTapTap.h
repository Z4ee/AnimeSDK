...
#define MIHOYO_SDK_WIN_BINDTAPTAP_AWAKE_OFFSET UNITYSDK_OFFSET(0x176C8600)
#define MIHOYO_SDK_WIN_BINDTAPTAP_BIND_OFFSET UNITYSDK_OFFSET(0x176C8CC0)
#define MIHOYO_SDK_WIN_BINDTAPTAP_HIDE_OFFSET UNITYSDK_OFFSET(0x176C18C0)
#define MIHOYO_SDK_WIN_BINDTAPTAP_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x176C8D00)
#define MIHOYO_SDK_WIN_BINDTAPTAP_REGISTER_OFFSET UNITYSDK_OFFSET(0x176C8CE0)
#define MIHOYO_SDK_WIN_BINDTAPTAP_SHOW_OFFSET UNITYSDK_OFFSET(0x176BE280)
#define MIHOYO_SDK_WIN_BINDTAPTAP_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x176C8BC0)
#define MIHOYO_SDK_WIN_BINDTAPTAP__CTOR_OFFSET UNITYSDK_OFFSET(0x176C8D40)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int BindTapTap_TypeDefinitionIndex = 8256;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::BindTapTap**)Il2CppClass::FromTypeDefinitionIndex(BindTapTap_TypeDefinitionIndex)->GetStaticField(0x27C80);
		}
