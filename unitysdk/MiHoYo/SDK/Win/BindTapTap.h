...
#define MIHOYO_SDK_WIN_BINDTAPTAP_AWAKE_OFFSET UNITYSDK_OFFSET(0x16064400)
#define MIHOYO_SDK_WIN_BINDTAPTAP_BIND_OFFSET UNITYSDK_OFFSET(0x16064AC0)
#define MIHOYO_SDK_WIN_BINDTAPTAP_HIDE_OFFSET UNITYSDK_OFFSET(0x1605D6D0)
#define MIHOYO_SDK_WIN_BINDTAPTAP_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x16064B00)
#define MIHOYO_SDK_WIN_BINDTAPTAP_REGISTER_OFFSET UNITYSDK_OFFSET(0x16064AE0)
#define MIHOYO_SDK_WIN_BINDTAPTAP_SHOW_OFFSET UNITYSDK_OFFSET(0x16059CA0)
#define MIHOYO_SDK_WIN_BINDTAPTAP_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x160649C0)
#define MIHOYO_SDK_WIN_BINDTAPTAP__CTOR_OFFSET UNITYSDK_OFFSET(0x16064B40)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int BindTapTap_TypeDefinitionIndex = 8110;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::BindTapTap**)Il2CppClass::FromTypeDefinitionIndex(BindTapTap_TypeDefinitionIndex)->GetStaticField(0x13660);
		}
