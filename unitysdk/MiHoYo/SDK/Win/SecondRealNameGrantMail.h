...
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_AWAKE_OFFSET UNITYSDK_OFFSET(0x17187A00)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_BACK_OFFSET UNITYSDK_OFFSET(0x1717DC40)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x17188F10)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_HIDE_OFFSET UNITYSDK_OFFSET(0x171799D0)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_LOGIN_OFFSET UNITYSDK_OFFSET(0x17188D30)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17188F80)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_OTHERVERIFY_OFFSET UNITYSDK_OFFSET(0x17188EF0)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_REDIRECT_OFFSET UNITYSDK_OFFSET(0x17188ED0)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x17188D00)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x17188CF0)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_SHOW_OFFSET UNITYSDK_OFFSET(0x1717A050)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1717DBC0)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_START_OFFSET UNITYSDK_OFFSET(0x17188BD0)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x17188A50)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x171888D0)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x17188FA0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int SecondRealNameGrantMail_TypeDefinitionIndex = 9184;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::SecondRealNameGrantMail**)Il2CppClass::FromTypeDefinitionIndex(SecondRealNameGrantMail_TypeDefinitionIndex)->GetStaticField(0x2FED0);
		}
		...
		{
			return ((::System::Void(*)(::MiHoYo::SDK::AccountModel*, ::System::Boolean, ::System::Boolean))((::PBYTE)hIl2Cpp + MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_SHOW_OFFSET))(a1, a2, a3);
		}
		...
		{
			return ((::System::Collections::IEnumerator*(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_COUNTDOWN_OFFSET))(this, a1);
		}
