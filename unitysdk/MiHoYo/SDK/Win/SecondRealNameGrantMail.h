...
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_AWAKE_OFFSET UNITYSDK_OFFSET(0x182C6110)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_BACK_OFFSET UNITYSDK_OFFSET(0x182BCD40)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x182C7480)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_HIDE_OFFSET UNITYSDK_OFFSET(0x182B8800)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_LOGIN_OFFSET UNITYSDK_OFFSET(0x182C72A0)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x182C74F0)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_OTHERVERIFY_OFFSET UNITYSDK_OFFSET(0x182C7460)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_REDIRECT_OFFSET UNITYSDK_OFFSET(0x182C7440)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x182C7270)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x182C7260)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_SHOW_OFFSET UNITYSDK_OFFSET(0x182B8E80)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x182BCCC0)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_START_OFFSET UNITYSDK_OFFSET(0x182C71A0)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x182C70B0)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x182C7010)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x182C7510)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int SecondRealNameGrantMail_TypeDefinitionIndex = 9172;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::SecondRealNameGrantMail**)Il2CppClass::FromTypeDefinitionIndex(SecondRealNameGrantMail_TypeDefinitionIndex)->GetStaticField(0x2C850);
		}
