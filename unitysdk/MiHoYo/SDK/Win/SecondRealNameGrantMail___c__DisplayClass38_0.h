...
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL___C__DISPLAYCLASS38_0__CTOR_OFFSET UNITYSDK_OFFSET(0x174C7F60)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL___C__DISPLAYCLASS38_0__SHOW_B__0_OFFSET UNITYSDK_OFFSET(0x174C8260)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int SecondRealNameGrantMail___c__DisplayClass38_0_TypeDefinitionIndex = 8270;
