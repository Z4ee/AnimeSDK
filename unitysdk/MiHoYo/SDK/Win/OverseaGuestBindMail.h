...
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1828D600)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_BACK_OFFSET UNITYSDK_OFFSET(0x1828E240)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_BIND_OFFSET UNITYSDK_OFFSET(0x1828E2B0)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_CLOSE_OFFSET UNITYSDK_OFFSET(0x1828E260)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_FORGETPASSWORD_OFFSET UNITYSDK_OFFSET(0x1828E510)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_HIDE_OFFSET UNITYSDK_OFFSET(0x1828D590)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1828E530)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_SETMAILINPUTTEXT_OFFSET UNITYSDK_OFFSET(0x1828E280)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_SHOW_OFFSET UNITYSDK_OFFSET(0x1828D430)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x1828DFD0)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1828E550)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int OverseaGuestBindMail_TypeDefinitionIndex = 9146;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::OverseaGuestBindMail**)Il2CppClass::FromTypeDefinitionIndex(OverseaGuestBindMail_TypeDefinitionIndex)->GetStaticField(0x26210);
		}
