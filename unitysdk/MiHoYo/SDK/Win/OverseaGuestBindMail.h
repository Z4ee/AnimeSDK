...
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1D4C6EA0)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_BACK_OFFSET UNITYSDK_OFFSET(0x1D4C7CC0)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_BIND_OFFSET UNITYSDK_OFFSET(0x1D4C7DA0)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_CLOSE_OFFSET UNITYSDK_OFFSET(0x1D4C7CE0)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_FORGETPASSWORD_OFFSET UNITYSDK_OFFSET(0x1D4C8000)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_HIDE_OFFSET UNITYSDK_OFFSET(0x1D4C6E30)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1D4C8020)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_SETMAILINPUTTEXT_OFFSET UNITYSDK_OFFSET(0x1D4C7D00)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_SHOW_OFFSET UNITYSDK_OFFSET(0x1D4C6D00)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x1D4C7A20)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4C8040)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int OverseaGuestBindMail_TypeDefinitionIndex = 21591;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::OverseaGuestBindMail**)Il2CppClass::FromTypeDefinitionIndex(OverseaGuestBindMail_TypeDefinitionIndex)->GetStaticField(0x9F40);
		}
