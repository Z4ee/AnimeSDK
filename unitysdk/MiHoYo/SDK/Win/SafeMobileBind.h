...
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND_AWAKE_OFFSET UNITYSDK_OFFSET(0x15E88D60)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND_BIND_OFFSET UNITYSDK_OFFSET(0x15E89A10)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND_CLOSE_OFFSET UNITYSDK_OFFSET(0x15E898F0)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x15E89990)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND_HIDE_OFFSET UNITYSDK_OFFSET(0x15E89880)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x15E89D30)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x15E89CD0)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x15E899F0)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND_SHOW_OFFSET UNITYSDK_OFFSET(0x15E89790)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x15E89910)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x15E89590)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND_VALUECHANGEPHONEINPUT_OFFSET UNITYSDK_OFFSET(0x15E89A00)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND__AWAKE_B__25_0_OFFSET UNITYSDK_OFFSET(0x15E89DB0)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND__CTOR_OFFSET UNITYSDK_OFFSET(0x15E89D70)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int SafeMobileBind_TypeDefinitionIndex = 8120;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::SafeMobileBind**)Il2CppClass::FromTypeDefinitionIndex(SafeMobileBind_TypeDefinitionIndex)->GetStaticField(0x17580);
		}
