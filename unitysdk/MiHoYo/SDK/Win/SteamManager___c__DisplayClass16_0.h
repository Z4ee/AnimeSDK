...
#define MIHOYO_SDK_WIN_STEAMMANAGER___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1718BB20)
#define MIHOYO_SDK_WIN_STEAMMANAGER___C__DISPLAYCLASS16_0__GETPRODUCTLIST_B__0_OFFSET UNITYSDK_OFFSET(0x1718F640)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int SteamManager___c__DisplayClass16_0_TypeDefinitionIndex = 9037;
