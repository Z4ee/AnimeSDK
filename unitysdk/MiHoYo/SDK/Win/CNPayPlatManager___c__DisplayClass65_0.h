...
#define MIHOYO_SDK_WIN_CNPAYPLATMANAGER___C__DISPLAYCLASS65_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4BC480)
#define MIHOYO_SDK_WIN_CNPAYPLATMANAGER___C__DISPLAYCLASS65_0__REQUESTCHECKOUTV2_B__0_OFFSET UNITYSDK_OFFSET(0x1D4BC490)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int CNPayPlatManager___c__DisplayClass65_0_TypeDefinitionIndex = 21373;
