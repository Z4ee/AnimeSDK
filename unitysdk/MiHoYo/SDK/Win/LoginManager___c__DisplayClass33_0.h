...
#define MIHOYO_SDK_WIN_LOGINMANAGER___C__DISPLAYCLASS33_0__CTOR_OFFSET UNITYSDK_OFFSET(0x156B37A0)
#define MIHOYO_SDK_WIN_LOGINMANAGER___C__DISPLAYCLASS33_0__SHOWPHONEMESSAGEVIEW_B__0_OFFSET UNITYSDK_OFFSET(0x156C9240)
#define MIHOYO_SDK_WIN_LOGINMANAGER___C__DISPLAYCLASS33_0__SHOWPHONEMESSAGEVIEW_B__1_OFFSET UNITYSDK_OFFSET(0x156C9280)
#define MIHOYO_SDK_WIN_LOGINMANAGER___C__DISPLAYCLASS33_0__SHOWPHONEMESSAGEVIEW_B__2_OFFSET UNITYSDK_OFFSET(0x156C92C0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int LoginManager___c__DisplayClass33_0_TypeDefinitionIndex = 9108;
