...
#define MIHOYO_SDK_WIN_COMBOMANAGER___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15672E90)
#define MIHOYO_SDK_WIN_COMBOMANAGER___C__DISPLAYCLASS16_0__ONMDKORAUTHTICKETLOGIN_B__0_OFFSET UNITYSDK_OFFSET(0x15672EA0)
#define MIHOYO_SDK_WIN_COMBOMANAGER___C__DISPLAYCLASS16_0__ONMDKORAUTHTICKETLOGIN_B__1_OFFSET UNITYSDK_OFFSET(0x15675160)
#define MIHOYO_SDK_WIN_COMBOMANAGER___C__DISPLAYCLASS16_0__ONMDKORAUTHTICKETLOGIN_B__3_OFFSET UNITYSDK_OFFSET(0x15674CC0)
#define MIHOYO_SDK_WIN_COMBOMANAGER___C__DISPLAYCLASS16_0__ONMDKORAUTHTICKETLOGIN_B__4_OFFSET UNITYSDK_OFFSET(0x15675130)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int ComboManager___c__DisplayClass16_0_TypeDefinitionIndex = 9081;
