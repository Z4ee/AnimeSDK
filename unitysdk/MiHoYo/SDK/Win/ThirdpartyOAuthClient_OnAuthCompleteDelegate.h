...
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT_ONAUTHCOMPLETEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C0F8A60)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT_ONAUTHCOMPLETEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C0F8AA0)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT_ONAUTHCOMPLETEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C0F84E0)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT_ONAUTHCOMPLETEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0F84C0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int ThirdpartyOAuthClient_OnAuthCompleteDelegate_TypeDefinitionIndex = 21007;
