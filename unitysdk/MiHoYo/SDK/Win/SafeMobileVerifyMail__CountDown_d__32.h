...
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL__COUNTDOWN_D__32_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x187A4130)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL__COUNTDOWN_D__32_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x187A4360)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL__COUNTDOWN_D__32_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x187A43C0)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL__COUNTDOWN_D__32_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x187A4370)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL__COUNTDOWN_D__32_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x187A4120)
#define MIHOYO_SDK_WIN_SAFEMOBILEVERIFYMAIL__COUNTDOWN_D__32__CTOR_OFFSET UNITYSDK_OFFSET(0x187A4080)
