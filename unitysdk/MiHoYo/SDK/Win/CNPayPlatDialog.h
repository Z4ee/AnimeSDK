...
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x184880F0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_BACK_OFFSET UNITYSDK_OFFSET(0x1848EBF0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_CLICKALIPAYBTN_OFFSET UNITYSDK_OFFSET(0x1848DE90)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_CLICKFOLDSWITCH_OFFSET UNITYSDK_OFFSET(0x1848E710)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_CLICKWECHATPAYBTN_OFFSET UNITYSDK_OFFSET(0x1848E2D0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_DIALOGANIMATOREND_OFFSET UNITYSDK_OFFSET(0x1848A370)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_FAILREFRESH_OFFSET UNITYSDK_OFFSET(0x1848A610)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_GET_CODELINKTYPE_OFFSET UNITYSDK_OFFSET(0x184876E0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x18487800)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1848F160)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_OVERDUEREFRESH_OFFSET UNITYSDK_OFFSET(0x1848BED0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_PAYSUCCESS_OFFSET UNITYSDK_OFFSET(0x1848EFD0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_REFRESHGOODSINFO_OFFSET UNITYSDK_OFFSET(0x18487990)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_SET_CODELINKTYPE_OFFSET UNITYSDK_OFFSET(0x184876F0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_SHOWNETWORKERROR_OFFSET UNITYSDK_OFFSET(0x1848C590)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_SHOWPAYLOADING_OFFSET UNITYSDK_OFFSET(0x1848C0E0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_SHOWPAYPLATLIST_OFFSET UNITYSDK_OFFSET(0x1848C9D0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_SHOWPAYSUCCESS_OFFSET UNITYSDK_OFFSET(0x1848C760)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_SHOWQRCODEERROR_OFFSET UNITYSDK_OFFSET(0x1848C440)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_SHOWQRCODEOVERDUE_OFFSET UNITYSDK_OFFSET(0x1848C2F0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_SHOWQRCODE_OFFSET UNITYSDK_OFFSET(0x1848C1D0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x18487700)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_START_OFFSET UNITYSDK_OFFSET(0x184878F0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG__BACK_B__118_0_OFFSET UNITYSDK_OFFSET(0x1848F1F0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1848F1A0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int CNPayPlatDialog_TypeDefinitionIndex = 9203;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::CNPayPlatDialog**)Il2CppClass::FromTypeDefinitionIndex(CNPayPlatDialog_TypeDefinitionIndex)->GetStaticField(0x26780);
		}
