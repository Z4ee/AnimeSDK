...
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x16065670)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_BACK_OFFSET UNITYSDK_OFFSET(0x1606C1E0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_CLICKALIPAYBTN_OFFSET UNITYSDK_OFFSET(0x1606B4A0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_CLICKFOLDSWITCH_OFFSET UNITYSDK_OFFSET(0x1606BD00)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_CLICKWECHATPAYBTN_OFFSET UNITYSDK_OFFSET(0x1606B8D0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_DIALOGANIMATOREND_OFFSET UNITYSDK_OFFSET(0x160678A0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_FAILREFRESH_OFFSET UNITYSDK_OFFSET(0x16067B40)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_GET_CODELINKTYPE_OFFSET UNITYSDK_OFFSET(0x16064C80)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x16064D90)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1606C740)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_OVERDUEREFRESH_OFFSET UNITYSDK_OFFSET(0x160694E0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_PAYSUCCESS_OFFSET UNITYSDK_OFFSET(0x1606C5B0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_REFRESHGOODSINFO_OFFSET UNITYSDK_OFFSET(0x16064F10)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_SET_CODELINKTYPE_OFFSET UNITYSDK_OFFSET(0x16064C90)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_SHOWNETWORKERROR_OFFSET UNITYSDK_OFFSET(0x16069BA0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_SHOWPAYLOADING_OFFSET UNITYSDK_OFFSET(0x160696F0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_SHOWPAYPLATLIST_OFFSET UNITYSDK_OFFSET(0x16069FE0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_SHOWPAYSUCCESS_OFFSET UNITYSDK_OFFSET(0x16069D70)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_SHOWQRCODEERROR_OFFSET UNITYSDK_OFFSET(0x16069A50)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_SHOWQRCODEOVERDUE_OFFSET UNITYSDK_OFFSET(0x16069900)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_SHOWQRCODE_OFFSET UNITYSDK_OFFSET(0x160697E0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x16064CA0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_START_OFFSET UNITYSDK_OFFSET(0x16064E80)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG__BACK_B__118_0_OFFSET UNITYSDK_OFFSET(0x1606C800)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1606C7B0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int CNPayPlatDialog_TypeDefinitionIndex = 8154;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::CNPayPlatDialog**)Il2CppClass::FromTypeDefinitionIndex(CNPayPlatDialog_TypeDefinitionIndex)->GetStaticField(0x13820);
		}
