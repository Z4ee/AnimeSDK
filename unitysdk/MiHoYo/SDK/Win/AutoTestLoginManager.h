...
#define MIHOYO_SDK_WIN_AUTOTESTLOGINMANAGER_COMBOLOGIN_OFFSET UNITYSDK_OFFSET(0x15C2D480)
#define MIHOYO_SDK_WIN_AUTOTESTLOGINMANAGER_COMBOLOGOUT_OFFSET UNITYSDK_OFFSET(0x15C2D770)
#define MIHOYO_SDK_WIN_AUTOTESTLOGINMANAGER_LOGIN_OFFSET UNITYSDK_OFFSET(0x15C2D5A0)
#define MIHOYO_SDK_WIN_AUTOTESTLOGINMANAGER_LOGOUT_OFFSET UNITYSDK_OFFSET(0x15C2D890)
#define MIHOYO_SDK_WIN_AUTOTESTLOGINMANAGER_ONCOMBOLOGINCALLBACK_OFFSET UNITYSDK_OFFSET(0x15C2CDE0)
#define MIHOYO_SDK_WIN_AUTOTESTLOGINMANAGER_REQUESTCOMBOLOGIN_OFFSET UNITYSDK_OFFSET(0x15C2CC50)
#define MIHOYO_SDK_WIN_AUTOTESTLOGINMANAGER_SETLOGINACCOUNT_OFFSET UNITYSDK_OFFSET(0x15C2DF40)
#define MIHOYO_SDK_WIN_AUTOTESTLOGINMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x15C2E2D0)
#define MIHOYO_SDK_WIN_AUTOTESTLOGINMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x15C2E2A0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int AutoTestLoginManager_TypeDefinitionIndex = 8936;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::AutoTestLoginManager**)Il2CppClass::FromTypeDefinitionIndex(AutoTestLoginManager_TypeDefinitionIndex)->GetStaticField(0x292C0);
		}
