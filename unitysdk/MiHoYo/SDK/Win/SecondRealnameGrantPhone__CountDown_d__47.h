...
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTPHONE__COUNTDOWN_D__47_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BBD82A0)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTPHONE__COUNTDOWN_D__47_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BBD8460)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTPHONE__COUNTDOWN_D__47_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BBD84C0)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTPHONE__COUNTDOWN_D__47_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BBD8470)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTPHONE__COUNTDOWN_D__47_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BBD8290)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTPHONE__COUNTDOWN_D__47__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBD8280)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int SecondRealnameGrantPhone__CountDown_d__47_TypeDefinitionIndex = 21274;
