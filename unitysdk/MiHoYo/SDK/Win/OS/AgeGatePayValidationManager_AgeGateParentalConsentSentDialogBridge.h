...
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTSENTDIALOGBRIDGE_GET_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x18B1A570)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTSENTDIALOGBRIDGE_GET_ONRESENDEMAIL_OFFSET UNITYSDK_OFFSET(0x18B1A550)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTSENTDIALOGBRIDGE_HIDEDIALOG_OFFSET UNITYSDK_OFFSET(0x18B1A590)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTSENTDIALOGBRIDGE_SETEMAIL_OFFSET UNITYSDK_OFFSET(0x18B1A640)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTSENTDIALOGBRIDGE_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x18B1A650)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTSENTDIALOGBRIDGE_SET_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x18B1A580)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTSENTDIALOGBRIDGE_SET_ONRESENDEMAIL_OFFSET UNITYSDK_OFFSET(0x18B1A560)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTSENTDIALOGBRIDGE_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x18B19BA0)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTSENTDIALOGBRIDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B19AA0)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTSENTDIALOGBRIDGE___CTOR_B__1_0_OFFSET UNITYSDK_OFFSET(0x18B1A660)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTSENTDIALOGBRIDGE___CTOR_B__1_1_OFFSET UNITYSDK_OFFSET(0x18B1A680)
