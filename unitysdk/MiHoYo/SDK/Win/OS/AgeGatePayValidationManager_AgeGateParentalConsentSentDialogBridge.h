...
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTSENTDIALOGBRIDGE_GET_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x1CE29800)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTSENTDIALOGBRIDGE_GET_ONRESENDEMAIL_OFFSET UNITYSDK_OFFSET(0x1CE297E0)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTSENTDIALOGBRIDGE_HIDEDIALOG_OFFSET UNITYSDK_OFFSET(0x1CE29820)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTSENTDIALOGBRIDGE_SETEMAIL_OFFSET UNITYSDK_OFFSET(0x1CE298D0)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTSENTDIALOGBRIDGE_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x1CE298E0)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTSENTDIALOGBRIDGE_SET_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x1CE29810)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTSENTDIALOGBRIDGE_SET_ONRESENDEMAIL_OFFSET UNITYSDK_OFFSET(0x1CE297F0)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTSENTDIALOGBRIDGE_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1CE29450)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTSENTDIALOGBRIDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE29380)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTSENTDIALOGBRIDGE___CTOR_B__1_0_OFFSET UNITYSDK_OFFSET(0x1CE298F0)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTSENTDIALOGBRIDGE___CTOR_B__1_1_OFFSET UNITYSDK_OFFSET(0x1CE29940)

namespace MiHoYo::SDK::Win::OS
{
	inline static constexpr unsigned int AgeGatePayValidationManager_AgeGateParentalConsentSentDialogBridge_TypeDefinitionIndex = 21659;
