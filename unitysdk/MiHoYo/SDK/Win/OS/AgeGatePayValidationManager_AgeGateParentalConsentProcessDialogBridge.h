...
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTPROCESSDIALOGBRIDGE_GET_ONBACK_OFFSET UNITYSDK_OFFSET(0x18B1A300)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTPROCESSDIALOGBRIDGE_HIDEDIALOG_OFFSET UNITYSDK_OFFSET(0x18B1A320)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTPROCESSDIALOGBRIDGE_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x18B1A3D0)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTPROCESSDIALOGBRIDGE_SET_ONBACK_OFFSET UNITYSDK_OFFSET(0x18B1A310)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTPROCESSDIALOGBRIDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B19CB0)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTPROCESSDIALOGBRIDGE___CTOR_B__5_0_OFFSET UNITYSDK_OFFSET(0x18B1A3E0)
