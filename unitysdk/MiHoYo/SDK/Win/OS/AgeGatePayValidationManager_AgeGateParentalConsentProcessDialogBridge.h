...
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTPROCESSDIALOGBRIDGE_GET_ONBACK_OFFSET UNITYSDK_OFFSET(0x182843D0)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTPROCESSDIALOGBRIDGE_HIDEDIALOG_OFFSET UNITYSDK_OFFSET(0x182843F0)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTPROCESSDIALOGBRIDGE_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x182844A0)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTPROCESSDIALOGBRIDGE_SET_ONBACK_OFFSET UNITYSDK_OFFSET(0x182843E0)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTPROCESSDIALOGBRIDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18283D80)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTPROCESSDIALOGBRIDGE___CTOR_B__5_0_OFFSET UNITYSDK_OFFSET(0x182844B0)

namespace MiHoYo::SDK::Win::OS
{
	inline static constexpr unsigned int AgeGatePayValidationManager_AgeGateParentalConsentProcessDialogBridge_TypeDefinitionIndex = 9215;
