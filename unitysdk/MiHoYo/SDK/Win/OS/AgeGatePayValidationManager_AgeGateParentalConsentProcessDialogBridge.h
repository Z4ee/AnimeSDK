...
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTPROCESSDIALOGBRIDGE_GET_ONBACK_OFFSET UNITYSDK_OFFSET(0x17140CF0)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTPROCESSDIALOGBRIDGE_HIDEDIALOG_OFFSET UNITYSDK_OFFSET(0x17140D10)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTPROCESSDIALOGBRIDGE_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x17140DC0)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTPROCESSDIALOGBRIDGE_SET_ONBACK_OFFSET UNITYSDK_OFFSET(0x17140D00)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTPROCESSDIALOGBRIDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x171406A0)
#define MIHOYO_SDK_WIN_OS_AGEGATEPAYVALIDATIONMANAGER_AGEGATEPARENTALCONSENTPROCESSDIALOGBRIDGE___CTOR_B__5_0_OFFSET UNITYSDK_OFFSET(0x17140DD0)

namespace MiHoYo::SDK::Win::OS
{
	inline static constexpr unsigned int AgeGatePayValidationManager_AgeGateParentalConsentProcessDialogBridge_TypeDefinitionIndex = 9227;
