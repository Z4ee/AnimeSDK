...
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_AWAKE_OFFSET UNITYSDK_OFFSET(0x182A0520)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_BACK_OFFSET UNITYSDK_OFFSET(0x182A1650)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_CLOSE_OFFSET UNITYSDK_OFFSET(0x182A1630)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x182A16F0)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_HIDE_OFFSET UNITYSDK_OFFSET(0x182A15C0)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x182A1950)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x182A1910)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x182A1750)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_SHOW_OFFSET UNITYSDK_OFFSET(0x182A14C0)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x182A1670)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_START_OFFSET UNITYSDK_OFFSET(0x182A1340)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_SUBMIT_OFFSET UNITYSDK_OFFSET(0x182A1770)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x182A1250)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_VALUECHANGEPHONEINPUT_OFFSET UNITYSDK_OFFSET(0x182A1760)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE__CTOR_OFFSET UNITYSDK_OFFSET(0x182A1970)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int OverseaVerifyPhone_TypeDefinitionIndex = 9164;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::OverseaVerifyPhone**)Il2CppClass::FromTypeDefinitionIndex(OverseaVerifyPhone_TypeDefinitionIndex)->GetStaticField(0x26000);
		}
