...
#define MIHOYO_SDK_WIN_BINDBYMAIL__COUNTDOWN_D__44_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x15C38840)
#define MIHOYO_SDK_WIN_BINDBYMAIL__COUNTDOWN_D__44_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15C38A40)
#define MIHOYO_SDK_WIN_BINDBYMAIL__COUNTDOWN_D__44_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15C38AA0)
#define MIHOYO_SDK_WIN_BINDBYMAIL__COUNTDOWN_D__44_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x15C38A50)
#define MIHOYO_SDK_WIN_BINDBYMAIL__COUNTDOWN_D__44_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15C38830)
#define MIHOYO_SDK_WIN_BINDBYMAIL__COUNTDOWN_D__44__CTOR_OFFSET UNITYSDK_OFFSET(0x15C38750)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int BindByMail__CountDown_d__44_TypeDefinitionIndex = 9170;
