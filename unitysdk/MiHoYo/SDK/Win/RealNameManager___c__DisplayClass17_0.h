...
#define MIHOYO_SDK_WIN_REALNAMEMANAGER___C__DISPLAYCLASS17_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8E07F0)
#define MIHOYO_SDK_WIN_REALNAMEMANAGER___C__DISPLAYCLASS17_0__SHOWREALNAMEPLUGINUI_B__0_OFFSET UNITYSDK_OFFSET(0x1B8E4D40)
#define MIHOYO_SDK_WIN_REALNAMEMANAGER___C__DISPLAYCLASS17_0__SHOWREALNAMEPLUGINUI_B__1_OFFSET UNITYSDK_OFFSET(0x1B8E4D70)
#define MIHOYO_SDK_WIN_REALNAMEMANAGER___C__DISPLAYCLASS17_0__SHOWREALNAMEPLUGINUI_B__2_OFFSET UNITYSDK_OFFSET(0x1B8E4E50)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int RealNameManager___c__DisplayClass17_0_TypeDefinitionIndex = 9292;
