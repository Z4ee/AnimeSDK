...
#define MIHOYO_SDK_WIN_BINDBYMAIL_AWAKE_OFFSET UNITYSDK_OFFSET(0x15C36F00)
#define MIHOYO_SDK_WIN_BINDBYMAIL_BACK_OFFSET UNITYSDK_OFFSET(0x15C38330)
#define MIHOYO_SDK_WIN_BINDBYMAIL_BIND_OFFSET UNITYSDK_OFFSET(0x15C38470)
#define MIHOYO_SDK_WIN_BINDBYMAIL_CLOSE_OFFSET UNITYSDK_OFFSET(0x15C38350)
#define MIHOYO_SDK_WIN_BINDBYMAIL_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x15C38400)
#define MIHOYO_SDK_WIN_BINDBYMAIL_HIDE_OFFSET UNITYSDK_OFFSET(0x15C36E90)
#define MIHOYO_SDK_WIN_BINDBYMAIL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x15C38760)
#define MIHOYO_SDK_WIN_BINDBYMAIL_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x15C386F0)
#define MIHOYO_SDK_WIN_BINDBYMAIL_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x15C38370)
#define MIHOYO_SDK_WIN_BINDBYMAIL_SHOW_OFFSET UNITYSDK_OFFSET(0x15C36D30)
#define MIHOYO_SDK_WIN_BINDBYMAIL_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x15C38380)
#define MIHOYO_SDK_WIN_BINDBYMAIL_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x15C380B0)
#define MIHOYO_SDK_WIN_BINDBYMAIL_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x15C37BB0)
#define MIHOYO_SDK_WIN_BINDBYMAIL_VALUECHANGEPHONEINPUT_OFFSET UNITYSDK_OFFSET(0x15C38460)
#define MIHOYO_SDK_WIN_BINDBYMAIL__AWAKE_B__35_0_OFFSET UNITYSDK_OFFSET(0x15C387C0)
#define MIHOYO_SDK_WIN_BINDBYMAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x15C38780)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int BindByMail_TypeDefinitionIndex = 9168;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::BindByMail**)Il2CppClass::FromTypeDefinitionIndex(BindByMail_TypeDefinitionIndex)->GetStaticField(0x29670);
		}
