...
#define MIHOYO_SDK_WIN_ACCOUNTLISTDROPDOWNITEMHANDLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1AA5C570)
#define MIHOYO_SDK_WIN_ACCOUNTLISTDROPDOWNITEMHANDLER_GETKEY_OFFSET UNITYSDK_OFFSET(0x1AA5DE60)
#define MIHOYO_SDK_WIN_ACCOUNTLISTDROPDOWNITEMHANDLER_ONDELETEACCOUNT_OFFSET UNITYSDK_OFFSET(0x1AA5DE90)
#define MIHOYO_SDK_WIN_ACCOUNTLISTDROPDOWNITEMHANDLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AA5DDB0)
#define MIHOYO_SDK_WIN_ACCOUNTLISTDROPDOWNITEMHANDLER_PARSEACCOUNTINFO_OFFSET UNITYSDK_OFFSET(0x1AA5D000)
#define MIHOYO_SDK_WIN_ACCOUNTLISTDROPDOWNITEMHANDLER_START_OFFSET UNITYSDK_OFFSET(0x1AA5CFF0)
#define MIHOYO_SDK_WIN_ACCOUNTLISTDROPDOWNITEMHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA5DEF0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int AccountListDropdownItemHandler_TypeDefinitionIndex = 19877;
