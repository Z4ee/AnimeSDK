...
#define MIHOYO_SDK_WIN_ACCOUNTLISTDROPDOWNITEMHANDLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B7DC000)
#define MIHOYO_SDK_WIN_ACCOUNTLISTDROPDOWNITEMHANDLER_GETKEY_OFFSET UNITYSDK_OFFSET(0x1B7DDB90)
#define MIHOYO_SDK_WIN_ACCOUNTLISTDROPDOWNITEMHANDLER_ONDELETEACCOUNT_OFFSET UNITYSDK_OFFSET(0x1B7DDC20)
#define MIHOYO_SDK_WIN_ACCOUNTLISTDROPDOWNITEMHANDLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B7DDB10)
#define MIHOYO_SDK_WIN_ACCOUNTLISTDROPDOWNITEMHANDLER_PARSEACCOUNTINFO_OFFSET UNITYSDK_OFFSET(0x1B7DC8E0)
#define MIHOYO_SDK_WIN_ACCOUNTLISTDROPDOWNITEMHANDLER_START_OFFSET UNITYSDK_OFFSET(0x1B7DC8D0)
#define MIHOYO_SDK_WIN_ACCOUNTLISTDROPDOWNITEMHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7DDCE0)
