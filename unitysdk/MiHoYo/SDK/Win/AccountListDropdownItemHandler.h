...
#define MIHOYO_SDK_WIN_ACCOUNTLISTDROPDOWNITEMHANDLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x15C2AD70)
#define MIHOYO_SDK_WIN_ACCOUNTLISTDROPDOWNITEMHANDLER_GETKEY_OFFSET UNITYSDK_OFFSET(0x15C2C8E0)
#define MIHOYO_SDK_WIN_ACCOUNTLISTDROPDOWNITEMHANDLER_ONDELETEACCOUNT_OFFSET UNITYSDK_OFFSET(0x15C2C970)
#define MIHOYO_SDK_WIN_ACCOUNTLISTDROPDOWNITEMHANDLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x15C2C880)
#define MIHOYO_SDK_WIN_ACCOUNTLISTDROPDOWNITEMHANDLER_PARSEACCOUNTINFO_OFFSET UNITYSDK_OFFSET(0x15C2B650)
#define MIHOYO_SDK_WIN_ACCOUNTLISTDROPDOWNITEMHANDLER_START_OFFSET UNITYSDK_OFFSET(0x15C2B640)
#define MIHOYO_SDK_WIN_ACCOUNTLISTDROPDOWNITEMHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15C2CA30)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int AccountListDropdownItemHandler_TypeDefinitionIndex = 8965;
