...
#define MIHOYO_SDK_WIN_COMBOMANAGER___C__DISPLAYCLASS37_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1567C900)
#define MIHOYO_SDK_WIN_COMBOMANAGER___C__DISPLAYCLASS37_0__EXIT_B__0_OFFSET UNITYSDK_OFFSET(0x1567C910)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int ComboManager___c__DisplayClass37_0_TypeDefinitionIndex = 9095;
