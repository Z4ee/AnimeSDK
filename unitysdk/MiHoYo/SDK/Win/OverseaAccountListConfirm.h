...
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLISTCONFIRM_AWAKE_OFFSET UNITYSDK_OFFSET(0x16106C20)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLISTCONFIRM_CANCEL_OFFSET UNITYSDK_OFFSET(0x16107A10)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLISTCONFIRM_CONFIRM_OFFSET UNITYSDK_OFFSET(0x161079D0)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLISTCONFIRM_HIDE_OFFSET UNITYSDK_OFFSET(0x160E1390)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLISTCONFIRM_SHOW_OFFSET UNITYSDK_OFFSET(0x160CEAD0)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLISTCONFIRM_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x161077C0)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLISTCONFIRM__CTOR_OFFSET UNITYSDK_OFFSET(0x16107A30)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int OverseaAccountListConfirm_TypeDefinitionIndex = 7910;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::OverseaAccountListConfirm**)Il2CppClass::FromTypeDefinitionIndex(OverseaAccountListConfirm_TypeDefinitionIndex)->GetStaticField(0x151F0);
		}
