...
#define MIHOYO_SDK_WIN_WEGAMESESSIONTICKETMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x15EA6690)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int WeGameSessionTicketModel_TypeDefinitionIndex = 8088;
