...
#define MIHOYO_SDK_WIN_BINDMANAGER___C__DISPLAYCLASS18_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15CE57E0)
#define MIHOYO_SDK_WIN_BINDMANAGER___C__DISPLAYCLASS18_0__SHOWOVERSEAVERIFYPHONEPLUGINUI_B__0_OFFSET UNITYSDK_OFFSET(0x15CEDD30)
#define MIHOYO_SDK_WIN_BINDMANAGER___C__DISPLAYCLASS18_0__SHOWOVERSEAVERIFYPHONEPLUGINUI_B__1_OFFSET UNITYSDK_OFFSET(0x15CEDD80)
#define MIHOYO_SDK_WIN_BINDMANAGER___C__DISPLAYCLASS18_0__SHOWOVERSEAVERIFYPHONEPLUGINUI_B__2_OFFSET UNITYSDK_OFFSET(0x15CEDE30)
#define MIHOYO_SDK_WIN_BINDMANAGER___C__DISPLAYCLASS18_0__SHOWOVERSEAVERIFYPHONEPLUGINUI_B__3_OFFSET UNITYSDK_OFFSET(0x15CEDF70)
#define MIHOYO_SDK_WIN_BINDMANAGER___C__DISPLAYCLASS18_0__SHOWOVERSEAVERIFYPHONEPLUGINUI_B__5_OFFSET UNITYSDK_OFFSET(0x15CEE410)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int BindManager___c__DisplayClass18_0_TypeDefinitionIndex = 9322;
