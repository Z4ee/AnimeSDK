...
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_AWAKE_OFFSET UNITYSDK_OFFSET(0x184D4FF0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_CLICKBACKBUTTON_OFFSET UNITYSDK_OFFSET(0x184D7ED0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_CLICKCLOSEBUTTON_OFFSET UNITYSDK_OFFSET(0x184D7EF0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_CLICKFORGETPASSWORDBUTTON_OFFSET UNITYSDK_OFFSET(0x184D7F30)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_CLICKLOGINBUTTON_OFFSET UNITYSDK_OFFSET(0x184D8030)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_CLICKPASSWORDCLEARBTN_OFFSET UNITYSDK_OFFSET(0x184D83F0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_CLICKPASSWORDSHOWBTN_OFFSET UNITYSDK_OFFSET(0x184D8350)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_CLICKREGISTERBUTTON_OFFSET UNITYSDK_OFFSET(0x184D7F10)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_CLICKSAVERECORDTOGGLE_OFFSET UNITYSDK_OFFSET(0x184D8300)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_CLICKTOGGLE_OFFSET UNITYSDK_OFFSET(0x184D8010)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_CLICKUSERAGREEMENTBUTTON_OFFSET UNITYSDK_OFFSET(0x184D7F50)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_CLICKUSERPRIVACYBUTTON_OFFSET UNITYSDK_OFFSET(0x184D7FB0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_DISABLEREGISTER_OFFSET UNITYSDK_OFFSET(0x184D7980)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_HIDE_OFFSET UNITYSDK_OFFSET(0x184D7E60)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x184D8500)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_ONPASSWORDVALUECHANGE_OFFSET UNITYSDK_OFFSET(0x184D8420)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_SHOW_OFFSET UNITYSDK_OFFSET(0x184D7D60)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_START_OFFSET UNITYSDK_OFFSET(0x184D7D30)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_UPDATESAVERECORDTIPS_OFFSET UNITYSDK_OFFSET(0x184D7360)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x184D6CC0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_UPDATETOGGLESTATUS_OFFSET UNITYSDK_OFFSET(0x184D8320)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x184D8550)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int LoginByAccount_TypeDefinitionIndex = 9188;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::LoginByAccount**)Il2CppClass::FromTypeDefinitionIndex(LoginByAccount_TypeDefinitionIndex)->GetStaticField(0x119E0);
		}
