...
#define MIHOYO_SDK_WIN_ACCOUNTLIST_AWAKE_OFFSET UNITYSDK_OFFSET(0x1CE21E70)
#define MIHOYO_SDK_WIN_ACCOUNTLIST_CLOSE_OFFSET UNITYSDK_OFFSET(0x1CE24640)
#define MIHOYO_SDK_WIN_ACCOUNTLIST_DELETEACCOUNT_OFFSET UNITYSDK_OFFSET(0x1CE243A0)
#define MIHOYO_SDK_WIN_ACCOUNTLIST_HIDE_OFFSET UNITYSDK_OFFSET(0x1CE24310)
#define MIHOYO_SDK_WIN_ACCOUNTLIST_LOADACCOUNTINFODATA_OFFSET UNITYSDK_OFFSET(0x1CE23060)
#define MIHOYO_SDK_WIN_ACCOUNTLIST_LOGINOTHERACCOUNT_OFFSET UNITYSDK_OFFSET(0x1CE24680)
#define MIHOYO_SDK_WIN_ACCOUNTLIST_ONACCOUNTSELECTED_OFFSET UNITYSDK_OFFSET(0x1CE241E0)
#define MIHOYO_SDK_WIN_ACCOUNTLIST_ONCHANGEACCOUNTLISTOPERABILITYSTATUS_OFFSET UNITYSDK_OFFSET(0x1CE23B90)
#define MIHOYO_SDK_WIN_ACCOUNTLIST_ONCHANGEACCOUNTTEXT_OFFSET UNITYSDK_OFFSET(0x1CE24190)
#define MIHOYO_SDK_WIN_ACCOUNTLIST_ONCHANGEACCOUNTTYPE_OFFSET UNITYSDK_OFFSET(0x1CE24030)
#define MIHOYO_SDK_WIN_ACCOUNTLIST_ONCOLLAPSELIST_OFFSET UNITYSDK_OFFSET(0x1CE241C0)
#define MIHOYO_SDK_WIN_ACCOUNTLIST_ONCONFIRMBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x1CE24660)
#define MIHOYO_SDK_WIN_ACCOUNTLIST_ONDELETEBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x1CE24380)
#define MIHOYO_SDK_WIN_ACCOUNTLIST_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1CE246A0)
#define MIHOYO_SDK_WIN_ACCOUNTLIST_ONHIDEACCOUNTLIST_OFFSET UNITYSDK_OFFSET(0x1CE23B70)
#define MIHOYO_SDK_WIN_ACCOUNTLIST_ONNOTICEEXPANDDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1CE241A0)
#define MIHOYO_SDK_WIN_ACCOUNTLIST_ONSHOWACCOUNTLIST_OFFSET UNITYSDK_OFFSET(0x1CE23B50)
#define MIHOYO_SDK_WIN_ACCOUNTLIST_SHOW_OFFSET UNITYSDK_OFFSET(0x1CE238D0)
#define MIHOYO_SDK_WIN_ACCOUNTLIST_START_OFFSET UNITYSDK_OFFSET(0x1CE22D30)
#define MIHOYO_SDK_WIN_ACCOUNTLIST_UPDATEACCOUNTLISTOPERABILITYSTATUS_OFFSET UNITYSDK_OFFSET(0x1CE23BA0)
#define MIHOYO_SDK_WIN_ACCOUNTLIST_UPDATEDROPDOWNTITLE_OFFSET UNITYSDK_OFFSET(0x1CE23B30)
#define MIHOYO_SDK_WIN_ACCOUNTLIST_UPDATESELECTEDACCOUNTINFO_OFFSET UNITYSDK_OFFSET(0x1CE24040)
#define MIHOYO_SDK_WIN_ACCOUNTLIST_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x1CE22ED0)
#define MIHOYO_SDK_WIN_ACCOUNTLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE246C0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int AccountList_TypeDefinitionIndex = 21383;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::AccountList**)Il2CppClass::FromTypeDefinitionIndex(AccountList_TypeDefinitionIndex)->GetStaticField(0xAA30);
		}
