...
#define MIHOYO_SDK_WIN_MIHOYOSDKHTTPRESPONSE_GET_BADREQUEST_OFFSET UNITYSDK_OFFSET(0x1775BC30)
#define MIHOYO_SDK_WIN_MIHOYOSDKHTTPRESPONSE_GET_CONTENTFILEPATH_OFFSET UNITYSDK_OFFSET(0x1775AE50)
#define MIHOYO_SDK_WIN_MIHOYOSDKHTTPRESPONSE_GET_FORBIDDEN_OFFSET UNITYSDK_OFFSET(0x1775BDD0)
#define MIHOYO_SDK_WIN_MIHOYOSDKHTTPRESPONSE_GET_HEADERS_OFFSET UNITYSDK_OFFSET(0x1775AE30)
#define MIHOYO_SDK_WIN_MIHOYOSDKHTTPRESPONSE_GET_METHODNOTALLOWED_OFFSET UNITYSDK_OFFSET(0x1775BD00)
#define MIHOYO_SDK_WIN_MIHOYOSDKHTTPRESPONSE_GET_STATUSCODE_OFFSET UNITYSDK_OFFSET(0x1775AE10)
#define MIHOYO_SDK_WIN_MIHOYOSDKHTTPRESPONSE_SENDTO_OFFSET UNITYSDK_OFFSET(0x1775AF10)
#define MIHOYO_SDK_WIN_MIHOYOSDKHTTPRESPONSE_SET_CONTENTFILEPATH_OFFSET UNITYSDK_OFFSET(0x1775AE60)
#define MIHOYO_SDK_WIN_MIHOYOSDKHTTPRESPONSE_SET_HEADERS_OFFSET UNITYSDK_OFFSET(0x1775AE40)
#define MIHOYO_SDK_WIN_MIHOYOSDKHTTPRESPONSE_SET_STATUSCODE_OFFSET UNITYSDK_OFFSET(0x1775AE20)
#define MIHOYO_SDK_WIN_MIHOYOSDKHTTPRESPONSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1775AE70)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int MiHoYoSDKHTTPResponse_TypeDefinitionIndex = 8155;
