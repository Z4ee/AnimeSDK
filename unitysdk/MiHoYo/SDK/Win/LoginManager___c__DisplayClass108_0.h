...
#define MIHOYO_SDK_WIN_LOGINMANAGER___C__DISPLAYCLASS108_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1EFD50)
#define MIHOYO_SDK_WIN_LOGINMANAGER___C__DISPLAYCLASS108_0__SHOWLOGINSTATEINVALID_B__0_OFFSET UNITYSDK_OFFSET(0x1D1EFD60)
#define MIHOYO_SDK_WIN_LOGINMANAGER___C__DISPLAYCLASS108_0__SHOWLOGINSTATEINVALID_B__1_OFFSET UNITYSDK_OFFSET(0x1D1EFFE0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int LoginManager___c__DisplayClass108_0_TypeDefinitionIndex = 21560;
