...
#define MIHOYO_SDK_WIN_OVERSEAGRANTMAIL__COUNTDOWN_D__48_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1610A6B0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTMAIL__COUNTDOWN_D__48_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1610A880)
#define MIHOYO_SDK_WIN_OVERSEAGRANTMAIL__COUNTDOWN_D__48_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1610A8E0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTMAIL__COUNTDOWN_D__48_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1610A890)
#define MIHOYO_SDK_WIN_OVERSEAGRANTMAIL__COUNTDOWN_D__48_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1610A6A0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTMAIL__COUNTDOWN_D__48__CTOR_OFFSET UNITYSDK_OFFSET(0x1610A5B0)
