...
#define MIHOYO_SDK_WIN_GRANTBINDPHONE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1770D730)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE_BACK_OFFSET UNITYSDK_OFFSET(0x1770E4C0)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1770E7D0)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE_HIDE_OFFSET UNITYSDK_OFFSET(0x1770E450)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1770E840)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE_QUESTION_OFFSET UNITYSDK_OFFSET(0x1770E4E0)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x1770E5A0)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1770E590)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE_SHOW_OFFSET UNITYSDK_OFFSET(0x1770E360)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1770E750)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE_START_OFFSET UNITYSDK_OFFSET(0x1770E290)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE_SUBMIT_OFFSET UNITYSDK_OFFSET(0x1770E5C0)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x1770E1A0)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x1770E0E0)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1770E880)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int GrantBindPhone_TypeDefinitionIndex = 8258;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::GrantBindPhone**)Il2CppClass::FromTypeDefinitionIndex(GrantBindPhone_TypeDefinitionIndex)->GetStaticField(0x2A810);
		}
