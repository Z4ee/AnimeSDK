...
#define MIHOYO_SDK_WIN_GRANTBINDPHONE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B847ED0)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE_BACK_OFFSET UNITYSDK_OFFSET(0x1B848F20)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1B849260)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE_HIDE_OFFSET UNITYSDK_OFFSET(0x1B848EB0)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B8492D0)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE_QUESTION_OFFSET UNITYSDK_OFFSET(0x1B848F40)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x1B849020)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1B849010)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE_SHOW_OFFSET UNITYSDK_OFFSET(0x1B848DB0)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1B8491F0)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE_START_OFFSET UNITYSDK_OFFSET(0x1B848C60)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE_SUBMIT_OFFSET UNITYSDK_OFFSET(0x1B849050)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x1B848AE0)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x1B848940)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8492F0)
...
namespace MiHoYo::SDK::Win
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::GrantBindPhone**)Il2CppClass::FromTypeDefinitionIndex(GrantBindPhone_TypeDefinitionIndex)->GetStaticField(0x2B1E0);
		}
