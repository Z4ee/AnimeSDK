...
#define MIHOYO_SDK_WIN_NEWDEVICEINFOMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF6DD0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int NewDeviceInfoModel_TypeDefinitionIndex = 19917;
