...
#define MIHOYO_SDK_WIN_GOOGLEPCMANAGER___C__DISPLAYCLASS21_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1568AD00)
#define MIHOYO_SDK_WIN_GOOGLEPCMANAGER___C__DISPLAYCLASS21_0__GETPRODUCTLIST_B__0_OFFSET UNITYSDK_OFFSET(0x1568DB10)
...
namespace MiHoYo::SDK::Win
{
	...
	public:
		...
		::MiHoYo::SDK::Win::GooglePCManager* __4__this; // 0x20
