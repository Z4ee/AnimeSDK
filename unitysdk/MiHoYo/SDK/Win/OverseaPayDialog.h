...
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x1D78A250)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_BACK_OFFSET UNITYSDK_OFFSET(0x1D78CA80)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_CLICKAMEXVENDOR_OFFSET UNITYSDK_OFFSET(0x1D78C910)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_CLICKECMCVENDOR_OFFSET UNITYSDK_OFFSET(0x1D78C900)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_CLICKJCBVENDOR_OFFSET UNITYSDK_OFFSET(0x1D78C920)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_CLICKPAYBUTTON_OFFSET UNITYSDK_OFFSET(0x1D78C940)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_CLICKPAYPALVENDOR_OFFSET UNITYSDK_OFFSET(0x1D78C930)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_CLICKPAYSUCCESSBUTTON_OFFSET UNITYSDK_OFFSET(0x1D78C9F0)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_CLICKPAYTYPEBUTTON_OFFSET UNITYSDK_OFFSET(0x1D78C8E0)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_CLICKVISAVENDOR_OFFSET UNITYSDK_OFFSET(0x1D78C8F0)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_HIDEBUYLOADING_OFFSET UNITYSDK_OFFSET(0x1D78C820)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x1D788460)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1D78CB90)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_REFRESHPAYINFO_OFFSET UNITYSDK_OFFSET(0x1D788650)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_REFRESH_OFFSET UNITYSDK_OFFSET(0x1D78C8D0)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_SETVENDORS_OFFSET UNITYSDK_OFFSET(0x1D78C810)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_SHOWBUYLOADING_OFFSET UNITYSDK_OFFSET(0x1D78C9C0)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_SHOWNETWORKERROR_OFFSET UNITYSDK_OFFSET(0x1D78C850)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_SHOWPAYSUCCESS_OFFSET UNITYSDK_OFFSET(0x1D78CA00)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x1D788370)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_START_OFFSET UNITYSDK_OFFSET(0x1D788590)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x1D78C4A0)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG__BACK_B__87_0_OFFSET UNITYSDK_OFFSET(0x1D78CBD0)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D78CBB0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int OverseaPayDialog_TypeDefinitionIndex = 21650;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::OverseaPayDialog**)Il2CppClass::FromTypeDefinitionIndex(OverseaPayDialog_TypeDefinitionIndex)->GetStaticField(0xABC0);
		}
