...
#define MIHOYO_SDK_WIN_COMBOMANAGER___C__DISPLAYCLASS21_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16080D10)
#define MIHOYO_SDK_WIN_COMBOMANAGER___C__DISPLAYCLASS21_0__REQUESTCOMBOLOGIN_B__0_OFFSET UNITYSDK_OFFSET(0x16093900)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int ComboManager___c__DisplayClass21_0_TypeDefinitionIndex = 8028;
