...
#define MIHOYO_SDK_WIN_GRANTMANAGER___C__DISPLAYCLASS15_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15694380)
#define MIHOYO_SDK_WIN_GRANTMANAGER___C__DISPLAYCLASS15_0__NEWDEVICEGRANTMESSAGE_B__0_OFFSET UNITYSDK_OFFSET(0x156979A0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int GrantManager___c__DisplayClass15_0_TypeDefinitionIndex = 9033;
