...
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1748B5D0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_BACK_OFFSET UNITYSDK_OFFSET(0x1748CC40)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_CLICTOTHERBUTTON_OFFSET UNITYSDK_OFFSET(0x1748CF90)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1748D030)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_HIDE_OFFSET UNITYSDK_OFFSET(0x1748CBD0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1748D0A0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_QUESTION_OFFSET UNITYSDK_OFFSET(0x1748CC60)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x1748CDE0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1748CDD0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_SHOW_OFFSET UNITYSDK_OFFSET(0x1748CAE0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1748CFB0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_START_OFFSET UNITYSDK_OFFSET(0x1748C740)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_SUBMIT_OFFSET UNITYSDK_OFFSET(0x1748CE00)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x1748C650)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x1748C350)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1748D0E0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int OverseaGrantPhone_TypeDefinitionIndex = 8275;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::OverseaGrantPhone**)Il2CppClass::FromTypeDefinitionIndex(OverseaGrantPhone_TypeDefinitionIndex)->GetStaticField(0x2A990);
		}
