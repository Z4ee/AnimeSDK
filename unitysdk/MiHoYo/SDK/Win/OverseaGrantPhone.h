...
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B8B1A00)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_BACK_OFFSET UNITYSDK_OFFSET(0x1B8B3290)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_CLICTOTHERBUTTON_OFFSET UNITYSDK_OFFSET(0x1B8B3610)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1B8B36F0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_HIDE_OFFSET UNITYSDK_OFFSET(0x1B84C3D0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B8B38E0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_QUESTION_OFFSET UNITYSDK_OFFSET(0x1B8B32B0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x1B8B3440)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1B8B3430)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_SHOW_OFFSET UNITYSDK_OFFSET(0x1B8B31A0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1B8B3630)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_START_OFFSET UNITYSDK_OFFSET(0x1B8B2DE0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_SUBMIT_OFFSET UNITYSDK_OFFSET(0x1B8B3470)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x1B8B3750)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x1B8B2850)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8B3900)
...
namespace MiHoYo::SDK::Win
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::OverseaGrantPhone**)Il2CppClass::FromTypeDefinitionIndex(OverseaGrantPhone_TypeDefinitionIndex)->GetStaticField(0x2B480);
		}
