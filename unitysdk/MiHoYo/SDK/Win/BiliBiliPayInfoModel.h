...
#define MIHOYO_SDK_WIN_BILIBILIPAYINFOMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A18BDA0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int BiliBiliPayInfoModel_TypeDefinitionIndex = 19913;
