...
#define MIHOYO_SDK_WIN_BILIBILIPAYINFOMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x176B6570)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int BiliBiliPayInfoModel_TypeDefinitionIndex = 8086;
