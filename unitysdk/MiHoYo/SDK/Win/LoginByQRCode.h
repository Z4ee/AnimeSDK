...
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_AWAKE_OFFSET UNITYSDK_OFFSET(0x177259A0)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_BACK_OFFSET UNITYSDK_OFFSET(0x17727940)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_CLICKSAVERECORDTOGGLE_OFFSET UNITYSDK_OFFSET(0x17727DE0)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_CLOSE_OFFSET UNITYSDK_OFFSET(0x17727960)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_HIDE_OFFSET UNITYSDK_OFFSET(0x177278D0)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17727E00)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17727740)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_REFRESH_OFFSET UNITYSDK_OFFSET(0x17727980)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_SETBUBBLETEXT_OFFSET UNITYSDK_OFFSET(0x17727850)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_SETSUPPORTEDSCANNINGAPPS_OFFSET UNITYSDK_OFFSET(0x177279A0)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_SHOWLOGINSUCCESS_OFFSET UNITYSDK_OFFSET(0x17727D80)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_SHOWNETWORKERROR_OFFSET UNITYSDK_OFFSET(0x17727C20)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_SHOWQRCODELOADING_OFFSET UNITYSDK_OFFSET(0x177279B0)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_SHOWQRCODEOVERDUE_OFFSET UNITYSDK_OFFSET(0x17727B70)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_SHOWQRCODE_OFFSET UNITYSDK_OFFSET(0x17727A80)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_SHOWSCANSUCCESS_OFFSET UNITYSDK_OFFSET(0x17727CB0)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_SHOW_OFFSET UNITYSDK_OFFSET(0x17727760)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_START_OFFSET UNITYSDK_OFFSET(0x17727730)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_UPDATESAVERECORDTIPS_OFFSET UNITYSDK_OFFSET(0x17727250)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x17727140)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE__CTOR_OFFSET UNITYSDK_OFFSET(0x17727E40)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int LoginByQRCode_TypeDefinitionIndex = 8283;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::LoginByQRCode**)Il2CppClass::FromTypeDefinitionIndex(LoginByQRCode_TypeDefinitionIndex)->GetStaticField(0x2EDF0);
		}
