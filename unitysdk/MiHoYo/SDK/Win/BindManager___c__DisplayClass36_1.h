...
#define MIHOYO_SDK_WIN_BINDMANAGER___C__DISPLAYCLASS36_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1847B9B0)
#define MIHOYO_SDK_WIN_BINDMANAGER___C__DISPLAYCLASS36_1__ONCHECKACCOUNT_B__14_OFFSET UNITYSDK_OFFSET(0x18485210)
#define MIHOYO_SDK_WIN_BINDMANAGER___C__DISPLAYCLASS36_1__ONCHECKACCOUNT_B__16_OFFSET UNITYSDK_OFFSET(0x18485380)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int BindManager___c__DisplayClass36_1_TypeDefinitionIndex = 9047;
