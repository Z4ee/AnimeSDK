...
#define MIHOYO_SDK_WIN_OVERSEAPAYMANAGER___C__DISPLAYCLASS60_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19491050)
#define MIHOYO_SDK_WIN_OVERSEAPAYMANAGER___C__DISPLAYCLASS60_0__REQUESTADYENCREATEORDER_B__0_OFFSET UNITYSDK_OFFSET(0x19491060)
#define MIHOYO_SDK_WIN_OVERSEAPAYMANAGER___C__DISPLAYCLASS60_0__REQUESTADYENCREATEORDER_G__CANCELCALLBACK_1_OFFSET UNITYSDK_OFFSET(0x19492B70)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int OverseaPayManager___c__DisplayClass60_0_TypeDefinitionIndex = 19927;
