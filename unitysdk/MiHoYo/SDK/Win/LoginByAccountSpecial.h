...
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1D7834F0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_CLICKCLOSEBUTTON_OFFSET UNITYSDK_OFFSET(0x1D7873E0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_CLICKFORGETPASSWORDBUTTON_OFFSET UNITYSDK_OFFSET(0x1D787440)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_CLICKGUESTBUTTON_OFFSET UNITYSDK_OFFSET(0x1D787920)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_CLICKLOGINBUTTON_OFFSET UNITYSDK_OFFSET(0x1D787600)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_CLICKPASSWORDCLEARBTN_OFFSET UNITYSDK_OFFSET(0x1D787DB0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_CLICKPASSWORDSHOWBTN_OFFSET UNITYSDK_OFFSET(0x1D787C50)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_CLICKPHONELOGINBUTTON_OFFSET UNITYSDK_OFFSET(0x1D787A40)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_CLICKQRCODEBUTTON_OFFSET UNITYSDK_OFFSET(0x1D787400)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_CLICKREGISTERBUTTON_OFFSET UNITYSDK_OFFSET(0x1D787420)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_CLICKSAVERECORDTOGGLE_OFFSET UNITYSDK_OFFSET(0x1D787B90)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_CLICKTAPTAPBUTTON_OFFSET UNITYSDK_OFFSET(0x1D787A60)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_CLICKTOGGLE_OFFSET UNITYSDK_OFFSET(0x1D7875A0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_CLICKUSERAGREEMENTBUTTON_OFFSET UNITYSDK_OFFSET(0x1D787460)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_CLICKUSERPRIVACYBUTTON_OFFSET UNITYSDK_OFFSET(0x1D787500)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_DISABLEREGISTER_OFFSET UNITYSDK_OFFSET(0x1D787080)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_HIDE_OFFSET UNITYSDK_OFFSET(0x1D787370)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1D787F20)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D787060)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_ONPASSWORDVALUECHANGE_OFFSET UNITYSDK_OFFSET(0x1D787E40)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_SHOW_OFFSET UNITYSDK_OFFSET(0x1D787290)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_START_OFFSET UNITYSDK_OFFSET(0x1D786FD0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_UPDATEBOTTOMCONTENT_OFFSET UNITYSDK_OFFSET(0x1D7859A0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_UPDATESAVERECORDTIPS_OFFSET UNITYSDK_OFFSET(0x1D786A20)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x1D785F80)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_UPDATETOGGLESTATUS_OFFSET UNITYSDK_OFFSET(0x1D787BF0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D788070)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int LoginByAccountSpecial_TypeDefinitionIndex = 21638;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::LoginByAccountSpecial**)Il2CppClass::FromTypeDefinitionIndex(LoginByAccountSpecial_TypeDefinitionIndex)->GetStaticField(0x97D0);
		}
