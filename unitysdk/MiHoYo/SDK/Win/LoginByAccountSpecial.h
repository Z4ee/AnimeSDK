...
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_AWAKE_OFFSET UNITYSDK_OFFSET(0x156A3D50)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_CLICKCLOSEBUTTON_OFFSET UNITYSDK_OFFSET(0x156A77A0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_CLICKFORGETPASSWORDBUTTON_OFFSET UNITYSDK_OFFSET(0x156A7800)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_CLICKGUESTBUTTON_OFFSET UNITYSDK_OFFSET(0x156A7BF0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_CLICKLOGINBUTTON_OFFSET UNITYSDK_OFFSET(0x156A7900)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_CLICKPASSWORDCLEARBTN_OFFSET UNITYSDK_OFFSET(0x156A7F60)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_CLICKPASSWORDSHOWBTN_OFFSET UNITYSDK_OFFSET(0x156A7E50)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_CLICKPHONELOGINBUTTON_OFFSET UNITYSDK_OFFSET(0x156A7CE0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_CLICKQRCODEBUTTON_OFFSET UNITYSDK_OFFSET(0x156A77C0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_CLICKREGISTERBUTTON_OFFSET UNITYSDK_OFFSET(0x156A77E0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_CLICKSAVERECORDTOGGLE_OFFSET UNITYSDK_OFFSET(0x156A7E00)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_CLICKTAPTAPBUTTON_OFFSET UNITYSDK_OFFSET(0x156A7D00)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_CLICKTOGGLE_OFFSET UNITYSDK_OFFSET(0x156A78E0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_CLICKUSERAGREEMENTBUTTON_OFFSET UNITYSDK_OFFSET(0x156A7820)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_CLICKUSERPRIVACYBUTTON_OFFSET UNITYSDK_OFFSET(0x156A7880)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_DISABLEREGISTER_OFFSET UNITYSDK_OFFSET(0x156A74F0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_HIDE_OFFSET UNITYSDK_OFFSET(0x156A7730)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x156A8070)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x156A74D0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_ONPASSWORDVALUECHANGE_OFFSET UNITYSDK_OFFSET(0x156A7F90)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_SHOW_OFFSET UNITYSDK_OFFSET(0x156A7630)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_START_OFFSET UNITYSDK_OFFSET(0x156A74A0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_UPDATEBOTTOMCONTENT_OFFSET UNITYSDK_OFFSET(0x156A5F40)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_UPDATESAVERECORDTIPS_OFFSET UNITYSDK_OFFSET(0x156A6FC0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x156A6330)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL_UPDATETOGGLESTATUS_OFFSET UNITYSDK_OFFSET(0x156A7E20)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTSPECIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x156A80C0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int LoginByAccountSpecial_TypeDefinitionIndex = 9205;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::LoginByAccountSpecial**)Il2CppClass::FromTypeDefinitionIndex(LoginByAccountSpecial_TypeDefinitionIndex)->GetStaticField(0x19E00);
		}
