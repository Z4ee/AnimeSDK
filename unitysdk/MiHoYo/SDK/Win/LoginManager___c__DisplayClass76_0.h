...
#define MIHOYO_SDK_WIN_LOGINMANAGER___C__DISPLAYCLASS76_0__CTOR_OFFSET UNITYSDK_OFFSET(0x177350B0)
#define MIHOYO_SDK_WIN_LOGINMANAGER___C__DISPLAYCLASS76_0__ONREGISTERCOMPLETE_B__0_OFFSET UNITYSDK_OFFSET(0x177464E0)
#define MIHOYO_SDK_WIN_LOGINMANAGER___C__DISPLAYCLASS76_0__ONREGISTERCOMPLETE_G__FAILCALLBACK_2_OFFSET UNITYSDK_OFFSET(0x177476A0)
#define MIHOYO_SDK_WIN_LOGINMANAGER___C__DISPLAYCLASS76_0__ONREGISTERCOMPLETE_G__SUCCESSCALLBACK_1_OFFSET UNITYSDK_OFFSET(0x17747870)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int LoginManager___c__DisplayClass76_0_TypeDefinitionIndex = 8200;
