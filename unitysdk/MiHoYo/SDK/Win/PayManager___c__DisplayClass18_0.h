...
#define MIHOYO_SDK_WIN_PAYMANAGER___C__DISPLAYCLASS18_0__CTOR_OFFSET UNITYSDK_OFFSET(0x182A59B0)
#define MIHOYO_SDK_WIN_PAYMANAGER___C__DISPLAYCLASS18_0__GETPRODUCTLIST_B__0_OFFSET UNITYSDK_OFFSET(0x182ABF30)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int PayManager___c__DisplayClass18_0_TypeDefinitionIndex = 9119;
