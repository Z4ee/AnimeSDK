...
#define MIHOYO_SDK_WIN_AUTOTESTLOGINMANAGER___C__DISPLAYCLASS8_1__COMBOLOGIN_B__1_OFFSET UNITYSDK_OFFSET(0x176AFED0)
#define MIHOYO_SDK_WIN_AUTOTESTLOGINMANAGER___C__DISPLAYCLASS8_1__CTOR_OFFSET UNITYSDK_OFFSET(0x176AFEC0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int AutoTestLoginManager___c__DisplayClass8_1_TypeDefinitionIndex = 8024;
