...
#define MIHOYO_SDK_WIN_LOGINBYPHONE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1DD5CD10)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKACCOUNTLOGINBUTTON_OFFSET UNITYSDK_OFFSET(0x1DD60B50)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKCLOSEBUTTON_OFFSET UNITYSDK_OFFSET(0x1DD60560)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKCODEBUTTON_OFFSET UNITYSDK_OFFSET(0x1DD605A0)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKGUESTBUTTON_OFFSET UNITYSDK_OFFSET(0x1DD60A30)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKLOGINBUTTON_OFFSET UNITYSDK_OFFSET(0x1DD60630)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKQRCODEBUTTON_OFFSET UNITYSDK_OFFSET(0x1DD60580)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKSAVERECORDTOGGLE_OFFSET UNITYSDK_OFFSET(0x1DD60E40)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKTAPTAPBUTTON_OFFSET UNITYSDK_OFFSET(0x1DD60B70)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKTOGGLE_OFFSET UNITYSDK_OFFSET(0x1DD60DE0)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKUSERAGREEMENTBUTTON_OFFSET UNITYSDK_OFFSET(0x1DD60CA0)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKUSERPRIVACYBUTTON_OFFSET UNITYSDK_OFFSET(0x1DD60D40)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1DD604F0)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_HIDE_OFFSET UNITYSDK_OFFSET(0x1DD601D0)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1DD60EA0)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1DD600D0)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_PHONEINPUTVALUECHANGE_OFFSET UNITYSDK_OFFSET(0x1DD60240)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1DD60550)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_RESETVERIFYCODEBUTTON_OFFSET UNITYSDK_OFFSET(0x1DD61050)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_SHOW_OFFSET UNITYSDK_OFFSET(0x1DD600F0)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1DD60410)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_START_OFFSET UNITYSDK_OFFSET(0x1DD60040)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_UPDATEBOTTOMCONTENT_OFFSET UNITYSDK_OFFSET(0x1DD5ED10)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_UPDATECODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x1DD60250)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_UPDATESAVERECORDTIPS_OFFSET UNITYSDK_OFFSET(0x1DD5F310)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x1DD5FA10)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_UPDATETOGGLESTATUS_OFFSET UNITYSDK_OFFSET(0x1DD60FF0)
#define MIHOYO_SDK_WIN_LOGINBYPHONE__AWAKE_B__43_0_OFFSET UNITYSDK_OFFSET(0x1DD61080)
#define MIHOYO_SDK_WIN_LOGINBYPHONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD61070)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int LoginByPhone_TypeDefinitionIndex = 21635;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::LoginByPhone**)Il2CppClass::FromTypeDefinitionIndex(LoginByPhone_TypeDefinitionIndex)->GetStaticField(0xA400);
		}
