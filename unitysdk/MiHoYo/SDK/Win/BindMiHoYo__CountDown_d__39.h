...
#define MIHOYO_SDK_WIN_BINDMIHOYO__COUNTDOWN_D__39_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A409B80)
#define MIHOYO_SDK_WIN_BINDMIHOYO__COUNTDOWN_D__39_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A409D80)
#define MIHOYO_SDK_WIN_BINDMIHOYO__COUNTDOWN_D__39_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A409DE0)
#define MIHOYO_SDK_WIN_BINDMIHOYO__COUNTDOWN_D__39_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A409D90)
#define MIHOYO_SDK_WIN_BINDMIHOYO__COUNTDOWN_D__39_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A409B70)
#define MIHOYO_SDK_WIN_BINDMIHOYO__COUNTDOWN_D__39__CTOR_OFFSET UNITYSDK_OFFSET(0x1A409B60)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int BindMiHoYo__CountDown_d__39_TypeDefinitionIndex = 20079;
