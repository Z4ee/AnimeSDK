...
#define MIHOYO_SDK_WIN_BINDMIHOYO__COUNTDOWN_D__39_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D777160)
#define MIHOYO_SDK_WIN_BINDMIHOYO__COUNTDOWN_D__39_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D777360)
#define MIHOYO_SDK_WIN_BINDMIHOYO__COUNTDOWN_D__39_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D7773C0)
#define MIHOYO_SDK_WIN_BINDMIHOYO__COUNTDOWN_D__39_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1D777370)
#define MIHOYO_SDK_WIN_BINDMIHOYO__COUNTDOWN_D__39_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D777150)
#define MIHOYO_SDK_WIN_BINDMIHOYO__COUNTDOWN_D__39__CTOR_OFFSET UNITYSDK_OFFSET(0x1D777140)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int BindMiHoYo__CountDown_d__39_TypeDefinitionIndex = 21600;
	...
	public:
		...
		::MiHoYo::SDK::Win::BindMiHoYo* __4__this; // 0x20
