...
#define MIHOYO_SDK_WIN_GUESTBINDPHONE__COUNTDOWN_D__44_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x160AFDA0)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE__COUNTDOWN_D__44_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x160AFF40)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE__COUNTDOWN_D__44_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x160AFFA0)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE__COUNTDOWN_D__44_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x160AFF50)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE__COUNTDOWN_D__44_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x160AFD90)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE__COUNTDOWN_D__44__CTOR_OFFSET UNITYSDK_OFFSET(0x160AFC60)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int GuestBindPhone__CountDown_d__44_TypeDefinitionIndex = 8103;
