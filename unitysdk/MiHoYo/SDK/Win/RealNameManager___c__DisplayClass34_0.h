...
#define MIHOYO_SDK_WIN_REALNAMEMANAGER___C__DISPLAYCLASS34_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A421250)
#define MIHOYO_SDK_WIN_REALNAMEMANAGER___C__DISPLAYCLASS34_0__SHOWGRANTPHONEPLUGINUI_B__0_OFFSET UNITYSDK_OFFSET(0x1A421260)
#define MIHOYO_SDK_WIN_REALNAMEMANAGER___C__DISPLAYCLASS34_0__SHOWGRANTPHONEPLUGINUI_B__1_OFFSET UNITYSDK_OFFSET(0x1A421280)
#define MIHOYO_SDK_WIN_REALNAMEMANAGER___C__DISPLAYCLASS34_0__SHOWGRANTPHONEPLUGINUI_B__2_OFFSET UNITYSDK_OFFSET(0x1A4212B0)
#define MIHOYO_SDK_WIN_REALNAMEMANAGER___C__DISPLAYCLASS34_0__SHOWGRANTPHONEPLUGINUI_B__3_OFFSET UNITYSDK_OFFSET(0x1A4215E0)
#define MIHOYO_SDK_WIN_REALNAMEMANAGER___C__DISPLAYCLASS34_0__SHOWGRANTPHONEPLUGINUI_B__4_OFFSET UNITYSDK_OFFSET(0x1A421630)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int RealNameManager___c__DisplayClass34_0_TypeDefinitionIndex = 19937;
