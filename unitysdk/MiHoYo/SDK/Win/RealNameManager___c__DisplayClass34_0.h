...
#define MIHOYO_SDK_WIN_REALNAMEMANAGER___C__DISPLAYCLASS34_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3B6830)
#define MIHOYO_SDK_WIN_REALNAMEMANAGER___C__DISPLAYCLASS34_0__SHOWGRANTPHONEPLUGINUI_B__0_OFFSET UNITYSDK_OFFSET(0x1C3B6840)
#define MIHOYO_SDK_WIN_REALNAMEMANAGER___C__DISPLAYCLASS34_0__SHOWGRANTPHONEPLUGINUI_B__1_OFFSET UNITYSDK_OFFSET(0x1C3B6860)
#define MIHOYO_SDK_WIN_REALNAMEMANAGER___C__DISPLAYCLASS34_0__SHOWGRANTPHONEPLUGINUI_B__2_OFFSET UNITYSDK_OFFSET(0x1C3B6890)
#define MIHOYO_SDK_WIN_REALNAMEMANAGER___C__DISPLAYCLASS34_0__SHOWGRANTPHONEPLUGINUI_B__3_OFFSET UNITYSDK_OFFSET(0x1C3B6BC0)
#define MIHOYO_SDK_WIN_REALNAMEMANAGER___C__DISPLAYCLASS34_0__SHOWGRANTPHONEPLUGINUI_B__4_OFFSET UNITYSDK_OFFSET(0x1C3B6C10)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int RealNameManager___c__DisplayClass34_0_TypeDefinitionIndex = 21103;
