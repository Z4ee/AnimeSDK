...
#define MIHOYO_SDK_WIN_MERCHANTINFOMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0F6720)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int MerchantInfoModel_TypeDefinitionIndex = 21004;
