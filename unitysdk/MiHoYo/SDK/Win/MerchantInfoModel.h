...
#define MIHOYO_SDK_WIN_MERCHANTINFOMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1850CB20)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int MerchantInfoModel_TypeDefinitionIndex = 8917;
