...
#define MIHOYO_SDK_WIN_MERCHANTINFOMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A08C3C0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int MerchantInfoModel_TypeDefinitionIndex = 19841;
