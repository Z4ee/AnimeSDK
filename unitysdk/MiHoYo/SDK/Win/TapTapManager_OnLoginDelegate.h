...
#define MIHOYO_SDK_WIN_TAPTAPMANAGER_ONLOGINDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15E989E0)
#define MIHOYO_SDK_WIN_TAPTAPMANAGER_ONLOGINDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15E98A50)
#define MIHOYO_SDK_WIN_TAPTAPMANAGER_ONLOGINDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15E98630)
#define MIHOYO_SDK_WIN_TAPTAPMANAGER_ONLOGINDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15E989C0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int TapTapManager_OnLoginDelegate_TypeDefinitionIndex = 7979;
