...
#define MIHOYO_SDK_WIN_DESCRIPTION_GETFROM_OFFSET UNITYSDK_OFFSET(0x176FB3E0)
#define MIHOYO_SDK_WIN_DESCRIPTION_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x176FB3B0)
#define MIHOYO_SDK_WIN_DESCRIPTION_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x176FB3C0)
#define MIHOYO_SDK_WIN_DESCRIPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x176FB3D0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int Description_TypeDefinitionIndex = 8161;
