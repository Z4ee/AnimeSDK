...
#define MIHOYO_SDK_WIN_DESCRIPTION_GETFROM_OFFSET UNITYSDK_OFFSET(0x1567FD90)
#define MIHOYO_SDK_WIN_DESCRIPTION_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x1567FD60)
#define MIHOYO_SDK_WIN_DESCRIPTION_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x1567FD70)
#define MIHOYO_SDK_WIN_DESCRIPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1567FD80)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int Description_TypeDefinitionIndex = 9076;
