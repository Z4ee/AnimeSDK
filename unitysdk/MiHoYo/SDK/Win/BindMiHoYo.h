...
#define MIHOYO_SDK_WIN_BINDMIHOYO_AWAKE_OFFSET UNITYSDK_OFFSET(0x1C917260)
#define MIHOYO_SDK_WIN_BINDMIHOYO_BACK_OFFSET UNITYSDK_OFFSET(0x1C918370)
#define MIHOYO_SDK_WIN_BINDMIHOYO_BIND_OFFSET UNITYSDK_OFFSET(0x1C9184F0)
#define MIHOYO_SDK_WIN_BINDMIHOYO_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1C918480)
#define MIHOYO_SDK_WIN_BINDMIHOYO_HIDE_OFFSET UNITYSDK_OFFSET(0x1C9171F0)
#define MIHOYO_SDK_WIN_BINDMIHOYO_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1C918740)
#define MIHOYO_SDK_WIN_BINDMIHOYO_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x1C918690)
#define MIHOYO_SDK_WIN_BINDMIHOYO_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1C918390)
#define MIHOYO_SDK_WIN_BINDMIHOYO_SHOW_OFFSET UNITYSDK_OFFSET(0x1C9170C0)
#define MIHOYO_SDK_WIN_BINDMIHOYO_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1C9183A0)
#define MIHOYO_SDK_WIN_BINDMIHOYO_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x1C918130)
#define MIHOYO_SDK_WIN_BINDMIHOYO_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x1C917E90)
#define MIHOYO_SDK_WIN_BINDMIHOYO_VALUECHANGEPHONEINPUT_OFFSET UNITYSDK_OFFSET(0x1C9184E0)
#define MIHOYO_SDK_WIN_BINDMIHOYO__AWAKE_B__31_0_OFFSET UNITYSDK_OFFSET(0x1C918770)
#define MIHOYO_SDK_WIN_BINDMIHOYO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C918760)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int BindMiHoYo_TypeDefinitionIndex = 21598;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::BindMiHoYo**)Il2CppClass::FromTypeDefinitionIndex(BindMiHoYo_TypeDefinitionIndex)->GetStaticField(0x9EA0);
		}
