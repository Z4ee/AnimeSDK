...
#define MIHOYO_SDK_WIN_BINDMIHOYO_AWAKE_OFFSET UNITYSDK_OFFSET(0x176C7160)
#define MIHOYO_SDK_WIN_BINDMIHOYO_BACK_OFFSET UNITYSDK_OFFSET(0x176C7FF0)
#define MIHOYO_SDK_WIN_BINDMIHOYO_BIND_OFFSET UNITYSDK_OFFSET(0x176C8090)
#define MIHOYO_SDK_WIN_BINDMIHOYO_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x176C8020)
#define MIHOYO_SDK_WIN_BINDMIHOYO_HIDE_OFFSET UNITYSDK_OFFSET(0x176BB170)
#define MIHOYO_SDK_WIN_BINDMIHOYO_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x176C8290)
#define MIHOYO_SDK_WIN_BINDMIHOYO_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x176C8200)
#define MIHOYO_SDK_WIN_BINDMIHOYO_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x176C8010)
#define MIHOYO_SDK_WIN_BINDMIHOYO_SHOW_OFFSET UNITYSDK_OFFSET(0x176BB4B0)
#define MIHOYO_SDK_WIN_BINDMIHOYO_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x176BBA60)
#define MIHOYO_SDK_WIN_BINDMIHOYO_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x176C7DD0)
#define MIHOYO_SDK_WIN_BINDMIHOYO_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x176C7B60)
#define MIHOYO_SDK_WIN_BINDMIHOYO_VALUECHANGEPHONEINPUT_OFFSET UNITYSDK_OFFSET(0x176C8080)
#define MIHOYO_SDK_WIN_BINDMIHOYO__AWAKE_B__31_0_OFFSET UNITYSDK_OFFSET(0x176C8310)
#define MIHOYO_SDK_WIN_BINDMIHOYO__CTOR_OFFSET UNITYSDK_OFFSET(0x176C82D0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int BindMiHoYo_TypeDefinitionIndex = 8250;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::BindMiHoYo**)Il2CppClass::FromTypeDefinitionIndex(BindMiHoYo_TypeDefinitionIndex)->GetStaticField(0x27B20);
		}
