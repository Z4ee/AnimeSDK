...
#define MIHOYO_SDK_WIN_WEGAMEMANAGER_WEGAMEEXITDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D104A10)
#define MIHOYO_SDK_WIN_WEGAMEMANAGER_WEGAMEEXITDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D104A60)
#define MIHOYO_SDK_WIN_WEGAMEMANAGER_WEGAMEEXITDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D1047F0)
#define MIHOYO_SDK_WIN_WEGAMEMANAGER_WEGAMEEXITDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1049A0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int WeGameManager_WeGameExitDelegate_TypeDefinitionIndex = 9146;
