...
#define MIHOYO_SDK_WIN_LOGINMANAGER___C__DISPLAYCLASS69_0__CTOR_OFFSET UNITYSDK_OFFSET(0x184F0FA0)
#define MIHOYO_SDK_WIN_LOGINMANAGER___C__DISPLAYCLASS69_0__SHOWACCOUNTLISTCONFIRMPLUGINUI_B__0_OFFSET UNITYSDK_OFFSET(0x18503160)
#define MIHOYO_SDK_WIN_LOGINMANAGER___C__DISPLAYCLASS69_0__SHOWACCOUNTLISTCONFIRMPLUGINUI_B__1_OFFSET UNITYSDK_OFFSET(0x18503210)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int LoginManager___c__DisplayClass69_0_TypeDefinitionIndex = 9102;
