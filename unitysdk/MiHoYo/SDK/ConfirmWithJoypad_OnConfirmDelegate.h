...
#define MIHOYO_SDK_CONFIRMWITHJOYPAD_ONCONFIRMDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A341190)
#define MIHOYO_SDK_CONFIRMWITHJOYPAD_ONCONFIRMDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A341220)
#define MIHOYO_SDK_CONFIRMWITHJOYPAD_ONCONFIRMDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A340D50)
#define MIHOYO_SDK_CONFIRMWITHJOYPAD_ONCONFIRMDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A341180)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConfirmWithJoypad_OnConfirmDelegate_TypeDefinitionIndex = 18865;
