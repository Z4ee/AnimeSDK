...
#define MIHOYO_SDK_KIBANAPCBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3FE2C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int KibanaPCBoxConfig_TypeDefinitionIndex = 18780;
