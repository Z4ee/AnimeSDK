...
#define MIHOYO_SDK_KIBANAPCBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D768FE0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int KibanaPCBoxConfig_TypeDefinitionIndex = 20024;
