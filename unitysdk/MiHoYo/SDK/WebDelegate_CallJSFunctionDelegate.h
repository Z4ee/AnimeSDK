...
#define MIHOYO_SDK_WEBDELEGATE_CALLJSFUNCTIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x160402A0)
#define MIHOYO_SDK_WEBDELEGATE_CALLJSFUNCTIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16040310)
#define MIHOYO_SDK_WEBDELEGATE_CALLJSFUNCTIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1603B980)
#define MIHOYO_SDK_WEBDELEGATE_CALLJSFUNCTIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16040280)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_CallJSFunctionDelegate_TypeDefinitionIndex = 6848;
