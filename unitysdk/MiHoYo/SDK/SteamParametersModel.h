...
#define MIHOYO_SDK_STEAMPARAMETERSMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAD7400)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SteamParametersModel_TypeDefinitionIndex = 7848;
