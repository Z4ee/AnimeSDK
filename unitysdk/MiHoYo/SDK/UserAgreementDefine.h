...
#define MIHOYO_SDK_USERAGREEMENTDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCA1310)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int UserAgreementDefine_TypeDefinitionIndex = 19339;
