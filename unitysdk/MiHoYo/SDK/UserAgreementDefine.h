...
#define MIHOYO_SDK_USERAGREEMENTDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x16024510)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int UserAgreementDefine_TypeDefinitionIndex = 6600;
