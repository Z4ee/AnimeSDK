...
#define MIHOYO_SDK_MIHOYOBASESDK___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xB21C420)
#define MIHOYO_SDK_MIHOYOBASESDK___C__CTOR_OFFSET UNITYSDK_OFFSET(0xB21C450)
#define MIHOYO_SDK_MIHOYOBASESDK___C__REGISTERINPUTSYSTEM_B__57_0_OFFSET UNITYSDK_OFFSET(0xB21C460)
#define MIHOYO_SDK_MIHOYOBASESDK___C__REGISTERINPUTSYSTEM_B__57_1_OFFSET UNITYSDK_OFFSET(0xB21C4B0)
...
namespace MiHoYo::SDK
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::InputSystemDelegate_DelegateSetIMECompositionMode**)Il2CppClass::FromTypeDefinitionIndex(MiHoYoBaseSDK___c_TypeDefinitionIndex)->GetStaticField(0x51FA0);
		}
		static ::MiHoYo::SDK::MiHoYoBaseSDK___c** StaticGet___9()
		{
			return (::MiHoYo::SDK::MiHoYoBaseSDK___c**)Il2CppClass::FromTypeDefinitionIndex(MiHoYoBaseSDK___c_TypeDefinitionIndex)->GetStaticField(0x51FA8);
		}
		static ::MiHoYo::SDK::InputSystemDelegate_DelegateGetIMECompositionMode** StaticGet___9__57_0()
		{
			return (::MiHoYo::SDK::InputSystemDelegate_DelegateGetIMECompositionMode**)Il2CppClass::FromTypeDefinitionIndex(MiHoYoBaseSDK___c_TypeDefinitionIndex)->GetStaticField(0x51FB0);
		}
