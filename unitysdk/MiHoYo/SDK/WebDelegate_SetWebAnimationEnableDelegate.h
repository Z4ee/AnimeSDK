...
#define MIHOYO_SDK_WEBDELEGATE_SETWEBANIMATIONENABLEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18466820)
#define MIHOYO_SDK_WEBDELEGATE_SETWEBANIMATIONENABLEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18466880)
#define MIHOYO_SDK_WEBDELEGATE_SETWEBANIMATIONENABLEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18462940)
#define MIHOYO_SDK_WEBDELEGATE_SETWEBANIMATIONENABLEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18466730)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetWebAnimationEnableDelegate_TypeDefinitionIndex = 7804;
