...
#define MIHOYO_SDK_CONFIGMANAGER_BUNDLECONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1820A8A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConfigManager_BundleConfigs_TypeDefinitionIndex = 8144;
