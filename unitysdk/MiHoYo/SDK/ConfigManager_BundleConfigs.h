...
#define MIHOYO_SDK_CONFIGMANAGER_BUNDLECONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1C4DB0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConfigManager_BundleConfigs_TypeDefinitionIndex = 8159;
