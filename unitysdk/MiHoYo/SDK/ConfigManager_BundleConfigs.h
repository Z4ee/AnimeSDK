...
#define MIHOYO_SDK_CONFIGMANAGER_BUNDLECONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x15E08ED0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConfigManager_BundleConfigs_TypeDefinitionIndex = 7198;
