...
#define MIHOYO_SDK_SDKDISPATCHER___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6BCEF0)
#define MIHOYO_SDK_SDKDISPATCHER___C__DISPLAYCLASS9_0__SDKINVOKE_B__0_OFFSET UNITYSDK_OFFSET(0x1C6BD2A0)
...
namespace MiHoYo::SDK
{
	...
	{
	public:
		::System::String* cbModuleType; // 0x10
