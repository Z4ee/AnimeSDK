...
#define MIHOYO_SDK_MIHOYOSDKCONFIGMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x8D3D740)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKConfigModel_TypeDefinitionIndex = 42947;
