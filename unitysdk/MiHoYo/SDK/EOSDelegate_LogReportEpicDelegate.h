...
#define MIHOYO_SDK_EOSDELEGATE_LOGREPORTEPICDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B943F10)
#define MIHOYO_SDK_EOSDELEGATE_LOGREPORTEPICDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B943F80)
#define MIHOYO_SDK_EOSDELEGATE_LOGREPORTEPICDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B943EF0)
#define MIHOYO_SDK_EOSDELEGATE_LOGREPORTEPICDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B943E80)
