...
#define MIHOYO_SDK_EOSDELEGATE_LOGREPORTEPICDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BB39680)
#define MIHOYO_SDK_EOSDELEGATE_LOGREPORTEPICDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BB39710)
#define MIHOYO_SDK_EOSDELEGATE_LOGREPORTEPICDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BB392F0)
#define MIHOYO_SDK_EOSDELEGATE_LOGREPORTEPICDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB392D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int EOSDelegate_LogReportEpicDelegate_TypeDefinitionIndex = 19483;
