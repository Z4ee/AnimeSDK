...
#define MIHOYO_SDK_CONFIGMANAGER_EOSPARAMETERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B75D6C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConfigManager_EosParameters_TypeDefinitionIndex = 8166;
