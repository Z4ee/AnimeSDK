...
#define MIHOYO_SDK_CONFIGMANAGER_EOSPARAMETERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9C0F20)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConfigManager_EosParameters_TypeDefinitionIndex = 19971;
