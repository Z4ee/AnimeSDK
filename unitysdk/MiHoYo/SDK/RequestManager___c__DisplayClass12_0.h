...
#define MIHOYO_SDK_REQUESTMANAGER___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C96F3B0)
#define MIHOYO_SDK_REQUESTMANAGER___C__DISPLAYCLASS12_0__LOGINBYACCOUNT_B__0_OFFSET UNITYSDK_OFFSET(0x1C96F3C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int RequestManager___c__DisplayClass12_0_TypeDefinitionIndex = 19823;
