...
#define MIHOYO_SDK_HOYOCHANNELSDK_CALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ACEC760)
#define MIHOYO_SDK_HOYOCHANNELSDK_CALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ACEC7C0)
#define MIHOYO_SDK_HOYOCHANNELSDK_CALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ACEC750)
#define MIHOYO_SDK_HOYOCHANNELSDK_CALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACEC6E0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoChannelSDK_CallBack_TypeDefinitionIndex = 44798;
