...
#define MIHOYO_SDK_HOYOCHANNELSDK_CALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA16AAD0)
#define MIHOYO_SDK_HOYOCHANNELSDK_CALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA16AB30)
#define MIHOYO_SDK_HOYOCHANNELSDK_CALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xA16AAC0)
#define MIHOYO_SDK_HOYOCHANNELSDK_CALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA16AA50)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoChannelSDK_CallBack_TypeDefinitionIndex = 43936;
