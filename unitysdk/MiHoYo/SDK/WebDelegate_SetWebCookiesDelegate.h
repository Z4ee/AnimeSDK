...
#define MIHOYO_SDK_WEBDELEGATE_SETWEBCOOKIESDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A9C7EC0)
#define MIHOYO_SDK_WEBDELEGATE_SETWEBCOOKIESDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A9C7EF0)
#define MIHOYO_SDK_WEBDELEGATE_SETWEBCOOKIESDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A9C79C0)
#define MIHOYO_SDK_WEBDELEGATE_SETWEBCOOKIESDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9C79A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetWebCookiesDelegate_TypeDefinitionIndex = 19621;
