...
#define MIHOYO_SDK_WEBDELEGATE_SETWEBCOOKIESDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18466980)
#define MIHOYO_SDK_WEBDELEGATE_SETWEBCOOKIESDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x184669B0)
#define MIHOYO_SDK_WEBDELEGATE_SETWEBCOOKIESDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x184629E0)
#define MIHOYO_SDK_WEBDELEGATE_SETWEBCOOKIESDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18466890)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetWebCookiesDelegate_TypeDefinitionIndex = 7807;
