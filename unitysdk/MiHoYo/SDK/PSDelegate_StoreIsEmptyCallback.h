...
#define MIHOYO_SDK_PSDELEGATE_STOREISEMPTYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B9E07B0)
#define MIHOYO_SDK_PSDELEGATE_STOREISEMPTYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B9E0840)
#define MIHOYO_SDK_PSDELEGATE_STOREISEMPTYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B9E0470)
#define MIHOYO_SDK_PSDELEGATE_STOREISEMPTYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E0450)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_StoreIsEmptyCallback_TypeDefinitionIndex = 19494;
