...
#define MIHOYO_SDK_WEBDELEGATE_SETCURRENTWEBVIEWANIMATIONENABLEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B6E8CD0)
#define MIHOYO_SDK_WEBDELEGATE_SETCURRENTWEBVIEWANIMATIONENABLEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B6E8D50)
#define MIHOYO_SDK_WEBDELEGATE_SETCURRENTWEBVIEWANIMATIONENABLEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B6E86E0)
#define MIHOYO_SDK_WEBDELEGATE_SETCURRENTWEBVIEWANIMATIONENABLEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6E86C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetCurrentWebviewAnimationEnableDelegate_TypeDefinitionIndex = 19595;
