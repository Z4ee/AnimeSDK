...
#define MIHOYO_SDK_KCP_KCPMANAGER_ONLOGMESSAGEACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DF660F0)
#define MIHOYO_SDK_KCP_KCPMANAGER_ONLOGMESSAGEACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DF66120)
#define MIHOYO_SDK_KCP_KCPMANAGER_ONLOGMESSAGEACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DF65BD0)
#define MIHOYO_SDK_KCP_KCPMANAGER_ONLOGMESSAGEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF65BB0)

namespace MiHoYo::SDK::KCP
{
	inline static constexpr unsigned int KCPManager_OnLogMessageAction_TypeDefinitionIndex = 37722;
