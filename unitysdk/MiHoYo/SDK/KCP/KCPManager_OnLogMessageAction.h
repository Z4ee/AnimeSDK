...
#define MIHOYO_SDK_KCP_KCPMANAGER_ONLOGMESSAGEACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A817000)
#define MIHOYO_SDK_KCP_KCPMANAGER_ONLOGMESSAGEACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A817030)
#define MIHOYO_SDK_KCP_KCPMANAGER_ONLOGMESSAGEACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A816B00)
#define MIHOYO_SDK_KCP_KCPMANAGER_ONLOGMESSAGEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A816AF0)

namespace MiHoYo::SDK::KCP
{
	inline static constexpr unsigned int KCPManager_OnLogMessageAction_TypeDefinitionIndex = 35462;
