...
#define MIHOYO_SDK_KCP_KCPMANAGER_ONLOGMESSAGEACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x84F39B0)
#define MIHOYO_SDK_KCP_KCPMANAGER_ONLOGMESSAGEACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x84F39E0)
#define MIHOYO_SDK_KCP_KCPMANAGER_ONLOGMESSAGEACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x84F1C80)
#define MIHOYO_SDK_KCP_KCPMANAGER_ONLOGMESSAGEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x84F3990)

namespace MiHoYo::SDK::KCP
{
	inline static constexpr unsigned int KCPManager_OnLogMessageAction_TypeDefinitionIndex = 37375;
