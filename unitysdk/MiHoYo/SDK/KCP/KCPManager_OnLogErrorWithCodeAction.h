...
#define MIHOYO_SDK_KCP_KCPMANAGER_ONLOGERRORWITHCODEACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x84F3900)
#define MIHOYO_SDK_KCP_KCPMANAGER_ONLOGERRORWITHCODEACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x84F3980)
#define MIHOYO_SDK_KCP_KCPMANAGER_ONLOGERRORWITHCODEACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x84F2270)
#define MIHOYO_SDK_KCP_KCPMANAGER_ONLOGERRORWITHCODEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x84F38E0)

namespace MiHoYo::SDK::KCP
{
	inline static constexpr unsigned int KCPManager_OnLogErrorWithCodeAction_TypeDefinitionIndex = 37376;
