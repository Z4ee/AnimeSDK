...
#define MIHOYO_SDK_PERFORMANCEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x15F9D2D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PerformanceInfo_TypeDefinitionIndex = 6882;
