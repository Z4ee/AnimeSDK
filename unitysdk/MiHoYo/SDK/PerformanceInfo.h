...
#define MIHOYO_SDK_PERFORMANCEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18DC9520)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PerformanceInfo_TypeDefinitionIndex = 18746;
