...
#define MIHOYO_SDK_PERFORMANCEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDE5AD0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PerformanceInfo_TypeDefinitionIndex = 19989;
