...
#define MIHOYO_SDK_TELEMETRYDELEGATE_REPORTTOKIBANADELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19FEC410)
#define MIHOYO_SDK_TELEMETRYDELEGATE_REPORTTOKIBANADELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19FEC4A0)
#define MIHOYO_SDK_TELEMETRYDELEGATE_REPORTTOKIBANADELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19FEBE70)
#define MIHOYO_SDK_TELEMETRYDELEGATE_REPORTTOKIBANADELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19FEBE60)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int TelemetryDelegate_ReportToKibanaDelegate_TypeDefinitionIndex = 18568;
