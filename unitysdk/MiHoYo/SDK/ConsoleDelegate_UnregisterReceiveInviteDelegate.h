...
#define MIHOYO_SDK_CONSOLEDELEGATE_UNREGISTERRECEIVEINVITEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B940BE0)
#define MIHOYO_SDK_CONSOLEDELEGATE_UNREGISTERRECEIVEINVITEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B940C10)
#define MIHOYO_SDK_CONSOLEDELEGATE_UNREGISTERRECEIVEINVITEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B940BD0)
#define MIHOYO_SDK_CONSOLEDELEGATE_UNREGISTERRECEIVEINVITEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B940B60)
