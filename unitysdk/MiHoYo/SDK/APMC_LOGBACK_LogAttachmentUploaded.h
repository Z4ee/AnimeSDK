...
#define MIHOYO_SDK_APMC_LOGBACK_LOGATTACHMENTUPLOADED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D945FF0)
#define MIHOYO_SDK_APMC_LOGBACK_LOGATTACHMENTUPLOADED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D9460A0)
#define MIHOYO_SDK_APMC_LOGBACK_LOGATTACHMENTUPLOADED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D945C50)
#define MIHOYO_SDK_APMC_LOGBACK_LOGATTACHMENTUPLOADED__CTOR_OFFSET UNITYSDK_OFFSET(0x1D945C30)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int APMC_LOGBACK_LogAttachmentUploaded_TypeDefinitionIndex = 37547;
