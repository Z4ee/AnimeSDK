...
#define MIHOYO_SDK_APMC_LOGBACK_LOGATTACHMENTUPLOADED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A2CB3F0)
#define MIHOYO_SDK_APMC_LOGBACK_LOGATTACHMENTUPLOADED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A2CB4A0)
#define MIHOYO_SDK_APMC_LOGBACK_LOGATTACHMENTUPLOADED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A2CB010)
#define MIHOYO_SDK_APMC_LOGBACK_LOGATTACHMENTUPLOADED__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2CB000)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int APMC_LOGBACK_LogAttachmentUploaded_TypeDefinitionIndex = 35322;
