...
#define MIHOYO_SDK_REPORTERUTIL_PERFORMANCEREPORTER_AUTOREPORTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BF12E50)
#define MIHOYO_SDK_REPORTERUTIL_PERFORMANCEREPORTER_AUTOREPORTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BF12E90)
#define MIHOYO_SDK_REPORTERUTIL_PERFORMANCEREPORTER_AUTOREPORTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BF12830)
#define MIHOYO_SDK_REPORTERUTIL_PERFORMANCEREPORTER_AUTOREPORTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF12810)

namespace MiHoYo::SDK::ReporterUtil
{
	inline static constexpr unsigned int PerformanceReporter_AutoReportHandler_TypeDefinitionIndex = 37012;
