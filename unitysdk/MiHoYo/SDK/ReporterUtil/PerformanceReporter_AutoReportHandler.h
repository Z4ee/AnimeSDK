...
#define MIHOYO_SDK_REPORTERUTIL_PERFORMANCEREPORTER_AUTOREPORTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19A3EC30)
#define MIHOYO_SDK_REPORTERUTIL_PERFORMANCEREPORTER_AUTOREPORTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19A3EC70)
#define MIHOYO_SDK_REPORTERUTIL_PERFORMANCEREPORTER_AUTOREPORTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19A3E610)
#define MIHOYO_SDK_REPORTERUTIL_PERFORMANCEREPORTER_AUTOREPORTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19A3E600)

namespace MiHoYo::SDK::ReporterUtil
{
	inline static constexpr unsigned int PerformanceReporter_AutoReportHandler_TypeDefinitionIndex = 35413;
