...
#define MIHOYO_SDK_REPORTERUTIL_FULLEDHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ADFDE40)
#define MIHOYO_SDK_REPORTERUTIL_FULLEDHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ADFDE70)
#define MIHOYO_SDK_REPORTERUTIL_FULLEDHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ADFD940)
#define MIHOYO_SDK_REPORTERUTIL_FULLEDHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADFD930)

namespace MiHoYo::SDK::ReporterUtil
{
	inline static constexpr unsigned int FulledHandler_TypeDefinitionIndex = 35418;
