...
#define MIHOYO_SDK_REPORTERUTIL_AVGRESULT_GET_FRACTIONAVG_OFFSET UNITYSDK_OFFSET(0x1ABA2200)
#define MIHOYO_SDK_REPORTERUTIL_AVGRESULT_GET_MAINAVG_OFFSET UNITYSDK_OFFSET(0x1ABA21E0)
#define MIHOYO_SDK_REPORTERUTIL_AVGRESULT_SET_FRACTIONAVG_OFFSET UNITYSDK_OFFSET(0x1ABA2210)
#define MIHOYO_SDK_REPORTERUTIL_AVGRESULT_SET_MAINAVG_OFFSET UNITYSDK_OFFSET(0x1ABA21F0)
#define MIHOYO_SDK_REPORTERUTIL_AVGRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABA2220)

namespace MiHoYo::SDK::ReporterUtil
{
	inline static constexpr unsigned int AvgResult_TypeDefinitionIndex = 44864;
