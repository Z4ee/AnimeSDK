...
#define MIHOYO_SDK_REPORTERUTIL_AVGRESULT_GET_FRACTIONAVG_OFFSET UNITYSDK_OFFSET(0x1CBA5E30)
#define MIHOYO_SDK_REPORTERUTIL_AVGRESULT_GET_MAINAVG_OFFSET UNITYSDK_OFFSET(0x1CBA5E10)
#define MIHOYO_SDK_REPORTERUTIL_AVGRESULT_SET_FRACTIONAVG_OFFSET UNITYSDK_OFFSET(0x1CBA5E40)
#define MIHOYO_SDK_REPORTERUTIL_AVGRESULT_SET_MAINAVG_OFFSET UNITYSDK_OFFSET(0x1CBA5E20)
#define MIHOYO_SDK_REPORTERUTIL_AVGRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBA5E50)

namespace MiHoYo::SDK::ReporterUtil
{
	inline static constexpr unsigned int AvgResult_TypeDefinitionIndex = 37009;

	class AvgResult : public ::System::Object
	{
	public:
		::System::Decimal _MainAvg_k__BackingField; // 0x10
		::System::Decimal _FractionAvg_k__BackingField; // 0x20
