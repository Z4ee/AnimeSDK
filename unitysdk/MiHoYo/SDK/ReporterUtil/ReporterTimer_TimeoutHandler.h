...
#define MIHOYO_SDK_REPORTERUTIL_REPORTERTIMER_TIMEOUTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ADFE890)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERTIMER_TIMEOUTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ADFE8D0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERTIMER_TIMEOUTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ADFE310)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERTIMER_TIMEOUTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADFE300)

namespace MiHoYo::SDK::ReporterUtil
{
	inline static constexpr unsigned int ReporterTimer_TimeoutHandler_TypeDefinitionIndex = 35425;
