...
#define MIHOYO_SDK_REPORTERUTIL_REPORTERTIMER_TIMEOUTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8579590)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERTIMER_TIMEOUTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x85795D0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERTIMER_TIMEOUTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x8578680)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERTIMER_TIMEOUTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8578030)

namespace MiHoYo::SDK::ReporterUtil
{
	inline static constexpr unsigned int ReporterTimer_TimeoutHandler_TypeDefinitionIndex = 37337;
