...
#define MIHOYO_SDK_REPORTERUTIL_REPORTERTIMER_TIMEOUTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E5C3050)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERTIMER_TIMEOUTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E5C3090)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERTIMER_TIMEOUTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E5C2AC0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERTIMER_TIMEOUTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5C2AA0)

namespace MiHoYo::SDK::ReporterUtil
{
	inline static constexpr unsigned int ReporterTimer_TimeoutHandler_TypeDefinitionIndex = 37685;
