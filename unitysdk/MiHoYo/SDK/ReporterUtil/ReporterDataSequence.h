...
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_ADDITEM_OFFSET UNITYSDK_OFFSET(0x1C4DAE30)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_ADD_FULLED_OFFSET UNITYSDK_OFFSET(0x1C4DAC70)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_ANALYZE_OFFSET UNITYSDK_OFFSET(0x1C4DAEF0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_BEGIN_OFFSET UNITYSDK_OFFSET(0x1C4DB020)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_CALCULATEAVERAGEVALUE_OFFSET UNITYSDK_OFFSET(0x1C4DB1F0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_CLEARDATAS_OFFSET UNITYSDK_OFFSET(0x1C4DAF40)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_END_OFFSET UNITYSDK_OFFSET(0x1C4DA400)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_GET_ANALYZER_OFFSET UNITYSDK_OFFSET(0x1C4DAB30)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_GET_ASCENDINGANALYZE_OFFSET UNITYSDK_OFFSET(0x1C4DAB20)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1C4DA7D0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_GET_CURRENTITEM_OFFSET UNITYSDK_OFFSET(0x1C4DA5E0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_GET_ITEMDURATIONS_OFFSET UNITYSDK_OFFSET(0x1C4DAB40)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_GET_TOTALMILLISECONDS_OFFSET UNITYSDK_OFFSET(0x1C4DA860)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_ITEM_OFFSET UNITYSDK_OFFSET(0x1C4DA580)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_REMOVE_FULLED_OFFSET UNITYSDK_OFFSET(0x1C4DACE0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_RESETDATA_OFFSET UNITYSDK_OFFSET(0x1C4DAD60)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_SORTITEMS_OFFSET UNITYSDK_OFFSET(0x1C4DB2A0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4DAD50)

namespace MiHoYo::SDK::ReporterUtil
{
	inline static constexpr unsigned int ReporterDataSequence_TypeDefinitionIndex = 37018;
