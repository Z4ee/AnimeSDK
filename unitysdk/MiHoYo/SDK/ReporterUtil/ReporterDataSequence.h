...
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_ADDITEM_OFFSET UNITYSDK_OFFSET(0x85771B0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_ADD_FULLED_OFFSET UNITYSDK_OFFSET(0x8577040)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_ANALYZE_OFFSET UNITYSDK_OFFSET(0x8577270)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_BEGIN_OFFSET UNITYSDK_OFFSET(0x85773A0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_CALCULATEAVERAGEVALUE_OFFSET UNITYSDK_OFFSET(0x8577530)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_CLEARDATAS_OFFSET UNITYSDK_OFFSET(0x85772C0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_END_OFFSET UNITYSDK_OFFSET(0x8575A80)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_GET_ANALYZER_OFFSET UNITYSDK_OFFSET(0x8576CE0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_GET_ASCENDINGANALYZE_OFFSET UNITYSDK_OFFSET(0x8576CD0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x8575E40)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_GET_CURRENTITEM_OFFSET UNITYSDK_OFFSET(0x8575C50)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_GET_ITEMDURATIONS_OFFSET UNITYSDK_OFFSET(0x8576CF0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_GET_TOTALMILLISECONDS_OFFSET UNITYSDK_OFFSET(0x8575ED0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_ITEM_OFFSET UNITYSDK_OFFSET(0x8575BF0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_REMOVE_FULLED_OFFSET UNITYSDK_OFFSET(0x85770A0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_RESETDATA_OFFSET UNITYSDK_OFFSET(0x8577110)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_SORTITEMS_OFFSET UNITYSDK_OFFSET(0x85777F0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x8577100)

namespace MiHoYo::SDK::ReporterUtil
{
	inline static constexpr unsigned int ReporterDataSequence_TypeDefinitionIndex = 37331;

	class ReporterDataSequence : public ::System::Object
	{
	public:
		// static const ::System::Int32 DefaultMaxItemsCount = 0x7530; // 0x0
		::MiHoYo::SDK::ReporterUtil::FulledHandler* onFulled; // 0x10
		::System::Collections::Generic::List_1<::MiHoYo::SDK::ReporterUtil::ReporterDataItem*>* items; // 0x18
		::MiHoYo::SDK::ReporterUtil::Analyzer_1<::System::Int64>* analyzer; // 0x20
