...
#define MIHOYO_SDK_REPORTERUTIL_DATAFULLEDHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AE2B8B0)
#define MIHOYO_SDK_REPORTERUTIL_DATAFULLEDHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AE2B8F0)
#define MIHOYO_SDK_REPORTERUTIL_DATAFULLEDHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AE2B330)
#define MIHOYO_SDK_REPORTERUTIL_DATAFULLEDHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE2B310)

namespace MiHoYo::SDK::ReporterUtil
{
	inline static constexpr unsigned int DataFulledHandler_TypeDefinitionIndex = 37020;
