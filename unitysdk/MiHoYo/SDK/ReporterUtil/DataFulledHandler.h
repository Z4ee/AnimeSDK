...
#define MIHOYO_SDK_REPORTERUTIL_DATAFULLEDHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8DA9110)
#define MIHOYO_SDK_REPORTERUTIL_DATAFULLEDHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8DA9150)
#define MIHOYO_SDK_REPORTERUTIL_DATAFULLEDHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x8DA8B90)
#define MIHOYO_SDK_REPORTERUTIL_DATAFULLEDHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8DA8B70)

namespace MiHoYo::SDK::ReporterUtil
{
	inline static constexpr unsigned int DataFulledHandler_TypeDefinitionIndex = 43210;
