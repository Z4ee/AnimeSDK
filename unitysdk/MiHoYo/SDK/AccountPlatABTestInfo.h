...
#define MIHOYO_SDK_ACCOUNTPLATABTESTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x181DE2C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AccountPlatABTestInfo_TypeDefinitionIndex = 7851;
