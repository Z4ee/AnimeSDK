...
#define MIHOYO_SDK_ACCOUNTPLATABTESTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B72B590)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AccountPlatABTestInfo_TypeDefinitionIndex = 7860;
