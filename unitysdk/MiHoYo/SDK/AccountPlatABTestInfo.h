...
#define MIHOYO_SDK_ACCOUNTPLATABTESTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4FE9D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AccountPlatABTestInfo_TypeDefinitionIndex = 19666;
