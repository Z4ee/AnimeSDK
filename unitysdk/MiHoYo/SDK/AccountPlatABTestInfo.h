...
#define MIHOYO_SDK_ACCOUNTPLATABTESTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C8D5B60)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AccountPlatABTestInfo_TypeDefinitionIndex = 20014;
