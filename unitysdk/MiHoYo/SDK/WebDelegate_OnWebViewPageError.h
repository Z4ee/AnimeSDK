...
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGEERROR_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBD37C0)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGEERROR_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBD37F0)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGEERROR_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBD32C0)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGEERROR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBD32A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_OnWebViewPageError_TypeDefinitionIndex = 19580;
