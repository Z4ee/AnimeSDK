...
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGEERROR_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16041170)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGEERROR_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x160411A0)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGEERROR_INVOKE_OFFSET UNITYSDK_OFFSET(0x1602E2B0)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGEERROR__CTOR_OFFSET UNITYSDK_OFFSET(0x16041150)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_OnWebViewPageError_TypeDefinitionIndex = 6821;
