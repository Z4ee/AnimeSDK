...
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGEERROR_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19C8EB60)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGEERROR_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19C8EB90)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGEERROR_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C8E660)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGEERROR__CTOR_OFFSET UNITYSDK_OFFSET(0x19C8E650)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_OnWebViewPageError_TypeDefinitionIndex = 18685;
