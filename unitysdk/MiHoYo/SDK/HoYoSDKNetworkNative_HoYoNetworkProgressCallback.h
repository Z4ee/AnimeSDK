...
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKPROGRESSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x84E9960)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKPROGRESSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x84E9A30)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKPROGRESSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x84E9510)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKPROGRESSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x84E7EC0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoSDKNetworkNative_HoYoNetworkProgressCallback_TypeDefinitionIndex = 36898;
