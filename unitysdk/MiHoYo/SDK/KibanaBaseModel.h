...
#define MIHOYO_SDK_KIBANABASEMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1834E9D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int KibanaBaseModel_TypeDefinitionIndex = 7829;
