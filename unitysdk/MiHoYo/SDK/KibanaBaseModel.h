...
#define MIHOYO_SDK_KIBANABASEMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x17565E90)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int KibanaBaseModel_TypeDefinitionIndex = 6926;
