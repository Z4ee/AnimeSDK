...
#define MIHOYO_SDK_SDKDELEGATE_GETDRIVETOTALFREESPACEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1711ED90)
#define MIHOYO_SDK_SDKDELEGATE_GETDRIVETOTALFREESPACEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1711EDC0)
#define MIHOYO_SDK_SDKDELEGATE_GETDRIVETOTALFREESPACEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1711ED80)
#define MIHOYO_SDK_SDKDELEGATE_GETDRIVETOTALFREESPACEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1711ED10)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_GetDriveTotalFreeSpaceDelegate_TypeDefinitionIndex = 7744;
