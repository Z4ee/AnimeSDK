...
#define MIHOYO_SDK_SDKDELEGATE_GETDRIVETOTALFREESPACEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BB52180)
#define MIHOYO_SDK_SDKDELEGATE_GETDRIVETOTALFREESPACEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BB521B0)
#define MIHOYO_SDK_SDKDELEGATE_GETDRIVETOTALFREESPACEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BB51C40)
#define MIHOYO_SDK_SDKDELEGATE_GETDRIVETOTALFREESPACEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB51C20)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_GetDriveTotalFreeSpaceDelegate_TypeDefinitionIndex = 19552;
