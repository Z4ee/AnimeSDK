...
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWBEFORENAVIGATIONMESSAGEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D775630)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWBEFORENAVIGATIONMESSAGEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D775660)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWBEFORENAVIGATIONMESSAGEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D775110)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWBEFORENAVIGATIONMESSAGEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7750F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_OnWebViewBeforeNavigationMessageDelegate_TypeDefinitionIndex = 19931;
