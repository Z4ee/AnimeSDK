...
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWBEFORENAVIGATIONMESSAGEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C39D480)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWBEFORENAVIGATIONMESSAGEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C39D4B0)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWBEFORENAVIGATIONMESSAGEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C39CF80)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWBEFORENAVIGATIONMESSAGEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C39CF60)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_OnWebViewBeforeNavigationMessageDelegate_TypeDefinitionIndex = 19583;
