...
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWBEFORENAVIGATIONMESSAGEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A408090)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWBEFORENAVIGATIONMESSAGEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A4080C0)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWBEFORENAVIGATIONMESSAGEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A407B90)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWBEFORENAVIGATIONMESSAGEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A407B80)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_OnWebViewBeforeNavigationMessageDelegate_TypeDefinitionIndex = 18688;
