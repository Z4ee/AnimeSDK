...
#define MIHOYO_SDK_CONSOLEDELEGATE_ACHIEVEMENTINITDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B93CA90)
#define MIHOYO_SDK_CONSOLEDELEGATE_ACHIEVEMENTINITDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B93CAC0)
#define MIHOYO_SDK_CONSOLEDELEGATE_ACHIEVEMENTINITDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B93CA80)
#define MIHOYO_SDK_CONSOLEDELEGATE_ACHIEVEMENTINITDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B93CA10)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_AchievementInitDelegate_TypeDefinitionIndex = 7584;
