...
#define MIHOYO_SDK_JSONOBJECT__GET_CHILDREN_D__25_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1820AD40)
#define MIHOYO_SDK_JSONOBJECT__GET_CHILDREN_D__25_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_MIHOYO_SDK_JSONNODE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1820AF30)
#define MIHOYO_SDK_JSONOBJECT__GET_CHILDREN_D__25_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_MIHOYO_SDK_JSONNODE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1820AEC0)
#define MIHOYO_SDK_JSONOBJECT__GET_CHILDREN_D__25_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1820B0A0)
#define MIHOYO_SDK_JSONOBJECT__GET_CHILDREN_D__25_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1820AF20)
#define MIHOYO_SDK_JSONOBJECT__GET_CHILDREN_D__25_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1820AED0)
#define MIHOYO_SDK_JSONOBJECT__GET_CHILDREN_D__25_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1820AD10)
#define MIHOYO_SDK_JSONOBJECT__GET_CHILDREN_D__25__CTOR_OFFSET UNITYSDK_OFFSET(0x1820A230)
#define MIHOYO_SDK_JSONOBJECT__GET_CHILDREN_D__25___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1820AD30)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int JSONObject__get_Children_d__25_TypeDefinitionIndex = 8088;

	class JSONObject__get_Children_d__25 : public ::System::Object
	{
	public:
		::MiHoYo::SDK::JSONNode* __2__current; // 0x10
		::System::Collections::Generic::KeyValuePair_2<::System::String*, ::MiHoYo::SDK::JSONNode*> _N_5__2; // 0x18
		::System::Collections::Generic::Dictionary_2_Enumerator<::System::String*, ::MiHoYo::SDK::JSONNode*> __s__1; // 0x28
		::MiHoYo::SDK::JSONObject* __4__this; // 0x50
