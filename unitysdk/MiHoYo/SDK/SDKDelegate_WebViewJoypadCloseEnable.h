...
#define MIHOYO_SDK_SDKDELEGATE_WEBVIEWJOYPADCLOSEENABLE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17120990)
#define MIHOYO_SDK_SDKDELEGATE_WEBVIEWJOYPADCLOSEENABLE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x171209E0)
#define MIHOYO_SDK_SDKDELEGATE_WEBVIEWJOYPADCLOSEENABLE_INVOKE_OFFSET UNITYSDK_OFFSET(0x17120980)
#define MIHOYO_SDK_SDKDELEGATE_WEBVIEWJOYPADCLOSEENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x17120910)
