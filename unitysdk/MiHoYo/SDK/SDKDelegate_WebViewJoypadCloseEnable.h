...
#define MIHOYO_SDK_SDKDELEGATE_WEBVIEWJOYPADCLOSEENABLE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BAC9E20)
#define MIHOYO_SDK_SDKDELEGATE_WEBVIEWJOYPADCLOSEENABLE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BAC9E70)
#define MIHOYO_SDK_SDKDELEGATE_WEBVIEWJOYPADCLOSEENABLE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BAC9E10)
#define MIHOYO_SDK_SDKDELEGATE_WEBVIEWJOYPADCLOSEENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAC9DA0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_WebViewJoypadCloseEnable_TypeDefinitionIndex = 7759;
