...
#define MIHOYO_SDK_SDKDELEGATE_WEBVIEWJOYPADCLOSEENABLE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C7D9010)
#define MIHOYO_SDK_SDKDELEGATE_WEBVIEWJOYPADCLOSEENABLE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C7D9080)
#define MIHOYO_SDK_SDKDELEGATE_WEBVIEWJOYPADCLOSEENABLE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C7D8C90)
#define MIHOYO_SDK_SDKDELEGATE_WEBVIEWJOYPADCLOSEENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C7D8C70)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_WebViewJoypadCloseEnable_TypeDefinitionIndex = 19914;
