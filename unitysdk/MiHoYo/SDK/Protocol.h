...
#define MIHOYO_SDK_PROTOCOL_AWAKE_OFFSET UNITYSDK_OFFSET(0x18DD42F0)
#define MIHOYO_SDK_PROTOCOL_CLICKACCEPTBUTTON_OFFSET UNITYSDK_OFFSET(0x18DD5540)
#define MIHOYO_SDK_PROTOCOL_CLICKREFUSEBUTTON_OFFSET UNITYSDK_OFFSET(0x18DD5420)
#define MIHOYO_SDK_PROTOCOL_HIDE_OFFSET UNITYSDK_OFFSET(0x18DD4280)
#define MIHOYO_SDK_PROTOCOL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18DD56A0)
#define MIHOYO_SDK_PROTOCOL_ONHREFCLICK_OFFSET UNITYSDK_OFFSET(0x18DD5560)
#define MIHOYO_SDK_PROTOCOL_SHOW_1_OFFSET UNITYSDK_OFFSET(0x18DD41A0)
#define MIHOYO_SDK_PROTOCOL_SHOW_OFFSET UNITYSDK_OFFSET(0x18DD40B0)
#define MIHOYO_SDK_PROTOCOL_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x18DD4910)
#define MIHOYO_SDK_PROTOCOL__CLICKREFUSEBUTTON_B__33_0_OFFSET UNITYSDK_OFFSET(0x18DD56D0)
#define MIHOYO_SDK_PROTOCOL__CTOR_OFFSET UNITYSDK_OFFSET(0x18DD56C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int Protocol_TypeDefinitionIndex = 19112;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Protocol**)Il2CppClass::FromTypeDefinitionIndex(Protocol_TypeDefinitionIndex)->GetStaticField(0x9B30);
		}
