...
#define MIHOYO_SDK_SDKDELEGATE_ISINSTACKTOPDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x197EB8B0)
#define MIHOYO_SDK_SDKDELEGATE_ISINSTACKTOPDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x197EB8E0)
#define MIHOYO_SDK_SDKDELEGATE_ISINSTACKTOPDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x197EB370)
#define MIHOYO_SDK_SDKDELEGATE_ISINSTACKTOPDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x197EB360)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_IsInStackTopDelegate_TypeDefinitionIndex = 18675;
