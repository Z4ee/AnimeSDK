...
#define MIHOYO_SDK_MIHOYOSDKSERVER_ONCONNECTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ADF6DB0)
#define MIHOYO_SDK_MIHOYOSDKSERVER_ONCONNECTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ADF6E30)
#define MIHOYO_SDK_MIHOYOSDKSERVER_ONCONNECTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ADF6A70)
#define MIHOYO_SDK_MIHOYOSDKSERVER_ONCONNECTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADF6A60)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKServer_OnConnectDelegate_TypeDefinitionIndex = 35138;
