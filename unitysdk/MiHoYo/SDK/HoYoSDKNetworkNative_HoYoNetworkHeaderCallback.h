...
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKHEADERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C2C6670)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKHEADERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C2C6740)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKHEADERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C2C62D0)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKHEADERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2C62B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoSDKNetworkNative_HoYoNetworkHeaderCallback_TypeDefinitionIndex = 37164;
