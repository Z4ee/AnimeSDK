...
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKHEADERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ADF2B60)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKHEADERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ADF2C30)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKHEADERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ADF2770)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKHEADERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADF2750)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoSDKNetworkNative_HoYoNetworkHeaderCallback_TypeDefinitionIndex = 36505;
