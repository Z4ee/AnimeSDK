...
#define MIHOYO_SDK_SDKDELEGATE_ONGAMEROLEUPDATEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15FEBCB0)
#define MIHOYO_SDK_SDKDELEGATE_ONGAMEROLEUPDATEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15FEBCE0)
#define MIHOYO_SDK_SDKDELEGATE_ONGAMEROLEUPDATEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15FEB760)
#define MIHOYO_SDK_SDKDELEGATE_ONGAMEROLEUPDATEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15FEB740)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_OnGameRoleUpdateDelegate_TypeDefinitionIndex = 6801;
