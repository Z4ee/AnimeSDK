...
#define MIHOYO_SDK_WEBDELEGATE_SETUSERAGENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x160426C0)
#define MIHOYO_SDK_WEBDELEGATE_SETUSERAGENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x160426F0)
#define MIHOYO_SDK_WEBDELEGATE_SETUSERAGENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x16035050)
#define MIHOYO_SDK_WEBDELEGATE_SETUSERAGENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x160426A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetUserAgentDelegate_TypeDefinitionIndex = 6839;
