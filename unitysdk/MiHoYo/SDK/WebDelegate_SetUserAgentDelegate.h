...
#define MIHOYO_SDK_WEBDELEGATE_SETUSERAGENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B6E9F20)
#define MIHOYO_SDK_WEBDELEGATE_SETUSERAGENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B6E9F50)
#define MIHOYO_SDK_WEBDELEGATE_SETUSERAGENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B6E9A20)
#define MIHOYO_SDK_WEBDELEGATE_SETUSERAGENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6E9A00)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetUserAgentDelegate_TypeDefinitionIndex = 19598;
