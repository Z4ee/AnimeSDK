...
#define MIHOYO_SDK_PSDELEGATE_PS5FRIENDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBCCE70)
#define MIHOYO_SDK_PSDELEGATE_PS5FRIENDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBCCEA0)
#define MIHOYO_SDK_PSDELEGATE_PS5FRIENDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBAD4E0)
#define MIHOYO_SDK_PSDELEGATE_PS5FRIENDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBCCE50)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_PS5FriendCallback_TypeDefinitionIndex = 19512;
