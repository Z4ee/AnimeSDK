...
#define MIHOYO_SDK_MIHOYOSDKLINKIMAGETEXT_HREFINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1B5D90)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKLinkImageText_HrefInfo_TypeDefinitionIndex = 37505;
