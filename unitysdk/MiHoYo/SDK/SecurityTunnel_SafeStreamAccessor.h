...
#define MIHOYO_SDK_SECURITYTUNNEL_SAFESTREAMACCESSOR_TRYREADSTREAM_OFFSET UNITYSDK_OFFSET(0x1ABB5180)
#define MIHOYO_SDK_SECURITYTUNNEL_SAFESTREAMACCESSOR_TRYWRITESTREAM_OFFSET UNITYSDK_OFFSET(0x1ABB8AD0)
#define MIHOYO_SDK_SECURITYTUNNEL_SAFESTREAMACCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABC11F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_SafeStreamAccessor_TypeDefinitionIndex = 44684;
