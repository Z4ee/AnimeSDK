...
#define MIHOYO_SDK_HOYOCHANNELSOCIALSERVICES___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE7D110)
#define MIHOYO_SDK_HOYOCHANNELSOCIALSERVICES___C__DISPLAYCLASS11_0__ONBLOCKLISTCALLBACK_B__0_OFFSET UNITYSDK_OFFSET(0x1CE7D120)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoChannelSocialServices___c__DisplayClass11_0_TypeDefinitionIndex = 36936;
