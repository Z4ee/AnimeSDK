...
#define MIHOYO_SDK_MIHOYOSDKGUESTMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x8D473A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKGuestModel_TypeDefinitionIndex = 42956;
