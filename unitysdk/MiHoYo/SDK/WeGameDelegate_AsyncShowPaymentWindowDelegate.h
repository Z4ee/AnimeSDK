...
#define MIHOYO_SDK_WEGAMEDELEGATE_ASYNCSHOWPAYMENTWINDOWDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DD517F0)
#define MIHOYO_SDK_WEGAMEDELEGATE_ASYNCSHOWPAYMENTWINDOWDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DD51830)
#define MIHOYO_SDK_WEGAMEDELEGATE_ASYNCSHOWPAYMENTWINDOWDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DD51260)
#define MIHOYO_SDK_WEGAMEDELEGATE_ASYNCSHOWPAYMENTWINDOWDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD51240)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WeGameDelegate_AsyncShowPaymentWindowDelegate_TypeDefinitionIndex = 19815;
