...
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOGETCHUNKTOTALSIZEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D1B8460)
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOGETCHUNKTOTALSIZEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D1B8490)
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOGETCHUNKTOTALSIZEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D1B7F40)
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOGETCHUNKTOTALSIZEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1B7F20)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_PlayGoGetChunkTotalSizeDelegate_TypeDefinitionIndex = 19769;
