...
#define MIHOYO_SDK_HOYOCHANNELSOCIALSERVICES___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1E52D690)
#define MIHOYO_SDK_HOYOCHANNELSOCIALSERVICES___C__DISPLAYCLASS5_0__ONFRIENDLISTCALLBACK_B__0_OFFSET UNITYSDK_OFFSET(0x1E52D6A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoChannelSocialServices___c__DisplayClass5_0_TypeDefinitionIndex = 37596;
