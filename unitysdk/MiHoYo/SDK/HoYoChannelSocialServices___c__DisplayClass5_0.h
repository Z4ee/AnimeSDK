...
#define MIHOYO_SDK_HOYOCHANNELSOCIALSERVICES___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6E5740)
#define MIHOYO_SDK_HOYOCHANNELSOCIALSERVICES___C__DISPLAYCLASS5_0__ONFRIENDLISTCALLBACK_B__0_OFFSET UNITYSDK_OFFSET(0x1C6E6E80)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoChannelSocialServices___c__DisplayClass5_0_TypeDefinitionIndex = 47017;
