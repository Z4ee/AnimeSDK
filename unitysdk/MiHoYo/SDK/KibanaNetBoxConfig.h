...
#define MIHOYO_SDK_KIBANANETBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x15F1D0A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int KibanaNetBoxConfig_TypeDefinitionIndex = 6912;
