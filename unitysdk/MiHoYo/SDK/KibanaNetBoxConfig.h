...
#define MIHOYO_SDK_KIBANANETBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1B87A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int KibanaNetBoxConfig_TypeDefinitionIndex = 20023;
