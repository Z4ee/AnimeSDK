...
#define MIHOYO_SDK_WEBVIEWAPMBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEC1050)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebViewAPMBoxConfig_TypeDefinitionIndex = 20030;
