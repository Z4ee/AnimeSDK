...
#define MIHOYO_SDK_WEBDELEGATE_SETWEBVOLUMEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16042FA0)
#define MIHOYO_SDK_WEBDELEGATE_SETWEBVOLUMEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16042FF0)
#define MIHOYO_SDK_WEBDELEGATE_SETWEBVOLUMEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x16042CB0)
#define MIHOYO_SDK_WEBDELEGATE_SETWEBVOLUMEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16042C90)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetWebVolumeDelegate_TypeDefinitionIndex = 6852;
