...
#define MIHOYO_SDK_WEBDELEGATE_HIDENAVIGATIONBARDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BE6D800)
#define MIHOYO_SDK_WEBDELEGATE_HIDENAVIGATIONBARDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BE6D8D0)
#define MIHOYO_SDK_WEBDELEGATE_HIDENAVIGATIONBARDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BE6D170)
#define MIHOYO_SDK_WEBDELEGATE_HIDENAVIGATIONBARDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE6D150)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_HideNavigationBarDelegate_TypeDefinitionIndex = 19591;
