...
#define MIHOYO_SDK_WEBDELEGATE_HIDENAVIGATIONBARDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184644C0)
#define MIHOYO_SDK_WEBDELEGATE_HIDENAVIGATIONBARDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18464560)
#define MIHOYO_SDK_WEBDELEGATE_HIDENAVIGATIONBARDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18462030)
#define MIHOYO_SDK_WEBDELEGATE_HIDENAVIGATIONBARDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x184643D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_HideNavigationBarDelegate_TypeDefinitionIndex = 7777;
