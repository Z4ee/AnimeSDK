...
#define MIHOYO_SDK_POPIMAGE_CLOSEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18DD4070)
#define MIHOYO_SDK_POPIMAGE_CLOSEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18DD40A0)
#define MIHOYO_SDK_POPIMAGE_CLOSEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18DD3B70)
#define MIHOYO_SDK_POPIMAGE_CLOSEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18DD3B60)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PopImage_CloseDelegate_TypeDefinitionIndex = 19120;
