...
#define MIHOYO_SDK_POPIMAGE_CLOSEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BDF0670)
#define MIHOYO_SDK_POPIMAGE_CLOSEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BDF06A0)
#define MIHOYO_SDK_POPIMAGE_CLOSEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BDF0150)
#define MIHOYO_SDK_POPIMAGE_CLOSEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDF0130)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PopImage_CloseDelegate_TypeDefinitionIndex = 20366;
