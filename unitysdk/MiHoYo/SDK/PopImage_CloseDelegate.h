...
#define MIHOYO_SDK_POPIMAGE_CLOSEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15FBCA10)
#define MIHOYO_SDK_POPIMAGE_CLOSEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15FBCA40)
#define MIHOYO_SDK_POPIMAGE_CLOSEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15FBB3D0)
#define MIHOYO_SDK_POPIMAGE_CLOSEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15FBC9F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PopImage_CloseDelegate_TypeDefinitionIndex = 7250;
