...
#define MIHOYO_SDK_WEB_ONWEBVIEWBEFORENAVIGATIONMESSAGE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CD7D920)
#define MIHOYO_SDK_WEB_ONWEBVIEWBEFORENAVIGATIONMESSAGE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CD7D960)
#define MIHOYO_SDK_WEB_ONWEBVIEWBEFORENAVIGATIONMESSAGE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CD7CFE0)
#define MIHOYO_SDK_WEB_ONWEBVIEWBEFORENAVIGATIONMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD7D830)
