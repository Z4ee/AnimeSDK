...
#define MIHOYO_SDK_WEB_ONWEBVIEWBEFORENAVIGATIONMESSAGE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15C234C0)
#define MIHOYO_SDK_WEB_ONWEBVIEWBEFORENAVIGATIONMESSAGE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15C23500)
#define MIHOYO_SDK_WEB_ONWEBVIEWBEFORENAVIGATIONMESSAGE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15C22B50)
#define MIHOYO_SDK_WEB_ONWEBVIEWBEFORENAVIGATIONMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x15C233D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int Web_OnWebViewBeforeNavigationMessage_TypeDefinitionIndex = 8173;
