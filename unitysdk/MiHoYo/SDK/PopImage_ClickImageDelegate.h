...
#define MIHOYO_SDK_POPIMAGE_CLICKIMAGEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x170F74D0)
#define MIHOYO_SDK_POPIMAGE_CLICKIMAGEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x170F7500)
#define MIHOYO_SDK_POPIMAGE_CLICKIMAGEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x170F6920)
#define MIHOYO_SDK_POPIMAGE_CLICKIMAGEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x170F73E0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PopImage_ClickImageDelegate_TypeDefinitionIndex = 8208;
