...
#define MIHOYO_SDK_POPIMAGE_CLICKIMAGEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19EA6A60)
#define MIHOYO_SDK_POPIMAGE_CLICKIMAGEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19EA6A90)
#define MIHOYO_SDK_POPIMAGE_CLICKIMAGEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19EA5EB0)
#define MIHOYO_SDK_POPIMAGE_CLICKIMAGEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19EA6970)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PopImage_ClickImageDelegate_TypeDefinitionIndex = 8214;
