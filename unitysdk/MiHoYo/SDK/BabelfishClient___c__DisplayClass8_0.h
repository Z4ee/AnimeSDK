...
#define MIHOYO_SDK_BABELFISHCLIENT___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB1B2020)
#define MIHOYO_SDK_BABELFISHCLIENT___C__DISPLAYCLASS8_0__TRANSLATE_B__0_OFFSET UNITYSDK_OFFSET(0xB1B2E90)
#define MIHOYO_SDK_BABELFISHCLIENT___C__DISPLAYCLASS8_0__TRANSLATE_B__1_OFFSET UNITYSDK_OFFSET(0xB1B3310)
...
namespace MiHoYo::SDK
{
	...
	{
	public:
		::System::Action_1<::MiHoYo::SDK::JSONNode*>* onSuccess; // 0x10
