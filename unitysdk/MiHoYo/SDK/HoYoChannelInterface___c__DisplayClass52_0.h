...
#define MIHOYO_SDK_HOYOCHANNELINTERFACE___C__DISPLAYCLASS52_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBDFC40)
#define MIHOYO_SDK_HOYOCHANNELINTERFACE___C__DISPLAYCLASS52_0__ONENTITLEMENTSCALLBACK_B__0_OFFSET UNITYSDK_OFFSET(0x1CBDFC50)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoChannelInterface___c__DisplayClass52_0_TypeDefinitionIndex = 36915;
