...
#define MIHOYO_SDK_PSDELEGATE_OPENIMEDIALOGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CEAEDB0)
#define MIHOYO_SDK_PSDELEGATE_OPENIMEDIALOGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CEAEDF0)
#define MIHOYO_SDK_PSDELEGATE_OPENIMEDIALOGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CEAE7F0)
#define MIHOYO_SDK_PSDELEGATE_OPENIMEDIALOGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEAE7D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_OpenImeDialogDelegate_TypeDefinitionIndex = 19849;
