...
namespace MiHoYo::SDK { class MiHoYoSDKBiliBiliInterface_Class_3_38EEFC268F197886; }
namespace System { class String; }

#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_ENUMWINDOWS_OFFSET UNITYSDK_OFFSET(0x1A87CDE0)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_GETPARENT_OFFSET UNITYSDK_OFFSET(0x1A87CEB0)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_GETPROCESSWND_OFFSET UNITYSDK_OFFSET(0x1A87D110)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_GETWINDOWTHREADPROCESSID_OFFSET UNITYSDK_OFFSET(0x1A87CF80)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_ISWINDOWVISIBLE_OFFSET UNITYSDK_OFFSET(0x1A87D090)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_SDKINIT_OFFSET UNITYSDK_OFFSET(0x1A87CA40)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_SDKLOGIN_OFFSET UNITYSDK_OFFSET(0x1A87CB90)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_SDKLOGOUT_OFFSET UNITYSDK_OFFSET(0x1A87CD60)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_SDKPAY_OFFSET UNITYSDK_OFFSET(0x1A87CC20)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_SDKSTARTHEARTBEAT_OFFSET UNITYSDK_OFFSET(0x1A87CCD0)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_SDKUNINIT_OFFSET UNITYSDK_OFFSET(0x1A87CB10)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_SETLASTERROR_OFFSET UNITYSDK_OFFSET(0x1A87D010)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_WINDOWPROCCESS_OFFSET UNITYSDK_OFFSET(0x1A87C700)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A87D3E0)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A87D3D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKBiliBiliInterface_TypeDefinitionIndex = 35122;
	...
	public:
		...
		{
			return (::System::IntPtr*)Il2CppClass::FromTypeDefinitionIndex(MiHoYoSDKBiliBiliInterface_TypeDefinitionIndex)->GetStaticField(0x83B0);
		}
		...
		static ::System::Boolean EnumWindows(::MiHoYo::SDK::MiHoYoSDKBiliBiliInterface_Class_3_38EEFC268F197886* lpEnumFunc, ::System::UInt32 lParam)
		{
			return ((::System::Boolean(*)(::MiHoYo::SDK::MiHoYoSDKBiliBiliInterface_Class_3_38EEFC268F197886*, ::System::UInt32))((::PBYTE)hIl2Cpp + MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_ENUMWINDOWS_OFFSET))(lpEnumFunc, lParam);
		}
