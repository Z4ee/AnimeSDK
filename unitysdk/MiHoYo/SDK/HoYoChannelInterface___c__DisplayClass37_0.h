...
#define MIHOYO_SDK_HOYOCHANNELINTERFACE___C__DISPLAYCLASS37_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8D0DAD0)
#define MIHOYO_SDK_HOYOCHANNELINTERFACE___C__DISPLAYCLASS37_0__ONLOGINCALLBACK_B__0_OFFSET UNITYSDK_OFFSET(0x8D12100)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoChannelInterface___c__DisplayClass37_0_TypeDefinitionIndex = 43120;
