...
#define MIHOYO_SDK_EOSPARAMETERSMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x194521F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int EOSParametersModel_TypeDefinitionIndex = 18758;
