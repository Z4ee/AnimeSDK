...
#define MIHOYO_SDK_EOSPARAMETERSMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA4A380)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int EOSParametersModel_TypeDefinitionIndex = 7845;
