...
#define MIHOYO_SDK_SDKDELEGATE_SECURITYSETLOGINRESULTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A07F9B0)
#define MIHOYO_SDK_SDKDELEGATE_SECURITYSETLOGINRESULTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A07F9E0)
#define MIHOYO_SDK_SDKDELEGATE_SECURITYSETLOGINRESULTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A07F4B0)
#define MIHOYO_SDK_SDKDELEGATE_SECURITYSETLOGINRESULTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A07F4A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_SecuritySetLoginResultDelegate_TypeDefinitionIndex = 18654;
