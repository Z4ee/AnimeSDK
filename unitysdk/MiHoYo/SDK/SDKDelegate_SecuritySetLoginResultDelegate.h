...
#define MIHOYO_SDK_SDKDELEGATE_SECURITYSETLOGINRESULTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15FEDB40)
#define MIHOYO_SDK_SDKDELEGATE_SECURITYSETLOGINRESULTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15FEDB70)
#define MIHOYO_SDK_SDKDELEGATE_SECURITYSETLOGINRESULTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15FED5F0)
#define MIHOYO_SDK_SDKDELEGATE_SECURITYSETLOGINRESULTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15FED5D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_SecuritySetLoginResultDelegate_TypeDefinitionIndex = 6790;
