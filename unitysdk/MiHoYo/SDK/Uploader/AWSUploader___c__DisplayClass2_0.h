...
#define MIHOYO_SDK_UPLOADER_AWSUPLOADER___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8DDCF50)
#define MIHOYO_SDK_UPLOADER_AWSUPLOADER___C__DISPLAYCLASS2_0__INTERNALUPLOAD_B__0_OFFSET UNITYSDK_OFFSET(0x8DDCF60)

namespace MiHoYo::SDK::Uploader
{
	inline static constexpr unsigned int AWSUploader___c__DisplayClass2_0_TypeDefinitionIndex = 43231;
