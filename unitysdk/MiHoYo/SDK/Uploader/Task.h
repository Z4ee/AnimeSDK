...
#define MIHOYO_SDK_UPLOADER_TASK_BUFFERTASK_OFFSET UNITYSDK_OFFSET(0x1AD97830)
#define MIHOYO_SDK_UPLOADER_TASK_FILETASK_OFFSET UNITYSDK_OFFSET(0x1AD976C0)
#define MIHOYO_SDK_UPLOADER_TASK__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AD979D0)
#define MIHOYO_SDK_UPLOADER_TASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD97810)

namespace MiHoYo::SDK::Uploader
{
	inline static constexpr unsigned int Task_TypeDefinitionIndex = 35434;

	class Task : public ::System::Object
	{
	public:
		::MiHoYo::SDK::Uploader::UploadCallbackAction* callback; // 0x10
		::System::String* m_strFilePath; // 0x18
