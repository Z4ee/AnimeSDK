...
#define MIHOYO_SDK_UPLOADER_ONLOGACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8DDF750)
#define MIHOYO_SDK_UPLOADER_ONLOGACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8DDF780)
#define MIHOYO_SDK_UPLOADER_ONLOGACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x8DDF200)
#define MIHOYO_SDK_UPLOADER_ONLOGACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x8DDF1E0)

namespace MiHoYo::SDK::Uploader
{
	inline static constexpr unsigned int OnLogAction_TypeDefinitionIndex = 43222;
