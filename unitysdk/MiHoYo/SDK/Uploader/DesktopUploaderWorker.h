...
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_ALIYUNINITUPLOADER_OFFSET UNITYSDK_OFFSET(0x198D2280)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_ALIYUNUPLOADBUFFER_OFFSET UNITYSDK_OFFSET(0x198D2720)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_ALIYUNUPLOADFILE_OFFSET UNITYSDK_OFFSET(0x198D23F0)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_AWSINITUPLOADER_OFFSET UNITYSDK_OFFSET(0x198D2A60)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_AWSUPLOADBUFFER_OFFSET UNITYSDK_OFFSET(0x198D2BC0)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_AWSUPLOADFILE_OFFSET UNITYSDK_OFFSET(0x198D2B50)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_INITENV_OFFSET UNITYSDK_OFFSET(0x198D2C40)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_INITUPLOADER_OFFSET UNITYSDK_OFFSET(0x198D2370)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_MIHOYOUPLOADERINTRNALCALLBACK_OFFSET UNITYSDK_OFFSET(0x198D2030)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_MIHOYOUPLOADER_CREATEUPLOADERHANDLE_OFFSET UNITYSDK_OFFSET(0x198D3250)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_MIHOYOUPLOADER_INITUPLOADER_OFFSET UNITYSDK_OFFSET(0x198D2EC0)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_MIHOYOUPLOADER_UPLOADBUFFER_OFFSET UNITYSDK_OFFSET(0x198D3140)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_MIHOYOUPLOADER_UPLOADFILE_OFFSET UNITYSDK_OFFSET(0x198D3030)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_UPLOADBUFFER_OFFSET UNITYSDK_OFFSET(0x198D27A0)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_UPLOADFILE_OFFSET UNITYSDK_OFFSET(0x198D2460)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER__CCTOR_OFFSET UNITYSDK_OFFSET(0x198D3320)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER__CTOR_OFFSET UNITYSDK_OFFSET(0x198D32F0)

namespace MiHoYo::SDK::Uploader
{
	inline static constexpr unsigned int DesktopUploaderWorker_TypeDefinitionIndex = 35429;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::MiHoYo::SDK::Uploader::UploadCallbackAction*>**)Il2CppClass::FromTypeDefinitionIndex(DesktopUploaderWorker_TypeDefinitionIndex)->GetStaticField(0x26D10);
		}
