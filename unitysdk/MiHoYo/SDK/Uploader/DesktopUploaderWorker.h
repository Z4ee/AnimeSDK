...
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_ALIYUNINITUPLOADER_OFFSET UNITYSDK_OFFSET(0x1B640460)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_ALIYUNUPLOADBUFFER_OFFSET UNITYSDK_OFFSET(0x1B640900)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_ALIYUNUPLOADFILE_OFFSET UNITYSDK_OFFSET(0x1B6405D0)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_AWSINITUPLOADER_OFFSET UNITYSDK_OFFSET(0x1B640C40)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_AWSUPLOADBUFFER_OFFSET UNITYSDK_OFFSET(0x1B640DA0)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_AWSUPLOADFILE_OFFSET UNITYSDK_OFFSET(0x1B640D30)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_INITENV_OFFSET UNITYSDK_OFFSET(0x1B640E20)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_INITUPLOADER_OFFSET UNITYSDK_OFFSET(0x1B640550)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_MIHOYOUPLOADERINTRNALCALLBACK_OFFSET UNITYSDK_OFFSET(0x1B640210)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_MIHOYOUPLOADER_CREATEUPLOADERHANDLE_OFFSET UNITYSDK_OFFSET(0x1B641430)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_MIHOYOUPLOADER_INITUPLOADER_OFFSET UNITYSDK_OFFSET(0x1B6410A0)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_MIHOYOUPLOADER_UPLOADBUFFER_OFFSET UNITYSDK_OFFSET(0x1B641320)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_MIHOYOUPLOADER_UPLOADFILE_OFFSET UNITYSDK_OFFSET(0x1B641210)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_UPLOADBUFFER_OFFSET UNITYSDK_OFFSET(0x1B640980)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_UPLOADFILE_OFFSET UNITYSDK_OFFSET(0x1B640640)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B641500)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6414D0)

namespace MiHoYo::SDK::Uploader
{
	inline static constexpr unsigned int DesktopUploaderWorker_TypeDefinitionIndex = 37028;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::MiHoYo::SDK::Uploader::UploadCallbackAction*>**)Il2CppClass::FromTypeDefinitionIndex(DesktopUploaderWorker_TypeDefinitionIndex)->GetStaticField(0x28990);
		}
