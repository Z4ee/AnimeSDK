...
namespace MiHoYo::SDK::Uploader
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Uploader::UploadCallbackAction**)Il2CppClass::FromTypeDefinitionIndex(DesktopUploaderWorker___O_TypeDefinitionIndex)->GetStaticField(0x1D650);
		}
	};
}
