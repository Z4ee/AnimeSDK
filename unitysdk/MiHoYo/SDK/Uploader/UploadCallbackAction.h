...
#define MIHOYO_SDK_UPLOADER_UPLOADCALLBACKACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CD506D0)
#define MIHOYO_SDK_UPLOADER_UPLOADCALLBACKACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CD50770)
#define MIHOYO_SDK_UPLOADER_UPLOADCALLBACKACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CD4FB20)
#define MIHOYO_SDK_UPLOADER_UPLOADCALLBACKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD50660)

namespace MiHoYo::SDK::Uploader
{
	inline static constexpr unsigned int UploadCallbackAction_TypeDefinitionIndex = 47122;
