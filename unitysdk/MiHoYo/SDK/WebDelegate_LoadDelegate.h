...
#define MIHOYO_SDK_WEBDELEGATE_LOADDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CD7F2C0)
#define MIHOYO_SDK_WEBDELEGATE_LOADDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CD7F300)
#define MIHOYO_SDK_WEBDELEGATE_LOADDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CD7C910)
#define MIHOYO_SDK_WEBDELEGATE_LOADDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD7F1D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_LoadDelegate_TypeDefinitionIndex = 7778;
