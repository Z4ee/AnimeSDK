...
#define MIHOYO_SDK_PSDELEGATE_ACTIVITYCHANGEAVAILABILITYLISTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15F90C60)
#define MIHOYO_SDK_PSDELEGATE_ACTIVITYCHANGEAVAILABILITYLISTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15F90C90)
#define MIHOYO_SDK_PSDELEGATE_ACTIVITYCHANGEAVAILABILITYLISTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15F90700)
#define MIHOYO_SDK_PSDELEGATE_ACTIVITYCHANGEAVAILABILITYLISTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15F906E0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_ActivityChangeAvailabilityListDelegate_TypeDefinitionIndex = 6761;
