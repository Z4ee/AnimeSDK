...
#define MIHOYO_SDK_PSDELEGATE_ACTIVITYCHANGEAVAILABILITYLISTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B6D1670)
#define MIHOYO_SDK_PSDELEGATE_ACTIVITYCHANGEAVAILABILITYLISTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B6D16A0)
#define MIHOYO_SDK_PSDELEGATE_ACTIVITYCHANGEAVAILABILITYLISTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B6D1130)
#define MIHOYO_SDK_PSDELEGATE_ACTIVITYCHANGEAVAILABILITYLISTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6D1110)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_ActivityChangeAvailabilityListDelegate_TypeDefinitionIndex = 19520;
