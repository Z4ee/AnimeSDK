...
#define MIHOYO_SDK_NETWORKMANAGER__POST_D__20_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1758FC40)
#define MIHOYO_SDK_NETWORKMANAGER__POST_D__20_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1758FD20)
#define MIHOYO_SDK_NETWORKMANAGER__POST_D__20_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1758FD80)
#define MIHOYO_SDK_NETWORKMANAGER__POST_D__20_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1758FD30)
#define MIHOYO_SDK_NETWORKMANAGER__POST_D__20_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1758FC30)
#define MIHOYO_SDK_NETWORKMANAGER__POST_D__20__CTOR_OFFSET UNITYSDK_OFFSET(0x17589D10)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int NetworkManager__Post_d__20_TypeDefinitionIndex = 7184;
