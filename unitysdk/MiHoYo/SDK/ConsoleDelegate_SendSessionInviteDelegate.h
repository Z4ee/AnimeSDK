...
#define MIHOYO_SDK_CONSOLEDELEGATE_SENDSESSIONINVITEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18309CA0)
#define MIHOYO_SDK_CONSOLEDELEGATE_SENDSESSIONINVITEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18309CE0)
#define MIHOYO_SDK_CONSOLEDELEGATE_SENDSESSIONINVITEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18309C90)
#define MIHOYO_SDK_CONSOLEDELEGATE_SENDSESSIONINVITEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18309C10)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_SendSessionInviteDelegate_TypeDefinitionIndex = 7585;
