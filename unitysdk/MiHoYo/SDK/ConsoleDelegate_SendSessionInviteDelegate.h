...
#define MIHOYO_SDK_CONSOLEDELEGATE_SENDSESSIONINVITEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C5FAC90)
#define MIHOYO_SDK_CONSOLEDELEGATE_SENDSESSIONINVITEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C5FACD0)
#define MIHOYO_SDK_CONSOLEDELEGATE_SENDSESSIONINVITEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C5FAC80)
#define MIHOYO_SDK_CONSOLEDELEGATE_SENDSESSIONINVITEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5FAC00)
