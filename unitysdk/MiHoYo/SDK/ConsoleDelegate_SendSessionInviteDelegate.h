...
#define MIHOYO_SDK_CONSOLEDELEGATE_SENDSESSIONINVITEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AA46150)
#define MIHOYO_SDK_CONSOLEDELEGATE_SENDSESSIONINVITEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AA46190)
#define MIHOYO_SDK_CONSOLEDELEGATE_SENDSESSIONINVITEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AA46140)
#define MIHOYO_SDK_CONSOLEDELEGATE_SENDSESSIONINVITEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA460C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_SendSessionInviteDelegate_TypeDefinitionIndex = 7591;
