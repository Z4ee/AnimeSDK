...
#define MIHOYO_SDK_TOOLS_SETTINGSDOCUMENT_GETFEATURE_OFFSET UNITYSDK_OFFSET(0x1C7C7910)
#define MIHOYO_SDK_TOOLS_SETTINGSDOCUMENT_GETSDKFOLDER_OFFSET UNITYSDK_OFFSET(0x1C7C7850)
#define MIHOYO_SDK_TOOLS_SETTINGSDOCUMENT_GET_BROADCASTURL_OFFSET UNITYSDK_OFFSET(0x1C7C73E0)
#define MIHOYO_SDK_TOOLS_SETTINGSDOCUMENT_GET_SERIALIZEDFROMFILE_OFFSET UNITYSDK_OFFSET(0x1C7C7410)
#define MIHOYO_SDK_TOOLS_SETTINGSDOCUMENT_ISBROADCASTURL_OFFSET UNITYSDK_OFFSET(0x1C7C78D0)
#define MIHOYO_SDK_TOOLS_SETTINGSDOCUMENT_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C7C7550)
#define MIHOYO_SDK_TOOLS_SETTINGSDOCUMENT_SET_BROADCASTURL_OFFSET UNITYSDK_OFFSET(0x1C7C7400)
#define MIHOYO_SDK_TOOLS_SETTINGSDOCUMENT_STRINGCONTAINSANY_OFFSET UNITYSDK_OFFSET(0x1C7C7420)
#define MIHOYO_SDK_TOOLS_SETTINGSDOCUMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C7C7B20)
