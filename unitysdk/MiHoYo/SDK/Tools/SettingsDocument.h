...
#define MIHOYO_SDK_TOOLS_SETTINGSDOCUMENT_GETFEATURE_OFFSET UNITYSDK_OFFSET(0x18C4FF20)
#define MIHOYO_SDK_TOOLS_SETTINGSDOCUMENT_GETSDKFOLDER_OFFSET UNITYSDK_OFFSET(0x18C4FE60)
#define MIHOYO_SDK_TOOLS_SETTINGSDOCUMENT_GET_BROADCASTURL_OFFSET UNITYSDK_OFFSET(0x18C4F920)
#define MIHOYO_SDK_TOOLS_SETTINGSDOCUMENT_GET_SERIALIZEDFROMFILE_OFFSET UNITYSDK_OFFSET(0x18C4F950)
#define MIHOYO_SDK_TOOLS_SETTINGSDOCUMENT_ISBROADCASTURL_OFFSET UNITYSDK_OFFSET(0x18C4FEE0)
#define MIHOYO_SDK_TOOLS_SETTINGSDOCUMENT_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x18C4FA90)
#define MIHOYO_SDK_TOOLS_SETTINGSDOCUMENT_SET_BROADCASTURL_OFFSET UNITYSDK_OFFSET(0x18C4F940)
#define MIHOYO_SDK_TOOLS_SETTINGSDOCUMENT_STRINGCONTAINSANY_OFFSET UNITYSDK_OFFSET(0x18C4F960)
#define MIHOYO_SDK_TOOLS_SETTINGSDOCUMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18C50180)

namespace MiHoYo::SDK::Tools
{
	inline static constexpr unsigned int SettingsDocument_TypeDefinitionIndex = 29930;
