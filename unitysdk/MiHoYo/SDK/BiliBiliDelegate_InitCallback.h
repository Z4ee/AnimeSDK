...
#define MIHOYO_SDK_BILIBILIDELEGATE_INITCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C8D6150)
#define MIHOYO_SDK_BILIBILIDELEGATE_INITCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C8D61D0)
#define MIHOYO_SDK_BILIBILIDELEGATE_INITCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C8D5BD0)
#define MIHOYO_SDK_BILIBILIDELEGATE_INITCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C8D5BB0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int BiliBiliDelegate_InitCallback_TypeDefinitionIndex = 19703;
