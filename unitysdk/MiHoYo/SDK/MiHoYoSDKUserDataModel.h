...
#define MIHOYO_SDK_MIHOYOSDKUSERDATAMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1851BDB0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKUserDataModel_TypeDefinitionIndex = 44644;
