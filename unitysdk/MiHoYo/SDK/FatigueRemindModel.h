...
#define MIHOYO_SDK_FATIGUEREMINDMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1830DF60)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int FatigueRemindModel_TypeDefinitionIndex = 7819;
