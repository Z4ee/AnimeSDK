...
#define MIHOYO_SDK_REQUESTMANAGER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17637980)
#define MIHOYO_SDK_REQUESTMANAGER___C__DISPLAYCLASS13_0__LOGINBYACCOUNT_B__0_OFFSET UNITYSDK_OFFSET(0x1763EC30)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int RequestManager___c__DisplayClass13_0_TypeDefinitionIndex = 7102;
