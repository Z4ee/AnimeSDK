...
#define MIHOYO_SDK_APMC_LOGBACK_LOGATTACHMENTFILEMAPPING_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DCB4CD0)
#define MIHOYO_SDK_APMC_LOGBACK_LOGATTACHMENTFILEMAPPING_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DCB4D90)
#define MIHOYO_SDK_APMC_LOGBACK_LOGATTACHMENTFILEMAPPING_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DCB4930)
#define MIHOYO_SDK_APMC_LOGBACK_LOGATTACHMENTFILEMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCB4910)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int APMC_LOGBACK_LogAttachmentFileMapping_TypeDefinitionIndex = 37548;
