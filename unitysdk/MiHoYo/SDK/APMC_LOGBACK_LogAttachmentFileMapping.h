...
#define MIHOYO_SDK_APMC_LOGBACK_LOGATTACHMENTFILEMAPPING_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C82BB70)
#define MIHOYO_SDK_APMC_LOGBACK_LOGATTACHMENTFILEMAPPING_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C82BC30)
#define MIHOYO_SDK_APMC_LOGBACK_LOGATTACHMENTFILEMAPPING_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C82B780)
#define MIHOYO_SDK_APMC_LOGBACK_LOGATTACHMENTFILEMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x1C82B760)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int APMC_LOGBACK_LogAttachmentFileMapping_TypeDefinitionIndex = 36887;
