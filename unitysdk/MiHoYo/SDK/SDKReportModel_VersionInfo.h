...
#define MIHOYO_SDK_SDKREPORTMODEL_VERSIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17651500)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKReportModel_VersionInfo_TypeDefinitionIndex = 6982;
