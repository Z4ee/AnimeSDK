...
#define MIHOYO_SDK_SDKREPORTMODEL_VERSIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18425660)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKReportModel_VersionInfo_TypeDefinitionIndex = 7885;
