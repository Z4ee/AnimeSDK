...
#define MIHOYO_SDK_WEGAMEDELEGATE_REGISTERCALLBACKDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1602CB30)
#define MIHOYO_SDK_WEGAMEDELEGATE_REGISTERCALLBACKDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1602CB60)
#define MIHOYO_SDK_WEGAMEDELEGATE_REGISTERCALLBACKDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1602C890)
#define MIHOYO_SDK_WEGAMEDELEGATE_REGISTERCALLBACKDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1602C870)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WeGameDelegate_RegisterCallbackDelegate_TypeDefinitionIndex = 6706;
