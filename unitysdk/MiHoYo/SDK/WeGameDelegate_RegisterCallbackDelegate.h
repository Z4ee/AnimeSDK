...
#define MIHOYO_SDK_WEGAMEDELEGATE_REGISTERCALLBACKDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CFE2050)
#define MIHOYO_SDK_WEGAMEDELEGATE_REGISTERCALLBACKDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CFE2080)
#define MIHOYO_SDK_WEGAMEDELEGATE_REGISTERCALLBACKDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CFE1DC0)
#define MIHOYO_SDK_WEGAMEDELEGATE_REGISTERCALLBACKDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFE1DA0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WeGameDelegate_RegisterCallbackDelegate_TypeDefinitionIndex = 19812;
