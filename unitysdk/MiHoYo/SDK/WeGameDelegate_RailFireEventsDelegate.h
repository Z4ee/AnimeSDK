...
#define MIHOYO_SDK_WEGAMEDELEGATE_RAILFIREEVENTSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x194CE7B0)
#define MIHOYO_SDK_WEGAMEDELEGATE_RAILFIREEVENTSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x194CE7E0)
#define MIHOYO_SDK_WEGAMEDELEGATE_RAILFIREEVENTSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x194CE510)
#define MIHOYO_SDK_WEGAMEDELEGATE_RAILFIREEVENTSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x194CE500)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WeGameDelegate_RailFireEventsDelegate_TypeDefinitionIndex = 18578;
