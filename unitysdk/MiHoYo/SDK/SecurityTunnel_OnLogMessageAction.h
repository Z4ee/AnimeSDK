...
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGMESSAGEACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DCC44D0)
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGMESSAGEACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DCC4500)
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGMESSAGEACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DCC3DF0)
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGMESSAGEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCC44B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_OnLogMessageAction_TypeDefinitionIndex = 37451;
