...
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGMESSAGEACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C83B4F0)
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGMESSAGEACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C83B520)
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGMESSAGEACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C83AE40)
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGMESSAGEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C83B4D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_OnLogMessageAction_TypeDefinitionIndex = 36790;
