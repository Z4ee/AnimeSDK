...
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONWEBVIEWINPUTENABLESTATUS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A1EF490)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONWEBVIEWINPUTENABLESTATUS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A1EF510)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONWEBVIEWINPUTENABLESTATUS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A1EEB60)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONWEBVIEWINPUTENABLESTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1EF480)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKWebView_OnWebViewInputEnableStatus_TypeDefinitionIndex = 35371;
