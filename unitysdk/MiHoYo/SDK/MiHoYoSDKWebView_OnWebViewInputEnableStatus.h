...
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONWEBVIEWINPUTENABLESTATUS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D847010)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONWEBVIEWINPUTENABLESTATUS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D847090)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONWEBVIEWINPUTENABLESTATUS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D8466B0)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONWEBVIEWINPUTENABLESTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D846FF0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKWebView_OnWebViewInputEnableStatus_TypeDefinitionIndex = 37631;
