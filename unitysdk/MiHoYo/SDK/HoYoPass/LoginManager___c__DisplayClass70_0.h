...
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER___C__DISPLAYCLASS70_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5B9890)
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER___C__DISPLAYCLASS70_0__FORGOTPASSWORD_B__0_OFFSET UNITYSDK_OFFSET(0x1B5B98A0)
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER___C__DISPLAYCLASS70_0__FORGOTPASSWORD_B__1_OFFSET UNITYSDK_OFFSET(0x1B5B9D70)

namespace MiHoYo::SDK::HoYoPass
{
	inline static constexpr unsigned int LoginManager___c__DisplayClass70_0_TypeDefinitionIndex = 20097;
