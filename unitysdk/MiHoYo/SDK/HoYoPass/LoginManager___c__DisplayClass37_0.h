...
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER___C__DISPLAYCLASS37_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3FD770)
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER___C__DISPLAYCLASS37_0__ONHOYOPASSRISKCHALLENGE_B__0_OFFSET UNITYSDK_OFFSET(0x1A3FD780)
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER___C__DISPLAYCLASS37_0__ONHOYOPASSRISKCHALLENGE_B__2_OFFSET UNITYSDK_OFFSET(0x1A3FD7B0)

namespace MiHoYo::SDK::HoYoPass
{
	inline static constexpr unsigned int LoginManager___c__DisplayClass37_0_TypeDefinitionIndex = 19170;
