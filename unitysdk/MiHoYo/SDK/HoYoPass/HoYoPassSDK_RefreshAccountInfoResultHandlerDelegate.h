...
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_REFRESHACCOUNTINFORESULTHANDLERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C8EB970)
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_REFRESHACCOUNTINFORESULTHANDLERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C8EBA10)
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_REFRESHACCOUNTINFORESULTHANDLERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C8EB630)
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_REFRESHACCOUNTINFORESULTHANDLERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C8EB610)

namespace MiHoYo::SDK::HoYoPass
{
	inline static constexpr unsigned int HoYoPassSDK_RefreshAccountInfoResultHandlerDelegate_TypeDefinitionIndex = 20409;
