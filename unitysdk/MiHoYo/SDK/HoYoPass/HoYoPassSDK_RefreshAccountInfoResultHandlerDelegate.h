...
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_REFRESHACCOUNTINFORESULTHANDLERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B514810)
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_REFRESHACCOUNTINFORESULTHANDLERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B5148B0)
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_REFRESHACCOUNTINFORESULTHANDLERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B514480)
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_REFRESHACCOUNTINFORESULTHANDLERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B514460)

namespace MiHoYo::SDK::HoYoPass
{
	inline static constexpr unsigned int HoYoPassSDK_RefreshAccountInfoResultHandlerDelegate_TypeDefinitionIndex = 20061;
