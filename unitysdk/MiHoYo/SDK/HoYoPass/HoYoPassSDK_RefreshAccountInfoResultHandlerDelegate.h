...
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_REFRESHACCOUNTINFORESULTHANDLERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19B47B10)
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_REFRESHACCOUNTINFORESULTHANDLERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19B47BB0)
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_REFRESHACCOUNTINFORESULTHANDLERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19B47780)
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_REFRESHACCOUNTINFORESULTHANDLERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B47770)

namespace MiHoYo::SDK::HoYoPass
{
	inline static constexpr unsigned int HoYoPassSDK_RefreshAccountInfoResultHandlerDelegate_TypeDefinitionIndex = 19161;
