...
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER___C__DISPLAYCLASS43_1__CTOR_OFFSET UNITYSDK_OFFSET(0x181F3300)
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER___C__DISPLAYCLASS43_1__ONHOYOPASSCHANNELACCOUNTBINDING_B__3_OFFSET UNITYSDK_OFFSET(0x181F3310)

namespace MiHoYo::SDK::HoYoPass
{
	inline static constexpr unsigned int LoginManager___c__DisplayClass43_1_TypeDefinitionIndex = 8269;
