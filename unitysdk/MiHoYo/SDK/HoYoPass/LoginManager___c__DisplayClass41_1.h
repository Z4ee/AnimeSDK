...
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER___C__DISPLAYCLASS41_1__CTOR_OFFSET UNITYSDK_OFFSET(0x19C9B420)
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER___C__DISPLAYCLASS41_1__ONHOYOPASSVERIFICATION_B__1_OFFSET UNITYSDK_OFFSET(0x19C9B430)

namespace MiHoYo::SDK::HoYoPass
{
	inline static constexpr unsigned int LoginManager___c__DisplayClass41_1_TypeDefinitionIndex = 19178;

	class LoginManager___c__DisplayClass41_1 : public ::System::Object
	{
	public:
		::MiHoYo::SDK::JSONNode* verifyObj; // 0x10
		::MiHoYo::SDK::HoYoPass::LoginManager___c__DisplayClass41_0* CS___8__locals1; // 0x18
