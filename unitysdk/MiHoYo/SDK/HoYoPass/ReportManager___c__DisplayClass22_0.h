...
#define MIHOYO_SDK_HOYOPASS_REPORTMANAGER___C__DISPLAYCLASS22_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B975570)
#define MIHOYO_SDK_HOYOPASS_REPORTMANAGER___C__DISPLAYCLASS22_0__WARNING_B__0_OFFSET UNITYSDK_OFFSET(0x1B976280)

namespace MiHoYo::SDK::HoYoPass
{
	inline static constexpr unsigned int ReportManager___c__DisplayClass22_0_TypeDefinitionIndex = 8309;
