...
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER_HOYOPASSLOGINCALLBACKDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15F09C60)
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER_HOYOPASSLOGINCALLBACKDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15F09CD0)
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER_HOYOPASSLOGINCALLBACKDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15EFBDF0)
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER_HOYOPASSLOGINCALLBACKDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15F09C40)

namespace MiHoYo::SDK::HoYoPass
{
	inline static constexpr unsigned int LoginManager_HoYoPassLoginCallbackDelegate_TypeDefinitionIndex = 7289;
