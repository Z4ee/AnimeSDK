...
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_GETREGIONSWITCHSTATUSHANDLERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BDCB490)
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_GETREGIONSWITCHSTATUSHANDLERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BDCB4C0)
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_GETREGIONSWITCHSTATUSHANDLERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BDCB200)
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_GETREGIONSWITCHSTATUSHANDLERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDCB1E0)

namespace MiHoYo::SDK::HoYoPass
{
	inline static constexpr unsigned int HoYoPassSDK_GetRegionSwitchStatusHandlerDelegate_TypeDefinitionIndex = 20411;
