...
#define MIHOYO_SDK_HOYOPASS_AGEGATEREGIONPOLICY_GET_GETCONFIRMDIALOGTEXT_OFFSET UNITYSDK_OFFSET(0x181D1D90)
#define MIHOYO_SDK_HOYOPASS_AGEGATEREGIONPOLICY_GET_REGION_OFFSET UNITYSDK_OFFSET(0x181D1D80)
#define MIHOYO_SDK_HOYOPASS_AGEGATEREGIONPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x181D1DA0)
