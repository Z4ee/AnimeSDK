...
#define MIHOYO_SDK_HOYOPASS_AGEGATEREGIONPOLICY_GET_GETCONFIRMDIALOGTEXT_OFFSET UNITYSDK_OFFSET(0x1D4A92D0)
#define MIHOYO_SDK_HOYOPASS_AGEGATEREGIONPOLICY_GET_REGION_OFFSET UNITYSDK_OFFSET(0x1D4A92C0)
#define MIHOYO_SDK_HOYOPASS_AGEGATEREGIONPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4A92E0)

namespace MiHoYo::SDK::HoYoPass
{
	inline static constexpr unsigned int AgeGateRegionPolicy_TypeDefinitionIndex = 20380;
