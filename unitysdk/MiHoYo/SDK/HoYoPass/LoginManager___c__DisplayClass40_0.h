...
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER___C__DISPLAYCLASS40_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19C9AC20)
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER___C__DISPLAYCLASS40_0__ONHOYOPASSPROTECTIVEBAN_B__0_OFFSET UNITYSDK_OFFSET(0x19C9AC30)
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER___C__DISPLAYCLASS40_0__ONHOYOPASSPROTECTIVEBAN_B__1_OFFSET UNITYSDK_OFFSET(0x19C9AC60)

namespace MiHoYo::SDK::HoYoPass
{
	inline static constexpr unsigned int LoginManager___c__DisplayClass40_0_TypeDefinitionIndex = 19175;
