...
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER_CLOSEGEETESTV4WEBVIEW_OFFSET UNITYSDK_OFFSET(0x17557750)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER_CREATERISKCHECK_1_OFFSET UNITYSDK_OFFSET(0x17556F50)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER_CREATERISKCHECK_2_OFFSET UNITYSDK_OFFSET(0x17556B10)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER_CREATERISKCHECK_OFFSET UNITYSDK_OFFSET(0x1753D1C0)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER_ISGEETESTV4_OFFSET UNITYSDK_OFFSET(0x1753D130)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER_ONGETGEETESTRESULT_OFFSET UNITYSDK_OFFSET(0x17557150)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER_ONPAGERESULTCALLBACK_OFFSET UNITYSDK_OFFSET(0x175573A0)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER_ONWEBPAGECLOSE_OFFSET UNITYSDK_OFFSET(0x175578B0)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER_ONWEBPAGEERROR_OFFSET UNITYSDK_OFFSET(0x17557930)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x17557C30)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER__CREATERISKCHECK_B__8_0_OFFSET UNITYSDK_OFFSET(0x17557C80)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x17557C20)

namespace MiHoYo::SDK::HoYoPass
{
	inline static constexpr unsigned int RiskCheckManager_TypeDefinitionIndex = 7370;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::HoYoPass::RiskCheckManager**)Il2CppClass::FromTypeDefinitionIndex(RiskCheckManager_TypeDefinitionIndex)->GetStaticField(0x8C0);
		}
