...
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER_CLOSEGEETESTV4WEBVIEW_OFFSET UNITYSDK_OFFSET(0x1BF682D0)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER_CREATERISKCHECK_1_OFFSET UNITYSDK_OFFSET(0x1BF67B10)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER_CREATERISKCHECK_2_OFFSET UNITYSDK_OFFSET(0x1BF67750)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER_CREATERISKCHECK_OFFSET UNITYSDK_OFFSET(0x1BF67590)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER_ISGEETESTV4_OFFSET UNITYSDK_OFFSET(0x1BF67500)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER_ONGETGEETESTRESULT_OFFSET UNITYSDK_OFFSET(0x1BF67C50)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER_ONPAGERESULTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1BF67EA0)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER_ONWEBPAGECLOSE_OFFSET UNITYSDK_OFFSET(0x1BF683E0)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER_ONWEBPAGEERROR_OFFSET UNITYSDK_OFFSET(0x1BF68430)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BF68820)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER__CREATERISKCHECK_B__8_0_OFFSET UNITYSDK_OFFSET(0x1BF68870)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF68810)

namespace MiHoYo::SDK::HoYoPass
{
	inline static constexpr unsigned int RiskCheckManager_TypeDefinitionIndex = 20102;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::HoYoPass::RiskCheckManager**)Il2CppClass::FromTypeDefinitionIndex(RiskCheckManager_TypeDefinitionIndex)->GetStaticField(0xB260);
		}
		// static const ::System::String* MODULE_NAME; // 0x0
		// static const ::System::String* USE_V4; // 0x0
		::System::Action_1<::System::String*>* OnRiskCheckCompletes; // 0x10
		::System::Action* OnRiskCheckCanceled; // 0x18
