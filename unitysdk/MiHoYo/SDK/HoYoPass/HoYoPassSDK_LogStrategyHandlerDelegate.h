...
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_LOGSTRATEGYHANDLERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C38FB70)
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_LOGSTRATEGYHANDLERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C38FBE0)
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_LOGSTRATEGYHANDLERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C38F880)
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_LOGSTRATEGYHANDLERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C38F860)

namespace MiHoYo::SDK::HoYoPass
{
	inline static constexpr unsigned int HoYoPassSDK_LogStrategyHandlerDelegate_TypeDefinitionIndex = 20060;
