...
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_EVENTHANDLERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15EEACE0)
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_EVENTHANDLERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15EEADA0)
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_EVENTHANDLERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15EEA8D0)
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_EVENTHANDLERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15EEA8B0)

namespace MiHoYo::SDK::HoYoPass
{
	inline static constexpr unsigned int HoYoPassSDK_EventHandlerDelegate_TypeDefinitionIndex = 7282;
