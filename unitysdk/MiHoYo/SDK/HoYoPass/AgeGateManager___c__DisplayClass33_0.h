...
#define MIHOYO_SDK_HOYOPASS_AGEGATEMANAGER___C__DISPLAYCLASS33_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE7A0F0)
#define MIHOYO_SDK_HOYOPASS_AGEGATEMANAGER___C__DISPLAYCLASS33_0__SHOWAGEAPPEALCONFIRMDIALOG_B__0_OFFSET UNITYSDK_OFFSET(0x1AE7BC90)
#define MIHOYO_SDK_HOYOPASS_AGEGATEMANAGER___C__DISPLAYCLASS33_0__SHOWAGEAPPEALCONFIRMDIALOG_B__1_OFFSET UNITYSDK_OFFSET(0x1AE7BD00)
#define MIHOYO_SDK_HOYOPASS_AGEGATEMANAGER___C__DISPLAYCLASS33_0__SHOWAGEAPPEALCONFIRMDIALOG_B__2_OFFSET UNITYSDK_OFFSET(0x1AE7BEF0)
#define MIHOYO_SDK_HOYOPASS_AGEGATEMANAGER___C__DISPLAYCLASS33_0__SHOWAGEAPPEALCONFIRMDIALOG_B__3_OFFSET UNITYSDK_OFFSET(0x1AE7BE80)
