...
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER___C__DISPLAYCLASS44_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE9DC90)
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER___C__DISPLAYCLASS44_1__ONHOYOPASSREACTIVATE_B__1_OFFSET UNITYSDK_OFFSET(0x1CE9DCA0)
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER___C__DISPLAYCLASS44_1__ONHOYOPASSREACTIVATE_B__2_OFFSET UNITYSDK_OFFSET(0x1CE9DDD0)

namespace MiHoYo::SDK::HoYoPass
{
	inline static constexpr unsigned int LoginManager___c__DisplayClass44_1_TypeDefinitionIndex = 20428;
