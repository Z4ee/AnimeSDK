...
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER___C__DISPLAYCLASS62_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C7C17A0)
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER___C__DISPLAYCLASS62_0__STARTTHIRDPARTYOAUTH_B__0_OFFSET UNITYSDK_OFFSET(0x1C7C17B0)
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER___C__DISPLAYCLASS62_0__STARTTHIRDPARTYOAUTH_B__1_OFFSET UNITYSDK_OFFSET(0x1C7C1880)
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER___C__DISPLAYCLASS62_0__STARTTHIRDPARTYOAUTH_B__2_OFFSET UNITYSDK_OFFSET(0x1C7C19F0)

namespace MiHoYo::SDK::HoYoPass
{
	inline static constexpr unsigned int LoginManager___c__DisplayClass62_0_TypeDefinitionIndex = 20441;
