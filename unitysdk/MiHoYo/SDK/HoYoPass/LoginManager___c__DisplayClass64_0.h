...
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER___C__DISPLAYCLASS64_0__CTOR_OFFSET UNITYSDK_OFFSET(0x197DF7D0)
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER___C__DISPLAYCLASS64_0__FORGOTPASSWORD_B__0_OFFSET UNITYSDK_OFFSET(0x197DF7E0)
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER___C__DISPLAYCLASS64_0__FORGOTPASSWORD_B__1_OFFSET UNITYSDK_OFFSET(0x197DFCB0)

namespace MiHoYo::SDK::HoYoPass
{
	inline static constexpr unsigned int LoginManager___c__DisplayClass64_0_TypeDefinitionIndex = 19192;
