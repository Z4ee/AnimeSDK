...
#define MIHOYO_SDK_HOYOPASS_REPORTMANAGER___C__DISPLAYCLASS20_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEA4970)
#define MIHOYO_SDK_HOYOPASS_REPORTMANAGER___C__DISPLAYCLASS20_0__INFO_B__0_OFFSET UNITYSDK_OFFSET(0x1AEA56C0)

namespace MiHoYo::SDK::HoYoPass
{
	inline static constexpr unsigned int ReportManager___c__DisplayClass20_0_TypeDefinitionIndex = 8307;
