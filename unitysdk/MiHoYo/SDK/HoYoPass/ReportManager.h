...
#define MIHOYO_SDK_HOYOPASS_REPORTMANAGER_BUSINESSREPORT_OFFSET UNITYSDK_OFFSET(0x17553740)
#define MIHOYO_SDK_HOYOPASS_REPORTMANAGER_DEBUG_OFFSET UNITYSDK_OFFSET(0x175543F0)
#define MIHOYO_SDK_HOYOPASS_REPORTMANAGER_ERROR_OFFSET UNITYSDK_OFFSET(0x17529960)
#define MIHOYO_SDK_HOYOPASS_REPORTMANAGER_GETMINORLOGSTOREURL_OFFSET UNITYSDK_OFFSET(0x17553800)
#define MIHOYO_SDK_HOYOPASS_REPORTMANAGER_H5LOGREPORT_OFFSET UNITYSDK_OFFSET(0x17554570)
#define MIHOYO_SDK_HOYOPASS_REPORTMANAGER_INFO_OFFSET UNITYSDK_OFFSET(0x1752AA50)
#define MIHOYO_SDK_HOYOPASS_REPORTMANAGER_PARSEANDREPORT_OFFSET UNITYSDK_OFFSET(0x17554630)
#define MIHOYO_SDK_HOYOPASS_REPORTMANAGER_PREPBUSINESSREPORT_OFFSET UNITYSDK_OFFSET(0x17553E70)
#define MIHOYO_SDK_HOYOPASS_REPORTMANAGER_REPORTBYLEVEL_OFFSET UNITYSDK_OFFSET(0x17554B10)
#define MIHOYO_SDK_HOYOPASS_REPORTMANAGER_SETREPORTTARGET_OFFSET UNITYSDK_OFFSET(0x1752A420)
#define MIHOYO_SDK_HOYOPASS_REPORTMANAGER_VALIDATECONTENT_OFFSET UNITYSDK_OFFSET(0x17554140)
#define MIHOYO_SDK_HOYOPASS_REPORTMANAGER_WARNING_OFFSET UNITYSDK_OFFSET(0x17528330)
#define MIHOYO_SDK_HOYOPASS_REPORTMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x17554BC0)
#define MIHOYO_SDK_HOYOPASS_REPORTMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x17554BB0)
...
namespace MiHoYo::SDK::HoYoPass
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::HoYoPass::ReportManager**)Il2CppClass::FromTypeDefinitionIndex(ReportManager_TypeDefinitionIndex)->GetStaticField(0x18380);
		}
