...
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER___C__DISPLAYCLASS57_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1754FF60)
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER___C__DISPLAYCLASS57_1__STARTTHIRDPARTYOAUTH_B__3_OFFSET UNITYSDK_OFFSET(0x17550190)

namespace MiHoYo::SDK::HoYoPass
{
	inline static constexpr unsigned int LoginManager___c__DisplayClass57_1_TypeDefinitionIndex = 7363;

	class LoginManager___c__DisplayClass57_1 : public ::System::Object
	{
	public:
		::System::String* accessToken; // 0x10
		::MiHoYo::SDK::HoYoPass::LoginManager___c__DisplayClass57_0* CS___8__locals1; // 0x18
