...
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER_HOYOPASSEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17553640)
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER_HOYOPASSEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17553670)
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER_HOYOPASSEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1753B3D0)
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER_HOYOPASSEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x175362A0)

namespace MiHoYo::SDK::HoYoPass
{
	inline static constexpr unsigned int LoginManager_HoYoPassEventHandler_TypeDefinitionIndex = 7337;
