...
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER_HOYOPASSEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BB3BCB0)
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER_HOYOPASSEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BB3BCE0)
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER_HOYOPASSEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BB3B7B0)
#define MIHOYO_SDK_HOYOPASS_LOGINMANAGER_HOYOPASSEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB3B790)

namespace MiHoYo::SDK::HoYoPass
{
	inline static constexpr unsigned int LoginManager_HoYoPassEventHandler_TypeDefinitionIndex = 20065;
