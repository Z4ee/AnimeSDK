...
#define MIHOYO_SDK_PASSWORDINPUTIMEGUARD_ACQUIREIME_OFFSET UNITYSDK_OFFSET(0x1BA76BB0)
#define MIHOYO_SDK_PASSWORDINPUTIMEGUARD_AWAKE_OFFSET UNITYSDK_OFFSET(0x1BA76970)
#define MIHOYO_SDK_PASSWORDINPUTIMEGUARD_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1BA77110)
#define MIHOYO_SDK_PASSWORDINPUTIMEGUARD_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1BA76F70)
#define MIHOYO_SDK_PASSWORDINPUTIMEGUARD_RELEASEIME_OFFSET UNITYSDK_OFFSET(0x1BA76DD0)
#define MIHOYO_SDK_PASSWORDINPUTIMEGUARD_UPDATE_OFFSET UNITYSDK_OFFSET(0x1BA769E0)
#define MIHOYO_SDK_PASSWORDINPUTIMEGUARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA772B0)
