...
#define MIHOYO_SDK_MMTMANAGER___C__DISPLAYCLASS13_0__CREATEMMT_B__0_OFFSET UNITYSDK_OFFSET(0x1757FF20)
#define MIHOYO_SDK_MMTMANAGER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1757F860)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MmtManager___c__DisplayClass13_0_TypeDefinitionIndex = 7077;
