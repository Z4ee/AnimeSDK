...
#define MIHOYO_SDK_MIHOYOSDK___C__DISPLAYCLASS25_0__CTOR_OFFSET UNITYSDK_OFFSET(0x194814A0)
#define MIHOYO_SDK_MIHOYOSDK___C__DISPLAYCLASS25_0__REQUESTWATERMARKDATA_B__0_OFFSET UNITYSDK_OFFSET(0x19481C40)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDK___c__DisplayClass25_0_TypeDefinitionIndex = 46720;
