...
#define MIHOYO_SDK_KIBANAREPORTSENDER__HTTPREQUESTTIMER_D__13_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xB2143D0)
#define MIHOYO_SDK_KIBANAREPORTSENDER__HTTPREQUESTTIMER_D__13_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB214450)
#define MIHOYO_SDK_KIBANAREPORTSENDER__HTTPREQUESTTIMER_D__13_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB2144B0)
#define MIHOYO_SDK_KIBANAREPORTSENDER__HTTPREQUESTTIMER_D__13_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xB214460)
#define MIHOYO_SDK_KIBANAREPORTSENDER__HTTPREQUESTTIMER_D__13_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB2143C0)
#define MIHOYO_SDK_KIBANAREPORTSENDER__HTTPREQUESTTIMER_D__13__CTOR_OFFSET UNITYSDK_OFFSET(0xB212BB0)
