...
#define MIHOYO_SDK_PS4BINDMOBILECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1945D520)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PS4BindMobileConfig_TypeDefinitionIndex = 7878;
