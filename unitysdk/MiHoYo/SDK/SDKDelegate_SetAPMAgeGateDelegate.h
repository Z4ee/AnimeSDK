...
#define MIHOYO_SDK_SDKDELEGATE_SETAPMAGEGATEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184210B0)
#define MIHOYO_SDK_SDKDELEGATE_SETAPMAGEGATEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18421100)
#define MIHOYO_SDK_SDKDELEGATE_SETAPMAGEGATEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x184210A0)
#define MIHOYO_SDK_SDKDELEGATE_SETAPMAGEGATEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18421030)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_SetAPMAgeGateDelegate_TypeDefinitionIndex = 7757;
