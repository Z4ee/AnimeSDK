...
#define MIHOYO_SDK_CONSOLEDELEGATE_REPORTMATCHRESULTSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17519980)
#define MIHOYO_SDK_CONSOLEDELEGATE_REPORTMATCHRESULTSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x175199C0)
#define MIHOYO_SDK_CONSOLEDELEGATE_REPORTMATCHRESULTSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x17519400)
#define MIHOYO_SDK_CONSOLEDELEGATE_REPORTMATCHRESULTSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x175193E0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_ReportMatchResultsDelegate_TypeDefinitionIndex = 6710;
