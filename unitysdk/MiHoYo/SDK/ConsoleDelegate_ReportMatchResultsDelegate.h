...
#define MIHOYO_SDK_CONSOLEDELEGATE_REPORTMATCHRESULTSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B3244D0)
#define MIHOYO_SDK_CONSOLEDELEGATE_REPORTMATCHRESULTSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B324510)
#define MIHOYO_SDK_CONSOLEDELEGATE_REPORTMATCHRESULTSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B323F50)
#define MIHOYO_SDK_CONSOLEDELEGATE_REPORTMATCHRESULTSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B323F30)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_ReportMatchResultsDelegate_TypeDefinitionIndex = 19416;
