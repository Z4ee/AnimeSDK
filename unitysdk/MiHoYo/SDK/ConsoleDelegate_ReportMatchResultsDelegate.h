...
#define MIHOYO_SDK_CONSOLEDELEGATE_REPORTMATCHRESULTSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x197DE0F0)
#define MIHOYO_SDK_CONSOLEDELEGATE_REPORTMATCHRESULTSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x197DE130)
#define MIHOYO_SDK_CONSOLEDELEGATE_REPORTMATCHRESULTSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x197DDB70)
#define MIHOYO_SDK_CONSOLEDELEGATE_REPORTMATCHRESULTSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x197DDB60)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_ReportMatchResultsDelegate_TypeDefinitionIndex = 18532;
