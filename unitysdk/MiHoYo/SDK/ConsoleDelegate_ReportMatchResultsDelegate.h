...
#define MIHOYO_SDK_CONSOLEDELEGATE_REPORTMATCHRESULTSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15ED37A0)
#define MIHOYO_SDK_CONSOLEDELEGATE_REPORTMATCHRESULTSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15ED37E0)
#define MIHOYO_SDK_CONSOLEDELEGATE_REPORTMATCHRESULTSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15ED3220)
#define MIHOYO_SDK_CONSOLEDELEGATE_REPORTMATCHRESULTSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15ED3200)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_ReportMatchResultsDelegate_TypeDefinitionIndex = 6676;
