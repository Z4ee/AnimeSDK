...
#define MIHOYO_SDK_WEBDELEGATE_REGISTERJSPOSTMESSAGEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BB15CB0)
#define MIHOYO_SDK_WEBDELEGATE_REGISTERJSPOSTMESSAGEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BB15CF0)
#define MIHOYO_SDK_WEBDELEGATE_REGISTERJSPOSTMESSAGEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BB12C50)
#define MIHOYO_SDK_WEBDELEGATE_REGISTERJSPOSTMESSAGEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB15BC0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_RegisterJSPostMessageDelegate_TypeDefinitionIndex = 7809;
