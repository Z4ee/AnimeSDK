...
#define MIHOYO_SDK_WEBDELEGATE_REGISTERJSPOSTMESSAGEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x176A6600)
#define MIHOYO_SDK_WEBDELEGATE_REGISTERJSPOSTMESSAGEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x176A6640)
#define MIHOYO_SDK_WEBDELEGATE_REGISTERJSPOSTMESSAGEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x176A0970)
#define MIHOYO_SDK_WEBDELEGATE_REGISTERJSPOSTMESSAGEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176A65E0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_RegisterJSPostMessageDelegate_TypeDefinitionIndex = 6899;
