...
#define MIHOYO_SDK_GOOGLEPLAYABTESTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C38F4B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int GooglePlayAbTestConfig_TypeDefinitionIndex = 19663;
