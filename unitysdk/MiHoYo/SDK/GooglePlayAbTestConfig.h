...
#define MIHOYO_SDK_GOOGLEPLAYABTESTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x181CA5B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int GooglePlayAbTestConfig_TypeDefinitionIndex = 7854;
