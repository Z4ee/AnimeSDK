...
#define MIHOYO_SDK_CONSOLEDELEGATE_ENDFREECOMMUNICATIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D3AF220)
#define MIHOYO_SDK_CONSOLEDELEGATE_ENDFREECOMMUNICATIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D3AF250)
#define MIHOYO_SDK_CONSOLEDELEGATE_ENDFREECOMMUNICATIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D3AEF90)
#define MIHOYO_SDK_CONSOLEDELEGATE_ENDFREECOMMUNICATIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3AEF70)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_EndFreeCommunicationDelegate_TypeDefinitionIndex = 19793;
