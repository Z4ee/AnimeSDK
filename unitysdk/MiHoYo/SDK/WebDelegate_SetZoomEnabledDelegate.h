...
#define MIHOYO_SDK_WEBDELEGATE_SETZOOMENABLEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16043020)
#define MIHOYO_SDK_WEBDELEGATE_SETZOOMENABLEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16043080)
#define MIHOYO_SDK_WEBDELEGATE_SETZOOMENABLEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x16032D50)
#define MIHOYO_SDK_WEBDELEGATE_SETZOOMENABLEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16043000)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetZoomEnabledDelegate_TypeDefinitionIndex = 6830;
