...
#define MIHOYO_SDK_UGCNETWORK_RESPONSEMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D849C50)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int UGCNetwork_ResponseModel_TypeDefinitionIndex = 37499;
