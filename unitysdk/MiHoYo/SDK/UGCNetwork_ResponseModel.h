...
#define MIHOYO_SDK_UGCNETWORK_RESPONSEMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B73E870)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int UGCNetwork_ResponseModel_TypeDefinitionIndex = 44725;
