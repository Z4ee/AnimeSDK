...
#define MIHOYO_SDK_UGCNETWORK_RESPONSEMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x85A6B20)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int UGCNetwork_ResponseModel_TypeDefinitionIndex = 37215;
