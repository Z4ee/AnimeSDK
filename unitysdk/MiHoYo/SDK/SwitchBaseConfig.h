...
#define MIHOYO_SDK_SWITCHBASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x15FFD420)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SwitchBaseConfig_TypeDefinitionIndex = 6925;
