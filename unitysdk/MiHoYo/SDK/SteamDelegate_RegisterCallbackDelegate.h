...
#define MIHOYO_SDK_STEAMDELEGATE_REGISTERCALLBACKDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15FFD070)
#define MIHOYO_SDK_STEAMDELEGATE_REGISTERCALLBACKDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15FFD0A0)
#define MIHOYO_SDK_STEAMDELEGATE_REGISTERCALLBACKDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15FFCDD0)
#define MIHOYO_SDK_STEAMDELEGATE_REGISTERCALLBACKDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15FFCDB0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SteamDelegate_RegisterCallbackDelegate_TypeDefinitionIndex = 6691;
