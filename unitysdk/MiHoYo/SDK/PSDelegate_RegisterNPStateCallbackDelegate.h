...
#define MIHOYO_SDK_PSDELEGATE_REGISTERNPSTATECALLBACKDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BE5E3F0)
#define MIHOYO_SDK_PSDELEGATE_REGISTERNPSTATECALLBACKDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BE5E420)
#define MIHOYO_SDK_PSDELEGATE_REGISTERNPSTATECALLBACKDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BE5DEB0)
#define MIHOYO_SDK_PSDELEGATE_REGISTERNPSTATECALLBACKDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE5DE90)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_RegisterNPStateCallbackDelegate_TypeDefinitionIndex = 19530;
