...
#define MIHOYO_SDK_PSDELEGATE_REGISTERNPSTATECALLBACKDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15F9A830)
#define MIHOYO_SDK_PSDELEGATE_REGISTERNPSTATECALLBACKDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15F9A860)
#define MIHOYO_SDK_PSDELEGATE_REGISTERNPSTATECALLBACKDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15F9A2D0)
#define MIHOYO_SDK_PSDELEGATE_REGISTERNPSTATECALLBACKDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15F9A2B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_RegisterNPStateCallbackDelegate_TypeDefinitionIndex = 6771;
