...
#define MIHOYO_SDK_PSDELEGATE_REGISTERNPSTATECALLBACKDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D1CFA30)
#define MIHOYO_SDK_PSDELEGATE_REGISTERNPSTATECALLBACKDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D1CFA60)
#define MIHOYO_SDK_PSDELEGATE_REGISTERNPSTATECALLBACKDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D1CF510)
#define MIHOYO_SDK_PSDELEGATE_REGISTERNPSTATECALLBACKDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1CF4F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_RegisterNPStateCallbackDelegate_TypeDefinitionIndex = 19877;
