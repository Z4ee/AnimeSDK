...
#define MIHOYO_SDK_NETWORKMANAGER__POST_D__19_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x18377DD0)
#define MIHOYO_SDK_NETWORKMANAGER__POST_D__19_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18377E90)
#define MIHOYO_SDK_NETWORKMANAGER__POST_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18377EF0)
#define MIHOYO_SDK_NETWORKMANAGER__POST_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x18377EA0)
#define MIHOYO_SDK_NETWORKMANAGER__POST_D__19_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18377DC0)
#define MIHOYO_SDK_NETWORKMANAGER__POST_D__19__CTOR_OFFSET UNITYSDK_OFFSET(0x18372390)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int NetworkManager__Post_d__19_TypeDefinitionIndex = 8086;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + MIHOYO_SDK_NETWORKMANAGER__POST_D__19__CTOR_OFFSET))(this, a1);
		}
