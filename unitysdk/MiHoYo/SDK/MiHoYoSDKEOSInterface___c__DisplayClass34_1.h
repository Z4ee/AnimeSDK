...
#define MIHOYO_SDK_MIHOYOSDKEOSINTERFACE___C__DISPLAYCLASS34_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1D285960)
#define MIHOYO_SDK_MIHOYOSDKEOSINTERFACE___C__DISPLAYCLASS34_1__PAY_B__1_OFFSET UNITYSDK_OFFSET(0x1D285970)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKEOSInterface___c__DisplayClass34_1_TypeDefinitionIndex = 36696;

	class MiHoYoSDKEOSInterface___c__DisplayClass34_1 : public ::System::Object
	{
	public:
		::MiHoYo::SDK::MiHoYoSDKEOSInterface___c__DisplayClass34_0* CS___8__locals1; // 0x10
