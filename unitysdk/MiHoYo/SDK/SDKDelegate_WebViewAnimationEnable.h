...
#define MIHOYO_SDK_SDKDELEGATE_WEBVIEWANIMATIONENABLE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18421530)
#define MIHOYO_SDK_SDKDELEGATE_WEBVIEWANIMATIONENABLE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18421580)
#define MIHOYO_SDK_SDKDELEGATE_WEBVIEWANIMATIONENABLE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18421520)
#define MIHOYO_SDK_SDKDELEGATE_WEBVIEWANIMATIONENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x184214B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_WebViewAnimationEnable_TypeDefinitionIndex = 7752;
