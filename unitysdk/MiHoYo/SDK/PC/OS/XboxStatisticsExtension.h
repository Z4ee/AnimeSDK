...
#define MIHOYO_SDK_PC_OS_XBOXSTATISTICSEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA38F40)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int XboxStatisticsExtension_TypeDefinitionIndex = 8620;
