...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELGOOGLEPLAY___C__DISPLAYCLASS11_1__CTOR_OFFSET UNITYSDK_OFFSET(0x175ABB50)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELGOOGLEPLAY___C__DISPLAYCLASS11_1__PAY_B__2_OFFSET UNITYSDK_OFFSET(0x175ABEA0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELGOOGLEPLAY___C__DISPLAYCLASS11_1__PAY_B__3_OFFSET UNITYSDK_OFFSET(0x175ABFD0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELGOOGLEPLAY___C__DISPLAYCLASS11_1__PAY_B__5_OFFSET UNITYSDK_OFFSET(0x175ABE60)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelGooglePlay___c__DisplayClass11_1_TypeDefinitionIndex = 7533;
