...
#define MIHOYO_SDK_PC_OS_XBOXCHECKOUTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABE1170)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int XboxCheckoutParam_TypeDefinitionIndex = 8597;
