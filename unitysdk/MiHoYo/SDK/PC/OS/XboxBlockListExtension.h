...
#define MIHOYO_SDK_PC_OS_XBOXBLOCKLISTEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABE1140)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int XboxBlockListExtension_TypeDefinitionIndex = 8607;
