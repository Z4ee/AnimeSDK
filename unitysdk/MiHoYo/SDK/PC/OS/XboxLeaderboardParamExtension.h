...
#define MIHOYO_SDK_PC_OS_XBOXLEADERBOARDPARAMEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABE11D0)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int XboxLeaderboardParamExtension_TypeDefinitionIndex = 8612;
