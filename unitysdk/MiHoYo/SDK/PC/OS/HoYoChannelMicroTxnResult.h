...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELMICROTXNRESULT_FROMJSON_OFFSET UNITYSDK_OFFSET(0x197E7540)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELMICROTXNRESULT_TOJSON_OFFSET UNITYSDK_OFFSET(0x197E7530)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELMICROTXNRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x197E7580)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelMicroTxnResult_TypeDefinitionIndex = 19396;
