...
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B524C40)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1B524C80)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER___C__HANDLEAGEGATEFROMERRORCODE_B__8_0_OFFSET UNITYSDK_OFFSET(0x1B524C90)

namespace MiHoYo::SDK::PC::OS::CXHandheld
{
	inline static constexpr unsigned int AgeGateManager___c_TypeDefinitionIndex = 20469;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PC::OS::CXHandheld::AgeGateManager___c**)Il2CppClass::FromTypeDefinitionIndex(AgeGateManager___c_TypeDefinitionIndex)->GetStaticField(0xB540);
		}
		static ::System::Action_1<::MiHoYo::SDK::UI::OS::IAgeGateGeneralErrorDialog*>** StaticGet___9__8_0()
		{
			return (::System::Action_1<::MiHoYo::SDK::UI::OS::IAgeGateGeneralErrorDialog*>**)Il2CppClass::FromTypeDefinitionIndex(AgeGateManager___c_TypeDefinitionIndex)->GetStaticField(0xB548);
		}
