...
#define MIHOYO_SDK_PC_OS_CXHANDHELD_BINDMANAGERBASE___C__DISPLAYCLASS19_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9DBCA0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_BINDMANAGERBASE___C__DISPLAYCLASS19_1__SHOWEMAILBINDINGDIALOG_B__7_OFFSET UNITYSDK_OFFSET(0x1B9DBCB0)

namespace MiHoYo::SDK::PC::OS::CXHandheld
{
	inline static constexpr unsigned int BindManagerBase___c__DisplayClass19_1_TypeDefinitionIndex = 20481;
