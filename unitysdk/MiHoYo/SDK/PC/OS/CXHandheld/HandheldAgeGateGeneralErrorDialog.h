...
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDAGEGATEGENERALERRORDIALOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B9DA0E0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDAGEGATEGENERALERRORDIALOG_GET_INTERACTABLE_OFFSET UNITYSDK_OFFSET(0x1B9DA0C0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDAGEGATEGENERALERRORDIALOG_GET_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x1B9DA080)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDAGEGATEGENERALERRORDIALOG_GET_ONCONFIRM_OFFSET UNITYSDK_OFFSET(0x1B9DA0A0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDAGEGATEGENERALERRORDIALOG_HIDEDIALOG_OFFSET UNITYSDK_OFFSET(0x1B9DAA30)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDAGEGATEGENERALERRORDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x1B9DA9A0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDAGEGATEGENERALERRORDIALOG_ONCLOSEDIALOG_OFFSET UNITYSDK_OFFSET(0x1B9DAAD0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDAGEGATEGENERALERRORDIALOG_ONCONFIRMDIALOG_OFFSET UNITYSDK_OFFSET(0x1B9DAB80)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDAGEGATEGENERALERRORDIALOG_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B9DA520)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDAGEGATEGENERALERRORDIALOG_SETDIALOGMESSAGE_OFFSET UNITYSDK_OFFSET(0x1B9DA560)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDAGEGATEGENERALERRORDIALOG_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x1B9DABA0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDAGEGATEGENERALERRORDIALOG_SET_INTERACTABLE_OFFSET UNITYSDK_OFFSET(0x1B9DA0D0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDAGEGATEGENERALERRORDIALOG_SET_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x1B9DA090)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDAGEGATEGENERALERRORDIALOG_SET_ONCONFIRM_OFFSET UNITYSDK_OFFSET(0x1B9DA0B0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDAGEGATEGENERALERRORDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x1B9DA870)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDAGEGATEGENERALERRORDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9DABB0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDAGEGATEGENERALERRORDIALOG__ONCLOSEDIALOG_G__ONCLOSEPRESSEDROUTINE_31_0_OFFSET UNITYSDK_OFFSET(0x1B9DAB30)
...
namespace MiHoYo::SDK::PC::OS::CXHandheld
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PC::OS::CXHandheld::HandheldAgeGateGeneralErrorDialog**)Il2CppClass::FromTypeDefinitionIndex(HandheldAgeGateGeneralErrorDialog_TypeDefinitionIndex)->GetStaticField(0x19DC0);
		}
