...
#define MIHOYO_SDK_PC_OS_CXHANDHELD_LOGINMANAGERHANDHELD___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A258000)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_LOGINMANAGERHANDHELD___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1A258040)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_LOGINMANAGERHANDHELD___C__OPENUSERCENTER_G__CALLBACK_25_2_OFFSET UNITYSDK_OFFSET(0x1A258050)
...
namespace MiHoYo::SDK::PC::OS::CXHandheld
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PC::OS::CXHandheld::LoginManagerHandheld___c**)Il2CppClass::FromTypeDefinitionIndex(LoginManagerHandheld___c_TypeDefinitionIndex)->GetStaticField(0x1A7F0);
		}
