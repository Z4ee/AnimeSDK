...
#define MIHOYO_SDK_PC_OS_CXHANDHELD_LOGINMANAGERCXHANDHELD_GENERATEACCESSTOKEN_OFFSET UNITYSDK_OFFSET(0x1C902120)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_LOGINMANAGERCXHANDHELD_GETPROTOCOLCHANNEL_OFFSET UNITYSDK_OFFSET(0x1C900C70)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_LOGINMANAGERCXHANDHELD_GETUSERUNIQUEID_OFFSET UNITYSDK_OFFSET(0x1C9020A0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_LOGINMANAGERCXHANDHELD_ISBINDINGACCOUNTSWITCHON_OFFSET UNITYSDK_OFFSET(0x1C9024A0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_LOGINMANAGERCXHANDHELD_LOGREPORT_OFFSET UNITYSDK_OFFSET(0x1C902530)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_LOGINMANAGERCXHANDHELD_ONHANDHELDLOGINCALLBACK_OFFSET UNITYSDK_OFFSET(0x1C900C80)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_LOGINMANAGERCXHANDHELD_OPENURL_OFFSET UNITYSDK_OFFSET(0x1C9022A0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_LOGINMANAGERCXHANDHELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1C900BC0)

namespace MiHoYo::SDK::PC::OS::CXHandheld
{
	inline static constexpr unsigned int LoginManagerCXHandheld_TypeDefinitionIndex = 20851;
