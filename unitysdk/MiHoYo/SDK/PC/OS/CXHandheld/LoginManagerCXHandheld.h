...
#define MIHOYO_SDK_PC_OS_CXHANDHELD_LOGINMANAGERCXHANDHELD_GENERATEACCESSTOKEN_OFFSET UNITYSDK_OFFSET(0x1A2508B0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_LOGINMANAGERCXHANDHELD_GETPROTOCOLCHANNEL_OFFSET UNITYSDK_OFFSET(0x1A24EAC0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_LOGINMANAGERCXHANDHELD_GETUSERUNIQUEID_OFFSET UNITYSDK_OFFSET(0x1A251E10)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_LOGINMANAGERCXHANDHELD_ISBINDINGACCOUNTSWITCHON_OFFSET UNITYSDK_OFFSET(0x1A2501A0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_LOGINMANAGERCXHANDHELD_LOGREPORT_OFFSET UNITYSDK_OFFSET(0x1A255340)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_LOGINMANAGERCXHANDHELD_ONHANDHELDLOGINCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A2528A0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_LOGINMANAGERCXHANDHELD_OPENURL_OFFSET UNITYSDK_OFFSET(0x1A24EAD0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_LOGINMANAGERCXHANDHELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1A24E040)
