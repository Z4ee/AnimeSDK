...
#define MIHOYO_SDK_PC_OS_CXHANDHELD_BINDMANAGERCXHANDHELD_GENERATEACCESSTOKEN_OFFSET UNITYSDK_OFFSET(0x1C963780)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_BINDMANAGERCXHANDHELD_GETBINDINGWEBURL_OFFSET UNITYSDK_OFFSET(0x1C963CA0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_BINDMANAGERCXHANDHELD_PERFORMBINDINGFLOW_OFFSET UNITYSDK_OFFSET(0x1C963900)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_BINDMANAGERCXHANDHELD_REACTIVATEACCOUNT_OFFSET UNITYSDK_OFFSET(0x1C964100)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_BINDMANAGERCXHANDHELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1C963640)

namespace MiHoYo::SDK::PC::OS::CXHandheld
{
	inline static constexpr unsigned int BindManagerCXHandheld_TypeDefinitionIndex = 20487;
