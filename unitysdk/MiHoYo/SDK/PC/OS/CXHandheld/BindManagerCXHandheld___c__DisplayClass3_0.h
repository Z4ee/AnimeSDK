...
#define MIHOYO_SDK_PC_OS_CXHANDHELD_BINDMANAGERCXHANDHELD___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C573510)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_BINDMANAGERCXHANDHELD___C__DISPLAYCLASS3_0__PERFORMBINDINGFLOW_B__0_OFFSET UNITYSDK_OFFSET(0x1C573520)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_BINDMANAGERCXHANDHELD___C__DISPLAYCLASS3_0__PERFORMBINDINGFLOW_B__1_OFFSET UNITYSDK_OFFSET(0x1C5739D0)

namespace MiHoYo::SDK::PC::OS::CXHandheld
{
	inline static constexpr unsigned int BindManagerCXHandheld___c__DisplayClass3_0_TypeDefinitionIndex = 20489;
	...
	public:
		...
		::MiHoYo::SDK::PC::OS::CXHandheld::BindManagerCXHandheld* __4__this; // 0x18
