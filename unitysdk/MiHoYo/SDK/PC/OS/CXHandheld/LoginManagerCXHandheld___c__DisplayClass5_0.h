...
#define MIHOYO_SDK_PC_OS_CXHANDHELD_LOGINMANAGERCXHANDHELD___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A254460)
...
namespace MiHoYo::SDK::PC::OS::CXHandheld
{
	...
	public:
		...
		::MiHoYo::SDK::PC::OS::CXHandheld::LoginManagerCXHandheld* __4__this; // 0x18
