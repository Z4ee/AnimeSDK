...
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDWELCOMEDIALOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B5C07C0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDWELCOMEDIALOG_BINDEXISTINGACCOUNT_OFFSET UNITYSDK_OFFSET(0x1B5C1B60)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDWELCOMEDIALOG_CANCELDIALOG_OFFSET UNITYSDK_OFFSET(0x1B5C1B90)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDWELCOMEDIALOG_CONFIRMDIALOG_OFFSET UNITYSDK_OFFSET(0x1B5C1BF0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDWELCOMEDIALOG_CREATEANDBINDNEWACCOUNT_OFFSET UNITYSDK_OFFSET(0x1B5C1B80)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDWELCOMEDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x1B5C0750)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDWELCOMEDIALOG_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B5C16C0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDWELCOMEDIALOG_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B5C1690)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDWELCOMEDIALOG_SHOWBINDMODESELECTION_OFFSET UNITYSDK_OFFSET(0x1B5C1390)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDWELCOMEDIALOG_SHOWNEWACCOUNTPROMPT_OFFSET UNITYSDK_OFFSET(0x1B5C16E0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDWELCOMEDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x1B5C0620)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDWELCOMEDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C1C10)

namespace MiHoYo::SDK::PC::OS::CXHandheld
{
	inline static constexpr unsigned int HandheldWelcomeDialog_TypeDefinitionIndex = 20568;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PC::OS::CXHandheld::HandheldWelcomeDialog**)Il2CppClass::FromTypeDefinitionIndex(HandheldWelcomeDialog_TypeDefinitionIndex)->GetStaticField(0xA1C0);
		}
