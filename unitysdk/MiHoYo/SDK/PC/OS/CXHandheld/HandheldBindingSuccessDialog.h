...
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDBINDINGSUCCESSDIALOG_AUTOCLOSECOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1B9E85E0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDBINDINGSUCCESSDIALOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B9E7D20)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDBINDINGSUCCESSDIALOG_CONFIRMDIALOG_OFFSET UNITYSDK_OFFSET(0x1B9E8650)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDBINDINGSUCCESSDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x1B9E7C80)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDBINDINGSUCCESSDIALOG_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B9E8630)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDBINDINGSUCCESSDIALOG_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x1B9E7CF0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDBINDINGSUCCESSDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x1B9E7B70)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDBINDINGSUCCESSDIALOG_UPDATECOUNTDOWNTIPS_OFFSET UNITYSDK_OFFSET(0x1B9E8350)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDBINDINGSUCCESSDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E87A0)
...
namespace MiHoYo::SDK::PC::OS::CXHandheld
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PC::OS::CXHandheld::HandheldBindingSuccessDialog**)Il2CppClass::FromTypeDefinitionIndex(HandheldBindingSuccessDialog_TypeDefinitionIndex)->GetStaticField(0x1A360);
		}
