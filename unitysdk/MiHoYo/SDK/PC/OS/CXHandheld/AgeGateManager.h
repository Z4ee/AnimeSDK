...
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_BUILDAGEAPPEALURL_OFFSET UNITYSDK_OFFSET(0x1A65B4C0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_CALCULATEDAYSFROMEXPIREDTIME_OFFSET UNITYSDK_OFFSET(0x1A65DA50)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_CHECKAGEGATEAGE_OFFSET UNITYSDK_OFFSET(0x1A65E660)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_CHECKREGIONCANAUTOREGISTER_OFFSET UNITYSDK_OFFSET(0x1A659D00)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_CONTINUEAGEGATE_OFFSET UNITYSDK_OFFSET(0x1A65B8D0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_CREATEPARENTALCONSENTDIALOG_OFFSET UNITYSDK_OFFSET(0x1A65DC80)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_ENDAGEGATE_OFFSET UNITYSDK_OFFSET(0x1A65B9B0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_EXTRACTAGEGATEPAYLOADFROMHEADERS_OFFSET UNITYSDK_OFFSET(0x1A659D10)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_GET_AGEGATEREPORTTYPE_OFFSET UNITYSDK_OFFSET(0x1A659CA0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1A65A800)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_GET_RSAKEY_OFFSET UNITYSDK_OFFSET(0x1A65ADA0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_HANDLEAGEGATEFROMERRORCODE_OFFSET UNITYSDK_OFFSET(0x1A65A160)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_HANDLEAGEGATETICKETRECEIVEDERROR_OFFSET UNITYSDK_OFFSET(0x1A65D810)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_LOGAGEGATE_OFFSET UNITYSDK_OFFSET(0x1A65AE50)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_ONAGEGATEERRORDIALOG_1_OFFSET UNITYSDK_OFFSET(0x1A65DFC0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_ONAGEGATEERRORDIALOG_OFFSET UNITYSDK_OFFSET(0x1A65DE30)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_ONAGEGATEPARENTALCONSENTCLOSED_OFFSET UNITYSDK_OFFSET(0x1A65FDF0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_ONAGEGATEPARENTALCONSENTREQUIREDCLOSED_OFFSET UNITYSDK_OFFSET(0x1A65FB80)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_ONAGEGATETICKETRECEIVEDSUCCESS_OFFSET UNITYSDK_OFFSET(0x1A65BA60)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_ONBIRTHDAYINPUTCLOSED_OFFSET UNITYSDK_OFFSET(0x1A65E150)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_ONBIRTHDAYINPUTNEXTBUTTONPRESSED_OFFSET UNITYSDK_OFFSET(0x1A65E2D0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_ONINPUTCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1A65EDE0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_ONPARENTALCONSENTINPUTEMAILBUTTONPRESSED_OFFSET UNITYSDK_OFFSET(0x1A65EDF0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_ONPARENTALCONSENTPROCESSCLOSED_OFFSET UNITYSDK_OFFSET(0x1A65ECC0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_ONRESENDEMAILCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1A65F630)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_ONRESENDEMAIL_OFFSET UNITYSDK_OFFSET(0x1A65F370)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_ONSHOWPARENTALCONTROLPROCESSBUTTONPRESSED_OFFSET UNITYSDK_OFFSET(0x1A65F170)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_OPENAGEAPPEALWEB_OFFSET UNITYSDK_OFFSET(0x1A65B810)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_PROCESSAGEGATETICKET_OFFSET UNITYSDK_OFFSET(0x1A65C4A0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_REPORTAGEGATEAGEAPPEAL_OFFSET UNITYSDK_OFFSET(0x1A65B360)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_REPORTAGEGATEPARENTALPROCESS_1_OFFSET UNITYSDK_OFFSET(0x1A65B200)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_REPORTAGEGATEPARENTALPROCESS_OFFSET UNITYSDK_OFFSET(0x1A65B0C0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_REPORTAGEGATE_1_OFFSET UNITYSDK_OFFSET(0x1A65AAC0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_REPORTAGEGATE_OFFSET UNITYSDK_OFFSET(0x1A65A900)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER_STARTAGEGATE_OFFSET UNITYSDK_OFFSET(0x1A65AC20)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A660060)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER__CONTINUEAGEGATE_B__27_0_OFFSET UNITYSDK_OFFSET(0x1A660160)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A65B4A0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER__PROCESSAGEGATETICKET_B__31_0_OFFSET UNITYSDK_OFFSET(0x1A660230)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER__PROCESSAGEGATETICKET_B__31_1_OFFSET UNITYSDK_OFFSET(0x1A660360)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER__PROCESSAGEGATETICKET_B__31_4_OFFSET UNITYSDK_OFFSET(0x1A660630)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_AGEGATEMANAGER__STARTAGEGATE_B__26_0_OFFSET UNITYSDK_OFFSET(0x1A660090)
...
namespace MiHoYo::SDK::PC::OS::CXHandheld
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PC::OS::CXHandheld::AgeGateManager**)Il2CppClass::FromTypeDefinitionIndex(AgeGateManager_TypeDefinitionIndex)->GetStaticField(0x187F0);
		}
		static ::System::String** StaticGet_extractedPayload()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(AgeGateManager_TypeDefinitionIndex)->GetStaticField(0x187F8);
		}
		static ::System::String** StaticGet_extractedAgeGateType()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(AgeGateManager_TypeDefinitionIndex)->GetStaticField(0x18800);
		}
