...
#define MIHOYO_SDK_PC_OS_CXHANDHELD_BINDMANAGERHANDHELD_BINDEMAIL_OFFSET UNITYSDK_OFFSET(0x1B9D5280)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_BINDMANAGERHANDHELD_GETCAPTCHACODE_OFFSET UNITYSDK_OFFSET(0x1B9D3120)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_BINDMANAGERHANDHELD_GET_RSAKEY_OFFSET UNITYSDK_OFFSET(0x1B9D5830)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_BINDMANAGERHANDHELD_QUERYWEBBINDINGRESULT_OFFSET UNITYSDK_OFFSET(0x1B9D59C0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_BINDMANAGERHANDHELD_REPORTBINDFAIL_OFFSET UNITYSDK_OFFSET(0x1B9D53C0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_BINDMANAGERHANDHELD_REQUESTACTIONTICKET_OFFSET UNITYSDK_OFFSET(0x1B9D58E0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_BINDMANAGERHANDHELD_REQUESTBINDTHIRDPARTY_OFFSET UNITYSDK_OFFSET(0x1B9D5C80)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_BINDMANAGERHANDHELD_REQUESTGETACTIONTICKETINFO_OFFSET UNITYSDK_OFFSET(0x1B9D5A60)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_BINDMANAGERHANDHELD_REQUESTLOGINBYACTIONTICKET_OFFSET UNITYSDK_OFFSET(0x1B9D5690)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_BINDMANAGERHANDHELD_REQUESTREACTIVATEACCOUNT_OFFSET UNITYSDK_OFFSET(0x1B9D44D0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_BINDMANAGERHANDHELD_REQUESTVERIFYCAPTCHA_OFFSET UNITYSDK_OFFSET(0x1B9D3F10)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_BINDMANAGERHANDHELD_UPDATEQRCODE_OFFSET UNITYSDK_OFFSET(0x1B9D1AA0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_BINDMANAGERHANDHELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9D3B60)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_BINDMANAGERHANDHELD__QUERYWEBBINDINGRESULT_B__17_0_OFFSET UNITYSDK_OFFSET(0x1B9D61B0)
#define MIHOYO_SDK_PC_OS_CXHANDHELD_BINDMANAGERHANDHELD__UPDATEQRCODE_B__16_0_OFFSET UNITYSDK_OFFSET(0x1B9D5EA0)
...
namespace MiHoYo::SDK::PC::OS::CXHandheld
{
	...
	public:
		...
		::System::String* ConsoleAccountName; // 0x80
		::System::String* UserEmail; // 0x88
