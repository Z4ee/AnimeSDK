...
namespace MiHoYo::SDK::PC::OS::CXHandheld
{
	...
	struct alignas(8) HandheldAgeGateVerificationDialog_DropDownInteraction
	{
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean))((::PBYTE)hIl2Cpp + MIHOYO_SDK_PC_OS_CXHANDHELD_HANDHELDAGEGATEVERIFICATIONDIALOG_DROPDOWNINTERACTION__CTOR_OFFSET))(this, isInteracted);
		}
	};
}
