...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_REGISTERAUTHSTATUSCHANGEDCALLBACKDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CFD4E70)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_REGISTERAUTHSTATUSCHANGEDCALLBACKDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CFD4EA0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_REGISTERAUTHSTATUSCHANGEDCALLBACKDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CFD4950)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_REGISTERAUTHSTATUSCHANGEDCALLBACKDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFD4930)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_RegisterAuthStatusChangedCallbackDelegate_TypeDefinitionIndex = 20644;
