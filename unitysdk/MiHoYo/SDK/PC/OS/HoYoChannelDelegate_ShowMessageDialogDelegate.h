...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_SHOWMESSAGEDIALOGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B3376D0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_SHOWMESSAGEDIALOGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B337710)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_SHOWMESSAGEDIALOGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B337150)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_SHOWMESSAGEDIALOGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B337130)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_ShowMessageDialogDelegate_TypeDefinitionIndex = 20305;
