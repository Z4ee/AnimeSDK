...
#define MIHOYO_SDK_PC_OS_XBOXPRIVILEGEEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B337E90)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int XboxPrivilegeExtension_TypeDefinitionIndex = 20436;
