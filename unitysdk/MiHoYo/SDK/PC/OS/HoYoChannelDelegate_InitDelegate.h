...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_INITDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1838CF00)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_INITDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1838CF30)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_INITDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1838CEF0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_INITDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1838CE00)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_InitDelegate_TypeDefinitionIndex = 8422;
