...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_INVITEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B531080)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_INVITEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B5310C0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_INVITEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B530B00)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_INVITEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B530AE0)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_InviteDelegate_TypeDefinitionIndex = 20315;
