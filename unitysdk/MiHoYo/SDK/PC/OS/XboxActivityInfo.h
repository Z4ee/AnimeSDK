...
#define MIHOYO_SDK_PC_OS_XBOXACTIVITYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABE1100)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int XboxActivityInfo_TypeDefinitionIndex = 8624;
