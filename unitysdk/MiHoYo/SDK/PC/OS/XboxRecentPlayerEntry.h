...
#define MIHOYO_SDK_PC_OS_XBOXRECENTPLAYERENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA38EF0)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int XboxRecentPlayerEntry_TypeDefinitionIndex = 8627;
