...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELBLOCKLISTRESULT_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1A9A0530)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELBLOCKLISTRESULT_TOJSON_OFFSET UNITYSDK_OFFSET(0x1A9A0520)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELBLOCKLISTRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A0570)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelBlockListResult_TypeDefinitionIndex = 20368;
