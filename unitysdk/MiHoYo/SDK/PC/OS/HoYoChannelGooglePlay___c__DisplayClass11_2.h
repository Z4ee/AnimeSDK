...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELGOOGLEPLAY___C__DISPLAYCLASS11_2__CTOR_OFFSET UNITYSDK_OFFSET(0x175AC6F0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELGOOGLEPLAY___C__DISPLAYCLASS11_2__PAY_B__7_OFFSET UNITYSDK_OFFSET(0x175AC700)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelGooglePlay___c__DisplayClass11_2_TypeDefinitionIndex = 7534;
