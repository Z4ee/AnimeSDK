...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_RECENTPLAYERSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A9A16F0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_RECENTPLAYERSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A9A1730)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_RECENTPLAYERSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A9A1170)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_RECENTPLAYERSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A1150)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_RecentPlayersDelegate_TypeDefinitionIndex = 20316;
