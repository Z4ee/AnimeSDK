...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_REGISTERMICROTXNCALLBACKDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1838D320)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_REGISTERMICROTXNCALLBACKDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1838D350)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_REGISTERMICROTXNCALLBACKDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1838D310)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_REGISTERMICROTXNCALLBACKDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1838D2A0)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_RegisterMicroTxnCallbackDelegate_TypeDefinitionIndex = 8429;
