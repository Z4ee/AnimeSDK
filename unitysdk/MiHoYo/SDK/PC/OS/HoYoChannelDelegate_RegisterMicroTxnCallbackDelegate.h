...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_REGISTERMICROTXNCALLBACKDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19940C50)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_REGISTERMICROTXNCALLBACKDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19940C80)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_REGISTERMICROTXNCALLBACKDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19940C40)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_REGISTERMICROTXNCALLBACKDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19940BD0)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_RegisterMicroTxnCallbackDelegate_TypeDefinitionIndex = 8441;
