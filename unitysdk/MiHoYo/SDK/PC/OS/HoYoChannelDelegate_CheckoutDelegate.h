...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_CHECKOUTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1838CC60)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_CHECKOUTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1838CCA0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_CHECKOUTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1838CC50)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_CHECKOUTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1838CB60)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_CheckoutDelegate_TypeDefinitionIndex = 8426;
