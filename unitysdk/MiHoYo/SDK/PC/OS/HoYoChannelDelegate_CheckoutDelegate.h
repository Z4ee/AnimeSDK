...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_CHECKOUTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19940590)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_CHECKOUTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x199405D0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_CHECKOUTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19940580)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_CHECKOUTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19940490)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_CheckoutDelegate_TypeDefinitionIndex = 8438;
