...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_CHECKENTITLEMENTSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A274100)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_CHECKENTITLEMENTSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A274140)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_CHECKENTITLEMENTSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A25D600)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_CHECKENTITLEMENTSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A274010)
