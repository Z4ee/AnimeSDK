...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_CHECKENTITLEMENTSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BB422B0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_CHECKENTITLEMENTSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BB422F0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_CHECKENTITLEMENTSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BB41D30)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_CHECKENTITLEMENTSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB41D10)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_CheckEntitlementsDelegate_TypeDefinitionIndex = 20293;
