...
#define MIHOYO_SDK_PC_OS_XBOXENTITLEMENTSPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1CA830)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int XboxEntitlementsParam_TypeDefinitionIndex = 20752;
