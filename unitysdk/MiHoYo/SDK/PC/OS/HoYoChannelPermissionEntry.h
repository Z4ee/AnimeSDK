...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELPERMISSIONENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFD54B0)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelPermissionEntry_TypeDefinitionIndex = 20785;
