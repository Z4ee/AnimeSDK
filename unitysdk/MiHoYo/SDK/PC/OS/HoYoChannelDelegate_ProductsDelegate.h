...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_PRODUCTSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A274D90)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_PRODUCTSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A274DD0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_PRODUCTSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A25DF80)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_PRODUCTSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A274CA0)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_ProductsDelegate_TypeDefinitionIndex = 8485;
