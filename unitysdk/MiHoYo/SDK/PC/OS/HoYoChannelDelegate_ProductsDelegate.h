...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_PRODUCTSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19940AC0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_PRODUCTSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19940B00)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_PRODUCTSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19940AB0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_PRODUCTSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x199409C0)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_ProductsDelegate_TypeDefinitionIndex = 8437;
