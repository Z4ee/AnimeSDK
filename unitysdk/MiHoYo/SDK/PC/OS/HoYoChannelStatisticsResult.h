...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELSTATISTICSRESULT_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1ABCFB80)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELSTATISTICSRESULT_TOJSON_OFFSET UNITYSDK_OFFSET(0x1ABCFB70)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELSTATISTICSRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABCFBC0)
