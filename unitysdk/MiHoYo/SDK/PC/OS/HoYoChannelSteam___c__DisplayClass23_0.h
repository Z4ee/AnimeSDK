...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELSTEAM___C__DISPLAYCLASS23_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1994B660)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELSTEAM___C__DISPLAYCLASS23_0__ONCREATEORDER_B__0_OFFSET UNITYSDK_OFFSET(0x1994DE10)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELSTEAM___C__DISPLAYCLASS23_0__ONCREATEORDER_B__1_OFFSET UNITYSDK_OFFSET(0x1994DE70)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelSteam___c__DisplayClass23_0_TypeDefinitionIndex = 8480;
