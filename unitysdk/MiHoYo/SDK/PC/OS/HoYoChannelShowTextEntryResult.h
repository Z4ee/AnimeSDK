...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELSHOWTEXTENTRYRESULT_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1D3C3050)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELSHOWTEXTENTRYRESULT_TOJSON_OFFSET UNITYSDK_OFFSET(0x1D3C3040)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELSHOWTEXTENTRYRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3C3090)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelShowTextEntryResult_TypeDefinitionIndex = 20704;
