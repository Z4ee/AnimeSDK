...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELGOOGLEPLAY_CHECKENTITLEMENTS_OFFSET UNITYSDK_OFFSET(0x1ABCB6F0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELGOOGLEPLAY_GETCHANNEL_OFFSET UNITYSDK_OFFSET(0x1ABC88C0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELGOOGLEPLAY_GETDEFAULTBODY_OFFSET UNITYSDK_OFFSET(0x1ABC8DD0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELGOOGLEPLAY_GETPRODUCTLIST_OFFSET UNITYSDK_OFFSET(0x1ABC8E80)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELGOOGLEPLAY_INIT_OFFSET UNITYSDK_OFFSET(0x1ABC8950)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELGOOGLEPLAY_LOGIN_OFFSET UNITYSDK_OFFSET(0x1ABCBA00)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELGOOGLEPLAY_ONGETPRODUCTLISTERROR_OFFSET UNITYSDK_OFFSET(0x1ABC9460)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELGOOGLEPLAY_ONPAYCALLBACKCANCEL_OFFSET UNITYSDK_OFFSET(0x1ABCB340)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELGOOGLEPLAY_ONPAYCALLBACKFAIL_OFFSET UNITYSDK_OFFSET(0x1ABCA0A0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELGOOGLEPLAY_ONPAYCALLBACKSUCCESS_OFFSET UNITYSDK_OFFSET(0x1ABCB520)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELGOOGLEPLAY_PAY_1_OFFSET UNITYSDK_OFFSET(0x1ABCA2A0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELGOOGLEPLAY_PAY_OFFSET UNITYSDK_OFFSET(0x1ABC9680)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELGOOGLEPLAY_PROCESSENTITLEMENT_OFFSET UNITYSDK_OFFSET(0x1ABCB8B0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELGOOGLEPLAY_SDKREPORTPAY_OFFSET UNITYSDK_OFFSET(0x1ABCA940)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELGOOGLEPLAY_SDKVERIFYRECEIPT_OFFSET UNITYSDK_OFFSET(0x1ABCA580)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELGOOGLEPLAY_USEHOYOCHANNEL_OFFSET UNITYSDK_OFFSET(0x1ABC88D0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELGOOGLEPLAY_VERIFYORDER_OFFSET UNITYSDK_OFFSET(0x1ABCA470)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELGOOGLEPLAY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ABCBA80)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELGOOGLEPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABCBA50)
...
namespace MiHoYo::SDK::PC::OS
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::MiHoYo::SDK::PC::OS::ProductData*>**)Il2CppClass::FromTypeDefinitionIndex(HoYoChannelGooglePlay_TypeDefinitionIndex)->GetStaticField(0x1D930);
		}
