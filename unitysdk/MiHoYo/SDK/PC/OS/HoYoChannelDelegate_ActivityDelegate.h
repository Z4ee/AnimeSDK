...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_ACTIVITYDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B6C9B10)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_ACTIVITYDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B6C9B50)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_ACTIVITYDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B6C9590)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_ACTIVITYDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C9570)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_ActivityDelegate_TypeDefinitionIndex = 20314;
