...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_USERPROFILEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BA8B360)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_USERPROFILEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BA8B3A0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_USERPROFILEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BA84D70)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_USERPROFILEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA8B340)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_UserProfileDelegate_TypeDefinitionIndex = 20309;
