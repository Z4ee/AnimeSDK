...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_CONSUMEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BB428A0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_CONSUMEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BB428E0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_CONSUMEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BB42320)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_CONSUMEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB42300)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_ConsumeDelegate_TypeDefinitionIndex = 20294;
