...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_CONSUMEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CEA6890)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_CONSUMEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CEA68D0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_CONSUMEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CEA6300)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_CONSUMEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEA62E0)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_ConsumeDelegate_TypeDefinitionIndex = 20641;
