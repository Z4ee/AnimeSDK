...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_CONSUMEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19CA3440)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_CONSUMEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19CA3480)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_CONSUMEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19CA2EC0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_CONSUMEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CA2EB0)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_ConsumeDelegate_TypeDefinitionIndex = 19352;
