...
#define MIHOYO_SDK_PC_OS_ABTESTMANAGER_GETABTESTKEY_OFFSET UNITYSDK_OFFSET(0x1A6506B0)
#define MIHOYO_SDK_PC_OS_ABTESTMANAGER_GETABTESTREQUESTPARAM_OFFSET UNITYSDK_OFFSET(0x1A652570)
#define MIHOYO_SDK_PC_OS_ABTESTMANAGER_GETCOMPLIANCEABMODEL_OFFSET UNITYSDK_OFFSET(0x1A6514D0)
#define MIHOYO_SDK_PC_OS_ABTESTMANAGER_GETHOYOPASSABMODEL_OFFSET UNITYSDK_OFFSET(0x1A651100)
#define MIHOYO_SDK_PC_OS_ABTESTMANAGER_GETRENDERMETHODABMODEL_OFFSET UNITYSDK_OFFSET(0x1A6518C0)
#define MIHOYO_SDK_PC_OS_ABTESTMANAGER_LOADALLABTESTRESULT_OFFSET UNITYSDK_OFFSET(0x1A653FB0)
#define MIHOYO_SDK_PC_OS_ABTESTMANAGER_LOADCOMPLIANCEABTESTRESULT_OFFSET UNITYSDK_OFFSET(0x1A653A50)
#define MIHOYO_SDK_PC_OS_ABTESTMANAGER_ONCOMBOINITFAILED_OFFSET UNITYSDK_OFFSET(0x1A653140)
#define MIHOYO_SDK_PC_OS_ABTESTMANAGER_ONCOMBOINITSUCCESS_OFFSET UNITYSDK_OFFSET(0x1A653C70)
#define MIHOYO_SDK_PC_OS_ABTESTMANAGER_REQUESTALLACCOUNTABTEST_OFFSET UNITYSDK_OFFSET(0x1A652640)
#define MIHOYO_SDK_PC_OS_ABTESTMANAGER_REQUESTCOMPLIANCEABTEST_OFFSET UNITYSDK_OFFSET(0x1A653310)
#define MIHOYO_SDK_PC_OS_ABTESTMANAGER_REQUESTLEGACYABTEST_OFFSET UNITYSDK_OFFSET(0x1A651F30)
#define MIHOYO_SDK_PC_OS_ABTESTMANAGER_REQUESTWEBVIEWRENDERMETHODABTESTCONFIG_OFFSET UNITYSDK_OFFSET(0x1A651FC0)
#define MIHOYO_SDK_PC_OS_ABTESTMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A653FD0)
#define MIHOYO_SDK_PC_OS_ABTESTMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A653FC0)
#define MIHOYO_SDK_PC_OS_ABTESTMANAGER__REQUESTCOMPLIANCEABTEST_B__12_0_OFFSET UNITYSDK_OFFSET(0x1A654000)
#define MIHOYO_SDK_PC_OS_ABTESTMANAGER__REQUESTWEBVIEWRENDERMETHODABTESTCONFIG_B__16_0_OFFSET UNITYSDK_OFFSET(0x1A654880)
...
namespace MiHoYo::SDK::PC::OS
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PC::OS::ABTestManager**)Il2CppClass::FromTypeDefinitionIndex(ABTestManager_TypeDefinitionIndex)->GetStaticField(0x183A0);
		}
