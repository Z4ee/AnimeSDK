...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELLEADERBOARDRESULT_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1D3C2F80)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELLEADERBOARDRESULT_TOJSON_OFFSET UNITYSDK_OFFSET(0x1D3C2F70)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELLEADERBOARDRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3C2FC0)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelLeaderboardResult_TypeDefinitionIndex = 20726;
