...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELFRIENDLISTRESULT_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1B5C1D70)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELFRIENDLISTRESULT_TOJSON_OFFSET UNITYSDK_OFFSET(0x1B5C1D60)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELFRIENDLISTRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C1DB0)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelFriendListResult_TypeDefinitionIndex = 20366;
