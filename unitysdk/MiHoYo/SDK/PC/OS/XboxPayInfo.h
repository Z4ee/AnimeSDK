...
#define MIHOYO_SDK_PC_OS_XBOXPAYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABD8260)
...
namespace MiHoYo::SDK::PC::OS
{
	...
	public:
		...
		::System::String* collectionsId; // 0x20
		::System::String* skuId; // 0x28
		::System::String* orderNo; // 0x30
		::System::String* countryCode; // 0x38
		::MiHoYo::SDK::PC::OS::ProductData* productData; // 0x40
