...
#define MIHOYO_SDK_PC_OS_PURCHASEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA38CF0)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int PurchaseData_TypeDefinitionIndex = 8539;
