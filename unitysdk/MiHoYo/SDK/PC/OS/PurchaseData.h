...
#define MIHOYO_SDK_PC_OS_PURCHASEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19CA3A70)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int PurchaseData_TypeDefinitionIndex = 19383;
