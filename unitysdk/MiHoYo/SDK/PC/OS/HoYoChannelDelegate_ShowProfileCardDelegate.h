...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_SHOWPROFILECARDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C7D38B0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_SHOWPROFILECARDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C7D38F0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_SHOWPROFILECARDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C7D3320)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_SHOWPROFILECARDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C7D3300)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_ShowProfileCardDelegate_TypeDefinitionIndex = 20651;
