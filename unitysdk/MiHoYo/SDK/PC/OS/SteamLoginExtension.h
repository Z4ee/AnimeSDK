...
#define MIHOYO_SDK_PC_OS_STEAMLOGINEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1839C150)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int SteamLoginExtension_TypeDefinitionIndex = 8470;
