...
#define MIHOYO_SDK_PC_OS_STEAMPAYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18395E50)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int SteamPayInfo_TypeDefinitionIndex = 8474;
