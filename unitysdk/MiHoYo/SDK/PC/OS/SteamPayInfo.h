...
#define MIHOYO_SDK_PC_OS_STEAMPAYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA29710)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int SteamPayInfo_TypeDefinitionIndex = 8645;
