...
#define MIHOYO_SDK_PC_OS_XBOXACHIEVEMENTSPARAMEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3C5230)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int XboxAchievementsParamExtension_TypeDefinitionIndex = 20763;
