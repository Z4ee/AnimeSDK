...
#define MIHOYO_SDK_PC_OS_STEAMPAYMENTNETWORKREQUEST_CREATEORDER_OFFSET UNITYSDK_OFFSET(0x18396260)
#define MIHOYO_SDK_PC_OS_STEAMPAYMENTNETWORKREQUEST_DEDUCT_OFFSET UNITYSDK_OFFSET(0x18398010)
#define MIHOYO_SDK_PC_OS_STEAMPAYMENTNETWORKREQUEST_GETPRICETIER_OFFSET UNITYSDK_OFFSET(0x18395220)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int SteamPaymentNetworkRequest_TypeDefinitionIndex = 8475;
