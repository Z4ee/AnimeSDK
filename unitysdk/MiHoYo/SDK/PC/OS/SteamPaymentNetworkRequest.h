...
#define MIHOYO_SDK_PC_OS_STEAMPAYMENTNETWORKREQUEST_CREATEORDER_OFFSET UNITYSDK_OFFSET(0x1ABD1CE0)
#define MIHOYO_SDK_PC_OS_STEAMPAYMENTNETWORKREQUEST_DEDUCT_OFFSET UNITYSDK_OFFSET(0x1ABD3E10)
#define MIHOYO_SDK_PC_OS_STEAMPAYMENTNETWORKREQUEST_GETPRICETIER_OFFSET UNITYSDK_OFFSET(0x1ABD0C50)
