...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELACTIVITYRESULT_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1CF42DD0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELACTIVITYRESULT_TOJSON_OFFSET UNITYSDK_OFFSET(0x1CF42DC0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELACTIVITYRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF42E10)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelActivityResult_TypeDefinitionIndex = 20728;
