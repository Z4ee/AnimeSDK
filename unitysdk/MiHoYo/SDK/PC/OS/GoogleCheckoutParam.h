...
#define MIHOYO_SDK_PC_OS_GOOGLECHECKOUTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x197E7520)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int GoogleCheckoutParam_TypeDefinitionIndex = 19341;
