...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELSHOWMESSAGEDIALOGRESULT_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1D76D420)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELSHOWMESSAGEDIALOGRESULT_TOJSON_OFFSET UNITYSDK_OFFSET(0x1D76D410)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELSHOWMESSAGEDIALOGRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D76D460)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelShowMessageDialogResult_TypeDefinitionIndex = 20708;
