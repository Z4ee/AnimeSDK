...
#define MIHOYO_SDK_PC_OS_GOOGLEPURCHASEEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x18DBD240)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int GooglePurchaseExtension_TypeDefinitionIndex = 19340;
