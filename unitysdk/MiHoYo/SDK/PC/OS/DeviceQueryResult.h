...
#define MIHOYO_SDK_PC_OS_DEVICEQUERYRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A0490)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int DeviceQueryResult_TypeDefinitionIndex = 20387;
