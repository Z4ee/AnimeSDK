...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_AUTHTOKENDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x194B1A90)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_AUTHTOKENDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x194B1AD0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_AUTHTOKENDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x194B1510)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_AUTHTOKENDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x194B1500)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_AuthTokenDelegate_TypeDefinitionIndex = 19348;
