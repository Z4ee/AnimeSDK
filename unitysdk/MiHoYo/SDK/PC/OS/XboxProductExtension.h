...
#define MIHOYO_SDK_PC_OS_XBOXPRODUCTEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA38ED0)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int XboxProductExtension_TypeDefinitionIndex = 8602;
