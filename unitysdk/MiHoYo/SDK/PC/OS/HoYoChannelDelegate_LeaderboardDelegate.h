...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_LEADERBOARDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A9A0B60)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_LEADERBOARDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A9A0BA0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_LEADERBOARDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A9A05E0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_LEADERBOARDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A05C0)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_LeaderboardDelegate_TypeDefinitionIndex = 20313;
