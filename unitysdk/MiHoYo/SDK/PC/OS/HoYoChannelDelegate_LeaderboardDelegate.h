...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_LEADERBOARDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A274B00)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_LEADERBOARDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A274B40)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_LEADERBOARDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A26AA10)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_LEADERBOARDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A274A10)
