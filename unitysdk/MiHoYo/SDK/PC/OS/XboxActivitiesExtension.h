...
#define MIHOYO_SDK_PC_OS_XBOXACTIVITIESEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA38DA0)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int XboxActivitiesExtension_TypeDefinitionIndex = 8625;
