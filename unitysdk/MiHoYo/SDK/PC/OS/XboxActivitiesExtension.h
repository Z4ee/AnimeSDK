...
#define MIHOYO_SDK_PC_OS_XBOXACTIVITIESEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6CC740)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int XboxActivitiesExtension_TypeDefinitionIndex = 20431;
