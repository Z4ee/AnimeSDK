...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_RESOLVEPRIVILEGEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BC94C50)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_RESOLVEPRIVILEGEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BC94C90)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_RESOLVEPRIVILEGEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BC946D0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_RESOLVEPRIVILEGEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC946B0)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_ResolvePrivilegeDelegate_TypeDefinitionIndex = 20301;
