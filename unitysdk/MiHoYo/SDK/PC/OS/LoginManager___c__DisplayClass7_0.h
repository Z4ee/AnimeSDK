...
#define MIHOYO_SDK_PC_OS_LOGINMANAGER___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA36380)
#define MIHOYO_SDK_PC_OS_LOGINMANAGER___C__DISPLAYCLASS7_0__SHOWLOGINSTATEINVALID_B__0_OFFSET UNITYSDK_OFFSET(0x1BA36EA0)
#define MIHOYO_SDK_PC_OS_LOGINMANAGER___C__DISPLAYCLASS7_0__SHOWLOGINSTATEINVALID_B__1_OFFSET UNITYSDK_OFFSET(0x1BA36F80)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int LoginManager___c__DisplayClass7_0_TypeDefinitionIndex = 8650;
