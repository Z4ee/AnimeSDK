...
#define MIHOYO_SDK_PC_OS_USERQUERYRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC94FB0)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int UserQueryResult_TypeDefinitionIndex = 20389;
