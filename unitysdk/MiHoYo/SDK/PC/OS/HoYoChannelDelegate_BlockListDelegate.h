...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_BLOCKLISTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BF749B0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_BLOCKLISTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BF749F0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_BLOCKLISTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BF74430)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_BLOCKLISTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF74410)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_BlockListDelegate_TypeDefinitionIndex = 20308;
