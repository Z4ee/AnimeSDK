...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_FRIENDLISTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CAD0DB0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_FRIENDLISTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CAD0DF0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_FRIENDLISTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CAD0820)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_FRIENDLISTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAD0800)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_FriendListDelegate_TypeDefinitionIndex = 20654;
