...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_ACHIEVEMENTSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B9DD1D0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_ACHIEVEMENTSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B9DD210)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_ACHIEVEMENTSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B9DCC50)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_ACHIEVEMENTSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9DCC30)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_AchievementsDelegate_TypeDefinitionIndex = 20311;
