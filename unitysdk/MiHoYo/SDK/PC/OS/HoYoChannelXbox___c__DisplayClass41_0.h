...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELXBOX___C__DISPLAYCLASS41_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD4AFD0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELXBOX___C__DISPLAYCLASS41_0__OPENXBOXCHECKOUT_B__0_OFFSET UNITYSDK_OFFSET(0x1DD4AFE0)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelXbox___c__DisplayClass41_0_TypeDefinitionIndex = 20744;
