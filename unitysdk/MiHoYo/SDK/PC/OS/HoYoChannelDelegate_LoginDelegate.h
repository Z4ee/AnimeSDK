...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_LOGINDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CEA6E90)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_LOGINDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CEA6ED0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_LOGINDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CEA6900)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_LOGINDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEA68E0)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_LoginDelegate_TypeDefinitionIndex = 20636;
