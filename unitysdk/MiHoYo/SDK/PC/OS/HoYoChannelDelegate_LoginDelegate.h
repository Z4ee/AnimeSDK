...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_LOGINDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1838D040)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_LOGINDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1838D080)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_LOGINDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1838D030)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_LOGINDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1838CF40)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_LoginDelegate_TypeDefinitionIndex = 8423;
