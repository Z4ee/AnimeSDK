...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELFRIENDLISTPARAMS_TOJSON_OFFSET UNITYSDK_OFFSET(0x1BA204B0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELFRIENDLISTPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA204C0)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelFriendListParams_TypeDefinitionIndex = 8558;
