...
#define MIHOYO_SDK_PC_OS_XBOXAUTHTOKENEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABE1120)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int XboxAuthTokenExtension_TypeDefinitionIndex = 8600;
