...
#define MIHOYO_SDK_PC_OS_XBOXAUTHTOKENEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC94FD0)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int XboxAuthTokenExtension_TypeDefinitionIndex = 20406;
