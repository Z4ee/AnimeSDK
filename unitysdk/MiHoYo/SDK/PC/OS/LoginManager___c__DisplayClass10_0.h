...
#define MIHOYO_SDK_PC_OS_LOGINMANAGER___C__DISPLAYCLASS10_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABDED70)
#define MIHOYO_SDK_PC_OS_LOGINMANAGER___C__DISPLAYCLASS10_0__ONLOGIN_B__0_OFFSET UNITYSDK_OFFSET(0x1ABDEE40)
#define MIHOYO_SDK_PC_OS_LOGINMANAGER___C__DISPLAYCLASS10_0__ONLOGIN_B__1_OFFSET UNITYSDK_OFFSET(0x1ABDEF00)
