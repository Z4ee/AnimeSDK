...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELUSERPROFILERESULT_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1DA11F50)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELUSERPROFILERESULT_TOJSON_OFFSET UNITYSDK_OFFSET(0x1DA11F40)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELUSERPROFILERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA11F90)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelUserProfileResult_TypeDefinitionIndex = 20718;
