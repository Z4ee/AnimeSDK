...
namespace MiHoYo::SDK::PC::OS
{
	...
	public:
		...
		::System::Void _QueryProductAndPay_b__0(::MiHoYo::SDK::PC::OS::HoYoChannelProductsResult* response)
		{
			return ((::System::Void(*)(::PVOID, ::MiHoYo::SDK::PC::OS::HoYoChannelProductsResult*))((::PBYTE)hIl2Cpp + MIHOYO_SDK_PC_OS_HOYOCHANNELXBOX___C__DISPLAYCLASS39_0__QUERYPRODUCTANDPAY_B__0_OFFSET))(this, response);
		}
	};
}
