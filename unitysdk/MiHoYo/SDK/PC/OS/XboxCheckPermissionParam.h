...
#define MIHOYO_SDK_PC_OS_XBOXCHECKPERMISSIONPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C1F70)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int XboxCheckPermissionParam_TypeDefinitionIndex = 20435;
