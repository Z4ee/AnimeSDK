...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_STATISTICSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C0DF070)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_STATISTICSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C0DF0B0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_STATISTICSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C0DEAF0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_STATISTICSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0DEAD0)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_StatisticsDelegate_TypeDefinitionIndex = 20312;
