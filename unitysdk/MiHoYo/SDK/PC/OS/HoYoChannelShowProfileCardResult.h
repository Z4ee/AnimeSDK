...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELSHOWPROFILECARDRESULT_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1CF47030)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELSHOWPROFILECARDRESULT_TOJSON_OFFSET UNITYSDK_OFFSET(0x1CF47020)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELSHOWPROFILECARDRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF47070)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelShowProfileCardResult_TypeDefinitionIndex = 20706;
