...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELCHECKPERMISSIONRESULT_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1B3370A0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELCHECKPERMISSIONRESULT_TOJSON_OFFSET UNITYSDK_OFFSET(0x1B337090)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELCHECKPERMISSIONRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3370E0)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelCheckPermissionResult_TypeDefinitionIndex = 20354;
