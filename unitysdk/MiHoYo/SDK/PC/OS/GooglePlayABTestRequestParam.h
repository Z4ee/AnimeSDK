...
#define MIHOYO_SDK_PC_OS_GOOGLEPLAYABTESTREQUESTPARAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17598DF0)
#define MIHOYO_SDK_PC_OS_GOOGLEPLAYABTESTREQUESTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x175A3170)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int GooglePlayABTestRequestParam_TypeDefinitionIndex = 7578;

	class GooglePlayABTestRequestParam : public ::System::Object
	{
	public:
		// static const ::System::String* ABTEST_KEY; // 0x0
		::System::Collections::Generic::List_1<::System::String*>* ExperimentIdList; // 0x10
		::System::Collections::Generic::List_1<::System::String*>* SceneIdList; // 0x18
		::System::String* AppId; // 0x20
		::System::String* uid; // 0x28
		::System::String* AppKey; // 0x30
