...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_REGISTERGAMEOVERLAYCALLBACKDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D1CA780)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_REGISTERGAMEOVERLAYCALLBACKDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D1CA7B0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_REGISTERGAMEOVERLAYCALLBACKDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D1CA260)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_REGISTERGAMEOVERLAYCALLBACKDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1CA240)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_RegisterGameOverlayCallbackDelegate_TypeDefinitionIndex = 20643;
