...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_SHOWERRORDIALOGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A9A2240)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_SHOWERRORDIALOGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A9A2280)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_SHOWERRORDIALOGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A9A1CC0)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_SHOWERRORDIALOGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A1CA0)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_ShowErrorDialogDelegate_TypeDefinitionIndex = 20306;
