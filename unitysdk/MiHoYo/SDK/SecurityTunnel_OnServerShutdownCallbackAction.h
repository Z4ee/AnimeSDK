...
#define MIHOYO_SDK_SECURITYTUNNEL_ONSERVERSHUTDOWNCALLBACKACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18D298F0)
#define MIHOYO_SDK_SECURITYTUNNEL_ONSERVERSHUTDOWNCALLBACKACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18D29920)
#define MIHOYO_SDK_SECURITYTUNNEL_ONSERVERSHUTDOWNCALLBACKACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x18D24F30)
#define MIHOYO_SDK_SECURITYTUNNEL_ONSERVERSHUTDOWNCALLBACKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18D298E0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_OnServerShutdownCallbackAction_TypeDefinitionIndex = 35222;
