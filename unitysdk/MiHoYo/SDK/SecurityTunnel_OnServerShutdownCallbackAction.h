...
#define MIHOYO_SDK_SECURITYTUNNEL_ONSERVERSHUTDOWNCALLBACKACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x85929A0)
#define MIHOYO_SDK_SECURITYTUNNEL_ONSERVERSHUTDOWNCALLBACKACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x85929D0)
#define MIHOYO_SDK_SECURITYTUNNEL_ONSERVERSHUTDOWNCALLBACKACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x8592700)
#define MIHOYO_SDK_SECURITYTUNNEL_ONSERVERSHUTDOWNCALLBACKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x85926E0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_OnServerShutdownCallbackAction_TypeDefinitionIndex = 37163;
