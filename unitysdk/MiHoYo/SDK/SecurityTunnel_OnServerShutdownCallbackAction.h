...
#define MIHOYO_SDK_SECURITYTUNNEL_ONSERVERSHUTDOWNCALLBACKACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AE356E0)
#define MIHOYO_SDK_SECURITYTUNNEL_ONSERVERSHUTDOWNCALLBACKACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AE35710)
#define MIHOYO_SDK_SECURITYTUNNEL_ONSERVERSHUTDOWNCALLBACKACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AE30D30)
#define MIHOYO_SDK_SECURITYTUNNEL_ONSERVERSHUTDOWNCALLBACKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE356C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_OnServerShutdownCallbackAction_TypeDefinitionIndex = 36786;
