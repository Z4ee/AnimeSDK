...
#define MIHOYO_SDK_WEB_ONUNIWEBVIEWMESSAGEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BB13260)
#define MIHOYO_SDK_WEB_ONUNIWEBVIEWMESSAGEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BB132E0)
#define MIHOYO_SDK_WEB_ONUNIWEBVIEWMESSAGEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BB128B0)
#define MIHOYO_SDK_WEB_ONUNIWEBVIEWMESSAGEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB13170)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int Web_OnUniWebViewMessageDelegate_TypeDefinitionIndex = 8172;
