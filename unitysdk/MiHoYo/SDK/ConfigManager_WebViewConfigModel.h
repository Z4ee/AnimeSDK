...
#define MIHOYO_SDK_CONFIGMANAGER_WEBVIEWCONFIGMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D761220)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConfigManager_WebViewConfigModel_TypeDefinitionIndex = 20316;
