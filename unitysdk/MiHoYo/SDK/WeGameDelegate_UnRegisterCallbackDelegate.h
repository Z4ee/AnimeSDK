...
#define MIHOYO_SDK_WEGAMEDELEGATE_UNREGISTERCALLBACKDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1602D220)
#define MIHOYO_SDK_WEGAMEDELEGATE_UNREGISTERCALLBACKDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1602D250)
#define MIHOYO_SDK_WEGAMEDELEGATE_UNREGISTERCALLBACKDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1602CF80)
#define MIHOYO_SDK_WEGAMEDELEGATE_UNREGISTERCALLBACKDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1602CF60)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WeGameDelegate_UnRegisterCallbackDelegate_TypeDefinitionIndex = 6707;
