...
#define MIHOYO_SDK_WEGAMEDELEGATE_UNREGISTERCALLBACKDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CF4CE20)
#define MIHOYO_SDK_WEGAMEDELEGATE_UNREGISTERCALLBACKDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CF4CE50)
#define MIHOYO_SDK_WEGAMEDELEGATE_UNREGISTERCALLBACKDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CF4CB90)
#define MIHOYO_SDK_WEGAMEDELEGATE_UNREGISTERCALLBACKDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF4CB70)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WeGameDelegate_UnRegisterCallbackDelegate_TypeDefinitionIndex = 19813;
