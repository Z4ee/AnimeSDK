...
#define MIHOYO_SDK_WEGAMEDELEGATE_UNREGISTERCALLBACKDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19C8CE60)
#define MIHOYO_SDK_WEGAMEDELEGATE_UNREGISTERCALLBACKDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19C8CE90)
#define MIHOYO_SDK_WEGAMEDELEGATE_UNREGISTERCALLBACKDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C8CBC0)
#define MIHOYO_SDK_WEGAMEDELEGATE_UNREGISTERCALLBACKDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C8CBB0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WeGameDelegate_UnRegisterCallbackDelegate_TypeDefinitionIndex = 18571;
