...
#define MIHOYO_SDK_BILIBILIDELEGATE_SDKLOGOUTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19C94A10)
#define MIHOYO_SDK_BILIBILIDELEGATE_SDKLOGOUTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19C94A40)
#define MIHOYO_SDK_BILIBILIDELEGATE_SDKLOGOUTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C94770)
#define MIHOYO_SDK_BILIBILIDELEGATE_SDKLOGOUTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C94760)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int BiliBiliDelegate_SDKLogoutDelegate_TypeDefinitionIndex = 18482;
