...
#define MIHOYO_SDK_WEBDELEGATE_GETUSERAGENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15C24710)
#define MIHOYO_SDK_WEBDELEGATE_GETUSERAGENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15C24740)
#define MIHOYO_SDK_WEBDELEGATE_GETUSERAGENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15C22710)
#define MIHOYO_SDK_WEBDELEGATE_GETUSERAGENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15C246A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_GetUserAgentDelegate_TypeDefinitionIndex = 7789;
