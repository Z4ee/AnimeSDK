...
#define MIHOYO_SDK_WEBDELEGATE_GETUSERAGENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16040C10)
#define MIHOYO_SDK_WEBDELEGATE_GETUSERAGENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16040C40)
#define MIHOYO_SDK_WEBDELEGATE_GETUSERAGENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x16034D70)
#define MIHOYO_SDK_WEBDELEGATE_GETUSERAGENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16040BF0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_GetUserAgentDelegate_TypeDefinitionIndex = 6838;
