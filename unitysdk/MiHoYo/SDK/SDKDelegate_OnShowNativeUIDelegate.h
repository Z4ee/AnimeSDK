...
#define MIHOYO_SDK_SDKDELEGATE_ONSHOWNATIVEUIDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C7D8910)
#define MIHOYO_SDK_SDKDELEGATE_ONSHOWNATIVEUIDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C7D8950)
#define MIHOYO_SDK_SDKDELEGATE_ONSHOWNATIVEUIDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C7D8380)
#define MIHOYO_SDK_SDKDELEGATE_ONSHOWNATIVEUIDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C7D8360)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_OnShowNativeUIDelegate_TypeDefinitionIndex = 19915;
