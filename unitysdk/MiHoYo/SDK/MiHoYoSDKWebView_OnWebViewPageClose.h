...
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONWEBVIEWPAGECLOSE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E530A50)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONWEBVIEWPAGECLOSE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E530A80)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONWEBVIEWPAGECLOSE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E530530)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONWEBVIEWPAGECLOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E530510)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKWebView_OnWebViewPageClose_TypeDefinitionIndex = 37628;
