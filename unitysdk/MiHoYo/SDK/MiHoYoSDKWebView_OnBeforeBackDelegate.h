...
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONBEFOREBACKDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BF0F530)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONBEFOREBACKDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BF0F560)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONBEFOREBACKDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BF0F030)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONBEFOREBACKDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF0F010)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKWebView_OnBeforeBackDelegate_TypeDefinitionIndex = 36973;
