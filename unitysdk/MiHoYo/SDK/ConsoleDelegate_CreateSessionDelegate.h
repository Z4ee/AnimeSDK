...
#define MIHOYO_SDK_CONSOLEDELEGATE_CREATESESSIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CF30C50)
#define MIHOYO_SDK_CONSOLEDELEGATE_CREATESESSIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CF30C90)
#define MIHOYO_SDK_CONSOLEDELEGATE_CREATESESSIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CF2AA70)
#define MIHOYO_SDK_CONSOLEDELEGATE_CREATESESSIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF30C30)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_CreateSessionDelegate_TypeDefinitionIndex = 19728;
