...
#define MIHOYO_SDK_CONSOLEDELEGATE_CREATESESSIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15EC9E70)
#define MIHOYO_SDK_CONSOLEDELEGATE_CREATESESSIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15EC9EB0)
#define MIHOYO_SDK_CONSOLEDELEGATE_CREATESESSIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15EC98B0)
#define MIHOYO_SDK_CONSOLEDELEGATE_CREATESESSIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15EC9890)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_CreateSessionDelegate_TypeDefinitionIndex = 6642;
