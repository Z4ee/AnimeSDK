...
#define MIHOYO_SDK_CONSOLEDELEGATE_CREATESESSIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1750D9E0)
#define MIHOYO_SDK_CONSOLEDELEGATE_CREATESESSIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1750DA20)
#define MIHOYO_SDK_CONSOLEDELEGATE_CREATESESSIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1750D420)
#define MIHOYO_SDK_CONSOLEDELEGATE_CREATESESSIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1750D400)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_CreateSessionDelegate_TypeDefinitionIndex = 6676;
