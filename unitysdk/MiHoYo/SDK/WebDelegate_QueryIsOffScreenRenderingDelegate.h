...
#define MIHOYO_SDK_WEBDELEGATE_QUERYISOFFSCREENRENDERINGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184653F0)
#define MIHOYO_SDK_WEBDELEGATE_QUERYISOFFSCREENRENDERINGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18465440)
#define MIHOYO_SDK_WEBDELEGATE_QUERYISOFFSCREENRENDERINGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x184653E0)
#define MIHOYO_SDK_WEBDELEGATE_QUERYISOFFSCREENRENDERINGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18465370)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_QueryIsOffScreenRenderingDelegate_TypeDefinitionIndex = 7805;
