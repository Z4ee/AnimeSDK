...
#define MIHOYO_SDK_CONFIGMANAGER_WATERMARKCONFIGMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1949EEF0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConfigManager_WatermarkConfigModel_TypeDefinitionIndex = 19070;
