...
#define MIHOYO_SDK_AGEGATELOGDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1885BEA0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AgeGateLogDefine_TypeDefinitionIndex = 7515;
