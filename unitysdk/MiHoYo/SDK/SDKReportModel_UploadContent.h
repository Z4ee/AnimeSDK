...
#define MIHOYO_SDK_SDKREPORTMODEL_UPLOADCONTENT__CTOR_OFFSET UNITYSDK_OFFSET(0x17124B90)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKReportModel_UploadContent_TypeDefinitionIndex = 7888;
