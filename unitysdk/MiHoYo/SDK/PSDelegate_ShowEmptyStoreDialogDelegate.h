...
#define MIHOYO_SDK_PSDELEGATE_SHOWEMPTYSTOREDIALOGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBCCF30)
#define MIHOYO_SDK_PSDELEGATE_SHOWEMPTYSTOREDIALOGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBCCF60)
#define MIHOYO_SDK_PSDELEGATE_SHOWEMPTYSTOREDIALOGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBACF20)
#define MIHOYO_SDK_PSDELEGATE_SHOWEMPTYSTOREDIALOGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBCCF10)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_ShowEmptyStoreDialogDelegate_TypeDefinitionIndex = 19508;
