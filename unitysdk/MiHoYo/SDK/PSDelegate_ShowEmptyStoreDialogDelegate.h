...
#define MIHOYO_SDK_PSDELEGATE_SHOWEMPTYSTOREDIALOGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19C883B0)
#define MIHOYO_SDK_PSDELEGATE_SHOWEMPTYSTOREDIALOGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19C883E0)
#define MIHOYO_SDK_PSDELEGATE_SHOWEMPTYSTOREDIALOGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C700D0)
#define MIHOYO_SDK_PSDELEGATE_SHOWEMPTYSTOREDIALOGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C883A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_ShowEmptyStoreDialogDelegate_TypeDefinitionIndex = 18613;
