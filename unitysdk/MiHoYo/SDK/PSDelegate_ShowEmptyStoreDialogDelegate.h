...
#define MIHOYO_SDK_PSDELEGATE_SHOWEMPTYSTOREDIALOGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1945FAF0)
#define MIHOYO_SDK_PSDELEGATE_SHOWEMPTYSTOREDIALOGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1945FB20)
#define MIHOYO_SDK_PSDELEGATE_SHOWEMPTYSTOREDIALOGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1943DA90)
#define MIHOYO_SDK_PSDELEGATE_SHOWEMPTYSTOREDIALOGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1945FA80)
