...
#define MIHOYO_SDK_NETUTIL__PERFORMHTTPREQUESTFORBINARYRESPONSE_D__20_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B9D7DC0)
#define MIHOYO_SDK_NETUTIL__PERFORMHTTPREQUESTFORBINARYRESPONSE_D__20_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B9D8A20)
#define MIHOYO_SDK_NETUTIL__PERFORMHTTPREQUESTFORBINARYRESPONSE_D__20_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B9D8A80)
#define MIHOYO_SDK_NETUTIL__PERFORMHTTPREQUESTFORBINARYRESPONSE_D__20_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B9D8A30)
#define MIHOYO_SDK_NETUTIL__PERFORMHTTPREQUESTFORBINARYRESPONSE_D__20_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B9D7DB0)
#define MIHOYO_SDK_NETUTIL__PERFORMHTTPREQUESTFORBINARYRESPONSE_D__20__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9D7DA0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int NetUtil__PerformHttpRequestForBinaryResponse_d__20_TypeDefinitionIndex = 19958;

	class NetUtil__PerformHttpRequestForBinaryResponse_d__20 : public ::System::Object
	{
	public:
		::System::Action_3<::Il2CppArray<::System::Byte>*, ::System::Int32, ::System::String*>* completeCallback; // 0x10
		::System::String* _value_5__6; // 0x18
		::System::Func_1<::UnityEngine::Networking::UnityWebRequest*>* buildRequestFun; // 0x20
		::System::Action* timeoutCallback; // 0x28
		::System::Exception* _ex_5__9; // 0x30
		::System::String* _key_5__5; // 0x38
		::System::Object* __2__current; // 0x40
		::System::String* _errorMsg_5__8; // 0x48
		::UnityEngine::Networking::UnityWebRequest* _request_5__3; // 0x50
