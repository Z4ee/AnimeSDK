...
#define MIHOYO_SDK_SECURITYTUNNEL_FILE_RANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D26EF60)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_File_Range_TypeDefinitionIndex = 36766;
