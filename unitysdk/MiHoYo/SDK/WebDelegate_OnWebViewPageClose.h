...
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGECLOSE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D776130)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGECLOSE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D776160)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGECLOSE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D775C10)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGECLOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D775BF0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_OnWebViewPageClose_TypeDefinitionIndex = 19929;
