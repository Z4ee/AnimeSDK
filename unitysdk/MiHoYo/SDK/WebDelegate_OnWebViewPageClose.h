...
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGECLOSE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16041110)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGECLOSE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16041140)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGECLOSE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1602E800)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGECLOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x160410F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_OnWebViewPageClose_TypeDefinitionIndex = 6822;
