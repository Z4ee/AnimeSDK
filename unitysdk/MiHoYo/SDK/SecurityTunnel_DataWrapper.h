...
#define MIHOYO_SDK_SECURITYTUNNEL_DATAWRAPPER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D288D90)
#define MIHOYO_SDK_SECURITYTUNNEL_DATAWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D288D80)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_DataWrapper_TypeDefinitionIndex = 36775;
