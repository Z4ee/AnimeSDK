...
#define MIHOYO_SDK_SECURITYTUNNEL_DATAWRAPPER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AE3F5F0)
#define MIHOYO_SDK_SECURITYTUNNEL_DATAWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE3F5E0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_DataWrapper_TypeDefinitionIndex = 35211;
