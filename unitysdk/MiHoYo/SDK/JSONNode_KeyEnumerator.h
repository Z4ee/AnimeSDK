...
#define MIHOYO_SDK_JSONNODE_KEYENUMERATOR_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x47DA80)
#define MIHOYO_SDK_JSONNODE_KEYENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x8CE9A0)
#define MIHOYO_SDK_JSONNODE_KEYENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x81CA90)
#define MIHOYO_SDK_JSONNODE_KEYENUMERATOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x896310)
#define MIHOYO_SDK_JSONNODE_KEYENUMERATOR__CTOR_2_OFFSET UNITYSDK_OFFSET(0x66F210)
#define MIHOYO_SDK_JSONNODE_KEYENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x8962D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int JSONNode_KeyEnumerator_TypeDefinitionIndex = 18993;
