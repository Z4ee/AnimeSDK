...
#define MIHOYO_SDK_JSONNODE_KEYENUMERATOR_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x381F70)
#define MIHOYO_SDK_JSONNODE_KEYENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x95D9D0)
#define MIHOYO_SDK_JSONNODE_KEYENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x881870)
#define MIHOYO_SDK_JSONNODE_KEYENUMERATOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x937E00)
#define MIHOYO_SDK_JSONNODE_KEYENUMERATOR__CTOR_2_OFFSET UNITYSDK_OFFSET(0x381AA0)
#define MIHOYO_SDK_JSONNODE_KEYENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x937DC0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int JSONNode_KeyEnumerator_TypeDefinitionIndex = 19890;
