...
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWNATIVEREADY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x160410B0)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWNATIVEREADY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x160410E0)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWNATIVEREADY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1602ED50)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWNATIVEREADY__CTOR_OFFSET UNITYSDK_OFFSET(0x16041090)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_OnWebViewNativeReady_TypeDefinitionIndex = 6818;
