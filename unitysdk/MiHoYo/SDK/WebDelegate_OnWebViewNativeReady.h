...
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWNATIVEREADY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x176A59D0)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWNATIVEREADY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x176A5A00)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWNATIVEREADY_INVOKE_OFFSET UNITYSDK_OFFSET(0x176935C0)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWNATIVEREADY__CTOR_OFFSET UNITYSDK_OFFSET(0x176A59B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_OnWebViewNativeReady_TypeDefinitionIndex = 6860;
