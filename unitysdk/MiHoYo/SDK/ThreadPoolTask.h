...
#define MIHOYO_SDK_THREADPOOLTASK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8599540)
#define MIHOYO_SDK_THREADPOOLTASK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8599570)
#define MIHOYO_SDK_THREADPOOLTASK_INVOKE_OFFSET UNITYSDK_OFFSET(0x85987B0)
#define MIHOYO_SDK_THREADPOOLTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x8594BC0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ThreadPoolTask_TypeDefinitionIndex = 37242;
