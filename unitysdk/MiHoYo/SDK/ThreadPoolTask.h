...
#define MIHOYO_SDK_THREADPOOLTASK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19FBBA60)
#define MIHOYO_SDK_THREADPOOLTASK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19FBBA90)
#define MIHOYO_SDK_THREADPOOLTASK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19FBB560)
#define MIHOYO_SDK_THREADPOOLTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x19FB4BA0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ThreadPoolTask_TypeDefinitionIndex = 35311;
