...
#define MIHOYO_SDK_THREADPOOLTASK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BFCBFA0)
#define MIHOYO_SDK_THREADPOOLTASK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BFCBFD0)
#define MIHOYO_SDK_THREADPOOLTASK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BFCBAA0)
#define MIHOYO_SDK_THREADPOOLTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFC0DD0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ThreadPoolTask_TypeDefinitionIndex = 36875;
