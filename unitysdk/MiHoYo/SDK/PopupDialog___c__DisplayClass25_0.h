...
#define MIHOYO_SDK_POPUPDIALOG___C__DISPLAYCLASS25_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19EA7890)
#define MIHOYO_SDK_POPUPDIALOG___C__DISPLAYCLASS25_0__SHOW_B__0_OFFSET UNITYSDK_OFFSET(0x19EA7E50)
...
namespace MiHoYo::SDK
{
	...
	public:
		...
		::MiHoYo::SDK::PopupDialog_OnSelectedDelegate* callback; // 0x18
