...
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_BUILDFROM_OFFSET UNITYSDK_OFFSET(0x1B701D90)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_COMPUTEFULLNAME_OFFSET UNITYSDK_OFFSET(0x1B6F98B0)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_CROSSLINK_OFFSET UNITYSDK_OFFSET(0x1B701FF0)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_DETERMINEPUBLICDEPENDENCIES_OFFSET UNITYSDK_OFFSET(0x1B701690)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_FROMGENERATEDCODE_OFFSET UNITYSDK_OFFSET(0x1B6F9440)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_DESCRIPTORPOOL_OFFSET UNITYSDK_OFFSET(0x1B701D80)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_MESSAGETYPES_OFFSET UNITYSDK_OFFSET(0x1B701D20)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B6F0990)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_PACKAGE_OFFSET UNITYSDK_OFFSET(0x1B6F0590)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_PROTO_OFFSET UNITYSDK_OFFSET(0x1B701CF0)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_PUBLICDEPENDENCIES_OFFSET UNITYSDK_OFFSET(0x1B701D40)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_SERVICES_OFFSET UNITYSDK_OFFSET(0x1B701D30)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_MIHOYO_SDK_PROTOBUF_REFLECTION_IDESCRIPTOR_GET_FILE_OFFSET UNITYSDK_OFFSET(0x1B701D70)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_MIHOYO_SDK_PROTOBUF_REFLECTION_IDESCRIPTOR_GET_FULLNAME_OFFSET UNITYSDK_OFFSET(0x1B701D50)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B703BE0)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7013B0)

namespace MiHoYo::SDK::Protobuf::Reflection
{
	inline static constexpr unsigned int FileDescriptor_TypeDefinitionIndex = 35163;

	class FileDescriptor : public ::System::Object
	{
	public:
		::MiHoYo::SDK::Protobuf::ByteString* _SerializedData_k__BackingField; // 0x10
		::MiHoYo::SDK::Protobuf::Reflection::DescriptorPool* _DescriptorPool_k__BackingField; // 0x18
		::MiHoYo::SDK::Protobuf::Reflection::FileDescriptorProto* _Proto_k__BackingField; // 0x20
		...
		::System::Collections::Generic::IList_1<::MiHoYo::SDK::Protobuf::Reflection::FileDescriptor*>* _PublicDependencies_k__BackingField; // 0x48
