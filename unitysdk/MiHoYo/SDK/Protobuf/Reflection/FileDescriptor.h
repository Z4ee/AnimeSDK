...
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_BUILDFROM_OFFSET UNITYSDK_OFFSET(0x1FB03B30)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_COMPUTEFULLNAME_OFFSET UNITYSDK_OFFSET(0x1FB03A10)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_CROSSLINK_OFFSET UNITYSDK_OFFSET(0x1FB03DA0)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_DETERMINEPUBLICDEPENDENCIES_OFFSET UNITYSDK_OFFSET(0x1FB03600)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_FROMGENERATEDCODE_OFFSET UNITYSDK_OFFSET(0x1FB04650)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_DESCRIPTORPOOL_OFFSET UNITYSDK_OFFSET(0x1FB03B20)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_MESSAGETYPES_OFFSET UNITYSDK_OFFSET(0x1FB03AC0)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1FB03A90)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_PACKAGE_OFFSET UNITYSDK_OFFSET(0x1FB039F0)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_PROTO_OFFSET UNITYSDK_OFFSET(0x1FB03AB0)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_PUBLICDEPENDENCIES_OFFSET UNITYSDK_OFFSET(0x1FB03AE0)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_SERVICES_OFFSET UNITYSDK_OFFSET(0x1FB03AD0)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_MIHOYO_SDK_PROTOBUF_REFLECTION_IDESCRIPTOR_GET_FILE_OFFSET UNITYSDK_OFFSET(0x1FB03B10)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_MIHOYO_SDK_PROTOBUF_REFLECTION_IDESCRIPTOR_GET_FULLNAME_OFFSET UNITYSDK_OFFSET(0x1FB03AF0)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1FB048D0)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1FB03360)

namespace MiHoYo::SDK::Protobuf::Reflection
{
	inline static constexpr unsigned int FileDescriptor_TypeDefinitionIndex = 29173;
	...
	public:
		...
		::System::Collections::Generic::IList_1<::MiHoYo::SDK::Protobuf::Reflection::FileDescriptor*>* _PublicDependencies_k__BackingField; // 0x18
		::MiHoYo::SDK::Protobuf::ByteString* _SerializedData_k__BackingField; // 0x20
		::System::Collections::Generic::IList_1<::MiHoYo::SDK::Protobuf::Reflection::MessageDescriptor*>* _MessageTypes_k__BackingField; // 0x28
		::System::Collections::Generic::IList_1<::MiHoYo::SDK::Protobuf::Reflection::EnumDescriptor*>* _EnumTypes_k__BackingField; // 0x30
		::System::Collections::Generic::IList_1<::MiHoYo::SDK::Protobuf::Reflection::FileDescriptor*>* _Dependencies_k__BackingField; // 0x38
		::MiHoYo::SDK::Protobuf::Reflection::FileDescriptorProto* _Proto_k__BackingField; // 0x40
		::System::Collections::Generic::IList_1<::MiHoYo::SDK::Protobuf::Reflection::ServiceDescriptor*>* _Services_k__BackingField; // 0x48
