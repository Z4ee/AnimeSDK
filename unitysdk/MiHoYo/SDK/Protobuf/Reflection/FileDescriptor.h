...
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_BUILDFROM_OFFSET UNITYSDK_OFFSET(0x15DAF980)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_COMPUTEFULLNAME_OFFSET UNITYSDK_OFFSET(0x15DA84F0)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_CROSSLINK_OFFSET UNITYSDK_OFFSET(0x15DAFBE0)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_DETERMINEPUBLICDEPENDENCIES_OFFSET UNITYSDK_OFFSET(0x15DAF3F0)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_FROMGENERATEDCODE_OFFSET UNITYSDK_OFFSET(0x15DA8090)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_DESCRIPTORPOOL_OFFSET UNITYSDK_OFFSET(0x15DAF970)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_MESSAGETYPES_OFFSET UNITYSDK_OFFSET(0x15DAF910)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_NAME_OFFSET UNITYSDK_OFFSET(0x15D9EB20)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_PACKAGE_OFFSET UNITYSDK_OFFSET(0x15D9E7E0)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_PROTO_OFFSET UNITYSDK_OFFSET(0x15DAF8E0)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_PUBLICDEPENDENCIES_OFFSET UNITYSDK_OFFSET(0x15DAF930)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_SERVICES_OFFSET UNITYSDK_OFFSET(0x15DAF920)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_MIHOYO_SDK_PROTOBUF_REFLECTION_IDESCRIPTOR_GET_FILE_OFFSET UNITYSDK_OFFSET(0x15DAF960)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_MIHOYO_SDK_PROTOBUF_REFLECTION_IDESCRIPTOR_GET_FULLNAME_OFFSET UNITYSDK_OFFSET(0x15DAF940)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x15DB0E30)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x15DAF130)

namespace MiHoYo::SDK::Protobuf::Reflection
{
	inline static constexpr unsigned int FileDescriptor_TypeDefinitionIndex = 28119;

	class FileDescriptor : public ::System::Object
	{
	public:
		::System::Collections::Generic::IList_1<::MiHoYo::SDK::Protobuf::Reflection::FileDescriptor*>* _Dependencies_k__BackingField; // 0x10
		::System::Collections::Generic::IList_1<::MiHoYo::SDK::Protobuf::Reflection::MessageDescriptor*>* _MessageTypes_k__BackingField; // 0x18
		::System::Collections::Generic::IList_1<::MiHoYo::SDK::Protobuf::Reflection::FileDescriptor*>* _PublicDependencies_k__BackingField; // 0x20
		::System::Collections::Generic::IList_1<::MiHoYo::SDK::Protobuf::Reflection::ServiceDescriptor*>* _Services_k__BackingField; // 0x28
		::MiHoYo::SDK::Protobuf::Reflection::FileDescriptorProto* _Proto_k__BackingField; // 0x30
		::MiHoYo::SDK::Protobuf::ByteString* _SerializedData_k__BackingField; // 0x38
		::System::Collections::Generic::IList_1<::MiHoYo::SDK::Protobuf::Reflection::EnumDescriptor*>* _EnumTypes_k__BackingField; // 0x40
		::MiHoYo::SDK::Protobuf::Reflection::DescriptorPool* _DescriptorPool_k__BackingField; // 0x48
