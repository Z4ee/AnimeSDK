...
#define MIHOYO_SDK_PROTOBUF_REFLECTION_DESCRIPTORPOOL_DESCRIPTORINTPAIR_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x20C9120)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_DESCRIPTORPOOL_DESCRIPTORINTPAIR_EQUALS_OFFSET UNITYSDK_OFFSET(0x1635280)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_DESCRIPTORPOOL_DESCRIPTORINTPAIR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x16352B0)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_DESCRIPTORPOOL_DESCRIPTORINTPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x1635270)

namespace MiHoYo::SDK::Protobuf::Reflection
{
	inline static constexpr unsigned int DescriptorPool_DescriptorIntPair_TypeDefinitionIndex = 28109;
