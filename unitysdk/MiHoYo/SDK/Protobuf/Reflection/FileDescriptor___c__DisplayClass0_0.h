...
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR___C__DISPLAYCLASS0_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC2DF20)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR___C__DISPLAYCLASS0_0___CTOR_B__0_OFFSET UNITYSDK_OFFSET(0x1FC2DF30)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR___C__DISPLAYCLASS0_0___CTOR_B__1_OFFSET UNITYSDK_OFFSET(0x1FC2DFE0)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR___C__DISPLAYCLASS0_0___CTOR_B__2_OFFSET UNITYSDK_OFFSET(0x1FC2E090)

namespace MiHoYo::SDK::Protobuf::Reflection
{
	inline static constexpr unsigned int FileDescriptor___c__DisplayClass0_0_TypeDefinitionIndex = 29174;
