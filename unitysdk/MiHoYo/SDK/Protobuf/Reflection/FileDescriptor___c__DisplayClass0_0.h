...
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR___C__DISPLAYCLASS0_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15DAF3E0)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR___C__DISPLAYCLASS0_0___CTOR_B__0_OFFSET UNITYSDK_OFFSET(0x15DB0E80)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR___C__DISPLAYCLASS0_0___CTOR_B__1_OFFSET UNITYSDK_OFFSET(0x15DB12C0)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FILEDESCRIPTOR___C__DISPLAYCLASS0_0___CTOR_B__2_OFFSET UNITYSDK_OFFSET(0x15DB1370)

namespace MiHoYo::SDK::Protobuf::Reflection
{
	inline static constexpr unsigned int FileDescriptor___c__DisplayClass0_0_TypeDefinitionIndex = 28120;
