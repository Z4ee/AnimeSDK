...
{
	inline static constexpr unsigned int RepeatedField_1__GetEnumerator_d__21_TypeDefinitionIndex = 28154;
	...
	public:
		...
		T __2__current; // 0x0
		::MiHoYo::SDK::Protobuf::Collections::RepeatedField_1<T>* __4__this; // 0x0
