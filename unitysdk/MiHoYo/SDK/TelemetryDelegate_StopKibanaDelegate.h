...
#define MIHOYO_SDK_TELEMETRYDELEGATE_STOPKIBANADELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16000360)
#define MIHOYO_SDK_TELEMETRYDELEGATE_STOPKIBANADELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16000390)
#define MIHOYO_SDK_TELEMETRYDELEGATE_STOPKIBANADELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15FFFE10)
#define MIHOYO_SDK_TELEMETRYDELEGATE_STOPKIBANADELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15FFFDF0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int TelemetryDelegate_StopKibanaDelegate_TypeDefinitionIndex = 6703;
