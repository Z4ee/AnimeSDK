...
#define MIHOYO_SDK_TELEMETRYDELEGATE_STOPKIBANADELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DD508E0)
#define MIHOYO_SDK_TELEMETRYDELEGATE_STOPKIBANADELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DD50910)
#define MIHOYO_SDK_TELEMETRYDELEGATE_STOPKIBANADELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DD503C0)
#define MIHOYO_SDK_TELEMETRYDELEGATE_STOPKIBANADELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD503A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int TelemetryDelegate_StopKibanaDelegate_TypeDefinitionIndex = 19809;
