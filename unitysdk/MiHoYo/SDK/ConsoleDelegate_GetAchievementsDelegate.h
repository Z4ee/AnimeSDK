...
#define MIHOYO_SDK_CONSOLEDELEGATE_GETACHIEVEMENTSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18307CC0)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETACHIEVEMENTSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18307CF0)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETACHIEVEMENTSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18307CB0)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETACHIEVEMENTSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18307C40)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_GetAchievementsDelegate_TypeDefinitionIndex = 7592;
