...
#define MIHOYO_SDK_PROTOCOLMANAGER_NATIVEPROTOCOL___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEB29B0)
#define MIHOYO_SDK_PROTOCOLMANAGER_NATIVEPROTOCOL___C__DISPLAYCLASS13_0__TRYSHOWLAUNCHERPROTOCOLCOMPLIANCE_B__1_OFFSET UNITYSDK_OFFSET(0x1CEB29C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ProtocolManager_NativeProtocol___c__DisplayClass13_0_TypeDefinitionIndex = 20153;

	class ProtocolManager_NativeProtocol___c__DisplayClass13_0 : public ::System::Object
	{
	public:
		::MiHoYo::SDK::ProtocolManager_NativeProtocol* __4__this; // 0x10
