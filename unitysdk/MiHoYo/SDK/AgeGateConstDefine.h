...
#define MIHOYO_SDK_AGEGATECONSTDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1885BE70)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AgeGateConstDefine_TypeDefinitionIndex = 7512;
