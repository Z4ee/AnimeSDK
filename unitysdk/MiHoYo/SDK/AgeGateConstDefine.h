...
#define MIHOYO_SDK_AGEGATECONSTDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x173D5D40)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AgeGateConstDefine_TypeDefinitionIndex = 6603;
