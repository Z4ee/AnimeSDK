...
#define MIHOYO_SDK_SDKDELEGATE_LOGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15FEABA0)
#define MIHOYO_SDK_SDKDELEGATE_LOGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15FEABD0)
#define MIHOYO_SDK_SDKDELEGATE_LOGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15FEA650)
#define MIHOYO_SDK_SDKDELEGATE_LOGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15FEA630)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_LogDelegate_TypeDefinitionIndex = 6781;
