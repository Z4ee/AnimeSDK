...
#define MIHOYO_SDK_CONSOLEDELEGATE_SHOWFRIENDINVITATIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CACE620)
#define MIHOYO_SDK_CONSOLEDELEGATE_SHOWFRIENDINVITATIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CACE660)
#define MIHOYO_SDK_CONSOLEDELEGATE_SHOWFRIENDINVITATIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CACE090)
#define MIHOYO_SDK_CONSOLEDELEGATE_SHOWFRIENDINVITATIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CACE070)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_ShowFriendInvitationDelegate_TypeDefinitionIndex = 19789;
