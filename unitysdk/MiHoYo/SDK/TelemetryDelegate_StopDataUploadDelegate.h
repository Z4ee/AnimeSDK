...
#define MIHOYO_SDK_TELEMETRYDELEGATE_STOPDATAUPLOADDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19C8C390)
#define MIHOYO_SDK_TELEMETRYDELEGATE_STOPDATAUPLOADDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19C8C3C0)
#define MIHOYO_SDK_TELEMETRYDELEGATE_STOPDATAUPLOADDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C8BE90)
#define MIHOYO_SDK_TELEMETRYDELEGATE_STOPDATAUPLOADDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C8BE80)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int TelemetryDelegate_StopDataUploadDelegate_TypeDefinitionIndex = 18564;
