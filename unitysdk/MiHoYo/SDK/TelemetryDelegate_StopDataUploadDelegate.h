...
#define MIHOYO_SDK_TELEMETRYDELEGATE_STOPDATAUPLOADDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CF4C370)
#define MIHOYO_SDK_TELEMETRYDELEGATE_STOPDATAUPLOADDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CF4C3A0)
#define MIHOYO_SDK_TELEMETRYDELEGATE_STOPDATAUPLOADDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CF4BE50)
#define MIHOYO_SDK_TELEMETRYDELEGATE_STOPDATAUPLOADDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF4BE30)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int TelemetryDelegate_StopDataUploadDelegate_TypeDefinitionIndex = 19806;
