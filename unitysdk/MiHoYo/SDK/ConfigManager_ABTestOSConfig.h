...
#define MIHOYO_SDK_CONFIGMANAGER_ABTESTOSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1820A880)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConfigManager_ABTestOSConfig_TypeDefinitionIndex = 8150;
