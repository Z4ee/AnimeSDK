...
#define MIHOYO_SDK_HOYOCHANNELINTERFACE___C__DISPLAYCLASS50_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6D9020)
#define MIHOYO_SDK_HOYOCHANNELINTERFACE___C__DISPLAYCLASS50_0__ONCHECKOUTCALLBACK_B__0_OFFSET UNITYSDK_OFFSET(0x1C6E1180)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoChannelInterface___c__DisplayClass50_0_TypeDefinitionIndex = 46989;
