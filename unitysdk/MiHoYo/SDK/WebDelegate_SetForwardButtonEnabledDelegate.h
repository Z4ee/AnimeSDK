...
#define MIHOYO_SDK_WEBDELEGATE_SETFORWARDBUTTONENABLEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16041FB0)
#define MIHOYO_SDK_WEBDELEGATE_SETFORWARDBUTTONENABLEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16042010)
#define MIHOYO_SDK_WEBDELEGATE_SETFORWARDBUTTONENABLEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1603C6E0)
#define MIHOYO_SDK_WEBDELEGATE_SETFORWARDBUTTONENABLEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16041F90)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetForwardButtonEnabledDelegate_TypeDefinitionIndex = 6834;
