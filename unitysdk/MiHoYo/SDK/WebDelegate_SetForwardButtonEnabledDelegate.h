...
#define MIHOYO_SDK_WEBDELEGATE_SETFORWARDBUTTONENABLEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x176A69A0)
#define MIHOYO_SDK_WEBDELEGATE_SETFORWARDBUTTONENABLEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x176A6A00)
#define MIHOYO_SDK_WEBDELEGATE_SETFORWARDBUTTONENABLEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x176A0FE0)
#define MIHOYO_SDK_WEBDELEGATE_SETFORWARDBUTTONENABLEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176A6980)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetForwardButtonEnabledDelegate_TypeDefinitionIndex = 6876;
