...
#define MIHOYO_SDK_WEBDELEGATE_SETFORWARDBUTTONENABLEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CAEF5D0)
#define MIHOYO_SDK_WEBDELEGATE_SETFORWARDBUTTONENABLEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CAEF650)
#define MIHOYO_SDK_WEBDELEGATE_SETFORWARDBUTTONENABLEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CAEEFC0)
#define MIHOYO_SDK_WEBDELEGATE_SETFORWARDBUTTONENABLEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAEEFA0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetForwardButtonEnabledDelegate_TypeDefinitionIndex = 19941;
