...
#define MIHOYO_SDK_WEBDELEGATE_CLEARCOOKIESDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B346360)
#define MIHOYO_SDK_WEBDELEGATE_CLEARCOOKIESDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B346390)
#define MIHOYO_SDK_WEBDELEGATE_CLEARCOOKIESDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B345E60)
#define MIHOYO_SDK_WEBDELEGATE_CLEARCOOKIESDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B345E40)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_ClearCookiesDelegate_TypeDefinitionIndex = 19603;
