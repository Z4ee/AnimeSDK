...
#define MIHOYO_SDK_PSDELEGATE_NOTIFYPREMIUMFEATUREDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1945F0D0)
#define MIHOYO_SDK_PSDELEGATE_NOTIFYPREMIUMFEATUREDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1945F120)
#define MIHOYO_SDK_PSDELEGATE_NOTIFYPREMIUMFEATUREDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1943F3E0)
#define MIHOYO_SDK_PSDELEGATE_NOTIFYPREMIUMFEATUREDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1945F060)
