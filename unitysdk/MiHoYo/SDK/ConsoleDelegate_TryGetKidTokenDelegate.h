...
#define MIHOYO_SDK_CONSOLEDELEGATE_TRYGETKIDTOKENDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DD3C630)
#define MIHOYO_SDK_CONSOLEDELEGATE_TRYGETKIDTOKENDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DD3C660)
#define MIHOYO_SDK_CONSOLEDELEGATE_TRYGETKIDTOKENDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DD3C110)
#define MIHOYO_SDK_CONSOLEDELEGATE_TRYGETKIDTOKENDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD3C0F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_TryGetKidTokenDelegate_TypeDefinitionIndex = 19786;
