...
#define MIHOYO_SDK_HOYOCHANNELONLINESERVICES___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB1F2DD0)
#define MIHOYO_SDK_HOYOCHANNELONLINESERVICES___C__DISPLAYCLASS8_0__ONRESOLVEPRIVILEGECALLBACK_B__0_OFFSET UNITYSDK_OFFSET(0xB1F3990)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoChannelOnlineServices___c__DisplayClass8_0_TypeDefinitionIndex = 47003;
