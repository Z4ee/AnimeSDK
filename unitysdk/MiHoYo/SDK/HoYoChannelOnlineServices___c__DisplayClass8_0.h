...
#define MIHOYO_SDK_HOYOCHANNELONLINESERVICES___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE7D040)
#define MIHOYO_SDK_HOYOCHANNELONLINESERVICES___C__DISPLAYCLASS8_0__ONRESOLVEPRIVILEGECALLBACK_B__0_OFFSET UNITYSDK_OFFSET(0x1CE7D050)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoChannelOnlineServices___c__DisplayClass8_0_TypeDefinitionIndex = 36924;

	class HoYoChannelOnlineServices___c__DisplayClass8_0 : public ::System::Object
	{
	public:
		::System::String* jsonResponse; // 0x10
		::System::Action_1<::MiHoYo::SDK::PC::OS::HoYoChannelPrivilegeResult*>* callback; // 0x18
