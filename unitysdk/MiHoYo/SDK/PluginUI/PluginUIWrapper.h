...
#define MIHOYO_SDK_PLUGINUI_PLUGINUIWRAPPER_CREATEBRIDGEELEMENT_OFFSET UNITYSDK_OFFSET(0x170D8A50)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIWRAPPER_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x170F2740)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIWRAPPER_NOTIFYELEMENTSTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0x170F2F70)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIWRAPPER_NOTIFYGETCAPTCHAFAILED_OFFSET UNITYSDK_OFFSET(0x170F2BC0)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIWRAPPER_NOTIFYGETCAPTCHASUCCESS_OFFSET UNITYSDK_OFFSET(0x170F29E0)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIWRAPPER_NOTIFYHIDEELEMENTS_OFFSET UNITYSDK_OFFSET(0x170F2F60)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIWRAPPER_NOTIFYSHOWELEMENTS_OFFSET UNITYSDK_OFFSET(0x170F2C90)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIWRAPPER_NOTIFYSHOWORHIDEELEMENTS_OFFSET UNITYSDK_OFFSET(0x170F2CA0)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIWRAPPER_UPDATEGETCAPTCHAELEMENTTEXT_OFFSET UNITYSDK_OFFSET(0x170F2B30)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIWRAPPER_UPDATEPLUGINUIELEMENT_OFFSET UNITYSDK_OFFSET(0x170F2820)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIWRAPPER__CCTOR_OFFSET UNITYSDK_OFFSET(0x170F30A0)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x170F2730)

namespace MiHoYo::SDK::PluginUI
{
	inline static constexpr unsigned int PluginUIWrapper_TypeDefinitionIndex = 8827;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PluginUI::PluginUIWrapper**)Il2CppClass::FromTypeDefinitionIndex(PluginUIWrapper_TypeDefinitionIndex)->GetStaticField(0x25CC0);
		}
