...
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x8DA5C70)

namespace MiHoYo::SDK::PluginUI
{
	inline static constexpr unsigned int MiHoYoSDKUIElement_TypeDefinitionIndex = 43433;
