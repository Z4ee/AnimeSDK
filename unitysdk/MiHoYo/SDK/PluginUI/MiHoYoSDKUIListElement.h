...
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUILISTELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0xB28CAF0)

namespace MiHoYo::SDK::PluginUI
{
	inline static constexpr unsigned int MiHoYoSDKUIListElement_TypeDefinitionIndex = 47344;
