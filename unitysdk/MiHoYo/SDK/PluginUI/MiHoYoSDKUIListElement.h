...
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUILISTELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0xA1F61D0)

namespace MiHoYo::SDK::PluginUI
{
	inline static constexpr unsigned int MiHoYoSDKUIListElement_TypeDefinitionIndex = 44238;

	class MiHoYoSDKUIListElement : public ::MiHoYo::SDK::PluginUI::MiHoYoSDKUIElement
	{
	public:
		::System::Collections::Generic::List_1<::MiHoYo::SDK::PluginUI::MiHoYoSDKUIListItem*>* lstItem; // 0x40
