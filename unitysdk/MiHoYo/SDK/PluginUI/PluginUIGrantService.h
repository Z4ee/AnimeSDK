...
#define MIHOYO_SDK_PLUGINUI_PLUGINUIGRANTSERVICE_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1B9E0870)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIGRANTSERVICE_ONCREATESERVICE_OFFSET UNITYSDK_OFFSET(0x1B9E0950)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIGRANTSERVICE_SHOWGRANTPHONEPLUGINUI_OFFSET UNITYSDK_OFFSET(0x1B9E0A60)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIGRANTSERVICE_SHOWOVERSEAGRANTMAILPLUGINUI_OFFSET UNITYSDK_OFFSET(0x1B9E1150)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIGRANTSERVICE_SHOWOVERSEAGRANTPHONEPLUGINUI_OFFSET UNITYSDK_OFFSET(0x1B9E1A90)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIGRANTSERVICE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B9E23D0)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIGRANTSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E0860)

namespace MiHoYo::SDK::PluginUI
{
	inline static constexpr unsigned int PluginUIGrantService_TypeDefinitionIndex = 20891;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PluginUI::PluginUIGrantService**)Il2CppClass::FromTypeDefinitionIndex(PluginUIGrantService_TypeDefinitionIndex)->GetStaticField(0xAA90);
		}
