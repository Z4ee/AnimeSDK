...
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER__ADDTIME_D__22_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1C6B6470)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER__ADDTIME_D__22_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C6B6510)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER__ADDTIME_D__22_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C6B6570)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER__ADDTIME_D__22_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1C6B6520)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER__ADDTIME_D__22_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C6B6460)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER__ADDTIME_D__22__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6B6080)

namespace MiHoYo::SDK::PluginUI
{
	inline static constexpr unsigned int MiHoYoSDKUIManager__AddTime_d__22_TypeDefinitionIndex = 47348;
