...
#define MIHOYO_SDK_PLUGINUI_PLUGINUIDATASECURITYSERVICE_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1D4B5DC0)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIDATASECURITYSERVICE_ONCREATESERVICE_OFFSET UNITYSDK_OFFSET(0x1D4B5EA0)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIDATASECURITYSERVICE_SHOWOVERSEACONSENTBANNERMANAGEPREFERENCESPLUGINUI_OFFSET UNITYSDK_OFFSET(0x1D4B6610)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIDATASECURITYSERVICE_SHOWOVERSEACONSENTBANNERPRIVACYPLUGINUI_OFFSET UNITYSDK_OFFSET(0x1D4B5F60)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIDATASECURITYSERVICE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D4B7420)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIDATASECURITYSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4B5DB0)

namespace MiHoYo::SDK::PluginUI
{
	inline static constexpr unsigned int PluginUIDataSecurityService_TypeDefinitionIndex = 21233;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PluginUI::PluginUIDataSecurityService**)Il2CppClass::FromTypeDefinitionIndex(PluginUIDataSecurityService_TypeDefinitionIndex)->GetStaticField(0xACE0);
		}
