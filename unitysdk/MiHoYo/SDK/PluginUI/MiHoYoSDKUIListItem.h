...
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUILISTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6B3EE0)

namespace MiHoYo::SDK::PluginUI
{
	inline static constexpr unsigned int MiHoYoSDKUIListItem_TypeDefinitionIndex = 47343;
