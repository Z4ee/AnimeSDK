...
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUILISTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA1F61E0)

namespace MiHoYo::SDK::PluginUI
{
	inline static constexpr unsigned int MiHoYoSDKUIListItem_TypeDefinitionIndex = 44237;
