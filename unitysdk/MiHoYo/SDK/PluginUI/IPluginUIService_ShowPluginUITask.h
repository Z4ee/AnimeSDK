...
#define MIHOYO_SDK_PLUGINUI_IPLUGINUISERVICE_SHOWPLUGINUITASK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBCD5C0)
#define MIHOYO_SDK_PLUGINUI_IPLUGINUISERVICE_SHOWPLUGINUITASK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBCD600)
#define MIHOYO_SDK_PLUGINUI_IPLUGINUISERVICE_SHOWPLUGINUITASK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBCD040)
#define MIHOYO_SDK_PLUGINUI_IPLUGINUISERVICE_SHOWPLUGINUITASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBCD020)

namespace MiHoYo::SDK::PluginUI
{
	inline static constexpr unsigned int IPluginUIService_ShowPluginUITask_TypeDefinitionIndex = 20895;
