...
#define MIHOYO_SDK_PLUGINUI_PLUGINUIBRIDGELIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA15D80)

namespace MiHoYo::SDK::PluginUI
{
	inline static constexpr unsigned int PluginUIBridgeList_TypeDefinitionIndex = 21259;
