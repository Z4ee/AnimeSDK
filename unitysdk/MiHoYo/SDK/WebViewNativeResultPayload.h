...
#define MIHOYO_SDK_WEBVIEWNATIVERESULTPAYLOAD__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD513A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebViewNativeResultPayload_TypeDefinitionIndex = 47065;
