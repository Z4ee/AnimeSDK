...
#define MIHOYO_SDK_WEBVIEWNATIVERESULTPAYLOAD__CTOR_OFFSET UNITYSDK_OFFSET(0x8DE0710)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebViewNativeResultPayload_TypeDefinitionIndex = 43164;
