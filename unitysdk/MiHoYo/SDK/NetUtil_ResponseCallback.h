...
#define MIHOYO_SDK_NETUTIL_RESPONSECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15F3EC00)
#define MIHOYO_SDK_NETUTIL_RESPONSECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15F3EC40)
#define MIHOYO_SDK_NETUTIL_RESPONSECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x15F3BB30)
#define MIHOYO_SDK_NETUTIL_RESPONSECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x15F3A5E0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int NetUtil_ResponseCallback_TypeDefinitionIndex = 7179;
