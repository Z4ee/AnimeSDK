...
#define MIHOYO_SDK_NETWORKRESPONSEMODEL_TOJSONOBJECT_OFFSET UNITYSDK_OFFSET(0x18379B70)
#define MIHOYO_SDK_NETWORKRESPONSEMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x18374FD0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int NetworkResponseModel_TypeDefinitionIndex = 8119;
