...
#define MIHOYO_SDK_BROWSERWIN32HELPER_WNDPROCDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x84C6AC0)
#define MIHOYO_SDK_BROWSERWIN32HELPER_WNDPROCDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x84C6BB0)
#define MIHOYO_SDK_BROWSERWIN32HELPER_WNDPROCDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x84C6630)
#define MIHOYO_SDK_BROWSERWIN32HELPER_WNDPROCDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x84C3860)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int BrowserWin32Helper_WndProcDelegate_TypeDefinitionIndex = 37290;
