...
#define MIHOYO_SDK_BROWSERWIN32HELPER_WNDPROCDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16A8AA40)
#define MIHOYO_SDK_BROWSERWIN32HELPER_WNDPROCDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16A8AB30)
#define MIHOYO_SDK_BROWSERWIN32HELPER_WNDPROCDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x16A8AA00)
#define MIHOYO_SDK_BROWSERWIN32HELPER_WNDPROCDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16A8A990)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int BrowserWin32Helper_WndProcDelegate_TypeDefinitionIndex = 47068;
