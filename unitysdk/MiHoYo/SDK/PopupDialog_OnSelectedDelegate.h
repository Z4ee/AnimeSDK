...
#define MIHOYO_SDK_POPUPDIALOG_ONSELECTEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x183FB630)
#define MIHOYO_SDK_POPUPDIALOG_ONSELECTEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x183FB6A0)
#define MIHOYO_SDK_POPUPDIALOG_ONSELECTEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x183FB3D0)
#define MIHOYO_SDK_POPUPDIALOG_ONSELECTEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x183FB5C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PopupDialog_OnSelectedDelegate_TypeDefinitionIndex = 7953;
