...
#define MIHOYO_SDK_BILIBILICONFIGMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x173E8800)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int BilibiliConfigModel_TypeDefinitionIndex = 6938;
