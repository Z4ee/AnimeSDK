...
#define MIHOYO_SDK_BILIBILICONFIGMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1886D5D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int BilibiliConfigModel_TypeDefinitionIndex = 7847;
