...
#define MIHOYO_SDK_WEB_ONWEBVIEWNATIVEREADY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15C23760)
#define MIHOYO_SDK_WEB_ONWEBVIEWNATIVEREADY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15C23790)
#define MIHOYO_SDK_WEB_ONWEBVIEWNATIVEREADY_INVOKE_OFFSET UNITYSDK_OFFSET(0x15C22A50)
#define MIHOYO_SDK_WEB_ONWEBVIEWNATIVEREADY__CTOR_OFFSET UNITYSDK_OFFSET(0x15C23670)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int Web_OnWebViewNativeReady_TypeDefinitionIndex = 8171;
