...
#define MIHOYO_SDK_WEB_ONWEBVIEWNATIVEREADY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CD7DBC0)
#define MIHOYO_SDK_WEB_ONWEBVIEWNATIVEREADY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CD7DBF0)
#define MIHOYO_SDK_WEB_ONWEBVIEWNATIVEREADY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CD7CEE0)
#define MIHOYO_SDK_WEB_ONWEBVIEWNATIVEREADY__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD7DAD0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int Web_OnWebViewNativeReady_TypeDefinitionIndex = 8177;
