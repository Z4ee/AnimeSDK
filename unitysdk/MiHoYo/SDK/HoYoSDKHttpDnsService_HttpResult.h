...
#define MIHOYO_SDK_HOYOSDKHTTPDNSSERVICE_HTTPRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0xA16C340)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoSDKHttpDnsService_HttpResult_TypeDefinitionIndex = 43505;
