...
#define MIHOYO_SDK_HOYOSDKHTTPDNSSERVICE_HTTPRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D27D610)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoSDKHttpDnsService_HttpResult_TypeDefinitionIndex = 37142;
