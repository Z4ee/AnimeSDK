...
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWINPUTENABLESTATUS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19952320)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWINPUTENABLESTATUS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19952350)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWINPUTENABLESTATUS_INVOKE_OFFSET UNITYSDK_OFFSET(0x19951E20)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWINPUTENABLESTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x19951E10)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_OnWebViewInputEnableStatus_TypeDefinitionIndex = 18683;
