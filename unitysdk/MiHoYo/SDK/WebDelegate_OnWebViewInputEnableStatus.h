...
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWINPUTENABLESTATUS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x176A5970)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWINPUTENABLESTATUS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x176A59A0)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWINPUTENABLESTATUS_INVOKE_OFFSET UNITYSDK_OFFSET(0x17693B10)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWINPUTENABLESTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x176A5950)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_OnWebViewInputEnableStatus_TypeDefinitionIndex = 6861;
