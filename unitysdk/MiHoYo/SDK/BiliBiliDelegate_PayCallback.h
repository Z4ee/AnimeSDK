...
#define MIHOYO_SDK_BILIBILIDELEGATE_PAYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A33EA40)
#define MIHOYO_SDK_BILIBILIDELEGATE_PAYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A33EAC0)
#define MIHOYO_SDK_BILIBILIDELEGATE_PAYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A33E4E0)
#define MIHOYO_SDK_BILIBILIDELEGATE_PAYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A33E4D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int BiliBiliDelegate_PayCallback_TypeDefinitionIndex = 18475;
