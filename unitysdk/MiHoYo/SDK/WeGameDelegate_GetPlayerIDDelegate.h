...
#define MIHOYO_SDK_WEGAMEDELEGATE_GETPLAYERIDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D774B20)
#define MIHOYO_SDK_WEGAMEDELEGATE_GETPLAYERIDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D774B50)
#define MIHOYO_SDK_WEGAMEDELEGATE_GETPLAYERIDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D774890)
#define MIHOYO_SDK_WEGAMEDELEGATE_GETPLAYERIDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D774870)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WeGameDelegate_GetPlayerIDDelegate_TypeDefinitionIndex = 19817;
