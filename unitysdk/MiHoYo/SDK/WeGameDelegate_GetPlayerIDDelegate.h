...
#define MIHOYO_SDK_WEGAMEDELEGATE_GETPLAYERIDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C39C9B0)
#define MIHOYO_SDK_WEGAMEDELEGATE_GETPLAYERIDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C39C9E0)
#define MIHOYO_SDK_WEGAMEDELEGATE_GETPLAYERIDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C39C710)
#define MIHOYO_SDK_WEGAMEDELEGATE_GETPLAYERIDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C39C6F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WeGameDelegate_GetPlayerIDDelegate_TypeDefinitionIndex = 19470;
