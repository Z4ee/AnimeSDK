...
#define MIHOYO_SDK_CONSOLEDELEGATE_UPDATESTATISTICSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A9948F0)
#define MIHOYO_SDK_CONSOLEDELEGATE_UPDATESTATISTICSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A994920)
#define MIHOYO_SDK_CONSOLEDELEGATE_UPDATESTATISTICSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A9943F0)
#define MIHOYO_SDK_CONSOLEDELEGATE_UPDATESTATISTICSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9943D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_UpdateStatisticsDelegate_TypeDefinitionIndex = 19434;
