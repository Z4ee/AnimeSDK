...
#define MIHOYO_SDK_BILIBILIDELEGATE_SDKUNINITDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1886D570)
#define MIHOYO_SDK_BILIBILIDELEGATE_SDKUNINITDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1886D5A0)
#define MIHOYO_SDK_BILIBILIDELEGATE_SDKUNINITDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1886D560)
#define MIHOYO_SDK_BILIBILIDELEGATE_SDKUNINITDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1886D4F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int BiliBiliDelegate_SDKUnInitDelegate_TypeDefinitionIndex = 7565;
