...
#define MIHOYO_SDK_CONSOLEDELEGATE_LEAVEMATCHDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17515990)
#define MIHOYO_SDK_CONSOLEDELEGATE_LEAVEMATCHDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x175159D0)
#define MIHOYO_SDK_CONSOLEDELEGATE_LEAVEMATCHDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x17515410)
#define MIHOYO_SDK_CONSOLEDELEGATE_LEAVEMATCHDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x175153F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_LeaveMatchDelegate_TypeDefinitionIndex = 6709;
