...
#define MIHOYO_SDK_CONSOLEDELEGATE_LEAVEMATCHDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15ED1AE0)
#define MIHOYO_SDK_CONSOLEDELEGATE_LEAVEMATCHDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15ED1B20)
#define MIHOYO_SDK_CONSOLEDELEGATE_LEAVEMATCHDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15ED1560)
#define MIHOYO_SDK_CONSOLEDELEGATE_LEAVEMATCHDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15ED1540)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_LeaveMatchDelegate_TypeDefinitionIndex = 6675;
