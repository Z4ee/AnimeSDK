...
#define MIHOYO_SDK_CONSOLEDELEGATE_LEAVEMATCHDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C0D6AF0)
#define MIHOYO_SDK_CONSOLEDELEGATE_LEAVEMATCHDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C0D6B30)
#define MIHOYO_SDK_CONSOLEDELEGATE_LEAVEMATCHDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C0D6570)
#define MIHOYO_SDK_CONSOLEDELEGATE_LEAVEMATCHDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0D6550)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_LeaveMatchDelegate_TypeDefinitionIndex = 19415;
