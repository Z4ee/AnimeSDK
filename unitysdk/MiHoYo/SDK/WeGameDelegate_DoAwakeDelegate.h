...
#define MIHOYO_SDK_WEGAMEDELEGATE_DOAWAKEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18460C60)
#define MIHOYO_SDK_WEGAMEDELEGATE_DOAWAKEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18460C90)
#define MIHOYO_SDK_WEGAMEDELEGATE_DOAWAKEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18460C50)
#define MIHOYO_SDK_WEGAMEDELEGATE_DOAWAKEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18460BE0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WeGameDelegate_DoAwakeDelegate_TypeDefinitionIndex = 7658;
