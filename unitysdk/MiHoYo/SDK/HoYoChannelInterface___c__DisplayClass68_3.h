...
#define MIHOYO_SDK_HOYOCHANNELINTERFACE___C__DISPLAYCLASS68_3__CLEANUPTIMEDOUTCALLBACKS_B__3_OFFSET UNITYSDK_OFFSET(0x1CC4D0D0)
#define MIHOYO_SDK_HOYOCHANNELINTERFACE___C__DISPLAYCLASS68_3__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC4D0C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoChannelInterface___c__DisplayClass68_3_TypeDefinitionIndex = 37581;
