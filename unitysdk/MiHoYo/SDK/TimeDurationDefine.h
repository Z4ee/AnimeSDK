...
#define MIHOYO_SDK_TIMEDURATIONDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A521AB0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int TimeDurationDefine_TypeDefinitionIndex = 18470;
