...
#define MIHOYO_SDK_TIMEDURATIONDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9BAD30)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int TimeDurationDefine_TypeDefinitionIndex = 7545;
