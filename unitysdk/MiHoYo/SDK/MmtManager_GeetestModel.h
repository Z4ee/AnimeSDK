...
#define MIHOYO_SDK_MMTMANAGER_GEETESTMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A637F40)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MmtManager_GeetestModel_TypeDefinitionIndex = 7993;
