...
#define MIHOYO_SDK_MMTMANAGER_GEETESTMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x18369F80)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MmtManager_GeetestModel_TypeDefinitionIndex = 7979;
