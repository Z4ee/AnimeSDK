...
#define MIHOYO_SDK_INPUTSYSTEM_COMMONADAPTER_GETBUTTONDOWN_OFFSET UNITYSDK_OFFSET(0x1D2D7080)
#define MIHOYO_SDK_INPUTSYSTEM_COMMONADAPTER_GETBUTTONUP_OFFSET UNITYSDK_OFFSET(0x1D2D72E0)
#define MIHOYO_SDK_INPUTSYSTEM_COMMONADAPTER_GETBUTTON_OFFSET UNITYSDK_OFFSET(0x1D2D71B0)
#define MIHOYO_SDK_INPUTSYSTEM_COMMONADAPTER_GETTOUCH_OFFSET UNITYSDK_OFFSET(0x1D2D7410)
#define MIHOYO_SDK_INPUTSYSTEM_COMMONADAPTER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1D2D6EC0)
#define MIHOYO_SDK_INPUTSYSTEM_COMMONADAPTER_REGISTERSERVICE_OFFSET UNITYSDK_OFFSET(0x1D2D7590)
#define MIHOYO_SDK_INPUTSYSTEM_COMMONADAPTER_SETINPUTACTIONASSET_OFFSET UNITYSDK_OFFSET(0x1D2D6F50)
#define MIHOYO_SDK_INPUTSYSTEM_COMMONADAPTER_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1D2D6F40)
#define MIHOYO_SDK_INPUTSYSTEM_COMMONADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2D6F30)

namespace MiHoYo::SDK::InputSystem
{
	inline static constexpr unsigned int CommonAdapter_TypeDefinitionIndex = 9801;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::InputSystem::CommonAdapter**)Il2CppClass::FromTypeDefinitionIndex(CommonAdapter_TypeDefinitionIndex)->GetStaticField(0x7A0);
		}
