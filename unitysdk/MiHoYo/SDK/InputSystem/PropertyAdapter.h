...
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_GETIMECOMPOSITIONMODE_OFFSET UNITYSDK_OFFSET(0x181971D0)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_GETMOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x18196D50)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_GETMOUSESCROLLDELTA_OFFSET UNITYSDK_OFFSET(0x18196FA0)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_GETSIMULATEMOUSEWITHTOUCHES_OFFSET UNITYSDK_OFFSET(0x18197860)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_GETTOUCHCOUNT_OFFSET UNITYSDK_OFFSET(0x18197630)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x18195A60)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_REGISTERSERVICE_OFFSET UNITYSDK_OFFSET(0x181986A0)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_SETIMECOMPOSITIONMODE_OFFSET UNITYSDK_OFFSET(0x18197400)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_SETSIMULATEMOUSEWITHTOUCHES_OFFSET UNITYSDK_OFFSET(0x18197A90)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x18198690)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18198680)

namespace MiHoYo::SDK::InputSystem
{
	inline static constexpr unsigned int PropertyAdapter_TypeDefinitionIndex = 9791;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::InputSystem::PropertyAdapter**)Il2CppClass::FromTypeDefinitionIndex(PropertyAdapter_TypeDefinitionIndex)->GetStaticField(0xB80);
		}
