...
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_GETIMECOMPOSITIONMODE_OFFSET UNITYSDK_OFFSET(0x15D8F080)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_GETMOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x15D8EC00)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_GETMOUSESCROLLDELTA_OFFSET UNITYSDK_OFFSET(0x15D8EE50)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_GETSIMULATEMOUSEWITHTOUCHES_OFFSET UNITYSDK_OFFSET(0x15D8F710)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_GETTOUCHCOUNT_OFFSET UNITYSDK_OFFSET(0x15D8F4E0)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x15D8D940)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_REGISTERSERVICE_OFFSET UNITYSDK_OFFSET(0x15D905B0)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_SETIMECOMPOSITIONMODE_OFFSET UNITYSDK_OFFSET(0x15D8F2B0)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_SETSIMULATEMOUSEWITHTOUCHES_OFFSET UNITYSDK_OFFSET(0x15D8F940)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x15D90570)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x15D90560)

namespace MiHoYo::SDK::InputSystem
{
	inline static constexpr unsigned int PropertyAdapter_TypeDefinitionIndex = 9829;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::InputSystem::PropertyAdapter**)Il2CppClass::FromTypeDefinitionIndex(PropertyAdapter_TypeDefinitionIndex)->GetStaticField(0x7E0);
		}
