...
#define MIHOYO_SDK_INPUTSYSTEM_KEYBOARDADAPTER_GETKEYDOWN_OFFSET UNITYSDK_OFFSET(0x1EFE71E0)
#define MIHOYO_SDK_INPUTSYSTEM_KEYBOARDADAPTER_GETKEYUP_OFFSET UNITYSDK_OFFSET(0x1EFE76D0)
#define MIHOYO_SDK_INPUTSYSTEM_KEYBOARDADAPTER_GETKEY_OFFSET UNITYSDK_OFFSET(0x1EFE7450)
#define MIHOYO_SDK_INPUTSYSTEM_KEYBOARDADAPTER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1EFE4D60)
#define MIHOYO_SDK_INPUTSYSTEM_KEYBOARDADAPTER_REGISTERSERVICE_OFFSET UNITYSDK_OFFSET(0x1EFE7950)
#define MIHOYO_SDK_INPUTSYSTEM_KEYBOARDADAPTER_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1EFE71D0)
#define MIHOYO_SDK_INPUTSYSTEM_KEYBOARDADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFE71C0)

namespace MiHoYo::SDK::InputSystem
{
	inline static constexpr unsigned int KeyboardAdapter_TypeDefinitionIndex = 10083;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::InputSystem::KeyboardAdapter**)Il2CppClass::FromTypeDefinitionIndex(KeyboardAdapter_TypeDefinitionIndex)->GetStaticField(0x730);
		}
