...
#define MIHOYO_SDK_INPUTSYSTEM_KEYBOARDADAPTER_GETKEYDOWN_OFFSET UNITYSDK_OFFSET(0x1FA91C80)
#define MIHOYO_SDK_INPUTSYSTEM_KEYBOARDADAPTER_GETKEYUP_OFFSET UNITYSDK_OFFSET(0x1FA92030)
#define MIHOYO_SDK_INPUTSYSTEM_KEYBOARDADAPTER_GETKEY_OFFSET UNITYSDK_OFFSET(0x1FA91E50)
#define MIHOYO_SDK_INPUTSYSTEM_KEYBOARDADAPTER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1FA8F380)
#define MIHOYO_SDK_INPUTSYSTEM_KEYBOARDADAPTER_REGISTERSERVICE_OFFSET UNITYSDK_OFFSET(0x1FA92210)
#define MIHOYO_SDK_INPUTSYSTEM_KEYBOARDADAPTER_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1FA91C70)
#define MIHOYO_SDK_INPUTSYSTEM_KEYBOARDADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FA91C60)

namespace MiHoYo::SDK::InputSystem
{
	inline static constexpr unsigned int KeyboardAdapter_TypeDefinitionIndex = 19619;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::InputSystem::KeyboardAdapter**)Il2CppClass::FromTypeDefinitionIndex(KeyboardAdapter_TypeDefinitionIndex)->GetStaticField(0x8F80);
		}
