...
#define MIHOYO_SDK_INPUTSYSTEM_JOYSTICKADAPTER_GETKEYDOWN_OFFSET UNITYSDK_OFFSET(0x1FA91980)
#define MIHOYO_SDK_INPUTSYSTEM_JOYSTICKADAPTER_GETKEYUP_OFFSET UNITYSDK_OFFSET(0x1FA91B60)
#define MIHOYO_SDK_INPUTSYSTEM_JOYSTICKADAPTER_GETKEY_OFFSET UNITYSDK_OFFSET(0x1FA91A70)
#define MIHOYO_SDK_INPUTSYSTEM_JOYSTICKADAPTER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1FA8F260)
#define MIHOYO_SDK_INPUTSYSTEM_JOYSTICKADAPTER_REGISTERSERVICE_OFFSET UNITYSDK_OFFSET(0x1FA91C50)
#define MIHOYO_SDK_INPUTSYSTEM_JOYSTICKADAPTER_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1FA91970)
#define MIHOYO_SDK_INPUTSYSTEM_JOYSTICKADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FA91960)

namespace MiHoYo::SDK::InputSystem
{
	inline static constexpr unsigned int JoystickAdapter_TypeDefinitionIndex = 19618;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::InputSystem::JoystickAdapter**)Il2CppClass::FromTypeDefinitionIndex(JoystickAdapter_TypeDefinitionIndex)->GetStaticField(0x8F70);
		}
