...
#define MIHOYO_SDK_SDKDELEGATE_ONGYROSCOPEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15FEC660)
#define MIHOYO_SDK_SDKDELEGATE_ONGYROSCOPEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15FEC6D0)
#define MIHOYO_SDK_SDKDELEGATE_ONGYROSCOPEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15FEC110)
#define MIHOYO_SDK_SDKDELEGATE_ONGYROSCOPEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15FEC0F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_OnGyroscopeDelegate_TypeDefinitionIndex = 6800;
