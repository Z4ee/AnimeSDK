...
#define MIHOYO_SDK_SDKDELEGATE_SHOWTEXTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A07FF00)
#define MIHOYO_SDK_SDKDELEGATE_SHOWTEXTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A07FF30)
#define MIHOYO_SDK_SDKDELEGATE_SHOWTEXTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A07FA00)
#define MIHOYO_SDK_SDKDELEGATE_SHOWTEXTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A07F9F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_ShowTextDelegate_TypeDefinitionIndex = 18644;
