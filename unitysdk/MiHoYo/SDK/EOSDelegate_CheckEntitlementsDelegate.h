...
#define MIHOYO_SDK_EOSDELEGATE_CHECKENTITLEMENTSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1830D640)
#define MIHOYO_SDK_EOSDELEGATE_CHECKENTITLEMENTSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1830D670)
#define MIHOYO_SDK_EOSDELEGATE_CHECKENTITLEMENTSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1830D630)
#define MIHOYO_SDK_EOSDELEGATE_CHECKENTITLEMENTSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1830D5C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int EOSDelegate_CheckEntitlementsDelegate_TypeDefinitionIndex = 7666;
