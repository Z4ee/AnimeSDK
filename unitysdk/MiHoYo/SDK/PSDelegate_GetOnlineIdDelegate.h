...
#define MIHOYO_SDK_PSDELEGATE_GETONLINEIDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BA75100)
#define MIHOYO_SDK_PSDELEGATE_GETONLINEIDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BA75130)
#define MIHOYO_SDK_PSDELEGATE_GETONLINEIDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BA750F0)
#define MIHOYO_SDK_PSDELEGATE_GETONLINEIDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA75080)
