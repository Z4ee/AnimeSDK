...
#define MIHOYO_SDK_SERVERREGIONMANAGER_COUNTRYCODE__CCTOR_OFFSET UNITYSDK_OFFSET(0x15FFA8F0)
#define MIHOYO_SDK_SERVERREGIONMANAGER_COUNTRYCODE__CTOR_OFFSET UNITYSDK_OFFSET(0x15FFA8E0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ServerRegionManager_CountryCode_TypeDefinitionIndex = 6964;
	...
	public:
		...
		{
			return (::System::Collections::Generic::HashSet_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ServerRegionManager_CountryCode_TypeDefinitionIndex)->GetStaticField(0x18990);
		}
