...
#define MIHOYO_SDK_SERVERREGIONMANAGER_COUNTRYCODE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1712BD10)
#define MIHOYO_SDK_SERVERREGIONMANAGER_COUNTRYCODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1712BD00)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ServerRegionManager_CountryCode_TypeDefinitionIndex = 7919;
	...
	public:
		...
		{
			return (::System::Collections::Generic::HashSet_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ServerRegionManager_CountryCode_TypeDefinitionIndex)->GetStaticField(0x276D0);
		}
