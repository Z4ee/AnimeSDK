...
#define MIHOYO_SDK_CONSOLEDELEGATE_TRYGETAUTHCODEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1751D440)
#define MIHOYO_SDK_CONSOLEDELEGATE_TRYGETAUTHCODEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1751D480)
#define MIHOYO_SDK_CONSOLEDELEGATE_TRYGETAUTHCODEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1751CEC0)
#define MIHOYO_SDK_CONSOLEDELEGATE_TRYGETAUTHCODEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1751CEA0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_TryGetAuthCodeDelegate_TypeDefinitionIndex = 6693;
