...
#define MIHOYO_SDK_CONSOLEDELEGATE_TRYGETAUTHCODEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BDCAC10)
#define MIHOYO_SDK_CONSOLEDELEGATE_TRYGETAUTHCODEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BDCAC50)
#define MIHOYO_SDK_CONSOLEDELEGATE_TRYGETAUTHCODEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BDCA680)
#define MIHOYO_SDK_CONSOLEDELEGATE_TRYGETAUTHCODEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDCA660)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_TryGetAuthCodeDelegate_TypeDefinitionIndex = 19746;
