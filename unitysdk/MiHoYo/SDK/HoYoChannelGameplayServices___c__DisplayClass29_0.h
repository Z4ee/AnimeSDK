...
#define MIHOYO_SDK_HOYOCHANNELGAMEPLAYSERVICES___C__DISPLAYCLASS29_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1D39CD40)
#define MIHOYO_SDK_HOYOCHANNELGAMEPLAYSERVICES___C__DISPLAYCLASS29_0__ONINVITECALLBACK_B__0_OFFSET UNITYSDK_OFFSET(0x1D39CD50)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoChannelGameplayServices___c__DisplayClass29_0_TypeDefinitionIndex = 37560;

	class HoYoChannelGameplayServices___c__DisplayClass29_0 : public ::System::Object
	{
	public:
		::System::String* jsonResponse; // 0x10
		::System::Action_1<::MiHoYo::SDK::PC::OS::HoYoChannelInviteResult*>* callback; // 0x18
