...
#define MIHOYO_SDK_WEBDELEGATE_SETFRAMEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BB16760)
#define MIHOYO_SDK_WEBDELEGATE_SETFRAMEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BB16810)
#define MIHOYO_SDK_WEBDELEGATE_SETFRAMEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BB12630)
#define MIHOYO_SDK_WEBDELEGATE_SETFRAMEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB16670)
