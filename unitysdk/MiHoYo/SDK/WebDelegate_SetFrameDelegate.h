...
#define MIHOYO_SDK_WEBDELEGATE_SETFRAMEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18466150)
#define MIHOYO_SDK_WEBDELEGATE_SETFRAMEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18466200)
#define MIHOYO_SDK_WEBDELEGATE_SETFRAMEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18462100)
#define MIHOYO_SDK_WEBDELEGATE_SETFRAMEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18466060)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetFrameDelegate_TypeDefinitionIndex = 7782;
