...
#define MIHOYO_SDK_WATERMARK_WATERMARKCODEDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD75490)

namespace MiHoYo::SDK::Watermark
{
	inline static constexpr unsigned int WatermarkCodeDefine_TypeDefinitionIndex = 8804;
