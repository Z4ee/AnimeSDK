...
#define MIHOYO_SDK_WATERMARK_WATERMARKCODEDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x19FEF3F0)

namespace MiHoYo::SDK::Watermark
{
	inline static constexpr unsigned int WatermarkCodeDefine_TypeDefinitionIndex = 19449;
