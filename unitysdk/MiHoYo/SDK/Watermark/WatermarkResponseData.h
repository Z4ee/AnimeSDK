...
#define MIHOYO_SDK_WATERMARK_WATERMARKRESPONSEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1602AE40)

namespace MiHoYo::SDK::Watermark
{
	inline static constexpr unsigned int WatermarkResponseData_TypeDefinitionIndex = 7493;
