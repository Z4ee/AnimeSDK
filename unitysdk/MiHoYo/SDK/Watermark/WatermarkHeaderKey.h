...
#define MIHOYO_SDK_WATERMARK_WATERMARKHEADERKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x1845B020)

namespace MiHoYo::SDK::Watermark
{
	inline static constexpr unsigned int WatermarkHeaderKey_TypeDefinitionIndex = 8535;
