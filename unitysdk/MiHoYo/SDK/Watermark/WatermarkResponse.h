...
#define MIHOYO_SDK_WATERMARK_WATERMARKRESPONSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD1A4C0)

namespace MiHoYo::SDK::Watermark
{
	inline static constexpr unsigned int WatermarkResponse_TypeDefinitionIndex = 20970;
