...
#define MIHOYO_SDK_WATERMARK_WATERMARKREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x17689E60)

namespace MiHoYo::SDK::Watermark
{
	inline static constexpr unsigned int WatermarkRequest_TypeDefinitionIndex = 7633;
