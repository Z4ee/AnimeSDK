...
#define MIHOYO_SDK_WATERMARK_WATERMARKREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBD1750)

namespace MiHoYo::SDK::Watermark
{
	inline static constexpr unsigned int WatermarkRequest_TypeDefinitionIndex = 20621;
