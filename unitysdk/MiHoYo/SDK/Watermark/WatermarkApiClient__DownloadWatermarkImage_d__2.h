...
#define MIHOYO_SDK_WATERMARK_WATERMARKAPICLIENT__DOWNLOADWATERMARKIMAGE_D__2_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1CD1A1B0)
#define MIHOYO_SDK_WATERMARK_WATERMARKAPICLIENT__DOWNLOADWATERMARKIMAGE_D__2_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CD1A270)
#define MIHOYO_SDK_WATERMARK_WATERMARKAPICLIENT__DOWNLOADWATERMARKIMAGE_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CD1A2D0)
#define MIHOYO_SDK_WATERMARK_WATERMARKAPICLIENT__DOWNLOADWATERMARKIMAGE_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1CD1A280)
#define MIHOYO_SDK_WATERMARK_WATERMARKAPICLIENT__DOWNLOADWATERMARKIMAGE_D__2_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CD1A1A0)
#define MIHOYO_SDK_WATERMARK_WATERMARKAPICLIENT__DOWNLOADWATERMARKIMAGE_D__2__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD1A190)

namespace MiHoYo::SDK::Watermark
{
	inline static constexpr unsigned int WatermarkApiClient__DownloadWatermarkImage_d__2_TypeDefinitionIndex = 20955;
