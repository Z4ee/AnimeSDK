...
#define MIHOYO_SDK_WATERMARK_WATERMARKAPICLIENT__DOWNLOADWATERMARKIMAGE_D__2_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BA97FF0)
#define MIHOYO_SDK_WATERMARK_WATERMARKAPICLIENT__DOWNLOADWATERMARKIMAGE_D__2_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BA980B0)
#define MIHOYO_SDK_WATERMARK_WATERMARKAPICLIENT__DOWNLOADWATERMARKIMAGE_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BA98110)
#define MIHOYO_SDK_WATERMARK_WATERMARKAPICLIENT__DOWNLOADWATERMARKIMAGE_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BA980C0)
#define MIHOYO_SDK_WATERMARK_WATERMARKAPICLIENT__DOWNLOADWATERMARKIMAGE_D__2_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BA97FE0)
#define MIHOYO_SDK_WATERMARK_WATERMARKAPICLIENT__DOWNLOADWATERMARKIMAGE_D__2__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA97FD0)

namespace MiHoYo::SDK::Watermark
{
	inline static constexpr unsigned int WatermarkApiClient__DownloadWatermarkImage_d__2_TypeDefinitionIndex = 20608;
