...
#define MIHOYO_SDK_WATERMARK_WATERMARKTOKENTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x18460800)

namespace MiHoYo::SDK::Watermark
{
	inline static constexpr unsigned int WatermarkTokenType_TypeDefinitionIndex = 8534;
