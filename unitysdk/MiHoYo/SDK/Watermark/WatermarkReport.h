...
#define MIHOYO_SDK_WATERMARK_WATERMARKREPORT_ERROR_OFFSET UNITYSDK_OFFSET(0x1B3453D0)
#define MIHOYO_SDK_WATERMARK_WATERMARKREPORT_INFO_OFFSET UNITYSDK_OFFSET(0x1B3452E0)
#define MIHOYO_SDK_WATERMARK_WATERMARKREPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3454B0)

namespace MiHoYo::SDK::Watermark
{
	inline static constexpr unsigned int WatermarkReport_TypeDefinitionIndex = 20624;
