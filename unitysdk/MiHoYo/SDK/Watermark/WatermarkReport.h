...
#define MIHOYO_SDK_WATERMARK_WATERMARKREPORT_ERROR_OFFSET UNITYSDK_OFFSET(0x16026530)
#define MIHOYO_SDK_WATERMARK_WATERMARKREPORT_INFO_OFFSET UNITYSDK_OFFSET(0x16026640)
#define MIHOYO_SDK_WATERMARK_WATERMARKREPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1602AE10)

namespace MiHoYo::SDK::Watermark
{
	inline static constexpr unsigned int WatermarkReport_TypeDefinitionIndex = 7495;
