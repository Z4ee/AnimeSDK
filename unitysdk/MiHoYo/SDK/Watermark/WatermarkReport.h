...
#define MIHOYO_SDK_WATERMARK_WATERMARKREPORT_ERROR_OFFSET UNITYSDK_OFFSET(0x1768AAF0)
#define MIHOYO_SDK_WATERMARK_WATERMARKREPORT_INFO_OFFSET UNITYSDK_OFFSET(0x1768AC00)
#define MIHOYO_SDK_WATERMARK_WATERMARKREPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1768F3D0)
