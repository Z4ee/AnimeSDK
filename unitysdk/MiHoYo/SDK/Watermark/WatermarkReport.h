...
#define MIHOYO_SDK_WATERMARK_WATERMARKREPORT_ERROR_OFFSET UNITYSDK_OFFSET(0x1BB0C280)
#define MIHOYO_SDK_WATERMARK_WATERMARKREPORT_INFO_OFFSET UNITYSDK_OFFSET(0x1BB0C390)
#define MIHOYO_SDK_WATERMARK_WATERMARKREPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB10DC0)

namespace MiHoYo::SDK::Watermark
{
	inline static constexpr unsigned int WatermarkReport_TypeDefinitionIndex = 8818;
