...
#define MIHOYO_SDK_PSDELEGATE_IMEDIALOGCLOSECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19E7B510)
#define MIHOYO_SDK_PSDELEGATE_IMEDIALOGCLOSECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19E7B540)
#define MIHOYO_SDK_PSDELEGATE_IMEDIALOGCLOSECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19E7B500)
#define MIHOYO_SDK_PSDELEGATE_IMEDIALOGCLOSECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19E7B490)
