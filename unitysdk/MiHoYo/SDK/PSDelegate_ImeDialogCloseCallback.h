...
#define MIHOYO_SDK_PSDELEGATE_IMEDIALOGCLOSECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x183D3760)
#define MIHOYO_SDK_PSDELEGATE_IMEDIALOGCLOSECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x183D3790)
#define MIHOYO_SDK_PSDELEGATE_IMEDIALOGCLOSECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x183D3750)
#define MIHOYO_SDK_PSDELEGATE_IMEDIALOGCLOSECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x183D36E0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_ImeDialogCloseCallback_TypeDefinitionIndex = 7686;
