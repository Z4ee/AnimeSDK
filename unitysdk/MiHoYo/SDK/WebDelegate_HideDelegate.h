...
#define MIHOYO_SDK_WEBDELEGATE_HIDEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C39CF20)
#define MIHOYO_SDK_WEBDELEGATE_HIDEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C39CF50)
#define MIHOYO_SDK_WEBDELEGATE_HIDEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C39CA20)
#define MIHOYO_SDK_WEBDELEGATE_HIDEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C39CA00)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_HideDelegate_TypeDefinitionIndex = 19587;
