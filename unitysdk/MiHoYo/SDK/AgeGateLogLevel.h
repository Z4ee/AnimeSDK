...
#define MIHOYO_SDK_AGEGATELOGLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x181DEE60)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AgeGateLogLevel_TypeDefinitionIndex = 7508;
