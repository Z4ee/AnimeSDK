...
#define MIHOYO_SDK_AGEGATELOGLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1885BEB0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AgeGateLogLevel_TypeDefinitionIndex = 7514;
