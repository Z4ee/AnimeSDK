...
#define MIHOYO_SDK_MIHOYOSDKHTTPRESPONSE_GET_BADREQUEST_OFFSET UNITYSDK_OFFSET(0x8513C40)
#define MIHOYO_SDK_MIHOYOSDKHTTPRESPONSE_GET_CONTENTFILEPATH_OFFSET UNITYSDK_OFFSET(0x8513220)
#define MIHOYO_SDK_MIHOYOSDKHTTPRESPONSE_GET_FORBIDDEN_OFFSET UNITYSDK_OFFSET(0x8513DE0)
#define MIHOYO_SDK_MIHOYOSDKHTTPRESPONSE_GET_HEADERS_OFFSET UNITYSDK_OFFSET(0x8513200)
#define MIHOYO_SDK_MIHOYOSDKHTTPRESPONSE_GET_METHODNOTALLOWED_OFFSET UNITYSDK_OFFSET(0x8513D10)
#define MIHOYO_SDK_MIHOYOSDKHTTPRESPONSE_GET_STATUSCODE_OFFSET UNITYSDK_OFFSET(0x85131E0)
#define MIHOYO_SDK_MIHOYOSDKHTTPRESPONSE_SENDTO_OFFSET UNITYSDK_OFFSET(0x85132E0)
#define MIHOYO_SDK_MIHOYOSDKHTTPRESPONSE_SET_CONTENTFILEPATH_OFFSET UNITYSDK_OFFSET(0x8513230)
#define MIHOYO_SDK_MIHOYOSDKHTTPRESPONSE_SET_HEADERS_OFFSET UNITYSDK_OFFSET(0x8513210)
#define MIHOYO_SDK_MIHOYOSDKHTTPRESPONSE_SET_STATUSCODE_OFFSET UNITYSDK_OFFSET(0x85131F0)
#define MIHOYO_SDK_MIHOYOSDKHTTPRESPONSE__CTOR_OFFSET UNITYSDK_OFFSET(0x8513240)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKHTTPResponse_TypeDefinitionIndex = 37054;
