...
#define MIHOYO_SDK_PSDELEGATE_AUTHCODECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C5797E0)
#define MIHOYO_SDK_PSDELEGATE_AUTHCODECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C579880)
#define MIHOYO_SDK_PSDELEGATE_AUTHCODECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C579460)
#define MIHOYO_SDK_PSDELEGATE_AUTHCODECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C565D20)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_AuthCodeCallback_TypeDefinitionIndex = 19486;
