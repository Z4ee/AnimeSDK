...
#define MIHOYO_SDK_PSDELEGATE_AUTHCODECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x175F99C0)
#define MIHOYO_SDK_PSDELEGATE_AUTHCODECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x175F9A40)
#define MIHOYO_SDK_PSDELEGATE_AUTHCODECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x175F9630)
#define MIHOYO_SDK_PSDELEGATE_AUTHCODECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x175CAB50)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_AuthCodeCallback_TypeDefinitionIndex = 6769;
