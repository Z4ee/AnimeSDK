...
#define MIHOYO_SDK_CUSTOMNOTICEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1830ABE0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int CustomNoticeParam_TypeDefinitionIndex = 7532;
