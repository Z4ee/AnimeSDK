...
#define MIHOYO_SDK_CUSTOMNOTICEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA47090)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int CustomNoticeParam_TypeDefinitionIndex = 7538;
