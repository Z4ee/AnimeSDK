...
#define MIHOYO_SDK_CUSTOMNOTICEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x194521E0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int CustomNoticeParam_TypeDefinitionIndex = 18451;
