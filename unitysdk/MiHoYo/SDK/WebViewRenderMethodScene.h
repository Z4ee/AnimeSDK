...
#define MIHOYO_SDK_WEBVIEWRENDERMETHODSCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7D9090)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebViewRenderMethodScene_TypeDefinitionIndex = 7855;
