...
#define MIHOYO_SDK_WEBDELEGATE_SETBACKBUTTONENABLEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x176A6770)
#define MIHOYO_SDK_WEBDELEGATE_SETBACKBUTTONENABLEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x176A67D0)
#define MIHOYO_SDK_WEBDELEGATE_SETBACKBUTTONENABLEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x17698930)
#define MIHOYO_SDK_WEBDELEGATE_SETBACKBUTTONENABLEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176A6750)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetBackButtonEnabledDelegate_TypeDefinitionIndex = 6875;
