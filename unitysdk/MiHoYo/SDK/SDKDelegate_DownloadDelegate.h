...
#define MIHOYO_SDK_SDKDELEGATE_DOWNLOADDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15FE5A80)
#define MIHOYO_SDK_SDKDELEGATE_DOWNLOADDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15FE5AB0)
#define MIHOYO_SDK_SDKDELEGATE_DOWNLOADDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x15FE5530)
#define MIHOYO_SDK_SDKDELEGATE_DOWNLOADDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x15FE5510)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_DownloadDelegate_TypeDefinitionIndex = 6778;
