...
#define MIHOYO_SDK_SDKDELEGATE_DOWNLOADDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DD4F050)
#define MIHOYO_SDK_SDKDELEGATE_DOWNLOADDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DD4F080)
#define MIHOYO_SDK_SDKDELEGATE_DOWNLOADDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DD4EB30)
#define MIHOYO_SDK_SDKDELEGATE_DOWNLOADDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD4EB10)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_DownloadDelegate_TypeDefinitionIndex = 19884;
