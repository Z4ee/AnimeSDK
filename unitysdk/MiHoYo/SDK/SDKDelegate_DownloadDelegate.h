...
#define MIHOYO_SDK_SDKDELEGATE_DOWNLOADDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C96FDB0)
#define MIHOYO_SDK_SDKDELEGATE_DOWNLOADDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C96FDE0)
#define MIHOYO_SDK_SDKDELEGATE_DOWNLOADDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C96F8B0)
#define MIHOYO_SDK_SDKDELEGATE_DOWNLOADDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C96F890)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_DownloadDelegate_TypeDefinitionIndex = 19537;
