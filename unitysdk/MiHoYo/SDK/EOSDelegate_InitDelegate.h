...
#define MIHOYO_SDK_EOSDELEGATE_INITDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A3FC890)
#define MIHOYO_SDK_EOSDELEGATE_INITDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A3FC8C0)
#define MIHOYO_SDK_EOSDELEGATE_INITDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A3FC350)
#define MIHOYO_SDK_EOSDELEGATE_INITDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3FC340)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int EOSDelegate_InitDelegate_TypeDefinitionIndex = 18580;
