...
#define MIHOYO_SDK_EOSDELEGATE_INITDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B943D40)
#define MIHOYO_SDK_EOSDELEGATE_INITDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B943D70)
#define MIHOYO_SDK_EOSDELEGATE_INITDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B943D30)
#define MIHOYO_SDK_EOSDELEGATE_INITDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B943C40)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int EOSDelegate_InitDelegate_TypeDefinitionIndex = 7667;
