...
#define MIHOYO_SDK_REGIONTRANSLATIONMANAGER__REQUESTREMOTEVERSION_D__18_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x176327C0)
#define MIHOYO_SDK_REGIONTRANSLATIONMANAGER__REQUESTREMOTEVERSION_D__18_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x17632960)
#define MIHOYO_SDK_REGIONTRANSLATIONMANAGER__REQUESTREMOTEVERSION_D__18_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x176329C0)
#define MIHOYO_SDK_REGIONTRANSLATIONMANAGER__REQUESTREMOTEVERSION_D__18_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x17632970)
#define MIHOYO_SDK_REGIONTRANSLATIONMANAGER__REQUESTREMOTEVERSION_D__18_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x176327B0)
#define MIHOYO_SDK_REGIONTRANSLATIONMANAGER__REQUESTREMOTEVERSION_D__18__CTOR_OFFSET UNITYSDK_OFFSET(0x17632430)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int RegionTranslationManager__RequestRemoteVersion_d__18_TypeDefinitionIndex = 7004;
