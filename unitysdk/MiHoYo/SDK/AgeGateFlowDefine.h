...
#define MIHOYO_SDK_AGEGATEFLOWDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9FAB00)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AgeGateFlowDefine_TypeDefinitionIndex = 19654;
