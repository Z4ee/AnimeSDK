...
#define MIHOYO_SDK_AGEGATEFLOWDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C55EA70)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AgeGateFlowDefine_TypeDefinitionIndex = 19309;
