...
#define MIHOYO_SDK_AGEGATEFLOWDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x173D5D60)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AgeGateFlowDefine_TypeDefinitionIndex = 6604;
