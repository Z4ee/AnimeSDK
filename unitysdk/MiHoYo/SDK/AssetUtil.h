...
#define MIHOYO_SDK_ASSETUTIL_ASBUNLOAD_OFFSET UNITYSDK_OFFSET(0x153678B0)
#define MIHOYO_SDK_ASSETUTIL_CALLMETHODWITHPARAMETERS_OFFSET UNITYSDK_OFFSET(0x15367CE0)
#define MIHOYO_SDK_ASSETUTIL_CREATEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x153674B0)
#define MIHOYO_SDK_ASSETUTIL_DESTROYGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x15367600)
#define MIHOYO_SDK_ASSETUTIL_GETASSETASBFULLPATH_OFFSET UNITYSDK_OFFSET(0x15367870)
#define MIHOYO_SDK_ASSETUTIL_HASMETHODWITHPARAMETERS_OFFSET UNITYSDK_OFFSET(0x153679B0)
#define MIHOYO_SDK_ASSETUTIL_LOADFROMASB_OFFSET UNITYSDK_OFFSET(0x15367620)
#define MIHOYO_SDK_ASSETUTIL_LOADJSONFILE_OFFSET UNITYSDK_OFFSET(0x15367910)
#define MIHOYO_SDK_ASSETUTIL_LOADRESOURCE_OFFSET UNITYSDK_OFFSET(0x15367560)
#define MIHOYO_SDK_ASSETUTIL__CCTOR_OFFSET UNITYSDK_OFFSET(0x15368020)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AssetUtil_TypeDefinitionIndex = 44742;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(AssetUtil_TypeDefinitionIndex)->GetStaticField(0xAE80);
		}
		static ::UnityEngine::AssetBundle** StaticGet__assetBundle()
		{
			return (::UnityEngine::AssetBundle**)Il2CppClass::FromTypeDefinitionIndex(AssetUtil_TypeDefinitionIndex)->GetStaticField(0xAE88);
		}
