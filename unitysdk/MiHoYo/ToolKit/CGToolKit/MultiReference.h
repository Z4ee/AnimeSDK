...
#define MIHOYO_TOOLKIT_CGTOOLKIT_MULTIREFERENCE_GETREFERENCES_OFFSET UNITYSDK_OFFSET(0x11441BD0)
#define MIHOYO_TOOLKIT_CGTOOLKIT_MULTIREFERENCE_RECOVERREFERENCE_OFFSET UNITYSDK_OFFSET(0x11441FB0)
#define MIHOYO_TOOLKIT_CGTOOLKIT_MULTIREFERENCE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x11441840)
#define MIHOYO_TOOLKIT_CGTOOLKIT_MULTIREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x11441830)

namespace MiHoYo::ToolKit::CGToolKit
{
	inline static constexpr unsigned int MultiReference_TypeDefinitionIndex = 51914;
