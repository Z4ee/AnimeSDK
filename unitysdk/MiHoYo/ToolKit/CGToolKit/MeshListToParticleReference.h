...
#define MIHOYO_TOOLKIT_CGTOOLKIT_MESHLISTTOPARTICLEREFERENCE_RECOVERREFERENCE_OFFSET UNITYSDK_OFFSET(0x106AA700)
#define MIHOYO_TOOLKIT_CGTOOLKIT_MESHLISTTOPARTICLEREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x106AA650)

namespace MiHoYo::ToolKit::CGToolKit
{
	inline static constexpr unsigned int MeshListToParticleReference_TypeDefinitionIndex = 52930;
