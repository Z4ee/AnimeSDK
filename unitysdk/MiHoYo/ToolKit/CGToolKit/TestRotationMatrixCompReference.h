...
#define MIHOYO_TOOLKIT_CGTOOLKIT_TESTROTATIONMATRIXCOMPREFERENCE_GETRENDERCOMPREFERENCES_OFFSET UNITYSDK_OFFSET(0x11C6F3E0)
#define MIHOYO_TOOLKIT_CGTOOLKIT_TESTROTATIONMATRIXCOMPREFERENCE_SETCOMPREFERENCE_OFFSET UNITYSDK_OFFSET(0x11C6F6D0)
#define MIHOYO_TOOLKIT_CGTOOLKIT_TESTROTATIONMATRIXCOMPREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x11C6F3D0)

namespace MiHoYo::ToolKit::CGToolKit
{
	inline static constexpr unsigned int TestRotationMatrixCompReference_TypeDefinitionIndex = 76673;
