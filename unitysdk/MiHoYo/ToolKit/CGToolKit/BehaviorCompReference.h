...
#define MIHOYO_TOOLKIT_CGTOOLKIT_BEHAVIORCOMPREFERENCE_GETRENDERCOMPREFERENCES_OFFSET UNITYSDK_OFFSET(0x106A9DE0)
#define MIHOYO_TOOLKIT_CGTOOLKIT_BEHAVIORCOMPREFERENCE_SETCOMPREFERENCE_OFFSET UNITYSDK_OFFSET(0x106AA210)
#define MIHOYO_TOOLKIT_CGTOOLKIT_BEHAVIORCOMPREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x106A9D40)

namespace MiHoYo::ToolKit::CGToolKit
{
	inline static constexpr unsigned int BehaviorCompReference_TypeDefinitionIndex = 57133;
