...
#define MIHOYO_TOOLKIT_CGTOOLKIT_RENDERCOMPREFERENCE_GETRENDERCOMPREFERENCES_OFFSET UNITYSDK_OFFSET(0x16C09C00)
#define MIHOYO_TOOLKIT_CGTOOLKIT_RENDERCOMPREFERENCE_SETMATERIALREFERENCE_OFFSET UNITYSDK_OFFSET(0x16C0A100)
#define MIHOYO_TOOLKIT_CGTOOLKIT_RENDERCOMPREFERENCE_SETRENDERCOMPREFERENCE_OFFSET UNITYSDK_OFFSET(0x16C09C40)
#define MIHOYO_TOOLKIT_CGTOOLKIT_RENDERCOMPREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x16C09AF0)

namespace MiHoYo::ToolKit::CGToolKit
{
	inline static constexpr unsigned int RenderCompReference_TypeDefinitionIndex = 56600;
