...
#define MIHOYO_TOOLKIT_CGTOOLKIT_RENDERCOMPREFERENCE_GETRENDERCOMPREFERENCES_OFFSET UNITYSDK_OFFSET(0x16278070)
#define MIHOYO_TOOLKIT_CGTOOLKIT_RENDERCOMPREFERENCE_SETMATERIALREFERENCE_OFFSET UNITYSDK_OFFSET(0x16278560)
#define MIHOYO_TOOLKIT_CGTOOLKIT_RENDERCOMPREFERENCE_SETRENDERCOMPREFERENCE_OFFSET UNITYSDK_OFFSET(0x162780B0)
#define MIHOYO_TOOLKIT_CGTOOLKIT_RENDERCOMPREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x16277F60)

namespace MiHoYo::ToolKit::CGToolKit
{
	inline static constexpr unsigned int RenderCompReference_TypeDefinitionIndex = 79010;
