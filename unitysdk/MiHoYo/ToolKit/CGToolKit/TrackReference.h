...
#define MIHOYO_TOOLKIT_CGTOOLKIT_TRACKREFERENCE_RECORDTRACKREFERENCE_OFFSET UNITYSDK_OFFSET(0xF119590)
#define MIHOYO_TOOLKIT_CGTOOLKIT_TRACKREFERENCE_SETTRACKREFERENCEBYTYPE_OFFSET UNITYSDK_OFFSET(0xF119660)
#define MIHOYO_TOOLKIT_CGTOOLKIT_TRACKREFERENCE_SETTRACKREFERENCE_OFFSET UNITYSDK_OFFSET(0xF119730)
#define MIHOYO_TOOLKIT_CGTOOLKIT_TRACKREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0xF119490)

namespace MiHoYo::ToolKit::CGToolKit
{
	inline static constexpr unsigned int TrackReference_TypeDefinitionIndex = 81659;
