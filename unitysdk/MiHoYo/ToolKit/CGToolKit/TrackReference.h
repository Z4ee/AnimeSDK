...
#define MIHOYO_TOOLKIT_CGTOOLKIT_TRACKREFERENCE_RECORDTRACKREFERENCE_OFFSET UNITYSDK_OFFSET(0xFAE1A70)
#define MIHOYO_TOOLKIT_CGTOOLKIT_TRACKREFERENCE_SETTRACKREFERENCEBYTYPE_OFFSET UNITYSDK_OFFSET(0xFAE1B40)
#define MIHOYO_TOOLKIT_CGTOOLKIT_TRACKREFERENCE_SETTRACKREFERENCE_OFFSET UNITYSDK_OFFSET(0xFAE1C10)
#define MIHOYO_TOOLKIT_CGTOOLKIT_TRACKREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0xFAE1970)

namespace MiHoYo::ToolKit::CGToolKit
{
	inline static constexpr unsigned int TrackReference_TypeDefinitionIndex = 59203;
