...
#define AREAFEDEGROUP_GET_FADEMODE_OFFSET UNITYSDK_OFFSET(0x1765F540)
#define AREAFEDEGROUP_METHOD_5_367B9590522079D1_OFFSET UNITYSDK_OFFSET(0x1765FC40)
#define AREAFEDEGROUP_METHOD_5_6A0EBEECA245A27C_OFFSET UNITYSDK_OFFSET(0x1765F720)
#define AREAFEDEGROUP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1765F6D0)
#define AREAFEDEGROUP_SET_FADEMODE_OFFSET UNITYSDK_OFFSET(0x1765F550)
#define AREAFEDEGROUP_UPDATE_OFFSET UNITYSDK_OFFSET(0x1765FBF0)
#define AREAFEDEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x17660100)
