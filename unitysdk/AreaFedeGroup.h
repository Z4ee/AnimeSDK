...
#define AREAFEDEGROUP_GET_FADEMODE_OFFSET UNITYSDK_OFFSET(0x10BF9990)
#define AREAFEDEGROUP_METHOD_5_1F3793A40D6D0F7F_OFFSET UNITYSDK_OFFSET(0x10BF9BB0)
#define AREAFEDEGROUP_METHOD_5_3CCA0B8A31B650A8_OFFSET UNITYSDK_OFFSET(0x10BFA1E0)
#define AREAFEDEGROUP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x10BF9B60)
#define AREAFEDEGROUP_SET_FADEMODE_OFFSET UNITYSDK_OFFSET(0x10BF99A0)
#define AREAFEDEGROUP_UPDATE_OFFSET UNITYSDK_OFFSET(0x10BFA190)
#define AREAFEDEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x10BFA650)

inline static constexpr unsigned int AreaFedeGroup_TypeDefinitionIndex = 38239;
