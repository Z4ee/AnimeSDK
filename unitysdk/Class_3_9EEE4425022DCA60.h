...
#define CLASS_3_9EEE4425022DCA60_METHOD_3_5242B274EDFF6B6A_OFFSET UNITYSDK_OFFSET(0x179EC940)
#define CLASS_3_9EEE4425022DCA60_METHOD_3_5FBAD89A54D9F070_OFFSET UNITYSDK_OFFSET(0x179EC770)
#define CLASS_3_9EEE4425022DCA60_METHOD_3_61EC2AC0BD93363E_OFFSET UNITYSDK_OFFSET(0x179ECB30)
#define CLASS_3_9EEE4425022DCA60_METHOD_3_D8F3C6B2E2C5586E_OFFSET UNITYSDK_OFFSET(0x179EC830)
#define CLASS_3_9EEE4425022DCA60_METHOD_3_F944CC0CE8B3E57A_OFFSET UNITYSDK_OFFSET(0x179EC990)
#define CLASS_3_9EEE4425022DCA60_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x179EC450)
#define CLASS_3_9EEE4425022DCA60_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x179ECA50)
#define CLASS_3_9EEE4425022DCA60__CTOR_OFFSET UNITYSDK_OFFSET(0x179EC3D0)
#define CLASS_3_9EEE4425022DCA60___ONIDLELIVETEAMUPDATED_B__6_0_OFFSET UNITYSDK_OFFSET(0x179ECC90)

inline static constexpr unsigned int Class_3_9EEE4425022DCA60_TypeDefinitionIndex = 58327;

class Class_3_9EEE4425022DCA60 : public ::Class_2_BB5C2228DBF7AE1F
{
public:
	::RPG::GameCore::TaskContext* EEFMDEHLLFI; // 0x28
	::RPG::Client::ActivityIdleLive::IdleLiveBaseTeamInfo* GLCFFOIDEMA; // 0x30
	::Class_3_019A582638BC3D1A_1* IGHAHBNLIJA; // 0x38
