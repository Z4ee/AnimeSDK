...
#define CLASS_1_76E2CAB0F55776A6__CTOR_OFFSET UNITYSDK_OFFSET(0x1D03E3C0)
...
{
public:
	::System::ValueTuple_2<::System::UInt32, ::System::UInt32> IHLOJINLCHB; // 0x10
	::RPG::Client::LittleGame::Match3::PieceRemoveReason KDHPKOFLNFM; // 0x18
