...
#define AGENTLINKMOVER__NORMALSPEED_D__3_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1289F600)
#define AGENTLINKMOVER__NORMALSPEED_D__3_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1289F930)
#define AGENTLINKMOVER__NORMALSPEED_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1289F990)
#define AGENTLINKMOVER__NORMALSPEED_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1289F940)
#define AGENTLINKMOVER__NORMALSPEED_D__3_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1289F5F0)
#define AGENTLINKMOVER__NORMALSPEED_D__3__CTOR_OFFSET UNITYSDK_OFFSET(0x1289F5E0)

inline static constexpr unsigned int AgentLinkMover__NormalSpeed_d__3_TypeDefinitionIndex = 80471;
