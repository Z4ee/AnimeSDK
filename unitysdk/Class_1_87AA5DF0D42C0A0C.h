...
#define CLASS_1_87AA5DF0D42C0A0C_GET_MAPPINGINFONODE_OFFSET UNITYSDK_OFFSET(0x11696BD0)
#define CLASS_1_87AA5DF0D42C0A0C_GET_SHORTESTPATH_OFFSET UNITYSDK_OFFSET(0x11696BF0)
#define CLASS_1_87AA5DF0D42C0A0C_SET_MAPPINGINFONODE_OFFSET UNITYSDK_OFFSET(0x11696BE0)
#define CLASS_1_87AA5DF0D42C0A0C_SET_SHORTESTPATH_OFFSET UNITYSDK_OFFSET(0x11696C00)
#define CLASS_1_87AA5DF0D42C0A0C__CTOR_OFFSET UNITYSDK_OFFSET(0x11696C10)

inline static constexpr unsigned int Class_1_87AA5DF0D42C0A0C_TypeDefinitionIndex = 61312;
