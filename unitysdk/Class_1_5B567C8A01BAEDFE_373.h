...
#define CLASS_1_5B567C8A01BAEDFE_373_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A497C60)
#define CLASS_1_5B567C8A01BAEDFE_373_CLONE_OFFSET UNITYSDK_OFFSET(0x1A497A70)
#define CLASS_1_5B567C8A01BAEDFE_373_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A497B70)
#define CLASS_1_5B567C8A01BAEDFE_373_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A497AE0)
#define CLASS_1_5B567C8A01BAEDFE_373_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A497BC0)
#define CLASS_1_5B567C8A01BAEDFE_373_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A497CB0)
#define CLASS_1_5B567C8A01BAEDFE_373_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A497C80)
#define CLASS_1_5B567C8A01BAEDFE_373_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A4979C0)
#define CLASS_1_5B567C8A01BAEDFE_373_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A497A20)
#define CLASS_1_5B567C8A01BAEDFE_373_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A497BF0)
#define CLASS_1_5B567C8A01BAEDFE_373_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A497C50)
#define CLASS_1_5B567C8A01BAEDFE_373__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A497D00)
#define CLASS_1_5B567C8A01BAEDFE_373__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A497A40)
#define CLASS_1_5B567C8A01BAEDFE_373__CTOR_OFFSET UNITYSDK_OFFSET(0x1A497A30)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_373_TypeDefinitionIndex = 32737;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_373*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_373_TypeDefinitionIndex)->GetStaticField(0x3060);
	}
