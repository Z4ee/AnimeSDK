...
#define CLASS_2_F7958344C5B7C4AF_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16FBB8D0)
#define CLASS_2_F7958344C5B7C4AF_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x16FBBF00)
#define CLASS_2_F7958344C5B7C4AF_METHOD_2_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x16FBBF70)
#define CLASS_2_F7958344C5B7C4AF_METHOD_2_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x16FBB710)
#define CLASS_2_F7958344C5B7C4AF_METHOD_2_68A2CA32DC720C44_OFFSET UNITYSDK_OFFSET(0x16FBBFD0)
#define CLASS_2_F7958344C5B7C4AF_METHOD_2_84415F48959FD9A3_OFFSET UNITYSDK_OFFSET(0x16FBB950)
#define CLASS_2_F7958344C5B7C4AF_METHOD_2_B1445E8504415D4D_OFFSET UNITYSDK_OFFSET(0x16FBC0E0)
#define CLASS_2_F7958344C5B7C4AF_METHOD_2_BF9BB9E2BBF3B6F4_OFFSET UNITYSDK_OFFSET(0x16FBBA00)
#define CLASS_2_F7958344C5B7C4AF_TICK_OFFSET UNITYSDK_OFFSET(0x16FBBE90)
#define CLASS_2_F7958344C5B7C4AF__CTOR_OFFSET UNITYSDK_OFFSET(0x16FBC0F0)
...
public:
	...
	::System::Collections::Generic::Dictionary_2<::System::Single, ::System::Single>* AJBAMNPFGIB; // 0x18
	::RPG::GameCore::GameEntity* DPDJLGOIALF; // 0x20
	::UnityEngine::Transform* DMOMBMJBBNP; // 0x28
	::RPG::GameCore::CharacterModelScaleEventParam* GJMEBCMNPMK; // 0x30
	::RPG::GameCore::CharacterModelComponent* EHFENKGDGJD; // 0x38
	::Class_2_F7958344C5B7C4AF_Struct_2_AD9C7534A8CF01E1_1 ENHJFLBIELP; // 0x40
	::System::Boolean IKCMMJAPKPC; // 0x44
	::System::Boolean MNMOPFJLDCJ; // 0x45
