...
#define CLASS_1_C2FA8D0A8F091715_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17C21620)
#define CLASS_1_C2FA8D0A8F091715_CLONE_OFFSET UNITYSDK_OFFSET(0x17C211F0)
#define CLASS_1_C2FA8D0A8F091715_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17C213C0)
#define CLASS_1_C2FA8D0A8F091715_EQUALS_OFFSET UNITYSDK_OFFSET(0x17C212F0)
#define CLASS_1_C2FA8D0A8F091715_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17C21490)
#define CLASS_1_C2FA8D0A8F091715_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17C21860)
#define CLASS_1_C2FA8D0A8F091715_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17C217B0)
#define CLASS_1_C2FA8D0A8F091715_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x17C21270)
#define CLASS_1_C2FA8D0A8F091715_METHOD_1_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0x17C212E0)
#define CLASS_1_C2FA8D0A8F091715_METHOD_1_686CBC4FBD0AAA58_OFFSET UNITYSDK_OFFSET(0x17C212C0)
#define CLASS_1_C2FA8D0A8F091715_METHOD_1_6BD2A2909D8CFAD3_OFFSET UNITYSDK_OFFSET(0x17C212B0)
#define CLASS_1_C2FA8D0A8F091715_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x17C21280)
#define CLASS_1_C2FA8D0A8F091715_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x17C212D0)
#define CLASS_1_C2FA8D0A8F091715_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x17C212A0)
#define CLASS_1_C2FA8D0A8F091715_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x17C21290)
#define CLASS_1_C2FA8D0A8F091715_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17C21160)
#define CLASS_1_C2FA8D0A8F091715_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17C214D0)
#define CLASS_1_C2FA8D0A8F091715_WRITETO_OFFSET UNITYSDK_OFFSET(0x17C21530)
#define CLASS_1_C2FA8D0A8F091715__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17C21180)
#define CLASS_1_C2FA8D0A8F091715__CTOR_OFFSET UNITYSDK_OFFSET(0x17C21170)

inline static constexpr unsigned int Class_1_C2FA8D0A8F091715_TypeDefinitionIndex = 23441;
...
public:
	...
	::Enum_3_DB663931210BBC27_14 Field_1_8; // 0x20
	...
	{
		return ((::Enum_3_DB663931210BBC27_14(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_C2FA8D0A8F091715_METHOD_1_A96DCA30C6927810_OFFSET))(this);
	}

	::System::Void Method_1_3DACC45AC8150727(::Enum_3_DB663931210BBC27_14 a1)
	{
		return ((::System::Void(*)(::PVOID, ::Enum_3_DB663931210BBC27_14))((::PBYTE)hIl2Cpp + CLASS_1_C2FA8D0A8F091715_METHOD_1_3DACC45AC8150727_OFFSET))(this, a1);
	}
