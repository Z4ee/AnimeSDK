...
#define CLASS_2_3E7D7FDF42A4A869_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1846FD10)
#define CLASS_2_3E7D7FDF42A4A869_METHOD_2_7EA54838B888644E_OFFSET UNITYSDK_OFFSET(0x18470640)
#define CLASS_2_3E7D7FDF42A4A869_METHOD_2_BCEDF88FD731AB55_OFFSET UNITYSDK_OFFSET(0x184705E0)
#define CLASS_2_3E7D7FDF42A4A869_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1846FE70)
#define CLASS_2_3E7D7FDF42A4A869_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x184704E0)
#define CLASS_2_3E7D7FDF42A4A869_TICK_OFFSET UNITYSDK_OFFSET(0x18470530)
#define CLASS_2_3E7D7FDF42A4A869__CTOR_OFFSET UNITYSDK_OFFSET(0x1846FBC0)
...
public:
	...
	::Class_3_07C3C4D2990C49EE* BCGLDJBEBPK; // 0x20
	::Class_3_4FEC308312B5461F* OFKGLJOAMLD; // 0x28
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x30
	::Class_1_0AD6129525BF5F86* BLDLELNJDML; // 0x38
