...
#define CLASS_2_23F9D0182A641C7D__CTOR_OFFSET UNITYSDK_OFFSET(0x1427BA10)
...
{
public:
	::Class_0_16E4307DCC419505_488* Field_2_0; // 0x58
	::RPG::GameCore::GameEntity* Field_2_1; // 0x60
	::Class_1_9AD7EC315F99B05E* Field_2_2; // 0x68
	::Il2CppArray<::RPG::GameCore::AttackDamageType>* Field_2_3; // 0x70
	::RPG::GameCore::WaveMonsterTiming Field_2_4; // 0x78
	::System::Single Field_2_5; // 0x7C
	::System::Nullable_1<::RPG::GameCore::FixPoint> Field_2_6; // 0x80
	::RPG::GameCore::FixPoint Field_2_7; // 0x90
	::System::Nullable_1<::RPG::GameCore::FixPoint> Field_2_8; // 0x98
	::RPG::GameCore::FixPoint Field_2_9; // 0xA8
	::System::Int32 Field_2_10; // 0xB0
	::System::UInt32 Field_2_11; // 0xB4
