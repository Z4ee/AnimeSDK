...
#define EZYSLICE_LINE_GET_DISTSQ_OFFSET UNITYSDK_OFFSET(0x3BD08C0)
#define EZYSLICE_LINE_GET_DIST_OFFSET UNITYSDK_OFFSET(0x3BD0870)
#define EZYSLICE_LINE_GET_POSITIONA_OFFSET UNITYSDK_OFFSET(0x17670)
#define EZYSLICE_LINE_GET_POSITIONB_OFFSET UNITYSDK_OFFSET(0x379FAC0)
#define EZYSLICE_LINE__CTOR_OFFSET UNITYSDK_OFFSET(0x6BC260)

namespace EzySlice
{
	inline static constexpr unsigned int Line_TypeDefinitionIndex = 47456;
