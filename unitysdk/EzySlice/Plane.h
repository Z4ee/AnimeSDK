...
#define EZYSLICE_PLANE_COMPUTE_1_OFFSET UNITYSDK_OFFSET(0x247C0)
#define EZYSLICE_PLANE_COMPUTE_2_OFFSET UNITYSDK_OFFSET(0x249D0)
#define EZYSLICE_PLANE_COMPUTE_OFFSET UNITYSDK_OFFSET(0x24620)
#define EZYSLICE_PLANE_GET_DIST_OFFSET UNITYSDK_OFFSET(0xCCC0)
#define EZYSLICE_PLANE_GET_NORMAL_OFFSET UNITYSDK_OFFSET(0x245E0)
...
#define EZYSLICE_PLANE_SIDEOF_OFFSET UNITYSDK_OFFSET(0x24BF0)
#define EZYSLICE_PLANE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x24660)
#define EZYSLICE_PLANE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x24680)
#define EZYSLICE_PLANE__CTOR_OFFSET UNITYSDK_OFFSET(0x24620)

namespace EzySlice
{
	inline static constexpr unsigned int Plane_TypeDefinitionIndex = 37933;
