...
#define EZYSLICE_TRIANGULATOR_MAPPED2D_GET_MAPPEDVALUE_OFFSET UNITYSDK_OFFSET(0x26200)
#define EZYSLICE_TRIANGULATOR_MAPPED2D_GET_ORIGINALVALUE_OFFSET UNITYSDK_OFFSET(0x25350)
#define EZYSLICE_TRIANGULATOR_MAPPED2D__CTOR_OFFSET UNITYSDK_OFFSET(0x261A0)

namespace EzySlice
{
	inline static constexpr unsigned int Triangulator_Mapped2D_TypeDefinitionIndex = 44357;
