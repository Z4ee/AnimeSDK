...
#define EZYSLICE_TRIANGULATOR_MAPPED2D_GET_MAPPEDVALUE_OFFSET UNITYSDK_OFFSET(0x25490)
#define EZYSLICE_TRIANGULATOR_MAPPED2D_GET_ORIGINALVALUE_OFFSET UNITYSDK_OFFSET(0x245E0)
#define EZYSLICE_TRIANGULATOR_MAPPED2D__CTOR_OFFSET UNITYSDK_OFFSET(0x25430)

namespace EzySlice
{
	inline static constexpr unsigned int Triangulator_Mapped2D_TypeDefinitionIndex = 37938;
