...
#define EZYSLICE_INTERSECTOR_INTERSECT_1_OFFSET UNITYSDK_OFFSET(0x83D8D50)
#define EZYSLICE_INTERSECTOR_INTERSECT_2_OFFSET UNITYSDK_OFFSET(0x83D8E90)
#define EZYSLICE_INTERSECTOR_INTERSECT_OFFSET UNITYSDK_OFFSET(0x83D8C40)
#define EZYSLICE_INTERSECTOR_TRIAREA2D_OFFSET UNITYSDK_OFFSET(0x83D8E60)
#define EZYSLICE_INTERSECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x83DDD00)

namespace EzySlice
{
	inline static constexpr unsigned int Intersector_TypeDefinitionIndex = 37930;
