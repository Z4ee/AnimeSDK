...
#define EZYSLICE_INTERSECTOR_INTERSECT_1_OFFSET UNITYSDK_OFFSET(0x1D44FC60)
#define EZYSLICE_INTERSECTOR_INTERSECT_2_OFFSET UNITYSDK_OFFSET(0x1D44FDA0)
#define EZYSLICE_INTERSECTOR_INTERSECT_OFFSET UNITYSDK_OFFSET(0x1D44FB50)
#define EZYSLICE_INTERSECTOR_TRIAREA2D_OFFSET UNITYSDK_OFFSET(0x1D44FD70)
#define EZYSLICE_INTERSECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D454C20)
