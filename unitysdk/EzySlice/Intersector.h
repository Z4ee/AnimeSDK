...
#define EZYSLICE_INTERSECTOR_INTERSECT_1_OFFSET UNITYSDK_OFFSET(0x1B7EF410)
#define EZYSLICE_INTERSECTOR_INTERSECT_2_OFFSET UNITYSDK_OFFSET(0x1B7EF550)
#define EZYSLICE_INTERSECTOR_INTERSECT_OFFSET UNITYSDK_OFFSET(0x1B7EF300)
#define EZYSLICE_INTERSECTOR_TRIAREA2D_OFFSET UNITYSDK_OFFSET(0x1B7EF520)
#define EZYSLICE_INTERSECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7F43D0)

namespace EzySlice
{
	inline static constexpr unsigned int Intersector_TypeDefinitionIndex = 45219;
