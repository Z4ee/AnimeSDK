...
#define EZYSLICE_TRIANGLE_BARYCENTRIC_OFFSET UNITYSDK_OFFSET(0x3BD1330)
#define EZYSLICE_TRIANGLE_COMPUTETANGENTS_OFFSET UNITYSDK_OFFSET(0x3BD1320)
#define EZYSLICE_TRIANGLE_GENERATENORMAL_OFFSET UNITYSDK_OFFSET(0x3BD1410)
#define EZYSLICE_TRIANGLE_GENERATETANGENT_OFFSET UNITYSDK_OFFSET(0x3BD14E0)
#define EZYSLICE_TRIANGLE_GENERATEUV_OFFSET UNITYSDK_OFFSET(0x3BD1360)
#define EZYSLICE_TRIANGLE_GET_HASNORMAL_OFFSET UNITYSDK_OFFSET(0x3BD1200)
#define EZYSLICE_TRIANGLE_GET_HASTANGENT_OFFSET UNITYSDK_OFFSET(0x3BD12B0)
#define EZYSLICE_TRIANGLE_GET_HASUV_OFFSET UNITYSDK_OFFSET(0x3BD11D0)
#define EZYSLICE_TRIANGLE_GET_NORMALA_OFFSET UNITYSDK_OFFSET(0x3AEB270)
#define EZYSLICE_TRIANGLE_GET_NORMALB_OFFSET UNITYSDK_OFFSET(0x3BD1270)
#define EZYSLICE_TRIANGLE_GET_NORMALC_OFFSET UNITYSDK_OFFSET(0x3BD1290)
#define EZYSLICE_TRIANGLE_GET_POSITIONA_OFFSET UNITYSDK_OFFSET(0x17670)
#define EZYSLICE_TRIANGLE_GET_POSITIONB_OFFSET UNITYSDK_OFFSET(0x379FAC0)
#define EZYSLICE_TRIANGLE_GET_POSITIONC_OFFSET UNITYSDK_OFFSET(0x3B19D00)
#define EZYSLICE_TRIANGLE_GET_TANGENTA_OFFSET UNITYSDK_OFFSET(0x3BD1300)
#define EZYSLICE_TRIANGLE_GET_TANGENTB_OFFSET UNITYSDK_OFFSET(0x3AEB350)
#define EZYSLICE_TRIANGLE_GET_TANGENTC_OFFSET UNITYSDK_OFFSET(0x3BD1310)
#define EZYSLICE_TRIANGLE_GET_UVA_OFFSET UNITYSDK_OFFSET(0x8354E0)
#define EZYSLICE_TRIANGLE_GET_UVB_OFFSET UNITYSDK_OFFSET(0xF3CFA0)
#define EZYSLICE_TRIANGLE_GET_UVC_OFFSET UNITYSDK_OFFSET(0x37AC550)
#define EZYSLICE_TRIANGLE_ISCW_OFFSET UNITYSDK_OFFSET(0x3BD15F0)
#define EZYSLICE_TRIANGLE_ONDEBUGDRAW_1_OFFSET UNITYSDK_OFFSET(0x10F00)
#define EZYSLICE_TRIANGLE_ONDEBUGDRAW_OFFSET UNITYSDK_OFFSET(0x10F00)
#define EZYSLICE_TRIANGLE_SETNORMAL_OFFSET UNITYSDK_OFFSET(0x3BD1210)
#define EZYSLICE_TRIANGLE_SETTANGENT_OFFSET UNITYSDK_OFFSET(0x3BD12C0)
#define EZYSLICE_TRIANGLE_SETUV_OFFSET UNITYSDK_OFFSET(0x3BD11E0)
#define EZYSLICE_TRIANGLE_SIGNEDSQUARE_OFFSET UNITYSDK_OFFSET(0x1D45AC80)
#define EZYSLICE_TRIANGLE_SPLIT_OFFSET UNITYSDK_OFFSET(0x3BD1590)
#define EZYSLICE_TRIANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x3BD10E0)
