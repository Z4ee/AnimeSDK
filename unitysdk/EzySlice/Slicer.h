...
#define EZYSLICE_SLICER_CREATEFROM_1_OFFSET UNITYSDK_OFFSET(0xB17B840)
#define EZYSLICE_SLICER_CREATEFROM_OFFSET UNITYSDK_OFFSET(0xB17B890)
#define EZYSLICE_SLICER_CREATEHULL_OFFSET UNITYSDK_OFFSET(0xB17B9C0)
#define EZYSLICE_SLICER_CREATELOWERHULL_OFFSET UNITYSDK_OFFSET(0xB17B9A0)
#define EZYSLICE_SLICER_CREATEUPPERHULL_OFFSET UNITYSDK_OFFSET(0xB17B980)
#define EZYSLICE_SLICER_SLICE_1_OFFSET UNITYSDK_OFFSET(0xB17A330)
#define EZYSLICE_SLICER_SLICE_OFFSET UNITYSDK_OFFSET(0xB179F40)
#define EZYSLICE_SLICER__CTOR_OFFSET UNITYSDK_OFFSET(0xB17D7F0)
