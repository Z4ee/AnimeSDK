...
#define EZYSLICE_SLICER_CREATEFROM_1_OFFSET UNITYSDK_OFFSET(0x1D4578F0)
#define EZYSLICE_SLICER_CREATEFROM_OFFSET UNITYSDK_OFFSET(0x1D457940)
#define EZYSLICE_SLICER_CREATEHULL_OFFSET UNITYSDK_OFFSET(0x1D457A70)
#define EZYSLICE_SLICER_CREATELOWERHULL_OFFSET UNITYSDK_OFFSET(0x1D457A50)
#define EZYSLICE_SLICER_CREATEUPPERHULL_OFFSET UNITYSDK_OFFSET(0x1D457A30)
#define EZYSLICE_SLICER_SLICE_1_OFFSET UNITYSDK_OFFSET(0x1D4563E0)
#define EZYSLICE_SLICER_SLICE_OFFSET UNITYSDK_OFFSET(0x1D455FF0)
#define EZYSLICE_SLICER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4598A0)

namespace EzySlice
{
	inline static constexpr unsigned int Slicer_TypeDefinitionIndex = 47466;
