...
#define CLASS_1_58C07D56FC57643C__CTOR_OFFSET UNITYSDK_OFFSET(0x15942700)
...
public:
	...
	::RPG::GameCore::EnviromentControlPriority JGLBEJOIDLK; // 0x20
	::System::Int32 PHCHCBKAEFH; // 0x24
