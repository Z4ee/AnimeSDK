...
#define CLASS_1_E555DFFCA4EEA2C0_1_METHOD_1_505594EF44B87658_OFFSET UNITYSDK_OFFSET(0x171166D0)
#define CLASS_1_E555DFFCA4EEA2C0_1_METHOD_1_BF3B280A16743FF2_OFFSET UNITYSDK_OFFSET(0x17116EC0)
#define CLASS_1_E555DFFCA4EEA2C0_1_METHOD_1_E16669239EB2C0C9_OFFSET UNITYSDK_OFFSET(0x17116E70)
#define CLASS_1_E555DFFCA4EEA2C0_1__CTOR_OFFSET UNITYSDK_OFFSET(0x171166A0)
...
{
public:
	::RPG::GameCore::AvatarPropertyType HGFIMHFOKNL; // 0x10
	::RPG::GameCore::AvatarPropertyType FMKJGJOKPNP; // 0x14
	::RPG::GameCore::AvatarPropertyType KALLAOMAHEB; // 0x18
	::RPG::GameCore::AvatarPropertyType JJPKJHBGAEC; // 0x1C
	::RPG::GameCore::AvatarPropertyType BFCNHGJAKFL; // 0x20
	::RPG::GameCore::AvatarPropertyType MJGCJCPOJBM; // 0x24
	::RPG::GameCore::AvatarPropertyType ANAKLGDMHEA; // 0x28
