...
#define CSHARPPEROBJECTSHADOWSETTINGS_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1AF495E0)
#define CSHARPPEROBJECTSHADOWSETTINGS_GET_MAXCOUNT_OFFSET UNITYSDK_OFFSET(0x1AF49570)
#define CSHARPPEROBJECTSHADOWSETTINGS_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1AF495F0)
#define CSHARPPEROBJECTSHADOWSETTINGS_SET_MAXCOUNT_OFFSET UNITYSDK_OFFSET(0x1AF495D0)
#define CSHARPPEROBJECTSHADOWSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF49640)

inline static constexpr unsigned int CSharpPerObjectShadowSettings_TypeDefinitionIndex = 26487;
