...
#define CLASS_1_5B567C8A01BAEDFE_37_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1BAE5E90)
#define CLASS_1_5B567C8A01BAEDFE_37_CLONE_OFFSET UNITYSDK_OFFSET(0x1BAE5B30)
#define CLASS_1_5B567C8A01BAEDFE_37_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1BAE5C90)
#define CLASS_1_5B567C8A01BAEDFE_37_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BAE5BA0)
#define CLASS_1_5B567C8A01BAEDFE_37_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BAE5DF0)
#define CLASS_1_5B567C8A01BAEDFE_37_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1BAE5EE0)
#define CLASS_1_5B567C8A01BAEDFE_37_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1BAE5EB0)
#define CLASS_1_5B567C8A01BAEDFE_37_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1BAE5A80)
#define CLASS_1_5B567C8A01BAEDFE_37_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1BAE5AE0)
#define CLASS_1_5B567C8A01BAEDFE_37_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BAE5E20)
#define CLASS_1_5B567C8A01BAEDFE_37_WRITETO_OFFSET UNITYSDK_OFFSET(0x1BAE5E80)
#define CLASS_1_5B567C8A01BAEDFE_37__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BAE5F30)
#define CLASS_1_5B567C8A01BAEDFE_37__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BAE5B00)
#define CLASS_1_5B567C8A01BAEDFE_37__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAE5AF0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_37_TypeDefinitionIndex = 25636;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_37*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_37_TypeDefinitionIndex)->GetStaticField(0x4F340);
	}
