...
#define CLASS_1_43CAD76A5B44BF76_DISPOSE_OFFSET UNITYSDK_OFFSET(0xDABB740)
#define CLASS_1_43CAD76A5B44BF76_METHOD_1_02F18FA9FE9F907A_OFFSET UNITYSDK_OFFSET(0xDABBF90)
#define CLASS_1_43CAD76A5B44BF76_METHOD_1_04AF66402B9859B9_OFFSET UNITYSDK_OFFSET(0xDABC7E0)
#define CLASS_1_43CAD76A5B44BF76_METHOD_1_09EF92B54F64E1A4_OFFSET UNITYSDK_OFFSET(0xDABC3F0)
#define CLASS_1_43CAD76A5B44BF76_METHOD_1_0B7E3489D2C0938B_OFFSET UNITYSDK_OFFSET(0xDABD010)
#define CLASS_1_43CAD76A5B44BF76_METHOD_1_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xDABCF00)
#define CLASS_1_43CAD76A5B44BF76_METHOD_1_2DA8F7A684C1DC34_OFFSET UNITYSDK_OFFSET(0xDABBEF0)
#define CLASS_1_43CAD76A5B44BF76_METHOD_1_3528E5AEECF3EE4B_OFFSET UNITYSDK_OFFSET(0xDABCD90)
#define CLASS_1_43CAD76A5B44BF76_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xDABD170)
#define CLASS_1_43CAD76A5B44BF76_METHOD_1_86ADBB4228161C74_OFFSET UNITYSDK_OFFSET(0xDABD470)
#define CLASS_1_43CAD76A5B44BF76_METHOD_1_A1781348F0A89177_OFFSET UNITYSDK_OFFSET(0xDABD1D0)
#define CLASS_1_43CAD76A5B44BF76_METHOD_1_AB1A8DFD378DB0BE_OFFSET UNITYSDK_OFFSET(0xDABC920)
#define CLASS_1_43CAD76A5B44BF76_METHOD_1_AD33C755E5D9741F_OFFSET UNITYSDK_OFFSET(0xDABC830)
#define CLASS_1_43CAD76A5B44BF76_METHOD_1_AF8423DBB79590E7_OFFSET UNITYSDK_OFFSET(0xDABBD60)
#define CLASS_1_43CAD76A5B44BF76_METHOD_1_C2D66F61AAAE8BC5_OFFSET UNITYSDK_OFFSET(0xDABD9F0)
#define CLASS_1_43CAD76A5B44BF76_METHOD_1_C30D88B8CC4EDF96_OFFSET UNITYSDK_OFFSET(0xDABD890)
#define CLASS_1_43CAD76A5B44BF76_METHOD_1_CD3AA47BC28882AC_OFFSET UNITYSDK_OFFSET(0xDABD590)
#define CLASS_1_43CAD76A5B44BF76_METHOD_1_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0xDABC700)
#define CLASS_1_43CAD76A5B44BF76_METHOD_1_D2A08F3D951A0C1D_OFFSET UNITYSDK_OFFSET(0xDABD0B0)
#define CLASS_1_43CAD76A5B44BF76__CTOR_OFFSET UNITYSDK_OFFSET(0xDABB610)
...
public:
	...
	::System::Action* GOKIJLFOJAB; // 0x10
	::System::Collections::Generic::List_1<::RPG::Client::MonoClockParkStoryCharacter*>* NMMHJPOOPEB; // 0x18
	::System::Collections::Generic::List_1<::Class_1_43CAD76A5B44BF76_Class_1_851E42474B6C53CF*>* BAHEAMBNLME; // 0x20
	::Il2CppArray<::System::String*>* LCBJGHLBMAM; // 0x28
	::RPG::GameCore::ClockParkStoryConfig* IGHAHBNLIJA; // 0x30
	::Il2CppArray<::System::String*>* COLBNHBELCC; // 0x38
	::System::Action* JCIFPBNPAIO; // 0x40
	::RPG::GameCore::GameEntity* KAKEIDJDNHJ; // 0x48
	::RPG::Client::MonoSpineStoryController* CPIIOIPAAKK; // 0x50
	::RPG::Client::MonoSpineStoryAnimEventListener* BGFDACCIPJI; // 0x58
	::System::Single EAFFOJLIIMN; // 0x60
	::System::Boolean LMAJJNKPEPF; // 0x64
	::System::Boolean EJDEKKEOHBE; // 0x65
