...
#define NPCAVATARMESHASSETSSO_ADDMESHASSETS_OFFSET UNITYSDK_OFFSET(0xF847AF0)
#define NPCAVATARMESHASSETSSO_CLEARMESHASSETS_OFFSET UNITYSDK_OFFSET(0xF847A30)
#define NPCAVATARMESHASSETSSO_GETAVATARSLOTMESHASSETS_OFFSET UNITYSDK_OFFSET(0xF847AA0)
#define NPCAVATARMESHASSETSSO_UNLOADEDASSETS_OFFSET UNITYSDK_OFFSET(0xF847820)
#define NPCAVATARMESHASSETSSO__CTOR_OFFSET UNITYSDK_OFFSET(0xF847CA0)

inline static constexpr unsigned int NPCAvatarMeshAssetsSO_TypeDefinitionIndex = 55883;
