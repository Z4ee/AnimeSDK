...
#define CLASS_1_0C1B8B2E4F85A50B_GET_LUAREVISION_OFFSET UNITYSDK_OFFSET(0x1B427EB0)
#define CLASS_1_0C1B8B2E4F85A50B_GET_LUATESTCLASSNAME_OFFSET UNITYSDK_OFFSET(0x1B427ED0)
#define CLASS_1_0C1B8B2E4F85A50B_METHOD_1_3B2051C60621D523_OFFSET UNITYSDK_OFFSET(0x1B428490)
#define CLASS_1_0C1B8B2E4F85A50B_METHOD_1_4C1A7CE92B89CB7C_OFFSET UNITYSDK_OFFSET(0x1B428530)
#define CLASS_1_0C1B8B2E4F85A50B_METHOD_1_5F90D86F03B598EE_OFFSET UNITYSDK_OFFSET(0x1B4292D0)
#define CLASS_1_0C1B8B2E4F85A50B_METHOD_1_B8FA2BA3B5C0B3B5_OFFSET UNITYSDK_OFFSET(0x1B428CD0)
#define CLASS_1_0C1B8B2E4F85A50B_METHOD_1_D3129FE8DF635B48_OFFSET UNITYSDK_OFFSET(0x1B429020)
#define CLASS_1_0C1B8B2E4F85A50B_METHOD_1_EA15CC30BC86B6C7_OFFSET UNITYSDK_OFFSET(0x1B429390)
#define CLASS_1_0C1B8B2E4F85A50B_METHOD_1_EA6D328EF56CB9CB_OFFSET UNITYSDK_OFFSET(0x1B429400)
#define CLASS_1_0C1B8B2E4F85A50B_METHOD_1_F7752AE6CC1E4291_OFFSET UNITYSDK_OFFSET(0x1B4287E0)
#define CLASS_1_0C1B8B2E4F85A50B_METHOD_1_FE12216A0FD81902_OFFSET UNITYSDK_OFFSET(0x1B4290C0)
#define CLASS_1_0C1B8B2E4F85A50B_SET_LUAREVISION_OFFSET UNITYSDK_OFFSET(0x1B427EC0)
#define CLASS_1_0C1B8B2E4F85A50B_SET_LUATESTCLASSNAME_OFFSET UNITYSDK_OFFSET(0x1B427EE0)
#define CLASS_1_0C1B8B2E4F85A50B__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B4294F0)
#define CLASS_1_0C1B8B2E4F85A50B__CTOR_OFFSET UNITYSDK_OFFSET(0x1B427EF0)
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0C1B8B2E4F85A50B_TypeDefinitionIndex)->GetStaticField(0x62140);
	}
	static ::System::Boolean* StaticGet_NNDDLEMBIDP()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_1_0C1B8B2E4F85A50B_TypeDefinitionIndex)->GetStaticField(0x142B0);
	}
	::System::String* _LuaTestClassName_k__BackingField; // 0x10
	::Class_1_ED6813C3C6A0CA52* LCGHJKFMIBI; // 0x18
	::System::Collections::Generic::HashSet_1<::System::String*>* HGBMIPAEMOJ; // 0x20
	::System::Collections::Generic::HashSet_1<::System::String*>* GLBHIKPFIHH; // 0x28
	::System::UInt32 ODBEEJHGNMN; // 0x30
	::System::UInt32 CLCNHJFFNNH; // 0x34
	::System::Int32 _LuaRevision_k__BackingField; // 0x38
	::System::Single MPLIIBHPGLG; // 0x3C
