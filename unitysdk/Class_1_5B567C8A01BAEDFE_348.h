...
#define CLASS_1_5B567C8A01BAEDFE_348_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A500860)
#define CLASS_1_5B567C8A01BAEDFE_348_CLONE_OFFSET UNITYSDK_OFFSET(0x1A5006D0)
#define CLASS_1_5B567C8A01BAEDFE_348_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A500770)
#define CLASS_1_5B567C8A01BAEDFE_348_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A500710)
#define CLASS_1_5B567C8A01BAEDFE_348_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A5007C0)
#define CLASS_1_5B567C8A01BAEDFE_348_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A5008B0)
#define CLASS_1_5B567C8A01BAEDFE_348_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A500880)
#define CLASS_1_5B567C8A01BAEDFE_348_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A500650)
#define CLASS_1_5B567C8A01BAEDFE_348_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A500680)
#define CLASS_1_5B567C8A01BAEDFE_348_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A5007F0)
#define CLASS_1_5B567C8A01BAEDFE_348_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A500850)
#define CLASS_1_5B567C8A01BAEDFE_348__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A500900)
#define CLASS_1_5B567C8A01BAEDFE_348__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5006A0)
#define CLASS_1_5B567C8A01BAEDFE_348__CTOR_OFFSET UNITYSDK_OFFSET(0x1A500690)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_348_TypeDefinitionIndex = 32201;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_348*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_348_TypeDefinitionIndex)->GetStaticField(0xB370);
	}
