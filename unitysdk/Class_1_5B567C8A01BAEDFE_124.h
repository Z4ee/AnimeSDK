...
#define CLASS_1_5B567C8A01BAEDFE_124_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1949B390)
#define CLASS_1_5B567C8A01BAEDFE_124_CLONE_OFFSET UNITYSDK_OFFSET(0x1949B1A0)
#define CLASS_1_5B567C8A01BAEDFE_124_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1949B2A0)
#define CLASS_1_5B567C8A01BAEDFE_124_EQUALS_OFFSET UNITYSDK_OFFSET(0x1949B210)
#define CLASS_1_5B567C8A01BAEDFE_124_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1949B2F0)
#define CLASS_1_5B567C8A01BAEDFE_124_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1949B3E0)
#define CLASS_1_5B567C8A01BAEDFE_124_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1949B3B0)
#define CLASS_1_5B567C8A01BAEDFE_124_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1949B0F0)
#define CLASS_1_5B567C8A01BAEDFE_124_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1949B150)
#define CLASS_1_5B567C8A01BAEDFE_124_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1949B320)
#define CLASS_1_5B567C8A01BAEDFE_124_WRITETO_OFFSET UNITYSDK_OFFSET(0x1949B380)
#define CLASS_1_5B567C8A01BAEDFE_124__CCTOR_OFFSET UNITYSDK_OFFSET(0x1949B430)
#define CLASS_1_5B567C8A01BAEDFE_124__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1949B170)
#define CLASS_1_5B567C8A01BAEDFE_124__CTOR_OFFSET UNITYSDK_OFFSET(0x1949B160)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_124_TypeDefinitionIndex = 27105;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_124*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_124_TypeDefinitionIndex)->GetStaticField(0x4E760);
	}
