...
#define CLASS_1_5B567C8A01BAEDFE_124_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C9FBD60)
#define CLASS_1_5B567C8A01BAEDFE_124_CLONE_OFFSET UNITYSDK_OFFSET(0x1C9FBA00)
#define CLASS_1_5B567C8A01BAEDFE_124_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C9FBB60)
#define CLASS_1_5B567C8A01BAEDFE_124_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C9FBA70)
#define CLASS_1_5B567C8A01BAEDFE_124_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C9FBCC0)
#define CLASS_1_5B567C8A01BAEDFE_124_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C9FBDB0)
#define CLASS_1_5B567C8A01BAEDFE_124_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C9FBD80)
#define CLASS_1_5B567C8A01BAEDFE_124_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C9FB950)
#define CLASS_1_5B567C8A01BAEDFE_124_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C9FB9B0)
#define CLASS_1_5B567C8A01BAEDFE_124_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C9FBCF0)
#define CLASS_1_5B567C8A01BAEDFE_124_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C9FBD50)
#define CLASS_1_5B567C8A01BAEDFE_124__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C9FBE00)
#define CLASS_1_5B567C8A01BAEDFE_124__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C9FB9D0)
#define CLASS_1_5B567C8A01BAEDFE_124__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9FB9C0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_124_TypeDefinitionIndex = 27518;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_124*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_124_TypeDefinitionIndex)->GetStaticField(0x37EF0);
	}
