...
#define CLASS_1_5B567C8A01BAEDFE_124_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DBB1400)
#define CLASS_1_5B567C8A01BAEDFE_124_CLONE_OFFSET UNITYSDK_OFFSET(0x1DBB10A0)
#define CLASS_1_5B567C8A01BAEDFE_124_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DBB1200)
#define CLASS_1_5B567C8A01BAEDFE_124_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DBB1110)
#define CLASS_1_5B567C8A01BAEDFE_124_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DBB1360)
#define CLASS_1_5B567C8A01BAEDFE_124_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DBB1450)
#define CLASS_1_5B567C8A01BAEDFE_124_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DBB1420)
#define CLASS_1_5B567C8A01BAEDFE_124_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1DBB0FF0)
#define CLASS_1_5B567C8A01BAEDFE_124_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DBB1050)
#define CLASS_1_5B567C8A01BAEDFE_124_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DBB1390)
#define CLASS_1_5B567C8A01BAEDFE_124_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DBB13F0)
#define CLASS_1_5B567C8A01BAEDFE_124__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DBB14A0)
#define CLASS_1_5B567C8A01BAEDFE_124__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DBB1070)
#define CLASS_1_5B567C8A01BAEDFE_124__CTOR_OFFSET UNITYSDK_OFFSET(0x1DBB1060)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_124_TypeDefinitionIndex = 28134;

class Class_1_5B567C8A01BAEDFE_124 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_124*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_124*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_124_TypeDefinitionIndex)->GetStaticField(0x35D60);
	}
