...
#define CLASS_1_5B567C8A01BAEDFE_9_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1CAD7F20)
#define CLASS_1_5B567C8A01BAEDFE_9_CLONE_OFFSET UNITYSDK_OFFSET(0x1CAD7C10)
#define CLASS_1_5B567C8A01BAEDFE_9_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1CAD7D20)
#define CLASS_1_5B567C8A01BAEDFE_9_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CAD7C50)
#define CLASS_1_5B567C8A01BAEDFE_9_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CAD7E80)
#define CLASS_1_5B567C8A01BAEDFE_9_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1CAD7F70)
#define CLASS_1_5B567C8A01BAEDFE_9_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1CAD7F40)
#define CLASS_1_5B567C8A01BAEDFE_9_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1CAD7B90)
#define CLASS_1_5B567C8A01BAEDFE_9_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1CAD7BC0)
#define CLASS_1_5B567C8A01BAEDFE_9_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1CAD7EB0)
#define CLASS_1_5B567C8A01BAEDFE_9_WRITETO_OFFSET UNITYSDK_OFFSET(0x1CAD7F10)
#define CLASS_1_5B567C8A01BAEDFE_9__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CAD7FC0)
#define CLASS_1_5B567C8A01BAEDFE_9__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CAD7BE0)
#define CLASS_1_5B567C8A01BAEDFE_9__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAD7BD0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_9*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_9_TypeDefinitionIndex)->GetStaticField(0x594F0);
	}
