...
#define CLASS_1_5B567C8A01BAEDFE_9_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A852A70)
#define CLASS_1_5B567C8A01BAEDFE_9_CLONE_OFFSET UNITYSDK_OFFSET(0x1A852880)
#define CLASS_1_5B567C8A01BAEDFE_9_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A852980)
#define CLASS_1_5B567C8A01BAEDFE_9_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A8528F0)
#define CLASS_1_5B567C8A01BAEDFE_9_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A8529D0)
#define CLASS_1_5B567C8A01BAEDFE_9_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A852AC0)
#define CLASS_1_5B567C8A01BAEDFE_9_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A852A90)
#define CLASS_1_5B567C8A01BAEDFE_9_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A8527D0)
#define CLASS_1_5B567C8A01BAEDFE_9_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A852830)
#define CLASS_1_5B567C8A01BAEDFE_9_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A852A00)
#define CLASS_1_5B567C8A01BAEDFE_9_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A852A60)
#define CLASS_1_5B567C8A01BAEDFE_9__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A852B10)
#define CLASS_1_5B567C8A01BAEDFE_9__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A852850)
#define CLASS_1_5B567C8A01BAEDFE_9__CTOR_OFFSET UNITYSDK_OFFSET(0x1A852840)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_9_TypeDefinitionIndex = 24539;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_9*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_9_TypeDefinitionIndex)->GetStaticField(0x51920);
	}
