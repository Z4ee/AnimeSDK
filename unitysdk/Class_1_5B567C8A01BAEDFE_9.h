...
#define CLASS_1_5B567C8A01BAEDFE_9_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x198B63F0)
#define CLASS_1_5B567C8A01BAEDFE_9_CLONE_OFFSET UNITYSDK_OFFSET(0x198B6200)
#define CLASS_1_5B567C8A01BAEDFE_9_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x198B6300)
#define CLASS_1_5B567C8A01BAEDFE_9_EQUALS_OFFSET UNITYSDK_OFFSET(0x198B6270)
#define CLASS_1_5B567C8A01BAEDFE_9_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x198B6350)
#define CLASS_1_5B567C8A01BAEDFE_9_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x198B6440)
#define CLASS_1_5B567C8A01BAEDFE_9_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x198B6410)
#define CLASS_1_5B567C8A01BAEDFE_9_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x198B6150)
#define CLASS_1_5B567C8A01BAEDFE_9_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x198B61B0)
#define CLASS_1_5B567C8A01BAEDFE_9_TOSTRING_OFFSET UNITYSDK_OFFSET(0x198B6380)
#define CLASS_1_5B567C8A01BAEDFE_9_WRITETO_OFFSET UNITYSDK_OFFSET(0x198B63E0)
#define CLASS_1_5B567C8A01BAEDFE_9__CCTOR_OFFSET UNITYSDK_OFFSET(0x198B6490)
#define CLASS_1_5B567C8A01BAEDFE_9__CTOR_1_OFFSET UNITYSDK_OFFSET(0x198B61D0)
#define CLASS_1_5B567C8A01BAEDFE_9__CTOR_OFFSET UNITYSDK_OFFSET(0x198B61C0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_9_TypeDefinitionIndex = 24678;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_9*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_9_TypeDefinitionIndex)->GetStaticField(0x21830);
	}
	...
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_9*>* Method_1_33819E510657F52F()
	{
		return ((::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_9*>*(*)())((::PBYTE)hIl2Cpp + CLASS_1_5B567C8A01BAEDFE_9_METHOD_1_33819E510657F52F_OFFSET))();
	}
