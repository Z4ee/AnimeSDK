...
#define CLASS_1_3DE83D320AD4AA4D_CLASS_1_A4B66D97A840228A_METHOD_1_37B19DD467840408_OFFSET UNITYSDK_OFFSET(0x15975C00)
#define CLASS_1_3DE83D320AD4AA4D_CLASS_1_A4B66D97A840228A_METHOD_1_B7365BEAE6ABC80E_OFFSET UNITYSDK_OFFSET(0x15975C70)
#define CLASS_1_3DE83D320AD4AA4D_CLASS_1_A4B66D97A840228A_METHOD_1_F10A0D072D26C4BF_OFFSET UNITYSDK_OFFSET(0x15976670)
#define CLASS_1_3DE83D320AD4AA4D_CLASS_1_A4B66D97A840228A__CTOR_OFFSET UNITYSDK_OFFSET(0x15978690)
...
public:
	...
	::RPG::GameCore::GameEntity* MBGIFEEHONI; // 0x18
	::RPG::GameCore::GameEntity* LIACFBDAIJA; // 0x20
	::UnityEngine::Vector3 EPDFFDPDGCI; // 0x28
	::System::Single NEIDCIINFHO; // 0x34
	::UnityEngine::Vector3 PBLCIKOCKPB; // 0x38
	::UnityEngine::Vector3 MMGLHLBIICB; // 0x44
