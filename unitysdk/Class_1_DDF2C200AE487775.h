...
#define CLASS_1_DDF2C200AE487775_METHOD_1_246354701856B763_OFFSET UNITYSDK_OFFSET(0x18CADE40)
#define CLASS_1_DDF2C200AE487775_METHOD_1_6B4DC5043D435955_OFFSET UNITYSDK_OFFSET(0x18CADC20)
#define CLASS_1_DDF2C200AE487775__CTOR_OFFSET UNITYSDK_OFFSET(0x18CADC00)

inline static constexpr unsigned int Class_1_DDF2C200AE487775_TypeDefinitionIndex = 80170;

class Class_1_DDF2C200AE487775 : public ::System::Object
{
public:
	::Class_1_7D46F1066EF90FA6_3* CKHDGEHELHN; // 0x10
	::Class_0_16E4307DCC419505_680* MOHKEEEHFOB; // 0x18
	::Class_1_FA2301FC3580108A* IJPANNPNBFG; // 0x20
	::Class_1_AEA0006661D84E3E* LIIFJAEMFDP; // 0x28
