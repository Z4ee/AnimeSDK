...
#define CLASS_2_A96177E35D1B1813_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x15544CC0)
#define CLASS_2_A96177E35D1B1813_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x15544E00)
#define CLASS_2_A96177E35D1B1813_METHOD_2_2F3FBB2E55AB1872_OFFSET UNITYSDK_OFFSET(0x15544150)
#define CLASS_2_A96177E35D1B1813_METHOD_2_364E91940C737CC9_OFFSET UNITYSDK_OFFSET(0x15543370)
#define CLASS_2_A96177E35D1B1813_METHOD_2_36F46336ADA62D13_OFFSET UNITYSDK_OFFSET(0x15543310)
#define CLASS_2_A96177E35D1B1813_METHOD_2_40D4B7BE16D185D0_OFFSET UNITYSDK_OFFSET(0x15544690)
#define CLASS_2_A96177E35D1B1813_METHOD_2_AAD864A9DF964170_OFFSET UNITYSDK_OFFSET(0x155436C0)
#define CLASS_2_A96177E35D1B1813_METHOD_2_B29205EE7F7B640C_OFFSET UNITYSDK_OFFSET(0x15543A70)
#define CLASS_2_A96177E35D1B1813_METHOD_2_C450A961450309C9_OFFSET UNITYSDK_OFFSET(0x15544BD0)
#define CLASS_2_A96177E35D1B1813_METHOD_2_CB31C267907A2689_OFFSET UNITYSDK_OFFSET(0x15544430)
#define CLASS_2_A96177E35D1B1813_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x15544B40)
#define CLASS_2_A96177E35D1B1813_METHOD_2_FE73875B305F4515_OFFSET UNITYSDK_OFFSET(0x155442B0)
#define CLASS_2_A96177E35D1B1813__CTOR_OFFSET UNITYSDK_OFFSET(0x15544F20)
#define CLASS_2_A96177E35D1B1813__ONBIND_OFFSET UNITYSDK_OFFSET(0x15542F10)

inline static constexpr unsigned int Class_2_A96177E35D1B1813_TypeDefinitionIndex = 72211;

class Class_2_A96177E35D1B1813 : public ::Class_1_34917908B7833130
{
public:
	::System::Collections::Generic::List_1<::Class_2_DBF482F9F6F56036*>* OMFKMHEBHKD; // 0x60
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::GridFightOrbType, ::System::UInt32>* DLECDDCAKAJ; // 0x68
	::UnityEngine::UI::Image* JPKHJJDEMFH; // 0x70
	::Class_2_38034A0ABCA9E37F* GBAKOENKKBH; // 0x78
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::GridFightOrbType, ::System::UInt32>* IDHNAHIPNIM; // 0x80
	::Class_2_A8886CB1373AE575* KLLFDGDIICC; // 0x88
	::UnityEngine::UI::Image* NACCDGKNFHN; // 0x90
	::UnityEngine::RectTransform* FOFFDAGOGJH; // 0x98
	::UnityEngine::Transform* GCMJKKGGMDH; // 0xA0
	::UnityEngine::UI::Text* KPICPMEANJJ; // 0xA8
	::UnityEngine::UI::Image* LGBBDPNNCJK; // 0xB0
	::UnityEngine::UI::Text* OEKNHAKDJPN; // 0xB8
	::RPG::Client::PrefabLoadMeta* KJECMEECIOG; // 0xC0
	::System::Int32 LLDCAPMMCFM; // 0xC8
