...
#define STRUCT_2_ACD0EF80A5330786_METHOD_2_5394145894BDC459_OFFSET UNITYSDK_OFFSET(0x821370)
#define STRUCT_2_ACD0EF80A5330786_METHOD_2_CE34EA208837238D_OFFSET UNITYSDK_OFFSET(0x821340)
#define STRUCT_2_ACD0EF80A5330786__CCTOR_OFFSET UNITYSDK_OFFSET(0x15657D40)
#define STRUCT_2_ACD0EF80A5330786__CTOR_OFFSET UNITYSDK_OFFSET(0x8212C0)

inline static constexpr unsigned int Struct_2_ACD0EF80A5330786_TypeDefinitionIndex = 80696;

struct alignas(8) Struct_2_ACD0EF80A5330786
{
	static ::Struct_2_ACD0EF80A5330786* StaticGet_Field_2_0()
	{
		return (::Struct_2_ACD0EF80A5330786*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_ACD0EF80A5330786_TypeDefinitionIndex)->GetStaticField(0xA960);
	}
	::Struct_2_F0CFA50094D8FF32 Field_2_3; // 0x10
	::Struct_2_172EDDF213DEFCC4 Field_2_2; // 0x60
	::Struct_2_E521CB413C09680F Field_2_1; // 0x90
