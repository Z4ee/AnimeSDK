...
#define CLASS_2_47DFEC9BD42C894E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x165DE060)
#define CLASS_2_47DFEC9BD42C894E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x165DE0A0)
#define CLASS_2_47DFEC9BD42C894E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x165DE120)
#define CLASS_2_47DFEC9BD42C894E_TICK_OFFSET UNITYSDK_OFFSET(0x165DE170)
#define CLASS_2_47DFEC9BD42C894E__CTOR_OFFSET UNITYSDK_OFFSET(0x165DE050)

inline static constexpr unsigned int Class_2_47DFEC9BD42C894E_TypeDefinitionIndex = 56645;

class Class_2_47DFEC9BD42C894E : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ShowUltraSkillAlternative* OFKGLJOAMLD; // 0x18
