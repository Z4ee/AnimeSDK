...
#define STAGEHARMONYGRADIENTDEMODULATOR_METHOD_3_39CA3A8D335F6DEC_OFFSET UNITYSDK_OFFSET(0xABDD3D0)
#define STAGEHARMONYGRADIENTDEMODULATOR_METHOD_3_F4B1CC0F7E08D926_OFFSET UNITYSDK_OFFSET(0xABDD470)
#define STAGEHARMONYGRADIENTDEMODULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xABDD4C0)

inline static constexpr unsigned int StageHarmonyGradientDemodulator_TypeDefinitionIndex = 38387;
