...
#define STAGEHARMONYGRADIENTDEMODULATOR_METHOD_3_39CA3A8D335F6DEC_OFFSET UNITYSDK_OFFSET(0xE93C470)
#define STAGEHARMONYGRADIENTDEMODULATOR_METHOD_3_F4B1CC0F7E08D926_OFFSET UNITYSDK_OFFSET(0xE93C510)
#define STAGEHARMONYGRADIENTDEMODULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xE93C560)
