...
#define CLASS_1_A7CE96953806D8B2__CTOR_OFFSET UNITYSDK_OFFSET(0x15E1CCE0)
...
{
public:
	::System::Single DMMINDDMKGC; // 0x10
	::UnityEngine::Vector3 MBOCCOCLONK; // 0x14
	::UnityEngine::Vector3 INFNMPEAHJN; // 0x20
	::System::Single OOFCHJHBKCD; // 0x2C
