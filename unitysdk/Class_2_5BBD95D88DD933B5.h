...
#define CLASS_2_5BBD95D88DD933B5_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1843EDB0)
#define CLASS_2_5BBD95D88DD933B5_METHOD_2_03F25796FF41212C_OFFSET UNITYSDK_OFFSET(0x1843EC20)
#define CLASS_2_5BBD95D88DD933B5_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x1843EBE0)
#define CLASS_2_5BBD95D88DD933B5_METHOD_2_939B0A8FB671683E_OFFSET UNITYSDK_OFFSET(0x1843EA60)
#define CLASS_2_5BBD95D88DD933B5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1843EF50)
#define CLASS_2_5BBD95D88DD933B5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1843ED60)
#define CLASS_2_5BBD95D88DD933B5_TICK_OFFSET UNITYSDK_OFFSET(0x1843EE00)
#define CLASS_2_5BBD95D88DD933B5__CTOR_OFFSET UNITYSDK_OFFSET(0x1843EA50)

inline static constexpr unsigned int Class_2_5BBD95D88DD933B5_TypeDefinitionIndex = 55887;

class Class_2_5BBD95D88DD933B5 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SetAudienceGroupVisible* Field_2_0; // 0x18
