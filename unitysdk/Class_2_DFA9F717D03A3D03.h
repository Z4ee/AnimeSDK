...
#define CLASS_2_DFA9F717D03A3D03_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17FEAF60)
#define CLASS_2_DFA9F717D03A3D03_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17FEAFA0)
#define CLASS_2_DFA9F717D03A3D03_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17FEAFF0)
#define CLASS_2_DFA9F717D03A3D03_TICK_OFFSET UNITYSDK_OFFSET(0x17FEB040)
#define CLASS_2_DFA9F717D03A3D03__CTOR_OFFSET UNITYSDK_OFFSET(0x17FEAF50)

inline static constexpr unsigned int Class_2_DFA9F717D03A3D03_TypeDefinitionIndex = 55724;

class Class_2_DFA9F717D03A3D03 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SetMechanismBarState* OFKGLJOAMLD; // 0x18
