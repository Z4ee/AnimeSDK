...
#define CLASS_1_D0CCDBD424B46DAF_EQUALS_OFFSET UNITYSDK_OFFSET(0x98B59F0)
#define CLASS_1_D0CCDBD424B46DAF_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x98B5A50)
#define CLASS_1_D0CCDBD424B46DAF__CCTOR_OFFSET UNITYSDK_OFFSET(0x98B5AF0)
#define CLASS_1_D0CCDBD424B46DAF__CTOR_OFFSET UNITYSDK_OFFSET(0x98B5AE0)

inline static constexpr unsigned int Class_1_D0CCDBD424B46DAF_TypeDefinitionIndex = 63884;
...
public:
	...
	{
		return (::Class_1_D0CCDBD424B46DAF**)Il2CppClass::FromTypeDefinitionIndex(Class_1_D0CCDBD424B46DAF_TypeDefinitionIndex)->GetStaticField(0x13180);
	}
