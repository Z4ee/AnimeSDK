...
#define CLASS_1_D0CCDBD424B46DAF_EQUALS_OFFSET UNITYSDK_OFFSET(0x153A59C0)
#define CLASS_1_D0CCDBD424B46DAF_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x153A5A20)
#define CLASS_1_D0CCDBD424B46DAF__CCTOR_OFFSET UNITYSDK_OFFSET(0x153A5AC0)
#define CLASS_1_D0CCDBD424B46DAF__CTOR_OFFSET UNITYSDK_OFFSET(0x153A5AB0)
...
public:
	...
	{
		return (::Class_1_D0CCDBD424B46DAF**)Il2CppClass::FromTypeDefinitionIndex(Class_1_D0CCDBD424B46DAF_TypeDefinitionIndex)->GetStaticField(0x1ECC0);
	}
