...
#define AKAUXSENDARRAY_ADD_1_OFFSET UNITYSDK_OFFSET(0x1C3707B0)
#define AKAUXSENDARRAY_ADD_OFFSET UNITYSDK_OFFSET(0x1C370550)
#define AKAUXSENDARRAY_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x1C370BB0)
#define AKAUXSENDARRAY_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1C370880)
#define AKAUXSENDARRAY_COUNT_OFFSET UNITYSDK_OFFSET(0x1C371100)
#define AKAUXSENDARRAY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C370490)
#define AKAUXSENDARRAY_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1C3704C0)
#define AKAUXSENDARRAY_GETBUFFER_OFFSET UNITYSDK_OFFSET(0x1C3710F0)
#define AKAUXSENDARRAY_GETOBJECTPTR_OFFSET UNITYSDK_OFFSET(0x1C370460)
#define AKAUXSENDARRAY_GETVALUES_OFFSET UNITYSDK_OFFSET(0x1C370EC0)
#define AKAUXSENDARRAY_GET_ISFULL_OFFSET UNITYSDK_OFFSET(0x1C370470)
#define AKAUXSENDARRAY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1C3703D0)
#define AKAUXSENDARRAY_RESET_OFFSET UNITYSDK_OFFSET(0x1C370540)
#define AKAUXSENDARRAY_SETVALUES_OFFSET UNITYSDK_OFFSET(0x1C370CA0)
#define AKAUXSENDARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C370330)

inline static constexpr unsigned int AkAuxSendArray_TypeDefinitionIndex = 31534;
