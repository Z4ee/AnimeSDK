...
#define AKAUXSENDARRAY_ADD_1_OFFSET UNITYSDK_OFFSET(0x1A5CE3A0)
#define AKAUXSENDARRAY_ADD_OFFSET UNITYSDK_OFFSET(0x1A5CE140)
#define AKAUXSENDARRAY_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x1A5CE780)
#define AKAUXSENDARRAY_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1A5CE530)
#define AKAUXSENDARRAY_COUNT_OFFSET UNITYSDK_OFFSET(0x1A5CEC40)
#define AKAUXSENDARRAY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A5CDFE0)
#define AKAUXSENDARRAY_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A5CE040)
#define AKAUXSENDARRAY_GETBUFFER_OFFSET UNITYSDK_OFFSET(0x1A5CEC00)
#define AKAUXSENDARRAY_GETOBJECTPTR_OFFSET UNITYSDK_OFFSET(0x1A5CDF20)
#define AKAUXSENDARRAY_GETVALUES_OFFSET UNITYSDK_OFFSET(0x1A5CEA70)
#define AKAUXSENDARRAY_GET_ISFULL_OFFSET UNITYSDK_OFFSET(0x1A5CDF90)
#define AKAUXSENDARRAY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A5CDE30)
#define AKAUXSENDARRAY_RESET_OFFSET UNITYSDK_OFFSET(0x1A5CE0F0)
#define AKAUXSENDARRAY_SETVALUES_OFFSET UNITYSDK_OFFSET(0x1A5CE8F0)
#define AKAUXSENDARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5CDD90)
