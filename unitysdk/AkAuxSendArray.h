...
#define AKAUXSENDARRAY_ADD_1_OFFSET UNITYSDK_OFFSET(0x1D582280)
#define AKAUXSENDARRAY_ADD_OFFSET UNITYSDK_OFFSET(0x1D582020)
#define AKAUXSENDARRAY_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x1D582660)
#define AKAUXSENDARRAY_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1D582410)
#define AKAUXSENDARRAY_COUNT_OFFSET UNITYSDK_OFFSET(0x1D582B20)
#define AKAUXSENDARRAY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D581EC0)
#define AKAUXSENDARRAY_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1D581F20)
#define AKAUXSENDARRAY_GETBUFFER_OFFSET UNITYSDK_OFFSET(0x1D582AE0)
#define AKAUXSENDARRAY_GETOBJECTPTR_OFFSET UNITYSDK_OFFSET(0x1D581E00)
#define AKAUXSENDARRAY_GETVALUES_OFFSET UNITYSDK_OFFSET(0x1D582950)
#define AKAUXSENDARRAY_GET_ISFULL_OFFSET UNITYSDK_OFFSET(0x1D581E70)
#define AKAUXSENDARRAY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D581D10)
#define AKAUXSENDARRAY_RESET_OFFSET UNITYSDK_OFFSET(0x1D581FD0)
#define AKAUXSENDARRAY_SETVALUES_OFFSET UNITYSDK_OFFSET(0x1D5827D0)
#define AKAUXSENDARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D581C70)
