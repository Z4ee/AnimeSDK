...
#define AKAUXSENDARRAY_ADD_1_OFFSET UNITYSDK_OFFSET(0x18B92DB0)
#define AKAUXSENDARRAY_ADD_OFFSET UNITYSDK_OFFSET(0x18B92B50)
#define AKAUXSENDARRAY_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x18B93190)
#define AKAUXSENDARRAY_CONTAINS_OFFSET UNITYSDK_OFFSET(0x18B92F40)
#define AKAUXSENDARRAY_COUNT_OFFSET UNITYSDK_OFFSET(0x18B93650)
#define AKAUXSENDARRAY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18B929F0)
#define AKAUXSENDARRAY_FINALIZE_OFFSET UNITYSDK_OFFSET(0x18B92A50)
#define AKAUXSENDARRAY_GETBUFFER_OFFSET UNITYSDK_OFFSET(0x18B93610)
#define AKAUXSENDARRAY_GETOBJECTPTR_OFFSET UNITYSDK_OFFSET(0x18B92930)
#define AKAUXSENDARRAY_GETVALUES_OFFSET UNITYSDK_OFFSET(0x18B93480)
#define AKAUXSENDARRAY_GET_ISFULL_OFFSET UNITYSDK_OFFSET(0x18B929A0)
#define AKAUXSENDARRAY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x18B92840)
#define AKAUXSENDARRAY_RESET_OFFSET UNITYSDK_OFFSET(0x18B92B00)
#define AKAUXSENDARRAY_SETVALUES_OFFSET UNITYSDK_OFFSET(0x18B93300)
#define AKAUXSENDARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x18B927A0)
