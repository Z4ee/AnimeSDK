...
#define CLASS_1_2AB9BCA81E3BF60F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19AA3A10)
#define CLASS_1_2AB9BCA81E3BF60F_METHOD_1_0B28C9A2CBDF8E59_OFFSET UNITYSDK_OFFSET(0x19AA3A50)
#define CLASS_1_2AB9BCA81E3BF60F_METHOD_1_413F493333BF3391_OFFSET UNITYSDK_OFFSET(0x19AA3A80)
#define CLASS_1_2AB9BCA81E3BF60F_METHOD_1_D37FAD0A6AA04B25_OFFSET UNITYSDK_OFFSET(0x19AA3A60)
#define CLASS_1_2AB9BCA81E3BF60F__CTOR_OFFSET UNITYSDK_OFFSET(0x19AA37D0)

inline static constexpr unsigned int Class_1_2AB9BCA81E3BF60F_TypeDefinitionIndex = 52401;

class Class_1_2AB9BCA81E3BF60F : public ::System::Object
{
public:
	::RPG::GameCore::LevelSmartObjectPointInfo* PMAPIEMDKKA; // 0x10
	::UnityEngine::Vector3 MIFKHBDOGLN; // 0x18
	::UnityEngine::Quaternion NCMEPPHLGEG; // 0x24
