...
#define CLASS_2_9A66FA3BB2310F53_GET_MESSAGETYPE_OFFSET UNITYSDK_OFFSET(0x1789A940)
#define CLASS_2_9A66FA3BB2310F53_METHOD_2_0507C99F3FA45C25_OFFSET UNITYSDK_OFFSET(0x1789B610)
#define CLASS_2_9A66FA3BB2310F53_METHOD_2_10054BB010E03EDD_OFFSET UNITYSDK_OFFSET(0x1789B400)
#define CLASS_2_9A66FA3BB2310F53_METHOD_2_1B9CC121BDC8766D_1_OFFSET UNITYSDK_OFFSET(0x1789BAC0)
#define CLASS_2_9A66FA3BB2310F53_METHOD_2_1B9CC121BDC8766D_OFFSET UNITYSDK_OFFSET(0x1789C0E0)
#define CLASS_2_9A66FA3BB2310F53_METHOD_2_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x1789AFE0)
#define CLASS_2_9A66FA3BB2310F53_METHOD_2_3456633D994FB6C5_OFFSET UNITYSDK_OFFSET(0x1789B040)
#define CLASS_2_9A66FA3BB2310F53_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x1789BDE0)
#define CLASS_2_9A66FA3BB2310F53_METHOD_2_39C2C0615CAE0F74_OFFSET UNITYSDK_OFFSET(0x1789A980)
#define CLASS_2_9A66FA3BB2310F53_METHOD_2_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x1789C530)
#define CLASS_2_9A66FA3BB2310F53_METHOD_2_4389275F4099DE36_OFFSET UNITYSDK_OFFSET(0x1789B2E0)
#define CLASS_2_9A66FA3BB2310F53_METHOD_2_44196695CAF284A8_OFFSET UNITYSDK_OFFSET(0x1789C160)
#define CLASS_2_9A66FA3BB2310F53_METHOD_2_479759059E440327_OFFSET UNITYSDK_OFFSET(0x1789BBD0)
#define CLASS_2_9A66FA3BB2310F53_METHOD_2_50884DFE76178C82_OFFSET UNITYSDK_OFFSET(0x1789C3B0)
#define CLASS_2_9A66FA3BB2310F53_METHOD_2_59F822BEBD709FE9_OFFSET UNITYSDK_OFFSET(0x1789C340)
#define CLASS_2_9A66FA3BB2310F53_METHOD_2_6DC60149A270E0D4_OFFSET UNITYSDK_OFFSET(0x1789BF40)
#define CLASS_2_9A66FA3BB2310F53_METHOD_2_6DFEF4918C679AF0_OFFSET UNITYSDK_OFFSET(0x1789B1A0)
#define CLASS_2_9A66FA3BB2310F53_METHOD_2_70589F89E4D22649_OFFSET UNITYSDK_OFFSET(0x1789BE30)
#define CLASS_2_9A66FA3BB2310F53_METHOD_2_709E9C02EF9B7181_OFFSET UNITYSDK_OFFSET(0x1789C720)
#define CLASS_2_9A66FA3BB2310F53_METHOD_2_76903A6ADE048EAF_OFFSET UNITYSDK_OFFSET(0x1789C7E0)
#define CLASS_2_9A66FA3BB2310F53_METHOD_2_7C7377C794E8973C_OFFSET UNITYSDK_OFFSET(0x1789AF70)
#define CLASS_2_9A66FA3BB2310F53_METHOD_2_8376FB8F62573977_OFFSET UNITYSDK_OFFSET(0x1789AD90)
#define CLASS_2_9A66FA3BB2310F53_METHOD_2_85EBE7A0BED75540_OFFSET UNITYSDK_OFFSET(0x1789C6B0)
#define CLASS_2_9A66FA3BB2310F53_METHOD_2_892F9DA89D0163F2_OFFSET UNITYSDK_OFFSET(0x1789AB00)
#define CLASS_2_9A66FA3BB2310F53_METHOD_2_AEA938E393CB58B0_OFFSET UNITYSDK_OFFSET(0x1789C060)
#define CLASS_2_9A66FA3BB2310F53_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x1789BB40)
#define CLASS_2_9A66FA3BB2310F53_METHOD_2_B732DC7FA82BA621_OFFSET UNITYSDK_OFFSET(0x1789C450)
#define CLASS_2_9A66FA3BB2310F53_METHOD_2_BADDA70ED68283AE_OFFSET UNITYSDK_OFFSET(0x1789B570)
#define CLASS_2_9A66FA3BB2310F53_METHOD_2_F5EE5DF9DB6DF16B_OFFSET UNITYSDK_OFFSET(0x1789B520)
#define CLASS_2_9A66FA3BB2310F53__CTOR_OFFSET UNITYSDK_OFFSET(0x1789C870)
#define CLASS_2_9A66FA3BB2310F53__ONBIND_OFFSET UNITYSDK_OFFSET(0x1789B6E0)
#define CLASS_2_9A66FA3BB2310F53__ONTICK_OFFSET UNITYSDK_OFFSET(0x1789BC50)

inline static constexpr unsigned int Class_2_9A66FA3BB2310F53_TypeDefinitionIndex = 71479;
...
public:
	...
	::UnityEngine::UI::ContentSizeFitter* PFIOEBPHDFI; // 0x68
	::UnityEngine::CanvasGroup* JNAEPLHBGAN; // 0x70
	::UnityEngine::UI::Image* FFMGCODMNGI; // 0x78
	::UnityEngine::UI::Image* HJBDCDMLDDO; // 0x80
	::System::String* AMMFAOBBPCN; // 0x88
	::RPG::GameCore::GameEntity* KAKEIDJDNHJ; // 0x90
	::UnityEngine::Transform* MACEILOIEKA; // 0x98
	::UnityEngine::Transform* ILEBMCNOKBC; // 0xA0
	::RPG::Client::LocalizedText* GBBFIGEPDGK; // 0xA8
	::UnityEngine::RectTransform* NEEDDJHCCND; // 0xB0
	::UnityEngine::Animation* JPHOOFFIAAH; // 0xB8
	::UnityEngine::Transform* JIFPALLIGIA; // 0xC0
	::RPG::Client::UIFollow3DTarget* LLBJOCEMNPK; // 0xC8
	::UnityEngine::Transform* DGNBGCHECOB; // 0xD0
	::UnityEngine::Transform* ICPDPLMAEHF; // 0xD8
	::UnityEngine::UI::LayoutGroup* BPPBHGGCBCH; // 0xE0
	::RPG::Client::LocalizedText* GEPFFDDHPAI; // 0xE8
	::UnityEngine::RectTransform* HACIPINNIOG; // 0xF0
	::System::Single HBDJCFFDGDD; // 0xF8
	::System::Single MFIFOONNJPE; // 0xFC
	::System::Boolean HCGJMGFNFBL; // 0x100
	::System::Boolean MCAPIAKDMAA; // 0x101
	::System::Boolean POGICBHCJIB; // 0x102
