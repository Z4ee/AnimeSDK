...
#define CLASS_2_1A82AC493F81B9D5_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB9B9B90)
#define CLASS_2_1A82AC493F81B9D5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB9B9BD0)
#define CLASS_2_1A82AC493F81B9D5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB9B9E40)
#define CLASS_2_1A82AC493F81B9D5_TICK_OFFSET UNITYSDK_OFFSET(0xB9B9E90)
#define CLASS_2_1A82AC493F81B9D5__CTOR_OFFSET UNITYSDK_OFFSET(0xB9B9B80)
...
{
public:
	::RPG::GameCore::ReleaseEnvProfileForStory* OFKGLJOAMLD; // 0x18
