...
#define PACKAGENAMERECORD__UPLOADFILE_D__3_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x9A8B0A0)
#define PACKAGENAMERECORD__UPLOADFILE_D__3_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x9A8B400)
#define PACKAGENAMERECORD__UPLOADFILE_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x9A8B460)
#define PACKAGENAMERECORD__UPLOADFILE_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x9A8B410)
#define PACKAGENAMERECORD__UPLOADFILE_D__3_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9A8B090)
#define PACKAGENAMERECORD__UPLOADFILE_D__3__CTOR_OFFSET UNITYSDK_OFFSET(0x9A8B070)
