...
#define PACKAGENAMERECORD__UPLOADFILE_D__3_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x8EB97D0)
#define PACKAGENAMERECORD__UPLOADFILE_D__3_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x8EB9B30)
#define PACKAGENAMERECORD__UPLOADFILE_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x8EB9B90)
#define PACKAGENAMERECORD__UPLOADFILE_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x8EB9B40)
#define PACKAGENAMERECORD__UPLOADFILE_D__3_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8EB97C0)
#define PACKAGENAMERECORD__UPLOADFILE_D__3__CTOR_OFFSET UNITYSDK_OFFSET(0x8EB97A0)

inline static constexpr unsigned int PackageNameRecord__UploadFile_d__3_TypeDefinitionIndex = 38442;
