...
#define CLASS_3_206F177A6C7E89E8_ADD_OFFSET UNITYSDK_OFFSET(0x115FFA80)
#define CLASS_3_206F177A6C7E89E8_METHOD_3_0A2C90C6A56B419C_OFFSET UNITYSDK_OFFSET(0x11600480)
#define CLASS_3_206F177A6C7E89E8_METHOD_3_6C0D3BB3C6621FFD_OFFSET UNITYSDK_OFFSET(0x11600160)
#define CLASS_3_206F177A6C7E89E8_METHOD_3_7017C9D6C32E7D7F_OFFSET UNITYSDK_OFFSET(0x115FF5B0)
#define CLASS_3_206F177A6C7E89E8_METHOD_3_83AE46DB8772209E_OFFSET UNITYSDK_OFFSET(0x11600520)
#define CLASS_3_206F177A6C7E89E8_METHOD_3_F4BACB8E9D45997B_OFFSET UNITYSDK_OFFSET(0x115FFC90)
#define CLASS_3_206F177A6C7E89E8__CTOR_OFFSET UNITYSDK_OFFSET(0x11600750)

inline static constexpr unsigned int Class_3_206F177A6C7E89E8_TypeDefinitionIndex = 76452;

class Class_3_206F177A6C7E89E8 : public ::Class_2_1792A4214A514F27
{
public:
	::Class_1_0EE68920FE366BFF_2* OKLJHINJMOO; // 0x30
	::Class_1_3FF87F4926CD1B22* FGAMCDANBPI; // 0x38
	::Class_1_4F12C4FA9BF0B865* PBDCDIJLCNN; // 0x40
	::System::Collections::Generic::List_1<::System::String*>* JEBEHBGJKNA; // 0x48
	::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_1271*>* LBGDAIGJNNI; // 0x50
	::Class_2_2FF2986CE7F8FBE1* PFOBCJOOMAD; // 0x58
	::Class_1_4FAE3CBDEA4A599A* IHNPLBIJJDA; // 0x60
	::Class_1_8130CBB13F62AEE0* EOEBCMKBHEI; // 0x68
