...
#define CLASS_1_72AE65C1FEC0C51C_METHOD_1_1CC50C58B8F1AC30_OFFSET UNITYSDK_OFFSET(0x17CDAD10)
#define CLASS_1_72AE65C1FEC0C51C_METHOD_1_8A66F5228F18C198_OFFSET UNITYSDK_OFFSET(0x17CDA350)
#define CLASS_1_72AE65C1FEC0C51C_METHOD_1_92E51253242E1B82_OFFSET UNITYSDK_OFFSET(0x17CDAE00)
#define CLASS_1_72AE65C1FEC0C51C_METHOD_1_A13AC4699C3ED431_OFFSET UNITYSDK_OFFSET(0x17CDAED0)
#define CLASS_1_72AE65C1FEC0C51C_METHOD_1_B877181B6123B7F6_OFFSET UNITYSDK_OFFSET(0x17CDA790)

inline static constexpr unsigned int Class_1_72AE65C1FEC0C51C_TypeDefinitionIndex = 85945;

class Class_1_72AE65C1FEC0C51C : public ::System::Object
{
public:
	static ::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::MoleMole::MainPageItemShowSetting*>*>** StaticGet_Field_1_0()
	{
		return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::MoleMole::MainPageItemShowSetting*>*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_72AE65C1FEC0C51C_TypeDefinitionIndex)->GetStaticField(0x37900);
	}
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::ConfigUIAvatarShowData_RuntimeMainPage3DInfo>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_72AE65C1FEC0C51C_TypeDefinitionIndex)->GetStaticField(0x37908);
	}
	static ::MoleMole::ConfigUIMainPageShow** StaticGet_Field_1_2()
	{
		return (::MoleMole::ConfigUIMainPageShow**)Il2CppClass::FromTypeDefinitionIndex(Class_1_72AE65C1FEC0C51C_TypeDefinitionIndex)->GetStaticField(0x37910);
	}
