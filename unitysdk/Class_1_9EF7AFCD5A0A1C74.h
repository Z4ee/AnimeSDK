...
#define CLASS_1_9EF7AFCD5A0A1C74_GET_CURRENTPLAYTIME_OFFSET UNITYSDK_OFFSET(0x1791D620)
#define CLASS_1_9EF7AFCD5A0A1C74_GET_CURRENTSTATEDATA_OFFSET UNITYSDK_OFFSET(0x1791D5E0)
#define CLASS_1_9EF7AFCD5A0A1C74_GET_CURRENTSTATUS_OFFSET UNITYSDK_OFFSET(0x1791D640)
#define CLASS_1_9EF7AFCD5A0A1C74_GET_ONUISTATEPLAYCOMPLETEDACTION_OFFSET UNITYSDK_OFFSET(0x1791D600)
#define CLASS_1_9EF7AFCD5A0A1C74_GET_PARENTUISTATECTRL_OFFSET UNITYSDK_OFFSET(0x1791D660)
#define CLASS_1_9EF7AFCD5A0A1C74_METHOD_1_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x1791D460)
#define CLASS_1_9EF7AFCD5A0A1C74_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1791D3A0)
#define CLASS_1_9EF7AFCD5A0A1C74_METHOD_1_482761CB050F1A57_OFFSET UNITYSDK_OFFSET(0x1791D410)
#define CLASS_1_9EF7AFCD5A0A1C74_METHOD_1_8A1C979A2319B852_OFFSET UNITYSDK_OFFSET(0x1791D4C0)
#define CLASS_1_9EF7AFCD5A0A1C74_METHOD_1_8C637C6318E207AD_OFFSET UNITYSDK_OFFSET(0x1791D510)
#define CLASS_1_9EF7AFCD5A0A1C74_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1791D590)
#define CLASS_1_9EF7AFCD5A0A1C74_METHOD_1_F754FB46877347EB_OFFSET UNITYSDK_OFFSET(0x1791D2A0)
#define CLASS_1_9EF7AFCD5A0A1C74_SET_CURRENTPLAYTIME_OFFSET UNITYSDK_OFFSET(0x1791D630)
#define CLASS_1_9EF7AFCD5A0A1C74_SET_CURRENTSTATEDATA_OFFSET UNITYSDK_OFFSET(0x1791D5F0)
#define CLASS_1_9EF7AFCD5A0A1C74_SET_CURRENTSTATUS_OFFSET UNITYSDK_OFFSET(0x1791D650)
#define CLASS_1_9EF7AFCD5A0A1C74_SET_ONUISTATEPLAYCOMPLETEDACTION_OFFSET UNITYSDK_OFFSET(0x1791D610)
#define CLASS_1_9EF7AFCD5A0A1C74_SET_PARENTUISTATECTRL_OFFSET UNITYSDK_OFFSET(0x1791D670)
#define CLASS_1_9EF7AFCD5A0A1C74__CTOR_OFFSET UNITYSDK_OFFSET(0x1791D680)

inline static constexpr unsigned int Class_1_9EF7AFCD5A0A1C74_TypeDefinitionIndex = 73969;
