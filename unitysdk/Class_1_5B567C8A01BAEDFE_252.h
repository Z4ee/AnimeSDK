...
#define CLASS_1_5B567C8A01BAEDFE_252_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1932A160)
#define CLASS_1_5B567C8A01BAEDFE_252_CLONE_OFFSET UNITYSDK_OFFSET(0x19329F70)
#define CLASS_1_5B567C8A01BAEDFE_252_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1932A070)
#define CLASS_1_5B567C8A01BAEDFE_252_EQUALS_OFFSET UNITYSDK_OFFSET(0x19329FE0)
#define CLASS_1_5B567C8A01BAEDFE_252_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1932A0C0)
#define CLASS_1_5B567C8A01BAEDFE_252_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1932A1B0)
#define CLASS_1_5B567C8A01BAEDFE_252_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1932A180)
#define CLASS_1_5B567C8A01BAEDFE_252_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19329EC0)
#define CLASS_1_5B567C8A01BAEDFE_252_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19329F20)
#define CLASS_1_5B567C8A01BAEDFE_252_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1932A0F0)
#define CLASS_1_5B567C8A01BAEDFE_252_WRITETO_OFFSET UNITYSDK_OFFSET(0x1932A150)
#define CLASS_1_5B567C8A01BAEDFE_252__CCTOR_OFFSET UNITYSDK_OFFSET(0x1932A200)
#define CLASS_1_5B567C8A01BAEDFE_252__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19329F40)
#define CLASS_1_5B567C8A01BAEDFE_252__CTOR_OFFSET UNITYSDK_OFFSET(0x19329F30)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_252_TypeDefinitionIndex = 30274;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_252*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_252_TypeDefinitionIndex)->GetStaticField(0x628A0);
	}
