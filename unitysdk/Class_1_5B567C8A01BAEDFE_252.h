...
#define CLASS_1_5B567C8A01BAEDFE_252_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DD8A100)
#define CLASS_1_5B567C8A01BAEDFE_252_CLONE_OFFSET UNITYSDK_OFFSET(0x1DD89DF0)
#define CLASS_1_5B567C8A01BAEDFE_252_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DD89F00)
#define CLASS_1_5B567C8A01BAEDFE_252_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DD89E30)
#define CLASS_1_5B567C8A01BAEDFE_252_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DD8A060)
#define CLASS_1_5B567C8A01BAEDFE_252_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DD8A150)
#define CLASS_1_5B567C8A01BAEDFE_252_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DD8A120)
#define CLASS_1_5B567C8A01BAEDFE_252_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1DD89D70)
#define CLASS_1_5B567C8A01BAEDFE_252_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DD89DA0)
#define CLASS_1_5B567C8A01BAEDFE_252_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DD8A090)
#define CLASS_1_5B567C8A01BAEDFE_252_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DD8A0F0)
#define CLASS_1_5B567C8A01BAEDFE_252__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DD8A1A0)
#define CLASS_1_5B567C8A01BAEDFE_252__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DD89DC0)
#define CLASS_1_5B567C8A01BAEDFE_252__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD89DB0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_252_TypeDefinitionIndex = 31330;

class Class_1_5B567C8A01BAEDFE_252 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_252*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_252*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_252_TypeDefinitionIndex)->GetStaticField(0x17CC0);
	}
