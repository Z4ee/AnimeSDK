...
#define INCONTROL_NATIVE_GETANALOGGLYPHNAME_OFFSET UNITYSDK_OFFSET(0x1717F060)
#define INCONTROL_NATIVE_GETBUTTONGLYPHNAME_OFFSET UNITYSDK_OFFSET(0x1717F0F0)
#define INCONTROL_NATIVE_GETDEVICEEVENTS_OFFSET UNITYSDK_OFFSET(0x1717EDA0)
#define INCONTROL_NATIVE_GETDEVICEINFO_OFFSET UNITYSDK_OFFSET(0x1717EBD0)
#define INCONTROL_NATIVE_GETDEVICESTATE_OFFSET UNITYSDK_OFFSET(0x1717ED10)
#define INCONTROL_NATIVE_GETVERSIONINFO_OFFSET UNITYSDK_OFFSET(0x1717EB50)
#define INCONTROL_NATIVE_INIT_OFFSET UNITYSDK_OFFSET(0x1717EA40)
#define INCONTROL_NATIVE_SETHAPTICSTATE_OFFSET UNITYSDK_OFFSET(0x1717EE20)
#define INCONTROL_NATIVE_SETLIGHTCOLOR_OFFSET UNITYSDK_OFFSET(0x1717EF40)
#define INCONTROL_NATIVE_SETLIGHTFLASH_OFFSET UNITYSDK_OFFSET(0x1717EFD0)
#define INCONTROL_NATIVE_SETTRIGGERSHAPTICSTATE_OFFSET UNITYSDK_OFFSET(0x1717EEB0)
#define INCONTROL_NATIVE_STOP_OFFSET UNITYSDK_OFFSET(0x1717EAD0)

namespace InControl
{
	inline static constexpr unsigned int Native_TypeDefinitionIndex = 37169;
