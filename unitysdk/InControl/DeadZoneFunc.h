...
#define INCONTROL_DEADZONEFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B4E7EB0)
#define INCONTROL_DEADZONEFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B4E7F60)
#define INCONTROL_DEADZONEFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B4E7E80)
#define INCONTROL_DEADZONEFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E7E10)
