...
#define INCONTROL_INCONTROLINPUTMODULE_ACTIVATEMODULE_OFFSET UNITYSDK_OFFSET(0x1B4EA470)
#define INCONTROL_INCONTROLINPUTMODULE_ADDINPUTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1B4ED3E0)
#define INCONTROL_INCONTROLINPUTMODULE_FORCERELEASEDRAG_OFFSET UNITYSDK_OFFSET(0x1B4EAF30)
#define INCONTROL_INCONTROLINPUTMODULE_GET_CANCELACTION_OFFSET UNITYSDK_OFFSET(0x1B4E9BD0)
#define INCONTROL_INCONTROLINPUTMODULE_GET_CANCELBUTTON_OFFSET UNITYSDK_OFFSET(0x1B4ED230)
#define INCONTROL_INCONTROLINPUTMODULE_GET_CANCELWASPRESSED_OFFSET UNITYSDK_OFFSET(0x1B4EA2D0)
#define INCONTROL_INCONTROLINPUTMODULE_GET_DEVICE_OFFSET UNITYSDK_OFFSET(0x1B4ECFE0)
#define INCONTROL_INCONTROLINPUTMODULE_GET_ISSHOWSDKUI_OFFSET UNITYSDK_OFFSET(0x1B4ED530)
#define INCONTROL_INCONTROLINPUTMODULE_GET_MOUSEBUTTONWASPRESSED_OFFSET UNITYSDK_OFFSET(0x1B4EA3D0)
#define INCONTROL_INCONTROLINPUTMODULE_GET_MOUSEHASMOVED_OFFSET UNITYSDK_OFFSET(0x1B4EA370)
#define INCONTROL_INCONTROLINPUTMODULE_GET_MOVEACTION_OFFSET UNITYSDK_OFFSET(0x1B4E9BF0)
#define INCONTROL_INCONTROLINPUTMODULE_GET_SUBMITACTION_OFFSET UNITYSDK_OFFSET(0x1B4E9BB0)
#define INCONTROL_INCONTROLINPUTMODULE_GET_SUBMITBUTTON_OFFSET UNITYSDK_OFFSET(0x1B4ED130)
#define INCONTROL_INCONTROLINPUTMODULE_GET_SUBMITWASPRESSED_OFFSET UNITYSDK_OFFSET(0x1B4EA2B0)
#define INCONTROL_INCONTROLINPUTMODULE_GET_SUBMITWASRELEASED_OFFSET UNITYSDK_OFFSET(0x1B4ECBF0)
#define INCONTROL_INCONTROLINPUTMODULE_GET_VECTORHASCHANGED_OFFSET UNITYSDK_OFFSET(0x1B4ED4E0)
#define INCONTROL_INCONTROLINPUTMODULE_GET_VECTORISPRESSED_OFFSET UNITYSDK_OFFSET(0x1B4ED0F0)
#define INCONTROL_INCONTROLINPUTMODULE_GET_VECTORISRELEASED_OFFSET UNITYSDK_OFFSET(0x1B4ED0B0)
#define INCONTROL_INCONTROLINPUTMODULE_GET_VECTORWASPRESSED_OFFSET UNITYSDK_OFFSET(0x1B4EA2F0)
#define INCONTROL_INCONTROLINPUTMODULE_ISMODULESUPPORTED_OFFSET UNITYSDK_OFFSET(0x1B4E9DA0)
#define INCONTROL_INCONTROLINPUTMODULE_PROCESSMOUSEEVENT_1_OFFSET UNITYSDK_OFFSET(0x1B4ED540)
#define INCONTROL_INCONTROLINPUTMODULE_PROCESSMOUSEEVENT_OFFSET UNITYSDK_OFFSET(0x1B4EAF20)
#define INCONTROL_INCONTROLINPUTMODULE_PROCESSMOUSEPRESS_OFFSET UNITYSDK_OFFSET(0x1B4EBDE0)
#define INCONTROL_INCONTROLINPUTMODULE_PROCESSMOVE_OFFSET UNITYSDK_OFFSET(0x1B4ECA40)
#define INCONTROL_INCONTROLINPUTMODULE_PROCESSTOUCHEVENTS_OFFSET UNITYSDK_OFFSET(0x1B4EAD80)
#define INCONTROL_INCONTROLINPUTMODULE_PROCESSTOUCHPRESS_OFFSET UNITYSDK_OFFSET(0x1B4EB190)
#define INCONTROL_INCONTROLINPUTMODULE_PROCESS_OFFSET UNITYSDK_OFFSET(0x1B4EA560)
#define INCONTROL_INCONTROLINPUTMODULE_REMOVEINPUTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1B4ED480)
#define INCONTROL_INCONTROLINPUTMODULE_SENDBUTTONEVENTTOSELECTEDOBJECT_OFFSET UNITYSDK_OFFSET(0x1B4EABD0)
#define INCONTROL_INCONTROLINPUTMODULE_SENDUPDATEEVENTTOSELECTEDOBJECT_OFFSET UNITYSDK_OFFSET(0x1B4EA770)
#define INCONTROL_INCONTROLINPUTMODULE_SENDVECTOREVENTTOSELECTEDOBJECT_OFFSET UNITYSDK_OFFSET(0x1B4EA890)
#define INCONTROL_INCONTROLINPUTMODULE_SETVECTORREPEATTIMER_OFFSET UNITYSDK_OFFSET(0x1B4ECC10)
#define INCONTROL_INCONTROLINPUTMODULE_SET_CANCELACTION_OFFSET UNITYSDK_OFFSET(0x1B4E9BE0)
#define INCONTROL_INCONTROLINPUTMODULE_SET_DEVICE_OFFSET UNITYSDK_OFFSET(0x1B4ED330)
#define INCONTROL_INCONTROLINPUTMODULE_SET_ISSHOWSDKUI_OFFSET UNITYSDK_OFFSET(0x1B4ED520)
#define INCONTROL_INCONTROLINPUTMODULE_SET_MOVEACTION_OFFSET UNITYSDK_OFFSET(0x1B4E9C00)
#define INCONTROL_INCONTROLINPUTMODULE_SET_SUBMITACTION_OFFSET UNITYSDK_OFFSET(0x1B4E9BC0)
#define INCONTROL_INCONTROLINPUTMODULE_SHOULDACTIVATEMODULE_OFFSET UNITYSDK_OFFSET(0x1B4E9E10)
#define INCONTROL_INCONTROLINPUTMODULE_SIMULATEMOUSEEVENT_OFFSET UNITYSDK_OFFSET(0x1B4ECA20)
#define INCONTROL_INCONTROLINPUTMODULE_SWITCHSUBMITANDCANCELBUTTON_OFFSET UNITYSDK_OFFSET(0x1B4ED3C0)
#define INCONTROL_INCONTROLINPUTMODULE_UPDATEINPUTSTATE_OFFSET UNITYSDK_OFFSET(0x1B4EA0B0)
#define INCONTROL_INCONTROLINPUTMODULE_UPDATEMODULE_OFFSET UNITYSDK_OFFSET(0x1B4E9D10)
#define INCONTROL_INCONTROLINPUTMODULE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B4ECC50)
#define INCONTROL_INCONTROLINPUTMODULE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B4EDA30)
#define INCONTROL_INCONTROLINPUTMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E9C10)

namespace InControl
{
	inline static constexpr unsigned int InControlInputModule_TypeDefinitionIndex = 39554;
	...
	public:
		...
		{
			return (::Unity::Profiling::ProfilerMarker*)Il2CppClass::FromTypeDefinitionIndex(InControlInputModule_TypeDefinitionIndex)->GetStaticField(0xC90);
		}
