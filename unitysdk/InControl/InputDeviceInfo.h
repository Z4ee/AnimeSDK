...
#define INCONTROL_INPUTDEVICEINFO_HASSAMELOCATION_OFFSET UNITYSDK_OFFSET(0x20C5400)
#define INCONTROL_INPUTDEVICEINFO_HASSAMEPRODUCTID_OFFSET UNITYSDK_OFFSET(0x20C53E0)
#define INCONTROL_INPUTDEVICEINFO_HASSAMESERIALNUMBER_OFFSET UNITYSDK_OFFSET(0x20C5430)
#define INCONTROL_INPUTDEVICEINFO_HASSAMEVENDORID_OFFSET UNITYSDK_OFFSET(0x20C53D0)
#define INCONTROL_INPUTDEVICEINFO_HASSAMEVERSIONNUMBER_OFFSET UNITYSDK_OFFSET(0x20C53F0)

namespace InControl
{
	inline static constexpr unsigned int InputDeviceInfo_TypeDefinitionIndex = 31424;
