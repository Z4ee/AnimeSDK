...
#define INCONTROL_TOUCHSTICKCONTROL_COMMITCONTROLSTATE_OFFSET UNITYSDK_OFFSET(0x14992970)
#define INCONTROL_TOUCHSTICKCONTROL_CONFIGURECONTROL_OFFSET UNITYSDK_OFFSET(0x14991B70)
#define INCONTROL_TOUCHSTICKCONTROL_CREATECONTROL_OFFSET UNITYSDK_OFFSET(0x14991830)
#define INCONTROL_TOUCHSTICKCONTROL_DESTROYCONTROL_OFFSET UNITYSDK_OFFSET(0x14991920)
#define INCONTROL_TOUCHSTICKCONTROL_DRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x14991CA0)
#define INCONTROL_TOUCHSTICKCONTROL_GET_ACTIVEAREA_OFFSET UNITYSDK_OFFSET(0xC081D80)
#define INCONTROL_TOUCHSTICKCONTROL_GET_ANCHOR_OFFSET UNITYSDK_OFFSET(0x149933F0)
#define INCONTROL_TOUCHSTICKCONTROL_GET_AREAUNITTYPE_OFFSET UNITYSDK_OFFSET(0xC081DC0)
#define INCONTROL_TOUCHSTICKCONTROL_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x14992D70)
#define INCONTROL_TOUCHSTICKCONTROL_GET_ISNOTACTIVE_OFFSET UNITYSDK_OFFSET(0x14992840)
#define INCONTROL_TOUCHSTICKCONTROL_GET_KNOBPOSITION_OFFSET UNITYSDK_OFFSET(0x14992230)
#define INCONTROL_TOUCHSTICKCONTROL_GET_OFFSETUNITTYPE_OFFSET UNITYSDK_OFFSET(0x14993470)
#define INCONTROL_TOUCHSTICKCONTROL_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x14993410)
#define INCONTROL_TOUCHSTICKCONTROL_GET_RINGPOSITION_OFFSET UNITYSDK_OFFSET(0x14992140)
#define INCONTROL_TOUCHSTICKCONTROL_SET_ACTIVEAREA_OFFSET UNITYSDK_OFFSET(0xC081D90)
#define INCONTROL_TOUCHSTICKCONTROL_SET_ANCHOR_OFFSET UNITYSDK_OFFSET(0x14993400)
#define INCONTROL_TOUCHSTICKCONTROL_SET_AREAUNITTYPE_OFFSET UNITYSDK_OFFSET(0xC081DD0)
#define INCONTROL_TOUCHSTICKCONTROL_SET_KNOBPOSITION_OFFSET UNITYSDK_OFFSET(0x149928C0)
#define INCONTROL_TOUCHSTICKCONTROL_SET_OFFSETUNITTYPE_OFFSET UNITYSDK_OFFSET(0x14993480)
#define INCONTROL_TOUCHSTICKCONTROL_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0x14993420)
#define INCONTROL_TOUCHSTICKCONTROL_SET_RINGPOSITION_OFFSET UNITYSDK_OFFSET(0x14992850)
#define INCONTROL_TOUCHSTICKCONTROL_SUBMITCONTROLSTATE_OFFSET UNITYSDK_OFFSET(0x14992930)
#define INCONTROL_TOUCHSTICKCONTROL_TOUCHBEGAN_OFFSET UNITYSDK_OFFSET(0x14992980)
#define INCONTROL_TOUCHSTICKCONTROL_TOUCHENDED_OFFSET UNITYSDK_OFFSET(0x14991990)
#define INCONTROL_TOUCHSTICKCONTROL_TOUCHMOVED_OFFSET UNITYSDK_OFFSET(0x14992D80)
#define INCONTROL_TOUCHSTICKCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0x14992320)
#define INCONTROL_TOUCHSTICKCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC081DE0)
