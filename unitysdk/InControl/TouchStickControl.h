...
#define INCONTROL_TOUCHSTICKCONTROL_COMMITCONTROLSTATE_OFFSET UNITYSDK_OFFSET(0x18046840)
#define INCONTROL_TOUCHSTICKCONTROL_CONFIGURECONTROL_OFFSET UNITYSDK_OFFSET(0x18045A40)
#define INCONTROL_TOUCHSTICKCONTROL_CREATECONTROL_OFFSET UNITYSDK_OFFSET(0x18045700)
#define INCONTROL_TOUCHSTICKCONTROL_DESTROYCONTROL_OFFSET UNITYSDK_OFFSET(0x180457F0)
#define INCONTROL_TOUCHSTICKCONTROL_DRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x18045B70)
#define INCONTROL_TOUCHSTICKCONTROL_GET_ACTIVEAREA_OFFSET UNITYSDK_OFFSET(0x18047670)
#define INCONTROL_TOUCHSTICKCONTROL_GET_ANCHOR_OFFSET UNITYSDK_OFFSET(0x180472C0)
#define INCONTROL_TOUCHSTICKCONTROL_GET_AREAUNITTYPE_OFFSET UNITYSDK_OFFSET(0x180476B0)
#define INCONTROL_TOUCHSTICKCONTROL_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x18046C40)
#define INCONTROL_TOUCHSTICKCONTROL_GET_ISNOTACTIVE_OFFSET UNITYSDK_OFFSET(0x18046710)
#define INCONTROL_TOUCHSTICKCONTROL_GET_KNOBPOSITION_OFFSET UNITYSDK_OFFSET(0x18046100)
#define INCONTROL_TOUCHSTICKCONTROL_GET_OFFSETUNITTYPE_OFFSET UNITYSDK_OFFSET(0x18047340)
#define INCONTROL_TOUCHSTICKCONTROL_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x180472E0)
#define INCONTROL_TOUCHSTICKCONTROL_GET_RINGPOSITION_OFFSET UNITYSDK_OFFSET(0x18046010)
#define INCONTROL_TOUCHSTICKCONTROL_SET_ACTIVEAREA_OFFSET UNITYSDK_OFFSET(0x18047680)
#define INCONTROL_TOUCHSTICKCONTROL_SET_ANCHOR_OFFSET UNITYSDK_OFFSET(0x180472D0)
#define INCONTROL_TOUCHSTICKCONTROL_SET_AREAUNITTYPE_OFFSET UNITYSDK_OFFSET(0x180476C0)
#define INCONTROL_TOUCHSTICKCONTROL_SET_KNOBPOSITION_OFFSET UNITYSDK_OFFSET(0x18046790)
#define INCONTROL_TOUCHSTICKCONTROL_SET_OFFSETUNITTYPE_OFFSET UNITYSDK_OFFSET(0x18047350)
#define INCONTROL_TOUCHSTICKCONTROL_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0x180472F0)
#define INCONTROL_TOUCHSTICKCONTROL_SET_RINGPOSITION_OFFSET UNITYSDK_OFFSET(0x18046720)
#define INCONTROL_TOUCHSTICKCONTROL_SUBMITCONTROLSTATE_OFFSET UNITYSDK_OFFSET(0x18046800)
#define INCONTROL_TOUCHSTICKCONTROL_TOUCHBEGAN_OFFSET UNITYSDK_OFFSET(0x18046850)
#define INCONTROL_TOUCHSTICKCONTROL_TOUCHENDED_OFFSET UNITYSDK_OFFSET(0x18045860)
#define INCONTROL_TOUCHSTICKCONTROL_TOUCHMOVED_OFFSET UNITYSDK_OFFSET(0x18046C50)
#define INCONTROL_TOUCHSTICKCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0x180461F0)
#define INCONTROL_TOUCHSTICKCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x180476D0)

namespace InControl
{
	inline static constexpr unsigned int TouchStickControl_TypeDefinitionIndex = 37914;
