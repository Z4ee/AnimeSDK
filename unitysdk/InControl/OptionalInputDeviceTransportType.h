...
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_CLEAR_OFFSET UNITYSDK_OFFSET(0x20C5DD0)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_COMBINEHASHCODES_OFFSET UNITYSDK_OFFSET(0x15C025C0)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x20C5E70)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x20C5E90)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_EQUALS_OFFSET UNITYSDK_OFFSET(0x20C5FB0)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x20C5EB0)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_GETVALUEORDEFAULT_OFFSET UNITYSDK_OFFSET(0x20C5DE0)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_GETVALUEORZERO_OFFSET UNITYSDK_OFFSET(0x20C5DF0)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_GET_HASNOVALUE_OFFSET UNITYSDK_OFFSET(0x20C5AD0)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_GET_HASVALUE_OFFSET UNITYSDK_OFFSET(0x29C50)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x20C5F40)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_OP_EQUALITY_1_OFFSET UNITYSDK_OFFSET(0x15C02580)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x15C02540)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x15C02670)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x15BBE640)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_OP_INEQUALITY_1_OFFSET UNITYSDK_OFFSET(0x15C025A0)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x15C02560)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x20C5D50)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x20C5D50)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x20C6040)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x20C5D50)

namespace InControl
{
	inline static constexpr unsigned int OptionalInputDeviceTransportType_TypeDefinitionIndex = 31491;
