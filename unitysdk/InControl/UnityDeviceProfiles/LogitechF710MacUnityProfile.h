...
#define INCONTROL_UNITYDEVICEPROFILES_LOGITECHF710MACUNITYPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0xB4E4290)
#define INCONTROL_UNITYDEVICEPROFILES_LOGITECHF710MACUNITYPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0xB4E54E0)

namespace InControl::UnityDeviceProfiles
{
	inline static constexpr unsigned int LogitechF710MacUnityProfile_TypeDefinitionIndex = 38863;
