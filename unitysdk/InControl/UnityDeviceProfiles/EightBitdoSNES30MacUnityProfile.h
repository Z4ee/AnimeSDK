...
#define INCONTROL_UNITYDEVICEPROFILES_EIGHTBITDOSNES30MACUNITYPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0xC0A58E0)
#define INCONTROL_UNITYDEVICEPROFILES_EIGHTBITDOSNES30MACUNITYPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0xC0A6220)
