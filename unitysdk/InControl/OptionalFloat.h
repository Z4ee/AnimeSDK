...
#define INCONTROL_OPTIONALFLOAT_APPROXIMATELYEQUALS_OFFSET UNITYSDK_OFFSET(0x3825510)
#define INCONTROL_OPTIONALFLOAT_CLEAR_OFFSET UNITYSDK_OFFSET(0x3825360)
#define INCONTROL_OPTIONALFLOAT_COMBINEHASHCODES_OFFSET UNITYSDK_OFFSET(0x18034820)
#define INCONTROL_OPTIONALFLOAT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x38253F0)
#define INCONTROL_OPTIONALFLOAT_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x3825440)
#define INCONTROL_OPTIONALFLOAT_EQUALS_OFFSET UNITYSDK_OFFSET(0x3825390)
#define INCONTROL_OPTIONALFLOAT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3825480)
#define INCONTROL_OPTIONALFLOAT_GETVALUEORDEFAULT_OFFSET UNITYSDK_OFFSET(0x3825370)
#define INCONTROL_OPTIONALFLOAT_GETVALUEORZERO_OFFSET UNITYSDK_OFFSET(0x3825380)
#define INCONTROL_OPTIONALFLOAT_GET_HASNOVALUE_OFFSET UNITYSDK_OFFSET(0x38252E0)
#define INCONTROL_OPTIONALFLOAT_GET_HASVALUE_OFFSET UNITYSDK_OFFSET(0x2D770)
#define INCONTROL_OPTIONALFLOAT_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x38252F0)
#define INCONTROL_OPTIONALFLOAT_ISAPPROXIMATELYEQUAL_OFFSET UNITYSDK_OFFSET(0x18034690)
#define INCONTROL_OPTIONALFLOAT_OP_EQUALITY_1_OFFSET UNITYSDK_OFFSET(0x180347A0)
#define INCONTROL_OPTIONALFLOAT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x18034700)
#define INCONTROL_OPTIONALFLOAT_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x180348D0)
#define INCONTROL_OPTIONALFLOAT_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x180348C0)
#define INCONTROL_OPTIONALFLOAT_OP_INEQUALITY_1_OFFSET UNITYSDK_OFFSET(0x180347E0)
#define INCONTROL_OPTIONALFLOAT_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x18034750)
#define INCONTROL_OPTIONALFLOAT_SETVALUE_OFFSET UNITYSDK_OFFSET(0x38252D0)
#define INCONTROL_OPTIONALFLOAT_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x38252D0)
#define INCONTROL_OPTIONALFLOAT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x38254B0)
#define INCONTROL_OPTIONALFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x38252D0)

namespace InControl
{
	inline static constexpr unsigned int OptionalFloat_TypeDefinitionIndex = 37941;
