...
#define INCONTROL_TOUCHTRACKCONTROL_COMMITCONTROLSTATE_OFFSET UNITYSDK_OFFSET(0xC082FA0)
#define INCONTROL_TOUCHTRACKCONTROL_CONFIGURECONTROL_OFFSET UNITYSDK_OFFSET(0xC082A80)
#define INCONTROL_TOUCHTRACKCONTROL_CREATECONTROL_OFFSET UNITYSDK_OFFSET(0xC082A20)
#define INCONTROL_TOUCHTRACKCONTROL_DESTROYCONTROL_OFFSET UNITYSDK_OFFSET(0xC082AE0)
#define INCONTROL_TOUCHTRACKCONTROL_DRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0xC082D30)
#define INCONTROL_TOUCHTRACKCONTROL_GET_ACTIVEAREA_OFFSET UNITYSDK_OFFSET(0xC083120)
#define INCONTROL_TOUCHTRACKCONTROL_GET_AREAUNITTYPE_OFFSET UNITYSDK_OFFSET(0xC083160)
#define INCONTROL_TOUCHTRACKCONTROL_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0xC082E80)
#define INCONTROL_TOUCHTRACKCONTROL_SET_ACTIVEAREA_OFFSET UNITYSDK_OFFSET(0xC083130)
#define INCONTROL_TOUCHTRACKCONTROL_SET_AREAUNITTYPE_OFFSET UNITYSDK_OFFSET(0xC083170)
#define INCONTROL_TOUCHTRACKCONTROL_SUBMITCONTROLSTATE_OFFSET UNITYSDK_OFFSET(0xC082F10)
#define INCONTROL_TOUCHTRACKCONTROL_TOUCHBEGAN_OFFSET UNITYSDK_OFFSET(0xC082FC0)
#define INCONTROL_TOUCHTRACKCONTROL_TOUCHENDED_OFFSET UNITYSDK_OFFSET(0xC082C00)
#define INCONTROL_TOUCHTRACKCONTROL_TOUCHMOVED_OFFSET UNITYSDK_OFFSET(0xC0830B0)
#define INCONTROL_TOUCHTRACKCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0xC082EA0)
#define INCONTROL_TOUCHTRACKCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC083180)
