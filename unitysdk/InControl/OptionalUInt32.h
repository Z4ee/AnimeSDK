...
#define INCONTROL_OPTIONALUINT32_CLEAR_OFFSET UNITYSDK_OFFSET(0x20C5B50)
#define INCONTROL_OPTIONALUINT32_COMBINEHASHCODES_OFFSET UNITYSDK_OFFSET(0x15C03110)
#define INCONTROL_OPTIONALUINT32_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x20C62B0)
#define INCONTROL_OPTIONALUINT32_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x20C62D0)
#define INCONTROL_OPTIONALUINT32_EQUALS_OFFSET UNITYSDK_OFFSET(0x20C64B0)
#define INCONTROL_OPTIONALUINT32_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x20C62E0)
#define INCONTROL_OPTIONALUINT32_GETVALUEORDEFAULT_OFFSET UNITYSDK_OFFSET(0x20C6260)
#define INCONTROL_OPTIONALUINT32_GETVALUEORZERO_OFFSET UNITYSDK_OFFSET(0x20C6270)
#define INCONTROL_OPTIONALUINT32_GET_HASNOVALUE_OFFSET UNITYSDK_OFFSET(0x20C5AD0)
#define INCONTROL_OPTIONALUINT32_GET_HASVALUE_OFFSET UNITYSDK_OFFSET(0x29C50)
#define INCONTROL_OPTIONALUINT32_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x20C6440)
#define INCONTROL_OPTIONALUINT32_OP_EQUALITY_1_OFFSET UNITYSDK_OFFSET(0x15C030D0)
#define INCONTROL_OPTIONALUINT32_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x15C03090)
#define INCONTROL_OPTIONALUINT32_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x15C03190)
#define INCONTROL_OPTIONALUINT32_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x15BE3410)
#define INCONTROL_OPTIONALUINT32_OP_INEQUALITY_1_OFFSET UNITYSDK_OFFSET(0x15C030F0)
#define INCONTROL_OPTIONALUINT32_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x15C030B0)
#define INCONTROL_OPTIONALUINT32_SETVALUE_OFFSET UNITYSDK_OFFSET(0x20C61E0)
#define INCONTROL_OPTIONALUINT32_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x20C61E0)
#define INCONTROL_OPTIONALUINT32_TOSTRING_OFFSET UNITYSDK_OFFSET(0x20C64E0)
#define INCONTROL_OPTIONALUINT32__CTOR_OFFSET UNITYSDK_OFFSET(0x20C61E0)

namespace InControl
{
	inline static constexpr unsigned int OptionalUInt32_TypeDefinitionIndex = 31495;
