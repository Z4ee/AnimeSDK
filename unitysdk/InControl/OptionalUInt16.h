...
#define INCONTROL_OPTIONALUINT16_CLEAR_OFFSET UNITYSDK_OFFSET(0x2297A10)
#define INCONTROL_OPTIONALUINT16_COMBINEHASHCODES_OFFSET UNITYSDK_OFFSET(0x17200880)
#define INCONTROL_OPTIONALUINT16_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x2297AB0)
#define INCONTROL_OPTIONALUINT16_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x2297AD0)
#define INCONTROL_OPTIONALUINT16_EQUALS_OFFSET UNITYSDK_OFFSET(0x2298000)
#define INCONTROL_OPTIONALUINT16_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2297AF0)
#define INCONTROL_OPTIONALUINT16_GETVALUEORDEFAULT_OFFSET UNITYSDK_OFFSET(0x2297A20)
#define INCONTROL_OPTIONALUINT16_GETVALUEORZERO_OFFSET UNITYSDK_OFFSET(0x2297A30)
#define INCONTROL_OPTIONALUINT16_GET_HASNOVALUE_OFFSET UNITYSDK_OFFSET(0x2297710)
#define INCONTROL_OPTIONALUINT16_GET_HASVALUE_OFFSET UNITYSDK_OFFSET(0x2A500)
#define INCONTROL_OPTIONALUINT16_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x2297F90)
#define INCONTROL_OPTIONALUINT16_OP_EQUALITY_1_OFFSET UNITYSDK_OFFSET(0x17200840)
#define INCONTROL_OPTIONALUINT16_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x17200800)
#define INCONTROL_OPTIONALUINT16_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x17200900)
#define INCONTROL_OPTIONALUINT16_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x171A9F70)
#define INCONTROL_OPTIONALUINT16_OP_INEQUALITY_1_OFFSET UNITYSDK_OFFSET(0x17200860)
#define INCONTROL_OPTIONALUINT16_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x17200820)
#define INCONTROL_OPTIONALUINT16_SETVALUE_OFFSET UNITYSDK_OFFSET(0x2297990)
#define INCONTROL_OPTIONALUINT16_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x2297990)
#define INCONTROL_OPTIONALUINT16_TOSTRING_OFFSET UNITYSDK_OFFSET(0x2298030)
#define INCONTROL_OPTIONALUINT16__CTOR_OFFSET UNITYSDK_OFFSET(0x2297990)

namespace InControl
{
	inline static constexpr unsigned int OptionalUInt16_TypeDefinitionIndex = 37214;
