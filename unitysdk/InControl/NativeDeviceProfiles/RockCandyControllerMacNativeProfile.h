...
#define INCONTROL_NATIVEDEVICEPROFILES_ROCKCANDYCONTROLLERMACNATIVEPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0x171C6830)
#define INCONTROL_NATIVEDEVICEPROFILES_ROCKCANDYCONTROLLERMACNATIVEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x171C68C0)

namespace InControl::NativeDeviceProfiles
{
	inline static constexpr unsigned int RockCandyControllerMacNativeProfile_TypeDefinitionIndex = 37535;
