...
#define INCONTROL_NATIVEDEVICEPROFILES_ROCKCANDYCONTROLLERMACNATIVEPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0x15BC8E50)
#define INCONTROL_NATIVEDEVICEPROFILES_ROCKCANDYCONTROLLERMACNATIVEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x15BC8EE0)

namespace InControl::NativeDeviceProfiles
{
	inline static constexpr unsigned int RockCandyControllerMacNativeProfile_TypeDefinitionIndex = 31815;
