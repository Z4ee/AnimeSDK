...
#define INCONTROL_NATIVEDEVICEPROFILES_MVCTESTICKMACNATIVEPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0x1736EF90)
#define INCONTROL_NATIVEDEVICEPROFILES_MVCTESTICKMACNATIVEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1736F050)

namespace InControl::NativeDeviceProfiles
{
	inline static constexpr unsigned int MVCTEStickMacNativeProfile_TypeDefinitionIndex = 39007;
