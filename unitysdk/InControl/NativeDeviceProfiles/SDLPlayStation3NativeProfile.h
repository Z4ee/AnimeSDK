...
#define INCONTROL_NATIVEDEVICEPROFILES_SDLPLAYSTATION3NATIVEPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0x15BD37D0)
#define INCONTROL_NATIVEDEVICEPROFILES_SDLPLAYSTATION3NATIVEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x15BD5A80)

namespace InControl::NativeDeviceProfiles
{
	inline static constexpr unsigned int SDLPlayStation3NativeProfile_TypeDefinitionIndex = 31869;
