...
#define INCONTROL_NATIVEDEVICEPROFILES_BIGBENCONTROLLERMACNATIVEPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0x17FCA720)
#define INCONTROL_NATIVEDEVICEPROFILES_BIGBENCONTROLLERMACNATIVEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x17FCA7A0)

namespace InControl::NativeDeviceProfiles
{
	inline static constexpr unsigned int BigBenControllerMacNativeProfile_TypeDefinitionIndex = 38146;
