...
#define INCONTROL_NATIVEDEVICEPROFILES_PDPVERSUSCONTROLLERMACNATIVEPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0x17FF43A0)
#define INCONTROL_NATIVEDEVICEPROFILES_PDPVERSUSCONTROLLERMACNATIVEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x17FF4420)

namespace InControl::NativeDeviceProfiles
{
	inline static constexpr unsigned int PDPVersusControllerMacNativeProfile_TypeDefinitionIndex = 38243;
