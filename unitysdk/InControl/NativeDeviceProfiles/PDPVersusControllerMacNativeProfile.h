...
#define INCONTROL_NATIVEDEVICEPROFILES_PDPVERSUSCONTROLLERMACNATIVEPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0x171B5460)
#define INCONTROL_NATIVEDEVICEPROFILES_PDPVERSUSCONTROLLERMACNATIVEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x171B54F0)

namespace InControl::NativeDeviceProfiles
{
	inline static constexpr unsigned int PDPVersusControllerMacNativeProfile_TypeDefinitionIndex = 37511;
