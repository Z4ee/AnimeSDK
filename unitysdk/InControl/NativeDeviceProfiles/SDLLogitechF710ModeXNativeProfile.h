...
#define INCONTROL_NATIVEDEVICEPROFILES_SDLLOGITECHF710MODEXNATIVEPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0x14954FE0)
#define INCONTROL_NATIVEDEVICEPROFILES_SDLLOGITECHF710MODEXNATIVEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x14956320)

namespace InControl::NativeDeviceProfiles
{
	inline static constexpr unsigned int SDLLogitechF710ModeXNativeProfile_TypeDefinitionIndex = 39986;
