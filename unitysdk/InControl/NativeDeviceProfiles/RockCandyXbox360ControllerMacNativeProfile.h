...
#define INCONTROL_NATIVEDEVICEPROFILES_ROCKCANDYXBOX360CONTROLLERMACNATIVEPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0x180031D0)
#define INCONTROL_NATIVEDEVICEPROFILES_ROCKCANDYXBOX360CONTROLLERMACNATIVEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x180032C0)

namespace InControl::NativeDeviceProfiles
{
	inline static constexpr unsigned int RockCandyXbox360ControllerMacNativeProfile_TypeDefinitionIndex = 38269;
