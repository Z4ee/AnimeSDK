...
#define INCONTROL_NATIVEDEVICEPROFILES_SDLNINTENDOSWITCHNATIVEPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0x171CEF20)
#define INCONTROL_NATIVEDEVICEPROFILES_SDLNINTENDOSWITCHNATIVEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x171D10C0)

namespace InControl::NativeDeviceProfiles
{
	inline static constexpr unsigned int SDLNintendoSwitchNativeProfile_TypeDefinitionIndex = 37588;
