...
#define INCONTROL_NATIVEDEVICEPROFILES_HORICONTROLLERMACNATIVEPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0x15B9B130)
#define INCONTROL_NATIVEDEVICEPROFILES_HORICONTROLLERMACNATIVEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x15B9B300)

namespace InControl::NativeDeviceProfiles
{
	inline static constexpr unsigned int HoriControllerMacNativeProfile_TypeDefinitionIndex = 31709;
