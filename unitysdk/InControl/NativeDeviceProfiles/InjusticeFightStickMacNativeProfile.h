...
#define INCONTROL_NATIVEDEVICEPROFILES_INJUSTICEFIGHTSTICKMACNATIVEPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0x15B9C390)
#define INCONTROL_NATIVEDEVICEPROFILES_INJUSTICEFIGHTSTICKMACNATIVEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x15B9C420)

namespace InControl::NativeDeviceProfiles
{
	inline static constexpr unsigned int InjusticeFightStickMacNativeProfile_TypeDefinitionIndex = 31733;
