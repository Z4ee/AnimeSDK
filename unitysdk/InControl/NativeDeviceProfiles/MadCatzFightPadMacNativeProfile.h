...
#define INCONTROL_NATIVEDEVICEPROFILES_MADCATZFIGHTPADMACNATIVEPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0x171A7EB0)
#define INCONTROL_NATIVEDEVICEPROFILES_MADCATZFIGHTPADMACNATIVEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x171A7F40)

namespace InControl::NativeDeviceProfiles
{
	inline static constexpr unsigned int MadCatzFightPadMacNativeProfile_TypeDefinitionIndex = 37475;
