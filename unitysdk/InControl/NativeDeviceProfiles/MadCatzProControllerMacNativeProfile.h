...
#define INCONTROL_NATIVEDEVICEPROFILES_MADCATZPROCONTROLLERMACNATIVEPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0x17FEACD0)
#define INCONTROL_NATIVEDEVICEPROFILES_MADCATZPROCONTROLLERMACNATIVEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x17FEAD50)

namespace InControl::NativeDeviceProfiles
{
	inline static constexpr unsigned int MadCatzProControllerMacNativeProfile_TypeDefinitionIndex = 38219;
