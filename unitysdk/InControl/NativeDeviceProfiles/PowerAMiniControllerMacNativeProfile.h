...
#define INCONTROL_NATIVEDEVICEPROFILES_POWERAMINICONTROLLERMACNATIVEPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0x15BC4530)
#define INCONTROL_NATIVEDEVICEPROFILES_POWERAMINICONTROLLERMACNATIVEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x15BC45C0)

namespace InControl::NativeDeviceProfiles
{
	inline static constexpr unsigned int PowerAMiniControllerMacNativeProfile_TypeDefinitionIndex = 31797;
