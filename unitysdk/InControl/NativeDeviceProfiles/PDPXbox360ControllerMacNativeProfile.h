...
#define INCONTROL_NATIVEDEVICEPROFILES_PDPXBOX360CONTROLLERMACNATIVEPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0x132C1520)
#define INCONTROL_NATIVEDEVICEPROFILES_PDPXBOX360CONTROLLERMACNATIVEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x132C15A0)

namespace InControl::NativeDeviceProfiles
{
	inline static constexpr unsigned int PDPXbox360ControllerMacNativeProfile_TypeDefinitionIndex = 39052;
