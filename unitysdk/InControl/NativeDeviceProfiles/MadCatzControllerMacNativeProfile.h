...
#define INCONTROL_NATIVEDEVICEPROFILES_MADCATZCONTROLLERMACNATIVEPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0x15BAA1D0)
#define INCONTROL_NATIVEDEVICEPROFILES_MADCATZCONTROLLERMACNATIVEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x15BAA340)

namespace InControl::NativeDeviceProfiles
{
	inline static constexpr unsigned int MadCatzControllerMacNativeProfile_TypeDefinitionIndex = 31752;
