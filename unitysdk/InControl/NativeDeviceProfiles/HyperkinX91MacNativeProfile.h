...
#define INCONTROL_NATIVEDEVICEPROFILES_HYPERKINX91MACNATIVEPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0x17199CD0)
#define INCONTROL_NATIVEDEVICEPROFILES_HYPERKINX91MACNATIVEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x17199D60)

namespace InControl::NativeDeviceProfiles
{
	inline static constexpr unsigned int HyperkinX91MacNativeProfile_TypeDefinitionIndex = 37452;
