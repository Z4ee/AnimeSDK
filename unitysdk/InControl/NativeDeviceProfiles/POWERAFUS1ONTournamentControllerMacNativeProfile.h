...
#define INCONTROL_NATIVEDEVICEPROFILES_POWERAFUS1ONTOURNAMENTCONTROLLERMACNATIVEPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0x132C1D80)
#define INCONTROL_NATIVEDEVICEPROFILES_POWERAFUS1ONTOURNAMENTCONTROLLERMACNATIVEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x132C1E00)

namespace InControl::NativeDeviceProfiles
{
	inline static constexpr unsigned int POWERAFUS1ONTournamentControllerMacNativeProfile_TypeDefinitionIndex = 39055;
