...
#define INCONTROL_NATIVEDEVICEPROFILES_POWERAFUS1ONTOURNAMENTCONTROLLERMACNATIVEPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0x14940E90)
#define INCONTROL_NATIVEDEVICEPROFILES_POWERAFUS1ONTOURNAMENTCONTROLLERMACNATIVEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x14940F10)
