...
#define INCONTROL_NATIVEDEVICEPROFILES_PDPTRONCONTROLLERMACNATIVEPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0x132C1240)
#define INCONTROL_NATIVEDEVICEPROFILES_PDPTRONCONTROLLERMACNATIVEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x132C12C0)

namespace InControl::NativeDeviceProfiles
{
	inline static constexpr unsigned int PDPTronControllerMacNativeProfile_TypeDefinitionIndex = 39050;
