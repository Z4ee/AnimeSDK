...
#define INCONTROL_NATIVEDEVICEPROFILES_PDPTRONCONTROLLERMACNATIVEPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0x17FF4230)
#define INCONTROL_NATIVEDEVICEPROFILES_PDPTRONCONTROLLERMACNATIVEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x17FF42B0)

namespace InControl::NativeDeviceProfiles
{
	inline static constexpr unsigned int PDPTronControllerMacNativeProfile_TypeDefinitionIndex = 38242;
