...
#define INCONTROL_NATIVEDEVICEPROFILES_GAMESTOPCONTROLLERMACNATIVEPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0x15B97BA0)
#define INCONTROL_NATIVEDEVICEPROFILES_GAMESTOPCONTROLLERMACNATIVEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x15B97D10)

namespace InControl::NativeDeviceProfiles
{
	inline static constexpr unsigned int GameStopControllerMacNativeProfile_TypeDefinitionIndex = 31701;
