...
#define INCONTROL_NATIVEDEVICEPROFILES_MADCATZSSF4CHUNLIFIGHTSTICKTEMACNATIVEPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0x171AAAF0)
#define INCONTROL_NATIVEDEVICEPROFILES_MADCATZSSF4CHUNLIFIGHTSTICKTEMACNATIVEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x171AAB80)

namespace InControl::NativeDeviceProfiles
{
	inline static constexpr unsigned int MadCatzSSF4ChunLiFightStickTEMacNativeProfile_TypeDefinitionIndex = 37491;
