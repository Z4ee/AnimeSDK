...
#define INCONTROL_NATIVEDEVICEPROFILES_SDLGENERICNATIVEPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0x132D17E0)
#define INCONTROL_NATIVEDEVICEPROFILES_SDLGENERICNATIVEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x132D3580)

namespace InControl::NativeDeviceProfiles
{
	inline static constexpr unsigned int SDLGenericNativeProfile_TypeDefinitionIndex = 39124;
