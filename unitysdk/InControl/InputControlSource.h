...
#define INCONTROL_INPUTCONTROLSOURCE_GETSTATE_OFFSET UNITYSDK_OFFSET(0x3AF1450)
#define INCONTROL_INPUTCONTROLSOURCE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x3AF1440)
#define INCONTROL_INPUTCONTROLSOURCE_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x784260)
#define INCONTROL_INPUTCONTROLSOURCE_GET_SOURCETYPE_OFFSET UNITYSDK_OFFSET(0x19050)
#define INCONTROL_INPUTCONTROLSOURCE_SET_INDEX_OFFSET UNITYSDK_OFFSET(0xB596A0)
#define INCONTROL_INPUTCONTROLSOURCE_SET_SOURCETYPE_OFFSET UNITYSDK_OFFSET(0x18EB0)
#define INCONTROL_INPUTCONTROLSOURCE_TOCODE_OFFSET UNITYSDK_OFFSET(0x3AF1460)
#define INCONTROL_INPUTCONTROLSOURCE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3AF1430)
#define INCONTROL_INPUTCONTROLSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x6B4C20)
