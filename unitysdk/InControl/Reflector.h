...
#define INCONTROL_REFLECTOR_GETALLASSEMBLYTYPES_OFFSET UNITYSDK_OFFSET(0x17206CD0)
#define INCONTROL_REFLECTOR_GET_ALLASSEMBLYTYPES_OFFSET UNITYSDK_OFFSET(0x17206C30)
#define INCONTROL_REFLECTOR_IGNOREASSEMBLYWITHNAME_OFFSET UNITYSDK_OFFSET(0x17206DF0)
#define INCONTROL_REFLECTOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x17206EF0)
...
namespace InControl
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::IEnumerable_1<::System::Type*>**)Il2CppClass::FromTypeDefinitionIndex(Reflector_TypeDefinitionIndex)->GetStaticField(0x112C0);
		}
		static ::Il2CppArray<::System::String*>** StaticGet_ignoreAssemblies()
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Reflector_TypeDefinitionIndex)->GetStaticField(0x112C8);
		}
