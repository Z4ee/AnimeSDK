...
#define INCONTROL_UNITYKEYBOARDPROVIDER_KEYMAPPING_GET_ISPRESSED_OFFSET UNITYSDK_OFFSET(0x20C66F0)
#define INCONTROL_UNITYKEYBOARDPROVIDER_KEYMAPPING_GET_NAME_OFFSET UNITYSDK_OFFSET(0x20C6730)
#define INCONTROL_UNITYKEYBOARDPROVIDER_KEYMAPPING_GET_UNITYKEY_OFFSET UNITYSDK_OFFSET(0x1DA90)
#define INCONTROL_UNITYKEYBOARDPROVIDER_KEYMAPPING_GET_WASPRESSED_OFFSET UNITYSDK_OFFSET(0x20C66B0)
#define INCONTROL_UNITYKEYBOARDPROVIDER_KEYMAPPING__CTOR_1_OFFSET UNITYSDK_OFFSET(0x20C6650)
#define INCONTROL_UNITYKEYBOARDPROVIDER_KEYMAPPING__CTOR_2_OFFSET UNITYSDK_OFFSET(0x20C6670)
#define INCONTROL_UNITYKEYBOARDPROVIDER_KEYMAPPING__CTOR_3_OFFSET UNITYSDK_OFFSET(0x20C6690)
#define INCONTROL_UNITYKEYBOARDPROVIDER_KEYMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x20C6630)

namespace InControl
{
	inline static constexpr unsigned int UnityKeyboardProvider_KeyMapping_TypeDefinitionIndex = 31443;
