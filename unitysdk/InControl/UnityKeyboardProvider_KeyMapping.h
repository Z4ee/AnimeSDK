...
#define INCONTROL_UNITYKEYBOARDPROVIDER_KEYMAPPING_GET_ISPRESSED_OFFSET UNITYSDK_OFFSET(0x3B58620)
#define INCONTROL_UNITYKEYBOARDPROVIDER_KEYMAPPING_GET_NAME_OFFSET UNITYSDK_OFFSET(0x3B58660)
#define INCONTROL_UNITYKEYBOARDPROVIDER_KEYMAPPING_GET_UNITYKEY_OFFSET UNITYSDK_OFFSET(0x1E120)
#define INCONTROL_UNITYKEYBOARDPROVIDER_KEYMAPPING_GET_WASPRESSED_OFFSET UNITYSDK_OFFSET(0x3B585E0)
#define INCONTROL_UNITYKEYBOARDPROVIDER_KEYMAPPING__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3B58580)
#define INCONTROL_UNITYKEYBOARDPROVIDER_KEYMAPPING__CTOR_2_OFFSET UNITYSDK_OFFSET(0x3B585A0)
#define INCONTROL_UNITYKEYBOARDPROVIDER_KEYMAPPING__CTOR_3_OFFSET UNITYSDK_OFFSET(0x3B585C0)
#define INCONTROL_UNITYKEYBOARDPROVIDER_KEYMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x3B58560)

namespace InControl
{
	inline static constexpr unsigned int UnityKeyboardProvider_KeyMapping_TypeDefinitionIndex = 39562;
