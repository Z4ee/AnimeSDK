...
#define INCONTROL_OPTIONALINPUTDEVICEDRIVERTYPE_CLEAR_OFFSET UNITYSDK_OFFSET(0x3A2FA40)
#define INCONTROL_OPTIONALINPUTDEVICEDRIVERTYPE_COMBINEHASHCODES_OFFSET UNITYSDK_OFFSET(0x1497F9D0)
#define INCONTROL_OPTIONALINPUTDEVICEDRIVERTYPE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3A2FA80)
#define INCONTROL_OPTIONALINPUTDEVICEDRIVERTYPE_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x3A2FAA0)
#define INCONTROL_OPTIONALINPUTDEVICEDRIVERTYPE_EQUALS_OFFSET UNITYSDK_OFFSET(0x3A2FA70)
#define INCONTROL_OPTIONALINPUTDEVICEDRIVERTYPE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3A2FAC0)
#define INCONTROL_OPTIONALINPUTDEVICEDRIVERTYPE_GETVALUEORDEFAULT_OFFSET UNITYSDK_OFFSET(0x3A2FA50)
#define INCONTROL_OPTIONALINPUTDEVICEDRIVERTYPE_GETVALUEORZERO_OFFSET UNITYSDK_OFFSET(0x3A2FA60)
#define INCONTROL_OPTIONALINPUTDEVICEDRIVERTYPE_GET_HASNOVALUE_OFFSET UNITYSDK_OFFSET(0x3A2F740)
#define INCONTROL_OPTIONALINPUTDEVICEDRIVERTYPE_GET_HASVALUE_OFFSET UNITYSDK_OFFSET(0x182E0)
#define INCONTROL_OPTIONALINPUTDEVICEDRIVERTYPE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x3A2F9D0)
#define INCONTROL_OPTIONALINPUTDEVICEDRIVERTYPE_OP_EQUALITY_1_OFFSET UNITYSDK_OFFSET(0x1497F9A0)
#define INCONTROL_OPTIONALINPUTDEVICEDRIVERTYPE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1497F960)
#define INCONTROL_OPTIONALINPUTDEVICEDRIVERTYPE_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1497FAC0)
#define INCONTROL_OPTIONALINPUTDEVICEDRIVERTYPE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x14936A80)
#define INCONTROL_OPTIONALINPUTDEVICEDRIVERTYPE_OP_INEQUALITY_1_OFFSET UNITYSDK_OFFSET(0x1497F9B0)
#define INCONTROL_OPTIONALINPUTDEVICEDRIVERTYPE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1497F980)
#define INCONTROL_OPTIONALINPUTDEVICEDRIVERTYPE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x3A2F9C0)
#define INCONTROL_OPTIONALINPUTDEVICEDRIVERTYPE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x3A2F9C0)
#define INCONTROL_OPTIONALINPUTDEVICEDRIVERTYPE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3A2FAE0)
#define INCONTROL_OPTIONALINPUTDEVICEDRIVERTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x3A2F9C0)
