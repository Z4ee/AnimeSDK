...
#define MONOUITABLESCROLLV2_INITSCROLLVIEWDATA_SALIGNPARAM_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x11C31700)
#define MONOUITABLESCROLLV2_INITSCROLLVIEWDATA_SALIGNPARAM_KEEPCUSTOMDATAPOSITION_OFFSET UNITYSDK_OFFSET(0x11C315E0)
#define MONOUITABLESCROLLV2_INITSCROLLVIEWDATA_SALIGNPARAM_KEEPCUSTOMITEMPOSITION_OFFSET UNITYSDK_OFFSET(0x11C31540)
#define MONOUITABLESCROLLV2_INITSCROLLVIEWDATA_SALIGNPARAM_KEEPSELECTEDITEMPOSITION_OFFSET UNITYSDK_OFFSET(0x11C314A0)
#define MONOUITABLESCROLLV2_INITSCROLLVIEWDATA_SALIGNPARAM_RESETTOSTART_OFFSET UNITYSDK_OFFSET(0x11C31670)

inline static constexpr unsigned int MonoUITableScrollV2_InitScrollViewData_SAlignParam_TypeDefinitionIndex = 74989;
