...
#define CLASS_2_9D8F794787C5DEB6_CLEARTRIGGER_OFFSET UNITYSDK_OFFSET(0xAA0EC00)
#define CLASS_2_9D8F794787C5DEB6_METHOD_2_0C32ED5B41B1582B_OFFSET UNITYSDK_OFFSET(0xAA0EAB0)
#define CLASS_2_9D8F794787C5DEB6_METHOD_2_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0xAA0EA60)
#define CLASS_2_9D8F794787C5DEB6_METHOD_2_406D18D7229C87E0_OFFSET UNITYSDK_OFFSET(0xAA0E170)
#define CLASS_2_9D8F794787C5DEB6_METHOD_2_549A9AEF4E247CAB_OFFSET UNITYSDK_OFFSET(0xAA0F1E0)
#define CLASS_2_9D8F794787C5DEB6_METHOD_2_69CD85726D432382_OFFSET UNITYSDK_OFFSET(0xAA0F190)
#define CLASS_2_9D8F794787C5DEB6_METHOD_2_892811B0A5984DEC_OFFSET UNITYSDK_OFFSET(0xAA0E710)
#define CLASS_2_9D8F794787C5DEB6_METHOD_2_B8894D16AB00C20E_OFFSET UNITYSDK_OFFSET(0xAA0F4E0)
#define CLASS_2_9D8F794787C5DEB6__CHECKDISABLEBUTTONCONDITIONS_OFFSET UNITYSDK_OFFSET(0xAA0EF60)
#define CLASS_2_9D8F794787C5DEB6__CHECKENABLEBUTTONCONDITIONS_OFFSET UNITYSDK_OFFSET(0xAA0EC80)
#define CLASS_2_9D8F794787C5DEB6__CTOR_OFFSET UNITYSDK_OFFSET(0xAA0E890)
#define CLASS_2_9D8F794787C5DEB6__GET_CHECKDISABLEINTERACT_B__2_0_OFFSET UNITYSDK_OFFSET(0xAA0F7C0)

inline static constexpr unsigned int Class_2_9D8F794787C5DEB6_TypeDefinitionIndex = 71280;

class Class_2_9D8F794787C5DEB6 : public ::RPG::Client::LittleGame::SimpleTriggerService_1<::Class_2_B8E38BF47138A2E5*>
{
public:
	::Class_3_D6E9A038FA23103A* Field_2_0; // 0x38
	::Class_1_2CDF619C23140440* Field_2_1; // 0x40
	::System::Collections::Generic::HashSet_1<::System::String*>* Field_2_2; // 0x48
	::System::Collections::Generic::HashSet_1<::System::String*>* Field_2_3; // 0x50
	::System::Boolean Field_2_4; // 0x58

	::System::Void _ctor(::Class_3_D6E9A038FA23103A* a1, ::Class_1_2CDF619C23140440* a2, ::UnityEngine::Transform* a3)
	{
		return ((::System::Void(*)(::PVOID, ::Class_3_D6E9A038FA23103A*, ::Class_1_2CDF619C23140440*, ::UnityEngine::Transform*))((::PBYTE)hIl2Cpp + CLASS_2_9D8F794787C5DEB6__CTOR_OFFSET))(this, a1, a2, a3);
	}
