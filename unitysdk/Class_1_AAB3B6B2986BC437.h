...
#define CLASS_1_AAB3B6B2986BC437_METHOD_1_F6FF3DE94D09C840_OFFSET UNITYSDK_OFFSET(0x1C9673A0)
#define CLASS_1_AAB3B6B2986BC437__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9676D0)
...
{
public:
	::System::String* ONDPOGOJIID; // 0x10
	::Il2CppArray<::System::UInt32>* KPNIGDPANOC; // 0x18
	::Il2CppArray<::System::UInt32>* KOAGHJCOOGA; // 0x20
	::System::UInt32 GDEOCHKAEMO; // 0x28
	::System::UInt32 GGKPLJJMBBA; // 0x2C
	::RPG::Client::TextID LLLJACLJAEP; // 0x30
	::System::UInt32 LHCNEHAHKHM; // 0x40
	::System::UInt32 AEONKNDCDKN; // 0x44
