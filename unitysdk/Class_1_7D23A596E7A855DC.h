...
#define CLASS_1_7D23A596E7A855DC_DISPOSE_OFFSET UNITYSDK_OFFSET(0xF3C85F0)
#define CLASS_1_7D23A596E7A855DC_GET_FORWARD_OFFSET UNITYSDK_OFFSET(0xF3C8C60)
#define CLASS_1_7D23A596E7A855DC_GET_UNIQUENAME_OFFSET UNITYSDK_OFFSET(0xF3C8C50)
#define CLASS_1_7D23A596E7A855DC_METHOD_1_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xF3C8970)
#define CLASS_1_7D23A596E7A855DC_METHOD_1_367B9590522079D1_OFFSET UNITYSDK_OFFSET(0xF3C8720)
#define CLASS_1_7D23A596E7A855DC_METHOD_1_43A46E5F9FAC62B8_OFFSET UNITYSDK_OFFSET(0xF3C8C80)
#define CLASS_1_7D23A596E7A855DC_METHOD_1_5323F2DF46A044DA_OFFSET UNITYSDK_OFFSET(0xF3C8CA0)
#define CLASS_1_7D23A596E7A855DC_METHOD_1_92A998451FF61049_OFFSET UNITYSDK_OFFSET(0xF3C8A90)
#define CLASS_1_7D23A596E7A855DC_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xF3C86E0)
#define CLASS_1_7D23A596E7A855DC_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xF3C8690)
#define CLASS_1_7D23A596E7A855DC_METHOD_1_E7F1AECA7CFF8AAD_OFFSET UNITYSDK_OFFSET(0xF3C8CB0)
#define CLASS_1_7D23A596E7A855DC_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xF3C8C90)
#define CLASS_1_7D23A596E7A855DC__CTOR_OFFSET UNITYSDK_OFFSET(0xF3C8500)
...
public:
	...
	::Class_1_3D4CDAF848DB014A* NFALPNEJCGP; // 0x18
	::RPG::Client::MonoEscalatorConfigure* CEPGFGIOMDB; // 0x20
	::RPG::Client::PropInstanceManageMonoPlugin* DODAGCBJHIK; // 0x28
	::Il2CppArray<::UnityEngine::Vector3>* EJJJMLPECEJ; // 0x30
	::Class_2_37D832480CB327E1* JHFKOHNKLMH; // 0x38
	::System::Single GHABAAOGBNO; // 0x40
	::System::Single HPCHCEFOKJB; // 0x44
	::UnityEngine::Vector3 _Forward_k__BackingField; // 0x48
	::System::Boolean HKOPHLNFBIO; // 0x54
