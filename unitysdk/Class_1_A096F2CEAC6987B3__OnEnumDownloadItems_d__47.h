...
#define CLASS_1_A096F2CEAC6987B3__ONENUMDOWNLOADITEMS_D__47_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x16AA31A0)
#define CLASS_1_A096F2CEAC6987B3__ONENUMDOWNLOADITEMS_D__47_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_HPATCHBLOCKINFO__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x16AA3E50)
#define CLASS_1_A096F2CEAC6987B3__ONENUMDOWNLOADITEMS_D__47_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_HPATCHBLOCKINFO__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16AA3DE0)
#define CLASS_1_A096F2CEAC6987B3__ONENUMDOWNLOADITEMS_D__47_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x16AA3ED0)
#define CLASS_1_A096F2CEAC6987B3__ONENUMDOWNLOADITEMS_D__47_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16AA3E40)
#define CLASS_1_A096F2CEAC6987B3__ONENUMDOWNLOADITEMS_D__47_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x16AA3DF0)
#define CLASS_1_A096F2CEAC6987B3__ONENUMDOWNLOADITEMS_D__47_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16AA3180)
#define CLASS_1_A096F2CEAC6987B3__ONENUMDOWNLOADITEMS_D__47__CTOR_OFFSET UNITYSDK_OFFSET(0x16A9FDA0)
#define CLASS_1_A096F2CEAC6987B3__ONENUMDOWNLOADITEMS_D__47___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x16AA3190)

inline static constexpr unsigned int Class_1_A096F2CEAC6987B3__OnEnumDownloadItems_d__47_TypeDefinitionIndex = 56810;

class Class_1_A096F2CEAC6987B3__OnEnumDownloadItems_d__47 : public ::System::Object
{
public:
	::Class_1_A096F2CEAC6987B3* __4__this; // 0x10
	::System::Collections::Generic::List_1_Enumerator<::Class_1_21DCD4640D389503_44*> __7__wrap5; // 0x18
