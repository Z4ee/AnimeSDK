...
#define CLASS_1_5B567C8A01BAEDFE_114_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C33CA00)
#define CLASS_1_5B567C8A01BAEDFE_114_CLONE_OFFSET UNITYSDK_OFFSET(0x1C33C6A0)
#define CLASS_1_5B567C8A01BAEDFE_114_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C33C800)
#define CLASS_1_5B567C8A01BAEDFE_114_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C33C710)
#define CLASS_1_5B567C8A01BAEDFE_114_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C33C960)
#define CLASS_1_5B567C8A01BAEDFE_114_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C33CA50)
#define CLASS_1_5B567C8A01BAEDFE_114_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C33CA20)
#define CLASS_1_5B567C8A01BAEDFE_114_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C33C5F0)
#define CLASS_1_5B567C8A01BAEDFE_114_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C33C650)
#define CLASS_1_5B567C8A01BAEDFE_114_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C33C990)
#define CLASS_1_5B567C8A01BAEDFE_114_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C33C9F0)
#define CLASS_1_5B567C8A01BAEDFE_114__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C33CAA0)
#define CLASS_1_5B567C8A01BAEDFE_114__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C33C670)
#define CLASS_1_5B567C8A01BAEDFE_114__CTOR_OFFSET UNITYSDK_OFFSET(0x1C33C660)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_114_TypeDefinitionIndex = 27206;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_114*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_114_TypeDefinitionIndex)->GetStaticField(0x60140);
	}
