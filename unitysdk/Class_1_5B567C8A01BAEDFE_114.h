...
#define CLASS_1_5B567C8A01BAEDFE_114_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19B51220)
#define CLASS_1_5B567C8A01BAEDFE_114_CLONE_OFFSET UNITYSDK_OFFSET(0x19B51030)
#define CLASS_1_5B567C8A01BAEDFE_114_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19B51130)
#define CLASS_1_5B567C8A01BAEDFE_114_EQUALS_OFFSET UNITYSDK_OFFSET(0x19B510A0)
#define CLASS_1_5B567C8A01BAEDFE_114_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19B51180)
#define CLASS_1_5B567C8A01BAEDFE_114_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19B51270)
#define CLASS_1_5B567C8A01BAEDFE_114_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19B51240)
#define CLASS_1_5B567C8A01BAEDFE_114_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19B50F80)
#define CLASS_1_5B567C8A01BAEDFE_114_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19B50FE0)
#define CLASS_1_5B567C8A01BAEDFE_114_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19B511B0)
#define CLASS_1_5B567C8A01BAEDFE_114_WRITETO_OFFSET UNITYSDK_OFFSET(0x19B51210)
#define CLASS_1_5B567C8A01BAEDFE_114__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B512C0)
#define CLASS_1_5B567C8A01BAEDFE_114__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B51000)
#define CLASS_1_5B567C8A01BAEDFE_114__CTOR_OFFSET UNITYSDK_OFFSET(0x19B50FF0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_114_TypeDefinitionIndex = 26784;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_114*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_114_TypeDefinitionIndex)->GetStaticField(0x6A20);
	}
