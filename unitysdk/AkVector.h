...
#define AKVECTOR_GET_X_OFFSET UNITYSDK_OFFSET(0x1FA989E0)
#define AKVECTOR_GET_Y_OFFSET UNITYSDK_OFFSET(0x1FA98A00)
#define AKVECTOR_GET_Z_OFFSET UNITYSDK_OFFSET(0x1FA98A20)
#define AKVECTOR_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1FA98A30)
#define AKVECTOR_SET_X_OFFSET UNITYSDK_OFFSET(0x1FA989D0)
#define AKVECTOR_SET_Y_OFFSET UNITYSDK_OFFSET(0x1FA989F0)
#define AKVECTOR_SET_Z_OFFSET UNITYSDK_OFFSET(0x1FA98A10)
#define AKVECTOR_ZERO_OFFSET UNITYSDK_OFFSET(0x1FA989C0)
#define AKVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1FA98A60)

inline static constexpr unsigned int AkVector_TypeDefinitionIndex = 33713;
