...
#define AKVECTOR_GET_X_OFFSET UNITYSDK_OFFSET(0x1D2D8290)
#define AKVECTOR_GET_Y_OFFSET UNITYSDK_OFFSET(0x1D2D8340)
#define AKVECTOR_GET_Z_OFFSET UNITYSDK_OFFSET(0x1D2D83F0)
#define AKVECTOR_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1D2D8440)
#define AKVECTOR_SET_X_OFFSET UNITYSDK_OFFSET(0x1D2D8230)
#define AKVECTOR_SET_Y_OFFSET UNITYSDK_OFFSET(0x1D2D82E0)
#define AKVECTOR_SET_Z_OFFSET UNITYSDK_OFFSET(0x1D2D8390)
#define AKVECTOR_ZERO_OFFSET UNITYSDK_OFFSET(0x1D2D81E0)
#define AKVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2D84B0)
