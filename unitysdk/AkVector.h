...
#define AKVECTOR_GET_X_OFFSET UNITYSDK_OFFSET(0x1C375070)
#define AKVECTOR_GET_Y_OFFSET UNITYSDK_OFFSET(0x1C375090)
#define AKVECTOR_GET_Z_OFFSET UNITYSDK_OFFSET(0x1C3750B0)
#define AKVECTOR_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1C3750C0)
#define AKVECTOR_SET_X_OFFSET UNITYSDK_OFFSET(0x1C375060)
#define AKVECTOR_SET_Y_OFFSET UNITYSDK_OFFSET(0x1C375080)
#define AKVECTOR_SET_Z_OFFSET UNITYSDK_OFFSET(0x1C3750A0)
#define AKVECTOR_ZERO_OFFSET UNITYSDK_OFFSET(0x1C375050)
#define AKVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3750F0)

inline static constexpr unsigned int AkVector_TypeDefinitionIndex = 31527;
