...
#define AKVECTOR_GET_X_OFFSET UNITYSDK_OFFSET(0x1E6B39E0)
#define AKVECTOR_GET_Y_OFFSET UNITYSDK_OFFSET(0x1E6B3A00)
#define AKVECTOR_GET_Z_OFFSET UNITYSDK_OFFSET(0x1E6B3A20)
#define AKVECTOR_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1E6B3A30)
#define AKVECTOR_SET_X_OFFSET UNITYSDK_OFFSET(0x1E6B39D0)
#define AKVECTOR_SET_Y_OFFSET UNITYSDK_OFFSET(0x1E6B39F0)
#define AKVECTOR_SET_Z_OFFSET UNITYSDK_OFFSET(0x1E6B3A10)
#define AKVECTOR_ZERO_OFFSET UNITYSDK_OFFSET(0x1E6B39C0)
#define AKVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6B3A60)

inline static constexpr unsigned int AkVector_TypeDefinitionIndex = 33078;
