...
#define CLASS_1_7DE30353A96A8E09__CREATECONFIGS_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x16031110)
#define CLASS_1_7DE30353A96A8E09__CREATECONFIGS_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_VALUETUPLE_SYSTEM_UINT32_RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCECONFIG___GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x16031750)
#define CLASS_1_7DE30353A96A8E09__CREATECONFIGS_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_VALUETUPLE_SYSTEM_UINT32_RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCECONFIG___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x160316A0)
#define CLASS_1_7DE30353A96A8E09__CREATECONFIGS_D__4_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x160317C0)
#define CLASS_1_7DE30353A96A8E09__CREATECONFIGS_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16031700)
#define CLASS_1_7DE30353A96A8E09__CREATECONFIGS_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x160316B0)
#define CLASS_1_7DE30353A96A8E09__CREATECONFIGS_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16031010)
#define CLASS_1_7DE30353A96A8E09__CREATECONFIGS_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x1602FC30)
#define CLASS_1_7DE30353A96A8E09__CREATECONFIGS_D__4___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x160310B0)
#define CLASS_1_7DE30353A96A8E09__CREATECONFIGS_D__4___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x160310D0)
#define CLASS_1_7DE30353A96A8E09__CREATECONFIGS_D__4___M__FINALLY3_OFFSET UNITYSDK_OFFSET(0x160310F0)

inline static constexpr unsigned int Class_1_7DE30353A96A8E09__CreateConfigs_d__4_TypeDefinitionIndex = 76537;

class Class_1_7DE30353A96A8E09__CreateConfigs_d__4 : public ::System::Object
{
public:
	::Class_1_7DE30353A96A8E09* __4__this; // 0x10
	::RPG::GameCore::FixEnumerator_2<::RPG::GameCore::CommonIndexKey, ::Class_1_FAC024BF6BF908E1*> _iter_5__2; // 0x18
	::RPG::GameCore::FixEnumerator_2<::RPG::GameCore::CommonIndexKey, ::Class_1_B10D9DB4D3D8BBA7*> _iter_5__4; // 0x58
	::RPG::GameCore::FixEnumerator_2<::RPG::GameCore::CommonIndexKey, ::Class_1_FAC024BF6BF908E1_1*> _iter_5__3; // 0x98
	::System::ValueTuple_2<::System::UInt32, ::Class_1_52DE58AEA447C9CD*> __2__current; // 0xD8
