...
#define CLASS_1_D26322A0A5D2FA93_METHOD_1_1808E1CF7A125519_1_OFFSET UNITYSDK_OFFSET(0x18753B30)
#define CLASS_1_D26322A0A5D2FA93_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x18753AC0)
#define CLASS_1_D26322A0A5D2FA93_METHOD_1_223FCF5315354AB5_OFFSET UNITYSDK_OFFSET(0x18753530)
#define CLASS_1_D26322A0A5D2FA93_METHOD_1_4B1FB5B1C14B54F5_OFFSET UNITYSDK_OFFSET(0x18753630)
#define CLASS_1_D26322A0A5D2FA93_METHOD_1_81B63EC00BDA4B22_OFFSET UNITYSDK_OFFSET(0x18753380)
#define CLASS_1_D26322A0A5D2FA93_METHOD_1_8542E37E74FDE1B5_OFFSET UNITYSDK_OFFSET(0x18752D80)
#define CLASS_1_D26322A0A5D2FA93_METHOD_1_A61A196E6AD5766D_OFFSET UNITYSDK_OFFSET(0x187537A0)
#define CLASS_1_D26322A0A5D2FA93_METHOD_1_ABFE6A357B89C69A_OFFSET UNITYSDK_OFFSET(0x18753360)
#define CLASS_1_D26322A0A5D2FA93_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x18752BC0)
#define CLASS_1_D26322A0A5D2FA93_METHOD_1_DEAC86EB2AD5D389_OFFSET UNITYSDK_OFFSET(0x18752C20)
#define CLASS_1_D26322A0A5D2FA93_METHOD_1_E5179FA5DCDA5B7D_OFFSET UNITYSDK_OFFSET(0x18753420)
#define CLASS_1_D26322A0A5D2FA93__CTOR_OFFSET UNITYSDK_OFFSET(0x18752B40)

inline static constexpr unsigned int Class_1_D26322A0A5D2FA93_TypeDefinitionIndex = 60868;

class Class_1_D26322A0A5D2FA93 : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::Class_1_D26322A0A5D2FA93_Class_1_7075CD4ADAC35B11*>* IFMDBDJCCCI; // 0x10
	::RPG::Client::UIManager* IGGHFMJPHHH; // 0x18
	::System::Collections::Generic::List_1<::Class_1_D26322A0A5D2FA93_Class_1_7075CD4ADAC35B11*>* OMKCCADAKDC; // 0x20
	::RPG::GameCore::ScreenTransferReason HBOPBCMODIE; // 0x28
	::System::Boolean FKBCNNMKDNE; // 0x2C
