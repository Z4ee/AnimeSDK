...
#define CLASS_2_8987AEE8D4D6ABF0_METHOD_2_4B75E771BB013954_OFFSET UNITYSDK_OFFSET(0x15812BD0)
#define CLASS_2_8987AEE8D4D6ABF0_METHOD_2_5BA91482F524632E_OFFSET UNITYSDK_OFFSET(0x15812DC0)
#define CLASS_2_8987AEE8D4D6ABF0_METHOD_2_EF94853A4119525A_OFFSET UNITYSDK_OFFSET(0x15812B60)
#define CLASS_2_8987AEE8D4D6ABF0_METHOD_2_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x15812F60)
#define CLASS_2_8987AEE8D4D6ABF0__CCTOR_OFFSET UNITYSDK_OFFSET(0x15813000)
#define CLASS_2_8987AEE8D4D6ABF0__CTOR_OFFSET UNITYSDK_OFFSET(0x15812FD0)
#define CLASS_2_8987AEE8D4D6ABF0__ONBIND_OFFSET UNITYSDK_OFFSET(0x15812AA0)

inline static constexpr unsigned int Class_2_8987AEE8D4D6ABF0_TypeDefinitionIndex = 71417;
...
public:
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::RPG::GameCore::SilverWolf999UltraPropState, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_8987AEE8D4D6ABF0_TypeDefinitionIndex)->GetStaticField(0x52430);
	}
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::RPG::GameCore::SilverWolf999UltraPropType, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_8987AEE8D4D6ABF0_TypeDefinitionIndex)->GetStaticField(0x52438);
	}
	::UnityEngine::RectTransform* HACIPINNIOG; // 0x60
	::UnityEngine::UI::Image* MKOCDHEFAME; // 0x68
	::RPG::Client::UIStateCtrl* GIMAEGBDOBL; // 0x70
