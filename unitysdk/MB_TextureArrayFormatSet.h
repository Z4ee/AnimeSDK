...
#define MB_TEXTUREARRAYFORMATSET_GETFORMATFORPROPERTY_OFFSET UNITYSDK_OFFSET(0x1BB04F50)
#define MB_TEXTUREARRAYFORMATSET_VALIDATETEXTUREIMPORTERFORMATSEXISTSFORTEXTUREFORMATS_OFFSET UNITYSDK_OFFSET(0x1BB046E0)
#define MB_TEXTUREARRAYFORMATSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB05020)

inline static constexpr unsigned int MB_TextureArrayFormatSet_TypeDefinitionIndex = 84953;
