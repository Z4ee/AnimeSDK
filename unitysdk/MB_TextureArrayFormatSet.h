...
#define MB_TEXTUREARRAYFORMATSET_GETFORMATFORPROPERTY_OFFSET UNITYSDK_OFFSET(0x1F2AB420)
#define MB_TEXTUREARRAYFORMATSET_VALIDATETEXTUREIMPORTERFORMATSEXISTSFORTEXTUREFORMATS_OFFSET UNITYSDK_OFFSET(0x1F2AABA0)
#define MB_TEXTUREARRAYFORMATSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1F2AB4F0)

inline static constexpr unsigned int MB_TextureArrayFormatSet_TypeDefinitionIndex = 94460;
