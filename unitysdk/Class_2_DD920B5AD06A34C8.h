...
#define CLASS_2_DD920B5AD06A34C8_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13BA64E0)
#define CLASS_2_DD920B5AD06A34C8_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x13BA6520)
#define CLASS_2_DD920B5AD06A34C8_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x13BA6570)
#define CLASS_2_DD920B5AD06A34C8_TICK_OFFSET UNITYSDK_OFFSET(0x13BA65C0)
#define CLASS_2_DD920B5AD06A34C8__CTOR_OFFSET UNITYSDK_OFFSET(0x13BA64D0)

inline static constexpr unsigned int Class_2_DD920B5AD06A34C8_TypeDefinitionIndex = 52096;

class Class_2_DD920B5AD06A34C8 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TurnInsertAssistantAbility* Field_2_0; // 0x18
