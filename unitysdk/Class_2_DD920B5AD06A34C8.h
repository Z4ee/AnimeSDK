...
#define CLASS_2_DD920B5AD06A34C8_DISPOSE_OFFSET UNITYSDK_OFFSET(0x157DA640)
#define CLASS_2_DD920B5AD06A34C8_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x157DA680)
#define CLASS_2_DD920B5AD06A34C8_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x157DA6D0)
#define CLASS_2_DD920B5AD06A34C8_TICK_OFFSET UNITYSDK_OFFSET(0x157DA720)
#define CLASS_2_DD920B5AD06A34C8__CTOR_OFFSET UNITYSDK_OFFSET(0x157DA630)

inline static constexpr unsigned int Class_2_DD920B5AD06A34C8_TypeDefinitionIndex = 53253;

class Class_2_DD920B5AD06A34C8 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::TurnInsertAssistantAbility* Field_2_1; // 0x20
