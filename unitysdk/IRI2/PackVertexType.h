...
#define IRI2_PACKVERTEXTYPE_METHOD_2_527DACE32CCDF759_OFFSET UNITYSDK_OFFSET(0x2BC9540)
#define IRI2_PACKVERTEXTYPE_METHOD_2_62D3B1E102826B2F_OFFSET UNITYSDK_OFFSET(0x2BC9590)
#define IRI2_PACKVERTEXTYPE_METHOD_2_85F1C287C26954B0_OFFSET UNITYSDK_OFFSET(0x2BC95B0)
#define IRI2_PACKVERTEXTYPE_METHOD_2_C68F979EE51FFD36_1_OFFSET UNITYSDK_OFFSET(0x14231750)
#define IRI2_PACKVERTEXTYPE_METHOD_2_C68F979EE51FFD36_OFFSET UNITYSDK_OFFSET(0x14231740)
#define IRI2_PACKVERTEXTYPE_METHOD_2_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x14231540)

namespace IRI2
{
	inline static constexpr unsigned int PackVertexType_TypeDefinitionIndex = 46841;
