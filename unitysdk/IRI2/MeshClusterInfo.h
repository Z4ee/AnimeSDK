...
#define IRI2_MESHCLUSTERINFO_METHOD_2_55CDF35EA89BC4E5_OFFSET UNITYSDK_OFFSET(0x14949B0)
#define IRI2_MESHCLUSTERINFO_METHOD_2_A683D01FB86C1949_OFFSET UNITYSDK_OFFSET(0x14948D0)
#define IRI2_MESHCLUSTERINFO_METHOD_2_F5599B7DA8E7E53C_OFFSET UNITYSDK_OFFSET(0x14948B0)

namespace IRI2
{
	inline static constexpr unsigned int MeshClusterInfo_TypeDefinitionIndex = 40350;
