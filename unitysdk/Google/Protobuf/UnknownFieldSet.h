...
#define GOOGLE_PROTOBUF_UNKNOWNFIELDSET_ADDORREPLACEFIELD_OFFSET UNITYSDK_OFFSET(0x1BDD38E0)
#define GOOGLE_PROTOBUF_UNKNOWNFIELDSET_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1BDBE750)
#define GOOGLE_PROTOBUF_UNKNOWNFIELDSET_CLONE_OFFSET UNITYSDK_OFFSET(0x1BDBD000)
#define GOOGLE_PROTOBUF_UNKNOWNFIELDSET_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BDD2EB0)
#define GOOGLE_PROTOBUF_UNKNOWNFIELDSET_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BDBD8F0)
#define GOOGLE_PROTOBUF_UNKNOWNFIELDSET_GETORADDFIELD_OFFSET UNITYSDK_OFFSET(0x1BDD3730)
#define GOOGLE_PROTOBUF_UNKNOWNFIELDSET_HASFIELD_OFFSET UNITYSDK_OFFSET(0x1BDD2D70)
#define GOOGLE_PROTOBUF_UNKNOWNFIELDSET_MERGEFIELDFROM_1_OFFSET UNITYSDK_OFFSET(0x1BDBF180)
#define GOOGLE_PROTOBUF_UNKNOWNFIELDSET_MERGEFIELDFROM_OFFSET UNITYSDK_OFFSET(0x1BDD3A70)
#define GOOGLE_PROTOBUF_UNKNOWNFIELDSET_MERGEFIELD_OFFSET UNITYSDK_OFFSET(0x1BDD4240)
#define GOOGLE_PROTOBUF_UNKNOWNFIELDSET_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1BDBEF20)
#define GOOGLE_PROTOBUF_UNKNOWNFIELDSET_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1BDD3D90)
#define GOOGLE_PROTOBUF_UNKNOWNFIELDSET_WRITETO_OFFSET UNITYSDK_OFFSET(0x1BDBE1F0)
#define GOOGLE_PROTOBUF_UNKNOWNFIELDSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDD2CE0)

namespace Google::Protobuf
{
	inline static constexpr unsigned int UnknownFieldSet_TypeDefinitionIndex = 5418;
