...
#define GOOGLE_PROTOBUF_UNKNOWNFIELDSET_ADDORREPLACEFIELD_OFFSET UNITYSDK_OFFSET(0x1B3A2EE0)
#define GOOGLE_PROTOBUF_UNKNOWNFIELDSET_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1B38DD30)
#define GOOGLE_PROTOBUF_UNKNOWNFIELDSET_CLONE_OFFSET UNITYSDK_OFFSET(0x1B38C5E0)
#define GOOGLE_PROTOBUF_UNKNOWNFIELDSET_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B3A24B0)
#define GOOGLE_PROTOBUF_UNKNOWNFIELDSET_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B38CED0)
#define GOOGLE_PROTOBUF_UNKNOWNFIELDSET_GETORADDFIELD_OFFSET UNITYSDK_OFFSET(0x1B3A2D30)
#define GOOGLE_PROTOBUF_UNKNOWNFIELDSET_HASFIELD_OFFSET UNITYSDK_OFFSET(0x1B3A2370)
#define GOOGLE_PROTOBUF_UNKNOWNFIELDSET_MERGEFIELDFROM_1_OFFSET UNITYSDK_OFFSET(0x1B38E760)
#define GOOGLE_PROTOBUF_UNKNOWNFIELDSET_MERGEFIELDFROM_OFFSET UNITYSDK_OFFSET(0x1B3A3070)
#define GOOGLE_PROTOBUF_UNKNOWNFIELDSET_MERGEFIELD_OFFSET UNITYSDK_OFFSET(0x1B3A3840)
#define GOOGLE_PROTOBUF_UNKNOWNFIELDSET_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1B38E500)
#define GOOGLE_PROTOBUF_UNKNOWNFIELDSET_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1B3A3390)
#define GOOGLE_PROTOBUF_UNKNOWNFIELDSET_WRITETO_OFFSET UNITYSDK_OFFSET(0x1B38D7D0)
#define GOOGLE_PROTOBUF_UNKNOWNFIELDSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A22E0)

namespace Google::Protobuf
{
	inline static constexpr unsigned int UnknownFieldSet_TypeDefinitionIndex = 5407;
