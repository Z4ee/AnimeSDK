...
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x19046710)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19045800)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_MERGEFROM_2_OFFSET UNITYSDK_OFFSET(0x19045A00)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_MERGEFROM_3_OFFSET UNITYSDK_OFFSET(0x19045630)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_MERGEFROM_4_OFFSET UNITYSDK_OFFSET(0x19045820)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_MERGEFROM_5_OFFSET UNITYSDK_OFFSET(0x19045A10)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19045620)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_TOBYTEARRAYFROMPOOL_OFFSET UNITYSDK_OFFSET(0x19045FA0)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_TOBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x19045BF0)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_TOBYTESTRING_OFFSET UNITYSDK_OFFSET(0x19046660)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_WRITETO_OFFSET UNITYSDK_OFFSET(0x19046380)

namespace Google::Protobuf
{
	inline static constexpr unsigned int MessageExtensions_TypeDefinitionIndex = 5410;
