...
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1AA88450)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1AA87540)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_MERGEFROM_2_OFFSET UNITYSDK_OFFSET(0x1AA87740)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_MERGEFROM_3_OFFSET UNITYSDK_OFFSET(0x1AA87360)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_MERGEFROM_4_OFFSET UNITYSDK_OFFSET(0x1AA87560)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_MERGEFROM_5_OFFSET UNITYSDK_OFFSET(0x1AA87750)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1AA87350)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_TOBYTEARRAYFROMPOOL_OFFSET UNITYSDK_OFFSET(0x1AA87CE0)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_TOBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x1AA87930)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_TOBYTESTRING_OFFSET UNITYSDK_OFFSET(0x1AA883A0)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_WRITETO_OFFSET UNITYSDK_OFFSET(0x1AA880C0)
