...
#define GOOGLE_PROTOBUF_EXTENSION_GET_FIELDNUMBER_OFFSET UNITYSDK_OFFSET(0x17E3BD70)

namespace Google::Protobuf
{
	inline static constexpr unsigned int Extension_TypeDefinitionIndex = 5370;
