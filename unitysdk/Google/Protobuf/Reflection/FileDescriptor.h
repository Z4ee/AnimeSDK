...
#define GOOGLE_PROTOBUF_REFLECTION_FILEDESCRIPTOR_ADDALLEXTENSIONS_OFFSET UNITYSDK_OFFSET(0x15B063C0)
#define GOOGLE_PROTOBUF_REFLECTION_FILEDESCRIPTOR_BUILDFROM_OFFSET UNITYSDK_OFFSET(0x15B05300)
#define GOOGLE_PROTOBUF_REFLECTION_FILEDESCRIPTOR_COMPUTEFULLNAME_OFFSET UNITYSDK_OFFSET(0x15AF59F0)
#define GOOGLE_PROTOBUF_REFLECTION_FILEDESCRIPTOR_CREATEDECLARATIONMAP_OFFSET UNITYSDK_OFFSET(0x15B04550)
#define GOOGLE_PROTOBUF_REFLECTION_FILEDESCRIPTOR_CROSSLINK_OFFSET UNITYSDK_OFFSET(0x15B05440)
#define GOOGLE_PROTOBUF_REFLECTION_FILEDESCRIPTOR_DETERMINEPUBLICDEPENDENCIES_OFFSET UNITYSDK_OFFSET(0x15B03FB0)
#define GOOGLE_PROTOBUF_REFLECTION_FILEDESCRIPTOR_FINDDESCRIPTORFORPATH_OFFSET UNITYSDK_OFFSET(0x15B04A60)
#define GOOGLE_PROTOBUF_REFLECTION_FILEDESCRIPTOR_FROMGENERATEDCODE_OFFSET UNITYSDK_OFFSET(0x15AF5380)
#define GOOGLE_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GETALLDEPENDEDEXTENSIONSFROMMESSAGE_OFFSET UNITYSDK_OFFSET(0x15B06840)
#define GOOGLE_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GETALLDEPENDEDEXTENSIONS_OFFSET UNITYSDK_OFFSET(0x15B06670)
#define GOOGLE_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GETALLGENERATEDEXTENSIONS_OFFSET UNITYSDK_OFFSET(0x15B06510)
#define GOOGLE_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GETDESCRIPTORFROMLIST_OFFSET UNITYSDK_OFFSET(0x15B04F80)
#define GOOGLE_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GETNESTEDDESCRIPTORLISTFORFIELD_OFFSET UNITYSDK_OFFSET(0x15B04EF0)
#define GOOGLE_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_DEPENDENCIES_OFFSET UNITYSDK_OFFSET(0x15B05250)
#define GOOGLE_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_DESCRIPTORPOOL_OFFSET UNITYSDK_OFFSET(0x15B052F0)
#define GOOGLE_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_ENUMTYPES_OFFSET UNITYSDK_OFFSET(0x15B05220)
#define GOOGLE_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_EXTENSIONS_OFFSET UNITYSDK_OFFSET(0x15B05240)
#define GOOGLE_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_MESSAGETYPES_OFFSET UNITYSDK_OFFSET(0x15B05210)
#define GOOGLE_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_NAME_OFFSET UNITYSDK_OFFSET(0x15AEA780)
#define GOOGLE_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_PACKAGE_OFFSET UNITYSDK_OFFSET(0x15AEA3F0)
#define GOOGLE_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_PROTO_OFFSET UNITYSDK_OFFSET(0x15B05120)
#define GOOGLE_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_PUBLICDEPENDENCIES_OFFSET UNITYSDK_OFFSET(0x15B05260)
#define GOOGLE_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GET_SERVICES_OFFSET UNITYSDK_OFFSET(0x15B05230)
#define GOOGLE_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GOOGLE_PROTOBUF_REFLECTION_IDESCRIPTOR_GET_FILE_OFFSET UNITYSDK_OFFSET(0x15B052E0)
#define GOOGLE_PROTOBUF_REFLECTION_FILEDESCRIPTOR_GOOGLE_PROTOBUF_REFLECTION_IDESCRIPTOR_GET_FULLNAME_OFFSET UNITYSDK_OFFSET(0x15B05270)
#define GOOGLE_PROTOBUF_REFLECTION_FILEDESCRIPTOR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x15B069B0)
#define GOOGLE_PROTOBUF_REFLECTION_FILEDESCRIPTOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x15B03950)
#define GOOGLE_PROTOBUF_REFLECTION_FILEDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x15B03CA0)

namespace Google::Protobuf::Reflection
{
	inline static constexpr unsigned int FileDescriptor_TypeDefinitionIndex = 6330;

	class FileDescriptor : public ::System::Object
	{
	public:
		::Google::Protobuf::Reflection::ExtensionCollection* _Extensions_k__BackingField; // 0x10
		::Google::Protobuf::ByteString* _SerializedData_k__BackingField; // 0x18
		::System::Collections::Generic::IList_1<::Google::Protobuf::Reflection::FileDescriptor*>* _PublicDependencies_k__BackingField; // 0x20
		::Google::Protobuf::Reflection::FileDescriptorProto* _Proto_k__BackingField; // 0x28
		::System::Collections::Generic::IList_1<::Google::Protobuf::Reflection::ServiceDescriptor*>* _Services_k__BackingField; // 0x30
		::Google::Protobuf::Reflection::DescriptorPool* _DescriptorPool_k__BackingField; // 0x38
		::System::Collections::Generic::IList_1<::Google::Protobuf::Reflection::FileDescriptor*>* _Dependencies_k__BackingField; // 0x40
		::System::Lazy_1<::System::Collections::Generic::Dictionary_2<::Google::Protobuf::Reflection::IDescriptor*, ::Google::Protobuf::Reflection::DescriptorDeclaration*>*>* declarations; // 0x48
