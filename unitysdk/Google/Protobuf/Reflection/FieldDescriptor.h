...
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1AA9E960)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_CREATEACCESSOR_OFFSET UNITYSDK_OFFSET(0x1AA9EBA0)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_CROSSLINK_OFFSET UNITYSDK_OFFSET(0x1AA9C740)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GETFIELDTYPEFROMPROTOTYPE_OFFSET UNITYSDK_OFFSET(0x1AA9E6C0)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_ACCESSOR_OFFSET UNITYSDK_OFFSET(0x1AA9E880)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_CONTAININGONEOF_OFFSET UNITYSDK_OFFSET(0x1AA9E5B0)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_CONTAININGTYPE_OFFSET UNITYSDK_OFFSET(0x1AA9E5A0)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_EXTENDEETYPE_OFFSET UNITYSDK_OFFSET(0x1AA8BD60)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_EXTENSION_OFFSET UNITYSDK_OFFSET(0x1AA9E5E0)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_FIELDNUMBER_OFFSET UNITYSDK_OFFSET(0x1AA86180)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_FIELDTYPE_OFFSET UNITYSDK_OFFSET(0x1AA9E8F0)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_ISMAP_OFFSET UNITYSDK_OFFSET(0x1AA813E0)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_ISREPEATED_OFFSET UNITYSDK_OFFSET(0x1AA81470)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_ISREQUIRED_OFFSET UNITYSDK_OFFSET(0x1AA89270)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_JSONNAME_OFFSET UNITYSDK_OFFSET(0x1AA9E5C0)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1AA8BDE0)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_PROTO_OFFSET UNITYSDK_OFFSET(0x1AA9E5D0)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA9CF30)
...
namespace Google::Protobuf::Reflection
{
	...
	{
	public:
		::Google::Protobuf::Reflection::IFieldAccessor* accessor; // 0x28
		::Google::Protobuf::Reflection::OneofDescriptor* _ContainingOneof_k__BackingField; // 0x30
		::System::String* propertyName; // 0x38
		::Google::Protobuf::Reflection::MessageDescriptor* extendeeType; // 0x40
		::Google::Protobuf::Reflection::EnumDescriptor* enumType; // 0x48
		::Google::Protobuf::Reflection::MessageDescriptor* _ContainingType_k__BackingField; // 0x50
		::Google::Protobuf::Reflection::MessageDescriptor* messageType; // 0x58
		::Google::Protobuf::Reflection::FieldDescriptorProto* _Proto_k__BackingField; // 0x60
		::Google::Protobuf::Extension* _Extension_k__BackingField; // 0x68
		::System::String* _JsonName_k__BackingField; // 0x70
