...
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_COMPARETO_OFFSET UNITYSDK_OFFSET(0x17E5BEE0)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_CREATEACCESSOR_OFFSET UNITYSDK_OFFSET(0x17E5C120)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_CROSSLINK_OFFSET UNITYSDK_OFFSET(0x17E59FA0)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GETFIELDTYPEFROMPROTOTYPE_OFFSET UNITYSDK_OFFSET(0x17E5BC40)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_ACCESSOR_OFFSET UNITYSDK_OFFSET(0x17E5BE00)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_CONTAININGONEOF_OFFSET UNITYSDK_OFFSET(0x17E5BB30)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_CONTAININGTYPE_OFFSET UNITYSDK_OFFSET(0x17E5BB20)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_EXTENDEETYPE_OFFSET UNITYSDK_OFFSET(0x17E49A90)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_EXTENSION_OFFSET UNITYSDK_OFFSET(0x17E5BB60)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_FIELDNUMBER_OFFSET UNITYSDK_OFFSET(0x17E451C0)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_FIELDTYPE_OFFSET UNITYSDK_OFFSET(0x17E5BE70)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_ISMAP_OFFSET UNITYSDK_OFFSET(0x17E41DE0)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_ISREPEATED_OFFSET UNITYSDK_OFFSET(0x17E41E70)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_ISREQUIRED_OFFSET UNITYSDK_OFFSET(0x17E478C0)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_JSONNAME_OFFSET UNITYSDK_OFFSET(0x17E5BB40)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_NAME_OFFSET UNITYSDK_OFFSET(0x17E49B10)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_PROTO_OFFSET UNITYSDK_OFFSET(0x17E5BB50)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17E5A790)

namespace Google::Protobuf::Reflection
{
	inline static constexpr unsigned int FieldDescriptor_TypeDefinitionIndex = 5540;
	...
	public:
		...
		::Google::Protobuf::Reflection::FieldDescriptorProto* _Proto_k__BackingField; // 0x30
		::Google::Protobuf::Reflection::MessageDescriptor* extendeeType; // 0x38
		::System::String* _JsonName_k__BackingField; // 0x40
		::System::String* propertyName; // 0x48
		::Google::Protobuf::Reflection::OneofDescriptor* _ContainingOneof_k__BackingField; // 0x50
		::Google::Protobuf::Reflection::IFieldAccessor* accessor; // 0x58
		::Google::Protobuf::Extension* _Extension_k__BackingField; // 0x60
		::Google::Protobuf::Reflection::EnumDescriptor* enumType; // 0x68
