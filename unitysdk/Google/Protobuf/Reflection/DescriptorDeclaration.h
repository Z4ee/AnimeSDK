...
#define GOOGLE_PROTOBUF_REFLECTION_DESCRIPTORDECLARATION_FROMPROTO_OFFSET UNITYSDK_OFFSET(0x170E5EE0)
#define GOOGLE_PROTOBUF_REFLECTION_DESCRIPTORDECLARATION_GET_STARTLINE_OFFSET UNITYSDK_OFFSET(0x170E5CB0)
#define GOOGLE_PROTOBUF_REFLECTION_DESCRIPTORDECLARATION__CTOR_OFFSET UNITYSDK_OFFSET(0x170E5CC0)

namespace Google::Protobuf::Reflection
{
	inline static constexpr unsigned int DescriptorDeclaration_TypeDefinitionIndex = 6324;
	...
	public:
		...
		::System::String* _TrailingComments_k__BackingField; // 0x20
		::Google::Protobuf::Reflection::IDescriptor* _Descriptor_k__BackingField; // 0x28
		::System::Int32 _EndColumn_k__BackingField; // 0x30
		::System::Int32 _StartColumn_k__BackingField; // 0x34
		::System::Int32 _StartLine_k__BackingField; // 0x38
		::System::Int32 _EndLine_k__BackingField; // 0x3C
