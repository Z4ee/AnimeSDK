...
#define GOOGLE_PROTOBUF_REFLECTION_DESCRIPTORDECLARATION_FROMPROTO_OFFSET UNITYSDK_OFFSET(0x1B361050)
#define GOOGLE_PROTOBUF_REFLECTION_DESCRIPTORDECLARATION_GET_STARTLINE_OFFSET UNITYSDK_OFFSET(0x1B360E20)
#define GOOGLE_PROTOBUF_REFLECTION_DESCRIPTORDECLARATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B360E30)

namespace Google::Protobuf::Reflection
{
	inline static constexpr unsigned int DescriptorDeclaration_TypeDefinitionIndex = 5520;

	class DescriptorDeclaration : public ::System::Object
	{
	public:
		::System::Collections::Generic::IReadOnlyList_1<::System::String*>* _LeadingDetachedComments_k__BackingField; // 0x10
		::Google::Protobuf::Reflection::IDescriptor* _Descriptor_k__BackingField; // 0x18
		::System::String* _LeadingComments_k__BackingField; // 0x20
		::System::String* _TrailingComments_k__BackingField; // 0x28
		::System::Int32 _EndLine_k__BackingField; // 0x30
		::System::Int32 _EndColumn_k__BackingField; // 0x34
		::System::Int32 _StartColumn_k__BackingField; // 0x38
