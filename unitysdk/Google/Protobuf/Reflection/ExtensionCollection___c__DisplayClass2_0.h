...
#define GOOGLE_PROTOBUF_REFLECTION_EXTENSIONCOLLECTION___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B373400)
#define GOOGLE_PROTOBUF_REFLECTION_EXTENSIONCOLLECTION___C__DISPLAYCLASS2_0___CTOR_B__0_OFFSET UNITYSDK_OFFSET(0x1B3748F0)

namespace Google::Protobuf::Reflection
{
	inline static constexpr unsigned int ExtensionCollection___c__DisplayClass2_0_TypeDefinitionIndex = 5531;
