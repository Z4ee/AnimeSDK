...
#define GOOGLE_PROTOBUF_REFLECTION_EXTENSIONCOLLECTION_CROSSLINK_OFFSET UNITYSDK_OFFSET(0x1B373520)
#define GOOGLE_PROTOBUF_REFLECTION_EXTENSIONCOLLECTION_GET_UNORDEREDEXTENSIONS_OFFSET UNITYSDK_OFFSET(0x1B373510)
#define GOOGLE_PROTOBUF_REFLECTION_EXTENSIONCOLLECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B373410)
#define GOOGLE_PROTOBUF_REFLECTION_EXTENSIONCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B373310)
