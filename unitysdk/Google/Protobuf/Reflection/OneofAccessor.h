...
#define GOOGLE_PROTOBUF_REFLECTION_ONEOFACCESSOR_GETCASEFIELDDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17117660)
#define GOOGLE_PROTOBUF_REFLECTION_ONEOFACCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17117300)

namespace Google::Protobuf::Reflection
{
	inline static constexpr unsigned int OneofAccessor_TypeDefinitionIndex = 6352;
