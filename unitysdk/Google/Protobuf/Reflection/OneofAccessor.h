...
#define GOOGLE_PROTOBUF_REFLECTION_ONEOFACCESSOR_GETCASEFIELDDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17E774C0)
#define GOOGLE_PROTOBUF_REFLECTION_ONEOFACCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17E77160)

namespace Google::Protobuf::Reflection
{
	inline static constexpr unsigned int OneofAccessor_TypeDefinitionIndex = 5554;

	class OneofAccessor : public ::System::Object
	{
	public:
		::System::Action_1<::Google::Protobuf::IMessage*>* clearDelegate; // 0x10
		::System::Func_2<::Google::Protobuf::IMessage*, ::System::Int32>* caseDelegate; // 0x18
		::Google::Protobuf::Reflection::OneofDescriptor* descriptor; // 0x20
