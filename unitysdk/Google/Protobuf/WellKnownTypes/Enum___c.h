...
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_ENUM___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x15B2D780)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_ENUM___C__CTOR_OFFSET UNITYSDK_OFFSET(0x15B2D7C0)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_ENUM___C___CCTOR_B__45_0_OFFSET UNITYSDK_OFFSET(0x15B2D7D0)

namespace Google::Protobuf::WellKnownTypes
{
	inline static constexpr unsigned int Enum___c_TypeDefinitionIndex = 6238;
	...
	public:
		...
		{
			return (::Google::Protobuf::WellKnownTypes::Enum___c**)Il2CppClass::FromTypeDefinitionIndex(Enum___c_TypeDefinitionIndex)->GetStaticField(0xE9A0);
		}
