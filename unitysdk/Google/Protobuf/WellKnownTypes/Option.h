...
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_OPTION_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x15B337A0)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_OPTION_CLONE_OFFSET UNITYSDK_OFFSET(0x15B33170)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_OPTION_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x15B33360)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_OPTION_EQUALS_OFFSET UNITYSDK_OFFSET(0x15B33260)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_OPTION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x15B33430)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_OPTION_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x15B32E20)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_OPTION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x15B331C0)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_OPTION_GET_PARSER_OFFSET UNITYSDK_OFFSET(0x15B32DC0)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_OPTION_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x15B33240)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_OPTION_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x15B33AD0)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_OPTION_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x15B338F0)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_OPTION_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x15B32FA0)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_OPTION_SET_NAME_OFFSET UNITYSDK_OFFSET(0x15B331D0)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_OPTION_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x15B33250)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_OPTION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x15B336B0)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_OPTION_WRITETO_OFFSET UNITYSDK_OFFSET(0x15B33710)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_OPTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x15B33C30)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_OPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x15B33010)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_OPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x15B33000)

namespace Google::Protobuf::WellKnownTypes
{
	inline static constexpr unsigned int Option_TypeDefinitionIndex = 6241;
	...
	public:
		...
		{
			return (::Google::Protobuf::MessageParser_1<::Google::Protobuf::WellKnownTypes::Option*>**)Il2CppClass::FromTypeDefinitionIndex(Option_TypeDefinitionIndex)->GetStaticField(0xEBB0);
		}
