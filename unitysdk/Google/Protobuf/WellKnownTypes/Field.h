...
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x17E8D130)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_CLONE_OFFSET UNITYSDK_OFFSET(0x17E8C6B0)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x17E8C980)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_EQUALS_OFFSET UNITYSDK_OFFSET(0x17E8C920)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x17E8CB10)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_GET_CARDINALITY_OFFSET UNITYSDK_OFFSET(0x17E8C720)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_GET_DEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x17E8C8C0)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17E8C270)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_GET_JSONNAME_OFFSET UNITYSDK_OFFSET(0x17E8C860)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_GET_KIND_OFFSET UNITYSDK_OFFSET(0x17E8C700)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_GET_NAME_OFFSET UNITYSDK_OFFSET(0x17E8C760)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_GET_NUMBER_OFFSET UNITYSDK_OFFSET(0x17E8C740)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_GET_ONEOFINDEX_OFFSET UNITYSDK_OFFSET(0x17E8C820)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_GET_PACKED_OFFSET UNITYSDK_OFFSET(0x17E8C840)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_GET_PARSER_OFFSET UNITYSDK_OFFSET(0x17E8C210)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_GET_TYPEURL_OFFSET UNITYSDK_OFFSET(0x17E8C7C0)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x17E8DA70)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x17E8D860)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x17E8C3F0)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_SET_CARDINALITY_OFFSET UNITYSDK_OFFSET(0x17E8C730)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_SET_DEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x17E8C8D0)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_SET_JSONNAME_OFFSET UNITYSDK_OFFSET(0x17E8C870)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_SET_KIND_OFFSET UNITYSDK_OFFSET(0x17E8C710)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_SET_NAME_OFFSET UNITYSDK_OFFSET(0x17E8C770)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_SET_NUMBER_OFFSET UNITYSDK_OFFSET(0x17E8C750)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_SET_ONEOFINDEX_OFFSET UNITYSDK_OFFSET(0x17E8C830)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_SET_PACKED_OFFSET UNITYSDK_OFFSET(0x17E8C850)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_SET_TYPEURL_OFFSET UNITYSDK_OFFSET(0x17E8C7D0)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17E8CE10)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_WRITETO_OFFSET UNITYSDK_OFFSET(0x17E8CE70)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD__CCTOR_OFFSET UNITYSDK_OFFSET(0x17E8DD20)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17E8C4D0)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x17E8C450)

namespace Google::Protobuf::WellKnownTypes
{
	inline static constexpr unsigned int Field_TypeDefinitionIndex = 5444;
	...
	public:
		...
		{
			return (::Google::Protobuf::FieldCodec_1<::Google::Protobuf::WellKnownTypes::Option*>**)Il2CppClass::FromTypeDefinitionIndex(Field_TypeDefinitionIndex)->GetStaticField(0x42C20);
		}
		static ::Google::Protobuf::MessageParser_1<::Google::Protobuf::WellKnownTypes::Field*>** StaticGet__parser()
		{
			return (::Google::Protobuf::MessageParser_1<::Google::Protobuf::WellKnownTypes::Field*>**)Il2CppClass::FromTypeDefinitionIndex(Field_TypeDefinitionIndex)->GetStaticField(0x42C28);
		}
