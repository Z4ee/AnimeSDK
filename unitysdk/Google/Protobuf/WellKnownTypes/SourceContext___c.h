...
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_SOURCECONTEXT___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DBC7920)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_SOURCECONTEXT___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1DBC7960)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_SOURCECONTEXT___C___CCTOR_B__25_0_OFFSET UNITYSDK_OFFSET(0x1DBC7970)
...
namespace Google::Protobuf::WellKnownTypes
{
	...
	public:
		...
		{
			return (::Google::Protobuf::WellKnownTypes::SourceContext___c**)Il2CppClass::FromTypeDefinitionIndex(SourceContext___c_TypeDefinitionIndex)->GetStaticField(0x190B0);
		}
