...
#define CLASS_2_D41B3B8D4D2B16E7_METHOD_2_98FE8344617B99D4_OFFSET UNITYSDK_OFFSET(0x16435BA0)
#define CLASS_2_D41B3B8D4D2B16E7__CTOR_OFFSET UNITYSDK_OFFSET(0x16435C40)

inline static constexpr unsigned int Class_2_D41B3B8D4D2B16E7_TypeDefinitionIndex = 77206;

class Class_2_D41B3B8D4D2B16E7 : public ::Class_1_43BD383C98B4C0C5_213
{
public:
	::RPG::GameCore::ChimeraDuelDitherOutNode* EABKOHGCHFP; // 0x10
