...
#define CLASS_1_8911FA5FAA0406FB_GET_DEPENDENCY_OFFSET UNITYSDK_OFFSET(0x11684960)
#define CLASS_1_8911FA5FAA0406FB_METHOD_1_2FA6CEE70ABB60EF_OFFSET UNITYSDK_OFFSET(0x11684710)
#define CLASS_1_8911FA5FAA0406FB_METHOD_1_90A9DC77F6A1323B_OFFSET UNITYSDK_OFFSET(0x11684910)
#define CLASS_1_8911FA5FAA0406FB_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x116848C0)
#define CLASS_1_8911FA5FAA0406FB_METHOD_1_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x11684760)
#define CLASS_1_8911FA5FAA0406FB_SET_DEPENDENCY_OFFSET UNITYSDK_OFFSET(0x11684970)
#define CLASS_1_8911FA5FAA0406FB__CTOR_1_OFFSET UNITYSDK_OFFSET(0x11684700)
#define CLASS_1_8911FA5FAA0406FB__CTOR_OFFSET UNITYSDK_OFFSET(0x116846A0)

inline static constexpr unsigned int Class_1_8911FA5FAA0406FB_TypeDefinitionIndex = 45450;

class Class_1_8911FA5FAA0406FB : public ::System::Object
{
public:
	::Il2CppArray<::System::String*>* _Dependency_k__BackingField; // 0x10
	::System::String* Field_1_2; // 0x18
	::RPG::GameCore::TurnBasedModifierConfig* Field_1_1; // 0x20
