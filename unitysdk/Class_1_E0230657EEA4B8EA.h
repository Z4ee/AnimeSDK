...
#define CLASS_1_E0230657EEA4B8EA_METHOD_1_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x1643CE30)
#define CLASS_1_E0230657EEA4B8EA_METHOD_1_1AF2DA66CAEEB938_OFFSET UNITYSDK_OFFSET(0x1643B490)
#define CLASS_1_E0230657EEA4B8EA_METHOD_1_2C6EBE7C20E87B94_OFFSET UNITYSDK_OFFSET(0x1643ACA0)
#define CLASS_1_E0230657EEA4B8EA_METHOD_1_5FAD56E9E208220A_OFFSET UNITYSDK_OFFSET(0x1643B070)
#define CLASS_1_E0230657EEA4B8EA_METHOD_1_6424D2B0A912F983_OFFSET UNITYSDK_OFFSET(0x1643C610)
#define CLASS_1_E0230657EEA4B8EA_METHOD_1_70764F01A4DBCF8A_OFFSET UNITYSDK_OFFSET(0x1643D360)
#define CLASS_1_E0230657EEA4B8EA_METHOD_1_9BAB385F8658C2AD_OFFSET UNITYSDK_OFFSET(0x1643B2A0)
#define CLASS_1_E0230657EEA4B8EA_METHOD_1_A411300876E69F5E_OFFSET UNITYSDK_OFFSET(0x1643CFF0)
#define CLASS_1_E0230657EEA4B8EA_METHOD_1_F7721D0B419638BB_OFFSET UNITYSDK_OFFSET(0x1643C290)
#define CLASS_1_E0230657EEA4B8EA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1643DA90)
#define CLASS_1_E0230657EEA4B8EA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1643AEC0)
#define CLASS_1_E0230657EEA4B8EA__CTOR_OFFSET UNITYSDK_OFFSET(0x1643AD10)

inline static constexpr unsigned int Class_1_E0230657EEA4B8EA_TypeDefinitionIndex = 49579;

class Class_1_E0230657EEA4B8EA : public ::System::Object
{
public:
	static ::System::String** StaticGet_BKDPIGHCNGD()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E0230657EEA4B8EA_TypeDefinitionIndex)->GetStaticField(0x64B60);
	}
	static ::System::String** StaticGet_JALLELCCGMH()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E0230657EEA4B8EA_TypeDefinitionIndex)->GetStaticField(0x64B68);
	}
	static ::System::String** StaticGet_OMEDIECPPNI()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E0230657EEA4B8EA_TypeDefinitionIndex)->GetStaticField(0x64B70);
	}
	::System::String* PFCGLCPIMIN; // 0x10
	::Class_1_C01CD724E4B5E41C* BIKKABLFFIM; // 0x18
	::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::String*>* BAHADOKJIPI; // 0x20
	::Class_1_C01CD724E4B5E41C* NHGMGHBIIDI; // 0x28
