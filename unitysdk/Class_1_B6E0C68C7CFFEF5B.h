...
#define CLASS_1_B6E0C68C7CFFEF5B_GET_ISBOSSPANEL_OFFSET UNITYSDK_OFFSET(0x16D8E330)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_086772AC32D6BFC9_OFFSET UNITYSDK_OFFSET(0x16D8D340)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_17F22C055863E893_1_OFFSET UNITYSDK_OFFSET(0x16D8D240)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_17F22C055863E893_2_OFFSET UNITYSDK_OFFSET(0x16D8D2C0)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_17F22C055863E893_OFFSET UNITYSDK_OFFSET(0x16D8D1C0)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x16D8D160)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_2DB9E513187D6683_OFFSET UNITYSDK_OFFSET(0x16D8D560)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_30E7533A487BD75C_OFFSET UNITYSDK_OFFSET(0x16D8D450)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_3845AD389B8E1E47_OFFSET UNITYSDK_OFFSET(0x16D8E1C0)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x16D8CED0)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_4011FDBF39CB0C46_OFFSET UNITYSDK_OFFSET(0x16D8DB30)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_4AADAF19CDCB660E_OFFSET UNITYSDK_OFFSET(0x16D8D6A0)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_4EC2E1ECDEE1B9F2_OFFSET UNITYSDK_OFFSET(0x16D8D0C0)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_4F1BE5A08CA439DD_OFFSET UNITYSDK_OFFSET(0x16D8DC30)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_5DB6CF4A7180BD76_OFFSET UNITYSDK_OFFSET(0x16D8DDE0)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_8A76897D6A693475_OFFSET UNITYSDK_OFFSET(0x16D8D850)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_9214CA70E05AF534_OFFSET UNITYSDK_OFFSET(0x16D8D960)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_C51E1F14BC0C7341_OFFSET UNITYSDK_OFFSET(0x16D8CFE0)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_CA033AD137D88B69_OFFSET UNITYSDK_OFFSET(0x16D8DEA0)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x16D8CF90)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_D14D1C669EDC2D6B_OFFSET UNITYSDK_OFFSET(0x16D8D3A0)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_DA5597481994D152_OFFSET UNITYSDK_OFFSET(0x16D8DAD0)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_DE23CE986C1A1789_OFFSET UNITYSDK_OFFSET(0x16D8CE60)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_E2A306C5DD2FB440_OFFSET UNITYSDK_OFFSET(0x16D8DBB0)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_EBBD06DFB7C23A9A_OFFSET UNITYSDK_OFFSET(0x16D8E130)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_EDE51B31CB05573F_OFFSET UNITYSDK_OFFSET(0x16D8CF20)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_F026F9F94BAA5E1F_OFFSET UNITYSDK_OFFSET(0x16D8DA70)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_F31F0AC82813D7EB_1_OFFSET UNITYSDK_OFFSET(0x16D8D7E0)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_F31F0AC82813D7EB_OFFSET UNITYSDK_OFFSET(0x16D8D770)
#define CLASS_1_B6E0C68C7CFFEF5B_METHOD_1_F941B64ADF94EB92_OFFSET UNITYSDK_OFFSET(0x16D8DCB0)
#define CLASS_1_B6E0C68C7CFFEF5B_SET_ISBOSSPANEL_OFFSET UNITYSDK_OFFSET(0x16D8E340)
#define CLASS_1_B6E0C68C7CFFEF5B__CCTOR_OFFSET UNITYSDK_OFFSET(0x16D8E350)
#define CLASS_1_B6E0C68C7CFFEF5B__CTOR_OFFSET UNITYSDK_OFFSET(0x16D8CEC0)

inline static constexpr unsigned int Class_1_B6E0C68C7CFFEF5B_TypeDefinitionIndex = 71723;

class Class_1_B6E0C68C7CFFEF5B : public ::System::Object
{
public:
	static ::System::Collections::Generic::List_1<::RPG::GameCore::MonsterWeaknessSpecialType>** StaticGet_AJNDMKNCKHE()
	{
		return (::System::Collections::Generic::List_1<::RPG::GameCore::MonsterWeaknessSpecialType>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B6E0C68C7CFFEF5B_TypeDefinitionIndex)->GetStaticField(0x62400);
	}
	::RPG::GameCore::GameEntity* KAKEIDJDNHJ; // 0x10
	::RPG::GameCore::LevelUIComponent* FGCIJADADDA; // 0x18
	::RPG::GameCore::TurnBasedAbilityComponent* PEPAJDNHBNF; // 0x20
