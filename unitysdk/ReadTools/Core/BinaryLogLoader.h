...
#define READTOOLS_CORE_BINARYLOGLOADER_ONSERIALIZEDUNIT_OFFSET UNITYSDK_OFFSET(0x1E231560)
#define READTOOLS_CORE_BINARYLOGLOADER_TRYGETLOGMETA_OFFSET UNITYSDK_OFFSET(0x1E22B080)
#define READTOOLS_CORE_BINARYLOGLOADER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E2313C0)
#define READTOOLS_CORE_BINARYLOGLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E231400)

namespace ReadTools::Core
{
	inline static constexpr unsigned int BinaryLogLoader_TypeDefinitionIndex = 33971;
