...
#define CLASS_1_5B567C8A01BAEDFE_311_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DE1F730)
#define CLASS_1_5B567C8A01BAEDFE_311_CLONE_OFFSET UNITYSDK_OFFSET(0x1DE1F420)
#define CLASS_1_5B567C8A01BAEDFE_311_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DE1F530)
#define CLASS_1_5B567C8A01BAEDFE_311_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DE1F460)
#define CLASS_1_5B567C8A01BAEDFE_311_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DE1F690)
#define CLASS_1_5B567C8A01BAEDFE_311_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DE1F780)
#define CLASS_1_5B567C8A01BAEDFE_311_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DE1F750)
#define CLASS_1_5B567C8A01BAEDFE_311_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1DE1F3A0)
#define CLASS_1_5B567C8A01BAEDFE_311_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DE1F3D0)
#define CLASS_1_5B567C8A01BAEDFE_311_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DE1F6C0)
#define CLASS_1_5B567C8A01BAEDFE_311_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DE1F720)
#define CLASS_1_5B567C8A01BAEDFE_311__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DE1F7D0)
#define CLASS_1_5B567C8A01BAEDFE_311__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DE1F3F0)
#define CLASS_1_5B567C8A01BAEDFE_311__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE1F3E0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_311_TypeDefinitionIndex = 32887;

class Class_1_5B567C8A01BAEDFE_311 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_311*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_311*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_311_TypeDefinitionIndex)->GetStaticField(0x5DC60);
	}
