...
#define CLASS_1_5B567C8A01BAEDFE_311_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19680650)
#define CLASS_1_5B567C8A01BAEDFE_311_CLONE_OFFSET UNITYSDK_OFFSET(0x196804C0)
#define CLASS_1_5B567C8A01BAEDFE_311_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19680560)
#define CLASS_1_5B567C8A01BAEDFE_311_EQUALS_OFFSET UNITYSDK_OFFSET(0x19680500)
#define CLASS_1_5B567C8A01BAEDFE_311_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x196805B0)
#define CLASS_1_5B567C8A01BAEDFE_311_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x196806A0)
#define CLASS_1_5B567C8A01BAEDFE_311_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19680670)
#define CLASS_1_5B567C8A01BAEDFE_311_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19680440)
#define CLASS_1_5B567C8A01BAEDFE_311_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19680470)
#define CLASS_1_5B567C8A01BAEDFE_311_TOSTRING_OFFSET UNITYSDK_OFFSET(0x196805E0)
#define CLASS_1_5B567C8A01BAEDFE_311_WRITETO_OFFSET UNITYSDK_OFFSET(0x19680640)
#define CLASS_1_5B567C8A01BAEDFE_311__CCTOR_OFFSET UNITYSDK_OFFSET(0x196806F0)
#define CLASS_1_5B567C8A01BAEDFE_311__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19680490)
#define CLASS_1_5B567C8A01BAEDFE_311__CTOR_OFFSET UNITYSDK_OFFSET(0x19680480)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_311_TypeDefinitionIndex = 31362;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_311*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_311_TypeDefinitionIndex)->GetStaticField(0x1AAD0);
	}
