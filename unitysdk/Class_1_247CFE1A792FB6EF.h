...
#define CLASS_1_247CFE1A792FB6EF_GETFIGHTSTATECONFIG_OFFSET UNITYSDK_OFFSET(0xECBD390)
#define CLASS_1_247CFE1A792FB6EF_INIT_OFFSET UNITYSDK_OFFSET(0xECBD3D0)
#define CLASS_1_247CFE1A792FB6EF_REFRESH_OFFSET UNITYSDK_OFFSET(0xECBD440)
#define CLASS_1_247CFE1A792FB6EF_RESET_OFFSET UNITYSDK_OFFSET(0xECBD550)
#define CLASS_1_247CFE1A792FB6EF__CTOR_OFFSET UNITYSDK_OFFSET(0xECBD6A0)

inline static constexpr unsigned int Class_1_247CFE1A792FB6EF_TypeDefinitionIndex = 64140;

class Class_1_247CFE1A792FB6EF : public ::System::Object
{
public:
	::Class_2_5D178EC982C80153* Field_1_0; // 0x10
	::RPG::Client::CameraFightStateCommonConfig* Field_1_2; // 0x18
