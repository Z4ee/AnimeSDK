...
#define CLASS_1_64A9C64835CF029E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1896EDF0)
#define CLASS_1_64A9C64835CF029E_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x1896EF60)
#define CLASS_1_64A9C64835CF029E_METHOD_1_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0x1896EFC0)
#define CLASS_1_64A9C64835CF029E_METHOD_1_B9B71AEDC43C03F6_OFFSET UNITYSDK_OFFSET(0x1896EDB0)
#define CLASS_1_64A9C64835CF029E__CTOR_OFFSET UNITYSDK_OFFSET(0x1896E9E0)

inline static constexpr unsigned int Class_1_64A9C64835CF029E_TypeDefinitionIndex = 74090;

class Class_1_64A9C64835CF029E : public ::System::Object
{
public:
	::RPG::Client::ParkourGame::EffectConfig EABKOHGCHFP; // 0x10
	::System::Func_1<::System::Boolean>* PDHKKDGOBEL; // 0x38
	::System::String* GFNAPNFFGPJ; // 0x40
	::Struct_2_0B84ADD7815498A2 FMJPMFEDIJL; // 0x48
