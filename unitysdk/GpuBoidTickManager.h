...
#define GPUBOIDTICKMANAGER_ALLPOINTSOUTSIDEPLANEAABB_OFFSET UNITYSDK_OFFSET(0x1967C860)
#define GPUBOIDTICKMANAGER_FRUSTUMCULLED_OFFSET UNITYSDK_OFFSET(0x1967C480)
#define GPUBOIDTICKMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1967BD90)
#define GPUBOIDTICKMANAGER_REGISTER_OFFSET UNITYSDK_OFFSET(0x1967BF90)
#define GPUBOIDTICKMANAGER_UNREGISTER_OFFSET UNITYSDK_OFFSET(0x1967C020)
#define GPUBOIDTICKMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1967C0B0)
#define GPUBOIDTICKMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1967CA80)
#define GPUBOIDTICKMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1967BEE0)

inline static constexpr unsigned int GpuBoidTickManager_TypeDefinitionIndex = 29540;
...
public:
	...
	{
		return (::GpuBoidTickManager**)Il2CppClass::FromTypeDefinitionIndex(GpuBoidTickManager_TypeDefinitionIndex)->GetStaticField(0x247F0);
	}
	...
	::Il2CppArray<::UnityEngine::Vector3>* points; // 0x20
