...
#define CLASS_2_5203B21EF18DD167_DISPOSE_OFFSET UNITYSDK_OFFSET(0x167A95C0)
#define CLASS_2_5203B21EF18DD167_METHOD_2_20A698DC0CFFEC8A_1_OFFSET UNITYSDK_OFFSET(0x167A9DF0)
#define CLASS_2_5203B21EF18DD167_METHOD_2_20A698DC0CFFEC8A_OFFSET UNITYSDK_OFFSET(0x167A99C0)
#define CLASS_2_5203B21EF18DD167_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x167A9050)
#define CLASS_2_5203B21EF18DD167_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x167A9320)
#define CLASS_2_5203B21EF18DD167_TICK_OFFSET UNITYSDK_OFFSET(0x167AA220)
#define CLASS_2_5203B21EF18DD167__CTOR_OFFSET UNITYSDK_OFFSET(0x167A8E80)
...
public:
	...
	::Class_3_07C3C4D2990C49EE* KPMOLCKCBHO; // 0x20
	::Class_3_07C3C4D2990C49EE* FPNIMFDENKJ; // 0x28
	::RPG::GameCore::EntityOnEraFlippedListener* IGHAHBNLIJA; // 0x30
	::Class_3_07C3C4D2990C49EE* KFMEEBGHGMF; // 0x38
	::Class_3_07C3C4D2990C49EE* NPOIKFJCHJL; // 0x40
