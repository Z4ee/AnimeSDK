...
#define CLASS_3_4C10A2521611B0C6_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x128AE230)
#define CLASS_3_4C10A2521611B0C6_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x128AE430)
#define CLASS_3_4C10A2521611B0C6_TICK_OFFSET UNITYSDK_OFFSET(0x128AE3D0)
#define CLASS_3_4C10A2521611B0C6__CTOR_OFFSET UNITYSDK_OFFSET(0x128AE200)
#define CLASS_3_4C10A2521611B0C6___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x128AE4A0)

inline static constexpr unsigned int Class_3_4C10A2521611B0C6_TypeDefinitionIndex = 48269;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + CLASS_3_4C10A2521611B0C6___IFIXBASEPROXY_TICK_OFFSET))(this, P0);
	}
};
