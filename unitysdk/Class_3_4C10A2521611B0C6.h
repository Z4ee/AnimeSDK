...
#define CLASS_3_4C10A2521611B0C6_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xA745270)
#define CLASS_3_4C10A2521611B0C6_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xA745470)
#define CLASS_3_4C10A2521611B0C6_TICK_OFFSET UNITYSDK_OFFSET(0xA745410)
#define CLASS_3_4C10A2521611B0C6__CTOR_OFFSET UNITYSDK_OFFSET(0xA745240)
#define CLASS_3_4C10A2521611B0C6___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xA7454E0)

inline static constexpr unsigned int Class_3_4C10A2521611B0C6_TypeDefinitionIndex = 48893;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + CLASS_3_4C10A2521611B0C6___IFIXBASEPROXY_TICK_OFFSET))(this, a1);
	}
};
