...
#define SHADERANIHELP_AWAKE_OFFSET UNITYSDK_OFFSET(0x1682DE90)
#define SHADERANIHELP_GETISPLAYINGANDNOTPREFAB_OFFSET UNITYSDK_OFFSET(0x1682DE40)
#define SHADERANIHELP_INIT_OFFSET UNITYSDK_OFFSET(0x1682EA60)
#define SHADERANIHELP_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x16830BB0)
#define SHADERANIHELP_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x16830640)
#define SHADERANIHELP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1682E7A0)
#define SHADERANIHELP_ONGRAPHICMATERIALCHANGEHANDLE_OFFSET UNITYSDK_OFFSET(0x16830B00)
#define SHADERANIHELP_ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x16830B50)
#define SHADERANIHELP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x16830DA0)
#define SHADERANIHELP_PRECHECKFIELDS_OFFSET UNITYSDK_OFFSET(0x1682E210)
#define SHADERANIHELP_REFLESH_OFFSET UNITYSDK_OFFSET(0x1682EAA0)
#define SHADERANIHELP_UPDATEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1682DA90)
#define SHADERANIHELP__CTOR_OFFSET UNITYSDK_OFFSET(0x16830DF0)

inline static constexpr unsigned int ShaderAniHelp_TypeDefinitionIndex = 59881;
