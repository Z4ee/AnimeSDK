...
#define SHADERANIHELP_AWAKE_OFFSET UNITYSDK_OFFSET(0x1D5CE350)
#define SHADERANIHELP_GETISPLAYINGANDNOTPREFAB_OFFSET UNITYSDK_OFFSET(0x1D5CE300)
#define SHADERANIHELP_INIT_OFFSET UNITYSDK_OFFSET(0x1D5CEF20)
#define SHADERANIHELP_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1D5D1070)
#define SHADERANIHELP_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1D5D0B00)
#define SHADERANIHELP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D5CEC60)
#define SHADERANIHELP_ONGRAPHICMATERIALCHANGEHANDLE_OFFSET UNITYSDK_OFFSET(0x1D5D0FC0)
#define SHADERANIHELP_ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1D5D1010)
#define SHADERANIHELP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1D5D1260)
#define SHADERANIHELP_PRECHECKFIELDS_OFFSET UNITYSDK_OFFSET(0x1D5CE6D0)
#define SHADERANIHELP_REFLESH_OFFSET UNITYSDK_OFFSET(0x1D5CEF60)
#define SHADERANIHELP_UPDATEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1D5CDF50)
#define SHADERANIHELP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5D12B0)

inline static constexpr unsigned int ShaderAniHelp_TypeDefinitionIndex = 49233;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + SHADERANIHELP_ONLATEUPDATE_OFFSET))(this);
	}
