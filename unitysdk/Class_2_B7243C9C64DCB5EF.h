...
#define CLASS_2_B7243C9C64DCB5EF_METHOD_2_324AEE341AAA7A1B_1_OFFSET UNITYSDK_OFFSET(0xE92C220)
#define CLASS_2_B7243C9C64DCB5EF_METHOD_2_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0xE92C200)
#define CLASS_2_B7243C9C64DCB5EF_METHOD_2_E5E342154D4EA5F5_OFFSET UNITYSDK_OFFSET(0xE92C210)
#define CLASS_2_B7243C9C64DCB5EF_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0xE92C100)
#define CLASS_2_B7243C9C64DCB5EF_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0xE92C190)
#define CLASS_2_B7243C9C64DCB5EF_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xE92BB80)
#define CLASS_2_B7243C9C64DCB5EF__CTOR_OFFSET UNITYSDK_OFFSET(0xE92C1F0)

inline static constexpr unsigned int Class_2_B7243C9C64DCB5EF_TypeDefinitionIndex = 61037;
