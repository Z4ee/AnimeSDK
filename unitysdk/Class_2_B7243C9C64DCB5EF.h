...
#define CLASS_2_B7243C9C64DCB5EF_METHOD_2_324AEE341AAA7A1B_1_OFFSET UNITYSDK_OFFSET(0x100817D0)
#define CLASS_2_B7243C9C64DCB5EF_METHOD_2_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x100817C0)
#define CLASS_2_B7243C9C64DCB5EF_METHOD_2_E5E342154D4EA5F5_OFFSET UNITYSDK_OFFSET(0x100817E0)
#define CLASS_2_B7243C9C64DCB5EF_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0x100816C0)
#define CLASS_2_B7243C9C64DCB5EF_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0x10081750)
#define CLASS_2_B7243C9C64DCB5EF_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x10081140)
#define CLASS_2_B7243C9C64DCB5EF__CTOR_OFFSET UNITYSDK_OFFSET(0x100817B0)

inline static constexpr unsigned int Class_2_B7243C9C64DCB5EF_TypeDefinitionIndex = 50293;

class Class_2_B7243C9C64DCB5EF : public ::UnityEngine::Playables::PlayableBehaviour
{
public:
	::Class_2_B7243C9C64DCB5EF_Class_0_16E7307DCC43CB2C_6* Field_2_0; // 0x10
