...
#define CLASS_1_A0C0ADCC8A5FDABE_GET_AVATAR_OFFSET UNITYSDK_OFFSET(0x179E5E80)
#define CLASS_1_A0C0ADCC8A5FDABE_GET_PLANDATA_OFFSET UNITYSDK_OFFSET(0x179E5ED0)
#define CLASS_1_A0C0ADCC8A5FDABE_GET_PLANEXTRASCORECALCULATOR_OFFSET UNITYSDK_OFFSET(0x179E5F40)
#define CLASS_1_A0C0ADCC8A5FDABE_GET_RELICSCORECALCULATOR_OFFSET UNITYSDK_OFFSET(0x179E5F20)
#define CLASS_1_A0C0ADCC8A5FDABE_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x179E5DD0)
#define CLASS_1_A0C0ADCC8A5FDABE_METHOD_1_603A483075EE5BAE_OFFSET UNITYSDK_OFFSET(0x179E5E20)
#define CLASS_1_A0C0ADCC8A5FDABE_METHOD_1_97152911748E4B77_OFFSET UNITYSDK_OFFSET(0x179E5FE0)
#define CLASS_1_A0C0ADCC8A5FDABE_METHOD_1_E9A575D18A0748D9_1_OFFSET UNITYSDK_OFFSET(0x179E6080)
#define CLASS_1_A0C0ADCC8A5FDABE_METHOD_1_E9A575D18A0748D9_OFFSET UNITYSDK_OFFSET(0x179E6030)
#define CLASS_1_A0C0ADCC8A5FDABE_METHOD_1_FAB076F9C2EDE3BE_OFFSET UNITYSDK_OFFSET(0x179E5F60)
#define CLASS_1_A0C0ADCC8A5FDABE_SET_PLANEXTRASCORECALCULATOR_OFFSET UNITYSDK_OFFSET(0x179E5F50)
#define CLASS_1_A0C0ADCC8A5FDABE_SET_RELICSCORECALCULATOR_OFFSET UNITYSDK_OFFSET(0x179E5F30)
#define CLASS_1_A0C0ADCC8A5FDABE__CTOR_OFFSET UNITYSDK_OFFSET(0x179E5FD0)

inline static constexpr unsigned int Class_1_A0C0ADCC8A5FDABE_TypeDefinitionIndex = 74340;

class Class_1_A0C0ADCC8A5FDABE : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::RPG::Client::RelicItemData*>* APDCBJCDALM; // 0x10
	::Class_1_52F4A47C29C64CBB* GANLOCFFMEF; // 0x18
