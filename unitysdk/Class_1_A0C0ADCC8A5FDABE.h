...
#define CLASS_1_A0C0ADCC8A5FDABE_GET_AVATAR_OFFSET UNITYSDK_OFFSET(0x16EE3DB0)
#define CLASS_1_A0C0ADCC8A5FDABE_GET_PLANDATA_OFFSET UNITYSDK_OFFSET(0x16EE3E00)
#define CLASS_1_A0C0ADCC8A5FDABE_GET_PLANEXTRASCORECALCULATOR_OFFSET UNITYSDK_OFFSET(0x16EE3E70)
#define CLASS_1_A0C0ADCC8A5FDABE_GET_RELICSCORECALCULATOR_OFFSET UNITYSDK_OFFSET(0x16EE3E50)
#define CLASS_1_A0C0ADCC8A5FDABE_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x16EE3D00)
#define CLASS_1_A0C0ADCC8A5FDABE_METHOD_1_603A483075EE5BAE_OFFSET UNITYSDK_OFFSET(0x16EE3D50)
#define CLASS_1_A0C0ADCC8A5FDABE_METHOD_1_97152911748E4B77_OFFSET UNITYSDK_OFFSET(0x16EE3F10)
#define CLASS_1_A0C0ADCC8A5FDABE_METHOD_1_E9A575D18A0748D9_1_OFFSET UNITYSDK_OFFSET(0x16EE3FB0)
#define CLASS_1_A0C0ADCC8A5FDABE_METHOD_1_E9A575D18A0748D9_OFFSET UNITYSDK_OFFSET(0x16EE3F60)
#define CLASS_1_A0C0ADCC8A5FDABE_METHOD_1_FAB076F9C2EDE3BE_OFFSET UNITYSDK_OFFSET(0x16EE3E90)
#define CLASS_1_A0C0ADCC8A5FDABE_SET_PLANEXTRASCORECALCULATOR_OFFSET UNITYSDK_OFFSET(0x16EE3E80)
#define CLASS_1_A0C0ADCC8A5FDABE_SET_RELICSCORECALCULATOR_OFFSET UNITYSDK_OFFSET(0x16EE3E60)
#define CLASS_1_A0C0ADCC8A5FDABE__CTOR_OFFSET UNITYSDK_OFFSET(0x16EE3F00)

inline static constexpr unsigned int Class_1_A0C0ADCC8A5FDABE_TypeDefinitionIndex = 71041;
...
public:
	...
	::Class_1_1F9F8375E16328FE* _PlanExtraScoreCalculator_k__BackingField; // 0x18
	::Class_1_61CCFA89E19EDD2D* _RelicScoreCalculator_k__BackingField; // 0x20
	::Class_1_52F4A47C29C64CBB* Field_1_3; // 0x28
