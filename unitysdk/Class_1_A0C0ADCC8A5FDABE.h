...
#define CLASS_1_A0C0ADCC8A5FDABE_GET_AVATAR_OFFSET UNITYSDK_OFFSET(0x154CF6D0)
#define CLASS_1_A0C0ADCC8A5FDABE_GET_PLANDATA_OFFSET UNITYSDK_OFFSET(0x154CF720)
#define CLASS_1_A0C0ADCC8A5FDABE_GET_PLANEXTRASCORECALCULATOR_OFFSET UNITYSDK_OFFSET(0x154CF790)
#define CLASS_1_A0C0ADCC8A5FDABE_GET_RELICSCORECALCULATOR_OFFSET UNITYSDK_OFFSET(0x154CF770)
#define CLASS_1_A0C0ADCC8A5FDABE_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x154CF620)
#define CLASS_1_A0C0ADCC8A5FDABE_METHOD_1_603A483075EE5BAE_OFFSET UNITYSDK_OFFSET(0x154CF670)
#define CLASS_1_A0C0ADCC8A5FDABE_METHOD_1_97152911748E4B77_OFFSET UNITYSDK_OFFSET(0x154CF830)
#define CLASS_1_A0C0ADCC8A5FDABE_METHOD_1_E9A575D18A0748D9_1_OFFSET UNITYSDK_OFFSET(0x154CF8D0)
#define CLASS_1_A0C0ADCC8A5FDABE_METHOD_1_E9A575D18A0748D9_OFFSET UNITYSDK_OFFSET(0x154CF880)
#define CLASS_1_A0C0ADCC8A5FDABE_METHOD_1_FAB076F9C2EDE3BE_OFFSET UNITYSDK_OFFSET(0x154CF7B0)
#define CLASS_1_A0C0ADCC8A5FDABE_SET_PLANEXTRASCORECALCULATOR_OFFSET UNITYSDK_OFFSET(0x154CF7A0)
#define CLASS_1_A0C0ADCC8A5FDABE_SET_RELICSCORECALCULATOR_OFFSET UNITYSDK_OFFSET(0x154CF780)
#define CLASS_1_A0C0ADCC8A5FDABE__CTOR_OFFSET UNITYSDK_OFFSET(0x154CF820)

inline static constexpr unsigned int Class_1_A0C0ADCC8A5FDABE_TypeDefinitionIndex = 74341;

class Class_1_A0C0ADCC8A5FDABE : public ::System::Object
{
public:
	::Class_1_61CCFA89E19EDD2D* _RelicScoreCalculator_k__BackingField; // 0x10
	::System::Collections::Generic::List_1<::RPG::Client::RelicItemData*>* APDCBJCDALM; // 0x18
	::Class_1_52F4A47C29C64CBB* GANLOCFFMEF; // 0x20
	::Class_1_1F9F8375E16328FE* _PlanExtraScoreCalculator_k__BackingField; // 0x28

	::System::Void _ctor(::Class_1_52F4A47C29C64CBB* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_52F4A47C29C64CBB*))((::PBYTE)hIl2Cpp + CLASS_1_A0C0ADCC8A5FDABE__CTOR_OFFSET))(this, a1);
	}
	...
	static ::Class_1_A0C0ADCC8A5FDABE* Method_1_FAB076F9C2EDE3BE(::Class_1_52F4A47C29C64CBB* a1)
	{
		return ((::Class_1_A0C0ADCC8A5FDABE*(*)(::Class_1_52F4A47C29C64CBB*))((::PBYTE)hIl2Cpp + CLASS_1_A0C0ADCC8A5FDABE_METHOD_1_FAB076F9C2EDE3BE_OFFSET))(a1);
	}
