...
#define CLASS_1_AC5917224CA07AC1_METHOD_1_0131B28D046A5D7C_OFFSET UNITYSDK_OFFSET(0x1C8C5C30)
#define CLASS_1_AC5917224CA07AC1__CTOR_OFFSET UNITYSDK_OFFSET(0x1C8C5EC0)

inline static constexpr unsigned int Class_1_AC5917224CA07AC1_TypeDefinitionIndex = 13671;

class Class_1_AC5917224CA07AC1 : public ::System::Object
{
public:
	::RPG::GameCore::FixPoint AAGBLKOLIGF; // 0x10
	::RPG::GameCore::FixPoint OEELKOMPNIM; // 0x18
	::RPG::GameCore::FixPoint IAEADDEKAAB; // 0x20
	::RPG::GameCore::FixPoint PEDFLGGDHDP; // 0x28
