...
#define CLASS_1_8D80FEF923501A99_1_METHOD_1_FA4D4EF9EFA7D38E_OFFSET UNITYSDK_OFFSET(0x18B65BC0)
#define CLASS_1_8D80FEF923501A99_1_START_OFFSET UNITYSDK_OFFSET(0x18B65AD0)
#define CLASS_1_8D80FEF923501A99_1_STOP_OFFSET UNITYSDK_OFFSET(0x18B65B60)
#define CLASS_1_8D80FEF923501A99_1__CTOR_OFFSET UNITYSDK_OFFSET(0x18B65A50)

inline static constexpr unsigned int Class_1_8D80FEF923501A99_1_TypeDefinitionIndex = 79439;

class Class_1_8D80FEF923501A99_1 : public ::System::Object
{
public:
	::Class_0_16E4307DCC419505_1343* LBNAGLIGKIO; // 0x10
	::Class_1_5F4D64A4B97E38F9* GJALMBBNNOF; // 0x18

	::System::Void _ctor(::Class_0_16E4307DCC419505_1343* a1, ::Class_1_5F4D64A4B97E38F9* a2)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_1343*, ::Class_1_5F4D64A4B97E38F9*))((::PBYTE)hIl2Cpp + CLASS_1_8D80FEF923501A99_1__CTOR_OFFSET))(this, a1, a2);
	}
