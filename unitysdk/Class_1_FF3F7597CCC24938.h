...
#define CLASS_1_FF3F7597CCC24938_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19F9DA70)
#define CLASS_1_FF3F7597CCC24938_GET_CLIP0NAMEHASH_OFFSET UNITYSDK_OFFSET(0x19F9CBA0)
#define CLASS_1_FF3F7597CCC24938_GET_CLIP0NAME_OFFSET UNITYSDK_OFFSET(0x19F9CB60)
#define CLASS_1_FF3F7597CCC24938_GET_CLIP1NAMEHASH_OFFSET UNITYSDK_OFFSET(0x19F9CBC0)
#define CLASS_1_FF3F7597CCC24938_GET_CLIP1NAME_OFFSET UNITYSDK_OFFSET(0x19F9CB80)
#define CLASS_1_FF3F7597CCC24938_GET_DISABLEANIMEVENT_OFFSET UNITYSDK_OFFSET(0x19F9CA80)
#define CLASS_1_FF3F7597CCC24938_GET_FREESTYLEMOTIONID_OFFSET UNITYSDK_OFFSET(0x19F9CA40)
#define CLASS_1_FF3F7597CCC24938_GET_GROUPINDEX_OFFSET UNITYSDK_OFFSET(0x19F9CA30)
#define CLASS_1_FF3F7597CCC24938_GET_PRELOADFREESTYLEMOTIONID_OFFSET UNITYSDK_OFFSET(0x19F9CA60)
#define CLASS_1_FF3F7597CCC24938_GET_RIBBONCLIP0NAMEHASH_OFFSET UNITYSDK_OFFSET(0x19F9CBE0)
#define CLASS_1_FF3F7597CCC24938_GET_RIBBONCLIP1NAMEHASH_OFFSET UNITYSDK_OFFSET(0x19F9CC00)
#define CLASS_1_FF3F7597CCC24938_METHOD_1_0552BEF80A6A3BAA_1_OFFSET UNITYSDK_OFFSET(0x19F9C9C0)
#define CLASS_1_FF3F7597CCC24938_METHOD_1_0552BEF80A6A3BAA_OFFSET UNITYSDK_OFFSET(0x19F9C710)
#define CLASS_1_FF3F7597CCC24938_METHOD_1_08CCBB9E689D6A81_OFFSET UNITYSDK_OFFSET(0x19F9CC20)
#define CLASS_1_FF3F7597CCC24938_METHOD_1_102192C05CB5CDCB_OFFSET UNITYSDK_OFFSET(0x19F9C5D0)
#define CLASS_1_FF3F7597CCC24938_METHOD_1_2950A42D31005822_OFFSET UNITYSDK_OFFSET(0x19F9D190)
#define CLASS_1_FF3F7597CCC24938_METHOD_1_4A6695F863A75568_OFFSET UNITYSDK_OFFSET(0x19F9D7D0)
#define CLASS_1_FF3F7597CCC24938_METHOD_1_4B6DEDB9FF4B740B_OFFSET UNITYSDK_OFFSET(0x19F9DAC0)
#define CLASS_1_FF3F7597CCC24938_METHOD_1_6011AA7C1E79F305_OFFSET UNITYSDK_OFFSET(0x19F9DB20)
#define CLASS_1_FF3F7597CCC24938_METHOD_1_6A5926614A3A36F5_OFFSET UNITYSDK_OFFSET(0x19F9DC80)
#define CLASS_1_FF3F7597CCC24938_METHOD_1_78A1456A6DBF4558_OFFSET UNITYSDK_OFFSET(0x19F9C4E0)
#define CLASS_1_FF3F7597CCC24938_METHOD_1_86EDAAEABA959F35_OFFSET UNITYSDK_OFFSET(0x19F9C780)
#define CLASS_1_FF3F7597CCC24938_METHOD_1_954EB24DA065442A_1_OFFSET UNITYSDK_OFFSET(0x19F9DCF0)
#define CLASS_1_FF3F7597CCC24938_METHOD_1_954EB24DA065442A_2_OFFSET UNITYSDK_OFFSET(0x19F9DD50)
#define CLASS_1_FF3F7597CCC24938_METHOD_1_954EB24DA065442A_OFFSET UNITYSDK_OFFSET(0x19F9DB80)
#define CLASS_1_FF3F7597CCC24938_METHOD_1_A00EAD174EF85E42_OFFSET UNITYSDK_OFFSET(0x19F9CF50)
#define CLASS_1_FF3F7597CCC24938_METHOD_1_A37026F5FDBACF68_OFFSET UNITYSDK_OFFSET(0x19F9DBF0)
#define CLASS_1_FF3F7597CCC24938_METHOD_1_AE51354F9458E8B7_OFFSET UNITYSDK_OFFSET(0x19F9CFC0)
#define CLASS_1_FF3F7597CCC24938_METHOD_1_C86F0349DCEC0A70_1_OFFSET UNITYSDK_OFFSET(0x19F9CB00)
#define CLASS_1_FF3F7597CCC24938_METHOD_1_C86F0349DCEC0A70_OFFSET UNITYSDK_OFFSET(0x19F9CAA0)
#define CLASS_1_FF3F7597CCC24938_SET_CLIP0NAMEHASH_OFFSET UNITYSDK_OFFSET(0x19F9CBB0)
#define CLASS_1_FF3F7597CCC24938_SET_CLIP0NAME_OFFSET UNITYSDK_OFFSET(0x19F9CB70)
#define CLASS_1_FF3F7597CCC24938_SET_CLIP1NAMEHASH_OFFSET UNITYSDK_OFFSET(0x19F9CBD0)
#define CLASS_1_FF3F7597CCC24938_SET_CLIP1NAME_OFFSET UNITYSDK_OFFSET(0x19F9CB90)
#define CLASS_1_FF3F7597CCC24938_SET_DISABLEANIMEVENT_OFFSET UNITYSDK_OFFSET(0x19F9CA90)
#define CLASS_1_FF3F7597CCC24938_SET_FREESTYLEMOTIONID_OFFSET UNITYSDK_OFFSET(0x19F9CA50)
#define CLASS_1_FF3F7597CCC24938_SET_PRELOADFREESTYLEMOTIONID_OFFSET UNITYSDK_OFFSET(0x19F9CA70)
#define CLASS_1_FF3F7597CCC24938_SET_RIBBONCLIP0NAMEHASH_OFFSET UNITYSDK_OFFSET(0x19F9CBF0)
#define CLASS_1_FF3F7597CCC24938_SET_RIBBONCLIP1NAMEHASH_OFFSET UNITYSDK_OFFSET(0x19F9CC10)
#define CLASS_1_FF3F7597CCC24938__CCTOR_OFFSET UNITYSDK_OFFSET(0x19F9DDB0)
#define CLASS_1_FF3F7597CCC24938__CTOR_OFFSET UNITYSDK_OFFSET(0x19F9CC30)
...
public:
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_FF3F7597CCC24938_TypeDefinitionIndex)->GetStaticField(0x34BE0);
	}
	// static const ::System::String* CKILBBNMPBJ; // 0x0
	// static const ::System::Int32 FNCJNOCCNHI = 0x2; // 0x0
	::Il2CppArray<::Class_1_FF3F7597CCC24938_Struct_2_1447C0841AEA19EF>* LGGJLMANEJF; // 0x10
	::UnityEngine::AnimationClip* CMOOEJBJILE; // 0x18
	::System::String* _Clip0Name_k__BackingField; // 0x20
	::System::String* KKBIKLPNAPE; // 0x28
	::System::String* MMMJBLGMDHG; // 0x30
	::System::String* _Clip1Name_k__BackingField; // 0x38
	::System::String* DIGDPJDEFFD; // 0x40
	::UnityEngine::AnimationClip* IONFOGLJECB; // 0x48
	::UnityEngine::AnimationClip* EHIOFJJKLNO; // 0x50
	::System::Collections::Generic::List_1<::System::Collections::Generic::KeyValuePair_2<::UnityEngine::AnimationClip*, ::UnityEngine::AnimationClip*>>* BADIPHHBBJC; // 0x58
	::System::String* GNAHLKCNFEA; // 0x60
	::UnityEngine::AnimationClip* CALPEKNOOID; // 0x68
	::System::Int32 NMFILPIBIJC; // 0x70
	::System::Int32 IDDLEBNMPIG; // 0x74
	::System::Boolean _DisableAnimEvent_k__BackingField; // 0x78
	::System::Boolean HHNIJEPEELB; // 0x79
	::System::Boolean AAFDNLMOHEB; // 0x7A
	::System::Boolean DNDHCFFOGJK; // 0x7B
	::System::Int32 JGLKNIMKIMI; // 0x7C
	::System::Int32 _Clip1NameHash_k__BackingField; // 0x80
	::System::Int32 _RibbonClip1NameHash_k__BackingField; // 0x84
	::System::Int32 _Clip0NameHash_k__BackingField; // 0x88
	::System::Int32 MJNCMEMBGLO; // 0x8C
	::System::Int32 AAPBDMEIPEI; // 0x90
	::System::Int32 _GroupIndex_k__BackingField; // 0x94
	::System::Int32 MILHFMNBLGE; // 0x98
	::System::Int32 PAJCGAHCINH; // 0x9C
	::System::Int32 HFCEDENGGNL; // 0xA0
	::System::Int32 GAJBICOMABH; // 0xA4
	::System::UInt32 _PreloadFreeStyleMotionID_k__BackingField; // 0xA8
	::System::Int32 _RibbonClip0NameHash_k__BackingField; // 0xAC
	::System::UInt32 _FreeStyleMotionID_k__BackingField; // 0xB0
