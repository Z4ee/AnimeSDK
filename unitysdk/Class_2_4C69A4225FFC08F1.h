...
#define CLASS_2_4C69A4225FFC08F1_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAEE2080)
#define CLASS_2_4C69A4225FFC08F1_METHOD_2_C8F03EB4AC0A2737_OFFSET UNITYSDK_OFFSET(0xAEE23F0)
#define CLASS_2_4C69A4225FFC08F1_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xAEE2180)
#define CLASS_2_4C69A4225FFC08F1_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xAEE2360)
#define CLASS_2_4C69A4225FFC08F1_TICK_OFFSET UNITYSDK_OFFSET(0xAEE2120)
#define CLASS_2_4C69A4225FFC08F1__CTOR_OFFSET UNITYSDK_OFFSET(0xAEE2070)

inline static constexpr unsigned int Class_2_4C69A4225FFC08F1_TypeDefinitionIndex = 54616;
...
public:
	...
	::RPG::GameCore::RogueDLC1Dot3PictureFrameDisappear* Field_2_2; // 0x28
