...
#define CLASS_1_5C85CC607D791BFF_GET_SKILLDESC_OFFSET UNITYSDK_OFFSET(0x176BD920)
#define CLASS_1_5C85CC607D791BFF_GET_SKILLEXTRAEFFECTLIST_OFFSET UNITYSDK_OFFSET(0x176BD9C0)
#define CLASS_1_5C85CC607D791BFF_GET_SKILLICONPATH_OFFSET UNITYSDK_OFFSET(0x176BD9D0)
#define CLASS_1_5C85CC607D791BFF_GET_SKILLNAME_OFFSET UNITYSDK_OFFSET(0x176BD900)
#define CLASS_1_5C85CC607D791BFF_GET_SKILLSIMPLEDESC_OFFSET UNITYSDK_OFFSET(0x176BD940)
#define CLASS_1_5C85CC607D791BFF_GET_SKILLTAG_OFFSET UNITYSDK_OFFSET(0x176BD960)
#define CLASS_1_5C85CC607D791BFF_GET_SKILLTYPECOLOR_OFFSET UNITYSDK_OFFSET(0x176BD9A0)
#define CLASS_1_5C85CC607D791BFF_GET_SKILLTYPE_OFFSET UNITYSDK_OFFSET(0x176BD980)
#define CLASS_1_5C85CC607D791BFF_GET_ULTRASKILLICONPATH_OFFSET UNITYSDK_OFFSET(0x176BD9F0)
#define CLASS_1_5C85CC607D791BFF_SET_SKILLDESC_OFFSET UNITYSDK_OFFSET(0x176BD930)
#define CLASS_1_5C85CC607D791BFF_SET_SKILLICONPATH_OFFSET UNITYSDK_OFFSET(0x176BD9E0)
#define CLASS_1_5C85CC607D791BFF_SET_SKILLNAME_OFFSET UNITYSDK_OFFSET(0x176BD910)
#define CLASS_1_5C85CC607D791BFF_SET_SKILLSIMPLEDESC_OFFSET UNITYSDK_OFFSET(0x176BD950)
#define CLASS_1_5C85CC607D791BFF_SET_SKILLTAG_OFFSET UNITYSDK_OFFSET(0x176BD970)
#define CLASS_1_5C85CC607D791BFF_SET_SKILLTYPECOLOR_OFFSET UNITYSDK_OFFSET(0x176BD9B0)
#define CLASS_1_5C85CC607D791BFF_SET_SKILLTYPE_OFFSET UNITYSDK_OFFSET(0x176BD990)
#define CLASS_1_5C85CC607D791BFF_SET_ULTRASKILLICONPATH_OFFSET UNITYSDK_OFFSET(0x176BDA00)
#define CLASS_1_5C85CC607D791BFF__CTOR_OFFSET UNITYSDK_OFFSET(0x176BDA10)

inline static constexpr unsigned int Class_1_5C85CC607D791BFF_TypeDefinitionIndex = 75867;

class Class_1_5C85CC607D791BFF : public ::System::Object
{
public:
	::System::String* _SkillDesc_k__BackingField; // 0x10
	::System::String* _UltraSkillIconPath_k__BackingField; // 0x18
	::System::String* _SkillIconPath_k__BackingField; // 0x20
	::System::Collections::Generic::List_1<::Class_1_3E8412A97A3D0DF7*>* _SkillExtraEffectList_k__BackingField; // 0x28
	::System::String* _SkillSimpleDesc_k__BackingField; // 0x30
	::RPG::Client::TextID _SkillType_k__BackingField; // 0x38
	::UnityEngine::Color _SkillTypeColor_k__BackingField; // 0x48
	::RPG::Client::TextID _SkillTag_k__BackingField; // 0x58
	::RPG::Client::TextID _SkillName_k__BackingField; // 0x68
