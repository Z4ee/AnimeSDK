...
#define CLASS_1_1DB2E9E79963A9A0_METHOD_1_081B82FB494CD83F_OFFSET UNITYSDK_OFFSET(0x188C6780)
#define CLASS_1_1DB2E9E79963A9A0_METHOD_1_2440FD2CA50CDA2B_OFFSET UNITYSDK_OFFSET(0x188C65E0)
#define CLASS_1_1DB2E9E79963A9A0_METHOD_1_34A82700F46F269B_OFFSET UNITYSDK_OFFSET(0x188C6080)
#define CLASS_1_1DB2E9E79963A9A0_METHOD_1_5DF0BEF00847060A_OFFSET UNITYSDK_OFFSET(0x188C5DD0)
#define CLASS_1_1DB2E9E79963A9A0_METHOD_1_86D4F832745D4A47_OFFSET UNITYSDK_OFFSET(0x188C64D0)
#define CLASS_1_1DB2E9E79963A9A0_METHOD_1_F3E072974F507E27_OFFSET UNITYSDK_OFFSET(0x188C5C40)
#define CLASS_1_1DB2E9E79963A9A0__CCTOR_OFFSET UNITYSDK_OFFSET(0x188C68F0)
#define CLASS_1_1DB2E9E79963A9A0__CTOR_OFFSET UNITYSDK_OFFSET(0x188C68E0)

inline static constexpr unsigned int Class_1_1DB2E9E79963A9A0_TypeDefinitionIndex = 59212;

class Class_1_1DB2E9E79963A9A0 : public ::System::Object
{
public:
	static ::Il2CppArray<::RPG::GameCore::AbilityProperty>** StaticGet_PGPNFONAIBC()
	{
		return (::Il2CppArray<::RPG::GameCore::AbilityProperty>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_1DB2E9E79963A9A0_TypeDefinitionIndex)->GetStaticField(0x51EC0);
	}
