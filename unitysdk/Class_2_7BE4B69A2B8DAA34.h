...
#define CLASS_2_7BE4B69A2B8DAA34_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1875C520)
#define CLASS_2_7BE4B69A2B8DAA34_METHOD_2_5C715D615BCEF8BF_OFFSET UNITYSDK_OFFSET(0x1875C7F0)
#define CLASS_2_7BE4B69A2B8DAA34_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1875C560)
#define CLASS_2_7BE4B69A2B8DAA34_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1875C740)
#define CLASS_2_7BE4B69A2B8DAA34_TICK_OFFSET UNITYSDK_OFFSET(0x1875C790)
#define CLASS_2_7BE4B69A2B8DAA34__CTOR_OFFSET UNITYSDK_OFFSET(0x1875C510)

inline static constexpr unsigned int Class_2_7BE4B69A2B8DAA34_TypeDefinitionIndex = 56070;

class Class_2_7BE4B69A2B8DAA34 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ShowTransitionLoadingUI* Field_2_0; // 0x18
