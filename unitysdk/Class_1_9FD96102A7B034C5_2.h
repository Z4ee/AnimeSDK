...
#define CLASS_1_9FD96102A7B034C5_2_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E5BF6E0)
#define CLASS_1_9FD96102A7B034C5_2_CLONE_OFFSET UNITYSDK_OFFSET(0x1E5BF230)
#define CLASS_1_9FD96102A7B034C5_2_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E5BF3E0)
#define CLASS_1_9FD96102A7B034C5_2_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E5BF290)
#define CLASS_1_9FD96102A7B034C5_2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E5BF510)
#define CLASS_1_9FD96102A7B034C5_2_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E5BF890)
#define CLASS_1_9FD96102A7B034C5_2_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E5BF7F0)
#define CLASS_1_9FD96102A7B034C5_2_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1E5BF260)
#define CLASS_1_9FD96102A7B034C5_2_METHOD_1_4C96E9A31DDA1BDD_OFFSET UNITYSDK_OFFSET(0x1E5BF280)
#define CLASS_1_9FD96102A7B034C5_2_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E5BF120)
#define CLASS_1_9FD96102A7B034C5_2_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1E5BF270)
#define CLASS_1_9FD96102A7B034C5_2_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E5BF150)
#define CLASS_1_9FD96102A7B034C5_2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E5BF580)
#define CLASS_1_9FD96102A7B034C5_2_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E5BF5E0)
#define CLASS_1_9FD96102A7B034C5_2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E5BFA50)
#define CLASS_1_9FD96102A7B034C5_2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E5BF1A0)
#define CLASS_1_9FD96102A7B034C5_2__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5BF160)

inline static constexpr unsigned int Class_1_9FD96102A7B034C5_2_TypeDefinitionIndex = 29609;

class Class_1_9FD96102A7B034C5_2 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_9FD96102A7B034C5_2*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_9FD96102A7B034C5_2*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9FD96102A7B034C5_2_TypeDefinitionIndex)->GetStaticField(0x1D670);
	}
	static ::Google::Protobuf::FieldCodec_1<::Proto::PileItem*>** StaticGet_EDEMPAMDAFD()
	{
		return (::Google::Protobuf::FieldCodec_1<::Proto::PileItem*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9FD96102A7B034C5_2_TypeDefinitionIndex)->GetStaticField(0x1D678);
	}
	// static const ::System::Int32 PLDKENJLKME = 0x6; // 0x0
	// static const ::System::Int32 DFABHHAPAEA = 0xC; // 0x0
