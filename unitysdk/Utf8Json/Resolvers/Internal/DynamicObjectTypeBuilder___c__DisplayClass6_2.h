...
#define UTF8JSON_RESOLVERS_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS6_2__BUILDTYPE_B__3_OFFSET UNITYSDK_OFFSET(0x1E56B7C0)
#define UTF8JSON_RESOLVERS_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS6_2__CTOR_OFFSET UNITYSDK_OFFSET(0x1E56B7B0)

namespace Utf8Json::Resolvers::Internal
{
	inline static constexpr unsigned int DynamicObjectTypeBuilder___c__DisplayClass6_2_TypeDefinitionIndex = 91154;

	class DynamicObjectTypeBuilder___c__DisplayClass6_2 : public ::System::Object
	{
	public:
		::System::Reflection::Emit::ILGenerator* il; // 0x10
		::Utf8Json::Resolvers::Internal::DynamicObjectTypeBuilder___c__DisplayClass6_0* CS___8__locals2; // 0x18
