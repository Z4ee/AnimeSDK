...
#define UTF8JSON_RESOLVERS_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS6_2__BUILDTYPE_B__3_OFFSET UNITYSDK_OFFSET(0x1C21F170)
#define UTF8JSON_RESOLVERS_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS6_2__CTOR_OFFSET UNITYSDK_OFFSET(0x1C21F160)

namespace Utf8Json::Resolvers::Internal
{
	inline static constexpr unsigned int DynamicObjectTypeBuilder___c__DisplayClass6_2_TypeDefinitionIndex = 85580;
