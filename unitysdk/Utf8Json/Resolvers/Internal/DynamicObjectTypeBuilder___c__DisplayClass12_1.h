...
#define UTF8JSON_RESOLVERS_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS12_1__BUILDDESERIALIZE_B__2_OFFSET UNITYSDK_OFFSET(0x1E122710)
#define UTF8JSON_RESOLVERS_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS12_1__BUILDDESERIALIZE_B__3_OFFSET UNITYSDK_OFFSET(0x1E122A10)
#define UTF8JSON_RESOLVERS_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS12_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1E122700)

namespace Utf8Json::Resolvers::Internal
{
	inline static constexpr unsigned int DynamicObjectTypeBuilder___c__DisplayClass12_1_TypeDefinitionIndex = 91162;
