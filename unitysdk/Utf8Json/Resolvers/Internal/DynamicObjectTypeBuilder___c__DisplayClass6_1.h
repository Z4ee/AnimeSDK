...
#define UTF8JSON_RESOLVERS_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS6_1__BUILDTYPE_B__1_OFFSET UNITYSDK_OFFSET(0x1DF66C90)
#define UTF8JSON_RESOLVERS_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS6_1__BUILDTYPE_B__2_OFFSET UNITYSDK_OFFSET(0x1DF66DC0)
#define UTF8JSON_RESOLVERS_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS6_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF5FDE0)

namespace Utf8Json::Resolvers::Internal
{
	inline static constexpr unsigned int DynamicObjectTypeBuilder___c__DisplayClass6_1_TypeDefinitionIndex = 91153;

	class DynamicObjectTypeBuilder___c__DisplayClass6_1 : public ::System::Object
	{
	public:
		::Utf8Json::Resolvers::Internal::DynamicObjectTypeBuilder___c__DisplayClass6_0* CS___8__locals1; // 0x10
