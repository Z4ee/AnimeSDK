...
#define UTF8JSON_JSONFORMATTERRESOLVEREXTENSIONS_GETFORMATTERDYNAMIC_OFFSET UNITYSDK_OFFSET(0x1FAB3750)

namespace Utf8Json
{
	inline static constexpr unsigned int JsonFormatterResolverExtensions_TypeDefinitionIndex = 95009;
