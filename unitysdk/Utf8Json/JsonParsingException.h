...
#define UTF8JSON_JSONPARSINGEXCEPTION_GETUNDERLYINGBYTEARRAYUNSAFE_OFFSET UNITYSDK_OFFSET(0x1C38B970)
#define UTF8JSON_JSONPARSINGEXCEPTION_GETUNDERLYINGSTRINGUNSAFE_OFFSET UNITYSDK_OFFSET(0x1C38B9D0)
#define UTF8JSON_JSONPARSINGEXCEPTION_GET_ACTUALCHAR_OFFSET UNITYSDK_OFFSET(0x1C38B790)
#define UTF8JSON_JSONPARSINGEXCEPTION_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1C38B770)
#define UTF8JSON_JSONPARSINGEXCEPTION_SET_ACTUALCHAR_OFFSET UNITYSDK_OFFSET(0x1C38B7A0)
#define UTF8JSON_JSONPARSINGEXCEPTION_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1C38B780)
#define UTF8JSON_JSONPARSINGEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C38B830)
#define UTF8JSON_JSONPARSINGEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C38B7B0)

namespace Utf8Json
{
	inline static constexpr unsigned int JsonParsingException_TypeDefinitionIndex = 85506;
	...
	public:
		...
		::System::Int32 _Offset_k__BackingField; // 0x98
		::System::Int32 limit; // 0x9C
