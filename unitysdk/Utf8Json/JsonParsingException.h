...
#define UTF8JSON_JSONPARSINGEXCEPTION_GETUNDERLYINGBYTEARRAYUNSAFE_OFFSET UNITYSDK_OFFSET(0x1FAB3AD0)
#define UTF8JSON_JSONPARSINGEXCEPTION_GETUNDERLYINGSTRINGUNSAFE_OFFSET UNITYSDK_OFFSET(0x1FAB3B30)
#define UTF8JSON_JSONPARSINGEXCEPTION_GET_ACTUALCHAR_OFFSET UNITYSDK_OFFSET(0x1FAB3900)
#define UTF8JSON_JSONPARSINGEXCEPTION_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1FAB38E0)
#define UTF8JSON_JSONPARSINGEXCEPTION_SET_ACTUALCHAR_OFFSET UNITYSDK_OFFSET(0x1FAB3910)
#define UTF8JSON_JSONPARSINGEXCEPTION_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1FAB38F0)
#define UTF8JSON_JSONPARSINGEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1FAB39A0)
#define UTF8JSON_JSONPARSINGEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1FAB3920)

namespace Utf8Json
{
	inline static constexpr unsigned int JsonParsingException_TypeDefinitionIndex = 95013;

	class JsonParsingException : public ::System::Exception
	{
	public:
		::System::String* _ActualChar_k__BackingField; // 0x88
		::System::WeakReference* underyingBytes; // 0x90
