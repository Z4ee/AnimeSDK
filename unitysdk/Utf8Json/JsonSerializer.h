...
#define UTF8JSON_JSONSERIALIZER_FILLFROMSTREAM_OFFSET UNITYSDK_OFFSET(0x1E121850)
#define UTF8JSON_JSONSERIALIZER_GET_DEFAULTRESOLVER_OFFSET UNITYSDK_OFFSET(0x1E11FB60)
#define UTF8JSON_JSONSERIALIZER_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1E11FC70)
#define UTF8JSON_JSONSERIALIZER_PRETTYPRINTBYTEARRAY_1_OFFSET UNITYSDK_OFFSET(0x1E120CC0)
#define UTF8JSON_JSONSERIALIZER_PRETTYPRINTBYTEARRAY_2_OFFSET UNITYSDK_OFFSET(0x1E120E10)
#define UTF8JSON_JSONSERIALIZER_PRETTYPRINTBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x1E120C60)
#define UTF8JSON_JSONSERIALIZER_PRETTYPRINT_1_OFFSET UNITYSDK_OFFSET(0x1E11FD90)
#define UTF8JSON_JSONSERIALIZER_PRETTYPRINT_2_OFFSET UNITYSDK_OFFSET(0x1E120A00)
#define UTF8JSON_JSONSERIALIZER_PRETTYPRINT_OFFSET UNITYSDK_OFFSET(0x1E11FD30)
#define UTF8JSON_JSONSERIALIZER_SETDEFAULTRESOLVER_OFFSET UNITYSDK_OFFSET(0x1E11FCD0)
#define UTF8JSON_JSONSERIALIZER_WRITEPRITTYPRINT_OFFSET UNITYSDK_OFFSET(0x1E11FF20)
#define UTF8JSON_JSONSERIALIZER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E1218E0)

namespace Utf8Json
{
	inline static constexpr unsigned int JsonSerializer_TypeDefinitionIndex = 91081;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Byte>**)Il2CppClass::FromTypeDefinitionIndex(JsonSerializer_TypeDefinitionIndex)->GetStaticField(0x4F0C0);
		}
		static ::Il2CppArray<::Il2CppArray<::System::Byte>*>** StaticGet_indent()
		{
			return (::Il2CppArray<::Il2CppArray<::System::Byte>*>**)Il2CppClass::FromTypeDefinitionIndex(JsonSerializer_TypeDefinitionIndex)->GetStaticField(0x4F0C8);
		}
		static ::Utf8Json::IJsonFormatterResolver** StaticGet_defaultResolver()
		{
			return (::Utf8Json::IJsonFormatterResolver**)Il2CppClass::FromTypeDefinitionIndex(JsonSerializer_TypeDefinitionIndex)->GetStaticField(0x4F0D0);
		}
