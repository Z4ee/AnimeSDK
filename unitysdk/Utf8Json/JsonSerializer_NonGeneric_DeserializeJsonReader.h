...
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZEJSONREADER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E510AC0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZEJSONREADER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E510B40)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZEJSONREADER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E510780)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZEJSONREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E510760)

namespace Utf8Json
{
	inline static constexpr unsigned int JsonSerializer_NonGeneric_DeserializeJsonReader_TypeDefinitionIndex = 91084;
