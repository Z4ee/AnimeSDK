...
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZEJSONREADER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F915620)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZEJSONREADER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F9156A0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZEJSONREADER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F915300)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZEJSONREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F9152E0)

namespace Utf8Json
{
	inline static constexpr unsigned int JsonSerializer_NonGeneric_DeserializeJsonReader_TypeDefinitionIndex = 95017;
