...
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_1_OFFSET UNITYSDK_OFFSET(0x1C21DF40)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_2_OFFSET UNITYSDK_OFFSET(0x1C21E080)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_3_OFFSET UNITYSDK_OFFSET(0x1C21E1B0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_4_OFFSET UNITYSDK_OFFSET(0x1C21E390)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_5_OFFSET UNITYSDK_OFFSET(0x1C21E240)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_6_OFFSET UNITYSDK_OFFSET(0x1C21E420)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_7_OFFSET UNITYSDK_OFFSET(0x1C21E4B0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_8_OFFSET UNITYSDK_OFFSET(0x1C21E5F0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_9_OFFSET UNITYSDK_OFFSET(0x1C21E680)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C21DEB0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_GETORADD_OFFSET UNITYSDK_OFFSET(0x1C21CB60)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZEUNSAFE_1_OFFSET UNITYSDK_OFFSET(0x1C21D810)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZEUNSAFE_2_OFFSET UNITYSDK_OFFSET(0x1C21DA10)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZEUNSAFE_3_OFFSET UNITYSDK_OFFSET(0x1C21D8B0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZEUNSAFE_OFFSET UNITYSDK_OFFSET(0x1C21D620)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_10_OFFSET UNITYSDK_OFFSET(0x1C21D440)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_1_OFFSET UNITYSDK_OFFSET(0x1C21CE80)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_2_OFFSET UNITYSDK_OFFSET(0x1C21CF10)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_3_OFFSET UNITYSDK_OFFSET(0x1C21CD40)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_4_OFFSET UNITYSDK_OFFSET(0x1C21CFB0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_5_OFFSET UNITYSDK_OFFSET(0x1C21D260)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_6_OFFSET UNITYSDK_OFFSET(0x1C21D300)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_7_OFFSET UNITYSDK_OFFSET(0x1C21D110)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_8_OFFSET UNITYSDK_OFFSET(0x1C21D3B0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_9_OFFSET UNITYSDK_OFFSET(0x1C21D580)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C21CBF0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_TOJSONSTRING_1_OFFSET UNITYSDK_OFFSET(0x1C21DC60)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_TOJSONSTRING_2_OFFSET UNITYSDK_OFFSET(0x1C21DE30)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_TOJSONSTRING_3_OFFSET UNITYSDK_OFFSET(0x1C21DCF0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_TOJSONSTRING_OFFSET UNITYSDK_OFFSET(0x1C21DB60)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C21CAA0)

namespace Utf8Json
{
	inline static constexpr unsigned int JsonSerializer_NonGeneric_TypeDefinitionIndex = 85508;
	...
	public:
		...
		{
			return (::Utf8Json::Internal::ThreadsafeTypeKeyHashTable_1<::Utf8Json::JsonSerializer_NonGeneric_CompiledMethods*>**)Il2CppClass::FromTypeDefinitionIndex(JsonSerializer_NonGeneric_TypeDefinitionIndex)->GetStaticField(0x4AA30);
		}
		static ::System::Func_2<::System::Type*, ::Utf8Json::JsonSerializer_NonGeneric_CompiledMethods*>** StaticGet_CreateCompiledMethods()
		{
			return (::System::Func_2<::System::Type*, ::Utf8Json::JsonSerializer_NonGeneric_CompiledMethods*>**)Il2CppClass::FromTypeDefinitionIndex(JsonSerializer_NonGeneric_TypeDefinitionIndex)->GetStaticField(0x4AA38);
		}
