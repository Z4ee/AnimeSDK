...
#define UTF8JSON_JSONWRITER_ADVANCEOFFSET_OFFSET UNITYSDK_OFFSET(0xAA7100)
#define UTF8JSON_JSONWRITER_ENSURECAPACITY_OFFSET UNITYSDK_OFFSET(0xAA7340)
#define UTF8JSON_JSONWRITER_GETBUFFER_OFFSET UNITYSDK_OFFSET(0xAA7110)
#define UTF8JSON_JSONWRITER_GETENCODEDPROPERTYNAMEWITHBEGINOBJECT_OFFSET UNITYSDK_OFFSET(0x1F53AA30)
#define UTF8JSON_JSONWRITER_GETENCODEDPROPERTYNAMEWITHOUTQUOTATION_OFFSET UNITYSDK_OFFSET(0x1F53AB10)
#define UTF8JSON_JSONWRITER_GETENCODEDPROPERTYNAMEWITHPREFIXVALUESEPARATOR_OFFSET UNITYSDK_OFFSET(0x1F53A950)
#define UTF8JSON_JSONWRITER_GETENCODEDPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1F53A8C0)
#define UTF8JSON_JSONWRITER_GET_CURRENTOFFSET_OFFSET UNITYSDK_OFFSET(0x32EEE0)
#define UTF8JSON_JSONWRITER_TOSTRING_OFFSET UNITYSDK_OFFSET(0xAA7240)
#define UTF8JSON_JSONWRITER_TOUTF8BYTEARRAY_OFFSET UNITYSDK_OFFSET(0xAA71D0)
#define UTF8JSON_JSONWRITER_WRITEBEGINARRAY_OFFSET UNITYSDK_OFFSET(0xAA7440)
#define UTF8JSON_JSONWRITER_WRITEBEGINOBJECT_OFFSET UNITYSDK_OFFSET(0xAA7500)
#define UTF8JSON_JSONWRITER_WRITEBOOLEAN_OFFSET UNITYSDK_OFFSET(0xAA7750)
#define UTF8JSON_JSONWRITER_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0xAA7880)
#define UTF8JSON_JSONWRITER_WRITEDOUBLE_OFFSET UNITYSDK_OFFSET(0xAA7800)
#define UTF8JSON_JSONWRITER_WRITEENDARRAY_OFFSET UNITYSDK_OFFSET(0xAA74A0)
#define UTF8JSON_JSONWRITER_WRITEENDOBJECT_OFFSET UNITYSDK_OFFSET(0xAA7560)
#define UTF8JSON_JSONWRITER_WRITEFALSE_OFFSET UNITYSDK_OFFSET(0xAA7770)
#define UTF8JSON_JSONWRITER_WRITEINT16_OFFSET UNITYSDK_OFFSET(0xAA7970)
#define UTF8JSON_JSONWRITER_WRITEINT32_OFFSET UNITYSDK_OFFSET(0xAA79A0)
#define UTF8JSON_JSONWRITER_WRITEINT64_OFFSET UNITYSDK_OFFSET(0xAA79D0)
#define UTF8JSON_JSONWRITER_WRITENAMESEPARATOR_OFFSET UNITYSDK_OFFSET(0xAA7620)
#define UTF8JSON_JSONWRITER_WRITENULL_OFFSET UNITYSDK_OFFSET(0xAA7740)
#define UTF8JSON_JSONWRITER_WRITEPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0xAA7680)
#define UTF8JSON_JSONWRITER_WRITEQUOTATION_OFFSET UNITYSDK_OFFSET(0xAA76E0)
#define UTF8JSON_JSONWRITER_WRITERAWUNSAFE_OFFSET UNITYSDK_OFFSET(0xAA7400)
#define UTF8JSON_JSONWRITER_WRITERAW_1_OFFSET UNITYSDK_OFFSET(0xAA73B0)
#define UTF8JSON_JSONWRITER_WRITERAW_OFFSET UNITYSDK_OFFSET(0xAA7350)
#define UTF8JSON_JSONWRITER_WRITESBYTE_OFFSET UNITYSDK_OFFSET(0xAA7940)
#define UTF8JSON_JSONWRITER_WRITESINGLE_OFFSET UNITYSDK_OFFSET(0xAA7780)
#define UTF8JSON_JSONWRITER_WRITESTRING_OFFSET UNITYSDK_OFFSET(0xAA7A00)
#define UTF8JSON_JSONWRITER_WRITETRUE_OFFSET UNITYSDK_OFFSET(0xAA7760)
#define UTF8JSON_JSONWRITER_WRITEUINT16_OFFSET UNITYSDK_OFFSET(0xAA78B0)
#define UTF8JSON_JSONWRITER_WRITEUINT32_OFFSET UNITYSDK_OFFSET(0xAA78E0)
#define UTF8JSON_JSONWRITER_WRITEUINT64_OFFSET UNITYSDK_OFFSET(0xAA7910)
#define UTF8JSON_JSONWRITER_WRITEVALUESEPARATOR_OFFSET UNITYSDK_OFFSET(0xAA75C0)
#define UTF8JSON_JSONWRITER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F53B0E0)
#define UTF8JSON_JSONWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x464D40)

namespace Utf8Json
{
	inline static constexpr unsigned int JsonWriter_TypeDefinitionIndex = 95024;

	struct alignas(8) JsonWriter
	{
		static ::Il2CppArray<::System::Byte>** StaticGet_emptyBytes()
		{
			return (::Il2CppArray<::System::Byte>**)Il2CppClass::FromTypeDefinitionIndex(JsonWriter_TypeDefinitionIndex)->GetStaticField(0x532A0);
		}
