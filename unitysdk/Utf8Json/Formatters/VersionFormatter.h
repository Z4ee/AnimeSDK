...
#define UTF8JSON_FORMATTERS_VERSIONFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E7ED080)
#define UTF8JSON_FORMATTERS_VERSIONFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E7ECFA0)
#define UTF8JSON_FORMATTERS_VERSIONFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E7ED170)
#define UTF8JSON_FORMATTERS_VERSIONFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7ED160)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int VersionFormatter_TypeDefinitionIndex = 91378;
	...
	public:
		...
		{
			return (::Utf8Json::IJsonFormatter_1<::System::Version*>**)Il2CppClass::FromTypeDefinitionIndex(VersionFormatter_TypeDefinitionIndex)->GetStaticField(0x4EF50);
		}
