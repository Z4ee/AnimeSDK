...
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1FB958B0)
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1FB957A0)
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEFORMATTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1FB95750)
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FB95700)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int NullableDateTimeFormatter_TypeDefinitionIndex = 95234;
