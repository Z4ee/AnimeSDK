...
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C479DA0)
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C479C90)
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEFORMATTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C479C40)
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C479BF0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int NullableDateTimeFormatter_TypeDefinitionIndex = 85727;
