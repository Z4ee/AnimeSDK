...
#define UTF8JSON_FORMATTERS_NULLABLETIMESPANFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1FB95FB0)
#define UTF8JSON_FORMATTERS_NULLABLETIMESPANFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1FB95E40)
#define UTF8JSON_FORMATTERS_NULLABLETIMESPANFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FB95DF0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int NullableTimeSpanFormatter_TypeDefinitionIndex = 95241;
