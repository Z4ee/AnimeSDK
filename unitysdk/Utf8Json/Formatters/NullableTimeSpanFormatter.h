...
#define UTF8JSON_FORMATTERS_NULLABLETIMESPANFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E7B8460)
#define UTF8JSON_FORMATTERS_NULLABLETIMESPANFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E7B82F0)
#define UTF8JSON_FORMATTERS_NULLABLETIMESPANFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7B82A0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int NullableTimeSpanFormatter_TypeDefinitionIndex = 91308;
