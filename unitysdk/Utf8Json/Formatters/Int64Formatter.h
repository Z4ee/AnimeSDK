...
#define UTF8JSON_FORMATTERS_INT64FORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1C4556F0)
#define UTF8JSON_FORMATTERS_INT64FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C4555C0)
#define UTF8JSON_FORMATTERS_INT64FORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1C455640)
#define UTF8JSON_FORMATTERS_INT64FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C455590)
#define UTF8JSON_FORMATTERS_INT64FORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C455730)
#define UTF8JSON_FORMATTERS_INT64FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C455720)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int Int64Formatter_TypeDefinitionIndex = 85770;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::Int64Formatter**)Il2CppClass::FromTypeDefinitionIndex(Int64Formatter_TypeDefinitionIndex)->GetStaticField(0x4A0E0);
		}
