...
#define UTF8JSON_FORMATTERS_INT64FORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1E795D30)
#define UTF8JSON_FORMATTERS_INT64FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E795C00)
#define UTF8JSON_FORMATTERS_INT64FORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1E795C80)
#define UTF8JSON_FORMATTERS_INT64FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E795BD0)
#define UTF8JSON_FORMATTERS_INT64FORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E795D70)
#define UTF8JSON_FORMATTERS_INT64FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E795D60)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int Int64Formatter_TypeDefinitionIndex = 91344;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::Int64Formatter**)Il2CppClass::FromTypeDefinitionIndex(Int64Formatter_TypeDefinitionIndex)->GetStaticField(0x4E830);
		}
