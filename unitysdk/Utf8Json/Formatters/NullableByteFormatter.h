...
#define UTF8JSON_FORMATTERS_NULLABLEBYTEFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1F910E90)
#define UTF8JSON_FORMATTERS_NULLABLEBYTEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1F910D70)
#define UTF8JSON_FORMATTERS_NULLABLEBYTEFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1F910DB0)
#define UTF8JSON_FORMATTERS_NULLABLEBYTEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1F910D10)
#define UTF8JSON_FORMATTERS_NULLABLEBYTEFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F910F30)
#define UTF8JSON_FORMATTERS_NULLABLEBYTEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F910F20)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int NullableByteFormatter_TypeDefinitionIndex = 95281;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::NullableByteFormatter**)Il2CppClass::FromTypeDefinitionIndex(NullableByteFormatter_TypeDefinitionIndex)->GetStaticField(0x53090);
		}
