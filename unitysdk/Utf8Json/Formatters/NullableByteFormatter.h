...
#define UTF8JSON_FORMATTERS_NULLABLEBYTEFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1C1D11D0)
#define UTF8JSON_FORMATTERS_NULLABLEBYTEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C1D10B0)
#define UTF8JSON_FORMATTERS_NULLABLEBYTEFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1C1D10F0)
#define UTF8JSON_FORMATTERS_NULLABLEBYTEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C1D1050)
#define UTF8JSON_FORMATTERS_NULLABLEBYTEFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C1D1270)
#define UTF8JSON_FORMATTERS_NULLABLEBYTEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1D1260)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int NullableByteFormatter_TypeDefinitionIndex = 85774;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::NullableByteFormatter**)Il2CppClass::FromTypeDefinitionIndex(NullableByteFormatter_TypeDefinitionIndex)->GetStaticField(0x4A790);
		}
