...
#define UTF8JSON_FORMATTERS_SBYTEFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1FB717F0)
#define UTF8JSON_FORMATTERS_SBYTEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1FB71730)
#define UTF8JSON_FORMATTERS_SBYTEFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1FB71740)
#define UTF8JSON_FORMATTERS_SBYTEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1FB71700)
#define UTF8JSON_FORMATTERS_SBYTEFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FB71870)
#define UTF8JSON_FORMATTERS_SBYTEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FB71860)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int SByteFormatter_TypeDefinitionIndex = 95268;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::SByteFormatter**)Il2CppClass::FromTypeDefinitionIndex(SByteFormatter_TypeDefinitionIndex)->GetStaticField(0x52A20);
		}
