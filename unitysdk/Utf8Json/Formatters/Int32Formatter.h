...
#define UTF8JSON_FORMATTERS_INT32FORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1C2D82A0)
#define UTF8JSON_FORMATTERS_INT32FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C2D81E0)
#define UTF8JSON_FORMATTERS_INT32FORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1C2D81F0)
#define UTF8JSON_FORMATTERS_INT32FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C2D81B0)
#define UTF8JSON_FORMATTERS_INT32FORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C2D8320)
#define UTF8JSON_FORMATTERS_INT32FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2D8310)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int Int32Formatter_TypeDefinitionIndex = 85767;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::Int32Formatter**)Il2CppClass::FromTypeDefinitionIndex(Int32Formatter_TypeDefinitionIndex)->GetStaticField(0x4A590);
		}
