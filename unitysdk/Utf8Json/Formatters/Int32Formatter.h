...
#define UTF8JSON_FORMATTERS_INT32FORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1E629B60)
#define UTF8JSON_FORMATTERS_INT32FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E629AA0)
#define UTF8JSON_FORMATTERS_INT32FORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1E629AB0)
#define UTF8JSON_FORMATTERS_INT32FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E629A70)
#define UTF8JSON_FORMATTERS_INT32FORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E629BE0)
#define UTF8JSON_FORMATTERS_INT32FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E629BD0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int Int32Formatter_TypeDefinitionIndex = 91341;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::Int32Formatter**)Il2CppClass::FromTypeDefinitionIndex(Int32Formatter_TypeDefinitionIndex)->GetStaticField(0x4ECE0);
		}
