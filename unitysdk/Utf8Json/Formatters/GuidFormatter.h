...
#define UTF8JSON_FORMATTERS_GUIDFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1E73CE30)
#define UTF8JSON_FORMATTERS_GUIDFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E73CCA0)
#define UTF8JSON_FORMATTERS_GUIDFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1E73CCE0)
#define UTF8JSON_FORMATTERS_GUIDFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E73CB60)
#define UTF8JSON_FORMATTERS_GUIDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E73CE80)
#define UTF8JSON_FORMATTERS_GUIDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E73CE70)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int GuidFormatter_TypeDefinitionIndex = 91375;
	...
	public:
		...
		{
			return (::Utf8Json::IJsonFormatter_1<::System::Guid>**)Il2CppClass::FromTypeDefinitionIndex(GuidFormatter_TypeDefinitionIndex)->GetStaticField(0x4EF30);
		}
