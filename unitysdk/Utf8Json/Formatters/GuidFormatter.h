...
#define UTF8JSON_FORMATTERS_GUIDFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1FB23940)
#define UTF8JSON_FORMATTERS_GUIDFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1FB237B0)
#define UTF8JSON_FORMATTERS_GUIDFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1FB237F0)
#define UTF8JSON_FORMATTERS_GUIDFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1FB23670)
#define UTF8JSON_FORMATTERS_GUIDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FB23990)
#define UTF8JSON_FORMATTERS_GUIDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FB23980)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int GuidFormatter_TypeDefinitionIndex = 95308;
	...
	public:
		...
		{
			return (::Utf8Json::IJsonFormatter_1<::System::Guid>**)Il2CppClass::FromTypeDefinitionIndex(GuidFormatter_TypeDefinitionIndex)->GetStaticField(0x530E0);
		}
