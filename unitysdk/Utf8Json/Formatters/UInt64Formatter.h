...
#define UTF8JSON_FORMATTERS_UINT64FORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1E8562A0)
#define UTF8JSON_FORMATTERS_UINT64FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E856170)
#define UTF8JSON_FORMATTERS_UINT64FORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1E8561F0)
#define UTF8JSON_FORMATTERS_UINT64FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E856140)
#define UTF8JSON_FORMATTERS_UINT64FORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E8562E0)
#define UTF8JSON_FORMATTERS_UINT64FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8562D0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int UInt64Formatter_TypeDefinitionIndex = 91355;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::UInt64Formatter**)Il2CppClass::FromTypeDefinitionIndex(UInt64Formatter_TypeDefinitionIndex)->GetStaticField(0x4EE60);
		}
