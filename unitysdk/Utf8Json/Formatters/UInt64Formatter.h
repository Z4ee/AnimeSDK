...
#define UTF8JSON_FORMATTERS_UINT64FORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1C5229B0)
#define UTF8JSON_FORMATTERS_UINT64FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C522880)
#define UTF8JSON_FORMATTERS_UINT64FORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1C522900)
#define UTF8JSON_FORMATTERS_UINT64FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C522850)
#define UTF8JSON_FORMATTERS_UINT64FORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C5229F0)
#define UTF8JSON_FORMATTERS_UINT64FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5229E0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int UInt64Formatter_TypeDefinitionIndex = 85781;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::UInt64Formatter**)Il2CppClass::FromTypeDefinitionIndex(UInt64Formatter_TypeDefinitionIndex)->GetStaticField(0x4A710);
		}
