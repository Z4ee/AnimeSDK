...
#define UTF8JSON_FORMATTERS_NULLABLEBOOLEANFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1F959F20)
#define UTF8JSON_FORMATTERS_NULLABLEBOOLEANFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1F959E00)
#define UTF8JSON_FORMATTERS_NULLABLEBOOLEANFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1F959E40)
#define UTF8JSON_FORMATTERS_NULLABLEBOOLEANFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1F959DA0)
#define UTF8JSON_FORMATTERS_NULLABLEBOOLEANFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F959F90)
#define UTF8JSON_FORMATTERS_NULLABLEBOOLEANFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F959F80)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int NullableBooleanFormatter_TypeDefinitionIndex = 95298;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::NullableBooleanFormatter**)Il2CppClass::FromTypeDefinitionIndex(NullableBooleanFormatter_TypeDefinitionIndex)->GetStaticField(0x53080);
		}
