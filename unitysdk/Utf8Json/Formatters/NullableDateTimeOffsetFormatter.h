...
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEOFFSETFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C21C630)
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEOFFSETFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C21C580)
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEOFFSETFORMATTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C21C530)
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEOFFSETFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C21C4E0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int NullableDateTimeOffsetFormatter_TypeDefinitionIndex = 85731;
