...
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEOFFSETFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1F95A120)
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEOFFSETFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1F95A070)
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEOFFSETFORMATTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F95A020)
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEOFFSETFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F959FD0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int NullableDateTimeOffsetFormatter_TypeDefinitionIndex = 95238;
