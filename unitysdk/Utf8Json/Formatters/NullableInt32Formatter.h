...
#define UTF8JSON_FORMATTERS_NULLABLEINT32FORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1DF5DDD0)
#define UTF8JSON_FORMATTERS_NULLABLEINT32FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1DF5DCA0)
#define UTF8JSON_FORMATTERS_NULLABLEINT32FORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1DF5DCE0)
#define UTF8JSON_FORMATTERS_NULLABLEINT32FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1DF5DC40)
#define UTF8JSON_FORMATTERS_NULLABLEINT32FORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DF5DE80)
#define UTF8JSON_FORMATTERS_NULLABLEINT32FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF5DE70)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int NullableInt32Formatter_TypeDefinitionIndex = 91342;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::NullableInt32Formatter**)Il2CppClass::FromTypeDefinitionIndex(NullableInt32Formatter_TypeDefinitionIndex)->GetStaticField(0x4E9E0);
		}
