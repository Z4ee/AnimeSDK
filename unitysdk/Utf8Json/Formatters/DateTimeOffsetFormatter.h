...
#define UTF8JSON_FORMATTERS_DATETIMEOFFSETFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C2D7BF0)
#define UTF8JSON_FORMATTERS_DATETIMEOFFSETFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C2D7BC0)
#define UTF8JSON_FORMATTERS_DATETIMEOFFSETFORMATTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C2D7BB0)
#define UTF8JSON_FORMATTERS_DATETIMEOFFSETFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2D7BA0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int DateTimeOffsetFormatter_TypeDefinitionIndex = 85730;
