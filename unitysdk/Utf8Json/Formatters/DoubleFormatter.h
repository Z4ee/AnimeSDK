...
#define UTF8JSON_FORMATTERS_DOUBLEFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1BFFB840)
#define UTF8JSON_FORMATTERS_DOUBLEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1BFFB610)
#define UTF8JSON_FORMATTERS_DOUBLEFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1BFFB730)
#define UTF8JSON_FORMATTERS_DOUBLEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1BFFB590)
#define UTF8JSON_FORMATTERS_DOUBLEFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BFFBA20)
#define UTF8JSON_FORMATTERS_DOUBLEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFFBA10)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int DoubleFormatter_TypeDefinitionIndex = 85787;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::DoubleFormatter**)Il2CppClass::FromTypeDefinitionIndex(DoubleFormatter_TypeDefinitionIndex)->GetStaticField(0x49F50);
		}
