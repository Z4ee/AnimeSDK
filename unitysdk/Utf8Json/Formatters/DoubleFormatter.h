...
#define UTF8JSON_FORMATTERS_DOUBLEFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1F743E20)
#define UTF8JSON_FORMATTERS_DOUBLEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1F743BF0)
#define UTF8JSON_FORMATTERS_DOUBLEFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1F743D10)
#define UTF8JSON_FORMATTERS_DOUBLEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1F743B70)
#define UTF8JSON_FORMATTERS_DOUBLEFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F744000)
#define UTF8JSON_FORMATTERS_DOUBLEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F743FF0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int DoubleFormatter_TypeDefinitionIndex = 95294;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::DoubleFormatter**)Il2CppClass::FromTypeDefinitionIndex(DoubleFormatter_TypeDefinitionIndex)->GetStaticField(0x52850);
		}
