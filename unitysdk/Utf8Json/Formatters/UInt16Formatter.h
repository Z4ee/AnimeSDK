...
#define UTF8JSON_FORMATTERS_UINT16FORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1FAE5AD0)
#define UTF8JSON_FORMATTERS_UINT16FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1FAE5A10)
#define UTF8JSON_FORMATTERS_UINT16FORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1FAE5A20)
#define UTF8JSON_FORMATTERS_UINT16FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1FAE59E0)
#define UTF8JSON_FORMATTERS_UINT16FORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FAE5B50)
#define UTF8JSON_FORMATTERS_UINT16FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FAE5B40)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int UInt16Formatter_TypeDefinitionIndex = 95282;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::UInt16Formatter**)Il2CppClass::FromTypeDefinitionIndex(UInt16Formatter_TypeDefinitionIndex)->GetStaticField(0x52DE0);
		}
