...
#define UTF8JSON_FORMATTERS_SINGLEFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1E50C810)
#define UTF8JSON_FORMATTERS_SINGLEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E50C6F0)
#define UTF8JSON_FORMATTERS_SINGLEFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1E50C700)
#define UTF8JSON_FORMATTERS_SINGLEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E50C670)
#define UTF8JSON_FORMATTERS_SINGLEFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E50C850)
#define UTF8JSON_FORMATTERS_SINGLEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E50C840)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int SingleFormatter_TypeDefinitionIndex = 91358;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::SingleFormatter**)Il2CppClass::FromTypeDefinitionIndex(SingleFormatter_TypeDefinitionIndex)->GetStaticField(0x4EE70);
		}
