...
#define UTF8JSON_FORMATTERS_BOOLEANFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1E162130)
#define UTF8JSON_FORMATTERS_BOOLEANFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E162080)
#define UTF8JSON_FORMATTERS_BOOLEANFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1E162090)
#define UTF8JSON_FORMATTERS_BOOLEANFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E162070)
#define UTF8JSON_FORMATTERS_BOOLEANFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E162170)
#define UTF8JSON_FORMATTERS_BOOLEANFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E162160)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int BooleanFormatter_TypeDefinitionIndex = 91364;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::BooleanFormatter**)Il2CppClass::FromTypeDefinitionIndex(BooleanFormatter_TypeDefinitionIndex)->GetStaticField(0x4EE80);
		}
