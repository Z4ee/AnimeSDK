...
#define UTF8JSON_FORMATTERS_DATETIMEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1FB94CB0)
#define UTF8JSON_FORMATTERS_DATETIMEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1FB94C30)
#define UTF8JSON_FORMATTERS_DATETIMEFORMATTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1FB94C20)
#define UTF8JSON_FORMATTERS_DATETIMEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FB94C10)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int DateTimeFormatter_TypeDefinitionIndex = 95233;
