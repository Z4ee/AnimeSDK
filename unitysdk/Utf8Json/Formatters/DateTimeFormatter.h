...
#define UTF8JSON_FORMATTERS_DATETIMEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C4791B0)
#define UTF8JSON_FORMATTERS_DATETIMEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C479130)
#define UTF8JSON_FORMATTERS_DATETIMEFORMATTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C479120)
#define UTF8JSON_FORMATTERS_DATETIMEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C479110)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int DateTimeFormatter_TypeDefinitionIndex = 85726;
