...
#define UTF8JSON_FORMATTERS_BYTEFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1FBCD780)
#define UTF8JSON_FORMATTERS_BYTEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1FBCD6C0)
#define UTF8JSON_FORMATTERS_BYTEFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1FBCD6D0)
#define UTF8JSON_FORMATTERS_BYTEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1FBCD690)
#define UTF8JSON_FORMATTERS_BYTEFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FBCD800)
#define UTF8JSON_FORMATTERS_BYTEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBCD7F0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int ByteFormatter_TypeDefinitionIndex = 95280;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::ByteFormatter**)Il2CppClass::FromTypeDefinitionIndex(ByteFormatter_TypeDefinitionIndex)->GetStaticField(0x53040);
		}
