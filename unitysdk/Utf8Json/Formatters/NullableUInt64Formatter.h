...
#define UTF8JSON_FORMATTERS_NULLABLEUINT64FORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1FB24CA0)
#define UTF8JSON_FORMATTERS_NULLABLEUINT64FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1FB24AD0)
#define UTF8JSON_FORMATTERS_NULLABLEUINT64FORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1FB24B80)
#define UTF8JSON_FORMATTERS_NULLABLEUINT64FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1FB24A40)
#define UTF8JSON_FORMATTERS_NULLABLEUINT64FORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FB24D10)
#define UTF8JSON_FORMATTERS_NULLABLEUINT64FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FB24D00)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int NullableUInt64Formatter_TypeDefinitionIndex = 95289;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::NullableUInt64Formatter**)Il2CppClass::FromTypeDefinitionIndex(NullableUInt64Formatter_TypeDefinitionIndex)->GetStaticField(0x53060);
		}
