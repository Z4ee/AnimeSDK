...
#define UTF8JSON_FORMATTERS_ENUMFORMATTERHELPER_GETDESERIALIZEDELEGATE_OFFSET UNITYSDK_OFFSET(0x1E6CE220)
#define UTF8JSON_FORMATTERS_ENUMFORMATTERHELPER_GETSERIALIZEDELEGATE_OFFSET UNITYSDK_OFFSET(0x1E6CDC80)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int EnumFormatterHelper_TypeDefinitionIndex = 91323;
