...
#define UTF8JSON_FORMATTERS_INT16FORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1FBCD930)
#define UTF8JSON_FORMATTERS_INT16FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1FBCD870)
#define UTF8JSON_FORMATTERS_INT16FORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1FBCD880)
#define UTF8JSON_FORMATTERS_INT16FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1FBCD840)
#define UTF8JSON_FORMATTERS_INT16FORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FBCD9B0)
#define UTF8JSON_FORMATTERS_INT16FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBCD9A0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int Int16Formatter_TypeDefinitionIndex = 95271;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::Int16Formatter**)Il2CppClass::FromTypeDefinitionIndex(Int16Formatter_TypeDefinitionIndex)->GetStaticField(0x52FF0);
		}
