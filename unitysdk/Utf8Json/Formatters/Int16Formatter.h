...
#define UTF8JSON_FORMATTERS_INT16FORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1C4B7E80)
#define UTF8JSON_FORMATTERS_INT16FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C4B7DC0)
#define UTF8JSON_FORMATTERS_INT16FORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1C4B7DD0)
#define UTF8JSON_FORMATTERS_INT16FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C4B7D90)
#define UTF8JSON_FORMATTERS_INT16FORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C4B7F00)
#define UTF8JSON_FORMATTERS_INT16FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4B7EF0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int Int16Formatter_TypeDefinitionIndex = 85764;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::Int16Formatter**)Il2CppClass::FromTypeDefinitionIndex(Int16Formatter_TypeDefinitionIndex)->GetStaticField(0x4A6F0);
		}
