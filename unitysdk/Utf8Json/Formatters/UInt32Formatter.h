...
#define UTF8JSON_FORMATTERS_UINT32FORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1FB24E40)
#define UTF8JSON_FORMATTERS_UINT32FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1FB24D80)
#define UTF8JSON_FORMATTERS_UINT32FORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1FB24D90)
#define UTF8JSON_FORMATTERS_UINT32FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1FB24D50)
#define UTF8JSON_FORMATTERS_UINT32FORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FB24EC0)
#define UTF8JSON_FORMATTERS_UINT32FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FB24EB0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int UInt32Formatter_TypeDefinitionIndex = 95285;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::UInt32Formatter**)Il2CppClass::FromTypeDefinitionIndex(UInt32Formatter_TypeDefinitionIndex)->GetStaticField(0x53000);
		}
