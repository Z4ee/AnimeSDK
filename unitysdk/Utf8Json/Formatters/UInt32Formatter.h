...
#define UTF8JSON_FORMATTERS_UINT32FORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1C3FC8A0)
#define UTF8JSON_FORMATTERS_UINT32FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C3FC7E0)
#define UTF8JSON_FORMATTERS_UINT32FORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1C3FC7F0)
#define UTF8JSON_FORMATTERS_UINT32FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C3FC7B0)
#define UTF8JSON_FORMATTERS_UINT32FORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C3FC920)
#define UTF8JSON_FORMATTERS_UINT32FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3FC910)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int UInt32Formatter_TypeDefinitionIndex = 85778;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::UInt32Formatter**)Il2CppClass::FromTypeDefinitionIndex(UInt32Formatter_TypeDefinitionIndex)->GetStaticField(0x4A700);
		}
