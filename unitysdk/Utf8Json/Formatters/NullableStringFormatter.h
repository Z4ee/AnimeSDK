...
#define UTF8JSON_FORMATTERS_NULLABLESTRINGFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1FAB28F0)
#define UTF8JSON_FORMATTERS_NULLABLESTRINGFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1FAB28D0)
#define UTF8JSON_FORMATTERS_NULLABLESTRINGFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1FAB28E0)
#define UTF8JSON_FORMATTERS_NULLABLESTRINGFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1FAB28C0)
#define UTF8JSON_FORMATTERS_NULLABLESTRINGFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FAB2910)
#define UTF8JSON_FORMATTERS_NULLABLESTRINGFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FAB2900)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int NullableStringFormatter_TypeDefinitionIndex = 95303;
	...
	public:
		...
		{
			return (::Utf8Json::IJsonFormatter_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(NullableStringFormatter_TypeDefinitionIndex)->GetStaticField(0x52FD0);
		}
