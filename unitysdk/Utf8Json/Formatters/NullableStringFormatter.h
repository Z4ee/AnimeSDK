...
#define UTF8JSON_FORMATTERS_NULLABLESTRINGFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1E6CEA50)
#define UTF8JSON_FORMATTERS_NULLABLESTRINGFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E6CEA30)
#define UTF8JSON_FORMATTERS_NULLABLESTRINGFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1E6CEA40)
#define UTF8JSON_FORMATTERS_NULLABLESTRINGFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1E6CEA20)
#define UTF8JSON_FORMATTERS_NULLABLESTRINGFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E6CEA70)
#define UTF8JSON_FORMATTERS_NULLABLESTRINGFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6CEA60)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int NullableStringFormatter_TypeDefinitionIndex = 91370;
	...
	public:
		...
		{
			return (::Utf8Json::IJsonFormatter_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(NullableStringFormatter_TypeDefinitionIndex)->GetStaticField(0x4EE20);
		}
