...
#define UTF8JSON_INTERNAL_STRINGMUTATOR_ORIGINAL_OFFSET UNITYSDK_OFFSET(0x1FBCE910)
#define UTF8JSON_INTERNAL_STRINGMUTATOR_TOCAMELCASE_OFFSET UNITYSDK_OFFSET(0x1FBCE920)
#define UTF8JSON_INTERNAL_STRINGMUTATOR_TOSNAKECASE_OFFSET UNITYSDK_OFFSET(0x1FBCEAA0)

namespace Utf8Json::Internal
{
	inline static constexpr unsigned int StringMutator_TypeDefinitionIndex = 95176;
