...
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1FBCE010)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_REFLECTION_PROPERTYINFO__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1FBCE810)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_REFLECTION_PROPERTYINFO__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1FBCE7A0)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1FBCE890)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1FBCE800)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1FBCE7B0)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1FBCDCD0)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBCDCB0)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1FBCDE50)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1FBCDF30)

namespace Utf8Json::Internal
{
	inline static constexpr unsigned int ReflectionExtensions__GetAllPropertiesCore_d__4_TypeDefinitionIndex = 95173;

	class ReflectionExtensions__GetAllPropertiesCore_d__4 : public ::System::Object
	{
	public:
		::System::Collections::Generic::HashSet_1<::System::String*>* nameCheck; // 0x10
		...
		::System::Collections::Generic::IEnumerator_1<::System::Reflection::PropertyInfo*>* __7__wrap1; // 0x38
