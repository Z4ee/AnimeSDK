...
#define UTF8JSON_INTERNAL_EMIT_METAMEMBER_EMITLOADVALUE_OFFSET UNITYSDK_OFFSET(0x1C3C5B90)
#define UTF8JSON_INTERNAL_EMIT_METAMEMBER_EMITSTOREVALUE_OFFSET UNITYSDK_OFFSET(0x1C3C5C20)
#define UTF8JSON_INTERNAL_EMIT_METAMEMBER_GETSHOULDSERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C3C5890)
#define UTF8JSON_INTERNAL_EMIT_METAMEMBER_GET_FIELDINFO_OFFSET UNITYSDK_OFFSET(0x1C3C5750)
#define UTF8JSON_INTERNAL_EMIT_METAMEMBER_GET_ISFIELD_OFFSET UNITYSDK_OFFSET(0x1C3C56E0)
#define UTF8JSON_INTERNAL_EMIT_METAMEMBER_GET_ISPROPERTY_OFFSET UNITYSDK_OFFSET(0x1C3C56D0)
#define UTF8JSON_INTERNAL_EMIT_METAMEMBER_GET_ISREADABLE_OFFSET UNITYSDK_OFFSET(0x1C3C5710)
#define UTF8JSON_INTERNAL_EMIT_METAMEMBER_GET_ISWRITABLE_OFFSET UNITYSDK_OFFSET(0x1C3C56F0)
#define UTF8JSON_INTERNAL_EMIT_METAMEMBER_GET_MEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1C3C56B0)
#define UTF8JSON_INTERNAL_EMIT_METAMEMBER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1C3C5690)
#define UTF8JSON_INTERNAL_EMIT_METAMEMBER_GET_PROPERTYINFO_OFFSET UNITYSDK_OFFSET(0x1C3C5770)
#define UTF8JSON_INTERNAL_EMIT_METAMEMBER_GET_SHOULDSERIALIZEMETHODINFO_OFFSET UNITYSDK_OFFSET(0x1C3C5790)
#define UTF8JSON_INTERNAL_EMIT_METAMEMBER_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1C3C5730)
#define UTF8JSON_INTERNAL_EMIT_METAMEMBER_SET_FIELDINFO_OFFSET UNITYSDK_OFFSET(0x1C3C5760)
#define UTF8JSON_INTERNAL_EMIT_METAMEMBER_SET_ISREADABLE_OFFSET UNITYSDK_OFFSET(0x1C3C5720)
#define UTF8JSON_INTERNAL_EMIT_METAMEMBER_SET_ISWRITABLE_OFFSET UNITYSDK_OFFSET(0x1C3C5700)
#define UTF8JSON_INTERNAL_EMIT_METAMEMBER_SET_MEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1C3C56C0)
#define UTF8JSON_INTERNAL_EMIT_METAMEMBER_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1C3C56A0)
#define UTF8JSON_INTERNAL_EMIT_METAMEMBER_SET_PROPERTYINFO_OFFSET UNITYSDK_OFFSET(0x1C3C5780)
#define UTF8JSON_INTERNAL_EMIT_METAMEMBER_SET_SHOULDSERIALIZEMETHODINFO_OFFSET UNITYSDK_OFFSET(0x1C3C57A0)
#define UTF8JSON_INTERNAL_EMIT_METAMEMBER_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1C3C5740)
#define UTF8JSON_INTERNAL_EMIT_METAMEMBER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C3C57D0)
#define UTF8JSON_INTERNAL_EMIT_METAMEMBER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C3C59A0)
#define UTF8JSON_INTERNAL_EMIT_METAMEMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3C57B0)

namespace Utf8Json::Internal::Emit
{
	inline static constexpr unsigned int MetaMember_TypeDefinitionIndex = 85678;
	...
	public:
		...
		::System::Reflection::FieldInfo* _FieldInfo_k__BackingField; // 0x28
		::System::Reflection::MethodInfo* getMethod; // 0x30
		::System::Reflection::MethodInfo* setMethod; // 0x38
		::System::String* _MemberName_k__BackingField; // 0x40
