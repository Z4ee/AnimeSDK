...
#define UTF8JSON_INTERNAL_EMIT_STRINGCONSTANTVALUEMETAMEMBER_EMITLOADVALUE_OFFSET UNITYSDK_OFFSET(0x1E11D580)
#define UTF8JSON_INTERNAL_EMIT_STRINGCONSTANTVALUEMETAMEMBER_EMITSTOREVALUE_OFFSET UNITYSDK_OFFSET(0x1E11D620)
#define UTF8JSON_INTERNAL_EMIT_STRINGCONSTANTVALUEMETAMEMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E11D520)

namespace Utf8Json::Internal::Emit
{
	inline static constexpr unsigned int StringConstantValueMetaMember_TypeDefinitionIndex = 91254;
