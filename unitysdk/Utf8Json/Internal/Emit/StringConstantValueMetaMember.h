...
#define UTF8JSON_INTERNAL_EMIT_STRINGCONSTANTVALUEMETAMEMBER_EMITLOADVALUE_OFFSET UNITYSDK_OFFSET(0x1BDD55E0)
#define UTF8JSON_INTERNAL_EMIT_STRINGCONSTANTVALUEMETAMEMBER_EMITSTOREVALUE_OFFSET UNITYSDK_OFFSET(0x1BDD5680)
#define UTF8JSON_INTERNAL_EMIT_STRINGCONSTANTVALUEMETAMEMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDD5580)

namespace Utf8Json::Internal::Emit
{
	inline static constexpr unsigned int StringConstantValueMetaMember_TypeDefinitionIndex = 85680;
