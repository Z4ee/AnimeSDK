...
#define UTF8JSON_INTERNAL_EMIT_ARGUMENTFIELD_EMITLOAD_OFFSET UNITYSDK_OFFSET(0xAAFE10)
#define UTF8JSON_INTERNAL_EMIT_ARGUMENTFIELD_EMITSTORE_OFFSET UNITYSDK_OFFSET(0xAAFE30)
#define UTF8JSON_INTERNAL_EMIT_ARGUMENTFIELD__CTOR_1_OFFSET UNITYSDK_OFFSET(0xAAFD30)
#define UTF8JSON_INTERNAL_EMIT_ARGUMENTFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0xA372D0)

namespace Utf8Json::Internal::Emit
{
	inline static constexpr unsigned int ArgumentField_TypeDefinitionIndex = 95182;
