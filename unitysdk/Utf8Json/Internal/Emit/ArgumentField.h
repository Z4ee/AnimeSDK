...
#define UTF8JSON_INTERNAL_EMIT_ARGUMENTFIELD_EMITLOAD_OFFSET UNITYSDK_OFFSET(0xA5F1B0)
#define UTF8JSON_INTERNAL_EMIT_ARGUMENTFIELD_EMITSTORE_OFFSET UNITYSDK_OFFSET(0xA5F1D0)
#define UTF8JSON_INTERNAL_EMIT_ARGUMENTFIELD__CTOR_1_OFFSET UNITYSDK_OFFSET(0xA5F0D0)
#define UTF8JSON_INTERNAL_EMIT_ARGUMENTFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x9EB520)

namespace Utf8Json::Internal::Emit
{
	inline static constexpr unsigned int ArgumentField_TypeDefinitionIndex = 91249;
