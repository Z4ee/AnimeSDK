...
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_ADD_1_OFFSET UNITYSDK_OFFSET(0x1FA1A050)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_ADD_OFFSET UNITYSDK_OFFSET(0x1FA19DD0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_BINARYSEARCH_OFFSET UNITYSDK_OFFSET(0x1FA1A270)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1FA1A4E0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_EMITSEARCHNEXTCORE_OFFSET UNITYSDK_OFFSET(0x1FA1A6B0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_EMITSEARCHNEXT_OFFSET UNITYSDK_OFFSET(0x1FA1A570)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_GET_HASCHILDREN_OFFSET UNITYSDK_OFFSET(0x1FA19D40)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_SEARCHNEXTSAFE_OFFSET UNITYSDK_OFFSET(0x1FA1A2F0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_SEARCHNEXT_OFFSET UNITYSDK_OFFSET(0x1FA1A080)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_YIELDCHILDREN_OFFSET UNITYSDK_OFFSET(0x1FA1A510)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FA1BAF0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1FA19D50)

namespace Utf8Json::Internal
{
	inline static constexpr unsigned int AutomataDictionary_AutomataNode_TypeDefinitionIndex = 95158;
	...
	public:
		...
		{
			return (::Il2CppArray<::Utf8Json::Internal::AutomataDictionary_AutomataNode*>**)Il2CppClass::FromTypeDefinitionIndex(AutomataDictionary_AutomataNode_TypeDefinitionIndex)->GetStaticField(0x52ED0);
		}
		static ::Il2CppArray<::System::UInt64>** StaticGet_emptyKeys()
		{
			return (::Il2CppArray<::System::UInt64>**)Il2CppClass::FromTypeDefinitionIndex(AutomataDictionary_AutomataNode_TypeDefinitionIndex)->GetStaticField(0x52ED8);
		}
		::Il2CppArray<::System::UInt64>* nextKeys; // 0x10
		::Il2CppArray<::Utf8Json::Internal::AutomataDictionary_AutomataNode*>* nexts; // 0x18
