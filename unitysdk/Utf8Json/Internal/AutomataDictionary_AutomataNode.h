...
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_ADD_1_OFFSET UNITYSDK_OFFSET(0x1C2D9620)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_ADD_OFFSET UNITYSDK_OFFSET(0x1C2D93A0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_BINARYSEARCH_OFFSET UNITYSDK_OFFSET(0x1C2D9850)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1C2D9AE0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_EMITSEARCHNEXTCORE_OFFSET UNITYSDK_OFFSET(0x1C2D9CB0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_EMITSEARCHNEXT_OFFSET UNITYSDK_OFFSET(0x1C2D9B70)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_GET_HASCHILDREN_OFFSET UNITYSDK_OFFSET(0x1C2D9310)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_SEARCHNEXTSAFE_OFFSET UNITYSDK_OFFSET(0x1C2D98D0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_SEARCHNEXT_OFFSET UNITYSDK_OFFSET(0x1C2D9650)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_YIELDCHILDREN_OFFSET UNITYSDK_OFFSET(0x1C2D9B10)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C2DB0C0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2D9320)

namespace Utf8Json::Internal
{
	inline static constexpr unsigned int AutomataDictionary_AutomataNode_TypeDefinitionIndex = 85651;
	...
	public:
		...
		{
			return (::Il2CppArray<::Utf8Json::Internal::AutomataDictionary_AutomataNode*>**)Il2CppClass::FromTypeDefinitionIndex(AutomataDictionary_AutomataNode_TypeDefinitionIndex)->GetStaticField(0x4A5D0);
		}
		static ::Il2CppArray<::System::UInt64>** StaticGet_emptyKeys()
		{
			return (::Il2CppArray<::System::UInt64>**)Il2CppClass::FromTypeDefinitionIndex(AutomataDictionary_AutomataNode_TypeDefinitionIndex)->GetStaticField(0x4A5D8);
		}
		::Il2CppArray<::Utf8Json::Internal::AutomataDictionary_AutomataNode*>* nexts; // 0x10
