...
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE___C__DISPLAYCLASS19_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C33C630)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE___C__DISPLAYCLASS19_0__EMITSEARCHNEXTCORE_B__2_OFFSET UNITYSDK_OFFSET(0x1C33C670)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE___C__DISPLAYCLASS19_0__EMITSEARCHNEXTCORE_B__3_OFFSET UNITYSDK_OFFSET(0x1C33C640)

namespace Utf8Json::Internal
{
	inline static constexpr unsigned int AutomataDictionary_AutomataNode___c__DisplayClass19_0_TypeDefinitionIndex = 85653;
