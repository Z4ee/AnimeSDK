...
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_ISNUMBERREPRESENTATION_OFFSET UNITYSDK_OFFSET(0x1F536AA0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_ISNUMBER_OFFSET UNITYSDK_OFFSET(0x1F536A90)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1F5387C0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READBYTE_OFFSET UNITYSDK_OFFSET(0x1F536CB0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READDOUBLE_OFFSET UNITYSDK_OFFSET(0x1F536FE0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READINT16_OFFSET UNITYSDK_OFFSET(0x1F536BE0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READINT32_OFFSET UNITYSDK_OFFSET(0x1F536C40)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READINT64_OFFSET UNITYSDK_OFFSET(0x1F536B20)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READSBYTE_OFFSET UNITYSDK_OFFSET(0x1F536AC0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READSINGLE_OFFSET UNITYSDK_OFFSET(0x1F536F00)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READUINT16_OFFSET UNITYSDK_OFFSET(0x1F536E30)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READUINT32_OFFSET UNITYSDK_OFFSET(0x1F536E90)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READUINT64_OFFSET UNITYSDK_OFFSET(0x1F536D10)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1F5370C0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITEDOUBLE_OFFSET UNITYSDK_OFFSET(0x1F538750)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITEINT16_OFFSET UNITYSDK_OFFSET(0x1F5386C0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITEINT32_OFFSET UNITYSDK_OFFSET(0x1F5386D0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITEINT64_OFFSET UNITYSDK_OFFSET(0x1F5379D0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITESBYTE_OFFSET UNITYSDK_OFFSET(0x1F5379C0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITESINGLE_OFFSET UNITYSDK_OFFSET(0x1F5386E0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITEUINT16_OFFSET UNITYSDK_OFFSET(0x1F5379A0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITEUINT32_OFFSET UNITYSDK_OFFSET(0x1F5379B0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITEUINT64_OFFSET UNITYSDK_OFFSET(0x1F5370D0)

namespace Utf8Json::Internal
{
	inline static constexpr unsigned int NumberConverter_TypeDefinitionIndex = 95171;
