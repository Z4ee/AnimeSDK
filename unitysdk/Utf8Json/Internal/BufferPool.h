...
#define UTF8JSON_INTERNAL_BUFFERPOOL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E568F20)
#define UTF8JSON_INTERNAL_BUFFERPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1E568EB0)

namespace Utf8Json::Internal
{
	inline static constexpr unsigned int BufferPool_TypeDefinitionIndex = 91222;
	...
	public:
		...
		{
			return (::Utf8Json::Internal::BufferPool**)Il2CppClass::FromTypeDefinitionIndex(BufferPool_TypeDefinitionIndex)->GetStaticField(0x4F170);
		}
