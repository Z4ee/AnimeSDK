...
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS_GETALLFIELDSCORE_OFFSET UNITYSDK_OFFSET(0x1DF5EE30)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS_GETALLFIELDS_OFFSET UNITYSDK_OFFSET(0x1DF5ED10)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS_GETALLPROPERTIESCORE_OFFSET UNITYSDK_OFFSET(0x1DF5ECB0)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS_GETALLPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1DF5EB90)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS_ISANONYMOUS_OFFSET UNITYSDK_OFFSET(0x1DF5EA80)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS_ISNULLABLE_OFFSET UNITYSDK_OFFSET(0x1DF5E9E0)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS_ISPUBLIC_OFFSET UNITYSDK_OFFSET(0x1DF5EA50)

namespace Utf8Json::Internal
{
	inline static constexpr unsigned int ReflectionExtensions_TypeDefinitionIndex = 91239;
