...
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS_GETALLFIELDSCORE_OFFSET UNITYSDK_OFFSET(0x1BBFB060)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS_GETALLFIELDS_OFFSET UNITYSDK_OFFSET(0x1BBFAF40)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS_GETALLPROPERTIESCORE_OFFSET UNITYSDK_OFFSET(0x1BBFAEE0)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS_GETALLPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1BBFADC0)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS_ISANONYMOUS_OFFSET UNITYSDK_OFFSET(0x1BBFACB0)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS_ISNULLABLE_OFFSET UNITYSDK_OFFSET(0x1BBFAC10)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS_ISPUBLIC_OFFSET UNITYSDK_OFFSET(0x1BBFAC80)

namespace Utf8Json::Internal
{
	inline static constexpr unsigned int ReflectionExtensions_TypeDefinitionIndex = 85665;
