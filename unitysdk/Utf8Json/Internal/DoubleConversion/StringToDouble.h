...
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_ADJUSTMENTPOWEROFTEN_OFFSET UNITYSDK_OFFSET(0x1C3C4A70)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_COMPUTEGUESS_OFFSET UNITYSDK_OFFSET(0x1C3C5090)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_CUTTOMAXSIGNIFICANTDIGITS_OFFSET UNITYSDK_OFFSET(0x1C3C4140)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_DIYFPSTRTOD_OFFSET UNITYSDK_OFFSET(0x1C3C4BB0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_DOUBLESTRTOD_OFFSET UNITYSDK_OFFSET(0x1C3C4610)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_GETCOPYBUFFER_OFFSET UNITYSDK_OFFSET(0x1C3C3E80)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_READDIYFP_OFFSET UNITYSDK_OFFSET(0x1C3C44B0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_READUINT64_OFFSET UNITYSDK_OFFSET(0x1C3C4420)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_STRTOD_OFFSET UNITYSDK_OFFSET(0x1C3C51C0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_STRTOF_OFFSET UNITYSDK_OFFSET(0x1C3C52B0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_TRIMANDCUT_OFFSET UNITYSDK_OFFSET(0x1C3C4200)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_TRIMLEADINGZEROS_OFFSET UNITYSDK_OFFSET(0x1C3C4000)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_TRIMTRAILINGZEROS_OFFSET UNITYSDK_OFFSET(0x1C3C40B0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C3C5540)

namespace Utf8Json::Internal::DoubleConversion
{
	inline static constexpr unsigned int StringToDouble_TypeDefinitionIndex = 85698;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Double>**)Il2CppClass::FromTypeDefinitionIndex(StringToDouble_TypeDefinitionIndex)->GetStaticField(0x4A4F0);
		}
		static ::System::Int32* StaticGet_kExactPowersOfTenSize()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(StringToDouble_TypeDefinitionIndex)->GetStaticField(0x12020);
		}
