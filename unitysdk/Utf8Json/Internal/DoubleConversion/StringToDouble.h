...
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_ADJUSTMENTPOWEROFTEN_OFFSET UNITYSDK_OFFSET(0x1E709140)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_COMPUTEGUESS_OFFSET UNITYSDK_OFFSET(0x1E709760)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_CUTTOMAXSIGNIFICANTDIGITS_OFFSET UNITYSDK_OFFSET(0x1E708810)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_DIYFPSTRTOD_OFFSET UNITYSDK_OFFSET(0x1E709280)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_DOUBLESTRTOD_OFFSET UNITYSDK_OFFSET(0x1E708CE0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_GETCOPYBUFFER_OFFSET UNITYSDK_OFFSET(0x1E708550)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_READDIYFP_OFFSET UNITYSDK_OFFSET(0x1E708B80)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_READUINT64_OFFSET UNITYSDK_OFFSET(0x1E708AF0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_STRTOD_OFFSET UNITYSDK_OFFSET(0x1E709890)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_STRTOF_OFFSET UNITYSDK_OFFSET(0x1E709980)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_TRIMANDCUT_OFFSET UNITYSDK_OFFSET(0x1E7088D0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_TRIMLEADINGZEROS_OFFSET UNITYSDK_OFFSET(0x1E7086D0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_TRIMTRAILINGZEROS_OFFSET UNITYSDK_OFFSET(0x1E708780)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E709C10)

namespace Utf8Json::Internal::DoubleConversion
{
	inline static constexpr unsigned int StringToDouble_TypeDefinitionIndex = 91272;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Double>**)Il2CppClass::FromTypeDefinitionIndex(StringToDouble_TypeDefinitionIndex)->GetStaticField(0x4EC40);
		}
		static ::System::Int32* StaticGet_kExactPowersOfTenSize()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(StringToDouble_TypeDefinitionIndex)->GetStaticField(0x12E90);
		}
