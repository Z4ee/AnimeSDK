...
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_ASDIYFP_OFFSET UNITYSDK_OFFSET(0xA74EC0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_ASUINT32_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_EXPONENT_OFFSET UNITYSDK_OFFSET(0xA74F10)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_INFINITY_OFFSET UNITYSDK_OFFSET(0x1E6860F0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_ISDENORMAL_OFFSET UNITYSDK_OFFSET(0xA74F50)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_ISINFINITE_OFFSET UNITYSDK_OFFSET(0xA74F90)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_ISNAN_OFFSET UNITYSDK_OFFSET(0xA74F70)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_ISSPECIAL_OFFSET UNITYSDK_OFFSET(0xA74F60)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_LOWERBOUNDARYISCLOSER_OFFSET UNITYSDK_OFFSET(0xA750E0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_NAN_OFFSET UNITYSDK_OFFSET(0x1E686100)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_NORMALIZEDBOUNDARIES_OFFSET UNITYSDK_OFFSET(0xA74FC0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_SIGNIFICAND_OFFSET UNITYSDK_OFFSET(0xA74F30)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_SIGN_OFFSET UNITYSDK_OFFSET(0xA74FB0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_UPPERBOUNDARY_OFFSET UNITYSDK_OFFSET(0xA75090)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_VALUE_OFFSET UNITYSDK_OFFSET(0x45B300)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x55FE60)

namespace Utf8Json::Internal::DoubleConversion
{
	inline static constexpr unsigned int Single_TypeDefinitionIndex = 91268;
