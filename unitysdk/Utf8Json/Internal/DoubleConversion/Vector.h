...
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_VECTOR_FIRST_OFFSET UNITYSDK_OFFSET(0x9D6840)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_VECTOR_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x9D7A60)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_VECTOR_IS_EMPTY_OFFSET UNITYSDK_OFFSET(0x50CC50)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_VECTOR_LAST_OFFSET UNITYSDK_OFFSET(0x9D7AE0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_VECTOR_LENGTH_OFFSET UNITYSDK_OFFSET(0x2F1C00)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_VECTOR_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x9D7AA0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_VECTOR_SUBVECTOR_OFFSET UNITYSDK_OFFSET(0x9D7B20)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_VECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x2F3700)

namespace Utf8Json::Internal::DoubleConversion
{
	inline static constexpr unsigned int Vector_TypeDefinitionIndex = 85697;
