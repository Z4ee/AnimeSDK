...
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_MINUS_OFFSET UNITYSDK_OFFSET(0x1E770280)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0xA79150)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_NORMALIZE_1_OFFSET UNITYSDK_OFFSET(0x1E7704B0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_NORMALIZE_OFFSET UNITYSDK_OFFSET(0xA791C0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1E7703C0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1E7702A0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_SUBTRACT_OFFSET UNITYSDK_OFFSET(0xA79140)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_TIMES_OFFSET UNITYSDK_OFFSET(0x1E770330)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP__CTOR_OFFSET UNITYSDK_OFFSET(0x332CF0)

namespace Utf8Json::Internal::DoubleConversion
{
	inline static constexpr unsigned int DiyFp_TypeDefinitionIndex = 91259;
