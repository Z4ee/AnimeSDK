...
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_MINUS_OFFSET UNITYSDK_OFFSET(0x1C42B620)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x9D7940)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_NORMALIZE_1_OFFSET UNITYSDK_OFFSET(0x1C42B850)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x9D79B0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1C42B760)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1C42B640)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_SUBTRACT_OFFSET UNITYSDK_OFFSET(0x9D7930)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_TIMES_OFFSET UNITYSDK_OFFSET(0x1C42B6D0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP__CTOR_OFFSET UNITYSDK_OFFSET(0x39EDC0)

namespace Utf8Json::Internal::DoubleConversion
{
	inline static constexpr unsigned int DiyFp_TypeDefinitionIndex = 85685;
