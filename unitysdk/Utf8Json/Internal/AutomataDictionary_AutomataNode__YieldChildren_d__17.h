...
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE__YIELDCHILDREN_D__17_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1C522A60)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE__YIELDCHILDREN_D__17_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1C522B60)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE__YIELDCHILDREN_D__17_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C522AF0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE__YIELDCHILDREN_D__17_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1C522BE0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE__YIELDCHILDREN_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C522B50)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE__YIELDCHILDREN_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1C522B00)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE__YIELDCHILDREN_D__17_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C522A50)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE__YIELDCHILDREN_D__17__CTOR_OFFSET UNITYSDK_OFFSET(0x1C522A30)

namespace Utf8Json::Internal
{
	inline static constexpr unsigned int AutomataDictionary_AutomataNode__YieldChildren_d__17_TypeDefinitionIndex = 85652;

	class AutomataDictionary_AutomataNode__YieldChildren_d__17 : public ::System::Object
	{
	public:
		::Utf8Json::Internal::AutomataDictionary_AutomataNode* __4__this; // 0x10
		::Utf8Json::Internal::AutomataDictionary_AutomataNode* __2__current; // 0x18
