...
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_ADD_1_OFFSET UNITYSDK_OFFSET(0x1BBFA210)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_ADD_OFFSET UNITYSDK_OFFSET(0x1BBFA1A0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_EMITMATCH_OFFSET UNITYSDK_OFFSET(0x1BBFABF0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BBFAA30)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BBFAA20)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_TOSTRINGCORE_OFFSET UNITYSDK_OFFSET(0x1BBFA5B0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BBFA4C0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_TRYGETVALUESAFE_OFFSET UNITYSDK_OFFSET(0x1BBFA430)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_YIELDCORE_OFFSET UNITYSDK_OFFSET(0x1BBFAB90)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBFA0F0)

namespace Utf8Json::Internal
{
	inline static constexpr unsigned int AutomataDictionary_TypeDefinitionIndex = 85650;
