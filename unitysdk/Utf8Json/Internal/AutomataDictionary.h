...
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_ADD_1_OFFSET UNITYSDK_OFFSET(0x1F34D240)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_ADD_OFFSET UNITYSDK_OFFSET(0x1F34D1D0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_EMITMATCH_OFFSET UNITYSDK_OFFSET(0x1F34DC20)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1F34DA50)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1F34DA40)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_TOSTRINGCORE_OFFSET UNITYSDK_OFFSET(0x1F34D5D0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1F34D4E0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_TRYGETVALUESAFE_OFFSET UNITYSDK_OFFSET(0x1F34D460)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_YIELDCORE_OFFSET UNITYSDK_OFFSET(0x1F34DBC0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY__CTOR_OFFSET UNITYSDK_OFFSET(0x1F34D120)

namespace Utf8Json::Internal
{
	inline static constexpr unsigned int AutomataDictionary_TypeDefinitionIndex = 95157;
