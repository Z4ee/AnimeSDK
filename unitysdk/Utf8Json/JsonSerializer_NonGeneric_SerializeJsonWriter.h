...
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZEJSONWRITER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C38BE50)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZEJSONWRITER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C38BEE0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZEJSONWRITER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C38BAD0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZEJSONWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C38BAC0)

namespace Utf8Json
{
	inline static constexpr unsigned int JsonSerializer_NonGeneric_SerializeJsonWriter_TypeDefinitionIndex = 85509;
