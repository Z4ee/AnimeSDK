...
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZEJSONWRITER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E6D0190)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZEJSONWRITER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E6D0220)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZEJSONWRITER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E6CFE10)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZEJSONWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6CFDF0)

namespace Utf8Json
{
	inline static constexpr unsigned int JsonSerializer_NonGeneric_SerializeJsonWriter_TypeDefinitionIndex = 91083;
