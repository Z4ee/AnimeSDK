...
#define CLASS_1_4796C2DE3B2D6C2A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x155D97E0)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_00DF89AF1D11BD2E_OFFSET UNITYSDK_OFFSET(0x155DAAC0)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_145A8D9201423FC6_OFFSET UNITYSDK_OFFSET(0x155DC4B0)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_1EB273CD688D06ED_OFFSET UNITYSDK_OFFSET(0x155DB860)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_2D312A3A46C6FB2F_OFFSET UNITYSDK_OFFSET(0x155DA550)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_3B50FC129987FCC0_OFFSET UNITYSDK_OFFSET(0x155DB040)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_43B0FFFD1A1BF974_OFFSET UNITYSDK_OFFSET(0x155DD050)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_466FDCDCBC13D73A_OFFSET UNITYSDK_OFFSET(0x155DC3F0)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_4DF0E0649EBE066A_OFFSET UNITYSDK_OFFSET(0x155DA740)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_52DD47985B15034A_OFFSET UNITYSDK_OFFSET(0x155DCA40)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_60882208D099D33E_OFFSET UNITYSDK_OFFSET(0x155DB230)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_66CC9828DB1F478F_OFFSET UNITYSDK_OFFSET(0x155D9FE0)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_6B4A3A1B5816B81E_OFFSET UNITYSDK_OFFSET(0x155D9700)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_71137C197370ED55_OFFSET UNITYSDK_OFFSET(0x155DB4B0)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_8F6A1B72899F4EA4_OFFSET UNITYSDK_OFFSET(0x155D9A40)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_9152E9750C76708B_OFFSET UNITYSDK_OFFSET(0x155DAB40)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_A7FF6AA8FA2F7FEB_OFFSET UNITYSDK_OFFSET(0x155D9840)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_A8624219B56B77C4_OFFSET UNITYSDK_OFFSET(0x155DC1A0)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_ABD781CAE1D41BD7_OFFSET UNITYSDK_OFFSET(0x155DBCA0)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_AF7C96CACF497A85_OFFSET UNITYSDK_OFFSET(0x155DCE40)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_BA7B415A985A3C25_OFFSET UNITYSDK_OFFSET(0x155DB3F0)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_DA37DFE3A5BDA9F4_OFFSET UNITYSDK_OFFSET(0x155D9B20)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_ECF16165D5B625B4_OFFSET UNITYSDK_OFFSET(0x155DC790)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_F476304D68944B28_OFFSET UNITYSDK_OFFSET(0x155DBD60)
#define CLASS_1_4796C2DE3B2D6C2A__CTOR_OFFSET UNITYSDK_OFFSET(0x155D95B0)
...
{
public:
	::System::Collections::Generic::Dictionary_2<::System::ValueTuple_2<::System::UInt32, ::System::String*>, ::System::Collections::Generic::List_1<::RPG::GameCore::LevelLittleGameInfo*>*>* FPPBMIBEODH; // 0x10
	::RPG::Client::MapDef* KKKADHHBMLD; // 0x18
	::System::Collections::Generic::HashSet_1<::System::UInt32>* NCMBOLBCPGP; // 0x20
	::System::Collections::Generic::List_1<::System::String*>* PPODONICOHF; // 0x28
	::RPG::Client::TwoKeyDictionary_3<::System::UInt32, ::System::UInt32, ::Class_1_4796C2DE3B2D6C2A_Class_1_7A8BA05CC3614C46*>* HCJHBODIKLF; // 0x30
	::System::Collections::Generic::Dictionary_2<::System::String*, ::RPG::PoolHashSet_1<::System::ValueTuple_2<::System::UInt32, ::System::UInt32>>*>* POOJBCGCNBF; // 0x38
