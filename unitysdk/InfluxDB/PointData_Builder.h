...
#define INFLUXDB_POINTDATA_BUILDER_FIELD_1_OFFSET UNITYSDK_OFFSET(0x1C010C20)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_2_OFFSET UNITYSDK_OFFSET(0x1C010CD0)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_3_OFFSET UNITYSDK_OFFSET(0x1C010D50)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_4_OFFSET UNITYSDK_OFFSET(0x1C010DF0)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_5_OFFSET UNITYSDK_OFFSET(0x1C010E90)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_6_OFFSET UNITYSDK_OFFSET(0x1C010F30)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_7_OFFSET UNITYSDK_OFFSET(0x1C010FD0)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_8_OFFSET UNITYSDK_OFFSET(0x1C011030)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_9_OFFSET UNITYSDK_OFFSET(0x1C0110D0)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_OFFSET UNITYSDK_OFFSET(0x1C010AA0)
#define INFLUXDB_POINTDATA_BUILDER_HASFIELDS_OFFSET UNITYSDK_OFFSET(0x1C0114B0)
#define INFLUXDB_POINTDATA_BUILDER_MEASUREMENT_OFFSET UNITYSDK_OFFSET(0x1C0108B0)
#define INFLUXDB_POINTDATA_BUILDER_PUTFIELD_OFFSET UNITYSDK_OFFSET(0x1C010B40)
#define INFLUXDB_POINTDATA_BUILDER_TAG_OFFSET UNITYSDK_OFFSET(0x1C010930)
#define INFLUXDB_POINTDATA_BUILDER_TIMESTAMP_1_OFFSET UNITYSDK_OFFSET(0x1C011200)
#define INFLUXDB_POINTDATA_BUILDER_TIMESTAMP_2_OFFSET UNITYSDK_OFFSET(0x1C0112C0)
#define INFLUXDB_POINTDATA_BUILDER_TIMESTAMP_3_OFFSET UNITYSDK_OFFSET(0x1C0113C0)
#define INFLUXDB_POINTDATA_BUILDER_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1C011130)
#define INFLUXDB_POINTDATA_BUILDER_TOPOINTDATA_OFFSET UNITYSDK_OFFSET(0x1C011510)
#define INFLUXDB_POINTDATA_BUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C010780)

namespace InfluxDB
{
	inline static constexpr unsigned int PointData_Builder_TypeDefinitionIndex = 8139;
