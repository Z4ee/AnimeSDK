...
#define INFLUXDB_POINTDATA_BUILDER_FIELD_1_OFFSET UNITYSDK_OFFSET(0x1F6990C0)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_2_OFFSET UNITYSDK_OFFSET(0x1F699170)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_3_OFFSET UNITYSDK_OFFSET(0x1F6991F0)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_4_OFFSET UNITYSDK_OFFSET(0x1F699290)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_5_OFFSET UNITYSDK_OFFSET(0x1F699330)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_6_OFFSET UNITYSDK_OFFSET(0x1F6993D0)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_7_OFFSET UNITYSDK_OFFSET(0x1F699470)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_8_OFFSET UNITYSDK_OFFSET(0x1F6994D0)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_9_OFFSET UNITYSDK_OFFSET(0x1F699570)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_OFFSET UNITYSDK_OFFSET(0x1F698F40)
#define INFLUXDB_POINTDATA_BUILDER_HASFIELDS_OFFSET UNITYSDK_OFFSET(0x1F699960)
#define INFLUXDB_POINTDATA_BUILDER_MEASUREMENT_OFFSET UNITYSDK_OFFSET(0x1F698D60)
#define INFLUXDB_POINTDATA_BUILDER_PUTFIELD_OFFSET UNITYSDK_OFFSET(0x1F698FE0)
#define INFLUXDB_POINTDATA_BUILDER_TAG_OFFSET UNITYSDK_OFFSET(0x1F698DE0)
#define INFLUXDB_POINTDATA_BUILDER_TIMESTAMP_1_OFFSET UNITYSDK_OFFSET(0x1F6996A0)
#define INFLUXDB_POINTDATA_BUILDER_TIMESTAMP_2_OFFSET UNITYSDK_OFFSET(0x1F699760)
#define INFLUXDB_POINTDATA_BUILDER_TIMESTAMP_3_OFFSET UNITYSDK_OFFSET(0x1F699860)
#define INFLUXDB_POINTDATA_BUILDER_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1F6995D0)
#define INFLUXDB_POINTDATA_BUILDER_TOPOINTDATA_OFFSET UNITYSDK_OFFSET(0x1F6999C0)
#define INFLUXDB_POINTDATA_BUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F698C30)

namespace InfluxDB
{
	inline static constexpr unsigned int PointData_Builder_TypeDefinitionIndex = 8235;

	class PointData_Builder : public ::System::Object
	{
	public:
		::System::String* _measurementName; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>* _tags; // 0x18
		::System::Nullable_1<::System::Numerics::BigInteger> _time; // 0x20
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Object*>* _fields; // 0x38
