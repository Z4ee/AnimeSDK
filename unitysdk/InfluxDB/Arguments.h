...
#define INFLUXDB_ARGUMENTS_CHECKDURATION_OFFSET UNITYSDK_OFFSET(0x1EF4D390)
#define INFLUXDB_ARGUMENTS_CHECKNONEMPTYSTRING_OFFSET UNITYSDK_OFFSET(0x1EF4D2E0)
#define INFLUXDB_ARGUMENTS_CHECKNOTNEGATIVENUMBER_OFFSET UNITYSDK_OFFSET(0x1EF4D540)
#define INFLUXDB_ARGUMENTS_CHECKNOTNULL_OFFSET UNITYSDK_OFFSET(0x1EF4D5F0)
#define INFLUXDB_ARGUMENTS_CHECKPOSITIVENUMBER_OFFSET UNITYSDK_OFFSET(0x1EF4D490)

namespace InfluxDB
{
	inline static constexpr unsigned int Arguments_TypeDefinitionIndex = 7982;
