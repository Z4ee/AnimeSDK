...
#define INFLUXDB_ARGUMENTS_CHECKDURATION_OFFSET UNITYSDK_OFFSET(0x1B76E370)
#define INFLUXDB_ARGUMENTS_CHECKNONEMPTYSTRING_OFFSET UNITYSDK_OFFSET(0x1B76E2C0)
#define INFLUXDB_ARGUMENTS_CHECKNOTNEGATIVENUMBER_OFFSET UNITYSDK_OFFSET(0x1B76E520)
#define INFLUXDB_ARGUMENTS_CHECKNOTNULL_OFFSET UNITYSDK_OFFSET(0x1B76E5D0)
#define INFLUXDB_ARGUMENTS_CHECKPOSITIVENUMBER_OFFSET UNITYSDK_OFFSET(0x1B76E470)

namespace InfluxDB
{
	inline static constexpr unsigned int Arguments_TypeDefinitionIndex = 8041;
