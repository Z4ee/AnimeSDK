...
#define INFLUXDB_POINTDATA___C__DISPLAYCLASS36_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEDE460)
#define INFLUXDB_POINTDATA___C__DISPLAYCLASS36_0__EQUALS_B__0_OFFSET UNITYSDK_OFFSET(0x1BEDE470)
#define INFLUXDB_POINTDATA___C__DISPLAYCLASS36_0__EQUALS_B__1_OFFSET UNITYSDK_OFFSET(0x1BEDE530)

namespace InfluxDB
{
	inline static constexpr unsigned int PointData___c__DisplayClass36_0_TypeDefinitionIndex = 8140;
