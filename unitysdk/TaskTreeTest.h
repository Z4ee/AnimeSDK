...
#define TASKTREETEST_BUILDTASK_OFFSET UNITYSDK_OFFSET(0x1BF50620)
#define TASKTREETEST_BUILDTREE_OFFSET UNITYSDK_OFFSET(0x1BF50390)
#define TASKTREETEST_DELAYTEST_OFFSET UNITYSDK_OFFSET(0x1BF50260)
#define TASKTREETEST_ROOTBEGIN_OFFSET UNITYSDK_OFFSET(0x1BF50710)
#define TASKTREETEST_ROOTCANCEL_OFFSET UNITYSDK_OFFSET(0x1BF50990)
#define TASKTREETEST_ROOTEND_OFFSET UNITYSDK_OFFSET(0x1BF50850)
#define TASKTREETEST_SETTASK_OFFSET UNITYSDK_OFFSET(0x1BF502E0)
#define TASKTREETEST_START_OFFSET UNITYSDK_OFFSET(0x1BF4FF10)
#define TASKTREETEST_TESTCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1BF4FFD0)
#define TASKTREETEST_TEST_OFFSET UNITYSDK_OFFSET(0x1BF4FE40)
#define TASKTREETEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF50AD0)

inline static constexpr unsigned int TaskTreeTest_TypeDefinitionIndex = 76077;
