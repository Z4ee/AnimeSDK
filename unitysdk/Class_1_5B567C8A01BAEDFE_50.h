...
#define CLASS_1_5B567C8A01BAEDFE_50_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x192CD3B0)
#define CLASS_1_5B567C8A01BAEDFE_50_CLONE_OFFSET UNITYSDK_OFFSET(0x192CD220)
#define CLASS_1_5B567C8A01BAEDFE_50_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x192CD2C0)
#define CLASS_1_5B567C8A01BAEDFE_50_EQUALS_OFFSET UNITYSDK_OFFSET(0x192CD260)
#define CLASS_1_5B567C8A01BAEDFE_50_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x192CD310)
#define CLASS_1_5B567C8A01BAEDFE_50_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x192CD400)
#define CLASS_1_5B567C8A01BAEDFE_50_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x192CD3D0)
#define CLASS_1_5B567C8A01BAEDFE_50_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x192CD1A0)
#define CLASS_1_5B567C8A01BAEDFE_50_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x192CD1D0)
#define CLASS_1_5B567C8A01BAEDFE_50_TOSTRING_OFFSET UNITYSDK_OFFSET(0x192CD340)
#define CLASS_1_5B567C8A01BAEDFE_50_WRITETO_OFFSET UNITYSDK_OFFSET(0x192CD3A0)
#define CLASS_1_5B567C8A01BAEDFE_50__CCTOR_OFFSET UNITYSDK_OFFSET(0x192CD450)
#define CLASS_1_5B567C8A01BAEDFE_50__CTOR_1_OFFSET UNITYSDK_OFFSET(0x192CD1F0)
#define CLASS_1_5B567C8A01BAEDFE_50__CTOR_OFFSET UNITYSDK_OFFSET(0x192CD1E0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_50_TypeDefinitionIndex = 25450;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_50*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_50_TypeDefinitionIndex)->GetStaticField(0x5A500);
	}
