...
#define CLASS_1_9FFB5B2DF976EA73_GET_MULTIPLEPATHCONFIGREPOSITORY_OFFSET UNITYSDK_OFFSET(0xBA1CDB0)
#define CLASS_1_9FFB5B2DF976EA73_GET_PROPERTYCALCULATOR_OFFSET UNITYSDK_OFFSET(0xBA1CD90)
#define CLASS_1_9FFB5B2DF976EA73_GET_SERVANTREPOSITORY_OFFSET UNITYSDK_OFFSET(0xBA1CD50)
#define CLASS_1_9FFB5B2DF976EA73_GET_SERVANTSKILLREPOSITORY_OFFSET UNITYSDK_OFFSET(0xBA1CD70)
#define CLASS_1_9FFB5B2DF976EA73_METHOD_1_0F4B0D4257A65E23_OFFSET UNITYSDK_OFFSET(0xBA1D1D0)
#define CLASS_1_9FFB5B2DF976EA73_METHOD_1_4A6A1943BE9D6C19_OFFSET UNITYSDK_OFFSET(0xBA1D3B0)
#define CLASS_1_9FFB5B2DF976EA73_METHOD_1_4CD8A56E35B158A2_OFFSET UNITYSDK_OFFSET(0xBA1CDD0)
#define CLASS_1_9FFB5B2DF976EA73_METHOD_1_59D634CA8DD784B2_OFFSET UNITYSDK_OFFSET(0xBA1D080)
#define CLASS_1_9FFB5B2DF976EA73_METHOD_1_95A45E456041E511_OFFSET UNITYSDK_OFFSET(0xBA1D140)
#define CLASS_1_9FFB5B2DF976EA73_SET_MULTIPLEPATHCONFIGREPOSITORY_OFFSET UNITYSDK_OFFSET(0xBA1CDC0)
#define CLASS_1_9FFB5B2DF976EA73_SET_PROPERTYCALCULATOR_OFFSET UNITYSDK_OFFSET(0xBA1CDA0)
#define CLASS_1_9FFB5B2DF976EA73_SET_SERVANTREPOSITORY_OFFSET UNITYSDK_OFFSET(0xBA1CD60)
#define CLASS_1_9FFB5B2DF976EA73_SET_SERVANTSKILLREPOSITORY_OFFSET UNITYSDK_OFFSET(0xBA1CD80)
#define CLASS_1_9FFB5B2DF976EA73__CTOR_OFFSET UNITYSDK_OFFSET(0xBA1D5C0)

inline static constexpr unsigned int Class_1_9FFB5B2DF976EA73_TypeDefinitionIndex = 62703;

class Class_1_9FFB5B2DF976EA73 : public ::System::Object
{
public:
	::Class_1_A11C7D917C5F44A3* _ServantRepository_k__BackingField; // 0x10
	::Class_2_036B9A291BBA6396* _PropertyCalculator_k__BackingField; // 0x18
	::Class_1_3E26D5D72F19C4DB_1* _ServantSkillRepository_k__BackingField; // 0x20
	::Class_0_16E4307DCC419505_776* _MultiplePathConfigRepository_k__BackingField; // 0x28
	...
	::Class_0_16E4307DCC419505_776* get_MultiplePathConfigRepository()
	{
		return ((::Class_0_16E4307DCC419505_776*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_9FFB5B2DF976EA73_GET_MULTIPLEPATHCONFIGREPOSITORY_OFFSET))(this);
	}

	::System::Void set_MultiplePathConfigRepository(::Class_0_16E4307DCC419505_776* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_776*))((::PBYTE)hIl2Cpp + CLASS_1_9FFB5B2DF976EA73_SET_MULTIPLEPATHCONFIGREPOSITORY_OFFSET))(this, a1);
	}

	::Class_1_F86E0BB362A55B9C* Method_1_4CD8A56E35B158A2(::Struct_2_BC950E36747FB4C9& a1, ::Class_0_16E4307DCC419505_446* a2, ::RPG::AvatarSystem::Property::IPropertyContext_1<::RPG::GameCore::FixPoint>* a3, ::Class_0_16E4307DCC419505_445* a4, ::Il2CppArray<::Class_0_16E4307DCC419505_446*>* a5)
	{
		return ((::Class_1_F86E0BB362A55B9C*(*)(::PVOID, ::Struct_2_BC950E36747FB4C9&, ::Class_0_16E4307DCC419505_446*, ::RPG::AvatarSystem::Property::IPropertyContext_1<::RPG::GameCore::FixPoint>*, ::Class_0_16E4307DCC419505_445*, ::Il2CppArray<::Class_0_16E4307DCC419505_446*>*))((::PBYTE)hIl2Cpp + CLASS_1_9FFB5B2DF976EA73_METHOD_1_4CD8A56E35B158A2_OFFSET))(this, a1, a2, a3, a4, a5);
	}
