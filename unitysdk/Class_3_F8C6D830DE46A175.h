...
#define CLASS_3_F8C6D830DE46A175_METHOD_3_B0B66673456EDDF6_OFFSET UNITYSDK_OFFSET(0x1C8B77B0)
#define CLASS_3_F8C6D830DE46A175_METHOD_3_C17C5E1EBAECCBCD_OFFSET UNITYSDK_OFFSET(0x1C8B77F0)
#define CLASS_3_F8C6D830DE46A175__CTOR_OFFSET UNITYSDK_OFFSET(0x1C8B77E0)

inline static constexpr unsigned int Class_3_F8C6D830DE46A175_TypeDefinitionIndex = 20754;

class Class_3_F8C6D830DE46A175 : public ::RPG::GameCore::TaskConfig
{
public:
	::RPG::GameCore::DynamicString* LKHIJJKHCNE; // 0x18
	::RPG::GameCore::DynamicString* DDPFGAENEAD; // 0x20
