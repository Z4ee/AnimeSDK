...
#define CLASS_1_E4E0EE0B8D84A8B2_METHOD_1_0A7C75AE549C5CCF_OFFSET UNITYSDK_OFFSET(0x18FE77C0)
#define CLASS_1_E4E0EE0B8D84A8B2_METHOD_1_238AB9E1DAED58DE_OFFSET UNITYSDK_OFFSET(0x18FE7600)
#define CLASS_1_E4E0EE0B8D84A8B2_METHOD_1_C101CD8C5CF89A5A_OFFSET UNITYSDK_OFFSET(0x18FE7A20)
#define CLASS_1_E4E0EE0B8D84A8B2_METHOD_1_C433AF37CE9D6E5B_OFFSET UNITYSDK_OFFSET(0x18FE7560)
#define CLASS_1_E4E0EE0B8D84A8B2_METHOD_1_E5EE09C33904CCDC_OFFSET UNITYSDK_OFFSET(0x18FE75B0)
#define CLASS_1_E4E0EE0B8D84A8B2__CTOR_OFFSET UNITYSDK_OFFSET(0x18FE74E0)

inline static constexpr unsigned int Class_1_E4E0EE0B8D84A8B2_TypeDefinitionIndex = 72554;

class Class_1_E4E0EE0B8D84A8B2 : public ::System::Object
{
public:
	::UnityEngine::GameObject* GGOPIDNLIJJ; // 0x10
	::UnityEngine::Behaviour* EOIJBPGPNAE; // 0x18
	::System::Collections::Generic::Dictionary_2<::RPG::Client::RecordPropertyType, ::Class_1_83665B095F1535B5_28*>* OLLHMJJAMCK; // 0x20
