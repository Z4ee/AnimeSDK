...
#define CLASS_2_F29E95DF5E4D58B4_DISPOSE_OFFSET UNITYSDK_OFFSET(0x164BACC0)
#define CLASS_2_F29E95DF5E4D58B4_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x164BAD00)
#define CLASS_2_F29E95DF5E4D58B4_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x164BAD50)
#define CLASS_2_F29E95DF5E4D58B4_TICK_OFFSET UNITYSDK_OFFSET(0x164BADA0)
#define CLASS_2_F29E95DF5E4D58B4__CTOR_OFFSET UNITYSDK_OFFSET(0x164BACB0)

inline static constexpr unsigned int Class_2_F29E95DF5E4D58B4_TypeDefinitionIndex = 53255;

class Class_2_F29E95DF5E4D58B4 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::LoadLevelGroup* OFKGLJOAMLD; // 0x18
