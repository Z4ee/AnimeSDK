...
#define CLASS_1_355A2207C3B7A99D_103_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A66F630)
#define CLASS_1_355A2207C3B7A99D_103_CLONE_OFFSET UNITYSDK_OFFSET(0x1A66F2D0)
#define CLASS_1_355A2207C3B7A99D_103_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A66F460)
#define CLASS_1_355A2207C3B7A99D_103_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A66F3B0)
#define CLASS_1_355A2207C3B7A99D_103_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A66F500)
#define CLASS_1_355A2207C3B7A99D_103_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A66F790)
#define CLASS_1_355A2207C3B7A99D_103_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A66F690)
#define CLASS_1_355A2207C3B7A99D_103_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x1A66F390)
#define CLASS_1_355A2207C3B7A99D_103_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A66F1D0)
#define CLASS_1_355A2207C3B7A99D_103_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1A66F3A0)
#define CLASS_1_355A2207C3B7A99D_103_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A66F200)
#define CLASS_1_355A2207C3B7A99D_103_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A66F570)
#define CLASS_1_355A2207C3B7A99D_103_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A66F5D0)
#define CLASS_1_355A2207C3B7A99D_103__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A66F920)
#define CLASS_1_355A2207C3B7A99D_103__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A66F220)
#define CLASS_1_355A2207C3B7A99D_103__CTOR_OFFSET UNITYSDK_OFFSET(0x1A66F210)

inline static constexpr unsigned int Class_1_355A2207C3B7A99D_103_TypeDefinitionIndex = 31651;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_355A2207C3B7A99D_103*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_355A2207C3B7A99D_103_TypeDefinitionIndex)->GetStaticField(0x2ABD0);
	}
	// static const ::System::Int32 Field_1_1 = 0xF; // 0x0
	::Google::Protobuf::UnknownFieldSet* Field_1_2; // 0x10
	::Class_1_EBB10EC01CCC4716_16* Field_1_3; // 0x18
	...
	{
		return ((::Class_1_EBB10EC01CCC4716_16*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_355A2207C3B7A99D_103_METHOD_1_24748FC20F375725_OFFSET))(this);
	}

	::System::Void Method_1_8C8625211DA811AE(::Class_1_EBB10EC01CCC4716_16* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_EBB10EC01CCC4716_16*))((::PBYTE)hIl2Cpp + CLASS_1_355A2207C3B7A99D_103_METHOD_1_8C8625211DA811AE_OFFSET))(this, a1);
	}
