...
#define CLASS_1_0A70BCA158503830_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1C523310)

inline static constexpr unsigned int Class_1_0A70BCA158503830_1_TypeDefinitionIndex = 41373;

class Class_1_0A70BCA158503830_1 : public ::System::Object
{
public:
	::UnityEngine::Vector3 LJDHGFECMHJ; // 0x10
	::System::Int32 DMPLCKNNKII; // 0x1C
