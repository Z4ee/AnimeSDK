...
#define CLASS_3_9A11345DD0C2D5DE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A0C8600)
#define CLASS_3_9A11345DD0C2D5DE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1A0C8640)
#define CLASS_3_9A11345DD0C2D5DE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0C85D0)

inline static constexpr unsigned int Class_3_9A11345DD0C2D5DE_TypeDefinitionIndex = 55084;
