...
#define CLASS_2_66BF2C9FC1D2A5C7_1_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1C47F030)
#define CLASS_2_66BF2C9FC1D2A5C7_1_FILTER_OFFSET UNITYSDK_OFFSET(0x1C47EF30)
#define CLASS_2_66BF2C9FC1D2A5C7_1_GETTRIGGER_OFFSET UNITYSDK_OFFSET(0x1C47EE10)
#define CLASS_2_66BF2C9FC1D2A5C7_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1C47ED90)

inline static constexpr unsigned int Class_2_66BF2C9FC1D2A5C7_1_TypeDefinitionIndex = 40749;

class Class_2_66BF2C9FC1D2A5C7_1 : public ::Entitas::ReactiveSystem_1<::Class_2_FD51057495DB654F*>
{
public:
	::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_214*>* BGKHCJPFFLN; // 0x28
