...
#define CLASS_1_5B567C8A01BAEDFE_147_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A931990)
#define CLASS_1_5B567C8A01BAEDFE_147_CLONE_OFFSET UNITYSDK_OFFSET(0x1A9317A0)
#define CLASS_1_5B567C8A01BAEDFE_147_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A9318A0)
#define CLASS_1_5B567C8A01BAEDFE_147_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A931810)
#define CLASS_1_5B567C8A01BAEDFE_147_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A9318F0)
#define CLASS_1_5B567C8A01BAEDFE_147_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A9319E0)
#define CLASS_1_5B567C8A01BAEDFE_147_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A9319B0)
#define CLASS_1_5B567C8A01BAEDFE_147_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A9316F0)
#define CLASS_1_5B567C8A01BAEDFE_147_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A931750)
#define CLASS_1_5B567C8A01BAEDFE_147_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A931920)
#define CLASS_1_5B567C8A01BAEDFE_147_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A931980)
#define CLASS_1_5B567C8A01BAEDFE_147__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A931A30)
#define CLASS_1_5B567C8A01BAEDFE_147__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A931770)
#define CLASS_1_5B567C8A01BAEDFE_147__CTOR_OFFSET UNITYSDK_OFFSET(0x1A931760)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_147_TypeDefinitionIndex = 27680;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_147*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_147_TypeDefinitionIndex)->GetStaticField(0x62BB0);
	}
