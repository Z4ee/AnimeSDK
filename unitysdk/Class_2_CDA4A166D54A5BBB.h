...
#define CLASS_2_CDA4A166D54A5BBB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x152D8B40)
#define CLASS_2_CDA4A166D54A5BBB_METHOD_2_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0x152D8F40)
#define CLASS_2_CDA4A166D54A5BBB_METHOD_2_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x152D90E0)
#define CLASS_2_CDA4A166D54A5BBB_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x152D8B80)
#define CLASS_2_CDA4A166D54A5BBB_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x152D91C0)
#define CLASS_2_CDA4A166D54A5BBB_TICK_OFFSET UNITYSDK_OFFSET(0x152D92C0)
#define CLASS_2_CDA4A166D54A5BBB__CTOR_OFFSET UNITYSDK_OFFSET(0x152D8B30)
...
{
public:
	::System::String* NEOGKILELNP; // 0x18
	::UnityEngine::Coroutine* OLPEBHPIFKH; // 0x20
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x28
	::RPG::GameCore::SetBattleBGMState* OFKGLJOAMLD; // 0x30
