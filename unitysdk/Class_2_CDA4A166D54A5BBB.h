...
#define CLASS_2_CDA4A166D54A5BBB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17E9E4B0)
#define CLASS_2_CDA4A166D54A5BBB_METHOD_2_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0x17E9E870)
#define CLASS_2_CDA4A166D54A5BBB_METHOD_2_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0x17E9EA10)
#define CLASS_2_CDA4A166D54A5BBB_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17E9E4F0)
#define CLASS_2_CDA4A166D54A5BBB_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17E9EAD0)
#define CLASS_2_CDA4A166D54A5BBB_TICK_OFFSET UNITYSDK_OFFSET(0x17E9EBB0)
#define CLASS_2_CDA4A166D54A5BBB__CTOR_OFFSET UNITYSDK_OFFSET(0x17E9E4A0)

inline static constexpr unsigned int Class_2_CDA4A166D54A5BBB_TypeDefinitionIndex = 55891;

class Class_2_CDA4A166D54A5BBB : public ::Class_1_5F51D4049EA87B7B
{
public:
	::System::String* Field_2_0; // 0x18
	::RPG::GameCore::SetBattleBGMState* Field_2_1; // 0x20
