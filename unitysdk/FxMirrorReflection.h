...
#define FXMIRRORREFLECTION_BINDPROPERTYBLOCK_OFFSET UNITYSDK_OFFSET(0x1AEB67F0)
#define FXMIRRORREFLECTION_GENERATEMIRRORPART_OFFSET UNITYSDK_OFFSET(0x1AEB6BF0)
#define FXMIRRORREFLECTION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AEB6620)
#define FXMIRRORREFLECTION_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x1AEB6770)
#define FXMIRRORREFLECTION_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x1AEB6720)
#define FXMIRRORREFLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEB73A0)

inline static constexpr unsigned int FxMirrorReflection_TypeDefinitionIndex = 27241;
