...
#define CLASS_1_ED492469204624B4_STRUCT_2_1D31833B4311C5D9_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x7D3000)
#define CLASS_1_ED492469204624B4_STRUCT_2_1D31833B4311C5D9_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x296F30)

inline static constexpr unsigned int Class_1_ED492469204624B4_Struct_2_1D31833B4311C5D9_TypeDefinitionIndex = 63469;
...
struct alignas(8) Class_1_ED492469204624B4_Struct_2_1D31833B4311C5D9
{
	...
	::Class_0_16E4307DCC419505_630* Field_2_5; // 0x20
	::Class_1_2899B0E942F4D2BC* Field_2_4; // 0x28
	::Cysharp::Threading::Tasks::CompilerServices::AsyncUniTaskMethodBuilder Field_2_0; // 0x30
	::Class_1_ED492469204624B4* Field_2_7; // 0x40
	::System::Int32 Field_2_1; // 0x48
	::Enum_3_ABCAEFDF06E3479A Field_2_6; // 0x4C
