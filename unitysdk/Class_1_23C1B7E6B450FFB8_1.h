...
#define CLASS_1_23C1B7E6B450FFB8_1_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1ECD6D10)
#define CLASS_1_23C1B7E6B450FFB8_1_CLONE_OFFSET UNITYSDK_OFFSET(0x1ECD6790)
#define CLASS_1_23C1B7E6B450FFB8_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1ECD68B0)
#define CLASS_1_23C1B7E6B450FFB8_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x1ECD6850)
#define CLASS_1_23C1B7E6B450FFB8_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1ECD6AA0)
#define CLASS_1_23C1B7E6B450FFB8_1_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1ECD6E10)
#define CLASS_1_23C1B7E6B450FFB8_1_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1ECD6DC0)
#define CLASS_1_23C1B7E6B450FFB8_1_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1ECD6810)
#define CLASS_1_23C1B7E6B450FFB8_1_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1ECD66D0)
#define CLASS_1_23C1B7E6B450FFB8_1_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1ECD6820)
#define CLASS_1_23C1B7E6B450FFB8_1_METHOD_1_8633AE51B23EBDFD_OFFSET UNITYSDK_OFFSET(0x1ECD6840)
#define CLASS_1_23C1B7E6B450FFB8_1_METHOD_1_C229FF62B898C0B2_OFFSET UNITYSDK_OFFSET(0x1ECD6830)
#define CLASS_1_23C1B7E6B450FFB8_1_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1ECD6730)
#define CLASS_1_23C1B7E6B450FFB8_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1ECD6BC0)
#define CLASS_1_23C1B7E6B450FFB8_1_WRITETO_OFFSET UNITYSDK_OFFSET(0x1ECD6C20)
#define CLASS_1_23C1B7E6B450FFB8_1__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ECD6F90)
#define CLASS_1_23C1B7E6B450FFB8_1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ECD6750)
#define CLASS_1_23C1B7E6B450FFB8_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1ECD6740)

inline static constexpr unsigned int Class_1_23C1B7E6B450FFB8_1_TypeDefinitionIndex = 25164;

class Class_1_23C1B7E6B450FFB8_1 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_23C1B7E6B450FFB8_1*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_23C1B7E6B450FFB8_1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_23C1B7E6B450FFB8_1_TypeDefinitionIndex)->GetStaticField(0x53680);
	}
	// static const ::System::Int32 KKAFPBONMMD = 0x1; // 0x0
	// static const ::System::Int32 PFIEAJFDPKN = 0x2; // 0x0
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x10
	::System::Double EEFAOKNJGJK; // 0x18
