...
#define CLASS_1_EBF9D778B7777840_CLEAR_OFFSET UNITYSDK_OFFSET(0x141A43D0)
#define CLASS_1_EBF9D778B7777840_GET_PRECISION_OFFSET UNITYSDK_OFFSET(0x141A4880)
#define CLASS_1_EBF9D778B7777840_METHOD_1_4DC89B52930F4CB0_OFFSET UNITYSDK_OFFSET(0x141A4420)
#define CLASS_1_EBF9D778B7777840_METHOD_1_A10567177DDE0779_OFFSET UNITYSDK_OFFSET(0x141A4820)
#define CLASS_1_EBF9D778B7777840_METHOD_1_BAD919AA5E7DD49E_OFFSET UNITYSDK_OFFSET(0x141A4640)
#define CLASS_1_EBF9D778B7777840_METHOD_1_D09831639F615812_OFFSET UNITYSDK_OFFSET(0x141A4350)
#define CLASS_1_EBF9D778B7777840_SET_PRECISION_OFFSET UNITYSDK_OFFSET(0x141A4890)
#define CLASS_1_EBF9D778B7777840__CCTOR_OFFSET UNITYSDK_OFFSET(0x141A48B0)
#define CLASS_1_EBF9D778B7777840__CTOR_OFFSET UNITYSDK_OFFSET(0x141A48A0)

inline static constexpr unsigned int Class_1_EBF9D778B7777840_TypeDefinitionIndex = 68531;
...
public:
	...
	{
		return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_EBF9D778B7777840_TypeDefinitionIndex)->GetStaticField(0x14120);
	}
