...
#define CLASS_1_EAFAB368CCDA222C_METHOD_1_002D39232CF0AC21_OFFSET UNITYSDK_OFFSET(0x170A34F0)
#define CLASS_1_EAFAB368CCDA222C_METHOD_1_438B627D5302EFB2_OFFSET UNITYSDK_OFFSET(0x170A3460)
#define CLASS_1_EAFAB368CCDA222C_METHOD_1_BFE1B95B4EC14E02_OFFSET UNITYSDK_OFFSET(0x170A3320)
#define CLASS_1_EAFAB368CCDA222C__CTOR_OFFSET UNITYSDK_OFFSET(0x170A2F20)

inline static constexpr unsigned int Class_1_EAFAB368CCDA222C_TypeDefinitionIndex = 63440;

class Class_1_EAFAB368CCDA222C : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::RPG::Client::ChimeraDuelRankData*>* OOKLLACALNI; // 0x10
