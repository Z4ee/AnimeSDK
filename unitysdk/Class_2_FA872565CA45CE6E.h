...
#define CLASS_2_FA872565CA45CE6E_ISCONCERNEDWITH_OFFSET UNITYSDK_OFFSET(0x19FE32E0)
#define CLASS_2_FA872565CA45CE6E_METHOD_2_1C92751553E32AE6_OFFSET UNITYSDK_OFFSET(0x19FE33F0)
#define CLASS_2_FA872565CA45CE6E_METHOD_2_B38DD5E8D6679D46_OFFSET UNITYSDK_OFFSET(0x19FE3210)
#define CLASS_2_FA872565CA45CE6E_UPDATEBEFORE_OFFSET UNITYSDK_OFFSET(0x19FE3340)
#define CLASS_2_FA872565CA45CE6E_UPDATECOIN_OFFSET UNITYSDK_OFFSET(0x19FE3590)
#define CLASS_2_FA872565CA45CE6E_UPDATELEVELANDEXP_OFFSET UNITYSDK_OFFSET(0x19FE37A0)
#define CLASS_2_FA872565CA45CE6E_UPDATEMAXROLENUM_OFFSET UNITYSDK_OFFSET(0x19FE3C00)
#define CLASS_2_FA872565CA45CE6E__CTOR_OFFSET UNITYSDK_OFFSET(0x19FE3E10)

inline static constexpr unsigned int Class_2_FA872565CA45CE6E_TypeDefinitionIndex = 65130;

class Class_2_FA872565CA45CE6E : public ::Class_1_41E07A9DDAB7FC78
{
public:
	::RPG::Client::GridFightPlayerChangeData* APPIHABBCGK; // 0x10
