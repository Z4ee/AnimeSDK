...
#define UISINWAVEGRAPHIC_BUILDADAPTIVESAMPLES_OFFSET UNITYSDK_OFFSET(0x1C1447D0)
#define UISINWAVEGRAPHIC_ENSURECANVASTEXCOORD1_OFFSET UNITYSDK_OFFSET(0x1C146230)
#define UISINWAVEGRAPHIC_FRAMERATETOINTERVAL_OFFSET UNITYSDK_OFFSET(0x1C1439D0)
#define UISINWAVEGRAPHIC_GETENTRYHALFWIDTH_OFFSET UNITYSDK_OFFSET(0x1C1442F0)
#define UISINWAVEGRAPHIC_GETMODIFIEDMATERIALFORBASE_OFFSET UNITYSDK_OFFSET(0x1C1463C0)
#define UISINWAVEGRAPHIC_GET_HASBASEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1C144080)
#define UISINWAVEGRAPHIC_GET_MATERIALCOUNT_OFFSET UNITYSDK_OFFSET(0x1C144270)
#define UISINWAVEGRAPHIC_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1C143E80)
#define UISINWAVEGRAPHIC_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C143CF0)
#define UISINWAVEGRAPHIC_SAMPLECURVE_OFFSET UNITYSDK_OFFSET(0x1C144390)
#define UISINWAVEGRAPHIC_START_OFFSET UNITYSDK_OFFSET(0x1C143A30)
#define UISINWAVEGRAPHIC_SUBDIVIDEADAPTIVE_OFFSET UNITYSDK_OFFSET(0x1C1444C0)
#define UISINWAVEGRAPHIC_UPDATEGEOMETRY_OFFSET UNITYSDK_OFFSET(0x1C144BD0)
#define UISINWAVEGRAPHIC_UPDATEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1C1468B0)
#define UISINWAVEGRAPHIC_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C143B50)
#define UISINWAVEGRAPHIC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C146E70)
#define UISINWAVEGRAPHIC__CTOR_OFFSET UNITYSDK_OFFSET(0x1C146C50)
#define UISINWAVEGRAPHIC___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1C146F00)
#define UISINWAVEGRAPHIC___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C146F10)
#define UISINWAVEGRAPHIC___BASE_START_OFFSET UNITYSDK_OFFSET(0x1C146F20)
#define UISINWAVEGRAPHIC___BASE_UPDATEGEOMETRY_OFFSET UNITYSDK_OFFSET(0x1C146FB0)
#define UISINWAVEGRAPHIC___BASE_UPDATEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1C147060)

inline static constexpr unsigned int UISinWaveGraphic_TypeDefinitionIndex = 89854;
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::UnityEngine::Component*>**)Il2CppClass::FromTypeDefinitionIndex(UISinWaveGraphic_TypeDefinitionIndex)->GetStaticField(0x412F0);
	}
