...
#define CLASS_2_A78F8A0A3E954953_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1622FED0)
#define CLASS_2_A78F8A0A3E954953_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1622FF10)
#define CLASS_2_A78F8A0A3E954953_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x16230250)
#define CLASS_2_A78F8A0A3E954953_TICK_OFFSET UNITYSDK_OFFSET(0x162302A0)
#define CLASS_2_A78F8A0A3E954953__CTOR_OFFSET UNITYSDK_OFFSET(0x1622FEC0)
