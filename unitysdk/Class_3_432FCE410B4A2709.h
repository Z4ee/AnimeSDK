...
#define CLASS_3_432FCE410B4A2709_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16355FC0)
#define CLASS_3_432FCE410B4A2709__CTOR_OFFSET UNITYSDK_OFFSET(0x16355F90)

inline static constexpr unsigned int Class_3_432FCE410B4A2709_TypeDefinitionIndex = 56172;
