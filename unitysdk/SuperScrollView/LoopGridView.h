...
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_ADJUSTCONTAINERANCHORANDPIVOT_OFFSET UNITYSDK_OFFSET(0xD0AB350)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_ADJUSTITEMANCHORANDPIVOT_OFFSET UNITYSDK_OFFSET(0xD0B1990)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_ADJUSTOBJECTINSTANCE_OFFSET UNITYSDK_OFFSET(0xD0B1B00)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_ADJUSTVIEWPORTPIVOT_OFFSET UNITYSDK_OFFSET(0xD0AB270)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_ASYNCPREPAREITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xD0B7130)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_ASYNCSETLISTITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xD0B71F0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_ASYNCUPDATEGRIDVIEWCONTENT_OFFSET UNITYSDK_OFFSET(0xD0B0B10)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_ASYNCUPDATEROWITEMGROUPFORRECYCLEANDNEW_OFFSET UNITYSDK_OFFSET(0xD0B3E80)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_CANSNAP_OFFSET UNITYSDK_OFFSET(0xD0B5170)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_CLEARALLTMPRECYCLEDITEM_OFFSET UNITYSDK_OFFSET(0xD0AC320)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_CLEARALL_OFFSET UNITYSDK_OFFSET(0xD0B78D0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_CLEARFADEIN_OFFSET UNITYSDK_OFFSET(0xD0B5EA0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_CLEARFOCUSCACHE_OFFSET UNITYSDK_OFFSET(0xD0AF8B0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_CLEARSNAPDATA_OFFSET UNITYSDK_OFFSET(0xD0AE290)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_CREATEITEMGROUP_OFFSET UNITYSDK_OFFSET(0xD0AFF30)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xD0B7CD0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_FILLCURSNAPDATA_OFFSET UNITYSDK_OFFSET(0xD0B55D0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_FINDNEARESTITEMWITHLOCALPOS_OFFSET UNITYSDK_OFFSET(0xD0B4040)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_FINISHSETFINISHCOROUTINE_OFFSET UNITYSDK_OFFSET(0xD0ABE80)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_FINISHSNAPIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0xD0B5120)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_FORCEADJUSTITEMPIVOTANDANCHOR_OFFSET UNITYSDK_OFFSET(0xD0B1940)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_FORCESNAPUPDATECHECK_OFFSET UNITYSDK_OFFSET(0xD0AE3A0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_FORCETOCHECKCONTENTPOS_OFFSET UNITYSDK_OFFSET(0xD0AC190)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GETCEILITEMROWCOLUMNATGIVENABSPOS_OFFSET UNITYSDK_OFFSET(0xD0B2CF0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GETCONTAINERMOVEDDISTANCE_OFFSET UNITYSDK_OFFSET(0xD0B3D50)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GETCONTAINERVAILDPOS_OFFSET UNITYSDK_OFFSET(0xD0AF5B0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GETITEMABSPOS_OFFSET UNITYSDK_OFFSET(0xD0AEA90)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GETITEMINDEXBYROWCOLUMN_OFFSET UNITYSDK_OFFSET(0xD0AEA10)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GETITEMPOS_OFFSET UNITYSDK_OFFSET(0xD0AE4F0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GETITEMPREFABCONFDATA_OFFSET UNITYSDK_OFFSET(0xD0AA6C0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GETITEMSNAPPIVOTLOCALPOS_OFFSET UNITYSDK_OFFSET(0xD0B42A0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GETNEWITEMBYROWCOLUMN_OFFSET UNITYSDK_OFFSET(0xD0ADDE0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GETONEITEMGROUPOBJ_OFFSET UNITYSDK_OFFSET(0xD0B3CA0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GETROWCOLUMNBYITEMINDEX_OFFSET UNITYSDK_OFFSET(0xD0AD910)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GETSHOWNGROUP_OFFSET UNITYSDK_OFFSET(0xD0ADD10)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GETSHOWNITEMBYITEMINDEX_OFFSET UNITYSDK_OFFSET(0xD0AEB20)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GETSHOWNITEMBYROWCOLUMN_OFFSET UNITYSDK_OFFSET(0xD0AEC00)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GETVIEWPORTSNAPPIVOTLOCALPOS_OFFSET UNITYSDK_OFFSET(0xD0B4930)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GET_ARRANGETYPE_OFFSET UNITYSDK_OFFSET(0xD0A9EC0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GET_AUTOADAPTITEMSIZE_OFFSET UNITYSDK_OFFSET(0xD0B6950)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GET_CONTAINERTRANS_OFFSET UNITYSDK_OFFSET(0xD0A9F00)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GET_CURSNAPNEARESTITEMROWCOLUMN_OFFSET UNITYSDK_OFFSET(0xD0AE390)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GET_FADEINLENGTH_OFFSET UNITYSDK_OFFSET(0xD0B5E80)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GET_FADEINOFFSET_OFFSET UNITYSDK_OFFSET(0xD0B5E60)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GET_INASYNCSETITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xD0B7870)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GET_ISAUTOFADEIN_OFFSET UNITYSDK_OFFSET(0xD0B68A0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GET_ISDRAGING_OFFSET UNITYSDK_OFFSET(0xD0AA000)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GET_ISFLEXIBLECOUNT_OFFSET UNITYSDK_OFFSET(0xD0B5E40)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GET_ISIGNORETRANSDIRTYWAIT_OFFSET UNITYSDK_OFFSET(0xD0B7D90)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GET_ISNAVITONEXTLINE_OFFSET UNITYSDK_OFFSET(0xD0B7DB0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GET_ISNEEDFADEIN_OFFSET UNITYSDK_OFFSET(0xD0B68C0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GET_ISPCPLATFORMSIZE_OFFSET UNITYSDK_OFFSET(0xD0B7DD0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GET_ITEMGROUPLIST_OFFSET UNITYSDK_OFFSET(0xD0B5870)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GET_ITEMPADDING_OFFSET UNITYSDK_OFFSET(0xD0AA3A0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GET_ITEMPOOLLIST_OFFSET UNITYSDK_OFFSET(0xD0B5880)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GET_ITEMPREFABDATALIST_OFFSET UNITYSDK_OFFSET(0xD0A9EE0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GET_ITEMPREVIEWCOUNT_OFFSET UNITYSDK_OFFSET(0xD0B7D20)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GET_ITEMSIZEWITHPADDING_OFFSET UNITYSDK_OFFSET(0xD0AA540)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GET_ITEMSIZE_OFFSET UNITYSDK_OFFSET(0xD0AA030)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GET_ITEMSNAPENABLE_OFFSET UNITYSDK_OFFSET(0xD0AA010)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GET_ITEMTOTALCOUNT_OFFSET UNITYSDK_OFFSET(0xD0A9EF0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GET_MITEMSIZE_OFFSET UNITYSDK_OFFSET(0xD0AA0B0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GET_PADDING_OFFSET UNITYSDK_OFFSET(0xD0AA550)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GET_SCROLLRECT_OFFSET UNITYSDK_OFFSET(0xD0A9FF0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GET_VIEWPORTHEIGHT_OFFSET UNITYSDK_OFFSET(0xD0A9F80)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_GET_VIEWPORTWIDTH_OFFSET UNITYSDK_OFFSET(0xD0A9F10)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_INITGRIDVIEW_OFFSET UNITYSDK_OFFSET(0xD0AA840)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_INITITEMPOOL_OFFSET UNITYSDK_OFFSET(0xD0AB4C0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_ISCONTAINERTRANSCANMOVE_OFFSET UNITYSDK_OFFSET(0xD0B0BB0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_ISINIGROREREFRESH_OFFSET UNITYSDK_OFFSET(0xD0B7E40)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_ISITEMOUTOFVIEWPORT_OFFSET UNITYSDK_OFFSET(0xD0B7F20)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_ISITEMWITHINVIEWPORT_OFFSET UNITYSDK_OFFSET(0xD0B7E90)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_ISREPEATUPDATE_OFFSET UNITYSDK_OFFSET(0xD0AE770)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_MARKNEXTFRAMEREFRESH_OFFSET UNITYSDK_OFFSET(0xD0B7DF0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_MOVEPANELTOITEMBYINDEX_OFFSET UNITYSDK_OFFSET(0xD0AE400)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_MOVEPANELTOITEMBYROWCOLUMN_OFFSET UNITYSDK_OFFSET(0xD0AC550)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_NEWLISTVIEWITEM_1_OFFSET UNITYSDK_OFFSET(0xD0B5890)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_NEWLISTVIEWITEM_OFFSET UNITYSDK_OFFSET(0xD0AD520)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_ONANIMATORBUTTONSELECTED_OFFSET UNITYSDK_OFFSET(0xD0B6A70)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xD0AE7D0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD0B7880)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_ONDRAG_OFFSET UNITYSDK_OFFSET(0xD0AE990)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD0B68E0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0xD0AE8C0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_ONITEMNEW_OFFSET UNITYSDK_OFFSET(0xD0B1BC0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_ONITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0xD0B0E30)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_ONPOINTERDOWNINSCROLLBAR_OFFSET UNITYSDK_OFFSET(0xD0B3F20)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_ONPOINTERUPINSCROLLBAR_OFFSET UNITYSDK_OFFSET(0xD0B3FB0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0xD0B6970)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_ONSETLISTITEMFINISH_OFFSET UNITYSDK_OFFSET(0xD0B7710)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0xD0B6270)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_PREPAREINSTANCEITEM_OFFSET UNITYSDK_OFFSET(0xD0B3AE0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_RECYCLEALLITEM_OFFSET UNITYSDK_OFFSET(0xD0AC1F0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_RECYCLEITEMGROUPTMP_OFFSET UNITYSDK_OFFSET(0xD0AF920)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_RECYCLEITEMTMP_OFFSET UNITYSDK_OFFSET(0xD0AE170)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_RECYCLEONEITEMGROUPOBJ_OFFSET UNITYSDK_OFFSET(0xD0B0D70)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_REFRESHALLITEMSIZEONSCREENCHANGED_OFFSET UNITYSDK_OFFSET(0xD0B31E0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_REFRESHALLSHOWNITEM_OFFSET UNITYSDK_OFFSET(0xD0AE640)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_REFRESHDIRTYCHECK_OFFSET UNITYSDK_OFFSET(0xD0B3170)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_REFRESHITEMBYITEMINDEX_OFFSET UNITYSDK_OFFSET(0xD0AD830)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_REFRESHITEMBYROWCOLUMN_OFFSET UNITYSDK_OFFSET(0xD0AD990)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_REFRESHVIEWPORTANDCONTENTPIVOTANDANCHOR_OFFSET UNITYSDK_OFFSET(0xD0B18F0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_SAFEINITGRIDVIEW_OFFSET UNITYSDK_OFFSET(0xD0B5C50)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_SETGRIDFIXEDGROUPCOUNT_OFFSET UNITYSDK_OFFSET(0xD0AF350)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_SETITEMPADDING_OFFSET UNITYSDK_OFFSET(0xD0AA400)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_SETITEMSIZE_OFFSET UNITYSDK_OFFSET(0xD0AA180)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_SETLISTITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xD0ABB50)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_SETPADDING_OFFSET UNITYSDK_OFFSET(0xD0AA5B0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_SETSCROLLBARLISTENER_OFFSET UNITYSDK_OFFSET(0xD0AAF60)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_SETSNAPTARGETITEMROWCOLUMN_OFFSET UNITYSDK_OFFSET(0xD0AE310)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_SET_ARRANGETYPE_OFFSET UNITYSDK_OFFSET(0xD0A9ED0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_SET_AUTOADAPTITEMSIZE_OFFSET UNITYSDK_OFFSET(0xD0B6960)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_SET_FADEINLENGTH_OFFSET UNITYSDK_OFFSET(0xD0B5E90)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_SET_FADEINOFFSET_OFFSET UNITYSDK_OFFSET(0xD0B5E70)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_SET_ISAUTOFADEIN_OFFSET UNITYSDK_OFFSET(0xD0B68B0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_SET_ISFLEXIBLECOUNT_OFFSET UNITYSDK_OFFSET(0xD0B5E50)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_SET_ISIGNORETRANSDIRTYWAIT_OFFSET UNITYSDK_OFFSET(0xD0B7DA0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_SET_ISNAVITONEXTLINE_OFFSET UNITYSDK_OFFSET(0xD0B7DC0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_SET_ISNEEDFADEIN_OFFSET UNITYSDK_OFFSET(0xD0B68D0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_SET_ISPCPLATFORMSIZE_OFFSET UNITYSDK_OFFSET(0xD0B7DE0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_SET_ITEMPADDING_OFFSET UNITYSDK_OFFSET(0xD0AA3B0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_SET_ITEMPREVIEWCOUNT_OFFSET UNITYSDK_OFFSET(0xD0B7D30)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_SET_ITEMSIZE_OFFSET UNITYSDK_OFFSET(0xD0AA130)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_SET_ITEMSNAPENABLE_OFFSET UNITYSDK_OFFSET(0xD0AA020)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_SET_MITEMSIZE_OFFSET UNITYSDK_OFFSET(0xD0AF520)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_SET_PADDING_OFFSET UNITYSDK_OFFSET(0xD0AA560)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_SPAWNED_OFFSET UNITYSDK_OFFSET(0xD0B7C90)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_UPDATEALLGRIDSETTING_OFFSET UNITYSDK_OFFSET(0xD0AB9B0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_UPDATECOLUMNITEMGROUPFORRECYCLEANDNEW_OFFSET UNITYSDK_OFFSET(0xD0B0550)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_UPDATECOLUMNROWCOUNT_OFFSET UNITYSDK_OFFSET(0xD0ABF60)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_UPDATECONTENTSIZE_OFFSET UNITYSDK_OFFSET(0xD0AC010)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_UPDATECURFRAMEITEMRANGEDATA_OFFSET UNITYSDK_OFFSET(0xD0AFB30)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_UPDATECURSNAPDATA_OFFSET UNITYSDK_OFFSET(0xD0B5310)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_UPDATEFROMSETTINGPARAM_OFFSET UNITYSDK_OFFSET(0xD0AAC20)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_UPDATEGRIDVIEWCONTENT_OFFSET UNITYSDK_OFFSET(0xD0ACA50)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_UPDATEITEMSIZE_OFFSET UNITYSDK_OFFSET(0xD0AEFF0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_UPDATENEARESTSNAPITEM_OFFSET UNITYSDK_OFFSET(0xD0B4E50)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_UPDATEROWITEMGROUPFORRECYCLEANDNEW_OFFSET UNITYSDK_OFFSET(0xD0AFF90)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_UPDATESNAPMOVE_OFFSET UNITYSDK_OFFSET(0xD0B3550)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_UPDATESTARTENDPADDING_OFFSET UNITYSDK_OFFSET(0xD0AED50)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0xD0B2E00)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW_VAILDANDSETCONTAINERPOS_OFFSET UNITYSDK_OFFSET(0xD0AC420)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW__CHANGEONGETITEMBYROWCOLUMN_OFFSET UNITYSDK_OFFSET(0xD0B5DA0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW__CHANGETABLE_OFFSET UNITYSDK_OFFSET(0xD0B5DF0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xD0B8540)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW__TICKFADEIN_OFFSET UNITYSDK_OFFSET(0xD0B3990)
#define SUPERSCROLLVIEW_LOOPGRIDVIEW__UPDATEFLEXIBLEFIXEDCOUNT_OFFSET UNITYSDK_OFFSET(0xD0B2FF0)

namespace SuperScrollView
{
	inline static constexpr unsigned int LoopGridView_TypeDefinitionIndex = 44943;
