...
#define SUPERSCROLLVIEW_ITEMPREFABCONFDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x14EDAE60)

namespace SuperScrollView
{
	inline static constexpr unsigned int ItemPrefabConfData_TypeDefinitionIndex = 45868;
