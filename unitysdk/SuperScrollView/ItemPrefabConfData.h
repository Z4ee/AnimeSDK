...
#define SUPERSCROLLVIEW_ITEMPREFABCONFDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD0A36B0)

namespace SuperScrollView
{
	inline static constexpr unsigned int ItemPrefabConfData_TypeDefinitionIndex = 44950;
