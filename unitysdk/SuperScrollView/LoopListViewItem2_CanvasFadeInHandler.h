...
#define SUPERSCROLLVIEW_LOOPLISTVIEWITEM2_CANVASFADEINHANDLER_CLEAR_OFFSET UNITYSDK_OFFSET(0xD0A9BA0)
#define SUPERSCROLLVIEW_LOOPLISTVIEWITEM2_CANVASFADEINHANDLER_DESTROY_OFFSET UNITYSDK_OFFSET(0xD0D4410)
#define SUPERSCROLLVIEW_LOOPLISTVIEWITEM2_CANVASFADEINHANDLER_GET_ANIMATIONFADEVALID_OFFSET UNITYSDK_OFFSET(0xD0D44B0)
#define SUPERSCROLLVIEW_LOOPLISTVIEWITEM2_CANVASFADEINHANDLER_HIDE_OFFSET UNITYSDK_OFFSET(0xD0A99D0)
#define SUPERSCROLLVIEW_LOOPLISTVIEWITEM2_CANVASFADEINHANDLER_INIT_OFFSET UNITYSDK_OFFSET(0xD0A9680)
#define SUPERSCROLLVIEW_LOOPLISTVIEWITEM2_CANVASFADEINHANDLER_ONRECYCLE_OFFSET UNITYSDK_OFFSET(0xD0A9750)
#define SUPERSCROLLVIEW_LOOPLISTVIEWITEM2_CANVASFADEINHANDLER_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0xD0A9380)
#define SUPERSCROLLVIEW_LOOPLISTVIEWITEM2_CANVASFADEINHANDLER_SHOW_OFFSET UNITYSDK_OFFSET(0xD0A9AA0)
#define SUPERSCROLLVIEW_LOOPLISTVIEWITEM2_CANVASFADEINHANDLER_TICKFADEIN_OFFSET UNITYSDK_OFFSET(0xD0A8F00)
#define SUPERSCROLLVIEW_LOOPLISTVIEWITEM2_CANVASFADEINHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD0A9670)

namespace SuperScrollView
{
	inline static constexpr unsigned int LoopListViewItem2_CanvasFadeInHandler_TypeDefinitionIndex = 44960;
