...
#define SUPERSCROLLVIEW_FLEXIBLEGRIDCONFDATA_GET_CANNAVI_OFFSET UNITYSDK_OFFSET(0xE9441F0)
#define SUPERSCROLLVIEW_FLEXIBLEGRIDCONFDATA_GET_ISPCSIZE_OFFSET UNITYSDK_OFFSET(0xE943E60)
#define SUPERSCROLLVIEW_FLEXIBLEGRIDCONFDATA_GET_ISREDEFINESIZE_OFFSET UNITYSDK_OFFSET(0xE943EE0)
#define SUPERSCROLLVIEW_FLEXIBLEGRIDCONFDATA_GET_ISTITLE_OFFSET UNITYSDK_OFFSET(0xE9441E0)
#define SUPERSCROLLVIEW_FLEXIBLEGRIDCONFDATA_GET_ITEMSIZE_OFFSET UNITYSDK_OFFSET(0xE943F30)
#define SUPERSCROLLVIEW_FLEXIBLEGRIDCONFDATA_GET_SIZEDELTA_OFFSET UNITYSDK_OFFSET(0xE944370)
#define SUPERSCROLLVIEW_FLEXIBLEGRIDCONFDATA_GET__RTF_OFFSET UNITYSDK_OFFSET(0xE943DB0)
#define SUPERSCROLLVIEW_FLEXIBLEGRIDCONFDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xE944490)
