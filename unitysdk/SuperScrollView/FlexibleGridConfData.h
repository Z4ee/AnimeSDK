...
#define SUPERSCROLLVIEW_FLEXIBLEGRIDCONFDATA_GET_CANNAVI_OFFSET UNITYSDK_OFFSET(0xB957170)
#define SUPERSCROLLVIEW_FLEXIBLEGRIDCONFDATA_GET_ISPCSIZE_OFFSET UNITYSDK_OFFSET(0xB956DD0)
#define SUPERSCROLLVIEW_FLEXIBLEGRIDCONFDATA_GET_ISREDEFINESIZE_OFFSET UNITYSDK_OFFSET(0xB956E50)
#define SUPERSCROLLVIEW_FLEXIBLEGRIDCONFDATA_GET_ISTITLE_OFFSET UNITYSDK_OFFSET(0xB957160)
#define SUPERSCROLLVIEW_FLEXIBLEGRIDCONFDATA_GET_ITEMSIZE_OFFSET UNITYSDK_OFFSET(0xB956EA0)
#define SUPERSCROLLVIEW_FLEXIBLEGRIDCONFDATA_GET_SIZEDELTA_OFFSET UNITYSDK_OFFSET(0xB9572F0)
#define SUPERSCROLLVIEW_FLEXIBLEGRIDCONFDATA_GET__RTF_OFFSET UNITYSDK_OFFSET(0xB956D20)
#define SUPERSCROLLVIEW_FLEXIBLEGRIDCONFDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB957410)

namespace SuperScrollView
{
	inline static constexpr unsigned int FlexibleGridConfData_TypeDefinitionIndex = 44387;
