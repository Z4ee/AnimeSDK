...
#define SUPERSCROLLVIEW_ROWCOLUMNPAIR_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x14B200)
#define SUPERSCROLLVIEW_ROWCOLUMNPAIR_EQUALS_OFFSET UNITYSDK_OFFSET(0x14B150)
#define SUPERSCROLLVIEW_ROWCOLUMNPAIR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x14B1B0)
#define SUPERSCROLLVIEW_ROWCOLUMNPAIR_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xD0B5820)
#define SUPERSCROLLVIEW_ROWCOLUMNPAIR_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xD0B50D0)
#define SUPERSCROLLVIEW_ROWCOLUMNPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x7BBE0)
#define SUPERSCROLLVIEW_ROWCOLUMNPAIR___IFIXBASEPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0x14B2C0)
#define SUPERSCROLLVIEW_ROWCOLUMNPAIR___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x14B210)
