...
#define SUPERSCROLLVIEW_GRIDITEMPOOL_ONNEWPREFABINS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xABE4960)
#define SUPERSCROLLVIEW_GRIDITEMPOOL_ONNEWPREFABINS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xABE4990)
#define SUPERSCROLLVIEW_GRIDITEMPOOL_ONNEWPREFABINS_INVOKE_OFFSET UNITYSDK_OFFSET(0xABE42A0)
#define SUPERSCROLLVIEW_GRIDITEMPOOL_ONNEWPREFABINS__CTOR_OFFSET UNITYSDK_OFFSET(0xABE4940)

namespace SuperScrollView
{
	inline static constexpr unsigned int GridItemPool_OnNewPrefabIns_TypeDefinitionIndex = 38511;
