...
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_ADJUSTANCHOR_OFFSET UNITYSDK_OFFSET(0x10517A70)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_ADJUSTCOLUMNORROW_OFFSET UNITYSDK_OFFSET(0x10518300)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_ADJUSTCONTAINERANCHOR_OFFSET UNITYSDK_OFFSET(0x1051BE00)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_ADJUSTCONTAINERPIVOT_OFFSET UNITYSDK_OFFSET(0x10517BC0)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_ADJUSTPIVOT_OFFSET UNITYSDK_OFFSET(0x10517990)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_CACHEDRAGPOINTEREVENTDATA_OFFSET UNITYSDK_OFFSET(0x1051C140)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_CHECKALLGROUPIFNEEDUPDATEITEMPOS_OFFSET UNITYSDK_OFFSET(0x1051A3D0)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_CLEARALLTMPRECYCLEDITEM_OFFSET UNITYSDK_OFFSET(0x10519540)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_CLEARALL_OFFSET UNITYSDK_OFFSET(0x1051E940)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x1051EDA0)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_GETCONTENTSIZE_OFFSET UNITYSDK_OFFSET(0x1051A530)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_GETCURSHOULDADDNEWITEMGROUPINDEX_OFFSET UNITYSDK_OFFSET(0x1051DB40)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_GETITEMABSPOSBYITEMINDEX_OFFSET UNITYSDK_OFFSET(0x1051A7F0)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_GETITEMBYGROUPANDGROUPINDEX_OFFSET UNITYSDK_OFFSET(0x1051E400)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_GETITEMGROUPBYINDEX_OFFSET UNITYSDK_OFFSET(0x105170D0)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_GETITEMINDEXDATA_OFFSET UNITYSDK_OFFSET(0x1051AC70)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_GETITEMPREFABCONFDATA_OFFSET UNITYSDK_OFFSET(0x10517160)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_GETNEWITEMBYGROUPANDINDEX_OFFSET UNITYSDK_OFFSET(0x1051D320)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_GETSHOWNITEMBYITEMINDEX_OFFSET UNITYSDK_OFFSET(0x1051ABF0)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_GET_ARRANGETYPE_OFFSET UNITYSDK_OFFSET(0x10517020)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_GET_CONTAINERTRANS_OFFSET UNITYSDK_OFFSET(0x10517080)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_GET_CURMAXCREATEDITEMINDEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1051C480)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_GET_ISDRAGING_OFFSET UNITYSDK_OFFSET(0x105170A0)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_GET_ISINITED_OFFSET UNITYSDK_OFFSET(0x105170C0)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_GET_ISVERTLIST_OFFSET UNITYSDK_OFFSET(0x10517060)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_GET_ITEMPREFABDATALIST_OFFSET UNITYSDK_OFFSET(0x10517040)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_GET_ITEMTOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x10517070)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_GET_LAYOUTPARAM_OFFSET UNITYSDK_OFFSET(0x105170B0)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_GET_LISTUPDATECHECKFRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x10517050)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_GET_SCROLLRECT_OFFSET UNITYSDK_OFFSET(0x10517090)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_GET_VIEWPORTHEIGHT_OFFSET UNITYSDK_OFFSET(0x10519670)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_GET_VIEWPORTSIZE_OFFSET UNITYSDK_OFFSET(0x1051A490)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_GET_VIEWPORTWIDTH_OFFSET UNITYSDK_OFFSET(0x10519600)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_INITITEMPOOL_OFFSET UNITYSDK_OFFSET(0x10517CA0)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_INITLISTVIEW_OFFSET UNITYSDK_OFFSET(0x10517310)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_ISCONTAINERTRANSCANMOVE_OFFSET UNITYSDK_OFFSET(0x1051E680)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_MOVEPANELTOITEMINDEX_OFFSET UNITYSDK_OFFSET(0x1051A090)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_NEWLISTVIEWITEM_1_OFFSET UNITYSDK_OFFSET(0x10519B20)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_NEWLISTVIEWITEM_OFFSET UNITYSDK_OFFSET(0x105196E0)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_ONANIMATORBUTTONSELECTED_OFFSET UNITYSDK_OFFSET(0x1051E5C0)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x1051C0B0)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1051ED50)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1051C3F0)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x1051C360)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_ONITEMNEW_OFFSET UNITYSDK_OFFSET(0x1051D620)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_ONITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0x1051BA30)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_ONITEMSIZECHANGED_OFFSET UNITYSDK_OFFSET(0x1051AF20)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x1051E390)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_RECYCLEALLITEM_OFFSET UNITYSDK_OFFSET(0x10519480)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_RECYCLEITEMTMP_OFFSET UNITYSDK_OFFSET(0x1051B800)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_REFRESHALLSHOWNITEM_OFFSET UNITYSDK_OFFSET(0x1051ADD0)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_REFRESHITEMBYITEMINDEX_OFFSET UNITYSDK_OFFSET(0x1051B160)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_RESETGRIDVIEWLAYOUTPARAM_OFFSET UNITYSDK_OFFSET(0x10518ED0)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_RESETLISTVIEW_OFFSET UNITYSDK_OFFSET(0x1051B560)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_SETANCHOREDPOSITIONX_OFFSET UNITYSDK_OFFSET(0x1051A6E0)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_SETANCHOREDPOSITIONY_OFFSET UNITYSDK_OFFSET(0x1051A5D0)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_SETLISTITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x105192C0)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_SET_ARRANGETYPE_OFFSET UNITYSDK_OFFSET(0x10517030)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_SPAWNED_OFFSET UNITYSDK_OFFSET(0x1051EDF0)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_UPDATEALLGROUPSHOWNITEMSPOS_OFFSET UNITYSDK_OFFSET(0x1051C4D0)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_UPDATECONTENTSIZE_OFFSET UNITYSDK_OFFSET(0x10518CD0)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_UPDATELAYOUTPARAMAUTOVALUE_OFFSET UNITYSDK_OFFSET(0x10518680)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_UPDATELISTVIEWWITHDEFAULT_OFFSET UNITYSDK_OFFSET(0x1051DE70)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_UPDATELISTVIEW_OFFSET UNITYSDK_OFFSET(0x1051A930)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0x1051DEF0)
#define SUPERSCROLLVIEW_LOOPSTAGGEREDGRIDVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1051EE30)
