...
#define SUPERSCROLLVIEW_ONRECYCLECHANGED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1051FB10)
#define SUPERSCROLLVIEW_ONRECYCLECHANGED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1051FB60)
#define SUPERSCROLLVIEW_ONRECYCLECHANGED_INVOKE_OFFSET UNITYSDK_OFFSET(0x10516110)
#define SUPERSCROLLVIEW_ONRECYCLECHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1051FAA0)

namespace SuperScrollView
{
	inline static constexpr unsigned int OnRecycleChanged_TypeDefinitionIndex = 45876;
