...
#define SROPTIONSPROPERTYCHANGED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x192824D0)
#define SROPTIONSPROPERTYCHANGED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19282510)
#define SROPTIONSPROPERTYCHANGED_INVOKE_OFFSET UNITYSDK_OFFSET(0x192821F0)
#define SROPTIONSPROPERTYCHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0x192823E0)

inline static constexpr unsigned int SROptionsPropertyChanged_TypeDefinitionIndex = 42606;
