...
#define SROPTIONSPROPERTYCHANGED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x861D170)
#define SROPTIONSPROPERTYCHANGED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x861D1B0)
#define SROPTIONSPROPERTYCHANGED_INVOKE_OFFSET UNITYSDK_OFFSET(0x861C9F0)
#define SROPTIONSPROPERTYCHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0x861D150)

inline static constexpr unsigned int SROptionsPropertyChanged_TypeDefinitionIndex = 35099;
