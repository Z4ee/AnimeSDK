...
#define SROPTIONSPROPERTYCHANGED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFEB330)
#define SROPTIONSPROPERTYCHANGED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFEB370)
#define SROPTIONSPROPERTYCHANGED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFEB050)
#define SROPTIONSPROPERTYCHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFEB240)

inline static constexpr unsigned int SROptionsPropertyChanged_TypeDefinitionIndex = 44788;
