...
#define POSTPROCESS_MKGLOW_PRESETS_SETGLAREPRESET_OFFSET UNITYSDK_OFFSET(0x1C13F490)
#define POSTPROCESS_MKGLOW_PRESETS_SETLENSFLAREPRESET_OFFSET UNITYSDK_OFFSET(0x1C13EC20)
#define POSTPROCESS_MKGLOW_PRESETS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C140D30)

namespace PostProcess::MKGlow
{
	inline static constexpr unsigned int Presets_TypeDefinitionIndex = 26347;
