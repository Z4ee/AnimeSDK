...
#define POSTPROCESS_MKGLOW_PRESETS_SETGLAREPRESET_OFFSET UNITYSDK_OFFSET(0x19F23AF0)
#define POSTPROCESS_MKGLOW_PRESETS_SETLENSFLAREPRESET_OFFSET UNITYSDK_OFFSET(0x19F23280)
#define POSTPROCESS_MKGLOW_PRESETS__CTOR_OFFSET UNITYSDK_OFFSET(0x19F25390)

namespace PostProcess::MKGlow
{
	inline static constexpr unsigned int Presets_TypeDefinitionIndex = 29666;
