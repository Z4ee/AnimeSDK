...
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_DRAW_1_OFFSET UNITYSDK_OFFSET(0x1B1710F0)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_DRAW_2_OFFSET UNITYSDK_OFFSET(0x1B171350)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_DRAW_3_OFFSET UNITYSDK_OFFSET(0x1B1713F0)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_DRAW_OFFSET UNITYSDK_OFFSET(0x1B170F00)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_GETTEMPORARY_OFFSET UNITYSDK_OFFSET(0x1B1717F0)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_GET_SCREENMESH_OFFSET UNITYSDK_OFFSET(0x1B170A00)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_SETKEYWORD_1_OFFSET UNITYSDK_OFFSET(0x1B170EA0)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_SETKEYWORD_OFFSET UNITYSDK_OFFSET(0x1B170E20)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_SINGLEPASSSTEREODOWNSCALE_OFFSET UNITYSDK_OFFSET(0x1B171470)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_UPDATEMIPRENDERCONTEXT_OFFSET UNITYSDK_OFFSET(0x1B171580)

namespace PostProcess::MKGlow
{
	inline static constexpr unsigned int PipelineExtensions_TypeDefinitionIndex = 26485;
	...
	public:
		...
		{
			return (::UnityEngine::Mesh**)Il2CppClass::FromTypeDefinitionIndex(PipelineExtensions_TypeDefinitionIndex)->GetStaticField(0x20AD0);
		}
