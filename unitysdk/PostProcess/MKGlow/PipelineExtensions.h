...
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_DRAW_1_OFFSET UNITYSDK_OFFSET(0x1C5A8400)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_DRAW_2_OFFSET UNITYSDK_OFFSET(0x1C5A8670)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_DRAW_3_OFFSET UNITYSDK_OFFSET(0x1C5A8710)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_DRAW_OFFSET UNITYSDK_OFFSET(0x1C5A8210)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_GETTEMPORARY_OFFSET UNITYSDK_OFFSET(0x1C5A8B10)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_GET_SCREENMESH_OFFSET UNITYSDK_OFFSET(0x1C5A7D10)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_SETKEYWORD_1_OFFSET UNITYSDK_OFFSET(0x1C5A81B0)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_SETKEYWORD_OFFSET UNITYSDK_OFFSET(0x1C5A8130)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_SINGLEPASSSTEREODOWNSCALE_OFFSET UNITYSDK_OFFSET(0x1C5A8790)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_UPDATEMIPRENDERCONTEXT_OFFSET UNITYSDK_OFFSET(0x1C5A88A0)

namespace PostProcess::MKGlow
{
	inline static constexpr unsigned int PipelineExtensions_TypeDefinitionIndex = 27389;
	...
	public:
		...
		{
			return (::UnityEngine::Mesh**)Il2CppClass::FromTypeDefinitionIndex(PipelineExtensions_TypeDefinitionIndex)->GetStaticField(0x21CD0);
		}
