...
#define POSTPROCESS_MKGLOW_MIPBUFFER_CLEARTEMPORARY_OFFSET UNITYSDK_OFFSET(0x1C4CF2D0)
#define POSTPROCESS_MKGLOW_MIPBUFFER_CREATETEMPORARY_OFFSET UNITYSDK_OFFSET(0x1C4CF180)
#define POSTPROCESS_MKGLOW_MIPBUFFER_GET_RENDERTARGETS_OFFSET UNITYSDK_OFFSET(0x1C4CEFB0)
#define POSTPROCESS_MKGLOW_MIPBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4CEFC0)

namespace PostProcess::MKGlow
{
	inline static constexpr unsigned int MipBuffer_TypeDefinitionIndex = 27012;
