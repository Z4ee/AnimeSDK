...
#define POSTPROCESS_MKGLOW_MIPBUFFER_CLEARTEMPORARY_OFFSET UNITYSDK_OFFSET(0x191033D0)
#define POSTPROCESS_MKGLOW_MIPBUFFER_CREATETEMPORARY_OFFSET UNITYSDK_OFFSET(0x19103280)
#define POSTPROCESS_MKGLOW_MIPBUFFER_GET_RENDERTARGETS_OFFSET UNITYSDK_OFFSET(0x191030B0)
#define POSTPROCESS_MKGLOW_MIPBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x191030C0)

namespace PostProcess::MKGlow
{
	inline static constexpr unsigned int MipBuffer_TypeDefinitionIndex = 29659;
