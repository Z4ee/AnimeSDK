...
#define POSTPROCESS_MKGLOW_RENDERDIMENSION_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x3EA3D0)
#define POSTPROCESS_MKGLOW_RENDERDIMENSION_GET_RENDERDIMENSION_OFFSET UNITYSDK_OFFSET(0x246290)
#define POSTPROCESS_MKGLOW_RENDERDIMENSION_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define POSTPROCESS_MKGLOW_RENDERDIMENSION_SET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x5120D0)
#define POSTPROCESS_MKGLOW_RENDERDIMENSION_SET_WIDTH_OFFSET UNITYSDK_OFFSET(0x2B66C0)
#define POSTPROCESS_MKGLOW_RENDERDIMENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x2AB920)

namespace PostProcess::MKGlow
{
	inline static constexpr unsigned int RenderDimension_TypeDefinitionIndex = 26732;
