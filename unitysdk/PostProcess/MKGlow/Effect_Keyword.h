...
#define POSTPROCESS_MKGLOW_EFFECT_KEYWORD__CTOR_OFFSET UNITYSDK_OFFSET(0x33DF30)

namespace PostProcess::MKGlow
{
	inline static constexpr unsigned int Effect_Keyword_TypeDefinitionIndex = 27230;
