...
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_COMPUTESHADER_OFFSET UNITYSDK_OFFSET(0xF7944A0)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_GLAREMATERIAL1_OFFSET UNITYSDK_OFFSET(0xF794500)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_GLAREMATERIAL2_OFFSET UNITYSDK_OFFSET(0xF794510)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_GLAREMATERIAL3_OFFSET UNITYSDK_OFFSET(0xF794520)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_GLAREMATERIAL4_OFFSET UNITYSDK_OFFSET(0xF794530)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_LENSFLARECOLORRAMPDEFAULT_OFFSET UNITYSDK_OFFSET(0xF794430)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_LENSSURFACEDIFFRACTIONTEXTUREDEFAULT_OFFSET UNITYSDK_OFFSET(0xF794420)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_LENSSURFACEDIRTTEXTUREDEFAULT_OFFSET UNITYSDK_OFFSET(0xF794410)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_SELECTIVERENDERSHADER_OFFSET UNITYSDK_OFFSET(0xF794440)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_SM20SHADER_OFFSET UNITYSDK_OFFSET(0xF794450)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_SM25SHADER_OFFSET UNITYSDK_OFFSET(0xF794460)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_SM35SHADER_OFFSET UNITYSDK_OFFSET(0xF794470)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_SM40GEOMETRYSHADER_OFFSET UNITYSDK_OFFSET(0xF794490)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_SM45SHADER_OFFSET UNITYSDK_OFFSET(0xF794480)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES__CTOR_OFFSET UNITYSDK_OFFSET(0xF794540)

namespace PostProcess::MKGlow
{
	inline static constexpr unsigned int MKGlowResources_TypeDefinitionIndex = 26849;
