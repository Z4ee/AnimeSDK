...
#define POSTPROCESS_MKGLOW_PIPELINEPROPERTIES_SHADERPROPERTIES_DEFAULTPROPERTY_GET_ID_OFFSET UNITYSDK_OFFSET(0x1C993010)
#define POSTPROCESS_MKGLOW_PIPELINEPROPERTIES_SHADERPROPERTIES_DEFAULTPROPERTY_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1C993000)
#define POSTPROCESS_MKGLOW_PIPELINEPROPERTIES_SHADERPROPERTIES_DEFAULTPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C993020)

namespace PostProcess::MKGlow
{
	inline static constexpr unsigned int PipelineProperties_ShaderProperties_DefaultProperty_TypeDefinitionIndex = 27288;
