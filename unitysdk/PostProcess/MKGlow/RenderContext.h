...
#define POSTPROCESS_MKGLOW_RENDERCONTEXT_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1908E010)
#define POSTPROCESS_MKGLOW_RENDERCONTEXT_GET_ENABLERANDOMWRITE_OFFSET UNITYSDK_OFFSET(0x1908E040)
#define POSTPROCESS_MKGLOW_RENDERCONTEXT_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x190838C0)
#define POSTPROCESS_MKGLOW_RENDERCONTEXT_GET_RENDERDIMENSION_OFFSET UNITYSDK_OFFSET(0x19084C10)
#define POSTPROCESS_MKGLOW_RENDERCONTEXT_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0x190838B0)
#define POSTPROCESS_MKGLOW_RENDERCONTEXT_SINGLEPASSSTEREOADJUSTWIDTH_OFFSET UNITYSDK_OFFSET(0x190837D0)
#define POSTPROCESS_MKGLOW_RENDERCONTEXT_UPDATERENDERCONTEXT_OFFSET UNITYSDK_OFFSET(0x19083000)
#define POSTPROCESS_MKGLOW_RENDERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x19081BD0)

namespace PostProcess::MKGlow
{
	inline static constexpr unsigned int RenderContext_TypeDefinitionIndex = 29667;
