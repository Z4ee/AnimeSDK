...
#define POSTPROCESS_MKGLOW_RENDERCONTEXT_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1AECA900)
#define POSTPROCESS_MKGLOW_RENDERCONTEXT_GET_ENABLERANDOMWRITE_OFFSET UNITYSDK_OFFSET(0x1AECA930)
#define POSTPROCESS_MKGLOW_RENDERCONTEXT_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x1AEC01D0)
#define POSTPROCESS_MKGLOW_RENDERCONTEXT_GET_RENDERDIMENSION_OFFSET UNITYSDK_OFFSET(0x1AEC1510)
#define POSTPROCESS_MKGLOW_RENDERCONTEXT_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0x1AEC01C0)
#define POSTPROCESS_MKGLOW_RENDERCONTEXT_SINGLEPASSSTEREOADJUSTWIDTH_OFFSET UNITYSDK_OFFSET(0x1AEC00E0)
#define POSTPROCESS_MKGLOW_RENDERCONTEXT_UPDATERENDERCONTEXT_OFFSET UNITYSDK_OFFSET(0x1AEBF910)
#define POSTPROCESS_MKGLOW_RENDERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEBE4D0)

namespace PostProcess::MKGlow
{
	inline static constexpr unsigned int RenderContext_TypeDefinitionIndex = 26579;
