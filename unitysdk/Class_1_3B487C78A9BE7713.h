...
#define CLASS_1_3B487C78A9BE7713_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E323300)
#define CLASS_1_3B487C78A9BE7713_CLONE_OFFSET UNITYSDK_OFFSET(0x1E322F10)
#define CLASS_1_3B487C78A9BE7713_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E323090)
#define CLASS_1_3B487C78A9BE7713_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E322F50)
#define CLASS_1_3B487C78A9BE7713_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E3231B0)
#define CLASS_1_3B487C78A9BE7713_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E323440)
#define CLASS_1_3B487C78A9BE7713_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E3233A0)
#define CLASS_1_3B487C78A9BE7713_METHOD_1_2E179BEDD6B3AA06_OFFSET UNITYSDK_OFFSET(0x1E322F40)
#define CLASS_1_3B487C78A9BE7713_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E322E00)
#define CLASS_1_3B487C78A9BE7713_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E322E30)
#define CLASS_1_3B487C78A9BE7713_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E323220)
#define CLASS_1_3B487C78A9BE7713_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E323280)
#define CLASS_1_3B487C78A9BE7713__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E323610)
#define CLASS_1_3B487C78A9BE7713__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E322E80)
#define CLASS_1_3B487C78A9BE7713__CTOR_OFFSET UNITYSDK_OFFSET(0x1E322E40)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_3B487C78A9BE7713*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_3B487C78A9BE7713_TypeDefinitionIndex)->GetStaticField(0x284C0);
	}
	static ::Google::Protobuf::FieldCodec_1<::Enum_3_01618AD0437C8486_2>** StaticGet_OBAMOJMBJGO()
	{
		return (::Google::Protobuf::FieldCodec_1<::Enum_3_01618AD0437C8486_2>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_3B487C78A9BE7713_TypeDefinitionIndex)->GetStaticField(0x284C8);
	}
