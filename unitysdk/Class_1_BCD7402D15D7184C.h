...
#define CLASS_1_BCD7402D15D7184C_METHOD_1_1E862743DFFAFAF1_OFFSET UNITYSDK_OFFSET(0x1B44EDA0)
#define CLASS_1_BCD7402D15D7184C_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x1B44EFB0)
#define CLASS_1_BCD7402D15D7184C_METHOD_1_369F4D8B975FCE58_OFFSET UNITYSDK_OFFSET(0x1B44D650)
#define CLASS_1_BCD7402D15D7184C_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1B44EF50)
#define CLASS_1_BCD7402D15D7184C_METHOD_1_7646FFE662147970_OFFSET UNITYSDK_OFFSET(0x1B44EEF0)
#define CLASS_1_BCD7402D15D7184C_METHOD_1_8D61BE16C9463302_OFFSET UNITYSDK_OFFSET(0x1B44F240)
#define CLASS_1_BCD7402D15D7184C_METHOD_1_A1781348F0A89177_OFFSET UNITYSDK_OFFSET(0x1B44ECF0)
#define CLASS_1_BCD7402D15D7184C_METHOD_1_E6ADFDCAE54F8710_OFFSET UNITYSDK_OFFSET(0x1B44F060)
#define CLASS_1_BCD7402D15D7184C__CTOR_OFFSET UNITYSDK_OFFSET(0x1B44F4D0)
...
public:
	...
	::RPG::GameCore::TaskContext* MIIIMIKGKEP; // 0x10
	::System::Collections::Generic::Dictionary_2<::Class_1_BCD7402D15D7184C_PhotoUpdateUseGraphType, ::Class_3_07C3C4D2990C49EE*>* BKKBPFMHDGF; // 0x18
	::RPG::GameCore::SwitchPhotographDragMode* IIEMJEPAGPE; // 0x20
	::RPG::GameCore::GlobalTimeSlow* ALJAPMHJBLA; // 0x28
	::System::Boolean GMEJICDOADK; // 0x30
	::System::Boolean HFMODAAECAN; // 0x31
