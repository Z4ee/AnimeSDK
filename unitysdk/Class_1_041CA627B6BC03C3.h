...
#define CLASS_1_041CA627B6BC03C3_METHOD_1_401D9792CCB3DD84_OFFSET UNITYSDK_OFFSET(0x180E1100)
#define CLASS_1_041CA627B6BC03C3_METHOD_1_403A1837F105DC0D_OFFSET UNITYSDK_OFFSET(0x180E0E70)
#define CLASS_1_041CA627B6BC03C3_METHOD_1_46BF5703641395C1_OFFSET UNITYSDK_OFFSET(0x180E0D30)
#define CLASS_1_041CA627B6BC03C3_METHOD_1_71A9B5BEA955F8AF_OFFSET UNITYSDK_OFFSET(0x180E0BA0)
#define CLASS_1_041CA627B6BC03C3_METHOD_1_9C6B3054F3C98939_OFFSET UNITYSDK_OFFSET(0x180E0C90)
#define CLASS_1_041CA627B6BC03C3_METHOD_1_B9F1EFBC29D405C2_OFFSET UNITYSDK_OFFSET(0x180E0F80)
#define CLASS_1_041CA627B6BC03C3_METHOD_1_C2D0A28EDD88D4E9_OFFSET UNITYSDK_OFFSET(0x180E11D0)
#define CLASS_1_041CA627B6BC03C3__CTOR_OFFSET UNITYSDK_OFFSET(0x180E0B30)

inline static constexpr unsigned int Class_1_041CA627B6BC03C3_TypeDefinitionIndex = 74930;

class Class_1_041CA627B6BC03C3 : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::RPG::Client::ActivityIdleLive::SpecialEquip*>* PEHEIFFLILI; // 0x10
	::RPG::Client::ActivityIdleLive::BaseSpEquipInventoryDisplayData* GLBBINMGMDL; // 0x18
	::RPG::Client::ActivityIdleLive::SpecialEquip* AFOBIFOCBMD; // 0x20
