...
#define CLASS_1_9CCDD9DFB0D3EBBA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18A77A00)
#define CLASS_1_9CCDD9DFB0D3EBBA_METHOD_1_5176DC743E478510_OFFSET UNITYSDK_OFFSET(0x18A77810)
#define CLASS_1_9CCDD9DFB0D3EBBA_METHOD_1_8C704EC832EDEFC8_OFFSET UNITYSDK_OFFSET(0x18A77D30)
#define CLASS_1_9CCDD9DFB0D3EBBA_METHOD_1_F15BB39D73E654DD_OFFSET UNITYSDK_OFFSET(0x18A77C30)
#define CLASS_1_9CCDD9DFB0D3EBBA_METHOD_1_F978A1D172468895_OFFSET UNITYSDK_OFFSET(0x18A77A50)
#define CLASS_1_9CCDD9DFB0D3EBBA__CTOR_OFFSET UNITYSDK_OFFSET(0x18A777E0)
...
{
public:
	::Struct_2_2FA61DF2EE4D4708 EJHODPJIFIN; // 0x10
	::RPG::GameCore::GameEntity* MFIEDDGBIPH; // 0x38
	::RPG::GameCore::GameEntity* BBMMBAKDJBC; // 0x40
	::System::Boolean LANGKOOBONL; // 0x48
	::System::Int32 APJNLBCCHPG; // 0x4C
