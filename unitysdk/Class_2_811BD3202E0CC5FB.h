...
#define CLASS_2_811BD3202E0CC5FB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A4507C0)
#define CLASS_2_811BD3202E0CC5FB_METHOD_2_0581090195E9C81F_OFFSET UNITYSDK_OFFSET(0x1A451D80)
#define CLASS_2_811BD3202E0CC5FB_METHOD_2_29861B2485680DBB_1_OFFSET UNITYSDK_OFFSET(0x1A451BB0)
#define CLASS_2_811BD3202E0CC5FB_METHOD_2_29861B2485680DBB_OFFSET UNITYSDK_OFFSET(0x1A451550)
#define CLASS_2_811BD3202E0CC5FB_METHOD_2_3ABD0165571B5EF8_OFFSET UNITYSDK_OFFSET(0x1A451E40)
#define CLASS_2_811BD3202E0CC5FB_METHOD_2_805C56F44231AEF9_OFFSET UNITYSDK_OFFSET(0x1A4511F0)
#define CLASS_2_811BD3202E0CC5FB_METHOD_2_870AF3CD1D0A67B1_OFFSET UNITYSDK_OFFSET(0x1A451720)
#define CLASS_2_811BD3202E0CC5FB_METHOD_2_FF7B2911BBACA4A9_1_OFFSET UNITYSDK_OFFSET(0x1A451F20)
#define CLASS_2_811BD3202E0CC5FB_METHOD_2_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x1A451DE0)
#define CLASS_2_811BD3202E0CC5FB_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1A450D00)
#define CLASS_2_811BD3202E0CC5FB_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1A450B20)
#define CLASS_2_811BD3202E0CC5FB_TICK_OFFSET UNITYSDK_OFFSET(0x1A451320)
#define CLASS_2_811BD3202E0CC5FB__CTOR_OFFSET UNITYSDK_OFFSET(0x1A450530)
...
public:
	...
	::RPG::GameCore::OpenTimeRewindRecreateWorldPage* OFKGLJOAMLD; // 0x20
	::Il2CppArray<::Class_3_07C3C4D2990C49EE*>* BPKFMAOLAOC; // 0x28
	::Il2CppArray<::System::Boolean>* AIOEAPCKFBM; // 0x30
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x38
	::Class_2_811BD3202E0CC5FB_Class_1_4C3415F922B5C2E8* EOMJAOMPAAH; // 0x40
	::Class_3_07C3C4D2990C49EE* IOMHPJIENKM; // 0x48
	::Class_2_811BD3202E0CC5FB_Class_1_4C3415F922B5C2E8* MLDBKFBECPB; // 0x50
	::RPG::GameCore::GameEntity* KCKEHDGBGGG; // 0x58
	::System::Int32 OHOGFBCFFFN; // 0x60
	::System::Single CDDGJKDCNMH; // 0x64
	::System::Single BLFDNCLDLMP; // 0x68
	::System::Single DNNONPLHEOI; // 0x6C
