...
#define CLASS_3_BF31CDCCDBD6CCC6_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16606730)
#define CLASS_3_BF31CDCCDBD6CCC6_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x16607160)
#define CLASS_3_BF31CDCCDBD6CCC6_TICK_OFFSET UNITYSDK_OFFSET(0x16606EA0)
#define CLASS_3_BF31CDCCDBD6CCC6__CTOR_OFFSET UNITYSDK_OFFSET(0x16606710)
#define CLASS_3_BF31CDCCDBD6CCC6___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x166071B0)

inline static constexpr unsigned int Class_3_BF31CDCCDBD6CCC6_TypeDefinitionIndex = 28767;
