...
#define CLASS_3_BF31CDCCDBD6CCC6_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18A38D60)
#define CLASS_3_BF31CDCCDBD6CCC6_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x18A39780)
#define CLASS_3_BF31CDCCDBD6CCC6_TICK_OFFSET UNITYSDK_OFFSET(0x18A39570)
#define CLASS_3_BF31CDCCDBD6CCC6__CTOR_OFFSET UNITYSDK_OFFSET(0x18A38D40)
#define CLASS_3_BF31CDCCDBD6CCC6___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x18A397D0)

inline static constexpr unsigned int Class_3_BF31CDCCDBD6CCC6_TypeDefinitionIndex = 34775;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + CLASS_3_BF31CDCCDBD6CCC6___IFIXBASEPROXY_TICK_OFFSET))(this, a1);
	}
};
