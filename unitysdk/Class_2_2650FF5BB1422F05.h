...
#define CLASS_2_2650FF5BB1422F05_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1891D5E0)
#define CLASS_2_2650FF5BB1422F05_METHOD_2_20A698DC0CFFEC8A_OFFSET UNITYSDK_OFFSET(0x1891DDD0)
#define CLASS_2_2650FF5BB1422F05_METHOD_2_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0x1891D910)
#define CLASS_2_2650FF5BB1422F05_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1891DA60)
#define CLASS_2_2650FF5BB1422F05_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1891DC50)
#define CLASS_2_2650FF5BB1422F05_TICK_OFFSET UNITYSDK_OFFSET(0x1891D7A0)
#define CLASS_2_2650FF5BB1422F05__CTOR_OFFSET UNITYSDK_OFFSET(0x1891D550)
...
public:
	...
	::RPG::GameCore::OnTimeRewindParentPropStateChangeEnd* OFKGLJOAMLD; // 0x20
	::RPG::GameCore::GameEntity* CFKHNPGEAJA; // 0x28
	::Class_3_07C3C4D2990C49EE* GELDCMCEBJF; // 0x30
