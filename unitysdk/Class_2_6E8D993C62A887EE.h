...
#define CLASS_2_6E8D993C62A887EE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14315770)
#define CLASS_2_6E8D993C62A887EE_METHOD_2_019BE49D6AE7D0EA_OFFSET UNITYSDK_OFFSET(0x14315C70)
#define CLASS_2_6E8D993C62A887EE_METHOD_2_142C872A468D65DC_OFFSET UNITYSDK_OFFSET(0x143161A0)
#define CLASS_2_6E8D993C62A887EE_METHOD_2_1B7062170F12239E_OFFSET UNITYSDK_OFFSET(0x14316550)
#define CLASS_2_6E8D993C62A887EE_METHOD_2_4867A7D59311A354_OFFSET UNITYSDK_OFFSET(0x14315DA0)
#define CLASS_2_6E8D993C62A887EE_METHOD_2_7D3EF3C6B6273FCA_OFFSET UNITYSDK_OFFSET(0x14316060)
#define CLASS_2_6E8D993C62A887EE_METHOD_2_99A5FB3E84B54B3D_OFFSET UNITYSDK_OFFSET(0x143165E0)
#define CLASS_2_6E8D993C62A887EE_METHOD_2_CC1F4B7E56F37345_OFFSET UNITYSDK_OFFSET(0x143164F0)
#define CLASS_2_6E8D993C62A887EE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x14315820)
#define CLASS_2_6E8D993C62A887EE_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x14315CF0)
#define CLASS_2_6E8D993C62A887EE_TICK_OFFSET UNITYSDK_OFFSET(0x14315D40)
#define CLASS_2_6E8D993C62A887EE__CCTOR_OFFSET UNITYSDK_OFFSET(0x143166B0)
#define CLASS_2_6E8D993C62A887EE__CTOR_OFFSET UNITYSDK_OFFSET(0x14315720)
...
public:
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::RPG::GameCore::PropState, ::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_6E8D993C62A887EE_TypeDefinitionIndex)->GetStaticField(0x2C710);
	}
	::System::Collections::Generic::List_1<::RPG::GameCore::MazePuzzleOrigamiRow*>* Field_2_1; // 0x18
	::RPG::GameCore::MazePuzzleOrigamiColonyRow* Field_2_2; // 0x20
	::System::Collections::Generic::List_1<::RPG::Client::MapPropDef*>* Field_2_3; // 0x28
	::RPG::GameCore::PropsReqInteractByColonyMirrorTakenDiff* Field_2_4; // 0x30
