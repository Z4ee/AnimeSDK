...
#define STRUCT_2_82FE4F7F2186C9FB__CCTOR_OFFSET UNITYSDK_OFFSET(0x180187C0)

inline static constexpr unsigned int Struct_2_82FE4F7F2186C9FB_TypeDefinitionIndex = 60520;

struct alignas(8) Struct_2_82FE4F7F2186C9FB
{
	static ::System::String** StaticGet_Field_2_6()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Struct_2_82FE4F7F2186C9FB_TypeDefinitionIndex)->GetStaticField(0x42940);
	}
