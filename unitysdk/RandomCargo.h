...
#define RANDOMCARGO_AWAKE_OFFSET UNITYSDK_OFFSET(0xE907340)
#define RANDOMCARGO_RANDOMCARGOWITHINDEX_OFFSET UNITYSDK_OFFSET(0xE907390)
#define RANDOMCARGO__CTOR_OFFSET UNITYSDK_OFFSET(0xE907720)
