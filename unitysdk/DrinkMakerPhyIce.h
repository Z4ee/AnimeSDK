...
#define DRINKMAKERPHYICE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xCB4E940)
#define DRINKMAKERPHYICE_METHOD_5_0BDFAC56E6B704CB_OFFSET UNITYSDK_OFFSET(0xCB4DE00)
#define DRINKMAKERPHYICE_METHOD_5_0D7638DBC93E5002_OFFSET UNITYSDK_OFFSET(0xCB4E7E0)
#define DRINKMAKERPHYICE_METHOD_5_10054BB010E03EDD_OFFSET UNITYSDK_OFFSET(0xCB4DFE0)
#define DRINKMAKERPHYICE_METHOD_5_1ABF1CBED7A4AF0A_OFFSET UNITYSDK_OFFSET(0xCB4E4B0)
#define DRINKMAKERPHYICE_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0xCB4DD10)
#define DRINKMAKERPHYICE_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xCB4EA50)
#define DRINKMAKERPHYICE_START_OFFSET UNITYSDK_OFFSET(0xCB4DB80)
#define DRINKMAKERPHYICE__CTOR_OFFSET UNITYSDK_OFFSET(0xCB4F1D0)

inline static constexpr unsigned int DrinkMakerPhyIce_TypeDefinitionIndex = 38099;
