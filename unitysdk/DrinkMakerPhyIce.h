...
#define DRINKMAKERPHYICE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x10C5F3D0)
#define DRINKMAKERPHYICE_METHOD_5_0BDFAC56E6B704CB_OFFSET UNITYSDK_OFFSET(0x10C5E890)
#define DRINKMAKERPHYICE_METHOD_5_0D7638DBC93E5002_OFFSET UNITYSDK_OFFSET(0x10C5F270)
#define DRINKMAKERPHYICE_METHOD_5_10054BB010E03EDD_OFFSET UNITYSDK_OFFSET(0x10C5EA70)
#define DRINKMAKERPHYICE_METHOD_5_1ABF1CBED7A4AF0A_OFFSET UNITYSDK_OFFSET(0x10C5EF40)
#define DRINKMAKERPHYICE_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x10C5E7A0)
#define DRINKMAKERPHYICE_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x10C5F4E0)
#define DRINKMAKERPHYICE_START_OFFSET UNITYSDK_OFFSET(0x10C5E610)
#define DRINKMAKERPHYICE__CTOR_OFFSET UNITYSDK_OFFSET(0x10C5FC60)

inline static constexpr unsigned int DrinkMakerPhyIce_TypeDefinitionIndex = 44526;
