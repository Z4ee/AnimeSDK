...
#define CLASS_2_66BF2C9FC1D2A5C7_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1C5415E0)
#define CLASS_2_66BF2C9FC1D2A5C7_FILTER_OFFSET UNITYSDK_OFFSET(0x1C5414E0)
#define CLASS_2_66BF2C9FC1D2A5C7_GETTRIGGER_OFFSET UNITYSDK_OFFSET(0x1C5413C0)
#define CLASS_2_66BF2C9FC1D2A5C7__CTOR_OFFSET UNITYSDK_OFFSET(0x1C541340)

inline static constexpr unsigned int Class_2_66BF2C9FC1D2A5C7_TypeDefinitionIndex = 40748;

class Class_2_66BF2C9FC1D2A5C7 : public ::Entitas::ReactiveSystem_1<::Class_2_1C9DAFE8E76EE3E9*>
{
public:
	::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_213*>* BGKHCJPFFLN; // 0x28
