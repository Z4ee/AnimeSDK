...
#define CLASS_3_032754C131C9ABAA_METHOD_3_3AD4360E2346F7A3_OFFSET UNITYSDK_OFFSET(0x18B88200)
#define CLASS_3_032754C131C9ABAA_METHOD_3_910CE6381099E090_OFFSET UNITYSDK_OFFSET(0x18B88180)
#define CLASS_3_032754C131C9ABAA__CTOR_OFFSET UNITYSDK_OFFSET(0x18B881D0)

inline static constexpr unsigned int Class_3_032754C131C9ABAA_TypeDefinitionIndex = 21024;

class Class_3_032754C131C9ABAA : public ::RPG::GameCore::TaskConfig
{
public:
	::RPG::GameCore::DynamicString* Field_3_3; // 0x18
	::RPG::GameCore::DynamicString* Field_3_0; // 0x20
	::RPG::GameCore::DynamicString* Field_3_1; // 0x28
	::Il2CppArray<::RPG::GameCore::DynamicString*>* Field_3_2; // 0x30
