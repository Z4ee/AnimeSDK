...
#define CLASS_1_7B51681C9029080E_EXECUTE_OFFSET UNITYSDK_OFFSET(0xC7C04E0)
#define CLASS_1_7B51681C9029080E_METHOD_1_1303B19CF454BD06_OFFSET UNITYSDK_OFFSET(0xC7C01C0)
#define CLASS_1_7B51681C9029080E_METHOD_1_4BC86543E53D0696_OFFSET UNITYSDK_OFFSET(0xC7BFDC0)
#define CLASS_1_7B51681C9029080E_METHOD_1_6FE6E0587E8D1F5C_OFFSET UNITYSDK_OFFSET(0xC7C0250)
#define CLASS_1_7B51681C9029080E_METHOD_1_A1F90F4B49B60010_OFFSET UNITYSDK_OFFSET(0xC7C00C0)
#define CLASS_1_7B51681C9029080E_TICK_OFFSET UNITYSDK_OFFSET(0xC7C06B0)
#define CLASS_1_7B51681C9029080E__CTOR_OFFSET UNITYSDK_OFFSET(0xC7BFCF0)

inline static constexpr unsigned int Class_1_7B51681C9029080E_TypeDefinitionIndex = 77192;
...
public:
	...
	::System::Collections::Generic::Queue_1<::Class_2_DCFF4DF692D90D03*>* LMKKGJFNMGM; // 0x20
	::System::Collections::Generic::List_1<::RPG::Client::LittleGame::ChimeraDuel::ChimeraDuelChimeraCache*>* ANIMIKECIMK; // 0x28
	::System::Collections::Generic::List_1<::Class_1_43BD383C98B4C0C5_213*>* OJFECHILFHG; // 0x30
	::Class_0_16E4307DCC419505_104* KGEIJJIFGOI; // 0x38
