...
#define CLASS_2_A357632217C8285B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13833990)
#define CLASS_2_A357632217C8285B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x138339D0)
#define CLASS_2_A357632217C8285B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x13833B90)
#define CLASS_2_A357632217C8285B_TICK_OFFSET UNITYSDK_OFFSET(0x13833BE0)
#define CLASS_2_A357632217C8285B__CTOR_OFFSET UNITYSDK_OFFSET(0x13833980)

inline static constexpr unsigned int Class_2_A357632217C8285B_TypeDefinitionIndex = 52000;

class Class_2_A357632217C8285B : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SwitchByCommandType* Field_2_0; // 0x18
