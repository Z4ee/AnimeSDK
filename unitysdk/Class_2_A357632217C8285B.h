...
#define CLASS_2_A357632217C8285B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15619690)
#define CLASS_2_A357632217C8285B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x156196D0)
#define CLASS_2_A357632217C8285B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15619890)
#define CLASS_2_A357632217C8285B_TICK_OFFSET UNITYSDK_OFFSET(0x156198E0)
#define CLASS_2_A357632217C8285B__CTOR_OFFSET UNITYSDK_OFFSET(0x15619680)

inline static constexpr unsigned int Class_2_A357632217C8285B_TypeDefinitionIndex = 55867;

class Class_2_A357632217C8285B : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SwitchByCommandType* OFKGLJOAMLD; // 0x18
