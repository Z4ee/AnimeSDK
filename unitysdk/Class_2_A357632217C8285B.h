...
#define CLASS_2_A357632217C8285B_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA05DD40)
#define CLASS_2_A357632217C8285B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xA05DD80)
#define CLASS_2_A357632217C8285B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xA05DF30)
#define CLASS_2_A357632217C8285B_TICK_OFFSET UNITYSDK_OFFSET(0xA05DF80)
#define CLASS_2_A357632217C8285B__CTOR_OFFSET UNITYSDK_OFFSET(0xA05DD30)

inline static constexpr unsigned int Class_2_A357632217C8285B_TypeDefinitionIndex = 51332;

class Class_2_A357632217C8285B : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SwitchByCommandType* Field_2_1; // 0x18
