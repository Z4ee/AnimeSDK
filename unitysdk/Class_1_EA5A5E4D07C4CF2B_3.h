...
#define CLASS_1_EA5A5E4D07C4CF2B_3_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E1AF7C0)
#define CLASS_1_EA5A5E4D07C4CF2B_3_CLONE_OFFSET UNITYSDK_OFFSET(0x1E1AF350)
#define CLASS_1_EA5A5E4D07C4CF2B_3_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E1AF4E0)
#define CLASS_1_EA5A5E4D07C4CF2B_3_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E1AF400)
#define CLASS_1_EA5A5E4D07C4CF2B_3_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E1AF5B0)
#define CLASS_1_EA5A5E4D07C4CF2B_3_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E1AF9F0)
#define CLASS_1_EA5A5E4D07C4CF2B_3_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E1AF9A0)
#define CLASS_1_EA5A5E4D07C4CF2B_3_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E1AF2C0)
#define CLASS_1_EA5A5E4D07C4CF2B_3_METHOD_1_C114A1F8E08B6F92_1_OFFSET UNITYSDK_OFFSET(0x1E1AF3D0)
#define CLASS_1_EA5A5E4D07C4CF2B_3_METHOD_1_C114A1F8E08B6F92_2_OFFSET UNITYSDK_OFFSET(0x1E1AF3F0)
#define CLASS_1_EA5A5E4D07C4CF2B_3_METHOD_1_C114A1F8E08B6F92_OFFSET UNITYSDK_OFFSET(0x1E1AF3B0)
#define CLASS_1_EA5A5E4D07C4CF2B_3_METHOD_1_C74CF020AA42ED85_1_OFFSET UNITYSDK_OFFSET(0x1E1AF3C0)
#define CLASS_1_EA5A5E4D07C4CF2B_3_METHOD_1_C74CF020AA42ED85_2_OFFSET UNITYSDK_OFFSET(0x1E1AF3E0)
#define CLASS_1_EA5A5E4D07C4CF2B_3_METHOD_1_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x1E1AF3A0)
#define CLASS_1_EA5A5E4D07C4CF2B_3_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E1AF2F0)
#define CLASS_1_EA5A5E4D07C4CF2B_3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E1AF5E0)
#define CLASS_1_EA5A5E4D07C4CF2B_3_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E1AF640)
#define CLASS_1_EA5A5E4D07C4CF2B_3__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E1AFBA0)
#define CLASS_1_EA5A5E4D07C4CF2B_3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E1AF310)
#define CLASS_1_EA5A5E4D07C4CF2B_3__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1AF300)

inline static constexpr unsigned int Class_1_EA5A5E4D07C4CF2B_3_TypeDefinitionIndex = 25128;

class Class_1_EA5A5E4D07C4CF2B_3 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_EA5A5E4D07C4CF2B_3*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_EA5A5E4D07C4CF2B_3*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_EA5A5E4D07C4CF2B_3_TypeDefinitionIndex)->GetStaticField(0x2B520);
	}
	// static const ::System::Int32 NJFNAJIJDDD = 0x1; // 0x0
	// static const ::System::Int32 GOOAJGAIILG = 0x2; // 0x0
	// static const ::System::Int32 NPINBKMLJAJ = 0x3; // 0x0
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x10
	::System::Int32 PCNDEHHDFGB; // 0x18
	::System::Int32 NMHOAGEBIMF; // 0x1C
	::System::Int32 JDFBMKHJLBI; // 0x20
