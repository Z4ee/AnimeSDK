...
#define CLASS_3_E374445C298C7C77_1_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x14AF5170)
#define CLASS_3_E374445C298C7C77_1_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x14AF5200)
#define CLASS_3_E374445C298C7C77_1__CTOR_OFFSET UNITYSDK_OFFSET(0x14AF5140)

inline static constexpr unsigned int Class_3_E374445C298C7C77_1_TypeDefinitionIndex = 51176;
