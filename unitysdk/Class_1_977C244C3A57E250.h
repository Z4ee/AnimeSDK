...
#define CLASS_1_977C244C3A57E250_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1848D770)
#define CLASS_1_977C244C3A57E250_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1848D730)
#define CLASS_1_977C244C3A57E250_METHOD_1_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x1848D0D0)
#define CLASS_1_977C244C3A57E250_METHOD_1_23BECAB4E8DF4D1B_OFFSET UNITYSDK_OFFSET(0x1848D9A0)
#define CLASS_1_977C244C3A57E250_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x1848D670)
#define CLASS_1_977C244C3A57E250_METHOD_1_7FBFC04DB341E38F_OFFSET UNITYSDK_OFFSET(0x1848D220)
#define CLASS_1_977C244C3A57E250_METHOD_1_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0x1848DB50)
#define CLASS_1_977C244C3A57E250_METHOD_1_B4DE4A1745AD2498_OFFSET UNITYSDK_OFFSET(0x1848DAD0)
#define CLASS_1_977C244C3A57E250__CTOR_OFFSET UNITYSDK_OFFSET(0x1848DC60)
#define CLASS_1_977C244C3A57E250___RETRIVEDEPTHSAMPLE_B__8_0_OFFSET UNITYSDK_OFFSET(0x1848DC70)
...
public:
	...
	{
		return (::UnityEngine::Mesh**)Il2CppClass::FromTypeDefinitionIndex(Class_1_977C244C3A57E250_TypeDefinitionIndex)->GetStaticField(0x66A30);
	}
	::UnityEngine::RenderTexture* HGADCGCBJCE; // 0x10
	::Il2CppArray<::UnityEngine::Vector4>* NKKKCPIDHGN; // 0x18
	::Il2CppArray<::UnityEngine::Vector3>* JMCJLDLFAHN; // 0x20
	::UnityEngine::Material* CGGJOHOBPIO; // 0x28
	::Il2CppArray<::System::Single>* GAFBBCEGJLJ; // 0x30
