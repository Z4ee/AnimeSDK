...
#define CLASS_2_E9390A06216886CF_DISPOSE_OFFSET UNITYSDK_OFFSET(0x12AAB7B0)
#define CLASS_2_E9390A06216886CF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x12AAB970)
#define CLASS_2_E9390A06216886CF_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x12AABBC0)
#define CLASS_2_E9390A06216886CF_TICK_OFFSET UNITYSDK_OFFSET(0x12AABC10)
#define CLASS_2_E9390A06216886CF__CTOR_OFFSET UNITYSDK_OFFSET(0x12AAB7A0)
#define CLASS_2_E9390A06216886CF__ONTASKBEGIN_B__4_0_OFFSET UNITYSDK_OFFSET(0x12AABC70)

inline static constexpr unsigned int Class_2_E9390A06216886CF_TypeDefinitionIndex = 49223;

class Class_2_E9390A06216886CF : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::CakeRaceWaitVoteEnd* Field_2_1; // 0x20
