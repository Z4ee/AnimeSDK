...
#define CLASS_2_E9390A06216886CF_DISPOSE_OFFSET UNITYSDK_OFFSET(0x124B1F20)
#define CLASS_2_E9390A06216886CF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x124B20E0)
#define CLASS_2_E9390A06216886CF_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x124B2320)
#define CLASS_2_E9390A06216886CF_TICK_OFFSET UNITYSDK_OFFSET(0x124B2370)
#define CLASS_2_E9390A06216886CF__CTOR_OFFSET UNITYSDK_OFFSET(0x124B1F10)
#define CLASS_2_E9390A06216886CF__ONTASKBEGIN_B__4_0_OFFSET UNITYSDK_OFFSET(0x124B23D0)

inline static constexpr unsigned int Class_2_E9390A06216886CF_TypeDefinitionIndex = 48596;

class Class_2_E9390A06216886CF : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::CakeRaceWaitVoteEnd* Field_2_0; // 0x20
