...
#define CLASS_2_CE8CCCB28AD1564F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D8BDD20)
#define CLASS_2_CE8CCCB28AD1564F_METHOD_2_7A6818D24D36DCBD_1_OFFSET UNITYSDK_OFFSET(0x1D8BE0F0)
#define CLASS_2_CE8CCCB28AD1564F_METHOD_2_7A6818D24D36DCBD_OFFSET UNITYSDK_OFFSET(0x1D8BDF50)
#define CLASS_2_CE8CCCB28AD1564F_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1D8BDBC0)
#define CLASS_2_CE8CCCB28AD1564F_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1D8BDCD0)
#define CLASS_2_CE8CCCB28AD1564F_TICK_OFFSET UNITYSDK_OFFSET(0x1D8BE290)
#define CLASS_2_CE8CCCB28AD1564F__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8BDAD0)

inline static constexpr unsigned int Class_2_CE8CCCB28AD1564F_TypeDefinitionIndex = 58282;

class Class_2_CE8CCCB28AD1564F : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_3_07C3C4D2990C49EE* FINPCOMDHCN; // 0x18
	::RPG::GameCore::TaskContext* EEFMDEHLLFI; // 0x20
	::Class_3_07C3C4D2990C49EE* JBHHMGFJJJN; // 0x28
	::RPG::GameCore::FormationMoveGroupCallback* IGHAHBNLIJA; // 0x30
