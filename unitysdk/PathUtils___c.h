...
#define PATHUTILS___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AAD91D0)
#define PATHUTILS___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAD9210)
#define PATHUTILS___C__FINDNEARESTPOINTSBYPATH_B__5_0_OFFSET UNITYSDK_OFFSET(0x1AAD9220)
#define PATHUTILS___C__FINDNEARESTPOINTSBYPATH_B__5_1_OFFSET UNITYSDK_OFFSET(0x1AAD9280)

inline static constexpr unsigned int PathUtils___c_TypeDefinitionIndex = 69333;
...
public:
	...
	{
		return (::System::Comparison_1<::PathUtils_IndexedPathDistance>**)Il2CppClass::FromTypeDefinitionIndex(PathUtils___c_TypeDefinitionIndex)->GetStaticField(0x41E80);
	}
	static ::PathUtils___c** StaticGet___9()
	{
		return (::PathUtils___c**)Il2CppClass::FromTypeDefinitionIndex(PathUtils___c_TypeDefinitionIndex)->GetStaticField(0x41E88);
	}
	static ::System::Func_2<::PathUtils_IndexedPathDistance, ::System::Int32>** StaticGet___9__5_1()
	{
		return (::System::Func_2<::PathUtils_IndexedPathDistance, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(PathUtils___c_TypeDefinitionIndex)->GetStaticField(0x41E90);
	}
