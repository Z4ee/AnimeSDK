...
#define CLASS_2_7CBE9AB8B9CFB3F3_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x139C81C0)
#define CLASS_2_7CBE9AB8B9CFB3F3_FROMFLX_OFFSET UNITYSDK_OFFSET(0x139C7B90)
#define CLASS_2_7CBE9AB8B9CFB3F3_METHOD_2_0B2CB6A77D912E66_OFFSET UNITYSDK_OFFSET(0x139C8AC0)
#define CLASS_2_7CBE9AB8B9CFB3F3_METHOD_2_23CDE0DA18CF2028_OFFSET UNITYSDK_OFFSET(0x139C8530)
#define CLASS_2_7CBE9AB8B9CFB3F3_METHOD_2_49128280A131ACC1_OFFSET UNITYSDK_OFFSET(0x139C8C70)
#define CLASS_2_7CBE9AB8B9CFB3F3_METHOD_2_8FF96CDDF39B2A01_OFFSET UNITYSDK_OFFSET(0x139C8220)
#define CLASS_2_7CBE9AB8B9CFB3F3_METHOD_2_B73F62522113F21F_OFFSET UNITYSDK_OFFSET(0x139C79D0)
#define CLASS_2_7CBE9AB8B9CFB3F3_METHOD_2_C444D4C8B9D548AF_OFFSET UNITYSDK_OFFSET(0x139C7B20)
#define CLASS_2_7CBE9AB8B9CFB3F3_METHOD_2_D4943D8F67F4699C_OFFSET UNITYSDK_OFFSET(0x139C8960)
#define CLASS_2_7CBE9AB8B9CFB3F3_METHOD_2_D8A163211C06267F_OFFSET UNITYSDK_OFFSET(0x139C7A20)
#define CLASS_2_7CBE9AB8B9CFB3F3_METHOD_2_DF413489329CBAF8_OFFSET UNITYSDK_OFFSET(0x139C7C10)
#define CLASS_2_7CBE9AB8B9CFB3F3__CTOR_OFFSET UNITYSDK_OFFSET(0x139C8950)

inline static constexpr unsigned int Class_2_7CBE9AB8B9CFB3F3_TypeDefinitionIndex = 67986;

class Class_2_7CBE9AB8B9CFB3F3 : public ::Class_1_D0D2B3C2533F6DF2_4
{
public:
	...
	{
		return ((::Class_1_D0D2B3C2533F6DF2_4*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_7CBE9AB8B9CFB3F3_METHOD_2_D8A163211C06267F_OFFSET))(this);
	}
