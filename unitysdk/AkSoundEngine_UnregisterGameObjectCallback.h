...
#define AKSOUNDENGINE_UNREGISTERGAMEOBJECTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C3D1B40)
#define AKSOUNDENGINE_UNREGISTERGAMEOBJECTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C3D1BC0)
#define AKSOUNDENGINE_UNREGISTERGAMEOBJECTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C3D15E0)
#define AKSOUNDENGINE_UNREGISTERGAMEOBJECTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3D15D0)

inline static constexpr unsigned int AkSoundEngine_UnregisterGameObjectCallback_TypeDefinitionIndex = 31479;
