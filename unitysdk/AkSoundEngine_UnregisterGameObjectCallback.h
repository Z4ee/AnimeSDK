...
#define AKSOUNDENGINE_UNREGISTERGAMEOBJECTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1FAF62C0)
#define AKSOUNDENGINE_UNREGISTERGAMEOBJECTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1FAF6340)
#define AKSOUNDENGINE_UNREGISTERGAMEOBJECTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1FAF5D30)
#define AKSOUNDENGINE_UNREGISTERGAMEOBJECTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1FAF5D10)

inline static constexpr unsigned int AkSoundEngine_UnregisterGameObjectCallback_TypeDefinitionIndex = 33665;
