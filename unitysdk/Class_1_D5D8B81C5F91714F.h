...
#define CLASS_1_D5D8B81C5F91714F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x138C2000)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_0C684A75C783EBC5_OFFSET UNITYSDK_OFFSET(0x138C32E0)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_0E46DC8C385F3B19_OFFSET UNITYSDK_OFFSET(0x138C3560)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_1E2F1551644E6AD0_OFFSET UNITYSDK_OFFSET(0x138C3000)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_40E490E2772D5D75_OFFSET UNITYSDK_OFFSET(0x138C2CB0)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_4307B2A4B4A12C1A_1_OFFSET UNITYSDK_OFFSET(0x138C2DC0)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x138C2D10)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_540DB5DAE524BF3C_OFFSET UNITYSDK_OFFSET(0x138C3500)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_6DB361889C24FBD3_OFFSET UNITYSDK_OFFSET(0x138C2B10)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_96423E189D7E47C7_OFFSET UNITYSDK_OFFSET(0x138C29F0)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_A0C3C8FB5CF273C4_OFFSET UNITYSDK_OFFSET(0x138C2470)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_B877181B6123B7F6_OFFSET UNITYSDK_OFFSET(0x138C2200)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_C120627FFC990F63_OFFSET UNITYSDK_OFFSET(0x138C2E70)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_CDD5ADAE43D40A5C_OFFSET UNITYSDK_OFFSET(0x138C2550)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_D219743A444E7E38_OFFSET UNITYSDK_OFFSET(0x138C2690)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_EC90937CEA9AFCA9_OFFSET UNITYSDK_OFFSET(0x138C27F0)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_F211F18433CEAF48_OFFSET UNITYSDK_OFFSET(0x138C2C00)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_F75084EC8D457B45_1_OFFSET UNITYSDK_OFFSET(0x138C2F00)
#define CLASS_1_D5D8B81C5F91714F_METHOD_1_F75084EC8D457B45_OFFSET UNITYSDK_OFFSET(0x138C28F0)
#define CLASS_1_D5D8B81C5F91714F__CCTOR_OFFSET UNITYSDK_OFFSET(0x138C3570)
#define CLASS_1_D5D8B81C5F91714F__CTOR_OFFSET UNITYSDK_OFFSET(0x138C1EE0)

inline static constexpr unsigned int Class_1_D5D8B81C5F91714F_TypeDefinitionIndex = 73057;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_D5D8B81C5F91714F_TypeDefinitionIndex)->GetStaticField(0x138C0);
	}
	::UnityEngine::Coroutine* Field_1_1; // 0x10
	::Il2CppArray<::RPG::Client::Prop::DestroyRootPuzzleChess*>* Field_1_2; // 0x18
	::UnityEngine::Transform* Field_1_3; // 0x20
	::System::String* Field_1_4; // 0x28
	::RPG::Client::Prop::DestroyRootPuzzleBoard* Field_1_5; // 0x30
	::RPG::Client::MonoEffect* Field_1_6; // 0x38
	::Il2CppArray<::UnityEngine::GameObject*>* Field_1_7; // 0x40
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_D5D8B81C5F91714F_METHOD_1_4307B2A4B4A12C1A_OFFSET))(this);
	}

	::System::Void Method_1_4307B2A4B4A12C1A_1()
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_D5D8B81C5F91714F_METHOD_1_4307B2A4B4A12C1A_1_OFFSET))(this);
	}
