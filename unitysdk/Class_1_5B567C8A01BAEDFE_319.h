...
#define CLASS_1_5B567C8A01BAEDFE_319_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A9A4F60)
#define CLASS_1_5B567C8A01BAEDFE_319_CLONE_OFFSET UNITYSDK_OFFSET(0x1A9A4D70)
#define CLASS_1_5B567C8A01BAEDFE_319_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A9A4E70)
#define CLASS_1_5B567C8A01BAEDFE_319_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A9A4DE0)
#define CLASS_1_5B567C8A01BAEDFE_319_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A9A4EC0)
#define CLASS_1_5B567C8A01BAEDFE_319_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A9A4FB0)
#define CLASS_1_5B567C8A01BAEDFE_319_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A9A4F80)
#define CLASS_1_5B567C8A01BAEDFE_319_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A9A4CC0)
#define CLASS_1_5B567C8A01BAEDFE_319_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A9A4D20)
#define CLASS_1_5B567C8A01BAEDFE_319_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A9A4EF0)
#define CLASS_1_5B567C8A01BAEDFE_319_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A9A4F50)
#define CLASS_1_5B567C8A01BAEDFE_319__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A9A5000)
#define CLASS_1_5B567C8A01BAEDFE_319__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A9A4D40)
#define CLASS_1_5B567C8A01BAEDFE_319__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A4D30)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_319_TypeDefinitionIndex = 31292;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_319*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_319_TypeDefinitionIndex)->GetStaticField(0x66960);
	}
	...
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_319*>* Method_1_33819E510657F52F()
	{
		return ((::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_319*>*(*)())((::PBYTE)hIl2Cpp + CLASS_1_5B567C8A01BAEDFE_319_METHOD_1_33819E510657F52F_OFFSET))();
	}
