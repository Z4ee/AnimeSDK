...
#define CLASS_1_5B567C8A01BAEDFE_319_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C834B10)
#define CLASS_1_5B567C8A01BAEDFE_319_CLONE_OFFSET UNITYSDK_OFFSET(0x1C834800)
#define CLASS_1_5B567C8A01BAEDFE_319_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C834910)
#define CLASS_1_5B567C8A01BAEDFE_319_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C834840)
#define CLASS_1_5B567C8A01BAEDFE_319_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C834A70)
#define CLASS_1_5B567C8A01BAEDFE_319_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C834B60)
#define CLASS_1_5B567C8A01BAEDFE_319_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C834B30)
#define CLASS_1_5B567C8A01BAEDFE_319_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C834780)
#define CLASS_1_5B567C8A01BAEDFE_319_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C8347B0)
#define CLASS_1_5B567C8A01BAEDFE_319_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C834AA0)
#define CLASS_1_5B567C8A01BAEDFE_319_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C834B00)
#define CLASS_1_5B567C8A01BAEDFE_319__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C834BB0)
#define CLASS_1_5B567C8A01BAEDFE_319__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C8347D0)
#define CLASS_1_5B567C8A01BAEDFE_319__CTOR_OFFSET UNITYSDK_OFFSET(0x1C8347C0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_319*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_319_TypeDefinitionIndex)->GetStaticField(0x24B50);
	}
