...
#define LEAVESSYSTEM_BAKESCENECOLLISION_OFFSET UNITYSDK_OFFSET(0x1C3F0430)
#define LEAVESSYSTEM_BUILDXZBOUNDS_OFFSET UNITYSDK_OFFSET(0x1C3EE490)
#define LEAVESSYSTEM_CALCULATESPAWNCOUNT_OFFSET UNITYSDK_OFFSET(0x1C3F0F40)
#define LEAVESSYSTEM_ENSURERUNTIMEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1C3F0160)
#define LEAVESSYSTEM_GETBOUNDSXZ_OFFSET UNITYSDK_OFFSET(0x1C3EE3F0)
#define LEAVESSYSTEM_GET_BAKEDCOLLISIONBOXCOUNT_OFFSET UNITYSDK_OFFSET(0x1C3F1150)
#define LEAVESSYSTEM_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1C3EE240)
#define LEAVESSYSTEM_GET_ISREADY_OFFSET UNITYSDK_OFFSET(0x1C3EE250)
#define LEAVESSYSTEM_GET_ISRUNNING_OFFSET UNITYSDK_OFFSET(0x1C3EE3E0)
#define LEAVESSYSTEM_GET_LASTSTEPCPUMS_OFFSET UNITYSDK_OFFSET(0x1C3EE3D0)
#define LEAVESSYSTEM_GET_PROCEDURALMATERIAL_OFFSET UNITYSDK_OFFSET(0x1C3EE0D0)
#define LEAVESSYSTEM_GET_SOLVER_OFFSET UNITYSDK_OFFSET(0x1C3EE0C0)
#define LEAVESSYSTEM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1C3EEFD0)
#define LEAVESSYSTEM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C3EEA10)
#define LEAVESSYSTEM_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1C3EE9B0)
#define LEAVESSYSTEM_RELEASERUNTIMEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1C3EF140)
#define LEAVESSYSTEM_RESETSYSTEM_OFFSET UNITYSDK_OFFSET(0x1C3F0E90)
#define LEAVESSYSTEM_RESOLVEBOUNDARYBOUNDS_OFFSET UNITYSDK_OFFSET(0x1C3EE5A0)
#define LEAVESSYSTEM_SCANCOLLISIONSOURCES_OFFSET UNITYSDK_OFFSET(0x1C3F1160)
#define LEAVESSYSTEM_SHUTDOWNSYSTEM_OFFSET UNITYSDK_OFFSET(0x1C3EF0D0)
#define LEAVESSYSTEM_SIMULATESTEP_OFFSET UNITYSDK_OFFSET(0x1C3EFA00)
#define LEAVESSYSTEM_STARTSYSTEM_OFFSET UNITYSDK_OFFSET(0x1C3EEAB0)
#define LEAVESSYSTEM_STOPSYSTEM_OFFSET UNITYSDK_OFFSET(0x1C3F0E40)
#define LEAVESSYSTEM_TICKFIXED_OFFSET UNITYSDK_OFFSET(0x1C3EF8D0)
#define LEAVESSYSTEM_TICKSIMULATION_OFFSET UNITYSDK_OFFSET(0x1C3EF710)
#define LEAVESSYSTEM_TRYGETCHARACTERPOSITION_OFFSET UNITYSDK_OFFSET(0x1C3F0C60)
#define LEAVESSYSTEM_TRYGETRUNTIMEMAINCHARACTERPOSITION_OFFSET UNITYSDK_OFFSET(0x1C3F1020)
#define LEAVESSYSTEM_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C3EF3C0)
#define LEAVESSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3F1670)

inline static constexpr unsigned int LeavesSystem_TypeDefinitionIndex = 26462;
