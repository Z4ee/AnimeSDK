...
#define CLASS_2_9B62EB4CD55641A9_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x153C8FA0)
#define CLASS_2_9B62EB4CD55641A9_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x153C9090)
#define CLASS_2_9B62EB4CD55641A9_METHOD_2_04AF66402B9859B9_OFFSET UNITYSDK_OFFSET(0x153C7AC0)
#define CLASS_2_9B62EB4CD55641A9_METHOD_2_102A1038C38883F3_1_OFFSET UNITYSDK_OFFSET(0x153C7A70)
#define CLASS_2_9B62EB4CD55641A9_METHOD_2_102A1038C38883F3_OFFSET UNITYSDK_OFFSET(0x153C78B0)
#define CLASS_2_9B62EB4CD55641A9_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x153C7C20)
#define CLASS_2_9B62EB4CD55641A9_METHOD_2_3A11E1DCF077C23D_OFFSET UNITYSDK_OFFSET(0x153C87B0)
#define CLASS_2_9B62EB4CD55641A9_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x153C8490)
#define CLASS_2_9B62EB4CD55641A9_METHOD_2_58828C82E2A63F3D_OFFSET UNITYSDK_OFFSET(0x153C7D80)
#define CLASS_2_9B62EB4CD55641A9_METHOD_2_6BCEDD4814D8A8D9_OFFSET UNITYSDK_OFFSET(0x153C8560)
#define CLASS_2_9B62EB4CD55641A9_METHOD_2_745F93A8744358B2_OFFSET UNITYSDK_OFFSET(0x153C85F0)
#define CLASS_2_9B62EB4CD55641A9_METHOD_2_83DA3EC57FF907F4_OFFSET UNITYSDK_OFFSET(0x153C7C60)
#define CLASS_2_9B62EB4CD55641A9_METHOD_2_8671E9AD2980095B_OFFSET UNITYSDK_OFFSET(0x153C80E0)
#define CLASS_2_9B62EB4CD55641A9_METHOD_2_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0x153C7D10)
#define CLASS_2_9B62EB4CD55641A9_METHOD_2_C450A961450309C9_OFFSET UNITYSDK_OFFSET(0x153C8EA0)
#define CLASS_2_9B62EB4CD55641A9_METHOD_2_D799715F2EF979EA_1_OFFSET UNITYSDK_OFFSET(0x153C7900)
#define CLASS_2_9B62EB4CD55641A9_METHOD_2_D799715F2EF979EA_OFFSET UNITYSDK_OFFSET(0x153C7740)
#define CLASS_2_9B62EB4CD55641A9_METHOD_2_D87C6C1BB5B9809B_OFFSET UNITYSDK_OFFSET(0x153C7B10)
#define CLASS_2_9B62EB4CD55641A9_METHOD_2_DA65010FF3DD1750_OFFSET UNITYSDK_OFFSET(0x153C8BE0)
#define CLASS_2_9B62EB4CD55641A9_METHOD_2_DDDB3490E38FF95F_OFFSET UNITYSDK_OFFSET(0x153C7F60)
#define CLASS_2_9B62EB4CD55641A9_METHOD_2_F74441856239DF08_OFFSET UNITYSDK_OFFSET(0x153C7DD0)
#define CLASS_2_9B62EB4CD55641A9__CTOR_OFFSET UNITYSDK_OFFSET(0x153C9160)
#define CLASS_2_9B62EB4CD55641A9__ONBIND_OFFSET UNITYSDK_OFFSET(0x153C7430)
#define CLASS_2_9B62EB4CD55641A9__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x153C84F0)

inline static constexpr unsigned int Class_2_9B62EB4CD55641A9_TypeDefinitionIndex = 72222;
...
public:
	...
	{
		return (::Class_2_9B62EB4CD55641A9**)Il2CppClass::FromTypeDefinitionIndex(Class_2_9B62EB4CD55641A9_TypeDefinitionIndex)->GetStaticField(0x190E0);
	}
	// static const ::System::String* DJCBDJMACFH; // 0x0
	// static const ::System::String* EFJMLJCGPCJ; // 0x0
	// static const ::System::String* HLKCHICNHJE; // 0x0
	::System::Collections::Generic::Dictionary_2<::System::String*, ::Class_3_A22F29BC6FDAFAF7*>* NAJEKBEDNMK; // 0x60
	::UnityEngine::CanvasGroup* MLMFIEKIPHG; // 0x68
	::Class_1_3FF51CE8B91EFA1B* CDMFHPLLFEC; // 0x70
	::UnityEngine::Transform* FHEMCAFOIKG; // 0x78
	::System::Collections::Generic::Dictionary_2<::System::String*, ::Class_3_F3E48B49C93D6539*>* PLGJPOCAPPN; // 0x80
	::UnityEngine::Animation* KCOAILOHDND; // 0x88
	::System::Action* IDDFLLPLNDG; // 0x90
	::RPG::Client::MonoClickOutsideDetect* AAFBCFCMAPI; // 0x98
	::RPG::UINavigation::UINavigationZoneManager* DJOAIHJIJKL; // 0xA0
