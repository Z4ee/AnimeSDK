...
#define AREAFADEPOINTLIGHT_METHOD_5_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0x158D3C00)
#define AREAFADEPOINTLIGHT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x158D41B0)
#define AREAFADEPOINTLIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x158D4230)
