...
#define CLASS_2_681FD6747B57BD1F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x89C2580)
#define CLASS_2_681FD6747B57BD1F_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x89C25C0)
#define CLASS_2_681FD6747B57BD1F_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x89C26E0)
#define CLASS_2_681FD6747B57BD1F_TICK_OFFSET UNITYSDK_OFFSET(0x89C2730)
#define CLASS_2_681FD6747B57BD1F__CTOR_OFFSET UNITYSDK_OFFSET(0x89C2570)

inline static constexpr unsigned int Class_2_681FD6747B57BD1F_TypeDefinitionIndex = 47213;

class Class_2_681FD6747B57BD1F : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SetBattleResult* Field_2_0; // 0x18
