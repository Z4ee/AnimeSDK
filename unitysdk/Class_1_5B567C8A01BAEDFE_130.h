...
#define CLASS_1_5B567C8A01BAEDFE_130_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19CFA2D0)
#define CLASS_1_5B567C8A01BAEDFE_130_CLONE_OFFSET UNITYSDK_OFFSET(0x19CFA0E0)
#define CLASS_1_5B567C8A01BAEDFE_130_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19CFA1E0)
#define CLASS_1_5B567C8A01BAEDFE_130_EQUALS_OFFSET UNITYSDK_OFFSET(0x19CFA150)
#define CLASS_1_5B567C8A01BAEDFE_130_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19CFA230)
#define CLASS_1_5B567C8A01BAEDFE_130_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19CFA320)
#define CLASS_1_5B567C8A01BAEDFE_130_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19CFA2F0)
#define CLASS_1_5B567C8A01BAEDFE_130_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19CFA030)
#define CLASS_1_5B567C8A01BAEDFE_130_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19CFA090)
#define CLASS_1_5B567C8A01BAEDFE_130_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19CFA260)
#define CLASS_1_5B567C8A01BAEDFE_130_WRITETO_OFFSET UNITYSDK_OFFSET(0x19CFA2C0)
#define CLASS_1_5B567C8A01BAEDFE_130__CCTOR_OFFSET UNITYSDK_OFFSET(0x19CFA370)
#define CLASS_1_5B567C8A01BAEDFE_130__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19CFA0B0)
#define CLASS_1_5B567C8A01BAEDFE_130__CTOR_OFFSET UNITYSDK_OFFSET(0x19CFA0A0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_130_TypeDefinitionIndex = 27302;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_130*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_130_TypeDefinitionIndex)->GetStaticField(0x67E60);
	}
