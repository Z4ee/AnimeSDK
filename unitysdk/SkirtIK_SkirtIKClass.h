...
#define SKIRTIK_SKIRTIKCLASS_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xB945C50)
#define SKIRTIK_SKIRTIKCLASS_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB945C10)
#define SKIRTIK_SKIRTIKCLASS__CTOR_OFFSET UNITYSDK_OFFSET(0xB945C90)

inline static constexpr unsigned int SkirtIK_SkirtIKClass_TypeDefinitionIndex = 44047;
