...
#define CLASS_3_1556B530A1B0703D_EVALUATE_OFFSET UNITYSDK_OFFSET(0x186EC0A0)
#define CLASS_3_1556B530A1B0703D__CTOR_OFFSET UNITYSDK_OFFSET(0x186EC070)

inline static constexpr unsigned int Class_3_1556B530A1B0703D_TypeDefinitionIndex = 52184;
