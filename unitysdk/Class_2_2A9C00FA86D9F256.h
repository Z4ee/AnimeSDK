...
#define CLASS_2_2A9C00FA86D9F256_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11BFA960)
#define CLASS_2_2A9C00FA86D9F256_METHOD_2_A7E8B52E9ABB8DB9_OFFSET UNITYSDK_OFFSET(0x11BFAFC0)
#define CLASS_2_2A9C00FA86D9F256_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11BFAAB0)
#define CLASS_2_2A9C00FA86D9F256_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11BFA9B0)
#define CLASS_2_2A9C00FA86D9F256_TICK_OFFSET UNITYSDK_OFFSET(0x11BFAA50)
#define CLASS_2_2A9C00FA86D9F256__CTOR_OFFSET UNITYSDK_OFFSET(0x11BFA950)

inline static constexpr unsigned int Class_2_2A9C00FA86D9F256_TypeDefinitionIndex = 49168;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::UInt16, ::System::Object*))((::PBYTE)hIl2Cpp + CLASS_2_2A9C00FA86D9F256_METHOD_2_A7E8B52E9ABB8DB9_OFFSET))(this, a1, a2);
	}
};
