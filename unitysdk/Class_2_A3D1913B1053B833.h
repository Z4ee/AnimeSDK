...
#define CLASS_2_A3D1913B1053B833_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A7BFE20)
#define CLASS_2_A3D1913B1053B833_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x1A7C0020)
#define CLASS_2_A3D1913B1053B833_METHOD_2_3C56C1AF247AC1EC_OFFSET UNITYSDK_OFFSET(0x1A7C00E0)
#define CLASS_2_A3D1913B1053B833_ONSKIP_OFFSET UNITYSDK_OFFSET(0x1A7C0030)
#define CLASS_2_A3D1913B1053B833_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1A7C0170)
#define CLASS_2_A3D1913B1053B833_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1A7C02D0)
#define CLASS_2_A3D1913B1053B833_TICK_OFFSET UNITYSDK_OFFSET(0x1A7C0360)
#define CLASS_2_A3D1913B1053B833__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7BFC80)
...
public:
	...
	::RPG::GameCore::PredicateTaskList* OFKGLJOAMLD; // 0x20
	::Class_3_07C3C4D2990C49EE* APFMMFLLIIM; // 0x28
	::Class_3_07C3C4D2990C49EE* LKDIMCCENOI; // 0x30
	::Class_3_07C3C4D2990C49EE* IMLDGCEMCCM; // 0x38
