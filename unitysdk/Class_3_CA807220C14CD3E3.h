...
#define CLASS_3_CA807220C14CD3E3_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19903530)
#define CLASS_3_CA807220C14CD3E3_ENTER_OFFSET UNITYSDK_OFFSET(0x19903620)
#define CLASS_3_CA807220C14CD3E3_GETGAMEPHASETYPE_OFFSET UNITYSDK_OFFSET(0x19903F70)
#define CLASS_3_CA807220C14CD3E3_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x19903CF0)
#define CLASS_3_CA807220C14CD3E3_LEAVE_OFFSET UNITYSDK_OFFSET(0x19903D90)
#define CLASS_3_CA807220C14CD3E3_METHOD_3_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0x19903920)
#define CLASS_3_CA807220C14CD3E3_METHOD_3_8C68E2CDEEC884A6_OFFSET UNITYSDK_OFFSET(0x19903AB0)
#define CLASS_3_CA807220C14CD3E3_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x19903D50)
#define CLASS_3_CA807220C14CD3E3_TICK_OFFSET UNITYSDK_OFFSET(0x199035C0)
#define CLASS_3_CA807220C14CD3E3__CTOR_OFFSET UNITYSDK_OFFSET(0x19903280)
