...
#define STRUCT_2_F1C4ECC5EFDCA1EF_1_DECONSTRUCT_OFFSET UNITYSDK_OFFSET(0x3AE67D0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3AE67A0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x3AE6730)
#define STRUCT_2_F1C4ECC5EFDCA1EF_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3AE6720)
#define STRUCT_2_F1C4ECC5EFDCA1EF_1_GET_PROMOTIONLEVEL_OFFSET UNITYSDK_OFFSET(0x12370)
#define STRUCT_2_F1C4ECC5EFDCA1EF_1_GET_PROTOTYPEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x161E0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_1_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x18929710)
#define STRUCT_2_F1C4ECC5EFDCA1EF_1_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x189296D0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_1_PRINTMEMBERS_OFFSET UNITYSDK_OFFSET(0x3AE6700)
#define STRUCT_2_F1C4ECC5EFDCA1EF_1_SET_PROMOTIONLEVEL_OFFSET UNITYSDK_OFFSET(0x379F970)
#define STRUCT_2_F1C4ECC5EFDCA1EF_1_SET_PROTOTYPEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x16050)
#define STRUCT_2_F1C4ECC5EFDCA1EF_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3AE66F0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_1__CTOR_OFFSET UNITYSDK_OFFSET(0x3AE66E0)

inline static constexpr unsigned int Struct_2_F1C4ECC5EFDCA1EF_1_TypeDefinitionIndex = 52257;
