...
#define AKSTATE_GET_GROUPGUID_OFFSET UNITYSDK_OFFSET(0x1C151F20)
#define AKSTATE_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1C151D00)
#define AKSTATE_GET_VALUEGUID_OFFSET UNITYSDK_OFFSET(0x1C151D20)
#define AKSTATE_GET_VALUEID_OFFSET UNITYSDK_OFFSET(0x1C151CB0)
#define AKSTATE_GET_WWISETYPE_OFFSET UNITYSDK_OFFSET(0x1C151C80)
#define AKSTATE_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x1C151C90)
#define AKSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C152120)

inline static constexpr unsigned int AkState_TypeDefinitionIndex = 31626;
