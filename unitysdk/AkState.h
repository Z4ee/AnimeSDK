...
#define AKSTATE_GET_GROUPGUID_OFFSET UNITYSDK_OFFSET(0x1F8C2710)
#define AKSTATE_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1F8C2500)
#define AKSTATE_GET_VALUEGUID_OFFSET UNITYSDK_OFFSET(0x1F8C2510)
#define AKSTATE_GET_VALUEID_OFFSET UNITYSDK_OFFSET(0x1F8C24B0)
#define AKSTATE_GET_WWISETYPE_OFFSET UNITYSDK_OFFSET(0x1F8C2480)
#define AKSTATE_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x1F8C2490)
#define AKSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F8C2910)

inline static constexpr unsigned int AkState_TypeDefinitionIndex = 33813;
