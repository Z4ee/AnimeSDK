...
#define AKSTATE_GET_GROUPGUID_OFFSET UNITYSDK_OFFSET(0x1B6D68D0)
#define AKSTATE_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1B6D66F0)
#define AKSTATE_GET_VALUEGUID_OFFSET UNITYSDK_OFFSET(0x1B6D6770)
#define AKSTATE_GET_VALUEID_OFFSET UNITYSDK_OFFSET(0x1B6D6690)
#define AKSTATE_GET_WWISETYPE_OFFSET UNITYSDK_OFFSET(0x1B6D6430)
#define AKSTATE_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x1B6D6630)
#define AKSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6D69B0)

inline static constexpr unsigned int AkState_TypeDefinitionIndex = 42152;
