...
#define AKSTATE_GET_GROUPGUID_OFFSET UNITYSDK_OFFSET(0x1E493B10)
#define AKSTATE_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1E4938F0)
#define AKSTATE_GET_VALUEGUID_OFFSET UNITYSDK_OFFSET(0x1E493910)
#define AKSTATE_GET_VALUEID_OFFSET UNITYSDK_OFFSET(0x1E4938A0)
#define AKSTATE_GET_WWISETYPE_OFFSET UNITYSDK_OFFSET(0x1E493870)
#define AKSTATE_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x1E493880)
#define AKSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E493D10)

inline static constexpr unsigned int AkState_TypeDefinitionIndex = 33177;
