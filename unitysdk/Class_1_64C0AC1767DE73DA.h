...
#define CLASS_1_64C0AC1767DE73DA_METHOD_1_A27DC2C5A103933A_OFFSET UNITYSDK_OFFSET(0xD85E930)
#define CLASS_1_64C0AC1767DE73DA_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD85EBC0)
#define CLASS_1_64C0AC1767DE73DA_METHOD_1_EAD10B3E55E2C4C5_OFFSET UNITYSDK_OFFSET(0xD85EB50)
#define CLASS_1_64C0AC1767DE73DA__CTOR_OFFSET UNITYSDK_OFFSET(0xD85E7E0)

inline static constexpr unsigned int Class_1_64C0AC1767DE73DA_TypeDefinitionIndex = 43649;

class Class_1_64C0AC1767DE73DA : public ::System::Object
{
public:
	::Spine::Unity::SkeletonGraphic* Field_1_0; // 0x10
	::MoleMole::ActivitBGSpineSequence* Field_1_1; // 0x18
