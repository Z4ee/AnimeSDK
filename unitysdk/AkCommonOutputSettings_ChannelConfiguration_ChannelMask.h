...
inline static constexpr unsigned int AkCommonOutputSettings_ChannelConfiguration_ChannelMask_TypeDefinitionIndex = 42033;

enum class AkCommonOutputSettings_ChannelConfiguration_ChannelMask : ::System::Int32
{
	NONE = 0,
	FRONT_LEFT = 1,
	FRONT_RIGHT = 2,
