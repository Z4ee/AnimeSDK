...
#define STRUCT_2_233C8AFD4256ACE6_METHOD_2_572232777D650DEF_OFFSET UNITYSDK_OFFSET(0x831520)
#define STRUCT_2_233C8AFD4256ACE6_METHOD_2_66AAEB7C48D81C4E_OFFSET UNITYSDK_OFFSET(0x831380)
#define STRUCT_2_233C8AFD4256ACE6_METHOD_2_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x3C51B0)
#define STRUCT_2_233C8AFD4256ACE6__CTOR_OFFSET UNITYSDK_OFFSET(0x8310D0)

inline static constexpr unsigned int Struct_2_233C8AFD4256ACE6_TypeDefinitionIndex = 89392;

struct alignas(8) Struct_2_233C8AFD4256ACE6
{
	::Struct_2_F0CFA50094D8FF32 Field_2_1; // 0x10
	::Foundation::FixedArray7_1<::UnityEngine::Animations::AnimationStream> Field_2_0; // 0x60
