...
#define CLASS_2_9EADA6C8E34FD58E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1158CC00)
#define CLASS_2_9EADA6C8E34FD58E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1158CC40)
#define CLASS_2_9EADA6C8E34FD58E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1158CCC0)
#define CLASS_2_9EADA6C8E34FD58E_TICK_OFFSET UNITYSDK_OFFSET(0x1158CD10)
#define CLASS_2_9EADA6C8E34FD58E__CTOR_OFFSET UNITYSDK_OFFSET(0x1158CBF0)

inline static constexpr unsigned int Class_2_9EADA6C8E34FD58E_TypeDefinitionIndex = 47138;
