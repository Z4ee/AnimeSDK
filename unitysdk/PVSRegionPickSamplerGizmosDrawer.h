...
#define PVSREGIONPICKSAMPLERGIZMOSDRAWER_DRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x8EB8D60)
#define PVSREGIONPICKSAMPLERGIZMOSDRAWER_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x8EB8F30)
#define PVSREGIONPICKSAMPLERGIZMOSDRAWER__CTOR_OFFSET UNITYSDK_OFFSET(0x8EB8F90)

inline static constexpr unsigned int PVSRegionPickSamplerGizmosDrawer_TypeDefinitionIndex = 38208;
