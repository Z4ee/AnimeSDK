...
#define PVSREGIONPICKSAMPLERGIZMOSDRAWER_DRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x9A8A630)
#define PVSREGIONPICKSAMPLERGIZMOSDRAWER_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x9A8A800)
#define PVSREGIONPICKSAMPLERGIZMOSDRAWER__CTOR_OFFSET UNITYSDK_OFFSET(0x9A8A860)

inline static constexpr unsigned int PVSRegionPickSamplerGizmosDrawer_TypeDefinitionIndex = 44092;
