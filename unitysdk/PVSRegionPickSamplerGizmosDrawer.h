...
#define PVSREGIONPICKSAMPLERGIZMOSDRAWER_DRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1ABA6B80)
#define PVSREGIONPICKSAMPLERGIZMOSDRAWER_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1ABA6D70)
#define PVSREGIONPICKSAMPLERGIZMOSDRAWER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABA6DD0)
