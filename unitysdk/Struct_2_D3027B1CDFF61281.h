...
#define STRUCT_2_D3027B1CDFF61281_METHOD_2_107247B6331E64C6_OFFSET UNITYSDK_OFFSET(0x3AE9CA0)
#define STRUCT_2_D3027B1CDFF61281_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x3AE9B20)
#define STRUCT_2_D3027B1CDFF61281_METHOD_2_64FC96223388C2D1_OFFSET UNITYSDK_OFFSET(0x3AE9D00)
#define STRUCT_2_D3027B1CDFF61281_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x3AE9B70)
#define STRUCT_2_D3027B1CDFF61281_METHOD_2_D0CD9A971CA3B1CF_OFFSET UNITYSDK_OFFSET(0x3AE9C90)
#define STRUCT_2_D3027B1CDFF61281_METHOD_2_FBF2CB29FD3B55E6_1_OFFSET UNITYSDK_OFFSET(0x3AE9C70)
#define STRUCT_2_D3027B1CDFF61281_METHOD_2_FBF2CB29FD3B55E6_2_OFFSET UNITYSDK_OFFSET(0x3AE9C80)
#define STRUCT_2_D3027B1CDFF61281_METHOD_2_FBF2CB29FD3B55E6_OFFSET UNITYSDK_OFFSET(0x3AE9C60)
#define STRUCT_2_D3027B1CDFF61281_TICK_OFFSET UNITYSDK_OFFSET(0x3AE9BC0)
#define STRUCT_2_D3027B1CDFF61281__CTOR_OFFSET UNITYSDK_OFFSET(0x3AE9A70)

inline static constexpr unsigned int Struct_2_D3027B1CDFF61281_TypeDefinitionIndex = 54980;

struct alignas(8) Struct_2_D3027B1CDFF61281
{
	::Class_1_F3391C70DC37088D* GIJPHIALKGF; // 0x10
	::System::Boolean LHJPKFDLIIN; // 0x18
	::System::Boolean FBCDBMLCNNL; // 0x19
	::System::Boolean CNGKAJJMNJE; // 0x1A
	::System::Collections::Generic::Queue_1<::Struct_2_D3027B1CDFF61281_TaskExecutorOpType>* BJJFFJGJPCL; // 0x20
	::System::Boolean NKFKGOJJEPG; // 0x28
	::System::Boolean CMOMEHMAEPK; // 0x29
	::System::Boolean MIFDMNOFMIB; // 0x2A
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x30
	::Class_1_5F51D4049EA87B7B* CLGLOGJNKOI; // 0x38
