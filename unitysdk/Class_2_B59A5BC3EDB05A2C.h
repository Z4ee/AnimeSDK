...
#define CLASS_2_B59A5BC3EDB05A2C_METHOD_2_78C5AA85812E15F5_OFFSET UNITYSDK_OFFSET(0xF60A2E0)
#define CLASS_2_B59A5BC3EDB05A2C_METHOD_2_C8903A36ECBA4078_OFFSET UNITYSDK_OFFSET(0xF60A760)
#define CLASS_2_B59A5BC3EDB05A2C_METHOD_2_DE52BD42C4B0B772_OFFSET UNITYSDK_OFFSET(0xF60A5F0)
#define CLASS_2_B59A5BC3EDB05A2C__CTOR_OFFSET UNITYSDK_OFFSET(0xF60A750)

inline static constexpr unsigned int Class_2_B59A5BC3EDB05A2C_TypeDefinitionIndex = 52162;

class Class_2_B59A5BC3EDB05A2C : public ::Class_1_EEA0111A28582B57
{
public:
	::UnityEngine::UI::Extension::UILocalizationText* Field_2_5; // 0x18
	::Class_3_30A064D7BE47C07D<::MoleMole::UIDoubleTipsInfoWidgetController*>* Field_2_12; // 0x20
	::Class_2_B4378B46E0020E85* Field_2_9; // 0x28
	::Class_3_30A064D7BE47C07D<::MoleMole::UIDoubleTipsInfoWidgetController*>* Field_2_11; // 0x30
	::Class_3_30A064D7BE47C07D<::MoleMole::UIWishlistTargetAvatarPopupWidgetController*>* Field_2_10; // 0x38
	::Class_3_6630F8877346891C<::MoleMole::UIDailyChallengeCardRowWidgetController*>* Field_2_6; // 0x40
