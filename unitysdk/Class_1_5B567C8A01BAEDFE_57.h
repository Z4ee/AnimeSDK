...
#define CLASS_1_5B567C8A01BAEDFE_57_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19955DC0)
#define CLASS_1_5B567C8A01BAEDFE_57_CLONE_OFFSET UNITYSDK_OFFSET(0x19955BD0)
#define CLASS_1_5B567C8A01BAEDFE_57_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19955CD0)
#define CLASS_1_5B567C8A01BAEDFE_57_EQUALS_OFFSET UNITYSDK_OFFSET(0x19955C40)
#define CLASS_1_5B567C8A01BAEDFE_57_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19955D20)
#define CLASS_1_5B567C8A01BAEDFE_57_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19955E10)
#define CLASS_1_5B567C8A01BAEDFE_57_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19955DE0)
#define CLASS_1_5B567C8A01BAEDFE_57_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19955B20)
#define CLASS_1_5B567C8A01BAEDFE_57_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19955B80)
#define CLASS_1_5B567C8A01BAEDFE_57_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19955D50)
#define CLASS_1_5B567C8A01BAEDFE_57_WRITETO_OFFSET UNITYSDK_OFFSET(0x19955DB0)
#define CLASS_1_5B567C8A01BAEDFE_57__CCTOR_OFFSET UNITYSDK_OFFSET(0x19955E60)
#define CLASS_1_5B567C8A01BAEDFE_57__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19955BA0)
#define CLASS_1_5B567C8A01BAEDFE_57__CTOR_OFFSET UNITYSDK_OFFSET(0x19955B90)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_57_TypeDefinitionIndex = 25561;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_57*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_57_TypeDefinitionIndex)->GetStaticField(0x5FFF0);
	}
