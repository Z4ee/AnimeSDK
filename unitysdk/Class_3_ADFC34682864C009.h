...
#define CLASS_3_ADFC34682864C009_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xC1CD800)
#define CLASS_3_ADFC34682864C009__CTOR_OFFSET UNITYSDK_OFFSET(0xC1CD7D0)

inline static constexpr unsigned int Class_3_ADFC34682864C009_TypeDefinitionIndex = 51325;
