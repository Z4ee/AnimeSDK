...
#define CLASS_2_14107EBE0A323C43_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1889C650)
#define CLASS_2_14107EBE0A323C43_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x1889C7F0)
#define CLASS_2_14107EBE0A323C43_METHOD_2_37A54FD52C523289_OFFSET UNITYSDK_OFFSET(0x1889BDF0)
#define CLASS_2_14107EBE0A323C43_METHOD_2_39A9FE040505BFA5_OFFSET UNITYSDK_OFFSET(0x1889BCB0)
#define CLASS_2_14107EBE0A323C43_METHOD_2_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x1889B120)
#define CLASS_2_14107EBE0A323C43_METHOD_2_49864B3B164A1961_OFFSET UNITYSDK_OFFSET(0x1889B470)
#define CLASS_2_14107EBE0A323C43_METHOD_2_7646FFE662147970_OFFSET UNITYSDK_OFFSET(0x1889BAD0)
#define CLASS_2_14107EBE0A323C43_METHOD_2_77A1C88EE6B459EB_OFFSET UNITYSDK_OFFSET(0x1889B2E0)
#define CLASS_2_14107EBE0A323C43_METHOD_2_7E1BADD1D133FA1C_OFFSET UNITYSDK_OFFSET(0x1889BB30)
#define CLASS_2_14107EBE0A323C43_METHOD_2_8CA1933EC1F9B137_OFFSET UNITYSDK_OFFSET(0x1889B290)
#define CLASS_2_14107EBE0A323C43_METHOD_2_A37EF40E0E62AE02_OFFSET UNITYSDK_OFFSET(0x1889BC30)
#define CLASS_2_14107EBE0A323C43_METHOD_2_C450A961450309C9_OFFSET UNITYSDK_OFFSET(0x1889C230)
#define CLASS_2_14107EBE0A323C43_METHOD_2_F37CDBD6D46274D2_1_OFFSET UNITYSDK_OFFSET(0x1889C430)
#define CLASS_2_14107EBE0A323C43_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x1889C340)
#define CLASS_2_14107EBE0A323C43_METHOD_2_FCEF005F844F513C_OFFSET UNITYSDK_OFFSET(0x1889C500)
#define CLASS_2_14107EBE0A323C43_METHOD_2_FD1726F5C8763865_OFFSET UNITYSDK_OFFSET(0x1889B4D0)
#define CLASS_2_14107EBE0A323C43__CTOR_OFFSET UNITYSDK_OFFSET(0x1889C960)

inline static constexpr unsigned int Class_2_14107EBE0A323C43_TypeDefinitionIndex = 71962;

class Class_2_14107EBE0A323C43 : public ::Class_1_34917908B7833130
{
public:
	::Il2CppArray<::RPG::GameCore::BattleTargetConfigType>* FFCNFDKPDEI; // 0x60
	::RPG::GameCore::BattleInstance* IFKCCHIFMOC; // 0x68
	::RPG::GameCore::LevelDataComponent* OOIDBIDKNOD; // 0x70
	::System::Boolean OECIIEEFKOC; // 0x78
