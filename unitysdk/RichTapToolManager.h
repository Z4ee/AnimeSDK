...
#define RICHTAPTOOLMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DE1EEF0)
#define RICHTAPTOOLMANAGER_ENABLEALTERNATIVEASSETS_OFFSET UNITYSDK_OFFSET(0x1DE167E0)
#define RICHTAPTOOLMANAGER_GETALTERNATIVEASSETSENABLE_OFFSET UNITYSDK_OFFSET(0x1DE1DCC0)
#define RICHTAPTOOLMANAGER_GETFILEMODELS_OFFSET UNITYSDK_OFFSET(0x1DE1DCD0)
#define RICHTAPTOOLMANAGER_GETFILTEREDFILES_OFFSET UNITYSDK_OFFSET(0x1DE1E4E0)
#define RICHTAPTOOLMANAGER_HANDLEFILECHANGES_OFFSET UNITYSDK_OFFSET(0x1DE1E840)
#define RICHTAPTOOLMANAGER_INITIALIZECACHE_OFFSET UNITYSDK_OFFSET(0x1DE1DF80)
#define RICHTAPTOOLMANAGER_INITIALIZEFILEOBSERVER_OFFSET UNITYSDK_OFFSET(0x1DE1DCE0)
#define RICHTAPTOOLMANAGER_OBSERVINGFILECHANGES_OFFSET UNITYSDK_OFFSET(0x1DE1DF30)
#define RICHTAPTOOLMANAGER_STARTOBSERVING_OFFSET UNITYSDK_OFFSET(0x1DE1DE90)
#define RICHTAPTOOLMANAGER_STOPOBSERVING_OFFSET UNITYSDK_OFFSET(0x1DE1DE30)
#define RICHTAPTOOLMANAGER_TRYGETFILECONTENT_OFFSET UNITYSDK_OFFSET(0x1DE1EDE0)
#define RICHTAPTOOLMANAGER_UPDATEFILEMODEL_OFFSET UNITYSDK_OFFSET(0x1DE1E5C0)
#define RICHTAPTOOLMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DE1F1D0)
#define RICHTAPTOOLMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE1F060)

inline static constexpr unsigned int RichTapToolManager_TypeDefinitionIndex = 38077;
...
public:
	...
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(RichTapToolManager_TypeDefinitionIndex)->GetStaticField(0x8DA0);
	}
	::System::String* targetDirectory; // 0x10
	::System::Object* fileLock; // 0x18
