...
#define CLASS_1_7B630EA0921A5074_GET_INTERVAL_OFFSET UNITYSDK_OFFSET(0xBDA46C0)
#define CLASS_1_7B630EA0921A5074_GET_ISENDED_OFFSET UNITYSDK_OFFSET(0xBDA46E0)
#define CLASS_1_7B630EA0921A5074_METHOD_1_426B9594CB3A4D9F_OFFSET UNITYSDK_OFFSET(0xBDA4980)
#define CLASS_1_7B630EA0921A5074_METHOD_1_A631C7EB7F64062E_OFFSET UNITYSDK_OFFSET(0xBDA48A0)
#define CLASS_1_7B630EA0921A5074_METHOD_1_FDB878EE730B6AA4_OFFSET UNITYSDK_OFFSET(0xBDA4700)
#define CLASS_1_7B630EA0921A5074_SET_INTERVAL_OFFSET UNITYSDK_OFFSET(0xBDA46D0)
#define CLASS_1_7B630EA0921A5074_SET_ISENDED_OFFSET UNITYSDK_OFFSET(0xBDA46F0)
#define CLASS_1_7B630EA0921A5074__CTOR_OFFSET UNITYSDK_OFFSET(0xBDA4850)

inline static constexpr unsigned int Class_1_7B630EA0921A5074_TypeDefinitionIndex = 75049;
...
public:
	...
	::System::UInt32 AINKFBPJMOB; // 0x1C
	::System::Single EAMEIJKODBG; // 0x20
	::System::Boolean _IsEnded_k__BackingField; // 0x24
	::System::UInt32 PHCCMACKMNO; // 0x28
	::System::Single _Interval_k__BackingField; // 0x2C
	::System::Single FLBLLMPABOJ; // 0x30
