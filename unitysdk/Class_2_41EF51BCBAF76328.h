...
#define CLASS_2_41EF51BCBAF76328_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xB8A7EB0)
#define CLASS_2_41EF51BCBAF76328_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xB8A8030)
#define CLASS_2_41EF51BCBAF76328_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xB8A5EC0)
#define CLASS_2_41EF51BCBAF76328_METHOD_2_0B1EB5C9B94BAB66_1_OFFSET UNITYSDK_OFFSET(0xB8A7B20)
#define CLASS_2_41EF51BCBAF76328_METHOD_2_0B1EB5C9B94BAB66_OFFSET UNITYSDK_OFFSET(0xB8A77D0)
#define CLASS_2_41EF51BCBAF76328_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xB8A7AB0)
#define CLASS_2_41EF51BCBAF76328_METHOD_2_2EE5451A8927066E_OFFSET UNITYSDK_OFFSET(0xB8A72B0)
#define CLASS_2_41EF51BCBAF76328_METHOD_2_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0xB8A75F0)
#define CLASS_2_41EF51BCBAF76328_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xB8A6950)
#define CLASS_2_41EF51BCBAF76328_METHOD_2_4389275F4099DE36_OFFSET UNITYSDK_OFFSET(0xB8A65B0)
#define CLASS_2_41EF51BCBAF76328_METHOD_2_4484591CA1060976_OFFSET UNITYSDK_OFFSET(0xB8A79B0)
#define CLASS_2_41EF51BCBAF76328_METHOD_2_464F9487BF0D77F8_OFFSET UNITYSDK_OFFSET(0xB8A7D80)
#define CLASS_2_41EF51BCBAF76328_METHOD_2_4DC99A0E8033A1A2_OFFSET UNITYSDK_OFFSET(0xB8A67F0)
#define CLASS_2_41EF51BCBAF76328_METHOD_2_5031A97BC9F22DE2_OFFSET UNITYSDK_OFFSET(0xB8A73D0)
#define CLASS_2_41EF51BCBAF76328_METHOD_2_56FE2EA783DDD2BA_OFFSET UNITYSDK_OFFSET(0xB8A6DF0)
#define CLASS_2_41EF51BCBAF76328_METHOD_2_67600FA8688BAD61_OFFSET UNITYSDK_OFFSET(0xB8A6CE0)
#define CLASS_2_41EF51BCBAF76328_METHOD_2_6BCEDD4814D8A8D9_OFFSET UNITYSDK_OFFSET(0xB8A6700)
#define CLASS_2_41EF51BCBAF76328_METHOD_2_6DE4075AAE6438BC_OFFSET UNITYSDK_OFFSET(0xB8A6AA0)
#define CLASS_2_41EF51BCBAF76328_METHOD_2_7AFC74ADCC2A9C7A_OFFSET UNITYSDK_OFFSET(0xB8A6E90)
#define CLASS_2_41EF51BCBAF76328_METHOD_2_848FDD59AB054F3D_OFFSET UNITYSDK_OFFSET(0xB8A6F50)
#define CLASS_2_41EF51BCBAF76328_METHOD_2_8800E8CC95B74FDB_OFFSET UNITYSDK_OFFSET(0xB8A70A0)
#define CLASS_2_41EF51BCBAF76328_METHOD_2_96BDC4B57CCFE000_1_OFFSET UNITYSDK_OFFSET(0xB8A69B0)
#define CLASS_2_41EF51BCBAF76328_METHOD_2_96BDC4B57CCFE000_OFFSET UNITYSDK_OFFSET(0xB8A6860)
#define CLASS_2_41EF51BCBAF76328_METHOD_2_A8F6F688241E6DBC_OFFSET UNITYSDK_OFFSET(0xB8A7890)
#define CLASS_2_41EF51BCBAF76328_METHOD_2_B07FEF75B659E00F_OFFSET UNITYSDK_OFFSET(0xB8A67A0)
#define CLASS_2_41EF51BCBAF76328_METHOD_2_B2C8D4ADAD1FAB0A_OFFSET UNITYSDK_OFFSET(0xB8A78F0)
#define CLASS_2_41EF51BCBAF76328_METHOD_2_F37CDBD6D46274D2_1_OFFSET UNITYSDK_OFFSET(0xB8A7CC0)
#define CLASS_2_41EF51BCBAF76328_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0xB8A7C00)
#define CLASS_2_41EF51BCBAF76328_METHOD_2_FDE09C8D62639E3E_OFFSET UNITYSDK_OFFSET(0xB8A6FE0)
#define CLASS_2_41EF51BCBAF76328_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xB8A5ED0)
#define CLASS_2_41EF51BCBAF76328__CTOR_OFFSET UNITYSDK_OFFSET(0xB8A8190)
#define CLASS_2_41EF51BCBAF76328__ONBIND_OFFSET UNITYSDK_OFFSET(0xB8A5EE0)
#define CLASS_2_41EF51BCBAF76328__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0xB8A6560)
#define CLASS_2_41EF51BCBAF76328__ONTICK_OFFSET UNITYSDK_OFFSET(0xB8A7640)
#define CLASS_2_41EF51BCBAF76328___ONBIND_B__5_0_OFFSET UNITYSDK_OFFSET(0xB8A8290)

inline static constexpr unsigned int Class_2_41EF51BCBAF76328_TypeDefinitionIndex = 72188;
...
public:
	...
	{
		return (::Class_2_41EF51BCBAF76328**)Il2CppClass::FromTypeDefinitionIndex(Class_2_41EF51BCBAF76328_TypeDefinitionIndex)->GetStaticField(0x18FF0);
	}
	...
	::UnityEngine::RectTransform* DDACLPLHFKH; // 0x60
	::UnityEngine::UI::Button* JDFGEHLFGKD; // 0x68
	::UnityEngine::Animation* JMGIDLKMHDG; // 0x70
	::Class_2_ABB406266ACF9A2E* PDLMOICFKFK; // 0x78
	::UnityEngine::Transform* AHHGNBNNDDC; // 0x80
	::RPG::Client::BattleGamePhase* NOHNKAIALPJ; // 0x88
	::Class_2_10FECA76F4010EF3* AFNMELOGAND; // 0x90
	::UnityEngine::Transform* JNOBFPEJPJL; // 0x98
	::UnityEngine::Animation* CKBJGHINKOE; // 0xA0
	::RPG::Client::MonoClickOutsideDetect* AAFBCFCMAPI; // 0xA8
	::UnityEngine::UI::Button* PHMANKGJECM; // 0xB0
	::System::Collections::Generic::Stack_1<::Class_2_ED349B47CFEDF9B8*>* JOPILGIMBJM; // 0xB8
	::Class_1_3FF51CE8B91EFA1B* CDMFHPLLFEC; // 0xC0
	::UnityEngine::Transform* KNNGFIKIECO; // 0xC8
	::RPG::UINavigation::UINavigationZoneManager* DJOAIHJIJKL; // 0xD0
	::System::Collections::Generic::Stack_1<::Class_2_ED349B47CFEDF9B8*>* DDKLNFGEAIP; // 0xD8
	::Class_1_56F79B35BC444FE2* EMEAEHDCJAF; // 0xE0
