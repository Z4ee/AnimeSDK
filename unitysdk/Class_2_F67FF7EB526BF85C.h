...
#define CLASS_2_F67FF7EB526BF85C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1351EE20)
#define CLASS_2_F67FF7EB526BF85C_METHOD_2_0798AB0C5AC86AC4_OFFSET UNITYSDK_OFFSET(0x1351F7B0)
#define CLASS_2_F67FF7EB526BF85C_METHOD_2_10AD0834AEF29F17_OFFSET UNITYSDK_OFFSET(0x1351F180)
#define CLASS_2_F67FF7EB526BF85C_METHOD_2_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x1351F990)
#define CLASS_2_F67FF7EB526BF85C_METHOD_2_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x1351F7D0)
#define CLASS_2_F67FF7EB526BF85C_METHOD_2_4AADAF19CDCB660E_OFFSET UNITYSDK_OFFSET(0x1351FA40)
#define CLASS_2_F67FF7EB526BF85C_METHOD_2_57D80B372834C5D1_OFFSET UNITYSDK_OFFSET(0x1351EF10)
#define CLASS_2_F67FF7EB526BF85C_METHOD_2_5F2139267A139D9A_OFFSET UNITYSDK_OFFSET(0x1351ED60)
#define CLASS_2_F67FF7EB526BF85C_METHOD_2_7003271FF3C0F5CC_OFFSET UNITYSDK_OFFSET(0x1351F8D0)
#define CLASS_2_F67FF7EB526BF85C_METHOD_2_97CAD17442913F0E_OFFSET UNITYSDK_OFFSET(0x1351F9A0)
#define CLASS_2_F67FF7EB526BF85C_METHOD_2_A99EF338505A0EA9_OFFSET UNITYSDK_OFFSET(0x1351FBD0)
#define CLASS_2_F67FF7EB526BF85C_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x1351F020)
#define CLASS_2_F67FF7EB526BF85C_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1351EFE0)
#define CLASS_2_F67FF7EB526BF85C_METHOD_2_F166DD22F369762B_OFFSET UNITYSDK_OFFSET(0x1351F830)
#define CLASS_2_F67FF7EB526BF85C_METHOD_2_FD647A48096EB173_OFFSET UNITYSDK_OFFSET(0x1351F880)
#define CLASS_2_F67FF7EB526BF85C_METHOD_2_FDE09C8D62639E3E_OFFSET UNITYSDK_OFFSET(0x1351EE70)
#define CLASS_2_F67FF7EB526BF85C_ONMODELROOTLOADED_OFFSET UNITYSDK_OFFSET(0x1351EF60)
#define CLASS_2_F67FF7EB526BF85C_ONMODELROOTUNLOADED_OFFSET UNITYSDK_OFFSET(0x1351EFA0)
#define CLASS_2_F67FF7EB526BF85C_TICK_OFFSET UNITYSDK_OFFSET(0x1351F060)
#define CLASS_2_F67FF7EB526BF85C__CTOR_OFFSET UNITYSDK_OFFSET(0x1351ED20)
...
{
public:
	::Class_1_B65F0DC23C3D5837* PGMBFHNLPNF; // 0x18
	::Class_2_3F4D673D3F90D12C* FAOEOJJKLLB; // 0x20
	::RPG::GameCore::TransformComponent* LMCMCFHLJEJ; // 0x28
	::RPG::GameCore::GameEntity* PAKNEPALMLB; // 0x30
	::Class_1_36C40D023D7EF65D* PIJPEKHJHHI; // 0x38
	::Class_2_21055A9FA74B791E* NILDKJKBHHG; // 0x40
	::RPG::GameCore::NPCComponent* OJAIBDDGDME; // 0x48
	::Class_1_36C40D023D7EF65D* JHIHGGIHCLD; // 0x50
	::System::Single DDNOLBBFKMA; // 0x58
	::System::Single IPCJOAPDIHN; // 0x5C
	::System::Boolean LHMNKBAOKIN; // 0x60
	::System::Boolean MHEAIOMEGCA; // 0x61
	::System::Boolean HHBOKPNACHE; // 0x62
	::RPG::GameCore::TargetingMode BHJDJDPLCLP; // 0x64
