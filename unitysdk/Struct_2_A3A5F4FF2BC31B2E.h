...
#define STRUCT_2_A3A5F4FF2BC31B2E_METHOD_2_28EBF7743F49BA15_OFFSET UNITYSDK_OFFSET(0x7EFAF0)
#define STRUCT_2_A3A5F4FF2BC31B2E_METHOD_2_625FBF14AF26EF8B_OFFSET UNITYSDK_OFFSET(0x7EFB30)
#define STRUCT_2_A3A5F4FF2BC31B2E_METHOD_2_70589F89E4D22649_OFFSET UNITYSDK_OFFSET(0x7EFBC0)
#define STRUCT_2_A3A5F4FF2BC31B2E_METHOD_2_B924E6EC33D07211_OFFSET UNITYSDK_OFFSET(0x7EFAB0)
#define STRUCT_2_A3A5F4FF2BC31B2E_METHOD_2_B9D8FD15D18938A0_OFFSET UNITYSDK_OFFSET(0x246290)
#define STRUCT_2_A3A5F4FF2BC31B2E_METHOD_2_C114A1F8E08B6F92_1_OFFSET UNITYSDK_OFFSET(0x52CCD0)
#define STRUCT_2_A3A5F4FF2BC31B2E_METHOD_2_C114A1F8E08B6F92_OFFSET UNITYSDK_OFFSET(0x52CD90)
#define STRUCT_2_A3A5F4FF2BC31B2E_METHOD_2_C74CF020AA42ED85_1_OFFSET UNITYSDK_OFFSET(0x2C3430)
#define STRUCT_2_A3A5F4FF2BC31B2E_METHOD_2_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x2C19D0)
#define STRUCT_2_A3A5F4FF2BC31B2E_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x3645D0)
#define STRUCT_2_A3A5F4FF2BC31B2E__CCTOR_OFFSET UNITYSDK_OFFSET(0x14EA40F0)
#define STRUCT_2_A3A5F4FF2BC31B2E__CTOR_1_OFFSET UNITYSDK_OFFSET(0x7EFA50)
#define STRUCT_2_A3A5F4FF2BC31B2E__CTOR_2_OFFSET UNITYSDK_OFFSET(0x7EFA60)
#define STRUCT_2_A3A5F4FF2BC31B2E__CTOR_3_OFFSET UNITYSDK_OFFSET(0x7EFAA0)
#define STRUCT_2_A3A5F4FF2BC31B2E__CTOR_OFFSET UNITYSDK_OFFSET(0x7EFA30)

inline static constexpr unsigned int Struct_2_A3A5F4FF2BC31B2E_TypeDefinitionIndex = 41710;

struct alignas(8) Struct_2_A3A5F4FF2BC31B2E
{
	static ::Struct_2_A3A5F4FF2BC31B2E* StaticGet_Field_2_0()
	{
		return (::Struct_2_A3A5F4FF2BC31B2E*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_A3A5F4FF2BC31B2E_TypeDefinitionIndex)->GetStaticField(0x385C0);
	}
