...
#define CLASS_2_B66B2B4A7689CC14_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAA8E430)
#define CLASS_2_B66B2B4A7689CC14_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xAA8E390)
#define CLASS_2_B66B2B4A7689CC14_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xAA8E3E0)
#define CLASS_2_B66B2B4A7689CC14_TICK_OFFSET UNITYSDK_OFFSET(0xAA8E4C0)
#define CLASS_2_B66B2B4A7689CC14__CTOR_OFFSET UNITYSDK_OFFSET(0xAA8E1F0)

inline static constexpr unsigned int Class_2_B66B2B4A7689CC14_TypeDefinitionIndex = 53837;

class Class_2_B66B2B4A7689CC14 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_1_F3391C70DC37088D* Field_2_6; // 0x18
	::RPG::GameCore::TaskContext* Field_2_2; // 0x20
	::RPG::GameCore::PuzzleBoxmanInBoard* Field_2_3; // 0x28
	::RPG::GameCore::PropComponent* Field_2_0; // 0x30
	::Class_1_F3391C70DC37088D* Field_2_7; // 0x38
	::Class_3_E21F6DE9B7FA4D05* Field_2_5; // 0x40
	::RPG::Client::Prop::BoxmanPuzzleBoard* Field_2_1; // 0x48
