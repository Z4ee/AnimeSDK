...
#define CLASS_1_12EBBCDF245A0FB0_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A7A7C40)
#define CLASS_1_12EBBCDF245A0FB0_CLONE_OFFSET UNITYSDK_OFFSET(0x1A7A7930)
#define CLASS_1_12EBBCDF245A0FB0_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A7A7A80)
#define CLASS_1_12EBBCDF245A0FB0_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A7A79E0)
#define CLASS_1_12EBBCDF245A0FB0_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A7A7B10)
#define CLASS_1_12EBBCDF245A0FB0_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A7A7CD0)
#define CLASS_1_12EBBCDF245A0FB0_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A7A7C80)
#define CLASS_1_12EBBCDF245A0FB0_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A7A78A0)
#define CLASS_1_12EBBCDF245A0FB0_METHOD_1_C74E50CBD41F0264_1_OFFSET UNITYSDK_OFFSET(0x1A7A79B0)
#define CLASS_1_12EBBCDF245A0FB0_METHOD_1_C74E50CBD41F0264_2_OFFSET UNITYSDK_OFFSET(0x1A7A79D0)
#define CLASS_1_12EBBCDF245A0FB0_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1A7A7990)
#define CLASS_1_12EBBCDF245A0FB0_METHOD_1_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x1A7A79A0)
#define CLASS_1_12EBBCDF245A0FB0_METHOD_1_F0088C88851A7DFB_2_OFFSET UNITYSDK_OFFSET(0x1A7A79C0)
#define CLASS_1_12EBBCDF245A0FB0_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1A7A7980)
#define CLASS_1_12EBBCDF245A0FB0_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A7A78D0)
#define CLASS_1_12EBBCDF245A0FB0_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A7A7B40)
#define CLASS_1_12EBBCDF245A0FB0_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A7A7BA0)
#define CLASS_1_12EBBCDF245A0FB0__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A7A7E80)
#define CLASS_1_12EBBCDF245A0FB0__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A7A78F0)
#define CLASS_1_12EBBCDF245A0FB0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7A78E0)

inline static constexpr unsigned int Class_1_12EBBCDF245A0FB0_TypeDefinitionIndex = 23945;

class Class_1_12EBBCDF245A0FB0 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_12EBBCDF245A0FB0*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_12EBBCDF245A0FB0*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_12EBBCDF245A0FB0_TypeDefinitionIndex)->GetStaticField(0x49320);
	}
