...
#define CLASS_1_26B93FFBE9FAEBB7_GET_CENTERSTYLE_OFFSET UNITYSDK_OFFSET(0x1750BC70)
#define CLASS_1_26B93FFBE9FAEBB7_GET_CURCOUNT_OFFSET UNITYSDK_OFFSET(0x1750BD30)
#define CLASS_1_26B93FFBE9FAEBB7_GET_CURSTATE_OFFSET UNITYSDK_OFFSET(0x1750BC50)
#define CLASS_1_26B93FFBE9FAEBB7_GET_CUSTOMCHANGEEFFCOLORSTR_OFFSET UNITYSDK_OFFSET(0x1750BDD0)
#define CLASS_1_26B93FFBE9FAEBB7_GET_CUSTOMFILLCOLORSTR_OFFSET UNITYSDK_OFFSET(0x1750BDB0)
#define CLASS_1_26B93FFBE9FAEBB7_GET_CUSTOMPREFABPATH_OFFSET UNITYSDK_OFFSET(0x1750BCD0)
#define CLASS_1_26B93FFBE9FAEBB7_GET_CUSTOMPROGRESSCOLORSTR_OFFSET UNITYSDK_OFFSET(0x1750BD90)
#define CLASS_1_26B93FFBE9FAEBB7_GET_ENERGYBARTYPE_OFFSET UNITYSDK_OFFSET(0x1750BBF0)
#define CLASS_1_26B93FFBE9FAEBB7_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1750BC90)
#define CLASS_1_26B93FFBE9FAEBB7_GET_ID_OFFSET UNITYSDK_OFFSET(0x1750BBD0)
#define CLASS_1_26B93FFBE9FAEBB7_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1750BC10)
#define CLASS_1_26B93FFBE9FAEBB7_GET_ISENABLESELECTEDSTATE_OFFSET UNITYSDK_OFFSET(0x1750BC30)
#define CLASS_1_26B93FFBE9FAEBB7_GET_MAXCOUNT_OFFSET UNITYSDK_OFFSET(0x1750BD10)
#define CLASS_1_26B93FFBE9FAEBB7_GET_NUMCOLORSTR_OFFSET UNITYSDK_OFFSET(0x1750BD70)
#define CLASS_1_26B93FFBE9FAEBB7_GET_SHOWCOUNT_OFFSET UNITYSDK_OFFSET(0x1750BD50)
#define CLASS_1_26B93FFBE9FAEBB7_GET_SPECIALEFFPATH_OFFSET UNITYSDK_OFFSET(0x1750BCF0)
#define CLASS_1_26B93FFBE9FAEBB7_GET_TRIGGERNAME_OFFSET UNITYSDK_OFFSET(0x1750BCB0)
#define CLASS_1_26B93FFBE9FAEBB7_SET_CENTERSTYLE_OFFSET UNITYSDK_OFFSET(0x1750BC80)
#define CLASS_1_26B93FFBE9FAEBB7_SET_CURCOUNT_OFFSET UNITYSDK_OFFSET(0x1750BD40)
#define CLASS_1_26B93FFBE9FAEBB7_SET_CURSTATE_OFFSET UNITYSDK_OFFSET(0x1750BC60)
#define CLASS_1_26B93FFBE9FAEBB7_SET_CUSTOMCHANGEEFFCOLORSTR_OFFSET UNITYSDK_OFFSET(0x1750BDE0)
#define CLASS_1_26B93FFBE9FAEBB7_SET_CUSTOMFILLCOLORSTR_OFFSET UNITYSDK_OFFSET(0x1750BDC0)
#define CLASS_1_26B93FFBE9FAEBB7_SET_CUSTOMPREFABPATH_OFFSET UNITYSDK_OFFSET(0x1750BCE0)
#define CLASS_1_26B93FFBE9FAEBB7_SET_CUSTOMPROGRESSCOLORSTR_OFFSET UNITYSDK_OFFSET(0x1750BDA0)
#define CLASS_1_26B93FFBE9FAEBB7_SET_ENERGYBARTYPE_OFFSET UNITYSDK_OFFSET(0x1750BC00)
#define CLASS_1_26B93FFBE9FAEBB7_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1750BCA0)
#define CLASS_1_26B93FFBE9FAEBB7_SET_ID_OFFSET UNITYSDK_OFFSET(0x1750BBE0)
#define CLASS_1_26B93FFBE9FAEBB7_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1750BC20)
#define CLASS_1_26B93FFBE9FAEBB7_SET_ISENABLESELECTEDSTATE_OFFSET UNITYSDK_OFFSET(0x1750BC40)
#define CLASS_1_26B93FFBE9FAEBB7_SET_MAXCOUNT_OFFSET UNITYSDK_OFFSET(0x1750BD20)
#define CLASS_1_26B93FFBE9FAEBB7_SET_NUMCOLORSTR_OFFSET UNITYSDK_OFFSET(0x1750BD80)
#define CLASS_1_26B93FFBE9FAEBB7_SET_SHOWCOUNT_OFFSET UNITYSDK_OFFSET(0x1750BD60)
#define CLASS_1_26B93FFBE9FAEBB7_SET_SPECIALEFFPATH_OFFSET UNITYSDK_OFFSET(0x1750BD00)
#define CLASS_1_26B93FFBE9FAEBB7_SET_TRIGGERNAME_OFFSET UNITYSDK_OFFSET(0x1750BCC0)
#define CLASS_1_26B93FFBE9FAEBB7__CTOR_OFFSET UNITYSDK_OFFSET(0x1750BDF0)

inline static constexpr unsigned int Class_1_26B93FFBE9FAEBB7_TypeDefinitionIndex = 76050;

class Class_1_26B93FFBE9FAEBB7 : public ::System::Object
{
public:
	::System::String* _CustomPrefabPath_k__BackingField; // 0x10
	::System::String* _NumColorStr_k__BackingField; // 0x18
	::System::String* _CustomFillColorStr_k__BackingField; // 0x20
	::System::String* _CustomProgressColorStr_k__BackingField; // 0x28
	::System::String* _IconPath_k__BackingField; // 0x30
	::System::String* _SpecialEffPath_k__BackingField; // 0x38
	::System::String* _CustomChangeEffColorStr_k__BackingField; // 0x40
	::System::String* _TriggerName_k__BackingField; // 0x48
	::System::Int32 _CenterStyle_k__BackingField; // 0x50
	::System::Boolean _IsActive_k__BackingField; // 0x54
	::System::Boolean _IsEnableSelectedState_k__BackingField; // 0x55
	::System::UInt32 _ID_k__BackingField; // 0x58
	::RPG::GameCore::MonsterEnergyBarType _EnergyBarType_k__BackingField; // 0x5C
	::RPG::GameCore::FixPoint _MaxCount_k__BackingField; // 0x60
	::RPG::GameCore::EnergyBarState _CurState_k__BackingField; // 0x68
	::RPG::GameCore::FixPoint _CurCount_k__BackingField; // 0x70
	::RPG::GameCore::FixPoint _ShowCount_k__BackingField; // 0x78
