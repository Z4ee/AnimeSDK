...
public:
	...
	{
		return (::System::Predicate_1<::RPG::GameCore::GameWorld*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_1266B9A4B9B8481C___O_TypeDefinitionIndex)->GetStaticField(0x5BEE0);
	}
};
