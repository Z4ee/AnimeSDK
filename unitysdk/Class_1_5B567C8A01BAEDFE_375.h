...
#define CLASS_1_5B567C8A01BAEDFE_375_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A556DD0)
#define CLASS_1_5B567C8A01BAEDFE_375_CLONE_OFFSET UNITYSDK_OFFSET(0x1A556C40)
#define CLASS_1_5B567C8A01BAEDFE_375_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A556CE0)
#define CLASS_1_5B567C8A01BAEDFE_375_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A556C80)
#define CLASS_1_5B567C8A01BAEDFE_375_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A556D30)
#define CLASS_1_5B567C8A01BAEDFE_375_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A556E20)
#define CLASS_1_5B567C8A01BAEDFE_375_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A556DF0)
#define CLASS_1_5B567C8A01BAEDFE_375_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A556BC0)
#define CLASS_1_5B567C8A01BAEDFE_375_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A556BF0)
#define CLASS_1_5B567C8A01BAEDFE_375_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A556D60)
#define CLASS_1_5B567C8A01BAEDFE_375_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A556DC0)
#define CLASS_1_5B567C8A01BAEDFE_375__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A556E70)
#define CLASS_1_5B567C8A01BAEDFE_375__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A556C10)
#define CLASS_1_5B567C8A01BAEDFE_375__CTOR_OFFSET UNITYSDK_OFFSET(0x1A556C00)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_375_TypeDefinitionIndex = 32768;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_375*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_375_TypeDefinitionIndex)->GetStaticField(0x12830);
	}
