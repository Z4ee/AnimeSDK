...
#define CLASS_1_15AADF33708BADBA_METHOD_1_097468641FDED14E_OFFSET UNITYSDK_OFFSET(0x8C82460)
#define CLASS_1_15AADF33708BADBA__CTOR_OFFSET UNITYSDK_OFFSET(0x8C824E0)

inline static constexpr unsigned int Class_1_15AADF33708BADBA_TypeDefinitionIndex = 45765;

class Class_1_15AADF33708BADBA : public ::System::Object
{
public:
	::RPG::GameCore::ProgressBarTypeConfig* Field_1_7; // 0x10
	::RPG::GameCore::GameEntity* Field_1_0; // 0x18
	::RPG::GameCore::DotBarTypeConfig* Field_1_6; // 0x20
	::RPG::GameCore::NumBarTypeConfig* Field_1_8; // 0x28
	::System::Int32 Field_1_4; // 0x30
	::System::Int32 Field_1_5; // 0x34
	::RPG::GameCore::SummonerEnergyBarType Field_1_2; // 0x38
