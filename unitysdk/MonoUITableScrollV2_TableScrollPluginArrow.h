...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_AFTERREFRESHARROW_OFFSET UNITYSDK_OFFSET(0x14122F00)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_CALARROWRED_OFFSET UNITYSDK_OFFSET(0x141229A0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_CALARROWSTATE_OFFSET UNITYSDK_OFFSET(0x14122940)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0x14123370)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_GET_DATACOUNT_OFFSET UNITYSDK_OFFSET(0x141232D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_GET_LOGIC_OFFSET UNITYSDK_OFFSET(0x14123310)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_GET_SIMPLEMODE_OFFSET UNITYSDK_OFFSET(0x14123350)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_GET__SCROLLPARAMS_OFFSET UNITYSDK_OFFSET(0x14123330)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_HIDESCROLLVIEWARROW_OFFSET UNITYSDK_OFFSET(0x14122E00)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_INITSCROLLVIEWARROWBTN_OFFSET UNITYSDK_OFFSET(0x14121EE0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x141222E0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_MARKARROWDIRTY_OFFSET UNITYSDK_OFFSET(0x14122600)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x14121E50)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_ONENABLENEXTFRAME_OFFSET UNITYSDK_OFFSET(0x141224C0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_ONSCROLLVIEWITEMMOVE_OFFSET UNITYSDK_OFFSET(0x141225A0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_REFRESHARROWIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x14122760)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_RESETSCROLLVIEWARROWINNER_OFFSET UNITYSDK_OFFSET(0x14122C80)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_RESETSCROLLVIEWARROW_OFFSET UNITYSDK_OFFSET(0x14122550)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_SHOWSCROLLVIEWARROW_OFFSET UNITYSDK_OFFSET(0x14122E80)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_UPDATEONENABLEDELAYMARKARROWDIRTY_OFFSET UNITYSDK_OFFSET(0x141223E0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_UPDATESCROLLVIEWARROW_OFFSET UNITYSDK_OFFSET(0x14122440)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__CALARROWSTATE_G__BYCONTENTEND_16_5_OFFSET UNITYSDK_OFFSET(0x141243A0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__CALARROWSTATE_G__BYCONTENTSTART_16_3_OFFSET UNITYSDK_OFFSET(0x14123CC0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__CALARROWSTATE_G__BYFIRSTITEM_16_2_OFFSET UNITYSDK_OFFSET(0x141239B0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__CALARROWSTATE_G__BYLASTITEM_16_4_OFFSET UNITYSDK_OFFSET(0x14124030)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__CALARROWSTATE_G__ISEND_16_1_OFFSET UNITYSDK_OFFSET(0x14123230)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__CALARROWSTATE_G__ISSTART_16_0_OFFSET UNITYSDK_OFFSET(0x14123190)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__CCTOR_OFFSET UNITYSDK_OFFSET(0x14123390)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__CTOR_OFFSET UNITYSDK_OFFSET(0x14121E40)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__INITSCROLLVIEWARROWBTN_B__14_0_OFFSET UNITYSDK_OFFSET(0x141233A0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__INITSCROLLVIEWARROWBTN_B__14_1_OFFSET UNITYSDK_OFFSET(0x141235F0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__INITSCROLLVIEWARROWBTN_G__GETINDEX_14_3_OFFSET UNITYSDK_OFFSET(0x14123600)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__INITSCROLLVIEWARROWBTN_G__SCROLLTO_14_2_OFFSET UNITYSDK_OFFSET(0x141233B0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__INITSCROLLVIEWARROWBTN_G__TRYSCROLLTOINDEX_14_4_OFFSET UNITYSDK_OFFSET(0x141237A0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__UPDATESCROLLVIEWARROW_G__UPDATEARROWREDDOT_12_1_OFFSET UNITYSDK_OFFSET(0x14123180)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__UPDATESCROLLVIEWARROW_G__UPDATEARROW_12_0_OFFSET UNITYSDK_OFFSET(0x14122F50)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW___BASE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x14124720)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x141247B0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW___BASE_ONENABLENEXTFRAME_OFFSET UNITYSDK_OFFSET(0x14124840)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW___BASE_ONSCROLLVIEWITEMMOVE_OFFSET UNITYSDK_OFFSET(0x141248D0)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginArrow_TypeDefinitionIndex = 75052;
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(MonoUITableScrollV2_TableScrollPluginArrow_TypeDefinitionIndex)->GetStaticField(0x114D0);
	}
	...
	::System::Int32 _delayMarkScrollViewDirty_ForOnEnable; // 0x40
	::MonoUITableScrollV2_TableScrollPluginArrow_ScrollViewDirtyFlag _lastScrollViewDirtyFlag; // 0x44
