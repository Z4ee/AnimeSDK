...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_AFTERREFRESHARROW_OFFSET UNITYSDK_OFFSET(0x116C1740)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_CALARROWRED_OFFSET UNITYSDK_OFFSET(0x116C11F0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_CALARROWSTATE_OFFSET UNITYSDK_OFFSET(0x116C1190)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0x116C1BA0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_GET_DATACOUNT_OFFSET UNITYSDK_OFFSET(0x116C1B10)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_GET_LOGIC_OFFSET UNITYSDK_OFFSET(0x116C1B40)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_GET_SIMPLEMODE_OFFSET UNITYSDK_OFFSET(0x116C1B80)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_GET__SCROLLPARAMS_OFFSET UNITYSDK_OFFSET(0x116C1B60)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_HIDESCROLLVIEWARROW_OFFSET UNITYSDK_OFFSET(0x116C1640)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_INITSCROLLVIEWARROWBTN_OFFSET UNITYSDK_OFFSET(0x116C0730)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x116C0B30)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_MARKARROWDIRTY_OFFSET UNITYSDK_OFFSET(0x116C0E50)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x116C06A0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_ONENABLENEXTFRAME_OFFSET UNITYSDK_OFFSET(0x116C0D10)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_ONSCROLLVIEWITEMMOVE_OFFSET UNITYSDK_OFFSET(0x116C0DF0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_REFRESHARROWIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x116C0FB0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_RESETSCROLLVIEWARROWINNER_OFFSET UNITYSDK_OFFSET(0x116C14C0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_RESETSCROLLVIEWARROW_OFFSET UNITYSDK_OFFSET(0x116C0DA0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_SHOWSCROLLVIEWARROW_OFFSET UNITYSDK_OFFSET(0x116C16C0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_UPDATEONENABLEDELAYMARKARROWDIRTY_OFFSET UNITYSDK_OFFSET(0x116C0C30)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_UPDATESCROLLVIEWARROW_OFFSET UNITYSDK_OFFSET(0x116C0C90)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__CALARROWSTATE_G__BYCONTENTEND_16_5_OFFSET UNITYSDK_OFFSET(0x116C2B80)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__CALARROWSTATE_G__BYCONTENTSTART_16_3_OFFSET UNITYSDK_OFFSET(0x116C24C0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__CALARROWSTATE_G__BYFIRSTITEM_16_2_OFFSET UNITYSDK_OFFSET(0x116C21B0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__CALARROWSTATE_G__BYLASTITEM_16_4_OFFSET UNITYSDK_OFFSET(0x116C2830)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__CALARROWSTATE_G__ISEND_16_1_OFFSET UNITYSDK_OFFSET(0x116C1A70)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__CALARROWSTATE_G__ISSTART_16_0_OFFSET UNITYSDK_OFFSET(0x116C19D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__CCTOR_OFFSET UNITYSDK_OFFSET(0x116C1BC0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__CTOR_OFFSET UNITYSDK_OFFSET(0x116C0690)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__INITSCROLLVIEWARROWBTN_B__14_0_OFFSET UNITYSDK_OFFSET(0x116C1BD0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__INITSCROLLVIEWARROWBTN_B__14_1_OFFSET UNITYSDK_OFFSET(0x116C1E40)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__INITSCROLLVIEWARROWBTN_G__GETINDEX_14_3_OFFSET UNITYSDK_OFFSET(0x116C1E50)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__INITSCROLLVIEWARROWBTN_G__SCROLLTO_14_2_OFFSET UNITYSDK_OFFSET(0x116C1BE0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__INITSCROLLVIEWARROWBTN_G__TRYSCROLLTOINDEX_14_4_OFFSET UNITYSDK_OFFSET(0x116C1FB0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__UPDATESCROLLVIEWARROW_G__UPDATEARROWREDDOT_12_1_OFFSET UNITYSDK_OFFSET(0x116C19C0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__UPDATESCROLLVIEWARROW_G__UPDATEARROW_12_0_OFFSET UNITYSDK_OFFSET(0x116C1790)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW___BASE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x116C2F00)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x116C2F90)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW___BASE_ONENABLENEXTFRAME_OFFSET UNITYSDK_OFFSET(0x116C3020)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW___BASE_ONSCROLLVIEWITEMMOVE_OFFSET UNITYSDK_OFFSET(0x116C30B0)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginArrow_TypeDefinitionIndex = 69923;
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(MonoUITableScrollV2_TableScrollPluginArrow_TypeDefinitionIndex)->GetStaticField(0x123C0);
	}
	...
	::System::Boolean _scrollViewArrowDirty; // 0x38
	::System::ValueTuple_2<::System::Boolean, ::System::Boolean> _currentFrameScrollViewArrowState; // 0x39
	::System::ValueTuple_2<::System::Boolean, ::System::Boolean> _lastFrameScrollViewArrowState; // 0x3B
	::MonoUITableScrollV2_TableScrollPluginArrow_ScrollViewDirtyFlag _currentScrollViewDirtyFlag; // 0x40
	::System::Int32 _delayMarkScrollViewDirty_ForOnEnable; // 0x44
	::MonoUITableScrollV2_TableScrollPluginArrow_ScrollViewDirtyFlag _lastScrollViewDirtyFlag; // 0x48
