...
#define MB3_MULTIMESHBAKER_ADDDELETEGAMEOBJECTSBYID_OFFSET UNITYSDK_OFFSET(0x1ECEA7F0)
#define MB3_MULTIMESHBAKER_ADDDELETEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1ECEA4C0)
#define MB3_MULTIMESHBAKER_GET_MESHCOMBINER_OFFSET UNITYSDK_OFFSET(0x1ECEA4B0)
#define MB3_MULTIMESHBAKER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1ECEAB20)
#define MB3_MULTIMESHBAKER_PRINTTIMINGS_OFFSET UNITYSDK_OFFSET(0x1ECE9940)
#define MB3_MULTIMESHBAKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ECEAB40)

inline static constexpr unsigned int MB3_MultiMeshBaker_TypeDefinitionIndex = 94481;
