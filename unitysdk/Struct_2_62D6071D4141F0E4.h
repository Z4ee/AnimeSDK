...
#define STRUCT_2_62D6071D4141F0E4_METHOD_2_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x3A50C80)
#define STRUCT_2_62D6071D4141F0E4_METHOD_2_9AB6F9B4F8414F84_OFFSET UNITYSDK_OFFSET(0x3A50B50)
#define STRUCT_2_62D6071D4141F0E4_METHOD_2_AD36E378507B7451_OFFSET UNITYSDK_OFFSET(0x3A50BC0)
#define STRUCT_2_62D6071D4141F0E4_METHOD_2_B350447248DADBD4_OFFSET UNITYSDK_OFFSET(0x3A50D70)
#define STRUCT_2_62D6071D4141F0E4_METHOD_2_C4F24C83C3503C58_OFFSET UNITYSDK_OFFSET(0x3A50D30)
#define STRUCT_2_62D6071D4141F0E4_METHOD_2_E29A3544556C0908_OFFSET UNITYSDK_OFFSET(0x3A50A00)
#define STRUCT_2_62D6071D4141F0E4_METHOD_2_EEB95CFE1E27DD81_OFFSET UNITYSDK_OFFSET(0x3A50CE0)
#define STRUCT_2_62D6071D4141F0E4_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3A50E60)
#define STRUCT_2_62D6071D4141F0E4__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3A50A00)
#define STRUCT_2_62D6071D4141F0E4__CTOR_2_OFFSET UNITYSDK_OFFSET(0x3A50AE0)
#define STRUCT_2_62D6071D4141F0E4__CTOR_3_OFFSET UNITYSDK_OFFSET(0x3A50B50)
#define STRUCT_2_62D6071D4141F0E4__CTOR_OFFSET UNITYSDK_OFFSET(0x3A50920)

inline static constexpr unsigned int Struct_2_62D6071D4141F0E4_TypeDefinitionIndex = 6290;

struct alignas(4) Struct_2_62D6071D4141F0E4
{
	::RPG::MVector3 AKFGOEJBPLD; // 0x10
	::RPG::MVector3 DIBFEBGIHCH; // 0x1C
	::RPG::MVector3 BHCMCMADHBF; // 0x28
	::RPG::MVector3 LJDHGFECMHJ; // 0x34
	::System::Single CLMMMEAIKBD; // 0x40
	...
	{
		return ((::System::Single(*)(::PVOID, ::RPG::MVector3))((::PBYTE)hIl2Cpp + STRUCT_2_62D6071D4141F0E4_METHOD_2_C4F24C83C3503C58_OFFSET))(this, a1);
	}
