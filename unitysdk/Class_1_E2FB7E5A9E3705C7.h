...
#define CLASS_1_E2FB7E5A9E3705C7_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x15489480)
#define CLASS_1_E2FB7E5A9E3705C7_GET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0x15489440)
#define CLASS_1_E2FB7E5A9E3705C7_GET_TEXTID_OFFSET UNITYSDK_OFFSET(0x15489460)
#define CLASS_1_E2FB7E5A9E3705C7_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x154895E0)
#define CLASS_1_E2FB7E5A9E3705C7_SET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0x15489450)
#define CLASS_1_E2FB7E5A9E3705C7_SET_TEXTID_OFFSET UNITYSDK_OFFSET(0x15489470)
#define CLASS_1_E2FB7E5A9E3705C7__CTOR_OFFSET UNITYSDK_OFFSET(0x154895F0)
