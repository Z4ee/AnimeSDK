...
#define CLASS_1_E2FB7E5A9E3705C7_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1799FE20)
#define CLASS_1_E2FB7E5A9E3705C7_GET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0x130BF220)
#define CLASS_1_E2FB7E5A9E3705C7_GET_TEXTID_OFFSET UNITYSDK_OFFSET(0x1799FE00)
#define CLASS_1_E2FB7E5A9E3705C7_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1799FE30)
#define CLASS_1_E2FB7E5A9E3705C7_SET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0x130BF230)
#define CLASS_1_E2FB7E5A9E3705C7_SET_TEXTID_OFFSET UNITYSDK_OFFSET(0x1799FE10)
#define CLASS_1_E2FB7E5A9E3705C7__CTOR_OFFSET UNITYSDK_OFFSET(0x1799FE40)

inline static constexpr unsigned int Class_1_E2FB7E5A9E3705C7_TypeDefinitionIndex = 57678;
