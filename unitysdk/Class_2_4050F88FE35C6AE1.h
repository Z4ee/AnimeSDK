...
#define CLASS_2_4050F88FE35C6AE1_DISPOSE_OFFSET UNITYSDK_OFFSET(0x112B0A70)
#define CLASS_2_4050F88FE35C6AE1_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x112B0AB0)
#define CLASS_2_4050F88FE35C6AE1_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x112B0C10)
#define CLASS_2_4050F88FE35C6AE1_TICK_OFFSET UNITYSDK_OFFSET(0x112B0C60)
#define CLASS_2_4050F88FE35C6AE1__CTOR_OFFSET UNITYSDK_OFFSET(0x112B0A60)

inline static constexpr unsigned int Class_2_4050F88FE35C6AE1_TypeDefinitionIndex = 49749;

class Class_2_4050F88FE35C6AE1 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::SetEntityTalkEnable* Field_2_1; // 0x20
