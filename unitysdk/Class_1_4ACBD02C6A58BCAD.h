...
#define CLASS_1_4ACBD02C6A58BCAD_METHOD_1_13696A527CD9CA86_OFFSET UNITYSDK_OFFSET(0x19B88F20)
#define CLASS_1_4ACBD02C6A58BCAD_METHOD_1_35B092FAA6096FA1_OFFSET UNITYSDK_OFFSET(0x19B88740)
#define CLASS_1_4ACBD02C6A58BCAD_METHOD_1_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x19B88D50)
#define CLASS_1_4ACBD02C6A58BCAD_METHOD_1_9DF8B3A92DBEAB3E_OFFSET UNITYSDK_OFFSET(0x19B88F70)
#define CLASS_1_4ACBD02C6A58BCAD_METHOD_1_AD31DD9682084C83_OFFSET UNITYSDK_OFFSET(0x19B88DE0)
#define CLASS_1_4ACBD02C6A58BCAD_METHOD_1_CC8B92ED5AED5634_OFFSET UNITYSDK_OFFSET(0x19B88B80)
#define CLASS_1_4ACBD02C6A58BCAD_METHOD_1_CE34EA208837238D_OFFSET UNITYSDK_OFFSET(0x19B889F0)
#define CLASS_1_4ACBD02C6A58BCAD_METHOD_1_DE52BD42C4B0B772_OFFSET UNITYSDK_OFFSET(0x19B887C0)
#define CLASS_1_4ACBD02C6A58BCAD_METHOD_1_E4FB03E5BF035D5F_OFFSET UNITYSDK_OFFSET(0x19B88A50)
#define CLASS_1_4ACBD02C6A58BCAD_METHOD_1_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0x19B88D10)
#define CLASS_1_4ACBD02C6A58BCAD_METHOD_1_F2E1599CBB58B20F_OFFSET UNITYSDK_OFFSET(0x19B88E80)
#define CLASS_1_4ACBD02C6A58BCAD__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B89290)

inline static constexpr unsigned int Class_1_4ACBD02C6A58BCAD_TypeDefinitionIndex = 13395;
...
public:
	...
	{
		return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4ACBD02C6A58BCAD_TypeDefinitionIndex)->GetStaticField(0x49710);
	}
	static ::System::Collections::Generic::Dictionary_2<::RPG::GameCore::CommonIndexKey, ::RPG::GameCore::MapEntranceUnlockRow*>** StaticGet_Field_1_1()
	{
		return (::System::Collections::Generic::Dictionary_2<::RPG::GameCore::CommonIndexKey, ::RPG::GameCore::MapEntranceUnlockRow*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4ACBD02C6A58BCAD_TypeDefinitionIndex)->GetStaticField(0x49718);
	}
	static ::System::Action_1<::Class_1_7A22A3DBEEDD1F80*>** StaticGet_Field_1_2()
	{
		return (::System::Action_1<::Class_1_7A22A3DBEEDD1F80*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4ACBD02C6A58BCAD_TypeDefinitionIndex)->GetStaticField(0x49720);
	}
	static ::System::Byte* StaticGet_Field_1_3()
	{
		return (::System::Byte*)Il2CppClass::FromTypeDefinitionIndex(Class_1_4ACBD02C6A58BCAD_TypeDefinitionIndex)->GetStaticField(0xDBB0);
	}
	static ::System::Boolean* StaticGet_Field_1_4()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_1_4ACBD02C6A58BCAD_TypeDefinitionIndex)->GetStaticField(0xDBB1);
	}
