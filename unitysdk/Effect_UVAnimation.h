...
#define EFFECT_UVANIMATION_START_OFFSET UNITYSDK_OFFSET(0x152F4F90)
#define EFFECT_UVANIMATION_UPDATE_OFFSET UNITYSDK_OFFSET(0x152F5060)
#define EFFECT_UVANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x152F51F0)
