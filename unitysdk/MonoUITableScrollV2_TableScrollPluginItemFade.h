...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_CLEARCOROUTINES_OFFSET UNITYSDK_OFFSET(0x108B0A40)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_ANIMSHOWALL_OFFSET UNITYSDK_OFFSET(0x108AE700)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_CALFADEINTIME_OFFSET UNITYSDK_OFFSET(0x108AE690)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_CALFADEOUTTIME_OFFSET UNITYSDK_OFFSET(0x108AE890)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0x108AE960)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_DONTPLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x108AE790)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_FADEINANIMATIONNAME_OFFSET UNITYSDK_OFFSET(0x108AE5B0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_FADEINTERVAL_OFFSET UNITYSDK_OFFSET(0x108AE620)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_FADEOUTANIMATIONNAME_OFFSET UNITYSDK_OFFSET(0x108AE7B0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_FADEOUTINTERVAL_OFFSET UNITYSDK_OFFSET(0x108AE820)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_GAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x108AE940)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_ISPLAYINGFADEINANIM_OFFSET UNITYSDK_OFFSET(0x108AE4E0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_ISPLAYINGFADEOUT_OFFSET UNITYSDK_OFFSET(0x108AE4C0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_ITEMFADEINDELAYTIME_OFFSET UNITYSDK_OFFSET(0x108AE720)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_LOGIC_OFFSET UNITYSDK_OFFSET(0x108AE920)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_M_DATAS_OFFSET UNITYSDK_OFFSET(0x108AE9A0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_M_ISDESTROY_OFFSET UNITYSDK_OFFSET(0x108B3560)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_SIMPLEMODE_OFFSET UNITYSDK_OFFSET(0x108AE900)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_SKIPFADEIN_OFFSET UNITYSDK_OFFSET(0x108AE590)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET__DATAMAP_OFFSET UNITYSDK_OFFSET(0x108AE980)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_LATEPLAYITEMANIM_OFFSET UNITYSDK_OFFSET(0x108B29C0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_LATEPLAYPAGESHOWANIMATION_OFFSET UNITYSDK_OFFSET(0x108AF1B0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x108AE550)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_ONINITDATA_OFFSET UNITYSDK_OFFSET(0x108AE500)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_PLAYCELLFADEOUTANIMATION_OFFSET UNITYSDK_OFFSET(0x108B2A80)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_PLAYFADEINANIMATIONWITHOUTEXPAND_OFFSET UNITYSDK_OFFSET(0x108B0BE0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_PLAYFADEINANIMATION_1_OFFSET UNITYSDK_OFFSET(0x108AF260)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_PLAYFADEINANIMATION_2_OFFSET UNITYSDK_OFFSET(0x108AEFC0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_PLAYFADEINANIMATION_3_OFFSET UNITYSDK_OFFSET(0x108B2130)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_PLAYFADEINANIMATION_OFFSET UNITYSDK_OFFSET(0x108AECC0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_PLAYFADEOUTANIMATION_1_OFFSET UNITYSDK_OFFSET(0x108B09E0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_PLAYFADEOUTANIMATION_OFFSET UNITYSDK_OFFSET(0x108AFE90)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_PLAYFADEOUTWITHOUTEXPAND_OFFSET UNITYSDK_OFFSET(0x108B0120)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_RESETUIANIMCELL_OFFSET UNITYSDK_OFFSET(0x108B1790)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_SAMPLEANIMATIONTOSTART_1_OFFSET UNITYSDK_OFFSET(0x108B1890)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_SAMPLEANIMATIONTOSTART_OFFSET UNITYSDK_OFFSET(0x108B32A0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_SETFADEINANIMATIONTOFIRSTFRAMEWITHOUTEXPAND_OFFSET UNITYSDK_OFFSET(0x108AEA60)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_SETFADEINANIMATIONTOFIRSTFRAME_OFFSET UNITYSDK_OFFSET(0x108AE9C0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_SET_ISPLAYINGFADEINANIM_OFFSET UNITYSDK_OFFSET(0x108AE4F0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_SET_ISPLAYINGFADEOUT_OFFSET UNITYSDK_OFFSET(0x108AE4D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_SET_M_ISDESTROY_OFFSET UNITYSDK_OFFSET(0x108B3570)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_STOPANIMATION_OFFSET UNITYSDK_OFFSET(0x108AF2C0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE__CTOR_OFFSET UNITYSDK_OFFSET(0x108AE450)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE__PLAYFADEINANIMATION_B__51_0_OFFSET UNITYSDK_OFFSET(0x108B3580)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE__SHOWNEXTANIMATION_OFFSET UNITYSDK_OFFSET(0x108B2930)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x108B35E0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE___BASE_ONINITDATA_OFFSET UNITYSDK_OFFSET(0x108B3670)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginItemFade_TypeDefinitionIndex = 69946;

class MonoUITableScrollV2_TableScrollPluginItemFade : public ::MonoUITableScrollV2_TableScrollPlugin
{
public:
	::MonoUITableScrollV2_ConfigItemAnim* _config; // 0x18
	::System::Collections::Generic::List_1<::Foundation::Coroutine::CoroutineHandle>* _coroutines; // 0x20
	::System::Boolean _isPlayingFadeOut_k__BackingField; // 0x28
	::System::Boolean _isPlayingFadeInAnim_k__BackingField; // 0x29
	::System::Boolean _m_isDestroy_k__BackingField; // 0x2A
	::System::Single _fadeOutAnimLength; // 0x2C
	::System::Int32 _animOffset; // 0x30
	::System::Single _fadeInAnimLength; // 0x34
