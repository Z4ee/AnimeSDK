...
#define CLASS_1_7EEA5E93C4D09894_GET_BOSSSTAGEID_OFFSET UNITYSDK_OFFSET(0x18E1CDE0)
#define CLASS_1_7EEA5E93C4D09894_GET_CURDEPARTMENTDATA_OFFSET UNITYSDK_OFFSET(0x18E1CE00)
#define CLASS_1_7EEA5E93C4D09894_GET_CURSTAGEDATA_OFFSET UNITYSDK_OFFSET(0x18E1CE40)
#define CLASS_1_7EEA5E93C4D09894_GET_CURSTAGEGROUPDATA_OFFSET UNITYSDK_OFFSET(0x18E1CE20)
#define CLASS_1_7EEA5E93C4D09894_GET_DEPARTMENTDATALIST_OFFSET UNITYSDK_OFFSET(0x18E1CD80)
#define CLASS_1_7EEA5E93C4D09894_GET_LEVELDATA_OFFSET UNITYSDK_OFFSET(0x18E1CE60)
#define CLASS_1_7EEA5E93C4D09894_GET_PLAYERSKILLINFOLIST_OFFSET UNITYSDK_OFFSET(0x18E1CD90)
#define CLASS_1_7EEA5E93C4D09894_GET_PVPMODEDATA_OFFSET UNITYSDK_OFFSET(0x18E1CE80)
#define CLASS_1_7EEA5E93C4D09894_GET_RESIDENTREWARDQUESTINFOS_OFFSET UNITYSDK_OFFSET(0x18E1CDB0)
#define CLASS_1_7EEA5E93C4D09894_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x18E1CE70)
#define CLASS_1_7EEA5E93C4D09894_GET_SUBMISSIONIDLIST_OFFSET UNITYSDK_OFFSET(0x18E1CDA0)
#define CLASS_1_7EEA5E93C4D09894_GET_TUTORIALSTAGEID_OFFSET UNITYSDK_OFFSET(0x18E1CDC0)
#define CLASS_1_7EEA5E93C4D09894_METHOD_1_0BDFAC56E6B704CB_OFFSET UNITYSDK_OFFSET(0x18E1B5D0)
#define CLASS_1_7EEA5E93C4D09894_METHOD_1_0E142E3463F30350_OFFSET UNITYSDK_OFFSET(0x18E1C440)
#define CLASS_1_7EEA5E93C4D09894_METHOD_1_2592BD93B135B397_OFFSET UNITYSDK_OFFSET(0x18E1C6E0)
#define CLASS_1_7EEA5E93C4D09894_METHOD_1_2A8751B8D14F2731_OFFSET UNITYSDK_OFFSET(0x18E1ACD0)
#define CLASS_1_7EEA5E93C4D09894_METHOD_1_2D8B82C4D1E1E4E6_OFFSET UNITYSDK_OFFSET(0x18E1A9B0)
#define CLASS_1_7EEA5E93C4D09894_METHOD_1_4B1A80A7EDD337A2_OFFSET UNITYSDK_OFFSET(0x18E1B030)
#define CLASS_1_7EEA5E93C4D09894_METHOD_1_5AE3519CC07A9919_OFFSET UNITYSDK_OFFSET(0x18E1CA00)
#define CLASS_1_7EEA5E93C4D09894_METHOD_1_65F8314FE9AF8BA8_OFFSET UNITYSDK_OFFSET(0x18E1CF40)
#define CLASS_1_7EEA5E93C4D09894_METHOD_1_7A2F869EA6CEC920_OFFSET UNITYSDK_OFFSET(0x18E1A8B0)
#define CLASS_1_7EEA5E93C4D09894_METHOD_1_809094DEBF13B21A_OFFSET UNITYSDK_OFFSET(0x18E1BF20)
#define CLASS_1_7EEA5E93C4D09894_METHOD_1_8F6B9A1D894B32B4_OFFSET UNITYSDK_OFFSET(0x18E1AB70)
#define CLASS_1_7EEA5E93C4D09894_METHOD_1_9477221A6F70535F_OFFSET UNITYSDK_OFFSET(0x18E1C920)
#define CLASS_1_7EEA5E93C4D09894_METHOD_1_96A53A17AC5D0E93_OFFSET UNITYSDK_OFFSET(0x18E1BB50)
#define CLASS_1_7EEA5E93C4D09894_METHOD_1_98CD66A7F3C102A5_OFFSET UNITYSDK_OFFSET(0x18E1A820)
#define CLASS_1_7EEA5E93C4D09894_METHOD_1_9AB55F553C4AC6E8_OFFSET UNITYSDK_OFFSET(0x18E1B6A0)
#define CLASS_1_7EEA5E93C4D09894_METHOD_1_9F51185C21230666_OFFSET UNITYSDK_OFFSET(0x18E1AE50)
#define CLASS_1_7EEA5E93C4D09894_METHOD_1_A40475C44AA8CEAB_OFFSET UNITYSDK_OFFSET(0x18E1B3C0)
#define CLASS_1_7EEA5E93C4D09894_METHOD_1_AE286FBAF97C7213_OFFSET UNITYSDK_OFFSET(0x18E1CEA0)
#define CLASS_1_7EEA5E93C4D09894_METHOD_1_AF22E162120CD5E6_OFFSET UNITYSDK_OFFSET(0x18E1AF30)
#define CLASS_1_7EEA5E93C4D09894_METHOD_1_B549F04EA33A764B_OFFSET UNITYSDK_OFFSET(0x18E1CB80)
#define CLASS_1_7EEA5E93C4D09894_METHOD_1_B6FE6E81B039A539_OFFSET UNITYSDK_OFFSET(0x18E1AA40)
#define CLASS_1_7EEA5E93C4D09894_METHOD_1_BB881F05E41D3A04_OFFSET UNITYSDK_OFFSET(0x18E1B1C0)
#define CLASS_1_7EEA5E93C4D09894_METHOD_1_D2809205008ACF99_OFFSET UNITYSDK_OFFSET(0x18E1CCD0)
#define CLASS_1_7EEA5E93C4D09894_METHOD_1_E10A809AE075CF77_OFFSET UNITYSDK_OFFSET(0x18E1ADC0)
#define CLASS_1_7EEA5E93C4D09894_METHOD_1_EC2B405D0723571D_OFFSET UNITYSDK_OFFSET(0x18E1C1E0)
#define CLASS_1_7EEA5E93C4D09894_METHOD_1_ECAD7084C2C4F600_OFFSET UNITYSDK_OFFSET(0x18E1C500)
#define CLASS_1_7EEA5E93C4D09894_METHOD_1_F978A1D172468895_OFFSET UNITYSDK_OFFSET(0x18E1BCD0)
#define CLASS_1_7EEA5E93C4D09894_SET_BOSSSTAGEID_OFFSET UNITYSDK_OFFSET(0x18E1CDF0)
#define CLASS_1_7EEA5E93C4D09894_SET_CURDEPARTMENTDATA_OFFSET UNITYSDK_OFFSET(0x18E1CE10)
#define CLASS_1_7EEA5E93C4D09894_SET_CURSTAGEDATA_OFFSET UNITYSDK_OFFSET(0x18E1CE50)
#define CLASS_1_7EEA5E93C4D09894_SET_CURSTAGEGROUPDATA_OFFSET UNITYSDK_OFFSET(0x18E1CE30)
#define CLASS_1_7EEA5E93C4D09894_SET_PVPMODEDATA_OFFSET UNITYSDK_OFFSET(0x18E1CE90)
#define CLASS_1_7EEA5E93C4D09894_SET_TUTORIALSTAGEID_OFFSET UNITYSDK_OFFSET(0x18E1CDD0)
#define CLASS_1_7EEA5E93C4D09894__CTOR_OFFSET UNITYSDK_OFFSET(0x18E1A500)

inline static constexpr unsigned int Class_1_7EEA5E93C4D09894_TypeDefinitionIndex = 78563;
...
public:
	...
	{
		return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_7EEA5E93C4D09894_TypeDefinitionIndex)->GetStaticField(0x40E0);
	}
	::RPG::Client::TeamTowers::TeamTowersLevelData* _LevelData_k__BackingField; // 0x10
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::TeamTowers::TeamTowersBossData*>* LFCOECHKGML; // 0x18
	::System::Collections::Generic::List_1<::Class_1_47CFC2D7B3865B39*>* _PlayerSkillInfoList_k__BackingField; // 0x20
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::TeamTowers::TeamTowersBossData*>* FDDEDGNJOJL; // 0x28
	::System::Collections::Generic::List_1<::RPG::Client::TeamTowers::TeamTowersDepartmentData*>* _DepartmentDataList_k__BackingField; // 0x30
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::TeamTowers::TeamTowersStageGroupData*>* PFGLALLKDOF; // 0x38
	::RPG::Client::TeamTowers::TeamTowersStageData* _CurStageData_k__BackingField; // 0x40
	::System::Collections::Generic::List_1<::Class_1_97E659ED8D5D259C_22*>* _ResidentRewardQuestInfos_k__BackingField; // 0x48
	::Class_1_115297B50AB60A5D_1* _PvpModeData_k__BackingField; // 0x50
	::System::Collections::Generic::List_1<::System::UInt32>* _SubMissionIDList_k__BackingField; // 0x58
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::TeamTowers::TeamTowersRobotData*>* GFLODJLGLNM; // 0x60
	::Class_1_2AE7FBE19C7FFFCD* _Settings_k__BackingField; // 0x68
	::RPG::Client::TeamTowers::TeamTowersStageGroupData* _CurStageGroupData_k__BackingField; // 0x70
	::RPG::Client::TeamTowers::TeamTowersDepartmentData* _CurDepartmentData_k__BackingField; // 0x78
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::TeamTowers::TeamTowersStageData*>* IFNENKLJJML; // 0x80
	::System::UInt32 _BossStageID_k__BackingField; // 0x88
	::System::UInt32 BHMANHGHNNC; // 0x8C
	::System::UInt32 _TutorialStageID_k__BackingField; // 0x90
