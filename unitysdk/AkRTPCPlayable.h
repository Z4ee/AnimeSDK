...
#define AKRTPCPLAYABLE_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1EEEC2D0)
#define AKRTPCPLAYABLE_GET_OWNINGCLIP_OFFSET UNITYSDK_OFFSET(0x1EEEC2A0)
#define AKRTPCPLAYABLE_GET_PARAMETER_OFFSET UNITYSDK_OFFSET(0x1EEEC280)
#define AKRTPCPLAYABLE_SET_OWNINGCLIP_OFFSET UNITYSDK_OFFSET(0x1EEEC2B0)
#define AKRTPCPLAYABLE_SET_PARAMETER_OFFSET UNITYSDK_OFFSET(0x1EEEC290)
#define AKRTPCPLAYABLE_UNITYENGINE_TIMELINE_ITIMELINECLIPASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1EEEC2C0)
#define AKRTPCPLAYABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEEC4E0)

inline static constexpr unsigned int AkRTPCPlayable_TypeDefinitionIndex = 43748;
