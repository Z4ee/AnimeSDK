...
#define RUNTIMESTATSWINDOW_CLEARTEXTURE_OFFSET UNITYSDK_OFFSET(0x19E341C0)
#define RUNTIMESTATSWINDOW_DRAWLINE_OFFSET UNITYSDK_OFFSET(0x19E34DB0)
#define RUNTIMESTATSWINDOW_DRAWWINDOW_OFFSET UNITYSDK_OFFSET(0x19E35290)
#define RUNTIMESTATSWINDOW_ENTITYINFODUMP_OFFSET UNITYSDK_OFFSET(0x19E35DF0)
#define RUNTIMESTATSWINDOW_INITIALIZETEXTURES_OFFSET UNITYSDK_OFFSET(0x19E33FE0)
#define RUNTIMESTATSWINDOW_MAXVALUE_OFFSET UNITYSDK_OFFSET(0x19E36860)
#define RUNTIMESTATSWINDOW_ONGUI_OFFSET UNITYSDK_OFFSET(0x19E351A0)
#define RUNTIMESTATSWINDOW_START_OFFSET UNITYSDK_OFFSET(0x19E33F90)
#define RUNTIMESTATSWINDOW_UPDATEGRAPHTEXTURES_OFFSET UNITYSDK_OFFSET(0x19E348D0)
#define RUNTIMESTATSWINDOW_UPDATEGRAPHTEXTURE_OFFSET UNITYSDK_OFFSET(0x19E34950)
#define RUNTIMESTATSWINDOW_UPDATE_OFFSET UNITYSDK_OFFSET(0x19E34450)
#define RUNTIMESTATSWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0x19E36B80)
#define RUNTIMESTATSWINDOW__ENTITYINFODUMP_G__CHILDSTARTWITHNAME_18_0_OFFSET UNITYSDK_OFFSET(0x19E36950)

inline static constexpr unsigned int RuntimeStatsWindow_TypeDefinitionIndex = 62235;
