...
#define RUNTIMESTATSWINDOW_CLEARTEXTURE_OFFSET UNITYSDK_OFFSET(0x17882780)
#define RUNTIMESTATSWINDOW_DRAWLINE_OFFSET UNITYSDK_OFFSET(0x17883380)
#define RUNTIMESTATSWINDOW_DRAWWINDOW_OFFSET UNITYSDK_OFFSET(0x17883860)
#define RUNTIMESTATSWINDOW_ENTITYINFODUMP_OFFSET UNITYSDK_OFFSET(0x178843C0)
#define RUNTIMESTATSWINDOW_INITIALIZETEXTURES_OFFSET UNITYSDK_OFFSET(0x178825A0)
#define RUNTIMESTATSWINDOW_MAXVALUE_OFFSET UNITYSDK_OFFSET(0x17884E40)
#define RUNTIMESTATSWINDOW_ONGUI_OFFSET UNITYSDK_OFFSET(0x17883770)
#define RUNTIMESTATSWINDOW_START_OFFSET UNITYSDK_OFFSET(0x17882550)
#define RUNTIMESTATSWINDOW_UPDATEGRAPHTEXTURES_OFFSET UNITYSDK_OFFSET(0x17882EA0)
#define RUNTIMESTATSWINDOW_UPDATEGRAPHTEXTURE_OFFSET UNITYSDK_OFFSET(0x17882F20)
#define RUNTIMESTATSWINDOW_UPDATE_OFFSET UNITYSDK_OFFSET(0x17882A10)
#define RUNTIMESTATSWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0x17885160)
#define RUNTIMESTATSWINDOW__ENTITYINFODUMP_G__CHILDSTARTWITHNAME_18_0_OFFSET UNITYSDK_OFFSET(0x17884F30)

inline static constexpr unsigned int RuntimeStatsWindow_TypeDefinitionIndex = 48017;
