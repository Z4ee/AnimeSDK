...
#define CLASS_3_BAF8A020BC857ED2_METHOD_3_0A604A5B360F30A7_OFFSET UNITYSDK_OFFSET(0x16FCC1A0)
#define CLASS_3_BAF8A020BC857ED2__CTOR_OFFSET UNITYSDK_OFFSET(0x16FCBFD0)
#define CLASS_3_BAF8A020BC857ED2__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x16FCC2A0)
#define CLASS_3_BAF8A020BC857ED2__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x16FCC360)

inline static constexpr unsigned int Class_3_BAF8A020BC857ED2_TypeDefinitionIndex = 53743;

class Class_3_BAF8A020BC857ED2 : public ::RPG::GameCore::AdvWaitingTaskBase_1<::RPG::GameCore::WaitPropEventInBattle*>
{
public:
	::System::Int32 OGLJOKAJHNC; // 0x68
