...
#define CLASS_2_5C42A1824BAAD352_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13A58440)
#define CLASS_2_5C42A1824BAAD352_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x13A58480)
#define CLASS_2_5C42A1824BAAD352_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x13A588E0)
#define CLASS_2_5C42A1824BAAD352_TICK_OFFSET UNITYSDK_OFFSET(0x13A58930)
#define CLASS_2_5C42A1824BAAD352__CTOR_OFFSET UNITYSDK_OFFSET(0x13A58370)

inline static constexpr unsigned int Class_2_5C42A1824BAAD352_TypeDefinitionIndex = 52890;

class Class_2_5C42A1824BAAD352 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SetDynamicEntityParam* Field_2_0; // 0x18
