...
#define CLASS_2_5C42A1824BAAD352_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBCDB9E0)
#define CLASS_2_5C42A1824BAAD352_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xBCDBA20)
#define CLASS_2_5C42A1824BAAD352_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xBCDBE80)
#define CLASS_2_5C42A1824BAAD352_TICK_OFFSET UNITYSDK_OFFSET(0xBCDBED0)
#define CLASS_2_5C42A1824BAAD352__CTOR_OFFSET UNITYSDK_OFFSET(0xBCDB910)
...
{
public:
	::RPG::GameCore::SetDynamicEntityParam* OFKGLJOAMLD; // 0x18
