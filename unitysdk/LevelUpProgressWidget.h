...
#define LEVELUPPROGRESSWIDGET_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x13F9AEB0)
#define LEVELUPPROGRESSWIDGET_PROGRESSBARANIM_OFFSET UNITYSDK_OFFSET(0x13F9A3C0)
#define LEVELUPPROGRESSWIDGET_PROGRESSBARMAX_OFFSET UNITYSDK_OFFSET(0x13F9AC70)
#define LEVELUPPROGRESSWIDGET_RESETPROGRESS_OFFSET UNITYSDK_OFFSET(0x13F9AE50)
#define LEVELUPPROGRESSWIDGET_UPDATEPROGRESSMES_OFFSET UNITYSDK_OFFSET(0x13F9ABA0)
#define LEVELUPPROGRESSWIDGET_UPDATEPROGRESS_OFFSET UNITYSDK_OFFSET(0x13F9ACF0)
#define LEVELUPPROGRESSWIDGET__CTOR_OFFSET UNITYSDK_OFFSET(0x13F9AFC0)
#define LEVELUPPROGRESSWIDGET__PROGRESSBARANIM_B__13_0_OFFSET UNITYSDK_OFFSET(0x13F9B020)
#define LEVELUPPROGRESSWIDGET__PROGRESSBARANIM_B__13_2_OFFSET UNITYSDK_OFFSET(0x13F9B030)

inline static constexpr unsigned int LevelUpProgressWidget_TypeDefinitionIndex = 71169;
