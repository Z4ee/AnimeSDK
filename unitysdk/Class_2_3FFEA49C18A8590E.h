...
#define CLASS_2_3FFEA49C18A8590E_METHOD_2_012617F70DD9D7B6_OFFSET UNITYSDK_OFFSET(0x1A7C4C80)
#define CLASS_2_3FFEA49C18A8590E_METHOD_2_022B0D58A3077BF2_OFFSET UNITYSDK_OFFSET(0x1A7C6390)
#define CLASS_2_3FFEA49C18A8590E_METHOD_2_1F0134B562731ABF_OFFSET UNITYSDK_OFFSET(0x1A7C65D0)
#define CLASS_2_3FFEA49C18A8590E_METHOD_2_29169364C61FFEF2_OFFSET UNITYSDK_OFFSET(0x1A7C69D0)
#define CLASS_2_3FFEA49C18A8590E_METHOD_2_30A8BE571FA65949_OFFSET UNITYSDK_OFFSET(0x1A7C4740)
#define CLASS_2_3FFEA49C18A8590E_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x1A7C6930)
#define CLASS_2_3FFEA49C18A8590E_METHOD_2_3CDF6ADA20D8C6EC_OFFSET UNITYSDK_OFFSET(0x1A7C4920)
#define CLASS_2_3FFEA49C18A8590E_METHOD_2_5CB1195CE7AFB965_OFFSET UNITYSDK_OFFSET(0x1A7C6620)
#define CLASS_2_3FFEA49C18A8590E_METHOD_2_6B181DF837608D32_OFFSET UNITYSDK_OFFSET(0x1A7C5E30)
#define CLASS_2_3FFEA49C18A8590E_METHOD_2_96BDC4B57CCFE000_OFFSET UNITYSDK_OFFSET(0x1A7C62E0)
#define CLASS_2_3FFEA49C18A8590E_METHOD_2_A9DAF3FE2888211B_OFFSET UNITYSDK_OFFSET(0x1A7C67F0)
#define CLASS_2_3FFEA49C18A8590E_METHOD_2_BCCEF225A11BDA90_OFFSET UNITYSDK_OFFSET(0x1A7C46D0)
#define CLASS_2_3FFEA49C18A8590E_METHOD_2_BE790DD47B832304_OFFSET UNITYSDK_OFFSET(0x1A7C55A0)
#define CLASS_2_3FFEA49C18A8590E_METHOD_2_CEB324AD021F471A_OFFSET UNITYSDK_OFFSET(0x1A7C5400)
#define CLASS_2_3FFEA49C18A8590E_METHOD_2_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x1A7C6980)
#define CLASS_2_3FFEA49C18A8590E_METHOD_2_E10F3359B5E0D724_OFFSET UNITYSDK_OFFSET(0x1A7C5CA0)
#define CLASS_2_3FFEA49C18A8590E__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7C6C60)
#define CLASS_2_3FFEA49C18A8590E__ONBIND_OFFSET UNITYSDK_OFFSET(0x1A7C45C0)

inline static constexpr unsigned int Class_2_3FFEA49C18A8590E_TypeDefinitionIndex = 71885;

class Class_2_3FFEA49C18A8590E : public ::Class_1_34917908B7833130
{
public:
	// static const ::System::String* EHELEAICPAD; // 0x0
	// static const ::System::String* CDFBFCEGCHE; // 0x0
	// static const ::System::String* EEKKKIACEIL; // 0x0
	::Class_0_16E4307DCC419505_1117* CBIDDFDIPFC; // 0x60
	::RPG::GameCore::BattleInstance* IFKCCHIFMOC; // 0x68
	::Class_0_16E4307DCC419505_1117* GPICOIAFHCF; // 0x70
	::Class_2_AD9AD2C922D82BDD* JPBNFMLIJMI; // 0x78
	::System::Boolean EMFKGGCEIHH; // 0x80
	::System::Boolean CGEIJFBMLLE; // 0x81
	...
	{
		return ((::System::Void(*)(::PVOID, ::RPG::GameCore::AvatarRowData*, ::RPG::GameCore::ICharacterSkillRowData*))((::PBYTE)hIl2Cpp + CLASS_2_3FFEA49C18A8590E_METHOD_2_BE790DD47B832304_OFFSET))(this, a1, a2);
	}
