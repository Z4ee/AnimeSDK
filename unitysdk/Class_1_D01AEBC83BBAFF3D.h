...
#define CLASS_1_D01AEBC83BBAFF3D_GET_AGENDAS_OFFSET UNITYSDK_OFFSET(0x18B68E70)
#define CLASS_1_D01AEBC83BBAFF3D_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x18B68D90)
#define CLASS_1_D01AEBC83BBAFF3D_GET_CURRENTDAY_OFFSET UNITYSDK_OFFSET(0x18B68DD0)
#define CLASS_1_D01AEBC83BBAFF3D_GET_DRIVERID_OFFSET UNITYSDK_OFFSET(0x18B68DF0)
#define CLASS_1_D01AEBC83BBAFF3D_GET_DRIVERS_OFFSET UNITYSDK_OFFSET(0x18B68E30)
#define CLASS_1_D01AEBC83BBAFF3D_GET_FINISHEDMATCHNUM_OFFSET UNITYSDK_OFFSET(0x18B68E50)
#define CLASS_1_D01AEBC83BBAFF3D_GET_PHASE_OFFSET UNITYSDK_OFFSET(0x18B68DB0)
#define CLASS_1_D01AEBC83BBAFF3D_GET_TARGETPARTID_OFFSET UNITYSDK_OFFSET(0x18B68E10)
#define CLASS_1_D01AEBC83BBAFF3D_GET_TEAMS_OFFSET UNITYSDK_OFFSET(0x18B68E90)
#define CLASS_1_D01AEBC83BBAFF3D_METHOD_1_2F821AE85EE61F1A_OFFSET UNITYSDK_OFFSET(0x18B68EB0)
#define CLASS_1_D01AEBC83BBAFF3D_METHOD_1_AA2D3E889C8A52CA_OFFSET UNITYSDK_OFFSET(0x18B68F60)
#define CLASS_1_D01AEBC83BBAFF3D_SET_AGENDAS_OFFSET UNITYSDK_OFFSET(0x18B68E80)
#define CLASS_1_D01AEBC83BBAFF3D_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x18B68DA0)
#define CLASS_1_D01AEBC83BBAFF3D_SET_CURRENTDAY_OFFSET UNITYSDK_OFFSET(0x18B68DE0)
#define CLASS_1_D01AEBC83BBAFF3D_SET_DRIVERID_OFFSET UNITYSDK_OFFSET(0x18B68E00)
#define CLASS_1_D01AEBC83BBAFF3D_SET_DRIVERS_OFFSET UNITYSDK_OFFSET(0x18B68E40)
#define CLASS_1_D01AEBC83BBAFF3D_SET_FINISHEDMATCHNUM_OFFSET UNITYSDK_OFFSET(0x18B68E60)
#define CLASS_1_D01AEBC83BBAFF3D_SET_PHASE_OFFSET UNITYSDK_OFFSET(0x18B68DC0)
#define CLASS_1_D01AEBC83BBAFF3D_SET_TARGETPARTID_OFFSET UNITYSDK_OFFSET(0x18B68E20)
#define CLASS_1_D01AEBC83BBAFF3D_SET_TEAMS_OFFSET UNITYSDK_OFFSET(0x18B68EA0)
#define CLASS_1_D01AEBC83BBAFF3D__CTOR_OFFSET UNITYSDK_OFFSET(0x18B68FB0)
#define CLASS_1_D01AEBC83BBAFF3D__GET_CURRENTAGENDA_B__37_0_OFFSET UNITYSDK_OFFSET(0x18B69050)

inline static constexpr unsigned int Class_1_D01AEBC83BBAFF3D_TypeDefinitionIndex = 80376;

class Class_1_D01AEBC83BBAFF3D : public ::System::Object
{
public:
	::Class_1_EF41A94FBB43C5D7_1* _Config_k__BackingField; // 0x10
	::System::Collections::Generic::List_1<::Class_1_89120A467F7A010D_2*>* _Drivers_k__BackingField; // 0x18
	::System::Collections::Generic::List_1<::Class_1_5452947417BCF16A*>* _Agendas_k__BackingField; // 0x20
	::System::Collections::Generic::List_1<::Class_1_C5CEA8DD589BD643*>* _Teams_k__BackingField; // 0x28
	::System::UInt32 _TargetPartID_k__BackingField; // 0x30
	::System::UInt32 _FinishedMatchNum_k__BackingField; // 0x34
	::System::UInt32 _DriverID_k__BackingField; // 0x38
	::RPG::Client::B51Racing::B51RacingCyclePhase _Phase_k__BackingField; // 0x3C
	::System::UInt32 _CurrentDay_k__BackingField; // 0x40
