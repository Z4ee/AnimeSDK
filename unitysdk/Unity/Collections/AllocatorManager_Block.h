...
#define UNITY_COLLECTIONS_ALLOCATORMANAGER_BLOCK_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA80430)
#define UNITY_COLLECTIONS_ALLOCATORMANAGER_BLOCK_GET_ALIGNMENT_OFFSET UNITYSDK_OFFSET(0xA803E0)
#define UNITY_COLLECTIONS_ALLOCATORMANAGER_BLOCK_GET_BYTES_OFFSET UNITYSDK_OFFSET(0xA803D0)
#define UNITY_COLLECTIONS_ALLOCATORMANAGER_BLOCK_SET_ALIGNMENT_OFFSET UNITYSDK_OFFSET(0xA803F0)
#define UNITY_COLLECTIONS_ALLOCATORMANAGER_BLOCK_TRYFREE_OFFSET UNITYSDK_OFFSET(0xA80550)

namespace Unity::Collections
{
	inline static constexpr unsigned int AllocatorManager_Block_TypeDefinitionIndex = 18452;
