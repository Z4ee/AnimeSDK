...
#define UNITY_COLLECTIONS_ALLOCATORMANAGER_BLOCK_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAD0B70)
#define UNITY_COLLECTIONS_ALLOCATORMANAGER_BLOCK_GET_ALIGNMENT_OFFSET UNITYSDK_OFFSET(0xAD0B20)
#define UNITY_COLLECTIONS_ALLOCATORMANAGER_BLOCK_GET_BYTES_OFFSET UNITYSDK_OFFSET(0xAD0B10)
#define UNITY_COLLECTIONS_ALLOCATORMANAGER_BLOCK_SET_ALIGNMENT_OFFSET UNITYSDK_OFFSET(0xAD0B30)
#define UNITY_COLLECTIONS_ALLOCATORMANAGER_BLOCK_TRYFREE_OFFSET UNITYSDK_OFFSET(0xAD0C90)

namespace Unity::Collections
{
	inline static constexpr unsigned int AllocatorManager_Block_TypeDefinitionIndex = 18858;
