...
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_4_CLEAR_OFFSET UNITYSDK_OFFSET(0x1D41A130)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_4_COUNT_OFFSET UNITYSDK_OFFSET(0x1D41A140)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_4_CREATE_OFFSET UNITYSDK_OFFSET(0x1D41A110)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_4_DESTROY_OFFSET UNITYSDK_OFFSET(0x1D41A120)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_4_INSERTORUPDATE_OFFSET UNITYSDK_OFFSET(0x1D41A160)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_4_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1D41A150)

namespace Unity::Collections::LowLevel::Unsafe
{
	inline static constexpr unsigned int ValueSparseHashMapHelper8_4_TypeDefinitionIndex = 5114;
