...
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_32_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B180B00)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_32_COUNT_OFFSET UNITYSDK_OFFSET(0x1B180B10)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_32_CREATE_OFFSET UNITYSDK_OFFSET(0x1B180AE0)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_32_DESTROY_OFFSET UNITYSDK_OFFSET(0x1B180AF0)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_32_INSERTORUPDATE_OFFSET UNITYSDK_OFFSET(0x1B180B30)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_32_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1B180B20)

namespace Unity::Collections::LowLevel::Unsafe
{
	inline static constexpr unsigned int ValueSparseHashMapHelper8_32_TypeDefinitionIndex = 5113;
