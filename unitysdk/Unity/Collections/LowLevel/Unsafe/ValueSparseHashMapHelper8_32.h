...
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_32_CLEAR_OFFSET UNITYSDK_OFFSET(0x1D5814D0)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_32_COUNT_OFFSET UNITYSDK_OFFSET(0x1D5814E0)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_32_CREATE_OFFSET UNITYSDK_OFFSET(0x1D5814B0)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_32_DESTROY_OFFSET UNITYSDK_OFFSET(0x1D5814C0)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_32_INSERTORUPDATE_OFFSET UNITYSDK_OFFSET(0x1D581500)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_32_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1D5814F0)
