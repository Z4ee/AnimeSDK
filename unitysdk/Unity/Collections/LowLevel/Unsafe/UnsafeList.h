...
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFELIST_CLEAR_OFFSET UNITYSDK_OFFSET(0x9DE930)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFELIST_CREATE_OFFSET UNITYSDK_OFFSET(0x1C501020)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFELIST_DESTROY_OFFSET UNITYSDK_OFFSET(0x1C501200)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFELIST_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9DE920)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFELIST_REALLOC_OFFSET UNITYSDK_OFFSET(0x9DEA00)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFELIST_REMOVERANGESWAPBACK_OFFSET UNITYSDK_OFFSET(0x9DEA70)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFELIST_RESIZE_OFFSET UNITYSDK_OFFSET(0x9DE940)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFELIST_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x9DEA10)

namespace Unity::Collections::LowLevel::Unsafe
{
	inline static constexpr unsigned int UnsafeList_TypeDefinitionIndex = 20171;
