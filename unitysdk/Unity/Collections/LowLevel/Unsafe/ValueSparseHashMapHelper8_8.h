...
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_8_CLEAR_OFFSET UNITYSDK_OFFSET(0x1EB4E2A0)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_8_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x1EB4E2F0)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_8_COUNT_OFFSET UNITYSDK_OFFSET(0x1EB4E2B0)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_8_CREATE_OFFSET UNITYSDK_OFFSET(0x1EB4E280)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_8_DESTROY_OFFSET UNITYSDK_OFFSET(0x1EB4E290)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_8_INSERTORUPDATE_OFFSET UNITYSDK_OFFSET(0x1EB4E2D0)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_8_REMOVE_OFFSET UNITYSDK_OFFSET(0x1EB4E2E0)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_8_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1EB4E2C0)

namespace Unity::Collections::LowLevel::Unsafe
{
	inline static constexpr unsigned int ValueSparseHashMapHelper8_8_TypeDefinitionIndex = 5113;
