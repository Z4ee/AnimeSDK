...
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFEHASHMAPDATA_DEALLOCATEHASHMAP_OFFSET UNITYSDK_OFFSET(0x1FC0D100)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFEHASHMAPDATA_GETBUCKETSIZE_OFFSET UNITYSDK_OFFSET(0x1FC0D0E0)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFEHASHMAPDATA_GROWCAPACITY_OFFSET UNITYSDK_OFFSET(0x1FC0D0F0)

namespace Unity::Collections::LowLevel::Unsafe
{
	inline static constexpr unsigned int UnsafeHashMapData_TypeDefinitionIndex = 18878;
