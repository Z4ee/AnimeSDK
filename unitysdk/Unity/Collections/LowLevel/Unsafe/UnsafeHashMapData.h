...
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFEHASHMAPDATA_DEALLOCATEHASHMAP_OFFSET UNITYSDK_OFFSET(0x1C500FE0)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFEHASHMAPDATA_GETBUCKETSIZE_OFFSET UNITYSDK_OFFSET(0x1C500FC0)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFEHASHMAPDATA_GROWCAPACITY_OFFSET UNITYSDK_OFFSET(0x1C500FD0)

namespace Unity::Collections::LowLevel::Unsafe
{
	inline static constexpr unsigned int UnsafeHashMapData_TypeDefinitionIndex = 20166;
