...
#define UNITY_COLLECTIONS_COLLECTIONHELPER_ALIGN_OFFSET UNITYSDK_OFFSET(0x1C500EE0)
#define UNITY_COLLECTIONS_COLLECTIONHELPER_CEILPOW2_OFFSET UNITYSDK_OFFSET(0x1C500F10)
#define UNITY_COLLECTIONS_COLLECTIONHELPER_LZCNT_1_OFFSET UNITYSDK_OFFSET(0x1C500F80)
#define UNITY_COLLECTIONS_COLLECTIONHELPER_LZCNT_OFFSET UNITYSDK_OFFSET(0x1C500F40)
#define UNITY_COLLECTIONS_COLLECTIONHELPER_SHOULDDEALLOCATE_OFFSET UNITYSDK_OFFSET(0x1C500F00)

namespace Unity::Collections
{
	inline static constexpr unsigned int CollectionHelper_TypeDefinitionIndex = 20150;
