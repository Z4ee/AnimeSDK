...
#define UNITY_COLLECTIONS_NATIVEQUEUEDATA_DEALLOCATEQUEUE_OFFSET UNITYSDK_OFFSET(0x1C501A40)
#define UNITY_COLLECTIONS_NATIVEQUEUEDATA_GETCURRENTWRITEBLOCKTLS_OFFSET UNITYSDK_OFFSET(0x9DEBC0)
#define UNITY_COLLECTIONS_NATIVEQUEUEDATA_SETCURRENTWRITEBLOCKTLS_OFFSET UNITYSDK_OFFSET(0x9DEBD0)

namespace Unity::Collections
{
	inline static constexpr unsigned int NativeQueueData_TypeDefinitionIndex = 20162;
