...
#define UNITY_COLLECTIONS_NATIVEQUEUEDATA_DEALLOCATEQUEUE_OFFSET UNITYSDK_OFFSET(0x1E8346F0)
#define UNITY_COLLECTIONS_NATIVEQUEUEDATA_GETCURRENTWRITEBLOCKTLS_OFFSET UNITYSDK_OFFSET(0xA80930)
#define UNITY_COLLECTIONS_NATIVEQUEUEDATA_SETCURRENTWRITEBLOCKTLS_OFFSET UNITYSDK_OFFSET(0xA80940)

namespace Unity::Collections
{
	inline static constexpr unsigned int NativeQueueData_TypeDefinitionIndex = 18465;
