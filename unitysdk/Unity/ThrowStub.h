...
#define UNITY_THROWSTUB_THROWNOTSUPPORTEDEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1E7C7800)

namespace Unity
{
	inline static constexpr unsigned int ThrowStub_TypeDefinitionIndex = 3912;
