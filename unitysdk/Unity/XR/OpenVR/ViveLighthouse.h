...
#define UNITY_XR_OPENVR_VIVELIGHTHOUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E01A320)

namespace Unity::XR::OpenVR
{
	inline static constexpr unsigned int ViveLighthouse_TypeDefinitionIndex = 31506;
