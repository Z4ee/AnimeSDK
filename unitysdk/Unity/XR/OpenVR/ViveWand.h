...
#define UNITY_XR_OPENVR_VIVEWAND_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1B4DFE10)
#define UNITY_XR_OPENVR_VIVEWAND_GET_DEVICEANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1B4DFDF0)
#define UNITY_XR_OPENVR_VIVEWAND_GET_DEVICEVELOCITY_OFFSET UNITYSDK_OFFSET(0x1B4DFDD0)
#define UNITY_XR_OPENVR_VIVEWAND_GET_GRIPPRESSED_OFFSET UNITYSDK_OFFSET(0x1B4DFCF0)
#define UNITY_XR_OPENVR_VIVEWAND_GET_GRIP_OFFSET UNITYSDK_OFFSET(0x1B4DFCD0)
#define UNITY_XR_OPENVR_VIVEWAND_GET_PRIMARY_OFFSET UNITYSDK_OFFSET(0x1B4DFD10)
#define UNITY_XR_OPENVR_VIVEWAND_GET_TRACKPADPRESSED_OFFSET UNITYSDK_OFFSET(0x1B4DFD30)
#define UNITY_XR_OPENVR_VIVEWAND_GET_TRACKPADTOUCHED_OFFSET UNITYSDK_OFFSET(0x1B4DFD50)
#define UNITY_XR_OPENVR_VIVEWAND_GET_TRACKPAD_OFFSET UNITYSDK_OFFSET(0x1B4DFD70)
#define UNITY_XR_OPENVR_VIVEWAND_GET_TRIGGERPRESSED_OFFSET UNITYSDK_OFFSET(0x1B4DFDB0)
#define UNITY_XR_OPENVR_VIVEWAND_GET_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1B4DFD90)
#define UNITY_XR_OPENVR_VIVEWAND_SET_DEVICEANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1B4DFE00)
#define UNITY_XR_OPENVR_VIVEWAND_SET_DEVICEVELOCITY_OFFSET UNITYSDK_OFFSET(0x1B4DFDE0)
#define UNITY_XR_OPENVR_VIVEWAND_SET_GRIPPRESSED_OFFSET UNITYSDK_OFFSET(0x1B4DFD00)
#define UNITY_XR_OPENVR_VIVEWAND_SET_GRIP_OFFSET UNITYSDK_OFFSET(0x1B4DFCE0)
#define UNITY_XR_OPENVR_VIVEWAND_SET_PRIMARY_OFFSET UNITYSDK_OFFSET(0x1B4DFD20)
#define UNITY_XR_OPENVR_VIVEWAND_SET_TRACKPADPRESSED_OFFSET UNITYSDK_OFFSET(0x1B4DFD40)
#define UNITY_XR_OPENVR_VIVEWAND_SET_TRACKPADTOUCHED_OFFSET UNITYSDK_OFFSET(0x1B4DFD60)
#define UNITY_XR_OPENVR_VIVEWAND_SET_TRACKPAD_OFFSET UNITYSDK_OFFSET(0x1B4DFD80)
#define UNITY_XR_OPENVR_VIVEWAND_SET_TRIGGERPRESSED_OFFSET UNITYSDK_OFFSET(0x1B4DFDC0)
#define UNITY_XR_OPENVR_VIVEWAND_SET_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1B4DFDA0)
#define UNITY_XR_OPENVR_VIVEWAND__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4DFF70)

namespace Unity::XR::OpenVR
{
	inline static constexpr unsigned int ViveWand_TypeDefinitionIndex = 28849;
	...
	public:
		...
		::UnityEngine::InputSystem::Controls::ButtonControl* _primary_k__BackingField; // 0x180
		::UnityEngine::InputSystem::Controls::ButtonControl* _gripPressed_k__BackingField; // 0x188
		::UnityEngine::InputSystem::Controls::Vector3Control* _deviceVelocity_k__BackingField; // 0x190
		::UnityEngine::InputSystem::Controls::Vector2Control* _trackpad_k__BackingField; // 0x198
		::UnityEngine::InputSystem::Controls::AxisControl* _trigger_k__BackingField; // 0x1A0
		::UnityEngine::InputSystem::Controls::ButtonControl* _trackpadTouched_k__BackingField; // 0x1A8
		::UnityEngine::InputSystem::Controls::ButtonControl* _triggerPressed_k__BackingField; // 0x1B0
