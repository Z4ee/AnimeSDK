...
#define UNITY_XR_OPENVR_VIVEWAND_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1D8A60A0)
#define UNITY_XR_OPENVR_VIVEWAND_GET_DEVICEANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1D8A6080)
#define UNITY_XR_OPENVR_VIVEWAND_GET_DEVICEVELOCITY_OFFSET UNITYSDK_OFFSET(0x1D8A6060)
#define UNITY_XR_OPENVR_VIVEWAND_GET_GRIPPRESSED_OFFSET UNITYSDK_OFFSET(0x1D8A5F80)
#define UNITY_XR_OPENVR_VIVEWAND_GET_GRIP_OFFSET UNITYSDK_OFFSET(0x1D8A5F60)
#define UNITY_XR_OPENVR_VIVEWAND_GET_PRIMARY_OFFSET UNITYSDK_OFFSET(0x1D8A5FA0)
#define UNITY_XR_OPENVR_VIVEWAND_GET_TRACKPADPRESSED_OFFSET UNITYSDK_OFFSET(0x1D8A5FC0)
#define UNITY_XR_OPENVR_VIVEWAND_GET_TRACKPADTOUCHED_OFFSET UNITYSDK_OFFSET(0x1D8A5FE0)
#define UNITY_XR_OPENVR_VIVEWAND_GET_TRACKPAD_OFFSET UNITYSDK_OFFSET(0x1D8A6000)
#define UNITY_XR_OPENVR_VIVEWAND_GET_TRIGGERPRESSED_OFFSET UNITYSDK_OFFSET(0x1D8A6040)
#define UNITY_XR_OPENVR_VIVEWAND_GET_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1D8A6020)
#define UNITY_XR_OPENVR_VIVEWAND_SET_DEVICEANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1D8A6090)
#define UNITY_XR_OPENVR_VIVEWAND_SET_DEVICEVELOCITY_OFFSET UNITYSDK_OFFSET(0x1D8A6070)
#define UNITY_XR_OPENVR_VIVEWAND_SET_GRIPPRESSED_OFFSET UNITYSDK_OFFSET(0x1D8A5F90)
#define UNITY_XR_OPENVR_VIVEWAND_SET_GRIP_OFFSET UNITYSDK_OFFSET(0x1D8A5F70)
#define UNITY_XR_OPENVR_VIVEWAND_SET_PRIMARY_OFFSET UNITYSDK_OFFSET(0x1D8A5FB0)
#define UNITY_XR_OPENVR_VIVEWAND_SET_TRACKPADPRESSED_OFFSET UNITYSDK_OFFSET(0x1D8A5FD0)
#define UNITY_XR_OPENVR_VIVEWAND_SET_TRACKPADTOUCHED_OFFSET UNITYSDK_OFFSET(0x1D8A5FF0)
#define UNITY_XR_OPENVR_VIVEWAND_SET_TRACKPAD_OFFSET UNITYSDK_OFFSET(0x1D8A6010)
#define UNITY_XR_OPENVR_VIVEWAND_SET_TRIGGERPRESSED_OFFSET UNITYSDK_OFFSET(0x1D8A6050)
#define UNITY_XR_OPENVR_VIVEWAND_SET_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1D8A6030)
#define UNITY_XR_OPENVR_VIVEWAND__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8A6200)

namespace Unity::XR::OpenVR
{
	inline static constexpr unsigned int ViveWand_TypeDefinitionIndex = 31505;
	...
	public:
		...
		::UnityEngine::InputSystem::Controls::AxisControl* _trigger_k__BackingField; // 0x180
		::UnityEngine::InputSystem::Controls::ButtonControl* _trackpadTouched_k__BackingField; // 0x188
		...
		::UnityEngine::InputSystem::Controls::Vector2Control* _trackpad_k__BackingField; // 0x1B0
		::UnityEngine::InputSystem::Controls::ButtonControl* _gripPressed_k__BackingField; // 0x1B8
		::UnityEngine::InputSystem::Controls::ButtonControl* _trackpadPressed_k__BackingField; // 0x1C0
