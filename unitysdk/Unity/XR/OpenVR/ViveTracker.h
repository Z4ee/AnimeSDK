...
#define UNITY_XR_OPENVR_VIVETRACKER_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1EB3FD20)
#define UNITY_XR_OPENVR_VIVETRACKER_GET_DEVICEANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1EB3FD00)
#define UNITY_XR_OPENVR_VIVETRACKER_GET_DEVICEVELOCITY_OFFSET UNITYSDK_OFFSET(0x1EB3FCE0)
#define UNITY_XR_OPENVR_VIVETRACKER_SET_DEVICEANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1EB3FD10)
#define UNITY_XR_OPENVR_VIVETRACKER_SET_DEVICEVELOCITY_OFFSET UNITYSDK_OFFSET(0x1EB3FCF0)
#define UNITY_XR_OPENVR_VIVETRACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EB3FD90)

namespace Unity::XR::OpenVR
{
	inline static constexpr unsigned int ViveTracker_TypeDefinitionIndex = 32127;
