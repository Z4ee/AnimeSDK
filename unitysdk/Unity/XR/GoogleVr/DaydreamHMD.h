...
#define UNITY_XR_GOOGLEVR_DAYDREAMHMD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4DFCA0)

namespace Unity::XR::GoogleVr
{
	inline static constexpr unsigned int DaydreamHMD_TypeDefinitionIndex = 28860;
