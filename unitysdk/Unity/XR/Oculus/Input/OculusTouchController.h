...
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1B986920)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_GET_DEVICEACCELERATION_OFFSET UNITYSDK_OFFSET(0x1B9868E0)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_GET_DEVICEANGULARACCELERATION_OFFSET UNITYSDK_OFFSET(0x1B986900)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_GET_DEVICEANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1B9868C0)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_GET_DEVICEVELOCITY_OFFSET UNITYSDK_OFFSET(0x1B9868A0)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_GET_GRIPPRESSED_OFFSET UNITYSDK_OFFSET(0x1B9867A0)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_GET_GRIP_OFFSET UNITYSDK_OFFSET(0x1B986740)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_GET_PRIMARYBUTTON_OFFSET UNITYSDK_OFFSET(0x1B986760)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_GET_PRIMARYTOUCHED_OFFSET UNITYSDK_OFFSET(0x1B986800)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_GET_SECONDARYBUTTON_OFFSET UNITYSDK_OFFSET(0x1B986780)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_GET_SECONDARYTOUCHED_OFFSET UNITYSDK_OFFSET(0x1B986820)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_GET_START_OFFSET UNITYSDK_OFFSET(0x1B9867C0)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_GET_THUMBSTICKCLICKED_OFFSET UNITYSDK_OFFSET(0x1B9867E0)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_GET_THUMBSTICKTOUCHED_OFFSET UNITYSDK_OFFSET(0x1B986880)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_GET_THUMBSTICK_OFFSET UNITYSDK_OFFSET(0x1B986700)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_GET_TRIGGERPRESSED_OFFSET UNITYSDK_OFFSET(0x1B986860)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_GET_TRIGGERTOUCHED_OFFSET UNITYSDK_OFFSET(0x1B986840)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_GET_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1B986720)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_SET_DEVICEACCELERATION_OFFSET UNITYSDK_OFFSET(0x1B9868F0)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_SET_DEVICEANGULARACCELERATION_OFFSET UNITYSDK_OFFSET(0x1B986910)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_SET_DEVICEANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1B9868D0)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_SET_DEVICEVELOCITY_OFFSET UNITYSDK_OFFSET(0x1B9868B0)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_SET_GRIPPRESSED_OFFSET UNITYSDK_OFFSET(0x1B9867B0)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_SET_GRIP_OFFSET UNITYSDK_OFFSET(0x1B986750)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_SET_PRIMARYBUTTON_OFFSET UNITYSDK_OFFSET(0x1B986770)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_SET_PRIMARYTOUCHED_OFFSET UNITYSDK_OFFSET(0x1B986810)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_SET_SECONDARYBUTTON_OFFSET UNITYSDK_OFFSET(0x1B986790)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_SET_SECONDARYTOUCHED_OFFSET UNITYSDK_OFFSET(0x1B986830)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_SET_START_OFFSET UNITYSDK_OFFSET(0x1B9867D0)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_SET_THUMBSTICKCLICKED_OFFSET UNITYSDK_OFFSET(0x1B9867F0)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_SET_THUMBSTICKTOUCHED_OFFSET UNITYSDK_OFFSET(0x1B986890)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_SET_THUMBSTICK_OFFSET UNITYSDK_OFFSET(0x1B986710)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_SET_TRIGGERPRESSED_OFFSET UNITYSDK_OFFSET(0x1B986870)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_SET_TRIGGERTOUCHED_OFFSET UNITYSDK_OFFSET(0x1B986850)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER_SET_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1B986730)
#define UNITY_XR_OCULUS_INPUT_OCULUSTOUCHCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B986B50)

namespace Unity::XR::Oculus::Input
{
	inline static constexpr unsigned int OculusTouchController_TypeDefinitionIndex = 28855;

	class OculusTouchController : public ::UnityEngine::InputSystem::XR::XRControllerWithRumble
	{
	public:
		::UnityEngine::InputSystem::Controls::ButtonControl* _secondaryButton_k__BackingField; // 0x178
		::UnityEngine::InputSystem::Controls::ButtonControl* _primaryButton_k__BackingField; // 0x180
		...
		::UnityEngine::InputSystem::Controls::ButtonControl* _thumbstickClicked_k__BackingField; // 0x198
		...
		::UnityEngine::InputSystem::Controls::ButtonControl* _primaryTouched_k__BackingField; // 0x1B0
		::UnityEngine::InputSystem::Controls::Vector2Control* _thumbstick_k__BackingField; // 0x1B8
		::UnityEngine::InputSystem::Controls::ButtonControl* _thumbstickTouched_k__BackingField; // 0x1C0
		::UnityEngine::InputSystem::Controls::ButtonControl* _triggerPressed_k__BackingField; // 0x1C8
		::UnityEngine::InputSystem::Controls::AxisControl* _triggerTouched_k__BackingField; // 0x1D0
		::UnityEngine::InputSystem::Controls::ButtonControl* _gripPressed_k__BackingField; // 0x1D8
		::UnityEngine::InputSystem::Controls::ButtonControl* _start_k__BackingField; // 0x1E0
		::UnityEngine::InputSystem::Controls::Vector3Control* _deviceAcceleration_k__BackingField; // 0x1E8
		::UnityEngine::InputSystem::Controls::Vector3Control* _deviceAngularVelocity_k__BackingField; // 0x1F0
		::UnityEngine::InputSystem::Controls::ButtonControl* _secondaryTouched_k__BackingField; // 0x1F8
