...
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPMETHODIMPLATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8867B0)

namespace Unity::IL2CPP::CompilerServices
{
	inline static constexpr unsigned int Il2CppMethodImplAttribute_TypeDefinitionIndex = 6973;
