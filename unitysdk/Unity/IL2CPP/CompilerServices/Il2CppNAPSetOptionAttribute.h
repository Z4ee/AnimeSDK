...
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPNAPSETOPTIONATTRIBUTE_GET_OPTION_OFFSET UNITYSDK_OFFSET(0x191D4740)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPNAPSETOPTIONATTRIBUTE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x191D4760)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPNAPSETOPTIONATTRIBUTE_SET_OPTION_OFFSET UNITYSDK_OFFSET(0x191D4750)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPNAPSETOPTIONATTRIBUTE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x191D4770)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPNAPSETOPTIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x191D4780)

namespace Unity::IL2CPP::CompilerServices
{
	inline static constexpr unsigned int Il2CppNAPSetOptionAttribute_TypeDefinitionIndex = 9501;
