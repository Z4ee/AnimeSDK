...
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPINTRINSICS_ADDGCEVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1E886790)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPINTRINSICS_FASTCREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1E886730)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPINTRINSICS_GETCURRENTMETHODRID_OFFSET UNITYSDK_OFFSET(0x1E886770)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPINTRINSICS_GETGCMARKTHREADIDS_OFFSET UNITYSDK_OFFSET(0x1E886780)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPINTRINSICS_GETTYPEHANDLE_OFFSET UNITYSDK_OFFSET(0x1E8866F0)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPINTRINSICS_LIKELY_OFFSET UNITYSDK_OFFSET(0x1E8866D0)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPINTRINSICS_REMOVEGCEVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1E8867A0)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPINTRINSICS_UNLIKELY_OFFSET UNITYSDK_OFFSET(0x1E8866E0)

namespace Unity::IL2CPP::CompilerServices
{
	inline static constexpr unsigned int Il2CppIntrinsics_TypeDefinitionIndex = 6959;
