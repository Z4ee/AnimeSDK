...
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPINTRINSICCASTTYPEATTRIBUTE_GET_NATIVETYPE_OFFSET UNITYSDK_OFFSET(0x1E886650)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPINTRINSICCASTTYPEATTRIBUTE_SET_NATIVETYPE_OFFSET UNITYSDK_OFFSET(0x1E886660)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPINTRINSICCASTTYPEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E886670)

namespace Unity::IL2CPP::CompilerServices
{
	inline static constexpr unsigned int Il2CppIntrinsicCastTypeAttribute_TypeDefinitionIndex = 6976;
