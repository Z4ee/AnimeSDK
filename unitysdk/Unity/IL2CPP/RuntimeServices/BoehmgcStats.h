...
#define UNITY_IL2CPP_RUNTIMESERVICES_BOEHMGCSTATS_ENABLEMAXHBLKONEXPAND_OFFSET UNITYSDK_OFFSET(0x1E8868C0)
#define UNITY_IL2CPP_RUNTIMESERVICES_BOEHMGCSTATS_GETGCCOLLECTMEMORYINFO_OFFSET UNITYSDK_OFFSET(0x1E886850)
#define UNITY_IL2CPP_RUNTIMESERVICES_BOEHMGCSTATS_GETGCCOLLECTTIMEINFO_OFFSET UNITYSDK_OFFSET(0x1E886840)
#define UNITY_IL2CPP_RUNTIMESERVICES_BOEHMGCSTATS_GETGCEVENTCAPACITY_OFFSET UNITYSDK_OFFSET(0x1E886830)
#define UNITY_IL2CPP_RUNTIMESERVICES_BOEHMGCSTATS_GETGCEVENTCOUNTER_OFFSET UNITYSDK_OFFSET(0x1E886810)
#define UNITY_IL2CPP_RUNTIMESERVICES_BOEHMGCSTATS_GETGCEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1E886820)
#define UNITY_IL2CPP_RUNTIMESERVICES_BOEHMGCSTATS_GETGCEXPANDINFO_OFFSET UNITYSDK_OFFSET(0x1E886860)
#define UNITY_IL2CPP_RUNTIMESERVICES_BOEHMGCSTATS_GETGCMALLOCEXCESSIVESTACKSTR_OFFSET UNITYSDK_OFFSET(0x1E886870)
#define UNITY_IL2CPP_RUNTIMESERVICES_BOEHMGCSTATS_SETMALLOCEXCESSIVETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1E8868B0)

namespace Unity::IL2CPP::RuntimeServices
{
	inline static constexpr unsigned int BoehmgcStats_TypeDefinitionIndex = 6961;
