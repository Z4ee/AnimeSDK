...
#define UNITY_IL2CPP_RUNTIMESERVICES_IL2CPPCODESWITCH_CLEAR_OFFSET UNITYSDK_OFFSET(0x1FC65BB0)
#define UNITY_IL2CPP_RUNTIMESERVICES_IL2CPPCODESWITCH_ISENABLED_OFFSET UNITYSDK_OFFSET(0x1FC65BA0)
#define UNITY_IL2CPP_RUNTIMESERVICES_IL2CPPCODESWITCH_REMOVE_OFFSET UNITYSDK_OFFSET(0x1FC65B90)
#define UNITY_IL2CPP_RUNTIMESERVICES_IL2CPPCODESWITCH_SET_OFFSET UNITYSDK_OFFSET(0x1FC65B80)

namespace Unity::IL2CPP::RuntimeServices
{
	inline static constexpr unsigned int Il2CppCodeSwitch_TypeDefinitionIndex = 6978;
