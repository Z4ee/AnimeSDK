...
#define UNITY_IL2CPP_RUNTIMESERVICES_IL2CPPCODESWITCH_CLEAR_OFFSET UNITYSDK_OFFSET(0x1C5573F0)
#define UNITY_IL2CPP_RUNTIMESERVICES_IL2CPPCODESWITCH_ISENABLED_OFFSET UNITYSDK_OFFSET(0x1C5573E0)
#define UNITY_IL2CPP_RUNTIMESERVICES_IL2CPPCODESWITCH_REMOVE_OFFSET UNITYSDK_OFFSET(0x1C5573D0)
#define UNITY_IL2CPP_RUNTIMESERVICES_IL2CPPCODESWITCH_SET_OFFSET UNITYSDK_OFFSET(0x1C5573C0)

namespace Unity::IL2CPP::RuntimeServices
{
	inline static constexpr unsigned int Il2CppCodeSwitch_TypeDefinitionIndex = 6825;
