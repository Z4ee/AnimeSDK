...
#define UNITY_PROFILING_PROFILERMARKERWITHINTDATA_BEGIN_OFFSET UNITYSDK_OFFSET(0x387DB50)
#define UNITY_PROFILING_PROFILERMARKERWITHINTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1B277220)
#define UNITY_PROFILING_PROFILERMARKERWITHINTDATA_END_OFFSET UNITYSDK_OFFSET(0x387DB30)

namespace Unity::Profiling
{
	inline static constexpr unsigned int ProfilerMarkerWithIntData_TypeDefinitionIndex = 3936;
