...
#define UNITY_PROFILING_PROFILERMARKERWITHINTDATA_BEGIN_OFFSET UNITYSDK_OFFSET(0x22E1680)
#define UNITY_PROFILING_PROFILERMARKERWITHINTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1A423FD0)
#define UNITY_PROFILING_PROFILERMARKERWITHINTDATA_END_OFFSET UNITYSDK_OFFSET(0x22E1660)

namespace Unity::Profiling
{
	inline static constexpr unsigned int ProfilerMarkerWithIntData_TypeDefinitionIndex = 3762;
