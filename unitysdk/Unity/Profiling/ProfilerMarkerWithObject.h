...
#define UNITY_PROFILING_PROFILERMARKERWITHOBJECT_BEGIN_OFFSET UNITYSDK_OFFSET(0x3AC3580)
#define UNITY_PROFILING_PROFILERMARKERWITHOBJECT_CREATE_OFFSET UNITYSDK_OFFSET(0x1C4C9BA0)
#define UNITY_PROFILING_PROFILERMARKERWITHOBJECT_END_OFFSET UNITYSDK_OFFSET(0x3AC3450)

namespace Unity::Profiling
{
	inline static constexpr unsigned int ProfilerMarkerWithObject_TypeDefinitionIndex = 3941;
