...
#define UNITY_PROFILING_PROFILERMARKERWITHOBJECT_BEGIN_OFFSET UNITYSDK_OFFSET(0x3BB5CD0)
#define UNITY_PROFILING_PROFILERMARKERWITHOBJECT_CREATE_OFFSET UNITYSDK_OFFSET(0x1ED04E20)
#define UNITY_PROFILING_PROFILERMARKERWITHOBJECT_END_OFFSET UNITYSDK_OFFSET(0x3BB5BA0)

namespace Unity::Profiling
{
	inline static constexpr unsigned int ProfilerMarkerWithObject_TypeDefinitionIndex = 3949;
