...
#define UNITY_LINQ_GAMEOBJECTEXTENSIONS_CHILDRENENUMERABLE_ENUMERATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define UNITY_LINQ_GAMEOBJECTEXTENSIONS_CHILDRENENUMERABLE_ENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x2BBFE0)
#define UNITY_LINQ_GAMEOBJECTEXTENSIONS_CHILDRENENUMERABLE_ENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xADDF60)
#define UNITY_LINQ_GAMEOBJECTEXTENSIONS_CHILDRENENUMERABLE_ENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xADDFE0)
#define UNITY_LINQ_GAMEOBJECTEXTENSIONS_CHILDRENENUMERABLE_ENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x2BBFE0)
#define UNITY_LINQ_GAMEOBJECTEXTENSIONS_CHILDRENENUMERABLE_ENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xADDF10)

namespace Unity::Linq
{
	inline static constexpr unsigned int GameObjectExtensions_ChildrenEnumerable_Enumerator_TypeDefinitionIndex = 35308;
