...
#define UNITY_JOBS_LOWLEVEL_UNSAFE_FOREACHJOBDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E7BF260)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_FOREACHJOBDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E7BF310)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_FOREACHJOBDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E7BEF30)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_FOREACHJOBDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7BEF10)

namespace Unity::Jobs::LowLevel::Unsafe
{
	inline static constexpr unsigned int ForeachJobDelegate_TypeDefinitionIndex = 5073;
