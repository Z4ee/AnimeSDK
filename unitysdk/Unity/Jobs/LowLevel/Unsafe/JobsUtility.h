...
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_COMBINEJOBSWITHHANDLEINFO_OFFSET UNITYSDK_OFFSET(0x1EB5C0B0)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_COMBINEJOBSWITHJOBID_OFFSET UNITYSDK_OFFSET(0x1EB5C0C0)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_COMPLETE_OFFSET UNITYSDK_OFFSET(0x1EB5C0D0)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_CREATEJOBREFLECTIONDATA_1_OFFSET UNITYSDK_OFFSET(0x1EB5BFB0)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_CREATEJOBREFLECTIONDATA_2_OFFSET UNITYSDK_OFFSET(0x1EB5BFE0)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_CREATEJOBREFLECTIONDATA_OFFSET UNITYSDK_OFFSET(0x1EB5BFA0)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_GETJOBQUEUEWORKERTHREADCOUNT_OFFSET UNITYSDK_OFFSET(0x1EB5C050)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_GETJOBRANGE_OFFSET UNITYSDK_OFFSET(0x1EB5BDC0)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_GETWORKSTEALINGRANGE_OFFSET UNITYSDK_OFFSET(0x1EB5BDE0)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_GET_ISEXECUTINGJOB_OFFSET UNITYSDK_OFFSET(0x1EB5C000)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_GET_JOBCOMPILERENABLED_OFFSET UNITYSDK_OFFSET(0x1EB5C030)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_GET_JOBDEBUGGERENABLED_OFFSET UNITYSDK_OFFSET(0x1EB5C010)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_GET_JOBWORKERCOUNT_OFFSET UNITYSDK_OFFSET(0x1EB5C120)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_GET_JOBWORKERMAXIMUMCOUNT_OFFSET UNITYSDK_OFFSET(0x1EB5C100)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_ISCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1EB5C0E0)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_PATCHBUFFERMINMAXRANGES_OFFSET UNITYSDK_OFFSET(0x1EB5BF90)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_REGISTERFOREACHTHREADDELEGATE_OFFSET UNITYSDK_OFFSET(0x1EB5C080)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_REGISTERTHREADDELEGATES_OFFSET UNITYSDK_OFFSET(0x1EB5C090)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_REGISTERTHREADDELEGATE_OFFSET UNITYSDK_OFFSET(0x1EB5C070)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_REGISTERTHREADFUNCTIONPTR_OFFSET UNITYSDK_OFFSET(0x1EB5C060)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_RESETJOBWORKERCOUNT_OFFSET UNITYSDK_OFFSET(0x1EB5C110)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_SCHEDULEPARALLELFORDEFERARRAYSIZE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EB5BEE0)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_SCHEDULEPARALLELFORDEFERARRAYSIZE_OFFSET UNITYSDK_OFFSET(0x1EB5BE90)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_SCHEDULEPARALLELFORTRANSFORMREADONLY_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EB5BF80)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_SCHEDULEPARALLELFORTRANSFORMREADONLY_OFFSET UNITYSDK_OFFSET(0x1EB5BF40)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_SCHEDULEPARALLELFORTRANSFORM_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EB5BF30)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_SCHEDULEPARALLELFORTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1EB5BEF0)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_SCHEDULEPARALLELFOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EB5BE80)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_SCHEDULEPARALLELFOR_OFFSET UNITYSDK_OFFSET(0x1EB5BE40)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_SCHEDULE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1EB5BE30)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_SCHEDULE_OFFSET UNITYSDK_OFFSET(0x1EB5BDF0)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_SETJOBQUEUEMAXIMUMACTIVETHREADCOUNT_OFFSET UNITYSDK_OFFSET(0x1EB5C0F0)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_SET_JOBCOMPILERENABLED_OFFSET UNITYSDK_OFFSET(0x1EB5C040)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_SET_JOBDEBUGGERENABLED_OFFSET UNITYSDK_OFFSET(0x1EB5C020)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_SET_JOBWORKERCOUNT_OFFSET UNITYSDK_OFFSET(0x1EB5C130)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_UNREGISTERLOWPRIORITYFUNCPTRS_OFFSET UNITYSDK_OFFSET(0x1EB5C0A0)
