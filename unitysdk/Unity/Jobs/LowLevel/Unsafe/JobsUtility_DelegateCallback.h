...
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_DELEGATECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B739EA0)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_DELEGATECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B739F10)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_DELEGATECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B739BA0)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBSUTILITY_DELEGATECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B739B90)

namespace Unity::Jobs::LowLevel::Unsafe
{
	inline static constexpr unsigned int JobsUtility_DelegateCallback_TypeDefinitionIndex = 5076;
