...
#define UNITY_JOBS_JOBHANDLE_COMBINEDEPENDENCIESINTERNAL2_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D72A940)
#define UNITY_JOBS_JOBHANDLE_COMBINEDEPENDENCIESINTERNAL2_OFFSET UNITYSDK_OFFSET(0x1D72A840)
#define UNITY_JOBS_JOBHANDLE_COMBINEDEPENDENCIESINTERNALPTR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D72A950)
#define UNITY_JOBS_JOBHANDLE_COMBINEDEPENDENCIESINTERNALPTR_OFFSET UNITYSDK_OFFSET(0x1D72A8C0)
#define UNITY_JOBS_JOBHANDLE_COMBINEDEPENDENCIES_1_OFFSET UNITYSDK_OFFSET(0x1D72A880)
#define UNITY_JOBS_JOBHANDLE_COMBINEDEPENDENCIES_2_OFFSET UNITYSDK_OFFSET(0x1D72A900)
#define UNITY_JOBS_JOBHANDLE_COMBINEDEPENDENCIES_OFFSET UNITYSDK_OFFSET(0x1D72A800)
#define UNITY_JOBS_JOBHANDLE_COMPLETEALL_OFFSET UNITYSDK_OFFSET(0x1D72A7A0)
#define UNITY_JOBS_JOBHANDLE_COMPLETE_OFFSET UNITYSDK_OFFSET(0xA08560)
#define UNITY_JOBS_JOBHANDLE_GET_ISCOMPLETED_OFFSET UNITYSDK_OFFSET(0xA08580)
#define UNITY_JOBS_JOBHANDLE_SCHEDULEBATCHEDJOBSANDCOMPLETEALL_OFFSET UNITYSDK_OFFSET(0x1D72A7C0)
#define UNITY_JOBS_JOBHANDLE_SCHEDULEBATCHEDJOBSANDCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1D72A790)
#define UNITY_JOBS_JOBHANDLE_SCHEDULEBATCHEDJOBSANDISCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1D72A7E0)
#define UNITY_JOBS_JOBHANDLE_SCHEDULEBATCHEDJOBS_OFFSET UNITYSDK_OFFSET(0x1D72A7F0)
