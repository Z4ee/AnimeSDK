...
#define CLASS_2_BAE91023EDD5B154_DISPOSE_OFFSET UNITYSDK_OFFSET(0x185C7770)
#define CLASS_2_BAE91023EDD5B154_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x185C7860)
#define CLASS_2_BAE91023EDD5B154_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x185C77B0)
#define CLASS_2_BAE91023EDD5B154_TICK_OFFSET UNITYSDK_OFFSET(0x185C7800)
#define CLASS_2_BAE91023EDD5B154__CTOR_OFFSET UNITYSDK_OFFSET(0x185C7760)

inline static constexpr unsigned int Class_2_BAE91023EDD5B154_TypeDefinitionIndex = 53127;

class Class_2_BAE91023EDD5B154 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::StackRedStance* Field_2_1; // 0x20
