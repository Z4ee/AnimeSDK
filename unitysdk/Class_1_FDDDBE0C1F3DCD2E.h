...
#define CLASS_1_FDDDBE0C1F3DCD2E_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DF54240)
#define CLASS_1_FDDDBE0C1F3DCD2E_CLONE_OFFSET UNITYSDK_OFFSET(0x1DF53D40)
#define CLASS_1_FDDDBE0C1F3DCD2E_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DF53E10)
#define CLASS_1_FDDDBE0C1F3DCD2E_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DF53DB0)
#define CLASS_1_FDDDBE0C1F3DCD2E_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DF54020)
#define CLASS_1_FDDDBE0C1F3DCD2E_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DF54460)
#define CLASS_1_FDDDBE0C1F3DCD2E_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DF543A0)
#define CLASS_1_FDDDBE0C1F3DCD2E_METHOD_1_2ACF2A61FB239D23_OFFSET UNITYSDK_OFFSET(0x1DF53D90)
#define CLASS_1_FDDDBE0C1F3DCD2E_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1DF53B40)
#define CLASS_1_FDDDBE0C1F3DCD2E_METHOD_1_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x1DF53DA0)
#define CLASS_1_FDDDBE0C1F3DCD2E_METHOD_1_AA935885E31AA701_OFFSET UNITYSDK_OFFSET(0x1DF53D10)
#define CLASS_1_FDDDBE0C1F3DCD2E_METHOD_1_EA1C8FD1B81E659E_OFFSET UNITYSDK_OFFSET(0x1DF53C90)
#define CLASS_1_FDDDBE0C1F3DCD2E_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DF53BA0)
#define CLASS_1_FDDDBE0C1F3DCD2E_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DF540D0)
#define CLASS_1_FDDDBE0C1F3DCD2E_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DF54130)
#define CLASS_1_FDDDBE0C1F3DCD2E__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DF545E0)
#define CLASS_1_FDDDBE0C1F3DCD2E__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DF53BC0)
#define CLASS_1_FDDDBE0C1F3DCD2E__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF53BB0)

inline static constexpr unsigned int Class_1_FDDDBE0C1F3DCD2E_TypeDefinitionIndex = 31123;

class Class_1_FDDDBE0C1F3DCD2E : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_FDDDBE0C1F3DCD2E*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_FDDDBE0C1F3DCD2E*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_FDDDBE0C1F3DCD2E_TypeDefinitionIndex)->GetStaticField(0x20D70);
	}
	// static const ::System::Int32 GEBBMPNOOFD = 0x7; // 0x0
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x10
	::System::Object* JEFEMOPFJOP; // 0x18
	::Class_1_FDDDBE0C1F3DCD2E_Enum_3_2E741879C8CDBAFC_15 NPIBMNININN; // 0x20
