...
#define AKPS4SETTINGS_GETADVANCEDSETTINGS_OFFSET UNITYSDK_OFFSET(0x1EEE4F50)
#define AKPS4SETTINGS_GETCOMMSSETTINGS_OFFSET UNITYSDK_OFFSET(0x1EEE4F90)
#define AKPS4SETTINGS_GETUSERSETTINGS_OFFSET UNITYSDK_OFFSET(0x1EEE4F10)
#define AKPS4SETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEE4D80)
