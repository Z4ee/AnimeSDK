...
#define AKPS4SETTINGS_GETADVANCEDSETTINGS_OFFSET UNITYSDK_OFFSET(0x1BD6D410)
#define AKPS4SETTINGS_GETCOMMSSETTINGS_OFFSET UNITYSDK_OFFSET(0x1BD6D450)
#define AKPS4SETTINGS_GETUSERSETTINGS_OFFSET UNITYSDK_OFFSET(0x1BD6D3D0)
#define AKPS4SETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD6D240)

inline static constexpr unsigned int AkPS4Settings_TypeDefinitionIndex = 42092;
