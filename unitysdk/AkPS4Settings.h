...
#define AKPS4SETTINGS_GETADVANCEDSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A6022E0)
#define AKPS4SETTINGS_GETCOMMSSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A602320)
#define AKPS4SETTINGS_GETUSERSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A6022A0)
#define AKPS4SETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A602110)

inline static constexpr unsigned int AkPS4Settings_TypeDefinitionIndex = 40450;
