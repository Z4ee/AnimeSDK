...
#define AKPS4SETTINGS_GETADVANCEDSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B44CB60)
#define AKPS4SETTINGS_GETCOMMSSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B44CBA0)
#define AKPS4SETTINGS_GETUSERSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B44CB20)
#define AKPS4SETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B44C990)

inline static constexpr unsigned int AkPS4Settings_TypeDefinitionIndex = 41277;
