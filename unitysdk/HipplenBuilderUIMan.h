...
#define HIPPLENBUILDERUIMAN_CLOSEBEHAVIORPANEL_OFFSET UNITYSDK_OFFSET(0x10C2B110)
#define HIPPLENBUILDERUIMAN_CLOSEBUFFSELECTIONPANEL_OFFSET UNITYSDK_OFFSET(0x10C29EB0)
#define HIPPLENBUILDERUIMAN_CLOSEENDDAYPANEL_OFFSET UNITYSDK_OFFSET(0x10C297E0)
#define HIPPLENBUILDERUIMAN_CLOSETAKETESTPANEL_OFFSET UNITYSDK_OFFSET(0x10C29E40)
#define HIPPLENBUILDERUIMAN_CLOSETRANINGBLACKSCREEN_OFFSET UNITYSDK_OFFSET(0x10C22190)
#define HIPPLENBUILDERUIMAN_CREATESTATUSITEMS_OFFSET UNITYSDK_OFFSET(0x10C1C710)
#define HIPPLENBUILDERUIMAN_DISPLAYACTIVITIES_OFFSET UNITYSDK_OFFSET(0x10C213B0)
#define HIPPLENBUILDERUIMAN_DISPLAYBEHAVIORMSG_OFFSET UNITYSDK_OFFSET(0x10C26BA0)
#define HIPPLENBUILDERUIMAN_HIDETESTPANEL_OFFSET UNITYSDK_OFFSET(0x10C29F20)
#define HIPPLENBUILDERUIMAN_INIT_OFFSET UNITYSDK_OFFSET(0x10C1C180)
#define HIPPLENBUILDERUIMAN_METHOD_5_2ED154071148A11A_OFFSET UNITYSDK_OFFSET(0x10C29840)
#define HIPPLENBUILDERUIMAN_METHOD_5_568E43EF375BC3A2_OFFSET UNITYSDK_OFFSET(0x10C2ABE0)
#define HIPPLENBUILDERUIMAN_METHOD_5_7CEDAA9D4018BD18_OFFSET UNITYSDK_OFFSET(0x10C2A4D0)
#define HIPPLENBUILDERUIMAN_METHOD_5_B983476B0D3440D6_OFFSET UNITYSDK_OFFSET(0x10C29540)
#define HIPPLENBUILDERUIMAN_ONTESTLINECLICK_OFFSET UNITYSDK_OFFSET(0x10C29F80)
#define HIPPLENBUILDERUIMAN_OPENBUFFSELECTIONPANEL_OFFSET UNITYSDK_OFFSET(0x10C1DD10)
#define HIPPLENBUILDERUIMAN_OPENENDDAYPANEL_OFFSET UNITYSDK_OFFSET(0x10C1EEE0)
#define HIPPLENBUILDERUIMAN_OPENTAKETESTPANEL_OFFSET UNITYSDK_OFFSET(0x10C228B0)
#define HIPPLENBUILDERUIMAN_OPENTESTPANEL_OFFSET UNITYSDK_OFFSET(0x10C1DAA0)
#define HIPPLENBUILDERUIMAN_OPENTRAININGBLACKSCREEN_OFFSET UNITYSDK_OFFSET(0x10C21D90)
#define HIPPLENBUILDERUIMAN_PINTESTLINE_OFFSET UNITYSDK_OFFSET(0x10C28EB0)
#define HIPPLENBUILDERUIMAN_REFRESHBUFFDISPLAY_OFFSET UNITYSDK_OFFSET(0x10C20CA0)
#define HIPPLENBUILDERUIMAN_REFRESHSTATUSITEMS_OFFSET UNITYSDK_OFFSET(0x10C1FC10)
#define HIPPLENBUILDERUIMAN_REFRESHTESTLINEPANEL_OFFSET UNITYSDK_OFFSET(0x10C1F360)
#define HIPPLENBUILDERUIMAN_REFRESHTIMEDISPLAY_OFFSET UNITYSDK_OFFSET(0x10C20BA0)
#define HIPPLENBUILDERUIMAN_REFRESHTODOLIST_OFFSET UNITYSDK_OFFSET(0x10C1F7C0)
#define HIPPLENBUILDERUIMAN_SETACTIVITYMODE_OFFSET UNITYSDK_OFFSET(0x10C21D00)
#define HIPPLENBUILDERUIMAN_SHOWTESTLINEPANEL_OFFSET UNITYSDK_OFFSET(0x10C2A010)
#define HIPPLENBUILDERUIMAN_TRYDISPLAYBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x10C1EA10)
#define HIPPLENBUILDERUIMAN__CTOR_OFFSET UNITYSDK_OFFSET(0x10C2B1D0)

inline static constexpr unsigned int HipplenBuilderUIMan_TypeDefinitionIndex = 38124;
