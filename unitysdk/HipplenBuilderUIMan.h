...
#define HIPPLENBUILDERUIMAN_CLOSEBEHAVIORPANEL_OFFSET UNITYSDK_OFFSET(0x17A6DF10)
#define HIPPLENBUILDERUIMAN_CLOSEBUFFSELECTIONPANEL_OFFSET UNITYSDK_OFFSET(0x17A6CC70)
#define HIPPLENBUILDERUIMAN_CLOSEENDDAYPANEL_OFFSET UNITYSDK_OFFSET(0x17A6C450)
#define HIPPLENBUILDERUIMAN_CLOSETAKETESTPANEL_OFFSET UNITYSDK_OFFSET(0x17A6CC00)
#define HIPPLENBUILDERUIMAN_CLOSETRANINGBLACKSCREEN_OFFSET UNITYSDK_OFFSET(0x17A63ED0)
#define HIPPLENBUILDERUIMAN_CREATESTATUSITEMS_OFFSET UNITYSDK_OFFSET(0x17A5D6C0)
#define HIPPLENBUILDERUIMAN_DISPLAYACTIVITIES_OFFSET UNITYSDK_OFFSET(0x17A63230)
#define HIPPLENBUILDERUIMAN_DISPLAYBEHAVIORMSG_OFFSET UNITYSDK_OFFSET(0x17A68AD0)
#define HIPPLENBUILDERUIMAN_HIDETESTPANEL_OFFSET UNITYSDK_OFFSET(0x17A6CCE0)
#define HIPPLENBUILDERUIMAN_INIT_OFFSET UNITYSDK_OFFSET(0x17A5D0D0)
#define HIPPLENBUILDERUIMAN_METHOD_5_039D2AB733A05336_OFFSET UNITYSDK_OFFSET(0x17A6DB80)
#define HIPPLENBUILDERUIMAN_METHOD_5_E915B76EB62656B0_OFFSET UNITYSDK_OFFSET(0x17A6C0F0)
#define HIPPLENBUILDERUIMAN_METHOD_5_F5FA636E6C5F7D3F_OFFSET UNITYSDK_OFFSET(0x17A6D3F0)
#define HIPPLENBUILDERUIMAN_METHOD_5_FA2A5D054A26EC88_OFFSET UNITYSDK_OFFSET(0x17A6C4B0)
#define HIPPLENBUILDERUIMAN_ONTESTLINECLICK_OFFSET UNITYSDK_OFFSET(0x17A6CD40)
#define HIPPLENBUILDERUIMAN_OPENBUFFSELECTIONPANEL_OFFSET UNITYSDK_OFFSET(0x17A5F150)
#define HIPPLENBUILDERUIMAN_OPENENDDAYPANEL_OFFSET UNITYSDK_OFFSET(0x17A605D0)
#define HIPPLENBUILDERUIMAN_OPENTAKETESTPANEL_OFFSET UNITYSDK_OFFSET(0x17A647C0)
#define HIPPLENBUILDERUIMAN_OPENTESTPANEL_OFFSET UNITYSDK_OFFSET(0x17A5ED90)
#define HIPPLENBUILDERUIMAN_OPENTRAININGBLACKSCREEN_OFFSET UNITYSDK_OFFSET(0x17A63BA0)
#define HIPPLENBUILDERUIMAN_PINTESTLINE_OFFSET UNITYSDK_OFFSET(0x17A6B8B0)
#define HIPPLENBUILDERUIMAN_REFRESHBUFFDISPLAY_OFFSET UNITYSDK_OFFSET(0x17A629F0)
#define HIPPLENBUILDERUIMAN_REFRESHSTATUSITEMS_OFFSET UNITYSDK_OFFSET(0x17A61450)
#define HIPPLENBUILDERUIMAN_REFRESHTESTLINEPANEL_OFFSET UNITYSDK_OFFSET(0x17A60B20)
#define HIPPLENBUILDERUIMAN_REFRESHTIMEDISPLAY_OFFSET UNITYSDK_OFFSET(0x17A62820)
#define HIPPLENBUILDERUIMAN_REFRESHTODOLIST_OFFSET UNITYSDK_OFFSET(0x17A60F50)
#define HIPPLENBUILDERUIMAN_SETACTIVITYMODE_OFFSET UNITYSDK_OFFSET(0x17A63B10)
#define HIPPLENBUILDERUIMAN_SHOWTESTLINEPANEL_OFFSET UNITYSDK_OFFSET(0x17A6CDD0)
#define HIPPLENBUILDERUIMAN_TRYDISPLAYBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x17A60040)
#define HIPPLENBUILDERUIMAN__CTOR_OFFSET UNITYSDK_OFFSET(0x17A6DFD0)

inline static constexpr unsigned int HipplenBuilderUIMan_TypeDefinitionIndex = 45426;
