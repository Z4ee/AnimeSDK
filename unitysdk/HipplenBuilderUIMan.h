...
#define HIPPLENBUILDERUIMAN_CLOSEBEHAVIORPANEL_OFFSET UNITYSDK_OFFSET(0x13C71120)
#define HIPPLENBUILDERUIMAN_CLOSEBUFFSELECTIONPANEL_OFFSET UNITYSDK_OFFSET(0x13C6FFD0)
#define HIPPLENBUILDERUIMAN_CLOSEENDDAYPANEL_OFFSET UNITYSDK_OFFSET(0x13C6F900)
#define HIPPLENBUILDERUIMAN_CLOSETAKETESTPANEL_OFFSET UNITYSDK_OFFSET(0x13C6FF60)
#define HIPPLENBUILDERUIMAN_CLOSETRANINGBLACKSCREEN_OFFSET UNITYSDK_OFFSET(0x13C68210)
#define HIPPLENBUILDERUIMAN_CREATESTATUSITEMS_OFFSET UNITYSDK_OFFSET(0x13C628B0)
#define HIPPLENBUILDERUIMAN_DISPLAYACTIVITIES_OFFSET UNITYSDK_OFFSET(0x13C67530)
#define HIPPLENBUILDERUIMAN_DISPLAYBEHAVIORMSG_OFFSET UNITYSDK_OFFSET(0x13C6CC70)
#define HIPPLENBUILDERUIMAN_HIDETESTPANEL_OFFSET UNITYSDK_OFFSET(0x13C70040)
#define HIPPLENBUILDERUIMAN_INIT_OFFSET UNITYSDK_OFFSET(0x13C622C0)
#define HIPPLENBUILDERUIMAN_METHOD_5_039D2AB733A05336_OFFSET UNITYSDK_OFFSET(0x13C70D90)
#define HIPPLENBUILDERUIMAN_METHOD_5_0A36321CE9809030_OFFSET UNITYSDK_OFFSET(0x13C70620)
#define HIPPLENBUILDERUIMAN_METHOD_5_E915B76EB62656B0_OFFSET UNITYSDK_OFFSET(0x13C6F5A0)
#define HIPPLENBUILDERUIMAN_METHOD_5_FA2A5D054A26EC88_OFFSET UNITYSDK_OFFSET(0x13C6F960)
#define HIPPLENBUILDERUIMAN_ONTESTLINECLICK_OFFSET UNITYSDK_OFFSET(0x13C700A0)
#define HIPPLENBUILDERUIMAN_OPENBUFFSELECTIONPANEL_OFFSET UNITYSDK_OFFSET(0x13C63E30)
#define HIPPLENBUILDERUIMAN_OPENENDDAYPANEL_OFFSET UNITYSDK_OFFSET(0x13C650A0)
#define HIPPLENBUILDERUIMAN_OPENTAKETESTPANEL_OFFSET UNITYSDK_OFFSET(0x13C689C0)
#define HIPPLENBUILDERUIMAN_OPENTESTPANEL_OFFSET UNITYSDK_OFFSET(0x13C63BD0)
#define HIPPLENBUILDERUIMAN_OPENTRAININGBLACKSCREEN_OFFSET UNITYSDK_OFFSET(0x13C67EE0)
#define HIPPLENBUILDERUIMAN_PINTESTLINE_OFFSET UNITYSDK_OFFSET(0x13C6EED0)
#define HIPPLENBUILDERUIMAN_REFRESHBUFFDISPLAY_OFFSET UNITYSDK_OFFSET(0x13C66E00)
#define HIPPLENBUILDERUIMAN_REFRESHSTATUSITEMS_OFFSET UNITYSDK_OFFSET(0x13C65E00)
#define HIPPLENBUILDERUIMAN_REFRESHTESTLINEPANEL_OFFSET UNITYSDK_OFFSET(0x13C65590)
#define HIPPLENBUILDERUIMAN_REFRESHTIMEDISPLAY_OFFSET UNITYSDK_OFFSET(0x13C66D00)
#define HIPPLENBUILDERUIMAN_REFRESHTODOLIST_OFFSET UNITYSDK_OFFSET(0x13C659C0)
#define HIPPLENBUILDERUIMAN_SETACTIVITYMODE_OFFSET UNITYSDK_OFFSET(0x13C67E50)
#define HIPPLENBUILDERUIMAN_SHOWTESTLINEPANEL_OFFSET UNITYSDK_OFFSET(0x13C70130)
#define HIPPLENBUILDERUIMAN_TRYDISPLAYBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x13C64B80)
#define HIPPLENBUILDERUIMAN__CTOR_OFFSET UNITYSDK_OFFSET(0x13C711E0)

inline static constexpr unsigned int HipplenBuilderUIMan_TypeDefinitionIndex = 44554;
...
public:
	...
	::System::Void Method_5_0A36321CE9809030(::HipplenBuilderActivityAsset_Activity* a1)
	{
		return ((::System::Void(*)(::PVOID, ::HipplenBuilderActivityAsset_Activity*))((::PBYTE)hIl2Cpp + HIPPLENBUILDERUIMAN_METHOD_5_0A36321CE9809030_OFFSET))(this, a1);
	}
