...
#define CLASS_1_5B567C8A01BAEDFE_275_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E4FF4C0)
#define CLASS_1_5B567C8A01BAEDFE_275_CLONE_OFFSET UNITYSDK_OFFSET(0x1E4FF1B0)
#define CLASS_1_5B567C8A01BAEDFE_275_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E4FF2C0)
#define CLASS_1_5B567C8A01BAEDFE_275_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E4FF1F0)
#define CLASS_1_5B567C8A01BAEDFE_275_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E4FF420)
#define CLASS_1_5B567C8A01BAEDFE_275_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E4FF510)
#define CLASS_1_5B567C8A01BAEDFE_275_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E4FF4E0)
#define CLASS_1_5B567C8A01BAEDFE_275_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E4FF130)
#define CLASS_1_5B567C8A01BAEDFE_275_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E4FF160)
#define CLASS_1_5B567C8A01BAEDFE_275_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E4FF450)
#define CLASS_1_5B567C8A01BAEDFE_275_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E4FF4B0)
#define CLASS_1_5B567C8A01BAEDFE_275__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E4FF560)
#define CLASS_1_5B567C8A01BAEDFE_275__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E4FF180)
#define CLASS_1_5B567C8A01BAEDFE_275__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4FF170)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_275_TypeDefinitionIndex = 31740;

class Class_1_5B567C8A01BAEDFE_275 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_275*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_275*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_275_TypeDefinitionIndex)->GetStaticField(0x216E0);
	}
