...
public:
	...
	{
		return (::RPG::CustomRP::SyncLoadAssetDel**)Il2CppClass::FromTypeDefinitionIndex(Class_1_278DBA9D7544F506___O_TypeDefinitionIndex)->GetStaticField(0x55100);
	}
	static ::RPG::CustomRP::ReleaseAssetDel** StaticGet__1___ReleaseAsset()
	{
		return (::RPG::CustomRP::ReleaseAssetDel**)Il2CppClass::FromTypeDefinitionIndex(Class_1_278DBA9D7544F506___O_TypeDefinitionIndex)->GetStaticField(0x55108);
	}
};
