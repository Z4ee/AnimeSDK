...
#define RADIALBLURPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0x1CB70460)
#define RADIALBLURPROXY_COPYVALUEFROMRADIALBLUR_OFFSET UNITYSDK_OFFSET(0x1CB70830)
#define RADIALBLURPROXY_SETVALUETORADIALBLUR_OFFSET UNITYSDK_OFFSET(0x1CB70A70)
#define RADIALBLURPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0x1CB70A20)
#define RADIALBLURPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB70E50)

inline static constexpr unsigned int RadialBlurProxy_TypeDefinitionIndex = 66498;
