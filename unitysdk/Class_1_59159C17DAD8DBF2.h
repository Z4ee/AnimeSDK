...
#define CLASS_1_59159C17DAD8DBF2_METHOD_1_0C46F2368C0954A8_OFFSET UNITYSDK_OFFSET(0x1851B9E0)
#define CLASS_1_59159C17DAD8DBF2_METHOD_1_0D34B29874E881BD_OFFSET UNITYSDK_OFFSET(0x1851C040)
#define CLASS_1_59159C17DAD8DBF2_METHOD_1_1F0AB91DB297B2B5_OFFSET UNITYSDK_OFFSET(0x1851B3B0)
#define CLASS_1_59159C17DAD8DBF2_METHOD_1_270C0C7CD4DC3FFA_OFFSET UNITYSDK_OFFSET(0x1851B260)
#define CLASS_1_59159C17DAD8DBF2_METHOD_1_3CD8F9B0233AF481_OFFSET UNITYSDK_OFFSET(0x1851AFD0)
#define CLASS_1_59159C17DAD8DBF2_METHOD_1_471569683E790EE5_1_OFFSET UNITYSDK_OFFSET(0x1851ADF0)
#define CLASS_1_59159C17DAD8DBF2_METHOD_1_471569683E790EE5_OFFSET UNITYSDK_OFFSET(0x1851AC90)
#define CLASS_1_59159C17DAD8DBF2_METHOD_1_4A80BBB92B6FD38D_OFFSET UNITYSDK_OFFSET(0x1851B880)
#define CLASS_1_59159C17DAD8DBF2_METHOD_1_58F36FC06998BB26_OFFSET UNITYSDK_OFFSET(0x1851C300)
#define CLASS_1_59159C17DAD8DBF2_METHOD_1_69B138FD124BCA65_OFFSET UNITYSDK_OFFSET(0x1851BE70)
#define CLASS_1_59159C17DAD8DBF2_METHOD_1_6D047DFA36D6B75B_OFFSET UNITYSDK_OFFSET(0x1851B090)
#define CLASS_1_59159C17DAD8DBF2_METHOD_1_7C3C606EA3940DC5_OFFSET UNITYSDK_OFFSET(0x1851AAC0)
#define CLASS_1_59159C17DAD8DBF2_METHOD_1_81ADF539CEB58030_OFFSET UNITYSDK_OFFSET(0x1851AF50)
#define CLASS_1_59159C17DAD8DBF2_METHOD_1_81EC382AB6020233_OFFSET UNITYSDK_OFFSET(0x1851C5B0)
#define CLASS_1_59159C17DAD8DBF2_METHOD_1_A4A9C09859726623_OFFSET UNITYSDK_OFFSET(0x1851C0F0)
#define CLASS_1_59159C17DAD8DBF2_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1851C2C0)
#define CLASS_1_59159C17DAD8DBF2_METHOD_1_CEBE254B0894039F_OFFSET UNITYSDK_OFFSET(0x1851BC60)
#define CLASS_1_59159C17DAD8DBF2_METHOD_1_E43C20C230203D14_OFFSET UNITYSDK_OFFSET(0x1851B5B0)
#define CLASS_1_59159C17DAD8DBF2_METHOD_1_E51D9168493BE0F8_OFFSET UNITYSDK_OFFSET(0x1851CA10)
#define CLASS_1_59159C17DAD8DBF2_METHOD_1_E96157A5844E0D85_OFFSET UNITYSDK_OFFSET(0x1851C8E0)
#define CLASS_1_59159C17DAD8DBF2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1851CAF0)
#define CLASS_1_59159C17DAD8DBF2__CTOR_OFFSET UNITYSDK_OFFSET(0x1851AAB0)

inline static constexpr unsigned int Class_1_59159C17DAD8DBF2_TypeDefinitionIndex = 73733;
...
public:
	...
	{
		return (::RPG::Client::RPGProfilerMarker**)Il2CppClass::FromTypeDefinitionIndex(Class_1_59159C17DAD8DBF2_TypeDefinitionIndex)->GetStaticField(0x12480);
	}
	static ::System::Single* StaticGet_PIIHMFECDJL()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_59159C17DAD8DBF2_TypeDefinitionIndex)->GetStaticField(0x7940);
	}
	static ::System::Single* StaticGet_CKFJCFJLEJP()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_59159C17DAD8DBF2_TypeDefinitionIndex)->GetStaticField(0x7944);
	}
	static ::System::Single* StaticGet_DPGFEFBFPFF()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_59159C17DAD8DBF2_TypeDefinitionIndex)->GetStaticField(0x7948);
	}
	static ::System::Single* StaticGet_ECCDDMLKKMC()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_59159C17DAD8DBF2_TypeDefinitionIndex)->GetStaticField(0x794C);
	}
	::RPG::Client::OpenWorld::StreamingLodSetting* PNIBBJODGFJ; // 0x10
	::System::Single GJDDHLIKCPG; // 0x18
	::UnityEngine::Vector3 PFBFFIMPNBL; // 0x1C
	::System::Single LNGCANKBIDF; // 0x28
