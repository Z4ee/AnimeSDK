...
#define CLASS_1_72B9A77B5361D293_METHOD_1_5D87C89C097F586D_OFFSET UNITYSDK_OFFSET(0x11C1B060)
#define CLASS_1_72B9A77B5361D293_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x11C1B050)
#define CLASS_1_72B9A77B5361D293_METHOD_1_AA79701578860DC4_OFFSET UNITYSDK_OFFSET(0x11C1B160)
#define CLASS_1_72B9A77B5361D293_METHOD_1_C50B93169B85DAEA_OFFSET UNITYSDK_OFFSET(0x11C1B100)
#define CLASS_1_72B9A77B5361D293_METHOD_1_FB24463ADA9D883B_OFFSET UNITYSDK_OFFSET(0x11C1B170)
#define CLASS_1_72B9A77B5361D293__CTOR_OFFSET UNITYSDK_OFFSET(0x11C1B150)

inline static constexpr unsigned int Class_1_72B9A77B5361D293_TypeDefinitionIndex = 67439;
...
public:
	...
	{
		return ((::Class_0_16E4307DCC419505_237*(*)(::PVOID, ::Struct_2_519740F826A15881))((::PBYTE)hIl2Cpp + CLASS_1_72B9A77B5361D293_METHOD_1_5D87C89C097F586D_OFFSET))(this, a1);
	}

	::System::Void Method_1_C50B93169B85DAEA(::Class_0_16E4307DCC419505_237* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_237*))((::PBYTE)hIl2Cpp + CLASS_1_72B9A77B5361D293_METHOD_1_C50B93169B85DAEA_OFFSET))(this, a1);
	}
