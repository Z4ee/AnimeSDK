...
#define FLEXBUFFERS_BITWIDTHUTIL_PADDINGSIZE_OFFSET UNITYSDK_OFFSET(0x1E9D3BB0)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_1_OFFSET UNITYSDK_OFFSET(0x1E9D3A70)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_2_OFFSET UNITYSDK_OFFSET(0x1E9D3A90)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_3_OFFSET UNITYSDK_OFFSET(0x1E9D3AC0)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_4_OFFSET UNITYSDK_OFFSET(0x1E9D3B10)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_5_OFFSET UNITYSDK_OFFSET(0x1E9D3B20)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_6_OFFSET UNITYSDK_OFFSET(0x1E9D3B30)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_7_OFFSET UNITYSDK_OFFSET(0x1E9D3B50)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_8_OFFSET UNITYSDK_OFFSET(0x1E9D3B80)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_9_OFFSET UNITYSDK_OFFSET(0x1E9D3B90)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_OFFSET UNITYSDK_OFFSET(0x1E9D3A60)

namespace FlexBuffers
{
	inline static constexpr unsigned int BitWidthUtil_TypeDefinitionIndex = 6741;
