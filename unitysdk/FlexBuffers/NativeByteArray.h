...
#define FLEXBUFFERS_NATIVEBYTEARRAY_ASSERT_OFFSET UNITYSDK_OFFSET(0x1B21B9B0)
#define FLEXBUFFERS_NATIVEBYTEARRAY_BLOCKCOPY_OFFSET UNITYSDK_OFFSET(0x1B21C000)
#define FLEXBUFFERS_NATIVEBYTEARRAY_COMPUTEINDIRECTOFFSET_OFFSET UNITYSDK_OFFSET(0x1B21C120)
#define FLEXBUFFERS_NATIVEBYTEARRAY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B21C140)
#define FLEXBUFFERS_NATIVEBYTEARRAY_GET_DATA_OFFSET UNITYSDK_OFFSET(0x1B21B9A0)
#define FLEXBUFFERS_NATIVEBYTEARRAY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1B21B890)
#define FLEXBUFFERS_NATIVEBYTEARRAY_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1B21B990)
#define FLEXBUFFERS_NATIVEBYTEARRAY_READBYTE_OFFSET UNITYSDK_OFFSET(0x1B21B910)
#define FLEXBUFFERS_NATIVEBYTEARRAY_READDOUBLE_OFFSET UNITYSDK_OFFSET(0x1B21BCE0)
#define FLEXBUFFERS_NATIVEBYTEARRAY_READLONG_OFFSET UNITYSDK_OFFSET(0x1B21BB60)
#define FLEXBUFFERS_NATIVEBYTEARRAY_READSPANBYTES_OFFSET UNITYSDK_OFFSET(0x1B21BF20)
#define FLEXBUFFERS_NATIVEBYTEARRAY_READSTRING_OFFSET UNITYSDK_OFFSET(0x1B21BDD0)
#define FLEXBUFFERS_NATIVEBYTEARRAY_READULONG_OFFSET UNITYSDK_OFFSET(0x1B21BC20)
#define FLEXBUFFERS_NATIVEBYTEARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2164C0)

namespace FlexBuffers
{
	inline static constexpr unsigned int NativeByteArray_TypeDefinitionIndex = 8763;
