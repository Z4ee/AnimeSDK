...
#define FLEXBUFFERS_FLEXBUFFER_ADDDYNAMICMAP_OFFSET UNITYSDK_OFFSET(0x1E9D6920)
#define FLEXBUFFERS_FLEXBUFFER_ADDDYNAMICVECTOR_OFFSET UNITYSDK_OFFSET(0x1E9D6FD0)
#define FLEXBUFFERS_FLEXBUFFER_ADDDYNAMIC_OFFSET UNITYSDK_OFFSET(0x1E9D8090)
#define FLEXBUFFERS_FLEXBUFFER_ADDINDIRECT_1_OFFSET UNITYSDK_OFFSET(0x1E9D7C30)
#define FLEXBUFFERS_FLEXBUFFER_ADDINDIRECT_2_OFFSET UNITYSDK_OFFSET(0x1E9D7E10)
#define FLEXBUFFERS_FLEXBUFFER_ADDINDIRECT_OFFSET UNITYSDK_OFFSET(0x1E9D7A00)
#define FLEXBUFFERS_FLEXBUFFER_ADDKEY_OFFSET UNITYSDK_OFFSET(0x1E9D8430)
#define FLEXBUFFERS_FLEXBUFFER_ADDNULL_OFFSET UNITYSDK_OFFSET(0x1E9D5050)
#define FLEXBUFFERS_FLEXBUFFER_ADD_1_OFFSET UNITYSDK_OFFSET(0x1E9D52E0)
#define FLEXBUFFERS_FLEXBUFFER_ADD_2_OFFSET UNITYSDK_OFFSET(0x1E9D5420)
#define FLEXBUFFERS_FLEXBUFFER_ADD_3_OFFSET UNITYSDK_OFFSET(0x1E9D5520)
#define FLEXBUFFERS_FLEXBUFFER_ADD_4_OFFSET UNITYSDK_OFFSET(0x1E9D4A40)
#define FLEXBUFFERS_FLEXBUFFER_ADD_5_OFFSET UNITYSDK_OFFSET(0x1E9D6720)
#define FLEXBUFFERS_FLEXBUFFER_ADD_OFFSET UNITYSDK_OFFSET(0x1E9D5170)
#define FLEXBUFFERS_FLEXBUFFER_ALIGN_OFFSET UNITYSDK_OFFSET(0x1E9D7650)
#define FLEXBUFFERS_FLEXBUFFER_CREATEVECTOR_OFFSET UNITYSDK_OFFSET(0x1E9D9010)
#define FLEXBUFFERS_FLEXBUFFER_ENDMAP_OFFSET UNITYSDK_OFFSET(0x1E9D8A80)
#define FLEXBUFFERS_FLEXBUFFER_ENDVECTOR_OFFSET UNITYSDK_OFFSET(0x1E9D4E50)
#define FLEXBUFFERS_FLEXBUFFER_FINISHBUFFER_OFFSET UNITYSDK_OFFSET(0x1E9D7380)
#define FLEXBUFFERS_FLEXBUFFER_FINISH_OFFSET UNITYSDK_OFFSET(0x1E9D4F20)
#define FLEXBUFFERS_FLEXBUFFER_FROM_OFFSET UNITYSDK_OFFSET(0x1E9D6880)
#define FLEXBUFFERS_FLEXBUFFER_NEWOFFSET_OFFSET UNITYSDK_OFFSET(0x1E9D7FD0)
#define FLEXBUFFERS_FLEXBUFFER_NULL_OFFSET UNITYSDK_OFFSET(0x1E9D4FD0)
#define FLEXBUFFERS_FLEXBUFFER_PARTITION_OFFSET UNITYSDK_OFFSET(0x1E9D8E20)
#define FLEXBUFFERS_FLEXBUFFER_QUICKSORT_OFFSET UNITYSDK_OFFSET(0x1E9D8A20)
#define FLEXBUFFERS_FLEXBUFFER_SHOULDFLIP_OFFSET UNITYSDK_OFFSET(0x1E9D88D0)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_10_OFFSET UNITYSDK_OFFSET(0x1E9D5F50)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_11_OFFSET UNITYSDK_OFFSET(0x1E9D6190)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_12_OFFSET UNITYSDK_OFFSET(0x1E9D62D0)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_13_OFFSET UNITYSDK_OFFSET(0x1E9D6480)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_14_OFFSET UNITYSDK_OFFSET(0x1E9D66A0)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_1_OFFSET UNITYSDK_OFFSET(0x1E9D5200)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_2_OFFSET UNITYSDK_OFFSET(0x1E9D5360)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_3_OFFSET UNITYSDK_OFFSET(0x1E9D5480)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_4_OFFSET UNITYSDK_OFFSET(0x1E9D5570)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_5_OFFSET UNITYSDK_OFFSET(0x1E9D55F0)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_6_OFFSET UNITYSDK_OFFSET(0x1E9D5770)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_7_OFFSET UNITYSDK_OFFSET(0x1E9D5980)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_8_OFFSET UNITYSDK_OFFSET(0x1E9D5C10)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_9_OFFSET UNITYSDK_OFFSET(0x1E9D5D70)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_OFFSET UNITYSDK_OFFSET(0x1E9D5080)
#define FLEXBUFFERS_FLEXBUFFER_SORTANDENDMAP_OFFSET UNITYSDK_OFFSET(0x1E9D8770)
#define FLEXBUFFERS_FLEXBUFFER_STARTVECTOR_OFFSET UNITYSDK_OFFSET(0x1E9D4A20)
#define FLEXBUFFERS_FLEXBUFFER_SWAP_OFFSET UNITYSDK_OFFSET(0x1E9D8F50)
#define FLEXBUFFERS_FLEXBUFFER_WRITE_1_OFFSET UNITYSDK_OFFSET(0x1E9D7900)
#define FLEXBUFFERS_FLEXBUFFER_WRITE_2_OFFSET UNITYSDK_OFFSET(0x1E9D7B40)
#define FLEXBUFFERS_FLEXBUFFER_WRITE_3_OFFSET UNITYSDK_OFFSET(0x1E9D7D50)
#define FLEXBUFFERS_FLEXBUFFER_WRITE_4_OFFSET UNITYSDK_OFFSET(0x1E9D7F20)
#define FLEXBUFFERS_FLEXBUFFER_WRITE_OFFSET UNITYSDK_OFFSET(0x1E9D7680)
#define FLEXBUFFERS_FLEXBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E9D47F0)

namespace FlexBuffers
{
	inline static constexpr unsigned int FlexBuffer_TypeDefinitionIndex = 6743;

	class FlexBuffer : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::FlexBuffers::StackValue>* _stack; // 0x10
		::System::Collections::Generic::Dictionary_2<::Il2CppArray<::System::Int64>*, ::FlexBuffers::StackValue>* _keyVectorCache; // 0x18
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::UInt64>* _keyCache; // 0x20
		::Il2CppArray<::System::Byte>* _bytes; // 0x28
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::UInt64>* _stringCache; // 0x30
