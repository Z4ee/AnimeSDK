...
#define FLEXBUFFERS_FLXMAP__GETENUMERATOR_D__23_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B215DF0)
#define FLEXBUFFERS_FLXMAP__GETENUMERATOR_D__23_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_SYSTEM_STRING_FLEXBUFFERS_FLXVALUE___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B215ED0)
#define FLEXBUFFERS_FLXMAP__GETENUMERATOR_D__23_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B215F40)
#define FLEXBUFFERS_FLXMAP__GETENUMERATOR_D__23_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B215EF0)
#define FLEXBUFFERS_FLXMAP__GETENUMERATOR_D__23_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B215DE0)
#define FLEXBUFFERS_FLXMAP__GETENUMERATOR_D__23__CTOR_OFFSET UNITYSDK_OFFSET(0x1B215D10)

namespace FlexBuffers
{
	inline static constexpr unsigned int FlxMap__GetEnumerator_d__23_TypeDefinitionIndex = 8768;

	class FlxMap__GetEnumerator_d__23 : public ::System::Object
	{
	public:
		::FlexBuffers::FlxVector _keys_5__2; // 0x10
		::FlexBuffers::FlxMap __4__this; // 0x28
		::FlexBuffers::FlxVector _values_5__3; // 0x40
