...
#define FLEXBUFFERS_FLXMAP__GETENUMERATOR_D__23_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D5FD3D0)
#define FLEXBUFFERS_FLXMAP__GETENUMERATOR_D__23_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_SYSTEM_STRING_FLEXBUFFERS_FLXVALUE___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D5FD4B0)
#define FLEXBUFFERS_FLXMAP__GETENUMERATOR_D__23_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D5FD520)
#define FLEXBUFFERS_FLXMAP__GETENUMERATOR_D__23_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1D5FD4D0)
#define FLEXBUFFERS_FLXMAP__GETENUMERATOR_D__23_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D5FD3C0)
#define FLEXBUFFERS_FLXMAP__GETENUMERATOR_D__23__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5FD2F0)

namespace FlexBuffers
{
	inline static constexpr unsigned int FlxMap__GetEnumerator_d__23_TypeDefinitionIndex = 6755;

	class FlxMap__GetEnumerator_d__23 : public ::System::Object
	{
	public:
		::FlexBuffers::FlxMap __4__this; // 0x10
		::System::Collections::Generic::KeyValuePair_2<::System::String*, ::FlexBuffers::FlxValue> __2__current; // 0x28
		::FlexBuffers::FlxVector _keys_5__2; // 0x40
		::FlexBuffers::FlxVector _values_5__3; // 0x58
