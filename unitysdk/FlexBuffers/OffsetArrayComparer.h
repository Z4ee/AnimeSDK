...
#define FLEXBUFFERS_OFFSETARRAYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E9E4990)
#define FLEXBUFFERS_OFFSETARRAYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E9E4A00)
#define FLEXBUFFERS_OFFSETARRAYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E9D4FC0)

namespace FlexBuffers
{
	inline static constexpr unsigned int OffsetArrayComparer_TypeDefinitionIndex = 6745;
