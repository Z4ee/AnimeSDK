...
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_CONVERTFILE_OFFSET UNITYSDK_OFFSET(0x1E9E23F0)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_CONVERT_1_OFFSET UNITYSDK_OFFSET(0x1E9E2500)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_CONVERT_OFFSET UNITYSDK_OFFSET(0x1E9E20B0)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_ENSUREVALIDFLXVALUE_OFFSET UNITYSDK_OFFSET(0x1E9E1910)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_ENSUREVALIDJSON_OFFSET UNITYSDK_OFFSET(0x1E9E18B0)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_READARRAY_OFFSET UNITYSDK_OFFSET(0x1E9E31F0)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_READBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1E9E37A0)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_READDIGITS_OFFSET UNITYSDK_OFFSET(0x1E9E3C50)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_READHEXDIGIT_OFFSET UNITYSDK_OFFSET(0x1E9E3FD0)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_READJSONVALUE_OFFSET UNITYSDK_OFFSET(0x1E9E2240)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_READNULL_OFFSET UNITYSDK_OFFSET(0x1E9E3A70)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_READNUMBER_OFFSET UNITYSDK_OFFSET(0x1E9E2A60)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_READOBJECT_OFFSET UNITYSDK_OFFSET(0x1E9E2FA0)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_READSTRING_OFFSET UNITYSDK_OFFSET(0x1E9E33F0)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_READUNICODELITERAL_OFFSET UNITYSDK_OFFSET(0x1E9E3F80)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E9E1780)

namespace FlexBuffers
{
	inline static constexpr unsigned int JsonToFlexBufferConverter_TypeDefinitionIndex = 6762;
