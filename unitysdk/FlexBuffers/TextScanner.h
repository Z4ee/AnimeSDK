...
#define FLEXBUFFERS_TEXTSCANNER_ASSERT_1_OFFSET UNITYSDK_OFFSET(0x1E9E3BA0)
#define FLEXBUFFERS_TEXTSCANNER_ASSERT_OFFSET UNITYSDK_OFFSET(0x1E9E3EC0)
#define FLEXBUFFERS_TEXTSCANNER_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1E9E3E90)
#define FLEXBUFFERS_TEXTSCANNER_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1E9E4C50)
#define FLEXBUFFERS_TEXTSCANNER_PEEK_OFFSET UNITYSDK_OFFSET(0x1E9E29B0)
#define FLEXBUFFERS_TEXTSCANNER_READLINE_OFFSET UNITYSDK_OFFSET(0x1E9E4C60)
#define FLEXBUFFERS_TEXTSCANNER_READ_OFFSET UNITYSDK_OFFSET(0x1E9E3D90)
#define FLEXBUFFERS_TEXTSCANNER_SKIPWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1E9E2650)
#define FLEXBUFFERS_TEXTSCANNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E9E1830)

namespace FlexBuffers
{
	inline static constexpr unsigned int TextScanner_TypeDefinitionIndex = 6761;
