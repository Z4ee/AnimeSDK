...
#define FLEXBUFFERS_TEXTSCANNER_ASSERT_1_OFFSET UNITYSDK_OFFSET(0x1B21B380)
#define FLEXBUFFERS_TEXTSCANNER_ASSERT_OFFSET UNITYSDK_OFFSET(0x1B21B6A0)
#define FLEXBUFFERS_TEXTSCANNER_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1B21B670)
#define FLEXBUFFERS_TEXTSCANNER_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1B21C410)
#define FLEXBUFFERS_TEXTSCANNER_PEEK_OFFSET UNITYSDK_OFFSET(0x1B21A1A0)
#define FLEXBUFFERS_TEXTSCANNER_READLINE_OFFSET UNITYSDK_OFFSET(0x1B21C420)
#define FLEXBUFFERS_TEXTSCANNER_READ_OFFSET UNITYSDK_OFFSET(0x1B21B570)
#define FLEXBUFFERS_TEXTSCANNER_SKIPWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1B219E40)
#define FLEXBUFFERS_TEXTSCANNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B219030)

namespace FlexBuffers
{
	inline static constexpr unsigned int TextScanner_TypeDefinitionIndex = 8770;
