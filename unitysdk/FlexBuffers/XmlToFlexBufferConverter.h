...
#define FLEXBUFFERS_XMLTOFLEXBUFFERCONVERTER_CONVERT_OFFSET UNITYSDK_OFFSET(0x1B21C4F0)
#define FLEXBUFFERS_XMLTOFLEXBUFFERCONVERTER_PROCESS_OFFSET UNITYSDK_OFFSET(0x1B21C6F0)

namespace FlexBuffers
{
	inline static constexpr unsigned int XmlToFlexBufferConverter_TypeDefinitionIndex = 8775;
