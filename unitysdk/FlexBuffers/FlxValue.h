...
#define FLEXBUFFERS_FLXVALUE_COMPARETO_OFFSET UNITYSDK_OFFSET(0xA47DF0)
#define FLEXBUFFERS_FLXVALUE_CONVERTUTF16TOUTF8_OFFSET UNITYSDK_OFFSET(0x1E9E08F0)
#define FLEXBUFFERS_FLXVALUE_FROMBYTES_1_OFFSET UNITYSDK_OFFSET(0x1E9DEC60)
#define FLEXBUFFERS_FLXVALUE_FROMBYTES_2_OFFSET UNITYSDK_OFFSET(0x1E9DE860)
#define FLEXBUFFERS_FLXVALUE_FROMBYTES_OFFSET UNITYSDK_OFFSET(0x1E9DE800)
#define FLEXBUFFERS_FLXVALUE_GET_ASBLOB_OFFSET UNITYSDK_OFFSET(0xA47EE0)
#define FLEXBUFFERS_FLXVALUE_GET_ASBOOL_OFFSET UNITYSDK_OFFSET(0xA47DD0)
#define FLEXBUFFERS_FLXVALUE_GET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0xA47DC0)
#define FLEXBUFFERS_FLXVALUE_GET_ASLONG_OFFSET UNITYSDK_OFFSET(0xA47DA0)
#define FLEXBUFFERS_FLXVALUE_GET_ASMAP_OFFSET UNITYSDK_OFFSET(0xA47EC0)
#define FLEXBUFFERS_FLXVALUE_GET_ASSTRING_OFFSET UNITYSDK_OFFSET(0xA47DE0)
#define FLEXBUFFERS_FLXVALUE_GET_ASULONG_OFFSET UNITYSDK_OFFSET(0xA47DB0)
#define FLEXBUFFERS_FLXVALUE_GET_ASVECTOR_OFFSET UNITYSDK_OFFSET(0xA47EA0)
#define FLEXBUFFERS_FLXVALUE_GET_BUFFEROFFSET_OFFSET UNITYSDK_OFFSET(0x32EEE0)
#define FLEXBUFFERS_FLXVALUE_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x259D70)
#define FLEXBUFFERS_FLXVALUE_GET_INDIRECTOFFSET_OFFSET UNITYSDK_OFFSET(0xA47F10)
#define FLEXBUFFERS_FLXVALUE_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0xA47D90)
#define FLEXBUFFERS_FLXVALUE_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0xA47E50)
#define FLEXBUFFERS_FLXVALUE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0xA47E00)
#define FLEXBUFFERS_FLXVALUE_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x32EEE0)
#define FLEXBUFFERS_FLXVALUE_GET_TOJSON_OFFSET UNITYSDK_OFFSET(0xA47EF0)
#define FLEXBUFFERS_FLXVALUE_GET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x7C7B50)
#define FLEXBUFFERS_FLXVALUE_TOPRETTYJSON_OFFSET UNITYSDK_OFFSET(0xA47F00)
#define FLEXBUFFERS_FLXVALUE__CTOR_1_OFFSET UNITYSDK_OFFSET(0xA47D70)
#define FLEXBUFFERS_FLXVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0xA47D40)

namespace FlexBuffers
{
	inline static constexpr unsigned int FlxValue_TypeDefinitionIndex = 6755;
