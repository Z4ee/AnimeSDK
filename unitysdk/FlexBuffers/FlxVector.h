...
#define FLEXBUFFERS_FLXVECTOR_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x9552C0)
#define FLEXBUFFERS_FLXVECTOR_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x955280)
#define FLEXBUFFERS_FLXVECTOR_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x2F1C00)
#define FLEXBUFFERS_FLXVECTOR_GET_TOJSON_OFFSET UNITYSDK_OFFSET(0x9552A0)
#define FLEXBUFFERS_FLXVECTOR_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x9552C0)
#define FLEXBUFFERS_FLXVECTOR_TOPRETTYJSON_OFFSET UNITYSDK_OFFSET(0x9552B0)
#define FLEXBUFFERS_FLXVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x955260)

namespace FlexBuffers
{
	inline static constexpr unsigned int FlxVector_TypeDefinitionIndex = 8765;
