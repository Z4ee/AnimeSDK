...
#define FLEXBUFFERS_FLXVECTOR_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xA47FA0)
#define FLEXBUFFERS_FLXVECTOR_GET_ITEM_OFFSET UNITYSDK_OFFSET(0xA47F60)
#define FLEXBUFFERS_FLXVECTOR_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x330F60)
#define FLEXBUFFERS_FLXVECTOR_GET_TOJSON_OFFSET UNITYSDK_OFFSET(0xA47F80)
#define FLEXBUFFERS_FLXVECTOR_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xA47FA0)
#define FLEXBUFFERS_FLXVECTOR_TOPRETTYJSON_OFFSET UNITYSDK_OFFSET(0xA47F90)
#define FLEXBUFFERS_FLXVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0xA47F40)

namespace FlexBuffers
{
	inline static constexpr unsigned int FlxVector_TypeDefinitionIndex = 6756;
