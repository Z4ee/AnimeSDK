...
#define FLEXBUFFERS_FLXMAP_COMPSTR_OFFSET UNITYSDK_OFFSET(0xA47CC0)
#define FLEXBUFFERS_FLXMAP_COMP_1_OFFSET UNITYSDK_OFFSET(0xA47CB0)
#define FLEXBUFFERS_FLXMAP_COMP_OFFSET UNITYSDK_OFFSET(0xA47C50)
#define FLEXBUFFERS_FLXMAP_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xA47CD0)
#define FLEXBUFFERS_FLXMAP_GET_ITEM_OFFSET UNITYSDK_OFFSET(0xA47B70)
#define FLEXBUFFERS_FLXMAP_GET_KEYS_OFFSET UNITYSDK_OFFSET(0xA47B20)
#define FLEXBUFFERS_FLXMAP_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x330F60)
#define FLEXBUFFERS_FLXMAP_GET_TOJSON_OFFSET UNITYSDK_OFFSET(0xA47BB0)
#define FLEXBUFFERS_FLXMAP_GET_VALUES_OFFSET UNITYSDK_OFFSET(0xA47B40)
#define FLEXBUFFERS_FLXMAP_KEYINDEX_OFFSET UNITYSDK_OFFSET(0xA47BD0)
#define FLEXBUFFERS_FLXMAP_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xA47CD0)
#define FLEXBUFFERS_FLXMAP_TOPRETTYJSON_OFFSET UNITYSDK_OFFSET(0xA47BC0)
#define FLEXBUFFERS_FLXMAP_VALUEBYINDEX_OFFSET UNITYSDK_OFFSET(0xA47B90)
#define FLEXBUFFERS_FLXMAP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E9DE590)
#define FLEXBUFFERS_FLXMAP__CTOR_OFFSET UNITYSDK_OFFSET(0xA47B00)

namespace FlexBuffers
{
	inline static constexpr unsigned int FlxMap_TypeDefinitionIndex = 6758;

	struct alignas(8) FlxMap
	{
		static ::Il2CppArray<::System::Char>** StaticGet__chars()
		{
			return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(FlxMap_TypeDefinitionIndex)->GetStaticField(0x5BD0);
		}
		static ::Il2CppArray<::System::Byte>** StaticGet__charBytes()
		{
			return (::Il2CppArray<::System::Byte>**)Il2CppClass::FromTypeDefinitionIndex(FlxMap_TypeDefinitionIndex)->GetStaticField(0x5BD8);
		}
