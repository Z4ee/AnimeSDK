...
#define CLASS_3_E40CF3D012A5C472_METHOD_3_0AD194604E14DF25_OFFSET UNITYSDK_OFFSET(0x18B83CE0)
#define CLASS_3_E40CF3D012A5C472_METHOD_3_1F130271093617A5_OFFSET UNITYSDK_OFFSET(0x18B839C0)
#define CLASS_3_E40CF3D012A5C472_METHOD_3_4AADAF19CDCB660E_OFFSET UNITYSDK_OFFSET(0x18B83C50)
#define CLASS_3_E40CF3D012A5C472__CTOR_OFFSET UNITYSDK_OFFSET(0x18B83970)
#define CLASS_3_E40CF3D012A5C472__PLAYTRANSITION_B__1_0_OFFSET UNITYSDK_OFFSET(0x18B83ED0)

inline static constexpr unsigned int Class_3_E40CF3D012A5C472_TypeDefinitionIndex = 73016;

class Class_3_E40CF3D012A5C472 : public ::Class_2_29E838C92FC61B7A
{
public:
	::RPG::Client::UIController* HKJLKMCDMGB; // 0x28
	::RPG::Client::Promises::Promise* OBLMKODKNCA; // 0x30
	::RPG::Client::UIController* IBLBKLNHKLL; // 0x38
	::RPG::Client::Promises::Promise* ECDCAFKFIFJ; // 0x40
	::RPG::Client::Promises::Promise* NFEBMNGKADJ; // 0x48
