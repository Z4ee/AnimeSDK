...
#define CLASS_1_D25FE2B85DFEC5A0_1_METHOD_1_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x11C812C0)
#define CLASS_1_D25FE2B85DFEC5A0_1_METHOD_1_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x11C812B0)
#define CLASS_1_D25FE2B85DFEC5A0_1_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x11C812A0)
#define CLASS_1_D25FE2B85DFEC5A0_1__CTOR_OFFSET UNITYSDK_OFFSET(0x11C81250)

inline static constexpr unsigned int Class_1_D25FE2B85DFEC5A0_1_TypeDefinitionIndex = 75266;

class Class_1_D25FE2B85DFEC5A0_1 : public ::System::Object
{
public:
	::Class_2_208CC9941471731A_1125* Field_1_7; // 0x10
