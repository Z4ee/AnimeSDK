...
#define STATETREESERIALIZE_COMPACTSTATETREETRANSITIONCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1E6E5000)
#define STATETREESERIALIZE_COMPACTSTATETREETRANSITIONCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1E6E4860)
#define STATETREESERIALIZE_COMPACTSTATETREETRANSITIONCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1E6E44D0)
#define STATETREESERIALIZE_COMPACTSTATETREETRANSITIONCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6E5040)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int CompactStateTreeTransitionConverter_TypeDefinitionIndex = 39186;
