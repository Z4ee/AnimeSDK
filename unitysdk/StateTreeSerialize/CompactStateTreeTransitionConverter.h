...
#define STATETREESERIALIZE_COMPACTSTATETREETRANSITIONCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1D333890)
#define STATETREESERIALIZE_COMPACTSTATETREETRANSITIONCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1D3330F0)
#define STATETREESERIALIZE_COMPACTSTATETREETRANSITIONCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1D332D70)
#define STATETREESERIALIZE_COMPACTSTATETREETRANSITIONCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3338D0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int CompactStateTreeTransitionConverter_TypeDefinitionIndex = 38525;
