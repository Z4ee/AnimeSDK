...
#define STATETREESERIALIZE_STATETREEPROPERTYACCESSNATIVESTRUCTLISTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1AF467F0)
#define STATETREESERIALIZE_STATETREEPROPERTYACCESSNATIVESTRUCTLISTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1AF461B0)
#define STATETREESERIALIZE_STATETREEPROPERTYACCESSNATIVESTRUCTLISTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1AF45F90)
#define STATETREESERIALIZE_STATETREEPROPERTYACCESSNATIVESTRUCTLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF46830)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyAccessNativeStructListConverter_TypeDefinitionIndex = 36910;
