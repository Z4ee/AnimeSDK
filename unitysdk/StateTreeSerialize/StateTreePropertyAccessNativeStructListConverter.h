...
#define STATETREESERIALIZE_STATETREEPROPERTYACCESSNATIVESTRUCTLISTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1E6F1210)
#define STATETREESERIALIZE_STATETREEPROPERTYACCESSNATIVESTRUCTLISTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1E6F0BE0)
#define STATETREESERIALIZE_STATETREEPROPERTYACCESSNATIVESTRUCTLISTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1E6F09B0)
#define STATETREESERIALIZE_STATETREEPROPERTYACCESSNATIVESTRUCTLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6F1250)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyAccessNativeStructListConverter_TypeDefinitionIndex = 39181;
