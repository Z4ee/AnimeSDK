...
#define STATETREESERIALIZE_STATETREEPROPERTYREFPATHNATIVESTRUCTLISTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1D343DF0)
#define STATETREESERIALIZE_STATETREEPROPERTYREFPATHNATIVESTRUCTLISTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1D343690)
#define STATETREESERIALIZE_STATETREEPROPERTYREFPATHNATIVESTRUCTLISTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1D343470)
#define STATETREESERIALIZE_STATETREEPROPERTYREFPATHNATIVESTRUCTLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D343E30)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyRefPathNativeStructListConverter_TypeDefinitionIndex = 38519;
