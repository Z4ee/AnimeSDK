...
#define STATETREESERIALIZE_STATETREERANDOMTIMEDURATIONCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1AF4B4E0)
#define STATETREESERIALIZE_STATETREERANDOMTIMEDURATIONCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1AF4B240)
#define STATETREESERIALIZE_STATETREERANDOMTIMEDURATIONCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1AF4B0B0)
#define STATETREESERIALIZE_STATETREERANDOMTIMEDURATIONCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF4B520)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeRandomTimeDurationConverter_TypeDefinitionIndex = 36913;
