...
#define STATETREESERIALIZE_STATETREERANDOMTIMEDURATIONCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1E6F6030)
#define STATETREESERIALIZE_STATETREERANDOMTIMEDURATIONCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1E6F5D00)
#define STATETREESERIALIZE_STATETREERANDOMTIMEDURATIONCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1E6F5B70)
#define STATETREESERIALIZE_STATETREERANDOMTIMEDURATIONCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6F6070)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeRandomTimeDurationConverter_TypeDefinitionIndex = 39184;
