...
#define STATETREESERIALIZE_STATETREESTATEHANDLECONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1D345160)
#define STATETREESERIALIZE_STATETREESTATEHANDLECONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1D344F40)
#define STATETREESERIALIZE_STATETREESTATEHANDLECONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1D344E50)
#define STATETREESERIALIZE_STATETREESTATEHANDLECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D344C70)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeStateHandleConverter_TypeDefinitionIndex = 38522;
