...
#define STATETREESERIALIZE_FPROPERTYBAGPROPERTYDESCMANAGEDSTRUCTLISTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1AF40A60)
#define STATETREESERIALIZE_FPROPERTYBAGPROPERTYDESCMANAGEDSTRUCTLISTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1AF403B0)
#define STATETREESERIALIZE_FPROPERTYBAGPROPERTYDESCMANAGEDSTRUCTLISTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1AF40170)
#define STATETREESERIALIZE_FPROPERTYBAGPROPERTYDESCMANAGEDSTRUCTLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF40AA0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int FPropertyBagPropertyDescManagedStructListConverter_TypeDefinitionIndex = 36920;
