...
#define STATETREESERIALIZE_FPROPERTYBAGPROPERTYDESCMANAGEDSTRUCTLISTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1E6EAB70)
#define STATETREESERIALIZE_FPROPERTYBAGPROPERTYDESCMANAGEDSTRUCTLISTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1E6EA4D0)
#define STATETREESERIALIZE_FPROPERTYBAGPROPERTYDESCMANAGEDSTRUCTLISTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1E6EA290)
#define STATETREESERIALIZE_FPROPERTYBAGPROPERTYDESCMANAGEDSTRUCTLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6EABB0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int FPropertyBagPropertyDescManagedStructListConverter_TypeDefinitionIndex = 39191;
