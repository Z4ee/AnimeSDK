...
#define STATETREESERIALIZE_TOBJECTHANDLESTRUCTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1D3469E0)
#define STATETREESERIALIZE_TOBJECTHANDLESTRUCTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1D346800)
#define STATETREESERIALIZE_TOBJECTHANDLESTRUCTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1D346630)
#define STATETREESERIALIZE_TOBJECTHANDLESTRUCTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D344C90)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int TObjectHandleStructConverter_TypeDefinitionIndex = 38533;
