...
#define STATETREESERIALIZE_TOBJECTHANDLESCRIPTSTRUCTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1E6F8310)
#define STATETREESERIALIZE_TOBJECTHANDLESCRIPTSTRUCTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1E6F8130)
#define STATETREESERIALIZE_TOBJECTHANDLESCRIPTSTRUCTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1E6F7F60)
#define STATETREESERIALIZE_TOBJECTHANDLESCRIPTSTRUCTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6F69C0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int TObjectHandleScriptStructConverter_TypeDefinitionIndex = 39195;
