...
#define STATETREESERIALIZE_TOBJECTHANDLESCRIPTSTRUCTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1AF4E3F0)
#define STATETREESERIALIZE_TOBJECTHANDLESCRIPTSTRUCTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1AF4E210)
#define STATETREESERIALIZE_TOBJECTHANDLESCRIPTSTRUCTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1AF4E040)
#define STATETREESERIALIZE_TOBJECTHANDLESCRIPTSTRUCTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF4CB20)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int TObjectHandleScriptStructConverter_TypeDefinitionIndex = 36924;
