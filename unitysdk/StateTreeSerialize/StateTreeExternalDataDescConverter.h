...
#define STATETREESERIALIZE_STATETREEEXTERNALDATADESCCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1E6EEAD0)
#define STATETREESERIALIZE_STATETREEEXTERNALDATADESCCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1E6EE5B0)
#define STATETREESERIALIZE_STATETREEEXTERNALDATADESCCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1E6EE350)
#define STATETREESERIALIZE_STATETREEEXTERNALDATADESCCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6EEB10)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeExternalDataDescConverter_TypeDefinitionIndex = 39166;
