...
#define STATETREESERIALIZE_STATETREEEXTERNALDATADESCCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1AF44610)
#define STATETREESERIALIZE_STATETREEEXTERNALDATADESCCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1AF44170)
#define STATETREESERIALIZE_STATETREEEXTERNALDATADESCCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1AF43F10)
#define STATETREESERIALIZE_STATETREEEXTERNALDATADESCCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF44650)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeExternalDataDescConverter_TypeDefinitionIndex = 36895;
