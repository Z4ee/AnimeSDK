...
#define STATETREESERIALIZE_FPROPERTYBAGPROPERTYDESCCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1AF40120)
#define STATETREESERIALIZE_FPROPERTYBAGPROPERTYDESCCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1AF3FA40)
#define STATETREESERIALIZE_FPROPERTYBAGPROPERTYDESCCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1AF3F670)
#define STATETREESERIALIZE_FPROPERTYBAGPROPERTYDESCCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF40160)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int FPropertyBagPropertyDescConverter_TypeDefinitionIndex = 36919;
