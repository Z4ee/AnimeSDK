...
#define STATETREESERIALIZE_FPROPERTYBAGCONTAINERTYPESCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1AF3F620)
#define STATETREESERIALIZE_FPROPERTYBAGCONTAINERTYPESCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1AF3F1C0)
#define STATETREESERIALIZE_FPROPERTYBAGCONTAINERTYPESCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1AF3EFF0)
#define STATETREESERIALIZE_FPROPERTYBAGCONTAINERTYPESCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF3F660)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int FPropertyBagContainerTypesConverter_TypeDefinitionIndex = 36921;
