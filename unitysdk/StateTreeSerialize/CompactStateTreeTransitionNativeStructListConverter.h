...
#define STATETREESERIALIZE_COMPACTSTATETREETRANSITIONNATIVESTRUCTLISTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1D334160)
#define STATETREESERIALIZE_COMPACTSTATETREETRANSITIONNATIVESTRUCTLISTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1D333B00)
#define STATETREESERIALIZE_COMPACTSTATETREETRANSITIONNATIVESTRUCTLISTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1D3338E0)
#define STATETREESERIALIZE_COMPACTSTATETREETRANSITIONNATIVESTRUCTLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3341A0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int CompactStateTreeTransitionNativeStructListConverter_TypeDefinitionIndex = 38514;
