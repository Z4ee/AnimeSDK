...
#define STATETREESERIALIZE_COMPACTSTATETREETRANSITIONNATIVESTRUCTLISTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1E6E58D0)
#define STATETREESERIALIZE_COMPACTSTATETREETRANSITIONNATIVESTRUCTLISTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1E6E5280)
#define STATETREESERIALIZE_COMPACTSTATETREETRANSITIONNATIVESTRUCTLISTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1E6E5050)
#define STATETREESERIALIZE_COMPACTSTATETREETRANSITIONNATIVESTRUCTLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6E5910)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int CompactStateTreeTransitionNativeStructListConverter_TypeDefinitionIndex = 39175;
