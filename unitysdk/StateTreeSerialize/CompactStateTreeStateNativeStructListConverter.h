...
#define STATETREESERIALIZE_COMPACTSTATETREESTATENATIVESTRUCTLISTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1D332D20)
#define STATETREESERIALIZE_COMPACTSTATETREESTATENATIVESTRUCTLISTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1D332590)
#define STATETREESERIALIZE_COMPACTSTATETREESTATENATIVESTRUCTLISTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1D332330)
#define STATETREESERIALIZE_COMPACTSTATETREESTATENATIVESTRUCTLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D332D60)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int CompactStateTreeStateNativeStructListConverter_TypeDefinitionIndex = 38513;
