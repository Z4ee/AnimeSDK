...
#define STATETREESERIALIZE_COMPACTSTATETREESTATENATIVESTRUCTLISTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1E6E4480)
#define STATETREESERIALIZE_COMPACTSTATETREESTATENATIVESTRUCTLISTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1E6E3CE0)
#define STATETREESERIALIZE_COMPACTSTATETREESTATENATIVESTRUCTLISTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1E6E3A80)
#define STATETREESERIALIZE_COMPACTSTATETREESTATENATIVESTRUCTLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6E44C0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int CompactStateTreeStateNativeStructListConverter_TypeDefinitionIndex = 39174;
