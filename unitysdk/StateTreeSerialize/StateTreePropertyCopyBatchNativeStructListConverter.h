...
#define STATETREESERIALIZE_STATETREEPROPERTYCOPYBATCHNATIVESTRUCTLISTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1AF48060)
#define STATETREESERIALIZE_STATETREEPROPERTYCOPYBATCHNATIVESTRUCTLISTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1AF47A30)
#define STATETREESERIALIZE_STATETREEPROPERTYCOPYBATCHNATIVESTRUCTLISTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1AF47810)
#define STATETREESERIALIZE_STATETREEPROPERTYCOPYBATCHNATIVESTRUCTLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF480A0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyCopyBatchNativeStructListConverter_TypeDefinitionIndex = 36907;
