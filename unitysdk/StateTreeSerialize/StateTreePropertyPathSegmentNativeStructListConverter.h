...
#define STATETREESERIALIZE_STATETREEPROPERTYPATHSEGMENTNATIVESTRUCTLISTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1AF4A150)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHSEGMENTNATIVESTRUCTLISTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1AF49B60)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHSEGMENTNATIVESTRUCTLISTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1AF49950)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHSEGMENTNATIVESTRUCTLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF4A190)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyPathSegmentNativeStructListConverter_TypeDefinitionIndex = 36911;
