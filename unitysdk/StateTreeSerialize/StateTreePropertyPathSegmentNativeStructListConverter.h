...
#define STATETREESERIALIZE_STATETREEPROPERTYPATHSEGMENTNATIVESTRUCTLISTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1D342F00)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHSEGMENTNATIVESTRUCTLISTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1D342910)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHSEGMENTNATIVESTRUCTLISTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1D342700)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHSEGMENTNATIVESTRUCTLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D342F40)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyPathSegmentNativeStructListConverter_TypeDefinitionIndex = 38521;
