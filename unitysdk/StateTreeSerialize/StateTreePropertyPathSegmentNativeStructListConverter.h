...
#define STATETREESERIALIZE_STATETREEPROPERTYPATHSEGMENTNATIVESTRUCTLISTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1E6F4C20)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHSEGMENTNATIVESTRUCTLISTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1E6F4630)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHSEGMENTNATIVESTRUCTLISTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1E6F4410)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHSEGMENTNATIVESTRUCTLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6F4C60)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyPathSegmentNativeStructListConverter_TypeDefinitionIndex = 39182;
