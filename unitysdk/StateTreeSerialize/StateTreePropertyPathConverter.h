...
#define STATETREESERIALIZE_STATETREEPROPERTYPATHCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1D3420B0)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1D341EE0)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1D341D60)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3420F0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyPathConverter_TypeDefinitionIndex = 38511;
