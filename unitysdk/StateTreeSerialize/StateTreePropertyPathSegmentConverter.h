...
#define STATETREESERIALIZE_STATETREEPROPERTYPATHSEGMENTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1D3426B0)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHSEGMENTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1D3422E0)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHSEGMENTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1D342100)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHSEGMENTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3426F0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyPathSegmentConverter_TypeDefinitionIndex = 38512;
