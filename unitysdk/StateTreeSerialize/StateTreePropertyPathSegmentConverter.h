...
#define STATETREESERIALIZE_STATETREEPROPERTYPATHSEGMENTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1AF49900)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHSEGMENTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1AF495C0)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHSEGMENTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1AF493E0)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHSEGMENTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF49940)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyPathSegmentConverter_TypeDefinitionIndex = 36902;
