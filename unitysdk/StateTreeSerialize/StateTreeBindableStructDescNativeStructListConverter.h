...
#define STATETREESERIALIZE_STATETREEBINDABLESTRUCTDESCNATIVESTRUCTLISTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1D339F40)
#define STATETREESERIALIZE_STATETREEBINDABLESTRUCTDESCNATIVESTRUCTLISTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1D3398F0)
#define STATETREESERIALIZE_STATETREEBINDABLESTRUCTDESCNATIVESTRUCTLISTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1D3396D0)
#define STATETREESERIALIZE_STATETREEBINDABLESTRUCTDESCNATIVESTRUCTLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D339F80)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeBindableStructDescNativeStructListConverter_TypeDefinitionIndex = 38516;
