...
#define STATETREESERIALIZE_STATETREEBINDABLESTRUCTDESCNATIVESTRUCTLISTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1AF41A80)
#define STATETREESERIALIZE_STATETREEBINDABLESTRUCTDESCNATIVESTRUCTLISTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1AF41420)
#define STATETREESERIALIZE_STATETREEBINDABLESTRUCTDESCNATIVESTRUCTLISTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1AF41200)
#define STATETREESERIALIZE_STATETREEBINDABLESTRUCTDESCNATIVESTRUCTLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF41AC0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeBindableStructDescNativeStructListConverter_TypeDefinitionIndex = 36906;
