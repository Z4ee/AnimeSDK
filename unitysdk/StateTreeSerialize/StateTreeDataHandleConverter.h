...
#define STATETREESERIALIZE_STATETREEDATAHANDLECONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1E6EE300)
#define STATETREESERIALIZE_STATETREEDATAHANDLECONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1E6EDFD0)
#define STATETREESERIALIZE_STATETREEDATAHANDLECONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1E6EDDF0)
#define STATETREESERIALIZE_STATETREEDATAHANDLECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6EE340)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeDataHandleConverter_TypeDefinitionIndex = 39199;
