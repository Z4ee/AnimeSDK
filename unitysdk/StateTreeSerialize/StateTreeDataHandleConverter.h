...
#define STATETREESERIALIZE_STATETREEDATAHANDLECONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1D33C5F0)
#define STATETREESERIALIZE_STATETREEDATAHANDLECONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1D33C2C0)
#define STATETREESERIALIZE_STATETREEDATAHANDLECONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1D33C0E0)
#define STATETREESERIALIZE_STATETREEDATAHANDLECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D33C630)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeDataHandleConverter_TypeDefinitionIndex = 38538;
