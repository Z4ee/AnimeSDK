...
#define STATETREESERIALIZE_STATETREEPROPERTYPATHBINDINGNATIVESTRUCTLISTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1E6F3A20)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHBINDINGNATIVESTRUCTLISTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1E6F34B0)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHBINDINGNATIVESTRUCTLISTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1E6F3250)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHBINDINGNATIVESTRUCTLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6F3A60)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyPathBindingNativeStructListConverter_TypeDefinitionIndex = 39179;
