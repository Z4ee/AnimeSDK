...
#define STATETREESERIALIZE_STATETREEPROPERTYPATHBINDINGNATIVESTRUCTLISTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1D341D10)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHBINDINGNATIVESTRUCTLISTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1D3417A0)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHBINDINGNATIVESTRUCTLISTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1D341540)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHBINDINGNATIVESTRUCTLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D341D50)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyPathBindingNativeStructListConverter_TypeDefinitionIndex = 38518;
