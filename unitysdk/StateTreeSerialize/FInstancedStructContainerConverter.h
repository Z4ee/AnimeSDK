...
#define STATETREESERIALIZE_FINSTANCEDSTRUCTCONTAINERCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1AF3E670)
#define STATETREESERIALIZE_FINSTANCEDSTRUCTCONTAINERCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1AF3E030)
#define STATETREESERIALIZE_FINSTANCEDSTRUCTCONTAINERCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1AF3DC90)
#define STATETREESERIALIZE_FINSTANCEDSTRUCTCONTAINERCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF3E6B0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int FInstancedStructContainerConverter_TypeDefinitionIndex = 36916;
