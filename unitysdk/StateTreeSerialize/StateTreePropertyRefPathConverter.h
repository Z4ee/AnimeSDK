...
#define STATETREESERIALIZE_STATETREEPROPERTYREFPATHCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1AF4A680)
#define STATETREESERIALIZE_STATETREEPROPERTYREFPATHCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1AF4A3A0)
#define STATETREESERIALIZE_STATETREEPROPERTYREFPATHCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1AF4A1A0)
#define STATETREESERIALIZE_STATETREEPROPERTYREFPATHCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF4A6C0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyRefPathConverter_TypeDefinitionIndex = 36899;
