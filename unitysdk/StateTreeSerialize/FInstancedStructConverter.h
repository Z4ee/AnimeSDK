...
#define STATETREESERIALIZE_FINSTANCEDSTRUCTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1AF3EC60)
#define STATETREESERIALIZE_FINSTANCEDSTRUCTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1AF3E950)
#define STATETREESERIALIZE_FINSTANCEDSTRUCTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1AF3E6C0)
#define STATETREESERIALIZE_FINSTANCEDSTRUCTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF3ECA0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int FInstancedStructConverter_TypeDefinitionIndex = 36917;
