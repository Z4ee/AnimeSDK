...
#define STATETREESERIALIZE_TOBJECTHANDLEENUMCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1D346200)
#define STATETREESERIALIZE_TOBJECTHANDLEENUMCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1D346020)
#define STATETREESERIALIZE_TOBJECTHANDLEENUMCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1D345E50)
#define STATETREESERIALIZE_TOBJECTHANDLEENUMCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D344C80)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int TObjectHandleEnumConverter_TypeDefinitionIndex = 38532;
