...
#define STATETREESERIALIZE_STATETREEEXTERNALDATADESCNATIVESTRUCTLISTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1AF44EE0)
#define STATETREESERIALIZE_STATETREEEXTERNALDATADESCNATIVESTRUCTLISTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1AF44880)
#define STATETREESERIALIZE_STATETREEEXTERNALDATADESCNATIVESTRUCTLISTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1AF44660)
#define STATETREESERIALIZE_STATETREEEXTERNALDATADESCNATIVESTRUCTLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF44F20)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeExternalDataDescNativeStructListConverter_TypeDefinitionIndex = 36905;
