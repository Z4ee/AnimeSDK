...
#define STATETREESERIALIZE_STATETREEEXTERNALDATADESCNATIVESTRUCTLISTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1D33D680)
#define STATETREESERIALIZE_STATETREEEXTERNALDATADESCNATIVESTRUCTLISTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1D33D030)
#define STATETREESERIALIZE_STATETREEEXTERNALDATADESCNATIVESTRUCTLISTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1D33CE10)
#define STATETREESERIALIZE_STATETREEEXTERNALDATADESCNATIVESTRUCTLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D33D6C0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeExternalDataDescNativeStructListConverter_TypeDefinitionIndex = 38515;
