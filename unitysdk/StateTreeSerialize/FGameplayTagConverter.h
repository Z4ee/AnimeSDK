...
#define STATETREESERIALIZE_FGAMEPLAYTAGCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1E6E5D50)
#define STATETREESERIALIZE_FGAMEPLAYTAGCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1E6E5A50)
#define STATETREESERIALIZE_FGAMEPLAYTAGCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1E6E5920)
#define STATETREESERIALIZE_FGAMEPLAYTAGCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6E5D90)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int FGameplayTagConverter_TypeDefinitionIndex = 39204;
