...
#define STATETREESERIALIZE_FGAMEPLAYTAGCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1D3345E0)
#define STATETREESERIALIZE_FGAMEPLAYTAGCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1D3342E0)
#define STATETREESERIALIZE_FGAMEPLAYTAGCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1D3341B0)
#define STATETREESERIALIZE_FGAMEPLAYTAGCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D334620)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int FGameplayTagConverter_TypeDefinitionIndex = 38543;
