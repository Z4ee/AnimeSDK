...
#define STATETREESERIALIZE_STATETREEPROPERTYCOPYBATCHCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1E6F2240)
#define STATETREESERIALIZE_STATETREEPROPERTYCOPYBATCHCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1E6F1F00)
#define STATETREESERIALIZE_STATETREEPROPERTYCOPYBATCHCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1E6F1D30)
#define STATETREESERIALIZE_STATETREEPROPERTYCOPYBATCHCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6F2280)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyCopyBatchConverter_TypeDefinitionIndex = 39168;
