...
#define STATETREESERIALIZE_STATETREEPROPERTYCOPYBATCHCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1AF477C0)
#define STATETREESERIALIZE_STATETREEPROPERTYCOPYBATCHCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1AF47500)
#define STATETREESERIALIZE_STATETREEPROPERTYCOPYBATCHCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1AF47320)
#define STATETREESERIALIZE_STATETREEPROPERTYCOPYBATCHCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF47800)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyCopyBatchConverter_TypeDefinitionIndex = 36897;
