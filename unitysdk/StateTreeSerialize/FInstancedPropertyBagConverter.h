...
#define STATETREESERIALIZE_FINSTANCEDPROPERTYBAGCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1D3360C0)
#define STATETREESERIALIZE_FINSTANCEDPROPERTYBAGCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1D335160)
#define STATETREESERIALIZE_FINSTANCEDPROPERTYBAGCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1D334950)
#define STATETREESERIALIZE_FINSTANCEDPROPERTYBAGCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D336100)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int FInstancedPropertyBagConverter_TypeDefinitionIndex = 38528;
