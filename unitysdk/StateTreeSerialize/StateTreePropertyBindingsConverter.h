...
#define STATETREESERIALIZE_STATETREEPROPERTYBINDINGSCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1E6F1CE0)
#define STATETREESERIALIZE_STATETREEPROPERTYBINDINGSCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1E6F15F0)
#define STATETREESERIALIZE_STATETREEPROPERTYBINDINGSCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1E6F1260)
#define STATETREESERIALIZE_STATETREEPROPERTYBINDINGSCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6F1D20)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyBindingsConverter_TypeDefinitionIndex = 39165;
