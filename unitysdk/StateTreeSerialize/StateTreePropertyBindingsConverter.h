...
#define STATETREESERIALIZE_STATETREEPROPERTYBINDINGSCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1AF472D0)
#define STATETREESERIALIZE_STATETREEPROPERTYBINDINGSCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1AF46BD0)
#define STATETREESERIALIZE_STATETREEPROPERTYBINDINGSCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1AF46840)
#define STATETREESERIALIZE_STATETREEPROPERTYBINDINGSCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF47310)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyBindingsConverter_TypeDefinitionIndex = 36894;
