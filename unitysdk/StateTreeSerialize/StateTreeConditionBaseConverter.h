...
#define STATETREESERIALIZE_STATETREECONDITIONBASECONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1AF42050)
#define STATETREESERIALIZE_STATETREECONDITIONBASECONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1AF41D10)
#define STATETREESERIALIZE_STATETREECONDITIONBASECONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1AF41AD0)
#define STATETREESERIALIZE_STATETREECONDITIONBASECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF42090)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeConditionBaseConverter_TypeDefinitionIndex = 36929;
