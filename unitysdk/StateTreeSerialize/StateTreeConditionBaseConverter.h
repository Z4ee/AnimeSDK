...
#define STATETREESERIALIZE_STATETREECONDITIONBASECONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1D33A590)
#define STATETREESERIALIZE_STATETREECONDITIONBASECONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1D33A1D0)
#define STATETREESERIALIZE_STATETREECONDITIONBASECONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1D339F90)
#define STATETREESERIALIZE_STATETREECONDITIONBASECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D33A5D0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeConditionBaseConverter_TypeDefinitionIndex = 38541;
