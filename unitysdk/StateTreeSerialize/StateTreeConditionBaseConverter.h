...
#define STATETREESERIALIZE_STATETREECONDITIONBASECONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1E6EC260)
#define STATETREESERIALIZE_STATETREECONDITIONBASECONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1E6EBE90)
#define STATETREESERIALIZE_STATETREECONDITIONBASECONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1E6EBC50)
#define STATETREESERIALIZE_STATETREECONDITIONBASECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6EC2A0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeConditionBaseConverter_TypeDefinitionIndex = 39202;
