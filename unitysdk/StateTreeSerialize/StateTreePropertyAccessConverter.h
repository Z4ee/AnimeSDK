...
#define STATETREESERIALIZE_STATETREEPROPERTYACCESSCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1D33EC40)
#define STATETREESERIALIZE_STATETREEPROPERTYACCESSCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1D33E8D0)
#define STATETREESERIALIZE_STATETREEPROPERTYACCESSCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1D33E6E0)
#define STATETREESERIALIZE_STATETREEPROPERTYACCESSCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D33EC80)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyAccessConverter_TypeDefinitionIndex = 38510;
