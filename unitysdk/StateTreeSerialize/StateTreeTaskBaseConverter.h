...
#define STATETREESERIALIZE_STATETREETASKBASECONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1E6F7740)
#define STATETREESERIALIZE_STATETREETASKBASECONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1E6F71A0)
#define STATETREESERIALIZE_STATETREETASKBASECONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1E6F6EC0)
#define STATETREESERIALIZE_STATETREETASKBASECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6F69E0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeTaskBaseConverter_TypeDefinitionIndex = 39201;
