...
#define STATETREESERIALIZE_STATETREETASKBASECONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1D345A20)
#define STATETREESERIALIZE_STATETREETASKBASECONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1D345480)
#define STATETREESERIALIZE_STATETREETASKBASECONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1D3451A0)
#define STATETREESERIALIZE_STATETREETASKBASECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D344CC0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeTaskBaseConverter_TypeDefinitionIndex = 38540;
