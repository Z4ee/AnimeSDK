...
#define STATETREESERIALIZE_STATETREETASKBASECONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1AF4D820)
#define STATETREESERIALIZE_STATETREETASKBASECONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1AF4D310)
#define STATETREESERIALIZE_STATETREETASKBASECONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1AF4D030)
#define STATETREESERIALIZE_STATETREETASKBASECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF4CB40)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeTaskBaseConverter_TypeDefinitionIndex = 36928;
