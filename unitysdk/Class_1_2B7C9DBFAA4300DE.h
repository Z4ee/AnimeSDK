...
#define CLASS_1_2B7C9DBFAA4300DE_METHOD_1_13A4856CD0BBDB3F_OFFSET UNITYSDK_OFFSET(0x1C748320)
#define CLASS_1_2B7C9DBFAA4300DE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C7485D0)
...
{
public:
	::RPG::GameCore::FixPoint DNPIAKNBJCC; // 0x10
	::RPG::GameCore::FixPoint CONAIKKDGGO; // 0x18
	::RPG::GameCore::FixPoint LIOIAIIHLON; // 0x20
	::RPG::GameCore::FixPoint HBJHAIAJABL; // 0x28
