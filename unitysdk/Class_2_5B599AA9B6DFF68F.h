...
#define CLASS_2_5B599AA9B6DFF68F_BEFOREDISPOSE_OFFSET UNITYSDK_OFFSET(0x19ABD7F0)
#define CLASS_2_5B599AA9B6DFF68F_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19ABDC10)
#define CLASS_2_5B599AA9B6DFF68F_METHOD_2_08E6E5B849FC7A4B_1_OFFSET UNITYSDK_OFFSET(0x19ABF940)
#define CLASS_2_5B599AA9B6DFF68F_METHOD_2_08E6E5B849FC7A4B_2_OFFSET UNITYSDK_OFFSET(0x19ABFA50)
#define CLASS_2_5B599AA9B6DFF68F_METHOD_2_08E6E5B849FC7A4B_OFFSET UNITYSDK_OFFSET(0x19ABF8E0)
#define CLASS_2_5B599AA9B6DFF68F_METHOD_2_091B1F0E0E06E7DD_OFFSET UNITYSDK_OFFSET(0x19ABF9A0)
#define CLASS_2_5B599AA9B6DFF68F_METHOD_2_110F0F8BA45288EF_OFFSET UNITYSDK_OFFSET(0x19ABC840)
#define CLASS_2_5B599AA9B6DFF68F_METHOD_2_1288E4E02611722A_OFFSET UNITYSDK_OFFSET(0x19ABEDD0)
#define CLASS_2_5B599AA9B6DFF68F_METHOD_2_2AB2DA210EBA511D_OFFSET UNITYSDK_OFFSET(0x19ABDDF0)
#define CLASS_2_5B599AA9B6DFF68F_METHOD_2_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0x19ABE850)
#define CLASS_2_5B599AA9B6DFF68F_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x19ABD7A0)
#define CLASS_2_5B599AA9B6DFF68F_METHOD_2_731625464DEE752F_OFFSET UNITYSDK_OFFSET(0x19ABF2E0)
#define CLASS_2_5B599AA9B6DFF68F_METHOD_2_7BA5C34C54F10DFA_OFFSET UNITYSDK_OFFSET(0x19ABD290)
#define CLASS_2_5B599AA9B6DFF68F_METHOD_2_8C0E3211A8AE23ED_OFFSET UNITYSDK_OFFSET(0x19ABE920)
#define CLASS_2_5B599AA9B6DFF68F_METHOD_2_B1B466AFE3B0CC1E_OFFSET UNITYSDK_OFFSET(0x19ABDB70)
#define CLASS_2_5B599AA9B6DFF68F_METHOD_2_BA904CAFF6C7217F_OFFSET UNITYSDK_OFFSET(0x19ABE8A0)
#define CLASS_2_5B599AA9B6DFF68F_METHOD_2_C8E2469222842786_OFFSET UNITYSDK_OFFSET(0x19ABF130)
#define CLASS_2_5B599AA9B6DFF68F_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x19ABFAB0)
#define CLASS_2_5B599AA9B6DFF68F_METHOD_2_DAD3604E9A4C3C87_OFFSET UNITYSDK_OFFSET(0x19ABE7A0)
#define CLASS_2_5B599AA9B6DFF68F_METHOD_2_DB51C66BCC16DD6E_OFFSET UNITYSDK_OFFSET(0x19ABF600)
#define CLASS_2_5B599AA9B6DFF68F_METHOD_2_E0A763B79A4221CB_OFFSET UNITYSDK_OFFSET(0x19ABE6E0)
#define CLASS_2_5B599AA9B6DFF68F_METHOD_2_F04DA50340D2CF1E_OFFSET UNITYSDK_OFFSET(0x19ABC350)
#define CLASS_2_5B599AA9B6DFF68F_ONAFTERMODELARTLOAD_OFFSET UNITYSDK_OFFSET(0x19ABE350)
#define CLASS_2_5B599AA9B6DFF68F_ONBEFOREMODELARTUNLOAD_OFFSET UNITYSDK_OFFSET(0x19ABE140)
#define CLASS_2_5B599AA9B6DFF68F_TICK_OFFSET UNITYSDK_OFFSET(0x19ABD2A0)
#define CLASS_2_5B599AA9B6DFF68F__BEFOREDISPOSE_B__4_0_OFFSET UNITYSDK_OFFSET(0x19ABFBA0)
#define CLASS_2_5B599AA9B6DFF68F__CTOR_OFFSET UNITYSDK_OFFSET(0x19ABFAF0)
#define CLASS_2_5B599AA9B6DFF68F__INITCOMPONENT_B__0_0_OFFSET UNITYSDK_OFFSET(0x19ABFB00)
#define CLASS_2_5B599AA9B6DFF68F__INITCOMPONENT_B__0_1_OFFSET UNITYSDK_OFFSET(0x19ABFB30)
#define CLASS_2_5B599AA9B6DFF68F__INITCOMPONENT_B__0_2_OFFSET UNITYSDK_OFFSET(0x19ABFB70)

inline static constexpr unsigned int Class_2_5B599AA9B6DFF68F_TypeDefinitionIndex = 73219;
...
public:
	...
	::RPG::Client::EraFlipperCommonConfig* IGHAHBNLIJA; // 0x20
	::System::String* MBJBPGDIJOE; // 0x28
	::RPG::GameCore::GameEntity* MOOADPLGAIH; // 0x30
	::RPG::GameCore::PropComponent* NKILIBDMOMC; // 0x38
	::Class_1_1342B57709FD7AC5* OIDAGBPPNBJ; // 0x40
	::RPG::Client::ReasonBool_1<::RPG::Client::EraVisibleReason> EPBLIMCONGG; // 0x48
	::System::UInt32 BGJGFPDIBBD; // 0x50
	::RPG::GameCore::EraStateType BGDKFBODOEO; // 0x54
	::System::Boolean JNMNBBAJFEG; // 0x58
	::System::Boolean GLOGHGMLHFA; // 0x59
	::System::Boolean LJNPFDGIOJA; // 0x5A
	::RPG::Client::EraEntityType LLGKKKFKBBC; // 0x5C
	::System::Boolean EPOBAPFJGBE; // 0x60
	::System::Boolean JBNGIGALLIJ; // 0x61
	::System::Boolean GPPNKACPDEK; // 0x62
	::System::Boolean NOMAHDHHAOC; // 0x63
	::System::Nullable_1<::RPG::Client::TimeSpaceCrisscrossGroupMonoPlugin_TimeSpaceCrisscrossState> HMNJLMFDCAL; // 0x64
	::System::UInt32 KOAIMKCDOIM; // 0x6C
