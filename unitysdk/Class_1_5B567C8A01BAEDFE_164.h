...
#define CLASS_1_5B567C8A01BAEDFE_164_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x192B1CE0)
#define CLASS_1_5B567C8A01BAEDFE_164_CLONE_OFFSET UNITYSDK_OFFSET(0x192B1AF0)
#define CLASS_1_5B567C8A01BAEDFE_164_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x192B1BF0)
#define CLASS_1_5B567C8A01BAEDFE_164_EQUALS_OFFSET UNITYSDK_OFFSET(0x192B1B60)
#define CLASS_1_5B567C8A01BAEDFE_164_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x192B1C40)
#define CLASS_1_5B567C8A01BAEDFE_164_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x192B1D30)
#define CLASS_1_5B567C8A01BAEDFE_164_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x192B1D00)
#define CLASS_1_5B567C8A01BAEDFE_164_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x192B1A40)
#define CLASS_1_5B567C8A01BAEDFE_164_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x192B1AA0)
#define CLASS_1_5B567C8A01BAEDFE_164_TOSTRING_OFFSET UNITYSDK_OFFSET(0x192B1C70)
#define CLASS_1_5B567C8A01BAEDFE_164_WRITETO_OFFSET UNITYSDK_OFFSET(0x192B1CD0)
#define CLASS_1_5B567C8A01BAEDFE_164__CCTOR_OFFSET UNITYSDK_OFFSET(0x192B1D80)
#define CLASS_1_5B567C8A01BAEDFE_164__CTOR_1_OFFSET UNITYSDK_OFFSET(0x192B1AC0)
#define CLASS_1_5B567C8A01BAEDFE_164__CTOR_OFFSET UNITYSDK_OFFSET(0x192B1AB0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_164_TypeDefinitionIndex = 28203;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_164*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_164_TypeDefinitionIndex)->GetStaticField(0x557B0);
	}
