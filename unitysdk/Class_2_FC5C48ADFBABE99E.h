...
#define CLASS_2_FC5C48ADFBABE99E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13C99D30)
#define CLASS_2_FC5C48ADFBABE99E_METHOD_2_2ED6C3773AA1E488_OFFSET UNITYSDK_OFFSET(0x13C9A060)
#define CLASS_2_FC5C48ADFBABE99E_METHOD_2_4EAF60B0FBDC2B64_OFFSET UNITYSDK_OFFSET(0x13C9A4C0)
#define CLASS_2_FC5C48ADFBABE99E_METHOD_2_B386444429A36A77_OFFSET UNITYSDK_OFFSET(0x13C9A660)
#define CLASS_2_FC5C48ADFBABE99E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x13C99E90)
#define CLASS_2_FC5C48ADFBABE99E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x13C9A2E0)
#define CLASS_2_FC5C48ADFBABE99E_TICK_OFFSET UNITYSDK_OFFSET(0x13C9A3C0)
#define CLASS_2_FC5C48ADFBABE99E__CTOR_OFFSET UNITYSDK_OFFSET(0x13C99D20)

inline static constexpr unsigned int Class_2_FC5C48ADFBABE99E_TypeDefinitionIndex = 54841;
...
public:
	...
	::RPG::GameCore::ShowTutorialGuideTalkListDialog* Field_2_3; // 0x30
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Object*))((::PBYTE)hIl2Cpp + CLASS_2_FC5C48ADFBABE99E_METHOD_2_B386444429A36A77_OFFSET))(this, a1);
	}
