...
#define CLASS_2_FC5C48ADFBABE99E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16255E90)
#define CLASS_2_FC5C48ADFBABE99E_METHOD_2_2ED6C3773AA1E488_OFFSET UNITYSDK_OFFSET(0x16256260)
#define CLASS_2_FC5C48ADFBABE99E_METHOD_2_5934C7451F9426C2_OFFSET UNITYSDK_OFFSET(0x162569D0)
#define CLASS_2_FC5C48ADFBABE99E_METHOD_2_D9F60ACC31982A46_OFFSET UNITYSDK_OFFSET(0x162567D0)
#define CLASS_2_FC5C48ADFBABE99E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16256040)
#define CLASS_2_FC5C48ADFBABE99E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x16256550)
#define CLASS_2_FC5C48ADFBABE99E_TICK_OFFSET UNITYSDK_OFFSET(0x16256680)
#define CLASS_2_FC5C48ADFBABE99E__CTOR_OFFSET UNITYSDK_OFFSET(0x16255E80)

inline static constexpr unsigned int Class_2_FC5C48ADFBABE99E_TypeDefinitionIndex = 56072;

class Class_2_FC5C48ADFBABE99E : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_0_16E4307DCC419505_601* Field_2_0; // 0x18
	::RPG::GameCore::ShowTutorialGuideTalkListDialog* Field_2_1; // 0x20
	::Class_0_16E4307DCC419505_603* Field_2_2; // 0x28
