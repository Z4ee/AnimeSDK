...
#define CLASS_2_2CC6EFEAC1D76722_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1875FEA0)
#define CLASS_2_2CC6EFEAC1D76722_METHOD_2_1290EA767C459179_1_OFFSET UNITYSDK_OFFSET(0x18760040)
#define CLASS_2_2CC6EFEAC1D76722_METHOD_2_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x1875FF30)
#define CLASS_2_2CC6EFEAC1D76722_METHOD_2_161BB21D09A261BD_OFFSET UNITYSDK_OFFSET(0x18760150)
#define CLASS_2_2CC6EFEAC1D76722_METHOD_2_41CB8B43C58E8E95_OFFSET UNITYSDK_OFFSET(0x18760160)
#define CLASS_2_2CC6EFEAC1D76722_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1875FEF0)
#define CLASS_2_2CC6EFEAC1D76722__CTOR_OFFSET UNITYSDK_OFFSET(0x18760240)
...
{
public:
	::System::Action_2<::RPG::GameCore::UnitStatus, ::RPG::GameCore::UnitStatus>* JIJMALNHDOG; // 0x18
	::System::Action_1<::System::Boolean>* HDMPDMAPKJP; // 0x20
	::System::Boolean COFDOHGGLCG; // 0x28
	::System::Boolean KIBOPOOCEPL; // 0x29
