...
#define CLASS_1_5B567C8A01BAEDFE_87_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C523740)
#define CLASS_1_5B567C8A01BAEDFE_87_CLONE_OFFSET UNITYSDK_OFFSET(0x1C5233E0)
#define CLASS_1_5B567C8A01BAEDFE_87_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C523540)
#define CLASS_1_5B567C8A01BAEDFE_87_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C523450)
#define CLASS_1_5B567C8A01BAEDFE_87_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C5236A0)
#define CLASS_1_5B567C8A01BAEDFE_87_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C523790)
#define CLASS_1_5B567C8A01BAEDFE_87_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C523760)
#define CLASS_1_5B567C8A01BAEDFE_87_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C523330)
#define CLASS_1_5B567C8A01BAEDFE_87_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C523390)
#define CLASS_1_5B567C8A01BAEDFE_87_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C5236D0)
#define CLASS_1_5B567C8A01BAEDFE_87_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C523730)
#define CLASS_1_5B567C8A01BAEDFE_87__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C5237E0)
#define CLASS_1_5B567C8A01BAEDFE_87__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C5233B0)
#define CLASS_1_5B567C8A01BAEDFE_87__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5233A0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_87_TypeDefinitionIndex = 26535;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_87*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_87_TypeDefinitionIndex)->GetStaticField(0x661C0);
	}
