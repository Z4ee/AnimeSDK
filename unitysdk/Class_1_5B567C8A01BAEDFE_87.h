...
#define CLASS_1_5B567C8A01BAEDFE_87_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A21F080)
#define CLASS_1_5B567C8A01BAEDFE_87_CLONE_OFFSET UNITYSDK_OFFSET(0x1A21EE90)
#define CLASS_1_5B567C8A01BAEDFE_87_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A21EF90)
#define CLASS_1_5B567C8A01BAEDFE_87_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A21EF00)
#define CLASS_1_5B567C8A01BAEDFE_87_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A21EFE0)
#define CLASS_1_5B567C8A01BAEDFE_87_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A21F0D0)
#define CLASS_1_5B567C8A01BAEDFE_87_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A21F0A0)
#define CLASS_1_5B567C8A01BAEDFE_87_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A21EDE0)
#define CLASS_1_5B567C8A01BAEDFE_87_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A21EE40)
#define CLASS_1_5B567C8A01BAEDFE_87_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A21F010)
#define CLASS_1_5B567C8A01BAEDFE_87_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A21F070)
#define CLASS_1_5B567C8A01BAEDFE_87__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A21F120)
#define CLASS_1_5B567C8A01BAEDFE_87__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A21EE60)
#define CLASS_1_5B567C8A01BAEDFE_87__CTOR_OFFSET UNITYSDK_OFFSET(0x1A21EE50)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_87_TypeDefinitionIndex = 25974;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_87*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_87_TypeDefinitionIndex)->GetStaticField(0x11A50);
	}
