...
#define MONOUIEXPANDANDSHRINKCELL_AWAKE_OFFSET UNITYSDK_OFFSET(0xE86FD80)
#define MONOUIEXPANDANDSHRINKCELL_EXPAND_OFFSET UNITYSDK_OFFSET(0xE86FE30)
#define MONOUIEXPANDANDSHRINKCELL_GETFADEINCURVE_OFFSET UNITYSDK_OFFSET(0xE870510)
#define MONOUIEXPANDANDSHRINKCELL_GETFADEOUTCURVE_OFFSET UNITYSDK_OFFSET(0xE870960)
#define MONOUIEXPANDANDSHRINKCELL_GET_CUREXPANDSTATE_OFFSET UNITYSDK_OFFSET(0xE870B30)
#define MONOUIEXPANDANDSHRINKCELL_GET_SIZERATIO_OFFSET UNITYSDK_OFFSET(0xE870620)
#define MONOUIEXPANDANDSHRINKCELL_ISENDTHAN_OFFSET UNITYSDK_OFFSET(0xE8714F0)
#define MONOUIEXPANDANDSHRINKCELL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xE86FDE0)
#define MONOUIEXPANDANDSHRINKCELL_ONRESET_OFFSET UNITYSDK_OFFSET(0xE870A70)
#define MONOUIEXPANDANDSHRINKCELL_PLAYANIM_OFFSET UNITYSDK_OFFSET(0xE8715A0)
#define MONOUIEXPANDANDSHRINKCELL_SAMPLEANIMATION_1_OFFSET UNITYSDK_OFFSET(0xE871910)
#define MONOUIEXPANDANDSHRINKCELL_SAMPLEANIMATION_OFFSET UNITYSDK_OFFSET(0xE870020)
#define MONOUIEXPANDANDSHRINKCELL_SET_SIZERATIO_OFFSET UNITYSDK_OFFSET(0xE871380)
#define MONOUIEXPANDANDSHRINKCELL_SHRINK_OFFSET UNITYSDK_OFFSET(0xE870700)
#define MONOUIEXPANDANDSHRINKCELL_UPDATE_OFFSET UNITYSDK_OFFSET(0xE870B40)
#define MONOUIEXPANDANDSHRINKCELL__CTOR_OFFSET UNITYSDK_OFFSET(0xE871CC0)

inline static constexpr unsigned int MonoUIExpandAndShrinkCell_TypeDefinitionIndex = 51169;
