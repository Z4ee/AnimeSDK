...
#define MONOUIEXPANDANDSHRINKCELL_AWAKE_OFFSET UNITYSDK_OFFSET(0x11BF9A40)
#define MONOUIEXPANDANDSHRINKCELL_EXPAND_OFFSET UNITYSDK_OFFSET(0x11BF9AF0)
#define MONOUIEXPANDANDSHRINKCELL_GETFADEINCURVE_OFFSET UNITYSDK_OFFSET(0x11BFA1D0)
#define MONOUIEXPANDANDSHRINKCELL_GETFADEOUTCURVE_OFFSET UNITYSDK_OFFSET(0x11BFA620)
#define MONOUIEXPANDANDSHRINKCELL_GET_CUREXPANDSTATE_OFFSET UNITYSDK_OFFSET(0x11BFA7F0)
#define MONOUIEXPANDANDSHRINKCELL_GET_SIZERATIO_OFFSET UNITYSDK_OFFSET(0x11BFA2E0)
#define MONOUIEXPANDANDSHRINKCELL_ISENDTHAN_OFFSET UNITYSDK_OFFSET(0x11BFB1B0)
#define MONOUIEXPANDANDSHRINKCELL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x11BF9AA0)
#define MONOUIEXPANDANDSHRINKCELL_ONRESET_OFFSET UNITYSDK_OFFSET(0x11BFA730)
#define MONOUIEXPANDANDSHRINKCELL_PLAYANIM_OFFSET UNITYSDK_OFFSET(0x11BFB260)
#define MONOUIEXPANDANDSHRINKCELL_SAMPLEANIMATION_1_OFFSET UNITYSDK_OFFSET(0x11BFB5D0)
#define MONOUIEXPANDANDSHRINKCELL_SAMPLEANIMATION_OFFSET UNITYSDK_OFFSET(0x11BF9CE0)
#define MONOUIEXPANDANDSHRINKCELL_SET_SIZERATIO_OFFSET UNITYSDK_OFFSET(0x11BFB040)
#define MONOUIEXPANDANDSHRINKCELL_SHRINK_OFFSET UNITYSDK_OFFSET(0x11BFA3C0)
#define MONOUIEXPANDANDSHRINKCELL_UPDATE_OFFSET UNITYSDK_OFFSET(0x11BFA800)
#define MONOUIEXPANDANDSHRINKCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x11BFB980)

inline static constexpr unsigned int MonoUIExpandAndShrinkCell_TypeDefinitionIndex = 67009;
