...
#define CLASS_1_B61DAAE4E79FA3B7_METHOD_1_821BBDC04720A2EB_OFFSET UNITYSDK_OFFSET(0x1848C060)
#define CLASS_1_B61DAAE4E79FA3B7_METHOD_1_8F9DF3D751E1E0BF_OFFSET UNITYSDK_OFFSET(0x1848C590)
#define CLASS_1_B61DAAE4E79FA3B7__CTOR_OFFSET UNITYSDK_OFFSET(0x1848C000)

inline static constexpr unsigned int Class_1_B61DAAE4E79FA3B7_TypeDefinitionIndex = 77932;

class Class_1_B61DAAE4E79FA3B7 : public ::System::Object
{
public:
	::RPG::Client::Prop::ChimeraBattlePuzzleBoard* PNMFAOJNNIC; // 0x10
	::RPG::GameCore::ChimeraBattleShowBubbleTalk* IGHAHBNLIJA; // 0x18
