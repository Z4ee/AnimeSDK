...
#define AKSOUNDENGINE_AUTOOBJECT_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1C43F570)
#define AKSOUNDENGINE_AUTOOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C43F390)

inline static constexpr unsigned int AkSoundEngine_AutoObject_TypeDefinitionIndex = 31477;
