...
#define CLASS_2_462C299C157AF4AB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x195B9FA0)
#define CLASS_2_462C299C157AF4AB_METHOD_2_7223CD34BEFCBF48_OFFSET UNITYSDK_OFFSET(0x195B9C10)
#define CLASS_2_462C299C157AF4AB_METHOD_2_ED79705457B92B5C_OFFSET UNITYSDK_OFFSET(0x195B9CB0)
#define CLASS_2_462C299C157AF4AB_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x195B9AF0)
#define CLASS_2_462C299C157AF4AB_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x195B9AA0)
#define CLASS_2_462C299C157AF4AB_TICK_OFFSET UNITYSDK_OFFSET(0x195B9F40)
#define CLASS_2_462C299C157AF4AB__CTOR_OFFSET UNITYSDK_OFFSET(0x195B9A90)
...
{
public:
	::RPG::Client::AdventurePhase* HAGFACOEAFD; // 0x18
	::RPG::GameCore::TriggerAetherDivideBattle* EJJEEJENLDA; // 0x20
