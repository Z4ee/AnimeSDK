...
#define LUMI_GEOMETRYLIBRARY_SCRIPTS_DYNAMICMESHCOMPONENT_CLASS_3_FA9425483BAC14EE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x90BDC10)
#define LUMI_GEOMETRYLIBRARY_SCRIPTS_DYNAMICMESHCOMPONENT_CLASS_3_FA9425483BAC14EE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x90BDC40)
#define LUMI_GEOMETRYLIBRARY_SCRIPTS_DYNAMICMESHCOMPONENT_CLASS_3_FA9425483BAC14EE_INVOKE_OFFSET UNITYSDK_OFFSET(0x90BD6C0)
#define LUMI_GEOMETRYLIBRARY_SCRIPTS_DYNAMICMESHCOMPONENT_CLASS_3_FA9425483BAC14EE__CTOR_OFFSET UNITYSDK_OFFSET(0x90BD6A0)

namespace Lumi::GeometryLibrary::Scripts
{
	inline static constexpr unsigned int DynamicMeshComponent_Class_3_FA9425483BAC14EE_TypeDefinitionIndex = 44474;
