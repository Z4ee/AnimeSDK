...
#define LUMI_GEOMETRYLIBRARY_SCRIPTS_DYNAMICMESHCOMPONENT_CLASS_3_FA9425483BAC14EE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x118EB810)
#define LUMI_GEOMETRYLIBRARY_SCRIPTS_DYNAMICMESHCOMPONENT_CLASS_3_FA9425483BAC14EE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x118EB840)
#define LUMI_GEOMETRYLIBRARY_SCRIPTS_DYNAMICMESHCOMPONENT_CLASS_3_FA9425483BAC14EE_INVOKE_OFFSET UNITYSDK_OFFSET(0x118EB2C0)
#define LUMI_GEOMETRYLIBRARY_SCRIPTS_DYNAMICMESHCOMPONENT_CLASS_3_FA9425483BAC14EE__CTOR_OFFSET UNITYSDK_OFFSET(0x118EB2A0)

namespace Lumi::GeometryLibrary::Scripts
{
	inline static constexpr unsigned int DynamicMeshComponent_Class_3_FA9425483BAC14EE_TypeDefinitionIndex = 38583;
