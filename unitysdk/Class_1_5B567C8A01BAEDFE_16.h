...
#define CLASS_1_5B567C8A01BAEDFE_16_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19C599A0)
#define CLASS_1_5B567C8A01BAEDFE_16_CLONE_OFFSET UNITYSDK_OFFSET(0x19C59810)
#define CLASS_1_5B567C8A01BAEDFE_16_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19C598B0)
#define CLASS_1_5B567C8A01BAEDFE_16_EQUALS_OFFSET UNITYSDK_OFFSET(0x19C59850)
#define CLASS_1_5B567C8A01BAEDFE_16_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19C59900)
#define CLASS_1_5B567C8A01BAEDFE_16_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19C599F0)
#define CLASS_1_5B567C8A01BAEDFE_16_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19C599C0)
#define CLASS_1_5B567C8A01BAEDFE_16_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19C59790)
#define CLASS_1_5B567C8A01BAEDFE_16_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19C597C0)
#define CLASS_1_5B567C8A01BAEDFE_16_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19C59930)
#define CLASS_1_5B567C8A01BAEDFE_16_WRITETO_OFFSET UNITYSDK_OFFSET(0x19C59990)
#define CLASS_1_5B567C8A01BAEDFE_16__CCTOR_OFFSET UNITYSDK_OFFSET(0x19C59A40)
#define CLASS_1_5B567C8A01BAEDFE_16__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19C597E0)
#define CLASS_1_5B567C8A01BAEDFE_16__CTOR_OFFSET UNITYSDK_OFFSET(0x19C597D0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_16_TypeDefinitionIndex = 24818;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_16*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_16_TypeDefinitionIndex)->GetStaticField(0x5E6A0);
	}
