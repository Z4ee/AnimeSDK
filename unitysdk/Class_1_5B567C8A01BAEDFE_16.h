...
#define CLASS_1_5B567C8A01BAEDFE_16_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1ED92F00)
#define CLASS_1_5B567C8A01BAEDFE_16_CLONE_OFFSET UNITYSDK_OFFSET(0x1ED92BF0)
#define CLASS_1_5B567C8A01BAEDFE_16_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1ED92D00)
#define CLASS_1_5B567C8A01BAEDFE_16_EQUALS_OFFSET UNITYSDK_OFFSET(0x1ED92C30)
#define CLASS_1_5B567C8A01BAEDFE_16_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1ED92E60)
#define CLASS_1_5B567C8A01BAEDFE_16_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1ED92F50)
#define CLASS_1_5B567C8A01BAEDFE_16_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1ED92F20)
#define CLASS_1_5B567C8A01BAEDFE_16_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1ED92B70)
#define CLASS_1_5B567C8A01BAEDFE_16_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1ED92BA0)
#define CLASS_1_5B567C8A01BAEDFE_16_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1ED92E90)
#define CLASS_1_5B567C8A01BAEDFE_16_WRITETO_OFFSET UNITYSDK_OFFSET(0x1ED92EF0)
#define CLASS_1_5B567C8A01BAEDFE_16__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ED92FA0)
#define CLASS_1_5B567C8A01BAEDFE_16__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ED92BC0)
#define CLASS_1_5B567C8A01BAEDFE_16__CTOR_OFFSET UNITYSDK_OFFSET(0x1ED92BB0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_16_TypeDefinitionIndex = 25762;

class Class_1_5B567C8A01BAEDFE_16 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_16*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_16*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_16_TypeDefinitionIndex)->GetStaticField(0x62030);
	}
