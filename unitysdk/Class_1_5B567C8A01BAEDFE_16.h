...
#define CLASS_1_5B567C8A01BAEDFE_16_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A72EE50)
#define CLASS_1_5B567C8A01BAEDFE_16_CLONE_OFFSET UNITYSDK_OFFSET(0x1A72ECC0)
#define CLASS_1_5B567C8A01BAEDFE_16_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A72ED60)
#define CLASS_1_5B567C8A01BAEDFE_16_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A72ED00)
#define CLASS_1_5B567C8A01BAEDFE_16_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A72EDB0)
#define CLASS_1_5B567C8A01BAEDFE_16_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A72EEA0)
#define CLASS_1_5B567C8A01BAEDFE_16_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A72EE70)
#define CLASS_1_5B567C8A01BAEDFE_16_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A72EC40)
#define CLASS_1_5B567C8A01BAEDFE_16_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A72EC70)
#define CLASS_1_5B567C8A01BAEDFE_16_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A72EDE0)
#define CLASS_1_5B567C8A01BAEDFE_16_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A72EE40)
#define CLASS_1_5B567C8A01BAEDFE_16__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A72EEF0)
#define CLASS_1_5B567C8A01BAEDFE_16__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A72EC90)
#define CLASS_1_5B567C8A01BAEDFE_16__CTOR_OFFSET UNITYSDK_OFFSET(0x1A72EC80)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_16_TypeDefinitionIndex = 24679;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_16*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_16_TypeDefinitionIndex)->GetStaticField(0x3DEF0);
	}
