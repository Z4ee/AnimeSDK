...
#define HIPPLENBUILDERTESTASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x17A6A7D0)

inline static constexpr unsigned int HipplenBuilderTestAsset_TypeDefinitionIndex = 45442;
