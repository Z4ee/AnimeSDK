...
#define CLASS_2_3AED00A354FF7FA1_METHOD_2_0A0D9CC2EC744C6B_OFFSET UNITYSDK_OFFSET(0x17CD71F0)
#define CLASS_2_3AED00A354FF7FA1_METHOD_2_15169B7DEE2D29F3_OFFSET UNITYSDK_OFFSET(0x17CD6CF0)
#define CLASS_2_3AED00A354FF7FA1_METHOD_2_17DD0384C21E3497_OFFSET UNITYSDK_OFFSET(0x17CD6E20)
#define CLASS_2_3AED00A354FF7FA1_METHOD_2_1CC4F6DB6780B6F9_OFFSET UNITYSDK_OFFSET(0x17CD6FD0)
#define CLASS_2_3AED00A354FF7FA1_METHOD_2_1D3E0D19D91C431C_OFFSET UNITYSDK_OFFSET(0x17CD6B30)
#define CLASS_2_3AED00A354FF7FA1_METHOD_2_2CBE0B79DD36047E_OFFSET UNITYSDK_OFFSET(0x17CD52B0)
#define CLASS_2_3AED00A354FF7FA1_METHOD_2_3429B5D19B31C90F_OFFSET UNITYSDK_OFFSET(0x17CD60C0)
#define CLASS_2_3AED00A354FF7FA1_METHOD_2_3B258437A86233AC_OFFSET UNITYSDK_OFFSET(0x17CD5080)
#define CLASS_2_3AED00A354FF7FA1_METHOD_2_3FCF62A0B1BFB5E7_OFFSET UNITYSDK_OFFSET(0x17CD69A0)
#define CLASS_2_3AED00A354FF7FA1_METHOD_2_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0x17CD7700)
#define CLASS_2_3AED00A354FF7FA1_METHOD_2_84EAB34EABC7F508_OFFSET UNITYSDK_OFFSET(0x17CD4F70)
#define CLASS_2_3AED00A354FF7FA1_METHOD_2_A8B662A2CC4B2F7D_OFFSET UNITYSDK_OFFSET(0x17CD72C0)
#define CLASS_2_3AED00A354FF7FA1_METHOD_2_C6B406092075024B_OFFSET UNITYSDK_OFFSET(0x17CD63D0)
#define CLASS_2_3AED00A354FF7FA1_METHOD_2_F4BCBAA3555FAF27_OFFSET UNITYSDK_OFFSET(0x17CD6300)
#define CLASS_2_3AED00A354FF7FA1_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x17CD5E10)
#define CLASS_2_3AED00A354FF7FA1_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x17CD4C70)
#define CLASS_2_3AED00A354FF7FA1_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0x17CD4B10)
#define CLASS_2_3AED00A354FF7FA1_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0x17CD4BC0)
#define CLASS_2_3AED00A354FF7FA1_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x17CD5EE0)
#define CLASS_2_3AED00A354FF7FA1__CTOR_OFFSET UNITYSDK_OFFSET(0x17CD7750)
...
{
public:
	::RPGTools::Timeline::MonoEffectFollowTimelinePlugin* EJCBMGAJDIG; // 0x10
	::UnityEngine::Object* NCPNKDBIINJ; // 0x18
	::RPG::Client::MonoEffect* AHLFACIHKKK; // 0x20
	::RPGTools::MonoTimelineEffect* LJOGFMELNBH; // 0x28
	::RPGTools::Timeline::VFX::VFXTimelineClip* OBKONNDLKDL; // 0x30
	::Class_1_4B703F2764047929* PGNKDKLMBJJ; // 0x38
	::UnityEngine::GameObject* HCLHNCAMGHL; // 0x40
	::UnityEngine::Transform* CHGLKBIEMFK; // 0x48
	::UnityEngine::Timeline::TrackAsset* CIBMFKKGFGN; // 0x50
	::UnityEngine::Playables::PlayableDirector* LDALFGDPLLF; // 0x58
