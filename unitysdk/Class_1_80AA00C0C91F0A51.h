...
#define CLASS_1_80AA00C0C91F0A51_EXECUTE_OFFSET UNITYSDK_OFFSET(0x18B388C0)
#define CLASS_1_80AA00C0C91F0A51_METHOD_1_0C1D1D0673982C1F_OFFSET UNITYSDK_OFFSET(0x18B38C10)
#define CLASS_1_80AA00C0C91F0A51_METHOD_1_C796A0B42720FBD3_OFFSET UNITYSDK_OFFSET(0x18B38A20)
#define CLASS_1_80AA00C0C91F0A51__CTOR_OFFSET UNITYSDK_OFFSET(0x18B38760)

inline static constexpr unsigned int Class_1_80AA00C0C91F0A51_TypeDefinitionIndex = 35113;
...
public:
	...
	::Entitas::IGroup_1<::Class_2_21AD365C113DC484*>* Field_1_3; // 0x28
	::System::Int32 Field_1_4; // 0x30

	::System::Void _ctor(::Class_2_3616FDE8A71D0590_2* a1, ::Class_2_F3C45F1FC7349B6E* a2)
	{
		return ((::System::Void(*)(::PVOID, ::Class_2_3616FDE8A71D0590_2*, ::Class_2_F3C45F1FC7349B6E*))((::PBYTE)hIl2Cpp + CLASS_1_80AA00C0C91F0A51__CTOR_OFFSET))(this, a1, a2);
	}
