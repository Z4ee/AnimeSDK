...
#define CLASS_1_80AA00C0C91F0A51_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1C24C4F0)
#define CLASS_1_80AA00C0C91F0A51_METHOD_1_0C1D1D0673982C1F_OFFSET UNITYSDK_OFFSET(0x1C24C840)
#define CLASS_1_80AA00C0C91F0A51_METHOD_1_C796A0B42720FBD3_OFFSET UNITYSDK_OFFSET(0x1C24C650)
#define CLASS_1_80AA00C0C91F0A51__CTOR_OFFSET UNITYSDK_OFFSET(0x1C24C390)
...
public:
	...
	::Entitas::IGroup_1<::Class_2_21AD365C113DC484*>* KGPHOAEPHHP; // 0x18
	::Class_2_3616FDE8A71D0590_1* EEFMDEHLLFI; // 0x20
	::Entitas::IGroup_1<::Class_2_21AD365C113DC484*>* NCGEECDENGP; // 0x28
