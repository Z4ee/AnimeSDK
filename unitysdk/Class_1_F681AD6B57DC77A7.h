...
#define CLASS_1_F681AD6B57DC77A7_GET_BATTLEAREAID_OFFSET UNITYSDK_OFFSET(0xC128430)
#define CLASS_1_F681AD6B57DC77A7_GET_BESTROUND_OFFSET UNITYSDK_OFFSET(0xC1284F0)
#define CLASS_1_F681AD6B57DC77A7_GET_BUFFS_OFFSET UNITYSDK_OFFSET(0xC128490)
#define CLASS_1_F681AD6B57DC77A7_GET_DISPLAYMONSTERID_OFFSET UNITYSDK_OFFSET(0xC128450)
#define CLASS_1_F681AD6B57DC77A7_GET_ID_OFFSET UNITYSDK_OFFSET(0xC1283F0)
#define CLASS_1_F681AD6B57DC77A7_GET_MONSTERDECOIMAGEPATH_OFFSET UNITYSDK_OFFSET(0xC128470)
#define CLASS_1_F681AD6B57DC77A7_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC1284B0)
#define CLASS_1_F681AD6B57DC77A7_GET_PASSEDLEVEL_OFFSET UNITYSDK_OFFSET(0xC1284D0)
#define CLASS_1_F681AD6B57DC77A7_GET_STAGEID_OFFSET UNITYSDK_OFFSET(0xC128410)
#define CLASS_1_F681AD6B57DC77A7_SET_BATTLEAREAID_OFFSET UNITYSDK_OFFSET(0xC128440)
#define CLASS_1_F681AD6B57DC77A7_SET_BESTROUND_OFFSET UNITYSDK_OFFSET(0xC128500)
#define CLASS_1_F681AD6B57DC77A7_SET_BUFFS_OFFSET UNITYSDK_OFFSET(0xC1284A0)
#define CLASS_1_F681AD6B57DC77A7_SET_DISPLAYMONSTERID_OFFSET UNITYSDK_OFFSET(0xC128460)
#define CLASS_1_F681AD6B57DC77A7_SET_ID_OFFSET UNITYSDK_OFFSET(0xC128400)
#define CLASS_1_F681AD6B57DC77A7_SET_MONSTERDECOIMAGEPATH_OFFSET UNITYSDK_OFFSET(0xC128480)
#define CLASS_1_F681AD6B57DC77A7_SET_NAME_OFFSET UNITYSDK_OFFSET(0xC1284C0)
#define CLASS_1_F681AD6B57DC77A7_SET_PASSEDLEVEL_OFFSET UNITYSDK_OFFSET(0xC1284E0)
#define CLASS_1_F681AD6B57DC77A7_SET_STAGEID_OFFSET UNITYSDK_OFFSET(0xC128420)
#define CLASS_1_F681AD6B57DC77A7__CTOR_OFFSET UNITYSDK_OFFSET(0xC128510)

inline static constexpr unsigned int Class_1_F681AD6B57DC77A7_TypeDefinitionIndex = 79695;
...
public:
	...
	::System::UInt32 _DisplayMonsterID_k__BackingField; // 0x20
	::System::UInt32 _PassedLevel_k__BackingField; // 0x24
	::System::UInt32 _StageID_k__BackingField; // 0x28
	::System::UInt32 _BattleAreaID_k__BackingField; // 0x2C
	::System::UInt32 _BestRound_k__BackingField; // 0x30
