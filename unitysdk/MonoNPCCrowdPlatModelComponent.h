...
#define MONONPCCROWDPLATMODELCOMPONENT_ACQUIRECLIPTEXTUREIFNEEDED_OFFSET UNITYSDK_OFFSET(0x162FB020)
#define MONONPCCROWDPLATMODELCOMPONENT_GET_CACHEMATERIALPROPBLOCK_OFFSET UNITYSDK_OFFSET(0x162F9A90)
#define MONONPCCROWDPLATMODELCOMPONENT_GET_GPUMESHRENDER_OFFSET UNITYSDK_OFFSET(0x162F9A80)
#define MONONPCCROWDPLATMODELCOMPONENT_INITMATERIALPARAMS_OFFSET UNITYSDK_OFFSET(0x162F9B30)
#define MONONPCCROWDPLATMODELCOMPONENT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x162FAFE0)
#define MONONPCCROWDPLATMODELCOMPONENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x162FACE0)
#define MONONPCCROWDPLATMODELCOMPONENT_ONFRAMEINDEXCHANGED_OFFSET UNITYSDK_OFFSET(0x162FBA10)
#define MONONPCCROWDPLATMODELCOMPONENT_RELEASECLIPTEXTUREIFNEEDED_OFFSET UNITYSDK_OFFSET(0x162FB4A0)
#define MONONPCCROWDPLATMODELCOMPONENT_TRIGGERDITHER_OFFSET UNITYSDK_OFFSET(0x162FB670)
#define MONONPCCROWDPLATMODELCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x162FBD30)

inline static constexpr unsigned int MonoNPCCrowdPlatModelComponent_TypeDefinitionIndex = 65798;
