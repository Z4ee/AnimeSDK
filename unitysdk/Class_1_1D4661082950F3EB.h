...
{
public:
	static ::MoleMole::ELocalPlayType Method_1_2C79CE8457598A8C()
	{
		return ((::MoleMole::ELocalPlayType(*)())((::PBYTE)hIl2Cpp + CLASS_1_1D4661082950F3EB_METHOD_1_2C79CE8457598A8C_OFFSET))();
	}
};
