...
#define STAGEHARMONYMATLINKSLOT_GET_ISSINGLERENDERER_OFFSET UNITYSDK_OFFSET(0xE93F9B0)
#define STAGEHARMONYMATLINKSLOT_METHOD_2_03BFDB1C3240A55A_OFFSET UNITYSDK_OFFSET(0xE93F9C0)
#define STAGEHARMONYMATLINKSLOT_METHOD_2_04A4B365E89A7C7D_OFFSET UNITYSDK_OFFSET(0xE93FD70)
#define STAGEHARMONYMATLINKSLOT_METHOD_2_3D2B77EBCAE390AB_OFFSET UNITYSDK_OFFSET(0xE93FC10)
#define STAGEHARMONYMATLINKSLOT_METHOD_2_482601AC39388AEF_OFFSET UNITYSDK_OFFSET(0xE93FF00)
#define STAGEHARMONYMATLINKSLOT_METHOD_2_51120F267FCE261F_OFFSET UNITYSDK_OFFSET(0xE9404B0)
#define STAGEHARMONYMATLINKSLOT_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xE93FBD0)
#define STAGEHARMONYMATLINKSLOT_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xE93FB80)
#define STAGEHARMONYMATLINKSLOT_METHOD_2_D7A3826BE77D1015_OFFSET UNITYSDK_OFFSET(0xE93FFE0)
#define STAGEHARMONYMATLINKSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0xE940B10)
