...
#define TASKTREETEST__SETTASK_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x755210)
#define TASKTREETEST__SETTASK_D__4_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x55E040)

inline static constexpr unsigned int TaskTreeTest__SetTask_d__4_TypeDefinitionIndex = 65433;

struct alignas(8) TaskTreeTest__SetTask_d__4
{
	::System::Runtime::CompilerServices::TaskAwaiter_1<::System::Int32> __u__1; // 0x10
	::System::Threading::Tasks::TaskCompletionSource_1<::System::Int32>* taskCompletionSource; // 0x18
