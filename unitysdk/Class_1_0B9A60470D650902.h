...
#define CLASS_1_0B9A60470D650902_CLEAR_OFFSET UNITYSDK_OFFSET(0x123F5210)
#define CLASS_1_0B9A60470D650902_GETUNEVALUATEDNEXTSTATE_OFFSET UNITYSDK_OFFSET(0x123F56F0)
#define CLASS_1_0B9A60470D650902_GETUNITYANIMATOR_OFFSET UNITYSDK_OFFSET(0x123F5780)
#define CLASS_1_0B9A60470D650902_GET_ANIMATORMOVECALLBACKORDER_OFFSET UNITYSDK_OFFSET(0x123F57C0)
#define CLASS_1_0B9A60470D650902_GET_ANIMATORNOTINIT_OFFSET UNITYSDK_OFFSET(0x123F5660)
#define CLASS_1_0B9A60470D650902_GET_DYNAMICANIMEVENTDATALIST_OFFSET UNITYSDK_OFFSET(0x123F56C0)
#define CLASS_1_0B9A60470D650902_GET_ENABLEANIMATORMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x123F57D0)
#define CLASS_1_0B9A60470D650902_GET_NEEDRESETEVENT_OFFSET UNITYSDK_OFFSET(0x123F5680)
#define CLASS_1_0B9A60470D650902_GET_ONANIMATIONSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x123F56A0)
#define CLASS_1_0B9A60470D650902_GET_ONANIMATORMOVECALLBACKMAP_OFFSET UNITYSDK_OFFSET(0x123F56E0)
#define CLASS_1_0B9A60470D650902_GET_REENTRYCOUNTER_OFFSET UNITYSDK_OFFSET(0x123F5640)
#define CLASS_1_0B9A60470D650902_GET_TASKCONTEXT_OFFSET UNITYSDK_OFFSET(0x123F55B0)
#define CLASS_1_0B9A60470D650902_GET_WORLDREF_OFFSET UNITYSDK_OFFSET(0x123F5580)
#define CLASS_1_0B9A60470D650902_METHOD_1_1D148E040584EEBC_OFFSET UNITYSDK_OFFSET(0x123F50F0)
#define CLASS_1_0B9A60470D650902_METHOD_1_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x123F54E0)
#define CLASS_1_0B9A60470D650902_METHOD_1_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x123F55D0)
#define CLASS_1_0B9A60470D650902_METHOD_1_892D0C7F01734DAA_OFFSET UNITYSDK_OFFSET(0x123F5010)
#define CLASS_1_0B9A60470D650902_METHOD_1_B1445E8504415D4D_OFFSET UNITYSDK_OFFSET(0x123F55A0)
#define CLASS_1_0B9A60470D650902_METHOD_1_F7A1793118115C9E_OFFSET UNITYSDK_OFFSET(0x123F4E50)
#define CLASS_1_0B9A60470D650902_METHOD_1_FAC3436B3B22B430_OFFSET UNITYSDK_OFFSET(0x123F5410)
#define CLASS_1_0B9A60470D650902_ONANIMATORMOVE_OFFSET UNITYSDK_OFFSET(0x123F57E0)
#define CLASS_1_0B9A60470D650902_QUERYSTATENORAMLIZEDSTARTTIME_OFFSET UNITYSDK_OFFSET(0x123F5730)
#define CLASS_1_0B9A60470D650902_SET_ANIMATORNOTINIT_OFFSET UNITYSDK_OFFSET(0x123F5670)
#define CLASS_1_0B9A60470D650902_SET_DYNAMICANIMEVENTDATALIST_OFFSET UNITYSDK_OFFSET(0x123F56D0)
#define CLASS_1_0B9A60470D650902_SET_NEEDRESETEVENT_OFFSET UNITYSDK_OFFSET(0x123F5690)
#define CLASS_1_0B9A60470D650902_SET_ONANIMATIONSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x123F56B0)
#define CLASS_1_0B9A60470D650902_SET_REENTRYCOUNTER_OFFSET UNITYSDK_OFFSET(0x123F5650)
#define CLASS_1_0B9A60470D650902_SET_TASKCONTEXT_OFFSET UNITYSDK_OFFSET(0x123F55C0)
#define CLASS_1_0B9A60470D650902_SET_WORLDREF_OFFSET UNITYSDK_OFFSET(0x123F5590)
#define CLASS_1_0B9A60470D650902__CCTOR_OFFSET UNITYSDK_OFFSET(0x123F5BA0)
#define CLASS_1_0B9A60470D650902__CTOR_OFFSET UNITYSDK_OFFSET(0x123F5AA0)

inline static constexpr unsigned int Class_1_0B9A60470D650902_TypeDefinitionIndex = 70988;
...
public:
	...
	{
		return (::Unity::Profiling::ProfilerMarkerWithObject*)Il2CppClass::FromTypeDefinitionIndex(Class_1_0B9A60470D650902_TypeDefinitionIndex)->GetStaticField(0x36B0);
	}
	::Struct_2_2B16FFFF87B43037 Field_1_13; // 0x10
	::System::Collections::Generic::Dictionary_2<::System::String*, ::Class_0_16E4307DCC419505_386_Class_3_410EEB4A0F592FBB*>* _OnAnimatorMoveCallbackMap_k__BackingField; // 0x20
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_0_16E4307DCC419505_97*>* Field_1_15; // 0x28
	::Class_0_16E4307DCC419505_386_Class_3_363670394F299996* _OnAnimationStateChange_k__BackingField; // 0x30
	::Il2CppArray<::System::String*>* Field_1_11; // 0x38
	::Class_1_FD7BA687A1A99180* Field_1_14; // 0x40
	...
	::System::Collections::Generic::List_1<::Class_1_38A5D85D4AE9F24D*>* _DynamicAnimEventDataList_k__BackingField; // 0x60
	::RPG::GameCore::TaskContext* _TaskContext_k__BackingField; // 0x68
	::Entitas::IEntity* Field_1_8; // 0x70
	::Il2CppArray<::System::String*>* Field_1_10; // 0x78
	::System::UInt32 Field_1_16; // 0x80
	::System::Int32 _ReEntryCounter_k__BackingField; // 0x84
	::System::Boolean _AnimatorNotInit_k__BackingField; // 0x88
	::System::Boolean _NeedResetEvent_k__BackingField; // 0x89
	...
	{
		return ((::Class_0_16E4307DCC419505_386_Class_3_363670394F299996*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_0B9A60470D650902_GET_ONANIMATIONSTATECHANGE_OFFSET))(this);
	}

	::System::Void set_OnAnimationStateChange(::Class_0_16E4307DCC419505_386_Class_3_363670394F299996* value)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_386_Class_3_363670394F299996*))((::PBYTE)hIl2Cpp + CLASS_1_0B9A60470D650902_SET_ONANIMATIONSTATECHANGE_OFFSET))(this, value);
	}
	...
	{
		return ((::System::Collections::Generic::Dictionary_2<::System::String*, ::Class_0_16E4307DCC419505_386_Class_3_410EEB4A0F592FBB*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_0B9A60470D650902_GET_ONANIMATORMOVECALLBACKMAP_OFFSET))(this);
	}
