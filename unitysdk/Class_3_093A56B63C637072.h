...
#define CLASS_3_093A56B63C637072_METHOD_3_B291FB5C41D58000_OFFSET UNITYSDK_OFFSET(0x1CCA1830)
#define CLASS_3_093A56B63C637072_METHOD_3_F32CA7BD1D486055_OFFSET UNITYSDK_OFFSET(0x1CCA17C0)
#define CLASS_3_093A56B63C637072__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCA1810)
...
public:
	...
	::RPG::GameCore::PPEffectFilterPriorityGroup OMJNGMHJPBD; // 0x24
	::System::Single JGNDPDFEBBO; // 0x28
	::System::Single IIPKCANDFBK; // 0x2C
	::System::Boolean IOBJFEJFLJP; // 0x30
	::System::Boolean FIKBKDJAFON; // 0x31
	::System::Single IEHPFADHJFD; // 0x34
	::RPG::GameCore::PPEffectFilterPriority NALMBOOCCIN; // 0x38
