...
public:
	...
	{
		return (::System::Predicate_1<::RPG::GameCore::GameEntity*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_44E46407C2A1CEEE___O_TypeDefinitionIndex)->GetStaticField(0x43EA0);
	}
};
