...
#define CLASS_3_6473C61C5360CBFE_METHOD_3_1AFF05DC1082906B_OFFSET UNITYSDK_OFFSET(0xC0BAE20)
#define CLASS_3_6473C61C5360CBFE_METHOD_3_84EAB34EABC7F508_OFFSET UNITYSDK_OFFSET(0xC0BA920)
#define CLASS_3_6473C61C5360CBFE_METHOD_3_A75AE34C285CC4D2_OFFSET UNITYSDK_OFFSET(0xC0B9740)
#define CLASS_3_6473C61C5360CBFE_METHOD_3_AB9B9E71B0D7294E_OFFSET UNITYSDK_OFFSET(0xC0BA870)
#define CLASS_3_6473C61C5360CBFE_METHOD_3_E9A575D18A0748D9_OFFSET UNITYSDK_OFFSET(0xC0B9A40)
#define CLASS_3_6473C61C5360CBFE_METHOD_3_FEBAE9E88E8E4148_OFFSET UNITYSDK_OFFSET(0xC0B9A90)
#define CLASS_3_6473C61C5360CBFE_ONBTNCANCELCLICK_OFFSET UNITYSDK_OFFSET(0xC0BA9F0)
#define CLASS_3_6473C61C5360CBFE_ONBTNDETAILCLICK_OFFSET UNITYSDK_OFFSET(0xC0BABF0)
#define CLASS_3_6473C61C5360CBFE__CTOR_OFFSET UNITYSDK_OFFSET(0xC0B99C0)
#define CLASS_3_6473C61C5360CBFE__CUSTOMBINDVIEW_OFFSET UNITYSDK_OFFSET(0xC0B9D60)
#define CLASS_3_6473C61C5360CBFE__SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xC0B9EA0)
#define CLASS_3_6473C61C5360CBFE___IFIXBASEPROXY_ONBTNCANCELCLICK_OFFSET UNITYSDK_OFFSET(0xC0BB040)
#define CLASS_3_6473C61C5360CBFE___IFIXBASEPROXY_ONBTNDETAILCLICK_OFFSET UNITYSDK_OFFSET(0xC0BB050)
#define CLASS_3_6473C61C5360CBFE___IFIXBASEPROXY__CUSTOMBINDVIEW_OFFSET UNITYSDK_OFFSET(0xC0BB020)
#define CLASS_3_6473C61C5360CBFE___IFIXBASEPROXY__SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xC0BB030)

inline static constexpr unsigned int Class_3_6473C61C5360CBFE_TypeDefinitionIndex = 66991;
