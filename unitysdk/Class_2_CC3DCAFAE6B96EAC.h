...
#define CLASS_2_CC3DCAFAE6B96EAC_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x127ACC50)
#define CLASS_2_CC3DCAFAE6B96EAC_METHOD_2_4E140453C4B32F06_OFFSET UNITYSDK_OFFSET(0x127ACC60)
#define CLASS_2_CC3DCAFAE6B96EAC_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x127ACD50)
#define CLASS_2_CC3DCAFAE6B96EAC_RESET_OFFSET UNITYSDK_OFFSET(0x127ACCD0)
#define CLASS_2_CC3DCAFAE6B96EAC__CTOR_OFFSET UNITYSDK_OFFSET(0x127ACC40)

inline static constexpr unsigned int Class_2_CC3DCAFAE6B96EAC_TypeDefinitionIndex = 38636;
