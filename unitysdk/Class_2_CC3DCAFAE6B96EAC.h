...
#define CLASS_2_CC3DCAFAE6B96EAC_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x12CC1C70)
#define CLASS_2_CC3DCAFAE6B96EAC_METHOD_2_4E140453C4B32F06_OFFSET UNITYSDK_OFFSET(0x12CC1C80)
#define CLASS_2_CC3DCAFAE6B96EAC_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x12CC1D70)
#define CLASS_2_CC3DCAFAE6B96EAC_RESET_OFFSET UNITYSDK_OFFSET(0x12CC1CF0)
#define CLASS_2_CC3DCAFAE6B96EAC__CTOR_OFFSET UNITYSDK_OFFSET(0x12CC1C60)

inline static constexpr unsigned int Class_2_CC3DCAFAE6B96EAC_TypeDefinitionIndex = 55459;
