...
#define CLASS_2_35962C2B7535512E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C2A4F40)
#define CLASS_2_35962C2B7535512E_GET_AISERVICE_OFFSET UNITYSDK_OFFSET(0x1C2A50C0)
#define CLASS_2_35962C2B7535512E_GET_INPUTSERVICE_OFFSET UNITYSDK_OFFSET(0x1C2A50A0)
#define CLASS_2_35962C2B7535512E_GET_INSTANCECLIENT_OFFSET UNITYSDK_OFFSET(0x1C2A50F0)
#define CLASS_2_35962C2B7535512E_GET_PHYSICS2DSERVICE_OFFSET UNITYSDK_OFFSET(0x1C2A5080)
#define CLASS_2_35962C2B7535512E_GET_RANDSERVICE_OFFSET UNITYSDK_OFFSET(0x1C2A5060)
#define CLASS_2_35962C2B7535512E_METHOD_2_43A46E5F9FAC62B8_OFFSET UNITYSDK_OFFSET(0x1C2A50E0)
#define CLASS_2_35962C2B7535512E_SET_AISERVICE_OFFSET UNITYSDK_OFFSET(0x1C2A50D0)
#define CLASS_2_35962C2B7535512E_SET_INPUTSERVICE_OFFSET UNITYSDK_OFFSET(0x1C2A50B0)
#define CLASS_2_35962C2B7535512E_SET_INSTANCECLIENT_OFFSET UNITYSDK_OFFSET(0x1C2A5100)
#define CLASS_2_35962C2B7535512E_SET_PHYSICS2DSERVICE_OFFSET UNITYSDK_OFFSET(0x1C2A5090)
#define CLASS_2_35962C2B7535512E_SET_RANDSERVICE_OFFSET UNITYSDK_OFFSET(0x1C2A5070)
#define CLASS_2_35962C2B7535512E__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2A4DD0)

inline static constexpr unsigned int Class_2_35962C2B7535512E_TypeDefinitionIndex = 36432;

class Class_2_35962C2B7535512E : public ::RPG::Client::LittleGameShare::Services_1<::Class_2_465A9E6CC2B0EF21*>
{
public:
	::Class_4_2281AFAA5CEEDF24* _InstanceClient_k__BackingField; // 0x10
	::Class_1_0AE74383D8A43588* _InputService_k__BackingField; // 0x18
	::Class_1_BD10A3BCF7C68615* _AIService_k__BackingField; // 0x20
	::Class_2_3616FDE8A71D0590_4* EEFMDEHLLFI; // 0x28
	::Class_1_3659AE0E8250857A* _RandService_k__BackingField; // 0x30
	::RPG::Client::LittleGameShare::HoyoPhysics::Physics2DService_1<::Class_2_465A9E6CC2B0EF21*>* _Physics2DService_k__BackingField; // 0x38
