...
#define CLASS_3_635476360DE473B3_DISPOSE_OFFSET UNITYSDK_OFFSET(0x119DD760)
#define CLASS_3_635476360DE473B3_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x119DE7F0)
#define CLASS_3_635476360DE473B3_METHOD_3_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x119DD8C0)
#define CLASS_3_635476360DE473B3_METHOD_3_3D2B77EBCAE390AB_OFFSET UNITYSDK_OFFSET(0x119DD4D0)
#define CLASS_3_635476360DE473B3_METHOD_3_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x119DEDA0)
#define CLASS_3_635476360DE473B3_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x119DF070)
#define CLASS_3_635476360DE473B3_METHOD_3_82B2F7CF908F696B_OFFSET UNITYSDK_OFFSET(0x119DEEF0)
#define CLASS_3_635476360DE473B3_METHOD_3_9641EAD9333FB8D3_OFFSET UNITYSDK_OFFSET(0x119DF3C0)
#define CLASS_3_635476360DE473B3_METHOD_3_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x119DD950)
#define CLASS_3_635476360DE473B3_METHOD_3_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0x119DF170)
#define CLASS_3_635476360DE473B3_METHOD_3_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0x119DF110)
#define CLASS_3_635476360DE473B3_METHOD_3_A42EAC97F065C7B5_OFFSET UNITYSDK_OFFSET(0x119DF210)
#define CLASS_3_635476360DE473B3_METHOD_3_D56DAA96379ECAB9_OFFSET UNITYSDK_OFFSET(0x119DDFA0)
#define CLASS_3_635476360DE473B3_METHOD_3_D7852DE078ACC1F1_OFFSET UNITYSDK_OFFSET(0x119DE330)
#define CLASS_3_635476360DE473B3_METHOD_3_DE069143E3F554D6_OFFSET UNITYSDK_OFFSET(0x119DE9B0)
#define CLASS_3_635476360DE473B3_METHOD_3_F15EECE317327525_OFFSET UNITYSDK_OFFSET(0x119DD480)
#define CLASS_3_635476360DE473B3_METHOD_3_F2ACC5B1FFC4D55A_OFFSET UNITYSDK_OFFSET(0x119DE7B0)
#define CLASS_3_635476360DE473B3_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x119DEB40)
#define CLASS_3_635476360DE473B3_ONSKIP_OFFSET UNITYSDK_OFFSET(0x119DE800)
#define CLASS_3_635476360DE473B3_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x119DDD00)
#define CLASS_3_635476360DE473B3_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x119DE5B0)
#define CLASS_3_635476360DE473B3_SETNEXTTASK_OFFSET UNITYSDK_OFFSET(0x119DE6F0)
#define CLASS_3_635476360DE473B3_TICK_OFFSET UNITYSDK_OFFSET(0x119DDAD0)
#define CLASS_3_635476360DE473B3__CTOR_OFFSET UNITYSDK_OFFSET(0x119DCAB0)

inline static constexpr unsigned int Class_3_635476360DE473B3_TypeDefinitionIndex = 48947;

class Class_3_635476360DE473B3 : public ::Class_2_A48F3719AA1CF200_6
{
public:
	::RPG::Client::Promises::Promise* Field_3_6; // 0x18
	::Class_3_E21F6DE9B7FA4D05* Field_3_3; // 0x20
	::Class_3_E21F6DE9B7FA4D05* Field_3_4; // 0x28
	::RPG::GameCore::PerformanceTransition* Field_3_2; // 0x30
	::RPG::GameCore::TaskContext* Field_3_1; // 0x38
	::Class_1_5F51D4049EA87B7B* Field_3_9; // 0x40
	::RPG::GameCore::ScreenTransferReason Field_3_7; // 0x48
	::System::Boolean Field_3_10; // 0x4C
	::System::Boolean Field_3_5; // 0x4D
	::System::Boolean Field_3_8; // 0x4E
