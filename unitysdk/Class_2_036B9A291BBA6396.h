...
#define CLASS_2_036B9A291BBA6396_METHOD_2_22621CB513042F77_OFFSET UNITYSDK_OFFSET(0xAFC2A30)
#define CLASS_2_036B9A291BBA6396_METHOD_2_51D0E84DD9AFCCF0_OFFSET UNITYSDK_OFFSET(0xAFC22B0)
#define CLASS_2_036B9A291BBA6396_METHOD_2_5BF44C2073589F07_OFFSET UNITYSDK_OFFSET(0xAFC2550)
#define CLASS_2_036B9A291BBA6396_METHOD_2_C40DF756F5780FF7_OFFSET UNITYSDK_OFFSET(0xAFC2830)
#define CLASS_2_036B9A291BBA6396_METHOD_2_D737CD2779D51A4E_OFFSET UNITYSDK_OFFSET(0xAFC1940)
#define CLASS_2_036B9A291BBA6396_METHOD_2_E9C5A8CF86EF4D91_1_OFFSET UNITYSDK_OFFSET(0xAFC21D0)
#define CLASS_2_036B9A291BBA6396_METHOD_2_E9C5A8CF86EF4D91_OFFSET UNITYSDK_OFFSET(0xAFC20F0)
#define CLASS_2_036B9A291BBA6396__CTOR_OFFSET UNITYSDK_OFFSET(0xAFC18B0)
#define CLASS_2_036B9A291BBA6396___REGISTERSUMMATIONFORMULA_B__7_0_OFFSET UNITYSDK_OFFSET(0xAFC2B50)

inline static constexpr unsigned int Class_2_036B9A291BBA6396_TypeDefinitionIndex = 58658;

class Class_2_036B9A291BBA6396 : public ::RPG::AvatarSystem::Property::PropertyCalculator_1<::RPG::GameCore::FixPoint>
{
public:
	::Class_0_16E4307DCC419505_701* Field_2_0; // 0x18

	::System::Void _ctor(::Class_0_16E4307DCC419505_701* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_701*))((::PBYTE)hIl2Cpp + CLASS_2_036B9A291BBA6396__CTOR_OFFSET))(this, a1);
	}
	...
	::Class_1_4F1450C7202739F5* __RegisterSummationFormula_b__7_0(::RPG::GameCore::AvatarPropertyType a1)
	{
		return ((::Class_1_4F1450C7202739F5*(*)(::PVOID, ::RPG::GameCore::AvatarPropertyType))((::PBYTE)hIl2Cpp + CLASS_2_036B9A291BBA6396___REGISTERSUMMATIONFORMULA_B__7_0_OFFSET))(this, a1);
	}
};
