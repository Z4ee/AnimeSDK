...
#define CLASS_1_5B567C8A01BAEDFE_155_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A3516A0)
#define CLASS_1_5B567C8A01BAEDFE_155_CLONE_OFFSET UNITYSDK_OFFSET(0x1A3514B0)
#define CLASS_1_5B567C8A01BAEDFE_155_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A3515B0)
#define CLASS_1_5B567C8A01BAEDFE_155_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A351520)
#define CLASS_1_5B567C8A01BAEDFE_155_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A351600)
#define CLASS_1_5B567C8A01BAEDFE_155_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A3516F0)
#define CLASS_1_5B567C8A01BAEDFE_155_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A3516C0)
#define CLASS_1_5B567C8A01BAEDFE_155_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A351400)
#define CLASS_1_5B567C8A01BAEDFE_155_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A351460)
#define CLASS_1_5B567C8A01BAEDFE_155_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A351630)
#define CLASS_1_5B567C8A01BAEDFE_155_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A351690)
#define CLASS_1_5B567C8A01BAEDFE_155__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A351740)
#define CLASS_1_5B567C8A01BAEDFE_155__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A351480)
#define CLASS_1_5B567C8A01BAEDFE_155__CTOR_OFFSET UNITYSDK_OFFSET(0x1A351470)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_155_TypeDefinitionIndex = 27765;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_155*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_155_TypeDefinitionIndex)->GetStaticField(0x13740);
	}
