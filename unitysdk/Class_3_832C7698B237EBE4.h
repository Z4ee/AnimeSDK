...
#define CLASS_3_832C7698B237EBE4_METHOD_3_F1BB718E73080948_OFFSET UNITYSDK_OFFSET(0x1A58A050)
#define CLASS_3_832C7698B237EBE4__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5630B0)

inline static constexpr unsigned int Class_3_832C7698B237EBE4_TypeDefinitionIndex = 35672;

class Class_3_832C7698B237EBE4 : public ::Class_2_98A798C0C96648F9
{
public:
	::RPG::GameCore::DiceCombatPredicateConfig_CustomValueCompare* PCBELGJOKHB; // 0x30
