...
#define CLASS_1_23C1B7E6B450FFB8_7_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1AA8BD70)
#define CLASS_1_23C1B7E6B450FFB8_7_CLONE_OFFSET UNITYSDK_OFFSET(0x1AA8B820)
#define CLASS_1_23C1B7E6B450FFB8_7_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1AA8B960)
#define CLASS_1_23C1B7E6B450FFB8_7_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AA8B900)
#define CLASS_1_23C1B7E6B450FFB8_7_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AA8BAD0)
#define CLASS_1_23C1B7E6B450FFB8_7_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1AA8BEA0)
#define CLASS_1_23C1B7E6B450FFB8_7_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1AA8BE30)
#define CLASS_1_23C1B7E6B450FFB8_7_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1AA8B8E0)
#define CLASS_1_23C1B7E6B450FFB8_7_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1AA8B760)
#define CLASS_1_23C1B7E6B450FFB8_7_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1AA8B8F0)
#define CLASS_1_23C1B7E6B450FFB8_7_METHOD_1_8633AE51B23EBDFD_1_OFFSET UNITYSDK_OFFSET(0x1AA8B8D0)
#define CLASS_1_23C1B7E6B450FFB8_7_METHOD_1_8633AE51B23EBDFD_OFFSET UNITYSDK_OFFSET(0x1AA8B8B0)
#define CLASS_1_23C1B7E6B450FFB8_7_METHOD_1_C229FF62B898C0B2_1_OFFSET UNITYSDK_OFFSET(0x1AA8B8C0)
#define CLASS_1_23C1B7E6B450FFB8_7_METHOD_1_C229FF62B898C0B2_OFFSET UNITYSDK_OFFSET(0x1AA8B8A0)
#define CLASS_1_23C1B7E6B450FFB8_7_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1AA8B7C0)
#define CLASS_1_23C1B7E6B450FFB8_7_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AA8BC30)
#define CLASS_1_23C1B7E6B450FFB8_7_WRITETO_OFFSET UNITYSDK_OFFSET(0x1AA8BC90)
#define CLASS_1_23C1B7E6B450FFB8_7__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AA8C040)
#define CLASS_1_23C1B7E6B450FFB8_7__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AA8B7E0)
#define CLASS_1_23C1B7E6B450FFB8_7__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA8B7D0)

inline static constexpr unsigned int Class_1_23C1B7E6B450FFB8_7_TypeDefinitionIndex = 27847;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_23C1B7E6B450FFB8_7*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_23C1B7E6B450FFB8_7_TypeDefinitionIndex)->GetStaticField(0xA760);
	}
	...
	{
		return ((::System::Double(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_23C1B7E6B450FFB8_7_METHOD_1_C229FF62B898C0B2_1_OFFSET))(this);
	}

	::System::Void Method_1_8633AE51B23EBDFD_1(::System::Double a1)
	{
		return ((::System::Void(*)(::PVOID, ::System::Double))((::PBYTE)hIl2Cpp + CLASS_1_23C1B7E6B450FFB8_7_METHOD_1_8633AE51B23EBDFD_1_OFFSET))(this, a1);
	}
