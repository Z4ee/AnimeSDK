...
#define CLASS_1_6C30C65EACF8D014_GET_DISTANCE_OFFSET UNITYSDK_OFFSET(0x18742520)
#define CLASS_1_6C30C65EACF8D014_GET_RAYENDPOINT_OFFSET UNITYSDK_OFFSET(0x187425A0)
#define CLASS_1_6C30C65EACF8D014_GET_RAYSTARTPOINT_OFFSET UNITYSDK_OFFSET(0x18742570)
#define CLASS_1_6C30C65EACF8D014_GET_TARGETDATA_OFFSET UNITYSDK_OFFSET(0x18742500)
#define CLASS_1_6C30C65EACF8D014_GET_TARGETWPOS_OFFSET UNITYSDK_OFFSET(0x18742540)
#define CLASS_1_6C30C65EACF8D014_SET_DISTANCE_OFFSET UNITYSDK_OFFSET(0x18742530)
#define CLASS_1_6C30C65EACF8D014_SET_RAYENDPOINT_OFFSET UNITYSDK_OFFSET(0x187425C0)
#define CLASS_1_6C30C65EACF8D014_SET_RAYSTARTPOINT_OFFSET UNITYSDK_OFFSET(0x18742590)
#define CLASS_1_6C30C65EACF8D014_SET_TARGETDATA_OFFSET UNITYSDK_OFFSET(0x18742510)
#define CLASS_1_6C30C65EACF8D014_SET_TARGETWPOS_OFFSET UNITYSDK_OFFSET(0x18742560)
#define CLASS_1_6C30C65EACF8D014__CTOR_OFFSET UNITYSDK_OFFSET(0x187425D0)

inline static constexpr unsigned int Class_1_6C30C65EACF8D014_TypeDefinitionIndex = 54418;
