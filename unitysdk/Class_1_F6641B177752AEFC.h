...
#define CLASS_1_F6641B177752AEFC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18A8D6F0)
#define CLASS_1_F6641B177752AEFC_METHOD_1_0B4DE962875F5FFD_OFFSET UNITYSDK_OFFSET(0x18A8D680)
#define CLASS_1_F6641B177752AEFC_METHOD_1_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x18A8D740)
#define CLASS_1_F6641B177752AEFC_METHOD_1_5C00C2EE4FCF347E_OFFSET UNITYSDK_OFFSET(0x18A8D7B0)
#define CLASS_1_F6641B177752AEFC_METHOD_1_A1C464B05BB7A5C1_OFFSET UNITYSDK_OFFSET(0x18A8D7C0)
#define CLASS_1_F6641B177752AEFC_METHOD_1_A5DE3ADF3D0115AD_OFFSET UNITYSDK_OFFSET(0x18A8D870)
#define CLASS_1_F6641B177752AEFC_METHOD_1_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x18A8D7A0)
#define CLASS_1_F6641B177752AEFC_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x18A8D790)
#define CLASS_1_F6641B177752AEFC__CTOR_OFFSET UNITYSDK_OFFSET(0x18A8D900)

inline static constexpr unsigned int Class_1_F6641B177752AEFC_TypeDefinitionIndex = 60410;

class Class_1_F6641B177752AEFC : public ::System::Object
{
public:
	::RPG::GameCore::AdventureCharacterController* CPIIOIPAAKK; // 0x10
	::RPG::Client::MonoControllableHand* KNBJLAPEIFJ; // 0x18
	::Class_2_5668A5419A7BEAB2* OJMMJIALPON; // 0x20
	...
	::Class_0_16E4307DCC419505_684* Method_1_5C00C2EE4FCF347E()
	{
		return ((::Class_0_16E4307DCC419505_684*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_F6641B177752AEFC_METHOD_1_5C00C2EE4FCF347E_OFFSET))(this);
	}
