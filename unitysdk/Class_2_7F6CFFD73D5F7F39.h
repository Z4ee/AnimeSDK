...
#define CLASS_2_7F6CFFD73D5F7F39_METHOD_2_01C417D27D338B5B_OFFSET UNITYSDK_OFFSET(0x16486300)
#define CLASS_2_7F6CFFD73D5F7F39_METHOD_2_032334B8C88491A3_OFFSET UNITYSDK_OFFSET(0x16485150)
#define CLASS_2_7F6CFFD73D5F7F39_METHOD_2_0A7A170096EAEF58_OFFSET UNITYSDK_OFFSET(0x16484510)
#define CLASS_2_7F6CFFD73D5F7F39_METHOD_2_2D4EF40E42C39240_OFFSET UNITYSDK_OFFSET(0x164866C0)
#define CLASS_2_7F6CFFD73D5F7F39_METHOD_2_32ADCFD3C944058C_OFFSET UNITYSDK_OFFSET(0x164863C0)
#define CLASS_2_7F6CFFD73D5F7F39_METHOD_2_352B61CD747EF90A_OFFSET UNITYSDK_OFFSET(0x16483BF0)
#define CLASS_2_7F6CFFD73D5F7F39_METHOD_2_4A63C0A7EEA81CCC_OFFSET UNITYSDK_OFFSET(0x16484100)
#define CLASS_2_7F6CFFD73D5F7F39_METHOD_2_4AFDAF3AFA948DA4_OFFSET UNITYSDK_OFFSET(0x164841C0)
#define CLASS_2_7F6CFFD73D5F7F39_METHOD_2_4E28CED68D3FE865_OFFSET UNITYSDK_OFFSET(0x16486540)
#define CLASS_2_7F6CFFD73D5F7F39_METHOD_2_602F77CD7A647441_OFFSET UNITYSDK_OFFSET(0x164842E0)
#define CLASS_2_7F6CFFD73D5F7F39_METHOD_2_6BAFD025520EE4FC_OFFSET UNITYSDK_OFFSET(0x164847A0)
#define CLASS_2_7F6CFFD73D5F7F39_METHOD_2_815E1C3A5EADAF61_OFFSET UNITYSDK_OFFSET(0x16485490)
#define CLASS_2_7F6CFFD73D5F7F39_METHOD_2_A3C4B7F46FA871E3_OFFSET UNITYSDK_OFFSET(0x16484AE0)
#define CLASS_2_7F6CFFD73D5F7F39_METHOD_2_CEBFF096B4C9D46B_OFFSET UNITYSDK_OFFSET(0x164837F0)
#define CLASS_2_7F6CFFD73D5F7F39_METHOD_2_D3B6A2C04C1A2515_OFFSET UNITYSDK_OFFSET(0x16484F20)
#define CLASS_2_7F6CFFD73D5F7F39_METHOD_2_DEEF602E4E0BE9ED_OFFSET UNITYSDK_OFFSET(0x16486240)
#define CLASS_2_7F6CFFD73D5F7F39_METHOD_2_E3768DF60BA5C9BA_OFFSET UNITYSDK_OFFSET(0x16484970)
#define CLASS_2_7F6CFFD73D5F7F39_METHOD_2_E658A310A9CE19AC_OFFSET UNITYSDK_OFFSET(0x16484C90)
#define CLASS_2_7F6CFFD73D5F7F39_METHOD_2_EAD10B3E55E2C4C5_OFFSET UNITYSDK_OFFSET(0x164854F0)
#define CLASS_2_7F6CFFD73D5F7F39_METHOD_2_F2F08395C02A5CC3_OFFSET UNITYSDK_OFFSET(0x164850E0)
#define CLASS_2_7F6CFFD73D5F7F39_METHOD_2_FB5CDCFD1D0099FA_1_OFFSET UNITYSDK_OFFSET(0x16486B30)
#define CLASS_2_7F6CFFD73D5F7F39_METHOD_2_FB5CDCFD1D0099FA_OFFSET UNITYSDK_OFFSET(0x164867C0)
#define CLASS_2_7F6CFFD73D5F7F39__CTOR_OFFSET UNITYSDK_OFFSET(0x16482F40)

inline static constexpr unsigned int Class_2_7F6CFFD73D5F7F39_TypeDefinitionIndex = 73675;

class Class_2_7F6CFFD73D5F7F39 : public ::Class_1_7256E7A2FB36A46D
{
public:
	::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::Class_1_8A6989C352B0F0F0*>*>* DAJFELPBOGP; // 0x18
	::System::Collections::Generic::Dictionary_2<::Class_1_303D5A33D1401D59*, ::System::Collections::Generic::List_1<::RPG::Client::OpenWorld::StreamingItemData*>*>* KJKIAFIIJJK; // 0x20
	::System::Collections::Generic::List_1<::System::Int32>* EMNAKHEHDPG; // 0x28
	::System::Collections::Generic::Dictionary_2<::RPG::Client::OpenWorld::StreamingItemData*, ::Class_1_D5302483370BD7FF*>* ENANIFLNEPO; // 0x30
	::System::Collections::Generic::Dictionary_2<::Class_1_8A6989C352B0F0F0*, ::System::Int32>* LOCAPLHAKAH; // 0x38
	::System::Collections::Generic::Dictionary_2<::Class_1_8A6989C352B0F0F0*, ::System::Int32>* MHKHGLMNLAF; // 0x40
	::System::Collections::Generic::Dictionary_2<::RPG::Client::OpenWorld::StreamingItemData*, ::UnityEngine::Transform*>* GKCDMJAOMHP; // 0x48
	::System::Collections::Generic::List_1<::System::Int32>* PEHPIFDHFNL; // 0x50
	::System::Single PGMIOKKLHIE; // 0x58
	...
	static ::RPG::GameCore::DriftComponentData* Method_2_E3768DF60BA5C9BA(::Struct_2_A77148D52D516E55 a1, ::RPG::Client::SceneTransformAnim* a2)
	{
		return ((::RPG::GameCore::DriftComponentData*(*)(::Struct_2_A77148D52D516E55, ::RPG::Client::SceneTransformAnim*))((::PBYTE)hIl2Cpp + CLASS_2_7F6CFFD73D5F7F39_METHOD_2_E3768DF60BA5C9BA_OFFSET))(a1, a2);
	}
