...
#define CLASS_2_58E1212704C5A399_DISPOSE_OFFSET UNITYSDK_OFFSET(0x169CF350)
#define CLASS_2_58E1212704C5A399_METHOD_2_BC6CEE43F93F10B5_OFFSET UNITYSDK_OFFSET(0x169CEE20)
#define CLASS_2_58E1212704C5A399_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x169CECC0)
#define CLASS_2_58E1212704C5A399_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x169CF300)
#define CLASS_2_58E1212704C5A399_TICK_OFFSET UNITYSDK_OFFSET(0x169CF4C0)
#define CLASS_2_58E1212704C5A399__CTOR_OFFSET UNITYSDK_OFFSET(0x169CEBC0)
...
{
public:
	::RPG::GameCore::MonopolyCheckAtFinalPos* OFKGLJOAMLD; // 0x18
	::Class_3_07C3C4D2990C49EE* IJBFOGOBMLE; // 0x20
