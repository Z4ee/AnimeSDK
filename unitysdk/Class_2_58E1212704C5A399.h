...
#define CLASS_2_58E1212704C5A399_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA9B5C10)
#define CLASS_2_58E1212704C5A399_METHOD_2_BC6CEE43F93F10B5_OFFSET UNITYSDK_OFFSET(0xA9B5710)
#define CLASS_2_58E1212704C5A399_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xA9B55B0)
#define CLASS_2_58E1212704C5A399_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xA9B5BC0)
#define CLASS_2_58E1212704C5A399_TICK_OFFSET UNITYSDK_OFFSET(0xA9B5CB0)
#define CLASS_2_58E1212704C5A399__CTOR_OFFSET UNITYSDK_OFFSET(0xA9B54B0)

inline static constexpr unsigned int Class_2_58E1212704C5A399_TypeDefinitionIndex = 54410;

class Class_2_58E1212704C5A399 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_3_07C3C4D2990C49EE* Field_2_0; // 0x18
	::RPG::GameCore::MonopolyCheckAtFinalPos* Field_2_1; // 0x20
