...
#define CLASS_2_17148030AA2B3E1D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19CAAFC0)
#define CLASS_2_17148030AA2B3E1D_METHOD_2_0869E1192F8E01DF_OFFSET UNITYSDK_OFFSET(0x19CAB1F0)
#define CLASS_2_17148030AA2B3E1D_METHOD_2_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x19CAC0D0)
#define CLASS_2_17148030AA2B3E1D_METHOD_2_30A2382C3FCC5386_OFFSET UNITYSDK_OFFSET(0x19CABFE0)
#define CLASS_2_17148030AA2B3E1D_METHOD_2_A4FC9423DE081646_OFFSET UNITYSDK_OFFSET(0x19CABDE0)
#define CLASS_2_17148030AA2B3E1D_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x19CAC080)
#define CLASS_2_17148030AA2B3E1D_METHOD_2_CFC95121222309BD_OFFSET UNITYSDK_OFFSET(0x19CABD00)
#define CLASS_2_17148030AA2B3E1D_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x19CAC0C0)
#define CLASS_2_17148030AA2B3E1D_ONMODELROOTLOADED_OFFSET UNITYSDK_OFFSET(0x19CABC00)
#define CLASS_2_17148030AA2B3E1D_ONMODELROOTUNLOADED_OFFSET UNITYSDK_OFFSET(0x19CABC80)
#define CLASS_2_17148030AA2B3E1D_TICK_OFFSET UNITYSDK_OFFSET(0x19CAB580)
#define CLASS_2_17148030AA2B3E1D__CCTOR_OFFSET UNITYSDK_OFFSET(0x19CAC140)
#define CLASS_2_17148030AA2B3E1D__CTOR_OFFSET UNITYSDK_OFFSET(0x19CAC0E0)
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_2_17148030AA2B3E1D_TypeDefinitionIndex)->GetStaticField(0x14470);
	}
	static ::System::Single* StaticGet_COOOECFEKHA()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_2_17148030AA2B3E1D_TypeDefinitionIndex)->GetStaticField(0x14474);
	}
	::System::Collections::Generic::List_1<::Class_1_218ED161703401BD*>* EEBOFPKIONO; // 0x18
	::RPG::GameCore::TransformComponent* NELGDHJKAJJ; // 0x20
	::Class_1_218ED161703401BD* OEOLAEIKMAB; // 0x28
	::System::Collections::Generic::List_1<::Class_1_5EBE290801EA4DF2*>* LLEEKMAIHFO; // 0x30
	::Class_2_21055A9FA74B791E* NILDKJKBHHG; // 0x38
	::System::Boolean HDJOGGDMCIO; // 0x40
	::System::Boolean IKBKEOELBBN; // 0x41
