...
#define CLASS_1_5B567C8A01BAEDFE_308_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A041BE0)
#define CLASS_1_5B567C8A01BAEDFE_308_CLONE_OFFSET UNITYSDK_OFFSET(0x1A041A50)
#define CLASS_1_5B567C8A01BAEDFE_308_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A041AF0)
#define CLASS_1_5B567C8A01BAEDFE_308_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A041A90)
#define CLASS_1_5B567C8A01BAEDFE_308_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A041B40)
#define CLASS_1_5B567C8A01BAEDFE_308_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A041C30)
#define CLASS_1_5B567C8A01BAEDFE_308_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A041C00)
#define CLASS_1_5B567C8A01BAEDFE_308_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A0419D0)
#define CLASS_1_5B567C8A01BAEDFE_308_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A041A00)
#define CLASS_1_5B567C8A01BAEDFE_308_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A041B70)
#define CLASS_1_5B567C8A01BAEDFE_308_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A041BD0)
#define CLASS_1_5B567C8A01BAEDFE_308__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A041C80)
#define CLASS_1_5B567C8A01BAEDFE_308__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A041A20)
#define CLASS_1_5B567C8A01BAEDFE_308__CTOR_OFFSET UNITYSDK_OFFSET(0x1A041A10)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_308_TypeDefinitionIndex = 31216;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_308*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_308_TypeDefinitionIndex)->GetStaticField(0x2D780);
	}
