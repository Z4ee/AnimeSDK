...
#define CLASS_1_5B567C8A01BAEDFE_308_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1ED09FD0)
#define CLASS_1_5B567C8A01BAEDFE_308_CLONE_OFFSET UNITYSDK_OFFSET(0x1ED09CC0)
#define CLASS_1_5B567C8A01BAEDFE_308_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1ED09DD0)
#define CLASS_1_5B567C8A01BAEDFE_308_EQUALS_OFFSET UNITYSDK_OFFSET(0x1ED09D00)
#define CLASS_1_5B567C8A01BAEDFE_308_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1ED09F30)
#define CLASS_1_5B567C8A01BAEDFE_308_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1ED0A020)
#define CLASS_1_5B567C8A01BAEDFE_308_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1ED09FF0)
#define CLASS_1_5B567C8A01BAEDFE_308_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1ED09C40)
#define CLASS_1_5B567C8A01BAEDFE_308_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1ED09C70)
#define CLASS_1_5B567C8A01BAEDFE_308_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1ED09F60)
#define CLASS_1_5B567C8A01BAEDFE_308_WRITETO_OFFSET UNITYSDK_OFFSET(0x1ED09FC0)
#define CLASS_1_5B567C8A01BAEDFE_308__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ED0A070)
#define CLASS_1_5B567C8A01BAEDFE_308__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ED09C90)
#define CLASS_1_5B567C8A01BAEDFE_308__CTOR_OFFSET UNITYSDK_OFFSET(0x1ED09C80)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_308_TypeDefinitionIndex = 32847;

class Class_1_5B567C8A01BAEDFE_308 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_308*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_308*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_308_TypeDefinitionIndex)->GetStaticField(0x42310);
	}
