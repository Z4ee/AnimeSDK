...
#define CLASS_1_5B567C8A01BAEDFE_308_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x197B8F60)
#define CLASS_1_5B567C8A01BAEDFE_308_CLONE_OFFSET UNITYSDK_OFFSET(0x197B8DD0)
#define CLASS_1_5B567C8A01BAEDFE_308_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x197B8E70)
#define CLASS_1_5B567C8A01BAEDFE_308_EQUALS_OFFSET UNITYSDK_OFFSET(0x197B8E10)
#define CLASS_1_5B567C8A01BAEDFE_308_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x197B8EC0)
#define CLASS_1_5B567C8A01BAEDFE_308_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x197B8FB0)
#define CLASS_1_5B567C8A01BAEDFE_308_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x197B8F80)
#define CLASS_1_5B567C8A01BAEDFE_308_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x197B8D50)
#define CLASS_1_5B567C8A01BAEDFE_308_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x197B8D80)
#define CLASS_1_5B567C8A01BAEDFE_308_TOSTRING_OFFSET UNITYSDK_OFFSET(0x197B8EF0)
#define CLASS_1_5B567C8A01BAEDFE_308_WRITETO_OFFSET UNITYSDK_OFFSET(0x197B8F50)
#define CLASS_1_5B567C8A01BAEDFE_308__CCTOR_OFFSET UNITYSDK_OFFSET(0x197B9000)
#define CLASS_1_5B567C8A01BAEDFE_308__CTOR_1_OFFSET UNITYSDK_OFFSET(0x197B8DA0)
#define CLASS_1_5B567C8A01BAEDFE_308__CTOR_OFFSET UNITYSDK_OFFSET(0x197B8D90)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_308_TypeDefinitionIndex = 31210;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_308*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_308_TypeDefinitionIndex)->GetStaticField(0x20CA0);
	}
