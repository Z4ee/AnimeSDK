...
public:
	...
	{
		return (::RPG::Client::OnAssetOperationDelegate**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A0302E9AE0B8A2B9___O_TypeDefinitionIndex)->GetStaticField(0x12AE0);
	}
};
