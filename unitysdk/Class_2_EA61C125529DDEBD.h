...
#define CLASS_2_EA61C125529DDEBD_METHOD_2_AE035F54FA1ED001_OFFSET UNITYSDK_OFFSET(0x13DA98A0)
#define CLASS_2_EA61C125529DDEBD__CTOR_OFFSET UNITYSDK_OFFSET(0x13DA9740)

inline static constexpr unsigned int Class_2_EA61C125529DDEBD_TypeDefinitionIndex = 67906;

class Class_2_EA61C125529DDEBD : public ::Class_1_5BD3EF046502B972
{
public:
	::UnityEngine::AnimationCurve* Field_2_2; // 0x20
	::MoleMole::Cameras::VNoiseSettings* Field_2_4; // 0x28
	::MoleMole::Config::ConfigCameraNoise* Field_2_3; // 0x30
