...
#define AKEVENT_CALLBACK_OFFSET UNITYSDK_OFFSET(0x18BAAF60)
#define AKEVENT_GET_EVENTID_OFFSET UNITYSDK_OFFSET(0x18BAB230)
#define AKEVENT_GET_M_CALLBACKDATA_OFFSET UNITYSDK_OFFSET(0x18BAB3F0)
#define AKEVENT_GET_VALUEGUID_OFFSET UNITYSDK_OFFSET(0x18BAB2B0)
#define AKEVENT_GET_WWISETYPE_OFFSET UNITYSDK_OFFSET(0x18BAAF10)
#define AKEVENT_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x18B8BE20)
#define AKEVENT_START_OFFSET UNITYSDK_OFFSET(0x18B8AFB0)
#define AKEVENT_STOP_1_OFFSET UNITYSDK_OFFSET(0x18BAB140)
#define AKEVENT_STOP_OFFSET UNITYSDK_OFFSET(0x18BAB0E0)
#define AKEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18B8C740)
#define AKEVENT___IFIXBASEPROXY_START_OFFSET UNITYSDK_OFFSET(0x18BAB400)

inline static constexpr unsigned int AkEvent_TypeDefinitionIndex = 34658;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + AKEVENT___IFIXBASEPROXY_START_OFFSET))(this);
	}
};
