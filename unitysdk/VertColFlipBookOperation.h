...
#define VERTCOLFLIPBOOKOPERATION_METHOD_3_2760FD3615174BA2_OFFSET UNITYSDK_OFFSET(0x1053B640)
#define VERTCOLFLIPBOOKOPERATION_METHOD_3_6454AD7212B2C6DE_OFFSET UNITYSDK_OFFSET(0x1053BA30)
#define VERTCOLFLIPBOOKOPERATION_METHOD_3_A0C1C05C5CFB7EEC_OFFSET UNITYSDK_OFFSET(0x1053B5B0)
#define VERTCOLFLIPBOOKOPERATION_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x1053BD00)
#define VERTCOLFLIPBOOKOPERATION_METHOD_3_B1C134C2EF0F4EA1_OFFSET UNITYSDK_OFFSET(0x1053B250)
#define VERTCOLFLIPBOOKOPERATION_METHOD_3_CD5DDE3898917E36_1_OFFSET UNITYSDK_OFFSET(0x1053B8D0)
#define VERTCOLFLIPBOOKOPERATION_METHOD_3_CD5DDE3898917E36_OFFSET UNITYSDK_OFFSET(0x1053B770)
#define VERTCOLFLIPBOOKOPERATION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1053BD60)
#define VERTCOLFLIPBOOKOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1053BD50)
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(VertColFlipBookOperation_TypeDefinitionIndex)->GetStaticField(0x14A00);
	}
