...
#define VERTCOLFLIPBOOKOPERATION_METHOD_3_01B6392FDDE71405_1_OFFSET UNITYSDK_OFFSET(0xB9B1290)
#define VERTCOLFLIPBOOKOPERATION_METHOD_3_01B6392FDDE71405_OFFSET UNITYSDK_OFFSET(0xB9B10F0)
#define VERTCOLFLIPBOOKOPERATION_METHOD_3_2760FD3615174BA2_OFFSET UNITYSDK_OFFSET(0xB9B0FC0)
#define VERTCOLFLIPBOOKOPERATION_METHOD_3_6454AD7212B2C6DE_OFFSET UNITYSDK_OFFSET(0xB9B1430)
#define VERTCOLFLIPBOOKOPERATION_METHOD_3_844E93377CD0D4F8_OFFSET UNITYSDK_OFFSET(0xB9B0B80)
#define VERTCOLFLIPBOOKOPERATION_METHOD_3_A0C1C05C5CFB7EEC_OFFSET UNITYSDK_OFFSET(0xB9B0F30)
#define VERTCOLFLIPBOOKOPERATION_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0xB9B1760)
#define VERTCOLFLIPBOOKOPERATION__CCTOR_OFFSET UNITYSDK_OFFSET(0xB9B17C0)
#define VERTCOLFLIPBOOKOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0xB9B17B0)

inline static constexpr unsigned int VertColFlipBookOperation_TypeDefinitionIndex = 43919;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(VertColFlipBookOperation_TypeDefinitionIndex)->GetStaticField(0x3380);
	}
