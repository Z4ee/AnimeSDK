...
#define CLASS_1_0A0F7052F7BEDB7E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x176C2CF0)
#define CLASS_1_0A0F7052F7BEDB7E_METHOD_1_41BCBD63D863EBC7_OFFSET UNITYSDK_OFFSET(0x176C2FF0)
#define CLASS_1_0A0F7052F7BEDB7E_METHOD_1_4BED6B3C2E3B03B2_OFFSET UNITYSDK_OFFSET(0x176C3220)
#define CLASS_1_0A0F7052F7BEDB7E_METHOD_1_4BFEF37B95753ADB_OFFSET UNITYSDK_OFFSET(0x176C2F40)
#define CLASS_1_0A0F7052F7BEDB7E_METHOD_1_84477C74B966316D_OFFSET UNITYSDK_OFFSET(0x176C3320)
#define CLASS_1_0A0F7052F7BEDB7E_METHOD_1_93AD5FDF788A0CCA_OFFSET UNITYSDK_OFFSET(0x176C3570)
#define CLASS_1_0A0F7052F7BEDB7E_METHOD_1_C6C47C9FFA92653C_1_OFFSET UNITYSDK_OFFSET(0x176C34D0)
#define CLASS_1_0A0F7052F7BEDB7E_METHOD_1_C6C47C9FFA92653C_OFFSET UNITYSDK_OFFSET(0x176C2EA0)
#define CLASS_1_0A0F7052F7BEDB7E_METHOD_1_F072550329FC7079_OFFSET UNITYSDK_OFFSET(0x176C3420)
#define CLASS_1_0A0F7052F7BEDB7E__CTOR_OFFSET UNITYSDK_OFFSET(0x176C2C50)

inline static constexpr unsigned int Class_1_0A0F7052F7BEDB7E_TypeDefinitionIndex = 58040;

class Class_1_0A0F7052F7BEDB7E : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::Class_1_D26322A0A5D2FA93*>* Field_1_0; // 0x10
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::ScreenTransferReason, ::Class_1_D26322A0A5D2FA93*>* Field_1_1; // 0x18
