...
#define CLASS_2_EE18388F80792C67_1_DISPOSE_OFFSET UNITYSDK_OFFSET(0x119DC1A0)
#define CLASS_2_EE18388F80792C67_1_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x119DC860)
#define CLASS_2_EE18388F80792C67_1_METHOD_2_464B80C09A37526F_OFFSET UNITYSDK_OFFSET(0x119DC900)
#define CLASS_2_EE18388F80792C67_1_METHOD_2_8A76897D6A693475_OFFSET UNITYSDK_OFFSET(0x119DC9D0)
#define CLASS_2_EE18388F80792C67_1_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x119DC700)
#define CLASS_2_EE18388F80792C67_1_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x119DC240)
#define CLASS_2_EE18388F80792C67_1_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x119DC470)
#define CLASS_2_EE18388F80792C67_1_TICK_OFFSET UNITYSDK_OFFSET(0x119DC780)
#define CLASS_2_EE18388F80792C67_1__CTOR_OFFSET UNITYSDK_OFFSET(0x119DC0A0)

inline static constexpr unsigned int Class_2_EE18388F80792C67_1_TypeDefinitionIndex = 48727;

class Class_2_EE18388F80792C67_1 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_3_C270952194C1A3FA_2* Field_2_1; // 0x18
	...
	{
		return ((::System::Void(*)(::PVOID, ::RPG::GameCore::TaskContext*, ::Class_3_C270952194C1A3FA_2*))((::PBYTE)hIl2Cpp + CLASS_2_EE18388F80792C67_1__CTOR_OFFSET))(this, a1, a2);
	}
