...
#define CLASS_1_6565B3A91153CD08_METHOD_1_D66FD197FFC5F33F_OFFSET UNITYSDK_OFFSET(0x17682A40)
#define CLASS_1_6565B3A91153CD08__CTOR_OFFSET UNITYSDK_OFFSET(0x17682A00)

inline static constexpr unsigned int Class_1_6565B3A91153CD08_TypeDefinitionIndex = 68864;

class Class_1_6565B3A91153CD08 : public ::System::Object
{
public:
	::UnityEngine::Transform* GKNBCPMJHMN; // 0x10
	::UnityEngine::Vector3 EDGNGCFCNID; // 0x18
	::UnityEngine::Vector3 EBLJHCBNCJG; // 0x24
