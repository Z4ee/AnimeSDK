...
#define CLASS_2_C0779DA1A164653E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1285E810)
#define CLASS_2_C0779DA1A164653E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1285E850)
#define CLASS_2_C0779DA1A164653E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1285EC20)
#define CLASS_2_C0779DA1A164653E_TICK_OFFSET UNITYSDK_OFFSET(0x1285EC70)
#define CLASS_2_C0779DA1A164653E__CTOR_OFFSET UNITYSDK_OFFSET(0x1285E800)
...
{
public:
	::RPG::GameCore::PPFilterStackEffectUpdate* OFKGLJOAMLD; // 0x18
