...
#define CLASS_2_C0779DA1A164653E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10C9B310)
#define CLASS_2_C0779DA1A164653E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10C9B350)
#define CLASS_2_C0779DA1A164653E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10C9B650)
#define CLASS_2_C0779DA1A164653E_TICK_OFFSET UNITYSDK_OFFSET(0x10C9B6A0)
#define CLASS_2_C0779DA1A164653E__CTOR_OFFSET UNITYSDK_OFFSET(0x10C9B300)

inline static constexpr unsigned int Class_2_C0779DA1A164653E_TypeDefinitionIndex = 51611;

class Class_2_C0779DA1A164653E : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::PPFilterStackEffectUpdate* Field_2_1; // 0x20
