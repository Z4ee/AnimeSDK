...
#define CLASS_2_C0779DA1A164653E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18715370)
#define CLASS_2_C0779DA1A164653E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x187153B0)
#define CLASS_2_C0779DA1A164653E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x18715780)
#define CLASS_2_C0779DA1A164653E_TICK_OFFSET UNITYSDK_OFFSET(0x187157D0)
#define CLASS_2_C0779DA1A164653E__CTOR_OFFSET UNITYSDK_OFFSET(0x18715360)

inline static constexpr unsigned int Class_2_C0779DA1A164653E_TypeDefinitionIndex = 55456;

class Class_2_C0779DA1A164653E : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::GameCore::PPFilterStackEffectUpdate* OFKGLJOAMLD; // 0x20
