...
#define CLASS_1_5B567C8A01BAEDFE_119_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C43F130)
#define CLASS_1_5B567C8A01BAEDFE_119_CLONE_OFFSET UNITYSDK_OFFSET(0x1C43EDD0)
#define CLASS_1_5B567C8A01BAEDFE_119_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C43EF30)
#define CLASS_1_5B567C8A01BAEDFE_119_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C43EE40)
#define CLASS_1_5B567C8A01BAEDFE_119_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C43F090)
#define CLASS_1_5B567C8A01BAEDFE_119_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C43F180)
#define CLASS_1_5B567C8A01BAEDFE_119_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C43F150)
#define CLASS_1_5B567C8A01BAEDFE_119_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C43ED20)
#define CLASS_1_5B567C8A01BAEDFE_119_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C43ED80)
#define CLASS_1_5B567C8A01BAEDFE_119_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C43F0C0)
#define CLASS_1_5B567C8A01BAEDFE_119_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C43F120)
#define CLASS_1_5B567C8A01BAEDFE_119__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C43F1D0)
#define CLASS_1_5B567C8A01BAEDFE_119__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C43EDA0)
#define CLASS_1_5B567C8A01BAEDFE_119__CTOR_OFFSET UNITYSDK_OFFSET(0x1C43ED90)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_119_TypeDefinitionIndex = 27415;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_119*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_119_TypeDefinitionIndex)->GetStaticField(0x1D120);
	}
