...
#define CLASS_3_9319AA7B5591C256_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x105C4EF0)
#define CLASS_3_9319AA7B5591C256__CTOR_OFFSET UNITYSDK_OFFSET(0x105C4EC0)

inline static constexpr unsigned int Class_3_9319AA7B5591C256_TypeDefinitionIndex = 42523;
