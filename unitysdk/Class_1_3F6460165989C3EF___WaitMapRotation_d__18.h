...
#define CLASS_1_3F6460165989C3EF___WAITMAPROTATION_D__18_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x10CC1B70)
#define CLASS_1_3F6460165989C3EF___WAITMAPROTATION_D__18_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x10CC1DA0)
#define CLASS_1_3F6460165989C3EF___WAITMAPROTATION_D__18_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x10CC1E00)
#define CLASS_1_3F6460165989C3EF___WAITMAPROTATION_D__18_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x10CC1DB0)
#define CLASS_1_3F6460165989C3EF___WAITMAPROTATION_D__18_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10CC1B50)
#define CLASS_1_3F6460165989C3EF___WAITMAPROTATION_D__18__CTOR_OFFSET UNITYSDK_OFFSET(0x10CC1860)

inline static constexpr unsigned int Class_1_3F6460165989C3EF___WaitMapRotation_d__18_TypeDefinitionIndex = 49026;
