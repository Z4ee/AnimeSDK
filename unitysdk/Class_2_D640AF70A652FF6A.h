...
#define CLASS_2_D640AF70A652FF6A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x105C2260)
#define CLASS_2_D640AF70A652FF6A_GET_WATERCOLOR_OFFSET UNITYSDK_OFFSET(0x105C6DD0)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_050E70FEDB783306_1_OFFSET UNITYSDK_OFFSET(0x105C5690)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x105C5640)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_0BDFAC56E6B704CB_OFFSET UNITYSDK_OFFSET(0x105C3C40)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x105C6DB0)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_151E25A63D14DDB0_1_OFFSET UNITYSDK_OFFSET(0x105C2680)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x105C3760)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_21886A8411E71157_OFFSET UNITYSDK_OFFSET(0x105C4750)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_2C95AFAD0256302F_OFFSET UNITYSDK_OFFSET(0x105C3850)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_2CBE0B79DD36047E_OFFSET UNITYSDK_OFFSET(0x105C4DA0)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x105C6D40)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_3C56C1AF247AC1EC_OFFSET UNITYSDK_OFFSET(0x105C67F0)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x105C4060)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x105C45F0)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x105C24F0)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_453AA36A51F9AA77_OFFSET UNITYSDK_OFFSET(0x105C4430)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_4BE99DDCF7F1FD88_OFFSET UNITYSDK_OFFSET(0x105C2820)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_67D41ACFEF39E84E_OFFSET UNITYSDK_OFFSET(0x105C3270)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_6AC0B31DB7C5670D_OFFSET UNITYSDK_OFFSET(0x105C2E00)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_6D71CC7A9DF62322_OFFSET UNITYSDK_OFFSET(0x105C27C0)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_70603E2AE56EBD6B_OFFSET UNITYSDK_OFFSET(0x105C46B0)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_7CA8CEC368BDAF2F_OFFSET UNITYSDK_OFFSET(0x105C45B0)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_7CABA4F189ABCB68_OFFSET UNITYSDK_OFFSET(0x105C40B0)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0x105C2CF0)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_81A971B44F36CAF8_OFFSET UNITYSDK_OFFSET(0x105C48F0)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_8C3DB70FFBBF01C7_OFFSET UNITYSDK_OFFSET(0x105C6CC0)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_926A87EF7B2C87F9_OFFSET UNITYSDK_OFFSET(0x105C2D40)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_96F429055CEF6085_OFFSET UNITYSDK_OFFSET(0x105C56E0)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x105C6B30)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_99C80A701DB439BB_OFFSET UNITYSDK_OFFSET(0x105C5810)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_A168E12C6BB2E0E2_OFFSET UNITYSDK_OFFSET(0x105C6840)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_A479FAB2BDAFE4D6_OFFSET UNITYSDK_OFFSET(0x105C6DA0)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_AB0D5AE688458ECB_OFFSET UNITYSDK_OFFSET(0x105C3050)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_B158205E55E833D6_OFFSET UNITYSDK_OFFSET(0x105C6DC0)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_B57CDB7FEEE3DDCE_OFFSET UNITYSDK_OFFSET(0x105C3EF0)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_C1238CC3B5758A25_1_OFFSET UNITYSDK_OFFSET(0x105C5C80)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_C1238CC3B5758A25_OFFSET UNITYSDK_OFFSET(0x105C6500)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_C56DC3B2E26040B8_OFFSET UNITYSDK_OFFSET(0x105C5580)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_C8D6B29192F288ED_OFFSET UNITYSDK_OFFSET(0x105C3130)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x105C4D50)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x105C2770)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x105C48B0)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x105C3A60)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_E255E6572360A66E_OFFSET UNITYSDK_OFFSET(0x105C5F30)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_EDB0D8DA4A269034_OFFSET UNITYSDK_OFFSET(0x105C2ED0)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_F02F7737367767B7_OFFSET UNITYSDK_OFFSET(0x105C2A20)
#define CLASS_2_D640AF70A652FF6A_METHOD_2_FD7514C64FB1B043_OFFSET UNITYSDK_OFFSET(0x105C6A40)
#define CLASS_2_D640AF70A652FF6A_ONMODELARTLOADED_OFFSET UNITYSDK_OFFSET(0x105C3210)
#define CLASS_2_D640AF70A652FF6A_ONMODELARTUNLOADED_OFFSET UNITYSDK_OFFSET(0x105C3A00)
#define CLASS_2_D640AF70A652FF6A_SET_WATERCOLOR_OFFSET UNITYSDK_OFFSET(0x105C6DE0)
#define CLASS_2_D640AF70A652FF6A_TICK_OFFSET UNITYSDK_OFFSET(0x105C3B10)
#define CLASS_2_D640AF70A652FF6A__CCTOR_OFFSET UNITYSDK_OFFSET(0x105C6DF0)
#define CLASS_2_D640AF70A652FF6A__CTOR_OFFSET UNITYSDK_OFFSET(0x105C21C0)
...
public:
	...
	{
		return (::RPG::Client::MonoEffect**)Il2CppClass::FromTypeDefinitionIndex(Class_2_D640AF70A652FF6A_TypeDefinitionIndex)->GetStaticField(0x1A290);
	}
	static ::System::String** StaticGet_PPAPPPHPAAK()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_2_D640AF70A652FF6A_TypeDefinitionIndex)->GetStaticField(0x1A298);
	}
	static ::System::String** StaticGet_BACMDDIOMIC()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_2_D640AF70A652FF6A_TypeDefinitionIndex)->GetStaticField(0x1A2A0);
	}
	// static const ::System::Int32 EPAFNFAHKJC = 0x3; // 0x0
	// static const ::System::Single BEMJEAHHNKM; // 0x0
	::System::String* CIHFBKDBKMA; // 0x18
	::UnityEngine::Collider* JGPLBJIJEGD; // 0x20
	::System::Action* CDOOFLBOLNH; // 0x28
	::UnityEngine::Transform* NEHEJBBBIMB; // 0x30
	::System::String* ONOJAMPKCBB; // 0x38
	::RPG::Client::AdventurePhase* HKDOPJJJALA; // 0x40
	::System::Collections::Generic::List_1<::Class_1_495BD7C43746BF8B*>* GKNCPFJCPMD; // 0x48
	::RPG::GameCore::NPCMonsterHintSoundConfig* JIBDIPLKCMN; // 0x50
	::RPG::GameCore::NPCSoundConfig* CFPOJLPMPCO; // 0x58
	::RPG::Client::GameObjectAudio* IBPBIPPHKGI; // 0x60
	::System::String* CADIBFBDBCB; // 0x68
	::Class_2_2464564425143749* IHMCFAGIPFG; // 0x70
	::RPG::GameCore::AdventureCharacterController* KCIMJOOHMKC; // 0x78
	::UnityEngine::Transform* FLFGHHJDMDP; // 0x80
	::UnityEngine::Transform* KHKDECKBKAD; // 0x88
	::System::String* CAACACOCLEI; // 0x90
	::System::Collections::Generic::List_1<::RPG::Client::Effect_DynamicWavesManager_HitData>* CHFEJGOMNFD; // 0x98
	::System::Int32 HDJIJJGBCAC; // 0xA0
	::System::Boolean CMMLNONIMBP; // 0xA4
	::System::Boolean IAMCONEKFEG; // 0xA5
	::System::Boolean MEGDBHGAAJG; // 0xA6
	::System::Boolean JLBLDDLFIHB; // 0xA7
	::System::Boolean JNECJPADBHL; // 0xA8
	::System::Boolean ENCKNGODENG; // 0xA9
	::System::Boolean ELAHKHACHJA; // 0xAA
	::System::Boolean HCLMAKDIPKP; // 0xAB
	::System::Boolean OKBFIBGOBCK; // 0xAC
	::System::Int32 BADIIFEHOGP; // 0xB0
	::RPG::GameCore::SurfaceType NONNMEEOPJF; // 0xB4
	::System::Single DJLJJMGABKH; // 0xB8
	::UnityEngine::Color _waterColor_k__BackingField; // 0xBC
	::UnityEngine::Vector3 JCBHPJEMKBA; // 0xCC
	::System::Int32 FBGBGMPOHIE; // 0xD8
