...
#define CLASS_2_B21C56B14C4A66B5_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15600390)
#define CLASS_2_B21C56B14C4A66B5_METHOD_2_025E4B1A2211CF52_OFFSET UNITYSDK_OFFSET(0x156004D0)
#define CLASS_2_B21C56B14C4A66B5_METHOD_2_0B57C515D997AC51_OFFSET UNITYSDK_OFFSET(0x15601B90)
#define CLASS_2_B21C56B14C4A66B5_METHOD_2_3EF33FD8BF224359_OFFSET UNITYSDK_OFFSET(0x15601C80)
#define CLASS_2_B21C56B14C4A66B5_METHOD_2_40E06565F44E066F_OFFSET UNITYSDK_OFFSET(0x15601A60)
#define CLASS_2_B21C56B14C4A66B5_METHOD_2_4BFD22BA064FDA06_OFFSET UNITYSDK_OFFSET(0x15601860)
#define CLASS_2_B21C56B14C4A66B5_METHOD_2_6A0EBEECA245A27C_OFFSET UNITYSDK_OFFSET(0x156008F0)
#define CLASS_2_B21C56B14C4A66B5_METHOD_2_85377D41FEE05B66_OFFSET UNITYSDK_OFFSET(0x15601180)
#define CLASS_2_B21C56B14C4A66B5_METHOD_2_9B12B3DBC5092B81_OFFSET UNITYSDK_OFFSET(0x15600030)
#define CLASS_2_B21C56B14C4A66B5_METHOD_2_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x15601910)
#define CLASS_2_B21C56B14C4A66B5_METHOD_2_A871253BFD471C99_OFFSET UNITYSDK_OFFSET(0x156012D0)
#define CLASS_2_B21C56B14C4A66B5_METHOD_2_B5B1B5EF5324F442_1_OFFSET UNITYSDK_OFFSET(0x15601DA0)
#define CLASS_2_B21C56B14C4A66B5_METHOD_2_B5B1B5EF5324F442_OFFSET UNITYSDK_OFFSET(0x15601960)
#define CLASS_2_B21C56B14C4A66B5_METHOD_2_B5B2A098DFB6D461_OFFSET UNITYSDK_OFFSET(0x155FFE10)
#define CLASS_2_B21C56B14C4A66B5_METHOD_2_CE1ABE6CC81D9AE6_OFFSET UNITYSDK_OFFSET(0x15601EA0)
#define CLASS_2_B21C56B14C4A66B5_METHOD_2_D1C386AEA2F5BE59_OFFSET UNITYSDK_OFFSET(0x15601380)
#define CLASS_2_B21C56B14C4A66B5_METHOD_2_F70251E97F300003_OFFSET UNITYSDK_OFFSET(0x15601480)
#define CLASS_2_B21C56B14C4A66B5_ONAFTERMODELARTLOAD_OFFSET UNITYSDK_OFFSET(0x15600340)
#define CLASS_2_B21C56B14C4A66B5_ONBEFOREMODELARTUNLOAD_OFFSET UNITYSDK_OFFSET(0x15601120)
#define CLASS_2_B21C56B14C4A66B5_TICK_OFFSET UNITYSDK_OFFSET(0x15600680)
#define CLASS_2_B21C56B14C4A66B5__CTOR_OFFSET UNITYSDK_OFFSET(0x156020F0)
...
{
public:
	::System::Collections::Generic::List_1<::RPG::GameCore::AnimGroupEventConfig*>* ECDEMCDBOPP; // 0x18
	::System::Collections::Generic::List_1<::Class_2_B21C56B14C4A66B5_Struct_2_BBD456EBC9087BC2_7>* GFMCAPNLKOK; // 0x20
	::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* HJLLLJKGCFO; // 0x28
	::RPG::GameCore::CharacterModelComponent* HLCINALDOAC; // 0x30
	::RPG::GameCore::TaskContext* OBKLPOKMIEA; // 0x38
