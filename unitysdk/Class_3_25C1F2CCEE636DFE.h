...
#define CLASS_3_25C1F2CCEE636DFE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11375BB0)
#define CLASS_3_25C1F2CCEE636DFE__CTOR_OFFSET UNITYSDK_OFFSET(0x11375B80)

inline static constexpr unsigned int Class_3_25C1F2CCEE636DFE_TypeDefinitionIndex = 42515;
