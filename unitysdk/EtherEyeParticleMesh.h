...
#define ETHEREYEPARTICLEMESH_DEALMESHTRANSMIT_OFFSET UNITYSDK_OFFSET(0x17C46FD0)
#define ETHEREYEPARTICLEMESH_DEALSIZESETTINGSANDMESHTRANSMIT_OFFSET UNITYSDK_OFFSET(0x17C46CB0)
#define ETHEREYEPARTICLEMESH_DOCOLLECTPROPERPARTICLESYSTEM_OFFSET UNITYSDK_OFFSET(0x17C458B0)
#define ETHEREYEPARTICLEMESH_FETCHCONFIG_OFFSET UNITYSDK_OFFSET(0x17C45D40)
#define ETHEREYEPARTICLEMESH_ONENTITYDISABLE_OFFSET UNITYSDK_OFFSET(0x17C47100)
#define ETHEREYEPARTICLEMESH_UPDATEPARTICLEMESHSOURCE_OFFSET UNITYSDK_OFFSET(0x17C45EF0)
#define ETHEREYEPARTICLEMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x17C475A0)

inline static constexpr unsigned int EtherEyeParticleMesh_TypeDefinitionIndex = 72167;
