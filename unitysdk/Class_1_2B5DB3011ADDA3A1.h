...
#define CLASS_1_2B5DB3011ADDA3A1_METHOD_1_097468641FDED14E_OFFSET UNITYSDK_OFFSET(0x18920B30)
#define CLASS_1_2B5DB3011ADDA3A1_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x18920A30)
#define CLASS_1_2B5DB3011ADDA3A1_METHOD_1_403E554B6AF81517_OFFSET UNITYSDK_OFFSET(0x18920C10)
#define CLASS_1_2B5DB3011ADDA3A1_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x18920BB0)
#define CLASS_1_2B5DB3011ADDA3A1_METHOD_1_D20BF56E36607D54_1_OFFSET UNITYSDK_OFFSET(0x18920AE0)
#define CLASS_1_2B5DB3011ADDA3A1_METHOD_1_D20BF56E36607D54_OFFSET UNITYSDK_OFFSET(0x18920A90)
#define CLASS_1_2B5DB3011ADDA3A1__CTOR_OFFSET UNITYSDK_OFFSET(0x18920CD0)

inline static constexpr unsigned int Class_1_2B5DB3011ADDA3A1_TypeDefinitionIndex = 57417;

class Class_1_2B5DB3011ADDA3A1 : public ::System::Object
{
public:
	::System::Int32 KOCGGNKJDEL; // 0x10
	::System::UInt32 ACCPEGBMFCB; // 0x14
	::System::Int32 EAJBNHGHPNM; // 0x18
	::System::Boolean BNIMJJNOLAI; // 0x1C
	::System::UInt32 GAEEJFJEGKA; // 0x20
	::System::Single ECBOJPEECMB; // 0x24
