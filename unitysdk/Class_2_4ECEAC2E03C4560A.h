...
#define CLASS_2_4ECEAC2E03C4560A_BEFOREDISPOSE_OFFSET UNITYSDK_OFFSET(0x13B7EE40)
#define CLASS_2_4ECEAC2E03C4560A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13B7EE00)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_169C5280D338BD7B_OFFSET UNITYSDK_OFFSET(0x13B7F440)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_1AD51778485AD495_OFFSET UNITYSDK_OFFSET(0x13B7F340)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_22806B2F0BB89E7E_OFFSET UNITYSDK_OFFSET(0x13B7DEC0)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_3899FDD7FD93BFAC_OFFSET UNITYSDK_OFFSET(0x13B7E730)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_3C6260EB9E672654_OFFSET UNITYSDK_OFFSET(0x13B7F4D0)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_66E0E2A93F031E36_OFFSET UNITYSDK_OFFSET(0x13B7E110)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_886EE15AAE69E211_OFFSET UNITYSDK_OFFSET(0x13B7D850)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_9AFCA18B112F248A_OFFSET UNITYSDK_OFFSET(0x13B7FA40)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_A9F402EE239E6F9D_OFFSET UNITYSDK_OFFSET(0x13B7D5F0)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_ABE7715DB28B2DD1_OFFSET UNITYSDK_OFFSET(0x13B7EF50)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0x13B7D830)
#define CLASS_2_4ECEAC2E03C4560A_TICK_OFFSET UNITYSDK_OFFSET(0x13B7F0D0)
#define CLASS_2_4ECEAC2E03C4560A__CTOR_OFFSET UNITYSDK_OFFSET(0x13B7FB20)
#define CLASS_2_4ECEAC2E03C4560A___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x13B7FB30)

inline static constexpr unsigned int Class_2_4ECEAC2E03C4560A_TypeDefinitionIndex = 68461;
...
public:
	...
	::Class_1_0CB627C4F1CDDD99* Field_2_2; // 0x28
	::System::String* Field_2_3; // 0x30
	::RPG::Client::EraFlipperManager* Field_2_4; // 0x38
	::System::Nullable_1<::Class_2_4ECEAC2E03C4560A_NpcShowState> Field_2_5; // 0x40
	::System::Nullable_1<::Class_2_4ECEAC2E03C4560A_NpcStateControlSource> Field_2_6; // 0x48
	::System::Single Field_2_7; // 0x50
	::Class_2_4ECEAC2E03C4560A_NpcShowState Field_2_8; // 0x54
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + CLASS_2_4ECEAC2E03C4560A___IFIXBASEPROXY_TICK_OFFSET))(this, a1);
	}
};
