...
#define CLASS_2_4ECEAC2E03C4560A_BEFOREDISPOSE_OFFSET UNITYSDK_OFFSET(0x180FC8F0)
#define CLASS_2_4ECEAC2E03C4560A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x180FC8B0)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_169C5280D338BD7B_OFFSET UNITYSDK_OFFSET(0x180FCF70)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_1AD51778485AD495_OFFSET UNITYSDK_OFFSET(0x180FCE70)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_22806B2F0BB89E7E_OFFSET UNITYSDK_OFFSET(0x180FB9D0)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_38E5BF87E9568775_OFFSET UNITYSDK_OFFSET(0x180FC240)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_4BBE37F6853A1AF7_OFFSET UNITYSDK_OFFSET(0x180FD000)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_66E0E2A93F031E36_OFFSET UNITYSDK_OFFSET(0x180FBC20)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_886EE15AAE69E211_OFFSET UNITYSDK_OFFSET(0x180FB3E0)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_9AFCA18B112F248A_OFFSET UNITYSDK_OFFSET(0x180FD4F0)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_A9F402EE239E6F9D_OFFSET UNITYSDK_OFFSET(0x180FB180)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_DF3C54A5ADEABAF1_OFFSET UNITYSDK_OFFSET(0x180FCA00)
#define CLASS_2_4ECEAC2E03C4560A_METHOD_2_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0x180FB3C0)
#define CLASS_2_4ECEAC2E03C4560A_TICK_OFFSET UNITYSDK_OFFSET(0x180FCC00)
#define CLASS_2_4ECEAC2E03C4560A__CTOR_OFFSET UNITYSDK_OFFSET(0x180FD5D0)

inline static constexpr unsigned int Class_2_4ECEAC2E03C4560A_TypeDefinitionIndex = 73212;

class Class_2_4ECEAC2E03C4560A : public ::RPG::GameCore::GameComponentBase
{
public:
	::RPG::Client::EraFlipperManager* JBIAKKMHBEH; // 0x18
	::RPG::GameCore::NPCComponent* OLMFOBHMCKN; // 0x20
	::Class_1_8C2489600391E2B0* DFDEKCNODOE; // 0x28
	::System::String* GJEJIPHAAMF; // 0x30
	::System::String* POPAAAFPELI; // 0x38
	::System::Nullable_1<::Class_2_4ECEAC2E03C4560A_NpcShowState> OBDPBBAABGK; // 0x40
	::System::Int32 HAKEBJOFIGO; // 0x48
	::System::Single LDGHLNKPJON; // 0x4C
	::System::Single OJGJKNMNBDH; // 0x50
	::Class_2_4ECEAC2E03C4560A_NpcShowState CFKDCNLOMNN; // 0x54
	::System::Boolean OPJDFDIKDIN; // 0x58
	::System::Nullable_1<::Class_2_4ECEAC2E03C4560A_NpcStateControlSource> KBDLFAAGIAA; // 0x5C
	::System::UInt32 NHOPHPGJGME; // 0x64
