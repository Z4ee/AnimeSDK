...
#define CLASS_1_4096CBE8D6E0A5EE_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x153C3760)
#define CLASS_1_4096CBE8D6E0A5EE_METHOD_1_AA2D3E889C8A52CA_OFFSET UNITYSDK_OFFSET(0x153C37C0)
#define CLASS_1_4096CBE8D6E0A5EE__CTOR_OFFSET UNITYSDK_OFFSET(0x153C3830)

inline static constexpr unsigned int Class_1_4096CBE8D6E0A5EE_TypeDefinitionIndex = 42577;
