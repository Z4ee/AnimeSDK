...
#define MDBEDITOR_MDBDEBUGDRAWCONSTRAINS__CTOR_OFFSET UNITYSDK_OFFSET(0x11A64CF0)

namespace MdbEditor
{
	inline static constexpr unsigned int MdbDebugDrawConstrains_TypeDefinitionIndex = 91481;
