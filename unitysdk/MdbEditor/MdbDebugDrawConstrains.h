...
#define MDBEDITOR_MDBDEBUGDRAWCONSTRAINS__CTOR_OFFSET UNITYSDK_OFFSET(0x1033FA00)

namespace MdbEditor
{
	inline static constexpr unsigned int MdbDebugDrawConstrains_TypeDefinitionIndex = 85950;
