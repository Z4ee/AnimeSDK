...
#define MDBEDITOR_MDBDEBUGDRAWSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x124210B0)

namespace MdbEditor
{
	inline static constexpr unsigned int MdbDebugDrawSettings_TypeDefinitionIndex = 95384;
