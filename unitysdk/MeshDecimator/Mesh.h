...
#define MESHDECIMATOR_MESH_CLEARVERTEXATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1E278A90)
#define MESHDECIMATOR_MESH_GETINDICES_OFFSET UNITYSDK_OFFSET(0x1E270910)
#define MESHDECIMATOR_MESH_GETSUBMESHINDICES_OFFSET UNITYSDK_OFFSET(0x1E27A5A0)
#define MESHDECIMATOR_MESH_GETTRIANGLECOUNT_OFFSET UNITYSDK_OFFSET(0x1E27A500)
#define MESHDECIMATOR_MESH_GETUVDIMENSION_OFFSET UNITYSDK_OFFSET(0x1E2709F0)
#define MESHDECIMATOR_MESH_GETUVS2D_OFFSET UNITYSDK_OFFSET(0x1E270AE0)
#define MESHDECIMATOR_MESH_GETUVS3D_OFFSET UNITYSDK_OFFSET(0x1E270B70)
#define MESHDECIMATOR_MESH_GETUVS4D_OFFSET UNITYSDK_OFFSET(0x1E270C00)
#define MESHDECIMATOR_MESH_GETUVS_1_OFFSET UNITYSDK_OFFSET(0x1E27A860)
#define MESHDECIMATOR_MESH_GETUVS_2_OFFSET UNITYSDK_OFFSET(0x1E27A960)
#define MESHDECIMATOR_MESH_GETUVS_OFFSET UNITYSDK_OFFSET(0x1E27A760)
#define MESHDECIMATOR_MESH_GET_BONEWEIGHTS_OFFSET UNITYSDK_OFFSET(0x1E279200)
#define MESHDECIMATOR_MESH_GET_COLORS_OFFSET UNITYSDK_OFFSET(0x1E2791F0)
#define MESHDECIMATOR_MESH_GET_INDICES_OFFSET UNITYSDK_OFFSET(0x1E278AB0)
#define MESHDECIMATOR_MESH_GET_NORMALS_OFFSET UNITYSDK_OFFSET(0x1E279010)
#define MESHDECIMATOR_MESH_GET_SUBMESHCOUNT_OFFSET UNITYSDK_OFFSET(0x1E2707D0)
#define MESHDECIMATOR_MESH_GET_TANGENTS_OFFSET UNITYSDK_OFFSET(0x1E279020)
#define MESHDECIMATOR_MESH_GET_TRIANGLECOUNT_OFFSET UNITYSDK_OFFSET(0x1E2707F0)
#define MESHDECIMATOR_MESH_GET_UV1_OFFSET UNITYSDK_OFFSET(0x1E279030)
#define MESHDECIMATOR_MESH_GET_UV2_OFFSET UNITYSDK_OFFSET(0x1E2790A0)
#define MESHDECIMATOR_MESH_GET_UV3_OFFSET UNITYSDK_OFFSET(0x1E279110)
#define MESHDECIMATOR_MESH_GET_UV4_OFFSET UNITYSDK_OFFSET(0x1E279180)
#define MESHDECIMATOR_MESH_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1E278920)
#define MESHDECIMATOR_MESH_GET_VERTICES_OFFSET UNITYSDK_OFFSET(0x1E2789F0)
#define MESHDECIMATOR_MESH_RECALCULATENORMALS_OFFSET UNITYSDK_OFFSET(0x1E279390)
#define MESHDECIMATOR_MESH_RECALCULATETANGENTS_OFFSET UNITYSDK_OFFSET(0x1E279990)
#define MESHDECIMATOR_MESH_SETINDICES_OFFSET UNITYSDK_OFFSET(0x1E278EA0)
#define MESHDECIMATOR_MESH_SETUVS_1_OFFSET UNITYSDK_OFFSET(0x1E2724A0)
#define MESHDECIMATOR_MESH_SETUVS_2_OFFSET UNITYSDK_OFFSET(0x1E272720)
#define MESHDECIMATOR_MESH_SETUVS_3_OFFSET UNITYSDK_OFFSET(0x1E27AA60)
#define MESHDECIMATOR_MESH_SETUVS_4_OFFSET UNITYSDK_OFFSET(0x1E27ACF0)
#define MESHDECIMATOR_MESH_SETUVS_5_OFFSET UNITYSDK_OFFSET(0x1E27AF80)
#define MESHDECIMATOR_MESH_SETUVS_OFFSET UNITYSDK_OFFSET(0x1E272220)
#define MESHDECIMATOR_MESH_SET_BONEWEIGHTS_OFFSET UNITYSDK_OFFSET(0x1E272150)
#define MESHDECIMATOR_MESH_SET_COLORS_OFFSET UNITYSDK_OFFSET(0x1E272080)
#define MESHDECIMATOR_MESH_SET_INDICES_OFFSET UNITYSDK_OFFSET(0x1E278D50)
#define MESHDECIMATOR_MESH_SET_NORMALS_OFFSET UNITYSDK_OFFSET(0x1E271EE0)
#define MESHDECIMATOR_MESH_SET_SUBMESHCOUNT_OFFSET UNITYSDK_OFFSET(0x1E278940)
#define MESHDECIMATOR_MESH_SET_TANGENTS_OFFSET UNITYSDK_OFFSET(0x1E271FB0)
#define MESHDECIMATOR_MESH_SET_UV1_OFFSET UNITYSDK_OFFSET(0x1E279090)
#define MESHDECIMATOR_MESH_SET_UV2_OFFSET UNITYSDK_OFFSET(0x1E279100)
#define MESHDECIMATOR_MESH_SET_UV3_OFFSET UNITYSDK_OFFSET(0x1E279170)
#define MESHDECIMATOR_MESH_SET_UV4_OFFSET UNITYSDK_OFFSET(0x1E2791E0)
#define MESHDECIMATOR_MESH_SET_VERTICES_OFFSET UNITYSDK_OFFSET(0x1E278A00)
#define MESHDECIMATOR_MESH_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E27B210)
#define MESHDECIMATOR_MESH__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E27B2A0)
#define MESHDECIMATOR_MESH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E271D80)
#define MESHDECIMATOR_MESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1E279210)

namespace MeshDecimator
{
	inline static constexpr unsigned int Mesh_TypeDefinitionIndex = 35474;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Mesh_TypeDefinitionIndex)->GetStaticField(0x294C0);
		}
		// static const ::System::Int32 UVChannelCount = 0x4; // 0x0
		::Il2CppArray<::MeshDecimator::Math::Vector4>* colors; // 0x10
		::Il2CppArray<::MeshDecimator::BoneWeight>* boneWeights; // 0x18
		::Il2CppArray<::MeshDecimator::Math::Vector3d>* vertices; // 0x20
		::Il2CppArray<::MeshDecimator::Math::Vector4>* tangents; // 0x28
		::Il2CppArray<::Il2CppArray<::System::Int32>*>* indices; // 0x30
		::Il2CppArray<::Il2CppArray<::MeshDecimator::Math::Vector3>*>* uvs3D; // 0x38
		::Il2CppArray<::Il2CppArray<::MeshDecimator::Math::Vector2>*>* uvs2D; // 0x40
		::Il2CppArray<::Il2CppArray<::MeshDecimator::Math::Vector4>*>* uvs4D; // 0x48
		::Il2CppArray<::MeshDecimator::Math::Vector3>* normals; // 0x50
