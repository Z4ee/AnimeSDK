...
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX_DETERMINANT1_OFFSET UNITYSDK_OFFSET(0x917CD0)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX_DETERMINANT2_OFFSET UNITYSDK_OFFSET(0x917D50)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX_DETERMINANT3_OFFSET UNITYSDK_OFFSET(0x917DF0)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX_DETERMINANT4_OFFSET UNITYSDK_OFFSET(0x917E80)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX_DETERMINANT_OFFSET UNITYSDK_OFFSET(0x917F30)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x917B00)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1AA323A0)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX__CTOR_1_OFFSET UNITYSDK_OFFSET(0x917C20)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX__CTOR_2_OFFSET UNITYSDK_OFFSET(0x917C70)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX__CTOR_OFFSET UNITYSDK_OFFSET(0x917BE0)

namespace MeshDecimator::Math
{
	inline static constexpr unsigned int SymmetricMatrix_TypeDefinitionIndex = 33256;
