...
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX_DETERMINANT1_OFFSET UNITYSDK_OFFSET(0x9C32F0)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX_DETERMINANT2_OFFSET UNITYSDK_OFFSET(0x9C3370)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX_DETERMINANT3_OFFSET UNITYSDK_OFFSET(0x9C3410)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX_DETERMINANT4_OFFSET UNITYSDK_OFFSET(0x9C34A0)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX_DETERMINANT_OFFSET UNITYSDK_OFFSET(0x9C3550)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x9C3120)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1CE86F90)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9C3240)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX__CTOR_2_OFFSET UNITYSDK_OFFSET(0x9C3290)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX__CTOR_OFFSET UNITYSDK_OFFSET(0x9C3200)

namespace MeshDecimator::Math
{
	inline static constexpr unsigned int SymmetricMatrix_TypeDefinitionIndex = 34819;
