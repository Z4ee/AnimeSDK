...
#define MESHDECIMATOR_MATH_MATHHELPER_CLAMP01_1_OFFSET UNITYSDK_OFFSET(0x1E273660)
#define MESHDECIMATOR_MATH_MATHHELPER_CLAMP01_OFFSET UNITYSDK_OFFSET(0x1E273640)
#define MESHDECIMATOR_MATH_MATHHELPER_CLAMP_1_OFFSET UNITYSDK_OFFSET(0x1E273600)
#define MESHDECIMATOR_MATH_MATHHELPER_CLAMP_OFFSET UNITYSDK_OFFSET(0x1E2735D0)
#define MESHDECIMATOR_MATH_MATHHELPER_MAX_1_OFFSET UNITYSDK_OFFSET(0x1E273580)
#define MESHDECIMATOR_MATH_MATHHELPER_MAX_2_OFFSET UNITYSDK_OFFSET(0x1E273590)
#define MESHDECIMATOR_MATH_MATHHELPER_MAX_3_OFFSET UNITYSDK_OFFSET(0x1E2735A0)
#define MESHDECIMATOR_MATH_MATHHELPER_MAX_4_OFFSET UNITYSDK_OFFSET(0x1E2735B0)
#define MESHDECIMATOR_MATH_MATHHELPER_MAX_5_OFFSET UNITYSDK_OFFSET(0x1E2735C0)
#define MESHDECIMATOR_MATH_MATHHELPER_MAX_OFFSET UNITYSDK_OFFSET(0x1E267F70)
#define MESHDECIMATOR_MATH_MATHHELPER_MIN_1_OFFSET UNITYSDK_OFFSET(0x1E273540)
#define MESHDECIMATOR_MATH_MATHHELPER_MIN_2_OFFSET UNITYSDK_OFFSET(0x1E273550)
#define MESHDECIMATOR_MATH_MATHHELPER_MIN_3_OFFSET UNITYSDK_OFFSET(0x1E273560)
#define MESHDECIMATOR_MATH_MATHHELPER_MIN_4_OFFSET UNITYSDK_OFFSET(0x1E273570)
#define MESHDECIMATOR_MATH_MATHHELPER_MIN_5_OFFSET UNITYSDK_OFFSET(0x1E269550)
#define MESHDECIMATOR_MATH_MATHHELPER_MIN_OFFSET UNITYSDK_OFFSET(0x1E273530)
#define MESHDECIMATOR_MATH_MATHHELPER_TRIANGLEAREA_1_OFFSET UNITYSDK_OFFSET(0x1E273940)
#define MESHDECIMATOR_MATH_MATHHELPER_TRIANGLEAREA_OFFSET UNITYSDK_OFFSET(0x1E273680)

namespace MeshDecimator::Math
{
	inline static constexpr unsigned int MathHelper_TypeDefinitionIndex = 35477;
