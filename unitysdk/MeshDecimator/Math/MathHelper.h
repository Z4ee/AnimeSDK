...
#define MESHDECIMATOR_MATH_MATHHELPER_CLAMP01_1_OFFSET UNITYSDK_OFFSET(0x1AA3C840)
#define MESHDECIMATOR_MATH_MATHHELPER_CLAMP01_OFFSET UNITYSDK_OFFSET(0x1AA3C820)
#define MESHDECIMATOR_MATH_MATHHELPER_CLAMP_1_OFFSET UNITYSDK_OFFSET(0x1AA3C7E0)
#define MESHDECIMATOR_MATH_MATHHELPER_CLAMP_OFFSET UNITYSDK_OFFSET(0x1AA3C7B0)
#define MESHDECIMATOR_MATH_MATHHELPER_MAX_1_OFFSET UNITYSDK_OFFSET(0x1AA3C760)
#define MESHDECIMATOR_MATH_MATHHELPER_MAX_2_OFFSET UNITYSDK_OFFSET(0x1AA3C770)
#define MESHDECIMATOR_MATH_MATHHELPER_MAX_3_OFFSET UNITYSDK_OFFSET(0x1AA3C780)
#define MESHDECIMATOR_MATH_MATHHELPER_MAX_4_OFFSET UNITYSDK_OFFSET(0x1AA3C790)
#define MESHDECIMATOR_MATH_MATHHELPER_MAX_5_OFFSET UNITYSDK_OFFSET(0x1AA3C7A0)
#define MESHDECIMATOR_MATH_MATHHELPER_MAX_OFFSET UNITYSDK_OFFSET(0x1AA31050)
#define MESHDECIMATOR_MATH_MATHHELPER_MIN_1_OFFSET UNITYSDK_OFFSET(0x1AA3C720)
#define MESHDECIMATOR_MATH_MATHHELPER_MIN_2_OFFSET UNITYSDK_OFFSET(0x1AA3C730)
#define MESHDECIMATOR_MATH_MATHHELPER_MIN_3_OFFSET UNITYSDK_OFFSET(0x1AA3C740)
#define MESHDECIMATOR_MATH_MATHHELPER_MIN_4_OFFSET UNITYSDK_OFFSET(0x1AA3C750)
#define MESHDECIMATOR_MATH_MATHHELPER_MIN_5_OFFSET UNITYSDK_OFFSET(0x1AA326D0)
#define MESHDECIMATOR_MATH_MATHHELPER_MIN_OFFSET UNITYSDK_OFFSET(0x1AA3C710)
#define MESHDECIMATOR_MATH_MATHHELPER_TRIANGLEAREA_1_OFFSET UNITYSDK_OFFSET(0x1AA3CB60)
#define MESHDECIMATOR_MATH_MATHHELPER_TRIANGLEAREA_OFFSET UNITYSDK_OFFSET(0x1AA3C860)

namespace MeshDecimator::Math
{
	inline static constexpr unsigned int MathHelper_TypeDefinitionIndex = 33255;
