...
#define MESHDECIMATOR_MATH_VECTOR3D_ANGLE_OFFSET UNITYSDK_OFFSET(0x1CE91940)
#define MESHDECIMATOR_MATH_VECTOR3D_CLAMP_OFFSET UNITYSDK_OFFSET(0x9C4550)
#define MESHDECIMATOR_MATH_VECTOR3D_CROSS_OFFSET UNITYSDK_OFFSET(0x1CE87A10)
#define MESHDECIMATOR_MATH_VECTOR3D_DOT_OFFSET UNITYSDK_OFFSET(0x1CE879E0)
#define MESHDECIMATOR_MATH_VECTOR3D_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9C4670)
#define MESHDECIMATOR_MATH_VECTOR3D_EQUALS_OFFSET UNITYSDK_OFFSET(0x9C45F0)
#define MESHDECIMATOR_MATH_VECTOR3D_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9C45B0)
#define MESHDECIMATOR_MATH_VECTOR3D_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x9C4340)
#define MESHDECIMATOR_MATH_VECTOR3D_GET_MAGNITUDESQR_OFFSET UNITYSDK_OFFSET(0x9C4300)
#define MESHDECIMATOR_MATH_VECTOR3D_GET_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x9C42C0)
#define MESHDECIMATOR_MATH_VECTOR3D_GET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x9C4320)
#define MESHDECIMATOR_MATH_VECTOR3D_LERP_OFFSET UNITYSDK_OFFSET(0x1CE94E80)
#define MESHDECIMATOR_MATH_VECTOR3D_NORMALIZE_1_OFFSET UNITYSDK_OFFSET(0x1CE947C0)
#define MESHDECIMATOR_MATH_VECTOR3D_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x9C44C0)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1CE87270)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x1CE94A00)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1CE94A50)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1CE94C70)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1CE94C50)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1CE94C30)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1CE94B40)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1CE949E0)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1CE872A0)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1CE87920)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1CE94A30)
#define MESHDECIMATOR_MATH_VECTOR3D_SCALE_1_OFFSET UNITYSDK_OFFSET(0x1CE94EC0)
#define MESHDECIMATOR_MATH_VECTOR3D_SCALE_OFFSET UNITYSDK_OFFSET(0x9C4490)
#define MESHDECIMATOR_MATH_VECTOR3D_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x9C43C0)
#define MESHDECIMATOR_MATH_VECTOR3D_SET_OFFSET UNITYSDK_OFFSET(0x9C4460)
#define MESHDECIMATOR_MATH_VECTOR3D_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x9C46E0)
#define MESHDECIMATOR_MATH_VECTOR3D_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9C46B0)
#define MESHDECIMATOR_MATH_VECTOR3D__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CE94EF0)
#define MESHDECIMATOR_MATH_VECTOR3D__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9C4460)
#define MESHDECIMATOR_MATH_VECTOR3D__CTOR_2_OFFSET UNITYSDK_OFFSET(0x9C4470)
#define MESHDECIMATOR_MATH_VECTOR3D__CTOR_OFFSET UNITYSDK_OFFSET(0x9C4450)

namespace MeshDecimator::Math
{
	inline static constexpr unsigned int Vector3d_TypeDefinitionIndex = 34824;

	struct alignas(8) Vector3d
	{
		static ::MeshDecimator::Math::Vector3d* StaticGet_zero()
		{
			return (::MeshDecimator::Math::Vector3d*)Il2CppClass::FromTypeDefinitionIndex(Vector3d_TypeDefinitionIndex)->GetStaticField(0x8620);
		}
