...
#define MESHDECIMATOR_MATH_VECTOR3D_ANGLE_OFFSET UNITYSDK_OFFSET(0x1AA3CD50)
#define MESHDECIMATOR_MATH_VECTOR3D_CLAMP_OFFSET UNITYSDK_OFFSET(0x918F40)
#define MESHDECIMATOR_MATH_VECTOR3D_CROSS_OFFSET UNITYSDK_OFFSET(0x1AA32E20)
#define MESHDECIMATOR_MATH_VECTOR3D_DOT_OFFSET UNITYSDK_OFFSET(0x1AA32DF0)
#define MESHDECIMATOR_MATH_VECTOR3D_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x919060)
#define MESHDECIMATOR_MATH_VECTOR3D_EQUALS_OFFSET UNITYSDK_OFFSET(0x918FE0)
#define MESHDECIMATOR_MATH_VECTOR3D_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x918FA0)
#define MESHDECIMATOR_MATH_VECTOR3D_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x918D30)
#define MESHDECIMATOR_MATH_VECTOR3D_GET_MAGNITUDESQR_OFFSET UNITYSDK_OFFSET(0x918CF0)
#define MESHDECIMATOR_MATH_VECTOR3D_GET_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x918CB0)
#define MESHDECIMATOR_MATH_VECTOR3D_GET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x918D10)
#define MESHDECIMATOR_MATH_VECTOR3D_LERP_OFFSET UNITYSDK_OFFSET(0x1AA40290)
#define MESHDECIMATOR_MATH_VECTOR3D_NORMALIZE_1_OFFSET UNITYSDK_OFFSET(0x1AA3FBD0)
#define MESHDECIMATOR_MATH_VECTOR3D_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x918EB0)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1AA32680)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x1AA3FE10)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AA3FE60)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1AA40080)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1AA40060)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1AA40040)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1AA3FF50)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1AA3FDF0)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1AA326B0)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1AA32D30)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1AA3FE40)
#define MESHDECIMATOR_MATH_VECTOR3D_SCALE_1_OFFSET UNITYSDK_OFFSET(0x1AA402D0)
#define MESHDECIMATOR_MATH_VECTOR3D_SCALE_OFFSET UNITYSDK_OFFSET(0x918E80)
#define MESHDECIMATOR_MATH_VECTOR3D_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x918DB0)
#define MESHDECIMATOR_MATH_VECTOR3D_SET_OFFSET UNITYSDK_OFFSET(0x918E50)
#define MESHDECIMATOR_MATH_VECTOR3D_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x9190D0)
#define MESHDECIMATOR_MATH_VECTOR3D_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9190A0)
#define MESHDECIMATOR_MATH_VECTOR3D__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AA40300)
#define MESHDECIMATOR_MATH_VECTOR3D__CTOR_1_OFFSET UNITYSDK_OFFSET(0x918E50)
#define MESHDECIMATOR_MATH_VECTOR3D__CTOR_2_OFFSET UNITYSDK_OFFSET(0x918E60)
#define MESHDECIMATOR_MATH_VECTOR3D__CTOR_OFFSET UNITYSDK_OFFSET(0x918E40)

namespace MeshDecimator::Math
{
	inline static constexpr unsigned int Vector3d_TypeDefinitionIndex = 33261;

	struct alignas(8) Vector3d
	{
		static ::MeshDecimator::Math::Vector3d* StaticGet_zero()
		{
			return (::MeshDecimator::Math::Vector3d*)Il2CppClass::FromTypeDefinitionIndex(Vector3d_TypeDefinitionIndex)->GetStaticField(0x8180);
		}
