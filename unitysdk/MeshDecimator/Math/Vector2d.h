...
#define MESHDECIMATOR_MATH_VECTOR2D_CLAMP_OFFSET UNITYSDK_OFFSET(0x9C3AF0)
#define MESHDECIMATOR_MATH_VECTOR2D_DOT_OFFSET UNITYSDK_OFFSET(0x1CE937E0)
#define MESHDECIMATOR_MATH_VECTOR2D_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9C3BC0)
#define MESHDECIMATOR_MATH_VECTOR2D_EQUALS_OFFSET UNITYSDK_OFFSET(0x9C3B50)
#define MESHDECIMATOR_MATH_VECTOR2D_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9C3B30)
#define MESHDECIMATOR_MATH_VECTOR2D_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x9C3940)
#define MESHDECIMATOR_MATH_VECTOR2D_GET_MAGNITUDESQR_OFFSET UNITYSDK_OFFSET(0x9C3900)
#define MESHDECIMATOR_MATH_VECTOR2D_GET_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x9C38D0)
#define MESHDECIMATOR_MATH_VECTOR2D_GET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x9C3920)
#define MESHDECIMATOR_MATH_VECTOR2D_LERP_OFFSET UNITYSDK_OFFSET(0x1CE93800)
#define MESHDECIMATOR_MATH_VECTOR2D_NORMALIZE_1_OFFSET UNITYSDK_OFFSET(0x1CE931E0)
#define MESHDECIMATOR_MATH_VECTOR2D_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x9C3A80)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1CE933B0)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x1CE93430)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1CE93470)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1CE935C0)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1CE93590)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1CE93500)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1CE93410)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1CE933F0)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1CE933D0)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1CE93450)
#define MESHDECIMATOR_MATH_VECTOR2D_SCALE_1_OFFSET UNITYSDK_OFFSET(0x1CE93820)
#define MESHDECIMATOR_MATH_VECTOR2D_SCALE_OFFSET UNITYSDK_OFFSET(0x9C3A60)
#define MESHDECIMATOR_MATH_VECTOR2D_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x9C39C0)
#define MESHDECIMATOR_MATH_VECTOR2D_SET_OFFSET UNITYSDK_OFFSET(0x3D5A20)
#define MESHDECIMATOR_MATH_VECTOR2D_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x9C3C20)
#define MESHDECIMATOR_MATH_VECTOR2D_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9C3BF0)
#define MESHDECIMATOR_MATH_VECTOR2D__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CE93840)
#define MESHDECIMATOR_MATH_VECTOR2D__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3D5A20)
#define MESHDECIMATOR_MATH_VECTOR2D__CTOR_OFFSET UNITYSDK_OFFSET(0x9C3A50)

namespace MeshDecimator::Math
{
	inline static constexpr unsigned int Vector2d_TypeDefinitionIndex = 34821;

	struct alignas(8) Vector2d
	{
		static ::MeshDecimator::Math::Vector2d* StaticGet_zero()
		{
			return (::MeshDecimator::Math::Vector2d*)Il2CppClass::FromTypeDefinitionIndex(Vector2d_TypeDefinitionIndex)->GetStaticField(0x85F0);
		}
