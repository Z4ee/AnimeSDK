...
#define MESHDECIMATOR_MATH_VECTOR2_CLAMP_OFFSET UNITYSDK_OFFSET(0xA0DF00)
#define MESHDECIMATOR_MATH_VECTOR2_DOT_OFFSET UNITYSDK_OFFSET(0x1E274E30)
#define MESHDECIMATOR_MATH_VECTOR2_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xA0DFF0)
#define MESHDECIMATOR_MATH_VECTOR2_EQUALS_OFFSET UNITYSDK_OFFSET(0xA0DF80)
#define MESHDECIMATOR_MATH_VECTOR2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA0DF40)
#define MESHDECIMATOR_MATH_VECTOR2_GET_ITEM_OFFSET UNITYSDK_OFFSET(0xA0DD80)
#define MESHDECIMATOR_MATH_VECTOR2_GET_MAGNITUDESQR_OFFSET UNITYSDK_OFFSET(0xA0DD50)
#define MESHDECIMATOR_MATH_VECTOR2_GET_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0xA0DD30)
#define MESHDECIMATOR_MATH_VECTOR2_GET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0xA0DD70)
#define MESHDECIMATOR_MATH_VECTOR2_LERP_OFFSET UNITYSDK_OFFSET(0x1E274E50)
#define MESHDECIMATOR_MATH_VECTOR2_NORMALIZE_1_OFFSET UNITYSDK_OFFSET(0x1E274900)
#define MESHDECIMATOR_MATH_VECTOR2_NORMALIZE_OFFSET UNITYSDK_OFFSET(0xA0DEB0)
#define MESHDECIMATOR_MATH_VECTOR2_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1E26BEA0)
#define MESHDECIMATOR_MATH_VECTOR2_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x1E274B10)
#define MESHDECIMATOR_MATH_VECTOR2_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1E26C3A0)
#define MESHDECIMATOR_MATH_VECTOR2_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1E274BF0)
#define MESHDECIMATOR_MATH_VECTOR2_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1E274C40)
#define MESHDECIMATOR_MATH_VECTOR2_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1E274C20)
#define MESHDECIMATOR_MATH_VECTOR2_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1E274B60)
#define MESHDECIMATOR_MATH_VECTOR2_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1E274AE0)
#define MESHDECIMATOR_MATH_VECTOR2_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1E26BED0)
#define MESHDECIMATOR_MATH_VECTOR2_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1E274AB0)
#define MESHDECIMATOR_MATH_VECTOR2_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1E274B40)
#define MESHDECIMATOR_MATH_VECTOR2_SCALE_1_OFFSET UNITYSDK_OFFSET(0x1E274E70)
#define MESHDECIMATOR_MATH_VECTOR2_SCALE_OFFSET UNITYSDK_OFFSET(0xA0DE90)
#define MESHDECIMATOR_MATH_VECTOR2_SET_ITEM_OFFSET UNITYSDK_OFFSET(0xA0DE00)
#define MESHDECIMATOR_MATH_VECTOR2_SET_OFFSET UNITYSDK_OFFSET(0x4E4210)
#define MESHDECIMATOR_MATH_VECTOR2_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0xA0E050)
#define MESHDECIMATOR_MATH_VECTOR2_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA0E020)
#define MESHDECIMATOR_MATH_VECTOR2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E274E80)
#define MESHDECIMATOR_MATH_VECTOR2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x4E4210)
#define MESHDECIMATOR_MATH_VECTOR2__CTOR_OFFSET UNITYSDK_OFFSET(0x66D350)

namespace MeshDecimator::Math
{
	inline static constexpr unsigned int Vector2_TypeDefinitionIndex = 35479;

	struct alignas(4) Vector2
	{
		static ::MeshDecimator::Math::Vector2* StaticGet_zero()
		{
			return (::MeshDecimator::Math::Vector2*)Il2CppClass::FromTypeDefinitionIndex(Vector2_TypeDefinitionIndex)->GetStaticField(0x86C0);
		}
