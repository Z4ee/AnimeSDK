...
#define MESHDECIMATOR_MATH_VECTOR3_ANGLE_OFFSET UNITYSDK_OFFSET(0x1AA3CA50)
#define MESHDECIMATOR_MATH_VECTOR3_CLAMP_OFFSET UNITYSDK_OFFSET(0x918AF0)
#define MESHDECIMATOR_MATH_VECTOR3_CROSS_OFFSET UNITYSDK_OFFSET(0x1AA3F830)
#define MESHDECIMATOR_MATH_VECTOR3_DOT_OFFSET UNITYSDK_OFFSET(0x1AA3F800)
#define MESHDECIMATOR_MATH_VECTOR3_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x918C20)
#define MESHDECIMATOR_MATH_VECTOR3_EQUALS_OFFSET UNITYSDK_OFFSET(0x918BA0)
#define MESHDECIMATOR_MATH_VECTOR3_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x918B40)
#define MESHDECIMATOR_MATH_VECTOR3_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x918920)
#define MESHDECIMATOR_MATH_VECTOR3_GET_MAGNITUDESQR_OFFSET UNITYSDK_OFFSET(0x9188E0)
#define MESHDECIMATOR_MATH_VECTOR3_GET_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x9188B0)
#define MESHDECIMATOR_MATH_VECTOR3_GET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x918900)
#define MESHDECIMATOR_MATH_VECTOR3_LERP_OFFSET UNITYSDK_OFFSET(0x1AA3F880)
#define MESHDECIMATOR_MATH_VECTOR3_NORMALIZE_1_OFFSET UNITYSDK_OFFSET(0x1AA3F1B0)
#define MESHDECIMATOR_MATH_VECTOR3_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x918A70)
#define MESHDECIMATOR_MATH_VECTOR3_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1AA34F60)
#define MESHDECIMATOR_MATH_VECTOR3_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x1AA3F3F0)
#define MESHDECIMATOR_MATH_VECTOR3_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AA35580)
#define MESHDECIMATOR_MATH_VECTOR3_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1AA3F530)
#define MESHDECIMATOR_MATH_VECTOR3_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1AA3F570)
#define MESHDECIMATOR_MATH_VECTOR3_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1AA3F550)
#define MESHDECIMATOR_MATH_VECTOR3_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1AA3F440)
#define MESHDECIMATOR_MATH_VECTOR3_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1AA3F3D0)
#define MESHDECIMATOR_MATH_VECTOR3_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1AA34F90)
#define MESHDECIMATOR_MATH_VECTOR3_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1AA3C9F0)
#define MESHDECIMATOR_MATH_VECTOR3_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1AA3F410)
#define MESHDECIMATOR_MATH_VECTOR3_ORTHONORMALIZE_OFFSET UNITYSDK_OFFSET(0x1AA3F8E0)
#define MESHDECIMATOR_MATH_VECTOR3_SCALE_1_OFFSET UNITYSDK_OFFSET(0x1AA3F8C0)
#define MESHDECIMATOR_MATH_VECTOR3_SCALE_OFFSET UNITYSDK_OFFSET(0x918A50)
#define MESHDECIMATOR_MATH_VECTOR3_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x9189A0)
#define MESHDECIMATOR_MATH_VECTOR3_SET_OFFSET UNITYSDK_OFFSET(0x494CF0)
#define MESHDECIMATOR_MATH_VECTOR3_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x918C80)
#define MESHDECIMATOR_MATH_VECTOR3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x918C50)
#define MESHDECIMATOR_MATH_VECTOR3__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AA3FA60)
#define MESHDECIMATOR_MATH_VECTOR3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x494CF0)
#define MESHDECIMATOR_MATH_VECTOR3__CTOR_2_OFFSET UNITYSDK_OFFSET(0x918A30)
#define MESHDECIMATOR_MATH_VECTOR3__CTOR_OFFSET UNITYSDK_OFFSET(0x588CA0)

namespace MeshDecimator::Math
{
	inline static constexpr unsigned int Vector3_TypeDefinitionIndex = 33260;

	struct alignas(4) Vector3
	{
		static ::MeshDecimator::Math::Vector3* StaticGet_zero()
		{
			return (::MeshDecimator::Math::Vector3*)Il2CppClass::FromTypeDefinitionIndex(Vector3_TypeDefinitionIndex)->GetStaticField(0x8170);
		}
