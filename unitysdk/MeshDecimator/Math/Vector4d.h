...
#define MESHDECIMATOR_MATH_VECTOR4D_CLAMP_OFFSET UNITYSDK_OFFSET(0x919BD0)
#define MESHDECIMATOR_MATH_VECTOR4D_DOT_OFFSET UNITYSDK_OFFSET(0x1AA41A50)
#define MESHDECIMATOR_MATH_VECTOR4D_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x919D30)
#define MESHDECIMATOR_MATH_VECTOR4D_EQUALS_OFFSET UNITYSDK_OFFSET(0x919CA0)
#define MESHDECIMATOR_MATH_VECTOR4D_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x919C50)
#define MESHDECIMATOR_MATH_VECTOR4D_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x919960)
#define MESHDECIMATOR_MATH_VECTOR4D_GET_MAGNITUDESQR_OFFSET UNITYSDK_OFFSET(0x919910)
#define MESHDECIMATOR_MATH_VECTOR4D_GET_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x9198D0)
#define MESHDECIMATOR_MATH_VECTOR4D_GET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x919940)
#define MESHDECIMATOR_MATH_VECTOR4D_LERP_OFFSET UNITYSDK_OFFSET(0x1AA41A90)
#define MESHDECIMATOR_MATH_VECTOR4D_NORMALIZE_1_OFFSET UNITYSDK_OFFSET(0x1AA411E0)
#define MESHDECIMATOR_MATH_VECTOR4D_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x919B30)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1AA41450)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x1AA41510)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AA41560)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1AA41710)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1AA416F0)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1AA41630)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1AA414E0)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1AA414B0)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1AA41480)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1AA41540)
#define MESHDECIMATOR_MATH_VECTOR4D_SCALE_1_OFFSET UNITYSDK_OFFSET(0x1AA41AD0)
#define MESHDECIMATOR_MATH_VECTOR4D_SCALE_OFFSET UNITYSDK_OFFSET(0x919B00)
#define MESHDECIMATOR_MATH_VECTOR4D_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x919A10)
#define MESHDECIMATOR_MATH_VECTOR4D_SET_OFFSET UNITYSDK_OFFSET(0x919AE0)
#define MESHDECIMATOR_MATH_VECTOR4D_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x919DC0)
#define MESHDECIMATOR_MATH_VECTOR4D_TOSTRING_OFFSET UNITYSDK_OFFSET(0x919D70)
#define MESHDECIMATOR_MATH_VECTOR4D__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AA41B00)
#define MESHDECIMATOR_MATH_VECTOR4D__CTOR_1_OFFSET UNITYSDK_OFFSET(0x919AE0)
#define MESHDECIMATOR_MATH_VECTOR4D__CTOR_OFFSET UNITYSDK_OFFSET(0x919AC0)

namespace MeshDecimator::Math
{
	inline static constexpr unsigned int Vector4d_TypeDefinitionIndex = 33264;

	struct alignas(8) Vector4d
	{
		static ::MeshDecimator::Math::Vector4d* StaticGet_zero()
		{
			return (::MeshDecimator::Math::Vector4d*)Il2CppClass::FromTypeDefinitionIndex(Vector4d_TypeDefinitionIndex)->GetStaticField(0x81C0);
		}
