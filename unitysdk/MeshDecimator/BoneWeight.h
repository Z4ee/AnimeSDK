...
#define MESHDECIMATOR_BONEWEIGHT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x917A90)
#define MESHDECIMATOR_BONEWEIGHT_EQUALS_OFFSET UNITYSDK_OFFSET(0x9179F0)
#define MESHDECIMATOR_BONEWEIGHT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x917950)
#define MESHDECIMATOR_BONEWEIGHT_MERGEBONEWEIGHT_OFFSET UNITYSDK_OFFSET(0x9178C0)
#define MESHDECIMATOR_BONEWEIGHT_MERGE_OFFSET UNITYSDK_OFFSET(0x1AA3C660)
#define MESHDECIMATOR_BONEWEIGHT_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x9178D0)
#define MESHDECIMATOR_BONEWEIGHT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AA3BBC0)
#define MESHDECIMATOR_BONEWEIGHT_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1AA3BD80)
#define MESHDECIMATOR_BONEWEIGHT_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1AA3BD40)
#define MESHDECIMATOR_BONEWEIGHT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x917AF0)
#define MESHDECIMATOR_BONEWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x917880)

namespace MeshDecimator
{
	inline static constexpr unsigned int BoneWeight_TypeDefinitionIndex = 33251;
