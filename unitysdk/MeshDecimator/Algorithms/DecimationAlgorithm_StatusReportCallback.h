...
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_STATUSREPORTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AA317D0)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_STATUSREPORTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AA31890)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_STATUSREPORTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AA31190)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_STATUSREPORTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA317C0)

namespace MeshDecimator::Algorithms
{
	inline static constexpr unsigned int DecimationAlgorithm_StatusReportCallback_TypeDefinitionIndex = 33269;
