...
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_STATUSREPORTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CE863C0)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_STATUSREPORTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CE86480)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_STATUSREPORTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CE85D70)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_STATUSREPORTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE863A0)

namespace MeshDecimator::Algorithms
{
	inline static constexpr unsigned int DecimationAlgorithm_StatusReportCallback_TypeDefinitionIndex = 34832;
