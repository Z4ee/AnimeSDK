...
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_TRIANGLE_GETATTRIBUTEINDICES_OFFSET UNITYSDK_OFFSET(0x9176E0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_TRIANGLE_GETERRORS_OFFSET UNITYSDK_OFFSET(0x917770)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_TRIANGLE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x917600)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_TRIANGLE_SETATTRIBUTEINDEX_OFFSET UNITYSDK_OFFSET(0x9176F0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_TRIANGLE_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x917620)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_TRIANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x9176A0)

namespace MeshDecimator::Algorithms
{
	inline static constexpr unsigned int FastQuadricMeshSimplification_Triangle_TypeDefinitionIndex = 33271;
