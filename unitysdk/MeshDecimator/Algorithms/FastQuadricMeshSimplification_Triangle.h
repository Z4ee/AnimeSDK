...
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_TRIANGLE_GETATTRIBUTEINDICES_OFFSET UNITYSDK_OFFSET(0xA0D520)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_TRIANGLE_GETERRORS_OFFSET UNITYSDK_OFFSET(0xA0D5B0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_TRIANGLE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0xA0D440)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_TRIANGLE_SETATTRIBUTEINDEX_OFFSET UNITYSDK_OFFSET(0xA0D530)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_TRIANGLE_SET_ITEM_OFFSET UNITYSDK_OFFSET(0xA0D460)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_TRIANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0xA0D4E0)

namespace MeshDecimator::Algorithms
{
	inline static constexpr unsigned int FastQuadricMeshSimplification_Triangle_TypeDefinitionIndex = 35493;
