...
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_AREUVSTHESAME_OFFSET UNITYSDK_OFFSET(0x1AA35050)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_CALCULATEERROR_OFFSET UNITYSDK_OFFSET(0x1AA31C70)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_COMPACTMESH_OFFSET UNITYSDK_OFFSET(0x1AA37CA0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_DECIMATEMESHLOSSLESS_OFFSET UNITYSDK_OFFSET(0x1AA3A140)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_DECIMATEMESH_OFFSET UNITYSDK_OFFSET(0x1AA39E40)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_FLIPPED_OFFSET UNITYSDK_OFFSET(0x1AA326E0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_GET_AGRESSIVENESS_OFFSET UNITYSDK_OFFSET(0x1AA31920)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_GET_ENABLESMARTLINK_OFFSET UNITYSDK_OFFSET(0x1AA318E0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_GET_MAXITERATIONCOUNT_OFFSET UNITYSDK_OFFSET(0x1AA31900)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_GET_PRESERVEFOLDOVERS_OFFSET UNITYSDK_OFFSET(0x1AA318C0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_GET_PRESERVESEAMS_OFFSET UNITYSDK_OFFSET(0x1AA318A0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_GET_VERTEXLINKDISTANCESQR_OFFSET UNITYSDK_OFFSET(0x1AA31940)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1AA39110)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_MERGEVERTEXATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1AA33F50)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_MOVEVERTEXATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1AA33620)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_REMOVEVERTEXPASS_OFFSET UNITYSDK_OFFSET(0x1AA35730)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_SET_AGRESSIVENESS_OFFSET UNITYSDK_OFFSET(0x1AA31930)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_SET_ENABLESMARTLINK_OFFSET UNITYSDK_OFFSET(0x1AA318F0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_SET_MAXITERATIONCOUNT_OFFSET UNITYSDK_OFFSET(0x1AA31910)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_SET_PRESERVEFOLDOVERS_OFFSET UNITYSDK_OFFSET(0x1AA318D0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_SET_PRESERVESEAMS_OFFSET UNITYSDK_OFFSET(0x1AA318B0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_SET_VERTEXLINKDISTANCESQR_OFFSET UNITYSDK_OFFSET(0x1AA31950)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_TOMESH_OFFSET UNITYSDK_OFFSET(0x1AA3A370)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_UPDATEMESH_OFFSET UNITYSDK_OFFSET(0x1AA361A0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_UPDATEREFERENCES_OFFSET UNITYSDK_OFFSET(0x1AA37820)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_UPDATETRIANGLES_OFFSET UNITYSDK_OFFSET(0x1AA32E70)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_VERTEXERROR_OFFSET UNITYSDK_OFFSET(0x1AA31B60)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA31960)

namespace MeshDecimator::Algorithms
{
	inline static constexpr unsigned int FastQuadricMeshSimplification_TypeDefinitionIndex = 33270;
	...
	public:
		...
		::MeshDecimator::Collections::ResizableArray_1<::MeshDecimator::Algorithms::FastQuadricMeshSimplification_Ref>* refs; // 0x20
		::MeshDecimator::Collections::UVChannels_1<::MeshDecimator::Math::Vector3>* vertUV3D; // 0x28
		::Il2CppArray<::System::Double>* errArr; // 0x30
		::MeshDecimator::Collections::ResizableArray_1<::MeshDecimator::Algorithms::FastQuadricMeshSimplification_Vertex>* vertices; // 0x38
		::MeshDecimator::Collections::ResizableArray_1<::MeshDecimator::Math::Vector3>* vertNormals; // 0x40
		::MeshDecimator::Collections::ResizableArray_1<::MeshDecimator::Algorithms::FastQuadricMeshSimplification_Triangle>* triangles; // 0x48
		::MeshDecimator::Collections::UVChannels_1<::MeshDecimator::Math::Vector4>* vertUV4D; // 0x50
		::MeshDecimator::Collections::ResizableArray_1<::MeshDecimator::Math::Vector4>* vertColors; // 0x58
		::MeshDecimator::Collections::ResizableArray_1<::MeshDecimator::BoneWeight>* vertBoneWeights; // 0x60
		::MeshDecimator::Collections::ResizableArray_1<::MeshDecimator::Math::Vector4>* vertTangents; // 0x68
		::Il2CppArray<::System::Int32>* attributeIndexArr; // 0x70
		::MeshDecimator::Collections::UVChannels_1<::MeshDecimator::Math::Vector2>* vertUV2D; // 0x78
		::System::Int32 subMeshCount; // 0x80
		::System::Boolean enableSmartLink; // 0x84
		::System::Boolean preserveSeams; // 0x85
		::System::Boolean preserveFoldovers; // 0x86
		::System::Double agressiveness; // 0x88
