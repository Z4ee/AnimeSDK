...
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_AREUVSTHESAME_OFFSET UNITYSDK_OFFSET(0x1CE89C40)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_CALCULATEERROR_OFFSET UNITYSDK_OFFSET(0x1CE86860)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_COMPACTMESH_OFFSET UNITYSDK_OFFSET(0x1CE8C890)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_DECIMATEMESHLOSSLESS_OFFSET UNITYSDK_OFFSET(0x1CE8ED30)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_DECIMATEMESH_OFFSET UNITYSDK_OFFSET(0x1CE8EA30)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_FLIPPED_OFFSET UNITYSDK_OFFSET(0x1CE872D0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_GET_AGRESSIVENESS_OFFSET UNITYSDK_OFFSET(0x1CE86510)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_GET_ENABLESMARTLINK_OFFSET UNITYSDK_OFFSET(0x1CE864D0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_GET_MAXITERATIONCOUNT_OFFSET UNITYSDK_OFFSET(0x1CE864F0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_GET_PRESERVEFOLDOVERS_OFFSET UNITYSDK_OFFSET(0x1CE864B0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_GET_PRESERVESEAMS_OFFSET UNITYSDK_OFFSET(0x1CE86490)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_GET_VERTEXLINKDISTANCESQR_OFFSET UNITYSDK_OFFSET(0x1CE86530)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1CE8DD00)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_MERGEVERTEXATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1CE88B40)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_MOVEVERTEXATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1CE88210)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_REMOVEVERTEXPASS_OFFSET UNITYSDK_OFFSET(0x1CE8A320)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_SET_AGRESSIVENESS_OFFSET UNITYSDK_OFFSET(0x1CE86520)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_SET_ENABLESMARTLINK_OFFSET UNITYSDK_OFFSET(0x1CE864E0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_SET_MAXITERATIONCOUNT_OFFSET UNITYSDK_OFFSET(0x1CE86500)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_SET_PRESERVEFOLDOVERS_OFFSET UNITYSDK_OFFSET(0x1CE864C0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_SET_PRESERVESEAMS_OFFSET UNITYSDK_OFFSET(0x1CE864A0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_SET_VERTEXLINKDISTANCESQR_OFFSET UNITYSDK_OFFSET(0x1CE86540)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_TOMESH_OFFSET UNITYSDK_OFFSET(0x1CE8EF60)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_UPDATEMESH_OFFSET UNITYSDK_OFFSET(0x1CE8AD90)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_UPDATEREFERENCES_OFFSET UNITYSDK_OFFSET(0x1CE8C410)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_UPDATETRIANGLES_OFFSET UNITYSDK_OFFSET(0x1CE87A60)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_VERTEXERROR_OFFSET UNITYSDK_OFFSET(0x1CE86750)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE86550)

namespace MeshDecimator::Algorithms
{
	inline static constexpr unsigned int FastQuadricMeshSimplification_TypeDefinitionIndex = 34833;
	...
	public:
		...
		::MeshDecimator::Collections::UVChannels_1<::MeshDecimator::Math::Vector4>* vertUV4D; // 0x30
		::MeshDecimator::Collections::ResizableArray_1<::MeshDecimator::Algorithms::FastQuadricMeshSimplification_Vertex>* vertices; // 0x38
		::MeshDecimator::Collections::UVChannels_1<::MeshDecimator::Math::Vector3>* vertUV3D; // 0x40
		::MeshDecimator::Collections::ResizableArray_1<::MeshDecimator::BoneWeight>* vertBoneWeights; // 0x48
		::Il2CppArray<::System::Double>* errArr; // 0x50
		::MeshDecimator::Collections::ResizableArray_1<::MeshDecimator::Math::Vector4>* vertTangents; // 0x58
		::MeshDecimator::Collections::UVChannels_1<::MeshDecimator::Math::Vector2>* vertUV2D; // 0x60
		::MeshDecimator::Collections::ResizableArray_1<::MeshDecimator::Algorithms::FastQuadricMeshSimplification_Ref>* refs; // 0x68
		::MeshDecimator::Collections::ResizableArray_1<::MeshDecimator::Math::Vector3>* vertNormals; // 0x70
		::MeshDecimator::Collections::ResizableArray_1<::MeshDecimator::Algorithms::FastQuadricMeshSimplification_Triangle>* triangles; // 0x78
		::System::Int32 maxIterationCount; // 0x80
		::System::Int32 subMeshCount; // 0x84
		::System::Int32 remainingVertices; // 0x88
		::System::Boolean preserveFoldovers; // 0x8C
		::System::Boolean preserveSeams; // 0x8D
		::System::Boolean enableSmartLink; // 0x8E
		::System::Double vertexLinkDistanceSqr; // 0x90
		::System::Double agressiveness; // 0x98
