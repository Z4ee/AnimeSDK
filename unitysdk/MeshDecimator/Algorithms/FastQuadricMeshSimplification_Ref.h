...
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_REF_SET_OFFSET UNITYSDK_OFFSET(0x2AB920)

namespace MeshDecimator::Algorithms
{
	inline static constexpr unsigned int FastQuadricMeshSimplification_Ref_TypeDefinitionIndex = 34836;
