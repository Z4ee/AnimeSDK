...
#define MESHDECIMATOR_MESHDECIMATION_CREATEALGORITHM_OFFSET UNITYSDK_OFFSET(0x1CE99670)
#define MESHDECIMATOR_MESHDECIMATION_DECIMATEMESHLOSSLESS_1_OFFSET UNITYSDK_OFFSET(0x1CE999C0)
#define MESHDECIMATOR_MESHDECIMATION_DECIMATEMESHLOSSLESS_2_OFFSET UNITYSDK_OFFSET(0x1CE99AB0)
#define MESHDECIMATOR_MESHDECIMATION_DECIMATEMESHLOSSLESS_OFFSET UNITYSDK_OFFSET(0x1CE999B0)
#define MESHDECIMATOR_MESHDECIMATION_DECIMATEMESH_1_OFFSET UNITYSDK_OFFSET(0x1CE99700)
#define MESHDECIMATOR_MESHDECIMATION_DECIMATEMESH_2_OFFSET UNITYSDK_OFFSET(0x1CE997F0)
#define MESHDECIMATOR_MESHDECIMATION_DECIMATEMESH_OFFSET UNITYSDK_OFFSET(0x1CE996F0)

namespace MeshDecimator
{
	inline static constexpr unsigned int MeshDecimation_TypeDefinitionIndex = 34817;
