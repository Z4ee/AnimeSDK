...
#define AKANDROIDSETTINGS_GETADVANCEDSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A5C8190)
#define AKANDROIDSETTINGS_GETCOMMSSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A5C81D0)
#define AKANDROIDSETTINGS_GETUSERSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A5C8150)
#define AKANDROIDSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5C7F10)

inline static constexpr unsigned int AkAndroidSettings_TypeDefinitionIndex = 40362;
