...
#define AKANDROIDSETTINGS_GETADVANCEDSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B412FE0)
#define AKANDROIDSETTINGS_GETCOMMSSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B413020)
#define AKANDROIDSETTINGS_GETUSERSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B412FA0)
#define AKANDROIDSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B412D60)

inline static constexpr unsigned int AkAndroidSettings_TypeDefinitionIndex = 41189;
