...
#define CLASS_1_0272D5A0C4F089B0__CTOR_OFFSET UNITYSDK_OFFSET(0x18AC3420)

inline static constexpr unsigned int Class_1_0272D5A0C4F089B0_TypeDefinitionIndex = 34470;

class Class_1_0272D5A0C4F089B0 : public ::System::Object
{
public:
	::RPG::GameCore::ActivityDiceCombatSpecialRuleRow* Field_1_0; // 0x10
	::Class_1_15B3DD195FDC216E* Field_1_1; // 0x18
	::RPG::GameCore::DiceCombatSkillConfig* Field_1_2; // 0x20
	::RPG::GameCore::DiceCombatWeatherSkillConfig* Field_1_3; // 0x28
	::RPG::GameCore::ActivityDiceCombatAIGroupRow* Field_1_4; // 0x30
