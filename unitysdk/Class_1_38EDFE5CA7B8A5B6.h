...
#define CLASS_1_38EDFE5CA7B8A5B6_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C733470)
#define CLASS_1_38EDFE5CA7B8A5B6_CLONE_OFFSET UNITYSDK_OFFSET(0x1C732F70)
#define CLASS_1_38EDFE5CA7B8A5B6_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C733100)
#define CLASS_1_38EDFE5CA7B8A5B6_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C733070)
#define CLASS_1_38EDFE5CA7B8A5B6_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C7331F0)
#define CLASS_1_38EDFE5CA7B8A5B6_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C7336B0)
#define CLASS_1_38EDFE5CA7B8A5B6_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C733660)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1C733030)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1C732FF0)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_3163C288F3AE2966_OFFSET UNITYSDK_OFFSET(0x1C733020)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C732EB0)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1C733040)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1C733000)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1C733060)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_CE81D059476B1F49_OFFSET UNITYSDK_OFFSET(0x1C733010)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1C733050)
#define CLASS_1_38EDFE5CA7B8A5B6_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C732F10)
#define CLASS_1_38EDFE5CA7B8A5B6_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C733240)
#define CLASS_1_38EDFE5CA7B8A5B6_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C7332A0)
#define CLASS_1_38EDFE5CA7B8A5B6__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C733760)
#define CLASS_1_38EDFE5CA7B8A5B6__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C732F30)
#define CLASS_1_38EDFE5CA7B8A5B6__CTOR_OFFSET UNITYSDK_OFFSET(0x1C732F20)

inline static constexpr unsigned int Class_1_38EDFE5CA7B8A5B6_TypeDefinitionIndex = 24240;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_38EDFE5CA7B8A5B6*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_38EDFE5CA7B8A5B6_TypeDefinitionIndex)->GetStaticField(0x5F570);
	}
