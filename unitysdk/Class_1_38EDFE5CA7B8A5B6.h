...
#define CLASS_1_38EDFE5CA7B8A5B6_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E2D26F0)
#define CLASS_1_38EDFE5CA7B8A5B6_CLONE_OFFSET UNITYSDK_OFFSET(0x1E2D21F0)
#define CLASS_1_38EDFE5CA7B8A5B6_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E2D2380)
#define CLASS_1_38EDFE5CA7B8A5B6_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E2D22F0)
#define CLASS_1_38EDFE5CA7B8A5B6_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E2D2470)
#define CLASS_1_38EDFE5CA7B8A5B6_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E2D2930)
#define CLASS_1_38EDFE5CA7B8A5B6_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E2D28E0)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1E2D22B0)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1E2D2270)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_3163C288F3AE2966_OFFSET UNITYSDK_OFFSET(0x1E2D22A0)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1E2D2130)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1E2D22C0)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1E2D2280)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1E2D22E0)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_CE81D059476B1F49_OFFSET UNITYSDK_OFFSET(0x1E2D2290)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1E2D22D0)
#define CLASS_1_38EDFE5CA7B8A5B6_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E2D2190)
#define CLASS_1_38EDFE5CA7B8A5B6_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E2D24C0)
#define CLASS_1_38EDFE5CA7B8A5B6_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E2D2520)
#define CLASS_1_38EDFE5CA7B8A5B6__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E2D29E0)
#define CLASS_1_38EDFE5CA7B8A5B6__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E2D21B0)
#define CLASS_1_38EDFE5CA7B8A5B6__CTOR_OFFSET UNITYSDK_OFFSET(0x1E2D21A0)

inline static constexpr unsigned int Class_1_38EDFE5CA7B8A5B6_TypeDefinitionIndex = 24829;

class Class_1_38EDFE5CA7B8A5B6 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_38EDFE5CA7B8A5B6*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_38EDFE5CA7B8A5B6*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_38EDFE5CA7B8A5B6_TypeDefinitionIndex)->GetStaticField(0x3A970);
	}
	...
	// static const ::System::Int32 ADIEOHBMAFA = 0x4; // 0x0
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x10
	::System::UInt32 GOHOKFAPDCI; // 0x18
	::System::UInt32 HJEGLCJEOKC; // 0x1C
	::System::UInt64 DEJFOEHNFJA; // 0x20
	::System::Boolean DDEGKLCOFDE; // 0x28
