...
inline static constexpr unsigned int Struct_2_86384ECD2885D438_TypeDefinitionIndex = 41501;

template <typename TFilterPolicy>
struct Struct_2_86384ECD2885D438
{
	TFilterPolicy Field_2_1; // 0x0
	::Struct_2_AAD2B1B6FB741157 Field_2_0; // 0x0
};
