...
#define CLASS_1_2AA304B71C6E8B6D_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x155EDEE0)
#define CLASS_1_2AA304B71C6E8B6D_EQUALS_OFFSET UNITYSDK_OFFSET(0x155EDE00)
#define CLASS_1_2AA304B71C6E8B6D_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x155EDF70)
#define CLASS_1_2AA304B71C6E8B6D_METHOD_1_148214CEA2F00B70_OFFSET UNITYSDK_OFFSET(0x155EE100)
#define CLASS_1_2AA304B71C6E8B6D_METHOD_1_6062BB7D9634C869_OFFSET UNITYSDK_OFFSET(0x155EE020)
#define CLASS_1_2AA304B71C6E8B6D__CTOR_OFFSET UNITYSDK_OFFSET(0x155EE1E0)

inline static constexpr unsigned int Class_1_2AA304B71C6E8B6D_TypeDefinitionIndex = 71493;

class Class_1_2AA304B71C6E8B6D : public ::System::Object
{
public:
	::UnityEngine::GameObject* MCLLALGABAB; // 0x10
	::UnityEngine::Vector2 JFAGECNFHJL; // 0x18
	::System::Boolean JILEMDKEOKL; // 0x20
	::System::Boolean CPFEDPAGDFF; // 0x21
	::System::Boolean BPEKOACCGHK; // 0x22
