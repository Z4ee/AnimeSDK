...
#define CLASS_2_4AFB5D2A57AE0B49_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA62B240)
#define CLASS_2_4AFB5D2A57AE0B49_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xA62B280)
#define CLASS_2_4AFB5D2A57AE0B49_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xA62B6B0)
#define CLASS_2_4AFB5D2A57AE0B49_TICK_OFFSET UNITYSDK_OFFSET(0xA62B700)
#define CLASS_2_4AFB5D2A57AE0B49__CTOR_OFFSET UNITYSDK_OFFSET(0xA62B230)

inline static constexpr unsigned int Class_2_4AFB5D2A57AE0B49_TypeDefinitionIndex = 51888;

class Class_2_4AFB5D2A57AE0B49 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::SetNoShadowCaster* Field_2_1; // 0x20
