...
#define CLASS_1_8789FE9A7EA728A4_4_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19FA6150)
#define CLASS_1_8789FE9A7EA728A4_4_CLONE_OFFSET UNITYSDK_OFFSET(0x19FA5CE0)
#define CLASS_1_8789FE9A7EA728A4_4_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19FA5E40)
#define CLASS_1_8789FE9A7EA728A4_4_EQUALS_OFFSET UNITYSDK_OFFSET(0x19FA5D60)
#define CLASS_1_8789FE9A7EA728A4_4_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19FA5F10)
#define CLASS_1_8789FE9A7EA728A4_4_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19FA6320)
#define CLASS_1_8789FE9A7EA728A4_4_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19FA6270)
#define CLASS_1_8789FE9A7EA728A4_4_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x19FA5D30)
#define CLASS_1_8789FE9A7EA728A4_4_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x19FA5D50)
#define CLASS_1_8789FE9A7EA728A4_4_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19FA5B90)
#define CLASS_1_8789FE9A7EA728A4_4_METHOD_1_686CBC4FBD0AAA58_OFFSET UNITYSDK_OFFSET(0x19FA5D20)
#define CLASS_1_8789FE9A7EA728A4_4_METHOD_1_6BD2A2909D8CFAD3_OFFSET UNITYSDK_OFFSET(0x19FA5D10)
#define CLASS_1_8789FE9A7EA728A4_4_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x19FA5D40)
#define CLASS_1_8789FE9A7EA728A4_4_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19FA5BC0)
#define CLASS_1_8789FE9A7EA728A4_4_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19FA6020)
#define CLASS_1_8789FE9A7EA728A4_4_WRITETO_OFFSET UNITYSDK_OFFSET(0x19FA6080)
#define CLASS_1_8789FE9A7EA728A4_4__CCTOR_OFFSET UNITYSDK_OFFSET(0x19FA6450)
#define CLASS_1_8789FE9A7EA728A4_4__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19FA5C20)
#define CLASS_1_8789FE9A7EA728A4_4__CTOR_OFFSET UNITYSDK_OFFSET(0x19FA5BD0)

inline static constexpr unsigned int Class_1_8789FE9A7EA728A4_4_TypeDefinitionIndex = 31398;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_8789FE9A7EA728A4_4*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_8789FE9A7EA728A4_4_TypeDefinitionIndex)->GetStaticField(0xC6C0);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_8789FE9A7EA728A4_4_TypeDefinitionIndex)->GetStaticField(0xC6C8);
	}
