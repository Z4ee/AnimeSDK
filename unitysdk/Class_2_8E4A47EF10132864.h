...
#define CLASS_2_8E4A47EF10132864_GET_FLAG_OFFSET UNITYSDK_OFFSET(0x19FE0E30)
#define CLASS_2_8E4A47EF10132864_METHOD_2_0B3C24AF37521D8A_OFFSET UNITYSDK_OFFSET(0x19FE03A0)
#define CLASS_2_8E4A47EF10132864_METHOD_2_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x19FE02A0)
#define CLASS_2_8E4A47EF10132864_METHOD_2_83693FD94A4D8C98_OFFSET UNITYSDK_OFFSET(0x19FE0910)
#define CLASS_2_8E4A47EF10132864_METHOD_2_9A90752C43418F0C_OFFSET UNITYSDK_OFFSET(0x19FDFF30)
#define CLASS_2_8E4A47EF10132864_METHOD_2_AC7CD4175E0A3EF8_OFFSET UNITYSDK_OFFSET(0x19FE0750)
#define CLASS_2_8E4A47EF10132864_METHOD_2_D7852DE078ACC1F1_OFFSET UNITYSDK_OFFSET(0x19FE0500)
#define CLASS_2_8E4A47EF10132864_METHOD_2_E41B6A823556FEEA_OFFSET UNITYSDK_OFFSET(0x19FDFE20)
#define CLASS_2_8E4A47EF10132864_METHOD_2_E88DC1D3D084A0F1_OFFSET UNITYSDK_OFFSET(0x19FDFE80)
#define CLASS_2_8E4A47EF10132864_METHOD_2_F6EB917C5A67C7BA_OFFSET UNITYSDK_OFFSET(0x19FE0250)
#define CLASS_2_8E4A47EF10132864__CCTOR_OFFSET UNITYSDK_OFFSET(0x19FE0E40)
#define CLASS_2_8E4A47EF10132864__CTOR_OFFSET UNITYSDK_OFFSET(0x19FDFD80)
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_2_8E4A47EF10132864_TypeDefinitionIndex)->GetStaticField(0x9900);
	}
	static ::System::Int32* StaticGet_IFLNJLFCHOM()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_2_8E4A47EF10132864_TypeDefinitionIndex)->GetStaticField(0x9904);
	}
	::RPG::GameCore::AdventureCharacterDataComponent* JBCJJOALMEF; // 0x68
	::RPG::GameCore::TransformComponent* NIDHDAOGNKO; // 0x70
	::Class_2_A0580152EB393340* NLLJCLJBMAJ; // 0x78
	::RPG::GameCore::AdventureCharacterController* CACEADPJLPB; // 0x80
	::RPG::GameCore::NPCComponent* OLMFOBHMCKN; // 0x88
	::UnityEngine::Vector3 ABEGGIHNEMD; // 0x90
