...
#define FISHINGRODCONTROLLER_BLENDTO_OFFSET UNITYSDK_OFFSET(0x1586C890)
#define FISHINGRODCONTROLLER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1586B3F0)
#define FISHINGRODCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1586B9B0)
#define FISHINGRODCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x1586B960)
#define FISHINGRODCONTROLLER_TRYINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1586B540)
#define FISHINGRODCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1586C900)

inline static constexpr unsigned int FishingRodController_TypeDefinitionIndex = 68087;
