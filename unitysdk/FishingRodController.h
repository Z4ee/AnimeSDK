...
#define FISHINGRODCONTROLLER_BLENDTO_OFFSET UNITYSDK_OFFSET(0x11F47AB0)
#define FISHINGRODCONTROLLER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x11F46610)
#define FISHINGRODCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x11F46BD0)
#define FISHINGRODCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x11F46B80)
#define FISHINGRODCONTROLLER_TRYINITIALIZE_OFFSET UNITYSDK_OFFSET(0x11F46760)
#define FISHINGRODCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11F47B20)

inline static constexpr unsigned int FishingRodController_TypeDefinitionIndex = 64553;
