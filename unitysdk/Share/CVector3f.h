...
#define SHARE_CVECTOR3F_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A945D30)
#define SHARE_CVECTOR3F_GET_X_OFFSET UNITYSDK_OFFSET(0x1A945A70)
#define SHARE_CVECTOR3F_GET_Y_OFFSET UNITYSDK_OFFSET(0x1A945A90)
#define SHARE_CVECTOR3F_GET_Z_OFFSET UNITYSDK_OFFSET(0x1A945AB0)
#define SHARE_CVECTOR3F_SET_X_OFFSET UNITYSDK_OFFSET(0x1A945A80)
#define SHARE_CVECTOR3F_SET_Y_OFFSET UNITYSDK_OFFSET(0x1A945AA0)
#define SHARE_CVECTOR3F_SET_Z_OFFSET UNITYSDK_OFFSET(0x1A945AC0)
#define SHARE_CVECTOR3F_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A945AD0)
#define SHARE_CVECTOR3F__CTOR_OFFSET UNITYSDK_OFFSET(0x1A945D40)

namespace Share
{
	inline static constexpr unsigned int CVector3f_TypeDefinitionIndex = 17647;
