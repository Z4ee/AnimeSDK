...
#define SHARE_CCHANGEDPROPERTYINFO_GET_CURVALUE_OFFSET UNITYSDK_OFFSET(0x18596570)
#define SHARE_CCHANGEDPROPERTYINFO_GET_PREVVALUE_OFFSET UNITYSDK_OFFSET(0x18596550)
#define SHARE_CCHANGEDPROPERTYINFO_SET_CURVALUE_OFFSET UNITYSDK_OFFSET(0x18596580)
#define SHARE_CCHANGEDPROPERTYINFO_SET_PREVVALUE_OFFSET UNITYSDK_OFFSET(0x18596560)
#define SHARE_CCHANGEDPROPERTYINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x185965A0)
#define SHARE_CCHANGEDPROPERTYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18596590)

namespace Share
{
	inline static constexpr unsigned int CChangedPropertyInfo_TypeDefinitionIndex = 12762;
