...
#define SHARE_CMAINCITYSECTIONCONFIG_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A142500)
#define SHARE_CMAINCITYSECTIONCONFIG_GET_BORNPOSNAME_OFFSET UNITYSDK_OFFSET(0x1A142310)
#define SHARE_CMAINCITYSECTIONCONFIG_GET_BORNTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A1422F0)
#define SHARE_CMAINCITYSECTIONCONFIG_GET_ID_OFFSET UNITYSDK_OFFSET(0x1A1422B0)
#define SHARE_CMAINCITYSECTIONCONFIG_GET_UNITYSCENEPATH_OFFSET UNITYSDK_OFFSET(0x1A1422D0)
#define SHARE_CMAINCITYSECTIONCONFIG_SET_BORNPOSNAME_OFFSET UNITYSDK_OFFSET(0x1A142320)
#define SHARE_CMAINCITYSECTIONCONFIG_SET_BORNTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A142300)
#define SHARE_CMAINCITYSECTIONCONFIG_SET_ID_OFFSET UNITYSDK_OFFSET(0x1A1422C0)
#define SHARE_CMAINCITYSECTIONCONFIG_SET_UNITYSCENEPATH_OFFSET UNITYSDK_OFFSET(0x1A1422E0)
#define SHARE_CMAINCITYSECTIONCONFIG_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A142330)
#define SHARE_CMAINCITYSECTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A142550)

namespace Share
{
	inline static constexpr unsigned int CMainCitySectionConfig_TypeDefinitionIndex = 17828;
