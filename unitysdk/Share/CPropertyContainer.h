...
#define SHARE_CPROPERTYCONTAINER_ADDPROPERTY_OFFSET UNITYSDK_OFFSET(0x1B21B0D0)
#define SHARE_CPROPERTYCONTAINER_ADDRAWPROPERTY_OFFSET UNITYSDK_OFFSET(0x1B21B040)
#define SHARE_CPROPERTYCONTAINER_ADD_ONAFTERPROPERTYSET_OFFSET UNITYSDK_OFFSET(0x1B21A8C0)
#define SHARE_CPROPERTYCONTAINER_ADD_ONBEFOREPROPERTYMODIFY_OFFSET UNITYSDK_OFFSET(0x1B21A7C0)
#define SHARE_CPROPERTYCONTAINER_ADD_ONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1B21A9C0)
#define SHARE_CPROPERTYCONTAINER_FIREALLEVENT_OFFSET UNITYSDK_OFFSET(0x1B21B300)
#define SHARE_CPROPERTYCONTAINER_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B21B260)
#define SHARE_CPROPERTYCONTAINER_GETPROPERTY_OFFSET UNITYSDK_OFFSET(0x1B21AEC0)
#define SHARE_CPROPERTYCONTAINER_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1B21AAC0)
#define SHARE_CPROPERTYCONTAINER_ISPROPERTYSETTED_OFFSET UNITYSDK_OFFSET(0x1B21AE60)
#define SHARE_CPROPERTYCONTAINER_REFRESHRELATEDPROPERTY_1_OFFSET UNITYSDK_OFFSET(0x1B21B1E0)
#define SHARE_CPROPERTYCONTAINER_REFRESHRELATEDPROPERTY_OFFSET UNITYSDK_OFFSET(0x1B21B160)
#define SHARE_CPROPERTYCONTAINER_REMOVE_ONAFTERPROPERTYSET_OFFSET UNITYSDK_OFFSET(0x1B21A940)
#define SHARE_CPROPERTYCONTAINER_REMOVE_ONBEFOREPROPERTYMODIFY_OFFSET UNITYSDK_OFFSET(0x1B21A840)
#define SHARE_CPROPERTYCONTAINER_REMOVE_ONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1B21AA40)
#define SHARE_CPROPERTYCONTAINER_SETPROPERTY_OFFSET UNITYSDK_OFFSET(0x1B21AFB0)
#define SHARE_CPROPERTYCONTAINER_SETRAWPROPERTY_OFFSET UNITYSDK_OFFSET(0x1B21AF20)
#define SHARE_CPROPERTYCONTAINER_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B21B2B0)
#define SHARE_CPROPERTYCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B21AAE0)
#define SHARE_CPROPERTYCONTAINER__ONAFTERPROPERTYSET_OFFSET UNITYSDK_OFFSET(0x1B21AE40)
#define SHARE_CPROPERTYCONTAINER__ONBEFOREPROPERTYMODIFY_OFFSET UNITYSDK_OFFSET(0x1B21AE30)
#define SHARE_CPROPERTYCONTAINER__ONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1B21AE50)

namespace Share
{
	inline static constexpr unsigned int CPropertyContainer_TypeDefinitionIndex = 17788;

	class CPropertyContainer : public ::System::Object
	{
	public:
		::Share::CPropertyContainer_COperatorHelper* m_oOperatorHelper; // 0x10
		::Share::CPropertyOperator_1<::Share::EPropertyType>* m_oPropertyOperator; // 0x18
		::Share::DOnBeforePropertyModify* OnBeforePropertyModify; // 0x20
		::Share::DOnAfterPropertySet* OnAfterPropertySet; // 0x28
