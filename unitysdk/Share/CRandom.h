...
#define SHARE_CRANDOM_GET_DEFAULT_OFFSET UNITYSDK_OFFSET(0x1BBC4340)
#define SHARE_CRANDOM_INTERNALSAMPLE_OFFSET UNITYSDK_OFFSET(0x1BBC4840)
#define SHARE_CRANDOM_NEXTBYTES_OFFSET UNITYSDK_OFFSET(0x1BBC4A60)
#define SHARE_CRANDOM_NEXTDOUBLE_OFFSET UNITYSDK_OFFSET(0x1BBC4A50)
#define SHARE_CRANDOM_NEXT_1_OFFSET UNITYSDK_OFFSET(0x1BBC4900)
#define SHARE_CRANDOM_NEXT_2_OFFSET UNITYSDK_OFFSET(0x1BBC49D0)
#define SHARE_CRANDOM_NEXT_OFFSET UNITYSDK_OFFSET(0x1BBC48F0)
#define SHARE_CRANDOM_SAMPLE_OFFSET UNITYSDK_OFFSET(0x1BBC4820)
#define SHARE_CRANDOM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BBC44F0)
#define SHARE_CRANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBC44A0)

namespace Share
{
	inline static constexpr unsigned int CRandom_TypeDefinitionIndex = 17205;
