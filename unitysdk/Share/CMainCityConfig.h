...
#define SHARE_CMAINCITYCONFIG_CLEAR_OFFSET UNITYSDK_OFFSET(0x17377DC0)
#define SHARE_CMAINCITYCONFIG_GET_DEFAULTSECTIONID_OFFSET UNITYSDK_OFFSET(0x17377B60)
#define SHARE_CMAINCITYCONFIG_GET_ID_OFFSET UNITYSDK_OFFSET(0x17377B40)
#define SHARE_CMAINCITYCONFIG_GET_SECTIONS_OFFSET UNITYSDK_OFFSET(0x17377B80)
#define SHARE_CMAINCITYCONFIG_SET_DEFAULTSECTIONID_OFFSET UNITYSDK_OFFSET(0x17377B70)
#define SHARE_CMAINCITYCONFIG_SET_ID_OFFSET UNITYSDK_OFFSET(0x17377B50)
#define SHARE_CMAINCITYCONFIG_SET_SECTIONS_OFFSET UNITYSDK_OFFSET(0x17377B90)
#define SHARE_CMAINCITYCONFIG_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17377BA0)
#define SHARE_CMAINCITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17377E40)

namespace Share
{
	inline static constexpr unsigned int CMainCityConfig_TypeDefinitionIndex = 17561;
	...
	public:
		...
		::System::Int32 m_DefaultSectionID; // 0x18
		::System::Int32 m_ID; // 0x1C
