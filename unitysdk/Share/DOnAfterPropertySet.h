...
#define SHARE_DONAFTERPROPERTYSET_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A1718C0)
#define SHARE_DONAFTERPROPERTYSET_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A171970)
#define SHARE_DONAFTERPROPERTYSET_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A171570)
#define SHARE_DONAFTERPROPERTYSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A171550)

namespace Share
{
	inline static constexpr unsigned int DOnAfterPropertySet_TypeDefinitionIndex = 12934;
