...
#define SHARE_DONBEFOREPROPERTYMODIFY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F8F50D0)
#define SHARE_DONBEFOREPROPERTYMODIFY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F8F5100)
#define SHARE_DONBEFOREPROPERTYMODIFY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F8F4BB0)
#define SHARE_DONBEFOREPROPERTYMODIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x1F8F4B90)

namespace Share
{
	inline static constexpr unsigned int DOnBeforePropertyModify_TypeDefinitionIndex = 15086;
