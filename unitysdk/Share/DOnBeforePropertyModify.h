...
#define SHARE_DONBEFOREPROPERTYMODIFY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18596FB0)
#define SHARE_DONBEFOREPROPERTYMODIFY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18596FE0)
#define SHARE_DONBEFOREPROPERTYMODIFY_INVOKE_OFFSET UNITYSDK_OFFSET(0x18596AB0)
#define SHARE_DONBEFOREPROPERTYMODIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x18596A90)

namespace Share
{
	inline static constexpr unsigned int DOnBeforePropertyModify_TypeDefinitionIndex = 11403;
