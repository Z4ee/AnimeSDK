...
#define SHARE_CPROPERTYCONTAINER_COPERATORHELPER_GETPROPERTYTEMPLATE_OFFSET UNITYSDK_OFFSET(0x18A7BC20)
#define SHARE_CPROPERTYCONTAINER_COPERATORHELPER_ISPERSISTENCEPORPERTY_OFFSET UNITYSDK_OFFSET(0x18A7BCA0)
#define SHARE_CPROPERTYCONTAINER_COPERATORHELPER_ONAFTERPROPERTYSET_OFFSET UNITYSDK_OFFSET(0x18A7C070)
#define SHARE_CPROPERTYCONTAINER_COPERATORHELPER_ONBEFOREPROPERTYSET_OFFSET UNITYSDK_OFFSET(0x18A7BD10)
#define SHARE_CPROPERTYCONTAINER_COPERATORHELPER_TEMPLATEIDTOPROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x18A7BD00)
#define SHARE_CPROPERTYCONTAINER_COPERATORHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x18A7BC10)
#define SHARE_CPROPERTYCONTAINER_COPERATORHELPER__FIXHP_OFFSET UNITYSDK_OFFSET(0x18A7BD30)

namespace Share
{
	inline static constexpr unsigned int CPropertyContainer_COperatorHelper_TypeDefinitionIndex = 14787;
