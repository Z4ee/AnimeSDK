...
#define SHARE_CPROPERTYCONTAINER_COPERATORHELPER_GETPROPERTYTEMPLATE_OFFSET UNITYSDK_OFFSET(0x1EA7F900)
#define SHARE_CPROPERTYCONTAINER_COPERATORHELPER_ISPERSISTENCEPORPERTY_OFFSET UNITYSDK_OFFSET(0x1EA7F980)
#define SHARE_CPROPERTYCONTAINER_COPERATORHELPER_ONAFTERPROPERTYSET_OFFSET UNITYSDK_OFFSET(0x1EA7FD50)
#define SHARE_CPROPERTYCONTAINER_COPERATORHELPER_ONBEFOREPROPERTYSET_OFFSET UNITYSDK_OFFSET(0x1EA7F9F0)
#define SHARE_CPROPERTYCONTAINER_COPERATORHELPER_TEMPLATEIDTOPROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x1EA7F9E0)
#define SHARE_CPROPERTYCONTAINER_COPERATORHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA7F8F0)
#define SHARE_CPROPERTYCONTAINER_COPERATORHELPER__FIXHP_OFFSET UNITYSDK_OFFSET(0x1EA7FA10)

namespace Share
{
	inline static constexpr unsigned int CPropertyContainer_COperatorHelper_TypeDefinitionIndex = 12334;
