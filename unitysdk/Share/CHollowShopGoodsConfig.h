...
#define SHARE_CHOLLOWSHOPGOODSCONFIG_CLEAR_OFFSET UNITYSDK_OFFSET(0x18846F70)
#define SHARE_CHOLLOWSHOPGOODSCONFIG_GET_BUYCOUNT_OFFSET UNITYSDK_OFFSET(0x18846C60)
#define SHARE_CHOLLOWSHOPGOODSCONFIG_GET_DISCOUNT_OFFSET UNITYSDK_OFFSET(0x18846CE0)
#define SHARE_CHOLLOWSHOPGOODSCONFIG_GET_GROUP_OFFSET UNITYSDK_OFFSET(0x18846CA0)
#define SHARE_CHOLLOWSHOPGOODSCONFIG_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0x18846C40)
#define SHARE_CHOLLOWSHOPGOODSCONFIG_GET_ITEMTYPE_OFFSET UNITYSDK_OFFSET(0x18846C00)
#define SHARE_CHOLLOWSHOPGOODSCONFIG_GET_PRICE_OFFSET UNITYSDK_OFFSET(0x18846C80)
#define SHARE_CHOLLOWSHOPGOODSCONFIG_GET_RARE_OFFSET UNITYSDK_OFFSET(0x18846C20)
#define SHARE_CHOLLOWSHOPGOODSCONFIG_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0x18846CC0)
#define SHARE_CHOLLOWSHOPGOODSCONFIG_SET_BUYCOUNT_OFFSET UNITYSDK_OFFSET(0x18846C70)
#define SHARE_CHOLLOWSHOPGOODSCONFIG_SET_DISCOUNT_OFFSET UNITYSDK_OFFSET(0x18846CF0)
#define SHARE_CHOLLOWSHOPGOODSCONFIG_SET_GROUP_OFFSET UNITYSDK_OFFSET(0x18846CB0)
#define SHARE_CHOLLOWSHOPGOODSCONFIG_SET_ITEMID_OFFSET UNITYSDK_OFFSET(0x18846C50)
#define SHARE_CHOLLOWSHOPGOODSCONFIG_SET_ITEMTYPE_OFFSET UNITYSDK_OFFSET(0x18846C10)
#define SHARE_CHOLLOWSHOPGOODSCONFIG_SET_PRICE_OFFSET UNITYSDK_OFFSET(0x18846C90)
#define SHARE_CHOLLOWSHOPGOODSCONFIG_SET_RARE_OFFSET UNITYSDK_OFFSET(0x18846C30)
#define SHARE_CHOLLOWSHOPGOODSCONFIG_SET_WEIGHT_OFFSET UNITYSDK_OFFSET(0x18846CD0)
#define SHARE_CHOLLOWSHOPGOODSCONFIG_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18846D00)
#define SHARE_CHOLLOWSHOPGOODSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18847030)

namespace Share
{
	inline static constexpr unsigned int CHollowShopGoodsConfig_TypeDefinitionIndex = 17845;

	class CHollowShopGoodsConfig : public ::System::Object
	{
	public:
		::System::String* m_BuyCount; // 0x10
		::System::String* m_Group; // 0x18
		::System::String* m_ItemID; // 0x20
		::System::String* m_Weight; // 0x28
		::System::Collections::Generic::List_1<::System::Int32>* m_Rare; // 0x30
		::System::String* m_Price; // 0x38
		::System::String* m_Discount; // 0x40
