...
#define CLASS_3_AA7C24AD819DC969_METHOD_3_8F7825DAFFB9B517_OFFSET UNITYSDK_OFFSET(0x166A31D0)
#define CLASS_3_AA7C24AD819DC969_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x166A30D0)
#define CLASS_3_AA7C24AD819DC969_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x166A35A0)
#define CLASS_3_AA7C24AD819DC969__CTOR_OFFSET UNITYSDK_OFFSET(0x166A30B0)

inline static constexpr unsigned int Class_3_AA7C24AD819DC969_TypeDefinitionIndex = 28770;
...
public:
	...
	::System::Void _ctor(::Class_1_8A3C2FE068793E61* a1, ::RPG::Client::LittleGameShare::ST_Main_CakeRaceUseRocketItemDecision* a2)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_8A3C2FE068793E61*, ::RPG::Client::LittleGameShare::ST_Main_CakeRaceUseRocketItemDecision*))((::PBYTE)hIl2Cpp + CLASS_3_AA7C24AD819DC969__CTOR_OFFSET))(this, a1, a2);
	}
