...
#define CLASS_1_7FF19F6206AF6DD7_9_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1D7E2A70)
#define CLASS_1_7FF19F6206AF6DD7_9_CLONE_OFFSET UNITYSDK_OFFSET(0x1D7E25C0)
#define CLASS_1_7FF19F6206AF6DD7_9_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1D7E2770)
#define CLASS_1_7FF19F6206AF6DD7_9_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D7E2620)
#define CLASS_1_7FF19F6206AF6DD7_9_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D7E2890)
#define CLASS_1_7FF19F6206AF6DD7_9_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1D7E2C40)
#define CLASS_1_7FF19F6206AF6DD7_9_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1D7E2BA0)
#define CLASS_1_7FF19F6206AF6DD7_9_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1D7E2600)
#define CLASS_1_7FF19F6206AF6DD7_9_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1D7E2470)
#define CLASS_1_7FF19F6206AF6DD7_9_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x1D7E25F0)
#define CLASS_1_7FF19F6206AF6DD7_9_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1D7E2610)
#define CLASS_1_7FF19F6206AF6DD7_9_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1D7E24A0)
#define CLASS_1_7FF19F6206AF6DD7_9_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D7E2900)
#define CLASS_1_7FF19F6206AF6DD7_9_WRITETO_OFFSET UNITYSDK_OFFSET(0x1D7E2960)
#define CLASS_1_7FF19F6206AF6DD7_9__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D7E2E10)
#define CLASS_1_7FF19F6206AF6DD7_9__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D7E2500)
#define CLASS_1_7FF19F6206AF6DD7_9__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7E24B0)

inline static constexpr unsigned int Class_1_7FF19F6206AF6DD7_9_TypeDefinitionIndex = 25652;

class Class_1_7FF19F6206AF6DD7_9 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_7FF19F6206AF6DD7_9*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_7FF19F6206AF6DD7_9*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7FF19F6206AF6DD7_9_TypeDefinitionIndex)->GetStaticField(0x3C3A0);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_C9E417278351157F_2*>** StaticGet_BONLPACGCEC()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_C9E417278351157F_2*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7FF19F6206AF6DD7_9_TypeDefinitionIndex)->GetStaticField(0x3C3A8);
	}
	// static const ::System::Int32 IKIBIAPHPEG = 0x9; // 0x0
	// static const ::System::Int32 PLDKENJLKME = 0xD; // 0x0
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x10
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_C9E417278351157F_2*>* FIIJLGNIBOP; // 0x18
