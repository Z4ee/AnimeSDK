...
#define CLASS_1_E657D03F0A0D98AD_GET_BOTTOM_OFFSET UNITYSDK_OFFSET(0x13548F40)
#define CLASS_1_E657D03F0A0D98AD_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x13548F10)
#define CLASS_1_E657D03F0A0D98AD_GET_LEFT_OFFSET UNITYSDK_OFFSET(0x13548F20)
#define CLASS_1_E657D03F0A0D98AD_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x13548F30)
#define CLASS_1_E657D03F0A0D98AD_GET_TOP_OFFSET UNITYSDK_OFFSET(0x13548F50)
#define CLASS_1_E657D03F0A0D98AD_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0x13548F00)
#define CLASS_1_E657D03F0A0D98AD__CTOR_OFFSET UNITYSDK_OFFSET(0x13548F60)

inline static constexpr unsigned int Class_1_E657D03F0A0D98AD_TypeDefinitionIndex = 60256;

class Class_1_E657D03F0A0D98AD : public ::System::Object
{
public:
	::System::Double _Top_k__BackingField; // 0x10
	::System::Double _Width_k__BackingField; // 0x18
	::System::Double _Bottom_k__BackingField; // 0x20
	::System::Double _Right_k__BackingField; // 0x28
