...
#define CLASS_1_E524FF101124C9B2_STRUCT_2_E076C6FF31662BFC_METHOD_2_012731B9818C2301_OFFSET UNITYSDK_OFFSET(0x716FD0)
#define CLASS_1_E524FF101124C9B2_STRUCT_2_E076C6FF31662BFC_METHOD_2_B40AC10910D7B05A_OFFSET UNITYSDK_OFFSET(0x716F40)
#define CLASS_1_E524FF101124C9B2_STRUCT_2_E076C6FF31662BFC_METHOD_2_D8DECFDA79E64038_OFFSET UNITYSDK_OFFSET(0x717110)
#define CLASS_1_E524FF101124C9B2_STRUCT_2_E076C6FF31662BFC__CCTOR_OFFSET UNITYSDK_OFFSET(0x11463ED0)
#define CLASS_1_E524FF101124C9B2_STRUCT_2_E076C6FF31662BFC__CTOR_OFFSET UNITYSDK_OFFSET(0x716EA0)

inline static constexpr unsigned int Class_1_E524FF101124C9B2_Struct_2_E076C6FF31662BFC_TypeDefinitionIndex = 40105;

struct alignas(4) Class_1_E524FF101124C9B2_Struct_2_E076C6FF31662BFC
{
	static ::UnityEngine::Color* StaticGet_Field_2_0()
	{
		return (::UnityEngine::Color*)Il2CppClass::FromTypeDefinitionIndex(Class_1_E524FF101124C9B2_Struct_2_E076C6FF31662BFC_TypeDefinitionIndex)->GetStaticField(0x10380);
	}
