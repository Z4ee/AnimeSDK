...
#define BATCHANIMATIONWRAPPER_APPLYCUSTOMCOLOR_OFFSET UNITYSDK_OFFSET(0x1C662FA0)
#define BATCHANIMATIONWRAPPER_CREATE_OFFSET UNITYSDK_OFFSET(0x1C6620C0)
#define BATCHANIMATIONWRAPPER_GETORCREATORBATCHANIMROOT_OFFSET UNITYSDK_OFFSET(0x1C661670)
#define BATCHANIMATIONWRAPPER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1C664110)
#define BATCHANIMATIONWRAPPER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C6620B0)
#define BATCHANIMATIONWRAPPER_PLAY_OFFSET UNITYSDK_OFFSET(0x1C662C30)
#define BATCHANIMATIONWRAPPER_RESETPART_1_OFFSET UNITYSDK_OFFSET(0x1C6641B0)
#define BATCHANIMATIONWRAPPER_RESETPART_OFFSET UNITYSDK_OFFSET(0x1C664140)
#define BATCHANIMATIONWRAPPER_RESET_OFFSET UNITYSDK_OFFSET(0x1C663AC0)
#define BATCHANIMATIONWRAPPER_SETUPRANDOMPART_OFFSET UNITYSDK_OFFSET(0x1C662A30)
#define BATCHANIMATIONWRAPPER_SETUPSHADOW_OFFSET UNITYSDK_OFFSET(0x1C662990)
#define BATCHANIMATIONWRAPPER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C664100)
#define BATCHANIMATIONWRAPPER__BUILDPOINTSEDGE_OFFSET UNITYSDK_OFFSET(0x1C661CC0)
#define BATCHANIMATIONWRAPPER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C664520)
#define BATCHANIMATIONWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6642C0)
#define BATCHANIMATIONWRAPPER__GETSTARTPOS_1_OFFSET UNITYSDK_OFFSET(0x1C661A70)
#define BATCHANIMATIONWRAPPER__GETSTARTPOS_OFFSET UNITYSDK_OFFSET(0x1C661820)
...
public:
	...
	{
		return (::Il2CppArray<::UnityEngine::Quaternion>**)Il2CppClass::FromTypeDefinitionIndex(BatchAnimationWrapper_TypeDefinitionIndex)->GetStaticField(0x2F290);
	}
	static ::Il2CppArray<::UnityEngine::Vector3>** StaticGet__posArray()
	{
		return (::Il2CppArray<::UnityEngine::Vector3>**)Il2CppClass::FromTypeDefinitionIndex(BatchAnimationWrapper_TypeDefinitionIndex)->GetStaticField(0x2F298);
	}
	static ::UnityEngine::Transform** StaticGet_s_BatchAnimationRootCache()
	{
		return (::UnityEngine::Transform**)Il2CppClass::FromTypeDefinitionIndex(BatchAnimationWrapper_TypeDefinitionIndex)->GetStaticField(0x2F2A0);
	}
