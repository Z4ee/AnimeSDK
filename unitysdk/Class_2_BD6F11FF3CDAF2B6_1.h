...
#define CLASS_2_BD6F11FF3CDAF2B6_1_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0xBC80A40)
#define CLASS_2_BD6F11FF3CDAF2B6_1_METHOD_2_AEFF7F3E842C9D98_OFFSET UNITYSDK_OFFSET(0xBC80E20)
#define CLASS_2_BD6F11FF3CDAF2B6_1_ONENTITYCREATED_OFFSET UNITYSDK_OFFSET(0xBC80BE0)
#define CLASS_2_BD6F11FF3CDAF2B6_1__CTOR_OFFSET UNITYSDK_OFFSET(0xBC808C0)

inline static constexpr unsigned int Class_2_BD6F11FF3CDAF2B6_1_TypeDefinitionIndex = 77246;

class Class_2_BD6F11FF3CDAF2B6_1 : public ::Entitas::VisualDebugging::Unity::ContextObserver
{
public:
	::Class_2_360C00D6092F4D31* EEFMDEHLLFI; // 0x38
	::System::Collections::Generic::Dictionary_2<::Entitas::IEntity*, ::Entitas::VisualDebugging::Unity::EntityBehaviour*>* HIHDEEBFGIL; // 0x40
