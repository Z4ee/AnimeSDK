...
#define CLASS_1_1FDE5CC33AEFB9D9_EXECUTE_OFFSET UNITYSDK_OFFSET(0x12AF2280)
#define CLASS_1_1FDE5CC33AEFB9D9__CTOR_OFFSET UNITYSDK_OFFSET(0x12AF2190)

inline static constexpr unsigned int Class_1_1FDE5CC33AEFB9D9_TypeDefinitionIndex = 70976;

class Class_1_1FDE5CC33AEFB9D9 : public ::System::Object
{
public:
	::Entitas::IGroup_1<::RPG::Client::LittleGame::ElfRestaurantGameEntity*>* Field_1_2; // 0x10
	::Class_2_43D1AA62A6D00FFF* Field_1_0; // 0x18
	::Class_3_F4528A5C0F861AF2* Field_1_1; // 0x20
