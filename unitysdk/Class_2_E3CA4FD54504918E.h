...
#define CLASS_2_E3CA4FD54504918E_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD7E3D30)
#define CLASS_2_E3CA4FD54504918E_GETCONFIG_OFFSET UNITYSDK_OFFSET(0xD7E3DD0)
#define CLASS_2_E3CA4FD54504918E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xD7E38B0)
#define CLASS_2_E3CA4FD54504918E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xD7E3D70)
#define CLASS_2_E3CA4FD54504918E_TICK_OFFSET UNITYSDK_OFFSET(0xD7E3B10)
#define CLASS_2_E3CA4FD54504918E__CTOR_OFFSET UNITYSDK_OFFSET(0xD7E38A0)
...
{
public:
	::Class_2_A59080F652920B7A* LPCDHEMDNEL; // 0x18
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x20
	::RPG::Client::RoadRashGameAbility_FireProjectileCast* OFKGLJOAMLD; // 0x28
	::Class_2_230F5EDDB35DAEBA* CFKHNPGEAJA; // 0x30
