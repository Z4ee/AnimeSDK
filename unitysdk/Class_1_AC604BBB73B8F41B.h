...
#define CLASS_1_AC604BBB73B8F41B_METHOD_1_11310AC9D361756D_OFFSET UNITYSDK_OFFSET(0x187247A0)
#define CLASS_1_AC604BBB73B8F41B_METHOD_1_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x18724750)
#define CLASS_1_AC604BBB73B8F41B_METHOD_1_5D45212808F4212D_OFFSET UNITYSDK_OFFSET(0x187249F0)
#define CLASS_1_AC604BBB73B8F41B_METHOD_1_97B231C192A52EEC_OFFSET UNITYSDK_OFFSET(0x18724B60)
#define CLASS_1_AC604BBB73B8F41B_METHOD_1_F730968E2645E14B_OFFSET UNITYSDK_OFFSET(0x18724650)
...
public:
	...
	{
		return (::RPG::GameCore::CharacterSkillStatisticConfig**)Il2CppClass::FromTypeDefinitionIndex(Class_1_AC604BBB73B8F41B_TypeDefinitionIndex)->GetStaticField(0x176B0);
	}
	static ::RPG::GameCore::CharacterSkillCustomStatisticConfig** StaticGet_PNAKCBAAJAC()
	{
		return (::RPG::GameCore::CharacterSkillCustomStatisticConfig**)Il2CppClass::FromTypeDefinitionIndex(Class_1_AC604BBB73B8F41B_TypeDefinitionIndex)->GetStaticField(0x176B8);
	}
