...
#define CLASS_1_F963C9FA5FC80637_DECONSTRUCT_OFFSET UNITYSDK_OFFSET(0x160426B0)
#define CLASS_1_F963C9FA5FC80637_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x16042420)
#define CLASS_1_F963C9FA5FC80637_EQUALS_OFFSET UNITYSDK_OFFSET(0x16042320)
#define CLASS_1_F963C9FA5FC80637_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x16042120)
#define CLASS_1_F963C9FA5FC80637_GET_EQUALITYCONTRACT_OFFSET UNITYSDK_OFFSET(0x160418E0)
#define CLASS_1_F963C9FA5FC80637_GET_STAGES_OFFSET UNITYSDK_OFFSET(0x16041910)
#define CLASS_1_F963C9FA5FC80637_METHOD_1_07396957EB9BA45F_OFFSET UNITYSDK_OFFSET(0x16041A80)
#define CLASS_1_F963C9FA5FC80637_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x16042080)
#define CLASS_1_F963C9FA5FC80637_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x16041FE0)
#define CLASS_1_F963C9FA5FC80637_PRINTMEMBERS_OFFSET UNITYSDK_OFFSET(0x16041ED0)
#define CLASS_1_F963C9FA5FC80637_SET_STAGES_OFFSET UNITYSDK_OFFSET(0x16041920)
#define CLASS_1_F963C9FA5FC80637_TOSTRING_OFFSET UNITYSDK_OFFSET(0x16041C90)
#define CLASS_1_F963C9FA5FC80637__CLONE___OFFSET UNITYSDK_OFFSET(0x16042630)
#define CLASS_1_F963C9FA5FC80637__CTOR_1_OFFSET UNITYSDK_OFFSET(0x16041930)
#define CLASS_1_F963C9FA5FC80637__CTOR_2_OFFSET UNITYSDK_OFFSET(0x16042690)
#define CLASS_1_F963C9FA5FC80637__CTOR_OFFSET UNITYSDK_OFFSET(0x160418D0)

inline static constexpr unsigned int Class_1_F963C9FA5FC80637_TypeDefinitionIndex = 76498;
