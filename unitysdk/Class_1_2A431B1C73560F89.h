...
#define CLASS_1_2A431B1C73560F89_ENTER_OFFSET UNITYSDK_OFFSET(0x18DB1B90)
#define CLASS_1_2A431B1C73560F89_EXIT_OFFSET UNITYSDK_OFFSET(0x18DB2060)
#define CLASS_1_2A431B1C73560F89_METHOD_1_0ECD6EA86C8A1D2A_OFFSET UNITYSDK_OFFSET(0x18DB21E0)
#define CLASS_1_2A431B1C73560F89_TICK_OFFSET UNITYSDK_OFFSET(0x18DB1E80)
#define CLASS_1_2A431B1C73560F89__CTOR_OFFSET UNITYSDK_OFFSET(0x18DB2280)

inline static constexpr unsigned int Class_1_2A431B1C73560F89_TypeDefinitionIndex = 64516;

class Class_1_2A431B1C73560F89 : public ::System::Object
{
public:
	::RPG::Client::GridFightDivisionListViewExtra* CFKHNPGEAJA; // 0x10
	::System::Int32 JCEMFJNEOND; // 0x18
