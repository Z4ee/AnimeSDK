...
#define MB2_TEXTUREBAKERESULTS_CONTAINSMATERIAL_OFFSET UNITYSDK_OFFSET(0x1E45A430)
#define MB2_TEXTUREBAKERESULTS_CREATEFORMATERIALSONRENDERER_OFFSET UNITYSDK_OFFSET(0x1E459860)
#define MB2_TEXTUREBAKERESULTS_DOANYRESULTMATSUSECONSIDERMESHUVS_OFFSET UNITYSDK_OFFSET(0x1E45A2F0)
#define MB2_TEXTUREBAKERESULTS_FINDRUNTIMEMATERIALSFROMADDRESSES_OFFSET UNITYSDK_OFFSET(0x1E459320)
#define MB2_TEXTUREBAKERESULTS_GETCOMBINEDMATERIALFORSUBMESH_OFFSET UNITYSDK_OFFSET(0x1E4592A0)
#define MB2_TEXTUREBAKERESULTS_GETCONSIDERMESHUVS_OFFSET UNITYSDK_OFFSET(0x1E459370)
#define MB2_TEXTUREBAKERESULTS_GETDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1E45A500)
#define MB2_TEXTUREBAKERESULTS_GETSOURCEMATERIALSUSEDBYRESULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1E4594F0)
#define MB2_TEXTUREBAKERESULTS_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1E4591A0)
#define MB2_TEXTUREBAKERESULTS_ISMESHANDMATERIALRECTENCLOSEDBYATLASRECT_OFFSET UNITYSDK_OFFSET(0x1E45AD60)
#define MB2_TEXTUREBAKERESULTS_NUMRESULTMATERIALS_OFFSET UNITYSDK_OFFSET(0x1E459270)
#define MB2_TEXTUREBAKERESULTS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1E459210)
#define MB2_TEXTUREBAKERESULTS_UPGRADETOCURRENTVERSION_OFFSET UNITYSDK_OFFSET(0x1E45AD00)
#define MB2_TEXTUREBAKERESULTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4591B0)

inline static constexpr unsigned int MB2_TextureBakeResults_TypeDefinitionIndex = 90529;
