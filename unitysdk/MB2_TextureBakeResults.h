...
#define MB2_TEXTUREBAKERESULTS_CONTAINSMATERIAL_OFFSET UNITYSDK_OFFSET(0x1C123170)
#define MB2_TEXTUREBAKERESULTS_CREATEFORMATERIALSONRENDERER_OFFSET UNITYSDK_OFFSET(0x1C1225A0)
#define MB2_TEXTUREBAKERESULTS_DOANYRESULTMATSUSECONSIDERMESHUVS_OFFSET UNITYSDK_OFFSET(0x1C123030)
#define MB2_TEXTUREBAKERESULTS_FINDRUNTIMEMATERIALSFROMADDRESSES_OFFSET UNITYSDK_OFFSET(0x1C122060)
#define MB2_TEXTUREBAKERESULTS_GETCOMBINEDMATERIALFORSUBMESH_OFFSET UNITYSDK_OFFSET(0x1C121FE0)
#define MB2_TEXTUREBAKERESULTS_GETCONSIDERMESHUVS_OFFSET UNITYSDK_OFFSET(0x1C1220B0)
#define MB2_TEXTUREBAKERESULTS_GETDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1C123240)
#define MB2_TEXTUREBAKERESULTS_GETSOURCEMATERIALSUSEDBYRESULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1C122230)
#define MB2_TEXTUREBAKERESULTS_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1C121EE0)
#define MB2_TEXTUREBAKERESULTS_ISMESHANDMATERIALRECTENCLOSEDBYATLASRECT_OFFSET UNITYSDK_OFFSET(0x1C123AA0)
#define MB2_TEXTUREBAKERESULTS_NUMRESULTMATERIALS_OFFSET UNITYSDK_OFFSET(0x1C121FB0)
#define MB2_TEXTUREBAKERESULTS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C121F50)
#define MB2_TEXTUREBAKERESULTS_UPGRADETOCURRENTVERSION_OFFSET UNITYSDK_OFFSET(0x1C123A40)
#define MB2_TEXTUREBAKERESULTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C121EF0)

inline static constexpr unsigned int MB2_TextureBakeResults_TypeDefinitionIndex = 84955;
