...
#define CLASS_3_505F89A6E16D8DA2_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1102EA40)
#define CLASS_3_505F89A6E16D8DA2_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1102EB20)
#define CLASS_3_505F89A6E16D8DA2_TICK_OFFSET UNITYSDK_OFFSET(0x1102EBF0)
#define CLASS_3_505F89A6E16D8DA2__CTOR_OFFSET UNITYSDK_OFFSET(0x1102EA10)
#define CLASS_3_505F89A6E16D8DA2___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x1102EC80)

inline static constexpr unsigned int Class_3_505F89A6E16D8DA2_TypeDefinitionIndex = 42246;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + CLASS_3_505F89A6E16D8DA2___IFIXBASEPROXY_TICK_OFFSET))(this, P0);
	}
};
