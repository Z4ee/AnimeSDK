...
#define CLASS_3_505F89A6E16D8DA2_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xAA5D4D0)
#define CLASS_3_505F89A6E16D8DA2_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xAA5D6B0)
#define CLASS_3_505F89A6E16D8DA2_TICK_OFFSET UNITYSDK_OFFSET(0xAA5D880)
#define CLASS_3_505F89A6E16D8DA2__CTOR_OFFSET UNITYSDK_OFFSET(0xAA5D4A0)
#define CLASS_3_505F89A6E16D8DA2___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xAA5D910)

inline static constexpr unsigned int Class_3_505F89A6E16D8DA2_TypeDefinitionIndex = 48830;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + CLASS_3_505F89A6E16D8DA2___IFIXBASEPROXY_TICK_OFFSET))(this, a1);
	}
};
