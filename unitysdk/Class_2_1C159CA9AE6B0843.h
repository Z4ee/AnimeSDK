...
#define CLASS_2_1C159CA9AE6B0843_DISPOSE_OFFSET UNITYSDK_OFFSET(0x154E7530)
#define CLASS_2_1C159CA9AE6B0843_METHOD_2_804AFBDABBD9560A_OFFSET UNITYSDK_OFFSET(0x154E78F0)
#define CLASS_2_1C159CA9AE6B0843_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x154E7570)
#define CLASS_2_1C159CA9AE6B0843_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x154E7A90)
#define CLASS_2_1C159CA9AE6B0843_TICK_OFFSET UNITYSDK_OFFSET(0x154E7AE0)
#define CLASS_2_1C159CA9AE6B0843__CTOR_OFFSET UNITYSDK_OFFSET(0x154E7520)
...
{
public:
	::Class_2_1C159CA9AE6B0843_Class_0_16E7307DCC43CB2C_15* FGGCJFFKCGM; // 0x18
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x20
	::RPG::GameCore::WaitUIAnim* OFKGLJOAMLD; // 0x28
