...
class Class_2_1C159CA9AE6B0843_Class_0_16E7307DCC43CB2C_12;
namespace RPG::GameCore { class TaskContext; }
namespace RPG::GameCore { class WaitUIAnim; }
namespace UnityEngine { class Transform; }

#define CLASS_2_1C159CA9AE6B0843_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11657150)
#define CLASS_2_1C159CA9AE6B0843_METHOD_2_804AFBDABBD9560A_OFFSET UNITYSDK_OFFSET(0x11657460)
#define CLASS_2_1C159CA9AE6B0843_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11657190)
#define CLASS_2_1C159CA9AE6B0843_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11657600)
#define CLASS_2_1C159CA9AE6B0843_TICK_OFFSET UNITYSDK_OFFSET(0x11657650)
#define CLASS_2_1C159CA9AE6B0843__CTOR_OFFSET UNITYSDK_OFFSET(0x11657140)

inline static constexpr unsigned int Class_2_1C159CA9AE6B0843_TypeDefinitionIndex = 47604;

class Class_2_1C159CA9AE6B0843 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_2_1C159CA9AE6B0843_Class_0_16E7307DCC43CB2C_12* Field_2_2; // 0x18
	::RPG::GameCore::TaskContext* Field_2_1; // 0x20
	::RPG::GameCore::WaitUIAnim* Field_2_0; // 0x28
