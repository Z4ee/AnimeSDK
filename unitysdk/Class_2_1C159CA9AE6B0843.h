...
#define CLASS_2_1C159CA9AE6B0843_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18A8D920)
#define CLASS_2_1C159CA9AE6B0843_METHOD_2_804AFBDABBD9560A_OFFSET UNITYSDK_OFFSET(0x18A8DCE0)
#define CLASS_2_1C159CA9AE6B0843_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18A8D960)
#define CLASS_2_1C159CA9AE6B0843_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x18A8DE70)
#define CLASS_2_1C159CA9AE6B0843_TICK_OFFSET UNITYSDK_OFFSET(0x18A8DEC0)
#define CLASS_2_1C159CA9AE6B0843__CTOR_OFFSET UNITYSDK_OFFSET(0x18A8D910)

inline static constexpr unsigned int Class_2_1C159CA9AE6B0843_TypeDefinitionIndex = 59084;

class Class_2_1C159CA9AE6B0843 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::GameCore::WaitUIAnim* OFKGLJOAMLD; // 0x20
	::Class_2_1C159CA9AE6B0843_Class_0_16E7307DCC43CB2C_15* FGGCJFFKCGM; // 0x28
	::System::Single MLENHINDJHH; // 0x30
