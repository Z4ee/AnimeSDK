...
#define CLASS_1_BF18D4907D184EDF__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4F2C20)
...
{
public:
	::System::Boolean DLCPEDKHMDA; // 0x10
	::RPG::Client::LittleGame::TimelineControlGameWorld_LevelCellSaver EABKOHGCHFP; // 0x14
