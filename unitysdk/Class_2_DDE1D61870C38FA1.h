...
#define CLASS_2_DDE1D61870C38FA1_GET_PROPERTYREPOSITORY_OFFSET UNITYSDK_OFFSET(0x138F2AE0)
#define CLASS_2_DDE1D61870C38FA1_METHOD_2_4352DFF1238F052B_OFFSET UNITYSDK_OFFSET(0x138F2DE0)
#define CLASS_2_DDE1D61870C38FA1_METHOD_2_C681656EABD8DE71_OFFSET UNITYSDK_OFFSET(0x138F2B00)
#define CLASS_2_DDE1D61870C38FA1_SET_PROPERTYREPOSITORY_OFFSET UNITYSDK_OFFSET(0x138F2AF0)
#define CLASS_2_DDE1D61870C38FA1__CTOR_OFFSET UNITYSDK_OFFSET(0x138F2E70)

inline static constexpr unsigned int Class_2_DDE1D61870C38FA1_TypeDefinitionIndex = 58665;

class Class_2_DDE1D61870C38FA1 : public ::RPG::AvatarSystem::Property::PropertyModifierBuilder_1<::RPG::GameCore::FixPoint>
{
public:
	::Class_0_16E4307DCC419505_701* _PropertyRepository_k__BackingField; // 0x20
	...
	::Class_0_16E4307DCC419505_701* get_PropertyRepository()
	{
		return ((::Class_0_16E4307DCC419505_701*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_DDE1D61870C38FA1_GET_PROPERTYREPOSITORY_OFFSET))(this);
	}

	::System::Void set_PropertyRepository(::Class_0_16E4307DCC419505_701* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_701*))((::PBYTE)hIl2Cpp + CLASS_2_DDE1D61870C38FA1_SET_PROPERTYREPOSITORY_OFFSET))(this, a1);
	}
