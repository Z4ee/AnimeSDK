...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGININITDATA_FILLPIVOTBOUNDSBYPIVOT_OFFSET UNITYSDK_OFFSET(0xF649390)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGININITDATA_PROCESSALIGNPARAM_OFFSET UNITYSDK_OFFSET(0xF649080)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGININITDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xF649070)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginInitData_TypeDefinitionIndex = 54038;
