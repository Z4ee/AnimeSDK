...
#define PRESKIRTIK_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1ABA86B0)
#define PRESKIRTIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABA8770)

inline static constexpr unsigned int PreSkirtIk_TypeDefinitionIndex = 47709;
