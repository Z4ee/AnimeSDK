...
#define CLASS_1_5B567C8A01BAEDFE_264_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C8ECD60)
#define CLASS_1_5B567C8A01BAEDFE_264_CLONE_OFFSET UNITYSDK_OFFSET(0x1C8ECA00)
#define CLASS_1_5B567C8A01BAEDFE_264_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C8ECB60)
#define CLASS_1_5B567C8A01BAEDFE_264_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C8ECA70)
#define CLASS_1_5B567C8A01BAEDFE_264_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C8ECCC0)
#define CLASS_1_5B567C8A01BAEDFE_264_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C8ECDB0)
#define CLASS_1_5B567C8A01BAEDFE_264_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C8ECD80)
#define CLASS_1_5B567C8A01BAEDFE_264_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C8EC950)
#define CLASS_1_5B567C8A01BAEDFE_264_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C8EC9B0)
#define CLASS_1_5B567C8A01BAEDFE_264_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C8ECCF0)
#define CLASS_1_5B567C8A01BAEDFE_264_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C8ECD50)
#define CLASS_1_5B567C8A01BAEDFE_264__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C8ECE00)
#define CLASS_1_5B567C8A01BAEDFE_264__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C8EC9D0)
#define CLASS_1_5B567C8A01BAEDFE_264__CTOR_OFFSET UNITYSDK_OFFSET(0x1C8EC9C0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_264_TypeDefinitionIndex = 30868;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_264*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_264_TypeDefinitionIndex)->GetStaticField(0x2F170);
	}
