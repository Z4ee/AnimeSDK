...
#define CLASS_1_5B567C8A01BAEDFE_264_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A32AB30)
#define CLASS_1_5B567C8A01BAEDFE_264_CLONE_OFFSET UNITYSDK_OFFSET(0x1A32A940)
#define CLASS_1_5B567C8A01BAEDFE_264_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A32AA40)
#define CLASS_1_5B567C8A01BAEDFE_264_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A32A9B0)
#define CLASS_1_5B567C8A01BAEDFE_264_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A32AA90)
#define CLASS_1_5B567C8A01BAEDFE_264_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A32AB80)
#define CLASS_1_5B567C8A01BAEDFE_264_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A32AB50)
#define CLASS_1_5B567C8A01BAEDFE_264_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A32A890)
#define CLASS_1_5B567C8A01BAEDFE_264_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A32A8F0)
#define CLASS_1_5B567C8A01BAEDFE_264_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A32AAC0)
#define CLASS_1_5B567C8A01BAEDFE_264_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A32AB20)
#define CLASS_1_5B567C8A01BAEDFE_264__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A32ABD0)
#define CLASS_1_5B567C8A01BAEDFE_264__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A32A910)
#define CLASS_1_5B567C8A01BAEDFE_264__CTOR_OFFSET UNITYSDK_OFFSET(0x1A32A900)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_264_TypeDefinitionIndex = 30371;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_264*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_264_TypeDefinitionIndex)->GetStaticField(0x55980);
	}
