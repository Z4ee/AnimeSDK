...
#define CLASS_1_715B7D8A35586A9E_GETFIGHTSTATECONFIG_OFFSET UNITYSDK_OFFSET(0x18B9E520)
#define CLASS_1_715B7D8A35586A9E_INIT_OFFSET UNITYSDK_OFFSET(0x18B9CB50)
#define CLASS_1_715B7D8A35586A9E_METHOD_1_0869E1192F8E01DF_OFFSET UNITYSDK_OFFSET(0x18B9D950)
#define CLASS_1_715B7D8A35586A9E_REFRESH_OFFSET UNITYSDK_OFFSET(0x18B9CC90)
#define CLASS_1_715B7D8A35586A9E_RESET_OFFSET UNITYSDK_OFFSET(0x18B9CBF0)
#define CLASS_1_715B7D8A35586A9E__CTOR_OFFSET UNITYSDK_OFFSET(0x18B9E560)
...
{
public:
	::RPG::Client::CameraFightStateUseSkillPerformConfig* MAFIONBKPIE; // 0x10
