...
#define CLASS_2_A1D637ADF2DB0791_GET_FLAG_OFFSET UNITYSDK_OFFSET(0x128AEF00)
#define CLASS_2_A1D637ADF2DB0791_METHOD_2_A72673A79DCC4200_OFFSET UNITYSDK_OFFSET(0x128AEDE0)
#define CLASS_2_A1D637ADF2DB0791_METHOD_2_CE4CE294A670DA1B_OFFSET UNITYSDK_OFFSET(0x128AEF10)
#define CLASS_2_A1D637ADF2DB0791__CTOR_OFFSET UNITYSDK_OFFSET(0x128AEDD0)

inline static constexpr unsigned int Class_2_A1D637ADF2DB0791_TypeDefinitionIndex = 52557;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Boolean, ::System::Boolean, ::RPG::GameCore::AdventureFeatureNormalActiveReason))((::PBYTE)hIl2Cpp + CLASS_2_A1D637ADF2DB0791_METHOD_2_CE4CE294A670DA1B_OFFSET))(this, P0, P1, P2);
	}
};
