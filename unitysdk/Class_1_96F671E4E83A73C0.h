...
#define CLASS_1_96F671E4E83A73C0_GET_CONCRETE_OFFSET UNITYSDK_OFFSET(0x1E75FF30)
#define CLASS_1_96F671E4E83A73C0_GET_CONTRACTS_OFFSET UNITYSDK_OFFSET(0x1E75FF20)
#define CLASS_1_96F671E4E83A73C0__CTOR_OFFSET UNITYSDK_OFFSET(0x1E75FF40)
...
{
public:
	::Class_1_7B4E9156998275BE* NKCLBBFDEEI; // 0x10
	::Class_1_F3CAAE7E7C7111CC* _Concrete_k__BackingField; // 0x18
	::System::Object* AFCLHADDBKA; // 0x20
	::System::Collections::Generic::HashSet_1<::Struct_2_B9E6DC87D4879FCD>* _Contracts_k__BackingField; // 0x28
	::Struct_2_B9E6DC87D4879FCD FNLHLLELBPA; // 0x30
	::Class_0_16E4307DCC419505_342* BEOPHFOAECG; // 0x48
