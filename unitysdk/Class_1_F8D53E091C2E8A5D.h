...
#define CLASS_1_F8D53E091C2E8A5D__CTOR_OFFSET UNITYSDK_OFFSET(0x1C537C80)
...
{
public:
	::System::Collections::Generic::List_1<::Class_1_0A9DA900CAB43E70*>* PJIAPLDJHDL; // 0x10
	::System::String* NKNKNFNGHJC; // 0x18
	::RPG::GameCore::FourRotateVoxelLevelEnvConfig* EOLEFDMJNNE; // 0x20
	::System::Int32 DKMLGHNPODM; // 0x28
	::System::Int32 OCPMLIBCHPD; // 0x2C
	::System::Boolean PJGOCPDOAOL; // 0x30
	::System::Boolean OJPDDAOJJKC; // 0x31
