...
#define CLASS_1_60475C2D4D583319_METHOD_1_2313407289FC2813_OFFSET UNITYSDK_OFFSET(0x15224430)
#define CLASS_1_60475C2D4D583319_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x152234C0)
#define CLASS_1_60475C2D4D583319_METHOD_1_3978A63BC8CCDBF6_OFFSET UNITYSDK_OFFSET(0x152235E0)
#define CLASS_1_60475C2D4D583319_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x15223450)
#define CLASS_1_60475C2D4D583319_METHOD_1_57D80B372834C5D1_OFFSET UNITYSDK_OFFSET(0x15223300)
#define CLASS_1_60475C2D4D583319_METHOD_1_C75FBCF88EADEF52_OFFSET UNITYSDK_OFFSET(0x15223780)
#define CLASS_1_60475C2D4D583319_METHOD_1_DB724851FEB3D97C_OFFSET UNITYSDK_OFFSET(0x15223370)
#define CLASS_1_60475C2D4D583319_METHOD_1_DDF954C8FE9E6001_OFFSET UNITYSDK_OFFSET(0x15223880)
#define CLASS_1_60475C2D4D583319_METHOD_1_EDCA216BAAE60E47_OFFSET UNITYSDK_OFFSET(0x15223510)
#define CLASS_1_60475C2D4D583319__CCTOR_OFFSET UNITYSDK_OFFSET(0x15224730)
#define CLASS_1_60475C2D4D583319__CTOR_OFFSET UNITYSDK_OFFSET(0x15223260)
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_60475C2D4D583319_TypeDefinitionIndex)->GetStaticField(0x13A30);
	}
	::Class_2_199C92B758EE3BC4* BLGPNMHAHPB; // 0x10
	::RPG::GameCore::TransformComponent* DPPIHOCPIFH; // 0x18
	::Il2CppArray<::System::Int32>* BHNGELGFGHI; // 0x20
	...
	::System::Single GKBKMPGIAFK; // 0x48
	::System::Int32 LCJDAMMJLEI; // 0x4C
	::System::Single INNBNACKGGH; // 0x50
	::System::Single MJPENADFCNM; // 0x54
	::System::Single LHABGBJIPMK; // 0x58
	::RPG::GameCore::AdvancedFollowType FKOGIANLJPP; // 0x5C
	::RPG::GameCore::FollowSideType POBLMPLBDKC; // 0x60
	::RPG::GameCore::FollowSideType FJDPAKGGEBK; // 0x64
