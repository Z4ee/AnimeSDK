...
#define CLASS_3_537CF2643FE966A2_METHOD_3_2D640F07944A24EB_OFFSET UNITYSDK_OFFSET(0x1CF98920)
#define CLASS_3_537CF2643FE966A2_METHOD_3_57A1D28F65E6799B_OFFSET UNITYSDK_OFFSET(0x1CF989C0)
#define CLASS_3_537CF2643FE966A2__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF98980)
...
{
public:
	::Il2CppArray<::RPG::GameCore::TaskConfig*>* KAJEPIBEDOG; // 0x18
	::RPG::GameCore::AdventureHitConfig* MBOFOKEJDDE; // 0x20
	::RPG::GameCore::TargetEvaluator* EDOLEIBGOGD; // 0x28
	::System::String* GMOLMMHPPDC; // 0x30
	::RPG::GameCore::AdventureDyingParam* GHNAMCDMMMO; // 0x38
	::Il2CppArray<::RPG::GameCore::TaskConfig*>* GKOIKCBJICD; // 0x40
