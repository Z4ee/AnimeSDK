...
#define CLASS_3_ECB23EE6F0DD3A2A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1ABB4E30)
#define CLASS_3_ECB23EE6F0DD3A2A_FLUSH_OFFSET UNITYSDK_OFFSET(0x1ABB3F10)
#define CLASS_3_ECB23EE6F0DD3A2A_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1ABB3BD0)
#define CLASS_3_ECB23EE6F0DD3A2A_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1ABB3BE0)
#define CLASS_3_ECB23EE6F0DD3A2A_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1ABB3BF0)
#define CLASS_3_ECB23EE6F0DD3A2A_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1ABB3C00)
#define CLASS_3_ECB23EE6F0DD3A2A_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1ABB3E40)
#define CLASS_3_ECB23EE6F0DD3A2A_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1ABB3DA0)
#define CLASS_3_ECB23EE6F0DD3A2A_METHOD_3_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1ABB4FF0)
#define CLASS_3_ECB23EE6F0DD3A2A_READ_OFFSET UNITYSDK_OFFSET(0x1ABB3F60)
#define CLASS_3_ECB23EE6F0DD3A2A_SEEK_OFFSET UNITYSDK_OFFSET(0x1ABB48D0)
#define CLASS_3_ECB23EE6F0DD3A2A_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1ABB4B70)
#define CLASS_3_ECB23EE6F0DD3A2A_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1ABB3E60)
#define CLASS_3_ECB23EE6F0DD3A2A_WRITE_OFFSET UNITYSDK_OFFSET(0x1ABB4C00)
#define CLASS_3_ECB23EE6F0DD3A2A__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABB3B30)

inline static constexpr unsigned int Class_3_ECB23EE6F0DD3A2A_TypeDefinitionIndex = 32321;
