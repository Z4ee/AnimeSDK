...
#define CLASS_2_645C561C607DB2B0_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA6D35A0)
#define CLASS_2_645C561C607DB2B0_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0xA6D3890)
#define CLASS_2_645C561C607DB2B0_ONSKIP_OFFSET UNITYSDK_OFFSET(0xA6D3640)
#define CLASS_2_645C561C607DB2B0_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xA6D3690)
#define CLASS_2_645C561C607DB2B0_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xA6D35F0)
#define CLASS_2_645C561C607DB2B0_TICK_OFFSET UNITYSDK_OFFSET(0xA6D3810)
#define CLASS_2_645C561C607DB2B0__CTOR_OFFSET UNITYSDK_OFFSET(0xA6D3580)

inline static constexpr unsigned int Class_2_645C561C607DB2B0_TypeDefinitionIndex = 54980;

class Class_2_645C561C607DB2B0 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::WaitAbilityStartTimeStamp* Field_2_1; // 0x20
	::Class_1_A2D8E5AB4B623162* Field_2_2; // 0x28
