...
#define CLASS_2_645C561C607DB2B0_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB9C06D0)
#define CLASS_2_645C561C607DB2B0_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0xB9C0A50)
#define CLASS_2_645C561C607DB2B0_ONSKIP_OFFSET UNITYSDK_OFFSET(0xB9C0770)
#define CLASS_2_645C561C607DB2B0_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB9C07C0)
#define CLASS_2_645C561C607DB2B0_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB9C0720)
#define CLASS_2_645C561C607DB2B0_TICK_OFFSET UNITYSDK_OFFSET(0xB9C09D0)
#define CLASS_2_645C561C607DB2B0__CTOR_OFFSET UNITYSDK_OFFSET(0xB9C06B0)
...
{
public:
	::RPG::GameCore::WaitAbilityStartTimeStamp* OFKGLJOAMLD; // 0x18
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x20
	::Class_1_A2D8E5AB4B623162* AGPOABLMPIC; // 0x28
