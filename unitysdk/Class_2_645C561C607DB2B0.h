...
#define CLASS_2_645C561C607DB2B0_DISPOSE_OFFSET UNITYSDK_OFFSET(0x96DBBE0)
#define CLASS_2_645C561C607DB2B0_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x96DBEF0)
#define CLASS_2_645C561C607DB2B0_ONSKIP_OFFSET UNITYSDK_OFFSET(0x96DBC80)
#define CLASS_2_645C561C607DB2B0_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x96DBCD0)
#define CLASS_2_645C561C607DB2B0_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x96DBC30)
#define CLASS_2_645C561C607DB2B0_TICK_OFFSET UNITYSDK_OFFSET(0x96DBE70)
#define CLASS_2_645C561C607DB2B0__CTOR_OFFSET UNITYSDK_OFFSET(0x96DBBC0)

inline static constexpr unsigned int Class_2_645C561C607DB2B0_TypeDefinitionIndex = 54254;
