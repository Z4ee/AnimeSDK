...
#define CLASS_2_645C561C607DB2B0_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17A9C890)
#define CLASS_2_645C561C607DB2B0_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x17A9CC10)
#define CLASS_2_645C561C607DB2B0_ONSKIP_OFFSET UNITYSDK_OFFSET(0x17A9C930)
#define CLASS_2_645C561C607DB2B0_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17A9C980)
#define CLASS_2_645C561C607DB2B0_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17A9C8E0)
#define CLASS_2_645C561C607DB2B0_TICK_OFFSET UNITYSDK_OFFSET(0x17A9CB90)
#define CLASS_2_645C561C607DB2B0__CTOR_OFFSET UNITYSDK_OFFSET(0x17A9C870)

inline static constexpr unsigned int Class_2_645C561C607DB2B0_TypeDefinitionIndex = 58995;

class Class_2_645C561C607DB2B0 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_1_A2D8E5AB4B623162* AGPOABLMPIC; // 0x18
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x20
	::RPG::GameCore::WaitAbilityStartTimeStamp* OFKGLJOAMLD; // 0x28
