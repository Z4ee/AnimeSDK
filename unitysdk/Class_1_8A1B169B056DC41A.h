...
#define CLASS_1_8A1B169B056DC41A_METHOD_1_00A4B38C951C5BD5_OFFSET UNITYSDK_OFFSET(0x1564DA50)
#define CLASS_1_8A1B169B056DC41A_METHOD_1_2943CB55423DBA35_OFFSET UNITYSDK_OFFSET(0x1564D910)
#define CLASS_1_8A1B169B056DC41A_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x1564DAE0)
#define CLASS_1_8A1B169B056DC41A_METHOD_1_6279B2A89754B8E7_OFFSET UNITYSDK_OFFSET(0x1564D7E0)
#define CLASS_1_8A1B169B056DC41A__CTOR_OFFSET UNITYSDK_OFFSET(0x1564DB80)

inline static constexpr unsigned int Class_1_8A1B169B056DC41A_TypeDefinitionIndex = 73632;

class Class_1_8A1B169B056DC41A : public ::System::Object
{
public:
	::UnityEngine::Texture2D* PKKLHJOCJAB; // 0x10
	::UnityEngine::Material* DFJEIPBBFMN; // 0x18
	::UnityEngine::Mesh* APBJFDCLGOC; // 0x20
	::UnityEngine::Material* EJGNBFKFHGG; // 0x28
	::RPG::Client::CrowdAnimator::CrowdPrototype* JHAHABGNPEM; // 0x30
	::System::Collections::Generic::List_1<::Class_1_E70BA5F62D4D16DE*>* OGBJANBPJJN; // 0x38
	::System::Int32 ILKENAAKKLH; // 0x40
	::System::Int32 GAGJLNOBMFK; // 0x44
	::System::Int32 BJIOBCHFCAA; // 0x48
