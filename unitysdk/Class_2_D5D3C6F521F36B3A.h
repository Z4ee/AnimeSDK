...
#define CLASS_2_D5D3C6F521F36B3A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x176D7760)
#define CLASS_2_D5D3C6F521F36B3A_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x176D78C0)
#define CLASS_2_D5D3C6F521F36B3A_METHOD_2_2B66C008535F8B01_OFFSET UNITYSDK_OFFSET(0x176D7920)
#define CLASS_2_D5D3C6F521F36B3A_METHOD_2_6B76E9F6796B173D_OFFSET UNITYSDK_OFFSET(0x176D7B90)
#define CLASS_2_D5D3C6F521F36B3A_METHOD_2_82E70A1D8784F4AB_1_OFFSET UNITYSDK_OFFSET(0x176D8160)
#define CLASS_2_D5D3C6F521F36B3A_METHOD_2_82E70A1D8784F4AB_OFFSET UNITYSDK_OFFSET(0x176D7CE0)
#define CLASS_2_D5D3C6F521F36B3A_METHOD_2_D8AF815800B66104_OFFSET UNITYSDK_OFFSET(0x176D77B0)
#define CLASS_2_D5D3C6F521F36B3A__CTOR_OFFSET UNITYSDK_OFFSET(0x176D7750)

inline static constexpr unsigned int Class_2_D5D3C6F521F36B3A_TypeDefinitionIndex = 54528;

class Class_2_D5D3C6F521F36B3A : public ::RPG::GameCore::GameComponentBase
{
public:
	::RPG::Client::ReasonBool_1<::RPG::GameCore::GroupForceVisibleReason> Field_2_0; // 0x18
	::RPG::Client::ReasonBool_1<::RPG::GameCore::GroupInvisibleReason> Field_2_1; // 0x20
