...
#define CLASS_3_9D50CD865666B27C_METHOD_3_61929A3103595552_OFFSET UNITYSDK_OFFSET(0x10B75A40)
#define CLASS_3_9D50CD865666B27C_METHOD_3_D0B0E8495E8A13B8_OFFSET UNITYSDK_OFFSET(0x10B75520)
#define CLASS_3_9D50CD865666B27C_ONCLEAR_OFFSET UNITYSDK_OFFSET(0x10B755B0)
#define CLASS_3_9D50CD865666B27C_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x10B75640)
#define CLASS_3_9D50CD865666B27C__CTOR_OFFSET UNITYSDK_OFFSET(0x10B75A90)
#define CLASS_3_9D50CD865666B27C___IFIXBASEPROXY_ONCLEAR_OFFSET UNITYSDK_OFFSET(0x10B75AA0)
#define CLASS_3_9D50CD865666B27C___IFIXBASEPROXY_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x10B75B00)

inline static constexpr unsigned int Class_3_9D50CD865666B27C_TypeDefinitionIndex = 53484;
...
public:
	...
	::Class_1_F2DCEB7D2C399774* Field_3_4; // 0x28
	::System::UInt32 Field_3_2; // 0x30
	::UnityEngine::Vector2 Field_3_0; // 0x34
	::RPG::Client::LittleGame::Match3::OpponentRole Field_3_5; // 0x3C
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_3_9D50CD865666B27C_METHOD_3_61929A3103595552_OFFSET))(this);
	}
