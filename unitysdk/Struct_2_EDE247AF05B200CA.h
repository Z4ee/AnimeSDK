...
#define STRUCT_2_EDE247AF05B200CA_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x77490)
#define STRUCT_2_EDE247AF05B200CA_EQUALS_OFFSET UNITYSDK_OFFSET(0x77410)
#define STRUCT_2_EDE247AF05B200CA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x774A0)
#define STRUCT_2_EDE247AF05B200CA_GET_PROMOTIONLEVEL_OFFSET UNITYSDK_OFFSET(0xD240)
#define STRUCT_2_EDE247AF05B200CA_GET_PROTOTYPEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x5580)
#define STRUCT_2_EDE247AF05B200CA__CTOR_OFFSET UNITYSDK_OFFSET(0x77400)
#define STRUCT_2_EDE247AF05B200CA___IFIXBASEPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0x77510)
#define STRUCT_2_EDE247AF05B200CA___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x77580)

inline static constexpr unsigned int Struct_2_EDE247AF05B200CA_TypeDefinitionIndex = 47957;
