...
#define CLASS_1_AB42C47522884ECB_METHOD_1_3485A366AE089637_OFFSET UNITYSDK_OFFSET(0x162200E0)
#define CLASS_1_AB42C47522884ECB_METHOD_1_5A120AEEEEE07BAA_OFFSET UNITYSDK_OFFSET(0x1621FFF0)
#define CLASS_1_AB42C47522884ECB__CTOR_OFFSET UNITYSDK_OFFSET(0x1621FEC0)

inline static constexpr unsigned int Class_1_AB42C47522884ECB_TypeDefinitionIndex = 79658;

class Class_1_AB42C47522884ECB : public ::System::Object
{
public:
	::Class_0_16E4307DCC419505_1370* JNBGEJAAMEG; // 0x10
	::Class_1_97F9E33E53026E4C* GCNNDHCLBPI; // 0x18
	::Class_1_E79EE3670D2EC49A* DBHBDBIFCNF; // 0x20
	::Class_0_16E4307DCC419505_1343* PODJBLOPDAK; // 0x28
	::Class_1_96586C089CD5CA69* CGFKNIOKJAH; // 0x30

	::System::Void _ctor(::Class_1_97F9E33E53026E4C* a1, ::Class_1_96586C089CD5CA69* a2, ::Class_0_16E4307DCC419505_1343* a3, ::Class_0_16E4307DCC419505_1370* a4, ::Class_1_E79EE3670D2EC49A* a5)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_97F9E33E53026E4C*, ::Class_1_96586C089CD5CA69*, ::Class_0_16E4307DCC419505_1343*, ::Class_0_16E4307DCC419505_1370*, ::Class_1_E79EE3670D2EC49A*))((::PBYTE)hIl2Cpp + CLASS_1_AB42C47522884ECB__CTOR_OFFSET))(this, a1, a2, a3, a4, a5);
	}
