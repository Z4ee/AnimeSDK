...
#define CLASS_1_EED1D87C81F7C2A6_METHOD_1_03B1BF2F2F8589FD_OFFSET UNITYSDK_OFFSET(0x16257EB0)
#define CLASS_1_EED1D87C81F7C2A6_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x16258A40)
#define CLASS_1_EED1D87C81F7C2A6_METHOD_1_283DA224BE06DA9F_OFFSET UNITYSDK_OFFSET(0x16257EF0)
#define CLASS_1_EED1D87C81F7C2A6_METHOD_1_45AA2F5085C2C40D_OFFSET UNITYSDK_OFFSET(0x16258280)
#define CLASS_1_EED1D87C81F7C2A6_METHOD_1_940B3F0997F915B8_OFFSET UNITYSDK_OFFSET(0x16258820)
#define CLASS_1_EED1D87C81F7C2A6_METHOD_1_A0B822F08B34B978_OFFSET UNITYSDK_OFFSET(0x162584F0)
#define CLASS_1_EED1D87C81F7C2A6_METHOD_1_B961D33AD47A2113_OFFSET UNITYSDK_OFFSET(0x162580D0)
#define CLASS_1_EED1D87C81F7C2A6_METHOD_1_C225C501A02569DB_OFFSET UNITYSDK_OFFSET(0x16258910)
#define CLASS_1_EED1D87C81F7C2A6_METHOD_1_CF3AF79A95F797F5_OFFSET UNITYSDK_OFFSET(0x162589A0)
#define CLASS_1_EED1D87C81F7C2A6__CTOR_OFFSET UNITYSDK_OFFSET(0x16257D40)

inline static constexpr unsigned int Class_1_EED1D87C81F7C2A6_TypeDefinitionIndex = 66124;

class Class_1_EED1D87C81F7C2A6 : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::Class_1_E8293664BB5E691F*>* Field_1_0; // 0x10
	::RPG::GameCore::MunicipalChatNodeInfo* Field_1_1; // 0x18
	::Class_1_CF8B0DC37DFDE560* Field_1_2; // 0x20
