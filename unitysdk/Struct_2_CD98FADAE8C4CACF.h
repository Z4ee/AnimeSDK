...
#define STRUCT_2_CD98FADAE8C4CACF_METHOD_2_0BC937355C326A37_OFFSET UNITYSDK_OFFSET(0xF242860)
#define STRUCT_2_CD98FADAE8C4CACF_METHOD_2_4D9E49E481430D6F_OFFSET UNITYSDK_OFFSET(0x635490)
#define STRUCT_2_CD98FADAE8C4CACF_METHOD_2_5715BE153D24F100_OFFSET UNITYSDK_OFFSET(0xF242670)
#define STRUCT_2_CD98FADAE8C4CACF_METHOD_2_6215A8999654A40E_OFFSET UNITYSDK_OFFSET(0xF242810)
#define STRUCT_2_CD98FADAE8C4CACF_METHOD_2_959545BFD49B48E1_OFFSET UNITYSDK_OFFSET(0xF242A00)
#define STRUCT_2_CD98FADAE8C4CACF_METHOD_2_B28EA912AECCA006_OFFSET UNITYSDK_OFFSET(0xF242690)

inline static constexpr unsigned int Struct_2_CD98FADAE8C4CACF_TypeDefinitionIndex = 59527;
...
struct alignas(8) Struct_2_CD98FADAE8C4CACF
{
	...
	::Il2CppArray<::UnityEngine::Vector3>* Field_2_6; // 0x28
	...
	::UnityEngine::AnimationCurve* Field_2_15; // 0x48
	...
	/*
	::PipelineCamera::WorldBasicCameraData Method_2_4D9E49E481430D6F()
	{
		return ((::PipelineCamera::WorldBasicCameraData(*)(::PVOID))((::PBYTE)hIl2Cpp + STRUCT_2_CD98FADAE8C4CACF_METHOD_2_4D9E49E481430D6F_OFFSET))(this);
	}
	*/
};
