...
#define CLASS_2_D681BCB4E8FE6FE3_METHOD_2_3228575429DB2F42_OFFSET UNITYSDK_OFFSET(0x158C17A0)
#define CLASS_2_D681BCB4E8FE6FE3_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x158C15C0)
#define CLASS_2_D681BCB4E8FE6FE3_METHOD_2_926A6229E864AA95_OFFSET UNITYSDK_OFFSET(0x158C1DC0)
#define CLASS_2_D681BCB4E8FE6FE3_METHOD_2_C3C468D4782C8090_OFFSET UNITYSDK_OFFSET(0x158C1620)
#define CLASS_2_D681BCB4E8FE6FE3__CTOR_OFFSET UNITYSDK_OFFSET(0x158C1500)

inline static constexpr unsigned int Class_2_D681BCB4E8FE6FE3_TypeDefinitionIndex = 76017;

class Class_2_D681BCB4E8FE6FE3 : public ::Class_1_FD893FD36F6A3A6D_2
{
public:
	::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_241*>* DGGAOHODICM; // 0x18
