...
#define STRUCT_2_0B6C9ACBECEC8DD3_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x795F60)
#define STRUCT_2_0B6C9ACBECEC8DD3_EQUALS_OFFSET UNITYSDK_OFFSET(0x795E40)
#define STRUCT_2_0B6C9ACBECEC8DD3_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x795F70)
#define STRUCT_2_0B6C9ACBECEC8DD3_METHOD_2_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x796060)
#define STRUCT_2_0B6C9ACBECEC8DD3_METHOD_2_51BF9A77B19EC5F3_OFFSET UNITYSDK_OFFSET(0x795D50)
#define STRUCT_2_0B6C9ACBECEC8DD3_METHOD_2_6D0360BD23602584_OFFSET UNITYSDK_OFFSET(0x795FE0)
#define STRUCT_2_0B6C9ACBECEC8DD3_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x796110)
#define STRUCT_2_0B6C9ACBECEC8DD3_METHOD_2_E6D206501EFDAD27_OFFSET UNITYSDK_OFFSET(0x796100)
#define STRUCT_2_0B6C9ACBECEC8DD3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x795FD0)
#define STRUCT_2_0B6C9ACBECEC8DD3__CCTOR_OFFSET UNITYSDK_OFFSET(0x1281BAB0)
#define STRUCT_2_0B6C9ACBECEC8DD3__CTOR_OFFSET UNITYSDK_OFFSET(0x795D20)

inline static constexpr unsigned int Struct_2_0B6C9ACBECEC8DD3_TypeDefinitionIndex = 63513;

struct alignas(8) Struct_2_0B6C9ACBECEC8DD3
{
	static ::Il2CppArray<::UnityEngine::RaycastHit>** StaticGet_Field_2_2()
	{
		return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(Struct_2_0B6C9ACBECEC8DD3_TypeDefinitionIndex)->GetStaticField(0x493B0);
	}
	...
	*/
	...
	::System::Boolean Method_2_E6D206501EFDAD27(::Struct_2_06CE88B3E17AB3C7& a1, ::Class_0_16E4307DCC419505_214*& a2)
	{
		return ((::System::Boolean(*)(::PVOID, ::Struct_2_06CE88B3E17AB3C7&, ::Class_0_16E4307DCC419505_214*&))((::PBYTE)hIl2Cpp + STRUCT_2_0B6C9ACBECEC8DD3_METHOD_2_E6D206501EFDAD27_OFFSET))(this, a1, a2);
	}
