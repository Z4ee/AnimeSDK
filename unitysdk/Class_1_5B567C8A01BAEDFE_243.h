...
#define CLASS_1_5B567C8A01BAEDFE_243_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E3C6300)
#define CLASS_1_5B567C8A01BAEDFE_243_CLONE_OFFSET UNITYSDK_OFFSET(0x1E3C5FF0)
#define CLASS_1_5B567C8A01BAEDFE_243_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E3C6100)
#define CLASS_1_5B567C8A01BAEDFE_243_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E3C6030)
#define CLASS_1_5B567C8A01BAEDFE_243_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E3C6260)
#define CLASS_1_5B567C8A01BAEDFE_243_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E3C6350)
#define CLASS_1_5B567C8A01BAEDFE_243_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E3C6320)
#define CLASS_1_5B567C8A01BAEDFE_243_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E3C5F70)
#define CLASS_1_5B567C8A01BAEDFE_243_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E3C5FA0)
#define CLASS_1_5B567C8A01BAEDFE_243_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E3C6290)
#define CLASS_1_5B567C8A01BAEDFE_243_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E3C62F0)
#define CLASS_1_5B567C8A01BAEDFE_243__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E3C63A0)
#define CLASS_1_5B567C8A01BAEDFE_243__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E3C5FC0)
#define CLASS_1_5B567C8A01BAEDFE_243__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3C5FB0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_243_TypeDefinitionIndex = 31010;

class Class_1_5B567C8A01BAEDFE_243 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_243*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_243*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_243_TypeDefinitionIndex)->GetStaticField(0x5F140);
	}
