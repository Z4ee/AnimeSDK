...
#define CLASS_2_C33602C0D64FA524_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x178A5790)
#define CLASS_2_C33602C0D64FA524_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x178A5C60)
#define CLASS_2_C33602C0D64FA524_METHOD_2_00A4B38C951C5BD5_OFFSET UNITYSDK_OFFSET(0x178A4EF0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_018BA1AE137EB2E2_OFFSET UNITYSDK_OFFSET(0x178A30C0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_1947BC35B7A7FCB8_OFFSET UNITYSDK_OFFSET(0x178A4870)
#define CLASS_2_C33602C0D64FA524_METHOD_2_33ABFC364E341C89_OFFSET UNITYSDK_OFFSET(0x178A4450)
#define CLASS_2_C33602C0D64FA524_METHOD_2_3B7F6352EF818AEA_OFFSET UNITYSDK_OFFSET(0x178A39A0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x178A3260)
#define CLASS_2_C33602C0D64FA524_METHOD_2_479759059E440327_OFFSET UNITYSDK_OFFSET(0x178A36B0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_50131F4CF014469C_OFFSET UNITYSDK_OFFSET(0x178A3EA0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0x178A33E0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_6E3EE215C182DE98_OFFSET UNITYSDK_OFFSET(0x178A2FC0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_84516C3E776F194F_OFFSET UNITYSDK_OFFSET(0x178A4330)
#define CLASS_2_C33602C0D64FA524_METHOD_2_8A3D91A38AD395C0_OFFSET UNITYSDK_OFFSET(0x178A3880)
#define CLASS_2_C33602C0D64FA524_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x178A4650)
#define CLASS_2_C33602C0D64FA524_METHOD_2_9839DFE3C10E4654_OFFSET UNITYSDK_OFFSET(0x178A46C0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_A6B0F2C779192279_OFFSET UNITYSDK_OFFSET(0x178A3740)
#define CLASS_2_C33602C0D64FA524_METHOD_2_AAD21DE195D05736_OFFSET UNITYSDK_OFFSET(0x178A43C0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x178A3B50)
#define CLASS_2_C33602C0D64FA524_METHOD_2_B888BDD107E26FEC_OFFSET UNITYSDK_OFFSET(0x178A3DA0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_C450A961450309C9_OFFSET UNITYSDK_OFFSET(0x178A5690)
#define CLASS_2_C33602C0D64FA524_METHOD_2_CB8E229BDF290D41_OFFSET UNITYSDK_OFFSET(0x178A4BC0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_CFC95121222309BD_OFFSET UNITYSDK_OFFSET(0x178A4E20)
#define CLASS_2_C33602C0D64FA524_METHOD_2_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x178A3BE0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_D53F77FB0786250F_OFFSET UNITYSDK_OFFSET(0x178A44E0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_DA1BF2C227DC3D86_1_OFFSET UNITYSDK_OFFSET(0x178A4F90)
#define CLASS_2_C33602C0D64FA524_METHOD_2_DA1BF2C227DC3D86_2_OFFSET UNITYSDK_OFFSET(0x178A4FE0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x178A4F40)
#define CLASS_2_C33602C0D64FA524_METHOD_2_EF249BECB59278D9_OFFSET UNITYSDK_OFFSET(0x178A3C90)
#define CLASS_2_C33602C0D64FA524_METHOD_2_F37CDBD6D46274D2_1_OFFSET UNITYSDK_OFFSET(0x178A50F0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_F37CDBD6D46274D2_2_OFFSET UNITYSDK_OFFSET(0x178A51B0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_F37CDBD6D46274D2_3_OFFSET UNITYSDK_OFFSET(0x178A5270)
#define CLASS_2_C33602C0D64FA524_METHOD_2_F37CDBD6D46274D2_4_OFFSET UNITYSDK_OFFSET(0x178A5330)
#define CLASS_2_C33602C0D64FA524_METHOD_2_F37CDBD6D46274D2_5_OFFSET UNITYSDK_OFFSET(0x178A53F0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_F37CDBD6D46274D2_6_OFFSET UNITYSDK_OFFSET(0x178A5480)
#define CLASS_2_C33602C0D64FA524_METHOD_2_F37CDBD6D46274D2_7_OFFSET UNITYSDK_OFFSET(0x178A5510)
#define CLASS_2_C33602C0D64FA524_METHOD_2_F37CDBD6D46274D2_8_OFFSET UNITYSDK_OFFSET(0x178A55D0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x178A5030)
#define CLASS_2_C33602C0D64FA524_ONACQUIRE_OFFSET UNITYSDK_OFFSET(0x178A2F60)
#define CLASS_2_C33602C0D64FA524_ONRETURN_OFFSET UNITYSDK_OFFSET(0x178A3200)
#define CLASS_2_C33602C0D64FA524__CTOR_OFFSET UNITYSDK_OFFSET(0x178A60F0)
#define CLASS_2_C33602C0D64FA524__ONBIND_OFFSET UNITYSDK_OFFSET(0x178A24B0)
#define CLASS_2_C33602C0D64FA524__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x178A3510)
#define CLASS_2_C33602C0D64FA524__ONTICK_OFFSET UNITYSDK_OFFSET(0x178A3570)

inline static constexpr unsigned int Class_2_C33602C0D64FA524_TypeDefinitionIndex = 72032;
...
public:
	...
	::UnityEngine::GameObject* HLMEGCINGKG; // 0x60
	::Class_2_E0065B933D71D9A9* BNFFILALODN; // 0x68
	::UnityEngine::Transform* KMPHCBLIPAN; // 0x70
	::Class_2_6E096A5FCBA7A3BD* COLBKPIKJOO; // 0x78
	::Class_2_33FE1515775ACE7E* GFGMECNGHIG; // 0x80
	::UnityEngine::Transform* FGHFLHBEGHJ; // 0x88
	::UnityEngine::Transform* HIGKIILCPEP; // 0x90
	::UnityEngine::Animation* NJDJFFENGOJ; // 0x98
	::Class_2_38CD28B3D11A00DD* EGHOLHLEHDC; // 0xA0
	::Class_2_D3061860904844A0* PIMKIKPMAPO; // 0xA8
	...
	::Class_2_01E36AFA5FDDCBCA* LFFBIIPBPJJ; // 0xC8
	::Class_2_E543FD1529E01E97* JFHMHENBIPB; // 0xD0
	::Class_2_A7947638CBFEF9CF* KFILGHMECDL; // 0xD8
	::UnityEngine::Transform* GDGDNANJFKI; // 0xE0
	::Class_3_AC01FCB2512C56A9* HEBFHCBPMFI; // 0xE8
	::UnityEngine::Transform* ENIOLPBCHLK; // 0xF0
	::UnityEngine::Animation* JPHOOFFIAAH; // 0xF8
	::UnityEngine::Animation* IGCIKMHNLLC; // 0x100
	::Class_2_B26B9A6AA507E78F* HOLOEFEIBDC; // 0x108
	::RPG::GameCore::CharacterDataComponent* HKCICBFPGGF; // 0x110
	::Class_2_BEBFA6F35799FF11* LEFDOCOCCBH; // 0x118
	::RPG::Client::MonoInControlTip* OOBBOFLHLDH; // 0x120
	::UnityEngine::UI::Image* ANIHJHGMMDP; // 0x128
	::Class_2_00B2FB63C06BFB5B* OENDKKCKOEG; // 0x130
	::RPG::GameCore::LevelUIComponent* GEAHNEAGEBG; // 0x138
	::System::Boolean FHBNNGCEPFD; // 0x140
	::System::Boolean FFIAGGGEAEG; // 0x141
	::System::Boolean ACAPCHBDIBF; // 0x142
	::System::Boolean FMBKOCPMBDF; // 0x143
	::System::Single CMKOAALCKAO; // 0x144
	::RPG::GameCore::MonsterEnergyBarType MBCDGGEGPFA; // 0x148
