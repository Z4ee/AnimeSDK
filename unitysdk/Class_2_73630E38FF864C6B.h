...
#define CLASS_2_73630E38FF864C6B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10AD6000)
#define CLASS_2_73630E38FF864C6B_METHOD_2_3A9C03366E936C66_OFFSET UNITYSDK_OFFSET(0x10AD6220)
#define CLASS_2_73630E38FF864C6B_METHOD_2_52CA0F45BC3414DC_OFFSET UNITYSDK_OFFSET(0x10AD6560)
#define CLASS_2_73630E38FF864C6B_METHOD_2_7F4EBEC55EBE2D81_OFFSET UNITYSDK_OFFSET(0x10AD6670)
#define CLASS_2_73630E38FF864C6B_METHOD_2_9CA35E5BF1A50E77_OFFSET UNITYSDK_OFFSET(0x10AD69E0)
#define CLASS_2_73630E38FF864C6B_METHOD_2_CB7FCC6E483860D4_OFFSET UNITYSDK_OFFSET(0x10AD6B10)
#define CLASS_2_73630E38FF864C6B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10AD6100)
#define CLASS_2_73630E38FF864C6B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10AD6430)
#define CLASS_2_73630E38FF864C6B_TICK_OFFSET UNITYSDK_OFFSET(0x10AD6930)
#define CLASS_2_73630E38FF864C6B__CTOR_OFFSET UNITYSDK_OFFSET(0x10AD5840)

inline static constexpr unsigned int Class_2_73630E38FF864C6B_TypeDefinitionIndex = 42416;

class Class_2_73630E38FF864C6B : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::AdventureCharacterDataComponent* Field_2_5; // 0x18
	::RPG::GameCore::TaskContext* Field_2_1; // 0x20
	::Class_1_5F51D4049EA87B7B* Field_2_13; // 0x28
	::Class_2_F67FF7EB526BF85C* Field_2_3; // 0x30
	::Class_1_5F51D4049EA87B7B* Field_2_11; // 0x38
	::Class_1_5F51D4049EA87B7B* Field_2_12; // 0x40
	::RPG::GameCore::NPCComponent* Field_2_8; // 0x48
	::Class_1_23F67DD15593C8D6* Field_2_9; // 0x50
	::RPG::GameCore::AdventureCharacterController* Field_2_4; // 0x58
	::Class_2_469A56953483CA0D* Field_2_7; // 0x60
	::Class_1_5F51D4049EA87B7B* Field_2_14; // 0x68
	::RPG::GameCore::AdvNPCChase* Field_2_0; // 0x70
	::Class_2_A0580152EB393340* Field_2_6; // 0x78
	::Class_1_5F51D4049EA87B7B* Field_2_10; // 0x80
	::RPG::GameCore::TransformComponent* Field_2_2; // 0x88
