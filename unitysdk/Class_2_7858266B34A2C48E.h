...
#define CLASS_2_7858266B34A2C48E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x134E2D40)
#define CLASS_2_7858266B34A2C48E_GET_ISFARMELEMENTACTIVE_OFFSET UNITYSDK_OFFSET(0x134E3820)
#define CLASS_2_7858266B34A2C48E_METHOD_2_2A3605480291B7E1_OFFSET UNITYSDK_OFFSET(0x134E34A0)
#define CLASS_2_7858266B34A2C48E_METHOD_2_2CBE0B79DD36047E_OFFSET UNITYSDK_OFFSET(0x134E2FD0)
#define CLASS_2_7858266B34A2C48E_METHOD_2_3CCA0B8A31B650A8_OFFSET UNITYSDK_OFFSET(0x134E2D90)
#define CLASS_2_7858266B34A2C48E_METHOD_2_627C7524E98F4AC5_1_OFFSET UNITYSDK_OFFSET(0x134E3420)
#define CLASS_2_7858266B34A2C48E_METHOD_2_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0x134E3260)
#define CLASS_2_7858266B34A2C48E_METHOD_2_7BB881FF8A7B80C2_OFFSET UNITYSDK_OFFSET(0x134E3650)
#define CLASS_2_7858266B34A2C48E_METHOD_2_D89E9B7A3325AE84_OFFSET UNITYSDK_OFFSET(0x134E3710)
#define CLASS_2_7858266B34A2C48E_METHOD_2_E7EF6BC52B28648C_1_OFFSET UNITYSDK_OFFSET(0x134E32E0)
#define CLASS_2_7858266B34A2C48E_METHOD_2_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0x134E3120)
#define CLASS_2_7858266B34A2C48E_METHOD_2_F0D9B6AAFF504D87_OFFSET UNITYSDK_OFFSET(0x134E3020)
#define CLASS_2_7858266B34A2C48E_SET_ISFARMELEMENTACTIVE_OFFSET UNITYSDK_OFFSET(0x134E3830)
#define CLASS_2_7858266B34A2C48E__CTOR_OFFSET UNITYSDK_OFFSET(0x134E3840)
#define CLASS_2_7858266B34A2C48E___DOACTIVE_B__7_0_OFFSET UNITYSDK_OFFSET(0x134E3880)
...
{
public:
	::System::Collections::Generic::List_1<::System::String*>* BJALAOKPDEB; // 0x18
	::System::String* DEMDLBLNHBJ; // 0x20
	::UnityEngine::Coroutine* JKKKEHIFEOF; // 0x28
	::System::String* FBJABBMJHNK; // 0x30
	::System::String* PIFEELOCJMM; // 0x38
	::UnityEngine::Coroutine* KKJKKOOMFDO; // 0x40
	::System::Collections::Generic::List_1<::System::String*>* PMJBNAFPDKM; // 0x48
	::System::String* DKHAGHGEFPI; // 0x50
	::System::String* GMLDDGKDJLL; // 0x58
	::UnityEngine::Coroutine* PBEEOEKJGIN; // 0x60
	::System::String* BNAINGMFJFH; // 0x68
