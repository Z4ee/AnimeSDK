...
#define CUSTOMSKIN_MODIFYREALNAME_BACK_OFFSET UNITYSDK_OFFSET(0x1551A0D0)
#define CUSTOMSKIN_MODIFYREALNAME_INSTANCE_OFFSET UNITYSDK_OFFSET(0x155193E0)
#define CUSTOMSKIN_MODIFYREALNAME_MEETPROBLEM_OFFSET UNITYSDK_OFFSET(0x1551A150)
#define CUSTOMSKIN_MODIFYREALNAME_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x155195A0)
#define CUSTOMSKIN_MODIFYREALNAME_ONCONSOLECANCEL_OFFSET UNITYSDK_OFFSET(0x1551A450)
#define CUSTOMSKIN_MODIFYREALNAME_ONSHOW_OFFSET UNITYSDK_OFFSET(0x15519600)
#define CUSTOMSKIN_MODIFYREALNAME_SETLISTENER_OFFSET UNITYSDK_OFFSET(0x15519D60)
#define CUSTOMSKIN_MODIFYREALNAME_SETTEXT_OFFSET UNITYSDK_OFFSET(0x15519980)
#define CUSTOMSKIN_MODIFYREALNAME_SUBMIT_OFFSET UNITYSDK_OFFSET(0x1551A1D0)
#define CUSTOMSKIN_MODIFYREALNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x15519510)
#define CUSTOMSKIN_MODIFYREALNAME__SETLISTENER_B__7_0_OFFSET UNITYSDK_OFFSET(0x1551A560)
#define CUSTOMSKIN_MODIFYREALNAME__SETLISTENER_B__7_1_OFFSET UNITYSDK_OFFSET(0x1551A5B0)
#define CUSTOMSKIN_MODIFYREALNAME__SETLISTENER_B__7_2_OFFSET UNITYSDK_OFFSET(0x1551A600)
#define CUSTOMSKIN_MODIFYREALNAME__SETLISTENER_B__7_3_OFFSET UNITYSDK_OFFSET(0x1551A680)

inline static constexpr unsigned int CustomSkin_ModifyRealName_TypeDefinitionIndex = 66042;
...
public:
	...
	{
		return (::CustomSkin_ModifyRealName**)Il2CppClass::FromTypeDefinitionIndex(CustomSkin_ModifyRealName_TypeDefinitionIndex)->GetStaticField(0x47C30);
	}
	::MoleMole::UIGeneralRealAuthenticationDialogPopWindowController* realName; // 0x18
	::Class_2_79F6D62CE30E3F8E_88* _view; // 0x20
