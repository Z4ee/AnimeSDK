...
#define CLASS_1_35D7E19A6BADFE2D_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DBC7F60)
#define CLASS_1_35D7E19A6BADFE2D_CLONE_OFFSET UNITYSDK_OFFSET(0x1DBC79A0)
#define CLASS_1_35D7E19A6BADFE2D_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DBC7A80)
#define CLASS_1_35D7E19A6BADFE2D_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DBC7A50)
#define CLASS_1_35D7E19A6BADFE2D_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DBC7C80)
#define CLASS_1_35D7E19A6BADFE2D_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DBC8110)
#define CLASS_1_35D7E19A6BADFE2D_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DBC80C0)
#define CLASS_1_35D7E19A6BADFE2D_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1DBC7A10)
#define CLASS_1_35D7E19A6BADFE2D_METHOD_1_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0x1DBC7A00)
#define CLASS_1_35D7E19A6BADFE2D_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1DBC7910)
#define CLASS_1_35D7E19A6BADFE2D_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1DBC7A20)
#define CLASS_1_35D7E19A6BADFE2D_METHOD_1_8633AE51B23EBDFD_OFFSET UNITYSDK_OFFSET(0x1DBC7A40)
#define CLASS_1_35D7E19A6BADFE2D_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x1DBC79F0)
#define CLASS_1_35D7E19A6BADFE2D_METHOD_1_C229FF62B898C0B2_OFFSET UNITYSDK_OFFSET(0x1DBC7A30)
#define CLASS_1_35D7E19A6BADFE2D_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DBC7940)
#define CLASS_1_35D7E19A6BADFE2D_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DBC7DA0)
#define CLASS_1_35D7E19A6BADFE2D_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DBC7E00)
#define CLASS_1_35D7E19A6BADFE2D__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DBC82B0)
#define CLASS_1_35D7E19A6BADFE2D__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DBC7960)
#define CLASS_1_35D7E19A6BADFE2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1DBC7950)

inline static constexpr unsigned int Class_1_35D7E19A6BADFE2D_TypeDefinitionIndex = 27628;

class Class_1_35D7E19A6BADFE2D : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_35D7E19A6BADFE2D*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_35D7E19A6BADFE2D*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_35D7E19A6BADFE2D_TypeDefinitionIndex)->GetStaticField(0x384C0);
	}
	// static const ::System::Int32 BOADFNPOBEP = 0x3; // 0x0
	// static const ::System::Int32 KOEOEHIMOEI = 0xD; // 0x0
	// static const ::System::Int32 IBJNBJNDPIK = 0x5; // 0x0
