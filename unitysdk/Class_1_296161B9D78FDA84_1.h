...
#define CLASS_1_296161B9D78FDA84_1_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E0E4A20)
#define CLASS_1_296161B9D78FDA84_1_CLONE_OFFSET UNITYSDK_OFFSET(0x1E0E4580)
#define CLASS_1_296161B9D78FDA84_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E0E4720)
#define CLASS_1_296161B9D78FDA84_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E0E4630)
#define CLASS_1_296161B9D78FDA84_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E0E4800)
#define CLASS_1_296161B9D78FDA84_1_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E0E4BE0)
#define CLASS_1_296161B9D78FDA84_1_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E0E4B90)
#define CLASS_1_296161B9D78FDA84_1_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1E0E45F0)
#define CLASS_1_296161B9D78FDA84_1_METHOD_1_4C4B9DFE092840D4_OFFSET UNITYSDK_OFFSET(0x1E0E45E0)
#define CLASS_1_296161B9D78FDA84_1_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E0E44F0)
#define CLASS_1_296161B9D78FDA84_1_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1E0E4600)
#define CLASS_1_296161B9D78FDA84_1_METHOD_1_7ADD5F1F5E247E3B_OFFSET UNITYSDK_OFFSET(0x1E0E45D0)
#define CLASS_1_296161B9D78FDA84_1_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1E0E4620)
#define CLASS_1_296161B9D78FDA84_1_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1E0E4610)
#define CLASS_1_296161B9D78FDA84_1_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E0E4520)
#define CLASS_1_296161B9D78FDA84_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E0E4850)
#define CLASS_1_296161B9D78FDA84_1_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E0E48B0)
#define CLASS_1_296161B9D78FDA84_1__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E0E4D90)
#define CLASS_1_296161B9D78FDA84_1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E0E4540)
#define CLASS_1_296161B9D78FDA84_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0E4530)

inline static constexpr unsigned int Class_1_296161B9D78FDA84_1_TypeDefinitionIndex = 31414;

class Class_1_296161B9D78FDA84_1 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_296161B9D78FDA84_1*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_296161B9D78FDA84_1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_296161B9D78FDA84_1_TypeDefinitionIndex)->GetStaticField(0x14830);
	}
	// static const ::System::Int32 JJALDILEIIF = 0x8; // 0x0
	// static const ::System::Int32 PLDKENJLKME = 0xC; // 0x0
	// static const ::System::Int32 OPKAOFANLJI = 0x6; // 0x0
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x10
	::System::UInt32 NAEACGPKNNH; // 0x18
	::System::Boolean KANHAPIFLOM; // 0x1C
	::System::Int64 IPBKMFIBBIB; // 0x20
