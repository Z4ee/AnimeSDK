...
#define STAGEHARMONYLIGHTLINKSLOT_METHOD_2_7DB49B5407C8FD68_OFFSET UNITYSDK_OFFSET(0x197ECF50)
#define STAGEHARMONYLIGHTLINKSLOT_METHOD_2_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0x197ED000)
#define STAGEHARMONYLIGHTLINKSLOT_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x197ED120)
#define STAGEHARMONYLIGHTLINKSLOT_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x197ED0E0)
#define STAGEHARMONYLIGHTLINKSLOT_METHOD_2_FD6AF0F9AA9298B1_OFFSET UNITYSDK_OFFSET(0x197ED160)
#define STAGEHARMONYLIGHTLINKSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x197ED7E0)

inline static constexpr unsigned int StageHarmonyLightLinkSlot_TypeDefinitionIndex = 48006;
