...
#define CLASS_1_F8DD202AA81EAB8E__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA96960)
...
{
public:
	::Struct_2_BAC27E6E9012E854 BPAPBAFOMCH; // 0x10
	::RPG::GameCore::FiveDimSpikeConfig* EABKOHGCHFP; // 0x38
