...
#define HEDGEHOGTEAM_EASYTOUCH_QUICKENTEROVEREXIST_AWAKE_OFFSET UNITYSDK_OFFSET(0x1652CFC0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKENTEROVEREXIST_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1652D460)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKENTEROVEREXIST_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1652D250)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKENTEROVEREXIST_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1652D050)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKENTEROVEREXIST_ON_TOUCHDOWN_OFFSET UNITYSDK_OFFSET(0x1652D470)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKENTEROVEREXIST_ON_TOUCHUP_OFFSET UNITYSDK_OFFSET(0x1652D8D0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKENTEROVEREXIST_UNSUBSCRIBEEVENT_OFFSET UNITYSDK_OFFSET(0x1652D260)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKENTEROVEREXIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1652CF20)
