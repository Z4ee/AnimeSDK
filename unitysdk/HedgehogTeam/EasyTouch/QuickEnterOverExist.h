...
#define HEDGEHOGTEAM_EASYTOUCH_QUICKENTEROVEREXIST_AWAKE_OFFSET UNITYSDK_OFFSET(0x146FA000)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKENTEROVEREXIST_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x146FA4A0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKENTEROVEREXIST_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x146FA290)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKENTEROVEREXIST_ONENABLE_OFFSET UNITYSDK_OFFSET(0x146FA090)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKENTEROVEREXIST_ON_TOUCHDOWN_OFFSET UNITYSDK_OFFSET(0x146FA4B0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKENTEROVEREXIST_ON_TOUCHUP_OFFSET UNITYSDK_OFFSET(0x146FA910)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKENTEROVEREXIST_UNSUBSCRIBEEVENT_OFFSET UNITYSDK_OFFSET(0x146FA2A0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKENTEROVEREXIST__CTOR_OFFSET UNITYSDK_OFFSET(0x146F9F60)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int QuickEnterOverExist_TypeDefinitionIndex = 37294;
