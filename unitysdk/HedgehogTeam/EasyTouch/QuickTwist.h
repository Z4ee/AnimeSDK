...
#define HEDGEHOGTEAM_EASYTOUCH_QUICKTWIST_DOACTION_OFFSET UNITYSDK_OFFSET(0x1D16D150)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKTWIST_ISRIGHTROTATION_OFFSET UNITYSDK_OFFSET(0x1D16D0B0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKTWIST_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1D16D000)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKTWIST_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1D16CDF0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKTWIST_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D16CBF0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKTWIST_ON_TWISTEND_OFFSET UNITYSDK_OFFSET(0x1D16D380)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKTWIST_ON_TWIST_OFFSET UNITYSDK_OFFSET(0x1D16D010)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKTWIST_UNSUBSCRIBEEVENT_OFFSET UNITYSDK_OFFSET(0x1D16CE00)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKTWIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D16CB60)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int QuickTwist_TypeDefinitionIndex = 38983;
