...
#define HEDGEHOGTEAM_EASYTOUCH_QUICKTWIST_DOACTION_OFFSET UNITYSDK_OFFSET(0x1B4F9C40)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKTWIST_ISRIGHTROTATION_OFFSET UNITYSDK_OFFSET(0x1B4F9BA0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKTWIST_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B4F9AF0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKTWIST_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B4F98E0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKTWIST_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B4F96E0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKTWIST_ON_TWISTEND_OFFSET UNITYSDK_OFFSET(0x1B4F9E70)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKTWIST_ON_TWIST_OFFSET UNITYSDK_OFFSET(0x1B4F9B00)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKTWIST_UNSUBSCRIBEEVENT_OFFSET UNITYSDK_OFFSET(0x1B4F98F0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKTWIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4F9650)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int QuickTwist_TypeDefinitionIndex = 38124;
