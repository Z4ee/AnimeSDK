...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_PINCHENDHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x146EFEC0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_PINCHENDHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x146EFEF0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_PINCHENDHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x146EADC0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_PINCHENDHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x146EFDD0)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_PinchEndHandler_TypeDefinitionIndex = 37353;
