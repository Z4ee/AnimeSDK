...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_LONGTAPENDHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x12C43320)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_LONGTAPENDHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x12C43350)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_LONGTAPENDHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x12C35B10)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_LONGTAPENDHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12C43300)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_LongTapEndHandler_TypeDefinitionIndex = 37034;
