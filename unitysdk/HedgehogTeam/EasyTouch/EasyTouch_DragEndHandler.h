...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DRAGENDHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x165220C0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DRAGENDHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x165220F0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DRAGENDHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1651DF10)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DRAGENDHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16521FD0)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_DragEndHandler_TypeDefinitionIndex = 39004;
