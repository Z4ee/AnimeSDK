...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DRAGENDHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B4EB470)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DRAGENDHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B4EB4A0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DRAGENDHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B4E72A0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DRAGENDHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4EB380)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_DragEndHandler_TypeDefinitionIndex = 38145;
