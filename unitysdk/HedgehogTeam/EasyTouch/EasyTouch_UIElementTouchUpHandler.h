...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_UIELEMENTTOUCHUPHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B4EDB20)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_UIELEMENTTOUCHUPHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B4EDB50)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_UIELEMENTTOUCHUPHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B4E7430)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_UIELEMENTTOUCHUPHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4EDA30)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_UIElementTouchUpHandler_TypeDefinitionIndex = 38171;
