...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_UIELEMENTTOUCHUPHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x146F17B0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_UIELEMENTTOUCHUPHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x146F17E0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_UIELEMENTTOUCHUPHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x146EAE40)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_UIELEMENTTOUCHUPHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x146F16C0)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_UIElementTouchUpHandler_TypeDefinitionIndex = 37363;
