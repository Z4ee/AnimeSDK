...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TOUCHDOWNHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x11A74C80)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TOUCHDOWNHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11A74CB0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TOUCHDOWNHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x11A64EE0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TOUCHDOWNHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11A74C60)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_TouchDownHandler_TypeDefinitionIndex = 31308;
