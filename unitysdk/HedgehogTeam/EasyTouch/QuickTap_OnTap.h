...
#define HEDGEHOGTEAM_EASYTOUCH_QUICKTAP_ONTAP__CTOR_OFFSET UNITYSDK_OFFSET(0x12C4E600)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int QuickTap_OnTap_TypeDefinitionIndex = 37010;
