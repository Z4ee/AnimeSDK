...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TOUCHUP2FINGERSHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B4ED660)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TOUCHUP2FINGERSHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B4ED690)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TOUCHUP2FINGERSHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B4E7300)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TOUCHUP2FINGERSHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4ED570)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_TouchUp2FingersHandler_TypeDefinitionIndex = 38151;
