...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TOUCHUP2FINGERSHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x146F12F0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TOUCHUP2FINGERSHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x146F1320)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TOUCHUP2FINGERSHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x146EAD10)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TOUCHUP2FINGERSHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x146F1200)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_TouchUp2FingersHandler_TypeDefinitionIndex = 37343;
