...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_PINCHOUTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16523210)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_PINCHOUTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16523240)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_PINCHOUTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1651E010)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_PINCHOUTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16523120)
