...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_PINCHOUTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B4EC5C0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_PINCHOUTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B4EC5F0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_PINCHOUTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B4E73A0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_PINCHOUTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4EC4D0)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_PinchOutHandler_TypeDefinitionIndex = 38160;
