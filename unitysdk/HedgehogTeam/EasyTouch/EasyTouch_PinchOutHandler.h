...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_PINCHOUTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x146F0250)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_PINCHOUTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x146F0280)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_PINCHOUTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x146EADB0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_PINCHOUTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x146F0160)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_PinchOutHandler_TypeDefinitionIndex = 37352;
