...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DOUBLETAPHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x11A741A0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DOUBLETAPHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11A741D0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DOUBLETAPHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x11A65ED0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DOUBLETAPHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11A74180)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_DoubleTapHandler_TypeDefinitionIndex = 31311;
