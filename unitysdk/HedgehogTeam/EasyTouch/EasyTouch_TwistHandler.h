...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TWISTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B4ED9F0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TWISTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B4EDA20)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TWISTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B4E7360)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TWISTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4ED900)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_TwistHandler_TypeDefinitionIndex = 38157;
