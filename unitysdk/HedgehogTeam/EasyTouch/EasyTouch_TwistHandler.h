...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TWISTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x146F1680)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TWISTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x146F16B0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TWISTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x146EAD70)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TWISTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x146F1590)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_TwistHandler_TypeDefinitionIndex = 37349;
