...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TWISTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D160F10)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TWISTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D160F40)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TWISTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D15A8A0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TWISTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D160E20)
