...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DRAGSTART2FINGERSHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x11A74380)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DRAGSTART2FINGERSHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11A743B0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DRAGSTART2FINGERSHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x11A6DE50)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DRAGSTART2FINGERSHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11A74360)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_DragStart2FingersHandler_TypeDefinitionIndex = 31335;
