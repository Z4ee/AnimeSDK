...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH__SINGLEORDOUBLE_D__236_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B4EAB40)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH__SINGLEORDOUBLE_D__236_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B4EAD20)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH__SINGLEORDOUBLE_D__236_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B4EAD80)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH__SINGLEORDOUBLE_D__236_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B4EAD30)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH__SINGLEORDOUBLE_D__236_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B4EAB30)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH__SINGLEORDOUBLE_D__236__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E3CE0)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch__SingleOrDouble_d__236_TypeDefinitionIndex = 38181;
