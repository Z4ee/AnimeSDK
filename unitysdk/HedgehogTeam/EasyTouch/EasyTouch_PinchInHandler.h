...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_PINCHINHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x11A74800)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_PINCHINHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11A74830)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_PINCHINHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x11A6CE60)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_PINCHINHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11A747E0)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_PinchInHandler_TypeDefinitionIndex = 31331;
