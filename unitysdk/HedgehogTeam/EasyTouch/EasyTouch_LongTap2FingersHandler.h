...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_LONGTAP2FINGERSHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16522630)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_LONGTAP2FINGERSHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16522660)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_LONGTAP2FINGERSHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1651DFB0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_LONGTAP2FINGERSHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16522540)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_LongTap2FingersHandler_TypeDefinitionIndex = 39014;
