...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_LONGTAP2FINGERSHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B4EB9E0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_LONGTAP2FINGERSHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B4EBA10)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_LONGTAP2FINGERSHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B4E7340)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_LONGTAP2FINGERSHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4EB8F0)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_LongTap2FingersHandler_TypeDefinitionIndex = 38155;
