...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_SWIPEHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16523930)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_SWIPEHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16523960)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_SWIPEHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1651DF30)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_SWIPEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16523840)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_SwipeHandler_TypeDefinitionIndex = 39006;
