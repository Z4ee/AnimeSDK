...
#define HEDGEHOGTEAM_EASYTOUCH_QUICKPINCH_DOACTION_OFFSET UNITYSDK_OFFSET(0x11A7E560)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKPINCH_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x11A7E530)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKPINCH_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x11A7E200)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKPINCH_ONENABLE_OFFSET UNITYSDK_OFFSET(0x11A7DEE0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKPINCH_ON_PICHEND_OFFSET UNITYSDK_OFFSET(0x11A7E7E0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKPINCH_ON_PINCHIN_OFFSET UNITYSDK_OFFSET(0x11A7E7A0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKPINCH_ON_PINCHOUT_OFFSET UNITYSDK_OFFSET(0x11A7E7C0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKPINCH_ON_PINCH_OFFSET UNITYSDK_OFFSET(0x11A7E540)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKPINCH_UNSUBSCRIBEEVENT_OFFSET UNITYSDK_OFFSET(0x11A7E210)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKPINCH__CTOR_OFFSET UNITYSDK_OFFSET(0x11A7DE50)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int QuickPinch_TypeDefinitionIndex = 31281;
