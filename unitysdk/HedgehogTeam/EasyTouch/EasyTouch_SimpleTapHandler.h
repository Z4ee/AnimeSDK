...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_SIMPLETAPHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x12C436E0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_SIMPLETAPHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x12C43710)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_SIMPLETAPHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x12C345D0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_SIMPLETAPHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x12C436C0)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_SimpleTapHandler_TypeDefinitionIndex = 37030;
