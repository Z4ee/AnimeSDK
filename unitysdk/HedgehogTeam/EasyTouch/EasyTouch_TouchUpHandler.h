...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TOUCHUPHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x146F1420)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TOUCHUPHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x146F1450)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TOUCHUPHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x146EAC30)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TOUCHUPHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x146F1330)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_TouchUpHandler_TypeDefinitionIndex = 37329;
