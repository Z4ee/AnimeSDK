...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TWISTENDHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16524510)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TWISTENDHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16524540)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TWISTENDHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1651DFE0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TWISTENDHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16524420)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_TwistEndHandler_TypeDefinitionIndex = 39017;
