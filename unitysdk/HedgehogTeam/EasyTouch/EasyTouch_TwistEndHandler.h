...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TWISTENDHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x146F1550)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TWISTENDHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x146F1580)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TWISTENDHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x146EAD80)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_TWISTENDHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x146F1460)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_TwistEndHandler_TypeDefinitionIndex = 37350;
