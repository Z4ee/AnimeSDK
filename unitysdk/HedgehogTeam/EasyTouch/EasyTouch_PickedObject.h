...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_PICKEDOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4DEA60)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_PickedObject_TypeDefinitionIndex = 38132;
