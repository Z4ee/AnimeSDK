...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DRAGSTARTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x11A743E0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DRAGSTARTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11A74410)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DRAGSTARTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x11A67410)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DRAGSTARTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11A743C0)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_DragStartHandler_TypeDefinitionIndex = 31315;
