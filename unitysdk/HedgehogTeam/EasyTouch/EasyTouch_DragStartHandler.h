...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DRAGSTARTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16522450)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DRAGSTARTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16522480)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DRAGSTARTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1651DEF0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_DRAGSTARTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16522360)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_DragStartHandler_TypeDefinitionIndex = 39002;
