...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_LONGTAPEND2FINGERSHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x11A74500)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_LONGTAPEND2FINGERSHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11A74530)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_LONGTAPEND2FINGERSHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x11A6B920)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_LONGTAPEND2FINGERSHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x11A744E0)

namespace HedgehogTeam::EasyTouch
{
	inline static constexpr unsigned int EasyTouch_LongTapEnd2FingersHandler_TypeDefinitionIndex = 31328;
