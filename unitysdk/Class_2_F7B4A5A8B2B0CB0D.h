...
#define CLASS_2_F7B4A5A8B2B0CB0D_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1C3B2130)
#define CLASS_2_F7B4A5A8B2B0CB0D_FILTER_OFFSET UNITYSDK_OFFSET(0x1C3B2030)
#define CLASS_2_F7B4A5A8B2B0CB0D_GETTRIGGER_OFFSET UNITYSDK_OFFSET(0x1C3B1F10)
#define CLASS_2_F7B4A5A8B2B0CB0D__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3B1E90)

inline static constexpr unsigned int Class_2_F7B4A5A8B2B0CB0D_TypeDefinitionIndex = 40747;

class Class_2_F7B4A5A8B2B0CB0D : public ::Entitas::ReactiveSystem_1<::Class_2_1C9DAFE8E76EE3E9*>
{
public:
	::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_212*>* BGKHCJPFFLN; // 0x28
