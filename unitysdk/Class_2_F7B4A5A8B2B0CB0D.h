...
#define CLASS_2_F7B4A5A8B2B0CB0D_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1BA9E090)
#define CLASS_2_F7B4A5A8B2B0CB0D_FILTER_OFFSET UNITYSDK_OFFSET(0x1BA9DF90)
#define CLASS_2_F7B4A5A8B2B0CB0D_GETTRIGGER_OFFSET UNITYSDK_OFFSET(0x1BA9DE70)
#define CLASS_2_F7B4A5A8B2B0CB0D__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA9DDF0)
