...
#define CLASS_1_5B567C8A01BAEDFE_49_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E2D6F10)
#define CLASS_1_5B567C8A01BAEDFE_49_CLONE_OFFSET UNITYSDK_OFFSET(0x1E2D6C00)
#define CLASS_1_5B567C8A01BAEDFE_49_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E2D6D10)
#define CLASS_1_5B567C8A01BAEDFE_49_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E2D6C40)
#define CLASS_1_5B567C8A01BAEDFE_49_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E2D6E70)
#define CLASS_1_5B567C8A01BAEDFE_49_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E2D6F60)
#define CLASS_1_5B567C8A01BAEDFE_49_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E2D6F30)
#define CLASS_1_5B567C8A01BAEDFE_49_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E2D6B80)
#define CLASS_1_5B567C8A01BAEDFE_49_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E2D6BB0)
#define CLASS_1_5B567C8A01BAEDFE_49_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E2D6EA0)
#define CLASS_1_5B567C8A01BAEDFE_49_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E2D6F00)
#define CLASS_1_5B567C8A01BAEDFE_49__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E2D6FB0)
#define CLASS_1_5B567C8A01BAEDFE_49__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E2D6BD0)
#define CLASS_1_5B567C8A01BAEDFE_49__CTOR_OFFSET UNITYSDK_OFFSET(0x1E2D6BC0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_49_TypeDefinitionIndex = 26470;

class Class_1_5B567C8A01BAEDFE_49 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_49*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_49*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_49_TypeDefinitionIndex)->GetStaticField(0x2B0E0);
	}
