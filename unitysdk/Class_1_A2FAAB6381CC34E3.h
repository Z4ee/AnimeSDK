...
#define CLASS_1_A2FAAB6381CC34E3_CLEAR_OFFSET UNITYSDK_OFFSET(0x1C5FA6E0)
#define CLASS_1_A2FAAB6381CC34E3__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5FA740)
...
{
public:
	::Class_1_89AD82AEAD720173* NNANJMDMAOC; // 0x10
	::RPG::GameCore::FiveDimCustomVisibilityConfig* EABKOHGCHFP; // 0x18
