...
#define CLASS_1_E14CBC48FE052048_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1536EF90)
...
public:
	...
	::System::String* TaskId; // 0x18
	::Class_1_945ACFB1FEBC7A2C_19* Prompts; // 0x20
	::Class_1_945ACFB1FEBC7A2C_18* Model; // 0x28
