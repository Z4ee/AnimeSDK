...
#define CLASS_1_F64CEA2EBA77404D_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A94FB80)
#define CLASS_1_F64CEA2EBA77404D_CLONE_OFFSET UNITYSDK_OFFSET(0x1A94F700)
#define CLASS_1_F64CEA2EBA77404D_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A94F7C0)
#define CLASS_1_F64CEA2EBA77404D_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A94F790)
#define CLASS_1_F64CEA2EBA77404D_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A94F8C0)
#define CLASS_1_F64CEA2EBA77404D_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A94FE10)
#define CLASS_1_F64CEA2EBA77404D_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A94FD40)
#define CLASS_1_F64CEA2EBA77404D_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1A94F750)
#define CLASS_1_F64CEA2EBA77404D_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1A94F730)
#define CLASS_1_F64CEA2EBA77404D_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A94F580)
#define CLASS_1_F64CEA2EBA77404D_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1A94F760)
#define CLASS_1_F64CEA2EBA77404D_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1A94F740)
#define CLASS_1_F64CEA2EBA77404D_METHOD_1_D7B5771D20F18855_OFFSET UNITYSDK_OFFSET(0x1A94F780)
#define CLASS_1_F64CEA2EBA77404D_METHOD_1_EE26AC512FD8F4BE_OFFSET UNITYSDK_OFFSET(0x1A94F770)
#define CLASS_1_F64CEA2EBA77404D_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A94F5B0)
#define CLASS_1_F64CEA2EBA77404D_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A94F9E0)
#define CLASS_1_F64CEA2EBA77404D_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A94FA40)
#define CLASS_1_F64CEA2EBA77404D__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A94FF50)
#define CLASS_1_F64CEA2EBA77404D__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A94F620)
#define CLASS_1_F64CEA2EBA77404D__CTOR_OFFSET UNITYSDK_OFFSET(0x1A94F5C0)

inline static constexpr unsigned int Class_1_F64CEA2EBA77404D_TypeDefinitionIndex = 32149;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_F64CEA2EBA77404D*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F64CEA2EBA77404D_TypeDefinitionIndex)->GetStaticField(0x23580);
	}
	static ::Google::Protobuf::FieldCodec_1<::Proto::SceneEntityInfo*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::FieldCodec_1<::Proto::SceneEntityInfo*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F64CEA2EBA77404D_TypeDefinitionIndex)->GetStaticField(0x23588);
	}
	static ::Google::Protobuf::Collections::MapField_2_Codec<::System::String*, ::System::Int32>** StaticGet_Field_1_2()
	{
		return (::Google::Protobuf::Collections::MapField_2_Codec<::System::String*, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F64CEA2EBA77404D_TypeDefinitionIndex)->GetStaticField(0x23590);
	}
	...
	::Google::Protobuf::Collections::RepeatedField_1<::Proto::SceneEntityInfo*>* Field_1_9; // 0x20
