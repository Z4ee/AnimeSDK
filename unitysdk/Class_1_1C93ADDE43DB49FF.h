...
#define CLASS_1_1C93ADDE43DB49FF__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF9A0A0)
...
public:
	...
	::RPG::GameCore::FourRotateVoxelEnvType FOLGBLOBAPM; // 0x18
	::System::UInt32 GBNPNJPBBLP; // 0x1C
