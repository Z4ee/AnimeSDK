...
#define INIPARSEREX_INIFILE_SECTIONITEM_CREATELIST_OFFSET UNITYSDK_OFFSET(0x1B272D10)
#define INIPARSEREX_INIFILE_SECTIONITEM_CREATEMAP_OFFSET UNITYSDK_OFFSET(0x1B272D70)
#define INIPARSEREX_INIFILE_SECTIONITEM_CREATESINGLE_OFFSET UNITYSDK_OFFSET(0x1B272CA0)
#define INIPARSEREX_INIFILE_SECTIONITEM_CREATESTRING_OFFSET UNITYSDK_OFFSET(0x1B272C50)
#define INIPARSEREX_INIFILE_SECTIONITEM_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B2731A0)
#define INIPARSEREX_INIFILE_SECTIONITEM_GET_ANYITEM_OFFSET UNITYSDK_OFFSET(0x1B272E30)
#define INIPARSEREX_INIFILE_SECTIONITEM_GET_ITEMTYPE_OFFSET UNITYSDK_OFFSET(0x1B272E10)
#define INIPARSEREX_INIFILE_SECTIONITEM_GET_LIST_OFFSET UNITYSDK_OFFSET(0x1B272F80)
#define INIPARSEREX_INIFILE_SECTIONITEM_GET_MAP_OFFSET UNITYSDK_OFFSET(0x1B273090)
#define INIPARSEREX_INIFILE_SECTIONITEM_GET_SINGLE_OFFSET UNITYSDK_OFFSET(0x1B272F00)
#define INIPARSEREX_INIFILE_SECTIONITEM_GET_STR_OFFSET UNITYSDK_OFFSET(0x1B272E50)
#define INIPARSEREX_INIFILE_SECTIONITEM_SET_ANYITEM_OFFSET UNITYSDK_OFFSET(0x1B272E40)
#define INIPARSEREX_INIFILE_SECTIONITEM_SET_ITEMTYPE_OFFSET UNITYSDK_OFFSET(0x1B272E20)
#define INIPARSEREX_INIFILE_SECTIONITEM_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B273200)
#define INIPARSEREX_INIFILE_SECTIONITEM_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B273250)
#define INIPARSEREX_INIFILE_SECTIONITEM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B272C40)
#define INIPARSEREX_INIFILE_SECTIONITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B272C30)

namespace IniParserEx
{
	inline static constexpr unsigned int IniFile_SectionItem_TypeDefinitionIndex = 3921;
