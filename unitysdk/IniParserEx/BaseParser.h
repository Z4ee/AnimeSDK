...
#define INIPARSEREX_BASEPARSER_CLEARCOMMENT_OFFSET UNITYSDK_OFFSET(0x1C4C0FE0)
#define INIPARSEREX_BASEPARSER_GETCHAR_OFFSET UNITYSDK_OFFSET(0x1C4C07F0)
#define INIPARSEREX_BASEPARSER_GETLEADINGCHAR_OFFSET UNITYSDK_OFFSET(0x1C4C10F0)
#define INIPARSEREX_BASEPARSER_GETLOCATION_OFFSET UNITYSDK_OFFSET(0x1C4C1000)
#define INIPARSEREX_BASEPARSER_GETTOKEN_OFFSET UNITYSDK_OFFSET(0x1C4C1700)
#define INIPARSEREX_BASEPARSER_INITPARSERSOURCE_OFFSET UNITYSDK_OFFSET(0x1C4C0600)
#define INIPARSEREX_BASEPARSER_ISBEGINCOMMENT_OFFSET UNITYSDK_OFFSET(0x1C4C0640)
#define INIPARSEREX_BASEPARSER_ISENDCOMMENT_OFFSET UNITYSDK_OFFSET(0x1C4C0710)
#define INIPARSEREX_BASEPARSER_ISENDOFLINE_OFFSET UNITYSDK_OFFSET(0x1C4C3000)
#define INIPARSEREX_BASEPARSER_ISEOL_OFFSET UNITYSDK_OFFSET(0x1C4C16D0)
#define INIPARSEREX_BASEPARSER_ISLINECOMMENT_OFFSET UNITYSDK_OFFSET(0x1C4C0780)
#define INIPARSEREX_BASEPARSER_ISWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1C4C16B0)
#define INIPARSEREX_BASEPARSER_MATCHSYMBOL_OFFSET UNITYSDK_OFFSET(0x1C4C2F80)
#define INIPARSEREX_BASEPARSER_PEEKCHAR_OFFSET UNITYSDK_OFFSET(0x1C4C06B0)
#define INIPARSEREX_BASEPARSER_REQUIRESYMBOL_OFFSET UNITYSDK_OFFSET(0x1C4C3040)
#define INIPARSEREX_BASEPARSER_UNGETCHAR_OFFSET UNITYSDK_OFFSET(0x1C4C16F0)
#define INIPARSEREX_BASEPARSER_UNGETTOKEN_OFFSET UNITYSDK_OFFSET(0x1C4C2F50)
#define INIPARSEREX_BASEPARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4C3050)
#define INIPARSEREX_BASEPARSER__GETTOKEN_G__ISPAIR_22_0_OFFSET UNITYSDK_OFFSET(0x1C4C2F30)

namespace IniParserEx
{
	inline static constexpr unsigned int BaseParser_TypeDefinitionIndex = 3919;
