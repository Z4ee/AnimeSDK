...
#define INIPARSEREX_INIFILE__GETENUMERATOR_D__11_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x189E5B20)
#define INIPARSEREX_INIFILE__GETENUMERATOR_D__11_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_SYSTEM_STRING_INIPARSEREX_INIFILE_SECTION___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x189E5C90)
#define INIPARSEREX_INIFILE__GETENUMERATOR_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x189E5CF0)
#define INIPARSEREX_INIFILE__GETENUMERATOR_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x189E5CA0)
#define INIPARSEREX_INIFILE__GETENUMERATOR_D__11_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x189E5B00)
#define INIPARSEREX_INIFILE__GETENUMERATOR_D__11__CTOR_OFFSET UNITYSDK_OFFSET(0x189E5140)
#define INIPARSEREX_INIFILE__GETENUMERATOR_D__11___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x189E5B10)

namespace IniParserEx
{
	inline static constexpr unsigned int IniFile__GetEnumerator_d__11_TypeDefinitionIndex = 3750;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + INIPARSEREX_INIFILE__GETENUMERATOR_D__11__CTOR_OFFSET))(this, __1__state);
		}
