...
#define INIPARSEREX_INIFILE_SECTIONITEM__GETENUMERATOR_D__28_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A420490)
#define INIPARSEREX_INIFILE_SECTIONITEM__GETENUMERATOR_D__28_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_INIPARSEREX_INIFILE_SECTIONITEM__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A420820)
#define INIPARSEREX_INIFILE_SECTIONITEM__GETENUMERATOR_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A420880)
#define INIPARSEREX_INIFILE_SECTIONITEM__GETENUMERATOR_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A420830)
#define INIPARSEREX_INIFILE_SECTIONITEM__GETENUMERATOR_D__28_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A420450)
#define INIPARSEREX_INIFILE_SECTIONITEM__GETENUMERATOR_D__28__CTOR_OFFSET UNITYSDK_OFFSET(0x1A41FF90)
#define INIPARSEREX_INIFILE_SECTIONITEM__GETENUMERATOR_D__28___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1A420470)
#define INIPARSEREX_INIFILE_SECTIONITEM__GETENUMERATOR_D__28___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1A420480)

namespace IniParserEx
{
	inline static constexpr unsigned int IniFile_SectionItem__GetEnumerator_d__28_TypeDefinitionIndex = 3751;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + INIPARSEREX_INIFILE_SECTIONITEM__GETENUMERATOR_D__28__CTOR_OFFSET))(this, __1__state);
		}
