...
#define INIPARSEREX_INIFILE_SECTIONITEM__GETENUMERATOR_D__28_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1C4C5760)
#define INIPARSEREX_INIFILE_SECTIONITEM__GETENUMERATOR_D__28_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_INIPARSEREX_INIFILE_SECTIONITEM__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C4C5BA0)
#define INIPARSEREX_INIFILE_SECTIONITEM__GETENUMERATOR_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C4C5C00)
#define INIPARSEREX_INIFILE_SECTIONITEM__GETENUMERATOR_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1C4C5BB0)
#define INIPARSEREX_INIFILE_SECTIONITEM__GETENUMERATOR_D__28_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C4C5720)
#define INIPARSEREX_INIFILE_SECTIONITEM__GETENUMERATOR_D__28__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4C5210)
#define INIPARSEREX_INIFILE_SECTIONITEM__GETENUMERATOR_D__28___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1C4C5740)
#define INIPARSEREX_INIFILE_SECTIONITEM__GETENUMERATOR_D__28___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1C4C5750)

namespace IniParserEx
{
	inline static constexpr unsigned int IniFile_SectionItem__GetEnumerator_d__28_TypeDefinitionIndex = 3929;
