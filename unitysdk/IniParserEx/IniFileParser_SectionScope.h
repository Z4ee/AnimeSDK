...
#define INIPARSEREX_INIFILEPARSER_SECTIONSCOPE_GET_SECTION_OFFSET UNITYSDK_OFFSET(0x1A423350)
#define INIPARSEREX_INIFILEPARSER_SECTIONSCOPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A421B10)

namespace IniParserEx
{
	inline static constexpr unsigned int IniFileParser_SectionScope_TypeDefinitionIndex = 3756;
