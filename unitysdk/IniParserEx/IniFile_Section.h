...
#define INIPARSEREX_INIFILE_SECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1ECFF820)
#define INIPARSEREX_INIFILE_SECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1ECFFB50)
#define INIPARSEREX_INIFILE_SECTION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1ECFFC60)
#define INIPARSEREX_INIFILE_SECTION_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1ECFFC70)
#define INIPARSEREX_INIFILE_SECTION_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1ECFFC10)
#define INIPARSEREX_INIFILE_SECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1ECFFAB0)

namespace IniParserEx
{
	inline static constexpr unsigned int IniFile_Section_TypeDefinitionIndex = 3931;
