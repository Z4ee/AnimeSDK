...
#define CLASS_3_F5D293F59A8E7124_METHOD_3_B4C09A5853E73B8A_OFFSET UNITYSDK_OFFSET(0x1CF0E1A0)
#define CLASS_3_F5D293F59A8E7124_METHOD_3_C6C799B3DFBE236B_OFFSET UNITYSDK_OFFSET(0x1CF0E160)
#define CLASS_3_F5D293F59A8E7124__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF0E190)

inline static constexpr unsigned int Class_3_F5D293F59A8E7124_TypeDefinitionIndex = 10175;

class Class_3_F5D293F59A8E7124 : public ::RPG::GameCore::TaskConfig
{
public:
	::System::String* EHMHINHDGIA; // 0x18
	::RPG::GameCore::DynamicFloat* FMLGGKAFMKC; // 0x20
	::System::String* PNDDBKCPCLC; // 0x28
