...
#define CLASS_3_C958A04556732C9F_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x104C7000)
#define CLASS_3_C958A04556732C9F__CTOR_OFFSET UNITYSDK_OFFSET(0x104C6FD0)

inline static constexpr unsigned int Class_3_C958A04556732C9F_TypeDefinitionIndex = 46889;
