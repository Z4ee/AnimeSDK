...
#define CLASS_1_5B567C8A01BAEDFE_160_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19AC7810)
#define CLASS_1_5B567C8A01BAEDFE_160_CLONE_OFFSET UNITYSDK_OFFSET(0x19AC7620)
#define CLASS_1_5B567C8A01BAEDFE_160_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19AC7720)
#define CLASS_1_5B567C8A01BAEDFE_160_EQUALS_OFFSET UNITYSDK_OFFSET(0x19AC7690)
#define CLASS_1_5B567C8A01BAEDFE_160_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19AC7770)
#define CLASS_1_5B567C8A01BAEDFE_160_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19AC7860)
#define CLASS_1_5B567C8A01BAEDFE_160_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19AC7830)
#define CLASS_1_5B567C8A01BAEDFE_160_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19AC7570)
#define CLASS_1_5B567C8A01BAEDFE_160_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19AC75D0)
#define CLASS_1_5B567C8A01BAEDFE_160_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19AC77A0)
#define CLASS_1_5B567C8A01BAEDFE_160_WRITETO_OFFSET UNITYSDK_OFFSET(0x19AC7800)
#define CLASS_1_5B567C8A01BAEDFE_160__CCTOR_OFFSET UNITYSDK_OFFSET(0x19AC78B0)
#define CLASS_1_5B567C8A01BAEDFE_160__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19AC75F0)
#define CLASS_1_5B567C8A01BAEDFE_160__CTOR_OFFSET UNITYSDK_OFFSET(0x19AC75E0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_160_TypeDefinitionIndex = 28046;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_160*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_160_TypeDefinitionIndex)->GetStaticField(0x5AFD0);
	}
