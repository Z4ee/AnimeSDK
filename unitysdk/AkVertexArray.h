...
#define AKVERTEXARRAY_CLONEINTOREFERENCEFROMINTPTR_OFFSET UNITYSDK_OFFSET(0x1FA280F0)
#define AKVERTEXARRAY_CREATENEWREFERENCEFROMINTPTR_OFFSET UNITYSDK_OFFSET(0x1FA280E0)
#define AKVERTEXARRAY_GET_STRUCTURESIZE_OFFSET UNITYSDK_OFFSET(0x1FA280D0)
#define AKVERTEXARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1FA28090)

inline static constexpr unsigned int AkVertexArray_TypeDefinitionIndex = 33715;
