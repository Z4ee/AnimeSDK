...
#define AKVERTEXARRAY_CLONEINTOREFERENCEFROMINTPTR_OFFSET UNITYSDK_OFFSET(0x1B6E74A0)
#define AKVERTEXARRAY_CREATENEWREFERENCEFROMINTPTR_OFFSET UNITYSDK_OFFSET(0x1B6E7450)
#define AKVERTEXARRAY_GET_STRUCTURESIZE_OFFSET UNITYSDK_OFFSET(0x1B6E73E0)
#define AKVERTEXARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6E73A0)

inline static constexpr unsigned int AkVertexArray_TypeDefinitionIndex = 42053;
