...
#define AKVERTEXARRAY_CLONEINTOREFERENCEFROMINTPTR_OFFSET UNITYSDK_OFFSET(0x1EF530B0)
#define AKVERTEXARRAY_CREATENEWREFERENCEFROMINTPTR_OFFSET UNITYSDK_OFFSET(0x1EF53060)
#define AKVERTEXARRAY_GET_STRUCTURESIZE_OFFSET UNITYSDK_OFFSET(0x1EF52FF0)
#define AKVERTEXARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF52FB0)

inline static constexpr unsigned int AkVertexArray_TypeDefinitionIndex = 43664;
