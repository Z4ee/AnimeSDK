...
#define CLASS_1_0D9C21C465475A65_METHOD_1_1B0715019949BFA3_OFFSET UNITYSDK_OFFSET(0x19CC7920)
#define CLASS_1_0D9C21C465475A65_METHOD_1_24ED6289627D7BE7_OFFSET UNITYSDK_OFFSET(0x19CC79F0)
#define CLASS_1_0D9C21C465475A65_METHOD_1_510B7E162CEE3E6C_OFFSET UNITYSDK_OFFSET(0x19CC7860)
#define CLASS_1_0D9C21C465475A65_METHOD_1_7F44CDFE2001210D_OFFSET UNITYSDK_OFFSET(0x19CC7700)
#define CLASS_1_0D9C21C465475A65_METHOD_1_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x19CC72E0)
#define CLASS_1_0D9C21C465475A65_METHOD_1_BE0A744D771D75F8_OFFSET UNITYSDK_OFFSET(0x19CC7640)
#define CLASS_1_0D9C21C465475A65_METHOD_1_FF2126F609DFC1B5_OFFSET UNITYSDK_OFFSET(0x19CC7790)

inline static constexpr unsigned int Class_1_0D9C21C465475A65_TypeDefinitionIndex = 62356;

class Class_1_0D9C21C465475A65 : public ::System::Object
{
public:
	static ::System::Collections::Generic::Dictionary_2<::RPG::GameCore::AlleyConditionType, ::Class_1_0D9C21C465475A65_Class_3_BE27BF221D2C7791*>** StaticGet_MANLKLDGKEC()
	{
		return (::System::Collections::Generic::Dictionary_2<::RPG::GameCore::AlleyConditionType, ::Class_1_0D9C21C465475A65_Class_3_BE27BF221D2C7791*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_0D9C21C465475A65_TypeDefinitionIndex)->GetStaticField(0x63360);
	}
