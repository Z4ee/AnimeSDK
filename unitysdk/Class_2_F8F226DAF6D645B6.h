...
#define CLASS_2_F8F226DAF6D645B6_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD806220)
#define CLASS_2_F8F226DAF6D645B6_METHOD_2_38E5361AAB271B31_OFFSET UNITYSDK_OFFSET(0xD806600)
#define CLASS_2_F8F226DAF6D645B6_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xD806260)
#define CLASS_2_F8F226DAF6D645B6_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xD806550)
#define CLASS_2_F8F226DAF6D645B6_TICK_OFFSET UNITYSDK_OFFSET(0xD8065A0)
#define CLASS_2_F8F226DAF6D645B6__CTOR_OFFSET UNITYSDK_OFFSET(0xD806210)
...
{
public:
	::RPG::GameCore::ModifyDefaultTeamFormation* OFKGLJOAMLD; // 0x18
