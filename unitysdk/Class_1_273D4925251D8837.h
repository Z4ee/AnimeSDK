...
#define CLASS_1_273D4925251D8837_GET_NEXTINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1627F9C0)
#define CLASS_1_273D4925251D8837_METHOD_1_2DFE974D2FEBD3E4_OFFSET UNITYSDK_OFFSET(0x1627DEE0)
#define CLASS_1_273D4925251D8837_METHOD_1_43A46E5F9FAC62B8_OFFSET UNITYSDK_OFFSET(0x1627F9E0)
#define CLASS_1_273D4925251D8837_METHOD_1_48A730878298E8F8_OFFSET UNITYSDK_OFFSET(0x1627DB70)
#define CLASS_1_273D4925251D8837_METHOD_1_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0x1627DCC0)
#define CLASS_1_273D4925251D8837_METHOD_1_87DA5EB0C040E3E5_OFFSET UNITYSDK_OFFSET(0x1627D9D0)
#define CLASS_1_273D4925251D8837_METHOD_1_88DFD67617E05BA5_OFFSET UNITYSDK_OFFSET(0x1627D810)
#define CLASS_1_273D4925251D8837_METHOD_1_8D7C7714BEF6FF15_OFFSET UNITYSDK_OFFSET(0x1627E7B0)
#define CLASS_1_273D4925251D8837_METHOD_1_A6CE5DAA2387E1E2_OFFSET UNITYSDK_OFFSET(0x1627E330)
#define CLASS_1_273D4925251D8837_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x1627D6B0)
#define CLASS_1_273D4925251D8837_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1627D7C0)
#define CLASS_1_273D4925251D8837_METHOD_1_CAB0AE3B3ACFE685_OFFSET UNITYSDK_OFFSET(0x1627E410)
#define CLASS_1_273D4925251D8837_METHOD_1_D9BFE6A940340607_OFFSET UNITYSDK_OFFSET(0x1627F850)
#define CLASS_1_273D4925251D8837_METHOD_1_E248AC4FD950B968_OFFSET UNITYSDK_OFFSET(0x1627EC80)
#define CLASS_1_273D4925251D8837_METHOD_1_E60B41B0210068CD_OFFSET UNITYSDK_OFFSET(0x1627E210)
#define CLASS_1_273D4925251D8837_METHOD_1_F9265FC7E012B3AA_OFFSET UNITYSDK_OFFSET(0x1627D570)
#define CLASS_1_273D4925251D8837_SET_NEXTINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1627F9D0)
#define CLASS_1_273D4925251D8837__CTOR_OFFSET UNITYSDK_OFFSET(0x1627F9F0)
...
public:
	...
	::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_27*>* ALCCLOKILPL; // 0x18
	::Class_2_35962C2B7535512E* PDENFEFCAGN; // 0x20
	::Class_0_16E4307DCC419505_27* MANEKNPNILP; // 0x28
	::Class_2_465A9E6CC2B0EF21* FPKJBBGNPBB; // 0x30
	::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_30*>* JEMGLDDOPFM; // 0x38
	::System::Single FIFMOFDCOKC; // 0x40
	::System::Int32 DHMPFJDBPDF; // 0x44
	::RPG::MVector2 AILIKDEBMOO; // 0x48
	::System::Boolean DLNNFPKMHLO; // 0x50
	::System::Boolean NHHALCBIMOF; // 0x51
	::System::Int32 EACDGPCDMFI; // 0x54
	::System::Int32 FDKGLFOFAJM; // 0x58
	::System::Single BKKIFNGBDAM; // 0x5C
	::System::Int32 MBKGOFAHEME; // 0x60
	::System::Single MFNEBFBIAMK; // 0x64
	::System::Int32 BNKBEOHFPLM; // 0x68
	::RPG::MVector2 HCMBEICKNCI; // 0x6C
	::System::Int32 KNLIPEKMICF; // 0x74
	::System::Single BOINDOAKOAK; // 0x78
	::System::Int32 JOOMGLOODGI; // 0x7C
	::System::Single DGONAMEFLAI; // 0x80
	::System::Single EDENKCJENDB; // 0x84
	::System::Int32 HEEIDDLIOMP; // 0x88
	::System::Int32 EOKGNNINCNM; // 0x8C
	::System::Single FPCJAMDMONB; // 0x90
	::System::Single KCHICCLINJN; // 0x94
	::RPG::MVector2 CLODCALCCFF; // 0x98
	::System::Single PGKAFGGPHMH; // 0xA0
	::System::Single MBPEINKNHAF; // 0xA4
	::RPG::Client::LittleGameShare::TeamTowersCore::TeamTowersInputActionType _NextInputAction_k__BackingField; // 0xA8
	::System::Int32 KGPAGGHKPLP; // 0xAC
