...
#define CLASS_1_937F95F9E8467C2D_CLEAR_OFFSET UNITYSDK_OFFSET(0x1583AD10)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_14CC93689192A32B_OFFSET UNITYSDK_OFFSET(0x1583B230)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_1991A7B40B7BA36D_OFFSET UNITYSDK_OFFSET(0x1583AE30)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_76BC447B9A4848CB_OFFSET UNITYSDK_OFFSET(0x1583AB60)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x1583BA40)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_907E24F785836BA0_OFFSET UNITYSDK_OFFSET(0x1583BAC0)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_976CDF5EF06E0838_OFFSET UNITYSDK_OFFSET(0x1583BB40)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x1583B600)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_A5624AB15FE32AEC_OFFSET UNITYSDK_OFFSET(0x1583B770)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_B8739D0DE156F9EB_OFFSET UNITYSDK_OFFSET(0x1583B650)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_C51EDA5D6F7FA146_OFFSET UNITYSDK_OFFSET(0x1583AE90)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x1583B6F0)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x1583B730)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1583B6B0)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_D71F1E82F429310A_OFFSET UNITYSDK_OFFSET(0x1583AA40)
#define CLASS_1_937F95F9E8467C2D__CCTOR_OFFSET UNITYSDK_OFFSET(0x1583BCD0)
#define CLASS_1_937F95F9E8467C2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1583BC80)
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_937F95F9E8467C2D_TypeDefinitionIndex)->GetStaticField(0x58070);
	}
	::RPG::GameCore::TransformComponent* NIDHDAOGNKO; // 0x10
	::Class_1_4E1996B50E2373CB* NLAEJIIDEJC; // 0x18
	::Class_1_F65DC6656DEF8159* EPMPEFJBAPM; // 0x20
	::RPG::GameCore::GameEntity* ICHEDAEHEBG; // 0x28
	::RPG::GameCore::CharacterModelComponent* OFGPBOKLGJJ; // 0x30
	::System::Collections::Generic::List_1<::Class_1_4E1996B50E2373CB*>* DPAFEHAOOGL; // 0x38
	::UnityEngine::SphereCollider* HKPKGJNFEDK; // 0x40
	::System::Single HBDJCFFDGDD; // 0x48
	::System::Single OIBEBCMDGPN; // 0x4C
	::RPG::GameCore::TimeRewindState MPGEHKEOCAK; // 0x50
	::System::Boolean MCAPIAKDMAA; // 0x54
