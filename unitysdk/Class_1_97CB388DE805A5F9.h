...
#define CLASS_1_97CB388DE805A5F9_DECONSTRUCT_OFFSET UNITYSDK_OFFSET(0xAFF4680)
#define CLASS_1_97CB388DE805A5F9_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xAFF4300)
#define CLASS_1_97CB388DE805A5F9_EQUALS_OFFSET UNITYSDK_OFFSET(0xAFF4290)
#define CLASS_1_97CB388DE805A5F9_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xAFF3F90)
#define CLASS_1_97CB388DE805A5F9_GET_EQUALITYCONTRACT_OFFSET UNITYSDK_OFFSET(0xAFF3A60)
#define CLASS_1_97CB388DE805A5F9_GET_EVENTIDS_OFFSET UNITYSDK_OFFSET(0xAFF3B30)
#define CLASS_1_97CB388DE805A5F9_GET_EXTRAMONSTERIDS_OFFSET UNITYSDK_OFFSET(0xAFF3AF0)
#define CLASS_1_97CB388DE805A5F9_GET_MAPENTRANCEID_OFFSET UNITYSDK_OFFSET(0xAFF3A90)
#define CLASS_1_97CB388DE805A5F9_GET_MAZECONFIGS_OFFSET UNITYSDK_OFFSET(0xAFF3AD0)
#define CLASS_1_97CB388DE805A5F9_GET_MAZEGROUPID_OFFSET UNITYSDK_OFFSET(0xAFF3AB0)
#define CLASS_1_97CB388DE805A5F9_GET_NPCMONSTERIDS_OFFSET UNITYSDK_OFFSET(0xAFF3B10)
#define CLASS_1_97CB388DE805A5F9_GET_RECOMMENDEDDAMAGETYPES_OFFSET UNITYSDK_OFFSET(0xAFF3B50)
#define CLASS_1_97CB388DE805A5F9_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xAFF3F70)
#define CLASS_1_97CB388DE805A5F9_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xAFF3F40)
#define CLASS_1_97CB388DE805A5F9_PRINTMEMBERS_OFFSET UNITYSDK_OFFSET(0xAFF3D40)
#define CLASS_1_97CB388DE805A5F9_SET_EVENTIDS_OFFSET UNITYSDK_OFFSET(0xAFF3B40)
#define CLASS_1_97CB388DE805A5F9_SET_EXTRAMONSTERIDS_OFFSET UNITYSDK_OFFSET(0xAFF3B00)
#define CLASS_1_97CB388DE805A5F9_SET_MAPENTRANCEID_OFFSET UNITYSDK_OFFSET(0xAFF3AA0)
#define CLASS_1_97CB388DE805A5F9_SET_MAZECONFIGS_OFFSET UNITYSDK_OFFSET(0xAFF3AE0)
#define CLASS_1_97CB388DE805A5F9_SET_MAZEGROUPID_OFFSET UNITYSDK_OFFSET(0xAFF3AC0)
#define CLASS_1_97CB388DE805A5F9_SET_NPCMONSTERIDS_OFFSET UNITYSDK_OFFSET(0xAFF3B20)
#define CLASS_1_97CB388DE805A5F9_SET_RECOMMENDEDDAMAGETYPES_OFFSET UNITYSDK_OFFSET(0xAFF3B60)
#define CLASS_1_97CB388DE805A5F9_TOSTRING_OFFSET UNITYSDK_OFFSET(0xAFF3B70)
#define CLASS_1_97CB388DE805A5F9__CLONE___OFFSET UNITYSDK_OFFSET(0xAFF45F0)
#define CLASS_1_97CB388DE805A5F9__CTOR_1_OFFSET UNITYSDK_OFFSET(0xAFF4640)
#define CLASS_1_97CB388DE805A5F9__CTOR_OFFSET UNITYSDK_OFFSET(0xAFF3A20)

inline static constexpr unsigned int Class_1_97CB388DE805A5F9_TypeDefinitionIndex = 74099;

class Class_1_97CB388DE805A5F9 : public ::System::Object
{
public:
	::System::Collections::Generic::IReadOnlyList_1<::System::UInt32>* _EventIDs_k__BackingField; // 0x10
	...
	::System::Collections::Generic::IReadOnlyList_1<::System::UInt32>* _NpcMonsterIDs_k__BackingField; // 0x28
