...
#define CLASS_1_EF7A5DF238C10B96_METHOD_1_B5EA5DD8B4C0957C_OFFSET UNITYSDK_OFFSET(0x15CF1910)
#define CLASS_1_EF7A5DF238C10B96__CTOR_OFFSET UNITYSDK_OFFSET(0x15CF1990)
...
public:
	...
	::RPG::GameCore::MoveToPositionUpdateMode HGDKNBJHDAP; // 0x18
	::RPG::MVector3 FJBPOFJPFNP; // 0x1C
