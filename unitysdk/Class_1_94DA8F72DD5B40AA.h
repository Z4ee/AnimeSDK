...
#define CLASS_1_94DA8F72DD5B40AA_METHOD_1_092E633B9CD2BE71_OFFSET UNITYSDK_OFFSET(0x1C757DC0)
#define CLASS_1_94DA8F72DD5B40AA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C757FE0)

inline static constexpr unsigned int Class_1_94DA8F72DD5B40AA_TypeDefinitionIndex = 14781;

class Class_1_94DA8F72DD5B40AA : public ::System::Object
{
public:
	::RPG::Client::TextID ANBDGFJDBPF; // 0x10
	::RPG::Client::TextID OENAMINOLLF; // 0x20
	::RPG::GameCore::RogueTournAreaGroupID JFMBIOOCPIL; // 0x30
