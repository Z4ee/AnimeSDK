...
#define CLASS_1_5E2A8BD9D2714BA0_METHOD_1_0947F577F1E5AE4F_OFFSET UNITYSDK_OFFSET(0x125B5EA0)
#define CLASS_1_5E2A8BD9D2714BA0_METHOD_1_4151B26B9E61852E_OFFSET UNITYSDK_OFFSET(0x125B5FA0)
#define CLASS_1_5E2A8BD9D2714BA0_METHOD_1_6E7B8A05F3580405_OFFSET UNITYSDK_OFFSET(0x125B5F90)
#define CLASS_1_5E2A8BD9D2714BA0_METHOD_1_8E2C129DE4FC3609_OFFSET UNITYSDK_OFFSET(0x125B5CE0)
#define CLASS_1_5E2A8BD9D2714BA0_METHOD_1_EE452B2A8AFCD109_OFFSET UNITYSDK_OFFSET(0x125B5FB0)

inline static constexpr unsigned int Class_1_5E2A8BD9D2714BA0_TypeDefinitionIndex = 43770;
...
public:
	...
	{
		return (::MoleMole::Config::ConfigMonsterAlerts**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5E2A8BD9D2714BA0_TypeDefinitionIndex)->GetStaticField(0x331D0);
	}
