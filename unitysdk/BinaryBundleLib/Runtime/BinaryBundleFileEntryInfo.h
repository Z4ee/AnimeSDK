...
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEENTRYINFO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9C9770)
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEENTRYINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x9C9760)
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEENTRYINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9C9750)
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEENTRYINFO_METHOD_2_6D0360BD23602584_OFFSET UNITYSDK_OFFSET(0x9C9960)
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEENTRYINFO_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x9C98F0)
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEENTRYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x40CF90)

namespace BinaryBundleLib::Runtime
{
	inline static constexpr unsigned int BinaryBundleFileEntryInfo_TypeDefinitionIndex = 33869;
