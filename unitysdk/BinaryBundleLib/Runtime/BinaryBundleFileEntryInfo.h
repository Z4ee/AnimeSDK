...
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEENTRYINFO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xA16030)
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEENTRYINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0xA16020)
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEENTRYINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA16010)
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEENTRYINFO_METHOD_2_6D0360BD23602584_OFFSET UNITYSDK_OFFSET(0xA16220)
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEENTRYINFO_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0xA161B0)
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEENTRYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x44F390)

namespace BinaryBundleLib::Runtime
{
	inline static constexpr unsigned int BinaryBundleFileEntryInfo_TypeDefinitionIndex = 34531;
