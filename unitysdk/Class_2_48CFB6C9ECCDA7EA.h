...
#define CLASS_2_48CFB6C9ECCDA7EA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1603F7D0)
#define CLASS_2_48CFB6C9ECCDA7EA_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1603F810)
#define CLASS_2_48CFB6C9ECCDA7EA_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1603FA00)
#define CLASS_2_48CFB6C9ECCDA7EA_TICK_OFFSET UNITYSDK_OFFSET(0x1603FA50)
#define CLASS_2_48CFB6C9ECCDA7EA__CTOR_OFFSET UNITYSDK_OFFSET(0x1603F7C0)

inline static constexpr unsigned int Class_2_48CFB6C9ECCDA7EA_TypeDefinitionIndex = 55470;

class Class_2_48CFB6C9ECCDA7EA : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::CreateLevelAreas* Field_2_0; // 0x18
