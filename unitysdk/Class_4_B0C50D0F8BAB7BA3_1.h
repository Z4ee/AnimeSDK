...
#define CLASS_4_B0C50D0F8BAB7BA3_1_CLONE_OFFSET UNITYSDK_OFFSET(0x15E22E00)
#define CLASS_4_B0C50D0F8BAB7BA3_1_METHOD_4_01D4972FD500ED86_OFFSET UNITYSDK_OFFSET(0x15E22ED0)
#define CLASS_4_B0C50D0F8BAB7BA3_1_METHOD_4_6332539B3C7FC700_OFFSET UNITYSDK_OFFSET(0x15E22990)
#define CLASS_4_B0C50D0F8BAB7BA3_1_METHOD_4_76C20C1C1323A406_OFFSET UNITYSDK_OFFSET(0x15E22BE0)
#define CLASS_4_B0C50D0F8BAB7BA3_1_METHOD_4_C256FFEE9A4AD041_OFFSET UNITYSDK_OFFSET(0x15E22A40)
#define CLASS_4_B0C50D0F8BAB7BA3_1_REVERSE_OFFSET UNITYSDK_OFFSET(0x15E22E60)
#define CLASS_4_B0C50D0F8BAB7BA3_1_STARTWITHTARGET_OFFSET UNITYSDK_OFFSET(0x15E22CA0)
#define CLASS_4_B0C50D0F8BAB7BA3_1__CTOR_OFFSET UNITYSDK_OFFSET(0x15E22BC0)

inline static constexpr unsigned int Class_4_B0C50D0F8BAB7BA3_1_TypeDefinitionIndex = 73417;

class Class_4_B0C50D0F8BAB7BA3_1 : public ::Class_3_3F1B1DE9D9F51912
{
public:
	::UnityEngine::Vector3 AJMFEHGFKNF; // 0x38
	::UnityEngine::Vector3 MMLBGFOKLCB; // 0x44
	::UnityEngine::Vector3 KICIGEMOJKB; // 0x50
