...
#define SHADERPERFTESTIRI_METHOD_5_FF8AAA1EAD899F63_OFFSET UNITYSDK_OFFSET(0x19F70BA0)
#define SHADERPERFTESTIRI_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19F716E0)
#define SHADERPERFTESTIRI_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19F70E10)
#define SHADERPERFTESTIRI__CTOR_OFFSET UNITYSDK_OFFSET(0x19F717F0)

inline static constexpr unsigned int ShaderPerfTestIRI_TypeDefinitionIndex = 45613;
...
public:
	...
	{
		return (::RPG::Client::IRIManager**)Il2CppClass::FromTypeDefinitionIndex(ShaderPerfTestIRI_TypeDefinitionIndex)->GetStaticField(0x6BA90);
	}
	::UnityEngine::Mesh* TestMesh; // 0x18
	::UnityEngine::Material* TestMat; // 0x20
	::Class_1_B947D336595B4072* Field_5_3; // 0x28
