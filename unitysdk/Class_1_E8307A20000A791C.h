...
#define CLASS_1_E8307A20000A791C_METHOD_1_0190D525C31177C7_OFFSET UNITYSDK_OFFSET(0x1612F730)
#define CLASS_1_E8307A20000A791C_METHOD_1_30E3686648EB2364_OFFSET UNITYSDK_OFFSET(0x1612FE20)
#define CLASS_1_E8307A20000A791C_METHOD_1_3B7A575DD9CEE3CE_OFFSET UNITYSDK_OFFSET(0x1612FAB0)
#define CLASS_1_E8307A20000A791C_METHOD_1_47C82DE92F8683DE_OFFSET UNITYSDK_OFFSET(0x1612FBB0)
#define CLASS_1_E8307A20000A791C__CTOR_OFFSET UNITYSDK_OFFSET(0x16130100)
...
{
public:
	::Class_3_F10D795907445CF3* EABKOHGCHFP; // 0x10
	::RPG::GameCore::TurnBasedModifierInstance* EAEJGPLLGMI; // 0x18
	::Class_1_5F51D4049EA87B7B* EKIJFPIPCKF; // 0x20
	::Class_3_07C3C4D2990C49EE* GEKIGCNCNBH; // 0x28
