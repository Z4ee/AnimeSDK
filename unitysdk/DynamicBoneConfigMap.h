...
#define DYNAMICBONECONFIGMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1F5EA410)

inline static constexpr unsigned int DynamicBoneConfigMap_TypeDefinitionIndex = 35282;
