...
#define CLASS_2_B319B4A0CF2C66A4_METHOD_2_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0x14072060)
#define CLASS_2_B319B4A0CF2C66A4_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x14071E60)
#define CLASS_2_B319B4A0CF2C66A4_METHOD_2_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x14071EB0)
#define CLASS_2_B319B4A0CF2C66A4_METHOD_2_3FDF2B060E99B28D_OFFSET UNITYSDK_OFFSET(0x14071DA0)
#define CLASS_2_B319B4A0CF2C66A4_METHOD_2_7985FB4984C2C320_OFFSET UNITYSDK_OFFSET(0x14071CD0)
#define CLASS_2_B319B4A0CF2C66A4_SYNCLOADBYTESFROMFILE_OFFSET UNITYSDK_OFFSET(0x14072570)
#define CLASS_2_B319B4A0CF2C66A4__CTOR_OFFSET UNITYSDK_OFFSET(0x14071E00)
#define CLASS_2_B319B4A0CF2C66A4__INITASSETLOADERPROVIDER_OFFSET UNITYSDK_OFFSET(0x14072290)

inline static constexpr unsigned int Class_2_B319B4A0CF2C66A4_TypeDefinitionIndex = 40135;

class Class_2_B319B4A0CF2C66A4 : public ::RPG::Client::DesignDataMgr
{
public:
	::System::Boolean JKEPCPBCKBB; // 0x80
