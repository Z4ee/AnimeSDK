...
#define MIRRORMENT_MIRRORMENTTOOL_CLASS_1_A02263FE1D25F653__CTOR_OFFSET UNITYSDK_OFFSET(0x9338750)

namespace Mirrorment
{
	inline static constexpr unsigned int MirrormentTool_Class_1_A02263FE1D25F653_TypeDefinitionIndex = 44538;

	class MirrormentTool_Class_1_A02263FE1D25F653 : public ::System::Object
	{
	public:
		::UnityEngine::GameObject* Field_1_3; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::GameObject*>* Field_1_4; // 0x18
		::RPG::Client::Prop::OpticalIllusionPuzzleItem* Field_1_1; // 0x20
		...
		::RPG::Client::Prop::OpticalIllusionAxis Field_1_2; // 0x5C
