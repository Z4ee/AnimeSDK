...
#define BONECHAIN_GET_MAXDEFORMATIONANGLE_OFFSET UNITYSDK_OFFSET(0x18BA7610)
#define BONECHAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x18BA7620)

inline static constexpr unsigned int BoneChain_TypeDefinitionIndex = 45469;
