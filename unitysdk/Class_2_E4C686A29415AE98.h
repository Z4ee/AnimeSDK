...
#define CLASS_2_E4C686A29415AE98_ISCONCERNEDWITH_OFFSET UNITYSDK_OFFSET(0x1AA44BA0)
#define CLASS_2_E4C686A29415AE98_METHOD_2_4EAC90433F8D078E_OFFSET UNITYSDK_OFFSET(0x1AA45400)
#define CLASS_2_E4C686A29415AE98_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1AA45650)
#define CLASS_2_E4C686A29415AE98_UPDATEADDROLE_OFFSET UNITYSDK_OFFSET(0x1AA454B0)
#define CLASS_2_E4C686A29415AE98_UPDATEBEFORE_OFFSET UNITYSDK_OFFSET(0x1AA44D60)
#define CLASS_2_E4C686A29415AE98_UPDATEDONE_OFFSET UNITYSDK_OFFSET(0x1AA45560)
#define CLASS_2_E4C686A29415AE98__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA456A0)

inline static constexpr unsigned int Class_2_E4C686A29415AE98_TypeDefinitionIndex = 65000;

class Class_2_E4C686A29415AE98 : public ::Class_1_41E07A9DDAB7FC78
{
public:
	::RPG::Client::GridFightEquipItemData* NDCHFDJLAML; // 0x10
	::RPG::Client::GridFightBonusResultData* ADIKIGNBDMN; // 0x18
	::RPG::Client::GridFightRole* LPNLGDLMJFM; // 0x20
	...
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_190BB2A3D431BCD2_1*))((::PBYTE)hIl2Cpp + CLASS_2_E4C686A29415AE98_UPDATEADDROLE_OFFSET))(this, a1);
	}
