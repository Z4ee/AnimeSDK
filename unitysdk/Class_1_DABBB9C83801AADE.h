...
#define CLASS_1_DABBB9C83801AADE_METHOD_1_0C29CE375C23153D_OFFSET UNITYSDK_OFFSET(0x13798370)
#define CLASS_1_DABBB9C83801AADE_METHOD_1_415752109343FC19_OFFSET UNITYSDK_OFFSET(0x137983C0)
#define CLASS_1_DABBB9C83801AADE_METHOD_1_4C9717BAC49A1DCF_OFFSET UNITYSDK_OFFSET(0x13797E30)
#define CLASS_1_DABBB9C83801AADE_METHOD_1_79830F666EE579C0_OFFSET UNITYSDK_OFFSET(0x137981D0)
#define CLASS_1_DABBB9C83801AADE_METHOD_1_96C7FAA41B688781_OFFSET UNITYSDK_OFFSET(0x13797E80)

inline static constexpr unsigned int Class_1_DABBB9C83801AADE_TypeDefinitionIndex = 43191;
...
public:
	...
	{
		return (::MoleMole::ConfigHollowChessboardEntityBehavior**)Il2CppClass::FromTypeDefinitionIndex(Class_1_DABBB9C83801AADE_TypeDefinitionIndex)->GetStaticField(0x42540);
	}
