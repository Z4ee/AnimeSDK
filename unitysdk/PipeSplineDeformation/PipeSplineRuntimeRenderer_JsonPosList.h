...
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_JSONPOSLIST_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1CC67950)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_JSONPOSLIST_TOJSON_OFFSET UNITYSDK_OFFSET(0x1CC67700)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_JSONPOSLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC676F0)

namespace PipeSplineDeformation
{
	inline static constexpr unsigned int PipeSplineRuntimeRenderer_JsonPosList_TypeDefinitionIndex = 27010;
