...
#define PIPESPLINEDEFORMATION_PIPESPLINEGPUBUFFERSET_BIND_1_OFFSET UNITYSDK_OFFSET(0x1C992A50)
#define PIPESPLINEDEFORMATION_PIPESPLINEGPUBUFFERSET_BIND_OFFSET UNITYSDK_OFFSET(0x1C992940)
#define PIPESPLINEDEFORMATION_PIPESPLINEGPUBUFFERSET_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C992EE0)
#define PIPESPLINEDEFORMATION_PIPESPLINEGPUBUFFERSET_ENSUREBUFFER_OFFSET UNITYSDK_OFFSET(0x1C9927E0)
#define PIPESPLINEDEFORMATION_PIPESPLINEGPUBUFFERSET_GET_CURVESAMPLEBUFFER_OFFSET UNITYSDK_OFFSET(0x1C991F10)
#define PIPESPLINEDEFORMATION_PIPESPLINEGPUBUFFERSET_GET_CURVESAMPLECOUNT_OFFSET UNITYSDK_OFFSET(0x1C991F30)
#define PIPESPLINEDEFORMATION_PIPESPLINEGPUBUFFERSET_GET_PIPEINSTANCEBUFFER_OFFSET UNITYSDK_OFFSET(0x1C991F20)
#define PIPESPLINEDEFORMATION_PIPESPLINEGPUBUFFERSET_GET_PIPEINSTANCECOUNT_OFFSET UNITYSDK_OFFSET(0x1C991F40)
#define PIPESPLINEDEFORMATION_PIPESPLINEGPUBUFFERSET_RELEASEBUFFER_OFFSET UNITYSDK_OFFSET(0x1C992E90)
#define PIPESPLINEDEFORMATION_PIPESPLINEGPUBUFFERSET_RELEASE_OFFSET UNITYSDK_OFFSET(0x1C992690)
#define PIPESPLINEDEFORMATION_PIPESPLINEGPUBUFFERSET_SETINSTANCEBASEINDEX_1_OFFSET UNITYSDK_OFFSET(0x1C992CF0)
#define PIPESPLINEDEFORMATION_PIPESPLINEGPUBUFFERSET_SETINSTANCEBASEINDEX_OFFSET UNITYSDK_OFFSET(0x1C992C40)
#define PIPESPLINEDEFORMATION_PIPESPLINEGPUBUFFERSET_UPLOAD_OFFSET UNITYSDK_OFFSET(0x1C991F50)
#define PIPESPLINEDEFORMATION_PIPESPLINEGPUBUFFERSET__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C992F40)
#define PIPESPLINEDEFORMATION_PIPESPLINEGPUBUFFERSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1C992F30)

namespace PipeSplineDeformation
{
	inline static constexpr unsigned int PipeSplineGpuBufferSet_TypeDefinitionIndex = 26811;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PipeSplineGpuBufferSet_TypeDefinitionIndex)->GetStaticField(0x65C0);
		}
		static ::System::Int32* StaticGet_CurveSamplesId()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PipeSplineGpuBufferSet_TypeDefinitionIndex)->GetStaticField(0x65C4);
		}
		static ::System::Int32* StaticGet_CurveSampleSpacingId()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PipeSplineGpuBufferSet_TypeDefinitionIndex)->GetStaticField(0x65C8);
		}
		static ::System::Int32* StaticGet_CurveSampleCountId()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PipeSplineGpuBufferSet_TypeDefinitionIndex)->GetStaticField(0x65CC);
		}
		static ::System::Int32* StaticGet_PipeInstancesId()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PipeSplineGpuBufferSet_TypeDefinitionIndex)->GetStaticField(0x65D0);
		}
		::UnityEngine::ComputeBuffer* curveSampleBuffer; // 0x10
		::UnityEngine::ComputeBuffer* pipeInstanceBuffer; // 0x18
		::System::Int32 curveSampleCount; // 0x20
		::System::Int32 pipeInstanceCount; // 0x24
		::System::Single curveSampleSpacing; // 0x28
