...
#define PIPESPLINEDEFORMATION_PIPESPLINEFRUSTUMCULLING_BUILDCULLGROUPS_OFFSET UNITYSDK_OFFSET(0x1B7F0520)
#define PIPESPLINEDEFORMATION_PIPESPLINEFRUSTUMCULLING_BUILDDISTANCERANGEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1B7F09E0)
#define PIPESPLINEDEFORMATION_PIPESPLINEFRUSTUMCULLING_CALCULATECAMERAPLANES_OFFSET UNITYSDK_OFFSET(0x1B7F1160)
#define PIPESPLINEDEFORMATION_PIPESPLINEFRUSTUMCULLING_EVALUATECURVEPOSITION_OFFSET UNITYSDK_OFFSET(0x1B7F1240)
#define PIPESPLINEDEFORMATION_PIPESPLINEFRUSTUMCULLING_FINDFIRSTSAMPLEATORAFTER_OFFSET UNITYSDK_OFFSET(0x1B7F16A0)
#define PIPESPLINEDEFORMATION_PIPESPLINEFRUSTUMCULLING_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x1B7F0F80)
#define PIPESPLINEDEFORMATION_PIPESPLINEFRUSTUMCULLING_TESTPLANESAABB_OFFSET UNITYSDK_OFFSET(0x1B7F11B0)

namespace PipeSplineDeformation
{
	inline static constexpr unsigned int PipeSplineFrustumCulling_TypeDefinitionIndex = 26678;
