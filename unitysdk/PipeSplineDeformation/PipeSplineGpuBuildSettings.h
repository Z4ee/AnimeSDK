...
#define PIPESPLINEDEFORMATION_PIPESPLINEGPUBUILDSETTINGS_FROMMESH_OFFSET UNITYSDK_OFFSET(0x1B06BB80)
#define PIPESPLINEDEFORMATION_PIPESPLINEGPUBUILDSETTINGS_GET_DEFAULT_OFFSET UNITYSDK_OFFSET(0x1B06BAF0)

namespace PipeSplineDeformation
{
	inline static constexpr unsigned int PipeSplineGpuBuildSettings_TypeDefinitionIndex = 26534;
