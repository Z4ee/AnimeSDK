...
#define PIPESPLINEDEFORMATION_PIPESPLINEGPUCONVERTER_ADDPIPEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1B06EDC0)
#define PIPESPLINEDEFORMATION_PIPESPLINEGPUCONVERTER_BUILDDENSESAMPLES_OFFSET UNITYSDK_OFFSET(0x1B06C680)
#define PIPESPLINEDEFORMATION_PIPESPLINEGPUCONVERTER_BUILDPARALLELTRANSPORTFRAMES_OFFSET UNITYSDK_OFFSET(0x1B06D7A0)
#define PIPESPLINEDEFORMATION_PIPESPLINEGPUCONVERTER_BUILDPIPEINSTANCES_OFFSET UNITYSDK_OFFSET(0x1B06E220)
#define PIPESPLINEDEFORMATION_PIPESPLINEGPUCONVERTER_BUILDRENDERBOUNDS_OFFSET UNITYSDK_OFFSET(0x1B06E610)
#define PIPESPLINEDEFORMATION_PIPESPLINEGPUCONVERTER_BUILD_OFFSET UNITYSDK_OFFSET(0x1B06C090)
#define PIPESPLINEDEFORMATION_PIPESPLINEGPUCONVERTER_CALCULATESAMPLECOUNT_OFFSET UNITYSDK_OFFSET(0x1B06CEC0)
#define PIPESPLINEDEFORMATION_PIPESPLINEGPUCONVERTER_ESTIMATECONTROLPOLYGONLENGTH_OFFSET UNITYSDK_OFFSET(0x1B06EB10)
#define PIPESPLINEDEFORMATION_PIPESPLINEGPUCONVERTER_REBUILDTANGENTSFROMARCSAMPLES_OFFSET UNITYSDK_OFFSET(0x1B06D490)
#define PIPESPLINEDEFORMATION_PIPESPLINEGPUCONVERTER_RESAMPLEBYDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B06CF60)
#define PIPESPLINEDEFORMATION_PIPESPLINEGPUCONVERTER_SAFENORMALIZE_OFFSET UNITYSDK_OFFSET(0x1B06EC80)

namespace PipeSplineDeformation
{
	inline static constexpr unsigned int PipeSplineGpuConverter_TypeDefinitionIndex = 26759;
