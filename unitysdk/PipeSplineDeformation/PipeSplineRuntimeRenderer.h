...
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_BUILDAPPROXIMATEINSTANCEMATRIX_OFFSET UNITYSDK_OFFSET(0x1C5A68D0)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_BUILDBOUNDSFROMSAMPLES_OFFSET UNITYSDK_OFFSET(0x1C5A47E0)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_CALCULATEAUTOTANGENT_OFFSET UNITYSDK_OFFSET(0x1C5A41F0)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_CALCULATECULLPADDING_OFFSET UNITYSDK_OFFSET(0x1C5A5390)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_CLEARDATA_OFFSET UNITYSDK_OFFSET(0x1C5A3FD0)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_DRAWFORCAMERA_OFFSET UNITYSDK_OFFSET(0x1C5A5930)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_DRAWINSTANCEDINDIRECT_OFFSET UNITYSDK_OFFSET(0x1C5A5E70)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_DRAWINSTANCEDRANGE_OFFSET UNITYSDK_OFFSET(0x1C5A64F0)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_DRAWINSTANCED_OFFSET UNITYSDK_OFFSET(0x1C5A61B0)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_GET_CURVESAMPLECOUNT_OFFSET UNITYSDK_OFFSET(0x1C5A2BA0)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_GET_DRAWMODE_OFFSET UNITYSDK_OFFSET(0x1C5A2B40)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_GET_PIPECOUNT_OFFSET UNITYSDK_OFFSET(0x1C5A2B70)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_GET_PIPEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1C5A2B20)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_GET_PIPEMESH_OFFSET UNITYSDK_OFFSET(0x1C5A29C0)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_GET_RENDERBOUNDS_OFFSET UNITYSDK_OFFSET(0x1C5A2BC0)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_GET_TOTALLENGTH_OFFSET UNITYSDK_OFFSET(0x1C5A2B60)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_GET_VISIBLEPIPECOUNT_OFFSET UNITYSDK_OFFSET(0x1C5A2B90)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_HANDLEBEGINCAMERARENDERING_OFFSET UNITYSDK_OFFSET(0x1C5A7A50)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_ISUSINGSCRIPTABLERENDERPIPELINE_OFFSET UNITYSDK_OFFSET(0x1C5A7790)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_MARKDIRTY_OFFSET UNITYSDK_OFFSET(0x1C5A2AC0)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1C5A3650)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1C5A3410)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C5A2BE0)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1C5A36A0)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_REBUILDANDUPLOAD_OFFSET UNITYSDK_OFFSET(0x1C5A52E0)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_REBUILDCULLGROUPS_OFFSET UNITYSDK_OFFSET(0x1C5A5220)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_REBUILDIFDIRTY_OFFSET UNITYSDK_OFFSET(0x1C5A2ED0)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_REGISTERCALLBACKS_OFFSET UNITYSDK_OFFSET(0x1C5A2C70)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_RELEASEGPURESOURCES_OFFSET UNITYSDK_OFFSET(0x1C5A35B0)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_RELEASEINDIRECTARGSBUFFER_OFFSET UNITYSDK_OFFSET(0x1C5A5330)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_ROTATIONFROMXAXIS_OFFSET UNITYSDK_OFFSET(0x1C5A71B0)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_SAFENORMALIZE_OFFSET UNITYSDK_OFFSET(0x1C5A7670)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_SETAUTOBEZIERFROMWORLDANCHORS_1_OFFSET UNITYSDK_OFFSET(0x1C5A3A80)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_SETAUTOBEZIERFROMWORLDANCHORS_OFFSET UNITYSDK_OFFSET(0x1C5A3A20)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_SETBAKEDDATA_1_OFFSET UNITYSDK_OFFSET(0x1C5A4CB0)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_SETBAKEDDATA_OFFSET UNITYSDK_OFFSET(0x1C5A4720)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_SETBEZIERSEGMENTS_1_OFFSET UNITYSDK_OFFSET(0x1C5A3790)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_SETBEZIERSEGMENTS_OFFSET UNITYSDK_OFFSET(0x1C5A2960)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_SET_DRAWMODE_OFFSET UNITYSDK_OFFSET(0x1C5A2B50)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_SET_PIPEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1C5A2B30)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_SET_PIPEMESH_OFFSET UNITYSDK_OFFSET(0x1C5A29D0)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_SHOULDDRAWFORCAMERA_OFFSET UNITYSDK_OFFSET(0x1C5A5E10)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_TESTPAST_OFFSET UNITYSDK_OFFSET(0x1C5A26D0)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_TRYEVALUATECURVESAMPLE_OFFSET UNITYSDK_OFFSET(0x1C5A6C80)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_UNREGISTERCALLBACKS_OFFSET UNITYSDK_OFFSET(0x1C5A3460)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_UPDATEINDIRECTARGSBUFFER_OFFSET UNITYSDK_OFFSET(0x1C5A5400)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER_UPLOADCURRENTDATA_OFFSET UNITYSDK_OFFSET(0x1C5A3360)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C5A7CD0)
#define PIPESPLINEDEFORMATION_PIPESPLINERUNTIMERENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5A7AB0)

namespace PipeSplineDeformation
{
	inline static constexpr unsigned int PipeSplineRuntimeRenderer_TypeDefinitionIndex = 27009;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PipeSplineRuntimeRenderer_TypeDefinitionIndex)->GetStaticField(0x5380);
		}
