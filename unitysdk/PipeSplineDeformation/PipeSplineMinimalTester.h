...
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_APPENDANCHOR_OFFSET UNITYSDK_OFFSET(0x1D6D3E60)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_APPLYCHILDNODEROTATIONFRAMES_OFFSET UNITYSDK_OFFSET(0x1D6D6D10)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_BUILDSEGMENTS_OFFSET UNITYSDK_OFFSET(0x1D6D6990)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_CALCULATEANCHORTANGENT_OFFSET UNITYSDK_OFFSET(0x1D6D3840)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_CALCULATEAUTOTANGENT_1_OFFSET UNITYSDK_OFFSET(0x1D6D8610)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_CALCULATEAUTOTANGENT_OFFSET UNITYSDK_OFFSET(0x1D6D6190)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_CALCULATECULLPADDING_OFFSET UNITYSDK_OFFSET(0x1D6D78E0)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_CREATEORREFRESHCHILDNODESFROMANCHORS_OFFSET UNITYSDK_OFFSET(0x1D6D5430)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_DRAWFORCAMERA_OFFSET UNITYSDK_OFFSET(0x1D6D8D10)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_DRAWINSTANCEDRANGE_OFFSET UNITYSDK_OFFSET(0x1D6D9370)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_ENSUREDEFAULTANCHORS_OFFSET UNITYSDK_OFFSET(0x1D6D2010)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_ESTIMATESEGMENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1D6D8950)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_EVALUATECURVEPOSITION_OFFSET UNITYSDK_OFFSET(0x1D6D9870)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_FINDDIRECTCHILD_OFFSET UNITYSDK_OFFSET(0x1D6D7DE0)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_FINDSEGMENTINDEX_OFFSET UNITYSDK_OFFSET(0x1D6D8A90)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_FORCEREBUILD_OFFSET UNITYSDK_OFFSET(0x1D6D6940)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_GENERATEANCHORSFROMBEZIERSEGMENTS_OFFSET UNITYSDK_OFFSET(0x1D6D4A40)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_GETANCHORWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x1D6D3670)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_GETANCHORWORLDTANGENT_OFFSET UNITYSDK_OFFSET(0x1D6D37C0)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_GETANCHORWORLDUP_OFFSET UNITYSDK_OFFSET(0x1D6D3A00)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_GETEDITORNODENAME_OFFSET UNITYSDK_OFFSET(0x1D6D7D50)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_GETHIERARCHYKEY_OFFSET UNITYSDK_OFFSET(0x1D6D9A90)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_GETSEGMENTENDTANGENT_OFFSET UNITYSDK_OFFSET(0x1D6D7AC0)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_GETSEGMENTSTARTTANGENT_OFFSET UNITYSDK_OFFSET(0x1D6D7950)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_GETTANGENTSCALE_OFFSET UNITYSDK_OFFSET(0x1D6D85B0)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_GET_ACTUALSAMPLESPACING_OFFSET UNITYSDK_OFFSET(0x1D6D1D10)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_GET_ANCHORCOUNT_OFFSET UNITYSDK_OFFSET(0x1D6D1C90)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_GET_EDITORCHILDNODES_OFFSET UNITYSDK_OFFSET(0x1D6D1CC0)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_GET_PIPECOUNT_OFFSET UNITYSDK_OFFSET(0x1D6D1CD0)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_GET_TOTALLENGTH_OFFSET UNITYSDK_OFFSET(0x1D6D1D00)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_GET_USEEDITORCHILDNODES_OFFSET UNITYSDK_OFFSET(0x1D6D1CB0)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_GET_VISIBLEPIPECOUNT_OFFSET UNITYSDK_OFFSET(0x1D6D1CF0)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_HANDLEBEGINCAMERARENDERING_OFFSET UNITYSDK_OFFSET(0x1D6D9A30)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_MARKDIRTY_OFFSET UNITYSDK_OFFSET(0x1D6D2BA0)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1D6D2EF0)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1D6D2D40)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1D6D9C80)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D6D1F40)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1D6D2F50)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_REBUILDCULLGROUPS_OFFSET UNITYSDK_OFFSET(0x1D6D7810)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_REBUILDIFDIRTY_OFFSET UNITYSDK_OFFSET(0x1D6D3290)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_REFRESHEDITORCHILDNODELIST_OFFSET UNITYSDK_OFFSET(0x1D6D66C0)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_REGISTERCALLBACKS_OFFSET UNITYSDK_OFFSET(0x1D6D2BF0)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_REMOVELASTANCHOR_OFFSET UNITYSDK_OFFSET(0x1D6D40D0)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_RESETANCHORS_OFFSET UNITYSDK_OFFSET(0x1D6D1D70)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_RESET_OFFSET UNITYSDK_OFFSET(0x1D6D1D20)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_ROTATIONFROMAXES_OFFSET UNITYSDK_OFFSET(0x1D6D80F0)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_SAFENORMALIZE_OFFSET UNITYSDK_OFFSET(0x1D6D7C30)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_SETANCHORWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x1D6D3CF0)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_SETAUTOBEZIERFROMWORLDANCHORS_1_OFFSET UNITYSDK_OFFSET(0x1D6D5BA0)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_SETAUTOBEZIERFROMWORLDANCHORS_OFFSET UNITYSDK_OFFSET(0x1D6D5B40)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_SETBEZIERSEGMENTS_1_OFFSET UNITYSDK_OFFSET(0x1D6D46D0)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_SETBEZIERSEGMENTS_OFFSET UNITYSDK_OFFSET(0x1D6D4670)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_SETEDITORCHILDNODES_OFFSET UNITYSDK_OFFSET(0x1D6D42C0)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_SETUSEEDITORCHILDNODES_OFFSET UNITYSDK_OFFSET(0x1D6D41C0)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_SYNCANCHORSFROMEDITORCHILDNODES_OFFSET UNITYSDK_OFFSET(0x1D6D2070)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_SYNCEDITORCHILDNODESONINTERVAL_OFFSET UNITYSDK_OFFSET(0x1D6D3200)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_TRYSETEDITORONLYTAG_OFFSET UNITYSDK_OFFSET(0x1D6D8000)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_UNREGISTERCALLBACKS_OFFSET UNITYSDK_OFFSET(0x1D6D2DA0)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1D6D3080)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D6DA0A0)
#define PIPESPLINEDEFORMATION_PIPESPLINEMINIMALTESTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6D9DE0)

namespace PipeSplineDeformation
{
	inline static constexpr unsigned int PipeSplineMinimalTester_TypeDefinitionIndex = 27714;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PipeSplineMinimalTester_TypeDefinitionIndex)->GetStaticField(0x6E30);
		}
