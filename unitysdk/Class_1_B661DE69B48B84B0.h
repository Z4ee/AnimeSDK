...
#define CLASS_1_B661DE69B48B84B0_METHOD_1_2DE13BE11F24F545_OFFSET UNITYSDK_OFFSET(0x128748B0)
#define CLASS_1_B661DE69B48B84B0_METHOD_1_92E298F85CD1081D_OFFSET UNITYSDK_OFFSET(0x128743F0)
#define CLASS_1_B661DE69B48B84B0_METHOD_1_ABDF6914795CF7E3_OFFSET UNITYSDK_OFFSET(0x128742C0)
#define CLASS_1_B661DE69B48B84B0_METHOD_1_D00CA09B6254F1ED_OFFSET UNITYSDK_OFFSET(0x128745F0)
#define CLASS_1_B661DE69B48B84B0_ONPLUGININIT_OFFSET UNITYSDK_OFFSET(0x12873E90)
#define CLASS_1_B661DE69B48B84B0_ONPLUGINUNINIT_OFFSET UNITYSDK_OFFSET(0x12873FC0)
#define CLASS_1_B661DE69B48B84B0__CTOR_OFFSET UNITYSDK_OFFSET(0x12874A40)

inline static constexpr unsigned int Class_1_B661DE69B48B84B0_TypeDefinitionIndex = 54539;

class Class_1_B661DE69B48B84B0 : public ::System::Object
{
public:
	// static const ::System::String* DHBECPGJIDH; // 0x0
	// static const ::System::String* DLCHOBHHLJO; // 0x0
	// static const ::System::String* JNKABLCGNCC; // 0x0
	::RPG::GameCore::GameWorld* IMMBMILPPFB; // 0x10
	::Class_1_D8203AFB32E9259C* JGAGMFENBHA; // 0x18
	::Class_1_12210BFF9F8CB0CA* MEKMJHBBAIB; // 0x20
	::System::Boolean BFJAPBAAGFI; // 0x28
