...
inline static constexpr unsigned int Struct_2_477156017493A5B9_TypeDefinitionIndex = 76118;

struct alignas(8) Struct_2_477156017493A5B9
{
	::Foundation::ReadOnlyNativeVariableArray_1<::Struct_2_85121BFD79A0E193> Field_2_3; // 0x10
	::System::Single Field_2_2; // 0x20
	::System::Single Field_2_1; // 0x24
	::UnityEngine::Vector3 Field_2_0; // 0x28
	::Struct_2_4D1ACF3BA3E010AE Field_2_7; // 0x34
	::System::Single Field_2_6; // 0x3C
	::System::Single Field_2_5; // 0x40
	::Foundation::ReadOnlyNativeVariableArray_1<::Struct_2_4D1ACF3BA3E010AE> Field_2_4; // 0x48
