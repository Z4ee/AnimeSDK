...
#define CLASS_1_EA02AD81FF55A3CC_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C8E3660)
#define CLASS_1_EA02AD81FF55A3CC_CLONE_OFFSET UNITYSDK_OFFSET(0x1C8E3080)
#define CLASS_1_EA02AD81FF55A3CC_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C8E3310)
#define CLASS_1_EA02AD81FF55A3CC_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C8E3160)
#define CLASS_1_EA02AD81FF55A3CC_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C8E3490)
#define CLASS_1_EA02AD81FF55A3CC_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C8E37C0)
#define CLASS_1_EA02AD81FF55A3CC_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C8E3730)
#define CLASS_1_EA02AD81FF55A3CC_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1C8E3120)
#define CLASS_1_EA02AD81FF55A3CC_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C8E2F90)
#define CLASS_1_EA02AD81FF55A3CC_METHOD_1_686CBC4FBD0AAA58_OFFSET UNITYSDK_OFFSET(0x1C8E3150)
#define CLASS_1_EA02AD81FF55A3CC_METHOD_1_6BD2A2909D8CFAD3_OFFSET UNITYSDK_OFFSET(0x1C8E3140)
#define CLASS_1_EA02AD81FF55A3CC_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1C8E3130)
#define CLASS_1_EA02AD81FF55A3CC_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C8E2FF0)
#define CLASS_1_EA02AD81FF55A3CC_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C8E3520)
#define CLASS_1_EA02AD81FF55A3CC_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C8E3580)
#define CLASS_1_EA02AD81FF55A3CC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C8E3980)
#define CLASS_1_EA02AD81FF55A3CC__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C8E3010)
#define CLASS_1_EA02AD81FF55A3CC__CTOR_OFFSET UNITYSDK_OFFSET(0x1C8E3000)

inline static constexpr unsigned int Class_1_EA02AD81FF55A3CC_TypeDefinitionIndex = 25483;

class Class_1_EA02AD81FF55A3CC : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_EA02AD81FF55A3CC*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_EA02AD81FF55A3CC*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_EA02AD81FF55A3CC_TypeDefinitionIndex)->GetStaticField(0x2E940);
	}
