...
#define SCREENSPACEQUADRENDERER_GENERATEQUADMESH_OFFSET UNITYSDK_OFFSET(0x18E293B0)
#define SCREENSPACEQUADRENDERER_GETPROJECTEDWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x18E2ACB0)
#define SCREENSPACEQUADRENDERER_INIT_OFFSET UNITYSDK_OFFSET(0x18E2A230)
#define SCREENSPACEQUADRENDERER_ONBEGINCAMERARENDERING_OFFSET UNITYSDK_OFFSET(0x18E29350)
#define SCREENSPACEQUADRENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18E29300)
#define SCREENSPACEQUADRENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18E291E0)
#define SCREENSPACEQUADRENDERER_REGISTERRENDERING_OFFSET UNITYSDK_OFFSET(0x18E29230)
#define SCREENSPACEQUADRENDERER_SETUPTARGET_OFFSET UNITYSDK_OFFSET(0x18E2A1E0)
#define SCREENSPACEQUADRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x18E2AE20)

inline static constexpr unsigned int ScreenSpaceQuadRenderer_TypeDefinitionIndex = 67956;
