...
#define CLASS_2_CABDFFBB96465EA6_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17C70630)
#define CLASS_2_CABDFFBB96465EA6_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17C70670)
#define CLASS_2_CABDFFBB96465EA6_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17C70AD0)
#define CLASS_2_CABDFFBB96465EA6_TICK_OFFSET UNITYSDK_OFFSET(0x17C70B20)
#define CLASS_2_CABDFFBB96465EA6__CTOR_OFFSET UNITYSDK_OFFSET(0x17C70620)

inline static constexpr unsigned int Class_2_CABDFFBB96465EA6_TypeDefinitionIndex = 52771;

class Class_2_CABDFFBB96465EA6 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::RadialBlurCurveEffect* Field_2_1; // 0x20
