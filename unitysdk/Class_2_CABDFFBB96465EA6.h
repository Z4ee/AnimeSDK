...
#define CLASS_2_CABDFFBB96465EA6_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10C93060)
#define CLASS_2_CABDFFBB96465EA6_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10C930A0)
#define CLASS_2_CABDFFBB96465EA6_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10C93410)
#define CLASS_2_CABDFFBB96465EA6_TICK_OFFSET UNITYSDK_OFFSET(0x10C93460)
#define CLASS_2_CABDFFBB96465EA6__CTOR_OFFSET UNITYSDK_OFFSET(0x10C93050)

inline static constexpr unsigned int Class_2_CABDFFBB96465EA6_TypeDefinitionIndex = 44245;

class Class_2_CABDFFBB96465EA6 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::RadialBlurCurveEffect* Field_2_0; // 0x18
