...
#define CLASS_1_411C76A6422C8F62_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC0B0240)
#define CLASS_1_411C76A6422C8F62_METHOD_1_0EAFE72DD9AA7D3A_OFFSET UNITYSDK_OFFSET(0xC0B0150)
#define CLASS_1_411C76A6422C8F62_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0xC0AF470)
#define CLASS_1_411C76A6422C8F62_METHOD_1_4B5F926BE68F2FC6_OFFSET UNITYSDK_OFFSET(0xC0AF480)
#define CLASS_1_411C76A6422C8F62_METHOD_1_4E33F9FBA4DC33F2_OFFSET UNITYSDK_OFFSET(0xC0AF8B0)
#define CLASS_1_411C76A6422C8F62_METHOD_1_5B17C4B976530A33_1_OFFSET UNITYSDK_OFFSET(0xC0AF4A0)
#define CLASS_1_411C76A6422C8F62_METHOD_1_5B17C4B976530A33_2_OFFSET UNITYSDK_OFFSET(0xC0AF4C0)
#define CLASS_1_411C76A6422C8F62_METHOD_1_5B17C4B976530A33_3_OFFSET UNITYSDK_OFFSET(0xC0AF4D0)
#define CLASS_1_411C76A6422C8F62_METHOD_1_5B17C4B976530A33_OFFSET UNITYSDK_OFFSET(0xC0AF490)
#define CLASS_1_411C76A6422C8F62_METHOD_1_6B2FF0308F7D3BFA_OFFSET UNITYSDK_OFFSET(0xC0AF4E0)
#define CLASS_1_411C76A6422C8F62_METHOD_1_735EE20B25F86BF4_OFFSET UNITYSDK_OFFSET(0xC0B00E0)
#define CLASS_1_411C76A6422C8F62_METHOD_1_8894E534FED3129C_OFFSET UNITYSDK_OFFSET(0xC0AF990)
#define CLASS_1_411C76A6422C8F62_METHOD_1_89EF21CA0414B145_OFFSET UNITYSDK_OFFSET(0xC0AFEB0)
#define CLASS_1_411C76A6422C8F62_METHOD_1_90B52FBF1D025FEC_OFFSET UNITYSDK_OFFSET(0xC0AF4B0)
#define CLASS_1_411C76A6422C8F62_METHOD_1_C1E0405EEC95DC65_OFFSET UNITYSDK_OFFSET(0xC0AF9F0)
#define CLASS_1_411C76A6422C8F62_METHOD_1_D001E91AEC8A16BE_OFFSET UNITYSDK_OFFSET(0xC0AFE50)
#define CLASS_1_411C76A6422C8F62_METHOD_1_D6004C962CEB957B_OFFSET UNITYSDK_OFFSET(0xC0AF6D0)
#define CLASS_1_411C76A6422C8F62_METHOD_1_EB12C4C03B306C03_OFFSET UNITYSDK_OFFSET(0xC0B01C0)
#define CLASS_1_411C76A6422C8F62__CTOR_OFFSET UNITYSDK_OFFSET(0xC0AF5E0)

inline static constexpr unsigned int Class_1_411C76A6422C8F62_TypeDefinitionIndex = 63129;

class Class_1_411C76A6422C8F62 : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::UnityChan::SpringCollider*>* Field_1_7; // 0x10
	::System::Collections::Generic::List_1<::UnityEngine::Transform*>* Field_1_9; // 0x18
	::System::Collections::Generic::List_1<::UnityEngine::Transform*>* Field_1_5; // 0x20
	::RootMotion::IKJob::IKThreadProxyContext* Field_1_4; // 0x28
	::System::Collections::Generic::List_1<::UnityEngine::Transform*>* Field_1_8; // 0x30
	::Class_1_43BD383C98B4C0C5_147* Field_1_3; // 0x38
	::System::Collections::Generic::List_1<::UnityEngine::Transform*>* Field_1_6; // 0x40
