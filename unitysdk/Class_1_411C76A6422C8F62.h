...
#define CLASS_1_411C76A6422C8F62_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB7FB520)
#define CLASS_1_411C76A6422C8F62_METHOD_1_1092C5537716905B_OFFSET UNITYSDK_OFFSET(0xB7FB0E0)
#define CLASS_1_411C76A6422C8F62_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0xB7FA730)
#define CLASS_1_411C76A6422C8F62_METHOD_1_464B80C09A37526F_OFFSET UNITYSDK_OFFSET(0xB7FB140)
#define CLASS_1_411C76A6422C8F62_METHOD_1_4B5F926BE68F2FC6_OFFSET UNITYSDK_OFFSET(0xB7FA740)
#define CLASS_1_411C76A6422C8F62_METHOD_1_4E33F9FBA4DC33F2_OFFSET UNITYSDK_OFFSET(0xB7FAB50)
#define CLASS_1_411C76A6422C8F62_METHOD_1_5B17C4B976530A33_1_OFFSET UNITYSDK_OFFSET(0xB7FA760)
#define CLASS_1_411C76A6422C8F62_METHOD_1_5B17C4B976530A33_2_OFFSET UNITYSDK_OFFSET(0xB7FA780)
#define CLASS_1_411C76A6422C8F62_METHOD_1_5B17C4B976530A33_3_OFFSET UNITYSDK_OFFSET(0xB7FA790)
#define CLASS_1_411C76A6422C8F62_METHOD_1_5B17C4B976530A33_OFFSET UNITYSDK_OFFSET(0xB7FA750)
#define CLASS_1_411C76A6422C8F62_METHOD_1_6B2FF0308F7D3BFA_OFFSET UNITYSDK_OFFSET(0xB7FA7A0)
#define CLASS_1_411C76A6422C8F62_METHOD_1_70484F0C4668EBF2_OFFSET UNITYSDK_OFFSET(0xB7FB4B0)
#define CLASS_1_411C76A6422C8F62_METHOD_1_735EE20B25F86BF4_OFFSET UNITYSDK_OFFSET(0xB7FB3D0)
#define CLASS_1_411C76A6422C8F62_METHOD_1_90B52FBF1D025FEC_OFFSET UNITYSDK_OFFSET(0xB7FA770)
#define CLASS_1_411C76A6422C8F62_METHOD_1_971DAF87368385CC_OFFSET UNITYSDK_OFFSET(0xB7FB440)
#define CLASS_1_411C76A6422C8F62_METHOD_1_C1E0405EEC95DC65_OFFSET UNITYSDK_OFFSET(0xB7FAC90)
#define CLASS_1_411C76A6422C8F62_METHOD_1_D6004C962CEB957B_OFFSET UNITYSDK_OFFSET(0xB7FA980)
#define CLASS_1_411C76A6422C8F62_METHOD_1_F0F8DE036FE283F6_OFFSET UNITYSDK_OFFSET(0xB7FAC30)
#define CLASS_1_411C76A6422C8F62__CTOR_OFFSET UNITYSDK_OFFSET(0xB7FA890)
...
{
public:
	::Class_1_43BD383C98B4C0C5_180* APPIHABBCGK; // 0x10
	::RootMotion::IKJob::IKThreadProxyContext* EEFMDEHLLFI; // 0x18
	::System::Collections::Generic::List_1<::UnityEngine::Transform*>* JLMMLHEOMJB; // 0x20
	::System::Collections::Generic::List_1<::UnityEngine::Transform*>* CMLADIHAHAK; // 0x28
	::System::Collections::Generic::List_1<::UnityEngine::Transform*>* OKCAKGNICCG; // 0x30
