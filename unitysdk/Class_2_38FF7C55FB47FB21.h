...
#define CLASS_2_38FF7C55FB47FB21_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x140E0600)
#define CLASS_2_38FF7C55FB47FB21_FROMFLX_OFFSET UNITYSDK_OFFSET(0x140DFE40)
#define CLASS_2_38FF7C55FB47FB21_METHOD_2_03C4FFAD29DE0852_OFFSET UNITYSDK_OFFSET(0x140DF2F0)
#define CLASS_2_38FF7C55FB47FB21_METHOD_2_0B2CB6A77D912E66_OFFSET UNITYSDK_OFFSET(0x140E0C20)
#define CLASS_2_38FF7C55FB47FB21_METHOD_2_0BD393E566CD3D4A_OFFSET UNITYSDK_OFFSET(0x140DFEC0)
#define CLASS_2_38FF7C55FB47FB21_METHOD_2_5C90773220FA8136_OFFSET UNITYSDK_OFFSET(0x140DFC40)
#define CLASS_2_38FF7C55FB47FB21_METHOD_2_82F37E818D9FE609_OFFSET UNITYSDK_OFFSET(0x140E0660)
#define CLASS_2_38FF7C55FB47FB21_METHOD_2_C444D4C8B9D548AF_OFFSET UNITYSDK_OFFSET(0x140DFDD0)
#define CLASS_2_38FF7C55FB47FB21_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x140E0B90)
#define CLASS_2_38FF7C55FB47FB21_METHOD_2_D4943D8F67F4699C_OFFSET UNITYSDK_OFFSET(0x140E0A30)
#define CLASS_2_38FF7C55FB47FB21_METHOD_2_D8A163211C06267F_OFFSET UNITYSDK_OFFSET(0x140DFCD0)
#define CLASS_2_38FF7C55FB47FB21__CTOR_OFFSET UNITYSDK_OFFSET(0x140E0990)

inline static constexpr unsigned int Class_2_38FF7C55FB47FB21_TypeDefinitionIndex = 49996;

class Class_2_38FF7C55FB47FB21 : public ::Class_1_8088D8743C1058EF
{
public:
	::Struct_2_2EF7AC7A6C04963E<::System::String*> Field_2_1; // 0x30
	::Struct_2_2EF7AC7A6C04963E<::UnityEngine::Vector3> Field_2_3; // 0x50
	::Struct_2_2EF7AC7A6C04963E<::System::String*> Field_2_2; // 0x70
