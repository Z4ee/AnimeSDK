...
#define CLASS_2_38FF7C55FB47FB21_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1191F7C0)
#define CLASS_2_38FF7C55FB47FB21_FROMFLX_OFFSET UNITYSDK_OFFSET(0x1191F020)
#define CLASS_2_38FF7C55FB47FB21_METHOD_2_03C4FFAD29DE0852_OFFSET UNITYSDK_OFFSET(0x1191E4F0)
#define CLASS_2_38FF7C55FB47FB21_METHOD_2_0B2CB6A77D912E66_OFFSET UNITYSDK_OFFSET(0x1191FBF0)
#define CLASS_2_38FF7C55FB47FB21_METHOD_2_0BD393E566CD3D4A_OFFSET UNITYSDK_OFFSET(0x1191F0A0)
#define CLASS_2_38FF7C55FB47FB21_METHOD_2_5C90773220FA8136_OFFSET UNITYSDK_OFFSET(0x1191EE80)
#define CLASS_2_38FF7C55FB47FB21_METHOD_2_82F37E818D9FE609_OFFSET UNITYSDK_OFFSET(0x1191F820)
#define CLASS_2_38FF7C55FB47FB21_METHOD_2_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x1191F010)
#define CLASS_2_38FF7C55FB47FB21_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1191FDA0)
#define CLASS_2_38FF7C55FB47FB21_METHOD_2_D4943D8F67F4699C_OFFSET UNITYSDK_OFFSET(0x1191FE30)
#define CLASS_2_38FF7C55FB47FB21_METHOD_2_D8A163211C06267F_OFFSET UNITYSDK_OFFSET(0x1191EF10)
#define CLASS_2_38FF7C55FB47FB21__CTOR_OFFSET UNITYSDK_OFFSET(0x1191FB50)

inline static constexpr unsigned int Class_2_38FF7C55FB47FB21_TypeDefinitionIndex = 42643;

class Class_2_38FF7C55FB47FB21 : public ::Class_1_8088D8743C1058EF
{
public:
	::Struct_2_2EF7AC7A6C04963E<::UnityEngine::Vector3> Field_2_5; // 0x30
	::Class_1_ED5EE319EA265EB6* Field_2_0; // 0x50
	::Struct_2_2EF7AC7A6C04963E<::System::String*> Field_2_7; // 0x58
	::Struct_2_2EF7AC7A6C04963E<::System::String*> Field_2_6; // 0x78
	...
	{
		return ((::System::Int32(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_38FF7C55FB47FB21_METHOD_2_C74CF020AA42ED85_OFFSET))(this);
	}
