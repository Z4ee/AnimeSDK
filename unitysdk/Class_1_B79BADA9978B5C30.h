...
#define CLASS_1_B79BADA9978B5C30_GET_ID_OFFSET UNITYSDK_OFFSET(0x18520520)
#define CLASS_1_B79BADA9978B5C30_METHOD_1_18A5053E0B8194D7_OFFSET UNITYSDK_OFFSET(0x18520330)
#define CLASS_1_B79BADA9978B5C30_METHOD_1_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x1851FEC0)
#define CLASS_1_B79BADA9978B5C30_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x18520590)
#define CLASS_1_B79BADA9978B5C30_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x1851FF50)
#define CLASS_1_B79BADA9978B5C30_METHOD_1_343609514F0B1F13_OFFSET UNITYSDK_OFFSET(0x1851FA50)
#define CLASS_1_B79BADA9978B5C30_METHOD_1_38B862BB2192EC08_OFFSET UNITYSDK_OFFSET(0x18520540)
#define CLASS_1_B79BADA9978B5C30_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x185204C0)
#define CLASS_1_B79BADA9978B5C30_METHOD_1_749948B663FCCCEF_OFFSET UNITYSDK_OFFSET(0x185202E0)
#define CLASS_1_B79BADA9978B5C30_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x18520470)
#define CLASS_1_B79BADA9978B5C30_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x18520430)
#define CLASS_1_B79BADA9978B5C30_METHOD_1_E67B8EE7D04609D0_1_OFFSET UNITYSDK_OFFSET(0x18520230)
#define CLASS_1_B79BADA9978B5C30_METHOD_1_E67B8EE7D04609D0_OFFSET UNITYSDK_OFFSET(0x18520180)
#define CLASS_1_B79BADA9978B5C30_METHOD_1_F7BA13C72A6B3F58_OFFSET UNITYSDK_OFFSET(0x18520080)
#define CLASS_1_B79BADA9978B5C30_ONSELECT_OFFSET UNITYSDK_OFFSET(0x1851FFD0)
#define CLASS_1_B79BADA9978B5C30_SET_ID_OFFSET UNITYSDK_OFFSET(0x18520530)
#define CLASS_1_B79BADA9978B5C30__CCTOR_OFFSET UNITYSDK_OFFSET(0x185205F0)
#define CLASS_1_B79BADA9978B5C30__CTOR_OFFSET UNITYSDK_OFFSET(0x1851FA40)

inline static constexpr unsigned int Class_1_B79BADA9978B5C30_TypeDefinitionIndex = 75287;

class Class_1_B79BADA9978B5C30 : public ::System::Object
{
public:
	static ::System::Int32* StaticGet_NEMOBIGKIBF()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_B79BADA9978B5C30_TypeDefinitionIndex)->GetStaticField(0x12BB0);
	}
	static ::System::Int32* StaticGet_NLOLPLEPBBP()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_B79BADA9978B5C30_TypeDefinitionIndex)->GetStaticField(0x12BB4);
	}
	static ::System::Int32* StaticGet_BAJIOAFNFDJ()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_B79BADA9978B5C30_TypeDefinitionIndex)->GetStaticField(0x12BB8);
	}
	::UnityEngine::Animator* APPGGMLEPLN; // 0x10
	::UnityEngine::MeshRenderer* GFEHCONCNCA; // 0x18
	::UnityEngine::GameObject* GOHBMPGIIDE; // 0x20
	::UnityEngine::Transform* GMKJFNDIBLN; // 0x28
	::System::Action* MPKAFEJFNKN; // 0x30
	::UnityEngine::GameObject* GKNBCPMJHMN; // 0x38
	::System::UInt32 _ID_k__BackingField; // 0x40
	::System::Boolean FHBNNGCEPFD; // 0x44
	::System::Nullable_1<::UnityEngine::Rect> PKLIOOJEGJO; // 0x48
