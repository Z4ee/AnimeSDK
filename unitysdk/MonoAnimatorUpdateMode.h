...
#define MONOANIMATORUPDATEMODE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1950CCF0)
#define MONOANIMATORUPDATEMODE_GET_AVATARANIMATOR_OFFSET UNITYSDK_OFFSET(0x1950CB30)
#define MONOANIMATORUPDATEMODE_UPDATEMANUAL_OFFSET UNITYSDK_OFFSET(0x1950CEA0)
#define MONOANIMATORUPDATEMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1950D060)

inline static constexpr unsigned int MonoAnimatorUpdateMode_TypeDefinitionIndex = 57691;
