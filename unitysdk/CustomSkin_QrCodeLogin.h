...
#define CUSTOMSKIN_QRCODELOGIN_GENQRENTERICON_OFFSET UNITYSDK_OFFSET(0x13A68D30)
#define CUSTOMSKIN_QRCODELOGIN_INITDYNAMICSHOWELEMENTS_OFFSET UNITYSDK_OFFSET(0x13A68400)
#define CUSTOMSKIN_QRCODELOGIN_INITPERSISTENCHECK_OFFSET UNITYSDK_OFFSET(0x13A68F30)
#define CUSTOMSKIN_QRCODELOGIN_INIT_OFFSET UNITYSDK_OFFSET(0x13A67390)
#define CUSTOMSKIN_QRCODELOGIN_INSTANCE_OFFSET UNITYSDK_OFFSET(0x13A66FE0)
#define CUSTOMSKIN_QRCODELOGIN_ONCLICKCLOSE_OFFSET UNITYSDK_OFFSET(0x13A691B0)
#define CUSTOMSKIN_QRCODELOGIN_ONCLICKFAILREFRESH_OFFSET UNITYSDK_OFFSET(0x13A699B0)
#define CUSTOMSKIN_QRCODELOGIN_ONCLICKOVERDUEREFRESH_OFFSET UNITYSDK_OFFSET(0x13A698B0)
#define CUSTOMSKIN_QRCODELOGIN_ONCLICKPC_OFFSET UNITYSDK_OFFSET(0x13A69230)
#define CUSTOMSKIN_QRCODELOGIN_ONCLICKPERSISTENCHECK_OFFSET UNITYSDK_OFFSET(0x13A692B0)
#define CUSTOMSKIN_QRCODELOGIN_ONCLICKSUCCESSSWITCH_OFFSET UNITYSDK_OFFSET(0x13A69930)
#define CUSTOMSKIN_QRCODELOGIN_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x13A678E0)
#define CUSTOMSKIN_QRCODELOGIN_ONELEMENTSTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0x13A68300)
#define CUSTOMSKIN_QRCODELOGIN_ONENTERPCSWITCH_OFFSET UNITYSDK_OFFSET(0x13A69480)
#define CUSTOMSKIN_QRCODELOGIN_ONEXITPCSWITCH_OFFSET UNITYSDK_OFFSET(0x13A69590)
#define CUSTOMSKIN_QRCODELOGIN_ONHIDEELEMENT_OFFSET UNITYSDK_OFFSET(0x13A67D80)
#define CUSTOMSKIN_QRCODELOGIN_ONSHOWELEMENT_OFFSET UNITYSDK_OFFSET(0x13A67A10)
#define CUSTOMSKIN_QRCODELOGIN_ONSHOW_OFFSET UNITYSDK_OFFSET(0x13A671A0)
#define CUSTOMSKIN_QRCODELOGIN_REFRESHBTNSTATE_OFFSET UNITYSDK_OFFSET(0x13A67DE0)
#define CUSTOMSKIN_QRCODELOGIN_SHOWELEMENT_OFFSET UNITYSDK_OFFSET(0x13A67A70)
#define CUSTOMSKIN_QRCODELOGIN_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x13A695F0)
#define CUSTOMSKIN_QRCODELOGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x13A67110)
#define CUSTOMSKIN_QRCODELOGIN___BASE_ONELEMENTSTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0x13A69A30)
#define CUSTOMSKIN_QRCODELOGIN___BASE_ONHIDEELEMENT_OFFSET UNITYSDK_OFFSET(0x13A69A40)
#define CUSTOMSKIN_QRCODELOGIN___BASE_ONSHOWELEMENT_OFFSET UNITYSDK_OFFSET(0x13A69A50)

inline static constexpr unsigned int CustomSkin_QrCodeLogin_TypeDefinitionIndex = 55460;
...
public:
	...
	{
		return (::CustomSkin_QrCodeLogin**)Il2CppClass::FromTypeDefinitionIndex(CustomSkin_QrCodeLogin_TypeDefinitionIndex)->GetStaticField(0x2A860);
	}
	::System::Collections::Generic::Dictionary_2<::System::String*, ::QREnterIcon>* enterIconDict; // 0x18
	::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::GameObject*>* dynamicElementDict; // 0x20
	::MoleMole::UIGeneralLoginQRCodeDialogPopWindowController* _qrDialog; // 0x28
	::Class_2_7B15B3118FE590CD_6* _view; // 0x30
	...
	::QREnterIcon GenQREnterIcon(::System::String* elementName, ::Class_2_7B15B3118FE590CD_6_Class_2_FCBF41D0BBD215F7* appIconView, ::System::Boolean created, ::System::String* tipTextKey)
	{
		return ((::QREnterIcon(*)(::PVOID, ::System::String*, ::Class_2_7B15B3118FE590CD_6_Class_2_FCBF41D0BBD215F7*, ::System::Boolean, ::System::String*))((::PBYTE)hIl2Cpp + CUSTOMSKIN_QRCODELOGIN_GENQRENTERICON_OFFSET))(this, elementName, appIconView, created, tipTextKey);
	}
