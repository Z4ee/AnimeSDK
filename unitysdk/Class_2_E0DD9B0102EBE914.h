...
#define CLASS_2_E0DD9B0102EBE914_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1542B410)
#define CLASS_2_E0DD9B0102EBE914_METHOD_2_5C715D615BCEF8BF_OFFSET UNITYSDK_OFFSET(0x1542B300)
#define CLASS_2_E0DD9B0102EBE914_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1542B1D0)
#define CLASS_2_E0DD9B0102EBE914_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1542B3C0)
#define CLASS_2_E0DD9B0102EBE914_TICK_OFFSET UNITYSDK_OFFSET(0x1542B450)
#define CLASS_2_E0DD9B0102EBE914__CTOR_OFFSET UNITYSDK_OFFSET(0x1542B1C0)
...
{
public:
	::RPG::GameCore::MonopolyTriggerMoveToNextMap* OFKGLJOAMLD; // 0x18
