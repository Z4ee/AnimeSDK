...
#define CLASS_2_48AF17AAEE2DD1C0_DISPOSE_OFFSET UNITYSDK_OFFSET(0x134DF560)
#define CLASS_2_48AF17AAEE2DD1C0_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x134DF5A0)
#define CLASS_2_48AF17AAEE2DD1C0_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x134DFA10)
#define CLASS_2_48AF17AAEE2DD1C0_TICK_OFFSET UNITYSDK_OFFSET(0x134DFA60)
#define CLASS_2_48AF17AAEE2DD1C0__CTOR_OFFSET UNITYSDK_OFFSET(0x134DF550)
...
{
public:
	::RPG::GameCore::SpeedLineEffect* OFKGLJOAMLD; // 0x18
