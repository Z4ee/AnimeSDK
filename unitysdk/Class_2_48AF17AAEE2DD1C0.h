...
#define CLASS_2_48AF17AAEE2DD1C0_DISPOSE_OFFSET UNITYSDK_OFFSET(0x12ABED60)
#define CLASS_2_48AF17AAEE2DD1C0_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x12ABEDA0)
#define CLASS_2_48AF17AAEE2DD1C0_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x12ABF150)
#define CLASS_2_48AF17AAEE2DD1C0_TICK_OFFSET UNITYSDK_OFFSET(0x12ABF1A0)
#define CLASS_2_48AF17AAEE2DD1C0__CTOR_OFFSET UNITYSDK_OFFSET(0x12ABED50)

inline static constexpr unsigned int Class_2_48AF17AAEE2DD1C0_TypeDefinitionIndex = 51962;

class Class_2_48AF17AAEE2DD1C0 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::SpeedLineEffect* Field_2_0; // 0x18
