...
#define STRUCT_2_2CEE35A1FF4AE199__CTOR_OFFSET UNITYSDK_OFFSET(0x8FF250)

inline static constexpr unsigned int Struct_2_2CEE35A1FF4AE199_TypeDefinitionIndex = 40665;

struct alignas(8) Struct_2_2CEE35A1FF4AE199
{
	::System::UInt32 Field_2_2; // 0x10
	::System::UInt32 Field_2_1; // 0x14
	::Nap::NapECS::EcsWorld* Field_2_0; // 0x18
	::PipelineCamera::CameraSequence::ICameraSequenceCollection_1<::PipelineCamera::WorldBasicCameraData>* Field_2_7; // 0x20
