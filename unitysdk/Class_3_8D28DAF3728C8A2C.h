...
#define CLASS_3_8D28DAF3728C8A2C_EVALUATE_OFFSET UNITYSDK_OFFSET(0x8DB3D60)
#define CLASS_3_8D28DAF3728C8A2C__CTOR_OFFSET UNITYSDK_OFFSET(0x8DB3D30)

inline static constexpr unsigned int Class_3_8D28DAF3728C8A2C_TypeDefinitionIndex = 42988;
