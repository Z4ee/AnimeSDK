...
#define CLASS_1_F335F1C12D8F872C_CLEAR_OFFSET UNITYSDK_OFFSET(0x187664A0)
#define CLASS_1_F335F1C12D8F872C_GET_NEXT_OFFSET UNITYSDK_OFFSET(0x18766570)
#define CLASS_1_F335F1C12D8F872C_GET_PREV_OFFSET UNITYSDK_OFFSET(0x18766550)
#define CLASS_1_F335F1C12D8F872C_METHOD_1_1FCB8F3A5D177A6D_OFFSET UNITYSDK_OFFSET(0x187664F0)
#define CLASS_1_F335F1C12D8F872C_SET_NEXT_OFFSET UNITYSDK_OFFSET(0x18766580)
#define CLASS_1_F335F1C12D8F872C_SET_PREV_OFFSET UNITYSDK_OFFSET(0x18766560)
#define CLASS_1_F335F1C12D8F872C__CTOR_OFFSET UNITYSDK_OFFSET(0x18766590)
...
public:
	...
	::System::Action* IMDLGFPMPEK; // 0x20
	::RPG::GameCore::FixPoint EPKFMHNJGDE; // 0x28
	::RPG::GameCore::RtDelayCallState MEPFOEEGBEA; // 0x30
