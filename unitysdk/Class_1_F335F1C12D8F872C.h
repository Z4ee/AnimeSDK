...
#define CLASS_1_F335F1C12D8F872C_CLEAR_OFFSET UNITYSDK_OFFSET(0xB917400)
#define CLASS_1_F335F1C12D8F872C_GET_NEXT_OFFSET UNITYSDK_OFFSET(0xB9174D0)
#define CLASS_1_F335F1C12D8F872C_GET_PREV_OFFSET UNITYSDK_OFFSET(0xB9174B0)
#define CLASS_1_F335F1C12D8F872C_METHOD_1_1FCB8F3A5D177A6D_OFFSET UNITYSDK_OFFSET(0xB917450)
#define CLASS_1_F335F1C12D8F872C_SET_NEXT_OFFSET UNITYSDK_OFFSET(0xB9174E0)
#define CLASS_1_F335F1C12D8F872C_SET_PREV_OFFSET UNITYSDK_OFFSET(0xB9174C0)
#define CLASS_1_F335F1C12D8F872C__CTOR_OFFSET UNITYSDK_OFFSET(0xB9174F0)

inline static constexpr unsigned int Class_1_F335F1C12D8F872C_TypeDefinitionIndex = 54344;

class Class_1_F335F1C12D8F872C : public ::System::Object
{
public:
	::Class_1_F335F1C12D8F872C* _Next_k__BackingField; // 0x10
	::System::Action* IMDLGFPMPEK; // 0x18
	::Class_1_F335F1C12D8F872C* _Prev_k__BackingField; // 0x20
	::RPG::GameCore::RtDelayCallState MEPFOEEGBEA; // 0x28
	::RPG::GameCore::FixPoint EPKFMHNJGDE; // 0x30
