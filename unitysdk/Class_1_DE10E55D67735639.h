...
#define CLASS_1_DE10E55D67735639_GET_ALLOWROTATION_OFFSET UNITYSDK_OFFSET(0x1897C640)
#define CLASS_1_DE10E55D67735639_GET_STATE_OFFSET UNITYSDK_OFFSET(0x1897C620)
#define CLASS_1_DE10E55D67735639_METHOD_1_4166DF40939A3516_OFFSET UNITYSDK_OFFSET(0x1897C970)
#define CLASS_1_DE10E55D67735639_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1897C8F0)
#define CLASS_1_DE10E55D67735639_METHOD_1_C10F8EF31879ABA4_OFFSET UNITYSDK_OFFSET(0x1897C680)
#define CLASS_1_DE10E55D67735639_METHOD_1_D437D090E63BE8A7_OFFSET UNITYSDK_OFFSET(0x1897CF70)
#define CLASS_1_DE10E55D67735639_METHOD_1_D64FD9A228A1C4E0_OFFSET UNITYSDK_OFFSET(0x1897C830)
#define CLASS_1_DE10E55D67735639_METHOD_1_FB4BE762B6186C23_OFFSET UNITYSDK_OFFSET(0x1897C660)
#define CLASS_1_DE10E55D67735639_SET_ALLOWROTATION_OFFSET UNITYSDK_OFFSET(0x1897C650)
#define CLASS_1_DE10E55D67735639_SET_STATE_OFFSET UNITYSDK_OFFSET(0x1897C630)
#define CLASS_1_DE10E55D67735639__CTOR_OFFSET UNITYSDK_OFFSET(0x1897D020)
...
public:
	...
	::RPG::Client::MovementStoppedRootMotionBakedData_Class_1_3B76E13757985C28_3* EDAHOAGFFHN; // 0x28
	::RPG::GameCore::AdventureCharacterController* JIIKAEMELPJ; // 0x30
	::Class_2_A0580152EB393340* DEMFJAMDLFP; // 0x38
	::System::Single ADFCGIBHAIH; // 0x40
	::RPG::GameCore::EAdventureNavigationRootMotionHandlerState _State_k__BackingField; // 0x44
	::System::Boolean _AllowRotation_k__BackingField; // 0x48
	::System::Boolean NFDILONBJHJ; // 0x49
	::System::Single PGMIOKKLHIE; // 0x4C
	::System::Single FCJJOMFMKOC; // 0x50
