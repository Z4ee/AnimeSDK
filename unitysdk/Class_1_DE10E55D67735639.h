...
#define CLASS_1_DE10E55D67735639_GET_ALLOWROTATION_OFFSET UNITYSDK_OFFSET(0xD15C360)
#define CLASS_1_DE10E55D67735639_GET_STATE_OFFSET UNITYSDK_OFFSET(0xD15C340)
#define CLASS_1_DE10E55D67735639_METHOD_1_4166DF40939A3516_OFFSET UNITYSDK_OFFSET(0xD15C690)
#define CLASS_1_DE10E55D67735639_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xD15C610)
#define CLASS_1_DE10E55D67735639_METHOD_1_C10F8EF31879ABA4_OFFSET UNITYSDK_OFFSET(0xD15C3A0)
#define CLASS_1_DE10E55D67735639_METHOD_1_D437D090E63BE8A7_OFFSET UNITYSDK_OFFSET(0xD15CC90)
#define CLASS_1_DE10E55D67735639_METHOD_1_D64FD9A228A1C4E0_OFFSET UNITYSDK_OFFSET(0xD15C550)
#define CLASS_1_DE10E55D67735639_METHOD_1_FB4BE762B6186C23_OFFSET UNITYSDK_OFFSET(0xD15C380)
#define CLASS_1_DE10E55D67735639_SET_ALLOWROTATION_OFFSET UNITYSDK_OFFSET(0xD15C370)
#define CLASS_1_DE10E55D67735639_SET_STATE_OFFSET UNITYSDK_OFFSET(0xD15C350)
#define CLASS_1_DE10E55D67735639__CTOR_OFFSET UNITYSDK_OFFSET(0xD15CD40)

inline static constexpr unsigned int Class_1_DE10E55D67735639_TypeDefinitionIndex = 53354;

class Class_1_DE10E55D67735639 : public ::System::Object
{
public:
	::RPG::GameCore::AdventureCharacterController* Field_1_0; // 0x10
	::RPG::Client::MovementStoppedRootMotionBakedData_Class_1_3B76E13757985C28_2* Field_1_1; // 0x18
	::RPG::Client::MovementStoppedRootMotionBakedData_RootMotionCurve Field_1_2; // 0x20
	::Class_2_A0580152EB393340* Field_1_3; // 0x38
	::RPG::GameCore::EAdventureNavigationRootMotionHandlerState _State_k__BackingField; // 0x40
	::System::Single Field_1_5; // 0x44
	::System::Single Field_1_6; // 0x48
	::System::Boolean _AllowRotation_k__BackingField; // 0x4C
