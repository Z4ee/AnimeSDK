...
#define CLASS_1_84DDF02C8C4ECC11_METHOD_1_39689BD8F3E60ECF_OFFSET UNITYSDK_OFFSET(0xBC11A20)
#define CLASS_1_84DDF02C8C4ECC11_METHOD_1_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xBC11780)
#define CLASS_1_84DDF02C8C4ECC11_METHOD_1_F2A165FD9DCABEF5_OFFSET UNITYSDK_OFFSET(0xBC11820)
#define CLASS_1_84DDF02C8C4ECC11_METHOD_1_F8BFB17B3DD6568D_OFFSET UNITYSDK_OFFSET(0xBC11720)
#define CLASS_1_84DDF02C8C4ECC11_METHOD_1_FA3D6E45984D6807_OFFSET UNITYSDK_OFFSET(0xBC11990)
#define CLASS_1_84DDF02C8C4ECC11__CTOR_OFFSET UNITYSDK_OFFSET(0xBC11B00)

inline static constexpr unsigned int Class_1_84DDF02C8C4ECC11_TypeDefinitionIndex = 71995;

class Class_1_84DDF02C8C4ECC11 : public ::System::Object
{
public:
	::RPG::GameCore::LevelUIComponent* CFKHNPGEAJA; // 0x10
	::RPG::GameCore::BattleInstance* IFKCCHIFMOC; // 0x18
	::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::RectTransform*>* HADAMKNKPLI; // 0x20
