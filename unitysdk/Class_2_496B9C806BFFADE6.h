...
#define CLASS_2_496B9C806BFFADE6_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10C54AB0)
#define CLASS_2_496B9C806BFFADE6_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10C54AF0)
#define CLASS_2_496B9C806BFFADE6_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10C54BA0)
#define CLASS_2_496B9C806BFFADE6_TICK_OFFSET UNITYSDK_OFFSET(0x10C54BF0)
#define CLASS_2_496B9C806BFFADE6__CTOR_OFFSET UNITYSDK_OFFSET(0x10C54AA0)

inline static constexpr unsigned int Class_2_496B9C806BFFADE6_TypeDefinitionIndex = 42831;

class Class_2_496B9C806BFFADE6 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::HideMissionInfo* Field_2_0; // 0x18
