...
#define CLASS_2_C2DE7756E351C461_METHOD_2_128774387667156B_OFFSET UNITYSDK_OFFSET(0x148B58F0)
#define CLASS_2_C2DE7756E351C461_METHOD_2_1C7D16CFD5E3856D_OFFSET UNITYSDK_OFFSET(0x148B58D0)
#define CLASS_2_C2DE7756E351C461_METHOD_2_1F4DE031F3F06AC8_OFFSET UNITYSDK_OFFSET(0x148B5A70)
#define CLASS_2_C2DE7756E351C461_METHOD_2_363ACD6E51339DEA_OFFSET UNITYSDK_OFFSET(0x148B5A60)
#define CLASS_2_C2DE7756E351C461_METHOD_2_50131F4CF014469C_OFFSET UNITYSDK_OFFSET(0x148B5830)
#define CLASS_2_C2DE7756E351C461_METHOD_2_5323F2DF46A044DA_1_OFFSET UNITYSDK_OFFSET(0x148B5A80)
#define CLASS_2_C2DE7756E351C461_METHOD_2_5323F2DF46A044DA_OFFSET UNITYSDK_OFFSET(0x148B5A40)
#define CLASS_2_C2DE7756E351C461_METHOD_2_76C4FA0157879317_OFFSET UNITYSDK_OFFSET(0x148B58C0)
#define CLASS_2_C2DE7756E351C461_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x148B5930)
#define CLASS_2_C2DE7756E351C461_METHOD_2_E71761697FA87C6D_OFFSET UNITYSDK_OFFSET(0x148B59C0)
#define CLASS_2_C2DE7756E351C461_METHOD_2_E7F1AECA7CFF8AAD_1_OFFSET UNITYSDK_OFFSET(0x148B5A50)
#define CLASS_2_C2DE7756E351C461_METHOD_2_E7F1AECA7CFF8AAD_OFFSET UNITYSDK_OFFSET(0x148B58E0)
#define CLASS_2_C2DE7756E351C461_TOSTRING_OFFSET UNITYSDK_OFFSET(0x148B5730)
#define CLASS_2_C2DE7756E351C461__CCTOR_OFFSET UNITYSDK_OFFSET(0x148B57B0)
#define CLASS_2_C2DE7756E351C461__CTOR_OFFSET UNITYSDK_OFFSET(0x148B5820)

inline static constexpr unsigned int Class_2_C2DE7756E351C461_TypeDefinitionIndex = 75884;

class Class_2_C2DE7756E351C461 : public ::Class_1_B7E341C5F1A6F199
{
public:
	// static const ::System::UInt16 Field_2_4 = 0x3F; // 0x0
	::System::Single Field_2_0; // 0x20
	::MoleMole::Config::DamageElementType Field_2_6; // 0x24
	::System::Single Field_2_7; // 0x28
	::MoleMole::Config::EVariantElement Field_2_5; // 0x2C
