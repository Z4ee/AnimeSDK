...
#define EFFECTPLUGIN_EFFECT_CUSTOMFOLLOWPLUGIN_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0xF2F3A80)
#define EFFECTPLUGIN_EFFECT_CUSTOMFOLLOWPLUGIN_INIT_OFFSET UNITYSDK_OFFSET(0xF2F36C0)
#define EFFECTPLUGIN_EFFECT_CUSTOMFOLLOWPLUGIN_METHOD_5_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xF2F40B0)
#define EFFECTPLUGIN_EFFECT_CUSTOMFOLLOWPLUGIN_METHOD_5_3E51EEFB06718274_OFFSET UNITYSDK_OFFSET(0xF2F4640)
#define EFFECTPLUGIN_EFFECT_CUSTOMFOLLOWPLUGIN_METHOD_5_89914D30EBFCC9C6_OFFSET UNITYSDK_OFFSET(0xF2F3F20)
#define EFFECTPLUGIN_EFFECT_CUSTOMFOLLOWPLUGIN_METHOD_5_939383CFABF4988F_OFFSET UNITYSDK_OFFSET(0xF2F3A90)
#define EFFECTPLUGIN_EFFECT_CUSTOMFOLLOWPLUGIN_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xF2F3870)
#define EFFECTPLUGIN_EFFECT_CUSTOMFOLLOWPLUGIN_ONENABLE_OFFSET UNITYSDK_OFFSET(0xF2F3660)
#define EFFECTPLUGIN_EFFECT_CUSTOMFOLLOWPLUGIN_SETFOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0xF2F38F0)
#define EFFECTPLUGIN_EFFECT_CUSTOMFOLLOWPLUGIN_START_OFFSET UNITYSDK_OFFSET(0xF2F38D0)
#define EFFECTPLUGIN_EFFECT_CUSTOMFOLLOWPLUGIN_UPDATE_OFFSET UNITYSDK_OFFSET(0xF2F38E0)
#define EFFECTPLUGIN_EFFECT_CUSTOMFOLLOWPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xF2F4740)

namespace EffectPlugin
{
	inline static constexpr unsigned int Effect_CustomFollowPlugin_TypeDefinitionIndex = 45630;
