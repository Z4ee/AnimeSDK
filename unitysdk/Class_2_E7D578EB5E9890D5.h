...
#define CLASS_2_E7D578EB5E9890D5_DISPOSE_OFFSET UNITYSDK_OFFSET(0x129E1A60)
#define CLASS_2_E7D578EB5E9890D5_METHOD_2_26F48F58F6BD506B_OFFSET UNITYSDK_OFFSET(0x129E1F60)
#define CLASS_2_E7D578EB5E9890D5_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x129E23E0)
#define CLASS_2_E7D578EB5E9890D5_METHOD_2_5AFFCF6F18A4FE2B_OFFSET UNITYSDK_OFFSET(0x129E2030)
#define CLASS_2_E7D578EB5E9890D5_METHOD_2_67B6484BDDE6464B_OFFSET UNITYSDK_OFFSET(0x129E2900)
#define CLASS_2_E7D578EB5E9890D5_METHOD_2_68E340ABEC62FD31_OFFSET UNITYSDK_OFFSET(0x129E3320)
#define CLASS_2_E7D578EB5E9890D5_METHOD_2_735EE20B25F86BF4_OFFSET UNITYSDK_OFFSET(0x129E32D0)
#define CLASS_2_E7D578EB5E9890D5_METHOD_2_76EE480686474477_OFFSET UNITYSDK_OFFSET(0x129E2620)
#define CLASS_2_E7D578EB5E9890D5_METHOD_2_9CA35E5BF1A50E77_OFFSET UNITYSDK_OFFSET(0x129E1E10)
#define CLASS_2_E7D578EB5E9890D5_METHOD_2_A1ADC999CFACEB89_OFFSET UNITYSDK_OFFSET(0x129E2500)
#define CLASS_2_E7D578EB5E9890D5_METHOD_2_B768DA94E3FD91D9_OFFSET UNITYSDK_OFFSET(0x129E2310)
#define CLASS_2_E7D578EB5E9890D5_METHOD_2_EFDD2EF954C3FDB4_OFFSET UNITYSDK_OFFSET(0x129E1B00)
#define CLASS_2_E7D578EB5E9890D5_METHOD_2_F978A1D172468895_OFFSET UNITYSDK_OFFSET(0x129E2100)
#define CLASS_2_E7D578EB5E9890D5_METHOD_2_FA99051EF61C23DD_OFFSET UNITYSDK_OFFSET(0x129E2A40)
#define CLASS_2_E7D578EB5E9890D5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x129E2F50)
#define CLASS_2_E7D578EB5E9890D5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x129E30E0)
#define CLASS_2_E7D578EB5E9890D5_TICK_OFFSET UNITYSDK_OFFSET(0x129E2E60)
#define CLASS_2_E7D578EB5E9890D5__CTOR_OFFSET UNITYSDK_OFFSET(0x129E1580)

inline static constexpr unsigned int Class_2_E7D578EB5E9890D5_TypeDefinitionIndex = 48382;

class Class_2_E7D578EB5E9890D5 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::AdvNpcFollowByPlayer* Field_2_1; // 0x18
	::RPG::GameCore::TransformComponent* Field_2_5; // 0x20
	::RPG::GameCore::AdventureCharacterController* Field_2_7; // 0x28
	::Class_1_5F51D4049EA87B7B* Field_2_3; // 0x30
	::Il2CppArray<::RPG::GameCore::FollowByPlayerCustomRoutePoint*>* Field_2_18; // 0x38
	::Class_2_19E76B515E7B257C* Field_2_6; // 0x40
	::RPG::GameCore::TaskContext* Field_2_0; // 0x48
	::Class_2_A0580152EB393340* Field_2_4; // 0x50
	::Class_1_5F51D4049EA87B7B* Field_2_2; // 0x58
	::System::Int32 Field_2_17; // 0x60
	::System::Single Field_2_14; // 0x64
	::System::Single Field_2_13; // 0x68
	::System::Single Field_2_9; // 0x6C
	::RPG::GameCore::NpcFollowByPlayerState Field_2_12; // 0x70
	::System::Boolean Field_2_19; // 0x74
	::System::Boolean Field_2_15; // 0x75
	::System::Single Field_2_8; // 0x78
	::System::Single Field_2_11; // 0x7C
	::System::Single Field_2_10; // 0x80
	::RPG::GameCore::CharacterMotionFlag Field_2_16; // 0x84
