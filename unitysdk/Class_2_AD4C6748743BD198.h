...
#define CLASS_2_AD4C6748743BD198_DISPOSE_OFFSET UNITYSDK_OFFSET(0x142638B0)
#define CLASS_2_AD4C6748743BD198_METHOD_2_390FABC99AD6B7EE_OFFSET UNITYSDK_OFFSET(0x14263CE0)
#define CLASS_2_AD4C6748743BD198_METHOD_2_E7070A6C038BF402_OFFSET UNITYSDK_OFFSET(0x14263A40)
#define CLASS_2_AD4C6748743BD198_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x142638F0)
#define CLASS_2_AD4C6748743BD198_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x14263C30)
#define CLASS_2_AD4C6748743BD198_TICK_OFFSET UNITYSDK_OFFSET(0x14263C80)
#define CLASS_2_AD4C6748743BD198__CTOR_OFFSET UNITYSDK_OFFSET(0x142638A0)

inline static constexpr unsigned int Class_2_AD4C6748743BD198_TypeDefinitionIndex = 49225;

class Class_2_AD4C6748743BD198 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::CalculateMissionCustomValue* Field_2_1; // 0x20
