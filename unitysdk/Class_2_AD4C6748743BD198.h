...
#define CLASS_2_AD4C6748743BD198_DISPOSE_OFFSET UNITYSDK_OFFSET(0x177AFDF0)
#define CLASS_2_AD4C6748743BD198_METHOD_2_390FABC99AD6B7EE_OFFSET UNITYSDK_OFFSET(0x177B0220)
#define CLASS_2_AD4C6748743BD198_METHOD_2_E7070A6C038BF402_OFFSET UNITYSDK_OFFSET(0x177AFF80)
#define CLASS_2_AD4C6748743BD198_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x177AFE30)
#define CLASS_2_AD4C6748743BD198_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x177B0170)
#define CLASS_2_AD4C6748743BD198_TICK_OFFSET UNITYSDK_OFFSET(0x177B01C0)
#define CLASS_2_AD4C6748743BD198__CTOR_OFFSET UNITYSDK_OFFSET(0x177AFDE0)

inline static constexpr unsigned int Class_2_AD4C6748743BD198_TypeDefinitionIndex = 52903;

class Class_2_AD4C6748743BD198 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::GameCore::CalculateMissionCustomValue* OFKGLJOAMLD; // 0x20
