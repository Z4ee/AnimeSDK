...
#define CLASS_2_CB38D1CC30518745_CLASS_1_AEB398135389F96A__CTOR_OFFSET UNITYSDK_OFFSET(0x931CD50)
...
public:
	...
	::RPG::Client::MonoEffect* Field_1_3; // 0x20
	::RPG::GameCore::GameEntity* Field_1_2; // 0x28
	::RPG::Client::Prop::RogueDLCRayModule* Field_1_1; // 0x30
