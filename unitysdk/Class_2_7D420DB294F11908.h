...
#define CLASS_2_7D420DB294F11908_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC3E2AE0)
#define CLASS_2_7D420DB294F11908_METHOD_2_A48C05A398CFF84F_OFFSET UNITYSDK_OFFSET(0xC3E26E0)
#define CLASS_2_7D420DB294F11908_METHOD_2_AB2964D28A356649_OFFSET UNITYSDK_OFFSET(0xC3E24B0)
#define CLASS_2_7D420DB294F11908_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xC3E2950)
#define CLASS_2_7D420DB294F11908_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xC3E2A90)
#define CLASS_2_7D420DB294F11908_TICK_OFFSET UNITYSDK_OFFSET(0xC3E2B20)
#define CLASS_2_7D420DB294F11908__CTOR_OFFSET UNITYSDK_OFFSET(0xC3E24A0)
...
{
public:
	::RPG::GameCore::TriggerFarmElementAnimState* OFKGLJOAMLD; // 0x18
	::RPG::Client::MockAnimator* JDFCDMAPBFJ; // 0x20
