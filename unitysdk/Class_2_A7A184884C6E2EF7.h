...
#define CLASS_2_A7A184884C6E2EF7_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC31C170)
#define CLASS_2_A7A184884C6E2EF7_METHOD_2_5934C7451F9426C2_OFFSET UNITYSDK_OFFSET(0xC31C610)
#define CLASS_2_A7A184884C6E2EF7_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xC31C320)
#define CLASS_2_A7A184884C6E2EF7_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xC31C450)
#define CLASS_2_A7A184884C6E2EF7_TICK_OFFSET UNITYSDK_OFFSET(0xC31C5B0)
#define CLASS_2_A7A184884C6E2EF7__CTOR_OFFSET UNITYSDK_OFFSET(0xC31C160)
...
{
public:
	::RPG::GameCore::ShowTutorialGuideTalk* OFKGLJOAMLD; // 0x18
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x20
	::Class_0_16E4307DCC419505_636* JELPBNHCPCO; // 0x28
