...
#define MONOSCENEMAP3DCONFIG_LIFTPOSINFO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x15B22A70)
#define MONOSCENEMAP3DCONFIG_LIFTPOSINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x15B22980)
#define MONOSCENEMAP3DCONFIG_LIFTPOSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x15B22B60)
#define MONOSCENEMAP3DCONFIG_LIFTPOSINFO___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x15B22B70)

inline static constexpr unsigned int MonoSceneMap3DConfig_LiftPosInfo_TypeDefinitionIndex = 50694;
