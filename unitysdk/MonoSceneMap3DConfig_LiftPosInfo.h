...
#define MONOSCENEMAP3DCONFIG_LIFTPOSINFO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1384A8A0)
#define MONOSCENEMAP3DCONFIG_LIFTPOSINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x138305B0)
#define MONOSCENEMAP3DCONFIG_LIFTPOSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1384A990)
#define MONOSCENEMAP3DCONFIG_LIFTPOSINFO___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1384A9A0)

inline static constexpr unsigned int MonoSceneMap3DConfig_LiftPosInfo_TypeDefinitionIndex = 40577;
