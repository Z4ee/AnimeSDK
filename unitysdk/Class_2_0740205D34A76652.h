...
#define CLASS_2_0740205D34A76652_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18DE4320)
#define CLASS_2_0740205D34A76652_METHOD_2_6BD012F436E1844D_OFFSET UNITYSDK_OFFSET(0x18DE4780)
#define CLASS_2_0740205D34A76652_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18DE3FC0)
#define CLASS_2_0740205D34A76652_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x18DE42D0)
#define CLASS_2_0740205D34A76652_TICK_OFFSET UNITYSDK_OFFSET(0x18DE4D70)
#define CLASS_2_0740205D34A76652__CTOR_OFFSET UNITYSDK_OFFSET(0x18DE3D10)
...
{
public:
	::Class_3_07C3C4D2990C49EE* HDPCLBHCDIF; // 0x18
	::Class_3_07C3C4D2990C49EE* KKBPDJDFOEC; // 0x20
	::Class_3_07C3C4D2990C49EE* DMKOLLPGHCF; // 0x28
	::Class_3_07C3C4D2990C49EE* APCGOOFNNEO; // 0x30
	::RPG::GameCore::TaskContext* EEFMDEHLLFI; // 0x38
	::Class_3_07C3C4D2990C49EE* BJHAAFHJOKH; // 0x40
	::Class_3_07C3C4D2990C49EE* MALOFCFGGEF; // 0x48
