...
#define CLASS_2_BABB56BDDF4A061C_METHOD_2_2478A1DBFBC4AB6D_OFFSET UNITYSDK_OFFSET(0x1C3C3990)
#define CLASS_2_BABB56BDDF4A061C_METHOD_2_3821EE6201CF74C2_OFFSET UNITYSDK_OFFSET(0x1C3C3B00)
#define CLASS_2_BABB56BDDF4A061C_METHOD_2_4008403A081848FB_OFFSET UNITYSDK_OFFSET(0x1C3C3730)
#define CLASS_2_BABB56BDDF4A061C_METHOD_2_E5E342154D4EA5F5_OFFSET UNITYSDK_OFFSET(0x1C3C3C90)
#define CLASS_2_BABB56BDDF4A061C_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1C3C3040)
#define CLASS_2_BABB56BDDF4A061C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C3C3BC0)
#define CLASS_2_BABB56BDDF4A061C__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3C3BB0)

inline static constexpr unsigned int Class_2_BABB56BDDF4A061C_TypeDefinitionIndex = 63696;

class Class_2_BABB56BDDF4A061C : public ::UnityEngine::Playables::PlayableBehaviour
{
public:
	static ::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Boolean>** StaticGet_Field_2_7()
	{
		return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_BABB56BDDF4A061C_TypeDefinitionIndex)->GetStaticField(0x51CE0);
	}
	static ::System::UInt64* StaticGet_Field_2_0()
	{
		return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(Class_2_BABB56BDDF4A061C_TypeDefinitionIndex)->GetStaticField(0x12EF0);
	}
