...
#define CLASS_1_DB4B27FBA0545EF9_METHOD_1_EF9BC5C1B5A8CD8E_OFFSET UNITYSDK_OFFSET(0x11422C50)
#define CLASS_1_DB4B27FBA0545EF9__CTOR_OFFSET UNITYSDK_OFFSET(0x11422C40)

inline static constexpr unsigned int Class_1_DB4B27FBA0545EF9_TypeDefinitionIndex = 54189;

class Class_1_DB4B27FBA0545EF9 : public ::System::Object
{
public:
	::System::Int32 Field_1_2; // 0x10
	::Enum_3_D7FE77D6BC79ADBB Field_1_0; // 0x14
