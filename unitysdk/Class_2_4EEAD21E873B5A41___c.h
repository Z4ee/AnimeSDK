...
#define CLASS_2_4EEAD21E873B5A41___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xBF1A8D0)
#define CLASS_2_4EEAD21E873B5A41___C__CTOR_OFFSET UNITYSDK_OFFSET(0xBF1A910)
#define CLASS_2_4EEAD21E873B5A41___C___APPLYENVIRONMENTPROFILE_B__26_0_OFFSET UNITYSDK_OFFSET(0xBF1A930)
#define CLASS_2_4EEAD21E873B5A41___C___ONENTITYASYNCLOADCOMPLETE_B__19_0_OFFSET UNITYSDK_OFFSET(0xBF1A920)
...
public:
	...
	{
		return (::System::Action**)Il2CppClass::FromTypeDefinitionIndex(Class_2_4EEAD21E873B5A41___c_TypeDefinitionIndex)->GetStaticField(0x67010);
	}
	static ::EnviromentSystem::EnviromentClip_OnEnvironmentClipLoadDelegate** StaticGet___9__26_0()
	{
		return (::EnviromentSystem::EnviromentClip_OnEnvironmentClipLoadDelegate**)Il2CppClass::FromTypeDefinitionIndex(Class_2_4EEAD21E873B5A41___c_TypeDefinitionIndex)->GetStaticField(0x67018);
	}
	static ::Class_2_4EEAD21E873B5A41___c** StaticGet___9()
	{
		return (::Class_2_4EEAD21E873B5A41___c**)Il2CppClass::FromTypeDefinitionIndex(Class_2_4EEAD21E873B5A41___c_TypeDefinitionIndex)->GetStaticField(0x67020);
	}
