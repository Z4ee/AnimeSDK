...
#define BABYHIPPLENCONTROLLER__LERPLOOKATHEADWEIGHT_D__42_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A77E890)
#define BABYHIPPLENCONTROLLER__LERPLOOKATHEADWEIGHT_D__42_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A77E9F0)
#define BABYHIPPLENCONTROLLER__LERPLOOKATHEADWEIGHT_D__42_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A77EA50)
#define BABYHIPPLENCONTROLLER__LERPLOOKATHEADWEIGHT_D__42_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A77EA00)
#define BABYHIPPLENCONTROLLER__LERPLOOKATHEADWEIGHT_D__42_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A77E880)
#define BABYHIPPLENCONTROLLER__LERPLOOKATHEADWEIGHT_D__42__CTOR_OFFSET UNITYSDK_OFFSET(0x1A77C0E0)
