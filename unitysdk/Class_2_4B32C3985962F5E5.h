...
#define CLASS_2_4B32C3985962F5E5_METHOD_2_0DCA45EDA639F38E_OFFSET UNITYSDK_OFFSET(0xCD13CB0)
#define CLASS_2_4B32C3985962F5E5_METHOD_2_141384519CB2AD57_OFFSET UNITYSDK_OFFSET(0xCD13BC0)
#define CLASS_2_4B32C3985962F5E5_METHOD_2_40584B808072C1C1_OFFSET UNITYSDK_OFFSET(0xCD13DC0)
#define CLASS_2_4B32C3985962F5E5_METHOD_2_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xCD13D30)
#define CLASS_2_4B32C3985962F5E5_METHOD_2_EAB1BE386CC4D972_OFFSET UNITYSDK_OFFSET(0xCD13960)
#define CLASS_2_4B32C3985962F5E5__CTOR_OFFSET UNITYSDK_OFFSET(0xCD13E30)
#define CLASS_2_4B32C3985962F5E5__ONBIND_OFFSET UNITYSDK_OFFSET(0xCD138C0)
#define CLASS_2_4B32C3985962F5E5__SETUPVIEW_B__4_0_OFFSET UNITYSDK_OFFSET(0xCD13E60)

inline static constexpr unsigned int Class_2_4B32C3985962F5E5_TypeDefinitionIndex = 71148;

class Class_2_4B32C3985962F5E5 : public ::Class_1_34917908B7833130
{
public:
	// static const ::System::String* NKEHMEGIJHB; // 0x0
	::RPG::Client::BeneficialBuffViewData* AIJODBLPFHG; // 0x60
	::RPG::Client::NodeListViewPanel_1<::Class_2_AF8737E878E8536B*>* ILKGDHECNMH; // 0x68
	::UnityEngine::UI::Text* ONMLHPMENNP; // 0x70
	::Class_2_E1E830ACEA2D2842* OOBEFKJCMEB; // 0x78
