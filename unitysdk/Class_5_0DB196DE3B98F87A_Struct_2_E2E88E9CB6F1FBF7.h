...
#define CLASS_5_0DB196DE3B98F87A_STRUCT_2_E2E88E9CB6F1FBF7_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x82FCC0)
#define CLASS_5_0DB196DE3B98F87A_STRUCT_2_E2E88E9CB6F1FBF7_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x283610)

inline static constexpr unsigned int Class_5_0DB196DE3B98F87A_Struct_2_E2E88E9CB6F1FBF7_TypeDefinitionIndex = 83235;

struct alignas(8) Class_5_0DB196DE3B98F87A_Struct_2_E2E88E9CB6F1FBF7
{
	::MoleMole::HollowChessboard::HollowEntity* Field_2_3; // 0x10
	::Cysharp::Threading::Tasks::CompilerServices::AsyncUniTaskMethodBuilder Field_2_1; // 0x18
	::Class_5_0DB196DE3B98F87A* Field_2_2; // 0x28
	::Cysharp::Threading::Tasks::UniTask_Awaiter Field_2_5; // 0x30
	::MoleMole::HollowChessboard::HollowCell Field_2_4; // 0x40
