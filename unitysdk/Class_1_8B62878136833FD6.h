...
#define CLASS_1_8B62878136833FD6_EXECUTE_OFFSET UNITYSDK_OFFSET(0x189182F0)
#define CLASS_1_8B62878136833FD6_METHOD_1_8EC467BB3B2A7AF2_OFFSET UNITYSDK_OFFSET(0x18918330)
#define CLASS_1_8B62878136833FD6_METHOD_1_B94B952E2B4ACDC7_OFFSET UNITYSDK_OFFSET(0x18918570)
#define CLASS_1_8B62878136833FD6__CTOR_OFFSET UNITYSDK_OFFSET(0x18918280)

inline static constexpr unsigned int Class_1_8B62878136833FD6_TypeDefinitionIndex = 76842;

class Class_1_8B62878136833FD6 : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::System::Int32>* EGGDAAEJAPI; // 0x10
	::Class_1_3B1EA953A4067E26_2* FKINCGODJEP; // 0x18
	::Class_3_8E5D4274ED1F9117* PDENFEFCAGN; // 0x20

	::System::Void _ctor(::Class_1_3B1EA953A4067E26_2* a1, ::Class_3_8E5D4274ED1F9117* a2)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_3B1EA953A4067E26_2*, ::Class_3_8E5D4274ED1F9117*))((::PBYTE)hIl2Cpp + CLASS_1_8B62878136833FD6__CTOR_OFFSET))(this, a1, a2);
	}
