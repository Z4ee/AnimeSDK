...
#define CLASS_2_7395023F8029C495_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB2C1B90)
#define CLASS_2_7395023F8029C495_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB2C1890)
#define CLASS_2_7395023F8029C495_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB2C1B40)
#define CLASS_2_7395023F8029C495_TICK_OFFSET UNITYSDK_OFFSET(0xB2C1AE0)
#define CLASS_2_7395023F8029C495__CTOR_OFFSET UNITYSDK_OFFSET(0xB2C1880)

inline static constexpr unsigned int Class_2_7395023F8029C495_TypeDefinitionIndex = 51680;

class Class_2_7395023F8029C495 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::RevertActionEntityToObserveState* Field_2_0; // 0x18
