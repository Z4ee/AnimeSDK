...
#define CLASS_2_2450EC85D0D7D5D7_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13866C00)
#define CLASS_2_2450EC85D0D7D5D7_METHOD_2_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0x13866F90)
#define CLASS_2_2450EC85D0D7D5D7_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x13866C90)
#define CLASS_2_2450EC85D0D7D5D7_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x13866FE0)
#define CLASS_2_2450EC85D0D7D5D7_TICK_OFFSET UNITYSDK_OFFSET(0x13867070)
#define CLASS_2_2450EC85D0D7D5D7__CTOR_OFFSET UNITYSDK_OFFSET(0x13866BF0)

inline static constexpr unsigned int Class_2_2450EC85D0D7D5D7_TypeDefinitionIndex = 54291;

class Class_2_2450EC85D0D7D5D7 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::ElfEnterNextDay* Field_2_1; // 0x20
