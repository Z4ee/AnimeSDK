...
#define CLASS_1_891BB32C830FA968_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1709C1C0)
#define CLASS_1_891BB32C830FA968_METHOD_1_DB16135CE8B84AE4_OFFSET UNITYSDK_OFFSET(0x1709C120)
#define CLASS_1_891BB32C830FA968__CTOR_OFFSET UNITYSDK_OFFSET(0x1709C1B0)

inline static constexpr unsigned int Class_1_891BB32C830FA968_TypeDefinitionIndex = 62406;

class Class_1_891BB32C830FA968 : public ::System::Object
{
public:
	::UnityEngine::Texture2D* HLHAIDNNEEL; // 0x10
	::UnityEngine::Vector2 DGEIHDFONAP; // 0x18
