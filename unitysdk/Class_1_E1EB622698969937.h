...
#define CLASS_1_E1EB622698969937_GET_CHIMERAID_OFFSET UNITYSDK_OFFSET(0x18F50290)
#define CLASS_1_E1EB622698969937_GET_UNITYGO_OFFSET UNITYSDK_OFFSET(0x18F502B0)
#define CLASS_1_E1EB622698969937_METHOD_1_2CE52CE032F120BC_OFFSET UNITYSDK_OFFSET(0x18F50210)
#define CLASS_1_E1EB622698969937_METHOD_1_2DC57A98C12C3B08_OFFSET UNITYSDK_OFFSET(0x18F50180)
#define CLASS_1_E1EB622698969937_METHOD_1_2DF312D8F1F2AEB0_OFFSET UNITYSDK_OFFSET(0x18F4FD10)
#define CLASS_1_E1EB622698969937_METHOD_1_987505A878484FEE_OFFSET UNITYSDK_OFFSET(0x18F50010)
#define CLASS_1_E1EB622698969937_METHOD_1_A1781348F0A89177_OFFSET UNITYSDK_OFFSET(0x18F500E0)
#define CLASS_1_E1EB622698969937_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x18F50090)
#define CLASS_1_E1EB622698969937_METHOD_1_D3129FE8DF635B48_OFFSET UNITYSDK_OFFSET(0x18F50130)
#define CLASS_1_E1EB622698969937_SET_CHIMERAID_OFFSET UNITYSDK_OFFSET(0x18F502A0)
#define CLASS_1_E1EB622698969937_SET_UNITYGO_OFFSET UNITYSDK_OFFSET(0x18F502C0)
#define CLASS_1_E1EB622698969937__CTOR_OFFSET UNITYSDK_OFFSET(0x18F4FCB0)

inline static constexpr unsigned int Class_1_E1EB622698969937_TypeDefinitionIndex = 77975;

class Class_1_E1EB622698969937 : public ::System::Object
{
public:
	// static const ::System::String* FBAIMOIGOHJ; // 0x0
	::UnityEngine::Transform* FNHOHADJEPE; // 0x10
	::RPG::Client::Prop::ChimeraEvaluationMockAnimator* APPGGMLEPLN; // 0x18
	::UnityEngine::GameObject* MIDIOOAFHDM; // 0x20
	::RPG::Client::Prop::ChimeraGameObjectBuilder* LIOJKFIGGIJ; // 0x28
	::UnityEngine::Transform* NOBIHPOEJIM; // 0x30
