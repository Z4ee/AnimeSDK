...
#define CLASS_2_D905714C1E15C1C8_GET_ATTACHENTITYSERVERENTITYID_OFFSET UNITYSDK_OFFSET(0x89DFC60)
#define CLASS_2_D905714C1E15C1C8_GET_CAMPID_OFFSET UNITYSDK_OFFSET(0x89DFCE0)
#define CLASS_2_D905714C1E15C1C8_GET_CONFIGDATA_OFFSET UNITYSDK_OFFSET(0x89DFCA0)
#define CLASS_2_D905714C1E15C1C8_GET_CREATETIMESTAMP_OFFSET UNITYSDK_OFFSET(0x89DFD20)
#define CLASS_2_D905714C1E15C1C8_GET_LIFETIME_OFFSET UNITYSDK_OFFSET(0x89DFD00)
#define CLASS_2_D905714C1E15C1C8_GET_NAME_OFFSET UNITYSDK_OFFSET(0x89DFCC0)
#define CLASS_2_D905714C1E15C1C8_GET_ROWDATA_OFFSET UNITYSDK_OFFSET(0x89DFC80)
#define CLASS_2_D905714C1E15C1C8_GET_SUMMONERSERVERENTITYID_OFFSET UNITYSDK_OFFSET(0x89DFC40)
#define CLASS_2_D905714C1E15C1C8_GET_SUMMONUNITID_OFFSET UNITYSDK_OFFSET(0x89DFC20)
#define CLASS_2_D905714C1E15C1C8_GET_TRIGGERNAMELIST_OFFSET UNITYSDK_OFFSET(0x89DFF00)
#define CLASS_2_D905714C1E15C1C8_METHOD_2_62B630FB66AD0307_OFFSET UNITYSDK_OFFSET(0x89DFDB0)
#define CLASS_2_D905714C1E15C1C8_METHOD_2_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x89DFD40)
#define CLASS_2_D905714C1E15C1C8_SET_ATTACHENTITYSERVERENTITYID_OFFSET UNITYSDK_OFFSET(0x89DFC70)
#define CLASS_2_D905714C1E15C1C8_SET_CAMPID_OFFSET UNITYSDK_OFFSET(0x89DFCF0)
#define CLASS_2_D905714C1E15C1C8_SET_CONFIGDATA_OFFSET UNITYSDK_OFFSET(0x89DFCB0)
#define CLASS_2_D905714C1E15C1C8_SET_CREATETIMESTAMP_OFFSET UNITYSDK_OFFSET(0x89DFD30)
#define CLASS_2_D905714C1E15C1C8_SET_LIFETIME_OFFSET UNITYSDK_OFFSET(0x89DFD10)
#define CLASS_2_D905714C1E15C1C8_SET_NAME_OFFSET UNITYSDK_OFFSET(0x89DFCD0)
#define CLASS_2_D905714C1E15C1C8_SET_ROWDATA_OFFSET UNITYSDK_OFFSET(0x89DFC90)
#define CLASS_2_D905714C1E15C1C8_SET_SUMMONERSERVERENTITYID_OFFSET UNITYSDK_OFFSET(0x89DFC50)
#define CLASS_2_D905714C1E15C1C8_SET_SUMMONUNITID_OFFSET UNITYSDK_OFFSET(0x89DFC30)
#define CLASS_2_D905714C1E15C1C8_SET_TRIGGERNAMELIST_OFFSET UNITYSDK_OFFSET(0x89DFF10)
#define CLASS_2_D905714C1E15C1C8_TOSTRING_OFFSET UNITYSDK_OFFSET(0x89E00E0)
#define CLASS_2_D905714C1E15C1C8__CTOR_OFFSET UNITYSDK_OFFSET(0x89DFF20)
#define CLASS_2_D905714C1E15C1C8___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x89E01C0)

inline static constexpr unsigned int Class_2_D905714C1E15C1C8_TypeDefinitionIndex = 50470;
...
public:
	...
	::RPG::GameCore::SummonUnitConfig* _ConfigData_k__BackingField; // 0x70
	::System::UInt32 _AttachEntityServerEntityID_k__BackingField; // 0x78
	::System::Single _LifeTime_k__BackingField; // 0x7C
	::RPG::GameCore::CampType _CampID_k__BackingField; // 0x80
	::System::UInt32 _SummonUnitID_k__BackingField; // 0x84
	::System::UInt32 _SummonerServerEntityID_k__BackingField; // 0x88
	::System::UInt64 _CreateTimeStamp_k__BackingField; // 0x90

	::System::Void _ctor(::System::UInt32 a1, ::System::UInt32 a2, ::Class_1_6DF80BD19ED59755* a3, ::System::String* a4, ::UnityEngine::Vector3 a5, ::UnityEngine::Quaternion a6, ::UnityEngine::Vector3 a7, ::System::UInt32 a8)
	{
		return ((::System::Void(*)(::PVOID, ::System::UInt32, ::System::UInt32, ::Class_1_6DF80BD19ED59755*, ::System::String*, ::UnityEngine::Vector3, ::UnityEngine::Quaternion, ::UnityEngine::Vector3, ::System::UInt32))((::PBYTE)hIl2Cpp + CLASS_2_D905714C1E15C1C8__CTOR_OFFSET))(this, a1, a2, a3, a4, a5, a6, a7, a8);
	}
