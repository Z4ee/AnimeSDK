...
#define CLASS_2_D905714C1E15C1C8_GET_ATTACHENTITYSERVERENTITYID_OFFSET UNITYSDK_OFFSET(0x18737100)
#define CLASS_2_D905714C1E15C1C8_GET_CAMPID_OFFSET UNITYSDK_OFFSET(0x18737180)
#define CLASS_2_D905714C1E15C1C8_GET_CONFIGDATA_OFFSET UNITYSDK_OFFSET(0x18737140)
#define CLASS_2_D905714C1E15C1C8_GET_CREATETIMESTAMP_OFFSET UNITYSDK_OFFSET(0x187371C0)
#define CLASS_2_D905714C1E15C1C8_GET_LIFETIME_OFFSET UNITYSDK_OFFSET(0x187371A0)
#define CLASS_2_D905714C1E15C1C8_GET_NAME_OFFSET UNITYSDK_OFFSET(0x18737160)
#define CLASS_2_D905714C1E15C1C8_GET_ROWDATA_OFFSET UNITYSDK_OFFSET(0x18737120)
#define CLASS_2_D905714C1E15C1C8_GET_SUMMONERSERVERENTITYID_OFFSET UNITYSDK_OFFSET(0x187370E0)
#define CLASS_2_D905714C1E15C1C8_GET_SUMMONUNITID_OFFSET UNITYSDK_OFFSET(0x187370C0)
#define CLASS_2_D905714C1E15C1C8_GET_TRIGGERNAMELIST_OFFSET UNITYSDK_OFFSET(0x187373A0)
#define CLASS_2_D905714C1E15C1C8_METHOD_2_62B630FB66AD0307_OFFSET UNITYSDK_OFFSET(0x18737250)
#define CLASS_2_D905714C1E15C1C8_METHOD_2_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x187371E0)
#define CLASS_2_D905714C1E15C1C8_SET_ATTACHENTITYSERVERENTITYID_OFFSET UNITYSDK_OFFSET(0x18737110)
#define CLASS_2_D905714C1E15C1C8_SET_CAMPID_OFFSET UNITYSDK_OFFSET(0x18737190)
#define CLASS_2_D905714C1E15C1C8_SET_CONFIGDATA_OFFSET UNITYSDK_OFFSET(0x18737150)
#define CLASS_2_D905714C1E15C1C8_SET_CREATETIMESTAMP_OFFSET UNITYSDK_OFFSET(0x187371D0)
#define CLASS_2_D905714C1E15C1C8_SET_LIFETIME_OFFSET UNITYSDK_OFFSET(0x187371B0)
#define CLASS_2_D905714C1E15C1C8_SET_NAME_OFFSET UNITYSDK_OFFSET(0x18737170)
#define CLASS_2_D905714C1E15C1C8_SET_ROWDATA_OFFSET UNITYSDK_OFFSET(0x18737130)
#define CLASS_2_D905714C1E15C1C8_SET_SUMMONERSERVERENTITYID_OFFSET UNITYSDK_OFFSET(0x187370F0)
#define CLASS_2_D905714C1E15C1C8_SET_SUMMONUNITID_OFFSET UNITYSDK_OFFSET(0x187370D0)
#define CLASS_2_D905714C1E15C1C8_SET_TRIGGERNAMELIST_OFFSET UNITYSDK_OFFSET(0x187373B0)
#define CLASS_2_D905714C1E15C1C8_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18737580)
#define CLASS_2_D905714C1E15C1C8__CTOR_OFFSET UNITYSDK_OFFSET(0x187373C0)

inline static constexpr unsigned int Class_2_D905714C1E15C1C8_TypeDefinitionIndex = 62220;
...
public:
	...
	::System::Single _LifeTime_k__BackingField; // 0x8C
	::RPG::GameCore::CampType _CampID_k__BackingField; // 0x90

	::System::Void _ctor(::System::UInt32 a1, ::System::UInt32 a2, ::Class_1_BB4B99DE4C2501EC_12* a3, ::System::String* a4, ::UnityEngine::Vector3 a5, ::UnityEngine::Quaternion a6, ::UnityEngine::Vector3 a7, ::System::UInt32 a8)
	{
		return ((::System::Void(*)(::PVOID, ::System::UInt32, ::System::UInt32, ::Class_1_BB4B99DE4C2501EC_12*, ::System::String*, ::UnityEngine::Vector3, ::UnityEngine::Quaternion, ::UnityEngine::Vector3, ::System::UInt32))((::PBYTE)hIl2Cpp + CLASS_2_D905714C1E15C1C8__CTOR_OFFSET))(this, a1, a2, a3, a4, a5, a6, a7, a8);
	}
