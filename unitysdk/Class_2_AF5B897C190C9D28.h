...
#define CLASS_2_AF5B897C190C9D28_DISPOSE_OFFSET UNITYSDK_OFFSET(0x188BD390)
#define CLASS_2_AF5B897C190C9D28_METHOD_2_3B911B6C3D1240C7_OFFSET UNITYSDK_OFFSET(0x188BD3D0)
#define CLASS_2_AF5B897C190C9D28_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x188BCC10)
#define CLASS_2_AF5B897C190C9D28_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x188BCBC0)
#define CLASS_2_AF5B897C190C9D28_TICK_OFFSET UNITYSDK_OFFSET(0x188BD330)
#define CLASS_2_AF5B897C190C9D28__CTOR_OFFSET UNITYSDK_OFFSET(0x188BCBB0)

inline static constexpr unsigned int Class_2_AF5B897C190C9D28_TypeDefinitionIndex = 55360;
