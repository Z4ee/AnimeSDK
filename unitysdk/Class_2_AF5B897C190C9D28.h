...
#define CLASS_2_AF5B897C190C9D28_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA432630)
#define CLASS_2_AF5B897C190C9D28_METHOD_2_3B911B6C3D1240C7_OFFSET UNITYSDK_OFFSET(0xA432670)
#define CLASS_2_AF5B897C190C9D28_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xA431F90)
#define CLASS_2_AF5B897C190C9D28_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xA431F40)
#define CLASS_2_AF5B897C190C9D28_TICK_OFFSET UNITYSDK_OFFSET(0xA4325D0)
#define CLASS_2_AF5B897C190C9D28__CTOR_OFFSET UNITYSDK_OFFSET(0xA431F30)

inline static constexpr unsigned int Class_2_AF5B897C190C9D28_TypeDefinitionIndex = 54137;
