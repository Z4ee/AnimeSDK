...
#define CLASS_2_AF5B897C190C9D28_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB6C5AC0)
#define CLASS_2_AF5B897C190C9D28_METHOD_2_3B911B6C3D1240C7_OFFSET UNITYSDK_OFFSET(0xB6C5B00)
#define CLASS_2_AF5B897C190C9D28_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB6C5340)
#define CLASS_2_AF5B897C190C9D28_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB6C52F0)
#define CLASS_2_AF5B897C190C9D28_TICK_OFFSET UNITYSDK_OFFSET(0xB6C5A60)
#define CLASS_2_AF5B897C190C9D28__CTOR_OFFSET UNITYSDK_OFFSET(0xB6C52E0)
...
{
public:
	::RPG::GameCore::AetherDivideTriggerAttackSimplified* EJJEEJENLDA; // 0x18
