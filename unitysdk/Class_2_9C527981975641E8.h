...
#define CLASS_2_9C527981975641E8_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA5E19F0)
#define CLASS_2_9C527981975641E8_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA5E1C40)
#define CLASS_2_9C527981975641E8_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xA5E1A40)
#define CLASS_2_9C527981975641E8_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xA5E1B90)
#define CLASS_2_9C527981975641E8_TICK_OFFSET UNITYSDK_OFFSET(0xA5E1BE0)
#define CLASS_2_9C527981975641E8__CTOR_OFFSET UNITYSDK_OFFSET(0xA5E19E0)

inline static constexpr unsigned int Class_2_9C527981975641E8_TypeDefinitionIndex = 49695;

class Class_2_9C527981975641E8 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::PropDestruct* Field_2_1; // 0x20
