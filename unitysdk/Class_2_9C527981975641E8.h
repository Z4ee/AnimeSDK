...
#define CLASS_2_9C527981975641E8_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB8F7FA0)
#define CLASS_2_9C527981975641E8_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB8F81F0)
#define CLASS_2_9C527981975641E8_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB8F7FF0)
#define CLASS_2_9C527981975641E8_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB8F8140)
#define CLASS_2_9C527981975641E8_TICK_OFFSET UNITYSDK_OFFSET(0xB8F8190)
#define CLASS_2_9C527981975641E8__CTOR_OFFSET UNITYSDK_OFFSET(0xB8F7F90)
...
{
public:
	::RPG::GameCore::PropDestruct* OFKGLJOAMLD; // 0x18
