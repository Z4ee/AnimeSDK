...
#define CLASS_1_5B567C8A01BAEDFE_81_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E4CF0F0)
#define CLASS_1_5B567C8A01BAEDFE_81_CLONE_OFFSET UNITYSDK_OFFSET(0x1E4CEDE0)
#define CLASS_1_5B567C8A01BAEDFE_81_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E4CEEF0)
#define CLASS_1_5B567C8A01BAEDFE_81_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E4CEE20)
#define CLASS_1_5B567C8A01BAEDFE_81_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E4CF050)
#define CLASS_1_5B567C8A01BAEDFE_81_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E4CF140)
#define CLASS_1_5B567C8A01BAEDFE_81_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E4CF110)
#define CLASS_1_5B567C8A01BAEDFE_81_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E4CED60)
#define CLASS_1_5B567C8A01BAEDFE_81_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E4CED90)
#define CLASS_1_5B567C8A01BAEDFE_81_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E4CF080)
#define CLASS_1_5B567C8A01BAEDFE_81_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E4CF0E0)
#define CLASS_1_5B567C8A01BAEDFE_81__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E4CF190)
#define CLASS_1_5B567C8A01BAEDFE_81__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E4CEDB0)
#define CLASS_1_5B567C8A01BAEDFE_81__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4CEDA0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_81_TypeDefinitionIndex = 27081;

class Class_1_5B567C8A01BAEDFE_81 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_81*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_81*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_81_TypeDefinitionIndex)->GetStaticField(0xBF20);
	}
