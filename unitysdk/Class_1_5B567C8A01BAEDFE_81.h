...
#define CLASS_1_5B567C8A01BAEDFE_81_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19B67D70)
#define CLASS_1_5B567C8A01BAEDFE_81_CLONE_OFFSET UNITYSDK_OFFSET(0x19B67B80)
#define CLASS_1_5B567C8A01BAEDFE_81_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19B67C80)
#define CLASS_1_5B567C8A01BAEDFE_81_EQUALS_OFFSET UNITYSDK_OFFSET(0x19B67BF0)
#define CLASS_1_5B567C8A01BAEDFE_81_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19B67CD0)
#define CLASS_1_5B567C8A01BAEDFE_81_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19B67DC0)
#define CLASS_1_5B567C8A01BAEDFE_81_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19B67D90)
#define CLASS_1_5B567C8A01BAEDFE_81_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19B67AD0)
#define CLASS_1_5B567C8A01BAEDFE_81_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19B67B30)
#define CLASS_1_5B567C8A01BAEDFE_81_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19B67D00)
#define CLASS_1_5B567C8A01BAEDFE_81_WRITETO_OFFSET UNITYSDK_OFFSET(0x19B67D60)
#define CLASS_1_5B567C8A01BAEDFE_81__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B67E10)
#define CLASS_1_5B567C8A01BAEDFE_81__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B67B50)
#define CLASS_1_5B567C8A01BAEDFE_81__CTOR_OFFSET UNITYSDK_OFFSET(0x19B67B40)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_81_TypeDefinitionIndex = 26003;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_81*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_81_TypeDefinitionIndex)->GetStaticField(0x6600);
	}
