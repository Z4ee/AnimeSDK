...
#define SCENEMATERIALPARAMETERREWRITER_APPLY_OFFSET UNITYSDK_OFFSET(0x1B85A570)
#define SCENEMATERIALPARAMETERREWRITER_CLEARCONTENT_OFFSET UNITYSDK_OFFSET(0x1B85A660)
#define SCENEMATERIALPARAMETERREWRITER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B85A610)
#define SCENEMATERIALPARAMETERREWRITER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B85A520)
#define SCENEMATERIALPARAMETERREWRITER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B85A700)
#define SCENEMATERIALPARAMETERREWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B85A750)

inline static constexpr unsigned int SceneMaterialParameterRewriter_TypeDefinitionIndex = 27187;
