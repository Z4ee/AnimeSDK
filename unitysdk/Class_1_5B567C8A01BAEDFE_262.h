...
#define CLASS_1_5B567C8A01BAEDFE_262_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1958BC30)
#define CLASS_1_5B567C8A01BAEDFE_262_CLONE_OFFSET UNITYSDK_OFFSET(0x1958BA40)
#define CLASS_1_5B567C8A01BAEDFE_262_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1958BB40)
#define CLASS_1_5B567C8A01BAEDFE_262_EQUALS_OFFSET UNITYSDK_OFFSET(0x1958BAB0)
#define CLASS_1_5B567C8A01BAEDFE_262_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1958BB90)
#define CLASS_1_5B567C8A01BAEDFE_262_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1958BC80)
#define CLASS_1_5B567C8A01BAEDFE_262_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1958BC50)
#define CLASS_1_5B567C8A01BAEDFE_262_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1958B990)
#define CLASS_1_5B567C8A01BAEDFE_262_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1958B9F0)
#define CLASS_1_5B567C8A01BAEDFE_262_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1958BBC0)
#define CLASS_1_5B567C8A01BAEDFE_262_WRITETO_OFFSET UNITYSDK_OFFSET(0x1958BC20)
#define CLASS_1_5B567C8A01BAEDFE_262__CCTOR_OFFSET UNITYSDK_OFFSET(0x1958BCD0)
#define CLASS_1_5B567C8A01BAEDFE_262__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1958BA10)
#define CLASS_1_5B567C8A01BAEDFE_262__CTOR_OFFSET UNITYSDK_OFFSET(0x1958BA00)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_262_TypeDefinitionIndex = 30470;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_262*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_262_TypeDefinitionIndex)->GetStaticField(0x4E440);
	}
