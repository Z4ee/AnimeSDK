...
#define CLASS_2_F9870DE8592C94DF__CREATETRIGGER_OFFSET UNITYSDK_OFFSET(0x9548B80)
#define CLASS_2_F9870DE8592C94DF__CTOR_OFFSET UNITYSDK_OFFSET(0x95486C0)
#define CLASS_2_F9870DE8592C94DF__REMOVETRIGGER_OFFSET UNITYSDK_OFFSET(0x95490C0)
#define CLASS_2_F9870DE8592C94DF__TEARDOWN_OFFSET UNITYSDK_OFFSET(0x95489A0)
#define CLASS_2_F9870DE8592C94DF___IFIXBASEPROXY__TEARDOWN_OFFSET UNITYSDK_OFFSET(0x9549210)

inline static constexpr unsigned int Class_2_F9870DE8592C94DF_TypeDefinitionIndex = 70776;
