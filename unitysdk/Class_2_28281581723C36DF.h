...
#define CLASS_2_28281581723C36DF_METHOD_2_0A0A8830B02C5A4B_OFFSET UNITYSDK_OFFSET(0x170BCB10)
#define CLASS_2_28281581723C36DF_METHOD_2_0EB2899F45F512FE_OFFSET UNITYSDK_OFFSET(0x170BC8A0)
#define CLASS_2_28281581723C36DF_METHOD_2_3422201382CE593B_OFFSET UNITYSDK_OFFSET(0x170BD100)
#define CLASS_2_28281581723C36DF_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x170BD170)
#define CLASS_2_28281581723C36DF_METHOD_2_E71A958DC020C7A7_OFFSET UNITYSDK_OFFSET(0x170BC770)
#define CLASS_2_28281581723C36DF__CTOR_1_OFFSET UNITYSDK_OFFSET(0x170BC610)
#define CLASS_2_28281581723C36DF__CTOR_OFFSET UNITYSDK_OFFSET(0x170BC600)

inline static constexpr unsigned int Class_2_28281581723C36DF_TypeDefinitionIndex = 69590;

class Class_2_28281581723C36DF : public ::Class_1_4A7F3B1CD6560F7E
{
public:
	::RPG::Client::InitializeModuleConfig* JDECJBOHCGL; // 0x38
	::System::Single HPFGIPBAHCB; // 0x40
	::System::Single JBEMENDMECC; // 0x44
