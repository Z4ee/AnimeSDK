...
#define CLASS_2_061C4FA4829DA86A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x186EC550)
#define CLASS_2_061C4FA4829DA86A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x186EC300)
#define CLASS_2_061C4FA4829DA86A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x186EC500)
#define CLASS_2_061C4FA4829DA86A_TICK_OFFSET UNITYSDK_OFFSET(0x186EC590)
#define CLASS_2_061C4FA4829DA86A__CTOR_OFFSET UNITYSDK_OFFSET(0x186EC2F0)

inline static constexpr unsigned int Class_2_061C4FA4829DA86A_TypeDefinitionIndex = 55646;

class Class_2_061C4FA4829DA86A : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::MonopolyUpdateInfoOnSwitchWorld* Field_2_0; // 0x18
