...
#define CLASS_2_061C4FA4829DA86A_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB48C020)
#define CLASS_2_061C4FA4829DA86A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB48BE00)
#define CLASS_2_061C4FA4829DA86A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB48BFD0)
#define CLASS_2_061C4FA4829DA86A_TICK_OFFSET UNITYSDK_OFFSET(0xB48C060)
#define CLASS_2_061C4FA4829DA86A__CTOR_OFFSET UNITYSDK_OFFSET(0xB48BDF0)

inline static constexpr unsigned int Class_2_061C4FA4829DA86A_TypeDefinitionIndex = 53700;

class Class_2_061C4FA4829DA86A : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::MonopolyUpdateInfoOnSwitchWorld* Field_2_1; // 0x18
