...
#define CLASS_2_7A4D3608A08D50F9_GET_SOURCEOBJECT_OFFSET UNITYSDK_OFFSET(0x993BDA0)
#define CLASS_2_7A4D3608A08D50F9_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0x993BDC0)
#define CLASS_2_7A4D3608A08D50F9_SET_SOURCEOBJECT_OFFSET UNITYSDK_OFFSET(0x993BDB0)
#define CLASS_2_7A4D3608A08D50F9__CTOR_OFFSET UNITYSDK_OFFSET(0x993C000)
#define CLASS_2_7A4D3608A08D50F9___IFIXBASEPROXY_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0x993C010)

inline static constexpr unsigned int Class_2_7A4D3608A08D50F9_TypeDefinitionIndex = 45508;
