...
namespace SQLite
{
	inline static constexpr unsigned int AsyncTableQuery_1___c__DisplayClass20_0_TypeDefinitionIndex = 38487;

	template <typename T>
	class AsyncTableQuery_1___c__DisplayClass20_0 : public ::System::Object
	{
	public:
