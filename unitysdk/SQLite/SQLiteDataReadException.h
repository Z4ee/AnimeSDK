...
#define SQLITE_SQLITEDATAREADEXCEPTION_NEW_1_OFFSET UNITYSDK_OFFSET(0x1B283360)
#define SQLITE_SQLITEDATAREADEXCEPTION_NEW_OFFSET UNITYSDK_OFFSET(0x1B2885F0)
#define SQLITE_SQLITEDATAREADEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B288540)
#define SQLITE_SQLITEDATAREADEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2884A0)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteDataReadException_TypeDefinitionIndex = 36750;
