...
#define SQLITE_SQLITEDATAREADEXCEPTION_NEW_1_OFFSET UNITYSDK_OFFSET(0x1EA075A0)
#define SQLITE_SQLITEDATAREADEXCEPTION_NEW_OFFSET UNITYSDK_OFFSET(0x1EA0C7E0)
#define SQLITE_SQLITEDATAREADEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EA0C730)
#define SQLITE_SQLITEDATAREADEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA0C690)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteDataReadException_TypeDefinitionIndex = 39021;
