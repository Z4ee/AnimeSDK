...
namespace SQLite
{
	inline static constexpr unsigned int AsyncTableQuery_1___c__DisplayClass19_0_TypeDefinitionIndex = 39147;

	template <typename T>
	class AsyncTableQuery_1___c__DisplayClass19_0 : public ::System::Object
	{
	public:
