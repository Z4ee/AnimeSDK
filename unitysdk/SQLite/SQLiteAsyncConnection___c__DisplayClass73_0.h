...
#define SQLITE_SQLITEASYNCCONNECTION___C__DISPLAYCLASS73_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1E9FF830)
#define SQLITE_SQLITEASYNCCONNECTION___C__DISPLAYCLASS73_0__GETMAPPINGASYNC_B__0_OFFSET UNITYSDK_OFFSET(0x1EA04520)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteAsyncConnection___c__DisplayClass73_0_TypeDefinitionIndex = 39125;
