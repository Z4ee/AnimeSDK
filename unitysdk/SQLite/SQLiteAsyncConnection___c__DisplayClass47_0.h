...
#define SQLITE_SQLITEASYNCCONNECTION___C__DISPLAYCLASS47_0__CREATEINDEXASYNC_B__0_OFFSET UNITYSDK_OFFSET(0x1D639B80)
#define SQLITE_SQLITEASYNCCONNECTION___C__DISPLAYCLASS47_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1D636D10)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteAsyncConnection___c__DisplayClass47_0_TypeDefinitionIndex = 38438;

	class SQLiteAsyncConnection___c__DisplayClass47_0 : public ::System::Object
	{
	public:
		::System::String* tableName; // 0x10
		::Il2CppArray<::System::String*>* columnNames; // 0x18
