...
#define SQLITE_ORM_COLLATION_OFFSET UNITYSDK_OFFSET(0x1E9FC120)
#define SQLITE_ORM_FALLBACKVALUE_OFFSET UNITYSDK_OFFSET(0x1E9FC6D0)
#define SQLITE_ORM_GETFIELD_OFFSET UNITYSDK_OFFSET(0x1E9FC290)
#define SQLITE_ORM_GETINDICES_OFFSET UNITYSDK_OFFSET(0x1E9FC3B0)
#define SQLITE_ORM_GETPROPERTY_OFFSET UNITYSDK_OFFSET(0x1E9FC300)
#define SQLITE_ORM_GETTYPE_OFFSET UNITYSDK_OFFSET(0x1E9FB960)
#define SQLITE_ORM_INFLATEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1E9FC370)
#define SQLITE_ORM_ISAUTOINC_OFFSET UNITYSDK_OFFSET(0x1E9FC180)
#define SQLITE_ORM_ISFALLBACKONERROR_OFFSET UNITYSDK_OFFSET(0x1E9FC5C0)
#define SQLITE_ORM_ISMARKEDNOTNULL_OFFSET UNITYSDK_OFFSET(0x1E9FC4B0)
#define SQLITE_ORM_ISPK_OFFSET UNITYSDK_OFFSET(0x1E9FC010)
#define SQLITE_ORM_MAXSTRINGLENGTH_1_OFFSET UNITYSDK_OFFSET(0x1E9FC450)
#define SQLITE_ORM_MAXSTRINGLENGTH_OFFSET UNITYSDK_OFFSET(0x1E9FC3F0)
#define SQLITE_ORM_SQLDECL_OFFSET UNITYSDK_OFFSET(0x1E9FB9F0)
#define SQLITE_ORM_SQLTYPE_OFFSET UNITYSDK_OFFSET(0x1E9FBBB0)

namespace SQLite
{
	inline static constexpr unsigned int Orm_TypeDefinitionIndex = 39064;
