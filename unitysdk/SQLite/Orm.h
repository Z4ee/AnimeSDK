...
#define SQLITE_ORM_COLLATION_OFFSET UNITYSDK_OFFSET(0x1B277F20)
#define SQLITE_ORM_FALLBACKVALUE_OFFSET UNITYSDK_OFFSET(0x1B2784D0)
#define SQLITE_ORM_GETFIELD_OFFSET UNITYSDK_OFFSET(0x1B278090)
#define SQLITE_ORM_GETINDICES_OFFSET UNITYSDK_OFFSET(0x1B2781B0)
#define SQLITE_ORM_GETPROPERTY_OFFSET UNITYSDK_OFFSET(0x1B278100)
#define SQLITE_ORM_GETTYPE_OFFSET UNITYSDK_OFFSET(0x1B277760)
#define SQLITE_ORM_INFLATEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1B278170)
#define SQLITE_ORM_ISAUTOINC_OFFSET UNITYSDK_OFFSET(0x1B277F80)
#define SQLITE_ORM_ISFALLBACKONERROR_OFFSET UNITYSDK_OFFSET(0x1B2783C0)
#define SQLITE_ORM_ISMARKEDNOTNULL_OFFSET UNITYSDK_OFFSET(0x1B2782B0)
#define SQLITE_ORM_ISPK_OFFSET UNITYSDK_OFFSET(0x1B277E10)
#define SQLITE_ORM_MAXSTRINGLENGTH_1_OFFSET UNITYSDK_OFFSET(0x1B278250)
#define SQLITE_ORM_MAXSTRINGLENGTH_OFFSET UNITYSDK_OFFSET(0x1B2781F0)
#define SQLITE_ORM_SQLDECL_OFFSET UNITYSDK_OFFSET(0x1B2777F0)
#define SQLITE_ORM_SQLTYPE_OFFSET UNITYSDK_OFFSET(0x1B2779B0)

namespace SQLite
{
	inline static constexpr unsigned int Orm_TypeDefinitionIndex = 36793;
