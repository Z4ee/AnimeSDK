...
#define SQLITE_SQLITECONNECTION___C__DISPLAYCLASS120_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA09870)
#define SQLITE_SQLITECONNECTION___C__DISPLAYCLASS120_0__INSERTALL_B__0_OFFSET UNITYSDK_OFFSET(0x1EA0B3B0)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteConnection___c__DisplayClass120_0_TypeDefinitionIndex = 39033;
