...
#define SQLITE_TABLEMAPPING_COLUMN_GETMEMBERTYPE_OFFSET UNITYSDK_OFFSET(0x1B289B90)
#define SQLITE_TABLEMAPPING_COLUMN_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1B2775C0)
#define SQLITE_TABLEMAPPING_COLUMN_GET_COLLATION_OFFSET UNITYSDK_OFFSET(0x1B289A50)
#define SQLITE_TABLEMAPPING_COLUMN_GET_COLUMNTYPE_OFFSET UNITYSDK_OFFSET(0x1B289A30)
#define SQLITE_TABLEMAPPING_COLUMN_GET_FALLBACKVALUE_OFFSET UNITYSDK_OFFSET(0x1B289B70)
#define SQLITE_TABLEMAPPING_COLUMN_GET_INDICES_OFFSET UNITYSDK_OFFSET(0x1B289AD0)
#define SQLITE_TABLEMAPPING_COLUMN_GET_ISAUTOGUID_OFFSET UNITYSDK_OFFSET(0x1B289A90)
#define SQLITE_TABLEMAPPING_COLUMN_GET_ISAUTOINC_OFFSET UNITYSDK_OFFSET(0x1B289A70)
#define SQLITE_TABLEMAPPING_COLUMN_GET_ISFALLBACKONERROR_OFFSET UNITYSDK_OFFSET(0x1B289B50)
#define SQLITE_TABLEMAPPING_COLUMN_GET_ISNULLABLE_OFFSET UNITYSDK_OFFSET(0x1B289AF0)
#define SQLITE_TABLEMAPPING_COLUMN_GET_ISPK_OFFSET UNITYSDK_OFFSET(0x1B289AB0)
#define SQLITE_TABLEMAPPING_COLUMN_GET_MAXSTRINGLENGTH_OFFSET UNITYSDK_OFFSET(0x1B289B10)
#define SQLITE_TABLEMAPPING_COLUMN_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B2899D0)
#define SQLITE_TABLEMAPPING_COLUMN_GET_PROPERTYINFO_OFFSET UNITYSDK_OFFSET(0x1B2899F0)
#define SQLITE_TABLEMAPPING_COLUMN_GET_PROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B289910)
#define SQLITE_TABLEMAPPING_COLUMN_GET_STOREASTEXT_OFFSET UNITYSDK_OFFSET(0x1B289B30)
#define SQLITE_TABLEMAPPING_COLUMN_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1B285640)
#define SQLITE_TABLEMAPPING_COLUMN_SET_COLLATION_OFFSET UNITYSDK_OFFSET(0x1B289A60)
#define SQLITE_TABLEMAPPING_COLUMN_SET_COLUMNTYPE_OFFSET UNITYSDK_OFFSET(0x1B289A40)
#define SQLITE_TABLEMAPPING_COLUMN_SET_FALLBACKVALUE_OFFSET UNITYSDK_OFFSET(0x1B289B80)
#define SQLITE_TABLEMAPPING_COLUMN_SET_INDICES_OFFSET UNITYSDK_OFFSET(0x1B289AE0)
#define SQLITE_TABLEMAPPING_COLUMN_SET_ISAUTOGUID_OFFSET UNITYSDK_OFFSET(0x1B289AA0)
#define SQLITE_TABLEMAPPING_COLUMN_SET_ISAUTOINC_OFFSET UNITYSDK_OFFSET(0x1B289A80)
#define SQLITE_TABLEMAPPING_COLUMN_SET_ISFALLBACKONERROR_OFFSET UNITYSDK_OFFSET(0x1B289B60)
#define SQLITE_TABLEMAPPING_COLUMN_SET_ISNULLABLE_OFFSET UNITYSDK_OFFSET(0x1B289B00)
#define SQLITE_TABLEMAPPING_COLUMN_SET_ISPK_OFFSET UNITYSDK_OFFSET(0x1B289AC0)
#define SQLITE_TABLEMAPPING_COLUMN_SET_MAXSTRINGLENGTH_OFFSET UNITYSDK_OFFSET(0x1B289B20)
#define SQLITE_TABLEMAPPING_COLUMN_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1B2899E0)
#define SQLITE_TABLEMAPPING_COLUMN_SET_STOREASTEXT_OFFSET UNITYSDK_OFFSET(0x1B289B40)
#define SQLITE_TABLEMAPPING_COLUMN__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B289C90)
#define SQLITE_TABLEMAPPING_COLUMN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B288E30)

namespace SQLite
{
	inline static constexpr unsigned int TableMapping_Column_TypeDefinitionIndex = 36783;
	...
	public:
		...
		::System::Object* _FallbackValue_k__BackingField; // 0x18
		::System::String* _Collation_k__BackingField; // 0x20
		...
		::System::Boolean _IsFallbackOnError_k__BackingField; // 0x41
		::System::Boolean _IsAutoInc_k__BackingField; // 0x42
		::System::Boolean _IsNullable_k__BackingField; // 0x43
		::System::Nullable_1<::System::Int32> _MaxStringLength_k__BackingField; // 0x44
		::System::Boolean _IsPK_k__BackingField; // 0x4C
