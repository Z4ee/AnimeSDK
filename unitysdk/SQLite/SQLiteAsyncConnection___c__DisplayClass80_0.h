...
#define SQLITE_SQLITEASYNCCONNECTION___C__DISPLAYCLASS80_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B27BA40)
#define SQLITE_SQLITEASYNCCONNECTION___C__DISPLAYCLASS80_0__RUNINTRANSACTIONASYNC_B__0_OFFSET UNITYSDK_OFFSET(0x1B281760)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteAsyncConnection___c__DisplayClass80_0_TypeDefinitionIndex = 36861;
