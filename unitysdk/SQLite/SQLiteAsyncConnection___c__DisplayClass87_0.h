...
#define SQLITE_SQLITEASYNCCONNECTION___C__DISPLAYCLASS87_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1D637F20)
#define SQLITE_SQLITEASYNCCONNECTION___C__DISPLAYCLASS87_0__DEFERREDQUERYASYNC_B__0_OFFSET UNITYSDK_OFFSET(0x1D63DF30)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteAsyncConnection___c__DisplayClass87_0_TypeDefinitionIndex = 38477;
