...
#define SQLITE_SQLITEASYNCCONNECTION___C__DISPLAYCLASS87_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1E9FFDF0)
#define SQLITE_SQLITEASYNCCONNECTION___C__DISPLAYCLASS87_0__DEFERREDQUERYASYNC_B__0_OFFSET UNITYSDK_OFFSET(0x1EA05E20)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteAsyncConnection___c__DisplayClass87_0_TypeDefinitionIndex = 39138;
