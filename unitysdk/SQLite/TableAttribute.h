...
#define SQLITE_TABLEATTRIBUTE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1D644A60)
#define SQLITE_TABLEATTRIBUTE_GET_WITHOUTROWID_OFFSET UNITYSDK_OFFSET(0x1D644A80)
#define SQLITE_TABLEATTRIBUTE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1D644A70)
#define SQLITE_TABLEATTRIBUTE_SET_WITHOUTROWID_OFFSET UNITYSDK_OFFSET(0x1D644A90)
#define SQLITE_TABLEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D644AA0)

namespace SQLite
{
	inline static constexpr unsigned int TableAttribute_TypeDefinitionIndex = 38379;
