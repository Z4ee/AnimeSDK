...
#define SQLITE_SQLITEASYNCCONNECTION___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B279820)
#define SQLITE_SQLITEASYNCCONNECTION___C__DISPLAYCLASS11_0__SETBUSYTIMEOUTASYNC_B__0_OFFSET UNITYSDK_OFFSET(0x1B27C130)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteAsyncConnection___c__DisplayClass11_0_TypeDefinitionIndex = 36815;
