...
#define SQLITE_NOTNULLCONSTRAINTVIOLATIONEXCEPTION_GET_COLUMNS_OFFSET UNITYSDK_OFFSET(0x1D6333E0)
#define SQLITE_NOTNULLCONSTRAINTVIOLATIONEXCEPTION_NEW_1_OFFSET UNITYSDK_OFFSET(0x1D6337F0)
#define SQLITE_NOTNULLCONSTRAINTVIOLATIONEXCEPTION_NEW_2_OFFSET UNITYSDK_OFFSET(0x1D633860)
#define SQLITE_NOTNULLCONSTRAINTVIOLATIONEXCEPTION_NEW_OFFSET UNITYSDK_OFFSET(0x1D6336D0)
#define SQLITE_NOTNULLCONSTRAINTVIOLATIONEXCEPTION_SET_COLUMNS_OFFSET UNITYSDK_OFFSET(0x1D6333F0)
#define SQLITE_NOTNULLCONSTRAINTVIOLATIONEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D6334E0)
#define SQLITE_NOTNULLCONSTRAINTVIOLATIONEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D633400)

namespace SQLite
{
	inline static constexpr unsigned int NotNullConstraintViolationException_TypeDefinitionIndex = 38361;
