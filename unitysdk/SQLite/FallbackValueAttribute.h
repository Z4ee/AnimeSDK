...
#define SQLITE_FALLBACKVALUEATTRIBUTE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B276DC0)
#define SQLITE_FALLBACKVALUEATTRIBUTE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B276DD0)
#define SQLITE_FALLBACKVALUEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B276DE0)

namespace SQLite
{
	inline static constexpr unsigned int FallbackValueAttribute_TypeDefinitionIndex = 36780;
