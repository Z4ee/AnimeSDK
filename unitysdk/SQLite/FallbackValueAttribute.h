...
#define SQLITE_FALLBACKVALUEATTRIBUTE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1E9FAFC0)
#define SQLITE_FALLBACKVALUEATTRIBUTE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1E9FAFD0)
#define SQLITE_FALLBACKVALUEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E9FAFE0)

namespace SQLite
{
	inline static constexpr unsigned int FallbackValueAttribute_TypeDefinitionIndex = 39051;
