...
#define SQLITE_INDEXEDATTRIBUTE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B276FC0)
#define SQLITE_INDEXEDATTRIBUTE_GET_ORDER_OFFSET UNITYSDK_OFFSET(0x1B276FE0)
#define SQLITE_INDEXEDATTRIBUTE_GET_UNIQUE_OFFSET UNITYSDK_OFFSET(0x1B277000)
#define SQLITE_INDEXEDATTRIBUTE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1B276FD0)
#define SQLITE_INDEXEDATTRIBUTE_SET_ORDER_OFFSET UNITYSDK_OFFSET(0x1B276FF0)
#define SQLITE_INDEXEDATTRIBUTE_SET_UNIQUE_OFFSET UNITYSDK_OFFSET(0x1B277010)
#define SQLITE_INDEXEDATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B277030)
#define SQLITE_INDEXEDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B277020)

namespace SQLite
{
	inline static constexpr unsigned int IndexedAttribute_TypeDefinitionIndex = 36773;
