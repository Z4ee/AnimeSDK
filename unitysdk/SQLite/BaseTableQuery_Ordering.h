...
#define SQLITE_BASETABLEQUERY_ORDERING_GET_ASCENDING_OFFSET UNITYSDK_OFFSET(0x1B276210)
#define SQLITE_BASETABLEQUERY_ORDERING_GET_COLUMNNAME_OFFSET UNITYSDK_OFFSET(0x1B2761F0)
#define SQLITE_BASETABLEQUERY_ORDERING_SET_ASCENDING_OFFSET UNITYSDK_OFFSET(0x1B276220)
#define SQLITE_BASETABLEQUERY_ORDERING_SET_COLUMNNAME_OFFSET UNITYSDK_OFFSET(0x1B276200)
#define SQLITE_BASETABLEQUERY_ORDERING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B276230)

namespace SQLite
{
	inline static constexpr unsigned int BaseTableQuery_Ordering_TypeDefinitionIndex = 36809;
