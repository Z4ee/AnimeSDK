...
#define SQLITE_PREPAREDSQLLITEINSERTCOMMAND_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1D6355A0)
#define SQLITE_PREPAREDSQLLITEINSERTCOMMAND_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D6354D0)
#define SQLITE_PREPAREDSQLLITEINSERTCOMMAND_EXECUTENONQUERY_OFFSET UNITYSDK_OFFSET(0x1D634A60)
#define SQLITE_PREPAREDSQLLITEINSERTCOMMAND_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1D6355D0)
#define SQLITE_PREPAREDSQLLITEINSERTCOMMAND__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D635660)
#define SQLITE_PREPAREDSQLLITEINSERTCOMMAND__CTOR_OFFSET UNITYSDK_OFFSET(0x1D634A50)

namespace SQLite
{
	inline static constexpr unsigned int PreparedSqlLiteInsertCommand_TypeDefinitionIndex = 38415;
	...
	public:
		...
		{
			return (::System::IntPtr*)Il2CppClass::FromTypeDefinitionIndex(PreparedSqlLiteInsertCommand_TypeDefinitionIndex)->GetStaticField(0x8E10);
		}
