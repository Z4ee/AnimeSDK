...
#define SQLITE_SQLITECONNECTIONPOOL_ENTRY_CLOSE_OFFSET UNITYSDK_OFFSET(0x1B287F30)
#define SQLITE_SQLITECONNECTIONPOOL_ENTRY_GET_CONNECTIONSTRING_OFFSET UNITYSDK_OFFSET(0x1B288100)
#define SQLITE_SQLITECONNECTIONPOOL_ENTRY_GET_CONNECTION_OFFSET UNITYSDK_OFFSET(0x1B2880E0)
#define SQLITE_SQLITECONNECTIONPOOL_ENTRY_GET_TRANSACTIONLOCK_OFFSET UNITYSDK_OFFSET(0x1B288110)
#define SQLITE_SQLITECONNECTIONPOOL_ENTRY_SET_CONNECTION_OFFSET UNITYSDK_OFFSET(0x1B2880F0)
#define SQLITE_SQLITECONNECTIONPOOL_ENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B287E00)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteConnectionPool_Entry_TypeDefinitionIndex = 36879;

	class SQLiteConnectionPool_Entry : public ::System::Object
	{
	public:
		::SQLite::SQLiteConnectionWithLock* _Connection_k__BackingField; // 0x10
		::System::Object* _TransactionLock_k__BackingField; // 0x18
		::SQLite::SQLiteConnectionString* _ConnectionString_k__BackingField; // 0x20
