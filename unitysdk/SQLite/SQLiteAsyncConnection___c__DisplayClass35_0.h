...
#define SQLITE_SQLITEASYNCCONNECTION___C__DISPLAYCLASS35_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B27A560)
#define SQLITE_SQLITEASYNCCONNECTION___C__DISPLAYCLASS35_0__ENABLELOADEXTENSIONASYNC_B__0_OFFSET UNITYSDK_OFFSET(0x1B27C2B0)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteAsyncConnection___c__DisplayClass35_0_TypeDefinitionIndex = 36820;
