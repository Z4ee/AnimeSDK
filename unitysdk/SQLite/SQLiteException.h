...
#define SQLITE_SQLITEEXCEPTION_GET_RESULT_OFFSET UNITYSDK_OFFSET(0x1EA0C8C0)
#define SQLITE_SQLITEEXCEPTION_NEW_OFFSET UNITYSDK_OFFSET(0x1E9FCC40)
#define SQLITE_SQLITEEXCEPTION_SET_RESULT_OFFSET UNITYSDK_OFFSET(0x1EA0C8D0)
#define SQLITE_SQLITEEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E9FB4E0)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteException_TypeDefinitionIndex = 39020;
