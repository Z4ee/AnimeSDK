...
#define SQLITE_SQLITECONNECTION_ADD_TABLECHANGED_OFFSET UNITYSDK_OFFSET(0x1B286B00)
#define SQLITE_SQLITECONNECTION_BACKUP_OFFSET UNITYSDK_OFFSET(0x1B27FC30)
#define SQLITE_SQLITECONNECTION_BEGINTRANSACTION_OFFSET UNITYSDK_OFFSET(0x1B281830)
#define SQLITE_SQLITECONNECTION_CLOSE_OFFSET UNITYSDK_OFFSET(0x1B286610)
#define SQLITE_SQLITECONNECTION_COMMIT_OFFSET UNITYSDK_OFFSET(0x1B281970)
#define SQLITE_SQLITECONNECTION_CREATECOMMAND_1_OFFSET UNITYSDK_OFFSET(0x1B284C80)
#define SQLITE_SQLITECONNECTION_CREATECOMMAND_OFFSET UNITYSDK_OFFSET(0x1B284B40)
#define SQLITE_SQLITECONNECTION_CREATEINDEX_1_OFFSET UNITYSDK_OFFSET(0x1B27D7A0)
#define SQLITE_SQLITECONNECTION_CREATEINDEX_2_OFFSET UNITYSDK_OFFSET(0x1B27D640)
#define SQLITE_SQLITECONNECTION_CREATEINDEX_3_OFFSET UNITYSDK_OFFSET(0x1B27D920)
#define SQLITE_SQLITECONNECTION_CREATEINDEX_OFFSET UNITYSDK_OFFSET(0x1B27DA40)
#define SQLITE_SQLITECONNECTION_CREATEINSERTCOMMAND_OFFSET UNITYSDK_OFFSET(0x1B285EE0)
#define SQLITE_SQLITECONNECTION_CREATETABLES_OFFSET UNITYSDK_OFFSET(0x1B27D340)
#define SQLITE_SQLITECONNECTION_CREATETABLE_OFFSET UNITYSDK_OFFSET(0x1B27C3D0)
#define SQLITE_SQLITECONNECTION_DEFERREDQUERY_OFFSET UNITYSDK_OFFSET(0x1B281C70)
#define SQLITE_SQLITECONNECTION_DELETEALL_OFFSET UNITYSDK_OFFSET(0x1B27FAA0)
#define SQLITE_SQLITECONNECTION_DELETE_1_OFFSET UNITYSDK_OFFSET(0x1B27F6E0)
#define SQLITE_SQLITECONNECTION_DELETE_OFFSET UNITYSDK_OFFSET(0x1B27F3D0)
#define SQLITE_SQLITECONNECTION_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1B286630)
#define SQLITE_SQLITECONNECTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B286560)
#define SQLITE_SQLITECONNECTION_DOSAVEPOINTEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B285310)
#define SQLITE_SQLITECONNECTION_DROPTABLE_OFFSET UNITYSDK_OFFSET(0x1B27D580)
#define SQLITE_SQLITECONNECTION_ENABLELOADEXTENSION_OFFSET UNITYSDK_OFFSET(0x1B27C330)
#define SQLITE_SQLITECONNECTION_ENABLEWRITEAHEADLOGGING_OFFSET UNITYSDK_OFFSET(0x1B27C0E0)
#define SQLITE_SQLITECONNECTION_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1B280880)
#define SQLITE_SQLITECONNECTION_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B2864F0)
#define SQLITE_SQLITECONNECTION_FINDWITHQUERY_OFFSET UNITYSDK_OFFSET(0x1B280210)
#define SQLITE_SQLITECONNECTION_FIND_OFFSET UNITYSDK_OFFSET(0x1B27FF80)
#define SQLITE_SQLITECONNECTION_GETINSERTCOMMAND_OFFSET UNITYSDK_OFFSET(0x1B285870)
#define SQLITE_SQLITECONNECTION_GETMAPPING_OFFSET UNITYSDK_OFFSET(0x1B280310)
#define SQLITE_SQLITECONNECTION_GETTABLEINFO_OFFSET UNITYSDK_OFFSET(0x1B2807C0)
#define SQLITE_SQLITECONNECTION_GET_BUSYTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1B283F00)
#define SQLITE_SQLITECONNECTION_GET_DATABASEPATH_OFFSET UNITYSDK_OFFSET(0x1B2834F0)
#define SQLITE_SQLITECONNECTION_GET_DATETIMESTRINGFORMAT_OFFSET UNITYSDK_OFFSET(0x1B2835F0)
#define SQLITE_SQLITECONNECTION_GET_DATETIMESTYLE_OFFSET UNITYSDK_OFFSET(0x1B283610)
#define SQLITE_SQLITECONNECTION_GET_HANDLE_OFFSET UNITYSDK_OFFSET(0x1B2834D0)
#define SQLITE_SQLITECONNECTION_GET_ISINTRANSACTION_OFFSET UNITYSDK_OFFSET(0x1B284E70)
#define SQLITE_SQLITECONNECTION_GET_LIBVERSIONNUMBER_OFFSET UNITYSDK_OFFSET(0x1B283510)
#define SQLITE_SQLITECONNECTION_GET_OFFSET UNITYSDK_OFFSET(0x1B27FDB0)
#define SQLITE_SQLITECONNECTION_GET_STOREDATETIMEASTICKS_OFFSET UNITYSDK_OFFSET(0x1B283590)
#define SQLITE_SQLITECONNECTION_GET_STOREDATETIMOFFSETASTICKS_OFFSET UNITYSDK_OFFSET(0x1B2835D0)
#define SQLITE_SQLITECONNECTION_GET_STORETIMESPANASTICKS_OFFSET UNITYSDK_OFFSET(0x1B2835B0)
#define SQLITE_SQLITECONNECTION_GET_TABLEMAPPINGS_OFFSET UNITYSDK_OFFSET(0x1B279A60)
#define SQLITE_SQLITECONNECTION_GET_TIMEEXECUTION_OFFSET UNITYSDK_OFFSET(0x1B283530)
#define SQLITE_SQLITECONNECTION_GET_TRACER_OFFSET UNITYSDK_OFFSET(0x1B283570)
#define SQLITE_SQLITECONNECTION_GET_TRACE_OFFSET UNITYSDK_OFFSET(0x1B283550)
#define SQLITE_SQLITECONNECTION_INSERTALL_1_OFFSET UNITYSDK_OFFSET(0x1B280F40)
#define SQLITE_SQLITECONNECTION_INSERTALL_2_OFFSET UNITYSDK_OFFSET(0x1B281390)
#define SQLITE_SQLITECONNECTION_INSERTALL_OFFSET UNITYSDK_OFFSET(0x1B280B60)
#define SQLITE_SQLITECONNECTION_INSERTORREPLACE_1_OFFSET UNITYSDK_OFFSET(0x1B27E7D0)
#define SQLITE_SQLITECONNECTION_INSERTORREPLACE_OFFSET UNITYSDK_OFFSET(0x1B27E6C0)
#define SQLITE_SQLITECONNECTION_INSERT_1_OFFSET UNITYSDK_OFFSET(0x1B27DEF0)
#define SQLITE_SQLITECONNECTION_INSERT_2_OFFSET UNITYSDK_OFFSET(0x1B27DFE0)
#define SQLITE_SQLITECONNECTION_INSERT_3_OFFSET UNITYSDK_OFFSET(0x1B27E0A0)
#define SQLITE_SQLITECONNECTION_INSERT_OFFSET UNITYSDK_OFFSET(0x1B27DDE0)
#define SQLITE_SQLITECONNECTION_MIGRATETABLE_OFFSET UNITYSDK_OFFSET(0x1B284600)
#define SQLITE_SQLITECONNECTION_NEWCOMMAND_OFFSET UNITYSDK_OFFSET(0x1B284A90)
#define SQLITE_SQLITECONNECTION_ONTABLECHANGED_OFFSET UNITYSDK_OFFSET(0x1B285E10)
#define SQLITE_SQLITECONNECTION_QUERY_OFFSET UNITYSDK_OFFSET(0x1B281B20)
#define SQLITE_SQLITECONNECTION_QUOTE_OFFSET UNITYSDK_OFFSET(0x1B283E90)
#define SQLITE_SQLITECONNECTION_REKEY_1_OFFSET UNITYSDK_OFFSET(0x1B281E40)
#define SQLITE_SQLITECONNECTION_REKEY_OFFSET UNITYSDK_OFFSET(0x1B281D00)
#define SQLITE_SQLITECONNECTION_RELEASE_OFFSET UNITYSDK_OFFSET(0x1B285430)
#define SQLITE_SQLITECONNECTION_REMOVE_TABLECHANGED_OFFSET UNITYSDK_OFFSET(0x1B286B80)
#define SQLITE_SQLITECONNECTION_ROLLBACKTO_1_OFFSET UNITYSDK_OFFSET(0x1B284E80)
#define SQLITE_SQLITECONNECTION_ROLLBACKTO_OFFSET UNITYSDK_OFFSET(0x1B285300)
#define SQLITE_SQLITECONNECTION_ROLLBACK_OFFSET UNITYSDK_OFFSET(0x1B281A60)
#define SQLITE_SQLITECONNECTION_RUNINTRANSACTION_OFFSET UNITYSDK_OFFSET(0x1B285550)
#define SQLITE_SQLITECONNECTION_SAVETRANSACTIONPOINT_OFFSET UNITYSDK_OFFSET(0x1B284F80)
#define SQLITE_SQLITECONNECTION_SETKEY_1_OFFSET UNITYSDK_OFFSET(0x1B283CF0)
#define SQLITE_SQLITECONNECTION_SETKEY_OFFSET UNITYSDK_OFFSET(0x1B283BE0)
#define SQLITE_SQLITECONNECTION_SET_BUSYTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1B27C1F0)
#define SQLITE_SQLITECONNECTION_SET_DATABASEPATH_OFFSET UNITYSDK_OFFSET(0x1B283500)
#define SQLITE_SQLITECONNECTION_SET_DATETIMESTRINGFORMAT_OFFSET UNITYSDK_OFFSET(0x1B283600)
#define SQLITE_SQLITECONNECTION_SET_DATETIMESTYLE_OFFSET UNITYSDK_OFFSET(0x1B283620)
#define SQLITE_SQLITECONNECTION_SET_HANDLE_OFFSET UNITYSDK_OFFSET(0x1B2834E0)
#define SQLITE_SQLITECONNECTION_SET_LIBVERSIONNUMBER_OFFSET UNITYSDK_OFFSET(0x1B283520)
#define SQLITE_SQLITECONNECTION_SET_STOREDATETIMEASTICKS_OFFSET UNITYSDK_OFFSET(0x1B2835A0)
#define SQLITE_SQLITECONNECTION_SET_STOREDATETIMOFFSETASTICKS_OFFSET UNITYSDK_OFFSET(0x1B2835E0)
#define SQLITE_SQLITECONNECTION_SET_STORETIMESPANASTICKS_OFFSET UNITYSDK_OFFSET(0x1B2835C0)
#define SQLITE_SQLITECONNECTION_SET_TIMEEXECUTION_OFFSET UNITYSDK_OFFSET(0x1B283540)
#define SQLITE_SQLITECONNECTION_SET_TRACER_OFFSET UNITYSDK_OFFSET(0x1B283580)
#define SQLITE_SQLITECONNECTION_SET_TRACE_OFFSET UNITYSDK_OFFSET(0x1B283560)
#define SQLITE_SQLITECONNECTION_UPDATEALL_OFFSET UNITYSDK_OFFSET(0x1B27EF90)
#define SQLITE_SQLITECONNECTION_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x1B27E960)
#define SQLITE_SQLITECONNECTION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B27E8B0)
#define SQLITE_SQLITECONNECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B286C00)
#define SQLITE_SQLITECONNECTION__CREATETABLE_B__75_0_OFFSET UNITYSDK_OFFSET(0x1B286CA0)
#define SQLITE_SQLITECONNECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B283B50)
#define SQLITE_SQLITECONNECTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B2836C0)
#define SQLITE_SQLITECONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B283630)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteConnection_TypeDefinitionIndex = 36756;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::SQLite::TableMapping*>**)Il2CppClass::FromTypeDefinitionIndex(SQLiteConnection_TypeDefinitionIndex)->GetStaticField(0x27380);
		}
		static ::System::IntPtr* StaticGet_NullBackupHandle()
		{
			return (::System::IntPtr*)Il2CppClass::FromTypeDefinitionIndex(SQLiteConnection_TypeDefinitionIndex)->GetStaticField(0x8970);
		}
		static ::System::IntPtr* StaticGet_NullHandle()
		{
			return (::System::IntPtr*)Il2CppClass::FromTypeDefinitionIndex(SQLiteConnection_TypeDefinitionIndex)->GetStaticField(0x8978);
		}
		::System::String* _DateTimeStringFormat_k__BackingField; // 0x10
		::System::Diagnostics::Stopwatch* _sw; // 0x18
		::System::Action_1<::System::String*>* _Tracer_k__BackingField; // 0x20
		::System::String* _DatabasePath_k__BackingField; // 0x28
		::System::EventHandler_1<::SQLite::NotifyTableChangedEventArgs*>* TableChanged; // 0x30
		...
		::System::IntPtr _Handle_k__BackingField; // 0x48
		::System::Int64 _elapsedMilliseconds; // 0x50
		::System::Int32 _transactionDepth; // 0x58
		::System::Boolean _StoreDateTimOffsetAsTicks_k__BackingField; // 0x5C
		::System::Boolean _TimeExecution_k__BackingField; // 0x5D
		::System::Boolean _StoreTimeSpanAsTicks_k__BackingField; // 0x5E
		::System::Boolean _open; // 0x5F
		::System::TimeSpan _busyTimeout; // 0x60
		::System::Globalization::DateTimeStyles _DateTimeStyle_k__BackingField; // 0x68
		::System::Int32 _LibVersionNumber_k__BackingField; // 0x6C
		::System::Boolean _Trace_k__BackingField; // 0x70
		::System::Boolean _StoreDateTimeAsTicks_k__BackingField; // 0x71
