...
#define SQLITE_SQLITECOMMAND_BINDALL_OFFSET UNITYSDK_OFFSET(0x1B2826B0)
#define SQLITE_SQLITECOMMAND_BINDPARAMETER_OFFSET UNITYSDK_OFFSET(0x1B278B00)
#define SQLITE_SQLITECOMMAND_BIND_1_OFFSET UNITYSDK_OFFSET(0x1B282370)
#define SQLITE_SQLITECOMMAND_BIND_OFFSET UNITYSDK_OFFSET(0x1B2822E0)
#define SQLITE_SQLITECOMMAND_EXECUTENONQUERY_OFFSET UNITYSDK_OFFSET(0x1B282090)
#define SQLITE_SQLITECOMMAND_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B2822C0)
#define SQLITE_SQLITECOMMAND_GET_COMMANDTEXT_OFFSET UNITYSDK_OFFSET(0x1B281FE0)
#define SQLITE_SQLITECOMMAND_ONINSTANCECREATED_OFFSET UNITYSDK_OFFSET(0x1B2822D0)
#define SQLITE_SQLITECOMMAND_PREPARE_OFFSET UNITYSDK_OFFSET(0x1B282210)
#define SQLITE_SQLITECOMMAND_READCOL_OFFSET UNITYSDK_OFFSET(0x1B2828A0)
#define SQLITE_SQLITECOMMAND_SET_COMMANDTEXT_OFFSET UNITYSDK_OFFSET(0x1B281FF0)
#define SQLITE_SQLITECOMMAND_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B2823F0)
#define SQLITE_SQLITECOMMAND__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B283460)
#define SQLITE_SQLITECOMMAND__CTOR_OFFSET UNITYSDK_OFFSET(0x1B282000)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteCommand_TypeDefinitionIndex = 36795;
	...
	public:
		...
		{
			return (::System::IntPtr*)Il2CppClass::FromTypeDefinitionIndex(SQLiteCommand_TypeDefinitionIndex)->GetStaticField(0x8960);
		}
