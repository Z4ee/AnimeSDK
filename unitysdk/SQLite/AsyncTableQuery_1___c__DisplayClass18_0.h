...
namespace SQLite
{
	inline static constexpr unsigned int AsyncTableQuery_1___c__DisplayClass18_0_TypeDefinitionIndex = 39146;

	template <typename T>
	class AsyncTableQuery_1___c__DisplayClass18_0 : public ::System::Object
	{
	public:
