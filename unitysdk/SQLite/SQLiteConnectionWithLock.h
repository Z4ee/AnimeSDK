...
#define SQLITE_SQLITECONNECTIONWITHLOCK_GET_SKIPLOCK_OFFSET UNITYSDK_OFFSET(0x1D6446B0)
#define SQLITE_SQLITECONNECTIONWITHLOCK_LOCK_OFFSET UNITYSDK_OFFSET(0x1D6446D0)
#define SQLITE_SQLITECONNECTIONWITHLOCK_SET_SKIPLOCK_OFFSET UNITYSDK_OFFSET(0x1D6446C0)
#define SQLITE_SQLITECONNECTIONWITHLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D644480)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteConnectionWithLock_TypeDefinitionIndex = 38490;
