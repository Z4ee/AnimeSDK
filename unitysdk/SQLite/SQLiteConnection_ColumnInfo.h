...
#define SQLITE_SQLITECONNECTION_COLUMNINFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B287D40)
#define SQLITE_SQLITECONNECTION_COLUMNINFO_GET_NOTNULL_OFFSET UNITYSDK_OFFSET(0x1B287D60)
#define SQLITE_SQLITECONNECTION_COLUMNINFO_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1B287D50)
#define SQLITE_SQLITECONNECTION_COLUMNINFO_SET_NOTNULL_OFFSET UNITYSDK_OFFSET(0x1B287D70)
#define SQLITE_SQLITECONNECTION_COLUMNINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B287D80)
#define SQLITE_SQLITECONNECTION_COLUMNINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B287D90)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteConnection_ColumnInfo_TypeDefinitionIndex = 36759;
