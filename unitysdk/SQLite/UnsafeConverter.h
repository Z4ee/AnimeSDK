...
#define SQLITE_UNSAFECONVERTER_TOINT_OFFSET UNITYSDK_OFFSET(0x1B282880)
#define SQLITE_UNSAFECONVERTER_TOLONG_OFFSET UNITYSDK_OFFSET(0x1B282890)
#define SQLITE_UNSAFECONVERTER_TOUINT_OFFSET UNITYSDK_OFFSET(0x1B283450)
#define SQLITE_UNSAFECONVERTER_TOULONG_OFFSET UNITYSDK_OFFSET(0x1B283440)

namespace SQLite
{
	inline static constexpr unsigned int UnsafeConverter_TypeDefinitionIndex = 36883;
