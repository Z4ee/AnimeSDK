...
#define SQLITE_UNSAFECONVERTER_TOINT_OFFSET UNITYSDK_OFFSET(0x1D63EBE0)
#define SQLITE_UNSAFECONVERTER_TOLONG_OFFSET UNITYSDK_OFFSET(0x1D63EBF0)
#define SQLITE_UNSAFECONVERTER_TOUINT_OFFSET UNITYSDK_OFFSET(0x1D63F7B0)
#define SQLITE_UNSAFECONVERTER_TOULONG_OFFSET UNITYSDK_OFFSET(0x1D63F7A0)

namespace SQLite
{
	inline static constexpr unsigned int UnsafeConverter_TypeDefinitionIndex = 38493;
