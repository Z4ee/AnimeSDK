...
#define SQLITE_NOTIFYTABLECHANGEDEVENTARGS_GET_ACTION_OFFSET UNITYSDK_OFFSET(0x1B2776E0)
#define SQLITE_NOTIFYTABLECHANGEDEVENTARGS_GET_TABLE_OFFSET UNITYSDK_OFFSET(0x1B2776C0)
#define SQLITE_NOTIFYTABLECHANGEDEVENTARGS_SET_ACTION_OFFSET UNITYSDK_OFFSET(0x1B2776F0)
#define SQLITE_NOTIFYTABLECHANGEDEVENTARGS_SET_TABLE_OFFSET UNITYSDK_OFFSET(0x1B2776D0)
#define SQLITE_NOTIFYTABLECHANGEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B277700)

namespace SQLite
{
	inline static constexpr unsigned int NotifyTableChangedEventArgs_TypeDefinitionIndex = 36766;
