...
#define SQLITE_SQLITECONNECTIONSTRING_GET_DATABASEPATH_OFFSET UNITYSDK_OFFSET(0x1EA0C380)
#define SQLITE_SQLITECONNECTIONSTRING_GET_DATETIMESTRINGFORMAT_OFFSET UNITYSDK_OFFSET(0x1EA0C3C0)
#define SQLITE_SQLITECONNECTIONSTRING_GET_DATETIMESTYLE_OFFSET UNITYSDK_OFFSET(0x1EA0C3D0)
#define SQLITE_SQLITECONNECTIONSTRING_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1EA0C3E0)
#define SQLITE_SQLITECONNECTIONSTRING_GET_OPENFLAGS_OFFSET UNITYSDK_OFFSET(0x1EA0C3F0)
#define SQLITE_SQLITECONNECTIONSTRING_GET_POSTKEYACTION_OFFSET UNITYSDK_OFFSET(0x1EA0C410)
#define SQLITE_SQLITECONNECTIONSTRING_GET_PREKEYACTION_OFFSET UNITYSDK_OFFSET(0x1EA0C400)
#define SQLITE_SQLITECONNECTIONSTRING_GET_STOREDATETIMEASTICKS_OFFSET UNITYSDK_OFFSET(0x1EA0C390)
#define SQLITE_SQLITECONNECTIONSTRING_GET_STOREDATETIMOFFSETASTICKS_OFFSET UNITYSDK_OFFSET(0x1EA0C3B0)
#define SQLITE_SQLITECONNECTIONSTRING_GET_STORETIMESPANASTICKS_OFFSET UNITYSDK_OFFSET(0x1EA0C3A0)
#define SQLITE_SQLITECONNECTIONSTRING_GET_UNIQUEKEY_OFFSET UNITYSDK_OFFSET(0x1EA0C370)
#define SQLITE_SQLITECONNECTIONSTRING_GET_VFSNAME_OFFSET UNITYSDK_OFFSET(0x1EA0C420)
#define SQLITE_SQLITECONNECTIONSTRING__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EA0C4A0)
#define SQLITE_SQLITECONNECTIONSTRING__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E9FD650)
#define SQLITE_SQLITECONNECTIONSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA0C430)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteConnectionString_TypeDefinitionIndex = 39039;
	...
	public:
		...
		::System::Action_1<::SQLite::SQLiteConnection*>* _PostKeyAction_k__BackingField; // 0x18
		::System::String* _UniqueKey_k__BackingField; // 0x20
		::System::String* _DateTimeStringFormat_k__BackingField; // 0x28
		::System::String* _DatabasePath_k__BackingField; // 0x30
		::System::String* _VfsName_k__BackingField; // 0x38
		::System::Object* _Key_k__BackingField; // 0x40
		::System::Boolean _StoreDateTimeAsTicks_k__BackingField; // 0x48
		::System::Boolean _StoreTimeSpanAsTicks_k__BackingField; // 0x49
		::System::Boolean _StoreDateTimOffsetAsTicks_k__BackingField; // 0x4A
