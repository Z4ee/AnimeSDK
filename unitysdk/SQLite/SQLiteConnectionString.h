...
#define SQLITE_SQLITECONNECTIONSTRING_GET_DATABASEPATH_OFFSET UNITYSDK_OFFSET(0x1D6444F0)
#define SQLITE_SQLITECONNECTIONSTRING_GET_DATETIMESTRINGFORMAT_OFFSET UNITYSDK_OFFSET(0x1D644530)
#define SQLITE_SQLITECONNECTIONSTRING_GET_DATETIMESTYLE_OFFSET UNITYSDK_OFFSET(0x1D644540)
#define SQLITE_SQLITECONNECTIONSTRING_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1D644550)
#define SQLITE_SQLITECONNECTIONSTRING_GET_OPENFLAGS_OFFSET UNITYSDK_OFFSET(0x1D644560)
#define SQLITE_SQLITECONNECTIONSTRING_GET_POSTKEYACTION_OFFSET UNITYSDK_OFFSET(0x1D644580)
#define SQLITE_SQLITECONNECTIONSTRING_GET_PREKEYACTION_OFFSET UNITYSDK_OFFSET(0x1D644570)
#define SQLITE_SQLITECONNECTIONSTRING_GET_STOREDATETIMEASTICKS_OFFSET UNITYSDK_OFFSET(0x1D644500)
#define SQLITE_SQLITECONNECTIONSTRING_GET_STOREDATETIMOFFSETASTICKS_OFFSET UNITYSDK_OFFSET(0x1D644520)
#define SQLITE_SQLITECONNECTIONSTRING_GET_STORETIMESPANASTICKS_OFFSET UNITYSDK_OFFSET(0x1D644510)
#define SQLITE_SQLITECONNECTIONSTRING_GET_UNIQUEKEY_OFFSET UNITYSDK_OFFSET(0x1D6444E0)
#define SQLITE_SQLITECONNECTIONSTRING_GET_VFSNAME_OFFSET UNITYSDK_OFFSET(0x1D644590)
#define SQLITE_SQLITECONNECTIONSTRING__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D644610)
#define SQLITE_SQLITECONNECTIONSTRING__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D635720)
#define SQLITE_SQLITECONNECTIONSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6445A0)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteConnectionString_TypeDefinitionIndex = 38378;

	class SQLiteConnectionString : public ::System::Object
	{
	public:
		// static const ::System::String* DateTimeSqliteDefaultFormat; // 0x0
		::System::Action_1<::SQLite::SQLiteConnection*>* _PreKeyAction_k__BackingField; // 0x10
		::System::Object* _Key_k__BackingField; // 0x18
		::System::Action_1<::SQLite::SQLiteConnection*>* _PostKeyAction_k__BackingField; // 0x20
		::System::String* _UniqueKey_k__BackingField; // 0x28
		::System::String* _VfsName_k__BackingField; // 0x30
		::System::String* _DatabasePath_k__BackingField; // 0x38
		::System::String* _DateTimeStringFormat_k__BackingField; // 0x40
		::System::Boolean _StoreDateTimOffsetAsTicks_k__BackingField; // 0x48
		::System::Boolean _StoreTimeSpanAsTicks_k__BackingField; // 0x49
		::System::Boolean _StoreDateTimeAsTicks_k__BackingField; // 0x4A
		::SQLite::SQLiteOpenFlags _OpenFlags_k__BackingField; // 0x4C
		::System::Globalization::DateTimeStyles _DateTimeStyle_k__BackingField; // 0x50
