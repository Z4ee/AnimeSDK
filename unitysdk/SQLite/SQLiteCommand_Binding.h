...
#define SQLITE_SQLITECOMMAND_BINDING_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x1EA076F0)
#define SQLITE_SQLITECOMMAND_BINDING_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1EA076B0)
#define SQLITE_SQLITECOMMAND_BINDING_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1EA076D0)
#define SQLITE_SQLITECOMMAND_BINDING_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x1EA07700)
#define SQLITE_SQLITECOMMAND_BINDING_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1EA076C0)
#define SQLITE_SQLITECOMMAND_BINDING_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1EA076E0)
#define SQLITE_SQLITECOMMAND_BINDING__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA065B0)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteCommand_Binding_TypeDefinitionIndex = 39067;
