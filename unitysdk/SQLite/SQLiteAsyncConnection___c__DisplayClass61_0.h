...
#define SQLITE_SQLITEASYNCCONNECTION___C__DISPLAYCLASS61_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1D637540)
#define SQLITE_SQLITEASYNCCONNECTION___C__DISPLAYCLASS61_0__DELETEASYNC_B__0_OFFSET UNITYSDK_OFFSET(0x1D63BA20)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteAsyncConnection___c__DisplayClass61_0_TypeDefinitionIndex = 38452;
