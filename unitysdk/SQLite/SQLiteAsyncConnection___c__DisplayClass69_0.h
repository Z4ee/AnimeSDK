...
#define SQLITE_SQLITEASYNCCONNECTION___C__DISPLAYCLASS69_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6377F0)
#define SQLITE_SQLITEASYNCCONNECTION___C__DISPLAYCLASS69_0__FINDASYNC_B__0_OFFSET UNITYSDK_OFFSET(0x1D63C2C0)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteAsyncConnection___c__DisplayClass69_0_TypeDefinitionIndex = 38460;
