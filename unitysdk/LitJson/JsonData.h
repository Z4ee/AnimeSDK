...
#define LITJSON_JSONDATA_ADD_OFFSET UNITYSDK_OFFSET(0x1BFF4620)
#define LITJSON_JSONDATA_CLEAR_OFFSET UNITYSDK_OFFSET(0x1BFF6210)
#define LITJSON_JSONDATA_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x1BFF0BD0)
#define LITJSON_JSONDATA_ENSURECOLLECTION_OFFSET UNITYSDK_OFFSET(0x1BFF0600)
#define LITJSON_JSONDATA_ENSUREDICTIONARY_OFFSET UNITYSDK_OFFSET(0x1BFF0A60)
#define LITJSON_JSONDATA_ENSURELIST_OFFSET UNITYSDK_OFFSET(0x1BFF1BA0)
#define LITJSON_JSONDATA_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BFF6340)
#define LITJSON_JSONDATA_GETCOMMENT_OFFSET UNITYSDK_OFFSET(0x1BFF4360)
#define LITJSON_JSONDATA_GETJSONTYPE_OFFSET UNITYSDK_OFFSET(0x1BFF6540)
#define LITJSON_JSONDATA_GET_ASBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1BFF06D0)
#define LITJSON_JSONDATA_GET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x1BFF07D0)
#define LITJSON_JSONDATA_GET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x1BFF0750)
#define LITJSON_JSONDATA_GET_ASINT_OFFSET UNITYSDK_OFFSET(0x1BFF07E0)
#define LITJSON_JSONDATA_GET_ASLONG_OFFSET UNITYSDK_OFFSET(0x1BFF0860)
#define LITJSON_JSONDATA_GET_ASSTRING_OFFSET UNITYSDK_OFFSET(0x1BFF08F0)
#define LITJSON_JSONDATA_GET_COMMENT_OFFSET UNITYSDK_OFFSET(0x1BFF0960)
#define LITJSON_JSONDATA_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1BFF0520)
#define LITJSON_JSONDATA_GET_ISARRAY_OFFSET UNITYSDK_OFFSET(0x1BFF06B0)
#define LITJSON_JSONDATA_GET_ISBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1BFF06C0)
#define LITJSON_JSONDATA_GET_ISDOUBLE_OFFSET UNITYSDK_OFFSET(0x1BFF0740)
#define LITJSON_JSONDATA_GET_ISINT_OFFSET UNITYSDK_OFFSET(0x1BFF07C0)
#define LITJSON_JSONDATA_GET_ISLONG_OFFSET UNITYSDK_OFFSET(0x1BFF0850)
#define LITJSON_JSONDATA_GET_ISOBJECT_OFFSET UNITYSDK_OFFSET(0x1BFF08D0)
#define LITJSON_JSONDATA_GET_ISSTRING_OFFSET UNITYSDK_OFFSET(0x1BFF08E0)
#define LITJSON_JSONDATA_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1BFF2DD0)
#define LITJSON_JSONDATA_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1BFF2CF0)
#define LITJSON_JSONDATA_GET_KEYS_OFFSET UNITYSDK_OFFSET(0x1BFF0980)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GETBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1BFF40F0)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GETDOUBLE_OFFSET UNITYSDK_OFFSET(0x1BFF4160)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GETINT_OFFSET UNITYSDK_OFFSET(0x1BFF41D0)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GETLONG_OFFSET UNITYSDK_OFFSET(0x1BFF4240)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GETSTRING_OFFSET UNITYSDK_OFFSET(0x1BFF42B0)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GET_ISARRAY_OFFSET UNITYSDK_OFFSET(0x1BFF1A40)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GET_ISBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1BFF1A50)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GET_ISDOUBLE_OFFSET UNITYSDK_OFFSET(0x1BFF1A60)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GET_ISINT_OFFSET UNITYSDK_OFFSET(0x1BFF1A70)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GET_ISLONG_OFFSET UNITYSDK_OFFSET(0x1BFF1A80)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GET_ISOBJECT_OFFSET UNITYSDK_OFFSET(0x1BFF1A90)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GET_ISSTRING_OFFSET UNITYSDK_OFFSET(0x1BFF1AA0)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_SETBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1BFF4320)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_SETDOUBLE_OFFSET UNITYSDK_OFFSET(0x1BFF4370)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_SETINT_OFFSET UNITYSDK_OFFSET(0x1BFF43B0)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_SETLONG_OFFSET UNITYSDK_OFFSET(0x1BFF43F0)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_SETSTRING_OFFSET UNITYSDK_OFFSET(0x1BFF4430)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_TOJSON_1_OFFSET UNITYSDK_OFFSET(0x1BFF4590)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_TOJSON_OFFSET UNITYSDK_OFFSET(0x1BFF4480)
#define LITJSON_JSONDATA_OP_EXPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1BFF3440)
#define LITJSON_JSONDATA_OP_EXPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1BFF34B0)
#define LITJSON_JSONDATA_OP_EXPLICIT_3_OFFSET UNITYSDK_OFFSET(0x1BFF3530)
#define LITJSON_JSONDATA_OP_EXPLICIT_4_OFFSET UNITYSDK_OFFSET(0x1BFF35B0)
#define LITJSON_JSONDATA_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1BFF33D0)
#define LITJSON_JSONDATA_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1BFF32A0)
#define LITJSON_JSONDATA_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1BFF32F0)
#define LITJSON_JSONDATA_OP_IMPLICIT_3_OFFSET UNITYSDK_OFFSET(0x1BFF3330)
#define LITJSON_JSONDATA_OP_IMPLICIT_4_OFFSET UNITYSDK_OFFSET(0x1BFF3380)
#define LITJSON_JSONDATA_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1BFF3260)
#define LITJSON_JSONDATA_REMOVE_OFFSET UNITYSDK_OFFSET(0x1BFF5DE0)
#define LITJSON_JSONDATA_SETBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1BFF4340)
#define LITJSON_JSONDATA_SETCOMMENT_OFFSET UNITYSDK_OFFSET(0x1BFF4470)
#define LITJSON_JSONDATA_SETDOUBLE_OFFSET UNITYSDK_OFFSET(0x1BFF4390)
#define LITJSON_JSONDATA_SETINT_OFFSET UNITYSDK_OFFSET(0x1BFF43D0)
#define LITJSON_JSONDATA_SETJSONTYPE_OFFSET UNITYSDK_OFFSET(0x1BFF6550)
#define LITJSON_JSONDATA_SETLONG_OFFSET UNITYSDK_OFFSET(0x1BFF4410)
#define LITJSON_JSONDATA_SETSTRING_OFFSET UNITYSDK_OFFSET(0x1BFF4450)
#define LITJSON_JSONDATA_SET_COMMENT_OFFSET UNITYSDK_OFFSET(0x1BFF0970)
#define LITJSON_JSONDATA_SET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1BFF2A00)
#define LITJSON_JSONDATA_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1BFF2030)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ICOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1BFF3620)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ICOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1BFF0E50)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ICOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1BFF0E60)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ICOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1BFF0F50)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_ADD_OFFSET UNITYSDK_OFFSET(0x1BFF3720)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_CLEAR_OFFSET UNITYSDK_OFFSET(0x1BFF3970)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1BFF3AF0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BFF3BE0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_GET_ISFIXEDSIZE_OFFSET UNITYSDK_OFFSET(0x1BFF1040)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1BFF1130)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1BFF1DA0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_GET_KEYS_OFFSET UNITYSDK_OFFSET(0x1BFF1220)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_GET_VALUES_OFFSET UNITYSDK_OFFSET(0x1BFF1630)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_REMOVE_OFFSET UNITYSDK_OFFSET(0x1BFF3CA0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1BFF1E80)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BFF4010)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_ADD_OFFSET UNITYSDK_OFFSET(0x1BFF4610)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_CLEAR_OFFSET UNITYSDK_OFFSET(0x1BFF4770)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1BFF4860)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_GET_ISFIXEDSIZE_OFFSET UNITYSDK_OFFSET(0x1BFF1AB0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1BFF1CB0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1BFF2890)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1BFF4950)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_INSERT_OFFSET UNITYSDK_OFFSET(0x1BFF4A40)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_REMOVEAT_OFFSET UNITYSDK_OFFSET(0x1BFF4C40)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_REMOVE_OFFSET UNITYSDK_OFFSET(0x1BFF4B50)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1BFF2970)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_SPECIALIZED_IORDEREDDICTIONARY_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BFF4D30)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_SPECIALIZED_IORDEREDDICTIONARY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1BFF24E0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_SPECIALIZED_IORDEREDDICTIONARY_INSERT_OFFSET UNITYSDK_OFFSET(0x1BFF4E10)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_SPECIALIZED_IORDEREDDICTIONARY_REMOVEAT_OFFSET UNITYSDK_OFFSET(0x1BFF4F90)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_SPECIALIZED_IORDEREDDICTIONARY_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1BFF25C0)
#define LITJSON_JSONDATA_TOJSONDATA_OFFSET UNITYSDK_OFFSET(0x1BFF1FB0)
#define LITJSON_JSONDATA_TOJSON_1_OFFSET UNITYSDK_OFFSET(0x1BFF45D0)
#define LITJSON_JSONDATA_TOJSON_2_OFFSET UNITYSDK_OFFSET(0x1BFF6720)
#define LITJSON_JSONDATA_TOJSON_OFFSET UNITYSDK_OFFSET(0x1BFF4490)
#define LITJSON_JSONDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BFF6830)
#define LITJSON_JSONDATA_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1BFF0D60)
#define LITJSON_JSONDATA_WRITECOMMENT_OFFSET UNITYSDK_OFFSET(0x1BFF5CD0)
#define LITJSON_JSONDATA_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1BFF51C0)
#define LITJSON_JSONDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BFF2F70)
#define LITJSON_JSONDATA__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1BFF2F80)
#define LITJSON_JSONDATA__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1BFF2F90)
#define LITJSON_JSONDATA__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1BFF2FA0)
#define LITJSON_JSONDATA__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1BFF2FB0)
#define LITJSON_JSONDATA__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1BFF3250)
#define LITJSON_JSONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFF2F60)

namespace LitJson
{
	inline static constexpr unsigned int JsonData_TypeDefinitionIndex = 8362;

	class JsonData : public ::System::Object
	{
	public:
		::System::String* comment; // 0x10
		::System::String* inst_string; // 0x18
		...
		::System::Boolean inst_boolean; // 0x4C
		::System::Int32 inst_int; // 0x50
