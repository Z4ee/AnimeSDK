...
#define LITJSON_JSONDATA_ADD_OFFSET UNITYSDK_OFFSET(0x1D5A8080)
#define LITJSON_JSONDATA_CLEAR_OFFSET UNITYSDK_OFFSET(0x1D5A9CB0)
#define LITJSON_JSONDATA_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x1D5A45D0)
#define LITJSON_JSONDATA_ENSURECOLLECTION_OFFSET UNITYSDK_OFFSET(0x1D5A4000)
#define LITJSON_JSONDATA_ENSUREDICTIONARY_OFFSET UNITYSDK_OFFSET(0x1D5A4460)
#define LITJSON_JSONDATA_ENSURELIST_OFFSET UNITYSDK_OFFSET(0x1D5A55A0)
#define LITJSON_JSONDATA_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D5A9DE0)
#define LITJSON_JSONDATA_GETCOMMENT_OFFSET UNITYSDK_OFFSET(0x1D5A7DC0)
#define LITJSON_JSONDATA_GETJSONTYPE_OFFSET UNITYSDK_OFFSET(0x1D5A9FD0)
#define LITJSON_JSONDATA_GET_ASBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1D5A40D0)
#define LITJSON_JSONDATA_GET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x1D5A41D0)
#define LITJSON_JSONDATA_GET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x1D5A4150)
#define LITJSON_JSONDATA_GET_ASINT_OFFSET UNITYSDK_OFFSET(0x1D5A41E0)
#define LITJSON_JSONDATA_GET_ASLONG_OFFSET UNITYSDK_OFFSET(0x1D5A4260)
#define LITJSON_JSONDATA_GET_ASSTRING_OFFSET UNITYSDK_OFFSET(0x1D5A42F0)
#define LITJSON_JSONDATA_GET_COMMENT_OFFSET UNITYSDK_OFFSET(0x1D5A4360)
#define LITJSON_JSONDATA_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1D5A3F10)
#define LITJSON_JSONDATA_GET_ISARRAY_OFFSET UNITYSDK_OFFSET(0x1D5A40B0)
#define LITJSON_JSONDATA_GET_ISBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1D5A40C0)
#define LITJSON_JSONDATA_GET_ISDOUBLE_OFFSET UNITYSDK_OFFSET(0x1D5A4140)
#define LITJSON_JSONDATA_GET_ISINT_OFFSET UNITYSDK_OFFSET(0x1D5A41C0)
#define LITJSON_JSONDATA_GET_ISLONG_OFFSET UNITYSDK_OFFSET(0x1D5A4250)
#define LITJSON_JSONDATA_GET_ISOBJECT_OFFSET UNITYSDK_OFFSET(0x1D5A42D0)
#define LITJSON_JSONDATA_GET_ISSTRING_OFFSET UNITYSDK_OFFSET(0x1D5A42E0)
#define LITJSON_JSONDATA_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1D5A6800)
#define LITJSON_JSONDATA_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D5A6720)
#define LITJSON_JSONDATA_GET_KEYS_OFFSET UNITYSDK_OFFSET(0x1D5A4380)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GETBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1D5A7B50)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GETDOUBLE_OFFSET UNITYSDK_OFFSET(0x1D5A7BC0)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GETINT_OFFSET UNITYSDK_OFFSET(0x1D5A7C30)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GETLONG_OFFSET UNITYSDK_OFFSET(0x1D5A7CA0)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GETSTRING_OFFSET UNITYSDK_OFFSET(0x1D5A7D10)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GET_ISARRAY_OFFSET UNITYSDK_OFFSET(0x1D5A5440)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GET_ISBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1D5A5450)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GET_ISDOUBLE_OFFSET UNITYSDK_OFFSET(0x1D5A5460)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GET_ISINT_OFFSET UNITYSDK_OFFSET(0x1D5A5470)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GET_ISLONG_OFFSET UNITYSDK_OFFSET(0x1D5A5480)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GET_ISOBJECT_OFFSET UNITYSDK_OFFSET(0x1D5A5490)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GET_ISSTRING_OFFSET UNITYSDK_OFFSET(0x1D5A54A0)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_SETBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1D5A7D80)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_SETDOUBLE_OFFSET UNITYSDK_OFFSET(0x1D5A7DD0)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_SETINT_OFFSET UNITYSDK_OFFSET(0x1D5A7E10)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_SETLONG_OFFSET UNITYSDK_OFFSET(0x1D5A7E50)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_SETSTRING_OFFSET UNITYSDK_OFFSET(0x1D5A7E90)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_TOJSON_1_OFFSET UNITYSDK_OFFSET(0x1D5A7FF0)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_TOJSON_OFFSET UNITYSDK_OFFSET(0x1D5A7EE0)
#define LITJSON_JSONDATA_OP_EXPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1D5A6E80)
#define LITJSON_JSONDATA_OP_EXPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1D5A6EF0)
#define LITJSON_JSONDATA_OP_EXPLICIT_3_OFFSET UNITYSDK_OFFSET(0x1D5A6F70)
#define LITJSON_JSONDATA_OP_EXPLICIT_4_OFFSET UNITYSDK_OFFSET(0x1D5A6FF0)
#define LITJSON_JSONDATA_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1D5A6E10)
#define LITJSON_JSONDATA_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1D5A6CE0)
#define LITJSON_JSONDATA_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1D5A6D30)
#define LITJSON_JSONDATA_OP_IMPLICIT_3_OFFSET UNITYSDK_OFFSET(0x1D5A6D70)
#define LITJSON_JSONDATA_OP_IMPLICIT_4_OFFSET UNITYSDK_OFFSET(0x1D5A6DC0)
#define LITJSON_JSONDATA_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1D5A6CA0)
#define LITJSON_JSONDATA_REMOVE_OFFSET UNITYSDK_OFFSET(0x1D5A9870)
#define LITJSON_JSONDATA_SETBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1D5A7DA0)
#define LITJSON_JSONDATA_SETCOMMENT_OFFSET UNITYSDK_OFFSET(0x1D5A7ED0)
#define LITJSON_JSONDATA_SETDOUBLE_OFFSET UNITYSDK_OFFSET(0x1D5A7DF0)
#define LITJSON_JSONDATA_SETINT_OFFSET UNITYSDK_OFFSET(0x1D5A7E30)
#define LITJSON_JSONDATA_SETJSONTYPE_OFFSET UNITYSDK_OFFSET(0x1D5A9FE0)
#define LITJSON_JSONDATA_SETLONG_OFFSET UNITYSDK_OFFSET(0x1D5A7E70)
#define LITJSON_JSONDATA_SETSTRING_OFFSET UNITYSDK_OFFSET(0x1D5A7EB0)
#define LITJSON_JSONDATA_SET_COMMENT_OFFSET UNITYSDK_OFFSET(0x1D5A4370)
#define LITJSON_JSONDATA_SET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1D5A6410)
#define LITJSON_JSONDATA_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D5A5A30)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ICOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1D5A7060)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ICOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1D5A4850)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ICOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1D5A4860)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ICOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1D5A4950)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_ADD_OFFSET UNITYSDK_OFFSET(0x1D5A7160)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_CLEAR_OFFSET UNITYSDK_OFFSET(0x1D5A73B0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1D5A7540)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1D5A7630)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_GET_ISFIXEDSIZE_OFFSET UNITYSDK_OFFSET(0x1D5A4A40)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1D5A4B30)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D5A57A0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_GET_KEYS_OFFSET UNITYSDK_OFFSET(0x1D5A4C20)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_GET_VALUES_OFFSET UNITYSDK_OFFSET(0x1D5A5030)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_REMOVE_OFFSET UNITYSDK_OFFSET(0x1D5A76F0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D5A5880)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1D5A7A70)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_ADD_OFFSET UNITYSDK_OFFSET(0x1D5A8070)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_CLEAR_OFFSET UNITYSDK_OFFSET(0x1D5A81D0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1D5A82C0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_GET_ISFIXEDSIZE_OFFSET UNITYSDK_OFFSET(0x1D5A54B0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1D5A56B0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D5A62A0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1D5A83B0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_INSERT_OFFSET UNITYSDK_OFFSET(0x1D5A84A0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_REMOVEAT_OFFSET UNITYSDK_OFFSET(0x1D5A86A0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_REMOVE_OFFSET UNITYSDK_OFFSET(0x1D5A85B0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D5A6380)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_SPECIALIZED_IORDEREDDICTIONARY_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1D5A8790)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_SPECIALIZED_IORDEREDDICTIONARY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D5A5EF0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_SPECIALIZED_IORDEREDDICTIONARY_INSERT_OFFSET UNITYSDK_OFFSET(0x1D5A8870)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_SPECIALIZED_IORDEREDDICTIONARY_REMOVEAT_OFFSET UNITYSDK_OFFSET(0x1D5A89F0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_SPECIALIZED_IORDEREDDICTIONARY_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D5A5FD0)
#define LITJSON_JSONDATA_TOJSONDATA_OFFSET UNITYSDK_OFFSET(0x1D5A59B0)
#define LITJSON_JSONDATA_TOJSON_1_OFFSET UNITYSDK_OFFSET(0x1D5A8030)
#define LITJSON_JSONDATA_TOJSON_2_OFFSET UNITYSDK_OFFSET(0x1D5AA190)
#define LITJSON_JSONDATA_TOJSON_OFFSET UNITYSDK_OFFSET(0x1D5A7EF0)
#define LITJSON_JSONDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D5AA2B0)
#define LITJSON_JSONDATA_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1D5A4760)
#define LITJSON_JSONDATA_WRITECOMMENT_OFFSET UNITYSDK_OFFSET(0x1D5A9760)
#define LITJSON_JSONDATA_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1D5A8C30)
#define LITJSON_JSONDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D5A69B0)
#define LITJSON_JSONDATA__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D5A69C0)
#define LITJSON_JSONDATA__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1D5A69D0)
#define LITJSON_JSONDATA__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1D5A69E0)
#define LITJSON_JSONDATA__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1D5A69F0)
#define LITJSON_JSONDATA__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1D5A6C90)
#define LITJSON_JSONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5A69A0)

namespace LitJson
{
	inline static constexpr unsigned int JsonData_TypeDefinitionIndex = 8449;

	class JsonData : public ::System::Object
	{
	public:
		::System::Collections::Generic::IList_1<::LitJson::JsonData*>* inst_array; // 0x10
		::System::String* json; // 0x18
		::System::String* comment; // 0x20
		::System::String* inst_string; // 0x28
		...
		::System::Collections::Generic::IDictionary_2<::System::String*, ::LitJson::JsonData*>* inst_object; // 0x38
		::System::Int64 inst_long; // 0x40
		::System::Boolean inst_boolean; // 0x48
		::System::Int32 inst_int; // 0x4C
		::LitJson::JsonType type; // 0x50
		::System::Double inst_double; // 0x58
