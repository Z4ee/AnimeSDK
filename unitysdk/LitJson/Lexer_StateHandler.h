...
#define LITJSON_LEXER_STATEHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF62B0)
#define LITJSON_LEXER_STATEHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF62E0)
#define LITJSON_LEXER_STATEHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF5D70)
#define LITJSON_LEXER_STATEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBF5D60)

namespace LitJson
{
	inline static constexpr unsigned int Lexer_StateHandler_TypeDefinitionIndex = 7738;
