...
#define LITJSON_LEXER_STATEHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E373190)
#define LITJSON_LEXER_STATEHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E3731C0)
#define LITJSON_LEXER_STATEHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E372C50)
#define LITJSON_LEXER_STATEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E372C30)

namespace LitJson
{
	inline static constexpr unsigned int Lexer_StateHandler_TypeDefinitionIndex = 7749;
