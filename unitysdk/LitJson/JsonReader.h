...
#define LITJSON_JSONREADER_CLOSE_OFFSET UNITYSDK_OFFSET(0x1DF14F70)
#define LITJSON_JSONREADER_GET_ALLOWCOMMENTS_OFFSET UNITYSDK_OFFSET(0x1DF134D0)
#define LITJSON_JSONREADER_GET_ALLOWSINGLEQUOTEDSTRINGS_OFFSET UNITYSDK_OFFSET(0x1DF13510)
#define LITJSON_JSONREADER_GET_COMMENTSTACK_OFFSET UNITYSDK_OFFSET(0x1DF13550)
#define LITJSON_JSONREADER_GET_ENDOFINPUT_OFFSET UNITYSDK_OFFSET(0x1DF135B0)
#define LITJSON_JSONREADER_GET_ENDOFJSON_OFFSET UNITYSDK_OFFSET(0x1DF135C0)
#define LITJSON_JSONREADER_GET_SKIPMISMATCHMEMBERS_OFFSET UNITYSDK_OFFSET(0x1DF13590)
#define LITJSON_JSONREADER_GET_SKIPNONMEMBERS_OFFSET UNITYSDK_OFFSET(0x1DF13570)
#define LITJSON_JSONREADER_GET_TOKEN_OFFSET UNITYSDK_OFFSET(0x1DF135D0)
#define LITJSON_JSONREADER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1DF135E0)
#define LITJSON_JSONREADER_POPULATEPARSETABLE_OFFSET UNITYSDK_OFFSET(0x1DF13610)
#define LITJSON_JSONREADER_PROCESSNUMBER_OFFSET UNITYSDK_OFFSET(0x1DF149E0)
#define LITJSON_JSONREADER_PROCESSSYMBOL_OFFSET UNITYSDK_OFFSET(0x1DF14C80)
#define LITJSON_JSONREADER_READTOKEN_OFFSET UNITYSDK_OFFSET(0x1DF14EA0)
#define LITJSON_JSONREADER_READ_OFFSET UNITYSDK_OFFSET(0x1DF14FB0)
#define LITJSON_JSONREADER_SET_ALLOWCOMMENTS_OFFSET UNITYSDK_OFFSET(0x1DF134F0)
#define LITJSON_JSONREADER_SET_ALLOWSINGLEQUOTEDSTRINGS_OFFSET UNITYSDK_OFFSET(0x1DF13530)
#define LITJSON_JSONREADER_SET_SKIPMISMATCHMEMBERS_OFFSET UNITYSDK_OFFSET(0x1DF135A0)
#define LITJSON_JSONREADER_SET_SKIPNONMEMBERS_OFFSET UNITYSDK_OFFSET(0x1DF13580)
#define LITJSON_JSONREADER_TABLEADDCOL_OFFSET UNITYSDK_OFFSET(0x1DF14860)
#define LITJSON_JSONREADER_TABLEADDROW_OFFSET UNITYSDK_OFFSET(0x1DF14720)
#define LITJSON_JSONREADER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DF135F0)
#define LITJSON_JSONREADER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DF14710)
#define LITJSON_JSONREADER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1DF14600)
#define LITJSON_JSONREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DF14530)

namespace LitJson
{
	inline static constexpr unsigned int JsonReader_TypeDefinitionIndex = 7861;
	...
	public:
		...
		{
			return (::System::Collections::Generic::IDictionary_2<::System::Int32, ::System::Collections::Generic::IDictionary_2<::System::Int32, ::Il2CppArray<::System::Int32>*>*>**)Il2CppClass::FromTypeDefinitionIndex(JsonReader_TypeDefinitionIndex)->GetStaticField(0x6F70);
		}
		::System::IO::TextReader* reader; // 0x10
		::System::Collections::Generic::Stack_1<::System::Int32>* automaton_stack; // 0x18
		::LitJson::Lexer* lexer; // 0x20
		::System::Object* token_value; // 0x28
		::System::Int32 current_symbol; // 0x30
		::LitJson::JsonToken token; // 0x34
		::System::Boolean end_of_json; // 0x38
		::System::Boolean parser_return; // 0x39
		::System::Boolean end_of_input; // 0x3A
		::System::Boolean skip_mismatch_members; // 0x3B
		::System::Int32 current_input; // 0x3C
		::System::Boolean reader_is_owned; // 0x40
		::System::Boolean parser_in_string; // 0x41
		::System::Boolean skip_non_members; // 0x42
		::System::Boolean read_started; // 0x43
