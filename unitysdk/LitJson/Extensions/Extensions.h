...
#define LITJSON_EXTENSIONS_EXTENSIONS_HASIMPLEMENTEDRAWGENERIC_OFFSET UNITYSDK_OFFSET(0x1BFF0370)
#define LITJSON_EXTENSIONS_EXTENSIONS_WRITEPROPERTY_1_OFFSET UNITYSDK_OFFSET(0x1BFF02D0)
#define LITJSON_EXTENSIONS_EXTENSIONS_WRITEPROPERTY_2_OFFSET UNITYSDK_OFFSET(0x1BFF0300)
#define LITJSON_EXTENSIONS_EXTENSIONS_WRITEPROPERTY_3_OFFSET UNITYSDK_OFFSET(0x1BFF0330)
#define LITJSON_EXTENSIONS_EXTENSIONS_WRITEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1BFF02A0)

namespace LitJson::Extensions
{
	inline static constexpr unsigned int Extensions_TypeDefinitionIndex = 8083;
