...
#define LITJSON_EXTENSIONS_EXTENSIONS_HASIMPLEMENTEDRAWGENERIC_OFFSET UNITYSDK_OFFSET(0x1D5A3D60)
#define LITJSON_EXTENSIONS_EXTENSIONS_WRITEPROPERTY_1_OFFSET UNITYSDK_OFFSET(0x1D5A3CC0)
#define LITJSON_EXTENSIONS_EXTENSIONS_WRITEPROPERTY_2_OFFSET UNITYSDK_OFFSET(0x1D5A3CF0)
#define LITJSON_EXTENSIONS_EXTENSIONS_WRITEPROPERTY_3_OFFSET UNITYSDK_OFFSET(0x1D5A3D20)
#define LITJSON_EXTENSIONS_EXTENSIONS_WRITEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1D5A3C90)

namespace LitJson::Extensions
{
	inline static constexpr unsigned int Extensions_TypeDefinitionIndex = 7975;
