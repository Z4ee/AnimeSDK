...
#define CLASS_2_ABB406266ACF9A2E_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xB7D0210)
#define CLASS_2_ABB406266ACF9A2E_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xB7D0390)
#define CLASS_2_ABB406266ACF9A2E_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xB7CFE20)
#define CLASS_2_ABB406266ACF9A2E_METHOD_2_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xB7CFEA0)
#define CLASS_2_ABB406266ACF9A2E_METHOD_2_5EBCF276C230582C_OFFSET UNITYSDK_OFFSET(0xB7CEB10)
#define CLASS_2_ABB406266ACF9A2E_METHOD_2_81D45978B8E3E7F2_OFFSET UNITYSDK_OFFSET(0xB7CF210)
#define CLASS_2_ABB406266ACF9A2E_METHOD_2_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xB7CF6A0)
#define CLASS_2_ABB406266ACF9A2E_METHOD_2_AB39AF650EC67EAB_OFFSET UNITYSDK_OFFSET(0xB7CF9E0)
#define CLASS_2_ABB406266ACF9A2E_METHOD_2_D8E6DC0B27699F85_OFFSET UNITYSDK_OFFSET(0xB7CFA70)
#define CLASS_2_ABB406266ACF9A2E_METHOD_2_DC715239B8B98D9C_OFFSET UNITYSDK_OFFSET(0xB7CE4C0)
#define CLASS_2_ABB406266ACF9A2E_METHOD_2_DDDB3490E38FF95F_OFFSET UNITYSDK_OFFSET(0xB7CE990)
#define CLASS_2_ABB406266ACF9A2E_METHOD_2_F0F8DE036FE283F6_OFFSET UNITYSDK_OFFSET(0xB7CF370)
#define CLASS_2_ABB406266ACF9A2E_METHOD_2_F37CDBD6D46274D2_1_OFFSET UNITYSDK_OFFSET(0xB7D00F0)
#define CLASS_2_ABB406266ACF9A2E_METHOD_2_F37CDBD6D46274D2_2_OFFSET UNITYSDK_OFFSET(0xB7D0180)
#define CLASS_2_ABB406266ACF9A2E_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0xB7D0060)
#define CLASS_2_ABB406266ACF9A2E_METHOD_2_F7300E87EC49A206_1_OFFSET UNITYSDK_OFFSET(0xB7CF760)
#define CLASS_2_ABB406266ACF9A2E_METHOD_2_F7300E87EC49A206_2_OFFSET UNITYSDK_OFFSET(0xB7CF8A0)
#define CLASS_2_ABB406266ACF9A2E_METHOD_2_F7300E87EC49A206_OFFSET UNITYSDK_OFFSET(0xB7CF560)
#define CLASS_2_ABB406266ACF9A2E_METHOD_2_F84EDFA9C4C77EA5_OFFSET UNITYSDK_OFFSET(0xB7CF020)
#define CLASS_2_ABB406266ACF9A2E__CTOR_OFFSET UNITYSDK_OFFSET(0xB7D04F0)
#define CLASS_2_ABB406266ACF9A2E__ONBIND_OFFSET UNITYSDK_OFFSET(0xB7CE1D0)

inline static constexpr unsigned int Class_2_ABB406266ACF9A2E_TypeDefinitionIndex = 72207;

class Class_2_ABB406266ACF9A2E : public ::Class_1_34917908B7833130
{
public:
	::UnityEngine::UI::Button* AJFFLOBFJAM; // 0x60
	::UnityEngine::Transform* JHIPBEPDLKI; // 0x68
	::UnityEngine::Transform* CLAIMGMCBDN; // 0x70
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>* AIAJPIMPMOF; // 0x78
	::UnityEngine::Transform* KKPDEDKKPIO; // 0x80
	::System::Collections::Generic::List_1<::Class_2_ABDB9F9EEB76D625*>* LBMILLAKLKI; // 0x88
	::System::Collections::Generic::List_1<::Class_2_C14495BD13DDA597*>* KMLNDLEGKAE; // 0x90
	::UnityEngine::Transform* LECOCIDLOJK; // 0x98
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::GridFightTraitConfigBase*>* HIMNHBLPLME; // 0xA0
	::UnityEngine::UI::Text* ELKINPHPBDC; // 0xA8
