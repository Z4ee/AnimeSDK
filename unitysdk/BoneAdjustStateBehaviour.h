...
#define BONEADJUSTSTATEBEHAVIOUR_INITCOMPONENT_OFFSET UNITYSDK_OFFSET(0x14E5BC90)
#define BONEADJUSTSTATEBEHAVIOUR_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x14E5BEF0)
#define BONEADJUSTSTATEBEHAVIOUR_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x14E5C2B0)
#define BONEADJUSTSTATEBEHAVIOUR_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x14E5C0D0)
#define BONEADJUSTSTATEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x14E5C490)
#define BONEADJUSTSTATEBEHAVIOUR___BASE_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x14E5C4F0)
#define BONEADJUSTSTATEBEHAVIOUR___BASE_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x14E5C500)
#define BONEADJUSTSTATEBEHAVIOUR___BASE_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x14E5C510)

inline static constexpr unsigned int BoneAdjustStateBehaviour_TypeDefinitionIndex = 54529;
