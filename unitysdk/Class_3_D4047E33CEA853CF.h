...
#define CLASS_3_D4047E33CEA853CF_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1887BCF0)
#define CLASS_3_D4047E33CEA853CF_METHOD_3_3C56C1AF247AC1EC_OFFSET UNITYSDK_OFFSET(0x1887C200)
#define CLASS_3_D4047E33CEA853CF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1887BE70)
#define CLASS_3_D4047E33CEA853CF_TICK_OFFSET UNITYSDK_OFFSET(0x1887C290)
#define CLASS_3_D4047E33CEA853CF__CTOR_OFFSET UNITYSDK_OFFSET(0x1887BBE0)

inline static constexpr unsigned int Class_3_D4047E33CEA853CF_TypeDefinitionIndex = 55480;

class Class_3_D4047E33CEA853CF : public ::RPG::GameCore::ImmediateTaskBase_1<::RPG::GameCore::ReceiveDynamicSkillTargetSelection*>
{
public:
	::RPG::GameCore::GameEntity* AKJFHPNOGEJ; // 0x28
	::Class_3_07C3C4D2990C49EE* JOBCHGELIKG; // 0x30
	::Class_3_07C3C4D2990C49EE* NOPDCJAEDBG; // 0x38
	::Class_3_07C3C4D2990C49EE* IMLDGCEMCCM; // 0x40
