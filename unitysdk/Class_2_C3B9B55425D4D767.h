...
#define CLASS_2_C3B9B55425D4D767_DISPOSE_OFFSET UNITYSDK_OFFSET(0x906F8C0)
#define CLASS_2_C3B9B55425D4D767_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x906F900)
#define CLASS_2_C3B9B55425D4D767_METHOD_2_3D8F0F1C6E55B9B6_OFFSET UNITYSDK_OFFSET(0x9070460)
#define CLASS_2_C3B9B55425D4D767_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9070410)
#define CLASS_2_C3B9B55425D4D767_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x9070550)
#define CLASS_2_C3B9B55425D4D767_ONSKIP_OFFSET UNITYSDK_OFFSET(0x90704B0)
#define CLASS_2_C3B9B55425D4D767_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x906F910)
#define CLASS_2_C3B9B55425D4D767_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x9070300)
#define CLASS_2_C3B9B55425D4D767_TICK_OFFSET UNITYSDK_OFFSET(0x90703B0)
#define CLASS_2_C3B9B55425D4D767__CTOR_OFFSET UNITYSDK_OFFSET(0x906F8B0)

inline static constexpr unsigned int Class_2_C3B9B55425D4D767_TypeDefinitionIndex = 53492;

class Class_2_C3B9B55425D4D767 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::CharacterNavigateTo* Field_2_1; // 0x18
	::RPG::GameCore::TaskContext* Field_2_0; // 0x20
	::RPG::GameCore::TransformComponent* Field_2_5; // 0x28
	::Class_2_A0580152EB393340* Field_2_2; // 0x30
