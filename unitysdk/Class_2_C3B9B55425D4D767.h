...
#define CLASS_2_C3B9B55425D4D767_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBF4D490)
#define CLASS_2_C3B9B55425D4D767_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0xBF4D4D0)
#define CLASS_2_C3B9B55425D4D767_METHOD_2_3D8F0F1C6E55B9B6_OFFSET UNITYSDK_OFFSET(0xBF4E010)
#define CLASS_2_C3B9B55425D4D767_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xBF4DFC0)
#define CLASS_2_C3B9B55425D4D767_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0xBF4E0F0)
#define CLASS_2_C3B9B55425D4D767_ONSKIP_OFFSET UNITYSDK_OFFSET(0xBF4E060)
#define CLASS_2_C3B9B55425D4D767_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xBF4D4E0)
#define CLASS_2_C3B9B55425D4D767_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xBF4DEB0)
#define CLASS_2_C3B9B55425D4D767_TICK_OFFSET UNITYSDK_OFFSET(0xBF4DF60)
#define CLASS_2_C3B9B55425D4D767__CTOR_OFFSET UNITYSDK_OFFSET(0xBF4D480)

inline static constexpr unsigned int Class_2_C3B9B55425D4D767_TypeDefinitionIndex = 54205;

class Class_2_C3B9B55425D4D767 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::CharacterNavigateTo* Field_2_0; // 0x18
