...
#define CLASS_1_B71FC14BA77C9F77_GET_CARDCONFIG_OFFSET UNITYSDK_OFFSET(0x1A84B590)
#define CLASS_1_B71FC14BA77C9F77_GET_CASTER_OFFSET UNITYSDK_OFFSET(0x1A84B490)
#define CLASS_1_B71FC14BA77C9F77_GET_COPIEDSOURCECARD_OFFSET UNITYSDK_OFFSET(0x1A84B5B0)
#define CLASS_1_B71FC14BA77C9F77_GET_FINALAMPLIFICATION_OFFSET UNITYSDK_OFFSET(0x1A84B430)
#define CLASS_1_B71FC14BA77C9F77_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1A84B410)
#define CLASS_1_B71FC14BA77C9F77_GET_ID_OFFSET UNITYSDK_OFFSET(0x1A84B400)
#define CLASS_1_B71FC14BA77C9F77_GET_MANACOSTRAW_OFFSET UNITYSDK_OFFSET(0x1A84B470)
#define CLASS_1_B71FC14BA77C9F77_GET_MANACOST_OFFSET UNITYSDK_OFFSET(0x1A84B450)
#define CLASS_1_B71FC14BA77C9F77_GET_NEEDRELEASETARGET_OFFSET UNITYSDK_OFFSET(0x1A84B4D0)
#define CLASS_1_B71FC14BA77C9F77_GET_RAWCASTER_OFFSET UNITYSDK_OFFSET(0x1A84B4B0)
#define CLASS_1_B71FC14BA77C9F77_GET_UID_OFFSET UNITYSDK_OFFSET(0x1A84B420)
#define CLASS_1_B71FC14BA77C9F77_METHOD_1_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0x1A84B540)
#define CLASS_1_B71FC14BA77C9F77_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x1A84B4F0)
#define CLASS_1_B71FC14BA77C9F77_SET_CARDCONFIG_OFFSET UNITYSDK_OFFSET(0x1A84B5A0)
#define CLASS_1_B71FC14BA77C9F77_SET_CASTER_OFFSET UNITYSDK_OFFSET(0x1A84B4A0)
#define CLASS_1_B71FC14BA77C9F77_SET_COPIEDSOURCECARD_OFFSET UNITYSDK_OFFSET(0x1A84B5C0)
#define CLASS_1_B71FC14BA77C9F77_SET_FINALAMPLIFICATION_OFFSET UNITYSDK_OFFSET(0x1A84B440)
#define CLASS_1_B71FC14BA77C9F77_SET_MANACOSTRAW_OFFSET UNITYSDK_OFFSET(0x1A84B480)
#define CLASS_1_B71FC14BA77C9F77_SET_MANACOST_OFFSET UNITYSDK_OFFSET(0x1A84B460)
#define CLASS_1_B71FC14BA77C9F77_SET_NEEDRELEASETARGET_OFFSET UNITYSDK_OFFSET(0x1A84B4E0)
#define CLASS_1_B71FC14BA77C9F77_SET_RAWCASTER_OFFSET UNITYSDK_OFFSET(0x1A84B4C0)
#define CLASS_1_B71FC14BA77C9F77__CTOR_OFFSET UNITYSDK_OFFSET(0x1A84B390)

inline static constexpr unsigned int Class_1_B71FC14BA77C9F77_TypeDefinitionIndex = 79774;
...
public:
	...
	::RPG::GameCore::FixPoint _FinalAmplification_k__BackingField; // 0x20
	::RPG::GameCore::FateRinCardCasterSource _Caster_k__BackingField; // 0x28
	::RPG::Client::FateRin::Card::FateRinBattleCardIdentifier _Identifier_k__BackingField; // 0x2C
	::RPG::GameCore::FateRinCardCasterSource _RawCaster_k__BackingField; // 0x30
	::System::Int32 _ManaCostRaw_k__BackingField; // 0x34
