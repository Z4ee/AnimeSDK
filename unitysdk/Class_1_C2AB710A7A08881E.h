...
#define CLASS_1_C2AB710A7A08881E__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4A3630)
...
public:
	...
	::System::Single LKKHEOOEGMG; // 0x18
	::System::UInt32 CLDPGBHMEOB; // 0x1C
	::RPG::GameCore::ElfTakeOutState MEPFOEEGBEA; // 0x20
