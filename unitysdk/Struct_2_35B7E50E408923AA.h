...
inline static constexpr unsigned int Struct_2_35B7E50E408923AA_TypeDefinitionIndex = 41734;

struct alignas(4) Struct_2_35B7E50E408923AA
{
	...
	::MoleMole::Photo::AnimationTwoBoneIKFlag Field_2_6; // 0x30
};
