...
#define CLASS_2_D87BFE4B9233352A_GET_FIRSTFRAMEOCCLUSION_OFFSET UNITYSDK_OFFSET(0xC09AAF0)
#define CLASS_2_D87BFE4B9233352A_METHOD_2_064D10072154189E_OFFSET UNITYSDK_OFFSET(0xC099780)
#define CLASS_2_D87BFE4B9233352A_METHOD_2_0F6506BADFC93779_OFFSET UNITYSDK_OFFSET(0xC099FF0)
#define CLASS_2_D87BFE4B9233352A_METHOD_2_1A8E27A3DA815532_OFFSET UNITYSDK_OFFSET(0xC09A800)
#define CLASS_2_D87BFE4B9233352A_METHOD_2_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0xC098750)
#define CLASS_2_D87BFE4B9233352A_METHOD_2_5484D998764BDD60_OFFSET UNITYSDK_OFFSET(0xC098960)
#define CLASS_2_D87BFE4B9233352A_METHOD_2_5AEC8C9EE262F230_OFFSET UNITYSDK_OFFSET(0xC09A9F0)
#define CLASS_2_D87BFE4B9233352A_METHOD_2_62EF504AE512C429_OFFSET UNITYSDK_OFFSET(0xC098F10)
#define CLASS_2_D87BFE4B9233352A_METHOD_2_67FE1E45920BC538_OFFSET UNITYSDK_OFFSET(0xC0992C0)
#define CLASS_2_D87BFE4B9233352A_METHOD_2_75E7CAAFEC7D5918_OFFSET UNITYSDK_OFFSET(0xC099DA0)
#define CLASS_2_D87BFE4B9233352A_METHOD_2_A835AB0FF207BB42_OFFSET UNITYSDK_OFFSET(0xC09A5C0)
#define CLASS_2_D87BFE4B9233352A_METHOD_2_B490983EE6E194E5_OFFSET UNITYSDK_OFFSET(0xC099560)
#define CLASS_2_D87BFE4B9233352A_METHOD_2_C59EE4BEDFED23F9_OFFSET UNITYSDK_OFFSET(0xC099930)
#define CLASS_2_D87BFE4B9233352A_METHOD_2_C821E92C9A44CF30_OFFSET UNITYSDK_OFFSET(0xC09A930)
#define CLASS_2_D87BFE4B9233352A_METHOD_2_C8448179FEB34E1E_OFFSET UNITYSDK_OFFSET(0xC099420)
#define CLASS_2_D87BFE4B9233352A_METHOD_2_CD8EB704BDED69B6_OFFSET UNITYSDK_OFFSET(0xC0984D0)
#define CLASS_2_D87BFE4B9233352A_METHOD_2_DF249C0E36759C3F_OFFSET UNITYSDK_OFFSET(0xC098870)
#define CLASS_2_D87BFE4B9233352A_METHOD_2_E270A10BE3BCF880_OFFSET UNITYSDK_OFFSET(0xC09AA50)
#define CLASS_2_D87BFE4B9233352A_METHOD_2_E52B7F78B553D90D_OFFSET UNITYSDK_OFFSET(0xC099E50)
#define CLASS_2_D87BFE4B9233352A_METHOD_2_F647B6F9507BF73F_OFFSET UNITYSDK_OFFSET(0xC09A8D0)
#define CLASS_2_D87BFE4B9233352A_METHOD_2_FDCD653AD53D337B_OFFSET UNITYSDK_OFFSET(0xC099250)
#define CLASS_2_D87BFE4B9233352A_SET_FIRSTFRAMEOCCLUSION_OFFSET UNITYSDK_OFFSET(0xC09AB00)
#define CLASS_2_D87BFE4B9233352A__CTOR_OFFSET UNITYSDK_OFFSET(0xC098450)
...
public:
	...
	::UnityEngine::Collider* NDAFFIDEPKJ; // 0x48
	::RPG::GameCore::ClimbableLinearWithDetectProjectileData* FPGPHIEOMFL; // 0x50
	::System::Single NOPMHDHPOOH; // 0x58
	::System::Single DHKMOEJJJGJ; // 0x5C
	::System::Single LMCBEIHGLDF; // 0x60
	::UnityEngine::Vector3 LOLDFFJAKEB; // 0x64
	::UnityEngine::Vector3 JCACOMLOPAB; // 0x70
	::System::Single GNIPNKGBDNO; // 0x7C
	::System::Boolean OGNJMLNMEMH; // 0x80
	::System::Boolean _FirstFrameOcclusion_k__BackingField; // 0x81
	::System::Boolean FOHBHIHFLMD; // 0x82
	::System::Boolean JENGAMCDOPC; // 0x83
	::UnityEngine::Vector3 DNPILOMHEFL; // 0x84
	...
	::UnityEngine::Vector3 Method_2_B490983EE6E194E5(::UnityEngine::Vector3 a1, ::UnityEngine::Vector3 a2)
	{
		return ((::UnityEngine::Vector3(*)(::PVOID, ::UnityEngine::Vector3, ::UnityEngine::Vector3))((::PBYTE)hIl2Cpp + CLASS_2_D87BFE4B9233352A_METHOD_2_B490983EE6E194E5_OFFSET))(this, a1, a2);
	}
