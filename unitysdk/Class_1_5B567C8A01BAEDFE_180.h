...
#define CLASS_1_5B567C8A01BAEDFE_180_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1EA66BA0)
#define CLASS_1_5B567C8A01BAEDFE_180_CLONE_OFFSET UNITYSDK_OFFSET(0x1EA66890)
#define CLASS_1_5B567C8A01BAEDFE_180_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1EA669A0)
#define CLASS_1_5B567C8A01BAEDFE_180_EQUALS_OFFSET UNITYSDK_OFFSET(0x1EA668D0)
#define CLASS_1_5B567C8A01BAEDFE_180_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1EA66B00)
#define CLASS_1_5B567C8A01BAEDFE_180_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1EA66BF0)
#define CLASS_1_5B567C8A01BAEDFE_180_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1EA66BC0)
#define CLASS_1_5B567C8A01BAEDFE_180_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1EA66810)
#define CLASS_1_5B567C8A01BAEDFE_180_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1EA66840)
#define CLASS_1_5B567C8A01BAEDFE_180_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1EA66B30)
#define CLASS_1_5B567C8A01BAEDFE_180_WRITETO_OFFSET UNITYSDK_OFFSET(0x1EA66B90)
#define CLASS_1_5B567C8A01BAEDFE_180__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EA66C40)
#define CLASS_1_5B567C8A01BAEDFE_180__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EA66860)
#define CLASS_1_5B567C8A01BAEDFE_180__CTOR_OFFSET UNITYSDK_OFFSET(0x1EA66850)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_180_TypeDefinitionIndex = 29679;

class Class_1_5B567C8A01BAEDFE_180 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_180*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_180*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_180_TypeDefinitionIndex)->GetStaticField(0x5ABA0);
	}
