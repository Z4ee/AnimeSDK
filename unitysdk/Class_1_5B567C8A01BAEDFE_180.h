...
#define CLASS_1_5B567C8A01BAEDFE_180_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1CC4DEA0)
#define CLASS_1_5B567C8A01BAEDFE_180_CLONE_OFFSET UNITYSDK_OFFSET(0x1CC4DB90)
#define CLASS_1_5B567C8A01BAEDFE_180_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1CC4DCA0)
#define CLASS_1_5B567C8A01BAEDFE_180_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CC4DBD0)
#define CLASS_1_5B567C8A01BAEDFE_180_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CC4DE00)
#define CLASS_1_5B567C8A01BAEDFE_180_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1CC4DEF0)
#define CLASS_1_5B567C8A01BAEDFE_180_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1CC4DEC0)
#define CLASS_1_5B567C8A01BAEDFE_180_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1CC4DB10)
#define CLASS_1_5B567C8A01BAEDFE_180_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1CC4DB40)
#define CLASS_1_5B567C8A01BAEDFE_180_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1CC4DE30)
#define CLASS_1_5B567C8A01BAEDFE_180_WRITETO_OFFSET UNITYSDK_OFFSET(0x1CC4DE90)
#define CLASS_1_5B567C8A01BAEDFE_180__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CC4DF40)
#define CLASS_1_5B567C8A01BAEDFE_180__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CC4DB60)
#define CLASS_1_5B567C8A01BAEDFE_180__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC4DB50)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_180_TypeDefinitionIndex = 29039;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_180*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_180_TypeDefinitionIndex)->GetStaticField(0x39920);
	}
