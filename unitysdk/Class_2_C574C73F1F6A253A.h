...
#define CLASS_2_C574C73F1F6A253A_DISPOSE_OFFSET UNITYSDK_OFFSET(0xE46F9D0)
#define CLASS_2_C574C73F1F6A253A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xE46F7D0)
#define CLASS_2_C574C73F1F6A253A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xE46FA10)
#define CLASS_2_C574C73F1F6A253A_TICK_OFFSET UNITYSDK_OFFSET(0xE46F970)
#define CLASS_2_C574C73F1F6A253A__CTOR_OFFSET UNITYSDK_OFFSET(0xE46F7C0)
#define CLASS_2_C574C73F1F6A253A__ONTASKBEGIN_B__1_0_OFFSET UNITYSDK_OFFSET(0xE46FA60)

inline static constexpr unsigned int Class_2_C574C73F1F6A253A_TypeDefinitionIndex = 43373;
