...
#define CLASS_2_C574C73F1F6A253A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1381C820)
#define CLASS_2_C574C73F1F6A253A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1381C610)
#define CLASS_2_C574C73F1F6A253A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1381C860)
#define CLASS_2_C574C73F1F6A253A_TICK_OFFSET UNITYSDK_OFFSET(0x1381C7C0)
#define CLASS_2_C574C73F1F6A253A__CTOR_OFFSET UNITYSDK_OFFSET(0x1381C600)
#define CLASS_2_C574C73F1F6A253A__ONTASKBEGIN_B__1_0_OFFSET UNITYSDK_OFFSET(0x1381C8B0)

inline static constexpr unsigned int Class_2_C574C73F1F6A253A_TypeDefinitionIndex = 50039;
