...
#define CLASS_2_C574C73F1F6A253A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9731610)
#define CLASS_2_C574C73F1F6A253A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x9731410)
#define CLASS_2_C574C73F1F6A253A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x9731650)
#define CLASS_2_C574C73F1F6A253A_TICK_OFFSET UNITYSDK_OFFSET(0x97315B0)
#define CLASS_2_C574C73F1F6A253A__CTOR_OFFSET UNITYSDK_OFFSET(0x9731400)
#define CLASS_2_C574C73F1F6A253A__ONTASKBEGIN_B__1_0_OFFSET UNITYSDK_OFFSET(0x97316A0)

inline static constexpr unsigned int Class_2_C574C73F1F6A253A_TypeDefinitionIndex = 49372;

class Class_2_C574C73F1F6A253A : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::GridFightShowGuideTalk* Field_2_1; // 0x18
