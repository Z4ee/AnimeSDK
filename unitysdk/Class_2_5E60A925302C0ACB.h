...
#define CLASS_2_5E60A925302C0ACB_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x16568E00)
#define CLASS_2_5E60A925302C0ACB_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x16568F80)
#define CLASS_2_5E60A925302C0ACB_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x16568060)
#define CLASS_2_5E60A925302C0ACB_GET_TRANS_OFFSET UNITYSDK_OFFSET(0x16568080)
#define CLASS_2_5E60A925302C0ACB_METHOD_2_28EB11670A8E5A86_OFFSET UNITYSDK_OFFSET(0x165680C0)
#define CLASS_2_5E60A925302C0ACB_METHOD_2_7AEA761C95272723_OFFSET UNITYSDK_OFFSET(0x16568980)
#define CLASS_2_5E60A925302C0ACB_METHOD_2_7D2BD1D8D2B63CC7_OFFSET UNITYSDK_OFFSET(0x165687A0)
#define CLASS_2_5E60A925302C0ACB_METHOD_2_A84CEAF7AFA573B3_OFFSET UNITYSDK_OFFSET(0x16568410)
#define CLASS_2_5E60A925302C0ACB_METHOD_2_C5F2E178DAEB1793_OFFSET UNITYSDK_OFFSET(0x165682B0)
#define CLASS_2_5E60A925302C0ACB_METHOD_2_D2A677C6728D2D07_1_OFFSET UNITYSDK_OFFSET(0x165688E0)
#define CLASS_2_5E60A925302C0ACB_METHOD_2_D2A677C6728D2D07_2_OFFSET UNITYSDK_OFFSET(0x16568930)
#define CLASS_2_5E60A925302C0ACB_METHOD_2_D2A677C6728D2D07_OFFSET UNITYSDK_OFFSET(0x16568890)
#define CLASS_2_5E60A925302C0ACB_METHOD_2_DA37DFE3A5BDA9F4_OFFSET UNITYSDK_OFFSET(0x165683C0)
#define CLASS_2_5E60A925302C0ACB_METHOD_2_F37CDBD6D46274D2_1_OFFSET UNITYSDK_OFFSET(0x16568B60)
#define CLASS_2_5E60A925302C0ACB_METHOD_2_F37CDBD6D46274D2_2_OFFSET UNITYSDK_OFFSET(0x16568C40)
#define CLASS_2_5E60A925302C0ACB_METHOD_2_F37CDBD6D46274D2_3_OFFSET UNITYSDK_OFFSET(0x16568D20)
#define CLASS_2_5E60A925302C0ACB_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x16568800)
#define CLASS_2_5E60A925302C0ACB_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x16568070)
#define CLASS_2_5E60A925302C0ACB__CTOR_OFFSET UNITYSDK_OFFSET(0x165690E0)
#define CLASS_2_5E60A925302C0ACB__ONBIND_OFFSET UNITYSDK_OFFSET(0x16567F60)
#define CLASS_2_5E60A925302C0ACB___REFRESHVIEW_B__19_0_OFFSET UNITYSDK_OFFSET(0x16569140)
#define CLASS_2_5E60A925302C0ACB___REFRESHVIEW_B__19_2_OFFSET UNITYSDK_OFFSET(0x165691C0)

inline static constexpr unsigned int Class_2_5E60A925302C0ACB_TypeDefinitionIndex = 72245;
...
public:
	...
	::UnityEngine::Transform* BIFPANKFMND; // 0x60
	::RPG::GameCore::LevelUIComponent* GEAHNEAGEBG; // 0x68
	::RPG::GameCore::TurnBasedAbilityComponent* PCDEEAAIFPK; // 0x70
	::UnityEngine::UI::Button* KJIOINOOIHP; // 0x78
	::RPG::Client::NodeListViewPanel_1<::Class_2_96290D3EA3548FA1*>* DLONGGHDOLM; // 0x80
	::RPG::GameCore::GameEntity* MDLFIFLPDNI; // 0x88
	::System::Collections::Generic::List_1<::RPG::GameCore::TurnBasedModifierInstance*>* PPNIJMHCKHN; // 0x90
