...
#define CLASS_1_5B567C8A01BAEDFE_266_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1ED5C5D0)
#define CLASS_1_5B567C8A01BAEDFE_266_CLONE_OFFSET UNITYSDK_OFFSET(0x1ED5C2C0)
#define CLASS_1_5B567C8A01BAEDFE_266_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1ED5C3D0)
#define CLASS_1_5B567C8A01BAEDFE_266_EQUALS_OFFSET UNITYSDK_OFFSET(0x1ED5C300)
#define CLASS_1_5B567C8A01BAEDFE_266_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1ED5C530)
#define CLASS_1_5B567C8A01BAEDFE_266_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1ED5C620)
#define CLASS_1_5B567C8A01BAEDFE_266_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1ED5C5F0)
#define CLASS_1_5B567C8A01BAEDFE_266_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1ED5C240)
#define CLASS_1_5B567C8A01BAEDFE_266_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1ED5C270)
#define CLASS_1_5B567C8A01BAEDFE_266_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1ED5C560)
#define CLASS_1_5B567C8A01BAEDFE_266_WRITETO_OFFSET UNITYSDK_OFFSET(0x1ED5C5C0)
#define CLASS_1_5B567C8A01BAEDFE_266__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ED5C670)
#define CLASS_1_5B567C8A01BAEDFE_266__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ED5C290)
#define CLASS_1_5B567C8A01BAEDFE_266__CTOR_OFFSET UNITYSDK_OFFSET(0x1ED5C280)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_266_TypeDefinitionIndex = 31589;

class Class_1_5B567C8A01BAEDFE_266 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_266*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_266*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_266_TypeDefinitionIndex)->GetStaticField(0x45CF0);
	}
