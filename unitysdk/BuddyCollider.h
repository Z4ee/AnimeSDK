...
#define BUDDYCOLLIDER_CALCONTAINSGRIDS_OFFSET UNITYSDK_OFFSET(0x12E389C0)
#define BUDDYCOLLIDER_GETLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0x12E38350)
#define BUDDYCOLLIDER_GET_CONTAINSGRIDLIST_OFFSET UNITYSDK_OFFSET(0x12E375D0)
#define BUDDYCOLLIDER_GET_GRIDSCALE_OFFSET UNITYSDK_OFFSET(0x12E375F0)
#define BUDDYCOLLIDER_GET_ISCANPUTDOWN_OFFSET UNITYSDK_OFFSET(0x12E37600)
#define BUDDYCOLLIDER_GET_MESH_OFFSET UNITYSDK_OFFSET(0x12E375B0)
#define BUDDYCOLLIDER_GET_RECTS_OFFSET UNITYSDK_OFFSET(0x12E37590)
#define BUDDYCOLLIDER_ISFULLENCIRCLEMENT_OFFSET UNITYSDK_OFFSET(0x12E387E0)
#define BUDDYCOLLIDER_ISINGRIDMAP_OFFSET UNITYSDK_OFFSET(0x12E38520)
#define BUDDYCOLLIDER_REBUILDCOLLIDERMESH_OFFSET UNITYSDK_OFFSET(0x12E378B0)
#define BUDDYCOLLIDER_ROTATE2_OFFSET UNITYSDK_OFFSET(0x12E37FB0)
#define BUDDYCOLLIDER_ROTATEPOINT_OFFSET UNITYSDK_OFFSET(0x12E38210)
#define BUDDYCOLLIDER_ROTATE_OFFSET UNITYSDK_OFFSET(0x12E37E30)
#define BUDDYCOLLIDER_SETRCTPOSITION_OFFSET UNITYSDK_OFFSET(0x12E37C30)
#define BUDDYCOLLIDER_SET_CONTAINSGRIDLIST_OFFSET UNITYSDK_OFFSET(0x12E375E0)
#define BUDDYCOLLIDER_SET_ISCANPUTDOWN_OFFSET UNITYSDK_OFFSET(0x12E37610)
#define BUDDYCOLLIDER_SET_MESH_OFFSET UNITYSDK_OFFSET(0x12E375C0)
#define BUDDYCOLLIDER_SET_RECTS_OFFSET UNITYSDK_OFFSET(0x12E375A0)
#define BUDDYCOLLIDER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x12E37D90)
#define BUDDYCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x12E37620)

inline static constexpr unsigned int BuddyCollider_TypeDefinitionIndex = 40663;

class BuddyCollider : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::UnityEngine::Vector2>* initLocalPos; // 0x10
	::System::Collections::Generic::List_1<::UnityEngine::Vector2>* _ContainsGridList_k__BackingField; // 0x18
	::System::Collections::Generic::List_1<::UnityEngine::Vector2>* initMesh; // 0x20
	::System::Collections::Generic::List_1<::UnityEngine::Vector2>* _Mesh_k__BackingField; // 0x28
	::System::Collections::Generic::List_1<::Struct_2_143B7A497B890286>* _Rects_k__BackingField; // 0x30
	::System::Int32 gridScale; // 0x38
	::Struct_2_143B7A497B890286 outLineRect; // 0x3C
	::System::Boolean _IsCanPutDown_k__BackingField; // 0x54
	::UnityEngine::Vector2 Spacing; // 0x58
	::UnityEngine::Vector2 gridMax; // 0x60
	::UnityEngine::Vector2 outLineSize; // 0x68
	::UnityEngine::Vector2 center; // 0x70
	::System::Int32 currentAngle; // 0x78
	::UnityEngine::Vector2 centerOffset; // 0x7C
