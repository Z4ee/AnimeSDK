...
#define MATANIMATION_AWAKE_OFFSET UNITYSDK_OFFSET(0x12CF9DF0)
#define MATANIMATION_GET_TARGETMATERIAL_OFFSET UNITYSDK_OFFSET(0x12CF9C40)
#define MATANIMATION_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x12CF9F80)
#define MATANIMATION_RECOVERMATPROPERTY_OFFSET UNITYSDK_OFFSET(0x12CFA020)
#define MATANIMATION_SETMAT_OFFSET UNITYSDK_OFFSET(0x12CFA0C0)
#define MATANIMATION_STARTANIMATION_OFFSET UNITYSDK_OFFSET(0x12CF9E50)
#define MATANIMATION_STOPANIMATION_OFFSET UNITYSDK_OFFSET(0x12CFA160)
#define MATANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x12CFA1B0)

inline static constexpr unsigned int MatAnimation_TypeDefinitionIndex = 79189;
