...
#define RPG_MQUATERNION_ANGLE_OFFSET UNITYSDK_OFFSET(0x14BE9320)
#define RPG_MQUATERNION_CREATEQUATERNIONFROMAXISQUATERNIONS_OFFSET UNITYSDK_OFFSET(0x14BE9CB0)
#define RPG_MQUATERNION_DOT_OFFSET UNITYSDK_OFFSET(0x14BE92B0)
#define RPG_MQUATERNION_EQUALS_OFFSET UNITYSDK_OFFSET(0x38DAD20)
#define RPG_MQUATERNION_EULER_OFFSET UNITYSDK_OFFSET(0x14BE9AB0)
#define RPG_MQUATERNION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x38DACA0)
#define RPG_MQUATERNION_GET_EULERANGLES_OFFSET UNITYSDK_OFFSET(0x38DAC80)
#define RPG_MQUATERNION_GET_IDENTITY_OFFSET UNITYSDK_OFFSET(0x14BE9080)
#define RPG_MQUATERNION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x38DAB20)
#define RPG_MQUATERNION_INTERNAL_MAKEPOSITIVE_OFFSET UNITYSDK_OFFSET(0x14BE9380)
#define RPG_MQUATERNION_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x14BE9270)
#define RPG_MQUATERNION_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x14BE92E0)
#define RPG_MQUATERNION_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x14BE9140)
#define RPG_MQUATERNION_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x14BE9090)
#define RPG_MQUATERNION_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x38DABD0)
#define RPG_MQUATERNION_SET_OFFSET UNITYSDK_OFFSET(0x7AF9A0)
#define RPG_MQUATERNION_TOEULERANGLE_OFFSET UNITYSDK_OFFSET(0x14BE8D10)
#define RPG_MQUATERNION_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x38DAE30)
#define RPG_MQUATERNION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x38DAE20)
#define RPG_MQUATERNION__CCTOR_OFFSET UNITYSDK_OFFSET(0x14BE9E60)
#define RPG_MQUATERNION__CTOR_OFFSET UNITYSDK_OFFSET(0x7AF9A0)

namespace RPG
{
	inline static constexpr unsigned int MQuaternion_TypeDefinitionIndex = 6767;

	struct alignas(4) MQuaternion
	{
		static ::RPG::MQuaternion* StaticGet_identityQuaternion()
		{
			return (::RPG::MQuaternion*)Il2CppClass::FromTypeDefinitionIndex(MQuaternion_TypeDefinitionIndex)->GetStaticField(0x33C0);
		}
