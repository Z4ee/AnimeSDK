...
#define RPG_MQUATERNION_ANGLE_OFFSET UNITYSDK_OFFSET(0x163BE840)
#define RPG_MQUATERNION_CREATEQUATERNIONFROMAXISQUATERNIONS_OFFSET UNITYSDK_OFFSET(0x163BF170)
#define RPG_MQUATERNION_DOT_OFFSET UNITYSDK_OFFSET(0x163BE7D0)
#define RPG_MQUATERNION_EQUALS_OFFSET UNITYSDK_OFFSET(0x3A544A0)
#define RPG_MQUATERNION_EULER_OFFSET UNITYSDK_OFFSET(0x163BEF70)
#define RPG_MQUATERNION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3A54420)
#define RPG_MQUATERNION_GET_EULERANGLES_OFFSET UNITYSDK_OFFSET(0x3A54400)
#define RPG_MQUATERNION_GET_IDENTITY_OFFSET UNITYSDK_OFFSET(0x163BE5A0)
#define RPG_MQUATERNION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x3A542A0)
#define RPG_MQUATERNION_INTERNAL_MAKEPOSITIVE_OFFSET UNITYSDK_OFFSET(0x163BE8A0)
#define RPG_MQUATERNION_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x163BE790)
#define RPG_MQUATERNION_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x163BE800)
#define RPG_MQUATERNION_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x163BE660)
#define RPG_MQUATERNION_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x163BE5B0)
#define RPG_MQUATERNION_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x3A54350)
#define RPG_MQUATERNION_SET_OFFSET UNITYSDK_OFFSET(0x82E380)
#define RPG_MQUATERNION_TOEULERANGLE_OFFSET UNITYSDK_OFFSET(0x163BE230)
#define RPG_MQUATERNION_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x3A545B0)
#define RPG_MQUATERNION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3A545A0)
#define RPG_MQUATERNION__CCTOR_OFFSET UNITYSDK_OFFSET(0x163BF320)
#define RPG_MQUATERNION__CTOR_OFFSET UNITYSDK_OFFSET(0x82E380)

namespace RPG
{
	inline static constexpr unsigned int MQuaternion_TypeDefinitionIndex = 6379;

	struct alignas(4) MQuaternion
	{
		static ::RPG::MQuaternion* StaticGet_identityQuaternion()
		{
			return (::RPG::MQuaternion*)Il2CppClass::FromTypeDefinitionIndex(MQuaternion_TypeDefinitionIndex)->GetStaticField(0x9930);
		}
