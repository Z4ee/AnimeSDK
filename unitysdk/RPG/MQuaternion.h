...
#define RPG_MQUATERNION_ANGLE_OFFSET UNITYSDK_OFFSET(0x1D78A130)
#define RPG_MQUATERNION_CREATEQUATERNIONFROMAXISQUATERNIONS_OFFSET UNITYSDK_OFFSET(0x1D78AA60)
#define RPG_MQUATERNION_DOT_OFFSET UNITYSDK_OFFSET(0x1D78A0C0)
#define RPG_MQUATERNION_EQUALS_OFFSET UNITYSDK_OFFSET(0x3B99580)
#define RPG_MQUATERNION_EULER_OFFSET UNITYSDK_OFFSET(0x1D78A860)
#define RPG_MQUATERNION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3B8ED30)
#define RPG_MQUATERNION_GET_EULERANGLES_OFFSET UNITYSDK_OFFSET(0x3B99560)
#define RPG_MQUATERNION_GET_IDENTITY_OFFSET UNITYSDK_OFFSET(0x1D789E90)
#define RPG_MQUATERNION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x3B99400)
#define RPG_MQUATERNION_INTERNAL_MAKEPOSITIVE_OFFSET UNITYSDK_OFFSET(0x1D78A190)
#define RPG_MQUATERNION_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1D78A080)
#define RPG_MQUATERNION_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1D78A0F0)
#define RPG_MQUATERNION_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1D789F50)
#define RPG_MQUATERNION_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1D789EA0)
#define RPG_MQUATERNION_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x3B994B0)
#define RPG_MQUATERNION_SET_OFFSET UNITYSDK_OFFSET(0x25B40)
#define RPG_MQUATERNION_TOEULERANGLE_OFFSET UNITYSDK_OFFSET(0x1D789B20)
#define RPG_MQUATERNION_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x3B99690)
#define RPG_MQUATERNION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3B99680)
#define RPG_MQUATERNION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D78AC10)
#define RPG_MQUATERNION__CTOR_OFFSET UNITYSDK_OFFSET(0x25B40)
...
namespace RPG
{
	...
	struct alignas(4) MQuaternion
	{
		...
		{
			return (::RPG::MQuaternion*)Il2CppClass::FromTypeDefinitionIndex(MQuaternion_TypeDefinitionIndex)->GetStaticField(0xA100);
		}
