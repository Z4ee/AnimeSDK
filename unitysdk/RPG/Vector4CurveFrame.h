...
#define RPG_VECTOR4CURVEFRAME_COMPARETO_OFFSET UNITYSDK_OFFSET(0x3864130)
#define RPG_VECTOR4CURVEFRAME_GETTIME_OFFSET UNITYSDK_OFFSET(0xD4D0)
#define RPG_VECTOR4CURVEFRAME_GETVALUE_OFFSET UNITYSDK_OFFSET(0x2D2CE60)
#define RPG_VECTOR4CURVEFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x3864190)

namespace RPG
{
	inline static constexpr unsigned int Vector4CurveFrame_TypeDefinitionIndex = 6714;
