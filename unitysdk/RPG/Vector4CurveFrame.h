...
#define RPG_VECTOR4CURVEFRAME_COMPARETO_OFFSET UNITYSDK_OFFSET(0x3C98200)
#define RPG_VECTOR4CURVEFRAME_GETTIME_OFFSET UNITYSDK_OFFSET(0x213E0)
#define RPG_VECTOR4CURVEFRAME_GETVALUE_OFFSET UNITYSDK_OFFSET(0x3AE8F80)
#define RPG_VECTOR4CURVEFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x3C98260)

namespace RPG
{
	inline static constexpr unsigned int Vector4CurveFrame_TypeDefinitionIndex = 6331;
