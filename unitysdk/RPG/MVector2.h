...
#define RPG_MVECTOR2_ANGLE_OFFSET UNITYSDK_OFFSET(0x14BEB1E0)
#define RPG_MVECTOR2_CLAMPMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x14BEB560)
#define RPG_MVECTOR2_DISTANCE_OFFSET UNITYSDK_OFFSET(0x14BEB520)
#define RPG_MVECTOR2_DOT_OFFSET UNITYSDK_OFFSET(0x14BEB1B0)
#define RPG_MVECTOR2_EQUALS_OFFSET UNITYSDK_OFFSET(0x38DB880)
#define RPG_MVECTOR2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x38DB840)
#define RPG_MVECTOR2_GET_DOWN_OFFSET UNITYSDK_OFFSET(0x1D25F570)
#define RPG_MVECTOR2_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x38DB4C0)
#define RPG_MVECTOR2_GET_LEFT_OFFSET UNITYSDK_OFFSET(0x1D25F580)
#define RPG_MVECTOR2_GET_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x38DB900)
#define RPG_MVECTOR2_GET_NEGATIVEINFINITY_OFFSET UNITYSDK_OFFSET(0x1D25F5B0)
#define RPG_MVECTOR2_GET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x38DB660)
#define RPG_MVECTOR2_GET_ONE_OFFSET UNITYSDK_OFFSET(0x1D25F550)
#define RPG_MVECTOR2_GET_POSITIVEINFINITY_OFFSET UNITYSDK_OFFSET(0x1D25F5A0)
#define RPG_MVECTOR2_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x1D25F590)
#define RPG_MVECTOR2_GET_SQRMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x38DB930)
#define RPG_MVECTOR2_GET_UP_OFFSET UNITYSDK_OFFSET(0x1D25F560)
#define RPG_MVECTOR2_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x1D25F540)
#define RPG_MVECTOR2_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x14BEADD0)
#define RPG_MVECTOR2_LERP_OFFSET UNITYSDK_OFFSET(0x14BEAD60)
#define RPG_MVECTOR2_MAX_OFFSET UNITYSDK_OFFSET(0x14BEB690)
#define RPG_MVECTOR2_MIN_OFFSET UNITYSDK_OFFSET(0x14BEB660)
#define RPG_MVECTOR2_MOVETOWARDS_OFFSET UNITYSDK_OFFSET(0x14BEAE10)
#define RPG_MVECTOR2_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x38DB5F0)
#define RPG_MVECTOR2_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x14BB9D10)
#define RPG_MVECTOR2_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x14BBFCB0)
#define RPG_MVECTOR2_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1D25F480)
#define RPG_MVECTOR2_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1D25F510)
#define RPG_MVECTOR2_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1D25F500)
#define RPG_MVECTOR2_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1D25F4C0)
#define RPG_MVECTOR2_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x14BB9CE0)
#define RPG_MVECTOR2_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x14BBBEC0)
#define RPG_MVECTOR2_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x14BB90A0)
#define RPG_MVECTOR2_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x14BD4290)
#define RPG_MVECTOR2_REFLECT_OFFSET UNITYSDK_OFFSET(0x14BEB150)
#define RPG_MVECTOR2_SCALE_1_OFFSET UNITYSDK_OFFSET(0x38DB5D0)
#define RPG_MVECTOR2_SCALE_OFFSET UNITYSDK_OFFSET(0x14BEAEF0)
#define RPG_MVECTOR2_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x38DB540)
#define RPG_MVECTOR2_SET_OFFSET UNITYSDK_OFFSET(0x6E8510)
#define RPG_MVECTOR2_SIGNEDANGLE_OFFSET UNITYSDK_OFFSET(0x14BEB360)
#define RPG_MVECTOR2_SMOOTHDAMP_OFFSET UNITYSDK_OFFSET(0x14BEB6C0)
#define RPG_MVECTOR2_SQRMAGNITUDE_1_OFFSET UNITYSDK_OFFSET(0x38DB930)
#define RPG_MVECTOR2_SQRMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x14BEB630)
#define RPG_MVECTOR2_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x38DB790)
#define RPG_MVECTOR2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x38DB6E0)
#define RPG_MVECTOR2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D25F5C0)
#define RPG_MVECTOR2__CTOR_OFFSET UNITYSDK_OFFSET(0x6E8510)
