...
#define RPG_MVECTOR2_ANGLE_OFFSET UNITYSDK_OFFSET(0x1922AE80)
#define RPG_MVECTOR2_CLAMPMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x1922B1F0)
#define RPG_MVECTOR2_DISTANCE_OFFSET UNITYSDK_OFFSET(0x1922B1B0)
#define RPG_MVECTOR2_DOT_OFFSET UNITYSDK_OFFSET(0x19221810)
#define RPG_MVECTOR2_EQUALS_OFFSET UNITYSDK_OFFSET(0x22CA2F0)
#define RPG_MVECTOR2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x22CA2B0)
#define RPG_MVECTOR2_GET_DOWN_OFFSET UNITYSDK_OFFSET(0x1922B6A0)
#define RPG_MVECTOR2_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x22C9F30)
#define RPG_MVECTOR2_GET_LEFT_OFFSET UNITYSDK_OFFSET(0x1922B6B0)
#define RPG_MVECTOR2_GET_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x22CA370)
#define RPG_MVECTOR2_GET_NEGATIVEINFINITY_OFFSET UNITYSDK_OFFSET(0x1922B6E0)
#define RPG_MVECTOR2_GET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x22CA0D0)
#define RPG_MVECTOR2_GET_ONE_OFFSET UNITYSDK_OFFSET(0x1922B680)
#define RPG_MVECTOR2_GET_POSITIVEINFINITY_OFFSET UNITYSDK_OFFSET(0x1922B6D0)
#define RPG_MVECTOR2_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x1922B6C0)
#define RPG_MVECTOR2_GET_SQRMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x22CA3A0)
#define RPG_MVECTOR2_GET_UP_OFFSET UNITYSDK_OFFSET(0x1922B690)
#define RPG_MVECTOR2_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x1922B670)
#define RPG_MVECTOR2_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x1922AA20)
#define RPG_MVECTOR2_LERP_OFFSET UNITYSDK_OFFSET(0x1922A9C0)
#define RPG_MVECTOR2_MAX_OFFSET UNITYSDK_OFFSET(0x1922B320)
#define RPG_MVECTOR2_MIN_OFFSET UNITYSDK_OFFSET(0x1922B2F0)
#define RPG_MVECTOR2_MOVETOWARDS_OFFSET UNITYSDK_OFFSET(0x1922AA60)
#define RPG_MVECTOR2_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x22CA060)
#define RPG_MVECTOR2_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x191F3570)
#define RPG_MVECTOR2_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x192212F0)
#define RPG_MVECTOR2_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1922B5B0)
#define RPG_MVECTOR2_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1922B640)
#define RPG_MVECTOR2_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1922B630)
#define RPG_MVECTOR2_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1922B5F0)
#define RPG_MVECTOR2_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x191F3540)
#define RPG_MVECTOR2_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x191F6720)
#define RPG_MVECTOR2_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x191F28D0)
#define RPG_MVECTOR2_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1920EE90)
#define RPG_MVECTOR2_REFLECT_OFFSET UNITYSDK_OFFSET(0x1922AE20)
#define RPG_MVECTOR2_SCALE_1_OFFSET UNITYSDK_OFFSET(0x22CA040)
#define RPG_MVECTOR2_SCALE_OFFSET UNITYSDK_OFFSET(0x1922AB40)
#define RPG_MVECTOR2_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x22C9FB0)
#define RPG_MVECTOR2_SET_OFFSET UNITYSDK_OFFSET(0x2A140)
#define RPG_MVECTOR2_SIGNEDANGLE_OFFSET UNITYSDK_OFFSET(0x1922B000)
#define RPG_MVECTOR2_SMOOTHDAMP_OFFSET UNITYSDK_OFFSET(0x1922B350)
#define RPG_MVECTOR2_SQRMAGNITUDE_1_OFFSET UNITYSDK_OFFSET(0x22CA3A0)
#define RPG_MVECTOR2_SQRMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x1922B2C0)
#define RPG_MVECTOR2_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x22CA200)
#define RPG_MVECTOR2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x22CA150)
#define RPG_MVECTOR2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1922B6F0)
#define RPG_MVECTOR2__CTOR_OFFSET UNITYSDK_OFFSET(0x2A140)
