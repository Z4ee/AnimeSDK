...
#define RPG_MRECT_EQUALS_OFFSET UNITYSDK_OFFSET(0x22C9DB0)
#define RPG_MRECT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x22C9D30)
#define RPG_MRECT_GET_BOTTOM_OFFSET UNITYSDK_OFFSET(0x22C9F20)
#define RPG_MRECT_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x22C9910)
#define RPG_MRECT_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0xCCB0)
#define RPG_MRECT_GET_LEFT_OFFSET UNITYSDK_OFFSET(0xCC50)
#define RPG_MRECT_GET_MAX_OFFSET UNITYSDK_OFFSET(0x22C9980)
#define RPG_MRECT_GET_MIN_OFFSET UNITYSDK_OFFSET(0x5580)
#define RPG_MRECT_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x5580)
#define RPG_MRECT_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x229B650)
#define RPG_MRECT_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x5AF0)
#define RPG_MRECT_GET_TOP_OFFSET UNITYSDK_OFFSET(0xCC70)
#define RPG_MRECT_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0xCC90)
#define RPG_MRECT_GET_XMAX_OFFSET UNITYSDK_OFFSET(0x22C9A10)
#define RPG_MRECT_GET_XMIN_OFFSET UNITYSDK_OFFSET(0xCC50)
#define RPG_MRECT_GET_X_OFFSET UNITYSDK_OFFSET(0xCC50)
#define RPG_MRECT_GET_YMAX_OFFSET UNITYSDK_OFFSET(0x22C9A30)
#define RPG_MRECT_GET_YMIN_OFFSET UNITYSDK_OFFSET(0xCC70)
#define RPG_MRECT_GET_Y_OFFSET UNITYSDK_OFFSET(0xCC70)
#define RPG_MRECT_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x19229AE0)
#define RPG_MRECT_METHOD_2_049CD1907283FB4E_OFFSET UNITYSDK_OFFSET(0x19229EB0)
#define RPG_MRECT_METHOD_2_1B9EA960A9DB41B1_OFFSET UNITYSDK_OFFSET(0x19229AF0)
#define RPG_MRECT_METHOD_2_263BE4375B628391_OFFSET UNITYSDK_OFFSET(0x22C9F10)
#define RPG_MRECT_METHOD_2_4022C2F79758BB77_OFFSET UNITYSDK_OFFSET(0x22C9A90)
#define RPG_MRECT_METHOD_2_5B0203A4BE86EC04_OFFSET UNITYSDK_OFFSET(0x22C9A50)
#define RPG_MRECT_METHOD_2_722BF5E0036337D0_1_OFFSET UNITYSDK_OFFSET(0x1922A180)
#define RPG_MRECT_METHOD_2_722BF5E0036337D0_OFFSET UNITYSDK_OFFSET(0x1922A140)
#define RPG_MRECT_METHOD_2_8264E922558C7063_OFFSET UNITYSDK_OFFSET(0x22C9AD0)
#define RPG_MRECT_METHOD_2_90D402E1D634495E_OFFSET UNITYSDK_OFFSET(0x1922A0A0)
#define RPG_MRECT_METHOD_2_9D50E61CF9674A13_OFFSET UNITYSDK_OFFSET(0x1922A010)
#define RPG_MRECT_METHOD_2_A574C24F2647CF85_OFFSET UNITYSDK_OFFSET(0x22C9B90)
#define RPG_MRECT_METHOD_2_CFB00F7EDF0A1A72_OFFSET UNITYSDK_OFFSET(0x22C9BE0)
#define RPG_MRECT_METHOD_2_D375F1894550A459_OFFSET UNITYSDK_OFFSET(0x24C30)
#define RPG_MRECT_SET_CENTER_OFFSET UNITYSDK_OFFSET(0x22C9940)
#define RPG_MRECT_SET_HEIGHT_OFFSET UNITYSDK_OFFSET(0xCCC0)
#define RPG_MRECT_SET_MAX_OFFSET UNITYSDK_OFFSET(0x22C99B0)
#define RPG_MRECT_SET_MIN_OFFSET UNITYSDK_OFFSET(0x22C9960)
#define RPG_MRECT_SET_POSITION_OFFSET UNITYSDK_OFFSET(0xBDC0)
#define RPG_MRECT_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x8D10)
#define RPG_MRECT_SET_WIDTH_OFFSET UNITYSDK_OFFSET(0xCCA0)
#define RPG_MRECT_SET_XMAX_OFFSET UNITYSDK_OFFSET(0x22C9A20)
#define RPG_MRECT_SET_XMIN_OFFSET UNITYSDK_OFFSET(0x22C99D0)
#define RPG_MRECT_SET_X_OFFSET UNITYSDK_OFFSET(0xCC60)
#define RPG_MRECT_SET_YMAX_OFFSET UNITYSDK_OFFSET(0x22C9A40)
#define RPG_MRECT_SET_YMIN_OFFSET UNITYSDK_OFFSET(0x22C99F0)
#define RPG_MRECT_SET_Y_OFFSET UNITYSDK_OFFSET(0xCC80)
#define RPG_MRECT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x22C9F00)
#define RPG_MRECT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x22C98F0)
#define RPG_MRECT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1682A10)
#define RPG_MRECT__CTOR_OFFSET UNITYSDK_OFFSET(0x24C30)

namespace RPG
{
	inline static constexpr unsigned int MRect_TypeDefinitionIndex = 8900;
