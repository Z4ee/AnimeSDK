...
#define RPG_MRECT_EQUALS_OFFSET UNITYSDK_OFFSET(0x38DB330)
#define RPG_MRECT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x38DB2B0)
#define RPG_MRECT_GET_BOTTOM_OFFSET UNITYSDK_OFFSET(0x38DB4B0)
#define RPG_MRECT_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x38DAE70)
#define RPG_MRECT_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0xA4C4A0)
#define RPG_MRECT_GET_LEFT_OFFSET UNITYSDK_OFFSET(0x167F50)
#define RPG_MRECT_GET_MAX_OFFSET UNITYSDK_OFFSET(0x38DAEE0)
#define RPG_MRECT_GET_MIN_OFFSET UNITYSDK_OFFSET(0x1651A0)
#define RPG_MRECT_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1651A0)
#define RPG_MRECT_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x38DB4A0)
#define RPG_MRECT_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x676DC0)
#define RPG_MRECT_GET_TOP_OFFSET UNITYSDK_OFFSET(0x7A80F0)
#define RPG_MRECT_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0xA4BEB0)
#define RPG_MRECT_GET_XMAX_OFFSET UNITYSDK_OFFSET(0x38DAF90)
#define RPG_MRECT_GET_XMIN_OFFSET UNITYSDK_OFFSET(0x167F50)
#define RPG_MRECT_GET_X_OFFSET UNITYSDK_OFFSET(0x167F50)
#define RPG_MRECT_GET_YMAX_OFFSET UNITYSDK_OFFSET(0x38DAFB0)
#define RPG_MRECT_GET_YMIN_OFFSET UNITYSDK_OFFSET(0x7A80F0)
#define RPG_MRECT_GET_Y_OFFSET UNITYSDK_OFFSET(0x7A80F0)
#define RPG_MRECT_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x14BE9EE0)
#define RPG_MRECT_METHOD_2_049CD1907283FB4E_OFFSET UNITYSDK_OFFSET(0x14BEA290)
#define RPG_MRECT_METHOD_2_1B9EA960A9DB41B1_OFFSET UNITYSDK_OFFSET(0x14BE9EF0)
#define RPG_MRECT_METHOD_2_4022C2F79758BB77_OFFSET UNITYSDK_OFFSET(0x38DB010)
#define RPG_MRECT_METHOD_2_5B0203A4BE86EC04_OFFSET UNITYSDK_OFFSET(0x38DAFD0)
#define RPG_MRECT_METHOD_2_722BF5E0036337D0_1_OFFSET UNITYSDK_OFFSET(0x14BEA560)
#define RPG_MRECT_METHOD_2_722BF5E0036337D0_OFFSET UNITYSDK_OFFSET(0x14BEA520)
#define RPG_MRECT_METHOD_2_8264E922558C7063_OFFSET UNITYSDK_OFFSET(0x38DB050)
#define RPG_MRECT_METHOD_2_90D402E1D634495E_OFFSET UNITYSDK_OFFSET(0x14BEA480)
#define RPG_MRECT_METHOD_2_9D50E61CF9674A13_OFFSET UNITYSDK_OFFSET(0x14BEA3F0)
#define RPG_MRECT_METHOD_2_A574C24F2647CF85_OFFSET UNITYSDK_OFFSET(0x38DB110)
#define RPG_MRECT_METHOD_2_C8AF816F85BE923A_OFFSET UNITYSDK_OFFSET(0x38DB490)
#define RPG_MRECT_METHOD_2_CFB00F7EDF0A1A72_OFFSET UNITYSDK_OFFSET(0x38DB160)
#define RPG_MRECT_METHOD_2_D375F1894550A459_OFFSET UNITYSDK_OFFSET(0x7AF9A0)
#define RPG_MRECT_SET_CENTER_OFFSET UNITYSDK_OFFSET(0x38DAEA0)
#define RPG_MRECT_SET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x38DAF40)
#define RPG_MRECT_SET_MAX_OFFSET UNITYSDK_OFFSET(0x38DAF10)
#define RPG_MRECT_SET_MIN_OFFSET UNITYSDK_OFFSET(0x38DAEC0)
#define RPG_MRECT_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x164FF0)
#define RPG_MRECT_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x7BE220)
#define RPG_MRECT_SET_WIDTH_OFFSET UNITYSDK_OFFSET(0x38DAF30)
#define RPG_MRECT_SET_XMAX_OFFSET UNITYSDK_OFFSET(0x38DAFA0)
#define RPG_MRECT_SET_XMIN_OFFSET UNITYSDK_OFFSET(0x38DAF50)
#define RPG_MRECT_SET_X_OFFSET UNITYSDK_OFFSET(0x167DB0)
#define RPG_MRECT_SET_YMAX_OFFSET UNITYSDK_OFFSET(0x38DAFC0)
#define RPG_MRECT_SET_YMIN_OFFSET UNITYSDK_OFFSET(0x38DAF70)
#define RPG_MRECT_SET_Y_OFFSET UNITYSDK_OFFSET(0x38DAE60)
#define RPG_MRECT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x38DB480)
#define RPG_MRECT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x38DAE40)
#define RPG_MRECT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x165220)
#define RPG_MRECT__CTOR_OFFSET UNITYSDK_OFFSET(0x7AF9A0)

namespace RPG
{
	inline static constexpr unsigned int MRect_TypeDefinitionIndex = 6769;
