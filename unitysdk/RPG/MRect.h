...
#define RPG_MRECT_EQUALS_OFFSET UNITYSDK_OFFSET(0x3A54AB0)
#define RPG_MRECT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3A54A30)
#define RPG_MRECT_GET_BOTTOM_OFFSET UNITYSDK_OFFSET(0x3A54C30)
#define RPG_MRECT_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x3A545F0)
#define RPG_MRECT_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0xB5A7F0)
#define RPG_MRECT_GET_LEFT_OFFSET UNITYSDK_OFFSET(0x213E0)
#define RPG_MRECT_GET_MAX_OFFSET UNITYSDK_OFFSET(0x3A54660)
#define RPG_MRECT_GET_MIN_OFFSET UNITYSDK_OFFSET(0x161E0)
#define RPG_MRECT_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x161E0)
#define RPG_MRECT_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x3A54C20)
#define RPG_MRECT_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x7846F0)
#define RPG_MRECT_GET_TOP_OFFSET UNITYSDK_OFFSET(0x784700)
#define RPG_MRECT_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0xB5A200)
#define RPG_MRECT_GET_XMAX_OFFSET UNITYSDK_OFFSET(0x3A54710)
#define RPG_MRECT_GET_XMIN_OFFSET UNITYSDK_OFFSET(0x213E0)
#define RPG_MRECT_GET_X_OFFSET UNITYSDK_OFFSET(0x213E0)
#define RPG_MRECT_GET_YMAX_OFFSET UNITYSDK_OFFSET(0x3A54730)
#define RPG_MRECT_GET_YMIN_OFFSET UNITYSDK_OFFSET(0x784700)
#define RPG_MRECT_GET_Y_OFFSET UNITYSDK_OFFSET(0x784700)
#define RPG_MRECT_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x163BF3A0)
#define RPG_MRECT_METHOD_2_049CD1907283FB4E_OFFSET UNITYSDK_OFFSET(0x163BF750)
#define RPG_MRECT_METHOD_2_1B9EA960A9DB41B1_OFFSET UNITYSDK_OFFSET(0x163BF3B0)
#define RPG_MRECT_METHOD_2_4022C2F79758BB77_OFFSET UNITYSDK_OFFSET(0x3A54790)
#define RPG_MRECT_METHOD_2_5B0203A4BE86EC04_OFFSET UNITYSDK_OFFSET(0x3A54750)
#define RPG_MRECT_METHOD_2_722BF5E0036337D0_1_OFFSET UNITYSDK_OFFSET(0x163BFA20)
#define RPG_MRECT_METHOD_2_722BF5E0036337D0_OFFSET UNITYSDK_OFFSET(0x163BF9E0)
#define RPG_MRECT_METHOD_2_8264E922558C7063_OFFSET UNITYSDK_OFFSET(0x3A547D0)
#define RPG_MRECT_METHOD_2_90D402E1D634495E_OFFSET UNITYSDK_OFFSET(0x163BF940)
#define RPG_MRECT_METHOD_2_9D50E61CF9674A13_OFFSET UNITYSDK_OFFSET(0x163BF8B0)
#define RPG_MRECT_METHOD_2_A574C24F2647CF85_OFFSET UNITYSDK_OFFSET(0x3A54890)
#define RPG_MRECT_METHOD_2_C8AF816F85BE923A_OFFSET UNITYSDK_OFFSET(0x3A54C10)
#define RPG_MRECT_METHOD_2_CFB00F7EDF0A1A72_OFFSET UNITYSDK_OFFSET(0x3A548E0)
#define RPG_MRECT_METHOD_2_D375F1894550A459_OFFSET UNITYSDK_OFFSET(0x82E380)
#define RPG_MRECT_SET_CENTER_OFFSET UNITYSDK_OFFSET(0x3A54620)
#define RPG_MRECT_SET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x3A546C0)
#define RPG_MRECT_SET_MAX_OFFSET UNITYSDK_OFFSET(0x3A54690)
#define RPG_MRECT_SET_MIN_OFFSET UNITYSDK_OFFSET(0x3A54640)
#define RPG_MRECT_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x16050)
#define RPG_MRECT_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x869800)
#define RPG_MRECT_SET_WIDTH_OFFSET UNITYSDK_OFFSET(0x3A546B0)
#define RPG_MRECT_SET_XMAX_OFFSET UNITYSDK_OFFSET(0x3A54720)
#define RPG_MRECT_SET_XMIN_OFFSET UNITYSDK_OFFSET(0x3A546D0)
#define RPG_MRECT_SET_X_OFFSET UNITYSDK_OFFSET(0x21240)
#define RPG_MRECT_SET_YMAX_OFFSET UNITYSDK_OFFSET(0x3A54740)
#define RPG_MRECT_SET_YMIN_OFFSET UNITYSDK_OFFSET(0x3A546F0)
#define RPG_MRECT_SET_Y_OFFSET UNITYSDK_OFFSET(0x3A545E0)
#define RPG_MRECT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3A54C00)
#define RPG_MRECT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3A545C0)
#define RPG_MRECT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x148D0)
#define RPG_MRECT__CTOR_OFFSET UNITYSDK_OFFSET(0x82E380)
