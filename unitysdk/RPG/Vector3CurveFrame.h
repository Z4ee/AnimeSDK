...
#define RPG_VECTOR3CURVEFRAME_COMPARETO_OFFSET UNITYSDK_OFFSET(0x20F81D0)
#define RPG_VECTOR3CURVEFRAME_GETTIME_OFFSET UNITYSDK_OFFSET(0xCC60)
#define RPG_VECTOR3CURVEFRAME_GETVALUE_OFFSET UNITYSDK_OFFSET(0x7F9E0)
#define RPG_VECTOR3CURVEFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x20F81B0)

namespace RPG
{
	inline static constexpr unsigned int Vector3CurveFrame_TypeDefinitionIndex = 8655;
