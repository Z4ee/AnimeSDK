...
#define RPG_VECTOR3CURVEFRAME_COMPARETO_OFFSET UNITYSDK_OFFSET(0x3B9A7C0)
#define RPG_VECTOR3CURVEFRAME_GETTIME_OFFSET UNITYSDK_OFFSET(0xD4B0)
#define RPG_VECTOR3CURVEFRAME_GETVALUE_OFFSET UNITYSDK_OFFSET(0x151430)
#define RPG_VECTOR3CURVEFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x3B9A7A0)
