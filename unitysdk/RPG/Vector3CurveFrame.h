...
#define RPG_VECTOR3CURVEFRAME_COMPARETO_OFFSET UNITYSDK_OFFSET(0x3C98200)
#define RPG_VECTOR3CURVEFRAME_GETTIME_OFFSET UNITYSDK_OFFSET(0x213E0)
#define RPG_VECTOR3CURVEFRAME_GETVALUE_OFFSET UNITYSDK_OFFSET(0x3A30270)
#define RPG_VECTOR3CURVEFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x3C981E0)

namespace RPG
{
	inline static constexpr unsigned int Vector3CurveFrame_TypeDefinitionIndex = 6330;
