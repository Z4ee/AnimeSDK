...
#define RPG_MVECTOR3_ANGLEBETWEEN_OFFSET UNITYSDK_OFFSET(0x17A677B0)
#define RPG_MVECTOR3_ANGLE_OFFSET UNITYSDK_OFFSET(0x17A66D40)
#define RPG_MVECTOR3_APPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x17A67180)
#define RPG_MVECTOR3_CLAMPMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x17A671D0)
#define RPG_MVECTOR3_CROSS_OFFSET UNITYSDK_OFFSET(0x17A66960)
#define RPG_MVECTOR3_DISTANCE_OFFSET UNITYSDK_OFFSET(0x17A670F0)
#define RPG_MVECTOR3_DOT_OFFSET UNITYSDK_OFFSET(0x17A58AF0)
#define RPG_MVECTOR3_EQUALS_OFFSET UNITYSDK_OFFSET(0x20F7DE0)
#define RPG_MVECTOR3_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x20F7D80)
#define RPG_MVECTOR3_GET_BACK_OFFSET UNITYSDK_OFFSET(0x17A673A0)
#define RPG_MVECTOR3_GET_DOWN_OFFSET UNITYSDK_OFFSET(0x17A673E0)
#define RPG_MVECTOR3_GET_FORWARD_OFFSET UNITYSDK_OFFSET(0x17A67380)
#define RPG_MVECTOR3_GET_FWD_OFFSET UNITYSDK_OFFSET(0x17A67790)
#define RPG_MVECTOR3_GET_ISINFINITY_OFFSET UNITYSDK_OFFSET(0x20F7BB0)
#define RPG_MVECTOR3_GET_ISNAN_OFFSET UNITYSDK_OFFSET(0x20F7B70)
#define RPG_MVECTOR3_GET_ISNEGATIVEINFINITY_OFFSET UNITYSDK_OFFSET(0x20F7C10)
#define RPG_MVECTOR3_GET_ISPOSITIVEINFINITY_OFFSET UNITYSDK_OFFSET(0x20F7BF0)
#define RPG_MVECTOR3_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x20F7C30)
#define RPG_MVECTOR3_GET_LEFT_OFFSET UNITYSDK_OFFSET(0x17A67400)
#define RPG_MVECTOR3_GET_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x20F7FD0)
#define RPG_MVECTOR3_GET_NEGATIVEINFINITY_OFFSET UNITYSDK_OFFSET(0x17A67460)
#define RPG_MVECTOR3_GET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x20F7F30)
#define RPG_MVECTOR3_GET_ONE_OFFSET UNITYSDK_OFFSET(0x17A67360)
#define RPG_MVECTOR3_GET_POSITIVEINFINITY_OFFSET UNITYSDK_OFFSET(0x17A67440)
#define RPG_MVECTOR3_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x17A67420)
#define RPG_MVECTOR3_GET_SQRMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x20F8000)
#define RPG_MVECTOR3_GET_UP_OFFSET UNITYSDK_OFFSET(0x17A673C0)
#define RPG_MVECTOR3_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x17A67340)
#define RPG_MVECTOR3_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x17A667B0)
#define RPG_MVECTOR3_LERP_OFFSET UNITYSDK_OFFSET(0x17A66760)
#define RPG_MVECTOR3_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x17A66B40)
#define RPG_MVECTOR3_MAX_OFFSET UNITYSDK_OFFSET(0x17A67310)
#define RPG_MVECTOR3_MIN_OFFSET UNITYSDK_OFFSET(0x17A672E0)
#define RPG_MVECTOR3_MOVETOWARDS_OFFSET UNITYSDK_OFFSET(0x17A667F0)
#define RPG_MVECTOR3_NORMALIZE_1_OFFSET UNITYSDK_OFFSET(0x20F7EA0)
#define RPG_MVECTOR3_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x17A59290)
#define RPG_MVECTOR3_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x17A67480)
#define RPG_MVECTOR3_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x17A67550)
#define RPG_MVECTOR3_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x17A67570)
#define RPG_MVECTOR3_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x17A675C0)
#define RPG_MVECTOR3_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x17A67530)
#define RPG_MVECTOR3_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x17A67510)
#define RPG_MVECTOR3_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x17A674B0)
#define RPG_MVECTOR3_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x17A674E0)
#define RPG_MVECTOR3_PROJECTONPLANE_OFFSET UNITYSDK_OFFSET(0x17A66C90)
#define RPG_MVECTOR3_PROJECT_OFFSET UNITYSDK_OFFSET(0x17A66C00)
#define RPG_MVECTOR3_REFLECT_OFFSET UNITYSDK_OFFSET(0x17A66AD0)
#define RPG_MVECTOR3_SCALE_1_OFFSET UNITYSDK_OFFSET(0x20F7D60)
#define RPG_MVECTOR3_SCALE_OFFSET UNITYSDK_OFFSET(0x17A66900)
#define RPG_MVECTOR3_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x20F7CB0)
#define RPG_MVECTOR3_SET_OFFSET UNITYSDK_OFFSET(0x14EDD10)
#define RPG_MVECTOR3_SIGNEDANGLE_OFFSET UNITYSDK_OFFSET(0x17A66EC0)
#define RPG_MVECTOR3_SQRDISTANCE_OFFSET UNITYSDK_OFFSET(0x17A67140)
#define RPG_MVECTOR3_SQRMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x17A672C0)
#define RPG_MVECTOR3_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x20F80D0)
#define RPG_MVECTOR3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x20F8020)
#define RPG_MVECTOR3__CCTOR_OFFSET UNITYSDK_OFFSET(0x17A67920)
#define RPG_MVECTOR3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x20F7D40)
#define RPG_MVECTOR3__CTOR_OFFSET UNITYSDK_OFFSET(0x14EDD10)

namespace RPG
{
	inline static constexpr unsigned int MVector3_TypeDefinitionIndex = 8707;

	struct alignas(4) MVector3
	{
		static ::RPG::MVector3* StaticGet_zeroVector()
		{
			return (::RPG::MVector3*)Il2CppClass::FromTypeDefinitionIndex(MVector3_TypeDefinitionIndex)->GetStaticField(0x440);
		}
		static ::RPG::MVector3* StaticGet_forwardVector()
		{
			return (::RPG::MVector3*)Il2CppClass::FromTypeDefinitionIndex(MVector3_TypeDefinitionIndex)->GetStaticField(0x44C);
		}
		static ::RPG::MVector3* StaticGet_upVector()
		{
			return (::RPG::MVector3*)Il2CppClass::FromTypeDefinitionIndex(MVector3_TypeDefinitionIndex)->GetStaticField(0x458);
		}
		static ::RPG::MVector3* StaticGet_downVector()
		{
			return (::RPG::MVector3*)Il2CppClass::FromTypeDefinitionIndex(MVector3_TypeDefinitionIndex)->GetStaticField(0x464);
		}
		static ::RPG::MVector3* StaticGet_negativeInfinityVector()
		{
			return (::RPG::MVector3*)Il2CppClass::FromTypeDefinitionIndex(MVector3_TypeDefinitionIndex)->GetStaticField(0x470);
		}
		static ::RPG::MVector3* StaticGet_backVector()
		{
			return (::RPG::MVector3*)Il2CppClass::FromTypeDefinitionIndex(MVector3_TypeDefinitionIndex)->GetStaticField(0x47C);
		}
		static ::RPG::MVector3* StaticGet_rightVector()
		{
			return (::RPG::MVector3*)Il2CppClass::FromTypeDefinitionIndex(MVector3_TypeDefinitionIndex)->GetStaticField(0x488);
		}
		static ::RPG::MVector3* StaticGet_leftVector()
		{
			return (::RPG::MVector3*)Il2CppClass::FromTypeDefinitionIndex(MVector3_TypeDefinitionIndex)->GetStaticField(0x494);
		}
		static ::RPG::MVector3* StaticGet_positiveInfinityVector()
		{
			return (::RPG::MVector3*)Il2CppClass::FromTypeDefinitionIndex(MVector3_TypeDefinitionIndex)->GetStaticField(0x4A0);
		}
		static ::RPG::MVector3* StaticGet_oneVector()
		{
			return (::RPG::MVector3*)Il2CppClass::FromTypeDefinitionIndex(MVector3_TypeDefinitionIndex)->GetStaticField(0x4AC);
		}
