...
#define RPG_MVECTOR3_ANGLEBETWEEN_OFFSET UNITYSDK_OFFSET(0x1D260930)
#define RPG_MVECTOR3_ANGLE_OFFSET UNITYSDK_OFFSET(0x1D25FFF0)
#define RPG_MVECTOR3_APPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x1D2603E0)
#define RPG_MVECTOR3_CLAMPMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x1D260430)
#define RPG_MVECTOR3_CROSS_OFFSET UNITYSDK_OFFSET(0x1D25FAA0)
#define RPG_MVECTOR3_DISTANCE_OFFSET UNITYSDK_OFFSET(0x1D260350)
#define RPG_MVECTOR3_DOT_OFFSET UNITYSDK_OFFSET(0x1D25FC80)
#define RPG_MVECTOR3_EQUALS_OFFSET UNITYSDK_OFFSET(0x3AFE810)
#define RPG_MVECTOR3_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3AF83A0)
#define RPG_MVECTOR3_GET_BACK_OFFSET UNITYSDK_OFFSET(0x1D260600)
#define RPG_MVECTOR3_GET_DOWN_OFFSET UNITYSDK_OFFSET(0x1D260640)
#define RPG_MVECTOR3_GET_FORWARD_OFFSET UNITYSDK_OFFSET(0x1D2605E0)
#define RPG_MVECTOR3_GET_FWD_OFFSET UNITYSDK_OFFSET(0x1D260910)
#define RPG_MVECTOR3_GET_ISINFINITY_OFFSET UNITYSDK_OFFSET(0x3AFE680)
#define RPG_MVECTOR3_GET_ISNAN_OFFSET UNITYSDK_OFFSET(0x3AFE640)
#define RPG_MVECTOR3_GET_ISNEGATIVEINFINITY_OFFSET UNITYSDK_OFFSET(0x3AFE6E0)
#define RPG_MVECTOR3_GET_ISPOSITIVEINFINITY_OFFSET UNITYSDK_OFFSET(0x3AFE6C0)
#define RPG_MVECTOR3_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x3AFE700)
#define RPG_MVECTOR3_GET_LEFT_OFFSET UNITYSDK_OFFSET(0x1D260660)
#define RPG_MVECTOR3_GET_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x3AF85A0)
#define RPG_MVECTOR3_GET_NEGATIVEINFINITY_OFFSET UNITYSDK_OFFSET(0x1D2606C0)
#define RPG_MVECTOR3_GET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x3AFE960)
#define RPG_MVECTOR3_GET_ONE_OFFSET UNITYSDK_OFFSET(0x1D2605C0)
#define RPG_MVECTOR3_GET_POSITIVEINFINITY_OFFSET UNITYSDK_OFFSET(0x1D2606A0)
#define RPG_MVECTOR3_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x1D260680)
#define RPG_MVECTOR3_GET_SQRMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x3AF85D0)
#define RPG_MVECTOR3_GET_UP_OFFSET UNITYSDK_OFFSET(0x1D260620)
#define RPG_MVECTOR3_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x1D2605A0)
#define RPG_MVECTOR3_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x1D25F710)
#define RPG_MVECTOR3_LERP_OFFSET UNITYSDK_OFFSET(0x1D25F6C0)
#define RPG_MVECTOR3_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x1D25FD60)
#define RPG_MVECTOR3_MAX_OFFSET UNITYSDK_OFFSET(0x1D260570)
#define RPG_MVECTOR3_MIN_OFFSET UNITYSDK_OFFSET(0x1D260540)
#define RPG_MVECTOR3_MOVETOWARDS_OFFSET UNITYSDK_OFFSET(0x1D25F750)
#define RPG_MVECTOR3_NORMALIZE_1_OFFSET UNITYSDK_OFFSET(0x3AFE8D0)
#define RPG_MVECTOR3_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x1D25FCD0)
#define RPG_MVECTOR3_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1D25F8D0)
#define RPG_MVECTOR3_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x1D25F890)
#define RPG_MVECTOR3_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1D260710)
#define RPG_MVECTOR3_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1D260760)
#define RPG_MVECTOR3_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1D25FCB0)
#define RPG_MVECTOR3_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1D25F8B0)
#define RPG_MVECTOR3_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1D25F830)
#define RPG_MVECTOR3_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1D2606E0)
#define RPG_MVECTOR3_PROJECTONPLANE_OFFSET UNITYSDK_OFFSET(0x1D25FF40)
#define RPG_MVECTOR3_PROJECT_OFFSET UNITYSDK_OFFSET(0x1D25FEB0)
#define RPG_MVECTOR3_REFLECT_OFFSET UNITYSDK_OFFSET(0x1D25FC10)
#define RPG_MVECTOR3_SCALE_1_OFFSET UNITYSDK_OFFSET(0x3AF8380)
#define RPG_MVECTOR3_SCALE_OFFSET UNITYSDK_OFFSET(0x1D25FA40)
#define RPG_MVECTOR3_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x3AFE780)
#define RPG_MVECTOR3_SET_OFFSET UNITYSDK_OFFSET(0x39C72C0)
#define RPG_MVECTOR3_SIGNEDANGLE_OFFSET UNITYSDK_OFFSET(0x1D260150)
#define RPG_MVECTOR3_SQRDISTANCE_OFFSET UNITYSDK_OFFSET(0x1D2603A0)
#define RPG_MVECTOR3_SQRMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x1D260520)
#define RPG_MVECTOR3_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x3AFEAA0)
#define RPG_MVECTOR3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3AFE9F0)
#define RPG_MVECTOR3__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D260A80)
#define RPG_MVECTOR3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3AF8360)
#define RPG_MVECTOR3__CTOR_OFFSET UNITYSDK_OFFSET(0x39C72C0)

namespace RPG
{
	inline static constexpr unsigned int MVector3_TypeDefinitionIndex = 6771;
