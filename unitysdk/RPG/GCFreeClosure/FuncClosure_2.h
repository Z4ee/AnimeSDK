...
{
	inline static constexpr unsigned int FuncClosure_2_TypeDefinitionIndex = 6840;

	template <typename TInput0, typename TInput1>
	struct FuncClosure_2
	{
		::Struct_2_6C64084003D66585 _context; // 0x0
		::RPG::GCFreeClosure::FuncByRef_4<::Struct_2_6C64084003D66585, TInput0, TInput1, ::Struct_2_3906C24C646CC83F>* _wrapper; // 0x0
	};
}
