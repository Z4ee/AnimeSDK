...
{
	inline static constexpr unsigned int FuncClosure_3_FuncClosureWrapper_VoidResult_TypeDefinitionIndex = 6851;

	template <typename TInput0, typename TInput1, typename TInput2>
	class FuncClosure_3_FuncClosureWrapper_VoidResult : public ::System::Object
	{
	public:
		...
		{
			return (::RPG::GCFreeClosure::FuncByRef_5<::Struct_2_6C64084003D66585, TInput0, TInput1, TInput2, ::Struct_2_3906C24C646CC83F>**)Il2CppClass::FromTypeDefinitionIndex(FuncClosure_3_FuncClosureWrapper_VoidResult_TypeDefinitionIndex)->GetStaticField(0x0);
		}
	};
}
