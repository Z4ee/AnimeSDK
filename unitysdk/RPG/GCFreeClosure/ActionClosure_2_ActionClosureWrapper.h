...
{
	inline static constexpr unsigned int ActionClosure_2_ActionClosureWrapper_TypeDefinitionIndex = 6802;
	...
	public:
		...
		{
			return (::RPG::GCFreeClosure::ActionByRef_3<::Struct_2_6C64084003D66585, TInput0, TInput1>**)Il2CppClass::FromTypeDefinitionIndex(ActionClosure_2_ActionClosureWrapper_TypeDefinitionIndex)->GetStaticField(0x0);
		}
	};
}
