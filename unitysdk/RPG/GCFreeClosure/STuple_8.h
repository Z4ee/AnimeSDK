...
{
	inline static constexpr unsigned int STuple_8_TypeDefinitionIndex = 6913;
	...
	struct STuple_8
	{
		...
		T5 _Item5_k__BackingField; // 0x0
		T6 _Item6_k__BackingField; // 0x0
		T7 _Item7_k__BackingField; // 0x0
		TRest _Rest_k__BackingField; // 0x0
	};
}
