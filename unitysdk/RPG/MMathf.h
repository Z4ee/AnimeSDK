...
#define RPG_MMATHF_ABS_1_OFFSET UNITYSDK_OFFSET(0x17A62550)
#define RPG_MMATHF_ABS_OFFSET UNITYSDK_OFFSET(0x17A31EF0)
#define RPG_MMATHF_ACOS_OFFSET UNITYSDK_OFFSET(0x17A57CF0)
#define RPG_MMATHF_APPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x17A63200)
#define RPG_MMATHF_ASIN_OFFSET UNITYSDK_OFFSET(0x17A624F0)
#define RPG_MMATHF_ATAN2_OFFSET UNITYSDK_OFFSET(0x17A62530)
#define RPG_MMATHF_ATAN_OFFSET UNITYSDK_OFFSET(0x17A62510)
#define RPG_MMATHF_CEILTOINT_OFFSET UNITYSDK_OFFSET(0x17A62CF0)
#define RPG_MMATHF_CEIL_OFFSET UNITYSDK_OFFSET(0x17A62C20)
#define RPG_MMATHF_CLAMP01_OFFSET UNITYSDK_OFFSET(0x17A62490)
#define RPG_MMATHF_CLAMP_1_OFFSET UNITYSDK_OFFSET(0x17A62E20)
#define RPG_MMATHF_CLAMP_OFFSET UNITYSDK_OFFSET(0x17A62E00)
#define RPG_MMATHF_COS_OFFSET UNITYSDK_OFFSET(0x17A48F70)
#define RPG_MMATHF_DELTAANGLE_OFFSET UNITYSDK_OFFSET(0x17A630C0)
#define RPG_MMATHF_EXP_OFFSET UNITYSDK_OFFSET(0x17A62B10)
#define RPG_MMATHF_FLOORTOINT_OFFSET UNITYSDK_OFFSET(0x17A62D10)
#define RPG_MMATHF_FLOOR_OFFSET UNITYSDK_OFFSET(0x17A62C30)
#define RPG_MMATHF_GAMMA_OFFSET UNITYSDK_OFFSET(0x17A63180)
#define RPG_MMATHF_INVERSELERP_OFFSET UNITYSDK_OFFSET(0x17A632B0)
#define RPG_MMATHF_LERPANGLE_OFFSET UNITYSDK_OFFSET(0x17A62E70)
#define RPG_MMATHF_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x17A62E60)
#define RPG_MMATHF_LERP_OFFSET UNITYSDK_OFFSET(0x17A62E30)
#define RPG_MMATHF_LINEINTERSECTION_OFFSET UNITYSDK_OFFSET(0x17A632F0)
#define RPG_MMATHF_LINESEGMENTINTERSECTION_OFFSET UNITYSDK_OFFSET(0x17A633E0)
#define RPG_MMATHF_LOG10_OFFSET UNITYSDK_OFFSET(0x17A62C00)
#define RPG_MMATHF_LOG_1_OFFSET UNITYSDK_OFFSET(0x17A62BE0)
#define RPG_MMATHF_LOG_OFFSET UNITYSDK_OFFSET(0x17A62B30)
#define RPG_MMATHF_MAX_1_OFFSET UNITYSDK_OFFSET(0x17A62840)
#define RPG_MMATHF_MAX_2_OFFSET UNITYSDK_OFFSET(0x17A62910)
#define RPG_MMATHF_MAX_3_OFFSET UNITYSDK_OFFSET(0x17A62920)
#define RPG_MMATHF_MAX_OFFSET UNITYSDK_OFFSET(0x17A62830)
#define RPG_MMATHF_MIN_1_OFFSET UNITYSDK_OFFSET(0x17A62570)
#define RPG_MMATHF_MIN_2_OFFSET UNITYSDK_OFFSET(0x17A62640)
#define RPG_MMATHF_MIN_3_OFFSET UNITYSDK_OFFSET(0x17A62650)
#define RPG_MMATHF_MIN_4_OFFSET UNITYSDK_OFFSET(0x17A62660)
#define RPG_MMATHF_MIN_OFFSET UNITYSDK_OFFSET(0x17A62560)
#define RPG_MMATHF_MOVETOWARDSANGLE_OFFSET UNITYSDK_OFFSET(0x17A62FC0)
#define RPG_MMATHF_MOVETOWARDS_OFFSET UNITYSDK_OFFSET(0x17A62F70)
#define RPG_MMATHF_PINGPONG_OFFSET UNITYSDK_OFFSET(0x17A63240)
#define RPG_MMATHF_POW_OFFSET UNITYSDK_OFFSET(0x17A62AF0)
#define RPG_MMATHF_RANDOMTOLONG_OFFSET UNITYSDK_OFFSET(0x17A634F0)
#define RPG_MMATHF_REPEAT_OFFSET UNITYSDK_OFFSET(0x17A62F20)
#define RPG_MMATHF_ROUNDTOINT_OFFSET UNITYSDK_OFFSET(0x17A62D30)
#define RPG_MMATHF_ROUND_OFFSET UNITYSDK_OFFSET(0x17A62C40)
#define RPG_MMATHF_SIGN_OFFSET UNITYSDK_OFFSET(0x17A62DE0)
#define RPG_MMATHF_SIN_OFFSET UNITYSDK_OFFSET(0x17A48F50)
#define RPG_MMATHF_SMOOTHSTEP_OFFSET UNITYSDK_OFFSET(0x17A63130)
#define RPG_MMATHF_SQRT_OFFSET UNITYSDK_OFFSET(0x17A31D10)
#define RPG_MMATHF_TAN_OFFSET UNITYSDK_OFFSET(0x17A624D0)
#define RPG_MMATHF__CCTOR_OFFSET UNITYSDK_OFFSET(0x17A63580)

namespace RPG
{
	inline static constexpr unsigned int MMathf_TypeDefinitionIndex = 8700;

	struct alignas(1) MMathf
	{
		static ::System::Single* StaticGet_Epsilon()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(MMathf_TypeDefinitionIndex)->GetStaticField(0x7680);
		}
