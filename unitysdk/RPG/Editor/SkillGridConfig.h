...
#define RPG_EDITOR_SKILLGRIDCONFIG_GET_COLS_OFFSET UNITYSDK_OFFSET(0xCC6FAD0)
#define RPG_EDITOR_SKILLGRIDCONFIG_GET_DIRSPACINGPX_OFFSET UNITYSDK_OFFSET(0xCC6FA30)
#define RPG_EDITOR_SKILLGRIDCONFIG_GET_ROWS_OFFSET UNITYSDK_OFFSET(0xCC6FBE0)
#define RPG_EDITOR_SKILLGRIDCONFIG_GET_UNITPX_OFFSET UNITYSDK_OFFSET(0xCC6F990)
#define RPG_EDITOR_SKILLGRIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xCC6FCF0)

namespace RPG::Editor
{
	inline static constexpr unsigned int SkillGridConfig_TypeDefinitionIndex = 48657;
