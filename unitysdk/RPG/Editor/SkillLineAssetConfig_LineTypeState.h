...
#define RPG_EDITOR_SKILLLINEASSETCONFIG_LINETYPESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xB508EC0)

namespace RPG::Editor
{
	inline static constexpr unsigned int SkillLineAssetConfig_LineTypeState_TypeDefinitionIndex = 48036;
