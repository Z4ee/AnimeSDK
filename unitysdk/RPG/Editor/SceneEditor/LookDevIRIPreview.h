...
#define RPG_EDITOR_SCENEEDITOR_LOOKDEVIRIPREVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xA7C3750)

namespace RPG::Editor::SceneEditor
{
	inline static constexpr unsigned int LookDevIRIPreview_TypeDefinitionIndex = 42108;
