...
#define RPG_EDITOR_SCENEEDITOR_LOOKDEVIRIDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB506860)

namespace RPG::Editor::SceneEditor
{
	inline static constexpr unsigned int LookDevIRIData_TypeDefinitionIndex = 48079;
