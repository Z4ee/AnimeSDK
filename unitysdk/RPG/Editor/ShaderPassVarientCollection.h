...
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xE463870)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_305D7772FC4F3138_OFFSET UNITYSDK_OFFSET(0xE465210)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_4C43A8AF5B60FD19_OFFSET UNITYSDK_OFFSET(0xE463D50)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_737220D2233A9067_OFFSET UNITYSDK_OFFSET(0xE4644D0)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_8A01D6F684F8A8D9_OFFSET UNITYSDK_OFFSET(0xE464730)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_A2DA8C12B45FA979_OFFSET UNITYSDK_OFFSET(0xE463970)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_ACDA63219002AD85_OFFSET UNITYSDK_OFFSET(0xE464A80)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_B2C0ADBFEA309440_OFFSET UNITYSDK_OFFSET(0xE464300)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_EA5FB0DE0563D2A7_OFFSET UNITYSDK_OFFSET(0xE463F30)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_F90E0BD1B4F23E4F_OFFSET UNITYSDK_OFFSET(0xE464C00)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0xE4655A0)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xE4637D0)
...
namespace RPG::Editor
{
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ShaderPassVarientCollection_TypeDefinitionIndex)->GetStaticField(0x653F0);
		}
		static ::RPG::Editor::ShaderPassVarientCollection** StaticGet__Asset()
		{
			return (::RPG::Editor::ShaderPassVarientCollection**)Il2CppClass::FromTypeDefinitionIndex(ShaderPassVarientCollection_TypeDefinitionIndex)->GetStaticField(0x653F8);
		}
		static ::Il2CppArray<::System::String*>** StaticGet__NoRuntimePassName()
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ShaderPassVarientCollection_TypeDefinitionIndex)->GetStaticField(0x65400);
		}
