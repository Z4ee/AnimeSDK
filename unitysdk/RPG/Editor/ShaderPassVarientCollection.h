...
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x106BFCB0)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_305D7772FC4F3138_OFFSET UNITYSDK_OFFSET(0x106C1650)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_4C43A8AF5B60FD19_OFFSET UNITYSDK_OFFSET(0x106C0190)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_737220D2233A9067_OFFSET UNITYSDK_OFFSET(0x106C0910)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_8A01D6F684F8A8D9_OFFSET UNITYSDK_OFFSET(0x106C0B70)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_A2DA8C12B45FA979_OFFSET UNITYSDK_OFFSET(0x106BFDB0)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_ACDA63219002AD85_OFFSET UNITYSDK_OFFSET(0x106C0EC0)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_B2C0ADBFEA309440_OFFSET UNITYSDK_OFFSET(0x106C0740)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_EA5FB0DE0563D2A7_OFFSET UNITYSDK_OFFSET(0x106C0370)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION_METHOD_3_F90E0BD1B4F23E4F_OFFSET UNITYSDK_OFFSET(0x106C1040)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x106C19E0)
#define RPG_EDITOR_SHADERPASSVARIENTCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x106BFC30)
...
namespace RPG::Editor
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ShaderPassVarientCollection_TypeDefinitionIndex)->GetStaticField(0x571B0);
		}
		static ::System::String** StaticGet__AssetPath()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ShaderPassVarientCollection_TypeDefinitionIndex)->GetStaticField(0x571B8);
		}
		static ::RPG::Editor::ShaderPassVarientCollection** StaticGet__Asset()
		{
			return (::RPG::Editor::ShaderPassVarientCollection**)Il2CppClass::FromTypeDefinitionIndex(ShaderPassVarientCollection_TypeDefinitionIndex)->GetStaticField(0x571C0);
		}
