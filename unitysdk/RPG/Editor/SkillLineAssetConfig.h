...
#define RPG_EDITOR_SKILLLINEASSETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16848CF0)

namespace RPG::Editor
{
	inline static constexpr unsigned int SkillLineAssetConfig_TypeDefinitionIndex = 52324;
