...
#define RPG_EDITOR_SKILLLINEASSETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA7C5410)

namespace RPG::Editor
{
	inline static constexpr unsigned int SkillLineAssetConfig_TypeDefinitionIndex = 42062;
