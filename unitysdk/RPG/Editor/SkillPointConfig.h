...
#define RPG_EDITOR_SKILLPOINTCONFIG_METHOD_1_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x106C29A0)
#define RPG_EDITOR_SKILLPOINTCONFIG_METHOD_1_3C56C1AF247AC1EC_OFFSET UNITYSDK_OFFSET(0x106C2900)
#define RPG_EDITOR_SKILLPOINTCONFIG_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x106C2AA0)
#define RPG_EDITOR_SKILLPOINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x106C2AF0)

namespace RPG::Editor
{
	inline static constexpr unsigned int SkillPointConfig_TypeDefinitionIndex = 49672;
