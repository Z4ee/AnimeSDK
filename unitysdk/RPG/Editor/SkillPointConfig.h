...
#define RPG_EDITOR_SKILLPOINTCONFIG_METHOD_1_1B167429A8B82AD3_OFFSET UNITYSDK_OFFSET(0xA7C5E80)
#define RPG_EDITOR_SKILLPOINTCONFIG_METHOD_1_3C56C1AF247AC1EC_OFFSET UNITYSDK_OFFSET(0xA7C5DE0)
#define RPG_EDITOR_SKILLPOINTCONFIG_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA7C5F20)
#define RPG_EDITOR_SKILLPOINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA7C5F70)

namespace RPG::Editor
{
	inline static constexpr unsigned int SkillPointConfig_TypeDefinitionIndex = 42068;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_EDITOR_SKILLPOINTCONFIG_METHOD_1_1B167429A8B82AD3_OFFSET))(this);
		}
