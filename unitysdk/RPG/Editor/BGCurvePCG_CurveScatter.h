...
#define RPG_EDITOR_BGCURVEPCG_CURVESCATTER_METHOD_2_019FAF8DF887E9D8_OFFSET UNITYSDK_OFFSET(0xB4FBD40)
#define RPG_EDITOR_BGCURVEPCG_CURVESCATTER_METHOD_2_2B66C008535F8B01_OFFSET UNITYSDK_OFFSET(0xB4FC580)
#define RPG_EDITOR_BGCURVEPCG_CURVESCATTER_METHOD_2_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0xB4FBE40)
#define RPG_EDITOR_BGCURVEPCG_CURVESCATTER_METHOD_2_8D886D6E58A21026_OFFSET UNITYSDK_OFFSET(0xB4FBFB0)
#define RPG_EDITOR_BGCURVEPCG_CURVESCATTER_METHOD_2_A5B6063FFC26FC8F_OFFSET UNITYSDK_OFFSET(0xB4FBD90)
#define RPG_EDITOR_BGCURVEPCG_CURVESCATTER_METHOD_2_AAD689B25B8AE167_OFFSET UNITYSDK_OFFSET(0xB4FBC00)
#define RPG_EDITOR_BGCURVEPCG_CURVESCATTER_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB4FC540)
#define RPG_EDITOR_BGCURVEPCG_CURVESCATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xB4FC5F0)

namespace RPG::Editor
{
	inline static constexpr unsigned int BGCurvePCG_CurveScatter_TypeDefinitionIndex = 48018;
