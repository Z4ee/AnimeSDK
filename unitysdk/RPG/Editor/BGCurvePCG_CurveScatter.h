...
#define RPG_EDITOR_BGCURVEPCG_CURVESCATTER_METHOD_2_0865E94460F11643_OFFSET UNITYSDK_OFFSET(0x1683BBB0)
#define RPG_EDITOR_BGCURVEPCG_CURVESCATTER_METHOD_2_102A1038C38883F3_OFFSET UNITYSDK_OFFSET(0x1683C6E0)
#define RPG_EDITOR_BGCURVEPCG_CURVESCATTER_METHOD_2_19B91D58E02869BC_OFFSET UNITYSDK_OFFSET(0x1683BB60)
#define RPG_EDITOR_BGCURVEPCG_CURVESCATTER_METHOD_2_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x1683BC90)
#define RPG_EDITOR_BGCURVEPCG_CURVESCATTER_METHOD_2_594E29428C750BB4_OFFSET UNITYSDK_OFFSET(0x1683C040)
#define RPG_EDITOR_BGCURVEPCG_CURVESCATTER_METHOD_2_AAD689B25B8AE167_OFFSET UNITYSDK_OFFSET(0x1683BA20)
#define RPG_EDITOR_BGCURVEPCG_CURVESCATTER_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1683C6A0)
#define RPG_EDITOR_BGCURVEPCG_CURVESCATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1683C750)

namespace RPG::Editor
{
	inline static constexpr unsigned int BGCurvePCG_CurveScatter_TypeDefinitionIndex = 52307;
