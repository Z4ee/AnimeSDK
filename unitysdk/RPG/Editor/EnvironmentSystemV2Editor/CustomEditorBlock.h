...
#define RPG_EDITOR_ENVIRONMENTSYSTEMV2EDITOR_CUSTOMEDITORBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x106BF8B0)

namespace RPG::Editor::EnvironmentSystemV2Editor
{
	inline static constexpr unsigned int CustomEditorBlock_TypeDefinitionIndex = 49708;
