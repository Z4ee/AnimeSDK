...
#define RPG_EDITOR_ENVIRONMENTSYSTEMV2EDITOR_ENVEDITORHEADER_GET_FOLDERON_OFFSET UNITYSDK_OFFSET(0x106BFA40)
#define RPG_EDITOR_ENVIRONMENTSYSTEMV2EDITOR_ENVEDITORHEADER_GET_PREFKEY_OFFSET UNITYSDK_OFFSET(0x106BFA60)
#define RPG_EDITOR_ENVIRONMENTSYSTEMV2EDITOR_ENVEDITORHEADER_SET_FOLDERON_OFFSET UNITYSDK_OFFSET(0x106BFA50)
#define RPG_EDITOR_ENVIRONMENTSYSTEMV2EDITOR_ENVEDITORHEADER__CTOR_OFFSET UNITYSDK_OFFSET(0x106BFAD0)

namespace RPG::Editor::EnvironmentSystemV2Editor
{
	inline static constexpr unsigned int EnvEditorHeader_TypeDefinitionIndex = 49703;
