...
#define RPG_EDITOR_ENVIRONMENTSYSTEMV2EDITOR_ENVEDITORHEADER_GET_FOLDERON_OFFSET UNITYSDK_OFFSET(0xA7C3590)
#define RPG_EDITOR_ENVIRONMENTSYSTEMV2EDITOR_ENVEDITORHEADER_GET_PREFKEY_OFFSET UNITYSDK_OFFSET(0xA7C35B0)
#define RPG_EDITOR_ENVIRONMENTSYSTEMV2EDITOR_ENVEDITORHEADER_SET_FOLDERON_OFFSET UNITYSDK_OFFSET(0xA7C35A0)
#define RPG_EDITOR_ENVIRONMENTSYSTEMV2EDITOR_ENVEDITORHEADER__CTOR_OFFSET UNITYSDK_OFFSET(0xA7C3620)

namespace RPG::Editor::EnvironmentSystemV2Editor
{
	inline static constexpr unsigned int EnvEditorHeader_TypeDefinitionIndex = 42099;
