...
#define RPG_EDITOR_ENVIRONMENTSYSTEMV2EDITOR_ENVEDITORFOLDOUT_GET_FOLDERON_OFFSET UNITYSDK_OFFSET(0xA7C34F0)
#define RPG_EDITOR_ENVIRONMENTSYSTEMV2EDITOR_ENVEDITORFOLDOUT_GET_PREFKEY_OFFSET UNITYSDK_OFFSET(0xA7C3510)
#define RPG_EDITOR_ENVIRONMENTSYSTEMV2EDITOR_ENVEDITORFOLDOUT_SET_FOLDERON_OFFSET UNITYSDK_OFFSET(0xA7C3500)
#define RPG_EDITOR_ENVIRONMENTSYSTEMV2EDITOR_ENVEDITORFOLDOUT__CTOR_OFFSET UNITYSDK_OFFSET(0xA7C3580)

namespace RPG::Editor::EnvironmentSystemV2Editor
{
	inline static constexpr unsigned int EnvEditorFoldout_TypeDefinitionIndex = 42098;
