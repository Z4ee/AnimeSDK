...
#define RPG_EDITOR_ENVIRONMENTSYSTEMV2EDITOR_ENVEDITORFOLDOUT_GET_FOLDERON_OFFSET UNITYSDK_OFFSET(0xE463540)
#define RPG_EDITOR_ENVIRONMENTSYSTEMV2EDITOR_ENVEDITORFOLDOUT_GET_PREFKEY_OFFSET UNITYSDK_OFFSET(0xE463560)
#define RPG_EDITOR_ENVIRONMENTSYSTEMV2EDITOR_ENVEDITORFOLDOUT_SET_FOLDERON_OFFSET UNITYSDK_OFFSET(0xE463550)
#define RPG_EDITOR_ENVIRONMENTSYSTEMV2EDITOR_ENVEDITORFOLDOUT__CTOR_OFFSET UNITYSDK_OFFSET(0xE4635D0)
