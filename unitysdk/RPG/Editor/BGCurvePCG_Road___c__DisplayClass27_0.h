...
#define RPG_EDITOR_BGCURVEPCG_ROAD___C__DISPLAYCLASS27_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA7C2B60)
#define RPG_EDITOR_BGCURVEPCG_ROAD___C__DISPLAYCLASS27_0__MERGELINEARMODULEGROUP_B__0_OFFSET UNITYSDK_OFFSET(0xA7C33D0)

namespace RPG::Editor
{
	inline static constexpr unsigned int BGCurvePCG_Road___c__DisplayClass27_0_TypeDefinitionIndex = 42042;
