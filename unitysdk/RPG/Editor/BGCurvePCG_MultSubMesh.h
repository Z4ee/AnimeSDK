...
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_METHOD_2_0E5F9F723F3FD31F_OFFSET UNITYSDK_OFFSET(0xA7C0ED0)
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_METHOD_2_2B9D478141E0F891_OFFSET UNITYSDK_OFFSET(0xA7C0DC0)
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_METHOD_2_630EDA686801A28F_OFFSET UNITYSDK_OFFSET(0xA7BFCC0)
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_METHOD_2_6F03F79E54DE121E_OFFSET UNITYSDK_OFFSET(0xA7BFED0)
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_METHOD_2_B917C58B4E14AC1B_OFFSET UNITYSDK_OFFSET(0xA7C0340)
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_METHOD_2_BF9BB9E2BBF3B6F4_OFFSET UNITYSDK_OFFSET(0xA7BFE60)
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_METHOD_2_C20A8E714F76AB3E_OFFSET UNITYSDK_OFFSET(0xA7C0E80)
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA7C0E40)
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_METHOD_2_F0F8DE036FE283F6_OFFSET UNITYSDK_OFFSET(0xA7C02D0)
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH__CTOR_OFFSET UNITYSDK_OFFSET(0xA7C0FE0)

namespace RPG::Editor
{
	inline static constexpr unsigned int BGCurvePCG_MultSubMesh_TypeDefinitionIndex = 42056;
