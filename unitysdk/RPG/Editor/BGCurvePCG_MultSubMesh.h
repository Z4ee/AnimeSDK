...
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_METHOD_2_2B9D478141E0F891_OFFSET UNITYSDK_OFFSET(0x106BD200)
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_METHOD_2_630EDA686801A28F_OFFSET UNITYSDK_OFFSET(0x106BC080)
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_METHOD_2_9216B801ACD0B564_OFFSET UNITYSDK_OFFSET(0x106BD2C0)
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_METHOD_2_929ED164DF433778_OFFSET UNITYSDK_OFFSET(0x106BD310)
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_METHOD_2_93E6B8A6D29521ED_OFFSET UNITYSDK_OFFSET(0x106BC220)
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_METHOD_2_B917C58B4E14AC1B_OFFSET UNITYSDK_OFFSET(0x106BC770)
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x106BD280)
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_METHOD_2_E6D3C4C666E119D9_OFFSET UNITYSDK_OFFSET(0x106BC290)
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_METHOD_2_F0F8DE036FE283F6_OFFSET UNITYSDK_OFFSET(0x106BC700)
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x106BD420)

namespace RPG::Editor
{
	inline static constexpr unsigned int BGCurvePCG_MultSubMesh_TypeDefinitionIndex = 49660;
