...
#define RPG_EDITOR_BGCURVEPCG_ROAD_BAKE_OFFSET UNITYSDK_OFFSET(0x106BE190)
#define RPG_EDITOR_BGCURVEPCG_ROAD_CLEAROBJECT_OFFSET UNITYSDK_OFFSET(0x106BE150)
#define RPG_EDITOR_BGCURVEPCG_ROAD_GENERATE_OFFSET UNITYSDK_OFFSET(0x106BDE70)
#define RPG_EDITOR_BGCURVEPCG_ROAD_INIT_OFFSET UNITYSDK_OFFSET(0x106BD540)
#define RPG_EDITOR_BGCURVEPCG_ROAD_METHOD_5_0241A04558156449_OFFSET UNITYSDK_OFFSET(0x106BF270)
#define RPG_EDITOR_BGCURVEPCG_ROAD_METHOD_5_3FC863B885E15ED5_OFFSET UNITYSDK_OFFSET(0x106BD660)
#define RPG_EDITOR_BGCURVEPCG_ROAD_METHOD_5_7073B423B15F467A_OFFSET UNITYSDK_OFFSET(0x106BDB80)
#define RPG_EDITOR_BGCURVEPCG_ROAD_METHOD_5_A90FA0B17EBA78B1_OFFSET UNITYSDK_OFFSET(0x106BE950)
#define RPG_EDITOR_BGCURVEPCG_ROAD_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x106BF520)
#define RPG_EDITOR_BGCURVEPCG_ROAD_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x106BDE30)
#define RPG_EDITOR_BGCURVEPCG_ROAD_METHOD_5_D10C11ED0EFFCFF4_OFFSET UNITYSDK_OFFSET(0x106BF050)
#define RPG_EDITOR_BGCURVEPCG_ROAD_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x106BE610)
#define RPG_EDITOR_BGCURVEPCG_ROAD_ONTRACKGENERATORCHANGED_OFFSET UNITYSDK_OFFSET(0x106BE8E0)
#define RPG_EDITOR_BGCURVEPCG_ROAD__CTOR_OFFSET UNITYSDK_OFFSET(0x106BF560)

namespace RPG::Editor
{
	inline static constexpr unsigned int BGCurvePCG_Road_TypeDefinitionIndex = 49645;
