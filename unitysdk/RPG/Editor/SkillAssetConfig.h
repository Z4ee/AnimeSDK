...
#define RPG_EDITOR_SKILLASSETCONFIG_METHOD_1_33ACA6CB2ABC73F7_1_OFFSET UNITYSDK_OFFSET(0x106C1C90)
#define RPG_EDITOR_SKILLASSETCONFIG_METHOD_1_33ACA6CB2ABC73F7_2_OFFSET UNITYSDK_OFFSET(0x106C23C0)
#define RPG_EDITOR_SKILLASSETCONFIG_METHOD_1_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x106C1B80)
#define RPG_EDITOR_SKILLASSETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x106C24C0)

namespace RPG::Editor
{
	inline static constexpr unsigned int SkillAssetConfig_TypeDefinitionIndex = 49664;
