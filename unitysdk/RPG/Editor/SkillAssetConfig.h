...
#define RPG_EDITOR_SKILLASSETCONFIG_METHOD_1_1B167429A8B82AD3_1_OFFSET UNITYSDK_OFFSET(0xA7C5900)
#define RPG_EDITOR_SKILLASSETCONFIG_METHOD_1_1B167429A8B82AD3_OFFSET UNITYSDK_OFFSET(0xA7C52C0)
#define RPG_EDITOR_SKILLASSETCONFIG_METHOD_1_5FBAD89A54D9F070_OFFSET UNITYSDK_OFFSET(0xA7C5370)
#define RPG_EDITOR_SKILLASSETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA7C59A0)

namespace RPG::Editor
{
	inline static constexpr unsigned int SkillAssetConfig_TypeDefinitionIndex = 42060;
