...
#define RPG_EDITOR_SKILLGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA7C5DB0)

namespace RPG::Editor
{
	inline static constexpr unsigned int SkillGroupConfig_TypeDefinitionIndex = 42067;
