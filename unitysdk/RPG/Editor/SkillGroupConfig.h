...
#define RPG_EDITOR_SKILLGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16849830)

namespace RPG::Editor
{
	inline static constexpr unsigned int SkillGroupConfig_TypeDefinitionIndex = 52329;
