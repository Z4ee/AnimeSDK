...
#define RPG_EDITOR_SKILLGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x106C28D0)

namespace RPG::Editor
{
	inline static constexpr unsigned int SkillGroupConfig_TypeDefinitionIndex = 49671;
