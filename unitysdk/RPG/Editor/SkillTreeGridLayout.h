...
#define RPG_EDITOR_SKILLTREEGRIDLAYOUT_ADDSKILLPOINT_OFFSET UNITYSDK_OFFSET(0xA7C6090)
#define RPG_EDITOR_SKILLTREEGRIDLAYOUT_RESET_OFFSET UNITYSDK_OFFSET(0xA7C6120)
#define RPG_EDITOR_SKILLTREEGRIDLAYOUT__CTOR_OFFSET UNITYSDK_OFFSET(0xA7C6270)

namespace RPG::Editor
{
	inline static constexpr unsigned int SkillTreeGridLayout_TypeDefinitionIndex = 42071;
