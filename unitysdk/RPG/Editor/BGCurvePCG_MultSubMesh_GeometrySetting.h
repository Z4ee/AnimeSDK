...
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_GEOMETRYSETTING__CCTOR_OFFSET UNITYSDK_OFFSET(0xA7C1080)

namespace RPG::Editor
{
	inline static constexpr unsigned int BGCurvePCG_MultSubMesh_GeometrySetting_TypeDefinitionIndex = 42058;
	...
	struct alignas(8) BGCurvePCG_MultSubMesh_GeometrySetting
	{
		...
		{
			return (::RPG::Editor::BGCurvePCG_MultSubMesh_GeometrySetting*)Il2CppClass::FromTypeDefinitionIndex(BGCurvePCG_MultSubMesh_GeometrySetting_TypeDefinitionIndex)->GetStaticField(0x40C60);
		}
