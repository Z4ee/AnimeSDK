...
#define RPG_EDITOR_SKILLPOINTASSETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16848BE0)

namespace RPG::Editor
{
	inline static constexpr unsigned int SkillPointAssetConfig_TypeDefinitionIndex = 52323;
