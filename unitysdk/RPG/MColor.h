...
#define RPG_MCOLOR_EQUALS_OFFSET UNITYSDK_OFFSET(0x22C9450)
#define RPG_MCOLOR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x22C95A0)
#define RPG_MCOLOR_METHOD_2_2C17A14F9DD6C0E3_1_OFFSET UNITYSDK_OFFSET(0x19227550)
#define RPG_MCOLOR_METHOD_2_2C17A14F9DD6C0E3_2_OFFSET UNITYSDK_OFFSET(0x19227570)
#define RPG_MCOLOR_METHOD_2_2C17A14F9DD6C0E3_OFFSET UNITYSDK_OFFSET(0x19227530)
#define RPG_MCOLOR_METHOD_2_4B0A91863BB1C92C_1_OFFSET UNITYSDK_OFFSET(0x192275B0)
#define RPG_MCOLOR_METHOD_2_4B0A91863BB1C92C_2_OFFSET UNITYSDK_OFFSET(0x192275D0)
#define RPG_MCOLOR_METHOD_2_4B0A91863BB1C92C_OFFSET UNITYSDK_OFFSET(0x19227590)
#define RPG_MCOLOR_METHOD_2_70A8AFA4B5F015AA_OFFSET UNITYSDK_OFFSET(0x19227520)
#define RPG_MCOLOR_METHOD_2_73A33226BF78995D_1_OFFSET UNITYSDK_OFFSET(0x19227640)
#define RPG_MCOLOR_METHOD_2_73A33226BF78995D_OFFSET UNITYSDK_OFFSET(0x192275F0)
#define RPG_MCOLOR_METHOD_2_992F40E2AD3811DF_OFFSET UNITYSDK_OFFSET(0x22C9370)
#define RPG_MCOLOR_METHOD_2_E571DD6924F35454_1_OFFSET UNITYSDK_OFFSET(0x192276D0)
#define RPG_MCOLOR_METHOD_2_E571DD6924F35454_OFFSET UNITYSDK_OFFSET(0x19227690)
#define RPG_MCOLOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x24C30)
#define RPG_MCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x22C9630)

namespace RPG
{
	inline static constexpr unsigned int MColor_TypeDefinitionIndex = 8894;
