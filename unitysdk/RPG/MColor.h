...
#define RPG_MCOLOR_EQUALS_OFFSET UNITYSDK_OFFSET(0x38DA920)
#define RPG_MCOLOR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x38DAA70)
#define RPG_MCOLOR_METHOD_2_2C17A14F9DD6C0E3_1_OFFSET UNITYSDK_OFFSET(0x14BE7960)
#define RPG_MCOLOR_METHOD_2_2C17A14F9DD6C0E3_2_OFFSET UNITYSDK_OFFSET(0x14BE7980)
#define RPG_MCOLOR_METHOD_2_2C17A14F9DD6C0E3_OFFSET UNITYSDK_OFFSET(0x14BE7940)
#define RPG_MCOLOR_METHOD_2_4B0A91863BB1C92C_1_OFFSET UNITYSDK_OFFSET(0x14BE79C0)
#define RPG_MCOLOR_METHOD_2_4B0A91863BB1C92C_2_OFFSET UNITYSDK_OFFSET(0x14BE79E0)
#define RPG_MCOLOR_METHOD_2_4B0A91863BB1C92C_OFFSET UNITYSDK_OFFSET(0x14BE79A0)
#define RPG_MCOLOR_METHOD_2_70A8AFA4B5F015AA_OFFSET UNITYSDK_OFFSET(0x14BE7930)
#define RPG_MCOLOR_METHOD_2_73A33226BF78995D_1_OFFSET UNITYSDK_OFFSET(0x14BE7A50)
#define RPG_MCOLOR_METHOD_2_73A33226BF78995D_OFFSET UNITYSDK_OFFSET(0x14BE7A00)
#define RPG_MCOLOR_METHOD_2_992F40E2AD3811DF_OFFSET UNITYSDK_OFFSET(0x38DA840)
#define RPG_MCOLOR_METHOD_2_E571DD6924F35454_1_OFFSET UNITYSDK_OFFSET(0x14BE7B00)
#define RPG_MCOLOR_METHOD_2_E571DD6924F35454_OFFSET UNITYSDK_OFFSET(0x14BE7AA0)
#define RPG_MCOLOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x7AF9A0)
#define RPG_MCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x38DAB00)

namespace RPG
{
	inline static constexpr unsigned int MColor_TypeDefinitionIndex = 6763;
