...
#define RPG_EMBREE_EMBREEMANAGER_ADDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B74CAF0)
#define RPG_EMBREE_EMBREEMANAGER_ADDMESH_OFFSET UNITYSDK_OFFSET(0x1B74CD40)
#define RPG_EMBREE_EMBREEMANAGER_ADDSTATICGEOMETRY_OFFSET UNITYSDK_OFFSET(0x1B74D6F0)
#define RPG_EMBREE_EMBREEMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B74C250)
#define RPG_EMBREE_EMBREEMANAGER_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1B74E4A0)
#define RPG_EMBREE_EMBREEMANAGER_COMMITSCENE_OFFSET UNITYSDK_OFFSET(0x1B74D9B0)
#define RPG_EMBREE_EMBREEMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1B74C170)
#define RPG_EMBREE_EMBREEMANAGER_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1B74C240)
#define RPG_EMBREE_EMBREEMANAGER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B74C2A0)
#define RPG_EMBREE_EMBREEMANAGER_ISOCCLUDED_OFFSET UNITYSDK_OFFSET(0x1B74E1C0)
#define RPG_EMBREE_EMBREEMANAGER_ONAPPLICATIONQUIT_OFFSET UNITYSDK_OFFSET(0x1B74E8D0)
#define RPG_EMBREE_EMBREEMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B74E850)
#define RPG_EMBREE_EMBREEMANAGER_RAYCAST_1_OFFSET UNITYSDK_OFFSET(0x1B74E0A0)
#define RPG_EMBREE_EMBREEMANAGER_RAYCAST_OFFSET UNITYSDK_OFFSET(0x1B74DC20)
#define RPG_EMBREE_EMBREEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B74E950)

namespace RPG::Embree
{
	inline static constexpr unsigned int EmbreeManager_TypeDefinitionIndex = 45239;
	...
	public:
		...
		{
			return (::RPG::Embree::EmbreeManager**)Il2CppClass::FromTypeDefinitionIndex(EmbreeManager_TypeDefinitionIndex)->GetStaticField(0x1DCC0);
		}
