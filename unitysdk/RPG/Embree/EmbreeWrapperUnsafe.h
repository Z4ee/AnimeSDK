...
#define RPG_EMBREE_EMBREEWRAPPERUNSAFE_CLEANUP_OFFSET UNITYSDK_OFFSET(0xB2D82E0)
#define RPG_EMBREE_EMBREEWRAPPERUNSAFE_COMMITSCENE_OFFSET UNITYSDK_OFFSET(0xB2D7D80)
#define RPG_EMBREE_EMBREEWRAPPERUNSAFE_GET_DEVICE_OFFSET UNITYSDK_OFFSET(0xB2D7940)
#define RPG_EMBREE_EMBREEWRAPPERUNSAFE_GET_SCENE_OFFSET UNITYSDK_OFFSET(0xB2D7950)
#define RPG_EMBREE_EMBREEWRAPPERUNSAFE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xB2D7960)
#define RPG_EMBREE_EMBREEWRAPPERUNSAFE_RAYCAST_OFFSET UNITYSDK_OFFSET(0xB2D7E00)
#define RPG_EMBREE_EMBREEWRAPPERUNSAFE_RTCCOMMITSCENE_OFFSET UNITYSDK_OFFSET(0xB2D77B0)
#define RPG_EMBREE_EMBREEWRAPPERUNSAFE_RTCGETDEVICEERROR_OFFSET UNITYSDK_OFFSET(0xB2D78C0)
#define RPG_EMBREE_EMBREEWRAPPERUNSAFE_RTCINTERSECT1_OFFSET UNITYSDK_OFFSET(0xB2D7830)
#define RPG_EMBREE_EMBREEWRAPPERUNSAFE_RTCNEWDEVICE_OFFSET UNITYSDK_OFFSET(0xB2D7590)
#define RPG_EMBREE_EMBREEWRAPPERUNSAFE_RTCNEWSCENE_OFFSET UNITYSDK_OFFSET(0xB2D76B0)
#define RPG_EMBREE_EMBREEWRAPPERUNSAFE_RTCRELEASEDEVICE_OFFSET UNITYSDK_OFFSET(0xB2D7630)
#define RPG_EMBREE_EMBREEWRAPPERUNSAFE_RTCRELEASESCENE_OFFSET UNITYSDK_OFFSET(0xB2D7730)
#define RPG_EMBREE_EMBREEWRAPPERUNSAFE__CTOR_OFFSET UNITYSDK_OFFSET(0xB2D83F0)
