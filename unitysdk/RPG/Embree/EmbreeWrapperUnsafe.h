...
#define RPG_EMBREE_EMBREEWRAPPERUNSAFE_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1B751670)
#define RPG_EMBREE_EMBREEWRAPPERUNSAFE_COMMITSCENE_OFFSET UNITYSDK_OFFSET(0x1B7515F0)
#define RPG_EMBREE_EMBREEWRAPPERUNSAFE_GET_DEVICE_OFFSET UNITYSDK_OFFSET(0x1B7511B0)
#define RPG_EMBREE_EMBREEWRAPPERUNSAFE_GET_SCENE_OFFSET UNITYSDK_OFFSET(0x1B7511C0)
#define RPG_EMBREE_EMBREEWRAPPERUNSAFE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B7511D0)
#define RPG_EMBREE_EMBREEWRAPPERUNSAFE_RAYCAST_OFFSET UNITYSDK_OFFSET(0x1B74F8D0)
#define RPG_EMBREE_EMBREEWRAPPERUNSAFE_RTCCOMMITSCENE_OFFSET UNITYSDK_OFFSET(0x1B751020)
#define RPG_EMBREE_EMBREEWRAPPERUNSAFE_RTCGETDEVICEERROR_OFFSET UNITYSDK_OFFSET(0x1B751130)
#define RPG_EMBREE_EMBREEWRAPPERUNSAFE_RTCINTERSECT1_OFFSET UNITYSDK_OFFSET(0x1B7510A0)
#define RPG_EMBREE_EMBREEWRAPPERUNSAFE_RTCNEWDEVICE_OFFSET UNITYSDK_OFFSET(0x1B750E00)
#define RPG_EMBREE_EMBREEWRAPPERUNSAFE_RTCNEWSCENE_OFFSET UNITYSDK_OFFSET(0x1B750F20)
#define RPG_EMBREE_EMBREEWRAPPERUNSAFE_RTCRELEASEDEVICE_OFFSET UNITYSDK_OFFSET(0x1B750EA0)
#define RPG_EMBREE_EMBREEWRAPPERUNSAFE_RTCRELEASESCENE_OFFSET UNITYSDK_OFFSET(0x1B750FA0)
#define RPG_EMBREE_EMBREEWRAPPERUNSAFE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B74F8C0)

namespace RPG::Embree
{
	inline static constexpr unsigned int EmbreeWrapperUnsafe_TypeDefinitionIndex = 45249;
