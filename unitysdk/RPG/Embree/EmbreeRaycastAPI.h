...
#define RPG_EMBREE_EMBREERAYCASTAPI_ADDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1CD5E510)
#define RPG_EMBREE_EMBREERAYCASTAPI_ADDMESH_OFFSET UNITYSDK_OFFSET(0x1CD5E410)
#define RPG_EMBREE_EMBREERAYCASTAPI_CALCULATEFRONTFACE_OFFSET UNITYSDK_OFFSET(0x1CD5F0B0)
#define RPG_EMBREE_EMBREERAYCASTAPI_COMMITSCENE_OFFSET UNITYSDK_OFFSET(0x1CD5E7D0)
#define RPG_EMBREE_EMBREERAYCASTAPI_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CD5F910)
#define RPG_EMBREE_EMBREERAYCASTAPI_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1CD5E110)
#define RPG_EMBREE_EMBREERAYCASTAPI_RAYCASTBATCHALL_OFFSET UNITYSDK_OFFSET(0x1CD5F0E0)
#define RPG_EMBREE_EMBREERAYCASTAPI_RAYCASTBATCH_OFFSET UNITYSDK_OFFSET(0x1CD5EA40)
#define RPG_EMBREE_EMBREERAYCASTAPI_RAYCAST_OFFSET UNITYSDK_OFFSET(0x1CD5E920)
#define RPG_EMBREE_EMBREERAYCASTAPI__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD5F940)

namespace RPG::Embree
{
	inline static constexpr unsigned int EmbreeRaycastAPI_TypeDefinitionIndex = 47472;
