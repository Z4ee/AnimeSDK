...
#define RPG_RENDERING_TERRAIN_TERRAINBLOCKINFO_DUMP_OFFSET UNITYSDK_OFFSET(0x19D4A1D0)
#define RPG_RENDERING_TERRAIN_TERRAINBLOCKINFO_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0x19D49FD0)
#define RPG_RENDERING_TERRAIN_TERRAINBLOCKINFO_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0x19D49FC0)
#define RPG_RENDERING_TERRAIN_TERRAINBLOCKINFO_GET_BLOCKBOUNDS_OFFSET UNITYSDK_OFFSET(0x19D49FA0)
#define RPG_RENDERING_TERRAIN_TERRAINBLOCKINFO_GET_GRIDCOL_OFFSET UNITYSDK_OFFSET(0x19D49F60)
#define RPG_RENDERING_TERRAIN_TERRAINBLOCKINFO_GET_GRIDROW_OFFSET UNITYSDK_OFFSET(0x19D49F50)
#define RPG_RENDERING_TERRAIN_TERRAINBLOCKINFO_GET_LOD_OFFSET UNITYSDK_OFFSET(0x19D49F70)
#define RPG_RENDERING_TERRAIN_TERRAINBLOCKINFO_GET_SHADOWHEIGHTMAPHEIGHTSCALE_OFFSET UNITYSDK_OFFSET(0x19D49F90)
#define RPG_RENDERING_TERRAIN_TERRAINBLOCKINFO_GET_SHADOWHEIGHTMAP_OFFSET UNITYSDK_OFFSET(0x19D49F80)
#define RPG_RENDERING_TERRAIN_TERRAINBLOCKINFO_GET_TERRAINSHADOWPROXYID_OFFSET UNITYSDK_OFFSET(0x19D49FF0)
#define RPG_RENDERING_TERRAIN_TERRAINBLOCKINFO_LOAD_OFFSET UNITYSDK_OFFSET(0x19D4A000)
#define RPG_RENDERING_TERRAIN_TERRAINBLOCKINFO_UNLOAD_OFFSET UNITYSDK_OFFSET(0x19D4A140)
#define RPG_RENDERING_TERRAIN_TERRAINBLOCKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19D4A220)
