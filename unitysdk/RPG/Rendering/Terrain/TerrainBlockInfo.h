...
#define RPG_RENDERING_TERRAIN_TERRAINBLOCKINFO_DUMP_OFFSET UNITYSDK_OFFSET(0xE7E90C0)
#define RPG_RENDERING_TERRAIN_TERRAINBLOCKINFO_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0xE7E8EC0)
#define RPG_RENDERING_TERRAIN_TERRAINBLOCKINFO_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0xE7E8EB0)
#define RPG_RENDERING_TERRAIN_TERRAINBLOCKINFO_GET_BLOCKBOUNDS_OFFSET UNITYSDK_OFFSET(0xE7E8E90)
#define RPG_RENDERING_TERRAIN_TERRAINBLOCKINFO_GET_GRIDCOL_OFFSET UNITYSDK_OFFSET(0xE7E8E50)
#define RPG_RENDERING_TERRAIN_TERRAINBLOCKINFO_GET_GRIDROW_OFFSET UNITYSDK_OFFSET(0xE7E8E40)
#define RPG_RENDERING_TERRAIN_TERRAINBLOCKINFO_GET_LOD_OFFSET UNITYSDK_OFFSET(0xE7E8E60)
#define RPG_RENDERING_TERRAIN_TERRAINBLOCKINFO_GET_SHADOWHEIGHTMAPHEIGHTSCALE_OFFSET UNITYSDK_OFFSET(0xE7E8E80)
#define RPG_RENDERING_TERRAIN_TERRAINBLOCKINFO_GET_SHADOWHEIGHTMAP_OFFSET UNITYSDK_OFFSET(0xE7E8E70)
#define RPG_RENDERING_TERRAIN_TERRAINBLOCKINFO_GET_TERRAINSHADOWPROXYID_OFFSET UNITYSDK_OFFSET(0xE7E8EE0)
#define RPG_RENDERING_TERRAIN_TERRAINBLOCKINFO_LOAD_OFFSET UNITYSDK_OFFSET(0xE7E8EF0)
#define RPG_RENDERING_TERRAIN_TERRAINBLOCKINFO_UNLOAD_OFFSET UNITYSDK_OFFSET(0xE7E9030)
#define RPG_RENDERING_TERRAIN_TERRAINBLOCKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xE7E9110)
