...
#define RPG_RENDERING_TERRAIN_TERRAINGRIDROOTMARKER_GETMARKEDBLOCKSFOREDITOR_OFFSET UNITYSDK_OFFSET(0xE7EC560)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDROOTMARKER_GET_STAGENAME_OFFSET UNITYSDK_OFFSET(0xE7EC020)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDROOTMARKER_SETBOXOFFSET_OFFSET UNITYSDK_OFFSET(0xE7EC100)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDROOTMARKER_SETBOXSIZE_OFFSET UNITYSDK_OFFSET(0xE7EC0A0)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDROOTMARKER_SETMARKEDBLOCKS_OFFSET UNITYSDK_OFFSET(0xE7EC160)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDROOTMARKER_SETSTAGENAME_OFFSET UNITYSDK_OFFSET(0xE7EC030)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDROOTMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0xE7EC5F0)
