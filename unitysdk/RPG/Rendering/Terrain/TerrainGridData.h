...
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_BLOCKCOUNT_OFFSET UNITYSDK_OFFSET(0x1B507430)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_BLOCKSIZE_OFFSET UNITYSDK_OFFSET(0x1B5076F0)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_CREATEORIGIN_OFFSET UNITYSDK_OFFSET(0x1B5073E0)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_GRIDCOLMIN_OFFSET UNITYSDK_OFFSET(0x1B5073B0)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_GRIDCOLUMNS_OFFSET UNITYSDK_OFFSET(0x1B5073D0)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_GRIDROWMIN_OFFSET UNITYSDK_OFFSET(0x1B5073A0)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_GRIDROWS_OFFSET UNITYSDK_OFFSET(0x1B5073C0)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_ROOTNAME_OFFSET UNITYSDK_OFFSET(0x1B507420)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_TERRAINHEIGHT_OFFSET UNITYSDK_OFFSET(0x1B507410)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_TERRAINLATERALSIZE_OFFSET UNITYSDK_OFFSET(0x1B507400)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_METHOD_3_03E0F1DB854D5804_OFFSET UNITYSDK_OFFSET(0x1B507650)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_METHOD_3_987AD1B6E19A63AC_OFFSET UNITYSDK_OFFSET(0x1B507480)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_METHOD_3_B6B7014A78386E25_OFFSET UNITYSDK_OFFSET(0x1B507580)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B507760)

namespace RPG::Rendering::Terrain
{
	inline static constexpr unsigned int TerrainGridData_TypeDefinitionIndex = 52094;
