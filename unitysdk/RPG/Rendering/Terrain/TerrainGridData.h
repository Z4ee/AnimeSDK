...
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_BLOCKCOUNT_OFFSET UNITYSDK_OFFSET(0xE7E92C0)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_BLOCKSIZE_OFFSET UNITYSDK_OFFSET(0xE7E9580)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_CREATEORIGIN_OFFSET UNITYSDK_OFFSET(0xE7E9270)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_GRIDCOLMIN_OFFSET UNITYSDK_OFFSET(0xE7E9240)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_GRIDCOLUMNS_OFFSET UNITYSDK_OFFSET(0xE7E9260)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_GRIDROWMIN_OFFSET UNITYSDK_OFFSET(0xE7E9230)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_GRIDROWS_OFFSET UNITYSDK_OFFSET(0xE7E9250)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_ROOTNAME_OFFSET UNITYSDK_OFFSET(0xE7E92B0)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_TERRAINHEIGHT_OFFSET UNITYSDK_OFFSET(0xE7E92A0)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_TERRAINLATERALSIZE_OFFSET UNITYSDK_OFFSET(0xE7E9290)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_METHOD_3_03E0F1DB854D5804_OFFSET UNITYSDK_OFFSET(0xE7E94E0)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_METHOD_3_987AD1B6E19A63AC_OFFSET UNITYSDK_OFFSET(0xE7E9310)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_METHOD_3_B6B7014A78386E25_OFFSET UNITYSDK_OFFSET(0xE7E9410)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xE7E95F0)
