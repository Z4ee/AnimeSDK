...
#define RPG_VIEW_ACTIVITYAVATARINFOCONTROL___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xB8859E0)
#define RPG_VIEW_ACTIVITYAVATARINFOCONTROL___C__CTOR_OFFSET UNITYSDK_OFFSET(0xB885A20)
...
namespace RPG::View
{
	...
	public:
		...
		{
			return (::RPG::View::ActivityAvatarInfoControl___c**)Il2CppClass::FromTypeDefinitionIndex(ActivityAvatarInfoControl___c_TypeDefinitionIndex)->GetStaticField(0x67230);
		}
