...
#define RPG_CUSTOMRP_CAPTURESCENE___QACAPTUREALL_D__19_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x18EC5A60)
#define RPG_CUSTOMRP_CAPTURESCENE___QACAPTUREALL_D__19_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18EC63A0)
#define RPG_CUSTOMRP_CAPTURESCENE___QACAPTUREALL_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18EC6400)
#define RPG_CUSTOMRP_CAPTURESCENE___QACAPTUREALL_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x18EC63B0)
#define RPG_CUSTOMRP_CAPTURESCENE___QACAPTUREALL_D__19_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18EC5A50)
#define RPG_CUSTOMRP_CAPTURESCENE___QACAPTUREALL_D__19__CTOR_OFFSET UNITYSDK_OFFSET(0x18EC39A0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CaptureScene___QACaptureAll_d__19_TypeDefinitionIndex = 35276;
