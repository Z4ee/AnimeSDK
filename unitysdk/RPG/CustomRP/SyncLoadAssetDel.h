...
#define RPG_CUSTOMRP_SYNCLOADASSETDEL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D135270)
#define RPG_CUSTOMRP_SYNCLOADASSETDEL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D1352E0)
#define RPG_CUSTOMRP_SYNCLOADASSETDEL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D135250)
#define RPG_CUSTOMRP_SYNCLOADASSETDEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1351D0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int SyncLoadAssetDel_TypeDefinitionIndex = 36345;
