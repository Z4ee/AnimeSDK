...
#define RPG_CUSTOMRP_SYNCLOADASSETDEL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16ADC6F0)
#define RPG_CUSTOMRP_SYNCLOADASSETDEL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16ADC760)
#define RPG_CUSTOMRP_SYNCLOADASSETDEL_INVOKE_OFFSET UNITYSDK_OFFSET(0x16ADC0B0)
#define RPG_CUSTOMRP_SYNCLOADASSETDEL__CTOR_OFFSET UNITYSDK_OFFSET(0x16ADC090)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int SyncLoadAssetDel_TypeDefinitionIndex = 29496;
