...
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_BEGINCAPTURE_OFFSET UNITYSDK_OFFSET(0x106A81E0)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_EXECUTE_OFFSET UNITYSDK_OFFSET(0x106A8740)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_GET_DUMPPATHS_OFFSET UNITYSDK_OFFSET(0x106A8150)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_GET_KEY_OFFSET UNITYSDK_OFFSET(0x106A8140)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x106A87E0)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_METHOD_5_50CDA0D6D52C2BA3_OFFSET UNITYSDK_OFFSET(0x106A8280)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_METHOD_5_96189EDEF38976A6_OFFSET UNITYSDK_OFFSET(0x106A83A0)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x106A8A40)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_ONENABLE_OFFSET UNITYSDK_OFFSET(0x106A88C0)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0x106A8B70)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int PathTracingDebug_TypeDefinitionIndex = 49477;
