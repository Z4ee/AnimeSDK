...
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_BEGINCAPTURE_OFFSET UNITYSDK_OFFSET(0xA7AE3D0)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_EXECUTE_OFFSET UNITYSDK_OFFSET(0xA7AE910)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_GET_DUMPPATHS_OFFSET UNITYSDK_OFFSET(0xA7AE340)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_GET_KEY_OFFSET UNITYSDK_OFFSET(0xA7AE330)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_METHOD_5_50CDA0D6D52C2BA3_OFFSET UNITYSDK_OFFSET(0xA7AE450)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_METHOD_5_96189EDEF38976A6_OFFSET UNITYSDK_OFFSET(0xA7AE570)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_METHOD_5_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0xA7AE9B0)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA7AEB80)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA7AEA50)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0xA7AEC60)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int PathTracingDebug_TypeDefinitionIndex = 41874;
