...
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_BEGINCAPTURE_OFFSET UNITYSDK_OFFSET(0xCC57300)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_EXECUTE_OFFSET UNITYSDK_OFFSET(0xCC57860)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_GET_DUMPPATHS_OFFSET UNITYSDK_OFFSET(0xCC57270)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_GET_KEY_OFFSET UNITYSDK_OFFSET(0xCC57260)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_METHOD_5_50CDA0D6D52C2BA3_OFFSET UNITYSDK_OFFSET(0xCC573A0)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_METHOD_5_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xCC57900)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_METHOD_5_96189EDEF38976A6_OFFSET UNITYSDK_OFFSET(0xCC574C0)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCC57B20)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCC579C0)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0xCC57C40)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int PathTracingDebug_TypeDefinitionIndex = 48464;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CUSTOMRP_PATHTRACINGDEBUG_METHOD_5_89D1F247B9D324EE_OFFSET))(this);
		}
